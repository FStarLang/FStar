...
size_t CBOR_cbor_size_comp(CBOR_cbor c, size_t sz, bool *perr);

uint8_t *CBOR_cbor_l2r_write(CBOR_cbor c, CBOR_t out);

CBOR_cbor CBOR_read_valid_cbor_from_buffer_with_size_strong(uint8_t *a, size_t alen);

CBOR_cbor_serialized CBOR_destr_cbor_serialized(CBOR_cbor c);

size_t CBOR_size_comp_for_serialized(CBOR_cbor c, size_t sz, bool *perr);

uint8_t *CBOR_l2r_writer_for_serialized(CBOR_cbor c, CBOR_t out);

CBOR_cbor_array CBOR_destr_cbor_array(CBOR_cbor a);

size_t CBOR_size_comp_for_string(CBOR_cbor c, size_t sz, bool *perr);

uint8_t *CBOR_l2r_write_cbor_string(CBOR_cbor c, CBOR_t out);

size_t CBOR_size_comp_for_simple_value(CBOR_cbor c, size_t sz, bool *perr);

uint8_t *CBOR_l2r_writer_for_simple_value(CBOR_cbor c, CBOR_t out);

size_t CBOR_size_comp_for_int64(CBOR_cbor c, size_t sz, bool *perr);

uint8_t *CBOR_l2r_writer_for_int64(CBOR_cbor c, CBOR_t out);

CBOR_cbor_map CBOR_destr_cbor_map(CBOR_cbor a);
