...
val init_l0_ctxt (cdi:A.larray U8.t (US.v dice_digest_len)) (#s:erased (elseq U8.t dice_digest_len))
  : stt locked_context_t
    (A.pts_to cdi full_perm s `star` pure (A.is_full_array cdi))
...
val init_l1_ctxt (deviceIDCSR_len: US.t) (aliasKeyCRT_len: US.t) 
  ...
  : stt locked_context_t
     (A.pts_to deviceID_priv full_perm s1 `star` 
      A.pts_to deviceID_pub full_perm s2 `star`  
      A.pts_to aliasKey_priv full_perm s3 `star`  
      A.pts_to aliasKey_pub full_perm s4 `star`  
      A.pts_to deviceIDCSR full_perm s5 `star` 
