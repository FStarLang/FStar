...
let (lb_init_and_def :
  FStar_Extraction_ML_Syntax.mllb ->
    (Prims.bool * FStar_Extraction_ML_Syntax.mlty *
    ...
    then
      let init =
        ...
        | FStar_Extraction_ML_Syntax.MLE_App
            ...
            uu___2 = "Pulse.Lib.Reference.alloc" -> init1
        | uu___ ->
            let uu___1 =
              let uu___2 =
      ...
      let ty =
        ...
        | FStar_Pervasives_Native.Some
            ([], FStar_Extraction_ML_Syntax.MLTY_Named (ty1::[], p)) when
            let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___ = "Pulse.Lib.Reference.ref" -> ty1
        | uu___ ->
            let uu___1 =
              let uu___2 =
                let uu___3 =
                ...
                FStar_Extraction_ML_Syntax.mltyscheme_to_string uu___3 in
              FStar_Compiler_Util.format1
                "unexpected type of mutable local: %s" uu___2 in
            fail uu___1 in
      (is_mut, ty, init)
    else
      (let is_mut1 =
         ...
         | FStar_Extraction_ML_Syntax.MLE_App
             ...
             uu___7 = "Pulse.Lib.Rust.Vec.alloc"
         | uu___1 -> false in
       let uu___1 =
         let uu___2 =
           FStar_Compiler_Util.must lb.FStar_Extraction_ML_Syntax.mllb_tysc in
         FStar_Pervasives_Native.snd uu___2 in
       (is_mut1, uu___1, (lb.FStar_Extraction_ML_Syntax.mllb_def)))
  ...
  fun g ->
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          ((let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___7 = "Pulse.Lib.Rust.Slice.op_Array_Access") ||
             (let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu___7 = "Pulse.Lib.Rust.Vec.op_Array_Access"))
            ||
            (let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___7 = "Pulse.Lib.Rust.Array.op_Array_Access")
          ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          ((let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___6 = "Pulse.Lib.Rust.Slice.op_Array_Assignment") ||
             (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu___6 = "Pulse.Lib.Rust.Vec.op_Array_Assignment"))
            ||
            (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___6 = "Pulse.Lib.Rust.Array.op_Array_Assignment")
          ->
          let e11 = extract_mlexpr g e1 in
          let e21 = extract_mlexpr g e2 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          uu___5 = "Pulse.Lib.Rust.Vec.alloc" ->
          let e11 = extract_mlexpr g e1 in
          let e21 = extract_mlexpr g e2 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___6 = "Pulse.Lib.Rust.Vec.free" ->
          let e2 = extract_mlexpr g e1 in
          Pulse2Rust_Rust_Syntax.mk_call
            (Pulse2Rust_Rust_Syntax.Expr_path "drop") [e2]
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
  ...
  fun g ->
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let uu___ = lb_init_and_def lb in
          (match uu___ with
           | (is_mut, ty, init) ->
               let s =
