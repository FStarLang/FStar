...
let frame_resolve_test3 (r:resource)
        (f:unit -> RST unit empty_resource (fun _ -> empty_resource) (fun _ -> True) (fun _ _ _ -> True))
      : RST unit r (fun _ -> r) (fun _ -> True) (fun _ _ _ -> True) =
  rst_frame r (fun _ -> r) f
...
(*
// next test currently fails, due to two-phase typechecking trying to retypecheck
// the refinement on the frame r3 <*> r4; turning two-phase off crashes F* with 
