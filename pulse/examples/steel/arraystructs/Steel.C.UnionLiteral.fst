...
assume val mk_union_def (tag: Type0) (field_descriptions: Type0): Type0
...
assume val union (tag: Type0) (fields: c_fields): Type0

assume val mk_union (tag: Type0) (fields: c_fields)
  (field: string) (x: (fields.get_field field).view_type)
: Pure (union tag fields)
    (requires fields.has_field field == true)
    (ensures fun _ -> True)

assume val union_pcm_carrier (tag: Type0) (fields: c_fields): Type0

assume val union_pcm (tag: Type0) (fields: c_fields): pcm (union_pcm_carrier tag fields)

let union_views (fields: c_fields) (field: field_of fields): Type0 =
  (fields.get_field field).view_type

assume val union_view (tag: Type0) (fields: c_fields)
: sel_view (union_pcm tag fields) (union tag fields) false

assume val dtuple2_of_union (#tag: Type0) (#fields: c_fields) (x: union tag fields)
: dtuple2 (field_of fields) (union_views fields)

assume val union_of_dtuple2 (#tag: Type0) (#fields: c_fields) 
...
assume val union_of_dtuple2_of_union
  (#tag: Type0) (#fields: c_fields)
  (x: union tag fields)
: Lemma (union_of_dtuple2 (dtuple2_of_union #tag #fields x) == x)

(* TOOD The two are mutually inverse *)

assume val union_field
