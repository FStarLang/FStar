...
val ctr_empty () : Lemma (ctr empty_heap == 0)

val ctr_join (h1: heap u#a) (h2: heap u#a { disjoint h1 h2 }) (a:nat) :
  Lemma (ctr (join h1 h2) == max (ctr h1) (ctr h2))

val ctr_prop (h:heap u#a)
: Lemma (forall i. i >= ctr h ==> select i h == None)
