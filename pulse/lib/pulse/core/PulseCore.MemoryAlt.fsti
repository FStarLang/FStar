...
[@@erasable]
val slprop : Type u#(a + 4) //invariant predicates, i --> p, live in u#a+3

[@@erasable]
val slprop2_base : Type u#(a + 3) //all other predicates live in u#a+2, e.g., big_pts_to, pts_to
...
[@@erasable]
val slprop1_base : Type u#(a + 2) //small slprops are heap storeable; these are the most common ones e.g., pts_to etc
...
val pts_to (#a:Type u#(a + 1)) (#pcm:_) (r:ref a pcm) (v:a) : slprop1 u#a
...
val ghost_pts_to (#a:Type u#(a + 1)) (#p:pcm a) (r:ghost_ref p) (v:a) : slprop1 u#a
...
val big_pts_to (#a:Type u#(a + 2)) (#pcm:_) (r:ref a pcm) (v:a) : slprop2 u#a
...
val big_ghost_pts_to (#a:Type u#(a + 2)) (#p:pcm a) (r:ghost_ref p) (v:a) : slprop2 u#a
