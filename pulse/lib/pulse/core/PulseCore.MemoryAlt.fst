...
let pts_to (#a:Type u#a) (#pcm:_) (r:ref a pcm) (v:a) : slprop u#a
 = up1 (B.base_heap.pts_to #a #pcm r v)
...
= up1_star (B.base_heap.pts_to #a #pcm r v0) (B.base_heap.pts_to #a #pcm r v1);
...
: pst_action_except (ref a pcm) e
    ...
    (fun r -> pts_to r x)
= up1_emp ();
  coerce_action #_ #_ #_ #(reveal_slprop emp) #(fun r -> up1 (B.base_heap.pts_to #a #pcm r x)) () <|
  lift_action_alt #small_sig <|
  lift_action_alt #B.base_heap <|
...
: pst_action_except (v:a{compatible p x v /\ p.refine v}) e
    (pts_to r x)
    (fun v -> pts_to r (f v))
= coerce_action #(v:a{compatible p x v /\ p.refine v}) #_ #_ #(reveal_slprop (pts_to r x)) #(fun v -> up1 (B.base_heap.pts_to #a #p r (f v))) #(pts_to r x) #(fun v -> pts_to r (f v)) () <|
  lift_action_alt #small_sig <|
  lift_action_alt #B.base_heap <|
...
: slprop u#a
= up1 (B.base_heap.ghost_pts_to false #a #p r v)
...
= up1_emp ();
  coerce_action #_ #_ #_ #(reveal_slprop emp) #(fun r -> up1 (B.base_heap.ghost_pts_to false #a #pcm r x)) () <|
  lift_action_alt #small_sig <|
  lift_action_alt #B.base_heap <|
...
= coerce_action #(erased (v:a{compatible p x v /\ p.refine v})) #_ #_
                ...
                #(fun v -> up1 (B.base_heap.ghost_pts_to false #a #p r (f v)))
                #(ghost_pts_to r x)
                #(fun v -> ghost_pts_to r (f v))
                () <|
  lift_action_alt #small_sig <|
...
= up1_star (B.base_heap.ghost_pts_to false #a #pcm r v0) (B.base_heap.ghost_pts_to false #a #pcm r v1);
...
: slprop2 u#a
= up2 (small_sig.pts_to #a #pcm r v)
...
= up2_star (small_sig.pts_to #a #pcm r v0) (small_sig.pts_to #a #pcm r v1);
...
= up2_emp ();
  coerce_action #_ #_ #_ #(reveal_slprop emp) #(fun r -> up2 (small_sig.pts_to #a #pcm r x)) () <|
  lift_action_alt #small_sig <|
...
= coerce_action #(v:a{compatible p x v /\ p.refine v}) #_ #_
      ...
      #(fun v -> up2 (small_sig.pts_to #a #p r (f v)))
      #(big_pts_to r x)
      #(fun v -> big_pts_to r (f v))
      () <|
  lift_action_alt #small_sig <|
...
: slprop2 u#a
= up2 (small_sig.ghost_pts_to false #a #p r v)
...
= up2_emp ();
  coerce_action #_ #_ #_ #(reveal_slprop emp) #(fun r -> up2 (small_sig.ghost_pts_to false #a #pcm r x)) () <|
  lift_action_alt #small_sig <|
...
= coerce_action #(erased (v:a{compatible p x v /\ p.refine v})) #_ #_
                ...
                #(fun v -> up2 (small_sig.ghost_pts_to false #a #p r (f v)))
                #(big_ghost_pts_to r x)
                #(fun v -> big_ghost_pts_to r (f v))
                () <|
  lift_action_alt #small_sig <|
...
= up2_star (small_sig.ghost_pts_to false #a #pcm r v0) (small_sig.ghost_pts_to false #a #pcm r v1);
