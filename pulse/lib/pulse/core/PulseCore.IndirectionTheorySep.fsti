...
val istore_invariant_update_timeless_mem (m: mem) (p: timeless_mem) (ex: inames) :
  Lemma (istore_invariant ex (update_timeless_mem m p) == istore_invariant ex m)
    [SMTPat (istore_invariant ex (update_timeless_mem m p))]
