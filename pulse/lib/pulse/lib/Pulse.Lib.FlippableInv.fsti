...
val flip_on  (#p:vprop) (fi : finv p) : stt_atomic unit (add_inv emp_inames (iname_of fi)) (off fi ** p) (fun () -> on fi)
val flip_off (#p:vprop) (fi : finv p) : stt_atomic unit (add_inv emp_inames (iname_of fi)) (on fi) (fun () -> off fi ** p)
