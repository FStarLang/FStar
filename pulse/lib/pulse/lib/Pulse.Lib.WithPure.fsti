...
instance val is_send_across_with_pure #b #g (p:prop) v {| (x:p -> is_send_across #b g (v x)) |} : is_send_across g (with_pure p v)
instance placeless_with_pure (p:prop) v {| inst: (x:p -> placeless (v x)) |} : placeless (with_pure p v) =
  is_send_across_with_pure p v #inst
instance is_send_with_pure (p:prop) v {| inst: (x:p -> is_send (v x)) |} : is_send (with_pure p v) =
  is_send_across_with_pure p v #inst
