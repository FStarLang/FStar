...
//       let pre_equiv
//           : vprop_equiv g (comp_pre preamble.c) (Tm_Star (list_as_vprop res.unmatched_p) matched_pre)
//           = let p_eq : vprop_equiv g (comp_pre preamble.c) (Tm_Star (list_as_vprop p.unmatched_pre) p.matched_pre) = p.pre_equiv in
//             let step_eq : vprop_equiv g (list_as_vprop p.unmatched_pre) (list_as_vprop (res.unmatched_p @ res.matched)) = res.p_eq in
//             let p_eq  : vprop_equiv g (comp_pre preamble.c) (Tm_Star (list_as_vprop (res.unmatched_p @ res.matched)) p.matched_pre) =
