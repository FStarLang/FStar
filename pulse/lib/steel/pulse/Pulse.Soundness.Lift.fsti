...
val elab_lift_stt_atomic_typing (f:stt_env) (g:env)
  (c1 c2:ln_comp)
  (e:R.term)
  (e_typing:RT.tot_typing (extend_env_l f g) e (elab_comp c1))
  (lc:lift_comp f g c1 c2)
  : Ghost (RT.tot_typing (extend_env_l f g) (elab_lift lc e) (elab_comp c2))
...
val elab_lift_stt_ghost_typing (f:stt_env) (g:env)
  ...
  (lc:lift_comp f g c1 c2)
  (reveal_a:R.term)
  (reveal_a_typing:RT.tot_typing (extend_env_l f g) reveal_a
