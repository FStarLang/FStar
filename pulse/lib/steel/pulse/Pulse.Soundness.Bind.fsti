...
val elab_bind_ghost_l_typing
  ...
  (r2_typing:RT.tot_typing (extend_env_l f g) r2
                           (elab_term (Tm_Arrow (null_binder (comp_res c1)) None (close_comp c2 x))))
  (bc:bind_comp f g x c1 c2 c)
  (t2_typing:RT.tot_typing (extend_env_l f g) (elab_term (comp_res c2))
                           (RT.tm_type (elab_universe (comp_u c2))))
  (post2_typing:RT.tot_typing (extend_env_l f g) (elab_comp_post c2)
                              (post2_type_bind (elab_term (comp_res c2))))
  (reveal_a:R.term)
...
val elab_bind_ghost_r_typing
  ...
  (post2_typing:RT.tot_typing (extend_env_l f g) (elab_comp_post c2)
                              (post2_type_bind (elab_term (comp_res c2))))
  (reveal_b:R.term)
  (reveal_b_typing:RT.tot_typing (extend_env_l f g) reveal_b
