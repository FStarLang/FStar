...
= let v: Ghost.erased (union tag fields) =
  ...
  let q = Steel.C.Model.Union.addr_of_union_field #'a #_ #_ #(union_pcms fields) p field s in
...
= let v: Ghost.erased (fields.get_field field).view_type =
  ...
  in
  Steel.C.Model.Union.unaddr_of_union_field #_ #_ #_ #_ #(union_pcms fields) field q p s;
  pts_to_view_intro p
