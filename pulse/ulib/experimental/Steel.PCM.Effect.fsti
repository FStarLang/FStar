...
let fact_valid_compat (#a:Type) (#pcm:Steel.PCM.pcm a)
                      (fact:stable_property pcm)
                      (v:Ghost.erased a)
  = squash (forall z. Steel.PCM.compatible pcm v z ==> fact z)

val witness (#a:Type) (#pcm:Steel.PCM.pcm a)
            (r:ref a pcm)
            (fact:stable_property pcm)
            (v:Ghost.erased a)
...
val recall (#a:Type u#1) (#pcm:Steel.PCM.pcm a) (#fact:property a)
           (r:ref a pcm)
           (v:Ghost.erased a)
  : SteelT (v1:Ghost.erased a{Steel.PCM.compatible pcm v v1})
