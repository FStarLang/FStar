...
let intro_pts_to #t #o (a:array t) (s:repr a) (s':seq t)
  : STGhost unit o
      (A.varray_pts_to a s)
      (fun _ -> pts_to a s')
      (requires s == s')
      (ensures fun _ -> True)
  = intro_pure (s == s');
    intro_exists s (fun (s:repr a) -> pure (s == s') `star` A.varray_pts_to a s)

let elim_pts_to #t #o (a:array t) (s:seq t)
  : STGhost (erased (repr a)) o
      (pts_to a s)
      (fun s' -> A.varray_pts_to a s')
      (requires True)
...
let pts_to_length #t #o (a:array t) (s:seq t)
  : STGhost unit o
      (pts_to a s)
      (fun _ -> pts_to a s)
      (requires True)
