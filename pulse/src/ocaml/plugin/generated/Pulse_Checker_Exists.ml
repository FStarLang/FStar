            ...
            fun frame_pre ->
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                         (Prims.of_int (35)) (Prims.of_int (32))
                         (Prims.of_int (35)) (Prims.of_int (38)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                         (Prims.of_int (34)) (Prims.of_int (56))
                         (Prims.of_int (75)) (Prims.of_int (61)))))
                (FStar_Tactics_Effect.lift_div_tac
                                                           ...
                                                           (FStar_Tactics_Effect.tac_bind
                                                              ...
                                                              (fun uu___3 ->
                                                                 (fun uu___3
                                                                    ...
                                                                    "check_elim_exists: frame_pre is false but post hint is set, bailing"
                                                                    else
                                                                    FStar_Tactics_Effect.lift_div_tac
                                                                    (fun
                                                                    uu___6 ->
                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           ...
                           (Prims.of_int (93)) (Prims.of_int (67)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           (Prims.of_int (91)) (Prims.of_int (56))
                                                              ...
                                                              uu___4) ->
                                                               Obj.magic
                                                                 (FStar_Tactics_Effect.tac_bind
                                                                    ...
                                                                    then
                                                                    FStar_Tactics_V2_Derived.fail
                                                                    "check_intro_exists_erased: frame_pre is false but post hint is set, bailing"
                                                                    else
                                                                    FStar_Tactics_Effect.lift_div_tac
                                                                    (fun
                                                                    uu___8 ->
              ...
              fun frame_pre ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           (Prims.of_int (128)) (Prims.of_int (66))
                           (Prims.of_int (128)) (Prims.of_int (73)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           (Prims.of_int (126)) (Prims.of_int (56))
                           (Prims.of_int (151)) (Prims.of_int (61)))))
                  (FStar_Tactics_Effect.lift_div_tac
                     (fun uu___ -> st.Pulse_Syntax_Base.term1))
                  (fun uu___ ->
                     (fun uu___ ->
                                                              ...
                                                              uu___4) ->
                                                               Obj.magic
                                                                 (FStar_Tactics_Effect.tac_bind
                                                                    ...
                                                                    then
                                                                    FStar_Tactics_V2_Derived.fail
                                                                    "check_intro_exists: frame_pre is false but post hint is set, bailing"
                                                                    else
                                                                    FStar_Tactics_Effect.lift_div_tac
                                                                    (fun
                                                                    uu___10
          ...
          fun pre_typing ->
            fun post_hint ->
              fun frame_pre ->
                ...
                then
                  check_intro_exists_erased g st vprop_typing pre ()
                    post_hint frame_pre
                else
                  check_intro_exists g st vprop_typing pre () post_hint
                    frame_pre