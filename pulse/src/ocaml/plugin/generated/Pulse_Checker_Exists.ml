            ...
            fun post_hint ->
              FStar_Tactics_Effect.tac_bind
                ...
                (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                   ...
                   (Prims.of_int (101)) (Prims.of_int (56)))
                (FStar_Tactics_Effect.lift_div_tac
                      ...
                      | Pulse_Syntax_Base.Tm_IntroExists
                          ...
                          Obj.magic
                            (FStar_Tactics_Effect.tac_bind
                               ...
                               (FStar_Range.mk_range
                                  "Pulse.Checker.Exists.fst"
                                  (Prims.of_int (87)) (Prims.of_int (56))
                                  (Prims.of_int (101)) (Prims.of_int (56)))
            ...
            fun post_hint ->
              FStar_Tactics_Effect.tac_bind
                (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                   ...
                   (Prims.of_int (113)) (Prims.of_int (59)))
                (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                   (Prims.of_int (111)) (Prims.of_int (46))
                   (Prims.of_int (130)) (Prims.of_int (56)))
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ -> st.Pulse_Syntax_Base.term1))
                (fun uu___ ->
                   (fun uu___ ->
