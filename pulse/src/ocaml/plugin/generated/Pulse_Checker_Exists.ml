            ...
            fun t ->
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                         (Prims.of_int (52)) (Prims.of_int (10))
                         (Prims.of_int (52)) (Prims.of_int (69)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (54)) (Prims.of_int (38)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Exists.fst"
                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           ...
                           (Prims.of_int (106)) (Prims.of_int (82)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Exists.fst"
                           (Prims.of_int (106)) (Prims.of_int (85))
                           (Prims.of_int (130)) (Prims.of_int (156)))))
                  (FStar_Tactics_Effect.lift_div_tac
                     (fun uu___ ->
