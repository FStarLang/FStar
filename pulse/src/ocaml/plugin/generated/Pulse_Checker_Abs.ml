            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                     ...
                     (Prims.of_int (225)) (Prims.of_int (42)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                     (Prims.of_int (226)) (Prims.of_int (2))
                     (Prims.of_int (276)) (Prims.of_int (7)))))
            (FStar_Tactics_Effect.lift_div_tac
               (fun uu___ ->
                  Prims.Mkdtuple2
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  ...
                                  (Prims.of_int (328)) (Prims.of_int (159)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                               ...
                               (FStar_Sealed.seal
                                  (Obj.magic
                                     (FStar_Range.mk_range
                                        ...
                                        (Prims.of_int (159)))))
                               (Obj.magic
                                  (FStar_Tactics_Unseal.unseal binder_attrs))
                               (fun uu___ ->
                                  (fun binder_attrs1 ->
                                     Obj.magic
                                       (FStar_Tactics_Effect.tac_bind
      ...
      fun check ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                   (Prims.of_int (441)) (Prims.of_int (10))
                   (Prims.of_int (441)) (Prims.of_int (28)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                   (Prims.of_int (442)) (Prims.of_int (2))
                   (Prims.of_int (442)) (Prims.of_int (26)))))
