...
let (range_of_comp : Pulse_Syntax_Base.comp -> FStar_Range.range) =
  fun c ->
    ...
    | Pulse_Syntax_Base.C_STGhost st -> range_of_st_comp st
    ...
    fun prog ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                 (Prims.of_int (55)) (Prims.of_int (3)) (Prims.of_int (120))
                 (Prims.of_int (5)))))
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                ...
                                (Prims.of_int (120)) (Prims.of_int (5)))))
                       (FStar_Tactics_Effect.lift_div_tac
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                   ...
                   (Prims.of_int (134)) (Prims.of_int (41)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  (Prims.of_int (137)) (Prims.of_int (15))
                                  (Prims.of_int (137)) (Prims.of_int (34)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  (Prims.of_int (138)) (Prims.of_int (6))
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  (Prims.of_int (183)) (Prims.of_int (16))
                                  (Prims.of_int (184)) (Prims.of_int (47)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                 (Prims.of_int (190)) (Prims.of_int (19))
                 (Prims.of_int (190)) (Prims.of_int (35)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                 (Prims.of_int (190)) (Prims.of_int (3)) (Prims.of_int (197))
                 (Prims.of_int (9))))) (Obj.magic (arrow_of_abs g t))
        (fun uu___ ->
           (fun uu___ ->
              match uu___ with
              | (annot, t1) ->
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                ...
                                (Prims.of_int (191)) (Prims.of_int (88)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                (Prims.of_int (191)) (Prims.of_int (89))
                           ...
                           | FStar_Pervasives_Native.Some c ->
                               (match (c_computed, c) with
                                ...
                                | (Pulse_Syntax_Base.C_STGhost uu___1,
                                   Pulse_Syntax_Base.C_STGhost uu___2) ->
                                    FStar_Pervasives_Native.None
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                     ...
                     (Prims.of_int (278)) (Prims.of_int (7)))))
            (FStar_Tactics_Effect.lift_div_tac
               (fun uu___ ->
                  Prims.Mkdtuple2
  ...
  fun c ->
    fun nv ->
      ...
      Pulse_Syntax_Naming.subst_ascription c
        [Pulse_Syntax_Naming.DT (Prims.int_zero, t)]
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                   ...
                   (Prims.of_int (444)) (Prims.of_int (29)))))
          (FStar_Tactics_Effect.lift_div_tac
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  (Prims.of_int (330)) (Prims.of_int (24))
                                  (Prims.of_int (330)) (Prims.of_int (49)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                                  (Prims.of_int (328)) (Prims.of_int (99))
                                  (Prims.of_int (444)) (Prims.of_int (29)))))
                         (Obj.magic
      ...
      fun check ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
                   (Prims.of_int (448)) (Prims.of_int (10))
                   (Prims.of_int (448)) (Prims.of_int (28)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Abs.fst"
