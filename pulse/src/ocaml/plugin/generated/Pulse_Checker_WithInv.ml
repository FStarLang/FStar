...
let (inv_disjointness_goal :
  Pulse_Syntax_Base.range ->
    FStar_Tactics_NamedView.term ->
      FStar_Tactics_NamedView.term ->
        FStar_Tactics_NamedView.term -> Pulse_Syntax_Base.term)
  =
  fun r ->
    fun inv_p ->
      fun inames ->
        fun inv ->
          let p = Pulse_Reflection_Util.mk_mem_inv inv_p inames inv in
          let p1 =
            Pulse_Reflection_Util.mk_reveal Pulse_Syntax_Pure.u_zero
              Pulse_Reflection_Util.bool_tm p in
          Pulse_Syntax_Base.tm_fstar
            (Pulse_Reflection_Util.mk_eq2 Pulse_Syntax_Pure.u_zero
               Pulse_Reflection_Util.bool_tm
               (FStar_Reflection_V2_Builtins.pack_ln
                  (FStar_Reflection_V2_Data.Tv_Const
                     FStar_Reflection_V2_Data.C_False)) p1) r
          ...
          fun inv ->
            FStar_Tactics_Effect.tac_bind
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.WithInv.fst"
                       (Prims.of_int (71)) (Prims.of_int (13))
                       (Prims.of_int (71)) (Prims.of_int (46)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.WithInv.fst"
                       (Prims.of_int (71)) (Prims.of_int (49))
                       (Prims.of_int (90)) (Prims.of_int (3)))))
              (FStar_Tactics_Effect.lift_div_tac
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  ...
                                  (Prims.of_int (73)) (Prims.of_int (61)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "Pulse.Checker.WithInv.fst"
                                          ...
                                          (FStar_Tactics_Effect.tac_bind
                                             ...
                                             (Obj.magic
                                                (FStar_Tactics_V2_Builtins.print
                                                   "Checking disjointness of invariants ...\n"))
                                             (fun uu___2 ->
                                                (fun uu___2 ->
                                                   Obj.magic
                                                     (FStar_Tactics_Effect.tac_bind
                                                           ...
                                                           (fun tok ->
                                                              Obj.magic
                                                                (FStar_Tactics_Effect.tac_bind
                                                                   ...
                                                                   (Obj.magic
                                                                    (FStar_Tactics_V2_Builtins.print
                                                                    "Checked!!! disjointness of invariants ...\n"))
                                                                   (fun
                                                                    uu___3 ->
                                                                    (fun
                                                                    uu___3 ->
              ...
              fun check1 ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.WithInv.fst"
                           (Prims.of_int (101)) (Prims.of_int (52))
                           (Prims.of_int (101)) (Prims.of_int (58)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.WithInv.fst"
                           (Prims.of_int (100)) (Prims.of_int (46))
