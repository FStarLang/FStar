      ...
      (fun env ->
         fun e ->
           ...
           | FStarC_Extraction_ML_Syntax.MLE_App
               ...
               let uu___7 = FStarC_Extraction_Krml.translate_type env t in
               let uu___8 = FStarC_Extraction_Krml.translate_expr env e1 in
               FStarC_Extraction_Krml.generate_is_null uu___7 uu___8
           | FStarC_Extraction_ML_Syntax.MLE_App
               ({
                  FStarC_Extraction_ML_Syntax.expr =
                    FStarC_Extraction_ML_Syntax.MLE_TApp
           ...
           | FStarC_Extraction_ML_Syntax.MLE_App
               ...
               let uu___8 =
                 let uu___9 = FStarC_Extraction_Krml.translate_expr env x in
                 (uu___9, FStarC_Extraction_Krml.TAny) in
           ...
           | FStarC_Extraction_ML_Syntax.MLE_App
               ...
               let uu___7 =
                 let uu___8 = FStarC_Extraction_Krml.translate_expr env x in
                 let uu___9 =
                   let uu___10 = FStarC_Extraction_Krml.translate_type env t in
                   FStarC_Extraction_Krml.TBuf uu___10 in
                 (uu___8, uu___9) in
               FStarC_Extraction_Krml.ECast uu___7
           | FStarC_Extraction_ML_Syntax.MLE_App
               ({
                  FStarC_Extraction_ML_Syntax.expr =
                    FStarC_Extraction_ML_Syntax.MLE_TApp
               ...
               let uu___9 =
                 ...
                 (uu___10,
                   (FStarC_Extraction_Krml.EQualified
                      (["C"], "_zero_for_deref"))) in
               FStarC_Extraction_Krml.EBufRead uu___9
           | FStarC_Extraction_ML_Syntax.MLE_App
               ({
                  FStarC_Extraction_ML_Syntax.expr =
                    FStarC_Extraction_ML_Syntax.MLE_TApp
