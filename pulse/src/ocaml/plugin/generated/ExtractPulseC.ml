...
let (char_of_typechar :
  ...
  fun t ->
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Named ([], p) ->
        ...
        if p1 = "Pulse.C.Typestring.cdot"
        then FStar_Pervasives_Native.Some 46
        else
          if FStar_Compiler_Util.starts_with p1 "Pulse.C.Typestring.c"
          then
            (let uu___1 =
               FStar_Compiler_String.get p1
                 (FStar_String.strlen "Pulse.C.Typestring.c") in
  ...
  fun t ->
    let rec go t1 =
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named ([], p) when
          ...
          uu___ = "Pulse.C.Typestring.string_nil" ->
          FStar_Pervasives_Native.Some []
      | FStar_Extraction_ML_Syntax.MLTY_Named (c::t2::[], p) when
          let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___ = "Pulse.C.Typestring.string_cons" ->
      ...
      (fun env ->
         fun t ->
           ...
           | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
               ...
               uu___1 = "Pulse.C.Types.Array.array_ptr_gen" ->
               let uu___1 =
                 FStar_Extraction_Krml.translate_type_without_decay env arg in
               FStar_Extraction_Krml.TBuf uu___1
           | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
               let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___1 = "Pulse.C.Types.Base.ptr_gen" ->
               let uu___1 =
                 FStar_Extraction_Krml.translate_type_without_decay env arg in
               FStar_Extraction_Krml.TBuf uu___1
           | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
               let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___1 = "Pulse.C.Types.Scalar.scalar_t" ->
               FStar_Extraction_Krml.translate_type_without_decay env arg
           | FStar_Extraction_ML_Syntax.MLTY_Named ([], p) when
               (let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___1 = "Pulse.C.Types.Base.void_ptr") ||
                 (let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                  uu___1 = "Pulse.C.Types.Array.array_void_ptr")
               ->
           ...
           | FStar_Extraction_ML_Syntax.MLTY_Named (t1::n::s::[], p) when
               let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___1 = "Pulse.C.Types.Array.base_array_t" ->
               let uu___1 =
                 let uu___2 =
      ...
      (fun env ->
         fun t ->
           ...
           | FStar_Extraction_ML_Syntax.MLTY_Named
               ...
               uu___3 = "Pulse.C.Types.Array.base_array_t" ->
               let uu___3 =
                 FStar_Extraction_Krml.translate_type_without_decay env t1 in
         ...
         fun e ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               (let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___7 = "Pulse.C.Types.Base.alloc") || false
               ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               (let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___7 = "Pulse.C.Types.Array.array_ptr_alloc") || false
               ->
               let uu___7 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               (let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___9 = "Pulse.C.Types.Array.array_ref_free") || false
               ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               uu___8 = "Pulse.C.Types.Base.free" ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___8 = "Pulse.C.Types.Array.array_ptr_is_null" ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___7 = "Pulse.C.Types.Base.is_null" ->
               let uu___7 = FStar_Extraction_Krml.translate_type env t in
               let uu___8 = FStar_Extraction_Krml.translate_expr env e1 in
               FStar_Extraction_Krml.generate_is_null uu___7 uu___8
           | FStar_Extraction_ML_Syntax.MLE_App
               ({
                  FStar_Extraction_ML_Syntax.expr =
                    FStar_Extraction_ML_Syntax.MLE_TApp
               ...
               (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___6 = "Pulse.C.Types.Base.null_gen") ||
                 (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                  uu___6 = "Pulse.C.Types.Array.null_array_ptr")
               ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_TApp
               ...
               when
               let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___3 = "Pulse.C.Types.Base.null_gen" ->
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               ((let uu___13 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                 uu___13 = "Pulse.C.Types.Struct.struct_field0") ||
                  (let uu___13 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               uu___11 = "Pulse.C.Types.UserStruct.struct_field0" ->
               let uu___11 =
                 let uu___12 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___8 = "Pulse.C.Types.Scalar.read0" ->
               let uu___8 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___7 = "Pulse.C.Types.Scalar.write" ->
               let uu___7 =
                 let uu___8 =
                   let uu___9 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               uu___10 = "Pulse.C.Types.Base.copy" ->
               let uu___10 =
                 let uu___11 =
                   let uu___12 =
                     let uu___13 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___8 = "Pulse.C.Types.Base.void_ptr_of_ptr" ->
               let uu___8 =
                 let uu___9 = FStar_Extraction_Krml.translate_expr env x in
                 (uu___9, FStar_Extraction_Krml.TAny) in
               FStar_Extraction_Krml.ECast uu___8
           | FStar_Extraction_ML_Syntax.MLE_App
               ({
                  FStar_Extraction_ML_Syntax.expr =
                    FStar_Extraction_ML_Syntax.MLE_TApp
               ...
               when
               let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___7 = "Pulse.C.Types.Base.ptr_of_void_ptr" ->
               let uu___7 =
                 let uu___8 = FStar_Extraction_Krml.translate_expr env x in
                 let uu___9 =
                   let uu___10 = FStar_Extraction_Krml.translate_type env t in
                   FStar_Extraction_Krml.TBuf uu___10 in
                 (uu___8, uu___9) in
               FStar_Extraction_Krml.ECast uu___7
           | FStar_Extraction_ML_Syntax.MLE_App
               ({
                  FStar_Extraction_ML_Syntax.expr =
                    FStar_Extraction_ML_Syntax.MLE_TApp
               ...
               when
               let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___9 = "Pulse.C.Types.Array.array_ref_of_base" ->
               let uu___9 =
                 let uu___10 = FStar_Extraction_Krml.translate_expr env r in
                 (uu___10,
                   (FStar_Extraction_Krml.EQualified
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               when
               (let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu___9 = "Pulse.C.Types.Array.array_ref_cell") ||
                 (let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                  uu___9 = "Pulse.C.Types.Array.array_ref_split")
               ->
               let uu___9 =
           ...
           | FStar_Extraction_ML_Syntax.MLE_App
               ...
               uu___12 = "Pulse.C.Types.Array.array_blit_ptr" ->
               let uu___12 =
  ...
  fun env ->
    fun fields ->
      let rec go fields1 =
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named ([], p) when
            let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___ = "Pulse.C.Types.Fields.field_t_nil" ->
            FStar_Pervasives_Native.Some []
        | FStar_Extraction_ML_Syntax.MLTY_Named (field::t::fields2::[], p)
            when
            let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___ = "Pulse.C.Types.Fields.field_t_cons" ->
      ...
      (fun env ->
         fun ty ->
           ...
           | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
               ...
               when
               let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___8 = "Pulse.C.Types.Struct.define_struct0" ->
           ...
           | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
               ...
               when
               let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___8 = "Pulse.C.Types.Union.define_union0" ->
