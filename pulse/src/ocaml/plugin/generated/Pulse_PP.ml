      ...
      pp =
        (fun x ->
           FStar_Tactics_Effect.tac_bind
             (FStar_Sealed.seal
                (Obj.magic
                   (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (54))
                      (Prims.of_int (34)) (Prims.of_int (54))
                      (Prims.of_int (42)))))
             (FStar_Sealed.seal
                (Obj.magic
                   (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (54))
                      (Prims.of_int (17)) (Prims.of_int (54))
                      (Prims.of_int (42)))))
                          ...
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range "Pulse.PP.fst"
                                   (Prims.of_int (66)) (Prims.of_int (54))
                     ...
                     (Obj.repr
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.PP.fst"
                                    (Prims.of_int (75)) (Prims.of_int (13))
                                    (Prims.of_int (75)) (Prims.of_int (16)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.PP.fst"
                                    (Prims.of_int (75)) (Prims.of_int (13))
                                    (Prims.of_int (75)) (Prims.of_int (49)))))
                           (Obj.magic (f x))
                           (fun uu___ ->
                              (fun uu___ ->
                                 Obj.magic
      ...
      pp =
        (fun l ->
           FStar_Tactics_Effect.tac_bind
             (FStar_Sealed.seal
                (Obj.magic
                   (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (78))
                      (Prims.of_int (26)) (Prims.of_int (78))
                      (Prims.of_int (51)))))
             (FStar_Sealed.seal
                (Obj.magic
                   (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (78))
                      (Prims.of_int (17)) (Prims.of_int (78))
                      (Prims.of_int (51)))))
...
let (pp_record :
  ...
  fun flds ->
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (91))
               (Prims.of_int (4)) (Prims.of_int (91)) (Prims.of_int (104)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (93))
               (Prims.of_int (2)) (Prims.of_int (93)) (Prims.of_int (25)))))
      (Obj.magic
...
let (uu___53 : Pulse_Typing.post_hint_t printable) =
  {
    pp =
      (fun h ->
         FStar_Tactics_Effect.tac_bind
           (FStar_Sealed.seal
              (Obj.magic
                 (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (97))
                    (Prims.of_int (20)) (Prims.of_int (101))
                    (Prims.of_int (41)))))
           (FStar_Sealed.seal
              (Obj.magic
                 (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (97))
                    (Prims.of_int (10)) (Prims.of_int (101))
                    (Prims.of_int (41)))))
           (Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "Pulse.PP.fst"
                          ...
                          (Prims.of_int (97)) (Prims.of_int (33)))))
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "Pulse.PP.fst"
                          (Prims.of_int (97)) (Prims.of_int (20))
                          (Prims.of_int (101)) (Prims.of_int (41)))))
                 (Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
    ...
    pp =
      (fun t ->
         FStar_Tactics_Effect.tac_bind
           (FStar_Sealed.seal
              (Obj.magic
                 (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (106))
                    (Prims.of_int (31)) (Prims.of_int (106))
                    (Prims.of_int (60)))))
           (FStar_Sealed.seal
              (Obj.magic
                 (FStar_Range.mk_range "Pulse.PP.fst" (Prims.of_int (106))
                    (Prims.of_int (17)) (Prims.of_int (106))
                    (Prims.of_int (60)))))
