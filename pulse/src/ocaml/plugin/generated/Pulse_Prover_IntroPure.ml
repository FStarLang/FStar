              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Prover.IntroPure.fst"
                       ...
                       (Prims.of_int (24)) (Prims.of_int (31)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Prover.IntroPure.fst"
                       (Prims.of_int (24)) (Prims.of_int (34))
...
let rec (try_collect_substs :
  Pulse_Typing_Env.env ->
    Pulse_Syntax_Base.term ->
      (Pulse_Prover_Substs.ss_t, unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___1 ->
    fun uu___ ->
      (fun uvs ->
         fun t ->
                                                 ...
                                                 (FStar_Tactics_Effect.tac_bind
                                                    ...
                                                    (fun ss1 ->
                                                       FStar_Tactics_Effect.lift_div_tac
                                                         (fun uu___ ->
                                                            if
                                                              Pulse_Prover_Substs.check_disjoint
                                                                ss0 ss1
                                                            then
           ...
           | uu___ ->
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___1 -> Pulse_Prover_Substs.empty)))) uu___1
        uu___
let (intro_pure :
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "Pulse.Prover.IntroPure.fst"
                                  (Prims.of_int (130)) (Prims.of_int (2))
                                  (Prims.of_int (133)) (Prims.of_int (30)))))
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "Pulse.Prover.IntroPure.fst"
                                  (Prims.of_int (133)) (Prims.of_int (31))
                                  (Prims.of_int (261)) (Prims.of_int (14)))))
                         (Obj.magic
