            ...
            fun bc ->
              fun e1 ->
                fun e2 ->
                  ...
                  let t2 =
                    Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_res c2) in
                  match bc with
          ...
          fun e ->
            ...
            | Pulse_Typing.Lift_STAtomic_ST (uu___, uu___1) ->
                ...
                Pulse_Reflection_Util.mk_lift_atomic_stt
                  (Pulse_Elaborate_Pure.elab_universe
                     (Pulse_Syntax.comp_u c1))
                  (Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_res c1))
                  t
            ...
            | Pulse_Typing.Lift_STGhost_STAtomic
                ...
                Pulse_Reflection_Util.mk_lift_ghost_atomic
                  ...
                  (Pulse_Elaborate_Pure.elab_term
                     (Pulse_Syntax.comp_inames c1))
                  (Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_pre c1))
                  (Pulse_Reflection_Util.mk_abs t
                     FStar_Reflection_Data.Q_Explicit
                     (Pulse_Elaborate_Pure.elab_term
                        (Pulse_Syntax.comp_post c1))) e
        ...
        fun d ->
              ...
              let body1 =
                elab_st_typing
                  (Pulse_Typing.extend x
                     (FStar_Pervasives.Inl (b.Pulse_Syntax.binder_ty)) uu___)
          ...
          | Pulse_Typing.T_Bind
              ...
              let e21 =
                elab_st_typing
                  (Pulse_Typing.extend x
                     (FStar_Pervasives.Inl (Pulse_Syntax.comp_res c1)) uu___)
