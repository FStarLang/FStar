            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Rewrite.fst"
                     ...
                     (Prims.of_int (41)) (Prims.of_int (22)))))
            (FStar_Tactics_Effect.lift_div_tac
               (fun uu___ -> Pulse_Elaborate_Pure.elab_term p))
            (fun uu___ ->
               (fun elab_p ->
                  Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (31)) (Prims.of_int (15))
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (41)) (Prims.of_int (22)))))
                       (FStar_Tactics_Effect.lift_div_tac
                          (fun uu___ -> Pulse_Elaborate_Pure.elab_term q))
                       (fun uu___ ->
                          (fun elab_q ->
                             Obj.magic
                               (FStar_Tactics_Effect.tac_bind
                                  ...
                                  (Obj.magic
                                     (FStar_Tactics_V2_Builtins.check_equiv
                                        (Pulse_Typing.elab_env g) elab_p
                                        elab_q))
                                  (fun uu___ ->
                                     (fun uu___ ->
                                        match uu___ with
            ...
            fun t ->
              FStar_Tactics_Effect.tac_bind
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Rewrite.fst"
                         (Prims.of_int (83)) (Prims.of_int (51))
                         (Prims.of_int (89)) (Prims.of_int (116)))))
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
                        ...
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Rewrite.fst"
                                    (Prims.of_int (84)) (Prims.of_int (32))
