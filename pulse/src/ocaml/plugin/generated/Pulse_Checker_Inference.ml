...
let (contains_uvar_r_deep :
  ...
  fun t ->
    FStar_Tactics_Effect.tac_bind
      (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
         (Prims.of_int (355)) (Prims.of_int (6)) (Prims.of_int (357))
         (Prims.of_int (12)))
      (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
         (Prims.of_int (359)) (Prims.of_int (4)) (Prims.of_int (363))
         (Prims.of_int (21)))
      (FStar_Tactics_Effect.lift_div_tac
         (fun uu___1 ->
            fun uu___ ->
            ...
            Obj.magic
              (FStar_Tactics_Derived.or_else
                 (fun uu___ ->
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                         (Prims.of_int (361)) (Prims.of_int (18))
                         (Prims.of_int (361)) (Prims.of_int (38)))
                      (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
    ...
    (fun t ->
       ...
       | Pulse_Syntax_Base.Tm_Star (l, r) ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                      (Prims.of_int (386)) (Prims.of_int (9))
                      (Prims.of_int (386)) (Prims.of_int (24)))
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                      (Prims.of_int (386)) (Prims.of_int (6))
                      (Prims.of_int (387)) (Prims.of_int (26)))
       ...
       | Pulse_Syntax_Base.Tm_ExistsSL (u, t1, body) ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                      (Prims.of_int (390)) (Prims.of_int (9))
                      (Prims.of_int (390)) (Prims.of_int (34)))
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
             ...
             (Obj.repr
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                      ...
                      (Prims.of_int (394)) (Prims.of_int (34)))
                   (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                      (Prims.of_int (394)) (Prims.of_int (6))
                      (Prims.of_int (395)) (Prims.of_int (29)))
                   (Obj.magic (contains_uvar t1.Pulse_Syntax_Base.binder_ty))
                   (fun uu___ ->
                      (fun uu___ ->
                         if uu___
       ...
       | Pulse_Syntax_Base.Tm_FStar (t1, uu___) ->
           Obj.magic
             (Obj.repr
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___1 -> contains_uvar_r t1)))) uu___
let (try_unify :
  Pulse_Typing_Env.env ->
    Pulse_Syntax_Base.term ->
      Pulse_Syntax_Base.term ->
      ...
      (fun g ->
         fun p ->
           let rec aux sol t =
             FStar_Tactics_Effect.tac_bind
               (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                  (Prims.of_int (419)) (Prims.of_int (12))
                  (Prims.of_int (419)) (Prims.of_int (27)))
               (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
               ...
               (fun uu___ ->
                  (fun t1 ->
                     Obj.magic
                       (FStar_Tactics_Effect.tac_bind
                          (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                             (Prims.of_int (420)) (Prims.of_int (12))
                             (Prims.of_int (420)) (Prims.of_int (33)))
                          (FStar_Range.mk_range "Pulse.Checker.Inference.fst"
                             (Prims.of_int (420)) (Prims.of_int (36))
                             (Prims.of_int (437)) (Prims.of_int (16)))
                          (Obj.magic
