          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Prover.Substs.fst"
                   (Prims.of_int (292)) (Prims.of_int (10))
                   (Prims.of_int (292)) (Prims.of_int (63)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.Prover.Substs.fst"
                   (Prims.of_int (293)) (Prims.of_int (2))
                   (Prims.of_int (317)) (Prims.of_int (66)))))
          (Obj.magic
             (FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.Substs.fst"
                         (Prims.of_int (292)) (Prims.of_int (47))
                         (Prims.of_int (292)) (Prims.of_int (63)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.Substs.fst"
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     ...
                                     (Prims.of_int (300)) (Prims.of_int (26))
                                     (Prims.of_int (300)) (Prims.of_int (44)))))
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "Pulse.Checker.Prover.Substs.fst"
