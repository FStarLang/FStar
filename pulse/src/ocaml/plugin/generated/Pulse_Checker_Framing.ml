      ...
      (Obj.magic
         (FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     (Prims.of_int (20)) (Prims.of_int (26))
                     (Prims.of_int (20)) (Prims.of_int (54)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     (Prims.of_int (20)) (Prims.of_int (4))
                     (Prims.of_int (20)) (Prims.of_int (55)))))
            (Obj.magic
  ...
  fun ff ->
    FStar_Tactics_Effect.tac_bind
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
               (Prims.of_int (23)) (Prims.of_int (2)) (Prims.of_int (25))
               (Prims.of_int (40)))))
  ...
  fun t ->
    ...
    | Pulse_Syntax_Base.Tm_FStar (host_term, uu___) ->
        (match FStar_Reflection_V2_Builtins.inspect_ln host_term with
         | FStar_Reflection_V2_Data.Tv_Match (uu___1, uu___2, uu___3) -> true
         | uu___1 -> false)
    | uu___ -> false
let (check_one_vprop :
  Pulse_Typing_Env.env ->
        ...
        fun req ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     (Prims.of_int (139)) (Prims.of_int (18))
                     (Prims.of_int (139)) (Prims.of_int (39)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     (Prims.of_int (139)) (Prims.of_int (42))
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     ...
                     (Prims.of_int (216)) (Prims.of_int (40)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                     (Prims.of_int (216)) (Prims.of_int (2))
                     (Prims.of_int (242)) (Prims.of_int (54)))))
