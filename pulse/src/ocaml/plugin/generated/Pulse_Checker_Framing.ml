                     ...
                     (Obj.repr
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                              ...
                              (Prims.of_int (154)) (Prims.of_int (39)))
                           (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                   ...
                   Obj.magic
                     (Obj.repr
                        (FStar_Tactics_Effect.tac_bind
                           ...
                           (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
                              (Prims.of_int (212)) (Prims.of_int (6))
                              (Prims.of_int (235)) (Prims.of_int (30)))
    ...
    fun ctxt ->
      fun ctxt_typing ->
        fun req ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
               (Prims.of_int (245)) (Prims.of_int (18)) (Prims.of_int (245))
               (Prims.of_int (36)))
            (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
               (Prims.of_int (245)) (Prims.of_int (39)) (Prims.of_int (273))
               (Prims.of_int (47)))
            (FStar_Tactics_Effect.lift_div_tac
    ...
    fun vp1 ->
      fun vp2 ->
        fun vp1_typing ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
               (Prims.of_int (298)) (Prims.of_int (8)) (Prims.of_int (298))
               (Prims.of_int (40)))
            (FStar_Range.mk_range "Pulse.Checker.Framing.fst"
               (Prims.of_int (298)) (Prims.of_int (2)) (Prims.of_int (324))
                      ...
                      Obj.magic
                        (Obj.repr
                           (FStar_Tactics_Effect.tac_bind
                              (FStar_Range.mk_range
                                 "Pulse.Checker.Framing.fst"
                                 (Prims.of_int (300)) (Prims.of_int (11))
                                 (Prims.of_int (304)) (Prims.of_int (94)))
                              (FStar_Range.mk_range
                                 "Pulse.Checker.Framing.fst"
