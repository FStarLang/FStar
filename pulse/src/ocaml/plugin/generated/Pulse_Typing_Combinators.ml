                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (218)) (Prims.of_int (83)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "Pulse.Typing.Combinators.fst"
                                (Prims.of_int (219)) (Prims.of_int (2))
                                (Prims.of_int (223)) (Prims.of_int (10)))))
                       (Obj.magic
        ...
        fun d ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
                     (Prims.of_int (227)) (Prims.of_int (10))
                     (Prims.of_int (227)) (Prims.of_int (33)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
        ...
        fun post_hint ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
                     (Prims.of_int (403)) (Prims.of_int (13))
                     (Prims.of_int (403)) (Prims.of_int (31)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
                     (Prims.of_int (404)) (Prims.of_int (4))
                     (Prims.of_int (426)) (Prims.of_int (7)))))
            (FStar_Tactics_Effect.lift_div_tac
