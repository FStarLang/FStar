                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (220)) (Prims.of_int (83)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "Pulse.Typing.Combinators.fst"
        ...
        fun post_hint ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
                     (Prims.of_int (424)) (Prims.of_int (13))
                     (Prims.of_int (424)) (Prims.of_int (31)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Combinators.fst"
                     (Prims.of_int (425)) (Prims.of_int (4))
                     (Prims.of_int (447)) (Prims.of_int (7)))))
            (FStar_Tactics_Effect.lift_div_tac
