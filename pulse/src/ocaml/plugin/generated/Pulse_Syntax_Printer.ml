                             ...
                             let uu___2 =
                               ...
                               FStar_Tactics_Effect.tac_bind
                                 ...
                                 (fun uu___4 ->
                                    FStar_Tactics_Effect.lift_div_tac
                                      (fun uu___5 ->
                                         uu___4 (qual_to_string arg_qual))) in
                             Obj.magic
                               (FStar_Tactics_Effect.tac_bind
                                  (FStar_Sealed.seal
                                     (Obj.magic
                     ...
                     FStar_Tactics_Effect.tac_bind
                       ...
                       (fun uu___1 ->
                          (fun uu___1 ->
                             let uu___2 =
                               let uu___3 =
                                 st_term_to_string' (indent level) body in
                               FStar_Tactics_Effect.tac_bind
                                 (FStar_Sealed.seal
                                    (Obj.magic
                                       (FStar_Range.mk_range
                       ...
                       (fun uu___1 ->
                          (fun uu___1 ->
                             let uu___2 =
                               let uu___3 =
                                 let uu___4 =
                                   term_to_string' (indent level) p in
                                 FStar_Tactics_Effect.tac_bind
                                   (FStar_Sealed.seal
                                      (Obj.magic
                                         (FStar_Range.mk_range
                                 ...
                                 FStar_Tactics_Effect.tac_bind
                                   ...
                                   (fun uu___5 ->
                                      (fun uu___5 ->
                                         let uu___6 =
                                           let uu___7 =
                                             term_to_string initializer1 in
                                           FStar_Tactics_Effect.tac_bind
                                             (FStar_Sealed.seal
                                                (Obj.magic
                                                   (FStar_Range.mk_range
