      ...
      (fun preamble ->
         fun pst ->
           ...
           | uu___ ->
               Obj.magic
                 (Obj.repr
                    (Pulse_Typing_Env.fail pst.Pulse_Checker_Prover_Base.pg
    ...
    fun pst0 ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                 (Prims.of_int (111)) (Prims.of_int (2)) (Prims.of_int (114))
                 (Prims.of_int (55)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                 (Prims.of_int (116)) (Prims.of_int (2)) (Prims.of_int (155))
                 (Prims.of_int (32)))))
        (Obj.magic
                          ...
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range
                                   ...
                                   (Prims.of_int (119)) (Prims.of_int (45)))))
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range
                                   "Pulse.Checker.Prover.fst"
            ...
            fun goals_typing ->
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         (Prims.of_int (179)) (Prims.of_int (2))
                         (Prims.of_int (181)) (Prims.of_int (55)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         (Prims.of_int (181)) (Prims.of_int (56))
                         (Prims.of_int (244)) (Prims.of_int (97)))))
                (Obj.magic
                         ...
                         FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                                    (Prims.of_int (181)) (Prims.of_int (30))
                                    (Prims.of_int (181)) (Prims.of_int (54)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                        ...
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                                    (Prims.of_int (183)) (Prims.of_int (15))
                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                           ...
                           (Prims.of_int (255)) (Prims.of_int (50)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                           (Prims.of_int (252)) (Prims.of_int (42))
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         ...
                         (Prims.of_int (298)) (Prims.of_int (32)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         (Prims.of_int (300)) (Prims.of_int (2))
                         (Prims.of_int (300)) (Prims.of_int (37)))))
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
