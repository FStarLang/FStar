...
type env =
  {
  uenv_inner: PulseExtract_CompilerLib.uenv ;
  coreenv: Pulse_Typing_Env.env }
let (__proj__Mkenv__item__uenv_inner : env -> PulseExtract_CompilerLib.uenv)
  =
  fun projectee ->
...
let (uenv_of_env : env -> PulseExtract_CompilerLib.uenv) =
  fun g ->
    PulseExtract_CompilerLib.set_tcenv g.uenv_inner
      (Pulse_Typing.elab_env g.coreenv)
let (term_as_mlexpr :
  env ->
    Pulse_Syntax_Base.term ->
      (PulseExtract_CompilerLib.mlexpr, unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___1 ->
    fun uu___ ->
      (fun g ->
         fun t ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ ->
                   match PulseExtract_CompilerLib.term_as_mlexpr
...
let (term_as_mlty :
  env ->
    Pulse_Syntax_Base.term ->
      (PulseExtract_CompilerLib.mlty, unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___1 ->
    fun uu___ ->
      (fun g ->
         fun t ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ ->
                   PulseExtract_CompilerLib.term_as_mlty (uenv_of_env g)
                     (Pulse_Elaborate_Pure.elab_term t)))) uu___1 uu___
let (extend_env :
  env ->
    Pulse_Syntax_Base.binder ->
      ((env * PulseExtract_CompilerLib.mlident *
         PulseExtract_CompilerLib.mlty * name),
  ...
  fun g ->
    fun b ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "PulseExtract.Main.fst"
                                    ...
                                    Obj.magic
                                      (FStar_Tactics_Effect.tac_bind
                                         ...
                                         (fun uu___ ->
                                            FStar_Tactics_Effect.lift_div_tac
                                              (fun uu___1 ->
                                                 match PulseExtract_CompilerLib.extend_bv
                                                         g.uenv_inner
                                                         b.Pulse_Syntax_Base.binder_ppname
                                                         x mlty
                                                 with
...
let rec (extract :
  env ->
    Pulse_Syntax_Base.st_term ->
      ((PulseExtract_CompilerLib.mlexpr * PulseExtract_CompilerLib.e_tag),
        unit) FStar_Tactics_Effect.tac_repr)
  =
  fun g ->
    fun p ->
                                      ...
                                      (fun uu___2 ->
                                         FStar_Tactics_Effect.lift_div_tac
                                           (fun uu___3 ->
                                              match uu___2 with
                                              | (body2, uu___4) ->
                                                  ((PulseExtract_CompilerLib.mle_fun
                                                      [(mlident, mlty)] body2),
                                                    PulseExtract_CompilerLib.e_tag_pure)))))
                                uu___2))) uu___1)
      | Pulse_Syntax_Base.Tm_Return
          ...
          FStar_Tactics_Effect.tac_bind
            ...
            (fun uu___2 ->
               FStar_Tactics_Effect.lift_div_tac
                 (fun uu___3 -> (uu___2, PulseExtract_CompilerLib.e_tag_pure)))
                  ...
                  Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                       ...
                       (fun arg1 ->
                          FStar_Tactics_Effect.lift_div_tac
                            (fun uu___1 ->
                               ((PulseExtract_CompilerLib.mle_app head1
                                   [arg1]),
                                 PulseExtract_CompilerLib.e_tag_impure)))))
                 uu___1)
                                                     ...
                                                     (fun uu___3 ->
                                                        FStar_Tactics_Effect.lift_div_tac
                                                          (fun uu___4 ->
                                                             ...
                                                             | (body2,
                                                                uu___5) ->
                                                                 ((PulseExtract_CompilerLib.mle_let
                                                                    (PulseExtract_CompilerLib.mk_mlletbinding
                                                                    false
                                                                    [
                                                                    PulseExtract_CompilerLib.mk_mllb
                                                                    mlident
                                                                    ([],
                                                                    mlty)
                                                                    head1])
...
let (extract_pulse :
  PulseExtract_CompilerLib.uenv ->
    Pulse_Syntax_Base.st_term ->
      (((PulseExtract_CompilerLib.mlexpr * PulseExtract_CompilerLib.e_tag *
          PulseExtract_CompilerLib.mlty),
                               ...
                               (extract
                                  {
                                    uenv_inner = g;
                                    coreenv =
                                      (PulseExtract_CompilerLib.initial_core_env
                                         g)
                                  } p))
                            (fun uu___2 ->
                               (fun uu___2 ->
                                                 ...
                                                 (FStar_Tactics_Effect.lift_div_tac
                                                    (fun uu___3 ->
                                                       Prims.strcat
                                                         "Extracted term: "
                                                         (Prims.strcat
                                                            (PulseExtract_CompilerLib.mlexpr_to_string
                                                               tm) "\n")))
                                                 (fun uu___3 ->
                                                    (fun uu___3 ->
                                                       Obj.magic
                                              ...
                                              FStar_Tactics_Effect.lift_div_tac
                                                (fun uu___4 ->
                                                   FStar_Pervasives.Inl
                                                     (tm, tag,
                                                       PulseExtract_CompilerLib.mlty_top)))))
                                 uu___2))
                   (fun uu___1 ->
                      (fun uu___1 ->
                         Obj.magic
