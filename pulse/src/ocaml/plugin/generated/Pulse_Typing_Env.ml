        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                 ...
                 (Prims.of_int (234)) (Prims.of_int (37)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                 (Prims.of_int (236)) (Prims.of_int (4)) (Prims.of_int (240))
                 (Prims.of_int (101)))))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              fun uu___ ->
    ...
    fun i ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                 (Prims.of_int (244)) (Prims.of_int (24))
                 (Prims.of_int (244)) (Prims.of_int (49)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                 (Prims.of_int (244)) (Prims.of_int (5)) (Prims.of_int (244))
                 (Prims.of_int (49)))))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                   ...
                   (Prims.of_int (264)) (Prims.of_int (31)))))
          (match r with
                     ...
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                              ...
                              (Prims.of_int (261)) (Prims.of_int (65)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                              (Prims.of_int (261)) (Prims.of_int (68))
                              (Prims.of_int (264)) (Prims.of_int (31)))))
                     (Obj.magic
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                    (Prims.of_int (261)) (Prims.of_int (48))
                                    (Prims.of_int (261)) (Prims.of_int (65)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "prims.fst"
