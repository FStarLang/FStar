  ...
  fun e ->
                ...
                | ((n, t), x) ->
                    let uu___3 =
                      ...
                      FStar_Tactics_Effect.tac_bind
                        ...
                        (fun uu___5 ->
                           FStar_Tactics_Effect.lift_div_tac
                             (fun uu___6 -> FStar_Pprint.doc_of_string uu___5)) in
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                      ...
                      (fun uu___4 ->
                         (fun uu___4 ->
                            let uu___5 =
                              let uu___6 = Pulse_Syntax_Printer.term_to_doc t in
                              FStar_Tactics_Effect.tac_bind
                                (FStar_Sealed.seal
                                   (Obj.magic
                                      (FStar_Range.mk_range
                                ...
                                (fun uu___7 ->
                                   FStar_Tactics_Effect.lift_div_tac
                                     (fun uu___8 -> FStar_Pprint.align uu___7)) in
                            Obj.magic
                              (FStar_Tactics_Effect.tac_bind
                                 (FStar_Sealed.seal
                                    (Obj.magic
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun pp1 ->
            let uu___1 =
              let uu___2 = FStar_Tactics_Util.zip e.bs e.names in
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                ...
                (fun uu___3 ->
                   (fun uu___3 ->
                      Obj.magic (separate_map FStar_Pprint.comma pp1 uu___3))
                     uu___3) in
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
                 ...
                 (fun uu___2 ->
                    FStar_Tactics_Effect.lift_div_tac
                      (fun uu___3 -> FStar_Pprint.brackets uu___2)))) uu___1)
let (get_range :
  env ->
                  ...
                  let uu___1 =
                    ...
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                               (Prims.of_int (395)) (Prims.of_int (19))
                               (Prims.of_int (395)) (Prims.of_int (47)))))
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                               (Prims.of_int (395)) (Prims.of_int (50))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                   ...
                   (Prims.of_int (419)) (Prims.of_int (45)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                   (Prims.of_int (420)) (Prims.of_int (2))
                   (Prims.of_int (422)) (Prims.of_int (3)))))
          (Obj.magic uu___)
          (fun uu___1 ->
             (fun indent ->
                let uu___1 =
                    ...
                    let uu___3 =
                      let uu___4 =
                        ...
                        FStar_Tactics_Effect.tac_bind
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                   (Prims.of_int (421)) (Prims.of_int (54))
                                   (Prims.of_int (421)) (Prims.of_int (68)))))
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                   (Prims.of_int (421)) (Prims.of_int (47))
                                   (Prims.of_int (421)) (Prims.of_int (68)))))
                          (Obj.magic uu___5)
                          (fun uu___6 ->
                             FStar_Tactics_Effect.lift_div_tac
                      ...
                      FStar_Tactics_Effect.tac_bind
                        ...
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                 (Prims.of_int (421)) (Prims.of_int (5))
                                 (Prims.of_int (421)) (Prims.of_int (68)))))
                        (Obj.magic uu___4)
                        (fun uu___5 ->
                           FStar_Tactics_Effect.lift_div_tac
                      ...
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                               ...
                               (Prims.of_int (421)) (Prims.of_int (69)))))
                      (Obj.magic uu___3)
                      (fun uu___4 ->
                         FStar_Tactics_Effect.lift_div_tac
                  ...
                  FStar_Tactics_Effect.tac_bind
                    ...
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                             (Prims.of_int (420)) (Prims.of_int (15))
                             (Prims.of_int (422)) (Prims.of_int (3)))))
                    (Obj.magic uu___2)
                    (fun uu___3 ->
                       FStar_Tactics_Effect.lift_div_tac
