  ...
  fun g ->
    fun t0 ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (85))
           (Prims.of_int (23)) (Prims.of_int (104)) (Prims.of_int (89)))
        (FStar_Tactics_Effect.lift_div_tac
              ...
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   ...
                   (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                      ...
                      (Prims.of_int (104)) (Prims.of_int (89)))
                   (FStar_Tactics_Effect.lift_div_tac
                                          ...
                                          (FStar_Tactics_Effect.tac_bind
                                             ...
                                             (Obj.magic
                                                (FStar_Tactics_Builtins.print
                                                   (Prims.strcat
                                                      (Prims.strcat
                                                         "instantiate_term_implicits (Some? res = "
                                                         (Prims.strcat
      ...
      fun e ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (210))
             (Prims.of_int (23)) (Prims.of_int (210)) (Prims.of_int (117)))
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (210))
    ...
    fun e ->
      fun t ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (237))
             (Prims.of_int (24)) (Prims.of_int (250)) (Prims.of_int (65)))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ -> Pulse_Typing.elab_env g))
          (fun uu___ ->
             (fun fg ->
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                        ...
                        (Prims.of_int (250)) (Prims.of_int (65)))
                     (FStar_Tactics_Effect.lift_div_tac
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (257))
           (Prims.of_int (4)) (Prims.of_int (257)) (Prims.of_int (84)))
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (254))
           (Prims.of_int (46)) (Prims.of_int (258)) (Prims.of_int (21)))
        (Obj.magic
           (check_term_with_expected_type
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (265))
           (Prims.of_int (17)) (Prims.of_int (265)) (Prims.of_int (112)))
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (266))
           (Prims.of_int (2)) (Prims.of_int (266)) (Prims.of_int (12)))
        (Obj.magic
           (core_check_term_with_expected_type
...
let (get_non_informative_witness :
  ...
  fun g ->
    fun u ->
      fun t ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (271))
             (Prims.of_int (8)) (Prims.of_int (272)) (Prims.of_int (52)))
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (272))
             (Prims.of_int (55)) (Prims.of_int (298)) (Prims.of_int (16)))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ ->
                fun uu___1 ->
                  FStar_Tactics_Effect.tac_bind
                    (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                       (Prims.of_int (271)) (Prims.of_int (20))
                       (Prims.of_int (272)) (Prims.of_int (52)))
                    (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
...
let (check_prop_validity :
  ...
  fun g ->
    fun p ->
      fun uu___ ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (302))
             (Prims.of_int (24)) (Prims.of_int (302)) (Prims.of_int (76)))
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (302))
             (Prims.of_int (3)) (Prims.of_int (307)) (Prims.of_int (20)))
          (Obj.magic
                           ...
                           (Obj.repr
                              (FStar_Tactics_Effect.tac_bind
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (306)) (Prims.of_int (46)))
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Pure.fst"
