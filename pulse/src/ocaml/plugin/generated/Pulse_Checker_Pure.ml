    ...
    fun i ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (76))
           (Prims.of_int (6)) (Prims.of_int (86)) (Prims.of_int (63)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              fun uu___ ->
                (fun uu___ ->
  ...
  fun g ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (93))
           (Prims.of_int (23)) (Prims.of_int (107)) (Prims.of_int (84)))
        (FStar_Tactics_Effect.lift_div_tac
              ...
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   ...
                   (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                      ...
                      (Prims.of_int (107)) (Prims.of_int (84)))
                   (FStar_Tactics_Effect.lift_div_tac
  ...
  fun g ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (111))
           (Prims.of_int (25)) (Prims.of_int (128)) (Prims.of_int (34)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> Pulse_Typing.elab_env g))
        (fun uu___ ->
           (fun f ->
  ...
  fun g ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (147))
           (Prims.of_int (26)) (Prims.of_int (166)) (Prims.of_int (24)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> Pulse_Typing.elab_env g))
        (fun uu___ ->
           (fun fg ->
  ...
  fun g ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (175))
           (Prims.of_int (26)) (Prims.of_int (190)) (Prims.of_int (32)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> Pulse_Typing.elab_env g))
        (fun uu___ ->
           (fun fg ->
      ...
      fun t ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (194))
             (Prims.of_int (35)) (Prims.of_int (208)) (Prims.of_int (74)))
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                            ...
                            (Prims.of_int (208)) (Prims.of_int (74)))
                         (FStar_Tactics_Effect.lift_div_tac
  ...
  fun f ->
    fun e ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (212))
           (Prims.of_int (3)) (Prims.of_int (216)) (Prims.of_int (71)))
  ...
  fun g ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (221))
           (Prims.of_int (26)) (Prims.of_int (236)) (Prims.of_int (23)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> Pulse_Typing.elab_env g))
        (fun uu___ ->
           (fun fg ->
    ...
    fun e ->
      fun t ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (239))
             (Prims.of_int (24)) (Prims.of_int (248)) (Prims.of_int (65)))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ -> Pulse_Typing.elab_env g))
          (fun uu___ ->
             (fun fg ->
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (FStar_Range.mk_range "Pulse.Checker.Pure.fst"
                        ...
                        (Prims.of_int (248)) (Prims.of_int (65)))
                     (FStar_Tactics_Effect.lift_div_tac
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (252))
           (Prims.of_int (46)) (Prims.of_int (255)) (Prims.of_int (21)))
      ...
      fun t ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Range.mk_range "Pulse.Checker.Pure.fst" (Prims.of_int (269))
             (Prims.of_int (55)) (Prims.of_int (290)) (Prims.of_int (16)))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ ->
                fun uu___1 ->
                  FStar_Tactics_Effect.tac_bind
