                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Par.fst"
                           ...
                           (Prims.of_int (27)) (Prims.of_int (44)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Par.fst"
                           (Prims.of_int (27)) (Prims.of_int (47))
                           (Prims.of_int (58)) (Prims.of_int (50)))))
                             ...
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                                      ...
                                      (Prims.of_int (29)) (Prims.of_int (50))
                                      (Prims.of_int (29)) (Prims.of_int (56)))))
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                                      "Pulse.Checker.Par.fst"
