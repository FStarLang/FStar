          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Prover.Match.fst"
                   ...
                   (Prims.of_int (88)) (Prims.of_int (61)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Prover.Match.fst"
                   (Prims.of_int (88)) (Prims.of_int (64))
                   (Prims.of_int (146)) (Prims.of_int (31)))))
          (FStar_Tactics_Effect.lift_div_tac
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (167)) (Prims.of_int (39)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Prover.Match.fst"
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (186)) (Prims.of_int (31)))))
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Prover.Match.fst"
                         ...
                         (Prims.of_int (356)) (Prims.of_int (27)))))
                (Obj.magic
              ...
              fun uu___ ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Prover.Match.fst"
                           (Prims.of_int (367)) (Prims.of_int (11))
                           (Prims.of_int (367)) (Prims.of_int (21)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Prover.Match.fst"
                           (Prims.of_int (368)) (Prims.of_int (52))
                          ...
                          (FStar_Tactics_Effect.tac_bind
                             ...
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                                      "Pulse.Prover.Match.fst"
                                      (Prims.of_int (372)) Prims.int_zero
                                      (Prims.of_int (430))
                                      (Prims.of_int (11)))))
                             (Obj.magic
