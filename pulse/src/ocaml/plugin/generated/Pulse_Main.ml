        ...
        fun r ->
          fun impl ->
            ...
            | (checked, se1, blob) ->
                let se2 =
                  let uu___1 =
                    Pulse_Extract_CompilerLib.mk_extracted_as_attr impl in
                  Pulse_RuntimeUtils.add_attribute se1 uu___1 in
                (checked, se2, blob)
let (check_fndefn :
          ...
          fun pre_typing ->
            ...
            FStar_Tactics_Effect.tac_bind
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Main.fst"
                       (Prims.of_int (73)) (Prims.of_int (20))
                       (Prims.of_int (73)) (Prims.of_int (23)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Main.fst"
                       (Prims.of_int (70)) Prims.int_one (Prims.of_int (183))
                        ...
                        Obj.magic
                          (FStar_Tactics_Effect.tac_bind
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range "Pulse.Main.fst"
                                      (Prims.of_int (74)) (Prims.of_int (16))
                                      (Prims.of_int (74)) (Prims.of_int (43)))))
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range "Pulse.Main.fst"
                                      (Prims.of_int (74)) (Prims.of_int (46))
  ...
  fun d ->
    fun g ->
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (190))
                 (Prims.of_int (32)) (Prims.of_int (190)) (Prims.of_int (35)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (189))
                 Prims.int_one (Prims.of_int (228)) (Prims.of_int (29)))))
        (Obj.magic uu___)
        (fun uu___1 ->
           (fun uu___1 ->
              match uu___1 with
                  ...
                  Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Main.fst"
                                (Prims.of_int (191)) (Prims.of_int (2))
                                (Prims.of_int (192)) (Prims.of_int (62)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Main.fst"
                                (Prims.of_int (192)) (Prims.of_int (63))
                                (Prims.of_int (228)) (Prims.of_int (29)))))
                       (Obj.magic uu___2)
                       (fun uu___3 ->
                          (fun uu___3 ->
                             let uu___4 =
...
let (join_smt_goals : unit -> (unit, unit) FStar_Tactics_Effect.tac_repr) =
  fun uu___ ->
    let uu___1 =
      let uu___2 =
        ...
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (253))
                   (Prims.of_int (23)) (Prims.of_int (253))
                   (Prims.of_int (35)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (253))
                   (Prims.of_int (5)) (Prims.of_int (253))
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (253))
                 (Prims.of_int (5)) (Prims.of_int (253)) (Prims.of_int (48)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (253))
                 (Prims.of_int (2)) (Prims.of_int (254)) (Prims.of_int (35)))))
        (Obj.magic uu___2)
        (fun uu___3 ->
           (fun uu___3 ->
              if uu___3
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (254))
               (Prims.of_int (36)) (Prims.of_int (275)) (Prims.of_int (4)))))
      (Obj.magic uu___1)
      (fun uu___2 ->
         (fun uu___2 ->
                 ...
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "Pulse.Main.fst"
                          ...
                          (Prims.of_int (257)) (Prims.of_int (30)))))
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "Pulse.Main.fst"
                       ...
                       let uu___4 =
                         ...
                         FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Main.fst"
                                    (Prims.of_int (258)) (Prims.of_int (12))
...
let (parse_guard_policy :
  Prims.string ->
    (FStarC_Tactics_Types.guard_policy, unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___ ->
    (fun s ->
       match s with
       | "Goal" ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ -> FStarC_Tactics_Types.Goal))
       | "SMT" ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ -> FStarC_Tactics_Types.SMT))
       | "SMTSync" ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ -> FStarC_Tactics_Types.SMTSync))
       | "Force" ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ -> FStarC_Tactics_Types.Force))
       | "ForceSMT" ->
           Obj.magic
             (FStar_Tactics_Effect.lift_div_tac
                (fun uu___ -> FStarC_Tactics_Types.ForceSMT))
       | uu___ ->
           Obj.magic
        ...
        | (g, expected_t) ->
            let uu___1 =
              FStarC_Tactics_V2_Builtins.set_guard_policy
                FStarC_Tactics_Types.ForceSMT in
            FStar_Tactics_Effect.tac_bind
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Main.fst"
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Main.fst"
                       ...
                       (Prims.of_int (305)) (Prims.of_int (5)))))
              (Obj.magic uu___1)
              (fun uu___2 ->
                 (fun uu___2 ->
                    let uu___3 =
                      ...
                      FStar_Tactics_Effect.tac_bind
                        ...
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "Pulse.Main.fst"
                                 (Prims.of_int (295)) (Prims.of_int (2))
                                 (Prims.of_int (296)) (Prims.of_int (73)))))
                        (Obj.magic uu___4)
                        (fun uu___5 ->
                           (fun uu___5 ->
                              if uu___5
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range "Pulse.Main.fst"
                                  (Prims.of_int (296)) (Prims.of_int (74))
                                  (Prims.of_int (305)) (Prims.of_int (5)))))
                         (Obj.magic uu___3)
                         (fun uu___4 ->
                            (fun uu___4 ->
    ...
    fun uu___ ->
      ...
      | (env, expected_t) ->
          let uu___1 =
            let uu___2 =
              let uu___3 =
                FStarC_Tactics_V2_Builtins.ext_getv "pulse:dump_on_failure" in
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Main.fst"
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Main.fst"
                         (Prims.of_int (311)) (Prims.of_int (9))
                         (Prims.of_int (311)) (Prims.of_int (48)))))
                (Obj.magic uu___3)
                (fun uu___4 ->
                   FStar_Tactics_Effect.lift_div_tac
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Main.fst"
                       ...
                       (Prims.of_int (312)) (Prims.of_int (33)))))
              (Obj.magic uu___2)
              (fun uu___3 ->
                 (fun uu___3 ->
                    if uu___3
          ...
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (311))
                     (Prims.of_int (6)) (Prims.of_int (312))
                     (Prims.of_int (33)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (313))
                     (Prims.of_int (6)) (Prims.of_int (329))
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Main.fst"
                                ...
                                (Prims.of_int (329)) (Prims.of_int (36)))))
                       (Obj.magic uu___3)
                       (fun uu___4 ->
                          (fun uu___4 ->
                             match uu___4 with
                ...
                fun uu___ ->
                  ...
                  | (env, expected_t) ->
                      check_pulse_core
                        ...
                        (env, expected_t)
let _ =
  FStarC_Tactics_Native.register_tactic "Pulse.Main.check_pulse"
    (Prims.of_int (9))
    (fun psc ->
       fun ncb ->
         fun us ->
