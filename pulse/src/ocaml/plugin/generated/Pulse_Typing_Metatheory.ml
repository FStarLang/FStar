              ...
              fun e1 ->
                fun c1 ->
                  fun e1_typing ->
                    ...
                    | Pulse_Typing.T_Equiv (uu___, e2, c, c', d_e, uu___1) ->
                        Pulse_Typing.T_Equiv
                          ((Pulse_Typing_Env.push_env g
                              (subst_env g' (nt x e))),
                            (Pulse_Syntax_Naming.subst_st_term e2 ss),
                        ...
                        Pulse_Typing.T_While
                          ((Pulse_Typing_Env.push_env g
                            ...
                            (st_typing_subst g x t g' e () body
                               ...
                               body_typing))
                    | Pulse_Typing.T_Par
                        (uu___, eL, cL, eR, cR, y, uu___1, uu___2, d_eL,
                         d_eR)
                        ->
                        Pulse_Typing.T_Par
                          ((Pulse_Typing_Env.push_env g
                    ...
                    | Pulse_Typing.T_Admit (uu___, s, c, uu___1) ->
                        Pulse_Typing.T_Admit
                          ((Pulse_Typing_Env.push_env g
                              (subst_env g' (nt x e))),
