  ...
  fun p ->
    let uu___ =
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Syntax.Base.fsti"
                   (Prims.of_int (417)) (Prims.of_int (32))
                   (Prims.of_int (417)) (Prims.of_int (47)))))
          (FStar_Sealed.seal
             (Obj.magic
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Syntax.Base.fsti"
                 (Prims.of_int (417)) (Prims.of_int (25))
                 (Prims.of_int (417)) (Prims.of_int (48)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Syntax.Base.fsti"
    ...
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Syntax.Base.fsti"
               (Prims.of_int (417)) (Prims.of_int (18)) (Prims.of_int (417))
               (Prims.of_int (48)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Syntax.Base.fsti"
               (Prims.of_int (417)) (Prims.of_int (4)) (Prims.of_int (417))
