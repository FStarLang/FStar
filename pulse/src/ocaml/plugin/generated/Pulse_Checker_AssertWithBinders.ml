      ...
      fun v ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.AssertWithBinders.fst"
                   (Prims.of_int (71)) (Prims.of_int (4)) (Prims.of_int (98))
                   (Prims.of_int (82)))))
          (FStar_Tactics_Effect.lift_div_tac
                     ...
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range
                              ...
                              (Prims.of_int (98)) (Prims.of_int (82)))))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Checker.AssertWithBinders.fst"
                   ...
                   (Prims.of_int (124)) (Prims.of_int (97)))))
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       ...
                       (Prims.of_int (129)) (Prims.of_int (81)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       "Pulse.Checker.AssertWithBinders.fst"
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       ...
                       (Prims.of_int (132)) (Prims.of_int (73)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       "Pulse.Checker.AssertWithBinders.fst"
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       "Pulse.Checker.AssertWithBinders.fst"
                       (Prims.of_int (135)) (Prims.of_int (4))
                       (Prims.of_int (136)) (Prims.of_int (73)))))
                ...
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range
                           "Pulse.Checker.AssertWithBinders.fst"
                           (Prims.of_int (161)) (Prims.of_int (68))
                           (Prims.of_int (161)) (Prims.of_int (75)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range
                           "Pulse.Checker.AssertWithBinders.fst"
                           (Prims.of_int (161)) (Prims.of_int (3))
                           (Prims.of_int (205)) (Prims.of_int (53)))))
                  (FStar_Tactics_Effect.lift_div_tac
