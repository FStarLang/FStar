                        ...
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "Pulse.Prover.Common.fst"
                                 ...
                                 (Prims.of_int (288)) (Prims.of_int (40)))))
              ...
              fun uvs ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Prover.Common.fst"
                           (Prims.of_int (338)) (Prims.of_int (40))
                           (Prims.of_int (338)) (Prims.of_int (71)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Prover.Common.fst"
                           (Prims.of_int (338)) (Prims.of_int (4))
                           (Prims.of_int (341)) (Prims.of_int (66)))))
              ...
              fun uvs ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Prover.Common.fst"
                           (Prims.of_int (352)) (Prims.of_int (25))
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Prover.Common.fsti"
                         (Prims.of_int (133)) (Prims.of_int (16))
