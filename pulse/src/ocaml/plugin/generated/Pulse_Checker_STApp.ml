            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                     ...
                     (Prims.of_int (59)) (Prims.of_int (82)))))
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                 (Prims.of_int (66)) (Prims.of_int (14)) (Prims.of_int (66))
                 (Prims.of_int (21)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                 (Prims.of_int (66)) (Prims.of_int (24)) (Prims.of_int (79))
                 (Prims.of_int (72)))))
        (FStar_Tactics_Effect.lift_div_tac
              ...
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                            (Prims.of_int (67)) (Prims.of_int (46))
                            (Prims.of_int (67)) (Prims.of_int (52)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                            (Prims.of_int (66)) (Prims.of_int (24))
                            (Prims.of_int (79)) (Prims.of_int (72)))))
                   (FStar_Tactics_Effect.lift_div_tac
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                       ...
                       (Prims.of_int (90)) (Prims.of_int (43)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                       (Prims.of_int (90)) (Prims.of_int (46))
                       (Prims.of_int (135)) (Prims.of_int (123)))))
              (FStar_Tactics_Effect.lift_div_tac
                 (fun uu___ ->
