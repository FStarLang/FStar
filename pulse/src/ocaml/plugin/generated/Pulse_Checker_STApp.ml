                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (59)) (Prims.of_int (7)))))
                           (FStar_Tactics_Effect.lift_div_tac
                              (fun uu___ ->
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                 (Prims.of_int (72)) (Prims.of_int (14)) (Prims.of_int (72))
                 (Prims.of_int (21)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                 (Prims.of_int (72)) (Prims.of_int (24)) (Prims.of_int (88))
                 (Prims.of_int (32)))))
        (FStar_Tactics_Effect.lift_div_tac
              ...
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                            (Prims.of_int (73)) (Prims.of_int (46))
                            (Prims.of_int (73)) (Prims.of_int (52)))))
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                            (Prims.of_int (72)) (Prims.of_int (24))
                            (Prims.of_int (88)) (Prims.of_int (32)))))
                   (FStar_Tactics_Effect.lift_div_tac
            ...
            fun t ->
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                         (Prims.of_int (100)) (Prims.of_int (11))
                         (Prims.of_int (100)) (Prims.of_int (43)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                         (Prims.of_int (100)) (Prims.of_int (46))
                         (Prims.of_int (187)) (Prims.of_int (123)))))
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
