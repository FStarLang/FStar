            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                     ...
                     (Prims.of_int (68)) (Prims.of_int (31)))))
    ...
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                 (Prims.of_int (76)) (Prims.of_int (24)) (Prims.of_int (92))
                 (Prims.of_int (32)))))
        (FStar_Tactics_Effect.lift_div_tac
                   ...
                   (FStar_Sealed.seal
                      (Obj.magic
                         (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                            ...
                            (Prims.of_int (92)) (Prims.of_int (32)))))
                   (FStar_Tactics_Effect.lift_div_tac
            ...
            fun t ->
              FStar_Tactics_Effect.tac_bind
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.STApp.fst"
                         (Prims.of_int (104)) (Prims.of_int (46))
                         (Prims.of_int (193)) (Prims.of_int (123)))))
                (FStar_Tactics_Effect.lift_div_tac
                   (fun uu___ ->
                        ...
                        (FStar_Tactics_Effect.tac_bind
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.STApp.fst"
                                    (Prims.of_int (105)) (Prims.of_int (24))
                                    (Prims.of_int (193)) (Prims.of_int (123)))))
                           (FStar_Tactics_Effect.lift_div_tac
                              (fun uu___ -> t.Pulse_Syntax_Base.range2))
                           (fun uu___ ->
