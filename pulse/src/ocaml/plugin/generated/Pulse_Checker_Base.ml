              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                       ...
                       (Prims.of_int (644)) (Prims.of_int (23)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                       (Prims.of_int (642)) (Prims.of_int (47))
                       (Prims.of_int (674)) (Prims.of_int (66)))))
    ...
    fun e ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                 (Prims.of_int (743)) (Prims.of_int (19))
                 (Prims.of_int (743)) (Prims.of_int (37)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                 (Prims.of_int (741)) (Prims.of_int (28))
                 (Prims.of_int (762)) (Prims.of_int (15)))))
        (FStar_Tactics_Effect.lift_div_tac
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                         ...
                         (Prims.of_int (792)) (Prims.of_int (15)))))
                (FStar_Tactics_Effect.lift_div_tac
                  ...
                  fun steps ->
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                               (Prims.of_int (803)) (Prims.of_int (47))
                               (Prims.of_int (805)) (Prims.of_int (54)))))
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                               (Prims.of_int (803)) (Prims.of_int (3))
                               (Prims.of_int (812)) (Prims.of_int (13)))))
                      (Obj.magic
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                               (Obj.magic
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "Pulse.Checker.Base.fst"
                                     (Prims.of_int (805)) (Prims.of_int (6))
                                     (Prims.of_int (805)) (Prims.of_int (54)))))
                            (FStar_Tactics_Effect.lift_div_tac
                               (fun uu___ -> ()))
                            (fun uu___ ->
                    ...
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                             ...
                             (Prims.of_int (825)) (Prims.of_int (24)))))
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range "Pulse.Checker.Base.fst"
                             (Prims.of_int (826)) (Prims.of_int (6))
                             (Prims.of_int (845)) (Prims.of_int (13)))))
