...
val check_equiv_now (g:env) (t1 t2 : term)
  : Tac (option (squash (equiv_token g (RTS.denote_term t1) (RTS.denote_term t2))) & issues)
...
val universe_of_now : g:env -> e:term ->
  Tac (option (u:universe{typing_token g (RTS.denote_term e) (E_Total, RTS.Ts_Type (RTS.denote_universe u))}) & issues)
