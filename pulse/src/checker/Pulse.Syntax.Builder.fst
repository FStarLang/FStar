...
let tm_if b then_ else_ pre post = Tm_If { b; then_; else_; pre; post }
...
let tm_while invariant condition body loop_requires meas = Tm_While { invariant; loop_requires; meas; condition; body }
