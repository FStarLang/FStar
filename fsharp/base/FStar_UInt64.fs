module FStar_UInt64
(* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! *)
(* THIS FILE IS BASED ON AUTOGENERATED ml/FStar_UInt64.ml FILE! *)
(* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! *)

type uint64 = System.UInt64
type t = System.UInt64
let n = Prims.of_int 64

let uint_to_t x = System.UInt64.Parse((string x))
...
let zero = 0UL
let one  = 1UL
let ones = System.UInt64.MaxValue
...
let of_string : string -> t = System.UInt64.Parse
