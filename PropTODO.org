...
** prims
- normalize_spec started failing after Nik Apr 16 changes
- squash' sanity check fails too now, maybe justified?
** FStar.TSet.fst
lemma_mem_tset_of_set_l
lemma_mem_tset_of_set_r
** FStar.Algebra.Monoid.fst (commented out the end)
...
* Minimize prims to end once we've defined GTot
