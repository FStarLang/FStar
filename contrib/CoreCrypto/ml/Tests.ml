...
module TestHmac = struct
  ...
  let test_cases = [{
    ...
    digest =        bytes_of_hex "9294727a3638bb1c13f48ef8158bfc9d";
    hash_alg =      MD5;
  }; {
    key =           bytes_of_string "Jefe";
    data =          bytes_of_string "what do ya want for nothing?";
    digest =        bytes_of_hex "750c783e6ab0b503eaa86e310a5db738";
    hash_alg =      MD5;
  }; {
    ...
    digest =        bytes_of_hex "56be34521d144c88dbb8c733f0e8b3f6";
    hash_alg =      MD5;
  }; {
    ...
    digest =        bytes_of_hex "697eaf0aca3a3aea3a75164746ffaa79";
    hash_alg =      MD5;
  }; {
    key =           bytes_of_hex "0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c";
    data =          bytes_of_string "Test With Truncation";
    digest =        bytes_of_hex "56461ef2342edc00f9bab995690efd4c";
    hash_alg =      MD5;
  }; {
    ...
    digest =        bytes_of_hex "6b1ab7fe4bd7bf8f0b62e6ce61b9d0cd";
    hash_alg =      MD5;
  }; {
    key =           bytes_of_hex "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    data =          bytes_of_string "Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data";
    digest =        bytes_of_hex "6f630fad67cda0ee1fb1f562db3aa53e";
    hash_alg =      MD5;
  }; {
    key =           bytes_of_hex "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b";
    data =          bytes_of_string "Hi There";
    digest =        bytes_of_hex "b617318655057264e28bc0b6fb378c8ef146be00";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_string "Jefe";
    data =          bytes_of_string "what do ya want for nothing?";
    digest =        bytes_of_hex "effcdf6ae5eb2fa2d27416d5f184df9c259a7c79";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    data =          bytes_of_hex "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd";
    digest =        bytes_of_hex "125d7342b9ac11cd91a39af48aa17b4f63f175d3";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "0102030405060708090a0b0c0d0e0f10111213141516171819";
    data =          bytes_of_hex "cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd";
    digest =        bytes_of_hex "4c9007f4026250c6bc8414f9bf50c86c2d7235da";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c";
    data =          bytes_of_string "Test With Truncation";
    digest =        bytes_of_hex "4c1a03424b55e07fe7f27be1d58bb9324a9a5a04";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    data =          bytes_of_string "Test Using Larger Than Block-Size Key - Hash Key First";
    digest =        bytes_of_hex "aa4ae5e15272d00e95705637ce8a3b55ed402112";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    data =          bytes_of_string "Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data";
    digest =        bytes_of_hex "e8e99d0f45237d786d6bbaa7965c7808bbff1a91";
    hash_alg =      SHA1;
  }; {
    key =           bytes_of_hex "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    data =          bytes_of_string "Test Using Larger Than Block-Size Key - Hash Key First";
  ...
  let print_test_case v =
    Printf.printf "key: %s\ndata: %s\ndigest: %s (%s)\n"
      ...
      (string_of_bytes v.digest) (string_of_hash_alg v.hash_alg)

  let test v =
    let digest = hmac v.hash_alg v.key v.data in
    Bytes.equalBytes digest v.digest
