...
let fetch_eq_side' #a : Tac (term * term) =
  gpm (fun (left: a) (right: a) (g: pm_goal (squash (left == right))) ->
...
let _ =
  assert_by_tactic (1 + 1 == 2)
    (gpm (fun (left: int) (right: int) (g: pm_goal (squash (left == right))) ->
            let l, r = (quote left), (quote right) in
            print (term_to_string l ^ " / " ^ term_to_string r) <: Tac unit))
    ...
    (fun () ->
        repeat' (fun () ->
              or_else (gpm #unit (fun (a: Type) (h: hyp (squash a)) -> clear h <: Tac unit))
                (fun () ->
                    or_else (gpm #unit
                          (fun (a: Type0) (b: Type0) (g: pm_goal (squash (a ==> b))) ->
                          ...
                          or_else (gpm #unit
                            ...
                            (fun () ->
                                or_else (gpm #unit
                                  ...
                                  (fun () ->
                                      gpm #unit
                                        (fun (a: Type0) (h: hyp a) (g: pm_goal (squash a)) ->
