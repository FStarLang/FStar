...
let aux_inj_type_powerset (f1 f2 : powerset (Type u#a))
  : Lemma (requires type_powerset u#a u#b f1 == type_powerset u#a u#b f2)
          (ensures f1 == f2)
=
  assert (type_powerset u#a u#b f1 == type_powerset u#a u#b f2);
  let xx1 : type_powerset u#a u#b f1 = Mk f1 in
  let xx2 : type_powerset u#a u#b f2 = coerce_eq () xx1 in
  assert (xx1 === xx2);
  assert (f1 == f2)
