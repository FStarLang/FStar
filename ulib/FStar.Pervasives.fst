...
let st_post_h' (heap:Type) (a:Type) (pre:prop) = a -> (_:heap{pre}) -> GTot prop
...
unfold let st_if_then_else  (heap:Type) (a:Type) (p:prop)
...
unfold let st_close_wp      (heap:Type) (a:Type) (b:Type)
     ...
     (forall (b:b). wp b p h)
unfold let st_assert_p      (heap:Type) (a:Type) (p:prop)
                             (wp:st_wp_h heap a)
                             (q:st_post_h heap a) (h:heap) =
     p /\ wp q h
unfold let st_assume_p      (heap:Type) (a:Type) (p:prop)
                             (wp:st_wp_h heap a)
                             (q:st_post_h heap a) (h:heap) =
     p ==> wp q h
...
unfold let ex_if_then_else (a:Type) (p:prop) (wp_then:ex_wp a) (wp_else:ex_wp a) (post:ex_post a) =
   l_ITE p
       (wp_then post)
       (wp_else post)
...
unfold let ex_assert_p (a:Type) (q:prop) (wp:ex_wp a) (p:ex_post a) = (q /\ wp p)
unfold let ex_assume_p (a:Type) (q:prop) (wp:ex_wp a) (p:ex_post a) = (q ==> wp p)
...
unfold let all_bind_wp (heap:Type) (r1:range) (a:Type) (b:Type)
                       ...
                       (p:all_post_h heap b) (h0:heap) : GTot prop =
  wp1 (fun ra h1 -> (match ra with
                  | V v     -> wp2 v p h1
		  | E e     -> p (E e) h1
		  | Err msg -> p (Err msg) h1)) h0

unfold let all_if_then_else (heap:Type) (a:Type) (p:prop)
...
unfold let all_close_wp (heap:Type) (a:Type) (b:Type)
    ...
    (forall (b:b). wp b p h)
unfold let all_assert_p (heap:Type) (a:Type) (p:prop)
                         (wp:all_wp_h heap a) (q:all_post_h heap a) (h:heap) =
    p /\ wp q h
unfold let all_assume_p (heap:Type) (a:Type) (p:prop)
                         (wp:all_wp_h heap a) (q:all_post_h heap a) (h:heap) =
    p ==> wp q h
