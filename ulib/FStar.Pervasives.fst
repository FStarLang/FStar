...
irreducible let wp_req_ens_attr : Type0 = True
...
[@wp_req_ens_attr]
unfold
let as_requires_if_then_else (a:Type) (p:Type0) (wp_then:pure_wp a) (wp_else:pure_wp a)
: pure_pre
= (p ==> as_requires wp_then) /\ ((~ p) ==> as_requires wp_else)

[@wp_req_ens_attr]
unfold
let as_ensures_if_then_else (a:Type) (p:Type0) (wp_then:pure_wp a) (wp_else:pure_wp a)
: pure_post a
...
[@wp_req_ens_attr]
unfold
let as_requires_null (a:Type) : pure_pre = True
