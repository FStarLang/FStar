...
abstract type mrref (id:rid) (a:Type) (rel:preorder a) = MH.mref a rel
...
abstract val as_mref : #a:Type -> #rel:preorder a -> #id:rid -> r:mrref id a rel -> Tot (mref a rel)
let as_mref #a #rel #id r = r

val addr_of: #a:Type -> #rel:preorder a -> #id:rid -> r:mrref id a rel -> GTot nat
let addr_of #a #rel #id r = MH.addr_of (as_mref r)

let is_mm (#a:Type) (#rel:preorder a) (#id:rid) (r:mrref id a rel) :GTot bool
  = MH.is_mm (as_mref r)

abstract val mref_as_mrref : #a:Type -> #rel:preorder a -> i:rid -> r:mref a rel -> GTot (mrref i a rel)
let mref_as_mrref #a #rel i r = r

val lemma_as_ref_inj: #a:Type -> #rel:preorder a -> #i:rid -> r:mrref i a rel
    -> Lemma (requires (True))
             (ensures ((mref_as_mrref i (as_mref r) == r)))
       [SMTPat (as_mref r)]
let lemma_as_ref_inj #a #rel #i r = ()
...
let sel (#a:Type) (#rel:preorder a) (#i:rid) (m:t) (r:mrref i a rel) : GTot a = MH.sel (Map.sel m i) (as_mref r)
unfold let op_String_Access (#a:Type) (#rel:preorder a) (#i:rid) (m:t) (r:mrref i a rel) = sel m r

let upd_condition (#a:Type) (#rel:preorder a) (#i:rid) (m:t) (r:mrref i a rel) (x:a) 
  = rel (sel m r) x

let upd (#a:Type) (#rel:preorder a) (#i:rid) (m:t) (r:mrref i a rel) (v:a{upd_condition m r v}) : GTot t 
  = Map.upd m i (MH.upd (Map.sel m i) (as_mref r) v)
...
let contains_ref (#a:Type) (#rel:preorder a) (#i:rid) (r:mrref i a rel) (m:t) :GTot bool  =
  Map.contains m i && (FStar.StrongExcludedMiddle.strong_excluded_middle (MH.contains (Map.sel m i) (as_mref r)))

let unused_in (#a:Type) (#rel:preorder a) (#i:rid) (r:mrref i a rel) (m:t) :GTot bool =
  not (Map.contains m i) ||
  FStar.StrongExcludedMiddle.strong_excluded_middle (MH.unused_in (as_mref r) (Map.sel m i))

let weak_contains_ref (#a:Type) (#rel:preorder a) (#i:rid) (r:mrref i a rel) (m:t) : GTot bool =
  FStar.StrongExcludedMiddle.strong_excluded_middle (MH.contains (Map.sel m i) (as_mref r))

let fresh_rref (#a:Type) (#rel:preorder a) (#i:rid) (r:mrref i a rel) (m0:t) (m1:t) =
  MH.unused_in (as_mref r) (Map.sel m0 i) /\
