...
assume private type get : #world:Type -> (world -> Tot prop) -> Tot prop
assume private type set : #world:Type -> prop -> world -> Tot prop
...
let witnessed_past (#state:Type) (rel:preorder state) (p:(state -> Tot prop)) = 
