...
let op_At_Plus_At (#a:Type) (#r:hh_rid) (#b:Type) (#s:hh_rid) (x:rref r a) (y:rref s b) =
   Set.union (Set.singleton (Heap.addr_of (as_ref x))) (Set.singleton (Heap.addr_of (as_ref y)))
let op_Plus_Plus_At (#a:Type) (#r:hh_rid) (x:Set.set nat) (y:rref r a) = Set.union x (Set.singleton (Heap.addr_of (as_ref y)))
