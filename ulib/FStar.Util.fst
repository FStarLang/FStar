...
let op_At_Plus_At (#a:Type) (#r:rid) (#b:Type) (#s:rid) (x:rref r a) (y:rref s b) =
   Set.union (Set.singleton (addr_of (as_ref x))) (Set.singleton (addr_of (as_ref y)))
let op_Plus_Plus_At (#a:Type) (#r:rid) (x:Set.set nat) (y:rref r a) = Set.union x (Set.singleton (addr_of (as_ref y)))
