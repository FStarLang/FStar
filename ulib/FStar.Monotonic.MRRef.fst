...
private type m_rid = r:MHH.rid{is_eternal_region r}

private type m_m_rref (r:rid) (a:Type) (rel:preorder a) = x:MHS.ref a rel{x.id = r}

private val as_hsref: #r:rid -> #a:Type -> #rel:preorder a -> m_m_rref r a rel -> GTot (x:MHS.ref a rel{x.id = r})
let as_hsref #r #a #rel x = x

private let m_m_contains (#r:rid) (#a:Type) (#rel:preorder a) (mr:m_m_rref r a rel) (m:mem) = MHS.contains m (as_hsref mr)

private let m_m_unused_in (#r:rid) (#a:Type) (#rel:preorder a) (mr:m_m_rref r a rel) (m:mem) = MHS.unused_in (as_hsref mr) m

let m_fresh (#r:rid) (#a:Type) (#rel:preorder a) (mr:m_m_rref r a rel) (m0:mem) (m1:mem) : GTot Type0 =
  let hsref = as_hsref mr in
  MHH.fresh_rref hsref.ref m0.h m1.h

val m_sel: #r:rid -> #a:Type -> #rel:preorder a -> h:mem -> m_m_rref r a rel -> GTot a
let m_sel #r #a #rel h m = MHS.sel h (as_hsref m)
