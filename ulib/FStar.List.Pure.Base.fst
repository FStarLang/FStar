...
val map2: #a1: Type -> #a2: Type -> #b: Type -> f: (a1 -> a2 -> b) -> l1: list a1 -> l2: list a2 ->
  Pure (list b) (requires (length l1 == length l2)) (ensures (fun _ -> True)) (decreases l1)
...
val zip: #a1: Type -> #a2: Type -> l1: list a1 -> l2: list a2 ->
  Pure (list (a1 * a2))
    (requires
      (let n = length l1 in
        n == length l2))
