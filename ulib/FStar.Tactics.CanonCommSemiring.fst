...
let test3 (a b c:int) =
  assert (a * b + c + b * b == (b + a) * b + c) by (semiring()) 
...
let semiring_poly () : Tac unit = canon_semiring_with ring_cr ( +. ) ( *. )

let poly (a b:ring) =
  assert (a +. b == b +. a) by (semiring_poly ())
