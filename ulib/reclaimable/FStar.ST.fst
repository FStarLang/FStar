...
new_effect_for_free STATE = STATE_h heap
unfold let lift_div_state (a:Type) (wp:pure_wp a) (h:heap) (p:st_post a) = wp (fun a -> p (a, h))
...
effect ST (a:Type) (pre:st_pre) (post: (heap -> Tot (st_post a))) =
       STATE a
             (fun (h:heap) (p:st_post a) -> pre h /\ (forall a h1. (pre h /\ post h (a, h1)) ==> p (a, h1))) (* WP *)
effect St (a:Type) =
...
assume val get: unit -> State heap (fun h 'post -> 'post (h, h))
