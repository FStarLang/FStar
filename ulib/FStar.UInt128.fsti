...
inline_for_extraction  let op_Plus_Question_Hat = add_underspec
inline_for_extraction  let op_Plus_Percent_Hat = add_mod
inline_for_extraction  let op_Subtraction_Hat = sub
inline_for_extraction  let op_Subtraction_Question_Hat = sub_underspec
...
inline_for_extraction  let op_Equals_Hat = eq
inline_for_extraction  let op_Greater_Hat = gt
inline_for_extraction  let op_Less_Hat = lt
inline_for_extraction  let op_Greater_Equals_Hat = gte
inline_for_extraction  let op_Less_Equals_Hat = lte
