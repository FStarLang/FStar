...
(* Typing reflection *)
[@@ erasable] val non_informative_token (g:env) (t:typ) : Type0
[@@ erasable] val subtyping_token (g:env) (t0 t1:typ) : Type0
[@@ erasable] val equiv_token (g:env) (t0 t1:typ) : Type0
[@@ erasable] val typing_token (g:env) (e:term) (c:tot_or_ghost & typ) : Type0
