...
#push-options "--z3rlimit 15 --z3cliopt 'smt.qi.eager_threshold=6'"
#restart-solver
let raise_loc_includes #al #c l1 l2 =
  ...
  admit() //hitting a Z3 assertion violation on this one
  // introduce loc_includes l1 l2 ==> loc_includes (raise_loc u#x u#y l1) (raise_loc u#x u#y l2)
  // with _ . ( 
  //   assert (loc_includes' (raise_loc u#x u#y l1) (raise_loc u#x u#y l2))
  // );
  // introduce loc_includes (raise_loc u#x u#y l1) (raise_loc u#x u#y l2) ==> loc_includes l1 l2 
  // with _ . ( admit () )
//  assume (loc_includes l1 l2 <==> loc_includes (raise_loc u#x u#y l1) (raise_loc u#x u#y l2))
#pop-options
