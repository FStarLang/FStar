...
unfold
let pure_bind_wp
  (r1: range) (a: Type) (b: Type) (wp1: pure_wp a) (wp2: (a -> GTot (pure_wp b))) (p: pure_post b) =
  wp1 (fun (bind_result_1: a) -> wp2 bind_result_1 p)

unfold
let pure_if_then_else
  (a: Type) (p: Type) (wp_then: pure_wp a) (wp_else: pure_wp a) (post: pure_post a) =
...
new_effect {
  PURE
  :
    (* The definition of the PURE effect is fixed; no user should ever change this *)
    a: Type -> wp: pure_wp a -> Effect
  with
...
assume
val mk_range: file: string -> from_line: int -> from_col: int -> to_line: int -> to_col: int ->
  Tot range
...
irreducible
let unsafe_coerce (#a: Type) (#b: Type) (x: a) : b =
  admit ();
  x
