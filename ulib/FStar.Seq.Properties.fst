...
let slice_is_empty (#a: Type) (s: seq a) (i: nat{i <= length s})
  : Lemma (requires True) (ensures (slice s i i == createEmpty)) [SMTPat (slice s i i)] =
...
let seq_of_list_tl (#a: Type) (l: list a {List.Tot.length l > 0})
  : Lemma (requires True)
    ...
    [SMTPat (seq_of_list (List.Tot.tl l))] = lemma_tl (List.Tot.hd l) (seq_of_list (List.Tot.tl l))
