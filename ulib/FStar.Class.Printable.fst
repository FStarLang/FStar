...
: printable (Tuple3.tuple3 t0 t1 t2) =
{
  to_string =
  (fun (v0,v1,v2) ->
    "(" ^
...
: printable (Tuple4.tuple4 t0 t1 t2 t3) =
{
  to_string =
  (fun (v0,v1,v2,v3) ->
    "(" ^
...
instance printable_tuple5
  ...
  {| printable t0 |} {| printable t1 |} {| printable t2 |} {| printable t3 |}
  {| printable t4 |}
: printable (Tuple5.tuple5 t0 t1 t2 t3 t4) =
{
  to_string =
  (fun (v0,v1,v2,v3,v4) ->
    "(" ^
...
: printable (Tuple6.tuple6 t0 t1 t2 t3 t4 t5) =
{
  to_string =
...
: printable (Tuple7.tuple7 t0 t1 t2 t3 t4 t5 t6) =
{
  to_string =
