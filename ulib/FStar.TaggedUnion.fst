...
let field_matches_tag (#l: P.union_typ) (tgs: tags l) (f: P.struct_field l) (t: UInt32.t)
  : Tot Type0 = tag_of_field tgs f == t

let rec field_of_tag_of_field' (#l: P.struct_typ') (tgs: tags' l) (f: P.struct_field' l)
...
let field_of_tag_of_field (#l: P.union_typ) (tgs: tags l) (f: P.struct_field l)
  : Lemma (field_of_tag #l tgs (tag_of_field #l tgs f) == f)
    [SMTPat (field_of_tag #l tgs (tag_of_field #l tgs f))] = field_of_tag_of_field' tgs f

let rec tag_of_field_of_tag' (#l: P.struct_typ') (tgs: tags' l) (t: UInt32.t)
  ...
  let (f', _) :: l' = l in
  let t' :: tgs' = tgs in
  if t = t' then () else (tag_of_field_of_tag' #l' tgs' t)
...
let field_matches_tag_intro (#l: P.union_typ) (tgs: tags l) (f: P.struct_field l) (t: UInt32.t)
  : Lemma (requires (tag_of_field tgs f == t)) (ensures (field_matches_tag tgs f t)) = ()

let field_matches_tag_elim (#l: P.union_typ) (tgs: tags l) (f: P.struct_field l) (t: UInt32.t)
  : Lemma (requires (field_matches_tag tgs f t)) (ensures (tag_of_field tgs f == t)) = ()

let assert_field_matches_tag (#l: P.union_typ) (tgs: tags l) (f: P.struct_field l) (t: UInt32.t)
  : Lemma (requires (normalize_term (tag_of_field tgs f) == t))
    (ensures (field_matches_tag tgs f t)) = ()

(* Stateful invariant *)

let valid (#l: P.union_typ) (h: HS.mem) (tgs: tags l) (p: P.pointer (typ l)) : GTot Type0 =
  let tag_ptr = P.gfield p (tag_field l) in
  let u_ptr = P.gfield p (union_field l) in
  let t = P.gread h tag_ptr in
  P.readable h tag_ptr /\ List.Tot.mem t tgs /\
  (let f = field_of_tag #l tgs t in
    P.is_active_union_field h u_ptr f)

let valid_live (#l: P.union_typ) (h: HS.mem) (tgs: tags l) (p: P.pointer (typ l))
  : Lemma (requires (valid h tgs p)) (ensures (P.live h p)) [SMTPat (valid h tgs p)] = ()

(* Operations *)

let gread_tag (#l: P.union_typ) (h: HS.mem) (tgs: tags l) (p: P.pointer (typ l)) : GTot UInt32.t =
  P.gread h (P.gfield p (tag_field l))

let read_tag (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l))
  : HST.Stack UInt32.t
...
let gfield (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l)
  : GTot (p': P.pointer (P.typ_of_struct_field l f) {P.includes p p'}) =
  P.gufield (P.gfield p (union_field l)) f


let field (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l)
...
let write
  (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l)
...
let write_tag (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l)
  : HST.Stack unit
    (requires (fun h -> valid h tgs p))
    (ensures
      (fun h0 _ h1 ->
...
let includes_gfield (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l)
  : Lemma (requires True)
...
let modifies_1_valid
  (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l) (h0: HS.mem)
  (h1: HS.mem) (#t': P.typ) (p': P.pointer t')
  : Lemma
    (requires
    ...
    [
      ...
      SMTPat (P.modifies_1 (gfield #l tgs p f) h0 h1);
...
let readable_intro
  (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l) (h: HS.mem)
...
let readable_field
  (#l: P.union_typ) (tgs: tags l) (p: P.pointer (typ l)) (f: P.struct_field l) (h: HS.mem)
  : Lemma
    (requires (valid h tgs p /\ P.readable h p /\ field_matches_tag tgs f (gread_tag h tgs p)))
...
let raw_get_tag (#l: P.union_typ) (tu: raw l) : Tot UInt32.t =
  P.struct_sel #(typ_l l) tu (tag_field l)

let raw_get_field (#l: P.union_typ) (tu: raw l) : GTot (P.struct_field l) =
...
let valid_matching_tags (#l: P.union_typ) (h: HS.mem) (tgs: tags l) (p: P.pointer (typ l))
