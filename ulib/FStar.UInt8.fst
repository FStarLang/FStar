...
abstract
let add (a b: t) : Pure t (requires (size (v a + v b) n)) (ensures (fun c -> v a + v b = v c)) =
  Mk (add (v a) (v b))
...
abstract
let sub (a b: t) : Pure t (requires (size (v a - v b) n)) (ensures (fun c -> v a - v b = v c)) =
  Mk (sub (v a) (v b))
...
abstract
let mul (a b: t) : Pure t (requires (size (v a * v b) n)) (ensures (fun c -> v a * v b = v c)) =
  Mk (mul (v a) (v b))
...
abstract
let logand (x y: t) : Pure t (requires True) (ensures (fun z -> (v x) `logand` (v y) = v z)) =
  Mk (logand (v x) (v y))

(** Bitwise logical exclusive-or *)
abstract
let logxor (x y: t) : Pure t (requires True) (ensures (fun z -> (v x) `logxor` (v y) == v z)) =
  Mk (logxor (v x) (v y))

(** Bitwise logical disjunction *)
abstract
let logor (x y: t) : Pure t (requires True) (ensures (fun z -> (v x) `logor` (v y) == v z)) =
  Mk (logor (v x) (v y))
...
(** Equality
    ...
    operator [=] *)
let eq (a b: t) : Tot bool = eq #n (v a) (v b)

(** Greater than *)
let gt (a b: t) : Tot bool = gt #n (v a) (v b)

(** Greater than or equal *)
let gte (a b: t) : Tot bool = gte #n (v a) (v b)

(** Less than *)
let lt (a b: t) : Tot bool = lt #n (v a) (v b)

(** Less than or equal *)
let lte (a b: t) : Tot bool = lte #n (v a) (v b)
