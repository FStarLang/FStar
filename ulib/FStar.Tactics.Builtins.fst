...
assume
val ngoals: unit -> Tac int


(** [ngoals_smt ()] returns the number of SMT goals *)
assume
val ngoals_smt: unit -> Tac int
...
assume private
val __trytac: #a: Type -> __tac a -> __tac (option a)
...
assume
val __divide: int -> __tac 'a -> __tac 'b -> __tac ('a * 'b)
...
assume
val __seq: __tac unit -> __tac unit -> __tac unit
...
assume
val __pointwise: direction -> __tac unit -> __tac unit
...
let pointwise (tau: (unit -> Tac unit)) : Tac unit =
  TAC?.reflect (__pointwise BottomUp (reify (tau ())))
let pointwise' (tau: (unit -> Tac unit)) : Tac unit =
  TAC?.reflect (__pointwise TopDown (reify (tau ())))

assume
val __topdown_rewrite: (term -> __tac (bool * int)) -> __tac unit -> __tac unit
