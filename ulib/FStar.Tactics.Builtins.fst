...
assume private val __intro_named (s_opt:option string) : __tac binder
(** [intro_named] pushes the first argument of an arrow goal into the
...
*)
let intro_named (s_opt:option string) : tactic binder = fun () -> TAC?.reflect (__intro_named s_opt)
