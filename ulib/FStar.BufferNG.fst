...
: Lemma
  (requires (P.live h p))
  (ensures (live h (gsingleton_buffer_of_pointer p)))
...
: Lemma
  (requires (P.live h p))
  (ensures (live h (gbuffer_of_array_pointer p)))
...
: Lemma
  (requires (live h b))
  (ensures (P.live h (gpointer_of_buffer_cell b i)))
