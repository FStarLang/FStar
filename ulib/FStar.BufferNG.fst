  ...
  HST.StackInline (buffer a)
    ...
    (ensures
      (fun (h0: HS.mem) b h1 ->
          ...
          frameOf b == h0.HS.tip /\ P.modifies_0 h0 h1 /\
  ...
  HST.StackInline (buffer a)
    ...
    (ensures
      (fun (h0: HS.mem) b h1 ->
          ...
          len > 0 /\ unused_in b h0 /\ live h1 b /\ length b == len /\ frameOf b == h0.HS.tip /\
          P.modifies_0 h0 h1 /\ as_seq h1 b == Seq.of_list init /\ q #a len b))
...
val rcreate: #a: typ -> r: HH.rid -> init: P.type_of_typ a -> len: UInt32.t ->
  HST.ST (buffer a)
    ...
    (ensures
      (fun (h0: HS.mem) b h1 ->
          unused_in b h0 /\ live h1 b /\ length b == UInt32.v len /\ h1.HS.tip == h0.HS.tip /\
