...
noextract assume
val uint8_to_uint63: a: U8.t -> Tot (b: U63.t{U63.v b = U8.v a})
assume
...
noextract assume
val uint16_to_uint63: a: U16.t -> Tot (b: U63.t{U63.v b = U16.v a})
assume
...
noextract assume
val uint32_to_uint63: a: U32.t -> Tot (b: U63.t{U63.v b = U32.v a})
...
noextract assume
val uint63_to_uint64: a: U63.t -> Tot (b: U64.t{U64.v b = U63.v a})
...
noextract assume
val uint63_to_uint32: a: U63.t -> Tot (b: U32.t{U32.v b = U63.v a % pow2 32})
noextract assume
val uint63_to_uint16: a: U63.t -> Tot (b: U16.t{U16.v b = U63.v a % pow2 16})
noextract assume
val uint63_to_uint8: a: U63.t -> Tot (b: U8.t{U8.v b = U63.v a % pow2 8})
...
noextract assume
val uint64_to_uint63: a: U64.t -> Tot (b: U63.t{U63.v b = U64.v a % pow2 63})
assume
...
noextract assume
val int8_to_int63: a: I8.t -> Tot (b: I63.t{I63.v b = I8.v a})
assume
...
noextract assume
val int16_to_int63: a: I16.t -> Tot (b: I63.t{I63.v b = I16.v a})
assume
...
noextract assume
val int32_to_int63: a: I32.t -> Tot (b: I63.t{I63.v b = I32.v a})
...
noextract assume
val int63_to_int64: a: I63.t -> Tot (b: I64.t{I64.v b = I63.v a})
...
noextract assume
val int63_to_int32: a: I63.t -> Tot (b: I32.t{I32.v b = (I63.v a @% pow2 32)})
noextract assume
val int63_to_int16: a: I63.t -> Tot (b: I16.t{I16.v b = (I63.v a @% pow2 16)})
noextract assume
val int63_to_int8: a: I63.t -> Tot (b: I8.t{I8.v b = (I63.v a @% pow2 8)})
...
noextract assume
val int64_to_int63: a: I64.t -> Tot (b: I63.t{I63.v b = (I64.v a @% pow2 63)})
assume
...
noextract assume
val uint8_to_int63: a: U8.t -> Tot (b: I63.t{I63.v b = U8.v a})
assume
...
noextract assume
val uint16_to_int63: a: U16.t -> Tot (b: I63.t{I63.v b = U16.v a})
assume
...
noextract assume
val uint32_to_int63: a: U32.t -> Tot (b: I63.t{I63.v b = U32.v a})
...
noextract assume
val uint63_to_int64: a: U63.t -> Tot (b: I64.t{I64.v b = U63.v a})
...
noextract assume
val uint63_to_int63: a: U63.t -> Tot (b: I63.t{I63.v b = (U63.v a @% pow2 63)})
noextract assume
val uint63_to_int32: a: U63.t -> Tot (b: I32.t{I32.v b = (U63.v a @% pow2 32)})
noextract assume
val uint63_to_int16: a: U63.t -> Tot (b: I16.t{I16.v b = (U63.v a @% pow2 16)})
noextract assume
val uint63_to_int8: a: U63.t -> Tot (b: I8.t{I8.v b = (U63.v a @% pow2 8)})
...
noextract assume
val uint64_to_int63: a: U64.t -> Tot (b: I63.t{I63.v b = (U64.v a @% pow2 63)})
assume
...
noextract assume
val int8_to_uint63: a: I8.t -> Tot (b: U63.t{U63.v b = I8.v a % pow2 63})
assume
...
noextract assume
val int16_to_uint63: a: I16.t -> Tot (b: U63.t{U63.v b = I16.v a % pow2 63})
assume
...
noextract assume
val int32_to_uint63: a: I32.t -> Tot (b: U63.t{U63.v b = I32.v a % pow2 63})
assume
...
noextract assume
val int63_to_uint64: a: I63.t -> Tot (b: U64.t{U64.v b = I63.v a % pow2 64})
noextract assume
val int63_to_uint63: a: I63.t -> Tot (b: U63.t{U63.v b = I63.v a % pow2 63})
...
noextract assume
val int63_to_uint32: a: I63.t -> Tot (b: U32.t{U32.v b = I63.v a % pow2 32})
noextract assume
val int63_to_uint16: a: I63.t -> Tot (b: U16.t{U16.v b = I63.v a % pow2 16})
noextract assume
val int63_to_uint8: a: I63.t -> Tot (b: U8.t{U8.v b = I63.v a % pow2 8})
...
noextract assume
val int64_to_uint63: a: I64.t -> Tot (b: U63.t{U63.v b = I64.v a % pow2 63})
assume
