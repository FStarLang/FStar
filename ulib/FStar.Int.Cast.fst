...
assume val uint16_to_uint8 : a:u16 -> Tot (b:u8{U8.v b = U16.v a % pow2 8})
...
assume val uint32_to_uint16: a:u32 -> Tot (b:u16{U16.v b = U32.v a % pow2 16})
assume val uint32_to_uint8 : a:u32 -> Tot (b:u8{U8.v b = U32.v a % pow2 8})
...
assume val uint63_to_uint32: a:u63 -> Tot (b:u32{U32.v b = U63.v a % pow2 32})
assume val uint63_to_uint16: a:u63 -> Tot (b:u16{U16.v b = U63.v a % pow2 16})
assume val uint63_to_uint8 : a:u63 -> Tot (b:u8{U8.v b = U63.v a % pow2 8})
...
assume val uint64_to_uint63: a:u64 -> Tot (b:u63{U63.v b = U64.v a % pow2 63})
assume val uint64_to_uint32: a:u64 -> Tot (b:u32{U32.v b = U64.v a % pow2 32})
assume val uint64_to_uint16: a:u64 -> Tot (b:u16{U16.v b = U64.v a % pow2 16})
assume val uint64_to_uint8 : a:u64 -> Tot (b:u8{U8.v b = U64.v a % pow2 8})
...
assume val int16_to_int8 : a:i16 -> Tot (b:i8 {I8.v b  = (I16.v a @% pow2 8)})
...
assume val int32_to_int16: a:i32 -> Tot (b:i16{I16.v b = (I32.v a @% pow2 16)})
assume val int32_to_int8 : a:i32 -> Tot (b:i8 {I8.v b  = (I32.v a @% pow2 8)})
...
assume val int63_to_int32: a:i63 -> Tot (b:i32{I32.v b = (I63.v a @% pow2 32)})
assume val int63_to_int16: a:i63 -> Tot (b:i16{I16.v b = (I63.v a @% pow2 16)})
assume val int63_to_int8 : a:i63 -> Tot (b:i8 {I8.v b  = (I63.v a @% pow2 8)})
...
assume val int64_to_int63: a:i64 -> Tot (b:i63{I63.v b = (I64.v a @% pow2 63)})
assume val int64_to_int32: a:i64 -> Tot (b:i32{I32.v b = (I64.v a @% pow2 32)})
assume val int64_to_int16: a:i64 -> Tot (b:i16{I16.v b = (I64.v a @% pow2 16)})
assume val int64_to_int8 : a:i64 -> Tot (b:i8 {I8.v b  = (I64.v a @% pow2 8)})
...
assume val uint8_to_int8 : a:u8 -> Tot (b:i8 {I8.v b  = (U8.v a @% pow2 8)})
...
assume val uint16_to_int16: a:u16 -> Tot (b:i16{I16.v b = (U16.v a @% pow2 16)})
assume val uint16_to_int8 : a:u16 -> Tot (b:i8 {I8.v b  = (U16.v a @% pow2 8)})
...
assume val uint32_to_int32: a:u32 -> Tot (b:i32{I32.v b = (U32.v a @% pow2 32)})
assume val uint32_to_int16: a:u32 -> Tot (b:i16{I16.v b = (U32.v a @% pow2 16)})
assume val uint32_to_int8 : a:u32 -> Tot (b:i8 {I8.v b  = (U32.v a @% pow2 8)})
...
assume val uint63_to_int63: a:u63 -> Tot (b:i63{I63.v b = (U63.v a @% pow2 63)})
assume val uint63_to_int32: a:u63 -> Tot (b:i32{I32.v b = (U63.v a @% pow2 32)})
assume val uint63_to_int16: a:u63 -> Tot (b:i16{I16.v b = (U63.v a @% pow2 16)})
assume val uint63_to_int8 : a:u63 -> Tot (b:i8 {I8.v b  = (U63.v a @% pow2 8)})
...
assume val uint64_to_int64: a:u64 -> Tot (b:i64{I64.v b = (U64.v a @% pow2 64)})
assume val uint64_to_int63: a:u64 -> Tot (b:i63{I63.v b = (U64.v a @% pow2 63)})
assume val uint64_to_int32: a:u64 -> Tot (b:i32{I32.v b = (U64.v a @% pow2 32)})
assume val uint64_to_int16: a:u64 -> Tot (b:i16{I16.v b = (U64.v a @% pow2 16)})
assume val uint64_to_int8 : a:u64 -> Tot (b:i8 {I8.v b  = (U64.v a @% pow2 8)})
