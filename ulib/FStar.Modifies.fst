...
noeq
type loc_aux : Type = | LocBuffer : #t: Type -> b: B.buffer t -> loc_aux
...
let loc_aux_includes_buffer (#a: Type) (s: loc_aux) (b: B.buffer a) : GTot Type0 =
  match s with | LocBuffer #a0 b0 -> a == a0 /\ B.includes b0 b

let loc_aux_includes (s1: loc_aux) (s2: loc_aux) : GTot Type0 (decreases s2) =
  match s2 with | LocBuffer b -> loc_aux_includes_buffer s1 b

let loc_aux_includes_refl (s: loc_aux) : Lemma (loc_aux_includes s s) = ()

let loc_aux_includes_buffer_includes (#a: Type) (s: loc_aux) (b1: B.buffer a) (b2: B.buffer a)
  : Lemma (requires (loc_aux_includes_buffer s b1 /\ B.includes b1 b2))
    (ensures (loc_aux_includes_buffer s b2)) = ()

let loc_aux_includes_loc_aux_includes_buffer (#a: Type) (s1: loc_aux) (s2: loc_aux) (b: B.buffer a)
...
let loc_aux_disjoint (l1: loc_aux) (l2: loc_aux) : GTot Type0 =
...
let loc_aux_disjoint_buffer_includes (l: loc_aux) (#t: Type) (p1: B.buffer t) (p2: B.buffer t)
...
let loc_aux_preserved (l: loc_aux) (h1: HS.mem) (h2: HS.mem) : GTot Type0 =
