...
let includes_gfield_gen #t p #l q fd = includes_gfield q fd; includes_trans p q (gfield q fd)

let includes_gufield_gen #t p #l q fd = includes_gufield q fd; includes_trans p q (gufield q fd)

let includes_gcell_gen #t p #length #value q i = includes_gcell q i; includes_trans p q (gcell q i)
...
let loc_disjoint_none_l s = loc_disjoint_none_r s; loc_disjoint_sym s loc_none
