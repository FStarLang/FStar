...
let par0 (#aL:Type u#a) (#preL:slprop) (#postL:aL -> slprop)
  ...
  = SteelX?.reflect (fun frame -> Sem.run #state #_ #_ #_ #_ #_ frame (Sem.Par (Sem.Act f) (Sem.Act g)))
...
let frame0 (#a:Type) (#pre:slprop) (#post:a -> slprop) (#req:fp_mprop pre) (#ens:fp_binary_mprop pre post)
    ...
    = SteelX?.reflect (fun frame' -> Sem.run #state #_ #_ #_ #_ #_ frame' (Sem.Frame (Sem.Act f) frame f_frame))
