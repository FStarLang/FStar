...
let rec incr_even r n =
  ...
  if x = n then (
    change_slprop (if x = n then pts_to r (Even n) else pts_to r (EvenWriteable n)) (s_even r n) (fun _ -> ());
    incr_even r n
  ) else (
    change_slprop (if x = n then pts_to r (Even n) else pts_to r (EvenWriteable n)) (pts_to r (EvenWriteable n)) (fun _ -> ());
    upd_even r n
  )
  // cond (x = n)
