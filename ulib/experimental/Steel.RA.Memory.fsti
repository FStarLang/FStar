...
val ref (a:Type u#a) (ra:ra a) : Type u#0
...
val emp : slprop u#a
val pts_to (#a:Type u#a) (#ra:_) (r:ref a ra) (v:a) : slprop u#a
...
val sel (#a:_) (#ra:_) (r:ref a ra) (m:hheap (ptr r))
  : a

/// sel respect pts_to
val sel_lemma (#a:_) (#ra:_) (r:ref a ra) (m:hheap (ptr r))
  : Lemma (interp (pts_to r (sel r m)) m)

val sel_action (#a:_) (#ra:_) (r:ref a ra) (v0:erased a)
...
val upd_action (#a:_) (#ra:_) (r:ref a ra) (v0:FStar.Ghost.erased a) (v1:a {Steel.RA.frame_preserving ra v0 v1})
