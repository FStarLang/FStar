...
let print_uint8 s = pr "%.02x" (FStar_UInt8.to_int s); flush stdout
let print_uint8_dec s = print_int (FStar_UInt8.to_int s); flush stdout
let print_uint32 s = pr "%.04x" (FStar_UInt32.to_int s); flush stdout
let print_uint32_dec s = print_int (FStar_UInt32.to_int s); flush stdout
let print_uint64 s = pr "%.08x" (FStar_UInt64.to_int s); flush stdout
let print_uint64_dec s = print_int (FStar_UInt64.to_int s); flush stdout
