...
let uint64_to_uint63 (a:u64) : (u63) = Int64.to_int a
let uint64_to_uint32 (a:u64) : (u32) = Int64.to_int (Int64.logand a (Int64.of_int 4294967295))
let uint64_to_uint16 (a:u64) : (u16) = Int64.to_int (Int64.logand a (Int64.of_int 65535))     
let uint64_to_uint8  (a:u64) : (u8)  = Int64.to_int (Int64.logand a (Int64.of_int 255))
...
let uint64_to_int64 (a:u64) : (i64) = a
let uint64_to_int63 (a:u64) : (i63) = Int64.to_int a
let uint64_to_int32 (a:u64) : (i32) = Int64.to_int a land 4294967295
let uint64_to_int16 (a:u64) : (i16) = Int64.to_int a land 65535                        
let uint64_to_int8  (a:u64) : (i8 ) = Int64.to_int a land 255

(** Ints to uints *)
let int8_to_uint64 (a:i8) : (u64) = Int64.of_int a
let int8_to_uint63 (a:i8) : (u63) = a
let int8_to_uint32 (a:i8) : (u32) = a
let int8_to_uint16 (a:i8) : (u16) = a
let int8_to_uint8  (a:i8) : (u8 ) = a

let int16_to_uint64 (a:i16) : (u64) = Int64.of_int a
...
let int32_to_uint64 (a:i32) : (u64) = Int64.of_int a
...
let int63_to_uint64 (a:i63) : (u64) = Int64.of_int a
...
let int64_to_uint64 (a:i64) : (u64) = a
