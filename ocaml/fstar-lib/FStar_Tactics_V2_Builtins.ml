...
let core_compute_term_type       = from_tac_2 "B.refl_core_compute_term_type2" B.refl_core_compute_term_type2
let core_compute_term_type2      = from_tac_2 "B.refl_core_compute_term_type2" B.refl_core_compute_term_type2
...
let tc_term                      = from_tac_2 "B.refl_tc_term2" B.refl_tc_term2
let tc_term2                     = from_tac_2 "B.refl_tc_term2" B.refl_tc_term2
