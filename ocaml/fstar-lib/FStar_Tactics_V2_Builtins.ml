...
let core_compute_term_type       = from_tac_2 "B.refl_core_compute_term_type2" B.refl_core_compute_term_type
...
let tc_term                      = from_tac_2 "B.refl_tc_term2" B.refl_tc_term
