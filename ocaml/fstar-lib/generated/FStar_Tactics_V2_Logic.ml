      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___3 ->
           FStar_Tactics_Effect.lift_div_tac
             (fun uu___4 -> FStar_Tactics_Types.goals_of uu___3)) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Logic.fsti"
      ...
      (fun uu___2 ->
         ...
         | g::uu___3 ->
             FStar_Tactics_Effect.lift_div_tac
               (fun uu___4 -> FStar_Tactics_Types.goal_type g)
         | uu___3 ->
...
let (l_revert : unit -> (unit, unit) FStar_Tactics_Effect.tac_repr) =
  fun uu___ ->
    let uu___1 = FStar_Tactics_V2_Builtins.revert () in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.l_revert"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 l_revert)
...
let rec (l_revert_all :
  ...
  fun uu___ ->
    (fun bs ->
      ...
      uu___
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.l_revert_all"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 l_revert_all)
...
let (forall_intro :
  ...
  fun uu___ ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         (fun uu___2 -> Obj.magic (FStar_Tactics_V2_Builtins.intro ()))
           uu___2)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.forall_intro"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 forall_intro)
               FStar_Syntax_Embeddings.e_unit
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
let (forall_intro_as :
  Prims.string ->
    (FStar_Tactics_NamedView.binding, unit) FStar_Tactics_Effect.tac_repr)
  =
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 forall_intro_as)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.forall_intros"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 forall_intros)
               FStar_Syntax_Embeddings.e_unit
               (FStar_Syntax_Embeddings.e_list
                  FStar_Reflection_V2_Embeddings.e_binding) psc ncb us args)
    ...
    FStar_Tactics_V2_Derived.try_with
      ...
      (fun uu___1 ->
         (fun uu___1 ->
           ...
           uu___1)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.split"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 split)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
let (implies_intro :
  unit ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         (fun uu___2 -> Obj.magic (FStar_Tactics_V2_Builtins.intro ()))
           uu___2)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.implies_intro"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 implies_intro)
               FStar_Syntax_Embeddings.e_unit
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 implies_intro_as)
               FStar_Syntax_Embeddings.e_string
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
let (implies_intros :
  unit ->
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 implies_intros)
               FStar_Syntax_Embeddings.e_unit
               (FStar_Syntax_Embeddings.e_list
                  FStar_Reflection_V2_Embeddings.e_binding) psc ncb us args)
let (l_intro :
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.l_intro"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 l_intro)
               FStar_Syntax_Embeddings.e_unit
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
let (l_intros :
  unit ->
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.l_intros"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 l_intros)
               FStar_Syntax_Embeddings.e_unit
               (FStar_Syntax_Embeddings.e_list
                  FStar_Reflection_V2_Embeddings.e_binding) psc ncb us args)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.squash_intro"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 squash_intro)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
let (l_exact :
         ...
         FStar_Tactics_Effect.tac_bind
           ...
           (fun uu___2 ->
              (fun uu___2 -> Obj.magic (FStar_Tactics_V2_Derived.exact t))
                uu___2))
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.l_exact"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 l_exact)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.hyp"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 hyp)
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun c ->
            let uu___1 =
              match c with
              | FStar_Reflection_V2_Data.C_Lemma (pre, post, uu___2) ->
                  Obj.magic
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___3 -> (pre, post)))
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.pose_lemma"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 pose_lemma)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.explode"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 explode)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
let rec (visit :
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 simplify_eq_implication)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 rewrite_all_equalities)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1
                  unfold_definition_and_simplify_eq)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_unit psc ncb us args)
let (unsquash :
         ...
         (fun v ->
            ...
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (fun uu___2 ->
                    (fun uu___2 ->
                       let uu___3 = FStar_Tactics_V2_Builtins.intro () in
                       Obj.magic
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                               (Obj.magic
                                    ...
                                    FStar_Tactics_NamedView.pack
                                      (FStar_Tactics_NamedView.Tv_Var
                                         (FStar_Tactics_V2_SyntaxCoercions.binding_to_namedv
                                            b)))))) uu___2))) uu___1)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.unsquash"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 unsquash)
               FStar_Reflection_V2_Embeddings.e_term
  ...
  fun o ->
    FStar_Tactics_V2_Derived.apply_lemma
      (FStar_Reflection_V2_Derived.mk_e_app
         ...
         [o])
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.cases_or"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 cases_or)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_unit psc ncb us args)
let (cases_bool :
  FStar_Tactics_NamedView.term -> (unit, unit) FStar_Tactics_Effect.tac_repr)
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun bi ->
                        ...
                        (fun uu___3 ->
                           ...
                           FStar_Tactics_Effect.tac_bind
                             ...
                             (fun uu___5 ->
                                (fun b1 ->
                                   let uu___5 =
                                     FStar_Tactics_V2_Builtins.rewrite b1 in
                                   Obj.magic
                                     (FStar_Tactics_Effect.tac_bind
                                        (FStar_Sealed.seal
                                           (Obj.magic
           ...
           uu___1)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.cases_bool"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 cases_bool)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_unit psc ncb us args)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.left"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 left)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.right"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 right)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
let (and_elim :
  FStar_Tactics_NamedView.term -> (unit, unit) FStar_Tactics_Effect.tac_repr)
           ...
           (FStar_Reflection_V2_Builtins.pack_ln
              (FStar_Reflection_V2_Data.Tv_App
                 ((FStar_Reflection_V2_Builtins.pack_ln
                   ...
                   (t, FStar_Reflection_V2_Data.Q_Explicit)))))
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.and_elim"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 and_elim)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_unit psc ncb us args)
let (destruct_and :
  FStar_Tactics_NamedView.term ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun uu___1 ->
           ...
           uu___1)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.destruct_and"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 destruct_and)
               FStar_Reflection_V2_Embeddings.e_term
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.witness"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 witness)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_unit psc ncb us args)
let (elim_exists :
  FStar_Tactics_NamedView.term ->
              ...
              ((FStar_Reflection_V2_Builtins.pack_ln
                  (FStar_Reflection_V2_Data.Tv_FVar
                     (FStar_Reflection_V2_Builtins.pack_fv
                        ...
                        "Lemmas";
                        "__elim_exists'"]))),
                (t, FStar_Reflection_V2_Data.Q_Explicit)))) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Logic.fst"
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            let uu___2 = FStar_Tactics_V2_Builtins.intro () in
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
                    (Obj.magic
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.elim_exists"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 elim_exists)
               FStar_Reflection_V2_Embeddings.e_term
               (FStar_Syntax_Embeddings.e_tuple2
                  FStar_Reflection_V2_Embeddings.e_binding
                  FStar_Reflection_V2_Embeddings.e_binding) psc ncb us args)
           ...
           FStar_Tactics_V2_Derived.try_with
             ...
             (fun uu___1 ->
                (fun uu___1 ->
                  ...
                  uu___1))
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.instantiate"
    (Prims.of_int (3))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_2
               ...
               (FStar_Tactics_Native.from_tactic_2 instantiate)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
let (instantiate_as :
         ...
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_3
               ...
               (FStar_Tactics_Native.from_tactic_3 instantiate_as)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Syntax_Embeddings.e_string
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)
                              ...
                              ((FStar_Reflection_V2_Builtins.pack_ln
                                  (FStar_Reflection_V2_Data.Tv_FVar
                                     (FStar_Reflection_V2_Builtins.pack_fv
                                        ...
                                        "sklem0"]))),
                                ((FStar_Tactics_V2_SyntaxCoercions.binding_to_term
                                    b), FStar_Reflection_V2_Data.Q_Explicit)))) in
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range
                            ...
                            Obj.magic
                              (FStar_Tactics_Effect.tac_bind
                                 ...
                                 (fun uu___5 ->
                                    (fun uu___5 ->
                                       let uu___6 =
                                         FStar_Tactics_V2_Builtins.clear b in
                                       Obj.magic
                                         (FStar_Tactics_Effect.tac_bind
                                            (FStar_Sealed.seal
                                               (Obj.magic
  ...
  fun uu___ ->
    let uu___1 =
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___3 ->
           FStar_Tactics_Effect.lift_div_tac
             (fun uu___4 -> FStar_Reflection_V2_Builtins.vars_of_env uu___3)) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Logic.fst"
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.skolem"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 skolem)
               FStar_Syntax_Embeddings.e_unit
               (FStar_Syntax_Embeddings.e_list
                  (FStar_Syntax_Embeddings.e_tuple2
                     (FStar_Syntax_Embeddings.e_list
                        FStar_Reflection_V2_Embeddings.e_binding)
                     FStar_Reflection_V2_Embeddings.e_binding)) psc ncb us
               args)
let (easy_fill : unit -> (unit, unit) FStar_Tactics_Effect.tac_repr) =
  fun uu___ ->
    let uu___1 =
      FStar_Tactics_V2_Derived.repeat FStar_Tactics_V2_Builtins.intro in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Logic.fst"
      ...
      (fun uu___2 ->
         (fun uu___2 ->
           ...
           uu___2)
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.easy_fill"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 easy_fill)
               FStar_Syntax_Embeddings.e_unit FStar_Syntax_Embeddings.e_unit
               psc ncb us args)
let easy : 'a . 'a -> 'a = fun x -> x
let _ =
  FStar_Tactics_Native.register_plugin "FStar.Tactics.V2.Logic.easy"
    (Prims.of_int (2))
    (fun _psc ->
       fun cb ->
         fun us ->
           fun args ->
             FStar_Syntax_Embeddings.debug_wrap "FStar.Tactics.V2.Logic.easy"
               (fun _ ->
                  match args with
                  | (tv_0, _)::args_tail ->
                      (FStar_Syntax_Embeddings.arrow_as_prim_step_1
                         (FStar_Syntax_Embeddings.mk_any_emb tv_0)
                         (FStar_Syntax_Embeddings.mk_any_emb tv_0) easy
             ...
             (fun _ ->
                ...
                | (tv_0, _)::args_tail ->
                    (FStar_TypeChecker_NBETerm.arrow_as_prim_step_1
                       (FStar_TypeChecker_NBETerm.mk_any_emb tv_0)
                       (FStar_TypeChecker_NBETerm.mk_any_emb tv_0) easy
                       (FStar_Ident.lid_of_str "FStar.Tactics.V2.Logic.easy")
                       cb us) args_tail
                | _ -> failwith "arity mismatch"))
let (using_lemma :
  FStar_Tactics_NamedView.term ->
...
let _ =
  FStar_Tactics_Native.register_tactic "FStar.Tactics.V2.Logic.using_lemma"
    (Prims.of_int (2))
    (fun psc ->
       fun ncb ->
         fun us ->
           fun args ->
             FStar_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               (FStar_Tactics_Native.from_tactic_1 using_lemma)
               FStar_Reflection_V2_Embeddings.e_term
               FStar_Reflection_V2_Embeddings.e_binding psc ncb us args)