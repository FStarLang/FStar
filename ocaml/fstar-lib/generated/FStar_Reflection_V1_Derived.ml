...
let (bv_of_binder :
  ...
  fun b ->
    (FStar_Reflection_V1_Builtins.inspect_binder b).FStar_Reflection_V1_Data.binder_bv
let rec (inspect_ln_unascribe :
  FStar_Reflection_Types.term -> FStar_Reflection_V1_Data.term_view) =
  fun t ->
    match FStar_Reflection_V1_Builtins.inspect_ln t with
    | FStar_Reflection_V1_Data.Tv_AscribedT (t', uu___, uu___1, uu___2) ->
        inspect_ln_unascribe t'
    | FStar_Reflection_V1_Data.Tv_AscribedC (t', uu___, uu___1, uu___2) ->
        inspect_ln_unascribe t'
    | tv -> tv
let (mk_binder :
...
let rec (mk_app :
  FStar_Reflection_Types.term ->
    FStar_Reflection_V1_Data.argv Prims.list -> FStar_Reflection_Types.term)
  =
  fun t ->
    fun args ->
      match args with
      ...
      | x::xs ->
          mk_app
            (FStar_Reflection_V1_Builtins.pack_ln
               (FStar_Reflection_V1_Data.Tv_App (t, x))) xs
let (mk_e_app :
  FStar_Reflection_Types.term ->
  ...
  fun t ->
    fun args ->
      let e t1 = (t1, FStar_Reflection_V1_Data.Q_Explicit) in
            ...
            (FStar_Reflection_V1_Data.Tv_Arrow
               (b,
                 (FStar_Reflection_V1_Builtins.pack_comp
                    (FStar_Reflection_V1_Data.C_Total (mk_tot_arr_ln bs1 cod)))))
let rec (collect_arr' :
  FStar_Reflection_Types.binder Prims.list ->
...
let rec (collect_abs' :
  ...
  fun bs ->
    fun t ->
      match inspect_ln_unascribe t with
      | FStar_Reflection_V1_Data.Tv_Abs (b, t') -> collect_abs' (b :: bs) t'
      | uu___ -> (bs, t)
let (collect_abs_ln :
  FStar_Reflection_Types.term ->
    ...
    fun h ->
      fun t ->
        mk_app
          ...
          (h, FStar_Reflection_V1_Data.Q_Explicit);
  ...
  fun ts ->
    ...
    | n ->
        ...
        mk_e_app
          (FStar_Reflection_V1_Builtins.pack_ln
             (FStar_Reflection_V1_Data.Tv_FVar
                (FStar_Reflection_V1_Builtins.pack_fv qn))) ts
let (destruct_tuple :
  FStar_Reflection_Types.term ->
  ...
  fun t ->
    ...
    match uu___ with
    | (head, args) ->
        (match FStar_Reflection_V1_Builtins.inspect_ln head with
               ...
               FStar_Pervasives_Native.Some
                 (FStar_List_Tot_Base.concatMap
                    (fun uu___1 ->
                       ...
                       | (t1, q) ->
                           (match q with
                            | FStar_Reflection_V1_Data.Q_Explicit -> [t1]
                            | uu___2 -> [])) args)
...
let rec (head : FStar_Reflection_Types.term -> FStar_Reflection_Types.term) =
  fun t ->
    match FStar_Reflection_V1_Builtins.inspect_ln t with
    | FStar_Reflection_V1_Data.Tv_Match (t1, uu___, uu___1) -> head t1
    | FStar_Reflection_V1_Data.Tv_Let
        (uu___, uu___1, uu___2, uu___3, t1, uu___4) -> head t1
    | FStar_Reflection_V1_Data.Tv_Abs (uu___, t1) -> head t1
    | FStar_Reflection_V1_Data.Tv_Refine (uu___, uu___1, t1) -> head t1
    | FStar_Reflection_V1_Data.Tv_App (t1, uu___) -> head t1
    | FStar_Reflection_V1_Data.Tv_AscribedT (t1, uu___, uu___1, uu___2) ->
        head t1
    | FStar_Reflection_V1_Data.Tv_AscribedC (t1, uu___, uu___1, uu___2) ->
        head t1
    | FStar_Reflection_V1_Data.Tv_Unknown -> t
    | FStar_Reflection_V1_Data.Tv_Uvar (uu___, uu___1) -> t
    | FStar_Reflection_V1_Data.Tv_Const uu___ -> t
    | FStar_Reflection_V1_Data.Tv_Type uu___ -> t
    | FStar_Reflection_V1_Data.Tv_Var uu___ -> t
    | FStar_Reflection_V1_Data.Tv_BVar uu___ -> t
    | FStar_Reflection_V1_Data.Tv_FVar uu___ -> t
    | FStar_Reflection_V1_Data.Tv_UInst (uu___, uu___1) -> t
    | FStar_Reflection_V1_Data.Tv_Arrow (uu___, uu___1) -> t
    | FStar_Reflection_V1_Data.Tv_Unsupp -> t
    ...
    fun nm ->
      ...
      | FStar_Reflection_V1_Data.Tv_FVar fv ->
          (FStar_Reflection_V1_Builtins.implode_qn
             (FStar_Reflection_V1_Builtins.inspect_fv fv))
            = nm
      | FStar_Reflection_V1_Data.Tv_UInst (fv, uu___) ->
          (FStar_Reflection_V1_Builtins.implode_qn
             (FStar_Reflection_V1_Builtins.inspect_fv fv))
            = nm
      | uu___ -> false
...
let (is_uvar : FStar_Reflection_Types.term -> Prims.bool) =
  fun t ->
    match FStar_Reflection_V1_Builtins.inspect_ln (head t) with
    | FStar_Reflection_V1_Data.Tv_Uvar (uu___, uu___1) -> true
    | uu___ -> false
let (binder_set_qual :
  ...
  fun q ->
    fun b ->
      let bview = FStar_Reflection_V1_Builtins.inspect_binder b in
      FStar_Reflection_V1_Builtins.pack_binder
        {
          FStar_Reflection_V1_Data.binder_bv =
            (bview.FStar_Reflection_V1_Data.binder_bv);
          FStar_Reflection_V1_Data.binder_qual = q;
          FStar_Reflection_V1_Data.binder_attrs =
            (bview.FStar_Reflection_V1_Data.binder_attrs);
...
let (add_check_with :
  ...
  fun vcfg ->
    fun se ->
      let attrs = FStar_Reflection_V1_Builtins.sigelt_attrs se in
      let vcfg_t = FStar_Reflection_V1_Builtins.embed_vconfig vcfg in
      let t =
        FStar_Reflection_V2_Builtins.pack_ln
             ...
             ((FStar_Reflection_V2_Builtins.pack_ln
                 (FStar_Reflection_V2_Data.Tv_FVar
                    (FStar_Reflection_V2_Builtins.pack_fv
                       ["FStar"; "Reflection"; "Types"; "check_with"]))),
...
let rec (is_name_imp :
  ...
  fun nm ->
    fun t ->
      match inspect_ln_unascribe t with
      | FStar_Reflection_V1_Data.Tv_FVar fv ->
          if (FStar_Reflection_V1_Builtins.inspect_fv fv) = nm
          then true
          else false
      | FStar_Reflection_V1_Data.Tv_UInst (fv, uu___) ->
          if (FStar_Reflection_V1_Builtins.inspect_fv fv) = nm
      ...
      | FStar_Reflection_V1_Data.Tv_App
          (l, (uu___, FStar_Reflection_V1_Data.Q_Implicit)) ->
          is_name_imp nm l
      | uu___ -> false
let (unsquash_term :
  FStar_Reflection_Types.term ->
  ...
  fun t ->
    match inspect_ln_unascribe t with
    | FStar_Reflection_V1_Data.Tv_App
        (l, (r, FStar_Reflection_V1_Data.Q_Explicit)) ->
