                           ...
                           let envbody1 =
                             {
                               ...
                               FStar_TypeChecker_Env.extension_state =
                                 (envbody.FStar_TypeChecker_Env.extension_state)
                             } in
                           let uu___2 =
                             FStar_Compiler_List.fold_left
                               (fun uu___3 ->
                              ...
                              let envbody2 =
                                {
                                  ...
                                  FStar_TypeChecker_Env.extension_state =
                                    (envbody1.FStar_TypeChecker_Env.extension_state)
                                } in
                              ...
                              tc_term
                                {
                                  ...
                                  FStar_TypeChecker_Env.extension_state =
                                    (envbody2.FStar_TypeChecker_Env.extension_state)
                                } body2 in
                            (match uu___7 with
        ...
        let pat_typ_ok env1 pat_t1 scrutinee_t =
          ...
          (let fail1 msg_str =
             let msg =
               if msg_str = ""
               then []
               else (let uu___2 = FStar_Errors_Msg.text msg_str in [uu___2]) in
             let msg1 =
               let uu___1 =
                 let uu___2 =
                   let uu___3 = FStar_Syntax_Print.term_to_string pat_t1 in
                   let uu___4 = FStar_Syntax_Print.term_to_string scrutinee_t in
                   FStar_Compiler_Util.format2
                                                                ...
                                                                (let pat_bv_tms1
                                                                 ...
                                                                 let pat_bv_tms2
                                                                   ...
                                                                   let env1 =
                                                                    ...
                                                                    FStar_TypeChecker_Env.extension_state
                                                                    =
                                                                    (uu___16.FStar_TypeChecker_Env.extension_state)
                                                                    } in
                                                                   let uu___16
                                                                    =
                                                                    let uu___17
            ...
            tc_check_tot_or_gtot_term
              {
                ...
                FStar_TypeChecker_Env.extension_state =
                  (env01.FStar_TypeChecker_Env.extension_state)
              } t uu___1 "" in
          match uu___ with
          | (t1, uu___1, g) ->
              let uu___2 =
                     ...
                     tc_maybe_toplevel_term
                       {
                         ...
                         FStar_TypeChecker_Env.extension_state =
                           (env11.FStar_TypeChecker_Env.extension_state)
                       } e11 in
                   match uu___4 with
                   | (e12, c1, g1) ->
                       let uu___5 =
