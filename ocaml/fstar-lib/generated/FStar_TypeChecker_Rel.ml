  ...
  fun uv ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_uvar (uv', uu___1) ->
          FStar_Syntax_Unionfind.equiv uv.FStar_Syntax_Syntax.ctx_uvar_head
...
let (uu___0 : defer_ok_t FStar_Class_Show.showable) =
  {
    FStar_Class_Show.show =
      (fun uu___ ->
         match uu___ with
...
type worklist =
  ...
  wl_deferred:
    (Prims.int * FStar_TypeChecker_Common.deferred_reason * lstring *
      FStar_TypeChecker_Common.prob) FStar_Compiler_CList.clist
    ;
  wl_deferred_to_tac:
    (Prims.int * FStar_TypeChecker_Common.deferred_reason * lstring *
      FStar_TypeChecker_Common.prob) FStar_Compiler_CList.clist
...
let (__proj__Mkworklist__item__typeclass_variables :
  worklist -> FStar_Syntax_Syntax.ctx_uvar FStar_Compiler_RBSet.t) =
  fun projectee ->
    match projectee with
    | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
        umax_heuristic_ok; tcenv; wl_implicits; repr_subcomp_allowed;
        ...
        fun imps ->
          let uu___ =
            ...
            FStar_Class_Monoid.op_Plus_Plus
              (FStar_Compiler_CList.monoid_clist ()) wl.wl_deferred uu___1 in
          let uu___1 =
            let uu___2 = as_wl_deferred wl defer_to_tac in
            FStar_Class_Monoid.op_Plus_Plus
              (FStar_Compiler_CList.monoid_clist ()) wl.wl_deferred_to_tac
              uu___2 in
          let uu___2 =
            FStar_Class_Monoid.op_Plus_Plus
  ...
  fun p ->
    {
      ...
      FStar_TypeChecker_Common.logical = (p.FStar_TypeChecker_Common.logical)
    }
let maybe_invert :
  'uuuuu .
    'uuuuu FStar_TypeChecker_Common.problem ->
        ...
        FStar_TypeChecker_Common.TProb
          {
            ...
            FStar_TypeChecker_Common.loc = (p.FStar_TypeChecker_Common.loc);
            FStar_TypeChecker_Common.rank = (p.FStar_TypeChecker_Common.rank);
            FStar_TypeChecker_Common.logical =
              (p.FStar_TypeChecker_Common.logical)
          }
    | FStar_TypeChecker_Common.CProb p ->
                    ...
                    let uu___8 =
                      let uu___9 =
                        FStar_Class_Show.show
                          ...
                          p.FStar_TypeChecker_Common.logical in
                      [uu___9] in
                    (match p.FStar_TypeChecker_Common.reason with
                     | [] -> ""
...
let (p_logical : FStar_TypeChecker_Common.prob -> Prims.bool) =
  fun uu___ ->
    match uu___ with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.logical
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.logical
let (set_logical :
  Prims.bool ->
    FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob)
  =
          ...
          FStar_TypeChecker_Common.TProb
            {
              ...
              FStar_TypeChecker_Common.rank =
                (p.FStar_TypeChecker_Common.rank);
              FStar_TypeChecker_Common.logical = b
            }
      | FStar_TypeChecker_Common.CProb p ->
          FStar_TypeChecker_Common.CProb
            {
                  ...
                  | (ctx_uvar, lg, wl1) ->
                      let prob =
                        let uu___1 = next_pid () in
                        {
                          ...
                          FStar_TypeChecker_Common.rank =
                            FStar_Pervasives_Native.None;
                          FStar_TypeChecker_Common.logical = (p_logical orig)
                        } in
                      (prob, wl1)
let (mk_t_problem :
  worklist ->
                  ...
                  | (ctx_uvar, lg, wl1) ->
                      ...
                      let prob =
                        let uu___1 = next_pid () in
                        {
                          ...
                          FStar_TypeChecker_Common.rank =
                            FStar_Pervasives_Native.None;
                          FStar_TypeChecker_Common.logical = false
                        } in
                      (prob, wl1)
    ...
    fun u ->
      fun should_check_opt ->
        fun t ->
          ...
          (let uu___2 = FStar_Options.defensive () in
           if uu___2
           then
             let uu___3 =
...
let (wl_to_string : worklist -> Prims.string) =
  fun wl ->
    ...
    let cprobs_to_string ps =
      let uu___ =
        let uu___1 = FStar_Compiler_CList.map (prob_to_string' wl) ps in
...
let (flex_t_to_string : flex_t -> Prims.string) =
  fun uu___ ->
    match uu___ with
    | Flex (uu___1, c, args) ->
        let uu___2 = FStar_Class_Show.show FStar_Syntax_Print.showable_ctxu c in
        let uu___3 =
          FStar_Class_Show.show
            (FStar_Class_Show.show_list
               (FStar_Class_Show.show_tuple2 FStar_Syntax_Print.showable_term
                  FStar_Syntax_Print.showable_aqual)) args in
            ...
            (match uu___1 with
                            ...
                            | (v, t_v, wl1) ->
                                ...
                                ((let uu___6 =
                                  ...
                                  then
                                    let uu___7 =
                                      FStar_Class_Show.show
                                        FStar_Syntax_Print.showable_ctxu uv in
                                    let uu___8 =
                                      FStar_Class_Show.show
             ...
             | uu___2 ->
                 let uu___3 =
                   let uu___4 =
                     FStar_Class_Tagged.tag_of
                       FStar_Syntax_Syntax.tagged_term t0 in
                   let uu___5 =
                     FStar_Class_Tagged.tag_of
                       FStar_Syntax_Syntax.tagged_term head in
                   let uu___6 =
                     let uu___7 = FStar_Syntax_Subst.compress head in
                     FStar_Class_Tagged.tag_of
                       FStar_Syntax_Syntax.tagged_term uu___7 in
                   FStar_Compiler_Util.format3
                      ...
                      Obj.magic
                        (FStar_Class_Setlike.add ()
                           (Obj.magic
                              (FStar_Compiler_RBSet.setlike_rbset
                                 FStar_Syntax_Syntax.ord_bv))
                           x.FStar_Syntax_Syntax.binder_bv (Obj.magic out)))
        ...
        (match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n))
         ...
         | (FStar_Syntax_Syntax.Tm_fvar f, FStar_Syntax_Syntax.Tm_fvar g) ->
             ...
             then FullMatch
               ...
               (let uu___3 =
                  let uu___4 =
                    let uu___5 = FStar_TypeChecker_Env.fv_delta_depth env f in
                    FStar_Pervasives_Native.Some uu___5 in
                  let uu___5 =
                    let uu___6 = FStar_TypeChecker_Env.fv_delta_depth env g in
         ...
         | uu___1 ->
             let maybe_dd t =
               ...
               | FStar_Syntax_Syntax.Tm_unknown ->
                   FStar_Pervasives_Native.None
               | FStar_Syntax_Syntax.Tm_bvar uu___3 ->
                   FStar_Pervasives_Native.None
               | FStar_Syntax_Syntax.Tm_name uu___3 ->
                   FStar_Pervasives_Native.None
               | FStar_Syntax_Syntax.Tm_uvar uu___3 ->
                   FStar_Pervasives_Native.None
               | FStar_Syntax_Syntax.Tm_let uu___3 ->
                   FStar_Pervasives_Native.None
               | FStar_Syntax_Syntax.Tm_match uu___3 ->
                   FStar_Pervasives_Native.None
               | uu___3 ->
                   let uu___4 =
                     FStar_TypeChecker_Env.delta_depth_of_term env t in
  ...
  FStar_TypeChecker_Env.env ->
    Prims.bool ->
      Prims.bool ->
        FStar_Syntax_Syntax.typ ->
          FStar_Syntax_Syntax.typ ->
            (match_result * (FStar_Syntax_Syntax.typ *
...
let (compress_tprob :
  ...
  fun wl ->
    fun p ->
      let env = p_env wl (FStar_TypeChecker_Common.TProb p) in
      let uu___ = whnf env p.FStar_TypeChecker_Common.lhs in
      let uu___1 = whnf env p.FStar_TypeChecker_Common.rhs in
      {
        FStar_TypeChecker_Common.pid = (p.FStar_TypeChecker_Common.pid);
  ...
  fun wl ->
    fun p ->
      let whnf_c env c =
        ...
        | FStar_Syntax_Syntax.Total ty ->
            let uu___ = whnf env ty in FStar_Syntax_Syntax.mk_Total uu___
        | uu___ -> c in
      let env = p_env wl (FStar_TypeChecker_Common.CProb p) in
      let uu___ = whnf_c env p.FStar_TypeChecker_Common.lhs in
      let uu___1 = whnf_c env p.FStar_TypeChecker_Common.rhs in
      {
        FStar_TypeChecker_Common.pid = (p.FStar_TypeChecker_Common.pid);
        FStar_TypeChecker_Common.lhs = uu___;
        FStar_TypeChecker_Common.relation =
...
let (compress_prob :
  ...
  fun wl ->
    fun p ->
      ...
      | FStar_TypeChecker_Common.CProb p1 ->
          let uu___ = compress_cprob wl p1 in
          FStar_TypeChecker_Common.CProb uu___
let (rank :
  worklist ->
    FStar_TypeChecker_Common.prob ->
                          ...
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                            {
                              ...
                              FStar_TypeChecker_Common.logical =
                                (tp.FStar_TypeChecker_Common.logical)
                            })
                      | (FStar_Syntax_Syntax.Tm_uvar uu___3,
                           ...
                           (FStar_TypeChecker_Common.TProb
                              {
                                ...
                                FStar_TypeChecker_Common.logical =
                                  (tp1.FStar_TypeChecker_Common.logical)
                              })))))
      | FStar_TypeChecker_Common.CProb cp ->
            ...
            (FStar_TypeChecker_Common.CProb
               {
                 ...
                 FStar_TypeChecker_Common.rank =
                   (FStar_Pervasives_Native.Some
                      FStar_TypeChecker_Common.Rigid_rigid);
                 FStar_TypeChecker_Common.logical =
                   (cp.FStar_TypeChecker_Common.logical)
               }))
let (next_prob :
  worklist ->
    ...
    fun ctx_u ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Ctx_uvar_meta_tac
          ...
          ((let uu___1 = FStar_Compiler_Effect.op_Bang dbg_Tac in
            ...
            then
              let uu___2 =
                FStar_Class_Show.show FStar_Syntax_Print.showable_ctxu ctx_u in
    ...
    fun env ->
      fun g ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let f2 = FStar_TypeChecker_Common.check_trivial f1 in
            {
                      ...
                      then
                        ...
                        (let uu___2 =
                         ...
                         FStar_Errors.raise_error
                           FStar_Class_HasRange.hasRange_range r1
  ...
  fun u ->
    fun wl ->
      FStar_Class_Setlike.for_any ()
        (Obj.magic
           (FStar_Compiler_RBSet.setlike_rbset FStar_Syntax_Free.ord_ctx_uvar))
        (fun v ->
...
let (lazy_complete_repr : FStar_Syntax_Syntax.lazy_kind -> Prims.bool) =
  fun k ->
    ...
    | uu___ -> false
let (has_free_uvars : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t ->
    let uu___ =
      ...
      FStar_Class_Setlike.is_empty ()
        (Obj.magic
           (FStar_Compiler_FlatSet.setlike_flat_set
              FStar_Syntax_Free.ord_ctx_uvar)) (Obj.magic uu___1) in
...
let (env_has_free_uvars : FStar_TypeChecker_Env.env_t -> Prims.bool) =
  fun e ->
    ...
    FStar_Compiler_List.existsb
      (fun b ->
         has_free_uvars
           (b.FStar_Syntax_Syntax.binder_bv).FStar_Syntax_Syntax.sort) uu___
  ...
  fun probs ->
    ...
    (let uu___2 = next_prob probs in
           ...
           | FStar_TypeChecker_Common.TProb tp ->
               ...
               then
                 ...
                 (let is_expand_uvar t =
                    ...
                    match uu___6 with
                    | FStar_Syntax_Syntax.Tm_uvar (ctx_u, uu___7) ->
                        let uu___8 =
                          FStar_Syntax_Unionfind.find_decoration
                            ctx_u.FStar_Syntax_Syntax.ctx_uvar_head in
                        uu___8.FStar_Syntax_Syntax.uvar_decoration_should_unrefine
                    | uu___7 -> false in
                  let maybe_expand tp1 =
                    let uu___6 =
                      ((let uu___7 = FStar_Options_Ext.get "__unrefine" in
                        uu___7 <> "") &&
                         (tp1.FStar_TypeChecker_Common.relation =
                            FStar_TypeChecker_Common.SUB))
                        && (is_expand_uvar tp1.FStar_TypeChecker_Common.rhs) in
                    if uu___6
                    then
                      let lhs = tp1.FStar_TypeChecker_Common.lhs in
                      let lhs_norm =
                      ...
                      let uu___7 =
                        let uu___8 =
                          let uu___9 = FStar_Syntax_Subst.compress lhs_norm in
                          uu___9.FStar_Syntax_Syntax.n in
                        FStar_Syntax_Syntax.uu___is_Tm_refine uu___8 in
                      (if uu___7
                       then
                         let lhs' =
                           FStar_TypeChecker_Normalize.unfold_whnf'
                         ...
                         ((let uu___9 = FStar_Compiler_Effect.op_Bang dbg_Rel in
                           ...
                           then
                             ...
                             let uu___11 =
                               FStar_Class_Show.show
                                 FStar_Syntax_Print.showable_term lhs in
                             let uu___12 =
                               FStar_Class_Show.show
                                 FStar_Syntax_Print.showable_term lhs' in
                             FStar_Compiler_Util.print3
                           ...
                           else ());
                          {
                            ...
                            FStar_TypeChecker_Common.loc =
                              (tp1.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (tp1.FStar_TypeChecker_Common.rank);
                            FStar_TypeChecker_Common.logical =
                              (tp1.FStar_TypeChecker_Common.logical)
                          })
                       else tp1)
     ...
     | FStar_Pervasives_Native.None ->
         let uu___3 =
           Obj.magic
             (FStar_Class_Listlike.view ()
                (Obj.magic (FStar_Compiler_CList.listlike_clist ()))
                (Obj.magic probs.wl_deferred)) in
         (match uu___3 with
          | FStar_Class_Listlike.VNil ->
              let uu___4 =
              ...
              Success uu___4
          | FStar_Class_Listlike.VCons (uu___4, uu___5) ->
              let uu___6 =
                FStar_Compiler_CList.partition
                  (fun uu___7 ->
                     match uu___7 with
        ...
        (let wl1 = solve_prob orig FStar_Pervasives_Native.None [] wl in
         let wl2 =
           let uu___1 =
             ...
             Obj.magic
               (FStar_Class_Listlike.cons ()
                  (Obj.magic (FStar_Compiler_CList.listlike_clist ())) uu___2
        ...
        (let flip = rank1 = FStar_TypeChecker_Common.Flex_rigid in
         let meet_or_join op ts wl1 =
           ...
           let pairwise t1 t2 wl2 =
             ...
             (let uu___2 =
                head_matches_delta
                  (p_env wl2 (FStar_TypeChecker_Common.TProb tp))
                  tp.FStar_TypeChecker_Common.logical wl2.smt_ok t1 t2 in
              match uu___2 with
              | (mr, ts1) ->
                  (match mr with
                   | HeadMatch (true) ->
                                        ...
                                        (FStar_Pervasives_Native.Some
                                           (if flip
                                            then
                                              ...
                                              FStar_Syntax_Util.mk_disj_simp))) in
                                  (match uu___8 with
            ...
            (let uu___1 = FStar_Compiler_Effect.op_Bang dbg_Rel in
             ...
             then
               let uu___2 =
                 FStar_Class_Show.show
                   (FStar_Class_Show.show_list
                      FStar_Syntax_Print.showable_binder) bs1 in
               let uu___3 =
                 FStar_Class_Show.show
                   (FStar_Class_Show.show_list
                      FStar_Syntax_Print.showable_binder) bs2 in
      ...
      fun lhs ->
        fun rhs ->
          (let uu___1 = FStar_Compiler_Effect.op_Bang dbg_Rel in
           ...
           then
             let uu___2 =
               FStar_Class_Show.show FStar_Syntax_Print.showable_term rhs in
             FStar_Compiler_Util.print1 "solve_t_flex_rigid_eq rhs=%s\n"
               uu___2
           else ());
          ...
          fun rhs ->
            let should_run_meta_arg_tac flex =
              ...
              ((flex_uvar_has_meta_tac uv) &&
                ...
                &&
                (let uu___ =
                   gamma_has_free_uvars uv.FStar_Syntax_Syntax.ctx_uvar_gamma in
                 Prims.op_Negation uu___) in
                                                           ...
                                                           new_uvar
                                                             ...
                                                             (if
                                                                FStar_Pervasives_Native.uu___is_Some
                                                                  u_lhs.FStar_Syntax_Syntax.ctx_uvar_meta
                                                              then
                                                                u_lhs.FStar_Syntax_Syntax.ctx_uvar_meta
                                                              else
                                                                u_rhs.FStar_Syntax_Syntax.ctx_uvar_meta) in
                                                         (match uu___24 with
                                                          | (uu___25, w, wl1)
                                                              ->
                                                              let w_app =
         ...
         (let uu___2 = FStar_Compiler_Effect.op_Bang dbg_Rel in
          ...
          then
            ...
            let uu___5 =
              FStar_Class_Show.show FStar_Syntax_Print.showable_term t2 in
            let uu___6 =
              FStar_Class_Tagged.tag_of FStar_Syntax_Syntax.tagged_term t2 in
                           ...
                           solve_t
                             {
                               ...
                               FStar_TypeChecker_Common.logical =
                                 (problem.FStar_TypeChecker_Common.logical)
                             } wl1
                         else
                           solve_head_then wl1
                             (fun ok ->
                                  ...
                                  (match (refinement1, refinement2) with
                                   | (FStar_Pervasives_Native.None,
                                      FStar_Pervasives_Native.None) ->
                                                             ...
                                                             (match uu___16
                                                              ...
                                                              | uu___17 ->
                                                                  let torig'
                                                                    ...
                                                                    FStar_TypeChecker_Common.logical
                                                                    =
                                                                    (torig.FStar_TypeChecker_Common.logical)
                                                                    } in
                                                                  ((let uu___19
                                                                    =
                                                                    FStar_Compiler_Effect.op_Bang
                                       ...
                                       let d =
                                         let uu___9 =
                                           FStar_TypeChecker_Env.delta_depth_of_term
                                             env head1 in
               ...
               | uu___3 ->
                   ((let uu___5 = FStar_Compiler_Effect.op_Bang dbg_Rel in
                     ...
                     then
                       let uu___6 =
                         FStar_Class_Tagged.tag_of
                           FStar_Syntax_Syntax.tagged_term t1 in
                       let uu___7 =
                         FStar_Class_Tagged.tag_of
          ...
          (let t1 = problem.FStar_TypeChecker_Common.lhs in
            ...
            then
              ...
              let uu___11 =
                FStar_Class_Show.show
                  ...
                  (FStar_Compiler_List.length wl.attempting) in
           ...
           (match ((t1.FStar_Syntax_Syntax.n), (t2.FStar_Syntax_Syntax.n))
            ...
            | (FStar_Syntax_Syntax.Tm_let uu___7, uu___8) ->
                ...
                FStar_Errors.raise_error
                  (FStar_Syntax_Syntax.has_range_syntax ()) t1
             ...
             (let uu___4 =
                FStar_Compiler_List.fold_left2
                  ...
                  ((Obj.magic
                      (FStar_Class_Listlike.empty ()
                         (Obj.magic (FStar_Compiler_CList.listlike_clist ())))),
                    wl) c1_comp.FStar_Syntax_Syntax.comp_univs
                       ...
                       (match uu___6 with
                        | (arg_sub_probs, wl3) ->
                            ...
                            let guard =
                              let guard1 =
                                let uu___7 =
                                  FStar_Compiler_List.map p_guard sub_probs1 in
                     ...
                     (let uu___7 =
                      ...
                      then
                        ...
                        FStar_Errors.raise_error
                          ...
                          FStar_Errors_Codes.Error_TypeError ()
                          (Obj.magic FStar_Errors_Msg.is_error_message_string)
                          (Obj.magic uu___8)
                      else ());
                     (let uu___7 =
           ...
           | (c, g) ->
               ...
               then
                 ...
                 FStar_Errors.raise_error FStar_Class_HasRange.hasRange_range
                   r FStar_Errors_Codes.Fatal_UnexpectedEffect ()
                   (Obj.magic FStar_Errors_Msg.is_error_message_string)
                   (Obj.magic uu___4)
            ...
            let uu___3 =
              ...
              | uu___4 ->
                  ...
                  FStar_Errors.raise_error FStar_TypeChecker_Env.hasRange_env
                    env FStar_Errors_Codes.Fatal_ExpectNormalizedEffect ()
                    (Obj.magic FStar_Errors_Msg.is_error_message_string)
                    (Obj.magic uu___5) in
            match uu___3 with
            | (wpc1, wpc2) ->
...
let (ineqs_to_string :
  (FStar_Syntax_Syntax.universe FStar_Compiler_CList.clist *
    (FStar_Syntax_Syntax.universe * FStar_Syntax_Syntax.universe)
    FStar_Compiler_CList.clist) -> Prims.string)
  =
  fun ineqs ->
    let uu___ = ineqs in
    match uu___ with
    | (vars, ineqs1) ->
        ...
        let uu___1 =
          FStar_Class_Show.show
            (FStar_Compiler_CList.showable_clist
               FStar_Syntax_Print.showable_univ) vars in
        let uu___2 =
          FStar_Class_Show.show
            (FStar_Compiler_CList.showable_clist
               (FStar_Class_Show.printableshow
  ...
  fun env ->
    fun g ->
      let uu___ =
        let uu___1 =
          Obj.magic
            (FStar_Class_Listlike.view ()
               (Obj.magic (FStar_Compiler_CList.listlike_clist ()))
               (Obj.magic g.FStar_TypeChecker_Common.deferred)) in
        ((g.FStar_TypeChecker_Common.guard_f), uu___1) in
      match uu___ with
      | (FStar_TypeChecker_Common.Trivial, FStar_Class_Listlike.VNil) when
      ...
      | uu___1 ->
          ...
          let uu___2 = carry g.FStar_TypeChecker_Common.deferred in
          let uu___3 = carry g.FStar_TypeChecker_Common.deferred_to_tac in
          let uu___4 = ineqs_to_string g.FStar_TypeChecker_Common.univ_ineqs in
      ...
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some (deferred, defer_to_tac, implicits) ->
            (FStar_Defensive.def_check_scoped
               FStar_TypeChecker_Env.hasBinders_env
               FStar_Class_Binders.hasNames_term
               FStar_Syntax_Print.pretty_term (p_loc prob) "with_guard" env
               (p_guard prob);
             (let uu___1 =
                simplify_guard env
                  {
           ...
           FStar_Profiling.profile
             (fun uu___3 ->
                ...
                (let uu___5 =
                   ...
                   new_t_problem uu___6 env t1 FStar_TypeChecker_Common.EQ t2
      ...
      fun t2 ->
        ...
        | FStar_Pervasives_Native.None ->
            (FStar_TypeChecker_Err.basic_type_error env
               env.FStar_TypeChecker_Env.range FStar_Pervasives_Native.None
               t2 t1;
    ...
    fun t1 ->
      fun t2 ->
        ...
        (let uu___1 =
           ...
           new_t_prob uu___2 env t1 FStar_TypeChecker_Common.EQ t2 in
         match uu___1 with
         | (prob, x, wl) ->
             let g =
               let uu___2 =
    ...
    fun e ->
      fun t1 ->
        fun t2 ->
          ...
          FStar_TypeChecker_Err.basic_type_error env uu___
...
let (solve_universe_inequalities' :
  FStar_Syntax_Unionfind.tx ->
    FStar_TypeChecker_Env.env_t ->
      (FStar_Syntax_Syntax.universe FStar_Compiler_CList.clist *
        (FStar_Syntax_Syntax.universe * FStar_Syntax_Syntax.universe)
        FStar_Compiler_CList.clist) -> unit)
  =
  fun tx ->
    fun env ->
      fun uu___ ->
        ...
        | (variables, ineqs) ->
            let fail u1 u2 =
              ...
              (let uu___2 =
               ...
               FStar_Errors.raise_error FStar_TypeChecker_Env.hasRange_env
                 env FStar_Errors_Codes.Fatal_IncompatibleUniverse ()
                 (Obj.magic FStar_Errors_Msg.is_error_message_string)
                 (Obj.magic uu___2)) in
            let equiv v v' =
              let uu___1 =
                               ...
                               (let lower_bounds_of_v =
                                ...
                                let lb =
                                  let uu___3 =
                                    ...
                                    FStar_Syntax_Syntax.U_max uu___4 in
                                  FStar_TypeChecker_Normalize.normalize_universe
                                    env uu___3 in
                                FStar_Class_Listlike.singleton
                                  (FStar_Compiler_CList.listlike_clist ())
                                  (lb, v)))
                      | uu___2 ->
                          Obj.magic
            ...
            then ()
              ...
              ((let uu___5 = FStar_Compiler_Effect.op_Bang dbg_GenUniverses in
               ...
               FStar_Errors.raise_error FStar_TypeChecker_Env.hasRange_env
                 env FStar_Errors_Codes.Fatal_FailToSolveUniverseInEquality
                 () (Obj.magic FStar_Errors_Msg.is_error_message_string)
                 (Obj.magic
            ...
            let smt_ok1 =
              smt_ok &&
                (let uu___ = FStar_Options.ml_ish () in
                 Prims.op_Negation uu___) in
            FStar_Errors.with_ctx "While solving deferred constraints"
              (fun uu___ ->
                 let uu___1 =
                   let uu___2 =
                   ...
                   (fun uu___2 ->
                      ...
                      let fail uu___3 =
                        ...
                        | (d, s) ->
                            ...
                            FStar_Errors.raise_error
                              FStar_Class_HasRange.hasRange_range (p_loc d)
                      ...
                      (let uu___4 = FStar_Compiler_Effect.op_Bang dbg_Rel in
                       if uu___4
                       then
                         let uu___5 = FStar_Class_Show.show uu___0 defer_ok in
                         let uu___6 =
                           FStar_Class_Show.show
                             (FStar_Class_Show.printableshow
                                FStar_Class_Printable.printable_bool)
...
let (do_discharge_vc :
  (unit -> Prims.string) FStar_Pervasives_Native.option ->
    FStar_TypeChecker_Env.env -> FStar_TypeChecker_Env.goal -> unit)
  =
  ...
  fun env ->
    fun t1 ->
      fun t2 ->
        ...
        (let uu___1 =
           let uu___2 = empty_worklist env in
           new_t_prob uu___2 env t1 FStar_TypeChecker_Common.SUB t2 in
         match uu___1 with
         | (prob, x, wl) ->
             let g =
               let uu___2 =
                                 ...
                                 (match uu___5 with
                                  | FStar_Pervasives_Native.None ->
                                      FStar_TypeChecker_Err.expected_expression_of_type
                                        env1 imp_tm1.FStar_Syntax_Syntax.pos
                                        uvar_ty imp_tm1 k'
                         ...
                         (let uu___4 =
                          ...
                          | FStar_Pervasives.Inr print_err ->
                              let uu___5 =
                                let uu___6 =
                                  FStar_Class_Show.show
                                    FStar_Syntax_Print.showable_ctxu imp_uvar in
                                let uu___7 =
                                  FStar_Class_Show.show
                                    (FStar_Class_Show.printableshow
                                       FStar_Class_Printable.printable_bool)
  ...
  fun env ->
    fun is_tac ->
      fun is_gen ->
        fun implicits ->
          let cacheable tac =
            (FStar_Syntax_Util.is_fvar FStar_Parser_Const.tcresolve_lid tac)
              ||
              (let uu___ =
                 let uu___1 = FStar_Syntax_Subst.compress tac in
                 uu___1.FStar_Syntax_Syntax.n in
               match uu___ with
               | FStar_Syntax_Syntax.Tm_abs
                   ...
                   ->
                   let uu___3 = FStar_Syntax_Util.head_and_args body in
                   (match uu___3 with
                    | (hd, args) ->
                        (FStar_Syntax_Util.is_fvar
                           FStar_Parser_Const.tcresolve_lid hd)
                          &&
    ...
    fun u2 ->
      let uu___ =
        let uu___1 =
          Obj.magic
            (FStar_Class_Listlike.cons ()
               (Obj.magic (FStar_Compiler_CList.listlike_clist ())) (u1, u2)
               (FStar_Class_Listlike.empty ()
                  (Obj.magic (FStar_Compiler_CList.listlike_clist ())))) in
        ((Obj.magic
            (FStar_Class_Listlike.empty ()
               (Obj.magic (FStar_Compiler_CList.listlike_clist ())))),
          uu___1) in
      {
        ...
        FStar_TypeChecker_Common.deferred =
          (FStar_TypeChecker_Common.trivial_guard.FStar_TypeChecker_Common.deferred);
        FStar_TypeChecker_Common.univ_ineqs = uu___;
        FStar_TypeChecker_Common.implicits =
          (FStar_TypeChecker_Common.trivial_guard.FStar_TypeChecker_Common.implicits)
      }