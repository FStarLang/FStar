...
let rec e_pattern_aq :
  ...
  =
  fun aq ->
    let embed_pattern cb p = failwith "FIXME" in
    let unembed_pattern cb t = failwith "FIXME" in
...
let (e_exp :
  FStar_Reflection_V2_Data.exp FStar_TypeChecker_NBETerm.embedding) =
  let rec embed_exp cb e =
    match e with
    | FStar_Reflection_V2_Data.Unit ->
        mkConstruct
          FStar_Reflection_V2_Constants.ref_E_Unit.FStar_Reflection_V2_Constants.fv
          [] []
    | FStar_Reflection_V2_Data.Var i ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V2_Constants.ref_E_Var.FStar_Reflection_V2_Constants.fv
          [] uu___
    | FStar_Reflection_V2_Data.Mult (e1, e2) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V2_Constants.ref_E_Mult.FStar_Reflection_V2_Constants.fv
          [] uu___ in
  let rec unembed_exp cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, uu___, []) when
        ...
        -> FStar_Pervasives_Native.Some FStar_Reflection_V2_Data.Unit
    | FStar_TypeChecker_NBETerm.Construct (fv, uu___, (i, uu___1)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        FStar_Compiler_Util.bind_opt uu___2
          (fun i1 ->
             FStar_Compiler_Effect.op_Less_Bar
               (fun uu___3 -> FStar_Pervasives_Native.Some uu___3)
               (FStar_Reflection_V2_Data.Var i1))
    | FStar_TypeChecker_NBETerm.Construct
          ...
          (fun e11 ->
             ...
             FStar_Compiler_Util.bind_opt uu___4
               (fun e21 ->
                  FStar_Compiler_Effect.op_Less_Bar
                    (fun uu___5 -> FStar_Pervasives_Native.Some uu___5)
                    (FStar_Reflection_V2_Data.Mult (e11, e21))))
    | uu___ ->
        ((let uu___2 =
            let uu___3 =
              let uu___4 = FStar_TypeChecker_NBETerm.t_to_string t in
  ...
  mk_emb' embed_exp unembed_exp
    FStar_Reflection_V2_Constants.fstar_refl_exp_fv
let (e_qualifier :
