...
let (fetch_eq_side :
  ...
  fun uu___ ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst" (Prims.of_int (63))
         (Prims.of_int (10)) (Prims.of_int (63)) (Prims.of_int (21)))
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst" (Prims.of_int (64))
         (Prims.of_int (2)) (Prims.of_int (88)) (Prims.of_int (39)))
                 ...
                 (fun uu___1 ->
                    (fun uu___1 ->
                                      ...
                                      | FStar_Reflection_Data.Tv_UInst
                                          ...
                                          then
                                            ...
                                            Obj.magic
                                              (FStar_Tactics_Derived.fail
                                                 "not a squash")
                                      | FStar_Reflection_Data.Tv_FVar squash1
                                          ->
                                          if
                                            (FStar_Reflection_Derived.fv_to_string
                                               squash1)
                       ...
                       | uu___2 ->
                           Obj.magic
                             (FStar_Tactics_Derived.fail
                                "not an app at top level")) uu___1))) uu___1)
let mustfail :
  'a .
        ...
        (fun uu___ ->
           (fun uu___ ->
              ...
              | FStar_Pervasives_Native.Some uu___1 ->
                  Obj.magic (Obj.repr (FStar_Tactics_Derived.fail message))
      ...
      (fun uu___ ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              ...
              | FStar_Reflection_Data.Tv_Refine (x, t1) -> "Tv_Refine"
               ...
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.tac_bind
                       ...
                       (fun uu___ ->
                          (fun uu___ ->
                             Obj.magic (FStar_Tactics_Derived.fail uu___))
                            uu___)))) uu___1 uu___
let lift_exn_tactic :
  'a 'b .
    ('a -> 'b match_res) -> 'a -> ('b, unit) FStar_Tactics_Effect.tac_repr
      ...
      fun tm ->
        FStar_Tactics_Effect.tac_bind
          (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
             ...
             (Prims.of_int (46)))
          (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
             (Prims.of_int (298)) (Prims.of_int (2)) (Prims.of_int (323))
             (Prims.of_int (19)))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ ->
                fun v ->
                ...
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                        ...
                        (Prims.of_int (323)) (Prims.of_int (19)))
                     (FStar_Tactics_Effect.lift_div_tac
                        (fun uu___ ->
                           fun qn1 ->
                             fun cur_bindings1 ->
                  ...
                  Obj.magic
                    (Obj.repr
                       (FStar_Tactics_Effect.tac_bind
                          ...
                          (fun uu___1 ->
                             (fun uu___1 ->
                                Obj.magic (FStar_Tactics_Derived.fail uu___1))
                               uu___1)))) uu___)
  ...
  fun ms ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         ...
         (Prims.of_int (57)))
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         (Prims.of_int (388)) (Prims.of_int (2)) (Prims.of_int (393))
         (Prims.of_int (26)))
      (Obj.magic
         (FStar_Tactics_Effect.tac_bind
            (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
            ...
            | h::hs ->
                FStar_Tactics_Derived.or_else
                  (fun uu___ ->
                     FStar_Tactics_Effect.tac_bind
                       (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                          (Prims.of_int (448)) (Prims.of_int (15))
                          (Prims.of_int (448)) (Prims.of_int (73)))
                       (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                          (Prims.of_int (448)) (Prims.of_int (9))
                          (Prims.of_int (453)) (Prims.of_int (73)))
                       (Obj.magic
  ...
  fun binder ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         ...
         (Prims.of_int (19)))
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         (Prims.of_int (585)) (Prims.of_int (2)) (Prims.of_int (596))
         (Prims.of_int (34)))
         ...
         (fun varname1 ->
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                    (Prims.of_int (586)) (Prims.of_int (2))
                    (Prims.of_int (596)) (Prims.of_int (34)))
                 (FStar_Tactics_Effect.lift_div_tac
                ...
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.tac_bind
                        ...
                        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                           (Prims.of_int (602)) (Prims.of_int (4))
                           (Prims.of_int (603)) (Prims.of_int (27)))
  ...
  fun tm ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         ...
         (Prims.of_int (65)))
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         (Prims.of_int (626)) (Prims.of_int (2)) (Prims.of_int (665))
         (Prims.of_int (18)))
      (Obj.magic
         (FStar_Tactics_Effect.tac_bind
            (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                ...
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                        ...
                        (Prims.of_int (665)) (Prims.of_int (18)))
                     (Obj.magic
                        (FStar_Tactics_Effect.tac_bind
                           (Prims.mk_range
                              "FStar.Tactics.PatternMatching.fst"
    ...
    fun argspec ->
      FStar_Tactics_Effect.tac_bind
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           ...
           (Prims.of_int (56)))
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           (Prims.of_int (693)) (Prims.of_int (2)) (Prims.of_int (696))
           (Prims.of_int (27)))
        (FStar_Tactics_Effect.lift_div_tac
                   ...
                   Obj.magic
                     (Obj.repr
                        (FStar_Tactics_Effect.tac_bind
                           ...
                           (Prims.mk_range
                              "FStar.Tactics.PatternMatching.fst"
                              (Prims.of_int (708)) (Prims.of_int (4))
                              (Prims.of_int (709)) (Prims.of_int (113)))
                           (FStar_Tactics_Effect.lift_div_tac
                              (fun uu___ ->
    ...
    fun solution_term ->
      FStar_Tactics_Effect.tac_bind
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           ...
           (Prims.of_int (54)))
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           (Prims.of_int (716)) (Prims.of_int (2)) (Prims.of_int (717))
           (Prims.of_int (52)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ ->
              fun argspec ->
  ...
  fun continuation ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         ...
         (Prims.of_int (57)))
      (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
         (Prims.of_int (725)) (Prims.of_int (2)) (Prims.of_int (731))
         (Prims.of_int (9)))
      (Obj.magic
         ...
         (fun solution_binder ->
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                    (Prims.of_int (726)) (Prims.of_int (2))
                    (Prims.of_int (731)) (Prims.of_int (9)))
                 (Obj.magic
                    (FStar_Tactics_Builtins.pack
                       (FStar_Reflection_Data.Tv_Var
                          (FStar_Reflection_Derived.bv_of_binder
    ...
    fun k ->
      FStar_Tactics_Effect.tac_bind
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           ...
           (Prims.of_int (24)))
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           (Prims.of_int (758)) (Prims.of_int (2)) (Prims.of_int (760))
           (Prims.of_int (51)))
        (Obj.magic (FStar_Tactics_Derived.cur_goal ()))
        (fun uu___ ->
           (fun goal ->
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   ...
                   (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
                      ...
                      (Prims.of_int (760)) (Prims.of_int (51)))
                   (Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
    ...
    fun uu___ ->
      FStar_Tactics_Effect.tac_bind
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           ...
           (Prims.of_int (56)))
        (Prims.mk_range "FStar.Tactics.PatternMatching.fst"
           (Prims.of_int (788)) (Prims.of_int (2)) (Prims.of_int (789))
