...
let (dbg_bind : Prims.bool FStar_Compiler_Effect.ref) =
  FStar_Compiler_Debug.get_toggle "Bind"
let (dbg_Coercions : Prims.bool FStar_Compiler_Effect.ref) =
  FStar_Compiler_Debug.get_toggle "Coercions"
let (dbg_Dec : Prims.bool FStar_Compiler_Effect.ref) =
  FStar_Compiler_Debug.get_toggle "Dec"
...
let (dbg_Pat : Prims.bool FStar_Compiler_Effect.ref) =
  FStar_Compiler_Debug.get_toggle "Pat"
...
let (dbg_Return : Prims.bool FStar_Compiler_Effect.ref) =
  FStar_Compiler_Debug.get_toggle "Return"
        ...
        (FStar_Options.push ();
         ...
         (let uu___5 =
          ...
          FStar_Errors.log_issue FStar_Class_HasRange.hasRange_range r
            FStar_Errors_Codes.Error_UncontrainedUnificationVar ()
      ...
      | { FStar_Syntax_Syntax.lbname = lbname;
          ...
          (match uu___4 with
           | (u_subst, univ_vars1) ->
               ...
               ((let uu___6 = FStar_Compiler_Effect.op_Bang dbg_Dec in
                 if uu___6
                 then
                   let uu___7 =
                                 ...
                                 (if (FStar_Compiler_List.length bs') <> n_bs
                                  then
                                    (let uu___9 =
                                       ...
                                       let uu___11 =
                                         let uu___12 =
                                           FStar_Errors_Msg.text "(explain)" in
                                         [uu___12] in
                                       uu___10 :: uu___11 in
                                     FStar_Errors.raise_error
                   ...
                   let rec aux_lbdef e2 =
                              ...
                              let uu___10 =
                                let uu___11 =
                                  ...
                                  let uu___13 =
                                    let uu___14 =
                                      FStar_Class_PP.pp
                                        FStar_Syntax_Print.pretty_comp c in
                                    let uu___15 =
                                      FStar_Errors_Msg.text "instead" in
                     ...
                     | uu___6 ->
                         let uu___7 =
                           ...
                           let uu___9 =
                             let uu___10 =
                               let uu___11 = FStar_Errors_Msg.text "Got" in
                               let uu___12 =
                                 let uu___13 =
                                   FStar_Class_PP.pp
                                     FStar_Syntax_Print.pretty_term e3 in
                                 let uu___14 =
                                   FStar_Errors_Msg.text "instead" in
                           ...
                           uu___8 :: uu___9 in
                         FStar_Errors.raise_error
                           (FStar_Syntax_Syntax.has_range_syntax ()) e3
                           FStar_Errors_Codes.Fatal_UnexpectedComputationTypeForLetRec
                           ()
                           (Obj.magic
                              FStar_Errors_Msg.is_error_message_list_doc)
      ...
      fun r ->
        let err uu___ =
          let uu___1 =
            let uu___2 =
              let uu___3 =
                FStar_Errors_Msg.text "Could not get effect args from repr" in
              let uu___4 =
                let uu___5 =
                  FStar_Class_PP.pp FStar_Syntax_Print.pretty_term repr in
                let uu___6 =
                  let uu___7 = FStar_Errors_Msg.text "with is_layered=" in
                  let uu___8 =
                    FStar_Class_PP.pp FStar_Class_PP.pp_bool is_layered in
        ...
        fun a ->
          fun e ->
            fun r ->
              ...
              (let uu___1 = FStar_Compiler_Effect.op_Bang dbg_Return in
               if uu___1
               then
                 let uu___2 =
             ...
             | FStar_Pervasives_Native.None ->
                 ...
                 (match uu___2 with
                  ...
                  | FStar_Pervasives_Native.None ->
                      let uu___3 =
                        let uu___4 =
                          let uu___5 = FStar_Errors_Msg.text "Effects" in
                          let uu___6 =
                            let uu___7 =
                              FStar_Class_PP.pp FStar_Ident.pretty_lident
                                l1_in in
                            let uu___8 =
                              let uu___9 = FStar_Errors_Msg.text "and" in
                              let uu___10 =
                                let uu___11 =
                                  FStar_Class_PP.pp FStar_Ident.pretty_lident
                                    l2_in in
                                let uu___12 =
                                  FStar_Errors_Msg.text "cannot be composed" in
                                FStar_Pprint.op_Hat_Slash_Hat uu___11 uu___12 in
        ...
        fun b ->
          fun for_bind ->
            ...
            | FStar_Pervasives_Native.None ->
                let uu___1 =
                  let uu___2 =
                    let uu___3 = FStar_Errors_Msg.text "Effects" in
                    let uu___4 =
                      let uu___5 =
                        FStar_Class_PP.pp FStar_Ident.pretty_lident
                          c11.FStar_Syntax_Syntax.effect_name in
                      let uu___6 =
                        let uu___7 = FStar_Errors_Msg.text "and" in
                        let uu___8 =
                          let uu___9 =
                            FStar_Class_PP.pp FStar_Ident.pretty_lident
                              c21.FStar_Syntax_Syntax.effect_name in
                ...
                FStar_Errors.raise_error FStar_TypeChecker_Env.hasRange_env
                  env FStar_Errors_Codes.Fatal_EffectsCannotBeComposed ()
                  (Obj.magic FStar_Errors_Msg.is_error_message_list_doc)
                  (Obj.magic uu___1)
let (lift_comps :
  FStar_TypeChecker_Env.env ->
        ...
        fun b_bv ->
          fun ct_args ->
            fun num_effect_params ->
              fun r ->
                let debug =
                  FStar_Compiler_Effect.op_Bang dbg_LayeredEffectsApp in
                let uu___ =
                            ...
                            FStar_TypeChecker_Env.uvars_for_binders env
                              ...
                              (fun b1 ->
                                 ...
                                 then
                                   let uu___2 =
                                     FStar_Class_Show.show
                                       FStar_Syntax_Print.showable_binder b1 in
    ...
    fun ed ->
      fun u_a ->
        fun a ->
          fun e ->
            fun r ->
              let debug = FStar_Compiler_Effect.op_Bang dbg_LayeredEffectsApp in
              if debug
              then
                (let uu___1 =
                   FStar_Ident.string_of_lid ed.FStar_Syntax_Syntax.mname in
                 let uu___2 =
                   FStar_Class_Show.show FStar_Syntax_Print.showable_univ u_a in
                 let uu___3 =
                   ...
                   let return_t_shape_error r1 s =
                     let uu___3 =
                       let uu___4 =
                         ...
                         let uu___6 =
                           let uu___7 = FStar_Errors_Msg.text ".return" in
                           let uu___8 =
                             FStar_Errors_Msg.text
                       ...
                       let uu___5 =
                         let uu___6 =
                           let uu___7 = FStar_Errors_Msg.text "Reason: " in
                         ...
                         | (rest_bs_uvars, g_uvars) ->
                             ...
                             (if debug
                              then
                                (let uu___6 =
                                   FStar_Class_Show.show
                                     FStar_Syntax_Print.showable_comp c in
                          ...
                          fun has_range_binders ->
                            ...
                            then
                              (let uu___1 =
                                 ...
                                 FStar_Class_Show.show
                                   FStar_Syntax_Print.showable_comp uu___2 in
                               let uu___2 =
                                 let uu___3 = FStar_Syntax_Syntax.mk_Comp ct2 in
                                 FStar_Class_Show.show
                                   FStar_Syntax_Print.showable_comp uu___3 in
                               FStar_Compiler_Util.print2
                                     ...
                                     let uu___5 =
                                       let uu___6 =
                                         ...
                                         let uu___8 =
                                           ...
                                           let uu___10 =
                                             let uu___11 =
                                               FStar_Errors_Msg.text "since" in
                                             let uu___12 =
                                               let uu___13 =
                                                 FStar_Class_PP.pp
                                                   FStar_Ident.pretty_lident
                                                   p in
                                               let uu___14 =
                                                 FStar_Errors_Msg.text
                ...
                let debug f =
                  let uu___1 =
                    (FStar_Compiler_Debug.extreme ()) ||
                      (FStar_Compiler_Effect.op_Bang dbg_bind) in
            ...
            fun ct_else ->
              fun r ->
                ...
                let conjunction_t_error r1 s =
                  let uu___ =
                    let uu___1 =
                      let uu___2 = FStar_Errors_Msg.text "Conjunction" in
                      let uu___3 =
                        let uu___4 =
                          FStar_Class_PP.pp FStar_Ident.pretty_lident
                            ct_then.FStar_Syntax_Syntax.effect_name in
                        let uu___5 =
                          FStar_Errors_Msg.text "does not have proper shape." in
                        FStar_Pprint.op_Hat_Hat uu___4 uu___5 in
                      FStar_Pprint.op_Hat_Hat uu___2 uu___3 in
                    let uu___2 =
                      let uu___3 =
                        let uu___4 = FStar_Errors_Msg.text "Reason: " in
                        let uu___5 = FStar_Errors_Msg.text s in
                        FStar_Pprint.op_Hat_Hat uu___4 uu___5 in
                      [uu___3] in
                    uu___1 :: uu___2 in
                  FStar_Errors.raise_error
                           ...
                           (if debug
                            then
                              (let uu___4 =
                                 ...
                                 FStar_Class_Show.show
                                   FStar_Syntax_Print.showable_comp uu___5 in
                               let uu___5 =
                                 let uu___6 = FStar_Syntax_Syntax.mk_Comp ct2 in
                                 FStar_Class_Show.show
                                   FStar_Syntax_Print.showable_comp uu___6 in
                               FStar_Compiler_Util.print2
           ...
           then FStar_Syntax_Syntax.U_zero
             ...
             (let uu___3 = FStar_TypeChecker_Env.effect_repr env c u_res in
              ...
              | FStar_Pervasives_Native.None ->
                  let uu___4 =
                    let uu___5 =
                      FStar_Class_Show.show FStar_Ident.showable_lident c_lid in
                    FStar_Compiler_Util.format1
                      "Effect %s is marked total but does not have a repr"
                      uu___5 in
                  FStar_Errors.raise_error
                    (FStar_Syntax_Syntax.has_range_syntax ()) c
            ...
            fun eargs ->
              fun comp2 ->
                ...
                | FStar_Pervasives_Native.Some uu___1 ->
                    ((let uu___3 =
                        FStar_Compiler_Effect.op_Bang dbg_Coercions in
                      if uu___3
                      then
            ...
            ((let uu___2 = FStar_Compiler_Effect.op_Bang dbg_Coercions in
             ...
             (let uu___2 = find_coercion env lc exp_t e in
              ...
              | FStar_Pervasives_Native.Some (coerced, lc1, g) ->
                  ((let uu___4 = FStar_Compiler_Effect.op_Bang dbg_Coercions in
                    if uu___4
                    then
                      let uu___5 =
                        FStar_Compiler_Range_Ops.string_of_range
                      ...
                      let uu___7 =
                        FStar_Class_Show.show
                          FStar_Syntax_Print.showable_term coerced in
          ...
          fun use_eq ->
            ...
            (let use_eq1 =
             ...
             | (FStar_Pervasives_Native.None, uu___1) ->
                 ...
                 then
                   FStar_TypeChecker_Err.raise_basic_type_error env
                     e.FStar_Syntax_Syntax.pos
                            ...
                            then
                              ((let uu___6 = FStar_Compiler_Debug.extreme () in
                                ...
                                then
                                  let uu___7 =
                                    FStar_Class_Show.show
                                      FStar_Syntax_Print.showable_term res_t in
                                  let uu___8 =
                                    FStar_Class_Show.show
        ...
        (let t' =
           FStar_TypeChecker_Normalize.normalize
             (FStar_Compiler_List.op_At
                ...
                FStar_TypeChecker_Env.Exclude FStar_TypeChecker_Env.Zeta]
                steps) env t in
         (let uu___2 = FStar_Compiler_Effect.op_Bang dbg_SMTEncodingReify in
          if uu___2
          then
            let uu___3 =
              FStar_Class_Show.show FStar_Syntax_Print.showable_term t in
                              ...
                              let uu___13 =
                                ...
                                let uu___15 =
                                  let uu___16 =
                                    FStar_Class_PP.pp FStar_Class_PP.pp_int
                                      n_available in
                                  let uu___17 = FStar_Errors_Msg.text "." in
        ...
        fun t2 ->
          fun use_eq ->
            ...
            | FStar_Pervasives_Native.None ->
                ...
                FStar_TypeChecker_Err.expected_expression_of_type env1 uu___
                  t2 e t1
                       ...
                       | FStar_Pervasives_Native.None ->
                           ...
                           let uu___7 =
                             ...
                             FStar_Compiler_Util.format1
                               ...
                               uu___8 in
                           FStar_Errors.raise_error
                             FStar_Class_HasRange.hasRange_range uu___6
                             FStar_Errors_Codes.Fatal_UnexpectedEffect ()
                             (Obj.magic
                                FStar_Errors_Msg.is_error_message_string)
                             (Obj.magic uu___7)
        ...
        fun signature_ts ->
          fun repr_ts_opt ->
            fun u ->
              fun a_tm ->
                let fail t =
                  FStar_TypeChecker_Err.unexpected_signature_for_monad env r
                    eff_name t in
          ...
          fun c ->
            ...
            then
              (let uu___1 =
                 FStar_Class_Show.show FStar_Syntax_Print.showable_comp c in
               let uu___2 =
                 FStar_Class_Show.show FStar_Ident.showable_lident tgt in
               FStar_Compiler_Util.print2
                        ...
                        | (substs, g) ->
                            ...
                            ((let uu___7 =
                              ...
                              then
                                let uu___8 =
                                  FStar_Class_Show.show
                                    FStar_Syntax_Print.showable_term fml in
                                FStar_Compiler_Util.print1
        ...
        fun a ->
          fun e ->
            ...
            let rest_bs =
              ...
              | uu___1 ->
                  let uu___2 =
                    let uu___3 = FStar_Syntax_Print.tscheme_to_string lift_t in
                    FStar_Compiler_Util.format1
      ...
      fun index ->
        ...
        | (uu___1, t) ->
            let err n =
              let uu___2 =
                let uu___3 =
                  FStar_Class_Show.show FStar_Ident.showable_lident datacon in
                let uu___4 =
                  FStar_Class_Show.show
                    (FStar_Class_Show.printableshow
          ...
          let default_rdc uu___ =
            ...
            | (FStar_Pervasives_Native.None, []) ->
                let uu___1 =
                  ...
                  [uu___2] in
                FStar_Errors.raise_error FStar_Class_HasRange.hasRange_range
                  rng FStar_Errors_Codes.Error_CannotResolveRecord ()
                  (Obj.magic FStar_Errors_Msg.is_error_message_list_doc)
                  (Obj.magic uu___1)
            | (FStar_Pervasives_Native.None, f::uu___1) ->
                ...
                let uu___2 =
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = FStar_Ident.string_of_lid f1 in
                      FStar_Compiler_Util.format1
                        "Field name %s could not be resolved." uu___5 in
                    FStar_Errors_Msg.text uu___4 in
                  [uu___3] in
                FStar_Errors.raise_error FStar_Ident.hasrange_lident f1
                  FStar_Errors_Codes.Error_CannotResolveRecord ()
                  (Obj.magic FStar_Errors_Msg.is_error_message_list_doc)
                  (Obj.magic uu___2)
            | (FStar_Pervasives_Native.Some tn, uu___1) ->
                ...
                (match uu___2 with
                 ...
                 | FStar_Pervasives_Native.None ->
                     ...
                     FStar_Errors.raise_error FStar_Ident.hasrange_lident tn
