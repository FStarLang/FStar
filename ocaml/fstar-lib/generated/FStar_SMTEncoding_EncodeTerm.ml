  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_abs
          { FStar_Syntax_Syntax.bs = uu___1;
            FStar_Syntax_Syntax.body = uu___2;
            FStar_Syntax_Syntax.rc_opt = FStar_Pervasives_Native.Some rc;_}
          ->
...
let rec (curried_arrow_formals_comp :
  ...
  fun k ->
    ...
    | FStar_Syntax_Syntax.Tm_refine
        { FStar_Syntax_Syntax.b = bv; FStar_Syntax_Syntax.phi = uu___;_} ->
    ...
    fun env ->
      ...
      (let t1 = FStar_Syntax_Subst.compress t in
       ...
       (match t1.FStar_Syntax_Syntax.n with
            ...
            let encode_freev uu___2 =
              ...
              let uu___3 =
                ...
                then
                  ...
                  | FStar_SMTEncoding_Term.FreeV uu___4 ->
                      let sym_name =
                        let uu___5 =
                          FStar_Compiler_Util.digest_of_string tkey_hash in
                        Prims.op_Hat "@kick_partial_app_" uu___5 in
                      let uu___5 =
                        let uu___6 =
                          let uu___7 =
                            let uu___8 =
                        ...
                        [uu___6] in
                      (uu___5, sym_name)
                  | FStar_SMTEncoding_Term.App (uu___4, []) ->
                      let sym_name =
                        let uu___5 =
                          FStar_Compiler_Util.digest_of_string tkey_hash in
                        Prims.op_Hat "@kick_partial_app_" uu___5 in
        ...
        | FStar_Syntax_Syntax.Tm_uinst (t2, uu___2) -> encode_term t2 env
                                   ...
                                   | (guards, guard_decls) ->
                                       ...
                                       let t_interp =
                                         let uu___9 =
                                           ...
                                           ([[app]], vars, uu___10) in
                                         FStar_SMTEncoding_Term.mkForall
                                           t1.FStar_Syntax_Syntax.pos uu___9 in
                                       let t_interp1 =
                                         let tot_fun_axioms =
                                           isTotFun_axioms
                                             t1.FStar_Syntax_Syntax.pos f
                   ...
                   (let tkey_hash =
                                ...
                                | (effect_args, uu___11) ->
                                    let tkey =
                                      let uu___12 =
                                        ...
                                        ([], vars, uu___13) in
                                      FStar_SMTEncoding_Term.mkForall
                                        t1.FStar_Syntax_Syntax.pos uu___12 in
                                    let tkey_hash1 =
                                      let uu___12 =
                                        let uu___13 =
                                          FStar_SMTEncoding_Term.hash_of_term
                                        ...
                                        let uu___14 =
                                          ...
                                          Prims.op_Hat "@Effect=" uu___15 in
                               ...
                               | (env1, decls, vars, tms, guards) ->
                                   let uu___8 =
                                     FStar_TypeChecker_Env.lookup_bv
                                       env1.FStar_SMTEncoding_Env.tcenv bv in
                                   (match uu___8 with
                                    | (sort, uu___9) ->
                                        let uu___10 =
                    ...
                    | (fstar_fvs,
                       (env1, fv_decls, fv_vars, fv_tms, fv_guards)) ->
                        let fv_decls1 = FStar_Compiler_List.rev fv_decls in
                        let fv_vars1 = FStar_Compiler_List.rev fv_vars in
                        let fv_tms1 = FStar_Compiler_List.rev fv_tms in
                        let fv_guards1 = FStar_Compiler_List.rev fv_guards in
                        let arg_sorts =
                          FStar_Compiler_List.map
                            (fun uu___6 -> FStar_SMTEncoding_Term.Term_sort)
                            fv_tms1 in
                        let tdecl =
                          FStar_SMTEncoding_Term.DeclFun
                            (tsym, arg_sorts,
                              ...
                              FStar_Pervasives_Native.None) in
                        let tapp =
                          FStar_SMTEncoding_Util.mkApp (tsym, fv_tms1) in
                        let t_kinding =
                          let a_name =
                          ...
                          let axiom =
                            ...
                            FStar_SMTEncoding_Term.mkForall
                              t0.FStar_Syntax_Syntax.pos uu___6 in
                          let svars =
                            FStar_SMTEncoding_Term.free_variables axiom in
                          let axiom1 =
                            FStar_SMTEncoding_Term.mkForall
                              t0.FStar_Syntax_Syntax.pos ([], svars, axiom) in
                          FStar_SMTEncoding_Util.mkAssume
                            (axiom1,
                              (FStar_Pervasives_Native.Some
                        ...
                        let tapp_concrete =
                          let uu___6 =
                            let uu___7 =
                              FStar_Compiler_List.map
                                (FStar_SMTEncoding_Env.lookup_term_var env0)
                                fstar_fvs in
                            (tsym, uu___7) in
                          FStar_SMTEncoding_Util.mkApp uu___6 in
                        let uu___6 =
                          let uu___7 =
                            FStar_SMTEncoding_Term.mk_decls tsym tkey_hash
                              [tdecl; t_kinding] [] in
                          FStar_Compiler_List.op_At fv_decls1 uu___7 in
        ...
        | FStar_Syntax_Syntax.Tm_refine uu___2 ->
            ...
            (match uu___3 with
             | (x, f) ->
                 ...
                 (match uu___4 with
                  | (base_t, decls) ->
                      let uu___5 = FStar_SMTEncoding_Env.gen_term_var env x in
                      (match uu___5 with
                       | (x1, xtm, env') ->
                                     ...
                                     ((let uu___9 =
                                      ...
                                      (let tsym =
                                         let uu___9 =
                                           FStar_Compiler_Util.digest_of_string
                                             tkey_hash in
                                         Prims.op_Hat "Tm_refine_" uu___9 in
                                       let cvar_sorts =
                                         FStar_Compiler_List.map
                                           FStar_SMTEncoding_Term.fv_sort
                                           cvars1 in
        ...
        | FStar_Syntax_Syntax.Tm_uvar (uv, uu___2) ->
            let ttm =
              ...
              FStar_SMTEncoding_Util.mk_Term_uvar uu___3 in
            let uu___3 =
                   ...
                   let uu___4 =
                     let uu___5 =
                       let uu___6 =
                         ...
                         FStar_Compiler_Util.format1 "uvar_typing_%s" uu___7 in
        ...
        | FStar_Syntax_Syntax.Tm_app uu___2 ->
            let uu___3 = FStar_Syntax_Util.head_and_args t0 in
            (match uu___3 with
             | (head, args_e) ->
                 let uu___4 =
                 ...
                 (match uu___4 with
                  | (head1, args_e1) ->
                      let uu___5 =
                        let uu___6 =
                          let uu___7 = FStar_Syntax_Subst.compress head1 in
                      ...
                      (match uu___5 with
                       ...
                       | (FStar_Syntax_Syntax.Tm_fvar fv, (arg, uu___6)::[])
                           when
                           ((FStar_Syntax_Syntax.fv_eq_lid fv
                       ...
                       | (FStar_Syntax_Syntax.Tm_uinst
                          ...
                          (arg, uu___10)::[]) when
                           ...
                           let t2 = FStar_Syntax_Util.refine dummy arg in
                           encode_term t2 env
                       | (FStar_Syntax_Syntax.Tm_fvar fv, uu___6) when
                           (Prims.op_Negation
                       ...
                       | (FStar_Syntax_Syntax.Tm_constant
                          (FStar_Const.Const_range_of), (arg, uu___6)::[]) ->
                           encode_const
                                      ...
                                      { FStar_Syntax_Syntax.tm = uu___8;
                                        FStar_Syntax_Syntax.asc =
                                          (FStar_Pervasives.Inl t2, uu___9,
                                           uu___10);
                                        FStar_Syntax_Syntax.eff_opt = uu___11;_}
                                      -> FStar_Pervasives_Native.Some t2
                                  | FStar_Syntax_Syntax.Tm_ascribed
                                      { FStar_Syntax_Syntax.tm = uu___8;
                                        FStar_Syntax_Syntax.asc =
            ...
            (match uu___2 with
             | (bs1, body1, opening) ->
                 ...
                 let codomain_eff rc =
                   ...
                   if uu___3
                   then
                     let uu___4 = FStar_Syntax_Syntax.mk_Total res_typ in
                     ...
                     (let uu___5 =
                      ...
                      if uu___5
                      then
                        let uu___6 = FStar_Syntax_Syntax.mk_GTotal res_typ in
                                   ...
                                   | (arrow_t_opt, decls'') ->
                                       let key_body =
                                         let uu___9 =
                                           ...
                                           ([], vars, uu___10) in
                                         FStar_SMTEncoding_Term.mkForall
                                           t0.FStar_Syntax_Syntax.pos uu___9 in
                                       let cvars =
                                         FStar_SMTEncoding_Term.free_variables
                                           key_body in
                                       let uu___9 =
