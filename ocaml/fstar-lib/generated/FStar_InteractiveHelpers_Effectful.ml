...
let (cast_info_to_string :
  ...
  fun info ->
    let uu___ =
      let uu___1 = FStar_Tactics_V1_Builtins.term_to_string info.term in
    ...
    let uu___ =
      let uu___1 =
        let uu___2 =
          let uu___3 =
            FStar_InteractiveHelpers_Base.option_to_string
              FStar_Tactics_V1_Builtins.term_to_string c.ei_pre in
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
  ...
  fun dbg ->
    fun c ->
      let uu___ =
        Obj.magic
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___1 -> FStar_Reflection_V1_Builtins.inspect_comp c)) in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.InteractiveHelpers.Effectful.fst"
    ...
    fun t ->
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___1 ->
           (fun uu___1 ->
              match uu___1 with
              | FStar_Reflection_V1_Data.Tv_App (uu___2, uu___3) ->
                    ...
                    (FStar_Tactics_Effect.tac_bind
                       ...
                       (fun uu___5 ->
                          (fun uu___5 ->
                             ...
                             | (hd, args) ->
                                 let uu___6 =
                                   FStar_Tactics_V1_Builtins.tcc e hd in
                                 Obj.magic
                                   (FStar_Tactics_Effect.tac_bind
                                      (FStar_Sealed.seal
                                         (Obj.magic
                                            ...
                                            Obj.magic
                                              (FStar_InteractiveHelpers_ExploreTerm.inst_comp
                                                 ...
                                                 (FStar_List_Tot_Base.map
                                                    ...
                                                    args))) uu___7))) uu___5))
              | uu___2 -> Obj.magic (FStar_Tactics_V1_Builtins.tcc e t))
             uu___1)
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___2 ->
              match uu___1 with
              | FStar_Reflection_V1_Data.Tv_Refine (uu___3, sort, uu___4) ->
                  sort
              | uu___3 -> ty))
...
let (is_st_get :
  ...
  fun dbg ->
    fun t ->
      let uu___ =
        let uu___1 =
          let uu___2 = FStar_Tactics_V1_Builtins.term_to_string t in
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___1 ->
           (fun uu___1 ->
              let uu___2 = FStar_Tactics_V1_Builtins.inspect t in
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Sealed.seal
                      (Obj.magic
  ...
  fun dbg ->
    fun t ->
      let uu___ =
        let uu___1 =
          let uu___2 =
            let uu___3 = FStar_Tactics_V1_Builtins.pack t in
            FStar_Tactics_Effect.tac_bind
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
              ...
              (fun uu___4 ->
                 (fun uu___4 ->
                    Obj.magic
                      (FStar_Tactics_V1_Builtins.term_to_string uu___4))
                   uu___4) in
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
      ...
      fun tv ->
        ...
        FStar_Tactics_Effect.tac_bind
          ...
          (fun uu___1 ->
             (fun is_effectful ->
                match tv with
                | FStar_Reflection_V1_Data.Tv_Var uu___1 ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___2 -> false)))
                | FStar_Reflection_V1_Data.Tv_BVar uu___1 ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___2 -> false)))
                | FStar_Reflection_V1_Data.Tv_FVar uu___1 ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___2 -> false)))
                ...
                | FStar_Reflection_V1_Data.Tv_AscribedT (e, ty, tac, uu___1)
                    ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___2 -> false)))
                | FStar_Reflection_V1_Data.Tv_AscribedC (e, c, tac, uu___1)
                    ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                   ...
                   Obj.magic
                     (Obj.repr
                        (let uu___ =
                           let uu___1 =
                             let uu___2 =
                               let uu___3 = FStar_Tactics_V1_Builtins.pack tv in
                               FStar_Tactics_Effect.tac_bind
                                 (FStar_Sealed.seal
                                    (Obj.magic
                                       (FStar_Range.mk_range
...
let rec (find_mem_in_children :
  ...
  fun dbg ->
    fun ge ->
      fun child ->
        let uu___ = FStar_Tactics_V1_Builtins.inspect child in
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range
