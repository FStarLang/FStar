...
let (bv_eq :
  ...
  fun bv1 ->
    fun bv2 ->
      let bvv1 = FStar_Reflection_V1_Builtins.inspect_bv bv1 in
      let bvv2 = FStar_Reflection_V1_Builtins.inspect_bv bv2 in
      bvv1.FStar_Reflection_V1_Data.bv_index =
        bvv2.FStar_Reflection_V1_Data.bv_index
let (fv_eq :
  FStar_Reflection_Types.fv -> FStar_Reflection_Types.fv -> Prims.bool) =
  fun fv1 ->
    fun fv2 ->
      let n1 = FStar_Reflection_V1_Builtins.inspect_fv fv1 in
      let n2 = FStar_Reflection_V1_Builtins.inspect_fv fv2 in n1 = n2
let (fv_eq_name :
  FStar_Reflection_Types.fv -> FStar_Reflection_Types.name -> Prims.bool) =
  fun fv ->
    fun n -> let fvn = FStar_Reflection_V1_Builtins.inspect_fv fv in fvn = n
let opt_apply :
  'a 'b .
    ('a -> 'b) ->
    ...
    fun t ->
      fun params ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ -> FStar_Reflection_V1_Derived.mk_e_app t params))
          (fun uu___ ->
             (fun t1 ->
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (Obj.magic
                        (FStar_Tactics_V1_Builtins.norm_term_env e [] t1))
                     (fun t2 ->
                      ...
                      (fun uu___1 ->
                         Prims.strcat uu___
                           (Prims.strcat " (%"
                              (Prims.strcat
                                 (Prims.string_of_int
                                    bvv.FStar_Reflection_V1_Data.bv_index)
                                 ")")))))) uu___)
let (print_binder_info :
  ...
  fun full ->
    fun b ->
      match FStar_Reflection_V1_Builtins.inspect_binder b with
      | { FStar_Reflection_V1_Data.binder_bv = binder_bv;
          FStar_Reflection_V1_Data.binder_qual = binder_qual;
          FStar_Reflection_V1_Data.binder_attrs = binder_attrs;
          FStar_Reflection_V1_Data.binder_sort = binder_sort;_} ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                                                            ...
                                                            Obj.magic
                                                              (FStar_Tactics_Effect.tac_bind
                                                                 ...
                                                                 (Obj.magic
                                                                    ...
                                                                    Prims.strcat
                                                                    (Prims.string_of_int
                                                                    bview.FStar_Reflection_V1_Data.bv_index)
                                                                    uu___3))))
                                                                    (fun
                                                                    uu___3 ->
                                                                    FStar_Tactics_Effect.lift_div_tac
  ...
  fun full ->
    fun e ->
      FStar_Tactics_Util.iter (print_binder_info full)
        (FStar_Reflection_V1_Builtins.binders_of_env e)
let (acomp_to_string :
  ...
  fun c ->
    ...
    | FStar_Reflection_V1_Data.C_Total ret ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
    ...
    | FStar_Reflection_V1_Data.C_GTotal ret ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range
                         ...
                         (Prims.of_int (117)) (Prims.of_int (18))
                         (Prims.of_int (117)) (Prims.of_int (72)))))
                (Obj.magic (FStar_Tactics_V1_Builtins.term_to_string pre))
                (fun uu___ ->
                   (fun uu___ ->
                      Obj.magic
                        (FStar_Tactics_Effect.tac_bind
    ...
    | FStar_Reflection_V1_Data.C_Eff (us, eff_name, result, eff_args, uu___)
        ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
  ...
  fun uu___1 ->
    fun uu___ ->
      (fun debug ->
         fun s ->
           if debug
           then Obj.magic (Obj.repr (FStar_Tactics_V1_Builtins.print s))
           else
             Obj.magic
               (Obj.repr
    ...
    (fun t ->
       Obj.magic
         (FStar_Tactics_Effect.lift_div_tac
            (fun uu___ ->
               match t with
               | FStar_Reflection_V1_Data.Tv_Var uu___1 -> "Tv_Var"
               | FStar_Reflection_V1_Data.Tv_BVar uu___1 -> "Tv_BVar"
               | FStar_Reflection_V1_Data.Tv_FVar uu___1 -> "Tv_FVar"
               | FStar_Reflection_V1_Data.Tv_App (uu___1, uu___2) -> "Tv_App"
               | FStar_Reflection_V1_Data.Tv_Abs (uu___1, uu___2) -> "Tv_Abs"
               | FStar_Reflection_V1_Data.Tv_Arrow (uu___1, uu___2) ->
                   "Tv_Arrow"
               | FStar_Reflection_V1_Data.Tv_Type uu___1 -> "Tv_Type"
               | FStar_Reflection_V1_Data.Tv_Refine (uu___1, uu___2, uu___3)
                   -> "Tv_Refine"
               | FStar_Reflection_V1_Data.Tv_Const uu___1 -> "Tv_Const"
                          ...
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range
                                   "FStar.InteractiveHelpers.Base.fst"
                                   (Prims.of_int (173)) (Prims.of_int (45))
                                   (Prims.of_int (173)) (Prims.of_int (61)))))
                          (FStar_Sealed.seal
                             (Obj.magic
                                (FStar_Range.mk_range
                                   "FStar.InteractiveHelpers.Base.fst"
                ...
                (FStar_Tactics_Visit.visit_tm
                   (fun t1 ->
                      FStar_Tactics_Effect.tac_bind
                        ...
                        (Obj.magic (FStar_Tactics_V1_Builtins.inspect t1))
                        (fun uu___1 ->
                           FStar_Tactics_Effect.lift_div_tac
                             (fun uu___2 ->
                                match uu___1 with
...
let rec bind_map_get :
  ...
  fun m ->
    fun b ->
      ...
      | [] -> FStar_Pervasives_Native.None
      | (b', x)::m' ->
          if (FStar_Reflection_V1_Builtins.compare_bv b b') = FStar_Order.Eq
               ...
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.tac_bind
                       ...
                       (FStar_Tactics_Effect.lift_div_tac
                          (fun uu___ ->
                             FStar_Reflection_V1_Builtins.inspect_bv b'))
                       (fun uu___ ->
                          (fun b'v ->
                             Obj.magic
                               (FStar_Tactics_Effect.tac_bind
  ...
  fun ge ->
    FStar_Tactics_Effect.tac_bind
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
               (Prims.of_int (247)) (Prims.of_int (4)) (Prims.of_int (259))
               (Prims.of_int (34)))))
      (FStar_Tactics_Effect.lift_div_tac
         (fun uu___ ->
            fun b ->
              FStar_Tactics_Effect.tac_bind
                ...
                (Obj.magic
                   (abv_to_string
                      (FStar_Reflection_V1_Derived.bv_of_binder b)))
                (fun uu___1 ->
                   FStar_Tactics_Effect.lift_div_tac
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (249)) (Prims.of_int (71))
        ...
        fun abs ->
          fun t ->
            FStar_Tactics_Effect.tac_bind
              ...
              (FStar_Tactics_Effect.lift_div_tac
                 (fun uu___ -> FStar_Reflection_V1_Derived.mk_binder b sort))
              (fun uu___ ->
                 (fun br ->
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "FStar.InteractiveHelpers.Base.fst"
                                  (Prims.of_int (274)) (Prims.of_int (50))
                                  (Prims.of_int (279)) (Prims.of_int (25)))))
                         (Obj.magic
                            (FStar_Tactics_Effect.tac_bind
                               (FStar_Sealed.seal
                               ...
                               (FStar_Sealed.seal
                                  (Obj.magic
                                     (FStar_Range.mk_range
                                        ...
                                        (Prims.of_int (47)))))
                               (Obj.magic
                                  (FStar_Tactics_V1_Derived.name_of_bv b))
                               (fun uu___ ->
                                  (fun uu___ ->
                                       ...
                                       (fun svars' ->
                                          Obj.magic
                                            (FStar_Tactics_Effect.tac_bind
                                               ...
                                               (FStar_Tactics_Effect.lift_div_tac
                                                  (fun uu___ ->
                                                     FStar_Reflection_V1_Builtins.push_binder
                                                       ge.env br))
                                               (fun uu___ ->
                                                  (fun e' ->
                                                     Obj.magic
        ...
        fun t ->
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                     (Prims.of_int (282)) (Prims.of_int (35))
                     (Prims.of_int (282)) (Prims.of_int (50)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                     (Prims.of_int (282)) (Prims.of_int (2))
                     (Prims.of_int (282)) (Prims.of_int (56)))))
            (Obj.magic (FStar_Tactics_V1_Derived.binder_sort b))
            (fun uu___ ->
               (fun uu___ ->
                  Obj.magic
                    (genv_push_bv ge
                       (FStar_Reflection_V1_Derived.bv_of_binder b) uu___ abs
                       t)) uu___)
          ...
          (fun uu___ ->
             (fun name ->
                ...
                then
                  ...
                  Obj.magic (FStar_Tactics_V1_Builtins.fresh_bv_named name))
               uu___)
let (fresh_bv :
  FStar_Reflection_Types.env ->
    Prims.string ->
    ...
    fun basename ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                 (Prims.of_int (323)) (Prims.of_int (35))
                 (Prims.of_int (325)) (Prims.of_int (35)))))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> FStar_Reflection_V1_Builtins.binders_of_env e))
        (fun uu___ ->
           (fun binders ->
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   ...
                   (Obj.magic
                      (FStar_Tactics_Util.map
                         FStar_Tactics_V1_Derived.name_of_binder binders))
                   (fun uu___ ->
                      (fun binder_names ->
                         Obj.magic
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (329)) (Prims.of_int (17)))))
          (Obj.magic (fresh_bv e basename))
          (fun bv ->
             FStar_Tactics_Effect.lift_div_tac
               (fun uu___ -> FStar_Reflection_V1_Derived.mk_binder bv ty))
      ...
      fun ty ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (339)) (Prims.of_int (39))
                   (Prims.of_int (341)) (Prims.of_int (7)))))
          (Obj.magic (fresh_binder e basename ty))
          (fun b ->
             FStar_Tactics_Effect.lift_div_tac
               (fun uu___ ->
                  ((FStar_Reflection_V1_Builtins.push_binder e b), b)))
      ...
      fun ty ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (344)) (Prims.of_int (15))
                   (Prims.of_int (344)) (Prims.of_int (52)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (343)) (Prims.of_int (85))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (349)) (Prims.of_int (47)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (348)) (Prims.of_int (35))
                      ...
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "FStar.InteractiveHelpers.Base.fst"
                                  (Prims.of_int (361)) (Prims.of_int (50))
                                  (Prims.of_int (365)) (Prims.of_int (20)))))
      ...
      fun ty ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (368)) (Prims.of_int (46))
                      ...
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "FStar.InteractiveHelpers.Base.fst"
                                  (Prims.of_int (369)) (Prims.of_int (57))
                                  (Prims.of_int (373)) (Prims.of_int (21)))))
      ...
      fun subst ->
        FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (386)) (Prims.of_int (32))
                      ...
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Sealed.seal
                            (Obj.magic
                               (FStar_Range.mk_range
                                  "FStar.InteractiveHelpers.Base.fst"
                                  (Prims.of_int (388)) (Prims.of_int (62))
                                  (Prims.of_int (391)) (Prims.of_int (23)))))
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___1 ->
                                    ...
                                    (FStar_Sealed.seal
                                       (Obj.magic
                                          (FStar_Range.mk_range
                                             ...
                                             (Prims.of_int (23)))))
                                    (Obj.magic
                                       (FStar_Tactics_V1_Derived.mk_abs bl1 t))
                                    (fun uu___1 ->
                                       (fun t1 ->
                                          Obj.magic
                                            (FStar_Tactics_Effect.tac_bind
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (394)) (Prims.of_int (51)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (394)) (Prims.of_int (54))
                                        ...
                                        (Obj.repr
                                           (FStar_Tactics_Effect.tac_bind
                                              ...
                                              (fun uu___1 ->
                                                 FStar_Tactics_Effect.lift_div_tac
                                                   (fun uu___2 ->
                                                      FStar_Reflection_V1_Data.Q_Meta
                                                        uu___1))))) uu___1
                               uu___))
                     (fun uu___ ->
                        (fun subst_in_aqualv ->
                           match FStar_Reflection_V1_Builtins.inspect_comp c
                           with
                           | FStar_Reflection_V1_Data.C_Total ret ->
                               Obj.magic
                                 (FStar_Tactics_Effect.tac_bind
                                 ...
                                 (FStar_Tactics_Effect.tac_bind
                                    ...
                                    (fun ret1 ->
                                       FStar_Tactics_Effect.lift_div_tac
                                         (fun uu___ ->
                                            FStar_Reflection_V1_Builtins.pack_comp
                                              (FStar_Reflection_V1_Data.C_GTotal
                                                 ret1))))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (511)) (Prims.of_int (5)))))
          (Obj.magic (FStar_Tactics_V1_Builtins.inspect t))
          (fun uu___ ->
             (fun uu___ ->
                match uu___ with
                | FStar_Reflection_V1_Data.Tv_Var b ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___1 ->
                ...
                | FStar_Reflection_V1_Data.Tv_BVar b ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.lift_div_tac
                            (fun uu___1 ->
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (450)) (Prims.of_int (43))
                                  ...
                                  Obj.magic
                                    (FStar_Tactics_V1_Builtins.pack
                                       (FStar_Reflection_V1_Data.Tv_Abs
                                          (br, body1)))) uu___1)))
                | FStar_Reflection_V1_Data.Tv_Arrow (br, c) ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (462)) (Prims.of_int (47))
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (470)) (Prims.of_int (43))
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (500)) (Prims.of_int (45))
                                               ...
                                               (FStar_Tactics_V1_Builtins.pack
                                                  (FStar_Reflection_V1_Data.Tv_AscribedT
                                                     (exp1, ty1,
                                                       ...
                                                       use_eq)))) uu___1)))
                                 uu___1)))
                | FStar_Reflection_V1_Data.Tv_AscribedC (exp, c, tac, use_eq)
                    ->
                    Obj.magic
                      (Obj.repr
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.InteractiveHelpers.Base.fst"
                                     (Prims.of_int (505)) (Prims.of_int (45))
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (516)) (Prims.of_int (35)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
...
and (deep_apply_subst_in_binder :
  ...
  fun e ->
    fun br ->
      fun subst ->
        match FStar_Reflection_V1_Builtins.inspect_binder br with
        | { FStar_Reflection_V1_Data.binder_bv = binder_bv;
            FStar_Reflection_V1_Data.binder_qual = binder_qual;
            FStar_Reflection_V1_Data.binder_attrs = binder_attrs;
            FStar_Reflection_V1_Data.binder_sort = binder_sort;_} ->
            FStar_Tactics_Effect.tac_bind
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                       (Prims.of_int (523)) (Prims.of_int (59))
                         ...
                         (fun uu___ ->
                            FStar_Tactics_Effect.lift_div_tac
                              (fun uu___1 ->
                                 match uu___ with
                                 | (binder_bv1, subst1) ->
                                     ((FStar_Reflection_V1_Builtins.pack_binder
                                         {
                                           FStar_Reflection_V1_Data.binder_bv
                                             = binder_bv1;
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   ...
                   (Prims.of_int (533)) (Prims.of_int (51)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
                   (Prims.of_int (533)) (Prims.of_int (54))
...
and (deep_apply_subst_in_pattern :
  FStar_Reflection_Types.env ->
    FStar_Reflection_V1_Data.pattern ->
      (FStar_Reflection_Types.bv * FStar_Reflection_Types.term) Prims.list ->
        ((FStar_Reflection_V1_Data.pattern * (FStar_Reflection_Types.bv *
           FStar_Reflection_Types.term) Prims.list),
          unit) FStar_Tactics_Effect.tac_repr)
  =
  fun uu___2 ->
      ...
      fun uu___ ->
        (fun e ->
           fun pat ->
             fun subst ->
               match pat with
               | FStar_Reflection_V1_Data.Pat_Constant uu___ ->
                   Obj.magic
                     (Obj.repr
                        (FStar_Tactics_Effect.lift_div_tac
                           (fun uu___1 -> (pat, subst))))
               | FStar_Reflection_V1_Data.Pat_Cons (fv, us, patterns) ->
                   Obj.magic
                     (Obj.repr
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "FStar.InteractiveHelpers.Base.fst"
                                    (Prims.of_int (561)) (Prims.of_int (30))
                        ...
                        (FStar_Tactics_Effect.tac_bind
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "FStar.InteractiveHelpers.Base.fst"
                                    (Prims.of_int (571)) (Prims.of_int (66))
                           ...
                           (Obj.magic
                              (FStar_Tactics_Effect.tac_bind
                                 ...
                                 (fun uu___ ->
                                    FStar_Tactics_Effect.lift_div_tac
                                      (fun uu___1 ->
                                         FStar_Reflection_V1_Data.Pat_Dot_Term
                                           uu___))))
                           (fun uu___ ->
                              FStar_Tactics_Effect.lift_div_tac
                                 ...
                                 | FStar_Reflection_V1_Data.Tv_Abs
                                     ...
                                     Obj.magic
                                       (FStar_Tactics_Effect.tac_bind
                                          ...
                                          (FStar_Tactics_Effect.lift_div_tac
                                             (fun uu___2 ->
                                                (FStar_Reflection_V1_Builtins.inspect_binder
                                                   b).FStar_Reflection_V1_Data.binder_bv))
                                          (fun uu___2 ->
                                             (fun bv ->
                                                Obj.magic
                                                  (FStar_Tactics_Effect.tac_bind
  ...
  fun ge ->
    FStar_Tactics_Effect.tac_bind
      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.InteractiveHelpers.Base.fst"
               (Prims.of_int (628)) (Prims.of_int (36)) (Prims.of_int (631))
               (Prims.of_int (39)))))
      (FStar_Tactics_Effect.lift_div_tac
              ...
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range
                          "FStar.InteractiveHelpers.Base.fst"
                          (Prims.of_int (629)) (Prims.of_int (68))
