  ...
  'a 'b .
    unit ->
      'a FStar_Tactics_Monad.tac ->
        ('a -> 'b FStar_Tactics_Monad.tac) -> 'b FStar_Tactics_Monad.tac
  =
  fun uu___2 ->
    fun uu___1 ->
      fun uu___ ->
        (fun uu___ ->
           Obj.magic
             (FStar_Class_Monad.op_let_Bang FStar_Tactics_Monad.monad_tac ()
                ())) uu___2 uu___1 uu___
let (idtac : unit FStar_Tactics_Monad.tac) =
      ...
      fun allow_guards ->
        fun uvs ->
          let aux u =
            ...
            match sc with
            | FStar_Syntax_Syntax.Allow_untyped uu___ -> ret ()
            | FStar_Syntax_Syntax.Already_checked -> ret ()
            | uu___ ->
                let uu___1 =
                 ...
                 (fun r ->
                    ...
                    then
                      ...
                      let uu___4 =
                        ...
                        Prims.op_Negation uu___5 in
                      (if uu___4
                       then (FStar_Syntax_Unionfind.rollback tx; ret false)
                       else ret true)
                    else ret false))
let (do_match_on_lhs :
  Prims.bool ->
                   ...
                   uu___5 uu___4
                     (fun r ->
                        ...
                        then
                          ...
                          (if uu___6
                           then
                             (FStar_Syntax_Unionfind.rollback tx; ret false)
                           else ret true)
                        else ret false))
let (set_solution :
  FStar_Tactics_Types.goal ->
        ...
        (fun uu___ ->
           ...
           uu___2 uu___1
             (fun b ->
                ...
                then
                  let uu___3 = bind () in
                  uu___3 FStar_Tactics_Monad.dismiss
                    (fun uu___4 -> FStar_Tactics_Monad.remove_solved_goals)
                else
                  (let uu___4 =
                     let uu___5 =
                     ...
                     let uu___6 =
                       ...
                       let uu___8 = FStar_Tactics_Types.goal_witness goal in
                       tts uu___7 uu___8 in
                     let uu___7 =
                       let uu___8 = FStar_Tactics_Types.goal_env goal in
                       let uu___9 = FStar_Tactics_Types.goal_type goal in
  ...
  fun uu___ ->
    ...
    uu___1 FStar_Tactics_Monad.get
      (fun ps ->
         ...
         let uu___3 = bind () in
         uu___3 uu___2
           (fun uu___4 -> let uu___5 = FStar_BigInt.of_int_fs n in ret uu___5))
                ...
                let e1 =
                  {
                    ...
                    FStar_TypeChecker_Env.extension_state =
                      (e.FStar_TypeChecker_Env.extension_state)
                  } in
                try
                  (fun uu___2 ->
                     match () with
                ...
                let e2 =
                  {
                    ...
                    FStar_TypeChecker_Env.extension_state =
                      (e1.FStar_TypeChecker_Env.extension_state)
                  } in
                try
                  (fun uu___2 ->
                     match () with
                ...
                let e3 =
                  {
                    ...
                    FStar_TypeChecker_Env.extension_state =
                      (e2.FStar_TypeChecker_Env.extension_state)
                  } in
                try
                  (fun uu___2 ->
                     match () with
      ...
      let uu___ =
        ...
        uu___2 uu___1
          (fun uu___3 ->
             ...
             | (uu___4, lc, uu___5) ->
                 let uu___6 =
                   let uu___7 = FStar_TypeChecker_Common.lcomp_comp lc in
  ...
  fun e ->
    fun t ->
      let uu___ =
        ...
        let uu___2 = bind () in
        uu___2 uu___1 (fun c -> ret (FStar_Syntax_Util.comp_result c)) in
             ...
             let uu___1 =
               try
                 (fun uu___2 ->
                    ...
                    | () ->
                        let uu___3 =
                          let uu___4 = FStar_BigInt.to_int_fs n in
                          FStar_Compiler_List.splitAt uu___4
                      ...
                      uu___5 uu___4
                        (fun uu___6 ->
                           ...
                           uu___7 l
                             (fun a1 ->
                                let uu___8 = bind () in
                                uu___8 FStar_Tactics_Monad.get
                                  (fun lp' ->
                                     let rp =
                                       {
                                         FStar_Tactics_Types.main_context =
...
let focus : 'a . 'a FStar_Tactics_Monad.tac -> 'a FStar_Tactics_Monad.tac =
  fun f ->
    let uu___ = divide FStar_BigInt.one f idtac in
    let uu___1 = bind () in
  ...
  fun tau ->
    ...
    uu___ FStar_Tactics_Monad.get
      (fun p ->
         ...
         | uu___1::uu___2 ->
             let uu___3 =
               let uu___4 = map tau in divide FStar_BigInt.one tau uu___4 in
             let uu___4 = bind () in
             uu___4 uu___3
                             ...
                             Obj.repr
                               (let typ' = FStar_Syntax_Util.comp_result c in
                                let uu___5 =
                                  ...
                                  FStar_Tactics_Monad.new_uvar "intro" env'
               ...
               | FStar_Pervasives_Native.Some (e0, b11, bvs) ->
                   Obj.magic
                     (Obj.repr
                        (let bs =
                           FStar_Compiler_List.map
                             FStar_Syntax_Syntax.mk_binder (b11 :: bvs) in
                         ...
                         | (bs', t') ->
                             let bs'1 =
                               ...
                               let uu___3 = FStar_Compiler_List.tail bs' in
                               uu___2 :: uu___3 in
                             let uu___2 =
                               FStar_TypeChecker_Core.open_binders_in_term e0
                                 bs'1 t' in
                             (match uu___2 with
                              | (new_env, bs'', t'') ->
                                  let b21 =
         ...
         (fun goal ->
            ...
            let uu___ =
              FStar_Tactics_Monad.if_verbose
                (fun uu___1 ->
                   let uu___2 =
                     FStar_Class_Show.show FStar_Syntax_Print.showable_binder
                       b in
                   let uu___3 =
                     let uu___4 =
                       let uu___5 =
                              ...
                              let check_uvar_subtype u t3 =
                                let env1 =
                                    ...
                                    FStar_Tactics_Types.goal_env g in
                                  {
                                    ...
                                    FStar_TypeChecker_Env.extension_state =
                                      (uu___12.FStar_TypeChecker_Env.extension_state)
                                  } in
                                let uu___12 =
                                                ...
                                                (fun uu___6 ->
                                                   ...
                                                   let nenv =
                                                         ...
                                                         g1 in
                                                     {
                                                       ...
                                                       FStar_TypeChecker_Env.extension_state
                                                         =
                                                         (uu___7.FStar_TypeChecker_Env.extension_state)
                                                     } in
                                                   let uu___7 =
                                                     FStar_Tactics_Monad.mk_irrelevant_goal
                                                       "joined" nenv ng
...
let (top_env : unit -> env FStar_Tactics_Monad.tac) =
  fun uu___ ->
    let uu___1 = bind () in
    uu___1 FStar_Tactics_Monad.get
      (fun ps -> ret ps.FStar_Tactics_Types.main_context)
                 ...
                 (FStar_Class_Monad.op_let_Bang FStar_Tactics_Monad.monad_tac
                    ...
                    (fun uu___ ->
                       (fun uu___ ->
                          ...
                          then
                            let s =
                              FStar_Compiler_Util.run_process "tactic_launch"
                                prog args
...
let (failwhen : Prims.bool -> Prims.string -> unit FStar_Tactics_Monad.tac) =
  fun b -> fun msg -> if b then FStar_Tactics_Monad.fail msg else ret ()
let (t_destruct :
  FStar_Syntax_Syntax.term ->
...
let (gather_explicit_guards_for_resolved_goals :
  unit -> unit FStar_Tactics_Monad.tac) = fun uu___ -> ret ()
           ...
           (fun uu___2 ->
              (fun e ->
                 ...
                 | FStar_Syntax_Syntax.Tm_name bv ->
                     Obj.magic (ret (FStar_Reflection_V1_Data.Tv_Var bv))
                 | FStar_Syntax_Syntax.Tm_bvar bv ->
                     Obj.magic (ret (FStar_Reflection_V1_Data.Tv_BVar bv))
                 | FStar_Syntax_Syntax.Tm_fvar fv ->
                     Obj.magic (ret (FStar_Reflection_V1_Data.Tv_FVar fv))
                 ...
                 | FStar_Syntax_Syntax.Tm_app
                     ...
                     (match uu___2 with
                      | (a, q) ->
                          let q' =
                            FStar_Reflection_V1_Builtins.inspect_aqual q in
                          let uu___3 =
                            let uu___4 =
                              let uu___5 =
                          ...
                          (match bs1 with
                           ...
                           | b::bs2 ->
                               let uu___3 =
                                 let uu___4 =
                                   let uu___5 =
                                     FStar_Syntax_Util.abs bs2 t4 k in
                                   (b, uu___5) in
                                 FStar_Reflection_V1_Data.Tv_Abs uu___4 in
                               Obj.magic (ret uu___3)))
                 | FStar_Syntax_Syntax.Tm_type u ->
                     Obj.magic (ret (FStar_Reflection_V1_Data.Tv_Type u))
                 ...
                 | FStar_Syntax_Syntax.Tm_let
                     ...
                     then Obj.magic (ret FStar_Reflection_V1_Data.Tv_Unsupp)
                     else
                       (match lb.FStar_Syntax_Syntax.lbname with
                        | FStar_Pervasives.Inr uu___3 ->
                            Obj.magic
                              (ret FStar_Reflection_V1_Data.Tv_Unsupp)
                        | FStar_Pervasives.Inl bv ->
                            let b = FStar_Syntax_Syntax.mk_binder bv in
                        ...
                        | FStar_Pervasives.Inl bv ->
                            ...
                            (match uu___3 with
                             | (lbs, t22) ->
                                 (match lbs with
                                  | lb1::[] ->
                                      (match lb1.FStar_Syntax_Syntax.lbname
                                       with
                 ...
                 | FStar_Syntax_Syntax.Tm_match
                     ...
                     let brs1 =
                       FStar_Compiler_List.map FStar_Syntax_Subst.open_branch
                         brs in
                     let brs2 =
                       FStar_Compiler_List.map
                         (fun uu___3 ->
                 ...
                 | FStar_Syntax_Syntax.Tm_unknown ->
                     Obj.magic (ret FStar_Reflection_V1_Data.Tv_Unknown)
                 | uu___2 ->
                     ((let uu___4 =
                         let uu___5 =
  ...
  fun tv ->
    fun leave_curried ->
      ...
      | FStar_Reflection_V1_Data.Tv_Var bv ->
          let uu___ = FStar_Syntax_Syntax.bv_to_name bv in ret uu___
      | FStar_Reflection_V1_Data.Tv_BVar bv ->
          let uu___ = FStar_Syntax_Syntax.bv_to_tm bv in ret uu___
      | FStar_Reflection_V1_Data.Tv_FVar fv ->
          let uu___ = FStar_Syntax_Syntax.fv_to_tm fv in ret uu___
      ...
      | FStar_Reflection_V1_Data.Tv_App (l, (r, q)) ->
          ...
          let uu___ = FStar_Syntax_Util.mk_app l [(r, q')] in ret uu___
      ...
      | FStar_Reflection_V1_Data.Tv_Refine (bv, sort, t) ->
          ...
          let uu___ = FStar_Syntax_Util.refine bv1 t in ret uu___
...
let (string_to_term :
  ...
  fun e ->
    fun s ->
      let frag_of_text s1 =
        {
          FStar_Parser_ParseIt.frag_fname = "<string_to_term>";
