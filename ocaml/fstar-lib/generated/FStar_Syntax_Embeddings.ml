           ...
           | (hd, args) ->
               ...
               (match uu___1 with
                ...
                | (FStar_Syntax_Syntax.Tm_fvar fv, uu___2::(a1, uu___3)::[])
                    ...
                    ->
                    let uu___4 =
                      let uu___5 = FStar_Syntax_Embeddings_Base.unembed ea a1 in
                      uu___5 w norm in
                 ...
                 (match uu___1 with
                  | (FStar_Syntax_Syntax.Tm_fvar fv,
                     uu___2::uu___3::(a1, uu___4)::(b1, uu___5)::[]) when
                      ...
                      let uu___6 =
                        let uu___7 =
                          FStar_Syntax_Embeddings_Base.unembed ea a1 in
                        uu___7 w norm in
                      FStar_Compiler_Util.bind_opt uu___6
                        (fun a2 ->
                           let uu___7 =
                             let uu___8 =
                               FStar_Syntax_Embeddings_Base.unembed eb b1 in
                             uu___8 w norm in
               ...
               (match uu___1 with
                ...
                | (FStar_Syntax_Syntax.Tm_fvar fv,
                   ...
                   (hd1, FStar_Pervasives_Native.None)::(tl,
                    ...
                    let uu___4 =
                      let uu___5 =
                        FStar_Syntax_Embeddings_Base.unembed ea hd1 in
                      uu___5 w norm in
                    FStar_Compiler_Util.bind_opt uu___4
                      (fun hd2 ->
             ...
             (match uu___1 with
              ...
              | (FStar_Syntax_Syntax.Tm_fvar fv, (l, uu___2)::[]) when
                  ...
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = e_list e_string in
                      FStar_Syntax_Embeddings_Base.unembed uu___5 l in
                    uu___4 w norm in
                  FStar_Compiler_Util.bind_opt uu___3
                    (fun ss ->
        ...
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            ...
            (trivial_pre_for_unannotated_effectful_fns, uu___27)::(reuse_hint_for,
             ...
             let uu___29 =
               let uu___30 =
                 FStar_Syntax_Embeddings_Base.unembed e_fsint initial_fuel in
               uu___30 w norm in
             FStar_Compiler_Util.bind_opt uu___29
               (fun initial_fuel1 ->
                  let uu___30 =
                    let uu___31 =
                      FStar_Syntax_Embeddings_Base.unembed e_fsint max_fuel in
                    uu___31 w norm in
             ...
             let f_wrapped a1 =
               ...
               (let a_tm =
                ...
                let b_tm =
                  ...
                  norm uu___1 in
                let uu___1 =
                  let uu___2 = FStar_Syntax_Embeddings_Base.unembed eb b_tm in
                  uu___2 w norm in
                match uu___1 with
                | FStar_Pervasives_Native.None ->
                    ...
                    (match uu___1 with
                     | (x, uu___2)::[] ->
                         ...
                         let uu___3 =
                           let uu___4 =
                             let uu___5 =
                               FStar_Syntax_Embeddings_Base.unembed ea x in
                             uu___5 true norm in
