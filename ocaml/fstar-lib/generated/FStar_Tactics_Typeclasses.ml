                        ...
                        trywith seen fuel
                          (FStar_Tactics_NamedView.pack
                             (FStar_Tactics_NamedView.Tv_Var
                                (FStar_Tactics_Derived.binding_to_namedv b))))
                     bs)) uu___1)
and (global :
  FStar_Reflection_Types.term Prims.list ->
    Prims.int -> unit -> (unit, unit) FStar_Tactics_Effect.tac_repr)
  ...
  fun nm ->
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.Typeclasses.fst"
               (Prims.of_int (136)) (Prims.of_int (13)) (Prims.of_int (136))
               (Prims.of_int (26)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.Typeclasses.fst"
               (Prims.of_int (136)) (Prims.of_int (29)) (Prims.of_int (224))
               (Prims.of_int (35)))))
      (FStar_Tactics_Effect.lift_div_tac
                       ...
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                ...
                                (Prims.of_int (137)) (Prims.of_int (35)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                                "FStar.Tactics.Typeclasses.fst"
                            ...
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.Tactics.Typeclasses.fst"
                                     (Prims.of_int (138)) (Prims.of_int (4))
                                     (Prims.of_int (138)) (Prims.of_int (19)))))
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "FStar.Tactics.Typeclasses.fst"
