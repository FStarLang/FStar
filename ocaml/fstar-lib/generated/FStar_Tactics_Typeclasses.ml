      ...
      fun uu___ ->
        FStar_Tactics_Effect.tac_bind
          ...
          (Obj.magic
             (FStar_Tactics_Effect.tac_bind
                (FStar_Range.mk_range "FStar.Tactics.Typeclasses.fst"
                   (Prims.of_int (52)) (Prims.of_int (25))
                        ...
                        FStar_Tactics_Effect.tac_bind
                          ...
                          (Obj.magic
                             (FStar_Tactics_Effect.tac_bind
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Typeclasses.fst"
                                   (Prims.of_int (53)) (Prims.of_int (44))
                                   (Prims.of_int (53)) (Prims.of_int (74)))
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Typeclasses.fst"
                                   (Prims.of_int (53)) (Prims.of_int (38))
                                   (Prims.of_int (53)) (Prims.of_int (75)))
...
let (mk_class :
  ...
  fun nm ->
    FStar_Tactics_Effect.tac_bind
      (FStar_Range.mk_range "FStar.Tactics.Typeclasses.fst"
         (Prims.of_int (120)) (Prims.of_int (13)) (Prims.of_int (120))
         (Prims.of_int (26)))
      (FStar_Range.mk_range "FStar.Tactics.Typeclasses.fst"
         (Prims.of_int (120)) (Prims.of_int (29)) (Prims.of_int (215))
         (Prims.of_int (35)))
      (FStar_Tactics_Effect.lift_div_tac
