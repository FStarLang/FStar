         ...
         | FStar_Syntax_Syntax.Sig_let
             ...
             let uu___3 =
               (let uu___4 = FStar_Options.codegen () in
                uu___4 <> (FStar_Pervasives_Native.Some FStar_Options.Plugin))
                 &&
                           ...
                           (match c.FStar_Syntax_Syntax.n with
                            | FStar_Syntax_Syntax.Comp ct ->
                                let uu___6 =
                                  let uu___7 =
                                    FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                                  FStar_TypeChecker_Env.norm_eff_name uu___7
                                    ct.FStar_Syntax_Syntax.effect_name in
                                FStar_Class_Deq.op_Equals_Question
                                  FStar_Syntax_Syntax.deq_fv uu___6
               ...
               (let attrs = se.FStar_Syntax_Syntax.sigattrs in
                ...
                let maybe_postprocess_lbs lbs1 =
                  let post_tau =
                    ...
                    | FStar_Pervasives_Native.None ->
                        FStar_Pervasives_Native.None
                    | FStar_Pervasives_Native.Some
                        (uu___6, (tau, FStar_Pervasives_Native.None)::uu___7)
                      ...
                      FStar_Profiling.profile
                        (fun uu___6 ->
                           FStar_TypeChecker_Env.postprocess env tau
                             lb.FStar_Syntax_Syntax.lbtyp
                             lb.FStar_Syntax_Syntax.lbdef) uu___5
                  ...
                  | FStar_Pervasives_Native.Some tau ->
                      ...
                      ((FStar_Pervasives_Native.fst lbs1), uu___5) in
                let maybe_normalize_for_extraction lbs1 =
                  let norm_steps =
                    ...
                    | FStar_Pervasives_Native.Some
                        (uu___6,
                         (steps, FStar_Pervasives_Native.None)::uu___7)
                        ->
                        let steps1 =
                          let uu___8 =
                            FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                          FStar_TypeChecker_Normalize.normalize
                            ...
                            FStar_TypeChecker_Env.Primops] uu___8 steps in
                        let uu___8 =
                          let uu___9 =
                            FStar_Syntax_Embeddings.e_list
                              FStar_Syntax_Embeddings.e_norm_step in
                          FStar_TypeChecker_Primops.try_unembed_simple uu___9
                            steps1 in
                        (match uu___8 with
                         ...
                         | uu___9 ->
                             ((let uu___11 =
                               ...
                               FStar_Errors.log_issue
                                 se.FStar_Syntax_Syntax.sigrng uu___11);
                              FStar_Pervasives_Native.None))
                    | FStar_Pervasives_Native.Some uu___6 ->
                        (FStar_Errors.log_issue se.FStar_Syntax_Syntax.sigrng
                           (FStar_Errors_Codes.Warning_UnrecognizedAttribute,
                ...
                let uu___5 =
                  let lbs1 =
                    let uu___6 = maybe_postprocess_lbs lbs in
                    maybe_normalize_for_extraction uu___6 in
                  let uu___6 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                         {
                                    ...
                                    | ((env, ml_lbs),
                                       { FStar_Syntax_Syntax.lbname = lbname;
                                         FStar_Syntax_Syntax.lbunivs =
                                           uu___12;
                                         FStar_Syntax_Syntax.lbtyp = t;
                                         FStar_Syntax_Syntax.lbeff = uu___13;
                                         FStar_Syntax_Syntax.lbdef = uu___14;
                                         FStar_Syntax_Syntax.lbattrs =
                                           uu___15;
                                         FStar_Syntax_Syntax.lbpos = uu___16;_})
                                        ->
                                        if
                                          FStar_Compiler_List.contains
                                          ...
                                          (let lb_lid =
                                             let uu___18 =
                                               let uu___19 =
                                                 FStar_Compiler_Util.right
                                                   lbname in
                                               uu___19.FStar_Syntax_Syntax.fv_name in
                                             uu___18.FStar_Syntax_Syntax.v in
                                           let flags'' =
                                             let uu___18 =
                                               let uu___19 =
                                               ...
                                               (let uu___21 =
                                                  let uu___22 =
                                                    FStar_Compiler_Util.must
                                                      ml_lb1.FStar_Extraction_ML_Syntax.mllb_tysc in
                                                  FStar_Extraction_ML_UEnv.extend_lb
                                                    env lbname t uu___22
                                                    ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit in
                                                match uu___21 with
                                                | (env1, uu___22, uu___23) ->
                                                    (env1, ml_lb1)) in
                                           match uu___18 with
                                           | (g1, ml_lb2) ->
                                               (g1, (ml_lb2 :: ml_lbs))))
                          ...
                          | (g1, ml_lbs') ->
                              let uu___10 =
                                ...
                                let uu___12 =
                                  FStar_Extraction_ML_RegEmb.maybe_register_plugin
                                    g1 se in
                                FStar_Compiler_List.op_At uu___11 uu___12 in
                              (g1, uu___10))
                     | uu___8 ->
                         let uu___9 =
                           let uu___10 =
                           ...
                           FStar_Compiler_Util.format1
                             ...
                             uu___10 in
                         FStar_Compiler_Effect.failwith uu___9)))
let (extract' :
  FStar_Extraction_ML_UEnv.uenv ->
...
let (has_pref : Prims.string -> Prims.string -> Prims.bool) =
  fun p ->
    fun s ->
      let n = FStar_Compiler_String.length p in
      ((FStar_Compiler_String.length s) >= n) &&
        (let uu___ = FStar_Compiler_String.substring s Prims.int_zero n in
         uu___ = p)
let (is_tactics_or_refl_module : FStar_Syntax_Syntax.modul -> Prims.bool) =
  fun m ->
    let s =
      let uu___ = FStar_Syntax_Syntax.mod_name m in
      FStar_Ident.string_of_lid uu___ in
    (has_pref "FStar.Tactics." s) || (has_pref "FStar.Reflection." s)
let (extract :
  FStar_Extraction_ML_UEnv.uenv ->
    FStar_Syntax_Syntax.modul ->
      (FStar_Extraction_ML_UEnv.uenv * FStar_Extraction_ML_Syntax.mllib
  ...
  fun g ->
    fun m ->
      let uu___ =
        (let uu___1 = FStar_Options.codegen () in
         uu___1 <> (FStar_Pervasives_Native.Some FStar_Options.Plugin)) &&
          (is_tactics_or_refl_module m) in
      if uu___
         ...
         (let tgt =
          ...
          (let uu___4 =
             let uu___5 =
               let uu___6 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               FStar_Options.should_extract uu___6 tgt in
                  ...
                  (match uu___7 with
                   | (g2, mllib1) ->
                       ((let uu___9 =
                         ...
                         ());
                        (let uu___9 = FStar_Extraction_ML_UEnv.exit_module g2 in
                         (uu___9, mllib1))))))))