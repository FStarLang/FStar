...
type fsteps =
  ...
  unfold_namespace:
    ...
    ;
  dont_unfold_attr: FStar_Ident.lid Prims.list FStar_Pervasives_Native.option ;
                          ...
                          FStar_Class_Show.show
                            (FStar_Class_Show.show_option
                               (FStar_Class_Show.show_list
                                  FStar_Ident.showable_lident)) f.unfold_only in
                        let uu___20 =
                          let uu___21 =
                            FStar_Class_Show.show
                              (FStar_Class_Show.show_option
      ...
      (fun f1 ->
         fun f2 ->
           (((((((((((((((((((((((((((((((FStar_Class_Deq.op_Equals_Question
                           ...
                           (FStar_Class_Deq.op_Equals_Question
                              (FStar_Class_Ord.ord_eq
                                 FStar_Class_Ord.ord_bool) f1.erase_universes
                              f2.erase_universes))
                          &&
                          (FStar_Class_Deq.op_Equals_Question
             ...
             &&
             (FStar_Class_Deq.op_Equals_Question
                (FStar_Class_Ord.ord_eq FStar_Class_Ord.ord_bool) f1.tactics
                f2.tactics))
  }
...
let (fstep_add_one : FStar_TypeChecker_Env.step -> fsteps -> fsteps) =
  fun s ->
    fun fs ->
      ...
      | FStar_TypeChecker_Env.DontUnfoldAttr lids ->
          {
            beta = (fs.beta);
            iota = (fs.iota);
            zeta = (fs.zeta);
