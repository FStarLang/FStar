...
let (e_aqualv :
  FStar_Reflection_Data.aqualv FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_universe_view :
  FStar_Reflection_Data.universe_view FStar_Syntax_Embeddings_Base.embedding)
  =
...
let rec e_pattern_aq :
  'uuuuu .
    'uuuuu ->
      FStar_Reflection_Data.pattern FStar_Syntax_Embeddings_Base.embedding
  =
  fun aq ->
               ...
               (match () with
                ...
                | uu___2 when
                    ...
                    let uu___3 =
                      ...
                      FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                        (fun uu___5 ->
                           FStar_Reflection_Data.Pat_Dot_Term uu___5) uu___4 in
                    FStar_Syntax_Embeddings_AppEmb.run args uu___3
...
let (e_pattern :
  ...
  e_pattern_aq noaqs
let (e_branch :
  FStar_Reflection_Data.branch FStar_Syntax_Embeddings_Base.embedding) =
  FStar_Syntax_Embeddings.e_tuple2 e_pattern e_term
let (e_argv :
  FStar_Reflection_Data.argv FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_term_view_aq :
  FStar_Syntax_Syntax.antiquotations ->
    FStar_Reflection_Data.term_view FStar_Syntax_Embeddings_Base.embedding)
  =
  fun aq ->
    let push uu___ =
...
let (e_namedv_view :
  FStar_Reflection_Data.namedv_view FStar_Syntax_Embeddings_Base.embedding) =
  let embed_namedv_view rng namedvv =
    let uu___ =
      let uu___1 =
        let uu___2 =
          embed FStar_Syntax_Embeddings.e_int rng
            namedvv.FStar_Reflection_Data.uniq in
        FStar_Syntax_Syntax.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 = embed e_sort rng namedvv.FStar_Reflection_Data.sort in
          FStar_Syntax_Syntax.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 =
              embed e_ppname rng namedvv.FStar_Reflection_Data.ppname in
            FStar_Syntax_Syntax.as_arg uu___6 in
          [uu___5] in
        uu___3 :: uu___4 in
      uu___1 :: uu___2 in
...
let (e_bv_view :
  FStar_Reflection_Data.bv_view FStar_Syntax_Embeddings_Base.embedding) =
  let embed_bv_view rng bvv =
    let uu___ =
      let uu___1 =
        let uu___2 =
          embed FStar_Syntax_Embeddings.e_int rng
            bvv.FStar_Reflection_Data.index in
        FStar_Syntax_Syntax.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 = embed e_sort rng bvv.FStar_Reflection_Data.sort1 in
          FStar_Syntax_Syntax.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 = embed e_ppname rng bvv.FStar_Reflection_Data.ppname1 in
            FStar_Syntax_Syntax.as_arg uu___6 in
          [uu___5] in
        uu___3 :: uu___4 in
      uu___1 :: uu___2 in
...
let (e_binding :
  FStar_Reflection_Data.binding FStar_Syntax_Embeddings_Base.embedding) =
  let embed1 rng bindingv =
    let uu___ =
      let uu___1 =
        let uu___2 =
          embed FStar_Syntax_Embeddings.e_int rng
            bindingv.FStar_Reflection_Data.uniq1 in
        FStar_Syntax_Syntax.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 = embed e_term rng bindingv.FStar_Reflection_Data.sort3 in
          FStar_Syntax_Syntax.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 =
              embed e_ppname rng bindingv.FStar_Reflection_Data.ppname3 in
            FStar_Syntax_Syntax.as_arg uu___6 in
          [uu___5] in
        uu___3 :: uu___4 in
      uu___1 :: uu___2 in
                            ...
                            fun uu___7 ->
                              {
                                ...
                                FStar_Reflection_Data.ppname3 = uu___7
                              }) FStar_Syntax_Embeddings.e_int in
                   FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                     uu___4 e_term in
                 FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
  ...
  mk_emb embed1 unembed1 FStar_Reflection_Constants.fstar_refl_binding
let (e_attribute :
...
let (e_binder_view :
  FStar_Reflection_Data.binder_view FStar_Syntax_Embeddings_Base.embedding) =
  let embed_binder_view rng bview =
    let uu___ =
      let uu___1 =
        let uu___2 = embed e_term rng bview.FStar_Reflection_Data.sort2 in
        FStar_Syntax_Syntax.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 = embed e_aqualv rng bview.FStar_Reflection_Data.qual in
          FStar_Syntax_Syntax.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 =
              embed e_attributes rng bview.FStar_Reflection_Data.attrs in
            FStar_Syntax_Syntax.as_arg uu___6 in
          let uu___6 =
            let uu___7 =
              let uu___8 =
                embed e_ppname rng bview.FStar_Reflection_Data.ppname2 in
              FStar_Syntax_Syntax.as_arg uu___8 in
            [uu___7] in
          uu___5 :: uu___6 in
        uu___3 :: uu___4 in
                                ...
                                fun uu___9 ->
                                  {
                                    ...
                                    FStar_Reflection_Data.ppname2 = uu___9
                                  }) e_term in
                     FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                       uu___5 e_aqualv in
                   let uu___5 = FStar_Syntax_Embeddings.e_list e_term in
...
let (e_comp_view :
  FStar_Reflection_Data.comp_view FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_univ_name :
  ...
  FStar_Syntax_Embeddings_Base.set_type
    FStar_Reflection_Constants.fstar_refl_univ_name uu___
let (e_univ_names :
...
let (e_subst_elt :
  ...
  mk_emb ee uu FStar_Reflection_Constants.fstar_refl_subst_elt
let (e_subst :
...
let (e_ctor :
  ...
  FStar_Syntax_Embeddings.e_tuple2 FStar_Syntax_Embeddings.e_string_list
    e_term
let (e_lb_view :
  FStar_Reflection_Data.lb_view FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_sigelt_view :
  FStar_Reflection_Data.sigelt_view FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_exp :
  FStar_Reflection_Data.exp FStar_Syntax_Embeddings_Base.embedding) =
...
let (e_qualifier :
  FStar_Reflection_Data.qualifier FStar_Syntax_Embeddings_Base.embedding) =
  let embed1 rng q =
    let r =
      match q with
                                                       ...
                                                       then
                                                         ...
                                                         then
                                                           ...
                                                           then
                                                             ...
                                                             FStar_Pervasives_Native.None) in
  mk_emb embed1 unembed1 FStar_Reflection_Constants.fstar_refl_qualifier
let (e_qualifiers :
