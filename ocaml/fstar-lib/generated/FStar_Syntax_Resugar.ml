...
let (is_imp_bqual :
  ...
  fun a ->
    ...
    | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) when
        FStar_Syntax_Util.is_fvar FStar_Parser_Const.tcresolve_lid t -> false
    | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit uu___) ->
        true
    | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta uu___) -> true
    | uu___ -> false
let (no_imp_args : FStar_Syntax_Syntax.args -> FStar_Syntax_Syntax.args) =
  fun args ->
...
let (no_imp_bs :
  ...
  fun bs ->
    FStar_Compiler_List.filter
      (fun b ->
         Prims.op_Negation (is_imp_bqual b.FStar_Syntax_Syntax.binder_qual))
      bs
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_refine
          ...
          (match uu___1 with
           | (x1, phi1) ->
               let b =
                 let uu___2 = FStar_Compiler_List.hd x1 in
                 resugar_binder' env uu___2 t.FStar_Syntax_Syntax.pos in
               let uu___2 =
                 let uu___3 =
          ...
          (match uu___2 with
           | FStar_Syntax_Syntax.Tm_app
               ...
               let is_hide_or_reveal e1 =
                 let uu___3 = FStar_Syntax_Util.un_uinst e1 in
                 match uu___3 with
                 | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                     ...
                     (FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.hide)
                       ||
                       (FStar_Syntax_Syntax.fv_eq_lid fv
                          FStar_Parser_Const.reveal)
                 | uu___4 -> false in
               let rec last uu___3 =
                 match uu___3 with
                 | hd::[] -> [hd]
                    ...
                    (let unsnoc l =
                       ...
                       | (pre, last1) ->
                           let uu___8 =
                             let uu___9 =
                               ...
                               (uu___10, last1) in
                             FStar_Parser_AST.Sum uu___9 in
                           mk uu___8 in
                     let resugar_dtuple_type env1 hd args2 =
                       let fancy_resugar uu___7 =
                         (fun uu___7 ->
                            ...
                            let take n1 l =
                              let uu___8 = FStar_Compiler_List.splitAt n1 l in
                              FStar_Pervasives_Native.fst uu___8 in
                            let uu___8 =
                              let uu___9 =
                                let uu___10 = FStar_Compiler_List.last args2 in
                                FStar_Pervasives_Native.fst uu___10 in
                              FStar_Syntax_Util.abs_formals uu___9 in
                            match uu___8 with
                            | (bs, uu___9, uu___10) ->
                                Obj.magic
                                  (FStar_Class_Monad.op_let_Bang
                                     ...
                                     (fun uu___11 ->
                                        (fun uu___11 ->
                                           ...
                                           let concatM uu___12 l =
                                             FStar_Class_Monad.mapM uu___12
                                               () ()
                                               (fun uu___13 ->
                                                  (fun x ->
                     ...
                     | FStar_Pervasives_Native.Some ts ->
                         let uu___8 =
                           ...
                           FStar_Parser_AST.ListLiteral uu___9 in
                         mk uu___8
                     | FStar_Pervasives_Native.None ->
                              ...
                              let uu___9 =
                                let uu___10 =
                                  FStar_Compiler_List.map (resugar_term' env)
                                    ts in
                                FStar_Parser_AST.SeqLiteral uu___10 in
                              mk uu___9
                          | FStar_Pervasives_Native.None ->
                               ...
                               | FStar_Pervasives_Native.Some
                                   ...
                                   let uu___11 =
                                     FStar_Ident.string_of_lid
                                       FStar_Parser_Const.sread_lid in
                                   ref_read = uu___11 ->
                                   let uu___11 = FStar_Compiler_List.hd args1 in
                                   (match uu___11 with
                                    | (t2, uu___12) ->
                                        let uu___13 =
                                          let uu___14 =
                               ...
                               | FStar_Pervasives_Native.Some (op, uu___10)
                                   ...
                                   let rec uncurry xs pats t2 flavor_matches
                                     ...
                                     | FStar_Parser_AST.QExists
                                         ...
                                         uncurry
                                           ...
                                           (FStar_Compiler_List.op_At pats
                                   ...
                                   let resugar_forall_body body =
                                     ...
                                     | FStar_Syntax_Syntax.Tm_abs
                                         ...
                                         ->
                                         let uu___13 =
                                           FStar_Syntax_Subst.open_term xs
                                             body1 in
                                         (match uu___13 with
                                          | (xs1, body2) ->
                                              let xs2 = filter_imp_bs xs1 in
                                         ...
                                         then
                                           let uu___13 =
                                             let uu___14 =
                                               ...
                                               ([], ([], []), uu___15) in
                                             FStar_Parser_AST.QForall uu___14 in
                                           mk uu___13
                                         else
                                           (let uu___14 =
                                              let uu___15 =
         ...
         fun t0 ->
                       ...
                       | FStar_Syntax_Syntax.Tm_app
                           ...
                           (match FStar_Compiler_List.rev args with
                            | (a1, FStar_Pervasives_Native.None)::(a2,
                                ...
                                ->
                                let uu___4 =
                                  (bv_eq_tm b11.FStar_Syntax_Syntax.binder_bv
                                     a2)
                                    &&
                                    (bv_eq_tm
                                       b21.FStar_Syntax_Syntax.binder_bv a1) in
                                if uu___4
                                then
                                  let uu___5 =
           ...
           let resugar_rel rel =
             ...
             | FStar_Pervasives_Native.Some (s, FStar_Pervasives_Native.None)
                 ...
                 let uu___1 =
                   let uu___2 =
                     let uu___3 = FStar_Ident.id_of_text s in (uu___3, []) in
             ...
             | FStar_Pervasives_Native.Some
                 ...
                 let uu___2 =
                   let uu___3 =
                     let uu___4 = FStar_Ident.id_of_text s in (uu___4, []) in
...
and (resugar_binder' :
  FStar_Syntax_DsEnv.env ->
    FStar_Syntax_Syntax.binder ->
      FStar_Compiler_Range_Type.range -> FStar_Parser_AST.binder)
  =
  fun env ->
    fun b ->
      fun r ->
        let imp = resugar_bqual env b.FStar_Syntax_Syntax.binder_qual in
        let e =
          resugar_term' env
        ...
        let b' =
          ...
          | FStar_Parser_AST.Wild ->
              let uu___ = bv_as_unique_ident b.FStar_Syntax_Syntax.binder_bv in
          ...
          | uu___ ->
              let uu___1 =
                FStar_Syntax_Syntax.is_null_bv
                  b.FStar_Syntax_Syntax.binder_bv in
              if uu___1
              then FStar_Parser_AST.NoName e
              else
                (let uu___3 =
                   let uu___4 =
                     bv_as_unique_ident b.FStar_Syntax_Syntax.binder_bv in
                   (uu___4, e) in
                 FStar_Parser_AST.Annotated uu___3) in
        FStar_Parser_AST.mk_binder_with_attrs b' r
          FStar_Parser_AST.Type_level imp attrs
  ...
  fun env ->
    fun q ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) ->
          let uu___ =
            let uu___1 = resugar_term' env t in FStar_Parser_AST.Meta uu___1 in
...
let (drop_n_bs :
  ...
  fun n ->
    fun t ->
      ...
      | (bs, c) ->
          let bs1 =
            let uu___1 = FStar_Compiler_List.splitAt n bs in
                 ...
                 let tyc =
                   let uu___4 =
                     (FStar_Compiler_Util.for_some
                        FStar_Syntax_Syntax.uu___is_RecordType
                        se.FStar_Syntax_Syntax.sigquals)
                       &&
                       ((FStar_Compiler_List.length current_datacons) =
                          Prims.int_one) in
                   if uu___4
                   then
                     ...
                     match uu___5 with
                     | dc::[] ->
                         (match dc.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              ...
                              let uu___9 =
                                let uu___10 = FStar_Ident.ident_of_lid tylid in
                                let uu___11 =
                                  FStar_Compiler_List.map (resugar_term' env)
  ...
  fun env ->
    fun ed ->
      ...
      | (eff_binders, eff_typ) ->
          ...
          let eff_binders2 =
            let uu___1 =
              FStar_Compiler_List.map (fun b -> resugar_binder' env b r)
                eff_binders1 in
      ...
      | FStar_Pervasives_Native.Some d1 ->
          let uu___ =
                ...
                se.FStar_Syntax_Syntax.sigattrs in
            {
              ...
              FStar_Parser_AST.attrs = uu___1;
              FStar_Parser_AST.interleaved =
                (d1.FStar_Parser_AST.interleaved)
            } in
          FStar_Pervasives_Native.Some uu___
      | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
