...
let (pretty_width : width FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun uu___ ->
         match uu___ with
      ...
      let uu___ =
        let uu___1 =
          let uu___2 =
            ...
            let uu___4 =
              let uu___5 = FStar_Pprint.doc_of_string n in uu___5 :: args in
            FStar_Pprint.flow uu___3 uu___4 in
...
let pp_list' :
  ...
  fun f ->
    fun xs ->
      (FStar_Class_PP.pp_list { FStar_Class_PP.pp = f }).FStar_Class_PP.pp xs
let rec (typ_to_doc : typ -> FStar_Pprint.document) =
  fun t ->
    match t with
    | TInt w ->
        let uu___ = let uu___1 = FStar_Class_PP.pp pretty_width w in [uu___1] in
        ctor "TInt" uu___
    | TBuf t1 ->
    ...
    | TBound x ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp FStar_Class_PP.pp_int x in [uu___1] in
        ctor "TBound" uu___
    | TApp (x, xs) ->
        let uu___ =
          let uu___1 =
    ...
    | TArray (t1, c) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    FStar_Class_PP.pp pretty_width
          ...
          uu___1 :: uu___2 in
        ctor "TArray" uu___
let (pretty_typ : typ FStar_Class_PP.pretty) =
  { FStar_Class_PP.pp = typ_to_doc }
let (pretty_string : Prims.string FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun s ->
         let uu___ = FStar_Pprint.doc_of_string s in
         FStar_Pprint.dquotes uu___)
  }
let (pretty_flag : flag FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun uu___ ->
         match uu___ with
         ...
         | Comment s ->
             let uu___1 =
               let uu___2 = FStar_Class_PP.pp pretty_string s in [uu___2] in
             ctor "Comment" uu___1
...
let (spaced : FStar_Pprint.document -> FStar_Pprint.document) =
  fun a ->
    ...
    let uu___1 =
      let uu___2 = FStar_Pprint.break_ Prims.int_one in
      FStar_Pprint.op_Hat_Hat a uu___2 in
        ...
        let uu___2 =
          let uu___3 =
            let uu___4 =
              ...
              FStar_Pprint.op_Hat_Hat FStar_Pprint.semi uu___5 in
            FStar_Pprint.separate uu___4 fs in
          spaced uu___3 in
        FStar_Pprint.braces uu___2 in
...
let (fld : Prims.string -> FStar_Pprint.document -> FStar_Pprint.document) =
  fun n ->
    fun v ->
      let uu___ =
        let uu___1 =
          let uu___2 = FStar_Pprint.doc_of_string (Prims.strcat n " =") in
          FStar_Pprint.op_Hat_Slash_Hat uu___2 v in
        FStar_Pprint.nest (Prims.of_int (2)) uu___1 in
      FStar_Pprint.group uu___
let (pretty_binder : binder FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun b ->
         let uu___ =
           let uu___1 =
             let uu___2 = FStar_Class_PP.pp pretty_string b.name in
             fld "name" uu___2 in
           let uu___2 =
             let uu___3 =
               let uu___4 = FStar_Class_PP.pp pretty_typ b.typ in
               fld "typ" uu___4 in
             let uu___4 =
               let uu___5 =
                 let uu___6 = FStar_Class_PP.pp FStar_Class_PP.pp_bool b.mut in
                 fld "mut" uu___6 in
               let uu___6 =
                 let uu___7 =
                   let uu___8 =
                     FStar_Class_PP.pp (FStar_Class_PP.pp_list pretty_flag)
                       b.meta in
                   fld "meta" uu___8 in
                 [uu___7] in
               uu___5 :: uu___6 in
...
let (pretty_lifetime : lifetime FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun uu___ ->
         match uu___ with
...
let (pretty_op : op FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun uu___ ->
         match uu___ with
...
let (pretty_cc : cc FStar_Class_PP.pretty) =
  {
    FStar_Class_PP.pp =
      (fun uu___ ->
         match uu___ with
...
let rec (decl_to_doc : decl -> FStar_Pprint.document) =
  fun d ->
    ...
    | DGlobal (fs, x, i, t, e) ->
        let uu___ =
          let uu___1 =
            FStar_Class_PP.pp (FStar_Class_PP.pp_list pretty_flag) fs in
          let uu___2 =
            let uu___3 =
              FStar_Class_PP.pp
                (FStar_Class_PP.pp_tuple2
                   (FStar_Class_PP.pp_list pretty_string) pretty_string) x in
            let uu___4 =
              let uu___5 = FStar_Class_PP.pp FStar_Class_PP.pp_int i in
              let uu___6 =
                let uu___7 = FStar_Class_PP.pp pretty_typ t in
    ...
    | DFunction (cc1, fs, i, t, x, bs, e) ->
        let uu___ =
          let uu___1 =
            FStar_Class_PP.pp (FStar_Class_PP.pp_option pretty_cc) cc1 in
          let uu___2 =
            let uu___3 =
              FStar_Class_PP.pp (FStar_Class_PP.pp_list pretty_flag) fs in
            let uu___4 =
              ...
              let uu___6 =
                ...
                let uu___8 =
                  let uu___9 =
                    FStar_Class_PP.pp
                      (FStar_Class_PP.pp_tuple2
                         (FStar_Class_PP.pp_list pretty_string) pretty_string)
                      x in
                  let uu___10 =
                    let uu___11 =
                      FStar_Class_PP.pp
                        (FStar_Class_PP.pp_list pretty_binder) bs in
        ...
        let uu___ =
          ...
          let uu___2 =
            ...
            let uu___4 =
              let uu___5 = FStar_Class_PP.pp FStar_Class_PP.pp_int i in
              let uu___6 =
                let uu___7 = FStar_Class_PP.pp pretty_typ t in [uu___7] in
              uu___5 :: uu___6 in
            uu___3 :: uu___4 in
          uu___1 :: uu___2 in
                ...
                let uu___7 =
                  FStar_Class_PP.pp
                    (FStar_Class_PP.pp_list
                       (FStar_Class_PP.pp_tuple2 pretty_string
                          (FStar_Class_PP.pp_tuple2 pretty_typ
                             FStar_Class_PP.pp_bool))) f in
                [uu___7] in
              uu___5 :: uu___6 in
            uu___3 :: uu___4 in
          uu___1 :: uu___2 in
          ...
          let uu___2 =
            ...
            let uu___4 =
              ...
              let uu___6 =
                ...
                let uu___8 =
                  let uu___9 =
                    FStar_Class_PP.pp (FStar_Class_PP.pp_list pretty_string)
                      xs in
                  [uu___9] in
                uu___7 :: uu___8 in
              uu___5 :: uu___6 in
            ...
            let uu___4 =
              ...
              let uu___6 =
                let uu___7 =
                  FStar_Class_PP.pp
                    (FStar_Class_PP.pp_list
                       (FStar_Class_PP.pp_tuple2 pretty_string pretty_typ))
                    xs in
                [uu___7] in
              uu___5 :: uu___6 in
            uu___3 :: uu___4 in
  ...
  fun e ->
    ...
    | EConstant x ->
        let uu___ =
          let uu___1 =
            FStar_Class_PP.pp
              (FStar_Class_PP.pp_tuple2 pretty_width pretty_string) x in
          [uu___1] in
    ...
    | ETypApp (x, xs) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              FStar_Class_PP.pp (FStar_Class_PP.pp_list pretty_typ) xs in
            [uu___3] in
          uu___1 :: uu___2 in
        ctor "ETypApp" uu___
    | ELet (x, y, z) ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp pretty_binder x in
          let uu___2 =
    ...
    | EBufCreate (x, y, z) ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp pretty_lifetime x in
          let uu___2 =
            let uu___3 = expr_to_doc y in
            let uu___4 = let uu___5 = expr_to_doc z in [uu___5] in uu___3 ::
              uu___4 in
    ...
    | EOp (x, y) ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp pretty_op x in
          let uu___2 =
            let uu___3 = FStar_Class_PP.pp pretty_width y in [uu___3] in
          uu___1 :: uu___2 in
        ctor "EOp" uu___
    | ECast (x, y) ->
        let uu___ =
          let uu___1 = expr_to_doc x in
          let uu___2 =
            let uu___3 = FStar_Class_PP.pp pretty_typ y in [uu___3] in
          uu___1 :: uu___2 in
        ctor "ECast" uu___
    ...
    | EBool x ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp FStar_Class_PP.pp_bool x in [uu___1] in
        ctor "EBool" uu___
    ...
    | EField (x, y, z) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 = expr_to_doc y in
            let uu___4 =
              let uu___5 = FStar_Class_PP.pp pretty_string z in [uu___5] in
            uu___3 :: uu___4 in
          uu___1 :: uu___2 in
        ctor "EField" uu___
    | EWhile (x, y) ->
    ...
    | ECons (x, y, xs) ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp pretty_typ x in
          let uu___2 =
            let uu___3 = FStar_Class_PP.pp pretty_string y in
    ...
    | EString x ->
        let uu___ =
          let uu___1 = FStar_Class_PP.pp pretty_string x in [uu___1] in
        ctor "EString" uu___
    | EFun (xs, y, z) ->
        let uu___ =
          let uu___1 = pp_list' (FStar_Class_PP.pp pretty_binder) xs in
          let uu___2 =
            let uu___3 = expr_to_doc y in
            let uu___4 =
              let uu___5 = FStar_Class_PP.pp pretty_typ z in [uu___5] in
            uu___3 :: uu___4 in
          uu___1 :: uu___2 in
        ctor "EFun" uu___
    | EAbortS x ->
    ...
    | EAddrOf x ->
        ...
        ctor "EAddrOf" uu___
    | EBufNull x ->
        let uu___ = let uu___1 = FStar_Class_PP.pp pretty_typ x in [uu___1] in
        ctor "EBufNull" uu___
    | EBufDiff (x, y) ->
        let uu___ =
          let uu___1 = expr_to_doc x in
...
let (showable_decl : decl FStar_Class_Show.showable) =
  FStar_Class_PP.showable_from_pretty pretty_decl
        ...
        (fun env2 ->
           fun uu___ ->
             ...
             | { FStar_Extraction_ML_Syntax.mlbinder_name = mlbinder_name;
                 FStar_Extraction_ML_Syntax.mlbinder_ty = uu___1;
...
and (translate_binders :
  env -> FStar_Extraction_ML_Syntax.mlbinder Prims.list -> binder Prims.list)
  = fun env1 -> fun bs -> FStar_Compiler_List.map (translate_binder env1) bs
and (translate_binder : env -> FStar_Extraction_ML_Syntax.mlbinder -> binder)
  =
  fun env1 ->
    fun uu___ ->
      match uu___ with
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ((flavor,
            { FStar_Extraction_ML_Syntax.mllb_name = name1;
              ...
              FStar_Extraction_ML_Syntax.mllb_attrs = uu___;
    ...
    fun flavor ->
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            FStar_Extraction_ML_Syntax.mllb_attrs = uu___1;
            FStar_Extraction_ML_Syntax.mllb_meta = meta;
            FStar_Extraction_ML_Syntax.print_typ = uu___2;_} when
            FStar_Compiler_Util.for_some
              (fun uu___3 ->
                 match uu___3 with
            ...
            let arg_names =
              match e.FStar_Extraction_ML_Syntax.expr with
              | FStar_Extraction_ML_Syntax.MLE_Fun (bs, uu___3) ->
                  FStar_Compiler_List.map
                    (fun uu___4 ->
                       match uu___4 with
                       | {
                           FStar_Extraction_ML_Syntax.mlbinder_name =
                             mlbinder_name;
                           FStar_Extraction_ML_Syntax.mlbinder_ty = uu___5;
                           FStar_Extraction_ML_Syntax.mlbinder_attrs = uu___6;_}
                           -> mlbinder_name) bs
              | uu___3 -> [] in
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            then FStar_Pervasives_Native.None
              ...
              (let env2 =
               ...
               | (i, eff, t) ->
                   ((let uu___8 =
                       (i > Prims.int_zero) && (FStar_Compiler_Debug.any ()) in
                     if uu___8
                     then
                       let msg =
                    ...
                    (let t1 = translate_type env3 t in
                     ...
                     let meta1 =
                       match (eff, t1) with
                       | (FStar_Extraction_ML_Syntax.E_ERASABLE, uu___8) ->
                     ...
                     with
                     | uu___8 ->
                         let msg = FStar_Compiler_Util.print_exn uu___8 in
                         ((let uu___10 =
                             let uu___11 =
                               let uu___12 =
                                 let uu___13 =
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            FStar_Extraction_ML_Syntax.mllb_attrs = uu___1;
            FStar_Extraction_ML_Syntax.mllb_meta = meta;
            FStar_Extraction_ML_Syntax.print_typ = uu___2;_} ->
            if
              FStar_Compiler_List.mem FStar_Extraction_ML_Syntax.NoExtract
                meta
            then FStar_Pervasives_Native.None
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            FStar_Extraction_ML_Syntax.mllb_attrs = uu___2;
