...
let (lident_of_string :
  Prims.string -> lident FStar_Pervasives_Native.option) =
  fun s ->
...
let (lident_of_typestring :
  FStar_Extraction_ML_Syntax.mlty -> lident FStar_Pervasives_Native.option) =
  fun t ->
  ...
  fun env1 ->
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (tag::uu___::uu___1::[], p)
          ...
          ->
          let uu___2 =
            let uu___3 = lident_of_typestring tag in
            FStar_Compiler_Util.must uu___3 in
          TQualified uu___2
      | FStar_Extraction_ML_Syntax.MLTY_Named
          (tag::uu___::uu___1::uu___2::[], p) when
          (let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           FStar_Compiler_Util.starts_with uu___3
             "Steel.ST.C.Types.struct_t0")
            ||
            (let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             FStar_Compiler_Util.starts_with uu___3
               "Steel.ST.C.Types.union_t0")
          ->
          let uu___3 =
            let uu___4 = lident_of_typestring tag in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (tag::uu___::[], p) when
          ...
          ->
          let uu___1 =
            let uu___2 = lident_of_typestring tag in
            FStar_Compiler_Util.must uu___2 in
          TQualified uu___1
      | FStar_Extraction_ML_Syntax.MLTY_Named
          (uu___::arg::uu___1::uu___2::[], p) when
          let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___3 = "Steel.C.Reference.ptr" ->
          let uu___3 = translate_type_without_decay env1 arg in TBuf uu___3
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu___::[], p) when
          (let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___1 = "Steel.ST.C.Types.ptr") ||
            (let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___1 = "Steel.ST.C.Types.array_ref")
          ->
          let uu___1 = translate_type_without_decay env1 arg in TBuf uu___1
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___ = "Steel.ST.C.Types.scalar_t" ->
          translate_type_without_decay env1 arg
      | FStar_Extraction_ML_Syntax.MLTY_Named (t1::n::s::[], p) when
          (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___ = "Steel.C.Array.Base.array_view_type_sized") ||
            (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___ = "Steel.ST.C.Types.base_array_t")
          ->
          let uu___ =
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu___::arg::[], p) when
          let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___1 = "Steel.C.Array.Base.array_or_null_from" ->
          let uu___1 = translate_type_without_decay env1 arg in TBuf uu___1
...
and (translate_type : env -> FStar_Extraction_ML_Syntax.mlty -> typ) =
  fun env1 ->
    fun t ->
      match t with
      | FStar_Extraction_ML_Syntax.MLTY_Named (t1::uu___::uu___1::[], p) when
          let uu___2 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___2 = "Steel.C.Array.Base.array_view_type_sized" ->
          let uu___2 = translate_type_without_decay env1 t1 in TBuf uu___2
      | FStar_Extraction_ML_Syntax.MLTY_Named (t1::uu___::[], p) when
          let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___1 = "Steel.C.Array.Base.array_view_type" ->
          let uu___1 = translate_type_without_decay env1 t1 in TBuf uu___1
      | t1 -> translate_type_without_decay env1 t1
  ...
  fun env1 ->
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___6 = "Steel.C.Array.Base.malloc_from") || false
          ->
          let uu___6 =
            let uu___7 = translate_expr env1 e1 in
            let uu___8 = translate_expr env1 e2 in
            (ManuallyManaged, uu___7, uu___8) in
          EBufCreate uu___6
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___5 = "Steel.C.Opt.malloc") || false
          ->
          let uu___5 =
            let uu___6 = translate_expr env1 e1 in
            (ManuallyManaged, uu___6, (EConstant (UInt32, "1"))) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___6 = "Steel.ST.C.Types.alloc") || false
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___7 = "Steel.C.Array.Base.free_from") || false
          -> let uu___7 = translate_expr env1 e2 in EBufFree uu___7
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.ST.C.Types.free" ->
          let uu___7 = translate_expr env1 e1 in EBufFree uu___7
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          (let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___3 = "FStar.HyperStack.ST.push_frame") ||
            (let uu___3 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.ST.Reference._free_and_pop_frame" -> EPopFrame
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___2;
             FStar_Extraction_ML_Syntax.loc = uu___3;_},
           uu___4::e1::uu___5::uu___6::[])
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.C.Array.Base.is_null_from" ->
          let uu___7 = translate_type env1 t in
          let uu___8 = translate_expr env1 e1 in
          generate_is_null uu___7 uu___8
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
          ...
          let uu___8 = translate_type env1 t in
          let uu___9 = translate_expr env1 e1 in
          generate_is_null uu___8 uu___9
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___2;
             FStar_Extraction_ML_Syntax.loc = uu___3;_},
           uu___4::uu___5::uu___6::e1::[])
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.ST.C.Types.is_null" ->
          let uu___7 = translate_type env1 t in
          let uu___8 = translate_expr env1 e1 in
          generate_is_null uu___7 uu___8
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___5 = "Steel.C.Array.Base.null_from" ->
          let uu___5 = translate_type env1 t in EBufNull uu___5
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___6 = "Steel.C.Reference.null") ||
            (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___6 = "Steel.ST.C.Types.null")
          -> let uu___6 = translate_type env1 t in EBufNull uu___6
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_TApp
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           uu___7::uu___8::{
                             ...
                             FStar_Extraction_ML_Syntax.loc = uu___10;_}::r::[])
          when
          let uu___11 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___11 = "Steel.C.StructLiteral.addr_of_struct_field''" ->
          let uu___11 =
            let uu___12 =
              let uu___13 =
                let uu___14 =
                  let uu___15 = lident_of_typestring struct_name in
                  FStar_Compiler_Util.must uu___15 in
                TQualified uu___14 in
              let uu___14 =
                let uu___15 =
                  let uu___16 = translate_expr env1 r in
                  (uu___16, (EConstant (UInt32, "0"))) in
                EBufRead uu___15 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu___4;_},
           {
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___5;
             FStar_Extraction_ML_Syntax.loc = uu___6;_}::uu___7::uu___8::r::
           {
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String field_name);
             FStar_Extraction_ML_Syntax.mlty = uu___9;
             FStar_Extraction_ML_Syntax.loc = uu___10;_}::uu___11::[])
          when
          ((let uu___12 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu___12 = "Steel.ST.C.Types.struct_field0") ||
             (let uu___12 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu___12 = "Steel.ST.C.Types.union_field0"))
            ||
            (let uu___12 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___12 = "Steel.ST.C.Types.union_switch_field0")
          ->
          let uu___12 =
            let uu___13 =
              let uu___14 =
                let uu___15 =
                  let uu___16 = lident_of_string struct_name in
                  FStar_Compiler_Util.must uu___16 in
                TQualified uu___15 in
              let uu___15 =
                let uu___16 =
                  let uu___17 = translate_expr env1 r in
                  (uu___17, (EQualified (["C"], "_zero_for_deref"))) in
                EBufRead uu___16 in
              (uu___14, uu___15, field_name) in
            EField uu___13 in
          EAddrOf uu___12
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           uu___6::{
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu___8;_}::r::[])
          when
          let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___9 = "Steel.C.UnionLiteral.addr_of_union_field''" ->
          let uu___9 =
            let uu___10 =
              let uu___11 =
                let uu___12 =
                  let uu___13 = lident_of_typestring union_name in
                  FStar_Compiler_Util.must uu___13 in
                TQualified uu___12 in
              let uu___12 =
                let uu___13 =
                  let uu___14 = translate_expr env1 r in
                  (uu___14, (EConstant (UInt32, "0"))) in
                EBufRead uu___13 in
              (uu___11, uu___12, field_name) in
            EField uu___10 in
          EAddrOf uu___9
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
          ...
          let uu___9 =
            let uu___10 =
              let uu___11 =
                let uu___12 =
                  let uu___13 =
                    let uu___14 = lident_of_typestring union_name in
                    FStar_Compiler_Util.must uu___14 in
                  TQualified uu___13 in
                let uu___13 =
                  let uu___14 =
                    let uu___15 = translate_expr env1 r in
                    (uu___15, (EConstant (UInt32, "0"))) in
                  EBufRead uu___14 in
                (uu___12, uu___13, field_name) in
              EField uu___11 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___6 = "Steel.C.Opt.opt_write_sel" ->
          let uu___6 =
            let uu___7 =
              let uu___8 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.ST.C.Types.read0" ->
          let uu___7 =
            let uu___8 = translate_expr env1 r in
            (uu___8, (EQualified (["C"], "_zero_for_deref"))) in
          EBufRead uu___7
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___6 = "Steel.ST.C.Types.write" ->
          let uu___6 =
            let uu___7 =
              let uu___8 =
                let uu___9 = translate_expr env1 r in
                (uu___9, (EQualified (["C"], "_zero_for_deref"))) in
              EBufRead uu___8 in
            let uu___8 = translate_expr env1 x in (uu___7, uu___8) in
          EAssign uu___6
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},
           uu___5::uu___6::uu___7::uu___8::r::[])
          when
          let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___9 = "Steel.ST.C.Types.array_ref_of_base" ->
          let uu___9 =
            let uu___10 = translate_expr env1 r in
            (uu___10, (EQualified (["C"], "_zero_for_deref"))) in
          EBufRead uu___9
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},
           uu___5::uu___6::a::uu___7::i::[])
          when
          (let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu___8 = "Steel.ST.C.Types.array_ref_cell") ||
            (let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___8 = "Steel.ST.C.Types.array_ref_split")
          ->
          let uu___8 =
            let uu___9 = translate_expr env1 a in
            let uu___10 = translate_expr env1 i in (uu___9, uu___10) in
          EBufSub uu___8
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},
           uu___5::r::uu___6::uu___7::[])
          when
          let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___8 = "Steel.C.Array.Base.ref_of_array_from" ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.C.Array.Base.mk_array_of_ref_from" ->
          translate_expr env1 r
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          let uu___9 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___9 = "Steel.C.Array.Base.intro_varray_from" ->
          let uu___9 =
            let uu___10 = translate_expr env1 r in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.C.Array.index_from" ->
          let uu___7 =
            let uu___8 = translate_expr env1 r in
            let uu___9 = translate_expr env1 i in (uu___8, uu___9) in
          EBufRead uu___7
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.C.Array.upd_from" ->
          let uu___7 =
            let uu___8 = translate_expr env1 r in
            let uu___9 = translate_expr env1 i in
            let uu___10 = translate_expr env1 x in (uu___8, uu___9, uu___10) in
          EBufWrite uu___7
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          let uu___7 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu___7 = "Steel.C.Array.Base.split_right_from" ->
          let uu___7 =
            let uu___8 =
              let uu___9 = translate_expr env1 a in
              let uu___10 = translate_expr env1 i in (uu___9, uu___10) in
  ...
  fun env1 ->
    fun fields ->
      let rec go fields1 =
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named ([], p) when
            (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___ = "Steel.C.Fields.c_fields_t_nil") ||
              (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___ = "Steel.ST.C.Types.field_t_nil")
            -> FStar_Pervasives_Native.Some []
        | FStar_Extraction_ML_Syntax.MLTY_Named (field::t::fields2::[], p)
            when
            (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___ = "Steel.C.Fields.c_fields_t_cons") ||
              (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu___ = "Steel.ST.C.Types.field_t_cons")
            ->
                   ...
                   | (field, ty) ->
                       ((let uu___6 =
                         ...
                         FStar_Compiler_Util.print1 "Translating %s.\n"
                           uu___6);
                        (let uu___6 = translate_type_without_decay env1 ty in
        ...
        (let define_struct tag fields =
           ...
           (let uu___2 = lident_of_typestring tag in
            ...
            | FStar_Pervasives_Native.Some p ->
                let fields1 =
                  let uu___3 = parse_steel_c_fields env1 fields in
                  FStar_Compiler_Util.must uu___3 in
                let uu___3 =
                  let uu___4 =
                    let uu___5 =
                    ...
                    (p, [], Prims.int_zero, uu___5) in
                  DTypeFlat uu___4 in
                FStar_Pervasives_Native.Some uu___3) in
         let define_union tag fields =
           ...
           (let uu___2 = lident_of_typestring tag in
            ...
            | FStar_Pervasives_Native.Some p ->
                let fields1 =
                  ...
                  FStar_Compiler_Util.must uu___3 in
                FStar_Pervasives_Native.Some
                  (DUntaggedUnion (p, [], Prims.int_zero, fields1))) in
         match ty with
         ...
         | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
             ...
             when
             let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___8 = "Steel.ST.C.Types.define_struct0" ->
             define_struct tag fields
         | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
             FStar_Extraction_ML_Syntax.tydecl_name = uu___2;
             FStar_Extraction_ML_Syntax.tydecl_ignored = uu___3;
             ...
             when
             let uu___8 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu___8 = "Steel.ST.C.Types.define_union0" ->
         ...
         | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
             ...
             (FStar_Compiler_Util.print_endline "Parsing union definition.";
              (let uu___7 = lident_of_typestring tag in
               match uu___7 with
               | FStar_Pervasives_Native.None ->
                   ((let uu___9 =
                       FStar_Extraction_ML_Code.string_of_mlty ([], "") tag in
               ...
               | FStar_Pervasives_Native.Some p1 ->
                   let fields1 =
                     let uu___8 = parse_steel_c_fields env1 fields in
                     FStar_Compiler_Util.must uu___8 in
                   FStar_Pervasives_Native.Some
                     (DUntaggedUnion (p1, [], Prims.int_zero, fields1))))
