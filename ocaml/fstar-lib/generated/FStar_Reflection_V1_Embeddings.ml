...
let (e_exp :
  FStar_Reflection_V1_Data.exp FStar_Syntax_Embeddings_Base.embedding) =
  let rec embed_exp rng e =
    let r =
      match e with
      | FStar_Reflection_V1_Data.Unit ->
          FStar_Reflection_V1_Constants.ref_E_Unit.FStar_Reflection_V1_Constants.t
      | FStar_Reflection_V1_Data.Var i ->
          let uu___ =
            let uu___1 =
              let uu___2 =
                let uu___3 = FStar_BigInt.string_of_big_int i in
            ...
            [uu___1] in
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_V1_Constants.ref_E_Var.FStar_Reflection_V1_Constants.t
            uu___ FStar_Compiler_Range_Type.dummyRange
      | FStar_Reflection_V1_Data.Mult (e1, e2) ->
          let uu___ =
            let uu___1 =
            ...
            uu___1 :: uu___2 in
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_V1_Constants.ref_E_Mult.FStar_Reflection_V1_Constants.t
            uu___ FStar_Compiler_Range_Type.dummyRange in
    {
      FStar_Syntax_Syntax.n = (r.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
  ...
  let rec unembed_exp t =
    ...
    | (hd, args) ->
        ...
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, []) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_V1_Constants.ref_E_Unit.FStar_Reflection_V1_Constants.lid
             -> FStar_Pervasives_Native.Some FStar_Reflection_V1_Data.Unit
         | (FStar_Syntax_Syntax.Tm_fvar fv, (i, uu___2)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_V1_Constants.ref_E_Var.FStar_Reflection_V1_Constants.lid
             ->
             let uu___3 = unembed FStar_Syntax_Embeddings.e_int i in
             FStar_Compiler_Util.bind_opt uu___3
               (fun i1 ->
                  FStar_Compiler_Effect.op_Less_Bar
                    (fun uu___4 -> FStar_Pervasives_Native.Some uu___4)
                    (FStar_Reflection_V1_Data.Var i1))
         | (FStar_Syntax_Syntax.Tm_fvar fv, (e1, uu___2)::(e2, uu___3)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_V1_Constants.ref_E_Mult.FStar_Reflection_V1_Constants.lid
             ->
             let uu___4 = unembed_exp e1 in
             FStar_Compiler_Util.bind_opt uu___4
               (fun e11 ->
                  let uu___5 = unembed_exp e2 in
                  FStar_Compiler_Util.bind_opt uu___5
                    (fun e21 ->
                       FStar_Compiler_Effect.op_Less_Bar
                         (fun uu___6 -> FStar_Pervasives_Native.Some uu___6)
                         (FStar_Reflection_V1_Data.Mult (e11, e21))))
         | uu___2 -> FStar_Pervasives_Native.None) in
  mk_emb embed_exp unembed_exp FStar_Reflection_V1_Constants.fstar_refl_exp
let (e_qualifier :
