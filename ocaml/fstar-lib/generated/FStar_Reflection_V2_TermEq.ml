        ...
        fun z ->
          fun c1 ->
            fun c2 ->
              ...
              | (uu___, Neq) -> Neq
              | uu___ -> Unknown
let (bv_cmp : FStar_Reflection_Types.bv comparator_for) =
  fun x1 ->
    fun x2 ->
      let v1 = FStar_Reflection_V2_Builtins.inspect_bv x1 in
      let v2 = FStar_Reflection_V2_Builtins.inspect_bv x2 in
      if
        v1.FStar_Reflection_V2_Data.index = v2.FStar_Reflection_V2_Data.index
      then Eq
      else Neq
let (namedv_cmp : FStar_Reflection_Types.namedv comparator_for) =
  fun x1 ->
    fun x2 ->
      let v1 = FStar_Reflection_V2_Builtins.inspect_namedv x1 in
      let v2 = FStar_Reflection_V2_Builtins.inspect_namedv x2 in
      if v1.FStar_Reflection_V2_Data.uniq = v2.FStar_Reflection_V2_Data.uniq
      then Eq
      else Neq
let (fv_cmp : FStar_Reflection_Types.fv comparator_for) =
  fun f1 ->
    fun f2 ->
      let n1 = FStar_Reflection_V2_Builtins.inspect_fv f1 in
      let n2 = FStar_Reflection_V2_Builtins.inspect_fv f2 in
...
let rec (univ_cmp : FStar_Reflection_Types.universe comparator_for) =
  fun u1 ->
    fun u2 ->
      let uv1 = FStar_Reflection_V2_Builtins.inspect_universe u1 in
      let uv2 = FStar_Reflection_V2_Builtins.inspect_universe u2 in
      match (uv1, uv2) with
      | (FStar_Reflection_V2_Data.Uv_Zero, FStar_Reflection_V2_Data.Uv_Zero)
          -> Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_V2_Data.Uv_Succ u11,
         FStar_Reflection_V2_Data.Uv_Succ u21) ->
          Obj.magic (Obj.repr (univ_cmp u11 u21))
      | (FStar_Reflection_V2_Data.Uv_Max us1, FStar_Reflection_V2_Data.Uv_Max
         us2) -> Obj.magic (Obj.repr (list_dec_cmp u1 u2 univ_cmp us1 us2))
      | (FStar_Reflection_V2_Data.Uv_BVar v1,
         FStar_Reflection_V2_Data.Uv_BVar v2) ->
          Obj.magic (Obj.repr (eq_cmp v1 v2))
      | (FStar_Reflection_V2_Data.Uv_Name n1,
         FStar_Reflection_V2_Data.Uv_Name n2) ->
          Obj.magic (Obj.repr (ident_cmp n1 n2))
      | (FStar_Reflection_V2_Data.Uv_Unif u11,
         FStar_Reflection_V2_Data.Uv_Unif u21) ->
...
let (const_cmp : FStar_Reflection_V2_Data.vconst comparator_for) =
  fun c1 ->
    fun c2 ->
      match (c1, c2) with
      | (FStar_Reflection_V2_Data.C_Unit, FStar_Reflection_V2_Data.C_Unit) ->
          Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_V2_Data.C_Int i1, FStar_Reflection_V2_Data.C_Int
         i2) -> Obj.magic (Obj.repr (eq_cmp i1 i2))
      | (FStar_Reflection_V2_Data.C_True, FStar_Reflection_V2_Data.C_True) ->
          Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_V2_Data.C_False, FStar_Reflection_V2_Data.C_False)
          -> Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_V2_Data.C_String s1,
         FStar_Reflection_V2_Data.C_String s2) ->
          Obj.magic (Obj.repr (eq_cmp s1 s2))
      | (FStar_Reflection_V2_Data.C_Range r1,
         FStar_Reflection_V2_Data.C_Range r2) ->
          Obj.magic (Obj.repr (range_cmp r1 r2))
      | (FStar_Reflection_V2_Data.C_Reify, FStar_Reflection_V2_Data.C_Reify)
          -> Obj.magic (Obj.repr Eq)
...
let rec (term_cmp : FStar_Reflection_Types.term comparator_for) =
  fun t1 ->
    fun t2 ->
      ...
      | (FStar_Reflection_V2_Data.Tv_BVar v1,
         FStar_Reflection_V2_Data.Tv_BVar v2) ->
          Obj.magic (Obj.repr (bv_cmp v1 v2))
      | (FStar_Reflection_V2_Data.Tv_FVar f1,
         FStar_Reflection_V2_Data.Tv_FVar f2) ->
          Obj.magic (Obj.repr (fv_cmp f1 f2))
      | (FStar_Reflection_V2_Data.Tv_UInst (f1, u1),
         FStar_Reflection_V2_Data.Tv_UInst (f2, u2)) ->
          Obj.magic
            (Obj.repr
      ...
      | (FStar_Reflection_V2_Data.Tv_Refine (sb1, r1),
         FStar_Reflection_V2_Data.Tv_Refine (sb2, r2)) ->
          Obj.magic
            (Obj.repr
               (op_Amp_Amp_Amp sb1 sb2 r1 r2 (binder_cmp sb1 sb2)
                  (term_cmp r1 r2)))
      | (FStar_Reflection_V2_Data.Tv_Const c1,
         FStar_Reflection_V2_Data.Tv_Const c2) ->
          Obj.magic (Obj.repr (const_cmp c1 c2))
      | (FStar_Reflection_V2_Data.Tv_Uvar (n1, u1),
         FStar_Reflection_V2_Data.Tv_Uvar (n2, u2)) ->
          Obj.magic
            (Obj.repr
               (op_Amp_Amp_Amp n1 n2 u1 u2 (eq_cmp n1 n2) (ctxu_cmp u1 u2)))
      | (FStar_Reflection_V2_Data.Tv_Let (r1, attrs1, sb1, e1, b1),
         FStar_Reflection_V2_Data.Tv_Let (r2, attrs2, sb2, e2, b2)) ->
          Obj.magic
            (Obj.repr
               (op_Amp_Amp_Amp (((r1, attrs1), sb1), e1)
                  ...
                  (term_cmp b1 b2)))
      | (FStar_Reflection_V2_Data.Tv_Match (sc1, o1, brs1),
         FStar_Reflection_V2_Data.Tv_Match (sc2, o2, brs2)) ->
          Obj.magic
            (Obj.repr
      ...
      | (FStar_Reflection_V2_Data.Tv_AscribedT (e1, ta1, tacopt1, eq1),
         FStar_Reflection_V2_Data.Tv_AscribedT (e2, ta2, tacopt2, eq2)) ->
          Obj.magic
            (Obj.repr
               (op_Amp_Amp_Amp ((e1, ta1), tacopt1) ((e2, ta2), tacopt2) eq1
                  ...
                  (eq_cmp eq1 eq2)))
      | (FStar_Reflection_V2_Data.Tv_AscribedC (e1, c1, tacopt1, eq1),
         FStar_Reflection_V2_Data.Tv_AscribedC (e2, c2, tacopt2, eq2)) ->
          Obj.magic
            (Obj.repr
...
and (aqual_cmp : FStar_Reflection_V2_Data.aqualv comparator_for) =
  fun a1 ->
    fun a2 ->
      match (a1, a2) with
           ...
           | (b2, (tc2, tacopt2, eq2)) ->
               Obj.magic
                 (op_Amp_Amp_Amp ((b1, tc1), tacopt1) ((b2, tc2), tacopt2)
                    ...
                    (eq_cmp eq1 eq2)))
and (binder_cmp : FStar_Reflection_Types.binder comparator_for) =
  fun b1 ->
    fun b2 ->
      let bv1 = FStar_Reflection_V2_Builtins.inspect_binder b1 in
      let bv2 = FStar_Reflection_V2_Builtins.inspect_binder b2 in
      Obj.magic
        (op_Amp_Amp_Amp
           ((bv1.FStar_Reflection_V2_Data.sort2),
             (bv1.FStar_Reflection_V2_Data.qual))
           ((bv2.FStar_Reflection_V2_Data.sort2),
             (bv2.FStar_Reflection_V2_Data.qual))
           bv1.FStar_Reflection_V2_Data.attrs
           bv2.FStar_Reflection_V2_Data.attrs
           (op_Amp_Amp_Amp bv1.FStar_Reflection_V2_Data.sort2
              bv2.FStar_Reflection_V2_Data.sort2
              bv1.FStar_Reflection_V2_Data.qual
              bv2.FStar_Reflection_V2_Data.qual
              (term_cmp bv1.FStar_Reflection_V2_Data.sort2
                 bv2.FStar_Reflection_V2_Data.sort2)
              (aqual_cmp bv1.FStar_Reflection_V2_Data.qual
                 bv2.FStar_Reflection_V2_Data.qual))
           (list_dec_cmp b1 b2 term_cmp bv1.FStar_Reflection_V2_Data.attrs
              bv2.FStar_Reflection_V2_Data.attrs))
and (comp_cmp : FStar_Reflection_Types.comp comparator_for) =
  fun c1 ->
    fun c2 ->
      let cv1 = FStar_Reflection_V2_Builtins.inspect_comp c1 in
      ...
      | (FStar_Reflection_V2_Data.C_GTotal t1,
         FStar_Reflection_V2_Data.C_GTotal t2) ->
          Obj.magic (Obj.repr (term_cmp t1 t2))
      | (FStar_Reflection_V2_Data.C_Lemma (pre1, post1, pat1),
         FStar_Reflection_V2_Data.C_Lemma (pre2, post2, pat2)) ->
          Obj.magic
            (Obj.repr
      ...
      | (FStar_Reflection_V2_Data.C_Eff (us1, ef1, t1, args1, dec1),
         FStar_Reflection_V2_Data.C_Eff (us2, ef2, t2, args2, dec2)) ->
          Obj.magic
            (Obj.repr
    ...
    fun br2 ->
      op_Amp_Amp_Amp (FStar_Pervasives_Native.fst br1)
        ...
        (term_cmp (FStar_Pervasives_Native.snd br1)
           (FStar_Pervasives_Native.snd br2))
and (pat_cmp : FStar_Reflection_V2_Data.pattern comparator_for) =
  fun p1 ->
    fun p2 ->
      match (p1, p2) with
      | (FStar_Reflection_V2_Data.Pat_Var (x1, s1),
         FStar_Reflection_V2_Data.Pat_Var (x2, s2)) ->
          Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_V2_Data.Pat_Constant x1,
         FStar_Reflection_V2_Data.Pat_Constant x2) ->
          Obj.magic (Obj.repr (const_cmp x1 x2))
      | (FStar_Reflection_V2_Data.Pat_Dot_Term x1,
         FStar_Reflection_V2_Data.Pat_Dot_Term x2) ->
          Obj.magic (Obj.repr (opt_dec_cmp p1 p2 term_cmp x1 x2))
      | (FStar_Reflection_V2_Data.Pat_Cons (head1, us1, subpats1),
         FStar_Reflection_V2_Data.Pat_Cons (head2, us2, subpats2)) ->
          Obj.magic
            (Obj.repr
      ...
      | uu___ -> Obj.magic (Obj.repr Neq)
and (pat_arg_cmp :
  (FStar_Reflection_V2_Data.pattern * Prims.bool) comparator_for) =
  fun uu___ ->
    fun uu___1 ->
      match (uu___, uu___1) with
      | ((p1, b1), (p2, b2)) ->
