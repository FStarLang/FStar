...
let one : 'a . 'a FStar_Syntax_Embeddings_Base.embedding -> 'a appemb =
  fun e ->
    fun args ->
      match args with
      | (t, uu___)::xs ->
...
let op_Less_Star_Star_Greater :
  'a 'b .
    ('a -> 'b) appemb ->
      'a FStar_Syntax_Embeddings_Base.embedding -> 'b appemb
...
let op_Less_Dollar_Dollar_Greater :
  'a 'b .
    ('a -> 'b) -> 'a FStar_Syntax_Embeddings_Base.embedding -> 'b appemb
  =
  fun u1 ->
    fun u2 ->
