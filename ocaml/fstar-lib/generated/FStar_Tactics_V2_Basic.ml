                          ...
                          (FStar_Class_Monad.op_let_Bang
                             ...
                             (fun uu___1 ->
                                (fun uu___1 ->
                                   let uu___1 = Obj.magic uu___1 in
                                   let uu___2 =
                                     FStar_Tactics_Monad.goal_of_guard reason
                                       e f sc_opt rng in
                                   Obj.magic
                                     (FStar_Class_Monad.op_let_Bang
                                        FStar_Tactics_Monad.monad_tac () ()
          ...
          fun sc_opt ->
            fun rng ->
              let uu___ =
                FStar_Tactics_Monad.log
                  (fun uu___1 ->
                     let uu___2 = FStar_TypeChecker_Rel.guard_to_string e g in
        ...
        FStar_Tactics_Monad.log
          (fun uu___1 ->
             let uu___2 =
               ...
               FStar_Class_Show.show FStar_Syntax_Print.showable_term uu___3 in
             let uu___3 =
                              ...
                              let uu___5 =
                                ...
                                let uu___7 =
                                  ...
                                  let uu___9 =
                                    ...
                                    let uu___11 =
                                      let uu___12 = FStar_Errors_Msg.text ":" in
                                      let uu___13 =
                                        let uu___14 =
                                          FStar_Tactics_Types.goal_env goal in
                                        let uu___15 =
                                ...
                                FStar_Pprint.op_Hat_Slash_Hat uu___6 uu___7 in
                              [uu___5] in
                            Obj.magic (FStar_Tactics_Monad.fail_doc uu___4)))
                        uu___3))) uu___1)
let (solve' :
  FStar_Tactics_Types.goal ->
    FStar_Syntax_Syntax.term -> unit FStar_Tactics_Monad.tac)
                                    ...
                                    | FStar_Errors.Error
                                        ...
                                        let uu___6 =
                                          ...
                                          FStar_Compiler_List.op_At uu___7
                                            msg in
                                        FStar_Tactics_Monad.fail_doc uu___6))
...
let (intros :
  FStar_BigInt.t ->
    FStar_Reflection_V2_Data.binding Prims.list FStar_Tactics_Monad.tac)
  =
  fun max ->
    let uu___ =
      let max1 = FStar_BigInt.to_int_fs max in
      Obj.magic
        (FStar_Class_Monad.op_let_Bang FStar_Tactics_Monad.monad_tac () ()
           (Obj.magic FStar_Tactics_Monad.cur_goal)
           (fun uu___1 ->
              (fun goal ->
                 ...
                 let uu___1 =
                   ...
                   FStar_Syntax_Util.arrow_formals_comp_ln uu___2 in
                 match uu___1 with
                 | (bs, c) ->
                     let uu___2 =
                       if max1 >= Prims.int_zero
                       then
                         let uu___3 = FStar_Compiler_List.splitAt max1 bs in
                         match uu___3 with
                         | (bs0, bs1) ->
                             let c1 =
                               let uu___4 = FStar_Syntax_Util.arrow_ln bs1 c in
                          ...
                          (match uu___3 with
                           | (env', bs2, c2) ->
                               let uu___4 =
                                 let uu___5 =
                                   let uu___6 =
                                     FStar_Syntax_Util.is_pure_comp c2 in
                                 ...
                                 then
                                   let uu___6 =
                                     ...
                                     Prims.strcat "Codomain is effectful: "
                                       uu___7 in
                                   FStar_Tactics_Monad.fail uu___6
                                 else
                                   FStar_Class_Monad.return
                                     FStar_Tactics_Monad.monad_tac ()
                                     (Obj.repr ()) in
                                            ...
                                            (FStar_Class_Monad.op_let_Bang
                                               ...
                                               (fun uu___7 ->
                                                  (fun uu___7 ->
                                                    ...
                                                    uu___7))) uu___5)))))
                uu___1)) in
    FStar_Tactics_Monad.wrap_err "intros" uu___
let (intro_rec :
  unit ->
    ...
    fun t2 ->
      fun s ->
        FStar_Syntax_Visit.visit_term false
          (fun t ->
             let uu___ = FStar_Syntax_Util.term_eq t t1 in
        ...
        let uu___1 =
          FStar_Class_Monad.op_let_Bang FStar_Tactics_Monad.monad_tac () ()
            ...
            (fun uu___2 ->
               (fun goal ->
                  let goal = Obj.magic goal in
                  let goal_t = FStar_Tactics_Types.goal_type goal in
                    ...
                    (FStar_Class_Monad.op_let_Bang
                       ...
                       (fun uu___3 ->
                          (fun uu___3 ->
                                                        ...
                                                        (fun uu___7 ->
                                                           ...
                                                           let uu___8 =
                                                             ...
                                                             FStar_Tactics_Monad.mk_irrelevant_goal
                                                               ...
                                                               env1 uu___9
                                                               FStar_Pervasives_Native.None
                                                               (goal.FStar_Tactics_Types.goal_ctx_uvar).FStar_Syntax_Syntax.ctx_uvar_range
                                                               goal.FStar_Tactics_Types.opts
                                                               goal.FStar_Tactics_Types.label in
                                                           Obj.magic
                                                             (FStar_Class_Monad.op_let_Bang
                            ...
                            uu___3))) uu___2) in
        FStar_Tactics_Monad.focus uu___1 in
      FStar_Tactics_Monad.wrap_err "grewrite" uu___
let (rename_to :
                            ...
                            | (gamma, r1, r2) ->
                                ...
                                let nenv =
                                    ...
                                    FStar_Tactics_Types.goal_env g1 in
                                  {
                                    ...
                                    FStar_TypeChecker_Env.flychecking =
                                      (uu___3.FStar_TypeChecker_Env.flychecking);
                                    FStar_TypeChecker_Env.uvar_subtyping =
...
let (set_dump_on_failure : Prims.bool -> unit FStar_Tactics_Monad.tac) =
  fun b ->
    FStar_Class_Monad.op_let_Bang FStar_Tactics_Monad.monad_tac () ()
      (Obj.magic FStar_Tactics_Monad.get)
      (fun uu___ ->
            ...
            let ps1 =
              {
                ...
                FStar_Tactics_Types.urgency =
                  (ps.FStar_Tactics_Types.urgency);
                FStar_Tactics_Types.dump_on_failure = b
              } in
            Obj.magic (FStar_Tactics_Monad.set ps1)) uu___)
                        ...
                        (let g2 =
                           {
                             ...
                             FStar_TypeChecker_Env.flychecking =
                               (g1.FStar_TypeChecker_Env.flychecking);
                             FStar_TypeChecker_Env.uvar_subtyping =
                           ...
                           let g3 =
                             {
                               ...
                               FStar_TypeChecker_Env.flychecking =
                                 (g2.FStar_TypeChecker_Env.flychecking);
                               FStar_TypeChecker_Env.uvar_subtyping =
                            ...
                            (let must_tot = false in
                             let g2 =
                               ...
                               | FStar_Pervasives_Native.Some typ ->
                                   FStar_TypeChecker_Env.set_expected_typ g1
                                     typ in
                             let g3 =
                               {
                                 FStar_TypeChecker_Env.solver =
                             ...
                             | (e1, t, guard) ->
                                 ...
                                 (dbg_refl g3
                                  ...
                                  (let g4 =
                                     ...
                                     FStar_TypeChecker_Env.push_bvs g3 uu___9 in
                                   let allow_uvars = false in
                                   let allow_names = true in
                                   let e2 =
                                     FStar_Syntax_Compress.deep_compress
        ...
        fun imps ->
          ...
          let ps =
            ...
            let uu___1 = FStar_Compiler_Util.psmap_empty () in
            {
              ...
              FStar_Tactics_Types.dump_on_failure = true
            } in
          ps
