            ...
            (fun uu___1 ->
               (fun uu___1 ->
                  ...
                  | (a1, uu___2) ->
                      Obj.magic
                        (FStar_Class_Monad.return
                           FStar_Tactics_Monad.monad_tac () (Obj.magic a1)))
                 uu___1))) uu___
let rec map :
               ...
               (fun ps ->
                  ...
                  | uu___::uu___1 ->
                      let uu___2 =
                        ...
                        divide FStar_BigInt.one tau uu___3 in
                      Obj.magic
                        (FStar_Class_Monad.op_let_Bang
                           FStar_Tactics_Monad.monad_tac () ()
                           (Obj.magic uu___2)
                       ...
                       (Obj.repr
                          (let typ' = FStar_Syntax_Util.comp_result c in
                           let uu___3 =
                             ...
                             let uu___5 = goal_typedness_deps goal in
                            ...
                            | (gamma, r1, r2) ->
                                ...
                                let nenv =
                                    ...
                                    FStar_Tactics_Types.goal_env g1 in
                                  {
                                    ...
                                    FStar_TypeChecker_Env.extension_state =
                                      (uu___3.FStar_TypeChecker_Env.extension_state)
                                  } in
                                let uu___3 =
                                  FStar_Tactics_Monad.mk_irrelevant_goal
                        ...
                        (let g2 =
                           {
                             ...
                             FStar_TypeChecker_Env.extension_state =
                               (g1.FStar_TypeChecker_Env.extension_state)
                           } in
                         let e1 =
                           let g3 =
                             {
                               ...
                               FStar_TypeChecker_Env.extension_state =
                                 (g2.FStar_TypeChecker_Env.extension_state)
                             } in
