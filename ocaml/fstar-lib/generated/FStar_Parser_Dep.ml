      ...
      fun deps1 ->
        let pref uu___ =
          (let uu___2 =
             ...
             [uu___3] in
           FStar_Compiler_Util.fprint outc
          ...
          (let uu___3 =
             let uu___4 =
               FStar_Class_Show.show
                 ...
                 FStar_Compiler_Util.exec_name in
             [uu___4] in
           FStar_Compiler_Util.fprint outc "# Executable: %s\n" uu___3);
          (let uu___4 =
             let uu___5 = FStar_Compiler_Effect.op_Bang FStar_Options._commit in
             [uu___5] in
           FStar_Compiler_Util.fprint outc "# Hash: %s\n" uu___4);
          (let uu___5 =
             let uu___6 =
               let uu___7 =
                 let uu___8 = FStar_Compiler_Util.getcwd () in
                 FStar_Compiler_Util.normalize_file_path uu___8 in
               FStar_Class_Show.show
                 (FStar_Class_Show.printableshow
                    FStar_Class_Printable.printable_string) uu___7 in
             [uu___6] in
           FStar_Compiler_Util.fprint outc "# Running in directory %s\n"
             uu___5);
          (let uu___6 =
             let uu___7 =
               let uu___8 = FStar_Compiler_Util.get_cmd_args () in
               FStar_Class_Show.show
                 (FStar_Class_Show.show_list
                    (FStar_Class_Show.printableshow
                       FStar_Class_Printable.printable_string)) uu___8 in
             [uu___7] in
           FStar_Compiler_Util.fprint outc
