  ...
  fun f ->
    fun b ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (26))
           (Prims.of_int (33)) (Prims.of_int (28)) (Prims.of_int (19)))
                   ...
                   (Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (FStar_Range.mk_range "FStar.Tactics.Visit.fst"
                            (Prims.of_int (27)) (Prims.of_int (16))
                            (Prims.of_int (27)) (Prims.of_int (46)))
                         (Obj.magic (f bview.FStar_Reflection_Data.sort2))
                         (fun uu___ ->
                            FStar_Tactics_Effect.lift_div_tac
                              (fun uu___1 ->
                                 {
                                   FStar_Reflection_Data.sort2 = uu___;
                                   FStar_Reflection_Data.qual =
                                     (bview.FStar_Reflection_Data.qual);
                                   FStar_Reflection_Data.attrs =
                                     (bview.FStar_Reflection_Data.attrs);
...
let (on_sort_simple_binder :
  (FStar_Reflection_Types.term ->
    ...
    FStar_Reflection_Data.simple_binder ->
      (FStar_Reflection_Data.simple_binder, unit)
  ...
  fun f ->
    fun b ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (32))
           (Prims.of_int (33)) (Prims.of_int (35)) (Prims.of_int (19)))
        (FStar_Tactics_Effect.lift_div_tac
           (fun uu___ -> FStar_Reflection_Builtins.inspect_binder b))
        (fun uu___ ->
           (fun bview ->
  ...
  fun ff ->
    fun t ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (38))
           (Prims.of_int (26)) (Prims.of_int (93)) (Prims.of_int (18)))
        (FStar_Tactics_Effect.lift_div_tac
                   ...
                   (match tv with
                    ...
                    | FStar_Reflection_Data.Tv_Unsupp ->
                        Obj.magic
                          (Obj.repr
                             (FStar_Tactics_Effect.lift_div_tac
                                (fun uu___ -> FStar_Reflection_Data.Tv_Unsupp)))
                          ...
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                (FStar_Range.mk_range
                                   ...
                                   (Prims.of_int (52)) (Prims.of_int (16))
                        ...
                        Obj.magic
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                ...
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Visit.fst"
                                   (Prims.of_int (60)) (Prims.of_int (33))
                        ...
                        Obj.magic
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                ...
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Visit.fst"
                                   (Prims.of_int (64)) (Prims.of_int (56))
                                   (Prims.of_int (66)) (Prims.of_int (21)))
                                (Obj.magic
                        ...
                        Obj.magic
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                ...
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Visit.fst"
                                   (Prims.of_int (68)) (Prims.of_int (56))
                        ...
                        Obj.magic
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                ...
                                (FStar_Range.mk_range
                                   "FStar.Tactics.Visit.fst"
                                   (Prims.of_int (73)) (Prims.of_int (34))
                          ...
                          (Obj.repr
                             (FStar_Tactics_Effect.tac_bind
                                ...
                                (FStar_Range.mk_range
                                   ...
                                   (Prims.of_int (88)) (Prims.of_int (36)))
...
and (visit_br :
  ...
  fun ff ->
    fun b ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (95))
           (Prims.of_int (15)) (Prims.of_int (95)) (Prims.of_int (16)))
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (94))
           (Prims.of_int (62)) (Prims.of_int (98)) (Prims.of_int (8)))
    ...
    fun uu___ ->
      (fun ff ->
         fun p ->
           ...
           | FStar_Reflection_Data.Pat_Var (v, s) ->
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___ -> FStar_Reflection_Data.Pat_Var (v, s))))
                          ...
                          FStar_Tactics_Effect.lift_div_tac
                            (fun uu___ ->
                               FStar_Reflection_Data.Pat_Cons
                                 (head, univs, subpats1)))))
           | FStar_Reflection_Data.Pat_Dot_Term t ->
               Obj.magic
                 (Obj.repr
                    (FStar_Tactics_Effect.tac_bind
                       (FStar_Range.mk_range "FStar.Tactics.Visit.fst"
...
and (visit_comp :
  ...
  fun ff ->
    fun c ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (111))
           (Prims.of_int (11)) (Prims.of_int (111)) (Prims.of_int (25)))
        (FStar_Range.mk_range "FStar.Tactics.Visit.fst" (Prims.of_int (111))
           (Prims.of_int (28)) (Prims.of_int (134)) (Prims.of_int (15)))
        (FStar_Tactics_Effect.lift_div_tac
                   ...
                   (match cv with
                    ...
                    | FStar_Reflection_Data.C_Lemma (pre, post, pats) ->
                        Obj.magic
                          (FStar_Tactics_Effect.tac_bind
                             (FStar_Range.mk_range "FStar.Tactics.Visit.fst"
                                (Prims.of_int (123)) (Prims.of_int (18))
