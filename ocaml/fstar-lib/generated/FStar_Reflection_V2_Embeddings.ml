  ...
  let embed_universe_view rng uv =
    ...
    | FStar_Reflection_V2_Data.Uv_Max us ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              embed (FStar_Syntax_Embeddings.e_list e_universe) rng us in
            FStar_Syntax_Syntax.as_arg uu___2 in
          [uu___1] in
        FStar_Syntax_Syntax.mk_Tm_app
             ...
             then
               ...
               then
                 ...
                 then
                   (let uu___2 =
                      FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                        (fun uu___3 -> FStar_Reflection_V2_Data.Uv_Max uu___3)
                ...
                let uu___4 =
                  embed
                    (FStar_Syntax_Embeddings.e_option
                       (FStar_Syntax_Embeddings.e_list e_universe)) rng univs in
                   ...
                   then
                     ...
                     then
                       (let uu___2 =
                          FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                            (fun uu___3 ->
                               FStar_Reflection_V2_Data.Pat_Dot_Term uu___3)
                 ...
                 let uu___3 =
                   let uu___4 =
                     ...
                     FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                       uu___5 e_aqualv in
                   FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                     uu___4 (FStar_Syntax_Embeddings.e_list e_term) in
                 FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                   uu___3 e_ppname in
               FStar_Syntax_Embeddings_AppEmb.run args uu___2
             else FStar_Pervasives_Native.None) in
                        ...
                        let uu___3 =
                          let uu___4 =
                            let uu___5 =
                              let uu___6 =
                                FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                                  (curry5
                                     (fun uu___7 ->
                                        FStar_Reflection_V2_Data.C_Eff uu___7))
                                  (FStar_Syntax_Embeddings.e_list e_universe) in
                              FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                            ...
                            FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                              uu___5 e_term in
                          FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                            uu___4 (FStar_Syntax_Embeddings.e_list e_argv) in
                        FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                          uu___3 (FStar_Syntax_Embeddings.e_list e_term) in
                      FStar_Syntax_Embeddings_AppEmb.run args uu___2)
                   else FStar_Pervasives_Native.None) in
  ...
  let ee rng e =
    ...
    | FStar_Syntax_Syntax.DT (i, t) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        FStar_Syntax_Syntax.mk_Tm_app
          FStar_Reflection_V2_Constants.ref_DT.FStar_Reflection_V2_Constants.t
          uu___ rng
      ...
      (fun uu___1 ->
         ...
         | (fv, args) ->
             ...
             then
               ...
               if
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Reflection_V2_Constants.ref_DT.FStar_Reflection_V2_Constants.lid
               then
                 (let uu___2 =
                    let uu___3 =
                      FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                        (curry (fun uu___4 -> FStar_Syntax_Syntax.DT uu___4))
                        FStar_Syntax_Embeddings.e_fsint in
                    FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                      uu___3 e_term in
                  FStar_Syntax_Embeddings_AppEmb.run args uu___2)
                 ...
                 then
                   (let uu___2 =
                      let uu___3 =
                        FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                          (curry
                             (fun uu___4 -> FStar_Syntax_Syntax.NM uu___4))
                          e_namedv in
                      FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                         ...
                         (let uu___2 =
                            let uu___3 =
                              FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                                (curry
                                   (fun uu___4 ->
                                      FStar_Syntax_Syntax.UD uu___4)) e_ident in
                            FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                              uu___3 FStar_Syntax_Embeddings.e_fsint in
                          FStar_Syntax_Embeddings_AppEmb.run args uu___2)
                       else FStar_Pervasives_Native.None) in
  ...
  let embed_lb_view rng lbv =
    let uu___ =
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            embed (FStar_Syntax_Embeddings.e_list e_univ_name) rng
    ...
    | FStar_Reflection_V2_Data.Sg_Let (r, lbs) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                embed (FStar_Syntax_Embeddings.e_list e_letbinding) rng lbs in
              FStar_Syntax_Syntax.as_arg uu___4 in
            [uu___3] in
          uu___1 :: uu___2 in
        FStar_Syntax_Syntax.mk_Tm_app
    ...
    | FStar_Reflection_V2_Data.Sg_Inductive (nm, univs, bs, t, dcs) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                embed (FStar_Syntax_Embeddings.e_list e_univ_name) rng univs in
              FStar_Syntax_Syntax.as_arg uu___4 in
            let uu___4 =
              let uu___5 =
               ...
               let uu___2 =
                 let uu___3 =
                   ...
                   FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                     uu___4 e_term in
                 FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                   uu___3 (FStar_Syntax_Embeddings.e_list e_ctor) in
               FStar_Syntax_Embeddings_AppEmb.run args uu___2
             else
               if
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 (let uu___2 =
                    let uu___3 =
                      FStar_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                        ...
                        FStar_Syntax_Embeddings.e_bool in
                    FStar_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                      uu___3 (FStar_Syntax_Embeddings.e_list e_letbinding) in
                  FStar_Syntax_Embeddings_AppEmb.run args uu___2)
               else
                 if
                   FStar_Syntax_Syntax.fv_eq_lid fv
              ...
              let uu___2 =
                embed
                  (FStar_Syntax_Embeddings.e_tuple2
                     (FStar_Syntax_Embeddings.e_list e_univ_name)
                     (FStar_Syntax_Embeddings.e_list e_univ_name)) rng
                  (ids1, ids2) in
              FStar_Syntax_Syntax.as_arg uu___2 in
            [uu___1] in
          FStar_Syntax_Syntax.mk_Tm_app
  ...
  fun i ->
    ...
    let uu___ =
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            embed (FStar_Syntax_Embeddings.e_list e_univ_name)
...
let (unfold_lazy_fvar :
  ...
  fun i ->
    ...
    let uu___ =
      let uu___1 =
        let uu___2 =
          let uu___3 = FStar_Reflection_V2_Builtins.inspect_fv fv in
