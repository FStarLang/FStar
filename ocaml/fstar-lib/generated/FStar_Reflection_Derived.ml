  ...
  fun nm ->
    fun sort ->
      FStar_Reflection_Builtins.pack_binder
        {
          FStar_Reflection_Data.sort2 = sort;
          FStar_Reflection_Data.qual = FStar_Reflection_Data.Q_Implicit;
          FStar_Reflection_Data.attrs = [];
          FStar_Reflection_Data.ppname2 = (FStar_Sealed.seal nm)
        }
let (push_binding :
  FStar_Reflection_Types.env ->
    FStar_Reflection_Data.binding -> FStar_Reflection_Types.env)
  =
  fun e ->
    fun b ->
      let nv =
        FStar_Reflection_Builtins.pack_namedv
          {
            FStar_Reflection_Data.uniq = (b.FStar_Reflection_Data.uniq1);
            FStar_Reflection_Data.sort =
              (FStar_Sealed.seal b.FStar_Reflection_Data.sort3);
            FStar_Reflection_Data.ppname = (b.FStar_Reflection_Data.ppname3)
          } in
      FStar_Reflection_Builtins.push_namedv e nv
let (type_of_binder :
...
let (binder_set_qual :
  ...
  fun q ->
    fun b ->
      ...
      FStar_Reflection_Builtins.pack_binder
        {
          FStar_Reflection_Data.sort2 = (bview.FStar_Reflection_Data.sort2);
          FStar_Reflection_Data.qual = q;
          FStar_Reflection_Data.attrs = (bview.FStar_Reflection_Data.attrs);
