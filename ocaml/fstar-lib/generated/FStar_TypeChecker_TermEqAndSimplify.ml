    ...
    fun env ->
      fun tm ->
        ...
        | FStar_Syntax_Syntax.Tm_app
            ...
            ->
            let uu___8 =
              FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid in
            if uu___8
                       ...
                       (let uu___16 =
                        ...
                        then
                          ...
                          | (uu___18, (arg, uu___19))::(FStar_Pervasives_Native.Some
                                                        (false), uu___20)::[]
                              ->
                              let uu___21 = FStar_Syntax_Util.mk_neg arg in
                          ...
                          | (uu___18, (p, uu___19))::(uu___20, (q, uu___21))::[]
                              ->
                              let uu___22 = FStar_Syntax_Util.term_eq p q in
                              (if uu___22
                               then w FStar_Syntax_Util.t_true
                               else squashed_head_un_auto_squash_args tm)
                          ...
                          (let uu___18 =
                           ...
                           then
                             ...
                             | (FStar_Pervasives_Native.Some (true), uu___20)::[]
                                 -> w FStar_Syntax_Util.t_false
                             | (FStar_Pervasives_Native.Some (false),
                                uu___20)::[] -> w FStar_Syntax_Util.t_true
                             | uu___20 ->
                                   ...
                                   (let uu___24 =
                                    ...
                                    then
                                      ...
                                      | ({
                                           ...
                                           FStar_Syntax_Syntax.pos = uu___25;
                                           FStar_Syntax_Syntax.vars = uu___26;
                          ...
                          (let uu___14 =
                           ...
                           then
                             ...
                             | (FStar_Pervasives_Native.Some (true), uu___16)::[]
                                 -> w FStar_Syntax_Util.t_false
                             | (FStar_Pervasives_Native.Some (false),
                                uu___16)::[] -> w FStar_Syntax_Util.t_true
                             | uu___16 ->
                                 squashed_head_un_auto_squash_args tm
                           else
                             (let uu___16 =
                                   ...
                                   (let uu___20 =
                                    ...
                                    then
                                      ...
                                      | ({
                                           ...
                                           FStar_Syntax_Syntax.vars = uu___22;
                                           FStar_Syntax_Syntax.hash_code =
                                             uu___23;_},
                                         uu___24)::[] ->
                                          w FStar_Syntax_Util.t_true
