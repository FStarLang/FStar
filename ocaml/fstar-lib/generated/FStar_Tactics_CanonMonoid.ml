      ...
      fun me ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
             ...
             (Prims.of_int (33)))
          (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
             (Prims.of_int (83)) (Prims.of_int (71)) (Prims.of_int (94))
             (Prims.of_int (25)))
    ...
    fun me ->
      FStar_Tactics_Effect.tac_bind
        (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
           ...
           (Prims.of_int (67)))
        (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
           (Prims.of_int (97)) (Prims.of_int (70)) (Prims.of_int (103))
           (Prims.of_int (32)))
        (Obj.magic
           (FStar_Tactics_Effect.tac_bind
              (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
  ...
  fun m ->
    FStar_Tactics_Effect.tac_bind
      (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
         ...
         (Prims.of_int (9)))
      (FStar_Range.mk_range "FStar.Tactics.CanonMonoid.fst"
         (Prims.of_int (106)) (Prims.of_int (10)) (Prims.of_int (120))
                    ...
                    (fun g ->
                       ...
                       | FStar_Reflection_Formula.Comp
                           (FStar_Reflection_Formula.Eq
                            (FStar_Pervasives_Native.Some t), me1, me2)
                           ->
                           Obj.magic
                             (Obj.repr
                                (FStar_Tactics_Effect.tac_bind
