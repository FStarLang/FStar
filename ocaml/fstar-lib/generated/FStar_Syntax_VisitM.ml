...
let __proj__Mklvm__item__lvm_monad :
  ...
  fun x11 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        ...
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> alvm_monad
let lvm_monad : 'm . 'm lvm -> 'm FStar_Class_Monad.monad =
  fun x11 -> __proj__Mklvm__item__lvm_monad x11
let __proj__Mklvm__item__f_term :
  ...
  fun x12 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_term
let f_term : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.term) endo =
  fun x12 -> __proj__Mklvm__item__f_term x12
let __proj__Mklvm__item__f_binder :
  ...
  fun x13 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_binder
let f_binder : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.binder) endo =
  fun x13 -> __proj__Mklvm__item__f_binder x13
let __proj__Mklvm__item__f_binding_bv :
  ...
  fun x14 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_binding_bv
let f_binding_bv : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.bv) endo =
  fun x14 -> __proj__Mklvm__item__f_binding_bv x14
let __proj__Mklvm__item__f_br :
  ...
  fun x15 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_br
let f_br : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.branch) endo =
  fun x15 -> __proj__Mklvm__item__f_br x15
let __proj__Mklvm__item__f_comp :
  ...
  fun x16 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_comp
let f_comp : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.comp) endo =
  fun x16 -> __proj__Mklvm__item__f_comp x16
let __proj__Mklvm__item__f_residual_comp :
  ...
  fun x17 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_residual_comp
let f_residual_comp :
  'm . 'm lvm -> ('m, FStar_Syntax_Syntax.residual_comp) endo =
  fun x17 -> __proj__Mklvm__item__f_residual_comp x17
let __proj__Mklvm__item__f_univ :
  ...
  fun x18 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> af_univ
let f_univ : 'm . 'm lvm -> ('m, FStar_Syntax_Syntax.universe) endo =
  fun x18 -> __proj__Mklvm__item__f_univ x18
let __proj__Mklvm__item__proc_quotes : 'm . 'm lvm -> Prims.bool =
  fun x19 ->
    ...
    | { lvm_monad = alvm_monad; f_term = af_term; f_binder = af_binder;
        f_binding_bv = af_binding_bv; f_br = af_br; f_comp = af_comp;
        f_residual_comp = af_residual_comp; f_univ = af_univ;
        proc_quotes = aproc_quotes;_} -> aproc_quotes
let proc_quotes : 'm . 'm lvm -> Prims.bool =
  fun x19 -> __proj__Mklvm__item__proc_quotes x19
