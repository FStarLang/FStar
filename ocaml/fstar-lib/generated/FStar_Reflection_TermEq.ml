...
let _ =
  FStar_Tactics_Native.register_plugin "FStar.Reflection.TermEq.term_eq"
    (Prims.of_int (2))
    (fun _psc ->
       fun cb ->
         fun us ->
...
let (term_eq_dec : faithful_term -> faithful_term -> Prims.bool) =
  fun t1 -> fun t2 -> uu___is_Eq (term_cmp t1 t2)
let _ =
  FStar_Tactics_Native.register_plugin "FStar.Reflection.TermEq.term_eq_dec"
    (Prims.of_int (2))
    (fun _psc ->
       fun cb ->
         fun us ->
...
let _ =
  FStar_Tactics_Native.register_plugin "FStar.Reflection.TermEq.univ_eq"
    (Prims.of_int (2))
    (fun _psc ->
       fun cb ->
         fun us ->
...
let (univ_eq_dec : faithful_universe -> faithful_universe -> Prims.bool) =
  fun u1 -> fun u2 -> uu___is_Eq (univ_cmp u1 u2)
let _ =
  FStar_Tactics_Native.register_plugin "FStar.Reflection.TermEq.univ_eq_dec"
    (Prims.of_int (2))
    (fun _psc ->
       fun cb ->
         fun us ->
