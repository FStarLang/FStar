...
let (bv_cmp : FStar_Reflection_Types.bv comparator_for) =
  fun x1 ->
    fun x2 ->
      ...
      if v1.FStar_Reflection_Data.index = v2.FStar_Reflection_Data.index
      then Eq
      else Neq
let (namedv_cmp : FStar_Reflection_Types.namedv comparator_for) =
  fun x1 ->
    fun x2 ->
      let v1 = FStar_Reflection_Builtins.inspect_namedv x1 in
      let v2 = FStar_Reflection_Builtins.inspect_namedv x2 in
      if v1.FStar_Reflection_Data.uniq = v2.FStar_Reflection_Data.uniq
      then Eq
      else Neq
  ...
  fun u1 ->
    fun u2 ->
      ...
      | (FStar_Reflection_Data.Uv_Succ u11, FStar_Reflection_Data.Uv_Succ
         u21) -> Obj.magic (Obj.repr (univ_cmp u11 u21))
...
let (const_cmp : FStar_Reflection_Data.vconst comparator_for) =
  fun c1 ->
    fun c2 ->
      match (c1, c2) with
      ...
      | (FStar_Reflection_Data.C_Reflect n1, FStar_Reflection_Data.C_Reflect
         n2) -> Obj.magic (Obj.repr (eq_cmp n1 n2))
      | uu___ -> Obj.magic (Obj.repr Neq)
...
let rec (term_cmp : FStar_Reflection_Types.term comparator_for) =
  fun t1 ->
    fun t2 ->
      ...
      | (FStar_Reflection_Data.Tv_Refine (sb1, r1),
         FStar_Reflection_Data.Tv_Refine (sb2, r2)) ->
          Obj.magic
            (Obj.repr
               (op_Amp_Amp_Amp sb1 sb2 r1 r2 (binder_cmp sb1 sb2)
                  (term_cmp r1 r2)))
      | (FStar_Reflection_Data.Tv_Const c1, FStar_Reflection_Data.Tv_Const
         c2) -> Obj.magic (Obj.repr (const_cmp c1 c2))
      ...
      | (FStar_Reflection_Data.Tv_Let (r1, attrs1, sb1, e1, b1),
         FStar_Reflection_Data.Tv_Let (r2, attrs2, sb2, e2, b2)) ->
          Obj.magic
            (Obj.repr
      ...
      | (FStar_Reflection_Data.Tv_Unknown, FStar_Reflection_Data.Tv_Unknown)
          -> Obj.magic (Obj.repr Eq)
      | uu___ -> Obj.magic (Obj.repr Neq)
and (arg_cmp : FStar_Reflection_Data.argv comparator_for) =
  fun uu___ ->
    fun uu___1 ->
      match (uu___, uu___1) with
      | ((a1, q1), (a2, q2)) ->
          op_Amp_Amp_Amp a1 a2 q1 q2 (term_cmp a1 a2) (aqual_cmp q1 q2)
and (aqual_cmp : FStar_Reflection_Data.aqualv comparator_for) =
  fun a1 ->
    fun a2 ->
      match (a1, a2) with
...
and (binder_cmp : FStar_Reflection_Types.binder comparator_for) =
  fun b1 ->
    fun b2 ->
      ...
      Obj.magic
        (op_Amp_Amp_Amp
           ((bv1.FStar_Reflection_Data.sort2),
             (bv1.FStar_Reflection_Data.qual))
           ((bv2.FStar_Reflection_Data.sort2),
             (bv2.FStar_Reflection_Data.qual))
           bv1.FStar_Reflection_Data.attrs bv2.FStar_Reflection_Data.attrs
           (op_Amp_Amp_Amp bv1.FStar_Reflection_Data.sort2
              bv2.FStar_Reflection_Data.sort2 bv1.FStar_Reflection_Data.qual
              bv2.FStar_Reflection_Data.qual
              (term_cmp bv1.FStar_Reflection_Data.sort2
                 bv2.FStar_Reflection_Data.sort2)
              (aqual_cmp bv1.FStar_Reflection_Data.qual
                 bv2.FStar_Reflection_Data.qual))
           (list_dec_cmp b1 b2 term_cmp bv1.FStar_Reflection_Data.attrs
              bv2.FStar_Reflection_Data.attrs))
and (comp_cmp : FStar_Reflection_Types.comp comparator_for) =
  fun c1 ->
    fun c2 ->
      ...
      | uu___ -> Obj.magic (Obj.repr Neq)
and (br_cmp : FStar_Reflection_Data.branch comparator_for) =
  fun br1 ->
    fun br2 ->
      op_Amp_Amp_Amp (FStar_Pervasives_Native.fst br1)
        ...
        (term_cmp (FStar_Pervasives_Native.snd br1)
           (FStar_Pervasives_Native.snd br2))
and (pat_cmp : FStar_Reflection_Data.pattern comparator_for) =
  fun p1 ->
    fun p2 ->
      match (p1, p2) with
      | (FStar_Reflection_Data.Pat_Var (x1, s1),
         FStar_Reflection_Data.Pat_Var (x2, s2)) -> Obj.magic (Obj.repr Eq)
      | (FStar_Reflection_Data.Pat_Constant x1,
         FStar_Reflection_Data.Pat_Constant x2) ->
          Obj.magic (Obj.repr (const_cmp x1 x2))
      | (FStar_Reflection_Data.Pat_Dot_Term x1,
         FStar_Reflection_Data.Pat_Dot_Term x2) ->
          Obj.magic (Obj.repr (opt_dec_cmp p1 p2 term_cmp x1 x2))
      | (FStar_Reflection_Data.Pat_Cons (head1, us1, subpats1),
         FStar_Reflection_Data.Pat_Cons (head2, us2, subpats2)) ->
          Obj.magic
            (Obj.repr
