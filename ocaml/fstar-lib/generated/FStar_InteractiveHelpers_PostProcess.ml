         ...
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              ...
              | FStar_Reflection_V1_Data.Tv_App
                  (hd, (a, FStar_Reflection_V1_Data.Q_Explicit)) ->
                  if
...
type 'a exploration_result =
  ...
  parents:
    (FStar_InteractiveHelpers_Base.genv * FStar_Reflection_V1_Data.term_view)
      Prims.list
    ;
  tgt_comp:
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
                     ...
                     (Prims.of_int (186)) (Prims.of_int (17)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
                     "FStar.InteractiveHelpers.PostProcess.fst"
                ...
                Obj.magic
                  (Obj.repr
                     (FStar_Tactics_Effect.tac_bind
                        ...
                        (Obj.magic (FStar_Tactics_V1_Builtins.inspect hd))
                        (fun uu___1 ->
                           FStar_Tactics_Effect.lift_div_tac
                             (fun uu___2 ->
                                match uu___1 with
         ...
         (fun t1 ->
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (Obj.magic (FStar_Tactics_V1_SyntaxHelpers.collect_app t1))
                 (fun uu___ ->
                    (fun uu___ ->
                       match uu___ with
                       | (hd, params) ->
                           (match params with
                            | (x, FStar_Reflection_V1_Data.Q_Explicit)::
                                (y, FStar_Reflection_V1_Data.Q_Explicit)::[]
                                ->
                                Obj.magic
                                  (Obj.repr
                                     (FStar_Tactics_Effect.tac_bind
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range
                 "FStar.InteractiveHelpers.PostProcess.fst"
                 (Prims.of_int (316)) (Prims.of_int (11))
                              ...
                              (FStar_Sealed.seal
                                 (Obj.magic
                                    (FStar_Range.mk_range
                                       ...
                                       (Prims.of_int (7)))))
                              (Obj.magic
                                 (FStar_Tactics_V1_Builtins.inspect t1))
                              (fun uu___1 ->
                                 (fun uu___1 ->
                                    match uu___1 with
      ...
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range
                 "FStar.InteractiveHelpers.PostProcess.fst"
                 (Prims.of_int (373)) (Prims.of_int (10))
                 (Prims.of_int (373)) (Prims.of_int (22)))))
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range
                 "FStar.InteractiveHelpers.PostProcess.fst"
      ...
      fun t2 ->
        ...
        | Eq_Dec ty ->
            FStar_Reflection_V1_Derived.mk_app
              ...
              (t1, FStar_Reflection_V1_Data.Q_Explicit);
              (t2, FStar_Reflection_V1_Data.Q_Explicit)]
        | Eq_Undec ty ->
            FStar_Reflection_V1_Derived.mk_app
              (FStar_Reflection_V2_Builtins.pack_ln
                 (FStar_Reflection_V2_Data.Tv_FVar
                    (FStar_Reflection_V2_Builtins.pack_fv ["Prims"; "eq2"])))
              [(ty, FStar_Reflection_V1_Data.Q_Implicit);
              (t1, FStar_Reflection_V1_Data.Q_Explicit);
              (t2, FStar_Reflection_V1_Data.Q_Explicit)]
        | Eq_Hetero (ty1, ty2) ->
            FStar_Reflection_V1_Derived.mk_app
              (FStar_Reflection_V2_Builtins.pack_ln
                 (FStar_Reflection_V2_Data.Tv_FVar
                    (FStar_Reflection_V2_Builtins.pack_fv
                       ["Prims"; "op_Equals_Equals_Equals"])))
              [(ty1, FStar_Reflection_V1_Data.Q_Implicit);
              (ty2, FStar_Reflection_V1_Data.Q_Implicit);
              (t1, FStar_Reflection_V1_Data.Q_Explicit);
              (t2, FStar_Reflection_V1_Data.Q_Explicit)]
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (435)) (Prims.of_int (4))
                                    (Prims.of_int (438)) (Prims.of_int (38)))))
                           (Obj.magic (FStar_Tactics_V1_Builtins.inspect tm))
                           (fun uu___1 ->
                              FStar_Tactics_Effect.lift_div_tac
                                (fun uu___2 ->
                                   match uu___1 with
            ...
            FStar_Tactics_Effect.tac_bind
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range
                       "FStar.InteractiveHelpers.PostProcess.fst"
                       (Prims.of_int (543)) (Prims.of_int (2))
                       (Prims.of_int (543)) (Prims.of_int (62)))))
              (Obj.magic
                 (FStar_Tactics_Effect.tac_bind
                    (FStar_Sealed.seal
                       (Obj.magic
          ...
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
                     "FStar.InteractiveHelpers.PostProcess.fst"
                     (Prims.of_int (548)) (Prims.of_int (5))
            ...
            (Obj.magic (term_eq from_term tm))
            (fun uu___ ->
               (fun uu___ ->
                  if uu___
                  then
                      ...
                      (Obj.repr
                         (FStar_Tactics_Effect.tac_bind
                            ...
                            (fun uu___2 ->
                               (fun uu___2 ->
                                  match uu___2 with
                                  | FStar_Reflection_V1_Data.Tv_Var uu___3 ->
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
                                              (fun uu___4 -> tm)))
                                  | FStar_Reflection_V1_Data.Tv_BVar uu___3
                                      ->
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
                                              (fun uu___4 -> tm)))
                                  | FStar_Reflection_V1_Data.Tv_FVar uu___3
                                      ->
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
                                  ...
                                  | FStar_Reflection_V1_Data.Tv_Arrow
                                      ...
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
                                              (fun uu___3 -> tm)))
                                  | FStar_Reflection_V1_Data.Tv_Type uu___3
                                      ->
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
                                                      ...
                                                      (FStar_Tactics_Effect.tac_bind
                                                         ...
                                                         (fun uu___3 ->
                                                            (fun ref' ->
                                                              ...
                                                              uu___3)))
                                                   uu___3)))
                                  | FStar_Reflection_V1_Data.Tv_Const uu___3
                                      ->
                                      Obj.magic
                                        (Obj.repr
                                           (FStar_Tactics_Effect.lift_div_tac
      ...
      (fun uu___ ->
         (fun uu___ ->
            ...
            | FStar_Reflection_V1_Data.Tv_App (hd, (a, qualif)) ->
                Obj.magic
                  (Obj.repr
                     (if FStar_Reflection_V1_Data.uu___is_Q_Implicit qualif
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range
                 "FStar.InteractiveHelpers.PostProcess.fst"
                 (Prims.of_int (603)) (Prims.of_int (79))
