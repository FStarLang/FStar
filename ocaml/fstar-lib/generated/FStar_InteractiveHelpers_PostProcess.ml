                 ...
                 (fun uu___2 ->
                    (fun e ->
                       let uu___2 =
                         let uu___3 =
                           let uu___4 =
                             FStar_Tactics_V1_Builtins.term_to_string g in
                           FStar_Tactics_Effect.tac_bind
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                 ...
                 (fun uu___3 ->
                    (fun res ->
                       let uu___3 =
                         let uu___4 =
                           let uu___5 =
                             FStar_Tactics_V1_Builtins.term_to_string res.res in
                           FStar_Tactics_Effect.tac_bind
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                    ...
                    (FStar_Tactics_Effect.tac_bind
                       ...
                       (fun uu___2 ->
                          (fun opt_c ->
                             let uu___2 =
                               let uu___3 =
                                 FStar_Tactics_V1_Builtins.inspect res.res in
                               FStar_Tactics_Effect.tac_bind
                                 (FStar_Sealed.seal
                                    (Obj.magic
                                       (FStar_Range.mk_range
                                                              ...
                                                              (fun
                                                                 ...
                                                                 Obj.magic
                                                                   (FStar_Tactics_Effect.tac_bind
                                                                    ...
                                                                    bvv0.FStar_Reflection_V1_Data.bv_ppname in
                                                                    FStar_Tactics_Effect.tac_bind
                                                                    (FStar_Sealed.seal
                                                                    (Obj.magic
                                                                    (FStar_Range.mk_range
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            ...
            | FStar_Reflection_V1_Data.Tv_App
                ...
                Obj.magic
                  (Obj.repr
                     (let uu___2 = FStar_Tactics_V1_Builtins.inspect hd in
                      FStar_Tactics_Effect.tac_bind
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range
                           ...
                           (match params with
                            | (x, FStar_Reflection_V1_Data.Q_Explicit)::
                                ...
                                Obj.magic
                                  (Obj.repr
                                     (let uu___3 =
                                        FStar_Tactics_V1_Builtins.inspect hd in
                                      FStar_Tactics_Effect.tac_bind
                                        (FStar_Sealed.seal
                                           (Obj.magic
                                              (FStar_Range.mk_range
           ...
           (fun t1 ->
              ...
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   ...
                   (fun uu___2 ->
                      (fun uu___2 ->
                         let uu___3 = FStar_Tactics_V1_Builtins.inspect t1 in
                         Obj.magic
                           (FStar_Tactics_Effect.tac_bind
                              (FStar_Sealed.seal
                                 (Obj.magic
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___1 ->
           (fun t1 ->
              let uu___1 =
                let uu___2 =
                  let uu___3 = FStar_Tactics_V1_Builtins.term_to_string t1 in
                  FStar_Tactics_Effect.tac_bind
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range
      ...
      fun p ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              let uu___3 =
                let uu___4 = FStar_Tactics_V1_Builtins.term_to_string tm in
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range
                  ...
                  (fun uu___5 ->
                     (fun uu___5 ->
                        let uu___6 =
                          let uu___7 =
                            FStar_Tactics_V1_Builtins.term_to_string p in
                          FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
        ...
        FStar_Tactics_Effect.tac_bind
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                let uu___2 =
                  let uu___3 = FStar_Tactics_V1_Builtins.inspect tm in
                  FStar_Tactics_Effect.tac_bind
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range
    ...
    fun ge0 ->
      fun tm ->
        fun parents ->
          fun children ->
            let uu___ =
              let uu___1 = FStar_Tactics_V1_Builtins.inspect tm in
              FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range
...
let rec (strip_implicit_parameters :
  ...
  =
  fun tm ->
    let uu___ = FStar_Tactics_V1_Builtins.inspect tm in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.InteractiveHelpers.PostProcess.fst"
...
let (unfold_in_assert_or_assume :
  ...
  fun dbg ->
    fun ares ->
      let uu___ =
        let uu___1 =
          let uu___2 = FStar_Tactics_V1_Builtins.term_to_string ares.res in
          FStar_Tactics_Effect.tac_bind
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range
