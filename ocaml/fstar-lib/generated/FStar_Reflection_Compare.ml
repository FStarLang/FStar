  ...
  fun s ->
    fun t ->
      ...
      | (FStar_Reflection_Data.Tv_Var sv, FStar_Reflection_Data.Tv_Var tv) ->
          FStar_Reflection_Builtins.compare_namedv sv tv
      ...
      | (FStar_Reflection_Data.Tv_Refine (b1, e1),
         FStar_Reflection_Data.Tv_Refine (b2, e2)) ->
          FStar_Order.lex (compare_binder b1 b2)
            (fun uu___ -> compare_term e1 e2)
      ...
      | (FStar_Reflection_Data.Tv_Let (_r1, _attrs1, b1, t1, t1'),
         FStar_Reflection_Data.Tv_Let (_r2, _attrs2, b2, t2, t2')) ->
          FStar_Order.lex (compare_binder b1 b2)
            (fun uu___ ->
...
and (compare_binder :
  ...
  fun b1 ->
    fun b2 ->
      ...
      compare_term bview1.FStar_Reflection_Data.sort2
