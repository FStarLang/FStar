    ...
    fun f ->
      fun i ->
        FStar_Tactics_Effect.tac_bind
          (Prims.mk_range "FStar.Reflection.Arith.fst" (Prims.of_int (77))
...
let lift :
  ...
  fun f ->
    fun x ->
      fun st1 ->
        FStar_Tactics_Effect.tac_bind
          (Prims.mk_range "FStar.Reflection.Arith.fst" (Prims.of_int (83))
          ...
          (Obj.magic
             (FStar_Tactics_Effect.tac_bind
                (Prims.mk_range "FStar.Reflection.Arith.fst"
                   (Prims.of_int (83)) (Prims.of_int (9)) (Prims.of_int (83))
                   (Prims.of_int (12)))
                (Prims.mk_range "FStar.Reflection.Arith.fst"
                   (Prims.of_int (83)) (Prims.of_int (8)) (Prims.of_int (83))
                   (Prims.of_int (17))) (Obj.magic (f x))
                (fun uu___ ->
                   FStar_Tactics_Effect.lift_div_tac
                     (fun uu___1 -> (uu___, st1)))))
          (fun uu___ ->
             FStar_Tactics_Effect.lift_div_tac
...
let (atom : FStar_Reflection_Types.term -> expr tm) =
  fun t ->
    fun uu___ ->
      ...
      | (n, atoms) ->
          FStar_Tactics_Effect.tac_bind
            (Prims.mk_range "FStar.Reflection.Arith.fst" (Prims.of_int (116))
  ...
  fun t ->
    op_let_Bang (as_arith_expr t)
      (fun a ->
         match a with
         | Atom (uu___, t1) ->
             let uu___1 = FStar_Reflection_Derived_Lemmas.collect_app_ref t1 in
             (match uu___1 with
              | (hd, tl) ->
                  (match ((FStar_Reflection_Builtins.inspect_ln hd), tl) with
                   ...
                   | uu___2 ->
                       op_let_Bang
                         (lift FStar_Tactics_Builtins.term_to_string t1)
                         (fun s ->
                            fail
...
let rec (is_arith_prop :
  ...
  fun t ->
    fun i ->
      op_let_Bang (lift FStar_Reflection_Formula.term_as_formula t)
        (fun f ->
           match f with
           ...
           | FStar_Reflection_Formula.Or (l, r) ->
               liftM2 (fun uu___ -> fun uu___1 -> OrProp (uu___, uu___1))
                 (is_arith_prop l) (is_arith_prop r)
           | uu___ ->
               op_let_Bang (lift FStar_Tactics_Builtins.term_to_string t)
                 (fun s ->
...
let run_tm :
  ...
  fun m ->
    FStar_Tactics_Effect.tac_bind
      (Prims.mk_range "FStar.Reflection.Arith.fst" (Prims.of_int (212))
         (Prims.of_int (10)) (Prims.of_int (212)) (Prims.of_int (19)))
      (Prims.mk_range "FStar.Reflection.Arith.fst" (Prims.of_int (212))
         (Prims.of_int (4)) (Prims.of_int (214)) (Prims.of_int (25)))
      (Obj.magic (m (Prims.int_zero, [])))
      (fun uu___ ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___1 ->
              match uu___ with
              | FStar_Pervasives.Inr (x, uu___2) -> FStar_Pervasives.Inr x
              | s ->
                  FStar_Pervasives.Inl
                    (FStar_Pervasives.__proj__Inl__item__v s)))
  ...
  fun e1 ->
    fun e2 ->
      ...
      | (Atom (uu___, t), Atom (uu___1, s)) ->
          FStar_Reflection_Compare.compare_term t s
