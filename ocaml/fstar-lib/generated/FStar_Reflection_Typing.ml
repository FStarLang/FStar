      ...
      fun ty ->
        fun q ->
          FStar_Reflection_Builtins.pack_binder
            {
              FStar_Reflection_Data.sort2 = ty;
              FStar_Reflection_Data.qual = q;
              FStar_Reflection_Data.attrs = [];
              FStar_Reflection_Data.ppname2 = pp_name
            }
let (extend_env :
  FStar_Reflection_Types.env ->
    FStar_Reflection_Data.var ->
  ...
  fun e ->
    fun x ->
      fun ty ->
        FStar_Reflection_Derived.push_binding e
          {
            FStar_Reflection_Data.uniq1 = x;
            FStar_Reflection_Data.sort3 = ty;
            FStar_Reflection_Data.ppname3 = (seal_pp_name "x")
          }
let (as_binder :
  FStar_Reflection_Data.var ->
...
let (bv_index : FStar_Reflection_Types.bv -> FStar_Reflection_Data.var) =
  fun x ->
    (FStar_Reflection_Builtins.inspect_bv x).FStar_Reflection_Data.index
let (namedv_uniq :
  FStar_Reflection_Types.namedv -> FStar_Reflection_Data.var) =
  fun x ->
    (FStar_Reflection_Builtins.inspect_namedv x).FStar_Reflection_Data.uniq
let (binder_sort :
...
let (binder_qual :
  ...
  fun b ->
    ...
    match uu___ with
    | { FStar_Reflection_Data.sort2 = uu___1; FStar_Reflection_Data.qual = q;
        FStar_Reflection_Data.attrs = uu___2;
        FStar_Reflection_Data.ppname2 = uu___3;_} -> q
type open_or_close =
...
let (var_as_term : FStar_Reflection_Data.var -> FStar_Reflection_Types.term)
  ...
  fun v ->
    FStar_Reflection_Builtins.pack_ln
      (FStar_Reflection_Data.Tv_Var (var_as_namedv v))
let (binder_of_t_q :
  FStar_Reflection_Types.term ->
    FStar_Reflection_Data.aqualv -> FStar_Reflection_Types.binder)
...
let (mk_simple_binder :
  ...
  fun t ->
    FStar_Reflection_Builtins.pack_binder
      {
        FStar_Reflection_Data.sort2 = t;
        FStar_Reflection_Data.qual = FStar_Reflection_Data.Q_Explicit;
        FStar_Reflection_Data.attrs = [];
        FStar_Reflection_Data.ppname2 = pp_name_default
      }
let (mk_let :
  FStar_Reflection_Data.ppname_t ->
    FStar_Reflection_Types.term ->
      FStar_Reflection_Types.term ->
        FStar_Reflection_Types.term -> FStar_Reflection_Types.term)
  =
      ...
      fun t1 ->
        fun e2 ->
          let b =
            FStar_Reflection_Builtins.pack_binder
              {
                FStar_Reflection_Data.sort2 = t1;
                FStar_Reflection_Data.qual = FStar_Reflection_Data.Q_Explicit;
                FStar_Reflection_Data.attrs = [];
                FStar_Reflection_Data.ppname2 = ppname
              } in
          FStar_Reflection_Builtins.pack_ln
            (FStar_Reflection_Data.Tv_Let (false, [], b, e1, e2))
let (open_with_var : FStar_Reflection_Data.var -> open_or_close) =
  fun x ->
    OpenWith
      (FStar_Reflection_Builtins.pack_ln
         (FStar_Reflection_Data.Tv_Var (var_as_namedv x)))
  ...
  fun x ->
    ...
    | FStar_Reflection_Data.Tv_Var v ->
        FStar_Pervasives_Native.Some
          ((FStar_Reflection_Builtins.inspect_namedv v).FStar_Reflection_Data.uniq)
  ...
  fun t ->
    fun v ->
      fun i ->
                   ...
                   FStar_Reflection_Builtins.pack_ln
                     (FStar_Reflection_Data.Tv_BVar
                        (FStar_Reflection_Builtins.pack_bv
                           {
                             FStar_Reflection_Data.index = i;
                             FStar_Reflection_Data.sort1 =
                               ((FStar_Reflection_Builtins.inspect_namedv x).FStar_Reflection_Data.sort);
                 ...
                 then
                   FStar_Reflection_Builtins.pack_ln
                     (FStar_Reflection_Data.Tv_Var
                        (FStar_Reflection_Builtins.pack_namedv
                           (let uu___ =
                              FStar_Reflection_Builtins.inspect_namedv x in
                            {
                              FStar_Reflection_Data.uniq = z;
                              FStar_Reflection_Data.sort =
                                (uu___.FStar_Reflection_Data.sort);
                              FStar_Reflection_Data.ppname =
                                (uu___.FStar_Reflection_Data.ppname)
                            })))
                 else t)
                    ...
                    | FStar_Pervasives_Native.Some k ->
                        FStar_Reflection_Builtins.pack_ln
                          (FStar_Reflection_Data.Tv_Var
                             (FStar_Reflection_Builtins.pack_namedv
                                {
                                  FStar_Reflection_Data.uniq = k;
                                  FStar_Reflection_Data.sort =
                                    ((FStar_Reflection_Builtins.inspect_bv j).FStar_Reflection_Data.sort1);
                                  FStar_Reflection_Data.ppname =
                                    ((FStar_Reflection_Builtins.inspect_bv j).FStar_Reflection_Data.ppname1)
                                })))
                 else t)
        ...
        | FStar_Reflection_Data.Tv_Refine (b, f) ->
        ...
        FStar_Reflection_Builtins.pack_binder
          {
            FStar_Reflection_Data.sort2 =
              (open_or_close_term' bndr.FStar_Reflection_Data.sort2 v i);
            FStar_Reflection_Data.qual = (bndr.FStar_Reflection_Data.qual);
            FStar_Reflection_Data.attrs =
              (open_or_close_terms' bndr.FStar_Reflection_Data.attrs v i);
            FStar_Reflection_Data.ppname2 =
              (bndr.FStar_Reflection_Data.ppname2)
          }
    ...
    fun v ->
      fun i ->
        ...
        | FStar_Reflection_Data.Pat_Cons (head, univs, subpats) ->
            ...
            FStar_Reflection_Data.Pat_Cons (head, univs, subpats1)
        | FStar_Reflection_Data.Pat_Var (bv, s) ->
            FStar_Reflection_Data.Pat_Var (bv, s)
...
let rec (freevars :
  ...
  fun e ->
    ...
    | FStar_Reflection_Data.Tv_Var x -> FStar_Set.singleton (namedv_uniq x)
...
and (freevars_binder :
  ...
  fun b ->
    let bndr = FStar_Reflection_Builtins.inspect_binder b in
    FStar_Set.union (freevars bndr.FStar_Reflection_Data.sort2)
      (freevars_terms bndr.FStar_Reflection_Data.attrs)
and (freevars_pattern :
  ...
  fun p ->
    ...
    | FStar_Reflection_Data.Pat_Var (bv, s) -> FStar_Set.empty ()
...
and (ln'_binder : FStar_Reflection_Types.binder -> Prims.int -> Prims.bool) =
  fun b ->
    fun n ->
      let bndr = FStar_Reflection_Builtins.inspect_binder b in
      (ln' bndr.FStar_Reflection_Data.sort2 n) &&
        (ln'_terms bndr.FStar_Reflection_Data.attrs n)
and (ln'_terms :
...
and (ln'_pattern : FStar_Reflection_Data.pattern -> Prims.int -> Prims.bool)
  ...
  fun p ->
    fun i ->
      ...
      | FStar_Reflection_Data.Pat_Var (bv, s) -> true
      | FStar_Reflection_Data.Pat_Dot_Term topt ->
          (match topt with
           | FStar_Pervasives_Native.None -> true
