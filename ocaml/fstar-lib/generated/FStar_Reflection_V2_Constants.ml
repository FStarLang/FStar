...
let (mk_inspect_pack_pair : Prims.string -> (refl_constant * refl_constant))
  ...
  fun s ->
    ...
    (inspect, pack)
let (uu___36 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_ln"
...
let (uu___43 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_fv"
...
let (uu___50 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_bv"
...
let (uu___57 : (refl_constant * refl_constant)) =
...
let (uu___64 : (refl_constant * refl_constant)) =
...
let (uu___71 : (refl_constant * refl_constant)) =
...
let (uu___78 : (refl_constant * refl_constant)) =
...
let (uu___85 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_lb"
...
let (uu___92 : (refl_constant * refl_constant)) =
...
let (fstar_refl_binding : FStar_Syntax_Syntax.term) =
  mk_refl_types_lid_as_term "binding"
let (fstar_refl_binding_fv : FStar_Syntax_Syntax.fv) =
...
let (fstar_refl_namedv_view : FStar_Syntax_Syntax.term) =
  mk_refl_data_lid_as_term "namedv_view"
let (fstar_refl_namedv_view_fv : FStar_Syntax_Syntax.fv) =
...
let (ref_Mk_namedv_view : refl_constant) =
  ...
  let attr =
    let uu___ =
      let uu___1 = fstar_refl_data_lid "namedv_view" in
      let uu___2 =
        let uu___3 =
          FStar_Ident.mk_ident ("uniq", FStar_Compiler_Range_Type.dummyRange) in
        let uu___4 =
          let uu___5 =
...
let (ref_Mk_bv_view : refl_constant) =
  ...
  let attr =
    let uu___ =
      let uu___1 = fstar_refl_data_lid "view" in
      let uu___2 =
        let uu___3 =
          FStar_Ident.mk_ident
            ("index", FStar_Compiler_Range_Type.dummyRange) in
        let uu___4 =
          let uu___5 =
            FStar_Ident.mk_ident
              ("sort", FStar_Compiler_Range_Type.dummyRange) in
...
let (ref_Mk_binding : refl_constant) =
  ...
  let attr =
    let uu___ =
      let uu___1 = fstar_refl_data_lid "binding" in
      let uu___2 =
        let uu___3 =
          FStar_Ident.mk_ident ("uniq", FStar_Compiler_Range_Type.dummyRange) in
        let uu___4 =
...
let (ref_Mk_binder_view : refl_constant) =
  ...
  let attr =
    let uu___ =
      ...
      let uu___2 =
        let uu___3 =
          FStar_Ident.mk_ident ("sort", FStar_Compiler_Range_Type.dummyRange) in
        let uu___4 =
          let uu___5 =
            FStar_Ident.mk_ident
              ("qual", FStar_Compiler_Range_Type.dummyRange) in
          let uu___6 =
            let uu___7 =
              FStar_Ident.mk_ident
