...
let (e_bv : FStar_Syntax_Syntax.bv FStar_TypeChecker_NBETerm.embedding) =
  let embed_bv cb bv =
    mk_lazy cb bv FStar_Reflection_V1_Constants.fstar_refl_bv
  ...
  mk_emb' embed_bv unembed_bv FStar_Reflection_V1_Constants.fstar_refl_bv_fv
let (e_binder :
  FStar_Syntax_Syntax.binder FStar_TypeChecker_NBETerm.embedding) =
  let embed_binder cb b =
    mk_lazy cb b FStar_Reflection_V1_Constants.fstar_refl_binder
  ...
  mk_emb' embed_binder unembed_binder
    FStar_Reflection_V1_Constants.fstar_refl_binder_fv
let rec mapM_opt :
  'a 'b .
  ...
  fun aq ->
    ...
    let unembed_term cb t =
      ...
      | FStar_TypeChecker_NBETerm.Quote (tm, qi) ->
          let uu___ =
            FStar_Reflection_V1_Embeddings.e_term_aq (Prims.int_zero, []) in
          let uu___1 =
            FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_quoted (tm, qi))
              FStar_Compiler_Range_Type.dummyRange in
          FStar_Syntax_Embeddings_Base.unembed uu___ uu___1
            FStar_Syntax_Embeddings_Base.id_norm_cb
      | uu___ -> FStar_Pervasives_Native.None in
    let uu___ = mkFV FStar_Reflection_V1_Constants.fstar_refl_term_fv [] [] in
    let uu___1 =
      fv_as_emb_typ FStar_Reflection_V1_Constants.fstar_refl_term_fv in
    {
...
let (e_aqualv :
  ...
  let embed_aqualv cb q =
    ...
    | FStar_Reflection_V1_Data.Q_Explicit ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Q_Explicit.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Q_Implicit ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Q_Implicit.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Q_Meta t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Q_Meta.FStar_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed_aqualv cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], (t1, uu___)::[]) when
        ...
        FStar_Compiler_Util.bind_opt uu___1
          (fun t2 ->
             FStar_Pervasives_Native.Some
               (FStar_Reflection_V1_Data.Q_Meta t2))
    | uu___ ->
        ((let uu___2 =
            let uu___3 =
              let uu___4 = FStar_TypeChecker_NBETerm.t_to_string t in
         ...
         FStar_Pervasives_Native.None) in
  let uu___ =
    mkConstruct FStar_Reflection_V1_Constants.fstar_refl_aqualv_fv [] [] in
  let uu___1 =
    fv_as_emb_typ FStar_Reflection_V1_Constants.fstar_refl_aqualv_fv in
...
let (e_fv : FStar_Syntax_Syntax.fv FStar_TypeChecker_NBETerm.embedding) =
  let embed_fv cb fv =
    mk_lazy cb fv FStar_Reflection_V1_Constants.fstar_refl_fv
  ...
  let unembed_fv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
          ...
          FStar_Errors.log_issue FStar_Compiler_Range_Type.dummyRange uu___2);
         FStar_Pervasives_Native.None) in
  mk_emb' embed_fv unembed_fv FStar_Reflection_V1_Constants.fstar_refl_fv_fv
let (e_comp : FStar_Syntax_Syntax.comp FStar_TypeChecker_NBETerm.embedding) =
  let embed_comp cb c =
    mk_lazy cb c FStar_Reflection_V1_Constants.fstar_refl_comp
  ...
  mk_emb' embed_comp unembed_comp
    FStar_Reflection_V1_Constants.fstar_refl_comp_fv
let (e_env : FStar_TypeChecker_Env.env FStar_TypeChecker_NBETerm.embedding) =
  let embed_env cb e =
    mk_lazy cb e FStar_Reflection_V1_Constants.fstar_refl_env
  ...
  mk_emb' embed_env unembed_env
    FStar_Reflection_V1_Constants.fstar_refl_env_fv
let (e_const :
  FStar_Reflection_V1_Data.vconst FStar_TypeChecker_NBETerm.embedding) =
  let embed_const cb c =
    match c with
    | FStar_Reflection_V1_Data.C_Unit ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Unit.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.C_True ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_True.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.C_False ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_False.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.C_Int i ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Int.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_String s ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_String.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_Range r ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              FStar_TypeChecker_NBETerm.embed
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Range.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_Reify ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Reify.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.C_Reflect ns ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Reflect.FStar_Reflection_V1_Constants.fv
          [] uu___ in
  ...
  mk_emb' embed_const unembed_const
    FStar_Reflection_V1_Constants.fstar_refl_vconst_fv
let (e_universe :
  FStar_Syntax_Syntax.universe FStar_TypeChecker_NBETerm.embedding) =
  let embed_universe cb u =
    mk_lazy cb u FStar_Reflection_V1_Constants.fstar_refl_universe
      FStar_Syntax_Syntax.Lazy_universe in
  ...
  mk_emb' embed_universe unembed_universe
    FStar_Reflection_V1_Constants.fstar_refl_universe_fv
let rec e_pattern_aq :
  'uuuuu .
    'uuuuu ->
      FStar_Reflection_V1_Data.pattern FStar_TypeChecker_NBETerm.embedding
  =
  fun aq ->
    let embed_pattern cb p =
      ...
      | FStar_Reflection_V1_Data.Pat_Constant c ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Pat_Constant.FStar_Reflection_V1_Constants.fv
            [] uu___
          ...
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 =
                    let uu___6 = FStar_TypeChecker_NBETerm.e_list e_universe in
                    FStar_TypeChecker_NBETerm.e_option uu___6 in
                  FStar_TypeChecker_NBETerm.embed uu___5 cb us_opt in
                  ...
                  let uu___6 =
                    let uu___7 =
                      let uu___8 =
                        ...
                        FStar_TypeChecker_NBETerm.e_tuple2 uu___9
                          FStar_TypeChecker_NBETerm.e_bool in
                      FStar_TypeChecker_NBETerm.e_list uu___8 in
                    FStar_TypeChecker_NBETerm.embed uu___7 cb ps in
                  FStar_TypeChecker_NBETerm.as_arg uu___6 in
                [uu___5] in
              uu___3 :: uu___4 in
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Pat_Cons.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Pat_Var (bv, sort) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Pat_Var.FStar_Reflection_V1_Constants.fv
            [] uu___
          ...
          let uu___ =
            let uu___1 =
              let uu___2 =
                ...
                FStar_TypeChecker_NBETerm.embed uu___3 cb eopt in
              FStar_TypeChecker_NBETerm.as_arg uu___2 in
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Pat_Dot_Term.FStar_Reflection_V1_Constants.fv
            [] uu___ in
    let unembed_pattern cb t =
      match t.FStar_TypeChecker_NBETerm.nbe_t with
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (c, uu___)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            ...
            (fun f1 ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 = FStar_TypeChecker_NBETerm.e_list e_universe in
                   FStar_TypeChecker_NBETerm.e_option uu___6 in
                 FStar_TypeChecker_NBETerm.unembed uu___5 cb us_opt in
    ...
    mk_emb' embed_pattern unembed_pattern
      FStar_Reflection_V1_Constants.fstar_refl_pattern_fv
let (e_pattern :
  FStar_Reflection_V1_Data.pattern FStar_TypeChecker_NBETerm.embedding) =
  e_pattern_aq noaqs
let (e_branch :
  FStar_Reflection_V1_Data.branch FStar_TypeChecker_NBETerm.embedding) =
  FStar_TypeChecker_NBETerm.e_tuple2 e_pattern e_term
let (e_argv :
  FStar_Reflection_V1_Data.argv FStar_TypeChecker_NBETerm.embedding) =
...
let (e_branch_aq :
  ...
  fun aq ->
    ...
    FStar_TypeChecker_NBETerm.e_tuple2 uu___ uu___1
let (e_argv_aq :
  (Prims.int * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
    Prims.list) ->
...
let (e_universe_view :
  ...
  let embed_universe_view cb uv =
    ...
    | FStar_Reflection_V1_Data.Uv_Zero ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Zero.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Uv_Succ u ->
        let uu___ =
          let uu___1 =
            let uu___2 = FStar_TypeChecker_NBETerm.embed e_universe cb u in
            FStar_TypeChecker_NBETerm.as_arg uu___2 in
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Succ.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Uv_Max us ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              let uu___3 = FStar_TypeChecker_NBETerm.e_list e_universe in
              FStar_TypeChecker_NBETerm.embed uu___3 cb us in
            FStar_TypeChecker_NBETerm.as_arg uu___2 in
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Max.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Uv_BVar n ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_BVar.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Uv_Name i ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Name.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Uv_Unif u ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              mk_lazy cb u FStar_Syntax_Util.t_universe_uvar
                FStar_Syntax_Syntax.Lazy_universe_uvar in
            FStar_TypeChecker_NBETerm.as_arg uu___2 in
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Unif.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Uv_Unk ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Uv_Unk.FStar_Reflection_V1_Constants.fv
          [] [] in
  ...
  fun aq ->
    ...
    let embed_term_view cb tv =
      ...
      | FStar_Reflection_V1_Data.Tv_FVar fv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_FVar.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_BVar bv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_BVar.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Var bv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Var.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_UInst (fv, us) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 = FStar_TypeChecker_NBETerm.e_list e_universe in
                  FStar_TypeChecker_NBETerm.embed uu___5 cb us in
                FStar_TypeChecker_NBETerm.as_arg uu___4 in
              [uu___3] in
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_UInst.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_App (hd, a) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_App.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Abs (b, t) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 = e_term_aq (shift aq) in
                  FStar_TypeChecker_NBETerm.embed uu___5 cb t in
                FStar_TypeChecker_NBETerm.as_arg uu___4 in
              [uu___3] in
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Abs.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Arrow (b, c) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Arrow.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Type u ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Type.FStar_Reflection_V1_Constants.fv
            [] uu___
          ...
          let uu___ =
            ...
            let uu___2 =
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    let uu___7 = e_term_aq (shift aq) in
                    FStar_TypeChecker_NBETerm.embed uu___7 cb t in
                  FStar_TypeChecker_NBETerm.as_arg uu___6 in
                [uu___5] in
              uu___3 :: uu___4 in
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Refine.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Const c ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Const.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Uvar (u, d) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Uvar.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Let (r, attrs, b, ty, t1, t2) ->
          let uu___ =
                ...
                let uu___6 =
                  let uu___7 =
                    let uu___8 =
                      ...
                      FStar_TypeChecker_NBETerm.embed uu___9 cb ty in
                    FStar_TypeChecker_NBETerm.as_arg uu___8 in
                  let uu___8 =
                    let uu___9 =
                      let uu___10 =
                        let uu___11 = e_term_aq aq in
                        FStar_TypeChecker_NBETerm.embed uu___11 cb t1 in
                      FStar_TypeChecker_NBETerm.as_arg uu___10 in
                    let uu___10 =
                      let uu___11 =
                        let uu___12 =
                          let uu___13 = e_term_aq (shift aq) in
                          FStar_TypeChecker_NBETerm.embed uu___13 cb t2 in
                        FStar_TypeChecker_NBETerm.as_arg uu___12 in
                      [uu___11] in
                    uu___9 :: uu___10 in
                  uu___7 :: uu___8 in
                uu___5 :: uu___6 in
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Let.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_Match (t, ret_opt, brs) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Match.FStar_Reflection_V1_Constants.fv
            [] uu___
      | FStar_Reflection_V1_Data.Tv_AscribedT (e, t, tacopt, use_eq) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_AscT.FStar_Reflection_V1_Constants.fv
            [] uu___
      ...
      | FStar_Reflection_V1_Data.Tv_Unknown ->
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Unknown.FStar_Reflection_V1_Constants.fv
            [] []
      | FStar_Reflection_V1_Data.Tv_Unsupp ->
          mkConstruct
            FStar_Reflection_V1_Constants.ref_Tv_Unsupp.FStar_Reflection_V1_Constants.fv
            [] [] in
    let unembed_term_view cb t =
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          ->
          let uu___4 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
          FStar_Compiler_Util.bind_opt uu___4
            (fun b1 ->
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Compiler_Util.bind_opt uu___7
            (fun r1 ->
               let uu___8 =
                 let uu___9 = FStar_TypeChecker_NBETerm.e_list e_term in
                 FStar_TypeChecker_NBETerm.unembed uu___9 cb attrs in
               FStar_Compiler_Util.bind_opt uu___8
                 (fun attrs1 ->
                    let uu___9 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
                         ...
                         FStar_Compiler_Util.bind_opt uu___10
                           (fun ty1 ->
                              ...
                              FStar_Compiler_Util.bind_opt uu___11
                                (fun t11 ->
                                   let uu___12 =
                                     FStar_TypeChecker_NBETerm.unembed e_term
                                       cb t2 in
    ...
    mk_emb' embed_term_view unembed_term_view
      FStar_Reflection_V1_Constants.fstar_refl_term_view_fv
let (e_term_view :
  FStar_Reflection_V1_Data.term_view FStar_TypeChecker_NBETerm.embedding) =
...
let (e_bv_view :
    ...
    let uu___ =
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            FStar_TypeChecker_NBETerm.embed FStar_TypeChecker_NBETerm.e_int
              cb bvv.FStar_Reflection_V1_Data.bv_index in
          FStar_TypeChecker_NBETerm.as_arg uu___4 in
        [uu___3] in
      uu___1 :: uu___2 in
    mkConstruct
      FStar_Reflection_V1_Constants.ref_Mk_bv.FStar_Reflection_V1_Constants.fv
      [] uu___ in
  ...
  mk_emb' embed_bv_view unembed_bv_view
    FStar_Reflection_V1_Constants.fstar_refl_bv_view_fv
let (e_attribute :
...
let (e_binder_view :
  ...
  let embed_binder_view cb bview =
    let uu___ =
      let uu___1 =
        let uu___2 =
          FStar_TypeChecker_NBETerm.embed e_bv cb
            bview.FStar_Reflection_V1_Data.binder_bv in
        FStar_TypeChecker_NBETerm.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 =
            FStar_TypeChecker_NBETerm.embed e_aqualv cb
              bview.FStar_Reflection_V1_Data.binder_qual in
          FStar_TypeChecker_NBETerm.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 =
              FStar_TypeChecker_NBETerm.embed e_attributes cb
            ...
            let uu___7 =
              let uu___8 =
                FStar_TypeChecker_NBETerm.embed e_term cb
                  bview.FStar_Reflection_V1_Data.binder_sort in
              FStar_TypeChecker_NBETerm.as_arg uu___8 in
            [uu___7] in
          uu___5 :: uu___6 in
        uu___3 :: uu___4 in
      uu___1 :: uu___2 in
    mkConstruct
      FStar_Reflection_V1_Constants.ref_Mk_binder.FStar_Reflection_V1_Constants.fv
      [] uu___ in
        ...
        FStar_Compiler_Util.bind_opt uu___5
          (fun bv1 ->
             ...
             FStar_Compiler_Util.bind_opt uu___6
               (fun q1 ->
                  let uu___7 =
                    FStar_TypeChecker_NBETerm.unembed e_attributes cb attrs in
                  FStar_Compiler_Util.bind_opt uu___7
                    (fun attrs1 ->
                       let uu___8 =
                            ...
                            FStar_Compiler_Effect.op_Less_Bar
                                 ...
                                 FStar_Pervasives_Native.Some uu___9)
                              {
                                ...
                                FStar_Reflection_V1_Data.binder_attrs =
                                  attrs1;
                                FStar_Reflection_V1_Data.binder_sort = sort1
                              }))))
    | uu___ ->
        ((let uu___2 =
            let uu___3 =
  ...
  mk_emb' embed_binder_view unembed_binder_view
    FStar_Reflection_V1_Constants.fstar_refl_binder_view_fv
let (e_comp_view :
  ...
  let embed_comp_view cb cv =
    ...
    | FStar_Reflection_V1_Data.C_Total t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Total.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_GTotal t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_GTotal.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_Lemma (pre, post, pats) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Lemma.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.C_Eff (us, eff, res, args, decrs) ->
        let uu___ =
            ...
            let uu___4 =
              ...
              let uu___6 =
                ...
                let uu___8 =
                  let uu___9 =
                    let uu___10 =
                      let uu___11 = FStar_TypeChecker_NBETerm.e_list e_term in
                      FStar_TypeChecker_NBETerm.embed uu___11 cb decrs in
                    FStar_TypeChecker_NBETerm.as_arg uu___10 in
                  [uu___9] in
                uu___7 :: uu___8 in
              uu___5 :: uu___6 in
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_C_Eff.FStar_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed_comp_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        ->
        let uu___6 =
          let uu___7 = FStar_TypeChecker_NBETerm.e_list e_universe in
          FStar_TypeChecker_NBETerm.unembed uu___7 cb us in
        FStar_Compiler_Util.bind_opt uu___6
          (fun us1 ->
             let uu___7 =
               FStar_TypeChecker_NBETerm.unembed
                  ...
                  FStar_Compiler_Util.bind_opt uu___8
                    (fun res1 ->
                       let uu___9 =
                         ...
                         FStar_TypeChecker_NBETerm.unembed uu___10 cb args in
                       FStar_Compiler_Util.bind_opt uu___9
                         (fun args1 ->
                            let uu___10 =
                              let uu___11 =
                                FStar_TypeChecker_NBETerm.e_list e_term in
...
let (e_sigelt :
  ...
  let embed_sigelt cb se =
    mk_lazy cb se FStar_Reflection_V1_Constants.fstar_refl_sigelt
...
let (e_lb_view :
  ...
  let embed_lb_view cb lbv =
    let uu___ =
      let uu___1 =
        let uu___2 =
          FStar_TypeChecker_NBETerm.embed e_fv cb
            lbv.FStar_Reflection_V1_Data.lb_fv in
        FStar_TypeChecker_NBETerm.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 =
            FStar_TypeChecker_NBETerm.embed e_univ_names cb
      ...
      uu___1 :: uu___2 in
    mkConstruct
      FStar_Reflection_V1_Constants.ref_Mk_lb.FStar_Reflection_V1_Constants.fv
      [] uu___ in
  let unembed_lb_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        ->
        let uu___5 = FStar_TypeChecker_NBETerm.unembed e_fv cb fv' in
        FStar_Compiler_Util.bind_opt uu___5
          (fun fv'1 ->
             let uu___6 =
             ...
             FStar_Compiler_Util.bind_opt uu___6
               (fun us1 ->
                  let uu___7 =
                    FStar_TypeChecker_NBETerm.unembed e_term cb typ in
                  FStar_Compiler_Util.bind_opt uu___7
                    (fun typ1 ->
                       let uu___8 =
  ...
  mk_emb' embed_lb_view unembed_lb_view
    FStar_Reflection_V1_Constants.fstar_refl_lb_view_fv
let (e_lid : FStar_Ident.lid FStar_TypeChecker_NBETerm.embedding) =
  ...
  let unembed cb t =
    ...
    FStar_Compiler_Util.map_opt uu___
      (fun p ->
         FStar_Ident.lid_of_path p FStar_Compiler_Range_Type.dummyRange) in
  let uu___ =
    mkConstruct FStar_Reflection_V1_Constants.fstar_refl_aqualv_fv [] [] in
  let uu___1 =
    fv_as_emb_typ FStar_Reflection_V1_Constants.fstar_refl_aqualv_fv in
...
let (e_letbinding :
  ...
  let embed_letbinding cb lb =
    mk_lazy cb lb FStar_Reflection_V1_Constants.fstar_refl_letbinding
      FStar_Syntax_Syntax.Lazy_letbinding in
  ...
  mk_emb' embed_letbinding unembed_letbinding
    FStar_Reflection_V1_Constants.fstar_refl_letbinding_fv
let (e_sigelt_view :
  ...
  let embed_sigelt_view cb sev =
    ...
    | FStar_Reflection_V1_Data.Sg_Let (r, lbs) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 = FStar_TypeChecker_NBETerm.e_list e_letbinding in
                FStar_TypeChecker_NBETerm.embed uu___5 cb lbs in
              FStar_TypeChecker_NBETerm.as_arg uu___4 in
            [uu___3] in
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Sg_Let.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Sg_Inductive (nm, univs, bs, t, dcs) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Sg_Inductive.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Sg_Val (nm, univs, t) ->
        let uu___ =
          ...
          let uu___2 =
            ...
            let uu___4 =
              let uu___5 =
                let uu___6 = FStar_TypeChecker_NBETerm.embed e_term cb t in
                FStar_TypeChecker_NBETerm.as_arg uu___6 in
              [uu___5] in
            uu___3 :: uu___4 in
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Sg_Val.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Unk ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_Unk.FStar_Reflection_V1_Constants.fv
          [] [] in
  let unembed_sigelt_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        ->
        let uu___4 = FStar_TypeChecker_NBETerm.unembed e_string_list cb nm in
        FStar_Compiler_Util.bind_opt uu___4
          (fun nm1 ->
             let uu___5 =
               FStar_TypeChecker_NBETerm.unembed e_univ_names cb us in
...
let (e_exp :
  FStar_Reflection_V1_Data.exp FStar_TypeChecker_NBETerm.embedding) =
  let rec embed_exp cb e =
    match e with
    | FStar_Reflection_V1_Data.Unit ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_E_Unit.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Var i ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_E_Var.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Mult (e1, e2) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_E_Mult.FStar_Reflection_V1_Constants.fv
          [] uu___ in
  let rec unembed_exp cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 =
              let uu___4 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Compiler_Util.format1 "Not an embedded exp: %s" uu___4 in
            (FStar_Errors_Codes.Warning_NotEmbedded, uu___3) in
          FStar_Errors.log_issue FStar_Compiler_Range_Type.dummyRange uu___2);
         FStar_Pervasives_Native.None) in
  mk_emb' embed_exp unembed_exp
    FStar_Reflection_V1_Constants.fstar_refl_exp_fv
let (e_qualifier :
  ...
  let embed cb q =
    ...
    | FStar_Reflection_V1_Data.Assumption ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Assumption.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.New ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_New.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Private ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Private.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Unfold_for_unification_and_vcgen ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Unfold_for_unification_and_vcgen.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Visible_default ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Visible_default.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Irreducible ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Irreducible.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Inline_for_extraction ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Inline_for_extraction.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.NoExtract ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_NoExtract.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Noeq ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Noeq.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Unopteq ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Unopteq.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.TotalEffect ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_TotalEffect.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Logic ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Logic.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Reifiable ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Reifiable.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.ExceptionConstructor ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_ExceptionConstructor.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.HasMaskedEffect ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_HasMaskedEffect.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Effect ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Effect.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.OnlyName ->
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_OnlyName.FStar_Reflection_V1_Constants.fv
          [] []
    | FStar_Reflection_V1_Data.Reflectable l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Reflectable.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Discriminator l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Discriminator.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Action l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Action.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.Projector (l, i) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_Projector.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.RecordType (ids1, ids2) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_RecordType.FStar_Reflection_V1_Constants.fv
          [] uu___
    | FStar_Reflection_V1_Data.RecordConstructor (ids1, ids2) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStar_Reflection_V1_Constants.ref_qual_RecordConstructor.FStar_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed cb t =
    match t.FStar_TypeChecker_NBETerm.nbe_t with
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        ->
        FStar_Pervasives_Native.Some FStar_Reflection_V1_Data.Visible_default
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_V1_Constants.ref_qual_Irreducible.FStar_Reflection_V1_Constants.lid
        -> FStar_Pervasives_Native.Some FStar_Reflection_V1_Data.Irreducible
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        -> FStar_Pervasives_Native.Some FStar_Reflection_V1_Data.TotalEffect
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        ->
        FStar_Pervasives_Native.Some FStar_Reflection_V1_Data.HasMaskedEffect
    | FStar_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        FStar_Compiler_Util.bind_opt uu___2
          (fun i1 ->
             ...
             FStar_Compiler_Util.bind_opt uu___3
               (fun l1 ->
                  FStar_Pervasives_Native.Some
                    (FStar_Reflection_V1_Data.Projector (l1, i1))))
    | FStar_TypeChecker_NBETerm.Construct
        ...
        FStar_Compiler_Util.bind_opt uu___2
          (fun ids11 ->
             ...
             FStar_Compiler_Util.bind_opt uu___3
               (fun ids21 ->
                  FStar_Pervasives_Native.Some
                    (FStar_Reflection_V1_Data.RecordType (ids11, ids21))))
    | FStar_TypeChecker_NBETerm.Construct
        (fv, [], (ids2, uu___)::(ids1, uu___1)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu___ ->
        ((let uu___2 =
         ...
         FStar_Pervasives_Native.None) in
  let uu___ =
    mkConstruct FStar_Reflection_V1_Constants.fstar_refl_qualifier_fv [] [] in
  let uu___1 =
    fv_as_emb_typ FStar_Reflection_V1_Constants.fstar_refl_qualifier_fv in
  FStar_TypeChecker_NBETerm.mk_emb embed unembed uu___ uu___1
let (e_qualifiers :
