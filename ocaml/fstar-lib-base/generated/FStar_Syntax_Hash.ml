  ...
  fun t1 ->
    fun t2 ->
      ...
      then true
        ...
        (let uu___2 =
           FStar_Compiler_Util.physical_equality t1.FStar_Syntax_Syntax.n
             t2.FStar_Syntax_Syntax.n in
         if uu___2
         then true
         else
           (let uu___4 =
            ...
            then false
              ...
              (let uu___6 =
                 ...
                 let uu___8 =
                   let uu___9 = FStar_Syntax_Subst.compress t2 in
                   uu___9.FStar_Syntax_Syntax.n in
                 (uu___7, uu___8) in
               match uu___6 with
               | (FStar_Syntax_Syntax.Tm_bvar x, FStar_Syntax_Syntax.Tm_bvar
                  y) ->
                   x.FStar_Syntax_Syntax.index = y.FStar_Syntax_Syntax.index
               | (FStar_Syntax_Syntax.Tm_name x, FStar_Syntax_Syntax.Tm_name
                  y) ->
                   x.FStar_Syntax_Syntax.index = y.FStar_Syntax_Syntax.index
               | (FStar_Syntax_Syntax.Tm_fvar f, FStar_Syntax_Syntax.Tm_fvar
                  g) -> equal_fv f g
