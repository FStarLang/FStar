...
#set-options "--z3cliopt smt.arith.nl=false --smtencoding.elim_box true --smtencoding.nl_arith_repr native --smtencoding.l_arith_repr native"
...
#push-options "--smtencoding.nl_arith_repr wrapped"
irreducible
let test10 (a:nat) (b:nat) (c:nat) (z:nat) = assert (a==z ==> a * (b + c) == (c * a) + (z * b))
#pop-options

#push-options "--z3cliopt smt.arith.nl=true --smtencoding.elim_box true --smtencoding.nl_arith_repr native --smtencoding.l_arith_repr native"
irreducible
