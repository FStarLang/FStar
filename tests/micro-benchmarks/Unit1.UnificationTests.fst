...
let test_unit_valued_implicits0 () : PURE unit (requires some_predicate) =
  some_f _

// make sure that we are not dropping the guard

[@@ expect_failure [19]]
let test_unit_valued_implicits1 () : PURE unit (requires True) = some_f _
...
: PURE unit (requires some_predicate) = some_g _

let test_unit_valued_implicits4 ()
: PURE unit (requires some_predicate /\ some_other_predicate) = some_g _
