...
let mktuple2 = Tuple2.Mk

let l_t_0 = [( 2+2, 1 )]
let l_t_1 = [Tuple2.Mk (2+2) 1]
let l_t_2 = Cons ( 2+2, 1 ) Nil
let l_t_3 = Cons #_ ( 2+2, 1 ) (Nil #_)
let l_t_4 = Cons (Tuple2.Mk (2+2) 1) Nil
let l_t_5 = Cons (Tuple2.Mk #_ #_ (2+2) 1) Nil
let l_t_6 = Cons #_ (Tuple2.Mk #_ #_ (2+2) 1) (Nil #_)
...
let b_t_3 = Box (Tuple2.Mk (2+2) 1)
let b_t_4 = Box (Tuple2.Mk #_ #_ (2+2) 1)
let b_t_5 = Box #_ (Tuple2.Mk #_ #_ (2+2) 1)
