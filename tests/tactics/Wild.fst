...
[@@(expect_failure [66])] let _ = assert False by (exact (quote (id _)))
[@@(expect_failure [66])] let _ = assert True  by (exact (quote (id _)))
[@@(expect_failure [66])] let _ = assert False by (exact (quote _))
[@@(expect_failure [66])] let _ = assert True  by (exact (quote _))
