...
SRC = sys.argv[2] if len(sys.argv) > 2 else '_output/CborBoundarySlice.dc'
WORK = '_output/mutants'
PREFIX = 'CborBoundarySlice_'
PARSER = [PREFIX + n for n in ['in_range', 'arg_is_minimal', 'arg_width', 'peek',
                               'rem', 'take_be', 'utf8_take', 'items', 'validate']]
