...
type equal (#key:eqtype) (#value:Type) (m1: map key value) (m2: map key value) =
  feq m1 m2
...
val lemma_equal_elim: #key:eqtype -> #value:Type -> m1:map key value -> m2:map key value ->
                      Lemma (requires (equal m1 m2)) (ensures  (m1 == m2))
                      [SMTPat (equal m1 m2)]



val lemma_equal_refl: #key:eqtype -> #value:Type -> m1:map key value -> m2:map key value ->
