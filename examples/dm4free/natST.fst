...
inline val st_bind_wp : r:range -> (a:Type) -> (b:Type) -> (f:st_wp a) -> (g:(a -> Tot (st_wp b))) -> Tot (st_wp b)
let st_bind_wp r a b f g =
...
inline val st_bind: (a:Type) -> (b:Type) -> (wp0:st_wp a) -> (wp1:(a -> Tot (st_wp b))) 
		 -> (f:st_repr a wp0)
		 -> (g:(x:a -> Tot (st_repr b (wp1 x)))) 
		 -> Tot (st_repr b (st_bind_wp r0 a b wp0 wp1))
let st_bind a b wp0 wp1 f g  
