(*--build-config
    options:--admit_fsi FStar.Set --admit_fsi Wysteria --admit_fsi Prins --admit_fsi FStar.OrdSet --admit_fsi FStar.IO --admit_fsi SMCExport;
...
val mill: ps:prins{ps = ab} -> w:Wire int ps -> Wys bool (pre (Mode Par ab)) post
let mill ps w =
