...
(* the boolean indicates whether to add mk_projwire, deal passes false *)
let run (p:prin) (fn:string) (t:typ) (l:exp list) (b:bool) :dvalue =
  ...
  let e = if b then mk_projwire (mk_const (C_prin p)) e_c else e_c in
