(*--build-config
    options:--admit_fsi FStar.OrdSet --admit_fsi FStar.Seq --admit_fsi FStar.OrdMap --admit_fsi FStar.Set --admit_fsi Ffibridge --admit_fsi Runtime --admit_fsi FStar.IO --admit_fsi FStar.String --admit_fsi FStar.Squash --admit_fsi Hashtable --__temp_no_proj  PSemantics --__temp_no_proj SecServer --verify_module SecServer;
