...
; encoding sigelt Test.append_eq_singl

; <Start encoding Test.append_eq_singl>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Test.append_eq_singl (Type Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Test.append_eq_singl@tok () Term)

; </end encoding Test.append_eq_singl>
...
; Starting query at append_eq_singl.fst(15,0-16,0)
;;;;;;;;;;;;;;;;'a
(declare-fun _a___1_850 () Type)
(assert (HasKind _a___1_850
Kind_type))
;;;;;;;;;;;;;;;;l1 : (list 'a) ((list 'a))
(declare-fun l1___1_12 () Term)
(assert (HasType l1___1_12
(Prims.list _a___1_850)))
;;;;;;;;;;;;;;;;l2 : (list 'a) ((list 'a))
(declare-fun l2___1_13 () Term)
(assert (HasType l2___1_13
(Prims.list _a___1_850)))
;;;;;;;;;;;;;;;;x : 'a ('a)
(declare-fun x___1_14 () Term)
(assert (HasType x___1_14
_a___1_850))
...
;;                      (implies (and (HasKind @a0
;;                                             Kind_arrow_2523)
;;                                    (Valid (Prims.b2t (Prims.op_Equality (Prims.list _a___1_850)
;;                                                                         (Test.append _a___1_850
;;                                                                                      l1___1_12
;;                                                                                      l2___1_13)
;;                                                                         (Prims.Cons _a___1_850
;;                                                                                     x___1_14
;;                                                                                     (Prims.Nil _a___1_850)))))
;;                                    (forall ((@x1 Term))
;;                                            (implies (and (HasType @x1
;;                                                                   Prims.unit)
;;                                                          (or label_2524
;;                                                              (and (Valid (Prims.b2t (Prims.op_Equality (Prims.list _a___1_850)
;;                                                                                                        l1___1_12
;;                                                                                                        (Prims.Cons _a___1_850
;;                                                                                                                    x___1_14
;;                                                                                                                    (Prims.Nil _a___1_850)))))
...
(assert (not (forall ((@a0 Type))
                     (implies (and (HasKind @a0 Kind_arrow_2523)
                                   (Valid (Prims.b2t (Prims.op_Equality (Prims.list _a___1_850)
                                                                        (Test.append _a___1_850
                                                                                     l1___1_12
                                                                                     l2___1_13)
