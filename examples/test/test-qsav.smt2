...
;;;;;;;;;;;;;;;;(projectee:_0_146:(list a){(is_Cons _0_146)} -> Tot a)
...
;;;;;;;;;;;;;;;;(projectee:_0_146:(list a){(is_Cons _0_146)} -> Tot (list a))
...
Kind_type))
;;;;;;;;;;;;;;;;_0_150:pattern{(is_SMTPat _0_150)}
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasType @x1
Typ_refine_683)
(and (HasType @x1
...
;;;;;;;;;;;;;;;;(projectee:_0_150:pattern{(is_SMTPat _0_150)} -> Tot (a projectee))
...
Kind_type))
;;;;;;;;;;;;;;;;_0_152:pattern{(is_SMTPatT _0_152)}
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasType @x1
Typ_refine_693)
(and (HasType @x1
...
Kind_type)))))
;;;;;;;;;;;;;;;;_0_162:(option a){(is_None _0_162)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type))
 (! (iff (HasType @x1
(Typ_refine_744 @a2))
(and (HasType @x1
...
Kind_type)))))
;;;;;;;;;;;;;;;;_0_164:(option a){(is_Some _0_164)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type))
 (! (iff (HasType @x1
(Typ_refine_748 @a2))
(and (HasType @x1
...
;;;;;;;;;;;;;;;;(projectee:_0_164:(option a){(is_Some _0_164)} -> Tot a)
...
@a1)
Kind_type)))))
;;;;;;;;;;;;;;;;_0_170:(either 'a 'b){(is_Inl _0_170)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type) (@a3 Type))
 (! (iff (HasType @x1
(Typ_refine_802 @a2
@a3))
...
;;;;;;;;;;;;;;;;(projectee:_0_170:(either 'a 'b){(is_Inl _0_170)} -> Tot 'a)
...
@a1)
Kind_type)))))
;;;;;;;;;;;;;;;;_0_172:(either 'a 'b){(is_Inr _0_172)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type) (@a3 Type))
 (! (iff (HasType @x1
(Typ_refine_813 @a2
@a3))
...
;;;;;;;;;;;;;;;;(projectee:_0_172:(either 'a 'b){(is_Inr _0_172)} -> Tot 'b)
...
;;;;;;;;;;;;;;;;(projectee:_0_178:(result a){(is_V _0_178)} -> Tot a)
...
;;;;;;;;;;;;;;;;(projectee:_0_180:(result a){(is_E _0_180)} -> Tot exn)
...
;;;;;;;;;;;;;;;;(projectee:_0_182:(result a){(is_Err _0_182)} -> Tot string)
...
; encoding sigelt Test.append

; <Start encoding Test.append>
(declare-fun Test.append (Type Term Term) Term)
;;;;;;;;;;;;;;;;((list 'a) -> (list 'a) -> Tot (list 'a))
(declare-fun Typ_fun_2505 () Type)
;;;;;;;;;;;;;;;;Typ_fun_2505 kinding
(assert (HasKind Typ_fun_2505
Kind_type))
;;;;;;;;;;;;;;;;pre-typing for functions
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
...
@x1
Typ_fun_2505)))))
(declare-fun Test.append@tok () Term)
;;;;;;;;;;;;;;;;fresh token
(assert (= 2508
(Term_constr_id Test.append@tok)))
(assert (forall ((@a0 Type) (@x1 Term) (@x2 Term))
 (! (= (ApplyEE (ApplyEE (ApplyET Test.append@tok
@a0)
@x1)
@x2)
(Test.append @a0
...
:pattern ((ApplyEE (ApplyEE (ApplyET Test.append@tok
@a0)
@x1)
@x2)))))
;;;;;;;;;;;;;;;;function token typing
(assert (HasType Test.append@tok
Typ_fun_2505))
;;;;;;;;;;;;;;;;free var typing
(assert (forall ((@a0 Type) (@x1 Term) (@x2 Term))
                (! (implies (and (HasKind @a0
                                 ...
                                 (HasType @x2
                                          (Prims.list @a0)))
                            (HasType (Test.append @a0
                                                  @x1
                                                  @x2)
                                     (Prims.list @a0)))
                   
                   :pattern ((Test.append @a0
                                          @x1
                                          @x2)))))

; </end encoding Test.append>

; encoding sigelt let Test.append : ((list 'a) -> (list 'a) -> Tot (list 'a))

; <Start encoding Test.append>
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Test.append__2520 (Fuel Type Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Test.append__2521 () Term)
;;;;;;;;;;;;;;;;Fuel token correspondence
(assert (forall ((@u0 Fuel) (@a1 Type) (@x2 Term) (@x3 Term))
 (! (= (ApplyEE (ApplyEE (ApplyET (ApplyEF Test.append__2521
@u0)
@a1)
@x2)
@x3)
(Test.append__2520 @u0
@a1
@x2
@x3))
  
:pattern ((ApplyEE (ApplyEE (ApplyET (ApplyEF Test.append__2521
@u0)
@a1)
@x2)
@x3)))))
...
(HasType @x3
(Prims.list @a1)))
(HasType (Test.append__2520 @u0
@a1
@x2
@x3)
(Prims.list @a1)))
  
:pattern ((Test.append__2520 @u0
@a1
@x2
@x3)))))
...
(assert (forall ((@u0 Fuel) (@a1 Type) (@x2 Term) (@x3 Term))
                (! (= (Test.append__2520 (SFuel @u0)
                   ...
                   :pattern ((Test.append__2520 (SFuel @u0)
                                                @a1
                                                @x2
                                                @x3)))))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Test.append
(assert (forall ((@u0 Fuel) (@a1 Type) (@x2 Term) (@x3 Term))
                (! (implies (and (HasKind @a1
                                          Kind_type)
                                 (HasType @x2
...
;; (assert (forall ((@u0 Fuel) (@i1 Fuel) (@i2 Fuel) (@a1 Type) (@x2 Term) (@x3 Term))
;;                 (! (implies (and (HasKind @a1
;;                                           Kind_type)
;;                                  (HasTypeFuel @i1 @x2
;;                                           (Prims.list @a1))
...
; encoding sigelt Test.append_cons_l

; <Start encoding Test.append_cons_l>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Test.append_cons_l (Type Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Test.append_cons_l@tok () Term)

; </end encoding Test.append_cons_l>
...
; Starting query at test.fst(13,0-13,30)
;;;;;;;;;;;;;;;;'a
(declare-fun _a___1_733 () Type)
(assert (HasKind _a___1_733
Kind_type))
;;;;;;;;;;;;;;;;hd : 'a ('a)
(declare-fun hd___1_12 () Term)
(assert (HasType hd___1_12
_a___1_733))
;;;;;;;;;;;;;;;;tl : (list 'a) ((list 'a))
(declare-fun tl___1_13 () Term)
(assert (HasType tl___1_13
(Prims.list _a___1_733)))
;;;;;;;;;;;;;;;;l : (list 'a) ((list 'a))
(declare-fun l___1_14 () Term)
(assert (HasType l___1_14
(Prims.list _a___1_733)))
(declare-fun label_2524 () Bool)
;;;;;;;;;;;;;;;;(unit -> Type)
(declare-fun Kind_arrow_2523 () Kind)
;;;;;;;;;;;;;;;;Kind_arrow_2523 interpretation
(assert (forall ((@a0 Type))
 (! (iff (HasKind @a0
Kind_arrow_2523)
(and (is-Kind_arrow (PreKind @a0))
...
;;                 (! (implies (HasTypeFuel (SFuel f) e t)
;;                             (HasTypeFuel f e t))
...
;;;;;;;;;;;;;;;;query
(assert (not 
         (= (Test.append _a___1_733
                         (Prims.Cons _a___1_733
                                     hd___1_12
                                     tl___1_13)
                         l___1_14)
            (Prims.Cons _a___1_733
