...
assume val length: list 'a -> Tot nat
...
// //TODO
// (* assume val filter: f:('a -> Tot bool) -> list 'a -> Tot (m:list 'a{forall x. mem x m })// ==> f x}) *)
...
assume val partition: f:('a -> Tot bool) -> list 'a -> Tot (list 'a * list 'a)
