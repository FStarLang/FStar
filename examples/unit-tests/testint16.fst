...
module TestInt16
open Int16
let f0 (x:nat16) : int16 = x - 1l
let f1 (x:nat16) (y:nat16{y <= x}) : nat16 = x - y
let f2 (x:nat16{x < (Int16.max_value / 2l)}) = x * 2l
let mid_nat (x:nat16) (y:nat16{y <= x /\ y<>0l}) : nat16 =
  x - ((x - y) / 2l)
...
let g2 (x:int16) = x ?* 2l
let mid_nat' (x:nat16) (y:nat16) : int16 = (x ?+ y) ?/ 2l
let times' (x:int16) = x ?* 2l
...
val lemma_g2_f2 : x:nat16{x < (Int16.max_value / 2l)} -> Lemma (ensures (f2 x = g2 x))
let lemma_g2_f2 x = ()

val lemma_mid'_mid : x:nat16 -> y:nat16{y <= x /\ y<>0l}
                -> Lemma
