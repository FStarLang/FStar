...
#set-options "--debug RST.Effect.Test --debug_level Extreme --ugly --print_effect_args --print_implicits --debug_level Rel --debug_level TwoPhases --debug_level LayeredEffects"
let test (r:resource) : RST unit r (fun _ -> r) (fun _ -> True) (fun _ _ _ -> True) =
  let r_tmp = r in
  let h0 = rst_get r_tmp in
  assert (h0 == h0)
