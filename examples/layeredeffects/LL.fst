...
#set-options "--debug LL --debug_level Extreme --debug_level LayeredEffects --debug_level TwoPhases --print_effect_args --print_universes --print_implicits --ugly --debug_level Rel"
