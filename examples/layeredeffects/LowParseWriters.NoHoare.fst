...
let read_bind
  ...
  ([@@@ defer_to refl_implicit] p:squash (l_f == l_g))
  (f_bind : read_repr a l_f)
  (g : (x: a -> read_repr b l_g))
: Tot (read_repr b l_g)
...
let bind (a:Type) (b:Type)
  (r_in_f:parser)
  ([@@@ defer_to refl_implicit] r_out_f: parser)
  ([@@@ defer_to refl_implicit] l_f: memory_invariant)
  ([@@@ defer_to refl_implicit] r_in_g:parser)
  (r_out_g: parser)
  ([@@@ defer_to refl_implicit] l_g: memory_invariant)
  ([@@@ defer_to refl_implicit] pr1:squash (r_out_f == r_in_g))
  ([@@@ defer_to refl_implicit] pr2:squash (l_f == l_g))
  (f_bind : repr a r_in_f r_out_f l_f)
  (g : (x: a -> repr b (r_in_g) r_out_g l_g))
...
let subcomp
  (a:Type)
  ([@@@ defer_to refl_implicit] r_in_f:parser)
  (r_out_f:parser)
  (l_f:memory_invariant)
  ([@@@ defer_to refl_implicit] r_in_g:parser)
  (r_out_g: parser)
  (l_g:memory_invariant)
  ([@@@ defer_to refl_implicit] pr:squash (r_in_f == r_in_g))
...
let if_then_else (a:Type)
  ...
  ([@@@ defer_to refl_implicit] l_f: memory_invariant)
  ([@@@ defer_to refl_implicit] r_in_g:parser)
  ([@@@ defer_to refl_implicit] r_out_g: parser)
  ([@@@ defer_to refl_implicit] l_g: memory_invariant)
  ([@@@ defer_to refl_implicit] pr1:squash (r_in_f == r_in_g))
  ([@@@ defer_to refl_implicit] pr2:squash (r_out_f == r_out_g))
  ([@@@ defer_to refl_implicit] pr3:squash (l_f == l_g))
