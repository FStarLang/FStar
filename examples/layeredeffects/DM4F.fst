...
unfold
let if_then_else_wp (#a:Type) (#st:Type0) (wpf wpg:wp st a) (b:bool) : wp st a =
...
let if_then_else
  ...
  (b : bool)
  : Type
  = repr a st (if_then_else_wp wpf wpg b)
...
unfold
let lift_pure_st_wp (#a:Type) (#st:Type0) (w:pure_wp a) : wp st a =
