 ...
 *)
irreducible type not_c_inv (t:rbtree') =
 ...
 *)
irreducible type lr_c_inv (t:rbtree') = is_T t /\ c_inv (T.left t) /\ c_inv (T.right t)

(*
 * this is the predicate satisfied by a tree before call to balance
 *)
irreducible type pre_balance (c:color) (lt:rbtree') (ky:nat) (rt:rbtree') =
    (* 
...
(* Somehow, making post-balance irreducible, makes it take WAY longer *)
(* irreducible *) type post_balance (c:color) (lt:rbtree') (ky:nat) (rt:rbtree') (r:rbtree') =
 ...
 *)
assume val balance: c:color -> lt:rbtree' -> ky:nat -> rt:rbtree' ->
             Pure rbtree'
 ...
 *)
irreducible val ins: t:rbtree' -> k:nat ->
         Pure rbtree'
 ...
 *)
irreducible type balanced_rbtree' (t:rbtree') = r_inv t /\ h_inv t /\ c_inv t /\ k_inv t

(*
 * make black blackens the root of a tree
 *)
irreducible val make_black: t:rbtree' -> Pure rbtree'
