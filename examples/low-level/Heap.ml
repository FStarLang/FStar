...
let only = (fun ( x ) -> (Support.Set.singleton (Support.Heap.Ref ((), (Obj.magic x)))))

let op_Hat_Plus_Plus = (fun ( r ) ( s ) -> (Support.Set.union (Support.Set.singleton (Support.Heap.Ref ((), (Obj.magic r)))) s))

let op_Plus_Plus_Hat = (fun ( s ) ( r ) -> (Support.Set.union s (Support.Set.singleton (Support.Heap.Ref ((), (Obj.magic r))))))

let op_Hat_Plus_Hat = (fun ( r1 ) ( r2 ) -> (Support.Set.union (Support.Set.singleton (Support.Heap.Ref ((), (Obj.magic r1)))) (Support.Set.singleton (Support.Heap.Ref ((), (Obj.magic r2))))))
