...
extern void Intrinsics_aes128_load(uint8_t *x0);

extern void Intrinsics_aes128_enc(uint8_t *x0, uint8_t *x1);

extern void Intrinsics_aes128_dec(uint8_t *x0, uint8_t *x1);
#endif
