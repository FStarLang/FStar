...
let op_AmpAmp = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_BarBar = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Negation = (fun ( _ ) -> (failwith ("Not yet implemented")))

let op_Multiply = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Subtraction = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Addition = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Minus = (fun ( _ ) -> (failwith ("Not yet implemented")))

let op_LessThanOrEqual = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_GreaterThan = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_GreaterThanOrEqual = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_LessThan = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Equality = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_disEquality = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))
...
let fst = (fun ( x ) -> (Prims_MkTuple2._1 x))

let snd = (fun ( x ) -> (Prims_MkTuple2._2 x))

let dfst = (Obj.magic (fun ( t ) -> (Prims_MkDTuple2._1 t)))

let dsnd = (Obj.magic (fun ( t ) -> (Prims_MkDTuple2._2 t)))

type (' a, ' x, ' body) l__Let =
' body

let by_induction_on = (fun ( induction_on ) ( proving ) -> (failwith ("Not yet implemented")))

let _assume = (fun ( _ ) -> (failwith ("Not yet implemented")))

let admit = (fun ( _ ) -> (failwith ("Not yet implemented")))

let magic = (fun ( _ ) -> (failwith ("Not yet implemented")))

let admitP = (fun ( _7_17412 ) -> (failwith ("Not yet implemented")))

let _assert = (fun ( _ ) -> (failwith ("Not yet implemented")))

let cut = (fun ( _7_17412 ) -> (failwith ("Not yet implemented")))

let qintro = (fun ( f ) -> (failwith ("Not yet implemented")))

let failwith = (fun ( _ ) -> (failwith ("Not yet implemented")))

let raise = (fun ( _ ) -> (failwith ("Not yet implemented")))

let pipe_right = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let pipe_left = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let ignore = (fun ( x ) -> ())

let erase = (fun ( x ) -> ())

let exit = (fun ( _ ) -> (failwith ("Not yet implemented")))

let try_with = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let min = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let max = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))
...
let op_Modulus = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))

let op_Division = (fun ( _ ) ( _ ) -> (failwith ("Not yet implemented")))
