(*--build-config
    ...
    variables:LIB=../../lib;
    other-files:$LIB/classical.fst $LIB/FStar.FunctionalExtensionality.fst $LIB/FStar.Set.fsi $LIB/FStar.Heap.fst $LIB/FStar.ST.fst $LIB/FStar.All.fst $LIB/seq.fsi $LIB/seqproperties.fst $LIB/arr.fst $LIB/ghost.fst axiomatic.fst intlib.fst limb.fst bigint_st.fst eval_st.fst
  --*)
