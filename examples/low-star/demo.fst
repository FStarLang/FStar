(*--build-config
  ...
  other-files:classical.fst FStar.FunctionalExtensionality.fst FStar.Set.fsi seq.fsi FStar.Heap.fst FStar.ST.fst FStar.All.fst seqproperties.fst list.fst listTot.fst listproperties.fst $SST/FStar.Stack.fst ghost.fst $SST/FStar.Regions.Located.fst $SST/FStar.Regions.Heap.fst $SST/FStar.Regions.Regions.fst $SST/Fstar.Regions.RST.fst $SST/FStar.Regions.RSTWhile.fst $SST/array.fsi $SST/array.fst buffer.fst system.fst;
  --*)
