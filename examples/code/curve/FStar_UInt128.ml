...
let mul_wide : FStar_UInt64.t  ->  FStar_UInt64.t  ->  t = (fun a b -> Mk ((FStar_Mul.op_Star (FStar_UInt64.v a) (FStar_UInt64.v b))))
...
let of_string : Prims.string  ->  t = (Obj.magic ((fun __1423 -> ())))


let to_string : t  ->  Prims.string = (Obj.magic ((fun __1427 -> ())))
