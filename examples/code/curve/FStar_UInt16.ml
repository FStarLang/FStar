...
let mod : t  ->  t  ->  t = (fun a b -> Mk ((FStar_UInt.mod n (v a) (v b))))
...
let shift_right : t  ->  FStar_UInt32.t  ->  t = (fun a s -> Mk ((FStar_UInt.shift_right n (v a) (FStar_UInt32.v s))))


let shift_left : t  ->  FStar_UInt32.t  ->  t = (fun a s -> Mk ((FStar_UInt.shift_left n (v a) (FStar_UInt32.v s))))
