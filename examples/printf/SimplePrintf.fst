...
(* let example6 : string = *)
(*   (sprintf "%d=%s" <: int -> string -> Tot string) 42 " answer" *)
(* ./SimplePrintf.fst(140,3-140,18): Subtyping check failed; expected type (ww___:Prims.int -> ww___:Prims.string -> Tot Prims.string); got type (((match (Prims.Some?.v (match (FStar.String.list_of_string "%d=%s") with *)
(* 	| (Prims.Nil #.ww___#12770)  -> (Prims.Some (Prims.Nil )) *)
(* 	|(Prims.Cons #.ww___#12974 % (Prims.Cons #.ww___#12970 c#39352 s'#39353))  -> ((match c@1 with *)
...
(* 	|(Prims.Cons #.ww___#14938 % (Prims.Nil #.ww___#14934))  -> (Prims.None ) *)
(* 	|(Prims.Cons #.ww___#15706 c#39355 s'#39356)  -> (SimplePrintf.add_dir (SimplePrintf.Lit c@1) (SimplePrintf.parse_format_pure s'@0)))) with *)
(* 	| (Prims.Nil #.ww___#1757)  -> Prims.string *)
(* 	|(Prims.Cons #.ww___#1919 (SimplePrintf.Lit c#39357) ds'#39358)  -> (SimplePrintf.dir_type ds'@0) *)
(* 	|(Prims.Cons #.ww___#2414 (SimplePrintf.Arg a#39359) ds'#39360)  -> (ww___:(SimplePrintf.arg_type a@1) -> Tot (SimplePrintf.dir_type ds'@1))) : Type) : Type) *)
...
(* 	| (Prims.Nil #.ww___#12770)  -> (Prims.Some (Prims.Nil )) *)
(* 	|(Prims.Cons #.ww___#12974 % (Prims.Cons #.ww___#12970 c#38766 s'#38767))  -> ((match c@1 with *)
(* 	| %  -> (SimplePrintf.add_dir (SimplePrintf.Lit %) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|b  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|d  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Int) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|c  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Char) (SimplePrintf.parse_format_pure s'@0)) *)
...
(* 	|_  -> (Prims.None )) : (Prims.option (Prims.list SimplePrintf.dir))) *)
(* 	|(Prims.Cons #.ww___#14938 % (Prims.Nil #.ww___#14934))  -> (Prims.None ) *)
(* 	|(Prims.Cons #.ww___#15706 c#38769 s'#38770)  -> (SimplePrintf.add_dir (SimplePrintf.Lit c@1) (SimplePrintf.parse_format_pure s'@0)))) true)}) -> Tot (((match (Prims.Some?.v (match (FStar.String.list_of_string s@0) with *)
(* 	| (Prims.Nil #.ww___#12770)  -> (Prims.Some (Prims.Nil )) *)
(* 	|(Prims.Cons #.ww___#12974 % (Prims.Cons #.ww___#12970 c#38755 s'#38756))  -> ((match c@1 with *)
(* 	| %  -> (SimplePrintf.add_dir (SimplePrintf.Lit %) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|b  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Bool) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|d  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Int) (SimplePrintf.parse_format_pure s'@0)) *)
(* 	|c  -> (SimplePrintf.add_dir (SimplePrintf.Arg SimplePrintf.Char) (SimplePrintf.parse_format_pure s'@0)) *)
...
(* 	|_  -> (Prims.None )) : (Prims.option (Prims.list SimplePrintf.dir))) *)
(* 	|(Prims.Cons #.ww___#14938 % (Prims.Nil #.ww___#14934))  -> (Prims.None ) *)
(* 	|(Prims.Cons #.ww___#15706 c#38758 s'#38759)  -> (SimplePrintf.add_dir (SimplePrintf.Lit c@1) (SimplePrintf.parse_format_pure s'@0)))) with *)
(* 	| (Prims.Nil #.ww___#1757)  -> Prims.string *)
(* 	|(Prims.Cons #.ww___#1919 (SimplePrintf.Lit c#38760) ds'#38761)  -> (SimplePrintf.dir_type ds'@0) *)
(* 	|(Prims.Cons #.ww___#2414 (SimplePrintf.Arg a#38762) ds'#38763)  -> (ww___:(SimplePrintf.arg_type a@1) -> Tot (SimplePrintf.dir_type ds'@1))) : Type) : Type)); got 3 arguments *)
