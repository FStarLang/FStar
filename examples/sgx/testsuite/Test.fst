 ...
 *)
  ...
  *)
  ...
  let mylambda = [
		 ("main", 
		 Seq (1200uL, [(Assign (1200uL, (Register "rbp"), (Constant 1000uL)));
				(Push (1201uL, (Register "rbp")));
				(Assign (1202uL, (Register "rbp"), (Register "rsp")));
				(Assign (1203uL, (Register "rbx"), (Constant 1402uL)));
		 		(Store (1204uL, 1uL, (Register "rbx"), (Constant 10uL)));
				(Load (1205uL, (Register "rdx"), 1uL, (Register "rbx")));
				(Call (1206uL, (Constant 1210uL)));
		 		(Assign (1207uL, (Register "rsp"), (Register "rbp")));
				(Pop (1208uL, (Register "rbp")));
				(Return 1209uL)	
				]));
		("counter", 
