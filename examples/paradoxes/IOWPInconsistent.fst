...
(* Showing WP that would result from using DM4F on the IO monad transformer leads to inconsistency.      *)
(*                                                                                                       *)
...
(*                                                                                                       *)
(*   - the DM4F construction amounting to applying Out_T to the continuations monad, resultin in         *)
...
(*                                                                                                       *)
(*     which itself is based on the following note about strict positivity and impredicateivity          *)
(*       http://vilhelms.github.io/posts/why-must-inductive-types-be-strictly-positive/                  *)


#set-options "--__no_positivity"                                         (* so as to Out_WP exists in F* *)
...
let out_wp_inconsistency (a:Type) 
  : Lemma False = 
