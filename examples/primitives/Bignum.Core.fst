...
type Eq' (ha:FStar.Heap.heap) (#size_a:pos) (a:buffer size_a) (la:pos) (hb:FStar.Heap.heap) (#size_b:pos) (b:buffer size_b) (lb:pos) = 
...
opaque type Serialized (h:FStar.Heap.heap) (b:buffer 8) = Live h b /\ length b = bytes_length
...
(*
  ...
  admitP (Modifies !{getRef a} h0 h6)
*)
