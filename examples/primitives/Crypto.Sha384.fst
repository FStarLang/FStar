...
let init whash =
  SBuffer.upd whash 0 (FStar.UInt64.of_string "0xcbbb9d5dc1059ed8");
  SBuffer.upd whash 1 (FStar.UInt64.of_string "0x629a292a367cd507");
  SBuffer.upd whash 2 (FStar.UInt64.of_string "0x9159015a3070dd17");
  SBuffer.upd whash 3 (FStar.UInt64.of_string "0x152fecd8f70e5939");
  SBuffer.upd whash 4 (FStar.UInt64.of_string "0x67332667ffc00b31");
  SBuffer.upd whash 5 (FStar.UInt64.of_string "0x8eb44a8768581511");
  SBuffer.upd whash 6 (FStar.UInt64.of_string "0xdb0c2e0d64f98fa7");
  SBuffer.upd whash 7 (FStar.UInt64.of_string "0x47b5481dbefa4fa4")
...
let finish hash whash = be_sbytes_of_uint64s hash whash 6


(* Compute the sha384 hash of some bytes *)
val sha384: (hash:sbytes { length hash = 64 }) ->
