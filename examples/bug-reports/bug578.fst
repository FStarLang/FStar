...
(* Expected a term of type "(ww___:Prims.unit -> (Bug578.t false))"; *)
(* got a function "(fun ww___ n -> n@0)" (Function definition takes more arguments than expected from its annotated type) *)
...
(* ./bug578.fst(29,29-29,41): Failed to resolve implicit argument of type 'Type' introduced in (?39422 b ww___) because user-provided implicit term *)

(* CH: ... and again *)
(* val f4 : b:bool -> t b *)
(* let f4 b = if b then 42 else (fun n -> n) *)
(* ./bug578.fst(31,29-31,41): Failed to resolve implicit argument of type '((fun b ww___ -> Type) b ww___)' introduced in (?17835 b ww___) because user-provided implicit term *)
