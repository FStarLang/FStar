(*--build-config
    ...
    other-files:FStar.Set.fsi FStar.Heap.fst FStar.ST.fst FStar.All.fst constr.fst classical.fst ext.fst ../metatheory/stlc_strong_db_parsubst.fst ../metatheory/stlc_cbv_db_parsubst.fst
 --*)
module Bug194
