...
; encoding sigelt let DList.ld : (l:(dList 't) -> Tot nat)
...
; encoding sigelt let DList.lt : (l:(list (dList 't)) -> Tot nat)
...
; Starting query at /home/hritcu/Projects/fstar/pub/examples/bug-reports/bug442.fst(40,0-42,3)
(declare-fun label_2923 () Bool)
(declare-fun label_2922 () Bool)
;;;;;;;;;;;;;;;;('a -> 't -> Tot 'a)
(declare-fun Typ_fun_2918 (Type Type) Type)
;;;;;;;;;;;;;;;;Typ_fun_2918 kinding
(assert (forall ((@a0 Type) (@a1 Type))
 (! (HasKind (Typ_fun_2918 @a0
@a1)
Kind_type)
  
:pattern ((HasKind (Typ_fun_2918 @a0
@a1)
Kind_type)))))
;;;;;;;;;;;;;;;;pre-typing for functions
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type) (@a3 Type))
...
;;;;;;;;;;;;;;;;'a
(declare-fun _a___5_3062 () Type)
(assert (HasKind _a___5_3062
Kind_type))
;;;;;;;;;;;;;;;;'t
(declare-fun _t___5_3063 () Type)
(assert (HasKind _t___5_3063
Kind_type))
...
(and (HasTypeFuel @u0
@x1
(DList.dList1 _t___5_3063))
(BoxBool_proj_0 (DList.isCorrectJoined _t___5_3063
@x1))))
...
@a2)
Kind_type)))))
;;;;;;;;;;;;;;;;_5_3075:('a -> 't -> Tot 'a){(%[(lt rights); 1] << %[((ld l) + (lt rights)); 0])}
...
(LexCons (BoxInt 1)
Prims.LexTop@tok))
(LexCons (Prims.op_Addition (DList.ld _t___5_3063
l___5_64)
(DList.lt _t___5_3063
rights___5_63))
(LexCons (BoxInt 0)
Prims.LexTop@tok))))))
...
;;;;;;;;;;;;;;;;(rights:(list (dList 't)) -> xs:'a -> f:_5_3075:('a -> 't -> Tot 'a){(%[(lt rights); 1] << %[((ld l) + (lt rights)); 0])} -> Tot 'a (decreases %[(lt rights); 1]))
...
@a3)
Kind_type)))))
;;;;;;;;;;;;;;;;_5_3485:('a -> 't -> Tot 'a){(%[((ld l) + (lt rights)); 0] << %[((ld l) + (lt rights)); 0])}
...
;;;;;;;;;;;;;;;;(rights:(list (dList 't)) -> l:(dList 't) -> xs:'a -> f:_5_3485:('a -> 't -> Tot 'a){(%[((ld l) + (lt rights)); 0] << %[((ld l) + (lt rights)); 0])} -> Tot 'a (decreases %[((ld l) + (lt rights)); 0]))
...
(SFuel (SFuel (SFuel (SFuel (SFuel (SFuel ZFuel))))))))
;;;;;;;;;;;;;;;;query
(assert (not (ite (= (DList.is_Nil _t___5_3063
                                   l___5_64)
                     (BoxBool true))
                  (implies (= l___5_64
                              (DList.Nil _t___5_3063))
                           (or label_2950
                               (Valid (Prims.Precedes Prims.lex_t
                                                      Prims.lex_t
                                                      (LexCons (DList.lt _t___5_3063
                                                                         rights___5_63)
                                                               (LexCons (BoxInt 1)
                                                                        Prims.LexTop@tok))
                                                      (LexCons (Prims.op_Addition (DList.ld _t___5_3063
