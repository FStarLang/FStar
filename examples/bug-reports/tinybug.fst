...
val tot_ret_weakest : #g:env -> #e:exp -> #t:typ -> 
                      ht: typing g e (tot t) ->
                      Tot (validity (textend (k_post_pure t) g) (TTApp (op EfPure (ttsh t) timpl (tot_wp t) (TTApp (ttsh (return_pure t e)) (TVar 0))) (TVar 0)))
...
let hvimpl'' : validity g' (TTApp (op EfPure t timpl (ttsh wp) (ttsh (return_pure t e))) (TVar 0)) = op_pure_timpl g t wpp rhs hvimpl in 
hvimpl'
