...
;;;;;;;;;;;;;;;;(projectee:_0_17:(p \/ q){(is_Left _0_17)} -> Tot p)
...
;;;;;;;;;;;;;;;;(projectee:_0_19:(p \/ q){(is_Right _0_19)} -> Tot q)
...
;;;;;;;;;;;;;;;;(projectee:_0_144:(list a){(is_Cons _0_144)} -> Tot a)
...
;;;;;;;;;;;;;;;;(projectee:_0_144:(list a){(is_Cons _0_144)} -> Tot (list a))
...
Kind_type))
;;;;;;;;;;;;;;;;_0_148:pattern{(is_SMTPat _0_148)}
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Typ_refine_617)
...
;;;;;;;;;;;;;;;;(projectee:_0_148:pattern{(is_SMTPat _0_148)} -> Tot (a projectee))
...
Kind_type))
;;;;;;;;;;;;;;;;_0_150:pattern{(is_SMTPatT _0_150)}
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Typ_refine_629)
...
Kind_type))
;;;;;;;;;;;;;;;;_0_152:pattern{(is_SMTPatOr _0_152)}
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Typ_refine_633)
...
;;;;;;;;;;;;;;;;(projectee:_0_152:pattern{(is_SMTPatOr _0_152)} -> Tot (list (list pattern)))
...
Kind_type)))))
;;;;;;;;;;;;;;;;_0_162:(option a){(is_Some _0_162)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type))
 (! (iff (HasTypeFuel @u0
@x1
(Typ_refine_682 @a2))
...
;;;;;;;;;;;;;;;;(projectee:_0_162:(option a){(is_Some _0_162)} -> Tot a)
...
@a1)
Kind_type)))))
;;;;;;;;;;;;;;;;_0_168:(either 'a 'b){(is_Inl _0_168)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type) (@a3 Type))
 (! (iff (HasTypeFuel @u0
@x1
(Typ_refine_729 @a2
...
;;;;;;;;;;;;;;;;(projectee:_0_168:(either 'a 'b){(is_Inl _0_168)} -> Tot 'a)
...
@a1)
Kind_type)))))
;;;;;;;;;;;;;;;;_0_170:(either 'a 'b){(is_Inr _0_170)}
(assert (forall ((@u0 Fuel) (@x1 Term) (@a2 Type) (@a3 Type))
 (! (iff (HasTypeFuel @u0
@x1
(Typ_refine_736 @a2
...
;;;;;;;;;;;;;;;;(projectee:_0_170:(either 'a 'b){(is_Inr _0_170)} -> Tot 'b)
...
;;;;;;;;;;;;;;;;(projectee:_0_176:(result a){(is_V _0_176)} -> Tot a)
...
;;;;;;;;;;;;;;;;(projectee:_0_178:(result a){(is_E _0_178)} -> Tot exn)
...
;;;;;;;;;;;;;;;;(projectee:_0_180:(result a){(is_Err _0_180)} -> Tot string)
...
; <Start encoding FStar.IO.EOF>
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.IO.EOF () Term)
;;;;;;;;;;;;;;;;data constructor proxy: EOF
...
;;;;;;;;;;;;;;;;Constructor distinct
(assert (= 2749
(Term_constr_id FStar.IO.EOF)))
;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.IO.EOF ((@x0 Term)) Bool
 (and (= (Term_constr_id @x0)
2749)
(= @x0
FStar.IO.EOF)))
...
;;;;;;;;;;;;;;;;typing for data constructor proxy
(assert (HasType FStar.IO.EOF@tok
Prims.exn))
;;;;;;;;;;;;;;;;equality for proxy
(assert (= FStar.IO.EOF@tok
FStar.IO.EOF))
;;;;;;;;;;;;;;;;data constructor typing intro
(assert (forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
...
; </end encoding FStar.IO.EOF>

; </end encoding FStar.IO.EOF>

; <Start encoding FStar.IO.is_EOF>
(declare-fun FStar.IO.is_EOF (Term) Term)
;;;;;;;;;;;;;;;;(exn -> Tot bool)
(declare-fun Typ_fun_2751 () Type)
;;;;;;;;;;;;;;;;Typ_fun_2751 kinding
(assert (HasKind Typ_fun_2751
Kind_type))
;;;;;;;;;;;;;;;;pre-typing for functions
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
...
:pattern ((HasTypeZ @x0
Typ_fun_2751)))))
(declare-fun FStar.IO.is_EOF@tok () Term)
;;;;;;;;;;;;;;;;fresh token
(assert (= 2753
(Term_constr_id FStar.IO.is_EOF@tok)))
(assert (forall ((@x0 Term))
 (! (= (ApplyEE FStar.IO.is_EOF@tok
@x0)
(FStar.IO.is_EOF @x0))
  
:pattern ((ApplyEE FStar.IO.is_EOF@tok
@x0)))))
;;;;;;;;;;;;;;;;function token typing
(assert (HasType FStar.IO.is_EOF@tok
Typ_fun_2751))
;;;;;;;;;;;;;;;;free var typing
(assert (forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.exn)
(HasType (FStar.IO.is_EOF @x0)
Prims.bool))
  
:pattern ((FStar.IO.is_EOF @x0)))))
;;;;;;;;;;;;;;;;Discriminator equation
(assert (forall ((@x0 Term))
 (! (= (FStar.IO.is_EOF @x0)
(BoxBool (is-FStar.IO.EOF @x0)))
  
:pattern ((FStar.IO.is_EOF @x0)))))

; </end encoding FStar.IO.is_EOF>

; <Start encoding FStar.IO.fd_read>

; <start constructor FStar.IO.fd_read>
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.IO.fd_read () Type)
;;;;;;;;;;;;;;;;Constructor distinct
(assert (= 2754
(Type_constr_id FStar.IO.fd_read)))
;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.IO.fd_read ((@a0 Type)) Bool
 (and (= (Type_constr_id @a0)
2754)
(= @a0
FStar.IO.fd_read)))

; </end constructor FStar.IO.fd_read>
;;;;;;;;;;;;;;;;kinding
(assert (HasKind FStar.IO.fd_read
Kind_type))
;;;;;;;;;;;;;;;;pretyping
(assert (forall ((@x0 Term) (@u1 Fuel))
 (! (implies (HasTypeFuel @u1
...
; </end encoding FStar.IO.fd_read>

; <Start encoding FStar.IO.fd_write>

; <start constructor FStar.IO.fd_write>
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.IO.fd_write () Type)
;;;;;;;;;;;;;;;;Constructor distinct
(assert (= 2757
(Type_constr_id FStar.IO.fd_write)))
;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.IO.fd_write ((@a0 Type)) Bool
 (and (= (Type_constr_id @a0)
2757)
(= @a0
FStar.IO.fd_write)))

; </end constructor FStar.IO.fd_write>
;;;;;;;;;;;;;;;;kinding
(assert (HasKind FStar.IO.fd_write
Kind_type))
;;;;;;;;;;;;;;;;pretyping
(assert (forall ((@x0 Term) (@u1 Fuel))
 (! (implies (HasTypeFuel @u1
...
; </end encoding FStar.IO.fd_write>

; <Start encoding FStar.IO.print_newline>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.print_newline (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.print_newline@tok () Term)

; </end encoding FStar.IO.print_newline>

; <Start encoding FStar.IO.print_string>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.print_string (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.print_string@tok () Term)

; </end encoding FStar.IO.print_string>

; <Start encoding FStar.IO.print_any>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.print_any (Type Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.print_any@tok () Term)

; </end encoding FStar.IO.print_any>

; <Start encoding FStar.IO.input_line>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.input_line (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.input_line@tok () Term)

; </end encoding FStar.IO.input_line>

; <Start encoding FStar.IO.input_int>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.input_int (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.input_int@tok () Term)

; </end encoding FStar.IO.input_int>

; <Start encoding FStar.IO.input_float>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.input_float (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.input_float@tok () Term)

; </end encoding FStar.IO.input_float>

; <Start encoding FStar.IO.open_read_file>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.open_read_file (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.open_read_file@tok () Term)

; </end encoding FStar.IO.open_read_file>

; <Start encoding FStar.IO.open_write_file>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.open_write_file (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.open_write_file@tok () Term)

; </end encoding FStar.IO.open_write_file>

; <Start encoding FStar.IO.close_read_file>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.close_read_file (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.close_read_file@tok () Term)

; </end encoding FStar.IO.close_read_file>

; <Start encoding FStar.IO.close_write_file>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.close_write_file (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.close_write_file@tok () Term)

; </end encoding FStar.IO.close_write_file>

; <Start encoding FStar.IO.read_line>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.read_line (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.read_line@tok () Term)

; </end encoding FStar.IO.read_line>

; <Start encoding FStar.IO.write_string>
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IO.write_string (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IO.write_string@tok () Term)

; </end encoding FStar.IO.write_string>

; End Externals for interface FStar.IO
(push)

; Internals for module Bug

; encoding sigelt Bug.foo

; <Start encoding Bug.foo>
(declare-fun Bug.foo () Type)
(declare-fun Bug.foo@tok () Type)
;;;;;;;;;;;;;;;;name-token correspondence
(assert (= Bug.foo@tok
Bug.foo))
(declare-fun Non_total_Typ_fun_2760 () Type)
(assert (HasKind Non_total_Typ_fun_2760
Kind_type))
;;;;;;;;;;;;;;;;pre-typing
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Non_total_Typ_fun_2760)
(is-Typ_fun (PreType @x1)))
...
Non_total_Typ_fun_2760))
;;;;;;;;;;;;;;;;abbrev. kinding
(assert (HasKind Bug.foo
Kind_type))

; </end encoding Bug.foo>

; encoding sigelt Bug.fail1

; <Skipped Bug.fail1/>
(push)

; Starting query at /home/hritcu/Projects/fstar/pub/examples/bug-reports/bug399.fst(6,0-6,36)
(declare-fun label_2769 () Bool)
(declare-fun label_2768 () Bool)
(declare-fun Non_total_Typ_fun_2762 () Type)
(assert (HasKind Non_total_Typ_fun_2762
Kind_type))
;;;;;;;;;;;;;;;;pre-typing
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Non_total_Typ_fun_2762)
(is-Typ_fun (PreType @x1)))
  
:pattern ((HasTypeFuel @u0
@x1
Non_total_Typ_fun_2762)))))
(declare-fun Non_total_Typ_fun_2764 () Type)
(assert (HasKind Non_total_Typ_fun_2764
Kind_type))
;;;;;;;;;;;;;;;;pre-typing
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Non_total_Typ_fun_2764)
(is-Typ_fun (PreType @x1)))
  
:pattern ((HasTypeFuel @u0
@x1
Non_total_Typ_fun_2764)))))
(declare-fun Non_total_Typ_fun_2766 () Type)
(assert (HasKind Non_total_Typ_fun_2766
Kind_type))
;;;;;;;;;;;;;;;;pre-typing
(assert (forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Non_total_Typ_fun_2766)
(is-Typ_fun (PreType @x1)))
...
(assert (not (forall ((@x0 Term) (@x1 Term))
                     (implies (and (HasType @x0
                                            (Prims.Tuple2 Prims.unit
                                                          Non_total_Typ_fun_2762))
                                   (HasType @x1
                                            FStar.Heap.heap))
                              (or label_2768
                                  (= (Prims.fst Prims.unit
                                                Non_total_Typ_fun_2764
                                                @x0)
                                     (Prims.fst Prims.unit
                                                Non_total_Typ_fun_2766
