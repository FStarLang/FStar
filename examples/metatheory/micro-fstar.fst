 ...
 * add split case option where useful
   * in substitution lemma, split_cases is mostly working but it is still not possible to add the full body of validity_substitution
...
val typing_replace : #g:env -> #e:exp -> #c:cmp ->
