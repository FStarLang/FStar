...
val read_i (i : nat) : h:HS.mem -> ls:lstate{well_formed h ls} -> GTot mint
...
val get_put_i : i:nat -> h:HS.mem -> ls:lstate{well_formed h ls} ->
...
val put_put_i : i:nat -> h:HS.mem -> ls:lstate{well_formed h ls} -> m1:mint -> m2:mint ->
