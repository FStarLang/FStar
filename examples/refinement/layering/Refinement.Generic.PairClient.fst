module Refinement.Generic.PairClient
...
#reset-options "--log_queries --query_stats --print_z3_statistics \
                --using_facts_from 'Prims FStar.Pervasives.Native' \
                --initial_ifuel 0 --max_fuel 0"
...
let n_swap (r:rlens l)
  : RST unit r
    (requires (fun _ -> True))
    (ensures (fun (v0, v1) _ (v0', v1') -> //Note, it seems to be important to write specs component wise; otherwise, we need to reveal a bit more about the representation in Refinement.Generic
      v0 == v0' /\
      v1 == v1'))
  = swap r;
    swap r;
...
#reset-options "--max_fuel 0 --max_ifuel 0 --z3rlimit_factor 6 --z3cliopt 'smt.qi.eager_threshold=100'"
