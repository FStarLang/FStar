...
type NTuple =
  | Tuple_UU : 'a -> 'b -> ('a * 'b)
  | Tuple_UA : 'a:S -> 'b:A -> 'a -> 'b -> ('a * 'b)
  | Tuple_AU : 'a:A -> 'b:S -> 'a -> 'b -> ('a * 'b)
  | Tuple_AA : 'a:A -> 'b:A -> 'a -> 'b -> ('a * 'b)
  | Tuple_UP : 'a:S -> 'b:P -> 'a -> 'b -> ('a * 'b)
  | Tuple_PU : 'a:P -> 'b:S -> 'a -> 'b -> ('a * 'b)
...
assume NotinCons: forall (x:'a) (y:'a) (tl:list 'a). not(In x tl) /\ x<>y ==> not(In x (Cons y tl))
...
val fold_left_A: 'a:A -> 'b:S -> ('a -> 'b >> 'a) -> 'a -> list 'b >> 'a
