...
let main = (fun (x_1:initial_heap) -> 
                ...
                (fun (x_5:dyn) (x_5_1:dyn) ->
                   ...
                   let _ =  _while<(Inv locals h0),_,_> (* (Inv locals h0) is the loop invariant that would be great to infer *)
                     ...
                     (fun () -> 
                        ...
                        let _ = update locals "cur" (gapply (select tmp "getChild") tmp x_9_1 "getChild") in 
                          Undef) in 
                     (select locals "cur")) in 
                
              let x_1_2 = update (Obj global) "getPath" (Fun getPath) in
              ...
              let elt = apply (select (Obj global) "getPath") (Obj global) x_79 in 
                if elt = Undef then Undef
                else (select elt "text")
           )
