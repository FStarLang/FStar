...
Let's look at writing some simple functions on lists, starting with
...
Now, suppose we were to define this ``app``, a version of ``append``
with a weaker type, as shown below.
