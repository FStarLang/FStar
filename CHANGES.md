...
* [ commit FStar@XXXX ] SMT Encoding for projectors includes a new
  pattern to relate projectors internal to the encoding to the
  user-facing projectors auto-generated by F* in the source program.