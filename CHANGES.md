...
* [ commit FStar@0b3bf1edf ] SMT Encoding for projectors includes a
  new pattern to relate projectors internal to the encoding to the
  user-facing projectors auto-generated by F* in the source
  program. Previously, given an occurrence of the latter one could
  derive the former, but not the other way round. This is now fixed.