      ...
      | FStar_Pervasives_Native.Some se ->
          ...
          then x2
            ...
            FStar_Tactics_V2_Derived.fail
              "ctors_of_typ: not an inductive type" ps
let (alg_ctor :
      ...
      | (tys, c) ->
          FStar_Tactics_Util.fold_right
            (fun uu___1 ->
               fun uu___ ->
                 (fun ty1 ->
                    fun acc -> Obj.magic (fun uu___ -> tuple2_ ty1 acc))
                   uu___1 uu___) tys unitt_ ps
        ...
        let x1 =
          FStar_Tactics_Util.fold_right
            (fun uu___1 ->
               fun uu___ ->
                 (fun ty ->
                    fun acc -> Obj.magic (fun uu___ -> either_ ty acc))
                   uu___1 uu___) x empty_ ps in
        x1
let _ =
                      ...
                      FStar_Tactics_V2_SyntaxHelpers.mk_tot_arr x
                        (FStar_Tactics_NamedView.pack
                           (FStar_Tactics_NamedView.Tv_Arrow
                              (x7, (FStarC_Reflection_V2_Data.C_Total x2))))
                        ps in
                    {
                      FStar_Tactics_NamedView.lb_fv =
                        (FStarC_Reflection_V2_Builtins.pack_fv
                  ...
                  let x14 =
                    let x15 =
                      FStar_Tactics_V2_SyntaxHelpers.mk_tot_arr x
                        (FStar_Tactics_NamedView.pack
                           (FStar_Tactics_NamedView.Tv_Arrow
                              (x10, (FStarC_Reflection_V2_Data.C_Total x1))))
                        ps in
                    {
                      FStar_Tactics_NamedView.lb_fv =
                        (FStarC_Reflection_V2_Builtins.pack_fv
