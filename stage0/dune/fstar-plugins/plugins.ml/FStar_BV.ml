...
let (bv_uext :
  Prims.pos -> Prims.pos -> Obj.t bv_t -> Prims.bool FStar_Seq_Base.seq) =
  fun n ->
...
let (bv2int : Prims.pos -> Obj.t bv_t -> Obj.t FStar_UInt.uint_t) =
  FStar_UInt.from_vec
let (int2bv_nat : Prims.pos -> Prims.nat -> Obj.t bv_t) =
  fun n -> fun num -> FStar_UInt.to_vec n (num mod (Prims.pow2 n))
let (list2bv : Prims.pos -> Prims.bool Prims.list -> Obj.t bv_t) =
  fun n -> fun l -> FStar_Seq_Base.seq_of_list l
let (bv2list : Prims.pos -> Obj.t bv_t -> Prims.bool Prims.list) =
...
let (bvnot : Prims.pos -> Obj.t bv_t -> Obj.t bv_t) =
  FStar_BitVector.lognot_vec
let (bvshl' : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n -> fun a -> fun s -> FStar_BitVector.shift_left_vec n a (bv2int n s)
let (bvshl : Prims.pos -> Obj.t bv_t -> Prims.nat -> Obj.t bv_t) =
  fun n -> fun a -> fun s -> bvshl' n a (int2bv_nat n s)
let (bvshr' : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n -> fun a -> fun s -> FStar_BitVector.shift_right_vec n a (bv2int n s)
let (bvshr : Prims.pos -> Obj.t bv_t -> Prims.nat -> Obj.t bv_t) =
  fun n -> fun a -> fun s -> bvshr' n a (int2bv_nat n s)
let (bv_zero : Prims.pos -> Obj.t bv_t) = fun n -> int2bv n Prims.int_zero
let (bvult : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Prims.bool) =
  fun n -> fun a -> fun b -> (bv2int n a) < (bv2int n b)
let (bvadd : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n ->
    fun a ->
      fun b -> int2bv n (FStar_UInt.add_mod n (bv2int n a) (bv2int n b))
let (bvsub : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n ->
    fun a ->
      fun b -> int2bv n (FStar_UInt.sub_mod n (bv2int n a) (bv2int n b))
let (bvdiv :
  Prims.pos -> Obj.t bv_t -> Obj.t FStar_UInt.uint_t -> Obj.t bv_t) =
  fun n -> fun a -> fun b -> int2bv n (FStar_UInt.udiv n (bv2int n a) b)
let (bvdiv_unsafe : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n ->
    fun a ->
      fun b ->
...
let (bvmod_unsafe : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n ->
    fun a ->
      fun b ->
        if (bv2int n b) <> Prims.int_zero
...
let (bvmul' : Prims.pos -> Obj.t bv_t -> Obj.t bv_t -> Obj.t bv_t) =
  fun n ->
    fun a ->
