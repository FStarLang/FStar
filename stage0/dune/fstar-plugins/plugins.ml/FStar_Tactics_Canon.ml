...
let rec (canon_point :
  ...
  fun e ->
    fun ps ->
      let x uu___ = fun ps1 -> FStar_Tactics_V2_Derived.trefl () ps1; e in
      match e with
      ...
      | FStar_Reflection_V2_Arith.Mult
          ...
          (FStar_Tactics_V2_Derived.apply_lemma
           ...
           FStar_Reflection_V2_Arith.Lit Prims.int_zero)
      | FStar_Reflection_V2_Arith.Mult
          (FStar_Reflection_V2_Arith.Lit uu___, r) when uu___ = Prims.int_one
          ->
          (FStar_Tactics_V2_Derived.apply_lemma
             (FStarC_Reflection_V2_Builtins.pack_ln
                (FStarC_Reflection_V2_Data.Tv_FVar
           ...
           r)
      | FStar_Reflection_V2_Arith.Mult
          (l, FStar_Reflection_V2_Arith.Lit uu___) when uu___ = Prims.int_one
          ->
          (FStar_Tactics_V2_Derived.apply_lemma
             (FStarC_Reflection_V2_Builtins.pack_ln
                (FStarC_Reflection_V2_Data.Tv_FVar
