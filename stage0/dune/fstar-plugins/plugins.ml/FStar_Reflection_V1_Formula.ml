...
let (term_as_formula' :
  ...
  fun t ->
    fun ps ->
               ...
               (match ((FStarC_Reflection_V1_Builtins.inspect_ln x2),
                ...
                | (FStarC_Reflection_V1_Data.Tv_FVar fv,
                   ...
                   (a3, FStarC_Reflection_V1_Data.Q_Explicit)::[]) ->
                    ...
                    then
                      Comp ((Eq (FStar_Pervasives_Native.Some a1)), a2, a3)
                    else
                      if
                        (FStarC_Reflection_V1_Builtins.inspect_fv fv) =
                      ...
                      then And (a1, a2)
                        ...
                        then Iff (a1, a2)
                          ...
                          then Or (a1, a2)
                            ...
                            then
                              Comp
                                ((Eq FStar_Pervasives_Native.None), a1, a2)
                            else
                              if
                                (FStarC_Reflection_V1_Builtins.inspect_fv fv)
                                  = FStar_Reflection_Const.eq1_qn
      ...
      | FStarC_Reflection_V1_Data.Tv_Const (FStarC_Reflection_V1_Data.C_Int
          i) -> IntLit i
      | FStarC_Reflection_V1_Data.Tv_Let
          (uu___, uu___1, uu___2, uu___3, uu___4, uu___5) -> F_Unknown
      | FStarC_Reflection_V1_Data.Tv_Match (uu___, uu___1, uu___2) ->
          F_Unknown
