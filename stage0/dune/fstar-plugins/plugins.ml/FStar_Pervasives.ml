...
type norm_step =
  ...
  | Unmeta 
  | Unascribe 
let (uu___is_Simpl : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool)
  = fun projectee -> match projectee with | Simpl -> true | uu___ -> false
let (uu___is_Weak : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Weak -> true | uu___ -> false
let (uu___is_HNF : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
  fun projectee -> match projectee with | HNF -> true | uu___ -> false
let (uu___is_Primops :
  Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Primops -> true | uu___ -> false
let (uu___is_Delta : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool)
  = fun projectee -> match projectee with | Delta -> true | uu___ -> false
let (uu___is_Zeta : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
...
let (uu___is_Iota : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Iota -> true | uu___ -> false
let (uu___is_NBE : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool) =
  fun projectee -> match projectee with | NBE -> true | uu___ -> false
let (uu___is_Reify : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool)
...
let (__proj__UnfoldOnly__item___0 :
  Fstarcompiler.FStar_Pervasives.norm_step -> Prims.string Prims.list) =
...
let (uu___is_Unmeta : Fstarcompiler.FStar_Pervasives.norm_step -> Prims.bool)
...
let (simplify : Fstarcompiler.FStar_Pervasives.norm_step) = Simpl
let (weak : Fstarcompiler.FStar_Pervasives.norm_step) = Weak
let (hnf : Fstarcompiler.FStar_Pervasives.norm_step) = HNF
let (primops : Fstarcompiler.FStar_Pervasives.norm_step) = Primops
let (delta : Fstarcompiler.FStar_Pervasives.norm_step) = Delta
let (norm_debug : Fstarcompiler.FStar_Pervasives.norm_step) = NormDebug
let (zeta : Fstarcompiler.FStar_Pervasives.norm_step) = Zeta
let (zeta_full : Fstarcompiler.FStar_Pervasives.norm_step) = ZetaFull
let (iota : Fstarcompiler.FStar_Pervasives.norm_step) = Iota
let (nbe : Fstarcompiler.FStar_Pervasives.norm_step) = NBE
let (reify_ : Fstarcompiler.FStar_Pervasives.norm_step) = Reify
let (delta_only :
  Prims.string Prims.list -> Fstarcompiler.FStar_Pervasives.norm_step) =
  fun s -> UnfoldOnly s
let (delta_once :
  Prims.string Prims.list -> Fstarcompiler.FStar_Pervasives.norm_step) =
  fun s -> UnfoldOnce s
...
let (unmeta : Fstarcompiler.FStar_Pervasives.norm_step) = Unmeta
let (unascribe : Fstarcompiler.FStar_Pervasives.norm_step) = Unascribe
let (norm :
