...
let uu___is_NotFoundFV (projectee : Prims.exn) : Prims.bool= true
...
let rec fold_right2 :
  'a 'b 'c .
    ('a -> 'b -> 'c -> FStarC_Tactics_Types.ref_proofstate -> 'c) ->
      'a Prims.list ->
        'b Prims.list -> 'c -> FStarC_Tactics_Types.ref_proofstate -> 'c
  =
  fun f l1 l2 c1 ->
    match (l1, l2) with
    | (h1::t1, h2::t2) ->
...
let rec zip3 :
  ...
  fun l1 l2 l3 ->
    ...
    | uu___ -> []
let last (xs : 'a Prims.list) : FStarC_Tactics_Types.ref_proofstate -> 'a=
...
let app_binders (t : FStar_Tactics_NamedView.term)
  ...
  FStar_Reflection_V2_Derived.mk_e_app t
    (FStar_List_Tot_Base.map FStar_Tactics_V2_SyntaxCoercions.binder_to_term
       bs)
...
exception NotARecFV 
let uu___is_NotARecFV (projectee : Prims.exn) : Prims.bool= true
exception NotFoundBV of FStar_Tactics_NamedView.namedv 
let uu___is_NotFoundBV (projectee : Prims.exn) : Prims.bool= true
...
let tabs (b : FStar_Tactics_NamedView.binder)
  (t : FStar_Tactics_NamedView.term)
  (uu___ : FStarC_Tactics_Types.ref_proofstate) :
  FStar_Tactics_NamedView.term=
...
and param_br (s : param_state) (br : FStar_Tactics_NamedView.branch)
  ...
  | (pat, t) ->
      ...
      (match x1 with
       | (s', (uu___, uu___1, pat')) -> let x2 = param' s' t ps in (pat', x2))
and push_binder (b : FStar_Tactics_NamedView.binder) (s : param_state)
  ...
  let x3 s1 t uu___ = Prims.strcat s1 t in
  let x4 =
  ...
  ((push_var_to_state (FStar_Tactics_V2_SyntaxCoercions.binder_to_namedv b)
      ...
      }
      {
        ...
        FStar_Tactics_NamedView.ppname = (x5.FStar_Tactics_NamedView.ppname);
      ...
      }
      {
        ...
        FStar_Tactics_NamedView.ppname = (x6.FStar_Tactics_NamedView.ppname);
...
let param (t : FStar_Tactics_NamedView.term)
  ...
  let x = param' init_param_state t ps in x
let _ =
...
let fv_to_tm (f : FStarC_Reflection_Types.fv)
  (uu___ : FStarC_Tactics_Types.ref_proofstate) :
  FStar_Tactics_NamedView.term=
...
let param_ctor (nm_ty : FStarC_Reflection_Types.name) (s : param_state)
  ...
  | (nm, ty) ->
      ...
      (match x2 with
       | (bs, c1) ->
           let x3 =
             let x4 = fv_to_tm (FStarC_Reflection_V2_Builtins.pack_fv nm) ps in
          ...
          (fun uu___ b ->
             ...
             | (s, bvs) ->
                 (fun ps1 ->
                    ...
                    match x4 with
                    | (s1, (bx0, bx1, bxr)) ->
                        (s1, (bxr :: bx1 :: bx0 :: bvs)))) (x1, []) params ps in
      (match x3 with
       | (s, param_bs) ->
...
let paramd (nm : Prims.string) (ps : FStarC_Tactics_Types.ref_proofstate) :
