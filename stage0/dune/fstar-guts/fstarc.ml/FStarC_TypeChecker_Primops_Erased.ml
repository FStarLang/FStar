...
type ('tmut, 'a) emb_erased =
  | Hide of 'tmut * 'a 
  | Reveal of 'tmut * 'a 
let uu___is_Hide : 'tmut 'a . ('tmut, 'a) emb_erased -> Prims.bool =
  fun projectee ->
    match projectee with | Hide (ty, x) -> true | uu___ -> false
let __proj__Hide__item__ty : 'tmut 'a . ('tmut, 'a) emb_erased -> 'tmut =
  fun projectee -> match projectee with | Hide (ty, x) -> ty
let __proj__Hide__item__x : 'tmut 'a . ('tmut, 'a) emb_erased -> 'a =
  fun projectee -> match projectee with | Hide (ty, x) -> x
let uu___is_Reveal : 'tmut 'a . ('tmut, 'a) emb_erased -> Prims.bool =
  fun projectee ->
    match projectee with | Reveal (ty, x) -> true | uu___ -> false
let __proj__Reveal__item__ty : 'tmut 'a . ('tmut, 'a) emb_erased -> 'tmut =
  fun projectee -> match projectee with | Reveal (ty, x) -> ty
let __proj__Reveal__item__x : 'tmut 'a . ('tmut, 'a) emb_erased -> 'a =
  fun projectee -> match projectee with | Reveal (ty, x) -> x
let e_erased :
  'a .
