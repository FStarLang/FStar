               ...
               (let uu___5 = FStarC_Debug.any () in
                ...
                then
                  ((let uu___7 =
                    ...
                    let uu___8 = FStarC_Effect.op_Bang FStarC_Options._commit in
                    let uu___9 = FStarC_Platform_Base.kernel () in
                    FStarC_Util.print3 "- F* version %s -- %s (on %s)\n"
                      uu___7 uu___8 uu___9);
                   FStarC_Util.print1 "- Executable: %s\n"
                     FStarC_Util.exec_name;
                   (let uu___9 =
                      let uu___10 = FStarC_Find.lib_root () in
                      FStarC_Util.dflt "<none>" uu___10 in
                    FStarC_Util.print1 "- Library root: %s\n" uu___9);
                   (let uu___10 =
                      let uu___11 = FStarC_Find.include_path () in
                      FStarC_Class_Show.show
