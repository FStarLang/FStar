...
let (__proj__Mkcounter__item__running :
  counter -> Prims.bool FStarC_Effect.ref) =
  fun projectee ->
    match projectee with
                       ...
                       (FStarC_Effect.op_Colon_Equals c.running true;
                        (let uu___5 = FStarC_Util.record_time_ns f in
                         ...
                         | (res, elapsed) ->
                             ((let uu___7 =
                                 let uu___8 =
                                   FStarC_Effect.op_Bang c.total_time in
                                 uu___8 + elapsed in
                               FStarC_Effect.op_Colon_Equals c.total_time
                                 uu___7);
       ...
       FStarC_Util.sort_with
         (fun c1 ->
            fun c2 ->
              ...
              let uu___2 = FStarC_Effect.op_Bang c1.total_time in
