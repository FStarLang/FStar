  ...
  (fun g0 rewriter env tm ->
     let should_skip =
       ...
       | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify uu___1)
           -> true
       | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reflect uu___1)
           -> true
       | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_range_of) ->
           true
       | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_set_range_of)
           -> true
       | uu___1 -> false in
     if should_skip
     then
                    ...
                    then
                      let typ' =
                        FStarC_TypeChecker_Normalize.unfold_whnf'
                          ...
                          FStarC_TypeChecker_Env.Unrefine] env typ_norm in
                      typ'
                    else typ)
                 else typ in
               let should_check =
       ...
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                match uu___1 with
                | FStar_Pervasives.Inl (FStarC_Tactics_Common.SKIP) ->
                    Obj.magic
                      (Obj.repr
                         (FStarC_Class_Monad.return
                            FStarC_Tactics_Monad.monad_tac () (Obj.magic tm)))
                | FStar_Pervasives.Inl e ->
                    Obj.magic (Obj.repr (FStarC_Tactics_Monad.traise e))
...
let seq_ctac (uu___1 : 'a ctac) (uu___ : 'a ctac) : 'a ctac=
  (fun c1 c2 x ->
     let uu___ = c1 x in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                     ...
                     | FStarC_Tactics_Types.Abort ->
                         Obj.magic
                           (Obj.repr
                              (FStarC_Class_Monad.return
                                 FStarC_Tactics_Monad.monad_tac ()
                                 (Obj.magic (x', FStarC_Tactics_Types.Abort))))
                     | FStarC_Tactics_Types.Skip ->
                         Obj.magic
                           (Obj.repr
                              (FStarC_Class_Monad.return
                                 FStarC_Tactics_Monad.monad_tac ()
                                 (Obj.magic (x', FStarC_Tactics_Types.Skip))))
                     | FStarC_Tactics_Types.Continue ->
                         Obj.magic (Obj.repr (c2 x')))) uu___1))) uu___1
    uu___
let par_combine
  (uu___ : (FStarC_Tactics_Types.ctrl_flag * FStarC_Tactics_Types.ctrl_flag))
  ...
  | (FStarC_Tactics_Types.Continue, FStarC_Tactics_Types.Continue) ->
      FStarC_Tactics_Types.Continue
let par_ctac (uu___1 : 'a ctac) (uu___ : 'b ctac) : ('a * 'b) ctac=
  (fun cl cr uu___ ->
     match uu___ with
     | (x, y) ->
         let uu___1 = cl x in
                         ...
                         | FStarC_Tactics_Types.Abort ->
                             Obj.magic
                               (FStarC_Class_Monad.return
                                  FStarC_Tactics_Monad.monad_tac ()
                                  (Obj.magic
                                     ((x1, y), FStarC_Tactics_Types.Abort)))
                         | fa ->
                             let uu___3 = cr y in
                             Obj.magic
                               (FStarC_Class_Monad.op_let_Bang
...
let maybe_rewrite (uu___4 : FStarC_Tactics_Types.goal)
  ...
  (fun g0 controller rewriter env tm ->
             ...
             (fun uu___1 ->
                ...
                | (rw, ctrl_flag) ->
                    let uu___2 =
                      if rw
                      then
                        Obj.magic (Obj.repr (do_rewrite g0 rewriter env tm))
                      else
                        Obj.magic
                          (Obj.repr
                             (FStarC_Class_Monad.return
                         ...
                         (fun uu___3 ->
                            (fun tm' ->
                               ...
                               Obj.magic
                                 (FStarC_Class_Monad.return
                                    FStarC_Tactics_Monad.monad_tac ()
                                    (Obj.magic (tm', ctrl_flag)))) uu___3)))
               uu___1))) uu___4 uu___3 uu___2 uu___1 uu___
let rec ctrl_fold_env (g0 : FStarC_Tactics_Types.goal)
  (d : FStarC_Tactics_Types.direction) (controller : controller_ty)
  (rewriter : rewriter_ty) (env : FStarC_TypeChecker_Env.env)
  (tm : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_Tactics_Types.ctrl_flag)
    FStarC_Tactics_Monad.tac=
...
and recurse_option_residual_comp (uu___3 : FStarC_TypeChecker_Env.env)
  ...
  (FStarC_Syntax_Syntax.residual_comp FStar_Pervasives_Native.option *
    FStarC_Tactics_Types.ctrl_flag) FStarC_Tactics_Monad.tac=
  (fun env retyping_subst rc_opt recurse ->
     match rc_opt with
     | FStar_Pervasives_Native.None ->
         Obj.magic
           (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
    ...
    uu___2 uu___1 uu___
and on_subterms (uu___5 : FStarC_Tactics_Types.goal)
  (uu___4 : FStarC_Tactics_Types.direction) (uu___3 : controller_ty)
  (uu___2 : rewriter_ty) (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * FStarC_Tactics_Types.ctrl_flag)
    FStarC_Tactics_Monad.tac=
  (fun g0 d controller rewriter env tm ->
     let recurse env1 tm1 = ctrl_fold_env g0 d controller rewriter env1 tm1 in
     let rr = recurse env in
     let rec descend_binders uu___8 uu___7 uu___6 uu___5 uu___4 uu___3 uu___2
       uu___1 uu___ =
       (fun orig accum_binders retyping_subst accum_flag env1 bs t k rebuild
          ->
          match bs with
          | [] ->
              let t1 = FStarC_Syntax_Subst.subst retyping_subst t in
          ...
          | b::bs1 ->
              let s =
                FStarC_Syntax_Subst.subst retyping_subst
                                  ...
                                  Obj.magic
                                    (Obj.repr
                                       (let bv =
                                        ...
                                        descend_binders orig (b1 ::
                                          accum_binders) retyping_subst1
                                          (par_combine (accum_flag, flag))
                                          env2 bs1 t k rebuild)))) uu___1)))
         uu___8 uu___7 uu___6 uu___5 uu___4 uu___3 uu___2 uu___1 uu___ in
     let go uu___ =
       (fun uu___ ->
              ...
              Obj.magic
                (Obj.repr
                   (let uu___1 =
                    ...
                    | (bs, phi1) ->
                        descend_binders tm1 [] []
                          FStarC_Tactics_Types.Continue env bs phi1
                          FStar_Pervasives_Native.None
                          (fun bs1 phi2 uu___2 ->
                             let x1 =
                               match bs1 with
          ...
          | FStarC_Syntax_Syntax.Tm_let
              ...
              Obj.magic
                (Obj.repr
                   (let lb =
                      let uu___6 =
                        let uu___7 = FStarC_Syntax_Subst.compress tm1 in
                        uu___7.FStarC_Syntax_Syntax.n in
                      match uu___6 with
                      | FStarC_Syntax_Syntax.Tm_let
          ...
          | FStarC_Syntax_Syntax.Tm_let
              ...
              Obj.magic
                (Obj.repr
                   (let c_lb uu___1 =
                      (fun lb ->
                         let uu___1 = rr lb.FStarC_Syntax_Syntax.lbdef in
                         Obj.magic
                           (FStarC_Class_Monad.op_let_Bang
                              FStarC_Tactics_Monad.monad_tac () ()
                              (Obj.magic uu___1)
                        ...
                        FStarC_Class_Monad.op_let_Bang
                          ...
                          (fun uu___3 ->
                             (fun uu___3 ->
                                ...
                                | ((lbs2, e2), flag) ->
                                    let uu___4 =
                                      FStarC_Syntax_Subst.close_let_rec lbs2
                                        e2 in
                                    (match uu___4 with
                                     | (lbs3, e3) ->
                                         Obj.magic
          ...
          | FStarC_Syntax_Syntax.Tm_ascribed
              { FStarC_Syntax_Syntax.tm = t; FStarC_Syntax_Syntax.asc = asc;
              ...
              Obj.magic
                (Obj.repr
                   (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                      ...
                      (Obj.magic
                         ((tm1.FStarC_Syntax_Syntax.n),
                           FStarC_Tactics_Types.Continue))))) uu___ in
     let uu___ = go () in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic uu___)
    ...
    uu___2 uu___1 uu___
let do_ctrl_rewrite (uu___5 : FStarC_Tactics_Types.goal)
  (uu___4 : FStarC_Tactics_Types.direction) (uu___3 : controller_ty)
  (uu___2 : rewriter_ty) (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  (fun g0 dir controller rewriter env tm ->
             ...
             (fun uu___1 ->
                ...
                | (tm', uu___2) ->
                    Obj.magic
                      (FStarC_Class_Monad.return
                         FStarC_Tactics_Monad.monad_tac () (Obj.magic tm')))
               uu___1))) uu___5 uu___4 uu___3 uu___2 uu___1 uu___
let ctrl_rewrite (dir : FStarC_Tactics_Types.direction)
  (controller : controller_ty) (rewriter : rewriter_ty) :
