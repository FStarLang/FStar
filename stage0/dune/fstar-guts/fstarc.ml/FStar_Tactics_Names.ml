open Prims
exception Appears 
let uu___is_Appears (projectee : Prims.exn) : Prims.bool= true
let name_appears_in (uu___2 : FStarC_Reflection_Types.name)
  (uu___1 : FStarC_Reflection_Types.term)
  (uu___ : FStarC_Tactics_Types.ref_proofstate) : Prims.bool=
  (fun nm t ps ->
     let x t1 ps1 =
