       ...
       | (FStarC_Reflection_V2_Data.Tv_FVar fv,
          ...
          (e3, FStarC_Reflection_V2_Data.Q_Explicit)::[]) ->
           ...
           then liftM2 (fun uu___1 uu___2 -> Land (uu___1, uu___2)) e2' e3'
             ...
             then liftM2 (fun uu___1 uu___2 -> Lxor (uu___1, uu___2)) e2' e3'
             else
               if qn = FStar_Reflection_Const.lor_qn
               then
                 liftM2 (fun uu___1 uu___2 -> Lor (uu___1, uu___2)) e2' e3'
               else
                 if qn = FStar_Reflection_Const.shiftr_qn
                 then
                   liftM2 (fun uu___1 uu___2 -> Shr (uu___1, uu___2)) e2' e3'
                 else
                   if qn = FStar_Reflection_Const.shiftl_qn
                   then
                     liftM2 (fun uu___1 uu___2 -> Shl (uu___1, uu___2)) e2'
                       e3'
                   else
                     if qn = FStar_Reflection_Const.udiv_qn
                     then
                       liftM2 (fun uu___1 uu___2 -> Udiv (uu___1, uu___2))
                         e2' e3'
                     else
                       if qn = FStar_Reflection_Const.umod_qn
                       then
                         liftM2 (fun uu___1 uu___2 -> Umod (uu___1, uu___2))
                           e2' e3'
                       else
                         if qn = FStar_Reflection_Const.mul_mod_qn
                         then
                           liftM2
                             (fun uu___1 uu___2 -> MulMod (uu___1, uu___2))
                             e2' e3'
                         else
                           if qn = FStar_Reflection_Const.ladd_qn
                           then
                             liftM2
                               (fun uu___1 uu___2 -> Ladd (uu___1, uu___2))
                               e2' e3'
                           else
                             if qn = FStar_Reflection_Const.lsub_qn
                             then
                               liftM2
                                 (fun uu___1 uu___2 -> Lsub (uu___1, uu___2))
                                 e2' e3'
                             else atom t
       | (FStarC_Reflection_V2_Data.Tv_FVar fv,
          (l, FStarC_Reflection_V2_Data.Q_Explicit)::(r,
           ...
           then liftM2 (fun uu___1 uu___2 -> Plus (uu___1, uu___2)) ll rr
             ...
             then liftM2 (fun uu___1 uu___2 -> Minus (uu___1, uu___2)) ll rr
             else
               if qn = FStar_Reflection_Const.mult_qn
               then liftM2 (fun uu___1 uu___2 -> Mult (uu___1, uu___2)) ll rr
               else atom t
       | (FStarC_Reflection_V2_Data.Tv_FVar fv,
