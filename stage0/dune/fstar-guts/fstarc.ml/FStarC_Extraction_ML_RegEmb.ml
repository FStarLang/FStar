...
let (bind_opt : FStarC_Extraction_ML_Syntax.mlexpr) =
  mk
    (FStarC_Extraction_ML_Syntax.MLE_Name
       (splitlast ["Fstarcompiler.FStarC"; "Util"; "bind_opt"]))
...
let (not_implemented_warning :
  FStarC_Range_Type.range -> Prims.string -> Prims.string -> unit) =
  fun r ->
    fun t ->
      fun msg ->
        let uu___ =
    ...
    fun d ->
      (let uu___1 = FStarC_Effect.op_Bang dbg_plugin in
       ...
       then
         ...
         FStarC_Util.print1 "Registering local embedding for %s\n" uu___2
       else ());
      (let uu___1 =
...
let (list_local : unit -> (FStarC_Ident.lident * embedding_data) Prims.list)
  = fun uu___ -> FStarC_Effect.op_Bang local_fv_embeddings
                  ...
                  | NBETerm ->
                      mk
                        (FStarC_Extraction_ML_Syntax.MLE_Name
                           (["Fstarcompiler.FStarC";
                            "TypeChecker";
                            "NBETerm"], "mk_any_emb")) in
                let s =
                  let uu___ =
                    let uu___1 = FStarC_Util.find_opt (find_env_entry bv) env in
            ...
            | FStarC_Syntax_Syntax.Tm_fvar fv ->
                let uu___ =
                  let uu___1 =
                    ...
                    FStarC_Util.format1 "Embedding not defined for name `%s'"
                      uu___2 in
            ...
            | uu___ ->
                let uu___1 =
                  let uu___2 =
                    ...
                    FStarC_Util.format2 "Cannot embed type `%s' (%s)" uu___3
                      uu___4 in
                  NoEmbedding uu___2 in
                FStarC_Effect.raise uu___1
type wrapped_term =
          ...
          fun ml_fv ->
            ...
            let fv_lid_embedded =
              let uu___ =
                let uu___1 =
                  let uu___2 =
                    as_name1 (["Fstarcompiler.FStarC_Ident"], "lid_of_str") in
                  let uu___3 =
                    let uu___4 =
                      let uu___5 =
                        let uu___6 =
                      ...
                      then (bs, c)
                        ...
                        then
                          ...
                          (let msg =
                             ...
                             let uu___6 = FStarC_Util.string_of_int n_bs in
                             FStarC_Util.format3
      ...
      fun record_fields ->
        fun ctors ->
          ...
          (let nomatch =
           ...
           let branches =
             let uu___1 =
               let uu___2 = FStarC_Effect.op_Bang e_branches in nomatch ::
                 uu___2 in
            ...
            let mk_registration lb =
              ...
              | FStar_Pervasives_Native.Some
                  ...
                  let uu___2 =
                    ...
                    then
                      ((["Fstarcompiler.FStarC_Tactics_Native"],
                         "register_plugin"), [interp; nbe_interp])
                    else
                      ((["Fstarcompiler.FStarC_Tactics_Native"],
                         "register_tactic"), [interp]) in
                  (match uu___2 with
                   | (register, args) ->
                       let h =
                         FStarC_Extraction_ML_Syntax.with_ty
                       ...
                       [uu___3])
              | FStar_Pervasives_Native.None -> [] in
            FStarC_List.collect mk_registration
