...
let (__proj__String__item___0 :
  constant -> (Prims.string * FStarC_Range_Type.t)) =
...
let (__proj__Range__item___0 : constant -> FStarC_Range_Type.t) =
...
let (__proj__Mkt__item__nbe_r : t -> FStarC_Range_Type.t) =
...
let (mk_rt : FStarC_Range_Type.t -> t' -> t) =
...
let (arg_as_int : arg -> Prims.int FStar_Pervasives_Native.option) =
            ...
            let f_wrapped _us =
              fun args1 ->
                ...
                | (x, uu___1) ->
                    ...
                    FStarC_Option.map
                      (fun x1 -> let uu___3 = f x1 in embed eb cb uu___3)
                      uu___2 in
            f_wrapped
