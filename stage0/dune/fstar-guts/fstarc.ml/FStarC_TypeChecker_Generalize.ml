            ...
            (let univs1 =
               ...
               FStarC_List.fold_left
                 (fun uu___6 uu___5 ->
                    (fun univs2 uv ->
                       let uu___5 =
                         let uu___6 = FStarC_Syntax_Util.ctx_uvar_typ uv in
                       ...
                       Obj.magic
                         (FStarC_Class_Setlike.union ()
                            ...
                            (Obj.magic univs2) (Obj.magic uu___5))) uu___6
                      uu___5) univs uu___4 in
                          ...
                          (match uu___6 with
                           | (e0, c0) ->
                               ...
                               let e' =
                                 ...
                                 FStarC_Syntax_Util.abs tvars_bs e2 uu___7 in
                               let uu___7 = FStarC_Syntax_Syntax.mk_Total t in
  ...
  (let univnames_lecs =
             ...
             | (l, t, c) ->
                 ...
                 Obj.magic
                   (FStarC_Class_Setlike.union ()
                      ...
                      (Obj.magic uu___3))) uu___3 uu___2) empty lecs in
   let univnames_lecs1 =
     FStarC_Class_Setlike.elems ()
       (Obj.magic
          (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_ident))
   ...
   let generalized_lecs =
     ...
     | FStar_Pervasives_Native.None ->
         FStarC_List.map
           (fun uu___3 -> match uu___3 with | (l, t, c) -> (l, [], t, c, []))
           lecs
