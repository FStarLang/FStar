...
let rec (resugar_universe :
  FStarC_Syntax_Syntax.universe ->
    FStarC_Range_Type.t -> FStarC_Parser_AST.term)
  =
  fun u ->
    fun r ->
      let mk a =
                     ...
                     let uu___3 =
                       ...
                       let uu___4 =
                         FStarC_List.partition
                           (fun a ->
                              (is_inline_let_attr a) ||
                                (is_inline_let_vc_attr a)) attrs in
                       match uu___4 with
                       | (inline_attrs, rest) ->
                           let uu___5 =
                           ...
                           then (FStarC_Parser_AST.LocalUnfold, rest)
                             ...
                             (FStarC_Parser_AST.LocalNoLetQualifier, attrs) in
                     (match uu___3 with
                      | (qual, attrs1) ->
                          let attrs2 =
                            match attrs1 with
...
and (resugar_binder' :
  FStarC_Syntax_DsEnv.env ->
    FStarC_Syntax_Syntax.binder ->
      FStarC_Range_Type.t -> FStarC_Parser_AST.binder)
  =
  fun env ->
    fun b ->
      fun r ->
