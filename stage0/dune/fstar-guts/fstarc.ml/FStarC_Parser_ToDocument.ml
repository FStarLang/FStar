      ...
      fun f ->
        fun l ->
          let uu___ =
            ...
            let uu___2 = let uu___3 = FStarC_List.hd l in f uu___3 in
...
let with_comment :
  'uuuuu .
    ('uuuuu -> FStarC_Pprint.document) ->
      'uuuuu -> FStarC_Range_Type.range -> FStarC_Pprint.document
  =
  fun printer ->
    fun tm ->
      fun tmrange ->
...
let with_comment_sep :
  'uuuuu 'uuuuu1 .
    ('uuuuu -> 'uuuuu1) ->
      'uuuuu -> FStarC_Range_Type.range -> (FStarC_Pprint.document * 'uuuuu1)
  =
  fun printer ->
    fun tm ->
      fun tmrange ->
...
let (comments_to_document :
  (Prims.string * FStarC_Range_Type.t) Prims.list -> FStarC_Pprint.document)
  =
  fun comments ->
    FStarC_Pprint.separate_map FStarC_Pprint.hardline
...
let (decls_with_comments_to_document :
  FStarC_Parser_AST.decl Prims.list ->
    (Prims.string * FStarC_Range_Type.range) Prims.list ->
      (FStarC_Pprint.document * (Prims.string * FStarC_Range_Type.range)
        Prims.list))
  =
  fun decls ->
    fun comments ->
...
let (modul_with_comments_to_document :
  FStarC_Parser_AST.modul ->
    (Prims.string * FStarC_Range_Type.t) Prims.list ->
      (FStarC_Pprint.document * (Prims.string * FStarC_Range_Type.t)
        Prims.list))
  =
  fun m ->
    fun comments ->
