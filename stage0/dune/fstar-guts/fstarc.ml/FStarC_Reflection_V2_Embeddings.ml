...
let mk_emb :
  'uuuuu .
    (FStarC_Range_Type.t -> 'uuuuu -> FStarC_Syntax_Syntax.term) ->
        ...
        | FStarC_Reflection_V2_Data.Tv_App (hd, a) ->
            let uu___ =
              ...
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    let uu___5 = e_argv_aq aq in embed uu___5 rng a in
                  FStarC_Syntax_Syntax.as_arg uu___4 in
                [uu___3] in
              uu___1 :: uu___2 in
            FStarC_Syntax_Syntax.mk_Tm_app
        ...
        | FStarC_Reflection_V2_Data.Tv_AscribedT (e, t1, tacopt, use_eq) ->
            let uu___ =
              ...
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    let uu___5 = e_term_aq aq in embed uu___5 rng t1 in
                  FStarC_Syntax_Syntax.as_arg uu___4 in
                let uu___4 =
                  let uu___5 =
                    let uu___6 =
                   ...
                   (let uu___2 =
                      let uu___3 =
                        FStarC_Syntax_Embeddings_AppEmb.op_Less_Dollar_Dollar_Greater
                          ...
                          e_namedv in
                      FStarC_Syntax_Embeddings_AppEmb.op_Less_Star_Star_Greater
                        uu___3 FStarC_Syntax_Embeddings.e_int in
                    FStarC_Syntax_Embeddings_AppEmb.run args uu___2)
                 else
                   if
                     FStarC_Syntax_Syntax.fv_eq_lid fv
    ...
    fun sev ->
      ...
      | FStarC_Reflection_V2_Data.Sg_Let (r, lbs) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  embed (FStarC_Syntax_Embeddings.e_list e_letbinding) rng
                    lbs in
                FStarC_Syntax_Syntax.as_arg uu___4 in
              [uu___3] in
            uu___1 :: uu___2 in
      ...
      | FStarC_Reflection_V2_Data.Sg_Inductive (nm, univs, bs, t, dcs) ->
          let uu___ =
            let uu___1 =
              let uu___2 =
                embed FStarC_Syntax_Embeddings.e_string_list rng nm in
              FStarC_Syntax_Syntax.as_arg uu___2 in
            let uu___2 =
              let uu___3 =
                let uu___4 =
              ...
              let uu___4 =
                ...
                let uu___6 =
                  ...
                  let uu___8 =
                    let uu___9 =
                      let uu___10 =
                        embed (FStarC_Syntax_Embeddings.e_list e_ctor) rng
                          dcs in
                      FStarC_Syntax_Syntax.as_arg uu___10 in
                    [uu___9] in
                  uu___7 :: uu___8 in
      ...
      let r =
        ...
        | FStarC_Reflection_V2_Data.Reflectable l ->
            let uu___ =
              let uu___1 =
                let uu___2 =
                  embed FStarC_Syntax_Embeddings.e_string_list rng l in
                FStarC_Syntax_Syntax.as_arg uu___2 in
              [uu___1] in
            FStarC_Syntax_Syntax.mk_Tm_app
                ...
                let uu___2 =
                  embed
                    (FStarC_Syntax_Embeddings.e_tuple2
                       FStarC_Syntax_Embeddings.e_string_list e_univ_name)
                    rng (l, i) in
                FStarC_Syntax_Syntax.as_arg uu___2 in
              [uu___1] in
            FStarC_Syntax_Syntax.mk_Tm_app
