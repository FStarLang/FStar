...
let bound_of_flex (require_ground : Prims.bool)
  ...
  | FStar_Pervasives_Native.Some u ->
      ...
      let ground t1 =
        if Prims.op_Negation require_ground
        then true
        else
         ...
         | (lhead, largs) ->
             let dispatch =
               ...
               | (FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify
                  uu___5), a::rest) when Prims.uu___is_Cons rest ->
                   let head =
                     let uu___6 =
                       FStarC_Range_Ops.union_ranges
                         lhead.FStarC_Syntax_Syntax.pos
                         ...
                         | ((rdc, constrname, constructor), topt) ->
                             ...
                             (if
                                (FStar_Pervasives_Native.uu___is_Some
                                   (FStarC_TypeChecker_Env.expected_typ env1))
                                  &&
                                  (Prims.op_Negation
      ...
      let rec as_function_typ norm1 t2 =
        ...
        | FStarC_Syntax_Syntax.Tm_uvar uu___1 when
            let uu___2 =
              ...
              uu___3.FStarC_Syntax_Syntax.n in
            FStarC_Syntax_Syntax.uu___is_Tm_uvar uu___2 ->
            ((match env.FStarC_TypeChecker_Env.letrecs with
              | [] -> ()
              | uu___3 ->
                  FStarC_Effect.failwith
         ...
         | ({ FStarC_Syntax_Syntax.binder_bv = hd;
            ...
            { FStarC_Syntax_Syntax.binder_bv = hd_expected;
             ...
             ((let special q1 q2 =
                 ...
                 | uu___2 -> false in
               let uu___2 =
                 if Prims.op_Negation (special imp imp')
                 then
             ...
             (let envbody1 =
              ...
              let uu___5 =
                let uu___6 =
                  ...
                  let uu___7 =
                    if FStar_Pervasives_Native.uu___is_Some c_opt
                    then
                      let uu___8 =
                                          ...
                                          let uu___12 =
                                            let uu___13 =
                                              FStarC_TypeChecker_TermEqAndSimplify.eq_tm
                                                ...
                                                c'.FStarC_TypeChecker_Common.res_typ
                                                t_e in
                                            FStarC_TypeChecker_TermEqAndSimplify.uu___is_Equal
                                              uu___13 in
                                          if uu___12
                                          then (e1, c, g_e)
                                          else
   ...
   let rec check_function_app tf guard =
     ...
     | FStarC_Syntax_Syntax.Tm_uvar uu___2 when
         let uu___3 =
           ...
           uu___4.FStarC_Syntax_Syntax.n in
         FStarC_Syntax_Syntax.uu___is_Tm_uvar uu___3 ->
         let uu___3 =
           FStarC_List.fold_right
             (fun uu___4 uu___5 ->
                match uu___5 with
                 ...
                 (match uu___4 with
                  | (e22, c2, g2) ->
                      ...
                      let lb1 =
                        let attrs =
                          let add_inline_let =
                            if Prims.op_Negation is_inline_let
                            then
                              let uu___5 =
                                if pure_or_ghost
                                then
                      ...
                      if
                        FStar_Pervasives_Native.uu___is_Some
                          (FStarC_TypeChecker_Env.expected_typ env2)
                      then
                        let tt =
                          let uu___5 =
                            FStarC_Option.must
...
and build_let_rec_env (_top_level : Prims.bool)
  ...
  let termination_check_enabled attrs lbname lbdef lbtyp =
    ...
    | (actuals, body, body_lc) ->
        ...
        (match uu___1 with
         | (formals, c) ->
             (if (Prims.uu___is_Nil formals) || (Prims.uu___is_Nil actuals1)
              then
                (let uu___3 =
                   let uu___4 =
                     let uu___5 =
      ...
      (match uu___1 with
       | (bs, body, FStar_Pervasives_Native.Some
          { FStarC_Syntax_Syntax.residual_effect = eff;
           ...
           if Prims.op_Negation (is_tot || is_gtot)
           then FStar_Pervasives_Native.None
           else
             (let tbody1 =
                match tbody with
