...
let (map_shadow :
  FStarC_Syntax_Embeddings_Base.shadow_term ->
    (FStarC_Syntax_Syntax.term -> FStarC_Syntax_Syntax.term) ->
      FStarC_Syntax_Embeddings_Base.shadow_term)
  = fun s -> fun f -> FStarC_Option.map (FStarC_Thunk.map f) s
let (force_shadow :
  FStarC_Syntax_Embeddings_Base.shadow_term ->
    FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  = fun s -> FStarC_Option.map FStarC_Thunk.force s
          ...
          let printer1 uu___ =
            ...
            | (x, y, z, w) ->
                ...
                let uu___4 =
                  ...
                  uu___5 w in
                FStarC_Format.fmt4 "(%s, %s, %s, %s)" uu___1 uu___2 uu___3
                  uu___4 in
          let em uu___ =
            fun rng ->
              fun shadow ->
            ...
            let printer1 uu___ =
              ...
              | (x, y, z, w, v) ->
                  ...
                  let uu___5 =
                    ...
                    uu___6 v in
                  FStarC_Format.fmt5 "(%s, %s, %s, %s, %s)" uu___1 uu___2
