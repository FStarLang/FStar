...
type scope_mod =
  | Local_bindings of local_binding FStarC_Util.psmap 
  ...
  | Top_level_defs of Prims.bool FStarC_Util.psmap 
...
let (__proj__Local_bindings__item___0 :
  scope_mod -> local_binding FStarC_Util.psmap) =
...
let (__proj__Top_level_defs__item___0 :
  scope_mod -> Prims.bool FStarC_Util.psmap) =
...
type env =
  ...
  exported_ids: exported_id_set FStarC_Util.smap ;
  trans_exported_ids: exported_id_set FStarC_Util.smap ;
  includes:
    (FStarC_Ident.lident * FStarC_Syntax_Syntax.restriction) Prims.list
      FStarC_Effect.ref FStarC_Util.smap
    ;
  sigaccum: FStarC_Syntax_Syntax.sigelts ;
  sigmap: (FStarC_Syntax_Syntax.sigelt * Prims.bool) FStarC_Util.smap ;
  iface: Prims.bool ;
...
let (__proj__Mkenv__item__exported_ids :
  env -> exported_id_set FStarC_Util.smap) =
  fun projectee ->
    match projectee with
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
...
let (__proj__Mkenv__item__sigmap :
  env -> (FStarC_Syntax_Syntax.sigelt * Prims.bool) FStarC_Util.smap) =
  fun projectee ->
    match projectee with
    | { curmodule; curmonad; modules; scope_mods; exported_ids;
        trans_exported_ids; includes; sigaccum; sigmap; iface;
...
let new_sigmap : 'uuuuu . unit -> 'uuuuu FStarC_Util.smap =
  fun uu___ -> FStarC_Util.smap_create (Prims.of_int (100))
          ...
          let typename' =
            let uu___ =
              let uu___1 =
                ...
                [uu___2] in
              FStarC_List.op_At ns uu___1 in
          ...
          then
            let fname =
              let uu___1 =
                ...
                FStarC_List.op_At uu___2 [id] in
...
let (get_exported_id_set :
  ...
  = fun e -> fun mname -> FStarC_Util.smap_try_find e.exported_ids mname
  ...
  env ->
    Prims.string ->
      (exported_id_kind -> string_set FStarC_Effect.ref)
        FStar_Pervasives_Native.option)
  =
  fun e -> fun mname -> FStarC_Util.smap_try_find e.trans_exported_ids mname
            ...
            fun id ->
              let rec aux uu___ =
                ...
                | (modul, id1)::q ->
                    ...
                    let mincludes =
                      let uu___1 =
                        FStarC_Util.smap_try_find env1.includes mname in
                      match uu___1 with
                      | FStar_Pervasives_Native.None -> []
                  ...
                  let proc uu___ =
                    ...
                    | Local_bindings lbs when
                        let uu___1 =
                          ...
                          FStarC_Util.psmap_try_find lbs uu___2 in
                    ...
                    | Top_level_defs ids when
                        let uu___1 =
                          let uu___2 = FStarC_Ident.string_of_id id in
                          FStarC_Util.psmap_try_find ids uu___2 in
                        FStar_Pervasives_Native.uu___is_Some uu___1 ->
      ...
      fun k_global_def ->
        fun k_not_found ->
          let uu___ =
            ...
            FStarC_Util.smap_try_find (sigmap env1) uu___1 in
          match uu___ with
          ...
          let find_in_monad =
            ...
            | FStar_Pervasives_Native.Some uu___ ->
                ...
                let uu___1 =
                  ...
                  FStarC_Util.smap_try_find (sigmap env1) uu___2 in
                (match uu___1 with
...
let (ns_of_lid_equals :
  ...
  fun lid ->
    fun ns ->
      (let uu___ =
         let uu___1 = FStarC_Ident.ns_of_lid lid in FStarC_List.length uu___1 in
       let uu___1 =
         let uu___2 = FStarC_Ident.ids_of_lid ns in FStarC_List.length uu___2 in
       uu___ = uu___1) &&
        (let uu___ =
      ...
      | FStar_Pervasives_Native.Some
          ...
          let rec aux new_name =
            let uu___12 =
              ...
              FStarC_Util.smap_try_find (sigmap env1) uu___13 in
            match uu___12 with
            | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
...
let (empty_include_smap :
  (FStarC_Ident.lident * FStarC_Syntax_Syntax.restriction) Prims.list
    FStarC_Effect.ref FStarC_Util.smap)
  = new_sigmap ()
let (empty_exported_id_smap : exported_id_set FStarC_Util.smap) =
  new_sigmap ()
let (try_lookup_lid' :
  Prims.bool ->
    Prims.bool ->
  ...
  fun env1 ->
    fun ns ->
      let rec aux ns1 rest =
        ...
        | hd::tl ->
            let uu___ =
              let uu___1 = FStarC_Ident.lid_of_ids (FStarC_List.rev ns1) in
  ...
  fun env1 ->
    fun lid0 ->
      ...
      | (pref, ns) ->
          ...
          let suffs = let uu___1 = tails ns in FStarC_List.rev uu___1 in
          let try1 lid' =
...
let (record_cache_aux_with_filter :
  ((((unit -> unit) * (unit -> unit)) * (((unit -> (Prims.int * unit)) *
    ...
    (unit -> unit)))
  =
  let record_cache = FStarC_Util.mk_ref [[]] in
  let push uu___ =
    let uu___1 =
      let uu___2 =
        let uu___3 = FStarC_Effect.op_Bang record_cache in
        FStarC_List.hd uu___3 in
      let uu___3 = FStarC_Effect.op_Bang record_cache in uu___2 :: uu___3 in
    FStarC_Effect.op_Colon_Equals record_cache uu___1 in
  let pop uu___ =
    let uu___1 =
      let uu___2 = FStarC_Effect.op_Bang record_cache in
  ...
  let peek uu___ =
    let uu___1 = FStarC_Effect.op_Bang record_cache in FStarC_List.hd uu___1 in
  let insert r =
    let uu___ =
            ...
            FStarC_List.iter
              (fun uu___1 ->
                 ...
                 | {
                     ...
                     FStarC_Syntax_Syntax.sigopts = uu___10;_} ->
                     let uu___11 =
                       let uu___12 = find_dc dc in FStarC_Util.must uu___12 in
                     (match uu___11 with
                      | {
                          FStarC_Syntax_Syntax.sigel =
                            FStarC_Syntax_Syntax.Sig_datacon
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  ...
                  FStarC_List.op_At uu___5 [r.constrname] in
...
let (push_bv' :
  ...
  fun env1 ->
    fun x ->
      ...
      let used_marker1 = FStarC_Util.mk_ref false in
      let scope_mods =
        ...
        | (Local_bindings lbs)::rest ->
            let uu___ =
              let uu___1 =
                ...
                FStarC_Util.psmap_add lbs uu___2 (x, bv, used_marker1) in
        ...
        | uu___ ->
            let uu___1 =
              let uu___2 =
                ...
                FStarC_Util.psmap_add uu___3 uu___4 (x, bv, used_marker1) in
      ...
      fun s ->
        let err l =
          let sopt =
            ...
            FStarC_Util.smap_try_find (sigmap env1) uu___ in
          let r =
            match sopt with
            | FStar_Pervasives_Native.Some (se, uu___) ->
                let uu___1 =
                  let uu___2 = FStarC_Syntax_Util.lids_of_sigelt se in
                  FStarC_Util.find_opt (FStarC_Ident.lid_equals l) uu___2 in
                (match uu___1 with
                 | FStar_Pervasives_Native.Some l1 ->
                     let uu___2 = FStarC_Ident.range_of_lid l1 in
                     FStarC_Range_Ops.string_of_range uu___2
          ...
          let uu___ =
            let uu___1 =
              let uu___2 =
                let uu___3 = FStarC_Ident.string_of_lid l in
                FStarC_Util.format1 "Duplicate top-level names [%s]" uu___3 in
          ...
          FStarC_Errors.raise_error FStarC_Ident.hasrange_lident l
            ...
            (Obj.magic uu___) in
        let globals = FStarC_Util.mk_ref env1.scope_mods in
        let env2 =
          let uu___ =
            match s.FStarC_Syntax_Syntax.sigel with
        ...
        let uu___ =
          ...
          | uu___1 ->
              let uu___2 =
                let uu___3 =
                  let uu___4 = FStarC_Syntax_Util.lids_of_sigelt s in
                  (uu___4, s) in
                [uu___3] in
              (env3, uu___2) in
        match uu___ with
            ...
            let push_top_level_def id stack =
              ...
              | (Top_level_defs ids)::rest ->
                  let uu___1 =
                    let uu___2 =
                      let uu___3 = FStarC_Ident.string_of_id id in
                      FStarC_Util.psmap_add ids uu___3 true in
              ...
              | uu___1 ->
                  let uu___2 =
                    let uu___3 =
                      ...
                      FStarC_Util.psmap_add uu___4 uu___5 true in
                  ...
                  | (lids, se) ->
                      FStarC_List.iter
                        (fun lid ->
                           (let uu___4 =
                              let uu___5 = FStarC_Ident.ident_of_lid lid in
                              let uu___6 = FStarC_Effect.op_Bang globals in
                              push_top_level_def uu___5 uu___6 in
                            FStarC_Effect.op_Colon_Equals globals uu___4);
                           (match () with
                            | () ->
                                let modul =
                                  let uu___4 =
                                ...
                                ((let uu___5 = get_exported_id_set env4 modul in
                                 ...
                                 (match () with
                                  | () ->
                                      ...
                                      FStarC_Util.smap_add (sigmap env4)
                                        uu___5
                                        (se,
                                          (env4.iface &&
                                             (Prims.op_Negation
            ...
            let uu___13 =
              let uu___14 =
                let uu___15 =
                  ...
                  FStarC_List.splitAt num_ty_params uu___16 in
                ...
                | FStar_Pervasives_Native.Some (id, i) ->
                    ...
                    ((let uu___2 =
                     ...
                     (let uu___2 =
                        ...
                        let uu___4 = FStarC_Ident.string_of_id id in
                        FStarC_Util.format1 uu___3 uu___4 in
              ...
              let uu___2 =
                FStarC_Util.for_some
                  (fun m ->
                     ...
                     FStarC_Util.starts_with uu___3 uu___4) module_names1 in
              if uu___2
              then (ns, FStarC_Syntax_Syntax.Open_namespace)
              else
                (let uu___4 =
                   let uu___5 = FStarC_Ident.string_of_lid ns in
                   FStarC_Util.format1 "Namespace %s cannot be found" uu___5 in
      ...
      fun restriction ->
        ...
        | FStar_Pervasives_Native.Some ns1 ->
            ((env1.ds_hooks).ds_push_include_hook env1 ns1;
             (let env2 =
              ...
              (let uu___3 = FStarC_Util.smap_try_find env2.includes curmod in
               match uu___3 with
               | FStar_Pervasives_Native.None -> ()
               | FStar_Pervasives_Native.Some incl ->
                   let uu___4 =
                     let uu___5 = FStarC_Effect.op_Bang incl in
                     (ns1, restriction) :: uu___5 in
                   FStarC_Effect.op_Colon_Equals incl uu___4);
              (match () with
               | () ->
                   let uu___3 =
                              ...
                              let update_exports k =
                                let ns_ex =
                                  let uu___6 =
                                    ...
                                    FStarC_Effect.op_Bang uu___7 in
                                  Obj.magic
                                    (FStarC_Class_Setlike.filter ()
                                       ...
                                       (fun id ->
                                          ...
                                          FStarC_Util.is_some uu___7)
                                       (Obj.magic uu___6)) in
                                let ex = cur_exports k in
                                (let uu___7 =
                                   let uu___8 = FStarC_Effect.op_Bang ex in
                                   Obj.magic
                                 ...
                                 FStarC_Effect.op_Colon_Equals ex uu___7);
                                (match () with
                                 | () ->
        ...
        | uu___1 ->
            let uu___2 =
              ...
              FStarC_Util.format1 "include: Module %s cannot be found" uu___3 in
            FStarC_Errors.raise_error FStarC_Ident.hasrange_lident ns
    ...
    fun x ->
      fun l ->
        ...
        then
          ...
          (let uu___2 =
             let uu___3 = FStarC_Ident.string_of_lid l in
             FStarC_Util.format1 "Module %s cannot be found" uu___3 in
           FStarC_Errors.raise_error FStarC_Ident.hasrange_lident l
             FStarC_Errors_Codes.Fatal_ModuleNotFound ()
             (Obj.magic FStarC_Errors_Msg.is_error_message_string)
             (Obj.magic uu___2))
                        ...
                        ((let uu___3 =
                         ...
                         (let quals = FStarC_Syntax_Syntax.Assumption ::
                          ...
                          (let uu___4 = FStarC_Ident.string_of_lid l in
                           FStarC_Util.smap_add (sigmap env1) uu___4
                             ({
                                FStarC_Syntax_Syntax.sigel =
        ...
        (fun se ->
                 ...
                 FStarC_List.iter
                   (fun se1 ->
                      ...
                      | FStarC_Syntax_Syntax.Sig_datacon
                          ...
                          FStarC_Util.smap_remove (sigmap env1) uu___8
                      | FStarC_Syntax_Syntax.Sig_inductive_typ
                          ...
                          ((let uu___7 = FStarC_Ident.string_of_lid lid in
                            FStarC_Util.smap_remove (sigmap env1) uu___7);
                           if
                             Prims.op_Negation
                               (FStarC_List.contains
                           ...
                           then
                             (let sigel =
                              ...
                              let uu___7 = FStarC_Ident.string_of_lid lid in
                              FStarC_Util.smap_add (sigmap env1) uu___7
                                (se2, false))
                           else ())
                      | uu___2 -> ()) ses
               else ()
           | FStarC_Syntax_Syntax.Sig_declare_typ
               ...
               then
                 ...
                 FStarC_Util.smap_remove (sigmap env1) uu___3
               else ()
           | FStarC_Syntax_Syntax.Sig_let
               { FStarC_Syntax_Syntax.lbs1 = (uu___1, lbs);
                 FStarC_Syntax_Syntax.lids1 = uu___2;_}
                 ...
                 FStarC_List.iter
                   (fun lb ->
                      let uu___3 =
                        ...
                        FStarC_Ident.string_of_lid uu___4 in
                      FStarC_Util.smap_remove (sigmap env1) uu___3) lbs
               else ()
        ...
        | (FStar_Pervasives_Native.Some cur_ex, FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu___3 = cur_ex eikind in FStarC_Effect.op_Bang uu___3 in
              let cur_trans_ex_set_ref = cur_trans_ex eikind in
              let uu___3 =
                let uu___4 = FStarC_Effect.op_Bang cur_trans_ex_set_ref in
                Obj.magic
                  (FStarC_Class_Setlike.union ()
                     (Obj.magic
                        (FStarC_RBSet.setlike_rbset
              ...
              FStarC_Effect.op_Colon_Equals cur_trans_ex_set_ref uu___3 in
...
let (stack : env Prims.list FStarC_Effect.ref) = FStarC_Util.mk_ref []
let (push : env -> env) =
  fun env1 ->
    FStarC_Util.atomically
      (fun uu___ ->
         push_record_cache ();
         (let uu___3 =
            let uu___4 = FStarC_Effect.op_Bang stack in env1 :: uu___4 in
          FStarC_Effect.op_Colon_Equals stack uu___3);
         (let uu___3 = FStarC_Util.smap_copy env1.exported_ids in
          let uu___4 = FStarC_Util.smap_copy env1.trans_exported_ids in
          let uu___5 = FStarC_Util.smap_copy env1.includes in
          let uu___6 = FStarC_Util.smap_copy env1.sigmap in
          {
            curmodule = (env1.curmodule);
            curmonad = (env1.curmonad);
            modules = (env1.modules);
...
let (pop : unit -> env) =
  fun uu___ ->
    FStarC_Util.atomically
      (fun uu___1 ->
         let uu___2 = FStarC_Effect.op_Bang stack in
         match uu___2 with
         | env1::tl ->
             (pop_record_cache ();
    ...
    fun env1 ->
      let sigelt_in_m se =
        ...
        | l::uu___1 ->
            ...
            let uu___3 = FStarC_Ident.string_of_lid m in uu___2 = uu___3
        | uu___1 -> false in
      let sm = sigmap env1 in
      let env2 = pop () in
      let keys = FStarC_Util.smap_keys sm in
      let sm' = sigmap env2 in
      FStarC_List.iter
        (fun k ->
           let uu___1 = FStarC_Util.smap_try_find sm' k in
           match uu___1 with
           | FStar_Pervasives_Native.Some (se, true) when sigelt_in_m se ->
               (FStarC_Util.smap_remove sm' k;
                (let se1 =
                   match se.FStarC_Syntax_Syntax.sigel with
                   | FStarC_Syntax_Syntax.Sig_declare_typ
                       { FStarC_Syntax_Syntax.lid2 = l;
                   ...
                   | uu___3 -> se in
                 FStarC_Util.smap_add sm' k (se1, false)))
           | uu___2 -> ()) keys;
      env2
...
let (as_exported_id_set :
  ...
  fun e ->
    ...
    | FStar_Pervasives_Native.Some e1 ->
        let terms = FStarC_Util.mk_ref e1.exported_id_terms in
        let fields = FStarC_Util.mk_ref e1.exported_id_fields in
        (fun uu___ ->
           match uu___ with
...
let as_includes :
  ...
  fun uu___ ->
    match uu___ with
    | FStar_Pervasives_Native.None -> FStarC_Util.mk_ref []
    | FStar_Pervasives_Native.Some l -> FStarC_Util.mk_ref l
let (inclusion_info : env -> FStarC_Ident.lident -> module_inclusion_info) =
  fun env1 ->
    fun l ->
      let mname = FStarC_Ident.string_of_lid l in
      let as_ids_opt m =
        let uu___ = FStarC_Util.smap_try_find m mname in
      ...
      let uu___2 =
        let uu___3 = FStarC_Util.smap_try_find env1.includes mname in
        FStarC_Util.map_opt uu___3 (fun r -> FStarC_Effect.op_Bang r) in
      {
          ...
          fun mii ->
            let prep env2 =
              ...
              (let uu___1 = FStarC_Ident.string_of_lid mname in
               ...
               FStarC_Util.smap_add env2.exported_ids uu___1 uu___2);
              (match () with
               | () ->
                   ((let uu___2 = FStarC_Ident.string_of_lid mname in
                     let uu___3 =
                       as_exported_id_set mii.mii_trans_exported_ids in
                     FStarC_Util.smap_add env2.trans_exported_ids uu___2
                       uu___3);
                    (match () with
                     | () ->
                         ((let uu___3 = FStarC_Ident.string_of_lid mname in
                           let uu___4 = as_includes mii.mii_includes in
                           FStarC_Util.smap_add env2.includes uu___3 uu___4);
                          (match () with
                           | () ->
                               let env' =
                                 let uu___3 =
      ...
      fun lid ->
        ...
        | FStar_Pervasives_Native.None ->
            ...
            let msg =
              let uu___1 =
                let uu___2 = FStarC_Ident.string_of_lid lid in
                FStarC_Util.format1 "Identifier not found: [%s]" uu___2 in
                 ...
                 | FStar_Pervasives_Native.Some modul' ->
                     let uu___4 =
                       let uu___5 =
                         ...
                         FStarC_Errors_Msg.text uu___6 in
                       [uu___5] in
                     FStarC_List.op_At msg uu___4) in
