    ...
    fun s2 ->
      fun xs ->
        ...
        | x::y::xs1 ->
            ...
            x :: uu___
let (typo_msg :
  Prims.string -> Prims.string Prims.list -> FStar_Pprint.document) =
  fun x ->
    fun xs ->
        ...
        (let uu___1 =
           ...
           let uu___3 =
             let uu___4 =
               let uu___5 =
                 let uu___6 =
                   FStarC_List.map FStar_Pprint.doc_of_string cands in
                 list_sep2
...
let (__proj__Top_level_defs__item___0 : scope_mod -> unit FStarC_PSMap.t) =
                               ...
                               | (ns1, restriction) ->
                                   let opt =
                                     FStarC_Syntax_Syntax.is_ident_allowed_by_restriction
                                       id1 restriction in
                                   FStarC_Option.map (fun id2 -> (ns1, id2))
                                     opt) uu___3 in
                    let look_into =
                      if not_shadowed
                      then
        ...
        fun uu___ ->
          ...
          | (se, uu___2) ->
              (match se with
               ...
               | {
                   FStarC_Syntax_Syntax.sigel =
                     FStarC_Syntax_Syntax.Sig_splice uu___3;
                   FStarC_Syntax_Syntax.sigrng = uu___4;
                   FStarC_Syntax_Syntax.sigquals = uu___5;
                   FStarC_Syntax_Syntax.sigmeta = uu___6;
                   FStarC_Syntax_Syntax.sigattrs = uu___7;
                   ...
                   let uu___10 =
                     let uu___11 =
                       FStarC_Syntax_Syntax.lid_and_dd_as_fv lid1 qual1 in
                     (uu___11, se) in
                   FStar_Pervasives_Native.Some uu___10
               | {
                   FStarC_Syntax_Syntax.sigel =
    ...
    fun env1 ->
      fun s ->
        ...
        let lss =
          ...
          | uu___ ->
              let uu___2 =
                let uu___3 = FStarC_Syntax_Util.lids_of_sigelt s in
                (uu___3, s) in
              [uu___2] in
                 ...
                 ((let uu___3 = get_exported_id_set env3 modul in
                  ...
                  (match () with
                   | () ->
                       let is_iface =
                         env3.iface &&
                           (Prims.op_Negation env3.admitted_iface) in
                       let uu___4 = FStarC_Ident.string_of_lid lid in
                             ...
                             FStarC_List.map
                               (fun uu___5 ->
                                  ...
                                  | (id1, renamed1) ->
                                      ...
                                      let uu___7 =
                                        FStarC_Option.map with_renamed_range
                                          renamed1 in
                  ...
                  FStarC_List.mapi
                    (fun i ->
                       fun uu___ ->
                         match uu___ with
                         | (id, renamed) ->
                             ((FStarC_Option.dflt id renamed), i)) l3 in
                let uu___ =
