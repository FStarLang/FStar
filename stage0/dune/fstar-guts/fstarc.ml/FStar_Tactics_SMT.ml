         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_2
               ...
               FStarC_Syntax_Embeddings.e_unit psc ncb us args)
let get_rlimit (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.int=
  let x = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               psc ncb us args)
let set_rlimit (v : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x =
...
let get_initial_fuel (uu___ : unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : Prims.int=
  let x = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_unit FStarC_Syntax_Embeddings.e_int
               psc ncb us args)
let get_max_fuel (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.int=
  let x = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_unit FStarC_Syntax_Embeddings.e_int
               psc ncb us args)
let get_max_ifuel (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.int=
  let x = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_int FStarC_Syntax_Embeddings.e_unit
               psc ncb us args)
let set_max_fuel (v : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x =
    let x1 = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
    {
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_int FStarC_Syntax_Embeddings.e_unit
               psc ncb us args)
let set_max_ifuel (v : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate)
  : unit=
  let x =
    let x1 = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
    {
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_int FStarC_Syntax_Embeddings.e_unit
               psc ncb us args)
let set_fuel (v : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x =
    let x1 = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
    {
         ...
         fun us ->
           fun args ->
             FStarC_Tactics_InterpFuns.mk_tactic_interpretation_1
               ...
               FStarC_Syntax_Embeddings.e_int FStarC_Syntax_Embeddings.e_unit
               psc ncb us args)
let set_ifuel (v : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x =
    let x1 = FStarC_Tactics_V2_Builtins.get_vconfig () ps in
    {
