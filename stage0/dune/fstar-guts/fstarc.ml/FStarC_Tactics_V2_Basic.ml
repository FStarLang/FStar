...
let dbg_TacUnify : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "TacUnify"
let dbg_2635 : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "2635"
let dbg_ReflTc : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "ReflTc"
let dbg_TacVerbose : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "TacVerbose"
let fixup_range (uu___ : FStarC_Range_Type.t) :
  FStarC_Range_Type.t FStarC_Tactics_Monad.tac=
  (fun r ->
...
let compress (uu___ : FStarC_Syntax_Syntax.term) :
...
let compress_univ (uu___ : FStarC_Syntax_Syntax.universe) :
  FStarC_Syntax_Syntax.universe FStarC_Tactics_Monad.tac=
  (fun u ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                let uu___1 = Obj.magic uu___1 in
                let uu___2 = FStarC_Syntax_Subst.compress_univ u in
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let core_check (env : FStarC_TypeChecker_Env.env)
  (sol : FStarC_Syntax_Syntax.term) (t : FStarC_Syntax_Syntax.typ)
  (must_tot : Prims.bool) :
  (FStarC_TypeChecker_Core.guard_and_tok_t FStar_Pervasives_Native.option,
  ...
  then FStar_Pervasives.Inl FStar_Pervasives_Native.None
    ...
    (let debug f =
       let uu___1 = FStarC_Debug.any () in if uu___1 then f () else () in
     let uu___1 = FStarC_TypeChecker_Core.check_term env sol t must_tot in
     match uu___1 with
     ...
     | FStar_Pervasives.Inr err ->
         (debug
            (fun uu___3 ->
               ...
               let uu___5 = FStarC_TypeChecker_Core.print_error_short err in
               let uu___6 =
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_term sol in
               let uu___7 =
                 FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t in
               let uu___8 = FStarC_TypeChecker_Core.print_error err in
...
let normalize (s : FStarC_TypeChecker_Env.steps)
  ...
  FStarC_Syntax_Syntax.term= FStarC_TypeChecker_Normalize.normalize s e t
let bnorm (e : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term= normalize [] e t
let whnf (e : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term= FStarC_TypeChecker_Normalize.unfold_whnf e t
let tts :
...
let bnorm_goal (g : FStarC_Tactics_Types.goal) : FStarC_Tactics_Types.goal=
  let uu___ =
    ...
    bnorm (FStarC_Tactics_Types.goal_env g) uu___1 in
  FStarC_Tactics_Monad.goal_with_type g uu___
let tacprint (s : Prims.string) : unit= FStarC_Format.print1 "TAC>> %s\n" s
let tacprint1 (s : Prims.string) (x : Prims.string) : unit=
  FStarC_Format.print1 "TAC>> %s\n" (FStarC_Format.fmt1 s x)
let tacprint2 (s : Prims.string) (x : Prims.string) (y : Prims.string) :
  unit= FStarC_Format.print1 "TAC>> %s\n" (FStarC_Format.fmt2 s x y)
let tacprint3 (s : Prims.string) (x : Prims.string) (y : Prims.string)
  (z : Prims.string) : unit=
       ...
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___2 ->
             (fun uu___2 ->
                ...
                let uu___3 = FStarC_Effect.op_Bang dbg_Tac in
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___3))) uu___2))) uu___
let ide (uu___ : unit) : Prims.bool FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     let uu___1 =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
          ...
          (fun uu___2 ->
             (fun uu___2 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___3))) uu___2))) uu___
let do_dump_ps (msg : Prims.string) (ps : FStarC_Tactics_Types.proofstate) :
  unit=
...
let dump (msg : Prims.string) : unit FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.mk_tac
    (fun ps -> do_dump_ps msg ps; FStarC_Tactics_Result.Success ((), ps))
let dump_all (print_resolved : Prims.bool) (msg : Prims.string) :
...
let dump_uvars_of (g : FStarC_Tactics_Types.goal) (msg : Prims.string) :
  unit FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.mk_tac
    (fun ps ->
       let uvs =
         ...
         FStarC_Class_Setlike.elems
           ...
           uu___ in
       let gs = FStarC_List.map (FStarC_Tactics_Types.goal_of_ctx_uvar g) uvs in
       let gs1 =
         FStarC_List.filter
           (fun g1 ->
       ...
       do_dump_ps msg ps'; FStarC_Tactics_Result.Success ((), ps))
let fail1 (msg : Prims.string) (x : Prims.string) :
  'uuuuu FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.fail (FStarC_Format.fmt1 msg x)
let fail2 (msg : Prims.string) (x : Prims.string) (y : Prims.string) :
  'uuuuu FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.fail (FStarC_Format.fmt2 msg x y)
let fail3 (msg : Prims.string) (x : Prims.string) (y : Prims.string)
  (z : Prims.string) : 'uuuuu FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.fail (FStarC_Format.fmt3 msg x y z)
let fail4 (msg : Prims.string) (x : Prims.string) (y : Prims.string)
  (z : Prims.string) (w : Prims.string) : 'uuuuu FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.fail (FStarC_Format.fmt4 msg x y z w)
let destruct_eq' (typ : FStarC_Syntax_Syntax.typ) :
  (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.term)
    FStar_Pervasives_Native.option=
  let typ1 = FStarC_Syntax_Util.unmeta typ in
  let uu___ = FStarC_Syntax_Formula.destruct_typ_as_formula typ1 in
  match uu___ with
...
let destruct_eq (env1 : FStarC_TypeChecker_Env.env)
  ...
  | FStar_Pervasives_Native.None ->
      ...
      (match uu___1 with
       ...
       | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None)
let get_guard_policy (uu___ : unit) :
  FStarC_Tactics_Types.guard_policy FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun ps ->
               ...
               uu___1))) uu___
let set_guard_policy (pol : FStarC_Tactics_Types.guard_policy) :
  unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___ ->
...
let with_policy (uu___1 : FStarC_Tactics_Types.guard_policy)
  (uu___ : 'a FStarC_Tactics_Monad.tac) : 'a FStarC_Tactics_Monad.tac=
  (fun pol t ->
       ...
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun old_pol ->
               ...
               uu___1))) uu___1 uu___
let proc_guard_formula (reason : Prims.string) (e : env)
  (f : FStarC_Syntax_Syntax.term)
  (tok :
    FStarC_TypeChecker_Core.guard_commit_token_cb
      FStar_Pervasives_Native.option)
  (sc_opt :
    FStarC_Syntax_Syntax.should_check_uvar FStar_Pervasives_Native.option)
  (rng : FStarC_Range_Type.t) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___ ->
       (fun ps ->
          ...
          (let commit_guard_token uu___1 =
             match tok with
             | FStar_Pervasives_Native.Some tok1 ->
                 FStarC_TypeChecker_Core.commit_guard tok1
               ...
               ((let uu___2 =
                   let uu___3 =
                     FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                       f in
                   FStarC_Format.fmt1 "Tactics admitted guard <%s>\n\n"
                     uu___3 in
                 FStarC_Errors.log_issue FStarC_TypeChecker_Env.hasRange_env
                   e FStarC_Errors_Codes.Warning_TacAdmit ()
                       ...
                       (fun uu___1 ->
                          ...
                          Obj.magic
                            (FStarC_Class_Monad.op_let_Bang
                               FStarC_Tactics_Monad.monad_tac () ()
                               (Obj.magic
                                  (FStarC_Tactics_Monad.goal_of_guard reason
                                     e f sc_opt rng))
                               (fun uu___2 ->
                                  (fun g ->
                                     let g = Obj.magic g in
                                     Obj.magic
                                       (FStarC_Tactics_Monad.push_goals [g]))
                                    uu___2))) uu___1))
                                 ...
                                 FStarC_Class_Monad.op_let_Bang
                                   ...
                                   (fun uu___3 ->
                                      (fun uu___3 ->
                                         ...
                                         let uu___4 =
                                           FStarC_Util.message_of_exn uu___2 in
                                         Obj.magic
                                           (fail2
                                              "Forcing the guard failed (%s)\n%s\n"
                                              reason uu___4)) uu___3)))
                         uu___1))
                                      ...
                                      (fun uu___3 ->
                                         ...
                                         Obj.magic
                                           (fail2
                                              ...
                                              reason uu___4)) uu___3)))
                         uu___1)))) uu___)
let proof_obligation_implicits_as_goals (e : env)
  (imps : FStarC_TypeChecker_Env.implicit Prims.list) :
  unit FStarC_Tactics_Monad.tac=
  let is_proof_obligation imp =
    let uu___ =
      let uu___1 =
    ...
    then
      let uu___1 =
        ...
        FStarC_Syntax_Util.arrow_formals_comp uu___2 in
      match uu___1 with
      | (uu___2, c) ->
          let uu___3 =
            let uu___4 =
              let uu___5 =
                FStarC_TypeChecker_Normalize.unfold_whnf e
  ...
  let uu___ = FStarC_List.filter is_proof_obligation imps in
  match uu___ with
  | [] ->
      FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
        (Obj.repr ())
  | imps1 ->
      let uu___1 =
        FStarC_List.map
          (fun imp ->
             let uu___2 =
               let uu___3 = FStarC_Options.peek () in
               FStarC_Tactics_Types.mk_goal e
                 imp.FStarC_TypeChecker_Common.imp_uvar uu___3 true
                 "goal for an unsolved proof obligation" in
             bnorm_goal uu___2) imps1 in
      FStarC_Tactics_Monad.push_goals uu___1
let proc_guard' (simplify : Prims.bool) (reason : Prims.string) (e : env)
  ...
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    ...
    (fun uu___ ->
       (fun uu___ ->
          ...
          (match sc_opt with
           | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Allow_untyped
               r) ->
               FStarC_List.iter
                 (fun imp ->
          ...
          Obj.magic
            (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac ()
               () (FStarC_Tactics_Monad.add_implicits imps)
               (fun uu___2 ->
                  (fun uu___2 ->
                     let uu___2 = Obj.magic uu___2 in
                     let uu___3 = proof_obligation_implicits_as_goals e imps in
                     Obj.magic
                       (FStarC_Class_Monad.op_let_Bang
                          ...
                          (fun uu___4 ->
                             (fun uu___4 ->
                                ...
                                let guard_f =
                                  ...
                                  then
                                    let uu___5 =
                                      FStarC_TypeChecker_Rel.simplify_guard e
                                        g in
                                ...
                                | FStarC_TypeChecker_Common.NonTrivial f ->
                                    Obj.magic
                                      (proc_guard_formula reason e f tok
                                         sc_opt rng)) uu___4))) uu___2)))
         uu___)
let proc_guard :
  Prims.string ->
    env ->
      FStarC_TypeChecker_Common.guard_t ->
        FStarC_TypeChecker_Core.guard_commit_token_cb
          ...
          FStarC_Syntax_Syntax.should_check_uvar
            FStar_Pervasives_Native.option ->
            FStarC_Range_Type.t -> unit FStarC_Tactics_Monad.tac=
  proc_guard' true
let tc_unifier_solved_implicits (env1 : FStarC_TypeChecker_Env.env)
  (must_tot : Prims.bool) (allow_guards : Prims.bool)
  (uvs : FStarC_Syntax_Syntax.ctx_uvar Prims.list) :
  unit FStarC_Tactics_Monad.tac=
  let aux u =
    let dec =
    ...
    | uu___ ->
        ...
        (match uu___1 with
         ...
         | FStar_Pervasives_Native.Some sol ->
             ...
             (match uu___2 with
              | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                  (FStarC_Tactics_Monad.mark_uvar_as_already_checked u;
                   FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.repr ()))
                  ...
                  then
                        ...
                        let uu___6 =
                          ...
                          let uu___8 =
                            ...
                            FStar_Pprint.op_Hat_Slash_Hat
                              (FStarC_Errors_Msg.text "to") uu___9 in
                          FStar_Pprint.op_Hat_Slash_Hat uu___7 uu___8 in
                        FStar_Pprint.op_Hat_Slash_Hat
                          (FStarC_Errors_Msg.text
                             "Could not typecheck unifier solved implicit")
                          uu___6 in
                      let uu___6 =
                        let uu___7 =
                          let uu___8 =
                          ...
                          FStar_Pprint.op_Hat_Slash_Hat
                            (FStarC_Errors_Msg.text "Guard =") uu___8 in
                        [uu___7] in
                      uu___5 :: uu___6 in
                    ...
                    (let uu___4 =
                       proc_guard' false "guard for implicit" env2 guard1
                         (FStar_Pervasives_Native.Some guard_tok)
                        ...
                        let uu___7 =
                          let uu___8 =
                            ...
                            let uu___10 =
                              ...
                              FStar_Pprint.op_Hat_Slash_Hat
                                (FStarC_Errors_Msg.text "because") uu___11 in
                            FStar_Pprint.op_Hat_Slash_Hat uu___9 uu___10 in
                          FStar_Pprint.op_Hat_Slash_Hat
                            (FStarC_Errors_Msg.text "to") uu___8 in
...
type check_unifier_solved_implicits_side =
  ...
  | Check_right_only 
  | Check_both 
let uu___is_Check_none (projectee : check_unifier_solved_implicits_side) :
  Prims.bool= match projectee with | Check_none -> true | uu___ -> false
let uu___is_Check_left_only (projectee : check_unifier_solved_implicits_side)
  : Prims.bool=
  match projectee with | Check_left_only -> true | uu___ -> false
let uu___is_Check_right_only
  (projectee : check_unifier_solved_implicits_side) : Prims.bool=
  match projectee with | Check_right_only -> true | uu___ -> false
let uu___is_Check_both (projectee : check_unifier_solved_implicits_side) :
  Prims.bool= match projectee with | Check_both -> true | uu___ -> false
let __do_unify_wflags (uu___6 : Prims.bool) (uu___5 : Prims.bool)
  (uu___4 : Prims.bool) (uu___3 : check_unifier_solved_implicits_side)
  (uu___2 : env) (uu___1 : FStarC_Syntax_Syntax.term)
  (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option
    FStarC_Tactics_Monad.tac=
  (fun dbg allow_guards must_tot check_side env1 t1 t2 ->
     if dbg
     then
       (let uu___1 =
     ...
     (let all_uvars =
        let uu___1 =
          ...
          | Check_both ->
              ...
              let uu___3 = FStarC_Syntax_Free.uvars t2 in
              FStarC_Class_Setlike.union
                (FStarC_FlatSet.setlike_flat_set
                   FStarC_Syntax_Free.ord_ctx_uvar) uu___2 uu___3 in
        FStarC_Class_Setlike.elems
          (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar)
          uu___1 in
      let uu___1 =
        let uu___2 =
          Obj.magic
            (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac ()
               ()
               (Obj.magic
                  (FStarC_Tactics_Monad.trytac FStarC_Tactics_Monad.cur_goal))
               (fun uu___3 ->
                  (fun gopt ->
                             ...
                             (fun uu___3 ->
                                ...
                                | () ->
                                    let res =
                                      if allow_guards
                                      then
                                        FStarC_TypeChecker_Rel.try_teq true
                                          env1 t1 t2
                                      else
           ...
           (fun uu___2 ->
              (fun uu___2 ->
                 ...
                 | FStar_Pervasives.Inl exn ->
                     Obj.magic (Obj.repr (FStarC_Tactics_Monad.traise exn))
                 | FStar_Pervasives.Inr v ->
                     Obj.magic
                       (Obj.repr
                          (FStarC_Class_Monad.return
                             FStarC_Tactics_Monad.monad_tac () (Obj.magic v))))
                uu___2)))) uu___6 uu___5 uu___4 uu___3 uu___2 uu___1 uu___
let __do_unify (uu___5 : Prims.bool) (uu___4 : Prims.bool)
  (uu___3 : check_unifier_solved_implicits_side) (uu___2 : env)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option
    FStarC_Tactics_Monad.tac=
  (fun allow_guards must_tot check_side env1 t1 t2 ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                let uu___1 = Obj.magic uu___1 in
                (let uu___3 = FStarC_Effect.op_Bang dbg_TacUnify in
                 if uu___3
                 then
                   (FStarC_Options.push ();
                    (let uu___5 =
                ...
                (let uu___3 =
                   let uu___4 = FStarC_Effect.op_Bang dbg_TacUnify in
                   __do_unify_wflags uu___4 allow_guards must_tot check_side
                     env1 t1 t2 in
                 Obj.magic
                   (FStarC_Class_Monad.op_let_Bang
                      FStarC_Tactics_Monad.monad_tac () () (Obj.magic uu___3)
                      (fun uu___4 ->
                         (fun r ->
                            let r = Obj.magic r in
                            (let uu___5 = FStarC_Effect.op_Bang dbg_TacUnify in
                             if uu___5 then FStarC_Options.pop () else ());
                            Obj.magic
                              (FStarC_Class_Monad.return
                                 FStarC_Tactics_Monad.monad_tac ()
                                 (Obj.magic r))) uu___4)))) uu___1))) uu___5
    uu___4 uu___3 uu___2 uu___1 uu___
let do_unify_aux (uu___4 : Prims.bool)
  (uu___3 : check_unifier_solved_implicits_side) (uu___2 : env)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  (fun must_tot check_side env1 t1 t2 ->
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                | FStar_Pervasives_Native.None ->
                    Obj.magic
                      (FStarC_Class_Monad.return
                         FStarC_Tactics_Monad.monad_tac () (Obj.magic false))
                | FStar_Pervasives_Native.Some g ->
                    let uu___2 =
                      if
                        Prims.not
                      ...
                      then
                        ...
                        FStarC_Class_Monad.return
                          FStarC_Tactics_Monad.monad_tac () (Obj.repr ()) in
                    Obj.magic
                      (FStarC_Class_Monad.op_let_Bang
                         ...
                         (fun uu___3 ->
                            (fun uu___3 ->
                               ...
                               Obj.magic
                                 (FStarC_Class_Monad.return
                                    FStarC_Tactics_Monad.monad_tac ()
                                    (Obj.magic true))) uu___3))) uu___1)))
    uu___4 uu___3 uu___2 uu___1 uu___
let do_unify (must_tot : Prims.bool) (env1 : env)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  do_unify_aux must_tot Check_both env1 t1 t2
let do_unify_maybe_guards (allow_guards : Prims.bool) (must_tot : Prims.bool)
  (env1 : env) (t1 : FStarC_Syntax_Syntax.term)
  (t2 : FStarC_Syntax_Syntax.term) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option
    FStarC_Tactics_Monad.tac=
  __do_unify allow_guards must_tot Check_both env1 t1 t2
let do_subtype (uu___3 : Prims.bool) (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  (fun must_tot env1 t1 t2 ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic
             (FStarC_Tactics_Monad.mk_tac
                (fun ps ->
                   ...
                   FStarC_Tactics_Result.Success (tx, ps))))
          (fun uu___ ->
             (fun tx ->
                let tx = Obj.magic tx in
                let all_uvars =
                  let uu___ =
                    let uu___1 = FStarC_Syntax_Free.uvars t1 in
                    let uu___2 = FStarC_Syntax_Free.uvars t2 in
                    FStarC_Class_Setlike.union
                      (FStarC_FlatSet.setlike_flat_set
                         FStarC_Syntax_Free.ord_ctx_uvar) uu___1 uu___2 in
                  FStarC_Class_Setlike.elems
                    (FStarC_FlatSet.setlike_flat_set
                       FStarC_Syntax_Free.ord_ctx_uvar) uu___ in
                let uu___ =
                  let uu___1 =
                    let uu___2 =
                      try
                        (fun uu___3 ->
                           (fun uu___3 ->
                              ...
                              | () ->
                                  let uu___4 =
                                    FStarC_TypeChecker_Rel.subtype_nosmt env1
                                      t1 t2 in
                                  (match uu___4 with
                                   ...
                                   | uu___5 ->
                                       Obj.magic
                                         (FStarC_Class_Monad.return
                                            FStarC_Tactics_Monad.monad_tac ()
                                            (Obj.magic false)))) uu___3) ()
                      with
                      | uu___3 ->
                          ((fun uu___3 ->
                              match uu___3 with
                              | FStarC_Errors.Error uu___4 ->
                                  Obj.magic
                                    (FStarC_Class_Monad.return
                                       FStarC_Tactics_Monad.monad_tac ()
                                       (Obj.magic false)))) uu___3 in
                    FStarC_Tactics_Monad.catch uu___2 in
                  Obj.magic
                    (FStarC_Class_Monad.op_let_Bang
                       FStarC_Tactics_Monad.monad_tac () ()
                       ...
                       (fun uu___2 ->
                          (fun uu___2 ->
                             ...
                             | FStar_Pervasives.Inl exn ->
                                 Obj.magic
                                   (Obj.repr
                                      (FStarC_Tactics_Monad.traise exn))
                             | FStar_Pervasives.Inr v ->
                                 Obj.magic
                                   (Obj.repr
                                      (FStarC_Class_Monad.return
                                         FStarC_Tactics_Monad.monad_tac ()
                                         (Obj.magic v)))) uu___2)) in
                Obj.magic
                  (FStarC_Class_Monad.op_let_Bang
                           ...
                           then
                             ...
                             (FStarC_Syntax_Unionfind.rollback tx;
                              Obj.magic
                                (FStarC_Class_Monad.return
                                   FStarC_Tactics_Monad.monad_tac ()
                                   (Obj.magic false)))) uu___1))) uu___)))
    uu___3 uu___2 uu___1 uu___
let do_match (uu___3 : Prims.bool) (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  (fun must_tot env1 t1 t2 ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___ ->
             (fun tx ->
                ...
                let uu___ = do_unify_aux must_tot Check_right_only env1 t1 t2 in
                Obj.magic
                  (FStarC_Class_Monad.op_let_Bang
                     FStarC_Tactics_Monad.monad_tac () () (Obj.magic uu___)
                     (fun uu___1 ->
                           ...
                           then
                             ...
                             let uu___1 =
                               FStarC_Class_Setlike.for_all
                                 (FStarC_FlatSet.setlike_flat_set
                                    FStarC_Syntax_Free.ord_ctx_uvar) check1
                                 uvs1 in
                             (if uu___1
                              then
                                Obj.magic
                             ...
                             Obj.magic
                               (FStarC_Class_Monad.return
                                  ...
                                  (Obj.magic false))) uu___1))) uu___)))
    uu___3 uu___2 uu___1 uu___
let do_match_on_lhs (uu___3 : Prims.bool)
  (uu___2 : FStarC_TypeChecker_Env.env) (uu___1 : FStarC_Syntax_Syntax.term)
  (uu___ : FStarC_Syntax_Syntax.term) : Prims.bool FStarC_Tactics_Monad.tac=
  (fun must_tot env1 t1 t2 ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic
          ...
          (fun uu___ ->
             (fun tx ->
                let tx = Obj.magic tx in
                let uu___ = destruct_eq env1 t1 in
                match uu___ with
                | FStar_Pervasives_Native.None ->
                    Obj.magic
                      (Obj.repr
                ...
                | FStar_Pervasives_Native.Some (lhs, uu___1) ->
                    Obj.magic
                      (Obj.repr
                          ...
                          FStarC_Class_Monad.op_let_Bang
                            ...
                            (fun uu___3 ->
                               (fun r ->
                                  ...
                                  then
                                    let uvs2 =
                                      FStarC_Syntax_Free.uvars_uncached lhs in
                                    let uu___3 =
                                      let uu___4 =
                                    ...
                                    Obj.magic
                                      (FStarC_Class_Monad.return
                                         FStarC_Tactics_Monad.monad_tac ()
                                         (Obj.magic false))) uu___3)))) uu___)))
    uu___3 uu___2 uu___1 uu___
let set_solution (goal : FStarC_Tactics_Types.goal)
  (solution : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Syntax_Unionfind.find
  ...
  | FStar_Pervasives_Native.Some uu___1 ->
      let uu___2 =
        ...
        FStarC_Format.fmt1 "Goal %s is already solved" uu___3 in
  ...
  | FStar_Pervasives_Native.None ->
      (FStarC_Syntax_Unionfind.change
       ...
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()))
let trysolve (goal : FStarC_Tactics_Types.goal)
  (solution : FStarC_Syntax_Syntax.term) :
  Prims.bool FStarC_Tactics_Monad.tac=
  let must_tot = true in
  let uu___ = FStarC_Tactics_Types.goal_witness goal in
  do_unify must_tot (FStarC_Tactics_Types.goal_env goal) solution uu___
let solve (goal : FStarC_Tactics_Types.goal)
  (solution : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  ...
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (FStarC_Tactics_Monad.log
       (fun uu___ ->
          ...
          let uu___2 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term solution in
                  ...
                  (fun b ->
                     ...
                     then
                       ...
                       (let uu___2 =
                          let uu___3 =
                            let uu___4 =
                              ttd (FStarC_Tactics_Types.goal_env goal)
                                solution in
                            let uu___5 =
                              let uu___6 =
                                let uu___7 =
                                  let uu___8 =
                                    FStarC_Tactics_Types.goal_witness goal in
                                  ttd (FStarC_Tactics_Types.goal_env goal)
                                    uu___8 in
                                let uu___8 =
                                  let uu___9 =
                                ...
                                FStar_Pprint.op_Hat_Slash_Hat uu___7 uu___8 in
                              FStar_Pprint.op_Hat_Slash_Hat
                                (FStarC_Errors_Msg.text "does not solve")
                                uu___6 in
                            FStar_Pprint.op_Hat_Slash_Hat uu___4 uu___5 in
                          [uu___3] in
                        Obj.magic (FStarC_Tactics_Monad.fail_doc uu___2)))
                    uu___2))) uu___)
let solve' (goal : FStarC_Tactics_Types.goal)
  (solution : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ = set_solution goal solution in
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () () uu___
    (fun uu___1 ->
       (fun uu___1 ->
          let uu___1 = Obj.magic uu___1 in
          Obj.magic
            (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac ()
               ...
               (fun uu___2 ->
                  (fun uu___2 ->
                    ...
                    uu___2))) uu___1)
let is_true (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  ...
  | FStar_Pervasives_Native.Some t' ->
      ...
      (match uu___1 with
       ...
       | uu___2 -> false)
  | uu___1 -> false
let is_false (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  ...
  | FStar_Pervasives_Native.Some t' ->
      ...
      (match uu___1 with
       ...
       | uu___2 -> false)
  | uu___1 -> false
let meas (s : Prims.string) (f : 'a FStarC_Tactics_Monad.tac) :
    ...
    (fun ps ->
       ...
       | (r, ms) ->
           ((let uu___2 =
             ...
             FStarC_Format.print2 "++ Tactic %s ran in \t\t%sms\n" s uu___2);
            r))
let tadmit_t (t : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.get)
      (fun uu___1 ->
                    ...
                    (fun g ->
                       ...
                       (let uu___2 =
                          ...
                          FStarC_Class_HasRange.pos
                            (FStarC_Syntax_Syntax.has_range_syntax ()) uu___3 in
                        let uu___3 =
                          let uu___4 =
                            let uu___5 =
                              let uu___6 =
                              ...
                              FStar_Pprint.prefix (Prims.of_int 2)
                                ...
                                uu___6 in
                            [uu___5] in
                          (FStarC_Errors_Msg.text "Tactics admitted goal.")
                            :: uu___4 in
...
let fresh (uu___ : unit) : Prims.int FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic FStarC_Tactics_Monad.get)
                     ...
                     (fun uu___1 ->
                        (fun uu___1 ->
                           ...
                           Obj.magic
                             (FStarC_Class_Monad.return
                                FStarC_Tactics_Monad.monad_tac ()
                                (Obj.magic n))) uu___1))) uu___1))) uu___
let curms (uu___ : unit) : Prims.int FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     let uu___1 = FStarC_Time.get_time_of_day_ms () in
     Obj.magic
       (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          (Obj.magic uu___1))) uu___
let __tc (uu___1 : env) (uu___ : FStarC_Syntax_Syntax.term) :
                     ...
                     (fun uu___ ->
                        (fun uu___ ->
                           ...
                           Obj.magic
                             (FStarC_Class_Monad.return
                                FStarC_Tactics_Monad.monad_tac ()
                                (Obj.magic uu___1))) uu___))) uu___))) uu___1
    uu___
                           ...
                           let e1 =
                             {
                               ...
                               FStarC_TypeChecker_Env.letrecs = [];
                               FStarC_TypeChecker_Env.rec_names =
                                 (e.FStarC_TypeChecker_Env.rec_names);
                               FStarC_TypeChecker_Env.top_level =
                               ...
                               FStarC_TypeChecker_Env.disc_proj_tab =
                                 (e.FStarC_TypeChecker_Env.disc_proj_tab);
                               FStarC_TypeChecker_Env.erasable_types_tab =
                               ...
                               FStarC_TypeChecker_Env.iface_val_lids =
                                 (e.FStarC_TypeChecker_Env.iface_val_lids)
                             } in
                           let uu___1 =
                           ...
                           | (t1, lc, g) ->
                               Obj.magic
                                 (FStarC_Class_Monad.return
                                    ...
                                    (Obj.magic
                                       (t1,
                                         (FStarC_Syntax_Util.comp_result lc),
                                         g)))) uu___))) uu___))) uu___1 uu___
                           ...
                           let uu___2 =
                             ...
                             FStarC_Class_Show.show
                               (FStarC_Class_Show.show_list
                                  FStarC_Syntax_Print.showable_binder) uu___3 in
                           FStarC_Format.print2
                           ...
                           let e2 =
                             {
                               ...
                               FStarC_TypeChecker_Env.letrecs = [];
                               FStarC_TypeChecker_Env.rec_names =
                                 (e1.FStarC_TypeChecker_Env.rec_names);
                               FStarC_TypeChecker_Env.top_level =
                               ...
                               FStarC_TypeChecker_Env.disc_proj_tab =
                                 (e1.FStarC_TypeChecker_Env.disc_proj_tab);
                               FStarC_TypeChecker_Env.erasable_types_tab =
                               ...
                               FStarC_TypeChecker_Env.iface_val_lids =
                                 (e1.FStarC_TypeChecker_Env.iface_val_lids)
                             } in
                           let uu___1 =
         ...
         (fun uu___2 ->
            (fun uu___2 ->
               ...
               | (uu___3, lc, uu___4) ->
                   Obj.magic
                     (FStarC_Class_Monad.return
                        FStarC_Tactics_Monad.monad_tac () (Obj.magic lc)))
              uu___2)) in
  FStarC_Tactics_Monad.wrap_err "tcc" uu___
let tc (e : env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Reflection_V2_Data.typ FStarC_Tactics_Monad.tac=
  let uu___ =
      ...
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
         ...
         (fun uu___2 ->
            (fun c ->
               ...
               Obj.magic
                 (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
                    (Obj.magic (FStarC_Syntax_Util.comp_result c)))) uu___2)) in
               ...
               (fun ps ->
                  ...
                  | uu___::uu___1 ->
                      let uu___2 =
                        ...
                        FStarC_Tactics_Monad.divide Prims.int_one tau uu___3 in
                      Obj.magic
                        (FStarC_Class_Monad.op_let_Bang
                           FStarC_Tactics_Monad.monad_tac () ()
                           (Obj.magic uu___2)
                 ...
                 uu___))) uu___
let seq (t1 : unit FStarC_Tactics_Monad.tac)
  (t2 : unit FStarC_Tactics_Monad.tac) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () () t1
      (fun uu___1 ->
         (fun uu___1 ->
            let uu___1 = Obj.magic uu___1 in
...
let should_check_goal_uvar (g : FStarC_Tactics_Types.goal) :
  FStarC_Syntax_Syntax.should_check_uvar=
  FStarC_Syntax_Util.ctx_uvar_should_check
    g.FStarC_Tactics_Types.goal_ctx_uvar
let bnorm_and_replace (g : FStarC_Tactics_Types.goal) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ = bnorm_goal g in FStarC_Tactics_Monad.replace_cur uu___
let bv_to_binding (bv : FStarC_Syntax_Syntax.bv) :
...
let binder_to_binding (b : FStarC_Syntax_Syntax.binder) :
  FStarC_Reflection_V2_Data.binding=
  bv_to_binding b.FStarC_Syntax_Syntax.binder_bv
let binding_to_string (b : FStarC_Reflection_V2_Data.binding) : Prims.string=
  let uu___ =
    let uu___1 =
      FStarC_Class_Show.show FStarC_Class_Show.showable_int
        b.FStarC_Reflection_V2_Data.uniq1 in
    Prims.strcat "#" uu___1 in
  Prims.strcat (FStarC_Sealed.unseal b.FStarC_Reflection_V2_Data.ppname3)
    uu___
let binding_to_bv (b : FStarC_Reflection_V2_Data.binding) :
  FStarC_Syntax_Syntax.bv=
  {
    FStarC_Syntax_Syntax.ppname =
      (FStarC_Ident.mk_ident
         ((FStarC_Sealed.unseal b.FStarC_Reflection_V2_Data.ppname3),
           FStarC_Range_Type.dummyRange));
    FStarC_Syntax_Syntax.index = (b.FStarC_Reflection_V2_Data.uniq1);
    FStarC_Syntax_Syntax.sort = (b.FStarC_Reflection_V2_Data.sort3)
  }
let binding_to_binder (b : FStarC_Reflection_V2_Data.binding) :
  FStarC_Syntax_Syntax.binder=
  let bv = binding_to_bv b in FStarC_Syntax_Syntax.mk_binder bv
let arrow_one (env1 : FStarC_TypeChecker_Env.env)
  ...
  | FStar_Pervasives_Native.Some (b, c) ->
      let uu___1 = FStarC_TypeChecker_Core.open_binders_in_comp env1 [b] c in
      (match uu___1 with
       | (env2, b1::[], c1) -> FStar_Pervasives_Native.Some (env2, b1, c1))
let arrow_one_whnf (env1 : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) :
  (FStarC_TypeChecker_Env.env * FStarC_Syntax_Syntax.binder *
    FStarC_Syntax_Syntax.comp) FStar_Pervasives_Native.option=
         ...
         (fun uu___2 ->
            (fun goal ->
               ...
               let uu___2 =
                 ...
                 arrow_one_whnf (FStarC_Tactics_Types.goal_env goal) uu___3 in
               match uu___2 with
                              ...
                              (fun uu___4 ->
                                 ...
                                 | (body, ctx_uvar) ->
                                     let sol =
                                       ...
                                       FStarC_Syntax_Util.abs [b] body uu___5 in
            ...
            (fun goal ->
               ...
               | (bs, c) ->
                   let uu___2 =
                     ...
                     then
                       let uu___3 = FStarC_List.splitAt max bs in
                       match uu___3 with
                       | (bs0, bs1) ->
                           let c1 =
                    ...
                    | (bs1, c1) ->
                        let uu___3 =
                          FStarC_TypeChecker_Core.open_binders_in_comp
                            (FStarC_Tactics_Types.goal_env goal) bs1 c1 in
                        (match uu___3 with
                         | (env', bs2, c2) ->
                             let uu___4 =
                               let uu___5 =
             ...
             (fun goal ->
                ...
                (let uu___3 =
                   let uu___4 =
                     ...
                     whnf (FStarC_Tactics_Types.goal_env goal) uu___5 in
                   arrow_one (FStarC_Tactics_Types.goal_env goal) uu___4 in
                 match uu___3 with
                 | FStar_Pervasives_Native.Some (env', b, c) ->
                     Obj.magic
                       (Obj.repr
                                                   ...
                                                   let uu___8 =
                                                     let uu___9 =
                                                       FStarC_Tactics_Types.goal_witness
                                                         goal in
                                                     uu___9.FStarC_Syntax_Syntax.pos in
                 ...
                 | FStar_Pervasives_Native.None ->
                     Obj.magic
                       (Obj.repr
                          (let uu___4 =
                             let uu___5 = FStarC_Tactics_Types.goal_type goal in
                             tts (FStarC_Tactics_Types.goal_env goal) uu___5 in
                           fail1 "intro_rec: goal is not an arrow (%s)"
                             uu___4)))) uu___1))) uu___
let norm (s : FStarC_NormSteps.norm_step Prims.list) :
  unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
               ...
               (FStarC_Tactics_Monad.if_verbose
                  (fun uu___ ->
                     let uu___1 =
                       let uu___2 = FStarC_Tactics_Types.goal_witness goal in
                       FStarC_Class_Show.show
                         FStarC_Syntax_Print.showable_term uu___2 in
                     ...
                     let steps =
                       ...
                       FStarC_List.op_At
                         ...
                         FStarC_TypeChecker_Env.DontUnfoldAttr
                           [FStarC_Parser_Const.tac_opaque_attr]] uu___1 in
                     let t =
                       let uu___1 = FStarC_Tactics_Types.goal_type goal in
                       normalize steps (FStarC_Tactics_Types.goal_env goal)
                         uu___1 in
                     let uu___1 = FStarC_Tactics_Monad.goal_with_type goal t in
                     Obj.magic (FStarC_Tactics_Monad.replace_cur uu___1))
                    uu___))) uu___)
let __norm_term_env (well_typed : Prims.bool) (e : env)
  (s : FStarC_NormSteps.norm_step Prims.list) (t : FStarC_Syntax_Syntax.term)
  : FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let norm_term_env (e : FStarC_TypeChecker_Env.env)
  (s : FStarC_NormSteps.norm_step Prims.list) (t : FStarC_Syntax_Syntax.term)
  : FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  __norm_term_env false e s t
let refl_norm_well_typed_term (e : FStarC_TypeChecker_Env.env)
  (s : FStarC_NormSteps.norm_step Prims.list) (t : FStarC_Syntax_Syntax.term)
  : FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  __norm_term_env true e s t
let refine_intro (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  let uu___1 =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___2 ->
         (fun g ->
            ...
            let uu___2 =
              let uu___3 = FStarC_Tactics_Types.goal_type g in
              FStarC_TypeChecker_Rel.base_and_refinement
                (FStarC_Tactics_Types.goal_env g) uu___3 in
            match uu___2 with
                  ...
                  let uu___4 =
                    let uu___5 =
                      FStarC_Syntax_Subst.open_term
                        [FStarC_Syntax_Syntax.mk_binder bv] phi in
                    match uu___5 with
                    | (bvs, phi1) ->
                        (((FStarC_List.hd bvs).FStarC_Syntax_Syntax.binder_bv),
                          phi1) in
                  match uu___4 with
                  | (bv1, phi1) ->
                      let uu___5 =
                          ...
                          let uu___7 =
                            let uu___8 =
                              let uu___9 =
                                ...
                                (bv1, uu___10) in
                              FStarC_Syntax_Syntax.NT uu___9 in
                            [uu___8] in
                          FStarC_Syntax_Subst.subst uu___7 phi1 in
                        let uu___7 =
                          let uu___8 = should_check_goal_uvar g in
                          FStar_Pervasives_Native.Some uu___8 in
                        FStarC_Tactics_Monad.mk_irrelevant_goal
                          "refine_intro refinement"
                          (FStarC_Tactics_Types.goal_env g) uu___6 uu___7
...
let __exact_now (set_expected_typ : Prims.bool)
  (t : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
       (fun goal ->
          ...
          let env1 =
            if set_expected_typ
            then
              let uu___ = FStarC_Tactics_Types.goal_type goal in
              FStarC_TypeChecker_Env.set_expected_typ
                (FStarC_Tactics_Types.goal_env goal) uu___
                           ...
                           (FStarC_Class_Monad.op_let_Bang
                              ...
                              (FStarC_Tactics_Monad.if_verbose
                                 (fun uu___2 ->
                                    ...
                                    let uu___4 =
                                      FStarC_TypeChecker_Rel.guard_to_string
                                        (FStarC_Tactics_Types.goal_env goal)
                                        guard in
                                    FStarC_Format.print2
                                 ...
                                 (fun uu___2 ->
                                    ...
                                    let uu___3 =
                                      ...
                                      proc_guard "__exact typing"
                                        (FStarC_Tactics_Types.goal_env goal)
                                        guard FStar_Pervasives_Native.None
                                                 ...
                                                 (FStarC_Class_Monad.op_let_Bang
                                                    ...
                                                    (fun uu___5 ->
                                                       (fun uu___5 ->
                                                         ...
                                                         uu___5))) uu___4)))
                                   uu___2))) uu___1))) uu___)
let t_exact (try_refine : Prims.bool) (set_expected_typ : Prims.bool)
  (tm : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (FStarC_Tactics_Monad.if_verbose
         (fun uu___1 ->
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            ...
            let uu___2 =
              ...
              FStarC_Tactics_Monad.catch uu___3 in
            Obj.magic
              (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac
                 () () (Obj.magic uu___2)
                 (fun uu___3 ->
                                ...
                                (fun uu___4 ->
                                   (fun uu___4 ->
                                      ...
                                      let uu___5 =
                                        let uu___6 =
                                          let uu___7 =
                                            norm [FStarC_NormSteps.Delta] in
                                          FStarC_Class_Monad.op_let_Bang
                                            FStarC_Tactics_Monad.monad_tac ()
                                            () uu___7
                                            (fun uu___8 ->
                                                          ...
                                                          (fun uu___10 ->
                                                             ...
                                                             Obj.magic
                                                               (__exact_now
                                                                  ...
                                                                  tm))
                                                            uu___10))) uu___8) in
                                        FStarC_Tactics_Monad.catch uu___6 in
                                      Obj.magic
                                        (FStarC_Class_Monad.op_let_Bang
                                           FStarC_Tactics_Monad.monad_tac ()
                                           () (Obj.magic uu___5)
...
let try_unify_by_application
  (should_check :
    FStarC_Syntax_Syntax.should_check_uvar FStar_Pervasives_Native.option)
  (only_match : Prims.bool) (e : env) (ty1 : FStarC_Syntax_Syntax.term)
  (ty2 : FStarC_Syntax_Syntax.term) (rng : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.aqual *
    FStarC_Syntax_Syntax.ctx_uvar FStar_Pervasives_Native.option) Prims.list
    FStarC_Tactics_Monad.tac=
  let must_tot = true in
  let rec aux uu___2 uu___1 uu___ =
    (fun acc typedness_deps ty11 ->
       let r =
         if only_match
         then do_match must_tot e ty2 ty11
         else do_unify must_tot e ty2 ty11 in
       Obj.magic
         (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
            (Obj.magic r)
            (fun uu___ ->
               (fun uu___ ->
                  ...
                  then
                    Obj.magic
                      (Obj.repr
                         (FStarC_Class_Monad.return
                            FStarC_Tactics_Monad.monad_tac () (Obj.magic acc)))
                  else
                    Obj.magic
                      (Obj.repr
                         (let uu___1 = FStarC_Syntax_Util.arrow_one ty11 in
                          match uu___1 with
                          | FStar_Pervasives_Native.None ->
                              Obj.repr
                                (let uu___2 =
                                   let uu___3 =
                                     FStarC_Syntax_Subst.compress ty11 in
                                   uu___3.FStarC_Syntax_Syntax.n in
                                 match uu___2 with
                                 | FStarC_Syntax_Syntax.Tm_refine uu___3 ->
                                     let uu___4 =
                                       FStarC_Syntax_Util.unrefine ty11 in
                                     aux acc typedness_deps uu___4
                                 | FStarC_Syntax_Syntax.Tm_ascribed uu___3 ->
                                     let uu___4 =
                                       FStarC_Syntax_Util.unrefine ty11 in
                                     aux acc typedness_deps uu___4
                                 | uu___3 ->
  ...
  aux [] [] ty1
let apply_implicits_as_goals (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : FStarC_Tactics_Types.goal FStar_Pervasives_Native.option)
  (uu___ :
    (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.ctx_uvar) Prims.list)
  : FStarC_Tactics_Types.goal Prims.list Prims.list FStarC_Tactics_Monad.tac=
  (fun env1 gl imps ->
     let one_implicit_as_goal uu___ =
       (fun uu___ ->
          match uu___ with
          | (term, ctx_uvar) ->
              let uu___1 = FStarC_Syntax_Util.head_and_args_full term in
              (match uu___1 with
               | (hd, uu___2) ->
                   let uu___3 =
                    ...
                    | FStarC_Syntax_Syntax.Tm_uvar (ctx_uvar1, uu___4) ->
                        let gl1 =
                          ...
                          | FStar_Pervasives_Native.None ->
                              ...
                              FStarC_Tactics_Types.mk_goal env1 ctx_uvar1
  ...
  let uu___ =
    ...
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (FStarC_Tactics_Monad.if_verbose
         (fun uu___1 ->
            let uu___2 =
              FStarC_Class_Show.show FStarC_Class_Show.showable_bool uopt in
            let uu___3 =
...
let lemma_or_sq (c : FStarC_Syntax_Syntax.comp) :
  ...
  | (eff_name, res) ->
      ...
      then
        let uu___1 = FStarC_Syntax_Util.un_squash res in
        FStarC_Option.map (fun post -> (FStarC_Syntax_Util.t_true, post))
          uu___1
      else FStar_Pervasives_Native.None
let t_apply_lemma (noinst : Prims.bool) (noinst_lhs : Prims.bool)
  (tm : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    let uu___1 =
      FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                                                              ...
                                                              (match uu___8
                                                               ...
                                                               | FStar_Pervasives_Native.None
                                                                   ...
                                                                   let uu___9
                                                                    ...
                                                                    Prims.int_one
                                                                    (FStarC_Errors_Msg.text
                                                                    "Term to apply has computation type:")
                                                                    uu___11 in
                                                                    [uu___10;
                                                                    FStarC_Errors_Msg.text
                                                               ...
                                                               | FStar_Pervasives_Native.Some
                                                                   ...
                                                                   Obj.magic
                                                                    ...
                                                                    let uu___20
                                                                    =
                                                                    FStarC_TypeChecker_Rel.simplify_vc
                                                                    false
                                                                    env1 pre1 in
                                                                    FStarC_TypeChecker_Env.check_trivial
                                                                    uu___20 in
                                                                    match uu___19
                                                                    with
                                                                    | 
...
let split_env (bvar : FStarC_Syntax_Syntax.bv) (e : env) :
  (env * FStarC_Syntax_Syntax.bv * FStarC_Syntax_Syntax.bv Prims.list)
    FStar_Pervasives_Native.option=
  let rec aux e1 =
    match FStarC_TypeChecker_Env.pop_bv e1 with
    | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
    | FStar_Pervasives_Native.Some (bv', e') ->
        if FStarC_Syntax_Syntax.bv_eq bvar bv'
        then FStar_Pervasives_Native.Some (e', bv', [])
        else
          (let uu___ = aux e' in
           FStarC_Option.map
             (fun uu___1 ->
                match uu___1 with | (e'', bv, bvs) -> (e'', bv, (bv' :: bvs)))
             uu___) in
  let uu___ = aux e in
  FStarC_Option.map
    (fun uu___1 ->
       match uu___1 with | (e', bv, bvs) -> (e', bv, (FStarC_List.rev bvs)))
    uu___
let rewrite (hh : FStarC_Reflection_V2_Data.binding) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
              ...
              (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac
                 ...
                 (fun uu___1 ->
                    (fun uu___1 ->
                       let uu___1 = Obj.magic uu___1 in
                       let uu___2 =
                         split_env bv (FStarC_Tactics_Types.goal_env goal) in
                       match uu___2 with
                       | FStar_Pervasives_Native.None ->
                           Obj.magic
                             (FStarC_Tactics_Monad.fail
                       ...
                       | FStar_Pervasives_Native.Some (e0, bv1, bvs) ->
                           ...
                           (match uu___3 with
                            | FStar_Pervasives_Native.Some (x, e) ->
                                let uu___4 =
                                  let uu___5 = FStarC_Syntax_Subst.compress x in
                                  uu___5.FStarC_Syntax_Syntax.n in
                                (match uu___4 with
                                 | FStarC_Syntax_Syntax.Tm_name x1 ->
                                     ...
                                     let uu___5 =
                                       let uu___6 =
                                         FStarC_Syntax_Subst.subst_binders s
                                           bs in
                                       let uu___7 =
                                         FStarC_Syntax_Subst.subst s t in
                                       (uu___6, uu___7) in
                                     (match uu___5 with
                                      | (bs', t') ->
                                          let e01 =
                            ...
                            | uu___4 ->
                                Obj.magic
                                  (FStarC_Tactics_Monad.fail
                                     "Not an equality hypothesis"))) uu___1)))
           uu___1) in
  FStarC_Tactics_Monad.wrap_err "rewrite" uu___
let replace (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term)
  (s : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term=
  FStarC_Syntax_Visit.visit_term false
    (fun t ->
       let uu___ = FStarC_Syntax_Util.term_eq t t1 in if uu___ then t2 else t)
    s
let grewrite (t1 : FStarC_Syntax_Syntax.term)
  (t2 : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    let uu___1 =
      FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
        (Obj.magic FStarC_Tactics_Monad.cur_goal)
                                                        ...
                                                        (let uu___9 =
                                                           let uu___10 =
                                                             ...
                                                             uu___11 ::
                                                               uu___12 in
                                                           (FStarC_Errors_Msg.text
                                                              "Types do not match for grewrite")
                                                             :: uu___10 in
                                                         Obj.magic
                                                           (FStarC_Tactics_Monad.fail_doc
                                                              uu___9)))
...
let rename_to (b : FStarC_Reflection_V2_Data.binding) (s : Prims.string) :
  FStarC_Reflection_V2_Data.binding FStarC_Tactics_Monad.tac=
  let subst_goal uu___2 uu___1 uu___ =
    (fun b1 b2 g ->
       let uu___ = split_env b1 (FStarC_Tactics_Types.goal_env g) in
       match uu___ with
       | FStar_Pervasives_Native.Some (e0, b11, bvs) ->
           ...
           let subst =
             let uu___1 =
               let uu___2 =
                 let uu___3 = FStarC_Syntax_Syntax.bv_to_name b2 in
                 (b11, uu___3) in
           ...
           let new_env =
             FStarC_TypeChecker_Env.push_binders e0
               ((FStarC_Syntax_Syntax.mk_binder b2) :: bs') in
           let uu___1 =
             let uu___2 =
               let uu___3 = should_check_goal_uvar g in
               FStar_Pervasives_Native.Some uu___3 in
             let uu___3 = FStarC_Tactics_Monad.goal_typedness_deps g in
             FStarC_Tactics_Monad.new_uvar "subst_goal" new_env t' uu___2
               uu___3 (rangeof g) in
           Obj.magic
             (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac
                () () (Obj.magic uu___1)
                (fun uu___2 ->
                   (fun uu___2 ->
                      ...
                      | (uvt, uv) ->
                          let goal' =
                            FStarC_Tactics_Types.mk_goal new_env uv
                              g.FStarC_Tactics_Types.opts
                              g.FStarC_Tactics_Types.is_guard
                              g.FStarC_Tactics_Types.label in
                          let uu___3 = set_solution g uvt in
                          Obj.magic
                            (FStarC_Class_Monad.op_let_Bang
                               FStarC_Tactics_Monad.monad_tac () () uu___3
                               (fun uu___4 ->
       ...
       | FStar_Pervasives_Native.None ->
           Obj.magic
             (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
                (Obj.magic FStar_Pervasives_Native.None))) uu___2 uu___1
      uu___ in
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                          ...
                          | FStar_Pervasives_Native.Some goal1 ->
                              Obj.magic
                                (Obj.repr
                                   (FStarC_Class_Monad.op_let_Bang
                                      FStarC_Tactics_Monad.monad_tac () ()
                                      (FStarC_Tactics_Monad.replace_cur goal1)
                                      (fun uu___3 ->
                                         (fun uu___3 ->
                                            let uu___3 = Obj.magic uu___3 in
                                            Obj.magic
                                                 ...
                                                 (Obj.magic
                                                    {
                                                      ...
                                                      FStarC_Reflection_V2_Data.ppname3
                                                        =
                                                        (FStarC_Sealed.seal s)
                                                    }))) uu___3)))) uu___2)))
              uu___1)) in
  FStarC_Tactics_Monad.wrap_err "rename_to" uu___
let var_retype (b : FStarC_Reflection_V2_Data.binding) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___1 ->
         (fun goal ->
            let goal = Obj.magic goal in
            let bv = binding_to_bv b in
            let uu___1 = split_env bv (FStarC_Tactics_Types.goal_env goal) in
            match uu___1 with
            | FStar_Pervasives_Native.None ->
                Obj.magic
                  (FStarC_Tactics_Monad.fail
...
let norm_binding_type (s : FStarC_NormSteps.norm_step Prims.list)
  (b : FStarC_Reflection_V2_Data.binding) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___1 ->
         (fun goal ->
            ...
            | FStar_Pervasives_Native.Some (e0, bv1, bvs) ->
                let steps =
                  let uu___2 = FStarC_TypeChecker_Cfg.translate_norm_steps s in
                  FStarC_List.op_At
                    [FStarC_TypeChecker_Env.Reify;
                    FStarC_TypeChecker_Env.DontUnfoldAttr
                ...
                Obj.magic (FStarC_Tactics_Monad.replace_cur uu___2)) uu___1) in
  FStarC_Tactics_Monad.wrap_err "norm_binding_type" uu___
let revert (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___1 ->
       (fun goal ->
          let goal = Obj.magic goal in
          match FStarC_TypeChecker_Env.pop_bv
                  (FStarC_Tactics_Types.goal_env goal)
          with
          | FStar_Pervasives_Native.None ->
              Obj.magic
          ...
          | FStar_Pervasives_Native.Some (x, env') ->
              let typ' =
                ...
                FStarC_Syntax_Util.arrow [FStarC_Syntax_Syntax.mk_binder x]
                  uu___1 in
              let uu___1 =
                let uu___2 =
                  let uu___3 = should_check_goal_uvar goal in
                  FStar_Pervasives_Native.Some uu___3 in
                let uu___3 = FStarC_Tactics_Monad.goal_typedness_deps goal in
                FStarC_Tactics_Monad.new_uvar "revert" env' typ' uu___2
                  uu___3 (rangeof goal) in
              Obj.magic
                (FStarC_Class_Monad.op_let_Bang
                   FStarC_Tactics_Monad.monad_tac () () (Obj.magic uu___1)
                   (fun uu___2 ->
                             ...
                             let uu___3 =
                               let uu___4 =
                                 ...
                                 let uu___6 =
                                   let uu___7 =
                                     FStarC_Tactics_Types.goal_type goal in
                                   uu___7.FStarC_Syntax_Syntax.pos in
                                 FStarC_Syntax_Syntax.mk_Tm_app r uu___5
                                   uu___6 in
                               set_solution goal uu___4 in
                             Obj.magic
                               (FStarC_Class_Monad.op_let_Bang
                                  FStarC_Tactics_Monad.monad_tac () () uu___3
                                  (fun uu___4 ->
...
let free_in (bv : FStarC_Syntax_Syntax.bv) (t : FStarC_Syntax_Syntax.term) :
  Prims.bool=
  let uu___ = FStarC_Syntax_Free.names t in
  FStarC_Class_Setlike.mem
    (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv) bv uu___
let clear (b : FStarC_Reflection_V2_Data.binding) :
  unit FStarC_Tactics_Monad.tac=
  let bv = binding_to_bv b in
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
       ...
       (fun goal ->
          ...
          Obj.magic
            (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac ()
               ...
               (FStarC_Tactics_Monad.if_verbose
                  (fun uu___ ->
                     let uu___1 = binding_to_string b in
                     let uu___2 =
                       let uu___3 =
                         let uu___4 =
                                       ...
                                       let uu___5 =
                                         ...
                                         let uu___8 =
                                           FStarC_Tactics_Monad.goal_typedness_deps
                                             goal in
                                         FStarC_Tactics_Monad.new_uvar
                                           "clear.witness" env' uu___6 uu___7
                                           uu___8 (rangeof goal) in
                                       Obj.magic
                                         (FStarC_Class_Monad.op_let_Bang
                                            FStarC_Tactics_Monad.monad_tac ()
                                            ...
                                            (fun uu___6 ->
                                               (fun uu___6 ->
                                                 ...
                                                 uu___6))) uu___4)))) uu___)))
         uu___)
let clear_top (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___1 ->
       (fun goal ->
          ...
          | FStar_Pervasives_Native.Some (x, uu___1) ->
              let uu___2 = bv_to_binding x in Obj.magic (clear uu___2))
         uu___1)
let prune (s : Prims.string) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
       (fun g ->
          ...
          let ctx' =
            FStarC_TypeChecker_Env.rem_proof_ns ctx
              (FStarC_Ident.path_of_text s) in
          let g' = FStarC_Tactics_Types.goal_with_env g ctx' in
          Obj.magic (FStarC_Tactics_Monad.replace_cur g')) uu___)
let addns (s : Prims.string) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
       (fun g ->
          ...
          let ctx = FStarC_Tactics_Types.goal_env g in
          let ctx' =
            FStarC_TypeChecker_Env.add_proof_ns ctx
              (FStarC_Ident.path_of_text s) in
          let g' = FStarC_Tactics_Types.goal_with_env g ctx' in
          Obj.magic (FStarC_Tactics_Monad.replace_cur g')) uu___)
let guard_formula (g : FStarC_TypeChecker_Common.guard_t) :
...
let _t_trefl (allow_guards : Prims.bool) (l : FStarC_Syntax_Syntax.term)
  (r : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let should_register_trefl g =
    ...
    then skip_register
      ...
      (let is_uvar_untyped_or_already_checked u =
         ...
         | FStarC_Syntax_Syntax.Allow_untyped uu___1 -> true
       ...
       let is_uvar t =
         ...
         let uu___1 =
           ...
           uu___2.FStarC_Syntax_Syntax.n in
         match uu___1 with
         | FStarC_Syntax_Syntax.Tm_uvar (u, uu___2) ->
             FStar_Pervasives.Inl (u, head, t)
         | uu___2 -> FStar_Pervasives.Inr t in
       let is_allow_untyped_uvar t =
         let uu___1 = is_uvar t in
         match uu___1 with
         | FStar_Pervasives.Inr uu___2 -> false
         | FStar_Pervasives.Inl (u, uu___2, uu___3) ->
             is_uvar_untyped_or_already_checked u in
       let t =
         FStarC_Syntax_Util.ctx_uvar_typ g.FStarC_Tactics_Types.goal_ctx_uvar in
       ...
       then skip_register
         ...
         (let uu___2 =
            let t1 =
              let uu___3 = FStarC_Syntax_Util.un_squash t in
              match uu___3 with
          ...
          | (head, args) ->
              ...
              (match uu___3 with
               | (FStarC_Syntax_Syntax.Tm_fvar fv,
                  (ty, uu___4)::(t1, uu___5)::(t2, uu___6)::[]) when
                   FStarC_Syntax_Syntax.fv_eq_lid fv
                     FStarC_Parser_Const.eq2_lid
                   ->
                   let uu___7 =
                     let uu___8 = is_allow_untyped_uvar t1 in
                     if uu___8 then true else is_allow_untyped_uvar t2 in
                   if uu___7
                   then skip_register
                   else
                     (let uu___8 =
                        FStarC_Tactics_Monad.is_goal_safe_as_well_typed g in
                      if uu___8
                      then
                        let check_uvar_subtype u t3 =
                          let env1 =
                            ...
                            {
                              FStarC_TypeChecker_Env.solver =
                                (uu___9.FStarC_TypeChecker_Env.solver);
                              FStarC_TypeChecker_Env.range =
                                (uu___9.FStarC_TypeChecker_Env.range);
                              FStarC_TypeChecker_Env.curmodule =
                                (uu___9.FStarC_TypeChecker_Env.curmodule);
                              FStarC_TypeChecker_Env.gamma =
                                ((g.FStarC_Tactics_Types.goal_ctx_uvar).FStarC_Syntax_Syntax.ctx_uvar_gamma);
                              FStarC_TypeChecker_Env.gamma_sig =
                                (uu___9.FStarC_TypeChecker_Env.gamma_sig);
                              FStarC_TypeChecker_Env.gamma_cache =
                                (uu___9.FStarC_TypeChecker_Env.gamma_cache);
                              FStarC_TypeChecker_Env.modules =
                                (uu___9.FStarC_TypeChecker_Env.modules);
                              FStarC_TypeChecker_Env.expected_typ =
                                (uu___9.FStarC_TypeChecker_Env.expected_typ);
                              FStarC_TypeChecker_Env.sigtab =
                                (uu___9.FStarC_TypeChecker_Env.sigtab);
                              FStarC_TypeChecker_Env.attrtab =
                                (uu___9.FStarC_TypeChecker_Env.attrtab);
                              FStarC_TypeChecker_Env.instantiate_imp =
                                (uu___9.FStarC_TypeChecker_Env.instantiate_imp);
                              FStarC_TypeChecker_Env.effects =
                                (uu___9.FStarC_TypeChecker_Env.effects);
                              FStarC_TypeChecker_Env.generalize =
                                (uu___9.FStarC_TypeChecker_Env.generalize);
                              FStarC_TypeChecker_Env.letrecs =
                                (uu___9.FStarC_TypeChecker_Env.letrecs);
                              FStarC_TypeChecker_Env.rec_names =
                                (uu___9.FStarC_TypeChecker_Env.rec_names);
                              FStarC_TypeChecker_Env.top_level =
                                (uu___9.FStarC_TypeChecker_Env.top_level);
                              FStarC_TypeChecker_Env.check_uvars =
                                (uu___9.FStarC_TypeChecker_Env.check_uvars);
                              FStarC_TypeChecker_Env.use_eq_strict =
                                (uu___9.FStarC_TypeChecker_Env.use_eq_strict);
                              FStarC_TypeChecker_Env.is_iface =
                                (uu___9.FStarC_TypeChecker_Env.is_iface);
                              FStarC_TypeChecker_Env.admit =
                                (uu___9.FStarC_TypeChecker_Env.admit);
                              FStarC_TypeChecker_Env.phase1 =
                                (uu___9.FStarC_TypeChecker_Env.phase1);
                              FStarC_TypeChecker_Env.failhard =
                                (uu___9.FStarC_TypeChecker_Env.failhard);
                              FStarC_TypeChecker_Env.flychecking =
                                (uu___9.FStarC_TypeChecker_Env.flychecking);
                              FStarC_TypeChecker_Env.uvar_subtyping =
                                (uu___9.FStarC_TypeChecker_Env.uvar_subtyping);
                              FStarC_TypeChecker_Env.intactics =
                                (uu___9.FStarC_TypeChecker_Env.intactics);
                              FStarC_TypeChecker_Env.nocoerce =
                                (uu___9.FStarC_TypeChecker_Env.nocoerce);
                              FStarC_TypeChecker_Env.tc_term =
                                (uu___9.FStarC_TypeChecker_Env.tc_term);
                              FStarC_TypeChecker_Env.typeof_tot_or_gtot_term
                                =
                                (uu___9.FStarC_TypeChecker_Env.typeof_tot_or_gtot_term);
                              FStarC_TypeChecker_Env.universe_of =
                                (uu___9.FStarC_TypeChecker_Env.universe_of);
                              FStarC_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term
                                =
                                (uu___9.FStarC_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term);
                              FStarC_TypeChecker_Env.teq_nosmt_force =
                                (uu___9.FStarC_TypeChecker_Env.teq_nosmt_force);
                              FStarC_TypeChecker_Env.subtype_nosmt_force =
                                (uu___9.FStarC_TypeChecker_Env.subtype_nosmt_force);
                              FStarC_TypeChecker_Env.qtbl_name_and_index =
                                (uu___9.FStarC_TypeChecker_Env.qtbl_name_and_index);
                              FStarC_TypeChecker_Env.fv_delta_depths =
                                (uu___9.FStarC_TypeChecker_Env.fv_delta_depths);
                              FStarC_TypeChecker_Env.proof_ns =
                                (uu___9.FStarC_TypeChecker_Env.proof_ns);
                              FStarC_TypeChecker_Env.synth_hook =
                                (uu___9.FStarC_TypeChecker_Env.synth_hook);
                              FStarC_TypeChecker_Env.try_solve_implicits_hook
                                =
                                (uu___9.FStarC_TypeChecker_Env.try_solve_implicits_hook);
                              FStarC_TypeChecker_Env.splice =
                                (uu___9.FStarC_TypeChecker_Env.splice);
                              FStarC_TypeChecker_Env.mpreprocess =
                                (uu___9.FStarC_TypeChecker_Env.mpreprocess);
                              FStarC_TypeChecker_Env.postprocess =
                                (uu___9.FStarC_TypeChecker_Env.postprocess);
                              FStarC_TypeChecker_Env.identifier_info =
                                (uu___9.FStarC_TypeChecker_Env.identifier_info);
                              FStarC_TypeChecker_Env.tc_hooks =
                                (uu___9.FStarC_TypeChecker_Env.tc_hooks);
                              FStarC_TypeChecker_Env.dsenv =
                                (uu___9.FStarC_TypeChecker_Env.dsenv);
                              FStarC_TypeChecker_Env.nbe =
                                (uu___9.FStarC_TypeChecker_Env.nbe);
                              FStarC_TypeChecker_Env.strict_args_tab =
                                (uu___9.FStarC_TypeChecker_Env.strict_args_tab);
                              FStarC_TypeChecker_Env.disc_proj_tab =
                                (uu___9.FStarC_TypeChecker_Env.disc_proj_tab);
                              FStarC_TypeChecker_Env.erasable_types_tab =
                                (uu___9.FStarC_TypeChecker_Env.erasable_types_tab);
                              FStarC_TypeChecker_Env.enable_defer_to_tac =
                                (uu___9.FStarC_TypeChecker_Env.enable_defer_to_tac);
                              FStarC_TypeChecker_Env.unif_allow_ref_guards =
                                (uu___9.FStarC_TypeChecker_Env.unif_allow_ref_guards);
                              FStarC_TypeChecker_Env.erase_erasable_args =
                                (uu___9.FStarC_TypeChecker_Env.erase_erasable_args);
                              FStarC_TypeChecker_Env.core_check =
                                (uu___9.FStarC_TypeChecker_Env.core_check);
                              FStarC_TypeChecker_Env.missing_decl =
                              ...
                              FStarC_TypeChecker_Env.iface_val_lids =
                                (uu___9.FStarC_TypeChecker_Env.iface_val_lids)
                            } in
                          let uu___9 =
                            FStarC_TypeChecker_Core.compute_term_type env1 t3 in
                          match uu___9 with
                          | FStar_Pervasives.Inr uu___10 -> false
                          | FStar_Pervasives.Inl (uu___10, t_ty, guard) ->
                              (FStarC_TypeChecker_Core.commit_guard_and_tok_opt
                                 guard;
                               (let uu___12 =
                                ...
                                | uu___13 -> false)) in
                        let uu___9 =
                          let uu___10 = is_uvar t1 in
                          let uu___11 = is_uvar t2 in (uu___10, uu___11) in
                        match uu___9 with
                        | (FStar_Pervasives.Inl (u, uu___10, tu),
                           FStar_Pervasives.Inr uu___11) ->
                            let uu___12 = check_uvar_subtype u tu in
                            (if uu___12
                             then skip_register
                             else should_register)
                        | (FStar_Pervasives.Inr uu___10, FStar_Pervasives.Inl
                           (u, uu___11, tu)) ->
                            let uu___12 = check_uvar_subtype u tu in
                            (if uu___12
                             then skip_register
                             else should_register)
                        | uu___10 -> should_register
                      else should_register)
               | uu___4 -> should_register))) in
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___ ->
       (fun g ->
             ...
             (fun l1 r1 ->
                let uu___1 =
                  do_unify_maybe_guards allow_guards must_tot
                    (FStarC_Tactics_Types.goal_env g) l1 r1 in
                Obj.magic
                  (FStarC_Class_Monad.op_let_Bang
                     FStarC_Tactics_Monad.monad_tac () () (Obj.magic uu___1)
                     (fun uu___2 ->
                                 ...
                                 (FStarC_Class_Monad.op_let_Bang
                                    ...
                                    (fun uu___4 ->
                                       (fun uu___4 ->
                                         ...
                                         uu___4))) uu___2))) uu___2 uu___1 in
                                       ...
                                       | (ls, rs) ->
                                           Obj.magic
                                             (fail2
                                                ...
                                                ls rs))) uu___4)))) uu___2))))
         uu___)
let t_trefl (allow_guards : Prims.bool) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___1 ->
         (fun g ->
            ...
            let uu___1 =
              ...
              destruct_eq (FStarC_Tactics_Types.goal_env g) uu___2 in
            match uu___1 with
                ...
                let uu___2 =
                  let uu___3 =
                    let uu___4 =
                      ...
                      ttd (FStarC_Tactics_Types.goal_env g) uu___5 in
                    FStar_Pprint.op_Hat_Slash_Hat
                      (FStarC_Errors_Msg.text "Not an equality:") uu___4 in
                  [uu___3] in
                Obj.magic (FStarC_Tactics_Monad.fail_doc uu___2)) uu___1) in
  FStarC_Tactics_Monad.wrap_err "t_trefl" uu___
let dup (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.cur_goal)
    (fun uu___1 ->
       (fun g ->
                                              ...
                                              (fun uu___5 ->
                                                 ...
                                                 Obj.magic
                                                   (FStarC_Tactics_Monad.add_goals
                                                      [g'])) uu___5))) uu___4)))))
                    uu___2))) uu___1)
let longest_prefix (f : 'a -> 'a -> Prims.bool) (l1 : 'a Prims.list)
  (l2 : 'a Prims.list) : ('a Prims.list * 'a Prims.list * 'a Prims.list)=
  let rec aux acc l11 l21 =
    match (l11, l21) with
    | (x::xs, y::ys) ->
        let uu___ = f x y in
        if uu___ then aux (x :: acc) xs ys else (acc, (x :: xs), (y :: ys))
...
let eq_binding (b1 : FStarC_Syntax_Syntax.binding)
  (b2 : FStarC_Syntax_Syntax.binding) : Prims.bool= false
let join_goals (uu___1 : FStarC_Tactics_Types.goal)
  (uu___ : FStarC_Tactics_Types.goal) :
  ...
  (fun g1 g2 ->
     ...
     | FStar_Pervasives_Native.None ->
         Obj.magic
           (Obj.repr (FStarC_Tactics_Monad.fail "goal 1 is not irrelevant"))
         ...
         Obj.magic
           (Obj.repr
              (let uu___1 = FStarC_Tactics_Monad.get_phi g2 in
               ...
               | FStar_Pervasives_Native.None ->
                   Obj.repr
                     (FStarC_Tactics_Monad.fail "goal 2 is not irrelevant")
               | FStar_Pervasives_Native.Some phi2 ->
                   Obj.repr
                     (let gamma1 =
                      ...
                      let uu___2 =
                        longest_prefix eq_binding (FStarC_List.rev gamma1)
                          (FStarC_List.rev gamma2) in
                      match uu___2 with
                      | (gamma, r1, r2) ->
                          let t1 =
                            let uu___3 =
                              FStarC_TypeChecker_Env.binders_of_bindings
                                (FStarC_List.rev r1) in
                            close_forall_no_univs uu___3 phi1 in
                          let t2 =
                            let uu___3 =
                              FStarC_TypeChecker_Env.binders_of_bindings
                                (FStarC_List.rev r2) in
                          ...
                          let goal_sc =
                            let uu___3 =
                              ...
                              (uu___4, uu___5) in
                            match uu___3 with
                            | (FStarC_Syntax_Syntax.Allow_untyped reason1,
                               FStarC_Syntax_Syntax.Allow_untyped uu___4) ->
                                FStar_Pervasives_Native.Some
                                  (FStarC_Syntax_Syntax.Allow_untyped reason1)
                            | uu___4 -> FStar_Pervasives_Native.None in
                          let ng = FStarC_Syntax_Util.mk_conj t1 t2 in
                          let nenv =
                            let uu___3 = FStarC_Tactics_Types.goal_env g1 in
                            {
                              FStarC_TypeChecker_Env.solver =
                              ...
                              FStarC_TypeChecker_Env.rec_names =
                                (uu___3.FStarC_TypeChecker_Env.rec_names);
                              FStarC_TypeChecker_Env.top_level =
                              ...
                              FStarC_TypeChecker_Env.disc_proj_tab =
                                (uu___3.FStarC_TypeChecker_Env.disc_proj_tab);
                              FStarC_TypeChecker_Env.erasable_types_tab =
                              ...
                              FStarC_TypeChecker_Env.iface_val_lids =
                                (uu___3.FStarC_TypeChecker_Env.iface_val_lids)
                            } in
                          FStarC_Class_Monad.op_let_Bang
                            FStarC_Tactics_Monad.monad_tac () ()
                            (Obj.magic
                                               ...
                                               (FStarC_Class_Monad.op_let_Bang
                                                  ...
                                                  (fun uu___5 ->
                                                     (fun uu___5 ->
                                                       ...
                                                       uu___5))) uu___3)))
                                 uu___3))))) uu___1 uu___
let join (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___1 ->
       (fun ps ->
              ...
              Obj.magic
                (FStarC_Class_Monad.op_let_Bang
                   ...
                   (fun uu___1 ->
                      (fun uu___1 ->
                         let uu___1 = Obj.magic uu___1 in
                         let uu___2 = join_goals g1 g2 in
                         Obj.magic
                           (FStarC_Class_Monad.op_let_Bang
                              FStarC_Tactics_Monad.monad_tac () ()
                              (Obj.magic uu___2)
                              (fun uu___3 ->
                                 (fun g12 ->
                                   ...
                                   uu___3))) uu___1))
          | uu___1 ->
              Obj.magic (FStarC_Tactics_Monad.fail "join: less than 2 goals"))
         uu___1)
let set_options (s : Prims.string) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___1 ->
...
let top_env (uu___ : unit) :
  FStarC_TypeChecker_Env.env FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic FStarC_Tactics_Monad.get)
          (fun uu___1 ->
             (fun ps ->
               ...
               uu___1))) uu___
let lax_on (uu___ : unit) : Prims.bool FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic FStarC_Tactics_Monad.get)
                 ...
                 (FStarC_Class_Monad.op_let_Bang
                    ...
                    (fun uu___2 ->
                       (fun goal ->
                          ...
                          let env1 =
                            FStarC_TypeChecker_Env.set_expected_typ
                              (FStarC_Tactics_Types.goal_env goal) ty in
...
let uvar_env (env1 : env)
  (ty : FStarC_Syntax_Syntax.typ FStar_Pervasives_Native.option) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
               ...
               let uu___1 =
                 ...
                 | FStar_Pervasives_Native.Some ty1 ->
                     let env2 =
                       ...
                       FStarC_TypeChecker_Env.set_expected_typ env1 uu___2 in
                 ...
                 | FStar_Pervasives_Native.None ->
                     let uu___2 =
                       ...
                       FStarC_Tactics_Monad.new_uvar "uvar_env.2" env1 uu___3
                         FStar_Pervasives_Native.None []
...
let ghost_uvar_env (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Reflection_V2_Data.typ) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  (fun env1 ty ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let fresh_universe_uvar (uu___ : unit) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     let uu___1 =
       let uu___2 = FStarC_Syntax_Util.type_u () in
     ...
     Obj.magic
       (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          (Obj.magic uu___1))) uu___
let unshelve (t : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.get)
      (fun uu___1 ->
...
let tac_and (uu___1 : Prims.bool FStarC_Tactics_Monad.tac)
  (uu___ : Prims.bool FStarC_Tactics_Monad.tac) :
  Prims.bool FStarC_Tactics_Monad.tac=
  (fun t1 t2 ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
                  ...
                  Obj.magic
                    (Obj.repr
                       (FStarC_Class_Monad.return
                          FStarC_Tactics_Monad.monad_tac () (Obj.magic false))))
               uu___))) uu___1 uu___
let default_if_err (uu___1 : 'a) (uu___ : 'a FStarC_Tactics_Monad.tac) :
  'a FStarC_Tactics_Monad.tac=
  (fun def t ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic (FStarC_Tactics_Monad.catch t))
          (fun uu___ ->
             (fun r ->
                let r = Obj.magic r in
                match r with
                | FStar_Pervasives.Inl uu___ ->
                    Obj.magic
                      (FStarC_Class_Monad.return
                         FStarC_Tactics_Monad.monad_tac () (Obj.magic def))
                | FStar_Pervasives.Inr v ->
                    Obj.magic
                      (FStarC_Class_Monad.return
                         FStarC_Tactics_Monad.monad_tac () (Obj.magic v)))
               uu___))) uu___1 uu___
let match_env (e : env) (t1 : FStarC_Syntax_Syntax.term)
  (t2 : FStarC_Syntax_Syntax.term) : Prims.bool FStarC_Tactics_Monad.tac=
  let uu___ =
    let uu___1 =
      Obj.magic
        (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let unify_env (e : env) (t1 : FStarC_Syntax_Syntax.term)
  (t2 : FStarC_Syntax_Syntax.term) : Prims.bool FStarC_Tactics_Monad.tac=
  let uu___ =
    let uu___1 =
      Obj.magic
...
let unify_guard_env (e : env) (t1 : FStarC_Syntax_Syntax.term)
  (t2 : FStarC_Syntax_Syntax.term) : Prims.bool FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let launch_process (uu___2 : Prims.string) (uu___1 : Prims.string Prims.list)
  (uu___ : Prims.string) : Prims.string FStarC_Tactics_Monad.tac=
  (fun prog args input ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
             ...
             (fun uu___1 ->
                ...
                then
                  Obj.magic
                    (Obj.repr
                       (let s =
                          FStarC_Util.run_process "tactic_launch" prog args
                            (FStar_Pervasives_Native.Some input) in
                        FStarC_Class_Monad.return
                          FStarC_Tactics_Monad.monad_tac () (Obj.magic s)))
                else
                  Obj.magic
                    (Obj.repr
                       (FStarC_Tactics_Monad.fail
...
let fresh_bv_named (uu___ : Prims.string) :
  FStarC_Syntax_Syntax.bv FStarC_Tactics_Monad.tac=
  (fun nm ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
       ...
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                let uu___1 = Obj.magic uu___1 in
                let uu___2 =
                  FStarC_Syntax_Syntax.gen_bv nm FStar_Pervasives_Native.None
                    FStarC_Syntax_Syntax.tun in
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let change (ty : FStarC_Syntax_Syntax.typ) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (FStarC_Tactics_Monad.if_verbose
         (fun uu___1 ->
            ...
            Obj.magic
              (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac
                 ...
                 (fun uu___2 ->
                    (fun g ->
                       let g = Obj.magic g in
                       let uu___2 = __tc (FStarC_Tactics_Types.goal_env g) ty in
                       Obj.magic
                         (FStarC_Class_Monad.op_let_Bang
                            FStarC_Tactics_Monad.monad_tac () ()
                            (Obj.magic uu___2)
...
let failwhen (b : Prims.bool) (msg : Prims.string) :
  unit FStarC_Tactics_Monad.tac=
  if b
  then FStarC_Tactics_Monad.fail msg
  else
    FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac () (Obj.repr ())
let t_destruct (s_tm : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.fv * Prims.int) Prims.list FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
         (Obj.magic FStarC_Tactics_Monad.cur_goal)
         (fun uu___1 ->
            (fun g ->
               let g = Obj.magic g in
               let uu___1 = __tc (FStarC_Tactics_Types.goal_env g) s_tm in
               Obj.magic
                 (FStarC_Class_Monad.op_let_Bang
                    FStarC_Tactics_Monad.monad_tac () () (Obj.magic uu___1)
                    (fun uu___2 ->
...
let gather_explicit_guards_for_resolved_goals (uu___ : unit) :
  unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac () (Obj.repr ())
let rec last : 'a . 'a Prims.list -> 'a =
  fun l ->
    match l with
    | [] -> FStarC_Effect.failwith "last: empty list"
    | x::[] -> x
    | uu___::xs -> last xs
let rec init : 'a . 'a Prims.list -> 'a Prims.list =
  fun l ->
    match l with
    | [] -> FStarC_Effect.failwith "init: empty list"
    | x::[] -> []
    | x::xs -> let uu___ = init xs in x :: uu___
let lget (ty : FStarC_Syntax_Syntax.term) (k : Prims.string) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  let uu___ =
    Obj.magic
      (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
         ...
         (fun uu___1 ->
            (fun ps ->
               ...
               match FStarC_PSMap.try_find
                       ps.FStarC_Tactics_Types.local_state k
               with
               | FStar_Pervasives_Native.None ->
                   Obj.magic (FStarC_Tactics_Monad.fail "not found")
               | FStar_Pervasives_Native.Some t -> Obj.magic (unquote ty t))
              uu___1)) in
  FStarC_Tactics_Monad.wrap_err "lget" uu___
let lset (_ty : FStarC_Syntax_Syntax.term) (k : Prims.string)
  (t : FStarC_Syntax_Syntax.term) : unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.get)
            ...
            let ps1 =
              {
                ...
                FStarC_Tactics_Types.tac_verb_dbg =
                  (ps.FStarC_Tactics_Types.tac_verb_dbg);
                FStarC_Tactics_Types.local_state =
                  (FStarC_PSMap.add ps.FStarC_Tactics_Types.local_state k t);
                FStarC_Tactics_Types.urgency =
                  (ps.FStarC_Tactics_Types.urgency);
                FStarC_Tactics_Types.dump_on_failure =
                  (ps.FStarC_Tactics_Types.dump_on_failure)
...
let set_urgency (u : Prims.int) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___ ->
       (fun ps ->
          ...
          let ps1 =
            {
              ...
              FStarC_Tactics_Types.local_state =
                (ps.FStarC_Tactics_Types.local_state);
              FStarC_Tactics_Types.urgency = u;
              FStarC_Tactics_Types.dump_on_failure =
                (ps.FStarC_Tactics_Types.dump_on_failure)
            } in
          Obj.magic (FStarC_Tactics_Monad.set ps1)) uu___)
let set_dump_on_failure (b : Prims.bool) : unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___ ->
       (fun ps ->
          ...
          Obj.magic (FStarC_Tactics_Monad.set ps1)) uu___)
let t_commute_applied_match (uu___ : unit) : unit FStarC_Tactics_Monad.tac=
  let uu___1 =
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.cur_goal)
      (fun uu___2 ->
         (fun g ->
            ...
            let uu___2 =
              let uu___3 = FStarC_Tactics_Types.goal_type g in
              destruct_eq (FStarC_Tactics_Types.goal_env g) uu___3 in
            match uu___2 with
            | FStar_Pervasives_Native.Some (l, r) ->
                 ...
                 | (lh, las) ->
                     ...
                     (match uu___4 with
                      | FStarC_Syntax_Syntax.Tm_match
                          ...
                          let must_tot = true in
                          let uu___5 =
                            do_unify_maybe_guards false must_tot
                              (FStarC_Tactics_Types.goal_env g) l' r in
                          Obj.magic
                            (FStarC_Class_Monad.op_let_Bang
                               FStarC_Tactics_Monad.monad_tac () ()
                               (Obj.magic uu___5)
...
let string_to_term (e : FStarC_TypeChecker_Env.env) (s : Prims.string) :
  FStarC_Syntax_Syntax.term FStarC_Tactics_Monad.tac=
  let frag_of_text s1 =
    {
  ...
  | FStarC_Parser_ParseIt.Term t ->
      let dsenv =
        FStarC_Syntax_DsEnv.set_current_module e.FStarC_TypeChecker_Env.dsenv
          (FStarC_TypeChecker_Env.current_module e) in
      (try
         (fun uu___1 ->
            (fun uu___1 ->
               match () with
               | () ->
                   let uu___2 = FStarC_ToSyntax_ToSyntax.desugar_term dsenv t in
                   Obj.magic
                     (FStarC_Class_Monad.return
                        FStarC_Tactics_Monad.monad_tac () (Obj.magic uu___2)))
              uu___1) ()
       ...
       | uu___2 -> FStarC_Tactics_Monad.fail "string_to_term: Unknown error")
  ...
  | FStarC_Parser_ParseIt.ParseError (uu___1, err, uu___2) ->
      ...
      FStarC_Tactics_Monad.fail uu___3
let push_bv_dsenv (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : Prims.string) :
  (FStarC_TypeChecker_Env.env * FStarC_Reflection_V2_Data.binding)
    FStarC_Tactics_Monad.tac=
  (fun e i ->
     ...
     | (dsenv, bv) ->
         let uu___1 =
           ...
           ({
              FStarC_TypeChecker_Env.solver =
                (e.FStarC_TypeChecker_Env.solver);
              FStarC_TypeChecker_Env.range = (e.FStarC_TypeChecker_Env.range);
              FStarC_TypeChecker_Env.curmodule =
                (e.FStarC_TypeChecker_Env.curmodule);
              FStarC_TypeChecker_Env.gamma = (e.FStarC_TypeChecker_Env.gamma);
              FStarC_TypeChecker_Env.gamma_sig =
                (e.FStarC_TypeChecker_Env.gamma_sig);
              FStarC_TypeChecker_Env.gamma_cache =
                (e.FStarC_TypeChecker_Env.gamma_cache);
              ...
              FStarC_TypeChecker_Env.is_iface =
                (e.FStarC_TypeChecker_Env.is_iface);
              FStarC_TypeChecker_Env.admit = (e.FStarC_TypeChecker_Env.admit);
              FStarC_TypeChecker_Env.phase1 =
                (e.FStarC_TypeChecker_Env.phase1);
              FStarC_TypeChecker_Env.failhard =
                (e.FStarC_TypeChecker_Env.failhard);
...
let term_to_string (uu___ : FStarC_Syntax_Syntax.term) :
  Prims.string FStarC_Tactics_Monad.tac=
  (fun t ->
...
let comp_to_string (uu___ : FStarC_Syntax_Syntax.comp) :
  Prims.string FStarC_Tactics_Monad.tac=
  (fun c ->
     let uu___ = top_env () in
     Obj.magic
          ...
          (fun uu___1 ->
             (fun g ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic s))) uu___1))) uu___
let term_to_doc (uu___ : FStarC_Syntax_Syntax.term) :
  FStar_Pprint.document FStarC_Tactics_Monad.tac=
  (fun t ->
     let uu___ = top_env () in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun g ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic s))) uu___1))) uu___
let comp_to_doc (uu___ : FStarC_Syntax_Syntax.comp) :
  FStar_Pprint.document FStarC_Tactics_Monad.tac=
  (fun c ->
     let uu___ = top_env () in
     Obj.magic
          ...
          (fun uu___1 ->
             (fun g ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic s))) uu___1))) uu___
let range_to_string (uu___ : FStarC_Range_Type.t) :
  Prims.string FStarC_Tactics_Monad.tac=
  (fun r ->
     ...
     Obj.magic
       (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          (Obj.magic uu___))) uu___
let with_compat_pre_core (n : Prims.int) (f : 'a FStarC_Tactics_Monad.tac) :
  'a FStarC_Tactics_Monad.tac=
  FStarC_Tactics_Monad.mk_tac
    (fun ps ->
         ...
         (fun goal ->
            ...
            | FStar_Pervasives_Native.Some phi ->
                ...
                then
                  ...
                  Obj.magic
                    (FStarC_Tactics_Monad.fail "SMT did not solve this goal"))
           uu___1) in
  FStarC_Tactics_Monad.wrap_err "t_smt_sync" uu___
let free_uvars (uu___ : FStarC_Syntax_Syntax.term) :
  Prims.int Prims.list FStarC_Tactics_Monad.tac=
  (fun tm ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
                  ...
                  FStarC_List.map
                    (fun u ->
                       FStarC_Syntax_Unionfind.uvar_id
                         u.FStarC_Syntax_Syntax.ctx_uvar_head) uu___2 in
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uvs))) uu___1))) uu___
let all_ext_options (uu___ : unit) :
          ...
          (fun uu___2 ->
             (fun uu___2 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___3))) uu___2))) uu___
let ext_getv (uu___ : Prims.string) : Prims.string FStarC_Tactics_Monad.tac=
  (fun k ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let ext_enabled (uu___ : Prims.string) : Prims.bool FStarC_Tactics_Monad.tac=
  (fun k ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let ext_getns (uu___ : Prims.string) :
  (Prims.string * Prims.string) Prims.list FStarC_Tactics_Monad.tac=
  (fun ns ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
             ...
             (fun uu___1 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let alloc (uu___ : 'a) :
  'a FStarC_Tactics_Types.tref FStarC_Tactics_Monad.tac=
  (fun x ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let read (uu___ : 'a FStarC_Tactics_Types.tref) :
  'a FStarC_Tactics_Monad.tac=
  (fun r ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                Obj.magic
                  (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                     () (Obj.magic uu___2))) uu___1))) uu___
let write (r : 'a FStarC_Tactics_Types.tref) (x : 'a) :
  unit FStarC_Tactics_Monad.tac=
  let uu___ =
    FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac () (Obj.repr ()) in
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () () uu___
    (fun uu___1 ->
       (fun uu___1 ->
          let uu___1 = Obj.magic uu___1 in
          FStarC_Effect.op_Colon_Equals r x;
          Obj.magic
            (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.repr ()))) uu___1)
let splice_quals (uu___ : unit) :
...
let splice_attrs (uu___ : unit) :
  FStarC_Syntax_Syntax.attribute Prims.list FStarC_Tactics_Monad.tac=
  (fun uu___ ->
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic FStarC_Tactics_Monad.get)
...
type remaining_uvar_t =
  (FStarC_Syntax_Syntax.bv * FStarC_Reflection_V2_Data.typ)
...
type refl_guard_and_tok_t = (env * FStarC_TypeChecker_Core.guard_and_tok_t)
let dbg_refl (g : env) (msg : unit -> Prims.string) : unit=
  let uu___ = FStarC_Effect.op_Bang dbg_ReflTc in
  if uu___
  then let uu___1 = msg () in FStarC_Format.print_string uu___1
  else ()
let refl_typing_guard (e : env) (g : FStarC_TypeChecker_Core.guard_and_tok_t)
  : unit FStarC_Tactics_Monad.tac=
  let reason = "refl_typing_guard" in
  let uu___ = g in
  match uu___ with
  | (g1, tok) ->
      proc_guard_formula "refl_typing_guard" e g1
        (FStar_Pervasives_Native.Some tok) FStar_Pervasives_Native.None
        (FStarC_TypeChecker_Env.get_range e)
let uncurry (f : 'uuuuu -> 'uuuuu1 -> 'uuuuu2) (uu___ : ('uuuuu * 'uuuuu1)) :
  'uuuuu2= match uu___ with | (x, y) -> f x y
let exn_to_issue (e : Prims.exn) : FStarC_Errors.issue=
  let uu___ =
...
let __refl_typing_builtin_wrapper
  (uu___ : unit -> ('a * refl_guard_and_tok_t Prims.list)) :
  ('a FStar_Pervasives_Native.option * issues) FStarC_Tactics_Monad.tac=
  (fun f ->
     let tx = FStarC_Syntax_Unionfind.new_transaction () in
     let uu___ =
                                                            ...
                                                            | FStar_Pervasives_Native.Some
                                                                iss1 ->
                                                                {
                                                                  FStarC_Errors.issue_msg
                                                                    ...
                                                                    FStarC_List.op_At
                                                                    issue_msg
                                                                    iss1.FStarC_Errors.issue_msg);
                                                                  FStarC_Errors.issue_level
                                                                    =
                                                                    (
                                                                    iss1.FStarC_Errors.issue_level);
                                                                  FStarC_Errors.issue_range
                                                                    =
                                                                    (
                                                                    iss1.FStarC_Errors.issue_range);
                                                                  FStarC_Errors.issue_number
                                                                    =
                                                                    issue_number;
                                            ...
                                            (Obj.magic
                                               (FStar_Pervasives_Native.None,
                                                 (FStarC_List.op_At errs
                                                    guard_errs))))) uu___3)))
                   uu___1))) uu___
let catch_all (f : 'a FStarC_Tactics_Monad.tac) :
...
let refl_typing_builtin_wrapper (uu___1 : Prims.string)
  (uu___ : unit -> ('a * refl_guard_and_tok_t Prims.list)) :
  ('a FStar_Pervasives_Native.option * issues) FStarC_Tactics_Monad.tac=
  (fun label f ->
     let uu___ =
            ...
            (fun uu___2 ->
               (fun uu___2 ->
                  ...
                  | FStar_Pervasives.Inr r ->
                      Obj.magic
                        (FStarC_Class_Monad.return
                           FStarC_Tactics_Monad.monad_tac () (Obj.magic r)))
                 uu___2)) in
     Obj.magic
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          (Obj.magic uu___)
             ...
             (fun uu___1 ->
                ...
                | (o, errs) ->
                          ...
                          (fun is ->
                             {
                               FStarC_Errors.issue_msg =
                                 (FStarC_List.op_At
                                    is.FStarC_Errors.issue_msg
                                    [FStarC_Errors_Msg.text
                                       (Prims.strcat "Raised within Tactics."
                                          label)]);
                               FStarC_Errors.issue_level =
                    ...
                    Obj.magic
                      (FStarC_Class_Monad.return
                         FStarC_Tactics_Monad.monad_tac ()
                         (Obj.magic (o, errs1)))) uu___1))) uu___1 uu___
let no_uvars_in_term (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ =
...
let no_univ_uvars_in_term (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ = FStarC_Syntax_Free.univs t in
  FStarC_Class_Setlike.is_empty
    (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_univ_uvar) uu___
...
let uu___is_Subtyping (projectee : relation) : Prims.bool=
  match projectee with | Subtyping -> true | uu___ -> false
let uu___is_Equality (projectee : relation) : Prims.bool=
  match projectee with | Equality -> true | uu___ -> false
let unexpected_uvars_issue (r : FStarC_Range_Type.t) : FStarC_Errors.issue=
  let i =
    let uu___ =
      let uu___1 =
        FStarC_Errors.errno
      ...
      FStar_Pervasives_Native.Some uu___1 in
    {
      ...
      FStarC_Errors.issue_number = uu___;
      FStarC_Errors.issue_ctx = []
    } in
  i
let refl_is_non_informative (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Reflection_V2_Data.typ) : unit refl_tac=
  (fun g t ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term t else false in
     if uu___
     then
       Obj.magic
         (Obj.repr
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let refl_check_relation (uu___5 : relation) (uu___4 : Prims.bool)
  (uu___3 : Prims.bool) (uu___2 : env) (uu___1 : FStarC_Syntax_Syntax.typ)
  (uu___ : FStarC_Syntax_Syntax.typ) :
  (unit FStar_Pervasives_Native.option * issues) FStarC_Tactics_Monad.tac=
  (fun rel smt_ok unfolding_ok g t0 t1 ->
     let uu___ =
       let uu___1 =
         let uu___2 = no_uvars_in_g g in
         if uu___2 then no_uvars_in_term t0 else false in
       if uu___1 then no_uvars_in_term t1 else false in
     if uu___
     then
       Obj.magic
         (Obj.repr
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt3 "refl_check_relation: %s %s %s\n"
                         uu___4 (if rel = Subtyping then "<:?" else "=?=")
                         uu___5);
                  (let result =
                     if rel = Subtyping
                     then
                       FStarC_TypeChecker_Core.check_term_subtyping smt_ok
                         unfolding_ok g1 t0 t1
                     else
                       FStarC_TypeChecker_Core.check_term_equality smt_ok
                         unfolding_ok g1 t0 t1 in
                   match result with
                   | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                       (dbg_refl g1
                          (fun uu___4 ->
                   ...
                   | FStar_Pervasives.Inl (FStar_Pervasives_Native.Some
                       guard_f) ->
                       (dbg_refl g1
                          (fun uu___4 -> "refl_check_relation: succeeded\n");
                        ((), [(g1, guard_f)]))
                   | FStar_Pervasives.Inr err ->
                       (dbg_refl g1
                          (fun uu___4 ->
                        ...
                        (let uu___4 =
                           let uu___5 =
                             FStarC_TypeChecker_Core.print_error err in
                           Prims.strcat "check_relation failed: " uu___5 in
                         FStarC_Errors.raise_error
                           FStarC_TypeChecker_Env.hasRange_env g1
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
               ...
               (FStar_Pervasives_Native.None, uu___2) in
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___5 uu___4 uu___3 uu___2 uu___1 uu___
let refl_check_subtyping (g : env) (t0 : FStarC_Syntax_Syntax.typ)
  (t1 : FStarC_Syntax_Syntax.typ) : unit refl_tac=
  refl_check_relation Subtyping true true g t0 t1
let t_refl_check_equiv :
  Prims.bool ->
    Prims.bool ->
      FStarC_TypeChecker_Env.env ->
        FStarC_Reflection_V2_Data.typ ->
          FStarC_Reflection_V2_Data.typ -> unit refl_tac=
  refl_check_relation Equality
let to_must_tot (eff : FStarC_TypeChecker_Core.tot_or_ghost) : Prims.bool=
  match eff with
  | FStarC_TypeChecker_Core.E_Total -> true
  | FStarC_TypeChecker_Core.E_Ghost -> false
let tot_or_ghost_to_string (uu___ : FStarC_TypeChecker_Core.tot_or_ghost) :
  Prims.string=
  match uu___ with
  | FStarC_TypeChecker_Core.E_Total -> "E_Total"
  | FStarC_TypeChecker_Core.E_Ghost -> "E_Ghost"
let refl_norm_type (g : env) (t : FStarC_Syntax_Syntax.typ) :
  FStarC_Syntax_Syntax.typ=
  FStarC_TypeChecker_Normalize.normalize
    [FStarC_TypeChecker_Env.Beta;
    FStarC_TypeChecker_Env.Exclude FStarC_TypeChecker_Env.Zeta] g t
let refl_core_compute_term_type (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) :
  (FStarC_TypeChecker_Core.tot_or_ghost * FStarC_Reflection_V2_Data.typ)
    refl_tac=
  (fun g e ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term e else false in
     if uu___
     then
       Obj.magic
         (Obj.repr
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt1 "refl_core_compute_term_type: %s\n"
                         uu___4);
                  (let uu___3 =
                     FStarC_TypeChecker_Core.compute_term_type g1 e in
                   match uu___3 with
                   | FStar_Pervasives.Inl (eff, t, guard) ->
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let refl_core_check_term (uu___3 : FStarC_TypeChecker_Env.env)
  (uu___2 : FStarC_Syntax_Syntax.term)
  (uu___1 : FStarC_Reflection_V2_Data.typ)
  (uu___ : FStarC_TypeChecker_Core.tot_or_ghost) : unit refl_tac=
  (fun g e t eff ->
     let uu___ =
       let uu___1 =
         let uu___2 = no_uvars_in_g g in
         if uu___2 then no_uvars_in_term e else false in
       if uu___1 then no_uvars_in_term t else false in
     if uu___
     then
       Obj.magic
               ...
               (fun uu___1 ->
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       let uu___6 =
                         FStarC_Class_Show.show
                           FStarC_TypeChecker_Core.showable_tot_or_ghost eff in
                       FStarC_Format.fmt3
                         "refl_core_check_term: term: %s, type: %s, eff: %s\n"
                         uu___4 uu___5 uu___6);
                  (let must_tot = to_must_tot eff in
                   let uu___3 =
                     FStarC_TypeChecker_Core.check_term g1 e t must_tot in
                   match uu___3 with
                   | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                       (dbg_refl g1
                          (fun uu___5 ->
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
               ...
               (FStar_Pervasives_Native.None, uu___2) in
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___3 uu___2 uu___1 uu___
let refl_core_check_term_at_type (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : FStarC_Syntax_Syntax.term)
  (uu___ : FStarC_Reflection_V2_Data.typ) :
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt2
                         ...
                         uu___4 uu___5);
                  (let uu___3 =
                     FStarC_TypeChecker_Core.check_term_at_type g1 e t in
                   match uu___3 with
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
               ...
               (FStar_Pervasives_Native.None, uu___2) in
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___2 uu___1 uu___
let refl_tc_term (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * (FStarC_TypeChecker_Core.tot_or_ghost *
    FStarC_Reflection_V2_Data.typ)) refl_tac=
  (fun g e ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term e else false in
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt2 "refl_tc_term@%s: %s\n" uu___4
                         uu___5);
                  dbg_refl g1 (fun uu___4 -> "refl_tc_term: starting tc {\n");
                  (let g2 =
                     {
                       FStarC_TypeChecker_Env.solver =
                       ...
                       FStarC_TypeChecker_Env.rec_names =
                         (g1.FStarC_TypeChecker_Env.rec_names);
                       FStarC_TypeChecker_Env.top_level =
                       ...
                       FStarC_TypeChecker_Env.disc_proj_tab =
                         (g1.FStarC_TypeChecker_Env.disc_proj_tab);
                       FStarC_TypeChecker_Env.erasable_types_tab =
                       ...
                       FStarC_TypeChecker_Env.iface_val_lids =
                         (g1.FStarC_TypeChecker_Env.iface_val_lids)
                     } in
                   let e1 =
                     let g3 =
                       {
                         ...
                         FStarC_TypeChecker_Env.rec_names =
                           (g2.FStarC_TypeChecker_Env.rec_names);
                         FStarC_TypeChecker_Env.top_level =
                         ...
                         FStarC_TypeChecker_Env.disc_proj_tab =
                           (g2.FStarC_TypeChecker_Env.disc_proj_tab);
                         FStarC_TypeChecker_Env.erasable_types_tab =
                         ...
                         FStarC_TypeChecker_Env.iface_val_lids =
                           (g2.FStarC_TypeChecker_Env.iface_val_lids)
                       } in
                     let must_tot = false in
                     let uu___4 =
                       g3.FStarC_TypeChecker_Env.typeof_tot_or_gtot_term g3 e
                         must_tot in
                     match uu___4 with
                     | (e2, uu___5, guard) ->
                         (FStarC_TypeChecker_Rel.force_trivial_guard g3 guard;
                          e2) in
                   try
                     (fun uu___4 ->
                        match () with
                        | () ->
                            ...
                            then
                              ...
                              (let allow_uvars = false in
                               ...
                               (let uu___7 =
                                  FStarC_TypeChecker_Core.compute_term_type
                                    g2 e2 in
                                match uu___7 with
                                | FStar_Pervasives.Inl (eff, t, guard) ->
                                     ...
                                     (let uu___9 =
                                        let uu___10 =
                                          FStarC_TypeChecker_Core.print_error
                                            err in
                                        Prims.strcat
                                          "tc_term callback failed: " uu___10 in
                                      FStarC_Errors.raise_error
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let refl_universe_of (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.universe refl_tac=
  (fun g e ->
     let check_univ_var_resolved g1 u =
       let uu___ = FStarC_Syntax_Subst.compress_univ u in
       match uu___ with
       | FStarC_Syntax_Syntax.U_unif uu___1 ->
           FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env g1
             FStarC_Errors_Codes.Fatal_IllTyped ()
             (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                       ...
                       | FStar_Pervasives.Inr err ->
                           (dbg_refl g1
                            ...
                            (let uu___5 =
                               let uu___6 =
                                 FStarC_TypeChecker_Core.print_error err in
                               Prims.strcat "universe_of failed: " uu___6 in
                             FStarC_Errors.raise_error
                               FStarC_TypeChecker_Env.hasRange_env g1
                               FStarC_Errors_Codes.Fatal_IllTyped ()
                               (Obj.magic
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let refl_check_prop_validity (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) : unit refl_tac=
  (fun g e ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term e else false in
            ...
            (refl_typing_builtin_wrapper "refl_check_prop_validity"
               (fun uu___1 ->
                  let g1 =
                    FStarC_TypeChecker_Env.set_range g
                      e.FStarC_Syntax_Syntax.pos in
                  ((), [(g1, (e, FStarC_TypeChecker_Core.empty_token))]))))
     else
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let refl_check_match_complete (g : env) (sc : FStarC_Syntax_Syntax.term)
  (scty : FStarC_Syntax_Syntax.typ)
  (pats : FStarC_Reflection_V2_Data.pattern Prims.list) :
  ...
  refl_typing_builtin_wrapper "refl_check_match_complete"
    (fun uu___ ->
       ...
       let uu___1 =
         FStarC_TypeChecker_TcTerm.typeof_tot_or_gtot_term env2 mm true in
       match uu___1 with
       | (mm1, uu___2, guard) ->
           (FStarC_TypeChecker_Rel.force_trivial_guard env2 guard;
            (let get_pats t =
               ...
               | FStarC_Syntax_Syntax.Tm_match
                   ...
                   FStarC_List.map
                     (fun br ->
                        let uu___8 = FStarC_Syntax_Subst.open_branch br in
                        match uu___8 with | (p, uu___9, uu___10) -> p) brs1
               | uu___5 ->
                   FStarC_Effect.failwith
             ...
             let rec bnds_for_pat p =
               ...
               | FStarC_Syntax_Syntax.Pat_cons (fv, uu___4, pats2) ->
                   FStarC_List.concatMap
                     (fun uu___5 ->
                        match uu___5 with | (p1, uu___6) -> bnds_for_pat p1)
                     pats2
             ...
             let uu___4 =
               let uu___5 =
                 FStarC_List.map FStarC_Reflection_V2_Builtins.inspect_pat
                   pats1 in
               let uu___6 = FStarC_List.map bnds_for_pat pats1 in
               (uu___5, uu___6) in
             (uu___4, []))))
let refl_instantiate_implicits (uu___3 : FStarC_TypeChecker_Env.env)
  (uu___2 : FStarC_Syntax_Syntax.term)
  (uu___1 : FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  (uu___ : Prims.bool) :
  (remaining_uvars_t * FStarC_Syntax_Syntax.term *
    FStarC_Reflection_V2_Data.typ) refl_tac=
  (fun g e expected_typ inst_extra ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term e else false in
     if uu___
               ...
               (fun uu___1 ->
                  ...
                  (let must_tot = false in
                   let g2 =
                     ...
                     | FStar_Pervasives_Native.None ->
                         FStar_Pervasives_Native.fst
                           (FStarC_TypeChecker_Env.clear_expected_typ g1)
                     | FStar_Pervasives_Native.Some typ ->
                         FStarC_TypeChecker_Env.set_expected_typ g1 typ in
                   let g3 =
                     {
                       FStarC_TypeChecker_Env.solver =
                         (g2.FStarC_TypeChecker_Env.solver);
                       ...
                       FStarC_TypeChecker_Env.attrtab =
                         (g2.FStarC_TypeChecker_Env.attrtab);
                       FStarC_TypeChecker_Env.instantiate_imp = inst_extra;
                       FStarC_TypeChecker_Env.effects =
                         (g2.FStarC_TypeChecker_Env.effects);
                       FStarC_TypeChecker_Env.generalize =
                         (g2.FStarC_TypeChecker_Env.generalize);
                   ...
                   | (e1, t, guard) ->
                       let guard1 =
                         let uu___5 =
                           FStarC_TypeChecker_Rel.solve_deferred_constraints
                             g3 guard in
                         FStarC_TypeChecker_Rel.resolve_implicits g3 uu___5 in
                       let bvs_and_ts =
                         let uu___5 =
                           FStarC_Class_Listlike.to_list
                             (FStarC_CList.listlike_clist ())
                             ...
                             (FStarC_List.iter
                                (fun uu___7 ->
                                   ...
                                   | (uv, uu___8, bv) ->
                                       ...
                                       FStarC_Syntax_Util.set_uvar uv uu___9)
                                l;
                              FStarC_List.map
                                (fun uu___7 ->
                                   match uu___7 with
                       ...
                       (dbg_refl g3
                        ...
                        (let g4 =
                           ...
                           FStarC_TypeChecker_Env.push_bvs g3 uu___10 in
                         let allow_uvars = false in
                         let allow_names = true in
                         let e2 =
                           FStarC_Syntax_Compress.deep_compress allow_uvars
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___3 uu___2 uu___1 uu___
let refl_try_unify (uu___3 : FStarC_TypeChecker_Env.env)
  (uu___2 :
    (FStarC_Syntax_Syntax.bv * FStarC_Reflection_V2_Data.typ) Prims.list)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  uvar_solution Prims.list refl_tac=
  (fun g uvs t0 t1 ->
     let uu___ =
       let uu___1 =
         let uu___2 =
           let uu___3 = no_uvars_in_g g in
           if uu___3 then no_uvars_in_term t0 else false in
         if uu___2 then no_uvars_in_term t1 else false in
       if uu___1
       then
         let uu___2 = FStarC_List.map FStar_Pervasives_Native.snd uvs in
         FStarC_List.for_all no_uvars_in_term uu___2
       else false in
     if uu___
     then
       Obj.magic
                         ...
                         FStarC_Class_Show.show
                           (FStarC_Class_Show.show_list
                              (FStarC_Class_Show.show_tuple2
                                 ...
                                 FStarC_Syntax_Print.showable_term)) uvs in
                       FStarC_Format.fmt3
                     ...
                     FStarC_List.fold_left
                       (fun uu___4 uu___5 ->
                          ...
                          | ((guard_uvs, ss, tbl), (bv, t)) ->
                              let t2 = FStarC_Syntax_Subst.subst ss t in
                              let uu___6 =
                                let reason =
                                  let uu___7 =
                                    FStarC_Class_Show.show
                                      FStarC_Syntax_Print.showable_bv bv in
                                  FStarC_Format.fmt1 "refl_try_unify for %s"
                                    uu___7 in
                                let should_check_uvar =
                                  FStarC_Syntax_Syntax.Allow_untyped
                                    "refl_try_unify" in
                                FStarC_TypeChecker_Env.new_implicit_var_aux
                                  reason t0.FStarC_Syntax_Syntax.pos g1 t2
                                  should_check_uvar
                                  FStar_Pervasives_Native.None false in
                              (match uu___6 with
                               | (uv_t, (ctx_u, uu___7), guard_uv) ->
                                   let uv_id =
                                   ...
                                   (uu___8,
                                     ((FStarC_Syntax_Syntax.NT (bv, uv_t)) ::
                                     ss),
                                     (FStarC_PIMap.add tbl uv_id
                                        ((ctx_u.FStarC_Syntax_Syntax.ctx_uvar_head),
                                          bv)))))
                       (FStarC_TypeChecker_Env.trivial_guard, [],
                         (FStarC_PIMap.empty ())) uvs in
                   match uu___3 with
                   | (guard_uvs, ss, tbl) ->
                       let uu___4 =
                         let uu___5 = FStarC_Syntax_Subst.subst ss t0 in
                         let uu___6 = FStarC_Syntax_Subst.subst ss t1 in
                         (uu___5, uu___6) in
                       (match uu___4 with
                        | (t01, t11) ->
                            let g2 =
                            ...
                            let guard_eq =
                              let smt_ok = true in
                              FStarC_TypeChecker_Rel.try_teq smt_ok g2 t01
                                t11 in
                            let l =
                              match guard_eq with
                              | FStar_Pervasives_Native.None -> []
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___3 uu___2 uu___1 uu___
let refl_maybe_relate_after_unfolding (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : FStarC_Syntax_Syntax.term) (uu___ : FStarC_Syntax_Syntax.term) :
  FStarC_TypeChecker_Core.side refl_tac=
  (fun g t0 t1 ->
     let uu___ =
       let uu___1 =
         let uu___2 = no_uvars_in_g g in
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt2
                         ...
                         uu___4 uu___5);
                  (let s =
                     FStarC_TypeChecker_Core.maybe_relate_after_unfolding g1
                       t0 t1 in
                   dbg_refl g1
                     (fun uu___4 ->
                        let uu___5 =
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___2 uu___1 uu___
let refl_maybe_unfold_head (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term refl_tac=
  (fun g e ->
     let uu___ =
       let uu___1 = no_uvars_in_g g in
       if uu___1 then no_uvars_in_term e else false in
                  ...
                  dbg_refl g1
                    (fun uu___3 ->
                       ...
                       FStarC_Format.fmt1 "refl_maybe_unfold_head: %s {\n"
                         uu___4);
                  (let eopt =
                     FStarC_TypeChecker_Normalize.maybe_unfold_head g1 e in
                   dbg_refl g1
                     (fun uu___4 ->
                        let uu___5 =
                          match eopt with
                   ...
                   then
                     (let uu___4 =
                        let uu___5 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Print.showable_term e in
                        FStarC_Format.fmt1 "Could not unfold head: %s\n"
                          uu___5 in
                      FStarC_Errors.raise_error
       ...
       Obj.magic
         (Obj.repr
            (let uu___1 =
             ...
             FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.magic uu___1)))) uu___1 uu___
let push_open_namespace (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : Prims.string Prims.list) :
  FStarC_TypeChecker_Env.env FStarC_Tactics_Monad.tac=
  (fun e ns ->
     let lid = FStarC_Ident.lid_of_path ns FStarC_Range_Type.dummyRange in
     let uu___ =
       let uu___1 =
         FStarC_Syntax_DsEnv.push_namespace e.FStarC_TypeChecker_Env.dsenv
           lid FStarC_Syntax_Syntax.Unrestricted in
       {
         FStarC_TypeChecker_Env.solver = (e.FStarC_TypeChecker_Env.solver);
         FStarC_TypeChecker_Env.range = (e.FStarC_TypeChecker_Env.range);
         FStarC_TypeChecker_Env.curmodule =
           (e.FStarC_TypeChecker_Env.curmodule);
         FStarC_TypeChecker_Env.gamma = (e.FStarC_TypeChecker_Env.gamma);
         ...
         FStarC_TypeChecker_Env.gamma_cache =
           (e.FStarC_TypeChecker_Env.gamma_cache);
         FStarC_TypeChecker_Env.modules = (e.FStarC_TypeChecker_Env.modules);
         FStarC_TypeChecker_Env.expected_typ =
           (e.FStarC_TypeChecker_Env.expected_typ);
         FStarC_TypeChecker_Env.sigtab = (e.FStarC_TypeChecker_Env.sigtab);
         FStarC_TypeChecker_Env.attrtab = (e.FStarC_TypeChecker_Env.attrtab);
         FStarC_TypeChecker_Env.instantiate_imp =
           (e.FStarC_TypeChecker_Env.instantiate_imp);
         FStarC_TypeChecker_Env.effects = (e.FStarC_TypeChecker_Env.effects);
         FStarC_TypeChecker_Env.generalize =
           (e.FStarC_TypeChecker_Env.generalize);
         FStarC_TypeChecker_Env.letrecs = (e.FStarC_TypeChecker_Env.letrecs);
         FStarC_TypeChecker_Env.rec_names =
           (e.FStarC_TypeChecker_Env.rec_names);
         FStarC_TypeChecker_Env.top_level =
           (e.FStarC_TypeChecker_Env.top_level);
         ...
         FStarC_TypeChecker_Env.is_iface =
           (e.FStarC_TypeChecker_Env.is_iface);
         FStarC_TypeChecker_Env.admit = (e.FStarC_TypeChecker_Env.admit);
         FStarC_TypeChecker_Env.phase1 = (e.FStarC_TypeChecker_Env.phase1);
         FStarC_TypeChecker_Env.failhard =
           (e.FStarC_TypeChecker_Env.failhard);
         FStarC_TypeChecker_Env.flychecking =
           (e.FStarC_TypeChecker_Env.flychecking);
         ...
         FStarC_TypeChecker_Env.nocoerce =
           (e.FStarC_TypeChecker_Env.nocoerce);
         FStarC_TypeChecker_Env.tc_term = (e.FStarC_TypeChecker_Env.tc_term);
         FStarC_TypeChecker_Env.typeof_tot_or_gtot_term =
           (e.FStarC_TypeChecker_Env.typeof_tot_or_gtot_term);
         FStarC_TypeChecker_Env.universe_of =
           (e.FStarC_TypeChecker_Env.universe_of);
         ...
         FStarC_TypeChecker_Env.try_solve_implicits_hook =
           (e.FStarC_TypeChecker_Env.try_solve_implicits_hook);
         FStarC_TypeChecker_Env.splice = (e.FStarC_TypeChecker_Env.splice);
         FStarC_TypeChecker_Env.mpreprocess =
           (e.FStarC_TypeChecker_Env.mpreprocess);
         FStarC_TypeChecker_Env.postprocess =
           (e.FStarC_TypeChecker_Env.postprocess);
...
let push_module_abbrev (uu___2 : FStarC_TypeChecker_Env.env)
  (uu___1 : Prims.string) (uu___ : Prims.string Prims.list) :
  FStarC_TypeChecker_Env.env FStarC_Tactics_Monad.tac=
  (fun e n m ->
...
let resolve_name (uu___1 : FStarC_TypeChecker_Env.env)
  (uu___ : Prims.string Prims.list) :
  ...
  (fun e n ->
     ...
     let uu___ =
       FStarC_Syntax_DsEnv.resolve_name e.FStarC_TypeChecker_Env.dsenv l in
     Obj.magic
       (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
          (Obj.magic uu___))) uu___1 uu___
let log_issues (is : FStarC_Errors.issue Prims.list) :
  unit FStarC_Tactics_Monad.tac=
  FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
    (Obj.magic FStarC_Tactics_Monad.get)
    (fun uu___ ->
       (fun ps ->
            ...
            then
              FStarC_List.map
                (fun i ->
                   {
                     FStarC_Errors.issue_msg =
                       ((FStarC_Errors_Msg.text "Tactic logged issue:") ::
                       (i.FStarC_Errors.issue_msg));
                     FStarC_Errors.issue_level =
          ...
          Obj.magic
            (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
               (Obj.repr ()))) uu___)
let tac_env (env1 : FStarC_TypeChecker_Env.env) : FStarC_TypeChecker_Env.env=
  ...
  | (env2, uu___1) ->
      let env3 =
        {
          ...
          FStarC_TypeChecker_Env.rec_names =
            (env2.FStarC_TypeChecker_Env.rec_names);
          FStarC_TypeChecker_Env.top_level =
          ...
          FStarC_TypeChecker_Env.disc_proj_tab =
            (env2.FStarC_TypeChecker_Env.disc_proj_tab);
          FStarC_TypeChecker_Env.erasable_types_tab =
      ...
      let env4 =
        {
          ...
          FStarC_TypeChecker_Env.rec_names =
            (env3.FStarC_TypeChecker_Env.rec_names);
          FStarC_TypeChecker_Env.top_level =
          ...
          FStarC_TypeChecker_Env.disc_proj_tab =
            (env3.FStarC_TypeChecker_Env.disc_proj_tab);
          FStarC_TypeChecker_Env.erasable_types_tab =
      ...
      let env5 =
        {
          ...
          FStarC_TypeChecker_Env.rec_names =
            (env4.FStarC_TypeChecker_Env.rec_names);
          FStarC_TypeChecker_Env.top_level =
          ...
          FStarC_TypeChecker_Env.disc_proj_tab =
            (env4.FStarC_TypeChecker_Env.disc_proj_tab);
          FStarC_TypeChecker_Env.erasable_types_tab =
      ...
      env5
let proofstate_of_goals (rng : FStarC_Range_Type.t)
  (env1 : FStarC_TypeChecker_Env.env)
  (goals : FStarC_Tactics_Types.goal Prims.list)
  (imps : FStarC_TypeChecker_Env.implicit Prims.list) :
  ...
  let ps =
    let uu___ = FStarC_Effect.op_Bang dbg_TacVerbose in
    {
      ...
      FStarC_Tactics_Types.psc = FStarC_TypeChecker_Primops_Base.null_psc;
      ...
      FStarC_Tactics_Types.local_state = (FStarC_PSMap.empty ());
      FStarC_Tactics_Types.urgency = Prims.int_one;
      FStarC_Tactics_Types.dump_on_failure = true
    } in
  ps
let proofstate_of_goal_ty (rng : FStarC_Range_Type.t)
  (env1 : FStarC_TypeChecker_Env.env) (typ : FStarC_Reflection_V2_Data.typ) :
...
let proofstate_of_all_implicits (rng : FStarC_Range_Type.t)
  (env1 : FStarC_TypeChecker_Env.env)
  (imps : FStarC_TypeChecker_Env.implicits) :
  (FStarC_Tactics_Types.proofstate * FStarC_Syntax_Syntax.term)=
  let env2 = tac_env env1 in
  let goals =
    FStarC_List.map (FStarC_Tactics_Types.goal_of_implicit env2) imps in
  ...
  (ps, w)
let getprop (e : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term)
...
let run_unembedded_tactic_on_ps_and_solve_remaining
  (t_range : FStarC_Range_Type.t) (g_range : FStarC_Range_Type.t)
  (background : Prims.bool) (t : 'a) (f : 'a -> 'b FStarC_Tactics_Monad.tac)
  (ps : FStarC_Tactics_Types.proofstate) : 'b=
  let uu___ =
    FStarC_Tactics_Interpreter.run_unembedded_tactic_on_ps t_range g_range
      background t f ps in
  match uu___ with
  | (remaining_goals, r) ->
      (FStarC_List.iter
         (fun g ->
            let uu___2 =
              let uu___3 = FStarC_Tactics_Types.goal_type g in
              getprop (FStarC_Tactics_Types.goal_env g) uu___3 in
            match uu___2 with
         ...
         remaining_goals;
       r)
let call_subtac (uu___3 : FStarC_TypeChecker_Env.env)
  (uu___2 : unit FStarC_Tactics_Monad.tac)
  (uu___1 : FStarC_Syntax_Syntax.universe)
  (uu___ : FStarC_Reflection_V2_Data.typ) :
  FStarC_Syntax_Syntax.term refl_tac=
  (fun g f _u goal_ty ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
       ...
       (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
          ...
          (fun uu___1 ->
             (fun uu___1 ->
                ...
                let uu___2 = proofstate_of_goal_ty rng g goal_ty in
                match uu___2 with
                | (ps, w) ->
                    let ps1 =
                      {
                        ...
                        FStarC_Tactics_Types.urgency =
                          (ps.FStarC_Tactics_Types.urgency);
                        FStarC_Tactics_Types.dump_on_failure = false
                      } in
                    let uu___3 =
                      FStarC_Errors.catch_errors_and_ignore_rest
                        (fun uu___4 ->
                           run_unembedded_tactic_on_ps_and_solve_remaining
                             rng rng false () (fun uu___5 -> f) ps1) in
                    (match uu___3 with
                     | ([], FStar_Pervasives_Native.Some ()) ->
                         Obj.magic
                           (FStarC_Class_Monad.return
                     ...
                     | (issues1, uu___4) ->
                         Obj.magic
                           (FStarC_Class_Monad.return
                              FStarC_Tactics_Monad.monad_tac ()
                              (Obj.magic
                                 (FStar_Pervasives_Native.None, issues1)))))
               uu___1))) uu___3 uu___2 uu___1 uu___
let run_tactic_on_ps_and_solve_remaining (t_range : FStarC_Range_Type.t)
  (g_range : FStarC_Range_Type.t) (background : Prims.bool) (t : 'a)
  (f_tm : FStarC_Syntax_Syntax.term) (ps : FStarC_Tactics_Types.proofstate) :
  unit=
  let uu___ =
    FStarC_Tactics_Interpreter.run_tactic_on_ps t_range g_range background
      FStarC_Syntax_Embeddings.e_unit () FStarC_Syntax_Embeddings.e_unit f_tm
      false ps in
  match uu___ with
  | (remaining_goals, r) ->
      FStarC_List.iter
        (fun g ->
           ...
           | FStar_Pervasives_Native.None ->
               FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range
                 g_range FStarC_Errors_Codes.Fatal_OpenGoalsInSynthesis ()
                 (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                 (Obj.magic
                    "tactic left a computationally-relevant goal unsolved"))
        remaining_goals
let call_subtac_tm (uu___3 : FStarC_TypeChecker_Env.env)
  (uu___2 : FStarC_Syntax_Syntax.term)
  (uu___1 : FStarC_Syntax_Syntax.universe)
  (uu___ : FStarC_Reflection_V2_Data.typ) :
  FStarC_Syntax_Syntax.term refl_tac=
  (fun g f_tm _u goal_ty ->
     let uu___ =
       FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac ()
         (Obj.repr ()) in
     Obj.magic
             ...
             (fun uu___1 ->
                ...
                | (ps, w) ->
                    ...
                    let uu___3 =
                      FStarC_Errors.catch_errors_and_ignore_rest
                        (fun uu___4 ->
                           run_tactic_on_ps_and_solve_remaining rng rng false
                             () f_tm ps1) in
                    (match uu___3 with
                     | ([], FStar_Pervasives_Native.Some ()) ->
                         Obj.magic
                         ...
                         Obj.magic
                           (FStarC_Class_Monad.return
                              ...
                              (Obj.magic
                                 (FStar_Pervasives_Native.None, issues1)))))
               uu___1))) uu___3 uu___2 uu___1 uu___
let stats_record (a1 : 'a) (wp : 'b) (s : Prims.string)
