...
let (dbg_2635 : Prims.bool FStarC_Effect.ref) =
...
let (fixup_range :
  FStarC_Range_Type.t -> FStarC_Range_Type.t FStarC_Tactics_Monad.tac) =
  fun uu___ ->
    (fun r ->
                    ...
                    (fun uu___4 ->
                       let uu___5 =
                         ...
                         FStarC_Class_Show.show
                           FStarC_Range_Ops.showable_range uu___6 in
                       let uu___6 =
...
let (rangeof : FStarC_Tactics_Types.goal -> FStarC_Range_Type.range) =
  fun g ->
...
let (tacprint : Prims.string -> unit) =
  fun s -> FStarC_Format.print1 "TAC>> %s\n" s
    ...
    fun msg ->
      FStarC_Tactics_Monad.mk_tac
        (fun ps ->
           ...
           let gs =
             FStarC_List.map (FStarC_Tactics_Types.goal_of_ctx_uvar g) uvs in
           let gs1 =
             FStarC_List.filter
               (fun g1 ->
...
let fail2 :
  ...
  fun msg ->
    fun x ->
      fun y ->
        let uu___ = FStarC_Format.fmt2 msg x y in
...
let fail3 :
  ...
  fun msg ->
    fun x ->
      fun y ->
        fun z ->
          let uu___ = FStarC_Format.fmt3 msg x y z in
          FStarC_Tactics_Monad.fail uu___
let fail4 :
  'uuuuu .
    Prims.string ->
                             ...
                             (FStarC_Class_Monad.op_let_Bang
                                ...
                                (fun uu___1 ->
                                   (fun uu___1 ->
                                      let uu___1 = Obj.magic uu___1 in
                                      (let uu___3 =
                                         FStarC_Effect.op_Bang dbg_TacUnify in
                                       if uu___3
                                       then
                                         (FStarC_Options.push ();
                                          (let uu___5 =
...
let (fresh : unit -> Prims.int FStarC_Tactics_Monad.tac) =
  fun uu___ ->
    (fun uu___ ->
       Obj.magic
         (FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
...
let (curms : unit -> Prims.int FStarC_Tactics_Monad.tac) =
  fun uu___ ->
    (fun uu___ ->
        ...
        then
          ...
          (let uu___3 =
           ...
           then
             ...
             FStarC_Option.map
               (fun post -> (FStarC_Syntax_Util.t_true, post)) uu___4
            ...
            then FStar_Pervasives_Native.Some (e', bv', [])
              ...
              (let uu___3 = aux e' in
               FStarC_Option.map
                 (fun uu___4 ->
                    match uu___4 with
                    | (e'', bv, bvs) -> (e'', bv, (bv' :: bvs))) uu___3) in
      let uu___ = aux e in
      FStarC_Option.map
        (fun uu___1 ->
           match uu___1 with
           | (e', bv, bvs) -> (e', bv, (FStarC_List.rev bvs))) uu___
let (subst_goal :
  FStarC_Syntax_Syntax.bv ->
    FStarC_Syntax_Syntax.bv ->
      FStarC_Tactics_Types.goal ->
           ...
           fun b2 ->
             fun g ->
               ...
               | FStar_Pervasives_Native.Some (e0, b11, bvs) ->
                   let bs =
                     FStarC_List.map FStarC_Syntax_Syntax.mk_binder (b11 ::
                       bvs) in
                   ...
                   (match uu___1 with
                    | (bs', t') ->
                        let bs'1 =
                          ...
                          let uu___3 = FStarC_List.tail bs' in uu___2 ::
                            uu___3 in
                        let uu___2 =
                        ...
                        (match uu___2 with
                         | (new_env, bs'', t'') ->
                             let b21 =
                               let uu___3 = FStarC_List.hd bs'' in
...
let (free_in :
  ...
  fun bv ->
    fun t ->
      ...
      FStarC_Class_Setlike.mem ()
        (Obj.magic
           (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv)) bv
        (Obj.magic uu___)
let (clear :
  FStarC_Reflection_V2_Data.binding -> unit FStarC_Tactics_Monad.tac) =
  fun b ->
                       ...
                       (fun uu___1 ->
                          ...
                          then
                            Obj.magic
                              (Obj.repr
                                 (let s =
                                    FStarC_Util.run_process "tactic_launch"
                                      prog args
...
let (set_urgency : Prims.int -> unit FStarC_Tactics_Monad.tac) =
  fun u ->
    FStarC_Class_Monad.op_let_Bang FStarC_Tactics_Monad.monad_tac () ()
      (Obj.magic FStarC_Tactics_Monad.get)
      (fun uu___ ->
  ...
  fun uu___1 ->
    fun uu___ ->
      (fun e ->
         fun i ->
           let ident =
             FStarC_Ident.mk_ident (i, FStarC_Range_Type.dummyRange) in
           let uu___ =
               ...
               (fun g ->
                  ...
                  Obj.magic
                    (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                       () (Obj.magic s))) uu___1))) uu___
let (term_to_doc :
  FStarC_Syntax_Syntax.term -> FStar_Pprint.document FStarC_Tactics_Monad.tac)
  =
  fun uu___ ->
    (fun t ->
       let uu___ = top_env () in
               ...
               (fun g ->
                  ...
                  Obj.magic
                    (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                       () (Obj.magic s))) uu___1))) uu___
let (comp_to_doc :
  FStarC_Syntax_Syntax.comp -> FStar_Pprint.document FStarC_Tactics_Monad.tac)
  =
  fun uu___ ->
    (fun c ->
       let uu___ = top_env () in
               ...
               (fun g ->
                  ...
                  Obj.magic
                    (FStarC_Class_Monad.return FStarC_Tactics_Monad.monad_tac
                       () (Obj.magic s))) uu___1))) uu___
let (range_to_string :
  FStarC_Range_Type.t -> Prims.string FStarC_Tactics_Monad.tac) =
  fun uu___ ->
    (fun r ->
...
let (free_uvars :
  FStarC_Syntax_Syntax.term -> Prims.int Prims.list FStarC_Tactics_Monad.tac)
  =
  fun uu___ ->
    (fun tm ->
       let uu___ =
...
let (unexpected_uvars_issue : FStarC_Range_Type.t -> FStarC_Errors.issue) =
  fun r ->
    let i =
                             ...
                             (fun uu___1 ->
                                ...
                                dbg_refl g1
                                  (fun uu___3 ->
                                     ...
                                     let uu___6 =
                                       FStarC_Class_Show.show
                                         FStarC_TypeChecker_Core.showable_tot_or_ghost
                                         eff in
                                     FStarC_Format.fmt3
                 ...
                 fun t1 ->
                   let uu___ =
                     (((no_uvars_in_g g) && (no_uvars_in_term t0)) &&
                       ...
                       &&
                       (let uu___1 =
                          FStarC_List.map FStar_Pervasives_Native.snd uvs in
      ...
      fun uu___ ->
        (fun e ->
           fun n ->
             fun m ->
               let mlid =
                 FStarC_Ident.lid_of_path m FStarC_Range_Type.dummyRange in
...
let stats_record :
  'a 'b 'c .
    'a ->
      'b ->
        Prims.string ->
          'c FStarC_Tactics_Monad.tac -> 'c FStarC_Tactics_Monad.tac
  =
  fun a1 ->
    fun wp ->
      fun s ->
        fun f ->
          FStarC_Tactics_Monad.mk_tac
            (fun ps ->
               FStarC_Stats.record s
                 (fun uu___ -> FStarC_Tactics_Monad.run f ps))
