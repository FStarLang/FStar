...
let __proj__Mkord__item__cmp : 'a . 'a ord -> 'a -> 'a -> FStarC_Order.order
...
let cmp : 'a . 'a ord -> 'a -> 'a -> FStarC_Order.order =
  fun projectee ->
    match projectee with | { super = super1; cmp = cmp1;_} -> cmp1
let op_Less_Question : 'a . 'a ord -> 'a -> 'a -> Prims.bool =
  fun uu___ ->
    fun x -> fun y -> let uu___1 = cmp uu___ x y in uu___1 = FStarC_Order.Lt
let op_Less_Equals_Question : 'a . 'a ord -> 'a -> 'a -> Prims.bool =
  fun uu___ ->
    fun x -> fun y -> let uu___1 = cmp uu___ x y in uu___1 <> FStarC_Order.Gt
...
let (ord_unit : unit ord) =
  {
    ...
    cmp = (fun uu___ -> fun uu___1 -> FStarC_Order.Eq)
  }
let (ord_string : Prims.string ord) =
  {
    ...
    cmp =
      (fun x ->
         fun y -> FStarC_Order.order_from_int (FStarC_String.compare x y))
  }
        ...
        (fun x ->
           fun y ->
             ...
             | (FStar_Pervasives_Native.Some uu___,
                FStar_Pervasives_Native.None) -> FStarC_Order.Gt
             | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some
                uu___) -> FStarC_Order.Lt
  ...
  fun d ->
    {
      ...
      cmp = (fun l1 -> fun l2 -> FStarC_Order.compare_list l1 l2 (cmp d))
    }
let ord_either :
