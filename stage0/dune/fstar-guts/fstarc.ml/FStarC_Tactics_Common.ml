...
let uu___is_NotAListLiteral (projectee : Prims.exn) : Prims.bool= true
exception TacticFailure of (FStarC_Errors_Msg.error_message *
  FStarC_Range_Type.t FStar_Pervasives_Native.option) 
let uu___is_TacticFailure (projectee : Prims.exn) : Prims.bool= true
