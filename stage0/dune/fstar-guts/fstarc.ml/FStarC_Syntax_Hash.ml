...
let op_let_Question (f : 't mm) (g : 't -> 's mm) : 's mm=
  fun b -> let uu___ = f b in match uu___ with | (t1, b1) -> g t1 b1
...
let hash_option (h : 'a -> FStarC_Hash.hash_code mm)
  ...
  match o with
  | FStar_Pervasives_Native.None ->
      ret (FStarC_Hash.of_int (Prims.of_int (1237)))
  | FStar_Pervasives_Native.Some o1 ->
      let uu___ = h o1 in
      mix (ret (FStarC_Hash.of_int (Prims.of_int (1249)))) uu___
...
and hash_term' (t : FStarC_Syntax_Syntax.term) : FStarC_Hash.hash_code mm=
  ...
  | FStarC_Syntax_Syntax.Tm_bvar bv ->
      mix (of_int (Prims.of_int (3))) (of_int bv.FStarC_Syntax_Syntax.index)
  | FStarC_Syntax_Syntax.Tm_name bv ->
      mix (of_int (Prims.of_int (5))) (of_int bv.FStarC_Syntax_Syntax.index)
  | FStarC_Syntax_Syntax.Tm_fvar fv ->
      let uu___1 = hash_fv fv in mix (of_int (Prims.of_int (7))) uu___1
  | FStarC_Syntax_Syntax.Tm_uinst (t1, us) ->
      let uu___1 =
        let uu___2 = hash_term t1 in
        let uu___3 = hash_list hash_universe us in mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (11))) uu___1
  | FStarC_Syntax_Syntax.Tm_constant sc ->
      let uu___1 = hash_constant sc in
      mix (of_int (Prims.of_int (13))) uu___1
  ...
  | FStarC_Syntax_Syntax.Tm_refine
      ...
      mix (of_int (Prims.of_int (29))) uu___1
  | FStarC_Syntax_Syntax.Tm_app uu___1 ->
      let uu___2 = FStarC_Syntax_Util.head_and_args_full t in
      (match uu___2 with
       | (hd, args) ->
           let uu___3 = hash_term hd in
           let uu___4 = hash_list hash_arg args in mix uu___3 uu___4)
  | FStarC_Syntax_Syntax.Tm_match
      ...
      ->
      let uu___1 =
        let uu___2 = hash_option hash_match_returns asc_opt in
        let uu___3 =
          let uu___4 =
            let uu___5 = hash_term t1 in
            let uu___6 = hash_list hash_branch branches in mix uu___5 uu___6 in
          let uu___5 = hash_option hash_rc rcopt in mix uu___4 uu___5 in
        mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (37))) uu___1
  | FStarC_Syntax_Syntax.Tm_ascribed
      ...
      let uu___1 =
        let uu___2 = hash_term t1 in
        let uu___3 =
          let uu___4 = hash_ascription a in
          let uu___5 = hash_option hash_lid lopt in mix uu___4 uu___5 in
        mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (43))) uu___1
  | FStarC_Syntax_Syntax.Tm_let
      { FStarC_Syntax_Syntax.lbs = (false, lb::[]);
        FStarC_Syntax_Syntax.body1 = t1;_}
      ->
      let uu___1 =
        let uu___2 = hash_lb lb in
        let uu___3 = hash_term t1 in mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (47))) uu___1
  | FStarC_Syntax_Syntax.Tm_let
      { FStarC_Syntax_Syntax.lbs = (uu___1, lbs);
        FStarC_Syntax_Syntax.body1 = t1;_}
      ->
      let uu___2 =
        let uu___3 = hash_list hash_lb lbs in
        let uu___4 = hash_term t1 in mix uu___3 uu___4 in
      mix (of_int (Prims.of_int (51))) uu___2
  | FStarC_Syntax_Syntax.Tm_uvar uv ->
      let uu___1 = hash_uvar uv in mix (of_int (Prims.of_int (53))) uu___1
  | FStarC_Syntax_Syntax.Tm_meta
      { FStarC_Syntax_Syntax.tm2 = t1; FStarC_Syntax_Syntax.meta = m;_} ->
      let uu___1 =
        let uu___2 = hash_term t1 in
        let uu___3 = hash_meta m in mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (61))) uu___1
  | FStarC_Syntax_Syntax.Tm_lazy li ->
      let uu___1 = hash_lazyinfo li in
      mix (of_int (Prims.of_int (67))) uu___1
  | FStarC_Syntax_Syntax.Tm_quoted (t1, qi) ->
      let uu___1 =
        let uu___2 = hash_term t1 in
        let uu___3 = hash_quoteinfo qi in mix uu___2 uu___3 in
      mix (of_int (Prims.of_int (71))) uu___1
      ...
      let uu___ =
        let uu___1 =
          ...
          let uu___3 =
            ...
            uu___4 :: uu___5 in
          uu___2 :: uu___3 in
        (of_int (Prims.of_int (823))) :: uu___1 in
      mix_list_lit uu___
and hash_lb (lb : FStarC_Syntax_Syntax.letbinding) :
  FStarC_Hash.hash_code mm=
  let uu___ =
    let uu___1 =
      let uu___2 = hash_lbname lb.FStarC_Syntax_Syntax.lbname in
      let uu___3 =
        let uu___4 = hash_list hash_ident lb.FStarC_Syntax_Syntax.lbunivs in
        let uu___5 =
          let uu___6 = hash_term lb.FStarC_Syntax_Syntax.lbtyp in
          let uu___7 =
            let uu___8 = hash_lid lb.FStarC_Syntax_Syntax.lbeff in
            let uu___9 =
              let uu___10 = hash_term lb.FStarC_Syntax_Syntax.lbdef in
              let uu___11 =
                let uu___12 =
        ...
        uu___4 :: uu___5 in
      uu___2 :: uu___3 in
    (of_int (Prims.of_int (79))) :: uu___1 in
  mix_list_lit uu___
...
and hash_branch
  ...
  | (p, topt, t) ->
      let uu___1 =
        let uu___2 =
          let uu___3 = hash_pat p in
          let uu___4 =
            let uu___5 = hash_option hash_term topt in
            let uu___6 = let uu___7 = hash_term t in [uu___7] in uu___5 ::
              uu___6 in
          uu___3 :: uu___4 in
        (of_int (Prims.of_int (83))) :: uu___2 in
      mix_list_lit uu___1
and hash_pat (p : FStarC_Syntax_Syntax.pat' FStarC_Syntax_Syntax.withinfo_t)
  ...
  | FStarC_Syntax_Syntax.Pat_constant c ->
      let uu___ = hash_constant c in mix (of_int (Prims.of_int (89))) uu___
  | FStarC_Syntax_Syntax.Pat_cons (fv, us, args) ->
      let uu___ =
        let uu___1 =
          let uu___2 = hash_fv fv in
          let uu___3 =
            let uu___4 = hash_option (hash_list hash_universe) us in
            let uu___5 =
              let uu___6 = hash_list (hash_pair hash_pat hash_bool) args in
              [uu___6] in
            uu___4 :: uu___5 in
          uu___2 :: uu___3 in
        (of_int (Prims.of_int (97))) :: uu___1 in
      mix_list_lit uu___
  | FStarC_Syntax_Syntax.Pat_var bv ->
      let uu___ = hash_bv bv in mix (of_int (Prims.of_int (101))) uu___
  | FStarC_Syntax_Syntax.Pat_dot_term t ->
      let uu___ =
        let uu___1 = let uu___2 = hash_option hash_term t in [uu___2] in
        (of_int (Prims.of_int (107))) :: uu___1 in
      mix_list_lit uu___
...
and hash_binder (b : FStarC_Syntax_Syntax.binder) : FStarC_Hash.hash_code mm=
  let uu___ =
    ...
    uu___1 :: uu___2 in
  mix_list_lit uu___
and hash_universe (u : FStarC_Syntax_Syntax.universe) :
  FStarC_Hash.hash_code mm=
  match u with
  | FStarC_Syntax_Syntax.U_zero -> of_int (Prims.of_int (179))
  | FStarC_Syntax_Syntax.U_succ u1 ->
      let uu___ = hash_universe u1 in mix (of_int (Prims.of_int (181))) uu___
  | FStarC_Syntax_Syntax.U_max us ->
      let uu___ = hash_list hash_universe us in
      mix (of_int (Prims.of_int (191))) uu___
  | FStarC_Syntax_Syntax.U_bvar i ->
      mix (of_int (Prims.of_int (193))) (of_int i)
  | FStarC_Syntax_Syntax.U_name i ->
      let uu___ = hash_ident i in mix (of_int (Prims.of_int (197))) uu___
  | FStarC_Syntax_Syntax.U_unif uv ->
      let uu___ = hash_universe_uvar uv in
      mix (of_int (Prims.of_int (199))) uu___
...
and hash_arg_qualifier (aq : FStarC_Syntax_Syntax.arg_qualifier) :
  ...
  mix uu___ uu___1
and hash_bqual (bq : FStarC_Syntax_Syntax.binder_qualifier) :
  FStarC_Hash.hash_code mm=
  match bq with
  ...
  | FStarC_Syntax_Syntax.Meta t ->
      let uu___ = hash_term t in mix (of_int (Prims.of_int (431))) uu___
...
and hash_constant (c : FStarC_Syntax_Syntax.sconst) :
  FStarC_Hash.hash_code mm=
  match c with
  ...
  | FStarC_Const.Const_range r ->
      let uu___ =
        let uu___1 = FStarC_Range_Ops.string_of_range r in of_string uu___1 in
      mix (of_int (Prims.of_int (367))) uu___
  | FStarC_Const.Const_reify uu___ -> of_int (Prims.of_int (367))
  | FStarC_Const.Const_reflect l ->
      let uu___ = hash_lid l in mix (of_int (Prims.of_int (373))) uu___
and hash_sw (x : (FStarC_Const.signedness * FStarC_Const.width)) :
  FStarC_Hash.hash_code mm=
  let uu___ = x in
  match uu___ with
  | (s, w) ->
      mix
        (match s with
         ...
         | FStarC_Const.Signed -> of_int (Prims.of_int (557)))
        (match w with
         ...
         | FStarC_Const.Sizet -> of_int (Prims.of_int (583)))
and hash_ident (i : FStarC_Syntax_Syntax.univ_name) :
  FStarC_Hash.hash_code mm= of_string (FStarC_Ident.string_of_id i)
...
and hash_flag (f : FStarC_Syntax_Syntax.cflag) : FStarC_Hash.hash_code mm=
  ...
  | FStarC_Syntax_Syntax.DECREASES (FStarC_Syntax_Syntax.Decreases_wf
      (t0, t1)) ->
      let uu___ = hash_list hash_term [t0; t1] in
      mix (of_int (Prims.of_int (2341))) uu___
and hash_meta (m : FStarC_Syntax_Syntax.metadata) : FStarC_Hash.hash_code mm=
  match m with
  | FStarC_Syntax_Syntax.Meta_pattern (ts, args) ->
      let uu___ =
        let uu___1 =
          let uu___2 = hash_list hash_term ts in
          let uu___3 =
            let uu___4 = hash_list (hash_list hash_arg) args in [uu___4] in
          uu___2 :: uu___3 in
        (of_int (Prims.of_int (1019))) :: uu___1 in
      mix_list_lit uu___
  | FStarC_Syntax_Syntax.Meta_named l ->
      let uu___ =
        let uu___1 = let uu___2 = hash_lid l in [uu___2] in
        (of_int (Prims.of_int (1021))) :: uu___1 in
      mix_list_lit uu___
  | FStarC_Syntax_Syntax.Meta_labeled (s, r, uu___) ->
      let uu___1 =
        let uu___2 =
          let uu___3 = hash_doc_list s in
          let uu___4 =
            let uu___5 =
            ...
            [uu___5] in
          uu___3 :: uu___4 in
        (of_int (Prims.of_int (1031))) :: uu___2 in
      mix_list_lit uu___1
  | FStarC_Syntax_Syntax.Meta_desugared msi ->
      let uu___ =
        let uu___1 = let uu___2 = hash_meta_source_info msi in [uu___2] in
        (of_int (Prims.of_int (1033))) :: uu___1 in
      mix_list_lit uu___
  | FStarC_Syntax_Syntax.Meta_monadic (m1, t) ->
      let uu___ =
        let uu___1 =
          let uu___2 = hash_lid m1 in
          let uu___3 = let uu___4 = hash_term t in [uu___4] in uu___2 ::
            uu___3 in
        (of_int (Prims.of_int (1039))) :: uu___1 in
      mix_list_lit uu___
  | FStarC_Syntax_Syntax.Meta_monadic_lift (m0, m1, t) ->
      let uu___ =
        let uu___1 =
          let uu___2 = hash_lid m0 in
          let uu___3 =
            let uu___4 = hash_lid m1 in
            let uu___5 = let uu___6 = hash_term t in [uu___6] in uu___4 ::
              uu___5 in
          uu___2 :: uu___3 in
        (of_int (Prims.of_int (1069))) :: uu___1 in
      mix_list_lit uu___
and hash_meta_source_info (m : FStarC_Syntax_Syntax.meta_source_info) :
  ...
  | FStarC_Syntax_Syntax.Machine_integer sw ->
      let uu___ = hash_sw sw in mix (of_int (Prims.of_int (1069))) uu___
...
and hash_quoteinfo (qi : FStarC_Syntax_Syntax.quoteinfo) :
  ...
  mix uu___ uu___1
let ml_and (a : Prims.bool) (b : Prims.bool) : Prims.bool=
...
let rec equal_list :
  ...
  fun f l1 l2 ->
    ...
    | ([], []) -> true
    | (h1::t1, h2::t2) ->
        let uu___ = f h1 h2 in
        let uu___1 = equal_list f t1 t2 in ml_and uu___ uu___1
    | uu___ -> false
let equal_opt (f : 'a -> 'a -> Prims.bool)
  (o1 : 'a FStar_Pervasives_Native.option)
  (o2 : 'a FStar_Pervasives_Native.option) : Prims.bool=
  match (o1, o2) with
  | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> true
  | (FStar_Pervasives_Native.Some a1, FStar_Pervasives_Native.Some b) ->
      f a1 b
  | uu___ -> false
let equal_pair (f : 'a -> 'a -> Prims.bool) (g : 'b -> 'b -> Prims.bool)
  (x1 : ('a * 'b)) (x2 : ('a * 'b)) : Prims.bool=
  let uu___ =
    f (FStar_Pervasives_Native.fst x1) (FStar_Pervasives_Native.fst x2) in
  let uu___1 =
    g (FStar_Pervasives_Native.snd x1) (FStar_Pervasives_Native.snd x2) in
  ml_and uu___ uu___1
         ...
         (let uu___4 =
          ...
          | (FStarC_Syntax_Syntax.Tm_uinst (t11, u1),
             FStarC_Syntax_Syntax.Tm_uinst (t21, u2)) ->
              ...
              let uu___6 = equal_list equal_universe u1 u2 in
              ml_and uu___5 uu___6
          ...
          | (FStarC_Syntax_Syntax.Tm_abs
             ...
             { FStarC_Syntax_Syntax.bs = bs2;
              ...
              let uu___6 =
                ...
                let uu___8 = equal_opt equal_rc rc1 rc2 in
                ml_and uu___7 uu___8 in
              ml_and uu___5 uu___6
          | (FStarC_Syntax_Syntax.Tm_arrow
             ...
             { FStarC_Syntax_Syntax.bs1 = bs2;
              ...
              ->
              let uu___5 = equal_list equal_binder bs1 bs2 in
              let uu___6 = equal_comp c1 c2 in ml_and uu___5 uu___6
          | (FStarC_Syntax_Syntax.Tm_refine
             ...
             { FStarC_Syntax_Syntax.b = b2; FStarC_Syntax_Syntax.phi = t21;_})
              ...
              let uu___6 = equal_term t11 t21 in ml_and uu___5 uu___6
               ...
               | (hd1, args1) ->
                   ...
                   (match uu___8 with
                    | (hd2, args2) ->
                        ...
                        let uu___10 = equal_list equal_arg args1 args2 in
                        ml_and uu___9 uu___10))
          | (FStarC_Syntax_Syntax.Tm_match
             ...
             { FStarC_Syntax_Syntax.scrutinee = t21;
              ...
              let uu___5 = equal_term t11 t21 in
              let uu___6 =
                let uu___7 = equal_opt equal_match_returns asc_opt1 asc_opt2 in
                let uu___8 =
                  let uu___9 = equal_list equal_branch bs1 bs2 in
                  let uu___10 = equal_opt equal_rc ropt1 ropt2 in
                  ml_and uu___9 uu___10 in
                ml_and uu___7 uu___8 in
              ml_and uu___5 uu___6
          | (FStarC_Syntax_Syntax.Tm_ascribed
             ...
             { FStarC_Syntax_Syntax.tm = t21; FStarC_Syntax_Syntax.asc = a2;
              ...
              let uu___5 = equal_term t11 t21 in
              let uu___6 =
                let uu___7 = equal_ascription a1 a2 in
                let uu___8 = equal_opt FStarC_Ident.lid_equals l1 l2 in
                ml_and uu___7 uu___8 in
              ml_and uu___5 uu___6
          | (FStarC_Syntax_Syntax.Tm_let
             ...
             { FStarC_Syntax_Syntax.lbs = (r2, lbs2);
              ...
              ->
              let uu___5 =
                let uu___6 = equal_list equal_letbinding lbs1 lbs2 in
                let uu___7 = equal_term t11 t21 in ml_and uu___6 uu___7 in
              ml_and (r1 = r2) uu___5
          ...
          | (FStarC_Syntax_Syntax.Tm_meta
             ...
             { FStarC_Syntax_Syntax.tm2 = t21;
              ...
              ->
              let uu___5 = equal_term t11 t21 in
              let uu___6 = equal_meta m1 m2 in ml_and uu___5 uu___6
          ...
          | (FStarC_Syntax_Syntax.Tm_quoted (t11, q1),
             FStarC_Syntax_Syntax.Tm_quoted (t21, q2)) ->
              let uu___5 = equal_term t11 t21 in
              let uu___6 = equal_quoteinfo q1 q2 in ml_and uu___5 uu___6
             ...
             let uu___5 =
               ...
               let uu___7 =
                 equal_list equal_flag ct1.FStarC_Syntax_Syntax.flags
                   ct2.FStarC_Syntax_Syntax.flags in
               ml_and uu___6 uu___7 in
             ml_and uu___4 uu___5 in
           ml_and uu___2 uu___3 in
         ml_and
           (FStarC_Ident.lid_equals ct1.FStarC_Syntax_Syntax.effect_name
              ct2.FStarC_Syntax_Syntax.effect_name) uu___1
     | uu___1 -> false)
  ...
  then true
    ...
    (let uu___1 =
     ...
     let uu___2 =
       ...
       ml_and uu___3 uu___4 in
     ml_and uu___1 uu___2)
  ...
  | (b1, asc1) ->
      ...
      (match uu___1 with
       | (b2, asc2) ->
           ...
           let uu___3 = equal_ascription asc1 asc2 in ml_and uu___2 uu___3)
         ...
         (match uu___2 with
          | (a2, t2, b2) ->
              let uu___3 =
                ...
                | uu___4 -> false in
              let uu___4 =
                let uu___5 = equal_opt equal_term t1 t2 in
                ml_and uu___5 (b1 = b2) in
              ml_and uu___3 uu___4))
and equal_letbinding (l1 : FStarC_Syntax_Syntax.letbinding)
  ...
  then true
    ...
    (let uu___1 =
     ...
     let uu___2 =
       let uu___3 =
         equal_list FStarC_Ident.ident_equals l1.FStarC_Syntax_Syntax.lbunivs
           l2.FStarC_Syntax_Syntax.lbunivs in
       let uu___4 =
         let uu___5 =
           equal_term l1.FStarC_Syntax_Syntax.lbtyp
             l2.FStarC_Syntax_Syntax.lbtyp in
         let uu___6 =
           let uu___7 =
             let uu___8 =
               equal_term l1.FStarC_Syntax_Syntax.lbdef
                 l2.FStarC_Syntax_Syntax.lbdef in
             let uu___9 =
               equal_list equal_term l1.FStarC_Syntax_Syntax.lbattrs
                 l2.FStarC_Syntax_Syntax.lbattrs in
             ml_and uu___8 uu___9 in
           ml_and
             (FStarC_Ident.lid_equals l1.FStarC_Syntax_Syntax.lbeff
                l2.FStarC_Syntax_Syntax.lbeff) uu___7 in
         ml_and uu___5 uu___6 in
       ml_and uu___3 uu___4 in
     ml_and uu___1 uu___2)
and equal_uvar
  (x1 :
  ...
  | (u1, (s1, uu___1)) ->
      ...
      (match uu___2 with
       | (u2, (s2, uu___3)) ->
           ...
           let uu___5 = equal_list (equal_list equal_subst_elt) s1 s2 in
           ml_and uu___4 uu___5)
and equal_bv (b1 : FStarC_Syntax_Syntax.bv) (b2 : FStarC_Syntax_Syntax.bv) :
  ...
  then true
    ...
    (let uu___1 =
       equal_term b1.FStarC_Syntax_Syntax.sort b2.FStarC_Syntax_Syntax.sort in
     ml_and
       (FStarC_Ident.ident_equals b1.FStarC_Syntax_Syntax.ppname
          b2.FStarC_Syntax_Syntax.ppname) uu___1)
and equal_fv (f1 : FStarC_Syntax_Syntax.fv) (f2 : FStarC_Syntax_Syntax.fv) :
  Prims.bool=
  if FStarC_Util.physical_equality f1 f2
  then true
  else
     ...
     | (t1, a1) ->
         ...
         (match uu___2 with
          | (t2, a2) ->
              ...
              let uu___4 = equal_opt equal_arg_qualifier a1 a2 in
              ml_and uu___3 uu___4))
and equal_bqual
...
and equal_branch
  ...
  | (p1, w1, t1) ->
      ...
      (match uu___1 with
       | (p2, w2, t2) ->
           let uu___2 = equal_pat p1 p2 in
           let uu___3 =
             let uu___4 = equal_opt equal_term w1 w2 in
             let uu___5 = equal_term t1 t2 in ml_and uu___4 uu___5 in
           ml_and uu___2 uu___3)
and equal_pat
  (p1 : FStarC_Syntax_Syntax.pat' FStarC_Syntax_Syntax.withinfo_t)
  (p2 : FStarC_Syntax_Syntax.pat' FStarC_Syntax_Syntax.withinfo_t) :
  Prims.bool=
  if FStarC_Util.physical_equality p1 p2
  then true
  else
    (match ((p1.FStarC_Syntax_Syntax.v), (p2.FStarC_Syntax_Syntax.v)) with
     ...
     | (FStarC_Syntax_Syntax.Pat_cons (fv1, us1, args1),
        FStarC_Syntax_Syntax.Pat_cons (fv2, us2, args2)) ->
         ...
         let uu___2 =
           let uu___3 = equal_opt (equal_list equal_universe) us1 us2 in
           let uu___4 =
             equal_list (equal_pair equal_pat equal_poly) args1 args2 in
           ml_and uu___3 uu___4 in
         ml_and uu___1 uu___2
...
and equal_meta (m1 : FStarC_Syntax_Syntax.metadata)
  ...
  | (FStarC_Syntax_Syntax.Meta_pattern (ts1, args1),
     FStarC_Syntax_Syntax.Meta_pattern (ts2, args2)) ->
      let uu___ = equal_list equal_term ts1 ts2 in
      let uu___1 = equal_list (equal_list equal_arg) args1 args2 in
      ml_and uu___ uu___1
  ...
  | (FStarC_Syntax_Syntax.Meta_labeled (s1, r1, uu___),
     FStarC_Syntax_Syntax.Meta_labeled (s2, r2, uu___1)) ->
      ml_and (s1 = s2) ((FStarC_Range_Ops.compare r1 r2) = Prims.int_zero)
  ...
  | (FStarC_Syntax_Syntax.Meta_monadic (m11, t1),
     FStarC_Syntax_Syntax.Meta_monadic (m21, t2)) ->
      ...
      ml_and (FStarC_Ident.lid_equals m11 m21) uu___
  | (FStarC_Syntax_Syntax.Meta_monadic_lift (m11, n1, t1),
     FStarC_Syntax_Syntax.Meta_monadic_lift (m21, n2, t2)) ->
      let uu___ =
        let uu___1 = equal_term t1 t2 in
        ml_and (FStarC_Ident.lid_equals n1 n2) uu___1 in
      ml_and (FStarC_Ident.lid_equals m11 m21) uu___
  | uu___ -> false
  ...
  let uu___ =
    let uu___1 =
      equal_list equal_term
        ...
        (FStar_Pervasives_Native.snd q2.FStarC_Syntax_Syntax.antiquotations) in
    ml_and
      ...
      uu___1 in
  ml_and (q1.FStarC_Syntax_Syntax.qkind = q2.FStarC_Syntax_Syntax.qkind)
    uu___
  ...
  let uu___ =
    let uu___1 =
      equal_opt equal_term r1.FStarC_Syntax_Syntax.residual_typ
        r2.FStarC_Syntax_Syntax.residual_typ in
    let uu___2 =
      equal_list equal_flag r1.FStarC_Syntax_Syntax.residual_flags
        r2.FStarC_Syntax_Syntax.residual_flags in
    ml_and uu___1 uu___2 in
  ml_and
    (FStarC_Ident.lid_equals r1.FStarC_Syntax_Syntax.residual_effect
       r2.FStarC_Syntax_Syntax.residual_effect) uu___
...
and equal_decreases_order (d1 : FStarC_Syntax_Syntax.decreases_order)
  ...
  | (FStarC_Syntax_Syntax.Decreases_wf (t1, t1'),
     FStarC_Syntax_Syntax.Decreases_wf (t2, t2')) ->
      let uu___ = equal_term t1 t2 in
      let uu___1 = equal_term t1' t2' in ml_and uu___ uu___1
  | uu___ -> false
and equal_arg_qualifier (a1 : FStarC_Syntax_Syntax.arg_qualifier)
  ...
  let uu___ =
    equal_list equal_term a1.FStarC_Syntax_Syntax.aqual_attributes
      a2.FStarC_Syntax_Syntax.aqual_attributes in
  ml_and
    (a1.FStarC_Syntax_Syntax.aqual_implicit =
       a2.FStarC_Syntax_Syntax.aqual_implicit) uu___
and equal_lbname
  (l1 :
    (FStarC_Syntax_Syntax.bv, FStarC_Syntax_Syntax.fv)
      FStar_Pervasives.either)
...
and equal_subst_elt (s1 : FStarC_Syntax_Syntax.subst_elt)
  ...
  | (FStarC_Syntax_Syntax.DB (i1, bv1), FStarC_Syntax_Syntax.DB (i2, bv2)) ->
      let uu___ = equal_bv bv1 bv2 in ml_and (i1 = i2) uu___
...
let deq_term : FStarC_Syntax_Syntax.term FStarC_Class_Deq.deq=
  { FStarC_Class_Deq.op_Equals_Question = equal_term }
type 'a term_map = (FStarC_Syntax_Syntax.term, 'a) FStarC_HashMap.hashmap
let term_map_empty (uu___ : unit) : 'a term_map= FStarC_HashMap.empty ()
let term_map_add (t : FStarC_Syntax_Syntax.term) (v : 'a) (m : 'a term_map) :
  'a term_map= FStarC_HashMap.add deq_term hashable_term t v m
let term_map_lookup (t : FStarC_Syntax_Syntax.term) (m : 'a term_map) :
  'a FStar_Pervasives_Native.option=
  FStarC_HashMap.lookup deq_term hashable_term t m
let term_map_mem (t : FStarC_Syntax_Syntax.term) (m : 'a term_map) :
  Prims.bool= FStarC_HashMap.mem deq_term hashable_term t m
let term_map_fold (f : FStarC_Syntax_Syntax.term -> 'a -> 'b -> 'b)
  (m : 'a term_map) (i : 'b) : 'b=
  FStarC_HashMap.fold deq_term hashable_term f m i
