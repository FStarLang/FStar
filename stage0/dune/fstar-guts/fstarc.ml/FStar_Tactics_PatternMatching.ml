open Prims
let fetch_eq_side (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
              ...
              | FStar_Tactics_NamedView.Tv_App (eq_type_x, (y, uu___3)) ->
                  ...
                  (match x4 with
                   | FStar_Tactics_NamedView.Tv_App (eq_type, (x5, uu___4))
                       ...
                       (match x6 with
                        | FStar_Tactics_NamedView.Tv_App (eq, (typ, uu___5))
                            ->
                            let x7 = FStar_Tactics_NamedView.inspect eq ps in
                            (match x7 with
                             | FStar_Tactics_NamedView.Tv_UInst (eq1, uu___6)
                                 ->
                                 if
                   ...
                   | uu___4 -> FStar_Tactics_V2_Derived.fail "not an app2" ps)
              | uu___3 ->
                  FStar_Tactics_V2_Derived.fail "not an app under squash" ps)
              ...
              | FStar_Tactics_NamedView.Tv_App (eq_type_x, (y, uu___2)) ->
                  ...
                  (match x4 with
                   | FStar_Tactics_NamedView.Tv_App (eq_type, (x5, uu___3))
                       ...
                       let x6 = FStar_Tactics_NamedView.inspect eq_type ps in
                       (match x6 with
                        | FStar_Tactics_NamedView.Tv_App (eq, (typ, uu___4))
                            ->
                            let x7 = FStar_Tactics_NamedView.inspect eq ps in
                            (match x7 with
                             | FStar_Tactics_NamedView.Tv_UInst (eq1, uu___5)
                                 ->
                                 if
                                   (FStar_Reflection_V2_Derived.fv_to_string
                                      eq1)
                        ...
                        | uu___4 ->
                            FStar_Tactics_V2_Derived.fail "not an app3" ps)
                   | uu___3 -> FStar_Tactics_V2_Derived.fail "not an app2" ps)
              | uu___2 ->
                  FStar_Tactics_V2_Derived.fail "not an app under squash" ps)
           else FStar_Tactics_V2_Derived.fail "not a squash" ps
       | uu___2 ->
           FStar_Tactics_V2_Derived.fail "not an app of fvar at top level" ps)
  | uu___1 -> FStar_Tactics_V2_Derived.fail "not an app at top level" ps
let mustfail (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (message : Prims.string) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
...
let implies_intro' (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate)
  : unit= let x = FStar_Tactics_V2_Logic.implies_intro () ps in ()
let repeat' (f : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = FStar_Tactics_V2_Derived.repeat f ps in ()
...
let op_let_Question (f : 'a match_res)
  (g : 'a -> FStarC_Tactics_Types.ref_proofstate -> 'b match_res) :
  FStarC_Tactics_Types.ref_proofstate -> 'b match_res=
      ...
      (fun uu___ ->
         ...
         | (nm, tm) ->
             (fun ps1 ->
                let x1 =
                  let x2 =
                    let x3 = FStarC_Tactics_V2_Builtins.term_to_string tm ps1 in
                    Prims.strcat ": " x3 in
...
let rec interp_pattern_aux (pat : pattern) (cur_bindings : bindings)
  ...
  (ps : FStarC_Tactics_Types.ref_proofstate) : bindings match_res=
    ...
    | FStar_Tactics_NamedView.Tv_App (hd, (arg, uu___)) ->
        ...
        op_let_Question x5
          (fun with_hd ps2 ->
             ...
             op_let_Question x6 (fun with_arg uu___1 -> return with_arg) ps2)
          ps1
    | uu___ -> raise (SimpleMismatch (pat, tm1)) in
  match pat with
...
let interp_pattern (pat : pattern) (tm : FStar_Tactics_NamedView.term)
  ...
  op_let_Question x
    (fun rev_bindings uu___ -> return (FStar_List_Tot_Base.rev rev_bindings))
    ps
let match_term (pat : pattern) (tm : FStar_Tactics_NamedView.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : bindings=
  let x =
...
let debug (msg : 'uuuuu) (uu___ : FStarC_Tactics_Types.ref_proofstate) :
  unit= ()
        ...
        (fun uu___ ->
           ...
           | (nm, binding) ->
               (fun ps1 ->
                  let x3 =
                    let x4 =
                      FStar_Tactics_V2_Derived.binding_to_string binding ps1 in
                    Prims.strcat ": " x4 in
...
let ms_locate_hyp (solution : matching_solution) (name : varname) :
  FStarC_Tactics_Types.ref_proofstate -> hypothesis=
    ...
    varname ->
      pattern ->
        hypothesis Prims.list ->
          (matching_solution -> FStarC_Tactics_Types.ref_proofstate -> 'a) ->
            matching_solution -> FStarC_Tactics_Types.ref_proofstate -> 'a
  =
...
let solve_mp (problem : matching_problem)
  ...
  (body : matching_solution -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a=
  let x =
...
let rec pattern_of_term_ex (tm : FStarC_Reflection_Types.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : pattern match_res=
  ...
  | FStar_Tactics_NamedView.Tv_App (f, (x1, uu___)) ->
      ...
      op_let_Question x2
        (fun fpat ps1 ->
           ...
           op_let_Question x3 (fun xpat uu___1 -> return (PApp (fpat, xpat)))
             ps1) ps
...
let pattern_of_term (tm : FStarC_Reflection_Types.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : pattern=
...
let classify_abspat_binder (b : FStar_Tactics_NamedView.binder)
  ...
  (abspat_binder_kind * FStar_Tactics_NamedView.term)=
  let x = "v" in
  ...
  | Success uu___ ->
      FStar_Tactics_V2_Derived.fail "classifiy_abspat_binder: impossible (1)"
        ps
  | Failure uu___ ->
...
let interp_abspat_continuation (continuation : abspat_continuation)
  ...
  FStarC_Tactics_V2_Builtins.unquote x ps
let interp_abspat (abspat : 'a) (ps : FStarC_Tactics_Types.ref_proofstate) :
  (matching_problem * abspat_continuation)=
  ...
  (k :
    abspat_continuation ->
      FStarC_Tactics_Types.ref_proofstate ->
        matching_solution -> FStarC_Tactics_Types.ref_proofstate -> 'b)
...
let inspect_abspat_problem (abspat : 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : matching_problem=
  let x = interp_abspat abspat ps in FStar_Pervasives_Native.fst x
let inspect_abspat_solution (abspat : 'a) :
  FStarC_Tactics_Types.ref_proofstate -> matching_solution=
  match_abspat abspat (fun uu___ uu___1 solution uu___2 -> solution)
let tpair (x : 'a) (uu___ : FStarC_Tactics_Types.ref_proofstate) (y : 'b)
  (uu___1 : FStarC_Tactics_Types.ref_proofstate) : ('a * 'b)= (x, y)
...
let pm (abspat : 'a) : FStarC_Tactics_Types.ref_proofstate -> 'b=
