                ...
                let quant_with_pre rel vars precondition body rng x1 =
                  let xname_decl =
                    ...
                    FStarC_SMTEncoding_Term.DeclFun
                      (x1, uu___3, FStarC_SMTEncoding_Term.Term_sort,
                      ...
                      let uu___8 =
                        ...
                        let uu___10 =
                          let uu___11 =
                            ...
                            (FStarC_Parser_Const.op_Not, uu___12) in
                          let uu___12 =
                            let uu___13 =
                              let uu___14 =
                                let uu___15 =
                                ...
                                let uu___18 =
                                  ...
                                  let uu___20 =
                                    let uu___21 =
                                      ...
                                      (FStarC_Parser_Const.op_Minus, uu___22) in
                                    let uu___22 =
                                      let uu___23 =
                                        let uu___24 =
                                          let uu___25 =
                ...
                let mk l v =
                  let uu___3 =
                    FStarC_List.find
                      (fun uu___4 ->
                         match uu___4 with
                         | (l', uu___5) -> FStarC_Ident.lid_equals l l')
                      prims1 in
                  match uu___3 with
                  | FStar_Pervasives_Native.Some (uu___4, b) ->
                      b (FStarC_Ident.range_of_lid l) v
                  | FStar_Pervasives_Native.None ->
                      FStarC_Effect.failwith "prims mk: not found" in
                let is l =
               ...
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
                               ...
                               let uu___12 =
                                 let uu___13 =
                                   FStarC_SMTEncoding_Util.mkApp
                                     ("PreType", [xx]) in
                                 [uu___13] in
                               ("Term_constr_id", uu___12) in
                             FStarC_SMTEncoding_Util.mkApp uu___11 in
                           (uu___9, uu___10) in
                         FStarC_SMTEncoding_Util.mkEq uu___8
                       else
                         (let uu___8 =
                            let uu___9 =
                     ...
                     (xx_has_type, uu___7) in
                   FStarC_SMTEncoding_Util.mkImp uu___6 in
                 ([[xx_has_type]],
                   ((FStarC_SMTEncoding_Term.mk_fv
                       (xxsym, FStarC_SMTEncoding_Term.Term_sort)) ::
                   (FStarC_SMTEncoding_Term.mk_fv
                      (ffsym, FStarC_SMTEncoding_Term.Fuel_sort)) :: vars),
                   uu___5) in
...
let primitive_type_axioms :
  ...
  let mkForall_fuel env =
    FStarC_SMTEncoding_EncodeTerm.mkForall_fuel
      (FStarC_Ident.string_of_lid (FStarC_TypeChecker_Env.current_module env)) in
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            ...
            mkForall_fuel env (FStarC_TypeChecker_Env.get_range env) uu___5 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Term.boxBool b in [uu___6] in
              [uu___5] in
            let uu___5 =
              let uu___6 = FStarC_SMTEncoding_Term.boxBool b in
  ...
  let mk_int env nm tt =
    let lex_t =
      FStarC_SMTEncoding_Util.mkFreeV
        (FStarC_SMTEncoding_Term.mk_fv
           ((FStarC_Ident.string_of_lid FStarC_Parser_Const.lex_t_lid),
             FStarC_SMTEncoding_Term.Term_sort)) in
    let typing_pred = FStarC_SMTEncoding_Term.mk_HasType x tt in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Term.boxInt b in [uu___6] in
              [uu___5] in
            let uu___5 =
              let uu___6 = FStarC_SMTEncoding_Term.boxInt b in
              FStarC_SMTEncoding_Term.mk_HasType uu___6 tt in
            (uu___4, [bb], uu___5) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Term.boxReal b in [uu___6] in
              [uu___5] in
            let uu___5 =
              let uu___6 = FStarC_SMTEncoding_Term.boxReal b in
              FStarC_SMTEncoding_Term.mk_HasType uu___6 tt in
            (uu___4, [bb], uu___5) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Term.boxString b in [uu___6] in
              [uu___5] in
            let uu___5 =
              let uu___6 = FStarC_SMTEncoding_Term.boxString b in
              FStarC_SMTEncoding_Term.mk_HasType uu___6 tt in
            (uu___4, [bb], uu___5) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            let uu___5 =
              let uu___6 =
                let uu___7 = FStarC_SMTEncoding_Util.mkAnd (valid_a, valid_b) in
                (uu___7, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___6 in
            ([[l_and_a_b]], [aa; bb], uu___5) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___4 in
      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            let uu___5 =
              let uu___6 =
                let uu___7 = FStarC_SMTEncoding_Util.mkOr (valid_a, valid_b) in
                (uu___7, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___6 in
            ([[l_or_a_b]], [aa; bb], uu___5) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___4 in
        (uu___3, (FStar_Pervasives_Native.Some "\\/ interpretation"),
          "l_or-interp") in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Util.mkEq (x1, y1) in
                (uu___6, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___5 in
            ([[eq2_x_y]], [uu; aa; xx1; yy1], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
          ...
          let uu___3 =
            let uu___4 =
              let uu___5 =
                ...
                (uu___6, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___5 in
            ([[eq3_x_y]], [uu; aa; bb; xx1; yy1], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Util.mkImp (valid_a, valid_b) in
                (uu___6, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___5 in
            ([[l_imp_a_b]], [aa; bb], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Util.mkIff (valid_a, valid_b) in
                (uu___6, valid) in
              FStarC_SMTEncoding_Util.mkIff uu___5 in
            ([[l_iff_a_b]], [aa; bb], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
        (uu___2, (FStar_Pervasives_Native.Some "<==> interpretation"),
          "l_iff-interp") in
  ...
  let mk_not_interp env l_not tt =
    ...
    let uu___ =
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 = FStarC_SMTEncoding_Util.mkIff (not_valid_a, valid) in
            ([[l_not_a]], [aa], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let body =
      ...
      let uu___ =
        let uu___1 = FStarC_SMTEncoding_Util.mkImp (hastypeZ, hastypeS) in
        ([[hastypeZ]], [xx1], uu___1) in
      FStarC_SMTEncoding_Term.mkForall (FStarC_TypeChecker_Env.get_range env)
        uu___ in
    let uu___ =
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 = FStarC_SMTEncoding_Util.mkImp (valid, body) in
            ([[inversion_t]], [uu; tt1], uu___4) in
          FStarC_SMTEncoding_Term.mkForall
            (FStarC_TypeChecker_Env.get_range env) uu___3 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = FStarC_SMTEncoding_Util.mkEq (with_type_t_e, e) in
                let uu___7 =
                  FStarC_SMTEncoding_Term.mk_HasType with_type_t_e t in
                (uu___6, uu___7) in
              FStarC_SMTEncoding_Util.mkAnd uu___5 in
            ([[with_type_t_e]],
  ...
  | us ->
      ...
      (match body1 with
       | FStarC_SMTEncoding_Term.Quant
           (FStarC_SMTEncoding_Term.Forall, pats, wopt, sorts, body2, r) ->
           FStarC_SMTEncoding_Term.mkForall'' r
             (pats, wopt, (FStarC_List.op_At csorts sorts), body2)
       | uu___ ->
           FStarC_SMTEncoding_Term.mkForall''
             (FStarC_SMTEncoding_Term.range_of_term body1)
      ...
      let form1 =
        let uu___1 =
          ...
          FStarC_Class_Setlike.elems
            ...
            uu___2 in
        forall_univs (FStarC_Syntax_Syntax.range_of_fv fv) uu___1 form in
      let uu___1 =
        let uu___2 =
          let uu___3 =
            FStarC_SMTEncoding_Util.mkAssume
              (form1,
                (FStar_Pervasives_Native.Some
                   (Prims.strcat "Lemma: " (FStarC_Ident.string_of_lid lid))),
                (Prims.strcat "lemma_" (FStarC_Ident.string_of_lid lid))) in
          [uu___3] in
...
let smt_arity_attribute (env : FStarC_SMTEncoding_Env.env_t)
  (lid : FStarC_Ident.lident) : Prims.int FStar_Pervasives_Native.option=
  let uu___ =
    FStarC_TypeChecker_Env.lookup_attrs_of_lid
      env.FStarC_SMTEncoding_Env.tcenv lid in
  match uu___ with
  | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
  | FStar_Pervasives_Native.Some attrs ->
      let uu___1 =
        FStarC_Syntax_Util.get_attribute FStarC_Parser_Const.smt_arity_attr
          attrs in
      (match uu___1 with
       | FStar_Pervasives_Native.Some ((a, uu___2)::uu___3) ->
           let uu___4 =
             let uu___5 = FStarC_Syntax_Subst.compress a in
                ...
                let uu___6 =
                  ...
                  let uu___8 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                      a in
                  FStarC_Format.fmt2
                    "Expected an integer literal in [@@smt_arity] on %s, got %s"
                    uu___7 uu___8 in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                FStarC_Syntax_Util.is_pure_or_ghost_function t_norm in
              if uu___5
              then true
              else
            ...
            Prims.not uu___4 in
          if uu___3 then true else FStarC_Syntax_Util.is_lemma t_norm in
        if uu___2 then true else uninterpreted in
      if uu___1
      then
        let arg_sorts =
          let uu___2 =
          ...
          | FStarC_Syntax_Syntax.Tm_arrow uu___3 ->
              let bs =
                let uu___4 =
                  FStarC_Syntax_Util.arrow_node_formals_comp_ln t_norm in
                FStar_Pervasives_Native.fst uu___4 in
              let bs1 =
                match arity_hint with
                | FStar_Pervasives_Native.Some n when
                    n < (FStarC_List.length bs) ->
                    FStar_Pervasives_Native.fst (FStarC_Util.first_N n bs)
                | uu___4 -> bs in
              FStarC_List.map
                (fun uu___4 -> FStarC_SMTEncoding_Term.Term_sort) bs1
          | uu___3 -> [] in
        ...
        (let encode_non_total_function_typ =
           (FStarC_Ident.nsstr lid) <> "Prims" in
         let n_indexed_formals d =
           let ty_lid =
             FStarC_TypeChecker_Env.typ_of_datacon
               env.FStarC_SMTEncoding_Env.tcenv d in
           let uu___2 =
             FStarC_TypeChecker_Env.lookup_lid
               env.FStarC_SMTEncoding_Env.tcenv ty_lid in
           match uu___2 with
           | ((uu___3, k), uu___4) ->
               let uu___5 =
                 let uu___6 = FStarC_Syntax_Util.arrow_formals_comp_ln k in
           ...
           FStarC_List.tryPick
             (fun uu___2 ->
                ...
                | FStarC_Syntax_Syntax.Discriminator d ->
                    let uu___3 =
                      let uu___4 = n_indexed_formals d in
                      uu___4 + Prims.int_one in
                    FStar_Pervasives_Native.Some uu___3
                | FStarC_Syntax_Syntax.Projector (d, uu___3) ->
                    let uu___4 =
                      let uu___5 = n_indexed_formals d in
                      uu___5 + Prims.int_one in
                    FStar_Pervasives_Native.Some uu___4
                | uu___3 -> FStar_Pervasives_Native.None) quals in
         let structural_arity1 =
           match arity_hint with
           | FStar_Pervasives_Native.Some uu___2 -> arity_hint
           | FStar_Pervasives_Native.None -> structural_arity in
         let uu___2 =
           let uu___3 =
           ...
           | (args, comp) ->
               let uu___4 =
                 match structural_arity1 with
                 | FStar_Pervasives_Native.Some n when
                     n < (FStarC_List.length args) ->
                     let uu___5 = FStarC_Util.first_N n args in
                     (match uu___5 with
                      | (args1, rest) ->
                          let uu___6 =
                            let uu___7 = FStarC_Syntax_Util.arrow rest comp in
                ...
                | (args1, comp1) ->
                    let tcenv_comp =
                      FStarC_TypeChecker_Env.push_binders
                        env.FStarC_SMTEncoding_Env.tcenv args1 in
                    let comp2 =
                      let uu___5 =
                        FStarC_SMTEncoding_Util.is_smt_reifiable_comp
                          env.FStarC_SMTEncoding_Env.tcenv comp1 in
                      if uu___5
                      then
                        let uu___6 =
                          FStarC_TypeChecker_Env.reify_comp
                            {
                              ...
                              FStarC_TypeChecker_Env.iface_todo =
                                (tcenv_comp.FStarC_TypeChecker_Env.iface_todo);
                              FStarC_TypeChecker_Env.iface_hidden =
                                (tcenv_comp.FStarC_TypeChecker_Env.iface_hidden);
                              FStarC_TypeChecker_Env.iface_lids =
                                (tcenv_comp.FStarC_TypeChecker_Env.iface_lids);
                              FStarC_TypeChecker_Env.iface_val_lids =
                                (tcenv_comp.FStarC_TypeChecker_Env.iface_val_lids)
                            } comp1 FStarC_Syntax_Syntax.U_unknown in
                        FStarC_Syntax_Syntax.mk_Total uu___6
                      else comp1 in
                    ...
                    then
                      ...
                      (args1,
                        (FStar_Pervasives_Native.None,
                          (FStarC_Syntax_Util.comp_result comp2)))) in
         match uu___2 with
         | (formals, (pre_opt, res_t)) ->
             let mk_disc_proj_axioms guard encoded_res_t vapp vars =
               let scrutinee_and_extra d =
                 let n_params = n_indexed_formals d in
                 if
                   (n_params < Prims.int_zero) ||
                     ((FStarC_List.length vars) <= n_params)
                 then FStar_Pervasives_Native.None
                 else
                   (let uu___3 = FStarC_Util.first_N n_params vars in
                    match uu___3 with
                    | (uu___4, rest) ->
                        (match rest with
                         | xxv::extra ->
                             FStar_Pervasives_Native.Some (xxv, extra)
                         | [] -> FStar_Pervasives_Native.None)) in
               let apply_extra tm extra =
                 FStarC_List.fold_left
                   (fun tm1 v ->
                      let uu___3 =
                        FStarC_SMTEncoding_Util.mkFreeV
                          (FStarC_SMTEncoding_Term.mk_fv
                             ((FStarC_SMTEncoding_Term.fv_name v),
                               FStarC_SMTEncoding_Term.Term_sort)) in
                      FStarC_SMTEncoding_Util.mk_ApplyTT tm1 uu___3) tm extra in
               FStarC_List.collect
                 (fun uu___3 ->
                    match uu___3 with
                    | FStarC_Syntax_Syntax.Discriminator d ->
                        let uu___4 = scrutinee_and_extra d in
                        (match uu___4 with
                         | FStar_Pervasives_Native.None -> []
                         | FStar_Pervasives_Native.Some (xxv, extra) ->
                             let xx =
                               FStarC_SMTEncoding_Util.mkFreeV
                                 (FStarC_SMTEncoding_Term.mk_fv
                                    ((FStarC_SMTEncoding_Term.fv_name xxv),
                                      FStarC_SMTEncoding_Term.Term_sort)) in
                             let disc =
                               let uu___5 =
                                 let uu___6 =
                                   FStarC_SMTEncoding_Term.mk_tester
                                     (FStarC_SMTEncoding_Env.escape
                                        (FStarC_Ident.string_of_lid d)) xx in
                                 FStarC_SMTEncoding_Term.boxBool uu___6 in
                               apply_extra uu___5 extra in
                             let uu___5 =
                               let uu___6 =
                                 let uu___7 =
                                   let uu___8 =
             ...
             (match uu___3 with
              | (vars, guards, env', decls1, uu___4) ->
                  let guards1 =
                    ...
                    then
                      ...
                      | x::y::[] ->
                          ...
                          let uu___6 =
                            let uu___7 = FStarC_SMTEncoding_Util.mkFreeV x in
                            FStarC_SMTEncoding_Term.mk_HasType uu___7 prop_ty in
                          let uu___7 =
                            let uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  let uu___11 =
                                    let uu___12 =
                                      let uu___13 =
                                        FStarC_SMTEncoding_Util.mkFreeV x in
                                      [uu___13] in
                                    ("Valid", uu___12) in
                                  FStarC_SMTEncoding_Util.mkApp uu___11 in
                                let uu___11 =
                                  let uu___12 =
                                    FStarC_SMTEncoding_Util.mkFreeV y in
                                  FStarC_SMTEncoding_Term.mk_HasType uu___12
                                    prop_ty in
                                (uu___10, uu___11) in
                              FStarC_SMTEncoding_Util.mkImp uu___9 in
                            [uu___8] in
                  ...
                  let uu___5 =
                    match pre_opt with
                    | FStar_Pervasives_Native.None ->
                        let uu___6 = FStarC_SMTEncoding_Util.mk_and_l guards1 in
                        (uu___6, decls1)
                         ...
                         | (g, ds) ->
                             let uu___7 =
                               FStarC_SMTEncoding_Util.mk_and_l (g ::
                                 guards1) in
                             (uu___7, (FStarC_List.op_At decls1 ds))) in
                  (match uu___5 with
                   | (guard, decls11) ->
                       let dummy_var =
                         FStarC_SMTEncoding_Term.mk_fv
                       ...
                       let dummy_tm =
                         FStarC_SMTEncoding_Term.mkFreeV dummy_var in
                       let should_thunk uu___6 =
                         let is_type t =
                           let uu___7 =
                             let uu___8 = FStarC_Syntax_Subst.compress t in
                             uu___8.FStarC_Syntax_Syntax.n in
                           match uu___7 with
                           | FStarC_Syntax_Syntax.Tm_type uu___8 -> true
                           | uu___8 -> false in
                         let is_squash t =
                           let uu___7 =
                             FStarC_Syntax_Util.head_and_args_full t in
                           match uu___7 with
                           | (head, uu___8) ->
                               let uu___9 =
                                 let uu___10 =
                                          ...
                                          FStarC_Syntax_Syntax.sort =
                                            {
                                              ...
                                              FStarC_Syntax_Syntax.hash_code
                                                = uu___13;_};_};
                                      FStarC_Syntax_Syntax.phi = uu___14;_}
                                    ->
                                    FStarC_Syntax_Syntax.fv_eq_lid fv1
                         ...
                         let uu___7 =
                           if
                             (((FStarC_Ident.nsstr lid) <> "Prims") &&
                                (match us with | [] -> true | uu___8 -> false))
                               &&
                               (Prims.not
                                  (FStarC_List.contains
                                     FStarC_Syntax_Syntax.Logic quals))
                           then
                             let uu___8 = is_squash t_norm in
                             Prims.not uu___8
                           else false in
                         if uu___7
                         then let uu___8 = is_type t_norm in Prims.not uu___8
                         else false in
                       let uu___6 =
                         match vars with
                         | [] when should_thunk () -> (true, [dummy_var])
                         | uu___7 -> (false, vars) in
                       (match uu___6 with
                        | (thunked, vars1) ->
                             ...
                             | (vname, vtok_opt, env1) ->
                                 ...
                                 let vtok_tm =
                                   ...
                                   | [] when thunked ->
                                       FStarC_SMTEncoding_Util.mkApp
                                         (vname, [dummy_tm])
                                   | [] when Prims.not thunked ->
                                       FStarC_SMTEncoding_Util.mkApp
                                         (vname, univs)
                                   | uu___8 ->
                                       let uu___9 =
                                         let uu___10 = get_vtok () in
                                         (uu___10, univs) in
                                     ...
                                     let uu___9 =
                                       let uu___10 =
                                         FStarC_List.map
                                           FStarC_SMTEncoding_Util.mkFreeV
                                           vars1 in
                                       FStarC_List.op_At univs uu___10 in
                                     (vname, uu___9) in
                                   FStarC_SMTEncoding_Util.mkApp uu___8 in
                                 let uu___8 =
                                   let vname_decl =
                                     let uu___9 =
                                       let uu___10 =
                                         FStarC_List.map
                                           ...
                                           vars1 in
                                       FStarC_List.op_At univ_sorts uu___10 in
                                     FStarC_SMTEncoding_Term.DeclFun
                                       (vname, uu___9,
                                         FStarC_SMTEncoding_Term.Term_sort,
                                         FStar_Pervasives_Native.None) in
                                       ...
                                       let tok_typing1 =
                                         close_universes
                                           (FStarC_Syntax_Syntax.range_of_fv
                                              fv) univ_fvs vtok_tm tok_typing in
                                       let uu___10 =
                                         match vars1 with
                                         | [] ->
                                             let tok_typing2 =
                                  ...
                                  | (decls2, env2) ->
                                      let uu___9 =
                                        ...
                                        | (encoded_res_t, decls) ->
                                            ...
                                            (encoded_res_t, uu___11, decls) in
                                      (match uu___9 with
                                                   ...
                                                   let uu___13 =
                                                     let uu___14 =
                                                       let uu___15 =
                                                         ...
                                                         typingAx :: uu___16 in
                                                       FStarC_List.op_At
                                                         uu___15 prim_defn in
                                                     FStarC_List.op_At
                                                       freshness uu___14 in
                                                   FStarC_SMTEncoding_Term.mk_decls_trivial
                                                     uu___13 in
...
let declare_top_level_let (env : FStarC_SMTEncoding_Env.env_t)
  ...
  match FStarC_SMTEncoding_Env.lookup_fvar_binding env
...
let encode_top_level_val (uninterpreted : Prims.bool)
  ...
  let tt =
    if
      (FStarC_Ident.nsstr (FStarC_Syntax_Syntax.lid_of_fv fv)) =
        "FStar.Ghost"
    then
      norm_with_steps
        [FStarC_TypeChecker_Env.Eager_unfolding;
...
let uu___is_Let_rec_unencodeable (projectee : Prims.exn) : Prims.bool= true
      ...
      let destruct_bound_function target_arity t e =
        let tcenv =
          let uu___1 = env.FStarC_SMTEncoding_Env.tcenv in
          {
            ...
            FStarC_TypeChecker_Env.iface_todo =
              (uu___1.FStarC_TypeChecker_Env.iface_todo);
            FStarC_TypeChecker_Env.iface_hidden =
              (uu___1.FStarC_TypeChecker_Env.iface_hidden);
            FStarC_TypeChecker_Env.iface_lids =
              (uu___1.FStarC_TypeChecker_Env.iface_lids);
            FStarC_TypeChecker_Env.iface_val_lids =
              (uu___1.FStarC_TypeChecker_Env.iface_val_lids)
          } in
              ...
              (match uu___2 with
               | (formals, comp) ->
                   let uu___3 =
                     ...
                     | FStar_Pervasives_Native.Some n when
                         n < (FStarC_List.length formals) ->
                         let uu___4 = FStarC_Util.first_N n formals in
                         (match uu___4 with
                          | (formals1, rest) ->
                              let uu___5 =
                                let uu___6 =
                                  FStarC_Syntax_Util.arrow rest comp in
                                FStarC_Syntax_Syntax.mk_Total uu___6 in
                              (formals1, uu___5))
                     | uu___4 -> (formals, comp) in
                   (match uu___3 with
                    | (formals1, comp1) ->
                        let nformals = FStarC_List.length formals1 in
                        let nbinders = FStarC_List.length binders in
                        let uu___4 =
                          if nformals < nbinders
                          then
                            let uu___5 = FStarC_Util.first_N nformals binders in
                            match uu___5 with
                            | (bs0, rest) ->
                                let body1 =
                                  FStarC_Syntax_Util.abs rest body lopt in
                                let uu___6 = subst_comp formals1 bs0 comp1 in
                                (bs0, body1, uu___6)
                          else
                            if nformals > nbinders
                            then
                              (let uu___5 =
                                 eta_expand binders formals1 body
                                   (FStarC_Syntax_Util.comp_result comp1) in
                               match uu___5 with
                               | (binders1, body1) ->
                                   let uu___6 =
                                     subst_comp formals1 binders1 comp1 in
                                   (binders1, body1, uu___6))
                            else
                              (let uu___5 = subst_comp formals1 binders comp1 in
                               (binders, body, uu___5)) in
                        (match uu___4 with
                         | (binders1, body1, comp2) ->
                             (binders1, body1, comp2)))) in
                                ...
                                | (us, t) ->
                                    let env2 =
                                          ...
                                          us in
                                      {
                                        ...
                                        FStarC_SMTEncoding_Env.depth =
                                          (env1.FStarC_SMTEncoding_Env.depth);
                                        FStarC_SMTEncoding_Env.tcenv = uu___7;
                                        FStarC_SMTEncoding_Env.warn =
                                          (env1.FStarC_SMTEncoding_Env.warn);
                                        FStarC_SMTEncoding_Env.nolabels =
                                          (env1.FStarC_SMTEncoding_Env.nolabels);
                           ...
                           let uu___4 =
                             let uu___5 =
                               FStarC_SMTEncoding_Env.varops.FStarC_SMTEncoding_Env.fresh
                                 env2.FStarC_SMTEncoding_Env.current_module_name
                                 "fuel" in
                             (uu___5, FStarC_SMTEncoding_Term.Fuel_sort) in
                           FStarC_SMTEncoding_Term.mk_fv uu___4 in
                                ...
                                | ((gtoks, env3), (fvb, univ_names)) ->
                                    ...
                                    let env4 =
                                      ...
                                      FStarC_SMTEncoding_Env.push_free_var_tok_with_fuel_and_univs
                                        ...
                                        fvb.FStarC_SMTEncoding_Env.smt_arity
                                        fvb.FStarC_SMTEncoding_Env.univ_arity
                                        gtok uu___7 univ_names in
                                    (((fvb, g, gtok) :: gtoks), env4))
                             ([], env2) toks1 in
                         match uu___4 with
                         | (gtoks, env3) ->
                             let gtoks1 = FStarC_List.rev gtoks in
                             let encode_one_binding env01 uu___5 t_norm
                               uu___6 =
                               match (uu___5, uu___6) with
                               | ((fvb, g, gtok),
                                  { FStarC_Syntax_Syntax.lbname = lbn;
                                      ...
                                      FStarC_List.fold_left
                                        (fun uu___8 elt ->
                                           ...
                                           | (prefix_decls, elts, rest) ->
                                               let uu___9 =
                                                 if
                                                   match elt.FStarC_SMTEncoding_Term.key
                                                   with
                                                   | FStar_Pervasives_Native.Some
                                                       v -> true
                                                   | uu___10 -> false
                                                 then
                                                   FStarC_List.existsb
                                                     isDeclFun
                                                     elt.FStarC_SMTEncoding_Term.decls
                                                 else false in
                                               if uu___9
                                               then
                                                 (prefix_decls,
                ...
                let constructor_or_logic_type_decl c =
                  ...
                  then
                    let uu___5 =
                      ...
                      FStarC_SMTEncoding_Term.DeclFun
                        ((c.FStarC_SMTEncoding_Term.constr_name), uu___6,
                          FStarC_SMTEncoding_Term.Term_sort,
                          FStar_Pervasives_Native.None) in
                    [uu___5]
                  else
                    FStarC_SMTEncoding_Term.constructor_to_decl
                      (FStarC_Ident.range_of_lid t) c in
                          ...
                          | (data_ax, decls) ->
                              ...
                              (match uu___8 with
                               | (ffsym, ff) ->
                                   ...
                                   FStarC_List.op_At decls uu___9))) in
                let uu___5 =
                  let k2 =
                    match tps1 with
                    | [] -> k1
                    | uu___6 ->
                        let uu___7 = FStarC_Syntax_Syntax.mk_Total k1 in
                        FStarC_Syntax_Syntax.mk_Tm_arrow tps1 uu___7
                                    ...
                                    let datacons =
                                      let uu___9 =
                                            ...
                                            uu___11 in
                                        {
                                          ...
                                          FStarC_SMTEncoding_Term.constr_base
                                            =
                                            (Prims.not injective_type_params1)
                                        } in
                                      FStarC_SMTEncoding_Term.constructor_to_decl
                                        (FStarC_Ident.range_of_lid d) uu___9 in
                                    let app =
                                      FStarC_SMTEncoding_EncodeTerm.mk_Apply
                                        ddtok_tm vars in
                                    let guard =
...
let rec encode_sigelt (env : FStarC_SMTEncoding_Env.env_t)
  ...
  let uu___ =
    let uu___1 =
      ...
      FStarC_Format.fmt1
        "While encoding top-level declaration \226\128\152%s\226\128\153"
        uu___2 in
      ...
      let g1 =
        ...
        | [] ->
            ((let uu___2 = FStarC_Effect.op_Bang dbg_SMTEncoding in
             ...
             FStarC_SMTEncoding_Term.mk_decls_trivial
               [FStarC_SMTEncoding_Term.Caption
                  (FStarC_Format.fmt1 "<Skipped %s/>" nm);
               FStarC_SMTEncoding_Term.EmptyLine])
        | uu___1 ->
            let uu___2 =
              FStarC_SMTEncoding_Term.mk_decls_trivial
                [FStarC_SMTEncoding_Term.Caption
                   (FStarC_Format.fmt1 "<Start encoding %s>" nm)] in
            let uu___3 =
              let uu___4 =
                FStarC_SMTEncoding_Term.mk_decls_trivial
                  [FStarC_SMTEncoding_Term.Caption
                     (FStarC_Format.fmt1 "</end encoding %s>" nm);
...
and encode_sigelt' (env : FStarC_SMTEncoding_Env.env_t)
  ...
  (let is_opaque_to_smt t =
   ...
   | FStarC_Syntax_Syntax.Sig_new_effect uu___1 -> ([], env)
            ...
            (match uu___2 with
             | (f3, decls) ->
                 let f4 =
                   ...
                   | (univ_fvs, univ_tms) ->
                       FStarC_SMTEncoding_Term.mkForall
                         (FStarC_Ident.range_of_lid l) ([], univ_fvs, f3) in
                 let g =
                   let uu___3 =
                     let uu___4 =
                       let uu___5 =
                            ...
                            let uu___17 =
                              FStarC_SMTEncoding_Util.mkApp
                                ((FStar_Pervasives_Native.snd
                                  ...
                                  [x]) in
                            (valid_b2t_x, uu___17) in
                          FStarC_SMTEncoding_Util.mkEq uu___16 in
                        ([[b2t_x]], [xx], uu___15) in
                      FStarC_SMTEncoding_Term.mkForall
                        (FStarC_Syntax_Syntax.range_of_fv b2t) uu___14 in
                            ...
                            let uu___18 =
                              ...
                              let uu___20 =
                                FStarC_SMTEncoding_Term.mk_HasType b2t_x
                                  prop_ty in
                              (uu___19, uu___20) in
                            FStarC_SMTEncoding_Util.mkImp uu___18 in
                          ([[b2t_x]], [xx], uu___17) in
                        FStarC_SMTEncoding_Term.mkForall
                          (FStarC_Syntax_Syntax.range_of_fv b2t) uu___16 in
         ...
         FStarC_Util.for_some
           (fun l ->
              (FStarC_Ident.string_of_id
                 (FStarC_List.hd (FStarC_Ident.ns_of_lid l)))
                = "Prims") lids in
       if uu___2
       then
         FStarC_Util.for_some
            ...
            let se1 =
              {
                ...
                FStarC_Syntax_Syntax.sigrng = (FStarC_Ident.range_of_lid l);
                FStarC_Syntax_Syntax.sigquals =
                  (se.FStarC_Syntax_Syntax.sigquals);
                FStarC_Syntax_Syntax.sigmeta =
                  (se.FStarC_Syntax_Syntax.sigmeta);
                   ...
                   FStarC_List.fold_left
                     (fun uu___5 elt ->
                        ...
                        | (decls, elts, rest) ->
                            let uu___6 =
                              if
                                match elt.FStarC_SMTEncoding_Term.key with
             ...
             (match uu___1 with
              | (u_fv, u_tm) ->
                  let decls' =
                    FStarC_SMTEncoding_Term.mk_decls_trivial
                      [FStarC_SMTEncoding_Term.DeclFun
                         ((FStarC_SMTEncoding_Term.fv_name u_fv), [],
                           FStarC_SMTEncoding_Term.univ_sort,
                           (FStar_Pervasives_Native.Some
  ...
  let uu___ =
    let uu___1 =
      let uu___2 = FStarC_SMap.create (Prims.of_int 100) in
      {
        ...
        FStarC_SMTEncoding_Env.global_cache = uu___2
      } in
    [uu___1] in
  ...
  | e::uu___1 ->
      {
        ...
        FStarC_SMTEncoding_Env.current_module_name =
          (FStarC_Ident.string_of_lid cmn);
        FStarC_SMTEncoding_Env.encoding_quantifier =
...
let deferred_encodings : (unit -> unit) Prims.list FStarC_Effect.ref=
  FStarC_Effect.mk_ref []
let defer_encoding (f : unit -> unit) : unit=
  let uu___ =
    let uu___1 = FStarC_Effect.op_Bang deferred_encodings in f :: uu___1 in
  FStarC_Effect.op_Colon_Equals deferred_encodings uu___
let flush_deferred_encodings (uu___ : unit) : unit=
  let uu___1 = FStarC_Effect.op_Bang deferred_encodings in
  match uu___1 with
  | [] -> ()
  | fs ->
      (FStarC_Effect.op_Colon_Equals deferred_encodings [];
       (let rec run l = match l with | [] -> () | f::tl -> (f (); run tl) in
        run (FStarC_List.rev fs)))
...
let fact_dbs_for_lid (env : FStarC_SMTEncoding_Env.env_t)
  ...
  let uu___ =
    ...
    uu___1 :: (open_fact_db_tags env) in
...
let encode_top_level_facts (env : FStarC_SMTEncoding_Env.env_t)
  ...
  (FStarC_SMTEncoding_Term.decls_elt Prims.list *
    FStarC_SMTEncoding_Env.env_t)=
  let fact_db_ids =
    FStarC_List.collect (fact_dbs_for_lid env)
    ...
    (fun elt ->
       ...
       then [elt]
         ...
         (let uu___ =
          ...
          match uu___ with
          | FStar_Pervasives_Native.Some (a_names, uu___1) ->
              FStarC_SMTEncoding_Term.mk_decls_trivial
                [FStarC_SMTEncoding_Term.RetainAssumptions a_names]
          | FStar_Pervasives_Native.None ->
  ...
  FStarC_Stats.record "encode_sig"
    (fun uu___ ->
       ...
       (let env = get_env (FStarC_TypeChecker_Env.current_module tcenv) tcenv in
        let uu___3 = encode_top_level_facts env se in
        match uu___3 with
        | (decls, env1) ->
            (set_env env1;
             (let uu___5 =
                let uu___6 =
                  let uu___7 = recover_caching_and_update_env env1 decls in
                  FStarC_SMTEncoding_Term.decls_list_of uu___7 in
                caption uu___6 in
              FStarC_SMTEncoding_Z3.giveZ3 uu___5))))
let give_index_to_z3_and_set_env (env : FStarC_SMTEncoding_Env.env_t)
  (name : Prims.string)
  (index : FStarC_SMTEncoding_Pruning.elt_summary Prims.list)
  (decls : unit -> FStarC_SMTEncoding_Term.decls_t) : unit=
  set_env
    {
      FStarC_SMTEncoding_Env.bvar_bindings =
        (env.FStarC_SMTEncoding_Env.bvar_bindings);
  ...
  (let uu___1 =
     FStarC_List.fold_left
       (fun uu___2 elt ->
          match uu___2 with
          | (dropped, sums) ->
              (match elt.FStarC_SMTEncoding_Pruning.elts_key with
               | FStar_Pervasives_Native.None ->
                   ((FStar_Pervasives_Native.None :: dropped),
                     (FStarC_List.rev_append
                        elt.FStarC_SMTEncoding_Pruning.elts_sums sums))
               | FStar_Pervasives_Native.Some key ->
                   let uu___3 =
                     FStarC_SMap.try_find
                       env.FStarC_SMTEncoding_Env.global_cache key in
                   (match uu___3 with
                    | FStar_Pervasives_Native.Some (a_names, uu___4) ->
                        (((FStar_Pervasives_Native.Some a_names) :: dropped),
                          ((FStarC_SMTEncoding_Pruning.Sum_retain a_names) ::
                          sums))
                    | FStar_Pervasives_Native.None ->
                        (FStarC_SMap.add
                           env.FStarC_SMTEncoding_Env.global_cache key
                           ((elt.FStarC_SMTEncoding_Pruning.elts_a_names),
                             (FStarC_TypeChecker_Env.current_module
                                env.FStarC_SMTEncoding_Env.tcenv));
                         ((FStar_Pervasives_Native.None :: dropped),
                           (FStarC_List.rev_append
   ...
   | (dropped, sums) ->
             ...
             let ds =
               let uu___4 =
                 ...
                 FStarC_List.map2
                   (fun elt d ->
                      match d with
                      | FStar_Pervasives_Native.Some a_names ->
                          [FStarC_SMTEncoding_Term.RetainAssumptions a_names]
                      | FStar_Pervasives_Native.None ->
                          elt.FStarC_SMTEncoding_Term.decls) uu___5 dropped1 in
       ...
       let force uu___2 =
         ...
         let uu___3 = FStarC_Options.log_queries () in
         if uu___3
         then
         ...
         else [FStarC_SMTEncoding_Term.Module (name, ds)] in
       let name_map = FStarC_Effect.mk_ref FStar_Pervasives_Native.None in
       let resolve n =
         let m =
           let uu___2 = FStarC_Effect.op_Bang name_map in
           match uu___2 with
           | FStar_Pervasives_Native.Some m1 -> m1
           | FStar_Pervasives_Native.None ->
               let m1 =
                 let uu___3 = force_flat () in
                 FStarC_List.fold_left
                   (fun m2 d ->
                      match d with
                      | FStarC_SMTEncoding_Term.Assume
                          { FStarC_SMTEncoding_Term.assumption_term = uu___4;
                            FStarC_SMTEncoding_Term.assumption_caption =
                              uu___5;
                            FStarC_SMTEncoding_Term.assumption_name = x;
                            FStarC_SMTEncoding_Term.assumption_fact_ids =
                              uu___6;_}
                          -> FStarC_PSMap.add m2 x d
                      | FStarC_SMTEncoding_Term.DeclFun
                          (x, uu___4, uu___5, uu___6) ->
                          FStarC_PSMap.add m2 x d
                      | FStarC_SMTEncoding_Term.DefineFun
                          (x, uu___4, uu___5, uu___6, uu___7) ->
                          FStarC_PSMap.add m2 x d
                      | uu___4 -> m2) (FStarC_PSMap.empty ()) uu___3 in
               (FStarC_Effect.op_Colon_Equals name_map
                  (FStar_Pervasives_Native.Some m1);
                m1) in
         FStarC_PSMap.try_find m n in
       let uu___2 =
         let uu___3 = FStarC_Options_Ext.enabled "context_pruning" in
         if uu___3 then FStarC_Options_Ext.enabled "prune_decls" else false in
       if uu___2
       then
         FStarC_SMTEncoding_Z3.giveZ3_lazy
           {
             FStarC_SMTEncoding_SolverState.ld_sums = sums1;
             FStarC_SMTEncoding_SolverState.ld_resolve = resolve;
             FStarC_SMTEncoding_SolverState.ld_force = force
           }
       else (let uu___3 = force () in FStarC_SMTEncoding_Z3.giveZ3 uu___3))
let give_decls_to_z3_and_set_env (env : FStarC_SMTEncoding_Env.env_t)
  ...
  let uu___ = FStarC_SMTEncoding_Pruning.summarize_elts decls in
  give_index_to_z3_and_set_env env name uu___ (fun uu___1 -> decls)
...
let encode_modul_aux (give_to_z3 : Prims.bool)
  (tcenv : FStarC_TypeChecker_Env.env) (modul : FStarC_Syntax_Syntax.modul) :
   ...
   FStarC_Syntax_Unionfind.with_uf_enabled
     (fun uu___1 ->
        ...
        (let name =
         ...
         (let env =
            let uu___4 = get_env modul.FStarC_Syntax_Syntax.name tcenv1 in
          ...
          let clear_current_module env1 =
            ...
            FStarC_List.iter
              (fun k ->
                 ...
                 match uu___5 with
                 | FStar_Pervasives_Native.None -> ()
                 | FStar_Pervasives_Native.Some (uu___6, m) ->
                     if
                 ...
                 (fun key v fvb1 ->
                    let uu___5 =
                      ...
                      FStarC_Ident.lid_equals uu___6
                        modul.FStarC_Syntax_Syntax.name in
                    if uu___5 then fvb1 else FStarC_PSMap.add fvb1 key v)
                 (FStarC_PSMap.empty ()) in
             (let uu___6 =
          ...
          let env1 =
            ...
            if uu___4 then clear_current_module env else env in
          (let uu___5 = FStarC_Debug.high () in
           if uu___5
           then
             let uu___6 =
               let uu___7 =
             ...
             let uu___8 = FStarC_SMTEncoding_Env.print_env env1 in
             FStarC_Format.print3
          ...
          (let encode_signature env2 ses =
             let uu___5 =
               FStarC_List.fold_left
                 (fun uu___6 se ->
                    match uu___6 with
                    | (g, env3) ->
                        let uu___7 = encode_top_level_facts env3 se in
                        (match uu___7 with
                         | (g', env4) ->
                             ((FStarC_List.rev_append g' g), env4)))
                 ([], env2) ses in
             match uu___5 with | (g', env3) -> ((FStarC_List.rev g'), env3) in
           let uu___5 =
             encode_signature
               {
                 FStarC_SMTEncoding_Env.bvar_bindings =
           ...
           match uu___5 with
           | (decls, env2) ->
               let index = FStarC_SMTEncoding_Pruning.summarize_elts decls in
               (if give_to_z3
                then
                  give_index_to_z3_and_set_env env2 name index
                    (fun uu___7 -> decls)
                else ();
                 ...
                 else ());
                {
                  ...
                  FStarC_SMTEncoding_Env.me_fvbs =
                    (FStarC_SMTEncoding_Env.get_current_module_fvbs env2);
                  FStarC_SMTEncoding_Env.me_decls = ((fun uu___8 -> decls))
                }))))))
let encode_modul (tcenv : FStarC_TypeChecker_Env.env)
  (modul : FStarC_Syntax_Syntax.modul) :
  FStarC_SMTEncoding_Env.module_encoding= encode_modul_aux true tcenv modul
let encode_modul_no_solver (tcenv : FStarC_TypeChecker_Env.env)
  (modul : FStarC_Syntax_Syntax.modul) :
  FStarC_SMTEncoding_Env.module_encoding= encode_modul_aux false tcenv modul
let encode_modul_from_cache (tcenv : FStarC_TypeChecker_Env.env)
  (tcmod : FStarC_Syntax_Syntax.modul)
  (me : FStarC_SMTEncoding_Env.module_encoding) : unit=
  let tcenv1 =
    FStarC_TypeChecker_Env.set_current_module tcenv
  ...
  (let uu___1 = FStarC_Debug.medium () in
   ...
   then
     let uu___2 =
       FStarC_Class_Show.show FStarC_Class_Show.showable_nat
         (FStarC_List.length me.FStarC_SMTEncoding_Env.me_index) in
     FStarC_Format.print2
       "+++++++++++Encoding externals from cache for %s ... %s decls\n" name
       uu___2
   else ());
  (let env =
     let uu___1 = get_env tcmod.FStarC_Syntax_Syntax.name tcenv1 in
     FStarC_SMTEncoding_Env.reset_current_module_fvbs uu___1 in
   let env1 =
     FStarC_List.fold_left
       (fun env2 fvb ->
          FStarC_SMTEncoding_Env.add_fvar_binding_to_env fvb env2) env
       (FStarC_List.rev me.FStarC_SMTEncoding_Env.me_fvbs) in
   give_index_to_z3_and_set_env env1 name me.FStarC_SMTEncoding_Env.me_index
     me.FStarC_SMTEncoding_Env.me_decls;
   (let uu___2 = FStarC_Debug.medium () in
    if uu___2
    then
      FStarC_Format.print1 "Done encoding externals from cache for %s\n" name
    else ()))
let encode_query
            ...
            (match uu___3 with
             | (env_decls, env1) ->
                 ((let uu___5 =
                     ...
                     if uu___6
                     then true
                     else FStarC_Effect.op_Bang dbg_SMTEncoding in
                   if uu___5
                   then
                     let uu___6 =
                       FStarC_Class_Show.show
                  ...
                  (let uu___5 =
                     FStarC_Timing.record_ms
                       (fun uu___6 ->
                          FStarC_SMTEncoding_ErrorReporting.split_goals
                            use_env_msg env1 q1) in
                   match uu___5 with
                   | ((goals, qdecls), ms) ->
                       let caption =
                         let uu___6 =
                           let uu___7 = FStarC_Options.log_queries () in
                           if uu___7
                           then true
                           else FStarC_Options.log_failing_queries () in
                         if uu___6
                         then
                           let uu___7 =
                             let uu___8 =
                               let uu___9 =
                                 FStarC_Class_Show.show
                                   FStarC_Syntax_Print.showable_term q1 in
                               Prims.strcat "Encoding query formula : "
                                 uu___9 in
                             FStarC_SMTEncoding_Term.Caption uu___8 in
                           let uu___8 =
                             let uu___9 =
                               let uu___10 =
                                 let uu___11 =
                                 ...
                                 Prims.strcat "Context: " uu___11 in
                               FStarC_SMTEncoding_Term.Caption uu___10 in
                             [uu___9] in
                           uu___7 :: uu___8
                         else [] in
                       let query_prelude =
                           ...
                           let uu___7 =
                             let uu___8 =
                               let uu___9 =
                                 FStarC_SMTEncoding_Term.mk_decls_trivial
                                   caption in
                               FStarC_List.op_At qdecls uu___9 in
                             FStarC_List.op_At env_decls uu___8 in
                           recover_caching_and_update_env env1 uu___7 in
                       ...
                       ((let uu___7 =
                         ...
                         if uu___7
                         then FStarC_Format.print_string "} Done encoding\n"
                         else ());
                        (let uu___8 =
                           let uu___9 =
                             let uu___10 = FStarC_Debug.medium () in
                             if uu___10
                             then true
                             else FStarC_Effect.op_Bang dbg_SMTEncoding in
                           if uu___9
                           then true
                           else FStarC_Effect.op_Bang dbg_Time in
                         if uu___8
                         then
                           let uu___9 =
                             FStarC_Class_Show.show
