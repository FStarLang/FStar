...
let ops : FStarC_TypeChecker_Primops_Base.primitive_step Prims.list=
  FStarC_List.map
    (fun p ->
         ...
         FStarC_TypeChecker_Primops_Base.as_primitive_step_nbecbs true p in
       {
         ...
         FStarC_TypeChecker_Primops_Base.unrepresentable_result =
           (uu___.FStarC_TypeChecker_Primops_Base.unrepresentable_result);
    ...
    [(FStarC_Parser_Const.unseal_lid, (Prims.of_int 2), Prims.int_one,
       ((fun psc univs cbs args ->
           ...
           | (ta, uu___)::(s, uu___1)::[] ->
               ...
               let uu___2 =
                 let uu___3 = try_unembed FStarC_Syntax_Embeddings.e_any ta in
                 let uu___4 =
                   try_unembed
       ...
       ((fun cb univs args ->
           ...
           | (ta, uu___)::(s, uu___1)::[] ->
               ...
               let uu___2 =
                 let uu___3 = try_unembed FStarC_TypeChecker_NBETerm.e_any ta in
                 let uu___4 =
                   try_unembed
               ...
               (match uu___2 with
                | (FStar_Pervasives_Native.Some ta1,
                   FStar_Pervasives_Native.Some s1) ->
                    ...
                    let uu___3 =
                      FStarC_TypeChecker_NBETerm.embed emb cb
                        (FStarC_Sealed.unseal s1) in
                    FStar_Pervasives_Native.Some uu___3
                | uu___3 -> FStar_Pervasives_Native.None)
           | uu___ -> FStar_Pervasives_Native.None)));
