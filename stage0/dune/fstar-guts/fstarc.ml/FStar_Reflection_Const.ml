...
let add_qn : Prims.string Prims.list= ["Prims"; "op_Plus"]
let neg_qn : Prims.string Prims.list= ["Prims"; "op_Tilde_Minus"]
let minus_qn : Prims.string Prims.list= ["Prims"; "op_Minus"]
let mult_qn : Prims.string Prims.list= ["Prims"; "op_Star"]
let div_qn : Prims.string Prims.list= ["Prims"; "op_Slash"]
let lt_qn : Prims.string Prims.list= ["Prims"; "op_Less"]
let lte_qn : Prims.string Prims.list= ["Prims"; "op_Less_Equals"]
let gt_qn : Prims.string Prims.list= ["Prims"; "op_Greater"]
let gte_qn : Prims.string Prims.list= ["Prims"; "op_Greater_Equals"]
let mod_qn : Prims.string Prims.list= ["Prims"; "op_Percent"]
