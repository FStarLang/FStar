...
let cfg_equivalent (c1 : FStarC_TypeChecker_Cfg.cfg)
  ...
  let uu___ =
    FStarC_Class_Deq.op_Equals_Question FStarC_TypeChecker_Cfg.deq_fsteps
      c1.FStarC_TypeChecker_Cfg.steps c2.FStarC_TypeChecker_Cfg.steps in
  if uu___
  then
    let uu___1 =
      FStarC_Class_Deq.op_Equals_Question
        ...
        c2.FStarC_TypeChecker_Cfg.delta_level in
    (if uu___1
     then
       FStarC_Class_Deq.op_Equals_Question
...
let read_memo (cfg : FStarC_TypeChecker_Cfg.cfg)
  ...
  | FStar_Pervasives_Native.Some (cfg', a1) when
      ...
      then true
        ...
        if FStarC_Util.physical_equality cfg cfg'
        then true
        else cfg_equivalent cfg' cfg
    ...
    (fun uu___ ->
       ...
       | () ->
           FStar_Pervasives_Native.__proj__Mktuple3__item___2
             (FStarC_List.nth env1 x.FStarC_Syntax_Syntax.index)) ()
  with
  | uu___ ->
      let uu___1 =
    ...
    | FStarC_Syntax_Syntax.U_bvar x ->
        (try
           (fun uu___ ->
              match () with
              | () ->
                  (match FStar_Pervasives_Native.__proj__Mktuple3__item___2
                           (FStarC_List.nth env1 x)
                   with
                   | Univ u3 ->
                       ((let uu___2 = FStarC_Effect.op_Bang dbg_univ_norm in
                         if uu___2
                         then
                           let uu___3 =
                             FStarC_Class_Show.show
...
let rec maybe_weakly_reduced
  ...
  let aux_comp c =
    ...
    | FStarC_Syntax_Syntax.Comp ct ->
        let uu___ = maybe_weakly_reduced ct.FStarC_Syntax_Syntax.result_typ in
        if uu___
        then true
        else
          FStarC_Util.for_some
            (fun uu___2 ->
               match uu___2 with | (a, uu___3) -> maybe_weakly_reduced a)
  ...
  | FStarC_Syntax_Syntax.Tm_app
      ...
      then true
        ...
        FStarC_Util.for_some
          (fun uu___2 ->
             match uu___2 with | (a, uu___3) -> maybe_weakly_reduced a) args
         ...
         | FStarC_Syntax_Syntax.Meta_pattern (uu___2, args) ->
             FStarC_Util.for_some
               (FStarC_Util.for_some
                  (fun uu___3 ->
                     match uu___3 with
                     | (a, uu___4) -> maybe_weakly_reduced a)) args
         | FStarC_Syntax_Syntax.Meta_monadic_lift (uu___2, uu___3, t') ->
             maybe_weakly_reduced t'
         | FStarC_Syntax_Syntax.Meta_monadic (uu___2, t') ->
             maybe_weakly_reduced t'
         | FStarC_Syntax_Syntax.Meta_labeled uu___2 -> false
         | FStarC_Syntax_Syntax.Meta_desugared uu___2 -> false
         | FStarC_Syntax_Syntax.Meta_named uu___2 -> false)
               ...
               let uu___3 =
                 let uu___4 =
                   FStarC_List.filter
                     (fun lid ->
                        Prims.op_Negation
                          (FStarC_Syntax_Syntax.fv_eq_lid fv lid)) once in
...
let rec norm (cfg : FStarC_TypeChecker_Cfg.cfg) (env1 : env) (stack1 : stack)
  ...
  (match t1.FStarC_Syntax_Syntax.n with
   ...
   | FStarC_Syntax_Syntax.Tm_fvar fv when
       ...
       handle_norm_request cfg env1 stack2 k t1
   | FStarC_Syntax_Syntax.Tm_fvar fv ->
       ...
       then
         ...
         (let uu___4 =
            ...
            then
              ...
              FStarC_Syntax_Util.is_div_effect uu___5
            else false in
          if uu___4
          then
            let ffun =
            ...
            then
              ...
              (let uu___7 =
                 FStarC_Syntax_Subst.open_term
                   [FStarC_Syntax_Syntax.mk_binder
                      (FStar_Pervasives.__proj__Inl__item__v
                         lb.FStarC_Syntax_Syntax.lbname)] body in
               match uu___7 with
               | (bs, body1) ->
                   (FStarC_TypeChecker_Cfg.log cfg
                      (fun uu___9 ->
      ...
      then
        ...
        (if uu___2
         then
           ...
           (if uu___3 then is_plugin () else false)
         else false)
      else false in
    if uu___1
    then
                               ...
                               let bind_inst_args f_arg =
                                 ...
                                 then
                                   ...
                                   (FStarC_Syntax_Syntax.as_arg
                                     ...
                                     (FStarC_List.op_At unit_args
                                        (FStarC_List.op_At range_args
                                   ...
                                   (let uu___11 =
                                    ...
                                    | (lb_head, head_bv, head1) ->
                                        let uu___12 =
                                          ...
                                          FStarC_Syntax_Syntax.Tm_let uu___13 in
                                        FStarC_Syntax_Syntax.mk uu___12 rng) in
                               FStarC_TypeChecker_Cfg.log cfg
                                 (fun uu___11 ->
                                    let uu___12 =
                                      FStarC_Class_Show.show
              ...
              | (e, q) ->
                  ...
                  (match uu___6 with
                   | FStarC_Syntax_Syntax.Tm_meta
                       ...
                       ->
                       Prims.op_Negation
                         (FStarC_Syntax_Util.is_pure_effect m1)
                   | uu___7 -> false) in
            let uu___5 =
              FStarC_Util.for_some is_arg_impure
                ((FStarC_Syntax_Syntax.as_arg head) :: args) in
            (if uu___5
             then
               let uu___6 =
                 let uu___7 =
         ...
         (let fallback1 uu___4 =
            ...
            (let uu___6 =
               FStarC_Syntax_Util.mk_reify top2
                 (FStar_Pervasives_Native.Some m) in
             norm cfg env1 (FStarC_List.tl stack1) uu___6) in
                ...
                (let uu___7 =
                 ...
                 then fallback2 ()
                   ...
                   (let t1 =
                    ...
                    norm cfg env1 (FStarC_List.tl stack1) t1))
          | uu___5 -> fallback1 ()))
    | FStarC_Syntax_Syntax.Tm_meta
...
and reify_lift (cfg : FStarC_TypeChecker_Cfg.cfg)
  ...
  (let uu___1 =
   ...
   then
     ...
     let uu___2 = FStarC_Option.must (FStarC_Syntax_Util.get_eff_repr ed) in
     match uu___2 with
     | (uu___3, repr) ->
         let uu___4 =
                   ...
                   let uu___7 =
                     let uu___8 =
                       let uu___9 =
                         ...
                         FStarC_Syntax_Subst.close
                           [FStarC_Syntax_Syntax.mk_binder e_bv] uu___10 in
                       {
       ...
       let effect_args =
         ...
         then
           ...
           FStarC_List.mapi
             (fun idx uu___3 ->
                match uu___3 with
                | (a, i) -> let uu___4 = norm cfg env1 [] a in (uu___4, i))
             ct.FStarC_Syntax_Syntax.effect_args in
       let flags =
         FStarC_List.map
           (fun uu___1 ->
         ...
         let rec clearly_inhabited ty =
           ...
           | FStarC_Syntax_Syntax.Tm_fvar fv ->
               ...
               then true
                 ...
                 if FStarC_Ident.lid_equals l FStarC_Parser_Const.bool_lid
                 then true
                 else
                   if
                      ...
                      then
                        (let uu___13 = FStarC_List.map simplify args in
                         ...
                         | (uu___14, (arg, uu___15))::(FStar_Pervasives_Native.Some
                             ...
                             let uu___17 = maybe_auto_squash arg in
                             (uu___17, false)
                         | uu___14 -> squashed_head_un_auto_squash_args tm1)
                      else
                        if
                          FStarC_Syntax_Syntax.fv_eq_lid fv
                            FStarC_Parser_Const.imp_lid
                        then
                          (let uu___14 = FStarC_List.map simplify args in
                           ...
                           | (FStar_Pervasives_Native.Some (true), uu___15)::
                               ...
                               (uu___18, false)
                           | (uu___15, (p, uu___16))::(uu___17, (q, uu___18))::[]
                               ->
                                    ...
                                    then
                                      (let t_has_eq_for_sure t =
                                       ...
                                       then
                                         ...
                                         let uu___20 = t_has_eq_for_sure t in
                                         (if uu___20
                                          then
                                            ((w FStarC_Syntax_Util.t_true),
                                              false)
                                      ...
                                      if
                                        FStarC_Syntax_Syntax.fv_eq_lid fv
                                          FStarC_Parser_Const.subtype_of_lid
                                      then
                                        (let is_unit ty =
                                           let uu___21 =
                                             let uu___22 =
                                           ...
                                           | uu___22 -> false in
                                         match args with
                                         | (t, uu___21)::(ty, uu___22)::[]
                                             when
                                             let uu___23 = is_unit ty in
                                             if uu___23
                                             then
                        ...
                        then
                          (let uu___10 = FStarC_List.map simplify args in
                           ...
                           | (uu___11, (p, uu___12))::(uu___13, (q, uu___14))::[]
                               ->
                               let uu___15 = FStarC_Syntax_Util.term_eq p q in
                               if uu___15
                               then ((w FStarC_Syntax_Util.t_true), false)
                               else squashed_head_un_auto_squash_args tm1
                                    ...
                                    then
                                      (let t_has_eq_for_sure t =
                                       ...
                                       then
                                         let t =
                                           FStar_Pervasives_Native.fst
                                             (FStarC_List.hd args) in
                                         let uu___16 = t_has_eq_for_sure t in
                                         (if uu___16
                                          then
                                            ((w FStarC_Syntax_Util.t_true),
                                              false)
                                      ...
                                      then
                                        (let is_unit ty =
                                           ...
                                           | uu___18 -> false in
                                         match args with
                                         | (t, uu___17)::(ty, uu___18)::[]
                                             when
                                             let uu___19 = is_unit ty in
                                             if uu___19
                                             then
                                               FStarC_Syntax_Util.is_sub_singleton
                                                 t
  ...
  | (App (env2, head, aq, r))::stack' when should_reify cfg stack1 ->
      ...
      let is_non_tac_layered_effect m =
        ...
        then
          FStarC_TypeChecker_Env.is_layered_effect
            cfg.FStarC_TypeChecker_Cfg.tcenv norm_m
        else false in
      let uu___ =
        let uu___1 = FStarC_Syntax_Subst.compress t in
        uu___1.FStarC_Syntax_Syntax.n in
      (match uu___ with
       | FStarC_Syntax_Syntax.Tm_meta
           { FStarC_Syntax_Syntax.tm2 = uu___1;
             FStarC_Syntax_Syntax.meta = FStarC_Syntax_Syntax.Meta_monadic
               (m, uu___2);_}
           when
           let uu___3 = is_non_tac_layered_effect m in
           if uu___3
           then
             Prims.op_Negation
               (cfg.FStarC_TypeChecker_Cfg.steps).FStarC_TypeChecker_Cfg.for_extraction
           ...
           then
             (if
              ...
              then
                ...
                FStarC_Syntax_Syntax.uu___is_Extract_none uu___4
              else false)
           else false ->
           let uu___3 =
             get_extraction_mode cfg.FStarC_TypeChecker_Cfg.tcenv m in
           ...
           then
             (if
              ...
              then
                let uu___4 =
                  get_extraction_mode cfg.FStarC_TypeChecker_Cfg.tcenv m in
                uu___4 = FStarC_Syntax_Syntax.Extract_primitive
              else false)
           else false ->
           fallback
             (FStarC_Format.fmt1
       ...
       | FStarC_Syntax_Syntax.Tm_meta
           ...
           when
           let uu___3 =
             let uu___4 = is_non_tac_layered_effect msrc in
             if uu___4 then true else is_non_tac_layered_effect mtgt in
           if uu___3
           then
             Prims.op_Negation
               (cfg.FStarC_TypeChecker_Cfg.steps).FStarC_TypeChecker_Cfg.for_extraction
           ...
           then
             let uu___3 =
               ...
               then
                 ...
                 FStarC_Syntax_Syntax.uu___is_Extract_none uu___5
               else false in
             (if uu___3
              then true
              else
                (let uu___5 = is_non_tac_layered_effect mtgt in
                 if uu___5
                 then
                   let uu___6 =
                     get_extraction_mode cfg.FStarC_TypeChecker_Cfg.tcenv
                       mtgt in
                   FStarC_Syntax_Syntax.uu___is_Extract_none uu___6
                 else false))
           else false ->
           FStarC_Errors.raise_error
             (FStarC_Syntax_Syntax.has_range_syntax ()) t
...
let maybe_promote_t (env1 : FStarC_TypeChecker_Env.env)
  ...
  Prims.bool=
  if Prims.op_Negation non_informative_only
  then true
  else non_info_norm env1 t
       ...
       | (c11, c21) ->
           ...
           then (c11, c21)
             ...
             (let c1_erasable =
              ...
              then let uu___3 = ghost_to_pure env1 c21 in (c11, uu___3)
              else
                if
                  c2_erasable &&
                    (FStarC_Ident.lid_equals c1_eff
                       FStarC_Parser_Const.effect_GHOST_lid)
                then (let uu___4 = ghost_to_pure env1 c11 in (uu___4, c21))
                else (c11, c21)))
              ...
              if
                lc1_erasable &&
                  (FStarC_Ident.lid_equals lc2_eff
                     FStarC_Parser_Const.effect_GHOST_lid)
              then
                let uu___3 = ghost_to_pure_lcomp env1 lc21 in (lc11, uu___3)
              else
                if
                  lc2_erasable &&
                    (FStarC_Ident.lid_equals lc1_eff
                       FStarC_Parser_Const.effect_GHOST_lid)
                then
                  (let uu___4 = ghost_to_pure_lcomp env1 lc11 in
                   (uu___4, lc21))
                else (lc11, lc21)))
    ...
    | (bs, c) ->
        ...
        (match (bs, c) with
         ...
         | (bs1, c1) when
             if len < n1
             then
               let uu___1 = FStarC_Syntax_Util.is_total_comp c1 in
               (if uu___1
                then
