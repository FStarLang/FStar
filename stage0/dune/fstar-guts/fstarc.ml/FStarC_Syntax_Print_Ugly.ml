        ...
        then " "
          ...
          (match us_opt with
           ...
           | FStar_Pervasives_Native.Some us ->
               ...
               FStarC_Format.fmt1 " %s " uu___4) in
      let uu___2 =
        let uu___3 =
          FStarC_List.map
            (fun uu___4 ->
      ...
      then
        let uu___1 =
          ...
          then "_"
            ...
            (let uu___3 = FStarC_Option.must topt in term_to_string uu___3) in
           ...
           let basic =
             ...
             then
               ...
               let uu___3 =
                 ...
                 FStarC_String.concat ", " uu___4 in
               let uu___4 = term_to_string c1.FStarC_Syntax_Syntax.result_typ in
               let uu___5 =
                 let uu___6 =
               ...
               (let uu___3 =
                  ...
                  if uu___4
                  then
                    let uu___5 = FStarC_Options.print_effect_args () in
                ...
                then
                  ...
                  (let uu___5 =
                     let uu___6 =
                       ...
                       if uu___7
                       then
                         let uu___8 = FStarC_Options.print_implicits () in
                         Prims.op_Negation uu___8
                       else false in
                     if uu___6
                     then
                       let uu___7 = FStarC_Parser_Const.effect_ML_lid () in
                       FStarC_Ident.lid_equals
                         c1.FStarC_Syntax_Syntax.effect_name uu___7
                     else false in
                   if uu___5
                   then term_to_string c1.FStarC_Syntax_Syntax.result_typ
                     ...
                     (let uu___7 =
                        let uu___8 =
                          let uu___9 = FStarC_Options.print_effect_args () in
...
let tscheme_to_string (s : FStarC_Syntax_Syntax.tscheme) : Prims.string=
  ...
  | (us, t) ->
      ...
      let uu___2 = term_to_string t in
      FStarC_Format.fmt2 "%s%s" uu___1 uu___2
let action_to_string (a : FStarC_Syntax_Syntax.action) : Prims.string=
  ...
  FStarC_Format.fmt5 "%s%s %s : %s = %s" uu___ uu___1 uu___2 uu___3 uu___4
let wp_eff_combinators_to_string
  (combs : FStarC_Syntax_Syntax.wp_eff_combinators) : Prims.string=
    ...
    let uu___2 =
      ...
      let uu___4 =
        ...
        let uu___6 =
          ...
          let uu___8 =
            let uu___9 = tscheme_to_string combs.FStarC_Syntax_Syntax.ite_wp in
            let uu___10 =
              let uu___11 =
...
let sub_eff_to_string (se : FStarC_Syntax_Syntax.sub_eff) : Prims.string=
  let tsopt_to_string ts_opt =
    ...
    then let uu___ = FStarC_Option.must ts_opt in tscheme_to_string uu___
    else "<None>" in
...
let layered_eff_combinators_to_string
  (combs : FStarC_Syntax_Syntax.layered_eff_combinators) : Prims.string=
  let to_str uu___ =
    match uu___ with
    | (ts_t, ts_ty, kopt) ->
            ...
            let uu___10 =
              let uu___11 =
                ...
                then ""
                  ...
                  (let uu___13 =
                     let uu___14 =
                       FStarC_Option.must combs.FStarC_Syntax_Syntax.l_close in
                     to_str2 uu___14 in
                   FStarC_Format.fmt1 "; l_close = %s\n" uu___13) in
              [uu___11] in
            uu___9 :: uu___10 in
          uu___7 :: uu___8 in
        uu___5 :: uu___6 in
        ...
        let uu___5 =
          FStarC_Class_Show.show
            (FStarC_Class_Show.show_option
               FStarC_Syntax_Syntax.showable_indexed_effect_combinator_kind)
            k in
        FStarC_Format.fmt6 "polymonadic_bind (%s, %s) |> %s = (%s, %s)<%s>"
        ...
        let uu___4 =
          FStarC_Class_Show.show
            (FStarC_Class_Show.show_option
               FStarC_Syntax_Syntax.showable_indexed_effect_combinator_kind)
            k in
        FStarC_Format.fmt5 "polymonadic_subcomp %s <: %s = (%s, %s)<%s>"
