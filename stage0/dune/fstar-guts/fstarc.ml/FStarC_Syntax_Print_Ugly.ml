    ...
    FStarC_Errors.with_ctx "While ugly-printing a term"
      (fun uu___ ->
         ...
         | FStarC_Syntax_Syntax.Tm_meta
             ...
             FStarC_Format.fmt3 "Meta_labeled(%s, %s){%s}" uu___1 uu___2
               uu___3
         | FStarC_Syntax_Syntax.Tm_meta
             { FStarC_Syntax_Syntax.tm2 = t;
...
and (ctx_uvar_to_string_aux :
  ...
  fun print_reason ->
    fun ctx_uvar ->
      ...
      FStarC_Format.fmt5 "%s(%s |- %s : %s) %s" reason_string uu___ uu___1
        uu___2 uu___3
        ...
        let uu___2 =
          FStarC_List.map
            (fun lb ->
               ...
               FStarC_Format.fmt5 "%s%s %s : %s = %s" uu___3 uu___4 uu___5
                                 ...
                                 let uu___4 =
                                   ...
                                   | hd::tl ->
                                       ...
                                       FStarC_List.fold_left
                                         ...
                                         tl in
                                 FStarC_Format.fmt1 " (decreases [%s])"
                                   uu___4 in
                               [uu___3]
...
let (sub_eff_to_string : FStarC_Syntax_Syntax.sub_eff -> Prims.string) =
  fun se ->
    ...
    FStarC_Format.fmt4 "sub_effect %s ~> %s : lift = %s ;; lift_wp = %s"
    ...
    let basic =
      ...
      | FStarC_Syntax_Syntax.Sig_inductive_typ
          ...
          then
            ...
            FStarC_Format.fmt5 "%stype %s<%s> %s : %s" quals_str uu___5
      ...
      | FStarC_Syntax_Syntax.Sig_fail
          ...
          let uu___2 =
            FStarC_Class_Show.show
              (FStarC_Class_Show.show_list FStarC_Class_Show.showable_int)
              errs in
          let uu___3 =
             ...
             | (univs1, t) ->
                 ...
                 (match uu___2 with
                  | (tps1, c1) ->
                      ...
                      FStarC_Format.fmt4 "effect %s<%s> %s = %s" uu___3
