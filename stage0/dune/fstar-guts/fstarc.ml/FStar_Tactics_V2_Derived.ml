...
let bv_to_string (bv : FStar_Tactics_NamedView.bv) :
  FStarC_Tactics_Types.ref_proofstate -> Prims.string= name_of_bv bv
...
let type_of_var (x : FStar_Tactics_NamedView.namedv) :
  FStarC_Tactics_Types.ref_proofstate -> FStarC_Reflection_Types.typ=
  FStarC_Tactics_Unseal.unseal
...
let uu___is_Goal_not_trivial (projectee : Prims.exn) : Prims.bool= true
let goals (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Tactics_Types.goal Prims.list=
  let x = FStarC_Tactics_V2_Builtins.get () ps in
  FStarC_Tactics_Types.goals_of x
let smt_goals (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Tactics_Types.goal Prims.list=
  let x = FStarC_Tactics_V2_Builtins.get () ps in
  FStarC_Tactics_Types.smt_goals_of x
let map_optRO (f : 'a -> FStarC_Tactics_Types.ref_proofstate -> 'b)
...
let _cur_goal (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Tactics_Types.goal=
  let x = goals () ps in
  match x with | [] -> fail "no more goals" ps | g::uu___1 -> g
let cur_env (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Reflection_Types.env=
  let x = _cur_goal () ps in FStarC_Tactics_Types.goal_env x
let cur_goal (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Reflection_Types.typ=
  let x = _cur_goal () ps in FStarC_Tactics_Types.goal_type x
let cur_witness (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStar_Tactics_NamedView.term=
  let x = _cur_goal () ps in FStarC_Tactics_Types.goal_witness x
let cur_vars (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
...
let with_policy (pol : FStarC_Tactics_Types.guard_policy)
  (f : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
...
let trivial (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.iota;
    FStarC_NormSteps.zeta;
    FStarC_NormSteps.reify_;
    FStarC_NormSteps.delta;
    FStarC_NormSteps.primops;
    FStarC_NormSteps.simplify;
    FStarC_NormSteps.unmeta] ps;
...
let dismiss (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  let x = goals () ps in
  match x with
  | [] -> fail "dismiss: no more goals" ps
  | uu___1::gs -> FStarC_Tactics_V2_Builtins.set_goals gs ps
let flip (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  let x = goals () ps in
  let x1 = goals () ps in
  match x1 with
...
let qed (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = goals () ps in
  match x with | [] -> () | uu___1 -> fail "qed: not done!" ps
let debug (m : Prims.string) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x = FStarC_Tactics_V2_Builtins.debugging () ps in
  if x then FStarC_Tactics_V2_Builtins.print m ps else ()
let smt (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
...
let idtac (uu___ : unit) (uu___1 : FStarC_Tactics_Types.ref_proofstate) :
  unit= ()
let later (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  let x = goals () ps in
  match x with
...
let trefl (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStarC_Tactics_V2_Builtins.t_trefl false
let trefl_guard (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
...
let t_pointwise (d : FStarC_Tactics_Types.direction)
  (tau : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x t uu___ = (true, FStarC_Tactics_Types.Continue) in
  let x1 uu___ = tau () in FStarC_Tactics_V2_Builtins.ctrl_rewrite d x x1 ps
let topdown_rewrite
  (ctrl :
    FStar_Tactics_NamedView.term ->
      FStarC_Tactics_Types.ref_proofstate -> (Prims.bool * Prims.int))
  (rw : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x t ps1 =
    ...
    | (b, i) ->
        let x2 =
          ...
          | uu___ when uu___ = (Prims.of_int 2) -> FStarC_Tactics_Types.Abort
  ...
  FStarC_Tactics_V2_Builtins.ctrl_rewrite FStarC_Tactics_Types.TopDown x rw
    ps
let pointwise (tau : unit -> FStarC_Tactics_Types.ref_proofstate -> unit) :
  FStarC_Tactics_Types.ref_proofstate -> unit=
  t_pointwise FStarC_Tactics_Types.BottomUp tau
let pointwise' (tau : unit -> FStarC_Tactics_Types.ref_proofstate -> unit) :
  FStarC_Tactics_Types.ref_proofstate -> unit=
  t_pointwise FStarC_Tactics_Types.TopDown tau
let cur_module (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Reflection_Types.name=
  let x = FStarC_Tactics_V2_Builtins.top_env () ps in
  FStarC_Reflection_V2_Builtins.moduleof x
let open_modules (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStarC_Reflection_Types.name Prims.list=
  let x = FStarC_Tactics_V2_Builtins.top_env () ps in
...
let divide (n : Prims.int)
  (l : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (r : unit -> FStarC_Tactics_Types.ref_proofstate -> 'b)
  (ps : FStarC_Tactics_Types.ref_proofstate) : ('a * 'b)=
       ...
       (match x2 with
        | (gs1, gs2) ->
            (FStarC_Tactics_V2_Builtins.set_goals gs1 ps;
             ...
             (let x5 = l () ps in
              let x6 =
                let x7 = goals () ps in let x8 = smt_goals () ps in (x7, x8) in
              match x6 with
              | (gsl, sgsl) ->
                   ...
                   (let x9 = r () ps in
                    ...
                    | (gsr, sgsr) ->
                        (FStarC_Tactics_V2_Builtins.set_goals
                         ...
                         (x5, x9))))))))
let rec iseq
  (ts : (unit -> FStarC_Tactics_Types.ref_proofstate -> unit) Prims.list) :
  FStarC_Tactics_Types.ref_proofstate -> unit=
  match ts with
  | t::ts1 ->
      (fun ps ->
  ...
  | [] -> (fun uu___ -> ())
let focus (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a=
  let x = goals () ps in
  match x with
  ...
  | g::gs ->
      ...
      (FStarC_Tactics_V2_Builtins.set_goals [g] ps;
       ...
       (let x4 = t () ps in
        ...
        x4))
let dump1 (m : Prims.string) : FStarC_Tactics_Types.ref_proofstate -> unit=
...
let rec iterAll (t : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = goals () ps in
  match x with
  | [] -> ()
...
let iterAllSMT (t : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = let x1 = goals () ps in let x2 = smt_goals () ps in (x1, x2) in
  match x with
  | (gs, sgs) ->
      (FStarC_Tactics_V2_Builtins.set_goals sgs ps;
       FStarC_Tactics_V2_Builtins.set_smt_goals [] ps;
       iterAll t ps;
       (let x4 = let x5 = goals () ps in let x6 = smt_goals () ps in (x5, x6) in
        match x4 with
        | (gs', sgs') ->
            (FStarC_Tactics_V2_Builtins.set_goals gs ps;
             FStarC_Tactics_V2_Builtins.set_smt_goals (op_At () gs' sgs') ps)))
let seq (f : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
  (g : unit -> FStarC_Tactics_Types.ref_proofstate -> unit) :
  FStarC_Tactics_Types.ref_proofstate -> unit=
...
let exact_n (n : Prims.int) (t : FStar_Tactics_NamedView.term)
  ...
  let x =
    FStar_Tactics_Util.repeatn n
      (fun uu___ uu___1 -> FStarC_Reflection_V2_Data.Q_Explicit) ps in
  exact_args x t ps
let ngoals (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.int= let x = goals () ps in FStar_List_Tot_Base.length x
let ngoals_smt (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.int= let x = smt_goals () ps in FStar_List_Tot_Base.length x
...
let fresh_namedv (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStar_Tactics_NamedView.namedv=
  let x = FStarC_Tactics_V2_Builtins.fresh () ps in
  FStar_Tactics_NamedView.pack_namedv
    {
...
let guard (b : Prims.bool) : FStarC_Tactics_Types.ref_proofstate -> unit=
  if Prims.not b then fail "guard failed" else (fun uu___ -> ())
let try_with (f : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (h : Prims.exn -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a=
  let x = FStarC_Tactics_V2_Builtins.catch f ps in
  match x with
  | FStar_Pervasives.Inl e -> h e ps
  | FStar_Pervasives.Inr x1 -> x1
let trytac (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a) :
  FStarC_Tactics_Types.ref_proofstate -> 'a FStar_Pervasives_Native.option=
  try_with
    (fun uu___ ->
       match () with
       | () -> (fun ps -> let x = t () ps in FStar_Pervasives_Native.Some x))
    (fun uu___ uu___1 -> FStar_Pervasives_Native.None)
let or_else (t1 : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (t2 : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a) :
  FStarC_Tactics_Types.ref_proofstate -> 'a=
...
let op_Less_Bar_Greater
  ...
  FStarC_Tactics_Types.ref_proofstate -> 'a= or_else t1 t2
let first
  (ts : (unit -> FStarC_Tactics_Types.ref_proofstate -> 'a) Prims.list) :
  FStarC_Tactics_Types.ref_proofstate -> 'a=
...
let rec repeat :
  ...
  fun t ps ->
    ...
    | FStar_Pervasives.Inr x1 -> let x2 = repeat t ps in x1 :: x2
let repeat1 (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a Prims.list=
  let x = t () ps in let x1 = repeat t ps in x :: x1
let repeat' (f : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = repeat f ps in ()
let norm_term (s : FStarC_NormSteps.norm_step Prims.list)
  (t : FStar_Tactics_NamedView.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : FStar_Tactics_NamedView.term=
  let x =
...
let discard (tau : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = tau () ps in ()
let rec repeatseq :
  'a .
    (unit -> FStarC_Tactics_Types.ref_proofstate -> 'a) ->
  ...
  fun t ps ->
    let x =
      trytac
        ...
        ps in
    ()
let tadmit (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStarC_Tactics_V2_Builtins.tadmit_t
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_Const FStarC_Reflection_V2_Data.C_Unit))
let admit1 (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  tadmit ()
let admit_all (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit= let x = repeat tadmit ps in ()
let is_guard (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  Prims.bool= let x = _cur_goal () ps in FStarC_Tactics_Types.is_guard x
let skip_guard (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit= let x = is_guard () ps in if x then smt () ps else fail "" ps
let guards_to_smt (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit= let x = repeat skip_guard ps in ()
let simpl (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.simplify; FStarC_NormSteps.primops]
let whnf (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.weak;
    FStarC_NormSteps.hnf;
    FStarC_NormSteps.primops;
    FStarC_NormSteps.delta]
let compute (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.primops;
    FStarC_NormSteps.iota;
    FStarC_NormSteps.delta;
...
let intros' (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit= let x = intros () ps in ()
let destruct (tm : FStarC_Reflection_Types.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = FStarC_Tactics_V2_Builtins.t_destruct tm ps in ()
...
let for_each_binding
  (f :
    FStar_Tactics_NamedView.binding ->
      FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a Prims.list=
  let x = cur_vars () ps in FStar_Tactics_Util.map f x ps
let rec revert_all (bs : FStar_Tactics_NamedView.binding Prims.list) :
  FStarC_Tactics_Types.ref_proofstate -> unit=
  match bs with
  | [] -> (fun uu___ -> ())
  | uu___::tl ->
...
let rec __assumption_aux (xs : FStar_Tactics_NamedView.binding Prims.list) :
  ...
  | b::bs ->
      try_with
        ...
        (fun uu___ -> __assumption_aux bs)
let assumption (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit= let x = cur_vars () ps in __assumption_aux x ps
...
let rec try_rewrite_equality (x : FStar_Tactics_NamedView.term)
...
let rewrite_eqs_from_context (uu___ : unit)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = cur_vars () ps in rewrite_all_context_equalities x ps
let rewrite_equality (t : FStar_Tactics_NamedView.term)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = cur_vars () ps in try_rewrite_equality t x ps
let unfold_def (t : FStar_Tactics_NamedView.term)
  ...
  | FStar_Tactics_NamedView.Tv_FVar fv ->
      ...
      FStarC_Tactics_V2_Builtins.norm [FStarC_NormSteps.delta_fully [x1]] ps
  ...
  let x uu___ ps1 =
    let x1 =
      FStar_Tactics_Util.fold_left
        (fun k l uu___1 uu___2 -> or_else (fun uu___3 -> apply_lemma_rw l) k)
        trefl lems ps1 in
    x1 () ps1 in
  pointwise x ps
    ...
    (fun uu___ ps1 ->
       ...
       | (lhs, rhs) ->
           ...
           let x4 =
             ...
             match x5 with
             | FStar_Tactics_NamedView.Tv_Uvar (_0, _1) -> true
             | uu___1 -> false in
           if x4
           then trefl () ps1
           else
             if Prims.not (term_eq lhs t1)
             then
               FStarC_Tactics_V2_Builtins.raise_core
                 FStarC_Tactics_Common.SKIP ps1
             else
               try_with (fun uu___1 -> match () with | () -> exact x1)
                 (fun uu___1 -> trefl ()) ps1) ps
let grewrite_eq (b : FStar_Tactics_NamedView.binding)
  (ps : FStarC_Tactics_Types.ref_proofstate) : unit=
  let x = FStar_Reflection_V2_Formula.term_as_formula (type_of_binding b) ps in
  match x with
  | FStar_Reflection_V2_Formula.Comp
...
let admit_dump_t (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
...
let magic_dump_t (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  FStarC_Tactics_V2_Builtins.dump "Admitting" ps;
  apply
    (FStarC_Reflection_V2_Builtins.pack_ln
...
let change_sq (t1 : FStar_Tactics_NamedView.term) :
  ...
  FStarC_Tactics_V2_Builtins.change
    (FStar_Reflection_V2_Derived.mk_e_app
       ...
       [t1])
let finish_by (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'a=
  let x = t () ps in
  or_else qed (fun uu___ -> fail "finish_by: not finished") ps; x
let solve_then (t1 : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a)
  (t2 : 'a -> FStarC_Tactics_Types.ref_proofstate -> 'b)
  (ps : FStarC_Tactics_Types.ref_proofstate) : 'b=
  FStarC_Tactics_V2_Builtins.dup () ps;
  (let x1 = focus (fun uu___ -> finish_by t1) ps in
   let x2 = t2 x1 ps in trefl () ps; x2)
let add_elem (t : unit -> FStarC_Tactics_Types.ref_proofstate -> 'a) :
  FStarC_Tactics_Types.ref_proofstate -> 'a=
  focus
    (fun uu___ ps ->
       apply
...
let specialize (f : 'a) (l : Prims.string Prims.list) (uu___ : unit) :
  ...
  solve_then
    ...
    (fun uu___1 ->
       FStarC_Tactics_V2_Builtins.norm
         [FStarC_NormSteps.delta_only l;
         FStarC_NormSteps.iota;
         FStarC_NormSteps.zeta])
let tlabel (l : Prims.string) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  let x = goals () ps in
  match x with
...
let focus_all (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  (let x1 =
...
let bump_nth (n : Prims.pos) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
    ...
    (fun uu___1 ps ->
       ...
       iterAll
         (fun uu___2 ps1 ->
            ...
            grewrite_eq x3 ps1;
            FStarC_Tactics_V2_Builtins.norm [FStarC_NormSteps.iota] ps1) ps)
let nth_var (i : Prims.int) (ps : FStarC_Tactics_Types.ref_proofstate) :
  FStar_Tactics_NamedView.binding=
...
let rec mk_abs (args : FStar_Tactics_NamedView.binder Prims.list)
  (t : FStar_Tactics_NamedView.term) :
           ...
           | (i, b) ->
               FStar_Tactics_NamedView.pack
                 (FStar_Tactics_NamedView.Tv_Let
                    (false, [], (binding_to_simple_binder b), i, t1))) x2
        lb_bindings ps
let trans (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  apply_lemma
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_FVar
          (FStarC_Reflection_V2_Builtins.pack_fv
             ["FStar"; "Tactics"; "V2"; "Derived"; "lem_trans"])))
let smt_sync (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
