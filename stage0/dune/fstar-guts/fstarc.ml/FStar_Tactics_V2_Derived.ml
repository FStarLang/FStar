...
let bv_to_string (bv : FStar_Tactics_NamedView.bv) :
  (Prims.string, Obj.t) FStar_Tactics_Effect.tac_repr= name_of_bv bv
...
let goals (uu___ : unit) :
  (FStarC_Tactics_Types.goal Prims.list, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let map_optRO (f : 'a -> ('b, Obj.t) FStar_Tactics_Effect.tac_repr)
...
let cur_env (uu___ : unit) :
  (FStarC_Reflection_Types.env, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let with_policy (pol : FStarC_Tactics_Types.guard_policy)
  (f : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let trivial (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let dismiss (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    match x with
    | [] -> fail "dismiss: no more goals" ps
    | uu___1::gs -> FStarC_Tactics_V2_Builtins.set_goals gs ps
let flip (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    let x1 = goals () ps in
    match x1 with
...
let qed (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    match x with | [] -> () | uu___1 -> fail "qed: not done!" ps
let debug (m : Prims.string) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = FStarC_Tactics_V2_Builtins.debugging () ps in
    if x then FStarC_Tactics_V2_Builtins.print m ps else ()
let smt (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let idtac (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun uu___1 -> ()
let later (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    match x with
...
let trefl (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  FStarC_Tactics_V2_Builtins.t_trefl false
let trefl_guard (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let t_pointwise (d : FStarC_Tactics_Types.direction)
  (tau : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let topdown_rewrite
  (ctrl :
    FStar_Tactics_NamedView.term ->
      ((Prims.bool * Prims.int), Obj.t) FStar_Tactics_Effect.tac_repr)
  (rw : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x t ps1 =
    ...
    FStarC_Tactics_V2_Builtins.ctrl_rewrite FStarC_Tactics_Types.TopDown x rw
      ps
let pointwise (tau : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let divide (n : Prims.int)
  (l : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr)
  (r : unit -> ('b, Obj.t) FStar_Tactics_Effect.tac_repr) :
                     ...
                     (let x9 = r () ps in
                      ...
                      | (gsr, sgsr) ->
                          (FStarC_Tactics_V2_Builtins.set_goals
                           ...
                           (x5, x9))))))))
let rec iseq
  (ts : (unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) Prims.list) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  match ts with
  | t::ts1 ->
    ...
    | g::gs ->
        ...
        (FStarC_Tactics_V2_Builtins.set_goals [g] ps;
         ...
         (let x4 = t () ps in
          ...
          x4))
let dump1 (m : Prims.string) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let rec iterAll (t : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    match x with
...
let iterAllSMT (t : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = let x1 = goals () ps in let x2 = smt_goals () ps in (x1, x2) in
    match x with
          ...
          | (gs', sgs') ->
              (FStarC_Tactics_V2_Builtins.set_goals gs ps;
               FStarC_Tactics_V2_Builtins.set_smt_goals (op_At () gs' sgs')
                 ps)))
let seq (f : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr)
  (g : unit -> (unit, Obj.t) FStar_Tactics_Effect.tac_repr) :
  (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let exact_n (n : Prims.int) (t : FStar_Tactics_NamedView.term) :
  ...
  fun ps ->
    ...
    exact_args x t ps
let ngoals (uu___ : unit) : (Prims.int, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let fresh_namedv_named (s : Prims.string) :
  (FStar_Tactics_NamedView.namedv, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let fresh_implicit_binder (t : FStarC_Reflection_Types.typ) :
  (FStar_Tactics_NamedView.binder, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = FStarC_Tactics_V2_Builtins.fresh () ps in
    {
      FStar_Tactics_NamedView.uniq = x;
...
let trytac (t : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a FStar_Pervasives_Native.option, Obj.t) FStar_Tactics_Effect.tac_repr=
  try_with
    (fun uu___ ->
       match () with
       | () -> (fun ps -> let x = t () ps in FStar_Pervasives_Native.Some x))
    (fun uu___ uu___1 -> FStar_Pervasives_Native.None)
let or_else (t1 : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr)
  (t2 : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let op_Less_Bar_Greater
  ...
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr= or_else t1 t2
let first
  (ts : (unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) Prims.list) :
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let repeat1 (t : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a Prims.list, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let discard (tau : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr)
  (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  ...
  fun t ps ->
    let x =
      trytac
        ...
        ps in
    ()
let tadmit (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  FStarC_Tactics_V2_Builtins.tadmit_t
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_Const FStarC_Reflection_V2_Data.C_Unit))
let admit1 (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  tadmit ()
let admit_all (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps -> let x = repeat tadmit ps in ()
let is_guard (uu___ : unit) :
  (Prims.bool, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps -> let x = _cur_goal () ps in FStarC_Tactics_Types.is_guard x
let skip_guard (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let simpl (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.simplify; FStarC_NormSteps.primops]
let whnf (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.weak;
    FStarC_NormSteps.hnf;
    FStarC_NormSteps.primops;
    FStarC_NormSteps.delta]
let compute (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  FStarC_Tactics_V2_Builtins.norm
    [FStarC_NormSteps.primops;
    FStarC_NormSteps.iota;
    FStarC_NormSteps.delta;
...
let intros' (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let tcut (t : FStar_Tactics_NamedView.term) :
  (FStar_Tactics_NamedView.binding, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let assumption (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
...
let unfold_def (t : FStar_Tactics_NamedView.term) :
  ...
  fun ps ->
    ...
    | FStar_Tactics_NamedView.Tv_FVar fv ->
        ...
        FStarC_Tactics_V2_Builtins.norm [FStarC_NormSteps.delta_fully [x1]]
          ps
    ...
    let x uu___ ps1 =
      let x1 =
        FStar_Tactics_Util.fold_left
          (fun k l uu___1 uu___2 ->
             or_else (fun uu___3 -> apply_lemma_rw l) k) trefl lems ps1 in
      x1 () ps1 in
    pointwise x ps
...
let change_sq (t1 : FStar_Tactics_NamedView.term) :
  ...
  FStarC_Tactics_V2_Builtins.change
    (FStar_Reflection_V2_Derived.mk_e_app
       ...
       [t1])
let finish_by (t : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = t () ps in
    or_else qed (fun uu___ -> fail "finish_by: not finished") ps; x
let solve_then (t1 : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr)
  (t2 : 'a -> ('b, Obj.t) FStar_Tactics_Effect.tac_repr) :
...
let add_elem (t : unit -> ('a, Obj.t) FStar_Tactics_Effect.tac_repr) :
  ('a, Obj.t) FStar_Tactics_Effect.tac_repr=
  focus
    (fun uu___ ps ->
       apply
  ...
  solve_then
    ...
    (fun uu___1 ->
       FStarC_Tactics_V2_Builtins.norm
         ...
         FStarC_NormSteps.iota;
         FStarC_NormSteps.zeta])
let tlabel (l : Prims.string) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    let x = goals () ps in
    match x with
...
let focus_all (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
    (let x1 =
...
let bump_nth (n : Prims.pos) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  fun ps ->
...
let rec destruct_list (t : FStar_Tactics_NamedView.term) :
  (FStar_Tactics_NamedView.term Prims.list, Obj.t)
    FStar_Tactics_Effect.tac_repr=
  fun ps ->
  ...
  fun ps ->
    ...
    | (e1, lb_bindings) ->
        ...
        FStar_Tactics_Util.fold_left
          ...
          lb_bindings ps
let trans (uu___ : unit) : (unit, Obj.t) FStar_Tactics_Effect.tac_repr=
  apply_lemma
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_FVar
          (FStarC_Reflection_V2_Builtins.pack_fv
