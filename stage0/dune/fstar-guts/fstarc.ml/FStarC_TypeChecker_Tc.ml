  ...
  FStarC_TypeChecker_Env.env ->
    FStarC_Syntax_Syntax.tscheme ->
      FStarC_Syntax_Syntax.typ ->
        FStarC_Range_Type.t -> FStarC_Syntax_Syntax.tscheme)
  =
  fun env ->
    fun uu___ ->
      fun expected_typ ->
...
let (read_postprocess_with_attr :
  Prims.bool ->
    FStarC_TypeChecker_Env.env ->
      FStarC_Syntax_Syntax.attribute Prims.list ->
        (FStarC_Syntax_Syntax.attribute Prims.list *
                      ...
                      let uu___4 =
                        let uu___5 =
                          FStarC_Class_Show.show FStarC_Ident.showable_lident
                            lid in
                        FStarC_Format.fmt1 "Ill-formed application of `%s`"
                          uu___5 in
                      FStarC_Errors_Msg.text uu___4 in
                    [uu___3] in
                  FStarC_Errors.log_issue FStarC_TypeChecker_Env.hasRange_env
                    env FStarC_Errors_Codes.Warning_UnrecognizedAttribute ()
              ...
              fun on_type1 ->
                fun lb ->
                  ...
                  | (s, univnames) ->
                      ...
                      let env1 =
                        FStarC_TypeChecker_Env.push_univ_vars env univnames in
                      let lbdef1 =
                        FStarC_TypeChecker_Env.postprocess env1 tau lbtyp
                          lbdef in
                      let lbdef2 =
                        FStarC_Syntax_Subst.close_univ_vars univnames lbdef1 in
                      let lbtyp1 =
                        if on_type1
                        then
                          let u =
                          ...
                          let lbtyp2 =
                            FStarC_TypeChecker_Env.postprocess env1 tau lbtyp
                              lbtyp in
                          FStarC_Syntax_Subst.close_univ_vars univnames
                            lbtyp2
                        else lbtyp in
                      {
                ...
                fun typ ->
                  ...
                  | {
                      ...
                      let has_auto_name bv =
                        ...
                        FStarC_Util.starts_with uu___2
                          FStarC_Ident.reserved_prefix in
                      let rec rename_binders def_bs1 =
                        fun val_bs1 ->
                             ...
                             FStarC_List.iter
                               (fun lb ->
                                  let fv =
                                    FStar_Pervasives.__proj__Inr__item__v
                                      lb.FStarC_Syntax_Syntax.lbname in
                                  FStarC_TypeChecker_Env.insert_fv_info env1
                                    fv lb.FStarC_Syntax_Syntax.lbtyp)
                               (FStar_Pervasives_Native.snd lbs1);
                 ...
                 then
                   let uu___4 =
                     let uu___5 =
                       FStarC_List.map
                         (FStarC_Class_Show.show
                            FStarC_Class_Show.showable_int) expected_errors in
                     ...
                     (fun uu___4 ->
                        FStarC_Options.with_saved_options
                          (fun uu___5 ->
                             let uu___6 =
                               let uu___7 =
                                 FStarC_Effect.op_Bang tc_decls_knot in
               ...
               then
                 ...
                 (match uu___2 with
                  | (ses, ne1, lift_from_pure_opt) ->
                      ...
                      ([], (FStarC_List.op_At ses effect_and_lift_ses1),
                        env0))
               else
                 (let ne1 =
                    let uu___3 = do_two_phases env in
             ...
             (match se.FStarC_Syntax_Syntax.sigel with
              ...
              | FStarC_Syntax_Syntax.Sig_pragma
                  ...
                  ((let uu___3 =
                   ...
                   env1)
              | FStarC_Syntax_Syntax.Sig_pragma (FStarC_Syntax_Syntax.Check
                  t0) ->
                            ...
                            (FStarC_Options.with_saved_options
                               (fun uu___5 ->
                                  ...
                                  (let uu___7 =
                                     let uu___8 =
                                       let uu___9 =
                                         FStarC_Errors_Msg.text "Term" in
                                       let uu___10 =
                                         let uu___11 =
                                           FStarC_Class_PP.pp
              ...
              | FStarC_Syntax_Syntax.Sig_polymonadic_subcomp
                  ...
                  ->
                  let uu___3 =
                    let uu___4 = FStarC_Option.must k in (ty, uu___4) in
...
let (tc_decls :
  ...
  fun env ->
    fun ses ->
      let rec process_one_decl uu___ =
        fun se ->
          match uu___ with
          | (ses1, env1) ->
                        ...
                        let ses'1 =
                          FStarC_List.map
                            (fun se1 ->
                               ...
                               FStarC_TypeChecker_Normalize.elim_uvars env2
                                 se1) ses' in
                        let ses_elaborated1 =
                          FStarC_List.map
                            (fun se1 ->
                        ...
                        (FStarC_TypeChecker_Env.promote_id_info env2
                         ...
                         (let ses'2 =
                          ...
                          (((FStarC_List.rev_append ses'2 ses1), env3),
                            ses_elaborated1))))))) in
      let process_one_decl_timed acc =
        fun se ->
          FStarC_TypeChecker_Core.clear_memo_table ();
          (let uu___1 = acc in
           match uu___1 with
            ...
            let modul1 =
              {
                ...
                FStarC_Syntax_Syntax.declarations =
                  (FStarC_List.op_At modul.FStarC_Syntax_Syntax.declarations
                     ses);
                FStarC_Syntax_Syntax.is_interface =
                  (modul.FStarC_Syntax_Syntax.is_interface)
              } in
  ...
  fun en ->
    fun m ->
      ...
      (let env = load_checked_module_sigelts en m in
       ...
       match uu___1 with
       | (uu___2, env1) -> (FStarC_Debug.restore dsnap; env1))
let (load_partial_checked_module :
  FStarC_TypeChecker_Env.env ->
    FStarC_Syntax_Syntax.modul -> FStarC_TypeChecker_Env.env)
  = fun en -> fun m -> load_checked_module_sigelts en m
let (check_module :
  FStarC_TypeChecker_Env.env ->
    FStarC_Syntax_Syntax.modul ->
      Prims.bool -> (FStarC_Syntax_Syntax.modul * FStarC_TypeChecker_Env.env))
