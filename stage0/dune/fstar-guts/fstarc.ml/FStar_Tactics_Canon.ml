open Prims
let step (t : unit -> FStarC_Tactics_Types.ref_proofstate -> unit)
...
let rec canon_point (e : FStar_Reflection_V2_Arith.expr)
  ...
  | FStar_Reflection_V2_Arith.Plus
      ...
      (FStarC_Tactics_V2_Builtins.norm [FStarC_NormSteps.primops] ps;
  ...
  | FStar_Reflection_V2_Arith.Mult (a, FStar_Reflection_V2_Arith.Plus (b, c))
      ->
      (step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
       ...
       step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "cong_plus"]))) ps;
  ...
  | FStar_Reflection_V2_Arith.Mult (FStar_Reflection_V2_Arith.Plus (a, b), c)
      ->
      (step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
       ...
       (let x3 = canon_point (FStar_Reflection_V2_Arith.Mult (a, c)) ps in
        ...
        canon_point (FStar_Reflection_V2_Arith.Plus (x3, x4)) ps))
  | FStar_Reflection_V2_Arith.Mult (a, FStar_Reflection_V2_Arith.Mult (b, c))
      ->
      (step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "ass_mult_l"]))) ps;
       step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "cong_mult"]))) ps;
       (let x3 = canon_point (FStar_Reflection_V2_Arith.Mult (a, b)) ps in
        let x4 = canon_point c ps in
        canon_point (FStar_Reflection_V2_Arith.Mult (x3, x4)) ps))
  | FStar_Reflection_V2_Arith.Plus (a, FStar_Reflection_V2_Arith.Plus (b, c))
      ->
      (step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "ass_plus_l"]))) ps;
       step_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
       ...
       (let x3 = canon_point (FStar_Reflection_V2_Arith.Plus (a, b)) ps in
        let x4 = canon_point c ps in
        canon_point (FStar_Reflection_V2_Arith.Plus (x3, x4)) ps))
  | FStar_Reflection_V2_Arith.Plus (FStar_Reflection_V2_Arith.Plus (a, b), c)
      ->
      ...
      then
        (step_lemma
           (FStarC_Reflection_V2_Builtins.pack_ln
              (FStarC_Reflection_V2_Data.Tv_FVar
                 (FStarC_Reflection_V2_Builtins.pack_fv
                    ["FStar"; "Tactics"; "Canon"; "Lemmas"; "sw_plus"]))) ps;
         FStar_Tactics_V2_Derived.apply_lemma
           (FStarC_Reflection_V2_Builtins.pack_ln
              (FStarC_Reflection_V2_Data.Tv_FVar
                 (FStarC_Reflection_V2_Builtins.pack_fv
  ...
  | FStar_Reflection_V2_Arith.Mult (FStar_Reflection_V2_Arith.Mult (a, b), c)
      ->
      if FStar_Order.gt (FStar_Reflection_V2_Arith.compare_expr b c)
      then
        (step_lemma
           (FStarC_Reflection_V2_Builtins.pack_ln
              (FStarC_Reflection_V2_Data.Tv_FVar
                 (FStarC_Reflection_V2_Builtins.pack_fv
                    ["FStar"; "Tactics"; "Canon"; "Lemmas"; "sw_mult"]))) ps;
         FStar_Tactics_V2_Derived.apply_lemma
           (FStarC_Reflection_V2_Builtins.pack_ln
              (FStarC_Reflection_V2_Data.Tv_FVar
                 (FStarC_Reflection_V2_Builtins.pack_fv
  ...
  | FStar_Reflection_V2_Arith.Mult (FStar_Reflection_V2_Arith.Lit uu___, r)
      ...
      (FStar_Tactics_V2_Derived.apply_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "one_mult_x"]))) ps;
       r)
  | FStar_Reflection_V2_Arith.Mult (l, FStar_Reflection_V2_Arith.Lit uu___)
      ...
      (FStar_Tactics_V2_Derived.apply_lemma
         (FStarC_Reflection_V2_Builtins.pack_ln
            (FStarC_Reflection_V2_Data.Tv_FVar
               (FStarC_Reflection_V2_Builtins.pack_fv
                  ["FStar"; "Tactics"; "Canon"; "Lemmas"; "x_mult_one"]))) ps;
       l)
...
let canon_point_entry (uu___ : unit)
  ...
  (let x1 = FStar_Tactics_V2_Derived.cur_goal () ps in
   ...
   | FStar_Reflection_V2_Formula.Comp
       ...
       (match x3 with
        | FStar_Pervasives.Inr e -> let x4 = canon_point e ps in ()
        | FStar_Pervasives.Inl uu___2 -> FStar_Tactics_V2_Derived.trefl () ps)
   | uu___1 ->
       let x3 =
...
let canon (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
