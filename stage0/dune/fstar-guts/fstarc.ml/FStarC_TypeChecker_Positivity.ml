    ...
    fun sig1 ->
      ...
      | FStarC_Syntax_Syntax.Sig_bundle
          ...
          (match uu___ with
           | (tcs, datas) ->
               let tcs1 =
                 FStarC_List.map (fun tc -> mark_tycon_parameters tc datas)
                   tcs in
               {
                        ...
                        then
                          ...
                          (check_no_index_occurrences_in_arities env mutuals
                           ...
                           (let ilid = fv in
                            ...
                            let uu___6 =
                              FStarC_List.splitAt num_uniform_params args in
                            match uu___6 with
                            | (params, _rest) ->
                                let uu___7 =
                                ...
                                then
                                  ...
                                  (debug_positivity env
                                   ...
                                   (let uu___11 =
                                    ...
                                    FStarC_Effect.op_Colon_Equals unfolded
                                      uu___11);
                                   FStarC_List.for_all
                                     (fun d ->
    ...
    fun mutuals ->
      fun ty ->
        ...
        | (env1, (ty_lid, ty_us, ty_params)) ->
            ...
            let mutuals2 =
              let uu___1 =
                FStarC_List.existsML (FStarC_Ident.lid_equals ty_lid)
                  mutuals1 in
