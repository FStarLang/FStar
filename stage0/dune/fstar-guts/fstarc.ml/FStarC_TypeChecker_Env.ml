...
let uu___is_SafePrimops (projectee : step) : Prims.bool=
  match projectee with | SafePrimops -> true | uu___ -> false
...
and env =
  ...
  letrecs:
    ...
    ;
  rec_names: FStarC_Syntax_Syntax.bv Prims.list ;
...
let __proj__Mkenv__item__solver (projectee : env) : solver_t=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      generalize; letrecs; rec_names; top_level; check_uvars; use_eq_strict;
      is_iface; admit; phase1; failhard; flychecking; uvar_subtyping;
      intactics; nocoerce; tc_term; typeof_tot_or_gtot_term; universe_of;
      typeof_well_typed_tot_or_gtot_term; teq_nosmt_force;
      subtype_nosmt_force; qtbl_name_and_index; fv_delta_depths; proof_ns;
      synth_hook; try_solve_implicits_hook; splice; mpreprocess; postprocess;
      identifier_info; tc_hooks; dsenv; nbe; strict_args_tab; disc_proj_tab;
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> solver
let __proj__Mkenv__item__range (projectee : env) : FStarC_Range_Type.t=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> range
let __proj__Mkenv__item__curmodule (projectee : env) : FStarC_Ident.lident=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> curmodule
let __proj__Mkenv__item__gamma (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> gamma
let __proj__Mkenv__item__gamma_sig (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> gamma_sig
let __proj__Mkenv__item__gamma_cache (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> gamma_cache
let __proj__Mkenv__item__modules (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> modules
let __proj__Mkenv__item__expected_typ (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> expected_typ
let __proj__Mkenv__item__sigtab (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> sigtab
let __proj__Mkenv__item__attrtab (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> attrtab
let __proj__Mkenv__item__instantiate_imp (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> instantiate_imp
let __proj__Mkenv__item__effects (projectee : env) : effects=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> effects1
let __proj__Mkenv__item__generalize (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> generalize
let __proj__Mkenv__item__letrecs (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> letrecs
let __proj__Mkenv__item__rec_names (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> rec_names
let __proj__Mkenv__item__top_level (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> top_level
let __proj__Mkenv__item__check_uvars (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> check_uvars
let __proj__Mkenv__item__use_eq_strict (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> use_eq_strict
let __proj__Mkenv__item__is_iface (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> is_iface
let __proj__Mkenv__item__admit (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> admit
let __proj__Mkenv__item__phase1 (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> phase1
let __proj__Mkenv__item__failhard (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> failhard
let __proj__Mkenv__item__flychecking (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> flychecking
let __proj__Mkenv__item__uvar_subtyping (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> uvar_subtyping
let __proj__Mkenv__item__intactics (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> intactics
let __proj__Mkenv__item__nocoerce (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> nocoerce
let __proj__Mkenv__item__tc_term (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> tc_term
let __proj__Mkenv__item__typeof_tot_or_gtot_term (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> typeof_tot_or_gtot_term
let __proj__Mkenv__item__universe_of (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> universe_of
let __proj__Mkenv__item__typeof_well_typed_tot_or_gtot_term (projectee : env)
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} ->
      typeof_well_typed_tot_or_gtot_term
let __proj__Mkenv__item__teq_nosmt_force (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> teq_nosmt_force
let __proj__Mkenv__item__subtype_nosmt_force (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> subtype_nosmt_force
let __proj__Mkenv__item__qtbl_name_and_index (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> qtbl_name_and_index
let __proj__Mkenv__item__fv_delta_depths (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> fv_delta_depths
let __proj__Mkenv__item__proof_ns (projectee : env) : proof_namespace=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> proof_ns
let __proj__Mkenv__item__synth_hook (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> synth_hook
let __proj__Mkenv__item__try_solve_implicits_hook (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> try_solve_implicits_hook
let __proj__Mkenv__item__splice (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> splice
let __proj__Mkenv__item__mpreprocess (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> mpreprocess
let __proj__Mkenv__item__postprocess (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> postprocess
let __proj__Mkenv__item__identifier_info (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> identifier_info
let __proj__Mkenv__item__tc_hooks (projectee : env) : tcenv_hooks=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> tc_hooks
let __proj__Mkenv__item__dsenv (projectee : env) : FStarC_Syntax_DsEnv.env=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> dsenv
let __proj__Mkenv__item__nbe (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> nbe
let __proj__Mkenv__item__strict_args_tab (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> strict_args_tab
let __proj__Mkenv__item__disc_proj_tab (projectee : env) :
  (FStarC_Syntax_Syntax.qualifier * Prims.int * Prims.int
    FStar_Pervasives_Native.option) FStar_Pervasives_Native.option
    FStarC_SMap.t=
  match projectee with
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> disc_proj_tab
let __proj__Mkenv__item__erasable_types_tab (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> erasable_types_tab
let __proj__Mkenv__item__enable_defer_to_tac (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> enable_defer_to_tac
let __proj__Mkenv__item__unif_allow_ref_guards (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> unif_allow_ref_guards
let __proj__Mkenv__item__erase_erasable_args (projectee : env) : Prims.bool=
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> erase_erasable_args
let __proj__Mkenv__item__core_check (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> core_check
let __proj__Mkenv__item__missing_decl (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> missing_decl
let __proj__Mkenv__item__iface_todo (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> iface_todo
let __proj__Mkenv__item__iface_hidden (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> iface_hidden
let __proj__Mkenv__item__iface_lids (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> iface_lids
let __proj__Mkenv__item__iface_val_lids (projectee : env) :
  ...
  | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
      ...
      erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;
      erase_erasable_args; core_check; missing_decl; iface_todo;
      iface_hidden; iface_lids; iface_val_lids;_} -> iface_val_lids
let __proj__Mksolver_t__item__init (projectee : solver_t) : env -> unit=
  match projectee with
  | { init; snapshot; rollback; encode_sig; preprocess; handle_smt_goal;
      solve; solve_sync; finish; refresh;_} -> init
let __proj__Mksolver_t__item__snapshot (projectee : solver_t) :
  Prims.string -> ((Prims.int * Prims.int * Prims.int) * unit)=
  match projectee with
  | { init; snapshot; rollback; encode_sig; preprocess; handle_smt_goal;
      solve; solve_sync; finish; refresh;_} -> snapshot
...
let rename_gamma (subst : FStarC_Syntax_Syntax.subst_t)
  (g : FStarC_Syntax_Syntax.gamma) : FStarC_Syntax_Syntax.gamma=
  FStarC_List.map
    (fun uu___ ->
       match uu___ with
       | FStarC_Syntax_Syntax.Binding_var x ->
           ...
           (match uu___1 with
            ...
            | uu___2 -> FStarC_Effect.failwith "Not a renaming")
       | b -> b) g
let rename_env (subst : FStarC_Syntax_Syntax.subst_t) (e : env) : env=
  let uu___ = rename_gamma subst e.gamma in
  {
    solver = (e.solver);
    range = (e.range);
              ...
              (res,
                {
                  ...
                  disc_proj_tab = (env2.disc_proj_tab);
...
let is_iface_hidden (e : env) (l : FStarC_Ident.lident) : Prims.bool=
  if match e.iface_todo with | hd::tl -> true | uu___ -> false
  then
...
let set_iface_lids (e : env) (ls : FStarC_Ident.lident Prims.list)
  ...
  let uu___ =
    let uu___1 =
      FStarC_Class_Setlike.from_list
        (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_fv) ls in
    FStar_Pervasives_Native.Some uu___1 in
  let uu___1 =
    FStarC_Class_Setlike.from_list
      (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_fv) vals in
  {
    solver = (e.solver);
    range = (e.range);
    curmodule = (e.curmodule);
...
let has_iface (e : env) : Prims.bool=
  match e.iface_lids with
  | FStar_Pervasives_Native.Some v -> true
  | uu___ -> false
let declared_in_iface (e : env) (l : FStarC_Ident.lident) : Prims.bool=
  match e.iface_lids with
  | FStar_Pervasives_Native.None -> false
  | FStar_Pervasives_Native.Some ls ->
      FStarC_Class_Setlike.mem
        (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_fv) l ls
let has_iface_val (e : env) (l : FStarC_Ident.lident) : Prims.bool=
  FStarC_Class_Setlike.mem
    (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_fv) l
    e.iface_val_lids
...
let initial_env (deps : FStarC_Parser_Dep.deps)
  (tc_term :
    env ->
      FStarC_Syntax_Syntax.term ->
        (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.comp * guard_t))
  (typeof_tot_or_gtot_term :
    env ->
      FStarC_Syntax_Syntax.term ->
        must_tot ->
  ...
  let uu___4 = FStarC_SMap.create (Prims.of_int 50) in
  let uu___5 = FStarC_Options.using_facts_from () in
  let uu___6 =
    FStarC_Effect.mk_ref FStarC_TypeChecker_Common.id_info_table_empty in
  let uu___7 =
    let uu___8 = FStarC_Syntax_DsEnv.empty_env deps in
    FStarC_Syntax_DsEnv.set_current_module uu___8 module_lid in
      ...
      (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_fv) () in
  {
    ...
    identifier_info = uu___6;
    tc_hooks = default_tc_hooks;
    dsenv = uu___7;
    nbe;
    strict_args_tab = uu___8;
    disc_proj_tab = uu___9;
...
let add_query_index (ln : (FStarC_Ident.lident * Prims.int)) : unit=
  ...
  | (l, n) ->
      ...
      (match uu___1 with
       ...
       | uu___2 -> FStarC_Effect.failwith "Empty query indices")
...
let push_stack (env1 : env) : env=
  ...
  (let uu___1 = FStarC_SMap.copy (gamma_cache env1) in
   ...
   let uu___5 = FStarC_SMap.copy env1.fv_delta_depths in
   let uu___6 =
     let uu___7 = FStarC_Effect.op_Bang env1.identifier_info in
     FStarC_Effect.mk_ref uu___7 in
   let uu___7 = FStarC_SMap.copy env1.strict_args_tab in
   let uu___8 = FStarC_SMap.copy env1.disc_proj_tab in
   let uu___9 = FStarC_SMap.copy env1.erasable_types_tab in
   {
     ...
     dsenv = (env1.dsenv);
     nbe = (env1.nbe);
     strict_args_tab = uu___7;
     disc_proj_tab = uu___8;
...
let pop_stack (uu___ : unit) : env=
  ...
  | uu___2 -> FStarC_Effect.failwith "Impossible: Too many pops"
                  ...
                  (match () with
                   | () ->
                       ...
                       (FStarC_Common.runtime_assert
                          (FStarC_Util.physical_equality tcenv.dsenv dsenv1)
...
let set_current_module (env1 : env) (lid : FStarC_Ident.lident) : env=
    ...
    } in
  {
    ...
    identifier_info = (env2.identifier_info);
    tc_hooks = (env2.tc_hooks);
    dsenv = (FStarC_Syntax_DsEnv.set_current_module env2.dsenv lid);
    nbe = (env2.nbe);
    strict_args_tab = (env2.strict_args_tab);
    disc_proj_tab = (env2.disc_proj_tab);
    erasable_types_tab = (env2.erasable_types_tab);
...
let inst_effect_fun_with (insts : FStarC_Syntax_Syntax.universes)
  ...
  (p : FStarC_Syntax_Syntax.tscheme) : FStarC_Syntax_Syntax.term=
  let uu___ = p in
  match uu___ with
  | (us, t) ->
      (if (FStarC_List.length insts) <> (FStarC_List.length us)
       ...
       (let uu___2 = inst_tscheme_with (us, t) insts in
...
let in_cur_mod (env1 : env) (l : FStarC_Ident.lident) : tri=
  ...
  if (FStarC_Ident.nsstr l) = (FStarC_Ident.string_of_lid cur)
  then Yes
  else
    if
      FStarC_Util.starts_with (FStarC_Ident.nsstr l)
        (FStarC_Ident.string_of_lid cur)
    then
      (let lns =
         FStarC_List.op_At (FStarC_Ident.ns_of_lid l)
           [FStarC_Ident.ident_of_lid l] in
       let cur1 =
         FStarC_List.op_At (FStarC_Ident.ns_of_lid cur)
...
let lookup_qname (env1 : env) (lid : FStarC_Ident.lident) : qninfo=
  ...
  let cache t =
    FStarC_SMap.add (gamma_cache env1) (FStarC_Ident.string_of_lid lid) t;
    FStar_Pervasives_Native.Some t in
  let found =
    if cur_mod <> No
    then
      let uu___ =
        FStarC_SMap.try_find (gamma_cache env1)
...
let lookup_attr (env1 : env) (attr : Prims.string) :
  ...
  if match env1.iface_todo with | [] -> true | uu___ -> false
  then ses
  else
    FStarC_List.filter
      (fun se ->
...
let try_add_sigelt (force : Prims.bool) (env1 : env)
  ...
  (let uu___1 =
   ...
   then
     ...
     (if
        (match old_se.FStarC_Syntax_Syntax.sigel with
  ...
  | uu___ ->
      ...
      (FStarC_List.iter (try_add_sigelt force env1 se) lids;
       FStarC_List.iter
         (fun l ->
            let s = FStarC_Ident.string_of_lid l in
            (let uu___4 = FStarC_SMap.try_find env1.fv_delta_depths s in
             match uu___4 with
             | FStar_Pervasives_Native.Some
                 (FStarC_Syntax_Syntax.Delta_abstract uu___5) ->
                 let ns = Prims.strcat (FStarC_Ident.nsstr l) "." in
                 let uu___6 = FStarC_SMap.keys env1.fv_delta_depths in
                 FStarC_List.iter
                   (fun k ->
                      if FStarC_Util.starts_with k ns
                      then FStarC_SMap.remove env1.fv_delta_depths k
                      else ()) uu___6
             | uu___5 -> ());
            FStarC_SMap.remove env1.fv_delta_depths s;
            FStarC_SMap.remove env1.strict_args_tab s;
            FStarC_SMap.remove env1.disc_proj_tab s) lids;
                 ...
                 let uu___2 =
                   let uu___3 =
                     inst_tscheme1
                       ((lb.FStarC_Syntax_Syntax.lbunivs),
                         (lb.FStarC_Syntax_Syntax.lbtyp)) in
                   (uu___3, (FStarC_Syntax_Syntax.range_of_fv fv)) in
                 FStar_Pervasives_Native.Some uu___2
               else FStar_Pervasives_Native.None)
  | uu___ -> FStar_Pervasives_Native.None
let effect_signature
  (us_opt : FStarC_Syntax_Syntax.universes FStar_Pervasives_Native.option)
  (se : FStarC_Syntax_Syntax.sigelt) (rng : 'uuuuu) :
  ((FStarC_Syntax_Syntax.universes * FStarC_Syntax_Syntax.typ) *
  ...
  let inst_ts us_opt1 ts =
    ...
    | FStar_Pervasives_Native.Some us -> inst_tscheme_with ts us in
  match se.FStarC_Syntax_Syntax.sigel with
  | FStarC_Syntax_Syntax.Sig_new_effect uu___ ->
      let a =
        let uu___1 =
      ...
      FStar_Pervasives_Native.Some uu___1
  | FStarC_Syntax_Syntax.Sig_effect_abbrev uu___ ->
      let a =
        let uu___1 =
          let uu___2 = FStarC_Syntax_Util.type_u () in
          FStar_Pervasives_Native.fst uu___2 in
                    ...
                    let uu___13 =
                      let uu___14 =
                        let uu___15 =
                          ...
                          FStarC_Syntax_Util.arrow tps uu___16 in
                        (uvs, uu___15) in
...
let lookup_bv (env1 : env) (bv : FStarC_Syntax_Syntax.bv) :
  ...
  | FStar_Pervasives_Native.Some (t, r) ->
      ...
      (uu___1,
        (FStarC_Range_Type.set_use_range r (FStarC_Range_Type.use_range bvr)))
let try_lookup_lid (env1 : env) (l : FStarC_Ident.lident) :
  ...
  | FStar_Pervasives_Native.Some ((us, t), r) ->
      ...
      let r1 =
        FStarC_Range_Type.set_use_range r
          (FStarC_Range_Type.use_range use_range) in
      let uu___1 =
        let uu___2 =
...
let try_lookup_val_decl (env1 : env) (lid : FStarC_Ident.lident) :
  ...
  | FStar_Pervasives_Native.Some
      ...
      let uu___8 =
        let uu___9 =
          let uu___10 =
            FStarC_Syntax_Subst.set_use_range (FStarC_Ident.range_of_lid lid)
              t in
          (uvs, uu___10) in
        (uu___9, q) in
...
let datacons_of_typ (env1 : env) (lid : FStarC_Ident.lident) :
  ...
  | FStar_Pervasives_Native.Some
      ...
      -> (true, dcs)
  | uu___1 -> (false, [])
let discard_specs (env1 : env) : Prims.bool=
  if env1.phase1 then true else FStarC_Options.admit_smt_queries ()
  ...
  | (hd, uu___1) ->
      ...
      (match uu___2 with
       | FStarC_Syntax_Syntax.Tm_fvar fv when
           ...
           let u = env1.universe_of env1 base in
           let uu___3 = FStarC_Syntax_Util.mk_has_type [u; u] base v base in
...
let num_datacon_non_injective_ty_params (env1 : env)
  ...
  | uu___1 -> FStar_Pervasives_Native.None
let num_datacon_ty_params (env1 : env) (lid : FStarC_Ident.lident) :
  ...
  | uu___1 -> FStar_Pervasives_Native.None
let datacon_decl (env1 : env) (lid : FStarC_Ident.lident) :
  (FStarC_Syntax_Syntax.fv_qual * Prims.int * FStarC_Syntax_Syntax.tscheme)
    FStar_Pervasives_Native.option=
  let uu___ = lookup_qname env1 lid in
  match uu___ with
  | FStar_Pervasives_Native.Some
      ...
      let fvq =
        let uu___12 =
          FStarC_Util.find_map sigquals
            (fun uu___13 ->
               match uu___13 with
               | FStarC_Syntax_Syntax.RecordConstructor (uu___14, fs) ->
                   FStar_Pervasives_Native.Some
                     (FStarC_Syntax_Syntax.Record_ctor (ty_lid, fs))
               | uu___14 -> FStar_Pervasives_Native.None) in
        match uu___12 with
        | FStar_Pervasives_Native.Some q -> q
        | FStar_Pervasives_Native.None -> FStarC_Syntax_Syntax.Data_ctor in
      FStar_Pervasives_Native.Some (fvq, num_ty_params, (us, t))
  | uu___1 -> FStar_Pervasives_Native.None
let disc_proj_qual (env1 : env) (l : FStarC_Ident.lident) :
  FStarC_Syntax_Syntax.qualifier FStar_Pervasives_Native.option=
  let n = FStarC_Ident.string_of_id (FStarC_Ident.ident_of_lid l) in
  if
    Prims.not
      ((FStarC_Util.starts_with n FStarC_Syntax_Util.field_projector_prefix)
         ||
         (FStarC_Util.starts_with n
            (Prims.strcat FStarC_Ident.reserved_prefix "is_")))
  then FStar_Pervasives_Native.None
  else
    (let uu___ = lookup_qname env1 l in
     match uu___ with
         ...
         FStarC_List.tryPick
           (fun uu___9 ->
              ...
              | FStarC_Syntax_Syntax.Discriminator d ->
                  FStar_Pervasives_Native.Some
                    (FStarC_Syntax_Syntax.Discriminator d)
              | uu___10 -> FStar_Pervasives_Native.None) quals
     | uu___1 -> FStar_Pervasives_Native.None)
let disc_proj_info (env1 : env) (l : FStarC_Ident.lident) :
  (FStarC_Syntax_Syntax.qualifier * Prims.int * Prims.int
    FStar_Pervasives_Native.option) FStar_Pervasives_Native.option=
  let uu___ = disc_proj_qual env1 l in
  match uu___ with
  | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
  | FStar_Pervasives_Native.Some q ->
      let d =
        ...
        | uu___1 -> FStarC_Effect.failwith "disc_proj_info: impossible" in
      let n_indexed =
        let ty_lid = typ_of_datacon env1 d in
        let uu___1 = lookup_lid env1 ty_lid in
        match uu___1 with
        | ((uu___2, k), uu___3) ->
            let uu___4 =
              let uu___5 = FStarC_Syntax_Util.arrow_formals_comp_ln k in
              FStar_Pervasives_Native.fst uu___5 in
            FStarC_List.length uu___4 in
      (match q with
       | FStarC_Syntax_Syntax.Discriminator uu___1 ->
           FStar_Pervasives_Native.Some
             (q, n_indexed, FStar_Pervasives_Native.None)
       | uu___1 ->
           let uu___2 = num_datacon_ty_params env1 d in
           (match uu___2 with
            | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some n_ty_params ->
                let uu___3 = lookup_datacon env1 d in
                (match uu___3 with
                 | (uu___4, ctor_t) ->
                     let uu___5 =
                       FStarC_Syntax_Util.arrow_formals_comp_ln_strict ctor_t in
                     (match uu___5 with
                      | (bs, uu___6) ->
                          if (FStarC_List.length bs) < n_ty_params
                          then FStar_Pervasives_Native.None
                          else
                            (let uu___7 = FStarC_Util.first_N n_ty_params bs in
                             match uu___7 with
                             | (uu___8, fields) ->
                                 let idx =
                                   let uu___9 =
                                     FStarC_List.mapi (fun j b -> (j, b))
                                       fields in
                                   FStarC_List.tryPick
                                     (fun uu___10 ->
                                        match uu___10 with
                                            ...
                                            let uu___11 =
                                              let uu___12 =
                                                FStarC_Syntax_Util.mk_field_projector_name
                                                  ...
                                                  j in
                                              FStarC_Ident.lid_equals uu___12
                                                l in
                                            if uu___11
                                            then
  ...
  | FStar_Pervasives_Native.Some
      ...
      (match se.FStarC_Syntax_Syntax.sigel with
       | FStarC_Syntax_Syntax.Sig_let
           ...
           if uu___2 then (Prims.not is_rec) || rec_ok else false ->
           FStarC_Util.find_map lbs
             (fun lb ->
                let fv =
                  match lb.FStarC_Syntax_Syntax.lbname with
           ...
           let uu___3 =
             FStarC_Util.for_some
               (fun uu___4 ->
                  ...
                  | uu___5 -> false) se.FStarC_Syntax_Syntax.sigquals in
           if uu___3
           then FStarC_Syntax_Syntax.Delta_equational_at_level Prims.int_one
           else
             (let uu___4 =
                let uu___5 =
                  FStarC_Util.for_some
                ...
                then
                  Prims.not
                    (se.FStarC_Syntax_Syntax.sigmeta).FStarC_Syntax_Syntax.sigmeta_type_constructor
                else false in
              if uu___4 then FStarC_Syntax_Syntax.Delta_abstract d0 else d0)
       | FStarC_Syntax_Syntax.Sig_let
               ...
               (fun lb ->
                  ...
                  then
                    let uu___5 =
                      ...
                      FStarC_Syntax_Util.incr_delta_depth uu___6 in
                    FStar_Pervasives_Native.Some uu___5
                  else FStar_Pervasives_Native.None) in
           FStarC_Option.must uu___4
       | FStarC_Syntax_Syntax.Sig_fail uu___2 ->
           FStarC_Effect.failwith "impossible: delta_depth_of_qninfo"
...
and delta_depth_of_fv (env1 : env) (fv : FStarC_Syntax_Syntax.fv) :
  ...
  let uu___ =
    FStarC_SMap.try_find env1.fv_delta_depths
      (FStarC_Ident.string_of_lid lid) in
  match uu___ with
  | FStar_Pervasives_Native.Some dd -> dd
  | FStar_Pervasives_Native.None ->
      (FStarC_SMap.add env1.fv_delta_depths (FStarC_Ident.string_of_lid lid)
...
and delta_depth_of_term (env1 : env) (t : FStarC_Syntax_Syntax.term) :
  ...
  | FStarC_Syntax_Syntax.Tm_meta uu___ ->
      FStarC_Effect.failwith "Impossible (delta depth of term)"
  ...
  | FStarC_Syntax_Syntax.Tm_app uu___ ->
      ...
      (match uu___1 with | (hd, uu___2) -> delta_depth_of_term env1 hd)
  | FStarC_Syntax_Syntax.Tm_abs uu___ ->
      let uu___1 = FStarC_Syntax_Util.abs_formals_ln t1 in
      (match uu___1 with
       | (uu___2, body, uu___3) -> delta_depth_of_term env1 body)
...
let fv_has_strict_args (env1 : env) (fv : FStarC_Syntax_Syntax.fv) :
  ...
  let f uu___ =
    let attrs = lookup_attrs_of_lid env1 (FStarC_Syntax_Syntax.lid_of_fv fv) in
    match attrs with
       ...
       | FStar_Pervasives_Native.Some ((uu___3, t), r) ->
           let uu___4 =
             FStarC_Syntax_Subst.set_use_range
               (FStarC_Ident.range_of_lid ftv) t in
...
let rec non_informative (env1 : env) (t : FStarC_Syntax_Syntax.typ) :
  ...
  | FStarC_Syntax_Syntax.Tm_app uu___1 ->
      let uu___2 =
        let uu___3 = FStarC_Syntax_Util.unrefine t in
        FStarC_Syntax_Util.head_and_args_full uu___3 in
      (match uu___2 with | (head, uu___3) -> non_informative env1 head)
  | FStarC_Syntax_Syntax.Tm_abs uu___1 ->
      let uu___2 =
        let uu___3 = FStarC_Syntax_Util.unrefine t in
        FStarC_Syntax_Util.abs_formals_ln uu___3 in
      (match uu___2 with
       | (uu___3, body, uu___4) -> non_informative env1 body)
  | FStarC_Syntax_Syntax.Tm_uinst (t1, uu___1) -> non_informative env1 t1
  | FStarC_Syntax_Syntax.Tm_arrow uu___1 ->
      let uu___2 =
        let uu___3 = FStarC_Syntax_Util.unrefine t in
        FStarC_Syntax_Util.arrow_formals_comp_ln uu___3 in
      (match uu___2 with
       | (uu___3, c) ->
           let uu___4 =
             let uu___5 = FStarC_Syntax_Util.is_pure_or_ghost_comp c in
             if uu___5
...
let num_effect_indices (env1 : env) (name : FStarC_Ident.lident)
  ...
  let uu___ = FStarC_Syntax_Util.arrow_formals_comp_ln_strict sig_t in
  match uu___ with
  | (bs, uu___1) ->
      (match bs with
       | _a::bs1 -> FStarC_List.length bs1
       | uu___2 ->
           let uu___3 =
             let uu___4 =
             ...
             FStarC_Format.fmt2 "Signature for %s not an arrow (%s)" uu___4
               uu___5 in
...
let lookup_projector (env1 : env) (lid : FStarC_Ident.lident) (i : Prims.int)
  ...
  | (uu___1, t) ->
      ...
      (match uu___2 with
       | (binders, uu___3) ->
           if (match binders with | [] -> true | uu___4 -> false)
           then fail ()
           else
...
let is_interpreted (env1 : env) (head : FStarC_Syntax_Syntax.term) :
  Prims.bool=
...
let get_lid_valued_effect_attr (env1 : env) (eff_lid : FStarC_Ident.lident)
  ...
  let attr_args =
    let uu___ =
      let uu___1 = lookup_attrs_of_lid env1 eff_lid in
...
let join_opt (env1 : env) (l1 : FStarC_Ident.lident)
  ...
  then FStar_Pervasives_Native.Some l1
    ...
    if
      ((FStarC_Parser_Const.is_gtot_lid l1) &&
         (FStarC_Parser_Const.is_tot_lid l2))
        ||
        ((FStarC_Parser_Const.is_gtot_lid l2) &&
           (FStarC_Parser_Const.is_tot_lid l1))
    then FStar_Pervasives_Native.Some FStarC_Parser_Const.primitive_ghost_lid
    else
      (let uu___ =
         FStarC_Option.find
           (fun uu___1 ->
    ...
    FStarC_Class_Binders.freeNames =
      (fun g ->
         ...
         | FStarC_TypeChecker_Common.NonTrivial f ->
             FStarC_Class_Binders.freeNames
               FStarC_Class_Binders.hasNames_term f)
  }
  ...
  (let r =
     {
       FStarC_Syntax_Syntax.n =
         (FStarC_Syntax_Syntax.Comp
            (let uu___1 = FStarC_Syntax_Util.comp_to_comp_typ c in
             {
               FStarC_Syntax_Syntax.effect_name =
                 (uu___1.FStarC_Syntax_Syntax.effect_name);
               FStarC_Syntax_Syntax.result_typ =
                 (uu___1.FStarC_Syntax_Syntax.result_typ);
               FStarC_Syntax_Syntax.flags = f;
               FStarC_Syntax_Syntax.source_effect_name =
                 (uu___1.FStarC_Syntax_Syntax.source_effect_name)
             }));
  ...
  | FStar_Pervasives_Native.Some (ed, uu___1) ->
      (match FStarC_Syntax_Util.get_eff_repr ed with
       ...
       | FStar_Pervasives_Native.Some ts ->
           let c1 = FStarC_Syntax_Util.comp_to_comp_typ c in
...
let is_user_reifiable_effect (env1 : env) (effect_lid : FStarC_Ident.lident)
  : Prims.bool=
  let quals = lookup_effect_quals env1 effect_lid in
...
let effect_universe (env1 : env) (eff : FStarC_Ident.lident)
  (u_res : FStarC_Syntax_Syntax.universe) : FStarC_Syntax_Syntax.universe=
  if FStarC_Syntax_Util.is_pure_or_ghost_effect eff
  then u_res
  else
    (let uu___ = let uu___1 = is_total_effect env1 eff in Prims.not uu___1 in
     if uu___
     then FStarC_Syntax_Syntax.U_zero
     else
       (let uu___1 = effect_decl_opt env1 eff in
        match uu___1 with
        | FStar_Pervasives_Native.None -> u_res
        | FStar_Pervasives_Native.Some (ed, uu___2) ->
            (match FStarC_Syntax_Util.get_repr_universe ed with
             | FStar_Pervasives_Native.None -> u_res
             | FStar_Pervasives_Native.Some ts ->
                 let uu___3 = inst_tscheme_with ts [u_res] in
                 (match uu___3 with
                  | (uu___4, t) ->
                      let uu___5 =
                           ...
                           let uu___7 =
                             let uu___8 =
                               FStarC_Class_Show.show
                                 FStarC_Syntax_Print.showable_term t in
                             FStarC_Format.fmt2
                               "Effect %s has no computed representation universe (got %s); its declaration was not typechecked"
                               (FStarC_Ident.string_of_lid eff) uu___8 in
                           FStarC_Effect.failwith uu___7)))))
let is_reifiable_effect (env1 : env) (effect_lid : FStarC_Ident.lident) :
  Prims.bool=
  let uu___ = effect_decl_opt env1 effect_lid in
  match uu___ with
  | FStar_Pervasives_Native.None -> false
  | FStar_Pervasives_Native.Some (ed, uu___1) ->
...
let is_reifiable_function (env1 : env) (t : FStarC_Syntax_Syntax.term) :
  ...
  match uu___ with
  | FStarC_Syntax_Syntax.Tm_arrow uu___1 ->
      let uu___2 = FStarC_Syntax_Util.arrow_formals_comp_ln t in
      (match uu___2 with | (uu___3, c) -> is_reifiable_comp env1 c)
  | uu___1 -> false
let reify_comp (env1 : env) (c : FStarC_Syntax_Syntax.comp)
  ...
  (let uu___1 = let uu___2 = is_reifiable_effect env1 l in Prims.not uu___2 in
   if uu___1
   then
     FStarC_Errors.raise_error hasRange_env env1
  ...
  (let uu___1 = effect_repr_aux true env1 c u_c in
   match uu___1 with
   | FStar_Pervasives_Native.None ->
       FStarC_Effect.failwith "internal error: reifiable effect has no repr?"
...
let push_sigelt (env1 : env) (s : FStarC_Syntax_Syntax.sigelt) : env=
  push_sigelt' false env1 s
let push_sigelt_force (env1 : env) (s : FStarC_Syntax_Syntax.sigelt) : 
  env= push_sigelt' true env1 s
...
let update_effect_lattice (env1 : env) (src : FStarC_Ident.lident)
  ...
  let find_edge order uu___ =
    match uu___ with
    | (i, j) ->
        if FStarC_Ident.lid_equals i j
  ...
  let check_cycle src1 tgt1 =
    if FStarC_Ident.lid_equals src1 tgt1
    then
      let uu___ =
        let uu___1 =
        ...
        let uu___3 = FStarC_Class_Show.show FStarC_Ident.showable_lident src1 in
        FStarC_Format.fmt3 "Adding an edge %s~>%s induces a cycle %s" uu___1
          uu___2 uu___3 in
      FStarC_Errors.raise_error hasRange_env env1
      ...
      (fun edges i_src ->
         FStarC_List.fold_left
           (fun edges1 tgt_j ->
              ...
              (compose_edges (compose_edges i_src edge1) tgt_j)
              ::
              edges1) edges all_tgt_j) [] all_i_src in
  let new_edges = edge1 ::
  ...
  FStarC_List.iter
    (fun edge2 ->
       let uu___1 =
         if FStarC_Parser_Const.is_div_effect_lid edge2.msource
         then
       ...
       (fun s l joins1 ->
          ...
          then
            FStarC_Errors.raise_error hasRange_env env1
              ...
              (Obj.magic
                 (FStarC_Format.fmt1
                    "Effects %s have incomparable upper bounds" s))
...
let uvars_in_env (env1 : env) : FStarC_Syntax_Syntax.uvars=
  let no_uvs =
    FStarC_Class_Setlike.empty
      (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar) () in
  let rec aux out g =
    match g with
    | [] -> out
...
let univ_vars (env1 : env) :
  ...
  let no_univs =
    FStarC_Class_Setlike.empty
      (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_univ_uvar) () in
  let rec aux out g =
    match g with
    | [] -> out
    | (FStarC_Syntax_Syntax.Binding_univ uu___)::tl -> aux out tl
...
let lidents (env1 : env) : FStarC_Ident.lident Prims.list=
  ...
  FStarC_SMap.fold (sigtab env1)
    (fun uu___ v keys1 ->
       FStarC_List.op_At (FStarC_Syntax_Util.lids_of_sigelt v) keys1) keys
let should_enc_path
...
let unbound_vars (e : env) (t : FStarC_Syntax_Syntax.term) :
  ...
  FStarC_List.fold_left
    (fun s bv ->
       FStarC_Class_Setlike.remove
         (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv) bv s)
    uu___ uu___1
...
let apply_guard (g : guard_t) (e : FStarC_Syntax_Syntax.term) : guard_t=
  ...
  | FStarC_TypeChecker_Common.NonTrivial f ->
      let uu___ =
        let uu___1 =
          FStarC_Syntax_Syntax.mk_Tm_app f [FStarC_Syntax_Syntax.as_arg e]
            f.FStarC_Syntax_Syntax.pos in
...
let trivial (t : FStarC_TypeChecker_Common.guard_formula) : unit=
  match t with
  | FStarC_TypeChecker_Common.Trivial -> ()
  | FStarC_TypeChecker_Common.NonTrivial uu___ ->
      FStarC_Effect.failwith "impossible"
        ...
        let uu___2 =
          FStarC_List.fold_right
            (fun bv uu___3 ->
               ...
               | (f1, e) ->
                   let e' =
                     let uu___4 = FStarC_Option.must (pop_bv e) in
                   ...
                   (FStarC_Defensive.def_check_scoped hasBinders_env
                    ...
                    (let f' =
                       if FStarC_Syntax_Syntax.is_null_bv bv
                       then f1
                       else
                         (let u =
...
let pure_precondition_for_trivial_post (env1 : env)
  ...
  let trivial_post =
    ...
    match uu___ with
    | (uu___1, post) ->
        FStarC_Syntax_Syntax.mk_Tm_app post [FStarC_Syntax_Syntax.as_arg t] r in
  FStarC_Syntax_Syntax.mk_Tm_app wp
    [FStarC_Syntax_Syntax.as_arg trivial_post] r
let get_letrec_arity (env1 : env) (lbname : FStarC_Syntax_Syntax.lbname) :
  ...
  | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
let mentions_rec_name (env1 : env) (t : FStarC_Syntax_Syntax.term) :
  Prims.bool=
  match env1.rec_names with
  | [] -> false
  | rec_names ->
      let ns =
        FStarC_Class_Binders.freeNames FStarC_Class_Binders.hasNames_term t in
      FStarC_Util.for_some
        (fun x ->
           FStarC_Class_Setlike.mem
