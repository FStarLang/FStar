      ...
      unit ->
        unit ->
          ('m, Obj.t, Obj.t) writer ->
            (Obj.t -> ('m, Obj.t, Obj.t) writer) -> ('m, Obj.t, Obj.t) writer
  =
  fun uu___ ->
    fun a ->
      fun b ->
...
let emit :
  'm . 'm FStarC_Class_Monoid.monoid -> 'm -> ('m, Obj.t, unit) writer =
