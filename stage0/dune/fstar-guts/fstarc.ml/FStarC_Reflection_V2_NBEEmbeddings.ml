  ...
  fun aq ->
    ...
    let unembed_pattern cb =
      fun t ->
        ...
        | FStarC_TypeChecker_NBETerm.Construct (fv, [], (eopt, uu___)::[])
            when
            FStarC_Syntax_Syntax.fv_eq_lid fv
...
let (e_universe_view :
  ...
  let unembed_universe_view cb =
    fun t ->
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (us, uu___1)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (n, uu___1)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (i, uu___1)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
    ...
    fun t ->
      ...
      | FStarC_TypeChecker_NBETerm.Construct
          ...
          FStarC_Option.bind uu___2
            (fun i1 ->
               let uu___3 =
                 FStarC_TypeChecker_NBETerm.unembed e_universe cb u in
               FStarC_Option.bind uu___3
                 (fun u1 ->
                    FStar_Pervasives_Native.Some
            ...
            let uu___ =
              ...
              let uu___2 =
                ...
                let uu___4 =
                  let uu___5 =
                    let uu___6 =
                      FStarC_TypeChecker_NBETerm.embed e_binder cb b in
                    FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                  let uu___6 =
                    let uu___7 =
                      let uu___8 =
              ...
              let uu___2 =
                ...
                let uu___4 =
                  let uu___5 =
                    let uu___6 =
                      FStarC_TypeChecker_NBETerm.embed
                        (FStarC_TypeChecker_NBETerm.e_option (e_term_aq aq))
                        cb tacopt in
                    FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                  let uu___6 =
                    let uu___7 =
                      ...
                      FStarC_Option.bind uu___8
                        (fun b1 ->
                           ...
                           FStarC_Option.bind uu___9
                             (fun t11 ->
                                let uu___10 =
                                  FStarC_TypeChecker_NBETerm.unembed e_term
                                    cb t2 in
  ...
  let unembed_namedv_view cb =
    fun t ->
      ...
      | FStarC_TypeChecker_NBETerm.Construct
          ...
          let uu___4 =
            FStarC_TypeChecker_NBETerm.unembed
              FStarC_TypeChecker_NBETerm.e_int cb uniq in
          FStarC_Option.bind uu___4
            (fun uniq1 ->
               let uu___5 =
                 FStarC_TypeChecker_NBETerm.unembed e_ppname cb ppname in
  ...
  let embed_bv_view cb =
    fun bvv ->
      ...
      mkConstruct
        ...
        [] uu___ in
  let unembed_bv_view cb =
    fun t ->
      match t.FStarC_TypeChecker_NBETerm.nbe_t with
      | FStarC_TypeChecker_NBETerm.Construct
          (fv, uu___, (sort, uu___1)::(ppname, uu___2)::(idx, uu___3)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
          ...
          FStarC_Option.bind uu___5
            (fun sort1 ->
               ...
               FStarC_Option.bind uu___6
                 (fun q1 ->
                    let uu___7 =
                      FStarC_TypeChecker_NBETerm.unembed e_attributes cb
                        attrs in
                    FStarC_Option.bind uu___7
                      (fun attrs1 ->
                         let uu___8 =
    ...
    fun cv ->
          ...
          let uu___ =
            ...
            let uu___2 =
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    FStarC_TypeChecker_NBETerm.embed e_term cb pats in
                  FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                [uu___5] in
              uu___3 :: uu___4 in
            uu___1 :: uu___2 in
      ...
      | FStarC_Reflection_V2_Data.C_Eff (us, eff, res, args, decrs) ->
          ...
          mkConstruct
            ...
            [] uu___ in
  let unembed_comp_view cb =
    fun t ->
      match t.FStarC_TypeChecker_NBETerm.nbe_t with
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (t1, uu___1)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
                 ...
                 (fun eff1 ->
                    ...
                    FStarC_Option.bind uu___8
                      (fun res1 ->
                         let uu___9 =
                           FStarC_TypeChecker_NBETerm.unembed
                             (FStarC_TypeChecker_NBETerm.e_list e_argv) cb
                             args in
                         FStarC_Option.bind uu___9
                           (fun args1 ->
                              let uu___10 =
                                FStarC_TypeChecker_NBETerm.unembed
                                  (FStarC_TypeChecker_NBETerm.e_list e_term)
                                  cb decrs in
                              FStarC_Option.bind uu___10
                                (fun decrs1 ->
                                   FStar_Pervasives_Native.Some
    ...
    fun sev ->
      ...
      | FStarC_Reflection_V2_Data.Sg_Inductive (nm, univs, bs, t, dcs) ->
          let uu___ =
            let uu___1 =
              let uu___2 =
                FStarC_TypeChecker_NBETerm.embed e_string_list cb nm in
              FStarC_TypeChecker_NBETerm.as_arg uu___2 in
            let uu___2 =
              let uu___3 =
                let uu___4 =
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    FStarC_TypeChecker_NBETerm.embed e_binders cb bs in
                  FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                let uu___6 =
                  let uu___7 =
                      ...
                      (fun bs1 ->
                         ...
                         FStarC_Option.bind uu___9
                           (fun t2 ->
                              let uu___10 =
                                FStarC_TypeChecker_NBETerm.unembed
                                  (FStarC_TypeChecker_NBETerm.e_list e_ctor)
                                  cb dcs in
                              FStarC_Option.bind uu___10
                                (fun dcs1 ->
                                   FStar_Pervasives_Native.Some
...
let (e_qualifier :
  ...
  let unembed cb =
    fun t ->
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, [], (ids12, uu___)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
...
let (e_vconfig : FStarC_Order.order FStarC_TypeChecker_NBETerm.embedding) =
  let emb cb = fun o -> failwith "emb vconfig NBE" in
  let unemb cb = fun t -> failwith "unemb vconfig NBE" in
  let uu___ =
