  ...
  let unembed_bv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            ...
            FStarC_Util.format1 "Not an embedded bv: %s" uu___3 in
...
let (e_namedv :
  ...
  let unembed_namedv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded namedv: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_binder :
  ...
  let unembed_binder cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded binder: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_aqualv :
  ...
  let unembed_aqualv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded aqualv: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_fv : FStarC_Syntax_Syntax.fv FStarC_TypeChecker_NBETerm.embedding) =
  ...
  let unembed_fv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded fvar: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_comp : FStarC_Syntax_Syntax.comp FStarC_TypeChecker_NBETerm.embedding)
  ...
  let unembed_comp cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded comp: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_env : FStarC_TypeChecker_Env.env FStarC_TypeChecker_NBETerm.embedding)
  ...
  let unembed_env cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded env: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_vconst :
  ...
  let unembed_const cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded vconst: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_universe :
  ...
  let unembed_universe cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded universe: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
  ...
  fun aq ->
    ...
    let unembed_pattern cb t =
      ...
      | uu___ ->
          ((let uu___2 =
              let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
              FStarC_Util.format1 "Not an embedded pattern: %s" uu___3 in
            FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded
              () (Obj.magic FStarC_Errors_Msg.is_error_message_string)
              (Obj.magic uu___2));
           FStar_Pervasives_Native.None) in
...
let (e_ident : FStarC_Ident.ident FStarC_TypeChecker_NBETerm.embedding) =
  ...
  let unembed_ident cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded ident: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_universe_view :
  ...
  let unembed_universe_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded universe view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
  ...
  fun aq ->
    ...
    let unembed_term_view cb t =
      ...
      | uu___ ->
          ((let uu___2 =
              let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
              FStarC_Util.format1 "Not an embedded term_view: %s" uu___3 in
            FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded
              () (Obj.magic FStarC_Errors_Msg.is_error_message_string)
              (Obj.magic uu___2));
           FStar_Pervasives_Native.None) in
...
let (e_namedv_view :
  ...
  let unembed_namedv_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded namedv_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_bv_view :
  ...
  let unembed_bv_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded bv_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_binder_view :
  ...
  let unembed_binder_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded binder_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_comp_view :
  ...
  let unembed_comp_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded comp_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_sigelt :
  ...
  let unembed_sigelt cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded sigelt: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_lb_view :
  ...
  let unembed_lb_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded lb_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_lid : FStarC_Ident.lid FStarC_TypeChecker_NBETerm.embedding) =
  ...
  let unembed cb t =
    ...
    FStarC_Util.map_opt uu___
      (fun p -> FStarC_Ident.lid_of_path p FStarC_Range_Type.dummyRange) in
...
let (e_letbinding :
  ...
  let unembed_letbinding cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded letbinding: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_sigelt_view :
  ...
  let unembed_sigelt_view cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded sigelt_view: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
...
let (e_qualifier :
  ...
  let unembed cb t =
    ...
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
            FStarC_Util.format1 "Not an embedded qualifier: %s" uu___3 in
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            (Obj.magic FStarC_Errors_Msg.is_error_message_string)
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
