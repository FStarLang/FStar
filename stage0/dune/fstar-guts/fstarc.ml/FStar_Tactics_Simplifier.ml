open Prims
let tiff (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStar_Tactics_V2_Derived.apply_lemma
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_FVar
          (FStarC_Reflection_V2_Builtins.pack_fv
             ["FStar"; "Tactics"; "Simplifier"; "lem_iff_refl"])))
let step (uu___ : unit) : FStarC_Tactics_Types.ref_proofstate -> unit=
  FStar_Tactics_V2_Derived.apply_lemma
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_FVar
          (FStarC_Reflection_V2_Builtins.pack_fv
      ...
      (match x1 with
       | FStar_Tactics_NamedView.Tv_App (l, r) ->
           ...
           (match x2 with
            ...
            | uu___1 -> false)
       | uu___1 -> false)
let inhabit (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  ...
  (let x2 = FStar_Tactics_V2_Derived.cur_goal () ps in
            ...
            then
              FStar_Tactics_V2_Derived.apply_lemma
                (FStarC_Reflection_V2_Builtins.pack_ln
                   (FStarC_Reflection_V2_Data.Tv_FVar
                      (FStarC_Reflection_V2_Builtins.pack_fv
                         ["FStar"; "Tactics"; "Simplifier"; "lem_true_and_p"])))
                ps
            else
            ...
            then
              FStar_Tactics_V2_Derived.apply_lemma
                (FStarC_Reflection_V2_Builtins.pack_ln
                   (FStarC_Reflection_V2_Data.Tv_FVar
                      (FStarC_Reflection_V2_Builtins.pack_fv
                         ["FStar"; "Tactics"; "Simplifier"; "lem_true_or_p"])))
                ps
            else
              (let x6 = is_true q ps in
               if x6
            ...
            then
              FStar_Tactics_V2_Derived.apply_lemma
                (FStarC_Reflection_V2_Builtins.pack_ln
                   (FStarC_Reflection_V2_Data.Tv_FVar
                      (FStarC_Reflection_V2_Builtins.pack_fv
                         ["FStar"; "Tactics"; "Simplifier"; "lem_true_imp_p"])))
                ps
            else
              (let x6 = is_true q ps in
               if x6
   ...
   | uu___1 ->
       FStar_Tactics_V2_Derived.fail
         "simplify_point: failed precondition: goal should be `g <==> ?u`" ps)
and recurse (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) : 
  unit=
  step () ps;
  FStarC_Tactics_V2_Builtins.norm [] ps;
  (let x2 = FStar_Tactics_V2_Derived.cur_goal () ps in
        ...
        | FStar_Reflection_V2_Formula.Not uu___1 ->
            (FStar_Tactics_V2_Derived.apply_lemma
               (FStarC_Reflection_V2_Builtins.pack_ln
                  (FStarC_Reflection_V2_Data.Tv_FVar
                     (FStarC_Reflection_V2_Builtins.pack_fv
                        ["FStar"; "Tactics"; "Simplifier"; "neg_cong"]))) ps;
             simplify_point () ps)
...
let simplify (uu___ : unit) (ps : FStarC_Tactics_Types.ref_proofstate) :
  unit=
  FStar_Tactics_V2_Derived.apply_lemma
    (FStarC_Reflection_V2_Builtins.pack_ln
       (FStarC_Reflection_V2_Data.Tv_FVar
