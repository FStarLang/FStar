...
type match_result =
  ...
  | FullMatch 
let uu___is_MisMatch (projectee : match_result) : Prims.bool=
  match projectee with | MisMatch _0 -> true | uu___ -> false
let __proj__MisMatch__item___0 (projectee : match_result) :
  (FStarC_Syntax_Syntax.delta_depth FStar_Pervasives_Native.option *
    FStarC_Syntax_Syntax.delta_depth FStar_Pervasives_Native.option)=
  match projectee with | MisMatch _0 -> _0
let uu___is_HeadMatch (projectee : match_result) : Prims.bool=
  match projectee with | HeadMatch _0 -> true | uu___ -> false
let __proj__HeadMatch__item___0 (projectee : match_result) : Prims.bool=
  match projectee with | HeadMatch _0 -> _0
let uu___is_FullMatch (projectee : match_result) : Prims.bool=
  match projectee with | FullMatch -> true | uu___ -> false
...
let dbg_ExplainRel : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "ExplainRel"
let dbg_GenUniverses : Prims.bool FStarC_Effect.ref=
...
let dbg_Imps : Prims.bool FStarC_Effect.ref= FStarC_Debug.get_toggle "Imps"
...
let dbg_RelBench : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "RelBench"
let dbg_RelDelta : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "RelDelta"
let dbg_RelTop : Prims.bool FStarC_Effect.ref=
  FStarC_Debug.get_toggle "RelTop"
let unsolvable_spec_uvars : Prims.int Prims.list FStarC_Effect.ref=
...
let is_base_type (env : FStarC_TypeChecker_Env.env)
  (typ : FStarC_Syntax_Syntax.typ) : Prims.bool=
  ...
  | (head, args) ->
      ...
      (match uu___1 with
       ...
       | uu___2 -> false)
let term_is_uvar (uv : FStarC_Syntax_Syntax.ctx_uvar)
  ...
  | uu___1 -> false
let binders_as_bv_set (bs : FStarC_Syntax_Syntax.binders) :
  FStarC_Syntax_Syntax.bv FStarC_FlatSet.t=
  let uu___ = FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) bs in
  FStarC_Class_Setlike.from_list
    (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv) uu___
type lstring = Prims.string FStarC_Thunk.t
let mklstr (f : unit -> Prims.string) : Prims.string FStarC_Thunk.thunk=
...
let uu___is_TERM (projectee : uvi) : Prims.bool=
  match projectee with | TERM _0 -> true | uu___ -> false
let __proj__TERM__item___0 (projectee : uvi) :
  (FStarC_Syntax_Syntax.ctx_uvar * FStarC_Syntax_Syntax.term)=
  match projectee with | TERM _0 -> _0
let uu___is_UNIV (projectee : uvi) : Prims.bool=
  match projectee with | UNIV _0 -> true | uu___ -> false
let __proj__UNIV__item___0 (projectee : uvi) :
  (FStarC_Syntax_Syntax.universe_uvar * FStarC_Syntax_Syntax.universe)=
  match projectee with | UNIV _0 -> _0
type defer_ok_t =
  | NoDefer 
  | DeferAny 
  | DeferFlexFlexOnly 
let uu___is_NoDefer (projectee : defer_ok_t) : Prims.bool=
  match projectee with | NoDefer -> true | uu___ -> false
let uu___is_DeferAny (projectee : defer_ok_t) : Prims.bool=
  match projectee with | DeferAny -> true | uu___ -> false
let uu___is_DeferFlexFlexOnly (projectee : defer_ok_t) : Prims.bool=
...
type worklist =
  ...
  wl_deferred:
    (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
      FStarC_TypeChecker_Common.prob) FStarC_CList.clist
    ;
  wl_deferred_to_tac:
    (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
      FStarC_TypeChecker_Common.prob) FStarC_CList.clist
  ...
  eq_norm_heuristic_ok: Prims.bool ;
  tcenv: FStarC_TypeChecker_Env.env ;
  wl_implicits: FStarC_TypeChecker_Common.implicits_t ;
  repr_subcomp_allowed: Prims.bool ;
  typeclass_variables: FStarC_Syntax_Syntax.ctx_uvar FStarC_RBSet.t }
let __proj__Mkworklist__item__attempting (projectee : worklist) :
  FStarC_TypeChecker_Common.probs=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> attempting
let __proj__Mkworklist__item__wl_deferred (projectee : worklist) :
  (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
    FStarC_TypeChecker_Common.prob) FStarC_CList.clist=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> wl_deferred
let __proj__Mkworklist__item__wl_deferred_to_tac (projectee : worklist) :
  (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
    FStarC_TypeChecker_Common.prob) FStarC_CList.clist=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> wl_deferred_to_tac
let __proj__Mkworklist__item__ctr (projectee : worklist) : Prims.int=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> ctr
let __proj__Mkworklist__item__defer_ok (projectee : worklist) : defer_ok_t=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> defer_ok
let __proj__Mkworklist__item__smt_ok (projectee : worklist) : Prims.bool=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> smt_ok
let __proj__Mkworklist__item__umax_heuristic_ok (projectee : worklist) :
  Prims.bool=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> umax_heuristic_ok
let __proj__Mkworklist__item__eq_norm_heuristic_ok (projectee : worklist) :
  Prims.bool=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> eq_norm_heuristic_ok
let __proj__Mkworklist__item__tcenv (projectee : worklist) :
  FStarC_TypeChecker_Env.env=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> tcenv
let __proj__Mkworklist__item__wl_implicits (projectee : worklist) :
  FStarC_TypeChecker_Common.implicits_t=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> wl_implicits
let __proj__Mkworklist__item__repr_subcomp_allowed (projectee : worklist) :
  Prims.bool=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> repr_subcomp_allowed
let __proj__Mkworklist__item__typeclass_variables (projectee : worklist) :
  FStarC_Syntax_Syntax.ctx_uvar FStarC_RBSet.t=
  match projectee with
  | { attempting; wl_deferred; wl_deferred_to_tac; ctr; defer_ok; smt_ok;
      umax_heuristic_ok; eq_norm_heuristic_ok; tcenv; wl_implicits;
      repr_subcomp_allowed; typeclass_variables;_} -> typeclass_variables
let as_deferred
  (wl_def :
    (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
      FStarC_TypeChecker_Common.prob) FStarC_CList.clist)
...
let as_wl_deferred (wl : worklist) (d : FStarC_TypeChecker_Common.deferred) :
  (Prims.int * FStarC_TypeChecker_Common.deferred_reason * lstring *
    FStarC_TypeChecker_Common.prob) FStarC_CList.clist=
  FStarC_CList.map
    (fun uu___ ->
       match uu___ with
       | (reason, m, p) ->
           let uu___1 = FStarC_Thunk.mkv m in ((wl.ctr), reason, uu___1, p))
    d
let new_uvar (reason : Prims.string) (wl : worklist)
  (r : FStarC_Range_Type.range)
  (gamma : FStarC_Syntax_Syntax.binding Prims.list)
  (binders : FStarC_Syntax_Syntax.binder Prims.list)
  (k : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (should_check : FStarC_Syntax_Syntax.should_check_uvar)
  (meta :
    FStarC_Syntax_Syntax.ctx_uvar_meta_t FStar_Pervasives_Native.option)
  : (FStarC_Syntax_Syntax.ctx_uvar * FStarC_Syntax_Syntax.term * worklist)=
  let decoration =
    {
      ...
      FStarC_Syntax_Syntax.uvar_decoration_should_unrefine = false
    } in
  let ctx_uvar =
   ...
   (ctx_uvar, t,
     {
       ...
       tcenv = (wl.tcenv);
       wl_implicits =
         (FStarC_Class_Listlike.cons (FStarC_CList.listlike_clist ()) imp
            wl.wl_implicits);
       repr_subcomp_allowed = (wl.repr_subcomp_allowed);
       typeclass_variables = (wl.typeclass_variables)
     }))
let copy_uvar (u : FStarC_Syntax_Syntax.ctx_uvar)
  (bs : FStarC_Syntax_Syntax.binders)
  ...
  let env =
    let uu___ = wl.tcenv in
    {
      ...
      FStarC_TypeChecker_Env.gamma = (u.FStarC_Syntax_Syntax.ctx_uvar_gamma);
      ...
      FStarC_TypeChecker_Env.modules = (uu___.FStarC_TypeChecker_Env.modules);
      ...
      FStarC_TypeChecker_Env.attrtab = (uu___.FStarC_TypeChecker_Env.attrtab);
      FStarC_TypeChecker_Env.instantiate_imp =
        (uu___.FStarC_TypeChecker_Env.instantiate_imp);
      FStarC_TypeChecker_Env.effects = (uu___.FStarC_TypeChecker_Env.effects);
      FStarC_TypeChecker_Env.generalize =
        (uu___.FStarC_TypeChecker_Env.generalize);
      FStarC_TypeChecker_Env.letrecs = (uu___.FStarC_TypeChecker_Env.letrecs);
      ...
      FStarC_TypeChecker_Env.tc_term = (uu___.FStarC_TypeChecker_Env.tc_term);
  ...
  new_uvar (Prims.strcat "copy:" u.FStarC_Syntax_Syntax.ctx_uvar_reason) wl
    u.FStarC_Syntax_Syntax.ctx_uvar_range env1.FStarC_TypeChecker_Env.gamma
    uu___ t uu___1 u.FStarC_Syntax_Syntax.ctx_uvar_meta
type solution =
...
let uu___is_Success (projectee : solution) : Prims.bool=
  match projectee with | Success _0 -> true | uu___ -> false
let __proj__Success__item___0 (projectee : solution) :
  (FStarC_TypeChecker_Common.deferred * FStarC_TypeChecker_Common.deferred *
    FStarC_TypeChecker_Common.implicits_t)=
  match projectee with | Success _0 -> _0
let uu___is_Failed (projectee : solution) : Prims.bool=
  match projectee with | Failed _0 -> true | uu___ -> false
let __proj__Failed__item___0 (projectee : solution) :
  (FStarC_TypeChecker_Common.prob * lstring)=
  match projectee with | Failed _0 -> _0
let extend_wl (wl : worklist) (defers : FStarC_TypeChecker_Common.deferred)
  (defer_to_tac : FStarC_TypeChecker_Common.deferred)
  (imps : FStarC_TypeChecker_Common.implicits_t) : worklist=
  let uu___ =
    let uu___1 = as_wl_deferred wl defers in
    FStarC_Class_Monoid.op_Plus_Plus (FStarC_CList.monoid_clist ())
      wl.wl_deferred uu___1 in
  let uu___1 =
    let uu___2 = as_wl_deferred wl defer_to_tac in
    FStarC_Class_Monoid.op_Plus_Plus (FStarC_CList.monoid_clist ())
      wl.wl_deferred_to_tac uu___2 in
  let uu___2 =
    FStarC_Class_Monoid.op_Plus_Plus (FStarC_CList.monoid_clist ())
      wl.wl_implicits imps in
  {
    attempting = (wl.attempting);
    wl_deferred = uu___;
...
type variance =
  ...
  | CONTRAVARIANT 
  | INVARIANT 
let uu___is_COVARIANT (projectee : variance) : Prims.bool=
  match projectee with | COVARIANT -> true | uu___ -> false
let uu___is_CONTRAVARIANT (projectee : variance) : Prims.bool=
  match projectee with | CONTRAVARIANT -> true | uu___ -> false
let uu___is_INVARIANT (projectee : variance) : Prims.bool=
  match projectee with | INVARIANT -> true | uu___ -> false
...
let invert_rel (uu___ : FStarC_TypeChecker_Common.rel) :
...
let invert (p : 'uuuuu FStarC_TypeChecker_Common.problem) :
  'uuuuu FStarC_TypeChecker_Common.problem=
  {
    ...
    FStarC_TypeChecker_Common.element = (p.FStarC_TypeChecker_Common.element);
    ...
    FStarC_TypeChecker_Common.logical = (p.FStarC_TypeChecker_Common.logical)
  }
let maybe_invert (p : 'uuuuu FStarC_TypeChecker_Common.problem) :
  'uuuuu FStarC_TypeChecker_Common.problem=
  if p.FStarC_TypeChecker_Common.relation = FStarC_TypeChecker_Common.SUBINV
  then invert p
  else p
let maybe_invert_p (uu___ : FStarC_TypeChecker_Common.prob) :
...
let make_prob_eq (uu___ : FStarC_TypeChecker_Common.prob) :
  FStarC_TypeChecker_Common.prob=
  match uu___ with
  | FStarC_TypeChecker_Common.TProb p ->
...
let p_pid (uu___ : FStarC_TypeChecker_Common.prob) : Prims.int=
  match uu___ with
...
let p_rel (uu___ : FStarC_TypeChecker_Common.prob) :
  FStarC_TypeChecker_Common.rel=
  match uu___ with
...
let p_reason (uu___ : FStarC_TypeChecker_Common.prob) :
...
let p_loc (uu___ : FStarC_TypeChecker_Common.prob) : FStarC_Range_Type.range=
  match uu___ with
...
let p_element (uu___ : FStarC_TypeChecker_Common.prob) :
...
let p_guard (uu___ : FStarC_TypeChecker_Common.prob) :
  ...
  | FStarC_TypeChecker_Common.CProb p ->
      p.FStarC_TypeChecker_Common.logical_guard
let p_scope (prob : FStarC_TypeChecker_Common.prob) :
  ...
  r
let p_guard_uvar (uu___ : FStarC_TypeChecker_Common.prob) :
  ...
  | FStarC_TypeChecker_Common.CProb p ->
      p.FStarC_TypeChecker_Common.logical_guard_uvar
let p_env (wl : worklist) (prob : FStarC_TypeChecker_Common.prob) :
  FStarC_TypeChecker_Env.env=
  let uu___ = wl.tcenv in
  {
    FStarC_TypeChecker_Env.solver = (uu___.FStarC_TypeChecker_Env.solver);
    ...
    FStarC_TypeChecker_Env.use_eq_strict =
      (uu___.FStarC_TypeChecker_Env.use_eq_strict);
    FStarC_TypeChecker_Env.is_iface = (uu___.FStarC_TypeChecker_Env.is_iface);
    FStarC_TypeChecker_Env.admit = (uu___.FStarC_TypeChecker_Env.admit);
    FStarC_TypeChecker_Env.phase1 = (uu___.FStarC_TypeChecker_Env.phase1);
    FStarC_TypeChecker_Env.failhard = (uu___.FStarC_TypeChecker_Env.failhard);
    FStarC_TypeChecker_Env.flychecking =
      (uu___.FStarC_TypeChecker_Env.flychecking);
    FStarC_TypeChecker_Env.uvar_subtyping =
      (uu___.FStarC_TypeChecker_Env.uvar_subtyping);
    FStarC_TypeChecker_Env.intactics =
      (uu___.FStarC_TypeChecker_Env.intactics);
    FStarC_TypeChecker_Env.nocoerce = (uu___.FStarC_TypeChecker_Env.nocoerce);
    FStarC_TypeChecker_Env.tc_term = (uu___.FStarC_TypeChecker_Env.tc_term);
    FStarC_TypeChecker_Env.typeof_tot_or_gtot_term =
      (uu___.FStarC_TypeChecker_Env.typeof_tot_or_gtot_term);
    FStarC_TypeChecker_Env.universe_of =
    ...
    FStarC_TypeChecker_Env.fv_delta_depths =
      (uu___.FStarC_TypeChecker_Env.fv_delta_depths);
    FStarC_TypeChecker_Env.proof_ns = (uu___.FStarC_TypeChecker_Env.proof_ns);
    FStarC_TypeChecker_Env.synth_hook =
      (uu___.FStarC_TypeChecker_Env.synth_hook);
    FStarC_TypeChecker_Env.try_solve_implicits_hook =
      (uu___.FStarC_TypeChecker_Env.try_solve_implicits_hook);
    ...
    FStarC_TypeChecker_Env.identifier_info =
      (uu___.FStarC_TypeChecker_Env.identifier_info);
    FStarC_TypeChecker_Env.tc_hooks = (uu___.FStarC_TypeChecker_Env.tc_hooks);
    FStarC_TypeChecker_Env.dsenv = (uu___.FStarC_TypeChecker_Env.dsenv);
    FStarC_TypeChecker_Env.nbe = (uu___.FStarC_TypeChecker_Env.nbe);
    FStarC_TypeChecker_Env.strict_args_tab =
      (uu___.FStarC_TypeChecker_Env.strict_args_tab);
...
let def_scope_wf (msg : Prims.string) (rng : FStarC_Range_Type.range)
  (r : FStarC_Syntax_Syntax.binder Prims.list) : unit=
  let uu___ = let uu___1 = FStarC_Options.defensive () in Prims.not uu___1 in
  if uu___
  then ()
  else
    (let rec aux prev next =
       ...
       | { FStarC_Syntax_Syntax.binder_bv = bv;
           ...
           FStarC_Syntax_Syntax.binder_attrs = uu___3;_}::bs ->
           (FStarC_Defensive.def_check_scoped
            ...
            aux (FStarC_List.op_At prev [bv]) bs) in
     aux [] r)
let hasBinders_prob :
    ...
    FStarC_Class_Binders.boundNames =
      (fun prob ->
         let uu___ =
           ...
           FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) uu___1 in
         FStarC_Class_Setlike.from_list
           (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv)
           uu___)
  }
let def_check_term_scoped_in_prob (msg : Prims.string)
  (prob : FStarC_TypeChecker_Common.prob) (phi : FStarC_Syntax_Syntax.term) :
  unit=
...
let def_check_comp_scoped_in_prob (msg : Prims.string)
  (prob : FStarC_TypeChecker_Common.prob) (phi : FStarC_Syntax_Syntax.comp) :
  unit=
  FStarC_Defensive.def_check_scoped hasBinders_prob
    FStarC_Class_Binders.hasNames_comp FStarC_Syntax_Print.pretty_comp
    (p_loc prob) msg prob phi
let def_check_prob (msg : Prims.string)
  (prob : FStarC_TypeChecker_Common.prob) : unit=
  let uu___ = let uu___1 = FStarC_Options.defensive () in Prims.not uu___1 in
  if uu___
  then ()
  else
         ...
         let uu___2 =
           let uu___3 =
             FStarC_Class_Show.show FStarC_Class_Show.showable_int
               (p_pid prob) in
           Prims.strcat uu___3 (Prims.strcat "." m) in
         Prims.strcat "." uu___2 in
       Prims.strcat msg uu___1 in
     (let uu___2 = msgf "scope" in
      let uu___3 = p_scope prob in def_scope_wf uu___2 (p_loc prob) uu___3);
     (let uu___3 = msgf "guard" in
      def_check_term_scoped_in_prob uu___3 prob (p_guard prob));
     (match prob with
      | FStarC_TypeChecker_Common.TProb p ->
          ((let uu___4 = msgf "lhs" in
            def_check_term_scoped_in_prob uu___4 prob
              p.FStarC_TypeChecker_Common.lhs);
           (let uu___4 = msgf "rhs" in
            def_check_term_scoped_in_prob uu___4 prob
              p.FStarC_TypeChecker_Common.rhs))
      | FStarC_TypeChecker_Common.CProb p ->
          ((let uu___4 = msgf "lhs" in
            def_check_comp_scoped_in_prob uu___4 prob
              p.FStarC_TypeChecker_Common.lhs);
           (let uu___4 = msgf "rhs" in
            def_check_comp_scoped_in_prob uu___4 prob
              p.FStarC_TypeChecker_Common.rhs))))
let rel_to_string (uu___ : FStarC_TypeChecker_Common.rel) : Prims.string=
  match uu___ with
  | FStarC_TypeChecker_Common.EQ -> "="
  | FStarC_TypeChecker_Common.SUB -> "<:"
  | FStarC_TypeChecker_Common.SUBINV -> ":>"
let term_to_string (t : FStarC_Syntax_Syntax.term) : Prims.string=
  let uu___ = FStarC_Syntax_Util.head_and_args_full t in
  match uu___ with
  | (head, args) ->
      (match head.FStarC_Syntax_Syntax.n with
       ...
       | uu___1 -> FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t)
let prob_to_string (env : FStarC_TypeChecker_Env.env)
  (prob : FStarC_TypeChecker_Common.prob) : Prims.string=
  match prob with
  | FStarC_TypeChecker_Common.TProb p ->
      let uu___ =
        let uu___1 =
        ...
        let uu___2 =
          ...
          let uu___4 =
            let uu___5 =
              ...
              uu___6 :: uu___7 in
            (rel_to_string p.FStarC_TypeChecker_Common.relation) :: uu___5 in
          uu___3 :: uu___4 in
        uu___1 :: uu___2 in
      FStarC_Format.fmt
        "\n%s:\t%s \n\t\t%s\n\t%s\n\t(reason:%s) (logical:%s)\n" uu___
  | FStarC_TypeChecker_Common.CProb p ->
      ...
      FStarC_Format.fmt4 "\n%s:\t%s \n\t\t%s\n\t%s" uu___ uu___1
        (rel_to_string p.FStarC_TypeChecker_Common.relation) uu___2
let prob_to_string' (wl : worklist) (prob : FStarC_TypeChecker_Common.prob) :
  Prims.string= let env = p_env wl prob in prob_to_string env prob
let uvi_to_string (env : FStarC_TypeChecker_Env.env) (uu___ : uvi) :
  Prims.string=
  match uu___ with
  | UNIV (u, t) ->
      let x =
        ...
        then "?"
          ...
          (let uu___2 = FStarC_Syntax_Unionfind.univ_uvar_id u in
           FStarC_Class_Show.show FStarC_Class_Show.showable_int uu___2) in
      let uu___1 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ t in
      FStarC_Format.fmt2 "UNIV %s <- %s" x uu___1
  | TERM (u, t) ->
      let x =
        let uu___1 = FStarC_Options.hide_uvar_nums () in
        if uu___1
      ...
      FStarC_Format.fmt2 "TERM %s <- %s" x uu___1
let uvis_to_string (env : FStarC_TypeChecker_Env.env) (uvis : uvi Prims.list)
  : Prims.string= FStarC_Common.string_of_list (uvi_to_string env) uvis
let empty_worklist (env : FStarC_TypeChecker_Env.env) : worklist=
  let uu___ =
    FStarC_Class_Setlike.empty
      (FStarC_RBSet.setlike_rbset FStarC_Syntax_Free.ord_ctx_uvar) () in
  {
    attempting = [];
    wl_deferred =
...
let giveup (wl : worklist) (reason : lstring)
  (prob : FStarC_TypeChecker_Common.prob) : solution=
  ...
  Failed (prob, reason)
let giveup_lit (wl : worklist) (reason : Prims.string)
  (prob : FStarC_TypeChecker_Common.prob) : solution=
  let uu___ = mklstr (fun uu___1 -> reason) in giveup wl uu___ prob
let singleton (wl : worklist) (prob : FStarC_TypeChecker_Common.prob)
  (smt_ok : Prims.bool) : worklist=
  {
    attempting = [prob];
    wl_deferred = (wl.wl_deferred);
    wl_deferred_to_tac = (wl.wl_deferred_to_tac);
...
let wl_of_guard (env : FStarC_TypeChecker_Env.env)
  (g : ('uuuuu * 'uuuuu1 * FStarC_TypeChecker_Common.prob) Prims.list) :
  worklist=
      ...
      (fun uu___2 -> match uu___2 with | (uu___3, uu___4, p) -> p) g in
  {
    ...
    eq_norm_heuristic_ok = (uu___.eq_norm_heuristic_ok);
    tcenv = (uu___.tcenv);
...
let defer (reason : FStarC_TypeChecker_Common.deferred_reason)
  (msg : lstring) (prob : FStarC_TypeChecker_Common.prob) (wl : worklist) :
  worklist=
  {
    attempting = (wl.attempting);
    wl_deferred =
      (FStarC_Class_Listlike.cons (FStarC_CList.listlike_clist ())
         ((wl.ctr), reason, msg, prob) wl.wl_deferred);
    wl_deferred_to_tac = (wl.wl_deferred_to_tac);
    ctr = (wl.ctr);
    defer_ok = (wl.defer_ok);
    smt_ok = (wl.smt_ok);
...
let defer_lit (reason : FStarC_TypeChecker_Common.deferred_reason)
  (msg : Prims.string) (prob : FStarC_TypeChecker_Common.prob)
  (wl : worklist) : worklist=
  let uu___ = FStarC_Thunk.mkv msg in defer reason uu___ prob wl
let attempt (probs : FStarC_TypeChecker_Common.prob Prims.list)
  (wl : worklist) : worklist=
...
let mk_eq2 (wl : worklist) (prob : FStarC_TypeChecker_Common.prob)
  (t1 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (t2 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax) :
  ...
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t1.FStarC_Syntax_Syntax.pos "mk_eq2.t1" env t1;
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t2.FStarC_Syntax_Syntax.pos "mk_eq2.t2" env t2;
  (let uu___2 =
     env.FStarC_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term env t1
       false in
   match uu___2 with
   | (tt, uu___3) ->
       let u = env.FStarC_TypeChecker_Env.universe_of env tt in
       let uu___4 = FStarC_Syntax_Util.mk_eq2 u tt t1 t2 in (uu___4, wl))
let p_logical (uu___ : FStarC_TypeChecker_Common.prob) : Prims.bool=
  match uu___ with
...
let set_logical (b : Prims.bool) (uu___ : FStarC_TypeChecker_Common.prob) :
  FStarC_TypeChecker_Common.prob=
  match uu___ with
  | FStarC_TypeChecker_Common.TProb p ->
      FStarC_TypeChecker_Common.TProb
...
let incr (r : Prims.int FStarC_Effect.ref) : unit=
  let uu___ = let uu___1 = FStarC_Effect.op_Bang r in uu___1 + Prims.int_one in
  FStarC_Effect.op_Colon_Equals r uu___
let next_pid : unit -> Prims.int=
  let ctr = FStarC_Effect.mk_ref Prims.int_zero in
  fun uu___ -> incr ctr; FStarC_Effect.op_Bang ctr
let mk_problem (wl : worklist)
  (scope : FStarC_Syntax_Syntax.binder Prims.list)
  (orig : FStarC_TypeChecker_Common.prob) (lhs : 'uuuuu)
  (rel : FStarC_TypeChecker_Common.rel) (rhs : 'uuuuu)
  (elt : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (reason : Prims.string) :
  ...
  let scope1 =
    ...
    | FStar_Pervasives_Native.Some x ->
        FStarC_List.op_At scope [FStarC_Syntax_Syntax.mk_binder x] in
  let bs =
    FStarC_List.op_At
      (p_guard_uvar orig).FStarC_Syntax_Syntax.ctx_uvar_binders scope1 in
  let gamma =
    let uu___ =
      let uu___1 =
        FStarC_List.map
  ...
  let uu___ =
    new_uvar (Prims.strcat "mk_problem: logical guard for " reason) wl
      FStarC_Range_Type.dummyRange gamma bs FStarC_Syntax_Util.ktype0
  ...
  | (ctx_uvar, lg, wl1) ->
      let prob =
        let uu___1 = next_pid () in
        {
          ...
          FStarC_TypeChecker_Common.logical_guard_uvar = ctx_uvar;
          FStarC_TypeChecker_Common.reason = (reason :: (p_reason orig));
          FStarC_TypeChecker_Common.loc = (p_loc orig);
          FStarC_TypeChecker_Common.rank = FStar_Pervasives_Native.None;
          FStarC_TypeChecker_Common.logical = (p_logical orig)
        } in
      (prob, wl1)
let mk_t_problem (wl : worklist)
  (scope : FStarC_Syntax_Syntax.binder Prims.list)
  (orig : FStarC_TypeChecker_Common.prob) (lhs : FStarC_Syntax_Syntax.typ)
  (rel : FStarC_TypeChecker_Common.rel) (rhs : FStarC_Syntax_Syntax.typ)
  (elt : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (reason : Prims.string) : (FStarC_TypeChecker_Common.prob * worklist)=
  def_check_prob (Prims.strcat reason ".mk_t.arg") orig;
  (let uu___1 = mk_problem wl scope orig lhs rel rhs elt reason in
   match uu___1 with
   | (p, wl1) ->
       (def_check_prob (Prims.strcat reason ".mk_t")
          (FStarC_TypeChecker_Common.TProb p);
        ((FStarC_TypeChecker_Common.TProb p), wl1)))
let mk_c_problem (wl : worklist)
  (scope : FStarC_Syntax_Syntax.binder Prims.list)
  (orig : FStarC_TypeChecker_Common.prob) (lhs : FStarC_Syntax_Syntax.comp)
  (rel : FStarC_TypeChecker_Common.rel) (rhs : FStarC_Syntax_Syntax.comp)
  (elt : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (reason : Prims.string) : (FStarC_TypeChecker_Common.prob * worklist)=
...
let new_problem (wl : worklist) (env : FStarC_TypeChecker_Env.env)
  (lhs : 'uuuuu) (rel : FStarC_TypeChecker_Common.rel) (rhs : 'uuuuu)
  (subject : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (loc : FStarC_Range_Type.range) (reason : Prims.string) :
  ('uuuuu FStarC_TypeChecker_Common.problem * worklist)=
  let lg_ty =
    match subject with
    | FStar_Pervasives_Native.None -> FStarC_Syntax_Util.ktype0
    | FStar_Pervasives_Native.Some x ->
        let bs = [FStarC_Syntax_Syntax.mk_binder x] in
        let uu___ = FStarC_Syntax_Syntax.mk_Total FStarC_Syntax_Util.ktype0 in
        FStarC_Syntax_Util.arrow bs uu___ in
  let uu___ =
    let uu___1 = FStarC_TypeChecker_Env.all_binders env in
    new_uvar (Prims.strcat "new_problem: logical guard for " reason)
      {
        attempting = (wl.attempting);
        wl_deferred = (wl.wl_deferred);
        wl_deferred_to_tac = (wl.wl_deferred_to_tac);
  ...
  | (ctx_uvar, lg, wl1) ->
      ...
      (prob, wl1)
let problem_using_guard (orig : FStarC_TypeChecker_Common.prob)
  (lhs : FStarC_Syntax_Syntax.typ) (rel : FStarC_TypeChecker_Common.rel)
  (rhs : FStarC_Syntax_Syntax.typ)
  (elt : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (reason : Prims.string) :
  ...
  let p =
    let uu___ = next_pid () in
    {
      ...
      FStarC_TypeChecker_Common.logical_guard_uvar = (p_guard_uvar orig);
      FStarC_TypeChecker_Common.reason = (reason :: (p_reason orig));
      FStarC_TypeChecker_Common.loc = (p_loc orig);
      FStarC_TypeChecker_Common.rank = FStar_Pervasives_Native.None;
      FStarC_TypeChecker_Common.logical = (p_logical orig)
...
let guard_on_element (wl : worklist)
  (problem : FStarC_Syntax_Syntax.typ FStarC_TypeChecker_Common.problem)
  ...
  | FStar_Pervasives_Native.Some e ->
      let uu___ =
        let uu___1 =
          let uu___2 =
            let uu___3 = FStarC_Syntax_Syntax.bv_to_name e in (x, uu___3) in
          FStarC_Syntax_Syntax.NT uu___2 in
        [uu___1] in
      FStarC_Syntax_Subst.subst uu___ phi
let explain (wl : worklist) (d : FStarC_TypeChecker_Common.prob)
  (s : lstring) : Prims.string=
  let uu___ =
    let uu___1 = FStarC_Effect.op_Bang dbg_ExplainRel in
    if uu___1 then true else FStarC_Effect.op_Bang dbg_Rel in
  if uu___
  then
    let uu___1 = FStarC_Range_Ops.string_of_range (p_loc d) in
    ...
    (let d1 = maybe_invert_p d in
     ...
     let uu___1 =
       ...
       | FStarC_TypeChecker_Common.TProb tp ->
           let uu___2 =
             let uu___3 = p_env wl d1 in
             FStarC_TypeChecker_Normalize.term_to_string uu___3 in
           FStarC_TypeChecker_Err.print_discrepancy uu___2
             tp.FStarC_TypeChecker_Common.lhs
             tp.FStarC_TypeChecker_Common.rhs
       | FStarC_TypeChecker_Common.CProb cp ->
           let uu___2 =
             let uu___3 = p_env wl d1 in
             FStarC_TypeChecker_Normalize.comp_to_string uu___3 in
           FStarC_TypeChecker_Err.print_discrepancy uu___2
             cp.FStarC_TypeChecker_Common.lhs
             cp.FStarC_TypeChecker_Common.rhs in
     match uu___1 with
     | (lhs, rhs) ->
         FStarC_Format.fmt3 "%s is not %s the expected type %s" lhs rel rhs)
let occurs (uk : FStarC_Syntax_Syntax.ctx_uvar)
  ...
  let uvars =
    ...
    FStarC_Class_Setlike.elems
      (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar) uu___ in
  let occurs1 =
  ...
  (uvars, occurs1)
let occurs_check (uk : FStarC_Syntax_Syntax.ctx_uvar)
  (t : FStarC_Syntax_Syntax.term) :
      ...
      let msg =
        ...
        then FStar_Pervasives_Native.None
          ...
          (let uu___1 =
             ...
             FStarC_Format.fmt2 "occurs-check failed (%s occurs in %s)"
               uu___2 uu___3 in
           FStar_Pervasives_Native.Some uu___1) in
      (uvars, (Prims.not occurs1), msg)
let set_uvar (env : 'uuuuu) (u : FStarC_Syntax_Syntax.ctx_uvar)
  (should_check_opt :
  ...
  (let uu___2 = FStarC_Options.defensive () in
   ...
   then
     ...
     (if uu___3 then FStarC_Effect.failwith "OCCURS BUG!" else ())
   else ());
  FStarC_Syntax_Util.set_uvar u.FStarC_Syntax_Syntax.ctx_uvar_head t
let commit (env : FStarC_TypeChecker_Env.env_t) (uvis : uvi Prims.list) :
  unit=
  FStarC_List.iter
    (fun uu___ ->
       match uu___ with
       ...
       | TERM (u, t) ->
           ((let uu___2 =
               FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv)
...
let sn' (env : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  let uu___ =
    let uu___1 =
...
let sn (env : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  FStarC_Profiling.profile (fun uu___ -> sn' env t)
    (FStar_Pervasives_Native.Some
       (FStarC_Ident.string_of_lid
          (FStarC_TypeChecker_Env.current_module env)))
    "FStarC.TypeChecker.Rel.sn"
let norm_with_steps (profiling_tag : Prims.string)
  (steps : FStarC_TypeChecker_Env.steps) (env : FStarC_TypeChecker_Env.env)
  ...
  FStarC_Profiling.profile
    ...
    (FStar_Pervasives_Native.Some
       (FStarC_Ident.string_of_lid
          (FStarC_TypeChecker_Env.current_module env))) profiling_tag
let should_strongly_reduce (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ =
    let uu___1 = FStarC_Syntax_Util.unascribe t in
  ...
  | (h, uu___1) ->
      ...
      (match uu___2 with
       | FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify uu___3)
           -> true
       | uu___3 -> false)
let whnf (env : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  let norm steps t1 =
    let uu___ =
      let uu___1 =
...
let sn_binders (env : FStarC_TypeChecker_Env.env)
...
let norm_univ (wl : worklist) (u : FStarC_Syntax_Syntax.universe) :
  FStarC_Syntax_Syntax.universe=
  let rec aux u1 =
    ...
    | FStarC_Syntax_Syntax.U_max us ->
        let uu___ = FStarC_List.map aux us in
...
let normalize_refinement (steps : FStarC_TypeChecker_Env.steps)
  (env : FStarC_TypeChecker_Env.env) (t0 : FStarC_Syntax_Syntax.typ) :
  FStarC_Syntax_Syntax.term=
  FStarC_Profiling.profile
    (fun uu___ ->
...
let base_and_refinement_maybe_delta (should_delta : Prims.bool)
  (env : FStarC_TypeChecker_Env.env) (t1 : FStarC_Syntax_Syntax.term) :
  ...
  let rec aux norm t11 =
    ...
    | FStarC_Syntax_Syntax.Tm_refine
        ...
        then
          ...
          (let uu___ = norm_refinement env t12 in
           match uu___ with
           | {
           ...
           | tt ->
               let uu___1 =
                 ...
                 FStarC_Format.fmt2 "impossible: Got %s ... %s\n" uu___2
                   uu___3 in
        ...
        then (t12, FStar_Pervasives_Native.None)
          ...
          (let t1' = norm_refinement env t12 in
           let uu___1 =
             ...
             uu___2.FStarC_Syntax_Syntax.n in
           match uu___1 with
           | FStarC_Syntax_Syntax.Tm_refine uu___2 -> aux true t1'
           | uu___2 -> (t12, FStar_Pervasives_Native.None))
    ...
    | FStarC_Syntax_Syntax.Tm_meta uu___ ->
        let uu___1 =
          let uu___2 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t12 in
          let uu___3 =
            FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term t12 in
          FStarC_Format.fmt2 "impossible (outer): Got %s ... %s\n" uu___2
            uu___3 in
        FStarC_Effect.failwith uu___1
    ...
    | FStarC_Syntax_Syntax.Tm_unknown ->
        let uu___ =
          ...
          FStarC_Format.fmt2 "impossible (outer): Got %s ... %s\n" uu___1
            uu___2 in
        FStarC_Effect.failwith uu___ in
  let uu___ = whnf env t1 in aux false uu___
let base_and_refinement (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * (FStarC_Syntax_Syntax.bv *
    FStarC_Syntax_Syntax.term) FStar_Pervasives_Native.option)=
  base_and_refinement_maybe_delta false env t
let unrefine (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.typ) : FStarC_Syntax_Syntax.typ=
  let uu___ = base_and_refinement env t in FStar_Pervasives_Native.fst uu___
let trivial_refinement (t : FStarC_Syntax_Syntax.term) :
...
let as_refinement (delta : Prims.bool) (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.bv * FStarC_Syntax_Syntax.term)=
  ...
  | (t_base, refopt) ->
      ...
      (match uu___1 with
       | (y, phi) ->
           FStarC_Syntax_Syntax.mk
             (FStarC_Syntax_Syntax.Tm_refine
                { FStarC_Syntax_Syntax.b2 = y; FStarC_Syntax_Syntax.phi = phi
                }) t_base.FStarC_Syntax_Syntax.pos)
let wl_to_string (wl : worklist) : Prims.string=
  let probs_to_string ps =
    let uu___ = FStarC_List.map (prob_to_string' wl) ps in
    FStarC_String.concat "\n\t" uu___ in
  let cprobs_to_string ps =
    let uu___ =
      let uu___1 = FStarC_CList.map (prob_to_string' wl) ps in
      FStarC_Class_Listlike.to_list (FStarC_CList.listlike_clist ()) uu___1 in
    FStarC_String.concat "\n\t" uu___ in
...
let uu___is_Flex (projectee : flex_t) : Prims.bool= true
let __proj__Flex__item___0 (projectee : flex_t) :
  (FStarC_Syntax_Syntax.term * FStarC_Syntax_Syntax.ctx_uvar *
    FStarC_Syntax_Syntax.args)=
  match projectee with | Flex _0 -> _0
let flex_reason (uu___ : flex_t) : Prims.string=
  match uu___ with
  | Flex (uu___1, u, uu___2) -> u.FStarC_Syntax_Syntax.ctx_uvar_reason
let flex_uvar (uu___ : flex_t) : FStarC_Syntax_Syntax.ctx_uvar=
  match uu___ with | Flex (uu___1, u, uu___2) -> u
let flex_uvar_has_meta_tac (u : FStarC_Syntax_Syntax.ctx_uvar) : Prims.bool=
  match u.FStarC_Syntax_Syntax.ctx_uvar_meta with
  | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Ctx_uvar_meta_tac
      uu___) -> true
  | uu___ -> false
let flex_t_to_string (flex : flex_t) : Prims.string=
  let uu___ = flex in
  match uu___ with
  | Flex (uu___1, c, args) ->
      let uu___2 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_ctxu c in
      let uu___3 =
        FStarC_Class_Show.show
          (FStarC_Class_Show.show_list
...
let is_flex (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ = FStarC_Syntax_Util.head_and_args_full t in
  match uu___ with
  | (head, _args) ->
      let uu___1 =
      ...
      (match uu___1 with
       ...
       | uu___2 -> false)
let flex_uvar_head (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.ctx_uvar=
  let uu___ = FStarC_Syntax_Util.head_and_args_full t in
  match uu___ with
  | (head, _args) ->
...
let ensure_no_uvar_subst (env : 'uuuuu) (t0 : FStarC_Syntax_Syntax.term)
  (wl : worklist) : (FStarC_Syntax_Syntax.term * worklist)=
  ...
  let binding_not_affected_by s b =
    ...
    | uu___ -> true in
  let uu___ = FStarC_Syntax_Util.head_and_args_full t0 in
  match uu___ with
  | (head, args) ->
      let uu___1 =
        let uu___2 = FStarC_Syntax_Subst.compress head in
      ...
      (match uu___1 with
       ...
       | FStarC_Syntax_Syntax.Tm_uvar (uv, uu___2) when
           match uv.FStarC_Syntax_Syntax.ctx_uvar_binders with
           | [] -> true
           | uu___3 -> false -> (t0, wl)
           ...
           (match uu___2 with
            | (gamma_aff, new_gamma) ->
                (match gamma_aff with
                 ...
                 | uu___3 ->
                     let dom_binders =
                       FStarC_TypeChecker_Env.binders_of_bindings gamma_aff in
                     let uu___4 =
                       let uu___5 =
                         FStarC_TypeChecker_Env.binders_of_bindings new_gamma in
                       let uu___6 =
                         let uu___7 =
                           let uu___8 = FStarC_Syntax_Util.ctx_uvar_typ uv in
                       ...
                       new_uvar
                         (Prims.strcat
                            ...
                            "; force delayed") wl t0.FStarC_Syntax_Syntax.pos
                         new_gamma uu___5 uu___6 uu___7
                     ...
                     (match uu___4 with
                      | (v, t_v, wl1) ->
                          ...
                          ((let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                            if uu___6
                            then
                              let uu___7 =
                                FStarC_Class_Show.show
                           ...
                           set_uvar env uv
                             (FStar_Pervasives_Native.Some
                                FStarC_Syntax_Syntax.Already_checked) sol;
                           (let args_sol_s =
                              FStarC_List.map
                                (fun uu___7 ->
                                   match uu___7 with
                            ...
                            let t =
                              FStarC_Syntax_Syntax.mk_Tm_app t_v
                                (FStarC_List.op_At args_sol_s args)
                                t0.FStarC_Syntax_Syntax.pos in
                            (t, wl1))))))
       | uu___2 ->
           let uu___3 =
...
let no_free_uvars (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ =
    let uu___1 = FStarC_Syntax_Free.uvars t in
    FStarC_Class_Setlike.is_empty
      (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar)
      uu___1 in
  if uu___
  then
    let uu___1 = FStarC_Syntax_Free.univs t in
    FStarC_Class_Setlike.is_empty
      (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_univ_uvar)
      uu___1
  else false
let rec has_uvar_needing_congruence (env : FStarC_TypeChecker_Env.env)
  (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let t1 =
    let uu___ = FStarC_Syntax_Subst.compress t in
  ...
  | FStarC_Syntax_Syntax.Tm_app uu___ ->
      ...
      (match uu___1 with
       | (hd, args) ->
           let hd_interpreted = FStarC_TypeChecker_Env.is_interpreted env hd in
           let uu___2 = has_uvar_needing_congruence env hd in
           if uu___2
           then true
           else
             FStarC_List.existsb
                  ...
                  | (a, q) ->
                      (match q with
                       | FStar_Pervasives_Native.Some
                           ...
                           when hd_interpreted -> false
                       | uu___4 -> has_uvar_needing_congruence env a)) args)
  | uu___ ->
      let uu___1 =
        let uu___2 = FStarC_Syntax_Free.uvars t1 in
        FStarC_Class_Setlike.is_empty
          (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar)
          uu___2 in
      Prims.not uu___1
let rec may_relate_with_logical_guard (env : FStarC_TypeChecker_Env.env)
  (is_eq : Prims.bool) (head : FStarC_Syntax_Syntax.typ) : Prims.bool=
  let uu___ =
  ...
  | FStarC_Syntax_Syntax.Tm_meta
      ...
      -> may_relate_with_logical_guard env is_eq t
  | uu___1 -> false
let may_relate (env : FStarC_TypeChecker_Env.env)
  (prel : FStarC_TypeChecker_Common.rel) (head : FStarC_Syntax_Syntax.typ) :
  Prims.bool=
  may_relate_with_logical_guard env
    (match prel with | FStarC_TypeChecker_Common.EQ -> true | uu___ -> false)
    head
let destruct_flex_t' (t : FStarC_Syntax_Syntax.term) :
  (flex_t * (FStarC_Syntax_Syntax.subst_ts * FStarC_Syntax_Syntax.term))=
  let uu___ = FStarC_Syntax_Util.head_and_args_full t in
  match uu___ with
  | (head, args) ->
      let uu___1 =
      ...
      (match uu___1 with
       | FStarC_Syntax_Syntax.Tm_uvar (uv, s) ->
           ((Flex (t, uv, args)), (s, t))
       | uu___2 -> FStarC_Effect.failwith "Not a flex-uvar")
let destruct_flex_t (t : FStarC_Syntax_Syntax.term) (wl : worklist) :
  (flex_t * worklist)=
  let uu___ = ensure_no_uvar_subst wl.tcenv t wl in
  match uu___ with
  | (t1, wl1) ->
      let uu___1 =
        let uu___2 = destruct_flex_t' t1 in
        FStar_Pervasives_Native.fst uu___2 in
      (uu___1, wl1)
let u_abs (k : FStarC_Syntax_Syntax.typ) (ys : FStarC_Syntax_Syntax.binders)
  (t : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term=
  let uu___ =
    let uu___1 =
    ...
    | FStarC_Syntax_Syntax.Tm_arrow uu___2 ->
        let uu___3 = FStarC_Syntax_Util.arrow_formals_comp_ln_strict k in
        (match uu___3 with
         | (bs, c) ->
             if (FStarC_List.length bs) = (FStarC_List.length ys)
             then
               let uu___4 = FStarC_Syntax_Subst.open_comp bs c in
               ((ys, t), uu___4)
             else
               (let uu___4 = FStarC_Syntax_Util.abs_formals t in
                match uu___4 with
                | (ys', t1, uu___5) ->
                    let uu___6 = FStarC_Syntax_Util.arrow_formals_comp k in
                    (((FStarC_List.op_At ys ys'), t1), uu___6)))
    | uu___2 ->
        let uu___3 =
  ...
  match uu___ with
  | ((ys1, t1), (xs, c)) ->
      if (FStarC_List.length xs) <> (FStarC_List.length ys1)
      then
        ...
        (let c1 =
           let uu___1 = FStarC_Syntax_Util.rename_binders xs ys1 in
           FStarC_Syntax_Subst.subst_comp uu___1 c in
         let uu___1 =
           let uu___2 = FStarC_Syntax_Util.residual_comp_of_comp c1 in
           FStar_Pervasives_Native.Some uu___2 in
         FStarC_Syntax_Util.abs ys1 t1 uu___1)
let solve_prob' (resolve_ok : Prims.bool)
  (prob : FStarC_TypeChecker_Common.prob)
  (logical_guard : FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  (uvis : uvi Prims.list) (wl : worklist) : worklist=
  ...
  (let phi =
   ...
   let assign_solution xs uv phi1 =
     (let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
      ...
      then
        let uu___3 =
          FStarC_Class_Show.show FStarC_Class_Show.showable_int (p_pid prob) in
        let uu___4 =
     ...
     (let phi2 =
      ...
      (let uu___3 =
       ...
       let uu___4 =
         ...
         FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) uu___5 in
       FStarC_Defensive.def_check_scoped
         FStarC_Class_Binders.hasBinders_list_bv
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         (p_loc prob) uu___3 uu___4 phi2);
          ...
          | (a, i) ->
              ...
              (match uu___2 with
               | FStarC_Syntax_Syntax.Tm_name x ->
                   let uu___3 = FStarC_Syntax_Util.bqual_and_attrs_of_aqual i in
                   (match uu___3 with
                    | (q, attrs) ->
                        let uu___4 =
                        ...
                        (match uu___4 with
                         | (pq, attrs1) ->
                             [FStarC_Syntax_Syntax.mk_binder_with_attrs x q
                                pq attrs1]))
               | uu___3 -> (fail (); []))) args in
   let wl1 =
     let rec aux retry env g =
       ...
       then
         ...
         if retry
         then (let uu___2 = whnf env g in aux false env uu___2)
         else if resolve_ok then wl else (fail (); wl) in
     let uu___1 = p_env wl prob in aux true uu___1 (p_guard prob) in
...
let extend_universe_solution (pid : Prims.int) (sol : uvi Prims.list)
  (wl : worklist) : worklist=
  (let uu___1 = FStarC_Effect.op_Bang dbg_Rel in
   if uu___1
   then
     let uu___2 = FStarC_Class_Show.show FStarC_Class_Show.showable_int pid in
...
let solve_prob (prob : FStarC_TypeChecker_Common.prob)
  (logical_guard : FStarC_Syntax_Syntax.term FStar_Pervasives_Native.option)
  (uvis : uvi Prims.list) (wl : worklist) : worklist=
  def_check_prob "solve_prob.prob" prob;
  FStarC_Option.iter (def_check_term_scoped_in_prob "solve_prob.guard" prob)
    logical_guard;
...
let rec maximal_prefix (bs : FStarC_Syntax_Syntax.binders)
  (bs' : FStarC_Syntax_Syntax.binders) :
  ...
  | (binder1::bs_tail,
     { FStarC_Syntax_Syntax.binder_bv = b';
      ...
      ->
      if FStarC_Syntax_Syntax.bv_eq binder1.FStarC_Syntax_Syntax.binder_bv b'
      then
        let uu___2 = maximal_prefix bs_tail bs'_tail in
        (match uu___2 with | (pfx, rest) -> ((binder1 :: pfx), rest))
      else ([], (bs, bs'))
  | uu___ -> ([], (bs, bs'))
let gamma_until (g : FStarC_Syntax_Syntax.gamma)
  (bs : FStarC_Syntax_Syntax.binders) :
...
let restrict_ctx (env : 'uuuuu) (tgt : FStarC_Syntax_Syntax.ctx_uvar)
  (bs : FStarC_Syntax_Syntax.binders) (src : FStarC_Syntax_Syntax.ctx_uvar)
  (wl : worklist) : worklist=
  let uu___ =
  ...
  match uu___ with
  | (pfx, uu___1) ->
      let g = gamma_until src.FStarC_Syntax_Syntax.ctx_uvar_gamma pfx in
      let aux t f =
        let uu___2 =
          let uu___3 =
            let uu___4 =
          ...
          new_uvar uu___3 wl src.FStarC_Syntax_Syntax.ctx_uvar_range g pfx t
            uu___4 src.FStarC_Syntax_Syntax.ctx_uvar_meta in
        match uu___2 with
        | (uu___3, src', wl1) ->
            ((let uu___5 = f src' in
              set_uvar env src
                   ...
                   FStarC_List.existsb
                     (fun uu___7 ->
                        ...
                        | { FStarC_Syntax_Syntax.binder_bv = bv2;
                            FStarC_Syntax_Syntax.binder_qual = uu___8;
                            FStarC_Syntax_Syntax.binder_positivity = uu___9;
                            FStarC_Syntax_Syntax.binder_attrs = uu___10;_} ->
                     ...
                     FStarC_List.existsb
                       (fun uu___8 ->
                          ...
                          | { FStarC_Syntax_Syntax.binder_bv = bv2;
                              ...
                              -> FStarC_Syntax_Syntax.bv_eq bv1 bv2) pfx in
                   Prims.not uu___7
                 else false) bs in
      if (match bs1 with | [] -> true | uu___2 -> false)
      then
        ...
        (let uu___2 =
           ...
           let uu___3 = FStarC_Syntax_Syntax.mk_Total t in
           FStarC_Syntax_Util.arrow bs1 uu___3 in
         aux uu___2
           (fun src' ->
              let uu___3 =
                let uu___4 = FStarC_Syntax_Syntax.binders_to_names bs1 in
                FStarC_List.map FStarC_Syntax_Syntax.as_arg uu___4 in
              FStarC_Syntax_Syntax.mk_Tm_app src' uu___3
                src.FStarC_Syntax_Syntax.ctx_uvar_range))
let restrict_all_uvars (env : 'uuuuu) (tgt : FStarC_Syntax_Syntax.ctx_uvar)
  (bs : FStarC_Syntax_Syntax.binders)
  (sources : FStarC_Syntax_Syntax.ctx_uvar Prims.list) (wl : worklist) :
  worklist=
  match bs with
  | [] ->
      let ctx_tgt =
      ...
      FStarC_List.fold_right
        (fun src wl1 ->
           let ctx_src =
             binders_as_bv_set src.FStarC_Syntax_Syntax.ctx_uvar_binders in
           let uu___ =
             FStarC_Class_Setlike.subset
               (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Syntax.ord_bv)
               ctx_src ctx_tgt in
           if uu___ then wl1 else restrict_ctx env tgt [] src wl1) sources wl
  | uu___ -> FStarC_List.fold_right (restrict_ctx env tgt bs) sources wl
let intersect_binders (g : FStarC_Syntax_Syntax.gamma)
  (v1 : FStarC_Syntax_Syntax.binders) (v2 : FStarC_Syntax_Syntax.binders) :
  FStarC_Syntax_Syntax.binders=
  let as_set v =
    let uu___ =
      FStarC_Class_Setlike.empty
        (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_bv) () in
    FStarC_List.fold_left
      (fun out x ->
         FStarC_Class_Setlike.add
           (FStarC_RBSet.setlike_rbset FStarC_Syntax_Syntax.ord_bv)
           x.FStarC_Syntax_Syntax.binder_bv out) uu___ v in
                    ...
                    let uu___4 =
                      FStarC_Class_Setlike.mem
                        (FStarC_RBSet.setlike_rbset
                           FStarC_Syntax_Syntax.ord_bv) x v1_set in
                    Prims.not uu___4 in
                  if uu___3
                  then (isect, isect_set)
                  else
                    (let fvs =
                       FStarC_Syntax_Free.names x.FStarC_Syntax_Syntax.sort in
                     let uu___4 =
                       FStarC_Class_Setlike.subset
                         (FStarC_FlatSet.setlike_flat_set
                            FStarC_Syntax_Syntax.ord_bv) fvs isect_set in
                     if uu___4
                     then
                       let uu___5 =
                         FStarC_Class_Setlike.add
                           (FStarC_FlatSet.setlike_flat_set
                              FStarC_Syntax_Syntax.ord_bv) x isect_set in
                       ((b :: isect), uu___5)
                     else (isect, isect_set)))) ([], ctx_binders) v2 in
  match uu___ with | (isect, uu___1) -> FStarC_List.rev isect
let binders_eq (v1 : FStarC_Syntax_Syntax.binder Prims.list)
  (v2 : FStarC_Syntax_Syntax.binder Prims.list) : Prims.bool=
  if (FStarC_List.length v1) = (FStarC_List.length v2)
  then
    FStarC_List.forall2
      (fun uu___ uu___1 ->
...
let name_exists_in_binders (x : FStarC_Syntax_Syntax.bv)
...
let pat_vars (env : FStarC_TypeChecker_Env.env)
  (ctx : FStarC_Syntax_Syntax.binder Prims.list)
  (args :
  ...
  let rec aux seen args1 =
    match args1 with
    | [] -> FStar_Pervasives_Native.Some (FStarC_List.rev seen)
    | (arg, i)::args2 ->
        let hd = sn env arg in
        (match hd.FStarC_Syntax_Syntax.n with
         | FStarC_Syntax_Syntax.Tm_name a ->
             let uu___ =
               let uu___1 = name_exists_in_binders a seen in
               if uu___1 then true else name_exists_in_binders a ctx in
             if uu___
             then FStar_Pervasives_Native.None
             else
               (let uu___1 = FStarC_Syntax_Util.bqual_and_attrs_of_aqual i in
                match uu___1 with
                | (bq, attrs) ->
                    let uu___2 =
                      FStarC_Syntax_Util.parse_positivity_attributes attrs in
                    (match uu___2 with
                     | (pq, attrs1) ->
                         aux
                           ((FStarC_Syntax_Syntax.mk_binder_with_attrs a bq
                               pq attrs1) :: seen) args2))
         | uu___ -> FStar_Pervasives_Native.None) in
  aux [] args
let string_of_match_result (uu___ : match_result) : Prims.string=
  match uu___ with
  | MisMatch (d1, d2) ->
      let uu___1 =
        FStarC_Class_Show.show
  ...
  | HeadMatch u ->
      let uu___1 = FStarC_Class_Show.show FStarC_Class_Show.showable_bool u in
...
let head_match (uu___ : match_result) : match_result=
  match uu___ with
  | MisMatch (i, j) -> MisMatch (i, j)
  | HeadMatch true -> HeadMatch true
  | uu___1 -> HeadMatch false
let universe_has_max (env : FStarC_TypeChecker_Env.env)
  (u : FStarC_Syntax_Syntax.universe) : Prims.bool=
  let u1 = FStarC_TypeChecker_Normalize.normalize_universe env u in
  match u1 with | FStarC_Syntax_Syntax.U_max uu___ -> true | uu___ -> false
let rec head_matches (env : FStarC_TypeChecker_Env.env)
  ...
  (let uu___1 = FStarC_Effect.op_Bang dbg_RelDelta in
   if uu___1
   then
     ((let uu___3 =
  ...
  (match ((t11.FStarC_Syntax_Syntax.n), (t21.FStarC_Syntax_Syntax.n)) with
   ...
   | (FStarC_Syntax_Syntax.Tm_lazy li1, FStarC_Syntax_Syntax.Tm_lazy li2) ->
       let uu___1 =
         FStarC_Class_Deq.op_Equals_Question
           FStarC_Syntax_Syntax.deq_lazy_kind li1.FStarC_Syntax_Syntax.lkind
   ...
   | (FStarC_Syntax_Syntax.Tm_name x, FStarC_Syntax_Syntax.Tm_name y) ->
       if FStarC_Syntax_Syntax.bv_eq x y
       then FullMatch
       else
         MisMatch
           (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
   | (FStarC_Syntax_Syntax.Tm_fvar f, FStarC_Syntax_Syntax.Tm_fvar g) ->
       if FStarC_Syntax_Syntax.fv_eq f g
       then FullMatch
       else
         (let uu___1 =
            let uu___2 =
              let uu___3 = FStarC_TypeChecker_Env.fv_delta_depth env f in
              FStar_Pervasives_Native.Some uu___3 in
            let uu___3 =
              let uu___4 = FStarC_TypeChecker_Env.fv_delta_depth env g in
   ...
   | (FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify uu___1),
      FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify uu___2)) ->
       FullMatch
   | (FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify uu___1),
      uu___2) -> HeadMatch true
   | (uu___1, FStarC_Syntax_Syntax.Tm_constant (FStarC_Const.Const_reify
      uu___2)) -> HeadMatch true
   | (FStarC_Syntax_Syntax.Tm_constant c, FStarC_Syntax_Syntax.Tm_constant d)
       ->
       if FStarC_Const.eq_const c d
       then FullMatch
       else
         MisMatch
           (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
   | (FStarC_Syntax_Syntax.Tm_uvar (uv, uu___1), FStarC_Syntax_Syntax.Tm_uvar
      (uv', uu___2)) ->
       let uu___3 =
         FStarC_Syntax_Unionfind.equiv uv.FStarC_Syntax_Syntax.ctx_uvar_head
   ...
   | (FStarC_Syntax_Syntax.Tm_refine
      ...
      FStarC_Syntax_Syntax.Tm_refine
      { FStarC_Syntax_Syntax.b2 = y; FStarC_Syntax_Syntax.phi = uu___2;_}) ->
       let uu___3 =
   ...
   | (FStarC_Syntax_Syntax.Tm_arrow uu___1, FStarC_Syntax_Syntax.Tm_arrow
      uu___2) -> HeadMatch false
   | (FStarC_Syntax_Syntax.Tm_app uu___1, FStarC_Syntax_Syntax.Tm_app uu___2)
       ->
       let uu___3 =
         let uu___4 =
           let uu___5 = FStarC_Syntax_Util.head_and_args_full t11 in
           FStar_Pervasives_Native.fst uu___5 in
         let uu___5 =
           let uu___6 = FStarC_Syntax_Util.head_and_args_full t21 in
           FStar_Pervasives_Native.fst uu___6 in
         head_matches env uu___4 uu___5 in
       head_match uu___3
   | (FStarC_Syntax_Syntax.Tm_app uu___1, uu___2) ->
       let uu___3 =
         let uu___4 =
           let uu___5 = FStarC_Syntax_Util.head_and_args_full t11 in
           FStar_Pervasives_Native.fst uu___5 in
         head_matches env uu___4 t21 in
       head_match uu___3
   | (uu___1, FStarC_Syntax_Syntax.Tm_app uu___2) ->
       let uu___3 =
         let uu___4 =
           let uu___5 = FStarC_Syntax_Util.head_and_args_full t21 in
           FStar_Pervasives_Native.fst uu___5 in
         head_matches env t11 uu___4 in
       head_match uu___3
   | (FStarC_Syntax_Syntax.Tm_let uu___1, FStarC_Syntax_Syntax.Tm_let uu___2)
       -> HeadMatch true
   | (FStarC_Syntax_Syntax.Tm_match uu___1, FStarC_Syntax_Syntax.Tm_match
      uu___2) -> HeadMatch true
   | (FStarC_Syntax_Syntax.Tm_quoted uu___1, FStarC_Syntax_Syntax.Tm_quoted
      uu___2) -> HeadMatch true
   | (FStarC_Syntax_Syntax.Tm_abs uu___1, FStarC_Syntax_Syntax.Tm_abs uu___2)
       -> HeadMatch true
   | uu___1 ->
       let maybe_dd t =
         let uu___2 =
         ...
         | FStarC_Syntax_Syntax.Tm_uvar uu___3 ->
             FStar_Pervasives_Native.None
         | FStarC_Syntax_Syntax.Tm_let uu___3 -> FStar_Pervasives_Native.None
         | FStarC_Syntax_Syntax.Tm_match uu___3 ->
             FStar_Pervasives_Native.None
         | uu___3 ->
             let uu___4 = FStarC_TypeChecker_Env.delta_depth_of_term env t in
             FStar_Pervasives_Native.Some uu___4 in
       let uu___2 =
         let uu___3 = maybe_dd t11 in
         let uu___4 = maybe_dd t21 in (uu___3, uu___4) in
       MisMatch uu___2)
let head_matches_delta (env : FStarC_TypeChecker_Env.env)
  (logical : Prims.bool) (smt_ok : Prims.bool)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  (match_result * (FStarC_Syntax_Syntax.typ * FStarC_Syntax_Syntax.typ)
    FStar_Pervasives_Native.option)=
  let base_steps =
    FStarC_List.op_At
      (if logical
  ...
  let maybe_inline t =
    let head = let uu___ = unrefine env t in FStarC_Syntax_Util.head_of uu___ in
    (let uu___1 = FStarC_Effect.op_Bang dbg_RelDelta in
     if uu___1
     then
       let uu___2 =
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t in
       let uu___3 =
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_term head in
     ...
     | FStarC_Syntax_Syntax.Tm_fvar fv ->
         ...
         let can_unfold =
           ...
           then true
             ...
             (let uu___2 =
                FStarC_TypeChecker_Env.disc_proj_qual env
                  fv.FStarC_Syntax_Syntax.fv_name in
              match uu___2 with
              | FStar_Pervasives_Native.Some v -> true
              | uu___3 -> false) in
         (match if can_unfold
          ...
          with
          | FStar_Pervasives_Native.None ->
              ((let uu___3 = FStarC_Effect.op_Bang dbg_RelDelta in
                if uu___3
                then
                  let uu___4 =
                    FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
          ...
          | FStar_Pervasives_Native.Some uu___2 ->
              ...
              let steps =
                ...
                then basic_steps
                  ...
                  :: basic_steps in
              let t' =
                norm_with_steps "FStarC.TypeChecker.Rel.norm_with_steps.1"
                  steps env t in
              let uu___3 =
                let uu___4 =
                  FStarC_TypeChecker_TermEqAndSimplify.eq_tm env t t' in
                uu___4 = FStarC_TypeChecker_TermEqAndSimplify.Equal in
              if uu___3
              then FStar_Pervasives_Native.None
              else
                ((let uu___5 = FStarC_Effect.op_Bang dbg_RelDelta in
                  if uu___5
                  then
                    let uu___6 =
                      FStarC_Class_Show.show
  ...
  let made_progress t t' =
    ...
    let head' =
      let uu___ = FStarC_Syntax_Util.head_and_args_full t' in
      FStar_Pervasives_Native.fst uu___ in
    let uu___ = FStarC_Syntax_Util.term_eq head head' in Prims.not uu___ in
  let rec aux retry n_delta t11 t21 =
    ...
    (let reduce_one_and_try_again d1 d2 =
       ...
       let uu___1 =
         ...
         then
           let t1' =
             normalize_refinement ((FStarC_TypeChecker_Env.UnfoldUntil d2) ::
               base_steps) env t11 in
           let uu___2 = made_progress t11 t1' in (t1', t21, uu___2)
         else
           (let t2' =
              normalize_refinement ((FStarC_TypeChecker_Env.UnfoldUntil d1)
                :: base_steps) env t21 in
            let uu___2 = made_progress t21 t2' in (t11, t2', uu___2)) in
       match uu___1 with
     ...
     let reduce_both_and_try_again d r1 =
       match FStarC_TypeChecker_Common.decr_delta_depth d with
       ...
       | FStar_Pervasives_Native.Some d1 ->
           ...
           let t2' =
             normalize_refinement ((FStarC_TypeChecker_Env.UnfoldUntil d1) ::
               base_steps) env t21 in
           let uu___1 =
             let uu___2 = made_progress t11 t1' in
             if uu___2 then made_progress t21 t2' else false in
           if uu___1
     ...
     | MisMatch
         (FStar_Pervasives_Native.Some
          (FStarC_Syntax_Syntax.Delta_equational_at_level uu___1), uu___2)
         ->
         if Prims.not retry
         then fail n_delta r t11 t21
         else
           (let uu___3 =
              let uu___4 = maybe_inline t11 in
              let uu___5 = maybe_inline t21 in (uu___4, uu___5) in
            match uu___3 with
            | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) ->
            ...
            | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some
               t22) -> aux false (n_delta + Prims.int_one) t11 t22
            | (FStar_Pervasives_Native.Some t12, FStar_Pervasives_Native.Some
               t22) -> aux false (n_delta + Prims.int_one) t12 t22)
     | MisMatch
  ...
  (let uu___1 = FStarC_Effect.op_Bang dbg_RelDelta in
   if uu___1
   then
     let uu___2 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
     let uu___3 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t2 in
     let uu___4 =
       FStarC_Class_Show.show
  ...
  r
let rank_t_num (uu___ : FStarC_TypeChecker_Common.rank_t) : Prims.int=
  match uu___ with
...
let rank_leq (r1 : FStarC_TypeChecker_Common.rank_t)
...
let compress_cprob (wl : worklist)
  (p : FStarC_Syntax_Syntax.comp FStarC_TypeChecker_Common.problem) :
  ...
  let whnf_c env c =
    ...
    | FStarC_Syntax_Syntax.Comp ct when
        FStarC_Syntax_Util.is_bare_total_comp c ->
        let uu___ =
          let uu___1 = whnf env ct.FStarC_Syntax_Syntax.result_typ in
          {
...
let compress_prob (wl : worklist) (p : FStarC_TypeChecker_Common.prob) :
  FStarC_TypeChecker_Common.prob=
  match p with
...
let rank (wl : worklist) (pr : FStarC_TypeChecker_Common.prob) :
                      ...
                      (match (lhs_args, rhs_args) with
                       | ([], []) when
                           ...
                           (FStarC_TypeChecker_Common.Flex_flex_pattern_eq,
                             tp)
                       | uu___5 -> (FStarC_TypeChecker_Common.Flex_flex, tp))
...
let next_prob (wl : worklist) :
  (FStarC_TypeChecker_Common.prob * FStarC_TypeChecker_Common.prob Prims.list
    * FStarC_TypeChecker_Common.rank_t) FStar_Pervasives_Native.option=
  let rec aux acc probs =
    let uu___ = acc in
    match uu___ with
    | (min_rank, min, out) ->
        (match probs with
         | [] ->
             (match (min, min_rank) with
              | (FStar_Pervasives_Native.Some p, FStar_Pervasives_Native.Some
                 r) -> FStar_Pervasives_Native.Some (p, out, r)
              ...
              | (rank1, hd1) ->
                  ...
                  then
                    (match min with
                     | FStar_Pervasives_Native.None ->
                         FStar_Pervasives_Native.Some
                           (hd1, (FStarC_List.op_At out tl), rank1)
                     | FStar_Pervasives_Native.Some m ->
                         FStar_Pervasives_Native.Some
                           (hd1, (FStarC_List.op_At out (m :: tl)), rank1))
                  else
                    (let uu___2 =
                       if min_rank = FStar_Pervasives_Native.None
                       then true
                       else
                         (let uu___3 = FStarC_Option.must min_rank in
                          rank_less_than rank1 uu___3) in
                     if uu___2
                     then
                       match min with
                       | FStar_Pervasives_Native.None ->
  ...
  aux (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None, [])
    wl.attempting
let flex_prob_closing (tcenv : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) (p : FStarC_TypeChecker_Common.prob) :
  Prims.bool=
       ...
       | FStarC_TypeChecker_Common.TProb p2 ->
           (match r with
            ...
            | FStarC_TypeChecker_Common.Flex_flex ->
                ...
                then
                  let uu___1 =
                    flex_will_be_closed p2.FStarC_TypeChecker_Common.lhs in
                  (if uu___1
                   then true
                   else flex_will_be_closed p2.FStarC_TypeChecker_Common.rhs)
                else false))
type univ_eq_sol =
  | UDeferred of worklist 
  | USolved of worklist 
  | UFailed of lstring 
let uu___is_UDeferred (projectee : univ_eq_sol) : Prims.bool=
  match projectee with | UDeferred _0 -> true | uu___ -> false
let __proj__UDeferred__item___0 (projectee : univ_eq_sol) : worklist=
  match projectee with | UDeferred _0 -> _0
let uu___is_USolved (projectee : univ_eq_sol) : Prims.bool=
  match projectee with | USolved _0 -> true | uu___ -> false
let __proj__USolved__item___0 (projectee : univ_eq_sol) : worklist=
  match projectee with | USolved _0 -> _0
let uu___is_UFailed (projectee : univ_eq_sol) : Prims.bool=
  match projectee with | UFailed _0 -> true | uu___ -> false
let __proj__UFailed__item___0 (projectee : univ_eq_sol) : lstring=
  match projectee with | UFailed _0 -> _0
let ufailed_simple (s : Prims.string) : univ_eq_sol=
  let uu___ = FStarC_Thunk.mkv s in UFailed uu___
let ufailed_thunk (s : unit -> Prims.string) : univ_eq_sol=
  let uu___ = mklstr s in UFailed uu___
let rec solve_universe_eq (pid_orig : Prims.int) (wl : worklist)
  (u1 : FStarC_Syntax_Syntax.universe) (u2 : FStarC_Syntax_Syntax.universe) :
  univ_eq_sol=
    ...
    let filter =
      FStarC_List.filter
        (fun u ->
           let uu___ =
             FStarC_List.existsML
               (fun u' -> FStarC_Syntax_Util.eq_univs u u') common_elts in
           Prims.not uu___) in
    let uu___ = filter u12 in let uu___1 = filter u22 in (uu___, uu___1) in
  let try_umax_components u12 u22 msg =
    if Prims.not wl.umax_heuristic_ok
    then ufailed_simple "Unable to unify universe terms with umax"
      ...
      (match (u12, u22) with
       | (FStarC_Syntax_Syntax.U_max us1, FStarC_Syntax_Syntax.U_max us2) ->
           let uu___ = filter_out_common_univs us1 us2 in
           (match uu___ with
            | (us11, us21) ->
                if (FStarC_List.length us11) = (FStarC_List.length us21)
                then
                  let rec aux wl1 us12 us22 =
                    match (us12, us22) with
                    | (u13::us13, u23::us23) ->
                        let uu___1 = solve_universe_eq pid_orig wl1 u13 u23 in
                        (match uu___1 with
                         | USolved wl2 -> aux wl2 us13 us23
                         | failed -> failed)
                    | uu___1 -> USolved wl1 in
                  aux wl us11 us21
                else
                  ufailed_thunk
                    (fun uu___1 ->
                       ...
                       FStarC_Format.fmt2
                         "Unable to unify universes: %s and %s" uu___2 uu___3))
       | (FStarC_Syntax_Syntax.U_max us, u') ->
           let rec aux wl1 us1 =
             match us1 with
             | [] -> USolved wl1
             | u::us2 ->
                 let uu___ = solve_universe_eq pid_orig wl1 u u' in
                 (match uu___ with
             ...
             (fun uu___1 ->
                ...
                let uu___3 =
                  FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ
                    u22 in
                FStarC_Format.fmt3
                  "Unable to unify universes: %s and %s (%s)" uu___2 uu___3
                  msg)) in
  match (u11, u21) with
  | (FStarC_Syntax_Syntax.U_bvar uu___, uu___1) ->
      let uu___2 =
        let uu___3 =
          FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u11 in
        let uu___4 =
          FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u21 in
        FStarC_Format.fmt2
  ...
  | (FStarC_Syntax_Syntax.U_name x, FStarC_Syntax_Syntax.U_name y) ->
      if (FStarC_Ident.string_of_id x) = (FStarC_Ident.string_of_id y)
      then USolved wl
      else ufailed_simple "Incompatible universes"
  | (FStarC_Syntax_Syntax.U_zero, FStarC_Syntax_Syntax.U_zero) -> USolved wl
  | (FStarC_Syntax_Syntax.U_succ u12, FStarC_Syntax_Syntax.U_succ u22) ->
      solve_universe_eq pid_orig wl u12 u22
  | (FStarC_Syntax_Syntax.U_unif v1, FStarC_Syntax_Syntax.U_unif v2) ->
      let uu___ = FStarC_Syntax_Unionfind.univ_equiv v1 v2 in
      if uu___
      then USolved wl
      else
        (let wl1 = extend_universe_solution pid_orig [UNIV (v1, u21)] wl in
         USolved wl1)
  | (FStarC_Syntax_Syntax.U_unif v1, u) ->
      ...
      then
        let uu___1 =
          ...
          let uu___3 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u3 in
          FStarC_Format.fmt2 "Failed occurs check: %s occurs in %s" uu___2
            uu___3 in
        try_umax_components u11 u21 uu___1
      else
        (let uu___1 = extend_universe_solution pid_orig [UNIV (v1, u3)] wl in
         USolved uu___1)
  ...
  | (FStarC_Syntax_Syntax.U_max uu___, uu___1) ->
      ...
      then UDeferred wl
        ...
        (let u12 = norm_univ wl u11 in
         ...
         let uu___2 = FStarC_Syntax_Util.eq_univs u12 u22 in
         if uu___2 then USolved wl else try_umax_components u12 u22 "")
  ...
  | (FStarC_Syntax_Syntax.U_succ uu___, FStarC_Syntax_Syntax.U_name uu___1)
      -> ufailed_simple "Incompatible universes"
  ...
  | (FStarC_Syntax_Syntax.U_zero, FStarC_Syntax_Syntax.U_name uu___) ->
      ufailed_simple "Incompatible universes"
  | (FStarC_Syntax_Syntax.U_name uu___, FStarC_Syntax_Syntax.U_succ uu___1)
      -> ufailed_simple "Incompatible universes"
  | (FStarC_Syntax_Syntax.U_name uu___, FStarC_Syntax_Syntax.U_zero) ->
      ufailed_simple "Incompatible universes"
let match_num_binders (bc1 : ('a Prims.list * ('a Prims.list -> 'b)))
  (bc2 : ('a Prims.list * ('a Prims.list -> 'b))) :
       ...
       | (bs2, mk_cod2) ->
           let rec aux bs11 bs21 =
             ...
             | (xs, ys) ->
                 ...
                 (uu___2, uu___3) in
           aux bs1 bs2)
let guard_of_prob (wl : worklist) (problem : tprob)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term) :
  (FStarC_Syntax_Syntax.term * worklist)=
  ...
  (let env = p_env wl (FStarC_TypeChecker_Common.TProb problem) in
   let has_type_guard t11 t21 =
     FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
       FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
       t11.FStarC_Syntax_Syntax.pos "guard_of_prob.universe_of" env t11;
     FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
       FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
       t21.FStarC_Syntax_Syntax.pos "guard_of_prob.universe_of" env t21;
     (let u1 = env.FStarC_TypeChecker_Env.universe_of env t11 in
      ...
      | FStar_Pervasives_Native.Some t ->
          ...
          FStarC_Syntax_Util.mk_has_type [u1; u2] t11 uu___3 t21
      | FStar_Pervasives_Native.None ->
          let x =
            FStarC_Syntax_Syntax.new_bv FStar_Pervasives_Native.None t11 in
          let uu___3 =
            let uu___4 = FStarC_Syntax_Syntax.bv_to_name x in
            FStarC_Syntax_Util.mk_has_type [u1; u2] t11 uu___4 t21 in
          FStarC_Syntax_Util.mk_forall u1 x uu___3) in
...
let is_flex_pat (uu___ : flex_t) : Prims.bool=
  match uu___ with | Flex (uu___1, uu___2, []) -> true | uu___1 -> false
let should_defer_flex_to_user_tac (wl : worklist) (f : flex_t) : Prims.bool=
  let uu___ = f in
  match uu___ with
  | Flex (uu___1, u, uu___2) ->
      let b =
        FStarC_TypeChecker_DeferredImplicits.should_defer_uvar_to_user_tac
          wl.tcenv u in
      ((let uu___4 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
        if uu___4
        then
          let uu___5 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_ctxu u in
       ...
       b)
let quasi_pattern (env : FStarC_TypeChecker_Env.env) (f : flex_t) :
  ...
  | Flex (uu___1, ctx_uvar, args) ->
      ...
      let rec aux pat_binders formals t_res args1 =
        ...
        | ([], []) ->
            let uu___2 =
              ...
              ((FStarC_List.rev pat_binders), uu___3) in
            FStar_Pervasives_Native.Some uu___2
        | (uu___2, []) ->
            let uu___3 =
              let uu___4 =
              ...
              ((FStarC_List.rev pat_binders), uu___4) in
            ...
            (match uu___2 with
             | (formal, formal_imp) ->
                 ...
                 (match uu___3 with
                  | FStarC_Syntax_Syntax.Tm_name x ->
                      let uu___4 =
                        let uu___5 = name_exists_in x ctx in
                        if uu___5 then true else name_exists_in x pat_binders in
                      if uu___4
                      then aux (fml :: pat_binders) formals1 t_res args2
                        ...
                        (let x1 =
                         ...
                         let subst =
                           ...
                           [uu___5] in
                         let formals2 =
                           FStarC_Syntax_Subst.subst_binders subst formals1 in
                         let t_res1 = FStarC_Syntax_Subst.subst subst t_res in
                         let uu___5 =
                           FStarC_Syntax_Util.bqual_and_attrs_of_aqual a_imp in
                         match uu___5 with
                         | (q, uu___6) ->
                             aux
                               ((FStarC_Syntax_Syntax.mk_binder_with_attrs
                                   ...
                                   fml.FStarC_Syntax_Syntax.binder_attrs) ::
                               pat_binders) formals2 t_res1 args2)
                  | uu___4 -> aux (fml :: pat_binders) formals1 t_res args2))
        | ([], args2) ->
            let uu___2 =
              let uu___3 = FStarC_TypeChecker_Normalize.unfold_whnf env t_res in
      ...
      (match args with
       ...
       | uu___2 ->
           ...
           (match uu___3 with | (formals, t_res) -> aux [] formals t_res args))
let run_meta_arg_tac (env : FStarC_TypeChecker_Env.env_t)
  (ctx_u : FStarC_Syntax_Syntax.ctx_uvar) : FStarC_Syntax_Syntax.term=
  match ctx_u.FStarC_Syntax_Syntax.ctx_uvar_meta with
  | FStar_Pervasives_Native.Some (FStarC_Syntax_Syntax.Ctx_uvar_meta_tac tau)
      ->
      let env1 =
        {
      ...
      ((let uu___1 = FStarC_Effect.op_Bang dbg_Tac in
        ...
        then
          let uu___2 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_ctxu ctx_u in
...
let simplify_vc (full_norm_allowed : Prims.bool)
  (env : FStarC_TypeChecker_Env.env) (t : FStarC_Syntax_Syntax.term) :
  FStarC_Syntax_Syntax.term=
  FStarC_Stats.record "simplify_vc"
    (fun uu___ ->
       (let uu___2 = FStarC_Effect.op_Bang dbg_Simplification in
        if uu___2
        then
          let uu___3 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t in
       ...
       (let steps =
        ...
        (let uu___3 = FStarC_Effect.op_Bang dbg_Simplification in
         if uu___3
         then
           let uu___4 =
             FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t' in
        ...
        t'))
let __simplify_guard (full_norm_allowed : Prims.bool)
  (env : FStarC_TypeChecker_Env.env) (g : FStarC_TypeChecker_Common.guard_t)
  : FStarC_TypeChecker_Common.guard_t=
  match g.FStarC_TypeChecker_Common.guard_f with
  | FStarC_TypeChecker_Common.Trivial -> g
  | uu___ when env.FStarC_TypeChecker_Env.phase1 ->
      {
...
let simplify_guard :
  ...
  __simplify_guard false
let simplify_guard_full_norm :
  FStarC_TypeChecker_Env.env ->
    FStarC_TypeChecker_Common.guard_t -> FStarC_TypeChecker_Common.guard_t=
  __simplify_guard true
let has_typeclass_constraint (u : FStarC_Syntax_Syntax.ctx_uvar)
  (wl : worklist) : Prims.bool=
  FStarC_Class_Setlike.for_any
    (FStarC_RBSet.setlike_rbset FStarC_Syntax_Free.ord_ctx_uvar)
    (fun v ->
       FStarC_Syntax_Unionfind.equiv v.FStarC_Syntax_Syntax.ctx_uvar_head
         u.FStarC_Syntax_Syntax.ctx_uvar_head) wl.typeclass_variables
let lazy_complete_repr (k : FStarC_Syntax_Syntax.lazy_kind) : Prims.bool=
  match k with
  ...
  | uu___ -> false
let has_free_uvars (t : FStarC_Syntax_Syntax.term) : Prims.bool=
  let uu___ =
    ...
    FStarC_Class_Setlike.is_empty
      ...
      uu___1 in
  Prims.not uu___
let gamma_has_free_uvars (g : FStarC_Syntax_Syntax.binding Prims.list) :
  Prims.bool=
  FStarC_List.existsb
    (fun uu___ ->
       match uu___ with
...
type reveal_hide_t =
  ...
  FStarC_Syntax_Syntax.term) 
let uu___is_Hide (projectee : reveal_hide_t) : Prims.bool=
  match projectee with | Hide _0 -> true | uu___ -> false
let __proj__Hide__item___0 (projectee : reveal_hide_t) :
  (FStarC_Syntax_Syntax.universe * FStarC_Syntax_Syntax.typ *
    FStarC_Syntax_Syntax.term)=
  match projectee with | Hide _0 -> _0
let uu___is_Reveal (projectee : reveal_hide_t) : Prims.bool=
  match projectee with | Reveal _0 -> true | uu___ -> false
let __proj__Reveal__item___0 (projectee : reveal_hide_t) :
  (FStarC_Syntax_Syntax.universe * FStarC_Syntax_Syntax.typ *
    FStarC_Syntax_Syntax.term)=
  match projectee with | Reveal _0 -> _0
let payload_of_hide_reveal
  (h : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (args :
    (FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax *
  ...
  | (FStarC_Syntax_Syntax.Tm_uinst (uu___, u::[]),
     (ty, FStar_Pervasives_Native.Some
      { FStarC_Syntax_Syntax.aqual_implicit = true;
        FStarC_Syntax_Syntax.aqual_attributes = uu___1;_})::(t, uu___2)::[])
      -> FStar_Pervasives_Native.Some (u, ty, t)
  | uu___ -> FStar_Pervasives_Native.None
let is_reveal_or_hide (t : FStarC_Syntax_Syntax.term) :
  reveal_hide_t FStar_Pervasives_Native.option=
  let uu___ = FStarC_Syntax_Util.head_and_args_full t in
  match uu___ with
  | (h, args) ->
      let uu___1 = FStarC_Syntax_Util.is_fvar FStarC_Parser_Const.reveal h in
      if uu___1
      then
        let uu___2 = payload_of_hide_reveal h args in
        (match uu___2 with
         | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
         | FStar_Pervasives_Native.Some t1 ->
             FStar_Pervasives_Native.Some (Reveal t1))
      else
        (let uu___2 = FStarC_Syntax_Util.is_fvar FStarC_Parser_Const.hide h in
         if uu___2
         then
           let uu___3 = payload_of_hide_reveal h args in
           match uu___3 with
           | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
           | FStar_Pervasives_Native.Some t1 ->
               FStar_Pervasives_Native.Some (Hide t1)
         else FStar_Pervasives_Native.None)
let mk_fv_app (g : FStarC_TypeChecker_Env.env) (lid : FStarC_Ident.lident)
  (u : FStarC_Syntax_Syntax.universe) (args : FStarC_Syntax_Syntax.args)
  (r : FStarC_Range_Type.range) : FStarC_Syntax_Syntax.term=
...
let solve_ref : (worklist -> solution) FStarC_Effect.ref=
  FStarC_Effect.alloc
    (fun uu___ -> FStarC_Effect.failwith "No solver attached")
let solve_c_ref : (cprob -> worklist -> solution) FStarC_Effect.ref=
  FStarC_Effect.alloc
    (fun uu___ uu___1 -> FStarC_Effect.failwith "No solver attached")
let solve_t'_ref : (tprob -> worklist -> solution) FStarC_Effect.ref=
  FStarC_Effect.alloc
    (fun uu___ uu___1 -> FStarC_Effect.failwith "No solver attached")
let init_refs (solve : worklist -> solution)
  (solve_c : cprob -> worklist -> solution)
  (solve_t' : tprob -> worklist -> solution) : unit=
  FStarC_Effect.op_Colon_Equals solve_ref solve;
  FStarC_Effect.op_Colon_Equals solve_c_ref solve_c;
  FStarC_Effect.op_Colon_Equals solve_t'_ref solve_t'
let solve (wl : worklist) : solution=
  let uu___ = FStarC_Effect.op_Bang solve_ref in uu___ wl
let solve_c (cp : cprob) (wl : worklist) : solution=
  let uu___ = FStarC_Effect.op_Bang solve_c_ref in uu___ cp wl
let solve_t' (tp : tprob) (wl : worklist) : solution=
  let uu___ = FStarC_Effect.op_Bang solve_t'_ref in uu___ tp wl
let solve_t (problem : tprob) (wl : worklist) : solution=
  def_check_prob "solve_t" (FStarC_TypeChecker_Common.TProb problem);
  (let uu___1 = compress_tprob wl problem in solve_t' uu___1 wl)
let defer_to_user_tac (orig : FStarC_TypeChecker_Common.prob)
  (reason : Prims.string) (wl : worklist) : solution=
  (let uu___1 = FStarC_Effect.op_Bang dbg_Rel in
   if uu___1
   then
  ...
  (let wl1 = solve_prob orig FStar_Pervasives_Native.None [] wl in
   let wl2 =
     let uu___1 =
       let uu___2 =
         ...
         ((wl1.ctr), FStarC_TypeChecker_Common.Deferred_to_user_tac, uu___3,
           orig) in
       FStarC_Class_Listlike.cons (FStarC_CList.listlike_clist ()) uu___2
         wl1.wl_deferred_to_tac in
     {
       attempting = (wl1.attempting);
       wl_deferred = (wl1.wl_deferred);
       wl_deferred_to_tac = uu___1;
   ...
   solve wl2)
let maybe_defer_to_user_tac
  (prob : FStarC_Syntax_Syntax.typ FStarC_TypeChecker_Common.problem)
  (reason : Prims.string) (wl : worklist) : solution=
  ...
  | uu___ ->
      let uu___1 =
        defer_lit FStarC_TypeChecker_Common.Deferred_flex reason
          (FStarC_TypeChecker_Common.TProb prob) wl in
      solve uu___1
let giveup_or_defer (orig : FStarC_TypeChecker_Common.prob) (wl : worklist)
  (reason : FStarC_TypeChecker_Common.deferred_reason) (msg : lstring) :
  solution=
  if wl.defer_ok = DeferAny
  then
    ((let uu___1 = FStarC_Effect.op_Bang dbg_Rel in
...
let giveup_or_defer_flex_flex (orig : FStarC_TypeChecker_Common.prob)
  (wl : worklist) (reason : FStarC_TypeChecker_Common.deferred_reason)
  (msg : lstring) : solution=
...
let try_solve_probs_without_smt (wl : worklist)
  (probs : worklist -> (FStarC_TypeChecker_Common.probs * worklist)) :
...
let try_solve_without_smt_or_else (wl : worklist)
...
let try_solve_then_or_else (wl : worklist) (try_solve : worklist -> solution)
  (then_solve : worklist -> solution) (else_solve : worklist -> solution) :
  solution=
  let empty_wl =
    {
      attempting = [];
  ...
  | Success (uu___1, defer_to_tac, imps) ->
      let wl1 =
        extend_wl wl
          ...
          defer_to_tac imps in
      then_solve wl1
  | Failed (p, s) -> (FStarC_Syntax_Unionfind.rollback tx; else_solve wl)
let solve_one_universe_eq (orig : FStarC_TypeChecker_Common.prob)
  (u1 : FStarC_Syntax_Syntax.universe) (u2 : FStarC_Syntax_Syntax.universe)
  (wl : worklist) : solution=
  let uu___ = solve_universe_eq (p_pid orig) wl u1 u2 in
  match uu___ with
  | USolved wl1 ->
      let uu___1 = solve_prob orig FStar_Pervasives_Native.None [] wl1 in
      solve uu___1
  | UFailed msg -> giveup wl msg orig
  | UDeferred wl1 ->
      let uu___1 =
        defer_lit FStarC_TypeChecker_Common.Deferred_univ_constraint "" orig
          wl1 in
      solve uu___1
let solve_maybe_uinsts (orig : FStarC_TypeChecker_Common.prob)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term)
  (wl : worklist) : univ_eq_sol=
  ...
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t1.FStarC_Syntax_Syntax.pos "solve_maybe_uinsts.whnf1" env t1;
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t2.FStarC_Syntax_Syntax.pos "solve_maybe_uinsts.whnf2" env t2;
  (let rec inspect retry t11 t21 =
     match ((t11.FStarC_Syntax_Syntax.n), (t21.FStarC_Syntax_Syntax.n)) with
     | (FStarC_Syntax_Syntax.Tm_uinst
        ...
        ({ FStarC_Syntax_Syntax.n = FStarC_Syntax_Syntax.Tm_fvar g;
         ...
         us2)) -> let b = FStarC_Syntax_Syntax.fv_eq f g in aux wl us1 us2
     | (FStarC_Syntax_Syntax.Tm_fvar uu___2, FStarC_Syntax_Syntax.Tm_fvar
        uu___3) -> USolved wl
     | uu___2 when retry ->
     ...
     | (FStarC_Syntax_Syntax.Tm_uinst uu___2, uu___3) ->
         FStarC_Effect.failwith "Impossible: expect head symbols to match"
     | (uu___2, FStarC_Syntax_Syntax.Tm_uinst uu___3) ->
         FStarC_Effect.failwith "Impossible: expect head symbols to match"
     | uu___2 -> USolved wl in
   inspect true t1 t2)
let imitate_arrow (orig : FStarC_TypeChecker_Common.prob) (wl : worklist)
  (lhs : flex_t) (bs_lhs : FStarC_Syntax_Syntax.binders)
  (t_res_lhs : FStarC_Syntax_Syntax.term)
  (rel : FStarC_TypeChecker_Common.rel) (arrow : FStarC_Syntax_Syntax.term) :
  solution=
  let bs_lhs_args =
    FStarC_List.map
      (fun uu___ ->
         ...
         | { FStarC_Syntax_Syntax.binder_bv = x;
             ...
             FStarC_Syntax_Syntax.binder_positivity = uu___1;
             FStarC_Syntax_Syntax.binder_attrs = uu___2;_} ->
             let uu___3 = FStarC_Syntax_Syntax.bv_to_name x in (uu___3, i))
      bs_lhs in
  let uu___ = lhs in
  match uu___ with
  | Flex (uu___1, u_lhs, uu___2) ->
      let imitate_comp bs bs_terms c wl1 =
        let imitate_tot_or_gtot t f wl2 =
          ...
          | (k, uu___4) ->
              let uu___5 =
                copy_uvar u_lhs (FStarC_List.op_At bs_lhs bs) k wl2 in
              (match uu___5 with
               | (uu___6, u, wl3) -> let uu___7 = f u in (uu___7, wl3)) in
        match c.FStarC_Syntax_Syntax.n with
        | FStarC_Syntax_Syntax.Comp ct when
            FStarC_Syntax_Util.is_bare_tot_or_gtot_comp c ->
            imitate_tot_or_gtot ct.FStarC_Syntax_Syntax.result_typ
              (fun t ->
              ...
              FStarC_List.fold_right
                (fun uu___4 uu___5 ->
                   ...
                   | ((a, i), (out_args, wl2)) ->
                       let uu___6 =
                         let uu___7 =
                           let uu___8 = FStarC_Syntax_Util.type_u () in
                           FStar_Pervasives_Native.fst uu___8 in
                         copy_uvar u_lhs [] uu___7 wl2 in
                       (match uu___6 with
                        | (uu___7, t_a, wl3) ->
                            let uu___8 = copy_uvar u_lhs bs t_a wl3 in
                            (match uu___8 with
                             | (uu___9, a', wl4) ->
                                 (((a', i) :: out_args), wl4))))
                [FStarC_Syntax_Syntax.as_arg
                   ct.FStarC_Syntax_Syntax.result_typ] ([], wl1) in
            (match uu___3 with
             | (out_args, wl2) ->
                 let nodec flags =
                   FStarC_List.filter
                 ...
                 let ct' =
                   let uu___4 = nodec ct.FStarC_Syntax_Syntax.flags in
                   {
                     FStarC_Syntax_Syntax.effect_name =
                       (ct.FStarC_Syntax_Syntax.effect_name);
                     FStarC_Syntax_Syntax.result_typ =
                       (FStar_Pervasives_Native.fst (FStarC_List.hd out_args));
                     FStarC_Syntax_Syntax.flags = uu___4;
                     FStarC_Syntax_Syntax.source_effect_name =
                       (ct.FStarC_Syntax_Syntax.source_effect_name)
                   } in
                 ({
                    FStarC_Syntax_Syntax.n = (FStarC_Syntax_Syntax.Comp ct');
                        ...
                        let uu___5 =
                          let uu___6 =
                            FStarC_Syntax_Util.abs bs_lhs lhs'
                              (FStar_Pervasives_Native.Some
                                 (FStarC_Syntax_Util.residual_tot t_res_lhs)) in
                          (u_lhs, uu___6) in
                        TERM uu___5 in
                      let uu___5 =
                        mk_t_problem wl2 [] orig lhs' rel arrow
                          FStar_Pervasives_Native.None "arrow imitation" in
                      (match uu___5 with
                       | (sub_prob, wl3) ->
                           let uu___6 =
                             let uu___7 =
             ...
             | { FStarC_Syntax_Syntax.binder_bv = x;
                 ...
                 let uu___4 =
                   let uu___5 =
                     ...
                     FStar_Pervasives_Native.fst uu___6 in
                   copy_uvar u_lhs (FStarC_List.op_At bs_lhs bs) uu___5 wl1 in
                 (match uu___4 with
                  | (_ctx_u_x, u_x, wl2) ->
                      let y =
                        FStarC_Syntax_Syntax.new_bv
                          (FStar_Pervasives_Native.Some
                             (FStarC_Syntax_Syntax.range_of_bv x)) u_x in
                      let b =
                        FStarC_Syntax_Syntax.mk_binder_with_attrs y imp pqual
                          attrs in
                      let uu___5 =
                        let uu___6 =
                          let uu___7 =
                            FStarC_Syntax_Util.arg_of_non_null_binder b in
                          [uu___7] in
                        FStarC_List.op_At bs_terms uu___6 in
                      aux (FStarC_List.op_At bs [b]) uu___5 formals2 wl2) in
           let uu___4 = occurs_check u_lhs arrow in
           (match uu___4 with
            | (uu___5, occurs_ok, msg) ->
                if Prims.not occurs_ok
                then
                  let uu___6 =
                    mklstr
                      (fun uu___7 ->
                         let uu___8 = FStarC_Option.must msg in
                         Prims.strcat "occurs-check failed: " uu___8) in
                  giveup_or_defer orig wl
                    FStarC_TypeChecker_Common.Deferred_occur_check_failed
                    uu___6
                else aux [] [] formals wl))
let solve_rigid_flex_or_flex_rigid_subtyping
  (rank1 : FStarC_TypeChecker_Common.rank_t) (tp : tprob) (wl : worklist) :
  solution=
  ...
  (let flip = rank1 = FStarC_TypeChecker_Common.Flex_rigid in
   let meet_or_join op ts wl1 =
     let eq_prob t1 t2 wl2 =
       let uu___1 =
         let uu___2 = p_env wl2 (FStarC_TypeChecker_Common.TProb tp) in
         new_problem wl2 uu___2 t1 FStarC_TypeChecker_Common.EQ t2
           FStar_Pervasives_Native.None t1.FStarC_Syntax_Syntax.pos
           "join/meet refinements" in
       match uu___1 with
       | (p, wl3) ->
           (def_check_prob "meet_or_join" (FStarC_TypeChecker_Common.TProb p);
     ...
     let refinement_of_flex t =
       ...
       | FStarC_Syntax_Syntax.Tm_refine
           ...
           let uu___3 =
             ...
             uu___4.FStarC_Syntax_Syntax.n in
           (match uu___3 with
            | FStarC_Syntax_Syntax.Tm_uvar (u, uu___4) ->
                let this_flex =
                  if flip
                ...
                let uu___5 =
                  let uu___6 =
                    let uu___7 =
                      let uu___8 =
                        FStarC_Syntax_Util.head_and_args_full this_flex in
                      FStar_Pervasives_Native.fst uu___8 in
                    FStarC_Syntax_Subst.compress uu___7 in
                  uu___6.FStarC_Syntax_Syntax.n in
                (match uu___5 with
                 | FStarC_Syntax_Syntax.Tm_uvar (u', uu___6) ->
                     let uu___7 =
     ...
     let pairwise t1 t2 wl2 =
       ...
       (let uu___2 =
          let uu___3 = p_env wl2 (FStarC_TypeChecker_Common.TProb tp) in
          head_matches_delta uu___3 tp.FStarC_TypeChecker_Common.logical
            wl2.smt_ok t1 t2 in
        match uu___2 with
        | (mr, ts1) ->
            let mr1 =
              match mr with
              | MisMatch uu___3 when
                  let uu___4 = refinement_of_flex t1 in
                  if uu___4 then true else refinement_of_flex t2 ->
                  HeadMatch false
              | uu___3 -> mr in
            (match mr1 with
             | HeadMatch true ->
             ...
             | FullMatch ->
                 (match ts1 with
                  ...
                  | FStar_Pervasives_Native.Some (t11, t21) -> (t11, [], wl2))
             | HeadMatch false ->
                 let uu___3 =
                   match ts1 with
                 ...
                 (match uu___3 with
                  | (t11, t21) ->
                      let try_eq_ex eq_norm_heuristic_ok t12 t22 wl3 =
                        let uu___4 =
                          FStarC_Syntax_Util.head_and_args_full t12 in
                        match uu___4 with
                        | (t1_hd, t1_args) ->
                            let uu___5 =
                              FStarC_Syntax_Util.head_and_args_full t22 in
                            (match uu___5 with
                             | (t2_hd, t2_args) ->
                                 if
                                   (FStarC_List.length t1_args) <>
                                     (FStarC_List.length t2_args)
                                 then FStar_Pervasives_Native.None
                                 else
                                   (let uu___6 =
                                      FStarC_List.fold_left2
                                        (fun uu___7 uu___8 uu___9 ->
                                           match (uu___7, uu___8, uu___9)
                                           with
                                           | ((probs, wl4), (a1, uu___10),
                                              (a2, uu___11)) ->
                                               let uu___12 =
                                               ...
                                               (match uu___12 with
                                                | (p, wl5) ->
                                                    ((p :: probs), wl5)))
                                        ([], wl3)
                                        ((FStarC_Syntax_Syntax.as_arg t1_hd)
                                        :: t1_args)
                                    ...
                                    | (probs, wl4) ->
                                        ...
                                        let tx =
                                          FStarC_Syntax_Unionfind.new_transaction
                                            () in
                                        let uu___7 = solve wl' in
                                        (match uu___7 with
                                         | Success
                                             (uu___8, defer_to_tac, imps) ->
                                             let uu___9 =
                                               extend_wl wl4
                                                 (FStarC_Class_Listlike.empty
                                                    (FStarC_CList.listlike_clist
                                         ...
                                         | Failed uu___8 ->
                                             (FStarC_Syntax_Unionfind.rollback
                                                tx;
                                              FStar_Pervasives_Native.None)))) in
                      let try_eq t12 t22 wl3 = try_eq_ex true t12 t22 wl3 in
                      let combine t12 t22 wl3 =
                        let env =
                          p_env wl3 (FStarC_TypeChecker_Common.TProb tp) in
                        let uu___4 =
                          base_and_refinement_maybe_delta false env t12 in
                        match uu___4 with
                        | (t1_base, p1_opt) ->
                            let uu___5 =
                              base_and_refinement_maybe_delta false env t22 in
                            (match uu___5 with
                             | (t2_base, p2_opt) ->
                                 let same_formula phi1 phi2 wl4 =
                                   let uu___6 =
                                     FStarC_Syntax_Util.term_eq phi1 phi2 in
                                   if uu___6
                                   then (true, wl4)
                                   else
                                     (let uu___7 =
                                        try_eq_ex false phi1 phi2 wl4 in
                                      match uu___7 with
                                      | FStar_Pervasives_Native.Some wl5 ->
                                          (true, wl5)
                                      | FStar_Pervasives_Native.None ->
                                          (false, wl4)) in
                                 let combine_refinements may_widen t_base
                                   p1_opt1 p2_opt1 wl4 =
                                   match op with
                                   | FStar_Pervasives_Native.None ->
                                       (t_base, wl4)
                                   | FStar_Pervasives_Native.Some op1 ->
                                       let refine x t =
                                         let uu___6 =
                                           FStarC_Syntax_Util.is_t_true t in
                                         if uu___6
                                         then x.FStarC_Syntax_Syntax.sort
                                         else FStarC_Syntax_Util.refine x t in
                                           ...
                                           (y, phi2)) ->
                                            ...
                                            let env_x =
                                              FStarC_TypeChecker_Env.push_bv
                                                env x1 in
                                            let uu___6 =
                                              same_formula phi11 phi21 wl4 in
                                            (match uu___6 with
                                             | (eq12, wl5) ->
                                                 let phi =
                                                   if eq12
                                        ...
                                        | (FStar_Pervasives_Native.Some
                                           ...
                                           FStar_Pervasives_Native.None) ->
                                            ...
                                            let uu___6 =
                                              ...
                                              refine x1 uu___7 in
                                            (uu___6, wl4)
                                        | uu___6 -> (t_base, wl4)) in
                                 let uu___6 = try_eq t1_base t2_base wl3 in
                                 (match uu___6 with
                                  | FStar_Pervasives_Native.Some wl4 ->
                                      let uu___7 =
                                        combine_refinements true t1_base
                                          p1_opt p2_opt wl4 in
                                      (match uu___7 with
                                       | (t, wl5) -> (t, [], wl5))
                                  | FStar_Pervasives_Native.None ->
                                      let uu___7 =
                                        base_and_refinement_maybe_delta true
                                          env t12 in
                                      (match uu___7 with
                                       | (t1_base1, p1_opt1) ->
                                           let uu___8 =
                       ...
                       | (t12, ps, wl3) ->
                           ((let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                             ...
                             then
                               let uu___7 =
                                 FStarC_Class_Show.show
                                   FStarC_Syntax_Print.showable_term t12 in
                               FStarC_Format.print1
                                 "pairwise fallback2 succeeded: %s" uu___7
                             else ());
                            (t12, ps, wl3)))))) in
     let rec aux state ts1 =
       let uu___1 = state in
       match uu___1 with
       | (out, probs, wl2) ->
           (match ts1 with
            ...
            | t::ts2 ->
                ...
                (match uu___2 with
                 | (out1, probs', wl3) ->
                     aux (out1, (FStarC_List.op_At probs probs'), wl3) ts2)) in
     aux ((FStarC_List.hd ts), [], wl1) (FStarC_List.tl ts) in
   let uu___1 =
     if flip
     then
       ((tp.FStarC_TypeChecker_Common.lhs),
   ...
   | (this_flex, this_rigid) ->
       ...
       (match uu___2 with
        | FStarC_Syntax_Syntax.Tm_arrow uu___3 ->
            let uu___4 =
              FStarC_Syntax_Util.arrow_formals_comp_ln_strict this_rigid in
            (match uu___4 with
             | (_bs, comp) ->
                 let uu___5 = FStarC_Syntax_Util.is_tot_or_gtot_comp comp in
                 if uu___5
                 then
                   let uu___6 = destruct_flex_t this_flex wl in
                   (match uu___6 with
                    | (flex, wl1) ->
                        let uu___7 = quasi_pattern wl1.tcenv flex in
                        (match uu___7 with
                         | FStar_Pervasives_Native.None ->
                             giveup_lit wl1
                         ...
                         | FStar_Pervasives_Native.Some (flex_bs, flex_t1) ->
                             ((let uu___9 = FStarC_Effect.op_Bang dbg_Rel in
                               if uu___9
                               then
                                 let uu___10 =
                                   FStarC_Class_Show.show
                              ...
                              imitate_arrow
                                (FStarC_TypeChecker_Common.TProb tp) wl1 flex
                                flex_bs flex_t1
                                tp.FStarC_TypeChecker_Common.relation
                                this_rigid)))
                 else
        ...
        | uu___3 ->
            ((let uu___5 = FStarC_Effect.op_Bang dbg_Rel in
             ...
             (let uu___5 = FStarC_Syntax_Util.head_and_args_full this_flex in
              match uu___5 with
              | (u, _args) ->
                  let env = p_env wl (FStarC_TypeChecker_Common.TProb tp) in
                  let uu___6 =
                  ...
                  (match uu___6 with
                   | FStarC_Syntax_Syntax.Tm_uvar (ctx_uvar, _subst) ->
                       let equiv t =
                         let uu___7 = FStarC_Syntax_Util.head_and_args_full t in
                         match uu___7 with
                         | (u', uu___8) ->
                             let uu___9 =
                           ...
                           (fun uu___8 ->
                              ...
                              | FStarC_TypeChecker_Common.TProb tp1 ->
                                  ...
                                  (match tp2.FStarC_TypeChecker_Common.rank
                                   with
                                   | FStar_Pervasives_Native.Some rank' when
                                       rank1 = rank' ->
                                       if flip
                                       then
                                         equiv
                            ...
                            let bounds_typs1 =
                              ...
                              then bounds_typs
                                ...
                                (let allowed =
                                          ...
                                          let uu___9 =
                                            let uu___10 =
                                              ...
                                              FStarC_Syntax_Subst.subst'
                                                _subst uu___11 in
                                            FStarC_Syntax_Free.names uu___10 in
                                          FStarC_Class_Setlike.elems
                                            (FStarC_FlatSet.setlike_flat_set
                                 ...
                                 let out_of_scope t =
                                   let uu___8 =
                                     let uu___9 = FStarC_Syntax_Free.names t in
                                     FStarC_Class_Setlike.elems
                                       (FStarC_FlatSet.setlike_flat_set
                                          FStarC_Syntax_Syntax.ord_bv) uu___9 in
                                   FStarC_Util.for_some
                                     (fun y ->
                                        let uu___9 =
                                          FStarC_Util.for_some
                                            (fun z ->
                                               FStarC_Syntax_Syntax.bv_eq y z)
                                            allowed in
                                        Prims.not uu___9) uu___8 in
                                 let rec weaken t =
                                   let uu___8 =
                                     let uu___9 = out_of_scope t in
                                     Prims.not uu___9 in
                                   if uu___8
                                   then t
                                   else
                                     (let uu___9 =
                                        base_and_refinement_maybe_delta true
                                          env t in
                                      match uu___9 with
                                      | (base, FStar_Pervasives_Native.Some
                                         uu___10) -> weaken base
                                      | uu___10 -> t) in
                                 FStarC_List.map weaken bounds_typs) in
                            let lower_bound_typs uu___8 =
                              FStarC_List.collect
                                (fun uu___9 ->
                                   match uu___9 with
                                   | FStarC_TypeChecker_Common.TProb tp1 ->
                                       ...
                                       (match tp2.FStarC_TypeChecker_Common.rank
                                        ...
                                        | FStar_Pervasives_Native.Some
                                            ...
                                            let uu___10 =
                                              whnf env
                                                tp2.FStarC_TypeChecker_Common.lhs in
                                            [uu___10]
                                        | uu___10 -> [])
                                   | uu___10 -> []) wl.attempting in
                            let deferred_upper_bound_typs uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  FStarC_CList.map
                                    (fun uu___11 ->
                                       match uu___11 with
                                       | (uu___12, uu___13, uu___14, p) -> p)
                                    wl.wl_deferred in
                                FStarC_Class_Listlike.to_list
                                  (FStarC_CList.listlike_clist ()) uu___10 in
                              FStarC_List.collect
                                (fun uu___10 ->
                                   match uu___10 with
                                   | FStarC_TypeChecker_Common.TProb tp1 ->
                                       ...
                                       (match tp2.FStarC_TypeChecker_Common.rank
                                        ...
                                        | FStar_Pervasives_Native.Some
                                            ...
                                            let uu___11 =
                                              whnf env
                                                tp2.FStarC_TypeChecker_Common.rhs in
                                            [uu___11]
                                        | uu___11 -> [])
                                   | uu___11 -> []) uu___9 in
                            let is_refined t =
                              ...
                              | uu___9 -> false in
                            let prefer_lower_bounds uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  if flip
                                  then
                                    FStarC_Util.for_some is_refined
                                      bounds_typs1
                                  else false in
                                if uu___10
                                then
                                  let uu___11 = lower_bound_typs () in
                                  match uu___11 with
                                  | hd::tl -> true
                                  | uu___12 -> false
                                else false in
                              ...
                              then
                                let uu___10 =
                                  let uu___11 =
                                    has_typeclass_constraint ctx_uvar wl in
                                  if uu___11
                                  then true
                                  else
                                    (let uu___12 = lower_bound_typs () in
                                     FStarC_Util.for_some is_refined uu___12) in
                                (if uu___10
                                 then true
                                 else
                                   (let uu___11 =
                                      let uu___12 =
                                        deferred_upper_bound_typs () in
                                      FStarC_List.op_At bounds_typs1 uu___12 in
                                    FStarC_Util.for_some
                                      (fun t ->
                                         let uu___12 = is_refined t in
                                         Prims.not uu___12) uu___11))
                              else false in
                            let uu___8 = prefer_lower_bounds () in
                            if uu___8
                            then
                              let uu___9 =
                                defer_lit
                                  FStarC_TypeChecker_Common.Deferred_flex
                                  "solving a flex variable from its lower bounds first"
                                  (FStarC_TypeChecker_Common.TProb tp) wl in
                              solve uu___9
                            else
                              (let uu___9 =
                                 let uu___10 =
                                   let uu___11 =
                                     has_typeclass_constraint ctx_uvar wl in
                                   if uu___11 then Prims.not flip else false in
                                 if uu___10
                                 then (true, FStar_Pervasives_Native.None)
                                   ...
                                   (false,
                                     (FStar_Pervasives_Native.Some
                                        (if flip
                                         then FStarC_Syntax_Util.mk_conj_simp
                                         else FStarC_Syntax_Util.mk_disj_simp))) in
                               match uu___9 with
                               | (widen, meet_or_join_op) ->
                                   let meet_or_join_op1 = meet_or_join_op in
                                   let implicits_before_meet =
                                     wl.wl_implicits in
                                   let uu___10 =
                                     match bounds_typs1 with
                                     | t::[] ->
                                         if widen
                                         then
                                           let t' =
                                          ...
                                          let uu___12 =
                                            let uu___13 =
                                              p_env wl1
                                                (FStarC_TypeChecker_Common.TProb
                                                   tp) in
                                            new_problem wl1 uu___13 bound1
                                              FStarC_TypeChecker_Common.EQ
                                              this_flex
                                              FStar_Pervasives_Native.None
                                              tp.FStarC_TypeChecker_Common.loc
                   ...
                   | uu___7 ->
                       let uu___8 =
                         ...
                         FStarC_Format.fmt2
                           ...
                           uu___9 uu___10 in
                       FStarC_Effect.failwith uu___8)))))
let rec solve_t_flex_rigid_eq (orig : FStarC_TypeChecker_Common.prob)
  (wl : worklist)
  (lhs :
    (flex_t * (FStarC_Syntax_Syntax.subst_ts * FStarC_Syntax_Syntax.term)))
  (rhs : FStarC_Syntax_Syntax.term) : solution=
  (let uu___1 = FStarC_Effect.op_Bang dbg_Rel in
   if uu___1
   then
     let uu___2 =
  ...
  (let uu___1 =
     should_defer_flex_to_user_tac wl (FStar_Pervasives_Native.fst lhs) in
   if uu___1
   then
     defer_to_user_tac orig (flex_reason (FStar_Pervasives_Native.fst lhs))
       wl
   else
     (let mk_solution env lhs1 bs rhs1 =
        ...
        | Flex (uu___3, ctx_u, args) ->
            let uu___4 =
              ...
              let bv_not_free_in_args x args1 =
                FStarC_Util.for_all (bv_not_free_in_arg x) args1 in
                   ...
                   FStar_Pervasives_Native.Some a) ->
                    ...
                    then
                      FStarC_Syntax_Util.eqlist
                        (fun x y ->
                           let uu___6 =
                             FStarC_TypeChecker_TermEqAndSimplify.eq_tm env x
                               y in
                           uu___6 =
                    ...
                    (match uu___5 with
                     | FStarC_Syntax_Syntax.Tm_name x when
                         let uu___6 =
                           ...
                           then binder_matches_aqual b aq
                           else false in
                         if uu___6
                         then
                           bv_not_free_in_args
                             b.FStarC_Syntax_Syntax.binder_bv rhs_tl
                         else false -> remove_matching_prefix lhs_tl rhs_tl
                     | uu___6 -> (lhs_binders, rhs_args)) in
              let uu___5 = FStarC_Syntax_Util.head_and_args_full rhs1 in
              match uu___5 with
              | (rhs_hd, rhs_args) ->
                  let uu___6 =
                    let uu___7 =
                      remove_matching_prefix (FStarC_List.rev bs_orig)
                        (FStarC_List.rev rhs_args) in
                    match uu___7 with
                    | (bs_rev, args_rev) ->
                        ((FStarC_List.rev bs_rev),
                          (FStarC_List.rev args_rev)) in
                  (match uu___6 with
                   | (bs1, rhs_args1) ->
                       let uu___7 =
                         FStarC_Syntax_Syntax.mk_Tm_app rhs_hd rhs_args1
            ...
            (match uu___4 with
             | (bs1, rhs2) ->
                 let sol =
                   ...
                   | [] -> rhs2
                   | uu___5 ->
                       let uu___6 = FStarC_Syntax_Util.ctx_uvar_typ ctx_u in
                       let uu___7 = sn_binders env bs1 in
                       u_abs uu___6 uu___7 rhs2 in
                 [TERM (ctx_u, sol)]) in
      let try_quasi_pattern orig1 env wl1 lhs1 rhs1 =
        (let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
         if uu___3
         then FStarC_Format.print_string "try_quasi_pattern\n"
         else ());
        (let uu___3 = quasi_pattern env lhs1 in
         match uu___3 with
         | FStar_Pervasives_Native.None ->
             ((FStar_Pervasives.Inl "Not a quasi-pattern"), wl1)
         | FStar_Pervasives_Native.Some (bs, uu___4) ->
             let uu___5 = lhs1 in
             (match uu___5 with
              | Flex (t_lhs, ctx_u, args) ->
                  let uu___6 = occurs_check ctx_u rhs1 in
                  (match uu___6 with
                   | (uvars, occurs_ok, msg) ->
                       if Prims.not occurs_ok
                       then
                         let uu___7 =
                           let uu___8 =
                             let uu___9 = FStarC_Option.must msg in
                             Prims.strcat
                               "quasi-pattern, occurs-check failed: " uu___9 in
                           FStar_Pervasives.Inl uu___8 in
                         (uu___7, wl1)
                       else
                         (let fvs_lhs =
                            binders_as_bv_set
                          ...
                          let uu___7 =
                            let uu___8 =
                              FStarC_Class_Setlike.subset
                                (FStarC_FlatSet.setlike_flat_set
                                   FStarC_Syntax_Syntax.ord_bv) fvs_rhs
                                fvs_lhs in
                            Prims.not uu___8 in
                          if uu___7
                          then
                            ...
                            (let uu___8 =
                               let uu___9 = mk_solution env lhs1 bs rhs1 in
                               FStar_Pervasives.Inr uu___9 in
                             let uu___9 =
                               restrict_all_uvars env ctx_u [] uvars wl1 in
                             (uu___8, uu___9)))))) in
      let imitate_app orig1 env wl1 lhs1 bs_lhs t_res_lhs rhs1 =
        let uu___2 = FStarC_Syntax_Util.head_and_args_full rhs1 in
        match uu___2 with
        | (rhs_hd, args) ->
            let uu___3 = FStarC_Util.prefix args in
            (match uu___3 with
                  ...
                  | Flex (t_lhs, u_lhs, _lhs_args) ->
                      let uu___5 =
                        ...
                        | (t_last_arg, uu___7) ->
                            let uu___8 =
                              let b =
                                FStarC_Syntax_Syntax.null_binder t_last_arg in
                              let uu___9 =
                                let uu___10 =
                                  FStarC_Syntax_Syntax.mk_Total t_res_lhs in
                                FStarC_Syntax_Util.arrow [b] uu___10 in
                              copy_uvar u_lhs (FStarC_List.op_At bs_lhs [b])
                                uu___9 wl1 in
                            (match uu___8 with
                             | (uu___9, lhs', wl2) ->
                                 let uu___10 =
                                   copy_uvar u_lhs bs_lhs t_last_arg wl2 in
                                 (match uu___10 with
                                  | (uu___11, lhs'_last_arg, wl3) ->
                      ...
                      (match uu___5 with
                       | (lhs', lhs'_last_arg, wl2) ->
                           let sol =
                             let uu___6 =
                               let uu___7 =
                                 let uu___8 =
                                   let uu___9 =
                                     FStarC_Syntax_Syntax.mk_Tm_app lhs'
                                       [(lhs'_last_arg,
                                          (FStar_Pervasives_Native.snd
                                             last_arg_rhs))]
                                       t_lhs.FStarC_Syntax_Syntax.pos in
                                   FStarC_Syntax_Util.abs bs_lhs uu___9
                                     (FStar_Pervasives_Native.Some
                           ...
                           let uu___6 =
                             ...
                             | (p1, wl3) ->
                                 let uu___8 =
                                   mk_t_problem wl3 [] orig1 lhs'_last_arg
                                     FStarC_TypeChecker_Common.EQ
                                     (FStar_Pervasives_Native.fst
                                        last_arg_rhs)
                                     FStar_Pervasives_Native.None
                           ...
                           (match uu___6 with
                            | (sub_probs, wl3) ->
                                let uu___7 =
                                  let uu___8 =
                                    solve_prob orig1
                                      FStar_Pervasives_Native.None sol wl3 in
                                  attempt sub_probs uu___8 in
                                solve uu___7)))) in
      let imitate orig1 env wl1 lhs1 rhs1 =
        (let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
         if uu___3 then FStarC_Format.print_string "imitate\n" else ());
        (let is_app rhs2 =
           let uu___3 = FStarC_Syntax_Util.head_and_args_full rhs2 in
           match uu___3 with
           | (uu___4, args) ->
               (match args with | [] -> false | uu___5 -> true) in
         let is_arrow rhs2 =
           let uu___3 =
             let uu___4 = FStarC_Syntax_Subst.compress rhs2 in
             uu___4.FStarC_Syntax_Syntax.n in
           match uu___3 with
           | FStarC_Syntax_Syntax.Tm_arrow uu___4 -> true
           | uu___4 -> false in
         let uu___3 = quasi_pattern env lhs1 in
         match uu___3 with
         | FStar_Pervasives_Native.None ->
             let msg =
               mklstr
                 (fun uu___4 ->
                    let uu___5 = prob_to_string env orig1 in
                    FStarC_Format.fmt1
         ...
         | FStar_Pervasives_Native.Some (bs_lhs, t_res_lhs) ->
             let uu___4 = is_app rhs1 in
             if uu___4
             then imitate_app orig1 env wl1 lhs1 bs_lhs t_res_lhs rhs1
             else
               (let uu___5 = is_arrow rhs1 in
                if uu___5
                then
                  ...
                  (let msg =
                     mklstr
                       (fun uu___6 ->
                          let uu___7 = prob_to_string env orig1 in
                          FStarC_Format.fmt1
      ...
      let try_first_order orig1 env wl1 lhs1 rhs1 =
          ...
          (let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
           ...
           then
             let extra_msg =
               ...
               | FStar_Pervasives_Native.None -> ""
               | FStar_Pervasives_Native.Some l -> FStarC_Thunk.force l in
        ...
        (let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
         if uu___3
         then
           let uu___4 = flex_t_to_string lhs1 in
           let uu___5 =
             FStarC_Class_Show.show FStarC_Syntax_Print.showable_term rhs1 in
        ...
        (let uu___3 = lhs1 in
         ...
         | Flex (_t1, ctx_uv, args_lhs) ->
             let n_args_lhs = FStarC_List.length args_lhs in
             let uu___4 = FStarC_Syntax_Util.head_and_args_full rhs1 in
             (match uu___4 with
              | (head, args_rhs) ->
                  let n_args_rhs = FStarC_List.length args_rhs in
                  ...
                  then
                    ...
                    (let i = n_args_rhs - n_args_lhs in
                     let uu___5 = FStarC_List.splitAt i args_rhs in
                     match uu___5 with
                     | (prefix, args_rhs1) ->
                         let head1 =
                           FStarC_Syntax_Syntax.mk_Tm_app head prefix
                             head.FStarC_Syntax_Syntax.pos in
                         let uu___6 = occurs_check ctx_uv head1 in
                         (match uu___6 with
                          | (uvars_head, occurs_ok, uu___7) ->
                              if Prims.not occurs_ok
                              then
                                ...
                                (let uu___8 =
                                 ...
                                 if uu___8
                                 then
                                   inapplicable "free name inclusion failed"
                                     FStar_Pervasives_Native.None
                                 else
                                   (let uu___9 =
                                      env.FStarC_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term
                                    ...
                                    | (t_head, uu___10) ->
                                        ...
                                        let solve_sub_probs_if_head_types_equal
                                          ...
                                          let sol = [TERM (ctx_uv, head1)] in
                                          let wl3 =
                                            restrict_all_uvars env ctx_uv []
                                              head_uvars_to_restrict wl2 in
                                          let wl4 =
                                            solve_prob orig1
                                              FStar_Pervasives_Native.None
                                              sol wl3 in
                                        ...
                                        then
                                          ...
                                          ((let uu___13 =
                                           ...
                                           (let typ_equality_prob wl2 =
                                              ...
                                              | (p, wl3) -> ([p], wl3) in
                                            let uu___13 =
                                              try_solve_probs_without_smt wl1
                                                typ_equality_prob in
                                            match uu___13 with
                                            | FStar_Pervasives.Inl wl2 ->
                                                let uu___14 =
                                                  let uu___15 =
      ...
      | FStarC_TypeChecker_Common.SUB ->
          if wl.defer_ok = DeferAny
          then
            let uu___2 = FStarC_Thunk.mkv "flex-rigid subtyping" in
            giveup_or_defer orig wl FStarC_TypeChecker_Common.Deferred_flex
              uu___2
      ...
      | FStarC_TypeChecker_Common.EQ ->
          let uu___2 = lhs in
          (match uu___2 with
           | (Flex (uu___3, ctx_uv, uu___4), (lhs_subst, lhs_t_orig)) ->
               let is_subst_noop subst rhs1 =
                 match FStar_Pervasives_Native.fst subst with
                 | [] -> true
                 | []::[] -> true
                 | uu___5 ->
                     let uu___6 =
                       let uu___7 = FStarC_Syntax_Free.names rhs1 in
                       let uu___8 =
                         binders_as_bv_set
                           ctx_uv.FStarC_Syntax_Syntax.ctx_uvar_binders in
                       FStarC_Class_Setlike.subset
                         (FStarC_FlatSet.setlike_flat_set
                            FStarC_Syntax_Syntax.ord_bv) uu___7 uu___8 in
                     if uu___6
                     then
                       let uu___7 = FStarC_Syntax_Subst.subst' subst rhs1 in
                       FStarC_Syntax_Util.term_eq rhs1 uu___7
                     else false in
               let uu___5 =
                 let uu___6 = is_subst_noop lhs_subst rhs in
                 if uu___6
                 then ((FStar_Pervasives_Native.fst lhs), wl)
                 else destruct_flex_t lhs_t_orig wl in
               (match uu___5 with
                | (lhs1, wl1) ->
                    let uu___6 = lhs1 in
                    (match uu___6 with
                     | Flex (_t1, ctx_uv1, args_lhs) ->
                         let env = p_env wl1 orig in
                         let uu___7 =
                           pat_vars env
                             ctx_uv1.FStarC_Syntax_Syntax.ctx_uvar_binders
                             args_lhs in
                         (match uu___7 with
                          | FStar_Pervasives_Native.Some lhs_binders ->
                              ((let uu___9 = FStarC_Effect.op_Bang dbg_Rel in
                               ...
                               (let rhs1 = sn env rhs in
                                ...
                                let uu___9 = occurs_check ctx_uv1 rhs1 in
                                match uu___9 with
                                | (uvars, occurs_ok, msg) ->
                                    let uu___10 =
                                      if occurs_ok
                                      then ((uvars, occurs_ok, msg), rhs1)
                                        ...
                                        (let rhs2 =
                                           ...
                                           FStarC_TypeChecker_Normalize.normalize
                                             ...
                                             uu___11 rhs1 in
                                         let uu___11 =
                                           occurs_check ctx_uv1 rhs2 in
                                         (uu___11, rhs2)) in
                                    (match uu___10 with
                                     | ((uvars1, occurs_ok1, msg1), rhs2) ->
                                         let uu___11 =
                                           let uu___12 =
                                             term_is_uvar ctx_uv1 rhs2 in
                                           if uu___12
                                           then
                                             match args_lhs with
                                             | [] -> true
                                         ...
                                         then
                                           ...
                                           if Prims.not occurs_ok1
                                           then
                                             (let uu___12 =
                                                let uu___13 =
                                                  let uu___14 =
                                                    FStarC_Option.must msg1 in
                                                  Prims.strcat
                                                    "occurs-check failed: "
                                                    uu___14 in
                                                FStarC_Thunk.mkv uu___13 in
                                              giveup_or_defer orig wl1
                                                FStarC_TypeChecker_Common.Deferred_occur_check_failed
                                                uu___12)
                                           else
                                             (let uu___12 =
                                              ...
                                              then
                                                ...
                                                then
                                                  ...
                                                  imitate orig env wl1 lhs1
                                                    rhs2))))
                          | uu___8 ->
                              if wl1.defer_ok = DeferAny
                              then
                                let uu___9 = FStarC_Thunk.mkv "Not a pattern" in
                                giveup_or_defer orig wl1
                                  FStarC_TypeChecker_Common.Deferred_not_a_pattern
                                  uu___9
                              else
                                (let uu___9 =
                                   try_first_order orig env wl1 lhs1 rhs in
                                 match uu___9 with
                                 | FStar_Pervasives.Inr wl2 -> solve wl2
                                 | uu___10 ->
                                     let uu___11 =
                                       try_quasi_pattern orig env wl1 lhs1
                                         rhs in
                                     (match uu___11 with
                                      | (FStar_Pervasives.Inr sol, wl2) ->
                                          let uu___12 =
                                            solve_prob orig
                                              FStar_Pervasives_Native.None
                                              sol wl2 in
                                          solve uu___12
                                      | (FStar_Pervasives.Inl msg, uu___12)
                                          -> imitate orig env wl1 lhs1 rhs))))))))
let rec solve_t_flex_flex (env : FStarC_TypeChecker_Env.env_t)
  (orig : FStarC_TypeChecker_Common.prob) (wl : worklist) (lhs : flex_t)
  (rhs : flex_t) : solution=
  let should_run_meta_arg_tac flex =
    let uv = flex_uvar flex in
    let uu___ =
      let uu___1 = flex_uvar_has_meta_tac uv in
      if uu___1
      then
        let uu___2 =
          let uu___3 = FStarC_Syntax_Util.ctx_uvar_typ uv in
          has_free_uvars uu___3 in
        Prims.not uu___2
      else false in
    if uu___
    then
      let uu___1 =
        gamma_has_free_uvars uv.FStarC_Syntax_Syntax.ctx_uvar_gamma in
      Prims.not uu___1
    else false in
  ...
  | FStarC_TypeChecker_Common.EQ ->
      let uu___ =
        ...
        if uu___1 then true else should_defer_flex_to_user_tac wl rhs in
      if uu___
      then
        ...
        if
          ((wl.defer_ok = DeferAny) || (wl.defer_ok = DeferFlexFlexOnly)) &&
            ((Prims.not (is_flex_pat lhs)) || (Prims.not (is_flex_pat rhs)))
        then
          (let uu___1 = FStarC_Thunk.mkv "flex-flex non-pattern" in
           giveup_or_defer_flex_flex orig wl
             FStarC_TypeChecker_Common.Deferred_flex_flex_nonpattern uu___1)
        else
          (let uu___1 = should_run_meta_arg_tac lhs in
           if uu___1
           then run_meta_arg_tac_and_try_again lhs
           else
             (let uu___2 = should_run_meta_arg_tac rhs in
              if uu___2
              then run_meta_arg_tac_and_try_again rhs
                ...
                (let rec occurs_bs u bs =
                   ...
                   | b::bs1 ->
                       ...
                       if uu___3 then true else occurs_bs u bs1 in
                 let uu___3 = lhs in
                 match uu___3 with
                 | Flex (t_lhs, uu___4, args_lhs0) ->
                     let uu___5 = rhs in
                     (match uu___5 with
                      | Flex (t_rhs, uu___6, args_rhs0) ->
                          let uu___7 =
                            let uu___8 =
                          ...
                          then
                            ...
                            (let try_first_order_flex_flex uu___8 =
                               if
                                 (Prims.not
                                    (match args_lhs0 with
                                     | hd::tl -> true
                                     | uu___9 -> false))
                                   ||
                                   ((FStarC_List.length args_lhs0) <>
                                      (FStarC_List.length args_rhs0))
                               then FStar_Pervasives_Native.None
                               else
                                 (let uu___9 =
                                    FStarC_Syntax_Util.head_and_args_full
                                       ...
                                       | (hd_rhs, uu___12) ->
                                           ...
                                           let wl0 =
                                             solve_prob orig
                                               ...
                                               [] wl in
                                           let uu___13 =
                                             mk_t_problem wl0 [] orig hd_lhs
                                               FStarC_TypeChecker_Common.EQ
                                               hd_rhs
                                               FStar_Pervasives_Native.None
                                               "flex-flex first-order head" in
                                           (match uu___13 with
                                            | (hd_prob, wl01) ->
                                                let uu___14 =
                                                  FStarC_List.fold_left2
                                                     ...
                                                     let wl' =
                                                       {
                                                         ...
                                                         wl_deferred =
                                                           (FStarC_Class_Listlike.empty
                                                              (FStarC_CList.listlike_clist
                                                                 ()));
                                                         wl_deferred_to_tac =
                                                           (wl02.wl_deferred_to_tac);
                                                         ctr = (wl02.ctr);
                                                         defer_ok = NoDefer;
                                                         smt_ok = false;
                                                         umax_heuristic_ok =
                                                           (wl02.umax_heuristic_ok);
                                                         eq_norm_heuristic_ok
                                                           =
                                                           (wl02.eq_norm_heuristic_ok);
                                                         tcenv = (wl02.tcenv);
                                                         wl_implicits =
                                                           (FStarC_Class_Listlike.empty
                                                              (FStarC_CList.listlike_clist
                                                         ...
                                                         repr_subcomp_allowed
                                                           =
                                                           (wl02.repr_subcomp_allowed);
                                                         typeclass_variables
                                                           =
                                                           (wl02.typeclass_variables)
                                                       } in
                                                     let uu___15 = solve wl' in
                                                     (match uu___15 with
                                                      | Success
                                                          (uu___16,
                                                           defer_to_tac,
                                                      ...
                                                      | Failed uu___16 ->
                                                          (FStarC_Syntax_Unionfind.rollback
                                                             tx;
                                                           FStar_Pervasives_Native.None)))))) in
                             let uu___8 = try_first_order_flex_flex () in
                             match uu___8 with
                             | FStar_Pervasives_Native.Some wl1 -> solve wl1
                             | FStar_Pervasives_Native.None ->
                                 let try_solve_bare bare other =
                                   let uu___9 = bare in
                                   match uu___9 with
                                   | Flex (uu___10, u_b, args_b) ->
                                       let uu___11 = other in
                                       (match uu___11 with
                                        | Flex (t_o, uu___12, uu___13) ->
                                            if
                                              (match args_b with
                                               | hd::tl -> true
                                               | uu___14 -> false)
                                                   ...
                                                   then
                                                     ...
                                                     (let uu___16 =
                                                        let uu___17 =
                                                          ...
                                                          let uu___19 =
                                                            binders_as_bv_set
                                                              u_b.FStarC_Syntax_Syntax.ctx_uvar_binders in
                                                          FStarC_Class_Setlike.subset
                                                            (FStarC_FlatSet.setlike_flat_set
                                                               FStarC_Syntax_Syntax.ord_bv)
                                                            uu___18 uu___19 in
                                                        Prims.not uu___17 in
                                                      if uu___16
                                                      then
                                                        FStar_Pervasives_Native.None
                                                      else
                                 ...
                                 let bare_solution =
                                   if
                                     (is_flex_pat lhs) &&
                                       (Prims.not (is_flex_pat rhs))
                                   then try_solve_bare lhs rhs
                                   else
                                     if
                                       (is_flex_pat rhs) &&
                                         (Prims.not (is_flex_pat lhs))
                                     then try_solve_bare rhs lhs
                                     else FStar_Pervasives_Native.None in
                                 (match bare_solution with
                                  | FStar_Pervasives_Native.Some (sol, wl1)
                                      ->
                                      let uu___9 =
                                        solve_prob orig
                                  ...
                                  | FStar_Pervasives_Native.None ->
                                      let uu___9 =
                                        let uu___10 = quasi_pattern env lhs in
                                        let uu___11 = quasi_pattern env rhs in
                                        (uu___10, uu___11) in
                                      (match uu___9 with
                                       | (FStar_Pervasives_Native.Some
                                          ...
                                          (binders_rhs, t_res_rhs)) ->
                                           ...
                                           (match uu___10 with
                                            | Flex
                                                ...
                                                ->
                                                let uu___14 =
                                                  occurs_bs u_lhs binders_lhs in
                                                if uu___14
                                                then
                                                  let uu___15 =
                                                    FStarC_Thunk.mkv
                                       ...
                                       | uu___10 ->
                                           let uu___11 =
                                             FStarC_Thunk.mkv
                                               "flex-flex: non-patterns" in
                                           giveup_or_defer orig wl
                                             FStarC_TypeChecker_Common.Deferred_flex_flex_nonpattern
                                             uu___11)))))))
let solve_binders (bs1 : FStarC_Syntax_Syntax.binders)
  (bs2 : FStarC_Syntax_Syntax.binders)
  (orig : FStarC_TypeChecker_Common.prob) (wl : worklist)
  (rhs :
    worklist ->
      FStarC_Syntax_Syntax.binders ->
  ...
  (let eq_bqual a1 a2 = FStarC_Syntax_Util.bqual_compat a1 a2 in
   let compat_positivity_qualifiers p1 p2 =
     match p_rel orig with
     | FStarC_TypeChecker_Common.EQ ->
         FStarC_TypeChecker_Common.check_positivity_qual false p1 p2
     | FStarC_TypeChecker_Common.SUB ->
         ...
         (match uu___1 with
          | (rhs_prob, wl2) ->
              ((let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
                ...
                then
                  let uu___4 =
                    let uu___5 = p_env wl2 rhs_prob in
                    prob_to_string uu___5 rhs_prob in
          ...
          | (hd1, imp) ->
              ...
              (match uu___2 with
               | (hd2, imp') ->
                   ...
                   (match uu___3 with
                    | (prob, wl2) ->
                        let hd12 = FStarC_Syntax_Syntax.freshen_bv hd11 in
                        let subst1 =
                          let uu___4 =
                            FStarC_Syntax_Subst.shift_subst Prims.int_one
                              subst in
                          (FStarC_Syntax_Syntax.DB (Prims.int_zero, hd12)) ::
                            uu___4 in
                        let uu___4 =
                          aux wl2
                            (FStarC_List.op_At scope
                               [{
                                  FStarC_Syntax_Syntax.binder_bv = hd12;
                                  FStarC_Syntax_Syntax.binder_qual =
                        ...
                        (match uu___4 with
                         | (FStar_Pervasives.Inl (sub_probs, phi), wl3) ->
                             let phi1 =
                               let uu___5 =
                                 let uu___6 = p_env wl3 prob in
                                 FStarC_TypeChecker_Env.close_forall uu___6
                                   [{
                                      FStarC_Syntax_Syntax.binder_bv = hd12;
                                      FStarC_Syntax_Syntax.binder_qual =
                                        (x.FStarC_Syntax_Syntax.binder_qual);
                               ...
                               FStarC_Syntax_Util.mk_conj (p_guard prob)
                                 uu___5 in
                             ((let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                               if uu___6
                               then
                                 ...
                                 let uu___8 =
                                   FStarC_Class_Show.show
                                     FStarC_Syntax_Print.showable_bv hd12 in
                                 FStarC_Format.print2
                                   "Formula is %s\n\thd1=%s\n" uu___7 uu___8
                               else ());
                              ((FStar_Pervasives.Inl
                                  ((prob :: sub_probs), phi1)), wl3))
                         | fail -> fail))))
     | uu___1 ->
         ((FStar_Pervasives.Inr "arity or argument-qualifier mismatch"), wl1) in
   let uu___1 = aux wl [] [] bs1 bs2 in
   match uu___1 with
   | (FStar_Pervasives.Inr msg, wl1) -> giveup_lit wl1 msg orig
   | (FStar_Pervasives.Inl (sub_probs, phi), wl1) ->
       let wl2 = solve_prob orig (FStar_Pervasives_Native.Some phi) [] wl1 in
       let uu___2 = attempt sub_probs wl2 in solve uu___2)
let solve_t'_aux (problem : tprob) (wl : worklist) : solution=
  ...
  (let giveup_or_defer1 orig msg = giveup_or_defer orig wl msg in
     ...
     (let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
      ...
      then
        ...
        FStarC_Format.print5 "Heads %s: %s (%s) and %s (%s)\n"
          (if need_unif then "need unification" else "match") uu___3 uu___4
          uu___5 uu___6
      else ());
     (let uu___2 = FStarC_Syntax_Util.head_and_args_full t1 in
      match uu___2 with
      | (head1, args1) ->
          let uu___3 = FStarC_Syntax_Util.head_and_args_full t2 in
          (match uu___3 with
           | (head2, args2) ->
               let need_unif1 =
                    ...
                    (FStarC_Syntax_Syntax.Tm_uinst (uu___7, us2),
                     ...
                     let uu___10 =
                       let uu___11 =
                         FStarC_List.for_all
                           (fun u ->
                              let uu___12 = universe_has_max env u in
                              Prims.not uu___12) us1 in
                       if uu___11
                       then
                         FStarC_List.for_all
                           (fun u ->
                              let uu___12 = universe_has_max env u in
                              Prims.not uu___12) us2
                       else false in
               ...
               let solve_head_then wl2 k =
                 ...
                 then k true wl2
                   ...
                   (let uu___4 = solve_maybe_uinsts orig head1 head2 wl2 in
                    match uu___4 with
               ...
               if nargs <> (FStarC_List.length args2)
               then
                 let uu___4 =
                   mklstr
                     (fun uu___5 ->
                        ...
                        let uu___7 =
                          FStarC_Class_Show.show
                            (FStarC_Class_Show.show_list
                               (FStarC_Class_Show.show_tuple2
                                  FStarC_Syntax_Print.showable_term
                                  FStarC_Syntax_Print.showable_aqual)) args1 in
                        let uu___8 =
                          FStarC_Class_Show.show
                        ...
                        let uu___9 =
                          FStarC_Class_Show.show
                            (FStarC_Class_Show.show_list
                               (FStarC_Class_Show.show_tuple2
                                  FStarC_Syntax_Print.showable_term
                                  FStarC_Syntax_Print.showable_aqual)) args2 in
                        FStarC_Format.fmt4
                 ...
                 (let uu___4 =
                  ...
                  then
                    ...
                    (let uu___5 = base_and_refinement env t1 in
                     match uu___5 with
                     | (base1, refinement1) ->
                         let uu___6 = base_and_refinement env t2 in
                         (match uu___6 with
                          | (base2, refinement2) ->
                              let uu___7 =
                                let is_squash h =
                                  let uu___8 =
                                    let uu___9 =
                                      FStarC_Syntax_Util.un_uinst h in
                                    uu___9.FStarC_Syntax_Syntax.n in
                                  match uu___8 with
                                  | FStarC_Syntax_Syntax.Tm_fvar fv ->
                                   ...
                                   FStar_Pervasives_Native.None) when
                                        ...
                                        let uu___10 =
                                          if
                                            torig.FStarC_TypeChecker_Common.relation
                                              = FStarC_TypeChecker_Common.SUB
                                          then is_squash head1
                                          else false in
                                        if uu___10
                                        then is_squash head2
                                        else false in
                                      if uu___9
                                      then no_free_uvars t1
                                      else false in
                                    if uu___8
                                    then no_free_uvars t2
                                    else false ->
                                    let uu___8 =
                                      base_and_refinement_maybe_delta true
                                        env t1 in
                                    (match uu___8 with
                                     | (base11, refinement11) ->
                                         ...
                                         (match uu___9 with
                                          | (base21, refinement21) ->
                                              (base11, refinement11, base21,
                                                refinement21)))
                                | uu___8 ->
                                    (base1, refinement1, base2, refinement2) in
                              (match uu___7 with
                               | (base11, refinement11, base21, refinement21)
                                   ->
                                   (match (refinement11, refinement21) with
                                    | (FStar_Pervasives_Native.None,
                                       FStar_Pervasives_Native.None) ->
                                            ...
                                            then
                                              FStarC_List.zip
                                                ...
                                                ((head2,
                                                   FStar_Pervasives_Native.None)
                                                :: args2)
                                            else FStarC_List.zip args1 args2 in
                                          let uu___8 =
                                            FStarC_List.fold_right
                                              (fun uu___9 uu___10 ->
                                        ...
                                        let solve_sub_probs_no_smt wl2 =
                                          solve_head_then wl2
                                            (fun ok wl3 ->
                                               let uu___8 = mk_sub_probs wl3 in
                                               match uu___8 with
                                               | (subprobs, wl4) ->
                                                   let formula =
                                                     let uu___9 =
                                                   ...
                                                   let uu___9 =
                                                     attempt subprobs wl5 in
                                                   solve uu___9) in
                                        let unfold_and_retry d wl2 env1 =
                                          let uu___8 =
                                            let uu___9 =
                                        ...
                                        let try_reveal_reveal_or_retry d wl2
                                          uu___8 =
                                          match uu___8 with
                                          | (prob, reason) ->
                                              ((let uu___10 =
                                               ...
                                               (let env1 = p_env wl2 prob in
                                                let uu___10 =
                                                  let uu___11 =
                                                    is_reveal_or_hide t1 in
                                                  let uu___12 =
                                                    is_reveal_or_hide t2 in
                                                  (uu___11, uu___12) in
                                                match uu___10 with
                                                | (FStar_Pervasives_Native.Some
                                                   (Reveal (u, ty, lhs)),
                                        ...
                                        let is_squash_sub_flex_rhs =
                                          ...
                                          then
                                            ...
                                            | (q, uu___9)::[] ->
                                                let uu___10 =
                                                  norm_with_steps
                                                    "FStarC.TypeChecker.Rel.squash_arg"
                                                    [FStarC_TypeChecker_Env.Beta]
                                                    env q in
                                                is_flex uu___10
                                            | uu___9 -> false
                                        ...
                                        if
                                          is_squash_sub_flex_rhs &&
                                            (wl1.defer_ok <> NoDefer)
                                        then
                                          let uu___8 =
                                            let uu___9 =
                                              mklstr
                                                (fun uu___10 ->
                                                   "squash of a flex term on the right-hand side") in
                                            defer
                                              FStarC_TypeChecker_Common.Deferred_flex
                                              uu___9 orig wl1 in
                                          solve uu___8
                                          ...
                                          if
                                            (((match d with
                                               ...
                                               | uu___8 -> false) &&
                                                wl1.smt_ok)
                                               &&
                                               (Prims.not treat_as_injective))
                                              || is_reveal
                                          then
                                            try_solve_without_smt_or_else wl1
                                              solve_sub_probs_no_smt
                                              (try_reveal_reveal_or_retry d)
                                          else solve_sub_probs env wl1
                                    | uu___8 ->
                                        let lhs =
                                          force_refinement
                                            (base11, refinement11) in
                                        let rhs =
                                          force_refinement
                                            (base21, refinement21) in
                                        solve_t'
                                          {
                                            FStarC_TypeChecker_Common.pid =
                                              (problem.FStarC_TypeChecker_Common.pid);
                  ...
                  FStarC_List.fold_left
                    (fun uu___5 x ->
                       ...
                       | (subst, wl3) ->
                           ...
                           (match uu___6 with
                            | (uu___7, u, wl4) ->
                                let subst1 = (FStarC_Syntax_Syntax.NT (x, u))
                                  :: subst in
                                (subst1, wl4))) ([], wl2) xs in
                (match uu___4 with
                 | (subst, wl3) ->
                     let pat_term1 = FStarC_Syntax_Subst.subst subst pat_term in
                     let uu___5 =
                       ...
                       (let uu___7 = FStarC_Effect.op_Bang dbg_Rel in
                        if uu___7
                        then
                          let uu___8 =
                            FStarC_Class_Show.show
                       ...
                       (let uu___7 =
                          env.FStarC_TypeChecker_Env.typeof_tot_or_gtot_term
                            (FStarC_TypeChecker_Env.set_expected_typ env
                               scrutinee_t) pat_term1 must_tot in
                        match uu___7 with
                             ...
                             | (prob, wl4) ->
                                 let wl' =
                                   extend_wl
                                     ...
                                     (FStarC_Class_Listlike.empty
                                        (FStarC_CList.listlike_clist ())) in
                                 ...
                                 (match uu___8 with
                                  | Success (uu___9, defer_to_tac, imps) ->
                                      ...
                                      (match uu___10 with
                                       | Success
                                           (uu___11, defer_to_tac', imps') ->
                                           let uu___12 =
                                             let uu___13 =
                                               FStarC_Class_Monoid.op_Plus_Plus
                                                 (FStarC_CList.monoid_clist
                                                    ()) defer_to_tac
                                                 defer_to_tac' in
                                             let uu___14 =
                                               let uu___15 =
         ...
         ((let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
          ...
          (let uu___2 =
           ...
           | ((uu___3,
              ...
              (s, t)) ->
               let uu___8 =
                 let uu___9 = is_flex scrutinee in Prims.not uu___9 in
               if uu___8
               then
                 ((let uu___10 = FStarC_Effect.op_Bang dbg_Rel in
                   if uu___10
                   then
                     let uu___11 =
                       FStarC_Class_Show.show
                 ...
                 then
                   ((let uu___10 = FStarC_Effect.op_Bang dbg_Rel in
                     if uu___10
                     then FStarC_Format.print_string "Deferring ... \n"
                     else ());
                    ...
                    (let pat_discriminates uu___10 =
                       ...
                       | ({
                            FStarC_Syntax_Syntax.v =
                              FStarC_Syntax_Syntax.Pat_constant uu___11;
                            FStarC_Syntax_Syntax.p = uu___12;_},
                          FStar_Pervasives_Native.None, uu___13) -> true
                       | ({
                            FStarC_Syntax_Syntax.v =
                              FStarC_Syntax_Syntax.Pat_cons uu___11;
                            FStarC_Syntax_Syntax.p = uu___12;_},
                          FStar_Pervasives_Native.None, uu___13) -> true
                       | uu___11 -> false in
                     let head_matching_branch =
                       FStarC_Util.try_find
                         (fun b ->
                            ...
                            then
                              let uu___10 = FStarC_Syntax_Subst.open_branch b in
                              match uu___10 with
                              | (uu___11, uu___12, t') ->
                                  let uu___13 =
                                    let uu___14 = p_env wl1 orig in
                                    head_matches_delta uu___14
                                      (p_logical orig) wl1.smt_ok s t' in
                                  (match uu___13 with
                                   | (FullMatch, uu___14) -> true
                                   | (HeadMatch uu___14, uu___15) -> true
                                   | uu___14 -> false)
                            else false) branches in
                     match head_matching_branch with
                     | FStar_Pervasives_Native.None ->
                         ((let uu___11 = FStarC_Effect.op_Bang dbg_Rel in
                           if uu___11
                           then
                             FStarC_Format.print_string
                          ...
                          (let try_branches =
                             let uu___11 =
                               FStarC_Util.prefix_until
                                 (fun b -> Prims.not (pat_discriminates b))
                                 branches in
                             match uu___11 with
                             | FStar_Pervasives_Native.Some
                                 (branches1, uu___12, uu___13) -> branches1
                             | uu___12 -> branches in
                           let uu___11 =
                             FStarC_Util.find_map try_branches
                               (fun b ->
                                  let uu___12 =
                     ...
                     | FStar_Pervasives_Native.Some b ->
                         ...
                         (match uu___10 with
                          | (p, uu___11, e) ->
                              ((let uu___13 = FStarC_Effect.op_Bang dbg_Rel in
                                if uu___13
                                then
                                  let uu___14 =
                                    FStarC_Class_Show.show
                               ...
                               (let uu___13 = try_solve_branch scrutinee p in
   ...
   let rigid_rigid_delta torig wl1 head1 head2 t1 t2 =
     let orig = FStarC_TypeChecker_Common.TProb torig in
     (let uu___2 = FStarC_Effect.op_Bang dbg_RelDelta in
      if uu___2
      then
        let uu___3 =
          FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term t1 in
     ...
     (let uu___2 =
        let uu___3 = p_env wl1 orig in
        head_matches_delta uu___3 (p_logical orig) wl1.smt_ok t1 t2 in
      match uu___2 with
      | (m, o) ->
          (match (m, o) with
           | (MisMatch uu___3, uu___4) ->
               let try_reveal_hide t11 t21 =
                 let mk_fv_app1 = mk_fv_app wl1.tcenv in
                 let uu___5 =
                 ...
                 | (FStar_Pervasives_Native.Some (Reveal (u, ty, lhs)),
                    FStar_Pervasives_Native.Some (Hide uu___6)) when
                     is_flex lhs ->
                     let rhs =
                       mk_fv_app1 FStarC_Parser_Const.hide u
                         [(ty, (FStarC_Syntax_Syntax.as_aqual_implicit true));
                         (t21, FStar_Pervasives_Native.None)]
                    ...
                    FStar_Pervasives_Native.None) when is_flex lhs ->
                     let rhs =
                       mk_fv_app1 FStarC_Parser_Const.hide u
                         ...
                         t21.FStarC_Syntax_Syntax.pos in
                     FStar_Pervasives_Native.Some (lhs, rhs)
                 | (FStar_Pervasives_Native.Some (Hide uu___6),
                    FStar_Pervasives_Native.Some (Reveal (u, ty, rhs))) when
                     is_flex rhs ->
                     let lhs =
                       mk_fv_app1 FStarC_Parser_Const.hide u
                         [(ty, (FStarC_Syntax_Syntax.as_aqual_implicit true));
                 ...
                 | (FStar_Pervasives_Native.Some (Hide (u, ty, lhs)),
                    FStar_Pervasives_Native.Some (Reveal uu___6)) ->
                     let rhs =
                       mk_fv_app1 FStarC_Parser_Const.reveal u
                         [(ty, (FStarC_Syntax_Syntax.as_aqual_implicit true));
                         (t21, FStar_Pervasives_Native.None)]
                         t21.FStarC_Syntax_Syntax.pos in
                     FStar_Pervasives_Native.Some (lhs, rhs)
               ...
               (match uu___5 with
                | FStar_Pervasives.Inl _defer_ok ->
                    let uu___6 = FStarC_Thunk.mkv "delaying match heuristic" in
                           ...
                           let uu___8 =
                             ...
                             then true
                               ...
                               may_relate wl1.tcenv
                                 problem.FStarC_TypeChecker_Common.relation
                                 head2 in
                           if uu___8 then wl1.smt_ok else false in
                         if uu___7
                         then
                 ...
                 (let uu___4 =
                    mklstr
                      (fun uu___5 ->
                         ...
                         FStarC_Format.fmt2
                           "head mismatch for subtyping (%s vs %s)" uu___6
                           uu___7) in
                  giveup wl1 uu___4 orig)
   ...
   if
     FStarC_Util.physical_equality problem.FStarC_TypeChecker_Common.lhs
       problem.FStarC_TypeChecker_Common.rhs
   then
     (let uu___2 = solve_prob orig FStar_Pervasives_Native.None [] wl in
      solve uu___2)
   else
     (let t1 = problem.FStarC_TypeChecker_Common.lhs in
      let t2 = problem.FStarC_TypeChecker_Common.rhs in
      (let uu___3 =
         let uu___4 = p_scope orig in
         FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) uu___4 in
       FStarC_Defensive.def_check_scoped
         FStarC_Class_Binders.hasBinders_list_bv
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         (p_loc orig) "ref.t1" uu___3 t1);
      (let uu___4 =
         let uu___5 = p_scope orig in
         FStarC_List.map (fun b -> b.FStarC_Syntax_Syntax.binder_bv) uu___5 in
       FStarC_Defensive.def_check_scoped
         FStarC_Class_Binders.hasBinders_list_bv
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         (p_loc orig) "ref.t2" uu___4 t2);
      (let uu___5 = FStarC_Effect.op_Bang dbg_Rel in
       if uu___5
       then
         let uu___6 =
         ...
         let uu___9 =
           FStarC_Class_Show.show FStarC_Class_Show.showable_nat
             (FStarC_List.length wl.attempting) in
         FStarC_Format.print5
           "Attempting %s (%s vs %s); rel = (%s); number of problems in wl = %s\n"
           uu___6 uu___7 uu___8
           (rel_to_string problem.FStarC_TypeChecker_Common.relation) uu___9
       else ());
      (match ((t1.FStarC_Syntax_Syntax.n), (t2.FStarC_Syntax_Syntax.n)) with
       | (FStarC_Syntax_Syntax.Tm_delayed uu___5, uu___6) ->
           FStarC_Effect.failwith "Impossible: terms were not compressed"
       | (uu___5, FStarC_Syntax_Syntax.Tm_delayed uu___6) ->
           FStarC_Effect.failwith "Impossible: terms were not compressed"
       | (FStarC_Syntax_Syntax.Tm_ascribed uu___5, uu___6) ->
           let uu___7 =
             let uu___8 = FStarC_Syntax_Util.unascribe t1 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
           ...
           solve_t' uu___7 wl
       | (FStarC_Syntax_Syntax.Tm_meta uu___5, uu___6) ->
           let uu___7 =
             let uu___8 = FStarC_Syntax_Util.unmeta t1 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
               FStarC_TypeChecker_Common.lhs = uu___8;
           ...
           solve_t' uu___7 wl
       | (uu___5, FStarC_Syntax_Syntax.Tm_ascribed uu___6) ->
           let uu___7 =
             let uu___8 = FStarC_Syntax_Util.unascribe t2 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
               FStarC_TypeChecker_Common.lhs =
               ...
               FStarC_TypeChecker_Common.relation =
                 (problem.FStarC_TypeChecker_Common.relation);
               FStarC_TypeChecker_Common.rhs = uu___8;
               FStarC_TypeChecker_Common.element =
                 (problem.FStarC_TypeChecker_Common.element);
               FStarC_TypeChecker_Common.logical_guard =
                 (problem.FStarC_TypeChecker_Common.logical_guard);
           ...
           solve_t' uu___7 wl
       | (uu___5, FStarC_Syntax_Syntax.Tm_meta uu___6) ->
           let uu___7 =
             let uu___8 = FStarC_Syntax_Util.unmeta t2 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
               FStarC_TypeChecker_Common.lhs =
           ...
           solve_t' uu___7 wl
       | (FStarC_Syntax_Syntax.Tm_quoted (t11, uu___5),
          FStarC_Syntax_Syntax.Tm_quoted (t21, uu___6)) ->
           let uu___7 = solve_prob orig FStar_Pervasives_Native.None [] wl in
           solve uu___7
       | (FStarC_Syntax_Syntax.Tm_bvar uu___5, uu___6) ->
           FStarC_Effect.failwith
             "Only locally nameless! We should never see a de Bruijn variable"
       | (uu___5, FStarC_Syntax_Syntax.Tm_bvar uu___6) ->
           FStarC_Effect.failwith
             "Only locally nameless! We should never see a de Bruijn variable"
       | (FStarC_Syntax_Syntax.Tm_type u1, FStarC_Syntax_Syntax.Tm_type u2)
           -> solve_one_universe_eq orig u1 u2 wl
       | (FStarC_Syntax_Syntax.Tm_arrow uu___5, FStarC_Syntax_Syntax.Tm_arrow
          uu___6) ->
           let uu___7 = FStarC_Syntax_Util.arrow_formals_comp_ln_strict t1 in
           (match uu___7 with
            | (bs1, c1) ->
                let uu___8 =
                  FStarC_Syntax_Util.arrow_formals_comp_ln_strict t2 in
                (match uu___8 with
                 | (bs2, c2) ->
                     let mk_c c uu___9 =
                       match uu___9 with
                       ...
                       | bs ->
                           let uu___10 =
                             FStarC_Syntax_Syntax.mk_Tm_arrow bs c
                               c.FStarC_Syntax_Syntax.pos in
                           FStarC_Syntax_Syntax.mk_Total uu___10 in
                     let uu___9 =
                          ...
                          solve_binders bs11 bs21 orig wl
                            (fun wl1 scope subst ->
                               ...
                               mk_c_problem wl1 scope orig c12 rel c22
                                 FStar_Pervasives_Native.None
                                 "function co-domain"))))
       | (FStarC_Syntax_Syntax.Tm_abs uu___5, FStarC_Syntax_Syntax.Tm_abs
          uu___6) ->
           let uu___7 = FStarC_Syntax_Util.abs_formals_ln t1 in
           (match uu___7 with
            | (bs1, tbody1, lopt1) ->
                let uu___8 = FStarC_Syntax_Util.abs_formals_ln t2 in
                (match uu___8 with
                 | (bs2, tbody2, lopt2) ->
                     let mk_t t l uu___9 =
                       match uu___9 with
                       | [] -> t
                       | bs ->
                           FStarC_Syntax_Syntax.mk_Tm_abs bs t l
                      ...
                      | ((bs11, tbody11), (bs21, tbody21)) ->
                          solve_binders bs11 bs21 orig wl
                            (fun wl1 scope subst ->
                               ...
                               mk_t_problem wl1 scope orig uu___10
                                 problem.FStarC_TypeChecker_Common.relation
       ...
       | (uu___5, uu___6) when
           let uu___7 =
             let uu___8 =
               let uu___9 =
                 if
                   problem.FStarC_TypeChecker_Common.relation <>
                     FStarC_TypeChecker_Common.EQ
                 then
                   let uu___10 = FStarC_Syntax_Util.is_squash t1 in
                   match uu___10 with
                   | FStar_Pervasives_Native.Some v -> true
                   | uu___11 -> false
                 else false in
               if uu___9
               then
                 let uu___10 = FStarC_Syntax_Util.is_squash t2 in
                 match uu___10 with
                 | FStar_Pervasives_Native.Some v -> true
                 | uu___11 -> false
               else false in
             if uu___8
             then
               let uu___9 = has_uvar_needing_congruence wl.tcenv t1 in
               Prims.not uu___9
             else false in
           if uu___7
           then
             let uu___8 = has_uvar_needing_congruence wl.tcenv t2 in
             Prims.not uu___8
           else false ->
           let unsquash t =
             let uu___7 =
             ...
             let uu___8 =
               let uu___9 = FStarC_Syntax_Util.is_squash t in
               match uu___9 with | FStar_Pervasives_Native.Some v -> v in
             FStarC_Syntax_Util.refine uu___7 uu___8 in
           let uu___7 =
             let uu___8 = unsquash t1 in
             let uu___9 = unsquash t2 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
               FStarC_TypeChecker_Common.lhs = uu___8;
           ...
           solve_t' uu___7 wl
       | (FStarC_Syntax_Syntax.Tm_refine
          { FStarC_Syntax_Syntax.b2 = x1; FStarC_Syntax_Syntax.phi = phi1;_},
          FStarC_Syntax_Syntax.Tm_refine
          { FStarC_Syntax_Syntax.b2 = x2; FStarC_Syntax_Syntax.phi = phi2;_})
           ->
           let env = p_env wl (FStarC_TypeChecker_Common.TProb problem) in
           let uu___5 =
             let uu___6 =
               head_matches_delta env false wl.smt_ok
                 x1.FStarC_Syntax_Syntax.sort x2.FStarC_Syntax_Syntax.sort in
             match uu___6 with
             ...
             | (HeadMatch uu___7, FStar_Pervasives_Native.Some (t11, t21)) ->
                 ({
                    FStarC_Syntax_Syntax.ppname =
                      (x1.FStarC_Syntax_Syntax.ppname);
                    FStarC_Syntax_Syntax.index =
            ...
            | (x11, x21) ->
                ...
                let t21 =
                  FStarC_Syntax_Syntax.mk
                    (FStarC_Syntax_Syntax.Tm_refine
                       {
                         FStarC_Syntax_Syntax.b2 = x21;
                         FStarC_Syntax_Syntax.phi = phi2
                       }) t2.FStarC_Syntax_Syntax.pos in
                let uu___6 = as_refinement false env t11 in
                (match uu___6 with
                 | (x12, phi11) ->
                     let uu___7 = as_refinement false env t21 in
                     (match uu___7 with
                      | (x22, phi21) ->
                          ((let uu___9 = FStarC_Effect.op_Bang dbg_Rel in
                            if uu___9
                            then
                              ((let uu___11 =
                                ...
                                let uu___13 =
                                  FStarC_Class_Show.show
                                    FStarC_Syntax_Print.showable_term phi11 in
                               ...
                               (let uu___11 =
                                ...
                                let uu___13 =
                                  FStarC_Class_Show.show
                                    FStarC_Syntax_Print.showable_term phi21 in
                           ...
                           (let uu___9 =
                            ...
                            match uu___9 with
                            | (base_prob, wl1) ->
                                let x13 = FStarC_Syntax_Syntax.freshen_bv x12 in
                                let subst =
                                  [FStarC_Syntax_Syntax.DB
                                ...
                                let close_on_element f =
                                  guard_on_element wl1 problem x13 f in
                                let fallback uu___10 =
                                  let impl =
                                    if
                                      problem.FStarC_TypeChecker_Common.relation
                                        = FStarC_TypeChecker_Common.EQ
                                    then
                                      let uu___11 =
                                        FStarC_Syntax_Util.mk_iff phi12 phi22 in
                                      close_on_element uu___11
                                    else
                                      (let f =
                                         FStarC_Syntax_Util.mk_imp_simp phi12
                                           phi22 in
                                       let uu___11 =
                                         FStarC_Syntax_Util.is_t_true f in
                                       if uu___11
                                       then f
                                       else close_on_element f) in
                                  let guard =
                                    FStarC_Syntax_Util.mk_conj_simp
                                      (p_guard base_prob) impl in
                                  (let uu___12 =
                                     let uu___13 = p_scope orig in
                                     FStarC_List.map
                                       (fun b ->
                                          b.FStarC_Syntax_Syntax.binder_bv)
                                       uu___13 in
                                   FStarC_Defensive.def_check_scoped
                                     ...
                                     (p_loc orig) "ref.1" uu___12
                                     (p_guard base_prob));
                                  (let uu___13 =
                                     let uu___14 = p_scope orig in
                                     FStarC_List.map
                                       (fun b ->
                                          b.FStarC_Syntax_Syntax.binder_bv)
                                       uu___14 in
                                   FStarC_Defensive.def_check_scoped
                                     ...
                                     FStarC_Class_Binders.hasNames_term
                                     FStarC_Syntax_Print.pretty_term
                                     (p_loc orig) "ref.2" uu___13 impl);
                                  (let wl2 =
                                     solve_prob orig
                                       (FStar_Pervasives_Native.Some guard)
                                       [] wl1 in
                                   let uu___13 = attempt [base_prob] wl2 in
                                   solve uu___13) in
                                let has_uvars =
                                  let uu___10 =
                                    let uu___11 =
                                ...
                                then
                                  let uu___10 =
                                    mk_t_problem wl1
                                      [FStarC_Syntax_Syntax.mk_binder x13]
                                      orig phi12 FStarC_TypeChecker_Common.EQ
                                  ...
                                  (match uu___10 with
                                   | (ref_prob, wl2) ->
                                       ...
                                       (match uu___11 with
                                        ...
                                        | Success
                                            (uu___12, defer_to_tac, imps) ->
                                            let guard =
                                              let uu___13 =
                                                let g = p_guard ref_prob1 in
                                                let uu___14 =
                                                  FStarC_Syntax_Util.is_t_true
                                                    g in
                                                if uu___14
                                                then g
                                                else close_on_element g in
                                              FStarC_Syntax_Util.mk_conj_simp
                                                (p_guard base_prob) uu___13 in
                                            let wl3 =
                                              solve_prob orig
                                                (FStar_Pervasives_Native.Some
                                                   guard) [] wl2 in
                                            let wl4 =
                                              {
                                                ...
                                                ctr =
                                                  (wl3.ctr + Prims.int_one);
                                                defer_ok = (wl3.defer_ok);
                                                smt_ok = (wl3.smt_ok);
                                                umax_heuristic_ok =
                                                  (wl3.umax_heuristic_ok);
                                                eq_norm_heuristic_ok =
                                                  (wl3.eq_norm_heuristic_ok);
                                                tcenv = (wl3.tcenv);
                                                wl_implicits =
                                                  (wl3.wl_implicits);
                                                repr_subcomp_allowed =
       ...
       | (uu___5, uu___6) when
           let uu___7 = is_flex t1 in if uu___7 then is_flex t2 else false ->
           let env = p_env wl (FStarC_TypeChecker_Common.TProb problem) in
           let uu___7 = ensure_no_uvar_subst env t1 wl in
           (match uu___7 with
            | (t11, wl1) ->
                let t21 = FStarC_Syntax_Util.canon_app t2 in
                let uu___8 = ensure_no_uvar_subst env t21 wl1 in
                (match uu___8 with
                 | (t22, wl2) ->
                     let uu___9 = destruct_flex_t' t11 in
                     (match uu___9 with
                      | (f1, uu___10) ->
                          let uu___11 = destruct_flex_t' t22 in
                          (match uu___11 with
                           | (f2, uu___12) ->
                               solve_t_flex_flex env orig wl2 f1 f2))))
       | (uu___5, uu___6) when
           let uu___7 = is_flex t1 in
           if uu___7
           then
             problem.FStarC_TypeChecker_Common.relation =
               FStarC_TypeChecker_Common.EQ
       ...
       | (uu___5, uu___6) when
           let uu___7 = is_flex t2 in
           if uu___7
           then
             problem.FStarC_TypeChecker_Common.relation =
               FStarC_TypeChecker_Common.EQ
           else false -> solve_t' (invert problem) wl
       | (uu___5, FStarC_Syntax_Syntax.Tm_arrow uu___6) when is_flex t1 ->
           solve_t'
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
       ...
       | (uu___5, uu___6) when
           let uu___7 = is_flex t1 in if uu___7 then true else is_flex t2 ->
           let uu___7 = attempt [FStarC_TypeChecker_Common.TProb problem] wl in
           solve uu___7
       | (FStarC_Syntax_Syntax.Tm_abs uu___5, uu___6) ->
           let is_abs t =
             match t.FStarC_Syntax_Syntax.n with
             | FStarC_Syntax_Syntax.Tm_abs uu___7 -> FStar_Pervasives.Inl t
             | uu___7 -> FStar_Pervasives.Inr t in
           let env = p_env wl orig in
           (match ((is_abs t1), (is_abs t2)) with
            | (FStar_Pervasives.Inl t_abs, FStar_Pervasives.Inr not_abs) ->
                let uu___7 =
                  let uu___8 = is_flex not_abs in
                  if uu___8
                  then (p_rel orig) = FStarC_TypeChecker_Common.EQ
                  else false in
                if uu___7
                then
                  let flex = destruct_flex_t' not_abs in
                  solve_t_flex_rigid_eq orig wl flex t_abs
                else
                  (let uu___8 =
                     head_matches_delta env false wl.smt_ok not_abs t_abs in
                   match uu___8 with
                   ...
                   | uu___9 ->
                       let uu___10 =
                         FStarC_Syntax_Util.head_and_args_full not_abs in
                       (match uu___10 with
                        | (head, uu___11) ->
                            let uu___12 =
                              if wl.smt_ok
                              then may_relate wl.tcenv (p_rel orig) head
                              else false in
                            if uu___12
                            then
                              let uu___13 = mk_eq2 wl orig t_abs not_abs in
                              (match uu___13 with
                               | (g, wl1) ->
                                   let uu___14 =
                                     solve_prob orig
       ...
       | (uu___5, FStarC_Syntax_Syntax.Tm_abs uu___6) ->
           let is_abs t =
             match t.FStarC_Syntax_Syntax.n with
             | FStarC_Syntax_Syntax.Tm_abs uu___7 -> FStar_Pervasives.Inl t
             | uu___7 -> FStar_Pervasives.Inr t in
           ...
           (match ((is_abs t1), (is_abs t2)) with
            ...
            | uu___7 ->
                FStarC_Effect.failwith
                  "Impossible: at least one side is an abstraction")
       | (FStarC_Syntax_Syntax.Tm_refine uu___5, uu___6) ->
           let t21 =
             let uu___7 =
               let uu___8 = p_env wl orig in base_and_refinement uu___8 t2 in
             force_refinement uu___7 in
           solve_t'
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
       ...
       | (uu___5, FStarC_Syntax_Syntax.Tm_refine uu___6) ->
           let t11 =
             let uu___7 =
               let uu___8 = p_env wl orig in base_and_refinement uu___8 t1 in
             force_refinement uu___7 in
           solve_t'
             {
               FStarC_TypeChecker_Common.pid =
       ...
       | (FStarC_Syntax_Syntax.Tm_match
          ...
          { FStarC_Syntax_Syntax.scrutinee = s2;
           ...
           ->
           let by_smt uu___9 =
             let uu___10 = guard_of_prob wl problem t1 t2 in
             match uu___10 with
             | (guard, wl1) ->
                 let uu___11 =
                   solve_prob orig (FStar_Pervasives_Native.Some guard) []
                 ...
                 (match uu___9 with
                  | (p1, w1, uu___10) ->
                      ...
                      (match uu___11 with
                       | (p2, w2, uu___12) ->
                           let uu___13 =
                             let uu___14 = FStarC_Syntax_Syntax.eq_pat p1 p2 in
                              ...
                              | ((p11, w11, e1), s) ->
                                  ...
                                  (match uu___15 with
                                   | (p21, w21, e2) ->
                                       let w22 =
                                         FStarC_Option.map
                                           (FStarC_Syntax_Subst.subst s) w21 in
                                       let e21 =
                                         FStarC_Syntax_Subst.subst s e2 in
                                       let scope =
                                         let uu___16 =
                                           FStarC_Syntax_Syntax.pat_bvs p11 in
                                         FStarC_List.map
                                           FStarC_Syntax_Syntax.mk_binder
                                           uu___16 in
                                       let uu___16 =
                                         ...
                                         | (FStar_Pervasives_Native.None,
                                            FStar_Pervasives_Native.None) ->
                                             FStar_Pervasives_Native.Some
                                               ([], wl1)
                                         | (FStar_Pervasives_Native.Some w12,
                                            FStar_Pervasives_Native.Some w23)
                                             ->
                                             let uu___17 =
                                               mk_t_problem wl1 scope orig
                                                 w12
            ...
            | FStar_Pervasives_Native.None ->
                ...
                then by_smt ()
                  ...
                  (let uu___10 =
                   ...
                   giveup wl uu___10 orig)
            | FStar_Pervasives_Native.Some (sub_probs, wl1) ->
                let uu___10 =
                  mk_t_problem wl1 [] orig s1 FStarC_TypeChecker_Common.EQ s2
                ...
                (match uu___10 with
                 | (sc_prob, wl2) ->
                       ...
                       let uu___11 =
                         FStarC_List.map
                           (fun uu___12 ->
                              match uu___12 with
                              | (scope, p) ->
                                  let uu___13 = p_env wl2 orig in
                                  FStarC_TypeChecker_Env.close_forall uu___13
                                    scope (p_guard p)) sub_probs1 in
                       FStarC_Syntax_Util.mk_conj_l uu___11 in
                     let tx = FStarC_Syntax_Unionfind.new_transaction () in
                     let wl3 =
                     ...
                     let uu___11 =
                       let uu___12 =
                         let uu___13 =
                           FStarC_List.map FStar_Pervasives_Native.snd
                             sub_probs1 in
                         attempt uu___13
                           {
                             attempting = (wl3.attempting);
                             ...
                             repr_subcomp_allowed =
                               (wl3.repr_subcomp_allowed);
                             typeclass_variables = (wl3.typeclass_variables)
                           } in
                       solve uu___12 in
                     (match uu___11 with
                          ...
                          (FStarC_Syntax_Unionfind.rollback tx;
                           ...
                           then by_smt ()
                             ...
                             (let uu___14 =
                              ...
                              giveup wl3 uu___14 orig)))))
       | (FStarC_Syntax_Syntax.Tm_match uu___5, uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t2 in
             FStar_Pervasives_Native.fst uu___7 in
           ((let uu___8 = FStarC_Effect.op_Bang dbg_Rel in
                 ...
                 let uu___11 =
                   ...
                   let uu___13 =
                     ...
                     let uu___15 =
                       let uu___16 =
                         let uu___17 =
                           FStarC_TypeChecker_Env.is_interpreted wl.tcenv
                             head1 in
                         FStarC_Class_Show.show
                           FStarC_Class_Show.showable_bool uu___17 in
                       let uu___17 =
                         let uu___18 =
                           let uu___19 = no_free_uvars t1 in
                           FStarC_Class_Show.show
                             ...
                             let uu___22 =
                               let uu___23 =
                                 FStarC_TypeChecker_Env.is_interpreted
                                   wl.tcenv head2 in
                               FStarC_Class_Show.show
                                 FStarC_Class_Show.showable_bool uu___23 in
                             let uu___23 =
                               let uu___24 =
                                 let uu___25 = no_free_uvars t2 in
                                 FStarC_Class_Show.show
            ...
            (let equal t11 t21 =
               ...
               | FStarC_TypeChecker_TermEqAndSimplify.Unknown ->
                   if Prims.not wl.eq_norm_heuristic_ok
                   then false
                   else
                     (let steps =
                        [FStarC_TypeChecker_Env.UnfoldUntil
                      ...
                      let uu___8 =
                        FStarC_TypeChecker_TermEqAndSimplify.eq_tm env t12
                          t22 in
                      uu___8 = FStarC_TypeChecker_TermEqAndSimplify.Equal) in
             let uu___8 =
               let uu___9 =
                 let uu___10 =
                   FStarC_TypeChecker_Env.is_interpreted wl.tcenv head1 in
                 if uu___10
                 then true
                 else FStarC_TypeChecker_Env.is_interpreted wl.tcenv head2 in
               if uu___9
               then
                 problem.FStarC_TypeChecker_Common.relation =
                   FStarC_TypeChecker_Common.EQ
             ...
             if uu___8
             then
               let solve_with_smt uu___9 =
                 let uu___10 =
                   let uu___11 = equal t1 t2 in
                   if uu___11
                   then (FStar_Pervasives_Native.None, wl)
                   else
                     (let uu___12 = mk_eq2 wl orig t1 t2 in
                      match uu___12 with
                      | (g, wl1) -> ((FStar_Pervasives_Native.Some g), wl1)) in
                 match uu___10 with
                 | (guard, wl1) ->
                     let uu___11 = solve_prob orig guard [] wl1 in
                     solve uu___11 in
               let uu___9 =
                 let uu___10 = no_free_uvars t1 in
                 if uu___10 then no_free_uvars t2 else false in
               (if uu___9
                then
                  (if Prims.not wl.smt_ok
                   then
                     let uu___10 = equal t1 t2 in
                     (if uu___10
                      then
                        let uu___11 =
                  ...
                  then rigid_rigid_delta problem wl head1 head2 t1 t2
                    ...
                    try_solve_then_or_else wl
                      (fun wl_empty ->
                         rigid_rigid_delta problem wl_empty head1 head2 t1 t2)
                      (fun wl1 -> solve wl1)
                      (fun uu___10 -> solve_with_smt ()))
             else rigid_rigid_delta problem wl head1 head2 t1 t2))
       ...
       | (FStarC_Syntax_Syntax.Tm_name uu___5, uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
       ...
       | (FStarC_Syntax_Syntax.Tm_constant uu___5, uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
       ...
       | (uu___5, FStarC_Syntax_Syntax.Tm_match uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
       ...
       | (uu___5, FStarC_Syntax_Syntax.Tm_name uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
       ...
       | (uu___5, FStarC_Syntax_Syntax.Tm_constant uu___6) ->
           let head1 =
             let uu___7 = FStarC_Syntax_Util.head_and_args_full t1 in
             FStar_Pervasives_Native.fst uu___7 in
           let head2 =
       ...
       | (FStarC_Syntax_Syntax.Tm_let uu___5, FStarC_Syntax_Syntax.Tm_let
          uu___6) ->
           let uu___7 = FStarC_Syntax_Util.term_eq t1 t2 in
           if uu___7
           then
             let uu___8 = solve_prob orig FStar_Pervasives_Native.None [] wl in
             solve uu___8
           else
             (let uu___8 = FStarC_Thunk.mkv "Tm_let mismatch" in
              giveup wl uu___8 orig)
       | (FStarC_Syntax_Syntax.Tm_let uu___5, uu___6) ->
           let uu___7 =
             let uu___8 =
               FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term t1 in
             let uu___9 =
       ...
       | (FStarC_Syntax_Syntax.Tm_lazy li1, FStarC_Syntax_Syntax.Tm_lazy li2)
           ...
           let uu___5 =
             FStarC_Class_Deq.op_Equals_Question
               ...
               li1.FStarC_Syntax_Syntax.lkind li2.FStarC_Syntax_Syntax.lkind in
           if uu___5
           then lazy_complete_repr li1.FStarC_Syntax_Syntax.lkind
           else false ->
           let uu___5 =
             let uu___6 = FStarC_Syntax_Util.unfold_lazy li1 in
             let uu___7 = FStarC_Syntax_Util.unfold_lazy li2 in
             {
               FStarC_TypeChecker_Common.pid =
                 (problem.FStarC_TypeChecker_Common.pid);
               FStarC_TypeChecker_Common.lhs = uu___6;
               FStarC_TypeChecker_Common.relation =
                 (problem.FStarC_TypeChecker_Common.relation);
                  ...
                  let uu___8 =
                    ...
                    let uu___10 =
                      let uu___11 =
                        FStarC_Class_Tagged.tag_of
                          FStarC_Syntax_Syntax.tagged_term t2 in
                      Prims.strcat " vs " uu___11 in
                    Prims.strcat uu___9 uu___10 in
                  Prims.strcat "head tag mismatch: " uu___8) in
           giveup wl uu___6 orig)))
let no_lemma_pats (c : FStarC_Syntax_Syntax.comp) :
  FStarC_Syntax_Syntax.comp=
  match c.FStarC_Syntax_Syntax.n with
  | FStarC_Syntax_Syntax.Comp ct when FStarC_Syntax_Util.is_lemma_comp c ->
      let uu___ =
        let uu___1 =
          let uu___2 =
            FStarC_List.filter
              (fun uu___3 ->
                 match uu___3 with
                 | FStarC_Syntax_Syntax.SMTPAT uu___4 -> false
                 | uu___4 -> true) ct.FStarC_Syntax_Syntax.flags in
          {
            FStarC_Syntax_Syntax.effect_name =
              (ct.FStarC_Syntax_Syntax.effect_name);
            FStarC_Syntax_Syntax.result_typ =
        ...
        FStarC_Syntax_Syntax.Comp uu___1 in
      {
        FStarC_Syntax_Syntax.n = uu___;
        FStarC_Syntax_Syntax.pos = (c.FStarC_Syntax_Syntax.pos);
        FStarC_Syntax_Syntax.hash_code = (c.FStarC_Syntax_Syntax.hash_code)
      }
  | uu___ -> c
let solve_c_aux
  (problem : FStarC_Syntax_Syntax.comp FStarC_TypeChecker_Common.problem)
  (wl : worklist) : solution=
  ...
  let sub_prob wl1 t1 rel t2 reason =
    mk_t_problem wl1 [] orig t1 rel t2 FStar_Pervasives_Native.None reason in
    ...
    if
      Prims.not
        (FStarC_Ident.lid_equals c1_comp.FStarC_Syntax_Syntax.effect_name
           c2_comp.FStarC_Syntax_Syntax.effect_name)
    then
      (let uu___1 =
         mklstr
           (fun uu___2 ->
              ...
              FStarC_Format.fmt2 "incompatible effects: %s <> %s" uu___3
                uu___4) in
       giveup wl uu___1 orig)
    else
      (let uu___1 =
         sub_prob wl c1_comp.FStarC_Syntax_Syntax.result_typ
           FStarC_TypeChecker_Common.EQ
           c2_comp.FStarC_Syntax_Syntax.result_typ "effect ret type" in
       match uu___1 with
       | (ret_sub_prob, wl1) ->
           let scoped_sub_probs =
             let uu___2 =
               FStarC_CList.map
                 (fun uu___3 ->
                    match uu___3 with | (uu___4, uu___5, p) -> ([], p))
                 g_lift.FStarC_TypeChecker_Common.deferred in
             FStarC_Class_Listlike.cons (FStarC_CList.listlike_clist ())
               ([], ret_sub_prob) uu___2 in
           let scoped_sub_probs1 =
             FStarC_Class_Listlike.to_list (FStarC_CList.listlike_clist ())
               scoped_sub_probs in
           let sub_probs =
             FStarC_List.map FStar_Pervasives_Native.snd scoped_sub_probs1 in
           let guard =
             let guard1 =
               let uu___2 =
                 FStarC_List.map
                   (fun uu___3 ->
                      match uu___3 with
                      | (scope, p) ->
                          let uu___4 = p_env wl1 orig in
                          FStarC_TypeChecker_Env.close_forall uu___4 scope
                            (p_guard p)) scoped_sub_probs1 in
               FStarC_Syntax_Util.mk_conj_l uu___2 in
             match g_lift.FStarC_TypeChecker_Common.guard_f with
           ...
           let wl2 =
             let uu___2 =
               FStarC_Class_Monoid.op_Plus_Plus
                 (FStarC_CList.monoid_clist ())
                 g_lift.FStarC_TypeChecker_Common.implicits wl1.wl_implicits in
             {
               attempting = (wl1.attempting);
               wl_deferred = (wl1.wl_deferred);
               wl_deferred_to_tac = (wl1.wl_deferred_to_tac);
           ...
           let wl3 =
             solve_prob orig (FStar_Pervasives_Native.Some guard) [] wl2 in
           let uu___2 = attempt sub_probs wl3 in solve uu___2) in
  let solve_sub c11 edge c21 =
    if
      problem.FStarC_TypeChecker_Common.relation <>
        FStarC_TypeChecker_Common.SUB
    then FStarC_Effect.failwith "impossible: solve_sub"
    else ();
    (let uu___1 =
       let uu___2 =
         let uu___3 =
     ...
     then
           ...
           (fun uu___3 ->
              ...
              let uu___6 =
                FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                  c11.FStarC_Syntax_Syntax.result_typ in
              FStarC_Format.fmt3
                "cannot lift erasable computation %s ~> %s: its result type %s is informative"
                uu___4 uu___5 uu___6) in
       ...
       (let uu___2 =
          sub_prob wl c11.FStarC_Syntax_Syntax.result_typ
            problem.FStarC_TypeChecker_Common.relation
            c21.FStarC_Syntax_Syntax.result_typ "result type" in
        match uu___2 with
        | (base_prob, wl1) ->
            let wl2 =
              solve_prob orig
                (FStar_Pervasives_Native.Some (p_guard base_prob)) [] wl1 in
            let uu___3 = attempt [base_prob] wl2 in solve uu___3)) in
  if FStarC_Util.physical_equality c1 c2
  then
    let uu___ = solve_prob orig FStar_Pervasives_Native.None [] wl in
    solve uu___
  else
    ((let uu___1 = FStarC_Effect.op_Bang dbg_Rel in
      if uu___1
      then
        ...
        FStarC_Format.print3 "solve_c %s %s %s\n" uu___2
          (rel_to_string problem.FStarC_TypeChecker_Common.relation) uu___3
      else ());
     (let uu___1 =
        let uu___2 =
        ...
        match uu___2 with
        | (eff1, eff2) ->
            if FStarC_Ident.lid_equals eff1 eff2
            then (c1, c2)
            else FStarC_TypeChecker_Normalize.ghost_to_pure2 env (c1, c2) in
      match uu___1 with
      | (c11, c21) ->
          let is_tot = FStarC_Syntax_Util.is_named_tot in
          let is_gtot = FStarC_Syntax_Util.is_named_gtot in
          let result_types_only uu___2 =
            let uu___3 =
              problem_using_guard orig (FStarC_Syntax_Util.comp_result c11)
                problem.FStarC_TypeChecker_Common.relation
                (FStarC_Syntax_Util.comp_result c21)
                FStar_Pervasives_Native.None "result type" in
            solve_t uu___3 wl in
          (match ((c11.FStarC_Syntax_Syntax.n), (c21.FStarC_Syntax_Syntax.n))
           with
           | (uu___2, uu___3) when
               let uu___4 = is_gtot c11 in
               if uu___4 then is_tot c21 else false ->
               let uu___4 =
                 FStarC_TypeChecker_Env.non_informative env
                   (FStarC_Syntax_Util.comp_result c21) in
               if uu___4
           ...
           | (uu___2, uu___3) when
               let uu___4 =
                 let uu___5 = is_tot c11 in
                 if uu___5 then is_tot c21 else false in
               if uu___4
               then true
               else
                 (let uu___5 = is_gtot c11 in
                  if uu___5 then is_gtot c21 else false)
               -> result_types_only ()
           | (uu___2, uu___3) when
               let uu___4 = is_tot c11 in
               if uu___4 then is_gtot c21 else false ->
               if
                 problem.FStarC_TypeChecker_Common.relation =
                   FStarC_TypeChecker_Common.SUB
               then result_types_only ()
           ...
           | (FStarC_Syntax_Syntax.Comp uu___2, FStarC_Syntax_Syntax.Comp
              uu___3) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
                     let uu___7 = FStarC_Syntax_Util.is_ml_comp c11 in
                     if uu___7
                     then FStarC_Syntax_Util.is_ml_comp c21
                     else false in
                   if uu___6
                   then true
                   else
                     (let uu___7 = FStarC_Syntax_Util.is_total_comp c11 in
                      if uu___7
                      then FStarC_Syntax_Util.is_total_comp c21
                      else false) in
                 if uu___5
                 then true
                 else
               ...
               then
                 ...
                 (let c1_comp = FStarC_Syntax_Util.comp_to_comp_typ c11 in
                  ...
                  then
                    ...
                    (let c12 = c1_comp in
                     ...
                     (let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                      if uu___6
                      then
                        FStarC_Format.print2 "solve_c for %s and %s\n"
                          (FStarC_Ident.string_of_lid
                             c12.FStarC_Syntax_Syntax.effect_name)
                          (FStarC_Ident.string_of_lid
                             c22.FStarC_Syntax_Syntax.effect_name)
                      else ());
                     (let uu___6 =
   ...
   | FStar_Pervasives_Native.Some (hd, tl, rank1) ->
       ...
       (def_check_prob "solve,hd" hd;
        (match hd with
         ...
         | FStarC_TypeChecker_Common.TProb tp ->
             if
               FStarC_Util.physical_equality tp.FStarC_TypeChecker_Common.lhs
                 tp.FStarC_TypeChecker_Common.rhs
             then
               let uu___4 =
               ...
               (let is_expand_uvar t =
                  ...
                  match uu___4 with
                  | FStarC_Syntax_Syntax.Tm_uvar (ctx_u, uu___5) ->
                      let uu___6 =
                        FStarC_Syntax_Unionfind.find_decoration
                          ctx_u.FStarC_Syntax_Syntax.ctx_uvar_head in
                      uu___6.FStarC_Syntax_Syntax.uvar_decoration_should_unrefine
                  | uu___5 -> false in
                let maybe_expand tp1 =
                  let uu___4 =
                    let uu___5 =
                      let uu___6 = FStarC_Options_Ext.enabled "__unrefine" in
                      if uu___6
                      then
                        tp1.FStarC_TypeChecker_Common.relation =
                          FStarC_TypeChecker_Common.SUB
                    ...
                    if uu___5
                    then is_expand_uvar tp1.FStarC_TypeChecker_Common.rhs
                    else false in
                  if uu___4
                  then
                    let lhs = tp1.FStarC_TypeChecker_Common.lhs in
                    let lhs_norm =
                      let uu___5 = p_env probs1 hd in
                      FStarC_TypeChecker_Normalize.unfold_whnf'
                        [FStarC_TypeChecker_Env.DontUnfoldAttr
                           [FStarC_Parser_Const.do_not_unrefine_attr]] uu___5
                        lhs in
                    let uu___5 =
                      let uu___6 =
                        let uu___7 = FStarC_Syntax_Subst.compress lhs_norm in
                        uu___7.FStarC_Syntax_Syntax.n in
                      match uu___6 with
                      | FStarC_Syntax_Syntax.Tm_refine _0 -> true
                      | uu___7 -> false in
                    (if uu___5
                     then
                       let lhs' =
                         let uu___6 = p_env probs1 hd in
                         FStarC_TypeChecker_Normalize.unfold_whnf'
                           [FStarC_TypeChecker_Env.DontUnfoldAttr
                              [FStarC_Parser_Const.do_not_unrefine_attr];
                           FStarC_TypeChecker_Env.Unrefine] uu___6 lhs_norm in
                       ((let uu___7 = FStarC_Effect.op_Bang dbg_Rel in
                         if uu___7
                         then
                           let uu___8 =
                  ...
                  then
                    ...
                    then
                      ...
                      solve_rigid_flex_or_flex_rigid_subtyping rank1 tp1
                        probs1)))
   | FStar_Pervasives_Native.None ->
       (match FStarC_Class_Listlike.view (FStarC_CList.listlike_clist ())
                probs.wl_deferred
        with
        | FStarC_Class_Listlike.VNil ->
            ...
            Success uu___3
        | FStarC_Class_Listlike.VCons (uu___3, uu___4) ->
            let uu___5 =
              FStarC_CList.partition
                (fun uu___6 ->
                   match uu___6 with
                   | (c, uu___7, uu___8, uu___9) -> c < probs.ctr)
                probs.wl_deferred in
            (match uu___5 with
             | (attempt1, rest) ->
                 (match FStarC_Class_Listlike.view
                          (FStarC_CList.listlike_clist ()) attempt1
                  with
                  | FStarC_Class_Listlike.VNil ->
                      let uu___6 =
                        let uu___7 = as_deferred probs.wl_deferred in
                        let uu___8 = as_deferred probs.wl_deferred_to_tac in
                  ...
                  | uu___6 ->
                      let uu___7 =
                        let uu___8 =
                          let uu___9 =
                            FStarC_Class_Listlike.to_list
                              (FStarC_CList.listlike_clist ()) attempt1 in
                          FStarC_List.map
                            (fun uu___10 ->
                               match uu___10 with
                               | (uu___11, uu___12, uu___13, y) -> y) uu___9 in
                        {
                          attempting = uu___8;
                          wl_deferred = rest;
                          wl_deferred_to_tac = (probs.wl_deferred_to_tac);
                      ...
                      solve uu___7))))
let uu___1 : unit= init_refs solve_aux solve_c_aux solve_t'_aux
let print_pending_implicits (g : FStarC_TypeChecker_Common.guard_t) :
  Prims.string=
  let uu___ =
    FStarC_CList.map
      (fun i ->
  ...
  FStarC_Class_Show.show
    (FStarC_CList.showable_clist FStarC_Class_Show.showable_string) uu___
let ineqs_to_string
  (ineqs :
    (FStarC_Syntax_Syntax.universe FStarC_CList.clist *
          ...
          (fun uu___2 ->
             ...
             | (u1, u2) ->
                 ...
                 let uu___4 =
                   FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ
                     u2 in
                 FStarC_Format.fmt2 "%s < %s" uu___3 uu___4) ineqs1 in
      let uu___2 =
        FStarC_Class_Show.show
          (FStarC_CList.showable_clist FStarC_Syntax_Print.showable_univ)
          vars in
      let uu___3 =
        FStarC_Class_Show.show
          (FStarC_CList.showable_clist FStarC_Class_Show.showable_string)
          ineqs2 in
      FStarC_Format.fmt2 "Solving for %s; inequalities are %s" uu___2 uu___3
let guard_to_string (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) : Prims.string=
  match ((g.FStarC_TypeChecker_Common.guard_f),
          (FStarC_Class_Listlike.view (FStarC_CList.listlike_clist ())
             g.FStarC_TypeChecker_Common.deferred))
  with
  | (FStarC_TypeChecker_Common.Trivial, FStarC_Class_Listlike.VNil) when
      let uu___ =
        let uu___2 = FStarC_Options.print_implicits () in Prims.not uu___2 in
      if uu___
      then
  ...
  | uu___ ->
      let form =
        ...
        | FStarC_TypeChecker_Common.NonTrivial f ->
            let uu___2 =
              let uu___3 =
                let uu___4 = FStarC_Effect.op_Bang dbg_Rel in
                if uu___4 then true else FStarC_Debug.extreme () in
              if uu___3 then true else FStarC_Options.print_implicits () in
            if uu___2
...
let new_t_problem (wl : worklist) (env : FStarC_TypeChecker_Env.env)
  (lhs : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (rel : FStarC_TypeChecker_Common.rel)
  (rhs : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (elt : FStarC_Syntax_Syntax.bv FStar_Pervasives_Native.option)
  (loc : FStarC_Range_Type.range) :
  (FStarC_TypeChecker_Common.prob * worklist)=
  let reason =
    let uu___ =
      let uu___2 = FStarC_Effect.op_Bang dbg_ExplainRel in
      if uu___2 then true else FStarC_Effect.op_Bang dbg_Rel in
    if uu___
    then
      let uu___2 = FStarC_TypeChecker_Normalize.term_to_string env lhs in
      let uu___3 = FStarC_TypeChecker_Normalize.term_to_string env rhs in
      FStarC_Format.fmt3 "Top-level:\n%s\n\t%s\n%s" uu___2
        (rel_to_string rel) uu___3
    else "TOP" in
  ...
  | (p, wl1) ->
      (def_check_prob (Prims.strcat "new_t_problem." reason)
         (FStarC_TypeChecker_Common.TProb p);
       ((FStarC_TypeChecker_Common.TProb p), wl1))
let new_t_prob (wl : worklist) (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (rel : FStarC_TypeChecker_Common.rel)
  (t2 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax) :
  (FStarC_TypeChecker_Common.prob * FStarC_Syntax_Syntax.bv * worklist)=
  let x =
    FStarC_Syntax_Syntax.new_bv
      (FStar_Pervasives_Native.Some (FStarC_TypeChecker_Env.get_range env))
      t1 in
  let uu___ =
    new_t_problem wl env t1 rel t2 (FStar_Pervasives_Native.Some x)
      (FStarC_TypeChecker_Env.get_range env) in
  match uu___ with | (p, wl1) -> (p, x, wl1)
let solve_and_commit (wl : worklist)
  (err :
    (FStarC_TypeChecker_Common.prob * lstring) ->
      (FStarC_TypeChecker_Common.deferred *
        FStarC_TypeChecker_Common.deferred *
  ...
  (FStarC_TypeChecker_Common.deferred * FStarC_TypeChecker_Common.deferred *
    FStarC_TypeChecker_Common.implicits_t) FStar_Pervasives_Native.option=
  let tx = FStarC_Syntax_Unionfind.new_transaction () in
  (let uu___2 = FStarC_Effect.op_Bang dbg_RelBench in
   if uu___2
   then
     let uu___3 =
       FStarC_Common.string_of_list
         (fun p ->
            FStarC_Class_Show.show FStarC_Class_Show.showable_int (p_pid p))
         wl.attempting in
     FStarC_Format.print1 "solving problems %s {\n" uu___3
   else ());
  (let uu___2 = FStarC_Timing.record_ms (fun uu___3 -> solve wl) in
   match uu___2 with
   | (sol, ms) ->
       ((let uu___4 = FStarC_Effect.op_Bang dbg_RelBench in
         if uu___4
         then
           let uu___5 =
        ...
        (match sol with
         | Success (deferred, defer_to_tac, implicits) ->
             let uu___4 = FStarC_Timing.record_ms (fun uu___5 -> ()) in
             (match uu___4 with
              | ((), ms1) ->
                  ((let uu___6 = FStarC_Effect.op_Bang dbg_RelBench in
                    if uu___6
                    then
                      let uu___7 =
                        FStarC_Class_Show.show FStarC_Class_Show.showable_int
         ...
         | Failed (d, s) ->
             ((let uu___5 =
                 let uu___6 = FStarC_Effect.op_Bang dbg_ExplainRel in
                 if uu___6 then true else FStarC_Effect.op_Bang dbg_Rel in
               if uu___5
               then
                 let uu___6 = explain wl d s in
                 FStarC_Format.print_string uu___6
               else ());
              (let result = err (d, s) in
               FStarC_Syntax_Unionfind.rollback tx; result)))))
let with_guard (env : FStarC_TypeChecker_Env.env)
  (prob : FStarC_TypeChecker_Common.prob)
  (dopt :
    (FStarC_TypeChecker_Common.deferred * FStarC_TypeChecker_Common.deferred
      * FStarC_TypeChecker_Common.implicits_t) FStar_Pervasives_Native.option)
  ...
  | FStar_Pervasives_Native.Some (deferred, defer_to_tac, implicits) ->
      (FStarC_Defensive.def_check_scoped
         ...
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         (p_loc prob) "with_guard" env (p_guard prob);
       (let uu___2 =
          simplify_guard env
            {
        ...
        FStar_Pervasives_Native.Some uu___2))
let try_teq (smt_ok : Prims.bool) (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t1.FStarC_Syntax_Syntax.pos "try_teq.1" env t1;
  FStarC_Defensive.def_check_scoped FStarC_TypeChecker_Env.hasBinders_env
    FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
    t2.FStarC_Syntax_Syntax.pos "try_teq.2" env t2;
  FStarC_Profiling.profile
    (fun uu___3 ->
       (let uu___5 = FStarC_Effect.op_Bang dbg_RelTop in
        if uu___5
        then
          let uu___6 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
       ...
       (let uu___5 =
          ...
          new_t_problem uu___6 env t1 FStarC_TypeChecker_Common.EQ t2
            FStar_Pervasives_Native.None
            (FStarC_TypeChecker_Env.get_range env) in
        match uu___5 with
        | (prob, wl) ->
            ...
            ((let uu___7 = FStarC_Effect.op_Bang dbg_RelTop in
              if uu___7
              then
                let uu___8 =
...
let teq (env : FStarC_TypeChecker_Env.env) (t1 : FStarC_Syntax_Syntax.typ)
  (t2 : FStarC_Syntax_Syntax.typ) : FStarC_TypeChecker_Common.guard_t=
  let uu___ = try_teq true env t1 t2 in
  match uu___ with
  | FStar_Pervasives_Native.None ->
      (FStarC_TypeChecker_Err.basic_type_error env
         env.FStarC_TypeChecker_Env.range FStar_Pervasives_Native.None t2 t1;
       FStarC_TypeChecker_Common.trivial_guard)
  | FStar_Pervasives_Native.Some g ->
      ((let uu___3 =
          let uu___4 = FStarC_Effect.op_Bang dbg_Rel in
          if uu___4 then true else FStarC_Effect.op_Bang dbg_RelTop in
        if uu___3
        then
          let uu___4 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
          let uu___5 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t2 in
          let uu___6 = guard_to_string env g in
          FStarC_Format.print3 "teq of %s and %s succeeded with guard %s\n"
            uu___4 uu___5 uu___6
        else ());
       g)
let subtype_fail (env : FStarC_TypeChecker_Env.env)
  (e : FStarC_Syntax_Syntax.term) (t1 : FStarC_Syntax_Syntax.typ)
  (t2 : FStarC_Syntax_Syntax.typ) : unit=
  FStarC_TypeChecker_Err.basic_type_error env
    (FStarC_TypeChecker_Env.get_range env) (FStar_Pervasives_Native.Some e)
    t2 t1
let sub_or_eq_comp (env : FStarC_TypeChecker_Env.env) (use_eq : Prims.bool)
       ...
       (let uu___3 =
        ...
        then
          ...
          FStarC_Format.print3 "sub_comp of %s --and-- %s --with-- %s\n"
            uu___4 uu___5
            (if rel = FStarC_TypeChecker_Common.EQ then "EQ" else "SUB")
        else ());
       (let uu___3 =
          let uu___4 = empty_worklist env in
          new_problem uu___4 env c1 rel c2 FStar_Pervasives_Native.None
            (FStarC_TypeChecker_Env.get_range env) "sub_comp" in
        match uu___3 with
        | (prob, wl) ->
            let wl1 =
              {
...
let sub_comp (env : FStarC_TypeChecker_Env.env)
  (c1 : FStarC_Syntax_Syntax.comp) (c2 : FStarC_Syntax_Syntax.comp) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  FStarC_Errors.with_ctx "While trying to subtype computation types"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_comp FStarC_Syntax_Print.pretty_comp
         c1.FStarC_Syntax_Syntax.pos "sub_comp c1" env c1;
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_comp FStarC_Syntax_Print.pretty_comp
         c2.FStarC_Syntax_Syntax.pos "sub_comp c2" env c2;
       sub_or_eq_comp env false c1 c2)
let eq_comp (env : FStarC_TypeChecker_Env.env)
  (c1 : FStarC_Syntax_Syntax.comp) (c2 : FStarC_Syntax_Syntax.comp) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  FStarC_Errors.with_ctx "While trying to equate computation types"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_comp FStarC_Syntax_Print.pretty_comp
         c1.FStarC_Syntax_Syntax.pos "eq_comp c1" env c1;
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_comp FStarC_Syntax_Print.pretty_comp
         c2.FStarC_Syntax_Syntax.pos "eq_comp c2" env c2;
       sub_or_eq_comp env true c1 c2)
let solve_universe_inequalities' (tx : FStarC_Syntax_Unionfind.tx)
  ...
  | (variables, ineqs) ->
      let fail u1 u2 =
        ...
        (let uu___3 =
           let uu___4 =
             FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u1 in
           let uu___5 =
             FStarC_Class_Show.show FStarC_Syntax_Print.showable_univ u2 in
           FStarC_Format.fmt2 "Universe %s and %s are incompatible" uu___4
             uu___5 in
      ...
      let equiv v v' =
        let uu___2 =
          ...
          let uu___4 = FStarC_Syntax_Subst.compress_univ v' in
          (uu___3, uu___4) in
        match uu___2 with
        | (FStarC_Syntax_Syntax.U_unif v0, FStarC_Syntax_Syntax.U_unif v0')
            -> FStarC_Syntax_Unionfind.univ_equiv v0 v0'
        | uu___3 -> false in
      let sols =
        FStarC_CList.collect
          (fun v ->
                 ...
                 let lower_bounds_of_v =
                   FStarC_CList.collect
                     (fun uu___4 ->
                        match uu___4 with
                        | (u, v') ->
                            let uu___5 = equiv v v' in
                            if uu___5
                            then
                              let uu___6 =
                                FStarC_CList.existsb (equiv u) variables in
                              (if uu___6
                               then
                                 FStarC_Class_Listlike.empty
                                   (FStarC_CList.listlike_clist ())
                                 ...
                                 FStarC_Class_Listlike.cons
                                   (FStarC_CList.listlike_clist ()) u
                                   (FStarC_Class_Listlike.empty
                                      (FStarC_CList.listlike_clist ())))
                            else
                              FStarC_Class_Listlike.empty
                                (FStarC_CList.listlike_clist ())) ineqs in
                 let lb =
                   let uu___4 =
                     let uu___5 =
                       FStarC_Class_Listlike.to_list
                         (FStarC_CList.listlike_clist ()) lower_bounds_of_v in
                     FStarC_Syntax_Syntax.U_max uu___5 in
                   FStarC_TypeChecker_Normalize.normalize_universe env uu___4 in
                 FStarC_Class_Listlike.singleton
                   (FStarC_CList.listlike_clist ()) (lb, v)
             | uu___3 ->
                 FStarC_Class_Listlike.empty (FStarC_CList.listlike_clist ()))
          variables in
      let uu___2 =
        let wl =
          let uu___3 = empty_worklist env in
          {
            ...
            eq_norm_heuristic_ok = (uu___3.eq_norm_heuristic_ok);
            tcenv = (uu___3.tcenv);
            wl_implicits = (uu___3.wl_implicits);
            repr_subcomp_allowed = (uu___3.repr_subcomp_allowed);
            typeclass_variables = (uu___3.typeclass_variables)
          } in
        FStarC_CList.map
          (fun uu___3 ->
             match uu___3 with
             | (lb, v) ->
                 let uu___4 = solve_universe_eq (Prims.of_int (-1)) wl lb v in
                 (match uu___4 with | USolved wl1 -> () | uu___5 -> fail lb v))
          sols in
      let rec check_ineq p =
        let uu___3 = p in
        match uu___3 with
        | (u, v) ->
            let u1 = FStarC_TypeChecker_Normalize.normalize_universe env u in
            ...
            (match (u1, v1) with
             | (FStarC_Syntax_Syntax.U_zero, uu___4) -> true
             | (FStarC_Syntax_Syntax.U_succ u0, FStarC_Syntax_Syntax.U_succ
                v0) -> check_ineq (u0, v0)
             | (FStarC_Syntax_Syntax.U_name u0, FStarC_Syntax_Syntax.U_name
                v0) -> FStarC_Ident.ident_equals u0 v0
             | (FStarC_Syntax_Syntax.U_unif u0, FStarC_Syntax_Syntax.U_unif
                v0) -> FStarC_Syntax_Unionfind.univ_equiv u0 v0
             | (FStarC_Syntax_Syntax.U_name uu___4,
                FStarC_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
             | (FStarC_Syntax_Syntax.U_unif uu___4,
                FStarC_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
             | (FStarC_Syntax_Syntax.U_max us, uu___4) ->
                 FStarC_Util.for_all (fun u2 -> check_ineq (u2, v1)) us
             | (uu___4, FStarC_Syntax_Syntax.U_max vs) ->
                 FStarC_Util.for_some (fun v2 -> check_ineq (u1, v2)) vs
             | uu___4 -> false) in
      let uu___3 =
        FStarC_CList.for_all
          (fun uu___4 ->
             match uu___4 with
             | (u, v) ->
                 let uu___5 = check_ineq (u, v) in
                 if uu___5
                 then true
                 else
                   ((let uu___7 = FStarC_Effect.op_Bang dbg_GenUniverses in
                     if uu___7
                     then
                       let uu___8 =
                         FStarC_Class_Show.show
                       ...
                       FStarC_Format.print2 "%s </= %s" uu___8 uu___9
                     else ());
                    false)) ineqs in
      if uu___3
      then ()
      else
        ((let uu___5 = FStarC_Effect.op_Bang dbg_GenUniverses in
          if uu___5
          then
         ...
         FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env env
           FStarC_Errors_Codes.Fatal_FailToSolveUniverseInEquality ()
           (Obj.magic FStarC_Errors_Msg.is_error_message_string)
           (Obj.magic "Failed to solve universe inequalities for inductives"))
let solve_universe_inequalities (env : FStarC_TypeChecker_Env.env_t)
  (ineqs :
    (FStarC_Syntax_Syntax.universe FStarC_CList.clist *
      (FStarC_Syntax_Syntax.universe * FStarC_Syntax_Syntax.universe)
      FStarC_CList.clist))
...
let try_solve_deferred_constraints (defer_ok : defer_ok_t)
  (smt_ok : Prims.bool) (deferred_to_tac_ok : Prims.bool)
  (env : FStarC_TypeChecker_Env.env) (g : FStarC_TypeChecker_Common.guard_t)
  : FStarC_TypeChecker_Common.guard_t=
       ...
       FStarC_Profiling.profile
         (fun uu___2 ->
              ...
              let uu___3 =
                FStarC_List.collect
                  (fun i ->
                     ...
                     with
                     | FStar_Pervasives_Native.Some
                         (FStarC_Syntax_Syntax.Ctx_uvar_meta_tac tac) ->
                         let uu___4 =
                           FStarC_Syntax_Util.head_and_args_full tac in
                         (match uu___4 with
                          | (head, uu___5) ->
                              let uu___6 =
                                FStarC_Syntax_Util.is_fvar
                                  FStarC_Parser_Const.tcresolve_lid head in
                              if uu___6
                              then
                                let goal_type =
                                  FStarC_Syntax_Util.ctx_uvar_typ
                                    i.FStarC_TypeChecker_Common.imp_uvar in
                                let uvs = FStarC_Syntax_Free.uvars goal_type in
                                FStarC_Class_Setlike.elems
                                  (FStarC_FlatSet.setlike_flat_set
                                     FStarC_Syntax_Free.ord_ctx_uvar) uvs
                              else [])
                     | uu___4 -> []) imps_l in
              FStarC_Class_Setlike.from_list
                (FStarC_RBSet.setlike_rbset FStarC_Syntax_Free.ord_ctx_uvar)
            ...
            (let g1 =
               ...
               match uu___4 with
               | FStar_Pervasives_Native.Some (deferred, uu___5, uu___6) when
                   (match FStarC_Class_Listlike.view
                            (FStarC_CList.listlike_clist ()) deferred
                    with
                    | FStarC_Class_Listlike.VCons (_0, _1) -> true
                    | uu___7 -> false) && (defer_ok = NoDefer)
                   ->
                   FStarC_Effect.failwith
               ...
               | FStar_Pervasives_Native.Some (deferred, defer_to_tac, imps)
                       ...
                       g.FStarC_TypeChecker_Common.implicits imps in
                   {
                     ...
                     FStarC_TypeChecker_Common.deferred_to_tac = uu___5;
                     FStarC_TypeChecker_Common.deferred = deferred;
                     FStarC_TypeChecker_Common.univ_ineqs =
                       (g.FStarC_TypeChecker_Common.univ_ineqs);
             ...
             (let g2 =
              ...
              (let uu___6 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
               if uu___6
               then
...
let solve_deferred_constraints (env : FStarC_TypeChecker_Env.env)
...
let solve_non_tactic_deferred_constraints
  (maybe_defer_flex_flex : Prims.bool) (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) :
  FStarC_TypeChecker_Common.guard_t=
  FStarC_Errors.with_ctx "solve_non_tactic_deferred_constraints"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         ...
         FStarC_TypeChecker_Env.pretty_guard FStarC_Range_Type.dummyRange
       ...
       (let defer_ok =
        ...
        try_solve_deferred_constraints defer_ok smt_ok deferred_to_tac_ok env
          g))
let dedup_vc (vc : FStarC_Syntax_Syntax.term) : FStarC_Syntax_Syntax.term=
  let uu___ =
    let uu___2 = FStarC_Util.expand_environment_variable "FSTAR_NO_DEDUP_VC" in
    match uu___2 with
    | FStar_Pervasives_Native.Some v -> true
    | uu___3 -> false in
  if uu___
  then vc
    ...
    (let head_is lid t =
       let uu___2 =
         let uu___3 = FStarC_Syntax_Util.un_uinst t in
         uu___3.FStarC_Syntax_Syntax.n in
       match uu___2 with
       | FStarC_Syntax_Syntax.Tm_fvar fv ->
     ...
     let rec go known t =
       ...
       | (hd, args) ->
           (match args with
            | (t1, uu___3)::(t2, uu___4)::[] when
                head_is FStarC_Parser_Const.and_lid hd ->
                let uu___5 = go known t1 in
                (match uu___5 with
                 | (t11, known1) ->
                     let uu___6 = go known1 t2 in
                     (match uu___6 with
                      | (t21, known2) ->
                          let uu___7 =
                            FStarC_Syntax_Util.mk_conj_simp t11 t21 in
                          (uu___7, known2)))
            | uu___3 when FStarC_Syntax_Hash.term_map_mem t0 known ->
                (FStarC_Syntax_Util.t_true, known)
            | (t1, uu___3)::(t2, uu___4)::[] when
                head_is FStarC_Parser_Const.imp_lid hd ->
                let uu___5 = go known t2 in
                (match uu___5 with
                 | (t21, uu___6) ->
                     let uu___7 = FStarC_Syntax_Util.mk_imp_simp t1 t21 in
                     let uu___8 = FStarC_Syntax_Hash.term_map_add t0 () known in
                     (uu___7, uu___8))
            | (ty, q1)::(f, q2)::[] when
                head_is FStarC_Parser_Const.forall_lid hd ->
                let uu___3 =
                  let uu___4 = FStarC_Syntax_Subst.compress f in
                  uu___4.FStarC_Syntax_Syntax.n in
                (match uu___3 with
                 | FStarC_Syntax_Syntax.Tm_abs
                     ...
                     ->
                     let uu___4 = FStarC_Syntax_Subst.open_term_1 b body in
                     (match uu___4 with
                      | (b1, body1) ->
                          let uu___5 = go known body1 in
                          (match uu___5 with
                           | (body2, uu___6) ->
                               let known1 =
                                 FStarC_Syntax_Hash.term_map_add t0 () known in
                               let uu___7 =
                                 FStarC_Syntax_Util.is_t_true body2 in
                               if uu___7
                               then (FStarC_Syntax_Util.t_true, known1)
                               else
                                 (let f1 =
                                    let uu___8 =
                                      let uu___9 =
                                        let uu___10 =
                                          let uu___11 =
                                            FStarC_Syntax_Subst.close_binders
                                              [b1] in
                                          FStarC_List.hd uu___11 in
                                        let uu___11 =
                                          FStarC_Syntax_Subst.close [b1]
                                            body2 in
                                        {
                                          FStarC_Syntax_Syntax.b = uu___10;
                                          FStarC_Syntax_Syntax.body = uu___11;
                                          FStarC_Syntax_Syntax.rc_opt =
                                            rc_opt
                                        } in
                                      FStarC_Syntax_Syntax.Tm_abs uu___9 in
                                  ...
                                  (uu___8, known1))))
                 | uu___4 ->
                     let uu___5 = FStarC_Syntax_Hash.term_map_add t0 () known in
                     (t0, uu___5))
            | uu___3 ->
                let uu___4 = FStarC_Syntax_Hash.term_map_add t0 () known in
                (t0, uu___4)) in
     let uu___2 =
       let uu___3 = FStarC_Syntax_Hash.term_map_empty () in go uu___3 vc in
     FStar_Pervasives_Native.fst uu___2)
let do_discharge_vc
  (use_env_range_msg : (unit -> Prims.string) FStar_Pervasives_Native.option)
  (env : FStarC_TypeChecker_Env.env) (vc : FStarC_TypeChecker_Env.goal) :
  unit=
  let debug =
    let uu___ =
      let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
  ...
  let vcs =
    ...
    then
                      ...
                      let uu___7 =
                        let uu___8 =
                          ...
                          FStar_Pprint.op_Hat_Slash_Hat uu___9
                            (FStarC_Errors_Msg.text "goals") in
                        FStar_Pprint.op_Hat_Slash_Hat
                          (FStarC_Errors_Msg.text
                             "Tactic preprocessing produced") uu___8 in
                      [uu___7] in
                    diag uu___6)
                 else ();
                 (let vcs2 =
                             ...
                             let uu___7 =
                               norm_with_steps
                                 ...
                                 FStarC_TypeChecker_Env.Exclude
                                   FStarC_TypeChecker_Env.Zeta] env1 goal in
                  ...
                  let vcs4 =
                    FStarC_List.concatMap
                      (fun uu___6 ->
                         ...
                         | (env1, goal, opts) ->
                             let uu___7 =
                               FStarC_TypeChecker_Common.check_trivial goal in
                             (match uu___7 with
      ...
      (let uu___2 = let uu___3 = FStarC_Options.peek () in (env, vc, uu___3) in
       [uu___2]) in
  FStarC_List.iter
    (fun uu___ ->
       match uu___ with
       | (env1, goal, opts) ->
           FStarC_Options.with_saved_options
             (fun uu___2 ->
                ...
                (let uu___4 = dedup_vc goal in
                 (env1.FStarC_TypeChecker_Env.solver).FStarC_TypeChecker_Env.solve
                   use_env_range_msg env1 uu___4))) vcs
let discharge_guard'
  (use_env_range_msg : (unit -> Prims.string) FStar_Pervasives_Native.option)
  (env : FStarC_TypeChecker_Env.env) (g : FStarC_TypeChecker_Common.guard_t)
  (use_smt : Prims.bool) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  (let uu___2 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
   if uu___2
   then
     let uu___3 = guard_to_string env g in
     FStarC_Format.print1
  ...
  (let g1 =
     ...
     let deferred_to_tac_ok = true in
     try_solve_deferred_constraints defer_ok smt_ok deferred_to_tac_ok env g in
   let debug =
     let uu___2 =
       let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
       if uu___3 then true else FStarC_Effect.op_Bang dbg_SMTQuery in
     if uu___2 then true else FStarC_Effect.op_Bang dbg_Discharge in
   let diag uu___2 =
     Obj.magic
       (FStarC_Errors.diag FStarC_Class_HasRange.hasRange_range
          (FStarC_TypeChecker_Env.get_range env) ()
          (Obj.magic FStarC_Errors_Msg.is_error_message_list_doc)) uu___2 in
   let ret_g =
     {
       FStarC_TypeChecker_Common.guard_f = FStarC_TypeChecker_Common.Trivial;
       FStarC_TypeChecker_Common.deferred_to_tac =
   ...
   then
     (if
        (debug &&
           (Prims.not
              (match g1.FStarC_TypeChecker_Common.guard_f with
               | FStarC_TypeChecker_Common.Trivial -> true
               | uu___3 -> false)))
          && (Prims.not env.FStarC_TypeChecker_Env.phase1)
      then
        (let uu___3 =
           let uu___4 =
             let uu___5 =
               let uu___6 =
                 FStarC_Class_PP.pp FStarC_TypeChecker_Env.pretty_guard g1 in
               FStar_Pprint.op_Hat_Slash_Hat (FStarC_Errors_Msg.text "VC =")
                 uu___6 in
             [uu___5] in
           (FStarC_Errors_Msg.text
     ...
     (let g2 = simplify_guard_full_norm env g1 in
      ...
      | FStarC_TypeChecker_Common.Trivial ->
          FStar_Pervasives_Native.Some ret_g
      | FStarC_TypeChecker_Common.NonTrivial vc when Prims.not use_smt ->
          (if debug
           then
             (let uu___3 =
                let uu___4 =
      ...
      | FStarC_TypeChecker_Common.NonTrivial vc ->
          (do_discharge_vc use_env_range_msg env vc;
           FStar_Pervasives_Native.Some ret_g)))
let discharge_guard (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) :
  FStarC_TypeChecker_Common.guard_t=
...
let discharge_guard_no_smt (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) :
  FStarC_TypeChecker_Common.guard_t=
  ...
  | FStar_Pervasives_Native.None ->
      FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env env
        ...
        (Obj.magic
           [FStarC_Errors_Msg.text "Expected a trivial pre-condition"])
let teq_nosmt (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
...
let subtype_nosmt (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  (let uu___2 =
     let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
   ...
   if uu___2
   then
     let uu___3 = FStarC_TypeChecker_Normalize.term_to_string env t1 in
     let uu___4 = FStarC_TypeChecker_Normalize.term_to_string env t2 in
     FStarC_Format.print2 "try_subtype_no_smt of %s and %s\n" uu___3 uu___4
   else ());
  (let uu___2 =
     let uu___3 = empty_worklist env in
     new_t_prob uu___3 env t1 FStarC_TypeChecker_Common.SUB t2 in
   match uu___2 with
   | (prob, x, wl) ->
       let g =
         let uu___3 =
           solve_and_commit (singleton wl prob false)
             (fun uu___4 -> FStar_Pervasives_Native.None) in
         with_guard env prob uu___3 in
       (match g with
        | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some g1 ->
            let g2 =
              FStarC_TypeChecker_Env.close_guard env
                [FStarC_Syntax_Syntax.mk_binder x] g1 in
            discharge_guard' FStar_Pervasives_Native.None env g2 false))
let check_subtyping (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax)
  (t2 : FStarC_Syntax_Syntax.term' FStarC_Syntax_Syntax.syntax) :
  ...
  FStarC_Profiling.profile
    (fun uu___ ->
       (let uu___3 =
        ...
        if uu___3
        then
          let uu___4 = FStarC_TypeChecker_Normalize.term_to_string env t1 in
          let uu___5 = FStarC_TypeChecker_Normalize.term_to_string env t2 in
            ...
            (match g with
             | FStar_Pervasives_Native.None ->
                 ((let uu___5 =
                   ...
                   then
                     let uu___6 =
                       FStarC_TypeChecker_Normalize.term_to_string env_x t1 in
                     let uu___7 =
                       FStarC_TypeChecker_Normalize.term_to_string env_x t2 in
                     FStarC_Format.print2
...
let get_subtyping_predicate (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  FStarC_Errors.with_ctx "While trying to get a subtyping predicate"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         t1.FStarC_Syntax_Syntax.pos "get_subtyping_predicate.1" env t1;
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         t2.FStarC_Syntax_Syntax.pos "get_subtyping_predicate.2" env t2;
       (let uu___4 = check_subtyping env t1 t2 in
        match uu___4 with
        | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x, g) ->
            let uu___5 =
              FStarC_TypeChecker_Env.abstract_guard
                (FStarC_Syntax_Syntax.mk_binder x) g in
            FStar_Pervasives_Native.Some uu___5))
let get_subtyping_prop (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  FStarC_TypeChecker_Common.guard_t FStar_Pervasives_Native.option=
  FStarC_Errors.with_ctx "While trying to get a subtyping proposition"
    (fun uu___ ->
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         t1.FStarC_Syntax_Syntax.pos "get_subtyping_prop.1" env t1;
       FStarC_Defensive.def_check_scoped
         FStarC_TypeChecker_Env.hasBinders_env
         FStarC_Class_Binders.hasNames_term FStarC_Syntax_Print.pretty_term
         t2.FStarC_Syntax_Syntax.pos "get_subtyping_prop.2" env t2;
       (let uu___4 = check_subtyping env t1 t2 in
        match uu___4 with
        | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x, g) ->
            let uu___5 =
              FStarC_TypeChecker_Env.close_guard env
                [FStarC_Syntax_Syntax.mk_binder x] g in
            FStar_Pervasives_Native.Some uu___5))
let try_solve_single_valued_implicits (env : FStarC_TypeChecker_Env.env)
  (is_tac : Prims.bool) (imps : FStarC_TypeChecker_Env.implicits) :
       ...
       | (ctx_u, r) ->
           ...
           (match uu___2 with
            | FStarC_Syntax_Syntax.Tm_fvar fv when
                ...
                ->
                let uu___3 = FStarC_Syntax_Syntax.unit_const_with_range r in
                FStar_Pervasives_Native.Some uu___3
            | FStarC_Syntax_Syntax.Tm_refine
                { FStarC_Syntax_Syntax.b2 = b;
                  FStarC_Syntax_Syntax.phi = uu___3;_}
                when FStarC_Syntax_Util.is_unit b.FStarC_Syntax_Syntax.sort
                ->
                let uu___4 = FStarC_Syntax_Syntax.unit_const_with_range r in
                FStar_Pervasives_Native.Some uu___4
            | FStarC_Syntax_Syntax.Tm_arrow uu___3 ->
                let uu___4 = FStarC_Syntax_Util.arrow_formals_comp t_norm in
                (match uu___4 with
                 | (bs, c) ->
                     let env_bs = FStarC_TypeChecker_Env.push_binders env bs in
                     let is_unit_like t =
                       let uu___5 =
                         let uu___6 =
                           let uu___7 =
                             FStarC_TypeChecker_Normalize.normalize
                               FStarC_TypeChecker_Normalize.whnf_steps env_bs
                               t in
                           FStarC_Syntax_Subst.compress uu___7 in
                         uu___6.FStarC_Syntax_Syntax.n in
                       match uu___5 with
                     ...
                     let uu___5 =
                       let uu___6 =
                         if match bs with | hd::tl -> true | uu___7 -> false
                         then FStarC_Syntax_Util.is_total_comp c
                         else false in
                       if uu___6
                       then is_unit_like (FStarC_Syntax_Util.comp_result c)
                       else false in
                     if uu___5
                     then
                       let uu___6 =
                         ...
                         FStarC_Syntax_Util.abs bs uu___7
                           FStar_Pervasives_Native.None in
         ...
         (fun b1 imp ->
            let uu___ =
              ...
              then
                ...
                uu___3 = FStarC_Syntax_Syntax.Strict
              else false in
            if uu___
            then
              ...
              | FStar_Pervasives_Native.Some tm ->
                  (commit env
                     [TERM ((imp.FStarC_TypeChecker_Common.imp_uvar), tm)];
                   true)
...
let check_implicit_solution_and_discharge_guard
  ...
  (imp : FStarC_TypeChecker_Common.implicit) (is_tac : Prims.bool)
  (force_univ_constraints : Prims.bool) :
  FStarC_TypeChecker_Common.implicits_t FStar_Pervasives_Native.option=
  let uu___ = imp in
  match uu___ with
  | { FStarC_TypeChecker_Common.imp_reason = imp_reason;
      ...
      ((let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
        ...
        then
          ...
          let uu___5 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term imp_tm in
          let uu___6 =
            FStarC_Class_Show.show FStarC_Syntax_Print.showable_term uvar_ty in
          let uu___7 = FStarC_Range_Ops.string_of_range imp_range in
          FStarC_Format.print5
            "Checking uvar %s resolved to %s at type %s, introduce for %s at %s\n"
            uu___4 uu___5 uu___6 imp_reason uu___7
        else ());
       (let env1 =
          FStar_Pervasives_Native.fst
        ...
        let env2 = FStarC_TypeChecker_Env.set_range env1 imp_range in
        let empty_cb uu___3 = () in
        let uu___3 =
          FStarC_Errors.with_ctx "While checking implicit solution"
            (fun uu___4 ->
               ...
               then
                 (if is_tac
                  then (FStarC_TypeChecker_Env.trivial_guard, empty_cb)
                  else
                    (let imp_tm1 =
                       let uu___5 =
                         let uu___6 = FStarC_Syntax_Subst.compress imp_tm in
                         uu___6.FStarC_Syntax_Syntax.n in
                       match uu___5 with
                       | FStarC_Syntax_Syntax.Tm_abs uu___6 ->
                           let uu___7 =
                             FStarC_Syntax_Util.abs_formals_ln imp_tm in
                           (match uu___7 with
                            | (bs, body, rc_opt) ->
                                (match rc_opt with
                                 | FStar_Pervasives_Native.Some rc ->
                                     FStarC_Syntax_Syntax.mk_Tm_abs bs body
                                       (FStar_Pervasives_Native.Some
                                          {
                                 ...
                                 | FStar_Pervasives_Native.None -> imp_tm))
                       | uu___6 -> imp_tm in
                     let uu___5 =
                       env2.FStarC_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term
                         env2 imp_tm1 must_tot in
                     match uu___5 with
                     | (k', g) ->
                         let uu___6 = get_subtyping_predicate env2 k' uvar_ty in
                         (match uu___6 with
                          | FStar_Pervasives_Native.None ->
                              let uu___7 =
                                FStarC_TypeChecker_Err.expected_expression_of_type
                                  env2 imp_tm1.FStarC_Syntax_Syntax.pos
                                  uvar_ty imp_tm1 k' in
                              (uu___7, empty_cb)
                          | FStar_Pervasives_Native.Some f ->
                              let uu___7 =
                                let uu___8 =
                                  let uu___9 =
                                    FStarC_TypeChecker_Env.apply_guard f
                                      imp_tm1 in
                                  FStarC_TypeChecker_Env.conj_guard uu___9 g in
                                {
                                  FStarC_TypeChecker_Common.guard_f =
                                    FStarC_TypeChecker_Common.Trivial;
                                  FStarC_TypeChecker_Common.deferred_to_tac =
                                    (uu___8.FStarC_TypeChecker_Common.deferred_to_tac);
                                  FStarC_TypeChecker_Common.deferred =
                                    (uu___8.FStarC_TypeChecker_Common.deferred);
                                  FStarC_TypeChecker_Common.univ_ineqs =
                                    (uu___8.FStarC_TypeChecker_Common.univ_ineqs);
                                  FStarC_TypeChecker_Common.implicits =
                                    (uu___8.FStarC_TypeChecker_Common.implicits)
                                } in
                              (uu___7, empty_cb))))
               else
                 (let uu___5 =
                    env2.FStarC_TypeChecker_Env.core_check env2 imp_tm
                      uvar_ty must_tot in
                  match uu___5 with
                  | FStar_Pervasives.Inl (FStar_Pervasives_Native.None) ->
                      (FStarC_TypeChecker_Common.trivial_guard, empty_cb)
                  ...
                  | FStar_Pervasives.Inr print_err ->
                      let uu___6 =
                        let uu___7 =
                          FStarC_Class_Show.show
                            FStarC_Syntax_Print.showable_ctxu imp_uvar in
                        let uu___8 =
                          FStarC_Class_Show.show
                      ...
                      FStarC_Errors.raise_error
                        FStarC_Class_HasRange.hasRange_range imp_range
        ...
        | (g, cb) ->
            let uu___4 =
              if Prims.not force_univ_constraints
              then
                FStarC_CList.existsb
                  (fun uu___5 ->
                     match uu___5 with
                   ...
                   discharge_guard'
                     (FStar_Pervasives_Native.Some
                        (fun uu___6 ->
                           ...
                           let uu___8 =
                             FStarC_Class_Show.show
                               FStarC_Range_Ops.showable_range imp_range in
                           let uu___9 =
                             FStarC_Class_Show.show
                           ...
                           FStarC_Format.fmt4
                             ...
                             uu___7 uu___8 imp_reason uu___9)) env2 g true in
                 match uu___5 with
                 | FStar_Pervasives_Native.Some g1 -> (cb (); g1)
                 | FStar_Pervasives_Native.None ->
                     FStarC_Effect.failwith
                       "Impossible, with use_smt = true, discharge_guard' must return Some" in
               FStar_Pervasives_Native.Some
                 (g'.FStarC_TypeChecker_Common.implicits))))
let rec unresolved (ctx_u : FStarC_Syntax_Syntax.ctx_uvar) : Prims.bool=
  let uu___ =
  ...
  | FStar_Pervasives_Native.Some r ->
      (match ctx_u.FStarC_Syntax_Syntax.ctx_uvar_meta with
       ...
       | FStar_Pervasives_Native.Some uu___2 ->
           let uu___3 =
             let uu___4 = FStarC_Syntax_Subst.compress r in
             uu___4.FStarC_Syntax_Syntax.n in
           (match uu___3 with
            | FStarC_Syntax_Syntax.Tm_uvar (ctx_u', uu___4) ->
                unresolved ctx_u'
            | uu___4 -> false))
  | FStar_Pervasives_Native.None -> true
      ...
      (match imps_with_deferred_univs with
       ...
       | hd::tl ->
           ((FStar_Pervasives_Native.Some (FStar_Pervasives_Native.fst hd)),
             (FStarC_List.op_At tl rest)))
let is_tac_implicit_resolved (env : FStarC_TypeChecker_Env.env)
  (i : FStarC_TypeChecker_Common.implicit) : Prims.bool=
  let uu___ = FStarC_Syntax_Free.uvars i.FStarC_TypeChecker_Common.imp_tm in
  FStarC_Class_Setlike.for_all
    (FStarC_FlatSet.setlike_flat_set FStarC_Syntax_Free.ord_ctx_uvar)
    (fun uv ->
       let uu___2 = FStarC_Syntax_Util.ctx_uvar_should_check uv in
       match uu___2 with
       | FStarC_Syntax_Syntax.Allow_unresolved _0 -> true
       | uu___3 -> false) uu___
let resolve_implicits' (env : FStarC_TypeChecker_Env.env)
  (is_tac : Prims.bool) (is_gen : Prims.bool)
  (implicits : FStarC_TypeChecker_Env.implicits) :
  (FStarC_TypeChecker_Common.implicit * implicit_checking_status) Prims.list=
  let cacheable tac =
    let uu___ =
      FStarC_Syntax_Util.is_fvar FStarC_Parser_Const.tcresolve_lid tac in
    if uu___
    then true
    else
      (let uu___2 =
         let uu___3 = FStarC_Syntax_Subst.compress tac in
         uu___3.FStarC_Syntax_Syntax.n in
       match uu___2 with
       | FStarC_Syntax_Syntax.Tm_abs
           ...
           ->
           let uu___5 = FStarC_Syntax_Util.head_and_args_full body in
           (match uu___5 with
            | (hd, args) ->
                let uu___6 =
                  FStarC_Syntax_Util.is_fvar
                    FStarC_Parser_Const.tcresolve_lid hd in
                if uu___6
                then (FStarC_List.length args) = Prims.int_one
                else false)
       | uu___3 -> false) in
  let meta_tac_allowed_for_open_problem tac = cacheable tac in
  let __meta_arg_cache = FStarC_Effect.mk_ref [] in
  let meta_arg_cache_result tac e ty res =
    let uu___ =
      let uu___2 = FStarC_Effect.op_Bang __meta_arg_cache in
      (tac, e, ty, res) :: uu___2 in
    FStarC_Effect.op_Colon_Equals __meta_arg_cache uu___ in
  let meta_arg_cache_lookup tac e ty =
    let rec aux l =
      ...
      | (tac', e', ty', res')::l' ->
          let uu___ =
            let uu___2 =
              let uu___3 = FStarC_Syntax_Util.term_eq tac tac' in
              if uu___3
              then
            ...
            if uu___2 then FStarC_Syntax_Util.term_eq ty ty' else false in
          if uu___ then FStar_Pervasives_Native.Some res' else aux l' in
    let uu___ = FStarC_Effect.op_Bang __meta_arg_cache in aux uu___ in
    ...
    | (out, changed, defer_open_metas) ->
        (match implicits1 with
         | [] ->
             if changed
             then
               let uu___2 = FStarC_List.map FStar_Pervasives_Native.fst out in
               until_fixpoint ([], false, true) uu___2
             else
               if defer_open_metas
               then
                 (let uu___2 =
                    FStarC_List.map FStar_Pervasives_Native.fst out in
                              ...
                              | FStar_Pervasives_Native.Some imp ->
                                  ...
                                  let imps1 =
                                    let uu___4 =
                                      check_implicit_solution_and_discharge_guard
                                        env imp is_tac force_univ_constraints in
                                  ...
                                  let uu___4 =
                                    ...
                                    FStarC_Class_Monoid.op_Plus_Plus
                                      ...
                                      uu___5 uu___6 in
                                  until_fixpoint ([], false, true) uu___4)))
         | hd::tl ->
             let uu___2 = hd in
             (match uu___2 with
              | { FStarC_TypeChecker_Common.imp_reason = reason;
                   ...
                   | {
                       ...
                       ((let uu___7 = FStarC_Effect.op_Bang dbg_Rel in
                         ...
                         then
                           ...
                           let uu___9 =
                             FStarC_Class_Show.show
                               FStarC_Syntax_Print.showable_ctxu ctx_u in
                           let uu___10 =
                             FStarC_Class_Show.show
                               FStarC_Class_Show.showable_bool is_tac in
                           let uu___11 =
                        ...
                        (match () with
                         | uu___7 when
                             match uvar_decoration_should_check with
                             | FStarC_Syntax_Syntax.Allow_unresolved _0 ->
                                 true
                             | uu___8 -> false ->
                             until_fixpoint (out, true, defer_open_metas) tl
                         | uu___7 when
                             let uu___8 = unresolved ctx_u in
                             if uu___8
                             then flex_uvar_has_meta_tac ctx_u
                             else false ->
                             let uu___8 =
                                      ...
                                      let is_goal_uvar i =
                                        FStarC_List.existsb
                                          (fun uv ->
                                             FStarC_Syntax_Unionfind.equiv
                                               uv.FStarC_Syntax_Syntax.ctx_uvar_head
                                               (i.FStarC_TypeChecker_Common.imp_uvar).FStarC_Syntax_Syntax.ctx_uvar_head)
                                          uvs in
                                      let uu___10 =
                                        let uu___11 =
                                          let uu___12 =
                                          ...
                                          FStarC_List.op_At tl uu___12 in
                                        FStarC_List.filter is_goal_uvar
                                          uu___11 in
                                      match uu___10 with
                                      | [] -> ()
                                      | pi ->
                                          let uu___11 =
                                            try_solve_single_valued_implicits
                                              env1 is_tac pi in
                                          ())
                                   else ();
                                   (let typ =
                                    ...
                                    let is_open =
                                      let uu___10 = has_free_uvars typ in
                                      if uu___10
                                      then true
                                      else
                                       ...
                                       then
                                         ...
                                         (let solve_with t =
                                            ...
                                            until_fixpoint
                                              ...
                                              (FStarC_List.op_At extra tl) in
                                          let uu___11 = cacheable tac in
                                          if uu___11
                                          then
                                            let uu___12 =
                                              meta_arg_cache_lookup tac env1
                                                typ in
                                            match uu___12 with
                                            | FStar_Pervasives_Native.Some
                                                res -> solve_with res
                                            | FStar_Pervasives_Native.None ->
                                                let t =
                                                  run_meta_arg_tac env1 ctx_u in
                                            ...
                                            (let t =
                                               run_meta_arg_tac env1 ctx_u in
                                             solve_with t))))))
                         | uu___7 when unresolved ctx_u ->
                             until_fixpoint
                               (((hd, Implicit_unresolved) :: out), changed,
                                 defer_open_metas) tl
                         | uu___7 when
                             ((match uvar_decoration_should_check with
                               | FStarC_Syntax_Syntax.Allow_untyped _0 ->
                                   true
                               | uu___8 -> false) ||
                                (match uvar_decoration_should_check with
                         ...
                         | uu___7 ->
                             ...
                             let tm1 =
                               norm_with_steps
                                 ...
                                 [FStarC_TypeChecker_Env.Beta] env1 tm in
                             let hd1 =
                               {
                                 ...
                                 FStarC_TypeChecker_Common.imp_tm = tm1;
                             ...
                             then
                               ((let uu___9 =
                                 ...
                                 then
                                   ...
                                   let res =
                                     check_implicit_solution_and_discharge_guard
                                       env1 hd1 is_tac force_univ_constraints in
                                   let res1 =
                                     FStarC_Option.map
                                       (FStarC_Class_Listlike.to_list
                                          (FStarC_CList.listlike_clist ()))
                                    ...
                                    let uu___8 =
                                      let uu___9 =
                                        let uu___10 =
                                          ...
                                          FStarC_List.map
                                            (fun i ->
                                               (i, Implicit_unresolved))
                                            uu___11 in
                                        FStarC_List.op_At uu___10 out in
                                      (uu___9, true, defer_open_metas) in
                                    until_fixpoint uu___8 tl)))))) in
...
let resolve_implicits (env : FStarC_TypeChecker_Env.env)
  ...
  (let tagged_implicits1 =
     let uu___2 =
       FStarC_Class_Listlike.to_list (FStarC_CList.listlike_clist ())
         g.FStarC_TypeChecker_Common.implicits in
     resolve_implicits' env false false uu___2 in
   (let uu___3 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
    if uu___3
    then
      FStarC_Format.print_string
   ...
   (let uu___3 =
      let uu___4 =
        FStarC_List.map FStar_Pervasives_Native.fst tagged_implicits1 in
      FStarC_Class_Listlike.from_list (FStarC_CList.listlike_clist ()) uu___4 in
    {
      FStarC_TypeChecker_Common.guard_f =
        (g.FStarC_TypeChecker_Common.guard_f);
      FStarC_TypeChecker_Common.deferred_to_tac =
...
let resolve_generalization_implicits (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) :
  FStarC_TypeChecker_Common.guard_t=
  let tagged_implicits1 =
    let uu___ =
  ...
  let uu___ =
    let uu___2 =
      FStarC_List.map FStar_Pervasives_Native.fst tagged_implicits1 in
    FStarC_Class_Listlike.from_list (FStarC_CList.listlike_clist ()) uu___2 in
  {
...
let resolve_implicits_tac (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) : tagged_implicits=
  let uu___ =
    FStarC_Class_Listlike.to_list (FStarC_CList.listlike_clist ())
      g.FStarC_TypeChecker_Common.implicits in
  resolve_implicits' env true false uu___
let force_trivial_guard (env : FStarC_TypeChecker_Env.env)
  (g : FStarC_TypeChecker_Common.guard_t) : unit=
  (let uu___2 = FStarC_Effect.op_Bang dbg_ResolveImplicitsHook in
   if uu___2
   then
     let uu___3 = guard_to_string env g in
  ...
  (let g1 = solve_deferred_constraints env g in
   ...
   match FStarC_Class_Listlike.view (FStarC_CList.listlike_clist ())
           g2.FStarC_TypeChecker_Common.implicits
   with
   | FStarC_Class_Listlike.VNil -> let uu___2 = discharge_guard env g2 in ()
       ...
       let hint =
         let uu___3 =
           let uu___4 =
             FStarC_Syntax_Unionfind.uvar_id
               (imp.FStarC_TypeChecker_Common.imp_uvar).FStarC_Syntax_Syntax.ctx_uvar_head in
           let uu___5 = FStarC_Effect.op_Bang unsolvable_spec_uvars in
           FStarC_List.mem uu___4 uu___5 in
         if uu___3
         then
           [FStarC_Errors_Msg.text
              "This implicit argument only occurs in a pre- or postcondition, so it cannot be inferred: a specification is a proof obligation, not part of the identity of a computation.  Write it out explicitly, or pass an argument whose declared type determines it."]
         else [] in
       let uu___3 =
         let uu___4 =
           let uu___5 =
             let uu___6 =
               ...
               FStar_Pprint.prefix (Prims.of_int 4) Prims.int_one
                 (FStarC_Errors_Msg.text
                    "Failed to resolve implicit argument") uu___7 in
             let uu___7 =
               let uu___8 =
                 let uu___9 =
                   let uu___10 =
...
let teq_force (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) : unit=
  let uu___ = teq env t1 t2 in force_trivial_guard env uu___
let teq_nosmt_force (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.typ) (t2 : FStarC_Syntax_Syntax.typ) :
  Prims.bool=
  ...
  | FStar_Pervasives_Native.None -> false
  | FStar_Pervasives_Native.Some g -> (force_trivial_guard env g; true)
let layered_effect_teq (env : FStarC_TypeChecker_Env.env)
  (t1 : FStarC_Syntax_Syntax.term) (t2 : FStarC_Syntax_Syntax.term)
  (reason : Prims.string FStar_Pervasives_Native.option) :
  FStarC_TypeChecker_Common.guard_t=
  (let uu___2 = FStarC_Effect.op_Bang dbg_LayeredEffectsEqns in
   if uu___2
   then
     let uu___3 =
       if
         ...
         | uu___4 -> false
       then "_"
       else FStarC_Option.must reason in
     let uu___4 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t1 in
     let uu___5 = FStarC_Class_Show.show FStarC_Syntax_Print.showable_term t2 in
     FStarC_Format.print3 "Layered Effect (%s) %s = %s\n" uu___3 uu___4
       uu___5
   else ());
  teq env t1 t2
let universe_inequality (u1 : FStarC_Syntax_Syntax.universe)
  (u2 : FStarC_Syntax_Syntax.universe) : FStarC_TypeChecker_Common.guard_t=
  {
    FStarC_TypeChecker_Common.guard_f =
