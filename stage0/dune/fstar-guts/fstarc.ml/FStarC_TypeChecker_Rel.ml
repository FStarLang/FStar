  ...
  | (head, args) ->
      ...
      (match uu___1 with
       ...
       | FStarC_Syntax_Syntax.Tm_uvar (uv, uu___2) when
           Prims.uu___is_Nil uv.FStarC_Syntax_Syntax.ctx_uvar_binders ->
           (t0, wl)
         ...
         (match uu___2 with
          ...
          | FStar_Pervasives_Native.Some uu___3 ->
              ...
              then FStar_Pervasives_Native.None
                ...
                ((let uu___6 = FStarC_Effect.op_Bang dbg_RelDelta in
                  if uu___6
                  then
                    let uu___7 =
                      FStarC_Class_Show.show
...
let guard_of_prob (wl : worklist) (problem : tprob)
  ...
  (let env = p_env wl (FStarC_TypeChecker_Common.TProb problem) in
   let has_type_guard t11 t21 =
     ...
     | FStar_Pervasives_Native.None ->
         let x = FStarC_Syntax_Syntax.new_bv FStar_Pervasives_Native.None t11 in
         (FStarC_Defensive.def_check_scoped
            FStarC_TypeChecker_Env.hasBinders_env
            FStarC_Class_Binders.hasNames_term
            FStarC_Syntax_Print.pretty_term t11.FStarC_Syntax_Syntax.pos
            "guard_of_prob.universe_of" env t11;
...
let apply_substitutive_indexed_subcomp (env : FStarC_TypeChecker_Env.env)
  (k : FStarC_Syntax_Syntax.indexed_effect_combinator_kind)
  (bs : FStarC_Syntax_Syntax.binders) (subcomp_c : FStarC_Syntax_Syntax.comp)
  ...
  (num_effect_params : Prims.int) (wl : worklist)
  (subcomp_name : Prims.string) (r1 : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.typ * FStarC_TypeChecker_Common.prob Prims.list *
    worklist)=
  let uu___ =
    let uu___1 = bs in
    match uu___1 with
  ...
  | (bs1, subst) ->
      let uu___1 =
        ...
        then
          (bs1, subst, (ct1.FStarC_Syntax_Syntax.effect_args),
            (ct2.FStarC_Syntax_Syntax.effect_args), [], wl)
        else
          (let split l = FStarC_List.splitAt num_effect_params l in
           let uu___2 = split bs1 in
           match uu___2 with
           | (eff_params_bs, bs2) ->
               let uu___3 = split ct1.FStarC_Syntax_Syntax.effect_args in
               (match uu___3 with
                | (param_args1, args1) ->
                    let uu___4 = split ct2.FStarC_Syntax_Syntax.effect_args in
                    (match uu___4 with
                     | (param_args2, args2) ->
                         let uu___5 =
                           FStarC_List.fold_left2
                             (fun uu___6 uu___7 uu___8 ->
                                match (uu___6, uu___7, uu___8) with
                                | ((ps, wl1), (t1, uu___9), (t2, uu___10)) ->
                                    let uu___11 =
                                      sub_prob wl1 t1
                                        FStarC_TypeChecker_Common.EQ t2
                                        "effect params subcomp" in
                                    (match uu___11 with
                                     | (p, wl2) -> ((p :: ps), wl2)))
                             ([], wl) param_args1 param_args2 in
                         (match uu___5 with
                          | (probs, wl1) ->
                              let probs1 = FStarC_List.rev probs in
                              let param_subst =
                                FStarC_List.map2
                                  (fun b uu___6 ->
                                     match uu___6 with
                                     | (arg, uu___7) ->
                                         FStarC_Syntax_Syntax.NT
                                           ((b.FStarC_Syntax_Syntax.binder_bv),
                                             arg)) eff_params_bs param_args1 in
                              (bs2, (FStarC_List.op_At subst param_subst),
                                args1, args2, probs1, wl1))))) in
      (match uu___1 with
       | (bs2, subst1, args1, args2, eff_params_sub_probs, wl1) ->
           let uu___2 =
             let uu___3 = FStarC_List.splitAt (FStarC_List.length args1) bs2 in
             match uu___3 with
             | (f_bs, bs3) ->
                 let f_substs =
                   FStarC_List.map2
                     (fun f_b uu___4 ->
                        ...
                        | (arg, uu___5) ->
                            FStarC_Syntax_Syntax.NT
                              ((f_b.FStarC_Syntax_Syntax.binder_bv), arg))
                     f_bs args1 in
                 (bs3, (FStarC_List.op_At subst1 f_substs)) in
           (match uu___2 with
            | (bs3, subst2) ->
                let uu___3 =
                  if FStarC_Syntax_Syntax.uu___is_Substitutive_combinator k
                  then
                    let uu___4 =
                      FStarC_List.splitAt (FStarC_List.length args2) bs3 in
                    match uu___4 with
                    | (g_bs, bs4) ->
                        let g_substs =
                          FStarC_List.map2
                               ...
                               | (arg, uu___6) ->
                                   FStarC_Syntax_Syntax.NT
                                     ((g_b.FStarC_Syntax_Syntax.binder_bv),
                                       arg)) g_bs args2 in
                        (bs4, (FStarC_List.op_At subst2 g_substs), [], wl1)
                  else
                    if
                    ...
                    then
                      (let uu___4 =
                         FStarC_List.fold_left2
                           (fun uu___5 uu___6 uu___7 ->
                              match (uu___5, uu___6, uu___7) with
                              | ((ps, wl2), (t1, uu___8), (t2, uu___9)) ->
                                  let uu___10 =
                                    sub_prob wl2 t1
                                      FStarC_TypeChecker_Common.EQ t2
                       ...
                       | (probs, wl2) ->
                           let probs1 = FStarC_List.rev probs in
                           (bs3, subst2, probs1, wl2))
                    else
                      FStarC_Effect.failwith
                        "Impossible (rel.apply_substitutive_indexed_subcomp unexpected k" in
                (match uu___3 with
                 | (bs4, subst3, f_g_args_eq_sub_probs, wl2) ->
                     let bs5 =
                       FStar_Pervasives_Native.fst
                         (FStarC_List.splitAt
                            ((FStarC_List.length bs4) - Prims.int_one) bs4) in
                     let uu___4 =
                       FStarC_List.fold_left
                         (fun uu___5 b ->
                            match uu___5 with
                     ...
                     (match uu___4 with
                      | (subst4, wl3) ->
                          let subcomp_ct =
                            let uu___5 =
                              FStarC_Syntax_Subst.subst_comp subst4 subcomp_c in
                            FStarC_TypeChecker_Env.comp_to_comp_typ env
                              uu___5 in
                          let fml =
                            let uu___5 =
                              ((FStarC_List.hd
                                  subcomp_ct.FStarC_Syntax_Syntax.comp_univs),
                                (FStar_Pervasives_Native.fst
                                   (FStarC_List.hd
                            ...
                            | (u, wp) ->
                                FStarC_TypeChecker_Env.pure_precondition_for_trivial_post
                                  ...
                                  wp FStarC_Range_Type.dummyRange in
                          (fml,
                            (FStarC_List.op_At eff_params_sub_probs
                               f_g_args_eq_sub_probs), wl3)))))
let apply_ad_hoc_indexed_subcomp (env : FStarC_TypeChecker_Env.env)
  (bs : FStarC_Syntax_Syntax.binders) (subcomp_c : FStarC_Syntax_Syntax.comp)
  (ct1 : FStarC_Syntax_Syntax.comp_typ) (ct2 : FStarC_Syntax_Syntax.comp_typ)
  (sub_prob :
    worklist ->
      FStarC_Syntax_Syntax.term ->
        FStarC_TypeChecker_Common.rel ->
          FStarC_Syntax_Syntax.term ->
            Prims.string -> (FStarC_TypeChecker_Common.prob * worklist))
  (wl : worklist) (subcomp_name : Prims.string) (r1 : FStarC_Range_Type.t) :
  (FStarC_Syntax_Syntax.typ * FStarC_TypeChecker_Common.prob Prims.list *
    worklist)=
  let stronger_t_shape_error s =
    FStarC_Format.fmt2 "Unexpected shape of stronger for %s, reason: %s"
      (FStarC_Ident.string_of_lid ct2.FStarC_Syntax_Syntax.effect_name) s in
  let uu___ =
    if (FStarC_List.length bs) >= (Prims.of_int 2)
    then
      let uu___1 = bs in
      match uu___1 with
      | a_b::bs1 ->
          let uu___2 =
            match FStarC_List.splitAt
                    ((FStarC_List.length bs1) - Prims.int_one) bs1
            with
            | (l1, l2) -> (l1, (FStarC_List.hd l2)) in
          (match uu___2 with | (rest_bs, f_b) -> (a_b, rest_bs, f_b))
    else
      FStarC_Errors.raise_error FStarC_Class_HasRange.hasRange_range r1
        FStarC_Errors_Codes.Fatal_UnexpectedExpressionType ()
        (Obj.magic FStarC_Errors_Msg.is_error_message_string)
        (Obj.magic
           (stronger_t_shape_error "not an arrow or not enough binders")) in
  match uu___ with
  | (a_b, rest_bs, f_b) ->
      let uu___1 =
        FStarC_TypeChecker_Env.uvars_for_binders env rest_bs
          ...
          (fun b ->
             let uu___2 = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
             if uu___2
             then
               let uu___3 =
               ...
               FStarC_Format.fmt3
                 "implicit for binder %s in subcomp %s at %s" uu___3
                 subcomp_name uu___4
       ...
       | (rest_bs_uvars, g_uvars) ->
           let wl1 =
             let uu___2 =
               FStarC_Class_Monoid.op_Plus_Plus
                 (FStarC_CList.monoid_clist ())
                 g_uvars.FStarC_TypeChecker_Common.implicits wl.wl_implicits in
             {
               attempting = (wl.attempting);
               wl_deferred = (wl.wl_deferred);
               wl_deferred_to_tac = (wl.wl_deferred_to_tac);
           ...
           let substs =
             FStarC_List.map2
               (fun b t ->
                  FStarC_Syntax_Syntax.NT
                    ((b.FStarC_Syntax_Syntax.binder_bv), t)) (a_b :: rest_bs)
               ((ct2.FStarC_Syntax_Syntax.result_typ) :: rest_bs_uvars) in
           let uu___2 =
             let f_sort_is =
               let uu___3 =
                 let uu___4 =
                 ...
                 FStarC_Syntax_Util.effect_indices_from_repr
                   ...
                   uu___4 r1
                   (stronger_t_shape_error "type of f is not a repr type") in
               FStarC_List.map (FStarC_Syntax_Subst.subst substs) uu___3 in
             let uu___3 =
               FStarC_List.map FStar_Pervasives_Native.fst
                 ct1.FStarC_Syntax_Syntax.effect_args in
             FStarC_List.fold_left2
               (fun uu___4 f_sort_i c1_i ->
                  match uu___4 with
                  | (ps, wl2) ->
                      ((let uu___6 =
                          FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
                        if uu___6
                        then
                          let uu___7 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term f_sort_i in
                          let uu___8 =
                            FStarC_Class_Show.show
                              FStarC_Syntax_Print.showable_term c1_i in
                          FStarC_Format.print3
                            "Layered Effects (%s) %s = %s\n" subcomp_name
                            uu___7 uu___8
                        else ());
                       (let uu___6 =
                          sub_prob wl2 f_sort_i FStarC_TypeChecker_Common.EQ
                            c1_i "indices of c1" in
                        match uu___6 with | (p, wl3) -> ((p :: ps), wl3))))
               ([], wl1) f_sort_is uu___3 in
           (match uu___2 with
            | (f_sub_probs, wl2) ->
                let f_sub_probs1 = FStarC_List.rev f_sub_probs in
                let subcomp_ct =
                  let uu___3 =
                    FStarC_Syntax_Subst.subst_comp substs subcomp_c in
                  FStarC_TypeChecker_Env.comp_to_comp_typ env uu___3 in
                let uu___3 =
                  let g_sort_is =
                    let uu___4 =
                      FStarC_TypeChecker_Env.is_layered_effect env
                    ...
                    FStarC_Syntax_Util.effect_indices_from_repr
                      subcomp_ct.FStarC_Syntax_Syntax.result_typ uu___4 r1
                       ...
                       | (ps, wl3) ->
                           ((let uu___7 =
                             ...
                             then
                               let uu___8 =
                                 FStarC_Class_Show.show
                                   FStarC_Syntax_Print.showable_term g_sort_i in
                               let uu___9 =
                                 FStarC_Class_Show.show
                                   FStarC_Syntax_Print.showable_term c2_i in
                               FStarC_Format.print3
                                 "Layered Effects (%s) %s = %s\n"
                                 subcomp_name uu___8 uu___9
                             else ());
                            (let uu___7 =
                               sub_prob wl3 g_sort_i
                                 FStarC_TypeChecker_Common.EQ c2_i
                                 "indices of c2" in
                             match uu___7 with | (p, wl4) -> ((p :: ps), wl4))))
                    ([], wl2) g_sort_is uu___4 in
                (match uu___3 with
                 | (g_sub_probs, wl3) ->
                     let g_sub_probs1 = FStarC_List.rev g_sub_probs in
                     let fml =
                       let uu___4 =
                         ((FStarC_List.hd
                             subcomp_ct.FStarC_Syntax_Syntax.comp_univs),
                       ...
                       | (u, wp) ->
                           FStarC_TypeChecker_Env.pure_precondition_for_trivial_post
                             env u subcomp_ct.FStarC_Syntax_Syntax.result_typ
                             wp FStarC_Range_Type.dummyRange in
                     (fml, (FStarC_List.op_At f_sub_probs1 g_sub_probs1),
                       wl3))))
  ...
  | Flex (uu___1, u_lhs, uu___2) ->
      let imitate_comp bs bs_terms c wl1 =
        ...
        | FStarC_Syntax_Syntax.Total t ->
            imitate_tot_or_gtot t FStarC_Syntax_Syntax.mk_Total wl1
        | FStarC_Syntax_Syntax.GTotal t ->
            imitate_tot_or_gtot t FStarC_Syntax_Syntax.mk_GTotal wl1
        | FStarC_Syntax_Syntax.Comp ct ->
            let uu___3 =
              FStarC_List.fold_right
                ...
                (ct.FStarC_Syntax_Syntax.effect_args)) ([], wl1) in
            (match uu___3 with
             | (out_args, wl2) ->
                 let nodec flags =
                   FStarC_List.filter
                            ...
                            (match uu___5 with
                             | (t2_base, p2_opt) ->
                                 let combine_refinements t_base p1_opt1
                                   p2_opt1 =
                                   match op with
                                   | FStar_Pervasives_Native.None -> t_base
                                 ...
                                 (match uu___6 with
                                  | FStar_Pervasives_Native.Some wl4 ->
                                      let uu___7 =
                                        combine_refinements t1_base p1_opt
                                          p2_opt in
                                      (uu___7, [], wl4)
                                  | FStar_Pervasives_Native.None ->
                                      let uu___7 =
                        ...
                        | (bounds_probs, rest) ->
                            let prefer_lower_bounds uu___8 =
                              let uu___9 =
                                let uu___10 =
                                  if flip
                                  then has_typeclass_constraint ctx_uvar wl
                                  else false in
                                if uu___10
                                then
                                  let uu___11 =
                                    let uu___12 =
                                      let uu___13 = whnf env this_rigid in
                                      FStarC_Syntax_Subst.compress uu___13 in
                            ...
                            then
                              ...
                              (let bounds_typs =
                                 let uu___9 = whnf env this_rigid in
                                 let uu___10 =
                                   FStarC_List.collect
                                     (fun uu___11 ->
                                        match uu___11 with
             ...
             (let uu___2 = should_run_meta_arg_tac rhs in
              ...
              then run_meta_arg_tac_and_try_again rhs
                ...
                (let rec occurs_bs u bs =
                 ...
                 match uu___3 with
                 | (FStar_Pervasives_Native.Some (binders_lhs, t_res_lhs),
                    FStar_Pervasives_Native.Some (binders_rhs, t_res_rhs)) ->
                     let uu___4 = lhs in
                     (match uu___4 with
                      | Flex
                          ({ FStarC_Syntax_Syntax.n = uu___5;
                             FStarC_Syntax_Syntax.pos = range;
                             FStarC_Syntax_Syntax.vars = uu___6;
                             FStarC_Syntax_Syntax.hash_code = uu___7;_},
                           u_lhs, uu___8)
                          ->
                          let uu___9 = occurs_bs u_lhs binders_lhs in
                          if uu___9
                          then
                            let uu___10 =
                              FStarC_Thunk.mkv
                            ...
                            (let uu___10 = rhs in
                             ...
                             | Flex (uu___11, u_rhs, uu___12) ->
                                 let uu___13 =
                                   ...
                                   if uu___14
                                   then binders_eq binders_lhs binders_rhs
                                   else false in
                                 if uu___13
                                 then
                                   let uu___14 =
                                    ...
                                    | (ctx_w, (ctx_l, ctx_r)) ->
                                        ...
                                        let zs =
                                          intersect_binders gamma_w
                                            (FStarC_List.op_At ctx_l
                                               binders_lhs)
                                            (FStarC_List.op_At ctx_r
                                               binders_rhs) in
                                        let new_uvar_typ =
                                          let uu___15 =
                                            FStarC_Syntax_Syntax.mk_Total
                                              t_res_lhs in
                                          FStarC_Syntax_Util.arrow zs uu___15 in
                                        let uu___15 =
                                          let uu___16 =
                                            let uu___17 =
                                              occurs u_lhs new_uvar_typ in
                                            FStar_Pervasives_Native.snd
                                              uu___17 in
                                          if uu___16
                                          then true
                                            ...
                                            (let uu___17 =
                                               let uu___18 =
                                                 FStarC_Syntax_Unionfind.equiv
                                                   u_lhs.FStarC_Syntax_Syntax.ctx_uvar_head
                                                   u_rhs.FStarC_Syntax_Syntax.ctx_uvar_head in
                                               Prims.op_Negation uu___18 in
                                             if uu___17
                                             then
                                               let uu___18 =
                                                 occurs u_rhs new_uvar_typ in
                                               FStar_Pervasives_Native.snd
                                                 uu___18
                                             else false) in
                                        if uu___15
                                        then
                                          let uu___16 =
                                            let uu___17 =
                                              let uu___18 =
                                                FStarC_Class_Show.show uu___0
                                                  wl.defer_ok in
                                              FStarC_Format.fmt1
                                                "flex-flex: occurs\n defer_ok=%s\n"
                                                uu___18 in
                                            FStarC_Thunk.mkv uu___17 in
                                          giveup_or_defer_flex_flex orig wl
                                            FStarC_TypeChecker_Common.Deferred_flex_flex_nonpattern
                                            uu___16
                                        else
                                                     ...
                                                     (let rc =
                                                      ...
                                                      then
                                                        ...
                                                        (let s2_sol =
                                                         ...
                                                         solve uu___21))))))))
                 | uu___4 ->
                     let uu___5 = FStarC_Thunk.mkv "flex-flex: non-patterns" in
                     giveup_or_defer orig wl
                       FStarC_TypeChecker_Common.Deferred_flex_flex_nonpattern
                       uu___5)))
                       ...
                       let uu___11 =
                         FStarC_List.for_all
                           (fun u ->
                              ...
                              Prims.op_Negation uu___12) us1 in
                       if uu___11
                       then
                         FStarC_List.for_all
                           (fun u ->
                              let uu___12 = universe_has_max env u in
                              Prims.op_Negation uu___12) us2
                       else false in
                         ...
                         (match uu___6 with
                          | (base2, refinement2) ->
                              (match (refinement1, refinement2) with
                                     ...
                                     solve_head_then wl2
                                       (fun ok wl3 ->
                                          ...
                                          then solve wl3
                                            ...
                                            (let uu___7 = mk_sub_probs wl3 in
                                             match uu___7 with
                                             | (subprobs, wl4) ->
                                                 let formula =
                                                   let uu___8 =
                                                   ...
                                                   (match uu___12 with
                                                    ...
                                                    | uu___13 ->
                                                        ...
                                                        ((let uu___15 =
                                                         ...
                                                         solve_t torig' wl2))))
                                     | uu___8 -> solve_sub_probs env1 wl2 in
                               ...
                               | uu___7 ->
                                   let lhs =
                                     force_refinement (base1, refinement1) in
                                   let rhs =
                                     force_refinement (base2, refinement2) in
                                   solve_t'
                                     {
                                       FStarC_TypeChecker_Common.pid =
                                         (problem.FStarC_TypeChecker_Common.pid);
         ...
         ((let uu___2 = FStarC_Effect.op_Bang dbg_Rel in
          ...
          (let uu___2 =
           ...
           | ((uu___3,
              ...
              (s, t)) ->
               let uu___9 =
                 let uu___10 = is_flex scrutinee in Prims.op_Negation uu___10 in
               if uu___9
               then
                    ...
                    (let pat_discriminates uu___11 =
                       ...
                       | ({
                            FStarC_Syntax_Syntax.v =
                              FStarC_Syntax_Syntax.Pat_constant uu___12;
                            FStarC_Syntax_Syntax.p = uu___13;_},
                          FStar_Pervasives_Native.None, uu___14) -> true
                       | ({
                            FStarC_Syntax_Syntax.v =
                              FStarC_Syntax_Syntax.Pat_cons uu___12;
                            FStarC_Syntax_Syntax.p = uu___13;_},
                          FStar_Pervasives_Native.None, uu___14) -> true
                       | uu___12 -> false in
                     let head_matching_branch =
                       FStarC_Util.try_find
                         (fun b ->
                            ...
                            then
                              let uu___11 = FStarC_Syntax_Subst.open_branch b in
                              match uu___11 with
                              | (uu___12, uu___13, t') ->
                                  let uu___14 =
                                    let uu___15 = p_env wl1 orig in
                                    head_matches_delta uu___15
                                      (p_logical orig) wl1.smt_ok s t' in
                                  (match uu___14 with
                                   | (FullMatch, uu___15) -> true
                                   | (HeadMatch uu___15, uu___16) -> true
                                   | uu___15 -> false)
                            else false) branches in
                     match head_matching_branch with
                     | FStar_Pervasives_Native.None ->
                         ((let uu___12 = FStarC_Effect.op_Bang dbg_Rel in
                           if uu___12
                           then
                             FStarC_Format.print_string
                          ...
                          (let try_branches =
                             let uu___12 =
                               FStarC_Util.prefix_until
                                 (fun b ->
                                    Prims.op_Negation (pat_discriminates b))
                                 branches in
                             match uu___12 with
                             | FStar_Pervasives_Native.Some
                                 (branches1, uu___13, uu___14) -> branches1
                             | uu___13 -> branches in
                           let uu___12 =
                           ...
                           FStar_Pervasives.Inr uu___12))
                     | FStar_Pervasives_Native.Some b ->
                         let uu___11 = FStarC_Syntax_Subst.open_branch b in
                         (match uu___11 with
                          | (p, uu___12, e) ->
                              ((let uu___14 = FStarC_Effect.op_Bang dbg_Rel in
                                if uu___14
                                then
                                  let uu___15 =
                                    FStarC_Class_Show.show
                               ...
                               (let uu___14 = try_solve_branch scrutinee p in
                           ...
                           (let uu___9 =
                            ...
                            | (base_prob, wl1) ->
                                ...
                                let mk_imp imp phi13 phi23 =
                                  let uu___10 = imp phi13 phi23 in
                                  guard_on_element wl1 problem x13 uu___10 in
                                  ...
                                  let impl =
                                    if
                                      problem.FStarC_TypeChecker_Common.relation
                                        = FStarC_TypeChecker_Common.EQ
                                    then
                                      mk_imp FStarC_Syntax_Util.mk_iff phi12
                                        phi22
                                    else
                                      mk_imp FStarC_Syntax_Util.mk_imp phi12
                                        phi22 in
                                  let guard =
                                    FStarC_Syntax_Util.mk_conj
                                   ...
                                   | (ref_prob, wl2) ->
                                       ...
                                       (match uu___11 with
                                        ...
                                        | Success
                                            ...
                                            let guard =
                                              let uu___13 =
                                                guard_on_element wl2 problem
                                                  x13 (p_guard ref_prob1) in
                                              FStarC_Syntax_Util.mk_conj
           ...
           ((let uu___8 = FStarC_Effect.op_Bang dbg_Rel in
            ...
            (let equal t11 t21 =
               ...
               | FStarC_TypeChecker_TermEqAndSimplify.Unknown ->
                   ...
                   let t12 =
                     norm_with_steps
                       "FStarC.TypeChecker.Rel.norm_with_steps.2" steps env
                       t11 in
                   let t22 =
                     norm_with_steps
                       "FStarC.TypeChecker.Rel.norm_with_steps.3" steps env
                       t21 in
                   let uu___8 =
                     FStarC_TypeChecker_TermEqAndSimplify.eq_tm env t12 t22 in
...
let no_lemma_pats (c : FStarC_Syntax_Syntax.comp) :
  ...
  let nil = FStarC_Syntax_Syntax.tdataconstr FStarC_Parser_Const.nil_lid in
  match c.FStarC_Syntax_Syntax.n with
  | FStarC_Syntax_Syntax.Comp ct when FStarC_Syntax_Util.is_lemma_comp c ->
      let args =
        match ct.FStarC_Syntax_Syntax.effect_args with
        | pre::post::uu___::rest -> pre :: post ::
            (nil, FStar_Pervasives_Native.None) :: rest
        | uu___ -> ct.FStarC_Syntax_Syntax.effect_args in
      {
          ...
          (FStarC_Syntax_Syntax.Comp
             {
               ...
               FStarC_Syntax_Syntax.result_typ =
                 (ct.FStarC_Syntax_Syntax.result_typ);
               FStarC_Syntax_Syntax.effect_args = args;
...
let solve_c_aux
  ...
  let solve_eq c1_comp c2_comp g_lift =
    ...
    then
      ...
      if
        (FStarC_List.length c1_comp.FStarC_Syntax_Syntax.effect_args) <>
          (FStarC_List.length c2_comp.FStarC_Syntax_Syntax.effect_args)
      then
        (let uu___1 =
           mklstr
             (fun uu___2 ->
                ...
                FStarC_Format.fmt2 "incompatible effect arguments: %s <> %s"
                  uu___3 uu___4) in
         giveup wl uu___1 orig)
      else
        (let uu___1 =
                    ...
                    let uu___3 =
                      ...
                      let uu___5 =
                        FStarC_Syntax_Syntax.mk
                          ...
                          FStarC_Range_Type.dummyRange in
                      sub_prob wl1 uu___4 FStarC_TypeChecker_Common.EQ uu___5
                        "effect universes" in
                    (match uu___3 with
                     | (p, wl2) ->
                         let uu___4 =
                           FStarC_Class_Monoid.op_Plus_Plus
                             (FStarC_CList.monoid_clist ()) univ_sub_probs
                             (FStarC_Class_Listlike.cons
                                (FStarC_CList.listlike_clist ()) p
                                (FStarC_Class_Listlike.empty
                                   (FStarC_CList.listlike_clist ()))) in
                         (uu___4, wl2)))
             ((FStarC_Class_Listlike.empty (FStarC_CList.listlike_clist ())),
              ...
              | (ret_sub_prob, wl2) ->
                  let uu___3 =
                    FStarC_List.fold_right2
                      (fun uu___4 uu___5 uu___6 ->
                         match (uu___4, uu___5, uu___6) with
                         | ((a1, uu___7), (a2, uu___8), (arg_sub_probs, wl3))
                             ->
                             let uu___9 =
                               sub_prob wl3 a1 FStarC_TypeChecker_Common.EQ
                                 a2 "effect arg" in
                             (match uu___9 with
                              | (p, wl4) ->
                                  ((FStarC_Class_Listlike.cons
                      ...
                      ((FStarC_Class_Listlike.empty
                          (FStarC_CList.listlike_clist ())), wl2) in
                  (match uu___3 with
                   | (arg_sub_probs, wl3) ->
                       let sub_probs =
                         let uu___4 =
                           let uu___5 =
                             ...
                             FStarC_Class_Monoid.op_Plus_Plus
                               (FStarC_CList.monoid_clist ()) arg_sub_probs
                               uu___6 in
                           FStarC_Class_Listlike.cons
                             (FStarC_CList.listlike_clist ()) ret_sub_prob
                             uu___5 in
                         FStarC_Class_Monoid.op_Plus_Plus
                           (FStarC_CList.monoid_clist ()) univ_sub_probs
                           uu___4 in
                       let sub_probs1 =
                         FStarC_Class_Listlike.to_list
                           (FStarC_CList.listlike_clist ()) sub_probs in
                       let guard =
                         let guard1 =
                           let uu___4 = FStarC_List.map p_guard sub_probs1 in
                           FStarC_Syntax_Util.mk_conj_l uu___4 in
                       ...
                       let wl5 =
                         solve_prob orig (FStar_Pervasives_Native.Some guard)
                           [] wl4 in
                       let uu___4 = attempt sub_probs1 wl5 in solve uu___4))) in
  let should_fail_since_repr_subcomp_not_allowed repr_subcomp_allowed c11 c21
    =
    let uu___ =
  ...
  let solve_layered_sub c11 c21 =
    (let uu___1 = FStarC_Effect.op_Bang dbg_LayeredEffectsApp in
     if uu___1
     then
       let uu___2 =
       ...
       let uu___3 =
         ...
         FStarC_Class_Show.show FStarC_Syntax_Print.showable_comp uu___4 in
       FStarC_Format.print2 "solve_layered_sub c1: %s and c2: %s {\n" uu___2
         uu___3
     else ());
    if
      problem.FStarC_TypeChecker_Common.relation =
       ...
       then
         ...
         (let subcomp_name =
          ...
          let lift_c1 edge =
            ...
            match uu___2 with
            | (c, g) ->
                let uu___3 = FStarC_TypeChecker_Env.comp_to_comp_typ env c in
                (uu___3, g) in
          let uu___2 =
            let uu___3 =
                      ...
                      | (c12, g_lift) ->
                          let ed2 =
                            FStarC_TypeChecker_Env.get_effect_decl env
                              c21.FStarC_Syntax_Syntax.effect_name in
                          let uu___6 =
                            match FStarC_Syntax_Util.get_stronger_vc_combinator
                                    ed2
                            with
                            | (ts, kopt) ->
                                let uu___7 =
                                  let uu___8 =
                                    ...
                                    FStar_Pervasives_Native.snd uu___9 in
                                  FStar_Pervasives_Native.Some uu___8 in
                                let uu___8 = FStarC_Option.must kopt in
                                (uu___7, uu___8) in
                          (match uu___6 with
                           | (tsopt, k) ->
                               let num_eff_params =
                               ...
                               (c12, g_lift, tsopt, k, num_eff_params, false))))
            | FStar_Pervasives_Native.Some (t, kind) ->
                ...
                (c11, FStarC_TypeChecker_Env.trivial_guard, uu___4, kind,
                  Prims.int_zero, true) in
          match uu___2 with
          | (c12, g_lift, stronger_t_opt, kind, num_eff_params,
             is_polymonadic) ->
              if FStar_Pervasives_Native.uu___is_None stronger_t_opt
              then
                let uu___3 =
                  mklstr
                    (fun uu___4 ->
                ...
                (let stronger_t = FStarC_Option.must stronger_t_opt in
                 let wl1 =
                    ...
                    let uu___5 =
                      ...
                      FStarC_Format.fmt3
                        ...
                        (FStarC_Ident.string_of_lid
                           c12.FStarC_Syntax_Syntax.effect_name)
                        (FStarC_Ident.string_of_lid
                           c21.FStarC_Syntax_Syntax.effect_name) uu___6 in
                    FStarC_Errors.raise_error
                 ...
                 (let uu___4 =
                    ...
                    then ([], wl1)
                      ...
                      (let rec is_uvar t =
                         let uu___5 =
                           ...
                           uu___6.FStarC_Syntax_Syntax.n in
                         match uu___5 with
                         | FStarC_Syntax_Syntax.Tm_uvar (uv, uu___6) ->
                             let uu___7 =
                               FStarC_TypeChecker_DeferredImplicits.should_defer_uvar_to_user_tac
                                 env uv in
                             Prims.op_Negation uu___7
                         | FStarC_Syntax_Syntax.Tm_uinst (t1, uu___6) ->
                             is_uvar t1
                         | FStarC_Syntax_Syntax.Tm_app
                             { FStarC_Syntax_Syntax.hd = t1;
                               FStarC_Syntax_Syntax.arg = uu___6;_}
                             -> is_uvar t1
                         | uu___6 -> false in
                       FStarC_List.fold_right2
                         (fun uu___5 uu___6 uu___7 ->
                  ...
                  | (is_sub_probs, wl2) ->
                      ...
                      (match uu___5 with
                       | (ret_sub_prob, wl3) ->
                           let uu___6 =
                             FStarC_Syntax_Util.arrow_formals_comp stronger_t in
                           (match uu___6 with
                            | (bs, subcomp_c) ->
                                let uu___7 =
                                  if
                                  ...
                                  then
                                    ...
                                    apply_substitutive_indexed_subcomp env
                                      kind bs subcomp_c c12 c21 sub_prob
                                      num_eff_params wl3 subcomp_name r in
                                (match uu___7 with
                                 | (fml, sub_probs, wl4) ->
                                     let sub_probs1 = ret_sub_prob ::
                                       (FStarC_List.op_At is_sub_probs
                                          sub_probs) in
                                     let guard =
                                       let guard1 =
                                         let uu___8 =
                                           FStarC_List.map p_guard sub_probs1 in
                                         FStarC_Syntax_Util.mk_conj_l uu___8 in
                                       let guard2 =
                                         ...
                                         | FStarC_TypeChecker_Common.NonTrivial
                                             ...
                                             FStarC_Syntax_Util.mk_conj
                                               guard1 f in
                                       FStarC_Syntax_Util.mk_conj guard2 fml in
                                     let wl5 =
                                       solve_prob orig
                                         (FStar_Pervasives_Native.Some guard)
                                         [] wl4 in
                                     ((let uu___9 =
                                         FStarC_Effect.op_Bang
                                           dbg_LayeredEffectsApp in
                                       if uu___9
                                       then FStarC_Format.print_string "}\n"
                                       else ());
                                      (let uu___9 = attempt sub_probs1 wl5 in
                                       solve uu___9))))))))) in
           ...
           FStarC_Syntax_Syntax.mk_Comp
             {
               ...
               FStarC_Syntax_Syntax.effect_args =
                 (c12.FStarC_Syntax_Syntax.effect_args);
               FStarC_Syntax_Syntax.flags = (c12.FStarC_Syntax_Syntax.flags)
             } in
         (edge.FStarC_TypeChecker_Env.mlift).FStarC_TypeChecker_Env.mlift_wp
           env uu___3 in
       match uu___2 with
       ...
       (let is_null_wp_2 =
          FStarC_Util.for_some
            (fun uu___2 ->
               ...
               | uu___3 -> false) c21.FStarC_Syntax_Syntax.flags in
        let uu___2 =
          match ((c11.FStarC_Syntax_Syntax.effect_args),
                  (c21.FStarC_Syntax_Syntax.effect_args))
          with
          | ((wp1, uu___3)::uu___4, (wp2, uu___5)::uu___6) -> (wp1, wp2)
          | uu___3 ->
              let uu___4 =
                let uu___5 =
                  FStarC_Class_Show.show FStarC_Ident.showable_lident
                ...
                let uu___6 =
                  FStarC_Class_Show.show FStarC_Ident.showable_lident
                    c21.FStarC_Syntax_Syntax.effect_name in
                FStarC_Format.fmt2
                  "Got effects %s and %s, expected normalized effects" uu___5
                  uu___6 in
              FStarC_Errors.raise_error FStarC_TypeChecker_Env.hasRange_env
                env FStarC_Errors_Codes.Fatal_ExpectNormalizedEffect ()
                (Obj.magic FStarC_Errors_Msg.is_error_message_string)
                (Obj.magic uu___4) in
        match uu___2 with
        | (wpc1, wpc2) ->
            if FStarC_Util.physical_equality wpc1 wpc2
            then
              let uu___3 =
                problem_using_guard orig c11.FStarC_Syntax_Syntax.result_typ
                  problem.FStarC_TypeChecker_Common.relation
              ...
              (let uu___3 =
               ...
               | (c2_decl, qualifiers) ->
                   if
                     FStarC_List.contains FStarC_Syntax_Syntax.Reifiable
                       qualifiers
                   then
                     let c1_repr =
                       let uu___4 =
                         let uu___5 =
                           let uu___6 = lift_c1 () in
                           FStarC_Syntax_Syntax.mk_Comp uu___6 in
                         let uu___6 =
                           env.FStarC_TypeChecker_Env.universe_of env
                             c11.FStarC_Syntax_Syntax.result_typ in
                         FStarC_TypeChecker_Env.reify_comp env uu___5 uu___6 in
                       norm_with_steps
                         "FStarC.TypeChecker.Rel.norm_with_steps.4"
                         [FStarC_TypeChecker_Env.UnfoldUntil
                            FStarC_Syntax_Syntax.delta_constant;
                         FStarC_TypeChecker_Env.Weak;
                         FStarC_TypeChecker_Env.HNF] env uu___4 in
                     let c2_repr =
                       let uu___4 =
                         let uu___5 = FStarC_Syntax_Syntax.mk_Comp c21 in
                         let uu___6 =
                           env.FStarC_TypeChecker_Env.universe_of env
                     ...
                     let uu___4 =
                       let uu___5 =
                         ...
                         FStarC_Format.fmt2 "sub effect repr: %s <: %s"
                           uu___6 uu___7 in
                       sub_prob wl c1_repr
                         problem.FStarC_TypeChecker_Common.relation c2_repr
                         uu___5 in
                     (match uu___4 with
                      | (prob, wl1) ->
                          let wl2 =
                            solve_prob orig
                              (FStar_Pervasives_Native.Some (p_guard prob))
                              [] wl1 in
                          let uu___5 = attempt [prob] wl2 in solve uu___5)
                   else
                     (let g =
                        let uu___4 = FStarC_Options.admit_smt_queries () in
                        if uu___4
                        then FStarC_Syntax_Util.t_true
                        else
                          (let wpc1_2 =
                             let uu___5 = lift_c1 () in
                             FStarC_List.hd
                               uu___5.FStarC_Syntax_Syntax.effect_args in
                           if is_null_wp_2
                           then
                             ((let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                               if uu___6
                              ...
                              (let c1_univ =
                                 env.FStarC_TypeChecker_Env.universe_of env
                                   c11.FStarC_Syntax_Syntax.result_typ in
                               let trivial =
                                 match FStarC_Syntax_Util.get_wp_trivial_combinator
                                         c2_decl
                                 with
                                 | FStar_Pervasives_Native.None ->
                                     FStarC_Effect.failwith
                               ...
                               FStarC_Syntax_Syntax.mk_Tm_app uu___6
                                 [FStarC_Syntax_Syntax.as_arg
                                    c11.FStarC_Syntax_Syntax.result_typ;
                                 wpc1_2] r))
                           else
                             (let c2_univ =
                              ...
                              FStarC_Syntax_Syntax.mk_Tm_app uu___5
                                [FStarC_Syntax_Syntax.as_arg
                                   c21.FStarC_Syntax_Syntax.result_typ;
                                FStarC_Syntax_Syntax.as_arg wpc2;
                                wpc1_2] r)) in
                      (let uu___5 = FStarC_Effect.op_Bang dbg_Rel in
                       if uu___5
                       then
                      ...
                      (let uu___5 =
                       ...
                       | (base_prob, wl1) ->
                           let wl2 =
                             ...
                             solve_prob orig uu___6 [] wl1 in
                           let uu___6 = attempt [base_prob] wl2 in
                           solve uu___6))))) in
     ...
     (let uu___1 =
      ...
      | (c11, c21) ->
          (match ((c11.FStarC_Syntax_Syntax.n), (c21.FStarC_Syntax_Syntax.n))
           with
           | (FStarC_Syntax_Syntax.GTotal t1, FStarC_Syntax_Syntax.Total t2)
               when FStarC_TypeChecker_Env.non_informative env t2 ->
               let uu___2 =
                 problem_using_guard orig t1
                   problem.FStarC_TypeChecker_Common.relation t2
                   FStar_Pervasives_Native.None "result type" in
               solve_t uu___2 wl
           | (FStarC_Syntax_Syntax.GTotal uu___2, FStarC_Syntax_Syntax.Total
              uu___3) ->
               let uu___4 =
                 FStarC_Thunk.mkv "incompatible monad ordering: GTot </: Tot" in
           ...
           | (FStarC_Syntax_Syntax.GTotal t1, FStarC_Syntax_Syntax.GTotal t2)
               ...
               let uu___2 =
                 problem_using_guard orig t1
                   ...
                   FStar_Pervasives_Native.None "result type" in
               solve_t uu___2 wl
           | (FStarC_Syntax_Syntax.Total t1, FStarC_Syntax_Syntax.GTotal t2)
               when
               problem.FStarC_TypeChecker_Common.relation =
                 FStarC_TypeChecker_Common.SUB
               ->
           ...
           | (FStarC_Syntax_Syntax.Total t1, FStarC_Syntax_Syntax.GTotal t2)
               ->
               let uu___2 = FStarC_Thunk.mkv "GTot =/= Tot" in
               giveup wl uu___2 orig
           | (FStarC_Syntax_Syntax.GTotal uu___2, FStarC_Syntax_Syntax.Comp
              uu___3) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
                   ...
                   FStarC_Syntax_Syntax.mk_Comp uu___6 in
                 {
                   FStarC_TypeChecker_Common.pid =
                     (problem.FStarC_TypeChecker_Common.pid);
                   FStarC_TypeChecker_Common.lhs = uu___5;
                   FStarC_TypeChecker_Common.relation =
                     (problem.FStarC_TypeChecker_Common.relation);
                   FStarC_TypeChecker_Common.rhs =
                     (problem.FStarC_TypeChecker_Common.rhs);
               ...
               solve_c uu___4 wl
           | (FStarC_Syntax_Syntax.Total uu___2, FStarC_Syntax_Syntax.Comp
              uu___3) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
               ...
               solve_c uu___4 wl
           | (FStarC_Syntax_Syntax.Comp uu___2, FStarC_Syntax_Syntax.GTotal
              uu___3) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
                   ...
                   FStarC_Syntax_Syntax.mk_Comp uu___6 in
                 {
                   ...
                   FStarC_TypeChecker_Common.relation =
                     (problem.FStarC_TypeChecker_Common.relation);
                   FStarC_TypeChecker_Common.rhs = uu___5;
                   FStarC_TypeChecker_Common.element =
                     (problem.FStarC_TypeChecker_Common.element);
                   FStarC_TypeChecker_Common.logical_guard =
                     (problem.FStarC_TypeChecker_Common.logical_guard);
               ...
               solve_c uu___4 wl
           | (FStarC_Syntax_Syntax.Comp uu___2, FStarC_Syntax_Syntax.Total
              uu___3) ->
               let uu___4 =
                 let uu___5 =
                   let uu___6 =
               ...
               then
                 ...
                 (let c1_comp =
                  ...
                  then
                    ...
                    (let c12 =
                       FStarC_TypeChecker_Env.unfold_effect_abbrev env c11 in
                     let c22 =
                       FStarC_TypeChecker_Env.unfold_effect_abbrev env c21 in
                     (let uu___6 = FStarC_Effect.op_Bang dbg_Rel in
                      if uu___6
                      then
...
let guard_to_string (env : FStarC_TypeChecker_Env.env)
  ...
  | (FStarC_TypeChecker_Common.Trivial, FStarC_Class_Listlike.VNil) when
      let uu___ =
        let uu___2 = FStarC_Options.print_implicits () in
           ...
           FStarC_Options.with_saved_options
             (fun uu___2 ->
                ...
                (env1.FStarC_TypeChecker_Env.solver).FStarC_TypeChecker_Env.solve
                  use_env_range_msg env1 goal)) vcs
let discharge_guard'
  (use_env_range_msg : (unit -> Prims.string) FStar_Pervasives_Native.option)
  (env : FStarC_TypeChecker_Env.env) (g : FStarC_TypeChecker_Common.guard_t)
  (use_smt : Prims.bool) :
  ...
  | { FStarC_TypeChecker_Common.imp_reason = imp_reason;
      ...
      ((let uu___3 = FStarC_Effect.op_Bang dbg_Rel in
       ...
       (let env1 =
          ...
          FStarC_Errors.with_ctx "While checking implicit solution"
            (fun uu___4 ->
               ...
               then
                 (if is_tac
                  then (FStarC_TypeChecker_Env.trivial_guard, empty_cb)
                    ...
                    (let imp_tm1 =
                     ...
                     match uu___5 with
                     | (k', g) ->
                         let uu___6 = get_subtyping_predicate env1 k' uvar_ty in
                         (match uu___6 with
                          | FStar_Pervasives_Native.None ->
                              let uu___7 =
                 ...
                 (let uu___5 =
                    env1.FStarC_TypeChecker_Env.core_check env1 imp_tm
                      uvar_ty must_tot in
                  match uu___5 with
        ...
        | (g, cb) ->
            let uu___4 =
              if Prims.op_Negation force_univ_constraints
              then
                     ...
                     (FStar_Pervasives_Native.Some
                        (fun uu___6 ->
                           ...
                           FStarC_Format.fmt4
                             ...
                             uu___7 uu___8 imp_reason uu___9)) env1 g true in
                 match uu___5 with
...
let is_tac_implicit_resolved (env : FStarC_TypeChecker_Env.env)
  ...
  FStarC_Class_Setlike.for_all
    ...
    (fun uv ->
       ...
       FStarC_Syntax_Syntax.uu___is_Allow_unresolved uu___2) uu___
                       ...
                       ((let uu___7 = FStarC_Effect.op_Bang dbg_Rel in
                        ...
                        if
                          FStarC_Syntax_Syntax.uu___is_Allow_unresolved
                            uvar_decoration_should_check
                        then until_fixpoint (out, true, defer_open_metas) tl
                        else
                          if
                            (let uu___7 = unresolved ctx_u in
                             if uu___7
                          ...
                          then
                            (let uu___7 =
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 let is_open =
                                   let uu___8 = has_free_uvars typ in
                                   if uu___8
                                   then true
                                   else
                                 ...
                                 then
                                   ...
                                   (let uu___8 =
                                    ...
                                    then
                                      ...
                                      (let solve_with t =
                                         let extra =
                                           let uu___9 = teq_nosmt env1 t tm in
                                           match uu___9 with
                                           | FStar_Pervasives_Native.None ->
                                               FStarC_Effect.failwith
                                       ...
                                       then
                                         let uu___10 =
                                           meta_arg_cache_lookup tac env1 typ in
                                         match uu___10 with
                                         ...
                                         | FStar_Pervasives_Native.None ->
                                             ...
                                             (meta_arg_cache_result tac env1
                                                typ t;
                                              solve_with t)
                                       else
                                         (let t = run_meta_arg_tac env1 ctx_u in
                                          solve_with t))))
                          else
                            if unresolved ctx_u
                            then
                                          ...
                                          let uu___8 =
                                            let uu___9 =
                                              ...
                                              FStarC_List.map
                                                ...
                                                uu___10 in
                                            FStarC_List.op_At uu___9 out in
                                          (uu___8, true, defer_open_metas) in
         ...
         let uu___4 =
           let uu___5 =
             ...
             FStar_Pprint.prefix (Prims.of_int 4) Prims.int_one
               (FStarC_Errors_Msg.text "Failed to resolve implicit argument")
               uu___6 in
           let uu___6 =
             let uu___7 =
               let uu___8 =
                 let uu___9 =
                   FStarC_Syntax_Util.ctx_uvar_typ
                     imp.FStarC_TypeChecker_Common.imp_uvar in
                 FStarC_TypeChecker_Normalize.term_to_doc env uu___9 in
               FStar_Pprint.prefix (Prims.of_int 4) Prims.int_one
                 (FStarC_Errors_Msg.text "of type") uu___8 in
...
let layered_effect_teq (env : FStarC_TypeChecker_Env.env)
  ...
  (let uu___2 = FStarC_Effect.op_Bang dbg_LayeredEffectsEqns in
   ...
   then
     let uu___3 =
       if FStar_Pervasives_Native.uu___is_None reason
       then "_"
