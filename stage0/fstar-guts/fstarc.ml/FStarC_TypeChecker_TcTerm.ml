...
let rec tc_term (env : FStarC_TypeChecker_Env.env)
  ...
  (let do1 uu___1 =
   ...
   let uu___1 =
     let uu___2 = FStarC_Debug.medium () in Prims.op_Negation uu___2 in
   if uu___1
   then do1 ()
   else
     ((let uu___4 =
       ...
       let uu___7 =
         ...
         FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term uu___8 in
       let uu___8 = print_expected_ty_str env in
       FStarC_Format.print5
         "(%s) Starting tc_term (phase1=%s) of %s (%s), %s {\n" uu___4 uu___5
         uu___6 uu___7 uu___8);
      (let uu___4 = FStarC_Timing.record_ms do1 in
       match uu___4 with
       | (r, ms) ->
           ((let uu___6 =
               let uu___7 = FStarC_TypeChecker_Env.get_range env in
               FStarC_Class_Show.show FStarC_Range_Ops.showable_range uu___7 in
             let uu___7 =
               FStarC_Class_Show.show FStarC_Syntax_Print.showable_term e in
             let uu___8 =
             ...
             | (e1, lc, uu___7) ->
                 ((let uu___9 =
                   ...
                   let uu___10 =
                     FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                       e1 in
                   let uu___11 = FStarC_TypeChecker_Common.lcomp_to_string lc in
                   let uu___12 =
                     let uu___13 = FStarC_Syntax_Subst.compress e1 in
                     FStarC_Class_Tagged.tag_of
                       FStarC_Syntax_Syntax.tagged_term uu___13 in
             ...
             let uu___7 =
               let fallback env2 =
                 ...
                 | FStar_Pervasives_Native.Some e1 ->
                     let uu___8 = tc_term env2 e1 in
                     (match uu___8 with
                      | (uu___9, lc, uu___10) ->
                          let uu___11 =
                            let uu___12 =
                              FStarC_TypeChecker_Util.head_fv_of_typ env2
                                lc.FStarC_TypeChecker_Common.res_typ in
                            FStarC_TypeChecker_Util.find_record_or_dc_from_head_fv
                              env2 uu___12 uc top.FStarC_Syntax_Syntax.pos in
                          (uu___11,
                            (FStar_Pervasives_Native.Some
                 ...
                 | FStar_Pervasives_Native.None ->
                     let uu___8 =
                       FStarC_TypeChecker_Util.find_record_or_dc_from_head_fv
                         env2 FStar_Pervasives_Native.None uc
                         top.FStarC_Syntax_Syntax.pos in
               ...
               | FStar_Pervasives_Native.Some (t, uu___9) ->
                   let uu___10 =
                     FStarC_TypeChecker_Util.head_fv_of_typ env1 t in
                   (match uu___10 with
                    | FStar_Pervasives_Native.None ->
                        let uu___11 =
                          let uu___12 =
                    ...
                    | hfv ->
                        let uu___11 =
                          FStarC_TypeChecker_Util.find_record_or_dc_from_head_fv
                            env1 hfv uc top.FStarC_Syntax_Syntax.pos in
                        (uu___11,
                          (FStar_Pervasives_Native.Some
                             (FStar_Pervasives.Inl t))))
               | FStar_Pervasives_Native.None -> fallback env1 in
             (match uu___7 with
              | ((rdc, constrname, constructor), topt) ->
                  let rdc1 = rdc in
                  ((let uu___9 =
                      (let uu___10 = FStarC_TypeChecker_Env.expected_typ env1 in
                       FStar_Pervasives_Native.uu___is_Some uu___10) &&
                   ...
                   (let constructor1 =
                    ...
                    let mk_field_projector i x =
                      ...
                      let candidate =
                        ...
                        FStarC_Syntax_Syntax.fvar uu___9 qual in
  ...
  let rec check_nested_pattern env1 p t =
    ...
    (let id t1 =
     ...
     | FStarC_Syntax_Syntax.Pat_cons
         ...
         ->
         let uu___2 =
           let uu___3 = FStarC_TypeChecker_Util.head_fv_of_typ env1 t in
           FStarC_TypeChecker_Util.find_record_or_dc_from_head_fv env1 uu___3
             uc p.FStarC_Syntax_Syntax.p in
         (match uu___2 with
           ...
           (match uu___1 with
            | (g11, e11, univ_vars1, c11) ->
                let uu___2 =
                  let uu___3 =
                    let uu___4 =
                      FStarC_TypeChecker_Env.push_univ_vars env1 univ_vars1 in
                    FStarC_TypeChecker_Util.check_top_level uu___4 g11 c11 in
                  match uu___3 with
                  | (ok, c12) ->
                      if ok
                      then (e2, c12)
                      ...
                      | (lbs3, g_lbs) ->
                          ...
                          let uu___4 =
                            ...
                            then
                              ...
                              let uu___5 =
                                let uu___6 = FStarC_List.hd lbs4 in
                                uu___6.FStarC_Syntax_Syntax.lbunivs in
                              (uu___5, lbs4, g_lbs1)
                            else
                              (let ecs =
                                 let uu___6 =
                               ...
                               let g_lbs2 =
                                 FStarC_TypeChecker_Rel.resolve_generalization_implicits
                                   env1 g_lbs1 in
                               let uu___6 =
                                 let uu___7 = FStarC_List.hd lbs4 in
                                 uu___7.FStarC_Syntax_Syntax.lbunivs in
                               (uu___6, lbs4, g_lbs2)) in
                          (match uu___4 with
                           | (univ_vars, lbs4, g_lbs2) ->
                               let cres =
                                 let uu___5 =
                                   FStarC_Syntax_Syntax.mk_Total
                                     FStarC_Syntax_Syntax.t_unit in
                    ...
                    | FStar_Pervasives_Native.None ->
                        let uu___4 =
                          FStarC_TypeChecker_Env.push_univ_vars env1
                            univ_vars in
                        ((FStar_Pervasives_Native.Some univ_vars), uu___4)
                    | FStar_Pervasives_Native.Some uvs ->
                        let uu___4 =
                          ((FStarC_List.length uvs) <>
                             (FStarC_List.length univ_vars))
                            ||
                            (let uu___5 =
                               FStarC_List.forall2
                                 (fun u1 u2 ->
                                    FStarC_Ident.ident_equals u1 u2) uvs
                                 univ_vars in
                             Prims.op_Negation uu___5) in
                        if uu___4
                        then
                          let uu___5 =
                            let uu___6 =
                              FStarC_Errors_Msg.text
                                "Mutually recursive functions must all have the same universe variables in their type annotation" in
                            [uu___6] in
                          FStarC_Errors.raise_error
                            (FStarC_Syntax_Syntax.has_range_syntax ()) lbtyp
                   ...
                   | (univ_vars_acc1, env2) ->
                       let uu___4 =
                         ...
                         then (g_acc, lbtyp)
                           ...
                           (let uu___6 = check_annot univ_vars lbtyp in
                            match uu___6 with
                            | (uu___7, g, t) ->
                                let uu___8 =
                                  FStarC_Class_Monoid.op_Plus_Plus
                       ...
                       (match uu___4 with
                        | (g, lbtyp1) ->
                            ...
                            (match uu___5 with
                             | (lb1, env3) ->
                                 (univ_vars_acc1, (lb1 :: lbs1), env3, g))))))
      (FStar_Pervasives_Native.None, [], env,
        (FStarC_Class_Monoid.mzero FStarC_TypeChecker_Common.monoid_guard_t))
      lbs in
  match uu___ with
  | (uu___1, lbs1, env1, g) -> ((FStarC_List.rev lbs1), env1, g)
