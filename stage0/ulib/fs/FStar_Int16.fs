module FStar_Int16
(* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! *)
(* THIS FILE IS BASED ON AUTOGENERATED ml/FStar_Int16.ml FILE! *)
(* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! *)
...
let int_to_t x = System.Int16.Parse((string x))
...
let zero = 0s
let one  = 1s
let ones = System.Int16.MaxValue
...
let of_string : string -> t = System.Int16.Parse
