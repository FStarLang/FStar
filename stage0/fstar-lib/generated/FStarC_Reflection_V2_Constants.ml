...
let (fstar_syntax_syntax_lid :
  ...
  fun s ->
    FStarC_Ident.lid_of_path
      (FStarC_Compiler_List.op_At ["FStar"; "Stubs"; "Syntax"; "Syntax"] s)
      ...
      let uu___10 =
        let uu___11 =
          FStarC_Ident.mk_ident
            ("uniq", FStarC_Compiler_Range_Type.dummyRange) in
        let uu___12 =
          let uu___13 =
            FStarC_Ident.mk_ident
              ("sort", FStarC_Compiler_Range_Type.dummyRange) in
          let uu___14 =
            let uu___15 =
              FStarC_Ident.mk_ident
                ("ppname", FStarC_Compiler_Range_Type.dummyRange) in
            [uu___15] in
          uu___13 :: uu___14 in
        uu___11 :: uu___12 in
      (uu___9, uu___10) in
  ...
  let attr =
    let uu___ =
      ...
      let uu___10 =
        let uu___11 =
          FStarC_Ident.mk_ident
            ("index", FStarC_Compiler_Range_Type.dummyRange) in
        let uu___12 =
          let uu___13 =
            FStarC_Ident.mk_ident
              ("sort", FStarC_Compiler_Range_Type.dummyRange) in
    ...
    let uu___ =
      ...
      let uu___10 =
        ...
        let uu___12 =
          let uu___13 =
            FStarC_Ident.mk_ident
              ("qual", FStarC_Compiler_Range_Type.dummyRange) in
          let uu___14 =
            let uu___15 =
              FStarC_Ident.mk_ident
                ("attrs", FStarC_Compiler_Range_Type.dummyRange) in
            let uu___16 =
              let uu___17 =
                FStarC_Ident.mk_ident
                  ("ppname", FStarC_Compiler_Range_Type.dummyRange) in
