...
let (e_bv : FStarC_Syntax_Syntax.bv FStarC_TypeChecker_NBETerm.embedding) =
  let embed_bv cb bv =
    mk_lazy cb bv FStarC_Reflection_V1_Constants.fstar_refl_bv
  ...
  mk_emb' embed_bv unembed_bv FStarC_Reflection_V1_Constants.fstar_refl_bv_fv
let (e_binder :
  FStarC_Syntax_Syntax.binder FStarC_TypeChecker_NBETerm.embedding) =
  let embed_binder cb b =
    mk_lazy cb b FStarC_Reflection_V1_Constants.fstar_refl_binder
  ...
  mk_emb' embed_binder unembed_binder
    FStarC_Reflection_V1_Constants.fstar_refl_binder_fv
let rec mapM_opt :
  'a 'b .
  ...
  fun aq ->
      ...
      | uu___ -> FStar_Pervasives_Native.None in
    {
      ...
      FStarC_TypeChecker_NBETerm.typ =
        (fun uu___ ->
           mkFV FStarC_Reflection_V1_Constants.fstar_refl_term_fv [] []);
      FStarC_TypeChecker_NBETerm.e_typ =
        (fun uu___ ->
           fv_as_emb_typ FStarC_Reflection_V1_Constants.fstar_refl_term_fv)
    }
...
let (e_aqualv :
  ...
  let embed_aqualv cb q =
    ...
    | FStarC_Reflection_V1_Data.Q_Explicit ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Q_Explicit.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Q_Implicit ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Q_Implicit.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Q_Meta t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Q_Meta.FStarC_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed_aqualv cb t =
    ...
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        -> FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.Q_Explicit
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
          FStarC_Reflection_V1_Constants.ref_Q_Implicit.FStarC_Reflection_V1_Constants.lid
        -> FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.Q_Implicit
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], (t1, uu___)::[]) when
        ...
        FStarC_Compiler_Util.bind_opt uu___1
          (fun t2 ->
             FStar_Pervasives_Native.Some
               (FStarC_Reflection_V1_Data.Q_Meta t2))
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
  ...
  FStarC_TypeChecker_NBETerm.mk_emb embed_aqualv unembed_aqualv
    (fun uu___ ->
       mkConstruct FStarC_Reflection_V1_Constants.fstar_refl_aqualv_fv [] [])
    (fun uu___ ->
       fv_as_emb_typ FStarC_Reflection_V1_Constants.fstar_refl_aqualv_fv)
let (e_binders :
...
let (e_fv : FStarC_Syntax_Syntax.fv FStarC_TypeChecker_NBETerm.embedding) =
  let embed_fv cb fv =
    mk_lazy cb fv FStarC_Reflection_V1_Constants.fstar_refl_fv
    ...
    | uu___ ->
        ((let uu___2 =
          ...
          FStarC_Errors.log_issue0 FStarC_Errors_Codes.Warning_NotEmbedded ()
            ...
            (Obj.magic uu___2));
         FStar_Pervasives_Native.None) in
  mk_emb' embed_fv unembed_fv FStarC_Reflection_V1_Constants.fstar_refl_fv_fv
let (e_comp : FStarC_Syntax_Syntax.comp FStarC_TypeChecker_NBETerm.embedding)
  =
  let embed_comp cb c =
    mk_lazy cb c FStarC_Reflection_V1_Constants.fstar_refl_comp
  ...
  mk_emb' embed_comp unembed_comp
    FStarC_Reflection_V1_Constants.fstar_refl_comp_fv
let (e_env : FStarC_TypeChecker_Env.env FStarC_TypeChecker_NBETerm.embedding)
  =
  let embed_env cb e =
    mk_lazy cb e FStarC_Reflection_V1_Constants.fstar_refl_env
...
let (e_const :
  FStarC_Reflection_V1_Data.vconst FStarC_TypeChecker_NBETerm.embedding) =
  let embed_const cb c =
    match c with
    | FStarC_Reflection_V1_Data.C_Unit ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Unit.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.C_True ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_True.FStarC_Reflection_V1_Constants.fv
          [] []
    ...
    | FStarC_Reflection_V1_Data.C_String s ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_String.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.C_Range r ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              FStarC_TypeChecker_NBETerm.embed
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Range.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.C_Reify ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Reify.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.C_Reflect ns ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Reflect.FStarC_Reflection_V1_Constants.fv
          [] uu___ in
...
let (e_universe :
  ...
  let embed_universe cb u =
    mk_lazy cb u FStarC_Reflection_V1_Constants.fstar_refl_universe
  ...
  mk_emb' embed_universe unembed_universe
    FStarC_Reflection_V1_Constants.fstar_refl_universe_fv
let rec e_pattern_aq :
  'uuuuu .
    'uuuuu ->
      FStarC_Reflection_V1_Data.pattern FStarC_TypeChecker_NBETerm.embedding
  =
  fun aq ->
    let embed_pattern cb p =
      ...
      | FStarC_Reflection_V1_Data.Pat_Constant c ->
          let uu___ =
            let uu___1 =
              let uu___2 = FStarC_TypeChecker_NBETerm.embed e_const cb c in
              FStarC_TypeChecker_NBETerm.as_arg uu___2 in
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Pat_Constant.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Pat_Cons (fv, us_opt, ps) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Pat_Cons.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Pat_Var (bv, sort) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 = FStarC_TypeChecker_NBETerm.embed e_sort cb sort in
                FStarC_TypeChecker_NBETerm.as_arg uu___4 in
              [uu___3] in
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Pat_Var.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Pat_Dot_Term eopt ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Pat_Dot_Term.FStarC_Reflection_V1_Constants.fv
            [] uu___ in
    let unembed_pattern cb t =
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, [], (c, uu___)::[]) when
          ...
          ->
          let uu___1 = FStarC_TypeChecker_NBETerm.unembed e_const cb c in
          FStarC_Compiler_Util.bind_opt uu___1
            (fun c1 ->
               FStar_Pervasives_Native.Some
               ...
               FStarC_Compiler_Util.bind_opt uu___4
                 (fun us ->
                    ...
                    FStarC_Compiler_Util.bind_opt uu___5
                      (fun ps1 ->
                         FStar_Pervasives_Native.Some
                           (FStarC_Reflection_V1_Data.Pat_Cons (f1, us, ps1)))))
      | FStarC_TypeChecker_NBETerm.Construct
          (fv, [], (sort, uu___)::(bv, uu___1)::[]) when
          FStarC_Syntax_Syntax.fv_eq_lid fv
            FStarC_Reflection_V1_Constants.ref_Pat_Var.FStarC_Reflection_V1_Constants.lid
          ->
          let uu___2 = FStarC_TypeChecker_NBETerm.unembed e_bv cb bv in
          FStarC_Compiler_Util.bind_opt uu___2
            (fun bv1 ->
               let uu___3 = FStarC_TypeChecker_NBETerm.unembed e_sort cb sort in
               FStarC_Compiler_Util.bind_opt uu___3
                 (fun sort1 ->
                    FStar_Pervasives_Native.Some
...
let (e_pattern :
  ...
  e_pattern_aq noaqs
let (e_branch :
  FStarC_Reflection_V1_Data.branch FStarC_TypeChecker_NBETerm.embedding) =
  FStarC_TypeChecker_NBETerm.e_tuple2 e_pattern e_term
let (e_argv :
  FStarC_Reflection_V1_Data.argv FStarC_TypeChecker_NBETerm.embedding) =
...
let (e_universe_view :
  ...
  let embed_universe_view cb uv =
    ...
    | FStarC_Reflection_V1_Data.Uv_Zero ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Zero.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Uv_Succ u ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Succ.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Uv_Max us ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Max.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Uv_BVar n ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_BVar.FStarC_Reflection_V1_Constants.fv
          [] uu___
            ...
            let uu___2 =
              FStarC_TypeChecker_NBETerm.embed
                (FStarC_TypeChecker_NBETerm.e_tuple2
                   ...
                   FStarC_TypeChecker_NBETerm.e_range) cb i in
            FStarC_TypeChecker_NBETerm.as_arg uu___2 in
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Name.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Uv_Unif u ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Unif.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Uv_Unk ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Uv_Unk.FStarC_Reflection_V1_Constants.fv
          [] [] in
  let unembed_universe_view cb t =
    ...
    | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (u, uu___1)::[]) when
        ...
        FStar_Pervasives_Native.Some (FStarC_Reflection_V1_Data.Uv_Unif u1)
    | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
  ...
  fun aq ->
    ...
    let embed_term_view cb tv =
      ...
      | FStarC_Reflection_V1_Data.Tv_FVar fv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_FVar.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_BVar bv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_BVar.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Var bv ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Var.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_UInst (fv, us) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_UInst.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_App (hd, a) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_App.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Abs (b, t) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Abs.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Arrow (b, c) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Arrow.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Type u ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Type.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Refine (bv, sort, t) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  FStarC_TypeChecker_NBETerm.embed (e_term_aq aq) cb sort in
                FStarC_TypeChecker_NBETerm.as_arg uu___4 in
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    FStarC_TypeChecker_NBETerm.embed (e_term_aq (shift aq))
                      cb t in
                  FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                [uu___5] in
              uu___3 :: uu___4 in
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Refine.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Const c ->
          let uu___ =
            ...
            [uu___1] in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Const.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Uvar (u, d) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Uvar.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Let (r, attrs, b, ty, t1, t2) ->
          let uu___ =
            ...
            let uu___2 =
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 = FStarC_TypeChecker_NBETerm.embed e_bv cb b in
                  FStarC_TypeChecker_NBETerm.as_arg uu___6 in
                let uu___6 =
                  let uu___7 =
                    let uu___8 =
                      FStarC_TypeChecker_NBETerm.embed (e_term_aq aq) cb ty in
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Let.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_Match (t, ret_opt, brs) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Match.FStarC_Reflection_V1_Constants.fv
            [] uu___
      | FStarC_Reflection_V1_Data.Tv_AscribedT (e, t, tacopt, use_eq) ->
          let uu___ =
            ...
            uu___1 :: uu___2 in
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_AscT.FStarC_Reflection_V1_Constants.fv
            [] uu___
      ...
      | FStarC_Reflection_V1_Data.Tv_Unknown ->
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Unknown.FStarC_Reflection_V1_Constants.fv
            [] []
      | FStarC_Reflection_V1_Data.Tv_Unsupp ->
          mkConstruct
            FStarC_Reflection_V1_Constants.ref_Tv_Unsupp.FStarC_Reflection_V1_Constants.fv
            [] [] in
    let unembed_term_view cb t =
      ...
      | FStarC_TypeChecker_NBETerm.Construct
          ...
          ->
          let uu___4 = FStarC_TypeChecker_NBETerm.unembed e_bv cb b in
          FStarC_Compiler_Util.bind_opt uu___4
            (fun b1 ->
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (c, uu___1)::[])
          ...
          ->
          let uu___2 = FStarC_TypeChecker_NBETerm.unembed e_const cb c in
          FStarC_Compiler_Util.bind_opt uu___2
            (fun c1 ->
               FStar_Pervasives_Native.Some
      ...
      | FStarC_TypeChecker_NBETerm.Construct
          (fv, uu___,
           (t2, uu___1)::(t1, uu___2)::(ty, uu___3)::(b, uu___4)::(attrs,
                                                                   uu___5)::
           (r, uu___6)::[])
          when
          FStarC_Syntax_Syntax.fv_eq_lid fv
          ...
          FStarC_Compiler_Util.bind_opt uu___7
            (fun r1 ->
               ...
               FStarC_Compiler_Util.bind_opt uu___8
                 (fun attrs1 ->
                    let uu___9 = FStarC_TypeChecker_NBETerm.unembed e_bv cb b in
                    FStarC_Compiler_Util.bind_opt uu___9
                      (fun b1 ->
                         let uu___10 =
                           FStarC_TypeChecker_NBETerm.unembed e_term cb ty in
      ...
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, []) when
          ...
          ->
          FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.Tv_Unknown
      | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, []) when
          FStarC_Syntax_Syntax.fv_eq_lid fv
        ...
        let uu___2 =
          FStarC_TypeChecker_NBETerm.embed
            (FStarC_TypeChecker_NBETerm.e_sealed
               FStarC_TypeChecker_NBETerm.e_string) cb
        ...
        let uu___3 =
          let uu___4 =
            FStarC_TypeChecker_NBETerm.embed FStarC_TypeChecker_NBETerm.e_int
              cb bvv.FStarC_Reflection_V1_Data.bv_index in
          FStarC_TypeChecker_NBETerm.as_arg uu___4 in
        [uu___3] in
      uu___1 :: uu___2 in
    mkConstruct
      FStarC_Reflection_V1_Constants.ref_Mk_bv.FStarC_Reflection_V1_Constants.fv
      [] uu___ in
  let unembed_bv_view cb t =
    match t.FStarC_TypeChecker_NBETerm.nbe_t with
    | FStarC_TypeChecker_NBETerm.Construct
        (fv, uu___, (idx, uu___1)::(nm, uu___2)::[]) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
        ...
        let uu___3 =
          FStarC_TypeChecker_NBETerm.unembed
            (FStarC_TypeChecker_NBETerm.e_sealed
               FStarC_TypeChecker_NBETerm.e_string) cb nm in
        FStarC_Compiler_Util.bind_opt uu___3
          (fun nm1 ->
             let uu___4 =
               FStarC_TypeChecker_NBETerm.unembed
                 FStarC_TypeChecker_NBETerm.e_int cb idx in
             FStarC_Compiler_Util.bind_opt uu___4
               (fun idx1 ->
                  FStar_Pervasives_Native.Some
                    {
...
let (e_binder_view :
  ...
  let embed_binder_view cb bview =
    let uu___ =
      let uu___1 =
        let uu___2 =
          FStarC_TypeChecker_NBETerm.embed e_bv cb
            bview.FStarC_Reflection_V1_Data.binder_bv in
        FStarC_TypeChecker_NBETerm.as_arg uu___2 in
      let uu___2 =
        let uu___3 =
          let uu___4 =
            FStarC_TypeChecker_NBETerm.embed e_aqualv cb
              bview.FStarC_Reflection_V1_Data.binder_qual in
          FStarC_TypeChecker_NBETerm.as_arg uu___4 in
        let uu___4 =
          let uu___5 =
            let uu___6 =
            ...
            let uu___7 =
              let uu___8 =
                FStarC_TypeChecker_NBETerm.embed e_term cb
                  bview.FStarC_Reflection_V1_Data.binder_sort in
              FStarC_TypeChecker_NBETerm.as_arg uu___8 in
            [uu___7] in
          uu___5 :: uu___6 in
        uu___3 :: uu___4 in
      uu___1 :: uu___2 in
    mkConstruct
      FStarC_Reflection_V1_Constants.ref_Mk_binder.FStarC_Reflection_V1_Constants.fv
      [] uu___ in
  let unembed_binder_view cb t =
    ...
    | FStarC_TypeChecker_NBETerm.Construct
        ...
        ->
        let uu___5 = FStarC_TypeChecker_NBETerm.unembed e_bv cb bv in
        FStarC_Compiler_Util.bind_opt uu___5
          (fun bv1 ->
             ...
             FStarC_Compiler_Util.bind_opt uu___6
               (fun q1 ->
                  ...
                  FStarC_Compiler_Util.bind_opt uu___7
                    (fun attrs1 ->
                       let uu___8 =
                         FStarC_TypeChecker_NBETerm.unembed e_term cb sort in
                       FStarC_Compiler_Util.bind_opt uu___8
                         (fun sort1 ->
                            FStar_Pervasives_Native.Some
                              {
                                FStarC_Reflection_V1_Data.binder_bv = bv1;
                                FStarC_Reflection_V1_Data.binder_qual = q1;
                                FStarC_Reflection_V1_Data.binder_attrs =
                                  attrs1;
                                FStarC_Reflection_V1_Data.binder_sort = sort1
                              }))))
    | uu___ ->
        ((let uu___2 =
            let uu___3 = FStarC_TypeChecker_NBETerm.t_to_string t in
  ...
  let embed_comp_view cb cv =
    ...
    | FStarC_Reflection_V1_Data.C_Total t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Total.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.C_GTotal t ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_GTotal.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.C_Lemma (pre, post, pats) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Lemma.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.C_Eff (us, eff, res, args, decrs) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_C_Eff.FStarC_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed_comp_view cb t =
    ...
    | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (t1, uu___1)::[]) when
        ...
        FStarC_Compiler_Util.bind_opt uu___2
          (fun t2 ->
             FStar_Pervasives_Native.Some
               (FStarC_Reflection_V1_Data.C_Total t2))
    | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, (t1, uu___1)::[]) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
        ...
        FStarC_Compiler_Util.bind_opt uu___2
          (fun t2 ->
             FStar_Pervasives_Native.Some
               (FStarC_Reflection_V1_Data.C_GTotal t2))
    | FStarC_TypeChecker_NBETerm.Construct
...
let (e_sigelt :
  ...
  let embed_sigelt cb se =
    mk_lazy cb se FStarC_Reflection_V1_Constants.fstar_refl_sigelt
...
let (e_univ_name :
  FStarC_Reflection_V1_Data.univ_name FStarC_TypeChecker_NBETerm.embedding) =
  e_ident
let (e_univ_names :
  FStarC_Reflection_V1_Data.univ_name Prims.list
    FStarC_TypeChecker_NBETerm.embedding)
...
let (e_lb_view :
  ...
  let embed_lb_view cb lbv =
    let uu___ =
      ...
      uu___1 :: uu___2 in
    mkConstruct
      FStarC_Reflection_V1_Constants.ref_Mk_lb.FStarC_Reflection_V1_Constants.fv
      [] uu___ in
...
let (e_letbinding :
  ...
  let embed_letbinding cb lb =
    mk_lazy cb lb FStarC_Reflection_V1_Constants.fstar_refl_letbinding
  ...
  let embed_sigelt_view cb sev =
    ...
    | FStarC_Reflection_V1_Data.Sg_Let (r, lbs) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Sg_Let.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Sg_Inductive (nm, univs, bs, t, dcs) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Sg_Inductive.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Sg_Val (nm, univs, t) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Sg_Val.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Unk ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_Unk.FStarC_Reflection_V1_Constants.fv
          [] [] in
             ...
             FStarC_Compiler_Util.bind_opt uu___5
               (fun us1 ->
                  ...
                  FStarC_Compiler_Util.bind_opt uu___6
                    (fun t2 ->
                       FStar_Pervasives_Native.Some
                         (FStarC_Reflection_V1_Data.Sg_Val (nm1, us1, t2)))))
    | FStarC_TypeChecker_NBETerm.Construct (fv, uu___, []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
...
let (e_name : Prims.string Prims.list FStarC_TypeChecker_NBETerm.embedding) =
  FStarC_TypeChecker_NBETerm.e_list FStarC_TypeChecker_NBETerm.e_string
let (e_qualifier :
  FStarC_Reflection_V1_Data.qualifier FStarC_TypeChecker_NBETerm.embedding) =
  let embed cb q =
    match q with
    | FStarC_Reflection_V1_Data.Assumption ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Assumption.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.New ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_New.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Private ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Private.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Unfold_for_unification_and_vcgen ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Unfold_for_unification_and_vcgen.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Visible_default ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Visible_default.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Irreducible ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Irreducible.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Inline_for_extraction ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Inline_for_extraction.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.NoExtract ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_NoExtract.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Noeq ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Noeq.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Unopteq ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Unopteq.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.TotalEffect ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_TotalEffect.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Logic ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Logic.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Reifiable ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Reifiable.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.ExceptionConstructor ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_ExceptionConstructor.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.HasMaskedEffect ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_HasMaskedEffect.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Effect ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Effect.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.OnlyName ->
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_OnlyName.FStarC_Reflection_V1_Constants.fv
          [] []
    | FStarC_Reflection_V1_Data.Reflectable l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Reflectable.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Discriminator l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Discriminator.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Action l ->
        let uu___ =
          ...
          [uu___1] in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Action.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.Projector (l, i) ->
        let uu___ =
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 = FStarC_TypeChecker_NBETerm.embed e_ident cb i in
              FStarC_TypeChecker_NBETerm.as_arg uu___4 in
            [uu___3] in
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_Projector.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.RecordType (ids1, ids2) ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              FStarC_TypeChecker_NBETerm.embed
                (FStarC_TypeChecker_NBETerm.e_list e_ident) cb ids1 in
            FStarC_TypeChecker_NBETerm.as_arg uu___2 in
          let uu___2 =
            let uu___3 =
              let uu___4 =
                FStarC_TypeChecker_NBETerm.embed
                  (FStarC_TypeChecker_NBETerm.e_list e_ident) cb ids2 in
              FStarC_TypeChecker_NBETerm.as_arg uu___4 in
            [uu___3] in
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_RecordType.FStarC_Reflection_V1_Constants.fv
          [] uu___
    | FStarC_Reflection_V1_Data.RecordConstructor (ids1, ids2) ->
        let uu___ =
          ...
          uu___1 :: uu___2 in
        mkConstruct
          FStarC_Reflection_V1_Constants.ref_qual_RecordConstructor.FStarC_Reflection_V1_Constants.fv
          [] uu___ in
  let unembed cb t =
    match t.FStarC_TypeChecker_NBETerm.nbe_t with
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        -> FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.Assumption
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        -> FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.Irreducible
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        ...
        -> FStar_Pervasives_Native.Some FStarC_Reflection_V1_Data.TotalEffect
    | FStarC_TypeChecker_NBETerm.Construct (fv, [], []) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStarC_TypeChecker_NBETerm.Construct
        ...
        FStarC_Compiler_Util.bind_opt uu___2
          (fun i1 ->
             let uu___3 = FStarC_TypeChecker_NBETerm.unembed e_name cb l in
             FStarC_Compiler_Util.bind_opt uu___3
               (fun l1 ->
                  FStar_Pervasives_Native.Some
                    (FStarC_Reflection_V1_Data.Projector (l1, i1))))
    | FStarC_TypeChecker_NBETerm.Construct
        ...
        FStarC_Compiler_Util.bind_opt uu___2
          (fun ids11 ->
             ...
             FStarC_Compiler_Util.bind_opt uu___3
               (fun ids21 ->
                  FStar_Pervasives_Native.Some
                    (FStarC_Reflection_V1_Data.RecordType (ids11, ids21))))
    | FStarC_TypeChecker_NBETerm.Construct
        (fv, [], (ids2, uu___)::(ids1, uu___1)::[]) when
        FStarC_Syntax_Syntax.fv_eq_lid fv
  ...
  FStarC_TypeChecker_NBETerm.mk_emb embed unembed
    (fun uu___ ->
       mkConstruct FStarC_Reflection_V1_Constants.fstar_refl_qualifier_fv []
         [])
    (fun uu___ ->
       fv_as_emb_typ FStarC_Reflection_V1_Constants.fstar_refl_qualifier_fv)
let (e_qualifiers :
