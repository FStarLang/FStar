...
;
 ...
 ;
    STATE2:: (* STATE a wp wlp *)
            ...
            type trivial (a:Type) (wp:WP a) = (forall h0. wp (fun r h1 -> True) h0)
            with ST2Core (a:Type) (wp:WP a) (wlp:WP a) = STATE2 a wp wlp
            and ST2 (a:Type) (pre:Pre) (post: (heap2 -> Post a)) =
                STATE2 a
...
;
  ...
  DIV   ~> STATE = (fun ('a:Type) ('wp:PURE.WP 'a) ('p:STATE.Post 'a) (h:heap) -> 'wp (fun a -> 'p a h));
  STATE ~> ALL   = (fun ('a:Type) ('wp:STATE.WP 'a) ('p:ALL.Post 'a) -> 'wp (fun a -> 'p (V a)));
  PURE  ~> STATE2  = (fun ('a:Type) ('wp:PURE.WP 'a) ('p:STATE2.Post 'a) -> (fun h2 -> 'wp (fun a0 -> 'p a0 h2)));
  STATE2 ~> ALL   = (fun ('a:Type) ('wp:STATE2.WP 'a) ('p:ALL.Post 'a) -> (fun h -> (forall x h'. 'p x h')));
