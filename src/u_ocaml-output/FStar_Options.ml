...
let clear : Prims.unit  ->  Prims.unit = (fun uu____440 -> (
...
let get_admit_smt_queries : Prims.unit  ->  Prims.bool = (fun uu____476 -> (lookup_opt "admit_smt_queries" as_bool))


let get_cardinality : Prims.unit  ->  Prims.string = (fun uu____479 -> (lookup_opt "cardinality" as_string))


let get_codegen : Prims.unit  ->  Prims.string Prims.option = (fun uu____483 -> (lookup_opt "codegen" (as_option as_string)))


let get_codegen_lib : Prims.unit  ->  Prims.string Prims.list = (fun uu____488 -> (lookup_opt "codegen-lib" (as_list as_string)))


let get_debug : Prims.unit  ->  Prims.string Prims.list = (fun uu____493 -> (lookup_opt "debug" (as_list as_string)))


let get_debug_level : Prims.unit  ->  Prims.string Prims.list = (fun uu____498 -> (lookup_opt "debug_level" (as_list as_string)))


let get_dep : Prims.unit  ->  Prims.string Prims.option = (fun uu____503 -> (lookup_opt "dep" (as_option as_string)))


let get_detail_errors : Prims.unit  ->  Prims.bool = (fun uu____507 -> (lookup_opt "detail_errors" as_bool))


let get_doc : Prims.unit  ->  Prims.bool = (fun uu____510 -> (lookup_opt "doc" as_bool))


let get_dump_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____514 -> (lookup_opt "dump_module" (as_list as_string)))


let get_eager_inference : Prims.unit  ->  Prims.bool = (fun uu____518 -> (lookup_opt "eager_inference" as_bool))


let get_explicit_deps : Prims.unit  ->  Prims.bool = (fun uu____521 -> (lookup_opt "explicit_deps" as_bool))


let get_extract_all : Prims.unit  ->  Prims.bool = (fun uu____524 -> (lookup_opt "extract_all" as_bool))


let get_extract_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____528 -> (lookup_opt "extract_module" (as_list as_string)))


let get_extract_namespace : Prims.unit  ->  Prims.string Prims.list = (fun uu____533 -> (lookup_opt "extract_namespace" (as_list as_string)))


let get_fs_typ_app : Prims.unit  ->  Prims.bool = (fun uu____537 -> (lookup_opt "fs_typ_app" as_bool))


let get_fstar_home : Prims.unit  ->  Prims.string Prims.option = (fun uu____541 -> (lookup_opt "fstar_home" (as_option as_string)))


let get_hide_genident_nums : Prims.unit  ->  Prims.bool = (fun uu____545 -> (lookup_opt "hide_genident_nums" as_bool))


let get_hide_uvar_nums : Prims.unit  ->  Prims.bool = (fun uu____548 -> (lookup_opt "hide_uvar_nums" as_bool))


let get_hint_info : Prims.unit  ->  Prims.bool = (fun uu____551 -> (lookup_opt "hint_info" as_bool))


let get_in : Prims.unit  ->  Prims.bool = (fun uu____554 -> (lookup_opt "in" as_bool))


let get_include : Prims.unit  ->  Prims.string Prims.list = (fun uu____558 -> (lookup_opt "include" (as_list as_string)))


let get_indent : Prims.unit  ->  Prims.bool = (fun uu____562 -> (lookup_opt "indent" as_bool))


let get_initial_fuel : Prims.unit  ->  Prims.int = (fun uu____565 -> (lookup_opt "initial_fuel" as_int))


let get_initial_ifuel : Prims.unit  ->  Prims.int = (fun uu____568 -> (lookup_opt "initial_ifuel" as_int))


let get_inline_arith : Prims.unit  ->  Prims.bool = (fun uu____571 -> (lookup_opt "inline_arith" as_bool))


let get_lax : Prims.unit  ->  Prims.bool = (fun uu____574 -> (lookup_opt "lax" as_bool))


let get_log_queries : Prims.unit  ->  Prims.bool = (fun uu____577 -> (lookup_opt "log_queries" as_bool))


let get_log_types : Prims.unit  ->  Prims.bool = (fun uu____580 -> (lookup_opt "log_types" as_bool))


let get_max_fuel : Prims.unit  ->  Prims.int = (fun uu____583 -> (lookup_opt "max_fuel" as_int))


let get_max_ifuel : Prims.unit  ->  Prims.int = (fun uu____586 -> (lookup_opt "max_ifuel" as_int))


let get_min_fuel : Prims.unit  ->  Prims.int = (fun uu____589 -> (lookup_opt "min_fuel" as_int))


let get_MLish : Prims.unit  ->  Prims.bool = (fun uu____592 -> (lookup_opt "MLish" as_bool))


let get_n_cores : Prims.unit  ->  Prims.int = (fun uu____595 -> (lookup_opt "n_cores" as_int))


let get_no_default_includes : Prims.unit  ->  Prims.bool = (fun uu____598 -> (lookup_opt "no_default_includes" as_bool))


let get_no_extract : Prims.unit  ->  Prims.string Prims.list = (fun uu____602 -> (lookup_opt "no_extract" (as_list as_string)))


let get_no_location_info : Prims.unit  ->  Prims.bool = (fun uu____606 -> (lookup_opt "no_location_info" as_bool))


let get_odir : Prims.unit  ->  Prims.string Prims.option = (fun uu____610 -> (lookup_opt "odir" (as_option as_string)))


let get_prims : Prims.unit  ->  Prims.string Prims.option = (fun uu____615 -> (lookup_opt "prims" (as_option as_string)))


let get_print_before_norm : Prims.unit  ->  Prims.bool = (fun uu____619 -> (lookup_opt "print_before_norm" as_bool))


let get_print_bound_var_types : Prims.unit  ->  Prims.bool = (fun uu____622 -> (lookup_opt "print_bound_var_types" as_bool))


let get_print_effect_args : Prims.unit  ->  Prims.bool = (fun uu____625 -> (lookup_opt "print_effect_args" as_bool))


let get_print_fuels : Prims.unit  ->  Prims.bool = (fun uu____628 -> (lookup_opt "print_fuels" as_bool))


let get_print_implicits : Prims.unit  ->  Prims.bool = (fun uu____631 -> (lookup_opt "print_implicits" as_bool))


let get_print_ml : Prims.unit  ->  Prims.bool = (fun uu____634 -> (lookup_opt "print_ml" as_bool))


let get_print_universes : Prims.unit  ->  Prims.bool = (fun uu____637 -> (lookup_opt "print_universes" as_bool))


let get_print_z3_statistics : Prims.unit  ->  Prims.bool = (fun uu____640 -> (lookup_opt "print_z3_statistics" as_bool))


let get_prn : Prims.unit  ->  Prims.bool = (fun uu____643 -> (lookup_opt "prn" as_bool))


let get_record_hints : Prims.unit  ->  Prims.bool = (fun uu____646 -> (lookup_opt "record_hints" as_bool))


let get_reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun uu____650 -> (lookup_opt "reuse_hint_for" (as_option as_string)))


let get_show_signatures : Prims.unit  ->  Prims.string Prims.list = (fun uu____655 -> (lookup_opt "show_signatures" (as_list as_string)))


let get_silent : Prims.unit  ->  Prims.bool = (fun uu____659 -> (lookup_opt "silent" as_bool))


let get_smt : Prims.unit  ->  Prims.string Prims.option = (fun uu____663 -> (lookup_opt "smt" (as_option as_string)))


let get_split_cases : Prims.unit  ->  Prims.int = (fun uu____667 -> (lookup_opt "split_cases" as_int))


let get_stratified : Prims.unit  ->  Prims.bool = (fun uu____670 -> (lookup_opt "stratified" as_bool))


let get_timing : Prims.unit  ->  Prims.bool = (fun uu____673 -> (lookup_opt "timing" as_bool))


let get_trace_error : Prims.unit  ->  Prims.bool = (fun uu____676 -> (lookup_opt "trace_error" as_bool))


let get_unthrottle_inductives : Prims.unit  ->  Prims.bool = (fun uu____679 -> (lookup_opt "unthrottle_inductives" as_bool))


let get_use_eq_at_higher_order : Prims.unit  ->  Prims.bool = (fun uu____682 -> (lookup_opt "use_eq_at_higher_order" as_bool))


let get_use_hints : Prims.unit  ->  Prims.bool = (fun uu____685 -> (lookup_opt "use_hints" as_bool))


let get_verify_all : Prims.unit  ->  Prims.bool = (fun uu____688 -> (lookup_opt "verify_all" as_bool))


let get_verify_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____692 -> (lookup_opt "verify_module" (as_list as_string)))


let get___temp_no_proj : Prims.unit  ->  Prims.string Prims.list = (fun uu____697 -> (lookup_opt "__temp_no_proj" (as_list as_string)))


let get_version : Prims.unit  ->  Prims.bool = (fun uu____701 -> (lookup_opt "version" as_bool))


let get_warn_top_level_effects : Prims.unit  ->  Prims.bool = (fun uu____704 -> (lookup_opt "no_warn_top_level_effects" as_bool))


let get_z3refresh : Prims.unit  ->  Prims.bool = (fun uu____707 -> (lookup_opt "z3refresh" as_bool))


let get_z3rlimit : Prims.unit  ->  Prims.int = (fun uu____710 -> (lookup_opt "z3rlimit" as_int))


let get_z3seed : Prims.unit  ->  Prims.int = (fun uu____713 -> (lookup_opt "z3seed" as_int))


let get_z3timeout : Prims.unit  ->  Prims.int = (fun uu____716 -> (lookup_opt "z3timeout" as_int))


let dlevel : Prims.string  ->  debug_level_t = (fun uu___48_719 -> (match (uu___48_719) with
| "Low" -> begin
Low
end
| "Medium" -> begin
...
| FStar_Getopt.OneArg (uu____781, argname) -> begin
(match ((doc = "")) with
| true -> begin
...
let g = (fun uu____822 -> (set_option' (let _0_30 = (f ())
in ((name), (_0_30)))))
...
let rec specs : Prims.unit  ->  FStar_Getopt.opt Prims.list = (fun uu____867 -> (
...
let settable : Prims.string  ->  Prims.bool = (fun uu___49_1454 -> (match (uu___49_1454) with
...
let settable_specs : (FStar_BaseTypes.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun uu____1478 -> (match (uu____1478) with
| (uu____1484, x, uu____1486, uu____1487) -> begin
(settable x)
end))))


let resettable_specs : (FStar_BaseTypes.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun uu____1508 -> (match (uu____1508) with
| (uu____1514, x, uu____1516, uu____1517) -> begin
(resettable x)
end))))


let display_usage : Prims.unit  ->  Prims.unit = (fun uu____1522 -> (display_usage_aux (specs ())))


let fstar_home : Prims.unit  ->  Prims.string = (fun uu____1525 -> (

let uu____1526 = (get_fstar_home ())
...
let uu____1551 = (not ((get_stratified ())))
...
in (FStar_Getopt.parse_string specs (fun uu____1559 -> ()) s)))


let file_list_ : Prims.string Prims.list FStar_ST.ref = (FStar_Util.mk_ref [])


let parse_cmd_line : Prims.unit  ->  (FStar_Getopt.parse_cmdline_res * Prims.string Prims.list) = (fun uu____1570 -> (
...
let file_list : Prims.unit  ->  Prims.string Prims.list = (fun uu____1586 -> (FStar_ST.read file_list_))
...
let uu____1607 = (get_verify_module ())
...
let uu____1625 = (should_verify m)
...
let include_path : Prims.unit  ->  Prims.string Prims.list = (fun uu____1630 -> (

let uu____1631 = (get_no_default_includes ())
...
let uu____1637 = (not ((get_stratified ())))
...
let check_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1683 -> (let _0_94 = (get_cardinality ())
in (_0_94 = "check")))
...
let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun uu____1692 -> (let _0_95 = (get_codegen_lib ())
in (FStar_All.pipe_right _0_95 (FStar_List.map (fun x -> (FStar_Util.split x "."))))))


let debug_any : Prims.unit  ->  Prims.bool = (fun uu____1700 -> (let _0_96 = (get_debug ())
in (_0_96 <> [])))
...
let full_context_dependency : Prims.unit  ->  Prims.bool = (fun uu____1740 -> (

let uu____1741 = (get_stratified ())
...
let hide_genident_nums : Prims.unit  ->  Prims.bool = (fun uu____1745 -> (get_hide_genident_nums ()))


let hide_uvar_nums : Prims.unit  ->  Prims.bool = (fun uu____1748 -> (get_hide_uvar_nums ()))


let hint_info : Prims.unit  ->  Prims.bool = (fun uu____1751 -> (get_hint_info ()))


let indent : Prims.unit  ->  Prims.bool = (fun uu____1754 -> (get_indent ()))


let initial_fuel : Prims.unit  ->  Prims.int = (fun uu____1757 -> (get_initial_fuel ()))


let initial_ifuel : Prims.unit  ->  Prims.int = (fun uu____1760 -> (get_initial_ifuel ()))


let inline_arith : Prims.unit  ->  Prims.bool = (fun uu____1763 -> (get_inline_arith ()))


let interactive : Prims.unit  ->  Prims.bool = (fun uu____1766 -> (get_in ()))


let lax : Prims.unit  ->  Prims.bool = (fun uu____1769 -> (get_lax ()))


let log_queries : Prims.unit  ->  Prims.bool = (fun uu____1772 -> (get_log_queries ()))


let log_types : Prims.unit  ->  Prims.bool = (fun uu____1775 -> (get_log_types ()))


let max_fuel : Prims.unit  ->  Prims.int = (fun uu____1778 -> (get_max_fuel ()))


let max_ifuel : Prims.unit  ->  Prims.int = (fun uu____1781 -> (get_max_ifuel ()))


let min_fuel : Prims.unit  ->  Prims.int = (fun uu____1784 -> (get_min_fuel ()))


let ml_ish : Prims.unit  ->  Prims.bool = (fun uu____1787 -> (get_MLish ()))


let n_cores : Prims.unit  ->  Prims.int = (fun uu____1790 -> (get_n_cores ()))


let no_default_includes : Prims.unit  ->  Prims.bool = (fun uu____1793 -> (get_no_default_includes ()))
...
let no_location_info : Prims.unit  ->  Prims.bool = (fun uu____1800 -> (get_no_location_info ()))


let norm_then_print : Prims.unit  ->  Prims.bool = (fun uu____1803 -> (let _0_102 = (get_print_before_norm ())
in (_0_102 = false)))


let output_dir : Prims.unit  ->  Prims.string Prims.option = (fun uu____1807 -> (get_odir ()))


let print_bound_var_types : Prims.unit  ->  Prims.bool = (fun uu____1810 -> (get_print_bound_var_types ()))


let print_effect_args : Prims.unit  ->  Prims.bool = (fun uu____1813 -> (get_print_effect_args ()))


let print_fuels : Prims.unit  ->  Prims.bool = (fun uu____1816 -> (get_print_fuels ()))


let print_implicits : Prims.unit  ->  Prims.bool = (fun uu____1819 -> (get_print_implicits ()))


let print_ml : Prims.unit  ->  Prims.bool = (fun uu____1822 -> (get_print_ml ()))


let print_real_names : Prims.unit  ->  Prims.bool = (fun uu____1825 -> (get_prn ()))


let print_universes : Prims.unit  ->  Prims.bool = (fun uu____1828 -> (get_print_universes ()))


let print_z3_statistics : Prims.unit  ->  Prims.bool = (fun uu____1831 -> (get_print_z3_statistics ()))


let record_hints : Prims.unit  ->  Prims.bool = (fun uu____1834 -> (get_record_hints ()))


let reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun uu____1838 -> (get_reuse_hint_for ()))


let silent : Prims.unit  ->  Prims.bool = (fun uu____1841 -> (get_silent ()))


let split_cases : Prims.unit  ->  Prims.int = (fun uu____1844 -> (get_split_cases ()))


let timing : Prims.unit  ->  Prims.bool = (fun uu____1847 -> (get_timing ()))


let trace_error : Prims.unit  ->  Prims.bool = (fun uu____1850 -> (get_trace_error ()))


let universes : Prims.unit  ->  Prims.bool = (fun uu____1853 -> (not ((get_stratified ()))))


let unthrottle_inductives : Prims.unit  ->  Prims.bool = (fun uu____1856 -> (get_unthrottle_inductives ()))


let use_eq_at_higher_order : Prims.unit  ->  Prims.bool = (fun uu____1859 -> (get_use_eq_at_higher_order ()))


let use_hints : Prims.unit  ->  Prims.bool = (fun uu____1862 -> (get_use_hints ()))


let verify_all : Prims.unit  ->  Prims.bool = (fun uu____1865 -> (get_verify_all ()))


let verify_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____1869 -> (get_verify_module ()))


let warn_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1872 -> (let _0_103 = (get_cardinality ())
in (_0_103 = "warn")))


let warn_top_level_effects : Prims.unit  ->  Prims.bool = (fun uu____1875 -> (get_warn_top_level_effects ()))


let z3_exe : Prims.unit  ->  Prims.string = (fun uu____1878 -> (

let uu____1879 = (get_smt ())
...
let z3_refresh : Prims.unit  ->  Prims.bool = (fun uu____1884 -> (get_z3refresh ()))


let z3_rlimit : Prims.unit  ->  Prims.int = (fun uu____1887 -> (get_z3rlimit ()))


let z3_seed : Prims.unit  ->  Prims.int = (fun uu____1890 -> (get_z3seed ()))


let z3_timeout : Prims.unit  ->  Prims.int = (fun uu____1893 -> (get_z3timeout ()))


let should_extract : Prims.string  ->  Prims.bool = (fun m -> ((not ((no_extract m))) && ((extract_all ()) || (

let uu____1897 = (get_extract_module ())
in (match (uu____1897) with
| [] -> begin
(

let uu____1899 = (get_extract_namespace ())
