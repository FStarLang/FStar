...
and residual_comp = lident * list<cflags> //TODO: Should we also retain the indices?
...
let mk_Comp (ct:comp_typ) : comp  = mk (Comp ct) None (Ident.range_of_lid ct.comp_typ_name)
