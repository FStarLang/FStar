...
and fv_qual =
  ...
  | Unresolved_projector of fv                  (* ToSyntax's best guess at what the projector is (based only on scoping rules) *)
...
and unresolved_constructor = {
  ...
  uc_typename: lident;      // The constructed type, as determined by the ToSyntax's scoping rules
