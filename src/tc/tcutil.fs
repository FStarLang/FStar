...
let refresh_comp_label env c = 
    ...
    | Comp ct -> 
      ...
      let wp = mk_Typ_meta(Meta_refresh_label(wp, Env.get_range env)) in
      let wlp = mk_Typ_meta(Meta_refresh_label(wlp, Env.get_range env)) in
