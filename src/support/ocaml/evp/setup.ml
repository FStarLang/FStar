...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00bf014b8cee94bf7a5624541bcf5b3c) *)
(*
...
(* # 21 "/home/strub/Projects/EasyCrypt/_tools/ocaml-4.00.1/opam/system/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "EVP"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "0Y\169gQ`\240w\006\207\193\176\222\227\028\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
