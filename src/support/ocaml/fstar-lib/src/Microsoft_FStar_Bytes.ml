...
let string_as_unicode_bytes (s:string) = Microsoft_FStar_Util.unicode_of_string s
let utf8_bytes_as_string (b:bytes) = Microsoft_FStar_Util.string_of_unicode b
let unicode_bytes_as_string (b:bytes) = Microsoft_FStar_Util.string_of_unicode b
...
let string_as_utf8_bytes (s:string) = Microsoft_FStar_Util.unicode_of_string s
