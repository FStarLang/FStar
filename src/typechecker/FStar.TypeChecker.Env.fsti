...
and env = {
  ...
  splice         :env -> is_typed:bool -> list lident -> term -> Range.range -> list sigelt; (* hook for synthesizing terms via tactics *)
                                                                          (* second arg is true for typed splice, i.e. no typechecking of the synthesized sigelt *)
