...
and check_let_bound_def top_level env lb
    ...
    //AR: strengthening the VC, as commented out below, turns a Pure.return wp into a Pure.assert_wp
    ...
    let g1 = Rel.conj_guard g1 (Rel.simplify_guard env1 wf_annot) in
