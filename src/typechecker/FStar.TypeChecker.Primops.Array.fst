module FStar.TypeChecker.Primops.Array
...
let as_primitive_step is_strong (l, arity, u_arity, f, f_nbe) =
  FStar.TypeChecker.Primops.Base.as_primitive_step_nbecbs is_strong (l, arity, u_arity, f, (fun cb univs args -> f_nbe univs args))
