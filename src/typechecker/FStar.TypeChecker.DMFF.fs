...
=
  ...
  *)
  ...
  let rec mk_rel rel t x y =
    ...
    let t = N.normalize [ Env.Beta; Env.UnfoldUntil S.delta_constant ] env t in
...
and infer (env: env) (e: term): nm * term * term =
  ...
  let mk x = mk x None e.pos in
  let normalize = N.normalize [ Env.Beta; Env.UnfoldUntil S.delta_constant; Env.EraseUniverses ] env.tcenv in
  match (SS.compress e).n with
  | Tm_bvar bv ->
...
let n = N.normalize [ Env.Beta; Env.UnfoldUntil delta_constant; Env.DoNotUnfoldPureLets; Env.EraseUniverses ]
