...
val desugar_machine_integer: env -> repr:string -> (FStar.Const.signedness * FStar.Const.width) -> Range.range -> Syntax.term
...
val add_modul_to_env:            Syntax.modul -> module_inclusion_info -> withenv<unit>
