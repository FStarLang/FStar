...
val fold_leftT : ('a -> 'b -> Tot<'a>) -> 'a -> l:(list<'b>) -> Tot<'a>
...
val filterT : f:('a -> Tot<bool>) -> (list<'a>) -> Tot<(list<'a>)>
...
val countT<'_4383 when '_4383 : equality> : '_4383 -> (list<'_4383>) -> Tot<nat>
...
val memT<'_17768 when '_17768 : equality>  : '_17768 -> (list<'_17768>) -> Tot<bool>
val contains<'_17778 when '_17778 : equality>  : '_17778 -> (list<'_17778>) -> Tot<bool>
val containsT<'_17788 when '_17788 : equality>  : '_17788 -> (list<'_17788>) -> Tot<bool>
val findT : f:('_19377 -> Tot<bool>) -> (list<'_19377>) -> Tot<(option<'_19377>)>
val assocT<'_35042, '_35041 when '_35042 : equality> : '_35042 -> (list<('_35042 * '_35041)>) -> Tot<(option<'_35041>)>
