...
(let _142_20 = (f FStar_ToSMT_Term.mkTrue)
in ((true), (_142_20), (negs), (t)))
end
| _49_21 -> begin
...
(let _142_31 = (let _142_30 = (let _142_29 = (FStar_ToSMT_Term.mkNot t)
in ((negs), (_142_29)))
in (FStar_ToSMT_Term.mkAnd _142_30))
in ((true), (l), (_142_31)))
end
| _49_30 -> begin
(
...
| (b, t, negs', rest) -> begin
if b then begin
(let _142_34 = (let _142_33 = (FStar_ToSMT_Term.mkImp ((negs), (t)))
in (_142_33)::l)
in (is_ite_all_the_way n rest negs' _142_34))
end else begin
...
(parse_query_for_split_cases n t (fun x -> (let _142_61 = (FStar_ToSMT_Term.mkForall'' ((l), (opt), (l'), (x)))
in (f _142_61))))
end
...
(parse_query_for_split_cases n t2 (fun x -> (let _142_69 = (FStar_ToSMT_Term.mkImp ((t1), (x)))
in (f _142_69))))
end
...
| (b, l, negs) -> begin
((b), ((((fun x -> (let _142_78 = (FStar_ToSMT_Term.mkImp ((t1), (x)))
in (f _142_78)))), (l), (negs))))
end))
end
| _49_80 -> begin
...
let rec check_split_cases : (FStar_ToSMT_Term.term  ->  FStar_ToSMT_Term.term)  ->  FStar_ToSMT_Term.term Prims.list  ->  (FStar_ToSMT_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f l check -> (FStar_List.iter (fun t -> (let _142_117 = (let _142_116 = (let _142_115 = (let _142_114 = (f t)
in (FStar_ToSMT_Term.mkNot _142_114))
in ((_142_115), (None)))
in FStar_ToSMT_Term.Assume (_142_116))
in (check _142_117))) (FStar_List.rev l)))

# 67 "FStar.ToSMT.SplitQueryCases.fst"
let check_exhaustiveness : (FStar_ToSMT_Term.term  ->  FStar_ToSMT_Term.term)  ->  FStar_ToSMT_Term.term  ->  (FStar_ToSMT_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f negs check -> (let _142_138 = (let _142_137 = (let _142_136 = (let _142_135 = (let _142_134 = (FStar_ToSMT_Term.mkNot negs)
in (f _142_134))
in (FStar_ToSMT_Term.mkNot _142_135))
in ((_142_136), (None)))
in FStar_ToSMT_Term.Assume (_142_137))
in (check _142_138)))
