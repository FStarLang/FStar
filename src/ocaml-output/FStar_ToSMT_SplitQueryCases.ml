...
(let _148_14 = (f FStar_ToSMT_Term.mkTrue)
in ((true), (_148_14), (negs), (t)))
end else begin
(match (t.FStar_ToSMT_Term.tm) with
| FStar_ToSMT_Term.App (FStar_ToSMT_Term.ITE, (g)::(t)::(e)::_50_7) -> begin
(let _148_19 = (let _148_16 = (let _148_15 = (FStar_ToSMT_Term.mkNot g)
in ((negs), (_148_15)))
in (FStar_ToSMT_Term.mkAnd _148_16))
in (get_next_n_ite (n - (Prims.parse_int "1")) e _148_19 (fun x -> (let _148_18 = (FStar_ToSMT_Term.mkITE ((g), (t), (x)))
in (f _148_18)))))
end
| FStar_ToSMT_Term.FreeV (_50_18) -> begin
(let _148_20 = (f FStar_ToSMT_Term.mkTrue)
in ((true), (_148_20), (negs), (t)))
end
| _50_21 -> begin
...
(let _148_31 = (let _148_30 = (let _148_29 = (FStar_ToSMT_Term.mkNot t)
in ((negs), (_148_29)))
in (FStar_ToSMT_Term.mkAnd _148_30))
in ((true), (l), (_148_31)))
end
| _50_30 -> begin
(
...
| (b, t, negs', rest) -> begin
if b then begin
(let _148_34 = (let _148_33 = (FStar_ToSMT_Term.mkImp ((negs), (t)))
in (_148_33)::l)
in (is_ite_all_the_way n rest negs' _148_34))
end else begin
...
(parse_query_for_split_cases n t (fun x -> (let _148_61 = (FStar_ToSMT_Term.mkForall'' ((l), (opt), (l'), (x)))
in (f _148_61))))
end
...
(parse_query_for_split_cases n t2 (fun x -> (let _148_69 = (FStar_ToSMT_Term.mkImp ((t1), (x)))
in (f _148_69))))
end
...
| (b, l, negs) -> begin
((b), ((((fun x -> (let _148_78 = (FStar_ToSMT_Term.mkImp ((t1), (x)))
in (f _148_78)))), (l), (negs))))
end))
end
| _50_80 -> begin
...
let rec check_split_cases : (FStar_ToSMT_Term.term  ->  FStar_ToSMT_Term.term)  ->  FStar_ToSMT_Term.term Prims.list  ->  (FStar_ToSMT_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f l check -> (FStar_List.iter (fun t -> (let _148_117 = (let _148_116 = (let _148_115 = (let _148_114 = (f t)
in (FStar_ToSMT_Term.mkNot _148_114))
in ((_148_115), (None)))
in FStar_ToSMT_Term.Assume (_148_116))
in (check _148_117))) (FStar_List.rev l)))


let check_exhaustiveness : (FStar_ToSMT_Term.term  ->  FStar_ToSMT_Term.term)  ->  FStar_ToSMT_Term.term  ->  (FStar_ToSMT_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f negs check -> (let _148_138 = (let _148_137 = (let _148_136 = (let _148_135 = (let _148_134 = (FStar_ToSMT_Term.mkNot negs)
in (f _148_134))
in (FStar_ToSMT_Term.mkNot _148_135))
in ((_148_136), (None)))
in FStar_ToSMT_Term.Assume (_148_137))
in (check _148_138)))
