...
let rec argIsExp = (fun k typeName -> (match ((let _130_7 = (FStar_Absyn_Util.compress_kind k)
in _130_7.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Kind_type -> begin
[]
end
| FStar_Absyn_Syntax.Kind_arrow (bs, r) -> begin
(let _130_9 = (FStar_List.map binderIsExp bs)
in (let _130_8 = (argIsExp r typeName)
in (FStar_List.append _130_9 _130_8)))
end
...
let numIndices = (fun k typeName -> (let _130_14 = (argIsExp k typeName)
in (FStar_List.length _130_14)))
...
| h1::h2::tl -> begin
(let _130_34 = (let _130_33 = (curry ((h2)::tl) f out)
in (h1, FStar_Extraction_ML_Syntax.E_PURE, _130_33))
in FStar_Extraction_ML_Syntax.MLTY_Fun (_130_34))
end))
...
(let _130_86 = (FStar_Extraction_ML_Util.mkTypApp tyin (FStar_List.append argsin arrgs) ty)
in (extractTyp c _130_86))
end
| _61_127 -> begin
FStar_Extraction_ML_Env.unknownType
end)
...
in (let _130_98 = (let _130_97 = (FStar_Extraction_ML_Syntax.mlpath_of_lident ftv.FStar_Absyn_Syntax.v)
in ((FStar_List.append mlargs argCompletion), _130_97))
in FStar_Extraction_ML_Syntax.MLTY_Named (_130_98)))
end)))))
end
| false -> begin
...
(let _130_102 = (extractKind c btv.FStar_Absyn_Syntax.sort)
in (let _130_101 = (extendContextAsTyvar false (FStar_Util.Inl (btv)) c)
in (_130_102, _130_101)))
end
| (FStar_Util.Inr (bvv), _61_210) -> begin
(let _130_104 = (extractTyp c bvv.FStar_Absyn_Syntax.sort)
in (let _130_103 = (extendContextAsTyvar false (FStar_Util.Inr (bvv)) c)
in (_130_104, _130_103)))
end))
and extractBindersTypes = (fun c bs -> (let _130_110 = (FStar_List.fold_left (fun _61_216 b -> (match (_61_216) with
| (lt, cp) -> begin
...
(let _130_117 = (extractTyp c ty)
in (_130_117, FStar_Extraction_ML_Syntax.E_PURE))
end
| FStar_Absyn_Syntax.Comp (cm) -> begin
(let _130_119 = (extractTyp c cm.FStar_Absyn_Syntax.result_typ)
in (let _130_118 = (translate_eff c cm.FStar_Absyn_Syntax.effect_name)
in (_130_119, _130_118)))
end))
...
(match ((l = l')) with
| true -> begin
(let t = (let _130_167 = (FStar_List.map (fun _61_291 -> (match (_61_291) with
| (x, _61_290) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _130_167 t))
in Some (t))
end
| false -> begin
None
...
let parseInductiveConstructors = (fun c cnames sigb -> (FStar_List.map (fun h -> (let _130_175 = (lookupDataConType c sigb h)
in {cname = h; ctype = _130_175})) cnames))
...
| true -> begin
(let _130_199 = (totalType_of_comp cp)
in (ll, _130_199))
end
| false -> begin
(let _130_200 = (FStar_Extraction_ML_Util.mkTypFun lr cp t)
in (ll, _130_200))
end)
end))
end
...
in (let newC = (let _130_215 = (FStar_List.map (fun _61_420 -> (match (_61_420) with
| (x, y) -> begin
((Prims.fst x), (Prims.fst y))
end)) lp)
in (extendContextWithRepAsTyVars _130_215 c))
in (let mlt = (let _130_216 = (extractTyp newC tr)
in (FStar_Extraction_ML_Util.eraseTypeDeep c _130_216))
in (let tys = (let _130_217 = (FStar_List.map mlTyIdentOfBinder tyBinders)
in (_130_217, mlt))
in (let fvv = (FStar_Extraction_ML_Env.mkFvvar ctor.cname ctor.ctype)
in (let _130_220 = (FStar_Extraction_ML_Env.extend_fv c fvv tys false)
in (let _130_219 = (let _130_218 = (argTypes mlt)
in ((lident2mlsymbol ctor.cname), _130_218))
in (_130_220, _130_219)))))))))
end)))

let rec firstNNats = (fun n -> (match ((0 < n)) with
| true -> begin
(let _130_223 = (firstNNats (n - 1))
in (n)::_130_223)
end
| false -> begin
[]
...
let dummyIdent = (fun n -> (let _130_227 = (let _130_226 = (FStar_Util.string_of_int n)
in (Prims.strcat "\'dummyV" _130_226))
in (_130_227, 0)))

let dummyIndexIdents = (fun n -> (let _130_230 = (firstNNats n)
in (FStar_List.map dummyIdent _130_230)))
...
| (nc, tyb) -> begin
(let mlbs = (let _130_236 = (FStar_List.map mlTyIdentOfBinder ind.tyBinders)
in (let _130_235 = (dummyIndexIdents nIndices)
in (FStar_List.append _130_236 _130_235)))
...
(let _61_470 = (let _130_246 = (let _130_245 = (mfst bs)
in (extendContext c _130_245))
in (headBinders _130_246 t))
...
in (let c = (let _130_251 = (mfst bs)
in (extendContext c _130_251))
...
in (let td = (let _130_252 = (FStar_List.map mlTyIdentOfBinder bs)
in ((mlsymbolOfLident l), _130_252, Some (tyDecBody)))
...
in (let ex_decl = (let _130_258 = (let _130_257 = (argTypes mlt)
in ((lident2mlsymbol exnConstr.cname), _130_257))
in FStar_Extraction_ML_Syntax.MLM_Exn (_130_258))
in (let _130_259 = (FStar_Extraction_ML_Env.extend_fv c fvv tys false)
in (_130_259, ex_decl))))))))
...
| (c, tds) -> begin
(let _130_264 = (match ((FStar_All.pipe_right quals (FStar_List.contains FStar_Absyn_Syntax.Logic))) with
| true -> begin
[]
end
| false -> begin
...
(let _61_527 = ()
in (let _61_531 = (let _130_265 = (FStar_List.hd exConstrs)
in (extractExn c _130_265))
