...
open Prims
# 28 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

let binderIsExp : FStar_Absyn_Syntax.binder  ->  Prims.bool = (fun bn -> (FStar_Absyn_Print.is_inr (Prims.fst bn)))

# 30 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 38 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 41 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 45 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 59 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 67 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 74 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

type context =
FStar_Extraction_ML_Env.env

# 86 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 96 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 100 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 106 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 109 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

let isTypeScheme : FStar_Ident.lident  ->  context  ->  Prims.bool = (fun i c -> true)

# 115 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 120 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 122 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 219 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 225 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 230 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

let mlsymbolOfLident : FStar_Ident.lident  ->  Prims.string = (fun id -> id.FStar_Ident.ident.FStar_Ident.idText)

# 234 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

type inductiveConstructor =
{cname : FStar_Ident.lident; ctype : FStar_Absyn_Syntax.typ}

# 238 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 241 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 242 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
if (l = l') then begin
(let t = (let _180_169 = (FStar_List.map (fun _78_291 -> (match (_78_291) with
| (x, _78_290) -> begin
...
# 266 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 270 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 296 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 304 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

let lident2mlsymbol : FStar_Ident.lident  ->  Prims.string = (fun l -> l.FStar_Ident.ident.FStar_Ident.idText)

# 306 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 311 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 317 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 333 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 340 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 342 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
in (let newC = (let _180_217 = (FStar_List.map (fun _78_420 -> (match (_78_420) with
| (x, y) -> begin
...
# 356 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 369 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 371 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 372 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
# 387 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"

let mfst = (fun x -> (FStar_List.map Prims.fst x))

# 389 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
(let _78_470 = (let _180_248 = (let _180_247 = (mfst bs)
...
# 400 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
in (let c = (let _180_253 = (mfst bs)
in (extendContext c _180_253))
...
in (let td = (let _180_254 = (FStar_List.map mlTyIdentOfBinder bs)
in ((mlsymbolOfLident l), _180_254, Some (tyDecBody)))
in (let c = (FStar_Extraction_ML_Env.extend_tydef c ((td)::[]))
in (c, td))))))))
end)))))))

# 422 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
in (let ex_decl = (let _180_260 = (let _180_259 = (argTypes mlt)
in ((lident2mlsymbol exnConstr.cname), _180_259))
in FStar_Extraction_ML_Syntax.MLM_Exn (_180_260))
in (let _180_261 = (FStar_Extraction_ML_Env.extend_fv c fvv tys false false)
in (_180_261, ex_decl))))))))

# 430 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
in (let _180_265 = (let _180_264 = (FStar_Range.file_of_range r)
in (line, _180_264))
in FStar_Extraction_ML_Syntax.MLM_Loc (_180_265)))))

# 435 "D:\\cygwin\\home\\protz\\Code\\fstar\\src\\extraction\\extracttyp.fs"
...
| (c, tds) -> begin
(let _180_271 = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Absyn_Syntax.Logic)) then begin
[]
end else begin
(let _180_270 = (mlloc_of_range range)
in (_180_270)::(FStar_Extraction_ML_Syntax.MLM_Ty ((tds)::[]))::[])
end
in (c, _180_271))
end))
end
...
(let _78_528 = ()
in (let _78_532 = (let _180_272 = (FStar_List.hd exConstrs)
in (extractExn c _180_272))
...
| (c, tyAbDecls) -> begin
(let _180_276 = (let _180_275 = (mlloc_of_range range)
in (_180_275)::(FStar_Extraction_ML_Syntax.MLM_Ty ((FStar_List.append indDecls tyAbDecls)))::[])
in (c, _180_276))
end))
end))
end))
