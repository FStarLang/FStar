...
in (let res = (let _70_30264 = (Microsoft_FStar_Options.specs ())
in (Support.Microsoft.FStar.Getopt.parse_cmdline _70_30264 (fun ( i ) -> (let _70_30263 = (let _70_30262 = (Support.ST.read file_list)
in (Support.List.append _70_30262 ((i)::[])))
in (Support.ST.op_Colon_Equals file_list _70_30263)))))
in (let _70_8 = (match (res) with
| Support.Microsoft.FStar.Getopt.GoOn -> begin
(let _70_30265 = (Microsoft_FStar_Options.set_fstar_home ())
in (Support.Prims.ignore _70_30265))
end
| _70_7 -> begin
()
end)
in (let _70_30266 = (Support.ST.read file_list)
in (res, _70_30266)))))
end))
...
in (let _70_20 = (let _70_30273 = (Microsoft_FStar_Parser_DesugarEnv.empty_env ())
in (Microsoft_FStar_Parser_Driver.parse_file _70_30273 p))
in (match (_70_20) with
| (dsenv, prims_mod) -> begin
(let _70_23 = (let _70_30274 = (Support.List.hd prims_mod)
in (Microsoft_FStar_Tc_Tc.check_module env _70_30274))
...
| true -> begin
(let _70_29 = (let _70_30277 = (Support.Microsoft.FStar.Util.string_of_int errs)
...
in (let _70_113 = (match ((let _70_30345 = (Support.ST.read Microsoft_FStar_Options.codegen)
in (Support.Option.isSome _70_30345))) with
| true -> begin
...
| Pop (msg) -> begin
(let _70_152 = (let _70_30356 = (Microsoft_FStar_Tc_Env.pop env msg)
in (Support.All.pipe_right _70_30356 Support.Prims.ignore))
in (let _70_154 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.refresh ())
in (let _70_156 = (let _70_30357 = (Microsoft_FStar_Options.reset_options ())
in (Support.All.pipe_right _70_30357 Support.Prims.ignore))
...
in (dsenv, env))))
in (let fail = (fun ( curmod ) ( dsenv_mark ) ( env_mark ) -> (let _70_198 = (let _70_30376 = (Microsoft_FStar_Tc_Errors.report_all ())
in (Support.All.pipe_right _70_30376 Support.Prims.ignore))
...
| true -> begin
(let _70_30385 = (let _70_30384 = (Microsoft_FStar_Absyn_Syntax.text_of_lid m.Microsoft_FStar_Absyn_Syntax.name)
in (Support.Microsoft.FStar.Util.format2 "%s module: %s\n" msg _70_30384))
in (Support.Microsoft.FStar.Util.print_string _70_30385))
end
| false -> begin
()
end))))
...
| () -> begin
(let mllib = (let _70_30391 = (Support.List.tail fmods)
in (Microsoft_FStar_Backends_OCaml_ASTTrans.mlmod_of_fstars _70_30391))
in (let doc = (Microsoft_FStar_Backends_OCaml_Code.doc_of_mllib mllib)
in (Support.List.iter (fun ( _70_267 ) -> (match (_70_267) with
| (n, d) -> begin
(let _70_30394 = (Microsoft_FStar_Options.prependOutputDir (Support.String.strcat n ".ml"))
in (let _70_30393 = (FSharp_Format.pretty 120 d)
in (Support.Microsoft.FStar.Util.write_file _70_30394 _70_30393)))
end)) doc)))
end)) (fun ( _70_252 ) -> (match (_70_252) with
| Microsoft_FStar_Backends_OCaml_ASTTrans.OCamlFailure ((rg, error)) -> begin
(let _70_259 = (let _70_30398 = (let _70_30397 = (Support.Microsoft.FStar.Range.string_of_range rg)
in (let _70_30396 = (Microsoft_FStar_Backends_OCaml_ASTTrans.string_of_error error)
in (Support.Microsoft.FStar.Util.format2 "OCaml Backend Error: %s %s\n" _70_30397 _70_30396)))
in (Support.All.pipe_left Support.Microsoft.FStar.Util.print_string _70_30398))
in (Support.All.exit 1))
end)))
end
| false -> begin
...
| true -> begin
(let _70_270 = (let _70_30399 = (Microsoft_FStar_Extraction_ML_Env.mkContext env)
in (Support.Microsoft.FStar.Util.fold_map Microsoft_FStar_Extraction_ML_ExtractMod.extract _70_30399 fmods))
...
| (n, d) -> begin
(let _70_30402 = (Microsoft_FStar_Options.prependOutputDir (Support.String.strcat n ".ml"))
in (let _70_30401 = (FSharp_Format.pretty 120 d)
in (Support.Microsoft.FStar.Util.write_file _70_30402 _70_30401)))
end)) newDocs)))
end))
end
| false -> begin
...
(let _70_30404 = (Microsoft_FStar_Options.specs ())
in (Microsoft_FStar_Options.display_usage _70_30404))
end
...
| true -> begin
(let _70_30409 = (Support.Microsoft.FStar.Util.message_of_exn e)
in (let _70_30408 = (Support.Microsoft.FStar.Util.trace_of_exn e)
in (Support.Microsoft.FStar.Util.fprint2 "\nUnexpected error\n%s\n%s\n" _70_30409 _70_30408)))
end
| false -> begin
(match ((not ((Microsoft_FStar_Absyn_Util.handleable e)))) with
| true -> begin
(let _70_30410 = (Support.Microsoft.FStar.Util.message_of_exn e)
