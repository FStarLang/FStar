...
let process_args = (fun _59_1 -> (match (_59_1) with
| () -> begin
...
let cleanup = (fun _59_10 -> (match (_59_10) with
| () -> begin
...
let tc_prims = (fun _59_12 -> (match (_59_12) with
| () -> begin
...
in (let _59_15 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.init env)
in (let p = (Microsoft_FStar_Options.prims ())
in (let _59_20 = (Microsoft_FStar_Parser_Driver.parse_file (Microsoft_FStar_Parser_DesugarEnv.empty_env ()) p)
in (match (_59_20) with
| (dsenv, prims_mod) -> begin
(let _59_23 = (Microsoft_FStar_Tc_Tc.check_module env (Support.List.hd prims_mod))
in (match (_59_23) with
| (prims_mod, env) -> begin
(prims_mod, dsenv, env)
end))
end))))))
...
let tc_one_file = (fun dsenv env fn -> (let _59_36 = (Microsoft_FStar_Parser_Driver.parse_file dsenv fn)
in (match (_59_36) with
| (dsenv, fmods) -> begin
(let _59_46 = ((Support.List.fold_left (fun _59_39 m -> (match (_59_39) with
| (env, all_mods) -> begin
(let _59_43 = (Microsoft_FStar_Tc_Tc.check_module env m)
in (match (_59_43) with
| (ms, env) -> begin
(env, ms)
end))
end)) (env, [])) fmods)
...
let tc_one_fragment = (fun curmod dsenv env frag -> (Support.Prims.try_with (fun _59_52 -> (match (_59_52) with
| () -> begin
...
in (let _59_79 = (Microsoft_FStar_Tc_Tc.tc_partial_modul env modul)
...
(let _59_92 = (Microsoft_FStar_Tc_Tc.tc_more_partial_modul env modul decls)
in (match (_59_92) with
| (modul, npds', env) -> begin
Some ((Some ((modul, (Support.List.append npds npds'))), dsenv, env))
end))
end)
end)
end)) (fun _59_51 -> (match (_59_51) with
| Microsoft_FStar_Absyn_Syntax.Error ((msg, r)) -> begin
(let _59_58 = (Microsoft_FStar_Tc_Errors.add_errors env (((msg, r))::[]))
in None)
end
| Microsoft_FStar_Absyn_Syntax.Err (msg) -> begin
(let _59_62 = (Microsoft_FStar_Tc_Errors.add_errors env (((msg, Microsoft_FStar_Absyn_Syntax.dummyRange))::[]))
in None)
end
| e -> begin
(raise (e))
...
in (let _59_110 = if (Support.Option.isSome (! (Microsoft_FStar_Options.codegen))) then begin
(let _59_108 = (Support.Microsoft.FStar.Util.print_string "Code-generation is not supported in interactive mode")
in (exit (1)))
end
in (let chunk = (Support.Microsoft.FStar.Util.new_string_builder ())
in (let stdin = (Support.Microsoft.FStar.Util.open_stdin ())
in (let rec fill_chunk = (fun _59_115 -> (match (_59_115) with
| () -> begin
...
| Pop (msg) -> begin
(let _59_149 = ((Support.Prims.ignore) (Microsoft_FStar_Tc_Env.pop env msg))
in (let _59_151 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.refresh ())
in (let _59_153 = ((Support.Prims.ignore) (Microsoft_FStar_Options.reset_options ()))
in (let _59_164 = (match (stack) with
| [] -> begin
...
in (dsenv, env))))
in (let fail = (fun curmod dsenv_mark env_mark -> (let _59_195 = ((Support.Prims.ignore) (Microsoft_FStar_Tc_Errors.report_all ()))
in (let _59_197 = (Support.ST.op_Colon_Equals Microsoft_FStar_Tc_Errors.num_errs 0)
in (let _59_199 = (Support.Microsoft.FStar.Util.fprint1 "%s\n" fail)
in (let _59_203 = (reset_mark dsenv_mark env_mark)
in (match (_59_203) with
| (dsenv, env) -> begin
(go stack curmod dsenv env)
end))))))
in (let _59_206 = (mark dsenv env)
...
(let _59_213 = (Support.Microsoft.FStar.Util.fprint1 "\n%s\n" ok)
in (let _59_217 = (commit_mark dsenv env)
in (match (_59_217) with
| (dsenv, env) -> begin
(go stack curmod dsenv env)
end)))
end else begin
...
let batch_mode_tc = (fun filenames -> (let _59_224 = (tc_prims ())
in (match (_59_224) with
| (prims_mod, dsenv, env) -> begin
(let _59_239 = ((Support.List.fold_left (fun _59_228 f -> (match (_59_228) with
| (all_mods, dsenv, env) -> begin
(let _59_230 = (Microsoft_FStar_Absyn_Util.reset_gensym ())
in (let _59_235 = (tc_one_file dsenv env f)
in (match (_59_235) with
| (dsenv, env, ms) -> begin
((Support.List.append all_mods ms), dsenv, env)
end)))
end)) (prims_mod, dsenv, env)) filenames)
in (match (_59_239) with
| (all_mods, dsenv, env) -> begin
(let _59_240 = if ((! (Microsoft_FStar_Options.interactive)) && ((Microsoft_FStar_Tc_Errors.get_err_count ()) = 0)) then begin
...
in (let _59_245 = ((Support.List.iter (fun m -> if (Microsoft_FStar_Options.should_verify m.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str) then begin
...
let go = (fun _59_267 -> (let _59_271 = (process_args ())
in (match (_59_271) with
| (res, filenames) -> begin
(match (res) with
...
in (let _59_286 = (batch_mode_tc filenames)
in (match (_59_286) with
| (fmods, dsenv, env) -> begin
(let _59_287 = (report_errors None)
in if (! (Microsoft_FStar_Options.interactive)) then begin
(interactive_mode dsenv env)
end else begin
(let _59_289 = (codegen fmods env)
...
let main = (fun _59_291 -> (match (_59_291) with
| () -> begin
(Support.Prims.try_with (fun _59_293 -> (match (_59_293) with
| () -> begin
(let _59_304 = (go ())
in (let _59_306 = (cleanup ())
in (exit (0))))
end)) (fun _59_292 -> (match (_59_292) with
| e -> begin
(let _59_296 = if (Microsoft_FStar_Absyn_Util.handleable e) then begin
(Microsoft_FStar_Absyn_Util.handle_err false () e)
end
in (let _59_298 = if (! (Microsoft_FStar_Options.trace_error)) then begin
