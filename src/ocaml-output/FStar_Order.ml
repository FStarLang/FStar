...
let (uu___is_Lt : order -> Prims.bool) =
  fun projectee  -> match projectee with | Lt  -> true | uu____14050 -> false 
let (uu___is_Eq : order -> Prims.bool) =
  fun projectee  -> match projectee with | Eq  -> true | uu____14061 -> false 
let (uu___is_Gt : order -> Prims.bool) =
  fun projectee  -> match projectee with | Gt  -> true | uu____14072 -> false 
  ...
  fun f  ->
    fun l1  ->
      fun l2  ->
        ...
        | (uu____14253,[]) -> Gt
        | (x::xs,y::ys) ->
            let uu____14272 = f x y  in
            lex uu____14272 (fun uu____14274  -> compare_list f xs ys)
    ...
    fun x  ->
      fun y  ->
        ...
        | (FStar_Pervasives_Native.Some
           uu____14331,FStar_Pervasives_Native.None ) -> Gt
