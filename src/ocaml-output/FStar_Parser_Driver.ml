...
let is_cache_file : Prims.string -> Prims.bool =
  fun fn ->
    let uu____4 = FStar_Util.get_file_extension fn in
    uu____4 = ".cache"
...
let uu___is_Modul : fragment -> Prims.bool =
  fun projectee -> match projectee with Modul _0 -> true | uu____23 -> false
...
let uu___is_Decls : fragment -> Prims.bool =
  fun projectee -> match projectee with Decls _0 -> true | uu____37 -> false
...
let parse_file
  ...
  fun fn ->
    let uu____139 =
      FStar_Parser_ParseIt.parse (FStar_Parser_ParseIt.Filename fn)
    in
