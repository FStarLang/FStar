...
(let _67_22 = (FStar_Parser_Desugar.desugar_partial_modul curmod env modul)
in (match (_67_22) with
| (env, modul) -> begin
Modul ((env, modul))
end))
end
...
| FStar_Util.Inl (FStar_Util.Inr (_67_39)) -> begin
(let _67_42 = (FStar_Util.print1 "%s: Expected a module\n" fn)
in (FStar_All.exit 1))
end
| FStar_Util.Inr (msg, r) -> begin
