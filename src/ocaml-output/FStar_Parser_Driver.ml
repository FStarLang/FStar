...
let print_error = (fun msg r -> (let _117_6 = (let _117_5 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "ERROR %s: %s\n" _117_5 msg))
in (FStar_Util.print_string _117_6)))
...
(let _117_41 = (FStar_Parser_Desugar.desugar_decls env decls)
in Decls (_117_41))
end
...
| true -> begin
(let full_name = (let _117_49 = (let _117_48 = (let _117_47 = (let _117_46 = (FStar_Options.get_fstar_home ())
in (Prims.strcat _117_46 "/"))
in (Prims.strcat _117_47 FStar_Options.cache_dir))
in (Prims.strcat _117_48 "/"))
in (Prims.strcat _117_49 fn))
in (let m = (let _117_50 = (FStar_Util.get_oreader full_name)
in (FStar_Absyn_SSyntax.deserialize_modul _117_50))
in (let _117_51 = (FStar_Parser_Desugar.add_modul_to_env m env)
in (_117_51, (m)::[]))))
end
| false -> begin
...
| FStar_Util.Inr (msg, r) -> begin
(let _48_51 = (let _117_52 = (FStar_Absyn_Print.format_error r msg)
in (FStar_All.pipe_left FStar_Util.print_string _117_52))
in (FStar_All.exit 1))
end)
end))
