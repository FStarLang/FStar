...
let tc_prims : Prims.unit  ->  (FStar_Absyn_Syntax.modul Prims.list * FStar_Parser_DesugarEnv.env * FStar_Tc_Env.env) = (fun _76_5 -> (match (()) with
| () -> begin
(
...
let _76_8 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.init env)
in (
# 58 "FStar.Stratified.fst"
let p = (FStar_Options.prims ())
in (
# 59 "FStar.Stratified.fst"
let _76_13 = (let _155_9 = (FStar_Parser_DesugarEnv.empty_env ())
in (parse _155_9 p))
in (match (_76_13) with
| (dsenv, prims_mod) -> begin
(
# 60 "FStar.Stratified.fst"
let _76_16 = (let _155_10 = (FStar_List.hd prims_mod)
in (FStar_Tc_Tc.check_module env _155_10))
in (match (_76_16) with
| (prims_mod, env) -> begin
(prims_mod, dsenv, env)
end))
end))))))
...
let _76_22 = (parse dsenv fn)
in (match (_76_22) with
| (dsenv, fmods) -> begin
(
# 70 "FStar.Stratified.fst"
let _76_32 = (FStar_All.pipe_right fmods (FStar_List.fold_left (fun _76_25 m -> (match (_76_25) with
| (env, all_mods) -> begin
(
# 72 "FStar.Stratified.fst"
let _76_29 = (FStar_Tc_Tc.check_module env m)
in (match (_76_29) with
| (ms, env) -> begin
...
let _76_50 = (FStar_All.pipe_right filenames (FStar_List.fold_left (fun _76_39 f -> (match (_76_39) with
| (all_mods, dsenv, env) -> begin
(
# 82 "FStar.Stratified.fst"
let _76_41 = (FStar_Absyn_Util.reset_gensym ())
in (
# 83 "FStar.Stratified.fst"
let _76_46 = (tc_one_file dsenv env f)
in (match (_76_46) with
| (ms, dsenv, env) -> begin
((FStar_List.append all_mods ms), dsenv, env)
end)))
end)) ([], dsenv, env)))
in (match (_76_50) with
| (all_mods, dsenv, env) -> begin
(
# 86 "FStar.Stratified.fst"
let _76_51 = if ((FStar_ST.read FStar_Options.interactive) && ((FStar_Tc_Errors.get_err_count ()) = 0)) then begin
...
let _76_57 = (tc_prims ())
in (match (_76_57) with
| (prims_mod, dsenv, env) -> begin
(
# 93 "FStar.Stratified.fst"
let _76_60 = (FStar_Dependences.find_deps_if_needed filenames)
in (match (_76_60) with
| (filenames, admit_fsi) -> begin
(
# 94 "FStar.Stratified.fst"
let _76_64 = (batch_mode_tc_no_prims dsenv env filenames)
in (match (_76_64) with
| (all_mods, dsenv, env) -> begin
...
let _76_90 = (FStar_Parser_Desugar.desugar_partial_modul curmod dsenv ast_modul)
in (match (_76_90) with
| (dsenv, modul) -> begin
(
...
let _76_98 = (FStar_Tc_Tc.tc_partial_modul env modul)
in (match (_76_98) with
| (modul, env) -> begin
...
let _76_103 = (FStar_Parser_Desugar.desugar_decls dsenv ast_decls)
in (match (_76_103) with
| (dsenv, decls) -> begin
(match (curmod) with
| None -> begin
(
# 117 "FStar.Stratified.fst"
let _76_105 = (FStar_Util.print_error "fragment without an enclosing module")
in (FStar_All.exit 1))
end
| Some (modul) -> begin
(
# 119 "FStar.Stratified.fst"
let _76_111 = (FStar_Tc_Tc.tc_more_partial_modul env modul decls)
in (match (_76_111) with
| (modul, env) -> begin
Some ((Some (modul), dsenv, env))
end))
end)
...
let _76_76 = (FStar_Tc_Errors.add_errors env (((msg, r))::[]))
in None)
end
| FStar_Absyn_Syntax.Err (msg) -> begin
(
# 127 "FStar.Stratified.fst"
let _76_80 = (FStar_Tc_Errors.add_errors env (((msg, FStar_Range.dummyRange))::[]))
in None)
end
| e -> begin
(Prims.raise e)
...
let pop = (fun _76_115 msg -> (match (_76_115) with
| (dsenv, env) -> begin
(
# 137 "FStar.Stratified.fst"
let _76_117 = (let _155_43 = (FStar_Parser_DesugarEnv.pop dsenv)
in (FStar_All.pipe_right _155_43 Prims.ignore))
in (
# 138 "FStar.Stratified.fst"
let _76_119 = (let _155_44 = (FStar_Tc_Env.pop env msg)
in (FStar_All.pipe_right _155_44 Prims.ignore))
in (
# 139 "FStar.Stratified.fst"
let _76_121 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (let _155_45 = (FStar_Options.restore_cmd_line_options ())
in (FStar_All.pipe_right _155_45 Prims.ignore)))))
end))
in (
# 142 "FStar.Stratified.fst"
let push = (fun _76_126 msg -> (match (_76_126) with
| (dsenv, env) -> begin
(
...
let mark = (fun _76_133 -> (match (_76_133) with
| (dsenv, env) -> begin
(
...
let reset_mark = (fun _76_139 -> (match (_76_139) with
| (dsenv, env) -> begin
(
...
let commit_mark = (fun _76_145 -> (match (_76_145) with
| (dsenv, env) -> begin
(
...
let check_frag = (fun _76_151 curmod text -> (match (_76_151) with
| (dsenv, env) -> begin
(match ((tc_one_fragment curmod dsenv env text)) with
| Some (m, dsenv, env) -> begin
(let _155_63 = (let _155_62 = (FStar_Tc_Errors.get_err_count ())
in (m, (dsenv, env), _155_62))
in Some (_155_63))
end
| _76_160 -> begin
None
...
let report_fail = (fun _76_162 -> (match (()) with
| () -> begin
(
# 169 "FStar.Stratified.fst"
let _76_163 = (let _155_66 = (FStar_Tc_Errors.report_all ())
in (FStar_All.pipe_right _155_66 Prims.ignore))
