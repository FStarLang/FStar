...
let _94_89 = (FStar_Parser_Desugar.desugar_partial_modul curmod dsenv ast_modul)
in (match (_94_89) with
| (dsenv, modul) -> begin
(
...
let _94_97 = (FStar_Tc_Tc.tc_partial_modul env modul)
...
let _94_102 = (FStar_Parser_Desugar.desugar_decls dsenv ast_decls)
...
let _94_104 = (FStar_Util.print_error "fragment without an enclosing module")
in (FStar_All.exit (Prims.parse_int "1")))
end
| Some (modul) -> begin
(

let _94_110 = (FStar_Tc_Tc.tc_more_partial_modul env modul decls)
in (match (_94_110) with
| (modul, env) -> begin
Some (((Some (modul)), (dsenv), (env)))
end))
end)
...
let _94_75 = (FStar_Tc_Errors.add_errors env ((((msg), (r)))::[]))
in None)
end
| FStar_Absyn_Syntax.Err (msg) -> begin
(

let _94_79 = (FStar_Tc_Errors.add_errors env ((((msg), (FStar_Range.dummyRange)))::[]))
in None)
end
| e -> begin
(Prims.raise e)
...
let pop = (fun _94_114 msg -> (match (_94_114) with
| (dsenv, env) -> begin
(

let _94_116 = (let _191_45 = (FStar_Parser_DesugarEnv.pop dsenv)
in (FStar_All.pipe_right _191_45 Prims.ignore))
in (

let _94_118 = (let _191_46 = (FStar_Tc_Env.pop env msg)
in (FStar_All.pipe_right _191_46 Prims.ignore))
in (

let _94_120 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (FStar_Options.pop ()))))
end))
in (

let push = (fun _94_125 msg -> (match (_94_125) with
| (dsenv, env) -> begin
(
...
let _94_129 = (FStar_Options.push ())
in ((dsenv), (env)))))
end))
in (

let mark = (fun _94_134 -> (match (_94_134) with
| (dsenv, env) -> begin
(
...
let _94_137 = (FStar_Options.push ())
in ((dsenv), (env)))))
end))
in (

let reset_mark = (fun _94_142 -> (match (_94_142) with
| (dsenv, env) -> begin
(
...
let _94_145 = (FStar_Options.pop ())
in ((dsenv), (env)))))
end))
in (

let commit_mark = (fun _94_150 -> (match (_94_150) with
| (dsenv, env) -> begin
(
...
let check_frag = (fun _94_156 curmod text -> (match (_94_156) with
| (dsenv, env) -> begin
(match ((tc_one_fragment curmod dsenv env text)) with
| Some (m, dsenv, env) -> begin
(let _191_64 = (let _191_63 = (FStar_Tc_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_191_63)))
in Some (_191_64))
end
| _94_165 -> begin
None
...
let report_fail = (fun _94_167 -> (match (()) with
| () -> begin
(

let _94_168 = (let _191_67 = (FStar_Tc_Errors.report_all ())
in (FStar_All.pipe_right _191_67 Prims.ignore))
