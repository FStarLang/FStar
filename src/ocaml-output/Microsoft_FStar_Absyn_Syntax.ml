...
| (ns, id) -> begin
(let nsstr = (let _65_7307 = (Support.List.map text_of_id ns)
in (Support.Prims.pipe_right _65_7307 text_of_path))
...
let no_fvs = (let _65_7356 = (new_ftv_set ())
in (let _65_7355 = (new_ftv_set ())
in {ftvs = _65_7356; fxvs = _65_7355}))

let no_uvs = (let _65_7359 = (new_uv_set ())
in (let _65_7358 = (new_uvt_set ())
in (let _65_7357 = (new_uvt_set ())
in {uvars_k = _65_7359; uvars_t = _65_7358; uvars_e = _65_7357})))
...
(let _20_353 = out
in (let _65_7364 = (Support.Microsoft.FStar.Util.set_add btv out.ftvs)
in {ftvs = _65_7364; fxvs = _20_353.fxvs}))
end
| Support.Microsoft.FStar.Util.Inr (bxv) -> begin
(let _20_357 = out
in (let _65_7365 = (Support.Microsoft.FStar.Util.set_add bxv out.fxvs)
in {ftvs = _20_357.ftvs; fxvs = _65_7365}))
end)) no_fvs)))

let list_of_freevars = (fun ( fvs ) -> (let _65_7373 = (let _65_7369 = (Support.Microsoft.FStar.Util.set_elements fvs.ftvs)
in (Support.Prims.pipe_right _65_7369 (Support.List.map (fun ( x ) -> Support.Microsoft.FStar.Util.Inl (x)))))
in (let _65_7372 = (let _65_7371 = (Support.Microsoft.FStar.Util.set_elements fvs.fxvs)
in (Support.Prims.pipe_right _65_7371 (Support.List.map (fun ( x ) -> Support.Microsoft.FStar.Util.Inr (x)))))
in (Support.List.append _65_7373 _65_7372))))
...
let mk_Kind_type = (let _65_7378 = (get_unit_ref ())
in (let _65_7377 = (mk_fvs ())
in (let _65_7376 = (mk_uvs ())
in {n = Kind_type; tk = _65_7378; pos = dummyRange; fvs = _65_7377; uvs = _65_7376})))

let mk_Kind_effect = (let _65_7381 = (get_unit_ref ())
in (let _65_7380 = (mk_fvs ())
in (let _65_7379 = (mk_uvs ())
in {n = Kind_effect; tk = _65_7381; pos = dummyRange; fvs = _65_7380; uvs = _65_7379})))

let mk_Kind_abbrev = (fun ( _20_368 ) ( p ) -> (match (_20_368) with
| (kabr, k) -> begin
(let _65_7388 = (get_unit_ref ())
in (let _65_7387 = (mk_fvs ())
in (let _65_7386 = (mk_uvs ())
in {n = Kind_abbrev ((kabr, k)); tk = _65_7388; pos = p; fvs = _65_7387; uvs = _65_7386})))
end))

let mk_Kind_arrow = (fun ( _20_372 ) ( p ) -> (match (_20_372) with
| (bs, k) -> begin
(let _65_7395 = (get_unit_ref ())
in (let _65_7394 = (mk_fvs ())
in (let _65_7393 = (mk_uvs ())
in {n = Kind_arrow ((bs, k)); tk = _65_7395; pos = p; fvs = _65_7394; uvs = _65_7393})))
end))
...
let mk_Kind_uvar = (fun ( uv ) ( p ) -> (let _65_7406 = (get_unit_ref ())
in (let _65_7405 = (mk_fvs ())
in (let _65_7404 = (mk_uvs ())
in {n = Kind_uvar (uv); tk = _65_7406; pos = p; fvs = _65_7405; uvs = _65_7404}))))

let mk_Kind_lam = (fun ( _20_391 ) ( p ) -> (match (_20_391) with
| (vs, k) -> begin
(let _65_7413 = (get_unit_ref ())
in (let _65_7412 = (mk_fvs ())
in (let _65_7411 = (mk_uvs ())
in {n = Kind_lam ((vs, k)); tk = _65_7413; pos = p; fvs = _65_7412; uvs = _65_7411})))
end))

let mk_Kind_delayed = (fun ( _20_396 ) ( p ) -> (match (_20_396) with
| (k, s, m) -> begin
(let _65_7420 = (get_unit_ref ())
in (let _65_7419 = (mk_fvs ())
in (let _65_7418 = (mk_uvs ())
in {n = Kind_delayed ((k, s, m)); tk = _65_7420; pos = p; fvs = _65_7419; uvs = _65_7418})))
end))

let mk_Kind_unknown = (let _65_7423 = (get_unit_ref ())
in (let _65_7422 = (mk_fvs ())
in (let _65_7421 = (mk_uvs ())
in {n = Kind_unknown; tk = _65_7423; pos = dummyRange; fvs = _65_7422; uvs = _65_7421})))
...
let mk_Typ_btvar = (fun ( x ) ( k ) ( p ) -> (let _65_7436 = (get_knd_ref k)
in (let _65_7435 = (mk_fvs ())
in (let _65_7434 = (mk_uvs ())
in {n = Typ_btvar (x); tk = _65_7436; pos = p; fvs = _65_7435; uvs = _65_7434}))))

let mk_Typ_const = (fun ( x ) ( k ) ( p ) -> (let _65_7443 = (get_knd_ref k)
in {n = Typ_const (x); tk = _65_7443; pos = p; fvs = memo_no_fvs; uvs = memo_no_uvs}))
...
| (bs, c) -> begin
(let _65_7456 = (check_fun bs c p)
in (let _65_7455 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7454 = (mk_fvs ())
in (let _65_7453 = (mk_uvs ())
in {n = _65_7456; tk = _65_7455; pos = p; fvs = _65_7454; uvs = _65_7453}))))
end))

let mk_Typ_refine = (fun ( _20_425 ) ( k ) ( p ) -> (match (_20_425) with
| (x, phi) -> begin
(let _65_7465 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7464 = (mk_fvs ())
in (let _65_7463 = (mk_uvs ())
in {n = Typ_refine ((x, phi)); tk = _65_7465; pos = p; fvs = _65_7464; uvs = _65_7463})))
end))

let mk_Typ_app = (fun ( _20_430 ) ( k ) ( p ) -> (match (_20_430) with
| (t1, args) -> begin
(let _65_7475 = (match (args) with
| [] -> begin
...
in (let _65_7474 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7473 = (mk_fvs ())
in (let _65_7472 = (mk_uvs ())
in {n = _65_7475; tk = _65_7474; pos = p; fvs = _65_7473; uvs = _65_7472}))))
end))
...
in (let _65_7496 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7495 = (mk_fvs ())
in (let _65_7494 = (mk_uvs ())
in {n = _65_7497; tk = _65_7496; pos = p; fvs = _65_7495; uvs = _65_7494}))))
end))
...
| (t, k) -> begin
(let _65_7512 = (Support.Microsoft.FStar.Util.mk_ref k')
in (let _65_7511 = (mk_fvs ())
in (let _65_7510 = (mk_uvs ())
in {n = Typ_ascribed ((t, k)); tk = _65_7512; pos = p; fvs = _65_7511; uvs = _65_7510})))
end))
...
let mk_Typ_meta' = (fun ( m ) ( k ) ( p ) -> (let _65_7525 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7524 = (mk_fvs ())
in (let _65_7523 = (mk_uvs ())
in {n = Typ_meta (m); tk = _65_7525; pos = p; fvs = _65_7524; uvs = _65_7523}))))
...
(let _65_7528 = (Support.ST.read t.tk)
in (mk_Typ_meta' m _65_7528 t.pos))
end))

let mk_Typ_uvar' = (fun ( _20_515 ) ( k' ) ( p ) -> (match (_20_515) with
| (u, k) -> begin
(let _65_7537 = (get_knd_ref k')
in (let _65_7536 = (mk_fvs ())
in (let _65_7535 = (mk_uvs ())
in {n = Typ_uvar ((u, k)); tk = _65_7537; pos = p; fvs = _65_7536; uvs = _65_7535})))
end))
...
in (let _65_7553 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7552 = (mk_fvs ())
in (let _65_7551 = (mk_uvs ())
in {n = _65_7554; tk = _65_7553; pos = p; fvs = _65_7552; uvs = _65_7551}))))
end))

let mk_Typ_delayed' = (fun ( st ) ( k ) ( p ) -> (let _65_7576 = (let _65_7572 = (let _65_7571 = (Support.Microsoft.FStar.Util.mk_ref None)
in (st, _65_7571))
in Typ_delayed (_65_7572))
in (let _65_7575 = (Support.Microsoft.FStar.Util.mk_ref k)
in (let _65_7574 = (mk_fvs ())
in (let _65_7573 = (mk_uvs ())
in {n = _65_7576; tk = _65_7575; pos = p; fvs = _65_7574; uvs = _65_7573})))))

let mk_Typ_unknown = (let _65_7579 = (get_knd_nref ())
in (let _65_7578 = (mk_fvs ())
in (let _65_7577 = (mk_uvs ())
in {n = Typ_unknown; tk = _65_7579; pos = dummyRange; fvs = _65_7578; uvs = _65_7577})))
...
let mk_Total = (fun ( t ) -> (let _65_7588 = (Support.Microsoft.FStar.Util.mk_ref None)
in (let _65_7587 = (mk_fvs ())
in (let _65_7586 = (mk_uvs ())
in {n = Total (t); tk = _65_7588; pos = t.pos; fvs = _65_7587; uvs = _65_7586}))))

let mk_Comp = (fun ( ct ) -> (let _65_7593 = (Support.Microsoft.FStar.Util.mk_ref None)
in (let _65_7592 = (mk_fvs ())
in (let _65_7591 = (mk_uvs ())
in {n = Comp (ct); tk = _65_7593; pos = ct.result_typ.pos; fvs = _65_7592; uvs = _65_7591}))))

let mk_Exp_bvar = (fun ( x ) ( t ) ( p ) -> (let _65_7602 = (get_typ_ref t)
in (let _65_7601 = (mk_fvs ())
in (let _65_7600 = (mk_uvs ())
in {n = Exp_bvar (x); tk = _65_7602; pos = p; fvs = _65_7601; uvs = _65_7600}))))

let mk_Exp_fvar = (fun ( _20_551 ) ( t ) ( p ) -> (match (_20_551) with
| (x, b) -> begin
(let _65_7611 = (get_typ_ref t)
in (let _65_7610 = (mk_fvs ())
in (let _65_7609 = (mk_uvs ())
in {n = Exp_fvar ((x, b)); tk = _65_7611; pos = p; fvs = _65_7610; uvs = _65_7609})))
end))

let mk_Exp_constant = (fun ( s ) ( t ) ( p ) -> (let _65_7620 = (get_typ_ref t)
in (let _65_7619 = (mk_fvs ())
in (let _65_7618 = (mk_uvs ())
in {n = Exp_constant (s); tk = _65_7620; pos = p; fvs = _65_7619; uvs = _65_7618}))))

let mk_Exp_abs = (fun ( _20_559 ) ( t' ) ( p ) -> (match (_20_559) with
| (b, e) -> begin
(let _65_7630 = (match (b) with
| [] -> begin
...
in (let _65_7629 = (get_typ_ref t')
in (let _65_7628 = (mk_fvs ())
in (let _65_7627 = (mk_uvs ())
in {n = _65_7630; tk = _65_7629; pos = p; fvs = _65_7628; uvs = _65_7627}))))
end))

let mk_Exp_abs' = (fun ( _20_567 ) ( t' ) ( p ) -> (match (_20_567) with
| (b, e) -> begin
(let _65_7640 = (match ((b, e.n)) with
...
in (let _65_7639 = (get_typ_ref t')
in (let _65_7638 = (mk_fvs ())
in (let _65_7637 = (mk_uvs ())
in {n = _65_7640; tk = _65_7639; pos = p; fvs = _65_7638; uvs = _65_7637}))))
end))

let mk_Exp_app = (fun ( _20_587 ) ( t ) ( p ) -> (match (_20_587) with
| (e1, args) -> begin
(let _65_7650 = (match (args) with
| [] -> begin
(failwith ("Empty args!"))
end
| _ -> begin
...
in (let _65_7649 = (get_typ_ref t)
in (let _65_7648 = (mk_fvs ())
in (let _65_7647 = (mk_uvs ())
in {n = _65_7650; tk = _65_7649; pos = p; fvs = _65_7648; uvs = _65_7647}))))
end))
...
in (match ((not ((let _65_7670 = (Support.List.tl vars)
in (let _65_7669 = (let _65_7668 = (let _65_7667 = (Support.List.hd vars)
in (Support.Microsoft.FStar.Util.set_eq order_bvd _65_7667))
in (Support.Microsoft.FStar.Util.for_all _65_7668))
in (Support.Prims.pipe_right _65_7670 _65_7669)))))) with
| true -> begin
(let vars = (let _65_7674 = (Support.Prims.pipe_right vars (Support.List.map (fun ( v ) -> (let _65_7673 = (Support.List.map (fun ( _20_2 ) -> (match (_20_2) with
...
in (Support.Microsoft.FStar.Util.concat_l ", " _65_7673)))))
in (Support.Microsoft.FStar.Util.concat_l ";\n" _65_7674))
in (let _65_7677 = (let _65_7676 = (let _65_7675 = (Support.Microsoft.FStar.Util.format1 "Each branch of this pattern binds different variables: %s" vars)
in (_65_7675, p.p))
in Error (_65_7676))
in (raise (_65_7677))))
end
...
| (e, pats) -> begin
(let _65_7686 = (get_typ_ref t)
in (let _65_7685 = (mk_fvs ())
in (let _65_7684 = (mk_uvs ())
in {n = Exp_match ((e, pats)); tk = _65_7686; pos = p; fvs = _65_7685; uvs = _65_7684})))
end))

let mk_Exp_ascribed = (fun ( _20_675 ) ( t' ) ( p ) -> (match (_20_675) with
| (e, t, l) -> begin
(let _65_7695 = (get_typ_ref t')
in (let _65_7694 = (mk_fvs ())
in (let _65_7693 = (mk_uvs ())
in {n = Exp_ascribed ((e, t, l)); tk = _65_7695; pos = p; fvs = _65_7694; uvs = _65_7693})))
end))

let mk_Exp_let = (fun ( _20_680 ) ( t ) ( p ) -> (match (_20_680) with
| (lbs, e) -> begin
(let _65_7704 = (get_typ_ref t)
in (let _65_7703 = (mk_fvs ())
in (let _65_7702 = (mk_uvs ())
in {n = Exp_let ((lbs, e)); tk = _65_7704; pos = p; fvs = _65_7703; uvs = _65_7702})))
end))

let mk_Exp_uvar' = (fun ( _20_685 ) ( t' ) ( p ) -> (match (_20_685) with
| (u, t) -> begin
(let _65_7713 = (get_typ_ref t')
in (let _65_7712 = (mk_fvs ())
in (let _65_7711 = (mk_uvs ())
in {n = Exp_uvar ((u, t)); tk = _65_7713; pos = p; fvs = _65_7712; uvs = _65_7711})))
end))
...
| (e, s, m) -> begin
(let _65_7726 = (get_typ_ref t)
in (let _65_7725 = (mk_fvs ())
in (let _65_7724 = (mk_uvs ())
in {n = Exp_delayed ((e, s, m)); tk = _65_7726; pos = p; fvs = _65_7725; uvs = _65_7724})))
end))

let mk_Exp_meta' = (fun ( m ) ( t ) ( p ) -> (let _65_7735 = (get_typ_ref t)
in (let _65_7734 = (mk_fvs ())
in (let _65_7733 = (mk_uvs ())
in {n = Exp_meta (m); tk = _65_7735; pos = p; fvs = _65_7734; uvs = _65_7733}))))

let mk_Exp_meta = (fun ( m ) -> (match (m) with
| Meta_desugared ((e, _)) -> begin
(let _65_7738 = (Support.ST.read e.tk)
in (mk_Exp_meta' m _65_7738 e.pos))
end))
...
let null_t_binder = (fun ( t ) -> (let _65_7757 = (let _65_7756 = (null_bvar t)
in Support.Microsoft.FStar.Util.Inl (_65_7756))
in (_65_7757, None)))

let null_v_binder = (fun ( t ) -> (let _65_7761 = (let _65_7760 = (null_bvar t)
in Support.Microsoft.FStar.Util.Inr (_65_7760))
in (_65_7761, None)))
...
(let _20_761 = out
in (let _65_7782 = (Support.Microsoft.FStar.Util.set_add btv out.ftvs)
in {ftvs = _65_7782; fxvs = _20_761.fxvs}))
end
| (Support.Microsoft.FStar.Util.Inr (bxv), _) -> begin
(let _20_768 = out
in (let _65_7783 = (Support.Microsoft.FStar.Util.set_add bxv out.fxvs)
in {ftvs = _20_768.ftvs; fxvs = _65_7783}))
end)) no_fvs)))

let binders_of_list = (fun ( fvs ) -> (Support.Prims.pipe_right fvs (Support.List.map (fun ( t ) -> (t, None)))))

let binders_of_freevars = (fun ( fvs ) -> (let _65_7792 = (let _65_7789 = (Support.Microsoft.FStar.Util.set_elements fvs.ftvs)
in (Support.Prims.pipe_right _65_7789 (Support.List.map t_binder)))
in (let _65_7791 = (let _65_7790 = (Support.Microsoft.FStar.Util.set_elements fvs.fxvs)
in (Support.Prims.pipe_right _65_7790 (Support.List.map v_binder)))
in (Support.List.append _65_7792 _65_7791))))
