        ...
        fun g'  ->
          fun check1  ->
            ...
            (let uu____192 = FStar_Main.process_args ()  in
             FStar_All.pipe_right uu____192 (fun a243  -> ()));
      ...
      (let id2 = FStar_Tests_Pars.tc "fun x -> x"  in
       ...
       (let id3 = FStar_Tests_Pars.tc "fun x -> x"  in
        ...
        (let uu____548 = FStar_Main.process_args ()  in
         FStar_All.pipe_right uu____548 (fun a244  -> ()));
        (let uu____561 =
                    ...
                    (let tm11 =
                     ...
                     (let tm12 =
                      ...
                      (let uu____627 =
                         ...
                         | (u_p,uu____715,uu____716) ->
                             let tm23 =
                               let uu____732 =
                                 let uu____735 =
                                   FStar_Tests_Util.app l1 [u_p]  in
                                 norm uu____735  in
                               FStar_Tests_Util.app uu____732 [unit]  in
                             (tm13, tm23)
                          in
                       ...
                       | (tm13,tm23) ->
                           (unify1 (Prims.parse_int "13") tm13 tm23
                            ...
                            (let uu____751 =
                                 ...
                                 let uu____766 =
                                   let uu____767 =
                                     let uu____770 =
                                       FStar_Syntax_Syntax.bv_to_name q  in
                                     [uu____770]  in
                                   FStar_Tests_Util.app l uu____767  in
                                 norm uu____766  in
                               let l1 =
                                 FStar_Tests_Pars.tc
                               ...
                               let unit = FStar_Tests_Pars.tc "()"  in
                               let env =
                                 let uu____774 = FStar_Tests_Pars.init ()  in
                                 let uu____775 =
                                   let uu____776 =
                                   ...
                                   let uu____783 =
                                     let uu____792 =
                                       FStar_Syntax_Syntax.mk_binder q  in
                                     [uu____792]  in
                                   uu____776 :: uu____783  in
                                 FStar_TypeChecker_Env.push_binders uu____774
                                   uu____775
                                  in
                               let uu____817 =
                                 FStar_TypeChecker_Util.new_implicit_var ""
                                   ...
                                   let tm24 =
                                     let uu____856 =
                                       let uu____859 =
                                         FStar_Tests_Util.app l1 [u_p]  in
                                       norm uu____859  in
                                     FStar_Tests_Util.app uu____856 [unit]
                                      in
                                   (tm14, tm24)
                                in
                             ...
                             | (tm14,tm24) ->
                                 (unify1 (Prims.parse_int "14") tm14 tm24
                                  ...
                                  (let uu____877 = FStar_ST.op_Bang success
                                      in
                                   if uu____877
                                   then
