            ...
            (if Prims.op_Negation b
             then
               (let uu___2 =
                ...
                FStar_Compiler_Effect.pipe_left fail uu___2)
             else ();
          ...
          fun check ->
            ...
            (let g =
               let uu___3 =
                 ...
                 FStar_Compiler_Effect.pipe_right uu___4 uu___5 in
               let uu___4 =
                 let uu___5 = tcenv () in
                 FStar_TypeChecker_Rel.simplify_guard uu___5 in
               FStar_Compiler_Effect.pipe_right uu___3 uu___4 in
        ...
        (fun uu___ ->
           ...
           | () ->
               let g =
                 ...
                 FStar_Compiler_Effect.pipe_right uu___1 uu___2 in
  ...
  fun x ->
    fun y ->
      ...
      let g =
        ...
        FStar_Compiler_Effect.pipe_right uu___ uu___1 in
  ...
  fun uu___ ->
    ...
    (let unify_check n x y g f = unify n x y g f in
     ...
     let x =
       ...
       FStar_Compiler_Effect.pipe_right uu___3 FStar_Syntax_Syntax.bv_to_name in
     let y =
       let uu___3 =
      ...
      (let id1 = FStar_Tests_Pars.tc "fun x -> x" in
       ...
       (let id2 = FStar_Tests_Pars.tc "fun x -> x" in
        ...
        (let uu___13 = FStar_Main.process_args () in
         FStar_Compiler_Effect.pipe_right uu___13 (fun uu___14 -> ()));
        (let uu___13 =
         ...
         | (tm, us) ->
             ...
             (unify_check (Prims.of_int (9)) tm sol
                ...
                (fun uu___15 ->
                   let uu___16 =
                     let uu___17 =
                       let uu___18 = FStar_Compiler_List.hd us in
                       norm uu___18 in
               ...
               | (tm1, us1) ->
                   ...
                   (unify_check (Prims.of_int (10)) tm1 sol1
                      ...
                      (fun uu___17 ->
                         let uu___18 =
                           let uu___19 =
                             let uu___20 = FStar_Compiler_List.hd us1 in
                             norm uu___20 in
                            ...
                            (let uu___21 =
                             ...
                             | (tm14, tm23) ->
                                 (unify1 (Prims.of_int (14)) tm14 tm23
                                  ...
                                  (let uu___25 =
                                     FStar_Compiler_Effect.op_Bang success in
                                   if uu___25
                                   then
                                     FStar_Compiler_Util.print_string
                                       "Unifier ok\n"
                                   else ());
                                  FStar_Compiler_Effect.op_Bang success))))))))))))))