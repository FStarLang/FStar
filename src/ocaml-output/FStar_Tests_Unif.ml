             ...
             FStar_TypeChecker_Common.NonTrivial f') ->
              let f1 =
                ...
                FStar_TypeChecker_Normalize.normalize
                  [FStar_TypeChecker_Env.EraseUniverses] uu____82 f in
              let f'1 =
                let uu____84 = tcenv () in
                FStar_TypeChecker_Normalize.normalize
                  [FStar_TypeChecker_Env.EraseUniverses] uu____84 f' in
        ...
        fun g' ->
          fun check1 ->
            ...
            (let uu____180 = FStar_Main.process_args () in
             FStar_All.pipe_right uu____180 (fun a242 -> ()));
            ...
            (let g =
               let uu____197 =
                 ...
                 let uu____200 =
                   ...
                   FStar_TypeChecker_Rel.solve_deferred_constraints uu____205 in
        ...
        then out
          ...
          (let uu____330 =
             ...
             FStar_TypeChecker_Util.new_implicit_var ""
               FStar_Range.dummyRange uu____343 FStar_Syntax_Util.ktype0 in
           match uu____330 with
           | (t, uu____347, uu____348) ->
               let uu____361 =
                 let uu____374 = FStar_Tests_Pars.init () in
                 FStar_TypeChecker_Util.new_implicit_var ""
                   FStar_Range.dummyRange uu____374 t in
      ...
      (let id2 = FStar_Tests_Pars.tc "fun x -> x" in
       ...
       (let id3 = FStar_Tests_Pars.tc "fun x -> x" in
        ...
        (let uu____536 = FStar_Main.process_args () in
         FStar_All.pipe_right uu____536 (fun a243 -> ()));
        (let uu____549 =
         ...
         | (tm1, us) ->
             ...
             (unify_check (Prims.parse_int "9") tm1 sol
                ...
                (fun uu____569 ->
                   let uu____570 =
                     let uu____571 =
                       let uu____574 = FStar_List.hd us in norm uu____574 in
                     ...
                     (let tm12 =
                      ...
                      (let uu____615 =
                         ...
                         let env =
                           ...
                           let uu____639 =
                             let uu____640 = FStar_Syntax_Syntax.mk_binder x2 in
                             let uu____647 =
                               let uu____656 =
                            ...
                            (let uu____739 =
                                   ...
                                   let tm24 =
                                     let uu____844 =
                                       let uu____847 =
                                         FStar_Tests_Util.app l1 [u_p] in
                                       norm uu____847 in
                                     FStar_Tests_Util.app uu____844 [unit] in
                                   (tm14, tm24) in
                             ...
                             | (tm14, tm24) ->
                                 (unify1 (Prims.parse_int "14") tm14 tm24
                                  ...
                                  (let uu____865 = FStar_ST.op_Bang success in
                                   if uu____865
                                   then
