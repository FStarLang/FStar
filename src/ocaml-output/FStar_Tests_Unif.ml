             ...
             f,FStar_TypeChecker_Common.NonTrivial f') ->
              let f1 =
                ...
                FStar_TypeChecker_Normalize.normalize
                  [FStar_TypeChecker_Env.EraseUniverses] uu___1 f
                 in
              let f'1 =
                let uu___1 = tcenv ()  in
                FStar_TypeChecker_Normalize.normalize
          ...
          fun check  ->
            ...
            (let g =
               let uu___3 =
                 ...
                 let uu___5 =
                   let uu___6 = tcenv ()  in
                   FStar_TypeChecker_Rel.solve_deferred_constraints uu___6
                    in
        ...
        (fun uu___  ->
           ...
           | () ->
               let g =
                 ...
                 let uu___2 =
                   let uu___3 = tcenv ()  in
                   FStar_TypeChecker_Rel.solve_deferred_constraints uu___3
                    in
...
let (unify' : Prims.string -> Prims.string -> unit) =
  fun x  ->
    fun y  ->
      ...
      let g =
        let uu___ =
          let uu___1 = tcenv ()  in FStar_TypeChecker_Rel.teq uu___1 x1 y1
           in
        let uu___1 =
          let uu___2 = tcenv ()  in
        ...
        then out
          ...
          (let uu___1 =
             ...
             FStar_TypeChecker_Util.new_implicit_var ""
               FStar_Range.dummyRange uu___2 FStar_Syntax_Util.ktype0
              in
           match uu___1 with
           | (t,uu___2,uu___3) ->
               let uu___4 =
                 ...
                 FStar_TypeChecker_Util.new_implicit_var ""
                   FStar_Range.dummyRange uu___5 t
                  in
               (match uu___4 with
                | (u,uu___5,uu___6) -> aux (u :: out) (n1 - Prims.int_one)))
         in
      let us = aux [] n  in
     ...
     (let id = FStar_Tests_Pars.tc "fun x -> x"  in
      ...
      (let id1 = FStar_Tests_Pars.tc "fun x -> x"  in
       ...
       (let id2 = FStar_Tests_Pars.tc "fun x -> x"  in
        ...
        (let uu___12 = FStar_Tests_Pars.tc "fun (x:int) (y:int) (z:int) -> y"
            in
         let uu___13 = FStar_Tests_Pars.tc "fun (x:int) (y:int) (z:int) -> z"
            in
         let uu___14 =
           let uu___15 =
             FStar_Tests_Pars.tc
               ...
               | (tm1,us1) ->
                   ...
                   (unify_check (Prims.of_int (10)) tm1 sol1
                      ...
                      (fun uu___17  ->
                         let uu___18 =
                           let uu___19 =
                             let uu___20 = FStar_List.hd us1  in norm uu___20
                              in
                     ...
                     (let tm12 =
                      ...
                      (let uu___19 =
                         ...
                         let tm13 =
                           let uu___20 =
                             let uu___21 =
                               let uu___22 = FStar_Syntax_Syntax.bv_to_name q
                                  in
                               [uu___22]  in
                         ...
                         let env =
                           ...
                           let uu___21 =
                             let uu___22 = FStar_Syntax_Syntax.mk_binder x1
                                in
                             let uu___23 =
                               let uu___24 = FStar_Syntax_Syntax.mk_binder q
                                  in
                               [uu___24]  in
                             uu___22 :: uu___23  in
                           FStar_TypeChecker_Env.push_binders uu___20 uu___21
                            in
                         let uu___20 =
                           FStar_TypeChecker_Util.new_implicit_var ""
                         ...
                         | (u_p,uu___21,uu___22) ->
                             let tm22 =
                               let uu___23 =
                                 let uu___24 = FStar_Tests_Util.app l1 [u_p]
                                    in
                                 norm uu___24  in
