             ...
             FStar_TypeChecker_Common.NonTrivial f') ->
              let f1 =
                ...
                FStar_TypeChecker_Normalize.normalize
                  [FStar_TypeChecker_Env.EraseUniverses] uu____91 f in
              let f'1 =
                let uu____93 = tcenv () in
                FStar_TypeChecker_Normalize.normalize
                  [FStar_TypeChecker_Env.EraseUniverses] uu____93 f' in
            ...
            (if Prims.op_Negation b
             then
               (let uu____111 =
                  ...
                  FStar_Util.format3
                    "Test %s failed:\n\tExpected guard %s;\n\tGot guard      %s\n"
                    uu____113 uu____115 uu____117 in
            ...
            (let g =
               let uu____235 =
                 ...
                 let uu____238 =
                   ...
                   FStar_TypeChecker_Rel.solve_deferred_constraints uu____243 in
           ...
           | () ->
               let g =
                 ...
                 let uu____278 =
                   ...
                   FStar_TypeChecker_Rel.solve_deferred_constraints uu____283 in
                 FStar_All.pipe_right uu____276 uu____278 in
               (match g.FStar_TypeChecker_Common.guard_f with
                | FStar_TypeChecker_Common.Trivial ->
                    let uu____284 =
                      let uu____286 = FStar_Syntax_Print.term_to_string x1 in
                      let uu____288 = FStar_Syntax_Print.term_to_string y1 in
                      FStar_Util.format2
        ...
        then out
          ...
          (let uu____399 =
             ...
             FStar_TypeChecker_Util.new_implicit_var ""
               FStar_Range.dummyRange uu____412 FStar_Syntax_Util.ktype0 in
           match uu____399 with
           | (t, uu____417, uu____418) ->
               let uu____431 =
                 let uu____444 = FStar_Tests_Pars.init () in
                 FStar_TypeChecker_Util.new_implicit_var ""
                   FStar_Range.dummyRange uu____444 t in
               (match uu____431 with
                | (u, uu____449, uu____450) ->
                    aux (u :: out) (n2 - Prims.int_one))) in
      let us = aux [] n1 in
      let uu____467 =
      ...
      (let id2 = FStar_Tests_Pars.tc "fun x -> x" in
       ...
       (let id3 = FStar_Tests_Pars.tc "fun x -> x" in
        ...
        (let uu____615 = FStar_Tests_Pars.tc "fun (x:int) (y:int) -> y" in
         ...
         unify1 (Prims.of_int (7)) uu____615 uu____619 uu____623);
        (let uu____628 =
         ...
         unify1 (Prims.of_int (8)) uu____628 uu____632 uu____636);
        ...
        (let uu____656 =
           ...
           inst Prims.int_one uu____663 in
         ...
         | (tm1, us) ->
             ...
             (unify_check (Prims.of_int (9)) tm1 sol
                ...
                (fun uu____681 ->
                   let uu____682 =
                     let uu____684 =
                       let uu____687 = FStar_List.hd us in norm uu____687 in
                     let uu____688 = norm sol in
                     FStar_Tests_Util.term_eq uu____684 uu____688 in
                   FStar_Tests_Util.always (Prims.of_int (9)) uu____682);
              (let uu____692 =
                 let uu____699 = FStar_Tests_Pars.tc "fun u x -> u x" in
                 inst Prims.int_one uu____699 in
                   ...
                   (unify_check (Prims.of_int (10)) tm2 sol1
                    ...
                    (let tm11 =
                     ...
                     (let uu____733 =
                      ...
                      unify1 (Prims.of_int (11)) tm11 tm21 uu____733);
                     (let tm12 =
                        FStar_Tests_Pars.tc
                      ...
                      (let uu____743 =
                         ...
                         let env =
                           ...
                           let uu____772 =
                             let uu____773 = FStar_Syntax_Syntax.mk_binder x2 in
                             let uu____780 =
                               let uu____789 =
                            ...
                            (let uu____875 =
                                   ...
                                   let tm24 =
                                     let uu____986 =
                                       let uu____989 =
                                         FStar_Tests_Util.app l1 [u_p] in
                                       norm uu____989 in
                                     FStar_Tests_Util.app uu____986 [unit] in
                                   (tm14, tm24) in
                             ...
                             | (tm14, tm24) ->
                                 (unify1 (Prims.of_int (14)) tm14 tm24
                                  ...
                                  (let uu____1009 = FStar_ST.op_Bang success in
                                   if uu____1009
                                   then
