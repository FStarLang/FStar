        ...
        fun g'  ->
          fun check1  ->
            ...
            (let uu____94 = FStar_Main.process_args ()  in
             FStar_All.pipe_right uu____94 (fun a245  -> ()));
...
let (should_fail :
  FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.term -> unit) =
  fun x1  ->
    fun y1  ->
      try
        let g =
    ...
    fun tm1  ->
      let rec aux out n2 =
        ...
        then out
          ...
          (let uu____229 =
             let uu____242 = FStar_Tests_Pars.init ()  in
             FStar_TypeChecker_Util.new_implicit_var ""
               FStar_Range.dummyRange uu____242 FStar_Syntax_Util.ktype0
              in
           match uu____229 with
           | (t,uu____246,uu____247) ->
               let uu____260 =
                 let uu____273 = FStar_Tests_Pars.init ()  in
                 FStar_TypeChecker_Util.new_implicit_var ""
                   FStar_Range.dummyRange uu____273 t
                  in
               (match uu____260 with
                | (u,uu____277,uu____278) ->
                    aux (u :: out) (n2 - (Prims.parse_int "1"))))
         in
      let us = aux [] n1  in
      let uu____294 =
        let uu____295 = FStar_Tests_Util.app tm1 us  in norm uu____295  in
      (uu____294, us)
...
let (run_all : unit -> unit) =
  fun uu____302  ->
    ...
    (let unify_check n1 x1 y1 g f = unify n1 x1 y1 g f  in
     let unify1 n1 x1 y1 g = unify n1 x1 y1 g (fun uu____358  -> ())  in
     let int_t = FStar_Tests_Pars.tc "Prims.int"  in
     let x1 =
       let uu____361 =
         FStar_Syntax_Syntax.gen_bv "x" FStar_Pervasives_Native.None int_t
          in
       FStar_All.pipe_right uu____361 FStar_Syntax_Syntax.bv_to_name  in
     let y1 =
       let uu____363 =
         FStar_Syntax_Syntax.gen_bv "y" FStar_Pervasives_Native.None int_t
          in
       FStar_All.pipe_right uu____363 FStar_Syntax_Syntax.bv_to_name  in
     ...
     (let uu____366 =
        let uu____367 =
          FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero
           ...
           in
        FStar_TypeChecker_Common.NonTrivial uu____367  in
      unify1 (Prims.parse_int "1") x1 y1 uu____366);
     (let id1 = FStar_Tests_Pars.tc "fun x -> x"  in
      (let uu____370 = FStar_Tests_Util.app id1 [x1]  in
       unify1 (Prims.parse_int "2") x1 uu____370
         FStar_TypeChecker_Common.Trivial);
      (let id2 = FStar_Tests_Pars.tc "fun x -> x"  in
       ...
       (let id3 = FStar_Tests_Pars.tc "fun x -> x"  in
        ...
        (let uu____377 = FStar_Tests_Pars.tc "fun x y -> x"  in
         let uu____378 = FStar_Tests_Pars.tc "fun a b -> a"  in
         unify1 (Prims.parse_int "5") uu____377 uu____378
           FStar_TypeChecker_Common.Trivial);
        (let uu____380 = FStar_Tests_Pars.tc "fun x y z -> y"  in
         let uu____381 = FStar_Tests_Pars.tc "fun a b c -> b"  in
         unify1 (Prims.parse_int "6") uu____380 uu____381
           FStar_TypeChecker_Common.Trivial);
        (let uu____383 = FStar_Tests_Pars.tc "fun (x:int) (y:int) -> y"  in
         let uu____384 = FStar_Tests_Pars.tc "fun (x:int) (y:int) -> x"  in
         let uu____385 =
           let uu____386 =
             FStar_Tests_Pars.tc "(forall (x:int). (forall (y:int). y==x))"
              in
           FStar_TypeChecker_Common.NonTrivial uu____386  in
         unify1 (Prims.parse_int "7") uu____383 uu____384 uu____385);
        (let uu____388 =
         ...
         unify1 (Prims.parse_int "8") uu____388 uu____389 uu____390);
        (let uu____393 = FStar_Main.process_args ()  in
         FStar_All.pipe_right uu____393 (fun a246  -> ()));
        (let uu____406 =
           let uu____413 = FStar_Tests_Pars.tc "fun u x -> u x"  in
           inst (Prims.parse_int "1") uu____413  in
         ...
         | (tm1,us) ->
             ...
             (unify_check (Prims.parse_int "9") tm1 sol
                ...
                (fun uu____426  ->
                   let uu____427 =
                     let uu____428 =
                       let uu____431 = FStar_List.hd us  in norm uu____431
                        in
                     let uu____432 = norm sol  in
                     FStar_Tests_Util.term_eq uu____428 uu____432  in
                   FStar_Tests_Util.always (Prims.parse_int "9") uu____427);
              (let uu____433 =
                 let uu____440 = FStar_Tests_Pars.tc "fun u x -> u x"  in
                 inst (Prims.parse_int "1") uu____440  in
               ...
               | (tm2,us1) ->
                   ...
                   (unify_check (Prims.parse_int "10") tm2 sol1
                      ...
                      (fun uu____453  ->
                         let uu____454 =
                           let uu____455 =
                             let uu____458 = FStar_List.hd us1  in
                             norm uu____458  in
                           let uu____459 = norm sol1  in
                           FStar_Tests_Util.term_eq uu____455 uu____459  in
                     ...
                     (let uu____463 =
                        let uu____464 =
                          FStar_Tests_Pars.tc
                           ...
                           in
                        FStar_TypeChecker_Common.NonTrivial uu____464  in
                      unify1 (Prims.parse_int "11") tm11 tm21 uu____463);
                     (let tm12 =
                        FStar_Tests_Pars.tc
                      ...
                      (let uu____468 =
                         ...
                         let tm13 =
                           let uu____481 =
                             let uu____482 =
                               ...
                               [uu____485]  in
                             FStar_Tests_Util.app l uu____482  in
                           norm uu____481  in
                         let l1 =
                         ...
                         let env =
                           let uu____489 = FStar_Tests_Pars.init ()  in
                           let uu____490 =
                             ...
                             let uu____496 =
                               ...
                               [uu____503]  in
                             uu____491 :: uu____496  in
                           FStar_TypeChecker_Env.push_binders uu____489
                             uu____490
                            in
                         let uu____520 =
                           FStar_TypeChecker_Util.new_implicit_var ""
                         ...
                         | (u_p,uu____540,uu____541) ->
                             let tm23 =
                               let uu____557 =
                                 let uu____560 =
                                   FStar_Tests_Util.app l1 [u_p]  in
                                 norm uu____560  in
                               FStar_Tests_Util.app uu____557 [unit]  in
                             (tm13, tm23)
                          in
                       ...
                       | (tm13,tm23) ->
                           ((let uu____570 =
                               ...
                               FStar_TypeChecker_Common.NonTrivial uu____571
                                in
                            ...
                            (let uu____572 =
                                 ...
                                 let uu____585 =
                                   let uu____586 =
                                     let uu____589 =
                                       FStar_Syntax_Syntax.bv_to_name q  in
                                     [uu____589]  in
                                   FStar_Tests_Util.app l uu____586  in
                                 norm uu____585  in
                               let l1 =
                                 FStar_Tests_Pars.tc
                               ...
                               let unit = FStar_Tests_Pars.tc "()"  in
                               let env =
                                 let uu____593 = FStar_Tests_Pars.init ()  in
                                 let uu____594 =
                                   let uu____595 =
                                   ...
                                   let uu____600 =
                                     let uu____607 =
                                       FStar_Syntax_Syntax.mk_binder q  in
                                     [uu____607]  in
                                   uu____595 :: uu____600  in
                                 FStar_TypeChecker_Env.push_binders uu____593
                                   uu____594
                                  in
                               let uu____624 =
                                 FStar_TypeChecker_Util.new_implicit_var ""
                               ...
                               | (u_p,uu____644,uu____645) ->
                                   let tm24 =
                                     let uu____661 =
                                       let uu____664 =
                                         FStar_Tests_Util.app l1 [u_p]  in
                                       norm uu____664  in
                                     FStar_Tests_Util.app uu____661 [unit]
                                      in
                                   (tm14, tm24)
                                in
