...
type kind_abbrev =
(Microsoft_FStar_Absyn_Syntax.lident * (Microsoft_FStar_Absyn_Syntax.btvdef, Microsoft_FStar_Absyn_Syntax.bvvdef) Microsoft_FStar_Util.either Prims.list * Microsoft_FStar_Absyn_Syntax.knd)

type env =
{curmodule : Microsoft_FStar_Absyn_Syntax.lident Prims.option; modules : (Microsoft_FStar_Absyn_Syntax.lident * Microsoft_FStar_Absyn_Syntax.modul) Prims.list; open_namespaces : Microsoft_FStar_Absyn_Syntax.lident Prims.list; sigaccum : Microsoft_FStar_Absyn_Syntax.sigelts; localbindings : ((Microsoft_FStar_Absyn_Syntax.btvdef, Microsoft_FStar_Absyn_Syntax.bvvdef) Microsoft_FStar_Util.either * binding) Prims.list; recbindings : binding Prims.list; phase : Microsoft_FStar_Parser_AST.level; sigmap : (Microsoft_FStar_Absyn_Syntax.sigelt * Prims.bool) Microsoft_FStar_Util.smap Prims.list; default_result_effect : Microsoft_FStar_Absyn_Syntax.typ  ->  Microsoft_FStar_Range.range  ->  Microsoft_FStar_Absyn_Syntax.comp; iface : Prims.bool; admitted_iface : Prims.bool}

let is_Mkenv = (fun _ -> (All.failwith "Not yet implemented:is_Mkenv"))

let open_modules = (fun e -> e.modules)

let current_module = (fun env -> (match (env.curmodule) with
| None -> begin
(All.failwith "Unset current module")
end
| Some (m) -> begin
m
end))

let qual = (fun lid id -> (let _107_111 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append lid.Microsoft_FStar_Absyn_Syntax.ns ((lid.Microsoft_FStar_Absyn_Syntax.ident)::(id)::[])))
in (Microsoft_FStar_Absyn_Util.set_lid_range _107_111 id.Microsoft_FStar_Absyn_Syntax.idRange)))

let qualify = (fun env id -> (let _107_116 = (current_module env)
in (qual _107_116 id)))

let qualify_lid = (fun env lid -> (let cur = (current_module env)
in (let _107_122 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append (Microsoft_FStar_List.append (Microsoft_FStar_List.append cur.Microsoft_FStar_Absyn_Syntax.ns ((cur.Microsoft_FStar_Absyn_Syntax.ident)::[])) lid.Microsoft_FStar_Absyn_Syntax.ns) ((lid.Microsoft_FStar_Absyn_Syntax.ident)::[])))
in (let _107_121 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range _107_122 _107_121)))))

let new_sigmap = (fun _41_52 -> (match (()) with
| () -> begin
(Microsoft_FStar_Util.smap_create 100)
end))
...
in (_107_126)::[])
in {curmodule = None; modules = []; open_namespaces = []; sigaccum = []; localbindings = []; recbindings = []; phase = Microsoft_FStar_Parser_AST.Un; sigmap = _107_127; default_result_effect = Microsoft_FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))

let sigmap = (fun env -> (Microsoft_FStar_List.hd env.sigmap))
...
let try_lookup_typ_var = (fun env id -> (let fopt = (Microsoft_FStar_List.tryFind (fun _41_76 -> (match (_41_76) with
| (_41_74, b) -> begin
(match (b) with
| (Binding_typ_var (id')) | (Binding_var (id')) -> begin
...
in (match (fopt) with
| Some (Microsoft_FStar_Util.Inl (bvd), Binding_typ_var (_41_86)) -> begin
(let _107_144 = (let _107_143 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_typ _107_143 Microsoft_FStar_Absyn_Syntax.kun))
in Some (_107_144))
end
| _41_91 -> begin
None
...
in (Microsoft_FStar_Util.find_map namespaces (fun ns -> (let full_name = (let _107_159 = (let _107_158 = (Microsoft_FStar_Absyn_Syntax.ids_of_lid ns)
in (Microsoft_FStar_List.append _107_158 ids))
in (Microsoft_FStar_Absyn_Syntax.lid_of_ids _107_159))
in (finder full_name)))))
end))
...
let unmangleOpName = (fun id -> (Microsoft_FStar_Util.find_map unmangleMap (fun _41_108 -> (match (_41_108) with
| (x, y) -> begin
(match ((id.Microsoft_FStar_Absyn_Syntax.idText = x)) with
| true -> begin
(let _107_165 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("Prims")::(y)::[]) id.Microsoft_FStar_Absyn_Syntax.idRange)
in Some (_107_165))
end
| false -> begin
None
...
| Some (l) -> begin
(let _107_173 = (let _107_172 = (let _107_171 = (let _107_170 = (Microsoft_FStar_Absyn_Util.fv l)
in (_107_170, None))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _107_171 None id.Microsoft_FStar_Absyn_Syntax.idRange))
in (l, _107_172))
in Some (_107_173))
end
| _41_114 -> begin
(let found = (Microsoft_FStar_Util.find_map env.localbindings (fun _41_2 -> (match (_41_2) with
| (Microsoft_FStar_Util.Inl (_41_117), Binding_typ_var (id')) when (id'.Microsoft_FStar_Absyn_Syntax.idText = id.Microsoft_FStar_Absyn_Syntax.idText) -> begin
Some (Microsoft_FStar_Util.Inl (()))
end
| (Microsoft_FStar_Util.Inr (bvd), Binding_var (id')) when (id'.Microsoft_FStar_Absyn_Syntax.idText = id.Microsoft_FStar_Absyn_Syntax.idText) -> begin
(let _107_179 = (let _107_178 = (let _107_177 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id')::[]))
in (let _107_176 = (let _107_175 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_exp _107_175 Microsoft_FStar_Absyn_Syntax.tun))
in (_107_177, _107_176)))
in Microsoft_FStar_Util.Inr (_107_178))
in Some (_107_179))
end
| _41_128 -> begin
None
...
in (match (found) with
| Some (Microsoft_FStar_Util.Inr (x)) -> begin
Some (x)
end
| _41_134 -> begin
None
...
(let qopt = (Microsoft_FStar_Util.find_map quals (fun _41_4 -> (match (_41_4) with
...
in (Microsoft_FStar_Util.smap_try_find _107_297 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
(let _107_300 = (let _107_299 = (let _107_298 = (Microsoft_FStar_Absyn_Util.ftv lid Microsoft_FStar_Absyn_Syntax.kun)
in (OSig (se), _107_298))
...
(let _107_304 = (let _107_303 = (let _107_302 = (let _107_301 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range ne.Microsoft_FStar_Absyn_Syntax.mname _107_301))
in (OSig (se), _107_302))
...
in (let _107_305 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _107_306 lid _107_305)))
in (OSig (se), _107_307))
in Exp_name (_107_308))
in Some (_107_309))
end
| Microsoft_FStar_Absyn_Syntax.Sig_let (_41_245) -> begin
(let _107_313 = (let _107_312 = (let _107_311 = (let _107_310 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _107_310))
in (OSig (se), _107_311))
in Exp_name (_107_312))
in Some (_107_313))
end
| Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_41_248, _41_250, quals, _41_253) -> begin
(match ((any_val || (All.pipe_right quals (Microsoft_FStar_Util.for_some (fun _41_6 -> (match (_41_6) with
...
in (let _107_315 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _107_316 lid _107_315)))
in (OSig (se), _107_317))
...
in (Microsoft_FStar_Util.find_map env.recbindings (fun _41_7 -> (match (_41_7) with
| Binding_let (l) when (Microsoft_FStar_Absyn_Syntax.lid_equals l recname) -> begin
(let _107_324 = (let _107_323 = (let _107_322 = (let _107_321 = (Microsoft_FStar_Absyn_Syntax.range_of_lid recname)
in (Microsoft_FStar_Absyn_Util.fvar None recname _107_321))
in (ORec (l), _107_322))
in Exp_name (_107_323))
in Some (_107_324))
end
| Binding_tycon (l) when (Microsoft_FStar_Absyn_Syntax.lid_equals l recname) -> begin
(let _107_327 = (let _107_326 = (let _107_325 = (Microsoft_FStar_Absyn_Util.ftv recname Microsoft_FStar_Absyn_Syntax.kun)
in (ORec (l), _107_325))
...
(let _107_334 = (Microsoft_FStar_Absyn_Util.ftv l Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_107_334))
end
| _41_300 -> begin
None
...
in (Microsoft_FStar_Util.smap_try_find _107_363 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some (Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, def, _41_350, _41_352), _41_356) -> begin
(let t = (let _107_366 = (let _107_365 = (let _107_364 = (Microsoft_FStar_Absyn_Util.close_with_lam tps def)
in (_107_364, lid))
in Microsoft_FStar_Absyn_Syntax.Meta_named (_107_365))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _107_366))
in Some (t))
end
| _41_361 -> begin
None
...
in (Microsoft_FStar_Util.smap_try_find _107_373 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
let try_lookup_module = (fun env path -> (match ((Microsoft_FStar_List.tryFind (fun _41_388 -> (match (_41_388) with
| (mlid, modul) -> begin
...
in (Microsoft_FStar_Util.smap_try_find _107_385 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some (Microsoft_FStar_Absyn_Syntax.Sig_let (_41_400), _41_403) -> begin
(let _107_387 = (let _107_386 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _107_386))
in Some (_107_387))
end
| _41_407 -> begin
None
...
in (Microsoft_FStar_Util.smap_try_find _107_406 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some (Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_41_427, _41_429, quals, _41_432), _41_436) -> begin
(match ((All.pipe_right quals (Microsoft_FStar_Util.for_some (fun _41_8 -> (match (_41_8) with
| Microsoft_FStar_Absyn_Syntax.Assumption -> begin
true
end
| _41_442 -> begin
...
| true -> begin
(let _107_408 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_107_408))
end
| false -> begin
None
...
(let _107_409 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_107_409))
end
| _41_451 -> begin
None
...
in (Microsoft_FStar_Util.smap_try_find _107_416 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
type record =
{typename : Microsoft_FStar_Absyn_Syntax.lident; constrname : Microsoft_FStar_Absyn_Syntax.lident; parms : Microsoft_FStar_Absyn_Syntax.binders; fields : (Microsoft_FStar_Absyn_Syntax.fieldname * Microsoft_FStar_Absyn_Syntax.typ) Prims.list}

let is_Mkrecord = (fun _ -> (All.failwith "Not yet implemented:is_Mkrecord"))

let record_cache = (Microsoft_FStar_Util.mk_ref [])
...
(let is_rec = (Microsoft_FStar_Util.for_some (fun _41_9 -> (match (_41_9) with
...
in (let find_dc = (fun dc -> (All.pipe_right sigs (Microsoft_FStar_Util.find_opt (fun _41_10 -> (match (_41_10) with
...
in (All.pipe_right sigs (Microsoft_FStar_List.iter (fun _41_11 -> (match (_41_11) with
...
in (All.pipe_left Microsoft_FStar_Util.must _107_440))) with
...
in (let fields = (All.pipe_right formals (Microsoft_FStar_List.collect (fun b -> (match (b) with
| (Microsoft_FStar_Util.Inr (x), q) -> begin
(match (((Microsoft_FStar_Absyn_Syntax.is_null_binder b) || (q = Some (Microsoft_FStar_Absyn_Syntax.Implicit)))) with
| true -> begin
[]
end
| false -> begin
(let _107_444 = (let _107_443 = (let _107_442 = (Microsoft_FStar_Absyn_Util.unmangle_field_name x.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.ppname)
in (qual constrname _107_442))
in (_107_443, x.Microsoft_FStar_Absyn_Syntax.sort))
in (_107_444)::[])
end)
end
| _41_561 -> begin
...
in (let _107_446 = (let _107_445 = (ST.read record_cache)
in (record)::_107_445)
in (ST.op_Colon_Equals record_cache _107_446)))))
end
| _41_565 -> begin
()
end)
...
| (ns, fieldname) -> begin
(let _107_462 = (ST.read record_cache)
in (Microsoft_FStar_Util.find_map _107_462 (fun record -> (let constrname = record.constrname.Microsoft_FStar_Absyn_Syntax.ident
in (let ns = (maybe_add_constrname ns constrname)
in (let fname = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append ns ((fieldname)::[])))
in (Microsoft_FStar_Util.find_map record.fields (fun _41_595 -> (match (_41_595) with
| (f, _41_594) -> begin
...
in (let fname = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append (Microsoft_FStar_List.append ns ((constrname)::[])) ((fieldname)::[])))
in (Microsoft_FStar_Util.find_map recd.fields (fun _41_609 -> (match (_41_609) with
| (f, _41_608) -> begin
(match ((Microsoft_FStar_Absyn_Syntax.lid_equals fname f)) with
| true -> begin
Some (fname)
...
(let _107_503 = (let _107_502 = (let _107_501 = (Microsoft_FStar_Absyn_Util.genident (Some (id.Microsoft_FStar_Absyn_Syntax.idRange)))
in (id, _107_501))
in (Microsoft_FStar_Absyn_Util.mkbvd _107_502))
in Microsoft_FStar_Util.Inl (_107_503))
end
| Binding_var (id) -> begin
(let _107_506 = (let _107_505 = (let _107_504 = (Microsoft_FStar_Absyn_Util.genident (Some (id.Microsoft_FStar_Absyn_Syntax.idRange)))
in (id, _107_504))
in (Microsoft_FStar_Absyn_Util.mkbvd _107_505))
in Microsoft_FStar_Util.Inr (_107_506))
end
| _41_656 -> begin
(All.failwith "Tried to generate a bound variable for a type constructor")
end))

let push_bvvdef = (fun env x -> (let b = Binding_var (x.Microsoft_FStar_Absyn_Syntax.ppname)
in (let _41_660 = env
in {curmodule = _41_660.curmodule; modules = _41_660.modules; open_namespaces = _41_660.open_namespaces; sigaccum = _41_660.sigaccum; localbindings = ((Microsoft_FStar_Util.Inr (x), b))::env.localbindings; recbindings = _41_660.recbindings; phase = _41_660.phase; sigmap = _41_660.sigmap; default_result_effect = _41_660.default_result_effect; iface = _41_660.iface; admitted_iface = _41_660.admitted_iface})))

let push_btvdef = (fun env x -> (let b = Binding_typ_var (x.Microsoft_FStar_Absyn_Syntax.ppname)
in (let _41_665 = env
in {curmodule = _41_665.curmodule; modules = _41_665.modules; open_namespaces = _41_665.open_namespaces; sigaccum = _41_665.sigaccum; localbindings = ((Microsoft_FStar_Util.Inl (x), b))::env.localbindings; recbindings = _41_665.recbindings; phase = _41_665.phase; sigmap = _41_665.sigmap; default_result_effect = _41_665.default_result_effect; iface = _41_665.iface; admitted_iface = _41_665.admitted_iface})))
...
| (env, Microsoft_FStar_Util.Inl (x)) -> begin
(env, x)
end
| _41_679 -> begin
...
| (env, Microsoft_FStar_Util.Inr (x)) -> begin
(env, x)
end
| _41_687 -> begin
(All.failwith "impossible")
...
| false -> begin
(let _107_533 = (let _107_532 = (let _107_531 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in ((Prims.strcat "Duplicate top-level names " lid.Microsoft_FStar_Absyn_Syntax.str), _107_531))
in Microsoft_FStar_Absyn_Syntax.Error (_107_532))
in (Prims.raise _107_533))
end)
end
| _41_696 -> begin
(All.failwith "Unexpected rec_binding")
end))

let push_sigelt = (fun env s -> (let err = (fun l -> (let sopt = (let _107_540 = (sigmap env)
in (Microsoft_FStar_Util.smap_try_find _107_540 l.Microsoft_FStar_Absyn_Syntax.str))
in (let r = (match (sopt) with
| Some (se, _41_704) -> begin
(match ((let _107_541 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (Microsoft_FStar_Util.find_opt (Microsoft_FStar_Absyn_Syntax.lid_equals l) _107_541))) with
| Some (l) -> begin
(let _107_542 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (All.pipe_left Microsoft_FStar_Range.string_of_range _107_542))
end
| None -> begin
"<unknown>"
end)
...
in (let _107_547 = (let _107_546 = (let _107_545 = (let _107_543 = (Microsoft_FStar_Absyn_Syntax.text_of_lid l)
in (Microsoft_FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" _107_543 r))
in (let _107_544 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (_107_545, _107_544)))
in Microsoft_FStar_Absyn_Syntax.Error (_107_546))
...
in (match ((Microsoft_FStar_Util.find_map lids (fun l -> (match ((not ((unique any_val exclude_if env l)))) with
| true -> begin
Some (l)
end
| false -> begin
...
(let _107_551 = (Microsoft_FStar_List.map (fun se -> (let _107_550 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (_107_550, se))) ses)
in (env, _107_551))
end
| _41_744 -> begin
(let _107_554 = (let _107_553 = (let _107_552 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt s)
in (_107_552, s))
in (_107_553)::[])
in (env, _107_554))
end)
...
| (env, lss) -> begin
(let _41_752 = (All.pipe_right lss (Microsoft_FStar_List.iter (fun _41_750 -> (match (_41_750) with
| (lids, se) -> begin
(All.pipe_right lids (Microsoft_FStar_List.iter (fun lid -> (let _107_557 = (sigmap env)
in (Microsoft_FStar_Util.smap_add _107_557 lid.Microsoft_FStar_Absyn_Syntax.str (se, (env.iface && (not (env.admitted_iface)))))))))
end))))
in env)
end)))))
...
let check_admits = (fun nm env -> (let warn = (not ((let _107_573 = (ST.read Microsoft_FStar_Options.admit_fsi)
in (All.pipe_right _107_573 (Microsoft_FStar_Util.for_some (fun l -> (nm.Microsoft_FStar_Absyn_Syntax.str = l)))))))
in (All.pipe_right env.sigaccum (Microsoft_FStar_List.iter (fun se -> (match (se) with
| Microsoft_FStar_Absyn_Syntax.Sig_val_decl (l, t, quals, r) -> begin
(match ((try_lookup_lid env l)) with
| None -> begin
(let _41_784 = (match (warn) with
| true -> begin
(let _107_578 = (let _107_577 = (let _107_575 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Microsoft_FStar_Range.string_of_range _107_575))
in (let _107_576 = (Microsoft_FStar_Absyn_Print.sli l)
in (Microsoft_FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _107_577 _107_576)))
in (Microsoft_FStar_Util.print_string _107_578))
end
| false -> begin
()
end)
in (let _107_579 = (sigmap env)
in (Microsoft_FStar_Util.smap_add _107_579 l.Microsoft_FStar_Absyn_Syntax.str (Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((l, t, (Microsoft_FStar_Absyn_Syntax.Assumption)::quals, r)), false))))
end
| Some (_41_787) -> begin
()
end)
...
let finish = (fun env modul -> (let _41_828 = (All.pipe_right modul.Microsoft_FStar_Absyn_Syntax.declarations (Microsoft_FStar_List.iter (fun _41_15 -> (match (_41_15) with
| Microsoft_FStar_Absyn_Syntax.Sig_bundle (ses, quals, _41_797, _41_799) -> begin
(match ((Microsoft_FStar_List.contains Microsoft_FStar_Absyn_Syntax.Private quals)) with
| true -> begin
(All.pipe_right ses (Microsoft_FStar_List.iter (fun _41_14 -> (match (_41_14) with
| Microsoft_FStar_Absyn_Syntax.Sig_datacon (lid, _41_805, _41_807, _41_809, _41_811, _41_813) -> begin
(let _107_586 = (sigmap env)
in (Microsoft_FStar_Util.smap_remove _107_586 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| _41_817 -> begin
()
end))))
...
in (Microsoft_FStar_Util.smap_remove _107_587 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.smap_copy _107_590))
...
in (let _107_597 = (Microsoft_FStar_List.tl env.sigmap)
...
| _41_858 -> begin
(All.failwith "No more modules to pop")
end))
...
in (match ((All.pipe_right env.modules (Microsoft_FStar_Util.find_opt (fun _41_875 -> (match (_41_875) with
| (l, _41_874) -> begin
...
| true -> begin
(let _107_620 = (let _107_619 = (let _107_618 = (Microsoft_FStar_Util.format1 "Duplicate module or interface name: %s" mname.Microsoft_FStar_Absyn_Syntax.str)
in (let _107_617 = (Microsoft_FStar_Absyn_Syntax.range_of_lid mname)
in (_107_618, _107_617)))
in Microsoft_FStar_Absyn_Syntax.Error (_107_619))
...
in (let mscope = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append curmod.Microsoft_FStar_Absyn_Syntax.ns ((curmod.Microsoft_FStar_Absyn_Syntax.ident)::(mname)::[])))
in (let _41_888 = env
...
| Some (r) -> begin
(let _107_636 = (Microsoft_FStar_Range.string_of_range r)
in (Microsoft_FStar_Util.format1 "(Possible clash with related name at %s)" _107_636))
end)
in (let _107_641 = (let _107_640 = (let _107_639 = (let _107_637 = (Microsoft_FStar_Absyn_Syntax.text_of_lid lid)
in (Microsoft_FStar_Util.format2 "Identifier not found: [%s] %s" _107_637 msg))
in (let _107_638 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (_107_639, _107_638)))
in Microsoft_FStar_Absyn_Syntax.Error (_107_640))
...
| None -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (((Prims.strcat (Prims.strcat "Identifier not found [" id.Microsoft_FStar_Absyn_Syntax.idText) "]"), id.Microsoft_FStar_Absyn_Syntax.idRange))))
end
| Some (r) -> begin
r
end))
