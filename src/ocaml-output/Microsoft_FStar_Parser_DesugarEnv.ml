...
let qual = (fun ( lid ) ( id ) -> (let _68_18166 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Support.List.append lid.Microsoft_FStar_Absyn_Syntax.ns ((lid.Microsoft_FStar_Absyn_Syntax.ident)::(id)::[])))
in (Microsoft_FStar_Absyn_Util.set_lid_range _68_18166 id.Microsoft_FStar_Absyn_Syntax.idRange)))

let qualify = (fun ( env ) ( id ) -> (let _68_18171 = (current_module env)
in (qual _68_18171 id)))

let qualify_lid = (fun ( env ) ( lid ) -> (let cur = (current_module env)
in (let _68_18177 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Support.List.append (Support.List.append (Support.List.append cur.Microsoft_FStar_Absyn_Syntax.ns ((cur.Microsoft_FStar_Absyn_Syntax.ident)::[])) lid.Microsoft_FStar_Absyn_Syntax.ns) ((lid.Microsoft_FStar_Absyn_Syntax.ident)::[])))
in (let _68_18176 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range _68_18177 _68_18176)))))
...
| () -> begin
(let _68_18182 = (let _68_18181 = (new_sigmap ())
in (_68_18181)::[])
in {curmodule = None; modules = []; open_namespaces = []; sigaccum = []; localbindings = []; recbindings = []; phase = Microsoft_FStar_Parser_AST.Un; sigmap = _68_18182; default_result_effect = Microsoft_FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))
...
(let _68_18199 = (let _68_18198 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_typ _68_18198 Microsoft_FStar_Absyn_Syntax.kun))
in Some (_68_18199))
end
| _ -> begin
None
...
in (Support.Microsoft.FStar.Util.find_map namespaces (fun ( ns ) -> (let full_name = (let _68_18214 = (let _68_18213 = (Microsoft_FStar_Absyn_Syntax.ids_of_lid ns)
in (Support.List.append _68_18213 ids))
in (Microsoft_FStar_Absyn_Syntax.lid_of_ids _68_18214))
in (finder full_name)))))
end))
in (let _68_18216 = (let _68_18215 = (current_module env)
in (_68_18215)::env.open_namespaces)
in (aux _68_18216))))
...
| true -> begin
(let _68_18220 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("Prims")::(y)::[]) id.Microsoft_FStar_Absyn_Syntax.idRange)
in Some (_68_18220))
end
| false -> begin
None
...
| Some (l) -> begin
(let _68_18228 = (let _68_18227 = (let _68_18226 = (let _68_18225 = (Microsoft_FStar_Absyn_Util.fv l)
in (_68_18225, None))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _68_18226 None id.Microsoft_FStar_Absyn_Syntax.idRange))
in (l, _68_18227))
in Some (_68_18228))
end
| _ -> begin
...
(let _68_18234 = (let _68_18233 = (let _68_18232 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id')::[]))
in (let _68_18231 = (let _68_18230 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_exp _68_18230 Microsoft_FStar_Absyn_Syntax.tun))
in (_68_18232, _68_18231)))
in Support.Microsoft.FStar.Util.Inr (_68_18233))
in Some (_68_18234))
end
| _ -> begin
None
...
let try_lookup_name = (fun ( any_val ) ( exclude_interf ) ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18303 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18303 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
(let _68_18306 = (let _68_18305 = (let _68_18304 = (Microsoft_FStar_Absyn_Util.ftv lid Microsoft_FStar_Absyn_Syntax.kun)
in (OSig (se), _68_18304))
in Typ_name (_68_18305))
in Some (_68_18306))
end
...
(let _68_18310 = (let _68_18309 = (let _68_18308 = (let _68_18307 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range ne.Microsoft_FStar_Absyn_Syntax.mname _68_18307))
in (OSig (se), _68_18308))
in Eff_name (_68_18309))
in Some (_68_18310))
end
...
(let _68_18315 = (let _68_18314 = (let _68_18313 = (let _68_18312 = (fv_qual_of_se se)
in (let _68_18311 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _68_18312 lid _68_18311)))
in (OSig (se), _68_18313))
in Exp_name (_68_18314))
in Some (_68_18315))
end
| Microsoft_FStar_Absyn_Syntax.Sig_let (_) -> begin
(let _68_18319 = (let _68_18318 = (let _68_18317 = (let _68_18316 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _68_18316))
in (OSig (se), _68_18317))
in Exp_name (_68_18318))
in Some (_68_18319))
end
| Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((_, _, quals, _)) -> begin
...
| true -> begin
(let _68_18325 = (let _68_18324 = (let _68_18323 = (let _68_18322 = (fv_qual_of_se se)
in (let _68_18321 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _68_18322 lid _68_18321)))
in (OSig (se), _68_18323))
in Exp_name (_68_18324))
in Some (_68_18325))
end
| false -> begin
None
...
(let _68_18330 = (let _68_18329 = (let _68_18328 = (let _68_18327 = (Microsoft_FStar_Absyn_Syntax.range_of_lid recname)
in (Microsoft_FStar_Absyn_Util.fvar None recname _68_18327))
in (ORec (l), _68_18328))
in Exp_name (_68_18329))
in Some (_68_18330))
end
| Binding_tycon (l) when (Microsoft_FStar_Absyn_Syntax.lid_equals l recname) -> begin
(let _68_18333 = (let _68_18332 = (let _68_18331 = (Microsoft_FStar_Absyn_Util.ftv recname Microsoft_FStar_Absyn_Syntax.kun)
in (ORec (l), _68_18331))
in Typ_name (_68_18332))
in Some (_68_18333))
end
| _ -> begin
None
...
(let _68_18340 = (Microsoft_FStar_Absyn_Util.ftv l Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_68_18340))
end
| _ -> begin
None
...
let try_resolve_typ_abbrev = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18369 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18369 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some ((Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev ((lid, tps, k, def, _, _)), _)) -> begin
(let t = (let _68_18372 = (let _68_18371 = (let _68_18370 = (Microsoft_FStar_Absyn_Util.close_with_lam tps def)
in (_68_18370, lid))
in Microsoft_FStar_Absyn_Syntax.Meta_named (_68_18371))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _68_18372))
in Some (t))
end
| _ -> begin
None
...
let lookup_letbinding_quals = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18379 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18379 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
let try_lookup_let = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18391 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18391 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some ((Microsoft_FStar_Absyn_Syntax.Sig_let (_), _)) -> begin
(let _68_18393 = (let _68_18392 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _68_18392))
in Some (_68_18393))
end
| _ -> begin
None
...
let try_lookup_datacon = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18412 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18412 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
| true -> begin
(let _68_18414 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_68_18414))
end
| false -> begin
None
...
(let _68_18415 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_68_18415))
end
| _ -> begin
None
...
let find_all_datacons = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _68_18422 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18422 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
| true -> begin
(match ((let _68_18446 = (find_dc dc)
in (Support.Prims.pipe_left Support.Microsoft.FStar.Util.must _68_18446))) with
...
| false -> begin
(let _68_18450 = (let _68_18449 = (let _68_18448 = (Microsoft_FStar_Absyn_Util.unmangle_field_name x.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.ppname)
in (qual constrname _68_18448))
in (_68_18449, x.Microsoft_FStar_Absyn_Syntax.sort))
in (_68_18450)::[])
end)
end
| _ -> begin
...
in (let _68_18452 = (let _68_18451 = (Support.ST.read record_cache)
in (record)::_68_18451)
in (Support.ST.op_Colon_Equals record_cache _68_18452)))))
end
| _ -> begin
()
end)
...
| (ns, fieldname) -> begin
(let _68_18468 = (Support.ST.read record_cache)
in (Support.Microsoft.FStar.Util.find_map _68_18468 (fun ( record ) -> (let constrname = record.constrname.Microsoft_FStar_Absyn_Syntax.ident
...
in Support.Microsoft.FStar.Util.Inl (_68_18509))
end
| Binding_var (id) -> begin
(let _68_18512 = (let _68_18511 = (let _68_18510 = (Microsoft_FStar_Absyn_Util.genident (Some (id.Microsoft_FStar_Absyn_Syntax.idRange)))
in (id, _68_18510))
in (Microsoft_FStar_Absyn_Util.mkbvd _68_18511))
in Support.Microsoft.FStar.Util.Inr (_68_18512))
end
| _ -> begin
...
| false -> begin
(let _68_18539 = (let _68_18538 = (let _68_18537 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in ((Support.String.strcat "Duplicate top-level names " lid.Microsoft_FStar_Absyn_Syntax.str), _68_18537))
in Microsoft_FStar_Absyn_Syntax.Error (_68_18538))
in (raise (_68_18539)))
end)
end
| _ -> begin
...
let push_sigelt = (fun ( env ) ( s ) -> (let err = (fun ( l ) -> (let sopt = (let _68_18546 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _68_18546 l.Microsoft_FStar_Absyn_Syntax.str))
in (let r = (match (sopt) with
| Some ((se, _)) -> begin
(match ((let _68_18547 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (Support.Microsoft.FStar.Util.find_opt (Microsoft_FStar_Absyn_Syntax.lid_equals l) _68_18547))) with
| Some (l) -> begin
(let _68_18548 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Support.Prims.pipe_left Support.Microsoft.FStar.Range.string_of_range _68_18548))
end
| None -> begin
"<unknown>"
end)
...
in (let _68_18553 = (let _68_18552 = (let _68_18551 = (let _68_18549 = (Microsoft_FStar_Absyn_Syntax.text_of_lid l)
in (Support.Microsoft.FStar.Util.format2 "Duplicate top-level names [%s]; previously declared at %s" _68_18549 r))
in (let _68_18550 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (_68_18551, _68_18550)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_18552))
in (raise (_68_18553))))))
...
(let _68_18557 = (Support.List.map (fun ( se ) -> (let _68_18556 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (_68_18556, se))) ses)
in (env, _68_18557))
end
| _ -> begin
(let _68_18560 = (let _68_18559 = (let _68_18558 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt s)
in (_68_18558, s))
in (_68_18559)::[])
in (env, _68_18560))
end)
...
| (lids, se) -> begin
(Support.Prims.pipe_right lids (Support.List.iter (fun ( lid ) -> (let _68_18563 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_add _68_18563 lid.Microsoft_FStar_Absyn_Syntax.str (se, (env.iface && (not (env.admitted_iface)))))))))
end))))
in env)
end)))))
...
let check_admits = (fun ( nm ) ( env ) -> (let warn = (not ((let _68_18579 = (Support.ST.read Microsoft_FStar_Options.admit_fsi)
in (Support.Prims.pipe_right _68_18579 (Support.Microsoft.FStar.Util.for_some (fun ( l ) -> (nm.Microsoft_FStar_Absyn_Syntax.str = l)))))))
...
| true -> begin
(let _68_18584 = (let _68_18583 = (let _68_18581 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Support.Microsoft.FStar.Range.string_of_range _68_18581))
in (let _68_18582 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.Microsoft.FStar.Util.format2 "%s: Warning: Admitting %s without a definition\n" _68_18583 _68_18582)))
in (Support.Microsoft.FStar.Util.print_string _68_18584))
end
| false -> begin
()
end)
in (let _68_18585 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_add _68_18585 l.Microsoft_FStar_Absyn_Syntax.str (Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((l, t, (Microsoft_FStar_Absyn_Syntax.Assumption)::quals, r)), false))))
end
| Some (_) -> begin
()
end)
...
| Microsoft_FStar_Absyn_Syntax.Sig_datacon ((lid, _, _, _, _, _)) -> begin
(let _68_18592 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_remove _68_18592 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| _ -> begin
()
end))))
...
(match ((Support.List.contains Microsoft_FStar_Absyn_Syntax.Private quals)) with
| true -> begin
(let _68_18593 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_remove _68_18593 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
...
| true -> begin
(let _68_18626 = (let _68_18625 = (let _68_18624 = (Support.Microsoft.FStar.Util.format1 "Duplicate module or interface name: %s" mname.Microsoft_FStar_Absyn_Syntax.str)
in (let _68_18623 = (Microsoft_FStar_Absyn_Syntax.range_of_lid mname)
in (_68_18624, _68_18623)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_18625))
in (raise (_68_18626)))
end
| false -> begin
()
...
(let _68_18641 = (range_of_occurrence o)
in Some (_68_18641))
end)
...
| Some (r) -> begin
(let _68_18642 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format1 "(Possible clash with related name at %s)" _68_18642))
end)
in (let _68_18647 = (let _68_18646 = (let _68_18645 = (let _68_18643 = (Microsoft_FStar_Absyn_Syntax.text_of_lid lid)
in (Support.Microsoft.FStar.Util.format2 "Identifier not found: [%s] %s" _68_18643 msg))
in (let _68_18644 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (_68_18645, _68_18644)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_18646))
in (raise (_68_18647)))))
end
| Some (r) -> begin
r
