...
let qual = (fun ( lid ) ( id ) -> (let _70_20368 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Support.List.append lid.Microsoft_FStar_Absyn_Syntax.ns ((lid.Microsoft_FStar_Absyn_Syntax.ident)::(id)::[])))
in (Microsoft_FStar_Absyn_Util.set_lid_range _70_20368 id.Microsoft_FStar_Absyn_Syntax.idRange)))

let qualify = (fun ( env ) ( id ) -> (let _70_20373 = (current_module env)
in (qual _70_20373 id)))

let qualify_lid = (fun ( env ) ( lid ) -> (let cur = (current_module env)
in (let _70_20379 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Support.List.append (Support.List.append (Support.List.append cur.Microsoft_FStar_Absyn_Syntax.ns ((cur.Microsoft_FStar_Absyn_Syntax.ident)::[])) lid.Microsoft_FStar_Absyn_Syntax.ns) ((lid.Microsoft_FStar_Absyn_Syntax.ident)::[])))
in (let _70_20378 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range _70_20379 _70_20378)))))
...
| () -> begin
(let _70_20384 = (let _70_20383 = (new_sigmap ())
in (_70_20383)::[])
in {curmodule = None; modules = []; open_namespaces = []; sigaccum = []; localbindings = []; recbindings = []; phase = Microsoft_FStar_Parser_AST.Un; sigmap = _70_20384; default_result_effect = Microsoft_FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))
...
(let _70_20401 = (let _70_20400 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_typ _70_20400 Microsoft_FStar_Absyn_Syntax.kun))
in Some (_70_20401))
end
| _41_91 -> begin
None
...
in (Support.Microsoft.FStar.Util.find_map namespaces (fun ( ns ) -> (let full_name = (let _70_20416 = (let _70_20415 = (Microsoft_FStar_Absyn_Syntax.ids_of_lid ns)
in (Support.List.append _70_20415 ids))
in (Microsoft_FStar_Absyn_Syntax.lid_of_ids _70_20416))
in (finder full_name)))))
end))
in (let _70_20418 = (let _70_20417 = (current_module env)
in (_70_20417)::env.open_namespaces)
in (aux _70_20418))))
...
| true -> begin
(let _70_20422 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("Prims")::(y)::[]) id.Microsoft_FStar_Absyn_Syntax.idRange)
in Some (_70_20422))
end
| false -> begin
None
...
| Some (l) -> begin
(let _70_20430 = (let _70_20429 = (let _70_20428 = (let _70_20427 = (Microsoft_FStar_Absyn_Util.fv l)
in (_70_20427, None))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _70_20428 None id.Microsoft_FStar_Absyn_Syntax.idRange))
in (l, _70_20429))
in Some (_70_20430))
end
| _41_114 -> begin
...
(let _70_20436 = (let _70_20435 = (let _70_20434 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id')::[]))
in (let _70_20433 = (let _70_20432 = (Microsoft_FStar_Absyn_Util.set_bvd_range bvd id.Microsoft_FStar_Absyn_Syntax.idRange)
in (Microsoft_FStar_Absyn_Util.bvd_to_exp _70_20432 Microsoft_FStar_Absyn_Syntax.tun))
in (_70_20434, _70_20433)))
in Support.Microsoft.FStar.Util.Inr (_70_20435))
in Some (_70_20436))
end
| _41_128 -> begin
None
...
let try_lookup_name = (fun ( any_val ) ( exclude_interf ) ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20554 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20554 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
(let _70_20557 = (let _70_20556 = (let _70_20555 = (Microsoft_FStar_Absyn_Util.ftv lid Microsoft_FStar_Absyn_Syntax.kun)
in (OSig (se), _70_20555))
in Typ_name (_70_20556))
in Some (_70_20557))
end
...
(let _70_20561 = (let _70_20560 = (let _70_20559 = (let _70_20558 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.set_lid_range ne.Microsoft_FStar_Absyn_Syntax.mname _70_20558))
in (OSig (se), _70_20559))
in Eff_name (_70_20560))
in Some (_70_20561))
end
...
(let _70_20566 = (let _70_20565 = (let _70_20564 = (let _70_20563 = (fv_qual_of_se se)
in (let _70_20562 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _70_20563 lid _70_20562)))
in (OSig (se), _70_20564))
in Exp_name (_70_20565))
in Some (_70_20566))
end
| Microsoft_FStar_Absyn_Syntax.Sig_let (_41_245) -> begin
(let _70_20570 = (let _70_20569 = (let _70_20568 = (let _70_20567 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _70_20567))
in (OSig (se), _70_20568))
in Exp_name (_70_20569))
in Some (_70_20570))
end
...
| true -> begin
(let _70_20576 = (let _70_20575 = (let _70_20574 = (let _70_20573 = (fv_qual_of_se se)
in (let _70_20572 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar _70_20573 lid _70_20572)))
in (OSig (se), _70_20574))
in Exp_name (_70_20575))
in Some (_70_20576))
end
| false -> begin
None
...
(let _70_20581 = (let _70_20580 = (let _70_20579 = (let _70_20578 = (Microsoft_FStar_Absyn_Syntax.range_of_lid recname)
in (Microsoft_FStar_Absyn_Util.fvar None recname _70_20578))
in (ORec (l), _70_20579))
in Exp_name (_70_20580))
in Some (_70_20581))
end
| Binding_tycon (l) when (Microsoft_FStar_Absyn_Syntax.lid_equals l recname) -> begin
(let _70_20584 = (let _70_20583 = (let _70_20582 = (Microsoft_FStar_Absyn_Util.ftv recname Microsoft_FStar_Absyn_Syntax.kun)
in (ORec (l), _70_20582))
in Typ_name (_70_20583))
in Some (_70_20584))
end
| _41_275 -> begin
None
...
(let _70_20591 = (Microsoft_FStar_Absyn_Util.ftv l Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_70_20591))
end
| _41_300 -> begin
None
...
let try_resolve_typ_abbrev = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20620 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20620 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some ((Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev ((lid, tps, k, def, _41_350, _41_352)), _41_356)) -> begin
(let t = (let _70_20623 = (let _70_20622 = (let _70_20621 = (Microsoft_FStar_Absyn_Util.close_with_lam tps def)
in (_70_20621, lid))
in Microsoft_FStar_Absyn_Syntax.Meta_named (_70_20622))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _70_20623))
in Some (t))
end
| _41_361 -> begin
None
...
let lookup_letbinding_quals = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20630 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20630 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
let try_lookup_let = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20642 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20642 lid.Microsoft_FStar_Absyn_Syntax.str))) with
| Some ((Microsoft_FStar_Absyn_Syntax.Sig_let (_41_400), _41_403)) -> begin
(let _70_20644 = (let _70_20643 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar None lid _70_20643))
in Some (_70_20644))
end
| _41_407 -> begin
None
...
let try_lookup_datacon = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20663 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20663 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
| true -> begin
(let _70_20665 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_70_20665))
end
| false -> begin
None
...
(let _70_20666 = (Microsoft_FStar_Absyn_Util.fv lid)
in Some (_70_20666))
end
| _41_451 -> begin
None
...
let find_all_datacons = (fun ( env ) ( lid ) -> (let find_in_sig = (fun ( lid ) -> (match ((let _70_20673 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20673 lid.Microsoft_FStar_Absyn_Syntax.str))) with
...
| true -> begin
(match ((let _70_20697 = (find_dc dc)
in (Support.All.pipe_left Support.Microsoft.FStar.Util.must _70_20697))) with
...
| false -> begin
(let _70_20701 = (let _70_20700 = (let _70_20699 = (Microsoft_FStar_Absyn_Util.unmangle_field_name x.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.ppname)
in (qual constrname _70_20699))
in (_70_20700, x.Microsoft_FStar_Absyn_Syntax.sort))
in (_70_20701)::[])
end)
end
| _41_561 -> begin
...
in (let _70_20703 = (let _70_20702 = (Support.ST.read record_cache)
in (record)::_70_20702)
in (Support.ST.op_Colon_Equals record_cache _70_20703)))))
end
| _41_565 -> begin
()
end)
...
| (ns, fieldname) -> begin
(let _70_20719 = (Support.ST.read record_cache)
in (Support.Microsoft.FStar.Util.find_map _70_20719 (fun ( record ) -> (let constrname = record.constrname.Microsoft_FStar_Absyn_Syntax.ident
...
(let _70_20760 = (let _70_20759 = (let _70_20758 = (Microsoft_FStar_Absyn_Util.genident (Some (id.Microsoft_FStar_Absyn_Syntax.idRange)))
in (id, _70_20758))
in (Microsoft_FStar_Absyn_Util.mkbvd _70_20759))
in Support.Microsoft.FStar.Util.Inl (_70_20760))
end
| Binding_var (id) -> begin
(let _70_20763 = (let _70_20762 = (let _70_20761 = (Microsoft_FStar_Absyn_Util.genident (Some (id.Microsoft_FStar_Absyn_Syntax.idRange)))
in (id, _70_20761))
in (Microsoft_FStar_Absyn_Util.mkbvd _70_20762))
in Support.Microsoft.FStar.Util.Inr (_70_20763))
end
| _41_656 -> begin
...
| false -> begin
(let _70_20790 = (let _70_20789 = (let _70_20788 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in ((Support.String.strcat "Duplicate top-level names " lid.Microsoft_FStar_Absyn_Syntax.str), _70_20788))
in Microsoft_FStar_Absyn_Syntax.Error (_70_20789))
in (raise (_70_20790)))
end)
end
| _41_696 -> begin
...
let push_sigelt = (fun ( env ) ( s ) -> (let err = (fun ( l ) -> (let sopt = (let _70_20797 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_try_find _70_20797 l.Microsoft_FStar_Absyn_Syntax.str))
in (let r = (match (sopt) with
| Some ((se, _41_704)) -> begin
(match ((let _70_20798 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (Support.Microsoft.FStar.Util.find_opt (Microsoft_FStar_Absyn_Syntax.lid_equals l) _70_20798))) with
| Some (l) -> begin
(let _70_20799 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Support.All.pipe_left Support.Microsoft.FStar.Range.string_of_range _70_20799))
end
| None -> begin
"<unknown>"
end)
...
in (let _70_20804 = (let _70_20803 = (let _70_20802 = (let _70_20800 = (Microsoft_FStar_Absyn_Syntax.text_of_lid l)
in (Support.Microsoft.FStar.Util.format2 "Duplicate top-level names [%s]; previously declared at %s" _70_20800 r))
in (let _70_20801 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (_70_20802, _70_20801)))
in Microsoft_FStar_Absyn_Syntax.Error (_70_20803))
in (raise (_70_20804))))))
...
(let _70_20808 = (Support.List.map (fun ( se ) -> (let _70_20807 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
in (_70_20807, se))) ses)
in (env, _70_20808))
end
| _41_744 -> begin
(let _70_20811 = (let _70_20810 = (let _70_20809 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt s)
in (_70_20809, s))
in (_70_20810)::[])
in (env, _70_20811))
end)
...
| (lids, se) -> begin
(Support.All.pipe_right lids (Support.List.iter (fun ( lid ) -> (let _70_20814 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_add _70_20814 lid.Microsoft_FStar_Absyn_Syntax.str (se, (env.iface && (not (env.admitted_iface)))))))))
end))))
in env)
end)))))
...
let check_admits = (fun ( nm ) ( env ) -> (let warn = (not ((let _70_20830 = (Support.ST.read Microsoft_FStar_Options.admit_fsi)
in (Support.All.pipe_right _70_20830 (Support.Microsoft.FStar.Util.for_some (fun ( l ) -> (nm.Microsoft_FStar_Absyn_Syntax.str = l)))))))
...
| true -> begin
(let _70_20835 = (let _70_20834 = (let _70_20832 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Support.Microsoft.FStar.Range.string_of_range _70_20832))
in (let _70_20833 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.Microsoft.FStar.Util.format2 "%s: Warning: Admitting %s without a definition\n" _70_20834 _70_20833)))
in (Support.Microsoft.FStar.Util.print_string _70_20835))
end
| false -> begin
()
end)
in (let _70_20836 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_add _70_20836 l.Microsoft_FStar_Absyn_Syntax.str (Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((l, t, (Microsoft_FStar_Absyn_Syntax.Assumption)::quals, r)), false))))
end
| Some (_41_787) -> begin
()
end)
...
(let _70_20843 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_remove _70_20843 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| _41_817 -> begin
()
end))))
...
(match ((Support.List.contains Microsoft_FStar_Absyn_Syntax.Private quals)) with
| true -> begin
(let _70_20844 = (sigmap env)
in (Support.Microsoft.FStar.Util.smap_remove _70_20844 lid.Microsoft_FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
...
| true -> begin
(let _70_20877 = (let _70_20876 = (let _70_20875 = (Support.Microsoft.FStar.Util.format1 "Duplicate module or interface name: %s" mname.Microsoft_FStar_Absyn_Syntax.str)
in (let _70_20874 = (Microsoft_FStar_Absyn_Syntax.range_of_lid mname)
in (_70_20875, _70_20874)))
in Microsoft_FStar_Absyn_Syntax.Error (_70_20876))
in (raise (_70_20877)))
end
| false -> begin
()
...
(let _70_20892 = (range_of_occurrence o)
in Some (_70_20892))
end)
...
| Some (r) -> begin
(let _70_20893 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format1 "(Possible clash with related name at %s)" _70_20893))
end)
in (let _70_20898 = (let _70_20897 = (let _70_20896 = (let _70_20894 = (Microsoft_FStar_Absyn_Syntax.text_of_lid lid)
in (Support.Microsoft.FStar.Util.format2 "Identifier not found: [%s] %s" _70_20894 msg))
in (let _70_20895 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (_70_20896, _70_20895)))
in Microsoft_FStar_Absyn_Syntax.Error (_70_20897))
in (raise (_70_20898)))))
end
| Some (r) -> begin
r
