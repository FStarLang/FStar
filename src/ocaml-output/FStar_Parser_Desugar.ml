...
| (env, binders) -> begin
(
# 1603 "FStar.Parser.Desugar.fst"
let defn = (desugar_typ env defn)
in (
# 1604 "FStar.Parser.Desugar.fst"
...
in (
# 1611 "FStar.Parser.Desugar.fst"
let sub = (FStar_Absyn_Util.subst_typ subst)
in (
# 1612 "FStar.Parser.Desugar.fst"
...
| (env, decls) -> begin
(
# 1647 "FStar.Parser.Desugar.fst"
let decls = (FStar_List.rev decls)
in (
# 1648 "FStar.Parser.Desugar.fst"
