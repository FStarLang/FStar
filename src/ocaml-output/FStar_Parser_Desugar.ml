...
let _63_890 = (let _163_307 = (FStar_Absyn_Syntax.pat_vars pat)
...
| None -> begin
(let _163_540 = (let _163_539 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _63_1556 -> (match (_63_1556) with
| (f, _63_1555) -> begin
...
let record = (let _163_545 = (let _163_544 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _63_1564 -> (match (_63_1564) with
| (f, _63_1563) -> begin
...
let _63_2049 = (let _163_709 = (let _163_708 = (FStar_Parser_DesugarEnv.default_ml env)
...
let all_params = (let _163_892 = (FStar_All.pipe_right tps (FStar_List.map (fun _63_2385 -> (match (_63_2385) with
| (b, _63_2384) -> begin
((b), (Some (imp_tag)))
end))))
...
in (let _163_963 = (FStar_All.pipe_right fields (FStar_List.map (fun _63_2568 -> (match (_63_2568) with
...
let _63_2623 = (let _163_984 = (FStar_Range.string_of_range rng)
...
in (let _163_988 = (FStar_All.pipe_right quals (FStar_List.filter (fun _63_24 -> (match (_63_24) with
| FStar_Absyn_Syntax.Effect -> begin
false
end
| _63_2655 -> begin
...
let _63_2780 = (let _163_1008 = (FStar_All.pipe_right constrs (FStar_List.map (fun _63_2762 -> (match (_63_2762) with
