...
| hd::tl -> begin
(let _44_1943 = (let _110_716 = (let _110_715 = (FStar_Parser_DesugarEnv.default_ml env)
...
in (let all_params = (let _110_903 = (FStar_All.pipe_right tps (FStar_List.map (fun _44_2276 -> (match (_44_2276) with
| (b, _44_2275) -> begin
...
in (let _110_985 = (FStar_All.pipe_right fields (FStar_List.map (fun _44_2453 -> (match (_44_2453) with
| (x, _44_2452) -> begin
...
in (let _44_2660 = (let _110_1026 = (FStar_All.pipe_right constrs (FStar_List.map (fun _44_2642 -> (match (_44_2642) with
