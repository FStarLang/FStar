...
let tcs = (FStar_List.map (fun _62_2884 -> (match (_62_2884) with
| (x, _62_2883) -> begin
x
end)) tcs)
...
| FStar_Absyn_Syntax.Exp_let (lbs, _62_2893) -> begin
(
...
| (_62_2905)::_62_2903 -> begin
(trans_quals quals)
end
| _62_2908 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun _62_30 -> (match (_62_30) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_62_2917); FStar_Absyn_Syntax.lbtyp = _62_2915; FStar_Absyn_Syntax.lbeff = _62_2913; FStar_Absyn_Syntax.lbdef = _62_2911} -> begin
[]
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = _62_2925; FStar_Absyn_Syntax.lbeff = _62_2923; FStar_Absyn_Syntax.lbdef = _62_2921} -> begin
...
let _62_2986 = (desugar_binders env binders)
...
| FStar_Parser_AST.NewEffectForFree (_62_2992) -> begin
...
let _62_3005 = (desugar_binders env eff_binders)
...
let _62_3009 = (FStar_Absyn_Util.head_and_args defn)
in (match (_62_3009) with
| (head, args) -> begin
...
let _62_3036 = (desugar_binders env eff_binders)
in (match (_62_3036) with
| (env, binders) -> begin
(
...
let _62_3047 = (FStar_All.pipe_right eff_decls (FStar_List.fold_left (fun _62_3040 decl -> (match (_62_3040) with
| (env, out) -> begin
(

let _62_3044 = (desugar_decl env decl)
...
let desugar_decls : FStar_Parser_DesugarEnv.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_Parser_DesugarEnv.env * FStar_Absyn_Syntax.sigelts) = (fun env decls -> (FStar_List.fold_left (fun _62_3078 d -> (match (_62_3078) with
| (env, sigelts) -> begin
(

let _62_3082 = (desugar_decl env d)
in (match (_62_3082) with
| (env, se) -> begin
...
let _62_3112 = (desugar_decls env decls)
...
| FStar_Parser_AST.Interface (mname, _62_3123, _62_3125) -> begin
...
let _62_3133 = (desugar_modul_common curmod env m)
...
let _62_3139 = (desugar_modul_common None env m)
...
let _62_3141 = if (FStar_Options.dump_module modul.FStar_Absyn_Syntax.name.FStar_Ident.str) then begin
...
let _62_3154 = (FStar_List.fold_left (fun _62_3147 m -> (match (_62_3147) with
| (env, mods) -> begin
(

let _62_3151 = (desugar_modul env m)
...
let _62_3159 = (FStar_Parser_DesugarEnv.prepare_module_or_interface false false en m.FStar_Absyn_Syntax.name)
in (match (_62_3159) with
...
let _62_3160 = en
in {FStar_Parser_DesugarEnv.curmodule = Some (m.FStar_Absyn_Syntax.name); FStar_Parser_DesugarEnv.modules = _62_3160.FStar_Parser_DesugarEnv.modules; FStar_Parser_DesugarEnv.open_namespaces = _62_3160.FStar_Parser_DesugarEnv.open_namespaces; FStar_Parser_DesugarEnv.modul_abbrevs = _62_3160.FStar_Parser_DesugarEnv.modul_abbrevs; FStar_Parser_DesugarEnv.sigaccum = _62_3160.FStar_Parser_DesugarEnv.sigaccum; FStar_Parser_DesugarEnv.localbindings = _62_3160.FStar_Parser_DesugarEnv.localbindings; FStar_Parser_DesugarEnv.recbindings = _62_3160.FStar_Parser_DesugarEnv.recbindings; FStar_Parser_DesugarEnv.phase = _62_3160.FStar_Parser_DesugarEnv.phase; FStar_Parser_DesugarEnv.sigmap = _62_3160.FStar_Parser_DesugarEnv.sigmap; FStar_Parser_DesugarEnv.default_result_effect = _62_3160.FStar_Parser_DesugarEnv.default_result_effect; FStar_Parser_DesugarEnv.iface = _62_3160.FStar_Parser_DesugarEnv.iface; FStar_Parser_DesugarEnv.admitted_iface = _62_3160.FStar_Parser_DesugarEnv.admitted_iface}) m.FStar_Absyn_Syntax.exports)
in (
