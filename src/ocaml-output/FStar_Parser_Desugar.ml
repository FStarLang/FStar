...
| FStar_Parser_AST.Annotated (_44_45) -> begin
true
end
| _44_48 -> begin
false
...
| FStar_Parser_AST.Labeled (t, _44_59, _44_61) -> begin
(unlabel t)
end
| _44_65 -> begin
t
...
in Some (_110_51)))
in (let fallback = (fun _44_102 -> (match (()) with
| () -> begin
(match (s) with
| "=" -> begin
...
| Some ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_fvar (fv, _44_135); FStar_Absyn_Syntax.tk = _44_132; FStar_Absyn_Syntax.pos = _44_130; FStar_Absyn_Syntax.fvs = _44_128; FStar_Absyn_Syntax.uvs = _44_126}) -> begin
...
| Some ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_const (ftv); FStar_Absyn_Syntax.tk = _44_164; FStar_Absyn_Syntax.pos = _44_162; FStar_Absyn_Syntax.fvs = _44_160; FStar_Absyn_Syntax.uvs = _44_158}) -> begin
...
| FStar_Parser_AST.Labeled (_44_175) -> begin
true
end
| FStar_Parser_AST.Op ("*", hd::_44_179) -> begin
(is_type env hd)
end
...
| FStar_Parser_AST.Product (_44_297, t) -> begin
(not ((is_kind env t)))
end
...
| FStar_Parser_AST.PatTvar (id, _44_323) -> begin
(let _44_329 = (FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (match (_44_329) with
| (env, _44_328) -> begin
(aux env pats)
end))
end
...
| FStar_Parser_AST.Name ({FStar_Absyn_Syntax.ns = _44_358; FStar_Absyn_Syntax.ident = _44_356; FStar_Absyn_Syntax.nsstr = _44_354; FStar_Absyn_Syntax.str = "Type"}) -> begin
true
end
| FStar_Parser_AST.Product (_44_362, t) -> begin
(is_kind env t)
end
| FStar_Parser_AST.Paren (t) -> begin
(is_kind env t)
...
| FStar_Parser_AST.Variable (_44_379) -> begin
false
end
...
| false -> begin
(match (b.FStar_Parser_AST.b) with
| FStar_Parser_AST.Variable (_44_394) -> begin
(Prims.raise (FStar_Absyn_Syntax.Error (("Unexpected binder without annotation", b.FStar_Parser_AST.brange))))
end
| FStar_Parser_AST.TVariable (_44_397) -> begin
false
end
| FStar_Parser_AST.TAnnotated (_44_400) -> begin
true
end
| (FStar_Parser_AST.Annotated (_, t)) | (FStar_Parser_AST.NoName (t)) -> begin
(is_kind env t)
...
| FStar_Parser_AST.Variable (_44_416) -> begin
(env, [])
end
| FStar_Parser_AST.TVariable (x) -> begin
(let _44_423 = (FStar_Parser_DesugarEnv.push_local_tbinding env x)
in (match (_44_423) with
| (env, _44_422) -> begin
(env, (x)::[])
end))
end
| FStar_Parser_AST.Annotated (_44_425, term) -> begin
(let _110_99 = (free_type_vars env term)
in (env, _110_99))
end
| FStar_Parser_AST.TAnnotated (id, _44_431) -> begin
(let _44_437 = (FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (match (_44_437) with
| (env, _44_436) -> begin
(env, [])
end))
end
...
| FStar_Parser_AST.Construct (_44_482, ts) -> begin
(FStar_List.collect (fun _44_489 -> (match (_44_489) with
| (t, _44_488) -> begin
(free_type_vars env t)
end)) ts)
end
| FStar_Parser_AST.Op (_44_491, ts) -> begin
(FStar_List.collect (free_type_vars env) ts)
end
| FStar_Parser_AST.App (t1, t2, _44_498) -> begin
(let _110_106 = (free_type_vars env t1)
in (let _110_105 = (free_type_vars env t2)
in (FStar_List.append _110_106 _110_105)))
end
| FStar_Parser_AST.Refine (b, t) -> begin
(let _44_507 = (free_type_vars_b env b)
in (match (_44_507) with
| (env, f) -> begin
...
(let _44_523 = (FStar_List.fold_left (fun _44_516 binder -> (match (_44_516) with
| (env, free) -> begin
(let _44_520 = (free_type_vars_b env binder)
in (match (_44_520) with
| (env, f) -> begin
(env, (FStar_List.append f free))
end))
end)) (env, []) binders)
in (match (_44_523) with
| (env, free) -> begin
(let _110_110 = (free_type_vars env body)
in (FStar_List.append free _110_110))
end))
end
| FStar_Parser_AST.Project (t, _44_526) -> begin
(free_type_vars env t)
end
...
| FStar_Parser_AST.Product (_44_583) -> begin
t
end
| _44_586 -> begin
...
| FStar_Parser_AST.PatAscribed (p, _44_600) -> begin
(is_app_pattern p)
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (_44_606); FStar_Parser_AST.prange = _44_604}, _44_610) -> begin
true
end
| _44_614 -> begin
false
...
(let _44_626 = (destruct_app_pattern env is_top_level p)
in (match (_44_626) with
| (name, args, _44_625) -> begin
(name, args, Some (t))
end))
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _44_631); FStar_Parser_AST.prange = _44_628}, args) when is_top_level -> begin
(let _110_150 = (let _110_149 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_110_149))
in (_110_150, args, None))
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _44_642); FStar_Parser_AST.prange = _44_639}, args) -> begin
...
| TBinder (_44_653) -> begin
_44_653
end))

let ___VBinder____0 = (fun projectee -> (match (projectee) with
| VBinder (_44_656) -> begin
_44_656
end))

let ___LetBinder____0 = (fun projectee -> (match (projectee) with
| LetBinder (_44_659) -> begin
_44_659
end))
...
(let _44_691 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (match (_44_691) with
| (env, a) -> begin
((FStar_Util.Inl ((FStar_Absyn_Util.bvd_to_bvar_s a k)), imp), env)
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(let _44_699 = (FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_44_699) with
| (env, x) -> begin
...
let mk_lb = (fun _44_735 -> (match (_44_735) with
| (n, t, e) -> begin
...
| _44_751 -> begin
(let _44_754 = (FStar_Parser_DesugarEnv.push_local_vbinding e x)
in (match (_44_754) with
| (e, x) -> begin
...
| _44_768 -> begin
(let _44_771 = (FStar_Parser_DesugarEnv.push_local_tbinding e a)
in (match (_44_771) with
| (e, a) -> begin
...
(let _44_793 = (aux loc env p)
in (match (_44_793) with
| (loc, env, var, p, _44_792) -> begin
(let _44_810 = (FStar_List.fold_left (fun _44_797 p -> (match (_44_797) with
| (loc, env, ps) -> begin
(let _44_806 = (aux loc env p)
in (match (_44_806) with
| (loc, env, _44_802, p, _44_805) -> begin
(loc, env, (p)::ps)
end))
end)) (loc, env, []) ps)
in (match (_44_810) with
| (loc, env, ps) -> begin
(let pat = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_disj ((p)::(FStar_List.rev ps))))
in (let _44_812 = (let _110_302 = (FStar_Absyn_Syntax.pat_vars pat)
...
| true -> begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatTvar (_44_819) -> begin
p
end
| FStar_Parser_AST.PatVar (x, imp) -> begin
(let _44_825 = p
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatTvar ((x, imp)); FStar_Parser_AST.prange = _44_825.FStar_Parser_AST.prange})
end
| _44_828 -> begin
...
in (let _44_835 = (aux loc env p)
in (match (_44_835) with
| (loc, env', binder, p, imp) -> begin
(let binder = (match (binder) with
| LetBinder (_44_837) -> begin
(FStar_All.failwith "impossible")
end
| TBinder (x, _44_841, aq) -> begin
(let _110_304 = (let _110_303 = (desugar_kind env t)
in (x, _110_303, aq))
in TBinder (_110_304))
end
| VBinder (x, _44_847, aq) -> begin
...
| false -> begin
(let _44_862 = (resolvea loc env a)
in (match (_44_862) with
| (loc, env, abvd) -> begin
...
in (let _44_877 = (resolvex loc env x)
in (match (_44_877) with
| (loc, env, xbvd) -> begin
...
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatName (l); FStar_Parser_AST.prange = _44_883}, args) -> begin
(let _44_905 = (FStar_List.fold_right (fun arg _44_894 -> (match (_44_894) with
| (loc, env, args) -> begin
(let _44_901 = (aux loc env arg)
in (match (_44_901) with
| (loc, env, _44_898, arg, imp) -> begin
(loc, env, ((arg, imp))::args)
end))
end)) args (loc, env, []))
in (match (_44_905) with
| (loc, env, args) -> begin
(let l = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
...
| FStar_Parser_AST.PatApp (_44_909) -> begin
(Prims.raise (FStar_Absyn_Syntax.Error (("Unexpected pattern", p.FStar_Parser_AST.prange))))
end
| FStar_Parser_AST.PatList (pats) -> begin
(let _44_929 = (FStar_List.fold_right (fun pat _44_917 -> (match (_44_917) with
| (loc, env, pats) -> begin
(let _44_925 = (aux loc env pat)
in (match (_44_925) with
| (loc, env, _44_921, pat, _44_924) -> begin
(loc, env, (pat)::pats)
end))
end)) pats (loc, env, []))
in (match (_44_929) with
| (loc, env, pats) -> begin
...
(let _44_955 = (FStar_List.fold_left (fun _44_942 p -> (match (_44_942) with
| (loc, env, pats) -> begin
(let _44_951 = (aux loc env p)
in (match (_44_951) with
| (loc, env, _44_947, pat, _44_950) -> begin
(loc, env, ((pat, false))::pats)
end))
end)) (loc, env, []) args)
in (match (_44_955) with
| (loc, env, args) -> begin
...
| FStar_Absyn_Syntax.Exp_fvar (v, _44_961) -> begin
v
end
| _44_965 -> begin
(FStar_All.failwith "impossible")
...
(let _44_975 = (FStar_List.hd fields)
in (match (_44_975) with
| (f, _44_974) -> begin
(let _44_979 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_record_by_field_name env) f)
in (match (_44_979) with
| (record, _44_978) -> begin
(let fields = (FStar_All.pipe_right fields (FStar_List.map (fun _44_982 -> (match (_44_982) with
| (f, p) -> begin
(let _110_333 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.qualify_field_to_record env record) f)
in (_110_333, p))
end))))
in (let args = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _44_987 -> (match (_44_987) with
| (f, _44_986) -> begin
(match ((FStar_All.pipe_right fields (FStar_List.tryFind (fun _44_991 -> (match (_44_991) with
| (g, _44_990) -> begin
...
in (let _44_1006 = (aux loc env app)
in (match (_44_1006) with
| (env, e, b, p, _44_1005) -> begin
(let p = (match (p.FStar_Absyn_Syntax.v) with
| FStar_Absyn_Syntax.Pat_cons (fv, _44_1009, args) -> begin
...
in (let _44_1023 = (aux [] env p)
in (match (_44_1023) with
| (_44_1017, env, b, p, _44_1022) -> begin
(env, b, p)
end))))))
and desugar_binding_pat_maybe_top = (fun top env p -> (match (top) with
| true -> begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatVar (x, _44_1029) -> begin
...
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, _44_1036); FStar_Parser_AST.prange = _44_1033}, t) -> begin
...
| false -> begin
(let _44_1048 = (desugar_data_pat env p)
in (match (_44_1048) with
| (env, binder, p) -> begin
(let p = (match (p.FStar_Absyn_Syntax.v) with
...
and desugar_match_pat_maybe_top = (fun _44_1063 env pat -> (let _44_1071 = (desugar_data_pat env pat)
in (match (_44_1071) with
| (env, _44_1069, pat) -> begin
(env, pat)
end)))
...
in (let setpos = (fun e -> (let _44_1085 = e
in {FStar_Absyn_Syntax.n = _44_1085.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _44_1085.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = top.FStar_Parser_AST.range; FStar_Absyn_Syntax.fvs = _44_1085.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _44_1085.FStar_Absyn_Syntax.uvs}))
...
| _44_1112 -> begin
(let args = (FStar_List.map (fun _44_1115 -> (match (_44_1115) with
| (t, imp) -> begin
...
(let _44_1152 = (FStar_List.fold_left (fun _44_1124 pat -> (match (_44_1124) with
| (env, ftvs) -> begin
(match (pat.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatTvar (a, imp); FStar_Parser_AST.prange = _44_1127}, t) -> begin
...
| p::rest -> begin
(let _44_1175 = (desugar_binding_pat env p)
in (match (_44_1175) with
| (env, b, pat) -> begin
(let _44_1235 = (match (b) with
| LetBinder (_44_1177) -> begin
(FStar_All.failwith "Impossible")
end
| TBinder (a, k, aq) -> begin
...
| (FStar_Absyn_Syntax.Exp_bvar (_44_1206), _44_1209) -> begin
...
| (FStar_Absyn_Syntax.Exp_app (_44_1215, args), FStar_Absyn_Syntax.Pat_cons (_44_1220, _44_1222, pats)) -> begin
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (a); FStar_Parser_AST.range = _44_1239; FStar_Parser_AST.level = _44_1237}, arg, _44_1245) when ((FStar_Absyn_Syntax.lid_equals a FStar_Absyn_Const.assert_lid) || (FStar_Absyn_Syntax.lid_equals a FStar_Absyn_Const.assume_lid)) -> begin
...
| FStar_Parser_AST.App (_44_1250) -> begin
...
(let ds_let_rec = (fun _44_1278 -> (match (()) with
| () -> begin
(let bindings = ((pat, _snd))::_tl
in (let funs = (FStar_All.pipe_right bindings (FStar_List.map (fun _44_1282 -> (match (_44_1282) with
| (p, def) -> begin
...
| _44_1288 -> begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _44_1293); FStar_Parser_AST.prange = _44_1290}, t) -> begin
...
| FStar_Parser_AST.PatVar (id, _44_1302) -> begin
(match (top_level) with
| true -> begin
...
in (let _44_1332 = (FStar_List.fold_left (fun _44_1310 _44_1319 -> (match ((_44_1310, _44_1319)) with
| ((env, fnames), ((f, _44_1313, _44_1315), _44_1318)) -> begin
(let _44_1329 = (match (f) with
| FStar_Util.Inl (x) -> begin
(let _44_1324 = (FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_44_1324) with
| (env, xx) -> begin
...
in (match (_44_1329) with
| (env, lbname) -> begin
(env, (lbname)::fnames)
end))
end)) (env, []) funs)
in (match (_44_1332) with
| (env', fnames) -> begin
(let fnames = (FStar_List.rev fnames)
in (let desugar_one_def = (fun env lbname _44_1343 -> (match (_44_1343) with
| ((_44_1338, args, result_t), def) -> begin
...
in (let _44_1363 = (desugar_binding_pat_maybe_top top_level env pat)
in (match (_44_1363) with
| (env, binder, pat) -> begin
(match (binder) with
| TBinder (_44_1365) -> begin
...
(let desugar_branch = (fun _44_1414 -> (match (_44_1414) with
| (pat, wopt, b) -> begin
(let _44_1417 = (desugar_match_pat env pat)
in (match (_44_1417) with
| (env, pat) -> begin
...
| FStar_Parser_AST.Record (_44_1428, []) -> begin
(Prims.raise (FStar_Absyn_Syntax.Error (("Unexpected empty record", top.FStar_Parser_AST.range))))
end
| FStar_Parser_AST.Record (eopt, fields) -> begin
(let _44_1439 = (FStar_List.hd fields)
in (match (_44_1439) with
| (f, _44_1438) -> begin
(let qfn = (fun g -> (FStar_Absyn_Syntax.lid_of_ids (FStar_List.append f.FStar_Absyn_Syntax.ns ((g)::[]))))
in (let _44_1445 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_record_by_field_name env) f)
in (match (_44_1445) with
| (record, _44_1444) -> begin
(let get_field = (fun xopt f -> (let fn = f.FStar_Absyn_Syntax.ident
in (let found = (FStar_All.pipe_right fields (FStar_Util.find_opt (fun _44_1453 -> (match (_44_1453) with
| (g, _44_1452) -> begin
(let gn = g.FStar_Absyn_Syntax.ident
in (fn.FStar_Absyn_Syntax.idText = gn.FStar_Absyn_Syntax.idText))
end))))
in (match (found) with
| Some (_44_1457, e) -> begin
(let _110_537 = (qfn fn)
in (_110_537, e))
end
| None -> begin
...
| None -> begin
(let _110_547 = (let _110_546 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _44_1469 -> (match (_44_1469) with
| (f, _44_1468) -> begin
...
in (let record = (let _110_552 = (let _110_551 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _44_1477 -> (match (_44_1477) with
| (f, _44_1476) -> begin
...
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_fvar (fv, _44_1500); FStar_Absyn_Syntax.tk = _44_1497; FStar_Absyn_Syntax.pos = _44_1495; FStar_Absyn_Syntax.fvs = _44_1493; FStar_Absyn_Syntax.uvs = _44_1491}, args); FStar_Absyn_Syntax.tk = _44_1489; FStar_Absyn_Syntax.pos = _44_1487; FStar_Absyn_Syntax.fvs = _44_1485; FStar_Absyn_Syntax.uvs = _44_1483}, FStar_Absyn_Syntax.Data_app)) -> begin
...
(let _44_1522 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_record_by_field_name env) f)
in (match (_44_1522) with
| (_44_1520, fieldname) -> begin
(let e = (desugar_exp env e)
in (let fn = (let _44_1527 = (FStar_Util.prefix fieldname.FStar_Absyn_Syntax.ns)
in (match (_44_1527) with
| (ns, _44_1526) -> begin
...
in (let setpos = (fun t -> (let _44_1539 = t
in {FStar_Absyn_Syntax.n = _44_1539.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _44_1539.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = top.FStar_Parser_AST.range; FStar_Absyn_Syntax.fvs = _44_1539.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _44_1539.FStar_Absyn_Syntax.uvs}))
...
| FStar_Parser_AST.Op ("*", t1::_44_1571::[]) -> begin
...
in (let args = (FStar_List.map (fun _44_1622 -> (match (_44_1622) with
| (t, imp) -> begin
...
| hd::tl -> begin
(let _44_1640 = (desugar_binding_pat env hd)
in (match (_44_1640) with
| (env, bnd, pat) -> begin
(match (pat) with
| Some (q) -> begin
...
| FStar_Parser_AST.App (_44_1646) -> begin
...
| FStar_Parser_AST.Product (binders, t) -> begin
(let _44_1670 = (uncurry binders t)
in (match (_44_1670) with
| (bs, t) -> begin
...
in (let _44_1684 = (as_binder env hd.FStar_Parser_AST.aqual bb)
in (match (_44_1684) with
| (b, env) -> begin
(aux env ((b)::bs) tl)
end))))
end))
...
| b -> begin
(let _44_1705 = (match ((as_binder env None (FStar_Util.Inr (b)))) with
| ((FStar_Util.Inr (x), _44_1697), env) -> begin
(x, env)
end
| _44_1702 -> begin
(FStar_All.failwith "impossible")
end)
in (match (_44_1705) with
| (b, env) -> begin
...
(let _44_1739 = (FStar_List.fold_left (fun _44_1724 b -> (match (_44_1724) with
| (env, tparams, typs) -> begin
(let _44_1728 = (desugar_exp_binder env b)
in (match (_44_1728) with
| (xopt, t) -> begin
(let _44_1734 = (match (xopt) with
| None -> begin
...
in (match (_44_1739) with
| (env, _44_1737, targs) -> begin
...
| FStar_Parser_AST.Record (_44_1742) -> begin
(FStar_All.failwith "Unexpected record type")
end
| (FStar_Parser_AST.If (_)) | (FStar_Parser_AST.Labeled (_)) -> begin
(desugar_formula env top)
end
| _44_1751 when (top.FStar_Parser_AST.level = FStar_Parser_AST.Formula) -> begin
(desugar_formula env top)
end
| _44_1753 -> begin
...
in (let pre_process_comp_typ = (fun t -> (let _44_1764 = (head_and_args t)
in (match (_44_1764) with
| (head, args) -> begin
...
in (let _44_1790 = (FStar_All.pipe_right args (FStar_List.partition (fun _44_1772 -> (match (_44_1772) with
| (arg, _44_1771) -> begin
(match ((let _110_674 = (unparen arg)
in _110_674.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (d); FStar_Parser_AST.range = _44_1776; FStar_Parser_AST.level = _44_1774}, _44_1781, _44_1783) -> begin
...
(let args = (FStar_List.map (fun _44_1805 -> (match (_44_1805) with
| (t, imp) -> begin
...
in (let _44_1812 = (FStar_Absyn_Util.head_and_args t)
...
| (FStar_Absyn_Syntax.Typ_const (eff), (FStar_Util.Inl (result_typ), _44_1819)::rest) -> begin
(let _44_1859 = (FStar_All.pipe_right rest (FStar_List.partition (fun _44_10 -> (match (_44_10) with
| (FStar_Util.Inr (_44_1825), _44_1828) -> begin
false
end
| (FStar_Util.Inl (t), _44_1833) -> begin
(match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_const (fv); FStar_Absyn_Syntax.tk = _44_1842; FStar_Absyn_Syntax.pos = _44_1840; FStar_Absyn_Syntax.fvs = _44_1838; FStar_Absyn_Syntax.uvs = _44_1836}, (FStar_Util.Inr (_44_1847), _44_1850)::[]) -> begin
...
in (match (_44_1859) with
| (dec, rest) -> begin
(let decreases_clause = (FStar_All.pipe_right dec (FStar_List.map (fun _44_11 -> (match (_44_11) with
| (FStar_Util.Inl (t), _44_1864) -> begin
(match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_app (_44_1867, (FStar_Util.Inr (arg), _44_1871)::[]) -> begin
...
| false -> begin
(let _110_684 = (let _110_683 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "%s is not an effect" _110_683))
in (fail _110_684))
end)
end))
end))
...
| false -> begin
(let _110_686 = (let _110_685 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "%s is not an effect" _110_685))
in (fail _110_686))
end)
end)
end))))))
and desugar_kind = (fun env k -> (let pos = (fun f -> (f k.FStar_Parser_AST.range))
in (let setpos = (fun kk -> (let _44_1890 = kk
in {FStar_Absyn_Syntax.n = _44_1890.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _44_1890.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = k.FStar_Parser_AST.range; FStar_Absyn_Syntax.fvs = _44_1890.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _44_1890.FStar_Absyn_Syntax.uvs}))
in (let k = (unparen k)
in (match (k.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Name ({FStar_Absyn_Syntax.ns = _44_1899; FStar_Absyn_Syntax.ident = _44_1897; FStar_Absyn_Syntax.nsstr = _44_1895; FStar_Absyn_Syntax.str = "Type"}) -> begin
(setpos FStar_Absyn_Syntax.mk_Kind_type)
end
| FStar_Parser_AST.Name ({FStar_Absyn_Syntax.ns = _44_1908; FStar_Absyn_Syntax.ident = _44_1906; FStar_Absyn_Syntax.nsstr = _44_1904; FStar_Absyn_Syntax.str = "Effect"}) -> begin
(setpos FStar_Absyn_Syntax.mk_Kind_effect)
end
| FStar_Parser_AST.Name (l) -> begin
(match ((let _110_698 = (FStar_Parser_DesugarEnv.qualify_lid env l)
in (FStar_Parser_DesugarEnv.find_kind_abbrev env _110_698))) with
| Some (l) -> begin
...
(let _44_1924 = (uncurry bs k)
in (match (_44_1924) with
| (bs, k) -> begin
(let rec aux = (fun env bs _44_12 -> (match (_44_12) with
| [] -> begin
(let _110_709 = (let _110_708 = (let _110_707 = (desugar_kind env k)
in ((FStar_List.rev bs), _110_707))
in (FStar_Absyn_Syntax.mk_Kind_arrow _110_708))
in (FStar_All.pipe_left pos _110_709))
end
| hd::tl -> begin
(let _44_1935 = (let _110_711 = (let _110_710 = (FStar_Parser_DesugarEnv.default_ml env)
in (desugar_binder _110_710 hd))
in (FStar_All.pipe_right _110_711 (as_binder env hd.FStar_Parser_AST.aqual)))
in (match (_44_1935) with
| (b, env) -> begin
(aux env ((b)::bs) tl)
end))
end))
...
| Some (l) -> begin
(let args = (FStar_List.map (fun _44_1945 -> (match (_44_1945) with
| (t, b) -> begin
...
in (let _110_713 = (desugar_typ_or_exp env t)
in (_110_713, qual)))
end)) args)
...
in (let setpos = (fun t -> (let _44_1965 = t
in {FStar_Absyn_Syntax.n = _44_1965.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _44_1965.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = f.FStar_Parser_AST.range; FStar_Absyn_Syntax.fvs = _44_1965.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _44_1965.FStar_Absyn_Syntax.uvs}))
in (let desugar_quant = (fun q qt b pats body -> (let tk = (desugar_binder env (let _44_1973 = b
in {FStar_Parser_AST.b = _44_1973.FStar_Parser_AST.b; FStar_Parser_AST.brange = _44_1973.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = _44_1973.FStar_Parser_AST.aqual}))
in (match (tk) with
| FStar_Util.Inl (Some (a), k) -> begin
(let _44_1983 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (match (_44_1983) with
| (env, a) -> begin
(let pats = (FStar_List.map (fun e -> (let _110_744 = (desugar_typ_or_exp env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _110_744))) pats)
...
| _44_1989 -> begin
(let _110_745 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern ((body, pats))))
in (FStar_All.pipe_left setpos _110_745))
end)
in (let body = (let _110_751 = (let _110_750 = (let _110_749 = (let _110_748 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_110_748)::[])
in (_110_749, body))
in (FStar_Absyn_Syntax.mk_Typ_lam _110_750))
in (FStar_All.pipe_left pos _110_751))
in (let _110_756 = (let _110_755 = (let _110_752 = (FStar_Absyn_Util.set_lid_range qt b.FStar_Parser_AST.brange)
in (FStar_Absyn_Util.ftv _110_752 FStar_Absyn_Syntax.kun))
in (let _110_754 = (let _110_753 = (FStar_Absyn_Syntax.targ body)
in (_110_753)::[])
in (FStar_Absyn_Util.mk_typ_app _110_755 _110_754)))
in (FStar_All.pipe_left setpos _110_756))))))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(let _44_1999 = (FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_44_1999) with
| (env, x) -> begin
(let pats = (FStar_List.map (fun e -> (let _110_758 = (desugar_typ_or_exp env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _110_758))) pats)
in (let body = (desugar_formula env body)
in (let body = (match (pats) with
| [] -> begin
body
...
in (let body = (let _110_764 = (let _110_763 = (let _110_762 = (let _110_761 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_110_761)::[])
in (_110_762, body))
in (FStar_Absyn_Syntax.mk_Typ_lam _110_763))
in (FStar_All.pipe_left pos _110_764))
in (let _110_769 = (let _110_768 = (let _110_765 = (FStar_Absyn_Util.set_lid_range q b.FStar_Parser_AST.brange)
in (FStar_Absyn_Util.ftv _110_765 FStar_Absyn_Syntax.kun))
in (let _110_767 = (let _110_766 = (FStar_Absyn_Syntax.targ body)
in (_110_766)::[])
in (FStar_Absyn_Util.mk_typ_app _110_768 _110_767)))
in (FStar_All.pipe_left setpos _110_769))))))
end))
end
| _44_2009 -> begin
(FStar_All.failwith "impossible")
...
| b::b'::_rest -> begin
(let rest = (b')::_rest
in (let body = (let _110_784 = (q (rest, pats, body))
in (let _110_783 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _110_784 _110_783 FStar_Parser_AST.Formula)))
in (let _110_785 = (q ((b)::[], [], body))
in (FStar_Parser_AST.mk_term _110_785 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _44_2023 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _110_786 = (unparen f)
in _110_786.FStar_Parser_AST.tm)) with
...
(let args = (hd)::_args
in (let args = (FStar_List.map (fun t -> (let _110_788 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _110_788))) args)
in (let eq = (match ((is_type env hd)) with
| true -> begin
(let _110_789 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.eqT_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _110_789 FStar_Absyn_Syntax.kun))
end
| false -> begin
(let _110_790 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.eq2_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _110_790 FStar_Absyn_Syntax.kun))
end)
in (FStar_Absyn_Util.mk_typ_app eq args))))
end
| FStar_Parser_AST.Op (s, args) -> begin
(match (((connective s), args)) with
| (Some (conn), _44_2049::_44_2047::[]) -> begin
(let _110_795 = (let _110_791 = (FStar_Absyn_Util.set_lid_range conn f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _110_791 FStar_Absyn_Syntax.kun))
in (let _110_794 = (FStar_List.map (fun x -> (let _110_793 = (desugar_formula env x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _110_793))) args)
in (FStar_Absyn_Util.mk_typ_app _110_795 _110_794)))
end
| _44_2054 -> begin
...
| false -> begin
(let _110_796 = (desugar_exp env f)
in (FStar_All.pipe_right _110_796 FStar_Absyn_Util.b2t))
end)
end)
end
| FStar_Parser_AST.If (f1, f2, f3) -> begin
(let _110_801 = (let _110_797 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.ite_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _110_797 FStar_Absyn_Syntax.kun))
in (let _110_800 = (FStar_List.map (fun x -> (match ((desugar_typ_or_exp env x)) with
| FStar_Util.Inl (t) -> begin
(FStar_Absyn_Syntax.targ t)
end
| FStar_Util.Inr (v) -> begin
(let _110_799 = (FStar_Absyn_Util.b2t v)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _110_799))
end)) ((f1)::(f2)::(f3)::[]))
in (FStar_Absyn_Util.mk_typ_app _110_801 _110_800)))
end
| FStar_Parser_AST.QForall (_1::_2::_3, pats, body) -> begin
(let binders = (_1)::(_2)::_3
in (let _110_803 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _110_803)))
end
| FStar_Parser_AST.QExists (_1::_2::_3, pats, body) -> begin
(let binders = (_1)::(_2)::_3
in (let _110_805 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _110_805)))
end
...
| false -> begin
(let _110_806 = (desugar_exp env f)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _110_806))
end)
end)))))))
and desugar_formula = (fun env t -> (desugar_formula' (let _44_2105 = env
in {FStar_Parser_DesugarEnv.curmodule = _44_2105.FStar_Parser_DesugarEnv.curmodule; FStar_Parser_DesugarEnv.modules = _44_2105.FStar_Parser_DesugarEnv.modules; FStar_Parser_DesugarEnv.open_namespaces = _44_2105.FStar_Parser_DesugarEnv.open_namespaces; FStar_Parser_DesugarEnv.sigaccum = _44_2105.FStar_Parser_DesugarEnv.sigaccum; FStar_Parser_DesugarEnv.localbindings = _44_2105.FStar_Parser_DesugarEnv.localbindings; FStar_Parser_DesugarEnv.recbindings = _44_2105.FStar_Parser_DesugarEnv.recbindings; FStar_Parser_DesugarEnv.phase = FStar_Parser_AST.Formula; FStar_Parser_DesugarEnv.sigmap = _44_2105.FStar_Parser_DesugarEnv.sigmap; FStar_Parser_DesugarEnv.default_result_effect = _44_2105.FStar_Parser_DesugarEnv.default_result_effect; FStar_Parser_DesugarEnv.iface = _44_2105.FStar_Parser_DesugarEnv.iface; FStar_Parser_DesugarEnv.admitted_iface = _44_2105.FStar_Parser_DesugarEnv.admitted_iface}) t))
and desugar_binder = (fun env b -> (match ((is_type_binder env b)) with
| true -> begin
(let _110_811 = (desugar_type_binder env b)
in FStar_Util.Inl (_110_811))
end
| false -> begin
(let _110_812 = (desugar_exp_binder env b)
in FStar_Util.Inr (_110_812))
end))
and typars_of_binders = (fun env bs -> (let _44_2138 = (FStar_List.fold_left (fun _44_2113 b -> (match (_44_2113) with
| (env, out) -> begin
(let tk = (desugar_binder env (let _44_2115 = b
in {FStar_Parser_AST.b = _44_2115.FStar_Parser_AST.b; FStar_Parser_AST.brange = _44_2115.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = _44_2115.FStar_Parser_AST.aqual}))
in (match (tk) with
| FStar_Util.Inl (Some (a), k) -> begin
(let _44_2125 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (match (_44_2125) with
| (env, a) -> begin
(env, ((FStar_Util.Inl ((FStar_Absyn_Util.bvd_to_bvar_s a k)), b.FStar_Parser_AST.aqual))::out)
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(let _44_2133 = (FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_44_2133) with
| (env, x) -> begin
...
in (match (_44_2138) with
| (env, tpars) -> begin
(env, (FStar_List.rev tpars))
end)))
and desugar_exp_binder = (fun env b -> (match (b.FStar_Parser_AST.b) with
| FStar_Parser_AST.Annotated (x, t) -> begin
(let _110_819 = (desugar_typ env t)
in (Some (x), _110_819))
end
| FStar_Parser_AST.TVariable (t) -> begin
(let _110_820 = (FStar_Parser_DesugarEnv.fail_or2 (FStar_Parser_DesugarEnv.try_lookup_typ_var env) t)
in (None, _110_820))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _110_821 = (desugar_typ env t)
in (None, _110_821))
end
...
and desugar_type_binder = (fun env b -> (let fail = (fun _44_2156 -> (match (()) with
| () -> begin
...
(let _110_826 = (desugar_kind env t)
in (Some (x), _110_826))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _110_827 = (desugar_kind env t)
in (None, _110_827))
end
| FStar_Parser_AST.TVariable (x) -> begin
(Some (x), (let _44_2167 = FStar_Absyn_Syntax.mk_Kind_type
in {FStar_Absyn_Syntax.n = _44_2167.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _44_2167.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = b.FStar_Parser_AST.brange; FStar_Absyn_Syntax.fvs = _44_2167.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _44_2167.FStar_Absyn_Syntax.uvs}))
end
| _44_2170 -> begin
(fail ())
end)))
...
| FStar_Absyn_Syntax.Kind_abbrev (_44_2181, k) -> begin
(aux bs k)
end
| _44_2186 -> begin
bs
end))
in (let _110_836 = (aux tps k)
in (FStar_All.pipe_right _110_836 FStar_Absyn_Util.name_binders))))
...
in (let imp_binders = (FStar_All.pipe_right binders (FStar_List.map (fun _44_2200 -> (match (_44_2200) with
| (x, _44_2199) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end))))
in (let binders = (let _110_857 = (let _110_856 = (let _110_855 = (let _110_854 = (let _110_853 = (FStar_Absyn_Util.ftv t FStar_Absyn_Syntax.kun)
in (let _110_852 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in (_110_853, _110_852)))
in (FStar_Absyn_Syntax.mk_Typ_app' _110_854 None p))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder _110_855))
in (_110_856)::[])
in (FStar_List.append imp_binders _110_857))
in (let disc_type = (let _110_860 = (let _110_859 = (let _110_858 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.bool_lid FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.total_comp _110_858 p))
in (binders, _110_859))
in (FStar_Absyn_Syntax.mk_Typ_fun _110_860 None p))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (let disc_name = (FStar_Absyn_Util.mk_discriminator d)
in (let _110_864 = (let _110_863 = (quals ((FStar_Absyn_Syntax.Logic)::(FStar_Absyn_Syntax.Discriminator (d))::[]))
in (let _110_862 = (FStar_Absyn_Syntax.range_of_lid disc_name)
in (disc_name, disc_type, _110_863, _110_862)))
in FStar_Absyn_Syntax.Sig_val_decl (_110_864)))))))))))))

let mk_indexed_projectors = (fun fvq refine_domain env _44_2212 lid formals t -> (match (_44_2212) with
| (tc, tps, k) -> begin
...
in (let projectee = (let _110_875 = (FStar_Absyn_Syntax.mk_ident ("projectee", p))
in (let _110_874 = (FStar_Absyn_Util.genident (Some (p)))
in {FStar_Absyn_Syntax.ppname = _110_875; FStar_Absyn_Syntax.realname = _110_874}))
in (let arg_exp = (FStar_Absyn_Util.bvd_to_exp projectee FStar_Absyn_Syntax.tun)
in (let arg_binder = (let arg_typ = (let _110_878 = (let _110_877 = (FStar_Absyn_Util.ftv tc FStar_Absyn_Syntax.kun)
in (let _110_876 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in (_110_877, _110_876)))
in (FStar_Absyn_Syntax.mk_Typ_app' _110_878 None p))
...
in (let _110_888 = (let _110_887 = (let _110_886 = (let _110_885 = (let _110_884 = (let _110_883 = (let _110_882 = (FStar_Absyn_Util.fvar None disc_name p)
in (let _110_881 = (let _110_880 = (let _110_879 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _110_879))
in (_110_880)::[])
in (_110_882, _110_881)))
in (FStar_Absyn_Syntax.mk_Exp_app _110_883 None p))
in (FStar_Absyn_Util.b2t _110_884))
in (x, _110_885))
in (FStar_Absyn_Syntax.mk_Typ_refine _110_886 None p))
in (FStar_All.pipe_left (FStar_Absyn_Util.bvd_to_bvar_s projectee) _110_887))
in (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder _110_888))))
end))
in (let imp_binders = (FStar_All.pipe_right binders (FStar_List.map (fun _44_2229 -> (match (_44_2229) with
| (x, _44_2228) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end))))
in (let binders = (FStar_List.append imp_binders ((arg_binder)::[]))
in (let arg = (FStar_Absyn_Util.arg_of_non_null_binder arg_binder)
in (let subst = (let _110_898 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i f -> (match ((Prims.fst f)) with
| FStar_Util.Inl (a) -> begin
(match ((FStar_All.pipe_right binders (FStar_Util.for_some (fun _44_13 -> (match (_44_13) with
| (FStar_Util.Inl (b), _44_2241) -> begin
...
| false -> begin
(let _44_2248 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (match (_44_2248) with
| (field_name, _44_2247) -> begin
(let proj = (let _110_894 = (let _110_893 = (FStar_Absyn_Util.ftv field_name FStar_Absyn_Syntax.kun)
in (_110_893, (arg)::[]))
in (FStar_Absyn_Syntax.mk_Typ_app _110_894 None p))
in (FStar_Util.Inl ((a.FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end
| FStar_Util.Inr (x) -> begin
(match ((FStar_All.pipe_right binders (FStar_Util.for_some (fun _44_14 -> (match (_44_14) with
| (FStar_Util.Inr (y), _44_2256) -> begin
...
| false -> begin
(let _44_2263 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (match (_44_2263) with
| (field_name, _44_2262) -> begin
(let proj = (let _110_897 = (let _110_896 = (FStar_Absyn_Util.fvar None field_name p)
in (_110_896, (arg)::[]))
in (FStar_Absyn_Syntax.mk_Exp_app _110_897 None p))
in (FStar_Util.Inr ((x.FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end))))
in (FStar_All.pipe_right _110_898 FStar_List.flatten))
in (let ntps = (FStar_List.length tps)
in (let _110_936 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i ax -> (match ((Prims.fst ax)) with
| FStar_Util.Inl (a) -> begin
(let _44_2274 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (match (_44_2274) with
| (field_name, _44_2273) -> begin
(let kk = (let _110_902 = (let _110_901 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (binders, _110_901))
in (FStar_Absyn_Syntax.mk_Kind_arrow _110_902 p))
in (let _110_905 = (let _110_904 = (let _110_903 = (FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, [], kk, [], [], (FStar_Absyn_Syntax.Logic)::(FStar_Absyn_Syntax.Projector ((lid, FStar_Util.Inl (a.FStar_Absyn_Syntax.v))))::[], _110_903))
in FStar_Absyn_Syntax.Sig_tycon (_110_904))
in (_110_905)::[]))
end))
end
| FStar_Util.Inr (x) -> begin
(let _44_2281 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (match (_44_2281) with
| (field_name, _44_2280) -> begin
(let t = (let _110_908 = (let _110_907 = (let _110_906 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Absyn_Util.total_comp _110_906 p))
in (binders, _110_907))
in (FStar_Absyn_Syntax.mk_Typ_fun _110_908 None p))
...
in (let impl = (match ((((let _110_911 = (FStar_Parser_DesugarEnv.current_module env)
in (FStar_Absyn_Syntax.lid_equals FStar_Absyn_Const.prims_lid _110_911)) || (fvq <> FStar_Absyn_Syntax.Data_ctor)) || (FStar_ST.read FStar_Options.__temp_no_proj))) with
| true -> begin
[]
end
| false -> begin
(let projection = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.tun)
in (let as_imp = (fun _44_15 -> (match (_44_15) with
...
in (let arg_pats = (let _110_926 = (FStar_All.pipe_right formals (FStar_List.mapi (fun j by -> (match (by) with
| (FStar_Util.Inl (_44_2296), imp) -> begin
(match ((j < ntps)) with
| true -> begin
[]
end
| false -> begin
(let _110_919 = (let _110_918 = (let _110_917 = (let _110_916 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.kun)
in FStar_Absyn_Syntax.Pat_tvar (_110_916))
in (pos _110_917))
in (_110_918, (as_imp imp)))
in (_110_919)::[])
end)
end
| (FStar_Util.Inr (_44_2301), imp) -> begin
(match ((i = j)) with
| true -> begin
(let _110_921 = (let _110_920 = (pos (FStar_Absyn_Syntax.Pat_var (projection)))
in (_110_920, (as_imp imp)))
in (_110_921)::[])
end
| false -> begin
(let _110_925 = (let _110_924 = (let _110_923 = (let _110_922 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.tun)
in FStar_Absyn_Syntax.Pat_wild (_110_922))
in (pos _110_923))
in (_110_924, (as_imp imp)))
in (_110_925)::[])
end)
end))))
in (FStar_All.pipe_right _110_926 FStar_List.flatten))
in (let pat = (let _110_931 = (let _110_929 = (let _110_928 = (let _110_927 = (FStar_Absyn_Util.fv lid)
in (_110_927, Some (fvq), arg_pats))
in FStar_Absyn_Syntax.Pat_cons (_110_928))
in (FStar_All.pipe_right _110_929 pos))
in (let _110_930 = (FStar_Absyn_Util.bvar_to_exp projection)
in (_110_931, None, _110_930)))
in (let body = (FStar_Absyn_Syntax.mk_Exp_match (arg_exp, (pat)::[]) None p)
in (let imp = (let _110_932 = (FStar_Absyn_Syntax.range_of_lid field_name)
in (FStar_Absyn_Syntax.mk_Exp_abs (binders, body) None _110_932))
...
in (let _110_935 = (let _110_934 = (let _110_933 = (FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, t, quals, _110_933))
in FStar_Absyn_Syntax.Sig_val_decl (_110_934))
in (_110_935)::impl)))))
end))
end))))
...
let mk_data_projectors = (fun env _44_18 -> (match (_44_18) with
| FStar_Absyn_Syntax.Sig_datacon (lid, t, tycon, quals, _44_2318, _44_2320) when (not ((FStar_Absyn_Syntax.lid_equals lid FStar_Absyn_Const.lexcons_lid))) -> begin
(let refine_domain = (match ((FStar_All.pipe_right quals (FStar_Util.for_some (fun _44_16 -> (match (_44_16) with
| FStar_Absyn_Syntax.RecordConstructor (_44_2325) -> begin
true
end
| _44_2328 -> begin
false
...
| false -> begin
(let _44_2334 = tycon
in (match (_44_2334) with
| (l, _44_2331, _44_2333) -> begin
...
in (let qual = (match ((FStar_Util.find_map quals (fun _44_17 -> (match (_44_17) with
...
let rec desugar_tycon = (fun env rng quals tcs -> (let tycon_id = (fun _44_19 -> (match (_44_19) with
| (FStar_Parser_AST.TyconAbstract (id, _, _)) | (FStar_Parser_AST.TyconAbbrev (id, _, _, _)) | (FStar_Parser_AST.TyconRecord (id, _, _, _)) | (FStar_Parser_AST.TyconVariant (id, _, _, _)) -> begin
id
end))
in (let binder_to_term = (fun b -> (match (b.FStar_Parser_AST.b) with
| (FStar_Parser_AST.Annotated (x, _)) | (FStar_Parser_AST.Variable (x)) -> begin
(let _110_956 = (let _110_955 = (FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_110_955))
in (FStar_Parser_AST.mk_term _110_956 x.FStar_Absyn_Syntax.idRange FStar_Parser_AST.Expr))
end
...
in (let apply_binders = (fun t binders -> (FStar_List.fold_left (fun out b -> (let _110_967 = (let _110_966 = (let _110_965 = (binder_to_term b)
in (out, _110_965, FStar_Parser_AST.Nothing))
in FStar_Parser_AST.App (_110_966))
in (FStar_Parser_AST.mk_term _110_967 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders))
in (let tycon_record_as_variant = (fun _44_20 -> (match (_44_20) with
...
in (let mfields = (FStar_List.map (fun _44_2429 -> (match (_44_2429) with
| (x, t) -> begin
(let _110_973 = (let _110_972 = (let _110_971 = (FStar_Absyn_Util.mangle_field_name x)
in (_110_971, t))
in FStar_Parser_AST.Annotated (_110_972))
in (FStar_Parser_AST.mk_binder _110_973 x.FStar_Absyn_Syntax.idRange FStar_Parser_AST.Expr None))
end)) fields)
in (let result = (let _110_976 = (let _110_975 = (let _110_974 = (FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_110_974))
in (FStar_Parser_AST.mk_term _110_975 id.FStar_Absyn_Syntax.idRange FStar_Parser_AST.Type))
in (apply_binders _110_976 parms))
...
in (let _110_978 = (FStar_All.pipe_right fields (FStar_List.map (fun _44_2436 -> (match (_44_2436) with
| (x, _44_2435) -> begin
(FStar_Parser_DesugarEnv.qualify env x)
end))))
in (FStar_Parser_AST.TyconVariant ((id, parms, kopt, ((constrName, Some (constrTyp), false))::[])), _110_978))))))
end
| _44_2438 -> begin
(FStar_All.failwith "impossible")
end))
in (let desugar_abstract_tc = (fun quals _env mutuals _44_21 -> (match (_44_21) with
| FStar_Parser_AST.TyconAbstract (id, binders, kopt) -> begin
(let _44_2452 = (typars_of_binders _env binders)
in (match (_44_2452) with
| (_env', typars) -> begin
...
in (let tconstr = (let _110_989 = (let _110_988 = (let _110_987 = (FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_110_987))
in (FStar_Parser_AST.mk_term _110_988 id.FStar_Absyn_Syntax.idRange FStar_Parser_AST.Type))
in (apply_binders _110_989 binders))
...
in (let push_tparam = (fun env _44_22 -> (match (_44_22) with
| (FStar_Util.Inr (x), _44_2470) -> begin
(FStar_Parser_DesugarEnv.push_bvvdef env x.FStar_Absyn_Syntax.v)
end
| (FStar_Util.Inl (a), _44_2475) -> begin
(FStar_Parser_DesugarEnv.push_btvdef env a.FStar_Absyn_Syntax.v)
end))
in (let push_tparams = (FStar_List.fold_left push_tparam)
in (match (tcs) with
| FStar_Parser_AST.TyconAbstract (_44_2479)::[] -> begin
(let tc = (FStar_List.hd tcs)
in (let _44_2490 = (desugar_abstract_tc quals env [] tc)
in (match (_44_2490) with
| (_44_2484, _44_2486, se, _44_2489) -> begin
(let env = (FStar_Parser_DesugarEnv.push_sigelt env se)
in (env, (se)::[]))
end)))
end
| FStar_Parser_AST.TyconAbbrev (id, binders, kopt, t)::[] -> begin
(let _44_2501 = (typars_of_binders env binders)
in (match (_44_2501) with
| (env', typars) -> begin
(let k = (match (kopt) with
| None -> begin
(match ((FStar_Util.for_some (fun _44_23 -> (match (_44_23) with
...
in (let t0 = t
in (let quals = (match ((FStar_All.pipe_right quals (FStar_Util.for_some (fun _44_24 -> (match (_44_24) with
...
in (let _110_1001 = (let _110_1000 = (FStar_Parser_DesugarEnv.qualify env id)
in (let _110_999 = (FStar_All.pipe_right quals (FStar_List.filter (fun _44_25 -> (match (_44_25) with
| FStar_Absyn_Syntax.Effect -> begin
false
end
| _44_2520 -> begin
...
in (_110_1000, typars, c, _110_999, rng)))
in FStar_Absyn_Syntax.Sig_effect_abbrev (_110_1001)))
end
| false -> begin
(let t = (desugar_typ env' t)
in (let _110_1003 = (let _110_1002 = (FStar_Parser_DesugarEnv.qualify env id)
in (_110_1002, typars, k, t, quals, rng))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_110_1003)))
end)
in (let env = (FStar_Parser_DesugarEnv.push_sigelt env se)
in (env, (se)::[]))))))
end))
end
| FStar_Parser_AST.TyconRecord (_44_2525)::[] -> begin
(let trec = (FStar_List.hd tcs)
in (let _44_2531 = (tycon_record_as_variant trec)
in (match (_44_2531) with
| (t, fs) -> begin
(desugar_tycon env rng ((FStar_Absyn_Syntax.RecordType (fs))::quals) ((t)::[]))
end)))
end
| _44_2535::_44_2533 -> begin
(let env0 = env
in (let mutuals = (FStar_List.map (fun x -> (FStar_All.pipe_left (FStar_Parser_DesugarEnv.qualify env) (tycon_id x))) tcs)
in (let rec collect_tcs = (fun quals et tc -> (let _44_2546 = et
in (match (_44_2546) with
| (env, tcs) -> begin
(match (tc) with
| FStar_Parser_AST.TyconRecord (_44_2548) -> begin
(let trec = tc
in (let _44_2553 = (tycon_record_as_variant trec)
...
(let _44_2567 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract ((id, binders, kopt))))
in (match (_44_2567) with
| (env, (_44_2562, tps), se, tconstr) -> begin
(env, (FStar_Util.Inl ((se, tps, constructors, tconstr, quals)))::tcs)
end))
end
| FStar_Parser_AST.TyconAbbrev (id, binders, kopt, t) -> begin
(let _44_2581 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract ((id, binders, kopt))))
in (match (_44_2581) with
| (env, (_44_2576, tps), se, tconstr) -> begin
...
in (let _44_2586 = (FStar_List.fold_left (collect_tcs quals) (env, []) tcs)
in (match (_44_2586) with
| (env, tcs) -> begin
(let tcs = (FStar_List.rev tcs)
in (let sigelts = (FStar_All.pipe_right tcs (FStar_List.collect (fun _44_27 -> (match (_44_27) with
| FStar_Util.Inr (FStar_Absyn_Syntax.Sig_tycon (id, tpars, k, _44_2593, _44_2595, _44_2597, _44_2599), tps, t, quals) -> begin
(let env_tps = (push_tparams env tps)
in (let t = (desugar_typ env_tps t)
in (FStar_Absyn_Syntax.Sig_typ_abbrev ((id, tpars, k, t, [], rng)))::[]))
end
| FStar_Util.Inl (FStar_Absyn_Syntax.Sig_tycon (tname, tpars, k, mutuals, _44_2614, tags, _44_2617), tps, constrs, tconstr, quals) -> begin
(let tycon = (tname, tpars, k)
in (let env_tps = (push_tparams env tps)
in (let _44_2653 = (let _110_1022 = (FStar_All.pipe_right constrs (FStar_List.map (fun _44_2631 -> (match (_44_2631) with
...
in (let t = (let _110_1014 = (FStar_Parser_DesugarEnv.default_total env_tps)
in (let _110_1013 = (close env_tps t)
in (desugar_typ _110_1014 _110_1013)))
in (let name = (FStar_Parser_DesugarEnv.qualify env id)
in (let quals = (FStar_All.pipe_right tags (FStar_List.collect (fun _44_26 -> (match (_44_26) with
...
in (let _110_1021 = (let _110_1020 = (let _110_1019 = (let _110_1018 = (let _110_1017 = (FStar_List.map (fun _44_2650 -> (match (_44_2650) with
| (x, _44_2649) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _110_1017 t))
in (FStar_All.pipe_right _110_1018 FStar_Absyn_Util.name_function_binders))
in (name, _110_1019, tycon, quals, mutuals, rng))
in FStar_Absyn_Syntax.Sig_datacon (_110_1020))
in (name, _110_1021))))))
end))))
in (FStar_All.pipe_left FStar_List.split _110_1022))
in (match (_44_2653) with
...
in (let bundle = (let _110_1024 = (let _110_1023 = (FStar_List.collect FStar_Absyn_Util.lids_of_sigelt sigelts)
in (sigelts, quals, _110_1023, rng))
in FStar_Absyn_Syntax.Sig_bundle (_110_1024))
...
in (let discs = (FStar_All.pipe_right sigelts (FStar_List.collect (fun _44_28 -> (match (_44_28) with
| FStar_Absyn_Syntax.Sig_tycon (tname, tps, k, _44_2665, constrs, quals, _44_2669) -> begin
...
let desugar_binders = (fun env binders -> (let _44_2704 = (FStar_List.fold_left (fun _44_2682 b -> (match (_44_2682) with
| (env, binders) -> begin
(match ((desugar_binder env b)) with
| FStar_Util.Inl (Some (a), k) -> begin
(let _44_2691 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (match (_44_2691) with
| (env, a) -> begin
(let _110_1033 = (let _110_1032 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_110_1032)::binders)
in (env, _110_1033))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(let _44_2699 = (FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_44_2699) with
| (env, x) -> begin
(let _110_1035 = (let _110_1034 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_110_1034)::binders)
in (env, _110_1035))
end))
end
| _44_2701 -> begin
...
(match ((let _110_1041 = (let _110_1040 = (desugar_exp_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let ((isrec, lets, (FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Absyn_Syntax.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr)))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Absyn_Util.compress_exp _110_1040))
in _110_1041.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Exp_let (lbs, _44_2723) -> begin
...
in (let quals = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun _44_29 -> (match (_44_29) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_44_2740); FStar_Absyn_Syntax.lbtyp = _44_2738; FStar_Absyn_Syntax.lbeff = _44_2736; FStar_Absyn_Syntax.lbdef = _44_2734} -> begin
[]
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = _44_2748; FStar_Absyn_Syntax.lbeff = _44_2746; FStar_Absyn_Syntax.lbdef = _44_2744} -> begin
...
in (let _110_1047 = (let _110_1046 = (let _110_1045 = (let _110_1044 = (FStar_Parser_DesugarEnv.qualify env id)
in (_110_1044, f, (FStar_Absyn_Syntax.Assumption)::[], d.FStar_Parser_AST.drange))
in FStar_Absyn_Syntax.Sig_assume (_110_1045))
in (_110_1046)::[])
in (env, _110_1047)))
end
| FStar_Parser_AST.Val (quals, id, t) -> begin
(let t = (let _110_1048 = (close_fun env t)
in (desugar_typ env _110_1048))
...
in (let se = (let _110_1050 = (let _110_1049 = (FStar_Parser_DesugarEnv.qualify env id)
in (_110_1049, t, quals, d.FStar_Parser_AST.drange))
in FStar_Absyn_Syntax.Sig_val_decl (_110_1050))
in (let env = (FStar_Parser_DesugarEnv.push_sigelt env se)
in (env, (se)::[])))))
end
...
in (let t = (let _110_1055 = (let _110_1054 = (let _110_1051 = (FStar_Absyn_Syntax.null_v_binder t)
in (_110_1051)::[])
in (let _110_1053 = (let _110_1052 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) FStar_Absyn_Const.exn_lid)
in (FStar_Absyn_Syntax.mk_Total _110_1052))
in (_110_1054, _110_1053)))
in (FStar_Absyn_Syntax.mk_Typ_fun _110_1055 None d.FStar_Parser_AST.drange))
in (let l = (FStar_Parser_DesugarEnv.qualify env id)
in (let se = FStar_Absyn_Syntax.Sig_datacon ((l, t, (FStar_Absyn_Const.exn_lid, [], FStar_Absyn_Syntax.ktype), (FStar_Absyn_Syntax.ExceptionConstructor)::[], (FStar_Absyn_Const.exn_lid)::[], d.FStar_Parser_AST.drange))
in (let se' = FStar_Absyn_Syntax.Sig_bundle (((se)::[], (FStar_Absyn_Syntax.ExceptionConstructor)::[], (l)::[], d.FStar_Parser_AST.drange))
in (let env = (FStar_Parser_DesugarEnv.push_sigelt env se')
...
(let _44_2809 = (desugar_binders env binders)
in (match (_44_2809) with
| (env_k, binders) -> begin
...
(let env0 = env
in (let _44_2825 = (desugar_binders env eff_binders)
in (match (_44_2825) with
| (env, binders) -> begin
(let defn = (desugar_typ env defn)
in (let _44_2829 = (FStar_Absyn_Util.head_and_args defn)
in (match (_44_2829) with
| (head, args) -> begin
...
| None -> begin
(let _110_1060 = (let _110_1059 = (let _110_1058 = (let _110_1057 = (let _110_1056 = (FStar_Absyn_Print.sli eff.FStar_Absyn_Syntax.v)
in (Prims.strcat "Effect " _110_1056))
in (Prims.strcat _110_1057 " not found"))
in (_110_1058, d.FStar_Parser_AST.drange))
in FStar_Absyn_Syntax.Error (_110_1059))
in (Prims.raise _110_1060))
end
| Some (ed) -> begin
(let subst = (FStar_Absyn_Util.subst_of_list ed.FStar_Absyn_Syntax.binders args)
in (let sub = (FStar_Absyn_Util.subst_typ subst)
in (let ed = (let _110_1077 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _110_1076 = (FStar_Absyn_Util.subst_kind subst ed.FStar_Absyn_Syntax.signature)
in (let _110_1075 = (sub ed.FStar_Absyn_Syntax.ret)
in (let _110_1074 = (sub ed.FStar_Absyn_Syntax.bind_wp)
in (let _110_1073 = (sub ed.FStar_Absyn_Syntax.bind_wlp)
in (let _110_1072 = (sub ed.FStar_Absyn_Syntax.if_then_else)
in (let _110_1071 = (sub ed.FStar_Absyn_Syntax.ite_wp)
in (let _110_1070 = (sub ed.FStar_Absyn_Syntax.ite_wlp)
in (let _110_1069 = (sub ed.FStar_Absyn_Syntax.wp_binop)
in (let _110_1068 = (sub ed.FStar_Absyn_Syntax.wp_as_type)
in (let _110_1067 = (sub ed.FStar_Absyn_Syntax.close_wp)
in (let _110_1066 = (sub ed.FStar_Absyn_Syntax.close_wp_t)
in (let _110_1065 = (sub ed.FStar_Absyn_Syntax.assert_p)
in (let _110_1064 = (sub ed.FStar_Absyn_Syntax.assume_p)
in (let _110_1063 = (sub ed.FStar_Absyn_Syntax.null_wp)
in (let _110_1062 = (sub ed.FStar_Absyn_Syntax.trivial)
in {FStar_Absyn_Syntax.mname = _110_1077; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = quals; FStar_Absyn_Syntax.signature = _110_1076; FStar_Absyn_Syntax.ret = _110_1075; FStar_Absyn_Syntax.bind_wp = _110_1074; FStar_Absyn_Syntax.bind_wlp = _110_1073; FStar_Absyn_Syntax.if_then_else = _110_1072; FStar_Absyn_Syntax.ite_wp = _110_1071; FStar_Absyn_Syntax.ite_wlp = _110_1070; FStar_Absyn_Syntax.wp_binop = _110_1069; FStar_Absyn_Syntax.wp_as_type = _110_1068; FStar_Absyn_Syntax.close_wp = _110_1067; FStar_Absyn_Syntax.close_wp_t = _110_1066; FStar_Absyn_Syntax.assert_p = _110_1065; FStar_Absyn_Syntax.assume_p = _110_1064; FStar_Absyn_Syntax.null_wp = _110_1063; FStar_Absyn_Syntax.trivial = _110_1062}))))))))))))))))
...
| _44_2841 -> begin
(let _110_1081 = (let _110_1080 = (let _110_1079 = (let _110_1078 = (FStar_Absyn_Print.typ_to_string head)
in (Prims.strcat _110_1078 " is not an effect"))
in (_110_1079, d.FStar_Parser_AST.drange))
in FStar_Absyn_Syntax.Error (_110_1080))
in (Prims.raise _110_1081))
end)
end)))
end)))
end
...
in (let _44_2855 = (desugar_binders env eff_binders)
in (match (_44_2855) with
| (env, binders) -> begin
(let eff_k = (desugar_kind env eff_kind)
in (let _44_2866 = (FStar_All.pipe_right eff_decls (FStar_List.fold_left (fun _44_2859 decl -> (match (_44_2859) with
| (env, out) -> begin
(let _44_2863 = (desugar_decl env decl)
in (match (_44_2863) with
| (env, ses) -> begin
(let _110_1085 = (let _110_1084 = (FStar_List.hd ses)
in (_110_1084)::out)
in (env, _110_1085))
end))
end)) (env, [])))
in (match (_44_2866) with
| (env, decls) -> begin
(let decls = (FStar_List.rev decls)
in (let lookup = (fun s -> (match ((let _110_1089 = (let _110_1088 = (FStar_Absyn_Syntax.mk_ident (s, d.FStar_Parser_AST.drange))
in (FStar_Parser_DesugarEnv.qualify env _110_1088))
in (FStar_Parser_DesugarEnv.try_resolve_typ_abbrev env _110_1089))) with
| None -> begin
...
in (let ed = (let _110_1104 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _110_1103 = (lookup "return")
in (let _110_1102 = (lookup "bind_wp")
in (let _110_1101 = (lookup "bind_wlp")
in (let _110_1100 = (lookup "if_then_else")
in (let _110_1099 = (lookup "ite_wp")
in (let _110_1098 = (lookup "ite_wlp")
in (let _110_1097 = (lookup "wp_binop")
in (let _110_1096 = (lookup "wp_as_type")
in (let _110_1095 = (lookup "close_wp")
in (let _110_1094 = (lookup "close_wp_t")
in (let _110_1093 = (lookup "assert_p")
in (let _110_1092 = (lookup "assume_p")
in (let _110_1091 = (lookup "null_wp")
in (let _110_1090 = (lookup "trivial")
in {FStar_Absyn_Syntax.mname = _110_1104; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = quals; FStar_Absyn_Syntax.signature = eff_k; FStar_Absyn_Syntax.ret = _110_1103; FStar_Absyn_Syntax.bind_wp = _110_1102; FStar_Absyn_Syntax.bind_wlp = _110_1101; FStar_Absyn_Syntax.if_then_else = _110_1100; FStar_Absyn_Syntax.ite_wp = _110_1099; FStar_Absyn_Syntax.ite_wlp = _110_1098; FStar_Absyn_Syntax.wp_binop = _110_1097; FStar_Absyn_Syntax.wp_as_type = _110_1096; FStar_Absyn_Syntax.close_wp = _110_1095; FStar_Absyn_Syntax.close_wp_t = _110_1094; FStar_Absyn_Syntax.assert_p = _110_1093; FStar_Absyn_Syntax.assume_p = _110_1092; FStar_Absyn_Syntax.null_wp = _110_1091; FStar_Absyn_Syntax.trivial = _110_1090})))))))))))))))
in (let se = FStar_Absyn_Syntax.Sig_new_effect ((ed, d.FStar_Parser_AST.drange))
in (let env = (FStar_Parser_DesugarEnv.push_sigelt env0 se)
in (env, (se)::[]))))))
end)))
...
| None -> begin
(let _110_1111 = (let _110_1110 = (let _110_1109 = (let _110_1108 = (let _110_1107 = (FStar_Absyn_Print.sli l)
in (Prims.strcat "Effect name " _110_1107))
in (Prims.strcat _110_1108 " not found"))
in (_110_1109, d.FStar_Parser_AST.drange))
in FStar_Absyn_Syntax.Error (_110_1110))
in (Prims.raise _110_1111))
end
| Some (l) -> begin
l
end))
...
let desugar_decls = (fun env decls -> (FStar_List.fold_left (fun _44_2891 d -> (match (_44_2891) with
| (env, sigelts) -> begin
(let _44_2895 = (desugar_decl env d)
in (match (_44_2895) with
| (env, se) -> begin
...
| true -> begin
(let _110_1128 = (let _110_1127 = (let _110_1125 = (FStar_Absyn_Syntax.lid_of_ids mname.FStar_Absyn_Syntax.ns)
in FStar_Parser_AST.Open (_110_1125))
in (let _110_1126 = (FStar_Absyn_Syntax.range_of_lid mname)
in (FStar_Parser_AST.mk_decl _110_1127 _110_1126)))
in (_110_1128)::d)
end
| false -> begin
d
...
| Some (prev_mod, _44_2906) -> begin
(FStar_Parser_DesugarEnv.finish_module_or_interface env prev_mod)
end)
in (let _44_2923 = (match (m) with
| FStar_Parser_AST.Interface (mname, decls, admitted) -> begin
(let _110_1130 = (FStar_Parser_DesugarEnv.prepare_module_or_interface true admitted env mname)
in (let _110_1129 = (open_ns mname decls)
in (_110_1130, mname, _110_1129, true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _110_1132 = (FStar_Parser_DesugarEnv.prepare_module_or_interface false false env mname)
in (let _110_1131 = (open_ns mname decls)
in (_110_1132, mname, _110_1131, false)))
end)
in (match (_44_2923) with
| (env, mname, decls, intf) -> begin
(let _44_2926 = (desugar_decls env decls)
...
(match (m) with
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _110_1139 = (let _110_1138 = (let _110_1137 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_Util.for_some (fun m -> (m = mname.FStar_Absyn_Syntax.str)) _110_1137))
in (mname, decls, _110_1138))
in FStar_Parser_AST.Interface (_110_1139))
end
| FStar_Parser_AST.Interface (mname, _44_2938, _44_2940) -> begin
...
let desugar_modul = (fun env m -> (let _44_2948 = (desugar_modul_common None env m)
in (match (_44_2948) with
| (env, modul) -> begin
(let env = (FStar_Parser_DesugarEnv.finish_module_or_interface env modul)
in (let _44_2950 = (match ((FStar_Options.should_dump modul.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str)) with
| true -> begin
(let _110_1144 = (FStar_Absyn_Print.modul_to_string modul)
...
let desugar_file = (fun env f -> (let _44_2963 = (FStar_List.fold_left (fun _44_2956 m -> (match (_44_2956) with
| (env, mods) -> begin
(let _44_2960 = (desugar_modul env m)
in (match (_44_2960) with
| (env, m) -> begin
(env, (m)::mods)
end))
end)) (env, []) f)
in (match (_44_2963) with
| (env, mods) -> begin
...
in (let en = (FStar_List.fold_left FStar_Parser_DesugarEnv.push_sigelt (let _44_2967 = en
in {FStar_Parser_DesugarEnv.curmodule = Some (m.FStar_Absyn_Syntax.name); FStar_Parser_DesugarEnv.modules = _44_2967.FStar_Parser_DesugarEnv.modules; FStar_Parser_DesugarEnv.open_namespaces = _44_2967.FStar_Parser_DesugarEnv.open_namespaces; FStar_Parser_DesugarEnv.sigaccum = _44_2967.FStar_Parser_DesugarEnv.sigaccum; FStar_Parser_DesugarEnv.localbindings = _44_2967.FStar_Parser_DesugarEnv.localbindings; FStar_Parser_DesugarEnv.recbindings = _44_2967.FStar_Parser_DesugarEnv.recbindings; FStar_Parser_DesugarEnv.phase = _44_2967.FStar_Parser_DesugarEnv.phase; FStar_Parser_DesugarEnv.sigmap = _44_2967.FStar_Parser_DesugarEnv.sigmap; FStar_Parser_DesugarEnv.default_result_effect = _44_2967.FStar_Parser_DesugarEnv.default_result_effect; FStar_Parser_DesugarEnv.iface = _44_2967.FStar_Parser_DesugarEnv.iface; FStar_Parser_DesugarEnv.admitted_iface = _44_2967.FStar_Parser_DesugarEnv.admitted_iface}) m.FStar_Absyn_Syntax.exports)
