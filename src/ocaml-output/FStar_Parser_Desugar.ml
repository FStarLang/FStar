...
(let _150_453 = (let _150_452 = (let _150_451 = (let _150_450 = (desugar_exp env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let ((false, (((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range), t1))::[], t2))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
...
| None -> begin
(let _150_531 = (let _150_530 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _60_1528 -> (match (_60_1528) with
| (f, _60_1527) -> begin
...
let record = (let _150_536 = (let _150_535 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _60_1536 -> (match (_60_1536) with
| (f, _60_1535) -> begin
...
let _60_2014 = (let _150_699 = (let _150_698 = (FStar_Parser_DesugarEnv.default_ml env)
...
let all_params = (let _150_888 = (FStar_All.pipe_right tps (FStar_List.map (fun _60_2350 -> (match (_60_2350) with
| (b, _60_2349) -> begin
(b, Some (imp_tag))
end))))
...
in (let _150_959 = (FStar_All.pipe_right fields (FStar_List.map (fun _60_2529 -> (match (_60_2529) with
| (x, _60_2528) -> begin
...
let _60_2584 = (let _150_980 = (FStar_Range.string_of_range rng)
...
let _60_2739 = (let _150_1004 = (FStar_All.pipe_right constrs (FStar_List.map (fun _60_2721 -> (match (_60_2721) with
