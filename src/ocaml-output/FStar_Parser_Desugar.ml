...
let r = (fun l -> (let _159_51 = (FStar_Ident.set_lid_range l rng)
in Some (_159_51)))
in (
...
in (match ((let _159_54 = (compile_op_lid arity s rng)
in (FStar_Parser_DesugarEnv.try_lookup_lid env _159_54))) with
...
let r = (fun l -> (let _159_65 = (FStar_Ident.set_lid_range l rng)
in Some (_159_65)))
in (match (s) with
| "~" -> begin
...
| s -> begin
(match ((let _159_66 = (compile_op_lid arity s rng)
in (FStar_Parser_DesugarEnv.try_lookup_typ_name env _159_66))) with
...
(match ((let _159_73 = (unparen t)
in _159_73.FStar_Parser_AST.tm)) with
...
(let _159_78 = (FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (FStar_All.pipe_right _159_78 Prims.fst))
end
| _62_346 -> begin
env
end)
...
(match ((let _159_81 = (unparen t)
in _159_81.FStar_Parser_AST.tm)) with
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _159_92 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _159_92)))
...
(let _159_99 = (free_type_vars env term)
in ((env), (_159_99)))
end
...
(let _159_100 = (free_type_vars env t)
in ((env), (_159_100)))
end))
and free_type_vars : FStar_Parser_DesugarEnv.env  ->  FStar_Parser_AST.term  ->  FStar_Ident.ident Prims.list = (fun env t -> (match ((let _159_103 = (unparen t)
in _159_103.FStar_Parser_AST.tm)) with
...
(let _159_106 = (free_type_vars env t1)
in (let _159_105 = (free_type_vars env t2)
in (FStar_List.append _159_106 _159_105)))
end
...
| (env, f) -> begin
(let _159_107 = (free_type_vars env t)
in (FStar_List.append f _159_107))
end))
end
...
| (env, free) -> begin
(let _159_110 = (free_type_vars env body)
in (FStar_List.append free _159_110))
end))
end
...
let rec aux = (fun args t -> (match ((let _159_117 = (unparen t)
in _159_117.FStar_Parser_AST.tm)) with
...
let ftv = (let _159_122 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _159_122))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _159_126 = (let _159_125 = (let _159_124 = (kind_star x.FStar_Ident.idRange)
in ((x), (_159_124)))
in FStar_Parser_AST.TAnnotated (_159_125))
in (FStar_Parser_AST.mk_binder _159_126 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _159_131 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _159_131))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _159_135 = (let _159_134 = (let _159_133 = (kind_star x.FStar_Ident.idRange)
in ((x), (_159_133)))
in FStar_Parser_AST.TAnnotated (_159_134))
in (FStar_Parser_AST.mk_binder _159_135 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (

let t = (match ((let _159_136 = (unlabel t)
in _159_136.FStar_Parser_AST.tm)) with
...
(let _159_150 = (let _159_149 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_149))
in ((_159_150), (args), (None)))
end
...
(let _159_203 = (FStar_Absyn_Syntax.null_t_binder k)
in ((_159_203), (env)))
end
| FStar_Util.Inr (None, t) -> begin
(let _159_204 = (FStar_Absyn_Syntax.null_v_binder t)
in ((_159_204), (env)))
end
...
| _62_773 -> begin
(let _159_215 = (FStar_Range.string_of_range f.FStar_Parser_AST.range)
in (FStar_Util.format2 "%s at %s" tag _159_215))
end)
...
(let _159_219 = (let _159_218 = (aux g)
in FStar_Parser_AST.Paren (_159_218))
in (FStar_Parser_AST.mk_term _159_219 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.Op ("/\\", (f1)::(f2)::[]) -> begin
(let _159_225 = (let _159_224 = (let _159_223 = (let _159_222 = (aux f1)
in (let _159_221 = (let _159_220 = (aux f2)
in (_159_220)::[])
in (_159_222)::_159_221))
in (("/\\"), (_159_223)))
in FStar_Parser_AST.Op (_159_224))
in (FStar_Parser_AST.mk_term _159_225 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.If (f1, f2, f3) -> begin
(let _159_229 = (let _159_228 = (let _159_227 = (aux f2)
in (let _159_226 = (aux f3)
in ((f1), (_159_227), (_159_226))))
in FStar_Parser_AST.If (_159_228))
in (FStar_Parser_AST.mk_term _159_229 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.Abs (binders, g) -> begin
(let _159_232 = (let _159_231 = (let _159_230 = (aux g)
in ((binders), (_159_230)))
in FStar_Parser_AST.Abs (_159_231))
in (FStar_Parser_AST.mk_term _159_232 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| _62_795 -> begin
(label f)
end))
...
let _62_879 = (let _159_304 = (FStar_Absyn_Syntax.pat_vars pat)
in (Prims.ignore _159_304))
...
(let _159_306 = (let _159_305 = (desugar_kind env t)
in ((x), (_159_305), (aq)))
in TBinder (_159_306))
end
...
in (let _159_308 = (let _159_307 = (desugar_typ env t)
in ((x), (_159_307), (aq)))
in VBinder (_159_308)))
end)
...
in (let _159_309 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_twild ((FStar_Absyn_Util.bvd_to_bvar_s a FStar_Absyn_Syntax.kun))))
in ((loc), (env), (TBinder (((a), (FStar_Absyn_Syntax.kun), (aq)))), (_159_309), (imp))))
end else begin
(
...
| (loc, env, abvd) -> begin
(let _159_310 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_tvar ((FStar_Absyn_Util.bvd_to_bvar_s abvd FStar_Absyn_Syntax.kun))))
in ((loc), (env), (TBinder (((abvd), (FStar_Absyn_Syntax.kun), (aq)))), (_159_310), (imp)))
end))
end))
end
...
in (let _159_311 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_wild ((FStar_Absyn_Util.bvd_to_bvar_s y FStar_Absyn_Syntax.tun))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_311), (false)))))
end
| FStar_Parser_AST.PatConst (c) -> begin
(

let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_312 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_constant (c)))
...
| (loc, env, xbvd) -> begin
(let _159_313 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_var ((FStar_Absyn_Util.bvd_to_bvar_s xbvd FStar_Absyn_Syntax.tun))))
in ((loc), (env), (VBinder (((xbvd), (FStar_Absyn_Syntax.tun), (aq)))), (_159_313), (imp)))
end))))
end
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_314 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), ([])))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_314), (false)))))
end
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_317 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), (args)))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_317), (false)))))
end))
end
...
let pat = (let _159_324 = (let _159_323 = (let _159_322 = (FStar_Range.end_range p.FStar_Parser_AST.prange)
in (pos_r _159_322))
in (FStar_All.pipe_left _159_323 (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv FStar_Absyn_Const.nil_lid)), (Some (FStar_Absyn_Syntax.Data_ctor)), ([]))))))
in (FStar_List.fold_right (fun hd tl -> (

let r = (FStar_Range.union_ranges hd.FStar_Absyn_Syntax.p tl.FStar_Absyn_Syntax.p)
in (FStar_All.pipe_left (pos_r r) (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv FStar_Absyn_Const.cons_lid)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((((hd), (false)))::(((tl), (false)))::[]))))))) pats _159_324))
in (
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_327 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), (args)))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_327), (false))))))))
end))
end
...
| (f, p) -> begin
(let _159_329 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.qualify_field_to_record env record) f)
in ((_159_329), (p)))
end))))
in (
...
(let _159_337 = (let _159_336 = (let _159_335 = (let _159_334 = (let _159_333 = (let _159_332 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_DesugarEnv.typename), (_159_332)))
in FStar_Absyn_Syntax.Record_ctor (_159_333))
in Some (_159_334))
in ((fv), (_159_335), (args)))
in FStar_Absyn_Syntax.Pat_cons (_159_336))
in (FStar_All.pipe_left pos _159_337))
end
| _62_1083 -> begin
p
end)
...
(let _159_343 = (let _159_342 = (let _159_341 = (FStar_Parser_DesugarEnv.qualify env x)
in ((_159_341), (FStar_Absyn_Syntax.tun)))
...
(let _159_347 = (let _159_346 = (let _159_345 = (FStar_Parser_DesugarEnv.qualify env x)
in (let _159_344 = (desugar_typ env t)
in ((_159_345), (_159_344))))
in LetBinder (_159_346))
in ((env), (_159_347), (None)))
end
| _62_1113 -> begin
...
(let _159_357 = (desugar_typ env t)
in FStar_Util.Inl (_159_357))
end else begin
(let _159_358 = (desugar_exp env t)
in FStar_Util.Inr (_159_358))
end)
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _159_382 = (desugar_typ_or_exp env t)
in ((_159_382), (None))))))
in (let _159_383 = (FStar_Absyn_Util.mk_exp_app op args)
in (FStar_All.pipe_left setpos _159_383))))
end)
end
...
(let _159_384 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_lid env) l)
in (FStar_All.pipe_left setpos _159_384))
end
end
| FStar_Parser_AST.Construct (l, args) -> begin
(

let dt = (let _159_389 = (let _159_388 = (let _159_387 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in ((_159_387), (Some (FStar_Absyn_Syntax.Data_ctor))))
in (FStar_Absyn_Syntax.mk_Exp_fvar _159_388))
in (FStar_All.pipe_left pos _159_389))
in (match (args) with
| [] -> begin
dt
end
...
in (let _159_394 = (let _159_393 = (let _159_392 = (let _159_391 = (FStar_Absyn_Util.mk_exp_app dt args)
in ((_159_391), (FStar_Absyn_Syntax.Data_app)))
in FStar_Absyn_Syntax.Meta_desugared (_159_392))
in (FStar_Absyn_Syntax.mk_Exp_meta _159_393))
in (FStar_All.pipe_left setpos _159_394)))
end))
end
...
let ftvs = (let _159_397 = (free_type_vars env t)
in (FStar_List.append _159_397 ftvs))
in (let _159_399 = (let _159_398 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (FStar_All.pipe_left Prims.fst _159_398))
in ((_159_399), (ftvs))))
end
| FStar_Parser_AST.PatTvar (a, _62_1208) -> begin
(let _159_401 = (let _159_400 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (FStar_All.pipe_left Prims.fst _159_400))
in ((_159_401), (ftvs)))
end
| FStar_Parser_AST.PatAscribed (_62_1212, t) -> begin
(let _159_403 = (let _159_402 = (free_type_vars env t)
in (FStar_List.append _159_402 ftvs))
in ((env), (_159_403)))
end
| _62_1217 -> begin
((env), (ftvs))
...
let binders = (let _159_405 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append _159_405 binders))
in (
...
| TBinder (a, k, aq) -> begin
(let _159_414 = (binder_of_bnd b)
in ((_159_414), (sc_pat_opt)))
end
| VBinder (x, t, aq) -> begin
(
...
| (Some (p), None) -> begin
(let _159_416 = (let _159_415 = (FStar_Absyn_Util.bvar_to_exp b)
in ((_159_415), (p)))
in Some (_159_416))
end
...
let sc = (let _159_423 = (let _159_422 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) tup top.FStar_Parser_AST.range)
in (let _159_421 = (let _159_420 = (FStar_Absyn_Syntax.varg sc)
in (let _159_419 = (let _159_418 = (let _159_417 = (FStar_Absyn_Util.bvar_to_exp b)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_417))
in (_159_418)::[])
in (_159_420)::_159_419))
in ((_159_422), (_159_421))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_423 None top.FStar_Parser_AST.range))
in (

let p = (let _159_424 = (FStar_Range.union_ranges p'.FStar_Absyn_Syntax.p p.FStar_Absyn_Syntax.p)
in (FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv tup)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((((p'), (false)))::(((p), (false)))::[])))) None _159_424))
in Some (((sc), (p))))))
end
...
let sc = (let _159_430 = (let _159_429 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) tup top.FStar_Parser_AST.range)
in (let _159_428 = (let _159_427 = (let _159_426 = (let _159_425 = (FStar_Absyn_Util.bvar_to_exp b)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_425))
in (_159_426)::[])
in (FStar_List.append args _159_427))
in ((_159_429), (_159_428))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_430 None top.FStar_Parser_AST.range))
in (

let p = (let _159_431 = (FStar_Range.union_ranges p'.FStar_Absyn_Syntax.p p.FStar_Absyn_Syntax.p)
in (FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv tup)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((FStar_List.append pats ((((p), (false)))::[])))))) None _159_431))
in Some (((sc), (p))))))
end
| _62_1300 -> begin
(FStar_All.failwith "Impossible")
...
in (let _159_441 = (let _159_440 = (let _159_439 = (FStar_Absyn_Util.fvar None a (FStar_Ident.range_of_lid a))
in (let _159_438 = (let _159_437 = (FStar_All.pipe_left FStar_Absyn_Syntax.targ phi)
in (let _159_436 = (let _159_435 = (let _159_434 = (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit None top.FStar_Parser_AST.range)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_434))
in (_159_435)::[])
in (_159_437)::_159_436))
in ((_159_439), (_159_438))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_440))
in (FStar_All.pipe_left pos _159_441)))
end
| FStar_Parser_AST.App (_62_1319) -> begin
(

let rec aux = (fun args e -> (match ((let _159_446 = (unparen e)
in _159_446.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, t, imp) -> begin
(

let arg = (let _159_447 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _159_447))
in (aux ((arg)::args) e))
end
| _62_1331 -> begin
(
...
(let _159_453 = (let _159_452 = (let _159_451 = (let _159_450 = (desugar_exp env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((_159_450), (FStar_Absyn_Syntax.Sequence)))
in FStar_Absyn_Syntax.Meta_desugared (_159_451))
in (FStar_Absyn_Syntax.mk_Exp_meta _159_452))
in (FStar_All.pipe_left setpos _159_453))
end
...
(let _159_457 = (destruct_app_pattern env top_level p)
in ((_159_457), (def)))
end else begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _159_458 = (destruct_app_pattern env top_level p)
in ((_159_458), (def)))
end
| _62_1361 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(let _159_461 = (let _159_460 = (let _159_459 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_459))
in ((_159_460), ([]), (Some (t))))
in ((_159_461), (def)))
end else begin
...
if top_level then begin
(let _159_464 = (let _159_463 = (let _159_462 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_462))
in ((_159_463), ([]), (None)))
in ((_159_464), (def)))
end else begin
...
(let _159_467 = (FStar_Parser_DesugarEnv.push_rec_binding env (FStar_Parser_DesugarEnv.Binding_let (l)))
in ((_159_467), (FStar_Util.Inr (l))))
end)
...
| Some (t) -> begin
(let _159_474 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t)))) _159_474 FStar_Parser_AST.Expr))
end)
in (
...
| Some (pat) -> begin
(let _159_486 = (let _159_485 = (FStar_Absyn_Util.bvd_to_exp x t)
in ((_159_485), ((((pat), (None), (body)))::[])))
in (FStar_Absyn_Syntax.mk_Exp_match _159_486 None body.FStar_Absyn_Syntax.pos))
end)
...
(let _159_499 = (let _159_498 = (let _159_497 = (desugar_exp env t1)
in (let _159_496 = (let _159_495 = (let _159_491 = (desugar_exp env t2)
in (((FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_constant (FStar_Const.Const_bool (true))) None t2.FStar_Parser_AST.range)), (None), (_159_491)))
in (let _159_494 = (let _159_493 = (let _159_492 = (desugar_exp env t3)
in (((FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_constant (FStar_Const.Const_bool (false))) None t3.FStar_Parser_AST.range)), (None), (_159_492)))
in (_159_493)::[])
in (_159_495)::_159_494))
in ((_159_497), (_159_496))))
in (FStar_Absyn_Syntax.mk_Exp_match _159_498))
in (FStar_All.pipe_left pos _159_499))
end
...
| Some (e) -> begin
(let _159_502 = (desugar_exp env e)
in Some (_159_502))
end)
in (
...
in (let _159_508 = (let _159_507 = (let _159_506 = (desugar_exp env e)
in (let _159_505 = (FStar_List.map desugar_branch branches)
in ((_159_506), (_159_505))))
in (FStar_Absyn_Syntax.mk_Exp_match _159_507))
in (FStar_All.pipe_left pos _159_508)))
end
| FStar_Parser_AST.Ascribed (e, t) -> begin
(let _159_514 = (let _159_513 = (let _159_512 = (desugar_exp env e)
in (let _159_511 = (desugar_typ env t)
in ((_159_512), (_159_511), (None))))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _159_513))
in (FStar_All.pipe_left pos _159_514))
end
...
(match (xopt) with
| None -> begin
(let _159_525 = (let _159_524 = (let _159_523 = (FStar_Util.format1 "Field %s is missing" (FStar_Ident.text_of_lid f))
in ((_159_523), (top.FStar_Parser_AST.range)))
in FStar_Absyn_Syntax.Error (_159_524))
in (Prims.raise _159_525))
end
| Some (x) -> begin
(let _159_526 = (qfn fn)
in ((_159_526), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Project (((x), (f)))) x.FStar_Parser_AST.range x.FStar_Parser_AST.level))))
end)
end))))
in (
...
| None -> begin
(let _159_531 = (let _159_530 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _62_1542 -> (match (_62_1542) with
| (f, _62_1541) -> begin
(let _159_529 = (let _159_528 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _159_528))
in ((_159_529), (FStar_Parser_AST.Nothing)))
end))))
in ((record.FStar_Parser_DesugarEnv.constrname), (_159_530)))
in FStar_Parser_AST.Construct (_159_531))
end
| Some (e) -> begin
(
...
let xterm = (let _159_533 = (let _159_532 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_159_532))
in (FStar_Parser_AST.mk_term _159_533 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let record = (let _159_536 = (let _159_535 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _62_1550 -> (match (_62_1550) with
| (f, _62_1549) -> begin
(get_field (Some (xterm)) f)
end))))
in ((None), (_159_535)))
in FStar_Parser_AST.Record (_159_536))
...
let e = (let _159_546 = (let _159_545 = (let _159_544 = (let _159_543 = (let _159_542 = (let _159_541 = (let _159_540 = (let _159_539 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_DesugarEnv.typename), (_159_539)))
in FStar_Absyn_Syntax.Record_ctor (_159_540))
in Some (_159_541))
in ((fv), (_159_542)))
in (FStar_Absyn_Syntax.mk_Exp_fvar _159_543 None e.FStar_Absyn_Syntax.pos))
in ((_159_544), (args)))
in (FStar_Absyn_Syntax.mk_Exp_app _159_545))
in (FStar_All.pipe_left pos _159_546))
...
in (let _159_553 = (let _159_552 = (let _159_551 = (FStar_Absyn_Util.fvar qual fieldname (FStar_Ident.range_of_lid f))
in (let _159_550 = (let _159_549 = (FStar_Absyn_Syntax.varg e)
in (_159_549)::[])
in ((_159_551), (_159_550))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_552))
in (FStar_All.pipe_left pos _159_553)))))
end))
end
...
let rec aux = (fun args t -> (match ((let _159_576 = (unparen t)
in _159_576.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (t, arg, imp) -> begin
(aux ((((arg), (imp)))::args) t)
end
| FStar_Parser_AST.Construct (l, args') -> begin
...
(let _159_577 = (desugar_exp env t)
in (FStar_All.pipe_right _159_577 FStar_Absyn_Util.b2t))
end)
end
...
(let _159_578 = (desugar_exp env t)
in (FStar_All.pipe_right _159_578 FStar_Absyn_Util.b2t))
end)
end
...
(let _159_581 = (flatten t1)
in (FStar_List.append _159_581 ((t2)::[])))
end
| _62_1658 -> begin
(t)::[]
end))
...
let targs = (let _159_584 = (flatten top)
in (FStar_All.pipe_right _159_584 (FStar_List.map (fun t -> (let _159_583 = (desugar_typ env t)
in (FStar_Absyn_Syntax.targ _159_583))))))
in (

let tup = (let _159_585 = (FStar_Absyn_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) _159_585))
in (FStar_All.pipe_left wpos (FStar_Absyn_Syntax.mk_Typ_app ((tup), (targs)))))))
end else begin
(let _159_591 = (let _159_590 = (let _159_589 = (let _159_588 = (FStar_Parser_AST.term_to_string t1)
in (FStar_Util.format1 "The operator \"*\" is resolved here as multiplication since \"%s\" is a term, although a type was expected" _159_588))
in ((_159_589), (top.FStar_Parser_AST.range)))
in FStar_Absyn_Syntax.Error (_159_590))
in (Prims.raise _159_591))
end
end
...
| None -> begin
(let _159_592 = (desugar_exp env top)
in (FStar_All.pipe_right _159_592 FStar_Absyn_Util.b2t))
end
| Some (l) -> begin
(

let args = (FStar_List.map (fun t -> (let _159_594 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_594))) args)
in (let _159_595 = (FStar_Absyn_Util.ftv l FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _159_595 args)))
end)
end
| FStar_Parser_AST.Tvar (a) -> begin
(let _159_596 = (FStar_Parser_DesugarEnv.fail_or2 (FStar_Parser_DesugarEnv.try_lookup_typ_var env) a)
...
| None -> begin
(let _159_597 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
...
in (let _159_598 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (FStar_All.pipe_left setpos _159_598)))
end
| FStar_Parser_AST.Construct (l, args) -> begin
(

let t = (let _159_599 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (FStar_All.pipe_left setpos _159_599))
in (

let args = (FStar_List.map (fun _62_1694 -> (match (_62_1694) with
| (t, imp) -> begin
(let _159_601 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_601))
end)) args)
...
(match (pat) with
| Some (q) -> begin
(let _159_613 = (let _159_612 = (let _159_611 = (let _159_610 = (FStar_Absyn_Print.pat_to_string q)
in (FStar_Util.format1 "Pattern matching at the type level is not supported; got %s\n" _159_610))
in ((_159_611), (hd.FStar_Parser_AST.prange)))
in FStar_Absyn_Syntax.Error (_159_612))
in (Prims.raise _159_613))
end
| None -> begin
(
...
let rec aux = (fun args e -> (match ((let _159_618 = (unparen e)
in _159_618.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, arg, imp) -> begin
(

let arg = (let _159_619 = (desugar_typ_or_exp env arg)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_619))
in (aux ((arg)::args) e))
end
| _62_1730 -> begin
(
...
(let _159_630 = (desugar_exp env f)
in (FStar_All.pipe_right _159_630 FStar_Absyn_Util.b2t))
end
...
(let _159_638 = (let _159_637 = (let _159_636 = (desugar_typ env t)
in (let _159_635 = (desugar_kind env k)
in ((_159_636), (_159_635))))
in (FStar_Absyn_Syntax.mk_Typ_ascribed' _159_637))
in (FStar_All.pipe_left wpos _159_638))
end
...
| None -> begin
(let _159_641 = (FStar_Absyn_Util.new_bvd (Some (top.FStar_Parser_AST.range)))
in ((env), (_159_641)))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _159_645 = (let _159_644 = (let _159_643 = (let _159_642 = (FStar_Absyn_Util.close_with_lam tparams t)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_642))
in (_159_643)::[])
in (FStar_List.append typs _159_644))
in ((env), ((FStar_List.append tparams ((((FStar_Util.Inr ((FStar_Absyn_Util.bvd_to_bvar_s x t))), (None)))::[]))), (_159_645)))
end))
end))
...
let tup = (let _159_646 = (FStar_Absyn_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) _159_646))
in (FStar_All.pipe_left wpos (FStar_Absyn_Syntax.mk_Typ_app ((tup), (targs)))))
end))
end
...
| (arg, _62_1853) -> begin
(match ((let _159_658 = (unparen arg)
in _159_658.FStar_Parser_AST.tm)) with
...
| FStar_Parser_AST.Name (tot) when (((tot.FStar_Ident.ident.FStar_Ident.idText = "Tot") && (not ((FStar_Parser_DesugarEnv.is_effect_name env FStar_Absyn_Const.effect_Tot_lid)))) && (let _159_659 = (FStar_Parser_DesugarEnv.current_module env)
in (FStar_Ident.lid_equals _159_659 FStar_Absyn_Const.prims_lid))) -> begin
(

let args = (FStar_List.map (fun _62_1887 -> (match (_62_1887) with
| (t, imp) -> begin
(let _159_661 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_661))
end)) args)
in (let _159_662 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.effect_Tot_lid FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _159_662 args)))
end
| _62_1890 -> begin
(desugar_typ env t)
end)
...
| (head, args) -> begin
(match ((let _159_664 = (let _159_663 = (FStar_Absyn_Util.compress_typ head)
in _159_663.FStar_Absyn_Syntax.n)
in ((_159_664), (args)))) with
...
(let _159_671 = (let _159_670 = (let _159_669 = (let _159_668 = (let _159_667 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared (((pat), (FStar_Absyn_Syntax.Meta_smt_pat)))))
in FStar_Util.Inr (_159_667))
in ((_159_668), (aq)))
in (_159_669)::[])
in (ens)::_159_670)
in (req)::_159_671)
...
(let _159_675 = (let _159_674 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "%s is not an effect" _159_674))
in (fail _159_675))
end
end)
end))))))
...
(match ((let _159_687 = (FStar_Parser_DesugarEnv.qualify_lid env l)
in (FStar_Parser_DesugarEnv.find_kind_abbrev env _159_687))) with
| Some (l) -> begin
...
| [] -> begin
(let _159_698 = (let _159_697 = (let _159_696 = (desugar_kind env k)
in (((FStar_List.rev bs)), (_159_696)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _159_697))
in (FStar_All.pipe_left pos _159_698))
end
| (hd)::tl -> begin
(

let _62_2027 = (let _159_700 = (let _159_699 = (FStar_Parser_DesugarEnv.default_ml env)
in (desugar_binder _159_699 hd))
in (FStar_All.pipe_right _159_700 (as_binder env hd.FStar_Parser_AST.aqual)))
...
in (let _159_702 = (desugar_typ_or_exp env t)
in ((_159_702), (qual))))
end)) args)
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _159_738 = (desugar_typ_or_exp env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_738)))))) pats))
in (match (tk) with
| FStar_Util.Inl (Some (a), k) -> begin
(
...
| _62_2085 -> begin
(let _159_739 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern (((body), (pats)))))
in (FStar_All.pipe_left setpos _159_739))
end)
in (

let body = (let _159_745 = (let _159_744 = (let _159_743 = (let _159_742 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_159_742)::[])
in ((_159_743), (body)))
in (FStar_Absyn_Syntax.mk_Typ_lam _159_744))
in (FStar_All.pipe_left pos _159_745))
in (let _159_750 = (let _159_749 = (let _159_746 = (FStar_Ident.set_lid_range qt b.FStar_Parser_AST.brange)
in (FStar_Absyn_Util.ftv _159_746 FStar_Absyn_Syntax.kun))
in (let _159_748 = (let _159_747 = (FStar_Absyn_Syntax.targ body)
in (_159_747)::[])
in (FStar_Absyn_Util.mk_typ_app _159_749 _159_748)))
in (FStar_All.pipe_left setpos _159_750))))))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(
...
let body = (let _159_756 = (let _159_755 = (let _159_754 = (let _159_753 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_159_753)::[])
in ((_159_754), (body)))
in (FStar_Absyn_Syntax.mk_Typ_lam _159_755))
in (FStar_All.pipe_left pos _159_756))
in (let _159_761 = (let _159_760 = (let _159_757 = (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange)
in (FStar_Absyn_Util.ftv _159_757 FStar_Absyn_Syntax.kun))
in (let _159_759 = (let _159_758 = (FStar_Absyn_Syntax.targ body)
in (_159_758)::[])
in (FStar_Absyn_Util.mk_typ_app _159_760 _159_759)))
in (FStar_All.pipe_left setpos _159_761))))))
end))
end
| _62_2104 -> begin
(FStar_All.failwith "impossible")
...
let body = (let _159_776 = (q ((rest), (pats), (body)))
in (let _159_775 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _159_776 _159_775 FStar_Parser_AST.Formula)))
in (let _159_777 = (q (((b)::[]), ([]), (body)))
in (FStar_Parser_AST.mk_term _159_777 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _62_2118 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _159_778 = (unparen f)
in _159_778.FStar_Parser_AST.tm)) with
...
let args = (FStar_List.map (fun t -> (let _159_780 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_780))) args)
in (

let eq = if (is_type env hd) then begin
(let _159_781 = (FStar_Ident.set_lid_range FStar_Absyn_Const.eqT_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _159_781 FStar_Absyn_Syntax.kun))
end else begin
(let _159_782 = (FStar_Ident.set_lid_range FStar_Absyn_Const.eq2_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _159_782 FStar_Absyn_Syntax.kun))
end
...
(let _159_787 = (let _159_783 = (FStar_Ident.set_lid_range conn f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _159_783 FStar_Absyn_Syntax.kun))
in (let _159_786 = (FStar_List.map (fun x -> (let _159_785 = (desugar_formula env x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_785))) args)
in (FStar_Absyn_Util.mk_typ_app _159_787 _159_786)))
end
| _62_2149 -> begin
if (is_type env f) then begin
(desugar_typ env f)
end else begin
(let _159_788 = (desugar_exp env f)
in (FStar_All.pipe_right _159_788 FStar_Absyn_Util.b2t))
end
end)
end
| FStar_Parser_AST.If (f1, f2, f3) -> begin
(let _159_793 = (let _159_789 = (FStar_Ident.set_lid_range FStar_Absyn_Const.ite_lid f.FStar_Parser_AST.range)
in (FStar_Absyn_Util.ftv _159_789 FStar_Absyn_Syntax.kun))
in (let _159_792 = (FStar_List.map (fun x -> (match ((desugar_typ_or_exp env x)) with
| FStar_Util.Inl (t) -> begin
(FStar_Absyn_Syntax.targ t)
end
| FStar_Util.Inr (v) -> begin
(let _159_791 = (FStar_Absyn_Util.b2t v)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_791))
end)) ((f1)::(f2)::(f3)::[]))
in (FStar_Absyn_Util.mk_typ_app _159_793 _159_792)))
end
...
in (let _159_795 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _159_795)))
end
| FStar_Parser_AST.QExists ((_1)::(_2)::_3, pats, body) -> begin
(

let binders = (_1)::(_2)::_3
in (let _159_797 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _159_797)))
end
...
(let _159_798 = (desugar_exp env f)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _159_798))
end
end)))))))
...
(let _159_803 = (desugar_type_binder env b)
in FStar_Util.Inl (_159_803))
end else begin
(let _159_804 = (desugar_exp_binder env b)
in FStar_Util.Inr (_159_804))
end)
...
(let _159_811 = (desugar_typ env t)
in ((Some (x)), (_159_811)))
end
| FStar_Parser_AST.TVariable (t) -> begin
(let _159_812 = (FStar_Parser_DesugarEnv.fail_or2 (FStar_Parser_DesugarEnv.try_lookup_typ_var env) t)
in ((None), (_159_812)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _159_813 = (desugar_typ env t)
in ((None), (_159_813)))
end
...
(let _159_818 = (desugar_kind env t)
in ((Some (x)), (_159_818)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _159_819 = (desugar_kind env t)
in ((None), (_159_819)))
end
| FStar_Parser_AST.TVariable (x) -> begin
((Some (x)), ((
...
in (let _159_828 = (aux tps k)
in (FStar_All.pipe_right _159_828 FStar_Absyn_Util.name_binders))))
...
let binders = (let _159_849 = (let _159_848 = (let _159_847 = (let _159_846 = (let _159_845 = (FStar_Absyn_Util.ftv t FStar_Absyn_Syntax.kun)
in (let _159_844 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in ((_159_845), (_159_844))))
in (FStar_Absyn_Syntax.mk_Typ_app' _159_846 None p))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder _159_847))
in (_159_848)::[])
in (FStar_List.append imp_binders _159_849))
in (

let disc_type = (let _159_852 = (let _159_851 = (let _159_850 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.bool_lid FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.total_comp _159_850 p))
in ((binders), (_159_851)))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_852 None p))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (

let disc_name = (FStar_Absyn_Util.mk_discriminator d)
in (let _159_855 = (let _159_854 = (quals ((FStar_Absyn_Syntax.Logic)::(FStar_Absyn_Syntax.Discriminator (d))::[]))
in ((disc_name), (disc_type), (_159_854), ((FStar_Ident.range_of_lid disc_name))))
in FStar_Absyn_Syntax.Sig_val_decl (_159_855)))))))))))))
...
let projectee = (let _159_866 = (FStar_Absyn_Syntax.mk_ident (("projectee"), (p)))
in (let _159_865 = (FStar_Absyn_Util.genident (Some (p)))
in {FStar_Absyn_Syntax.ppname = _159_866; FStar_Absyn_Syntax.realname = _159_865}))
in (
...
let arg_typ = (let _159_869 = (let _159_868 = (FStar_Absyn_Util.ftv tc FStar_Absyn_Syntax.kun)
in (let _159_867 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in ((_159_868), (_159_867))))
in (FStar_Absyn_Syntax.mk_Typ_app' _159_869 None p))
...
in (let _159_879 = (let _159_878 = (let _159_877 = (let _159_876 = (let _159_875 = (let _159_874 = (let _159_873 = (FStar_Absyn_Util.fvar None disc_name p)
in (let _159_872 = (let _159_871 = (let _159_870 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_870))
in (_159_871)::[])
in ((_159_873), (_159_872))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_874 None p))
in (FStar_Absyn_Util.b2t _159_875))
in ((x), (_159_876)))
in (FStar_Absyn_Syntax.mk_Typ_refine _159_877 None p))
in (FStar_All.pipe_left (FStar_Absyn_Util.bvd_to_bvar_s projectee) _159_878))
in (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder _159_879))))
end)
in (
...
let subst = (let _159_887 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i f -> (match ((Prims.fst f)) with
...
let proj = (let _159_884 = (let _159_883 = (FStar_Absyn_Util.ftv field_name FStar_Absyn_Syntax.kun)
in ((_159_883), ((arg)::[])))
in (FStar_Absyn_Syntax.mk_Typ_app _159_884 None p))
...
let proj = (let _159_886 = (let _159_885 = (FStar_Absyn_Util.fvar None field_name p)
in ((_159_885), ((arg)::[])))
in (FStar_Absyn_Syntax.mk_Exp_app _159_886 None p))
in (FStar_Util.Inr (((x.FStar_Absyn_Syntax.v), (proj))))::[])
end))
end))))
in (FStar_All.pipe_right _159_887 FStar_List.flatten))
in (

let ntps = (FStar_List.length tps)
in (

let all_params = (let _159_889 = (FStar_All.pipe_right tps (FStar_List.map (fun _62_2363 -> (match (_62_2363) with
| (b, _62_2362) -> begin
((b), (Some (imp_tag)))
end))))
in (FStar_List.append _159_889 formals))
in (let _159_919 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i ax -> (match ((Prims.fst ax)) with
| FStar_Util.Inl (a) -> begin
(
...
let kk = (let _159_893 = (let _159_892 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in ((binders), (_159_892)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _159_893 p))
...
let t = (let _159_896 = (let _159_895 = (let _159_894 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Absyn_Util.total_comp _159_894 p))
in ((binders), (_159_895)))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_896 None p))
in (
...
let impl = if (((let _159_899 = (FStar_Parser_DesugarEnv.current_module env)
in (FStar_Ident.lid_equals FStar_Absyn_Const.prims_lid _159_899)) || (fvq <> FStar_Absyn_Syntax.Data_ctor)) || (let _159_901 = (let _159_900 = (FStar_Parser_DesugarEnv.current_module env)
in _159_900.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _159_901))) then begin
[]
end else begin
(
...
let arg_pats = (let _159_916 = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j by -> (match (by) with
| (FStar_Util.Inl (_62_2396), imp) -> begin
if (j < ntps) then begin
[]
end else begin
(let _159_909 = (let _159_908 = (let _159_907 = (let _159_906 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.kun)
in FStar_Absyn_Syntax.Pat_tvar (_159_906))
in (pos _159_907))
in ((_159_908), ((as_imp imp))))
in (_159_909)::[])
end
end
| (FStar_Util.Inr (_62_2401), imp) -> begin
if ((i + ntps) = j) then begin
(let _159_911 = (let _159_910 = (pos (FStar_Absyn_Syntax.Pat_var (projection)))
in ((_159_910), ((as_imp imp))))
in (_159_911)::[])
end else begin
if (j < ntps) then begin
[]
end else begin
(let _159_915 = (let _159_914 = (let _159_913 = (let _159_912 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.tun)
in FStar_Absyn_Syntax.Pat_wild (_159_912))
in (pos _159_913))
in ((_159_914), ((as_imp imp))))
in (_159_915)::[])
end
end
end))))
in (FStar_All.pipe_right _159_916 FStar_List.flatten))
in (

let pat = (let _159_918 = (FStar_All.pipe_right (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv lid)), (Some (fvq)), (arg_pats)))) pos)
in (let _159_917 = (FStar_Absyn_Util.bvar_to_exp projection)
in ((_159_918), (None), (_159_917))))
in (
...
in (FStar_All.pipe_right _159_919 FStar_List.flatten))))))))))))))
end))
...
(let _159_939 = (let _159_938 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_159_938))
in (FStar_Parser_AST.mk_term _159_939 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _159_952 = (let _159_951 = (let _159_950 = (binder_to_term b)
in ((out), (_159_950), ((imp_of_aqual b))))
in FStar_Parser_AST.App (_159_951))
in (FStar_Parser_AST.mk_term _159_952 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _159_958 = (let _159_957 = (let _159_956 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_159_956))
in (FStar_Parser_AST.mk_term _159_957 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _159_958 parms))
in (

let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product (((mfields), ((with_constructor_effect result))))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _159_960 = (FStar_All.pipe_right fields (FStar_List.map (fun _62_2546 -> (match (_62_2546) with
| (x, _62_2543, _62_2545) -> begin
(FStar_Parser_DesugarEnv.qualify env x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_159_960)))))))
end
| _62_2548 -> begin
(FStar_All.failwith "impossible")
end))
...
let tconstr = (let _159_971 = (let _159_970 = (let _159_969 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_159_969))
in (FStar_Parser_AST.mk_term _159_970 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _159_971 binders))
in (
...
let _62_2601 = (let _159_981 = (FStar_Range.string_of_range rng)
in (let _159_980 = (let _159_979 = (let _159_978 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _159_978 (FStar_List.map FStar_Absyn_Print.sli)))
in (FStar_All.pipe_right _159_979 (FStar_String.concat ", ")))
...
in (let _159_987 = (let _159_986 = (FStar_Parser_DesugarEnv.qualify env id)
in (let _159_985 = (FStar_All.pipe_right quals (FStar_List.filter (fun _62_24 -> (match (_62_24) with
| FStar_Absyn_Syntax.Effect -> begin
false
end
| _62_2633 -> begin
...
in ((_159_986), (typars), (c), (_159_985), (rng))))
in FStar_Absyn_Syntax.Sig_effect_abbrev (_159_987)))
end else begin
(

let t = (desugar_typ env' t)
in (let _159_989 = (let _159_988 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_988), (typars), (k), (t), (quals), (rng)))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_159_989)))
end
in (
...
let _62_2758 = (let _159_1005 = (FStar_All.pipe_right constrs (FStar_List.map (fun _62_2740 -> (match (_62_2740) with
...
let t = (let _159_1000 = (FStar_Parser_DesugarEnv.default_total env_tps)
in (let _159_999 = (close env_tps t)
in (desugar_typ _159_1000 _159_999)))
in (
...
in (let _159_1004 = (let _159_1003 = (let _159_1002 = (FStar_All.pipe_right t FStar_Absyn_Util.name_function_binders)
in ((name), (_159_1002), (tycon), (quals), (mutuals), (rng)))
in FStar_Absyn_Syntax.Sig_datacon (_159_1003))
in ((name), (_159_1004)))))))
end))))
in (FStar_All.pipe_left FStar_List.split _159_1005))
...
let bundle = (let _159_1007 = (let _159_1006 = (FStar_List.collect FStar_Absyn_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_159_1006), (rng)))
in FStar_Absyn_Syntax.Sig_bundle (_159_1007))
in (
...
| (env, a) -> begin
(let _159_1016 = (let _159_1015 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_159_1015)::binders)
in ((env), (_159_1016)))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
...
| (env, x) -> begin
(let _159_1018 = (let _159_1017 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_159_1017)::binders)
in ((env), (_159_1018)))
end))
end
| _62_2806 -> begin
...
| FStar_Parser_AST.TopLevelModule (_62_2844) -> begin
...
(let _159_1036 = (FStar_Parser_DesugarEnv.push_module_abbrev env x l)
in ((_159_1036), ([])))
end
| FStar_Parser_AST.Tycon (qual, tcs) -> begin
(

let tcs = (FStar_List.map (fun _62_2860 -> (match (_62_2860) with
| (x, _62_2859) -> begin
x
end)) tcs)
in (let _159_1038 = (trans_quals qual)
in (desugar_tycon env d.FStar_Parser_AST.drange _159_1038 tcs)))
end
| FStar_Parser_AST.ToplevelLet (quals, isrec, lets) -> begin
(match ((let _159_1040 = (let _159_1039 = (desugar_exp_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((isrec), (lets), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Absyn_Util.compress_exp _159_1039))
in _159_1040.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Exp_let (lbs, _62_2869) -> begin
(
...
| (_62_2881)::_62_2879 -> begin
(trans_quals quals)
end
| _62_2884 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun _62_30 -> (match (_62_30) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_62_2893); FStar_Absyn_Syntax.lbtyp = _62_2891; FStar_Absyn_Syntax.lbeff = _62_2889; FStar_Absyn_Syntax.lbdef = _62_2887} -> begin
[]
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = _62_2901; FStar_Absyn_Syntax.lbeff = _62_2899; FStar_Absyn_Syntax.lbdef = _62_2897} -> begin
...
in (let _159_1046 = (let _159_1045 = (let _159_1044 = (let _159_1043 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_1043), (f), ((FStar_Absyn_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Sig_assume (_159_1044))
in (_159_1045)::[])
in ((env), (_159_1046))))
end
...
let t = (let _159_1047 = (close_fun env t)
in (desugar_typ env _159_1047))
in (

let quals = if (env.FStar_Parser_DesugarEnv.iface && env.FStar_Parser_DesugarEnv.admitted_iface) then begin
(let _159_1048 = (trans_quals quals)
in (FStar_Absyn_Syntax.Assumption)::_159_1048)
end else begin
(trans_quals quals)
end
in (

let se = (let _159_1050 = (let _159_1049 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_1049), (t), (quals), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Sig_val_decl (_159_1050))
in (
...
let t = (let _159_1055 = (let _159_1054 = (let _159_1051 = (FStar_Absyn_Syntax.null_v_binder t)
in (_159_1051)::[])
in (let _159_1053 = (let _159_1052 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) FStar_Absyn_Const.exn_lid)
in (FStar_Absyn_Syntax.mk_Total _159_1052))
in ((_159_1054), (_159_1053))))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_1055 None d.FStar_Parser_AST.drange))
in (
...
let _62_2962 = (desugar_binders env binders)
in (match (_62_2962) with
| (env_k, binders) -> begin
(
...
| FStar_Parser_AST.NewEffectForFree (_62_2968) -> begin
...
let _62_2981 = (desugar_binders env eff_binders)
in (match (_62_2981) with
| (env, binders) -> begin
(
...
let _62_2985 = (FStar_Absyn_Util.head_and_args defn)
in (match (_62_2985) with
| (head, args) -> begin
...
| None -> begin
(let _159_1060 = (let _159_1059 = (let _159_1058 = (let _159_1057 = (let _159_1056 = (FStar_Absyn_Print.sli eff.FStar_Absyn_Syntax.v)
in (Prims.strcat _159_1056 " not found"))
in (Prims.strcat "Effect " _159_1057))
in ((_159_1058), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1059))
in (Prims.raise _159_1060))
end
| Some (ed) -> begin
(
...
let ed = (let _159_1078 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _159_1077 = (trans_quals quals)
in (let _159_1076 = (FStar_Absyn_Util.subst_kind subst ed.FStar_Absyn_Syntax.signature)
in (let _159_1075 = (sub ed.FStar_Absyn_Syntax.ret)
in (let _159_1074 = (sub ed.FStar_Absyn_Syntax.bind_wp)
in (let _159_1073 = (sub ed.FStar_Absyn_Syntax.bind_wlp)
in (let _159_1072 = (sub ed.FStar_Absyn_Syntax.if_then_else)
in (let _159_1071 = (sub ed.FStar_Absyn_Syntax.ite_wp)
in (let _159_1070 = (sub ed.FStar_Absyn_Syntax.ite_wlp)
in (let _159_1069 = (sub ed.FStar_Absyn_Syntax.wp_binop)
in (let _159_1068 = (sub ed.FStar_Absyn_Syntax.wp_as_type)
in (let _159_1067 = (sub ed.FStar_Absyn_Syntax.close_wp)
in (let _159_1066 = (sub ed.FStar_Absyn_Syntax.close_wp_t)
in (let _159_1065 = (sub ed.FStar_Absyn_Syntax.assert_p)
in (let _159_1064 = (sub ed.FStar_Absyn_Syntax.assume_p)
in (let _159_1063 = (sub ed.FStar_Absyn_Syntax.null_wp)
in (let _159_1062 = (sub ed.FStar_Absyn_Syntax.trivial)
in {FStar_Absyn_Syntax.mname = _159_1078; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = _159_1077; FStar_Absyn_Syntax.signature = _159_1076; FStar_Absyn_Syntax.ret = _159_1075; FStar_Absyn_Syntax.bind_wp = _159_1074; FStar_Absyn_Syntax.bind_wlp = _159_1073; FStar_Absyn_Syntax.if_then_else = _159_1072; FStar_Absyn_Syntax.ite_wp = _159_1071; FStar_Absyn_Syntax.ite_wlp = _159_1070; FStar_Absyn_Syntax.wp_binop = _159_1069; FStar_Absyn_Syntax.wp_as_type = _159_1068; FStar_Absyn_Syntax.close_wp = _159_1067; FStar_Absyn_Syntax.close_wp_t = _159_1066; FStar_Absyn_Syntax.assert_p = _159_1065; FStar_Absyn_Syntax.assume_p = _159_1064; FStar_Absyn_Syntax.null_wp = _159_1063; FStar_Absyn_Syntax.trivial = _159_1062})))))))))))))))))
in (
...
| _62_2997 -> begin
(let _159_1082 = (let _159_1081 = (let _159_1080 = (let _159_1079 = (FStar_Absyn_Print.typ_to_string head)
in (Prims.strcat _159_1079 " is not an effect"))
in ((_159_1080), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1081))
in (Prims.raise _159_1082))
end)
end)))
end)))
end
...
let _62_3012 = (desugar_binders env eff_binders)
...
let _62_3023 = (FStar_All.pipe_right eff_decls (FStar_List.fold_left (fun _62_3016 decl -> (match (_62_3016) with
| (env, out) -> begin
(

let _62_3020 = (desugar_decl env decl)
in (match (_62_3020) with
| (env, ses) -> begin
(let _159_1086 = (let _159_1085 = (FStar_List.hd ses)
in (_159_1085)::out)
in ((env), (_159_1086)))
end))
end)) ((env), ([]))))
in (match (_62_3023) with
| (env, decls) -> begin
(
...
let lookup = (fun s -> (match ((let _159_1090 = (let _159_1089 = (FStar_Absyn_Syntax.mk_ident ((s), (d.FStar_Parser_AST.drange)))
in (FStar_Parser_DesugarEnv.qualify env _159_1089))
in (FStar_Parser_DesugarEnv.try_resolve_typ_abbrev env _159_1090))) with
| None -> begin
...
let ed = (let _159_1106 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _159_1105 = (trans_quals quals)
in (let _159_1104 = (lookup "return")
in (let _159_1103 = (lookup "bind_wp")
in (let _159_1102 = (lookup "bind_wlp")
in (let _159_1101 = (lookup "if_then_else")
in (let _159_1100 = (lookup "ite_wp")
in (let _159_1099 = (lookup "ite_wlp")
in (let _159_1098 = (lookup "wp_binop")
in (let _159_1097 = (lookup "wp_as_type")
in (let _159_1096 = (lookup "close_wp")
in (let _159_1095 = (lookup "close_wp_t")
in (let _159_1094 = (lookup "assert_p")
in (let _159_1093 = (lookup "assume_p")
in (let _159_1092 = (lookup "null_wp")
in (let _159_1091 = (lookup "trivial")
in {FStar_Absyn_Syntax.mname = _159_1106; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = _159_1105; FStar_Absyn_Syntax.signature = eff_k; FStar_Absyn_Syntax.ret = _159_1104; FStar_Absyn_Syntax.bind_wp = _159_1103; FStar_Absyn_Syntax.bind_wlp = _159_1102; FStar_Absyn_Syntax.if_then_else = _159_1101; FStar_Absyn_Syntax.ite_wp = _159_1100; FStar_Absyn_Syntax.ite_wlp = _159_1099; FStar_Absyn_Syntax.wp_binop = _159_1098; FStar_Absyn_Syntax.wp_as_type = _159_1097; FStar_Absyn_Syntax.close_wp = _159_1096; FStar_Absyn_Syntax.close_wp_t = _159_1095; FStar_Absyn_Syntax.assert_p = _159_1094; FStar_Absyn_Syntax.assume_p = _159_1093; FStar_Absyn_Syntax.null_wp = _159_1092; FStar_Absyn_Syntax.trivial = _159_1091}))))))))))))))))
in (
...
| None -> begin
(let _159_1113 = (let _159_1112 = (let _159_1111 = (let _159_1110 = (let _159_1109 = (FStar_Absyn_Print.sli l)
in (Prims.strcat _159_1109 " not found"))
in (Prims.strcat "Effect name " _159_1110))
in ((_159_1111), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1112))
in (Prims.raise _159_1113))
end
| Some (l) -> begin
l
end))
...
let lift = (let _159_1116 = (non_reifiable l.FStar_Parser_AST.lift_op)
in (desugar_typ env _159_1116))
in (
...
let desugar_decls : FStar_Parser_DesugarEnv.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_Parser_DesugarEnv.env * FStar_Absyn_Syntax.sigelts) = (fun env decls -> (FStar_List.fold_left (fun _62_3054 d -> (match (_62_3054) with
| (env, sigelts) -> begin
(

let _62_3058 = (desugar_decl env d)
in (match (_62_3058) with
| (env, se) -> begin
...
(let _159_1141 = (let _159_1140 = (let _159_1138 = (FStar_Absyn_Syntax.lid_of_ids mname.FStar_Ident.ns)
in FStar_Parser_AST.Open (_159_1138))
in (let _159_1139 = (FStar_Absyn_Syntax.range_of_lid mname)
in (FStar_Parser_AST.mk_decl _159_1140 _159_1139 None)))
in (_159_1141)::d)
end else begin
d
end
...
let _62_3085 = (match (m) with
| FStar_Parser_AST.Interface (mname, decls, admitted) -> begin
(let _159_1143 = (FStar_Parser_DesugarEnv.prepare_module_or_interface true admitted env mname)
in (let _159_1142 = (open_ns mname decls)
in ((_159_1143), (mname), (_159_1142), (true))))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _159_1145 = (FStar_Parser_DesugarEnv.prepare_module_or_interface false false env mname)
in (let _159_1144 = (open_ns mname decls)
in ((_159_1145), (mname), (_159_1144), (false))))
end)
in (match (_62_3085) with
| ((env, pop_when_done), mname, decls, intf) -> begin
(

let _62_3088 = (desugar_decls env decls)
in (match (_62_3088) with
| (env, sigelts) -> begin
(
...
| FStar_Parser_AST.Interface (mname, _62_3099, _62_3101) -> begin
...
let _62_3109 = (desugar_modul_common curmod env m)
in (match (_62_3109) with
| (x, y, _62_3108) -> begin
((x), (y))
end))))
...
let _62_3115 = (desugar_modul_common None env m)
...
let _62_3117 = if (FStar_Options.dump_module modul.FStar_Absyn_Syntax.name.FStar_Ident.str) then begin
(let _159_1156 = (FStar_Absyn_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _159_1156))
end else begin
()
end
in (let _159_1157 = if pop_when_done then begin
...
let _62_3130 = (FStar_List.fold_left (fun _62_3123 m -> (match (_62_3123) with
| (env, mods) -> begin
(

let _62_3127 = (desugar_modul env m)
in (match (_62_3127) with
| (env, m) -> begin
((env), ((m)::mods))
end))
end)) ((env), ([])) f)
in (match (_62_3130) with
| (env, mods) -> begin
...
let _62_3135 = (FStar_Parser_DesugarEnv.prepare_module_or_interface false false en m.FStar_Absyn_Syntax.name)
in (match (_62_3135) with
...
let _62_3136 = en
in {FStar_Parser_DesugarEnv.curmodule = Some (m.FStar_Absyn_Syntax.name); FStar_Parser_DesugarEnv.modules = _62_3136.FStar_Parser_DesugarEnv.modules; FStar_Parser_DesugarEnv.open_namespaces = _62_3136.FStar_Parser_DesugarEnv.open_namespaces; FStar_Parser_DesugarEnv.modul_abbrevs = _62_3136.FStar_Parser_DesugarEnv.modul_abbrevs; FStar_Parser_DesugarEnv.sigaccum = _62_3136.FStar_Parser_DesugarEnv.sigaccum; FStar_Parser_DesugarEnv.localbindings = _62_3136.FStar_Parser_DesugarEnv.localbindings; FStar_Parser_DesugarEnv.recbindings = _62_3136.FStar_Parser_DesugarEnv.recbindings; FStar_Parser_DesugarEnv.phase = _62_3136.FStar_Parser_DesugarEnv.phase; FStar_Parser_DesugarEnv.sigmap = _62_3136.FStar_Parser_DesugarEnv.sigmap; FStar_Parser_DesugarEnv.default_result_effect = _62_3136.FStar_Parser_DesugarEnv.default_result_effect; FStar_Parser_DesugarEnv.iface = _62_3136.FStar_Parser_DesugarEnv.iface; FStar_Parser_DesugarEnv.admitted_iface = _62_3136.FStar_Parser_DesugarEnv.admitted_iface}) m.FStar_Absyn_Syntax.exports)
in (
