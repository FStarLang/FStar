                    ...
                    (match t.FStar_SMTEncoding_Term.tm with
                     | FStar_SMTEncoding_Term.App (uu____1195,fuel::[]) ->
                         ...
                         then
                           ...
                           FStar_All.pipe_left (fun _0_310  -> Some _0_310)
                             _0_312
                         else Some t
                     | uu____1202 -> Some t)
                | uu____1203 -> None))
  ...
  fun env  ->
    fun t0  ->
      let rec aux norm t =
        ...
        | uu____1807 ->
            if norm
            then let _0_326 = whnf env t in aux false _0_326
            else
              failwith
                (let _0_328 =
                                           ...
                                           let fsym =
                                             varops.mk_unique
                                               (let _0_411 =
                                                  FStar_Util.digest_of_string
                                                    tkey_hash in
                                                Prims.strcat "Tm_abs_" _0_411) in
                                           let fdecl =
                                             FStar_SMTEncoding_Term.DeclFun
                                               (fsym, cvar_sorts,
                                                 FStar_SMTEncoding_Term.Term_sort,
                      ...
                      then (decls, env)
                        ...
                        then
                          ...
                          (let fuel =
                             ...
                             (_0_835, FStar_SMTEncoding_Term.Fuel_sort) in
            ...
            (let close_effect_params tm =
               ...
               | uu____10393 ->
                   (FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_abs
                         (let _0_882 =
                            FStar_All.pipe_left (fun _0_881  -> Some _0_881)
                              (FStar_Util.Inr
                                 (FStar_Syntax_Const.effect_Tot_lid,
                  ...
                  let _0_911 =
                    FStar_SMTEncoding_Term.DeclFun
                      (let _0_910 =
                       ...
                       (name, _0_910, FStar_SMTEncoding_Term.Term_sort, None)) in
                  [_0_911]
                             ...
                             let fuel_guarded_inversion =
                               ...
                               FStar_SMTEncoding_Term.Assume
                                 (let _0_924 =
                                  ...
                                  (_0_924, (Some "inversion axiom"), _0_923)) in
                                     ...
                                     (let _0_928 =
                                        FStar_SMTEncoding_Util.mkForall
                                          (let _0_926 =
                                           ...
                                           ([[xx_has_type_fuel;
                                             pattern_guard]], _0_926, _0_925)) in
                                      let _0_927 =
                                        Some
                                          (varops.mk_unique
                                             (Prims.strcat
                  ...
                  (let uu____12040 = encode_term t1 env in
                   ...
                   | (t,decls') ->
                       ...
                       let uu____12050 =
                         let _0_1013 =
                           let _0_1012 =
                             let _0_1011 = FStar_Util.digest_of_string t_hash in
                             let _0_1010 =
                              ...
                              then
                                Some
                                  (let _0_1016 =
                                   ...
                                   FStar_Util.format3 "%s : %s (%s)" _0_1016
                                     _0_1015 _0_1014)
                              else None in
                            let ax =
                              let a_name =
          ...
          let _0_1026 =
            FStar_SMTEncoding_Term.Caption
              (let _0_1025 =
                 ...
                 FStar_All.pipe_right _0_1024 (FStar_String.concat ", ") in
               Prims.strcat "encoding sigelt " _0_1025) in
          _0_1026 :: decls
        else decls in
              ...
              | (env_decls,env) ->
                  ((let uu____12549 =
                   ...
                   (let uu____12551 = encode_formula q env in
                    ...
                    | (phi,qdecls) ->
                        let uu____12563 =
                          let _0_1033 = FStar_TypeChecker_Env.get_range tcenv in
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg _0_1033 phi in
                             ...
                             (match uu____12575 with
                              | (label_prefix,label_suffix) ->
                                  ...
                                  let suffix =
                                    ...
                                    FStar_List.append label_suffix _0_1037 in
