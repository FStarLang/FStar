...
let mk_term_projector_name:
  ...
  fun lid  ->
    fun a  ->
      let a1 =
        let uu___383_221 = a in
        let uu____222 =
          FStar_Syntax_Util.unmangle_field_name a.FStar_Syntax_Syntax.ppname in
        {
          FStar_Syntax_Syntax.ppname = uu____222;
          FStar_Syntax_Syntax.index =
            (uu___383_221.FStar_Syntax_Syntax.index);
          FStar_Syntax_Syntax.sort = (uu___383_221.FStar_Syntax_Syntax.sort)
        } in
      let uu____223 =
...
let unmangle: FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv =
  fun x  ->
    let uu___384_1896 = x in
    let uu____1897 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname in
    {
      FStar_Syntax_Syntax.ppname = uu____1897;
      FStar_Syntax_Syntax.index = (uu___384_1896.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___384_1896.FStar_Syntax_Syntax.sort)
    }
type binding =
...
let gen_term_var:
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___385_2483 = env in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (env.depth + (Prims.parse_int "1"));
           tcenv = (uu___385_2483.tcenv);
           warn = (uu___385_2483.warn);
           cache = (uu___385_2483.cache);
           nolabels = (uu___385_2483.nolabels);
           use_zfuel_name = (uu___385_2483.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___385_2483.encode_non_total_function_typ);
           current_module_name = (uu___385_2483.current_module_name)
         }))
let new_term_constant:
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___386_2503 = env in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (uu___386_2503.depth);
           tcenv = (uu___386_2503.tcenv);
           warn = (uu___386_2503.warn);
           cache = (uu___386_2503.cache);
           nolabels = (uu___386_2503.nolabels);
           use_zfuel_name = (uu___386_2503.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___386_2503.encode_non_total_function_typ);
           current_module_name = (uu___386_2503.current_module_name)
         }))
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, []) in
        (ysym, y,
          (let uu___387_2527 = env in
           {
             bindings = ((Binding_var (x, y)) :: (env.bindings));
             depth = (uu___387_2527.depth);
             tcenv = (uu___387_2527.tcenv);
             warn = (uu___387_2527.warn);
             cache = (uu___387_2527.cache);
             nolabels = (uu___387_2527.nolabels);
             use_zfuel_name = (uu___387_2527.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___387_2527.encode_non_total_function_typ);
             current_module_name = (uu___387_2527.current_module_name)
           }))
let push_term_var:
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___388_2540 = env in
        {
          bindings = ((Binding_var (x, t)) :: (env.bindings));
          depth = (uu___388_2540.depth);
          tcenv = (uu___388_2540.tcenv);
          warn = (uu___388_2540.warn);
          cache = (uu___388_2540.cache);
          nolabels = (uu___388_2540.nolabels);
          use_zfuel_name = (uu___388_2540.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___388_2540.encode_non_total_function_typ);
          current_module_name = (uu___388_2540.current_module_name)
        }
let lookup_term_var:
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____2638 =
        ...
        {
          bindings = uu____2640;
          depth = (uu___389_2639.depth);
          tcenv = (uu___389_2639.tcenv);
          warn = (uu___389_2639.warn);
          cache = (uu___389_2639.cache);
          nolabels = (uu___389_2639.nolabels);
          use_zfuel_name = (uu___389_2639.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___389_2639.encode_non_total_function_typ);
          current_module_name = (uu___389_2639.current_module_name)
        } in
...
let push_free_var:
  ...
  fun env  ->
    fun x  ->
      fun fname  ->
        fun ftok  ->
          let uu___390_2892 = env in
          {
            bindings =
              ((Binding_fvar (x, fname, ftok, FStar_Pervasives_Native.None))
              :: (env.bindings));
            depth = (uu___390_2892.depth);
            tcenv = (uu___390_2892.tcenv);
            warn = (uu___390_2892.warn);
            cache = (uu___390_2892.cache);
            nolabels = (uu___390_2892.nolabels);
            use_zfuel_name = (uu___390_2892.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___390_2892.encode_non_total_function_typ);
            current_module_name = (uu___390_2892.current_module_name)
          }
    ...
    fun x  ->
      fun f  ->
        ...
        | (t1,t2,uu____2922) ->
            ...
            let uu___391_2947 = env in
            {
              bindings =
                ((Binding_fvar (x, t1, t2, (FStar_Pervasives_Native.Some t3)))
                :: (env.bindings));
              depth = (uu___391_2947.depth);
              tcenv = (uu___391_2947.tcenv);
              warn = (uu___391_2947.warn);
              cache = (uu___391_2947.cache);
              nolabels = (uu___391_2947.nolabels);
              use_zfuel_name = (uu___391_2947.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___391_2947.encode_non_total_function_typ);
              current_module_name = (uu___391_2947.current_module_name)
            }
                   ...
                   | (vars,guards,env',decls,uu____6350) ->
                       ...
                       let uu____6371 =
                         FStar_TypeChecker_Util.pure_or_ghost_pre_and_post
                           (let uu___392_6380 = env.tcenv in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___392_6380.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___392_6380.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___392_6380.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___392_6380.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___392_6380.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___392_6380.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___392_6380.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___392_6380.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___392_6380.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___392_6380.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___392_6380.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___392_6380.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___392_6380.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___392_6380.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___392_6380.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___392_6380.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___392_6380.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___392_6380.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___392_6380.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___392_6380.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___392_6380.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___392_6380.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___392_6380.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___392_6380.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___392_6380.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qname_and_index =
                                (uu___392_6380.FStar_TypeChecker_Env.qname_and_index);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___392_6380.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth =
                                (uu___392_6380.FStar_TypeChecker_Env.synth);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___392_6380.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___392_6380.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___392_6380.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___392_6380.FStar_TypeChecker_Env.dsenv)
                            }) res in
  ...
  fun t  ->
    fun env  ->
      ...
      | (binders,pre,post,patterns) ->
          let env1 =
            let uu___393_10457 = env in
            {
              bindings = (uu___393_10457.bindings);
              depth = (uu___393_10457.depth);
              tcenv = (uu___393_10457.tcenv);
              warn = (uu___393_10457.warn);
              cache = (uu___393_10457.cache);
              nolabels = (uu___393_10457.nolabels);
              use_zfuel_name = true;
              encode_non_total_function_typ =
                (uu___393_10457.encode_non_total_function_typ);
              current_module_name = (uu___393_10457.current_module_name)
            } in
          let uu____10458 =
           ...
           | (vars,guards,env2,decls,uu____10483) ->
               ...
               (match uu____10496 with
                | (pats,decls') ->
                    ...
                    let env3 =
                      let uu___394_10674 = env2 in
                      {
                        bindings = (uu___394_10674.bindings);
                        depth = (uu___394_10674.depth);
                        tcenv = (uu___394_10674.tcenv);
                        warn = (uu___394_10674.warn);
                        cache = (uu___394_10674.cache);
                        nolabels = true;
                        use_zfuel_name = (uu___394_10674.use_zfuel_name);
                        encode_non_total_function_typ =
                          (uu___394_10674.encode_non_total_function_typ);
                        current_module_name =
                          (uu___394_10674.current_module_name)
                      } in
                    let uu____10675 =
  ...
  fun phi  ->
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            let uu____10831 =
              let uu___395_10832 = f args in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___395_10832.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___395_10832.FStar_SMTEncoding_Term.freevars);
      ...
      let bin_op f uu___369_10911 =
        match uu___369_10911 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
        ...
        | (decls,phis) ->
            let uu____11023 =
              let uu___396_11024 = f phis in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___396_11024.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___396_11024.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              } in
      ...
      let eq_op r args =
        ...
        then
          ...
          (let uu____11134 = enc (bin_op FStar_SMTEncoding_Util.mkEq) in
           uu____11134 r rf) in
      let mk_imp1 r uu___370_11159 =
        match uu___370_11159 with
      ...
      let mk_ite r uu___371_11250 =
        match uu___371_11250 with
                  ...
                  | (tt,decls) ->
                      let uu____12210 =
                        FStar_SMTEncoding_Term.mk_Valid
                          (let uu___397_12213 = tt in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___397_12213.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___397_12213.FStar_SMTEncoding_Term.freevars);
        ...
        | uu____12214 ->
            ...
            (match uu____12215 with
             | (tt,decls) ->
                 let uu____12226 =
                   FStar_SMTEncoding_Term.mk_Valid
                     (let uu___398_12229 = tt in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___398_12229.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___398_12229.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      }) in
                            ...
                            FStar_All.pipe_right p
                              (FStar_List.map
                                 (fun uu____12417  ->
                                    ...
                                    | (t,uu____12427) ->
                                        encode_term t
                                          (let uu___399_12429 = env2 in
                                           {
                                             bindings =
                                               (uu___399_12429.bindings);
                                             depth = (uu___399_12429.depth);
                                             tcenv = (uu___399_12429.tcenv);
                                             warn = (uu___399_12429.warn);
                                             cache = (uu___399_12429.cache);
                                             nolabels =
                                               (uu___399_12429.nolabels);
                                             use_zfuel_name = true;
                                             encode_non_total_function_typ =
                                               (uu___399_12429.encode_non_total_function_typ);
                                             current_module_name =
                                               (uu___399_12429.current_module_name)
                                           }))) in
                            ...
                            then
                              let uu____17033 =
                                FStar_TypeChecker_Env.reify_comp
                                  (let uu___400_17036 = env.tcenv in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___400_17036.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___400_17036.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___400_17036.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___400_17036.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___400_17036.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___400_17036.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       (uu___400_17036.FStar_TypeChecker_Env.expected_typ);
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___400_17036.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___400_17036.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___400_17036.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___400_17036.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___400_17036.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (uu___400_17036.FStar_TypeChecker_Env.letrecs);
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___400_17036.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___400_17036.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___400_17036.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___400_17036.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___400_17036.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax = true;
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___400_17036.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.failhard =
                                       (uu___400_17036.FStar_TypeChecker_Env.failhard);
                                     FStar_TypeChecker_Env.nosynth =
                                       (uu___400_17036.FStar_TypeChecker_Env.nosynth);
                                     FStar_TypeChecker_Env.tc_term =
                                       (uu___400_17036.FStar_TypeChecker_Env.tc_term);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___400_17036.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___400_17036.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       (uu___400_17036.FStar_TypeChecker_Env.use_bv_sorts);
                                     FStar_TypeChecker_Env.qname_and_index =
                                       (uu___400_17036.FStar_TypeChecker_Env.qname_and_index);
                                     FStar_TypeChecker_Env.proof_ns =
                                       (uu___400_17036.FStar_TypeChecker_Env.proof_ns);
                                     FStar_TypeChecker_Env.synth =
                                       (uu___400_17036.FStar_TypeChecker_Env.synth);
                                     FStar_TypeChecker_Env.is_native_tactic =
                                       (uu___400_17036.FStar_TypeChecker_Env.is_native_tactic);
                                     FStar_TypeChecker_Env.identifier_info =
                                       (uu___400_17036.FStar_TypeChecker_Env.identifier_info);
                                     FStar_TypeChecker_Env.tc_hooks =
                                       (uu___400_17036.FStar_TypeChecker_Env.tc_hooks);
                                     FStar_TypeChecker_Env.dsenv =
                                       (uu___400_17036.FStar_TypeChecker_Env.dsenv)
                                  ...
                                  (match uu____17371 with
                                   | (guard,decls11) ->
                                       ...
                                       let uu____17422 =
                                         ...
                                         let uu____17460 =
                                           let env2 =
                                             let uu___401_17466 = env1 in
                                             {
                                               bindings =
                                                 (uu___401_17466.bindings);
                                               depth = (uu___401_17466.depth);
                                               tcenv = (uu___401_17466.tcenv);
                                               warn = (uu___401_17466.warn);
                                               cache = (uu___401_17466.cache);
                                               nolabels =
                                                 (uu___401_17466.nolabels);
                                               use_zfuel_name =
                                                 (uu___401_17466.use_zfuel_name);
                                               encode_non_total_function_typ;
                                               current_module_name =
                                                 (uu___401_17466.current_module_name)
                                             } in
                                           let uu____17467 =
                                             let uu____17468 =
        ...
        | (is_rec,bindings) ->
                      ...
                      FStar_All.pipe_right extra_formals
                        (FStar_List.map
                           (fun uu____18437  ->
                              ...
                              | (x,i) ->
                                  let uu____18448 =
                                    let uu___402_18449 = x in
                                    let uu____18450 =
                                      FStar_Syntax_Subst.subst subst1
                                        x.FStar_Syntax_Syntax.sort in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___402_18449.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___402_18449.FStar_Syntax_Syntax.index);
            ...
            let destruct_bound_function flid t_norm e =
              let get_result_type c =
                ...
                then
                  FStar_TypeChecker_Env.reify_comp
                    (let uu___403_18535 = env.tcenv in
                     {
                       FStar_TypeChecker_Env.solver =
                         (uu___403_18535.FStar_TypeChecker_Env.solver);
                       FStar_TypeChecker_Env.range =
                         (uu___403_18535.FStar_TypeChecker_Env.range);
                       FStar_TypeChecker_Env.curmodule =
                         (uu___403_18535.FStar_TypeChecker_Env.curmodule);
                       FStar_TypeChecker_Env.gamma =
                         (uu___403_18535.FStar_TypeChecker_Env.gamma);
                       FStar_TypeChecker_Env.gamma_cache =
                         (uu___403_18535.FStar_TypeChecker_Env.gamma_cache);
                       FStar_TypeChecker_Env.modules =
                         (uu___403_18535.FStar_TypeChecker_Env.modules);
                       FStar_TypeChecker_Env.expected_typ =
                         (uu___403_18535.FStar_TypeChecker_Env.expected_typ);
                       FStar_TypeChecker_Env.sigtab =
                         (uu___403_18535.FStar_TypeChecker_Env.sigtab);
                       FStar_TypeChecker_Env.is_pattern =
                         (uu___403_18535.FStar_TypeChecker_Env.is_pattern);
                       FStar_TypeChecker_Env.instantiate_imp =
                         (uu___403_18535.FStar_TypeChecker_Env.instantiate_imp);
                       FStar_TypeChecker_Env.effects =
                         (uu___403_18535.FStar_TypeChecker_Env.effects);
                       FStar_TypeChecker_Env.generalize =
                         (uu___403_18535.FStar_TypeChecker_Env.generalize);
                       FStar_TypeChecker_Env.letrecs =
                         (uu___403_18535.FStar_TypeChecker_Env.letrecs);
                       FStar_TypeChecker_Env.top_level =
                         (uu___403_18535.FStar_TypeChecker_Env.top_level);
                       FStar_TypeChecker_Env.check_uvars =
                         (uu___403_18535.FStar_TypeChecker_Env.check_uvars);
                       FStar_TypeChecker_Env.use_eq =
                         (uu___403_18535.FStar_TypeChecker_Env.use_eq);
                       FStar_TypeChecker_Env.is_iface =
                         (uu___403_18535.FStar_TypeChecker_Env.is_iface);
                       FStar_TypeChecker_Env.admit =
                         (uu___403_18535.FStar_TypeChecker_Env.admit);
                       FStar_TypeChecker_Env.lax = true;
                       FStar_TypeChecker_Env.lax_universes =
                         (uu___403_18535.FStar_TypeChecker_Env.lax_universes);
                       FStar_TypeChecker_Env.failhard =
                         (uu___403_18535.FStar_TypeChecker_Env.failhard);
                       FStar_TypeChecker_Env.nosynth =
                         (uu___403_18535.FStar_TypeChecker_Env.nosynth);
                       FStar_TypeChecker_Env.tc_term =
                         (uu___403_18535.FStar_TypeChecker_Env.tc_term);
                       FStar_TypeChecker_Env.type_of =
                         (uu___403_18535.FStar_TypeChecker_Env.type_of);
                       FStar_TypeChecker_Env.universe_of =
                         (uu___403_18535.FStar_TypeChecker_Env.universe_of);
                       FStar_TypeChecker_Env.use_bv_sorts =
                         (uu___403_18535.FStar_TypeChecker_Env.use_bv_sorts);
                       FStar_TypeChecker_Env.qname_and_index =
                         (uu___403_18535.FStar_TypeChecker_Env.qname_and_index);
                       FStar_TypeChecker_Env.proof_ns =
                         (uu___403_18535.FStar_TypeChecker_Env.proof_ns);
                       FStar_TypeChecker_Env.synth =
                         (uu___403_18535.FStar_TypeChecker_Env.synth);
                       FStar_TypeChecker_Env.is_native_tactic =
                         (uu___403_18535.FStar_TypeChecker_Env.is_native_tactic);
                       FStar_TypeChecker_Env.identifier_info =
                         (uu___403_18535.FStar_TypeChecker_Env.identifier_info);
                       FStar_TypeChecker_Env.tc_hooks =
                         (uu___403_18535.FStar_TypeChecker_Env.tc_hooks);
                       FStar_TypeChecker_Env.dsenv =
                         (uu___403_18535.FStar_TypeChecker_Env.dsenv)
                            ...
                            let uu____20077 =
                              ...
                              | (tcenv',uu____20102,e_t) ->
                                  ...
                                  (match uu____20108 with
                                   | (e1,t_norm1) ->
                                       ((let uu___406_20135 = env2 in
                                         {
                                           bindings =
                                             (uu___406_20135.bindings);
                                           depth = (uu___406_20135.depth);
                                           tcenv = tcenv';
                                           warn = (uu___406_20135.warn);
                                           cache = (uu___406_20135.cache);
                                           nolabels =
                                             (uu___406_20135.nolabels);
                                           use_zfuel_name =
                                             (uu___406_20135.use_zfuel_name);
                                           encode_non_total_function_typ =
                                             (uu___406_20135.encode_non_total_function_typ);
                                           current_module_name =
                                             (uu___406_20135.current_module_name)
                                         }), e1, t_norm1)) in
                      ...
                      let encode_rec_lbdefs bindings1 typs2 toks2 env2 =
                        ...
                        | (gtoks,env3) ->
                                  ...
                                  let uu____20896 =
                                    ...
                                    | (tcenv',uu____20925,e_t) ->
                                        ...
                                        (match uu____20931 with
                                         | (e1,t_norm1) ->
                                             ((let uu___407_20958 = env3 in
                                               {
                                                 bindings =
                                                   (uu___407_20958.bindings);
                                                 depth =
                                                   (uu___407_20958.depth);
                                                 tcenv = tcenv';
                                                 warn = (uu___407_20958.warn);
                                                 cache =
                                                   (uu___407_20958.cache);
                                                 nolabels =
                                                   (uu___407_20958.nolabels);
                                                 use_zfuel_name =
                                                   (uu___407_20958.use_zfuel_name);
                                                 encode_non_total_function_typ
                                                   =
                                                   (uu___407_20958.encode_non_total_function_typ);
                                                 current_module_name =
                                                   (uu___407_20958.current_module_name)
                                               }), e1, t_norm1)) in
                            ...
                            (match uu____21541 with
                             | (decls2,eqns,env01) ->
                                 let uu____21862 =
                                   let isDeclFun uu___373_21874 =
                                     match uu___373_21874 with
                                     | FStar_SMTEncoding_Term.DeclFun
                                         uu____21875 -> true
                     ...
                     let val_decl =
                       let uu___410_22822 = se in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___410_22822.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___410_22822.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___410_22822.FStar_Syntax_Syntax.sigattrs)
                       } in
           ...
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 let uu___411_23044 = se in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___411_23044.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___411_23044.FStar_Syntax_Syntax.sigmeta);
                   FStar_Syntax_Syntax.sigattrs =
                     (uu___411_23044.FStar_Syntax_Syntax.sigattrs)
                 } in
...
let get_env: FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____26459 ->
          let uu___412_26462 = e in
          let uu____26463 = FStar_Ident.string_of_lid cmn in
          {
            bindings = (uu___412_26462.bindings);
            depth = (uu___412_26462.depth);
            tcenv;
            warn = (uu___412_26462.warn);
            cache = (uu___412_26462.cache);
            nolabels = (uu___412_26462.nolabels);
            use_zfuel_name = (uu___412_26462.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___412_26462.encode_non_total_function_typ);
...
let push_env: Prims.unit -> Prims.unit =
  fun uu____26578  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___413_26640 = hd1 in
          {
            bindings = (uu___413_26640.bindings);
            depth = (uu___413_26640.depth);
            tcenv = (uu___413_26640.tcenv);
            warn = (uu___413_26640.warn);
            cache = refs;
            nolabels = (uu___413_26640.nolabels);
            use_zfuel_name = (uu___413_26640.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___413_26640.encode_non_total_function_typ);
            current_module_name = (uu___413_26640.current_module_name)
          } in
    ...
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____26846::uu____26847,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___414_26855 = a in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___414_26855.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___414_26855.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___414_26855.FStar_SMTEncoding_Term.assumption_name);
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv in
       ...
       let uu____27069 =
         encode_signature
           (let uu___415_27078 = env in
            {
              bindings = (uu___415_27078.bindings);
              depth = (uu___415_27078.depth);
              tcenv = (uu___415_27078.tcenv);
              warn = false;
              cache = (uu___415_27078.cache);
              nolabels = (uu___415_27078.nolabels);
              use_zfuel_name = (uu___415_27078.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___415_27078.encode_non_total_function_typ);
              current_module_name = (uu___415_27078.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___416_27103 = env1 in
               {
                 bindings = (uu___416_27103.bindings);
                 depth = (uu___416_27103.depth);
                 tcenv = (uu___416_27103.tcenv);
                 warn = true;
                 cache = (uu___416_27103.cache);
                 nolabels = (uu___416_27103.nolabels);
                 use_zfuel_name = (uu___416_27103.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___416_27103.encode_non_total_function_typ);
                 current_module_name = (uu___416_27103.current_module_name)
               });
            (let uu____27105 =
                      ...
                      let uu____27251 =
                        let uu____27254 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___417_27257 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___417_27257.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___417_27257.FStar_Syntax_Syntax.index);
