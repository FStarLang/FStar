...
| FStar_Syntax_Syntax.Tm_ascribed (_79_906, FStar_Util.Inl (t), _79_910) -> begin
Some (t)
end
| FStar_Syntax_Syntax.Tm_ascribed (_79_914, FStar_Util.Inr (c), _79_918) -> begin
...
let _79_930 = (curried_arrow_formals_comp head_type)
in (match (_79_930) with
| (formals, c) -> begin
...
let _79_955 = (FStar_Syntax_Subst.open_term' bs body)
in (match (_79_955) with
| (bs, body, opening) -> begin
(
# 633 "FStar.SMTEncoding.Encode.fst"
let fallback = (fun _79_957 -> (match (()) with
| () -> begin
(
...
let _79_961 = (let _164_640 = (let _164_639 = (FStar_Syntax_Print.term_to_string t0)
...
let _79_973 = (encode_binders None bs env)
in (match (_79_973) with
| (vars, guards, envbody, decls, _79_972) -> begin
(
# 651 "FStar.SMTEncoding.Encode.fst"
let _79_976 = (encode_term body envbody)
in (match (_79_976) with
| (body, decls') -> begin
(
...
let _79_999 = (encode_term_pred None tfun env f)
in (match (_79_999) with
| (f_has_t, decls'') -> begin
(
...
let _79_1003 = (FStar_Util.smap_add env.cache tkey.FStar_SMTEncoding_Term.hash (fsym, cvar_sorts, f_decls))
in (f, f_decls)))))
end))))))))
end)
end))))
...
| FStar_Syntax_Syntax.Tm_let ((_79_1006, {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (_79_1018); FStar_Syntax_Syntax.lbunivs = _79_1016; FStar_Syntax_Syntax.lbtyp = _79_1014; FStar_Syntax_Syntax.lbeff = _79_1012; FStar_Syntax_Syntax.lbdef = _79_1010}::_79_1008), _79_1024) -> begin
(FStar_All.failwith "Impossible: already handled by encoding of Sig_let")
end
| FStar_Syntax_Syntax.Tm_let ((false, {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _79_1033; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = _79_1030; FStar_Syntax_Syntax.lbdef = e1}::[]), e2) -> begin
(encode_let x t1 e1 e2 env encode_term)
end
| FStar_Syntax_Syntax.Tm_let (_79_1043) -> begin
(
# 688 "FStar.SMTEncoding.Encode.fst"
let _79_1045 = (FStar_TypeChecker_Errors.warn t0.FStar_Syntax_Syntax.pos "Non-top-level recursive functions are not yet fully encoded to the SMT solver; you may not be able to prove some facts")
in (
...
let _79_1061 = (encode_term e1 env)
in (match (_79_1061) with
| (ee1, decls1) -> begin
(
# 698 "FStar.SMTEncoding.Encode.fst"
let _79_1064 = (FStar_Syntax_Subst.open_term (((x, None))::[]) e2)
in (match (_79_1064) with
| (xs, e2) -> begin
(
# 699 "FStar.SMTEncoding.Encode.fst"
let _79_1068 = (FStar_List.hd xs)
in (match (_79_1068) with
| (x, _79_1067) -> begin
(
...
let _79_1072 = (encode_body e2 env')
in (match (_79_1072) with
| (ee2, decls2) -> begin
...
let _79_1080 = (encode_term e env)
in (match (_79_1080) with
| (scr, decls) -> begin
(
# 706 "FStar.SMTEncoding.Encode.fst"
let _79_1117 = (FStar_List.fold_right (fun b _79_1084 -> (match (_79_1084) with
| (else_case, decls) -> begin
(
# 707 "FStar.SMTEncoding.Encode.fst"
let _79_1088 = (FStar_Syntax_Subst.open_branch b)
in (match (_79_1088) with
| (p, w, br) -> begin
(
# 708 "FStar.SMTEncoding.Encode.fst"
let patterns = (encode_pat env p)
in (FStar_List.fold_right (fun _79_1092 _79_1095 -> (match ((_79_1092, _79_1095)) with
...
let env = (FStar_All.pipe_right projections (FStar_List.fold_left (fun env _79_1101 -> (match (_79_1101) with
| (x, t) -> begin
(push_term_var env x t)
end)) env))
in (
# 713 "FStar.SMTEncoding.Encode.fst"
let _79_1111 = (match (w) with
| None -> begin
(guard, [])
end
| Some (w) -> begin
...
let _79_1108 = (encode_term w env)
...
in (match (_79_1111) with
| (guard, decls2) -> begin
(
# 718 "FStar.SMTEncoding.Encode.fst"
let _79_1114 = (encode_br br env)
...
let _79_1126 = if (FStar_TypeChecker_Env.debug env.tcenv FStar_Options.Low) then begin
...
let _79_1130 = (FStar_TypeChecker_Util.decorated_pattern_as_term pat)
in (match (_79_1130) with
| (vars, pat_term) -> begin
(
# 735 "FStar.SMTEncoding.Encode.fst"
let _79_1142 = (FStar_All.pipe_right vars (FStar_List.fold_left (fun _79_1133 v -> (match (_79_1133) with
| (env, vars) -> begin
(
# 736 "FStar.SMTEncoding.Encode.fst"
let _79_1139 = (gen_term_var env v)
in (match (_79_1139) with
| (xx, _79_1137, env) -> begin
(env, ((v, (xx, FStar_SMTEncoding_Term.Term_sort)))::vars)
end))
end)) (env, [])))
in (match (_79_1142) with
| (env, vars) -> begin
(
# 739 "FStar.SMTEncoding.Encode.fst"
let rec mk_guard = (fun pat scrutinee -> (match (pat.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_disj (_79_1147) -> begin
(FStar_All.failwith "Impossible")
end
...
let sub_term_guards = (FStar_All.pipe_right args (FStar_List.mapi (fun i _79_1169 -> (match (_79_1169) with
| (arg, _79_1168) -> begin
(
...
| FStar_Syntax_Syntax.Pat_disj (_79_1176) -> begin
(FStar_All.failwith "Impossible")
end
| (FStar_Syntax_Syntax.Pat_dot_term (x, _)) | (FStar_Syntax_Syntax.Pat_var (x)) | (FStar_Syntax_Syntax.Pat_wild (x)) -> begin
((x, scrutinee))::[]
end
| FStar_Syntax_Syntax.Pat_constant (_79_1186) -> begin
[]
end
| FStar_Syntax_Syntax.Pat_cons (f, args) -> begin
(let _164_720 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _79_1196 -> (match (_79_1196) with
| (arg, _79_1195) -> begin
(
...
let pat_term = (fun _79_1199 -> (match (()) with
| () -> begin
...
let _79_1215 = (FStar_All.pipe_right l (FStar_List.fold_left (fun _79_1205 _79_1209 -> (match ((_79_1205, _79_1209)) with
| ((tms, decls), (t, _79_1208)) -> begin
(
# 782 "FStar.SMTEncoding.Encode.fst"
let _79_1212 = (encode_term t env)
in (match (_79_1212) with
| (t, decls') -> begin
...
let _79_1224 = (let _164_733 = (FStar_Syntax_Util.unmeta e)
in (FStar_Syntax_Util.head_and_args _164_733))
in (match (_79_1224) with
| (head, args) -> begin
(match ((let _164_735 = (let _164_734 = (FStar_Syntax_Util.un_uinst head)
in _164_734.FStar_Syntax_Syntax.n)
in (_164_735, args))) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), _79_1228) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
[]
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), _79_1241::(hd, _79_1238)::(tl, _79_1234)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
...
let _79_1246 = (FStar_TypeChecker_Errors.warn e.FStar_Syntax_Syntax.pos "SMT pattern is not a list literal; ignoring the pattern")
in [])
end)
end)))
in (
...
let _79_1252 = (let _164_739 = (FStar_Syntax_Util.unmeta p)
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_79_1260, _79_1262)::(e, _79_1257)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.smtpat_lid) -> begin
(e, None)
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (e, _79_1270)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.smtpatT_lid) -> begin
(e, None)
end
| _79_1275 -> begin
...
let _79_1283 = (let _164_746 = (FStar_Syntax_Util.unmeta t)
in (FStar_All.pipe_right _164_746 FStar_Syntax_Util.head_and_args))
in (match (_79_1283) with
| (head, args) -> begin
(match ((let _164_748 = (let _164_747 = (FStar_Syntax_Util.un_uinst head)
in _164_747.FStar_Syntax_Syntax.n)
in (_164_748, args))) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (e, _79_1288)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.smtpatOr_lid) -> begin
Some (e)
end
| _79_1293 -> begin
None
...
let _79_1336 = (match ((let _164_754 = (FStar_Syntax_Subst.compress t)
in _164_754.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(
# 822 "FStar.SMTEncoding.Encode.fst"
let _79_1309 = (FStar_Syntax_Subst.open_comp binders c)
in (match (_79_1309) with
| (binders, c) -> begin
(
# 823 "FStar.SMTEncoding.Encode.fst"
let ct = (FStar_Syntax_Util.comp_to_comp_typ c)
in (match (ct.FStar_Syntax_Syntax.effect_args) with
| (pre, _79_1321)::(post, _79_1317)::(pats, _79_1313)::[] -> begin
(
...
in (match (_79_1336) with
| (binders, pre, post, patterns) -> begin
(
# 834 "FStar.SMTEncoding.Encode.fst"
let _79_1343 = (encode_binders None binders env)
in (match (_79_1343) with
| (vars, guards, env, decls, _79_1342) -> begin
(
# 837 "FStar.SMTEncoding.Encode.fst"
let _79_1356 = (let _164_759 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (
# 838 "FStar.SMTEncoding.Encode.fst"
let _79_1353 = (let _164_758 = (FStar_All.pipe_right branch (FStar_List.map (fun _79_1348 -> (match (_79_1348) with
| (t, _79_1347) -> begin
(encode_term t (
# 838 "FStar.SMTEncoding.Encode.fst"
let _79_1349 = env
in {bindings = _79_1349.bindings; depth = _79_1349.depth; tcenv = _79_1349.tcenv; warn = _79_1349.warn; cache = _79_1349.cache; nolabels = _79_1349.nolabels; use_zfuel_name = true; encode_non_total_function_typ = _79_1349.encode_non_total_function_typ}))
end))))
in (FStar_All.pipe_right _164_758 FStar_List.unzip))
in (match (_79_1353) with
| (pats, decls) -> begin
(pats, decls)
end)))))
in (FStar_All.pipe_right _164_759 FStar_List.unzip))
in (match (_79_1356) with
| (pats, decls') -> begin
(
...
# 858 "FStar.SMTEncoding.Encode.fst"
let _79_1380 = env
in {bindings = _79_1380.bindings; depth = _79_1380.depth; tcenv = _79_1380.tcenv; warn = _79_1380.warn; cache = _79_1380.cache; nolabels = true; use_zfuel_name = _79_1380.use_zfuel_name; encode_non_total_function_typ = _79_1380.encode_non_total_function_typ})
in (
# 859 "FStar.SMTEncoding.Encode.fst"
let _79_1385 = (let _164_772 = (FStar_Syntax_Util.unmeta pre)
in (encode_formula _164_772 env))
in (match (_79_1385) with
| (pre, decls'') -> begin
(
# 860 "FStar.SMTEncoding.Encode.fst"
let _79_1388 = (let _164_773 = (FStar_Syntax_Util.unmeta post)
in (encode_formula _164_773 env))
in (match (_79_1388) with
| (post, decls''') -> begin
(
...
let _79_1404 = (FStar_Util.fold_map (fun decls x -> (
# 871 "FStar.SMTEncoding.Encode.fst"
let _79_1401 = (encode_term (Prims.fst x) env)
in (match (_79_1401) with
| (t, decls') -> begin
...
let _79_1435 = (FStar_List.fold_right (fun _79_1426 _79_1429 -> (match ((_79_1426, _79_1429)) with
| ((t, _79_1425), (phis, decls)) -> begin
(
# 883 "FStar.SMTEncoding.Encode.fst"
let _79_1432 = (encode_formula t env)
in (match (_79_1432) with
| (phi, decls') -> begin
((phi)::phis, (FStar_List.append decls' decls))
end))
end)) l ([], []))
in (match (_79_1435) with
| (phis, decls) -> begin
(let _164_839 = (f phis)
in (_164_839, decls))
end)))
...
| (lhs, _79_1453)::(rhs, _79_1449)::[] -> begin
(
# 894 "FStar.SMTEncoding.Encode.fst"
let _79_1458 = (encode_formula rhs env)
in (match (_79_1458) with
| (l1, decls1) -> begin
(match (l1.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.True, _79_1461) -> begin
(l1, decls1)
end
| _79_1465 -> begin
(
# 898 "FStar.SMTEncoding.Encode.fst"
let _79_1468 = (encode_formula lhs env)
...
| (guard, _79_1483)::(_then, _79_1479)::(_else, _79_1475)::[] -> begin
(
# 905 "FStar.SMTEncoding.Encode.fst"
let _79_1488 = (encode_formula guard env)
in (match (_79_1488) with
| (g, decls1) -> begin
(
# 906 "FStar.SMTEncoding.Encode.fst"
let _79_1491 = (encode_formula _then env)
in (match (_79_1491) with
| (t, decls2) -> begin
(
# 907 "FStar.SMTEncoding.Encode.fst"
let _79_1494 = (encode_formula _else env)
...
let _79_1515 = (encode_formula phi' env)
...
let _79_1522 = (encode_match e pats FStar_SMTEncoding_Term.mkFalse env encode_formula)
in (match (_79_1522) with
| (t, decls) -> begin
(t, decls)
end))
end
| FStar_Syntax_Syntax.Tm_let ((false, {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _79_1529; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = _79_1526; FStar_Syntax_Syntax.lbdef = e1}::[]), e2) -> begin
(
# 936 "FStar.SMTEncoding.Encode.fst"
let _79_1540 = (encode_let x t1 e1 e2 env encode_formula)
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), _79_1557::(x, _79_1554)::(t, _79_1550)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.has_type_lid) -> begin
(
# 943 "FStar.SMTEncoding.Encode.fst"
let _79_1562 = (encode_term x env)
in (match (_79_1562) with
| (x, decls) -> begin
(
# 944 "FStar.SMTEncoding.Encode.fst"
let _79_1565 = (encode_term t env)
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), _79_1583::_79_1581::(r, _79_1578)::(msg, _79_1574)::(phi, _79_1570)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.labeled_lid) -> begin
...
| (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_range (r)), FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (s, _79_1591))) -> begin
(
...
| _79_1600 when (head_redex env head) -> begin
...
let _79_1605 = (encode_term phi env)
...
let _79_1610 = (encode_term phi env)
...
let _79_1622 = (encode_binders None bs env)
in (match (_79_1622) with
| (vars, guards, env, decls, _79_1621) -> begin
(
# 970 "FStar.SMTEncoding.Encode.fst"
let _79_1635 = (let _164_932 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (
# 971 "FStar.SMTEncoding.Encode.fst"
let _79_1632 = (let _164_931 = (FStar_All.pipe_right p (FStar_List.map (fun _79_1627 -> (match (_79_1627) with
| (t, _79_1626) -> begin
(encode_term t (
# 971 "FStar.SMTEncoding.Encode.fst"
let _79_1628 = env
in {bindings = _79_1628.bindings; depth = _79_1628.depth; tcenv = _79_1628.tcenv; warn = _79_1628.warn; cache = _79_1628.cache; nolabels = _79_1628.nolabels; use_zfuel_name = true; encode_non_total_function_typ = _79_1628.encode_non_total_function_typ}))
end))))
...
in (match (_79_1635) with
| (pats, decls') -> begin
(
# 973 "FStar.SMTEncoding.Encode.fst"
let _79_1638 = (encode_formula body env)
...
(match ((FStar_All.pipe_right connectives (FStar_List.tryFind (fun _79_1651 -> (match (_79_1651) with
| (l, _79_1650) -> begin
...
let _79_1664 = if (FStar_TypeChecker_Env.debug env.tcenv FStar_Options.Low) then begin
...
let _79_1671 = (encode_q_body env vars pats body)
...
let _79_1683 = (encode_q_body env vars pats body)
...
let _79_1689 = (fresh_fvar "a" FStar_SMTEncoding_Term.Term_sort)
in (match (_79_1689) with
| (asym, a) -> begin
(
# 1012 "FStar.SMTEncoding.Encode.fst"
let _79_1692 = (fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (_79_1692) with
| (xsym, x) -> begin
(
# 1013 "FStar.SMTEncoding.Encode.fst"
let _79_1695 = (fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort)
...
let mk = (fun l v -> (let _164_1199 = (FStar_All.pipe_right prims (FStar_List.filter (fun _79_1715 -> (match (_79_1715) with
| (l', _79_1714) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _164_1199 (FStar_List.collect (fun _79_1719 -> (match (_79_1719) with
| (_79_1717, b) -> begin
(b v)
end))))))
in (
# 1042 "FStar.SMTEncoding.Encode.fst"
let is = (fun l -> (FStar_All.pipe_right prims (FStar_Util.for_some (fun _79_1725 -> (match (_79_1725) with
| (l', _79_1724) -> begin
(FStar_Ident.lid_equals l l')
end)))))
in {mk = mk; is = is}))))))))
...
let _79_1731 = (fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (_79_1731) with
| (xxsym, xx) -> begin
(
# 1049 "FStar.SMTEncoding.Encode.fst"
let _79_1734 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
in (match (_79_1734) with
| (ffsym, ff) -> begin
(
...
let mk_ref = (fun env reft_name _79_1777 -> (
...
let mk_and_interp = (fun env conj _79_1794 -> (
...
let mk_or_interp = (fun env disj _79_1806 -> (
...
in (fun env t s tt -> (match ((FStar_Util.find_opt (fun _79_1892 -> (match (_79_1892) with
| (l, _79_1891) -> begin
...
let _79_1901 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env.tcenv) (FStar_Options.Other ("SMTEncoding"))) then begin
...
let _79_1909 = (encode_sigelt' env se)
in (match (_79_1909) with
| (g, e) -> begin
(match (g) with
| [] -> begin
...
let _79_1925 = (encode_free_var env lid t tt quals)
in (match (_79_1925) with
| (decls, env) -> begin
...
let encode_top_level_vals = (fun env bindings quals -> (FStar_All.pipe_right bindings (FStar_List.fold_left (fun _79_1932 lb -> (match (_79_1932) with
| (decls, env) -> begin
(
# 1248 "FStar.SMTEncoding.Encode.fst"
let _79_1936 = (let _164_1788 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (encode_top_level_val env _164_1788 lb.FStar_Syntax_Syntax.lbtyp quals))
in (match (_79_1936) with
| (decls', env) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, _79_1954, _79_1956, _79_1958, _79_1960) when (FStar_Ident.lid_equals lid FStar_Syntax_Const.precedes_lid) -> begin
(
# 1260 "FStar.SMTEncoding.Encode.fst"
let _79_1966 = (new_term_constant_and_tok_from_lid env lid)
in (match (_79_1966) with
| (tname, ttok, env) -> begin
([], env)
end))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, _79_1969, t, quals, _79_1973) -> begin
(
...
let _79_1991 = (encode_top_level_val env fv t quals)
in (match (_79_1991) with
| (decls, env) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (l, f, _79_1997, _79_1999) -> begin
(
# 1278 "FStar.SMTEncoding.Encode.fst"
let _79_2004 = (encode_formula f env)
in (match (_79_2004) with
| (f, decls) -> begin
(
...
| FStar_Syntax_Syntax.Sig_let (lbs, r, _79_2009, quals) when (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Irreducible)) -> begin
([], env)
end
| FStar_Syntax_Syntax.Sig_let ((_79_2014, {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (b2t); FStar_Syntax_Syntax.lbunivs = _79_2022; FStar_Syntax_Syntax.lbtyp = _79_2020; FStar_Syntax_Syntax.lbeff = _79_2018; FStar_Syntax_Syntax.lbdef = _79_2016}::[]), _79_2029, _79_2031, _79_2033) when (FStar_Syntax_Syntax.fv_eq_lid b2t FStar_Syntax_Const.b2t_lid) -> begin
(
# 1286 "FStar.SMTEncoding.Encode.fst"
let _79_2039 = (new_term_constant_and_tok_from_lid env b2t.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (_79_2039) with
| (tname, ttok, env) -> begin
(
...
| FStar_Syntax_Syntax.Sig_let (_79_2045, _79_2047, _79_2049, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun _79_13 -> (match (_79_13) with
...
| FStar_Syntax_Syntax.Sig_let ((false, lb::[]), _79_2065, _79_2067, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun _79_14 -> (match (_79_14) with
| FStar_Syntax_Syntax.Projector (_79_2073) -> begin
true
end
| _79_2076 -> begin
false
...
| FStar_Syntax_Syntax.Sig_let ((is_rec, bindings), _79_2088, _79_2090, quals) -> begin
(
...
let _79_2102 = (FStar_Util.first_N nbinders formals)
in (match (_79_2102) with
| (formals, extra_formals) -> begin
(
# 1319 "FStar.SMTEncoding.Encode.fst"
let subst = (FStar_List.map2 (fun _79_2106 _79_2110 -> (match ((_79_2106, _79_2110)) with
| ((formal, _79_2105), (binder, _79_2109)) -> begin
...
let extra_formals = (let _164_1825 = (FStar_All.pipe_right extra_formals (FStar_List.map (fun _79_2114 -> (match (_79_2114) with
| (x, i) -> begin
(let _164_1824 = (
# 1320 "FStar.SMTEncoding.Encode.fst"
let _79_2115 = x
in (let _164_1823 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _79_2115.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _79_2115.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _164_1823}))
in (_164_1824, i))
end))))
...
let _79_2134 = (FStar_Syntax_Subst.open_term' binders body)
in (match (_79_2134) with
...
let _79_2141 = (FStar_Syntax_Subst.open_comp formals c)
in (match (_79_2141) with
| (formals, c) -> begin
(
...
let _79_2148 = (FStar_Util.first_N nformals binders)
in (match (_79_2148) with
| (bs0, rest) -> begin
(
# 1338 "FStar.SMTEncoding.Encode.fst"
let c = (
# 1339 "FStar.SMTEncoding.Encode.fst"
let subst = (FStar_List.map2 (fun _79_2152 _79_2156 -> (match ((_79_2152, _79_2156)) with
| ((b, _79_2151), (x, _79_2155)) -> begin
...
let _79_2162 = (eta_expand binders formals body tres)
in (match (_79_2162) with
| (binders, body) -> begin
...
| FStar_Syntax_Syntax.Tm_refine (x, _79_2165) -> begin
(aux true x.FStar_Syntax_Syntax.sort)
end
| _79_2169 when (not (norm)) -> begin
(
...
let _79_2181 = (FStar_Syntax_Subst.open_comp formals c)
in (match (_79_2181) with
| (formals, c) -> begin
(
...
let _79_2185 = (eta_expand [] formals e tres)
in (match (_79_2185) with
| (binders, body) -> begin
(binders, body, formals, tres)
end)))
end))
...
let _79_2215 = (FStar_All.pipe_right bindings (FStar_List.fold_left (fun _79_2202 lb -> (match (_79_2202) with
| (toks, typs, decls, env) -> begin
(
# 1374 "FStar.SMTEncoding.Encode.fst"
let _79_2204 = if (FStar_Syntax_Util.is_lemma lb.FStar_Syntax_Syntax.lbtyp) then begin
...
let _79_2210 = (let _164_1857 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (declare_top_level_let env _164_1857 lb.FStar_Syntax_Syntax.lbtyp t_norm))
in (match (_79_2210) with
| (tok, decl, env) -> begin
...
| ({FStar_Syntax_Syntax.lbname = _79_2232; FStar_Syntax_Syntax.lbunivs = _79_2230; FStar_Syntax_Syntax.lbtyp = _79_2228; FStar_Syntax_Syntax.lbeff = _79_2226; FStar_Syntax_Syntax.lbdef = e}::[], t_norm::[], (flid_fv, (f, ftok))::[]) -> begin
(
...
let _79_2252 = (destruct_bound_function flid t_norm e)
in (match (_79_2252) with
| (binders, body, _79_2249, _79_2251) -> begin
(
# 1390 "FStar.SMTEncoding.Encode.fst"
let _79_2259 = (encode_binders None binders env)
in (match (_79_2259) with
| (vars, guards, env', binder_decls, _79_2258) -> begin
(
...
let _79_2268 = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Logic)) then begin
...
let _79_2289 = (FStar_All.pipe_right toks (FStar_List.fold_left (fun _79_2277 _79_2282 -> (match ((_79_2277, _79_2282)) with
...
let encode_one_binding = (fun env0 _79_2298 t_norm _79_2309 -> (match ((_79_2298, _79_2309)) with
| ((flid, f, ftok, g, gtok), {FStar_Syntax_Syntax.lbname = _79_2308; FStar_Syntax_Syntax.lbunivs = _79_2306; FStar_Syntax_Syntax.lbtyp = _79_2304; FStar_Syntax_Syntax.lbeff = _79_2302; FStar_Syntax_Syntax.lbdef = e}) -> begin
(
# 1413 "FStar.SMTEncoding.Encode.fst"
let _79_2314 = (destruct_bound_function flid t_norm e)
in (match (_79_2314) with
| (binders, body, formals, tres) -> begin
(
# 1414 "FStar.SMTEncoding.Encode.fst"
let _79_2321 = (encode_binders None binders env)
in (match (_79_2321) with
| (vars, guards, env', binder_decls, _79_2320) -> begin
(
...
let _79_2331 = (encode_term body env')
in (match (_79_2331) with
...
let _79_2341 = (encode_binders None formals env0)
in (match (_79_2341) with
| (vars, v_guards, env, binder_decls, _79_2340) -> begin
(
...
let _79_2348 = (encode_term_pred None tres env gapp)
in (match (_79_2348) with
| (g_typing, d3) -> begin
...
in (match (_79_2351) with
| (aux_decls, typing_corr) -> begin
((FStar_List.append binder_decls aux_decls), (FStar_List.append typing_corr ((tok_corr)::[])))
end)))))
end))
in (match (_79_2354) with
...
let _79_2370 = (let _164_1940 = (FStar_List.zip3 gtoks typs bindings)
in (FStar_List.fold_left (fun _79_2358 _79_2362 -> (match ((_79_2358, _79_2362)) with
| ((decls, eqns, env0), (gtok, ty, bs)) -> begin
(
# 1443 "FStar.SMTEncoding.Encode.fst"
let _79_2366 = (encode_one_binding env0 gtok ty bs)
in (match (_79_2366) with
...
let _79_2379 = (let _164_1942 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _164_1942 (FStar_List.partition (fun _79_16 -> (match (_79_16) with
| FStar_SMTEncoding_Term.DeclFun (_79_2373) -> begin
true
end
| _79_2376 -> begin
false
end)))))
in (match (_79_2379) with
...
| FStar_Syntax_Syntax.Sig_bundle (ses, _79_2383, _79_2385, _79_2387) -> begin
(
# 1457 "FStar.SMTEncoding.Encode.fst"
let _79_2392 = (encode_signature env ses)
in (match (_79_2392) with
| (g, env) -> begin
(
# 1458 "FStar.SMTEncoding.Encode.fst"
let _79_2404 = (FStar_All.pipe_right g (FStar_List.partition (fun _79_17 -> (match (_79_17) with
| FStar_SMTEncoding_Term.Assume (_79_2395, Some ("inversion axiom")) -> begin
false
end
| _79_2401 -> begin
true
...
let _79_2413 = (FStar_All.pipe_right g' (FStar_List.partition (fun _79_18 -> (match (_79_18) with
| FStar_SMTEncoding_Term.DeclFun (_79_2407) -> begin
true
end
| _79_2410 -> begin
false
end))))
in (match (_79_2413) with
| (decls, rest) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (t, _79_2416, tps, k, _79_2420, datas, quals, _79_2424) -> begin
(
...
let _79_2443 = c
in (match (_79_2443) with
| (name, args, _79_2438, _79_2440, _79_2442) -> begin
...
let _79_2450 = (fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (_79_2450) with
| (xxsym, xx) -> begin
(
# 1479 "FStar.SMTEncoding.Encode.fst"
let _79_2486 = (FStar_All.pipe_right datas (FStar_List.fold_left (fun _79_2453 l -> (match (_79_2453) with
| (out, decls) -> begin
(
# 1480 "FStar.SMTEncoding.Encode.fst"
let _79_2458 = (FStar_TypeChecker_Env.lookup_datacon env.tcenv l)
in (match (_79_2458) with
| (_79_2456, data_t) -> begin
(
# 1481 "FStar.SMTEncoding.Encode.fst"
let _79_2461 = (FStar_Syntax_Util.arrow_formals data_t)
in (match (_79_2461) with
| (args, res) -> begin
(
...
| FStar_Syntax_Syntax.Tm_app (_79_2463, indices) -> begin
indices
end
| _79_2468 -> begin
[]
...
let env = (FStar_All.pipe_right args (FStar_List.fold_left (fun env _79_2474 -> (match (_79_2474) with
| (x, _79_2473) -> begin
...
let _79_2478 = (encode_args indices env)
in (match (_79_2478) with
| (indices, decls') -> begin
(
# 1489 "FStar.SMTEncoding.Encode.fst"
let _79_2479 = if ((FStar_List.length indices) <> (FStar_List.length vars)) then begin
(FStar_All.failwith "Impossible")
end else begin
()
end
...
in (match (_79_2486) with
| (data_ax, decls) -> begin
(
# 1493 "FStar.SMTEncoding.Encode.fst"
let _79_2489 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
in (match (_79_2489) with
| (ffsym, ff) -> begin
(
...
let _79_2499 = (match ((let _164_1986 = (FStar_Syntax_Subst.compress k)
...
in (match (_79_2499) with
| (formals, res) -> begin
(
# 1504 "FStar.SMTEncoding.Encode.fst"
let _79_2502 = (FStar_Syntax_Subst.open_term formals res)
in (match (_79_2502) with
| (formals, res) -> begin
(
# 1505 "FStar.SMTEncoding.Encode.fst"
let _79_2509 = (encode_binders None formals env)
in (match (_79_2509) with
| (vars, guards, env', binder_decls, _79_2508) -> begin
(
# 1507 "FStar.SMTEncoding.Encode.fst"
let _79_2513 = (new_term_constant_and_tok_from_lid env t)
in (match (_79_2513) with
| (tname, ttok, env) -> begin
(
...
let tname_decl = (let _164_1992 = (let _164_1991 = (FStar_All.pipe_right vars (FStar_List.map (fun _79_2519 -> (match (_79_2519) with
| (n, s) -> begin
...
in (match (_79_2531) with
| (tok_decls, env) -> begin
((FStar_List.append tname_decl tok_decls), env)
end)))
in (match (_79_2534) with
| (decls, env) -> begin
(
# 1525 "FStar.SMTEncoding.Encode.fst"
let kindingAx = (
# 1526 "FStar.SMTEncoding.Encode.fst"
let _79_2537 = (encode_term_pred None res env' tapp)
in (match (_79_2537) with
| (k, decls) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (d, _79_2544, _79_2546, _79_2548, _79_2550, _79_2552, _79_2554, _79_2556) when (FStar_Ident.lid_equals d FStar_Syntax_Const.lexcons_lid) -> begin
([], env)
end
| FStar_Syntax_Syntax.Sig_datacon (d, _79_2561, t, _79_2564, n_tps, quals, _79_2568, drange) -> begin
(
# 1545 "FStar.SMTEncoding.Encode.fst"
let _79_2575 = (new_term_constant_and_tok_from_lid env d)
in (match (_79_2575) with
...
let _79_2579 = (FStar_Syntax_Util.arrow_formals t)
in (match (_79_2579) with
| (formals, t_res) -> begin
(
# 1548 "FStar.SMTEncoding.Encode.fst"
let _79_2582 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
in (match (_79_2582) with
...
let _79_2589 = (encode_binders (Some (fuel_tm)) formals env)
in (match (_79_2589) with
...
let _79_2599 = (encode_term_pred None t env ddtok_tm)
in (match (_79_2599) with
| (tok_typing, decls3) -> begin
(
# 1560 "FStar.SMTEncoding.Encode.fst"
let _79_2606 = (encode_binders (Some (fuel_tm)) formals env)
in (match (_79_2606) with
| (vars', guards', env'', decls_formals, _79_2605) -> begin
(
...
let encode_elim = (fun _79_2618 -> (match (()) with
| () -> begin
(
# 1571 "FStar.SMTEncoding.Encode.fst"
let _79_2621 = (FStar_Syntax_Util.head_and_args t_res)
in (match (_79_2621) with
| (head, args) -> begin
...
let _79_2639 = (encode_args args env')
in (match (_79_2639) with
| (encoded_args, arg_decls) -> begin
(
# 1577 "FStar.SMTEncoding.Encode.fst"
let _79_2654 = (FStar_List.fold_left (fun _79_2643 arg -> (match (_79_2643) with
| (env, arg_vars, eqns) -> begin
(
# 1578 "FStar.SMTEncoding.Encode.fst"
let _79_2649 = (let _164_2027 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env _164_2027))
in (match (_79_2649) with
| (_79_2646, xv, env) -> begin
(let _164_2029 = (let _164_2028 = (FStar_SMTEncoding_Term.mkEq (arg, xv))
in (_164_2028)::eqns)
in (env, (xv)::arg_vars, _164_2029))
end))
end)) (env', [], []) encoded_args)
in (match (_79_2654) with
| (_79_2651, arg_vars, eqns) -> begin
(
...
let _79_2673 = (let _164_2060 = (let _164_2059 = (FStar_Syntax_Print.lid_to_string d)
...
let _79_2686 = (encode_free_var env x t t_norm [])
in (match (_79_2686) with
| (decls, env) -> begin
(
# 1628 "FStar.SMTEncoding.Encode.fst"
let _79_2691 = (lookup_lid env x.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (_79_2691) with
| (n, x', _79_2690) -> begin
((n, x'), decls, env)
end))
end))
end
| Some (n, x, _79_2695) -> begin
((n, x), [], env)
end))
...
let _79_2704 = (encode_function_type_as_formula None None t env)
in (match (_79_2704) with
| (form, decls) -> begin
...
let _79_2714 = (new_term_constant_and_tok_from_lid env lid)
in (match (_79_2714) with
...
| FStar_Syntax_Syntax.Tm_arrow (binders, _79_2717) -> begin
(FStar_All.pipe_right binders (FStar_List.map (fun _79_2720 -> FStar_SMTEncoding_Term.Term_sort)))
end
| _79_2723 -> begin
[]
end)
...
let _79_2733 = (curried_arrow_formals_comp t_norm)
...
in (match (_79_2738) with
| (formals, (pre_opt, res_t)) -> begin
(
# 1660 "FStar.SMTEncoding.Encode.fst"
let _79_2742 = (new_term_constant_and_tok_from_lid env lid)
in (match (_79_2742) with
| (vname, vtok, env) -> begin
(
...
let _79_2761 = (FStar_Util.prefix vars)
in (match (_79_2761) with
| (_79_2756, (xxsym, _79_2759)) -> begin
(
...
let _79_2773 = (FStar_Util.prefix vars)
in (match (_79_2773) with
| (_79_2768, (xxsym, _79_2771)) -> begin
(
...
let _79_2785 = (encode_binders None formals env)
in (match (_79_2785) with
| (vars, guards, env', decls1, _79_2784) -> begin
(
# 1680 "FStar.SMTEncoding.Encode.fst"
let _79_2794 = (match (pre_opt) with
| None -> begin
...
let vname_decl = (let _164_2132 = (let _164_2131 = (FStar_All.pipe_right formals (FStar_List.map (fun _79_2797 -> FStar_SMTEncoding_Term.Term_sort)))
...
# 1689 "FStar.SMTEncoding.Encode.fst"
let _79_2800 = env
in {bindings = _79_2800.bindings; depth = _79_2800.depth; tcenv = _79_2800.tcenv; warn = _79_2800.warn; cache = _79_2800.cache; nolabels = _79_2800.nolabels; use_zfuel_name = _79_2800.use_zfuel_name; encode_non_total_function_typ = encode_non_total_function_typ})
in if (not ((head_normal env tt))) then begin
(encode_term_pred None tt env vtok_tm)
end else begin
(encode_term_pred None t_norm env vtok_tm)
end)
in (match (_79_2805) with
...
let _79_2815 = (match (formals) with
| [] -> begin
...
in (match (_79_2815) with
| (tok_decl, env) -> begin
((vname_decl)::tok_decl, env)
end)))
end)))
in (match (_79_2818) with
| (decls2, env) -> begin
(
...
and encode_signature : env_t  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_SMTEncoding_Term.decl Prims.list * env_t) = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun _79_2834 se -> (match (_79_2834) with
| (g, env) -> begin
(
# 1718 "FStar.SMTEncoding.Encode.fst"
let _79_2838 = (encode_sigelt env se)
in (match (_79_2838) with
| (g', env) -> begin
...
let encode_binding = (fun b _79_2845 -> (match (_79_2845) with
| (decls, env) -> begin
(match (b) with
| FStar_TypeChecker_Env.Binding_univ (_79_2847) -> begin
([], env)
end
| FStar_TypeChecker_Env.Binding_var (x) -> begin
(
# 1751 "FStar.SMTEncoding.Encode.fst"
let _79_2854 = (new_term_constant env x)
in (match (_79_2854) with
| (xxsym, xx, env') -> begin
(
...
let _79_2856 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env.tcenv) (FStar_Options.Other ("Encoding"))) then begin
...
let _79_2860 = (encode_term_pred None t1 env xx)
in (match (_79_2860) with
| (t, decls') -> begin
(
...
| FStar_TypeChecker_Env.Binding_lid (x, (_79_2865, t)) -> begin
(
...
let _79_2874 = (encode_free_var env fv t t_norm [])
in (match (_79_2874) with
| (g, env') -> begin
...
let _79_2888 = (encode_sigelt env se)
in (match (_79_2888) with
| (g, env') -> begin
((FStar_List.append decls g), env')
end))
end)
...
let prefix = (FStar_All.pipe_right labs (FStar_List.map (fun _79_2895 -> (match (_79_2895) with
| (l, _79_2892, _79_2894) -> begin
FStar_SMTEncoding_Term.DeclFun (((Prims.fst l), [], FStar_SMTEncoding_Term.Bool_sort, None))
end))))
in (
# 1781 "FStar.SMTEncoding.Encode.fst"
let suffix = (FStar_All.pipe_right labs (FStar_List.collect (fun _79_2902 -> (match (_79_2902) with
| (l, _79_2899, _79_2901) -> begin
...
let _79_2911 = e
in {bindings = _79_2911.bindings; depth = _79_2911.depth; tcenv = tcenv; warn = _79_2911.warn; cache = _79_2911.cache; nolabels = _79_2911.nolabels; use_zfuel_name = _79_2911.use_zfuel_name; encode_non_total_function_typ = _79_2911.encode_non_total_function_typ})
end))
...
let push_env : Prims.unit  ->  Prims.unit = (fun _79_2919 -> (match (()) with
| () -> begin
...
# 1799 "FStar.SMTEncoding.Encode.fst"
let _79_2925 = hd
in {bindings = _79_2925.bindings; depth = _79_2925.depth; tcenv = _79_2925.tcenv; warn = _79_2925.warn; cache = refs; nolabels = _79_2925.nolabels; use_zfuel_name = _79_2925.use_zfuel_name; encode_non_total_function_typ = _79_2925.encode_non_total_function_typ})
in (FStar_ST.op_Colon_Equals last_env ((top)::(hd)::tl))))
end)
end))

# 1801 "FStar.SMTEncoding.Encode.fst"
let pop_env : Prims.unit  ->  Prims.unit = (fun _79_2928 -> (match (()) with
| () -> begin
(match ((FStar_ST.read last_env)) with
| [] -> begin
...
let mark_env : Prims.unit  ->  Prims.unit = (fun _79_2934 -> (match (()) with
| () -> begin
(push_env ())
end))

# 1805 "FStar.SMTEncoding.Encode.fst"
let reset_mark_env : Prims.unit  ->  Prims.unit = (fun _79_2935 -> (match (()) with
| () -> begin
(pop_env ())
end))

# 1806 "FStar.SMTEncoding.Encode.fst"
let commit_mark_env : Prims.unit  ->  Prims.unit = (fun _79_2936 -> (match (()) with
| () -> begin
(match ((FStar_ST.read last_env)) with
| hd::_79_2939::tl -> begin
...
let _79_2946 = (init_env tcenv)
in (
# 1814 "FStar.SMTEncoding.Encode.fst"
let _79_2948 = (FStar_SMTEncoding_Z3.init ())
...
let _79_2982 = (encode_sigelt env se)
in (match (_79_2982) with
| (decls, env) -> begin
(
# 1843 "FStar.SMTEncoding.Encode.fst"
let _79_2983 = (set_env env)
...
let _79_2988 = if (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) then begin
...
let _79_2995 = (encode_signature (
# 1851 "FStar.SMTEncoding.Encode.fst"
let _79_2991 = env
in {bindings = _79_2991.bindings; depth = _79_2991.depth; tcenv = _79_2991.tcenv; warn = false; cache = _79_2991.cache; nolabels = _79_2991.nolabels; use_zfuel_name = _79_2991.use_zfuel_name; encode_non_total_function_typ = _79_2991.encode_non_total_function_typ}) modul.FStar_Syntax_Syntax.exports)
in (match (_79_2995) with
| (decls, env) -> begin
(
...
let _79_3001 = (set_env (
# 1857 "FStar.SMTEncoding.Encode.fst"
let _79_2999 = env
in {bindings = _79_2999.bindings; depth = _79_2999.depth; tcenv = _79_2999.tcenv; warn = true; cache = _79_2999.cache; nolabels = _79_2999.nolabels; use_zfuel_name = _79_2999.use_zfuel_name; encode_non_total_function_typ = _79_2999.encode_non_total_function_typ}))
in (
# 1858 "FStar.SMTEncoding.Encode.fst"
let _79_3003 = if (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) then begin
...
let _79_3009 = (let _164_2253 = (let _164_2252 = (let _164_2251 = (FStar_TypeChecker_Env.get_range tcenv)
...
let pop = (fun _79_3012 -> (match (()) with
| () -> begin
...
let _79_3025 = (aux rest)
in (match (_79_3025) with
| (out, rest) -> begin
(
...
let _79_3027 = x
in {FStar_Syntax_Syntax.ppname = _79_3027.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _79_3027.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}))
in (_164_2263)::out)
in (_164_2264, rest)))
end))
end
...
let _79_3033 = (aux bindings)
in (match (_79_3033) with
...
let _79_3045 = (let _164_2267 = (FStar_List.filter (fun _79_21 -> (match (_79_21) with
| FStar_TypeChecker_Env.Binding_sig (_79_3039) -> begin
false
end
| _79_3042 -> begin
true
...
in (match (_79_3045) with
| (env_decls, env) -> begin
(
# 1878 "FStar.SMTEncoding.Encode.fst"
let _79_3046 = if ((FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTEncoding")))) then begin
...
let _79_3050 = (encode_formula q env)
in (match (_79_3050) with
| (phi, qdecls) -> begin
(
# 1882 "FStar.SMTEncoding.Encode.fst"
let _79_3055 = (let _164_2269 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _164_2269 phi))
in (match (_79_3055) with
| (phi, labels, _79_3054) -> begin
(
# 1883 "FStar.SMTEncoding.Encode.fst"
let _79_3058 = (encode_labels labels)
in (match (_79_3058) with
...
in (match (_79_3066) with
| (prefix, labels, qry, suffix) -> begin
(match (qry) with
| FStar_SMTEncoding_Term.Assume ({FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.False, _79_3073); FStar_SMTEncoding_Term.hash = _79_3070; FStar_SMTEncoding_Term.freevars = _79_3068}, _79_3078) -> begin
(
# 1892 "FStar.SMTEncoding.Encode.fst"
let _79_3081 = (pop ())
in ())
end
| _79_3084 when tcenv.FStar_TypeChecker_Env.admit -> begin
(
# 1893 "FStar.SMTEncoding.Encode.fst"
let _79_3085 = (pop ())
in ())
end
| FStar_SMTEncoding_Term.Assume (q, _79_3089) -> begin
(
...
let _79_3093 = (FStar_SMTEncoding_ErrorReporting.askZ3_and_report_errors tcenv fresh labels prefix qry suffix)
in (pop ())))
end
| _79_3096 -> begin
(FStar_All.failwith "Impossible")
...
let _79_3100 = (push "query")
in (
# 1905 "FStar.SMTEncoding.Encode.fst"
let _79_3105 = (encode_formula q env)
in (match (_79_3105) with
| (f, _79_3104) -> begin
(
# 1906 "FStar.SMTEncoding.Encode.fst"
let _79_3106 = (pop "query")
in (match (f.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.True, _79_3110) -> begin
true
end
| _79_3114 -> begin
false
...
let dummy : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = (fun _79_3115 -> ()); FStar_TypeChecker_Env.push = (fun _79_3117 -> ()); FStar_TypeChecker_Env.pop = (fun _79_3119 -> ()); FStar_TypeChecker_Env.mark = (fun _79_3121 -> ()); FStar_TypeChecker_Env.reset_mark = (fun _79_3123 -> ()); FStar_TypeChecker_Env.commit_mark = (fun _79_3125 -> ()); FStar_TypeChecker_Env.encode_modul = (fun _79_3127 _79_3129 -> ()); FStar_TypeChecker_Env.encode_sig = (fun _79_3131 _79_3133 -> ()); FStar_TypeChecker_Env.solve = (fun _79_3135 _79_3137 _79_3139 -> ()); FStar_TypeChecker_Env.is_trivial = (fun _79_3141 _79_3143 -> false); FStar_TypeChecker_Env.finish = (fun _79_3145 -> ()); FStar_TypeChecker_Env.refresh = (fun _79_3146 -> ())}
