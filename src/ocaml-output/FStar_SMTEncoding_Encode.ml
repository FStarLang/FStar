    ...
    fun se ->
      ...
      (let is_opaque_to_smt t =
                                          ...
                                          let uu____15012 =
                                            let uu____15015 =
                                              ...
                                              FStar_SMTEncoding_Util.mkAssume
                                                uu____15016 in
                                            [uu____15015] in
                                          FStar_List.append karr uu____15012 in
                                        FStar_All.pipe_right uu____15009
                                          FStar_SMTEncoding_Term.mk_decls_trivial in
                                      FStar_List.append decls1 uu____15006 in
                                let aux =
                                  let uu____15056 =
                                    let uu____15059 =
                                    ...
                                    let uu____15062 =
                                      ...
                                      FStar_All.pipe_right uu____15065
                                        FStar_SMTEncoding_Term.mk_decls_trivial in
                                    FStar_List.append uu____15059 uu____15062 in
       ...
       | FStar_Syntax_Syntax.Sig_datacon
           (d, uu____15085, uu____15086, uu____15087, uu____15088,
            uu____15089)
                               ...
                               let datacons =
                                 ...
                                 let uu____15299 =
                                   ...
                                   FStar_SMTEncoding_Term.constructor_to_decl
                                     uu____15306 in
                                 FStar_All.pipe_right uu____15290 uu____15299 in
                               let app =
                                 FStar_SMTEncoding_EncodeTerm.mk_Apply
                                   ddtok_tm vars in
                               let guard =
                                                       ...
                                                       let uu____16908 =
                                                         let uu____16911 =
                                                           ...
                                                           FStar_List.append
                                                             ...
                                                             uu____16950 in
                                                         FStar_List.append
                                                           decls3 uu____16911 in
                                                       FStar_List.append
                                                         decls2 uu____16908 in
                                                     FStar_List.append
                                                       binder_decls
                                                       uu____16905 in
                                                   let uu____17053 =
                   ...
                   | (t, decls') ->
                       ...
                       (match uu____17253 with
                        | (xxsym, xx, env') ->
                            ...
                            let caption =
                              let uu____17285 = FStar_Options.log_queries () in
                              if uu____17285
                              then
                                let uu____17288 =
                                  let uu____17290 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____17290 uu____17292 uu____17294 in
             ...
             | FStar_Syntax_Syntax.Binding_lid (x, (uu____17335, t)) ->
                 ...
                 let fv =
                   FStar_Syntax_Syntax.lid_as_fv x
                     FStar_Syntax_Syntax.delta_constant
                     FStar_Pervasives_Native.None in
                 let uu____17355 = encode_free_var false env1 fv t t_norm [] in
              ...
              | (l, uu____17465, uu____17466) ->
                  let uu____17469 =
                    ...
                    (uu____17481, [], FStar_SMTEncoding_Term.Bool_sort,
                      FStar_Pervasives_Native.None) in
                  FStar_SMTEncoding_Term.DeclFun uu____17469)) in
    let suffix =
      FStar_All.pipe_right labs
        (FStar_List.collect
           (fun uu____17514 ->
  ...
  fun tcenv ->
    let uu____17556 =
      let uu____17559 =
        ...
        let uu____17575 =
          let uu____17584 = FStar_Util.psmap_empty () in (uu____17584, []) in
        let uu____17591 =
  ...
  fun env ->
    fun lid ->
      let uu____18220 =
        ...
        let uu____18225 = open_fact_db_tags env in uu____18223 :: uu____18225 in
              ...
              then [elt]
                ...
                (let uu____18298 =
                   ...
                   FStar_Util.smap_try_find
                     env.FStar_SMTEncoding_Env.global_cache uu____18301 in
          ...
          let uu____18351 =
            let uu____18352 =
              let uu____18354 =
                ...
                FStar_All.pipe_right uu____18356 (FStar_String.concat ", ") in
...
let (encode_modul :
  ...
  fun tcenv ->
    fun modul ->
      let uu____18486 = (FStar_Options.lax ()) && (FStar_Options.ml_ish ()) in
      if uu____18486
      then ([], [])
      else
        (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.reset_fresh ();
         (let name =
          ...
          (let env =
             let uu____18521 = get_env modul.FStar_Syntax_Syntax.name tcenv in
               ...
               (FStar_List.fold_left
                  (fun uu____18560 ->
                     fun se ->
                       ...
                       | (g, env2) ->
                           let uu____18580 = encode_top_level_facts env2 se in
            ...
            ((let uu____18676 =
             ...
             (let env =
                ...
                FStar_All.pipe_right uu____18692
                  FStar_SMTEncoding_Env.reset_current_module_fvbs in
              let env1 =
                let uu____18694 = FStar_All.pipe_right fvbs FStar_List.rev in
             ...
             (match uu____18927 with
              | (env_decls, env1) ->
                  ((let uu____18949 =
                    ...
                    if uu____18949
                    then
                      let uu____18956 = FStar_Syntax_Print.term_to_string q1 in
                    ...
                    | (phi, qdecls) ->
                        let uu____18982 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____18987 phi in
