...
let inversion_axioms = (fun tapp vars -> if (((FStar_List.length datas) = 0) || (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _156_1830 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
