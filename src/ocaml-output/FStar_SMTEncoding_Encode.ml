      ...
      (match t0.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_quoted (qt, uu____5670) ->
           let tv =
             ...
             FStar_Syntax_Embeddings.embed
               ...
               t.FStar_Syntax_Syntax.pos uu____5676 in
           let t1 =
             let uu____5680 =
               let uu____5689 = FStar_Syntax_Syntax.as_arg tv in [uu____5689] in
             FStar_Syntax_Util.mk_app
               (FStar_Reflection_Data.refl_constant_term
                  FStar_Reflection_Data.fstar_refl_pack_ln) uu____5680 in
           encode_term t1 env
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____6222 ->
           ...
           (match uu____6229 with
            | (x, f) ->
                let uu____6295 = encode_term x.FStar_Syntax_Syntax.sort env in
                ...
                let d =
                  let uu____6661 =
                    let uu____6668 =
                      let uu____6669 =
                        let uu____6670 =
                          let uu____6671 = FStar_Syntax_Unionfind.uvar_id uv in
                ...
                (match uu____6732 with
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                     ...
                     uu____6810),
                    uu____6811::(v1, uu____6813)::(v2, uu____6815)::[]) when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar fv,
                    uu____6892::(v1, uu____6894)::(v2, uu____6896)::[]) when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                    ...
                    (FStar_Const.Const_reify), uu____7032) ->
                     ...
                     ((let uu____7058 =
                      ...
                      (let e =
                       ...
                       encode_term e env))
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reflect uu____7075),
                    (arg, uu____7077)::[]) -> encode_term arg env
                 | uu____7102 ->
                      ...
                      | (args, decls) ->
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____7534, (FStar_Util.Inl t1, uu____7536),
                                 uu____7537)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____7586, (FStar_Util.Inr c, uu____7588),
                                 uu____7589)
                                ->
                                FStar_Pervasives_Native.Some
                          ...
                          (match head_type with
                           ...
                           | FStar_Pervasives_Native.Some head_type1 ->
                               let head_type2 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____7665 in
                               let uu____7666 =
                ...
                let codomain_eff rc =
                  ...
                  then
                    ...
                    (let uu____7817 =
                     ...
                     if uu____7817
                     then
                       let uu____7820 = FStar_Syntax_Syntax.mk_GTotal res_typ in
                     ...
                     let uu____7835 =
                       (is_impure rc) &&
                         (let uu____7837 =
                          ...
                          Prims.op_Negation uu____7837) in
                     if uu____7835
                     then fallback ()
                     else
                             ...
                             | (body3, decls') ->
                                 let uu____7896 =
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____7924 = encode_term tfun env in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____8155,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu____8156;
               ...
               FStar_Syntax_Syntax.lbpos = uu____8162;_}::uu____8163),
            uu____8164)
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((false,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
               ...
               FStar_Syntax_Syntax.lbpos = uu____8199;_}::[]),
            e2)
...
and (encode_pat :
  ...
  fun env ->
    fun pat ->
      ...
      (let uu____8668 = FStar_TypeChecker_Util.decorated_pattern_as_term pat in
                                ...
                                fun uu____9125 ->
                                  ...
                                  | (arg, uu____9139) ->
                                      ...
                                      let uu____9145 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee]) in
                                      mk_projections arg uu____9145)) in
                      FStar_All.pipe_right uu____9081 FStar_List.flatten in
      ...
      let one_pat p =
        ...
        | (head1, args) ->
            ...
            (match uu____9411 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (uu____9439, uu____9440)::(e, uu____9442)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> e
             | uu____9477 -> failwith "Unexpected pattern term") in
      let lemma_pats p =
        let elts = list_elements1 p in
        let smt_pat_or1 t1 =
          let uu____9513 =
            let uu____9528 = FStar_Syntax_Util.unmeta t1 in
            FStar_All.pipe_right uu____9528 FStar_Syntax_Util.head_and_args in
          ...
          | (head1, args) ->
              ...
              (match uu____9569 with
               ...
               | uu____9627 -> FStar_Pervasives_Native.None) in
        match elts with
        | t1::[] ->
                  ...
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____9846;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre, uu____9850)::(post, uu____9852)::(pats,
                                                                  uu____9854)::[];
               ...
               (match uu____10019 with
                | (pats, decls') ->
                    ...
                    (match uu____10252 with
                     | (pre1, decls'') ->
                         let uu____10264 =
                           let uu____10269 = FStar_Syntax_Util.unmeta post1 in
                              ...
                              let uu____10279 =
                                let uu____10280 =
                                  let uu____10291 =
                                    ...
                                    FStar_SMTEncoding_Util.mkImp uu____10292 in
                                  (pats, vars, uu____10291) in
                                FStar_SMTEncoding_Util.mkForall uu____10280 in
                              (uu____10279, decls1)))))
    ...
    fun env ->
      ...
      | (head1, args) ->
          ...
          (match ((head2.FStar_Syntax_Syntax.n), args) with
           | (FStar_Syntax_Syntax.Tm_fvar fv,
              uu____10369::(x, uu____10371)::(t1, uu____10373)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
...
and (encode_formula :
  ...
  fun phi ->
    fun env ->
      ...
      let unboxInt_l f l =
        let uu____11091 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l in
        f uu____11091 in
      let connectives =
        let uu____11109 =
          let uu____11122 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd) in
          (FStar_Parser_Const.and_lid, uu____11122) in
        let uu____11139 =
          let uu____11154 =
            let uu____11167 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr) in
      ...
      let rec fallback phi1 =
        ...
        | FStar_Syntax_Syntax.Tm_let
            ((false,
              { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                ...
                FStar_Syntax_Syntax.lbpos = uu____11683;_}::[]),
             e2)
            ->
        ...
        | FStar_Syntax_Syntax.Tm_app (head1, args) ->
            ...
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____11754::(x, uu____11756)::(t, uu____11758)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
             ...
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (r, uu____11832)::(msg, uu____11834)::(phi2, uu____11836)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        | uu____11980 ->
            ...
            (match uu____11981 with
             | (tt, decls) ->
                 ...
                 (uu____11992, decls)) in
      let encode_q_body env1 bs ps body =
        let uu____12031 = encode_binders FStar_Pervasives_Native.None bs env1 in
                  ...
                  (FStar_List.map
                     (fun p ->
                        let uu____12148 =
                          ...
                          FStar_All.pipe_right uu____12159 FStar_List.unzip in
               ...
               FStar_List.fold_left
                 (fun out ->
                    fun x ->
                      ...
                      FStar_Util.set_union out uu____12468) uu____12456 tl1 in
             let uu____12471 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
                    (fun uu____12498 ->
                       ...
                       | (b, uu____12504) ->
                           let uu____12505 = FStar_Util.set_mem b pat_vars in
              ...
              | FStar_Pervasives_Native.Some (x, uu____12511) ->
                  ...
                  let uu____12525 =
                    ...
                    (FStar_Errors.Warning_SMTPatternMissingBoundVar,
                      uu____12530) in
                  FStar_Errors.log_issue pos uu____12525) in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____12599 ->
                     ...
                     | (l, uu____12613) -> FStar_Ident.lid_equals op l)) in
...
let (prims : prims_t) =
  ...
  | (asym, a) ->
      ...
      (match uu____12927 with
       | (xsym, x) ->
           let uu____12934 = fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort in
            ...
            | (ysym, y) ->
                          ...
                          let uu____13088 =
                            let uu____13089 =
                              let uu____13096 =
                                ...
                                FStar_SMTEncoding_Util.mkForall uu____13097 in
                              (uu____13096,
                                (FStar_Pervasives_Native.Some
                ...
                let prims1 =
                  let uu____13205 =
                    let uu____13220 =
                      let uu____13231 =
                        let uu____13232 = FStar_SMTEncoding_Util.mkEq (x, y) in
                      ...
                      let uu____13316 =
                        let uu____13331 =
                          let uu____13342 =
                            ...
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool uu____13343 in
                        ...
                        let uu____13378 =
                          let uu____13393 =
                            let uu____13404 =
                              ...
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool uu____13405 in
                              ...
                              let uu____13517 =
                                let uu____13528 =
                                  let uu____13529 =
                                    ...
                                    FStar_SMTEncoding_Util.mkGTE uu____13530 in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool
                                    uu____13529 in
                            ...
                            let uu____13547 =
                              ...
                              let uu____13609 =
                                let uu____13626 =
                                  ...
                                  (FStar_Parser_Const.op_Minus, uu____13641) in
                                let uu____13665 =
                                  let uu____13682 =
                                    let uu____13697 =
                                      let uu____13708 =
                ...
                let mk1 l v1 =
                  let uu____14332 =
                    ...
                    FStar_All.pipe_right uu____14343
                      (FStar_Option.map
                         (fun uu____14497 ->
                            match uu____14497 with | (uu____14520, b) -> b v1)) in
                  ...
                  FStar_All.pipe_right prims1
                    (FStar_Util.for_some
                       (fun uu____14605 ->
                          ...
                          | (l', uu____14621) -> FStar_Ident.lid_equals l l')) in
                { mk = mk1; is }))
let (pretype_axiom :
  env_t ->
    FStar_SMTEncoding_Term.term ->
  ...
  fun env ->
    fun tapp ->
      fun vars ->
        ...
        | (xxsym, xx) ->
            let uu____14670 = fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort in
...
let (primitive_type_axioms :
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let body =
      ...
      let hastypeS =
        let uu____16374 = FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "1") in
        FStar_SMTEncoding_Term.mk_HasTypeFuel uu____16374 x1 t in
      let uu____16375 =
        let uu____16386 = FStar_SMTEncoding_Util.mkImp (hastypeZ, hastypeS) in
          ...
          let uu____16856 =
            FStar_Util.find_opt
              (fun uu____16882 ->
                 ...
                 | (l, uu____16894) -> FStar_Ident.lid_equals l t) prims1 in
                  ...
                  | (toks, typs, decls, env1) ->
                      ...
                      let encode_non_rec_lbdef bindings1 typs2 toks1 env2 =
                        ...
                        | ({ FStar_Syntax_Syntax.lbname = lbn;
                             ...
                             FStar_Syntax_Syntax.lbpos = uu____19774;_}::[],
                           t_norm::[], fvb::[]) ->
                            ...
                            let uu____19798 =
                              ...
                              | (tcenv', uu____19823, e_t) ->
                                  let uu____19829 =
                                    ...
                                    | uu____19840 -> failwith "Impossible" in
                            ...
                            (match uu____19798 with
                             | (env', e1, t_norm1) ->
                                 ...
                                 (match uu____19866 with
                                  | ((binders, body, uu____19887, t_body),
                                     curry) ->
                                      ((let uu____19899 =
                                          FStar_All.pipe_left
                                        ...
                                        let env4 =
                                          let uu____20224 =
                                            ...
                                            FStar_All.pipe_left
                                              (fun _0_42 ->
                                                 FStar_Pervasives_Native.Some
                                                   _0_42) uu____20227 in
                                          push_free_var env3 flid
                                            fvb.smt_arity gtok uu____20224 in
                        ...
                        | (gtoks, env3) ->
                            ...
                            let encode_one_binding env01 uu____20327 t_norm
                              ...
                              | ((fvb, g, gtok),
                                 { FStar_Syntax_Syntax.lbname = lbn;
                                   FStar_Syntax_Syntax.lbunivs = uvs;
                                   FStar_Syntax_Syntax.lbtyp = uu____20359;
                                   FStar_Syntax_Syntax.lbeff = uu____20360;
                                   FStar_Syntax_Syntax.lbdef = e;
                                   FStar_Syntax_Syntax.lbattrs = uu____20362;
                                   FStar_Syntax_Syntax.lbpos = uu____20363;_})
                                  ->
                                  let uu____20384 =
                                    let uu____20391 =
                                      FStar_TypeChecker_Env.open_universes_in
          ...
          let g1 =
            ...
            | uu____21501 ->
                ...
                let uu____21507 =
                  ...
                  [uu____21510] in
                FStar_List.append uu____21502 uu____21507 in
          (g1, env1)
and (encode_sigelt' :
  env_t ->
    FStar_Syntax_Syntax.sigelt ->
                         ...
                         | (tm, decls) ->
                             let a_decls =
                               let uu____21707 =
                                 ...
                                 FStar_SMTEncoding_Term.DeclFun uu____21708 in
                               [uu____21707;
                               FStar_SMTEncoding_Term.DeclFun
                             ...
                             let uu____21748 =
                               let aux uu____21800 uu____21801 =
                                 ...
                                 | ((bv, uu____21853),
                                    (env3, acc_sorts, acc)) ->
                                     let uu____21891 = gen_term_var env3 bv in
                        ...
                        let uu____22201 =
                          let uu____22208 =
                            let uu____22211 =
                              ...
                              FStar_Util.format1 "Assumption: %s" uu____22212 in
      ...
      | FStar_Syntax_Syntax.Sig_let
          ((uu____22315,
            { FStar_Syntax_Syntax.lbname = FStar_Util.Inr b2t1;
              ...
              FStar_Syntax_Syntax.lbpos = uu____22322;_}::[]),
           uu____22323)
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____22728 ->
                                ...
                                | (uu____22735, sort, uu____22737) -> sort)) in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l ->
                      ...
                      FStar_All.pipe_right uu____22770 FStar_Option.isNone)) in
            if uu____22764
            then []
            else
              (let uu____22802 =
                         ...
                         | (ffsym, ff) ->
                             let fuel_guarded_inversion =
                               ...
                               let uu____23095 =
                                 ...
                                 (uu____23102,
                                   (FStar_Pervasives_Native.Some
                                      "inversion axiom"), uu____23144) in
                              ...
                              let uu____23318 =
                                let tname_decl =
                                  let uu____23328 =
                                    ...
                                    (tname, uu____23329,
                                      FStar_SMTEncoding_Term.Term_sort,
                                      uu____23374, false) in
                                  constructor_or_logic_type_decl uu____23328 in
                                let uu____23383 =
                                  match vars with
                                  | [] ->
                                      let uu____23396 =
                                        ...
                                        FStar_SMTEncoding_Term.DeclFun
                                          (ttok, [],
                                            ...
                                            (FStar_Pervasives_Native.Some
                                               "token")) in
                                      let ttok_fresh =
                                        let uu____23420 = varops.next_id () in
                                           ...
                                           let uu____23531 =
                                             let uu____23534 =
                                               ...
                                               FStar_SMTEncoding_Util.mkAssume
                                                 uu____23535 in
                                             [uu____23534] in
                                           FStar_List.append karr uu____23531 in
                                         FStar_List.append decls1 uu____23528 in
                                   let aux =
                                     let uu____23570 =
                                       let uu____23573 =
                                       ...
                                       FStar_List.append uu____23573
                                         uu____23576 in
                                     FStar_List.append kindingAx uu____23570 in
                                   let g =
                                     FStar_List.append decls
                                       (FStar_List.append binder_decls aux) in
                                   (g, env2))))))
      | FStar_Syntax_Syntax.Sig_datacon
          (d, uu____23586, uu____23587, uu____23588, uu____23589,
           uu____23590)
                                                    ...
                                                    | uu____25164 ->
                                                        ((let uu____25166 =
                                                          ...
                                                          FStar_Errors.log_issue
                                                            ...
                                                            uu____25166);
                                                         ([], []))) in
                                             let uu____25178 = encode_elim () in
                                                      ...
                                                      let uu____25201 =
                                                        let uu____25204 =
                                                          ...
                                                          FStar_List.append
                                                            ...
                                                            uu____25231 in
                                                        FStar_List.append
                                                          decls3 uu____25204 in
                                                      FStar_List.append
                                                        decls2 uu____25201 in
                                                    FStar_List.append
                                                      binder_decls
                                                      uu____25198 in
                                                  ((FStar_List.append
                 ...
                 ((let uu____25477 =
                   ...
                   then
                     ...
                     let uu____25479 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort in
                     let uu____25480 = FStar_Syntax_Print.term_to_string t1 in
                   ...
                   | (t, decls') ->
                       ...
                       (match uu____25498 with
                        | (xxsym, xx, env') ->
                            ...
                            let caption =
                              let uu____25523 = FStar_Options.log_queries () in
                              if uu____25523
                              then
                                let uu____25526 =
                                  let uu____25527 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____25527 uu____25528 uu____25529 in
             ...
             | FStar_TypeChecker_Env.Binding_lid (x, (uu____25545, t)) ->
                 ...
                 let fv =
                   FStar_Syntax_Syntax.lid_as_fv x
                     FStar_Syntax_Syntax.Delta_constant
                     FStar_Pervasives_Native.None in
                 let uu____25559 = encode_free_var false env1 fv t t_norm [] in
...
let encode_labels :
  'Auu____25664 'Auu____25665 .
    ((Prims.string, FStar_SMTEncoding_Term.sort)
       FStar_Pervasives_Native.tuple2,
      'Auu____25664, 'Auu____25665) FStar_Pervasives_Native.tuple3 Prims.list
      ->
      (FStar_SMTEncoding_Term.decl Prims.list,
        FStar_SMTEncoding_Term.decl Prims.list)
        FStar_Pervasives_Native.tuple2
  ...
  fun env ->
    fun lid ->
      let uu____26151 =
        ...
        let uu____26156 = open_fact_db_tags env in uu____26154 :: uu____26156 in
          ...
          let uu____26217 =
            let uu____26218 =
              let uu____26219 =
                ...
                FStar_All.pipe_right uu____26220 (FStar_String.concat ", ") in
              Prims.strcat "encoding sigelt " uu____26219 in
            FStar_SMTEncoding_Term.Caption uu____26218 in
          uu____26217 :: decls
        else decls in
      (let uu____26231 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low in
       if uu____26231
       then
...
let (encode_modul :
  ...
  fun tcenv ->
    fun modul ->
      ...
      (let uu____26262 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low in
       if uu____26262
       then
         let uu____26263 =
           FStar_All.pipe_right
             ...
             (match uu____26586 with
              | (env_decls, env1) ->
                  ((let uu____26622 =
                    ...
                    if uu____26622
                    then
                      let uu____26623 = FStar_Syntax_Print.term_to_string q1 in
                    ...
                    | (phi, qdecls) ->
                        let uu____26646 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____26651 phi in
