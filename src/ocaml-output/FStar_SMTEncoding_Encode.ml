...
let uu____11749 = (FStar_Syntax_Subst.univ_var_opening uvs)
...
let uu___161_11764 = env1
in (

let uu____11765 = (FStar_TypeChecker_Env.push_univ_vars env1.tcenv univ_vars1)
in {bindings = uu___161_11764.bindings; depth = uu___161_11764.depth; tcenv = uu____11765; warn = uu___161_11764.warn; cache = uu___161_11764.cache; nolabels = uu___161_11764.nolabels; use_zfuel_name = uu___161_11764.use_zfuel_name; encode_non_total_function_typ = uu___161_11764.encode_non_total_function_typ; current_module_name = uu___161_11764.current_module_name}))
in (
...
let uu____11768 = (FStar_Syntax_Subst.subst univ_subst e)
in (FStar_Syntax_Subst.compress uu____11768))
in (

let uu____11769 = (destruct_bound_function flid t_norm1 e1)
in (match (uu____11769) with
| ((binders, body, uu____11781, uu____11782), curry) -> begin
((

let uu____11789 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____11789) with
| true -> begin
(

let uu____11790 = (FStar_Syntax_Print.binders_to_string ", " binders)
in (

let uu____11791 = (FStar_Syntax_Print.term_to_string body)
in (FStar_Util.print2 "Encoding let : binders=[%s], body=%s\n" uu____11790 uu____11791)))
end
| uu____11792 -> begin
()
end));
...
let uu____11793 = (encode_binders None binders env')
in (match (uu____11793) with
| (vars, guards, env'1, binder_decls, uu____11809) -> begin
(

let body1 = (

let uu____11817 = (FStar_TypeChecker_Env.is_reifiable_function env'1.tcenv t_norm1)
...
let uu____11825 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Logic))
in (match (uu____11825) with
| true -> begin
(

let uu____11831 = (FStar_SMTEncoding_Term.mk_Valid app)
in (

let uu____11832 = (encode_formula body1 env'1)
in ((uu____11831), (uu____11832))))
end
| uu____11837 -> begin
(

let uu____11838 = (encode_term body1 env'1)
in ((app), (uu____11838)))
end))
...
let uu____11863 = (FStar_SMTEncoding_Util.mkEq ((app1), (body2)))
in ((((app1)::[])::[]), (vars), (uu____11863)))
in (FStar_SMTEncoding_Util.mkForall uu____11857))
in (

let uu____11869 = (

let uu____11871 = (FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str)
in Some (uu____11871))
in ((uu____11856), (uu____11869), ((Prims.strcat "equation_" f)))))
in FStar_SMTEncoding_Term.Assume (uu____11852))
in (
...
let uu____11881 = (primitive_type_axioms env1.tcenv flid f app1)
in (FStar_List.append ((eqn)::[]) uu____11881))
in (FStar_List.append decls2 uu____11879))
in (FStar_List.append binder_decls uu____11877))
in (FStar_List.append decls1 uu____11875))
in ((uu____11873), (env1))))
end))))
end));
)
...
let uu____11903 = (varops.fresh "fuel")
in ((uu____11903), (FStar_SMTEncoding_Term.Fuel_sort)))
in (
...
let uu____11906 = (FStar_All.pipe_right toks1 (FStar_List.fold_left (fun uu____11945 uu____11946 -> (match (((uu____11945), (uu____11946))) with
...
let uu____12028 = (FStar_Ident.lid_add_suffix flid "fuel_instrumented")
in (varops.new_fvar uu____12028))
in (

let gtok = (

let uu____12030 = (FStar_Ident.lid_add_suffix flid "fuel_instrumented_token")
in (varops.new_fvar uu____12030))
in (
...
let uu____12034 = (FStar_SMTEncoding_Util.mkApp ((g), ((fuel_tm)::[])))
in (FStar_All.pipe_left (fun _0_36 -> Some (_0_36)) uu____12034))
in (push_free_var env2 flid gtok uu____12032))
...
let encode_one_binding = (fun env01 uu____12118 t_norm uu____12120 -> (match (((uu____12118), (uu____12120))) with
| ((flid, f, ftok, g, gtok), {FStar_Syntax_Syntax.lbname = lbn; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = uu____12145; FStar_Syntax_Syntax.lbeff = uu____12146; FStar_Syntax_Syntax.lbdef = e}) -> begin
(

let uu____12163 = (FStar_Syntax_Subst.univ_var_opening uvs)
...
let uu___162_12180 = env2
in (

let uu____12181 = (FStar_TypeChecker_Env.push_univ_vars env2.tcenv univ_vars1)
in {bindings = uu___162_12180.bindings; depth = uu___162_12180.depth; tcenv = uu____12181; warn = uu___162_12180.warn; cache = uu___162_12180.cache; nolabels = uu___162_12180.nolabels; use_zfuel_name = uu___162_12180.use_zfuel_name; encode_non_total_function_typ = uu___162_12180.encode_non_total_function_typ; current_module_name = uu___162_12180.current_module_name}))
in (
...
let uu____12185 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env01.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____12185) with
| true -> begin
(

let uu____12186 = (FStar_Syntax_Print.lbname_to_string lbn)
in (

let uu____12187 = (FStar_Syntax_Print.term_to_string t_norm1)
in (

let uu____12188 = (FStar_Syntax_Print.term_to_string e1)
...
let uu____12190 = (destruct_bound_function flid t_norm1 e1)
in (match (uu____12190) with
| ((binders, body, formals, tres), curry) -> begin
((

let uu____12212 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env01.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____12212) with
| true -> begin
(

let uu____12213 = (FStar_Syntax_Print.binders_to_string ", " binders)
in (

let uu____12214 = (FStar_Syntax_Print.term_to_string body)
in (

let uu____12215 = (FStar_Syntax_Print.binders_to_string ", " formals)
in (

let uu____12216 = (FStar_Syntax_Print.term_to_string tres)
in (FStar_Util.print4 "Encoding let rec: binders=[%s], body=%s, formals=[%s], tres=%s\n" uu____12213 uu____12214 uu____12215 uu____12216)))))
end
| uu____12217 -> begin
()
end));
...
let uu____12220 = (encode_binders None binders env')
in (match (uu____12220) with
| (vars, guards, env'1, binder_decls, uu____12238) -> begin
(
...
let uu____12254 = (FStar_List.map Prims.snd vars)
in (FStar_SMTEncoding_Term.Fuel_sort)::uu____12254)
in ((g), (uu____12252), (FStar_SMTEncoding_Term.Term_sort), (Some ("Fuel-instrumented function name"))))
in FStar_SMTEncoding_Term.DeclFun (uu____12246))
in (
...
let uu____12273 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((f), (uu____12273)))
in (FStar_SMTEncoding_Util.mkApp uu____12269))
in (
...
let uu____12285 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((fuel_tm)::[])))
in (uu____12285)::vars_tm)
in ((g), (uu____12283)))
in (FStar_SMTEncoding_Util.mkApp uu____12279))
in (
...
let uu____12295 = (FStar_SMTEncoding_Util.mkApp (("MaxFuel"), ([])))
in (uu____12295)::vars_tm)
in ((g), (uu____12293)))
in (FStar_SMTEncoding_Util.mkApp uu____12289))
in (

let body1 = (

let uu____12299 = (FStar_TypeChecker_Env.is_reifiable_function env'1.tcenv t_norm1)
...
let uu____12301 = (encode_term body1 env'1)
...
let uu____12325 = (FStar_SMTEncoding_Util.mkEq ((gsapp), (body_tm)))
in ((((gsapp)::[])::[]), (Some ((Prims.parse_int "0"))), ((fuel)::vars), (uu____12325)))
in (FStar_SMTEncoding_Util.mkForall' uu____12317))
in (

let uu____12336 = (

let uu____12338 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Ident.str)
in Some (uu____12338))
in ((uu____12316), (uu____12336), ((Prims.strcat "equation_with_fuel_" g)))))
in FStar_SMTEncoding_Term.Assume (uu____12312))
in (
...
let uu____12352 = (FStar_SMTEncoding_Util.mkEq ((app), (gmax)))
in ((((app)::[])::[]), (vars), (uu____12352)))
in (FStar_SMTEncoding_Util.mkForall uu____12346))
in ((uu____12345), (Some ("Correspondence of recursive function to instrumented version")), ((Prims.strcat "fuel_correspondence_" g))))
in FStar_SMTEncoding_Term.Assume (uu____12341))
in (
...
let uu____12382 = (FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "0"))
in (uu____12382)::vars_tm)
in ((g), (uu____12380)))
in (FStar_SMTEncoding_Util.mkApp uu____12376))
in ((gsapp), (uu____12375)))
in (FStar_SMTEncoding_Util.mkEq uu____12372))
in ((((gsapp)::[])::[]), ((fuel)::vars), (uu____12371)))
in (FStar_SMTEncoding_Util.mkForall uu____12365))
in ((uu____12364), (Some ("Fuel irrelevance")), ((Prims.strcat "fuel_irrelevance_" g))))
in FStar_SMTEncoding_Term.Assume (uu____12360))
in (

let uu____12394 = (

let uu____12399 = (encode_binders None formals env02)
in (match (uu____12399) with
| (vars1, v_guards, env3, binder_decls1, uu____12416) -> begin
(
...
let uu____12431 = (FStar_SMTEncoding_Util.mkFreeV ((gtok), (FStar_SMTEncoding_Term.Term_sort)))
in (mk_Apply uu____12431 ((fuel)::vars1)))
in (
...
let uu____12445 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (gapp)))
in ((((tok_app)::[])::[]), ((fuel)::vars1), (uu____12445)))
in (FStar_SMTEncoding_Util.mkForall uu____12439))
in ((uu____12438), (Some ("Fuel token correspondence")), ((Prims.strcat "fuel_token_correspondence_" gtok))))
in FStar_SMTEncoding_Term.Assume (uu____12434)))
in (

let uu____12456 = (

let uu____12460 = (encode_term_pred None tres env3 gapp)
...
let uu____12486 = (FStar_SMTEncoding_Util.mk_and_l v_guards)
in ((uu____12486), (g_typing)))
in (FStar_SMTEncoding_Util.mkImp uu____12483))
in ((((gapp)::[])::[]), ((fuel)::vars1), (uu____12482)))
in (FStar_SMTEncoding_Util.mkForall uu____12476))
in ((uu____12475), (Some ("Typing correspondence of token to term")), ((Prims.strcat "token_correspondence_" g))))
in FStar_SMTEncoding_Term.Assume (uu____12471))
in (uu____12470)::[])
in ((d3), (uu____12468)))
end))
...
let uu____12528 = (FStar_List.zip3 gtoks1 typs1 bindings)
in (FStar_List.fold_left (fun uu____12560 uu____12561 -> (match (((uu____12560), (uu____12561))) with
| ((decls2, eqns, env01), (gtok, ty, lb)) -> begin
(

let uu____12637 = (encode_one_binding env01 gtok ty lb)
in (match (uu____12637) with
| (decls', eqns', env02) -> begin
(((decls')::decls2), ((FStar_List.append eqns' eqns)), (env02))
end))
end)) (((decls1)::[]), ([]), (env0)) uu____12528))
...
let isDeclFun = (fun uu___128_12685 -> (match (uu___128_12685) with
| FStar_SMTEncoding_Term.DeclFun (uu____12686) -> begin
true
end
| uu____12692 -> begin
false
...
let uu____12693 = (FStar_All.pipe_right decls2 FStar_List.flatten)
in (FStar_All.pipe_right uu____12693 (FStar_List.partition isDeclFun))))
...
let uu____12720 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right uu____12720 (FStar_String.concat " and ")))
in (
...
let uu____12753 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____12753) with
| true -> begin
(

let uu____12754 = (FStar_Syntax_Print.sigelt_to_string se)
...
let uu____12757 = (FStar_Syntax_Util.lid_of_sigelt se)
...
let uu____12760 = (encode_sigelt' env se)
...
let uu____12772 = (FStar_Util.format1 "<Skipped %s/>" nm)
in FStar_SMTEncoding_Term.Caption (uu____12772))
in (uu____12771)::[])
in ((uu____12769), (e)))
end
| uu____12774 -> begin
...
let uu____12780 = (FStar_Util.format1 "<Start encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (uu____12780))
in (uu____12779)::g)
in (
...
let uu____12784 = (FStar_Util.format1 "</end encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (uu____12784))
in (uu____12783)::[])
in (FStar_List.append uu____12777 uu____12781)))
in ((uu____12775), (e)))
end)
end)));
))
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____12792) -> begin
...
let uu____12802 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right uu____12802 Prims.op_Negation))
...
let uu____12842 = (FStar_All.pipe_left (fun _0_37 -> Some (_0_37)) (FStar_Util.Inr (((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[])))))
in ((ed.FStar_Syntax_Syntax.binders), (tm), (uu____12842)))
in FStar_Syntax_Syntax.Tm_abs (uu____12827))
in (FStar_Syntax_Syntax.mk uu____12826))
in (uu____12823 None tm.FStar_Syntax_Syntax.pos))
end))
in (

let encode_action = (fun env1 a -> (

let uu____12895 = (new_term_constant_and_tok_from_lid env1 a.FStar_Syntax_Syntax.action_name)
in (match (uu____12895) with
| (aname, atok, env2) -> begin
(

let uu____12905 = (FStar_Syntax_Util.arrow_formals_comp a.FStar_Syntax_Syntax.action_typ)
in (match (uu____12905) with
| (formals, uu____12915) -> begin
(

let uu____12922 = (

let uu____12925 = (close_effect_params a.FStar_Syntax_Syntax.action_defn)
in (encode_term uu____12925 env2))
in (match (uu____12922) with
| (tm, decls) -> begin
(
...
let uu____12940 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____12948 -> FStar_SMTEncoding_Term.Term_sort)))
in ((aname), (uu____12940), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action"))))
in FStar_SMTEncoding_Term.DeclFun (uu____12934))
in (uu____12933)::(FStar_SMTEncoding_Term.DeclFun (((atok), ([]), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action token")))))::[])
in (

let uu____12955 = (

let aux = (fun uu____12984 uu____12985 -> (match (((uu____12984), (uu____12985))) with
| ((bv, uu____13012), (env3, acc_sorts, acc)) -> begin
(

let uu____13033 = (gen_term_var env3 bv)
...
let uu____13100 = (mk_Apply tm xs_sorts)
in ((app), (uu____13100)))
in (FStar_SMTEncoding_Util.mkEq uu____13097))
in ((((app)::[])::[]), (xs_sorts), (uu____13096)))
in (FStar_SMTEncoding_Util.mkForall uu____13090))
in ((uu____13089), (Some ("Action equality")), ((Prims.strcat aname "_equality"))))
in FStar_SMTEncoding_Term.Assume (uu____13085))
in (
...
let uu____13123 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (app)))
in ((((tok_app)::[])::[]), (xs_sorts), (uu____13123)))
in (FStar_SMTEncoding_Util.mkForall uu____13117))
in ((uu____13116), (Some ("Action token correspondence")), ((Prims.strcat aname "_token_correspondence"))))
in FStar_SMTEncoding_Term.Assume (uu____13112))))
...
let uu____13133 = (FStar_Util.fold_map encode_action env ed.FStar_Syntax_Syntax.actions)
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____13149, uu____13150, uu____13151) when (FStar_Ident.lid_equals lid FStar_Syntax_Const.precedes_lid) -> begin
(

let uu____13154 = (new_term_constant_and_tok_from_lid env lid)
in (match (uu____13154) with
| (tname, ttok, env1) -> begin
(([]), (env1))
end))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____13165, t, quals) -> begin
(

let will_encode_definition = (

let uu____13171 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___129_13173 -> (match (uu___129_13173) with
...
let uu____13182 = (encode_top_level_val env fv t quals)
...
let uu____13196 = (primitive_type_axioms env1.tcenv lid tname tsym)
in (FStar_List.append decls uu____13196))
in ((uu____13194), (env1)))))
end)))
end))
end
| FStar_Syntax_Syntax.Sig_assume (l, f, uu____13201) -> begin
(

let uu____13204 = (encode_formula f env)
...
let uu____13221 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Assumption: %s" uu____13221))
in Some (uu____13220))
in (

let uu____13222 = (varops.mk_unique (Prims.strcat "assumption_" l.FStar_Ident.str))
in ((f1), (uu____13218), (uu____13222))))
in FStar_SMTEncoding_Term.Assume (uu____13214))
in (uu____13213)::[])
in (((FStar_List.append decls g)), (env)))
end))
end
| FStar_Syntax_Syntax.Sig_let (lbs, uu____13226, quals, uu____13228) when (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Irreducible)) -> begin
(

let uu____13236 = (FStar_Util.fold_map (fun env1 lb -> (

let lid = (

let uu____13243 = (

let uu____13248 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____13248.FStar_Syntax_Syntax.fv_name)
in uu____13243.FStar_Syntax_Syntax.v)
in (

let uu____13252 = (

let uu____13253 = (FStar_TypeChecker_Env.try_lookup_val_decl env1.tcenv lid)
in (FStar_All.pipe_left FStar_Option.isNone uu____13253))
...
let uu____13272 = (encode_sigelt' env1 val_decl)
...
| FStar_Syntax_Syntax.Sig_let ((uu____13289, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (b2t1); FStar_Syntax_Syntax.lbunivs = uu____13291; FStar_Syntax_Syntax.lbtyp = uu____13292; FStar_Syntax_Syntax.lbeff = uu____13293; FStar_Syntax_Syntax.lbdef = uu____13294})::[]), uu____13295, uu____13296, uu____13297) when (FStar_Syntax_Syntax.fv_eq_lid b2t1 FStar_Syntax_Const.b2t_lid) -> begin
(

let uu____13313 = (new_term_constant_and_tok_from_lid env b2t1.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu____13337 = (FStar_SMTEncoding_Util.mkApp (("Prims.b2t"), ((x)::[])))
in (uu____13337)::[])
in (("Valid"), (uu____13335)))
in (FStar_SMTEncoding_Util.mkApp uu____13331))
in (
...
let uu____13360 = (FStar_SMTEncoding_Util.mkApp (("BoxBool_proj_0"), ((x)::[])))
in ((valid_b2t_x), (uu____13360)))
in (FStar_SMTEncoding_Util.mkEq uu____13357))
in ((((valid_b2t_x)::[])::[]), ((xx)::[]), (uu____13356)))
in (FStar_SMTEncoding_Util.mkForall uu____13350))
in ((uu____13349), (Some ("b2t def")), ("b2t_def")))
in FStar_SMTEncoding_Term.Assume (uu____13345))
in (uu____13344)::[])
in (FStar_SMTEncoding_Term.DeclFun (((tname), ((FStar_SMTEncoding_Term.Term_sort)::[]), (FStar_SMTEncoding_Term.Term_sort), (None))))::uu____13342)
in ((decls), (env1))))))
end))
end
| FStar_Syntax_Syntax.Sig_let (uu____13377, uu____13378, quals, uu____13380) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___130_13388 -> (match (uu___130_13388) with
| FStar_Syntax_Syntax.Discriminator (uu____13389) -> begin
true
end
| uu____13390 -> begin
false
...
| FStar_Syntax_Syntax.Sig_let (uu____13392, lids, quals, uu____13395) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> (

let uu____13404 = (

let uu____13405 = (FStar_List.hd l.FStar_Ident.ns)
in uu____13405.FStar_Ident.idText)
in (uu____13404 = "Prims"))))) && (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___131_13407 -> (match (uu___131_13407) with
...
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____13411, quals, uu____13413) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___132_13425 -> (match (uu___132_13425) with
...
let uu____13436 = (try_lookup_free_var env l)
in (match (uu____13436) with
| Some (uu____13440) -> begin
(([]), (env))
end
| None -> begin
(
...
| FStar_Syntax_Syntax.Sig_let ((is_rec, bindings), uu____13449, quals, uu____13451) -> begin
(encode_top_level_let env ((is_rec), (bindings)) quals)
end
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____13465, uu____13466) -> begin
(

let uu____13473 = (encode_signature env ses)
in (match (uu____13473) with
| (g, env1) -> begin
(

let uu____13483 = (FStar_All.pipe_right g (FStar_List.partition (fun uu___133_13493 -> (match (uu___133_13493) with
| FStar_SMTEncoding_Term.Assume (uu____13494, Some ("inversion axiom"), uu____13495) -> begin
false
end
| uu____13497 -> begin
true
...
let uu____13506 = (FStar_All.pipe_right g' (FStar_List.partition (fun uu___134_13516 -> (match (uu___134_13516) with
| FStar_SMTEncoding_Term.DeclFun (uu____13517) -> begin
true
end
| uu____13523 -> begin
false
...
| FStar_Syntax_Syntax.Sig_inductive_typ (t, uu____13534, tps, k, uu____13537, datas, quals) -> begin
(

let is_logical = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___135_13548 -> (match (uu___135_13548) with
...
| (name, args, uu____13560, uu____13561, uu____13562) -> begin
(
...
let uu____13572 = (FStar_All.pipe_right args (FStar_List.map (fun uu____13579 -> (match (uu____13579) with
| (uu____13583, sort, uu____13585) -> begin
sort
end))))
in ((name), (uu____13572), (FStar_SMTEncoding_Term.Term_sort), (None)))
in FStar_SMTEncoding_Term.DeclFun (uu____13566))
in (uu____13565)::[])
end))
end
| uu____13588 -> begin
...
let uu____13603 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (

let uu____13606 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
in (FStar_All.pipe_right uu____13606 FStar_Option.isNone)))))
in (match (uu____13603) with
| true -> begin
[]
end
| uu____13622 -> begin
...
let uu____13623 = (fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (uu____13623) with
| (xxsym, xx) -> begin
(

let uu____13629 = (FStar_All.pipe_right datas (FStar_List.fold_left (fun uu____13640 l -> (match (uu____13640) with
| (out, decls) -> begin
(

let uu____13652 = (FStar_TypeChecker_Env.lookup_datacon env.tcenv l)
in (match (uu____13652) with
| (uu____13658, data_t) -> begin
(

let uu____13660 = (FStar_Syntax_Util.arrow_formals data_t)
...
let uu____13690 = (FStar_Syntax_Subst.compress res)
in uu____13690.FStar_Syntax_Syntax.n)
in (match (uu____13689) with
| FStar_Syntax_Syntax.Tm_app (uu____13698, indices) -> begin
indices
end
| uu____13714 -> begin
[]
...
let env1 = (FStar_All.pipe_right args (FStar_List.fold_left (fun env1 uu____13726 -> (match (uu____13726) with
| (x, uu____13730) -> begin
(
...
let uu____13736 = (mk_term_projector_name l x)
in ((uu____13736), ((xx)::[])))
in (FStar_SMTEncoding_Util.mkApp uu____13732))
in (push_term_var env1 x uu____13731))
end)) env))
in (

let uu____13738 = (encode_args indices env1)
...
let uu____13758 = (FStar_List.map2 (fun v1 a -> (

let uu____13766 = (

let uu____13769 = (FStar_SMTEncoding_Util.mkFreeV v1)
in ((uu____13769), (a)))
in (FStar_SMTEncoding_Util.mkEq uu____13766))) vars indices1)
in (FStar_All.pipe_right uu____13758 FStar_SMTEncoding_Util.mk_and_l))
in (
...
let uu____13779 = (mk_data_tester env1 l xx)
in ((uu____13779), (eqs)))
in (FStar_SMTEncoding_Util.mkAnd uu____13776))
in ((out), (uu____13775)))
in (FStar_SMTEncoding_Util.mkOr uu____13772))
in ((uu____13771), ((FStar_List.append decls decls')))));
)
end))))
end))
end))
...
let uu____13787 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
...
let uu____13798 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((ff)::[])))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel uu____13798 xx tapp))
end
| uu____13800 -> begin
...
let uu____13812 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (

let uu____13820 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_sfuel), (data_ax)))
in ((((xx_has_type_sfuel)::[])::[]), (uu____13812), (uu____13820))))
in (FStar_SMTEncoding_Util.mkForall uu____13806))
in (

let uu____13828 = (varops.mk_unique (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str))
in ((uu____13805), (Some ("inversion axiom")), (uu____13828))))
in FStar_SMTEncoding_Term.Assume (uu____13801)))
in (

let pattern_guarded_inversion = (

let uu____13832 = ((contains_name env "Prims.inversion") && ((FStar_List.length datas) > (Prims.parse_int "1")))
...
let uu____13852 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (

let uu____13860 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_fuel), (data_ax)))
in ((((xx_has_type_fuel)::(pattern_guard)::[])::[]), (uu____13852), (uu____13860))))
in (FStar_SMTEncoding_Util.mkForall uu____13846))
in (

let uu____13868 = (varops.mk_unique (Prims.strcat "pattern_guarded_inversion_" t.FStar_Ident.str))
in ((uu____13845), (Some ("inversion axiom")), (uu____13868))))
in FStar_SMTEncoding_Term.Assume (uu____13841))
in (uu____13840)::[])))
end
| uu____13870 -> begin
[]
...
let uu____13880 = (FStar_Syntax_Subst.compress k)
in uu____13880.FStar_Syntax_Syntax.n)
in (match (uu____13879) with
...
let uu____13924 = (FStar_Syntax_Subst.open_term formals res)
in (match (uu____13924) with
| (formals1, res1) -> begin
(

let uu____13931 = (encode_binders None formals1 env)
in (match (uu____13931) with
| (vars, guards, env', binder_decls, uu____13946) -> begin
(

let uu____13953 = (new_term_constant_and_tok_from_lid env t)
...
let uu____13970 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((tname), (uu____13970)))
in (FStar_SMTEncoding_Util.mkApp uu____13966))
in (
...
let uu____13982 = (FStar_All.pipe_right vars (FStar_List.map (fun uu____13997 -> (match (uu____13997) with
| (n1, s) -> begin
(((Prims.strcat tname n1)), (s), (false))
end))))
in (

let uu____14005 = (varops.next_id ())
in ((tname), (uu____13982), (FStar_SMTEncoding_Term.Term_sort), (uu____14005), (false))))
in (constructor_or_logic_type_decl uu____13981))
in (
...
in (push_free_var env1 t tname uu____14018))
in (([]), (uu____14017)))
end
| uu____14024 -> begin
(
...
let uu____14052 = (FStar_SMTEncoding_Util.mkEq ((ttok_app), (tapp)))
in ((pats), (None), (vars), (uu____14052)))
in (FStar_SMTEncoding_Util.mkForall' uu____14044))
in ((uu____14043), (Some ("name-token correspondence")), ((Prims.strcat "token_correspondence_" ttok))))
...
let uu____14075 = (encode_term_pred None res1 env' tapp)
...
let uu____14095 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" uu____14095))
in ((uu____14094), (Some ("kinding")), ((Prims.strcat "pre_kinding_" ttok))))
in FStar_SMTEncoding_Term.Assume (uu____14090))
in (uu____14089)::[])
end
| uu____14097 -> begin
[]
...
let uu____14114 = (FStar_SMTEncoding_Util.mkImp ((guard), (k1)))
in ((((tapp)::[])::[]), (vars), (uu____14114)))
in (FStar_SMTEncoding_Util.mkForall uu____14108))
in ((uu____14107), (None), ((Prims.strcat "kinding_" ttok))))
in FStar_SMTEncoding_Term.Assume (uu____14103))
in (uu____14102)::[])
in (FStar_List.append karr uu____14100))
in (FStar_List.append decls1 uu____14098)))
end))
in (
...
let uu____14125 = (inversion_axioms tapp vars)
in (

let uu____14127 = (

let uu____14129 = (pretype_axiom env2 tapp vars)
in (uu____14129)::[])
in (FStar_List.append uu____14125 uu____14127)))
in (FStar_List.append kindingAx uu____14123))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (d, uu____14134, uu____14135, uu____14136, uu____14137, uu____14138, uu____14139) when (FStar_Ident.lid_equals d FStar_Syntax_Const.lexcons_lid) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_datacon (d, uu____14146, t, uu____14148, n_tps, quals, uu____14151) -> begin
(

let uu____14156 = (new_term_constant_and_tok_from_lid env d)
...
let uu____14167 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____14167) with
| (formals, t_res) -> begin
(

let uu____14189 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
...
let uu____14198 = (encode_binders (Some (fuel_tm)) formals env1)
in (match (uu____14198) with
...
let uu____14236 = (mk_term_projector_name d x)
in ((uu____14236), (FStar_SMTEncoding_Term.Term_sort), (projectible)))))))
in (
...
let uu____14248 = (varops.next_id ())
in ((ddconstrsym), (fields), (FStar_SMTEncoding_Term.Term_sort), (uu____14248), (true)))
in (FStar_All.pipe_right uu____14238 FStar_SMTEncoding_Term.constructor_to_decl))
in (
...
let uu____14270 = (encode_term_pred None t env1 ddtok_tm)
in (match (uu____14270) with
| (tok_typing, decls3) -> begin
(

let tok_typing1 = (match (fields) with
| (uu____14278)::uu____14279 -> begin
(
...
let uu____14310 = (FStar_SMTEncoding_Term.mk_NoHoist f tok_typing)
in ((((vtok_app_l)::[])::((vtok_app_r)::[])::[]), ((ff)::[]), (uu____14310)))
in (FStar_SMTEncoding_Util.mkForall uu____14304))))))
end
| uu____14323 -> begin
tok_typing
end)
...
let uu____14328 = (encode_binders (Some (fuel_tm)) formals env1)
in (match (uu____14328) with
| (vars', guards', env'', decls_formals, uu____14343) -> begin
(
...
in (FStar_SMTEncoding_Term.fresh_token ((ddtok), (FStar_SMTEncoding_Term.Term_sort)) uu____14374))
in (uu____14373)::[])
end)
in (

let encode_elim = (fun uu____14381 -> (

let uu____14382 = (FStar_Syntax_Util.head_and_args t_res)
...
let uu____14412 = (FStar_Syntax_Subst.compress head1)
in uu____14412.FStar_Syntax_Syntax.n)
...
let uu____14430 = (encode_args args env')
...
let uu____14465 = (FStar_SMTEncoding_Term.free_variables g)
in (FStar_List.contains fv1 uu____14465))
in (match (uu____14464) with
| true -> begin
(

let uu____14472 = (FStar_SMTEncoding_Term.subst g fv1 xv)
in (uu____14472)::[])
end
| uu____14473 -> begin
[]
...
let uu____14474 = (FStar_List.fold_left (fun uu____14487 arg -> (match (uu____14487) with
| (env2, arg_vars, eqns_or_guards, i) -> begin
(

let uu____14509 = (

let uu____14513 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env2 uu____14513))
in (match (uu____14509) with
| (uu____14520, xv, env3) -> begin
(
...
let uu____14526 = (guards_for_parameter arg xv)
in (uu____14526)::eqns_or_guards)
end
| uu____14527 -> begin
(

let uu____14528 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (uu____14528)::eqns_or_guards)
end)
in ((env3), ((xv)::arg_vars), (eqns), ((i + (Prims.parse_int "1")))))
end))
end)) ((env'), ([]), ([]), ((Prims.parse_int "0"))) encoded_args)
in (match (uu____14474) with
| (uu____14536, arg_vars, elim_eqns_or_guards, uu____14539) -> begin
(
...
let uu____14579 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append elim_eqns_or_guards guards))
...
in ((uu____14562), (Some ("data constructor typing elim")), ((Prims.strcat "data_elim_" ddconstrsym))))
in FStar_SMTEncoding_Term.Assume (uu____14558))
in (
...
let uu____14592 = (varops.fresh "x")
in ((uu____14592), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
let uu____14610 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in (uu____14610)::[])
in (uu____14608)::[])
in (
...
let uu____14617 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (

let uu____14618 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in ((uu____14617), (uu____14618))))
in (FStar_SMTEncoding_Util.mkImp uu____14614))
in ((uu____14605), ((x)::[]), (uu____14613))))
in (FStar_SMTEncoding_Util.mkForall uu____14599))
in (

let uu____14628 = (varops.mk_unique "lextop")
in ((uu____14598), (Some ("lextop is top")), (uu____14628))))
in FStar_SMTEncoding_Term.Assume (uu____14594))))
end
| uu____14630 -> begin
(
...
let uu____14633 = (FStar_All.pipe_right vars (FStar_List.mapi (fun i v1 -> (match ((i < n_tps)) with
| true -> begin
[]
end
| uu____14647 -> begin
...
let uu____14649 = (FStar_SMTEncoding_Util.mkFreeV v1)
in (FStar_SMTEncoding_Util.mk_Precedes uu____14649 dapp1))
in (uu____14648)::[])
end))))
in (FStar_All.pipe_right uu____14633 FStar_List.flatten))
in (
...
let uu____14664 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____14674 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (uu____14674)))
in (FStar_SMTEncoding_Util.mkImp uu____14671))
in ((((ty_pred)::[])::[]), (uu____14664), (uu____14670))))
in (FStar_SMTEncoding_Util.mkForall uu____14658))
in ((uu____14657), (Some ("subterm ordering")), ((Prims.strcat "subterm_ordering_" ddconstrsym))))
in FStar_SMTEncoding_Term.Assume (uu____14653)))
end)
...
let uu____14687 = (FStar_Syntax_Print.lid_to_string d)
in (

let uu____14688 = (FStar_Syntax_Print.term_to_string head1)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" uu____14687 uu____14688)))
in (FStar_Errors.warn se.FStar_Syntax_Syntax.sigrng uu____14686));
(([]), ([]));
)
end))
end)))
...
let uu____14721 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" uu____14721))
in Some (uu____14720))
in ((ddtok), ([]), (FStar_SMTEncoding_Term.Term_sort), (uu____14718)))
in FStar_SMTEncoding_Term.DeclFun (uu____14712))
in (uu____14711)::[])
in (
...
let uu____14748 = (FStar_SMTEncoding_Util.mkEq ((app), (dapp)))
in ((((app)::[])::[]), (vars), (uu____14748)))
in (FStar_SMTEncoding_Util.mkForall uu____14742))
in ((uu____14741), (Some ("equality for proxy")), ((Prims.strcat "equality_tok_" ddtok))))
in FStar_SMTEncoding_Term.Assume (uu____14737))
in (
...
let uu____14769 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) vars')
in (

let uu____14775 = (FStar_SMTEncoding_Util.mkImp ((guard'), (ty_pred')))
in ((((ty_pred')::[])::[]), (uu____14769), (uu____14775))))
in (FStar_SMTEncoding_Util.mkForall uu____14763))
in ((uu____14762), (Some ("data constructor typing intro")), ((Prims.strcat "data_typing_intro_" ddtok))))
in FStar_SMTEncoding_Term.Assume (uu____14758))
in (uu____14757)::[])
in (uu____14736)::uu____14755))
in (FStar_SMTEncoding_Term.Assume (((tok_typing1), (Some ("typing for data constructor proxy")), ((Prims.strcat "typing_tok_" ddtok)))))::uu____14734)
in (FStar_List.append uu____14732 elim))
in (FStar_List.append decls_pred uu____14730))
in (FStar_List.append decls_formals uu____14728))
in (FStar_List.append proxy_fresh uu____14726))
in (FStar_List.append uu____14709 uu____14724)))
in (FStar_List.append decls3 uu____14707))
in (FStar_List.append decls2 uu____14705))
in (FStar_List.append binder_decls uu____14703))
...
and encode_signature : env_t  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_SMTEncoding_Term.decl Prims.list * env_t) = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun uu____14796 se -> (match (uu____14796) with
| (g, env1) -> begin
(

let uu____14808 = (encode_sigelt env1 se)
...
let encode_binding = (fun b uu____14844 -> (match (uu____14844) with
| (i, decls, env1) -> begin
(match (b) with
| FStar_TypeChecker_Env.Binding_univ (uu____14862) -> begin
...
let uu____14867 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____14867) with
| true -> begin
(

let uu____14868 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____14869 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____14870 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" uu____14868 uu____14869 uu____14870))))
end
| uu____14871 -> begin
()
end));
...
let uu____14872 = (encode_term t1 env1)
...
let uu____14888 = (FStar_Util.digest_of_string t_hash)
in (Prims.strcat uu____14888 (Prims.strcat "_" (Prims.string_of_int i))))
in (Prims.strcat "x_" uu____14887))
in (new_term_constant_from_string env1 x uu____14886))
...
let uu____14899 = (FStar_Options.log_queries ())
...
let uu____14902 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____14903 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____14904 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" uu____14902 uu____14903 uu____14904))))
in Some (uu____14901))
end
| uu____14905 -> begin
None
...
| FStar_TypeChecker_Env.Binding_lid (x, (uu____14915, t)) -> begin
(
...
let uu____14924 = (encode_free_var env1 fv t t_norm [])
...
let uu____14943 = (encode_sigelt env1 se)
in (match (uu____14943) with
| (g, env') -> begin
(((i + (Prims.parse_int "1"))), ((FStar_List.append decls g)), (env'))
end))
end)
...
let uu____14953 = (FStar_List.fold_right encode_binding bindings (((Prims.parse_int "0")), ([]), (env)))
in (match (uu____14953) with
| (uu____14965, decls, env1) -> begin
((decls), (env1))
end))))
...
let prefix1 = (FStar_All.pipe_right labs (FStar_List.map (fun uu____15010 -> (match (uu____15010) with
| (l, uu____15017, uu____15018) -> begin
FStar_SMTEncoding_Term.DeclFun ((((Prims.fst l)), ([]), (FStar_SMTEncoding_Term.Bool_sort), (None)))
end))))
in (

let suffix = (FStar_All.pipe_right labs (FStar_List.collect (fun uu____15039 -> (match (uu____15039) with
| (l, uu____15047, uu____15048) -> begin
(

let uu____15053 = (FStar_All.pipe_left (fun _0_39 -> FStar_SMTEncoding_Term.Echo (_0_39)) (Prims.fst l))
in (
...
let uu____15057 = (FStar_SMTEncoding_Util.mkFreeV l)
in FStar_SMTEncoding_Term.Eval (uu____15057))
in (uu____15056)::[])
in (uu____15053)::uu____15054))
end))))
in ((prefix1), (suffix)))))
...
let uu____15071 = (FStar_Util.smap_create (Prims.parse_int "100"))
in (

let uu____15083 = (

let uu____15084 = (FStar_TypeChecker_Env.current_module tcenv)
in (FStar_All.pipe_right uu____15084 FStar_Ident.string_of_lid))
in {bindings = []; depth = (Prims.parse_int "0"); tcenv = tcenv; warn = true; cache = uu____15071; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true; current_module_name = uu____15083}))
in (uu____15070)::[])
in (FStar_ST.write last_env uu____15068)))
...
let uu___163_15102 = e
in (

let uu____15103 = (FStar_Ident.string_of_lid cmn)
in {bindings = uu___163_15102.bindings; depth = uu___163_15102.depth; tcenv = tcenv; warn = uu___163_15102.warn; cache = uu___163_15102.cache; nolabels = uu___163_15102.nolabels; use_zfuel_name = uu___163_15102.use_zfuel_name; encode_non_total_function_typ = uu___163_15102.encode_non_total_function_typ; current_module_name = uu____15103}))
end)))


let set_env : env_t  ->  Prims.unit = (fun env -> (

let uu____15107 = (FStar_ST.read last_env)
in (match (uu____15107) with
| [] -> begin
(failwith "Empty env stack")
end
| (uu____15112)::tl1 -> begin
(FStar_ST.write last_env ((env)::tl1))
end)))


let push_env : Prims.unit  ->  Prims.unit = (fun uu____15120 -> (

let uu____15121 = (FStar_ST.read last_env)
in (match (uu____15121) with
| [] -> begin
(failwith "Empty env stack")
end
| (hd1)::tl1 -> begin
...
let uu___164_15142 = hd1
in {bindings = uu___164_15142.bindings; depth = uu___164_15142.depth; tcenv = uu___164_15142.tcenv; warn = uu___164_15142.warn; cache = refs; nolabels = uu___164_15142.nolabels; use_zfuel_name = uu___164_15142.use_zfuel_name; encode_non_total_function_typ = uu___164_15142.encode_non_total_function_typ; current_module_name = uu___164_15142.current_module_name})
in (FStar_ST.write last_env ((top)::(hd1)::tl1))))
end)))


let pop_env : Prims.unit  ->  Prims.unit = (fun uu____15148 -> (

let uu____15149 = (FStar_ST.read last_env)
in (match (uu____15149) with
| [] -> begin
(failwith "Popping an empty stack")
end
| (uu____15154)::tl1 -> begin
(FStar_ST.write last_env tl1)
end)))


let mark_env : Prims.unit  ->  Prims.unit = (fun uu____15162 -> (push_env ()))


let reset_mark_env : Prims.unit  ->  Prims.unit = (fun uu____15165 -> (pop_env ()))


let commit_mark_env : Prims.unit  ->  Prims.unit = (fun uu____15168 -> (

let uu____15169 = (FStar_ST.read last_env)
in (match (uu____15169) with
| (hd1)::(uu____15175)::tl1 -> begin
...
let uu____15226 = (FStar_Options.log_queries ())
...
let uu____15231 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se) (FStar_List.map FStar_Syntax_Print.lid_to_string))
in (FStar_All.pipe_right uu____15231 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " uu____15230))
in FStar_SMTEncoding_Term.Caption (uu____15229))
in (uu____15228)::decls)
end
| uu____15236 -> begin
decls
end)))
...
let uu____15238 = (FStar_TypeChecker_Env.current_module tcenv)
in (get_env uu____15238 tcenv))
in (

let uu____15239 = (encode_sigelt env se)
in (match (uu____15239) with
| (decls, env1) -> begin
((set_env env1);
(

let uu____15245 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 uu____15245));
)
end)))))
...
let uu____15256 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
in (match (uu____15256) with
| true -> begin
(

let uu____15257 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) Prims.string_of_int)
...
let uu____15262 = (encode_signature (

let uu___165_15266 = env
in {bindings = uu___165_15266.bindings; depth = uu___165_15266.depth; tcenv = uu___165_15266.tcenv; warn = false; cache = uu___165_15266.cache; nolabels = uu___165_15266.nolabels; use_zfuel_name = uu___165_15266.use_zfuel_name; encode_non_total_function_typ = uu___165_15266.encode_non_total_function_typ; current_module_name = uu___165_15266.current_module_name}) modul.FStar_Syntax_Syntax.exports)
in (match (uu____15262) with
| (decls, env1) -> begin
(
...
let uu___166_15283 = env1
in {bindings = uu___166_15283.bindings; depth = uu___166_15283.depth; tcenv = uu___166_15283.tcenv; warn = true; cache = uu___166_15283.cache; nolabels = uu___166_15283.nolabels; use_zfuel_name = uu___166_15283.use_zfuel_name; encode_non_total_function_typ = uu___166_15283.encode_non_total_function_typ; current_module_name = uu___166_15283.current_module_name}));
(

let uu____15285 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
in (match (uu____15285) with
| true -> begin
...
let uu____15321 = (FStar_TypeChecker_Env.current_module tcenv)
in uu____15321.FStar_Ident.str)
in (FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name uu____15320));
(

let env = (

let uu____15323 = (FStar_TypeChecker_Env.current_module tcenv)
in (get_env uu____15323 tcenv))
in (
...
let uu____15369 = (FStar_Syntax_Util.destruct_typ_as_formula x.FStar_Syntax_Syntax.sort)
in (match (uu____15369) with
| Some (uu____15373) -> begin
(

let uu____15374 = (FStar_Syntax_Syntax.new_bv None FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.refine uu____15374 x.FStar_Syntax_Syntax.sort))
end
| uu____15375 -> begin
...
let uu____15380 = (FStar_Syntax_Syntax.mk_binder (

let uu___167_15381 = x
in {FStar_Syntax_Syntax.ppname = uu___167_15381.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___167_15381.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in (uu____15380)::out)
in ((uu____15378), (rest1)))))
end))
end
| uu____15384 -> begin
(([]), (bindings1))
...
let uu____15388 = (aux bindings)
in (match (uu____15388) with
| (closing, bindings1) -> begin
(

let uu____15402 = (FStar_Syntax_Util.close_forall_no_univs (FStar_List.rev closing) q)
in ((uu____15402), (bindings1)))
end)))
in (match (uu____15330) with
| (q1, bindings1) -> begin
(

let uu____15415 = (

let uu____15418 = (FStar_List.filter (fun uu___136_15420 -> (match (uu___136_15420) with
| FStar_TypeChecker_Env.Binding_sig (uu____15421) -> begin
false
end
| uu____15425 -> begin
true
end)) bindings1)
in (encode_env_bindings env uu____15418))
in (match (uu____15415) with
| (env_decls, env1) -> begin
((

let uu____15436 = (((FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTEncoding")))) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTQuery"))))
in (match (uu____15436) with
| true -> begin
(

let uu____15437 = (FStar_Syntax_Print.term_to_string q1)
...
let uu____15439 = (encode_formula q1 env1)
...
let uu____15454 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg uu____15454 phi))
in (match (uu____15451) with
| (labels, phi1) -> begin
(

let uu____15464 = (encode_labels labels)
...
let uu____15489 = (FStar_SMTEncoding_Util.mkNot phi1)
in (

let uu____15490 = (varops.mk_unique "@query")
in ((uu____15489), (Some ("query")), (uu____15490))))
in FStar_SMTEncoding_Term.Assume (uu____15485))
in (
...
let uu____15498 = (FStar_Options.print_z3_statistics ())
...
in (FStar_List.append uu____15496 ((FStar_SMTEncoding_Term.Echo ("Done!"))::[])))
in (FStar_List.append label_suffix uu____15494))
...
let uu____15510 = (FStar_TypeChecker_Env.current_module tcenv)
in (get_env uu____15510 tcenv))
in ((FStar_SMTEncoding_Z3.push "query");
(

let uu____15512 = (encode_formula q env)
in (match (uu____15512) with
| (f, uu____15516) -> begin
((FStar_SMTEncoding_Z3.pop "query");
(match (f.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.TrueOp, uu____15518) -> begin
true
end
| uu____15521 -> begin
false
