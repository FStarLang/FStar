...
let mk_term_projector_name:
  ...
  fun lid  ->
    fun a  ->
      let a1 =
        let uu___384_203 = a in
        let uu____204 =
          FStar_Syntax_Util.unmangle_field_name a.FStar_Syntax_Syntax.ppname in
        {
          FStar_Syntax_Syntax.ppname = uu____204;
          FStar_Syntax_Syntax.index =
            (uu___384_203.FStar_Syntax_Syntax.index);
          FStar_Syntax_Syntax.sort = (uu___384_203.FStar_Syntax_Syntax.sort)
        } in
      let uu____205 =
...
let unmangle: FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv =
  fun x  ->
    let uu___385_1847 = x in
    let uu____1848 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname in
    {
      FStar_Syntax_Syntax.ppname = uu____1848;
      FStar_Syntax_Syntax.index = (uu___385_1847.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___385_1847.FStar_Syntax_Syntax.sort)
    }
type binding =
...
let gen_term_var:
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___386_2398 = env in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (env.depth + (Prims.parse_int "1"));
           tcenv = (uu___386_2398.tcenv);
           warn = (uu___386_2398.warn);
           cache = (uu___386_2398.cache);
           nolabels = (uu___386_2398.nolabels);
           use_zfuel_name = (uu___386_2398.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___386_2398.encode_non_total_function_typ);
           current_module_name = (uu___386_2398.current_module_name)
         }))
let new_term_constant:
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___387_2416 = env in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (uu___387_2416.depth);
           tcenv = (uu___387_2416.tcenv);
           warn = (uu___387_2416.warn);
           cache = (uu___387_2416.cache);
           nolabels = (uu___387_2416.nolabels);
           use_zfuel_name = (uu___387_2416.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___387_2416.encode_non_total_function_typ);
           current_module_name = (uu___387_2416.current_module_name)
         }))
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, []) in
        (ysym, y,
          (let uu___388_2437 = env in
           {
             bindings = ((Binding_var (x, y)) :: (env.bindings));
             depth = (uu___388_2437.depth);
             tcenv = (uu___388_2437.tcenv);
             warn = (uu___388_2437.warn);
             cache = (uu___388_2437.cache);
             nolabels = (uu___388_2437.nolabels);
             use_zfuel_name = (uu___388_2437.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___388_2437.encode_non_total_function_typ);
             current_module_name = (uu___388_2437.current_module_name)
           }))
let push_term_var:
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___389_2447 = env in
        {
          bindings = ((Binding_var (x, t)) :: (env.bindings));
          depth = (uu___389_2447.depth);
          tcenv = (uu___389_2447.tcenv);
          warn = (uu___389_2447.warn);
          cache = (uu___389_2447.cache);
          nolabels = (uu___389_2447.nolabels);
          use_zfuel_name = (uu___389_2447.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___389_2447.encode_non_total_function_typ);
          current_module_name = (uu___389_2447.current_module_name)
        }
let lookup_term_var:
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____2541 =
        ...
        {
          bindings = uu____2543;
          depth = (uu___390_2542.depth);
          tcenv = (uu___390_2542.tcenv);
          warn = (uu___390_2542.warn);
          cache = (uu___390_2542.cache);
          nolabels = (uu___390_2542.nolabels);
          use_zfuel_name = (uu___390_2542.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___390_2542.encode_non_total_function_typ);
          current_module_name = (uu___390_2542.current_module_name)
        } in
...
let push_free_var:
  ...
  fun env  ->
    fun x  ->
      fun fname  ->
        fun ftok  ->
          let uu___391_2785 = env in
          {
            bindings =
              ((Binding_fvar (x, fname, ftok, FStar_Pervasives_Native.None))
              :: (env.bindings));
            depth = (uu___391_2785.depth);
            tcenv = (uu___391_2785.tcenv);
            warn = (uu___391_2785.warn);
            cache = (uu___391_2785.cache);
            nolabels = (uu___391_2785.nolabels);
            use_zfuel_name = (uu___391_2785.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___391_2785.encode_non_total_function_typ);
            current_module_name = (uu___391_2785.current_module_name)
          }
    ...
    fun x  ->
      fun f  ->
        ...
        | (t1,t2,uu____2812) ->
            ...
            let uu___392_2837 = env in
            {
              bindings =
                ((Binding_fvar (x, t1, t2, (FStar_Pervasives_Native.Some t3)))
                :: (env.bindings));
              depth = (uu___392_2837.depth);
              tcenv = (uu___392_2837.tcenv);
              warn = (uu___392_2837.warn);
              cache = (uu___392_2837.cache);
              nolabels = (uu___392_2837.nolabels);
              use_zfuel_name = (uu___392_2837.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___392_2837.encode_non_total_function_typ);
              current_module_name = (uu___392_2837.current_module_name)
            }
                   ...
                   | (vars,guards,env',decls,uu____6190) ->
                       ...
                       let uu____6211 =
                         FStar_TypeChecker_Util.pure_or_ghost_pre_and_post
                           (let uu___393_6220 = env.tcenv in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___393_6220.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___393_6220.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___393_6220.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___393_6220.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___393_6220.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___393_6220.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___393_6220.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___393_6220.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___393_6220.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___393_6220.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___393_6220.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___393_6220.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___393_6220.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___393_6220.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___393_6220.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___393_6220.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___393_6220.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___393_6220.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___393_6220.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___393_6220.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___393_6220.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___393_6220.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___393_6220.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___393_6220.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___393_6220.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qname_and_index =
                                (uu___393_6220.FStar_TypeChecker_Env.qname_and_index);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___393_6220.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth =
                                (uu___393_6220.FStar_TypeChecker_Env.synth);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___393_6220.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___393_6220.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___393_6220.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___393_6220.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___393_6220.FStar_TypeChecker_Env.dep_graph)
                            }) res in
  ...
  fun t  ->
    fun env  ->
      ...
      | (binders,pre,post,patterns) ->
          let env1 =
            let uu___394_10361 = env in
            {
              bindings = (uu___394_10361.bindings);
              depth = (uu___394_10361.depth);
              tcenv = (uu___394_10361.tcenv);
              warn = (uu___394_10361.warn);
              cache = (uu___394_10361.cache);
              nolabels = (uu___394_10361.nolabels);
              use_zfuel_name = true;
              encode_non_total_function_typ =
                (uu___394_10361.encode_non_total_function_typ);
              current_module_name = (uu___394_10361.current_module_name)
            } in
          let uu____10362 =
           ...
           | (vars,guards,env2,decls,uu____10387) ->
               ...
               (match uu____10400 with
                | (pats,decls') ->
                    ...
                    let env3 =
                      let uu___395_10578 = env2 in
                      {
                        bindings = (uu___395_10578.bindings);
                        depth = (uu___395_10578.depth);
                        tcenv = (uu___395_10578.tcenv);
                        warn = (uu___395_10578.warn);
                        cache = (uu___395_10578.cache);
                        nolabels = true;
                        use_zfuel_name = (uu___395_10578.use_zfuel_name);
                        encode_non_total_function_typ =
                          (uu___395_10578.encode_non_total_function_typ);
                        current_module_name =
                          (uu___395_10578.current_module_name)
                      } in
                    let uu____10579 =
  ...
  fun phi  ->
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            let uu____10735 =
              let uu___396_10736 = f args in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___396_10736.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___396_10736.FStar_SMTEncoding_Term.freevars);
      ...
      let bin_op f uu___370_10815 =
        match uu___370_10815 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
        ...
        | (decls,phis) ->
            let uu____10927 =
              let uu___397_10928 = f phis in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___397_10928.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___397_10928.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              } in
      ...
      let eq_op r args =
        ...
        then
          ...
          (let uu____11038 = enc (bin_op FStar_SMTEncoding_Util.mkEq) in
           uu____11038 r rf) in
      let mk_imp1 r uu___371_11063 =
        match uu___371_11063 with
      ...
      let mk_ite r uu___372_11154 =
        match uu___372_11154 with
                  ...
                  | (tt,decls) ->
                      let uu____12114 =
                        FStar_SMTEncoding_Term.mk_Valid
                          (let uu___398_12117 = tt in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___398_12117.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___398_12117.FStar_SMTEncoding_Term.freevars);
        ...
        | uu____12118 ->
            ...
            (match uu____12119 with
             | (tt,decls) ->
                 let uu____12130 =
                   FStar_SMTEncoding_Term.mk_Valid
                     (let uu___399_12133 = tt in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___399_12133.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___399_12133.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      }) in
                            ...
                            FStar_All.pipe_right p
                              (FStar_List.map
                                 (fun uu____12321  ->
                                    ...
                                    | (t,uu____12331) ->
                                        encode_term t
                                          (let uu___400_12333 = env2 in
                                           {
                                             bindings =
                                               (uu___400_12333.bindings);
                                             depth = (uu___400_12333.depth);
                                             tcenv = (uu___400_12333.tcenv);
                                             warn = (uu___400_12333.warn);
                                             cache = (uu___400_12333.cache);
                                             nolabels =
                                               (uu___400_12333.nolabels);
                                             use_zfuel_name = true;
                                             encode_non_total_function_typ =
                                               (uu___400_12333.encode_non_total_function_typ);
                                             current_module_name =
                                               (uu___400_12333.current_module_name)
                                           }))) in
                            ...
                            then
                              let uu____16917 =
                                FStar_TypeChecker_Env.reify_comp
                                  (let uu___401_16920 = env.tcenv in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___401_16920.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___401_16920.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___401_16920.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___401_16920.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___401_16920.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___401_16920.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       (uu___401_16920.FStar_TypeChecker_Env.expected_typ);
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___401_16920.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___401_16920.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___401_16920.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___401_16920.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___401_16920.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (uu___401_16920.FStar_TypeChecker_Env.letrecs);
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___401_16920.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___401_16920.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___401_16920.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___401_16920.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___401_16920.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax = true;
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___401_16920.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.failhard =
                                       (uu___401_16920.FStar_TypeChecker_Env.failhard);
                                     FStar_TypeChecker_Env.nosynth =
                                       (uu___401_16920.FStar_TypeChecker_Env.nosynth);
                                     FStar_TypeChecker_Env.tc_term =
                                       (uu___401_16920.FStar_TypeChecker_Env.tc_term);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___401_16920.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___401_16920.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       (uu___401_16920.FStar_TypeChecker_Env.use_bv_sorts);
                                     FStar_TypeChecker_Env.qname_and_index =
                                       (uu___401_16920.FStar_TypeChecker_Env.qname_and_index);
                                     FStar_TypeChecker_Env.proof_ns =
                                       (uu___401_16920.FStar_TypeChecker_Env.proof_ns);
                                     FStar_TypeChecker_Env.synth =
                                       (uu___401_16920.FStar_TypeChecker_Env.synth);
                                     FStar_TypeChecker_Env.is_native_tactic =
                                       (uu___401_16920.FStar_TypeChecker_Env.is_native_tactic);
                                     FStar_TypeChecker_Env.identifier_info =
                                       (uu___401_16920.FStar_TypeChecker_Env.identifier_info);
                                     FStar_TypeChecker_Env.tc_hooks =
                                       (uu___401_16920.FStar_TypeChecker_Env.tc_hooks);
                                     FStar_TypeChecker_Env.dsenv =
                                       (uu___401_16920.FStar_TypeChecker_Env.dsenv);
                                     FStar_TypeChecker_Env.dep_graph =
                                       (uu___401_16920.FStar_TypeChecker_Env.dep_graph)
                                  ...
                                  (match uu____17255 with
                                   | (guard,decls11) ->
                                       ...
                                       let uu____17306 =
                                         ...
                                         let uu____17344 =
                                           let env2 =
                                             let uu___402_17350 = env1 in
                                             {
                                               bindings =
                                                 (uu___402_17350.bindings);
                                               depth = (uu___402_17350.depth);
                                               tcenv = (uu___402_17350.tcenv);
                                               warn = (uu___402_17350.warn);
                                               cache = (uu___402_17350.cache);
                                               nolabels =
                                                 (uu___402_17350.nolabels);
                                               use_zfuel_name =
                                                 (uu___402_17350.use_zfuel_name);
                                               encode_non_total_function_typ;
                                               current_module_name =
                                                 (uu___402_17350.current_module_name)
                                             } in
                                           let uu____17351 =
                                             let uu____17352 =
        ...
        | (is_rec,bindings) ->
                      ...
                      FStar_All.pipe_right extra_formals
                        (FStar_List.map
                           (fun uu____18305  ->
                              ...
                              | (x,i) ->
                                  let uu____18316 =
                                    let uu___403_18317 = x in
                                    let uu____18318 =
                                      FStar_Syntax_Subst.subst subst1
                                        x.FStar_Syntax_Syntax.sort in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___403_18317.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___403_18317.FStar_Syntax_Syntax.index);
            ...
            let destruct_bound_function flid t_norm e =
              let get_result_type c =
                ...
                then
                  FStar_TypeChecker_Env.reify_comp
                    (let uu___404_18403 = env.tcenv in
                     {
                       FStar_TypeChecker_Env.solver =
                         (uu___404_18403.FStar_TypeChecker_Env.solver);
                       FStar_TypeChecker_Env.range =
                         (uu___404_18403.FStar_TypeChecker_Env.range);
                       FStar_TypeChecker_Env.curmodule =
                         (uu___404_18403.FStar_TypeChecker_Env.curmodule);
                       FStar_TypeChecker_Env.gamma =
                         (uu___404_18403.FStar_TypeChecker_Env.gamma);
                       FStar_TypeChecker_Env.gamma_cache =
                         (uu___404_18403.FStar_TypeChecker_Env.gamma_cache);
                       FStar_TypeChecker_Env.modules =
                         (uu___404_18403.FStar_TypeChecker_Env.modules);
                       FStar_TypeChecker_Env.expected_typ =
                         (uu___404_18403.FStar_TypeChecker_Env.expected_typ);
                       FStar_TypeChecker_Env.sigtab =
                         (uu___404_18403.FStar_TypeChecker_Env.sigtab);
                       FStar_TypeChecker_Env.is_pattern =
                         (uu___404_18403.FStar_TypeChecker_Env.is_pattern);
                       FStar_TypeChecker_Env.instantiate_imp =
                         (uu___404_18403.FStar_TypeChecker_Env.instantiate_imp);
                       FStar_TypeChecker_Env.effects =
                         (uu___404_18403.FStar_TypeChecker_Env.effects);
                       FStar_TypeChecker_Env.generalize =
                         (uu___404_18403.FStar_TypeChecker_Env.generalize);
                       FStar_TypeChecker_Env.letrecs =
                         (uu___404_18403.FStar_TypeChecker_Env.letrecs);
                       FStar_TypeChecker_Env.top_level =
                         (uu___404_18403.FStar_TypeChecker_Env.top_level);
                       FStar_TypeChecker_Env.check_uvars =
                         (uu___404_18403.FStar_TypeChecker_Env.check_uvars);
                       FStar_TypeChecker_Env.use_eq =
                         (uu___404_18403.FStar_TypeChecker_Env.use_eq);
                       FStar_TypeChecker_Env.is_iface =
                         (uu___404_18403.FStar_TypeChecker_Env.is_iface);
                       FStar_TypeChecker_Env.admit =
                         (uu___404_18403.FStar_TypeChecker_Env.admit);
                       FStar_TypeChecker_Env.lax = true;
                       FStar_TypeChecker_Env.lax_universes =
                         (uu___404_18403.FStar_TypeChecker_Env.lax_universes);
                       FStar_TypeChecker_Env.failhard =
                         (uu___404_18403.FStar_TypeChecker_Env.failhard);
                       FStar_TypeChecker_Env.nosynth =
                         (uu___404_18403.FStar_TypeChecker_Env.nosynth);
                       FStar_TypeChecker_Env.tc_term =
                         (uu___404_18403.FStar_TypeChecker_Env.tc_term);
                       FStar_TypeChecker_Env.type_of =
                         (uu___404_18403.FStar_TypeChecker_Env.type_of);
                       FStar_TypeChecker_Env.universe_of =
                         (uu___404_18403.FStar_TypeChecker_Env.universe_of);
                       FStar_TypeChecker_Env.use_bv_sorts =
                         (uu___404_18403.FStar_TypeChecker_Env.use_bv_sorts);
                       FStar_TypeChecker_Env.qname_and_index =
                         (uu___404_18403.FStar_TypeChecker_Env.qname_and_index);
                       FStar_TypeChecker_Env.proof_ns =
                         (uu___404_18403.FStar_TypeChecker_Env.proof_ns);
                       FStar_TypeChecker_Env.synth =
                         (uu___404_18403.FStar_TypeChecker_Env.synth);
                       FStar_TypeChecker_Env.is_native_tactic =
                         (uu___404_18403.FStar_TypeChecker_Env.is_native_tactic);
                       FStar_TypeChecker_Env.identifier_info =
                         (uu___404_18403.FStar_TypeChecker_Env.identifier_info);
                       FStar_TypeChecker_Env.tc_hooks =
                         (uu___404_18403.FStar_TypeChecker_Env.tc_hooks);
                       FStar_TypeChecker_Env.dsenv =
                         (uu___404_18403.FStar_TypeChecker_Env.dsenv);
                       FStar_TypeChecker_Env.dep_graph =
                         (uu___404_18403.FStar_TypeChecker_Env.dep_graph)
                            ...
                            let uu____19945 =
                              ...
                              | (tcenv',uu____19970,e_t) ->
                                  ...
                                  (match uu____19976 with
                                   | (e1,t_norm1) ->
                                       ((let uu___407_20003 = env2 in
                                         {
                                           bindings =
                                             (uu___407_20003.bindings);
                                           depth = (uu___407_20003.depth);
                                           tcenv = tcenv';
                                           warn = (uu___407_20003.warn);
                                           cache = (uu___407_20003.cache);
                                           nolabels =
                                             (uu___407_20003.nolabels);
                                           use_zfuel_name =
                                             (uu___407_20003.use_zfuel_name);
                                           encode_non_total_function_typ =
                                             (uu___407_20003.encode_non_total_function_typ);
                                           current_module_name =
                                             (uu___407_20003.current_module_name)
                                         }), e1, t_norm1)) in
                      ...
                      let encode_rec_lbdefs bindings1 typs2 toks2 env2 =
                        ...
                        | (gtoks,env3) ->
                                  ...
                                  let uu____20764 =
                                    ...
                                    | (tcenv',uu____20793,e_t) ->
                                        ...
                                        (match uu____20799 with
                                         | (e1,t_norm1) ->
                                             ((let uu___408_20826 = env3 in
                                               {
                                                 bindings =
                                                   (uu___408_20826.bindings);
                                                 depth =
                                                   (uu___408_20826.depth);
                                                 tcenv = tcenv';
                                                 warn = (uu___408_20826.warn);
                                                 cache =
                                                   (uu___408_20826.cache);
                                                 nolabels =
                                                   (uu___408_20826.nolabels);
                                                 use_zfuel_name =
                                                   (uu___408_20826.use_zfuel_name);
                                                 encode_non_total_function_typ
                                                   =
                                                   (uu___408_20826.encode_non_total_function_typ);
                                                 current_module_name =
                                                   (uu___408_20826.current_module_name)
                                               }), e1, t_norm1)) in
                            ...
                            (match uu____21409 with
                             | (decls2,eqns,env01) ->
                                 let uu____21730 =
                                   let isDeclFun uu___374_21742 =
                                     match uu___374_21742 with
                                     | FStar_SMTEncoding_Term.DeclFun
                                         uu____21743 -> true
                     ...
                     let val_decl =
                       let uu___411_22690 = se in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___411_22690.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___411_22690.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___411_22690.FStar_Syntax_Syntax.sigattrs)
                       } in
           ...
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 let uu___412_22912 = se in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___412_22912.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___412_22912.FStar_Syntax_Syntax.sigmeta);
                   FStar_Syntax_Syntax.sigattrs =
                     (uu___412_22912.FStar_Syntax_Syntax.sigattrs)
                 } in
...
let get_env: FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____26319 ->
          let uu___413_26322 = e in
          let uu____26323 = FStar_Ident.string_of_lid cmn in
          {
            bindings = (uu___413_26322.bindings);
            depth = (uu___413_26322.depth);
            tcenv;
            warn = (uu___413_26322.warn);
            cache = (uu___413_26322.cache);
            nolabels = (uu___413_26322.nolabels);
            use_zfuel_name = (uu___413_26322.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___413_26322.encode_non_total_function_typ);
...
let push_env: Prims.unit -> Prims.unit =
  fun uu____26436  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___414_26498 = hd1 in
          {
            bindings = (uu___414_26498.bindings);
            depth = (uu___414_26498.depth);
            tcenv = (uu___414_26498.tcenv);
            warn = (uu___414_26498.warn);
            cache = refs;
            nolabels = (uu___414_26498.nolabels);
            use_zfuel_name = (uu___414_26498.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___414_26498.encode_non_total_function_typ);
            current_module_name = (uu___414_26498.current_module_name)
          } in
    ...
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____26696::uu____26697,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___415_26705 = a in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___415_26705.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___415_26705.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___415_26705.FStar_SMTEncoding_Term.assumption_name);
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv in
       ...
       let uu____26911 =
         encode_signature
           (let uu___416_26920 = env in
            {
              bindings = (uu___416_26920.bindings);
              depth = (uu___416_26920.depth);
              tcenv = (uu___416_26920.tcenv);
              warn = false;
              cache = (uu___416_26920.cache);
              nolabels = (uu___416_26920.nolabels);
              use_zfuel_name = (uu___416_26920.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___416_26920.encode_non_total_function_typ);
              current_module_name = (uu___416_26920.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___417_26945 = env1 in
               {
                 bindings = (uu___417_26945.bindings);
                 depth = (uu___417_26945.depth);
                 tcenv = (uu___417_26945.tcenv);
                 warn = true;
                 cache = (uu___417_26945.cache);
                 nolabels = (uu___417_26945.nolabels);
                 use_zfuel_name = (uu___417_26945.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___417_26945.encode_non_total_function_typ);
                 current_module_name = (uu___417_26945.current_module_name)
               });
            (let uu____26947 =
                      ...
                      let uu____27090 =
                        let uu____27093 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___418_27096 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___418_27096.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___418_27096.FStar_Syntax_Syntax.index);
