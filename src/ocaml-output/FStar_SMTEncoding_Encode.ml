...
let (primitive_type_axioms :
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let body =
      ...
      let hastypeS =
        let uu____6285 = FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "1") in
    ...
    fun se ->
      ...
      (let is_opaque_to_smt t =
                                       ...
                                       let uu____13283 =
                                         ...
                                         let uu____13285 =
                                           let uu____13296 =
                                             ...
                                             FStar_SMTEncoding_Util.mkEq
                                               uu____13297 in
                                           ([[app]], xs_sorts, uu____13296) in
                                         FStar_SMTEncoding_Term.mkForall
                                           uu____13284 uu____13285 in
                                       (uu____13283,
                                         (FStar_Pervasives_Native.Some
                                            "Action equality"),
       ...
       | FStar_Syntax_Syntax.Sig_let
           ((uu____13655,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inr b2t1;
               ...
               FStar_Syntax_Syntax.lbpos = uu____13662;_}::[]),
            uu____13663)
       ...
       | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____13836) when
           ...
           let uu____13862 = FStar_SMTEncoding_Env.try_lookup_free_var env l in
           ...
           let is_injective =
             ...
             | (usubst, uvs) ->
                 ...
                 (match uu____14321 with
                  | (env1, tps1, k1) ->
                      let uu____14344 = FStar_Syntax_Subst.open_term tps1 k1 in
                                       ...
                                       let uu____14405 =
                                         ...
                                         let uu____14407 =
                                           ...
                                           FStar_Syntax_Syntax.mk_Tm_app
                                             uu____14412 uu____14414 in
                                         uu____14407
                                           FStar_Pervasives_Native.None
                                           uu____14406 in
                                       FStar_TypeChecker_TcTerm.level_of_type
                                         env_tps uu____14405 k3 in
             ...
             let constructor_or_logic_type_decl c =
               ...
               then
                           ...
                           FStar_All.pipe_right args
                             (FStar_List.map
                                (fun uu____14702 ->
                                   ...
                                   | (uu____14711, sort, uu____14713) -> sort)) in
                         (name, uu____14675,
                           FStar_SMTEncoding_Term.Term_sort,
                           FStar_Pervasives_Native.None) in
                 ...
                 (let uu____14724 = FStar_Ident.range_of_lid t in
                  FStar_SMTEncoding_Term.constructor_to_decl uu____14724 c) in
                 ...
                 FStar_All.pipe_right datas
                   (FStar_Util.for_some
                      (fun l ->
                         ...
                         FStar_All.pipe_right uu____14750 FStar_Option.isNone)) in
               if uu____14742
               then []
               else
                 (let uu____14785 =
                            ...
                            | (ffsym, ff) ->
                                let fuel_guarded_inversion =
                                  ...
                                  let uu____15096 =
                                    ...
                                    (uu____15104,
                                      (FStar_Pervasives_Native.Some
                                         "inversion axiom"), uu____15134) in
                                  FStar_SMTEncoding_Util.mkAssume uu____15096 in
                                let uu____15140 =
                                  FStar_All.pipe_right
                                    [fuel_guarded_inversion]
                                    FStar_SMTEncoding_Term.mk_decls_trivial in
                                FStar_List.append decls uu____15140))) in
             let uu____15147 =
               let k1 =
                 match tps with
                 | [] -> k
                 | uu____15169 ->
                     let uu____15170 =
                       let uu____15177 =
                         let uu____15178 =
                           let uu____15193 = FStar_Syntax_Syntax.mk_Total k in
                           (tps, uu____15193) in
                                        ...
                                        (fun fv ->
                                           let uu____15342 =
                                             let uu____15344 =
                                               FStar_SMTEncoding_Term.fv_name
                                                 fv in
                                             Prims.op_Hat tname uu____15344 in
                                           let uu____15346 =
                                             FStar_SMTEncoding_Term.fv_sort
                                               fv in
                                           (uu____15342, uu____15346, false))) in
                                 let uu____15350 =
                                   FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.next_id
                                     () in
                                 (tname, uu____15323,
                                   FStar_SMTEncoding_Term.Term_sort,
                                   uu____15350, false) in
                                   ...
                                   let uu____15371 =
                                     let uu____15372 =
                                       ...
                                       FStar_All.pipe_left
                                         (fun _15381 ->
                                            FStar_Pervasives_Native.Some
                                              _15381) uu____15375 in
                                     FStar_SMTEncoding_Env.push_free_var env1
                                       t arity tname uu____15372 in
                                   ([], uu____15371)
                               | uu____15384 ->
                                   let ttok_decl =
                                     FStar_SMTEncoding_Term.DeclFun
                                      ...
                                      let tot_fun_axioms =
                                        let uu____15533 =
                                          FStar_List.map
                                            ...
                                            vars in
                                        FStar_SMTEncoding_EncodeTerm.isTotFun_axioms
                                          rng ttok_tm vars uu____15533 true in
                                      let uu____15539 =
                                        let uu____15542 =
                                          let uu____15545 =
                                            let uu____15548 =
                                              ...
                                              FStar_SMTEncoding_Util.mkAssume
                                                uu____15549 in
                                            [uu____15548] in
                                          FStar_List.append karr uu____15545 in
                                        FStar_All.pipe_right uu____15542
                                          FStar_SMTEncoding_Term.mk_decls_trivial in
                                      FStar_List.append decls1 uu____15539 in
                                let aux =
                                  let uu____15594 =
                                    let uu____15597 =
                                    ...
                                    let uu____15600 =
                                      ...
                                      FStar_All.pipe_right uu____15603
                                        FStar_SMTEncoding_Term.mk_decls_trivial in
                                    FStar_List.append uu____15597 uu____15600 in
       ...
       | FStar_Syntax_Syntax.Sig_datacon
           (d, uu____15623, uu____15624, uu____15625, uu____15626,
            uu____15627)
                               ...
                               let datacons =
                                 ...
                                 let uu____15837 =
                                   ...
                                   FStar_SMTEncoding_Term.constructor_to_decl
                                     uu____15844 in
                                 FStar_All.pipe_right uu____15828 uu____15837 in
                               let app =
                                 FStar_SMTEncoding_EncodeTerm.mk_Apply
                                   ddtok_tm vars in
                               let guard =
                                                       ...
                                                       let uu____17445 =
                                                         let uu____17448 =
                                                           ...
                                                           FStar_List.append
                                                             ...
                                                             uu____17487 in
                                                         FStar_List.append
                                                           decls3 uu____17448 in
                                                       FStar_List.append
                                                         decls2 uu____17445 in
                                                     FStar_List.append
                                                       binder_decls
                                                       uu____17442 in
                                                   let uu____17590 =
                 ...
                 ((let uu____17758 =
                   ...
                   then
                     ...
                     let uu____17765 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort in
                     let uu____17767 = FStar_Syntax_Print.term_to_string t1 in
                   ...
                   | (t, decls') ->
                       ...
                       (match uu____17790 with
                        | (xxsym, xx, env') ->
                            ...
                            let caption =
                              let uu____17822 = FStar_Options.log_queries () in
                              if uu____17822
                              then
                                let uu____17825 =
                                  let uu____17827 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____17827 uu____17829 uu____17831 in
             ...
             | FStar_Syntax_Syntax.Binding_lid (x, (uu____17872, t)) ->
                 ...
                 let fv =
                   FStar_Syntax_Syntax.lid_as_fv x
                     FStar_Syntax_Syntax.delta_constant
                     FStar_Pervasives_Native.None in
                 let uu____17892 = encode_free_var false env1 fv t t_norm [] in
              ...
              | (l, uu____18002, uu____18003) ->
                  let uu____18006 =
                    ...
                    (uu____18018, [], FStar_SMTEncoding_Term.Bool_sort,
                      FStar_Pervasives_Native.None) in
                  FStar_SMTEncoding_Term.DeclFun uu____18006)) in
    let suffix =
      FStar_All.pipe_right labs
        (FStar_List.collect
           (fun uu____18051 ->
  ...
  fun tcenv ->
    let uu____18093 =
      let uu____18096 =
        ...
        let uu____18112 =
          let uu____18121 = FStar_Util.psmap_empty () in (uu____18121, []) in
        let uu____18128 =
  ...
  fun env ->
    fun lid ->
      let uu____18757 =
        ...
        let uu____18762 = open_fact_db_tags env in uu____18760 :: uu____18762 in
              ...
              then [elt]
                ...
                (let uu____18835 =
                   ...
                   FStar_Util.smap_try_find
                     env.FStar_SMTEncoding_Env.global_cache uu____18838 in
          ...
          let uu____18888 =
            let uu____18889 =
              let uu____18891 =
                ...
                FStar_All.pipe_right uu____18893 (FStar_String.concat ", ") in
...
let (encode_modul :
  ...
  fun tcenv ->
    fun modul ->
      let uu____19023 = (FStar_Options.lax ()) && (FStar_Options.ml_ish ()) in
      if uu____19023
      then ([], [])
      else
        (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.reset_fresh ();
         (let name =
          ...
          (let env =
             let uu____19058 = get_env modul.FStar_Syntax_Syntax.name tcenv in
               ...
               (FStar_List.fold_left
                  (fun uu____19097 ->
                     fun se ->
                       ...
                       | (g, env2) ->
                           let uu____19117 = encode_top_level_facts env2 se in
            ...
            ((let uu____19213 =
             ...
             (let env =
                ...
                FStar_All.pipe_right uu____19229
                  FStar_SMTEncoding_Env.reset_current_module_fvbs in
              let env1 =
                let uu____19231 = FStar_All.pipe_right fvbs FStar_List.rev in
             ...
             (match uu____19464 with
              | (env_decls, env1) ->
                  ((let uu____19486 =
                    ...
                    if uu____19486
                    then
                      let uu____19493 = FStar_Syntax_Print.term_to_string q1 in
                    ...
                    | (phi, qdecls) ->
                        let uu____19519 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____19524 phi in
