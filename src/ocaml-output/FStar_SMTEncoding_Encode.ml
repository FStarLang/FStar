...
and encode_sigelt':
  ...
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_let (lbs,uu____14179,attrs) when
          (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                 ...
                 fun lb  ->
                   let lid =
                     let uu____14202 =
                       let uu____14204 =
                         FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
                       uu____14204.FStar_Syntax_Syntax.fv_name in
                     uu____14202.FStar_Syntax_Syntax.v in
                   let uu____14205 =
                     let uu____14206 =
                       FStar_TypeChecker_Env.try_lookup_val_decl env1.tcenv
                         lid in
                     FStar_All.pipe_left FStar_Option.isNone uu____14206 in
                   if uu____14205
                   then
                     let val_decl =
                       let uu___151_14221 = se in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___151_14221.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___151_14221.FStar_Syntax_Syntax.sigmeta)
                       } in
                     let uu____14225 = encode_sigelt' env1 val_decl in
                     match uu____14225 with | (decls,env2) -> (env2, decls)
                   else (env1, [])) env (FStar_Pervasives_Native.snd lbs) in
          (match uu____14187 with
           | (env1,decls) -> ((FStar_List.flatten decls), env1))
      | FStar_Syntax_Syntax.Sig_let
          ((uu____14242,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inr b2t1;
                          FStar_Syntax_Syntax.lbunivs = uu____14244;
                          FStar_Syntax_Syntax.lbtyp = uu____14245;
                          FStar_Syntax_Syntax.lbeff = uu____14246;
                          FStar_Syntax_Syntax.lbdef = uu____14247;_}::[]),uu____14248,uu____14249)
                           ...
                           let uu____14296 =
                             let uu____14297 =
                               let uu____14300 =
                                 FStar_SMTEncoding_Util.mkApp
                                   ("BoxBool_proj_0", [x]) in
                               (valid_b2t_x, uu____14300) in
                             FStar_SMTEncoding_Util.mkEq uu____14297 in
                           ([[b2t_x]], [xx], uu____14296) in
                         FStar_SMTEncoding_Util.mkForall uu____14290 in
                       (uu____14289,
                         (FStar_Pervasives_Native.Some "b2t def"), "b2t_def") in
                     FStar_SMTEncoding_Util.mkAssume uu____14285 in
                   [uu____14284] in
                 (FStar_SMTEncoding_Term.DeclFun
                   ...
                   :: uu____14282 in
               (decls, env1))
      | FStar_Syntax_Syntax.Sig_let (uu____14317,uu____14318,uu____14319)
          when
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___119_14327  ->
                  match uu___119_14327 with
                  | FStar_Syntax_Syntax.Discriminator uu____14328 -> true
                  | uu____14329 -> false))
          -> ([], env)
      | FStar_Syntax_Syntax.Sig_let (uu____14331,lids,uu____14333) when
          (FStar_All.pipe_right lids
             (FStar_Util.for_some
                (fun l  ->
                   let uu____14342 =
                     let uu____14343 = FStar_List.hd l.FStar_Ident.ns in
                     uu____14343.FStar_Ident.idText in
                   uu____14342 = "Prims")))
            &&
            (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
               (FStar_Util.for_some
                  (fun uu___120_14346  ->
                     match uu___120_14346 with
                     | FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen 
                         -> true
                     | uu____14347 -> false)))
          -> ([], env)
      | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____14350,uu____14351)
          when
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___121_14363  ->
                  match uu___121_14363 with
                  | FStar_Syntax_Syntax.Projector uu____14364 -> true
                  | uu____14367 -> false))
          ->
          let fv = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
          let l = (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
          let uu____14370 = try_lookup_free_var env l in
          (match uu____14370 with
           | FStar_Pervasives_Native.Some uu____14374 -> ([], env)
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 let uu___152_14377 = se in
                 {
                   FStar_Syntax_Syntax.sigel =
                     (FStar_Syntax_Syntax.Sig_declare_typ
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___152_14377.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___152_14377.FStar_Syntax_Syntax.sigmeta)
                 } in
               encode_sigelt env se1)
      | FStar_Syntax_Syntax.Sig_let
          ((is_rec,bindings),uu____14383,uu____14384) ->
          encode_top_level_let env (is_rec, bindings)
            se.FStar_Syntax_Syntax.sigquals
      | FStar_Syntax_Syntax.Sig_bundle (ses,uu____14396) ->
          let uu____14401 = encode_sigelts env ses in
                ...
                | (g',inversions) ->
                    let uu____14439 =
                      FStar_All.pipe_right g'
                        (FStar_List.partition
                           (fun uu___123_14451  ->
                              match uu___123_14451 with
                              | FStar_SMTEncoding_Term.DeclFun uu____14452 ->
                                  true
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          (t,uu____14469,tps,k,uu____14472,datas) ->
          let quals = se.FStar_Syntax_Syntax.sigquals in
          let is_logical =
            FStar_All.pipe_right quals
              (FStar_Util.for_some
                 (fun uu___124_14483  ->
                    match uu___124_14483 with
          ...
          let constructor_or_logic_type_decl c =
            if is_logical
            then
              let uu____14491 = c in
              match uu____14491 with
              | (name,args,uu____14495,uu____14496,uu____14497) ->
                  let uu____14500 =
                    let uu____14501 =
                      let uu____14507 =
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____14518  ->
                                ...
                                | (uu____14522,sort,uu____14524) -> sort)) in
                      (name, uu____14507, FStar_SMTEncoding_Term.Term_sort,
                        FStar_Pervasives_Native.None) in
                    FStar_SMTEncoding_Term.DeclFun uu____14501 in
                  [uu____14500]
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____14547 FStar_Option.isNone)) in
            if uu____14542
            then []
            else
              (let uu____14564 =
                         ...
                         | (ffsym,ff) ->
                             let fuel_guarded_inversion =
                               ...
                               let uu____14775 =
                                 ...
                                 (uu____14779,
                                   (FStar_Pervasives_Native.Some
                                      "inversion axiom"), uu____14802) in
                               ...
                               then
                                 ...
                                 let uu____14817 =
                                   let uu____14818 =
                                     ...
                                     (uu____14822,
                                       (FStar_Pervasives_Native.Some
                                          "inversion axiom"), uu____14845) in
                                   FStar_SMTEncoding_Util.mkAssume
                                     uu____14818 in
                                 [uu____14817]
                               else [] in
          ...
          let uu____14848 =
            let uu____14856 =
              let uu____14857 = FStar_Syntax_Subst.compress k in
              uu____14857.FStar_Syntax_Syntax.n in
            match uu____14856 with
            | FStar_Syntax_Syntax.Tm_arrow (formals,kres) ->
                ((FStar_List.append tps formals),
                  (FStar_Syntax_Util.comp_result kres))
            | uu____14886 -> (tps, k) in
          (match uu____14848 with
           | (formals,res) ->
               let uu____14901 = FStar_Syntax_Subst.open_term formals res in
               (match uu____14901 with
                | (formals1,res1) ->
                    ...
                    (match uu____14908 with
                     | (vars,guards,env',binder_decls,uu____14923) ->
                         let uu____14930 =
                              ...
                              let tapp =
                                let uu____14943 =
                                  let uu____14947 =
                                    FStar_List.map
                                      FStar_SMTEncoding_Util.mkFreeV vars in
                                  (tname, uu____14947) in
                                FStar_SMTEncoding_Util.mkApp uu____14943 in
                              let uu____14952 =
                                let tname_decl =
                                  let uu____14958 =
                                    let uu____14959 =
                                           ...
                                           (fun uu____14977  ->
                                              ...
                                              | (n1,s) ->
                                                  ((Prims.strcat tname n1),
                                                    s, false))) in
                                    let uu____14985 = varops.next_id () in
                                    (tname, uu____14959,
                                      FStar_SMTEncoding_Term.Term_sort,
                                      uu____14985, false) in
                                  constructor_or_logic_type_decl uu____14958 in
                                let uu____14990 =
                                  match vars with
                                  | [] ->
                                      let uu____14997 =
                                        ...
                                        FStar_SMTEncoding_Term.DeclFun
                                          (ttok, [],
                                            ...
                                            (FStar_Pervasives_Native.Some
                                               "token")) in
                                      let ttok_fresh =
                                        let uu____15010 = varops.next_id () in
                                        FStar_SMTEncoding_Term.fresh_token
                                          (ttok,
                                            FStar_SMTEncoding_Term.Term_sort)
                                          uu____15010 in
                                           ...
                                           let uu____15083 =
                                             let uu____15085 =
                                               ...
                                               FStar_SMTEncoding_Util.mkAssume
                                                 uu____15086 in
                                             [uu____15085] in
                                           FStar_List.append karr uu____15083 in
                                         FStar_List.append decls1 uu____15081 in
                                   let aux =
                                     let uu____15106 =
                                       let uu____15108 =
                                       ...
                                       let uu____15110 =
                                         ...
                                         [uu____15112] in
                                       FStar_List.append uu____15108
                                         uu____15110 in
                                     FStar_List.append kindingAx uu____15106 in
                                   let g =
                                     FStar_List.append decls
                                       (FStar_List.append binder_decls aux) in
                                   (g, env2))))))
      | FStar_Syntax_Syntax.Sig_datacon
          (d,uu____15117,uu____15118,uu____15119,uu____15120,uu____15121)
          when FStar_Ident.lid_equals d FStar_Parser_Const.lexcons_lid ->
          ([], env)
      | FStar_Syntax_Syntax.Sig_datacon
          (d,uu____15126,t,uu____15128,n_tps,uu____15130) ->
          let quals = se.FStar_Syntax_Syntax.sigquals in
          let uu____15135 = new_term_constant_and_tok_from_lid env d in
          (match uu____15135 with
           | (ddconstrsym,ddtok,env1) ->
               let ddtok_tm = FStar_SMTEncoding_Util.mkApp (ddtok, []) in
               let uu____15146 = FStar_Syntax_Util.arrow_formals t in
                     ...
                     | (fuel_var,fuel_tm) ->
                         ...
                         (match uu____15177 with
                          | (vars,guards,env',binder_decls,names1) ->
                              ...
                              let datacons =
                                let uu____15221 =
                                  let uu____15231 = varops.next_id () in
                                  (ddconstrsym, fields,
                                    FStar_SMTEncoding_Term.Term_sort,
                                    uu____15231, true) in
                               ...
                               | (tok_typing,decls3) ->
                                   let tok_typing1 =
                                     ...
                                     | uu____15261::uu____15262 ->
                                         ...
                                         FStar_SMTEncoding_Util.mkForall
                                           uu____15287
                                     | uu____15306 -> tok_typing in
                                   let uu____15311 =
                                     encode_binders
                                       (FStar_Pervasives_Native.Some fuel_tm)
                                       formals env1 in
                                   (match uu____15311 with
                                    | (vars',guards',env'',decls_formals,uu____15326)
                                        ->
                                        let uu____15333 =
                                          let xvars1 =
                                            FStar_List.map
                                                    ...
                                                    | FStar_Syntax_Syntax.Tm_uinst
                                                        ...
                                                        (match uu____15411
                                                         ...
                                                         | (encoded_args,arg_decls)
                                                             ...
                                                             (match uu____15467
                                                              with
                                                              | (uu____15586,arg_vars,elim_eqns_or_guards,uu____15589)
                                                                  ->
                                                                  let arg_vars1
                                                                    =
                                                                    FStar_List.rev
                                                    ...
                                                    | FStar_Syntax_Syntax.Tm_fvar
                                                        ...
                                                        (match uu____15738
                                                         ...
                                                         | (encoded_args,arg_decls)
                                                             ...
                                                             (match uu____15794
                                                              with
                                                              | (uu____15913,arg_vars,elim_eqns_or_guards,uu____15916)
                                                                  ->
                                                                  let arg_vars1
                                                                    =
                                                                    FStar_List.rev
                                                    ...
                                                    | uu____16063 ->
                                                        ((let uu____16065 =
                                                          ...
                                                          FStar_Errors.warn
                                                            ...
                                                            uu____16065);
                                                         ([], []))) in
                                             let uu____16070 = encode_elim () in
                                                      ...
                                                      let uu____16084 =
                                                        let uu____16086 =
                                                          ...
                                                          FStar_List.append
                                                            ...
                                                            uu____16103 in
                                                        FStar_List.append
                                                          decls3 uu____16086 in
                                                      FStar_List.append
                                                        decls2 uu____16084 in
                                                    FStar_List.append
                                                      binder_decls
                                                      uu____16082 in
                                                  ((FStar_List.append
        ...
        (FStar_List.fold_left
           (fun uu____16182  ->
              fun se  ->
                ...
                | (g,env1) ->
                    let uu____16194 = encode_sigelt env1 se in
...
let encode_env_bindings:
  ...
  fun env  ->
    fun bindings  ->
      let encode_binding b uu____16232 =
        match uu____16232 with
        | (i,decls,env1) ->
            (match b with
             | FStar_TypeChecker_Env.Binding_univ uu____16250 ->
             ...
             | FStar_TypeChecker_Env.Binding_var x ->
                 ...
                 ((let uu____16255 =
                   ...
                   if uu____16255
                   then
                     let uu____16256 = FStar_Syntax_Print.bv_to_string x in
                     let uu____16257 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort in
                     let uu____16258 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print3 "Normalized %s : %s to %s\n"
                       uu____16256 uu____16257 uu____16258
                   else ());
                  (let uu____16260 = encode_term t1 env1 in
                   ...
                   | (t,decls') ->
                       ...
                       let uu____16270 =
                         let uu____16274 =
                           let uu____16275 =
                             ...
                             Prims.strcat uu____16276
                               (Prims.strcat "_" (Prims.string_of_int i)) in
                           Prims.strcat "x_" uu____16275 in
                         new_term_constant_from_string env1 x uu____16274 in
                       (match uu____16270 with
                        | (xxsym,xx,env') ->
                            ...
                            let caption =
                              let uu____16287 = FStar_Options.log_queries () in
                              if uu____16287
                              then
                                let uu____16289 =
                                  let uu____16290 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____16290 uu____16291 uu____16292 in
                                FStar_Pervasives_Native.Some uu____16289
                              else FStar_Pervasives_Native.None in
                            let ax =
                            ...
                            ((i + (Prims.parse_int "1")),
                              (FStar_List.append decls g), env'))))
             | FStar_TypeChecker_Env.Binding_lid (x,(uu____16303,t)) ->
                 let t_norm = whnf env1 t in
                 let fv =
                   FStar_Syntax_Syntax.lid_as_fv x
                     FStar_Syntax_Syntax.Delta_constant
                     FStar_Pervasives_Native.None in
                 let uu____16312 = encode_free_var env1 fv t t_norm [] in
                 (match uu____16312 with
                  | (g,env') ->
                      ((i + (Prims.parse_int "1")),
                        (FStar_List.append decls g), env'))
             | FStar_TypeChecker_Env.Binding_sig_inst
                 (uu____16325,se,uu____16327) ->
                 let uu____16330 = encode_sigelt env1 se in
                 (match uu____16330 with
                  | (g,env') ->
                      ((i + (Prims.parse_int "1")),
                        (FStar_List.append decls g), env'))
             | FStar_TypeChecker_Env.Binding_sig (uu____16340,se) ->
                 let uu____16344 = encode_sigelt env1 se in
      ...
      match uu____16354 with | (uu____16366,decls,env1) -> (decls, env1)
      ...
      (FStar_List.collect
         (fun uu____16453  ->
            ...
            | (l,uu____16461,uu____16462) ->
                ...
                let uu____16468 =
                  let uu____16470 =
                    let uu____16471 = FStar_SMTEncoding_Util.mkFreeV l in
                    FStar_SMTEncoding_Term.Eval uu____16471 in
                  [uu____16470] in
                uu____16467 :: uu____16468)) in
  (prefix1, suffix)
...
let init_env: FStar_TypeChecker_Env.env -> Prims.unit =
  fun tcenv  ->
    let uu____16483 =
      let uu____16485 =
        let uu____16486 = FStar_Util.smap_create (Prims.parse_int "100") in
        let uu____16488 =
          let uu____16489 = FStar_TypeChecker_Env.current_module tcenv in
          FStar_All.pipe_right uu____16489 FStar_Ident.string_of_lid in
        {
          bindings = [];
          ...
          current_module_name = uu____16488
        } in
      [uu____16485] in
    FStar_ST.write last_env uu____16483
let get_env: FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t =
  fun cmn  ->
    fun tcenv  ->
      let uu____16501 = FStar_ST.read last_env in
      match uu____16501 with
      | [] -> failwith "No env; call init first!"
      | e::uu____16507 ->
          let uu___153_16509 = e in
          let uu____16510 = FStar_Ident.string_of_lid cmn in
          {
            bindings = (uu___153_16509.bindings);
            depth = (uu___153_16509.depth);
            tcenv;
            warn = (uu___153_16509.warn);
            cache = (uu___153_16509.cache);
            nolabels = (uu___153_16509.nolabels);
            use_zfuel_name = (uu___153_16509.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___153_16509.encode_non_total_function_typ);
            current_module_name = uu____16510
          }
let set_env: env_t -> Prims.unit =
  fun env  ->
    let uu____16515 = FStar_ST.read last_env in
    match uu____16515 with
    | [] -> failwith "Empty env stack"
    | uu____16520::tl1 -> FStar_ST.write last_env (env :: tl1)
let push_env: Prims.unit -> Prims.unit =
  fun uu____16529  ->
    let uu____16530 = FStar_ST.read last_env in
    match uu____16530 with
    | [] -> failwith "Empty env stack"
    | hd1::tl1 ->
        let refs = FStar_Util.smap_copy hd1.cache in
        let top =
          let uu___154_16541 = hd1 in
          {
            bindings = (uu___154_16541.bindings);
            depth = (uu___154_16541.depth);
            tcenv = (uu___154_16541.tcenv);
            warn = (uu___154_16541.warn);
            cache = refs;
            nolabels = (uu___154_16541.nolabels);
            use_zfuel_name = (uu___154_16541.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___154_16541.encode_non_total_function_typ);
            current_module_name = (uu___154_16541.current_module_name)
          } in
        FStar_ST.write last_env (top :: hd1 :: tl1)
let pop_env: Prims.unit -> Prims.unit =
  fun uu____16548  ->
    let uu____16549 = FStar_ST.read last_env in
    match uu____16549 with
    | [] -> failwith "Popping an empty stack"
    | uu____16554::tl1 -> FStar_ST.write last_env tl1
let mark_env: Prims.unit -> Prims.unit = fun uu____16563  -> push_env ()
let reset_mark_env: Prims.unit -> Prims.unit = fun uu____16567  -> pop_env ()
let commit_mark_env: Prims.unit -> Prims.unit =
  fun uu____16571  ->
    let uu____16572 = FStar_ST.read last_env in
    match uu____16572 with
    | hd1::uu____16578::tl1 -> FStar_ST.write last_env (hd1 :: tl1)
    | uu____16584 -> failwith "Impossible"
  ...
  fun env  ->
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____16643::uu____16644,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___155_16650 = a in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___155_16650.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___155_16650.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___155_16650.FStar_SMTEncoding_Term.assumption_name);
...
let fact_dbs_for_lid:
  ...
  fun env  ->
    fun lid  ->
      let uu____16664 =
        let uu____16666 =
          let uu____16667 = FStar_Ident.lid_of_ids lid.FStar_Ident.ns in
          FStar_SMTEncoding_Term.Namespace uu____16667 in
        let uu____16668 = open_fact_db_tags env in uu____16666 :: uu____16668 in
      (FStar_SMTEncoding_Term.Name lid) :: uu____16664
let encode_top_level_facts:
  ...
  fun env  ->
    fun se  ->
      ...
      let uu____16685 = encode_sigelt env se in
...
let encode_sig:
  ...
  fun tcenv  ->
    fun se  ->
      let caption decls =
        let uu____16712 = FStar_Options.log_queries () in
        if uu____16712
        then
          let uu____16714 =
            let uu____16715 =
              let uu____16716 =
                ...
                FStar_All.pipe_right uu____16717 (FStar_String.concat ", ") in
              Prims.strcat "encoding sigelt " uu____16716 in
            FStar_SMTEncoding_Term.Caption uu____16715 in
          uu____16714 :: decls
        else decls in
      let env =
        let uu____16724 = FStar_TypeChecker_Env.current_module tcenv in
        get_env uu____16724 tcenv in
      let uu____16725 = encode_top_level_facts env se in
      match uu____16725 with
      | (decls,env1) ->
          (set_env env1;
           (let uu____16734 = caption decls in
            FStar_SMTEncoding_Z3.giveZ3 uu____16734))
let encode_modul:
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let uu____16747 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low in
       if uu____16747
       then
         let uu____16748 =
           FStar_All.pipe_right
           ...
           (FStar_List.fold_left
              (fun uu____16778  ->
                 fun se  ->
                   ...
                   | (g,env2) ->
                       let uu____16790 = encode_top_level_facts env2 se in
                       (match uu____16790 with
                        | (g',env3) -> ((FStar_List.append g g'), env3)))
              ([], env1)) in
       let uu____16803 =
         encode_signature
           (let uu___156_16809 = env in
            {
              bindings = (uu___156_16809.bindings);
              depth = (uu___156_16809.depth);
              tcenv = (uu___156_16809.tcenv);
              warn = false;
              cache = (uu___156_16809.cache);
              nolabels = (uu___156_16809.nolabels);
              use_zfuel_name = (uu___156_16809.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___156_16809.encode_non_total_function_typ);
              current_module_name = (uu___156_16809.current_module_name)
            }) modul.FStar_Syntax_Syntax.exports in
       match uu____16803 with
       | (decls,env1) ->
           let caption decls1 =
             let uu____16821 = FStar_Options.log_queries () in
             if uu____16821
             then
           ...
           (set_env
              (let uu___157_16828 = env1 in
               {
                 bindings = (uu___157_16828.bindings);
                 depth = (uu___157_16828.depth);
                 tcenv = (uu___157_16828.tcenv);
                 warn = true;
                 cache = (uu___157_16828.cache);
                 nolabels = (uu___157_16828.nolabels);
                 use_zfuel_name = (uu___157_16828.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___157_16828.encode_non_total_function_typ);
                 current_module_name = (uu___157_16828.current_module_name)
               });
            (let uu____16830 =
...
let encode_query:
  ...
  fun use_env_msg  ->
    fun tcenv  ->
      fun q  ->
        (let uu____16868 =
           let uu____16869 = FStar_TypeChecker_Env.current_module tcenv in
           uu____16869.FStar_Ident.str in
         FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name
           uu____16868);
        (let env =
           let uu____16871 = FStar_TypeChecker_Env.current_module tcenv in
           get_env uu____16871 tcenv in
         let bindings =
                  ...
                  | (out,rest1) ->
                      let t =
                        ...
                        | FStar_Pervasives_Native.Some uu____16923 ->
                            ...
                            FStar_Syntax_Util.refine uu____16924
                              x.FStar_Syntax_Syntax.sort
                        | uu____16925 -> x.FStar_Syntax_Syntax.sort in
                      let t1 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Normalize.Eager_unfolding;
                          FStar_TypeChecker_Normalize.Beta;
                      ...
                      let uu____16928 =
                        let uu____16930 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___158_16933 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___158_16933.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___158_16933.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = t1
                             }) in
                        uu____16930 :: out in
                      (uu____16928, rest1))
             | uu____16936 -> ([], bindings1) in
           let uu____16940 = aux bindings in
           match uu____16940 with
           | (closing,bindings1) ->
               let uu____16954 =
                 FStar_Syntax_Util.close_forall_no_univs
                   (FStar_List.rev closing) q in
               (uu____16954, bindings1) in
         ...
         | (q1,bindings1) ->
             let uu____16967 =
               let uu____16970 =
                 FStar_List.filter
                   (fun uu___125_16974  ->
                      match uu___125_16974 with
                      | FStar_TypeChecker_Env.Binding_sig uu____16975 ->
                          false
                      | uu____16979 -> true) bindings1 in
               encode_env_bindings env uu____16970 in
             (match uu____16967 with
              | (env_decls,env1) ->
                  ((let uu____16990 =
                    ...
                    if uu____16990
                    then
                      let uu____16991 = FStar_Syntax_Print.term_to_string q1 in
                      FStar_Util.print1 "Encoding query formula: %s\n"
                        uu____16991
                    else ());
                   (let uu____16993 = encode_formula q1 env1 in
                    ...
                    | (phi,qdecls) ->
                        let uu____17005 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____17008 phi in
                        (match uu____17005 with
                         | (labels,phi1) ->
                             let uu____17018 = encode_labels labels in
...
let is_trivial:
  ...
  fun tcenv  ->
    fun q  ->
      let env =
        let uu____17059 = FStar_TypeChecker_Env.current_module tcenv in
        get_env uu____17059 tcenv in
      FStar_SMTEncoding_Z3.push "query";
      (let uu____17061 = encode_formula q env in
       match uu____17061 with
       | (f,uu____17065) ->
           (FStar_SMTEncoding_Z3.pop "query";
            (match f.FStar_SMTEncoding_Term.tm with
             | FStar_SMTEncoding_Term.App
                 (FStar_SMTEncoding_Term.TrueOp ,uu____17067) -> true
             | uu____17070 -> false)))