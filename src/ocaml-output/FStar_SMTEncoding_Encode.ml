                  ...
                  (FStar_List.forall2
                     (fun a  ->
                        fun v1  ->
                          ...
                          | uu____1926 -> false) args (FStar_List.rev xs))
                 in
...
let encode_const : FStar_Const.sconst -> FStar_SMTEncoding_Term.term =
  fun uu___111_2031  ->
    ...
    | FStar_Const.Const_string (bytes,uu____2059) ->
        let uu____2062 = FStar_All.pipe_left FStar_Util.string_of_bytes bytes
           in
                         ...
                         let uu____2381 =
                           ...
                           | (xxsym,xx,env') ->
                               let uu____2404 =
                                 ...
                                 encode_term_pred fuel_opt uu____2407 env1 xx
                                  in
      ...
      fun env  ->
        fun e  ->
          ...
          | (t1,decls) ->
              (match fuel_opt with
               | None  ->
                   let uu____2519 = FStar_SMTEncoding_Term.mk_HasTypeZ e t1
                      in
                   (uu____2519, decls)
               | Some f ->
                   let uu____2521 =
      ...
      fun args_e  ->
        ...
        | (arg_tms,decls) ->
            ...
            let mk_l op mk_args ts =
              let uu____2610 = FStar_Options.smtencoding_l_arith_native ()
                 in
              if uu____2610
              then
                let uu____2611 =
                  let uu____2612 = mk_args ts  in op uu____2612  in
                FStar_All.pipe_right uu____2611 FStar_SMTEncoding_Term.boxInt
              else mk_default ()  in
            let mk_nl nm op ts =
              let uu____2635 = FStar_Options.smtencoding_nl_arith_wrapped ()
                 in
              if uu____2635
              then
      ...
      (match t0.FStar_Syntax_Syntax.n with
       | FStar_Syntax_Syntax.Tm_delayed uu____2807 ->
           let uu____2822 =
             ...
             FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" uu____2823
               uu____2824 uu____2825 uu____2826
              in
           failwith uu____2822
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____2829 =
             ...
             FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" uu____2830
               uu____2831 uu____2832 uu____2833
              in
           failwith uu____2829
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____3205 ->
           let uu____3210 =
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 let uu____3227 = FStar_Syntax_Subst.open_term [(x, None)] f
                    in
                 (match uu____3227 with
                  | (b,f1) ->
                      let uu____3241 =
                        let uu____3242 = FStar_List.hd b  in fst uu____3242
                         in
                      (uu____3241, f1))
             | uu____3247 -> failwith "impossible"  in
           (match uu____3210 with
            | (x,f) ->
                let uu____3254 = encode_term x.FStar_Syntax_Syntax.sort env
                   in
                ...
                let d =
                  let uu____3519 =
                    let uu____3523 =
                      let uu____3524 =
                        let uu____3525 =
                          let uu____3526 = FStar_Syntax_Unionfind.uvar_id uv
                             in
                               ...
                               let head_type2 =
                                 let uu____4171 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____4171
                                  in
                               let uu____4172 =
                  ...
                  then
                    ...
                    if
                      FStar_Ident.lid_equals
                        ...
                        FStar_Syntax_Const.effect_GTot_lid
                    then
                      (let uu____4295 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                       Some uu____4295)
                    else None
                   in
                             ...
                             | (body3,decls') ->
                                 let uu____4339 =
                                   ...
                                   | Some c ->
                                       ...
                                       let uu____4356 = encode_term tfun env
                                          in
...
and encode_pat : env_t -> FStar_Syntax_Syntax.pat -> (env_t * pattern) =
  fun env  ->
    fun pat  ->
      ...
      (let uu____4828 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
                                  ...
                                  | (arg,uu____5107) ->
                                      ...
                                      let uu____5117 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____5117))
                         in
                      FStar_All.pipe_right uu____5076 FStar_List.flatten
                   in
            ...
            (match uu____5274 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____5294,uu____5295)::(e,uu____5297)::[]) when
                 ...
                 -> e
             | uu____5323 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        ...
        let smt_pat_or1 t1 =
          let uu____5350 =
            ...
            FStar_All.pipe_right uu____5360 FStar_Syntax_Util.head_and_args
             in
                           ...
                           let uu____5741 =
                             let uu____5746 =
                               FStar_All.pipe_right branch1
                                ...
                                in
                             FStar_All.pipe_right uu____5746 FStar_List.unzip
                              in
                                    ...
                                    let uu____5831 =
                                      let uu____5834 =
                                        FStar_SMTEncoding_Util.mk_and_l (pre1
                                         ...
                                         in
                                      (uu____5834, post1)  in
                                    FStar_SMTEncoding_Util.mkImp uu____5831
                                     in
                                  (pats, vars, uu____5830)  in
                                FStar_SMTEncoding_Util.mkForall uu____5824
                                 in
                              (uu____5823, decls1)))))
    ...
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            ...
            (uu____5906, decls)
         in
      let const_op f r uu____5932 = let uu____5941 = f r  in (uu____5941, [])
         in
      let un_op f l =
        let uu____5957 = FStar_List.hd l  in FStar_All.pipe_left f uu____5957
         in
      ...
      let connectives =
        let uu____6292 =
          let uu____6301 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Syntax_Const.and_lid, uu____6301)  in
        let uu____6314 =
          let uu____6324 =
            let uu____6333 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
                        ...
                        let uu____6984 =
                          let uu____6989 =
                            FStar_All.pipe_right p
                             ...
                             in
                          FStar_All.pipe_right uu____6989 FStar_List.unzip
                           in
               ...
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      ...
                      FStar_Util.set_union out uu____7143) uu____7137 tl1
                in
             let uu____7145 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
              ...
              | Some (x,uu____7166) ->
                  ...
                  let uu____7176 =
                    ...
                    FStar_Util.format1
                      ...
                      uu____7177
                     in
                  FStar_Errors.warn pos uu____7176)
          in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____7220  ->
                     ...
                     | (l,uu____7230) -> FStar_Ident.lid_equals op l))
              in
...
let prims : prims_t =
  ...
  | (asym,a) ->
      ...
      (match uu____7417 with
       | (xsym,x) ->
           let uu____7422 = fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort
              in
            ...
            | (ysym,y) ->
                          ...
                          let uu____7514 =
                            let uu____7515 =
                              let uu____7519 =
                                ...
                                FStar_SMTEncoding_Util.mkForall uu____7520
                                 in
                              (uu____7519,
                ...
                let prims1 =
                  let uu____7575 =
                    let uu____7583 =
                      let uu____7589 =
                        let uu____7590 = FStar_SMTEncoding_Util.mkEq (x, y)
                           in
                      ...
                      let uu____7636 =
                        let uu____7644 =
                          let uu____7650 =
                            ...
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool uu____7651
                             in
                        ...
                        let uu____7671 =
                          let uu____7679 =
                            let uu____7685 =
                              ...
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool uu____7686
                               in
                          ...
                          let uu____7706 =
                            let uu____7714 =
                              let uu____7720 =
                                ...
                                FStar_All.pipe_left
                                  FStar_SMTEncoding_Term.boxBool uu____7721
                                 in
                              ...
                              let uu____7749 =
                                let uu____7755 =
                                  let uu____7756 =
                                    ...
                                    FStar_SMTEncoding_Util.mkGTE uu____7757
                                     in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool uu____7756
                                   in
                            ...
                            let uu____7767 =
                                ...
                                let uu____7784 =
                                  let uu____7790 =
                                    let uu____7791 =
                                      ...
                                      FStar_SMTEncoding_Util.mkSub uu____7792
                                       in
                                    FStar_All.pipe_left
                                      FStar_SMTEncoding_Term.boxInt
                                      uu____7791
                              ...
                              let uu____7802 =
                                let uu____7811 =
                                  ...
                                  (FStar_Syntax_Const.op_Minus, uu____7819)
                                   in
                                let uu____7833 =
                                  let uu____7842 =
                                    let uu____7850 =
                ...
                let mk1 l v1 =
                  let uu____8196 =
                    ...
                    FStar_All.pipe_right uu____8201
                      (FStar_Option.map
                         (fun uu____8275  ->
                            match uu____8275 with | (uu____8286,b) -> b v1))
                     in
                  ...
                  FStar_All.pipe_right prims1
                    (FStar_Util.for_some
                       (fun uu____8327  ->
                          ...
                          | (l',uu____8336) -> FStar_Ident.lid_equals l l'))
                   in
                { mk = mk1; is }))
  ...
  fun env  ->
    fun tapp  ->
      fun vars  ->
        ...
        | (xxsym,xx) ->
            let uu____8367 = fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort
               in
...
let primitive_type_axioms :
  ...
  let mk_ref1 env reft_name uu____8807 =
    ...
    let refa =
      let uu____8818 =
        let uu____8822 =
          let uu____8824 = FStar_SMTEncoding_Util.mkFreeV aa  in [uu____8824]
           in
    ...
    let refb =
      let uu____8827 =
        let uu____8831 =
          let uu____8833 = FStar_SMTEncoding_Util.mkFreeV bb  in [uu____8833]
           in
      ...
      let uu____8838 =
        let uu____8842 =
          let uu____8843 =
            let uu____8849 =
              let uu____8850 =
                let uu____8853 = FStar_SMTEncoding_Term.mk_tester "BoxRef" x
                   in
          ...
          let uu____9766 =
            FStar_Util.find_opt
              (fun uu____9784  ->
                 ...
                 | (l,uu____9794) -> FStar_Ident.lid_equals l t) prims1
             in
                             ...
                             FStar_All.pipe_right quals
                               (FStar_List.collect
                                  (fun uu___115_10047  ->
                                     ...
                                     | uu____10149 -> []))
                              in
                           let uu____10150 = encode_binders None formals env1
                              in
                            ...
                            | (vars,guards,env',decls1,uu____10166) ->
                                let uu____10173 =
                                  ...
                                  | None  ->
                                      ...
                                      (uu____10178, decls1)
                                  | Some p ->
                                      let uu____10180 = encode_formula p env'
                                         in
            ...
            let eta_expand1 binders formals body t =
              ...
              | (formals1,extra_formals) ->
                  ...
                  let body1 =
                    let uu____10828 =
                      let uu____10830 =
                        let uu____10831 = FStar_Syntax_Subst.subst subst1 t
                           in
                      ...
                      let uu____10837 =
                        let uu____10838 =
                          FStar_Syntax_Util.args_of_binders extra_formals1
                           in
                        FStar_All.pipe_left FStar_Pervasives.snd uu____10838
                         in
                              ...
                              (let uu____11633 =
                                 let uu____11637 =
                                   FStar_List.map
                                    ...
                                    in
                                 (f, uu____11637)  in
                               FStar_SMTEncoding_Util.mkApp uu____11633)
                         in
                      let uu____11642 =
                        (FStar_All.pipe_right quals
                           (FStar_Util.for_some
                      ...
                      then (decls1, env1)
                        ...
                        then
                               ...
                               let uu____11712 =
                                 ...
                                 | (tcenv',uu____11727,e_t) ->
                                     let uu____11731 =
                                       ...
                                       | uu____11738 -> failwith "Impossible"
                                        in
                          ...
                          (let fuel =
                             ...
                             (uu____11888, FStar_SMTEncoding_Term.Fuel_sort)
                              in
  ...
  fun env  ->
    fun se  ->
      let nm =
        ...
        match uu____12783 with | None  -> "" | Some l -> l.FStar_Ident.str
         in
          ...
          let g1 =
            ...
            | uu____12798 ->
                ...
                let uu____12803 =
                  ...
                  [uu____12805]  in
                FStar_List.append uu____12799 uu____12803
             in
          (g1, env1)
                               ...
                               let uu____12924 =
                                 let uu____12925 =
                                   ...
                                   (aname, uu____12931,
                                     ...
                                     (Some "Action"))
                                    in
                                 FStar_SMTEncoding_Term.DeclFun uu____12925
                                  in
                               [uu____12924;
                               FStar_SMTEncoding_Term.DeclFun
                             ...
                             let uu____12946 =
                               let aux uu____12975 uu____12976 =
                                 ...
                                 | ((bv,uu____13003),(env3,acc_sorts,acc)) ->
                                     let uu____13024 = gen_term_var env3 bv
                                        in
               ...
               let g =
                 let uu____13199 =
                   let uu____13200 =
                     let uu____13204 =
                       let uu____13206 =
                         let uu____13207 = FStar_Syntax_Print.lid_to_string l
                            in
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____13539  ->
                                ...
                                | (uu____13543,sort,uu____13545) -> sort))
                         in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____13566 FStar_Option.isNone))
               in
            if uu____13563
            then []
            else
                                               ...
                                               let uu____13649 =
                                                 let uu____13650 =
                                                   FStar_Syntax_Subst.compress
                                                     res
                                                    in
                                                 uu____13650.FStar_Syntax_Syntax.n
                                                  in
                             ...
                             let fuel_guarded_inversion =
                               ...
                               let uu____13761 =
                                 ...
                                 (uu____13765, (Some "inversion axiom"),
                                   uu____13788)
                                  in
                               FStar_SMTEncoding_Util.mkAssume uu____13761
                                in
                                ...
                                let tname_decl =
                                  let uu____13941 =
                                    ...
                                    (tname, uu____13942,
                                      ...
                                      uu____13965, false)
                                     in
                                  constructor_or_logic_type_decl uu____13941
                                   in
                                let uu____13970 =
                                  match vars with
                                  | [] ->
                                  ...
                                  | uu____13984 ->
                                      let ttok_decl =
                                        FStar_SMTEncoding_Term.DeclFun
                                         ...
                                         in
                                      let ttok_fresh =
                                        let uu____13990 = varops.next_id ()
                                           in
                                        FStar_SMTEncoding_Term.fresh_token
                                          (ttok,
                                            FStar_SMTEncoding_Term.Term_sort)
                                           ...
                                           let uu____14060 =
                                             let uu____14062 =
                                               ...
                                               FStar_SMTEncoding_Util.mkAssume
                                                ...
                                                in
                                             [uu____14062]  in
                                           FStar_List.append karr uu____14060
                                            in
                                         FStar_List.append decls1 uu____14058
                                      in
                                   let aux =
                                     let uu____14083 =
                                       let uu____14085 =
                                       ...
                                       FStar_List.append uu____14085
                                         uu____14087
                                        in
                                     FStar_List.append kindingAx uu____14083
                                      in
                                   let g =
                                     FStar_List.append decls
                                                   ...
                                                   let uu____14367 =
                                                     let uu____14368 =
                                                       FStar_Syntax_Subst.compress
                                                         head1
                                                        in
                                                     uu____14368.FStar_Syntax_Syntax.n
                                                      in
                              ...
                              then
                                let uu____15119 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____15120 uu____15121 uu____15122
                                   in
                                Some uu____15119
                              else None  in
                            let ax =
  ...
  fun env  ->
    fun lid  ->
      let uu____15458 =
        ...
        let uu____15462 = open_fact_db_tags env  in uu____15460 ::
          uu____15462
         in
              ...
              let uu____15506 =
                let uu____15507 =
                  FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se)
                   ...
                   in
                FStar_All.pipe_right uu____15507 (FStar_String.concat ", ")
                 in
    ...
    fun modul  ->
      let name =
        FStar_Util.format2 "%s %s"
         ...
         in
      (let uu____15535 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low
          in
       if uu____15535
       then
         let uu____15536 =
             ...
             (match uu____15735 with
              | (env_decls,env1) ->
                  ((let uu____15756 =
                    ...
                    if uu____15756
                    then
                      let uu____15757 = FStar_Syntax_Print.term_to_string q1
                         in
