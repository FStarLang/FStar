...
let (primitive_type_axioms :
  ...
  let mk_eq2_interp env eq2 tt =
    ...
    let eq2_x_y = FStar_SMTEncoding_Util.mkApp (eq2, [u; a; x1; y1]) in
  ...
  let mk_eq3_interp env eq3 tt =
    ...
    let x1 = FStar_SMTEncoding_Util.mkFreeV xx1 in
    let y1 = FStar_SMTEncoding_Util.mkFreeV yy1 in
    let eq3_x_y = FStar_SMTEncoding_Util.mkApp (eq3, [u; a; b; x1; y1]) in
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let xx1 =
      FStar_SMTEncoding_Term.mk_fv ("x", FStar_SMTEncoding_Term.Term_sort) in
    let x1 = FStar_SMTEncoding_Util.mkFreeV xx1 in
    let inversion_t = FStar_SMTEncoding_Util.mkApp (inversion, [u; t]) in
            ...
            fun t_norm ->
              fun quals ->
                ...
                let uu___ =
                  let uu___1 =
                    FStar_List.map
                      FStar_SMTEncoding_EncodeTerm.encode_univ_name us in
                ...
                | (univ_fvs, univs) ->
                    let univ_sorts =
                      FStar_All.pipe_right univs
                        (FStar_List.map
                           (fun uu___1 -> FStar_SMTEncoding_Term.univ_sort)) in
                    let uu___1 =
                      ((let uu___2 =
                      ...
                      (match uu___2 with
                       | (vname, vtok, env1) ->
                           let univ_arity =
                             FStar_List.map
                               (fun uu___3 ->
                                  FStar_SMTEncoding_Term.univ_sort) us in
                           let d =
                             FStar_SMTEncoding_Term.DeclFun
                               (vname,
                                 (FStar_List.append univ_arity arg_sorts),
                                 FStar_SMTEncoding_Term.Term_sort,
                                 (FStar_Pervasives_Native.Some
                      ...
                      (let uu___3 = prims.is lid in
                       ...
                       then
                         ...
                         (let encode_non_total_function_typ =
                            let uu___5 = FStar_Ident.nsstr lid in
                            uu___5 <> "Prims" in
                          let uu___5 =
                            let uu___6 =
                                        ...
                                        (let uu___9 =
                                           env.FStar_SMTEncoding_Env.tcenv in
                                         {
                                           FStar_TypeChecker_Env.solver =
                                             (uu___9.FStar_TypeChecker_Env.solver);
                                           FStar_TypeChecker_Env.range =
                                             (uu___9.FStar_TypeChecker_Env.range);
                                           FStar_TypeChecker_Env.curmodule =
                                             (uu___9.FStar_TypeChecker_Env.curmodule);
                                           FStar_TypeChecker_Env.gamma =
                                             (uu___9.FStar_TypeChecker_Env.gamma);
                                           FStar_TypeChecker_Env.gamma_sig =
                                             (uu___9.FStar_TypeChecker_Env.gamma_sig);
                                           FStar_TypeChecker_Env.gamma_cache
                                             =
                                             (uu___9.FStar_TypeChecker_Env.gamma_cache);
                                           FStar_TypeChecker_Env.modules =
                                             (uu___9.FStar_TypeChecker_Env.modules);
                                           FStar_TypeChecker_Env.expected_typ
                                             =
                                             (uu___9.FStar_TypeChecker_Env.expected_typ);
                                           FStar_TypeChecker_Env.sigtab =
                                             (uu___9.FStar_TypeChecker_Env.sigtab);
                                           FStar_TypeChecker_Env.attrtab =
                                             (uu___9.FStar_TypeChecker_Env.attrtab);
                                           FStar_TypeChecker_Env.instantiate_imp
                                             =
                                             (uu___9.FStar_TypeChecker_Env.instantiate_imp);
                                           FStar_TypeChecker_Env.effects =
                                             (uu___9.FStar_TypeChecker_Env.effects);
                                           FStar_TypeChecker_Env.generalize =
                                             (uu___9.FStar_TypeChecker_Env.generalize);
                                           FStar_TypeChecker_Env.letrecs =
                                             (uu___9.FStar_TypeChecker_Env.letrecs);
                                           FStar_TypeChecker_Env.top_level =
                                             (uu___9.FStar_TypeChecker_Env.top_level);
                                           FStar_TypeChecker_Env.check_uvars
                                             =
                                             (uu___9.FStar_TypeChecker_Env.check_uvars);
                                           FStar_TypeChecker_Env.use_eq =
                                             (uu___9.FStar_TypeChecker_Env.use_eq);
                                           FStar_TypeChecker_Env.use_eq_strict
                                             =
                                             (uu___9.FStar_TypeChecker_Env.use_eq_strict);
                                           FStar_TypeChecker_Env.is_iface =
                                             (uu___9.FStar_TypeChecker_Env.is_iface);
                                           FStar_TypeChecker_Env.admit =
                                             (uu___9.FStar_TypeChecker_Env.admit);
                                           FStar_TypeChecker_Env.lax = true;
                                           FStar_TypeChecker_Env.lax_universes
                                             =
                                             (uu___9.FStar_TypeChecker_Env.lax_universes);
                                           FStar_TypeChecker_Env.phase1 =
                                             (uu___9.FStar_TypeChecker_Env.phase1);
                                           FStar_TypeChecker_Env.failhard =
                                             (uu___9.FStar_TypeChecker_Env.failhard);
                                           FStar_TypeChecker_Env.nosynth =
                                             (uu___9.FStar_TypeChecker_Env.nosynth);
                                           FStar_TypeChecker_Env.uvar_subtyping
                                             =
                                             (uu___9.FStar_TypeChecker_Env.uvar_subtyping);
                                           FStar_TypeChecker_Env.tc_term =
                                             (uu___9.FStar_TypeChecker_Env.tc_term);
                                           FStar_TypeChecker_Env.type_of =
                                             (uu___9.FStar_TypeChecker_Env.type_of);
                                           FStar_TypeChecker_Env.type_of_well_typed
                                             =
                                             (uu___9.FStar_TypeChecker_Env.type_of_well_typed);
                                           FStar_TypeChecker_Env.universe_of
                                             =
                                             (uu___9.FStar_TypeChecker_Env.universe_of);
                                           FStar_TypeChecker_Env.check_type_of
                                             =
                                             (uu___9.FStar_TypeChecker_Env.check_type_of);
                                           FStar_TypeChecker_Env.use_bv_sorts
                                             =
                                             (uu___9.FStar_TypeChecker_Env.use_bv_sorts);
                                           FStar_TypeChecker_Env.qtbl_name_and_index
                                             =
                                             (uu___9.FStar_TypeChecker_Env.qtbl_name_and_index);
                                           FStar_TypeChecker_Env.normalized_eff_names
                                             =
                                             (uu___9.FStar_TypeChecker_Env.normalized_eff_names);
                                           FStar_TypeChecker_Env.fv_delta_depths
                                             =
                                             (uu___9.FStar_TypeChecker_Env.fv_delta_depths);
                                           FStar_TypeChecker_Env.proof_ns =
                                             (uu___9.FStar_TypeChecker_Env.proof_ns);
                                           FStar_TypeChecker_Env.synth_hook =
                                             (uu___9.FStar_TypeChecker_Env.synth_hook);
                                           FStar_TypeChecker_Env.try_solve_implicits_hook
                                             =
                                             (uu___9.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                           FStar_TypeChecker_Env.splice =
                                             (uu___9.FStar_TypeChecker_Env.splice);
                                           FStar_TypeChecker_Env.mpreprocess
                                             =
                                             (uu___9.FStar_TypeChecker_Env.mpreprocess);
                                           FStar_TypeChecker_Env.postprocess
                                             =
                                             (uu___9.FStar_TypeChecker_Env.postprocess);
                                           FStar_TypeChecker_Env.identifier_info
                                             =
                                             (uu___9.FStar_TypeChecker_Env.identifier_info);
                                           FStar_TypeChecker_Env.tc_hooks =
                                             (uu___9.FStar_TypeChecker_Env.tc_hooks);
                                           FStar_TypeChecker_Env.dsenv =
                                             (uu___9.FStar_TypeChecker_Env.dsenv);
                                           FStar_TypeChecker_Env.nbe =
                                             (uu___9.FStar_TypeChecker_Env.nbe);
                                           FStar_TypeChecker_Env.strict_args_tab
                                             =
                                             (uu___9.FStar_TypeChecker_Env.strict_args_tab);
                                           FStar_TypeChecker_Env.erasable_types_tab
                                             =
                                             (uu___9.FStar_TypeChecker_Env.erasable_types_tab);
                                           FStar_TypeChecker_Env.enable_defer_to_tac
                                             =
                                             (uu___9.FStar_TypeChecker_Env.enable_defer_to_tac);
                                           FStar_TypeChecker_Env.unif_allow_ref_guards
                                             =
                                             (uu___9.FStar_TypeChecker_Env.unif_allow_ref_guards)
                                         }) comp
                                        FStar_Syntax_Syntax.U_unknown in
                                    FStar_Syntax_Syntax.mk_Total uu___8
                                  else comp in
                                                  ...
                                                  let uu___11 =
                                                    ...
                                                    let uu___12 =
                                                      let env2 =
                                                        let uu___13 = env1 in
                                                        {
                                                          FStar_SMTEncoding_Env.universes
                                                            =
                                                            (uu___13.FStar_SMTEncoding_Env.universes);
                                                          ...
                                                          FStar_SMTEncoding_Env.tcenv
                                                            =
                                                            (uu___13.FStar_SMTEncoding_Env.tcenv);
        ...
        fun us ->
          fun t ->
            fun quals ->
              ...
              let uu___ = encode_free_var uninterpreted env lid us t tt quals in
              match uu___ with
              | (decls, env1) ->
          ...
          (FStar_List.fold_left
             (fun uu___ ->
                fun lb ->
                  match uu___ with
                  | (decls, env1) ->
                      FStar_SMTEncoding_Env.with_open_universes env1
                             ...
                             fun uu___1 ->
                               ...
                               | t::[] ->
                                   let uu___2 =
                                     ...
                                     encode_top_level_val false env2 uu___3
                                       us t quals in
                                   (match uu___2 with
                                    | (decls', env3) ->
...
let (copy_env : FStar_SMTEncoding_Env.env_t -> FStar_SMTEncoding_Env.env_t) =
  fun en ->
    ...
    {
      FStar_SMTEncoding_Env.universes =
        (uu___.FStar_SMTEncoding_Env.universes);
      FStar_SMTEncoding_Env.bvar_bindings =
                                   ...
                                   fun lb ->
                                     ...
                                     | ((toks, typs, decls), env1) ->
                                         ((let uu___7 =
                                          ...
                                          FStar_SMTEncoding_Env.with_open_universes
                                            env1
                                            lb.FStar_Syntax_Syntax.lbunivs
                                            [lb.FStar_Syntax_Syntax.lbtyp]
                                            (fun env2 ->
                                  ...
                                  t_norm::[], fvb::[]) ->
                                   ...
                                   let uu___9 =
                                     FStar_SMTEncoding_Env.open_universes_in
                                       env2 uvs [e; t_norm] in
                                   (match uu___9 with
                                    | (env', univ_names, e_t) ->
                                        let uu___10 =
                                          match e_t with
                                          | e1::t_norm1::[] -> (e1, t_norm1)
                                          | uu___11 -> failwith "Impossible" in
                                        (match uu___10 with
                                         | (e1, t_norm1) ->
                                             let uu___11 =
                                               let uu___12 =
                                                             ...
                                                             let uu___16 =
                                                               ...
                                                               then
                                                                 ...
                                                                 (let uu___18
                                                                    ...
                                                                    =
                                                                    (uu___21.FStar_SMTEncoding_Env.fvar_lid);
                                                                    ...
                                                                    =
                                                                    (uu___21.FStar_SMTEncoding_Env.smt_id);
                                                                    FStar_SMTEncoding_Env.smt_token
                                                                    =
                                                                    (uu___21.FStar_SMTEncoding_Env.smt_token);
                                                                    FStar_SMTEncoding_Env.smt_fuel_partial_app
                                                                    =
                                                                    (uu___21.FStar_SMTEncoding_Env.smt_fuel_partial_app);
                                                                    FStar_SMTEncoding_Env.fvb_thunked
                                                                    =
                                                                    (uu___21.FStar_SMTEncoding_Env.fvb_thunked)
                                                                    })
                                                                    uu___20 in
                                                                  ((FStar_List.append
                                                                    univ_vars
    ...
    fun se ->
      ...
      (let is_opaque_to_smt t =
       ...
       | FStar_Syntax_Syntax.Sig_declare_typ (lid, us, t) ->
           FStar_SMTEncoding_Env.with_open_universes env us [t]
             (fun env1 ->
                fun us1 ->
                  fun uu___1 ->
                    match uu___1 with
                            ...
                            FStar_All.pipe_right quals
                              (FStar_Util.for_some
                                 (fun uu___3 ->
                                    ...
                                    | FStar_Syntax_Syntax.Projector uu___4 ->
                                        true
                        ...
                        then ([], env1)
                          ...
                          (let fv =
                           ...
                           let uu___3 =
                             ...
                             encode_top_level_val uu___4 env1 fv us1 t1 quals in
                           match uu___3 with
                           | (decls, env2) ->
                               let tname = FStar_Ident.string_of_lid lid in
                               let tsym =
                                 let uu___4 =
                                   FStar_SMTEncoding_Env.try_lookup_free_var
                                     env2 lid in
                               ...
                               let uu___4 =
                                 let uu___5 =
                                   let uu___6 =
                                     primitive_type_axioms
                                       env2.FStar_SMTEncoding_Env.tcenv lid
                                       tname tsym in
       ...
       | FStar_Syntax_Syntax.Sig_assume (l, us, f) ->
           FStar_SMTEncoding_Env.with_open_universes env us [f]
             (fun env1 ->
                fun uvs ->
                  fun uu___1 ->
                    match uu___1 with
       ...
       | FStar_Syntax_Syntax.Sig_inductive_typ
           ...
           let tcenv_orig = env.FStar_SMTEncoding_Env.tcenv in
           let universes_orig = env.FStar_SMTEncoding_Env.universes in
           let uu___2 = FStar_Syntax_Subst.univ_var_opening universe_names in
           (match uu___2 with
            | (usubst, uvs) ->
                let uu___3 =
                  let uu___4 =
                    FStar_TypeChecker_Env.push_univ_vars tcenv_orig uvs in
                 ...
                 | (tcenv, tps1, k1) ->
                     let env1 =
                       let uu___4 = env in
                       {
                         FStar_SMTEncoding_Env.universes =
                           (FStar_List.append
                              env.FStar_SMTEncoding_Env.universes uvs);
                         FStar_SMTEncoding_Env.bvar_bindings =
                           (uu___4.FStar_SMTEncoding_Env.bvar_bindings);
                         FStar_SMTEncoding_Env.fvar_bindings =
                           (uu___4.FStar_SMTEncoding_Env.fvar_bindings);
                         FStar_SMTEncoding_Env.depth =
                           (uu___4.FStar_SMTEncoding_Env.depth);
                         FStar_SMTEncoding_Env.tcenv = tcenv;
                         FStar_SMTEncoding_Env.warn =
                           (uu___4.FStar_SMTEncoding_Env.warn);
                         FStar_SMTEncoding_Env.nolabels =
                           (uu___4.FStar_SMTEncoding_Env.nolabels);
                         FStar_SMTEncoding_Env.use_zfuel_name =
                           (uu___4.FStar_SMTEncoding_Env.use_zfuel_name);
                         FStar_SMTEncoding_Env.encode_non_total_function_typ
                           =
                           (uu___4.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                         FStar_SMTEncoding_Env.current_module_name =
                           (uu___4.FStar_SMTEncoding_Env.current_module_name);
                         FStar_SMTEncoding_Env.encoding_quantifier =
                           (uu___4.FStar_SMTEncoding_Env.encoding_quantifier);
                         FStar_SMTEncoding_Env.global_cache =
                           (uu___4.FStar_SMTEncoding_Env.global_cache)
                       } in
                     let uu___4 =
                       let uu___5 =
                         FStar_List.map
                           FStar_SMTEncoding_EncodeTerm.encode_univ_name uvs in
                     ...
                     (match uu___4 with
                      | (univ_vars, univ_terms) ->
                          ...
                          ((let uu___6 =
                            ...
                            if uu___6
                            then
                              let uu___7 = FStar_Ident.string_of_lid t in
                              FStar_Util.print2 "%s injectivity for %s\n"
                                (if is_injective then "YES" else "NO") uu___7
                            else ());
                           (let quals = se.FStar_Syntax_Syntax.sigquals in
                            let is_logical =
                              FStar_All.pipe_right quals
                            ...
                            let constructor_or_logic_type_decl c =
                              ...
                              then
                                let uu___6 = c in
                                match uu___6 with
                                | (name, args, uu___7, uu___8, uu___9) ->
                                    let uu___10 =
                                      let uu___11 =
                                        let uu___12 =
                                          FStar_All.pipe_right args
                                            (FStar_List.map
                                               (fun uu___13 ->
                                                  match uu___13 with
                                                  | (uu___14, sort, uu___15)
                                                      -> sort)) in
                                        (name, uu___12,
                                          FStar_SMTEncoding_Term.Term_sort,
                                          FStar_Pervasives_Native.None) in
                                      FStar_SMTEncoding_Term.DeclFun uu___11 in
                                    [uu___10]
                              else
                                (let uu___7 = FStar_Ident.range_of_lid t in
                            ...
                            | (formals, res) ->
                                ...
                                (match uu___7 with
                                 | (vars, guards, env', binder_decls, uu___8)
                                     ->
                                           ...
                                           | (decls, env3) ->
                                               ...
                                               let env4 =
                                                 let uu___11 = env3 in
                                                 {
                                                   ...
                                                   FStar_SMTEncoding_Env.bvar_bindings
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.bvar_bindings);
                                                   FStar_SMTEncoding_Env.fvar_bindings
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.fvar_bindings);
                                                   FStar_SMTEncoding_Env.depth
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.depth);
                                                   FStar_SMTEncoding_Env.tcenv
                                                     = tcenv_orig;
                                                   FStar_SMTEncoding_Env.warn
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.warn);
                                                   FStar_SMTEncoding_Env.nolabels
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.nolabels);
                                                   FStar_SMTEncoding_Env.use_zfuel_name
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.use_zfuel_name);
                                                   FStar_SMTEncoding_Env.encode_non_total_function_typ
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                                                   FStar_SMTEncoding_Env.current_module_name
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.current_module_name);
                                                   FStar_SMTEncoding_Env.encoding_quantifier
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.encoding_quantifier);
                                                   FStar_SMTEncoding_Env.global_cache
                                                     =
                                                     (uu___11.FStar_SMTEncoding_Env.global_cache)
                                                 } in
                                               (g, env4)))))))))
       | FStar_Syntax_Syntax.Sig_datacon
           ...
           ([], env)
       | FStar_Syntax_Syntax.Sig_datacon (d, us, t, uu___1, n_tps, uu___2) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let encode_datacon_body env1 us1 t1 =
             let uu___3 =
               let uu___4 =
                 FStar_List.map FStar_SMTEncoding_EncodeTerm.encode_univ_name
                   us1 in
               FStar_All.pipe_right uu___4 FStar_List.unzip in
             match uu___3 with
             | (univ_fvs, univs) ->
                 let univ_sorts =
                   FStar_All.pipe_right univs
                     (FStar_List.map
                        (fun uu___4 -> FStar_SMTEncoding_Term.univ_sort)) in
                                      ...
                                      | (tok_typing, decls3) ->
                                          let tok_typing1 =
                                            ...
                                            | uu___9 ->
                                                let uu___10 =
                                                  FStar_Ident.range_of_lid d in
                                                close_universes uu___10
                                                  univ_fvs ddtok_tm
                                                  tok_typing in
                                          let uu___9 =
                                            FStar_SMTEncoding_EncodeTerm.encode_binders
                                              (FStar_Pervasives_Native.Some
                                                 fuel_tm) formals env2 in
                                          (match uu___9 with
                                           | (vars', guards', env'',
                                              decls_formals, uu___10) ->
                                               let uu___11 =
                                                 let xvars1 =
                                                   FStar_List.map
                                                     FStar_SMTEncoding_Util.mkFreeV
                                                               ...
                                                               (match uu___18
                                                                ...
                                                                | (encoded_args,
                                                                   arg_decls)
                                                                    ...
                                                                    FStar_SMTEncoding_Env.fvar_lid
                                                                    =
                                                                    (uu___22.FStar_SMTEncoding_Env.fvar_lid);
                                                                    FStar_SMTEncoding_Env.smt_arity
                                                                    =
                                                                    ((FStar_List.length
                                                                    univ_fvs)
                                                                    +
                                                                    encoded_head_fvb.FStar_SMTEncoding_Env.smt_arity);
                                                                    FStar_SMTEncoding_Env.smt_id
                                                                    =
                                                                    (uu___22.FStar_SMTEncoding_Env.smt_id);
                                                                    FStar_SMTEncoding_Env.smt_token
                                                                    =
                                                                    (uu___22.FStar_SMTEncoding_Env.smt_token);
                                                                    FStar_SMTEncoding_Env.smt_fuel_partial_app
                                                                    =
                                                                    (uu___22.FStar_SMTEncoding_Env.smt_fuel_partial_app);
                                                                    FStar_SMTEncoding_Env.fvb_thunked
                                                                    =
                                                                    (uu___22.FStar_SMTEncoding_Env.fvb_thunked)
                                                                    })
                                                                    (FStar_List.append
                                                                    univs
                                                                    arg_vars1) in
                                                               ...
                                                               (match uu___15
                                                                ...
                                                                | (encoded_args,
                                                                   arg_decls)
                                                                    ...
                                                                    FStar_SMTEncoding_Env.fvar_lid
                                                                    =
                                                                    (uu___19.FStar_SMTEncoding_Env.fvar_lid);
                                                                    FStar_SMTEncoding_Env.smt_arity
                                                                    =
                                                                    ((FStar_List.length
                                                                    univ_fvs)
                                                                    ...
                                                                    FStar_SMTEncoding_Env.smt_id
                                                                    =
                                                                    (uu___19.FStar_SMTEncoding_Env.smt_id);
                                                                    FStar_SMTEncoding_Env.smt_token
                                                                    =
                                                                    (uu___19.FStar_SMTEncoding_Env.smt_token);
                                                                    FStar_SMTEncoding_Env.smt_fuel_partial_app
                                                                    =
                                                                    (uu___19.FStar_SMTEncoding_Env.smt_fuel_partial_app);
                                                                    FStar_SMTEncoding_Env.fvb_thunked
                                                                    =
                                                                    (uu___19.FStar_SMTEncoding_Env.fvb_thunked)
                                                                    })
                                                                    (FStar_List.append
                                                                    univs
                                                                    arg_vars1) in
           ...
           FStar_SMTEncoding_Env.with_open_universes env us [t]
             (fun env1 ->
                fun us1 ->
                  fun uu___3 ->
                    match uu___3 with
                    | t1::[] -> encode_datacon_body env1 us1 t1))
and (encode_sigelts :
  FStar_SMTEncoding_Env.env_t ->
        ...
        | (i, decls, env1) ->
            (match b with
             ...
             | FStar_Syntax_Syntax.Binding_lid (x, (us, t)) ->
                 let uu___1 =
                   FStar_SMTEncoding_Env.with_open_universes env1 us 
                     [t]
                     (fun env2 ->
                        fun us1 ->
                          fun uu___2 ->
                            match uu___2 with
                            | t1::[] ->
                                let t_norm = norm_before_encoding env2 t1 in
                                let fv =
                                  FStar_Syntax_Syntax.lid_as_fv x
                                    FStar_Syntax_Syntax.delta_constant
                                    FStar_Pervasives_Native.None in
                                let uu___3 =
                                  encode_free_var false env2 fv us1 t1 t_norm
                                    [] in
                                (match uu___3 with
                                 | (g, env') ->
                                     (((i + Prims.int_one),
                 ...
                 (match uu___1 with
                  | ((j, decls1), env2) -> (j, decls1, env2))) in
      let uu___ =
  ...
  fun cmn ->
    fun tcenv ->
      ...
      | e::uu___1 ->
          ...
          {
            FStar_SMTEncoding_Env.universes =
              (uu___2.FStar_SMTEncoding_Env.universes);
            FStar_SMTEncoding_Env.bvar_bindings =
      ...
      fun decls ->
        ...
        set_env
          (let uu___1 = env in
           {
             FStar_SMTEncoding_Env.universes =
               (uu___1.FStar_SMTEncoding_Env.universes);
             FStar_SMTEncoding_Env.bvar_bindings =
               ...
               let uu___5 =
                 encode_signature
                   (let uu___6 = env in
                    {
                      FStar_SMTEncoding_Env.universes =
                        (uu___6.FStar_SMTEncoding_Env.universes);
                      FStar_SMTEncoding_Env.bvar_bindings =
