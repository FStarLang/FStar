...
in (_162_590, Some ("Typing for non-total arrows")))
...
in (_162_615)::[])
in (FStar_SMTEncoding_Term.Assume ((t_kinding, Some ("refinement kinding"))))::_162_616)
in (tdecl)::_162_617)
...
in (_162_629, Some ("Partial app typing")))
...
in (_162_1934, Some ("Typing correspondence of token to term")))
...
in (_162_2140, Some ("Name-token correspondence")))
...
let g = (let _162_2178 = (let _162_2177 = (let _162_2176 = (let _162_2175 = (FStar_All.pipe_left (fun _162_2174 -> Some (_162_2174)) (Prims.strcat "Encoding " xxsym))
in (t, _162_2175))
in FStar_SMTEncoding_Term.Assume (_162_2176))
in (_162_2177)::[])
in (FStar_List.append (FStar_List.append ((FStar_SMTEncoding_Term.DeclFun ((xxsym, [], FStar_SMTEncoding_Term.Term_sort, caption)))::[]) decls') _162_2178))
in ((FStar_List.append decls g), env')))
end))))
end))
end
...
(let _162_2186 = (FStar_All.pipe_left (fun _162_2182 -> FStar_SMTEncoding_Term.Echo (_162_2182)) (Prims.fst l))
in (let _162_2185 = (let _162_2184 = (let _162_2183 = (FStar_SMTEncoding_Term.mkFreeV l)
in FStar_SMTEncoding_Term.Eval (_162_2183))
in (_162_2184)::[])
in (_162_2186)::_162_2185))
end))))
in (prefix, suffix))))
...
let init_env : FStar_TypeChecker_Env.env  ->  Prims.unit = (fun tcenv -> (let _162_2191 = (let _162_2190 = (let _162_2189 = (FStar_Util.smap_create 100)
in {bindings = []; depth = 0; tcenv = tcenv; warn = true; cache = _162_2189; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_162_2190)::[])
in (FStar_ST.op_Colon_Equals last_env _162_2191)))
...
let _78_2947 = (let _162_2212 = (pop_env ())
in (FStar_All.pipe_left Prims.ignore _162_2212))
in (
...
(let _162_2228 = (let _162_2227 = (let _162_2226 = (let _162_2225 = (let _162_2224 = (FStar_Syntax_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _162_2224 (FStar_List.map FStar_Syntax_Print.lid_to_string)))
in (FStar_All.pipe_right _162_2225 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " _162_2226))
in FStar_SMTEncoding_Term.Caption (_162_2227))
in (_162_2228)::decls)
end else begin
decls
end)
...
in (let _162_2229 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 _162_2229)))
end)))))
...
(let _162_2234 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) FStar_Util.string_of_int)
...
let _78_3000 = (let _162_2253 = (let _162_2252 = (let _162_2251 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _162_2251))
in (FStar_Util.format1 "Starting query at %s" _162_2252))
in (push _162_2253))
in (
# 1863 "FStar.SMTEncoding.Encode.fst"
let pop = (fun _78_3003 -> (match (()) with
| () -> begin
(let _162_2258 = (let _162_2257 = (let _162_2256 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _162_2256))
in (FStar_Util.format1 "Ending query at %s" _162_2257))
in (pop _162_2258))
end))
in (
...
in (let _162_2264 = (let _162_2263 = (FStar_Syntax_Syntax.mk_binder (
...
(let _162_2265 = (FStar_Syntax_Util.close_forall (FStar_List.rev closing) q)
in (_162_2265, bindings))
end)))
in (match (_78_3027) with
| (q, bindings) -> begin
(
# 1876 "FStar.SMTEncoding.Encode.fst"
let _78_3036 = (let _162_2267 = (FStar_List.filter (fun _78_21 -> (match (_78_21) with
...
in (encode_env_bindings env _162_2267))
...
(let _162_2268 = (FStar_Syntax_Print.term_to_string q)
...
let _78_3046 = (let _162_2269 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _162_2269 phi))
...
let qry = (let _162_2271 = (let _162_2270 = (FStar_SMTEncoding_Term.mkNot phi)
in (_162_2270, Some ("query")))
in FStar_SMTEncoding_Term.Assume (_162_2271))
in (
