      ...
      let a1 =
           ...
           in
        {
          ...
          FStar_Syntax_Syntax.index =
            (uu___131_143.FStar_Syntax_Syntax.index);
          FStar_Syntax_Syntax.sort = (uu___131_143.FStar_Syntax_Syntax.sort)
        }  in
      let uu____145 =
...
let (unmangle : FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv) =
  fun x  ->
    let uu___132_1621 = x  in
    let uu____1622 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname  in
    {
      FStar_Syntax_Syntax.ppname = uu____1622;
      FStar_Syntax_Syntax.index = (uu___132_1621.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___132_1621.FStar_Syntax_Syntax.sort)
    }
    ...
    fun x  ->
      ...
      let y =
        FStar_SMTEncoding_Util.mkFreeV
         ...
         in
      (ysym, y,
        (let uu___133_2193 = env  in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (env.depth + (Prims.parse_int "1"));
           tcenv = (uu___133_2193.tcenv);
           warn = (uu___133_2193.warn);
           cache = (uu___133_2193.cache);
           nolabels = (uu___133_2193.nolabels);
           use_zfuel_name = (uu___133_2193.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___133_2193.encode_non_total_function_typ);
           current_module_name = (uu___133_2193.current_module_name)
         }))
...
let (new_term_constant :
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___134_2211 = env  in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (uu___134_2211.depth);
           tcenv = (uu___134_2211.tcenv);
           warn = (uu___134_2211.warn);
           cache = (uu___134_2211.cache);
           nolabels = (uu___134_2211.nolabels);
           use_zfuel_name = (uu___134_2211.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___134_2211.encode_non_total_function_typ);
           current_module_name = (uu___134_2211.current_module_name)
         }))
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, [])  in
        (ysym, y,
          (let uu___135_2232 = env  in
           {
             bindings = ((Binding_var (x, y)) :: (env.bindings));
             depth = (uu___135_2232.depth);
             tcenv = (uu___135_2232.tcenv);
             warn = (uu___135_2232.warn);
             cache = (uu___135_2232.cache);
             nolabels = (uu___135_2232.nolabels);
             use_zfuel_name = (uu___135_2232.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___135_2232.encode_non_total_function_typ);
             current_module_name = (uu___135_2232.current_module_name)
           }))
...
let (push_term_var :
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___136_2242 = env  in
        {
          bindings = ((Binding_var (x, t)) :: (env.bindings));
          depth = (uu___136_2242.depth);
          tcenv = (uu___136_2242.tcenv);
          warn = (uu___136_2242.warn);
          cache = (uu___136_2242.cache);
          nolabels = (uu___136_2242.nolabels);
          use_zfuel_name = (uu___136_2242.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___136_2242.encode_non_total_function_typ);
          current_module_name = (uu___136_2242.current_module_name)
        }
      ...
      fun arity  ->
        ...
        let fvb =
          mk_fvb x fname arity (FStar_Pervasives_Native.Some ftok)
           ...
           in
        (fname, ftok_name,
          (let uu___137_2367 = env  in
           {
             bindings = ((Binding_fvar fvb) :: (env.bindings));
             depth = (uu___137_2367.depth);
             tcenv = (uu___137_2367.tcenv);
             warn = (uu___137_2367.warn);
             cache = (uu___137_2367.cache);
             nolabels = (uu___137_2367.nolabels);
             use_zfuel_name = (uu___137_2367.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___137_2367.encode_non_total_function_typ);
             current_module_name = (uu___137_2367.current_module_name)
           }))
        ...
        fun fname  ->
          fun ftok  ->
            let fvb = mk_fvb x fname arity ftok FStar_Pervasives_Native.None
               in
            let uu___138_2433 = env  in
            {
              bindings = ((Binding_fvar fvb) :: (env.bindings));
              depth = (uu___138_2433.depth);
              tcenv = (uu___138_2433.tcenv);
              warn = (uu___138_2433.warn);
              cache = (uu___138_2433.cache);
              nolabels = (uu___138_2433.nolabels);
              use_zfuel_name = (uu___138_2433.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___138_2433.encode_non_total_function_typ);
              current_module_name = (uu___138_2433.current_module_name)
            }
      ...
      fun f  ->
        ...
        let fvb1 =
          mk_fvb x fvb.smt_id fvb.smt_arity fvb.smt_token
           ...
           in
        let uu___139_2461 = env  in
        {
          bindings = ((Binding_fvar fvb1) :: (env.bindings));
          depth = (uu___139_2461.depth);
          tcenv = (uu___139_2461.tcenv);
          warn = (uu___139_2461.warn);
          cache = (uu___139_2461.cache);
          nolabels = (uu___139_2461.nolabels);
          use_zfuel_name = (uu___139_2461.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___139_2461.encode_non_total_function_typ);
          current_module_name = (uu___139_2461.current_module_name)
        }
                   ...
                   | (vars,guards,env',decls,uu____5781) ->
                       ...
                       let uu____5802 =
                         FStar_TypeChecker_Util.pure_or_ghost_pre_and_post
                           (let uu___140_5811 = env.tcenv  in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___140_5811.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___140_5811.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___140_5811.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___140_5811.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___140_5811.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___140_5811.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___140_5811.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___140_5811.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___140_5811.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___140_5811.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___140_5811.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___140_5811.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___140_5811.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___140_5811.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___140_5811.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___140_5811.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___140_5811.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___140_5811.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___140_5811.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___140_5811.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___140_5811.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___140_5811.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___140_5811.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___140_5811.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___140_5811.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___140_5811.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___140_5811.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___140_5811.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth =
                                (uu___140_5811.FStar_TypeChecker_Env.synth);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___140_5811.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___140_5811.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___140_5811.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___140_5811.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___140_5811.FStar_TypeChecker_Env.dep_graph)
                            }) res
                          in
  ...
  fun t  ->
    fun env  ->
      ...
      | (binders,pre,post,patterns) ->
          let env1 =
            let uu___141_9983 = env  in
            {
              bindings = (uu___141_9983.bindings);
              depth = (uu___141_9983.depth);
              tcenv = (uu___141_9983.tcenv);
              warn = (uu___141_9983.warn);
              cache = (uu___141_9983.cache);
              nolabels = (uu___141_9983.nolabels);
              use_zfuel_name = true;
              encode_non_total_function_typ =
                (uu___141_9983.encode_non_total_function_typ);
              current_module_name = (uu___141_9983.current_module_name)
            }  in
          let uu____9984 =
           ...
           | (vars,guards,env2,decls,uu____10009) ->
               ...
               (match uu____10022 with
                | (pats,decls') ->
                    ...
                    let env3 =
                      let uu___142_10254 = env2  in
                      {
                        bindings = (uu___142_10254.bindings);
                        depth = (uu___142_10254.depth);
                        tcenv = (uu___142_10254.tcenv);
                        warn = (uu___142_10254.warn);
                        cache = (uu___142_10254.cache);
                        nolabels = true;
                        use_zfuel_name = (uu___142_10254.use_zfuel_name);
                        encode_non_total_function_typ =
                          (uu___142_10254.encode_non_total_function_typ);
                        current_module_name =
                          (uu___142_10254.current_module_name)
                      }  in
                    let uu____10255 =
  ...
  fun phi  ->
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            let uu____10567 =
              let uu___143_10568 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___143_10568.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___143_10568.FStar_SMTEncoding_Term.freevars);
      ...
      let bin_op f uu___117_10647 =
        match uu___117_10647 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
        ...
        | (decls,phis) ->
            let uu____10759 =
              let uu___144_10760 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___144_10760.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___144_10760.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____10759, decls)
         in
      let eq_op r args =
        ...
        then
          ...
          (let uu____10870 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____10870 r rf)
         in
      let mk_imp1 r uu___118_10895 =
        match uu___118_10895 with
      ...
      let mk_ite r uu___119_10986 =
        match uu___119_10986 with
                  ...
                  | (tt,decls) ->
                      let uu____11978 =
                        FStar_SMTEncoding_Term.mk_Valid
                          (let uu___145_11981 = tt  in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___145_11981.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___145_11981.FStar_SMTEncoding_Term.freevars);
        ...
        | uu____11982 ->
            ...
            (match uu____11983 with
             | (tt,decls) ->
                 let uu____11994 =
                   FStar_SMTEncoding_Term.mk_Valid
                     (let uu___146_11997 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___146_11997.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___146_11997.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                                 ...
                                 (fun uu____12201  ->
                                    ...
                                    | (t,uu____12215) ->
                                        encode_smt_pattern t
                                          (let uu___147_12221 = env2  in
                                           {
                                             bindings =
                                               (uu___147_12221.bindings);
                                             depth = (uu___147_12221.depth);
                                             tcenv = (uu___147_12221.tcenv);
                                             warn = (uu___147_12221.warn);
                                             cache = (uu___147_12221.cache);
                                             nolabels =
                                               (uu___147_12221.nolabels);
                                             use_zfuel_name = true;
                                             encode_non_total_function_typ =
                                               (uu___147_12221.encode_non_total_function_typ);
                                             current_module_name =
                                               (uu___147_12221.current_module_name)
                                           })))
                             in
                            ...
                            then
                              let uu____17151 =
                                FStar_TypeChecker_Env.reify_comp
                                  (let uu___148_17154 = env.tcenv  in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___148_17154.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___148_17154.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___148_17154.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___148_17154.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___148_17154.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___148_17154.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       (uu___148_17154.FStar_TypeChecker_Env.expected_typ);
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___148_17154.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___148_17154.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___148_17154.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___148_17154.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___148_17154.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (uu___148_17154.FStar_TypeChecker_Env.letrecs);
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___148_17154.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___148_17154.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___148_17154.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___148_17154.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___148_17154.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax = true;
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___148_17154.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.failhard =
                                       (uu___148_17154.FStar_TypeChecker_Env.failhard);
                                     FStar_TypeChecker_Env.nosynth =
                                       (uu___148_17154.FStar_TypeChecker_Env.nosynth);
                                     FStar_TypeChecker_Env.tc_term =
                                       (uu___148_17154.FStar_TypeChecker_Env.tc_term);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___148_17154.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___148_17154.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.check_type_of =
                                       (uu___148_17154.FStar_TypeChecker_Env.check_type_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       (uu___148_17154.FStar_TypeChecker_Env.use_bv_sorts);
                                     FStar_TypeChecker_Env.qtbl_name_and_index
                                       =
                                       (uu___148_17154.FStar_TypeChecker_Env.qtbl_name_and_index);
                                     FStar_TypeChecker_Env.proof_ns =
                                       (uu___148_17154.FStar_TypeChecker_Env.proof_ns);
                                     FStar_TypeChecker_Env.synth =
                                       (uu___148_17154.FStar_TypeChecker_Env.synth);
                                     FStar_TypeChecker_Env.is_native_tactic =
                                       (uu___148_17154.FStar_TypeChecker_Env.is_native_tactic);
                                     FStar_TypeChecker_Env.identifier_info =
                                       (uu___148_17154.FStar_TypeChecker_Env.identifier_info);
                                     FStar_TypeChecker_Env.tc_hooks =
                                       (uu___148_17154.FStar_TypeChecker_Env.tc_hooks);
                                     FStar_TypeChecker_Env.dsenv =
                                       (uu___148_17154.FStar_TypeChecker_Env.dsenv);
                                     FStar_TypeChecker_Env.dep_graph =
                                       (uu___148_17154.FStar_TypeChecker_Env.dep_graph)
                                  ...
                                  (match uu____17498 with
                                   | (guard,decls11) ->
                                       ...
                                       let uu____17549 =
                                         ...
                                         let uu____17587 =
                                           let env2 =
                                             let uu___149_17593 = env1  in
                                             {
                                               bindings =
                                                 (uu___149_17593.bindings);
                                               depth = (uu___149_17593.depth);
                                               tcenv = (uu___149_17593.tcenv);
                                               warn = (uu___149_17593.warn);
                                               cache = (uu___149_17593.cache);
                                               nolabels =
                                                 (uu___149_17593.nolabels);
                                               use_zfuel_name =
                                                 (uu___149_17593.use_zfuel_name);
                                               encode_non_total_function_typ;
                                               current_module_name =
                                                 (uu___149_17593.current_module_name)
                                             }  in
                                           let uu____17594 =
                                             let uu____17595 =
        ...
        | (is_rec,bindings) ->
                           ...
                           (fun uu____18443  ->
                              ...
                              | (x,i) ->
                                  let uu____18454 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___150_18455.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___150_18455.FStar_Syntax_Syntax.index);
            ...
            let destruct_bound_function flid t_norm e =
              let get_result_type c =
                ...
                then
                  FStar_TypeChecker_Env.reify_comp
                    (let uu___151_18541 = env.tcenv  in
                     {
                       FStar_TypeChecker_Env.solver =
                         (uu___151_18541.FStar_TypeChecker_Env.solver);
                       FStar_TypeChecker_Env.range =
                         (uu___151_18541.FStar_TypeChecker_Env.range);
                       FStar_TypeChecker_Env.curmodule =
                         (uu___151_18541.FStar_TypeChecker_Env.curmodule);
                       FStar_TypeChecker_Env.gamma =
                         (uu___151_18541.FStar_TypeChecker_Env.gamma);
                       FStar_TypeChecker_Env.gamma_cache =
                         (uu___151_18541.FStar_TypeChecker_Env.gamma_cache);
                       FStar_TypeChecker_Env.modules =
                         (uu___151_18541.FStar_TypeChecker_Env.modules);
                       FStar_TypeChecker_Env.expected_typ =
                         (uu___151_18541.FStar_TypeChecker_Env.expected_typ);
                       FStar_TypeChecker_Env.sigtab =
                         (uu___151_18541.FStar_TypeChecker_Env.sigtab);
                       FStar_TypeChecker_Env.is_pattern =
                         (uu___151_18541.FStar_TypeChecker_Env.is_pattern);
                       FStar_TypeChecker_Env.instantiate_imp =
                         (uu___151_18541.FStar_TypeChecker_Env.instantiate_imp);
                       FStar_TypeChecker_Env.effects =
                         (uu___151_18541.FStar_TypeChecker_Env.effects);
                       FStar_TypeChecker_Env.generalize =
                         (uu___151_18541.FStar_TypeChecker_Env.generalize);
                       FStar_TypeChecker_Env.letrecs =
                         (uu___151_18541.FStar_TypeChecker_Env.letrecs);
                       FStar_TypeChecker_Env.top_level =
                         (uu___151_18541.FStar_TypeChecker_Env.top_level);
                       FStar_TypeChecker_Env.check_uvars =
                         (uu___151_18541.FStar_TypeChecker_Env.check_uvars);
                       FStar_TypeChecker_Env.use_eq =
                         (uu___151_18541.FStar_TypeChecker_Env.use_eq);
                       FStar_TypeChecker_Env.is_iface =
                         (uu___151_18541.FStar_TypeChecker_Env.is_iface);
                       FStar_TypeChecker_Env.admit =
                         (uu___151_18541.FStar_TypeChecker_Env.admit);
                       FStar_TypeChecker_Env.lax = true;
                       FStar_TypeChecker_Env.lax_universes =
                         (uu___151_18541.FStar_TypeChecker_Env.lax_universes);
                       FStar_TypeChecker_Env.failhard =
                         (uu___151_18541.FStar_TypeChecker_Env.failhard);
                       FStar_TypeChecker_Env.nosynth =
                         (uu___151_18541.FStar_TypeChecker_Env.nosynth);
                       FStar_TypeChecker_Env.tc_term =
                         (uu___151_18541.FStar_TypeChecker_Env.tc_term);
                       FStar_TypeChecker_Env.type_of =
                         (uu___151_18541.FStar_TypeChecker_Env.type_of);
                       FStar_TypeChecker_Env.universe_of =
                         (uu___151_18541.FStar_TypeChecker_Env.universe_of);
                       FStar_TypeChecker_Env.check_type_of =
                         (uu___151_18541.FStar_TypeChecker_Env.check_type_of);
                       FStar_TypeChecker_Env.use_bv_sorts =
                         (uu___151_18541.FStar_TypeChecker_Env.use_bv_sorts);
                       FStar_TypeChecker_Env.qtbl_name_and_index =
                         (uu___151_18541.FStar_TypeChecker_Env.qtbl_name_and_index);
                       FStar_TypeChecker_Env.proof_ns =
                         (uu___151_18541.FStar_TypeChecker_Env.proof_ns);
                       FStar_TypeChecker_Env.synth =
                         (uu___151_18541.FStar_TypeChecker_Env.synth);
                       FStar_TypeChecker_Env.is_native_tactic =
                         (uu___151_18541.FStar_TypeChecker_Env.is_native_tactic);
                       FStar_TypeChecker_Env.identifier_info =
                         (uu___151_18541.FStar_TypeChecker_Env.identifier_info);
                       FStar_TypeChecker_Env.tc_hooks =
                         (uu___151_18541.FStar_TypeChecker_Env.tc_hooks);
                       FStar_TypeChecker_Env.dsenv =
                         (uu___151_18541.FStar_TypeChecker_Env.dsenv);
                       FStar_TypeChecker_Env.dep_graph =
                         (uu___151_18541.FStar_TypeChecker_Env.dep_graph)
                            ...
                            let uu____19798 =
                              ...
                              | (tcenv',uu____19823,e_t) ->
                                  ...
                                  (match uu____19829 with
                                   | (e1,t_norm1) ->
                                       ((let uu___154_19856 = env2  in
                                         {
                                           bindings =
                                             (uu___154_19856.bindings);
                                           depth = (uu___154_19856.depth);
                                           tcenv = tcenv';
                                           warn = (uu___154_19856.warn);
                                           cache = (uu___154_19856.cache);
                                           nolabels =
                                             (uu___154_19856.nolabels);
                                           use_zfuel_name =
                                             (uu___154_19856.use_zfuel_name);
                                           encode_non_total_function_typ =
                                             (uu___154_19856.encode_non_total_function_typ);
                                           current_module_name =
                                             (uu___154_19856.current_module_name)
                                         }), e1, t_norm1))
                               in
                      ...
                      let encode_rec_lbdefs bindings1 typs2 toks1 env2 =
                        ...
                        | (gtoks,env3) ->
                                  ...
                                  let uu____20383 =
                                    ...
                                    | (tcenv',uu____20412,e_t) ->
                                        ...
                                        (match uu____20418 with
                                         | (e1,t_norm1) ->
                                             ((let uu___155_20445 = env3  in
                                               {
                                                 bindings =
                                                   (uu___155_20445.bindings);
                                                 depth =
                                                   (uu___155_20445.depth);
                                                 tcenv = tcenv';
                                                 warn = (uu___155_20445.warn);
                                                 cache =
                                                   (uu___155_20445.cache);
                                                 nolabels =
                                                   (uu___155_20445.nolabels);
                                                 use_zfuel_name =
                                                   (uu___155_20445.use_zfuel_name);
                                                 encode_non_total_function_typ
                                                   =
                                                   (uu___155_20445.encode_non_total_function_typ);
                                                 current_module_name =
                                                   (uu___155_20445.current_module_name)
                                               }), e1, t_norm1))
                                     in
                            ...
                            (match uu____21028 with
                             | (decls2,eqns,env01) ->
                                 let uu____21301 =
                                   let isDeclFun uu___121_21313 =
                                     match uu___121_21313 with
                                     | FStar_SMTEncoding_Term.DeclFun
                                         uu____21314 -> true
                     ...
                     let val_decl =
                       let uu___158_22270 = se  in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___158_22270.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___158_22270.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___158_22270.FStar_Syntax_Syntax.sigattrs)
                       }  in
           ...
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 let uu___159_22497 = se  in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___159_22497.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___159_22497.FStar_Syntax_Syntax.sigmeta);
                   FStar_Syntax_Syntax.sigattrs =
                     (uu___159_22497.FStar_Syntax_Syntax.sigattrs)
                 }  in
...
let (get_env : FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t) =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____25895 ->
          let uu___160_25898 = e  in
          let uu____25899 = FStar_Ident.string_of_lid cmn  in
          {
            bindings = (uu___160_25898.bindings);
            depth = (uu___160_25898.depth);
            tcenv;
            warn = (uu___160_25898.warn);
            cache = (uu___160_25898.cache);
            nolabels = (uu___160_25898.nolabels);
            use_zfuel_name = (uu___160_25898.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___160_25898.encode_non_total_function_typ);
...
let (push_env : Prims.unit -> Prims.unit) =
  fun uu____25958  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___161_25993 = hd1  in
          {
            bindings = (uu___161_25993.bindings);
            depth = (uu___161_25993.depth);
            tcenv = (uu___161_25993.tcenv);
            warn = (uu___161_25993.warn);
            cache = refs;
            nolabels = (uu___161_25993.nolabels);
            use_zfuel_name = (uu___161_25993.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___161_25993.encode_non_total_function_typ);
            current_module_name = (uu___161_25993.current_module_name)
          }  in
    ...
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____26110::uu____26111,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___162_26119 = a  in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___162_26119.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___162_26119.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___162_26119.FStar_SMTEncoding_Term.assumption_name);
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv  in
       ...
       let uu____26325 =
         encode_signature
           (let uu___163_26334 = env  in
            {
              bindings = (uu___163_26334.bindings);
              depth = (uu___163_26334.depth);
              tcenv = (uu___163_26334.tcenv);
              warn = false;
              cache = (uu___163_26334.cache);
              nolabels = (uu___163_26334.nolabels);
              use_zfuel_name = (uu___163_26334.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___163_26334.encode_non_total_function_typ);
              current_module_name = (uu___163_26334.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___164_26359 = env1  in
               {
                 bindings = (uu___164_26359.bindings);
                 depth = (uu___164_26359.depth);
                 tcenv = (uu___164_26359.tcenv);
                 warn = true;
                 cache = (uu___164_26359.cache);
                 nolabels = (uu___164_26359.nolabels);
                 use_zfuel_name = (uu___164_26359.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___164_26359.encode_non_total_function_typ);
                 current_module_name = (uu___164_26359.current_module_name)
               });
            (let uu____26361 =
                      ...
                      let uu____26504 =
                        let uu____26507 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___165_26510 = x  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___165_26510.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___165_26510.FStar_Syntax_Syntax.index);
