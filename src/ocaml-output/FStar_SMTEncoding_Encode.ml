...
Some (FStar_Util.Inl ((let _0_260 = (let _0_259 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp s _0_259))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _0_260))))
end
| uu____118 -> begin
l
end))
...
let uu___133_132 = a
in (let _0_261 = (FStar_Syntax_Util.unmangle_field_name a.FStar_Syntax_Syntax.ppname)
in {FStar_Syntax_Syntax.ppname = _0_261; FStar_Syntax_Syntax.index = uu___133_132.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___133_132.FStar_Syntax_Syntax.sort}))
in (let _0_262 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str a.FStar_Syntax_Syntax.ppname.FStar_Ident.idText)
in (FStar_All.pipe_left escape _0_262))))


let primitive_projector_by_pos : FStar_TypeChecker_Env.env  ->  FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun env lid i -> (

let fail = (fun uu____145 -> (failwith (let _0_263 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "Projector %s on data constructor %s not found" _0_263 lid.FStar_Ident.str))))
in (
...
let mk_term_projector_name_by_pos : FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun lid i -> (let _0_265 = (let _0_264 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str _0_264))
in (FStar_All.pipe_left escape _0_265)))


let mk_term_projector : FStar_Ident.lident  ->  FStar_Syntax_Syntax.bv  ->  FStar_SMTEncoding_Term.term = (fun lid a -> (FStar_SMTEncoding_Util.mkFreeV (let _0_266 = (mk_term_projector_name lid a)
in ((_0_266), (FStar_SMTEncoding_Term.Arrow (((FStar_SMTEncoding_Term.Term_sort), (FStar_SMTEncoding_Term.Term_sort))))))))


let mk_term_projector_by_pos : FStar_Ident.lident  ->  Prims.int  ->  FStar_SMTEncoding_Term.term = (fun lid i -> (FStar_SMTEncoding_Util.mkFreeV (let _0_267 = (mk_term_projector_name_by_pos lid i)
in ((_0_267), (FStar_SMTEncoding_Term.Arrow (((FStar_SMTEncoding_Term.Term_sort), (FStar_SMTEncoding_Term.Term_sort))))))))
...
let new_scope = (fun uu____387 -> (let _0_269 = (FStar_Util.smap_create (Prims.parse_int "100"))
in (let _0_268 = (FStar_Util.smap_create (Prims.parse_int "100"))
in ((_0_269), (_0_268)))))
in (

let scopes = (FStar_Util.mk_ref (let _0_270 = (new_scope ())
in (_0_270)::[]))
in (
...
let uu____417 = (let _0_271 = (FStar_ST.read scopes)
in (FStar_Util.find_map _0_271 (fun uu____430 -> (match (uu____430) with
...
((FStar_Util.incr ctr);
(let _0_273 = (let _0_272 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (Prims.strcat "__" _0_272))
in (Prims.strcat y _0_273));
)
end))
in (

let top_scope = (let _0_274 = (FStar_List.hd (FStar_ST.read scopes))
in (FStar_All.pipe_left Prims.fst _0_274))
in ((FStar_Util.smap_add top_scope y true);
y;
)))))
in (

let new_var = (fun pp rn -> (let _0_277 = (let _0_276 = (let _0_275 = (FStar_Util.string_of_int rn)
in (Prims.strcat "__" _0_275))
in (Prims.strcat pp.FStar_Ident.idText _0_276))
in (FStar_All.pipe_left mk_unique _0_277)))
in (
...
let fresh = (fun pfx -> (let _0_279 = (let _0_278 = (next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_278))
in (FStar_Util.format2 "%s_%s" pfx _0_279)))
in (

let string_const = (fun s -> (

let uu____499 = (let _0_280 = (FStar_ST.read scopes)
in (FStar_Util.find_map _0_280 (fun uu____512 -> (match (uu____512) with
...
let f = (let _0_281 = (FStar_SMTEncoding_Util.mk_String_const id)
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxString _0_281))
in (

let top_scope = (let _0_282 = (FStar_List.hd (FStar_ST.read scopes))
in (FStar_All.pipe_left Prims.snd _0_282))
...
let push = (fun uu____551 -> (let _0_285 = (let _0_284 = (new_scope ())
in (let _0_283 = (FStar_ST.read scopes)
in (_0_284)::_0_283))
in (FStar_ST.write scopes _0_285)))
in (

let pop = (fun uu____573 -> (let _0_286 = (FStar_List.tl (FStar_ST.read scopes))
in (FStar_ST.write scopes _0_286)))
in (
...
let uu___134_673 = x
in (let _0_287 = (FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname)
in {FStar_Syntax_Syntax.ppname = _0_287; FStar_Syntax_Syntax.index = uu___134_673.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___134_673.FStar_Syntax_Syntax.sort})))
...
let print_env : env_t  ->  Prims.string = (fun e -> (let _0_288 = (FStar_All.pipe_right e.bindings (FStar_List.map (fun uu___109_840 -> (match (uu___109_840) with
...
in (let _0_289 = (FStar_SMTEncoding_Util.mkFreeV ((xsym), (s)))
in ((xsym), (_0_289)))))


let gen_term_var : env_t  ->  FStar_Syntax_Syntax.bv  ->  (Prims.string * FStar_SMTEncoding_Term.term * env_t) = (fun env x -> (

let ysym = (let _0_290 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@x" _0_290))
in (
...
| None -> begin
(failwith (let _0_291 = (FStar_Syntax_Print.bv_to_string a)
in (FStar_Util.format1 "Bound term variable not found (after unmangling): %s" _0_291)))
end
| Some (b, t) -> begin
t
end)))
...
in (let _0_296 = (let _0_295 = Binding_fvar ((let _0_294 = (let _0_293 = (FStar_SMTEncoding_Util.mkApp ((ftok), ([])))
in (FStar_All.pipe_left (fun _0_292 -> Some (_0_292)) _0_293))
in ((x), (fname), (_0_294), (None))))
in (_0_295)::env.bindings)
in {bindings = _0_296; depth = uu___139_999.depth; tcenv = uu___139_999.tcenv; warn = uu___139_999.warn; cache = uu___139_999.cache; nolabels = uu___139_999.nolabels; use_zfuel_name = uu___139_999.use_zfuel_name; encode_non_total_function_typ = uu___139_999.encode_non_total_function_typ}))
in ((fname), (ftok), (_0_297))))))
...
let contains_name : env_t  ->  Prims.string  ->  Prims.bool = (fun env s -> (let _0_298 = (lookup_binding env (fun uu___112_1056 -> (match (uu___112_1056) with
...
in (FStar_All.pipe_right _0_298 FStar_Option.isSome)))
...
| None -> begin
(failwith (let _0_299 = (FStar_Syntax_Print.lid_to_string a)
in (FStar_Util.format1 "Name not found: %s" _0_299)))
end
| Some (s) -> begin
s
end)))
...
let t3 = (FStar_SMTEncoding_Util.mkApp (let _0_301 = (let _0_300 = (FStar_SMTEncoding_Util.mkApp (("ZFuel"), ([])))
in (_0_300)::[])
in ((f), (_0_301))))
in (
...
let uu____1198 = (let _0_303 = (let _0_302 = (FStar_SMTEncoding_Term.fv_of_term fuel)
in (FStar_All.pipe_right _0_302 Prims.fst))
in (FStar_Util.starts_with _0_303 "fuel"))
in (match (uu____1198) with
| true -> begin
(let _0_306 = (let _0_305 = (FStar_SMTEncoding_Util.mkFreeV ((name), (FStar_SMTEncoding_Term.Term_sort)))
in (FStar_SMTEncoding_Term.mk_ApplyTF _0_305 fuel))
in (FStar_All.pipe_left (fun _0_304 -> Some (_0_304)) _0_306))
end
| uu____1201 -> begin
Some (t)
end))
...
| None -> begin
(failwith (let _0_307 = (FStar_Syntax_Print.lid_to_string a.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Name not found: %s" _0_307)))
end)))
...
| uu____1406 -> begin
(let _0_308 = (add_fuel ((guard)::[]))
in (FStar_All.pipe_right _0_308 FStar_List.hd))
end)
...
in (FStar_All.pipe_right _0_309 FStar_Option.isNone))
end
| uu____1461 -> begin
false
end)))
...
(let _0_310 = (FStar_TypeChecker_Env.lookup_definition ((FStar_TypeChecker_Env.Eager_unfolding_only)::[]) env.tcenv fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_All.pipe_right _0_310 FStar_Option.isSome))
end
| uu____1538 -> begin
false
end)))
...
let trivial_post : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun t -> (let _0_313 = (let _0_311 = (FStar_Syntax_Syntax.null_binder t)
in (_0_311)::[])
in (let _0_312 = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.true_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Util.abs _0_313 _0_312 None))))


let mk_Apply : FStar_SMTEncoding_Term.term  ->  (Prims.string * FStar_SMTEncoding_Term.sort) Prims.list  ->  FStar_SMTEncoding_Term.term = (fun e vars -> (FStar_All.pipe_right vars (FStar_List.fold_left (fun out var -> (match ((Prims.snd var)) with
| FStar_SMTEncoding_Term.Fuel_sort -> begin
(let _0_314 = (FStar_SMTEncoding_Util.mkFreeV var)
in (FStar_SMTEncoding_Term.mk_ApplyTF out _0_314))
end
| s -> begin
(

let _0_315 = (FStar_SMTEncoding_Util.mkFreeV var)
in (FStar_SMTEncoding_Util.mk_ApplyTT out _0_315))
end)) e)))
...
(FStar_SMTEncoding_Util.mkApp (let _0_317 = (let _0_316 = (FStar_SMTEncoding_Term.boxInt (FStar_SMTEncoding_Util.mkInteger' (FStar_Util.int_of_char c)))
in (_0_316)::[])
in (("FStar.Char.Char"), (_0_317))))
end
...
| c -> begin
(failwith (let _0_318 = (FStar_Syntax_Print.const_to_string c)
in (FStar_Util.format1 "Unhandled constant: %s" _0_318)))
end))
...
(let _0_319 = (FStar_Syntax_Util.unrefine t)
in (aux true _0_319))
end
| uu____1807 -> begin
(match (norm) with
| true -> begin
(let _0_320 = (whnf env t)
in (aux false _0_320))
end
| uu____1808 -> begin
(failwith (let _0_322 = (FStar_Range.string_of_range t0.FStar_Syntax_Syntax.pos)
in (let _0_321 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format2 "(%s) Expected a function typ; got %s" _0_322 _0_321))))
end)
end)))
in (aux true t0)))
...
| uu____1829 -> begin
(let _0_323 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_0_323)))
end)))
...
| true -> begin
(let _0_324 = (FStar_Syntax_Print.binders_to_string ", " bs)
...
let uu____2076 = (let _0_325 = (norm env x.FStar_Syntax_Syntax.sort)
in (encode_term_pred fuel_opt _0_325 env xx))
...
| (t, decls) -> begin
(let _0_326 = (FStar_SMTEncoding_Term.mk_HasTypeWithFuel fuel_opt e t)
in ((_0_326), (decls)))
end)))
and encode_term_pred' : FStar_SMTEncoding_Term.term Prims.option  ->  FStar_Syntax_Syntax.typ  ->  env_t  ->  FStar_SMTEncoding_Term.term  ->  (FStar_SMTEncoding_Term.term * FStar_SMTEncoding_Term.decls_t) = (fun fuel_opt t env e -> (
...
(match (fuel_opt) with
| None -> begin
(let _0_327 = (FStar_SMTEncoding_Term.mk_HasTypeZ e t)
in ((_0_327), (decls)))
end
| Some (f) -> begin
(let _0_328 = (FStar_SMTEncoding_Term.mk_HasTypeFuel f e t)
in ((_0_328), (decls)))
end)
end)))
...
| true -> begin
(let _0_331 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_330 = (FStar_Syntax_Print.tag_of_term t0)
in (let _0_329 = (FStar_Syntax_Print.term_to_string t0)
...
(failwith (let _0_335 = (FStar_All.pipe_left FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos)
in (let _0_334 = (FStar_Syntax_Print.tag_of_term t0)
in (let _0_333 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_332 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" _0_335 _0_334 _0_333 _0_332))))))
end
| FStar_Syntax_Syntax.Tm_bvar (x) -> begin
(failwith (let _0_336 = (FStar_Syntax_Print.bv_to_string x)
in (FStar_Util.format1 "Impossible: locally nameless; got %s" _0_336)))
end
...
(let _0_337 = (lookup_free_var env v.FStar_Syntax_Syntax.fv_name)
in ((_0_337), ([])))
end
...
let fsym = (let _0_339 = (varops.fresh "f")
in ((_0_339), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
| None -> begin
(let _0_340 = (FStar_SMTEncoding_Util.mk_and_l guards)
in ((_0_340), ([])))
end
| Some (pre) -> begin
(
...
| (guard, decls0) -> begin
(let _0_341 = (FStar_SMTEncoding_Util.mk_and_l ((guard)::guards))
in ((_0_341), (decls0)))
end))
end)
...
let t_interp = (FStar_SMTEncoding_Util.mkForall (let _0_342 = (FStar_SMTEncoding_Util.mkImp ((guards), (res_pred)))
in ((((app)::[])::[]), (vars), (_0_342))))
in (

let cvars = (let _0_343 = (FStar_SMTEncoding_Term.free_variables t_interp)
in (FStar_All.pipe_right _0_343 (FStar_List.filter (fun uu____2357 -> (match (uu____2357) with
| (x, uu____2361) -> begin
(x <> (Prims.fst fsym))
end)))))
in (
...
(let _0_345 = (FStar_SMTEncoding_Util.mkApp (let _0_344 = (FStar_All.pipe_right cvars (FStar_List.map FStar_SMTEncoding_Util.mkFreeV))
in ((t'), (_0_344))))
in ((_0_345), ([])))
end
| None -> begin
...
let tsym = (varops.mk_unique (let _0_346 = (FStar_Util.digest_of_string tkey_hash)
in (Prims.strcat "Tm_arrow_" _0_346)))
in (
...
let t = (FStar_SMTEncoding_Util.mkApp (let _0_347 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((tsym), (_0_347))))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_348 = (FStar_SMTEncoding_Util.mkForall ((((t_has_kind)::[])::[]), (cvars), (t_has_kind)))
in ((_0_348), (a_name), (a_name)))))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_352 = (mkForall_fuel (let _0_351 = (FStar_SMTEncoding_Util.mkImp (let _0_350 = (let _0_349 = (FStar_SMTEncoding_Term.mk_PreType f)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _0_349))
in ((f_has_t), (_0_350))))
in ((((f_has_t)::[])::[]), ((fsym)::cvars), (_0_351))))
in ((_0_352), (Some ("pre-typing for functions")), (a_name)))))
in (

let t_interp = (

let a_name = Some ((Prims.strcat "interpretation_" tsym))
in FStar_SMTEncoding_Term.Assume ((let _0_354 = (FStar_SMTEncoding_Util.mkForall (let _0_353 = (FStar_SMTEncoding_Util.mkIff ((f_has_t_z), (t_interp)))
in ((((f_has_t_z)::[])::[]), ((fsym)::cvars), (_0_353))))
...
in FStar_SMTEncoding_Term.Assume ((let _0_355 = (FStar_SMTEncoding_Term.mk_HasType t FStar_SMTEncoding_Term.mk_Term_type)
in ((_0_355), (Some ("Typing for non-total arrows")), (a_name)))))
in (
...
| (b, f) -> begin
(let _0_360 = (Prims.fst (FStar_List.hd b))
in ((_0_360), (f)))
end))
end
| uu____2554 -> begin
...
let encoding = (FStar_SMTEncoding_Util.mkAnd (let _0_361 = (FStar_SMTEncoding_Term.mk_HasTypeWithFuel (Some (fterm)) xtm base_t)
in ((_0_361), (refinement))))
in (

let cvars = (let _0_362 = (FStar_SMTEncoding_Term.free_variables encoding)
in (FStar_All.pipe_right _0_362 (FStar_List.filter (fun uu____2601 -> (match (uu____2601) with
| (y, uu____2605) -> begin
((y <> x) && (y <> fsym))
end)))))
in (
...
(let _0_364 = (FStar_SMTEncoding_Util.mkApp (let _0_363 = (FStar_All.pipe_right cvars (FStar_List.map FStar_SMTEncoding_Util.mkFreeV))
in ((t), (_0_363))))
in ((_0_364), ([])))
end
| None -> begin
...
let tsym = (varops.mk_unique (let _0_365 = (FStar_Util.digest_of_string tkey_hash)
in (Prims.strcat "Tm_refine_" _0_365)))
in (
...
let t = (FStar_SMTEncoding_Util.mkApp (let _0_366 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((tsym), (_0_366))))
in (
...
let t_haseq = FStar_SMTEncoding_Term.Assume ((let _0_368 = (FStar_SMTEncoding_Util.mkForall (let _0_367 = (FStar_SMTEncoding_Util.mkIff ((t_haseq_ref), (t_haseq_base)))
in ((((t_haseq_ref)::[])::[]), (cvars), (_0_367))))
in ((_0_368), (Some ((Prims.strcat "haseq for " tsym))), (Some ((Prims.strcat "haseq" tsym))))))
in (

let t_kinding = FStar_SMTEncoding_Term.Assume ((let _0_369 = (FStar_SMTEncoding_Util.mkForall ((((t_has_kind)::[])::[]), (cvars), (t_has_kind)))
in ((_0_369), (Some ("refinement kinding")), (Some ((Prims.strcat "refinement_kinding_" tsym))))))
in (

let t_interp = FStar_SMTEncoding_Term.Assume ((let _0_372 = (FStar_SMTEncoding_Util.mkForall (let _0_370 = (FStar_SMTEncoding_Util.mkIff ((x_has_t), (encoding)))
in ((((x_has_t)::[])::[]), ((ffv)::(xfv)::cvars), (_0_370))))
in (let _0_371 = Some ((FStar_Syntax_Print.term_to_string t0))
in ((_0_372), (_0_371), (Some ((Prims.strcat "refinement_interpretation_" tsym)))))))
in (
...
let d = FStar_SMTEncoding_Term.Assume ((let _0_375 = Some ((varops.mk_unique (let _0_374 = (let _0_373 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _0_373))
in (FStar_Util.format1 "uvar_typing_%s" _0_374))))
in ((t_has_k), (Some ("Uvar typing")), (_0_375))))
...
let uu____2794 = (let _0_376 = (FStar_Syntax_Subst.compress head).FStar_Syntax_Syntax.n
in ((_0_376), (args_e)))
in (match (uu____2794) with
| (uu____2809, uu____2810) when (head_redex env head) -> begin
(let _0_377 = (whnf env t)
in (encode_term _0_377 env))
end
...
| (v2, decls2) -> begin
(let _0_378 = (FStar_SMTEncoding_Util.mk_LexCons v1 v2)
in ((_0_378), ((FStar_List.append decls1 decls2))))
end))
end))
end
...
let e0 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_380 = (let _0_379 = (FStar_List.hd args_e)
in (_0_379)::[])
in ((head), (_0_380)))))) None head.FStar_Syntax_Syntax.pos)
in (

let e = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_381 = (FStar_List.tl args_e)
in ((e0), (_0_381)))))) None t0.FStar_Syntax_Syntax.pos)
...
| (tm, decls) -> begin
(let _0_382 = (FStar_SMTEncoding_Util.mkApp (("Reify"), ((tm)::[])))
in ((_0_382), (decls)))
end))
end
...
let new_uvar = (fun uu____3480 -> (let _0_394 = (FStar_TypeChecker_Rel.new_uvar FStar_Range.dummyRange [] FStar_Syntax_Util.ktype0)
...
in (FStar_Util.format1 "Losing precision when encoding a function literal: %s" _0_399))
...
| FStar_Syntax_Syntax.Pat_cons (f, args) -> begin
(let _0_422 = (FStar_All.pipe_right args (FStar_List.mapi (fun i uu____4220 -> (match (uu____4220) with
...
let uu____4357 = (let _0_423 = (FStar_Syntax_Util.unmeta p)
in (FStar_All.pipe_right _0_423 FStar_Syntax_Util.head_and_args))
in (match (uu____4357) with
| (head, args) -> begin
(

let uu____4397 = (let _0_424 = (FStar_Syntax_Util.un_uinst head).FStar_Syntax_Syntax.n
in ((_0_424), (args)))
...
let uu____4504 = (let _0_425 = (FStar_Syntax_Util.unmeta t)
in (FStar_All.pipe_right _0_425 FStar_Syntax_Util.head_and_args))
in (match (uu____4504) with
| (head, args) -> begin
(

let uu____4542 = (let _0_426 = (FStar_Syntax_Util.un_uinst head).FStar_Syntax_Syntax.n
in ((_0_426), (args)))
...
let uu____4910 = (let _0_433 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (

let uu____4953 = (let _0_432 = (FStar_All.pipe_right branch (FStar_List.map (fun uu____4977 -> (match (uu____4977) with
| (t, uu____4984) -> begin
(encode_term t (
...
let uu____5075 = (let _0_440 = (FStar_Syntax_Util.unmeta pre)
in (encode_formula _0_440 env))
in (match (uu____5075) with
| (pre, decls'') -> begin
(

let uu____5082 = (let _0_441 = (FStar_Syntax_Util.unmeta post)
...
let const_op = (fun f r uu____5179 -> (let _0_448 = (f r)
in ((_0_448), ([]))))
in (
...
let connectives = (let _0_464 = (let _0_452 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd))
in ((FStar_Syntax_Const.and_lid), (_0_452)))
in (let _0_463 = (let _0_462 = (let _0_453 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr))
in ((FStar_Syntax_Const.or_lid), (_0_453)))
in (let _0_461 = (let _0_460 = (let _0_459 = (let _0_454 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff))
in ((FStar_Syntax_Const.iff_lid), (_0_454)))
in (let _0_458 = (let _0_457 = (let _0_456 = (let _0_455 = (enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot))
...
let uu____5896 = (let _0_469 = (FStar_Syntax_Subst.compress r).FStar_Syntax_Syntax.n
...
let uu____6012 = (let _0_474 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (

let uu____6047 = (let _0_473 = (FStar_All.pipe_right p (FStar_List.map (fun uu____6069 -> (match (uu____6069) with
| (t, uu____6075) -> begin
(encode_term t (
...
let mk = (fun l v -> (let _0_594 = (let _0_593 = (FStar_All.pipe_right prims (FStar_List.find (fun uu____6788 -> (match (uu____6788) with
| (l', uu____6797) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _0_593 (FStar_Option.map (fun uu____6818 -> (match (uu____6818) with
| (uu____6829, b) -> begin
(b v)
end)))))
...
let uu____7978 = ((let _0_760 = (FStar_Syntax_Util.is_pure_or_ghost_function t_norm)
...
let vname_decl = FStar_SMTEncoding_Term.DeclFun ((let _0_773 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____8258 -> FStar_SMTEncoding_Term.Term_sort)))
...
let uu____8534 = (let _0_796 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
...
let extra_formals = (let _0_800 = (FStar_All.pipe_right extra_formals (FStar_List.map (fun uu____8688 -> (match (uu____8688) with
| (x, i) -> begin
(let _0_799 = (

let uu___151_8695 = x
in (let _0_798 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___151_8695.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_8695.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_798}))
in ((_0_799), (i)))
end))))
...
let uu____9353 = (let _0_811 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
...
let uu____10126 = (let _0_858 = (FStar_List.zip3 gtoks typs bindings)
...
let uu____10271 = (let _0_859 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _0_859 (FStar_List.partition (fun uu___124_10284 -> (match (uu___124_10284) with
...
let uu____10380 = (let _0_869 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
...
let uu____10474 = (let _0_872 = (close_effect_params a.FStar_Syntax_Syntax.action_defn)
in (encode_term _0_872 env))
in (match (uu____10474) with
| (tm, decls) -> begin
(

let a_decls = (let _0_874 = FStar_SMTEncoding_Term.DeclFun ((let _0_873 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____10492 -> FStar_SMTEncoding_Term.Term_sort)))
...
let uu____10497 = (let _0_875 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____10529 -> (match (uu____10529) with
...
let uu____10696 = (let _0_889 = (FStar_TypeChecker_Env.try_lookup_val_decl env.tcenv lid)
...
| FStar_Syntax_Syntax.Sig_let (uu____10808, uu____10809, lids, quals, uu____10812) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> (let _0_897 = (FStar_List.hd l.FStar_Ident.ns).FStar_Ident.idText
in (_0_897 = "Prims"))))) && (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___127_10822 -> (match (uu___127_10822) with
...
(let _0_900 = FStar_SMTEncoding_Term.DeclFun ((let _0_899 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in ((name), (_0_899), (FStar_SMTEncoding_Term.Term_sort), (None))))
in (_0_900)::[])
end))
end
| uu____11123 -> begin
...
let uu____11138 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _0_901 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
in (FStar_All.pipe_right _0_901 FStar_Option.isNone)))))
...
| (x, uu____11252) -> begin
(let _0_903 = (FStar_SMTEncoding_Util.mkApp (let _0_902 = (mk_term_projector_name l x)
in ((_0_902), ((xx)::[]))))
in (push_term_var env x _0_903))
end)) env))
in (
...
let eqs = (let _0_905 = (FStar_List.map2 (fun v a -> (FStar_SMTEncoding_Util.mkEq (let _0_904 = (FStar_SMTEncoding_Util.mkFreeV v)
in ((_0_904), (a))))) vars indices)
in (FStar_All.pipe_right _0_905 FStar_SMTEncoding_Util.mk_and_l))
in (let _0_908 = (FStar_SMTEncoding_Util.mkOr (let _0_907 = (FStar_SMTEncoding_Util.mkAnd (let _0_906 = (mk_data_tester env l xx)
in ((_0_906), (eqs))))
in ((out), (_0_907))))
in ((_0_908), ((FStar_List.append decls decls')))));
)
end))))
end))
end))
...
| true -> begin
(let _0_909 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((ff)::[])))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel _0_909 xx tapp))
end
| uu____11300 -> begin
(FStar_SMTEncoding_Term.mk_HasTypeFuel ff xx tapp)
end)
in FStar_SMTEncoding_Term.Assume ((let _0_913 = (FStar_SMTEncoding_Util.mkForall (let _0_911 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (let _0_910 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_sfuel), (data_ax)))
in ((((xx_has_type_sfuel)::[])::[]), (_0_911), (_0_910)))))
in (let _0_912 = Some ((varops.mk_unique (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str)))
in ((_0_913), (Some ("inversion axiom")), (_0_912))))))
in (
...
in (let _0_918 = FStar_SMTEncoding_Term.Assume ((let _0_917 = (FStar_SMTEncoding_Util.mkForall (let _0_915 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (let _0_914 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_fuel), (data_ax)))
in ((((xx_has_type_fuel)::(pattern_guard)::[])::[]), (_0_915), (_0_914)))))
in (let _0_916 = Some ((varops.mk_unique (Prims.strcat "pattern_guarded_inversion_" t.FStar_Ident.str)))
in ((_0_917), (Some ("inversion axiom")), (_0_916)))))
in (_0_918)::[])))
end
| uu____11337 -> begin
[]
...
let tapp = (FStar_SMTEncoding_Util.mkApp (let _0_919 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((tname), (_0_919))))
in (

let uu____11433 = (

let tname_decl = (constructor_or_logic_type_decl (let _0_921 = (FStar_All.pipe_right vars (FStar_List.map (fun uu____11450 -> (match (uu____11450) with
| (n, s) -> begin
(((Prims.strcat tname n)), (s))
end))))
in (let _0_920 = (varops.next_id ())
in ((tname), (_0_921), (FStar_SMTEncoding_Term.Term_sort), (_0_920), (false)))))
in (

let uu____11457 = (match (vars) with
| [] -> begin
(let _0_925 = (let _0_924 = (let _0_923 = (FStar_SMTEncoding_Util.mkApp ((tname), ([])))
in (FStar_All.pipe_left (fun _0_922 -> Some (_0_922)) _0_923))
in (push_free_var env t tname _0_924))
in (([]), (_0_925)))
end
| uu____11467 -> begin
(
...
let ttok_fresh = (let _0_926 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ttok), (FStar_SMTEncoding_Term.Term_sort)) _0_926))
in (
...
let name_tok_corr = FStar_SMTEncoding_Term.Assume ((let _0_928 = (FStar_SMTEncoding_Util.mkForall' (let _0_927 = (FStar_SMTEncoding_Util.mkEq ((ttok_app), (tapp)))
in ((pats), (None), (vars), (_0_927))))
in ((_0_928), (Some ("name-token correspondence")), (Some ((Prims.strcat "token_correspondence_" ttok))))))
...
| true -> begin
(let _0_931 = FStar_SMTEncoding_Term.Assume ((let _0_930 = (let _0_929 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _0_929))
in ((_0_930), (Some ("kinding")), (Some ((Prims.strcat "pre_kinding_" ttok))))))
in (_0_931)::[])
end
| uu____11520 -> begin
[]
end)
in (let _0_936 = (let _0_935 = (let _0_934 = FStar_SMTEncoding_Term.Assume ((let _0_933 = (FStar_SMTEncoding_Util.mkForall (let _0_932 = (FStar_SMTEncoding_Util.mkImp ((guard), (k)))
in ((((tapp)::[])::[]), (vars), (_0_932))))
in ((_0_933), (None), (Some ((Prims.strcat "kinding_" ttok))))))
in (_0_934)::[])
in (FStar_List.append karr _0_935))
in (FStar_List.append decls _0_936)))
end))
in (

let aux = (let _0_940 = (let _0_939 = (inversion_axioms tapp vars)
in (let _0_938 = (let _0_937 = (pretype_axiom tapp vars)
in (_0_937)::[])
in (FStar_List.append _0_939 _0_938)))
in (FStar_List.append kindingAx _0_940))
in (
...
let projectors = (FStar_All.pipe_right names (FStar_List.map (fun x -> (let _0_941 = (mk_term_projector_name d x)
in ((_0_941), (FStar_SMTEncoding_Term.Term_sort))))))
in (

let datacons = (let _0_943 = (let _0_942 = (varops.next_id ())
in ((ddconstrsym), (projectors), (FStar_SMTEncoding_Term.Term_sort), (_0_942), (true)))
in (FStar_All.pipe_right _0_943 FStar_SMTEncoding_Term.constructor_to_decl))
in (
...
| uu____11701 -> begin
(let _0_945 = (let _0_944 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ddtok), (FStar_SMTEncoding_Term.Term_sort)) _0_944))
in (_0_945)::[])
end)
in (
...
let uu____11798 = (let _0_946 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env _0_946))
in (match (uu____11798) with
| (uu____11807, xv, env) -> begin
(let _0_948 = (let _0_947 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (_0_947)::eqns)
in ((env), ((xv)::arg_vars), (_0_948)))
end))
...
let typing_inversion = FStar_SMTEncoding_Term.Assume ((let _0_952 = (FStar_SMTEncoding_Util.mkForall (let _0_951 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (let _0_950 = (FStar_SMTEncoding_Util.mkImp (let _0_949 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append eqns guards))
in ((ty_pred), (_0_949))))
in ((((ty_pred)::[])::[]), (_0_951), (_0_950)))))
in ((_0_952), (Some ("data constructor typing elim")), (Some ((Prims.strcat "data_elim_" ddconstrsym))))))
in (
...
let x = (let _0_953 = (varops.fresh "x")
in ((_0_953), (FStar_SMTEncoding_Term.Term_sort)))
in (

let xtm = (FStar_SMTEncoding_Util.mkFreeV x)
in FStar_SMTEncoding_Term.Assume ((let _0_961 = (FStar_SMTEncoding_Util.mkForall (let _0_959 = (let _0_955 = (let _0_954 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp)
in (_0_954)::[])
in (_0_955)::[])
in (let _0_958 = (FStar_SMTEncoding_Util.mkImp (let _0_957 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (let _0_956 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp)
in ((_0_957), (_0_956)))))
in ((_0_959), ((x)::[]), (_0_958)))))
in (let _0_960 = Some ((varops.mk_unique "lextop"))
in ((_0_961), (Some ("lextop is top")), (_0_960)))))))
end
| uu____11867 -> begin
(
...
(let _0_963 = (let _0_962 = (FStar_SMTEncoding_Util.mkFreeV v)
in (FStar_SMTEncoding_Util.mk_Precedes _0_962 dapp))
in (_0_963)::[])
end
| uu____11878 -> begin
(failwith "unexpected sort")
end))))
in FStar_SMTEncoding_Term.Assume ((let _0_967 = (FStar_SMTEncoding_Util.mkForall (let _0_966 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (let _0_965 = (FStar_SMTEncoding_Util.mkImp (let _0_964 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (_0_964))))
in ((((ty_pred)::[])::[]), (_0_966), (_0_965)))))
in ((_0_967), (Some ("subterm ordering")), (Some ((Prims.strcat "subterm_ordering_" ddconstrsym)))))))
end)
...
| uu____11892 -> begin
((let _0_970 = (let _0_969 = (FStar_Syntax_Print.lid_to_string d)
in (let _0_968 = (FStar_Syntax_Print.term_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _0_969 _0_968)))
in (FStar_Errors.warn drange _0_970));
(([]), ([]));
)
end))
end)))
...
let g = (let _0_991 = (let _0_990 = (let _0_989 = (let _0_988 = (let _0_973 = FStar_SMTEncoding_Term.DeclFun ((let _0_972 = Some ((let _0_971 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" _0_971)))
in ((ddtok), ([]), (FStar_SMTEncoding_Term.Term_sort), (_0_972))))
in (_0_973)::[])
in (let _0_987 = (let _0_986 = (let _0_985 = (let _0_984 = (let _0_983 = (let _0_982 = (let _0_981 = FStar_SMTEncoding_Term.Assume ((let _0_975 = (FStar_SMTEncoding_Util.mkForall (let _0_974 = (FStar_SMTEncoding_Util.mkEq ((app), (dapp)))
in ((((app)::[])::[]), (vars), (_0_974))))
in ((_0_975), (Some ("equality for proxy")), (Some ((Prims.strcat "equality_tok_" ddtok))))))
in (let _0_980 = (let _0_979 = FStar_SMTEncoding_Term.Assume ((let _0_978 = (FStar_SMTEncoding_Util.mkForall (let _0_977 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) vars')
in (let _0_976 = (FStar_SMTEncoding_Util.mkImp ((guard'), (ty_pred')))
in ((((ty_pred')::[])::[]), (_0_977), (_0_976)))))
in ((_0_978), (Some ("data constructor typing intro")), (Some ((Prims.strcat "data_typing_intro_" ddtok))))))
in (_0_979)::[])
in (_0_981)::_0_980))
in (FStar_SMTEncoding_Term.Assume (((tok_typing), (Some ("typing for data constructor proxy")), (Some ((Prims.strcat "typing_tok_" ddtok))))))::_0_982)
in (FStar_List.append _0_983 elim))
in (FStar_List.append decls_pred _0_984))
in (FStar_List.append decls_formals _0_985))
in (FStar_List.append proxy_fresh _0_986))
in (FStar_List.append _0_988 _0_987)))
in (FStar_List.append decls3 _0_989))
in (FStar_List.append decls2 _0_990))
in (FStar_List.append binder_decls _0_991))
...
| true -> begin
(let _0_994 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_993 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_992 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" _0_994 _0_993 _0_992))))
end
| uu____12013 -> begin
()
end));
...
let uu____12024 = (let _0_999 = (let _0_998 = (let _0_997 = (FStar_Util.digest_of_string t_hash)
in (let _0_996 = (let _0_995 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _0_995))
in (Prims.strcat _0_997 _0_996)))
in (Prims.strcat "x_" _0_998))
in (new_term_constant_from_string env x _0_999))
...
| true -> begin
Some ((let _0_1002 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_1001 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_1000 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _0_1002 _0_1001 _0_1000)))))
end
| uu____12040 -> begin
None
end))
...
(let _0_1006 = (FStar_All.pipe_left (fun _0_1003 -> FStar_SMTEncoding_Term.Echo (_0_1003)) (Prims.fst l))
in (let _0_1005 = (let _0_1004 = FStar_SMTEncoding_Term.Eval ((FStar_SMTEncoding_Util.mkFreeV l))
in (_0_1004)::[])
in (_0_1006)::_0_1005))
end))))
in ((prefix), (suffix)))))
...
let init_env : FStar_TypeChecker_Env.env  ->  Prims.unit = (fun tcenv -> (let _0_1009 = (let _0_1008 = (let _0_1007 = (FStar_Util.smap_create (Prims.parse_int "100"))
in {bindings = []; depth = (Prims.parse_int "0"); tcenv = tcenv; warn = true; cache = _0_1007; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_0_1008)::[])
in (FStar_ST.write last_env _0_1009)))
...
| true -> begin
(let _0_1012 = FStar_SMTEncoding_Term.Caption ((let _0_1011 = (let _0_1010 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se) (FStar_List.map FStar_Syntax_Print.lid_to_string))
in (FStar_All.pipe_right _0_1010 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " _0_1011)))
in (_0_1012)::decls)
end
| uu____12347 -> begin
decls
...
| true -> begin
(let _0_1013 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) FStar_Util.string_of_int)
...
in (let _0_1015 = (let _0_1014 = (FStar_Syntax_Syntax.mk_binder (
...
(let _0_1016 = (FStar_Syntax_Util.close_forall (FStar_List.rev closing) q)
in ((_0_1016), (bindings)))
end)))
...
let uu____12504 = (let _0_1017 = (FStar_List.filter (fun uu___132_12507 -> (match (uu___132_12507) with
...
in (encode_env_bindings env _0_1017))
...
| true -> begin
(let _0_1018 = (FStar_Syntax_Print.term_to_string q)
...
let uu____12537 = (let _0_1019 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _0_1019 phi))
...
let qry = FStar_SMTEncoding_Term.Assume ((let _0_1021 = (FStar_SMTEncoding_Util.mkNot phi)
in (let _0_1020 = Some ((varops.mk_unique "@query"))
in ((_0_1021), (Some ("query")), (_0_1020)))))
in (

let suffix = (let _0_1023 = (let _0_1022 = (
...
in (FStar_List.append _0_1022 ((FStar_SMTEncoding_Term.Echo ("Done!"))::[])))
in (FStar_List.append label_suffix _0_1023))
