                               ...
                               (match uu____2891 with
                                | (fsym,fterm) ->
                                    let encoding =
                                      ...
                                      FStar_SMTEncoding_Util.mkAnd uu____2899 in
                                    let cvars =
                                      let uu____2907 =
                                        FStar_SMTEncoding_Term.free_variables
                                          encoding in
                       ...
                       (let e02 =
                        ...
                        let e =
                          ...
                          | uu____3440 ->
                              ...
                              uu____3446 None t0.FStar_Syntax_Syntax.pos in
                        encode_term e env)))
                 | (FStar_Syntax_Syntax.Tm_constant
                                  ...
                                  let uu____3739 =
                                    let uu____3742 =
                                      FStar_TypeChecker_Env.lookup_lid
                                        env.tcenv
                                        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                                    FStar_All.pipe_right uu____3742 Prims.fst in
                                  FStar_All.pipe_right uu____3739 Prims.snd in
                                Some uu____3738
                          ...
                          (match head_type with
                           ...
                           | Some head_type1 ->
                               let head_type2 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____3863 in
                               let uu____3864 =
                  ...
                  | FStar_Util.Inr (eff,uu____3967) ->
                      let uu____3973 =
                        FStar_TypeChecker_Util.is_pure_or_ghost_effect
                          env.tcenv eff in
                      FStar_All.pipe_right uu____3973 Prims.op_Negation in
                        ...
                        let typ =
                          ...
                          FStar_TypeChecker_Env.reify_comp
                            (let uu___145_4019 = env1.tcenv in
                             ...
                             }) uu____4018 FStar_Syntax_Syntax.U_unknown in
                        let uu____4020 =
                          let uu____4021 = FStar_Syntax_Syntax.mk_Total typ in
                       ...
                       (let uu____4119 = encode_binders None bs1 env in
                        ...
                        | (vars,guards,envbody,decls,uu____4134) ->
                            ...
                            (match uu____4141 with
                             | (lc2,body2) ->
                                 let uu____4174 = encode_term body2 envbody in
                                                ...
                                                let fsym =
                                                  let uu____4256 =
                                                    ...
                                                    Prims.strcat "Tm_abs_"
                                                      uu____4257 in
                                                  varops.mk_unique uu____4256 in
                                                let fdecl =
                                                  FStar_SMTEncoding_Term.DeclFun
                                                    (fsym, cvar_sorts,
                                                      FStar_SMTEncoding_Term.Term_sort,
...
and encode_pat:
  ...
  fun env  ->
    fun pat  ->
      ...
      | uu____4699 -> let uu____4700 = encode_one_pat env pat in [uu____4700]
and encode_one_pat: env_t -> FStar_Syntax_Syntax.pat -> (env_t* pattern) =
  fun env  ->
    fun pat  ->
      ...
      (let uu____4715 = FStar_TypeChecker_Util.decorated_pattern_as_term pat in
                                ...
                                fun uu____4980  ->
                                  ...
                                  | (arg,uu____4989) ->
                                      ...
                                      let uu____4999 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee]) in
                                      mk_projections arg uu____4999)) in
                      FStar_All.pipe_right uu____4958 FStar_List.flatten in
        ...
        fun env  ->
          ...
          let one_pat p =
            let uu____5125 =
              ...
              FStar_All.pipe_right uu____5135 FStar_Syntax_Util.head_and_args in
            ...
            | (head1,args) ->
                ...
                (match uu____5166 with
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____5223)::[]) when
                     ...
                     -> (e, None)
                 | uu____5244 -> failwith "Unexpected pattern term") in
          let lemma_pats p =
                   ...
                   (match uu____5717 with
                    | (pats,decls') ->
                        ...
                        (match uu____5898 with
                         | (pre1,decls'') ->
                             let uu____5906 =
                               let uu____5909 = FStar_Syntax_Util.unmeta post in
    ...
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            ...
            (uu____5999, decls) in
      let const_op f r uu____6019 = let uu____6022 = f r in (uu____6022, []) in
      let un_op f l =
        let uu____6038 = FStar_List.hd l in FStar_All.pipe_left f uu____6038 in
      ...
      let connectives =
        let uu____6392 =
          let uu____6401 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd) in
          (FStar_Syntax_Const.and_lid, uu____6401) in
        let uu____6414 =
          let uu____6424 =
            let uu____6433 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr) in
                  ...
                  (FStar_List.map
                     (fun p  ->
                        let uu____7030 =
                          ...
                          FStar_All.pipe_right uu____7035 FStar_List.unzip in
               ...
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      ...
                      FStar_Util.set_union out uu____7189) uu____7183 tl1 in
             let uu____7191 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
                    (fun uu____7203  ->
              ...
              | Some (x,uu____7212) ->
                  ...
                  let uu____7222 =
                    ...
                    FStar_Util.format1
                      ...
                      uu____7223 in
                  FStar_Errors.warn pos uu____7222) in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____7266  ->
                     ...
                     | (l,uu____7276) -> FStar_Ident.lid_equals op l)) in
...
let prims: prims_t =
  ...
  | (asym,a) ->
      ...
      (match uu____7458 with
       | (xsym,x) ->
           let uu____7463 = fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort in
            ...
            | (ysym,y) ->
                ...
                let prims1 =
                  let uu____7616 =
                    let uu____7624 =
                      let uu____7630 =
                        let uu____7631 = FStar_SMTEncoding_Util.mkEq (x, y) in
                      ...
                      let uu____7677 =
                        let uu____7685 =
                          let uu____7691 =
                            ...
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool uu____7692 in
                        ...
                        let uu____7712 =
                          let uu____7720 =
                            let uu____7726 =
                              ...
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool uu____7727 in
                              ...
                              let uu____7790 =
                                let uu____7796 =
                                  let uu____7797 =
                                    ...
                                    FStar_SMTEncoding_Util.mkGTE uu____7798 in
                                  FStar_All.pipe_left
                            ...
                            let uu____7808 =
                                ...
                                let uu____7825 =
                                  let uu____7831 =
                                    let uu____7832 =
                                      ...
                                      FStar_SMTEncoding_Util.mkSub uu____7833 in
                                    FStar_All.pipe_left
                              ...
                              let uu____7843 =
                                let uu____7852 =
                                  ...
                                  (FStar_Syntax_Const.op_Minus, uu____7860) in
                                let uu____7874 =
                                  let uu____7883 =
                                    let uu____7891 =
                                      let uu____7897 =
                ...
                let mk1 l v1 =
                  let uu____8237 =
                    ...
                    FStar_All.pipe_right uu____8242
                      (FStar_Option.map
                         (fun uu____8316  ->
                            match uu____8316 with | (uu____8327,b) -> b v1)) in
                  ...
                  FStar_All.pipe_right prims1
                    (FStar_Util.for_some
                       (fun uu____8368  ->
                          ...
                          | (l',uu____8377) -> FStar_Ident.lid_equals l l')) in
                { mk = mk1; is }))
let pretype_axiom:
  FStar_SMTEncoding_Term.term ->
    (Prims.string* FStar_SMTEncoding_Term.sort) Prims.list ->
  ...
  fun tapp  ->
    fun vars  ->
      ...
      | (xxsym,xx) ->
          let uu____8405 = fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort in
          (match uu____8405 with
           | (ffsym,ff) ->
               ...
               let uu____8412 =
                 ...
                 let uu____8444 =
                   let uu____8445 =
                     let uu____8446 = FStar_Util.digest_of_string tapp_hash in
...
let primitive_type_axioms:
  ...
  let mk_ref1 env reft_name uu____8843 =
    ...
    let refa =
      let uu____8854 =
        let uu____8858 =
          let uu____8860 = FStar_SMTEncoding_Util.mkFreeV aa in [uu____8860] in
        (reft_name, uu____8858) in
      FStar_SMTEncoding_Util.mkApp uu____8854 in
    let refb =
      let uu____8863 =
        let uu____8867 =
          let uu____8869 = FStar_SMTEncoding_Util.mkFreeV bb in [uu____8869] in
      ...
      let uu____8874 =
        let uu____8878 =
          let uu____8879 =
            let uu____8885 =
              let uu____8886 =
                let uu____8889 = FStar_SMTEncoding_Term.mk_tester "BoxRef" x in
    ...
    let uu____8904 =
      let uu____8906 =
        let uu____8907 =
          ...
          (uu____8911, (Some "ref typing is injective"), "ref_injectivity") in
  ...
  let mk_eq2_interp env eq2 tt =
    ...
    let valid =
      let uu____9126 =
        let uu____9130 =
          let uu____9132 = FStar_SMTEncoding_Util.mkApp (eq2, [a; x1; y1]) in
          [uu____9132] in
        ("Valid", uu____9130) in
  ...
  let mk_eq3_interp env eq3 tt =
    ...
    let valid =
      let uu____9195 =
        let uu____9199 =
          let uu____9201 = FStar_SMTEncoding_Util.mkApp (eq3, [a; b; x1; y1]) in
          [uu____9201] in
        ("Valid", uu____9199) in
  ...
  let mk_forall_interp env for_all1 tt =
    ...
    let valid =
      let uu____9440 =
        let uu____9444 =
          let uu____9446 = FStar_SMTEncoding_Util.mkApp (for_all1, [a; b]) in
          [uu____9446] in
        ("Valid", uu____9444) in
  ...
  let mk_exists_interp env for_some1 tt =
    ...
    let valid =
      let uu____9540 =
        let uu____9544 =
          let uu____9546 = FStar_SMTEncoding_Util.mkApp (for_some1, [a; b]) in
          [uu____9546] in
        ("Valid", uu____9544) in
          ...
          let uu____9897 =
            FStar_Util.find_opt
              (fun uu____9915  ->
                 ...
                 | (l,uu____9925) -> FStar_Ident.lid_equals l t) prims1 in
      ...
      fun tt  ->
        fun t_norm  ->
          fun quals  ->
            ...
            if uu____10016
            then
              let uu____10021 = new_term_constant_and_tok_from_lid env lid in
              match uu____10021 with
              | (vname,vtok,env1) ->
                  let arg_sorts =
                    let uu____10033 =
                      let uu____10034 = FStar_Syntax_Subst.compress t_norm in
                                     ...
                                     | FStar_Syntax_Syntax.Projector 
                                         ...
                                         (match uu____10232 with
                                          | (uu____10243,(xxsym,uu____10245))
                                              ...
                                              [uu____10259])
                                     | uu____10280 -> [])) in
                           let uu____10281 = encode_binders None formals env1 in
                            ...
                            | (vars,guards,env',decls1,uu____10297) ->
                                let uu____10304 =
                                  ...
                                  | None  ->
                                      ...
                                      (uu____10309, decls1)
                                  | Some p ->
                                      let uu____10311 = encode_formula p env' in
            ...
            let eta_expand1 binders formals body t =
              ...
              | (formals1,extra_formals) ->
                  ...
                  let body1 =
                    let uu____10914 =
                      let uu____10916 =
                        let uu____10917 = FStar_Syntax_Subst.subst subst1 t in
                                   ...
                                   (match uu____11401 with
                                    | (binders1,body1) ->
                                        ((binders1, body1, formals1, tres),
                                          false)))
                          | uu____11449 -> (([], e, [], t_norm1), false))) in
              aux false t_norm in
            (try
               let uu____11477 =
                 FStar_All.pipe_right bindings
                        ...
                        | uu____11727 ->
                            ...
                            then
                              ...
                              (let uu____11734 =
                                 ...
                                 (f, uu____11738) in
                               FStar_SMTEncoding_Util.mkApp uu____11734) in
                      let uu____11743 =
                        (FStar_All.pipe_right quals
                           (FStar_Util.for_some
                              (fun uu___125_11745  ->
                               ...
                               (match uu____11813 with
                                | (univ_subst,univ_vars1) ->
                                    ...
                                    let e1 =
                                      ...
                                      FStar_Syntax_Subst.compress uu____11832 in
                                    let uu____11833 =
                                                    ...
                                                    let uu____11937 =
                                                      let uu____11939 =
                                                        ...
                                                        FStar_List.append
                                                          ...
                                                          uu____11941 in
                                                      FStar_List.append
                                                        decls1 uu____11939 in
                                                    (uu____11937, env1))))))
                           | uu____11948 -> failwith "Impossible")
                        else
                          (let fuel =
                             let uu____11967 = varops.fresh "fuel" in
                             (uu____11967, FStar_SMTEncoding_Term.Fuel_sort) in
  ...
  fun env  ->
    fun se  ->
      ...
      (let nm =
         ...
         match uu____12821 with | None  -> "" | Some l -> l.FStar_Ident.str in
       ...
       | (g,e) ->
           (match g with
            | [] ->
                let uu____12833 =
                  let uu____12835 =
                    let uu____12836 = FStar_Util.format1 "<Skipped %s/>" nm in
                   ...
                   let uu____12887 =
                     let uu____12890 =
                       let uu____12891 =
                         ...
                         ((ed.FStar_Syntax_Syntax.binders), tm, uu____12906) in
                       FStar_Syntax_Syntax.Tm_abs uu____12891 in
                     FStar_Syntax_Syntax.mk uu____12890 in
                   uu____12887 None tm.FStar_Syntax_Syntax.pos in
                             ...
                             let uu____13019 =
                               let aux uu____13048 uu____13049 =
                                 ...
                                 | ((bv,uu____13076),(env3,acc_sorts,acc)) ->
                                     let uu____13097 = gen_term_var env3 bv in
                             ...
                             (match uu____13019 with
                              | (uu____13135,xs_sorts,xs) ->
                                      ...
                                      let uu____13153 =
                                        let uu____13154 =
                                          let uu____13160 =
                                            ...
                                            FStar_SMTEncoding_Util.mkEq
                                              uu____13161 in
                                          ([[app]], xs_sorts, uu____13160) in
                                        FStar_SMTEncoding_Util.mkForall
                                          uu____13154 in
                                      (uu____13153, (Some "Action equality"),
                                        (Prims.strcat aname "_equality")) in
                                    FStar_SMTEncoding_Term.Assume uu____13149 in
                                  let tok_correspondence =
                                    ...
                                    FStar_SMTEncoding_Term.Assume uu____13176 in
                                  (env2,
                                    (FStar_List.append decls
               ...
               let g =
                 let uu____13277 =
                   let uu____13278 =
                     let uu____13282 =
                       let uu____13284 =
                         let uu____13285 = FStar_Syntax_Print.lid_to_string l in
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____13643  ->
                                ...
                                | (uu____13647,sort,uu____13649) -> sort)) in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____13670 FStar_Option.isNone)) in
            if uu____13667
            then []
            else
              (let uu____13687 =
                                 ...
                                 let uu____13904 =
                                   let uu____13905 =
                                     ...
                                     (uu____13909, (Some "inversion axiom"),
                                       uu____13932) in
                                   FStar_SMTEncoding_Term.Assume uu____13905 in
                                 [uu____13904]
                               else [] in
                             FStar_List.append decls
                              ...
                              let uu____14039 =
                                let tname_decl =
                                  let uu____14045 =
                                    ...
                                    (tname, uu____14046,
                                      FStar_SMTEncoding_Term.Term_sort,
                                      uu____14069, false) in
                                  constructor_or_logic_type_decl uu____14045 in
                                let uu____14074 =
                                  match vars with
                                  | [] ->
                                      let uu____14081 =
                                      ...
                                      let ttok_decl =
                                        FStar_SMTEncoding_Term.DeclFun
                                          (ttok, [],
                                            ...
                                            (Some "token")) in
                                      let ttok_fresh =
                                        let uu____14094 = varops.next_id () in
                                        FStar_SMTEncoding_Term.fresh_token
                                          (ttok,
                                            FStar_SMTEncoding_Term.Term_sort)
                                          uu____14094 in
                                           ...
                                           let uu____14164 =
                                             let uu____14166 =
                                               ...
                                               FStar_SMTEncoding_Term.Assume
                                                 uu____14167 in
                                             [uu____14166] in
                                           FStar_List.append karr uu____14164 in
                                         FStar_List.append decls1 uu____14162 in
                                   let aux =
                                     let uu____14187 =
                                       let uu____14189 =
                                       ...
                                       FStar_List.append uu____14189
                                         uu____14191 in
                                     FStar_List.append kindingAx uu____14187 in
                                   let g =
                                     FStar_List.append decls
                                                    ...
                                                    | uu____14697 ->
                                                        ((let uu____14699 =
                                                          ...
                                                          FStar_Errors.warn
                                                            ...
                                                            uu____14699);
                                                         ([], []))) in
                                             let uu____14704 = encode_elim () in
                                                      ...
                                                      let uu____14718 =
                                                        let uu____14720 =
                                                          ...
                                                          FStar_List.append
                                                            ...
                                                            uu____14737 in
                                                        FStar_List.append
                                                          decls3 uu____14720 in
                                                      FStar_List.append
                                                        decls2 uu____14718 in
                                                    FStar_List.append
                                                      binder_decls
                                                      uu____14716 in
                                                  ((FStar_List.append
                 ...
                 ((let uu____14880 =
                   ...
                   then
                     ...
                     let uu____14882 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort in
                     let uu____14883 = FStar_Syntax_Print.term_to_string t1 in
                        ...
                        | (xxsym,xx,env') ->
                            let t2 =
                              FStar_SMTEncoding_Term.mk_HasTypeWithFuel None
                                xx t in
                            let caption =
                              let uu____14912 = FStar_Options.log_queries () in
                              if uu____14912
                              then
                                let uu____14914 =
                                  let uu____14915 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____14915 uu____14916 uu____14917 in
                                Some uu____14914
                              else None in
                            let ax =
...
let reset_mark_env: Prims.unit -> Prims.unit = fun uu____15172  -> pop_env ()
          ...
          let uu____15235 =
            let uu____15236 =
              let uu____15237 =
                ...
                FStar_All.pipe_right uu____15238 (FStar_String.concat ", ") in
...
let encode_modul:
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let uu____15262 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low in
       if uu____15262
       then
         let uu____15263 =
           FStar_All.pipe_right
             ...
             (match uu____15420 with
              | (env_decls,env1) ->
                  ((let uu____15441 =
                    ...
                    if uu____15441
                    then
                      let uu____15442 = FStar_Syntax_Print.term_to_string q1 in
                    ...
                    | (phi,qdecls) ->
                        let uu____15456 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____15459 phi in
                                  ...
                                  let qry =
                                    let uu____15490 =
                                      ...
                                      (uu____15494, (Some "query"),
                                        uu____15495) in
                                    FStar_SMTEncoding_Term.Assume uu____15490 in
                                  let suffix =
                                    let uu____15499 =
                                      let uu____15501 =
                                        let uu____15503 =
