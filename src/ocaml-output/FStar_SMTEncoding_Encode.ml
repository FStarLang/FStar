...
| FStar_Syntax_Syntax.Sig_new_effect (ed, uu____12979) -> begin
(

let uu____12980 = (

let uu____12981 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right uu____12981 Prims.op_Negation))
...
let uu____13021 = (FStar_All.pipe_left (fun _0_37 -> Some (_0_37)) (FStar_Util.Inr (((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[])))))
in ((ed.FStar_Syntax_Syntax.binders), (tm), (uu____13021)))
in FStar_Syntax_Syntax.Tm_abs (uu____13006))
in (FStar_Syntax_Syntax.mk uu____13005))
in (uu____13002 None tm.FStar_Syntax_Syntax.pos))
end))
in (

let encode_action = (fun env1 a -> (

let uu____13074 = (new_term_constant_and_tok_from_lid env1 a.FStar_Syntax_Syntax.action_name)
in (match (uu____13074) with
| (aname, atok, env2) -> begin
(

let uu____13084 = (FStar_Syntax_Util.arrow_formals_comp a.FStar_Syntax_Syntax.action_typ)
in (match (uu____13084) with
| (formals, uu____13094) -> begin
(

let uu____13101 = (

let uu____13104 = (close_effect_params a.FStar_Syntax_Syntax.action_defn)
in (encode_term uu____13104 env2))
...
let uu____13119 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____13127 -> FStar_SMTEncoding_Term.Term_sort)))
in ((aname), (uu____13119), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action"))))
in FStar_SMTEncoding_Term.DeclFun (uu____13113))
in (uu____13112)::(FStar_SMTEncoding_Term.DeclFun (((atok), ([]), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action token")))))::[])
in (

let uu____13134 = (

let aux = (fun uu____13163 uu____13164 -> (match (((uu____13163), (uu____13164))) with
| ((bv, uu____13191), (env3, acc_sorts, acc)) -> begin
(

let uu____13212 = (gen_term_var env3 bv)
...
let uu____13280 = (mk_Apply tm xs_sorts)
in ((app), (uu____13280)))
in (FStar_SMTEncoding_Util.mkEq uu____13277))
in ((((app)::[])::[]), (xs_sorts), (uu____13276)))
in (FStar_SMTEncoding_Util.mkForall uu____13270))
in ((uu____13269), (Some ("Action equality")), (Some ((Prims.strcat aname "_equality")))))
...
let uu____13305 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (app)))
in ((((tok_app)::[])::[]), (xs_sorts), (uu____13305)))
in (FStar_SMTEncoding_Util.mkForall uu____13299))
in ((uu____13298), (Some ("Action token correspondence")), (Some ((Prims.strcat aname "_token_correspondence")))))
in FStar_SMTEncoding_Term.Assume (uu____13293))))
...
let uu____13316 = (FStar_Util.fold_map encode_action env ed.FStar_Syntax_Syntax.actions)
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____13332, uu____13333, uu____13334, uu____13335) when (FStar_Ident.lid_equals lid FStar_Syntax_Const.precedes_lid) -> begin
(
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____13349, t, quals, uu____13352) -> begin
(

let will_encode_definition = (

let uu____13356 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___127_13358 -> (match (uu___127_13358) with
...
let uu____13367 = (encode_top_level_val env fv t quals)
...
let uu____13381 = (primitive_type_axioms env1.tcenv lid tname tsym)
in (FStar_List.append decls uu____13381))
in ((uu____13379), (env1)))))
end)))
end))
end
| FStar_Syntax_Syntax.Sig_assume (l, f, uu____13386, uu____13387) -> begin
(

let uu____13390 = (encode_formula f env)
...
let uu____13408 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Assumption: %s" uu____13408))
in Some (uu____13407))
in (

let uu____13409 = (

let uu____13411 = (varops.mk_unique (Prims.strcat "assumption_" l.FStar_Ident.str))
in Some (uu____13411))
in ((f1), (uu____13405), (uu____13409))))
in FStar_SMTEncoding_Term.Assume (uu____13400))
in (uu____13399)::[])
in (((FStar_List.append decls g)), (env)))
end))
end
| FStar_Syntax_Syntax.Sig_let (lbs, r, uu____13417, quals, uu____13419) when (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Irreducible)) -> begin
(

let uu____13427 = (FStar_Util.fold_map (fun env1 lb -> (

let lid = (

let uu____13434 = (

let uu____13439 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____13439.FStar_Syntax_Syntax.fv_name)
in uu____13434.FStar_Syntax_Syntax.v)
in (

let uu____13443 = (

let uu____13444 = (FStar_TypeChecker_Env.try_lookup_val_decl env1.tcenv lid)
in (FStar_All.pipe_left FStar_Option.isNone uu____13444))
...
let uu____13463 = (encode_sigelt' env1 val_decl)
...
| FStar_Syntax_Syntax.Sig_let ((uu____13480, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (b2t1); FStar_Syntax_Syntax.lbunivs = uu____13482; FStar_Syntax_Syntax.lbtyp = uu____13483; FStar_Syntax_Syntax.lbeff = uu____13484; FStar_Syntax_Syntax.lbdef = uu____13485})::[]), uu____13486, uu____13487, uu____13488, uu____13489) when (FStar_Syntax_Syntax.fv_eq_lid b2t1 FStar_Syntax_Const.b2t_lid) -> begin
(

let uu____13505 = (new_term_constant_and_tok_from_lid env b2t1.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu____13529 = (FStar_SMTEncoding_Util.mkApp (("Prims.b2t"), ((x)::[])))
in (uu____13529)::[])
in (("Valid"), (uu____13527)))
in (FStar_SMTEncoding_Util.mkApp uu____13523))
in (
...
let uu____13553 = (FStar_SMTEncoding_Util.mkApp (("BoxBool_proj_0"), ((x)::[])))
in ((valid_b2t_x), (uu____13553)))
in (FStar_SMTEncoding_Util.mkEq uu____13550))
in ((((valid_b2t_x)::[])::[]), ((xx)::[]), (uu____13549)))
in (FStar_SMTEncoding_Util.mkForall uu____13543))
in ((uu____13542), (Some ("b2t def")), (Some ("b2t_def"))))
in FStar_SMTEncoding_Term.Assume (uu____13537))
in (uu____13536)::[])
in (FStar_SMTEncoding_Term.DeclFun (((tname), ((FStar_SMTEncoding_Term.Term_sort)::[]), (FStar_SMTEncoding_Term.Term_sort), (None))))::uu____13534)
in ((decls), (env1))))))
end))
end
| FStar_Syntax_Syntax.Sig_let (uu____13571, uu____13572, uu____13573, quals, uu____13575) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___128_13583 -> (match (uu___128_13583) with
| FStar_Syntax_Syntax.Discriminator (uu____13584) -> begin
true
end
| uu____13585 -> begin
false
...
| FStar_Syntax_Syntax.Sig_let (uu____13587, uu____13588, lids, quals, uu____13591) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> (

let uu____13600 = (

let uu____13601 = (FStar_List.hd l.FStar_Ident.ns)
in uu____13601.FStar_Ident.idText)
in (uu____13600 = "Prims"))))) && (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___129_13603 -> (match (uu___129_13603) with
...
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____13607, uu____13608, quals, uu____13610) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___130_13622 -> (match (uu___130_13622) with
| FStar_Syntax_Syntax.Projector (uu____13623) -> begin
true
end
| uu____13626 -> begin
false
...
let uu____13633 = (try_lookup_free_var env l)
in (match (uu____13633) with
| Some (uu____13637) -> begin
(([]), (env))
end
| None -> begin
(

let se1 = FStar_Syntax_Syntax.Sig_declare_typ (((l), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp), (quals), ((FStar_Ident.range_of_lid l))))
in (encode_sigelt env se1))
end))))
end
| FStar_Syntax_Syntax.Sig_let ((is_rec, bindings), uu____13646, uu____13647, quals, uu____13649) -> begin
(encode_top_level_let env ((is_rec), (bindings)) quals)
end
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____13663, uu____13664, uu____13665) -> begin
(

let uu____13672 = (encode_signature env ses)
in (match (uu____13672) with
| (g, env1) -> begin
(

let uu____13682 = (FStar_All.pipe_right g (FStar_List.partition (fun uu___131_13692 -> (match (uu___131_13692) with
| FStar_SMTEncoding_Term.Assume (uu____13693, Some ("inversion axiom"), uu____13694) -> begin
false
end
| uu____13698 -> begin
true
...
let uu____13707 = (FStar_All.pipe_right g' (FStar_List.partition (fun uu___132_13717 -> (match (uu___132_13717) with
| FStar_SMTEncoding_Term.DeclFun (uu____13718) -> begin
true
end
| uu____13724 -> begin
false
...
| FStar_Syntax_Syntax.Sig_inductive_typ (t, uu____13735, tps, k, uu____13738, datas, quals, uu____13741) -> begin
(

let is_logical = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___133_13750 -> (match (uu___133_13750) with
...
| (name, args, uu____13762, uu____13763, uu____13764) -> begin
(
...
let uu____13774 = (FStar_All.pipe_right args (FStar_List.map (fun uu____13781 -> (match (uu____13781) with
| (uu____13785, sort, uu____13787) -> begin
sort
end))))
in ((name), (uu____13774), (FStar_SMTEncoding_Term.Term_sort), (None)))
in FStar_SMTEncoding_Term.DeclFun (uu____13768))
in (uu____13767)::[])
end))
end
| uu____13790 -> begin
...
let uu____13805 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (

let uu____13808 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
in (FStar_All.pipe_right uu____13808 FStar_Option.isNone)))))
...
let uu____13825 = (fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (uu____13825) with
| (xxsym, xx) -> begin
(

let uu____13831 = (FStar_All.pipe_right datas (FStar_List.fold_left (fun uu____13842 l -> (match (uu____13842) with
| (out, decls) -> begin
(

let uu____13854 = (FStar_TypeChecker_Env.lookup_datacon env.tcenv l)
in (match (uu____13854) with
| (uu____13860, data_t) -> begin
(

let uu____13862 = (FStar_Syntax_Util.arrow_formals data_t)
...
let uu____13892 = (FStar_Syntax_Subst.compress res)
in uu____13892.FStar_Syntax_Syntax.n)
in (match (uu____13891) with
| FStar_Syntax_Syntax.Tm_app (uu____13900, indices) -> begin
indices
end
| uu____13916 -> begin
[]
...
let env1 = (FStar_All.pipe_right args (FStar_List.fold_left (fun env1 uu____13928 -> (match (uu____13928) with
| (x, uu____13932) -> begin
(
...
let uu____13938 = (mk_term_projector_name l x)
in ((uu____13938), ((xx)::[])))
in (FStar_SMTEncoding_Util.mkApp uu____13934))
in (push_term_var env1 x uu____13933))
end)) env))
in (

let uu____13940 = (encode_args indices env1)
in (match (uu____13940) with
...
let uu____13960 = (FStar_List.map2 (fun v1 a -> (

let uu____13968 = (

let uu____13971 = (FStar_SMTEncoding_Util.mkFreeV v1)
in ((uu____13971), (a)))
in (FStar_SMTEncoding_Util.mkEq uu____13968))) vars indices1)
in (FStar_All.pipe_right uu____13960 FStar_SMTEncoding_Util.mk_and_l))
in (
...
let uu____13981 = (mk_data_tester env1 l xx)
in ((uu____13981), (eqs)))
in (FStar_SMTEncoding_Util.mkAnd uu____13978))
in ((out), (uu____13977)))
in (FStar_SMTEncoding_Util.mkOr uu____13974))
in ((uu____13973), ((FStar_List.append decls decls')))));
)
end))))
end))
end))
...
let uu____13989 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
in (match (uu____13989) with
| (ffsym, ff) -> begin
(
...
let uu____14000 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((ff)::[])))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel uu____14000 xx tapp))
end
| uu____14002 -> begin
...
let uu____14015 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (

let uu____14023 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_sfuel), (data_ax)))
in ((((xx_has_type_sfuel)::[])::[]), (uu____14015), (uu____14023))))
in (FStar_SMTEncoding_Util.mkForall uu____14009))
in (

let uu____14031 = (

let uu____14033 = (varops.mk_unique (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str))
in Some (uu____14033))
in ((uu____14008), (Some ("inversion axiom")), (uu____14031))))
in FStar_SMTEncoding_Term.Assume (uu____14003)))
in (

let pattern_guarded_inversion = (

let uu____14038 = ((contains_name env "Prims.inversion") && ((FStar_List.length datas) > (Prims.parse_int "1")))
...
let uu____14059 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (

let uu____14067 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_fuel), (data_ax)))
in ((((xx_has_type_fuel)::(pattern_guard)::[])::[]), (uu____14059), (uu____14067))))
in (FStar_SMTEncoding_Util.mkForall uu____14053))
in (

let uu____14075 = (

let uu____14077 = (varops.mk_unique (Prims.strcat "pattern_guarded_inversion_" t.FStar_Ident.str))
in Some (uu____14077))
in ((uu____14052), (Some ("inversion axiom")), (uu____14075))))
in FStar_SMTEncoding_Term.Assume (uu____14047))
in (uu____14046)::[])))
end
| uu____14080 -> begin
[]
...
let uu____14090 = (FStar_Syntax_Subst.compress k)
in uu____14090.FStar_Syntax_Syntax.n)
...
let uu____14134 = (FStar_Syntax_Subst.open_term formals res)
in (match (uu____14134) with
| (formals1, res1) -> begin
(

let uu____14141 = (encode_binders None formals1 env)
in (match (uu____14141) with
| (vars, guards, env', binder_decls, uu____14156) -> begin
(

let uu____14163 = (new_term_constant_and_tok_from_lid env t)
...
let uu____14180 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((tname), (uu____14180)))
in (FStar_SMTEncoding_Util.mkApp uu____14176))
in (
...
let uu____14192 = (FStar_All.pipe_right vars (FStar_List.map (fun uu____14207 -> (match (uu____14207) with
| (n1, s) -> begin
(((Prims.strcat tname n1)), (s), (false))
end))))
in (

let uu____14215 = (varops.next_id ())
in ((tname), (uu____14192), (FStar_SMTEncoding_Term.Term_sort), (uu____14215), (false))))
in (constructor_or_logic_type_decl uu____14191))
in (

let uu____14220 = (match (vars) with
| [] -> begin
(
...
let uu____14230 = (FStar_SMTEncoding_Util.mkApp ((tname), ([])))
in (FStar_All.pipe_left (fun _0_38 -> Some (_0_38)) uu____14230))
in (push_free_var env1 t tname uu____14228))
in (([]), (uu____14227)))
end
| uu____14234 -> begin
(
...
let uu____14240 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ttok), (FStar_SMTEncoding_Term.Term_sort)) uu____14240))
in (
...
let uu____14263 = (FStar_SMTEncoding_Util.mkEq ((ttok_app), (tapp)))
in ((pats), (None), (vars), (uu____14263)))
in (FStar_SMTEncoding_Util.mkForall' uu____14255))
in ((uu____14254), (Some ("name-token correspondence")), (Some ((Prims.strcat "token_correspondence_" ttok)))))
in FStar_SMTEncoding_Term.Assume (uu____14249))
...
let uu____14287 = (encode_term_pred None res1 env' tapp)
...
let uu____14308 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" uu____14308))
in ((uu____14307), (Some ("kinding")), (Some ((Prims.strcat "pre_kinding_" ttok)))))
in FStar_SMTEncoding_Term.Assume (uu____14302))
in (uu____14301)::[])
end
| uu____14311 -> begin
[]
...
let uu____14329 = (FStar_SMTEncoding_Util.mkImp ((guard), (k1)))
in ((((tapp)::[])::[]), (vars), (uu____14329)))
in (FStar_SMTEncoding_Util.mkForall uu____14323))
in ((uu____14322), (None), (Some ((Prims.strcat "kinding_" ttok)))))
in FStar_SMTEncoding_Term.Assume (uu____14317))
in (uu____14316)::[])
in (FStar_List.append karr uu____14314))
in (FStar_List.append decls1 uu____14312)))
end))
in (
...
let uu____14341 = (inversion_axioms tapp vars)
in (

let uu____14343 = (

let uu____14345 = (pretype_axiom tapp vars)
in (uu____14345)::[])
in (FStar_List.append uu____14341 uu____14343)))
in (FStar_List.append kindingAx uu____14339))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (d, uu____14350, uu____14351, uu____14352, uu____14353, uu____14354, uu____14355, uu____14356) when (FStar_Ident.lid_equals d FStar_Syntax_Const.lexcons_lid) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_datacon (d, uu____14363, t, uu____14365, n_tps, quals, uu____14368, drange) -> begin
(

let uu____14374 = (new_term_constant_and_tok_from_lid env d)
...
let uu____14385 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____14385) with
| (formals, t_res) -> begin
(

let uu____14407 = (fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
...
let uu____14416 = (encode_binders (Some (fuel_tm)) formals env1)
...
let uu____14454 = (mk_term_projector_name d x)
in ((uu____14454), (FStar_SMTEncoding_Term.Term_sort), (projectible)))))))
in (
...
let uu____14466 = (varops.next_id ())
in ((ddconstrsym), (fields), (FStar_SMTEncoding_Term.Term_sort), (uu____14466), (true)))
in (FStar_All.pipe_right uu____14456 FStar_SMTEncoding_Term.constructor_to_decl))
in (
...
let uu____14488 = (encode_term_pred None t env1 ddtok_tm)
in (match (uu____14488) with
| (tok_typing, decls3) -> begin
(

let uu____14495 = (encode_binders (Some (fuel_tm)) formals env1)
in (match (uu____14495) with
| (vars', guards', env'', decls_formals, uu____14510) -> begin
(
...
let uu____14541 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ddtok), (FStar_SMTEncoding_Term.Term_sort)) uu____14541))
in (uu____14540)::[])
end)
in (

let encode_elim = (fun uu____14548 -> (

let uu____14549 = (FStar_Syntax_Util.head_and_args t_res)
...
let uu____14579 = (FStar_Syntax_Subst.compress head1)
...
let uu____14597 = (encode_args args env')
...
let uu____14632 = (FStar_SMTEncoding_Term.free_variables g)
in (FStar_List.contains fv1 uu____14632))
in (match (uu____14631) with
| true -> begin
(

let uu____14639 = (FStar_SMTEncoding_Term.subst g fv1 xv)
in (uu____14639)::[])
end
| uu____14640 -> begin
[]
...
let uu____14641 = (FStar_List.fold_left (fun uu____14654 arg -> (match (uu____14654) with
| (env2, arg_vars, eqns_or_guards, i) -> begin
(

let uu____14676 = (

let uu____14680 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env2 uu____14680))
in (match (uu____14676) with
| (uu____14687, xv, env3) -> begin
(
...
let uu____14693 = (guards_for_parameter arg xv)
in (uu____14693)::eqns_or_guards)
end
| uu____14694 -> begin
(

let uu____14695 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (uu____14695)::eqns_or_guards)
end)
in ((env3), ((xv)::arg_vars), (eqns), ((i + (Prims.parse_int "1")))))
end))
end)) ((env'), ([]), ([]), ((Prims.parse_int "0"))) encoded_args)
in (match (uu____14641) with
| (uu____14703, arg_vars, elim_eqns_or_guards, uu____14706) -> begin
(
...
let uu____14737 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____14747 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append elim_eqns_or_guards guards))
in ((ty_pred), (uu____14747)))
in (FStar_SMTEncoding_Util.mkImp uu____14744))
in ((((ty_pred)::[])::[]), (uu____14737), (uu____14743))))
in (FStar_SMTEncoding_Util.mkForall uu____14731))
in ((uu____14730), (Some ("data constructor typing elim")), (Some ((Prims.strcat "data_elim_" ddconstrsym)))))
in FStar_SMTEncoding_Term.Assume (uu____14725))
in (
...
let uu____14761 = (varops.fresh "x")
in ((uu____14761), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
let uu____14780 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in (uu____14780)::[])
in (uu____14778)::[])
in (
...
let uu____14787 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (

let uu____14788 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in ((uu____14787), (uu____14788))))
in (FStar_SMTEncoding_Util.mkImp uu____14784))
in ((uu____14775), ((x)::[]), (uu____14783))))
in (FStar_SMTEncoding_Util.mkForall uu____14769))
in (

let uu____14798 = (

let uu____14800 = (varops.mk_unique "lextop")
in Some (uu____14800))
in ((uu____14768), (Some ("lextop is top")), (uu____14798))))
in FStar_SMTEncoding_Term.Assume (uu____14763))))
end
| uu____14803 -> begin
(
...
let uu____14806 = (FStar_All.pipe_right vars (FStar_List.mapi (fun i v1 -> (match ((i < n_tps)) with
| true -> begin
[]
end
| uu____14820 -> begin
...
let uu____14822 = (FStar_SMTEncoding_Util.mkFreeV v1)
in (FStar_SMTEncoding_Util.mk_Precedes uu____14822 dapp1))
in (uu____14821)::[])
end))))
in (FStar_All.pipe_right uu____14806 FStar_List.flatten))
in (
...
let uu____14838 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____14848 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (uu____14848)))
in (FStar_SMTEncoding_Util.mkImp uu____14845))
in ((((ty_pred)::[])::[]), (uu____14838), (uu____14844))))
in (FStar_SMTEncoding_Util.mkForall uu____14832))
in ((uu____14831), (Some ("subterm ordering")), (Some ((Prims.strcat "subterm_ordering_" ddconstrsym)))))
in FStar_SMTEncoding_Term.Assume (uu____14826)))
end)
...
let uu____14862 = (FStar_Syntax_Print.lid_to_string d)
in (

let uu____14863 = (FStar_Syntax_Print.term_to_string head1)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" uu____14862 uu____14863)))
in (FStar_Errors.warn drange uu____14861));
(([]), ([]));
)
end))
end)))
...
let uu____14896 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" uu____14896))
in Some (uu____14895))
in ((ddtok), ([]), (FStar_SMTEncoding_Term.Term_sort), (uu____14893)))
in FStar_SMTEncoding_Term.DeclFun (uu____14887))
in (uu____14886)::[])
in (
...
let uu____14924 = (FStar_SMTEncoding_Util.mkEq ((app), (dapp)))
in ((((app)::[])::[]), (vars), (uu____14924)))
in (FStar_SMTEncoding_Util.mkForall uu____14918))
in ((uu____14917), (Some ("equality for proxy")), (Some ((Prims.strcat "equality_tok_" ddtok)))))
in FStar_SMTEncoding_Term.Assume (uu____14912))
in (
...
let uu____14947 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) vars')
in (

let uu____14953 = (FStar_SMTEncoding_Util.mkImp ((guard'), (ty_pred')))
in ((((ty_pred')::[])::[]), (uu____14947), (uu____14953))))
in (FStar_SMTEncoding_Util.mkForall uu____14941))
in ((uu____14940), (Some ("data constructor typing intro")), (Some ((Prims.strcat "data_typing_intro_" ddtok)))))
in FStar_SMTEncoding_Term.Assume (uu____14935))
in (uu____14934)::[])
in (uu____14911)::uu____14932))
in (FStar_SMTEncoding_Term.Assume (((tok_typing), (Some ("typing for data constructor proxy")), (Some ((Prims.strcat "typing_tok_" ddtok))))))::uu____14909)
in (FStar_List.append uu____14907 elim))
in (FStar_List.append decls_pred uu____14905))
in (FStar_List.append decls_formals uu____14903))
in (FStar_List.append proxy_fresh uu____14901))
in (FStar_List.append uu____14884 uu____14899)))
in (FStar_List.append decls3 uu____14882))
in (FStar_List.append decls2 uu____14880))
in (FStar_List.append binder_decls uu____14878))
...
and encode_signature : env_t  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_SMTEncoding_Term.decl Prims.list * env_t) = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun uu____14976 se -> (match (uu____14976) with
| (g, env1) -> begin
(

let uu____14988 = (encode_sigelt env1 se)
...
let encode_binding = (fun b uu____15024 -> (match (uu____15024) with
| (i, decls, env1) -> begin
(match (b) with
| FStar_TypeChecker_Env.Binding_univ (uu____15042) -> begin
...
let uu____15047 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____15047) with
| true -> begin
(

let uu____15048 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____15049 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____15050 = (FStar_Syntax_Print.term_to_string t1)
...
let uu____15052 = (encode_term t1 env1)
...
let uu____15068 = (FStar_Util.digest_of_string t_hash)
in (Prims.strcat uu____15068 (Prims.strcat "_" (Prims.string_of_int i))))
in (Prims.strcat "x_" uu____15067))
in (new_term_constant_from_string env1 x uu____15066))
...
let uu____15079 = (FStar_Options.log_queries ())
...
let uu____15082 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____15083 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____15084 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" uu____15082 uu____15083 uu____15084))))
in Some (uu____15081))
end
| uu____15085 -> begin
None
...
| FStar_TypeChecker_Env.Binding_lid (x, (uu____15097, t)) -> begin
(
...
let uu____15106 = (encode_free_var env1 fv t t_norm [])
...
let uu____15125 = (encode_sigelt env1 se)
in (match (uu____15125) with
| (g, env') -> begin
(((i + (Prims.parse_int "1"))), ((FStar_List.append decls g)), (env'))
end))
end)
...
let uu____15135 = (FStar_List.fold_right encode_binding bindings (((Prims.parse_int "0")), ([]), (env)))
in (match (uu____15135) with
| (uu____15147, decls, env1) -> begin
((decls), (env1))
end))))
...
let prefix1 = (FStar_All.pipe_right labs (FStar_List.map (fun uu____15192 -> (match (uu____15192) with
| (l, uu____15199, uu____15200) -> begin
FStar_SMTEncoding_Term.DeclFun ((((Prims.fst l)), ([]), (FStar_SMTEncoding_Term.Bool_sort), (None)))
end))))
in (

let suffix = (FStar_All.pipe_right labs (FStar_List.collect (fun uu____15221 -> (match (uu____15221) with
| (l, uu____15229, uu____15230) -> begin
(

let uu____15235 = (FStar_All.pipe_left (fun _0_39 -> FStar_SMTEncoding_Term.Echo (_0_39)) (Prims.fst l))
in (
...
let uu____15239 = (FStar_SMTEncoding_Util.mkFreeV l)
in FStar_SMTEncoding_Term.Eval (uu____15239))
in (uu____15238)::[])
in (uu____15235)::uu____15236))
end))))
in ((prefix1), (suffix)))))
...
let uu____15253 = (FStar_Util.smap_create (Prims.parse_int "100"))
in {bindings = []; depth = (Prims.parse_int "0"); tcenv = tcenv; warn = true; cache = uu____15253; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (uu____15252)::[])
in (FStar_ST.write last_env uu____15250)))
...
let uu___161_15279 = e
in {bindings = uu___161_15279.bindings; depth = uu___161_15279.depth; tcenv = tcenv; warn = uu___161_15279.warn; cache = uu___161_15279.cache; nolabels = uu___161_15279.nolabels; use_zfuel_name = uu___161_15279.use_zfuel_name; encode_non_total_function_typ = uu___161_15279.encode_non_total_function_typ})
end)))


let set_env : env_t  ->  Prims.unit = (fun env -> (

let uu____15283 = (FStar_ST.read last_env)
in (match (uu____15283) with
| [] -> begin
(failwith "Empty env stack")
end
| (uu____15288)::tl1 -> begin
(FStar_ST.write last_env ((env)::tl1))
end)))


let push_env : Prims.unit  ->  Prims.unit = (fun uu____15296 -> (

let uu____15297 = (FStar_ST.read last_env)
...
let uu___162_15318 = hd1
in {bindings = uu___162_15318.bindings; depth = uu___162_15318.depth; tcenv = uu___162_15318.tcenv; warn = uu___162_15318.warn; cache = refs; nolabels = uu___162_15318.nolabels; use_zfuel_name = uu___162_15318.use_zfuel_name; encode_non_total_function_typ = uu___162_15318.encode_non_total_function_typ})
in (FStar_ST.write last_env ((top)::(hd1)::tl1))))
end)))


let pop_env : Prims.unit  ->  Prims.unit = (fun uu____15324 -> (

let uu____15325 = (FStar_ST.read last_env)
in (match (uu____15325) with
| [] -> begin
(failwith "Popping an empty stack")
end
| (uu____15330)::tl1 -> begin
...
let commit_mark_env : Prims.unit  ->  Prims.unit = (fun uu____15344 -> (

let uu____15345 = (FStar_ST.read last_env)
in (match (uu____15345) with
| (hd1)::(uu____15351)::tl1 -> begin
...
let uu____15402 = (FStar_Options.log_queries ())
...
let uu____15407 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se) (FStar_List.map FStar_Syntax_Print.lid_to_string))
in (FStar_All.pipe_right uu____15407 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " uu____15406))
in FStar_SMTEncoding_Term.Caption (uu____15405))
in (uu____15404)::decls)
end
| uu____15412 -> begin
decls
end)))
...
let uu____15414 = (encode_sigelt env se)
in (match (uu____15414) with
| (decls, env1) -> begin
((set_env env1);
(

let uu____15420 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 uu____15420));
)
end)))))
...
let uu____15431 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
in (match (uu____15431) with
| true -> begin
(

let uu____15432 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) Prims.string_of_int)
...
let uu____15437 = (encode_signature (

let uu___163_15441 = env
in {bindings = uu___163_15441.bindings; depth = uu___163_15441.depth; tcenv = uu___163_15441.tcenv; warn = false; cache = uu___163_15441.cache; nolabels = uu___163_15441.nolabels; use_zfuel_name = uu___163_15441.use_zfuel_name; encode_non_total_function_typ = uu___163_15441.encode_non_total_function_typ}) modul.FStar_Syntax_Syntax.exports)
...
let uu____15453 = (FStar_Options.log_queries ())
...
let uu___164_15458 = env1
in {bindings = uu___164_15458.bindings; depth = uu___164_15458.depth; tcenv = uu___164_15458.tcenv; warn = true; cache = uu___164_15458.cache; nolabels = uu___164_15458.nolabels; use_zfuel_name = uu___164_15458.use_zfuel_name; encode_non_total_function_typ = uu___164_15458.encode_non_total_function_typ}));
(

let uu____15460 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
...
let uu____15496 = (FStar_TypeChecker_Env.current_module tcenv)
in uu____15496.FStar_Ident.str)
in (FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name uu____15495));
(
...
let uu____15543 = (FStar_Syntax_Util.destruct_typ_as_formula x.FStar_Syntax_Syntax.sort)
in (match (uu____15543) with
| Some (uu____15547) -> begin
(

let uu____15548 = (FStar_Syntax_Syntax.new_bv None FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.refine uu____15548 x.FStar_Syntax_Syntax.sort))
end
| uu____15549 -> begin
...
let uu____15554 = (FStar_Syntax_Syntax.mk_binder (

let uu___165_15555 = x
in {FStar_Syntax_Syntax.ppname = uu___165_15555.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___165_15555.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in (uu____15554)::out)
in ((uu____15552), (rest1)))))
end))
end
| uu____15558 -> begin
(([]), (bindings1))
...
let uu____15562 = (aux bindings)
in (match (uu____15562) with
| (closing, bindings1) -> begin
(

let uu____15576 = (FStar_Syntax_Util.close_forall_no_univs (FStar_List.rev closing) q)
in ((uu____15576), (bindings1)))
end)))
...
let uu____15592 = (FStar_List.filter (fun uu___134_15594 -> (match (uu___134_15594) with
| FStar_TypeChecker_Env.Binding_sig (uu____15595) -> begin
false
end
| uu____15599 -> begin
true
end)) bindings1)
in (encode_env_bindings env uu____15592))
in (match (uu____15589) with
| (env_decls, env1) -> begin
((

let uu____15610 = (((FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTEncoding")))) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTQuery"))))
in (match (uu____15610) with
| true -> begin
(

let uu____15611 = (FStar_Syntax_Print.term_to_string q1)
...
let uu____15613 = (encode_formula q1 env1)
...
let uu____15628 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg uu____15628 phi))
in (match (uu____15625) with
| (labels, phi1) -> begin
(

let uu____15638 = (encode_labels labels)
...
let uu____15664 = (FStar_SMTEncoding_Util.mkNot phi1)
in (

let uu____15665 = (

let uu____15667 = (varops.mk_unique "@query")
in Some (uu____15667))
in ((uu____15664), (Some ("query")), (uu____15665))))
in FStar_SMTEncoding_Term.Assume (uu____15659))
in (
...
let uu____15676 = (FStar_Options.print_z3_statistics ())
...
in (FStar_List.append uu____15674 ((FStar_SMTEncoding_Term.Echo ("Done!"))::[])))
in (FStar_List.append label_suffix uu____15672))
...
let uu____15689 = (encode_formula q env)
in (match (uu____15689) with
| (f, uu____15693) -> begin
((FStar_SMTEncoding_Z3.pop "query");
(match (f.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.TrueOp, uu____15695) -> begin
true
end
| uu____15698 -> begin
false
