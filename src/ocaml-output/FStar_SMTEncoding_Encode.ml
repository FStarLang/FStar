      ...
      (match t0.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           let decl =
             let uu____5807 =
               let uu____5818 =
                 let uu____5821 = FStar_Util.format1 "alien term (%s)" desc
                    in
                 FStar_Pervasives_Native.Some uu____5821  in
               ((FStar_Pervasives_Native.fst tsym), [],
                 FStar_SMTEncoding_Term.Term_sort, uu____5818)
                in
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____6360 ->
           ...
           (match uu____6367 with
            | (x,f) ->
                let uu____6433 = encode_term x.FStar_Syntax_Syntax.sort env
                   in
                ...
                let d =
                  let uu____6799 =
                    let uu____6806 =
                      let uu____6807 =
                        let uu____6808 =
                          let uu____6809 = FStar_Syntax_Unionfind.uvar_id uv
                             in
                               ...
                               let head_type2 =
                                 let uu____7802 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____7802
                                  in
                               let uu____7803 =
                  ...
                  then
                    ...
                    if
                      FStar_Ident.lid_equals
                        ...
                        FStar_Parser_Const.effect_GTot_lid
                    then
                      (let uu____7955 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                             ...
                             | (body3,decls') ->
                                 let uu____8031 =
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____8059 = encode_term tfun env
                                          in
...
and (encode_pat :
  ...
  fun env  ->
    fun pat  ->
      ...
      (let uu____8776 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
                                  ...
                                  | (arg,uu____9247) ->
                                      ...
                                      let uu____9253 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____9253))
                         in
                      FStar_All.pipe_right uu____9189 FStar_List.flatten
                   in
            ...
            (match uu____9519 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____9547,uu____9548)::(e,uu____9550)::[]) when
                 ...
                 -> e
             | uu____9585 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        ...
        let smt_pat_or1 t1 =
          let uu____9621 =
            ...
            FStar_All.pipe_right uu____9636 FStar_Syntax_Util.head_and_args
             in
               ...
               (match uu____10127 with
                | (pats,decls') ->
                    ...
                    (match uu____10360 with
                     | (pre1,decls'') ->
                         let uu____10372 =
                           let uu____10377 = FStar_Syntax_Util.unmeta post1
                              in
                              ...
                              let uu____10387 =
                                let uu____10388 =
                                  let uu____10399 =
                                    ...
                                    FStar_SMTEncoding_Util.mkImp uu____10400
                                     in
                                  (pats, vars, uu____10399)  in
                                FStar_SMTEncoding_Util.mkForall uu____10388
                                 in
                              (uu____10387, decls1)))))
...
and (encode_formula :
  ...
  fun phi  ->
    fun env  ->
      ...
      let unboxInt_l f l =
        let uu____11199 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l
           in
        f uu____11199  in
      let connectives =
        let uu____11217 =
          let uu____11230 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Parser_Const.and_lid, uu____11230)  in
        let uu____11247 =
          let uu____11262 =
            let uu____11275 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
      ...
      let encode_q_body env1 bs ps body =
        let uu____12133 = encode_binders FStar_Pervasives_Native.None bs env1
           in
               ...
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      ...
                      FStar_Util.set_union out uu____12569) uu____12557 tl1
                in
             let uu____12572 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
                    (fun uu____12599  ->
                       ...
                       | (b,uu____12605) ->
                           let uu____12606 = FStar_Util.set_mem b pat_vars
                              in
                           Prims.op_Negation uu____12606))
                in
              ...
              | FStar_Pervasives_Native.Some (x,uu____12612) ->
                  ...
                  let uu____12626 =
                    ...
                    (FStar_Errors.Warning_SMTPatternMissingBoundVar,
                      uu____12631)
                     in
                  FStar_Errors.log_issue pos uu____12626)
          in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____12700  ->
                     ...
                     | (l,uu____12714) -> FStar_Ident.lid_equals op l))
              in
...
let (prims : prims_t) =
  ...
  | (asym,a) ->
      ...
      (match uu____13018 with
       | (xsym,x) ->
           let uu____13025 = fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort
              in
            ...
            | (ysym,y) ->
                          ...
                          let uu____13175 =
                            let uu____13176 =
                              let uu____13183 =
                                ...
                                FStar_SMTEncoding_Util.mkForall uu____13184
                                 in
                              (uu____13183,
                                (FStar_Pervasives_Native.Some
                ...
                let prims1 =
                  let uu____13286 =
                    let uu____13299 =
                      let uu____13308 =
                        let uu____13309 = FStar_SMTEncoding_Util.mkEq (x, y)
                           in
                      ...
                      let uu____13381 =
                        let uu____13394 =
                          let uu____13403 =
                            ...
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool uu____13404
                             in
                        ...
                        let uu____13435 =
                          let uu____13448 =
                            let uu____13457 =
                              ...
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool uu____13458
                               in
                          ...
                          let uu____13489 =
                            let uu____13502 =
                              let uu____13511 =
                                ...
                                FStar_All.pipe_left
                                  FStar_SMTEncoding_Term.boxBool uu____13512
                                 in
                              ...
                              let uu____13556 =
                                let uu____13565 =
                                  let uu____13566 =
                                    ...
                                    FStar_SMTEncoding_Util.mkGTE uu____13567
                                     in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool
                                    uu____13566
                            ...
                            let uu____13582 =
                              ...
                              let uu____13636 =
                                let uu____13651 =
                                  ...
                                  (FStar_Parser_Const.op_Minus, uu____13664)
                                   in
                                let uu____13684 =
                                  let uu____13699 =
                                    let uu____13712 =
                ...
                let mk1 l v1 =
                  let uu____14261 =
                    ...
                    FStar_All.pipe_right uu____14270
                      (FStar_Option.map
                         (fun uu____14402  ->
                            match uu____14402 with | (uu____14421,b) -> b v1))
                     in
                  ...
                  FStar_All.pipe_right prims1
                    (FStar_Util.for_some
                       (fun uu____14492  ->
                          ...
                          | (l',uu____14506) -> FStar_Ident.lid_equals l l'))
                   in
                { mk = mk1; is }))
  ...
  fun env  ->
    fun tapp  ->
      fun vars  ->
        ...
        | (xxsym,xx) ->
            let uu____14551 = fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort
               in
...
let (primitive_type_axioms :
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let body =
      ...
      let hastypeS =
        let uu____16255 = FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "1")
           in
        FStar_SMTEncoding_Term.mk_HasTypeFuel uu____16255 x1 t  in
      let uu____16256 =
        let uu____16267 = FStar_SMTEncoding_Util.mkImp (hastypeZ, hastypeS)
           in
          ...
          let uu____16737 =
            FStar_Util.find_opt
              (fun uu____16763  ->
                 ...
                 | (l,uu____16775) -> FStar_Ident.lid_equals l t) prims1
             in
                              ...
                              (let uu____19896 =
                                 let uu____19903 =
                                   FStar_List.map
                                    ...
                                    in
                                 (f, uu____19903)  in
                               FStar_SMTEncoding_Util.mkApp uu____19896)
                         in
                            ...
                            let uu____20051 =
                              ...
                              | (tcenv',uu____20076,e_t) ->
                                  let uu____20082 =
                                    ...
                                    | uu____20093 -> failwith "Impossible"
                                     in
          ...
          let g1 =
            ...
            | uu____22035 ->
                ...
                let uu____22041 =
                  ...
                  [uu____22044]  in
                FStar_List.append uu____22036 uu____22041
             in
          (g1, env1)
                               ...
                               let uu____22221 =
                                 let uu____22222 =
                                   ...
                                   (aname, uu____22233,
                                    ...
                                    in
                                 FStar_SMTEncoding_Term.DeclFun uu____22222
                                  in
                               [uu____22221;
                               FStar_SMTEncoding_Term.DeclFun
                             ...
                             let uu____22262 =
                               let aux uu____22314 uu____22315 =
                                 ...
                                 | ((bv,uu____22367),(env3,acc_sorts,acc)) ->
                                     let uu____22405 = gen_term_var env3 bv
                                        in
                        ...
                        let uu____22715 =
                          let uu____22722 =
                            let uu____22725 =
                              ...
                              FStar_Util.format1 "Assumption: %s" uu____22726
                               in
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____23235  ->
                                ...
                                | (uu____23242,sort,uu____23244) -> sort))
                         in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____23277 FStar_Option.isNone))
               in
            if uu____23271
            then []
            else
                                               ...
                                               let uu____23436 =
                                                 let uu____23437 =
                                                   FStar_Syntax_Subst.compress
                                                     res
                                                    in
                                                 uu____23437.FStar_Syntax_Syntax.n
                                                  in
                         ...
                         | (ffsym,ff) ->
                             let fuel_guarded_inversion =
                               ...
                               let uu____23602 =
                                 ...
                                 (uu____23609,
                                   (FStar_Pervasives_Native.Some
                                      "inversion axiom"), uu____23651)
                                  in
                               FStar_SMTEncoding_Util.mkAssume uu____23602
                                in
                                ...
                                let tname_decl =
                                  let uu____23830 =
                                    ...
                                    (tname, uu____23831,
                                      ...
                                      uu____23876, false)
                                     in
                                  constructor_or_logic_type_decl uu____23830
                                   in
                                let uu____23885 =
                                  match vars with
                                  | [] ->
                                  ...
                                  | uu____23909 ->
                                      let ttok_decl =
                                        FStar_SMTEncoding_Term.DeclFun
                                         ...
                                         in
                                      let ttok_fresh =
                                        let uu____23918 = varops.next_id ()
                                           in
                                           ...
                                           let uu____24029 =
                                             let uu____24032 =
                                               ...
                                               FStar_SMTEncoding_Util.mkAssume
                                                ...
                                                in
                                             [uu____24032]  in
                                           FStar_List.append karr uu____24029
                                            in
                                         FStar_List.append decls1 uu____24026
                                      in
                                   let aux =
                                     let uu____24068 =
                                       let uu____24071 =
                                       ...
                                       FStar_List.append uu____24071
                                         uu____24074
                                        in
                                     FStar_List.append kindingAx uu____24068
                                      in
                                   let g =
                                     FStar_List.append decls
                                                   ...
                                                   let uu____24538 =
                                                     let uu____24539 =
                                                       FStar_Syntax_Subst.compress
                                                         head1
                                                        in
                                                     uu____24539.FStar_Syntax_Syntax.n
                                                      in
                   ...
                   then
                     ...
                     let uu____25946 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort
                        in
                     let uu____25947 = FStar_Syntax_Print.term_to_string t1
                        in
                        ...
                        | (xxsym,xx,env') ->
                            let t2 =
                              FStar_SMTEncoding_Term.mk_HasTypeWithFuel
                               ...
                               in
                            let caption =
                              let uu____25990 = FStar_Options.log_queries ()
                                 in
                              if uu____25990
                              then
                                let uu____25993 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____25994 uu____25995 uu____25996
                                   in
             ...
             | FStar_TypeChecker_Env.Binding_lid (x,(uu____26012,t)) ->
                 ...
                 let fv =
                   FStar_Syntax_Syntax.lid_as_fv x
                     ...
                     FStar_Pervasives_Native.None
                    in
                 let uu____26026 = encode_free_var false env1 fv t t_norm []
                    in
  ...
  fun env  ->
    fun lid  ->
      let uu____26618 =
        ...
        let uu____26623 = open_fact_db_tags env  in uu____26621 ::
          uu____26623
         in
              ...
              let uu____26686 =
                let uu____26687 =
                  FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se)
                   ...
                   in
                FStar_All.pipe_right uu____26687 (FStar_String.concat ", ")
                 in
              Prims.strcat "encoding sigelt " uu____26686  in
            FStar_SMTEncoding_Term.Caption uu____26685  in
          uu____26684 :: decls
        else decls  in
      (let uu____26698 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low
          in
       if uu____26698
       then
    ...
    fun modul  ->
      let name =
        FStar_Util.format2 "%s %s"
         ...
         in
      (let uu____26729 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low
          in
       if uu____26729
       then
         let uu____26730 =
             ...
             (match uu____27053 with
              | (env_decls,env1) ->
                  ((let uu____27089 =
                    ...
                    if uu____27089
                    then
                      let uu____27090 = FStar_Syntax_Print.term_to_string q1
                         in
