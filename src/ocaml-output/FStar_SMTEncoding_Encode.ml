...
let (primitive_type_axioms :
  ...
  let mk_inversion_axiom env inversion tt =
    ...
    let body =
      ...
      let hastypeS =
        let uu____6286 = FStar_SMTEncoding_Term.n_fuel Prims.int_one  in
                                  ...
                                  (let uu___311_7436 =
                                     env.FStar_SMTEncoding_Env.tcenv  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.strict_args_tab =
                                       (uu___311_7436.FStar_TypeChecker_Env.strict_args_tab);
                                     FStar_TypeChecker_Env.erasable_types_tab
                                       =
                                       (uu___311_7436.FStar_TypeChecker_Env.erasable_types_tab)
            ...
            let destruct_bound_function t e =
              let tcenv =
                let uu___523_9450 = env.FStar_SMTEncoding_Env.tcenv  in
                {
                  ...
                  FStar_TypeChecker_Env.strict_args_tab =
                    (uu___523_9450.FStar_TypeChecker_Env.strict_args_tab);
                  FStar_TypeChecker_Env.erasable_types_tab =
                    (uu___523_9450.FStar_TypeChecker_Env.erasable_types_tab)
                }  in
  ...
  fun tcenv  ->
    let uu____18094 =
      let uu____18097 =
        ...
        let uu____18133 = FStar_Util.smap_create (Prims.of_int (100))  in
        {
