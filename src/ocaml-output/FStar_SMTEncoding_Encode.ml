                         ...
                         let uu____2342 =
                           ...
                           | (xxsym,xx,env') ->
                               let uu____2365 =
                                 ...
                                 encode_term_pred fuel_opt uu____2368 env1 xx
                                  in
      ...
      fun env  ->
        fun e  ->
          ...
          | (t1,decls) ->
              (match fuel_opt with
               | None  ->
                   let uu____2480 = FStar_SMTEncoding_Term.mk_HasTypeZ e t1
                      in
                   (uu____2480, decls)
               | Some f ->
                   let uu____2482 =
      ...
      fun args_e  ->
        ...
        | (arg_tms,decls) ->
            ...
            let mk_l op mk_args ts =
              let uu____2571 = FStar_Options.smtencoding_l_arith_native ()
                 in
              if uu____2571
              then
                let uu____2572 =
                  let uu____2573 = mk_args ts  in op uu____2573  in
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____3145 ->
           let uu____3150 =
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 let uu____3167 = FStar_Syntax_Subst.open_term [(x, None)] f
                    in
                 (match uu____3167 with
                  | (b,f1) ->
                      let uu____3181 =
                        let uu____3182 = FStar_List.hd b  in fst uu____3182
                         in
                      (uu____3181, f1))
             | uu____3187 -> failwith "impossible"  in
           (match uu____3150 with
            | (x,f) ->
                let uu____3194 = encode_term x.FStar_Syntax_Syntax.sort env
                   in
                               ...
                               let head_type2 =
                                 let uu____4009 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____4009
                                  in
                               let uu____4010 =
                  ...
                  | FStar_Util.Inr (eff,uu____4113) ->
                      let uu____4119 =
                        FStar_TypeChecker_Util.is_pure_or_ghost_effect
                          env.tcenv eff
                         in
                      FStar_All.pipe_right uu____4119 Prims.op_Negation
                   in
                        ...
                        let typ =
                          ...
                          FStar_TypeChecker_Env.reify_comp
                            (let uu___136_4165 = env1.tcenv  in
                             ...
                             }) uu____4164 FStar_Syntax_Syntax.U_unknown
                           in
                        let uu____4166 =
                          let uu____4167 = FStar_Syntax_Syntax.mk_Total typ
                             in
                      ...
                      let new_uvar1 uu____4218 =
                        let uu____4219 =
                          FStar_TypeChecker_Rel.new_uvar
                           ...
                           in
                        FStar_All.pipe_right uu____4219 FStar_Pervasives.fst
                         in
                      if
                       ...
                       (let cache_size = FStar_Util.smap_size env.cache  in
                        ...
                        | (vars,guards,envbody,decls,uu____4281) ->
                            ...
                            (match uu____4288 with
                             | (lc2,body2) ->
                                 let uu____4321 = encode_term body2 envbody
                                    in
...
and encode_pat :
  ...
  fun env  ->
    fun pat  ->
      ...
      | uu____4851 ->
          let uu____4852 = encode_one_pat env pat  in [uu____4852]
...
and encode_one_pat : env_t -> FStar_Syntax_Syntax.pat -> (env_t * pattern) =
  fun env  ->
    fun pat  ->
      ...
      (let uu____4867 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
                                  ...
                                  | (arg,uu____5141) ->
                                      ...
                                      let uu____5151 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____5151))
                         in
                      FStar_All.pipe_right uu____5110 FStar_List.flatten
                   in
        ...
        | (head1,args) ->
            ...
            (match uu____5314 with
             ...
             | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____5371)::[]) when
                 ...
                 -> (e, None)
             | uu____5392 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        ...
        let smt_pat_or t1 =
          let uu____5425 =
            ...
            FStar_All.pipe_right uu____5435 FStar_Syntax_Util.head_and_args
             in
                                 ...
                                 (FStar_List.map
                                    (fun uu____5924  ->
                                       ...
                                       | (t1,uu____5931) ->
                                           encode_term t1 env2))
                                in
                             FStar_All.pipe_right uu____5908 FStar_List.unzip
                              in
                                    ...
                                    let uu____6008 =
                                      let uu____6011 =
                                        FStar_SMTEncoding_Util.mk_and_l (pre1
                                         ...
                                         in
                                      (uu____6011, post1)  in
                                    FStar_SMTEncoding_Util.mkImp uu____6008
                                     in
                                  (pats, vars, uu____6007)  in
                                FStar_SMTEncoding_Util.mkForall uu____6001
                                 in
                              (uu____6000, decls1)))))
    ...
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            ...
            (uu____6083, decls)
         in
      let const_op f r uu____6103 = let uu____6106 = f r  in (uu____6106, [])
         in
      let un_op f l =
        let uu____6122 = FStar_List.hd l  in FStar_All.pipe_left f uu____6122
         in
      ...
      let connectives =
        let uu____6476 =
          let uu____6485 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Syntax_Const.and_lid, uu____6485)  in
        let uu____6498 =
          let uu____6508 =
            let uu____6517 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
                        ...
                        let uu____7114 =
                          let uu____7119 =
                            FStar_All.pipe_right p
                             ...
                             in
                          FStar_All.pipe_right uu____7119 FStar_List.unzip
                           in
               ...
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      ...
                      FStar_Util.set_union out uu____7273) uu____7267 tl1
                in
             let uu____7275 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
              ...
              | Some (x,uu____7296) ->
                  ...
                  let uu____7306 =
                    ...
                    FStar_Util.format1
                      ...
                      uu____7307
                     in
                  FStar_Errors.warn pos uu____7306)
          in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____7350  ->
                     ...
                     | (l,uu____7360) -> FStar_Ident.lid_equals op l))
              in
...
let prims : prims_t =
  ...
  | (asym,a) ->
      ...
      (match uu____7542 with
       | (xsym,x) ->
           let uu____7547 = fresh_fvar "y" FStar_SMTEncoding_Term.Term_sort
              in
            ...
            | (ysym,y) ->
                          ...
                          let uu____7639 =
                            let uu____7640 =
                              let uu____7644 =
                                ...
                                FStar_SMTEncoding_Util.mkForall uu____7645
                                 in
                              (uu____7644,
                ...
                let prims1 =
                  let uu____7700 =
                    let uu____7708 =
                      let uu____7714 =
                        let uu____7715 = FStar_SMTEncoding_Util.mkEq (x, y)
                           in
                      ...
                      let uu____7761 =
                        let uu____7769 =
                          let uu____7775 =
                            ...
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool uu____7776
                             in
                        ...
                        let uu____7796 =
                          let uu____7804 =
                            let uu____7810 =
                              ...
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool uu____7811
                               in
                          ...
                          let uu____7831 =
                            let uu____7839 =
                              let uu____7845 =
                                ...
                                FStar_All.pipe_left
                                  FStar_SMTEncoding_Term.boxBool uu____7846
                                 in
                              ...
                              let uu____7874 =
                                let uu____7880 =
                                  let uu____7881 =
                                    ...
                                    FStar_SMTEncoding_Util.mkGTE uu____7882
                                     in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool uu____7881
                                   in
                            ...
                            let uu____7892 =
                                ...
                                let uu____7909 =
                                  let uu____7915 =
                                    let uu____7916 =
                                      ...
                                      FStar_SMTEncoding_Util.mkSub uu____7917
                                       in
                                    FStar_All.pipe_left
                                      FStar_SMTEncoding_Term.boxInt
                                      uu____7916
                              ...
                              let uu____7927 =
                                let uu____7936 =
                                  ...
                                  (FStar_Syntax_Const.op_Minus, uu____7944)
                                   in
                                let uu____7958 =
                                  let uu____7967 =
                                    let uu____7975 =
                ...
                let mk1 l v1 =
                  let uu____8321 =
                    ...
                    FStar_All.pipe_right uu____8326
                      (FStar_Option.map
                         (fun uu____8400  ->
                            match uu____8400 with | (uu____8411,b) -> b v1))
                     in
                  ...
                  FStar_All.pipe_right prims1
                    (FStar_Util.for_some
                       (fun uu____8452  ->
                          ...
                          | (l',uu____8461) -> FStar_Ident.lid_equals l l'))
                   in
                { mk = mk1; is }))
  ...
  fun env  ->
    fun tapp  ->
      fun vars  ->
        ...
        | (xxsym,xx) ->
            let uu____8492 = fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort
               in
...
let primitive_type_axioms :
  ...
  let mk_ref1 env reft_name uu____8932 =
    ...
    let refa =
      let uu____8943 =
        let uu____8947 =
          let uu____8949 = FStar_SMTEncoding_Util.mkFreeV aa  in [uu____8949]
           in
    ...
    let refb =
      let uu____8952 =
        let uu____8956 =
          let uu____8958 = FStar_SMTEncoding_Util.mkFreeV bb  in [uu____8958]
           in
      ...
      let uu____8963 =
        let uu____8967 =
          let uu____8968 =
            let uu____8974 =
              let uu____8975 =
                let uu____8978 = FStar_SMTEncoding_Term.mk_tester "BoxRef" x
                   in
          ...
          let uu____9891 =
            FStar_Util.find_opt
              (fun uu____9909  ->
                 ...
                 | (l,uu____9919) -> FStar_Ident.lid_equals l t) prims1
             in
      ...
      fun tt  ->
        fun t_norm  ->
          fun quals  ->
            ...
            if uu____10010
            then
              let uu____10015 = new_term_constant_and_tok_from_lid env lid
                 in
              match uu____10015 with
              | (vname,vtok,env1) ->
                  let arg_sorts =
                    let uu____10027 =
                      let uu____10028 = FStar_Syntax_Subst.compress t_norm
                         in
                             ...
                             FStar_All.pipe_right quals
                               (FStar_List.collect
                                  (fun uu___115_10172  ->
                                     ...
                                     | uu____10274 -> []))
                              in
                           let uu____10275 = encode_binders None formals env1
                              in
                            ...
                            | (vars,guards,env',decls1,uu____10291) ->
                                let uu____10298 =
                                  ...
                                  | None  ->
                                      ...
                                      (uu____10303, decls1)
                                  | Some p ->
                                      let uu____10305 = encode_formula p env'
                                         in
            ...
            let eta_expand1 binders formals body t =
              ...
              | (formals1,extra_formals) ->
                  ...
                  let body1 =
                    let uu____10953 =
                      let uu____10955 =
                        let uu____10956 = FStar_Syntax_Subst.subst subst1 t
                           in
                      ...
                      let uu____10962 =
                        let uu____10963 =
                          FStar_Syntax_Util.args_of_binders extra_formals1
                           in
                        FStar_All.pipe_left FStar_Pervasives.snd uu____10963
                         in
                              ...
                              (let uu____11773 =
                                 let uu____11777 =
                                   FStar_List.map
                                    ...
                                    in
                                 (f, uu____11777)  in
                               FStar_SMTEncoding_Util.mkApp uu____11773)
                         in
                      let uu____11782 =
                        (FStar_All.pipe_right quals
                           (FStar_Util.for_some
                      ...
                      then (decls1, env1)
                        ...
                        then
                               ...
                               let uu____11852 =
                                 ...
                                 | (tcenv',uu____11867,e_t) ->
                                     let uu____11871 =
                                       ...
                                       | uu____11878 -> failwith "Impossible"
                                        in
                          ...
                          (let fuel =
                             ...
                             (uu____12028, FStar_SMTEncoding_Term.Fuel_sort)
                              in
  ...
  fun env  ->
    fun se  ->
      let nm =
        ...
        match uu____12923 with | None  -> "" | Some l -> l.FStar_Ident.str
         in
          ...
          let g1 =
            ...
            | uu____12938 ->
                ...
                let uu____12943 =
                  ...
                  [uu____12945]  in
                FStar_List.append uu____12939 uu____12943
             in
          (g1, env1)
                       ...
                       let uu____12989 =
                         let uu____13004 =
                           FStar_All.pipe_left (fun _0_37  -> Some _0_37)
                            ...
                            in
                         ((ed.FStar_Syntax_Syntax.binders), tm, uu____13004)
                          in
                       FStar_Syntax_Syntax.Tm_abs uu____12989  in
                     FStar_Syntax_Syntax.mk uu____12988  in
                   uu____12985 None tm.FStar_Syntax_Syntax.pos
                in
                               ...
                               let uu____13095 =
                                 let uu____13096 =
                                   ...
                                   (aname, uu____13102,
                                     ...
                                     (Some "Action"))
                                    in
                                 FStar_SMTEncoding_Term.DeclFun uu____13096
                                  in
                               [uu____13095;
                               FStar_SMTEncoding_Term.DeclFun
                             ...
                             let uu____13117 =
                               let aux uu____13146 uu____13147 =
                                 ...
                                 | ((bv,uu____13174),(env3,acc_sorts,acc)) ->
                                     let uu____13195 = gen_term_var env3 bv
                                        in
               ...
               let g =
                 let uu____13368 =
                   let uu____13369 =
                     let uu____13373 =
                       let uu____13375 =
                         let uu____13376 = FStar_Syntax_Print.lid_to_string l
                            in
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____13707  ->
                                ...
                                | (uu____13711,sort,uu____13713) -> sort))
                         in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____13734 FStar_Option.isNone))
               in
            if uu____13731
            then []
            else
                                               ...
                                               let uu____13817 =
                                                 let uu____13818 =
                                                   FStar_Syntax_Subst.compress
                                                     res
                                                    in
                                                 uu____13818.FStar_Syntax_Syntax.n
                                                  in
                             ...
                             let fuel_guarded_inversion =
                               ...
                               let uu____13929 =
                                 ...
                                 (uu____13933, (Some "inversion axiom"),
                                   uu____13956)
                                  in
                               FStar_SMTEncoding_Util.mkAssume uu____13929
                                in
                                ...
                                let tname_decl =
                                  let uu____14109 =
                                    ...
                                    (tname, uu____14110,
                                      ...
                                      uu____14133, false)
                                     in
                                  constructor_or_logic_type_decl uu____14109
                                   in
                                let uu____14138 =
                                  match vars with
                                  | [] ->
                                  ...
                                  | uu____14152 ->
                                      let ttok_decl =
                                        FStar_SMTEncoding_Term.DeclFun
                                         ...
                                         in
                                      let ttok_fresh =
                                        let uu____14158 = varops.next_id ()
                                           in
                                        FStar_SMTEncoding_Term.fresh_token
                                          (ttok,
                                            FStar_SMTEncoding_Term.Term_sort)
                                           ...
                                           let uu____14228 =
                                             let uu____14230 =
                                               ...
                                               FStar_SMTEncoding_Util.mkAssume
                                                ...
                                                in
                                             [uu____14230]  in
                                           FStar_List.append karr uu____14228
                                            in
                                         FStar_List.append decls1 uu____14226
                                      in
                                   let aux =
                                     let uu____14251 =
                                       let uu____14253 =
                                       ...
                                       FStar_List.append uu____14253
                                         uu____14255
                                        in
                                     FStar_List.append kindingAx uu____14251
                                      in
                                   let g =
                                     FStar_List.append decls
                                                   ...
                                                   let uu____14535 =
                                                     let uu____14536 =
                                                       FStar_Syntax_Subst.compress
                                                         head1
                                                        in
                                                     uu____14536.FStar_Syntax_Syntax.n
                                                      in
                   ...
                   then
                     ...
                     let uu____14993 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort
                        in
                     let uu____14994 = FStar_Syntax_Print.term_to_string t1
                        in
                        ...
                        | (xxsym,xx,env') ->
                            let t2 =
                              FStar_SMTEncoding_Term.mk_HasTypeWithFuel None
                               ...
                               in
                            let caption =
                              let uu____15023 = FStar_Options.log_queries ()
                                 in
                              if uu____15023
                              then
                                let uu____15025 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____15026 uu____15027 uu____15028
                                   in
                                Some uu____15025
                              else None  in
                            let ax =
  ...
  fun env  ->
    fun lid  ->
      let uu____15351 =
        ...
        let uu____15355 = open_fact_db_tags env  in uu____15353 ::
          uu____15355
         in
              ...
              let uu____15399 =
                let uu____15400 =
                  FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se)
                   ...
                   in
                FStar_All.pipe_right uu____15400 (FStar_String.concat ", ")
                 in
    ...
    fun modul  ->
      let name =
        FStar_Util.format2 "%s %s"
         ...
         in
      (let uu____15428 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low
          in
       if uu____15428
       then
         let uu____15429 =
             ...
             (match uu____15628 with
              | (env_decls,env1) ->
                  ((let uu____15649 =
                    ...
                    if uu____15649
                    then
                      let uu____15650 = FStar_Syntax_Print.term_to_string q1
                         in
