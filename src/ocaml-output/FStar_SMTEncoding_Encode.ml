      ...
      let a1 =
           ...
           in
        {
          ...
          FStar_Syntax_Syntax.index =
            (uu___136_143.FStar_Syntax_Syntax.index);
          FStar_Syntax_Syntax.sort = (uu___136_143.FStar_Syntax_Syntax.sort)
        }  in
      let uu____145 =
...
let (unmangle : FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv) =
  fun x  ->
    let uu___137_1621 = x  in
    let uu____1622 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname  in
    {
      FStar_Syntax_Syntax.ppname = uu____1622;
      FStar_Syntax_Syntax.index = (uu___137_1621.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___137_1621.FStar_Syntax_Syntax.sort)
    }
    ...
    fun x  ->
      ...
      let y =
        FStar_SMTEncoding_Util.mkFreeV
         ...
         in
      (ysym, y,
        (let uu___138_2193 = env  in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (env.depth + (Prims.parse_int "1"));
           tcenv = (uu___138_2193.tcenv);
           warn = (uu___138_2193.warn);
           cache = (uu___138_2193.cache);
           nolabels = (uu___138_2193.nolabels);
           use_zfuel_name = (uu___138_2193.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___138_2193.encode_non_total_function_typ);
           current_module_name = (uu___138_2193.current_module_name)
         }))
...
let (new_term_constant :
  ...
  fun env  ->
    fun x  ->
      ...
      (ysym, y,
        (let uu___139_2211 = env  in
         {
           bindings = ((Binding_var (x, y)) :: (env.bindings));
           depth = (uu___139_2211.depth);
           tcenv = (uu___139_2211.tcenv);
           warn = (uu___139_2211.warn);
           cache = (uu___139_2211.cache);
           nolabels = (uu___139_2211.nolabels);
           use_zfuel_name = (uu___139_2211.use_zfuel_name);
           encode_non_total_function_typ =
             (uu___139_2211.encode_non_total_function_typ);
           current_module_name = (uu___139_2211.current_module_name)
         }))
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, [])  in
        (ysym, y,
          (let uu___140_2232 = env  in
           {
             bindings = ((Binding_var (x, y)) :: (env.bindings));
             depth = (uu___140_2232.depth);
             tcenv = (uu___140_2232.tcenv);
             warn = (uu___140_2232.warn);
             cache = (uu___140_2232.cache);
             nolabels = (uu___140_2232.nolabels);
             use_zfuel_name = (uu___140_2232.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___140_2232.encode_non_total_function_typ);
             current_module_name = (uu___140_2232.current_module_name)
           }))
...
let (push_term_var :
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___141_2242 = env  in
        {
          bindings = ((Binding_var (x, t)) :: (env.bindings));
          depth = (uu___141_2242.depth);
          tcenv = (uu___141_2242.tcenv);
          warn = (uu___141_2242.warn);
          cache = (uu___141_2242.cache);
          nolabels = (uu___141_2242.nolabels);
          use_zfuel_name = (uu___141_2242.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___141_2242.encode_non_total_function_typ);
          current_module_name = (uu___141_2242.current_module_name)
        }
      ...
      fun arity  ->
        ...
        let fvb =
          mk_fvb x fname arity (FStar_Pervasives_Native.Some ftok)
           ...
           in
        (fname, ftok_name,
          (let uu___142_2367 = env  in
           {
             bindings = ((Binding_fvar fvb) :: (env.bindings));
             depth = (uu___142_2367.depth);
             tcenv = (uu___142_2367.tcenv);
             warn = (uu___142_2367.warn);
             cache = (uu___142_2367.cache);
             nolabels = (uu___142_2367.nolabels);
             use_zfuel_name = (uu___142_2367.use_zfuel_name);
             encode_non_total_function_typ =
               (uu___142_2367.encode_non_total_function_typ);
             current_module_name = (uu___142_2367.current_module_name)
           }))
        ...
        fun fname  ->
          fun ftok  ->
            let fvb = mk_fvb x fname arity ftok FStar_Pervasives_Native.None
               in
            let uu___143_2433 = env  in
            {
              bindings = ((Binding_fvar fvb) :: (env.bindings));
              depth = (uu___143_2433.depth);
              tcenv = (uu___143_2433.tcenv);
              warn = (uu___143_2433.warn);
              cache = (uu___143_2433.cache);
              nolabels = (uu___143_2433.nolabels);
              use_zfuel_name = (uu___143_2433.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___143_2433.encode_non_total_function_typ);
              current_module_name = (uu___143_2433.current_module_name)
            }
      ...
      fun f  ->
        ...
        let fvb1 =
          mk_fvb x fvb.smt_id fvb.smt_arity fvb.smt_token
           ...
           in
        let uu___144_2461 = env  in
        {
          bindings = ((Binding_fvar fvb1) :: (env.bindings));
          depth = (uu___144_2461.depth);
          tcenv = (uu___144_2461.tcenv);
          warn = (uu___144_2461.warn);
          cache = (uu___144_2461.cache);
          nolabels = (uu___144_2461.nolabels);
          use_zfuel_name = (uu___144_2461.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___144_2461.encode_non_total_function_typ);
          current_module_name = (uu___144_2461.current_module_name)
        }
                   ...
                   | (vars,guards,env',decls,uu____5781) ->
                       ...
                       let uu____5802 =
                         FStar_TypeChecker_Util.pure_or_ghost_pre_and_post
                           (let uu___145_5811 = env.tcenv  in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___145_5811.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___145_5811.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___145_5811.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___145_5811.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___145_5811.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___145_5811.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___145_5811.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___145_5811.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___145_5811.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___145_5811.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___145_5811.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___145_5811.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___145_5811.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___145_5811.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___145_5811.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___145_5811.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___145_5811.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___145_5811.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___145_5811.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___145_5811.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___145_5811.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___145_5811.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___145_5811.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___145_5811.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___145_5811.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___145_5811.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___145_5811.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___145_5811.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth =
                                (uu___145_5811.FStar_TypeChecker_Env.synth);
                              FStar_TypeChecker_Env.splice =
                                (uu___145_5811.FStar_TypeChecker_Env.splice);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___145_5811.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___145_5811.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___145_5811.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___145_5811.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___145_5811.FStar_TypeChecker_Env.dep_graph)
                            }) res
                          in
  ...
  fun t  ->
    fun env  ->
      ...
      | (binders,pre,post,patterns) ->
          let env1 =
            let uu___146_9985 = env  in
            {
              bindings = (uu___146_9985.bindings);
              depth = (uu___146_9985.depth);
              tcenv = (uu___146_9985.tcenv);
              warn = (uu___146_9985.warn);
              cache = (uu___146_9985.cache);
              nolabels = (uu___146_9985.nolabels);
              use_zfuel_name = true;
              encode_non_total_function_typ =
                (uu___146_9985.encode_non_total_function_typ);
              current_module_name = (uu___146_9985.current_module_name)
            }  in
          let uu____9986 =
           ...
           | (vars,guards,env2,decls,uu____10011) ->
               ...
               (match uu____10024 with
                | (pats,decls') ->
                    ...
                    let env3 =
                      let uu___147_10256 = env2  in
                      {
                        bindings = (uu___147_10256.bindings);
                        depth = (uu___147_10256.depth);
                        tcenv = (uu___147_10256.tcenv);
                        warn = (uu___147_10256.warn);
                        cache = (uu___147_10256.cache);
                        nolabels = true;
                        use_zfuel_name = (uu___147_10256.use_zfuel_name);
                        encode_non_total_function_typ =
                          (uu___147_10256.encode_non_total_function_typ);
                        current_module_name =
                          (uu___147_10256.current_module_name)
                      }  in
                    let uu____10257 =
  ...
  fun phi  ->
    fun env  ->
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            let uu____10569 =
              let uu___148_10570 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___148_10570.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___148_10570.FStar_SMTEncoding_Term.freevars);
      ...
      let bin_op f uu___122_10649 =
        match uu___122_10649 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
        ...
        | (decls,phis) ->
            let uu____10761 =
              let uu___149_10762 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___149_10762.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___149_10762.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____10761, decls)
         in
      let eq_op r args =
        ...
        then
          ...
          (let uu____10872 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____10872 r rf)
         in
      let mk_imp1 r uu___123_10897 =
        match uu___123_10897 with
      ...
      let mk_ite r uu___124_10988 =
        match uu___124_10988 with
                  ...
                  | (tt,decls) ->
                      let uu____11981 =
                        FStar_SMTEncoding_Term.mk_Valid
                          (let uu___150_11984 = tt  in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___150_11984.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___150_11984.FStar_SMTEncoding_Term.freevars);
        ...
        | uu____11985 ->
            ...
            (match uu____11986 with
             | (tt,decls) ->
                 let uu____11997 =
                   FStar_SMTEncoding_Term.mk_Valid
                     (let uu___151_12000 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___151_12000.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___151_12000.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                                 ...
                                 (fun uu____12204  ->
                                    ...
                                    | (t,uu____12218) ->
                                        encode_smt_pattern t
                                          (let uu___152_12224 = env2  in
                                           {
                                             bindings =
                                               (uu___152_12224.bindings);
                                             depth = (uu___152_12224.depth);
                                             tcenv = (uu___152_12224.tcenv);
                                             warn = (uu___152_12224.warn);
                                             cache = (uu___152_12224.cache);
                                             nolabels =
                                               (uu___152_12224.nolabels);
                                             use_zfuel_name = true;
                                             encode_non_total_function_typ =
                                               (uu___152_12224.encode_non_total_function_typ);
                                             current_module_name =
                                               (uu___152_12224.current_module_name)
                                           })))
                             in
                            ...
                            then
                              let uu____17154 =
                                FStar_TypeChecker_Env.reify_comp
                                  (let uu___153_17157 = env.tcenv  in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___153_17157.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___153_17157.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___153_17157.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___153_17157.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___153_17157.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___153_17157.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       (uu___153_17157.FStar_TypeChecker_Env.expected_typ);
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___153_17157.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___153_17157.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___153_17157.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___153_17157.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___153_17157.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (uu___153_17157.FStar_TypeChecker_Env.letrecs);
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___153_17157.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___153_17157.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___153_17157.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___153_17157.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___153_17157.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax = true;
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___153_17157.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.failhard =
                                       (uu___153_17157.FStar_TypeChecker_Env.failhard);
                                     FStar_TypeChecker_Env.nosynth =
                                       (uu___153_17157.FStar_TypeChecker_Env.nosynth);
                                     FStar_TypeChecker_Env.tc_term =
                                       (uu___153_17157.FStar_TypeChecker_Env.tc_term);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___153_17157.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___153_17157.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.check_type_of =
                                       (uu___153_17157.FStar_TypeChecker_Env.check_type_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       (uu___153_17157.FStar_TypeChecker_Env.use_bv_sorts);
                                     FStar_TypeChecker_Env.qtbl_name_and_index
                                       =
                                       (uu___153_17157.FStar_TypeChecker_Env.qtbl_name_and_index);
                                     FStar_TypeChecker_Env.proof_ns =
                                       (uu___153_17157.FStar_TypeChecker_Env.proof_ns);
                                     FStar_TypeChecker_Env.synth =
                                       (uu___153_17157.FStar_TypeChecker_Env.synth);
                                     FStar_TypeChecker_Env.splice =
                                       (uu___153_17157.FStar_TypeChecker_Env.splice);
                                     FStar_TypeChecker_Env.is_native_tactic =
                                       (uu___153_17157.FStar_TypeChecker_Env.is_native_tactic);
                                     FStar_TypeChecker_Env.identifier_info =
                                       (uu___153_17157.FStar_TypeChecker_Env.identifier_info);
                                     FStar_TypeChecker_Env.tc_hooks =
                                       (uu___153_17157.FStar_TypeChecker_Env.tc_hooks);
                                     FStar_TypeChecker_Env.dsenv =
                                       (uu___153_17157.FStar_TypeChecker_Env.dsenv);
                                     FStar_TypeChecker_Env.dep_graph =
                                       (uu___153_17157.FStar_TypeChecker_Env.dep_graph)
                                  ...
                                  (match uu____17501 with
                                   | (guard,decls11) ->
                                       ...
                                       let uu____17552 =
                                         ...
                                         let uu____17590 =
                                           let env2 =
                                             let uu___154_17596 = env1  in
                                             {
                                               bindings =
                                                 (uu___154_17596.bindings);
                                               depth = (uu___154_17596.depth);
                                               tcenv = (uu___154_17596.tcenv);
                                               warn = (uu___154_17596.warn);
                                               cache = (uu___154_17596.cache);
                                               nolabels =
                                                 (uu___154_17596.nolabels);
                                               use_zfuel_name =
                                                 (uu___154_17596.use_zfuel_name);
                                               encode_non_total_function_typ;
                                               current_module_name =
                                                 (uu___154_17596.current_module_name)
                                             }  in
                                           let uu____17597 =
                                             let uu____17598 =
        ...
        | (is_rec,bindings) ->
                           ...
                           (fun uu____18446  ->
                              ...
                              | (x,i) ->
                                  let uu____18457 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___155_18458.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___155_18458.FStar_Syntax_Syntax.index);
            ...
            let destruct_bound_function flid t_norm e =
              let get_result_type c =
                ...
                then
                  FStar_TypeChecker_Env.reify_comp
                    (let uu___156_18544 = env.tcenv  in
                     {
                       FStar_TypeChecker_Env.solver =
                         (uu___156_18544.FStar_TypeChecker_Env.solver);
                       FStar_TypeChecker_Env.range =
                         (uu___156_18544.FStar_TypeChecker_Env.range);
                       FStar_TypeChecker_Env.curmodule =
                         (uu___156_18544.FStar_TypeChecker_Env.curmodule);
                       FStar_TypeChecker_Env.gamma =
                         (uu___156_18544.FStar_TypeChecker_Env.gamma);
                       FStar_TypeChecker_Env.gamma_cache =
                         (uu___156_18544.FStar_TypeChecker_Env.gamma_cache);
                       FStar_TypeChecker_Env.modules =
                         (uu___156_18544.FStar_TypeChecker_Env.modules);
                       FStar_TypeChecker_Env.expected_typ =
                         (uu___156_18544.FStar_TypeChecker_Env.expected_typ);
                       FStar_TypeChecker_Env.sigtab =
                         (uu___156_18544.FStar_TypeChecker_Env.sigtab);
                       FStar_TypeChecker_Env.is_pattern =
                         (uu___156_18544.FStar_TypeChecker_Env.is_pattern);
                       FStar_TypeChecker_Env.instantiate_imp =
                         (uu___156_18544.FStar_TypeChecker_Env.instantiate_imp);
                       FStar_TypeChecker_Env.effects =
                         (uu___156_18544.FStar_TypeChecker_Env.effects);
                       FStar_TypeChecker_Env.generalize =
                         (uu___156_18544.FStar_TypeChecker_Env.generalize);
                       FStar_TypeChecker_Env.letrecs =
                         (uu___156_18544.FStar_TypeChecker_Env.letrecs);
                       FStar_TypeChecker_Env.top_level =
                         (uu___156_18544.FStar_TypeChecker_Env.top_level);
                       FStar_TypeChecker_Env.check_uvars =
                         (uu___156_18544.FStar_TypeChecker_Env.check_uvars);
                       FStar_TypeChecker_Env.use_eq =
                         (uu___156_18544.FStar_TypeChecker_Env.use_eq);
                       FStar_TypeChecker_Env.is_iface =
                         (uu___156_18544.FStar_TypeChecker_Env.is_iface);
                       FStar_TypeChecker_Env.admit =
                         (uu___156_18544.FStar_TypeChecker_Env.admit);
                       FStar_TypeChecker_Env.lax = true;
                       FStar_TypeChecker_Env.lax_universes =
                         (uu___156_18544.FStar_TypeChecker_Env.lax_universes);
                       FStar_TypeChecker_Env.failhard =
                         (uu___156_18544.FStar_TypeChecker_Env.failhard);
                       FStar_TypeChecker_Env.nosynth =
                         (uu___156_18544.FStar_TypeChecker_Env.nosynth);
                       FStar_TypeChecker_Env.tc_term =
                         (uu___156_18544.FStar_TypeChecker_Env.tc_term);
                       FStar_TypeChecker_Env.type_of =
                         (uu___156_18544.FStar_TypeChecker_Env.type_of);
                       FStar_TypeChecker_Env.universe_of =
                         (uu___156_18544.FStar_TypeChecker_Env.universe_of);
                       FStar_TypeChecker_Env.check_type_of =
                         (uu___156_18544.FStar_TypeChecker_Env.check_type_of);
                       FStar_TypeChecker_Env.use_bv_sorts =
                         (uu___156_18544.FStar_TypeChecker_Env.use_bv_sorts);
                       FStar_TypeChecker_Env.qtbl_name_and_index =
                         (uu___156_18544.FStar_TypeChecker_Env.qtbl_name_and_index);
                       FStar_TypeChecker_Env.proof_ns =
                         (uu___156_18544.FStar_TypeChecker_Env.proof_ns);
                       FStar_TypeChecker_Env.synth =
                         (uu___156_18544.FStar_TypeChecker_Env.synth);
                       FStar_TypeChecker_Env.splice =
                         (uu___156_18544.FStar_TypeChecker_Env.splice);
                       FStar_TypeChecker_Env.is_native_tactic =
                         (uu___156_18544.FStar_TypeChecker_Env.is_native_tactic);
                       FStar_TypeChecker_Env.identifier_info =
                         (uu___156_18544.FStar_TypeChecker_Env.identifier_info);
                       FStar_TypeChecker_Env.tc_hooks =
                         (uu___156_18544.FStar_TypeChecker_Env.tc_hooks);
                       FStar_TypeChecker_Env.dsenv =
                         (uu___156_18544.FStar_TypeChecker_Env.dsenv);
                       FStar_TypeChecker_Env.dep_graph =
                         (uu___156_18544.FStar_TypeChecker_Env.dep_graph)
                            ...
                            let uu____19802 =
                              ...
                              | (tcenv',uu____19827,e_t) ->
                                  ...
                                  (match uu____19833 with
                                   | (e1,t_norm1) ->
                                       ((let uu___159_19860 = env2  in
                                         {
                                           bindings =
                                             (uu___159_19860.bindings);
                                           depth = (uu___159_19860.depth);
                                           tcenv = tcenv';
                                           warn = (uu___159_19860.warn);
                                           cache = (uu___159_19860.cache);
                                           nolabels =
                                             (uu___159_19860.nolabels);
                                           use_zfuel_name =
                                             (uu___159_19860.use_zfuel_name);
                                           encode_non_total_function_typ =
                                             (uu___159_19860.encode_non_total_function_typ);
                                           current_module_name =
                                             (uu___159_19860.current_module_name)
                                         }), e1, t_norm1))
                               in
                      ...
                      let encode_rec_lbdefs bindings1 typs2 toks1 env2 =
                        ...
                        | (gtoks,env3) ->
                                  ...
                                  let uu____20388 =
                                    ...
                                    | (tcenv',uu____20417,e_t) ->
                                        ...
                                        (match uu____20423 with
                                         | (e1,t_norm1) ->
                                             ((let uu___160_20450 = env3  in
                                               {
                                                 bindings =
                                                   (uu___160_20450.bindings);
                                                 depth =
                                                   (uu___160_20450.depth);
                                                 tcenv = tcenv';
                                                 warn = (uu___160_20450.warn);
                                                 cache =
                                                   (uu___160_20450.cache);
                                                 nolabels =
                                                   (uu___160_20450.nolabels);
                                                 use_zfuel_name =
                                                   (uu___160_20450.use_zfuel_name);
                                                 encode_non_total_function_typ
                                                   =
                                                   (uu___160_20450.encode_non_total_function_typ);
                                                 current_module_name =
                                                   (uu___160_20450.current_module_name)
                                               }), e1, t_norm1))
                                     in
                            ...
                            (match uu____21033 with
                             | (decls2,eqns,env01) ->
                                 let uu____21306 =
                                   let isDeclFun uu___126_21318 =
                                     match uu___126_21318 with
                                     | FStar_SMTEncoding_Term.DeclFun
                                         uu____21319 -> true
                     ...
                     let val_decl =
                       let uu___163_22280 = se  in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___163_22280.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___163_22280.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___163_22280.FStar_Syntax_Syntax.sigattrs)
                       }  in
           ...
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 let uu___164_22508 = se  in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___164_22508.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___164_22508.FStar_Syntax_Syntax.sigmeta);
                   FStar_Syntax_Syntax.sigattrs =
                     (uu___164_22508.FStar_Syntax_Syntax.sigattrs)
                 }  in
...
let (get_env : FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t) =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____25906 ->
          let uu___165_25909 = e  in
          let uu____25910 = FStar_Ident.string_of_lid cmn  in
          {
            bindings = (uu___165_25909.bindings);
            depth = (uu___165_25909.depth);
            tcenv;
            warn = (uu___165_25909.warn);
            cache = (uu___165_25909.cache);
            nolabels = (uu___165_25909.nolabels);
            use_zfuel_name = (uu___165_25909.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___165_25909.encode_non_total_function_typ);
...
let (push_env : Prims.unit -> Prims.unit) =
  fun uu____25969  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___166_26004 = hd1  in
          {
            bindings = (uu___166_26004.bindings);
            depth = (uu___166_26004.depth);
            tcenv = (uu___166_26004.tcenv);
            warn = (uu___166_26004.warn);
            cache = refs;
            nolabels = (uu___166_26004.nolabels);
            use_zfuel_name = (uu___166_26004.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___166_26004.encode_non_total_function_typ);
            current_module_name = (uu___166_26004.current_module_name)
          }  in
    ...
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____26121::uu____26122,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___167_26130 = a  in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___167_26130.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___167_26130.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___167_26130.FStar_SMTEncoding_Term.assumption_name);
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv  in
       ...
       let uu____26336 =
         encode_signature
           (let uu___168_26345 = env  in
            {
              bindings = (uu___168_26345.bindings);
              depth = (uu___168_26345.depth);
              tcenv = (uu___168_26345.tcenv);
              warn = false;
              cache = (uu___168_26345.cache);
              nolabels = (uu___168_26345.nolabels);
              use_zfuel_name = (uu___168_26345.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___168_26345.encode_non_total_function_typ);
              current_module_name = (uu___168_26345.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___169_26370 = env1  in
               {
                 bindings = (uu___169_26370.bindings);
                 depth = (uu___169_26370.depth);
                 tcenv = (uu___169_26370.tcenv);
                 warn = true;
                 cache = (uu___169_26370.cache);
                 nolabels = (uu___169_26370.nolabels);
                 use_zfuel_name = (uu___169_26370.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___169_26370.encode_non_total_function_typ);
                 current_module_name = (uu___169_26370.current_module_name)
               });
            (let uu____26372 =
                      ...
                      let uu____26515 =
                        let uu____26518 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___170_26521 = x  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___170_26521.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___170_26521.FStar_Syntax_Syntax.index);
