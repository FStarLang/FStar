                            ...
                            let uu____7933 =
                              ...
                              let uu____7968 =
                                let uu____7977 =
                                  ...
                                  (FStar_Syntax_Const.op_Minus, uu____7985)
                                   in
                                let uu____7999 =
                                  let uu____8008 =
                                    let uu____8016 =
                             ...
                             FStar_All.pipe_right quals
                               (FStar_List.collect
                                  (fun uu___115_10213  ->
                                     ...
                                     | uu____10315 -> []))
                              in
                           let uu____10316 = encode_binders None formals env1
                              in
                      ...
                      let uu____11003 =
                        let uu____11004 =
                          FStar_Syntax_Util.args_of_binders extra_formals1
                           in
                        FStar_All.pipe_left FStar_Pervasives.snd uu____11004
                         in
  ...
  fun env  ->
    fun se  ->
      let nm =
        ...
        match uu____12964 with | None  -> "" | Some l -> l.FStar_Ident.str
         in
          ...
          then ([], env)
            ...
            (let close_effect_params tm =
               ...
               | uu____13047 ->
                   ...
                   uu____13048 None tm.FStar_Syntax_Syntax.pos
                in
                   ...
                   then
                     ...
                     let uu____15321 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort
                        in
                     let uu____15322 = FStar_Syntax_Print.term_to_string t1
                        in
                        ...
                        | (xxsym,xx,env') ->
                            let t2 =
                              FStar_SMTEncoding_Term.mk_HasTypeWithFuel None
                               ...
                               in
                            let caption =
                              let uu____15351 = FStar_Options.log_queries ()
                                 in
                              if uu____15351
                              then
                                let uu____15353 =
                                  ...
                                  FStar_Util.format3 "%s : %s (%s)"
                                    uu____15354 uu____15355 uu____15356
                                   in
                                Some uu____15353
                              else None  in
                            let ax =
  ...
  fun env  ->
    fun lid  ->
      let uu____15692 =
        ...
        let uu____15696 = open_fact_db_tags env  in uu____15694 ::
          uu____15696
         in
              ...
              let uu____15740 =
                let uu____15741 =
                  FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se)
                   ...
                   in
                FStar_All.pipe_right uu____15741 (FStar_String.concat ", ")
                 in
    ...
    fun modul  ->
      let name =
        FStar_Util.format2 "%s %s"
         ...
         in
      (let uu____15769 = FStar_TypeChecker_Env.debug tcenv FStar_Options.Low
          in
       if uu____15769
       then
         let uu____15770 =
             ...
             (match uu____15969 with
              | (env_decls,env1) ->
                  ((let uu____15990 =
                    ...
                    if uu____15990
                    then
                      let uu____15991 = FStar_Syntax_Print.term_to_string q1
                         in
