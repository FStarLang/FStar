          ...
          let uu____9877 =
            FStar_Util.find_opt
              (fun uu____9895  ->
                 ...
                 | (l,uu____9905) -> FStar_Ident.lid_equals l t) prims1
             in
                              ...
                              (let uu____11759 =
                                 let uu____11763 =
                                   FStar_List.map
                                    ...
                                    in
                                 (f, uu____11763)  in
                               FStar_SMTEncoding_Util.mkApp uu____11759)
                         in
                      let uu____11768 =
                        (FStar_All.pipe_right quals
                           (FStar_Util.for_some
                      ...
                      then (decls1, env1)
                        ...
                        then
                               ...
                               let uu____11838 =
                                 ...
                                 | (tcenv',uu____11853,e_t) ->
                                     let uu____11857 =
                                       ...
                                       | uu____11864 -> failwith "Impossible"
                                        in
                          ...
                          (let fuel =
                             ...
                             (uu____12014, FStar_SMTEncoding_Term.Fuel_sort)
                              in
  ...
  fun env  ->
    fun se  ->
      ...
      (let nm =
         ...
         match uu____12913 with | None  -> "" | Some l -> l.FStar_Ident.str
          in
                       ...
                       let uu____12983 =
                         let uu____12998 =
                           FStar_All.pipe_left (fun _0_37  -> Some _0_37)
                            ...
                            in
                         ((ed.FStar_Syntax_Syntax.binders), tm, uu____12998)
                          in
                       FStar_Syntax_Syntax.Tm_abs uu____12983  in
                     FStar_Syntax_Syntax.mk uu____12982  in
                   uu____12979 None tm.FStar_Syntax_Syntax.pos
                in
                                  ...
                                  let a_eq =
                                    let uu____13241 =
                                      ...
                                      (uu____13245, (Some "Action equality"),
                                       ...
                                       in
                                    FStar_SMTEncoding_Term.Assume uu____13241
                                     in
                                  let tok_correspondence =
                                    ...
                                    let uu____13268 =
                                      ...
                                      (uu____13272,
                                       ...
                                       in
                                    FStar_SMTEncoding_Term.Assume uu____13268
                                     in
                                  (env2,
                                    (FStar_List.append decls
                        ...
                        FStar_All.pipe_right args
                          (FStar_List.map
                             (fun uu____13729  ->
                                ...
                                | (uu____13733,sort,uu____13735) -> sort))
                         in
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right uu____13756 FStar_Option.isNone))
               in
            if uu____13753
            then []
            else
                                               ...
                                               let uu____13839 =
                                                 let uu____13840 =
                                                   FStar_Syntax_Subst.compress
                                                     res
                                                    in
                                                 uu____13840.FStar_Syntax_Syntax.n
                                                  in
                                 ...
                                 let uu____13990 =
                                   let uu____13991 =
                                     ...
                                     (uu____13995, (Some "inversion axiom"),
                                       uu____14018)
                                      in
                                   FStar_SMTEncoding_Term.Assume uu____13991
                                    in
                                 [uu____13990]
                               else []  in
                             FStar_List.append decls
                                ...
                                let tname_decl =
                                  let uu____14131 =
                                    ...
                                    (tname, uu____14132,
                                      ...
                                      uu____14155, false)
                                     in
                                  constructor_or_logic_type_decl uu____14131
                                   in
                                let uu____14160 =
                                  match vars with
                                  | [] ->
                                           ...
                                           let uu____14250 =
                                             let uu____14252 =
                                               ...
                                               FStar_SMTEncoding_Term.Assume
                                                ...
                                                in
                                             [uu____14252]  in
                                           FStar_List.append karr uu____14250
                                            in
                                         FStar_List.append decls1 uu____14248
                                      in
                                   let aux =
                                     let uu____14273 =
                                       let uu____14275 =
                                       ...
                                       FStar_List.append uu____14275
                                         uu____14277
                                        in
                                     FStar_List.append kindingAx uu____14273
                                      in
                                   let g =
                                     FStar_List.append decls
...
let get_env : FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____15250 ->
          let uu___166_15252 = e  in
          let uu____15253 = FStar_Ident.string_of_lid cmn  in
          {
            bindings = (uu___166_15252.bindings);
            depth = (uu___166_15252.depth);
            tcenv;
            warn = (uu___166_15252.warn);
            cache = (uu___166_15252.cache);
            nolabels = (uu___166_15252.nolabels);
            use_zfuel_name = (uu___166_15252.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___166_15252.encode_non_total_function_typ);
...
let push_env : Prims.unit -> Prims.unit =
  fun uu____15270  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___167_15292 = hd1  in
          {
            bindings = (uu___167_15292.bindings);
            depth = (uu___167_15292.depth);
            tcenv = (uu___167_15292.tcenv);
            warn = (uu___167_15292.warn);
            cache = refs;
            nolabels = (uu___167_15292.nolabels);
            use_zfuel_name = (uu___167_15292.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___167_15292.encode_non_total_function_typ);
            current_module_name = (uu___167_15292.current_module_name)
          }  in
              ...
              let uu____15380 =
                let uu____15381 =
                  FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se)
                   ...
                   in
                FStar_All.pipe_right uu____15381 (FStar_String.concat ", ")
                 in
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv  in
       let uu____15412 =
         encode_signature
           (let uu___168_15416 = env  in
            {
              bindings = (uu___168_15416.bindings);
              depth = (uu___168_15416.depth);
              tcenv = (uu___168_15416.tcenv);
              warn = false;
              cache = (uu___168_15416.cache);
              nolabels = (uu___168_15416.nolabels);
              use_zfuel_name = (uu___168_15416.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___168_15416.encode_non_total_function_typ);
              current_module_name = (uu___168_15416.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___169_15433 = env1  in
               {
                 bindings = (uu___169_15433.bindings);
                 depth = (uu___169_15433.depth);
                 tcenv = (uu___169_15433.tcenv);
                 warn = true;
                 cache = (uu___169_15433.cache);
                 nolabels = (uu___169_15433.nolabels);
                 use_zfuel_name = (uu___169_15433.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___169_15433.encode_non_total_function_typ);
                 current_module_name = (uu___169_15433.current_module_name)
               });
            (let uu____15435 =
                      ...
                      let uu____15528 =
                        let uu____15530 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___170_15531 = x  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___170_15531.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___170_15531.FStar_Syntax_Syntax.index);
         ...
         | (q1,bindings1) ->
             let uu____15565 =
               let uu____15568 =
                 FStar_List.filter
                   (fun uu___139_15570  ->
                      match uu___139_15570 with
                      | FStar_TypeChecker_Env.Binding_sig uu____15571 ->
                          false
                      | uu____15575 -> true) bindings1
                  in
                                  ...
                                  let qry =
                                    let uu____15635 =
                                      ...
                                      (uu____15639, (Some "query"),
                                        uu____15640)
                                       in
                                    FStar_SMTEncoding_Term.Assume uu____15635
                                     in
                                  let suffix =
                                    let uu____15644 =
                                      let uu____15646 =
