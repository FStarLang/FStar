                 ...
                 then
                   ...
                   (let encode_non_total_function_typ =
                    ...
                    | (formals, (pre_opt, res_t)) ->
                        ...
                        (match uu___5 with
                         | (vars, uu___6, guards, env', decls1, uu___7) ->
                             let uu___8 =
                               match pre_opt with
                               | FStar_Pervasives_Native.None ->
                                   let uu___9 =
                              ...
                              | (guard, decls11) ->
                                  ...
                                  let should_thunk uu___9 =
                                    let is_type t =
                                      ...
                                      match uu___10 with
                                      | FStar_Syntax_Syntax.Tm_type uu___11
                                          -> true
                                      | uu___11 -> false in
                                    let is_squash t =
                                      let uu___10 =
                                      ...
                                      | (head, uu___11) ->
                                          ...
                                          (match uu___12 with
                                           ...
                                           | uu___13 -> false) in
                                    (((let uu___10 = FStar_Ident.nsstr lid in
                                       uu___10 <> "Prims") &&
                                        (let uu___10 =
                                           FStar_All.pipe_right quals
                                             (FStar_List.contains
             ...
             | (formals, res) ->
                 let uu___4 =
                   FStar_SMTEncoding_EncodeTerm.encode_binders
                     FStar_Pervasives_Native.None formals env in
                 (match uu___4 with
                  | (vars, uu___5, guards, env', binder_decls, uu___6) ->
                                      ...
                                      let tot_fun_axioms =
                                        let uu___11 =
                                          FStar_List.map
                                            ...
                                            vars in
                                        FStar_SMTEncoding_EncodeTerm.isTotFun_axioms
                                          rng ttok_tm vars uu___11 true in
                                      let uu___11 =
                                        let uu___12 =
                                          let uu___13 =
                                            let uu___14 =
                                              ...
                                              FStar_SMTEncoding_Util.mkAssume
                                                uu___15 in
                                            [uu___14] in
                                          FStar_List.append karr uu___13 in
                                        FStar_All.pipe_right uu___12
                                          FStar_SMTEncoding_Term.mk_decls_trivial in
                                      FStar_List.append decls1 uu___11 in
                                let aux =
                                  let uu___9 =
                                    let uu___10 = inversion_axioms tapp vars in
                                    let uu___11 =
                                      let uu___12 =
                                        let uu___13 =
                                          let uu___14 =
                                  ...
                                  FStar_List.append kindingAx uu___9 in
                                let g =
                                  let uu___9 =
                                    FStar_All.pipe_right decls
                                      FStar_SMTEncoding_Term.mk_decls_trivial in
                      ...
                      | (fuel_var, fuel_tm) ->
                          ...
                          let uu___7 =
                            FStar_SMTEncoding_EncodeTerm.encode_binders
                              ...
                              env1 in
                          (match uu___7 with
                           | (vars, vars_sorts, guards, env', binder_decls,
                              names) ->
                               let fields =
                                ...
                                | (uu___9, tok_typing, decls3) ->
                                    let tok_typing1 =
                                      ...
                                      | uu___10::uu___11 ->
                                          ...
                                          FStar_SMTEncoding_Term.mkForall
                                            uu___12 uu___13
                                      | uu___10 -> tok_typing in
                                    let uu___10 =
                                      FStar_SMTEncoding_EncodeTerm.encode_binders
                                        (FStar_Pervasives_Native.Some fuel_tm)
                                        formals env1 in
                                    (match uu___10 with
                                     | (vars', uu___11, guards', env'',
                                        decls_formals, uu___12) ->
                                         let uu___13 =
                                           let xvars1 =
                                             FStar_List.map
                                               FStar_SMTEncoding_Util.mkFreeV
