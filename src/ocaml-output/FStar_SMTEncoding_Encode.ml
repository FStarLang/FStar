...
let varops : varops_t =
  ...
  let new_var pp rn =
    let _0_308 =
      let _0_307 =
        let _0_306 = FStar_Util.string_of_int rn  in Prims.strcat "__" _0_306
         in
...
let fresh_fvar :
  ...
  fun x  ->
    fun s  ->
      ...
      let _0_320 = FStar_SMTEncoding_Util.mkFreeV (xsym, s)  in
      (xsym, _0_320)
        ...
        | (t1,t2,uu____1145) ->
            let t3 =
              FStar_SMTEncoding_Util.mkApp
                (let _0_332 =
                   let _0_331 = FStar_SMTEncoding_Util.mkApp ("ZFuel", [])
                      in
                   [_0_331]  in
                 (f, _0_332))
               in
                           ...
                           let _0_337 =
                             let _0_336 =
                               FStar_SMTEncoding_Util.mkFreeV
                                ...
                                in
                             FStar_SMTEncoding_Term.mk_ApplyTF _0_336 fuel
                              in
               ...
               | FStar_SMTEncoding_Term.App
                   ...
                   let guard =
                     ...
                     | uu____1406 ->
                         ...
                         FStar_All.pipe_right _0_339 FStar_List.hd
                      in
...
let trivial_post : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun t  ->
    let _0_344 = let _0_342 = FStar_Syntax_Syntax.null_binder t  in [_0_342]
       in
    let _0_343 =
          ...
          | (t,decls) ->
              (match fuel_opt with
               | None  ->
                   ...
                   (_0_358, decls)
               | Some f ->
                   let _0_359 = FStar_SMTEncoding_Term.mk_HasTypeFuel f e t
                      in
                   (_0_359, decls))
           ...
           let uu____2521 =
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 (match uu____2538 with
                  | (b,f) ->
                      let _0_391 = Prims.fst (FStar_List.hd b)  in
                      (_0_391, f))
                         ...
                         (varops.mk_unique
                            (let _0_405 =
                               ...
                               FStar_All.pipe_left FStar_Util.string_of_int
                                 _0_404
                                in
                             FStar_Util.format1 "uvar_typing_%s" _0_405))
                        in
                     (t_has_k, (Some "Uvar typing"), _0_406))
                   in
                     ...
                     let e0 =
                       (FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                             (let _0_411 =
                                let _0_410 = FStar_List.hd args_e  in
                                [_0_410]  in
                              (head, _0_411)))) None
                       ...
                       (FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                             (let _0_412 = FStar_List.tl args_e  in
                              (e0, _0_412)))) None t0.FStar_Syntax_Syntax.pos
                        in
                     encode_term e env
                 | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify
                    ),(arg,uu____2991)::[]) ->
                               ...
                               let head_type =
                                 let _0_419 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine _0_419
                                  in
                               let uu____3333 =
           ...
           (match uu____3403 with
            | (bs,body,opening) ->
                  ...
                  | FStar_Util.Inr (eff,uu____3443) ->
                      let _0_421 =
                        FStar_TypeChecker_Util.is_pure_or_ghost_effect
                          env.tcenv eff
                         in
                      FStar_All.pipe_right _0_421 Prims.op_Negation
                   in
                let codomain_eff lc =
                  match lc with
                  | FStar_Util.Inl lc ->
                ...
                (match lopt with
                 | None  ->
                     ((let _0_431 =
                         let _0_430 = FStar_Syntax_Print.term_to_string t0
                            in
                         FStar_Util.format1
                                  ...
                                  | (arg,uu____4229) ->
                                      ...
                                      let _0_452 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg _0_452))
                         in
                      FStar_All.pipe_right _0_453 FStar_List.flatten
                   in
          ...
          let lemma_pats p =
            ...
            let smt_pat_or t =
              let uu____4504 =
                ...
                FStar_All.pipe_right _0_456 FStar_Syntax_Util.head_and_args
                 in
                               ...
                               let uu____4953 =
                                 let _0_463 =
                                   FStar_All.pipe_right branch
                                    ...
                                    in
                                 FStar_All.pipe_right _0_463 FStar_List.unzip
                                  in
      ...
      let connectives =
        ...
        let _0_494 =
          ...
          let _0_492 =
            let _0_491 =
              let _0_490 =
                let _0_485 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)
                   in
                 ...
                 (match uu____5841 with
                  | (x,decls) ->
                      ...
                      (match uu____5848 with
                       | (t,decls') ->
                           let _0_498 = FStar_SMTEncoding_Term.mk_HasType x t
                              in
               ...
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      ...
                      FStar_Util.set_union out _0_507) _0_508 tl
                in
             let uu____6188 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu____6322 = encode_q_body env vars pats body  in
             ...
             | (vars,pats,guard,body,decls) ->
                 let tm =
                   let _0_512 =
                     let _0_511 = FStar_SMTEncoding_Util.mkImp (guard, body)
                        in
                     (pats, vars, _0_511)  in
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu____6359 = encode_q_body env vars pats body  in
             ...
             | (vars,pats,guard,body,decls) ->
                 let _0_515 =
                   let _0_514 =
                     let _0_513 = FStar_SMTEncoding_Util.mkAnd (guard, body)
                        in
                     (pats, vars, _0_513)  in
                    ...
                    FStar_SMTEncoding_Term.DeclFun
                      (let _0_516 =
                         FStar_All.pipe_right vars (FStar_List.map Prims.snd)
                          in
                       (x, _0_516, FStar_SMTEncoding_Term.Term_sort, None))
                     in
                          ...
                          let _0_537 =
                            let _0_536 =
                              FStar_SMTEncoding_Util.mkLT
                               ...
                               in
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool _0_536
                             in
                          quant xy _0_537  in
                            ...
                            let _0_542 =
                              let _0_541 =
                                FStar_SMTEncoding_Util.mkLTE
                                 ...
                                 in
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool _0_541
                               in
                            quant xy _0_542  in
                              ...
                              let _0_547 =
                                let _0_546 =
                                  FStar_SMTEncoding_Util.mkGT
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_SMTEncoding_Term.boxBool _0_546
                                 in
                              quant xy _0_547  in
                                ...
                                let _0_552 =
                                  let _0_551 =
                                    FStar_SMTEncoding_Util.mkGTE
                                     ...
                                     in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool _0_551
                                   in
                                quant xy _0_552  in
                                  ...
                                  let _0_557 =
                                    let _0_556 =
                                      FStar_SMTEncoding_Util.mkSub
                                       ...
                                       in
                                    FStar_All.pipe_left
                                      FStar_SMTEncoding_Term.boxInt _0_556
                                     in
                                  quant xy _0_557  in
                                (FStar_Syntax_Const.op_Subtraction, _0_558)
                                 in
                              let _0_610 =
                                let _0_609 =
                                  let _0_561 =
                                    let _0_560 =
                                      let _0_559 =
                                        FStar_SMTEncoding_Util.mkMinus
                                         ...
                                         in
                                      FStar_All.pipe_left
                                        FStar_SMTEncoding_Term.boxInt _0_559
                                       in
                                    quant qx _0_560  in
                                    ...
                                    let _0_566 =
                                      let _0_565 =
                                        ...
                                        FStar_All.pipe_left
                                         ...
                                         in
                                      quant xy _0_565  in
                                    (FStar_Syntax_Const.op_Addition, _0_566)
                                     in
                                  let _0_606 =
                                    let _0_605 =
                                      let _0_571 =
               ...
               FStar_SMTEncoding_Term.Assume
                 (let _0_631 =
                  ...
                  let _0_630 =
                    Some
                      (varops.mk_unique
                         (let _0_629 = FStar_Util.digest_of_string tapp_hash
                             in
                          Prims.strcat "pretyping_" _0_629))
                     in
...
let primitive_type_axioms :
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_632 =
           FStar_SMTEncoding_Term.mk_HasType
            ...
            in
         (_0_632, (Some "unit typing"), (Some "unit_typing")))
       in
    let _0_637 =
      let _0_636 =
        FStar_SMTEncoding_Term.Assume
               ...
               (let _0_634 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_633 =
                     ...
                     (typing_pred, _0_633))
                   in
                ([[typing_pred]], [xx], _0_634))
              in
           (_0_635, (Some "unit inversion"), (Some "unit_inversion")))
         in
      [_0_636]  in
    _0_638 :: _0_637  in
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_644 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_643 =
                let _0_640 =
                  let _0_639 = FStar_SMTEncoding_Term.boxBool b  in [_0_639]
                   in
                [_0_640]  in
              let _0_642 =
              ...
              (_0_643, [bb], _0_642))
            in
         (_0_644, (Some "bool typing"), (Some "bool_typing")))
       in
    let _0_649 =
      let _0_648 =
        FStar_SMTEncoding_Term.Assume
               ...
               (let _0_646 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_645 =
                     ...
                     (typing_pred, _0_645))
                   in
                ([[typing_pred]], [xx], _0_646))
              in
           (_0_647, (Some "bool inversion"), (Some "bool_inversion")))
         in
      [_0_648]  in
    _0_650 :: _0_649  in
          ...
          (let _0_656 =
             let _0_655 =
               let _0_654 =
                 ...
                 let _0_652 =
                   let _0_651 = FStar_SMTEncoding_Term.boxInt b  in [_0_651]
                    in
                 _0_653 :: _0_652  in
               tt :: _0_654  in
             tt :: _0_655  in
           ("Prims.Precedes", _0_656))
         in
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_664 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_663 =
                let _0_660 =
                  let _0_659 = FStar_SMTEncoding_Term.boxInt b  in [_0_659]
                   in
                [_0_660]  in
              let _0_662 =
              ...
              (_0_663, [bb], _0_662))
            in
         (_0_664, (Some "int typing"), (Some "int_typing")))
       in
    let _0_687 =
      let _0_686 =
        FStar_SMTEncoding_Term.Assume
          (let _0_667 =
             mkForall_fuel
               (let _0_666 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_665 = FStar_SMTEncoding_Term.mk_tester "BoxInt" x
                        in
                     (typing_pred, _0_665))
                   in
                ([[typing_pred]], [xx], _0_666))
              in
           (_0_667, (Some "int inversion"), (Some "int_inversion")))
         in
      let _0_685 =
        let _0_684 =
          FStar_SMTEncoding_Term.Assume
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_694 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_693 =
                let _0_690 =
                  let _0_689 = FStar_SMTEncoding_Term.boxString b  in
                  [_0_689]  in
                [_0_690]  in
              let _0_692 =
              ...
              (_0_693, [bb], _0_692))
            in
         (_0_694, (Some "string typing"), (Some "string_typing")))
       in
    let _0_699 =
      let _0_698 =
        FStar_SMTEncoding_Term.Assume
               ...
               (let _0_696 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_695 =
                     ...
                     (typing_pred, _0_695))
                   in
                ([[typing_pred]], [xx], _0_696))
              in
           (_0_697, (Some "string inversion"), (Some "string_inversion")))
         in
      [_0_698]  in
    _0_700 :: _0_699  in
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_707 =
           mkForall_fuel
             (let _0_706 =
                FStar_SMTEncoding_Util.mkImp
                  (let _0_705 = FStar_SMTEncoding_Term.mk_tester "BoxRef" x
                      in
                   (typing_pred, _0_705))
                 in
              ([[typing_pred]], [xx; aa], _0_706))
            in
         (_0_707, (Some "ref inversion"), (Some "ref_inversion")))
       in
    let _0_716 =
      let _0_715 =
        FStar_SMTEncoding_Term.Assume
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_718 =
           FStar_SMTEncoding_Util.mkIff
            ...
            in
         (_0_718, (Some "False interpretation"), (Some "false_interp")))
       in
    [_0_719]  in
        ...
        (let _0_724 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_723 =
              ...
              ([[valid]], [aa; bb], _0_723))
            in
         (_0_724, (Some "/\\ interpretation"), (Some "l_and-interp")))
       in
    [_0_725]  in
        ...
        (let _0_730 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_729 =
              ...
              ([[valid]], [aa; bb], _0_729))
            in
         (_0_730, (Some "\\/ interpretation"), (Some "l_or-interp")))
       in
    [_0_731]  in
             ...
             (let _0_735 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_734 = FStar_SMTEncoding_Util.mkEq (x, y)  in
                   (_0_734, valid))
                 in
              ([[valid]], [aa; xx; yy], _0_735))
            in
         (_0_736, (Some "Eq2 interpretation"), (Some "eq2-interp")))
       in
    [_0_737]  in
             ...
             (let _0_741 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_740 = FStar_SMTEncoding_Util.mkEq (x, y)  in
                   (_0_740, valid))
                 in
              ([[valid]], [aa; bb; xx; yy], _0_741))
            in
         (_0_742, (Some "Eq3 interpretation"), (Some "eq3-interp")))
       in
    [_0_743]  in
        ...
        (let _0_748 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_747 =
              ...
              ([[valid]], [aa; bb], _0_747))
            in
         (_0_748, (Some "==> interpretation"), (Some "l_imp-interp")))
       in
    [_0_749]  in
        ...
        (let _0_754 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_753 =
              ...
              ([[valid]], [aa; bb], _0_753))
            in
         (_0_754, (Some "<==> interpretation"), (Some "l_iff-interp")))
       in
    [_0_755]  in
  let mk_not_interp env l_not tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_757 =
           let _0_756 = FStar_SMTEncoding_Util.mkApp (l_not, [a])  in
           [_0_756]  in
         ("Valid", _0_757))
       in
    let not_valid_a =
    ...
    let _0_761 =
      FStar_SMTEncoding_Term.Assume
        (let _0_760 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_759 = FStar_SMTEncoding_Util.mkIff (not_valid_a, valid)
                 in
              ([[valid]], [aa], _0_759))
            in
         (_0_760, (Some "not interpretation"), (Some "l_not-interp")))
       in
    [_0_761]  in
        ...
        (let _0_773 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_772 =
              ...
              ([[valid]], [aa; bb], _0_772))
            in
         (_0_773, (Some "forall interpretation"), (Some "forall-interp")))
       in
    [_0_774]  in
  let mk_exists_interp env for_some tt =
    ...
    let valid_b_x =
      FStar_SMTEncoding_Util.mkApp
        (let _0_778 =
           let _0_777 = FStar_SMTEncoding_Util.mk_ApplyTT b x  in [_0_777]
            in
         ("Valid", _0_778))
       in
    let _0_787 =
        ...
        (let _0_786 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_785 =
              ...
              ([[valid]], [aa; bb], _0_785))
            in
         (_0_786, (Some "exists interpretation"), (Some "exists-interp")))
       in
    [_0_787]  in
    ...
    let _0_790 =
      FStar_SMTEncoding_Term.Assume
        (let _0_789 =
         ...
         (_0_789, (Some "Range_const typing"), _0_788))
       in
    [_0_790]  in
  let prims =
                    ...
                    let _0_837 =
                      let _0_836 =
                        (FStar_Syntax_Subst.subst subst t).FStar_Syntax_Syntax.n
                         in
                      FStar_All.pipe_left (fun _0_835  -> Some _0_835) _0_836
                       in
                       ...
                       (FStar_List.map
                          (fun lb  ->
                             FStar_Syntax_Print.lbname_to_string
                               lb.FStar_Syntax_Syntax.lbname))
                      in
                   FStar_All.pipe_right _0_896 (FStar_String.concat " and ")
                    in
                 let decl =
                                             ...
                                             (match uu____10531 with
                                              | (xxsym,xx,uu____10541) ->
                                                  ((xxsym,
                                                    ...
                                                    xx))))
                                  in
                               FStar_All.pipe_right _0_911 FStar_List.split
                                in
               ...
               let g =
                 let _0_924 =
                   FStar_SMTEncoding_Term.Assume
                     (let _0_923 =
                        Some
                          (let _0_921 = FStar_Syntax_Print.lid_to_string l
                              in
                           FStar_Util.format1 "Assumption: %s" _0_921)
                         in
                      let _0_922 =
                        Some
                          (varops.mk_unique
                            ...
                            (let _0_929 =
                               FStar_SMTEncoding_Util.mkEq
                                 (let _0_928 =
                                  ...
                                  (valid_b2t_x, _0_928))
                                in
                             ([[valid_b2t_x]], [xx], _0_929))
                           in
                        (_0_930, (Some "b2t def"), (Some "b2t_def")))
                      in
                   [_0_931]  in
                 (FStar_SMTEncoding_Term.DeclFun
                    (tname, [FStar_SMTEncoding_Term.Term_sort],
                 ...
                 | (formals,comp) ->
                     let reified_typ =
                       FStar_TypeChecker_Util.reify_comp
                        ...
                        in
                     let _0_934 = FStar_Syntax_Syntax.mk_Total reified_typ
                        in
                     FStar_Syntax_Util.arrow formals _0_934
                  in
               let lb =
                    ...
                    FStar_SMTEncoding_Term.DeclFun
                      (let _0_935 =
                         FStar_All.pipe_right args
                          ...
                          in
                       (name, _0_935, FStar_SMTEncoding_Term.Term_sort, None))
                     in
                  [_0_936]
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right _0_937 FStar_Option.isNone))
               in
            if uu____11109
            then []
            else
                                    ...
                                    Some
                                      (varops.mk_unique
                                         (Prims.strcat
                                            ...
                                            t.FStar_Ident.str))
                                     in
                                  (_0_949, (Some "inversion axiom"), _0_948))
                                in
                               ...
                               | (decls,env) ->
                                   let kindingAx =
                                     ...
                                     | (k,decls) ->
                                         ...
                                         FStar_List.append decls _0_972
                                      in
                                   let aux =
                                     let _0_976 =
                                       let _0_975 =
                                       ...
                                       let _0_974 =
                                         let _0_973 = pretype_axiom tapp vars
                                            in
                                         [_0_973]  in
                  ...
                  (let uu____12040 = encode_term t1 env  in
                   ...
                   | (t,decls') ->
                       ...
                       let uu____12050 =
                         let _0_1038 =
                           let _0_1037 =
                             let _0_1036 = FStar_Util.digest_of_string t_hash
                                in
                             let _0_1035 =
          ...
          let _0_1051 =
            FStar_SMTEncoding_Term.Caption
              (let _0_1050 =
               ...
               Prims.strcat "encoding sigelt " _0_1050)
             in
          _0_1051 :: decls
        else decls  in
              ...
              | (env_decls,env) ->
                  ((let uu____12549 =
                   ...
                   (let uu____12551 = encode_formula q env  in
                    ...
                    | (phi,qdecls) ->
                        let uu____12563 =
                          let _0_1058 = FStar_TypeChecker_Env.get_range tcenv
                             in
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg _0_1058 phi
                           in
                                  ...
                                  let suffix =
                                    let _0_1062 =
                                      ...
                                      FStar_List.append _0_1061
                                       ...
                                       in
                                    FStar_List.append label_suffix _0_1062
                                     in
