                     ...
                     let val_decl =
                       let uu___167_13414 = se in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___167_13414.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (uu___167_13414.FStar_Syntax_Syntax.sigquals);
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___167_13414.FStar_Syntax_Syntax.sigmeta)
                       } in
           ...
           | None  ->
               let se1 =
                 let uu___168_13571 = se in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___168_13571.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___168_13571.FStar_Syntax_Syntax.sigmeta)
                 } in
...
let get_env: FStar_Ident.lident -> FStar_TypeChecker_Env.env -> env_t =
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____15217 ->
          let uu___169_15219 = e in
          let uu____15220 = FStar_Ident.string_of_lid cmn in
          {
            bindings = (uu___169_15219.bindings);
            depth = (uu___169_15219.depth);
            tcenv;
            warn = (uu___169_15219.warn);
            cache = (uu___169_15219.cache);
            nolabels = (uu___169_15219.nolabels);
            use_zfuel_name = (uu___169_15219.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___169_15219.encode_non_total_function_typ);
...
let push_env: Prims.unit -> Prims.unit =
  fun uu____15237  ->
    ...
    | hd1::tl1 ->
        ...
        let top =
          let uu___170_15259 = hd1 in
          {
            bindings = (uu___170_15259.bindings);
            depth = (uu___170_15259.depth);
            tcenv = (uu___170_15259.tcenv);
            warn = (uu___170_15259.warn);
            cache = refs;
            nolabels = (uu___170_15259.nolabels);
            use_zfuel_name = (uu___170_15259.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___170_15259.encode_non_total_function_typ);
            current_module_name = (uu___170_15259.current_module_name)
          } in
  ...
  fun tcenv  ->
    fun modul  ->
      ...
      (let env = get_env modul.FStar_Syntax_Syntax.name tcenv in
       let uu____15379 =
         encode_signature
           (let uu___171_15383 = env in
            {
              bindings = (uu___171_15383.bindings);
              depth = (uu___171_15383.depth);
              tcenv = (uu___171_15383.tcenv);
              warn = false;
              cache = (uu___171_15383.cache);
              nolabels = (uu___171_15383.nolabels);
              use_zfuel_name = (uu___171_15383.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___171_15383.encode_non_total_function_typ);
              current_module_name = (uu___171_15383.current_module_name)
       ...
       | (decls,env1) ->
           ...
           (set_env
              (let uu___172_15400 = env1 in
               {
                 bindings = (uu___172_15400.bindings);
                 depth = (uu___172_15400.depth);
                 tcenv = (uu___172_15400.tcenv);
                 warn = true;
                 cache = (uu___172_15400.cache);
                 nolabels = (uu___172_15400.nolabels);
                 use_zfuel_name = (uu___172_15400.use_zfuel_name);
                 encode_non_total_function_typ =
                   (uu___172_15400.encode_non_total_function_typ);
                 current_module_name = (uu___172_15400.current_module_name)
               });
            (let uu____15402 =
                      ...
                      let uu____15495 =
                        let uu____15497 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___173_15498 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___173_15498.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___173_15498.FStar_Syntax_Syntax.index);
