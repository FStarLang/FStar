...
Some (FStar_Util.Inl ((let _0_264 = (let _0_263 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp s _0_263))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _0_264))))
end
| uu____118 -> begin
l
end))
...
let uu___134_132 = a
in (let _0_265 = (FStar_Syntax_Util.unmangle_field_name a.FStar_Syntax_Syntax.ppname)
in {FStar_Syntax_Syntax.ppname = _0_265; FStar_Syntax_Syntax.index = uu___134_132.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___134_132.FStar_Syntax_Syntax.sort}))
in (let _0_266 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str a.FStar_Syntax_Syntax.ppname.FStar_Ident.idText)
in (FStar_All.pipe_left escape _0_266))))


let primitive_projector_by_pos : FStar_TypeChecker_Env.env  ->  FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun env lid i -> (

let fail = (fun uu____145 -> (failwith (let _0_267 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "Projector %s on data constructor %s not found" _0_267 lid.FStar_Ident.str))))
in (
...
let mk_term_projector_name_by_pos : FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun lid i -> (let _0_269 = (let _0_268 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str _0_268))
in (FStar_All.pipe_left escape _0_269)))


let mk_term_projector : FStar_Ident.lident  ->  FStar_Syntax_Syntax.bv  ->  FStar_SMTEncoding_Term.term = (fun lid a -> (FStar_SMTEncoding_Util.mkFreeV (let _0_270 = (mk_term_projector_name lid a)
in ((_0_270), (FStar_SMTEncoding_Term.Arrow (((FStar_SMTEncoding_Term.Term_sort), (FStar_SMTEncoding_Term.Term_sort))))))))


let mk_term_projector_by_pos : FStar_Ident.lident  ->  Prims.int  ->  FStar_SMTEncoding_Term.term = (fun lid i -> (FStar_SMTEncoding_Util.mkFreeV (let _0_271 = (mk_term_projector_name_by_pos lid i)
...
let new_scope = (fun uu____387 -> (let _0_273 = (FStar_Util.smap_create (Prims.parse_int "100"))
in (let _0_272 = (FStar_Util.smap_create (Prims.parse_int "100"))
in ((_0_273), (_0_272)))))
in (

let scopes = (FStar_Util.mk_ref (let _0_274 = (new_scope ())
in (_0_274)::[]))
in (
...
let uu____417 = (let _0_275 = (FStar_ST.read scopes)
in (FStar_Util.find_map _0_275 (fun uu____430 -> (match (uu____430) with
...
((FStar_Util.incr ctr);
(let _0_277 = (let _0_276 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (Prims.strcat "__" _0_276))
in (Prims.strcat y _0_277));
)
end))
in (

let top_scope = (let _0_278 = (FStar_List.hd (FStar_ST.read scopes))
...
let new_var = (fun pp rn -> (let _0_281 = (let _0_280 = (let _0_279 = (FStar_Util.string_of_int rn)
in (Prims.strcat "__" _0_279))
in (Prims.strcat pp.FStar_Ident.idText _0_280))
in (FStar_All.pipe_left mk_unique _0_281)))
in (
...
let fresh = (fun pfx -> (let _0_283 = (let _0_282 = (next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_282))
in (FStar_Util.format2 "%s_%s" pfx _0_283)))
in (

let string_const = (fun s -> (

let uu____499 = (let _0_284 = (FStar_ST.read scopes)
in (FStar_Util.find_map _0_284 (fun uu____512 -> (match (uu____512) with
...
let f = (let _0_285 = (FStar_SMTEncoding_Util.mk_String_const id)
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxString _0_285))
in (

let top_scope = (let _0_286 = (FStar_List.hd (FStar_ST.read scopes))
in (FStar_All.pipe_left Prims.snd _0_286))
...
let push = (fun uu____551 -> (let _0_289 = (let _0_288 = (new_scope ())
in (let _0_287 = (FStar_ST.read scopes)
in (_0_288)::_0_287))
in (FStar_ST.write scopes _0_289)))
in (

let pop = (fun uu____573 -> (let _0_290 = (FStar_List.tl (FStar_ST.read scopes))
...
let uu___135_673 = x
in (let _0_291 = (FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname)
in {FStar_Syntax_Syntax.ppname = _0_291; FStar_Syntax_Syntax.index = uu___135_673.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___135_673.FStar_Syntax_Syntax.sort})))
...
let print_env : env_t  ->  Prims.string = (fun e -> (let _0_292 = (FStar_All.pipe_right e.bindings (FStar_List.map (fun uu___110_840 -> (match (uu___110_840) with
...
in (FStar_All.pipe_right _0_292 (FStar_String.concat ", "))))
...
in (let _0_293 = (FStar_SMTEncoding_Util.mkFreeV ((xsym), (s)))
in ((xsym), (_0_293)))))


let gen_term_var : env_t  ->  FStar_Syntax_Syntax.bv  ->  (Prims.string * FStar_SMTEncoding_Term.term * env_t) = (fun env x -> (

let ysym = (let _0_294 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@x" _0_294))
in (
...
| None -> begin
(failwith (let _0_295 = (FStar_Syntax_Print.bv_to_string a)
in (FStar_Util.format1 "Bound term variable not found (after unmangling): %s" _0_295)))
end
| Some (b, t) -> begin
t
end)))
...
in (let _0_300 = (let _0_299 = Binding_fvar ((let _0_298 = (let _0_297 = (FStar_SMTEncoding_Util.mkApp ((ftok), ([])))
in (FStar_All.pipe_left (fun _0_296 -> Some (_0_296)) _0_297))
in ((x), (fname), (_0_298), (None))))
in (_0_299)::env.bindings)
in {bindings = _0_300; depth = uu___140_999.depth; tcenv = uu___140_999.tcenv; warn = uu___140_999.warn; cache = uu___140_999.cache; nolabels = uu___140_999.nolabels; use_zfuel_name = uu___140_999.use_zfuel_name; encode_non_total_function_typ = uu___140_999.encode_non_total_function_typ}))
in ((fname), (ftok), (_0_301))))))
...
let contains_name : env_t  ->  Prims.string  ->  Prims.bool = (fun env s -> (let _0_302 = (lookup_binding env (fun uu___113_1056 -> (match (uu___113_1056) with
...
in (FStar_All.pipe_right _0_302 FStar_Option.isSome)))
...
| None -> begin
(failwith (let _0_303 = (FStar_Syntax_Print.lid_to_string a)
in (FStar_Util.format1 "Name not found: %s" _0_303)))
end
| Some (s) -> begin
s
end)))
...
let t3 = (FStar_SMTEncoding_Util.mkApp (let _0_305 = (let _0_304 = (FStar_SMTEncoding_Util.mkApp (("ZFuel"), ([])))
in (_0_304)::[])
in ((f), (_0_305))))
in (
...
let uu____1198 = (let _0_307 = (let _0_306 = (FStar_SMTEncoding_Term.fv_of_term fuel)
in (FStar_All.pipe_right _0_306 Prims.fst))
in (FStar_Util.starts_with _0_307 "fuel"))
in (match (uu____1198) with
| true -> begin
(let _0_310 = (let _0_309 = (FStar_SMTEncoding_Util.mkFreeV ((name), (FStar_SMTEncoding_Term.Term_sort)))
in (FStar_SMTEncoding_Term.mk_ApplyTF _0_309 fuel))
in (FStar_All.pipe_left (fun _0_308 -> Some (_0_308)) _0_310))
end
| uu____1201 -> begin
Some (t)
end))
...
| None -> begin
(failwith (let _0_311 = (FStar_Syntax_Print.lid_to_string a.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Name not found: %s" _0_311)))
end)))
...
| uu____1406 -> begin
(let _0_312 = (add_fuel ((guard)::[]))
in (FStar_All.pipe_right _0_312 FStar_List.hd))
end)
...
(let _0_313 = (FStar_TypeChecker_Env.lookup_definition ((FStar_TypeChecker_Env.Eager_unfolding_only)::[]) env.tcenv fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_All.pipe_right _0_313 FStar_Option.isNone))
end
| uu____1461 -> begin
false
end)))
...
in (FStar_All.pipe_right _0_314 FStar_Option.isSome))
end
| uu____1538 -> begin
false
end)))
...
let trivial_post : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun t -> (let _0_317 = (let _0_315 = (FStar_Syntax_Syntax.null_binder t)
in (_0_315)::[])
in (let _0_316 = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.true_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Util.abs _0_317 _0_316 None))))


let mk_Apply : FStar_SMTEncoding_Term.term  ->  (Prims.string * FStar_SMTEncoding_Term.sort) Prims.list  ->  FStar_SMTEncoding_Term.term = (fun e vars -> (FStar_All.pipe_right vars (FStar_List.fold_left (fun out var -> (match ((Prims.snd var)) with
| FStar_SMTEncoding_Term.Fuel_sort -> begin
(let _0_318 = (FStar_SMTEncoding_Util.mkFreeV var)
in (FStar_SMTEncoding_Term.mk_ApplyTF out _0_318))
end
| s -> begin
(

let _0_319 = (FStar_SMTEncoding_Util.mkFreeV var)
in (FStar_SMTEncoding_Util.mk_ApplyTT out _0_319))
end)) e)))
...
(FStar_SMTEncoding_Util.mkApp (let _0_321 = (let _0_320 = (FStar_SMTEncoding_Term.boxInt (FStar_SMTEncoding_Util.mkInteger' (FStar_Util.int_of_char c)))
in (_0_320)::[])
in (("FStar.Char.Char"), (_0_321))))
end
...
| c -> begin
(failwith (let _0_322 = (FStar_Syntax_Print.const_to_string c)
in (FStar_Util.format1 "Unhandled constant: %s" _0_322)))
end))
...
(let _0_323 = (FStar_Syntax_Util.unrefine t)
in (aux true _0_323))
end
| uu____1807 -> begin
(match (norm) with
| true -> begin
(let _0_324 = (whnf env t)
in (aux false _0_324))
end
| uu____1808 -> begin
(failwith (let _0_326 = (FStar_Range.string_of_range t0.FStar_Syntax_Syntax.pos)
in (let _0_325 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format2 "(%s) Expected a function typ; got %s" _0_326 _0_325))))
end)
end)))
in (aux true t0)))
...
| uu____1829 -> begin
(let _0_327 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_0_327)))
end)))
...
| true -> begin
(let _0_328 = (FStar_Syntax_Print.binders_to_string ", " bs)
...
let uu____2076 = (let _0_329 = (norm env x.FStar_Syntax_Syntax.sort)
in (encode_term_pred fuel_opt _0_329 env xx))
...
| (t, decls) -> begin
(let _0_330 = (FStar_SMTEncoding_Term.mk_HasTypeWithFuel fuel_opt e t)
in ((_0_330), (decls)))
end)))
and encode_term_pred' : FStar_SMTEncoding_Term.term Prims.option  ->  FStar_Syntax_Syntax.typ  ->  env_t  ->  FStar_SMTEncoding_Term.term  ->  (FStar_SMTEncoding_Term.term * FStar_SMTEncoding_Term.decls_t) = (fun fuel_opt t env e -> (
...
(match (fuel_opt) with
| None -> begin
(let _0_331 = (FStar_SMTEncoding_Term.mk_HasTypeZ e t)
in ((_0_331), (decls)))
end
| Some (f) -> begin
(let _0_332 = (FStar_SMTEncoding_Term.mk_HasTypeFuel f e t)
in ((_0_332), (decls)))
end)
end)))
...
| true -> begin
(let _0_335 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_334 = (FStar_Syntax_Print.tag_of_term t0)
in (let _0_333 = (FStar_Syntax_Print.term_to_string t0)
...
(failwith (let _0_339 = (FStar_All.pipe_left FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos)
in (let _0_338 = (FStar_Syntax_Print.tag_of_term t0)
in (let _0_337 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_336 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" _0_339 _0_338 _0_337 _0_336))))))
end
| FStar_Syntax_Syntax.Tm_bvar (x) -> begin
(failwith (let _0_340 = (FStar_Syntax_Print.bv_to_string x)
in (FStar_Util.format1 "Impossible: locally nameless; got %s" _0_340)))
end
...
(let _0_341 = (lookup_free_var env v.FStar_Syntax_Syntax.fv_name)
in ((_0_341), ([])))
end
...
let fsym = (let _0_343 = (varops.fresh "f")
in ((_0_343), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
| None -> begin
(let _0_344 = (FStar_SMTEncoding_Util.mk_and_l guards)
in ((_0_344), ([])))
end
| Some (pre) -> begin
(
...
| (guard, decls0) -> begin
(let _0_345 = (FStar_SMTEncoding_Util.mk_and_l ((guard)::guards))
in ((_0_345), (decls0)))
end))
end)
...
let t_interp = (FStar_SMTEncoding_Util.mkForall (let _0_346 = (FStar_SMTEncoding_Util.mkImp ((guards), (res_pred)))
in ((((app)::[])::[]), (vars), (_0_346))))
in (

let cvars = (let _0_347 = (FStar_SMTEncoding_Term.free_variables t_interp)
in (FStar_All.pipe_right _0_347 (FStar_List.filter (fun uu____2357 -> (match (uu____2357) with
| (x, uu____2361) -> begin
(x <> (Prims.fst fsym))
end)))))
in (
...
(let _0_349 = (FStar_SMTEncoding_Util.mkApp (let _0_348 = (FStar_All.pipe_right cvars (FStar_List.map FStar_SMTEncoding_Util.mkFreeV))
in ((t'), (_0_348))))
in ((_0_349), ([])))
end
| None -> begin
...
let tsym = (varops.mk_unique (let _0_350 = (FStar_Util.digest_of_string tkey_hash)
in (Prims.strcat "Tm_arrow_" _0_350)))
in (
...
let t = (FStar_SMTEncoding_Util.mkApp (let _0_351 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((tsym), (_0_351))))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_352 = (FStar_SMTEncoding_Util.mkForall ((((t_has_kind)::[])::[]), (cvars), (t_has_kind)))
in ((_0_352), (a_name), (a_name)))))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_356 = (mkForall_fuel (let _0_355 = (FStar_SMTEncoding_Util.mkImp (let _0_354 = (let _0_353 = (FStar_SMTEncoding_Term.mk_PreType f)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _0_353))
in ((f_has_t), (_0_354))))
in ((((f_has_t)::[])::[]), ((fsym)::cvars), (_0_355))))
in ((_0_356), (Some ("pre-typing for functions")), (a_name)))))
in (

let t_interp = (

let a_name = Some ((Prims.strcat "interpretation_" tsym))
in FStar_SMTEncoding_Term.Assume ((let _0_358 = (FStar_SMTEncoding_Util.mkForall (let _0_357 = (FStar_SMTEncoding_Util.mkIff ((f_has_t_z), (t_interp)))
in ((((f_has_t_z)::[])::[]), ((fsym)::cvars), (_0_357))))
...
in FStar_SMTEncoding_Term.Assume ((let _0_359 = (FStar_SMTEncoding_Term.mk_HasType t FStar_SMTEncoding_Term.mk_Term_type)
in ((_0_359), (Some ("Typing for non-total arrows")), (a_name)))))
in (
...
let a_name = Some ((Prims.strcat "pre_typing_" tsym))
in FStar_SMTEncoding_Term.Assume ((let _0_363 = (mkForall_fuel (let _0_362 = (FStar_SMTEncoding_Util.mkImp (let _0_361 = (let _0_360 = (FStar_SMTEncoding_Term.mk_PreType f)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _0_360))
in ((f_has_t), (_0_361))))
in ((((f_has_t)::[])::[]), ((fsym)::[]), (_0_362))))
in ((_0_363), (a_name), (a_name)))))
...
| (b, f) -> begin
(let _0_364 = (Prims.fst (FStar_List.hd b))
in ((_0_364), (f)))
end))
end
| uu____2554 -> begin
...
let encoding = (FStar_SMTEncoding_Util.mkAnd (let _0_365 = (FStar_SMTEncoding_Term.mk_HasTypeWithFuel (Some (fterm)) xtm base_t)
in ((_0_365), (refinement))))
in (

let cvars = (let _0_366 = (FStar_SMTEncoding_Term.free_variables encoding)
in (FStar_All.pipe_right _0_366 (FStar_List.filter (fun uu____2601 -> (match (uu____2601) with
| (y, uu____2605) -> begin
((y <> x) && (y <> fsym))
end)))))
in (
...
(let _0_368 = (FStar_SMTEncoding_Util.mkApp (let _0_367 = (FStar_All.pipe_right cvars (FStar_List.map FStar_SMTEncoding_Util.mkFreeV))
in ((t), (_0_367))))
in ((_0_368), ([])))
end
| None -> begin
...
let tsym = (varops.mk_unique (let _0_369 = (FStar_Util.digest_of_string tkey_hash)
in (Prims.strcat "Tm_refine_" _0_369)))
in (
...
let t = (FStar_SMTEncoding_Util.mkApp (let _0_370 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((tsym), (_0_370))))
in (
...
let t_haseq = FStar_SMTEncoding_Term.Assume ((let _0_372 = (FStar_SMTEncoding_Util.mkForall (let _0_371 = (FStar_SMTEncoding_Util.mkIff ((t_haseq_ref), (t_haseq_base)))
in ((((t_haseq_ref)::[])::[]), (cvars), (_0_371))))
in ((_0_372), (Some ((Prims.strcat "haseq for " tsym))), (Some ((Prims.strcat "haseq" tsym))))))
in (

let t_kinding = FStar_SMTEncoding_Term.Assume ((let _0_373 = (FStar_SMTEncoding_Util.mkForall ((((t_has_kind)::[])::[]), (cvars), (t_has_kind)))
in ((_0_373), (Some ("refinement kinding")), (Some ((Prims.strcat "refinement_kinding_" tsym))))))
in (

let t_interp = FStar_SMTEncoding_Term.Assume ((let _0_376 = (FStar_SMTEncoding_Util.mkForall (let _0_374 = (FStar_SMTEncoding_Util.mkIff ((x_has_t), (encoding)))
in ((((x_has_t)::[])::[]), ((ffv)::(xfv)::cvars), (_0_374))))
in (let _0_375 = Some ((FStar_Syntax_Print.term_to_string t0))
in ((_0_376), (_0_375), (Some ((Prims.strcat "refinement_interpretation_" tsym)))))))
in (
...
let d = FStar_SMTEncoding_Term.Assume ((let _0_379 = Some ((varops.mk_unique (let _0_378 = (let _0_377 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _0_377))
in (FStar_Util.format1 "uvar_typing_%s" _0_378))))
in ((t_has_k), (Some ("Uvar typing")), (_0_379))))
...
let uu____2794 = (let _0_380 = (FStar_Syntax_Subst.compress head).FStar_Syntax_Syntax.n
in ((_0_380), (args_e)))
in (match (uu____2794) with
| (uu____2809, uu____2810) when (head_redex env head) -> begin
(let _0_381 = (whnf env t)
in (encode_term _0_381 env))
end
...
| (v2, decls2) -> begin
(let _0_382 = (FStar_SMTEncoding_Util.mk_LexCons v1 v2)
in ((_0_382), ((FStar_List.append decls1 decls2))))
end))
end))
end
...
let e0 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_384 = (let _0_383 = (FStar_List.hd args_e)
in (_0_383)::[])
in ((head), (_0_384)))))) None head.FStar_Syntax_Syntax.pos)
in (

let e = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_385 = (FStar_List.tl args_e)
...
| (tm, decls) -> begin
(let _0_386 = (FStar_SMTEncoding_Util.mkApp (("Reify"), ((tm)::[])))
in ((_0_386), (decls)))
end))
end
...
let ty = (let _0_387 = (FStar_Syntax_Util.arrow rest c)
in (FStar_All.pipe_right _0_387 (FStar_Syntax_Subst.subst subst)))
in (
...
let e_typing = FStar_SMTEncoding_Term.Assume ((let _0_390 = (FStar_SMTEncoding_Util.mkForall ((((has_type)::[])::[]), (cvars), (has_type)))
in (let _0_389 = Some ((varops.mk_unique (let _0_388 = (FStar_Util.digest_of_string (FStar_SMTEncoding_Term.hash_of_term app_tm))
in (Prims.strcat "partial_app_typing_" _0_388))))
in ((_0_390), (Some ("Partial app typing")), (_0_389)))))
...
Some ((let _0_391 = (FStar_TypeChecker_Env.lookup_lid env.tcenv fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let head_type = (let _0_392 = (FStar_TypeChecker_Normalize.normalize_refinement ((FStar_TypeChecker_Normalize.WHNF)::(FStar_TypeChecker_Normalize.EraseUniverses)::[]) env.tcenv head_type)
in (FStar_All.pipe_left FStar_Syntax_Util.unrefine _0_392))
in (
...
in (let _0_393 = (FStar_SMTEncoding_Util.mkFreeV ((f), (FStar_SMTEncoding_Term.Term_sort)))
in ((_0_393), ((decl)::[]))))))
in (
...
(let _0_394 = (FStar_TypeChecker_Util.is_pure_or_ghost_effect env.tcenv eff)
in (FStar_All.pipe_right _0_394 Prims.op_Negation))
end))
in (

let codomain_eff = (fun lc -> (match (lc) with
| FStar_Util.Inl (lc) -> begin
(let _0_397 = (let _0_395 = (lc.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _0_395))
in (FStar_All.pipe_right _0_397 (fun _0_396 -> Some (_0_396))))
end
| FStar_Util.Inr (eff, flags) -> begin
(

let new_uvar = (fun uu____3480 -> (let _0_398 = (FStar_TypeChecker_Rel.new_uvar FStar_Range.dummyRange [] FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _0_398 Prims.fst)))
in (match ((FStar_Ident.lid_equals eff FStar_Syntax_Const.effect_Tot_lid)) with
| true -> begin
(let _0_400 = (FStar_Syntax_Syntax.mk_Total (new_uvar ()))
...
| true -> begin
(let _0_402 = (FStar_Syntax_Syntax.mk_GTotal (new_uvar ()))
in (FStar_All.pipe_right _0_402 (fun _0_401 -> Some (_0_401))))
end
| uu____3490 -> begin
None
end)
...
in (match (lopt) with
| None -> begin
((let _0_404 = (let _0_403 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format1 "Losing precision when encoding a function literal: %s" _0_403))
in (FStar_Errors.warn t0.FStar_Syntax_Syntax.pos _0_404));
(fallback ());
)
end
| Some (lc) -> begin
...
let key_body = (FStar_SMTEncoding_Util.mkForall (let _0_406 = (FStar_SMTEncoding_Util.mkImp (let _0_405 = (FStar_SMTEncoding_Util.mk_and_l guards)
in ((_0_405), (body))))
in (([]), (vars), (_0_406))))
in (
...
(let _0_408 = (FStar_SMTEncoding_Util.mkApp (let _0_407 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((t), (_0_407))))
in ((_0_408), ([])))
end
| None -> begin
...
let fsym = (varops.mk_unique (let _0_409 = (FStar_Util.digest_of_string tkey_hash)
in (Prims.strcat "Tm_abs_" _0_409)))
in (

let fdecl = FStar_SMTEncoding_Term.DeclFun (((fsym), (cvar_sorts), (FStar_SMTEncoding_Term.Term_sort), (None)))
in (

let f = (FStar_SMTEncoding_Util.mkApp (let _0_410 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV cvars)
in ((fsym), (_0_410))))
in (
...
in (let _0_413 = (let _0_412 = FStar_SMTEncoding_Term.Assume ((let _0_411 = (FStar_SMTEncoding_Util.mkForall ((((f)::[])::[]), (cvars), (f_has_t)))
in ((_0_411), (a_name), (a_name))))
in (_0_412)::[])
in (FStar_List.append decls'' _0_413)))
end)))
end))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_415 = (FStar_SMTEncoding_Util.mkForall (let _0_414 = (FStar_SMTEncoding_Util.mkEq ((app), (body)))
in ((((app)::[])::[]), ((FStar_List.append vars cvars)), (_0_414))))
...
in (let _0_416 = (FStar_SMTEncoding_Util.mkFreeV ((e), (FStar_SMTEncoding_Term.Term_sort)))
in ((_0_416), ((decl_e)::[])))));
)
end
...
| (w, decls2) -> begin
(let _0_419 = (FStar_SMTEncoding_Util.mkAnd (let _0_418 = (FStar_SMTEncoding_Util.mkEq (let _0_417 = (FStar_SMTEncoding_Term.boxBool FStar_SMTEncoding_Util.mkTrue)
in ((w), (_0_417))))
in ((guard), (_0_418))))
in ((_0_419), (decls2)))
end))
...
| (br, decls3) -> begin
(let _0_420 = (FStar_SMTEncoding_Util.mkITE ((guard), (br), (else_case)))
in ((_0_420), ((FStar_List.append decls (FStar_List.append decls2 decls3)))))
end))
end)))))
...
| uu____3962 -> begin
(let _0_421 = (encode_one_pat env pat)
in (_0_421)::[])
end))
...
| true -> begin
(let _0_422 = (FStar_Syntax_Print.pat_to_string pat)
...
(FStar_SMTEncoding_Util.mkEq (let _0_423 = (encode_const c)
in ((scrutinee), (_0_423))))
end
...
| FStar_Syntax_Syntax.Pat_cons (f, args) -> begin
(let _0_426 = (FStar_All.pipe_right args (FStar_List.mapi (fun i uu____4220 -> (match (uu____4220) with
| (arg, uu____4229) -> begin
(

let proj = (primitive_projector_by_pos env.tcenv f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v i)
in (let _0_425 = (FStar_SMTEncoding_Util.mkApp ((proj), ((scrutinee)::[])))
in (mk_projections arg _0_425)))
end))))
...
let uu____4357 = (let _0_427 = (FStar_Syntax_Util.unmeta p)
in (FStar_All.pipe_right _0_427 FStar_Syntax_Util.head_and_args))
in (match (uu____4357) with
| (head, args) -> begin
(

let uu____4397 = (let _0_428 = (FStar_Syntax_Util.un_uinst head).FStar_Syntax_Syntax.n
in ((_0_428), (args)))
...
let uu____4504 = (let _0_429 = (FStar_Syntax_Util.unmeta t)
in (FStar_All.pipe_right _0_429 FStar_Syntax_Util.head_and_args))
in (match (uu____4504) with
| (head, args) -> begin
(

let uu____4542 = (let _0_430 = (FStar_Syntax_Util.un_uinst head).FStar_Syntax_Syntax.n
in ((_0_430), (args)))
...
| Some (e) -> begin
(let _0_432 = (list_elements e)
in (FStar_All.pipe_right _0_432 (FStar_List.map (fun branch -> (let _0_431 = (list_elements branch)
in (FStar_All.pipe_right _0_431 (FStar_List.map one_pat)))))))
end
| uu____4641 -> begin
...
in (let _0_435 = (lemma_pats pats')
in ((binders), (pre), (post), (_0_435))))
end
| uu____4828 -> begin
(failwith "impos")
end)
...
let uu____4910 = (let _0_437 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (

let uu____4953 = (let _0_436 = (FStar_All.pipe_right branch (FStar_List.map (fun uu____4977 -> (match (uu____4977) with
| (t, uu____4984) -> begin
(encode_term t (
...
| (l)::[] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _0_439 = (let _0_438 = (FStar_SMTEncoding_Util.mkFreeV l)
in (FStar_SMTEncoding_Util.mk_Precedes _0_438 e))
in (_0_439)::p))))
end
| uu____5033 -> begin
(
...
| [] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _0_440 = (FStar_SMTEncoding_Util.mk_Precedes tl e)
in (_0_440)::p))))
end
| ((x, FStar_SMTEncoding_Term.Term_sort))::vars -> begin
(let _0_442 = (let _0_441 = (FStar_SMTEncoding_Util.mkFreeV ((x), (FStar_SMTEncoding_Term.Term_sort)))
in (FStar_SMTEncoding_Util.mk_LexCons _0_441 tl))
in (aux _0_442 vars))
end
| uu____5069 -> begin
pats
end))
in (let _0_443 = (FStar_SMTEncoding_Util.mkFreeV (("Prims.LexTop"), (FStar_SMTEncoding_Term.Term_sort)))
in (aux _0_443 vars)))
end)
end)
in (
...
let uu____5075 = (let _0_444 = (FStar_Syntax_Util.unmeta pre)
in (encode_formula _0_444 env))
in (match (uu____5075) with
| (pre, decls'') -> begin
(

let uu____5082 = (let _0_445 = (FStar_Syntax_Util.unmeta post)
...
in (let _0_448 = (FStar_SMTEncoding_Util.mkForall (let _0_447 = (FStar_SMTEncoding_Util.mkImp (let _0_446 = (FStar_SMTEncoding_Util.mk_and_l ((pre)::guards))
in ((_0_446), (post))))
in ((pats), (vars), (_0_447))))
in ((_0_448), (decls))))
end))
...
| true -> begin
(let _0_450 = (FStar_Syntax_Print.tag_of_term phi)
in (let _0_449 = (FStar_Syntax_Print.term_to_string phi)
...
let const_op = (fun f r uu____5179 -> (let _0_452 = (f r)
in ((_0_452), ([]))))
in (

let un_op = (fun f l -> (let _0_453 = (FStar_List.hd l)
in (FStar_All.pipe_left f _0_453)))
in (
...
| (l2, decls2) -> begin
(let _0_455 = (FStar_SMTEncoding_Term.mkImp ((l2), (l1)) r)
in ((_0_455), ((FStar_List.append decls1 decls2))))
end))
end)
end))
end
...
let connectives = (let _0_468 = (let _0_456 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd))
in ((FStar_Syntax_Const.and_lid), (_0_456)))
in (let _0_467 = (let _0_466 = (let _0_457 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr))
in ((FStar_Syntax_Const.or_lid), (_0_457)))
in (let _0_465 = (let _0_464 = (let _0_463 = (let _0_458 = (enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff))
in ((FStar_Syntax_Const.iff_lid), (_0_458)))
in (let _0_462 = (let _0_461 = (let _0_460 = (let _0_459 = (enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot))
in ((FStar_Syntax_Const.not_lid), (_0_459)))
in (_0_460)::(((FStar_Syntax_Const.eq2_lid), (eq_op)))::(((FStar_Syntax_Const.eq3_lid), (eq_op)))::(((FStar_Syntax_Const.true_lid), ((const_op FStar_SMTEncoding_Term.mkTrue))))::(((FStar_Syntax_Const.false_lid), ((const_op FStar_SMTEncoding_Term.mkFalse))))::[])
in (((FStar_Syntax_Const.ite_lid), (mk_ite)))::_0_461)
in (_0_463)::_0_462))
in (((FStar_Syntax_Const.imp_lid), (mk_imp)))::_0_464)
in (_0_466)::_0_465))
in (_0_468)::_0_467))
in (
...
| (phi, decls) -> begin
(let _0_469 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Labeled (((phi), (msg), (r)))) r)
in ((_0_469), (decls)))
end))
end
| FStar_Syntax_Syntax.Tm_meta (uu____5712) -> begin
(let _0_470 = (FStar_Syntax_Util.unmeta phi)
...
| (t, decls') -> begin
(let _0_471 = (FStar_SMTEncoding_Term.mk_HasType x t)
in ((_0_471), ((FStar_List.append decls decls'))))
end))
end))
end
...
let uu____5896 = (let _0_473 = (FStar_Syntax_Subst.compress r).FStar_Syntax_Syntax.n
in (let _0_472 = (FStar_Syntax_Subst.compress msg).FStar_Syntax_Syntax.n
in ((_0_473), (_0_472))))
...
(let _0_474 = (whnf env phi)
in (encode_formula _0_474 env))
end
| uu____5930 -> begin
(
...
let uu____6012 = (let _0_478 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (

let uu____6047 = (let _0_477 = (FStar_All.pipe_right p (FStar_List.map (fun uu____6069 -> (match (uu____6069) with
| (t, uu____6075) -> begin
(encode_term t (
...
in (let _0_479 = (FStar_SMTEncoding_Util.mk_and_l guards)
in ((vars), (pats), (_0_479), (body), ((FStar_List.append decls (FStar_List.append (FStar_List.flatten decls') decls''))))))
end))
end))
end)))
in ((debug phi);
...
let pat_vars = (let _0_481 = (FStar_Syntax_Free.names hd)
in (FStar_List.fold_left (fun out x -> (let _0_480 = (FStar_Syntax_Free.names x)
in (FStar_Util.set_union out _0_480))) _0_481 tl))
in (
...
in (let _0_483 = (let _0_482 = (FStar_Syntax_Print.bv_to_string x)
in (FStar_Util.format1 "SMT pattern misses at least one bound variable: %s" _0_482))
in (FStar_Errors.warn pos _0_483)))
end)))
end)))
in (
...
let tm = (let _0_485 = (let _0_484 = (FStar_SMTEncoding_Util.mkImp ((guard), (body)))
in ((pats), (vars), (_0_484)))
in (FStar_SMTEncoding_Term.mkForall _0_485 phi.FStar_Syntax_Syntax.pos))
in ((tm), (decls)))
end));
)
end
...
| (vars, pats, guard, body, decls) -> begin
(let _0_488 = (let _0_487 = (let _0_486 = (FStar_SMTEncoding_Util.mkAnd ((guard), (body)))
in ((pats), (vars), (_0_486)))
in (FStar_SMTEncoding_Term.mkExists _0_487 phi.FStar_Syntax_Syntax.pos))
in ((_0_488), (decls)))
end));
)
end))));
...
let xname_decl = FStar_SMTEncoding_Term.DeclFun ((let _0_489 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in ((x), (_0_489), (FStar_SMTEncoding_Term.Term_sort), (None))))
in (
...
let xapp = (FStar_SMTEncoding_Util.mkApp (let _0_490 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((x), (_0_490))))
in (
...
in (let _0_500 = (let _0_499 = (let _0_498 = (let _0_497 = FStar_SMTEncoding_Term.Assume ((let _0_492 = (FStar_SMTEncoding_Util.mkForall (let _0_491 = (FStar_SMTEncoding_Util.mkEq ((xapp), (body)))
in ((((xapp)::[])::[]), (vars), (_0_491))))
in ((_0_492), (None), (Some ((Prims.strcat "primitive_" x))))))
in (let _0_496 = (let _0_495 = FStar_SMTEncoding_Term.Assume ((let _0_494 = (FStar_SMTEncoding_Util.mkForall (let _0_493 = (FStar_SMTEncoding_Util.mkEq ((xtok_app), (xapp)))
in ((((xtok_app)::[])::[]), (vars), (_0_493))))
in ((_0_494), (Some ("Name-token correspondence")), (Some ((Prims.strcat "token_correspondence_" x))))))
in (_0_495)::[])
in (_0_497)::_0_496))
in (xtok_decl)::_0_498)
in (xname_decl)::_0_499)
in ((xtok), (_0_500))))))))))
in (
...
let prims = (let _0_596 = (let _0_503 = (let _0_502 = (let _0_501 = (FStar_SMTEncoding_Util.mkEq ((x), (y)))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_501))
in (quant axy _0_502))
in ((FStar_Syntax_Const.op_Eq), (_0_503)))
in (let _0_595 = (let _0_594 = (let _0_506 = (let _0_505 = (let _0_504 = (FStar_SMTEncoding_Util.mkNot (FStar_SMTEncoding_Util.mkEq ((x), (y))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_504))
in (quant axy _0_505))
in ((FStar_Syntax_Const.op_notEq), (_0_506)))
in (let _0_593 = (let _0_592 = (let _0_511 = (let _0_510 = (let _0_509 = (FStar_SMTEncoding_Util.mkLT (let _0_508 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_507 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_508), (_0_507)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_509))
in (quant xy _0_510))
in ((FStar_Syntax_Const.op_LT), (_0_511)))
in (let _0_591 = (let _0_590 = (let _0_516 = (let _0_515 = (let _0_514 = (FStar_SMTEncoding_Util.mkLTE (let _0_513 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_512 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_513), (_0_512)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_514))
in (quant xy _0_515))
in ((FStar_Syntax_Const.op_LTE), (_0_516)))
in (let _0_589 = (let _0_588 = (let _0_521 = (let _0_520 = (let _0_519 = (FStar_SMTEncoding_Util.mkGT (let _0_518 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_517 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_518), (_0_517)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_519))
in (quant xy _0_520))
in ((FStar_Syntax_Const.op_GT), (_0_521)))
in (let _0_587 = (let _0_586 = (let _0_526 = (let _0_525 = (let _0_524 = (FStar_SMTEncoding_Util.mkGTE (let _0_523 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_522 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_523), (_0_522)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_524))
in (quant xy _0_525))
in ((FStar_Syntax_Const.op_GTE), (_0_526)))
in (let _0_585 = (let _0_584 = (let _0_531 = (let _0_530 = (let _0_529 = (FStar_SMTEncoding_Util.mkSub (let _0_528 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_527 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_528), (_0_527)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_529))
in (quant xy _0_530))
in ((FStar_Syntax_Const.op_Subtraction), (_0_531)))
in (let _0_583 = (let _0_582 = (let _0_534 = (let _0_533 = (let _0_532 = (FStar_SMTEncoding_Util.mkMinus (FStar_SMTEncoding_Term.unboxInt x))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_532))
in (quant qx _0_533))
in ((FStar_Syntax_Const.op_Minus), (_0_534)))
in (let _0_581 = (let _0_580 = (let _0_539 = (let _0_538 = (let _0_537 = (FStar_SMTEncoding_Util.mkAdd (let _0_536 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_535 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_536), (_0_535)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_537))
in (quant xy _0_538))
in ((FStar_Syntax_Const.op_Addition), (_0_539)))
in (let _0_579 = (let _0_578 = (let _0_544 = (let _0_543 = (let _0_542 = (FStar_SMTEncoding_Util.mkMul (let _0_541 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_540 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_541), (_0_540)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_542))
in (quant xy _0_543))
in ((FStar_Syntax_Const.op_Multiply), (_0_544)))
in (let _0_577 = (let _0_576 = (let _0_549 = (let _0_548 = (let _0_547 = (FStar_SMTEncoding_Util.mkDiv (let _0_546 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_545 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_546), (_0_545)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_547))
in (quant xy _0_548))
in ((FStar_Syntax_Const.op_Division), (_0_549)))
in (let _0_575 = (let _0_574 = (let _0_554 = (let _0_553 = (let _0_552 = (FStar_SMTEncoding_Util.mkMod (let _0_551 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_550 = (FStar_SMTEncoding_Term.unboxInt y)
in ((_0_551), (_0_550)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _0_552))
in (quant xy _0_553))
in ((FStar_Syntax_Const.op_Modulus), (_0_554)))
in (let _0_573 = (let _0_572 = (let _0_559 = (let _0_558 = (let _0_557 = (FStar_SMTEncoding_Util.mkAnd (let _0_556 = (FStar_SMTEncoding_Term.unboxBool x)
in (let _0_555 = (FStar_SMTEncoding_Term.unboxBool y)
in ((_0_556), (_0_555)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_557))
in (quant xy _0_558))
in ((FStar_Syntax_Const.op_And), (_0_559)))
in (let _0_571 = (let _0_570 = (let _0_564 = (let _0_563 = (let _0_562 = (FStar_SMTEncoding_Util.mkOr (let _0_561 = (FStar_SMTEncoding_Term.unboxBool x)
in (let _0_560 = (FStar_SMTEncoding_Term.unboxBool y)
in ((_0_561), (_0_560)))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_562))
in (quant xy _0_563))
in ((FStar_Syntax_Const.op_Or), (_0_564)))
in (let _0_569 = (let _0_568 = (let _0_567 = (let _0_566 = (let _0_565 = (FStar_SMTEncoding_Util.mkNot (FStar_SMTEncoding_Term.unboxBool x))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_565))
in (quant qx _0_566))
in ((FStar_Syntax_Const.op_Negation), (_0_567)))
in (_0_568)::[])
in (_0_570)::_0_569))
in (_0_572)::_0_571))
in (_0_574)::_0_573))
...
let mk = (fun l v -> (let _0_598 = (let _0_597 = (FStar_All.pipe_right prims (FStar_List.find (fun uu____6788 -> (match (uu____6788) with
| (l', uu____6797) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _0_597 (FStar_Option.map (fun uu____6818 -> (match (uu____6818) with
| (uu____6829, b) -> begin
(b v)
end)))))
in (FStar_All.pipe_right _0_598 FStar_Option.get)))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_604 = (FStar_SMTEncoding_Util.mkForall (let _0_601 = (FStar_SMTEncoding_Util.mkImp (let _0_600 = (FStar_SMTEncoding_Util.mkEq (let _0_599 = (FStar_SMTEncoding_Util.mkApp (("PreType"), ((xx)::[])))
in ((tapp), (_0_599))))
in ((xx_has_type), (_0_600))))
in ((((xx_has_type)::[])::[]), ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::(((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)))::vars), (_0_601))))
in (let _0_603 = Some ((varops.mk_unique (let _0_602 = (FStar_Util.digest_of_string tapp_hash)
in (Prims.strcat "pretyping_" _0_602))))
in ((_0_604), (Some ("pretyping")), (_0_603)))))))
end))
end)))
...
in (let _0_611 = FStar_SMTEncoding_Term.Assume ((let _0_605 = (FStar_SMTEncoding_Term.mk_HasType FStar_SMTEncoding_Term.mk_Term_unit tt)
in ((_0_605), (Some ("unit typing")), (Some ("unit_typing")))))
in (let _0_610 = (let _0_609 = FStar_SMTEncoding_Term.Assume ((let _0_608 = (mkForall_fuel (let _0_607 = (FStar_SMTEncoding_Util.mkImp (let _0_606 = (FStar_SMTEncoding_Util.mkEq ((x), (FStar_SMTEncoding_Term.mk_Term_unit)))
in ((typing_pred), (_0_606))))
in ((((typing_pred)::[])::[]), ((xx)::[]), (_0_607))))
in ((_0_608), (Some ("unit inversion")), (Some ("unit_inversion")))))
in (_0_609)::[])
in (_0_611)::_0_610))))
in (
...
in (let _0_623 = FStar_SMTEncoding_Term.Assume ((let _0_617 = (FStar_SMTEncoding_Util.mkForall (let _0_616 = (let _0_613 = (let _0_612 = (FStar_SMTEncoding_Term.boxBool b)
in (_0_612)::[])
in (_0_613)::[])
in (let _0_615 = (let _0_614 = (FStar_SMTEncoding_Term.boxBool b)
in (FStar_SMTEncoding_Term.mk_HasType _0_614 tt))
in ((_0_616), ((bb)::[]), (_0_615)))))
in ((_0_617), (Some ("bool typing")), (Some ("bool_typing")))))
in (let _0_622 = (let _0_621 = FStar_SMTEncoding_Term.Assume ((let _0_620 = (mkForall_fuel (let _0_619 = (FStar_SMTEncoding_Util.mkImp (let _0_618 = (FStar_SMTEncoding_Term.mk_tester "BoxBool" x)
in ((typing_pred), (_0_618))))
in ((((typing_pred)::[])::[]), ((xx)::[]), (_0_619))))
in ((_0_620), (Some ("bool inversion")), (Some ("bool_inversion")))))
in (_0_621)::[])
in (_0_623)::_0_622))))))
in (
...
let precedes = (let _0_630 = (FStar_SMTEncoding_Util.mkApp (let _0_629 = (let _0_628 = (let _0_627 = (let _0_626 = (FStar_SMTEncoding_Term.boxInt a)
in (let _0_625 = (let _0_624 = (FStar_SMTEncoding_Term.boxInt b)
in (_0_624)::[])
in (_0_626)::_0_625))
in (tt)::_0_627)
in (tt)::_0_628)
in (("Prims.Precedes"), (_0_629))))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _0_630))
in (

let precedes_y_x = (let _0_631 = (FStar_SMTEncoding_Util.mkApp (("Precedes"), ((y)::(x)::[])))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _0_631))
in (let _0_661 = FStar_SMTEncoding_Term.Assume ((let _0_637 = (FStar_SMTEncoding_Util.mkForall (let _0_636 = (let _0_633 = (let _0_632 = (FStar_SMTEncoding_Term.boxInt b)
in (_0_632)::[])
in (_0_633)::[])
in (let _0_635 = (let _0_634 = (FStar_SMTEncoding_Term.boxInt b)
in (FStar_SMTEncoding_Term.mk_HasType _0_634 tt))
in ((_0_636), ((bb)::[]), (_0_635)))))
in ((_0_637), (Some ("int typing")), (Some ("int_typing")))))
in (let _0_660 = (let _0_659 = FStar_SMTEncoding_Term.Assume ((let _0_640 = (mkForall_fuel (let _0_639 = (FStar_SMTEncoding_Util.mkImp (let _0_638 = (FStar_SMTEncoding_Term.mk_tester "BoxInt" x)
in ((typing_pred), (_0_638))))
in ((((typing_pred)::[])::[]), ((xx)::[]), (_0_639))))
in ((_0_640), (Some ("int inversion")), (Some ("int_inversion")))))
in (let _0_658 = (let _0_657 = FStar_SMTEncoding_Term.Assume ((let _0_656 = (mkForall_fuel (let _0_655 = (FStar_SMTEncoding_Util.mkImp (let _0_654 = (FStar_SMTEncoding_Util.mk_and_l (let _0_653 = (let _0_652 = (let _0_651 = (FStar_SMTEncoding_Util.mkGT (let _0_642 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _0_641 = (FStar_SMTEncoding_Util.mkInteger' (Prims.parse_int "0"))
in ((_0_642), (_0_641)))))
in (let _0_650 = (let _0_649 = (FStar_SMTEncoding_Util.mkGTE (let _0_644 = (FStar_SMTEncoding_Term.unboxInt y)
in (let _0_643 = (FStar_SMTEncoding_Util.mkInteger' (Prims.parse_int "0"))
in ((_0_644), (_0_643)))))
in (let _0_648 = (let _0_647 = (FStar_SMTEncoding_Util.mkLT (let _0_646 = (FStar_SMTEncoding_Term.unboxInt y)
in (let _0_645 = (FStar_SMTEncoding_Term.unboxInt x)
in ((_0_646), (_0_645)))))
in (_0_647)::[])
in (_0_649)::_0_648))
in (_0_651)::_0_650))
in (typing_pred_y)::_0_652)
in (typing_pred)::_0_653))
in ((_0_654), (precedes_y_x))))
in ((((typing_pred)::(typing_pred_y)::(precedes_y_x)::[])::[]), ((xx)::(yy)::[]), (_0_655))))
in ((_0_656), (Some ("well-founded ordering on nat (alt)")), (Some ("well-founded-ordering-on-nat")))))
in (_0_657)::[])
in (_0_659)::_0_658))
in (_0_661)::_0_660)))))))))))
in (
...
let b = (FStar_SMTEncoding_Util.mkFreeV bb)
in (let _0_673 = FStar_SMTEncoding_Term.Assume ((let _0_667 = (FStar_SMTEncoding_Util.mkForall (let _0_666 = (let _0_663 = (let _0_662 = (FStar_SMTEncoding_Term.boxString b)
in (_0_662)::[])
in (_0_663)::[])
in (let _0_665 = (let _0_664 = (FStar_SMTEncoding_Term.boxString b)
in (FStar_SMTEncoding_Term.mk_HasType _0_664 tt))
in ((_0_666), ((bb)::[]), (_0_665)))))
in ((_0_667), (Some ("string typing")), (Some ("string_typing")))))
in (let _0_672 = (let _0_671 = FStar_SMTEncoding_Term.Assume ((let _0_670 = (mkForall_fuel (let _0_669 = (FStar_SMTEncoding_Util.mkImp (let _0_668 = (FStar_SMTEncoding_Term.mk_tester "BoxString" x)
in ((typing_pred), (_0_668))))
in ((((typing_pred)::[])::[]), ((xx)::[]), (_0_669))))
in ((_0_670), (Some ("string inversion")), (Some ("string_inversion")))))
in (_0_671)::[])
in (_0_673)::_0_672))))))
in (
...
let refa = (FStar_SMTEncoding_Util.mkApp (let _0_675 = (let _0_674 = (FStar_SMTEncoding_Util.mkFreeV aa)
in (_0_674)::[])
in ((reft_name), (_0_675))))
in (

let refb = (FStar_SMTEncoding_Util.mkApp (let _0_677 = (let _0_676 = (FStar_SMTEncoding_Util.mkFreeV bb)
in (_0_676)::[])
in ((reft_name), (_0_677))))
in (
...
in (let _0_690 = FStar_SMTEncoding_Term.Assume ((let _0_680 = (mkForall_fuel (let _0_679 = (FStar_SMTEncoding_Util.mkImp (let _0_678 = (FStar_SMTEncoding_Term.mk_tester "BoxRef" x)
in ((typing_pred), (_0_678))))
in ((((typing_pred)::[])::[]), ((xx)::(aa)::[]), (_0_679))))
in ((_0_680), (Some ("ref inversion")), (Some ("ref_inversion")))))
in (let _0_689 = (let _0_688 = FStar_SMTEncoding_Term.Assume ((let _0_687 = (let _0_686 = (let _0_685 = (FStar_SMTEncoding_Util.mkImp (let _0_684 = (FStar_SMTEncoding_Util.mkAnd ((typing_pred), (typing_pred_b)))
in (let _0_683 = (FStar_SMTEncoding_Util.mkEq (let _0_682 = (FStar_SMTEncoding_Util.mkFreeV aa)
in (let _0_681 = (FStar_SMTEncoding_Util.mkFreeV bb)
in ((_0_682), (_0_681)))))
in ((_0_684), (_0_683)))))
in ((((typing_pred)::(typing_pred_b)::[])::[]), ((xx)::(aa)::(bb)::[]), (_0_685)))
in (mkForall_fuel' (Prims.parse_int "2") _0_686))
in ((_0_687), (Some ("ref typing is injective")), (Some ("ref_injectivity")))))
in (_0_688)::[])
in (_0_690)::_0_689))))))))))
in (
...
in (let _0_692 = FStar_SMTEncoding_Term.Assume ((let _0_691 = (FStar_SMTEncoding_Util.mkIff ((FStar_SMTEncoding_Util.mkFalse), (valid)))
in ((_0_691), (Some ("False interpretation")), (Some ("false_interp")))))
in (_0_692)::[])))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_694 = (let _0_693 = (FStar_SMTEncoding_Util.mkApp ((conj), ((a)::(b)::[])))
in (_0_693)::[])
in (("Valid"), (_0_694))))
in (
...
in (let _0_698 = FStar_SMTEncoding_Term.Assume ((let _0_697 = (FStar_SMTEncoding_Util.mkForall (let _0_696 = (FStar_SMTEncoding_Util.mkIff (let _0_695 = (FStar_SMTEncoding_Util.mkAnd ((valid_a), (valid_b)))
in ((_0_695), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::[]), (_0_696))))
in ((_0_697), (Some ("/\\ interpretation")), (Some ("l_and-interp")))))
in (_0_698)::[])))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_700 = (let _0_699 = (FStar_SMTEncoding_Util.mkApp ((disj), ((a)::(b)::[])))
in (_0_699)::[])
in (("Valid"), (_0_700))))
in (
...
let valid_b = (FStar_SMTEncoding_Util.mkApp (("Valid"), ((b)::[])))
in (let _0_704 = FStar_SMTEncoding_Term.Assume ((let _0_703 = (FStar_SMTEncoding_Util.mkForall (let _0_702 = (FStar_SMTEncoding_Util.mkIff (let _0_701 = (FStar_SMTEncoding_Util.mkOr ((valid_a), (valid_b)))
in ((_0_701), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::[]), (_0_702))))
in ((_0_703), (Some ("\\/ interpretation")), (Some ("l_or-interp")))))
in (_0_704)::[])))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_706 = (let _0_705 = (FStar_SMTEncoding_Util.mkApp ((eq2), ((a)::(x)::(y)::[])))
in (_0_705)::[])
in (("Valid"), (_0_706))))
in (let _0_710 = FStar_SMTEncoding_Term.Assume ((let _0_709 = (FStar_SMTEncoding_Util.mkForall (let _0_708 = (FStar_SMTEncoding_Util.mkIff (let _0_707 = (FStar_SMTEncoding_Util.mkEq ((x), (y)))
in ((_0_707), (valid))))
in ((((valid)::[])::[]), ((aa)::(xx)::(yy)::[]), (_0_708))))
in ((_0_709), (Some ("Eq2 interpretation")), (Some ("eq2-interp")))))
in (_0_710)::[])))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_712 = (let _0_711 = (FStar_SMTEncoding_Util.mkApp ((eq3), ((a)::(b)::(x)::(y)::[])))
in (_0_711)::[])
in (("Valid"), (_0_712))))
...
in ((_0_713), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::(xx)::(yy)::[]), (_0_714))))
in ((_0_715), (Some ("Eq3 interpretation")), (Some ("eq3-interp")))))
in (_0_716)::[])))))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_718 = (let _0_717 = (FStar_SMTEncoding_Util.mkApp ((imp), ((a)::(b)::[])))
in (_0_717)::[])
in (("Valid"), (_0_718))))
in (
...
let valid_b = (FStar_SMTEncoding_Util.mkApp (("Valid"), ((b)::[])))
in (let _0_722 = FStar_SMTEncoding_Term.Assume ((let _0_721 = (FStar_SMTEncoding_Util.mkForall (let _0_720 = (FStar_SMTEncoding_Util.mkIff (let _0_719 = (FStar_SMTEncoding_Util.mkImp ((valid_a), (valid_b)))
in ((_0_719), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::[]), (_0_720))))
in ((_0_721), (Some ("==> interpretation")), (Some ("l_imp-interp")))))
in (_0_722)::[])))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_724 = (let _0_723 = (FStar_SMTEncoding_Util.mkApp ((iff), ((a)::(b)::[])))
in (_0_723)::[])
in (("Valid"), (_0_724))))
in (
...
let valid_b = (FStar_SMTEncoding_Util.mkApp (("Valid"), ((b)::[])))
in (let _0_728 = FStar_SMTEncoding_Term.Assume ((let _0_727 = (FStar_SMTEncoding_Util.mkForall (let _0_726 = (FStar_SMTEncoding_Util.mkIff (let _0_725 = (FStar_SMTEncoding_Util.mkIff ((valid_a), (valid_b)))
in ((_0_725), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::[]), (_0_726))))
in ((_0_727), (Some ("<==> interpretation")), (Some ("l_iff-interp")))))
in (_0_728)::[])))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_730 = (let _0_729 = (FStar_SMTEncoding_Util.mkApp ((l_not), ((a)::[])))
in (_0_729)::[])
in (("Valid"), (_0_730))))
in (

let not_valid_a = (let _0_731 = (FStar_SMTEncoding_Util.mkApp (("Valid"), ((a)::[])))
in (FStar_All.pipe_left FStar_SMTEncoding_Util.mkNot _0_731))
in (let _0_734 = FStar_SMTEncoding_Term.Assume ((let _0_733 = (FStar_SMTEncoding_Util.mkForall (let _0_732 = (FStar_SMTEncoding_Util.mkIff ((not_valid_a), (valid)))
in ((((valid)::[])::[]), ((aa)::[]), (_0_732))))
in ((_0_733), (Some ("not interpretation")), (Some ("l_not-interp")))))
in (_0_734)::[]))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_736 = (let _0_735 = (FStar_SMTEncoding_Util.mkApp ((for_all), ((a)::(b)::[])))
in (_0_735)::[])
in (("Valid"), (_0_736))))
in (
...
in (_0_737)::[])
in (("Valid"), (_0_738))))
in (let _0_747 = FStar_SMTEncoding_Term.Assume ((let _0_746 = (FStar_SMTEncoding_Util.mkForall (let _0_745 = (FStar_SMTEncoding_Util.mkIff (let _0_744 = (FStar_SMTEncoding_Util.mkForall (let _0_743 = (let _0_740 = (let _0_739 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_0_739)::[])
in (_0_740)::[])
...
in ((_0_746), (Some ("forall interpretation")), (Some ("forall-interp")))))
in (_0_747)::[]))))))))))
in (
...
let valid = (FStar_SMTEncoding_Util.mkApp (let _0_749 = (let _0_748 = (FStar_SMTEncoding_Util.mkApp ((for_some), ((a)::(b)::[])))
in (_0_748)::[])
in (("Valid"), (_0_749))))
in (

let valid_b_x = (FStar_SMTEncoding_Util.mkApp (let _0_751 = (let _0_750 = (FStar_SMTEncoding_Util.mk_ApplyTT b x)
in (_0_750)::[])
in (("Valid"), (_0_751))))
in (let _0_760 = FStar_SMTEncoding_Term.Assume ((let _0_759 = (FStar_SMTEncoding_Util.mkForall (let _0_758 = (FStar_SMTEncoding_Util.mkIff (let _0_757 = (FStar_SMTEncoding_Util.mkExists (let _0_756 = (let _0_753 = (let _0_752 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_0_752)::[])
in (_0_753)::[])
in (let _0_755 = (FStar_SMTEncoding_Util.mkImp (let _0_754 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in ((_0_754), (valid_b_x))))
in ((_0_756), ((xx)::[]), (_0_755)))))
in ((_0_757), (valid))))
in ((((valid)::[])::[]), ((aa)::(bb)::[]), (_0_758))))
in ((_0_759), (Some ("exists interpretation")), (Some ("exists-interp")))))
in (_0_760)::[]))))))))))
in (
...
in (let _0_763 = FStar_SMTEncoding_Term.Assume ((let _0_762 = (FStar_SMTEncoding_Term.mk_HasTypeZ FStar_SMTEncoding_Term.mk_Range_const range_ty)
in (let _0_761 = Some ((varops.mk_unique "typing_range_const"))
in ((_0_762), (Some ("Range_const typing")), (_0_761)))))
in (_0_763)::[])))
in (
...
let uu____7978 = ((let _0_764 = (FStar_Syntax_Util.is_pure_or_ghost_function t_norm)
in (FStar_All.pipe_left Prims.op_Negation _0_764)) || (FStar_Syntax_Util.is_lemma t_norm))
...
| true -> begin
(let _0_765 = (FStar_TypeChecker_Util.pure_or_ghost_pre_and_post env.tcenv comp)
in ((args), (_0_765)))
end
| uu____8070 -> begin
...
in (let _0_770 = FStar_SMTEncoding_Term.Assume ((let _0_769 = (FStar_SMTEncoding_Util.mkForall (let _0_768 = (FStar_SMTEncoding_Util.mkEq (let _0_767 = (let _0_766 = (FStar_SMTEncoding_Term.mk_tester (escape d.FStar_Ident.str) xx)
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _0_766))
in ((vapp), (_0_767))))
in ((((vapp)::[])::[]), (vars), (_0_768))))
in ((_0_769), (Some ("Discriminator equation")), (Some ((Prims.strcat "disc_equation_" (escape d.FStar_Ident.str)))))))
in (_0_770)::[]))
end))
end
...
in (let _0_773 = FStar_SMTEncoding_Term.Assume ((let _0_772 = (FStar_SMTEncoding_Util.mkForall (let _0_771 = (FStar_SMTEncoding_Util.mkEq ((vapp), (prim_app)))
in ((((vapp)::[])::[]), (vars), (_0_771))))
in ((_0_772), (Some ("Projector equation")), (Some ((Prims.strcat "proj_equation_" tp_name))))))
in (_0_773)::[])))))
end))
end
| uu____8200 -> begin
...
| None -> begin
(let _0_774 = (FStar_SMTEncoding_Util.mk_and_l guards)
in ((_0_774), (decls1)))
end
| Some (p) -> begin
(
...
| (g, ds) -> begin
(let _0_775 = (FStar_SMTEncoding_Util.mk_and_l ((g)::guards))
in ((_0_775), ((FStar_List.append decls1 ds))))
end))
end)
...
let vapp = (FStar_SMTEncoding_Util.mkApp (let _0_776 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((vname), (_0_776))))
in (

let uu____8248 = (

let vname_decl = FStar_SMTEncoding_Term.DeclFun ((let _0_777 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____8258 -> FStar_SMTEncoding_Term.Term_sort)))
in ((vname), (_0_777), (FStar_SMTEncoding_Term.Term_sort), (None))))
in (
...
| [] -> begin
(let _0_781 = (let _0_780 = (let _0_779 = (FStar_SMTEncoding_Util.mkFreeV ((vname), (FStar_SMTEncoding_Term.Term_sort)))
in (FStar_All.pipe_left (fun _0_778 -> Some (_0_778)) _0_779))
in (push_free_var env lid vname _0_780))
in (((FStar_List.append decls2 ((tok_typing)::[]))), (_0_781)))
end
| uu____8289 -> begin
(
...
let vtok_fresh = (let _0_782 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((vtok), (FStar_SMTEncoding_Term.Term_sort)) _0_782))
in (

let name_tok_corr = FStar_SMTEncoding_Term.Assume ((let _0_784 = (FStar_SMTEncoding_Util.mkForall (let _0_783 = (FStar_SMTEncoding_Util.mkEq ((vtok_app), (vapp)))
in ((((vtok_app)::[])::((vapp)::[])::[]), (vars), (_0_783))))
in ((_0_784), (Some ("Name-token correspondence")), (Some ((Prims.strcat "token_correspondence_" vname))))))
...
(let _0_785 = (FStar_SMTEncoding_Term.mk_HasType vapp encoded_res_t)
in ((encoded_res_t), (_0_785), (decls)))
end)))
in (match (uu____8319) with
| (encoded_res_t, ty_pred, decls3) -> begin
(

let typingAx = FStar_SMTEncoding_Term.Assume ((let _0_787 = (FStar_SMTEncoding_Util.mkForall (let _0_786 = (FStar_SMTEncoding_Util.mkImp ((guard), (ty_pred)))
in ((((vapp)::[])::[]), (vars), (_0_786))))
in ((_0_787), (Some ("free var typing")), (Some ((Prims.strcat "typing_" vname))))))
in (
...
| true -> begin
(let _0_792 = (FStar_SMTEncoding_Term.fresh_constructor (let _0_789 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (let _0_788 = (varops.next_id ())
in ((vname), (_0_789), (FStar_SMTEncoding_Term.Term_sort), (_0_788)))))
in (let _0_791 = (let _0_790 = (pretype_axiom vapp vars)
in (_0_790)::[])
in (_0_792)::_0_791))
end
| uu____8356 -> begin
...
let g = (let _0_797 = (let _0_796 = (let _0_795 = (let _0_794 = (let _0_793 = (mk_disc_proj_axioms guard encoded_res_t vapp vars)
in (typingAx)::_0_793)
in (FStar_List.append freshness _0_794))
in (FStar_List.append decls3 _0_795))
in (FStar_List.append decls2 _0_796))
in (FStar_List.append decls1 _0_797))
in ((g), (env)))))
end))
end))))
end))
...
| true -> begin
(let _0_799 = (let _0_798 = (encode_smt_lemma env lid tt)
in (FStar_List.append decls _0_798))
in ((_0_799), (env)))
end
| uu____8497 -> begin
((decls), (env))
...
let uu____8534 = (let _0_800 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (encode_top_level_val env _0_800 lb.FStar_Syntax_Syntax.lbtyp quals))
...
FStar_Syntax_Syntax.NT ((let _0_801 = (FStar_Syntax_Syntax.bv_to_name binder)
in ((formal), (_0_801))))
end)) formals binders)
in (

let extra_formals = (let _0_804 = (FStar_All.pipe_right extra_formals (FStar_List.map (fun uu____8688 -> (match (uu____8688) with
| (x, i) -> begin
(let _0_803 = (

let uu___152_8695 = x
in (let _0_802 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___152_8695.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___152_8695.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_802}))
in ((_0_803), (i)))
end))))
in (FStar_All.pipe_right _0_804 FStar_Syntax_Util.name_binders))
in (

let body = (let _0_810 = (let _0_809 = (FStar_Syntax_Subst.subst subst t).FStar_Syntax_Syntax.n
in (FStar_All.pipe_left (fun _0_808 -> Some (_0_808)) _0_809))
in ((let _0_807 = (FStar_Syntax_Subst.compress body)
in (let _0_806 = (let _0_805 = (FStar_Syntax_Util.args_of_binders extra_formals)
in (FStar_All.pipe_left Prims.snd _0_805))
in (FStar_Syntax_Syntax.extend_app_n _0_807 _0_806))) _0_810 body.FStar_Syntax_Syntax.pos))
...
FStar_Syntax_Syntax.NT ((let _0_811 = (FStar_Syntax_Syntax.bv_to_name x)
in ((b), (_0_811))))
end)) bs0 formals)
...
(let _0_812 = (Prims.fst (aux norm x.FStar_Syntax_Syntax.sort))
in ((_0_812), (true)))
end
...
| uu____9095 -> begin
(failwith (let _0_814 = (FStar_Syntax_Print.term_to_string e)
in (let _0_813 = (FStar_Syntax_Print.term_to_string t_norm)
in (FStar_Util.format3 "Impossible! let-bound lambda %s = %s has a type that\'s not a function: %s\n" flid.FStar_Ident.str _0_814 _0_813))))
end))
end
| uu____9110 -> begin
(
...
let uu____9344 = (let _0_815 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (declare_top_level_let env _0_815 lb.FStar_Syntax_Syntax.lbtyp t_norm))
in (match (uu____9344) with
| (tok, decl, env) -> begin
(let _0_818 = (let _0_817 = (let _0_816 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in ((_0_816), (tok)))
in (_0_817)::toks)
in ((_0_818), ((t_norm)::typs), ((decl)::decls), (env)))
end)));
)
end)) (([]), ([]), ([]), (env))))
...
| None -> begin
(let _0_819 = (FStar_SMTEncoding_Util.mkFreeV ((f), (FStar_SMTEncoding_Term.Term_sort)))
in (mk_Apply _0_819 vars))
end)
end
| uu____9482 -> begin
(FStar_SMTEncoding_Util.mkApp (let _0_820 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((f), (_0_820))))
end)
end))
in (
...
| uu____9489 -> begin
false
end)))) || (FStar_All.pipe_right typs (FStar_Util.for_some (fun t -> (let _0_821 = (FStar_Syntax_Util.is_pure_or_ghost_function t)
in (FStar_All.pipe_left Prims.op_Negation _0_821))))))
...
| true -> begin
(let _0_823 = (FStar_SMTEncoding_Term.mk_Valid app)
in (let _0_822 = (encode_formula body env')
in ((_0_823), (_0_822))))
end
| uu____9612 -> begin
(let _0_824 = (encode_term body env')
in ((app), (_0_824)))
end))
...
let eqn = FStar_SMTEncoding_Term.Assume ((let _0_827 = (FStar_SMTEncoding_Util.mkForall (let _0_825 = (FStar_SMTEncoding_Util.mkEq ((app), (body)))
in ((((app)::[])::[]), (vars), (_0_825))))
in (let _0_826 = Some ((FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str))
in ((_0_827), (_0_826), (Some ((Prims.strcat "equation_" f)))))))
in (let _0_832 = (let _0_831 = (let _0_830 = (let _0_829 = (let _0_828 = (primitive_type_axioms env.tcenv flid f app)
in (FStar_List.append ((eqn)::[]) _0_828))
in (FStar_List.append decls2 _0_829))
in (FStar_List.append binder_decls _0_830))
in (FStar_List.append decls _0_831))
in ((_0_832), (env))))
end)))
end))
end))))
...
let fuel = (let _0_833 = (varops.fresh "fuel")
in ((_0_833), (FStar_SMTEncoding_Term.Fuel_sort)))
in (
...
let env = (let _0_836 = (let _0_835 = (FStar_SMTEncoding_Util.mkApp ((g), ((fuel_tm)::[])))
in (FStar_All.pipe_left (fun _0_834 -> Some (_0_834)) _0_835))
in (push_free_var env flid gtok _0_836))
...
| true -> begin
(let _0_839 = (FStar_Syntax_Print.lbname_to_string lbn)
in (let _0_838 = (FStar_Syntax_Print.term_to_string t_norm)
in (let _0_837 = (FStar_Syntax_Print.term_to_string e)
...
| true -> begin
(let _0_841 = (FStar_Syntax_Print.binders_to_string ", " binders)
in (let _0_840 = (FStar_Syntax_Print.term_to_string body)
...
let decl_g = FStar_SMTEncoding_Term.DeclFun ((let _0_843 = (let _0_842 = (FStar_List.map Prims.snd vars)
in (FStar_SMTEncoding_Term.Fuel_sort)::_0_842)
in ((g), (_0_843), (FStar_SMTEncoding_Term.Term_sort), (Some ("Fuel-instrumented function name")))))
in (
...
let app = (FStar_SMTEncoding_Util.mkApp (let _0_844 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((f), (_0_844))))
in (

let gsapp = (FStar_SMTEncoding_Util.mkApp (let _0_846 = (let _0_845 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((fuel_tm)::[])))
in (_0_845)::vars_tm)
in ((g), (_0_846))))
in (

let gmax = (FStar_SMTEncoding_Util.mkApp (let _0_848 = (let _0_847 = (FStar_SMTEncoding_Util.mkApp (("MaxFuel"), ([])))
in (_0_847)::vars_tm)
in ((g), (_0_848))))
in (
...
let eqn_g = FStar_SMTEncoding_Term.Assume ((let _0_851 = (FStar_SMTEncoding_Util.mkForall' (let _0_849 = (FStar_SMTEncoding_Util.mkEq ((gsapp), (body_tm)))
in ((((gsapp)::[])::[]), (Some ((Prims.parse_int "0"))), ((fuel)::vars), (_0_849))))
in (let _0_850 = Some ((FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Ident.str))
in ((_0_851), (_0_850), (Some ((Prims.strcat "equation_with_fuel_" g)))))))
in (

let eqn_f = FStar_SMTEncoding_Term.Assume ((let _0_853 = (FStar_SMTEncoding_Util.mkForall (let _0_852 = (FStar_SMTEncoding_Util.mkEq ((app), (gmax)))
in ((((app)::[])::[]), (vars), (_0_852))))
in ((_0_853), (Some ("Correspondence of recursive function to instrumented version")), (Some ((Prims.strcat "fuel_correspondence_" g))))))
in (

let eqn_g' = FStar_SMTEncoding_Term.Assume ((let _0_858 = (FStar_SMTEncoding_Util.mkForall (let _0_857 = (FStar_SMTEncoding_Util.mkEq (let _0_856 = (FStar_SMTEncoding_Util.mkApp (let _0_855 = (let _0_854 = (FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "0"))
in (_0_854)::vars_tm)
in ((g), (_0_855))))
in ((gsapp), (_0_856))))
in ((((gsapp)::[])::[]), ((fuel)::vars), (_0_857))))
in ((_0_858), (Some ("Fuel irrelevance")), (Some ((Prims.strcat "fuel_irrelevance_" g))))))
in (
...
let tok_app = (let _0_859 = (FStar_SMTEncoding_Util.mkFreeV ((gtok), (FStar_SMTEncoding_Term.Term_sort)))
in (mk_Apply _0_859 ((fuel)::vars)))
in FStar_SMTEncoding_Term.Assume ((let _0_861 = (FStar_SMTEncoding_Util.mkForall (let _0_860 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (gapp)))
in ((((tok_app)::[])::[]), ((fuel)::vars), (_0_860))))
in ((_0_861), (Some ("Fuel token correspondence")), (Some ((Prims.strcat "fuel_token_correspondence_" gtok)))))))
in (
...
| (g_typing, d3) -> begin
(let _0_866 = (let _0_865 = FStar_SMTEncoding_Term.Assume ((let _0_864 = (FStar_SMTEncoding_Util.mkForall (let _0_863 = (FStar_SMTEncoding_Util.mkImp (let _0_862 = (FStar_SMTEncoding_Util.mk_and_l v_guards)
in ((_0_862), (g_typing))))
in ((((gapp)::[])::[]), ((fuel)::vars), (_0_863))))
in ((_0_864), (Some ("Typing correspondence of token to term")), (Some ((Prims.strcat "token_correspondence_" g))))))
in (_0_865)::[])
in ((d3), (_0_866)))
end))
...
let uu____10123 = (let _0_867 = (FStar_List.zip3 gtoks typs bindings)
...
end)) (((decls)::[]), ([]), (env0)) _0_867))
in (match (uu____10123) with
| (decls, eqns, env0) -> begin
(

let uu____10268 = (let _0_868 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _0_868 (FStar_List.partition (fun uu___125_10281 -> (match (uu___125_10281) with
...
let msg = (let _0_869 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right _0_869 (FStar_String.concat " and ")))
in (
...
| true -> begin
(let _0_870 = (FStar_Syntax_Print.sigelt_to_string se)
...
(match (g) with
| [] -> begin
(let _0_872 = (let _0_871 = FStar_SMTEncoding_Term.Caption ((FStar_Util.format1 "<Skipped %s/>" nm))
in (_0_871)::[])
in ((_0_872), (e)))
end
| uu____10353 -> begin
(let _0_877 = (let _0_876 = (let _0_873 = FStar_SMTEncoding_Term.Caption ((FStar_Util.format1 "<Start encoding %s>" nm))
in (_0_873)::g)
in (let _0_875 = (let _0_874 = FStar_SMTEncoding_Term.Caption ((FStar_Util.format1 "</end encoding %s>" nm))
in (_0_874)::[])
in (FStar_List.append _0_876 _0_875)))
in ((_0_877), (e)))
end)
end)));
))
...
let uu____10373 = (let _0_878 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right _0_878 Prims.op_Negation))
...
| uu____10393 -> begin
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_abs ((let _0_880 = (FStar_All.pipe_left (fun _0_879 -> Some (_0_879)) (FStar_Util.Inr (((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[])))))
in ((ed.FStar_Syntax_Syntax.binders), (tm), (_0_880)))))) None tm.FStar_Syntax_Syntax.pos)
end))
in (
...
let uu____10467 = (let _0_881 = (close_effect_params a.FStar_Syntax_Syntax.action_defn)
in (encode_term _0_881 env))
in (match (uu____10467) with
| (tm, decls) -> begin
(

let a_decls = (let _0_883 = FStar_SMTEncoding_Term.DeclFun ((let _0_882 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____10485 -> FStar_SMTEncoding_Term.Term_sort)))
in ((aname), (_0_882), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action")))))
in (_0_883)::(FStar_SMTEncoding_Term.DeclFun (((atok), ([]), (FStar_SMTEncoding_Term.Term_sort), (Some ("Action token")))))::[])
in (

let uu____10490 = (let _0_884 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____10522 -> (match (uu____10522) with
...
in (FStar_All.pipe_right _0_884 FStar_List.split))
in (match (uu____10490) with
| (xs_sorts, xs) -> begin
(

let app = (FStar_SMTEncoding_Util.mkApp (let _0_886 = (let _0_885 = (FStar_SMTEncoding_Util.mkApp ((aname), (xs)))
in (_0_885)::[])
in (("Reify"), (_0_886))))
in (

let a_eq = FStar_SMTEncoding_Term.Assume ((let _0_889 = (FStar_SMTEncoding_Util.mkForall (let _0_888 = (FStar_SMTEncoding_Util.mkEq (let _0_887 = (mk_Apply tm xs_sorts)
in ((app), (_0_887))))
in ((((app)::[])::[]), (xs_sorts), (_0_888))))
in ((_0_889), (Some ("Action equality")), (Some ((Prims.strcat aname "_equality"))))))
in (
...
in FStar_SMTEncoding_Term.Assume ((let _0_891 = (FStar_SMTEncoding_Util.mkForall (let _0_890 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (app)))
in ((((tok_app)::[])::[]), (xs_sorts), (_0_890))))
in ((_0_891), (Some ("Action token correspondence")), (Some ((Prims.strcat aname "_token_correspondence"))))))))
...
in (let _0_893 = (let _0_892 = (primitive_type_axioms env.tcenv lid tname tsym)
in (FStar_List.append decls _0_892))
in ((_0_893), (env)))))
end)))
end))
end
...
let g = (let _0_897 = FStar_SMTEncoding_Term.Assume ((let _0_896 = Some ((let _0_894 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Assumption: %s" _0_894)))
in (let _0_895 = Some ((varops.mk_unique (Prims.strcat "assumption_" l.FStar_Ident.str)))
in ((f), (_0_896), (_0_895)))))
in (_0_897)::[])
...
let uu____10689 = (let _0_898 = (FStar_TypeChecker_Env.try_lookup_val_decl env.tcenv lid)
in (FStar_All.pipe_left FStar_Option.isNone _0_898))
...
let valid_b2t_x = (FStar_SMTEncoding_Util.mkApp (let _0_900 = (let _0_899 = (FStar_SMTEncoding_Util.mkApp (("Prims.b2t"), ((x)::[])))
in (_0_899)::[])
in (("Valid"), (_0_900))))
in (

let decls = (let _0_905 = (let _0_904 = FStar_SMTEncoding_Term.Assume ((let _0_903 = (FStar_SMTEncoding_Util.mkForall (let _0_902 = (FStar_SMTEncoding_Util.mkEq (let _0_901 = (FStar_SMTEncoding_Util.mkApp (("BoxBool_proj_0"), ((x)::[])))
in ((valid_b2t_x), (_0_901))))
in ((((valid_b2t_x)::[])::[]), ((xx)::[]), (_0_902))))
in ((_0_903), (Some ("b2t def")), (Some ("b2t_def")))))
in (_0_904)::[])
in (FStar_SMTEncoding_Term.DeclFun (((tname), ((FStar_SMTEncoding_Term.Term_sort)::[]), (FStar_SMTEncoding_Term.Term_sort), (None))))::_0_905)
in ((decls), (env))))))
end))
end
...
| FStar_Syntax_Syntax.Sig_let (uu____10801, uu____10802, lids, quals, uu____10805) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> (let _0_906 = (FStar_List.hd l.FStar_Ident.ns).FStar_Ident.idText
in (_0_906 = "Prims"))))) && (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___128_10815 -> (match (uu___128_10815) with
...
in (let _0_907 = (FStar_Syntax_Syntax.mk_Total reified_typ)
in (FStar_Syntax_Util.arrow formals _0_907)))
end))
in (
...
(let _0_909 = FStar_SMTEncoding_Term.DeclFun ((let _0_908 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in ((name), (_0_908), (FStar_SMTEncoding_Term.Term_sort), (None))))
in (_0_909)::[])
end))
end
| uu____11116 -> begin
...
let uu____11131 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _0_910 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
in (FStar_All.pipe_right _0_910 FStar_Option.isNone)))))
...
| (x, uu____11245) -> begin
(let _0_912 = (FStar_SMTEncoding_Util.mkApp (let _0_911 = (mk_term_projector_name l x)
in ((_0_911), ((xx)::[]))))
in (push_term_var env x _0_912))
end)) env))
in (
...
let eqs = (let _0_914 = (FStar_List.map2 (fun v a -> (FStar_SMTEncoding_Util.mkEq (let _0_913 = (FStar_SMTEncoding_Util.mkFreeV v)
in ((_0_913), (a))))) vars indices)
in (FStar_All.pipe_right _0_914 FStar_SMTEncoding_Util.mk_and_l))
in (let _0_917 = (FStar_SMTEncoding_Util.mkOr (let _0_916 = (FStar_SMTEncoding_Util.mkAnd (let _0_915 = (mk_data_tester env l xx)
in ((_0_915), (eqs))))
in ((out), (_0_916))))
in ((_0_917), ((FStar_List.append decls decls')))));
)
end))))
end))
end))
...
| true -> begin
(let _0_918 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((ff)::[])))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel _0_918 xx tapp))
end
| uu____11293 -> begin
(FStar_SMTEncoding_Term.mk_HasTypeFuel ff xx tapp)
end)
in FStar_SMTEncoding_Term.Assume ((let _0_922 = (FStar_SMTEncoding_Util.mkForall (let _0_920 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (let _0_919 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_sfuel), (data_ax)))
in ((((xx_has_type_sfuel)::[])::[]), (_0_920), (_0_919)))))
in (let _0_921 = Some ((varops.mk_unique (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str)))
in ((_0_922), (Some ("inversion axiom")), (_0_921))))))
in (
...
in (let _0_927 = FStar_SMTEncoding_Term.Assume ((let _0_926 = (FStar_SMTEncoding_Util.mkForall (let _0_924 = (add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (let _0_923 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_fuel), (data_ax)))
in ((((xx_has_type_fuel)::(pattern_guard)::[])::[]), (_0_924), (_0_923)))))
in (let _0_925 = Some ((varops.mk_unique (Prims.strcat "pattern_guarded_inversion_" t.FStar_Ident.str)))
in ((_0_926), (Some ("inversion axiom")), (_0_925)))))
in (_0_927)::[])))
end
| uu____11330 -> begin
[]
...
let tapp = (FStar_SMTEncoding_Util.mkApp (let _0_928 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((tname), (_0_928))))
in (

let uu____11426 = (

let tname_decl = (constructor_or_logic_type_decl (let _0_930 = (FStar_All.pipe_right vars (FStar_List.map (fun uu____11443 -> (match (uu____11443) with
| (n, s) -> begin
(((Prims.strcat tname n)), (s))
end))))
in (let _0_929 = (varops.next_id ())
in ((tname), (_0_930), (FStar_SMTEncoding_Term.Term_sort), (_0_929), (false)))))
in (

let uu____11450 = (match (vars) with
| [] -> begin
(let _0_934 = (let _0_933 = (let _0_932 = (FStar_SMTEncoding_Util.mkApp ((tname), ([])))
in (FStar_All.pipe_left (fun _0_931 -> Some (_0_931)) _0_932))
in (push_free_var env t tname _0_933))
in (([]), (_0_934)))
end
| uu____11460 -> begin
(
...
let ttok_fresh = (let _0_935 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ttok), (FStar_SMTEncoding_Term.Term_sort)) _0_935))
in (
...
let name_tok_corr = FStar_SMTEncoding_Term.Assume ((let _0_937 = (FStar_SMTEncoding_Util.mkForall' (let _0_936 = (FStar_SMTEncoding_Util.mkEq ((ttok_app), (tapp)))
in ((pats), (None), (vars), (_0_936))))
in ((_0_937), (Some ("name-token correspondence")), (Some ((Prims.strcat "token_correspondence_" ttok))))))
...
| true -> begin
(let _0_940 = FStar_SMTEncoding_Term.Assume ((let _0_939 = (let _0_938 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _0_938))
in ((_0_939), (Some ("kinding")), (Some ((Prims.strcat "pre_kinding_" ttok))))))
in (_0_940)::[])
end
| uu____11513 -> begin
[]
end)
in (let _0_945 = (let _0_944 = (let _0_943 = FStar_SMTEncoding_Term.Assume ((let _0_942 = (FStar_SMTEncoding_Util.mkForall (let _0_941 = (FStar_SMTEncoding_Util.mkImp ((guard), (k)))
in ((((tapp)::[])::[]), (vars), (_0_941))))
in ((_0_942), (None), (Some ((Prims.strcat "kinding_" ttok))))))
in (_0_943)::[])
in (FStar_List.append karr _0_944))
in (FStar_List.append decls _0_945)))
end))
in (

let aux = (let _0_949 = (let _0_948 = (inversion_axioms tapp vars)
in (let _0_947 = (let _0_946 = (pretype_axiom tapp vars)
in (_0_946)::[])
in (FStar_List.append _0_948 _0_947)))
in (FStar_List.append kindingAx _0_949))
in (
...
let projectors = (FStar_All.pipe_right names (FStar_List.map (fun x -> (let _0_950 = (mk_term_projector_name d x)
in ((_0_950), (FStar_SMTEncoding_Term.Term_sort))))))
in (

let datacons = (let _0_952 = (let _0_951 = (varops.next_id ())
in ((ddconstrsym), (projectors), (FStar_SMTEncoding_Term.Term_sort), (_0_951), (true)))
in (FStar_All.pipe_right _0_952 FStar_SMTEncoding_Term.constructor_to_decl))
in (
...
| uu____11694 -> begin
(let _0_954 = (let _0_953 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ddtok), (FStar_SMTEncoding_Term.Term_sort)) _0_953))
in (_0_954)::[])
end)
in (
...
let uu____11791 = (let _0_955 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env _0_955))
in (match (uu____11791) with
| (uu____11800, xv, env) -> begin
(let _0_957 = (let _0_956 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (_0_956)::eqns)
in ((env), ((xv)::arg_vars), (_0_957)))
end))
...
let typing_inversion = FStar_SMTEncoding_Term.Assume ((let _0_961 = (FStar_SMTEncoding_Util.mkForall (let _0_960 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (let _0_959 = (FStar_SMTEncoding_Util.mkImp (let _0_958 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append eqns guards))
in ((ty_pred), (_0_958))))
in ((((ty_pred)::[])::[]), (_0_960), (_0_959)))))
in ((_0_961), (Some ("data constructor typing elim")), (Some ((Prims.strcat "data_elim_" ddconstrsym))))))
in (
...
let x = (let _0_962 = (varops.fresh "x")
in ((_0_962), (FStar_SMTEncoding_Term.Term_sort)))
in (

let xtm = (FStar_SMTEncoding_Util.mkFreeV x)
in FStar_SMTEncoding_Term.Assume ((let _0_970 = (FStar_SMTEncoding_Util.mkForall (let _0_968 = (let _0_964 = (let _0_963 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp)
in (_0_963)::[])
in (_0_964)::[])
in (let _0_967 = (FStar_SMTEncoding_Util.mkImp (let _0_966 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (let _0_965 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp)
in ((_0_966), (_0_965)))))
in ((_0_968), ((x)::[]), (_0_967)))))
in (let _0_969 = Some ((varops.mk_unique "lextop"))
in ((_0_970), (Some ("lextop is top")), (_0_969)))))))
end
| uu____11860 -> begin
(
...
(let _0_972 = (let _0_971 = (FStar_SMTEncoding_Util.mkFreeV v)
in (FStar_SMTEncoding_Util.mk_Precedes _0_971 dapp))
in (_0_972)::[])
end
| uu____11871 -> begin
(failwith "unexpected sort")
end))))
in FStar_SMTEncoding_Term.Assume ((let _0_976 = (FStar_SMTEncoding_Util.mkForall (let _0_975 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (let _0_974 = (FStar_SMTEncoding_Util.mkImp (let _0_973 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (_0_973))))
in ((((ty_pred)::[])::[]), (_0_975), (_0_974)))))
in ((_0_976), (Some ("subterm ordering")), (Some ((Prims.strcat "subterm_ordering_" ddconstrsym)))))))
end)
...
| uu____11885 -> begin
((let _0_979 = (let _0_978 = (FStar_Syntax_Print.lid_to_string d)
in (let _0_977 = (FStar_Syntax_Print.term_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _0_978 _0_977)))
in (FStar_Errors.warn drange _0_979));
(([]), ([]));
)
end))
end)))
...
let g = (let _0_1000 = (let _0_999 = (let _0_998 = (let _0_997 = (let _0_982 = FStar_SMTEncoding_Term.DeclFun ((let _0_981 = Some ((let _0_980 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" _0_980)))
in ((ddtok), ([]), (FStar_SMTEncoding_Term.Term_sort), (_0_981))))
in (_0_982)::[])
in (let _0_996 = (let _0_995 = (let _0_994 = (let _0_993 = (let _0_992 = (let _0_991 = (let _0_990 = FStar_SMTEncoding_Term.Assume ((let _0_984 = (FStar_SMTEncoding_Util.mkForall (let _0_983 = (FStar_SMTEncoding_Util.mkEq ((app), (dapp)))
in ((((app)::[])::[]), (vars), (_0_983))))
in ((_0_984), (Some ("equality for proxy")), (Some ((Prims.strcat "equality_tok_" ddtok))))))
in (let _0_989 = (let _0_988 = FStar_SMTEncoding_Term.Assume ((let _0_987 = (FStar_SMTEncoding_Util.mkForall (let _0_986 = (add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) vars')
in (let _0_985 = (FStar_SMTEncoding_Util.mkImp ((guard'), (ty_pred')))
in ((((ty_pred')::[])::[]), (_0_986), (_0_985)))))
in ((_0_987), (Some ("data constructor typing intro")), (Some ((Prims.strcat "data_typing_intro_" ddtok))))))
in (_0_988)::[])
in (_0_990)::_0_989))
in (FStar_SMTEncoding_Term.Assume (((tok_typing), (Some ("typing for data constructor proxy")), (Some ((Prims.strcat "typing_tok_" ddtok))))))::_0_991)
in (FStar_List.append _0_992 elim))
in (FStar_List.append decls_pred _0_993))
in (FStar_List.append decls_formals _0_994))
in (FStar_List.append proxy_fresh _0_995))
in (FStar_List.append _0_997 _0_996)))
in (FStar_List.append decls3 _0_998))
in (FStar_List.append decls2 _0_999))
in (FStar_List.append binder_decls _0_1000))
...
| true -> begin
(let _0_1003 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_1002 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_1001 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" _0_1003 _0_1002 _0_1001))))
end
| uu____12006 -> begin
()
end));
...
let uu____12017 = (let _0_1008 = (let _0_1007 = (let _0_1006 = (FStar_Util.digest_of_string t_hash)
in (let _0_1005 = (let _0_1004 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _0_1004))
in (Prims.strcat _0_1006 _0_1005)))
in (Prims.strcat "x_" _0_1007))
in (new_term_constant_from_string env x _0_1008))
...
| true -> begin
Some ((let _0_1011 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_1010 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_1009 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _0_1011 _0_1010 _0_1009)))))
end
| uu____12033 -> begin
None
end))
...
(let _0_1015 = (FStar_All.pipe_left (fun _0_1012 -> FStar_SMTEncoding_Term.Echo (_0_1012)) (Prims.fst l))
in (let _0_1014 = (let _0_1013 = FStar_SMTEncoding_Term.Eval ((FStar_SMTEncoding_Util.mkFreeV l))
in (_0_1013)::[])
in (_0_1015)::_0_1014))
end))))
in ((prefix), (suffix)))))
...
let init_env : FStar_TypeChecker_Env.env  ->  Prims.unit = (fun tcenv -> (let _0_1018 = (let _0_1017 = (let _0_1016 = (FStar_Util.smap_create (Prims.parse_int "100"))
in {bindings = []; depth = (Prims.parse_int "0"); tcenv = tcenv; warn = true; cache = _0_1016; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_0_1017)::[])
in (FStar_ST.write last_env _0_1018)))
...
| true -> begin
(let _0_1021 = FStar_SMTEncoding_Term.Caption ((let _0_1020 = (let _0_1019 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se) (FStar_List.map FStar_Syntax_Print.lid_to_string))
in (FStar_All.pipe_right _0_1019 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " _0_1020)))
in (_0_1021)::decls)
end
| uu____12340 -> begin
decls
...
| true -> begin
(let _0_1022 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) FStar_Util.string_of_int)
...
in (let _0_1024 = (let _0_1023 = (FStar_Syntax_Syntax.mk_binder (
...
(let _0_1025 = (FStar_Syntax_Util.close_forall (FStar_List.rev closing) q)
in ((_0_1025), (bindings)))
end)))
...
let uu____12497 = (let _0_1026 = (FStar_List.filter (fun uu___133_12500 -> (match (uu___133_12500) with
...
in (encode_env_bindings env _0_1026))
...
| true -> begin
(let _0_1027 = (FStar_Syntax_Print.term_to_string q)
...
let uu____12530 = (let _0_1028 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _0_1028 phi))
...
let qry = FStar_SMTEncoding_Term.Assume ((let _0_1030 = (FStar_SMTEncoding_Util.mkNot phi)
in (let _0_1029 = Some ((varops.mk_unique "@query"))
in ((_0_1030), (Some ("query")), (_0_1029)))))
in (

let suffix = (let _0_1032 = (let _0_1031 = (
...
in (FStar_List.append _0_1031 ((FStar_SMTEncoding_Term.Echo ("Done!"))::[])))
in (FStar_List.append label_suffix _0_1032))
