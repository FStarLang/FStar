...
in (FStar_Util.format1 "Pattern misses at least one bound variable: %s" _188_1096))
...
| FStar_Syntax_Syntax.Sig_let (_90_2768, _90_2770, lids, quals) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> ((let _188_2305 = (FStar_List.hd l.FStar_Ident.ns)
...
let _90_2970 = (match ((let _188_2358 = (FStar_Syntax_Subst.compress k)
...
let tname_decl = (let _188_2364 = (let _188_2363 = (FStar_All.pipe_right vars (FStar_List.map (fun _90_2990 -> (match (_90_2990) with
| (n, s) -> begin
...
let _90_3120 = (let _188_2400 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
...
let _90_3144 = (let _188_2435 = (let _188_2434 = (FStar_Syntax_Print.lid_to_string d)
...
let _90_3182 = (let _188_2482 = (let _188_2481 = (let _188_2480 = (FStar_Util.digest_of_string t_hash)
...
let _90_3286 = (let _188_2520 = (pop_env ())
...
(let _188_2536 = (let _188_2535 = (let _188_2534 = (let _188_2533 = (let _188_2532 = (FStar_Syntax_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _188_2532 (FStar_List.map FStar_Syntax_Print.lid_to_string)))
in (FStar_All.pipe_right _188_2533 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " _188_2534))
in FStar_SMTEncoding_Term.Caption (_188_2535))
in (_188_2536)::decls)
end else begin
decls
end)
...
in (let _188_2537 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 _188_2537)))
end)))))
...
(let _188_2542 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) FStar_Util.string_of_int)
...
let _90_3339 = (let _188_2560 = (let _188_2559 = (FStar_TypeChecker_Env.current_module tcenv)
in _188_2559.FStar_Ident.str)
in (FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name _188_2560))
in (
...
in (let _188_2566 = (let _188_2565 = (FStar_Syntax_Syntax.mk_binder (
...
(let _188_2567 = (FStar_Syntax_Util.close_forall (FStar_List.rev closing) q)
in ((_188_2567), (bindings)))
end)))
in (match (_90_3364) with
| (q, bindings) -> begin
(

let _90_3373 = (let _188_2569 = (FStar_List.filter (fun _90_25 -> (match (_90_25) with
...
in (encode_env_bindings env _188_2569))
...
(let _188_2570 = (FStar_Syntax_Print.term_to_string q)
...
let _90_3381 = (let _188_2571 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _188_2571 phi))
...
let qry = (let _188_2575 = (let _188_2574 = (FStar_SMTEncoding_Util.mkNot phi)
in (let _188_2573 = (let _188_2572 = (varops.mk_unique "@query")
in Some (_188_2572))
in ((_188_2574), (Some ("query")), (_188_2573))))
in FStar_SMTEncoding_Term.Assume (_188_2575))
in (

let suffix = (let _188_2577 = (let _188_2576 = if (FStar_Options.print_z3_statistics ()) then begin
(FStar_SMTEncoding_Term.PrintStats)::[]
end else begin
[]
end
in (FStar_List.append _188_2576 ((FStar_SMTEncoding_Term.Echo ("Done!"))::[])))
in (FStar_List.append label_suffix _188_2577))
