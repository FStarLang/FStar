...
let subst_lcomp_opt s l =
  ...
  | Some (FStar_Util.Inl l) ->
      Some
        (FStar_Util.Inl
           (let _0_273 =
              let _0_272 = l.FStar_Syntax_Syntax.comp () in
              FStar_Syntax_Subst.subst_comp s _0_272 in
            FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _0_273))
  | uu____118 -> l
  ...
  fun lid  ->
    fun a  ->
      let a =
        ...
        {
          FStar_Syntax_Syntax.ppname = _0_274;
      ...
      FStar_All.pipe_left escape _0_275
  ...
  fun env  ->
    fun lid  ->
      fun i  ->
        let fail uu____145 =
          failwith
            (let _0_276 = FStar_Util.string_of_int i in
             FStar_Util.format2
               "Projector %s on data constructor %s not found" _0_276
  ...
  fun lid  ->
    fun i  ->
      let _0_278 =
        ...
        FStar_Util.format2 "%s_%s" lid.FStar_Ident.str _0_277 in
      FStar_All.pipe_left escape _0_278
  ...
  fun lid  ->
    fun a  ->
      FStar_SMTEncoding_Util.mkFreeV
        (let _0_279 = mk_term_projector_name lid a in
         (_0_279,
...
let mk_term_projector_by_pos:
  ...
  fun lid  ->
    fun i  ->
      FStar_SMTEncoding_Util.mkFreeV
        (let _0_280 = mk_term_projector_name_by_pos lid i in
         (_0_280,
           (FStar_SMTEncoding_Term.Arrow
              (FStar_SMTEncoding_Term.Term_sort,
                FStar_SMTEncoding_Term.Term_sort))))
...
let varops: varops_t =
  ...
  let new_scope uu____387 =
    let _0_282 = FStar_Util.smap_create (Prims.parse_int "100") in
    let _0_281 = FStar_Util.smap_create (Prims.parse_int "100") in
    (_0_282, _0_281) in
  let scopes = FStar_Util.mk_ref (let _0_283 = new_scope () in [_0_283]) in
  let mk_unique y =
    let y = escape y in
    let y =
      let uu____417 =
        let _0_284 = FStar_ST.read scopes in
        FStar_Util.find_map _0_284
          (fun uu____430  ->
      ...
      | Some uu____442 ->
          (FStar_Util.incr ctr;
           (let _0_286 =
              let _0_285 = FStar_Util.string_of_int (FStar_ST.read ctr) in
              Prims.strcat "__" _0_285 in
            Prims.strcat y _0_286)) in
    let top_scope =
      let _0_287 = FStar_List.hd (FStar_ST.read scopes) in
      FStar_All.pipe_left Prims.fst _0_287 in
    FStar_Util.smap_add top_scope y true; y in
  let new_var pp rn =
    let _0_290 =
      let _0_289 =
        let _0_288 = FStar_Util.string_of_int rn in Prims.strcat "__" _0_288 in
      Prims.strcat pp.FStar_Ident.idText _0_289 in
    FStar_All.pipe_left mk_unique _0_290 in
  let new_fvar lid = mk_unique lid.FStar_Ident.str in
  let next_id uu____484 = FStar_Util.incr ctr; FStar_ST.read ctr in
  let fresh pfx =
    let _0_292 =
      let _0_291 = next_id () in
      FStar_All.pipe_left FStar_Util.string_of_int _0_291 in
    FStar_Util.format2 "%s_%s" pfx _0_292 in
  let string_const s =
    let uu____499 =
      let _0_293 = FStar_ST.read scopes in
      FStar_Util.find_map _0_293
        (fun uu____512  ->
    ...
    | None  ->
        let id = next_id () in
        let f =
          let _0_294 = FStar_SMTEncoding_Util.mk_String_const id in
          FStar_All.pipe_left FStar_SMTEncoding_Term.boxString _0_294 in
        let top_scope =
          let _0_295 = FStar_List.hd (FStar_ST.read scopes) in
          FStar_All.pipe_left Prims.snd _0_295 in
        (FStar_Util.smap_add top_scope s f; f) in
  let push uu____551 =
    let _0_298 =
      let _0_297 = new_scope () in
      let _0_296 = FStar_ST.read scopes in _0_297 :: _0_296 in
    FStar_ST.write scopes _0_298 in
  let pop uu____573 =
    let _0_299 = FStar_List.tl (FStar_ST.read scopes) in
    FStar_ST.write scopes _0_299 in
...
let unmangle: FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv =
  fun x  ->
    ...
    {
      FStar_Syntax_Syntax.ppname = _0_300;
...
let print_env: env_t -> Prims.string =
  fun e  ->
    ...
    FStar_All.pipe_right _0_301 (FStar_String.concat ", ")
...
let fresh_fvar:
  ...
  fun x  ->
    fun s  ->
      ...
      let _0_302 = FStar_SMTEncoding_Util.mkFreeV (xsym, s) in (xsym, _0_302)
let gen_term_var:
  env_t ->
  ...
  fun env  ->
    fun x  ->
      let ysym =
        let _0_303 = FStar_Util.string_of_int env.depth in
        Prims.strcat "@x" _0_303 in
      let y =
        FStar_SMTEncoding_Util.mkFreeV
    ...
    fun a  ->
      ...
      | None  ->
          ...
          (match uu____974 with
           | None  ->
               failwith
                 (let _0_304 = FStar_Syntax_Print.bv_to_string a in
                  FStar_Util.format1
      ...
      let _0_310 =
        ...
        let _0_309 =
          let _0_308 =
            Binding_fvar
              (let _0_307 =
                 let _0_306 = FStar_SMTEncoding_Util.mkApp (ftok, []) in
                 FStar_All.pipe_left (fun _0_305  -> Some _0_305) _0_306 in
               (x, fname, _0_307, None)) in
          _0_308 :: (env.bindings) in
        {
          bindings = _0_309;
        ...
        lookup_binding env
          (fun uu___113_1056  ->
             ...
             | Binding_fvar (b,t1,t2,t3) when b.FStar_Ident.str = s ->
                 Some ()
             | uu____1066 -> None) in
      FStar_All.pipe_right _0_311 FStar_Option.isSome
let lookup_lid:
  env_t ->
    FStar_Ident.lident ->
      (Prims.string* FStar_SMTEncoding_Term.term Prims.option*
  ...
  fun env  ->
    fun a  ->
      ...
      | None  ->
          failwith
            (let _0_312 = FStar_Syntax_Print.lid_to_string a in
             FStar_Util.format1 "Name not found: %s" _0_312)
      | Some s -> s
let push_free_var:
  env_t ->
    FStar_Ident.lident ->
        ...
        | (t1,t2,uu____1145) ->
            let t3 =
              FStar_SMTEncoding_Util.mkApp
                (let _0_314 =
                   let _0_313 = FStar_SMTEncoding_Util.mkApp ("ZFuel", []) in
                   [_0_313] in
                 (f, _0_314)) in
                     ...
                     | FStar_SMTEncoding_Term.App (uu____1195,fuel::[]) ->
                         let uu____1198 =
                           let _0_316 =
                             ...
                             FStar_All.pipe_right _0_315 Prims.fst in
                           FStar_Util.starts_with _0_316 "fuel" in
                         if uu____1198
                         then
                           let _0_319 =
                             let _0_318 =
                             ...
                             FStar_SMTEncoding_Term.mk_ApplyTF _0_318 fuel in
                           FStar_All.pipe_left (fun _0_317  -> Some _0_317)
                             _0_319
                         else Some t
                     | uu____1202 -> Some t)
                | uu____1203 -> None))
  ...
  | None  ->
      failwith
        (let _0_320 =
         ...
         FStar_Util.format1 "Name not found: %s" _0_320)
             ...
             let body =
               ...
               | FStar_SMTEncoding_Term.App
                   ...
                   let guard =
                     ...
                     | uu____1406 ->
                         let _0_321 = add_fuel [guard] in
                         FStar_All.pipe_right _0_321 FStar_List.hd in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv|FStar_Syntax_Syntax.Tm_app
        ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
          ...
          FStar_All.pipe_right _0_322 FStar_Option.isNone
      | uu____1461 -> false
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let _0_323 =
            FStar_TypeChecker_Env.lookup_definition
              [FStar_TypeChecker_Env.Eager_unfolding_only] env.tcenv
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
          FStar_All.pipe_right _0_323 FStar_Option.isSome
      | uu____1538 -> false
...
let trivial_post: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun t  ->
    let _0_326 = let _0_324 = FStar_Syntax_Syntax.null_binder t in [_0_324] in
    let _0_325 =
      FStar_Syntax_Syntax.fvar FStar_Syntax_Const.true_lid
        FStar_Syntax_Syntax.Delta_constant None in
    FStar_Syntax_Util.abs _0_326 _0_325 None
let mk_Apply:
  FStar_SMTEncoding_Term.term ->
    (Prims.string* FStar_SMTEncoding_Term.sort) Prims.list ->
      FStar_SMTEncoding_Term.term
           ...
           (fun out  ->
              fun var  ->
                ...
                | FStar_SMTEncoding_Term.Fuel_sort  ->
                    ...
                    FStar_SMTEncoding_Term.mk_ApplyTF out _0_327
                | s ->
                    let _0_328 = FStar_SMTEncoding_Util.mkFreeV var in
                    FStar_SMTEncoding_Util.mk_ApplyTT out _0_328) e)
let mk_Apply_args:
  FStar_SMTEncoding_Term.term ->
...
let encode_const: FStar_Const.sconst -> FStar_SMTEncoding_Term.term =
  fun uu___117_1751  ->
    ...
    | c ->
        failwith
          (let _0_331 = FStar_Syntax_Print.const_to_string c in
           FStar_Util.format1 "Unhandled constant: %s" _0_331)
let as_function_typ:
  env_t ->
    ...
    fun t0  ->
      let rec aux norm t =
        ...
        | FStar_Syntax_Syntax.Tm_refine uu____1802 ->
            let _0_332 = FStar_Syntax_Util.unrefine t in aux true _0_332
        | uu____1807 ->
            if norm
            then let _0_333 = whnf env t in aux false _0_333
            else
              failwith
                (let _0_335 =
                   FStar_Range.string_of_range t0.FStar_Syntax_Syntax.pos in
                 let _0_334 = FStar_Syntax_Print.term_to_string t0 in
...
let curried_arrow_formals_comp:
  ...
  fun k  ->
    ...
    | uu____1829 ->
        let _0_336 = FStar_Syntax_Syntax.mk_Total k in ([], _0_336)
    ...
    fun bs  ->
      fun env  ->
        (let uu____1972 =
         ...
         if uu____1972
         then
           let _0_337 = FStar_Syntax_Print.binders_to_string ", " bs in
                         ...
                         let uu____2053 =
                           ...
                           | (xxsym,xx,env') ->
                               let uu____2076 =
                                 ...
                                 encode_term_pred fuel_opt _0_338 env xx in
      ...
      fun env  ->
        fun e  ->
          ...
          | (t,decls) ->
              (match fuel_opt with
               | None  ->
                   let _0_340 = FStar_SMTEncoding_Term.mk_HasTypeZ e t in
                   (_0_340, decls)
               | Some f ->
                   let _0_341 = FStar_SMTEncoding_Term.mk_HasTypeFuel f e t in
                   (_0_341, decls))
and encode_term:
  FStar_Syntax_Syntax.typ ->
  ...
  fun t  ->
    fun env  ->
      ...
      (let uu____2196 =
       ...
       if uu____2196
       then
         let _0_344 = FStar_Syntax_Print.tag_of_term t in
         let _0_343 = FStar_Syntax_Print.tag_of_term t0 in
         let _0_342 = FStar_Syntax_Print.term_to_string t0 in
         FStar_Util.print3 "(%s) (%s)   %s\n" _0_344 _0_343 _0_342
       else ());
       ...
       | FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
           failwith
             (let _0_348 =
              ...
              let _0_345 = FStar_Syntax_Print.term_to_string t in
              FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" _0_348
                _0_347 _0_346 _0_345)
       | FStar_Syntax_Syntax.Tm_bvar x ->
           failwith
             (let _0_349 = FStar_Syntax_Print.bv_to_string x in
                ...
                then
                  ...
                  (match uu____2274 with
                   | (vars,guards,env',decls,uu____2289) ->
                       let fsym =
                         let _0_352 = varops.fresh "f" in
                         (_0_352, FStar_SMTEncoding_Term.Term_sort) in
                     ...
                     FStar_SMTEncoding_Term.Assume
                       (let _0_368 =
                          FStar_SMTEncoding_Term.mk_HasType t
                            FStar_SMTEncoding_Term.mk_Term_type in
                        (_0_368, (Some "Typing for non-total arrows"),
                          a_name)) in
                               ...
                               FStar_SMTEncoding_Util.mkImp
                                 (let _0_370 =
                                    ...
                                    FStar_SMTEncoding_Term.mk_tester
                                      "Tm_arrow" _0_369 in
                                  (f_has_t, _0_370)) in
                             ([[f_has_t]], [fsym], _0_371)) in
                        (_0_372, a_name, a_name)) in
           ...
           let uu____2521 =
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 (match uu____2538 with
                  | (b,f) ->
                      let _0_373 = Prims.fst (FStar_List.hd b) in (_0_373, f))
                                    ...
                                    let encoding =
                                      FStar_SMTEncoding_Util.mkAnd
                                        (let _0_374 =
                                         ...
                                         (_0_374, refinement)) in
                                    let cvars =
                                      let _0_375 =
                                        FStar_SMTEncoding_Term.free_variables
                                          encoding in
                                      FStar_All.pipe_right _0_375
                                        (FStar_List.filter
                                           (fun uu____2601  ->
                  ...
                  FStar_SMTEncoding_Term.Assume
                    (let _0_388 =
                       Some
                         (varops.mk_unique
                            (let _0_387 =
                               let _0_386 = FStar_Unionfind.uvar_id uv in
                               FStar_All.pipe_left FStar_Util.string_of_int
                                 _0_386 in
                             FStar_Util.format1 "uvar_typing_%s" _0_387)) in
                     (t_has_k, (Some "Uvar typing"), _0_388)) in
            ...
            | (head,args_e) ->
                ...
                (match uu____2794 with
                 | (uu____2809,uu____2810) when head_redex env head ->
                     let _0_390 = whnf env t in encode_term _0_390 env
                      ...
                      | (v1,decls1) ->
                          ...
                          (match uu____2901 with
                           | (v2,decls2) ->
                               ...
                               (_0_391, (FStar_List.append decls1 decls2))))
                     ...
                     let e0 =
                       (FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                             (let _0_393 =
                                let _0_392 = FStar_List.hd args_e in [_0_392] in
                              (head, _0_393)))) None
                         head.FStar_Syntax_Syntax.pos in
                     let e =
                       (FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                             (let _0_394 = FStar_List.tl args_e in
                              (e0, _0_394)))) None t0.FStar_Syntax_Syntax.pos in
                     encode_term e env
                 | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify
                    ),(arg,uu____2991)::[]) ->
                                ...
                                Some
                                  (let _0_400 =
                                     FStar_TypeChecker_Env.lookup_lid
                                       env.tcenv
                                       (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                                   FStar_All.pipe_right _0_400 Prims.snd)
                          ...
                          (match head_type with
                           ...
                           | Some head_type ->
                               let head_type =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine _0_401 in
                               let uu____3333 =
                  ...
                  | FStar_Util.Inr (eff,uu____3443) ->
                      let _0_403 =
                        FStar_TypeChecker_Util.is_pure_or_ghost_effect
                          env.tcenv eff in
                      FStar_All.pipe_right _0_403 Prims.op_Negation in
                let codomain_eff lc =
                  match lc with
                  | FStar_Util.Inl lc ->
                      let _0_406 =
                        let _0_404 = lc.FStar_Syntax_Syntax.comp () in
                        FStar_Syntax_Subst.subst_comp opening _0_404 in
                  ...
                  | FStar_Util.Inr (eff,flags) ->
                      let new_uvar uu____3480 =
                        ...
                        FStar_All.pipe_right _0_407 Prims.fst in
                      if
                        ...
                        then
                          (let _0_411 =
                           ...
                           FStar_All.pipe_right _0_411
                             (fun _0_410  -> Some _0_410))
                        else None in
                (match lopt with
                 | None  ->
                     ((let _0_413 =
                         let _0_412 = FStar_Syntax_Print.term_to_string t0 in
                         FStar_Util.format1
                           "Losing precision when encoding a function literal: %s"
                           _0_412 in
                       FStar_Errors.warn t0.FStar_Syntax_Syntax.pos _0_413);
                      fallback ())
                 | Some lc ->
                                           ...
                                           let fsym =
                                             varops.mk_unique
                                               (let _0_418 =
                                                  FStar_Util.digest_of_string
                                                    tkey_hash in
                                                Prims.strcat "Tm_abs_" _0_418) in
                                           let fdecl =
                                             FStar_SMTEncoding_Term.DeclFun
                                               (fsym, cvar_sorts,
                                                 FStar_SMTEncoding_Term.Term_sort,
...
and encode_pat:
  ...
  fun env  ->
    fun pat  ->
      ...
      | uu____3962 -> let _0_430 = encode_one_pat env pat in [_0_430]
  ...
  fun env  ->
    fun pat  ->
      (let uu____3972 =
       ...
       if uu____3972
       then
         let _0_431 = FStar_Syntax_Print.pat_to_string pat in
            ...
            | (env,vars) ->
                let rec mk_guard pat scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_constant c ->
                      FStar_SMTEncoding_Util.mkEq
                        (let _0_432 = encode_const c in (scrutinee, _0_432))
                                ...
                                fun uu____4220  ->
                                  ...
                                  | (arg,uu____4229) ->
                                      ...
                                      let _0_434 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee]) in
                                      mk_projections arg _0_434)) in
                      FStar_All.pipe_right _0_435 FStar_List.flatten in
    ...
    fun new_pats  ->
      fun t  ->
        fun env  ->
          ...
          let one_pat p =
            let uu____4357 =
              let _0_436 = FStar_Syntax_Util.unmeta p in
              FStar_All.pipe_right _0_436 FStar_Syntax_Util.head_and_args in
          ...
          let lemma_pats p =
            ...
            let smt_pat_or t =
              let uu____4504 =
                let _0_438 = FStar_Syntax_Util.unmeta t in
                FStar_All.pipe_right _0_438 FStar_Syntax_Util.head_and_args in
            ...
            | t::[] ->
                ...
                (match uu____4598 with
                 | Some e ->
                     let _0_441 = list_elements e in
                     FStar_All.pipe_right _0_441
                       (FStar_List.map
                          (fun branch  ->
                             let _0_440 = list_elements branch in
                             FStar_All.pipe_right _0_440
                     ...
                     (match c.FStar_Syntax_Syntax.n with
                      | FStar_Syntax_Syntax.Comp
                          ...
                          let pats' =
                            ...
                            | None  -> pats in
                          let _0_444 = lemma_pats pats' in
                          (binders, pre, post, _0_444)
               ...
               | (vars,guards,env,decls,uu____4903) ->
                         ...
                         (FStar_List.map
                            (fun branch  ->
                               let uu____4953 =
                                 ...
                                 FStar_All.pipe_right _0_445 FStar_List.unzip in
                               match uu____4953 with
                               | (pats,decls) -> (pats, decls))) in
                     FStar_All.pipe_right _0_446 FStar_List.unzip in
                   (match uu____4910 with
                    | (pats,decls') ->
                        ...
                        let uu____5075 =
                          let _0_453 = FStar_Syntax_Util.unmeta pre in
                          encode_formula _0_453 env in
                        (match uu____5075 with
                         | (pre,decls'') ->
                             let uu____5082 =
                               let _0_454 = FStar_Syntax_Util.unmeta post in
                               encode_formula _0_454 env in
  ...
  fun phi  ->
    fun env  ->
      let debug phi =
        ...
        if uu____5103
        then
          let _0_459 = FStar_Syntax_Print.tag_of_term phi in
          let _0_458 = FStar_Syntax_Print.term_to_string phi in
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            ...
            (_0_460, decls) in
      let const_op f r uu____5179 = let _0_461 = f r in (_0_461, []) in
      let un_op f l =
        let _0_462 = FStar_List.hd l in FStar_All.pipe_left f _0_462 in
                  ...
                  | uu____5419 ->
                      ...
                      (match uu____5420 with
                       | (l2,decls2) ->
                           ...
                           (_0_464, (FStar_List.append decls1 decls2)))))
      ...
      let connectives =
        let _0_477 =
          let _0_465 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd) in
          (FStar_Syntax_Const.and_lid, _0_465) in
        let _0_476 =
          let _0_475 =
            let _0_466 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr) in
            (FStar_Syntax_Const.or_lid, _0_466) in
          let _0_474 =
            let _0_473 =
              let _0_472 =
                let _0_467 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff) in
                (FStar_Syntax_Const.iff_lid, _0_467) in
              let _0_471 =
                let _0_470 =
                  let _0_469 =
                    let _0_468 =
                      enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot) in
                    (FStar_Syntax_Const.not_lid, _0_468) in
                  [_0_469;
                ...
                (FStar_Syntax_Const.ite_lid, mk_ite) :: _0_470 in
              _0_472 :: _0_471 in
            (FStar_Syntax_Const.imp_lid, mk_imp) :: _0_473 in
          _0_475 :: _0_474 in
        _0_477 :: _0_476 in
      let rec fallback phi =
        ...
        | FStar_Syntax_Syntax.Tm_meta uu____5712 ->
            let _0_479 = FStar_Syntax_Util.unmeta phi in
            encode_formula _0_479 env
        | FStar_Syntax_Syntax.Tm_match (e,pats) ->
            let uu____5745 =
        ...
        | FStar_Syntax_Syntax.Tm_app (head,args) ->
            ...
            (match ((head.FStar_Syntax_Syntax.n), args) with
                 ...
                 (match uu____5841 with
                  | (x,decls) ->
                      ...
                      (match uu____5848 with
                       | (t,decls') ->
                           let _0_480 = FStar_SMTEncoding_Term.mk_HasType x t in
                           (_0_480, (FStar_List.append decls decls'))))
             | (FStar_Syntax_Syntax.Tm_fvar
             ...
             | uu____5922 when head_redex env head ->
                 let _0_483 = whnf env phi in encode_formula _0_483 env
             | uu____5930 ->
                  ...
                  (FStar_List.map
                     (fun p  ->
                        let uu____6047 =
                          ...
                          FStar_All.pipe_right _0_486 FStar_List.unzip in
                        match uu____6047 with
                        | (p,decls) -> (p, (FStar_List.flatten decls)))) in
              FStar_All.pipe_right _0_487 FStar_List.unzip in
             ...
             | (pats,decls') ->
                 ...
                 (match uu____6110 with
                  | (body,decls'') ->
                      ...
                      let _0_488 = FStar_SMTEncoding_Util.mk_and_l guards in
                      (vars, pats, _0_488, body,
                        (FStar_List.append decls
      ...
      (let phi = FStar_Syntax_Util.unascribe phi in
       let check_pattern_vars vars pats =
         ...
         | hd::tl ->
             let pat_vars =
               let _0_490 = FStar_Syntax_Free.names hd in
               FStar_List.fold_left
                 (fun out  ->
                    fun x  ->
                      let _0_489 = FStar_Syntax_Free.names x in
                      FStar_Util.set_union out _0_489) _0_490 tl in
             let uu____6188 =
               FStar_All.pipe_right vars
                 (FStar_Util.find_opt
                    (fun uu____6200  ->
             ...
             (match uu____6188 with
              ...
              | Some (x,uu____6208) ->
                  ...
                  let _0_492 =
                    let _0_491 = FStar_Syntax_Print.bv_to_string x in
                    FStar_Util.format1
                      "SMT pattern misses at least one bound variable: %s"
                      _0_491 in
                  FStar_Errors.warn pos _0_492) in
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu____6322 = encode_q_body env vars pats body in
             ...
             | (vars,pats,guard,body,decls) ->
                 let tm =
                   let _0_494 =
                     let _0_493 = FStar_SMTEncoding_Util.mkImp (guard, body) in
                     (pats, vars, _0_493) in
                   FStar_SMTEncoding_Term.mkForall _0_494
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu____6359 = encode_q_body env vars pats body in
             ...
             | (vars,pats,guard,body,decls) ->
                 let _0_497 =
                   let _0_496 =
                     let _0_495 = FStar_SMTEncoding_Util.mkAnd (guard, body) in
                     (pats, vars, _0_495) in
                   FStar_SMTEncoding_Term.mkExists _0_496
                     phi.FStar_Syntax_Syntax.pos in
                 (_0_497, decls))))
type prims_t =
  {
            ...
            | (ysym,y) ->
                  ...
                  let xname_decl =
                    FStar_SMTEncoding_Term.DeclFun
                      (let _0_498 =
                       ...
                       (x, _0_498, FStar_SMTEncoding_Term.Term_sort, None)) in
                              ...
                              (let _0_503 =
                                 FStar_SMTEncoding_Util.mkForall
                                   (let _0_502 =
                                      FStar_SMTEncoding_Util.mkEq
                                        (xtok_app, xapp) in
                                    ([[xtok_app]], vars, _0_502)) in
                               (_0_503, (Some "Name-token correspondence"),
                                 (Some
                                    (Prims.strcat "token_correspondence_" x)))) in
                          [_0_504] in
                        _0_506 :: _0_505 in
                      xtok_decl :: _0_507 in
                    xname_decl :: _0_508 in
                  (xtok, _0_509) in
                let axy =
                ...
                let prims =
                  let _0_605 =
                    let _0_512 =
                      let _0_511 =
                        let _0_510 = FStar_SMTEncoding_Util.mkEq (x, y) in
                        FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool
                          _0_510 in
                      quant axy _0_511 in
                    (FStar_Syntax_Const.op_Eq, _0_512) in
                  let _0_604 =
                    let _0_603 =
                      let _0_515 =
                        let _0_514 =
                          ...
                          FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool
                            _0_513 in
                        quant axy _0_514 in
                      (FStar_Syntax_Const.op_notEq, _0_515) in
                    let _0_602 =
                      let _0_601 =
                        let _0_520 =
                          let _0_519 =
                            let _0_518 =
                              FStar_SMTEncoding_Util.mkLT
                                (let _0_517 =
                                 ...
                                 (_0_517, _0_516)) in
                            FStar_All.pipe_left
                              FStar_SMTEncoding_Term.boxBool _0_518 in
                          quant xy _0_519 in
                        (FStar_Syntax_Const.op_LT, _0_520) in
                      let _0_600 =
                        let _0_599 =
                          let _0_525 =
                            let _0_524 =
                              let _0_523 =
                                FStar_SMTEncoding_Util.mkLTE
                                  (let _0_522 =
                                   ...
                                   (_0_522, _0_521)) in
                              FStar_All.pipe_left
                                FStar_SMTEncoding_Term.boxBool _0_523 in
                            quant xy _0_524 in
                          (FStar_Syntax_Const.op_LTE, _0_525) in
                        let _0_598 =
                          let _0_597 =
                            let _0_530 =
                              let _0_529 =
                                let _0_528 =
                                  FStar_SMTEncoding_Util.mkGT
                                    (let _0_527 =
                                     ...
                                     (_0_527, _0_526)) in
                                FStar_All.pipe_left
                                  FStar_SMTEncoding_Term.boxBool _0_528 in
                              quant xy _0_529 in
                            (FStar_Syntax_Const.op_GT, _0_530) in
                          let _0_596 =
                            let _0_595 =
                              let _0_535 =
                                let _0_534 =
                                  let _0_533 =
                                    FStar_SMTEncoding_Util.mkGTE
                                      (let _0_532 =
                                       ...
                                       (_0_532, _0_531)) in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Term.boxBool _0_533 in
                                quant xy _0_534 in
                              (FStar_Syntax_Const.op_GTE, _0_535) in
                            let _0_594 =
                              let _0_593 =
                                let _0_540 =
                                  let _0_539 =
                                    let _0_538 =
                                      FStar_SMTEncoding_Util.mkSub
                                        (let _0_537 =
                                         ...
                                         (_0_537, _0_536)) in
                                    FStar_All.pipe_left
                                      FStar_SMTEncoding_Term.boxInt _0_538 in
                                  quant xy _0_539 in
                                (FStar_Syntax_Const.op_Subtraction, _0_540) in
                              let _0_592 =
                                let _0_591 =
                                  let _0_543 =
                                    let _0_542 =
                                      let _0_541 =
                                        FStar_SMTEncoding_Util.mkMinus
                                          (FStar_SMTEncoding_Term.unboxInt x) in
                                      FStar_All.pipe_left
                                        FStar_SMTEncoding_Term.boxInt _0_541 in
                                    quant qx _0_542 in
                                  (FStar_Syntax_Const.op_Minus, _0_543) in
                                let _0_590 =
                                  let _0_589 =
                                    let _0_548 =
                                      let _0_547 =
                                        ...
                                        FStar_All.pipe_left
                                          ...
                                          _0_546 in
                                      quant xy _0_547 in
                                    (FStar_Syntax_Const.op_Addition, _0_548) in
                                  let _0_588 =
                                    let _0_587 =
                                      let _0_553 =
                                        let _0_552 =
                ...
                let mk l v =
                  ...
                  FStar_All.pipe_right _0_607 FStar_Option.get in
                let is l =
                  FStar_All.pipe_right prims
                    (FStar_Util.for_some
                       (fun uu____6863  ->
               ...
               FStar_SMTEncoding_Term.Assume
                 (let _0_613 =
                  ...
                  let _0_612 =
                    Some
                      (varops.mk_unique
                         (let _0_611 = FStar_Util.digest_of_string tapp_hash in
                          Prims.strcat "pretyping_" _0_611)) in
                  (_0_613, (Some "pretyping"), _0_612)))
let primitive_type_axioms:
    ...
    let _0_620 =
      FStar_SMTEncoding_Term.Assume
        (let _0_614 =
         ...
         (_0_614, (Some "unit typing"), (Some "unit_typing"))) in
    let _0_619 =
      let _0_618 =
        FStar_SMTEncoding_Term.Assume
          (let _0_617 =
               ...
               (let _0_616 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_615 =
                     ...
                     (typing_pred, _0_615)) in
                ([[typing_pred]], [xx], _0_616)) in
           (_0_617, (Some "unit inversion"), (Some "unit_inversion"))) in
      [_0_618] in
    _0_620 :: _0_619 in
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_626 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_625 =
                let _0_622 =
                  let _0_621 = FStar_SMTEncoding_Term.boxBool b in [_0_621] in
                [_0_622] in
              let _0_624 =
                let _0_623 = FStar_SMTEncoding_Term.boxBool b in
                FStar_SMTEncoding_Term.mk_HasType _0_623 tt in
              (_0_625, [bb], _0_624)) in
         (_0_626, (Some "bool typing"), (Some "bool_typing"))) in
    let _0_631 =
      let _0_630 =
        FStar_SMTEncoding_Term.Assume
          (let _0_629 =
               ...
               (let _0_628 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_627 =
                     ...
                     (typing_pred, _0_627)) in
                ([[typing_pred]], [xx], _0_628)) in
           (_0_629, (Some "bool inversion"), (Some "bool_inversion"))) in
      [_0_630] in
    _0_632 :: _0_631 in
      ...
      let _0_639 =
        FStar_SMTEncoding_Util.mkApp
          (let _0_638 =
             let _0_637 =
               let _0_636 =
                 let _0_635 = FStar_SMTEncoding_Term.boxInt a in
                 let _0_634 =
                   let _0_633 = FStar_SMTEncoding_Term.boxInt b in [_0_633] in
                 _0_635 :: _0_634 in
               tt :: _0_636 in
             tt :: _0_637 in
           ("Prims.Precedes", _0_638)) in
      FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _0_639 in
    let precedes_y_x =
      let _0_640 = FStar_SMTEncoding_Util.mkApp ("Precedes", [y; x]) in
      FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _0_640 in
    let _0_670 =
      FStar_SMTEncoding_Term.Assume
        (let _0_646 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_645 =
                let _0_642 =
                  let _0_641 = FStar_SMTEncoding_Term.boxInt b in [_0_641] in
                [_0_642] in
              let _0_644 =
                let _0_643 = FStar_SMTEncoding_Term.boxInt b in
                FStar_SMTEncoding_Term.mk_HasType _0_643 tt in
              (_0_645, [bb], _0_644)) in
         (_0_646, (Some "int typing"), (Some "int_typing"))) in
    let _0_669 =
      let _0_668 =
        FStar_SMTEncoding_Term.Assume
          (let _0_649 =
             mkForall_fuel
               (let _0_648 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_647 = FStar_SMTEncoding_Term.mk_tester "BoxInt" x in
                     (typing_pred, _0_647)) in
                ([[typing_pred]], [xx], _0_648)) in
           (_0_649, (Some "int inversion"), (Some "int_inversion"))) in
      let _0_667 =
        let _0_666 =
          FStar_SMTEncoding_Term.Assume
            (let _0_665 =
                           ...
                           (let _0_662 =
                              let _0_661 =
                                ...
                                let _0_659 =
                                  ...
                                  _0_658 :: _0_657 in
                                _0_660 :: _0_659 in
                              typing_pred_y :: _0_661 in
                            typing_pred :: _0_662) in
                       (_0_663, precedes_y_x)) in
                  ([[typing_pred; typing_pred_y; precedes_y_x]], [xx; yy],
                    _0_664)) in
             (_0_665, (Some "well-founded ordering on nat (alt)"),
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_676 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_675 =
                let _0_672 =
                  let _0_671 = FStar_SMTEncoding_Term.boxString b in [_0_671] in
                [_0_672] in
              let _0_674 =
                let _0_673 = FStar_SMTEncoding_Term.boxString b in
                FStar_SMTEncoding_Term.mk_HasType _0_673 tt in
              (_0_675, [bb], _0_674)) in
         (_0_676, (Some "string typing"), (Some "string_typing"))) in
    let _0_681 =
      let _0_680 =
        FStar_SMTEncoding_Term.Assume
          (let _0_679 =
               ...
               (let _0_678 =
                  FStar_SMTEncoding_Util.mkImp
                    (let _0_677 =
                     ...
                     (typing_pred, _0_677)) in
                ([[typing_pred]], [xx], _0_678)) in
           (_0_679, (Some "string inversion"), (Some "string_inversion"))) in
      [_0_680] in
    _0_682 :: _0_681 in
  let mk_ref env reft_name uu____7120 =
    ...
    let refa =
      FStar_SMTEncoding_Util.mkApp
        (let _0_684 =
           let _0_683 = FStar_SMTEncoding_Util.mkFreeV aa in [_0_683] in
         (reft_name, _0_684)) in
    let refb =
      FStar_SMTEncoding_Util.mkApp
        (let _0_686 =
           let _0_685 = FStar_SMTEncoding_Util.mkFreeV bb in [_0_685] in
         (reft_name, _0_686)) in
      ...
      FStar_SMTEncoding_Term.Assume
        (let _0_689 =
           mkForall_fuel
             (let _0_688 =
                FStar_SMTEncoding_Util.mkImp
                  (let _0_687 = FStar_SMTEncoding_Term.mk_tester "BoxRef" x in
                   (typing_pred, _0_687)) in
              ([[typing_pred]], [xx; aa], _0_688)) in
         (_0_689, (Some "ref inversion"), (Some "ref_inversion"))) in
    let _0_698 =
      let _0_697 =
        FStar_SMTEncoding_Term.Assume
          (let _0_696 =
               ...
               let _0_694 =
                 FStar_SMTEncoding_Util.mkImp
                   (let _0_693 =
                    ...
                    let _0_692 =
                      FStar_SMTEncoding_Util.mkEq
                        (let _0_691 = FStar_SMTEncoding_Util.mkFreeV aa in
                         let _0_690 = FStar_SMTEncoding_Util.mkFreeV bb in
                         (_0_691, _0_690)) in
                    (_0_693, _0_692)) in
               ([[typing_pred; typing_pred_b]], [xx; aa; bb], _0_694) in
             mkForall_fuel' (Prims.parse_int "2") _0_695 in
           (_0_696, (Some "ref typing is injective"),
    ...
    let _0_701 =
      FStar_SMTEncoding_Term.Assume
        (let _0_700 =
         ...
         (_0_700, (Some "False interpretation"), (Some "false_interp"))) in
    [_0_701] in
  let mk_and_interp env conj uu____7205 =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_703 =
           let _0_702 = FStar_SMTEncoding_Util.mkApp (conj, [a; b]) in
           [_0_702] in
         ("Valid", _0_703)) in
             ...
             (let _0_705 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_704 =
                   ...
                   (_0_704, valid)) in
              ([[valid]], [aa; bb], _0_705)) in
         (_0_706, (Some "/\\ interpretation"), (Some "l_and-interp"))) in
    [_0_707] in
  let mk_or_interp env disj uu____7245 =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_709 =
           let _0_708 = FStar_SMTEncoding_Util.mkApp (disj, [a; b]) in
           [_0_708] in
         ("Valid", _0_709)) in
    let valid_a = FStar_SMTEncoding_Util.mkApp ("Valid", [a]) in
    let valid_b = FStar_SMTEncoding_Util.mkApp ("Valid", [b]) in
             ...
             (let _0_711 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_710 =
                   ...
                   (_0_710, valid)) in
              ([[valid]], [aa; bb], _0_711)) in
         (_0_712, (Some "\\/ interpretation"), (Some "l_or-interp"))) in
    [_0_713] in
  let mk_eq2_interp env eq2 tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_715 =
           let _0_714 = FStar_SMTEncoding_Util.mkApp (eq2, [a; x; y]) in
           [_0_714] in
         ("Valid", _0_715)) in
    let _0_719 =
      FStar_SMTEncoding_Term.Assume
        (let _0_718 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_717 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_716 = FStar_SMTEncoding_Util.mkEq (x, y) in
                   (_0_716, valid)) in
              ([[valid]], [aa; xx; yy], _0_717)) in
         (_0_718, (Some "Eq2 interpretation"), (Some "eq2-interp"))) in
    [_0_719] in
  let mk_eq3_interp env eq3 tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_721 =
           let _0_720 = FStar_SMTEncoding_Util.mkApp (eq3, [a; b; x; y]) in
           [_0_720] in
         ("Valid", _0_721)) in
    let _0_725 =
      FStar_SMTEncoding_Term.Assume
        (let _0_724 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_723 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_722 = FStar_SMTEncoding_Util.mkEq (x, y) in
                   (_0_722, valid)) in
              ([[valid]], [aa; bb; xx; yy], _0_723)) in
         (_0_724, (Some "Eq3 interpretation"), (Some "eq3-interp"))) in
    [_0_725] in
  let mk_imp_interp env imp tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_727 =
           let _0_726 = FStar_SMTEncoding_Util.mkApp (imp, [a; b]) in
           [_0_726] in
         ("Valid", _0_727)) in
    let valid_a = FStar_SMTEncoding_Util.mkApp ("Valid", [a]) in
    let valid_b = FStar_SMTEncoding_Util.mkApp ("Valid", [b]) in
    let _0_731 =
      FStar_SMTEncoding_Term.Assume
        (let _0_730 =
         ...
         (_0_730, (Some "==> interpretation"), (Some "l_imp-interp"))) in
    [_0_731] in
  let mk_iff_interp env iff tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_733 =
           let _0_732 = FStar_SMTEncoding_Util.mkApp (iff, [a; b]) in
           [_0_732] in
         ("Valid", _0_733)) in
    let valid_a = FStar_SMTEncoding_Util.mkApp ("Valid", [a]) in
    let valid_b = FStar_SMTEncoding_Util.mkApp ("Valid", [b]) in
             ...
             (let _0_735 =
                FStar_SMTEncoding_Util.mkIff
                  (let _0_734 =
                   ...
                   (_0_734, valid)) in
              ([[valid]], [aa; bb], _0_735)) in
         (_0_736, (Some "<==> interpretation"), (Some "l_iff-interp"))) in
    [_0_737] in
  let mk_not_interp env l_not tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_739 =
           let _0_738 = FStar_SMTEncoding_Util.mkApp (l_not, [a]) in [_0_738] in
         ("Valid", _0_739)) in
    let not_valid_a =
      let _0_740 = FStar_SMTEncoding_Util.mkApp ("Valid", [a]) in
      FStar_All.pipe_left FStar_SMTEncoding_Util.mkNot _0_740 in
    let _0_743 =
      FStar_SMTEncoding_Term.Assume
        (let _0_742 =
           FStar_SMTEncoding_Util.mkForall
             (let _0_741 = FStar_SMTEncoding_Util.mkIff (not_valid_a, valid) in
              ([[valid]], [aa], _0_741)) in
         (_0_742, (Some "not interpretation"), (Some "l_not-interp"))) in
    [_0_743] in
  let mk_forall_interp env for_all tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_745 =
           let _0_744 = FStar_SMTEncoding_Util.mkApp (for_all, [a; b]) in
           [_0_744] in
         ("Valid", _0_745)) in
    let valid_b_x =
      FStar_SMTEncoding_Util.mkApp
        (let _0_747 =
           let _0_746 = FStar_SMTEncoding_Util.mk_ApplyTT b x in [_0_746] in
         ("Valid", _0_747)) in
    let _0_756 =
      FStar_SMTEncoding_Term.Assume
        (let _0_755 =
                  ...
                  (let _0_753 =
                     FStar_SMTEncoding_Util.mkForall
                       (let _0_752 =
                        ...
                        (_0_752, [xx], _0_751)) in
                   (_0_753, valid)) in
              ([[valid]], [aa; bb], _0_754)) in
         (_0_755, (Some "forall interpretation"), (Some "forall-interp"))) in
    [_0_756] in
  let mk_exists_interp env for_some tt =
    ...
    let valid =
      FStar_SMTEncoding_Util.mkApp
        (let _0_758 =
           let _0_757 = FStar_SMTEncoding_Util.mkApp (for_some, [a; b]) in
           [_0_757] in
         ("Valid", _0_758)) in
    let valid_b_x =
      FStar_SMTEncoding_Util.mkApp
        (let _0_760 =
           let _0_759 = FStar_SMTEncoding_Util.mk_ApplyTT b x in [_0_759] in
         ("Valid", _0_760)) in
    let _0_769 =
      FStar_SMTEncoding_Term.Assume
        (let _0_768 =
                  ...
                  (let _0_766 =
                     FStar_SMTEncoding_Util.mkExists
                       (let _0_765 =
                        ...
                        (_0_765, [xx], _0_764)) in
                   (_0_766, valid)) in
              ([[valid]], [aa; bb], _0_767)) in
         (_0_768, (Some "exists interpretation"), (Some "exists-interp"))) in
    [_0_769] in
    ...
    let _0_772 =
      FStar_SMTEncoding_Term.Assume
        (let _0_771 =
         ...
         let _0_770 = Some (varops.mk_unique "typing_range_const") in
         (_0_771, (Some "Range_const typing"), _0_770)) in
    [_0_772] in
  let prims =
          ...
          fun quals  ->
            ...
            let uu____7978 =
              (let _0_773 =
               ...
               FStar_All.pipe_left Prims.op_Negation _0_773) ||
      ...
      fun t  ->
        fun quals  ->
          ...
          | (decls,env) ->
              ...
              then
                let _0_808 =
                  let _0_807 = encode_smt_lemma env lid tt in
                  FStar_List.append decls _0_807 in
                (_0_808, env)
              else (decls, env)
                ...
                fun lb  ->
                  ...
                  | (decls,env) ->
                      let uu____8534 =
                        ...
                        encode_top_level_val env _0_809
                           ...
                           | ((formal,uu____8661),(binder,uu____8663)) ->
                               FStar_Syntax_Syntax.NT
                                 (let _0_810 =
                                  ...
                                  (formal, _0_810))) formals binders in
                  let extra_formals =
                    let _0_813 =
                              ...
                              | (x,i) ->
                                  let _0_812 =
                                        ...
                                        x.FStar_Syntax_Syntax.sort in
                                    {
                                      ...
                                      FStar_Syntax_Syntax.sort = _0_811
                                    } in
                                  (_0_812, i))) in
                    FStar_All.pipe_right _0_813
                      FStar_Syntax_Util.name_binders in
                  let body =
                    let _0_819 =
                      let _0_818 =
                        (FStar_Syntax_Subst.subst subst t).FStar_Syntax_Syntax.n in
                      FStar_All.pipe_left (fun _0_817  -> Some _0_817) _0_818 in
                    (let _0_816 = FStar_Syntax_Subst.compress body in
                     let _0_815 =
                       let _0_814 =
                         FStar_Syntax_Util.args_of_binders extra_formals in
                       FStar_All.pipe_left Prims.snd _0_814 in
                     FStar_Syntax_Syntax.extend_app_n _0_816 _0_815) _0_819
                              ...
                              failwith
                                (let _0_823 =
                                 ...
                                 FStar_Util.format3
                                   ...
                                   flid.FStar_Ident.str _0_823 _0_822))
                     | uu____9110 ->
                         let uu____9111 =
                           (FStar_Syntax_Subst.compress t_norm).FStar_Syntax_Syntax.n in
                                  ...
                                  ((let uu____9341 =
                                   ...
                                   (let t_norm =
                                    ...
                                    let uu____9344 =
                                      ...
                                      declare_top_level_let env _0_824
                  ...
                  | (toks,typs,decls,env) ->
                      ...
                      then (decls, env)
                        ...
                        then
                          ...
                          (let fuel =
                             let _0_842 = varops.fresh "fuel" in
                             (_0_842, FStar_SMTEncoding_Term.Fuel_sort) in
                     ...
                     FStar_All.pipe_right bindings
                       (FStar_List.map
                          (fun lb  ->
                             FStar_Syntax_Print.lbname_to_string
                               lb.FStar_Syntax_Syntax.lbname)) in
                   FStar_All.pipe_right _0_878 (FStar_String.concat " and ") in
                 let decl =
  ...
  fun env  ->
    fun se  ->
      (let uu____10337 =
       ...
       if uu____10337
       then
         let _0_879 = FStar_Syntax_Print.sigelt_to_string se in
            ...
            | uu____10353 ->
                let _0_886 =
                  ...
                  let _0_884 =
                    ...
                    [_0_883] in
                  FStar_List.append _0_885 _0_884 in
                (_0_886, e)))
and encode_sigelt':
  env_t ->
    FStar_Syntax_Syntax.sigelt -> (FStar_SMTEncoding_Term.decls_t* env_t)
    ...
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect (ed,uu____10372) ->
          let uu____10373 =
            ...
            FStar_All.pipe_right _0_887 Prims.op_Negation in
          if uu____10373
          then ([], env)
          else
            (let close_effect_params tm =
               ...
               | uu____10393 ->
                   (FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_abs
                         (let _0_889 =
                            FStar_All.pipe_left (fun _0_888  -> Some _0_888)
                              (FStar_Util.Inr
                                 (FStar_Syntax_Const.effect_Tot_lid,
                                   [FStar_Syntax_Syntax.TOTAL])) in
                          ((ed.FStar_Syntax_Syntax.binders), tm, _0_889))))
                                             ...
                                             (match uu____10531 with
                                              | (xxsym,xx,uu____10541) ->
                                                  ((xxsym,
                                                     FStar_SMTEncoding_Term.Term_sort),
                                                    xx)))) in
                               FStar_All.pipe_right _0_893 FStar_List.split in
                                           ...
                                           (let _0_897 =
                                              FStar_SMTEncoding_Util.mkEq
                                                (let _0_896 =
                                                 ...
                                                 (app, _0_896)) in
                                            ([[app]], xs_sorts, _0_897)) in
                                       (_0_898, (Some "Action equality"),
                                         (Some
            ...
            (let fv =
             ...
             | (decls,env) ->
                 ...
                 let _0_902 =
                   ...
                   FStar_List.append decls _0_901 in
                 (_0_902, env))
               ...
               let g =
                 let _0_906 =
                   FStar_SMTEncoding_Term.Assume
                     (let _0_905 =
                        Some
                          (let _0_903 = FStar_Syntax_Print.lid_to_string l in
                           FStar_Util.format1 "Assumption: %s" _0_903) in
                      let _0_904 =
                        Some
                          (varops.mk_unique
                   ...
                   let uu____10689 =
                     let _0_907 =
                       FStar_TypeChecker_Env.try_lookup_val_decl env.tcenv
                         lid in
                     FStar_All.pipe_left FStar_Option.isNone _0_907 in
                   if uu____10689
                   then
                     let val_decl =
                       FStar_Syntax_Syntax.Sig_declare_typ
                            ...
                            (let _0_911 =
                               FStar_SMTEncoding_Util.mkEq
                                 (let _0_910 =
                                    FStar_SMTEncoding_Util.mkApp
                                      ("BoxBool_proj_0", [x]) in
                                  (valid_b2t_x, _0_910)) in
                             ([[valid_b2t_x]], [xx], _0_911)) in
                        (_0_912, (Some "b2t def"), (Some "b2t_def"))) in
                   [_0_913] in
                 (FStar_SMTEncoding_Term.DeclFun
           ...
           | FStar_Syntax_Syntax.Tm_abs (bs,body,uu____10877) ->
               ...
               let lb_typ =
                 ...
                 | (formals,comp) ->
                     ...
                     let _0_916 = FStar_Syntax_Syntax.mk_Total reified_typ in
                     FStar_Syntax_Util.arrow formals _0_916 in
               let lb =
                  ...
                  let _0_918 =
                    FStar_SMTEncoding_Term.DeclFun
                      (let _0_917 =
                       ...
                       (name, _0_917, FStar_SMTEncoding_Term.Term_sort, None)) in
                  [_0_918]
              ...
              FStar_All.pipe_right datas
                (FStar_Util.for_some
                   (fun l  ->
                      ...
                      FStar_All.pipe_right _0_919 FStar_Option.isNone)) in
            if uu____11109
            then []
            else
              (let uu____11119 =
                             ...
                             let fuel_guarded_inversion =
                               ...
                               FStar_SMTEncoding_Term.Assume
                                 (let _0_931 =
                                  ...
                                  (_0_931, (Some "inversion axiom"), _0_930)) in
                                     ...
                                     (let _0_935 =
                                        FStar_SMTEncoding_Util.mkForall
                                          (let _0_933 =
                                           ...
                                           ([[xx_has_type_fuel;
                                             pattern_guard]], _0_933, _0_932)) in
                                      let _0_934 =
                                        Some
                                          (varops.mk_unique
                                             (Prims.strcat
                                        ...
                                        let _0_942 =
                                          let _0_941 =
                                            FStar_SMTEncoding_Util.mkApp
                                              (tname, []) in
                                          FStar_All.pipe_left
                                            (fun _0_940  -> Some _0_940)
                                            _0_941 in
                                        push_free_var env t tname _0_942 in
                                      ([], _0_943)
                                  | uu____11442 ->
                                      let ttok_decl =
                                        FStar_SMTEncoding_Term.DeclFun
                                                  ...
                                                  (_0_951, None,
                                                    (Some
                                                       (Prims.strcat
                                                          "kinding_" ttok)))) in
                                             [_0_952] in
                                           FStar_List.append karr _0_953 in
                                         FStar_List.append decls _0_954 in
                                   let aux =
                                     let _0_958 =
                                       let _0_957 =
                                         inversion_axioms tapp vars in
                                       let _0_956 =
                                         let _0_955 = pretype_axiom tapp vars in
                                         [_0_955] in
                                       FStar_List.append _0_957 _0_956 in
                                     FStar_List.append kindingAx _0_958 in
                                   let g =
                                     FStar_List.append decls
                     ...
                     | (fuel_var,fuel_tm) ->
                         ...
                         (match uu____11575 with
                          | (vars,guards,env',binder_decls,names) ->
                              ...
                              let datacons =
                                let _0_961 =
                                  let _0_960 = varops.next_id () in
                                  (ddconstrsym, fields,
                                    FStar_SMTEncoding_Term.Term_sort, _0_960,
                                    true) in
                                FStar_All.pipe_right _0_961
            ...
            (match b with
             ...
             | FStar_TypeChecker_Env.Binding_var x ->
                 ...
                 ((let uu____12038 =
                   ...
                   if uu____12038
                   then
                     let _0_1015 = FStar_Syntax_Print.bv_to_string x in
                     let _0_1014 =
                       FStar_Syntax_Print.term_to_string
                         x.FStar_Syntax_Syntax.sort in
                     let _0_1013 = FStar_Syntax_Print.term_to_string t1 in
                  ...
                  (let uu____12040 = encode_term t1 env in
                   ...
                   | (t,decls') ->
                       ...
                       let uu____12050 =
                         let _0_1020 =
                           let _0_1019 =
                             let _0_1018 = FStar_Util.digest_of_string t_hash in
                             let _0_1017 =
                               let _0_1016 = FStar_Util.string_of_int i in
                               Prims.strcat "_" _0_1016 in
                             Prims.strcat _0_1018 _0_1017 in
                           Prims.strcat "x_" _0_1019 in
                         new_term_constant_from_string env x _0_1020 in
                              ...
                              then
                                Some
                                  (let _0_1023 =
                                   ...
                                   FStar_Util.format3 "%s : %s (%s)" _0_1023
                                     _0_1022 _0_1021)
                              else None in
                            let ax =
                              let a_name =
      ...
      (FStar_List.collect
         (fun uu____12202  ->
            ...
            | (l,uu____12210,uu____12211) ->
                let _0_1027 =
                  FStar_All.pipe_left
                    (fun _0_1024  -> FStar_SMTEncoding_Term.Echo _0_1024)
                    (Prims.fst l) in
                let _0_1026 =
                  let _0_1025 =
...
let init_env: FStar_TypeChecker_Env.env -> Prims.unit =
  fun tcenv  ->
    let _0_1030 =
      let _0_1029 =
        let _0_1028 = FStar_Util.smap_create (Prims.parse_int "100") in
        {
          bindings = [];
      ...
      [_0_1029] in
    FStar_ST.write last_env _0_1030
          ...
          let _0_1033 =
            FStar_SMTEncoding_Term.Caption
              (let _0_1032 =
                 ...
                 FStar_All.pipe_right _0_1031 (FStar_String.concat ", ") in
               Prims.strcat "encoding sigelt " _0_1032) in
          _0_1033 :: decls
        else decls in
        ...
        (let env = get_env tcenv in
         ...
         | (q,bindings) ->
             let uu____12530 =
               ...
               encode_env_bindings env _0_1038 in
             (match uu____12530 with
              | (env_decls,env) ->
                  ((let uu____12549 =
                    ...
                    if uu____12549
                    then
                      let _0_1039 = FStar_Syntax_Print.term_to_string q in
                   ...
                   (let uu____12551 = encode_formula q env in
                    ...
                    | (phi,qdecls) ->
                        let uu____12563 =
                          let _0_1040 = FStar_TypeChecker_Env.get_range tcenv in
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg _0_1040 phi in
                              ...
                              | (label_prefix,label_suffix) ->
                                  ...
                                  let suffix =
                                    let _0_1044 =
                                      ...
                                      FStar_List.append _0_1043
                                        [FStar_SMTEncoding_Term.Echo "Done!"] in
                                    FStar_List.append label_suffix _0_1044 in
