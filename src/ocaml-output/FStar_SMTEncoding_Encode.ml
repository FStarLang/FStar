...
let uu____6641 = (match ((is_prop && (not (is_lbname_squash)))) with
| true -> begin
((

let uu____6659 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2.FStar_SMTEncoding_Env.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____6659) with
| true -> begin
(

let uu____6660 = (FStar_Syntax_Print.lbname_to_string lbn)
...
let uu____6662 = (FStar_SMTEncoding_Term.mk_Valid app)
in (

let uu____6663 = (FStar_SMTEncoding_EncodeTerm.encode_formula body1 env'1)
...
let uu____6673 = (FStar_SMTEncoding_EncodeTerm.encode_term body1 env'1)
in ((app), (uu____6673)))
end)
...
let uu____6715 = (FStar_SMTEncoding_Util.mkEq ((app1), (body2)))
in ((((app1)::[])::[]), (vars), (uu____6715)))
in (FStar_SMTEncoding_Util.mkForall uu____6704))
in (

let uu____6726 = (

let uu____6729 = (FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str)
in FStar_Pervasives_Native.Some (uu____6729))
in ((uu____6703), (uu____6726), ((Prims.strcat "equation_" fvb.FStar_SMTEncoding_Env.smt_id)))))
in (FStar_SMTEncoding_Util.mkAssume uu____6696))
in (
...
let uu____6744 = (primitive_type_axioms env2.FStar_SMTEncoding_Env.tcenv flid fvb.FStar_SMTEncoding_Env.smt_id app1)
in (FStar_List.append ((eqn)::[]) uu____6744))
in (FStar_List.append decls2 uu____6741))
in (FStar_List.append binder_decls uu____6738))
in (FStar_List.append decls1 uu____6735))
in ((uu____6732), (env2))))
end))))
end));
)))
...
let uu____6812 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh "fuel")
in ((uu____6812), (FStar_SMTEncoding_Term.Fuel_sort)))
in (
...
let uu____6815 = (FStar_All.pipe_right toks1 (FStar_List.fold_left (fun uu____6862 fvb -> (match (uu____6862) with
| (gtoks, env3) -> begin
(
...
let uu____6908 = (FStar_Ident.lid_add_suffix flid "fuel_instrumented")
in (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.new_fvar uu____6908))
in (

let gtok = (

let uu____6910 = (FStar_Ident.lid_add_suffix flid "fuel_instrumented_token")
in (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.new_fvar uu____6910))
in (
...
let uu____6915 = (FStar_SMTEncoding_Util.mkApp ((g), ((fuel_tm)::[])))
in (FStar_All.pipe_left (fun _0_19 -> FStar_Pervasives_Native.Some (_0_19)) uu____6915))
in (FStar_SMTEncoding_Env.push_free_var env3 flid fvb.FStar_SMTEncoding_Env.smt_arity gtok uu____6912))
...
let encode_one_binding = (fun env01 uu____7023 t_norm uu____7025 -> (match (((uu____7023), (uu____7025))) with
| ((fvb, g, gtok), {FStar_Syntax_Syntax.lbname = lbn; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = uu____7055; FStar_Syntax_Syntax.lbeff = uu____7056; FStar_Syntax_Syntax.lbdef = e; FStar_Syntax_Syntax.lbattrs = uu____7058; FStar_Syntax_Syntax.lbpos = uu____7059}) -> begin
(

let uu____7080 = (

let uu____7087 = (FStar_TypeChecker_Env.open_universes_in env3.FStar_SMTEncoding_Env.tcenv uvs ((e)::(t_norm)::[]))
in (match (uu____7087) with
| (tcenv', uu____7109, e_t) -> begin
(

let uu____7115 = (match (e_t) with
| (e1)::(t_norm1)::[] -> begin
((e1), (t_norm1))
end
| uu____7126 -> begin
...
let uu___92_7142 = env3
in {FStar_SMTEncoding_Env.bvar_bindings = uu___92_7142.FStar_SMTEncoding_Env.bvar_bindings; FStar_SMTEncoding_Env.fvar_bindings = uu___92_7142.FStar_SMTEncoding_Env.fvar_bindings; FStar_SMTEncoding_Env.depth = uu___92_7142.FStar_SMTEncoding_Env.depth; FStar_SMTEncoding_Env.tcenv = tcenv'; FStar_SMTEncoding_Env.warn = uu___92_7142.FStar_SMTEncoding_Env.warn; FStar_SMTEncoding_Env.cache = uu___92_7142.FStar_SMTEncoding_Env.cache; FStar_SMTEncoding_Env.nolabels = uu___92_7142.FStar_SMTEncoding_Env.nolabels; FStar_SMTEncoding_Env.use_zfuel_name = uu___92_7142.FStar_SMTEncoding_Env.use_zfuel_name; FStar_SMTEncoding_Env.encode_non_total_function_typ = uu___92_7142.FStar_SMTEncoding_Env.encode_non_total_function_typ; FStar_SMTEncoding_Env.current_module_name = uu___92_7142.FStar_SMTEncoding_Env.current_module_name; FStar_SMTEncoding_Env.encoding_quantifier = uu___92_7142.FStar_SMTEncoding_Env.encoding_quantifier})), (e1), (t_norm1))
end))
end))
...
let uu____7157 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env01.FStar_SMTEncoding_Env.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____7157) with
| true -> begin
(

let uu____7158 = (FStar_Syntax_Print.lbname_to_string lbn)
in (

let uu____7159 = (FStar_Syntax_Print.term_to_string t_norm1)
in (

let uu____7160 = (FStar_Syntax_Print.term_to_string e1)
...
let uu____7162 = (destruct_bound_function fvb.FStar_SMTEncoding_Env.fvar_lid t_norm1 e1)
in (match (uu____7162) with
| ((binders, body, formals, tres), curry) -> begin
((

let uu____7199 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env01.FStar_SMTEncoding_Env.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____7199) with
| true -> begin
(

let uu____7200 = (FStar_Syntax_Print.binders_to_string ", " binders)
in (

let uu____7201 = (FStar_Syntax_Print.term_to_string body)
in (

let uu____7202 = (FStar_Syntax_Print.binders_to_string ", " formals)
in (

let uu____7203 = (FStar_Syntax_Print.term_to_string tres)
in (FStar_Util.print4 "Encoding let rec: binders=[%s], body=%s, formals=[%s], tres=%s\n" uu____7200 uu____7201 uu____7202 uu____7203)))))
end
| uu____7204 -> begin
()
end));
...
let uu____7207 = (FStar_SMTEncoding_EncodeTerm.encode_binders FStar_Pervasives_Native.None binders env')
in (match (uu____7207) with
| (vars, guards, env'1, binder_decls, uu____7238) -> begin
(
...
let uu____7266 = (FStar_List.map FStar_Pervasives_Native.snd vars)
in (FStar_SMTEncoding_Term.Fuel_sort)::uu____7266)
in ((g), (uu____7263), (FStar_SMTEncoding_Term.Term_sort), (FStar_Pervasives_Native.Some ("Fuel-instrumented function name"))))
in FStar_SMTEncoding_Term.DeclFun (uu____7252))
in (
...
let uu____7298 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((fvb.FStar_SMTEncoding_Env.smt_id), (uu____7298)))
in (FStar_SMTEncoding_Util.mkApp uu____7291))
in (
...
let uu____7318 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((fuel_tm)::[])))
in (uu____7318)::vars_tm)
in ((g), (uu____7315)))
in (FStar_SMTEncoding_Util.mkApp uu____7308))
in (
...
let uu____7334 = (FStar_SMTEncoding_Util.mkApp (("MaxFuel"), ([])))
in (uu____7334)::vars_tm)
in ((g), (uu____7331)))
in (FStar_SMTEncoding_Util.mkApp uu____7324))
in (

let body1 = (

let uu____7340 = (FStar_TypeChecker_Env.is_reifiable_function env'1.FStar_SMTEncoding_Env.tcenv t_norm1)
...
let uu____7342 = (FStar_SMTEncoding_EncodeTerm.encode_term body1 env'1)
...
let uu____7383 = (FStar_SMTEncoding_Util.mkEq ((gsapp), (body_tm)))
in ((((gsapp)::[])::[]), (FStar_Pervasives_Native.Some ((Prims.parse_int "0"))), ((fuel)::vars), (uu____7383)))
in (FStar_SMTEncoding_Util.mkForall' uu____7368))
in (

let uu____7404 = (

let uu____7407 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" fvb.FStar_SMTEncoding_Env.fvar_lid.FStar_Ident.str)
in FStar_Pervasives_Native.Some (uu____7407))
in ((uu____7367), (uu____7404), ((Prims.strcat "equation_with_fuel_" g)))))
in (FStar_SMTEncoding_Util.mkAssume uu____7360))
in (
...
let uu____7430 = (FStar_SMTEncoding_Util.mkEq ((app), (gmax)))
in ((((app)::[])::[]), (vars), (uu____7430)))
in (FStar_SMTEncoding_Util.mkForall uu____7419))
in ((uu____7418), (FStar_Pervasives_Native.Some ("Correspondence of recursive function to instrumented version")), ((Prims.strcat "@fuel_correspondence_" g))))
in (FStar_SMTEncoding_Util.mkAssume uu____7411))
in (
...
let uu____7480 = (FStar_SMTEncoding_Term.n_fuel (Prims.parse_int "0"))
in (uu____7480)::vars_tm)
in ((g), (uu____7477)))
in (FStar_SMTEncoding_Util.mkApp uu____7470))
in ((gsapp), (uu____7469)))
in (FStar_SMTEncoding_Util.mkEq uu____7464))
in ((((gsapp)::[])::[]), ((fuel)::vars), (uu____7463)))
in (FStar_SMTEncoding_Util.mkForall uu____7452))
in ((uu____7451), (FStar_Pervasives_Native.Some ("Fuel irrelevance")), ((Prims.strcat "@fuel_irrelevance_" g))))
in (FStar_SMTEncoding_Util.mkAssume uu____7444))
in (

let uu____7503 = (

let uu____7512 = (FStar_SMTEncoding_EncodeTerm.encode_binders FStar_Pervasives_Native.None formals env02)
in (match (uu____7512) with
| (vars1, v_guards, env4, binder_decls1, uu____7541) -> begin
(
...
let uu____7566 = (FStar_SMTEncoding_Util.mkFreeV ((gtok), (FStar_SMTEncoding_Term.Term_sort)))
in (FStar_SMTEncoding_EncodeTerm.mk_Apply uu____7566 ((fuel)::vars1)))
in (
...
let uu____7590 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (gapp)))
in ((((tok_app)::[])::[]), ((fuel)::vars1), (uu____7590)))
in (FStar_SMTEncoding_Util.mkForall uu____7579))
in ((uu____7578), (FStar_Pervasives_Native.Some ("Fuel token correspondence")), ((Prims.strcat "fuel_token_correspondence_" gtok))))
in (FStar_SMTEncoding_Util.mkAssume uu____7571)))
in (

let uu____7611 = (

let uu____7618 = (FStar_SMTEncoding_EncodeTerm.encode_term_pred FStar_Pervasives_Native.None tres env4 gapp)
...
let uu____7660 = (FStar_SMTEncoding_Util.mk_and_l v_guards)
in ((uu____7660), (g_typing)))
in (FStar_SMTEncoding_Util.mkImp uu____7655))
in ((((gapp)::[])::[]), ((fuel)::vars1), (uu____7654)))
in (FStar_SMTEncoding_Util.mkForall uu____7643))
in ((uu____7642), (FStar_Pervasives_Native.Some ("Typing correspondence of token to term")), ((Prims.strcat "token_correspondence_" g))))
in (FStar_SMTEncoding_Util.mkAssume uu____7635))
in (uu____7634)::[])
in ((d3), (uu____7631)))
end))
...
let uu____7738 = (FStar_List.zip3 gtoks1 typs2 bindings1)
in (FStar_List.fold_left (fun uu____7799 uu____7800 -> (match (((uu____7799), (uu____7800))) with
| ((decls2, eqns, env01), (gtok, ty, lb)) -> begin
(

let uu____7925 = (encode_one_binding env01 gtok ty lb)
in (match (uu____7925) with
| (decls', eqns', env02) -> begin
(((decls')::decls2), ((FStar_List.append eqns' eqns)), (env02))
end))
end)) (((decls1)::[]), ([]), (env0)) uu____7738))
...
let isDeclFun = (fun uu___75_8012 -> (match (uu___75_8012) with
| FStar_SMTEncoding_Term.DeclFun (uu____8013) -> begin
true
end
| uu____8024 -> begin
false
...
let uu____8025 = (FStar_All.pipe_right decls2 FStar_List.flatten)
in (FStar_All.pipe_right uu____8025 (FStar_List.partition isDeclFun))))
...
let uu____8065 = ((FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___76_8069 -> (match (uu___76_8069) with
...
let uu____8076 = ((FStar_Syntax_Util.is_pure_or_ghost_function t) || (FStar_TypeChecker_Env.is_reifiable_function env1.FStar_SMTEncoding_Env.tcenv t))
in (FStar_All.pipe_left Prims.op_Negation uu____8076))))))
in (match (uu____8065) with
| true -> begin
((decls1), (env1))
end
| uu____8085 -> begin
(FStar_All.try_with (fun uu___94_8093 -> (match (()) with
| () -> begin
...
end)) (fun uu___93_8108 -> (match (uu___93_8108) with
...
end)) (fun uu___89_8120 -> (match (uu___89_8120) with
| Let_rec_unencodeable -> begin
(

let msg = (

let uu____8128 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right uu____8128 (FStar_String.concat " and ")))
in (
...
let uu____8189 = (FStar_Syntax_Util.lid_of_sigelt se)
...
let uu____8193 = (encode_sigelt' env se)
...
let uu____8210 = (FStar_Util.format1 "<Skipped %s/>" nm)
in FStar_SMTEncoding_Term.Caption (uu____8210))
in (uu____8209)::[])
end
| uu____8211 -> begin
(
...
let uu____8216 = (FStar_Util.format1 "<Start encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (uu____8216))
in (uu____8215)::g)
in (
...
let uu____8221 = (FStar_Util.format1 "</end encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (uu____8221))
in (uu____8220)::[])
in (FStar_List.append uu____8212 uu____8217)))
end)
in ((g1), (env1)))
end))))
...
let uu____8237 = (FStar_Syntax_Subst.compress t)
in uu____8237.FStar_Syntax_Syntax.n)
in (match (uu____8236) with
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (s, uu____8241)) -> begin
...
let uu____8250 = (FStar_Syntax_Subst.compress t)
in uu____8250.FStar_Syntax_Syntax.n)
in (match (uu____8249) with
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (s, uu____8254)) -> begin
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____8260) -> begin
(failwith "impossible -- new_effect_for_free should have been removed by Tc.fs")
end
| FStar_Syntax_Syntax.Sig_splice (uu____8265) -> begin
(failwith "impossible -- splice should have been removed by Tc.fs")
end
| FStar_Syntax_Syntax.Sig_pragma (uu____8276) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_main (uu____8279) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (uu____8282) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_sub_effect (uu____8297) -> begin
(([]), (env))
end
...
let uu____8302 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right uu____8302 Prims.op_Negation))
...
let uu____8354 = (FStar_Syntax_Util.arrow_formals_comp a.FStar_Syntax_Syntax.action_typ)
in (match (uu____8354) with
| (formals, uu____8372) -> begin
(

let arity = (FStar_List.length formals)
in (

let uu____8390 = (FStar_SMTEncoding_Env.new_term_constant_and_tok_from_lid env1 a.FStar_Syntax_Syntax.action_name arity)
...
let uu____8415 = (close_effect_params a.FStar_Syntax_Syntax.action_defn)
in (FStar_SMTEncoding_EncodeTerm.encode_term uu____8415 env2))
...
let uu____8439 = (FStar_All.pipe_right formals (FStar_List.map (fun uu____8455 -> FStar_SMTEncoding_Term.Term_sort)))
in ((aname), (uu____8439), (FStar_SMTEncoding_Term.Term_sort), (FStar_Pervasives_Native.Some ("Action"))))
in FStar_SMTEncoding_Term.DeclFun (uu____8428))
in (uu____8427)::(FStar_SMTEncoding_Term.DeclFun (((atok), ([]), (FStar_SMTEncoding_Term.Term_sort), (FStar_Pervasives_Native.Some ("Action token")))))::[])
in (

let uu____8468 = (

let aux = (fun uu____8524 uu____8525 -> (match (((uu____8524), (uu____8525))) with
| ((bv, uu____8577), (env3, acc_sorts, acc)) -> begin
(

let uu____8615 = (FStar_SMTEncoding_Env.gen_term_var env3 bv)
...
let uu____8735 = (FStar_SMTEncoding_EncodeTerm.mk_Apply tm xs_sorts)
in ((app), (uu____8735)))
in (FStar_SMTEncoding_Util.mkEq uu____8730))
in ((((app)::[])::[]), (xs_sorts), (uu____8729)))
in (FStar_SMTEncoding_Util.mkForall uu____8718))
in ((uu____8717), (FStar_Pervasives_Native.Some ("Action equality")), ((Prims.strcat aname "_equality"))))
in (FStar_SMTEncoding_Util.mkAssume uu____8710))
in (
...
let uu____8774 = (FStar_SMTEncoding_Util.mkEq ((tok_app), (app)))
in ((((tok_app)::[])::[]), (xs_sorts), (uu____8774)))
in (FStar_SMTEncoding_Util.mkForall uu____8763))
in ((uu____8762), (FStar_Pervasives_Native.Some ("Action token correspondence")), ((Prims.strcat aname "_token_correspondence"))))
in (FStar_SMTEncoding_Util.mkAssume uu____8755))))
...
let uu____8793 = (FStar_Util.fold_map encode_action env ed.FStar_Syntax_Syntax.actions)
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____8821, uu____8822) when (FStar_Ident.lid_equals lid FStar_Parser_Const.precedes_lid) -> begin
(

let uu____8823 = (FStar_SMTEncoding_Env.new_term_constant_and_tok_from_lid env lid (Prims.parse_int "4"))
in (match (uu____8823) with
| (tname, ttok, env1) -> begin
(([]), (env1))
end))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____8840, t) -> begin
(
...
let uu____8846 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___77_8850 -> (match (uu___77_8850) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| FStar_Syntax_Syntax.Projector (uu____8851) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____8856) -> begin
true
end
...
let uu____8873 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigattrs (FStar_Util.for_some is_uninterpreted_by_smt))
in (encode_top_level_val uu____8873 env fv t quals))
...
let uu____8891 = (primitive_type_axioms env1.FStar_SMTEncoding_Env.tcenv lid tname tsym)
in (FStar_List.append decls uu____8891))
in ((uu____8888), (env1)))))
end)))
end)))
end
...
let uu____8899 = (FStar_Syntax_Subst.open_univ_vars us f)
in (match (uu____8899) with
| (uu____8908, f1) -> begin
(

let uu____8910 = (FStar_SMTEncoding_EncodeTerm.encode_formula f1 env)
...
let uu____8936 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Assumption: %s" uu____8936))
in FStar_Pervasives_Native.Some (uu____8935))
in (

let uu____8937 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.mk_unique (Prims.strcat "assumption_" l.FStar_Ident.str))
in ((f2), (uu____8932), (uu____8937))))
in (FStar_SMTEncoding_Util.mkAssume uu____8925))
in (uu____8924)::[])
in (((FStar_List.append decls g)), (env)))
end))
end))
end
| FStar_Syntax_Syntax.Sig_let (lbs, uu____8943) when ((FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_List.contains FStar_Syntax_Syntax.Irreducible)) || (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigattrs (FStar_Util.for_some is_opaque_to_smt))) -> begin
(

let attrs = se.FStar_Syntax_Syntax.sigattrs
in (

let uu____8955 = (FStar_Util.fold_map (fun env1 lb -> (

let lid = (

let uu____8973 = (

let uu____8976 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____8976.FStar_Syntax_Syntax.fv_name)
in uu____8973.FStar_Syntax_Syntax.v)
in (

let uu____8977 = (

let uu____8978 = (FStar_TypeChecker_Env.try_lookup_val_decl env1.FStar_SMTEncoding_Env.tcenv lid)
in (FStar_All.pipe_left FStar_Option.isNone uu____8978))
...
let uu___95_9006 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp))); FStar_Syntax_Syntax.sigrng = uu___95_9006.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Irreducible)::se.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___95_9006.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___95_9006.FStar_Syntax_Syntax.sigattrs})
in (

let uu____9011 = (encode_sigelt' env1 val_decl)
...
| FStar_Syntax_Syntax.Sig_let ((uu____9039, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (b2p1); FStar_Syntax_Syntax.lbunivs = uu____9041; FStar_Syntax_Syntax.lbtyp = uu____9042; FStar_Syntax_Syntax.lbeff = uu____9043; FStar_Syntax_Syntax.lbdef = uu____9044; FStar_Syntax_Syntax.lbattrs = uu____9045; FStar_Syntax_Syntax.lbpos = uu____9046})::[]), uu____9047) when (FStar_Syntax_Syntax.fv_eq_lid b2p1 FStar_Parser_Const.b2p_lid) -> begin
(

let uu____9070 = (FStar_SMTEncoding_Env.new_term_constant_and_tok_from_lid env b2p1.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v (Prims.parse_int "1"))
...
let uu____9128 = (FStar_SMTEncoding_Util.mkApp (((FStar_Pervasives_Native.snd FStar_SMTEncoding_Term.boxBoolFun)), ((x)::[])))
in ((valid_b2p_x), (uu____9128)))
in (FStar_SMTEncoding_Util.mkEq uu____9123))
in ((((b2p_x)::[])::[]), ((xx)::[]), (uu____9122)))
in (FStar_SMTEncoding_Util.mkForall uu____9111))
in ((uu____9110), (FStar_Pervasives_Native.Some ("b2p def")), ("b2p_def")))
in (FStar_SMTEncoding_Util.mkAssume uu____9103))
in (uu____9102)::[])
in (FStar_SMTEncoding_Term.DeclFun (((tname), ((FStar_SMTEncoding_Term.Term_sort)::[]), (FStar_SMTEncoding_Term.Term_sort), (FStar_Pervasives_Native.None))))::uu____9099)
in ((decls), (env1)))))))
end))
end
| FStar_Syntax_Syntax.Sig_let (uu____9161, uu____9162) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___78_9171 -> (match (uu___78_9171) with
| FStar_Syntax_Syntax.Discriminator (uu____9172) -> begin
true
end
| uu____9173 -> begin
false
...
| FStar_Syntax_Syntax.Sig_let (uu____9176, lids) when ((FStar_All.pipe_right lids (FStar_Util.for_some (fun l -> (

let uu____9187 = (

let uu____9188 = (FStar_List.hd l.FStar_Ident.ns)
in uu____9188.FStar_Ident.idText)
in (Prims.op_Equality uu____9187 "Prims"))))) && (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___79_9192 -> (match (uu___79_9192) with
...
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____9197) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___80_9214 -> (match (uu___80_9214) with
| FStar_Syntax_Syntax.Projector (uu____9215) -> begin
true
end
| uu____9220 -> begin
false
...
let uu____9223 = (FStar_SMTEncoding_Env.try_lookup_free_var env l)
in (match (uu____9223) with
| FStar_Pervasives_Native.Some (uu____9230) -> begin
(([]), (env))
end
| FStar_Pervasives_Native.None -> begin
(
...
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp))); FStar_Syntax_Syntax.sigrng = uu____9235; FStar_Syntax_Syntax.sigquals = uu___96_9234.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___96_9234.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___96_9234.FStar_Syntax_Syntax.sigattrs}))
in (encode_sigelt env se1))
end))))
end
| FStar_Syntax_Syntax.Sig_let ((is_rec, bindings), uu____9242) -> begin
(encode_top_level_let env ((is_rec), (bindings)) se.FStar_Syntax_Syntax.sigquals)
end
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____9260) -> begin
(

let uu____9269 = (encode_sigelts env ses)
in (match (uu____9269) with
| (g, env1) -> begin
(

let uu____9286 = (FStar_All.pipe_right g (FStar_List.partition (fun uu___81_9309 -> (match (uu___81_9309) with
| FStar_SMTEncoding_Term.Assume ({FStar_SMTEncoding_Term.assumption_term = uu____9310; FStar_SMTEncoding_Term.assumption_caption = FStar_Pervasives_Native.Some ("inversion axiom"); FStar_SMTEncoding_Term.assumption_name = uu____9311; FStar_SMTEncoding_Term.assumption_fact_ids = uu____9312}) -> begin
false
end
| uu____9315 -> begin
true
...
let uu____9330 = (FStar_All.pipe_right g' (FStar_List.partition (fun uu___82_9351 -> (match (uu___82_9351) with
| FStar_SMTEncoding_Term.DeclFun (uu____9352) -> begin
true
end
| uu____9363 -> begin
false
...
| FStar_Syntax_Syntax.Sig_inductive_typ (t, uu____9381, tps, k, uu____9384, datas) -> begin
(

let quals = se.FStar_Syntax_Syntax.sigquals
in (

let is_assumption = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___83_9401 -> (match (uu___83_9401) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____9402 -> begin
...
| (name, args, uu____9418, uu____9419, uu____9420) -> begin
(
...
let uu____9437 = (FStar_All.pipe_right args (FStar_List.map (fun uu____9454 -> (match (uu____9454) with
| (uu____9461, sort, uu____9463) -> begin
sort
end))))
in ((name), (uu____9437), (FStar_SMTEncoding_Term.Term_sort), (FStar_Pervasives_Native.None)))
in FStar_SMTEncoding_Term.DeclFun (uu____9426))
in (uu____9425)::[])
end))
end
| uu____9468 -> begin
...
let uu____9494 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (

let uu____9500 = (FStar_TypeChecker_Env.try_lookup_lid env.FStar_SMTEncoding_Env.tcenv l)
in (FStar_All.pipe_right uu____9500 FStar_Option.isNone)))))
...
let uu____9532 = (FStar_SMTEncoding_Env.fresh_fvar "x" FStar_SMTEncoding_Term.Term_sort)
in (match (uu____9532) with
| (xxsym, xx) -> begin
(

let uu____9541 = (FStar_All.pipe_right datas (FStar_List.fold_left (fun uu____9580 l -> (match (uu____9580) with
| (out, decls) -> begin
(

let uu____9600 = (FStar_TypeChecker_Env.lookup_datacon env.FStar_SMTEncoding_Env.tcenv l)
in (match (uu____9600) with
| (uu____9611, data_t) -> begin
(

let uu____9613 = (FStar_Syntax_Util.arrow_formals data_t)
...
let uu____9660 = (FStar_Syntax_Subst.compress res)
in uu____9660.FStar_Syntax_Syntax.n)
in (match (uu____9659) with
| FStar_Syntax_Syntax.Tm_app (uu____9671, indices) -> begin
indices
end
| uu____9693 -> begin
[]
...
let env1 = (FStar_All.pipe_right args (FStar_List.fold_left (fun env1 uu____9717 -> (match (uu____9717) with
| (x, uu____9723) -> begin
(
...
let uu____9732 = (FStar_SMTEncoding_Env.mk_term_projector_name l x)
in ((uu____9732), ((xx)::[])))
in (FStar_SMTEncoding_Util.mkApp uu____9725))
in (FStar_SMTEncoding_Env.push_term_var env1 x uu____9724))
end)) env))
in (

let uu____9735 = (FStar_SMTEncoding_EncodeTerm.encode_args indices env1)
...
let uu____9761 = (FStar_List.map2 (fun v1 a -> (

let uu____9777 = (

let uu____9782 = (FStar_SMTEncoding_Util.mkFreeV v1)
in ((uu____9782), (a)))
in (FStar_SMTEncoding_Util.mkEq uu____9777))) vars indices1)
in (FStar_All.pipe_right uu____9761 FStar_SMTEncoding_Util.mk_and_l))
in (
...
let uu____9797 = (FStar_SMTEncoding_Env.mk_data_tester env1 l xx)
in ((uu____9797), (eqs)))
in (FStar_SMTEncoding_Util.mkAnd uu____9792))
in ((out), (uu____9791)))
in (FStar_SMTEncoding_Util.mkOr uu____9786))
in ((uu____9785), ((FStar_List.append decls decls')))));
)
end))))
end))
end))
...
let uu____9810 = (FStar_SMTEncoding_Env.fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
...
let uu____9821 = (FStar_SMTEncoding_Util.mkApp (("SFuel"), ((ff)::[])))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel uu____9821 xx tapp))
end
| uu____9824 -> begin
...
let uu____9844 = (FStar_SMTEncoding_Env.add_fuel ((ffsym), (FStar_SMTEncoding_Term.Fuel_sort)) ((((xxsym), (FStar_SMTEncoding_Term.Term_sort)))::vars))
in (

let uu____9859 = (FStar_SMTEncoding_Util.mkImp ((xx_has_type_sfuel), (data_ax)))
in ((((xx_has_type_sfuel)::[])::[]), (uu____9844), (uu____9859))))
in (FStar_SMTEncoding_Util.mkForall uu____9833))
in (

let uu____9874 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.mk_unique (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str))
in ((uu____9832), (FStar_Pervasives_Native.Some ("inversion axiom")), (uu____9874))))
in (FStar_SMTEncoding_Util.mkAssume uu____9825)))
...
let uu____9891 = (FStar_Syntax_Subst.compress k)
in uu____9891.FStar_Syntax_Syntax.n)
...
let uu____9959 = (FStar_Syntax_Subst.open_term formals res)
in (match (uu____9959) with
| (formals1, res1) -> begin
(

let uu____9970 = (FStar_SMTEncoding_EncodeTerm.encode_binders FStar_Pervasives_Native.None formals1 env)
...
let uu____10009 = (FStar_SMTEncoding_Env.new_term_constant_and_tok_from_lid env t arity)
...
let uu____10039 = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV vars)
in ((tname), (uu____10039)))
in (FStar_SMTEncoding_Util.mkApp uu____10032))
in (
...
let uu____10059 = (FStar_All.pipe_right vars (FStar_List.map (fun uu____10091 -> (match (uu____10091) with
| (n1, s) -> begin
(((Prims.strcat tname n1)), (s), (false))
end))))
in (

let uu____10104 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.next_id ())
in ((tname), (uu____10059), (FStar_SMTEncoding_Term.Term_sort), (uu____10104), (false))))
in (constructor_or_logic_type_decl uu____10058))
in (

let uu____10113 = (match (vars) with
| [] -> begin
(
...
let uu____10130 = (FStar_SMTEncoding_Util.mkApp ((tname), ([])))
in (FStar_All.pipe_left (fun _0_20 -> FStar_Pervasives_Native.Some (_0_20)) uu____10130))
in (FStar_SMTEncoding_Env.push_free_var env1 t arity tname uu____10127))
in (([]), (uu____10126)))
end
| uu____10141 -> begin
(
...
let uu____10150 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ttok), (FStar_SMTEncoding_Term.Term_sort)) uu____10150))
in (
...
let uu____10187 = (FStar_SMTEncoding_Util.mkEq ((ttok_app), (tapp)))
in ((pats), (FStar_Pervasives_Native.None), (vars), (uu____10187)))
in (FStar_SMTEncoding_Util.mkForall' uu____10172))
in ((uu____10171), (FStar_Pervasives_Native.Some ("name-token correspondence")), ((Prims.strcat "token_correspondence_" ttok))))
in (FStar_SMTEncoding_Util.mkAssume uu____10164))
...
let uu____10227 = (FStar_SMTEncoding_EncodeTerm.encode_term_pred FStar_Pervasives_Native.None res1 env' tapp)
...
let uu____10254 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" uu____10254))
in ((uu____10253), (FStar_Pervasives_Native.Some ("kinding")), ((Prims.strcat "pre_kinding_" ttok))))
in (FStar_SMTEncoding_Util.mkAssume uu____10246))
in (uu____10245)::[])
end
| uu____10257 -> begin
[]
...
let uu____10284 = (FStar_SMTEncoding_Util.mkImp ((guard), (k1)))
in ((((tapp)::[])::[]), (vars), (uu____10284)))
in (FStar_SMTEncoding_Util.mkForall uu____10273))
in ((uu____10272), (FStar_Pervasives_Native.None), ((Prims.strcat "kinding_" ttok))))
in (FStar_SMTEncoding_Util.mkAssume uu____10265))
in (uu____10264)::[])
in (FStar_List.append karr uu____10261))
in (FStar_List.append decls1 uu____10258)))
end))
in (
...
let uu____10303 = (inversion_axioms tapp vars)
in (

let uu____10306 = (

let uu____10309 = (pretype_axiom env2 tapp vars)
in (uu____10309)::[])
in (FStar_List.append uu____10303 uu____10306)))
in (FStar_List.append kindingAx uu____10300))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (d, uu____10316, uu____10317, uu____10318, uu____10319, uu____10320) when (FStar_Ident.lid_equals d FStar_Parser_Const.lexcons_lid) -> begin
(([]), (env))
end
| FStar_Syntax_Syntax.Sig_datacon (d, uu____10328, t, uu____10330, n_tps, uu____10332) -> begin
(

let quals = se.FStar_Syntax_Syntax.sigquals
in (

let uu____10340 = (FStar_Syntax_Util.arrow_formals t)
...
let uu____10380 = (FStar_SMTEncoding_Env.new_term_constant_and_tok_from_lid env d arity)
...
let uu____10401 = (FStar_SMTEncoding_Env.fresh_fvar "f" FStar_SMTEncoding_Term.Fuel_sort)
...
let uu____10415 = (FStar_SMTEncoding_EncodeTerm.encode_binders (FStar_Pervasives_Native.Some (fuel_tm)) formals env1)
...
let uu____10485 = (FStar_SMTEncoding_Env.mk_term_projector_name d x)
in ((uu____10485), (FStar_SMTEncoding_Term.Term_sort), (projectible)))))))
in (
...
let uu____10506 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.next_id ())
in ((ddconstrsym), (fields), (FStar_SMTEncoding_Term.Term_sort), (uu____10506), (true)))
in (FStar_All.pipe_right uu____10487 FStar_SMTEncoding_Term.constructor_to_decl))
in (
...
let uu____10545 = (FStar_SMTEncoding_EncodeTerm.encode_term_pred FStar_Pervasives_Native.None t env1 ddtok_tm)
in (match (uu____10545) with
| (tok_typing, decls3) -> begin
(

let tok_typing1 = (match (fields) with
| (uu____10557)::uu____10558 -> begin
(
...
let uu____10614 = (FStar_SMTEncoding_Term.mk_NoHoist f tok_typing)
in ((((vtok_app_l)::[])::((vtok_app_r)::[])::[]), ((ff)::[]), (uu____10614)))
in (FStar_SMTEncoding_Util.mkForall uu____10603))))))
end
| uu____10639 -> begin
tok_typing
end)
...
let uu____10648 = (FStar_SMTEncoding_EncodeTerm.encode_binders (FStar_Pervasives_Native.Some (fuel_tm)) formals env1)
in (match (uu____10648) with
| (vars', guards', env'', decls_formals, uu____10673) -> begin
(
...
let uu____10725 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.next_id ())
in (FStar_SMTEncoding_Term.fresh_token ((ddtok), (FStar_SMTEncoding_Term.Term_sort)) uu____10725))
in (uu____10724)::[])
end)
in (

let encode_elim = (fun uu____10737 -> (

let uu____10738 = (FStar_Syntax_Util.head_and_args t_res)
...
let uu____10782 = (FStar_Syntax_Subst.compress head1)
in uu____10782.FStar_Syntax_Syntax.n)
in (match (uu____10781) with
| FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____10792; FStar_Syntax_Syntax.vars = uu____10793}, uu____10794) -> begin
(

let uu____10799 = (FStar_SMTEncoding_Env.lookup_free_var_name env' fv.FStar_Syntax_Syntax.fv_name)
in (match (uu____10799) with
| (encoded_head, encoded_head_arity) -> begin
(

let uu____10812 = (FStar_SMTEncoding_EncodeTerm.encode_args args env')
...
let uu____10868 = (FStar_Syntax_Print.term_to_string orig_arg)
in (FStar_Util.format1 "Inductive type parameter %s must be a variable ; You may want to change it to an index." uu____10868))
in ((FStar_Errors.Fatal_NonVariableInductiveTypeParameter), (uu____10867)))
in (FStar_Errors.raise_error uu____10862 orig_arg.FStar_Syntax_Syntax.pos))
end)
in (
...
let uu____10885 = (FStar_SMTEncoding_Term.free_variables g)
in (FStar_List.contains fv1 uu____10885))
in (match (uu____10884) with
| true -> begin
(

let uu____10898 = (FStar_SMTEncoding_Term.subst g fv1 xv)
in (uu____10898)::[])
end
| uu____10899 -> begin
[]
...
let uu____10913 = (FStar_List.zip args encoded_args)
in (FStar_List.fold_left (fun uu____10963 uu____10964 -> (match (((uu____10963), (uu____10964))) with
| ((env2, arg_vars, eqns_or_guards, i), (orig_arg, arg)) -> begin
(

let uu____11059 = (

let uu____11066 = (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None FStar_Syntax_Syntax.tun)
in (FStar_SMTEncoding_Env.gen_term_var env2 uu____11066))
in (match (uu____11059) with
| (uu____11079, xv, env3) -> begin
(
...
let uu____11087 = (guards_for_parameter (FStar_Pervasives_Native.fst orig_arg) arg xv)
in (uu____11087)::eqns_or_guards)
end
| uu____11088 -> begin
(

let uu____11089 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (uu____11089)::eqns_or_guards)
end)
in ((env3), ((xv)::arg_vars), (eqns), ((i + (Prims.parse_int "1")))))
end))
end)) ((env'), ([]), ([]), ((Prims.parse_int "0"))) uu____10913))
in (match (uu____10900) with
| (uu____11104, arg_vars, elim_eqns_or_guards, uu____11107) -> begin
(
...
let uu____11154 = (FStar_SMTEncoding_Env.add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____11171 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append elim_eqns_or_guards guards))
in ((ty_pred), (uu____11171)))
in (FStar_SMTEncoding_Util.mkImp uu____11166))
in ((((ty_pred)::[])::[]), (uu____11154), (uu____11165))))
in (FStar_SMTEncoding_Util.mkForall uu____11143))
in ((uu____11142), (FStar_Pervasives_Native.Some ("data constructor typing elim")), ((Prims.strcat "data_elim_" ddconstrsym))))
in (FStar_SMTEncoding_Util.mkAssume uu____11135))
in (

let subterm_ordering = (

let uu____11189 = (FStar_Ident.lid_equals d FStar_Parser_Const.lextop_lid)
...
let uu____11195 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh "x")
in ((uu____11195), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
let uu____11224 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in (uu____11224)::[])
in (uu____11221)::[])
in (
...
let uu____11235 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (

let uu____11236 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in ((uu____11235), (uu____11236))))
in (FStar_SMTEncoding_Util.mkImp uu____11230))
in ((uu____11216), ((x)::[]), (uu____11229))))
in (FStar_SMTEncoding_Util.mkForall uu____11205))
in (

let uu____11255 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.mk_unique "lextop")
in ((uu____11204), (FStar_Pervasives_Native.Some ("lextop is top")), (uu____11255))))
in (FStar_SMTEncoding_Util.mkAssume uu____11197))))
end
| uu____11258 -> begin
(
...
let uu____11262 = (FStar_All.pipe_right vars (FStar_List.mapi (fun i v1 -> (match ((i < n_tps)) with
| true -> begin
[]
end
| uu____11289 -> begin
...
let uu____11291 = (FStar_SMTEncoding_Util.mkFreeV v1)
in (FStar_SMTEncoding_Util.mk_Precedes uu____11291 dapp1))
in (uu____11290)::[])
end))))
in (FStar_All.pipe_right uu____11262 FStar_List.flatten))
in (
...
let uu____11317 = (FStar_SMTEncoding_Env.add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____11334 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (uu____11334)))
in (FStar_SMTEncoding_Util.mkImp uu____11329))
in ((((ty_pred)::[])::[]), (uu____11317), (uu____11328))))
in (FStar_SMTEncoding_Util.mkForall uu____11306))
in ((uu____11305), (FStar_Pervasives_Native.Some ("subterm ordering")), ((Prims.strcat "subterm_ordering_" ddconstrsym))))
in (FStar_SMTEncoding_Util.mkAssume uu____11298)))
end))
...
let uu____11354 = (FStar_SMTEncoding_Env.lookup_free_var_name env' fv.FStar_Syntax_Syntax.fv_name)
in (match (uu____11354) with
| (encoded_head, encoded_head_arity) -> begin
(

let uu____11367 = (FStar_SMTEncoding_EncodeTerm.encode_args args env')
...
let uu____11423 = (FStar_Syntax_Print.term_to_string orig_arg)
in (FStar_Util.format1 "Inductive type parameter %s must be a variable ; You may want to change it to an index." uu____11423))
in ((FStar_Errors.Fatal_NonVariableInductiveTypeParameter), (uu____11422)))
in (FStar_Errors.raise_error uu____11417 orig_arg.FStar_Syntax_Syntax.pos))
end)
in (
...
let uu____11440 = (FStar_SMTEncoding_Term.free_variables g)
in (FStar_List.contains fv1 uu____11440))
in (match (uu____11439) with
| true -> begin
(

let uu____11453 = (FStar_SMTEncoding_Term.subst g fv1 xv)
in (uu____11453)::[])
end
| uu____11454 -> begin
[]
...
let uu____11468 = (FStar_List.zip args encoded_args)
in (FStar_List.fold_left (fun uu____11518 uu____11519 -> (match (((uu____11518), (uu____11519))) with
| ((env2, arg_vars, eqns_or_guards, i), (orig_arg, arg)) -> begin
(

let uu____11614 = (

let uu____11621 = (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None FStar_Syntax_Syntax.tun)
in (FStar_SMTEncoding_Env.gen_term_var env2 uu____11621))
in (match (uu____11614) with
| (uu____11634, xv, env3) -> begin
(
...
let uu____11642 = (guards_for_parameter (FStar_Pervasives_Native.fst orig_arg) arg xv)
in (uu____11642)::eqns_or_guards)
end
| uu____11643 -> begin
(

let uu____11644 = (FStar_SMTEncoding_Util.mkEq ((arg), (xv)))
in (uu____11644)::eqns_or_guards)
end)
in ((env3), ((xv)::arg_vars), (eqns), ((i + (Prims.parse_int "1")))))
end))
end)) ((env'), ([]), ([]), ((Prims.parse_int "0"))) uu____11468))
in (match (uu____11455) with
| (uu____11659, arg_vars, elim_eqns_or_guards, uu____11662) -> begin
(
...
let uu____11709 = (FStar_SMTEncoding_Env.add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____11726 = (FStar_SMTEncoding_Util.mk_and_l (FStar_List.append elim_eqns_or_guards guards))
in ((ty_pred), (uu____11726)))
in (FStar_SMTEncoding_Util.mkImp uu____11721))
in ((((ty_pred)::[])::[]), (uu____11709), (uu____11720))))
in (FStar_SMTEncoding_Util.mkForall uu____11698))
in ((uu____11697), (FStar_Pervasives_Native.Some ("data constructor typing elim")), ((Prims.strcat "data_elim_" ddconstrsym))))
in (FStar_SMTEncoding_Util.mkAssume uu____11690))
in (

let subterm_ordering = (

let uu____11744 = (FStar_Ident.lid_equals d FStar_Parser_Const.lextop_lid)
...
let uu____11750 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh "x")
in ((uu____11750), (FStar_SMTEncoding_Term.Term_sort)))
in (
...
let uu____11779 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in (uu____11779)::[])
in (uu____11776)::[])
in (
...
let uu____11790 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (

let uu____11791 = (FStar_SMTEncoding_Util.mk_Precedes xtm dapp1)
in ((uu____11790), (uu____11791))))
in (FStar_SMTEncoding_Util.mkImp uu____11785))
in ((uu____11771), ((x)::[]), (uu____11784))))
in (FStar_SMTEncoding_Util.mkForall uu____11760))
in (

let uu____11810 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.mk_unique "lextop")
in ((uu____11759), (FStar_Pervasives_Native.Some ("lextop is top")), (uu____11810))))
in (FStar_SMTEncoding_Util.mkAssume uu____11752))))
end
| uu____11813 -> begin
(
...
let uu____11817 = (FStar_All.pipe_right vars (FStar_List.mapi (fun i v1 -> (match ((i < n_tps)) with
| true -> begin
[]
end
| uu____11844 -> begin
...
let uu____11846 = (FStar_SMTEncoding_Util.mkFreeV v1)
in (FStar_SMTEncoding_Util.mk_Precedes uu____11846 dapp1))
in (uu____11845)::[])
end))))
in (FStar_All.pipe_right uu____11817 FStar_List.flatten))
in (
...
let uu____11872 = (FStar_SMTEncoding_Env.add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) (FStar_List.append vars arg_binders))
in (
...
let uu____11889 = (FStar_SMTEncoding_Util.mk_and_l prec)
in ((ty_pred), (uu____11889)))
in (FStar_SMTEncoding_Util.mkImp uu____11884))
in ((((ty_pred)::[])::[]), (uu____11872), (uu____11883))))
in (FStar_SMTEncoding_Util.mkForall uu____11861))
in ((uu____11860), (FStar_Pervasives_Native.Some ("subterm ordering")), ((Prims.strcat "subterm_ordering_" ddconstrsym))))
in (FStar_SMTEncoding_Util.mkAssume uu____11853)))
end))
in ((arg_decls), ((typing_inversion)::(subterm_ordering)::[]))))))))))
end)))
end))
...
let uu____11916 = (FStar_Syntax_Print.lid_to_string d)
in (

let uu____11917 = (FStar_Syntax_Print.term_to_string head1)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" uu____11916 uu____11917)))
in ((FStar_Errors.Warning_ConstructorBuildsUnexpectedType), (uu____11915)))
in (FStar_Errors.log_issue se.FStar_Syntax_Syntax.sigrng uu____11910));
(([]), ([]));
)
end))
end)))
...
let uu____11970 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" uu____11970))
in FStar_Pervasives_Native.Some (uu____11969))
in ((ddtok), ([]), (FStar_SMTEncoding_Term.Term_sort), (uu____11966)))
in FStar_SMTEncoding_Term.DeclFun (uu____11955))
in (uu____11954)::[])
in (
...
let uu____12013 = (FStar_SMTEncoding_Util.mkEq ((app), (dapp)))
in ((((app)::[])::[]), (vars), (uu____12013)))
in (FStar_SMTEncoding_Util.mkForall uu____12002))
in ((uu____12001), (FStar_Pervasives_Native.Some ("equality for proxy")), ((Prims.strcat "equality_tok_" ddtok))))
in (FStar_SMTEncoding_Util.mkAssume uu____11994))
in (
...
let uu____12049 = (FStar_SMTEncoding_Env.add_fuel ((fuel_var), (FStar_SMTEncoding_Term.Fuel_sort)) vars')
in (

let uu____12060 = (FStar_SMTEncoding_Util.mkImp ((guard'), (ty_pred')))
in ((((ty_pred')::[])::[]), (uu____12049), (uu____12060))))
in (FStar_SMTEncoding_Util.mkForall uu____12038))
in ((uu____12037), (FStar_Pervasives_Native.Some ("data constructor typing intro")), ((Prims.strcat "data_typing_intro_" ddtok))))
in (FStar_SMTEncoding_Util.mkAssume uu____12030))
in (uu____12029)::[])
in (uu____11993)::uu____12026))
in ((FStar_SMTEncoding_Util.mkAssume ((tok_typing1), (FStar_Pervasives_Native.Some ("typing for data constructor proxy")), ((Prims.strcat "typing_tok_" ddtok)))))::uu____11990)
in (FStar_List.append uu____11987 elim))
in (FStar_List.append decls_pred uu____11984))
in (FStar_List.append decls_formals uu____11981))
in (FStar_List.append proxy_fresh uu____11978))
in (FStar_List.append uu____11951 uu____11975)))
in (FStar_List.append decls3 uu____11948))
in (FStar_List.append decls2 uu____11945))
in (FStar_List.append binder_decls uu____11942))
...
and encode_sigelts : FStar_SMTEncoding_Env.env_t  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_SMTEncoding_Term.decl Prims.list * FStar_SMTEncoding_Env.env_t) = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun uu____12106 se -> (match (uu____12106) with
| (g, env1) -> begin
(

let uu____12126 = (encode_sigelt env1 se)
...
let encode_binding = (fun b uu____12191 -> (match (uu____12191) with
| (i, decls, env1) -> begin
(match (b) with
| FStar_TypeChecker_Env.Binding_univ (uu____12223) -> begin
...
let uu____12229 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1.FStar_SMTEncoding_Env.tcenv) (FStar_Options.Other ("SMTEncoding")))
in (match (uu____12229) with
| true -> begin
(

let uu____12230 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____12231 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____12232 = (FStar_Syntax_Print.term_to_string t1)
...
let uu____12234 = (FStar_SMTEncoding_EncodeTerm.encode_term t1 env1)
in (match (uu____12234) with
| (t, decls') -> begin
(
...
let uu____12259 = (FStar_Util.digest_of_string t_hash)
in (Prims.strcat uu____12259 (Prims.strcat "_" (Prims.string_of_int i))))
in (Prims.strcat "x_" uu____12258))
in (FStar_SMTEncoding_Env.new_term_constant_from_string env1 x uu____12257))
...
let uu____12275 = (FStar_Options.log_queries ())
...
let uu____12279 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____12280 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____12281 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" uu____12279 uu____12280 uu____12281))))
in FStar_Pervasives_Native.Some (uu____12278))
end
| uu____12282 -> begin
...
| FStar_TypeChecker_Env.Binding_lid (x, (uu____12297, t)) -> begin
(
...
let uu____12311 = (encode_free_var false env1 fv t t_norm [])
in (match (uu____12311) with
| (g, env') -> begin
(((i + (Prims.parse_int "1"))), ((FStar_List.append decls g)), (env'))
end))))
end
| FStar_TypeChecker_Env.Binding_sig_inst (uu____12334, se, uu____12336) -> begin
(

let uu____12341 = (encode_sigelt env1 se)
in (match (uu____12341) with
| (g, env') -> begin
(((i + (Prims.parse_int "1"))), ((FStar_List.append decls g)), (env'))
end))
end
| FStar_TypeChecker_Env.Binding_sig (uu____12358, se) -> begin
(

let uu____12364 = (encode_sigelt env1 se)
...
let uu____12381 = (FStar_List.fold_right encode_binding bindings (((Prims.parse_int "0")), ([]), (env)))
in (match (uu____12381) with
| (uu____12404, decls, env1) -> begin
((decls), (env1))
end))))


let encode_labels : 'Auu____12419 'Auu____12420 . ((Prims.string * FStar_SMTEncoding_Term.sort) * 'Auu____12419 * 'Auu____12420) Prims.list  ->  (FStar_SMTEncoding_Term.decl Prims.list * FStar_SMTEncoding_Term.decl Prims.list) = (fun labs -> (

let prefix1 = (FStar_All.pipe_right labs (FStar_List.map (fun uu____12489 -> (match (uu____12489) with
| (l, uu____12501, uu____12502) -> begin
...
let suffix = (FStar_All.pipe_right labs (FStar_List.collect (fun uu____12548 -> (match (uu____12548) with
| (l, uu____12562, uu____12563) -> begin
(

let uu____12572 = (FStar_All.pipe_left (fun _0_21 -> FStar_SMTEncoding_Term.Echo (_0_21)) (FStar_Pervasives_Native.fst l))
in (
...
let uu____12577 = (FStar_SMTEncoding_Util.mkFreeV l)
in FStar_SMTEncoding_Term.Eval (uu____12577))
in (uu____12576)::[])
in (uu____12572)::uu____12573))
end))))
in ((prefix1), (suffix)))))
...
let uu____12632 = (FStar_Util.psmap_empty ())
in (

let uu____12647 = (FStar_Util.psmap_empty ())
in (

let uu____12650 = (FStar_Util.smap_create (Prims.parse_int "100"))
in (

let uu____12653 = (

let uu____12654 = (FStar_TypeChecker_Env.current_module tcenv)
in (FStar_All.pipe_right uu____12654 FStar_Ident.string_of_lid))
in {FStar_SMTEncoding_Env.bvar_bindings = uu____12632; FStar_SMTEncoding_Env.fvar_bindings = uu____12647; FStar_SMTEncoding_Env.depth = (Prims.parse_int "0"); FStar_SMTEncoding_Env.tcenv = tcenv; FStar_SMTEncoding_Env.warn = true; FStar_SMTEncoding_Env.cache = uu____12650; FStar_SMTEncoding_Env.nolabels = false; FStar_SMTEncoding_Env.use_zfuel_name = false; FStar_SMTEncoding_Env.encode_non_total_function_typ = true; FStar_SMTEncoding_Env.current_module_name = uu____12653; FStar_SMTEncoding_Env.encoding_quantifier = false}))))
in (uu____12631)::[])
in (FStar_ST.op_Colon_Equals last_env uu____12628)))


let get_env : FStar_Ident.lident  ->  FStar_TypeChecker_Env.env  ->  FStar_SMTEncoding_Env.env_t = (fun cmn tcenv -> (

let uu____12698 = (FStar_ST.op_Bang last_env)
...
let uu____12739 = (FStar_Ident.string_of_lid cmn)
in {FStar_SMTEncoding_Env.bvar_bindings = uu___97_12738.FStar_SMTEncoding_Env.bvar_bindings; FStar_SMTEncoding_Env.fvar_bindings = uu___97_12738.FStar_SMTEncoding_Env.fvar_bindings; FStar_SMTEncoding_Env.depth = uu___97_12738.FStar_SMTEncoding_Env.depth; FStar_SMTEncoding_Env.tcenv = tcenv; FStar_SMTEncoding_Env.warn = uu___97_12738.FStar_SMTEncoding_Env.warn; FStar_SMTEncoding_Env.cache = uu___97_12738.FStar_SMTEncoding_Env.cache; FStar_SMTEncoding_Env.nolabels = uu___97_12738.FStar_SMTEncoding_Env.nolabels; FStar_SMTEncoding_Env.use_zfuel_name = uu___97_12738.FStar_SMTEncoding_Env.use_zfuel_name; FStar_SMTEncoding_Env.encode_non_total_function_typ = uu___97_12738.FStar_SMTEncoding_Env.encode_non_total_function_typ; FStar_SMTEncoding_Env.current_module_name = uu____12739; FStar_SMTEncoding_Env.encoding_quantifier = uu___97_12738.FStar_SMTEncoding_Env.encoding_quantifier}))
end)))


let set_env : FStar_SMTEncoding_Env.env_t  ->  unit = (fun env -> (

let uu____12745 = (FStar_ST.op_Bang last_env)
in (match (uu____12745) with
| [] -> begin
(failwith "Empty env stack")
end
| (uu____12781)::tl1 -> begin
(FStar_ST.op_Colon_Equals last_env ((env)::tl1))
end)))


let push_env : unit  ->  unit = (fun uu____12822 -> (

let uu____12823 = (FStar_ST.op_Bang last_env)
...
let uu___98_12867 = hd1
in {FStar_SMTEncoding_Env.bvar_bindings = uu___98_12867.FStar_SMTEncoding_Env.bvar_bindings; FStar_SMTEncoding_Env.fvar_bindings = uu___98_12867.FStar_SMTEncoding_Env.fvar_bindings; FStar_SMTEncoding_Env.depth = uu___98_12867.FStar_SMTEncoding_Env.depth; FStar_SMTEncoding_Env.tcenv = uu___98_12867.FStar_SMTEncoding_Env.tcenv; FStar_SMTEncoding_Env.warn = uu___98_12867.FStar_SMTEncoding_Env.warn; FStar_SMTEncoding_Env.cache = refs; FStar_SMTEncoding_Env.nolabels = uu___98_12867.FStar_SMTEncoding_Env.nolabels; FStar_SMTEncoding_Env.use_zfuel_name = uu___98_12867.FStar_SMTEncoding_Env.use_zfuel_name; FStar_SMTEncoding_Env.encode_non_total_function_typ = uu___98_12867.FStar_SMTEncoding_Env.encode_non_total_function_typ; FStar_SMTEncoding_Env.current_module_name = uu___98_12867.FStar_SMTEncoding_Env.current_module_name; FStar_SMTEncoding_Env.encoding_quantifier = uu___98_12867.FStar_SMTEncoding_Env.encoding_quantifier})
in (FStar_ST.op_Colon_Equals last_env ((top)::(hd1)::tl1))))
end)))


let pop_env : unit  ->  unit = (fun uu____12905 -> (

let uu____12906 = (FStar_ST.op_Bang last_env)
in (match (uu____12906) with
| [] -> begin
(failwith "Popping an empty stack")
end
| (uu____12942)::tl1 -> begin
...
| ((uu____13030)::uu____13031, FStar_SMTEncoding_Term.Assume (a)) -> begin
FStar_SMTEncoding_Term.Assume ((

let uu___99_13039 = a
in {FStar_SMTEncoding_Term.assumption_term = uu___99_13039.FStar_SMTEncoding_Term.assumption_term; FStar_SMTEncoding_Term.assumption_caption = uu___99_13039.FStar_SMTEncoding_Term.assumption_caption; FStar_SMTEncoding_Term.assumption_name = uu___99_13039.FStar_SMTEncoding_Term.assumption_name; FStar_SMTEncoding_Term.assumption_fact_ids = fact_db_ids}))
end
| uu____13040 -> begin
d
end))
...
let uu____13063 = (FStar_Ident.lid_of_ids lid.FStar_Ident.ns)
in FStar_SMTEncoding_Term.Namespace (uu____13063))
in (

let uu____13064 = (open_fact_db_tags env)
in (uu____13062)::uu____13064))
in (FStar_SMTEncoding_Term.Name (lid))::uu____13059))
...
let uu____13090 = (encode_sigelt env se)
...
let uu____13132 = (FStar_Options.log_queries ())
in (match (uu____13132) with
| true -> begin
(
...
let uu____13138 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt se) (FStar_List.map FStar_Syntax_Print.lid_to_string))
in (FStar_All.pipe_right uu____13138 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " uu____13137))
in FStar_SMTEncoding_Term.Caption (uu____13136))
in (uu____13135)::decls)
end
| uu____13147 -> begin
decls
end)))
...
let uu____13149 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
in (match (uu____13149) with
| true -> begin
(

let uu____13150 = (FStar_Syntax_Print.sigelt_to_string se)
...
let uu____13153 = (FStar_TypeChecker_Env.current_module tcenv)
in (get_env uu____13153 tcenv))
in (

let uu____13154 = (encode_top_level_facts env se)
in (match (uu____13154) with
| (decls, env1) -> begin
((set_env env1);
(

let uu____13168 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 uu____13168));
)
end)));
)))
...
let uu____13184 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
in (match (uu____13184) with
| true -> begin
(

let uu____13185 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) Prims.string_of_int)
...
let encode_signature = (fun env1 ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun uu____13224 se -> (match (uu____13224) with
| (g, env2) -> begin
(

let uu____13244 = (encode_top_level_facts env2 se)
in (match (uu____13244) with
| (g', env3) -> begin
...
let uu____13267 = (encode_signature (

let uu___100_13276 = env
in {FStar_SMTEncoding_Env.bvar_bindings = uu___100_13276.FStar_SMTEncoding_Env.bvar_bindings; FStar_SMTEncoding_Env.fvar_bindings = uu___100_13276.FStar_SMTEncoding_Env.fvar_bindings; FStar_SMTEncoding_Env.depth = uu___100_13276.FStar_SMTEncoding_Env.depth; FStar_SMTEncoding_Env.tcenv = uu___100_13276.FStar_SMTEncoding_Env.tcenv; FStar_SMTEncoding_Env.warn = false; FStar_SMTEncoding_Env.cache = uu___100_13276.FStar_SMTEncoding_Env.cache; FStar_SMTEncoding_Env.nolabels = uu___100_13276.FStar_SMTEncoding_Env.nolabels; FStar_SMTEncoding_Env.use_zfuel_name = uu___100_13276.FStar_SMTEncoding_Env.use_zfuel_name; FStar_SMTEncoding_Env.encode_non_total_function_typ = uu___100_13276.FStar_SMTEncoding_Env.encode_non_total_function_typ; FStar_SMTEncoding_Env.current_module_name = uu___100_13276.FStar_SMTEncoding_Env.current_module_name; FStar_SMTEncoding_Env.encoding_quantifier = uu___100_13276.FStar_SMTEncoding_Env.encoding_quantifier}) modul.FStar_Syntax_Syntax.exports)
...
let uu____13295 = (FStar_Options.log_queries ())
...
let uu___101_13303 = env1
in {FStar_SMTEncoding_Env.bvar_bindings = uu___101_13303.FStar_SMTEncoding_Env.bvar_bindings; FStar_SMTEncoding_Env.fvar_bindings = uu___101_13303.FStar_SMTEncoding_Env.fvar_bindings; FStar_SMTEncoding_Env.depth = uu___101_13303.FStar_SMTEncoding_Env.depth; FStar_SMTEncoding_Env.tcenv = uu___101_13303.FStar_SMTEncoding_Env.tcenv; FStar_SMTEncoding_Env.warn = true; FStar_SMTEncoding_Env.cache = uu___101_13303.FStar_SMTEncoding_Env.cache; FStar_SMTEncoding_Env.nolabels = uu___101_13303.FStar_SMTEncoding_Env.nolabels; FStar_SMTEncoding_Env.use_zfuel_name = uu___101_13303.FStar_SMTEncoding_Env.use_zfuel_name; FStar_SMTEncoding_Env.encode_non_total_function_typ = uu___101_13303.FStar_SMTEncoding_Env.encode_non_total_function_typ; FStar_SMTEncoding_Env.current_module_name = uu___101_13303.FStar_SMTEncoding_Env.current_module_name; FStar_SMTEncoding_Env.encoding_quantifier = uu___101_13303.FStar_SMTEncoding_Env.encoding_quantifier}));
(

let uu____13305 = (FStar_TypeChecker_Env.debug tcenv FStar_Options.Low)
...
let uu____13364 = (FStar_TypeChecker_Env.current_module tcenv)
in uu____13364.FStar_Ident.str)
in (FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name uu____13363));
(

let env = (

let uu____13366 = (FStar_TypeChecker_Env.current_module tcenv)
in (get_env uu____13366 tcenv))
in (
...
let uu____13445 = (FStar_Syntax_Util.destruct_typ_as_formula x.FStar_Syntax_Syntax.sort)
in (match (uu____13445) with
| FStar_Pervasives_Native.Some (uu____13450) -> begin
(

let uu____13451 = (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None FStar_Syntax_Syntax.t_unit)
in (FStar_Syntax_Util.refine uu____13451 x.FStar_Syntax_Syntax.sort))
end
| uu____13452 -> begin
...
let uu____13459 = (FStar_Syntax_Syntax.mk_binder (

let uu___102_13462 = x
in {FStar_Syntax_Syntax.ppname = uu___102_13462.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___102_13462.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in (uu____13459)::out)
in ((uu____13456), (rest1)))))
end))
end
| uu____13467 -> begin
(([]), (bindings1))
...
let uu____13474 = (aux bindings)
in (match (uu____13474) with
| (closing, bindings1) -> begin
(

let uu____13499 = (FStar_Syntax_Util.close_forall_no_univs (FStar_List.rev closing) q)
in ((uu____13499), (bindings1)))
end)))
...
let uu____13527 = (FStar_List.filter (fun uu___84_13532 -> (match (uu___84_13532) with
| FStar_TypeChecker_Env.Binding_sig (uu____13533) -> begin
false
end
| uu____13540 -> begin
true
end)) bindings1)
in (encode_env_bindings env uu____13527))
in (match (uu____13522) with
| (env_decls, env1) -> begin
((

let uu____13558 = (((FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTEncoding")))) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTQuery"))))
in (match (uu____13558) with
| true -> begin
(

let uu____13559 = (FStar_Syntax_Print.term_to_string q1)
...
let uu____13561 = (FStar_SMTEncoding_EncodeTerm.encode_formula q1 env1)
...
let uu____13587 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg uu____13587 phi))
in (match (uu____13582) with
| (labels, phi1) -> begin
(

let uu____13604 = (encode_labels labels)
...
let uu____13648 = (FStar_SMTEncoding_Util.mkNot phi1)
in (

let uu____13649 = (FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.mk_unique "@query")
in ((uu____13648), (FStar_Pervasives_Native.Some ("query")), (uu____13649))))
in (FStar_SMTEncoding_Util.mkAssume uu____13641))
in (
