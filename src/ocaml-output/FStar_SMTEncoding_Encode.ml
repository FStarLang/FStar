...
let t_haseq = (let _173_620 = (let _173_619 = (let _173_618 = (let _173_617 = (FStar_SMTEncoding_Term.mkIff (t_haseq_ref, t_haseq_base))
in (((t_haseq_ref)::[])::[], cvars, _173_617))
in (FStar_SMTEncoding_Term.mkForall _173_618))
in (_173_619, Some ((Prims.strcat "haseq for " tsym)), Some ((Prims.strcat "haseq" tsym))))
in FStar_SMTEncoding_Term.Assume (_173_620))
in (

<<<<<<< HEAD
let t_kinding = (let _173_622 = (let _173_621 = (FStar_SMTEncoding_Term.mkForall (((t_has_kind)::[])::[], cvars, t_has_kind))
in (_173_621, Some ("refinement kinding"), Some ((Prims.strcat "refinement_kinding_" tsym))))
in FStar_SMTEncoding_Term.Assume (_173_622))
in (

let t_interp = (let _173_628 = (let _173_627 = (let _173_624 = (let _173_623 = (FStar_SMTEncoding_Term.mkIff (x_has_t, encoding))
in (((x_has_t)::[])::[], (ffv)::(xfv)::cvars, _173_623))
in (FStar_SMTEncoding_Term.mkForall _173_624))
in (let _173_626 = (let _173_625 = (FStar_Syntax_Print.term_to_string t0)
in Some (_173_625))
in (_173_627, _173_626, Some ((Prims.strcat "refinement_interpretation_" tsym)))))
in FStar_SMTEncoding_Term.Assume (_173_628))
in (
...
<<<<<<< HEAD
let ttm = (let _173_629 = (FStar_Unionfind.uvar_id uv)
in (FStar_SMTEncoding_Term.mk_Term_uvar _173_629))
in (
...
let d = (let _173_635 = (let _173_634 = (let _173_633 = (let _173_632 = (let _173_631 = (let _173_630 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _173_630))
in (FStar_Util.format1 "@uvar_typing_%s" _173_631))
in (varops.fresh _173_632))
in Some (_173_633))
in (t_has_k, Some ("Uvar typing"), _173_634))
in FStar_SMTEncoding_Term.Assume (_173_635))
...
| (head, args_e) -> begin
(match ((let _173_637 = (let _173_636 = (FStar_Syntax_Subst.compress head)
in _173_636.FStar_Syntax_Syntax.n)
in (_173_637, args_e))) with
| (_83_815, _83_817) when (head_redex env head) -> begin
(let _173_638 = (whnf env t)
in (encode_term _173_638 env))
=======
...
| (v2, decls2) -> begin
(let _173_639 = (FStar_SMTEncoding_Term.mk_LexCons v1 v2)
in (_173_639, (FStar_List.append decls1 decls2)))
end))
end))
end
| _83_862 -> begin
...
<<<<<<< HEAD
let ty = (let _173_644 = (FStar_Syntax_Util.arrow rest c)
in (FStar_All.pipe_right _173_644 (FStar_Syntax_Subst.subst subst)))
in (
...
<<<<<<< HEAD
let e_typing = (let _173_648 = (let _173_647 = (FStar_SMTEncoding_Term.mkForall (((has_type)::[])::[], cvars, has_type))
in (let _173_646 = (let _173_645 = (varops.fresh "@partial_app_typing_")
in Some (_173_645))
in (_173_647, Some ("Partial app typing"), _173_646)))
in FStar_SMTEncoding_Term.Assume (_173_648))
=======
...
<<<<<<< HEAD
(let _173_652 = (let _173_651 = (FStar_TypeChecker_Env.lookup_lid env.tcenv fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_All.pipe_right _173_651 Prims.snd))
in Some (_173_652))
end
...
<<<<<<< HEAD
let head_type = (let _173_653 = (FStar_TypeChecker_Normalize.normalize_refinement ((FStar_TypeChecker_Normalize.WHNF)::(FStar_TypeChecker_Normalize.EraseUniverses)::[]) env.tcenv head_type)
in (FStar_All.pipe_left FStar_Syntax_Util.unrefine _173_653))
in (
...
<<<<<<< HEAD
in (let _173_656 = (FStar_SMTEncoding_Term.mkFreeV (f, FStar_SMTEncoding_Term.Term_sort))
in (_173_656, (decl)::[]))))
=======
...
| FStar_Util.Inl (lc) -> begin
<<<<<<< HEAD
(let _173_661 = (lc.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _173_661))
end
| FStar_Util.Inr (ef) -> begin
(let _173_663 = (let _173_662 = (FStar_TypeChecker_Rel.new_uvar FStar_Range.dummyRange [] FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _173_662 Prims.fst))
in (FStar_Syntax_Syntax.mk_Total _173_663))
=======
...
<<<<<<< HEAD
let _83_998 = (let _173_665 = (let _173_664 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format1 "Losing precision when encoding a function literal: %s" _173_664))
in (FStar_TypeChecker_Errors.warn t0.FStar_Syntax_Syntax.pos _173_665))
in (fallback ()))
end
| Some (lc) -> begin
if (let _173_666 = (is_pure_or_ghost lc)
in (FStar_All.pipe_left Prims.op_Negation _173_666)) then begin
=======
...
let key_body = (let _173_670 = (let _173_669 = (let _173_668 = (let _173_667 = (FStar_SMTEncoding_Term.mk_and_l guards)
in (_173_667, body))
in (FStar_SMTEncoding_Term.mkImp _173_668))
in ([], vars, _173_669))
in (FStar_SMTEncoding_Term.mkForall _173_670))
=======
...
(let _173_673 = (let _173_672 = (let _173_671 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV cvars)
in (t, _173_671))
in (FStar_SMTEncoding_Term.mkApp _173_672))
in (_173_673, []))
=======
...
<<<<<<< HEAD
let f = (let _173_675 = (let _173_674 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV cvars)
in (fsym, _173_674))
in (FStar_SMTEncoding_Term.mkApp _173_675))
=======
...
<<<<<<< HEAD
in (let _173_677 = (let _173_676 = (FStar_SMTEncoding_Term.mkForall (((f)::[])::[], cvars, f_has_t))
in (_173_676, a_name, a_name))
in FStar_SMTEncoding_Term.Assume (_173_677)))
=======
...
<<<<<<< HEAD
in (let _173_684 = (let _173_683 = (let _173_682 = (let _173_681 = (let _173_680 = (let _173_679 = (FStar_SMTEncoding_Term.mk_IsTyped app)
in (let _173_678 = (FStar_SMTEncoding_Term.mkEq (app, body))
in (_173_679, _173_678)))
in (FStar_SMTEncoding_Term.mkImp _173_680))
in (((app)::[])::[], (FStar_List.append vars cvars), _173_681))
in (FStar_SMTEncoding_Term.mkForall _173_682))
in (_173_683, a_name, a_name))
in FStar_SMTEncoding_Term.Assume (_173_684)))
=======
...
<<<<<<< HEAD
in (let _173_685 = (FStar_SMTEncoding_Term.mkFreeV (e, FStar_SMTEncoding_Term.Term_sort))
in (_173_685, (decl_e)::[])))))
=======
...
| (w, decls2) -> begin
(let _173_719 = (let _173_718 = (let _173_717 = (let _173_716 = (let _173_715 = (FStar_SMTEncoding_Term.boxBool FStar_SMTEncoding_Term.mkTrue)
in (w, _173_715))
in (FStar_SMTEncoding_Term.mkEq _173_716))
in (guard, _173_717))
in (FStar_SMTEncoding_Term.mkAnd _173_718))
in (_173_719, decls2))
end))
end)
...
| (br, decls3) -> begin
(let _173_720 = (FStar_SMTEncoding_Term.mkITE (guard, br, else_case))
in (_173_720, (FStar_List.append (FStar_List.append decls decls2) decls3)))
=======
...
<<<<<<< HEAD
(let _173_734 = (let _173_733 = (encode_const c)
in (scrutinee, _173_733))
in (FStar_SMTEncoding_Term.mkEq _173_734))
=======
...
in (let _173_737 = (FStar_SMTEncoding_Term.mkApp (proj, (scrutinee)::[]))
in (mk_guard arg _173_737)))
=======
...
| FStar_Syntax_Syntax.Pat_cons (f, args) -> begin
(let _173_745 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _83_1234 -> (match (_83_1234) with
| (arg, _83_1233) -> begin
(

let proj = (primitive_projector_by_pos env.tcenv f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v i)
in (let _173_744 = (FStar_SMTEncoding_Term.mkApp (proj, (scrutinee)::[]))
in (mk_projections arg _173_744)))
end))))
in (FStar_All.pipe_right _173_745 FStar_List.flatten))
end))
in (
...
<<<<<<< HEAD
let _83_1262 = (let _173_758 = (FStar_Syntax_Util.unmeta e)
in (FStar_Syntax_Util.head_and_args _173_758))
in (match (_83_1262) with
| (head, args) -> begin
(match ((let _173_760 = (let _173_759 = (FStar_Syntax_Util.un_uinst head)
in _173_759.FStar_Syntax_Syntax.n)
in (_173_760, args))) with
...
<<<<<<< HEAD
let _83_1290 = (let _173_764 = (FStar_Syntax_Util.unmeta p)
in (FStar_All.pipe_right _173_764 FStar_Syntax_Util.head_and_args))
in (match (_83_1290) with
| (head, args) -> begin
(match ((let _173_766 = (let _173_765 = (FStar_Syntax_Util.un_uinst head)
in _173_765.FStar_Syntax_Syntax.n)
in (_173_766, args))) with
...
<<<<<<< HEAD
let _83_1321 = (let _173_771 = (FStar_Syntax_Util.unmeta t)
in (FStar_All.pipe_right _173_771 FStar_Syntax_Util.head_and_args))
in (match (_83_1321) with
| (head, args) -> begin
(match ((let _173_773 = (let _173_772 = (FStar_Syntax_Util.un_uinst head)
in _173_772.FStar_Syntax_Syntax.n)
in (_173_773, args))) with
...
| Some (e) -> begin
<<<<<<< HEAD
(let _173_776 = (list_elements e)
in (FStar_All.pipe_right _173_776 (FStar_List.map (fun branch -> (let _173_775 = (list_elements branch)
in (FStar_All.pipe_right _173_775 (FStar_List.map one_pat)))))))
end
| _83_1338 -> begin
(let _173_777 = (FStar_All.pipe_right elts (FStar_List.map one_pat))
in (_173_777)::[])
end)
end
| _83_1340 -> begin
(let _173_778 = (FStar_All.pipe_right elts (FStar_List.map one_pat))
in (_173_778)::[])
end))))
in (

let _83_1374 = (match ((let _173_779 = (FStar_Syntax_Subst.compress t)
in _173_779.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(
...
<<<<<<< HEAD
in (let _173_780 = (lemma_pats pats')
in (binders, pre, post, _173_780)))
end
| _83_1367 -> begin
=======
...
let _83_1394 = (let _173_784 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (

let _83_1391 = (let _173_783 = (FStar_All.pipe_right branch (FStar_List.map (fun _83_1386 -> (match (_83_1386) with
| (t, _83_1385) -> begin
(encode_term t (
...
in (FStar_All.pipe_right _173_783 FStar_List.unzip))
in (match (_83_1391) with
| (pats, decls) -> begin
(pats, decls)
end)))))
in (FStar_All.pipe_right _173_784 FStar_List.unzip))
...
| (l)::[] -> begin
<<<<<<< HEAD
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _173_787 = (let _173_786 = (FStar_SMTEncoding_Term.mkFreeV l)
in (FStar_SMTEncoding_Term.mk_Precedes _173_786 e))
in (_173_787)::p))))
end
| _83_1404 -> begin
=======
...
| [] -> begin
<<<<<<< HEAD
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _173_793 = (FStar_SMTEncoding_Term.mk_Precedes tl e)
in (_173_793)::p))))
end
| ((x, FStar_SMTEncoding_Term.Term_sort))::vars -> begin
(let _173_795 = (let _173_794 = (FStar_SMTEncoding_Term.mkFreeV (x, FStar_SMTEncoding_Term.Term_sort))
in (FStar_SMTEncoding_Term.mk_LexCons _173_794 tl))
in (aux _173_795 vars))
end
| _83_1416 -> begin
pats
end))
in (let _173_796 = (FStar_SMTEncoding_Term.mkFreeV ("Prims.LexTop", FStar_SMTEncoding_Term.Term_sort))
in (aux _173_796 vars)))
=======
...
let _83_1423 = (let _173_797 = (FStar_Syntax_Util.unmeta pre)
in (encode_formula _173_797 env))
in (match (_83_1423) with
| (pre, decls'') -> begin
(

let _83_1426 = (let _173_798 = (FStar_Syntax_Util.unmeta post)
in (encode_formula _173_798 env))
...
<<<<<<< HEAD
in (let _173_803 = (let _173_802 = (let _173_801 = (let _173_800 = (let _173_799 = (FStar_SMTEncoding_Term.mk_and_l ((pre)::guards))
in (_173_799, post))
in (FStar_SMTEncoding_Term.mkImp _173_800))
in (pats, vars, _173_801))
in (FStar_SMTEncoding_Term.mkForall _173_802))
in (_173_803, decls)))
=======
...
<<<<<<< HEAD
(let _173_809 = (FStar_Syntax_Print.tag_of_term phi)
in (let _173_808 = (FStar_Syntax_Print.term_to_string phi)
...
let un_op = (fun f l -> (let _173_839 = (FStar_List.hd l)
in (FStar_All.pipe_left f _173_839)))
=======
...
| (l2, decls2) -> begin
(let _173_869 = (FStar_SMTEncoding_Term.mkImp (l2, l1))
in (_173_869, (FStar_List.append decls1 decls2)))
=======
...
<<<<<<< HEAD
let unboxInt_l = (fun f l -> (let _173_881 = (FStar_List.map FStar_SMTEncoding_Term.unboxInt l)
in (f _173_881)))
in (

let connectives = (let _173_934 = (let _173_890 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_SMTEncoding_Term.mkAnd))
in (FStar_Syntax_Const.and_lid, _173_890))
in (let _173_933 = (let _173_932 = (let _173_896 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_SMTEncoding_Term.mkOr))
in (FStar_Syntax_Const.or_lid, _173_896))
in (let _173_931 = (let _173_930 = (let _173_929 = (let _173_905 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_SMTEncoding_Term.mkIff))
in (FStar_Syntax_Const.iff_lid, _173_905))
in (let _173_928 = (let _173_927 = (let _173_926 = (let _173_914 = (FStar_All.pipe_left enc_prop_c (un_op FStar_SMTEncoding_Term.mkNot))
in (FStar_Syntax_Const.not_lid, _173_914))
in (_173_926)::((FStar_Syntax_Const.eq2_lid, eq_op))::((FStar_Syntax_Const.true_lid, (const_op FStar_SMTEncoding_Term.mkTrue)))::((FStar_Syntax_Const.false_lid, (const_op FStar_SMTEncoding_Term.mkFalse)))::[])
in ((FStar_Syntax_Const.ite_lid, mk_ite))::_173_927)
in (_173_929)::_173_928))
in ((FStar_Syntax_Const.imp_lid, mk_imp))::_173_930)
in (_173_932)::_173_931))
in (_173_934)::_173_933))
=======
...
| (phi, decls) -> begin
(let _173_937 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Labeled ((phi, msg, r))))
in (_173_937, decls))
=======
...
| (t, decls') -> begin
(let _173_938 = (FStar_SMTEncoding_Term.mk_HasType x t)
in (_173_938, (FStar_List.append decls decls')))
end))
end))
end
...
(match ((let _173_942 = (let _173_939 = (FStar_Syntax_Subst.compress r)
in _173_939.FStar_Syntax_Syntax.n)
in (let _173_941 = (let _173_940 = (FStar_Syntax_Subst.compress msg)
in _173_940.FStar_Syntax_Syntax.n)
in (_173_942, _173_941)))) with
...
(let _173_943 = (whnf env phi)
in (encode_formula _173_943 env))
end
| _83_1634 -> begin
(
...
| (tt, decls) -> begin
(let _173_944 = (FStar_SMTEncoding_Term.mk_Valid tt)
in (_173_944, decls))
end))
end))
end
...
let _83_1667 = (let _173_957 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (

let _83_1664 = (let _173_956 = (FStar_All.pipe_right p (FStar_List.map (fun _83_1659 -> (match (_83_1659) with
| (t, _83_1658) -> begin
(encode_term t (
...
in (FStar_All.pipe_right _173_956 FStar_List.unzip))
...
in (let _173_958 = (FStar_SMTEncoding_Term.mk_and_l guards)
in (vars, pats, _173_958, body, (FStar_List.append (FStar_List.append decls (FStar_List.flatten decls')) decls''))))
=======
...
(let _173_975 = (FStar_All.pipe_right vars (FStar_Syntax_Print.binders_to_string "; "))
...
let tm = (let _173_977 = (let _173_976 = (FStar_SMTEncoding_Term.mkImp (guard, body))
in (pats, vars, _173_976))
in (FStar_SMTEncoding_Term.mkForall _173_977))
in (

let _83_1721 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env.tcenv) (FStar_Options.Other ("Encoding"))) then begin
(let _173_978 = (FStar_SMTEncoding_Term.termToSmt tm)
...
| (vars, pats, guard, body, decls) -> begin
(let _173_981 = (let _173_980 = (let _173_979 = (FStar_SMTEncoding_Term.mkAnd (guard, body))
in (pats, vars, _173_979))
in (FStar_SMTEncoding_Term.mkExists _173_980))
in (_173_981, decls))
=======
...
<<<<<<< HEAD
let t1 = (let _173_1024 = (let _173_1023 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV vars)
in (x, _173_1023))
in (FStar_SMTEncoding_Term.mkApp _173_1024))
in (

let vname_decl = (let _173_1026 = (let _173_1025 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (x, _173_1025, FStar_SMTEncoding_Term.Term_sort, None))
in FStar_SMTEncoding_Term.DeclFun (_173_1026))
in (let _173_1032 = (let _173_1031 = (let _173_1030 = (let _173_1029 = (let _173_1028 = (let _173_1027 = (FStar_SMTEncoding_Term.mkEq (t1, body))
in (((t1)::[])::[], vars, _173_1027))
in (FStar_SMTEncoding_Term.mkForall _173_1028))
in (_173_1029, None, Some ((Prims.strcat "primitive_" x))))
in FStar_SMTEncoding_Term.Assume (_173_1030))
in (_173_1031)::[])
in (vname_decl)::_173_1032))))
=======
...
<<<<<<< HEAD
let prims = (let _173_1192 = (let _173_1041 = (let _173_1040 = (let _173_1039 = (FStar_SMTEncoding_Term.mkEq (x, y))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1039))
in (quant axy _173_1040))
in (FStar_Syntax_Const.op_Eq, _173_1041))
in (let _173_1191 = (let _173_1190 = (let _173_1048 = (let _173_1047 = (let _173_1046 = (let _173_1045 = (FStar_SMTEncoding_Term.mkEq (x, y))
in (FStar_SMTEncoding_Term.mkNot _173_1045))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1046))
in (quant axy _173_1047))
in (FStar_Syntax_Const.op_notEq, _173_1048))
in (let _173_1189 = (let _173_1188 = (let _173_1057 = (let _173_1056 = (let _173_1055 = (let _173_1054 = (let _173_1053 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1052 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1053, _173_1052)))
in (FStar_SMTEncoding_Term.mkLT _173_1054))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1055))
in (quant xy _173_1056))
in (FStar_Syntax_Const.op_LT, _173_1057))
in (let _173_1187 = (let _173_1186 = (let _173_1066 = (let _173_1065 = (let _173_1064 = (let _173_1063 = (let _173_1062 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1061 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1062, _173_1061)))
in (FStar_SMTEncoding_Term.mkLTE _173_1063))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1064))
in (quant xy _173_1065))
in (FStar_Syntax_Const.op_LTE, _173_1066))
in (let _173_1185 = (let _173_1184 = (let _173_1075 = (let _173_1074 = (let _173_1073 = (let _173_1072 = (let _173_1071 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1070 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1071, _173_1070)))
in (FStar_SMTEncoding_Term.mkGT _173_1072))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1073))
in (quant xy _173_1074))
in (FStar_Syntax_Const.op_GT, _173_1075))
in (let _173_1183 = (let _173_1182 = (let _173_1084 = (let _173_1083 = (let _173_1082 = (let _173_1081 = (let _173_1080 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1079 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1080, _173_1079)))
in (FStar_SMTEncoding_Term.mkGTE _173_1081))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1082))
in (quant xy _173_1083))
in (FStar_Syntax_Const.op_GTE, _173_1084))
in (let _173_1181 = (let _173_1180 = (let _173_1093 = (let _173_1092 = (let _173_1091 = (let _173_1090 = (let _173_1089 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1088 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1089, _173_1088)))
in (FStar_SMTEncoding_Term.mkSub _173_1090))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1091))
in (quant xy _173_1092))
in (FStar_Syntax_Const.op_Subtraction, _173_1093))
in (let _173_1179 = (let _173_1178 = (let _173_1100 = (let _173_1099 = (let _173_1098 = (let _173_1097 = (FStar_SMTEncoding_Term.unboxInt x)
in (FStar_SMTEncoding_Term.mkMinus _173_1097))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1098))
in (quant qx _173_1099))
in (FStar_Syntax_Const.op_Minus, _173_1100))
in (let _173_1177 = (let _173_1176 = (let _173_1109 = (let _173_1108 = (let _173_1107 = (let _173_1106 = (let _173_1105 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1104 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1105, _173_1104)))
in (FStar_SMTEncoding_Term.mkAdd _173_1106))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1107))
in (quant xy _173_1108))
in (FStar_Syntax_Const.op_Addition, _173_1109))
in (let _173_1175 = (let _173_1174 = (let _173_1118 = (let _173_1117 = (let _173_1116 = (let _173_1115 = (let _173_1114 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1113 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1114, _173_1113)))
in (FStar_SMTEncoding_Term.mkMul _173_1115))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1116))
in (quant xy _173_1117))
in (FStar_Syntax_Const.op_Multiply, _173_1118))
in (let _173_1173 = (let _173_1172 = (let _173_1127 = (let _173_1126 = (let _173_1125 = (let _173_1124 = (let _173_1123 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1122 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1123, _173_1122)))
in (FStar_SMTEncoding_Term.mkDiv _173_1124))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1125))
in (quant xy _173_1126))
in (FStar_Syntax_Const.op_Division, _173_1127))
in (let _173_1171 = (let _173_1170 = (let _173_1136 = (let _173_1135 = (let _173_1134 = (let _173_1133 = (let _173_1132 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1131 = (FStar_SMTEncoding_Term.unboxInt y)
in (_173_1132, _173_1131)))
in (FStar_SMTEncoding_Term.mkMod _173_1133))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxInt _173_1134))
in (quant xy _173_1135))
in (FStar_Syntax_Const.op_Modulus, _173_1136))
in (let _173_1169 = (let _173_1168 = (let _173_1145 = (let _173_1144 = (let _173_1143 = (let _173_1142 = (let _173_1141 = (FStar_SMTEncoding_Term.unboxBool x)
in (let _173_1140 = (FStar_SMTEncoding_Term.unboxBool y)
in (_173_1141, _173_1140)))
in (FStar_SMTEncoding_Term.mkAnd _173_1142))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1143))
in (quant xy _173_1144))
in (FStar_Syntax_Const.op_And, _173_1145))
in (let _173_1167 = (let _173_1166 = (let _173_1154 = (let _173_1153 = (let _173_1152 = (let _173_1151 = (let _173_1150 = (FStar_SMTEncoding_Term.unboxBool x)
in (let _173_1149 = (FStar_SMTEncoding_Term.unboxBool y)
in (_173_1150, _173_1149)))
in (FStar_SMTEncoding_Term.mkOr _173_1151))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1152))
in (quant xy _173_1153))
in (FStar_Syntax_Const.op_Or, _173_1154))
in (let _173_1165 = (let _173_1164 = (let _173_1161 = (let _173_1160 = (let _173_1159 = (let _173_1158 = (FStar_SMTEncoding_Term.unboxBool x)
in (FStar_SMTEncoding_Term.mkNot _173_1158))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_1159))
in (quant qx _173_1160))
in (FStar_Syntax_Const.op_Negation, _173_1161))
in (_173_1164)::[])
=======
...
in (_173_1190)::_173_1189))
in (_173_1192)::_173_1191))
in (

let mk = (fun l v -> (let _173_1224 = (FStar_All.pipe_right prims (FStar_List.filter (fun _83_1766 -> (match (_83_1766) with
| (l', _83_1765) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _173_1224 (FStar_List.collect (fun _83_1770 -> (match (_83_1770) with
| (_83_1768, b) -> begin
=======
in (
...
<<<<<<< HEAD
in (let _173_1252 = (let _173_1251 = (let _173_1248 = (let _173_1247 = (let _173_1246 = (let _173_1245 = (let _173_1244 = (let _173_1243 = (FStar_SMTEncoding_Term.mkApp ("PreType", (xx)::[]))
in (tapp, _173_1243))
in (FStar_SMTEncoding_Term.mkEq _173_1244))
in (xx_has_type, _173_1245))
in (FStar_SMTEncoding_Term.mkImp _173_1246))
in (((xx_has_type)::[])::[], ((xxsym, FStar_SMTEncoding_Term.Term_sort))::((ffsym, FStar_SMTEncoding_Term.Fuel_sort))::vars, _173_1247))
in (FStar_SMTEncoding_Term.mkForall _173_1248))
in (let _173_1250 = (let _173_1249 = (varops.fresh "@pretyping_")
in Some (_173_1249))
in (_173_1251, Some ("pretyping"), _173_1250)))
in FStar_SMTEncoding_Term.Assume (_173_1252)))
=======
...
<<<<<<< HEAD
in (let _173_1273 = (let _173_1264 = (let _173_1263 = (FStar_SMTEncoding_Term.mk_HasType FStar_SMTEncoding_Term.mk_Term_unit tt)
in (_173_1263, Some ("unit typing"), Some ("unit_typing")))
in FStar_SMTEncoding_Term.Assume (_173_1264))
in (let _173_1272 = (let _173_1271 = (let _173_1270 = (let _173_1269 = (let _173_1268 = (let _173_1267 = (let _173_1266 = (let _173_1265 = (FStar_SMTEncoding_Term.mkEq (x, FStar_SMTEncoding_Term.mk_Term_unit))
in (typing_pred, _173_1265))
in (FStar_SMTEncoding_Term.mkImp _173_1266))
in (((typing_pred)::[])::[], (xx)::[], _173_1267))
in (mkForall_fuel _173_1268))
in (_173_1269, Some ("unit inversion"), Some ("unit_inversion")))
in FStar_SMTEncoding_Term.Assume (_173_1270))
in (_173_1271)::[])
in (_173_1273)::_173_1272))))
=======
...
<<<<<<< HEAD
in (let _173_1296 = (let _173_1287 = (let _173_1286 = (let _173_1285 = (let _173_1284 = (let _173_1281 = (let _173_1280 = (FStar_SMTEncoding_Term.boxBool b)
in (_173_1280)::[])
in (_173_1281)::[])
in (let _173_1283 = (let _173_1282 = (FStar_SMTEncoding_Term.boxBool b)
in (FStar_SMTEncoding_Term.mk_HasType _173_1282 tt))
in (_173_1284, (bb)::[], _173_1283)))
in (FStar_SMTEncoding_Term.mkForall _173_1285))
in (_173_1286, Some ("bool typing"), Some ("bool_typing")))
in FStar_SMTEncoding_Term.Assume (_173_1287))
in (let _173_1295 = (let _173_1294 = (let _173_1293 = (let _173_1292 = (let _173_1291 = (let _173_1290 = (let _173_1289 = (let _173_1288 = (FStar_SMTEncoding_Term.mk_tester "BoxBool" x)
in (typing_pred, _173_1288))
in (FStar_SMTEncoding_Term.mkImp _173_1289))
in (((typing_pred)::[])::[], (xx)::[], _173_1290))
in (mkForall_fuel _173_1291))
in (_173_1292, Some ("bool inversion"), Some ("bool_inversion")))
in FStar_SMTEncoding_Term.Assume (_173_1293))
in (_173_1294)::[])
in (_173_1296)::_173_1295))))))
=======
...
<<<<<<< HEAD
let precedes = (let _173_1310 = (let _173_1309 = (let _173_1308 = (let _173_1307 = (let _173_1306 = (let _173_1305 = (FStar_SMTEncoding_Term.boxInt a)
in (let _173_1304 = (let _173_1303 = (FStar_SMTEncoding_Term.boxInt b)
in (_173_1303)::[])
in (_173_1305)::_173_1304))
in (tt)::_173_1306)
in (tt)::_173_1307)
in ("Prims.Precedes", _173_1308))
in (FStar_SMTEncoding_Term.mkApp _173_1309))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _173_1310))
in (

let precedes_y_x = (let _173_1311 = (FStar_SMTEncoding_Term.mkApp ("Precedes", (y)::(x)::[]))
in (FStar_All.pipe_left FStar_SMTEncoding_Term.mk_Valid _173_1311))
in (let _173_1353 = (let _173_1319 = (let _173_1318 = (let _173_1317 = (let _173_1316 = (let _173_1313 = (let _173_1312 = (FStar_SMTEncoding_Term.boxInt b)
in (_173_1312)::[])
in (_173_1313)::[])
in (let _173_1315 = (let _173_1314 = (FStar_SMTEncoding_Term.boxInt b)
in (FStar_SMTEncoding_Term.mk_HasType _173_1314 tt))
in (_173_1316, (bb)::[], _173_1315)))
in (FStar_SMTEncoding_Term.mkForall _173_1317))
in (_173_1318, Some ("int typing"), Some ("int_typing")))
in FStar_SMTEncoding_Term.Assume (_173_1319))
in (let _173_1352 = (let _173_1351 = (let _173_1325 = (let _173_1324 = (let _173_1323 = (let _173_1322 = (let _173_1321 = (let _173_1320 = (FStar_SMTEncoding_Term.mk_tester "BoxInt" x)
in (typing_pred, _173_1320))
in (FStar_SMTEncoding_Term.mkImp _173_1321))
in (((typing_pred)::[])::[], (xx)::[], _173_1322))
in (mkForall_fuel _173_1323))
in (_173_1324, Some ("int inversion"), Some ("int_inversion")))
in FStar_SMTEncoding_Term.Assume (_173_1325))
in (let _173_1350 = (let _173_1349 = (let _173_1348 = (let _173_1347 = (let _173_1346 = (let _173_1345 = (let _173_1344 = (let _173_1343 = (let _173_1342 = (let _173_1341 = (let _173_1340 = (let _173_1339 = (let _173_1328 = (let _173_1327 = (FStar_SMTEncoding_Term.unboxInt x)
in (let _173_1326 = (FStar_SMTEncoding_Term.mkInteger' 0)
in (_173_1327, _173_1326)))
in (FStar_SMTEncoding_Term.mkGT _173_1328))
in (let _173_1338 = (let _173_1337 = (let _173_1331 = (let _173_1330 = (FStar_SMTEncoding_Term.unboxInt y)
in (let _173_1329 = (FStar_SMTEncoding_Term.mkInteger' 0)
in (_173_1330, _173_1329)))
in (FStar_SMTEncoding_Term.mkGTE _173_1331))
in (let _173_1336 = (let _173_1335 = (let _173_1334 = (let _173_1333 = (FStar_SMTEncoding_Term.unboxInt y)
in (let _173_1332 = (FStar_SMTEncoding_Term.unboxInt x)
in (_173_1333, _173_1332)))
in (FStar_SMTEncoding_Term.mkLT _173_1334))
in (_173_1335)::[])
in (_173_1337)::_173_1336))
in (_173_1339)::_173_1338))
in (typing_pred_y)::_173_1340)
in (typing_pred)::_173_1341)
in (FStar_SMTEncoding_Term.mk_and_l _173_1342))
in (_173_1343, precedes_y_x))
in (FStar_SMTEncoding_Term.mkImp _173_1344))
in (((typing_pred)::(typing_pred_y)::(precedes_y_x)::[])::[], (xx)::(yy)::[], _173_1345))
in (mkForall_fuel _173_1346))
in (_173_1347, Some ("well-founded ordering on nat (alt)"), Some ("well-founded-ordering-on-nat")))
in FStar_SMTEncoding_Term.Assume (_173_1348))
in (_173_1349)::[])
in (_173_1351)::_173_1350))
in (_173_1353)::_173_1352)))))))))))
=======
...
let b = (FStar_SMTEncoding_Term.mkFreeV bb)
<<<<<<< HEAD
in (let _173_1376 = (let _173_1367 = (let _173_1366 = (let _173_1365 = (let _173_1364 = (let _173_1361 = (let _173_1360 = (FStar_SMTEncoding_Term.boxString b)
in (_173_1360)::[])
in (_173_1361)::[])
in (let _173_1363 = (let _173_1362 = (FStar_SMTEncoding_Term.boxString b)
in (FStar_SMTEncoding_Term.mk_HasType _173_1362 tt))
in (_173_1364, (bb)::[], _173_1363)))
in (FStar_SMTEncoding_Term.mkForall _173_1365))
in (_173_1366, Some ("string typing"), Some ("string_typing")))
in FStar_SMTEncoding_Term.Assume (_173_1367))
in (let _173_1375 = (let _173_1374 = (let _173_1373 = (let _173_1372 = (let _173_1371 = (let _173_1370 = (let _173_1369 = (let _173_1368 = (FStar_SMTEncoding_Term.mk_tester "BoxString" x)
in (typing_pred, _173_1368))
in (FStar_SMTEncoding_Term.mkImp _173_1369))
in (((typing_pred)::[])::[], (xx)::[], _173_1370))
in (mkForall_fuel _173_1371))
in (_173_1372, Some ("string inversion"), Some ("string_inversion")))
in FStar_SMTEncoding_Term.Assume (_173_1373))
in (_173_1374)::[])
in (_173_1376)::_173_1375))))))
in (
...
<<<<<<< HEAD
let refa = (let _173_1385 = (let _173_1384 = (let _173_1383 = (FStar_SMTEncoding_Term.mkFreeV aa)
in (_173_1383)::[])
in (reft_name, _173_1384))
in (FStar_SMTEncoding_Term.mkApp _173_1385))
in (

let refb = (let _173_1388 = (let _173_1387 = (let _173_1386 = (FStar_SMTEncoding_Term.mkFreeV bb)
in (_173_1386)::[])
in (reft_name, _173_1387))
in (FStar_SMTEncoding_Term.mkApp _173_1388))
=======
...
<<<<<<< HEAD
in (let _173_1407 = (let _173_1394 = (let _173_1393 = (let _173_1392 = (let _173_1391 = (let _173_1390 = (let _173_1389 = (FStar_SMTEncoding_Term.mk_tester "BoxRef" x)
in (typing_pred, _173_1389))
in (FStar_SMTEncoding_Term.mkImp _173_1390))
in (((typing_pred)::[])::[], (xx)::(aa)::[], _173_1391))
in (mkForall_fuel _173_1392))
in (_173_1393, Some ("ref inversion"), Some ("ref_inversion")))
in FStar_SMTEncoding_Term.Assume (_173_1394))
in (let _173_1406 = (let _173_1405 = (let _173_1404 = (let _173_1403 = (let _173_1402 = (let _173_1401 = (let _173_1400 = (let _173_1399 = (FStar_SMTEncoding_Term.mkAnd (typing_pred, typing_pred_b))
in (let _173_1398 = (let _173_1397 = (let _173_1396 = (FStar_SMTEncoding_Term.mkFreeV aa)
in (let _173_1395 = (FStar_SMTEncoding_Term.mkFreeV bb)
in (_173_1396, _173_1395)))
in (FStar_SMTEncoding_Term.mkEq _173_1397))
in (_173_1399, _173_1398)))
in (FStar_SMTEncoding_Term.mkImp _173_1400))
in (((typing_pred)::(typing_pred_b)::[])::[], (xx)::(aa)::(bb)::[], _173_1401))
in (mkForall_fuel' 2 _173_1402))
in (_173_1403, Some ("ref typing is injective"), Some ("ref_injectivity")))
in FStar_SMTEncoding_Term.Assume (_173_1404))
in (_173_1405)::[])
in (_173_1407)::_173_1406))))))))))
=======
...
<<<<<<< HEAD
in (let _173_1416 = (let _173_1415 = (let _173_1414 = (FStar_SMTEncoding_Term.mkIff (FStar_SMTEncoding_Term.mkFalse, valid))
in (_173_1414, Some ("False interpretation"), Some ("false_interp")))
in FStar_SMTEncoding_Term.Assume (_173_1415))
in (_173_1416)::[])))
in (
...
<<<<<<< HEAD
let valid = (let _173_1425 = (let _173_1424 = (let _173_1423 = (FStar_SMTEncoding_Term.mkApp (conj, (a)::(b)::[]))
in (_173_1423)::[])
in ("Valid", _173_1424))
in (FStar_SMTEncoding_Term.mkApp _173_1425))
=======
...
<<<<<<< HEAD
in (let _173_1432 = (let _173_1431 = (let _173_1430 = (let _173_1429 = (let _173_1428 = (let _173_1427 = (let _173_1426 = (FStar_SMTEncoding_Term.mkAnd (valid_a, valid_b))
in (_173_1426, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1427))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1428))
in (FStar_SMTEncoding_Term.mkForall _173_1429))
in (_173_1430, Some ("/\\ interpretation"), Some ("l_and-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1431))
in (_173_1432)::[])))))))))
in (
...
<<<<<<< HEAD
let valid = (let _173_1441 = (let _173_1440 = (let _173_1439 = (FStar_SMTEncoding_Term.mkApp (disj, (a)::(b)::[]))
in (_173_1439)::[])
in ("Valid", _173_1440))
in (FStar_SMTEncoding_Term.mkApp _173_1441))
=======
...
let valid_b = (FStar_SMTEncoding_Term.mkApp ("Valid", (b)::[]))
<<<<<<< HEAD
in (let _173_1448 = (let _173_1447 = (let _173_1446 = (let _173_1445 = (let _173_1444 = (let _173_1443 = (let _173_1442 = (FStar_SMTEncoding_Term.mkOr (valid_a, valid_b))
in (_173_1442, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1443))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1444))
in (FStar_SMTEncoding_Term.mkForall _173_1445))
in (_173_1446, Some ("\\/ interpretation"), Some ("l_or-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1447))
in (_173_1448)::[])))))))))
=======
...
<<<<<<< HEAD
let valid = (let _173_1457 = (let _173_1456 = (let _173_1455 = (FStar_SMTEncoding_Term.mkApp (eq2, (a)::(b)::(x)::(y)::[]))
in (_173_1455)::[])
in ("Valid", _173_1456))
in (FStar_SMTEncoding_Term.mkApp _173_1457))
in (let _173_1464 = (let _173_1463 = (let _173_1462 = (let _173_1461 = (let _173_1460 = (let _173_1459 = (let _173_1458 = (FStar_SMTEncoding_Term.mkEq (x, y))
in (_173_1458, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1459))
in (((valid)::[])::[], (aa)::(bb)::(xx)::(yy)::[], _173_1460))
in (FStar_SMTEncoding_Term.mkForall _173_1461))
in (_173_1462, Some ("Eq2 interpretation"), Some ("eq2-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1463))
in (_173_1464)::[])))))))))))
=======
...
<<<<<<< HEAD
let valid = (let _173_1473 = (let _173_1472 = (let _173_1471 = (FStar_SMTEncoding_Term.mkApp (imp, (a)::(b)::[]))
in (_173_1471)::[])
in ("Valid", _173_1472))
in (FStar_SMTEncoding_Term.mkApp _173_1473))
=======
...
let valid_b = (FStar_SMTEncoding_Term.mkApp ("Valid", (b)::[]))
<<<<<<< HEAD
in (let _173_1480 = (let _173_1479 = (let _173_1478 = (let _173_1477 = (let _173_1476 = (let _173_1475 = (let _173_1474 = (FStar_SMTEncoding_Term.mkImp (valid_a, valid_b))
in (_173_1474, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1475))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1476))
in (FStar_SMTEncoding_Term.mkForall _173_1477))
in (_173_1478, Some ("==> interpretation"), Some ("l_imp-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1479))
in (_173_1480)::[])))))))))
=======
...
<<<<<<< HEAD
let valid = (let _173_1489 = (let _173_1488 = (let _173_1487 = (FStar_SMTEncoding_Term.mkApp (iff, (a)::(b)::[]))
in (_173_1487)::[])
in ("Valid", _173_1488))
in (FStar_SMTEncoding_Term.mkApp _173_1489))
=======
...
let valid_b = (FStar_SMTEncoding_Term.mkApp ("Valid", (b)::[]))
<<<<<<< HEAD
in (let _173_1496 = (let _173_1495 = (let _173_1494 = (let _173_1493 = (let _173_1492 = (let _173_1491 = (let _173_1490 = (FStar_SMTEncoding_Term.mkIff (valid_a, valid_b))
in (_173_1490, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1491))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1492))
in (FStar_SMTEncoding_Term.mkForall _173_1493))
in (_173_1494, Some ("<==> interpretation"), Some ("l_iff-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1495))
in (_173_1496)::[])))))))))
=======
...
<<<<<<< HEAD
let valid = (let _173_1505 = (let _173_1504 = (let _173_1503 = (FStar_SMTEncoding_Term.mkApp (for_all, (a)::(b)::[]))
in (_173_1503)::[])
in ("Valid", _173_1504))
in (FStar_SMTEncoding_Term.mkApp _173_1505))
in (

let valid_b_x = (let _173_1508 = (let _173_1507 = (let _173_1506 = (FStar_SMTEncoding_Term.mk_ApplyTT b x)
in (_173_1506)::[])
in ("Valid", _173_1507))
in (FStar_SMTEncoding_Term.mkApp _173_1508))
in (let _173_1522 = (let _173_1521 = (let _173_1520 = (let _173_1519 = (let _173_1518 = (let _173_1517 = (let _173_1516 = (let _173_1515 = (let _173_1514 = (let _173_1510 = (let _173_1509 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_173_1509)::[])
in (_173_1510)::[])
in (let _173_1513 = (let _173_1512 = (let _173_1511 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_173_1511, valid_b_x))
in (FStar_SMTEncoding_Term.mkImp _173_1512))
in (_173_1514, (xx)::[], _173_1513)))
in (FStar_SMTEncoding_Term.mkForall _173_1515))
in (_173_1516, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1517))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1518))
in (FStar_SMTEncoding_Term.mkForall _173_1519))
in (_173_1520, Some ("forall interpretation"), Some ("forall-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1521))
in (_173_1522)::[]))))))))))
=======
...
<<<<<<< HEAD
let valid = (let _173_1531 = (let _173_1530 = (let _173_1529 = (FStar_SMTEncoding_Term.mkApp (for_some, (a)::(b)::[]))
in (_173_1529)::[])
in ("Valid", _173_1530))
in (FStar_SMTEncoding_Term.mkApp _173_1531))
in (

let valid_b_x = (let _173_1534 = (let _173_1533 = (let _173_1532 = (FStar_SMTEncoding_Term.mk_ApplyTT b x)
in (_173_1532)::[])
in ("Valid", _173_1533))
in (FStar_SMTEncoding_Term.mkApp _173_1534))
in (let _173_1548 = (let _173_1547 = (let _173_1546 = (let _173_1545 = (let _173_1544 = (let _173_1543 = (let _173_1542 = (let _173_1541 = (let _173_1540 = (let _173_1536 = (let _173_1535 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_173_1535)::[])
in (_173_1536)::[])
in (let _173_1539 = (let _173_1538 = (let _173_1537 = (FStar_SMTEncoding_Term.mk_HasTypeZ x a)
in (_173_1537, valid_b_x))
in (FStar_SMTEncoding_Term.mkImp _173_1538))
in (_173_1540, (xx)::[], _173_1539)))
in (FStar_SMTEncoding_Term.mkExists _173_1541))
in (_173_1542, valid))
in (FStar_SMTEncoding_Term.mkIff _173_1543))
in (((valid)::[])::[], (aa)::(bb)::[], _173_1544))
in (FStar_SMTEncoding_Term.mkForall _173_1545))
in (_173_1546, Some ("exists interpretation"), Some ("exists-interp")))
in FStar_SMTEncoding_Term.Assume (_173_1547))
in (_173_1548)::[]))))))))))
=======
...
<<<<<<< HEAD
in (let _173_1559 = (let _173_1558 = (let _173_1557 = (FStar_SMTEncoding_Term.mk_HasTypeZ FStar_SMTEncoding_Term.mk_Range_const range_ty)
in (let _173_1556 = (let _173_1555 = (varops.fresh "typing_range_const")
in Some (_173_1555))
in (_173_1557, Some ("Range_const typing"), _173_1556)))
in FStar_SMTEncoding_Term.Assume (_173_1558))
in (_173_1559)::[])))
in (
...
(let _173_1753 = (FStar_Syntax_Print.sigelt_to_string se)
...
(match (g) with
| [] -> begin
(let _173_1756 = (let _173_1755 = (let _173_1754 = (FStar_Util.format1 "<Skipped %s/>" nm)
in FStar_SMTEncoding_Term.Caption (_173_1754))
in (_173_1755)::[])
in (_173_1756, e))
end
| _83_1955 -> begin
(let _173_1763 = (let _173_1762 = (let _173_1758 = (let _173_1757 = (FStar_Util.format1 "<Start encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (_173_1757))
in (_173_1758)::g)
in (let _173_1761 = (let _173_1760 = (let _173_1759 = (FStar_Util.format1 "</end encoding %s>" nm)
in FStar_SMTEncoding_Term.Caption (_173_1759))
in (_173_1760)::[])
in (FStar_List.append _173_1762 _173_1761)))
in (_173_1763, e))
=======
...
(let _173_1777 = (let _173_1776 = (encode_smt_lemma env lid tt)
in (FStar_List.append decls _173_1776))
in (_173_1777, env))
=======
...
let _83_1979 = (let _173_1786 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (encode_top_level_val env _173_1786 lb.FStar_Syntax_Syntax.lbtyp quals))
...
<<<<<<< HEAD
in (let _173_1789 = (let _173_1788 = (primitive_type_axioms env.tcenv lid tname tsym)
in (FStar_List.append decls _173_1788))
in (_173_1789, env))))
end)))
end)
end
...
let g = (let _173_1796 = (let _173_1795 = (let _173_1794 = (let _173_1791 = (let _173_1790 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Assumption: %s" _173_1790))
in Some (_173_1791))
in (let _173_1793 = (let _173_1792 = (varops.fresh (Prims.strcat "assumption_" l.FStar_Ident.str))
in Some (_173_1792))
in (f, _173_1794, _173_1793)))
in FStar_SMTEncoding_Term.Assume (_173_1795))
in (_173_1796)::[])
...
let lid = (let _173_1800 = (let _173_1799 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _173_1799.FStar_Syntax_Syntax.fv_name)
in _173_1800.FStar_Syntax_Syntax.v)
in if (let _173_1801 = (FStar_TypeChecker_Env.try_lookup_val_decl env.tcenv lid)
in (FStar_All.pipe_left FStar_Option.isNone _173_1801)) then begin
=======
...
<<<<<<< HEAD
let valid_b2t_x = (let _173_1804 = (let _173_1803 = (let _173_1802 = (FStar_SMTEncoding_Term.mkApp ("Prims.b2t", (x)::[]))
in (_173_1802)::[])
in ("Valid", _173_1803))
in (FStar_SMTEncoding_Term.mkApp _173_1804))
in (

let decls = (let _173_1812 = (let _173_1811 = (let _173_1810 = (let _173_1809 = (let _173_1808 = (let _173_1807 = (let _173_1806 = (let _173_1805 = (FStar_SMTEncoding_Term.mkApp ("BoxBool_proj_0", (x)::[]))
in (valid_b2t_x, _173_1805))
in (FStar_SMTEncoding_Term.mkEq _173_1806))
in (((valid_b2t_x)::[])::[], (xx)::[], _173_1807))
in (FStar_SMTEncoding_Term.mkForall _173_1808))
in (_173_1809, Some ("b2t def"), Some ("b2t_def")))
in FStar_SMTEncoding_Term.Assume (_173_1810))
in (_173_1811)::[])
in (FStar_SMTEncoding_Term.DeclFun ((tname, (FStar_SMTEncoding_Term.Term_sort)::[], FStar_SMTEncoding_Term.Term_sort, None)))::_173_1812)
in (decls, env)))))
end))
end
...
(let _173_1826 = (let _173_1825 = (FStar_Syntax_Syntax.bv_to_name binder)
in (formal, _173_1825))
in FStar_Syntax_Syntax.NT (_173_1826))
end)) formals binders)
in (

let extra_formals = (let _173_1830 = (FStar_All.pipe_right extra_formals (FStar_List.map (fun _83_2170 -> (match (_83_2170) with
| (x, i) -> begin
(let _173_1829 = (

let _83_2171 = x
in (let _173_1828 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _83_2171.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _83_2171.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _173_1828}))
in (_173_1829, i))
end))))
in (FStar_All.pipe_right _173_1830 FStar_Syntax_Util.name_binders))
in (

let body = (let _173_1837 = (FStar_Syntax_Subst.compress body)
in (let _173_1836 = (let _173_1831 = (FStar_Syntax_Util.args_of_binders extra_formals)
in (FStar_All.pipe_left Prims.snd _173_1831))
in (let _173_1835 = (let _173_1834 = (let _173_1833 = (FStar_Syntax_Subst.subst subst t)
in _173_1833.FStar_Syntax_Syntax.n)
in (FStar_All.pipe_left (fun _173_1832 -> Some (_173_1832)) _173_1834))
in (FStar_Syntax_Syntax.extend_app_n _173_1837 _173_1836 _173_1835 body.FStar_Syntax_Syntax.pos))))
=======
...
<<<<<<< HEAD
let rec aux = (fun norm t_norm -> (match ((let _173_1848 = (FStar_Syntax_Util.unascribe e)
in _173_1848.FStar_Syntax_Syntax.n)) with
...
(let _173_1853 = (let _173_1852 = (FStar_Syntax_Syntax.bv_to_name x)
in (b, _173_1852))
in FStar_Syntax_Syntax.NT (_173_1853))
=======
...
<<<<<<< HEAD
| _83_2228 -> begin
(let _173_1856 = (let _173_1855 = (FStar_Syntax_Print.term_to_string e)
in (let _173_1854 = (FStar_Syntax_Print.term_to_string t_norm)
in (FStar_Util.format3 "Impossible! let-bound lambda %s = %s has a type that\'s not a function: %s\n" flid.FStar_Ident.str _173_1855 _173_1854)))
in (FStar_All.failwith _173_1856))
end)
end))
end
| _83_2230 -> begin
(match ((let _173_1857 = (FStar_Syntax_Subst.compress t_norm)
in _173_1857.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (formals, c) -> begin
(
...
<<<<<<< HEAD
let _83_2266 = (let _173_1862 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (declare_top_level_let env _173_1862 lb.FStar_Syntax_Syntax.lbtyp t_norm))
in (match (_83_2266) with
| (tok, decl, env) -> begin
(let _173_1865 = (let _173_1864 = (let _173_1863 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (_173_1863, tok))
in (_173_1864)::toks)
in (_173_1865, (t_norm)::typs, (decl)::decls, env))
end))))
end)) ([], [], [], env)))
...
| _83_2278 -> begin
false
end)))) || (FStar_All.pipe_right typs (FStar_Util.for_some (fun t -> (let _173_1868 = (FStar_Syntax_Util.is_pure_or_ghost_function t)
in (FStar_All.pipe_left Prims.op_Negation _173_1868)))))) then begin
=======
| _83_2276 -> begin
false
...
<<<<<<< HEAD
| _83_2318 -> begin
(let _173_1870 = (let _173_1869 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV vars)
in (f, _173_1869))
in (FStar_SMTEncoding_Term.mkApp _173_1870))
end)
in (

let _83_2324 = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Logic)) then begin
(let _173_1872 = (FStar_SMTEncoding_Term.mk_Valid app)
in (let _173_1871 = (encode_formula body env')
in (_173_1872, _173_1871)))
end else begin
(let _173_1873 = (encode_term body env')
in (app, _173_1873))
end
...
let eqn = (let _173_1879 = (let _173_1878 = (let _173_1875 = (let _173_1874 = (FStar_SMTEncoding_Term.mkEq (app, body))
in (((app)::[])::[], vars, _173_1874))
in (FStar_SMTEncoding_Term.mkForall _173_1875))
in (let _173_1877 = (let _173_1876 = (FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str)
in Some (_173_1876))
in (_173_1878, _173_1877, Some ((Prims.strcat "equation_" f)))))
in FStar_SMTEncoding_Term.Assume (_173_1879))
in (let _173_1881 = (let _173_1880 = (primitive_type_axioms env.tcenv flid f app)
in (FStar_List.append (FStar_List.append (FStar_List.append (FStar_List.append decls binder_decls) decls2) ((eqn)::[])) _173_1880))
in (_173_1881, env)))
=======
| _83_2316 -> begin
...
<<<<<<< HEAD
let fuel = (let _173_1882 = (varops.fresh "fuel")
in (_173_1882, FStar_SMTEncoding_Term.Fuel_sort))
=======
...
<<<<<<< HEAD
let env = (let _173_1887 = (let _173_1886 = (FStar_SMTEncoding_Term.mkApp (g, (fuel_tm)::[]))
in (FStar_All.pipe_left (fun _173_1885 -> Some (_173_1885)) _173_1886))
in (push_free_var env flid gtok _173_1887))
...
let decl_g = (let _173_1898 = (let _173_1897 = (let _173_1896 = (FStar_List.map Prims.snd vars)
in (FStar_SMTEncoding_Term.Fuel_sort)::_173_1896)
in (g, _173_1897, FStar_SMTEncoding_Term.Term_sort, Some ("Fuel-instrumented function name")))
in FStar_SMTEncoding_Term.DeclFun (_173_1898))
=======
...
<<<<<<< HEAD
let gsapp = (let _173_1901 = (let _173_1900 = (let _173_1899 = (FStar_SMTEncoding_Term.mkApp ("SFuel", (fuel_tm)::[]))
in (_173_1899)::vars_tm)
in (g, _173_1900))
in (FStar_SMTEncoding_Term.mkApp _173_1901))
in (

let gmax = (let _173_1904 = (let _173_1903 = (let _173_1902 = (FStar_SMTEncoding_Term.mkApp ("MaxFuel", []))
in (_173_1902)::vars_tm)
in (g, _173_1903))
in (FStar_SMTEncoding_Term.mkApp _173_1904))
in (
...
let eqn_g = (let _173_1910 = (let _173_1909 = (let _173_1906 = (let _173_1905 = (FStar_SMTEncoding_Term.mkEq (gsapp, body_tm))
in (((gsapp)::[])::[], (fuel)::vars, _173_1905))
in (FStar_SMTEncoding_Term.mkForall _173_1906))
in (let _173_1908 = (let _173_1907 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Ident.str)
in Some (_173_1907))
in (_173_1909, _173_1908, Some ((Prims.strcat "equation_with_fuel_" g)))))
in FStar_SMTEncoding_Term.Assume (_173_1910))
in (

let eqn_f = (let _173_1914 = (let _173_1913 = (let _173_1912 = (let _173_1911 = (FStar_SMTEncoding_Term.mkEq (app, gmax))
in (((app)::[])::[], vars, _173_1911))
in (FStar_SMTEncoding_Term.mkForall _173_1912))
in (_173_1913, Some ("Correspondence of recursive function to instrumented version"), Some ((Prims.strcat "fuel_correspondence_" g))))
in FStar_SMTEncoding_Term.Assume (_173_1914))
in (

let eqn_g' = (let _173_1923 = (let _173_1922 = (let _173_1921 = (let _173_1920 = (let _173_1919 = (let _173_1918 = (let _173_1917 = (let _173_1916 = (let _173_1915 = (FStar_SMTEncoding_Term.n_fuel 0)
in (_173_1915)::vars_tm)
in (g, _173_1916))
in (FStar_SMTEncoding_Term.mkApp _173_1917))
in (gsapp, _173_1918))
in (FStar_SMTEncoding_Term.mkEq _173_1919))
in (((gsapp)::[])::[], (fuel)::vars, _173_1920))
in (FStar_SMTEncoding_Term.mkForall _173_1921))
in (_173_1922, Some ("Fuel irrelevance"), Some ((Prims.strcat "fuel_irrelevance_" g))))
in FStar_SMTEncoding_Term.Assume (_173_1923))
in (
...
<<<<<<< HEAD
let tok_app = (let _173_1924 = (FStar_SMTEncoding_Term.mkFreeV (gtok, FStar_SMTEncoding_Term.Term_sort))
in (mk_Apply _173_1924 ((fuel)::vars)))
in (let _173_1928 = (let _173_1927 = (let _173_1926 = (let _173_1925 = (FStar_SMTEncoding_Term.mkEq (tok_app, gapp))
in (((tok_app)::[])::[], (fuel)::vars, _173_1925))
in (FStar_SMTEncoding_Term.mkForall _173_1926))
in (_173_1927, Some ("Fuel token correspondence"), Some ((Prims.strcat "fuel_tokem_correspondence_" gtok))))
in FStar_SMTEncoding_Term.Assume (_173_1928)))
in (
...
| (g_typing, d3) -> begin
(let _173_1936 = (let _173_1935 = (let _173_1934 = (let _173_1933 = (let _173_1932 = (let _173_1931 = (let _173_1930 = (let _173_1929 = (FStar_SMTEncoding_Term.mk_and_l v_guards)
in (_173_1929, g_typing))
in (FStar_SMTEncoding_Term.mkImp _173_1930))
in (((gapp)::[])::[], (fuel)::vars, _173_1931))
in (FStar_SMTEncoding_Term.mkForall _173_1932))
in (_173_1933, Some ("Typing correspondence of token to term"), Some ((Prims.strcat "token_correspondence_" g))))
in FStar_SMTEncoding_Term.Assume (_173_1934))
in (_173_1935)::[])
in (d3, _173_1936))
end))
...
<<<<<<< HEAD
let _83_2426 = (let _173_1939 = (FStar_List.zip3 gtoks typs bindings)
...
end)) ((decls)::[], [], env0) _173_1939))
in (match (_83_2426) with
| (decls, eqns, env0) -> begin
(

let _83_2435 = (let _173_1941 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _173_1941 (FStar_List.partition (fun _83_17 -> (match (_83_17) with
...
<<<<<<< HEAD
let msg = (let _173_1944 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right _173_1944 (FStar_String.concat " and ")))
=======
...
(let _173_1952 = (let _173_1951 = (let _173_1950 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in (name, _173_1950, FStar_SMTEncoding_Term.Term_sort, None))
in FStar_SMTEncoding_Term.DeclFun (_173_1951))
in (_173_1952)::[])
=======
let _83_2499 = c
...
<<<<<<< HEAD
let inversion_axioms = (fun tapp vars -> if (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _173_1958 = (FStar_TypeChecker_Env.try_lookup_lid env.tcenv l)
in (FStar_All.pipe_right _173_1958 FStar_Option.isNone))))) then begin
=======
...
let indices = (match ((let _173_1961 = (FStar_Syntax_Subst.compress res)
in _173_1961.FStar_Syntax_Syntax.n)) with
...
| (x, _83_2531) -> begin
(let _173_1966 = (let _173_1965 = (let _173_1964 = (mk_term_projector_name l x)
in (_173_1964, (xx)::[]))
in (FStar_SMTEncoding_Term.mkApp _173_1965))
in (push_term_var env x _173_1966))
end)) env))
in (
...
<<<<<<< HEAD
let eqs = (let _173_1971 = (FStar_List.map2 (fun v a -> (let _173_1970 = (let _173_1969 = (FStar_SMTEncoding_Term.mkFreeV v)
in (_173_1969, a))
in (FStar_SMTEncoding_Term.mkEq _173_1970))) vars indices)
in (FStar_All.pipe_right _173_1971 FStar_SMTEncoding_Term.mk_and_l))
in (let _173_1976 = (let _173_1975 = (let _173_1974 = (let _173_1973 = (let _173_1972 = (mk_data_tester env l xx)
in (_173_1972, eqs))
in (FStar_SMTEncoding_Term.mkAnd _173_1973))
in (out, _173_1974))
in (FStar_SMTEncoding_Term.mkOr _173_1975))
in (_173_1976, (FStar_List.append decls decls')))))
=======
...
<<<<<<< HEAD
(let _173_1977 = (FStar_SMTEncoding_Term.mkApp ("SFuel", (ff)::[]))
in (FStar_SMTEncoding_Term.mk_HasTypeFuel _173_1977 xx tapp))
end else begin
(FStar_SMTEncoding_Term.mk_HasTypeFuel ff xx tapp)
end
in (let _173_1984 = (let _173_1983 = (let _173_1980 = (let _173_1979 = (add_fuel (ffsym, FStar_SMTEncoding_Term.Fuel_sort) (((xxsym, FStar_SMTEncoding_Term.Term_sort))::vars))
in (let _173_1978 = (FStar_SMTEncoding_Term.mkImp (xx_has_type_sfuel, data_ax))
in (((xx_has_type_sfuel)::[])::[], _173_1979, _173_1978)))
in (FStar_SMTEncoding_Term.mkForall _173_1980))
in (let _173_1982 = (let _173_1981 = (varops.fresh (Prims.strcat "fuel_guarded_inversion_" t.FStar_Ident.str))
in Some (_173_1981))
...
<<<<<<< HEAD
in (let _173_1992 = (let _173_1991 = (let _173_1990 = (let _173_1987 = (let _173_1986 = (add_fuel (ffsym, FStar_SMTEncoding_Term.Fuel_sort) (((xxsym, FStar_SMTEncoding_Term.Term_sort))::vars))
in (let _173_1985 = (FStar_SMTEncoding_Term.mkImp (xx_has_type_fuel, data_ax))
in (((xx_has_type_fuel)::(pattern_guard)::[])::[], _173_1986, _173_1985)))
in (FStar_SMTEncoding_Term.mkForall _173_1987))
in (let _173_1989 = (let _173_1988 = (varops.fresh (Prims.strcat "pattern_guarded_inversion_" t.FStar_Ident.str))
in Some (_173_1988))
in (_173_1990, Some ("inversion axiom"), _173_1989)))
in FStar_SMTEncoding_Term.Assume (_173_1991))
in (_173_1992)::[])))
=======
...
<<<<<<< HEAD
let _83_2561 = (match ((let _173_1993 = (FStar_Syntax_Subst.compress k)
in _173_1993.FStar_Syntax_Syntax.n)) with
...
<<<<<<< HEAD
let tapp = (let _173_1995 = (let _173_1994 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV vars)
in (tname, _173_1994))
in (FStar_SMTEncoding_Term.mkApp _173_1995))
in (

let _83_2596 = (

let tname_decl = (let _173_1999 = (let _173_1998 = (FStar_All.pipe_right vars (FStar_List.map (fun _83_2581 -> (match (_83_2581) with
| (n, s) -> begin
((Prims.strcat tname n), s)
end))))
in (let _173_1997 = (varops.next_id ())
in (tname, _173_1998, FStar_SMTEncoding_Term.Term_sort, _173_1997, false)))
in (constructor_or_logic_type_decl _173_1999))
in (

let _83_2593 = (match (vars) with
| [] -> begin
(let _173_2003 = (let _173_2002 = (let _173_2001 = (FStar_SMTEncoding_Term.mkApp (tname, []))
in (FStar_All.pipe_left (fun _173_2000 -> Some (_173_2000)) _173_2001))
in (push_free_var env t tname _173_2002))
in ([], _173_2003))
end
| _83_2585 -> begin
=======
...
<<<<<<< HEAD
let ttok_fresh = (let _173_2004 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token (ttok, FStar_SMTEncoding_Term.Term_sort) _173_2004))
=======
...
<<<<<<< HEAD
let name_tok_corr = (let _173_2008 = (let _173_2007 = (let _173_2006 = (let _173_2005 = (FStar_SMTEncoding_Term.mkEq (ttok_app, tapp))
in (pats, None, vars, _173_2005))
in (FStar_SMTEncoding_Term.mkForall' _173_2006))
in (_173_2007, Some ("name-token correspondence"), Some ((Prims.strcat "token_correspondence_" ttok))))
...
<<<<<<< HEAD
(let _173_2012 = (let _173_2011 = (let _173_2010 = (let _173_2009 = (FStar_SMTEncoding_Term.mk_PreType ttok_tm)
in (FStar_SMTEncoding_Term.mk_tester "Tm_arrow" _173_2009))
in (_173_2010, Some ("kinding"), Some ((Prims.strcat "pre_kinding_" ttok))))
in FStar_SMTEncoding_Term.Assume (_173_2011))
in (_173_2012)::[])
end else begin
[]
end
in (let _173_2018 = (let _173_2017 = (let _173_2016 = (let _173_2015 = (let _173_2014 = (let _173_2013 = (FStar_SMTEncoding_Term.mkImp (guard, k))
in (((tapp)::[])::[], vars, _173_2013))
in (FStar_SMTEncoding_Term.mkForall _173_2014))
in (_173_2015, None, Some ((Prims.strcat "kinding_" ttok))))
in FStar_SMTEncoding_Term.Assume (_173_2016))
in (_173_2017)::[])
in (FStar_List.append (FStar_List.append decls karr) _173_2018)))
end))
in (

let aux = (let _173_2022 = (let _173_2019 = (inversion_axioms tapp vars)
in (FStar_List.append kindingAx _173_2019))
in (let _173_2021 = (let _173_2020 = (pretype_axiom tapp vars)
in (_173_2020)::[])
in (FStar_List.append _173_2022 _173_2021)))
=======
...
let projectors = (FStar_All.pipe_right names (FStar_List.map (fun x -> (let _173_2024 = (mk_term_projector_name d x)
in (_173_2024, FStar_SMTEncoding_Term.Term_sort)))))
in (

let datacons = (let _173_2026 = (let _173_2025 = (varops.next_id ())
in (ddconstrsym, projectors, FStar_SMTEncoding_Term.Term_sort, _173_2025, true))
in (FStar_All.pipe_right _173_2026 FStar_SMTEncoding_Term.constructor_to_decl))
=======
...
<<<<<<< HEAD
| _83_2677 -> begin
(let _173_2028 = (let _173_2027 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token (ddtok, FStar_SMTEncoding_Term.Term_sort) _173_2027))
in (_173_2028)::[])
end)
in (
...
| (head, args) -> begin
(match ((let _173_2031 = (FStar_Syntax_Subst.compress head)
in _173_2031.FStar_Syntax_Syntax.n)) with
=======
| _83_2675 -> begin
...
let _83_2711 = (let _173_2034 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in (gen_term_var env _173_2034))
in (match (_83_2711) with
| (_83_2708, xv, env) -> begin
(let _173_2036 = (let _173_2035 = (FStar_SMTEncoding_Term.mkEq (arg, xv))
in (_173_2035)::eqns)
in (env, (xv)::arg_vars, _173_2036))
end))
...
<<<<<<< HEAD
let typing_inversion = (let _173_2043 = (let _173_2042 = (let _173_2041 = (let _173_2040 = (add_fuel (fuel_var, FStar_SMTEncoding_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _173_2039 = (let _173_2038 = (let _173_2037 = (FStar_SMTEncoding_Term.mk_and_l (FStar_List.append eqns guards))
in (ty_pred, _173_2037))
in (FStar_SMTEncoding_Term.mkImp _173_2038))
in (((ty_pred)::[])::[], _173_2040, _173_2039)))
in (FStar_SMTEncoding_Term.mkForall _173_2041))
in (_173_2042, Some ("data constructor typing elim"), Some ((Prims.strcat "data_elim_" ddconstrsym))))
in FStar_SMTEncoding_Term.Assume (_173_2043))
=======
...
<<<<<<< HEAD
let x = (let _173_2044 = (varops.fresh "x")
in (_173_2044, FStar_SMTEncoding_Term.Term_sort))
in (

let xtm = (FStar_SMTEncoding_Term.mkFreeV x)
in (let _173_2056 = (let _173_2055 = (let _173_2052 = (let _173_2051 = (let _173_2046 = (let _173_2045 = (FStar_SMTEncoding_Term.mk_Precedes xtm dapp)
in (_173_2045)::[])
in (_173_2046)::[])
in (let _173_2050 = (let _173_2049 = (let _173_2048 = (FStar_SMTEncoding_Term.mk_tester "LexCons" xtm)
in (let _173_2047 = (FStar_SMTEncoding_Term.mk_Precedes xtm dapp)
in (_173_2048, _173_2047)))
in (FStar_SMTEncoding_Term.mkImp _173_2049))
in (_173_2051, (x)::[], _173_2050)))
in (FStar_SMTEncoding_Term.mkForall _173_2052))
in (let _173_2054 = (let _173_2053 = (varops.fresh "lextop")
in Some (_173_2053))
in (_173_2055, Some ("lextop is top"), _173_2054)))
in FStar_SMTEncoding_Term.Assume (_173_2056))))
=======
...
<<<<<<< HEAD
(let _173_2059 = (let _173_2058 = (FStar_SMTEncoding_Term.mkFreeV v)
in (FStar_SMTEncoding_Term.mk_Precedes _173_2058 dapp))
in (_173_2059)::[])
end
| _83_2730 -> begin
(FStar_All.failwith "unexpected sort")
end))))
in (let _173_2066 = (let _173_2065 = (let _173_2064 = (let _173_2063 = (add_fuel (fuel_var, FStar_SMTEncoding_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _173_2062 = (let _173_2061 = (let _173_2060 = (FStar_SMTEncoding_Term.mk_and_l prec)
in (ty_pred, _173_2060))
in (FStar_SMTEncoding_Term.mkImp _173_2061))
in (((ty_pred)::[])::[], _173_2063, _173_2062)))
in (FStar_SMTEncoding_Term.mkForall _173_2064))
in (_173_2065, Some ("subterm ordering"), Some ((Prims.strcat "subterm_ordering_" ddconstrsym))))
in FStar_SMTEncoding_Term.Assume (_173_2066)))
=======
...
let _83_2735 = (let _173_2069 = (let _173_2068 = (FStar_Syntax_Print.lid_to_string d)
in (let _173_2067 = (FStar_Syntax_Print.term_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _173_2068 _173_2067)))
in (FStar_TypeChecker_Errors.warn drange _173_2069))
=======
| _83_2732 -> begin
(
...
let g = (let _173_2094 = (let _173_2093 = (let _173_2078 = (let _173_2077 = (let _173_2076 = (let _173_2075 = (let _173_2074 = (let _173_2073 = (let _173_2072 = (let _173_2071 = (let _173_2070 = (FStar_Syntax_Print.lid_to_string d)
in (FStar_Util.format1 "data constructor proxy: %s" _173_2070))
in Some (_173_2071))
in (ddtok, [], FStar_SMTEncoding_Term.Term_sort, _173_2072))
in FStar_SMTEncoding_Term.DeclFun (_173_2073))
in (_173_2074)::[])
in (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls2) decls3) _173_2075))
in (FStar_List.append _173_2076 proxy_fresh))
in (FStar_List.append _173_2077 decls_formals))
in (FStar_List.append _173_2078 decls_pred))
in (let _173_2092 = (let _173_2091 = (let _173_2090 = (let _173_2082 = (let _173_2081 = (let _173_2080 = (let _173_2079 = (FStar_SMTEncoding_Term.mkEq (app, dapp))
in (((app)::[])::[], vars, _173_2079))
in (FStar_SMTEncoding_Term.mkForall _173_2080))
in (_173_2081, Some ("equality for proxy"), Some ((Prims.strcat "equality_tok_" ddtok))))
in FStar_SMTEncoding_Term.Assume (_173_2082))
in (let _173_2089 = (let _173_2088 = (let _173_2087 = (let _173_2086 = (let _173_2085 = (let _173_2084 = (add_fuel (fuel_var, FStar_SMTEncoding_Term.Fuel_sort) vars')
in (let _173_2083 = (FStar_SMTEncoding_Term.mkImp (guard', ty_pred'))
in (((ty_pred')::[])::[], _173_2084, _173_2083)))
in (FStar_SMTEncoding_Term.mkForall _173_2085))
in (_173_2086, Some ("data constructor typing intro"), Some ((Prims.strcat "data_typing_intro_" ddtok))))
in FStar_SMTEncoding_Term.Assume (_173_2087))
in (_173_2088)::[])
in (_173_2090)::_173_2089))
in (FStar_SMTEncoding_Term.Assume ((tok_typing, Some ("typing for data constructor proxy"), Some ((Prims.strcat "typing_tok_" ddtok)))))::_173_2091)
in (FStar_List.append _173_2093 _173_2092)))
in (FStar_List.append _173_2094 elim))
=======
...
let lid = fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
<<<<<<< HEAD
in if ((let _173_2107 = (FStar_Syntax_Util.is_pure_or_ghost_function t_norm)
in (FStar_All.pipe_left Prims.op_Negation _173_2107)) || (FStar_Syntax_Util.is_lemma t_norm)) then begin
(
...
let arg_sorts = (match ((let _173_2108 = (FStar_Syntax_Subst.compress t_norm)
in _173_2108.FStar_Syntax_Syntax.n)) with
...
(let _173_2110 = (FStar_TypeChecker_Util.pure_or_ghost_pre_and_post env.tcenv comp)
in (args, _173_2110))
=======
let _83_2798 = (
...
in (let _173_2127 = (let _173_2126 = (let _173_2125 = (let _173_2124 = (let _173_2123 = (let _173_2122 = (let _173_2121 = (let _173_2120 = (FStar_SMTEncoding_Term.mk_tester (escape d.FStar_Ident.str) xx)
in (FStar_All.pipe_left FStar_SMTEncoding_Term.boxBool _173_2120))
in (vapp, _173_2121))
in (FStar_SMTEncoding_Term.mkEq _173_2122))
in (((vapp)::[])::[], vars, _173_2123))
in (FStar_SMTEncoding_Term.mkForall _173_2124))
in (_173_2125, Some ("Discriminator equation"), Some ((Prims.strcat "disc_equation_" (escape d.FStar_Ident.str)))))
in FStar_SMTEncoding_Term.Assume (_173_2126))
in (_173_2127)::[]))
=======
...
<<<<<<< HEAD
in (let _173_2132 = (let _173_2131 = (let _173_2130 = (let _173_2129 = (let _173_2128 = (FStar_SMTEncoding_Term.mkEq (vapp, prim_app))
in (((vapp)::[])::[], vars, _173_2128))
in (FStar_SMTEncoding_Term.mkForall _173_2129))
in (_173_2130, Some ("Projector equation"), Some ((Prims.strcat "proj_equation_" tp_name))))
in FStar_SMTEncoding_Term.Assume (_173_2131))
in (_173_2132)::[])))))
end))
end
| _83_2841 -> begin
...
| None -> begin
(let _173_2133 = (FStar_SMTEncoding_Term.mk_and_l guards)
in (_173_2133, decls1))
=======
...
| (g, ds) -> begin
(let _173_2134 = (FStar_SMTEncoding_Term.mk_and_l ((g)::guards))
in (_173_2134, (FStar_List.append decls1 ds)))
end))
end)
...
<<<<<<< HEAD
let vapp = (let _173_2136 = (let _173_2135 = (FStar_List.map FStar_SMTEncoding_Term.mkFreeV vars)
in (vname, _173_2135))
in (FStar_SMTEncoding_Term.mkApp _173_2136))
in (

let _83_2881 = (

let vname_decl = (let _173_2139 = (let _173_2138 = (FStar_All.pipe_right formals (FStar_List.map (fun _83_2860 -> FStar_SMTEncoding_Term.Term_sort)))
in (vname, _173_2138, FStar_SMTEncoding_Term.Term_sort, None))
in FStar_SMTEncoding_Term.DeclFun (_173_2139))
in (
...
| [] -> begin
(let _173_2143 = (let _173_2142 = (let _173_2141 = (FStar_SMTEncoding_Term.mkFreeV (vname, FStar_SMTEncoding_Term.Term_sort))
in (FStar_All.pipe_left (fun _173_2140 -> Some (_173_2140)) _173_2141))
in (push_free_var env lid vname _173_2142))
in ((FStar_List.append decls2 ((tok_typing)::[])), _173_2143))
end
| _83_2872 -> begin
=======
...
<<<<<<< HEAD
let vtok_fresh = (let _173_2144 = (varops.next_id ())
in (FStar_SMTEncoding_Term.fresh_token (vtok, FStar_SMTEncoding_Term.Term_sort) _173_2144))
in (

let name_tok_corr = (let _173_2148 = (let _173_2147 = (let _173_2146 = (let _173_2145 = (FStar_SMTEncoding_Term.mkEq (vtok_app, vapp))
in (((vtok_app)::[])::[], vars, _173_2145))
in (FStar_SMTEncoding_Term.mkForall _173_2146))
in (_173_2147, Some ("Name-token correspondence"), Some ((Prims.strcat "token_correspondence_" vname))))
in FStar_SMTEncoding_Term.Assume (_173_2148))
...
(let _173_2149 = (FStar_SMTEncoding_Term.mk_HasType vapp encoded_res_t)
in (encoded_res_t, _173_2149, decls))
end)))
in (match (_83_2889) with
| (encoded_res_t, ty_pred, decls3) -> begin
(

let typingAx = (let _173_2153 = (let _173_2152 = (let _173_2151 = (let _173_2150 = (FStar_SMTEncoding_Term.mkImp (guard, ty_pred))
in (((vapp)::[])::[], vars, _173_2150))
in (FStar_SMTEncoding_Term.mkForall _173_2151))
in (_173_2152, Some ("free var typing"), Some ((Prims.strcat "typing_" vname))))
in FStar_SMTEncoding_Term.Assume (_173_2153))
in (

let freshness = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.New)) then begin
(let _173_2159 = (let _173_2156 = (let _173_2155 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (let _173_2154 = (varops.next_id ())
in (vname, _173_2155, FStar_SMTEncoding_Term.Term_sort, _173_2154)))
in (FStar_SMTEncoding_Term.fresh_constructor _173_2156))
in (let _173_2158 = (let _173_2157 = (pretype_axiom vapp vars)
in (_173_2157)::[])
in (_173_2159)::_173_2158))
=======
...
<<<<<<< HEAD
let g = (let _173_2161 = (let _173_2160 = (mk_disc_proj_axioms guard encoded_res_t vapp vars)
in (typingAx)::_173_2160)
in (FStar_List.append (FStar_List.append (FStar_List.append (FStar_List.append decls1 decls2) decls3) freshness) _173_2161))
=======
...
(let _173_2176 = (FStar_Syntax_Print.bv_to_string x)
in (let _173_2175 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _173_2174 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" _173_2176 _173_2175 _173_2174))))
=======
...
let caption = if (FStar_Options.log_queries ()) then begin
<<<<<<< HEAD
(let _173_2180 = (let _173_2179 = (FStar_Syntax_Print.bv_to_string x)
in (let _173_2178 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _173_2177 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _173_2179 _173_2178 _173_2177))))
in Some (_173_2180))
=======
...
(let _173_2188 = (FStar_All.pipe_left (fun _173_2184 -> FStar_SMTEncoding_Term.Echo (_173_2184)) (Prims.fst l))
in (let _173_2187 = (let _173_2186 = (let _173_2185 = (FStar_SMTEncoding_Term.mkFreeV l)
in FStar_SMTEncoding_Term.Eval (_173_2185))
in (_173_2186)::[])
in (_173_2188)::_173_2187))
=======
...
<<<<<<< HEAD
let init_env : FStar_TypeChecker_Env.env  ->  Prims.unit = (fun tcenv -> (let _173_2193 = (let _173_2192 = (let _173_2191 = (FStar_Util.smap_create 100)
in {bindings = []; depth = 0; tcenv = tcenv; warn = true; cache = _173_2191; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_173_2192)::[])
in (FStar_ST.op_Colon_Equals last_env _173_2193)))
=======
...
<<<<<<< HEAD
let _83_3021 = (let _173_2214 = (pop_env ())
in (FStar_All.pipe_left Prims.ignore _173_2214))
in (
...
<<<<<<< HEAD
(let _173_2230 = (let _173_2229 = (let _173_2228 = (let _173_2227 = (let _173_2226 = (FStar_Syntax_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _173_2226 (FStar_List.map FStar_Syntax_Print.lid_to_string)))
in (FStar_All.pipe_right _173_2227 (FStar_String.concat ", ")))
in (Prims.strcat "encoding sigelt " _173_2228))
in FStar_SMTEncoding_Term.Caption (_173_2229))
in (_173_2230)::decls)
=======
...
in (let _173_2231 = (caption decls)
in (FStar_SMTEncoding_Z3.giveZ3 _173_2231)))
=======
...
(let _173_2236 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Syntax_Syntax.exports) FStar_Util.string_of_int)
...
<<<<<<< HEAD
let _83_3086 = (aux rest)
in (match (_83_3086) with
=======
...
<<<<<<< HEAD
in (let _173_2258 = (let _173_2257 = (FStar_Syntax_Syntax.mk_binder (

let _83_3088 = x
in {FStar_Syntax_Syntax.ppname = _83_3088.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _83_3088.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}))
in (_173_2257)::out)
in (_173_2258, rest)))
end))
end
...
<<<<<<< HEAD
let _83_3094 = (aux bindings)
in (match (_83_3094) with
| (closing, bindings) -> begin
(let _173_2259 = (FStar_Syntax_Util.close_forall (FStar_List.rev closing) q)
in (_173_2259, bindings))
end)))
in (match (_83_3097) with
| (q, bindings) -> begin
(

let _83_3106 = (let _173_2261 = (FStar_List.filter (fun _83_22 -> (match (_83_22) with
| FStar_TypeChecker_Env.Binding_sig (_83_3100) -> begin
false
end
| _83_3103 -> begin
true
end)) bindings)
in (encode_env_bindings env _173_2261))
in (match (_83_3106) with
| (env_decls, env) -> begin
(

let _83_3107 = if ((FStar_TypeChecker_Env.debug tcenv FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug tcenv) (FStar_Options.Other ("SMTEncoding")))) then begin
(let _173_2262 = (FStar_Syntax_Print.term_to_string q)
...
<<<<<<< HEAD
let _83_3111 = (encode_formula q env)
in (match (_83_3111) with
| (phi, qdecls) -> begin
(

let _83_3116 = (let _173_2263 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_SMTEncoding_ErrorReporting.label_goals use_env_msg _173_2263 phi))
in (match (_83_3116) with
| (phi, labels, _83_3115) -> begin
(

let _83_3119 = (encode_labels labels)
...
<<<<<<< HEAD
let qry = (let _173_2267 = (let _173_2266 = (FStar_SMTEncoding_Term.mkNot phi)
in (let _173_2265 = (let _173_2264 = (varops.fresh "@query")
in Some (_173_2264))
in (_173_2266, Some ("query"), _173_2265)))
in FStar_SMTEncoding_Term.Assume (_173_2267))
=======
...
let _83_3132 = (pop "query")
in (match (f.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.True, _83_3136) -> begin
true
end
| _83_3140 -> begin
=======
