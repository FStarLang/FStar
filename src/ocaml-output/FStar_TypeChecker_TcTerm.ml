      ...
      (let top = FStar_Syntax_Subst.compress e in
                 ...
                 | (expected_c1,uu____2234,g) ->
                     ...
                     (match uu____2239 with
                      | (e2,c',g') ->
                          let uu____2256 =
                            let uu____2263 =
                              let uu____2268 = c'.FStar_Syntax_Syntax.comp () in
                              (e2, uu____2268) in
                               ...
                               let uu____2464 =
                                 let uu____2471 =
                                   FStar_Syntax_Syntax.mk
                                     ...
                                     FStar_Pervasives_Native.None
                                     top.FStar_Syntax_Syntax.pos in
                                 comp_check_expected_typ env1 uu____2471 c1 in
           ...
           (match uu____2726 with
            | (unary_op,uu____2748) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (unary_op, [a]))
                    FStar_Pervasives_Native.None uu____2772 in
                let t =
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (head1, rest1))
                    FStar_Pervasives_Native.None top.FStar_Syntax_Syntax.pos in
       ...
       | FStar_Syntax_Syntax.Tm_app
           ...
           (if FStar_Option.isSome aqual
            ...
            (let uu____2844 =
               let uu____2851 = FStar_TypeChecker_Env.clear_expected_typ env1 in
               match uu____2851 with | (env0,uu____2865) -> tc_term env0 e1 in
                 ...
                 (match uu____2879 with
                  | (reify_op,uu____2901) ->
                      let u_c =
                        ...
                        | (uu____2930,c',uu____2932) ->
                            ...
                            (match uu____2933 with
                             ...
                             | uu____2938 ->
                                 let uu____2939 = FStar_Syntax_Util.type_u () in
                      ...
                      let repr =
                        ...
                        FStar_TypeChecker_Env.reify_comp env1 uu____2956 u_c in
                      let e3 =
                        FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                             (reify_op, [(e2, aqual)]))
                          ...
                          top.FStar_Syntax_Syntax.pos in
                      let c1 =
                        let uu____2977 = FStar_Syntax_Syntax.mk_Total repr in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           ...
           let env2 =
             let uu____3514 =
               let uu____3515 = FStar_TypeChecker_Env.clear_expected_typ env1 in
               FStar_All.pipe_right uu____3515 FStar_Pervasives_Native.fst in
                 ...
                 (match uu____3554 with
                  | (e1,c,g) ->
                      ((let uu____3608 =
                       ...
                       (let uu____3611 = comp_check_expected_typ env0 e1 c in
                        ...
                        | (e2,c1,g') ->
                            ...
                            let gres =
                              ...
                              FStar_TypeChecker_Rel.conj_guard g uu____3746 in
                            ((let uu____3748 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.Extreme in
                              if uu____3748
                                           ...
                                           let uu____4372 =
                                             let uu____4385 =
                                               ...
                                               FStar_Syntax_Subst.close
                                                 uu____4386 e_match in
                                             ((false, [lb]), uu____4385) in
                                           FStar_Syntax_Syntax.Tm_let
                                             uu____4372 in
                                         FStar_Syntax_Syntax.mk uu____4371 in
                                       uu____4368
                                         FStar_Pervasives_Native.None
                                         top.FStar_Syntax_Syntax.pos in
                                     FStar_TypeChecker_Util.maybe_monadic
      ...
      | FStar_Pervasives_Native.Some tactic ->
          let uu____4914 =
            tc_check_tot_or_gtot_term env tactic
              FStar_Syntax_Syntax.t_tactic_unit in
  ...
  fun env  ->
    fun e  ->
      let check_instantiated_fvar env1 v1 dc e1 t =
        let uu____4964 = FStar_TypeChecker_Util.maybe_instantiate env1 e1 t in
                ...
                | (e1,uu____5289,g1) ->
                    let uu____5303 =
                      ...
                      FStar_All.pipe_right uu____5304
                        FStar_Syntax_Util.lcomp_of_comp in
                    let uu____5305 = FStar_TypeChecker_Rel.conj_guard g0 g1 in
                 ...
                 | (e2,t1,implicits) ->
                     let tc =
                       ...
                       then FStar_Util.Inl t1
                         ...
                         (let uu____5369 =
                            let uu____5370 = FStar_Syntax_Syntax.mk_Total t1 in
                            FStar_All.pipe_left
                              FStar_Syntax_Util.lcomp_of_comp uu____5370 in
                          FStar_Util.Inr uu____5369) in
               ...
               (if (FStar_List.length us1) <> (FStar_List.length us')
                then
                  (let uu____5444 =
                     let uu____5445 =
                       let uu____5450 =
                         let uu____5451 = FStar_Syntax_Print.fv_to_string fv in
                         let uu____5452 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____5451 uu____5452 uu____5453 in
                       let uu____5454 = FStar_TypeChecker_Env.get_range env1 in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          ...
          (match uu____5534 with
           | (bs1,c1) ->
               let env0 = env1 in
               let uu____5548 = FStar_TypeChecker_Env.clear_expected_typ env1 in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          ...
          (match uu____5633 with
           | (x1,phi1) ->
               let env0 = env1 in
               let uu____5649 = FStar_TypeChecker_Env.clear_expected_typ env1 in
           ...
           | (tc1,uu____5984,f) ->
               ...
               (match uu____5986 with
                | (head3,args) ->
                    let comp_univs =
                      let uu____6030 =
                        let uu____6031 = FStar_Syntax_Subst.compress head3 in
                ...
                ((match env1.FStar_TypeChecker_Env.letrecs with
                 ...
                 (let uu____6907 = tc_binders env1 bs in
                  ...
                  | (bs1,envbody,g,uu____6945) ->
                      let uu____6946 =
                        let uu____6959 =
                          let uu____6960 = FStar_Syntax_Subst.compress body1 in
              ...
              (let monadic_application uu____8886 subst1 arg_comps_rev
                     ...
                     let uu____8946 =
                       ...
                       | uu____8961 ->
                           ...
                           let uu____8970 =
                             ...
                             FStar_All.pipe_left
                               FStar_Syntax_Util.lcomp_of_comp uu____8971 in
                           (uu____8970, g) in
                              ...
                              then
                                ...
                                (let uu____9124 =
                                   ...
                                   | (lifted_args,reverse_args) ->
                                       ...
                                       (lifted_args, uu____9560, uu____9570) in
                             ...
                             (let uu____10354 = tc_term env2 e in
                              ...
                              | (e1,c,g_e) ->
                                  ...
                                  let xterm =
                                    ...
                                    FStar_Syntax_Syntax.as_arg uu____10381 in
                                  let uu____10382 =
                           ...
                           | (head2,chead1,ghead1) ->
                               let rec aux norm1 tres =
                                 ...
                                 | uu____10698 ->
                                     ...
                                     FStar_Exn.raise uu____10699 in
               ...
               let rec check_function_app tf =
                     ...
                     (match uu____10929 with
                      | (args1,comps,g_args) ->
                          let bs =
                            ...
                            FStar_Syntax_Util.null_binders_of_tks uu____10966 in
                          let ml_or_tot t r1 =
                            ...
                            let uu____11037 =
                              let uu____11040 =
                                ...
                                FStar_All.pipe_right uu____11041
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____11040 in
                     ...
                     (match uu____11300 with
                      | (args1,comps,g_args) ->
                                ...
                                (FStar_List.map
                                   (fun uu____11375  ->
                                      ...
                                      | (uu____11388,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____11337 in
                          let ml_or_tot t r1 =
                          ...
                          let cres =
                            let uu____11408 =
                              let uu____11411 =
                                let uu____11412 = FStar_Syntax_Util.type_u () in
                                FStar_All.pipe_right uu____11412
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____11411 in
                 ...
                 | uu____11595 ->
                     ...
                     FStar_Exn.raise uu____11596 in
                                   ...
                                   | (e1,c1,g) ->
                                       ...
                                       let uu____11810 =
                                         let uu____11819 =
                                           ...
                                           [uu____11828] in
                                         FStar_List.append seen uu____11819 in
                                       let uu____11835 =
                                         FStar_TypeChecker_Rel.conj_guard
                                           guard g1 in
                      ...
                      (match uu____12282 with
                       | (pattern1,pat_bvs1,pat_env,pat_exp,norm_pat_exp) ->
                           ...
                           (match uu____12320 with
                            | (when_clause1,g_when) ->
                                let uu____12397 = tc_term pat_env branch_exp in
                   ...
                   (let g11 =
                    ...
                    let uu____13030 =
                      let uu____13039 =
                        let uu____13050 =
                          let uu____13059 =
                            let uu____13072 = c1.FStar_Syntax_Syntax.comp () in
                            ((lb.FStar_Syntax_Syntax.lbname), e1,
                              uu____13072) in
                          [uu____13059] in
                        FStar_TypeChecker_Util.generalize env1 uu____13050 in
                    ...
                    let uu____13135 =
                      ...
                      then
                        ...
                        (FStar_TypeChecker_Rel.force_trivial_guard env1 g11;
                         (let c =
                            let uu____13183 = c11.FStar_Syntax_Syntax.comp () in
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          let uu____13262 =
            let uu____13273 =
              let uu____13274 = FStar_TypeChecker_Env.clear_expected_typ env2 in
              FStar_All.pipe_right uu____13274 FStar_Pervasives_Native.fst in
           ...
           | (e1,uu____13296,c1,g1,annotated) ->
               ...
               (match uu____13302 with
                | (xb,e21) ->
                    ...
                    let uu____13327 =
                      let uu____13334 = FStar_TypeChecker_Env.push_bv env2 x1 in
                         ...
                         let x_eq_e1 =
                           let uu____13384 =
                             ...
                             FStar_Syntax_Util.mk_eq2 uu____13385
                               c1.FStar_Syntax_Syntax.res_typ uu____13386 e11 in
                           FStar_All.pipe_left
                             (fun _0_41  ->
                         ...
                         let g21 =
                           let uu____13388 =
                             let uu____13389 =
                               FStar_TypeChecker_Rel.guard_of_guard_formula
                                 x_eq_e1 in
                             FStar_TypeChecker_Rel.imp_guard uu____13389 g2 in
                              ...
                              let cres =
                                let uu____13699 =
                                  FStar_Syntax_Syntax.mk_Total
                                    FStar_Syntax_Syntax.t_unit in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____13699 in
                              let uu____13704 =
                                          ...
                                          let uu____13915 =
                                            let uu____13916 =
                                              FStar_List.map
                                                ...
                                                bvs in
                                            FStar_TypeChecker_Rel.close_guard
                                              env2 uu____13916 g2 in
                                          FStar_TypeChecker_Rel.conj_guard
                                            g_lbs uu____13915 in
                                        let cres1 =
                                          FStar_TypeChecker_Util.close_lcomp
                                            env2 bvs cres in
                                        let tres =
        ...
        let termination_check_enabled lbname lbdef lbtyp =
                  ...
                  let formals_msg =
                    ...
                    then "1 argument"
                      ...
                      (let uu____14089 = FStar_Util.string_of_int n1 in
                       FStar_Util.format1 "%s arguments" uu____14089) in
                  let msg =
                    let uu____14097 = FStar_Syntax_Print.term_to_string lbtyp in
                    let uu____14098 =
                      FStar_Syntax_Print.lbname_to_string lbname in
                    FStar_Util.format4
                      "From its type %s, the definition of `let rec %s` expects a function with %s, but %s"
                      uu____14097 uu____14098 formals_msg actuals_msg in
                  FStar_Exn.raise
                    (FStar_Errors.Error
          ...
          | uu____14105 ->
              let uu____14110 =
                let uu____14111 =
                  let uu____14116 =
                    let uu____14117 = FStar_Syntax_Print.term_to_string lbdef in
                    let uu____14118 = FStar_Syntax_Print.term_to_string lbtyp in
                    FStar_Util.format2
                      "Only function literals with arrow types can be defined recursively; got %s : %s"
                      uu____14117 uu____14118 in
                  (uu____14116, (lbtyp.FStar_Syntax_Syntax.pos)) in
                FStar_Errors.Error uu____14111 in
              FStar_Exn.raise uu____14110 in
        let uu____14119 =
          FStar_List.fold_left
            (fun uu____14145  ->
               fun lb  ->
                            ...
                            then t
                              ...
                              (let uu____14185 =
                                 let uu____14192 =
                                   ...
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____14193 in
                                 tc_check_tot_or_gtot_term
                       ...
                       let uu____14479 =
                         ...
                         FStar_TypeChecker_Util.strengthen_precondition
                           (FStar_Pervasives_Native.Some
                              (fun uu____14488  ->
                                 FStar_TypeChecker_Err.ill_kinded_type))
                           uu____14484 e12 c1 wf_annot in
             ...
             | (univ_opening,univ_vars1) ->
                 ...
                 then
                   ...
                   (let uu____14608 = FStar_Syntax_Util.type_u () in
                    ...
                    | (k,uu____14628) ->
                        let uu____14629 = tc_check_tot_or_gtot_term env1 t1 k in
                               ...
                               then
                                 let uu____14655 =
                                   let uu____14656 =
                                     FStar_Syntax_Syntax.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname in
                                   FStar_Range.string_of_range uu____14656 in
                                 let uu____14657 =
             ...
             | (b1,env',g,u) ->
                 ...
                 (match uu____14877 with
                  | (bs3,env'1,g',us) ->
                      ...
                      ((b1 :: bs3), env'1, uu____14930, (u :: us)))) in
      aux env bs
and tc_pats:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax,FStar_Syntax_Syntax.aqual)
           ...
           fun uu____15148  ->
             ...
             | (pats1,g) ->
                 ...
                 (match uu____15173 with
                  | (args,g') ->
                      let uu____15186 = FStar_TypeChecker_Rel.conj_guard g g' in
      ...
      (let env1 =
       ...
       let uu____15347 =
         ...
         | FStar_Errors.Error (msg,uu____15380) ->
             ...
             FStar_Exn.raise uu____15381 in
        ...
        let uu____15449 =
          let uu____15450 =
            let uu____15455 =
              ...
              FStar_Util.format2
                "Expected a term of type 'Type'; got %s : %s" uu____15456 t in
           ...
           | ((us',t),uu____15761) ->
               (if (FStar_List.length us) <> (FStar_List.length us')
                then
                  (let uu____15767 =
                     let uu____15768 =
                       let uu____15773 = FStar_TypeChecker_Env.get_range env in
           ...
           | (bs1,c1) ->
               ...
               let u_c =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     ...
                     level_of_type env trepr uu____15861 in
               let u =
            ...
            | FStar_Syntax_Syntax.Tm_match (uu____16220,hd4::uu____16222) ->
                ...
                (match uu____16287 with
                 | (uu____16302,uu____16303,hd5) ->
                     let uu____16321 = FStar_Syntax_Util.head_and_args hd5 in
