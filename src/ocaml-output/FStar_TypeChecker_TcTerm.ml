       ...
       | FStar_Syntax_Syntax.Tm_let
           ((true,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu____5520;
               ...
               FStar_Syntax_Syntax.lbpos = uu____5526;_}::uu____5527),
            uu____5528)
  ...
  fun env ->
    fun e ->
      let check_instantiated_fvar env1 v1 dc e1 t0 =
        let uu____5967 = FStar_TypeChecker_Util.maybe_instantiate env1 e1 t0 in
                ...
                | (e1, uu____6291, g1) ->
                    let uu____6305 =
                      ...
                      FStar_All.pipe_right uu____6306
                        FStar_Syntax_Util.lcomp_of_comp in
                    let uu____6307 = FStar_TypeChecker_Rel.conj_guard g0 g1 in
                 ...
                 | (e2, t1, implicits) ->
                     let tc =
                       ...
                       then FStar_Util.Inl t1
                         ...
                         (let uu____6371 =
                            let uu____6372 = FStar_Syntax_Syntax.mk_Total t1 in
                            FStar_All.pipe_left
                              FStar_Syntax_Util.lcomp_of_comp uu____6372 in
                          FStar_Util.Inr uu____6371) in
                     value_check_expected_typ env1 e2 tc implicits)))
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____6378;
             FStar_Syntax_Syntax.vars = uu____6379;_},
           uu____6380)
           ...
           | ((us', t), range) ->
               (if (FStar_List.length us1) <> (FStar_List.length us')
                then
                  (let uu____6434 =
                     let uu____6439 =
                       let uu____6440 = FStar_Syntax_Print.fv_to_string fv in
                       let uu____6441 =
                       ...
                       FStar_Util.format3
                         ...
                         uu____6440 uu____6441 uu____6442 in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (bs, c) ->
          ...
          (match uu____6523 with
           | (bs1, c1) ->
               let env0 = env1 in
               let uu____6537 = FStar_TypeChecker_Env.clear_expected_typ env1 in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x, phi) ->
          ...
          (match uu____6622 with
           | (x1, phi1) ->
               let env0 = env1 in
               let uu____6638 = FStar_TypeChecker_Env.clear_expected_typ env1 in
           ...
           | (tc1, uu____7031, f) ->
               ...
               (match uu____7033 with
                | (head3, args) ->
                    let comp_univs =
                      let uu____7077 =
                        let uu____7078 = FStar_Syntax_Subst.compress head3 in
          ...
          let fail1 a msg t =
            let uu____7407 =
              FStar_TypeChecker_Err.expected_a_term_of_type_t_got_a_function
                env msg t top in
            FStar_Errors.raise_error uu____7407 top.FStar_Syntax_Syntax.pos in
                  ...
                  (match (bs2, bs_expected1) with
                   ...
                   | ((hd1, imp)::bs3, (hd_expected, imp')::bs_expected2) ->
                       ((match (imp, imp') with
                         ...
                         | (FStar_Pervasives_Native.Some
                            (FStar_Syntax_Syntax.Implicit uu____7682),
                            FStar_Pervasives_Native.None) ->
                             let uu____7687 =
                               let uu____7692 =
                                 let uu____7693 =
                ...
                let rec as_function_typ norm1 t2 =
                  ...
                  | FStar_Syntax_Syntax.Tm_app
                      ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____8151;_},
                       uu____8152)
                      ->
                      ((match env1.FStar_TypeChecker_Env.letrecs with
                        | [] -> ()
                       ...
                       | (bs_expected1, c_expected1) ->
                           ...
                           (match uu____9060 with
                            | (envbody, bs1, g, c, body2) ->
                                let uu____9114 = mk_letrec_env envbody bs1 c in
                  ...
                  | uu____9160 ->
                      ...
                      then
                        ...
                        (let uu____9183 =
                         ...
                         | (uu____9222, bs1, uu____9224, c_opt, envbody,
                            body2, g) ->
                             ((FStar_Pervasives_Native.Some t2), bs1, [],
                    ...
                    let uu____9309 =
                      let should_check_expected_effect =
                        ...
                        | (FStar_Pervasives_Native.None,
                           FStar_Syntax_Syntax.Tm_ascribed
                           (uu____9330,
                            (FStar_Util.Inr expected_c, uu____9332),
                            uu____9333)) -> false
                        | uu____9382 -> true in
                      let uu____9389 =
                        tc_term
                      ...
                      | (body2, cbody, guard_body) ->
                          ...
                          then
                            ...
                            (let uu____9442 =
                               FStar_Syntax_Syntax.lcomp_comp cbody in
                             (body2, uu____9442, guard_body1)) in
                     ...
                     let uu____9698 =
                       ...
                       | uu____9712 ->
                           ...
                           let uu____9721 =
                             ...
                             FStar_All.pipe_left
                               FStar_Syntax_Util.lcomp_of_comp uu____9722 in
                           (uu____9721, g) in
                 ...
                 | (subst1, outargs, arg_rets, g, fvs) ->
                     (match (bs, args1) with
                      ...
                      | ((x, aqual)::rest, (e, aq)::rest') ->
                          ((match (aqual, aq) with
                            | (FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11089),
                               FStar_Pervasives_Native.Some
                                  ...
                                  let xterm =
                                    let uu____11174 =
                                      let uu____11177 =
                                        ...
                                        FStar_Syntax_Syntax.as_arg
                                          uu____11184 in
                                      FStar_Pervasives_Native.fst uu____11177 in
                                    (uu____11174, aq) in
                                  let uu____11191 =
                     ...
                     (match uu____11777 with
                      | (args1, comps, g_args) ->
                                ...
                                (FStar_List.map
                                   (fun uu____11852 ->
                                      ...
                                      | (uu____11865, c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____11814 in
                          let ml_or_tot t r1 =
                          ...
                          let cres =
                            let uu____11885 =
                              let uu____11888 =
                                let uu____11889 = FStar_Syntax_Util.type_u () in
                                FStar_All.pipe_right uu____11889
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____11888 in
                                ...
                                (FStar_List.map
                                   (fun uu____12223 ->
                                      ...
                                      | (uu____12236, c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____12185 in
                          let ml_or_tot t r1 =
                            ...
                            let uu____12256 =
                              let uu____12259 =
                                ...
                                FStar_All.pipe_right uu____12260
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____12259 in
                                   ...
                                   | (e1, c1, g) ->
                                       ...
                                       let uu____12657 =
                                         let uu____12666 =
                                           ...
                                           [uu____12675] in
                                         FStar_List.append seen uu____12666 in
                                       let uu____12682 =
                                         FStar_TypeChecker_Rel.conj_guard
                                           guard g1 in
                                   ...
                                   ((let uu____13139 =
                                     ...
                                     then
                                       ((let uu____13141 =
                                           FStar_Syntax_Print.term_to_string
                                             norm_exp in
                                         let uu____13142 = uvs_to_string uvs1 in
                                         FStar_Util.print2
                                           ">> free_1(%s) = %s\n" uu____13141
                                           uu____13142);
                                        (let uu____13143 =
                                           FStar_Syntax_Print.term_to_string
                                             expected_pat_t in
                                         let uu____13144 = uvs_to_string uvs2 in
                                         FStar_Util.print2
                                           ">> free_2(%s) = %s\n" uu____13143
                                           uu____13144))
                                     else ());
                       ...
                       | (pattern1, pat_bvs1, pat_env, pat_exp,
                          guard_pat_annots, norm_pat_exp) ->
                           ...
                           (match uu____13278 with
                            | (when_clause1, g_when) ->
                                let uu____13363 = tc_term pat_env branch_exp in
                                          ...
                                          let branch_guard =
                                            let uu____13603 =
                                              let uu____13604 =
                                                FStar_TypeChecker_Env.should_verify
                                                  env in
                                              Prims.op_Negation uu____13604 in
                                            if uu____13603
                 ...
                 then
                   ...
                   (let g11 =
                    ...
                    | (uu____14155, univs1, e11, c11, gvs) ->
                        ...
                        let uu____14168 = FStar_Syntax_Util.lcomp_of_comp c11 in
                        (g13, e11, univs1, uu____14168)) in
  ...
  fun env ->
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), e2) ->
          ...
          let uu____14305 =
            let uu____14316 =
              let uu____14317 = FStar_TypeChecker_Env.clear_expected_typ env2 in
              FStar_All.pipe_right uu____14317 FStar_Pervasives_Native.fst in
           ...
           | (e1, uu____14339, c1, g1, annotated) ->
               ((let uu____14344 =
                 ...
                 then
                   let uu____14347 =
                     let uu____14352 =
                       let uu____14353 = FStar_Syntax_Print.term_to_string e1 in
                       let uu____14354 =
                     ...
                     (FStar_Errors.Fatal_ExpectedPureExpression, uu____14352) in
                          ...
                          let g21 =
                            let uu____14444 =
                              let uu____14445 =
                                FStar_TypeChecker_Rel.guard_of_guard_formula
                                  x_eq_e1 in
                              FStar_TypeChecker_Rel.imp_guard uu____14445 g2 in
                              ...
                              let cres =
                                let uu____14763 =
                                  FStar_Syntax_Syntax.mk_Total
                                    FStar_Syntax_Syntax.t_unit in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____14763 in
                              let uu____14768 =
                                          ...
                                          let uu____14981 =
                                            let uu____14982 =
                                              FStar_List.map
                                                ...
                                                bvs in
                                            FStar_TypeChecker_Rel.close_guard
                                              env2 uu____14982 g2 in
                                          FStar_TypeChecker_Rel.conj_guard
                                            g_lbs uu____14981 in
                                        let cres3 =
                                          FStar_TypeChecker_Util.close_lcomp
                                            env2 bvs cres2 in
                                        let tres =
                         ...
                         FStar_TypeChecker_Util.strengthen_precondition
                           (FStar_Pervasives_Native.Some
                              (fun uu____15554 ->
                                 FStar_Util.return_all
                                   FStar_TypeChecker_Err.ill_kinded_type))
                           uu____15550 e12 c1 wf_annot in
             ...
             | (univ_opening, univ_vars1) ->
                 ...
                 then
                   ...
                   (let uu____15703 = FStar_Syntax_Util.type_u () in
                    ...
                    | (k, uu____15723) ->
                        let uu____15724 = tc_check_tot_or_gtot_term env1 t1 k in
                                 ...
                                 let uu____15750 =
                                   let uu____15751 =
                                     FStar_Syntax_Util.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname in
                                   FStar_Range.string_of_range uu____15751 in
                                 let uu____15752 =
             ...
             | (b1, env', g, u) ->
                 ...
                 (match uu____15972 with
                  | (bs3, env'1, g', us) ->
                      ...
                      ((b1 :: bs3), env'1, uu____16025, (u :: us)))) in
      aux env bs
and (tc_pats :
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax,
           ...
           fun uu____16243 ->
             ...
             | (pats1, g) ->
                 ...
                 (match uu____16268 with
                  | (args, g') ->
                      let uu____16281 = FStar_TypeChecker_Rel.conj_guard g g' in
      ...
      (let env1 =
       ...
       let uu____16437 =
         ...
         | FStar_Errors.Error (e1, msg, uu____16472) ->
             ...
             FStar_Errors.raise_error (e1, msg) uu____16473 in
             ...
             (let uu____16499 =
                let uu____16504 =
                  ...
                  FStar_Util.format1
                    ...
                    uu____16505 in
                (FStar_Errors.Fatal_UnexpectedImplictArgument, uu____16504) in
    ...
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu____16826;_},
           us)
          ->
          let uu____16832 =
            FStar_TypeChecker_Env.lookup_lid env
           ...
           | (bs1, c1) ->
               ...
               let u_c =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     ...
                     level_of_type env trepr uu____16939 in
               let u =
            ...
            | FStar_Syntax_Syntax.Tm_match (uu____17298, hd4::uu____17300) ->
                ...
                (match uu____17365 with
                 | (uu____17380, uu____17381, hd5) ->
                     let uu____17399 = FStar_Syntax_Util.head_and_args hd5 in
                 ...
                 | (env1, uu____17526) ->
                     ...
                     ((let uu____17534 =
                      ...
                      (let uu____17539 = tc_term env2 hd3 in
                       ...
                       | (uu____17560,
                          { FStar_Syntax_Syntax.eff_name = uu____17561;
                            FStar_Syntax_Syntax.res_typ = t;
                            FStar_Syntax_Syntax.cflags = uu____17563;
                            FStar_Syntax_Syntax.comp_thunk = uu____17564;_},
                          g) ->
                           ((let uu____17583 =
                               FStar_TypeChecker_Rel.solve_deferred_constraints
                                 env2 g in
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu____17943;_},
           us)
          ->
          let uu____17949 =
                ...
                let bs_t_opt =
                  ...
                  then
                    ...
                    | (bs1, rest) ->
                        ...
                        let uu____18413 =
                          let uu____18418 = FStar_Syntax_Syntax.mk_Total t1 in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____18454 = FStar_Syntax_Subst.open_comp bs c in
                     ...
                     | (bs1, t1) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args in
                         let uu____18557 = FStar_Syntax_Subst.subst subst1 t1 in
        ...
        fun k ->
          ...
          let slow_check uu____18832 =
            ...
            then
              ...
              (let uu____18844 = env2.FStar_TypeChecker_Env.tc_term env2 t in
               match uu____18844 with | (uu____18851, uu____18852, g) -> g) in
          let uu____18854 =
             ...
             | FStar_Pervasives_Native.Some k' ->
                 ((let uu____18862 =
                   ...
                   then
                     ...
                     let uu____18864 = FStar_Syntax_Print.term_to_string t in
                     let uu____18865 = FStar_Syntax_Print.term_to_string k' in
                     let uu____18866 = FStar_Syntax_Print.term_to_string k in
                  ...
                  (let b = FStar_TypeChecker_Rel.subtype_nosmt env2 k' k in
                   (let uu____18870 =
                    ...
                    then
                      let uu____18871 =
                        FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos in
                      let uu____18872 = FStar_Syntax_Print.term_to_string t in
                      let uu____18873 = FStar_Syntax_Print.term_to_string k' in
                      let uu____18874 = FStar_Syntax_Print.term_to_string k in
