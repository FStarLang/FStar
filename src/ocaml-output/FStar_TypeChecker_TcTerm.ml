                  ...
                  (match uu____16507 with
                   | (args1,guard,ghost) ->
                       ...
                       let e1 =
                         FStar_Syntax_Syntax.mk
                           (FStar_Syntax_Syntax.Tm_meta
                              (e, FStar_Syntax_Syntax.Meta_short_circuit))
                           FStar_Pervasives_Native.None r
                          in
                       let c1 =
                         if ghost
                       ...
                       let uu____16909 =
                         FStar_TypeChecker_Util.strengthen_precondition
                           FStar_Pervasives_Native.None env e1 c1 guard
                          in
                       (match uu____16909 with | (c2,g) -> (e1, c2, g)))
              | uu____16926 ->
      ...
      fun p0  ->
        ...
        let expected_pat_typ env1 pos scrutinee_t =
          let rec aux norm1 t =
            ...
            let uu____17017 = FStar_Syntax_Util.head_and_args t1  in
            match uu____17017 with
            | (head1,args) ->
                let uu____17060 =
                  let uu____17061 = FStar_Syntax_Subst.compress head1  in
                ...
                (match uu____17060 with
                 | FStar_Syntax_Syntax.Tm_uinst
                     ({
                        ...
                        FStar_Syntax_Syntax.vars = uu____17066;_},us)
        ...
        let pat_typ_ok env1 pat_t1 scrutinee_t =
          (let uu____17151 =
           ...
           if uu____17151
           then
             let uu____17156 = FStar_Syntax_Print.term_to_string pat_t1  in
             let uu____17158 = FStar_Syntax_Print.term_to_string scrutinee_t
                in
          ...
          (let fail2 msg =
             let msg1 =
               let uu____17178 = FStar_Syntax_Print.term_to_string pat_t1  in
               let uu____17180 =
                 FStar_Syntax_Print.term_to_string scrutinee_t  in
               FStar_Util.format3
                 "Type of pattern (%s) does not match type of scrutinee (%s)%s"
                 uu____17178 uu____17180 msg
                in
             FStar_Errors.raise_error
               (FStar_Errors.Fatal_MismatchedPatternType, msg1)
               p0.FStar_Syntax_Syntax.p
              in
           let uu____17184 = FStar_Syntax_Util.head_and_args scrutinee_t  in
           ...
           | (head_s,args_s) ->
               let pat_t2 =
                 FStar_TypeChecker_Normalize.normalize
                  ...
                  in
               let uu____17228 = FStar_Syntax_Util.un_uinst head_s  in
               (match uu____17228 with
                | {
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar
                      uu____17229;
                    FStar_Syntax_Syntax.pos = uu____17230;
                    FStar_Syntax_Syntax.vars = uu____17231;_} ->
                    let uu____17234 = FStar_Syntax_Util.head_and_args pat_t2
                       in
                                 ...
                                 (let uu____17318 =
                                    ...
                                    | FStar_Pervasives_Native.Some n1 ->
                                        ...
                                        (match uu____17396 with
                                         | (params_p,uu____17454) ->
                                             let uu____17495 =
                                               FStar_Util.first_N n1 args_s
                                                in
                                             (match uu____17495 with
                                              | (params_s,uu____17553) ->
                                                  (params_p, params_s)))
                                     in
        ...
        let type_of_simple_pat env1 e =
          let uu____17813 = FStar_Syntax_Util.head_and_args e  in
              ...
              (match head1.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_fvar f ->
                   ...
                   (match uu____17877 with
                    | (us,t_f) ->
                        let uu____17894 = FStar_Syntax_Util.arrow_formals t_f
                           in
                        (match uu____17894 with
                         | (formals,t) ->
                             (if
                              ...
                              (let rec aux uu____18023 formals1 args1 =
                                      ...
                                      | ([],[]) ->
                                          ...
                                          let uu____18168 =
                                            FStar_Syntax_Subst.subst subst1 t
                                             in
                                          (pat_e, uu____18168, bvs, guard)
                                      | ((f1,uu____18174)::formals2,(a,imp_a)::args2)
                                          ->
                                          let t_f1 =
                                            FStar_Syntax_Subst.subst subst1
                                          ...
                                          let uu____18232 =
                                            ...
                                            | FStar_Syntax_Syntax.Tm_name x
                                                ->
                                                let x1 =
                                                  let uu___378_18279 = x  in
                                                  {
                                                    FStar_Syntax_Syntax.ppname
                                                      =
                                                      (uu___378_18279.FStar_Syntax_Syntax.ppname);
                                                    FStar_Syntax_Syntax.index
                                                      =
                                                      (uu___378_18279.FStar_Syntax_Syntax.index);
                                                    FStar_Syntax_Syntax.sort
                                                      = t_f1
                                                  }  in
                                                let a1 =
                                           ...
                                           | (a1,subst2,bvs1,g) ->
                                               let uu____18430 =
                                                 ...
                                                 (subst2,
                                                   ...
                                                   uu____18453)
                                                  in
                                               aux uu____18430 formals2 args2)
                                      | uu____18492 ->
                               ...
                               aux
                                 ([], [], [],
                                   FStar_TypeChecker_Env.trivial_guard)
                                 formals args))))
               | uu____18548 -> fail1 "Not a simple pattern")
           in
        let rec check_nested_pattern env1 p t =
          (let uu____18597 =
           ...
           if uu____18597
           then
             let uu____18602 = FStar_Syntax_Print.pat_to_string p  in
             let uu____18604 = FStar_Syntax_Print.term_to_string t  in
             FStar_Util.print2 "Checking pattern %s at type %s\n" uu____18602
               uu____18604
           else ());
          (match p.FStar_Syntax_Syntax.v with
           | FStar_Syntax_Syntax.Pat_dot_term uu____18619 ->
               let uu____18626 =
                 let uu____18628 = FStar_Syntax_Print.pat_to_string p  in
                 FStar_Util.format1
                   "Impossible: Expected an undecorated pattern, got %s"
                   uu____18628
                  in
               failwith uu____18626
           | FStar_Syntax_Syntax.Pat_wild x ->
               let x1 =
                 let uu___379_18643 = x  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___379_18643.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___379_18643.FStar_Syntax_Syntax.index);
                   FStar_Syntax_Syntax.sort = t
                 }  in
               let uu____18644 = FStar_Syntax_Syntax.bv_to_name x1  in
               ([x1], uu____18644,
                 (let uu___380_18648 = p  in
                  {
           ...
           | FStar_Syntax_Syntax.Pat_var x ->
               let x1 =
                 let uu___381_18651 = x  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___381_18651.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___381_18651.FStar_Syntax_Syntax.index);
                   FStar_Syntax_Syntax.sort = t
                 }  in
               let uu____18652 = FStar_Syntax_Syntax.bv_to_name x1  in
               ([x1], uu____18652,
                 (let uu___382_18656 = p  in
                  {
                    FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
                    FStar_Syntax_Syntax.p =
                      (uu___382_18656.FStar_Syntax_Syntax.p)
                  }), FStar_TypeChecker_Env.trivial_guard)
           | FStar_Syntax_Syntax.Pat_constant uu____18657 ->
               let uu____18658 =
                 FStar_TypeChecker_PatternUtils.pat_as_exp false env1 p  in
               (match uu____18658 with
                | (uu____18680,e_c,uu____18682,uu____18683) ->
                    let uu____18688 = tc_tot_or_gtot_term env1 e_c  in
                           ...
                           (let uu____18711 =
                              let uu____18713 =
                                FStar_TypeChecker_Rel.teq_nosmt_force env1
                                 ...
                                 in
                              Prims.op_Negation uu____18713  in
                            if uu____18711
                            then
                              let uu____18716 =
                                let uu____18718 =
                                   ...
                                   let uu____18822 =
                                     let uu____18823 =
                                       FStar_Syntax_Syntax.new_bv
                                         ...
                                         FStar_Syntax_Syntax.tun
                                        in
                                     FStar_Syntax_Syntax.Pat_var uu____18823
                                      in
                                   FStar_Syntax_Syntax.withinfo uu____18822
                                     p1.FStar_Syntax_Syntax.p
                                    in
                                 (uu____18819, b))) sub_pats
                    in
                 let uu___383_18827 = p  in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons (fv, simple_sub_pats));
                   FStar_Syntax_Syntax.p =
                     (uu___383_18827.FStar_Syntax_Syntax.p)
                 }  in
               let sub_pats1 =
                      ...
                      (fun uu____18872  ->
                         ...
                         | (x,uu____18882) ->
                             (match x.FStar_Syntax_Syntax.v with
                              | FStar_Syntax_Syntax.Pat_dot_term uu____18890
                                  -> false
                              | uu____18898 -> true)))
                  in
               let uu____18900 =
                     ...
                     then
                       (let uu____18937 =
                          ...
                          FStar_Util.format4
                            ...
                            uu____18939 uu____18941 uu____18943 uu____18950
                           in
                            ...
                            let g' =
                              let uu____18992 =
                                expected_pat_typ env1
                                 ...
                                 in
                              pat_typ_ok env1 simple_pat_t uu____18992  in
                            let guard1 =
                            ...
                            ((let uu____18995 =
                              ...
                              then
                                             ...
                                             let uu____19020 =
                                               let uu____19022 =
                                                 FStar_Syntax_Print.term_to_string
                                                   x.FStar_Syntax_Syntax.sort
                                                  in
                                               Prims.strcat uu____19022 ")"
                                                in
                                             Prims.strcat " : " uu____19020
                                              in
                                ...
                                FStar_Util.print3
                                  ...
                                  uu____19000 uu____19002 uu____19004
                              else ());
                          ...
                          let uu____19054 =
                            ...
                            FStar_List.fold_left2
                              (fun uu____19159  ->
                                 fun uu____19160  ->
                                   fun x  ->
                                     match (uu____19159, uu____19160) with
                                       ...
                                       (match hd1.FStar_Syntax_Syntax.v with
                                        | FStar_Syntax_Syntax.Pat_dot_term
                                            ...
                                            let e1 =
                                              FStar_Syntax_Subst.subst subst1
                                               ...
                                               in
                                            let hd2 =
                                              let uu___384_19546 = hd1  in
                                              {
                                                FStar_Syntax_Syntax.v =
                                                  (FStar_Syntax_Syntax.Pat_dot_term
                                                     (x, e1));
                                                FStar_Syntax_Syntax.p =
                                                  (uu___384_19546.FStar_Syntax_Syntax.p)
                                              }  in
                                            let uu____19551 =
                                        ...
                                        | FStar_Syntax_Syntax.Pat_var x ->
                                            (match (bvs1, sub_pats2) with
                                             | (x'::bvs2,(hd2,uu____19595)::sub_pats3)
                                                 when
                                 ...
                                 | FStar_Syntax_Syntax.Pat_cons
                                     ...
                                     let nested_pats =
                                       aux simple_pats simple_bvs1
                                         checked_sub_pats
                                        in
                                     let uu___385_19721 = pat  in
                                     {
                                       FStar_Syntax_Syntax.v =
                                         (FStar_Syntax_Syntax.Pat_cons
                                            (fv1, nested_pats));
                                       FStar_Syntax_Syntax.p =
                                         (uu___385_19721.FStar_Syntax_Syntax.p)
                                     }
                                 | uu____19733 -> failwith "Impossible"  in
                               let uu____19737 =
                                 reconstruct_nested_pat simple_pat_elab  in
                               (bvs, pat_e, uu____19737, g))))))
           in
        (let uu____19741 =
         ...
         if uu____19741
         then
           let uu____19746 = FStar_Syntax_Print.pat_to_string p0  in
           FStar_Util.print1 "Checking pattern: %s\n" uu____19746
         else ());
        (let uu____19751 =
           let uu____19762 =
             let uu___386_19763 =
               let uu____19764 = FStar_TypeChecker_Env.clear_expected_typ env
                  in
               FStar_All.pipe_right uu____19764 FStar_Pervasives_Native.fst
                in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___386_19763.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___386_19763.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___386_19763.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___386_19763.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_sig =
                 (uu___386_19763.FStar_TypeChecker_Env.gamma_sig);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___386_19763.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___386_19763.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___386_19763.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___386_19763.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.attrtab =
                 (uu___386_19763.FStar_TypeChecker_Env.attrtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___386_19763.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___386_19763.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___386_19763.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___386_19763.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___386_19763.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___386_19763.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___386_19763.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq = true;
               FStar_TypeChecker_Env.is_iface =
                 (uu___386_19763.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___386_19763.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___386_19763.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___386_19763.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.phase1 =
                 (uu___386_19763.FStar_TypeChecker_Env.phase1);
               FStar_TypeChecker_Env.failhard =
                 (uu___386_19763.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth =
                 (uu___386_19763.FStar_TypeChecker_Env.nosynth);
               FStar_TypeChecker_Env.uvar_subtyping =
                 (uu___386_19763.FStar_TypeChecker_Env.uvar_subtyping);
               FStar_TypeChecker_Env.tc_term =
                 (uu___386_19763.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___386_19763.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___386_19763.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.check_type_of =
                 (uu___386_19763.FStar_TypeChecker_Env.check_type_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___386_19763.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qtbl_name_and_index =
                 (uu___386_19763.FStar_TypeChecker_Env.qtbl_name_and_index);
               FStar_TypeChecker_Env.normalized_eff_names =
                 (uu___386_19763.FStar_TypeChecker_Env.normalized_eff_names);
               FStar_TypeChecker_Env.fv_delta_depths =
                 (uu___386_19763.FStar_TypeChecker_Env.fv_delta_depths);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___386_19763.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth_hook =
                 (uu___386_19763.FStar_TypeChecker_Env.synth_hook);
               FStar_TypeChecker_Env.splice =
                 (uu___386_19763.FStar_TypeChecker_Env.splice);
               FStar_TypeChecker_Env.postprocess =
                 (uu___386_19763.FStar_TypeChecker_Env.postprocess);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___386_19763.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___386_19763.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___386_19763.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___386_19763.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.nbe =
                 (uu___386_19763.FStar_TypeChecker_Env.nbe)
             }  in
           let uu____19780 =
             FStar_TypeChecker_PatternUtils.elaborate_pat env p0  in
           check_nested_pattern uu____19762 uu____19780 pat_t  in
         ...
         | (bvs,pat_e,pat,g) ->
             ((let uu____19804 =
               ...
               if uu____19804
               then
                 let uu____19809 = FStar_Syntax_Print.pat_to_string pat  in
                 let uu____19811 = FStar_Syntax_Print.term_to_string pat_e
                    in
                 FStar_Util.print2
                   "Done checking pattern %s as expression %s\n" uu____19809
                   uu____19811
               else ());
              (let uu____19816 = FStar_TypeChecker_Env.push_bvs env bvs  in
               let uu____19817 =
                 FStar_TypeChecker_Normalize.normalize
                   [FStar_TypeChecker_Env.Beta] env pat_e
                  in
               (pat, bvs, uu____19816, pat_e, uu____19817, g))))
...
and (tc_eqn :
  ...
  fun scrutinee  ->
    fun env  ->
      fun branch1  ->
        let uu____19863 = FStar_Syntax_Subst.open_branch branch1  in
        match uu____19863 with
        | (pattern,when_clause,branch_exp) ->
            let uu____19909 = branch1  in
            (match uu____19909 with
             | (cpat,uu____19951,cbr) ->
                 ...
                 (match uu____19973 with
                  | (scrutinee_env,uu____20014) ->
                      let uu____20019 = tc_pat env pat_t pattern  in
                      (match uu____20019 with
                       | (pattern1,pat_bvs1,pat_env,pat_exp,norm_pat_exp,guard_pat)
                           ...
                           (match uu____20070 with
                            | (when_clause1,g_when) ->
                                let uu____20184 = tc_term pat_env branch_exp
                                   in
                                           ...
                                           let branch_guard =
                                             ...
                                             then FStar_Syntax_Util.t_true
                                               ...
                                               (let rec build_branch_guard
                                                  ...
                                                  with
                                                  | (uu____20758,FStar_Syntax_Syntax.Tm_name
                                                     uu____20759) -> []
                                                  | (uu____20760,FStar_Syntax_Syntax.Tm_constant
                                                     ...
                                                     (uu____20766,FStar_Pervasives_Native.Some
                                                      ...
                                                      (match uu____20785 with
                                                       | (uu____20813,t,uu____20815)
                                                           ...
                                                           [uu____20816])
                                                  | (FStar_Syntax_Syntax.Pat_cons
                                                     (uu____20818,[]),FStar_Syntax_Syntax.Tm_uinst
                                                     uu____20819) ->
                                                      let f =
                                                        head_constructor
                                                          pat_exp2
                                                      ...
                                                      then
                                                        ...
                                                        (let uu____20855 =
                                                         ...
                                                         discriminate
                                                           ...
                                                           uu____20858)
                                                  | (FStar_Syntax_Syntax.Pat_cons
                                                     (uu____20861,[]),FStar_Syntax_Syntax.Tm_fvar
                                                     uu____20862) ->
                                                      let f =
                                                        head_constructor
                                                          pat_exp2
                                                      ...
                                                      then
                                                        ...
                                                        (let uu____20892 =
                                                         ...
                                                         discriminate
                                                           ...
                                                           uu____20895)
                                                  | (FStar_Syntax_Syntax.Pat_cons
                                                     (uu____20898,pat_args),FStar_Syntax_Syntax.Tm_app
                                                     (head1,args)) ->
                                                      let f =
                                                        head_constructor
                                                          head1
                                             ...
                                             let uu____21319 =
                                               let uu____21320 =
                                                 FStar_List.map
                                                  ...
                                                  in
                                               FStar_TypeChecker_Util.close_guard_implicits
                                                 env uu____21320 guard
                                                in
                                             (uu____21302, branch_guard,
                                               effect_label, cflags,
                                               maybe_return_c, uu____21319))))))))))
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let uu____21367 = check_let_bound_def true env1 lb  in
                    ...
                    let uu____21422 =
                      let uu____21435 =
                        ...
                        FStar_TypeChecker_Util.generalize env1 false
                          uu____21450
                         in
                      FStar_List.hd uu____21435  in
                    match uu____21422 with
                    | (uu____21502,univs1,e11,c11,gvs) ->
                        let g12 =
                          FStar_All.pipe_left
                        ...
                        let uu____21516 = FStar_Syntax_Util.lcomp_of_comp c11
                           in
                        (g13, e11, univs1, uu____21516))
                  in
                            ...
                            (if ok
                             then (e2, c12)
                               ...
                               ((let uu____21587 =
                                 ...
                                 FStar_Errors.log_issue uu____21587
                         ...
                         (let c =
                          ...
                          let e21 =
                            ...
                            then e2
                              ...
                              ((let uu____21617 =
                                  FStar_TypeChecker_Env.get_range env1  in
                                FStar_Errors.log_issue uu____21617
                                  FStar_TypeChecker_Err.top_level_effect);
                               FStar_Syntax_Syntax.mk
                                 (FStar_Syntax_Syntax.Tm_meta
                                    (e2,
                    ...
                    (match uu____21533 with
                     | (e21,c12) ->
                         ((let uu____21641 =
                          ...
                          (let e12 =
                             let uu____21650 = FStar_Options.tcnorm ()  in
                             if uu____21650
                             then
                               FStar_TypeChecker_Normalize.normalize
                           ...
                           (let cres =
                            ...
                            (uu____21668, uu____21682,
                              FStar_TypeChecker_Env.trivial_guard)))))))
      | uu____21683 -> failwith "Impossible"
...
and (check_inner_let :
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___387_21718 = env1  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___387_21718.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___387_21718.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___387_21718.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___387_21718.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___387_21718.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___387_21718.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___387_21718.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___387_21718.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___387_21718.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___387_21718.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___387_21718.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___387_21718.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___387_21718.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___387_21718.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___387_21718.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level = false;
              FStar_TypeChecker_Env.check_uvars =
                (uu___387_21718.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___387_21718.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___387_21718.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___387_21718.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___387_21718.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___387_21718.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___387_21718.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___387_21718.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___387_21718.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___387_21718.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___387_21718.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___387_21718.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___387_21718.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___387_21718.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___387_21718.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___387_21718.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___387_21718.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___387_21718.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___387_21718.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___387_21718.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___387_21718.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___387_21718.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___387_21718.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___387_21718.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___387_21718.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___387_21718.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___387_21718.FStar_TypeChecker_Env.nbe)
            }  in
          let uu____21720 =
            let uu____21732 =
              let uu____21733 = FStar_TypeChecker_Env.clear_expected_typ env2
                 in
              FStar_All.pipe_right uu____21733 FStar_Pervasives_Native.fst
               in
            check_let_bound_def false uu____21732 lb  in
          (match uu____21720 with
           | (e1,uu____21756,c1,g1,annotated) ->
               let pure_or_ghost =
               ...
               (if is_inline_let && (Prims.op_Negation pure_or_ghost)
                then
                  (let uu____21770 =
                     let uu____21776 =
                       let uu____21778 = FStar_Syntax_Print.term_to_string e1
                          in
                       let uu____21780 =
                       ...
                       FStar_Util.format2
                         ...
                         uu____21778 uu____21780
                        in
                     (FStar_Errors.Fatal_ExpectedPureExpression, uu____21776)
                      in
                   FStar_Errors.raise_error uu____21770
                     e1.FStar_Syntax_Syntax.pos)
                else ();
                (let attrs =
                   let uu____21791 =
                 ...
                 let x =
                   ...
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___388_21803.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___388_21803.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort =
                       (c1.FStar_Syntax_Syntax.res_typ)
                   }  in
                 let uu____21804 =
                   let uu____21809 =
                     let uu____21810 = FStar_Syntax_Syntax.mk_binder x  in
                     [uu____21810]  in
                   FStar_Syntax_Subst.open_term uu____21809 e2  in
                 match uu____21804 with
                 | (xb,e21) ->
                     let xbinder = FStar_List.hd xb  in
                     let x1 = FStar_Pervasives_Native.fst xbinder  in
                     let env_x = FStar_TypeChecker_Env.push_bv env2 x1  in
                     let uu____21854 = tc_term env_x e21  in
                      ...
                      | (e22,c2,g2) ->
                            ...
                            let uu____21879 =
                              let uu____21886 =
                                let uu____21887 =
                                  ...
                                  ((false, [lb1]), uu____21901)  in
                                FStar_Syntax_Syntax.Tm_let uu____21887  in
                              FStar_Syntax_Syntax.mk uu____21886  in
                            uu____21879 FStar_Pervasives_Native.None
                              e.FStar_Syntax_Syntax.pos
                             in
                          let e4 =
                          ...
                          let x_eq_e1 =
                            let uu____21922 =
                              ...
                              FStar_Syntax_Util.mk_eq2 uu____21923
                                c1.FStar_Syntax_Syntax.res_typ uu____21924
                                e11
                               in
                            FStar_All.pipe_left
                              (fun _0_3  ->
                            ...
                            let uu____21926 =
                              let uu____21927 =
                                FStar_TypeChecker_Env.guard_of_guard_formula
                                  x_eq_e1
                                 in
                              FStar_TypeChecker_Env.imp_guard uu____21927 g2
                               in
                          ...
                          let uu____21930 =
                            ...
                            FStar_Option.isSome uu____21932  in
                          if uu____21930
                          then
                            let tt =
                              let uu____21943 =
                                 ...
                                 ((let uu____21977 =
                                  ...
                                  (let uu____21989 =
                                     FStar_TypeChecker_Env.conj_guard g_ex
                                      ...
                                      in
                                   (e4,
                                     (let uu___389_21991 = cres  in
                                      {
                                        FStar_Syntax_Syntax.eff_name =
                                          (uu___389_21991.FStar_Syntax_Syntax.eff_name);
                                        FStar_Syntax_Syntax.res_typ = t;
                                        FStar_Syntax_Syntax.cflags =
                                          (uu___389_21991.FStar_Syntax_Syntax.cflags);
                                        FStar_Syntax_Syntax.comp_thunk =
                                          (uu___389_21991.FStar_Syntax_Syntax.comp_thunk)
                                      }), uu____21989))))))))
      | uu____21992 ->
  ...
  fun env  ->
    fun top  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          let uu____22028 = FStar_Syntax_Subst.open_let_rec lbs e2  in
          (match uu____22028 with
           | (lbs1,e21) ->
               ...
               (match uu____22047 with
                | (env0,topt) ->
                    let uu____22066 = build_let_rec_env true env0 lbs1  in
                              ...
                              let cres =
                                let uu____22286 =
                                  FStar_Syntax_Syntax.mk_Total
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____22286
                                 in
                              let uu____22287 =
                               ...
                               | (lbs5,e22) ->
                                   ((let uu____22307 =
                                       FStar_TypeChecker_Rel.discharge_guard
                                         env1 g_lbs1
                                        in
                                     FStar_All.pipe_right uu____22307
                                    ...
                                    (let uu____22308 =
                                     ...
                                     (uu____22308, cres,
                                       FStar_TypeChecker_Env.trivial_guard))))))))
      | uu____22322 -> failwith "Impossible"
...
and (check_inner_let_rec :
  ...
  fun env  ->
    fun top  ->
      ...
      match top.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          let uu____22358 = FStar_Syntax_Subst.open_let_rec lbs e2  in
          (match uu____22358 with
           | (lbs1,e21) ->
               ...
               (match uu____22377 with
                | (env0,topt) ->
                    let uu____22396 = build_let_rec_env false env0 lbs1  in
                    (match uu____22396 with
                     | (lbs2,rec_env,g_t) ->
                         let uu____22419 =
                           let uu____22426 = check_let_recs rec_env lbs2  in
                           FStar_All.pipe_right uu____22426
                             (fun uu____22449  ->
                                     ...
                                     (fun env2  ->
                                        fun lb  ->
                                          let x =
                                            ...
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___390_22506.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___390_22506.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort =
                                                (lb.FStar_Syntax_Syntax.lbtyp)
                                            }  in
                                          let lb1 =
                                            let uu___391_22508 = lb  in
                                            {
                                              FStar_Syntax_Syntax.lbname =
                                                (FStar_Util.Inl x);
                                              FStar_Syntax_Syntax.lbunivs =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbunivs);
                                              FStar_Syntax_Syntax.lbtyp =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbtyp);
                                              FStar_Syntax_Syntax.lbeff =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbeff);
                                              FStar_Syntax_Syntax.lbdef =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbdef);
                                              FStar_Syntax_Syntax.lbattrs =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbattrs);
                                              FStar_Syntax_Syntax.lbpos =
                                                (uu___391_22508.FStar_Syntax_Syntax.lbpos)
                                            }  in
                                          let env3 =
                                            FStar_TypeChecker_Env.push_let_binding
                                              env2
                                       ...
                                       (FStar_List.map
                                          (fun lb  ->
                                             FStar_Util.left
                                               lb.FStar_Syntax_Syntax.lbname))
                                      in
                                   let uu____22535 = tc_term env2 e21  in
                                    ...
                                    | (e22,cres,g2) ->
                                        ...
                                        let tres =
                                          norm env2
                                           ...
                                           in
                                        let cres4 =
                                          let uu___392_22565 = cres3  in
                                          {
                                            FStar_Syntax_Syntax.eff_name =
                                              (uu___392_22565.FStar_Syntax_Syntax.eff_name);
                                            FStar_Syntax_Syntax.res_typ =
                                              tres;
                                            FStar_Syntax_Syntax.cflags =
                                              (uu___392_22565.FStar_Syntax_Syntax.cflags);
                                            FStar_Syntax_Syntax.comp_thunk =
                                              (uu___392_22565.FStar_Syntax_Syntax.comp_thunk)
                                          }  in
                                        let guard1 =
                                          let bs =
                                            FStar_All.pipe_right lbs4
                                                   ...
                                                   | (tres1,g_ex) ->
                                                       let cres5 =
                                                           ...
                                                           cres4  in
                                                         {
                                                           FStar_Syntax_Syntax.eff_name
                                                             =
                                                             (uu___393_22630.FStar_Syntax_Syntax.eff_name);
                                                           FStar_Syntax_Syntax.res_typ
                                                             = tres1;
                                                           FStar_Syntax_Syntax.cflags
                                                             =
                                                             (uu___393_22630.FStar_Syntax_Syntax.cflags);
                                                           FStar_Syntax_Syntax.comp_thunk
                                                             =
                                                             (uu___393_22630.FStar_Syntax_Syntax.comp_thunk)
                                                         }  in
                                                       let uu____22631 =
                                                         FStar_TypeChecker_Env.conj_guard
                                                           g_ex guard1
                                                       ...
                                                       (e, cres5,
                                                         uu____22631))))))))))
      | uu____22632 -> failwith "Impossible"
    ...
    fun env  ->
      fun lbs  ->
        ...
        let termination_check_enabled lbname lbdef lbtyp =
          let uu____22680 = FStar_Options.ml_ish ()  in
          if uu____22680
          then false
          else
            (let t = FStar_TypeChecker_Normalize.unfold_whnf env lbtyp  in
             let uu____22688 = FStar_Syntax_Util.arrow_formals_comp t  in
             match uu____22688 with
             | (formals,c) ->
                 let uu____22720 = FStar_Syntax_Util.abs_formals lbdef  in
                 (match uu____22720 with
                  | (actuals,uu____22731,uu____22732) ->
                      if
                        ...
                        let uu____22753 =
                          let uu____22759 =
                            ...
                            FStar_Util.format2
                              ...
                              uu____22761 uu____22763
                             in
                          (FStar_Errors.Fatal_RecursiveFunctionLiteral,
                            uu____22759)
                           in
                        FStar_Errors.raise_error uu____22753
                           ...
                           (let actuals_msg =
                            ...
                            let msg =
                              ...
                              FStar_Util.format4
                                ...
                                uu____22846 uu____22848 formals_msg
                                actuals_msg
                               in
                            FStar_Errors.raise_error
                               ...
                               let uu____22960 =
                                 let uu____22967 =
                                   let uu____22968 =
                                     FStar_Syntax_Util.type_u ()  in
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____22968
                                    in
                                 tc_check_tot_or_gtot_term
                                   (let uu___394_22979 = env01  in
                                    {
                                      FStar_TypeChecker_Env.solver =
                                        (uu___394_22979.FStar_TypeChecker_Env.solver);
                                      FStar_TypeChecker_Env.range =
                                        (uu___394_22979.FStar_TypeChecker_Env.range);
                                      FStar_TypeChecker_Env.curmodule =
                                        (uu___394_22979.FStar_TypeChecker_Env.curmodule);
                                      FStar_TypeChecker_Env.gamma =
                                        (uu___394_22979.FStar_TypeChecker_Env.gamma);
                                      FStar_TypeChecker_Env.gamma_sig =
                                        (uu___394_22979.FStar_TypeChecker_Env.gamma_sig);
                                      FStar_TypeChecker_Env.gamma_cache =
                                        (uu___394_22979.FStar_TypeChecker_Env.gamma_cache);
                                      FStar_TypeChecker_Env.modules =
                                        (uu___394_22979.FStar_TypeChecker_Env.modules);
                                      FStar_TypeChecker_Env.expected_typ =
                                        (uu___394_22979.FStar_TypeChecker_Env.expected_typ);
                                      FStar_TypeChecker_Env.sigtab =
                                        (uu___394_22979.FStar_TypeChecker_Env.sigtab);
                                      FStar_TypeChecker_Env.attrtab =
                                        (uu___394_22979.FStar_TypeChecker_Env.attrtab);
                                      FStar_TypeChecker_Env.is_pattern =
                                        (uu___394_22979.FStar_TypeChecker_Env.is_pattern);
                                      FStar_TypeChecker_Env.instantiate_imp =
                                        (uu___394_22979.FStar_TypeChecker_Env.instantiate_imp);
                                      FStar_TypeChecker_Env.effects =
                                        (uu___394_22979.FStar_TypeChecker_Env.effects);
                                      FStar_TypeChecker_Env.generalize =
                                        (uu___394_22979.FStar_TypeChecker_Env.generalize);
                                      FStar_TypeChecker_Env.letrecs =
                                        (uu___394_22979.FStar_TypeChecker_Env.letrecs);
                                      FStar_TypeChecker_Env.top_level =
                                        (uu___394_22979.FStar_TypeChecker_Env.top_level);
                                      FStar_TypeChecker_Env.check_uvars =
                                        true;
                                      FStar_TypeChecker_Env.use_eq =
                                        (uu___394_22979.FStar_TypeChecker_Env.use_eq);
                                      FStar_TypeChecker_Env.is_iface =
                                        (uu___394_22979.FStar_TypeChecker_Env.is_iface);
                                      FStar_TypeChecker_Env.admit =
                                        (uu___394_22979.FStar_TypeChecker_Env.admit);
                                      FStar_TypeChecker_Env.lax =
                                        (uu___394_22979.FStar_TypeChecker_Env.lax);
                                      FStar_TypeChecker_Env.lax_universes =
                                        (uu___394_22979.FStar_TypeChecker_Env.lax_universes);
                                      FStar_TypeChecker_Env.phase1 =
                                        (uu___394_22979.FStar_TypeChecker_Env.phase1);
                                      FStar_TypeChecker_Env.failhard =
                                        (uu___394_22979.FStar_TypeChecker_Env.failhard);
                                      FStar_TypeChecker_Env.nosynth =
                                        (uu___394_22979.FStar_TypeChecker_Env.nosynth);
                                      FStar_TypeChecker_Env.uvar_subtyping =
                                        (uu___394_22979.FStar_TypeChecker_Env.uvar_subtyping);
                                      FStar_TypeChecker_Env.tc_term =
                                        (uu___394_22979.FStar_TypeChecker_Env.tc_term);
                                      FStar_TypeChecker_Env.type_of =
                                        (uu___394_22979.FStar_TypeChecker_Env.type_of);
                                      FStar_TypeChecker_Env.universe_of =
                                        (uu___394_22979.FStar_TypeChecker_Env.universe_of);
                                      FStar_TypeChecker_Env.check_type_of =
                                        (uu___394_22979.FStar_TypeChecker_Env.check_type_of);
                                      FStar_TypeChecker_Env.use_bv_sorts =
                                        (uu___394_22979.FStar_TypeChecker_Env.use_bv_sorts);
                                      FStar_TypeChecker_Env.qtbl_name_and_index
                                        =
                                        (uu___394_22979.FStar_TypeChecker_Env.qtbl_name_and_index);
                                      FStar_TypeChecker_Env.normalized_eff_names
                                        =
                                        (uu___394_22979.FStar_TypeChecker_Env.normalized_eff_names);
                                      FStar_TypeChecker_Env.fv_delta_depths =
                                        (uu___394_22979.FStar_TypeChecker_Env.fv_delta_depths);
                                      FStar_TypeChecker_Env.proof_ns =
                                        (uu___394_22979.FStar_TypeChecker_Env.proof_ns);
                                      FStar_TypeChecker_Env.synth_hook =
                                        (uu___394_22979.FStar_TypeChecker_Env.synth_hook);
                                      FStar_TypeChecker_Env.splice =
                                        (uu___394_22979.FStar_TypeChecker_Env.splice);
                                      FStar_TypeChecker_Env.postprocess =
                                        (uu___394_22979.FStar_TypeChecker_Env.postprocess);
                                      FStar_TypeChecker_Env.is_native_tactic
                                        =
                                        (uu___394_22979.FStar_TypeChecker_Env.is_native_tactic);
                                      FStar_TypeChecker_Env.identifier_info =
                                        (uu___394_22979.FStar_TypeChecker_Env.identifier_info);
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___394_22979.FStar_TypeChecker_Env.tc_hooks);
                                      FStar_TypeChecker_Env.dsenv =
                                        (uu___394_22979.FStar_TypeChecker_Env.dsenv);
                                      FStar_TypeChecker_Env.nbe =
                                        (uu___394_22979.FStar_TypeChecker_Env.nbe)
                                    }) t uu____22967
                                  in
                               ...
                               | (t1,uu____22988,g) ->
                                   let uu____22990 =
                                       ...
                                       let uu____22992 =
                                         FStar_All.pipe_right g
                                           (FStar_TypeChecker_Rel.resolve_implicits
                                              env2)
                                          in
                                       FStar_All.pipe_right uu____22992
                                         (FStar_TypeChecker_Rel.discharge_guard
                                            env2)
                                        in
                                     FStar_TypeChecker_Env.conj_guard g_acc
                                       uu____22991
                                      in
                                   let uu____22993 = norm env01 t1  in
                                   (uu____22990, uu____22993))
                             in
                          (match uu____22941 with
                           | (g,t1) ->
                               let env3 =
                                 ...
                                 if uu____23013
                                 then
                                   let uu___395_23016 = env2  in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___395_23016.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___395_23016.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___395_23016.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___395_23016.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_sig =
                                       (uu___395_23016.FStar_TypeChecker_Env.gamma_sig);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___395_23016.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___395_23016.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       (uu___395_23016.FStar_TypeChecker_Env.expected_typ);
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___395_23016.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.attrtab =
                                       (uu___395_23016.FStar_TypeChecker_Env.attrtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___395_23016.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___395_23016.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___395_23016.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___395_23016.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (((lb.FStar_Syntax_Syntax.lbname), t1,
                                          univ_vars1) ::
                                       (env2.FStar_TypeChecker_Env.letrecs));
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___395_23016.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___395_23016.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___395_23016.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___395_23016.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___395_23016.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax =
                                       (uu___395_23016.FStar_TypeChecker_Env.lax);
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___395_23016.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.phase1 =
                                       (uu___395_23016.FStar_TypeChecker_Env.phase1);
                                     FStar_TypeChecker_Env.failhard =
                                       (uu___395_23016.FStar_TypeChecker_Env.failhard);
                                     FStar_TypeChecker_Env.nosynth =
                                       (uu___395_23016.FStar_TypeChecker_Env.nosynth);
                                     FStar_TypeChecker_Env.uvar_subtyping =
                                       (uu___395_23016.FStar_TypeChecker_Env.uvar_subtyping);
                                     FStar_TypeChecker_Env.tc_term =
                                       (uu___395_23016.FStar_TypeChecker_Env.tc_term);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___395_23016.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___395_23016.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.check_type_of =
                                       (uu___395_23016.FStar_TypeChecker_Env.check_type_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       (uu___395_23016.FStar_TypeChecker_Env.use_bv_sorts);
                                     FStar_TypeChecker_Env.qtbl_name_and_index
                                       =
                                       (uu___395_23016.FStar_TypeChecker_Env.qtbl_name_and_index);
                                     FStar_TypeChecker_Env.normalized_eff_names
                                       =
                                       (uu___395_23016.FStar_TypeChecker_Env.normalized_eff_names);
                                     FStar_TypeChecker_Env.fv_delta_depths =
                                       (uu___395_23016.FStar_TypeChecker_Env.fv_delta_depths);
                                     FStar_TypeChecker_Env.proof_ns =
                                       (uu___395_23016.FStar_TypeChecker_Env.proof_ns);
                                     FStar_TypeChecker_Env.synth_hook =
                                       (uu___395_23016.FStar_TypeChecker_Env.synth_hook);
                                     FStar_TypeChecker_Env.splice =
                                       (uu___395_23016.FStar_TypeChecker_Env.splice);
                                     FStar_TypeChecker_Env.postprocess =
                                       (uu___395_23016.FStar_TypeChecker_Env.postprocess);
                                     FStar_TypeChecker_Env.is_native_tactic =
                                       (uu___395_23016.FStar_TypeChecker_Env.is_native_tactic);
                                     FStar_TypeChecker_Env.identifier_info =
                                       (uu___395_23016.FStar_TypeChecker_Env.identifier_info);
                                     FStar_TypeChecker_Env.tc_hooks =
                                       (uu___395_23016.FStar_TypeChecker_Env.tc_hooks);
                                     FStar_TypeChecker_Env.dsenv =
                                       (uu___395_23016.FStar_TypeChecker_Env.dsenv);
                                     FStar_TypeChecker_Env.nbe =
                                       (uu___395_23016.FStar_TypeChecker_Env.nbe)
                                   }
                                 else
                                   FStar_TypeChecker_Env.push_let_binding
                                  ...
                                  in
                               let lb1 =
                                 let uu___396_23030 = lb  in
                                 {
                                   FStar_Syntax_Syntax.lbname =
                                     (uu___396_23030.FStar_Syntax_Syntax.lbname);
                                   FStar_Syntax_Syntax.lbunivs = univ_vars1;
                                   FStar_Syntax_Syntax.lbtyp = t1;
                                   FStar_Syntax_Syntax.lbeff =
                                     (uu___396_23030.FStar_Syntax_Syntax.lbeff);
                                   FStar_Syntax_Syntax.lbdef = e;
                                   FStar_Syntax_Syntax.lbattrs =
                                     (uu___396_23030.FStar_Syntax_Syntax.lbattrs);
                                   FStar_Syntax_Syntax.lbpos =
                                     (uu___396_23030.FStar_Syntax_Syntax.lbpos)
                                 }  in
                               ((lb1 :: lbs1), env3, g))))
               ...
               (fun lb  ->
                  ...
                  | (bs,t,lcomp) ->
                      (match bs with
                       ...
                       | uu____23128 ->
                           let lb1 =
                             let uu___397_23131 = lb  in
                             let uu____23132 =
                               FStar_Syntax_Util.abs bs t lcomp  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = uu____23132;
                               FStar_Syntax_Syntax.lbattrs =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbattrs);
                               FStar_Syntax_Syntax.lbpos =
                                 (uu___397_23131.FStar_Syntax_Syntax.lbpos)
                             }  in
                           let uu____23135 =
                             let uu____23142 =
                               FStar_TypeChecker_Env.set_expected_typ env
                                 lb1.FStar_Syntax_Syntax.lbtyp
                                in
                             tc_tot_or_gtot_term uu____23142
                           ...
                           (match uu____23135 with
                            | (e,c,g) ->
                                ((let uu____23151 =
                                    ...
                                    Prims.op_Negation uu____23153  in
                                  if uu____23151
                                  then
                                    FStar_Errors.raise_error
                                 ...
                                 (let lb2 =
                                  ...
                                  (lb2, g)))))))
           in
        FStar_All.pipe_right uu____23065 FStar_List.unzip  in
...
and (check_let_bound_def :
  ...
  fun top_level  ->
    fun env  ->
      fun lb  ->
        let uu____23209 = FStar_TypeChecker_Env.clear_expected_typ env  in
        match uu____23209 with
        | (env1,uu____23228) ->
            let e1 = lb.FStar_Syntax_Syntax.lbdef  in
            let uu____23236 = check_lbtyp top_level env lb  in
             ...
             | (topt,wf_annot,univ_vars1,univ_opening,env11) ->
                 (if (Prims.op_Negation top_level) && (univ_vars1 <> [])
                  ...
                  (let e11 = FStar_Syntax_Subst.subst univ_opening e1  in
                   let uu____23285 =
                     tc_maybe_toplevel_term
                       (let uu___398_23294 = env11  in
                        {
                          FStar_TypeChecker_Env.solver =
                            (uu___398_23294.FStar_TypeChecker_Env.solver);
                          FStar_TypeChecker_Env.range =
                            (uu___398_23294.FStar_TypeChecker_Env.range);
                          FStar_TypeChecker_Env.curmodule =
                            (uu___398_23294.FStar_TypeChecker_Env.curmodule);
                          FStar_TypeChecker_Env.gamma =
                            (uu___398_23294.FStar_TypeChecker_Env.gamma);
                          FStar_TypeChecker_Env.gamma_sig =
                            (uu___398_23294.FStar_TypeChecker_Env.gamma_sig);
                          FStar_TypeChecker_Env.gamma_cache =
                            (uu___398_23294.FStar_TypeChecker_Env.gamma_cache);
                          FStar_TypeChecker_Env.modules =
                            (uu___398_23294.FStar_TypeChecker_Env.modules);
                          FStar_TypeChecker_Env.expected_typ =
                            (uu___398_23294.FStar_TypeChecker_Env.expected_typ);
                          FStar_TypeChecker_Env.sigtab =
                            (uu___398_23294.FStar_TypeChecker_Env.sigtab);
                          FStar_TypeChecker_Env.attrtab =
                            (uu___398_23294.FStar_TypeChecker_Env.attrtab);
                          FStar_TypeChecker_Env.is_pattern =
                            (uu___398_23294.FStar_TypeChecker_Env.is_pattern);
                          FStar_TypeChecker_Env.instantiate_imp =
                            (uu___398_23294.FStar_TypeChecker_Env.instantiate_imp);
                          FStar_TypeChecker_Env.effects =
                            (uu___398_23294.FStar_TypeChecker_Env.effects);
                          FStar_TypeChecker_Env.generalize =
                            (uu___398_23294.FStar_TypeChecker_Env.generalize);
                          FStar_TypeChecker_Env.letrecs =
                            (uu___398_23294.FStar_TypeChecker_Env.letrecs);
                          FStar_TypeChecker_Env.top_level = top_level;
                          FStar_TypeChecker_Env.check_uvars =
                            (uu___398_23294.FStar_TypeChecker_Env.check_uvars);
                          FStar_TypeChecker_Env.use_eq =
                            (uu___398_23294.FStar_TypeChecker_Env.use_eq);
                          FStar_TypeChecker_Env.is_iface =
                            (uu___398_23294.FStar_TypeChecker_Env.is_iface);
                          FStar_TypeChecker_Env.admit =
                            (uu___398_23294.FStar_TypeChecker_Env.admit);
                          FStar_TypeChecker_Env.lax =
                            (uu___398_23294.FStar_TypeChecker_Env.lax);
                          FStar_TypeChecker_Env.lax_universes =
                            (uu___398_23294.FStar_TypeChecker_Env.lax_universes);
                          FStar_TypeChecker_Env.phase1 =
                            (uu___398_23294.FStar_TypeChecker_Env.phase1);
                          FStar_TypeChecker_Env.failhard =
                            (uu___398_23294.FStar_TypeChecker_Env.failhard);
                          FStar_TypeChecker_Env.nosynth =
                            (uu___398_23294.FStar_TypeChecker_Env.nosynth);
                          FStar_TypeChecker_Env.uvar_subtyping =
                            (uu___398_23294.FStar_TypeChecker_Env.uvar_subtyping);
                          FStar_TypeChecker_Env.tc_term =
                            (uu___398_23294.FStar_TypeChecker_Env.tc_term);
                          FStar_TypeChecker_Env.type_of =
                            (uu___398_23294.FStar_TypeChecker_Env.type_of);
                          FStar_TypeChecker_Env.universe_of =
                            (uu___398_23294.FStar_TypeChecker_Env.universe_of);
                          FStar_TypeChecker_Env.check_type_of =
                            (uu___398_23294.FStar_TypeChecker_Env.check_type_of);
                          FStar_TypeChecker_Env.use_bv_sorts =
                            (uu___398_23294.FStar_TypeChecker_Env.use_bv_sorts);
                          FStar_TypeChecker_Env.qtbl_name_and_index =
                            (uu___398_23294.FStar_TypeChecker_Env.qtbl_name_and_index);
                          FStar_TypeChecker_Env.normalized_eff_names =
                            (uu___398_23294.FStar_TypeChecker_Env.normalized_eff_names);
                          FStar_TypeChecker_Env.fv_delta_depths =
                            (uu___398_23294.FStar_TypeChecker_Env.fv_delta_depths);
                          FStar_TypeChecker_Env.proof_ns =
                            (uu___398_23294.FStar_TypeChecker_Env.proof_ns);
                          FStar_TypeChecker_Env.synth_hook =
                            (uu___398_23294.FStar_TypeChecker_Env.synth_hook);
                          FStar_TypeChecker_Env.splice =
                            (uu___398_23294.FStar_TypeChecker_Env.splice);
                          FStar_TypeChecker_Env.postprocess =
                            (uu___398_23294.FStar_TypeChecker_Env.postprocess);
                          FStar_TypeChecker_Env.is_native_tactic =
                            (uu___398_23294.FStar_TypeChecker_Env.is_native_tactic);
                          FStar_TypeChecker_Env.identifier_info =
                            (uu___398_23294.FStar_TypeChecker_Env.identifier_info);
                          FStar_TypeChecker_Env.tc_hooks =
                            (uu___398_23294.FStar_TypeChecker_Env.tc_hooks);
                          FStar_TypeChecker_Env.dsenv =
                            (uu___398_23294.FStar_TypeChecker_Env.dsenv);
                          FStar_TypeChecker_Env.nbe =
                            (uu___398_23294.FStar_TypeChecker_Env.nbe)
                        }) e11
                      in
                            ...
                            ((let uu____23337 =
                              ...
                              then
                                ...
                                FStar_Util.print3
                                  ...
                                  uu____23340 uu____23342 uu____23344
                              else ());
             ...
             | (univ_opening,univ_vars1) ->
                 ...
                 then
                   ...
                   ((FStar_Pervasives_Native.Some t1),
                     FStar_TypeChecker_Env.trivial_guard, univ_vars1,
                     univ_opening, uu____23472)
                 else
                   (let uu____23479 = FStar_Syntax_Util.type_u ()  in
                    match uu____23479 with
                    | (k,uu____23499) ->
                        let uu____23500 = tc_check_tot_or_gtot_term env1 t1 k
                           in
                             ...
                             ((let uu____23525 =
                                 ...
                                 let uu____23528 =
                                   let uu____23530 =
                                     FStar_Syntax_Util.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname
                                      in
                                   FStar_Range.string_of_range uu____23530
                                    in
                                 let uu____23531 =
                                   FStar_Syntax_Print.term_to_string t2  in
                                 FStar_Util.print2
                                   "(%s) Checked type annotation %s\n"
                                   uu____23528 uu____23531
                               else ());
                              (let t3 = norm env1 t2  in
                               ...
                               ((FStar_Pervasives_Native.Some t3), g,
                                 univ_vars1, univ_opening, uu____23537))))))
          ...
          (match uu____23570 with
           | (tu,u) ->
               ((let uu____23592 =
                 ...
                 if uu____23592
                 then
                   let uu____23595 = FStar_Syntax_Print.bv_to_string x  in
                   let uu____23597 =
                     FStar_Syntax_Print.term_to_string
                       x.FStar_Syntax_Syntax.sort
                      in
                   let uu____23599 = FStar_Syntax_Print.term_to_string tu  in
                   FStar_Util.print3 "Checking binder %s:%s at type %s\n"
                     uu____23595 uu____23597 uu____23599
                 else ());
                (let uu____23604 =
                 ...
                 | (t,uu____23626,g) ->
                     let uu____23628 =
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let uu____23644 = tc_tactic env tau  in
                     ...
                     (match uu____23628 with
                      | (imp1,g') ->
                          let x1 =
                            ((let uu___399_23697 = x  in
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___399_23697.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index =
                                  (uu___399_23697.FStar_Syntax_Syntax.index);
                                FStar_Syntax_Syntax.sort = t
                              }), imp1)
                             in
                          ((let uu____23699 =
                           ...
                           (let uu____23711 = push_binding env x1  in
                            (x1, uu____23711, g, u)))))))
  ...
  fun env  ->
    fun bs  ->
      (let uu____23723 =
       ...
       if uu____23723
       then
         let uu____23726 = FStar_Syntax_Print.binders_to_string ", " bs  in
      ...
      (let rec aux env1 bs1 =
         ...
         | b::bs2 ->
             let uu____23839 = tc_binder env1 b  in
             (match uu____23839 with
              | (b1,env',g,u) ->
                  let uu____23888 = aux env' bs2  in
                       ...
                       let uu____23949 =
                         let uu____23950 =
                           FStar_TypeChecker_Env.close_guard_univs [u] 
                             [b1] g'
                            in
                         FStar_TypeChecker_Env.conj_guard g uu____23950  in
                       ((b1 :: bs3), env'1, uu____23949, (u :: us))))
          in
       aux env bs)
    ...
    fun pats  ->
      let tc_args env1 args =
        FStar_List.fold_right
          (fun uu____24057  ->
             fun uu____24058  ->
               match (uu____24057, uu____24058) with
               | ((t,imp),(args1,g)) ->
                   let uu____24149 = tc_term env1 t  in
                   (match uu____24149 with
                    | (t1,uu____24169,g') ->
                        let uu____24171 =
                          FStar_TypeChecker_Env.conj_guard g g'  in
                        (((t1, imp) :: args1), uu____24171))) args
          ([], FStar_TypeChecker_Env.trivial_guard)
         in
      FStar_List.fold_right
        (fun p  ->
           fun uu____24225  ->
             ...
             | (pats1,g) ->
                 let uu____24252 = tc_args env p  in
                 (match uu____24252 with
                  | (args,g') ->
                      let uu____24265 = FStar_TypeChecker_Env.conj_guard g g'
                         in
                      ((args :: pats1), uu____24265))) pats
        ([], FStar_TypeChecker_Env.trivial_guard)
...
and (tc_tot_or_gtot_term :
  ...
  fun env  ->
    fun e  ->
      let uu____24278 = tc_maybe_toplevel_term env e  in
      match uu____24278 with
      | (e1,c,g) ->
          let uu____24294 = FStar_Syntax_Util.is_tot_or_gtot_lcomp c  in
          if uu____24294
          then (e1, c, g)
          else
                      ...
                      then
                        let uu____24362 =
                          FStar_TypeChecker_Err.expected_ghost_expression e1
                            c2
                           in
                        FStar_Errors.raise_error uu____24362
                          e1.FStar_Syntax_Syntax.pos
                      else
                        (let uu____24376 =
...
and (tc_trivial_guard :
  ...
  fun env  ->
    fun t  ->
      let uu____24400 = tc_tot_or_gtot_term env t  in
  ...
  fun env  ->
    fun e  ->
      (let uu____24433 =
       ...
       if uu____24433
       then
         let uu____24438 = FStar_Syntax_Print.term_to_string e  in
         FStar_Util.print1 "Checking term %s\n" uu____24438
       else ());
      (let env1 =
         let uu___400_24444 = env  in
         {
           FStar_TypeChecker_Env.solver =
             (uu___400_24444.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___400_24444.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___400_24444.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___400_24444.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_sig =
             (uu___400_24444.FStar_TypeChecker_Env.gamma_sig);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___400_24444.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___400_24444.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___400_24444.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___400_24444.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.attrtab =
             (uu___400_24444.FStar_TypeChecker_Env.attrtab);
           FStar_TypeChecker_Env.is_pattern =
             (uu___400_24444.FStar_TypeChecker_Env.is_pattern);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___400_24444.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___400_24444.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___400_24444.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs = [];
           FStar_TypeChecker_Env.top_level = false;
           FStar_TypeChecker_Env.check_uvars =
             (uu___400_24444.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___400_24444.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.is_iface =
             (uu___400_24444.FStar_TypeChecker_Env.is_iface);
           FStar_TypeChecker_Env.admit =
             (uu___400_24444.FStar_TypeChecker_Env.admit);
           FStar_TypeChecker_Env.lax =
             (uu___400_24444.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___400_24444.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.phase1 =
             (uu___400_24444.FStar_TypeChecker_Env.phase1);
           FStar_TypeChecker_Env.failhard =
             (uu___400_24444.FStar_TypeChecker_Env.failhard);
           FStar_TypeChecker_Env.nosynth =
             (uu___400_24444.FStar_TypeChecker_Env.nosynth);
           FStar_TypeChecker_Env.uvar_subtyping =
             (uu___400_24444.FStar_TypeChecker_Env.uvar_subtyping);
           FStar_TypeChecker_Env.tc_term =
             (uu___400_24444.FStar_TypeChecker_Env.tc_term);
           FStar_TypeChecker_Env.type_of =
             (uu___400_24444.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___400_24444.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.check_type_of =
             (uu___400_24444.FStar_TypeChecker_Env.check_type_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___400_24444.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qtbl_name_and_index =
             (uu___400_24444.FStar_TypeChecker_Env.qtbl_name_and_index);
           FStar_TypeChecker_Env.normalized_eff_names =
             (uu___400_24444.FStar_TypeChecker_Env.normalized_eff_names);
           FStar_TypeChecker_Env.fv_delta_depths =
             (uu___400_24444.FStar_TypeChecker_Env.fv_delta_depths);
           FStar_TypeChecker_Env.proof_ns =
             (uu___400_24444.FStar_TypeChecker_Env.proof_ns);
           FStar_TypeChecker_Env.synth_hook =
             (uu___400_24444.FStar_TypeChecker_Env.synth_hook);
           FStar_TypeChecker_Env.splice =
             (uu___400_24444.FStar_TypeChecker_Env.splice);
           FStar_TypeChecker_Env.postprocess =
             (uu___400_24444.FStar_TypeChecker_Env.postprocess);
           FStar_TypeChecker_Env.is_native_tactic =
             (uu___400_24444.FStar_TypeChecker_Env.is_native_tactic);
           FStar_TypeChecker_Env.identifier_info =
             (uu___400_24444.FStar_TypeChecker_Env.identifier_info);
           FStar_TypeChecker_Env.tc_hooks =
             (uu___400_24444.FStar_TypeChecker_Env.tc_hooks);
           FStar_TypeChecker_Env.dsenv =
             (uu___400_24444.FStar_TypeChecker_Env.dsenv);
           FStar_TypeChecker_Env.nbe =
             (uu___400_24444.FStar_TypeChecker_Env.nbe)
         }  in
       let uu____24452 =
         try
           (fun uu___402_24466  ->
         ...
         with
         | FStar_Errors.Error (e1,msg,uu____24487) ->
             let uu____24490 = FStar_TypeChecker_Env.get_range env1  in
             FStar_Errors.raise_error (e1, msg) uu____24490
          in
       match uu____24452 with
       | (t,c,g) ->
           let uu____24507 = FStar_Syntax_Util.is_total_lcomp c  in
           if uu____24507
           then (t, (c.FStar_Syntax_Syntax.res_typ), g)
           else
             (let uu____24518 =
                let uu____24524 =
                  let uu____24526 = FStar_Syntax_Print.term_to_string e  in
                  FStar_Util.format1
                    "Implicit argument: Expected a total term; got a ghost term: %s"
                    uu____24526
                   in
                (FStar_Errors.Fatal_UnexpectedImplictArgument, uu____24524)
                 in
              let uu____24530 = FStar_TypeChecker_Env.get_range env1  in
              FStar_Errors.raise_error uu____24518 uu____24530))
  
let level_of_type_fail :
  'Auu____24546 .
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.term -> Prims.string -> 'Auu____24546
  =
  fun env  ->
    fun e  ->
      fun t  ->
        let uu____24564 =
          let uu____24570 =
            let uu____24572 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format2 "Expected a term of type 'Type'; got %s : %s"
              uu____24572 t
             in
          (FStar_Errors.Fatal_UnexpectedTermType, uu____24570)  in
        let uu____24576 = FStar_TypeChecker_Env.get_range env  in
        FStar_Errors.raise_error uu____24564 uu____24576
    ...
    fun e  ->
      fun t  ->
        let rec aux retry t1 =
          let uu____24614 =
            let uu____24615 = FStar_Syntax_Util.unrefine t1  in
          ...
          | uu____24619 ->
              ...
              then
                ...
                (let uu____24625 = FStar_Syntax_Util.type_u ()  in
                 match uu____24625 with
                 | (t_u,u) ->
                     let env1 =
                       let uu___403_24633 = env  in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___403_24633.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___403_24633.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___403_24633.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___403_24633.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_sig =
                           (uu___403_24633.FStar_TypeChecker_Env.gamma_sig);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___403_24633.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___403_24633.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___403_24633.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___403_24633.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.attrtab =
                           (uu___403_24633.FStar_TypeChecker_Env.attrtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___403_24633.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___403_24633.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___403_24633.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize =
                           (uu___403_24633.FStar_TypeChecker_Env.generalize);
                         FStar_TypeChecker_Env.letrecs =
                           (uu___403_24633.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level =
                           (uu___403_24633.FStar_TypeChecker_Env.top_level);
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___403_24633.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___403_24633.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___403_24633.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___403_24633.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax = true;
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___403_24633.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.phase1 =
                           (uu___403_24633.FStar_TypeChecker_Env.phase1);
                         FStar_TypeChecker_Env.failhard =
                           (uu___403_24633.FStar_TypeChecker_Env.failhard);
                         FStar_TypeChecker_Env.nosynth =
                           (uu___403_24633.FStar_TypeChecker_Env.nosynth);
                         FStar_TypeChecker_Env.uvar_subtyping =
                           (uu___403_24633.FStar_TypeChecker_Env.uvar_subtyping);
                         FStar_TypeChecker_Env.tc_term =
                           (uu___403_24633.FStar_TypeChecker_Env.tc_term);
                         FStar_TypeChecker_Env.type_of =
                           (uu___403_24633.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___403_24633.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.check_type_of =
                           (uu___403_24633.FStar_TypeChecker_Env.check_type_of);
                         FStar_TypeChecker_Env.use_bv_sorts =
                           (uu___403_24633.FStar_TypeChecker_Env.use_bv_sorts);
                         FStar_TypeChecker_Env.qtbl_name_and_index =
                           (uu___403_24633.FStar_TypeChecker_Env.qtbl_name_and_index);
                         FStar_TypeChecker_Env.normalized_eff_names =
                           (uu___403_24633.FStar_TypeChecker_Env.normalized_eff_names);
                         FStar_TypeChecker_Env.fv_delta_depths =
                           (uu___403_24633.FStar_TypeChecker_Env.fv_delta_depths);
                         FStar_TypeChecker_Env.proof_ns =
                           (uu___403_24633.FStar_TypeChecker_Env.proof_ns);
                         FStar_TypeChecker_Env.synth_hook =
                           (uu___403_24633.FStar_TypeChecker_Env.synth_hook);
                         FStar_TypeChecker_Env.splice =
                           (uu___403_24633.FStar_TypeChecker_Env.splice);
                         FStar_TypeChecker_Env.postprocess =
                           (uu___403_24633.FStar_TypeChecker_Env.postprocess);
                         FStar_TypeChecker_Env.is_native_tactic =
                           (uu___403_24633.FStar_TypeChecker_Env.is_native_tactic);
                         FStar_TypeChecker_Env.identifier_info =
                           (uu___403_24633.FStar_TypeChecker_Env.identifier_info);
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___403_24633.FStar_TypeChecker_Env.tc_hooks);
                         FStar_TypeChecker_Env.dsenv =
                           (uu___403_24633.FStar_TypeChecker_Env.dsenv);
                         FStar_TypeChecker_Env.nbe =
                           (uu___403_24633.FStar_TypeChecker_Env.nbe)
                       }  in
                     ...
                     ((match g.FStar_TypeChecker_Env.guard_f with
                       | FStar_TypeChecker_Common.NonTrivial f ->
                           let uu____24638 =
                             FStar_Syntax_Print.term_to_string t1  in
                           level_of_type_fail env1 e uu____24638
                       | uu____24640 ->
                           FStar_TypeChecker_Rel.force_trivial_guard env1 g);
                      u))
           in
...
let rec (universe_of_aux :
  ...
  fun env  ->
    fun e  ->
      let uu____24659 =
        let uu____24660 = FStar_Syntax_Subst.compress e  in
        uu____24660.FStar_Syntax_Syntax.n  in
      match uu____24659 with
      | FStar_Syntax_Syntax.Tm_bvar uu____24665 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_unknown  -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_delayed uu____24672 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_let uu____24698 ->
          let e1 = FStar_TypeChecker_Normalize.normalize [] env e  in
          universe_of_aux env e1
      | FStar_Syntax_Syntax.Tm_abs (bs,t,uu____24715) ->
          level_of_type_fail env e "arrow type"
      | FStar_Syntax_Syntax.Tm_uvar (u,s) ->
          FStar_Syntax_Subst.subst' s u.FStar_Syntax_Syntax.ctx_uvar_typ
      | FStar_Syntax_Syntax.Tm_meta (t,uu____24762) -> universe_of_aux env t
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let uu____24769 =
            FStar_TypeChecker_Env.lookup_lid env
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
             in
          (match uu____24769 with | ((uu____24780,t),uu____24782) -> t)
      | FStar_Syntax_Syntax.Tm_lazy i ->
          let uu____24788 = FStar_Syntax_Util.unfold_lazy i  in
          universe_of_aux env uu____24788
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____24791,(FStar_Util.Inl t,uu____24793),uu____24794) -> t
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____24841,(FStar_Util.Inr c,uu____24843),uu____24844) ->
          FStar_Syntax_Util.comp_result c
      | FStar_Syntax_Syntax.Tm_type u ->
          FStar_Syntax_Syntax.mk
            (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_succ u))
            FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos
      | FStar_Syntax_Syntax.Tm_quoted uu____24892 -> FStar_Syntax_Util.ktype0
      | FStar_Syntax_Syntax.Tm_constant sc ->
          tc_constant env e.FStar_Syntax_Syntax.pos sc
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____24901;
             FStar_Syntax_Syntax.vars = uu____24902;_},us)
          ->
          let uu____24908 =
            FStar_TypeChecker_Env.lookup_lid env
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
          ...
          (match uu____24908 with
           | ((us',t),uu____24921) ->
               (if (FStar_List.length us) <> (FStar_List.length us')
                then
                  (let uu____24928 = FStar_TypeChecker_Env.get_range env  in
                   FStar_Errors.raise_error
                     (FStar_Errors.Fatal_UnexpectedNumberOfUniverse,
                  ...
                  FStar_List.iter2
                    (fun u'  ->
                       fun u  ->
                         ...
                         | FStar_Syntax_Syntax.U_unif u'' ->
                             FStar_Syntax_Unionfind.univ_change u'' u
                         | uu____24947 -> failwith "Impossible") us' us;
                t))
      | FStar_Syntax_Syntax.Tm_uinst uu____24949 ->
          failwith "Impossible: Tm_uinst's head must be an fvar"
      | FStar_Syntax_Syntax.Tm_refine (x,uu____24960) ->
          universe_of_aux env x.FStar_Syntax_Syntax.sort
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____24987 = FStar_Syntax_Subst.open_comp bs c  in
          (match uu____24987 with
           | (bs1,c1) ->
               ...
               let u_res =
                 ...
                 let uu____25029 = universe_of_aux env res  in
                 level_of_type env res uu____25029  in
               let u_c =
      ...
      | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
          let rec type_of_head retry hd2 args1 =
            ...
            | FStar_Syntax_Syntax.Tm_unknown  -> failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_bvar uu____25148 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_delayed uu____25166 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_fvar uu____25206 ->
                let uu____25207 = universe_of_aux env hd3  in
                (uu____25207, args1)
            | FStar_Syntax_Syntax.Tm_name uu____25222 ->
                let uu____25223 = universe_of_aux env hd3  in
                (uu____25223, args1)
            | FStar_Syntax_Syntax.Tm_uvar uu____25238 ->
                let uu____25251 = universe_of_aux env hd3  in
                (uu____25251, args1)
            | FStar_Syntax_Syntax.Tm_uinst uu____25266 ->
                let uu____25273 = universe_of_aux env hd3  in
                (uu____25273, args1)
            | FStar_Syntax_Syntax.Tm_ascribed uu____25288 ->
                let uu____25315 = universe_of_aux env hd3  in
                (uu____25315, args1)
            | FStar_Syntax_Syntax.Tm_refine uu____25330 ->
                let uu____25337 = universe_of_aux env hd3  in
                (uu____25337, args1)
            | FStar_Syntax_Syntax.Tm_constant uu____25352 ->
                let uu____25353 = universe_of_aux env hd3  in
                (uu____25353, args1)
            | FStar_Syntax_Syntax.Tm_arrow uu____25368 ->
                let uu____25383 = universe_of_aux env hd3  in
                (uu____25383, args1)
            | FStar_Syntax_Syntax.Tm_meta uu____25398 ->
                let uu____25405 = universe_of_aux env hd3  in
                (uu____25405, args1)
            | FStar_Syntax_Syntax.Tm_type uu____25420 ->
                let uu____25421 = universe_of_aux env hd3  in
                (uu____25421, args1)
            | FStar_Syntax_Syntax.Tm_match (uu____25436,hd4::uu____25438) ->
                let uu____25503 = FStar_Syntax_Subst.open_branch hd4  in
                (match uu____25503 with
                 | (uu____25520,uu____25521,hd5) ->
                     let uu____25539 = FStar_Syntax_Util.head_and_args hd5
                        in
                     (match uu____25539 with
                      | (hd6,args2) -> type_of_head retry hd6 args2))
            | uu____25598 when retry ->
                let e1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Env.Beta;
                    FStar_TypeChecker_Env.DoNotUnfoldPureLets] env e
                   in
                let uu____25600 = FStar_Syntax_Util.head_and_args e1  in
            ...
            | uu____25660 ->
                ...
                (match uu____25661 with
                 | (env1,uu____25685) ->
                     let env2 =
                       let uu___404_25691 = env1  in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___404_25691.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___404_25691.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___404_25691.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___404_25691.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_sig =
                           (uu___404_25691.FStar_TypeChecker_Env.gamma_sig);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___404_25691.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___404_25691.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___404_25691.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___404_25691.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.attrtab =
                           (uu___404_25691.FStar_TypeChecker_Env.attrtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___404_25691.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___404_25691.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___404_25691.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize =
                           (uu___404_25691.FStar_TypeChecker_Env.generalize);
                         FStar_TypeChecker_Env.letrecs =
                           (uu___404_25691.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level = false;
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___404_25691.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___404_25691.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___404_25691.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___404_25691.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax = true;
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___404_25691.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.phase1 =
                           (uu___404_25691.FStar_TypeChecker_Env.phase1);
                         FStar_TypeChecker_Env.failhard =
                           (uu___404_25691.FStar_TypeChecker_Env.failhard);
                         FStar_TypeChecker_Env.nosynth =
                           (uu___404_25691.FStar_TypeChecker_Env.nosynth);
                         FStar_TypeChecker_Env.uvar_subtyping =
                           (uu___404_25691.FStar_TypeChecker_Env.uvar_subtyping);
                         FStar_TypeChecker_Env.tc_term =
                           (uu___404_25691.FStar_TypeChecker_Env.tc_term);
                         FStar_TypeChecker_Env.type_of =
                           (uu___404_25691.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___404_25691.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.check_type_of =
                           (uu___404_25691.FStar_TypeChecker_Env.check_type_of);
                         FStar_TypeChecker_Env.use_bv_sorts = true;
                         FStar_TypeChecker_Env.qtbl_name_and_index =
                           (uu___404_25691.FStar_TypeChecker_Env.qtbl_name_and_index);
                         FStar_TypeChecker_Env.normalized_eff_names =
                           (uu___404_25691.FStar_TypeChecker_Env.normalized_eff_names);
                         FStar_TypeChecker_Env.fv_delta_depths =
                           (uu___404_25691.FStar_TypeChecker_Env.fv_delta_depths);
                         FStar_TypeChecker_Env.proof_ns =
                           (uu___404_25691.FStar_TypeChecker_Env.proof_ns);
                         FStar_TypeChecker_Env.synth_hook =
                           (uu___404_25691.FStar_TypeChecker_Env.synth_hook);
                         FStar_TypeChecker_Env.splice =
                           (uu___404_25691.FStar_TypeChecker_Env.splice);
                         FStar_TypeChecker_Env.postprocess =
                           (uu___404_25691.FStar_TypeChecker_Env.postprocess);
                         FStar_TypeChecker_Env.is_native_tactic =
                           (uu___404_25691.FStar_TypeChecker_Env.is_native_tactic);
                         FStar_TypeChecker_Env.identifier_info =
                           (uu___404_25691.FStar_TypeChecker_Env.identifier_info);
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___404_25691.FStar_TypeChecker_Env.tc_hooks);
                         FStar_TypeChecker_Env.dsenv =
                           (uu___404_25691.FStar_TypeChecker_Env.dsenv);
                         FStar_TypeChecker_Env.nbe =
                           (uu___404_25691.FStar_TypeChecker_Env.nbe)
                       }  in
                     ((let uu____25696 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
                       ...
                       then
                         let uu____25701 =
                           ...
                           FStar_Range.string_of_range uu____25703  in
                         let uu____25704 =
                           FStar_Syntax_Print.term_to_string hd3  in
                         FStar_Util.print2 "%s: About to type-check %s\n"
                           uu____25701 uu____25704
                       else ());
                      (let uu____25709 = tc_term env2 hd3  in
                       ...
                       | (uu____25732,{
                           ...
                           ((let uu____25750 =
                               FStar_TypeChecker_Rel.solve_deferred_constraints
                                 env2 g
                                in
                             FStar_All.pipe_right uu____25750 (fun a1  -> ()));
                            (t, args1)))))
             in
          let uu____25763 = type_of_head true hd1 args  in
           ...
           | (t,args1) ->
               let t1 =
                 FStar_TypeChecker_Normalize.normalize
                  ...
                  in
               let uu____25810 = FStar_Syntax_Util.arrow_formals_comp t1  in
                ...
                | (bs,res) ->
                    ...
                    then
                      ...
                      (let uu____25866 =
                       ...
                       level_of_type_fail env e uu____25866)))
      | FStar_Syntax_Syntax.Tm_match (uu____25870,hd1::uu____25872) ->
          let uu____25937 = FStar_Syntax_Subst.open_branch hd1  in
          (match uu____25937 with
           | (uu____25940,uu____25941,hd2) -> universe_of_aux env hd2)
      | FStar_Syntax_Syntax.Tm_match (uu____25959,[]) ->
...
let (universe_of :
  ...
  fun env  ->
    fun e  ->
      let uu____26008 = universe_of_aux env e  in
      level_of_type env e uu____26008
...
let (tc_tparams :
  ...
  fun env  ->
    fun tps  ->
      let uu____26034 = tc_binders env tps  in
...
let rec (type_of_well_typed_term :
  ...
  fun env  ->
    fun t  ->
      ...
      let t1 = FStar_Syntax_Subst.compress t  in
      match t1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_delayed uu____26092 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_bvar uu____26118 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_name x ->
          FStar_Pervasives_Native.Some (x.FStar_Syntax_Syntax.sort)
      | FStar_Syntax_Syntax.Tm_lazy i ->
          let uu____26124 = FStar_Syntax_Util.unfold_lazy i  in
          type_of_well_typed_term env uu____26124
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let uu____26126 =
            FStar_TypeChecker_Env.try_lookup_and_inst_lid env []
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
             in
          FStar_Util.bind_opt uu____26126
            (fun uu____26140  ->
               match uu____26140 with
               | (t2,uu____26148) -> FStar_Pervasives_Native.Some t2)
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____26150;
             FStar_Syntax_Syntax.vars = uu____26151;_},us)
          ->
          let uu____26157 =
            FStar_TypeChecker_Env.try_lookup_and_inst_lid env us
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
             in
          FStar_Util.bind_opt uu____26157
            (fun uu____26171  ->
               match uu____26171 with
               | (t2,uu____26179) -> FStar_Pervasives_Native.Some t2)
      | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify ) ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect
          uu____26180) -> FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_constant sc ->
          let uu____26182 = tc_constant env t1.FStar_Syntax_Syntax.pos sc  in
          FStar_Pervasives_Native.Some uu____26182
      | FStar_Syntax_Syntax.Tm_type u ->
          let uu____26184 = mk_tm_type (FStar_Syntax_Syntax.U_succ u)  in
          FStar_Pervasives_Native.Some uu____26184
      | FStar_Syntax_Syntax.Tm_abs
          (bs,body,FStar_Pervasives_Native.Some
           { FStar_Syntax_Syntax.residual_effect = eff;
             FStar_Syntax_Syntax.residual_typ = FStar_Pervasives_Native.Some
               tbody;
             FStar_Syntax_Syntax.residual_flags = uu____26189;_})
          ->
          let mk_comp =
            let uu____26233 =
          ...
          FStar_Util.bind_opt mk_comp
            (fun f  ->
               let uu____26334 = universe_of_well_typed_term env tbody  in
               FStar_Util.bind_opt uu____26334
                 (fun u  ->
                    let uu____26342 =
                      let uu____26345 =
                        let uu____26352 =
                          let uu____26353 =
                            ...
                            (bs, uu____26368)  in
                          FStar_Syntax_Syntax.Tm_arrow uu____26353  in
                        FStar_Syntax_Syntax.mk uu____26352  in
                      uu____26345 FStar_Pervasives_Native.None
                        t1.FStar_Syntax_Syntax.pos
                       in
                    FStar_Pervasives_Native.Some uu____26342))
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____26408 = FStar_Syntax_Subst.open_comp bs c  in
                 ...
                 | [] ->
                     let uu____26467 =
                       universe_of_well_typed_term env1
                         (FStar_Syntax_Util.comp_result c1)
                        in
                     FStar_Util.bind_opt uu____26467
                       (fun uc  ->
                          let uu____26475 =
                            mk_tm_type (FStar_Syntax_Syntax.U_max (uc :: us))
                             in
                          FStar_Pervasives_Native.Some uu____26475)
                 | (x,imp)::bs3 ->
                     let uu____26501 =
                       universe_of_well_typed_term env1
                         x.FStar_Syntax_Syntax.sort
                        in
                     FStar_Util.bind_opt uu____26501
                       (fun u_x  ->
                          let env2 = FStar_TypeChecker_Env.push_bv env1 x  in
                          aux env2 (u_x :: us) bs3)
                  in
               aux env [] bs1)
      | FStar_Syntax_Syntax.Tm_abs uu____26510 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_refine (x,uu____26530) ->
          let uu____26535 =
            universe_of_well_typed_term env x.FStar_Syntax_Syntax.sort  in
          FStar_Util.bind_opt uu____26535
            (fun u_x  ->
               let uu____26543 = mk_tm_type u_x  in
               FStar_Pervasives_Native.Some uu____26543)
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_range_of );
             FStar_Syntax_Syntax.pos = uu____26548;
             FStar_Syntax_Syntax.vars = uu____26549;_},a::hd1::rest)
          ->
          let rest1 = hd1 :: rest  in
          let uu____26628 = FStar_Syntax_Util.head_and_args t1  in
          (match uu____26628 with
           | (unary_op1,uu____26648) ->
               let head1 =
                 let uu____26676 =
                 ...
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (unary_op1, [a]))
                   FStar_Pervasives_Native.None uu____26676
                  in
               let t2 =
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (head1, rest1))
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_set_range_of );
             FStar_Syntax_Syntax.pos = uu____26724;
             FStar_Syntax_Syntax.vars = uu____26725;_},a1::a2::hd1::rest)
          ->
          let rest1 = hd1 :: rest  in
          let uu____26821 = FStar_Syntax_Util.head_and_args t1  in
          (match uu____26821 with
           | (unary_op1,uu____26841) ->
               let head1 =
                 let uu____26869 =
                   FStar_Range.union_ranges unary_op1.FStar_Syntax_Syntax.pos
                     (FStar_Pervasives_Native.fst a1).FStar_Syntax_Syntax.pos
                 ...
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (unary_op1, [a1; a2]))
                   FStar_Pervasives_Native.None uu____26869
                  in
               let t2 =
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (head1, rest1))
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_range_of );
             FStar_Syntax_Syntax.pos = uu____26925;
             FStar_Syntax_Syntax.vars = uu____26926;_},uu____26927::[])
          -> FStar_Pervasives_Native.Some FStar_Syntax_Syntax.t_range
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_set_range_of );
             FStar_Syntax_Syntax.pos = uu____26966;
             FStar_Syntax_Syntax.vars = uu____26967;_},(t2,uu____26969)::uu____26970::[])
          -> type_of_well_typed_term env t2
      | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
          ...
          let rec aux t_hd1 =
            ...
            | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
                ...
                let bs_t_opt =
                  if n_args < n_bs
                  then
                    let uu____27150 = FStar_Util.first_N n_args bs  in
                    ...
                    | (bs1,rest) ->
                        let t2 =
                          FStar_Syntax_Syntax.mk
                           ...
                           in
                        let uu____27242 =
                          let uu____27247 = FStar_Syntax_Syntax.mk_Total t2
                             in
                          FStar_Syntax_Subst.open_comp bs1 uu____27247  in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____27309 = FStar_Syntax_Subst.open_comp bs c
                          in
                     ...
                     | (bs1,t2) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args
                            in
                         let uu____27488 = FStar_Syntax_Subst.subst subst1 t2
                            in
                         FStar_Pervasives_Native.Some uu____27488)
            | FStar_Syntax_Syntax.Tm_refine (x,uu____27490) ->
                aux x.FStar_Syntax_Syntax.sort
            | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____27496,uu____27497) ->
                aux t2
            | uu____27538 -> FStar_Pervasives_Native.None  in
          FStar_Util.bind_opt t_hd aux
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____27539,(FStar_Util.Inl t2,uu____27541),uu____27542) ->
          FStar_Pervasives_Native.Some t2
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____27589,(FStar_Util.Inr c,uu____27591),uu____27592) ->
          FStar_Pervasives_Native.Some (FStar_Syntax_Util.comp_result c)
      | FStar_Syntax_Syntax.Tm_uvar (u,s) ->
          let uu____27657 =
            FStar_Syntax_Subst.subst' s u.FStar_Syntax_Syntax.ctx_uvar_typ
             in
          FStar_Pervasives_Native.Some uu____27657
      | FStar_Syntax_Syntax.Tm_quoted (tm,qi) ->
          FStar_Pervasives_Native.Some FStar_Syntax_Syntax.t_term
      | FStar_Syntax_Syntax.Tm_meta (t2,uu____27665) ->
          type_of_well_typed_term env t2
      | FStar_Syntax_Syntax.Tm_match uu____27670 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_let uu____27693 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_uinst uu____27707 ->
          FStar_Pervasives_Native.None
...
and (universe_of_well_typed_term :
  ...
  fun env  ->
    fun t  ->
      let uu____27718 = type_of_well_typed_term env t  in
      match uu____27718 with
      | FStar_Pervasives_Native.Some
          { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_type u;
            FStar_Syntax_Syntax.pos = uu____27724;
            FStar_Syntax_Syntax.vars = uu____27725;_}
          -> FStar_Pervasives_Native.Some u
      | uu____27728 -> FStar_Pervasives_Native.None
    ...
    fun env  ->
      fun t  ->
        fun k  ->
          ...
          let env2 =
            let uu___405_27756 = env1  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___405_27756.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___405_27756.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___405_27756.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___405_27756.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___405_27756.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___405_27756.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___405_27756.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___405_27756.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___405_27756.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___405_27756.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___405_27756.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___405_27756.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___405_27756.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___405_27756.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___405_27756.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___405_27756.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___405_27756.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___405_27756.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___405_27756.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___405_27756.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___405_27756.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___405_27756.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___405_27756.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___405_27756.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___405_27756.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___405_27756.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___405_27756.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___405_27756.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___405_27756.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___405_27756.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts = true;
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___405_27756.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___405_27756.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___405_27756.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___405_27756.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___405_27756.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___405_27756.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___405_27756.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___405_27756.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___405_27756.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___405_27756.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___405_27756.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___405_27756.FStar_TypeChecker_Env.nbe)
            }  in
          let slow_check uu____27763 =
            if must_total
            then
              let uu____27765 = env2.FStar_TypeChecker_Env.type_of env2 t  in
              match uu____27765 with | (uu____27772,uu____27773,g) -> g
            else
              (let uu____27777 = env2.FStar_TypeChecker_Env.tc_term env2 t
                  in
               match uu____27777 with | (uu____27784,uu____27785,g) -> g)
             in
          let uu____27787 = type_of_well_typed_term env2 t  in
          ...
          | FStar_Pervasives_Native.Some k' ->
              ((let uu____27792 =
                ...
                then
                  ...
                  let uu____27801 = FStar_Syntax_Print.term_to_string k'  in
                  let uu____27803 = FStar_Syntax_Print.term_to_string k  in
                  FStar_Util.print4 "(%s) Fast check  %s : %s <:? %s\n"
                    uu____27797 uu____27799 uu____27801 uu____27803
                else ());
                 ...
                 then
                   let uu____27817 =
                     FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos
                      in
                   let uu____27819 = FStar_Syntax_Print.term_to_string t  in
                   let uu____27821 = FStar_Syntax_Print.term_to_string k'  in
                   let uu____27823 = FStar_Syntax_Print.term_to_string k  in
                   FStar_Util.print5 "(%s) Fast check %s: %s : %s <: %s\n"
                     uu____27817
                     (if FStar_Option.isSome g
                      then "succeeded with guard"
                      else "failed") uu____27819 uu____27821 uu____27823
                 else ());
                (match g with
                 | FStar_Pervasives_Native.None  -> slow_check ()
    ...
    fun env  ->
      fun t  ->
        fun k  ->
          let env1 = FStar_TypeChecker_Env.set_expected_typ env k  in
          let env2 =
            let uu___406_27860 = env1  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___406_27860.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___406_27860.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___406_27860.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___406_27860.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___406_27860.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___406_27860.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___406_27860.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___406_27860.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___406_27860.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___406_27860.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___406_27860.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___406_27860.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___406_27860.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___406_27860.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___406_27860.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___406_27860.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___406_27860.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___406_27860.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___406_27860.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___406_27860.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___406_27860.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___406_27860.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___406_27860.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___406_27860.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___406_27860.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___406_27860.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___406_27860.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___406_27860.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___406_27860.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___406_27860.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts = true;
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___406_27860.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___406_27860.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___406_27860.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___406_27860.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___406_27860.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___406_27860.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___406_27860.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___406_27860.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___406_27860.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___406_27860.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___406_27860.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___406_27860.FStar_TypeChecker_Env.nbe)
            }  in
          let slow_check uu____27867 =
            if must_total
            then
              let uu____27869 = env2.FStar_TypeChecker_Env.type_of env2 t  in
              match uu____27869 with | (uu____27876,uu____27877,g) -> g
            else
              (let uu____27881 = env2.FStar_TypeChecker_Env.tc_term env2 t
                  in
               match uu____27881 with | (uu____27888,uu____27889,g) -> g)
             in
          let uu____27891 =
            let uu____27893 = FStar_Options.__temp_fast_implicits ()  in
            FStar_All.pipe_left Prims.op_Negation uu____27893  in
          if uu____27891
          then slow_check ()
