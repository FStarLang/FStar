...
and tc_constant:
  ...
  fun r  ->
    fun c  ->
      ...
      | FStar_Const.Const_float uu____3946 ->
          FStar_TypeChecker_Common.t_float
      | FStar_Const.Const_char uu____3947 -> FStar_TypeChecker_Common.t_char
      | FStar_Const.Const_effect  -> FStar_Syntax_Util.ktype0
      | FStar_Const.Const_range uu____3948 ->
          FStar_TypeChecker_Common.t_range
      | uu____3949 -> raise (FStar_Errors.Error ("Unsupported constant", r))
and tc_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
  ...
  fun env  ->
    fun c  ->
      let c0 = c in
      match c.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Total (t,uu____3960) ->
          let uu____3967 = FStar_Syntax_Util.type_u () in
          (match uu____3967 with
           | (k,u) ->
               let uu____3975 = tc_check_tot_or_gtot_term env t k in
               (match uu____3975 with
                | (t1,uu____3983,g) ->
                    ...
                    (uu____3985, u, g)))
      | FStar_Syntax_Syntax.GTotal (t,uu____3987) ->
          let uu____3994 = FStar_Syntax_Util.type_u () in
          (match uu____3994 with
           | (k,u) ->
               let uu____4002 = tc_check_tot_or_gtot_term env t k in
          ...
          let tc =
            let uu____4028 =
              let uu____4029 =
                ...
                uu____4030 :: (c1.FStar_Syntax_Syntax.effect_args) in
              FStar_Syntax_Syntax.mk_Tm_app head2 uu____4029 in
            uu____4028 FStar_Pervasives_Native.None
              (c1.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
          let uu____4035 =
            tc_check_tot_or_gtot_term env tc FStar_Syntax_Syntax.teff in
          (match uu____4035 with
           | (tc1,uu____4043,f) ->
               let uu____4045 = FStar_Syntax_Util.head_and_args tc1 in
               (match uu____4045 with
                | (head3,args) ->
                    let comp_univs =
                      let uu____4075 =
                        let uu____4076 = FStar_Syntax_Subst.compress head3 in
                        uu____4076.FStar_Syntax_Syntax.n in
                      match uu____4075 with
                      | FStar_Syntax_Syntax.Tm_uinst (uu____4079,us) -> us
                      | uu____4085 -> [] in
                    let uu____4086 = FStar_Syntax_Util.head_and_args tc1 in
                    (match uu____4086 with
                     | (uu____4099,args1) ->
                         let uu____4115 =
                           let uu____4127 = FStar_List.hd args1 in
                           let uu____4136 = FStar_List.tl args1 in
                           (uu____4127, uu____4136) in
                          ...
                          | (res,args2) ->
                              ...
                              (match uu____4178 with
                               | (flags,guards) ->
                                   ...
                                   let c2 =
                                     FStar_Syntax_Syntax.mk_Comp
                                       (let uu___105_4239 = c1 in
                                        {
                                          FStar_Syntax_Syntax.comp_univs =
                                            comp_univs;
                                          FStar_Syntax_Syntax.effect_name =
                                            (uu___105_4239.FStar_Syntax_Syntax.effect_name);
                                          FStar_Syntax_Syntax.result_typ =
                                            (FStar_Pervasives_Native.fst res);
                                          FStar_Syntax_Syntax.effect_args =
                                            args2;
                                          FStar_Syntax_Syntax.flags =
                                            (uu___105_4239.FStar_Syntax_Syntax.flags)
                                        }) in
                                   let u_c =
                                     let uu____4243 =
  ...
  fun env  ->
    fun u  ->
      let rec aux u1 =
        ...
        match u2 with
        | FStar_Syntax_Syntax.U_bvar uu____4254 ->
            failwith "Impossible: locally nameless"
        | FStar_Syntax_Syntax.U_unknown  -> failwith "Unknown universe"
        | FStar_Syntax_Syntax.U_unif uu____4255 -> u2
        | FStar_Syntax_Syntax.U_zero  -> u2
        | FStar_Syntax_Syntax.U_succ u3 ->
            let uu____4259 = aux u3 in FStar_Syntax_Syntax.U_succ uu____4259
        | FStar_Syntax_Syntax.U_max us ->
            let uu____4262 = FStar_List.map aux us in
            FStar_Syntax_Syntax.U_max uu____4262
      ...
      then FStar_Syntax_Syntax.U_zero
        ...
        (match u with
         | FStar_Syntax_Syntax.U_unknown  ->
             let uu____4266 = FStar_Syntax_Util.type_u () in
             FStar_All.pipe_right uu____4266 FStar_Pervasives_Native.snd
         | uu____4271 -> aux u)
and tc_abs:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
        ...
        fun body  ->
              ...
              let uu____4293 =
                let uu____4296 =
                  FStar_TypeChecker_Err.expected_a_term_of_type_t_got_a_function
                    env msg t top in
                (uu____4296, (top.FStar_Syntax_Syntax.pos)) in
              FStar_Errors.Error uu____4293 in
            raise uu____4292 in
          let check_binders env1 bs1 bs_expected =
            let rec aux uu____4350 bs2 bs_expected1 =
                  ...
                  (match (bs2, bs_expected1) with
                   ...
                   | ((hd1,imp)::bs3,(hd_expected,imp')::bs_expected2) ->
                       ((match (imp, imp') with
                         | (FStar_Pervasives_Native.None
                            ,FStar_Pervasives_Native.Some
                            (FStar_Syntax_Syntax.Implicit uu____4441)) ->
                             let uu____4444 =
                               let uu____4445 =
                                 let uu____4448 =
                                   let uu____4449 =
                            ...
                            uu____4451),FStar_Pervasives_Native.None ) ->
                             let uu____4454 =
                               let uu____4455 =
                                 ...
                                 let uu____4460 =
                                   FStar_Syntax_Syntax.range_of_bv hd1 in
                                 (uu____4458, uu____4460) in
                               FStar_Errors.Error uu____4455 in
                             raise uu____4454
                         | uu____4461 -> ());
                        (let expected_t =
                         ...
                         | (t,g1) ->
                             let hd2 =
                               let uu___106_4508 = hd1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___106_4508.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___106_4508.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = t
                               } in
                             let b = (hd2, imp) in
          ...
          let rec expected_function_typ1 env1 t0 body1 =
            ...
            | FStar_Pervasives_Native.None  ->
                ((match env1.FStar_TypeChecker_Env.letrecs with
                 ...
                 (let uu____4623 = tc_binders env1 bs in
                  match uu____4623 with
                  | (bs1,envbody,g,uu____4644) ->
                      let uu____4645 =
                        let uu____4652 =
                          let uu____4653 = FStar_Syntax_Subst.compress body1 in
                          uu____4653.FStar_Syntax_Syntax.n in
                        match uu____4652 with
                        | FStar_Syntax_Syntax.Tm_ascribed
                            (e,(FStar_Util.Inr c,tacopt),uu____4665) ->
                            let uu____4701 = tc_comp envbody c in
            ...
            | FStar_Pervasives_Native.Some t ->
                ...
                let rec as_function_typ norm1 t2 =
                  let uu____4778 =
                    let uu____4779 = FStar_Syntax_Subst.compress t2 in
                    uu____4779.FStar_Syntax_Syntax.n in
                  match uu____4778 with
                  | FStar_Syntax_Syntax.Tm_uvar uu____4796 ->
                      ((match env1.FStar_TypeChecker_Env.letrecs with
                        | [] -> ()
                        | uu____4808 -> failwith "Impossible");
                       (let uu____4812 = tc_binders env1 bs in
                        match uu____4812 with
                        | (bs1,envbody,g,uu____4834) ->
                            let uu____4835 =
                              FStar_TypeChecker_Env.clear_expected_typ
                                envbody in
                  ...
                  | FStar_Syntax_Syntax.Tm_app
                      ({
                         FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                           uu____4865;
                         FStar_Syntax_Syntax.tk = uu____4866;
                         FStar_Syntax_Syntax.pos = uu____4867;
                         FStar_Syntax_Syntax.vars = uu____4868;_},uu____4869)
                      ->
                      ((match env1.FStar_TypeChecker_Env.letrecs with
                        | [] -> ()
                        | uu____4895 -> failwith "Impossible");
                       (let uu____4899 = tc_binders env1 bs in
                        match uu____4899 with
                        | (bs1,envbody,g,uu____4921) ->
                            let uu____4922 =
                              FStar_TypeChecker_Env.clear_expected_typ
                                envbody in
                            (match uu____4922 with
                             | (envbody1,uu____4941) ->
                                 ((FStar_Pervasives_Native.Some (t2, true)),
                                   ...
                                   FStar_Pervasives_Native.None, envbody1,
                                   body1, g))))
                  | FStar_Syntax_Syntax.Tm_refine (b,uu____4953) ->
                      let uu____4958 =
                        as_function_typ norm1 b.FStar_Syntax_Syntax.sort in
                      (match uu____4958 with
                       | (uu____4987,bs1,bs',copt,tacopt,env2,body2,g) ->
                      ...
                      (match uu____5027 with
                       | (bs_expected1,c_expected1) ->
                           let check_actuals_against_formals env2 bs1
                             bs_expected2 =
                             let rec handle_more uu____5090 c_expected2 =
                             ...
                             handle_more uu____5292 c_expected1 in
                           let mk_letrec_env envbody bs1 c =
                             let letrecs = guard_letrecs envbody bs1 c in
                             let envbody1 =
                               let uu___107_5330 = envbody in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___107_5330.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___107_5330.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___107_5330.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___107_5330.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___107_5330.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___107_5330.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___107_5330.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___107_5330.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern =
                                   (uu___107_5330.FStar_TypeChecker_Env.is_pattern);
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___107_5330.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___107_5330.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___107_5330.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs = [];
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___107_5330.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___107_5330.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq =
                                   (uu___107_5330.FStar_TypeChecker_Env.use_eq);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___107_5330.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___107_5330.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax =
                                   (uu___107_5330.FStar_TypeChecker_Env.lax);
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___107_5330.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___107_5330.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___107_5330.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___107_5330.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___107_5330.FStar_TypeChecker_Env.qname_and_index)
                               } in
                             FStar_All.pipe_right letrecs
                               (FStar_List.fold_left
                                  (fun uu____5344  ->
                                     fun uu____5345  ->
                                       match (uu____5344, uu____5345) with
                                           ...
                                           let uu____5370 =
                                             let uu____5374 =
                                               ...
                                               FStar_All.pipe_right
                                                 uu____5375
                                                 FStar_Pervasives_Native.fst in
                                             tc_term uu____5374 t3 in
                                           (match uu____5370 with
                                            | (t4,uu____5387,uu____5388) ->
                                                let env3 =
                                                        ...
                                                        FStar_Syntax_Syntax.mk_binder
                                                          (let uu___108_5396
                                                             = x in
                                                           {
                                                             FStar_Syntax_Syntax.ppname
                                                               =
                                                               (uu___108_5396.FStar_Syntax_Syntax.ppname);
                                                             FStar_Syntax_Syntax.index
                                                               =
                                                               (uu___108_5396.FStar_Syntax_Syntax.index);
                  ...
                  | uu____5472 ->
                      ...
                      then
                        ...
                        as_function_typ true uu____5487
                      else
                        (let uu____5489 =
                           expected_function_typ1 env1
                             FStar_Pervasives_Native.None body1 in
                         match uu____5489 with
                         | (uu____5517,bs1,uu____5519,c_opt,tacopt,envbody,body2,g)
                             ->
                             ((FStar_Pervasives_Native.Some (t2, false)),
                               bs1, [], c_opt, tacopt, envbody, body2, g)) in
                as_function_typ false t1 in
          let use_eq = env.FStar_TypeChecker_Env.use_eq in
          let uu____5544 = FStar_TypeChecker_Env.clear_expected_typ env in
          ...
          | (env1,topt) ->
              ((let uu____5556 =
               ...
               (let uu____5561 = expected_function_typ1 env1 topt body in
                match uu____5561 with
                | (tfun_opt,bs1,letrec_binders,c_opt,tacopt,envbody,body1,g)
                    ->
                    let uu____5596 =
                      tc_term
                        (let uu___109_5600 = envbody in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___109_5600.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___109_5600.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___109_5600.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___109_5600.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___109_5600.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___109_5600.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ =
                             (uu___109_5600.FStar_TypeChecker_Env.expected_typ);
                           FStar_TypeChecker_Env.sigtab =
                             (uu___109_5600.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___109_5600.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___109_5600.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___109_5600.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___109_5600.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___109_5600.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level = false;
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___109_5600.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq = use_eq;
                           FStar_TypeChecker_Env.is_iface =
                             (uu___109_5600.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___109_5600.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax =
                             (uu___109_5600.FStar_TypeChecker_Env.lax);
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___109_5600.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.type_of =
                             (uu___109_5600.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___109_5600.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts =
                             (uu___109_5600.FStar_TypeChecker_Env.use_bv_sorts);
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___109_5600.FStar_TypeChecker_Env.qname_and_index)
                         }) body1 in
                         ...
                         ((let uu____5609 =
                           ...
                           then
                             ...
                             let uu____5619 =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Print.comp_to_string uu____5620 in
                             FStar_Util.print2
                          ...
                          (let uu____5622 =
                             ...
                             check_expected_effect
                               (let uu___110_5634 = envbody in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___110_5634.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___110_5634.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___110_5634.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___110_5634.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___110_5634.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___110_5634.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___110_5634.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___110_5634.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___110_5634.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___110_5634.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___110_5634.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___110_5634.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___110_5634.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___110_5634.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___110_5634.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq = use_eq;
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___110_5634.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___110_5634.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax =
                                    (uu___110_5634.FStar_TypeChecker_Env.lax);
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___110_5634.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___110_5634.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___110_5634.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts =
                                    (uu___110_5634.FStar_TypeChecker_Env.use_bv_sorts);
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___110_5634.FStar_TypeChecker_Env.qname_and_index)
                                }) c_opt uu____5626 in
                           ...
                           | (body3,cbody1,guard) ->
                               ...
                               let e =
                                 let uu____5655 =
                                   ...
                                   FStar_Pervasives_Native.Some uu____5662 in
                                 FStar_Syntax_Util.abs bs1 body3 uu____5655 in
                               let uu____5682 =
                                 match tfun_opt with
            ...
            fun expected_topt  ->
              ...
              (let uu____5767 =
               ...
               then
                 ...
                 let uu____5769 = FStar_Syntax_Print.term_to_string thead in
                 FStar_Util.print2 "(%s) Type of head is %s\n" uu____5768
                   uu____5769
               else ());
              (let monadic_application uu____5807 subst1 arg_comps_rev
                 ...
                 | (head2,chead1,ghead1,cres) ->
                     ...
                     let cres1 =
                       let uu___111_5844 = cres in
                       {
                         FStar_Syntax_Syntax.eff_name =
                           (uu___111_5844.FStar_Syntax_Syntax.eff_name);
                         FStar_Syntax_Syntax.res_typ = rt;
                         FStar_Syntax_Syntax.cflags =
                           (uu___111_5844.FStar_Syntax_Syntax.cflags);
                         FStar_Syntax_Syntax.comp =
                           (uu___111_5844.FStar_Syntax_Syntax.comp)
                       } in
                     let uu____5845 =
                       match bs with
                       | [] ->
                             ...
                             let uu____5861 =
                               let uu____5864 =
                                 let uu____5865 =
                                   ...
                                   FStar_Syntax_Util.arrow bs uu____5866 in
                                 FStar_All.pipe_left
                                   (FStar_Syntax_Subst.subst subst1)
                                   uu____5865 in
                               FStar_Syntax_Syntax.mk_Total uu____5864 in
                             FStar_All.pipe_left
                               FStar_Syntax_Util.lcomp_of_comp uu____5861 in
                           (uu____5860, g) in
                                ...
                                (let uu____5972 =
                                       ...
                                       let uu____6111 =
                                         let uu____6119 =
                                           ...
                                           (uu____6124,
                                             FStar_Pervasives_Native.None,
                                             chead1) in
                                         uu____6119 :: arg_comps_rev in
                                       FStar_List.map map_fun uu____6111 in
                                   ...
                                   | (lifted_args,reverse_args) ->
                                       ...
                                       let uu____6225 =
                                         ...
                                         FStar_List.rev uu____6229 in
                                       (lifted_args, uu____6219, uu____6225) in
                                 ...
                                 | (lifted_args,head3,args1) ->
                                     ...
                                     let app2 =
                                       FStar_TypeChecker_Util.maybe_monadic
                                         ...
                                         comp1.FStar_Syntax_Syntax.eff_name
                                         comp1.FStar_Syntax_Syntax.res_typ in
                                     let bind_lifted_args e uu___86_6297 =
                                       match uu___86_6297 with
               ...
               let rec tc_args head_info uu____6441 bs args1 =
                 match uu____6441 with
                 | (subst1,outargs,arg_rets,g,fvs) ->
                     (match (bs, args1) with
                      | ((x,FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Implicit uu____6524))::rest,
                         (uu____6526,FStar_Pervasives_Native.None )::uu____6527)
                          ->
                          let t =
                            FStar_Syntax_Subst.subst subst1
                              x.FStar_Syntax_Syntax.sort in
                                 ...
                                 let uu____6607 =
                                   let uu____6615 =
                                     ...
                                     (arg, FStar_Pervasives_Native.None,
                                       uu____6622) in
                                   uu____6615 :: outargs in
                                 let uu____6633 =
                                   FStar_TypeChecker_Rel.conj_guard implicits
                                     g in
                                 (subst2, uu____6607, (arg :: arg_rets),
                                   uu____6633, fvs) in
                               tc_args head_info uu____6589 rest args1)
                      | ((x,aqual)::rest,(e,aq)::rest') ->
                          ((match (aqual, aq) with
                            | (FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit
                               uu____6693),FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____6694)) ->
                                ()
                            | (FStar_Pervasives_Native.None
                               ,FStar_Pervasives_Native.None ) -> ()
                            | (FStar_Pervasives_Native.Some
                           ...
                           (let targ =
                              FStar_Syntax_Subst.subst subst1
                                x.FStar_Syntax_Syntax.sort in
                            let x1 =
                              let uu___112_6708 = x in
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___112_6708.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index =
                                  (uu___112_6708.FStar_Syntax_Syntax.index);
                            ...
                            (let targ1 =
                             ...
                             let env1 =
                               FStar_TypeChecker_Env.set_expected_typ env
                                 targ1 in
                             let env2 =
                               let uu___113_6716 = env1 in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___113_6716.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___113_6716.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___113_6716.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___113_6716.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___113_6716.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___113_6716.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___113_6716.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___113_6716.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern =
                                   (uu___113_6716.FStar_TypeChecker_Env.is_pattern);
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___113_6716.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___113_6716.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___113_6716.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs =
                                   (uu___113_6716.FStar_TypeChecker_Env.letrecs);
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___113_6716.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___113_6716.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq = (is_eq aqual);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___113_6716.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___113_6716.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax =
                                   (uu___113_6716.FStar_TypeChecker_Env.lax);
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___113_6716.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___113_6716.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___113_6716.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___113_6716.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___113_6716.FStar_TypeChecker_Env.qname_and_index)
                               } in
                             (let uu____6718 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.High in
                             ...
                             (let uu____6723 = tc_term env2 e in
                              ...
                              | (e1,c,g_e) ->
                                  ...
                                  let xterm =
                                    ...
                                    FStar_Syntax_Syntax.as_arg uu____6740 in
                                  let uu____6741 =
                                  ...
                                  then
                                    let subst2 =
                                      let uu____6746 = FStar_List.hd bs in
                                      maybe_extend_subst subst1 uu____6746 e1 in
                                    tc_args head_info
                                      (subst2,
                                        ((arg,
                                          ...
                                          ((let uu____6898 =
                                           ...
                                           tc_args head_info1
                                             ([], [], [],
                                               FStar_TypeChecker_Rel.trivial_guard,
                                               []) bs2 args1))
                                 | uu____6921 when Prims.op_Negation norm1 ->
                                     let uu____6922 =
                                       FStar_TypeChecker_Normalize.unfold_whnf
                                         env tres1 in
                                     aux true uu____6922
                                       ...
                                       let uu____6925 =
                                         let uu____6928 =
                                           ...
                                           FStar_Util.format2
                                             ...
                                             uu____6929 uu____6930 in
                                         let uu____6934 =
                                           FStar_Syntax_Syntax.argpos arg in
                                         (uu____6928, uu____6934) in
                                       FStar_Errors.Error uu____6925 in
                                     raise uu____6924 in
               ...
               let rec check_function_app tf =
                 ...
                 | FStar_Syntax_Syntax.Tm_uvar uu____6956 ->
                     let rec tc_args1 env1 args1 =
                       ...
                       | [] -> ([], [], FStar_TypeChecker_Rel.trivial_guard)
                       | (e,imp)::tl1 ->
                           let uu____7020 = tc_term env1 e in
                           (match uu____7020 with
                            | (e1,c,g_e) ->
                                let uu____7033 = tc_args1 env1 tl1 in
                                (match uu____7033 with
                                 | (args2,comps,g_rest) ->
                                     ...
                                     (((e1, imp) :: args2),
                                       ...
                                       comps), uu____7055))) in
                     let uu____7066 = tc_args1 env args in
                     (match uu____7066 with
                      | (args1,comps,g_args) ->
                          let bs =
                            ...
                            FStar_Syntax_Util.null_binders_of_tks uu____7088 in
                          let ml_or_tot t r1 =
                            let uu____7132 = FStar_Options.ml_ish () in
                            if uu____7132
                          ...
                          let cres =
                            let uu____7135 =
                              let uu____7138 =
                                let uu____7139 = FStar_Syntax_Util.type_u () in
                                FStar_All.pipe_right uu____7139
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____7138 in
                            ml_or_tot uu____7135 r in
                          ...
                          ((let uu____7148 =
                           ...
                           (let comp =
                            ...
                            (uu____7170, comp, uu____7177))))
                 | FStar_Syntax_Syntax.Tm_app
                     ({
                        FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                          uu____7180;
                        FStar_Syntax_Syntax.tk = uu____7181;
                        FStar_Syntax_Syntax.pos = uu____7182;
                        FStar_Syntax_Syntax.vars = uu____7183;_},uu____7184)
                     ->
                     let rec tc_args1 env1 args1 =
                       match args1 with
                       | [] -> ([], [], FStar_TypeChecker_Rel.trivial_guard)
                       | (e,imp)::tl1 ->
                           let uu____7262 = tc_term env1 e in
                           (match uu____7262 with
                            | (e1,c,g_e) ->
                                let uu____7275 = tc_args1 env1 tl1 in
                                (match uu____7275 with
                                 | (args2,comps,g_rest) ->
                                     ...
                                     (((e1, imp) :: args2),
                                       (((e1.FStar_Syntax_Syntax.pos), c) ::
                                       comps), uu____7297))) in
                     let uu____7308 = tc_args1 env args in
                                ...
                                (FStar_List.map
                                   (fun uu____7350  ->
                                      ...
                                      | (uu____7358,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____7330 in
                          let ml_or_tot t r1 =
                            let uu____7374 = FStar_Options.ml_ish () in
                            if uu____7374
                            then FStar_Syntax_Util.ml_comp t r1
                            else FStar_Syntax_Syntax.mk_Total t in
                          let cres =
                            let uu____7377 =
                              let uu____7380 =
                                ...
                                FStar_All.pipe_right uu____7381
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____7380 in
                            ml_or_tot uu____7377 r in
                          let bs_cres = FStar_Syntax_Util.arrow bs cres in
                          ((let uu____7390 =
                              FStar_All.pipe_left
                                (FStar_TypeChecker_Env.debug env)
                     ...
                     (match uu____7434 with
                      | (bs1,c1) ->
                          ...
                          tc_args head_info
                            ([], [], [], FStar_TypeChecker_Rel.trivial_guard,
                              []) bs1 args)
                 | FStar_Syntax_Syntax.Tm_refine (bv,uu____7470) ->
                     check_function_app bv.FStar_Syntax_Syntax.sort
                 | FStar_Syntax_Syntax.Tm_ascribed (t,uu____7476,uu____7477)
                 ...
                 | uu____7506 ->
                     let uu____7507 =
                       let uu____7508 =
                         ...
                         (uu____7511, (head1.FStar_Syntax_Syntax.pos)) in
                       FStar_Errors.Error uu____7508 in
                     raise uu____7507 in
              ...
              | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                  ...
                  let uu____7562 =
                    FStar_List.fold_left2
                      (fun uu____7575  ->
                         fun uu____7576  ->
                           fun uu____7577  ->
                             match (uu____7575, uu____7576, uu____7577) with
                                   ...
                                   | (e1,c1,g) ->
                                       ...
                                       let uu____7637 =
                                         let uu____7643 =
                                           ...
                                           [uu____7649] in
                                         FStar_List.append seen uu____7643 in
                                       let uu____7654 =
                                         FStar_TypeChecker_Rel.conj_guard
                                           guard g1 in
                                       (uu____7637, uu____7654, ghost1))))
                  ...
                  (match uu____7562 with
                   | (args1,guard,ghost) ->
                       ...
                       (match uu____7685 with | (c2,g) -> (e, c2, g)))
              | uu____7697 ->
...
and tc_eqn:
  ...
  fun scrutinee  ->
    fun env  ->
      fun branch1  ->
        let uu____7719 = FStar_Syntax_Subst.open_branch branch1 in
        match uu____7719 with
        | (pattern,when_clause,branch_exp) ->
            let uu____7745 = branch1 in
                   ...
                   | (pat_bvs1,exp,p) ->
                       ((let uu____7820 =
                        ...
                        (let pat_env =
                         ...
                         | (env1,uu____7836) ->
                             let env11 =
                               let uu___114_7840 = env1 in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___114_7840.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___114_7840.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___114_7840.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___114_7840.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___114_7840.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___114_7840.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___114_7840.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___114_7840.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern = true;
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___114_7840.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___114_7840.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___114_7840.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs =
                                   (uu___114_7840.FStar_TypeChecker_Env.letrecs);
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___114_7840.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___114_7840.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq =
                                   (uu___114_7840.FStar_TypeChecker_Env.use_eq);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___114_7840.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___114_7840.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax =
                                   (uu___114_7840.FStar_TypeChecker_Env.lax);
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___114_7840.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___114_7840.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___114_7840.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___114_7840.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___114_7840.FStar_TypeChecker_Env.qname_and_index)
                               } in
                             let expected_pat_t =
                             ...
                             ((let uu____7843 =
                              ...
                              (let env12 =
                                 FStar_TypeChecker_Env.set_expected_typ env11
                                   expected_pat_t in
                               let uu____7848 = tc_tot_or_gtot_term env12 exp in
                               match uu____7848 with
                               | (exp1,lc,g) ->
                                   let g1 =
                                     let uu___115_7862 = g in
                                     {
                                       FStar_TypeChecker_Env.guard_f =
                                         FStar_TypeChecker_Common.Trivial;
                                       FStar_TypeChecker_Env.deferred =
                                         (uu___115_7862.FStar_TypeChecker_Env.deferred);
                                       FStar_TypeChecker_Env.univ_ineqs =
                                         (uu___115_7862.FStar_TypeChecker_Env.univ_ineqs);
                                       FStar_TypeChecker_Env.implicits =
                                         (uu___115_7862.FStar_TypeChecker_Env.implicits)
                                     } in
                                   let uu____7863 =
                                     let g' =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          let uu____8745 =
            let uu____8751 =
              ...
              FStar_All.pipe_right uu____8752 FStar_Pervasives_Native.fst in
                            ...
                            then t
                              ...
                              (let uu____9368 =
                                 let uu____9372 =
                                   ...
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____9373 in
                                 tc_check_tot_or_gtot_term
                             ...
                             ((let uu____9654 =
                              ...
                              (let t3 = norm env1 t2 in
                               ...
                               ((FStar_Pervasives_Native.Some t3), g,
                                 univ_vars1, univ_opening, uu____9660))))))
and tc_binder:
  FStar_TypeChecker_Env.env ->
