...
and tc_constant:
  ...
  fun r  ->
    fun c  ->
      ...
      | FStar_Const.Const_int (uu____3918,FStar_Pervasives_Native.None ) ->
          FStar_TypeChecker_Common.t_int
      | FStar_Const.Const_int
          (uu____3924,FStar_Pervasives_Native.Some uu____3925) ->
    ...
    fun c  ->
      ...
      | FStar_Syntax_Syntax.Comp c1 ->
          ...
          let tc =
            ...
            uu____4019 FStar_Pervasives_Native.None
      ...
      then FStar_Syntax_Syntax.U_zero
        ...
        (match u with
         | FStar_Syntax_Syntax.U_unknown  ->
             ...
             FStar_All.pipe_right uu____4257 FStar_Pervasives_Native.snd
         | uu____4262 -> aux u)
and tc_abs:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
                  ...
                  (match (bs2, bs_expected1) with
                   ...
                   | ((hd1,imp)::bs3,(hd_expected,imp')::bs_expected2) ->
                       ((match (imp, imp') with
                         | (FStar_Pervasives_Native.None
                            ,FStar_Pervasives_Native.Some
                            (FStar_Syntax_Syntax.Implicit uu____4432)) ->
                             let uu____4435 =
                               let uu____4436 =
                                 let uu____4439 =
                                   let uu____4440 =
                         ...
                         | (FStar_Pervasives_Native.Some
                            ...
                            uu____4442),FStar_Pervasives_Native.None ) ->
                             let uu____4445 =
                               let uu____4446 =
                                 let uu____4449 =
                                   let uu____4450 =
                 ...
                 | (subst1,outargs,arg_rets,g,fvs) ->
                     (match (bs, args1) with
                      | ((x,FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Implicit uu____6515))::rest,
                         (uu____6517,FStar_Pervasives_Native.None )::uu____6518)
                          ->
                          let t =
                            FStar_Syntax_Subst.subst subst1
                              x.FStar_Syntax_Syntax.sort in
                      ...
                      | ((x,aqual)::rest,(e,aq)::rest') ->
                          ((match (aqual, aq) with
                            | (FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit
                               uu____6684),FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____6685)) ->
                                ()
                            | (FStar_Pervasives_Native.None
                               ,FStar_Pervasives_Native.None ) -> ()
                            | (FStar_Pervasives_Native.Some
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          let uu____8735 =
            let uu____8741 =
              ...
              FStar_All.pipe_right uu____8742 FStar_Pervasives_Native.fst in
                            ...
                            then t
                              ...
                              (let uu____9358 =
                                 let uu____9362 =
                                   ...
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____9363 in
                                 tc_check_tot_or_gtot_term
                             ...
                             ((let uu____9644 =
                              ...
                              (let t3 = norm env1 t2 in
                               ...
                               ((FStar_Pervasives_Native.Some t3), g,
                                 univ_vars1, univ_opening, uu____9650))))))
and tc_binder:
  FStar_TypeChecker_Env.env ->
