                ...
                let bs_t_opt =
                  ...
                  then
                    ...
                    | (bs1,rest) ->
                        ...
                        let uu____18614 =
                          let uu____18619 = FStar_Syntax_Syntax.mk_Total t1 in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____18655 = FStar_Syntax_Subst.open_comp bs c in
                     ...
                     | (bs1,t1) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args in
                         let uu____18758 = FStar_Syntax_Subst.subst subst1 t1 in
        ...
        fun k  ->
          ...
          let slow_check uu____19027 =
            ...
            then
              ...
              (let uu____19039 = env2.FStar_TypeChecker_Env.tc_term env2 t in
               match uu____19039 with | (uu____19046,uu____19047,g) -> g) in
