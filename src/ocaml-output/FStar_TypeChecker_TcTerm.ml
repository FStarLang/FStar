...
let (print_expected_ty : FStar_TypeChecker_Env.env -> unit) =
  fun env ->
    ...
    | FStar_Pervasives_Native.Some (t, use_eq) ->
        ...
        FStar_Compiler_Util.print2 "Expected type is (%s, use_eq=%s)" uu___1
          uu___2
       ...
       then
         ...
         let uu___6 =
           ...
           | FStar_Pervasives_Native.Some (t, uu___8) ->
               FStar_Syntax_Print.term_to_string t in
         let uu___7 =
           let uu___8 = FStar_TypeChecker_Env.expected_typ env in
           match uu___8 with
           | FStar_Pervasives_Native.None -> "None"
           | FStar_Pervasives_Native.Some (uu___9, use_eq) ->
               FStar_Compiler_Util.string_of_bool use_eq in
         FStar_Compiler_Util.print6
           "(%s) Starting tc_term (phase1=%s) of %s (%s) with expected type: (%s, use_eq=%s) {\n"
                ...
                (match uu___3 with
                 | (t'1, c, g) ->
                     let t'2 =
                       ...
                       | FStar_Syntax_Syntax.Tm_ascribed
                           (e2,
                            (asc1, FStar_Pervasives_Native.None, _use_eq0),
                            labopt1)
                           ->
                           FStar_Syntax_Syntax.mk
                             (FStar_Syntax_Syntax.Tm_ascribed
                   ...
                   (fun uu___7 ->
                      ...
                      | FStar_Pervasives_Native.Some (t, use_eq) ->
                          ...
                          let uu___9 =
                            let uu___10 =
                              FStar_Compiler_Util.string_of_bool use_eq in
                            Prims.op_Hat ", use_eq = " uu___10 in
                ...
                | FStar_Pervasives_Native.None ->
                    ...
                    (match uu___1 with
                     | FStar_Pervasives_Native.Some (t, use_eq) ->
                         (if use_eq
                          then
                            failwith "NYI: use_eq with the synth hook type"
                          else ();
                          t)
                     | FStar_Pervasives_Native.None ->
    ...
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_unknown ->
          ...
          let uu___ =
            ...
            | FStar_Pervasives_Native.Some (t, use_eq) ->
                (if use_eq
                 then failwith "NYI: use_eq for an unknown type ascription"
                 else ();
              ...
              ((let uu___2 =
                ...
                then
                  let uu___3 =
                    match topt with
                    | FStar_Pervasives_Native.None -> "None"
                    | FStar_Pervasives_Native.Some (t, use_eq1) ->
                        let uu___4 = FStar_Syntax_Print.term_to_string t in
                        let uu___5 =
                          let uu___6 =
                            FStar_Compiler_Util.string_of_bool use_eq1 in
      ...
      (FStar_Syntax_Syntax.binder *
        ...
        (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t *
          ...
          ((FStar_Syntax_Syntax.pat * FStar_Syntax_Syntax.term
            ...
            FStar_Pervasives_Native.option * FStar_TypeChecker_Common.guard_t
            * Prims.bool))
  =
  fun scrutinee ->
    fun env ->
