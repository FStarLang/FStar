    ...
    fun e ->
      ...
      (match top.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           ->
           let e' = FStar_Syntax_Util.unmeta e1 in
           let uu___1 =
             let uu___2 = FStar_Syntax_Subst.compress e' in
             uu___2.FStar_Syntax_Syntax.n in
           (match uu___1 with
            | FStar_Syntax_Syntax.Tm_let ((false, uu___2::[]), uu___3) ->
                let uu___4 = tc_term env1 e1 in
                (match uu___4 with
                 | (e2, c, g) ->
                     let e'1 = FStar_Syntax_Util.unmeta e2 in
                     let uu___5 =
                       let uu___6 = FStar_Syntax_Subst.compress e'1 in
                       uu___6.FStar_Syntax_Syntax.n in
                     (match uu___5 with
                      | FStar_Syntax_Syntax.Tm_let
                          ((false,
                            { FStar_Syntax_Syntax.lbname = uu___6;
                              FStar_Syntax_Syntax.lbunivs = uu___7;
                              FStar_Syntax_Syntax.lbtyp = t;
                              FStar_Syntax_Syntax.lbeff = uu___8;
                          ...
                          ->
                          let gopt =
                            FStar_TypeChecker_Rel.get_subtyping_prop env1 t
                            ...
                            | FStar_Pervasives_Native.None ->
                                let uu___12 =
                                  FStar_TypeChecker_Err.expected_expression_of_type
                                    env1 FStar_Syntax_Syntax.t_unit e11 t in
                      ...
                      | uu___6 ->
                          let uu___7 =
                            let uu___8 = FStar_Syntax_Print.tag_of_term e'1 in
                            FStar_Compiler_Util.format1
                              "Impossible: Typechecking a Tm_let produced a %s"
                              uu___8 in
                          failwith uu___7))
            | uu___2 ->
                let uu___3 =
                  let uu___4 = FStar_Syntax_Print.tag_of_term e' in
                  FStar_Compiler_Util.format1
                    "Impossible: Unexpected Sequence label on a %s" uu___4 in
                failwith uu___3)
       | FStar_Syntax_Syntax.Tm_meta
                           ...
                           let envbody1 =
                             {
                               ...
                               FStar_TypeChecker_Env.use_eq =
                                 (envbody.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.use_eq_strict =
                              ...
                              let envbody2 =
                                {
                                  ...
                                  FStar_TypeChecker_Env.use_eq =
                                    (envbody1.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.use_eq_strict =
                                          ...
                                          check_expected_effect
                                            {
                                              ...
                                              FStar_TypeChecker_Env.top_level
                                                =
                                                (envbody2.FStar_TypeChecker_Env.top_level);
                                              FStar_TypeChecker_Env.check_uvars
                                                =
                                                (envbody2.FStar_TypeChecker_Env.check_uvars);
                                              FStar_TypeChecker_Env.use_eq =
            ...
            tc_check_tot_or_gtot_term
              {
                ...
                FStar_TypeChecker_Env.use_eq =
                  (env01.FStar_TypeChecker_Env.use_eq);
                FStar_TypeChecker_Env.use_eq_strict =
                     ...
                     tc_maybe_toplevel_term
                       {
                         ...
                         FStar_TypeChecker_Env.use_eq =
                           (env11.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.use_eq_strict =
