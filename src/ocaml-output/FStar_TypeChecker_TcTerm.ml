...
let fail = (fun _59_1957 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (t, _59_1964) -> begin
(head_constructor t)
end
| _59_1968 -> begin
(fail ())
...
| FStar_Syntax_Syntax.Tm_constant (_59_1993) -> begin
...
let sub_term_guards = (let _156_732 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _59_2011 -> (match (_59_2011) with
| (ei, _59_2010) -> begin
(
...
let _59_2027 = (FStar_Syntax_Util.type_u ())
in (match (_59_2027) with
| (k, _59_2026) -> begin
(

let _59_2033 = (tc_check_tot_or_gtot_term scrutinee_env t k)
in (match (_59_2033) with
| (t, _59_2030, _59_2032) -> begin
t
end))
end)))
end)
...
let _59_2041 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _59_2058 = (check_let_bound_def true env lb)
in (match (_59_2058) with
| (e1, univ_vars, c1, g1, annotated) -> begin
(

let _59_2072 = if (annotated && (not (env.FStar_TypeChecker_Env.generalize))) then begin
((g1), (e1), (univ_vars), (c1))
end else begin
(
...
let _59_2067 = (let _156_748 = (let _156_747 = (let _156_746 = (let _156_745 = (c1.FStar_Syntax_Syntax.comp ())
...
let _59_2083 = if (FStar_TypeChecker_Env.should_verify env) then begin
(

let _59_2075 = (FStar_TypeChecker_Util.check_top_level env g1 c1)
in (match (_59_2075) with
| (ok, c1) -> begin
if ok then begin
((e2), (c1))
end else begin
...
let _59_2076 = if (FStar_Options.warn_top_level_effects ()) then begin
...
let _59_2078 = (FStar_TypeChecker_Rel.force_trivial_guard env g1)
in (
...
let _59_2085 = (FStar_ST.op_Colon_Equals e2.FStar_Syntax_Syntax.tk (Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)))
in (
...
let _59_2100 = env
in {FStar_TypeChecker_Env.solver = _59_2100.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2100.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2100.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2100.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2100.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2100.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2100.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2100.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2100.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2100.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2100.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2100.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2100.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _59_2100.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2100.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2100.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2100.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_2100.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2100.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2100.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2100.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2100.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2100.FStar_TypeChecker_Env.qname_and_index})
in (

let _59_2109 = (let _156_757 = (let _156_756 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (FStar_All.pipe_right _156_756 Prims.fst))
in (check_let_bound_def false _156_757 lb))
in (match (_59_2109) with
| (e1, _59_2105, c1, g1, annotated) -> begin
(

let x = (

let _59_2110 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _59_2110.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_2110.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = c1.FStar_Syntax_Syntax.res_typ})
in (

let _59_2115 = (let _156_759 = (let _156_758 = (FStar_Syntax_Syntax.mk_binder x)
in (_156_758)::[])
...
let _59_2121 = (let _156_760 = (FStar_TypeChecker_Env.push_bv env x)
in (tc_term _156_760 e2))
in (match (_59_2121) with
| (e2, c2, g2) -> begin
(
...
let _59_2132 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Exports"))) then begin
...
let _59_2135 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Exports"))) then begin
...
let _59_2137 = cres
in {FStar_Syntax_Syntax.eff_name = _59_2137.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = _59_2137.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = _59_2137.FStar_Syntax_Syntax.comp})), (guard))))
end)))))))))
end))))
end)))
end)))
...
let _59_2152 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (_59_2152) with
| (lbs, e2) -> begin
(

let _59_2155 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (_59_2155) with
| (env0, topt) -> begin
(

let _59_2158 = (build_let_rec_env true env0 lbs)
in (match (_59_2158) with
| (lbs, rec_env) -> begin
(

let _59_2161 = (check_let_recs rec_env lbs)
in (match (_59_2161) with
| (lbs, g_lbs) -> begin
(
...
in (FStar_All.pipe_right ecs (FStar_List.map (fun _59_2172 -> (match (_59_2172) with
| (x, uvs, e, c) -> begin
...
let _59_2175 = (FStar_ST.op_Colon_Equals e2.FStar_Syntax_Syntax.tk (Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)))
in (

let _59_2179 = (FStar_Syntax_Subst.close_let_rec lbs e2)
in (match (_59_2179) with
| (lbs, e2) -> begin
...
let _59_2193 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (_59_2193) with
| (lbs, e2) -> begin
(

let _59_2196 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (_59_2196) with
| (env0, topt) -> begin
(

let _59_2199 = (build_let_rec_env false env0 lbs)
in (match (_59_2199) with
| (lbs, rec_env) -> begin
(

let _59_2202 = (check_let_recs rec_env lbs)
in (match (_59_2202) with
| (lbs, g_lbs) -> begin
(

let _59_2214 = (FStar_All.pipe_right lbs (FStar_Util.fold_map (fun env lb -> (

let x = (

let _59_2205 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _59_2205.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_2205.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lb.FStar_Syntax_Syntax.lbtyp})
in (

let lb = (

let _59_2208 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _59_2208.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _59_2208.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _59_2208.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _59_2208.FStar_Syntax_Syntax.lbdef})
in (
...
let _59_2220 = (tc_term env e2)
in (match (_59_2220) with
| (e2, cres, g2) -> begin
(
...
let _59_2224 = cres
in {FStar_Syntax_Syntax.eff_name = _59_2224.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres; FStar_Syntax_Syntax.cflags = _59_2224.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = _59_2224.FStar_Syntax_Syntax.comp})
in (

let _59_2229 = (FStar_Syntax_Subst.close_let_rec lbs e2)
...
let _59_2236 = cres
in {FStar_Syntax_Syntax.eff_name = _59_2236.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres; FStar_Syntax_Syntax.cflags = _59_2236.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = _59_2236.FStar_Syntax_Syntax.comp})
in ((e), (cres), (guard))))
end))
end))))))
end)))
...
let _59_2250 = (FStar_Syntax_Util.arrow_formals_comp t)
in (match (_59_2250) with
| (_59_2248, c) -> begin
(
...
let _59_2280 = (FStar_List.fold_left (fun _59_2254 lb -> (match (_59_2254) with
| (lbs, env) -> begin
(

let _59_2259 = (FStar_TypeChecker_Util.extract_let_rec_annotation env lb)
in (match (_59_2259) with
...
let _59_2268 = (let _156_802 = (let _156_801 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_left Prims.fst _156_801))
in (tc_check_tot_or_gtot_term (

let _59_2262 = env0
in {FStar_TypeChecker_Env.solver = _59_2262.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2262.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2262.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2262.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2262.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2262.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2262.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2262.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2262.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2262.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2262.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2262.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2262.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_2262.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = true; FStar_TypeChecker_Env.use_eq = _59_2262.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2262.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2262.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_2262.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2262.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2262.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2262.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2262.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2262.FStar_TypeChecker_Env.qname_and_index}) t _156_802))
in (match (_59_2268) with
| (t, _59_2266, g) -> begin
(

let _59_2269 = (FStar_TypeChecker_Rel.force_trivial_guard env0 g)
in (norm env0 t))
end))
end
end
...
let _59_2272 = env
in {FStar_TypeChecker_Env.solver = _59_2272.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2272.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2272.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2272.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2272.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2272.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2272.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2272.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2272.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2272.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2272.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2272.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = (((lb.FStar_Syntax_Syntax.lbname), (t)))::env.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_2272.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_2272.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2272.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2272.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2272.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_2272.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2272.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2272.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2272.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2272.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2272.FStar_TypeChecker_Env.qname_and_index})
end else begin
...
let _59_2275 = lb
in {FStar_Syntax_Syntax.lbname = _59_2275.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = univ_vars; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _59_2275.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = e})
in (((lb)::lbs), (env)))))))
end))
end)) (([]), (env)) lbs)
...
let _59_2293 = (let _156_807 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _59_2287 = (let _156_806 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term _156_806 lb.FStar_Syntax_Syntax.lbdef))
in (match (_59_2287) with
| (e, c, g) -> begin
(

let _59_2288 = if (not ((FStar_Syntax_Util.is_total_lcomp c))) then begin
...
let _59_2301 = (FStar_TypeChecker_Env.clear_expected_typ env)
...
let _59_2308 = (check_lbtyp top_level env lb)
in (match (_59_2308) with
| (topt, wf_annot, univ_vars, univ_opening, env1) -> begin
(

let _59_2309 = if ((not (top_level)) && (univ_vars <> [])) then begin
...
let _59_2319 = (tc_maybe_toplevel_term (

let _59_2314 = env1
in {FStar_TypeChecker_Env.solver = _59_2314.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2314.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2314.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2314.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2314.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2314.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2314.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2314.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2314.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2314.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2314.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2314.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2314.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = top_level; FStar_TypeChecker_Env.check_uvars = _59_2314.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2314.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2314.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2314.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_2314.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2314.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2314.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2314.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2314.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2314.FStar_TypeChecker_Env.qname_and_index}) e1)
in (match (_59_2319) with
| (e1, c1, g1) -> begin
(

let _59_2323 = (let _156_814 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (Some ((fun _59_2320 -> (match (()) with
| () -> begin
FStar_TypeChecker_Errors.ill_kinded_type
end)))) _156_814 e1 c1 wf_annot))
in (match (_59_2323) with
| (c1, guard_f) -> begin
(
...
let _59_2325 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
...
let _59_2332 = if (lb.FStar_Syntax_Syntax.lbunivs <> []) then begin
...
let _59_2338 = (FStar_Syntax_Subst.univ_var_opening lb.FStar_Syntax_Syntax.lbunivs)
...
let _59_2344 = (FStar_Syntax_Util.type_u ())
in (match (_59_2344) with
| (k, _59_2343) -> begin
(

let _59_2349 = (tc_check_tot_or_gtot_term env1 t k)
in (match (_59_2349) with
| (t, _59_2347, g) -> begin
(

let _59_2350 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
and tc_binder : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.arg_qualifier Prims.option) * FStar_TypeChecker_Env.env * FStar_TypeChecker_Env.guard_t * FStar_Syntax_Syntax.universe) = (fun env _59_2356 -> (match (_59_2356) with
| (x, imp) -> begin
(

let _59_2359 = (FStar_Syntax_Util.type_u ())
in (match (_59_2359) with
| (tu, u) -> begin
(

let _59_2360 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
...
let _59_2366 = (tc_check_tot_or_gtot_term env x.FStar_Syntax_Syntax.sort tu)
in (match (_59_2366) with
| (t, _59_2364, g) -> begin
(
...
let _59_2367 = x
in {FStar_Syntax_Syntax.ppname = _59_2367.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_2367.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (imp))
in (

let _59_2370 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _59_2385 = (tc_binder env b)
in (match (_59_2385) with
| (b, env', g, u) -> begin
(

let _59_2390 = (aux env' bs)
in (match (_59_2390) with
| (bs, env', g', us) -> begin
...
let tc_args = (fun env args -> (FStar_List.fold_right (fun _59_2398 _59_2401 -> (match (((_59_2398), (_59_2401))) with
| ((t, imp), (args, g)) -> begin
(

let _59_2406 = (tc_term env t)
in (match (_59_2406) with
| (t, _59_2404, g') -> begin
(let _156_851 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((((t), (imp)))::args), (_156_851)))
end))
end)) args (([]), (FStar_TypeChecker_Rel.trivial_guard))))
in (FStar_List.fold_right (fun p _59_2410 -> (match (_59_2410) with
| (pats, g) -> begin
(

let _59_2413 = (tc_args env p)
in (match (_59_2413) with
| (args, g') -> begin
...
let _59_2419 = (tc_maybe_toplevel_term env e)
in (match (_59_2419) with
| (e, c, g) -> begin
...
let _59_2425 = if (FStar_TypeChecker_Util.is_pure_effect env (FStar_Syntax_Util.comp_effect_name c)) then begin
...
let _59_2439 = (tc_tot_or_gtot_term env t)
in (match (_59_2439) with
| (t, c, g) -> begin
(

let _59_2440 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in ((t), (c)))
end)))
...
let _59_2444 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _59_2446 = env
in {FStar_TypeChecker_Env.solver = _59_2446.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2446.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2446.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2446.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2446.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2446.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2446.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2446.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2446.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2446.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2446.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2446.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2446.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _59_2446.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2446.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2446.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2446.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_2446.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2446.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2446.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2446.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2446.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2446.FStar_TypeChecker_Env.qname_and_index})
in (
...
with
| FStar_Syntax_Syntax.Error (msg, _59_2454) -> begin
...
let _59_2465 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
...
let _59_2470 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (_59_2470) with
| (env, _59_2469) -> begin
(
...
let _59_2471 = env
in {FStar_TypeChecker_Env.solver = _59_2471.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2471.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2471.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2471.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2471.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2471.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2471.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2471.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2471.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2471.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2471.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2471.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2471.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _59_2471.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2471.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2471.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2471.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _59_2471.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2471.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2471.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _59_2471.FStar_TypeChecker_Env.qname_and_index})
in (
...
let _59_2479 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
...
| FStar_Syntax_Syntax.Tm_arrow (_59_2498, t) -> begin
...
let _59_2521 = (tc_term env e)
in (match (_59_2521) with
| (_59_2511, {FStar_Syntax_Syntax.eff_name = _59_2518; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = _59_2515; FStar_Syntax_Syntax.comp = _59_2513}, g) -> begin
(

let _59_2522 = (let _156_914 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
