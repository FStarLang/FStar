...
| FStar_Const.Const_float (uu____3947) -> begin
FStar_TypeChecker_Common.t_float
end
| FStar_Const.Const_char (uu____3948) -> begin
FStar_TypeChecker_Common.t_char
end
| FStar_Const.Const_effect -> begin
FStar_Syntax_Util.ktype0
end
| FStar_Const.Const_range (uu____3949) -> begin
...
| FStar_Syntax_Syntax.Total (t, uu____3961) -> begin
(

let uu____3968 = (FStar_Syntax_Util.type_u ())
in (match (uu____3968) with
| (k, u) -> begin
(

let uu____3976 = (tc_check_tot_or_gtot_term env t k)
in (match (uu____3976) with
| (t1, uu____3984, g) -> begin
(

let uu____3986 = (FStar_Syntax_Syntax.mk_Total' t1 (FStar_Pervasives_Native.Some (u)))
in ((uu____3986), (u), (g)))
end))
end))
end
| FStar_Syntax_Syntax.GTotal (t, uu____3988) -> begin
(

let uu____3995 = (FStar_Syntax_Util.type_u ())
in (match (uu____3995) with
| (k, u) -> begin
(

let uu____4003 = (tc_check_tot_or_gtot_term env t k)
in (match (uu____4003) with
| (t1, uu____4011, g) -> begin
(

let uu____4013 = (FStar_Syntax_Syntax.mk_GTotal' t1 (FStar_Pervasives_Native.Some (u)))
in ((uu____4013), (u), (g)))
end))
end))
end
...
let uu____4031 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (uu____4031)::c1.FStar_Syntax_Syntax.effect_args)
in (FStar_Syntax_Syntax.mk_Tm_app head2 uu____4030))
in (uu____4029 FStar_Pervasives_Native.None c1.FStar_Syntax_Syntax.result_typ.FStar_Syntax_Syntax.pos))
in (

let uu____4036 = (tc_check_tot_or_gtot_term env tc FStar_Syntax_Syntax.teff)
in (match (uu____4036) with
| (tc1, uu____4044, f) -> begin
(

let uu____4046 = (FStar_Syntax_Util.head_and_args tc1)
...
let uu____4077 = (FStar_Syntax_Subst.compress head3)
in uu____4077.FStar_Syntax_Syntax.n)
in (match (uu____4076) with
| FStar_Syntax_Syntax.Tm_uinst (uu____4080, us) -> begin
us
end
| uu____4086 -> begin
[]
...
let uu____4087 = (FStar_Syntax_Util.head_and_args tc1)
in (match (uu____4087) with
| (uu____4100, args1) -> begin
(

let uu____4116 = (

let uu____4128 = (FStar_List.hd args1)
in (

let uu____4137 = (FStar_List.tl args1)
in ((uu____4128), (uu____4137))))
...
let uu____4184 = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___85_4194 -> (match (uu___85_4194) with
| FStar_Syntax_Syntax.DECREASES (e) -> begin
(

let uu____4200 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____4200) with
| (env1, uu____4207) -> begin
(

let uu____4210 = (tc_tot_or_gtot_term env1 e)
in (match (uu____4210) with
| (e1, uu____4217, g) -> begin
...
in (FStar_All.pipe_right uu____4184 FStar_List.unzip))
...
let uu___105_4240 = c1
in {FStar_Syntax_Syntax.comp_univs = comp_univs; FStar_Syntax_Syntax.effect_name = uu___105_4240.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = (FStar_Pervasives_Native.fst res); FStar_Syntax_Syntax.effect_args = args2; FStar_Syntax_Syntax.flags = uu___105_4240.FStar_Syntax_Syntax.flags}))
in (

let u_c = (

let uu____4244 = (FStar_TypeChecker_Env.effect_repr env c2 u)
...
let uu____4247 = (FStar_List.fold_left FStar_TypeChecker_Rel.conj_guard f guards)
in ((c2), (u_c), (uu____4247))))))
end))
end))
end)))
end))
...
in (match (u2) with
| FStar_Syntax_Syntax.U_bvar (uu____4255) -> begin
(failwith "Impossible: locally nameless")
end
| FStar_Syntax_Syntax.U_unknown -> begin
(failwith "Unknown universe")
end
| FStar_Syntax_Syntax.U_unif (uu____4256) -> begin
u2
end
...
let uu____4260 = (aux u3)
in FStar_Syntax_Syntax.U_succ (uu____4260))
end
| FStar_Syntax_Syntax.U_max (us) -> begin
(

let uu____4263 = (FStar_List.map aux us)
in FStar_Syntax_Syntax.U_max (uu____4263))
end
...
let uu____4267 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right uu____4267 FStar_Pervasives_Native.snd))
end
| uu____4272 -> begin
(aux u)
end)
...
let uu____4297 = (FStar_TypeChecker_Err.expected_a_term_of_type_t_got_a_function env msg t top)
in ((uu____4297), (top.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____4294))
in (FStar_Pervasives.raise uu____4293)))
in (

let check_binders = (fun env1 bs1 bs_expected -> (

let rec aux = (fun uu____4351 bs2 bs_expected1 -> (match (uu____4351) with
...
((match (((imp), (imp'))) with
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____4442))) -> begin
(
...
let uu____4450 = (FStar_Syntax_Print.bv_to_string hd1)
in (FStar_Util.format1 "Inconsistent implicit argument annotation on argument %s" uu____4450))
in (

let uu____4451 = (FStar_Syntax_Syntax.range_of_bv hd1)
in ((uu____4449), (uu____4451))))
in FStar_Errors.Error (uu____4446))
in (FStar_Pervasives.raise uu____4445))
end
| (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____4452)), FStar_Pervasives_Native.None) -> begin
(
...
let uu____4460 = (FStar_Syntax_Print.bv_to_string hd1)
in (FStar_Util.format1 "Inconsistent implicit argument annotation on argument %s" uu____4460))
in (

let uu____4461 = (FStar_Syntax_Syntax.range_of_bv hd1)
in ((uu____4459), (uu____4461))))
in FStar_Errors.Error (uu____4456))
in (FStar_Pervasives.raise uu____4455))
end
| uu____4462 -> begin
()
end);
...
let uu____4470 = (FStar_Syntax_Util.unmeta hd1.FStar_Syntax_Syntax.sort)
in uu____4470.FStar_Syntax_Syntax.n)
...
let uu____4477 = (FStar_TypeChecker_Env.debug env2 FStar_Options.High)
in (match (uu____4477) with
| true -> begin
(

let uu____4478 = (FStar_Syntax_Print.bv_to_string hd1)
...
let uu____4480 = (tc_tot_or_gtot_term env2 hd1.FStar_Syntax_Syntax.sort)
in (match (uu____4480) with
| (t, uu____4487, g1) -> begin
(

let g2 = (

let uu____4490 = (FStar_TypeChecker_Env.get_range env2)
in (

let uu____4491 = (FStar_TypeChecker_Rel.teq env2 t expected_t)
in (FStar_TypeChecker_Util.label_guard uu____4490 "Type annotation on parameter incompatible with the expected type" uu____4491)))
in (

let g3 = (

let uu____4493 = (FStar_TypeChecker_Rel.conj_guard g1 g2)
in (FStar_TypeChecker_Rel.conj_guard g uu____4493))
in ((t), (g3))))
end));
)
end))
...
let uu___106_4509 = hd1
in {FStar_Syntax_Syntax.ppname = uu___106_4509.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___106_4509.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
...
let uu____4518 = (FStar_Syntax_Syntax.bv_to_name hd2)
in (maybe_extend_subst subst1 b_expected uu____4518))
...
let uu____4624 = (tc_binders env1 bs)
in (match (uu____4624) with
| (bs1, envbody, g, uu____4645) -> begin
(
...
let uu____4654 = (FStar_Syntax_Subst.compress body1)
in uu____4654.FStar_Syntax_Syntax.n)
in (match (uu____4653) with
| FStar_Syntax_Syntax.Tm_ascribed (e, (FStar_Util.Inr (c), tacopt), uu____4666) -> begin
(

let uu____4702 = (tc_comp envbody c)
in (match (uu____4702) with
| (c1, uu____4713, g') -> begin
(

let uu____4715 = (tc_tactic_opt envbody tacopt)
in (

let uu____4717 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((FStar_Pervasives_Native.Some (c1)), (uu____4715), (body1), (uu____4717))))
end))
end
| uu____4720 -> begin
...
let uu____4780 = (FStar_Syntax_Subst.compress t2)
in uu____4780.FStar_Syntax_Syntax.n)
in (match (uu____4779) with
| FStar_Syntax_Syntax.Tm_uvar (uu____4797) -> begin
((match (env1.FStar_TypeChecker_Env.letrecs) with
| [] -> begin
()
end
...
let uu____4813 = (tc_binders env1 bs)
in (match (uu____4813) with
| (bs1, envbody, g, uu____4835) -> begin
(

let uu____4836 = (FStar_TypeChecker_Env.clear_expected_typ envbody)
in (match (uu____4836) with
| (envbody1, uu____4855) -> begin
((FStar_Pervasives_Native.Some (((t2), (true)))), (bs1), ([]), (FStar_Pervasives_Native.None), (FStar_Pervasives_Native.None), (envbody1), (body1), (g))
end))
end));
)
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uu____4866); FStar_Syntax_Syntax.tk = uu____4867; FStar_Syntax_Syntax.pos = uu____4868; FStar_Syntax_Syntax.vars = uu____4869}, uu____4870) -> begin
((match (env1.FStar_TypeChecker_Env.letrecs) with
| [] -> begin
()
end
...
let uu____4900 = (tc_binders env1 bs)
in (match (uu____4900) with
| (bs1, envbody, g, uu____4922) -> begin
(

let uu____4923 = (FStar_TypeChecker_Env.clear_expected_typ envbody)
in (match (uu____4923) with
| (envbody1, uu____4942) -> begin
((FStar_Pervasives_Native.Some (((t2), (true)))), (bs1), ([]), (FStar_Pervasives_Native.None), (FStar_Pervasives_Native.None), (envbody1), (body1), (g))
end))
end));
)
end
| FStar_Syntax_Syntax.Tm_refine (b, uu____4954) -> begin
(

let uu____4959 = (as_function_typ norm1 b.FStar_Syntax_Syntax.sort)
in (match (uu____4959) with
| (uu____4988, bs1, bs', copt, tacopt, env2, body2, g) -> begin
...
let uu____5028 = (FStar_Syntax_Subst.open_comp bs_expected c_expected)
...
let rec handle_more = (fun uu____5091 c_expected2 -> (match (uu____5091) with
| (env3, bs2, more, guard, subst1) -> begin
(match (more) with
| FStar_Pervasives_Native.None -> begin
(

let uu____5152 = (FStar_Syntax_Subst.subst_comp subst1 c_expected2)
in ((env3), (bs2), (guard), (uu____5152)))
end
...
let uu____5169 = (FStar_Syntax_Util.arrow more_bs_expected c_expected2)
in (FStar_Syntax_Syntax.mk_Total uu____5169))
in (

let uu____5170 = (FStar_Syntax_Subst.subst_comp subst1 c)
in ((env3), (bs2), (guard), (uu____5170))))
end
...
let uu____5211 = (FStar_Syntax_Subst.open_comp bs_expected3 c_expected3)
in (match (uu____5211) with
| (bs_expected4, c_expected4) -> begin
(

let uu____5223 = (check_binders env3 more_bs bs_expected4)
...
let uu____5266 = (FStar_TypeChecker_Rel.conj_guard guard guard')
in ((env4), ((FStar_List.append bs2 bs')), (more1), (uu____5266), (subst2)))
in (handle_more uu____5250 c_expected4))
end))
end))
end
| uu____5275 -> begin
...
let uu____5277 = (FStar_Syntax_Print.term_to_string t3)
in (FStar_Util.format1 "More arguments than annotated type (%s)" uu____5277))
in (fail uu____5276 t3))
end))
end
| uu____5285 -> begin
...
let uu____5293 = (check_binders env2 bs1 bs_expected2)
in (handle_more uu____5293 c_expected1))))
in (
...
let uu___107_5331 = envbody
in {FStar_TypeChecker_Env.solver = uu___107_5331.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___107_5331.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___107_5331.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___107_5331.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___107_5331.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___107_5331.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___107_5331.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___107_5331.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___107_5331.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___107_5331.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___107_5331.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___107_5331.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = []; FStar_TypeChecker_Env.top_level = uu___107_5331.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___107_5331.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___107_5331.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___107_5331.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___107_5331.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___107_5331.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___107_5331.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___107_5331.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___107_5331.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___107_5331.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___107_5331.FStar_TypeChecker_Env.qname_and_index})
in (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun uu____5345 uu____5346 -> (match (((uu____5345), (uu____5346))) with
...
let uu____5376 = (FStar_TypeChecker_Env.clear_expected_typ env2)
in (FStar_All.pipe_right uu____5376 FStar_Pervasives_Native.fst))
in (tc_term uu____5375 t3))
in (match (uu____5371) with
| (t4, uu____5388, uu____5389) -> begin
(
...
let uu____5396 = (FStar_Syntax_Syntax.mk_binder (

let uu___108_5397 = x
in {FStar_Syntax_Syntax.ppname = uu___108_5397.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___108_5397.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t4}))
in (uu____5396)::letrec_binders)
end
| uu____5398 -> begin
letrec_binders
end)
...
let uu____5401 = (check_actuals_against_formals env1 bs bs_expected1)
...
let uu____5437 = (FStar_TypeChecker_Env.should_verify env1)
...
let uu____5488 = (FStar_TypeChecker_Normalize.unfold_whnf env1 t2)
in (as_function_typ true uu____5488))
end
| uu____5489 -> begin
(

let uu____5490 = (expected_function_typ1 env1 FStar_Pervasives_Native.None body1)
in (match (uu____5490) with
| (uu____5518, bs1, uu____5520, c_opt, tacopt, envbody, body2, g) -> begin
...
let uu____5545 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____5545) with
| (env1, topt) -> begin
((

let uu____5557 = (FStar_TypeChecker_Env.debug env1 FStar_Options.High)
in (match (uu____5557) with
| true -> begin
(

let uu____5558 = (match (topt) with
| FStar_Pervasives_Native.None -> begin
"None"
end
| FStar_Pervasives_Native.Some (t) -> begin
...
in (FStar_Util.print2 "!!!!!!!!!!!!!!!Expected type is %s, top_level=%s\n" uu____5558 (match (env1.FStar_TypeChecker_Env.top_level) with
| true -> begin
"true"
end
| uu____5560 -> begin
...
let uu____5562 = (expected_function_typ1 env1 topt body)
in (match (uu____5562) with
| (tfun_opt, bs1, letrec_binders, c_opt, tacopt, envbody, body1, g) -> begin
(

let uu____5597 = (tc_term (

let uu___109_5601 = envbody
in {FStar_TypeChecker_Env.solver = uu___109_5601.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___109_5601.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___109_5601.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___109_5601.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___109_5601.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___109_5601.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___109_5601.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___109_5601.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___109_5601.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___109_5601.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___109_5601.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___109_5601.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___109_5601.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___109_5601.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = use_eq; FStar_TypeChecker_Env.is_iface = uu___109_5601.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___109_5601.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___109_5601.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___109_5601.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___109_5601.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___109_5601.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___109_5601.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___109_5601.FStar_TypeChecker_Env.qname_and_index}) body1)
...
let uu____5610 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1) (FStar_Options.Other ("Implicits")))
in (match (uu____5610) with
| true -> begin
(

let uu____5611 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length guard_body1.FStar_TypeChecker_Env.implicits))
in (

let uu____5620 = (

let uu____5621 = (cbody.FStar_Syntax_Syntax.comp ())
in (FStar_All.pipe_left FStar_Syntax_Print.comp_to_string uu____5621))
...
let uu____5630 = (cbody.FStar_Syntax_Syntax.comp ())
in ((body2), (uu____5630)))
in (check_expected_effect (

let uu___110_5635 = envbody
in {FStar_TypeChecker_Env.solver = uu___110_5635.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___110_5635.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___110_5635.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___110_5635.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___110_5635.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___110_5635.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___110_5635.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___110_5635.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___110_5635.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___110_5635.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___110_5635.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___110_5635.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___110_5635.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___110_5635.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___110_5635.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = use_eq; FStar_TypeChecker_Env.is_iface = uu___110_5635.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___110_5635.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___110_5635.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___110_5635.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___110_5635.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___110_5635.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___110_5635.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___110_5635.FStar_TypeChecker_Env.qname_and_index}) c_opt uu____5627))
...
let uu____5644 = (env1.FStar_TypeChecker_Env.top_level || (

let uu____5645 = (FStar_TypeChecker_Env.should_verify env1)
in (not (uu____5645))))
in (match (uu____5644) with
| true -> begin
(

let uu____5646 = (FStar_TypeChecker_Rel.conj_guard g guard1)
in (FStar_TypeChecker_Rel.discharge_guard envbody uu____5646))
end
| uu____5647 -> begin
(
...
let uu____5649 = (FStar_TypeChecker_Rel.conj_guard g guard1)
in (FStar_TypeChecker_Rel.close_guard env1 (FStar_List.append bs1 letrec_binders) uu____5649))
in guard2)
end))
in (
...
let uu____5669 = (FStar_All.pipe_right (FStar_Util.dflt cbody1 c_opt) FStar_Syntax_Util.lcomp_of_comp)
in (FStar_All.pipe_right uu____5669 (fun _0_30 -> FStar_Util.Inl (_0_30))))
in FStar_Pervasives_Native.Some (uu____5663))
in (FStar_Syntax_Util.abs bs1 body3 uu____5656))
in (

let uu____5683 = (match (tfun_opt) with
| FStar_Pervasives_Native.Some (t, use_teq) -> begin
(

let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (uu____5698) -> begin
((e), (t1), (guard2))
end
| uu____5706 -> begin
(

let uu____5707 = (match (use_teq) with
| true -> begin
(

let uu____5712 = (FStar_TypeChecker_Rel.teq env1 t1 tfun_computed)
in ((e), (uu____5712)))
end
| uu____5713 -> begin
...
let uu____5719 = (FStar_TypeChecker_Rel.conj_guard guard2 guard')
in ((e1), (t1), (uu____5719)))
end))
end))
end
...
let uu____5732 = (FStar_TypeChecker_Util.strengthen_precondition FStar_Pervasives_Native.None env1 e1 (FStar_Syntax_Util.lcomp_of_comp c) guard3)
...
let uu____5768 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____5768) with
| true -> begin
(

let uu____5769 = (FStar_Range.string_of_range head1.FStar_Syntax_Syntax.pos)
in (

let uu____5770 = (FStar_Syntax_Print.term_to_string thead)
...
let monadic_application = (fun uu____5808 subst1 arg_comps_rev arg_rets_rev guard fvs bs -> (match (uu____5808) with
...
let uu___111_5845 = cres
in {FStar_Syntax_Syntax.eff_name = uu___111_5845.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = rt; FStar_Syntax_Syntax.cflags = uu___111_5845.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___111_5845.FStar_Syntax_Syntax.comp})
in (

let uu____5846 = (match (bs) with
| [] -> begin
(
...
let uu____5860 = (FStar_TypeChecker_Rel.conj_guard ghead1 guard)
in (FStar_All.pipe_right uu____5860 (FStar_TypeChecker_Rel.solve_deferred_constraints env)))
in (
...
let uu____5867 = (cres1.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Util.arrow bs uu____5867))
in (FStar_All.pipe_left (FStar_Syntax_Subst.subst subst1) uu____5866))
in (FStar_Syntax_Syntax.mk_Total uu____5865))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____5862))
in ((uu____5861), (g))))
end)
...
let uu____5878 = (FStar_TypeChecker_Env.debug env FStar_Options.Low)
in (match (uu____5878) with
| true -> begin
(

let uu____5879 = (FStar_Syntax_Print.lcomp_to_string cres2)
...
let uu____5882 = (FStar_Syntax_Util.is_pure_or_ghost_lcomp cres2)
...
let comp = (FStar_List.fold_left (fun out_c uu____5905 -> (match (uu____5905) with
| ((e, q), x, c) -> begin
(

let uu____5928 = (FStar_Syntax_Util.is_pure_or_ghost_lcomp c)
...
let uu____5938 = (FStar_Syntax_Subst.compress head2)
in uu____5938.FStar_Syntax_Syntax.n)
...
let args1 = (FStar_List.fold_left (fun args1 uu____5952 -> (match (uu____5952) with
| (arg, uu____5960, uu____5961) -> begin
(arg)::args1
end)) [] arg_comps_rev)
in (
...
let map_fun = (fun uu____6008 -> (match (uu____6008) with
| ((e, q), uu____6028, c) -> begin
(

let uu____6034 = (FStar_Syntax_Util.is_pure_or_ghost_lcomp c)
...
let uu____6067 = (FStar_Syntax_Syntax.bv_to_name x)
in ((uu____6067), (q)))
in ((FStar_Pervasives_Native.Some (((x), (c.FStar_Syntax_Syntax.eff_name), (c.FStar_Syntax_Syntax.res_typ), (e1)))), (uu____6064)))))
end))
end))
in (
...
let uu____6125 = (FStar_Syntax_Syntax.as_arg head2)
in ((uu____6125), (FStar_Pervasives_Native.None), (chead1)))
in (uu____6120)::arg_comps_rev)
in (FStar_List.map map_fun uu____6112))
in (FStar_All.pipe_left FStar_List.split uu____6099))
...
let uu____6221 = (FStar_List.hd reverse_args)
in (FStar_Pervasives_Native.fst uu____6221))
in (

let uu____6226 = (

let uu____6230 = (FStar_List.tl reverse_args)
in (FStar_List.rev uu____6230))
in ((lifted_args), (uu____6220), (uu____6226))))
end)))
...
let bind_lifted_args = (fun e uu___86_6298 -> (match (uu___86_6298) with
| FStar_Pervasives_Native.None -> begin
e
end
...
let uu____6354 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____6354)::[])
in (FStar_Syntax_Subst.close uu____6353 e))
in ((((false), ((lb)::[]))), (uu____6352)))
in FStar_Syntax_Syntax.Tm_let (uu____6344))
in (FStar_Syntax_Syntax.mk uu____6343))
in (uu____6340 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos))
...
let uu____6388 = (FStar_TypeChecker_Util.strengthen_precondition FStar_Pervasives_Native.None env app comp1 guard1)
...
let rec tc_args = (fun head_info uu____6442 bs args1 -> (match (uu____6442) with
| (subst1, outargs, arg_rets, g, fvs) -> begin
(match (((bs), (args1))) with
| (((x, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____6525))))::rest, ((uu____6527, FStar_Pervasives_Native.None))::uu____6528) -> begin
(
...
let uu____6565 = (FStar_TypeChecker_Util.new_implicit_var "Instantiating implicit argument in application" head1.FStar_Syntax_Syntax.pos env t1)
in (match (uu____6565) with
| (varg, uu____6576, implicits) -> begin
(
...
let uu____6589 = (FStar_Syntax_Syntax.as_implicit true)
in ((varg), (uu____6589)))
in (
...
let uu____6624 = (FStar_Syntax_Syntax.mk_Total t1)
in (FStar_All.pipe_right uu____6624 FStar_Syntax_Util.lcomp_of_comp))
in ((arg), (FStar_Pervasives_Native.None), (uu____6623)))
in (uu____6616)::outargs)
in (

let uu____6634 = (FStar_TypeChecker_Rel.conj_guard implicits g)
in ((subst2), (uu____6608), ((arg)::arg_rets), (uu____6634), (fvs))))
in (tc_args head_info uu____6590 rest args1))))
end))))
end
| (((x, aqual))::rest, ((e, aq))::rest') -> begin
((match (((aqual), (aq))) with
| (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____6694)), FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____6695))) -> begin
()
end
...
let uu___112_6709 = x
in {FStar_Syntax_Syntax.ppname = uu___112_6709.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___112_6709.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = targ})
in ((

let uu____6711 = (FStar_TypeChecker_Env.debug env FStar_Options.Extreme)
in (match (uu____6711) with
| true -> begin
(

let uu____6712 = (FStar_Syntax_Print.term_to_string targ)
...
let uu___113_6717 = env1
in {FStar_TypeChecker_Env.solver = uu___113_6717.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___113_6717.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___113_6717.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___113_6717.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___113_6717.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___113_6717.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___113_6717.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___113_6717.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___113_6717.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___113_6717.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___113_6717.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___113_6717.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___113_6717.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___113_6717.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___113_6717.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = (is_eq aqual); FStar_TypeChecker_Env.is_iface = uu___113_6717.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___113_6717.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___113_6717.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___113_6717.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___113_6717.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___113_6717.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___113_6717.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___113_6717.FStar_TypeChecker_Env.qname_and_index})
in ((

let uu____6719 = (FStar_TypeChecker_Env.debug env2 FStar_Options.High)
in (match (uu____6719) with
| true -> begin
(

let uu____6720 = (FStar_Syntax_Print.tag_of_term e)
in (

let uu____6721 = (FStar_Syntax_Print.term_to_string e)
in (

let uu____6722 = (FStar_Syntax_Print.term_to_string targ1)
...
let uu____6741 = (FStar_Syntax_Syntax.bv_to_name x1)
in (FStar_Syntax_Syntax.as_arg uu____6741))
in (

let uu____6742 = ((FStar_Syntax_Util.is_tot_or_gtot_lcomp c) || (FStar_TypeChecker_Util.is_pure_or_ghost_effect env2 c.FStar_Syntax_Syntax.eff_name))
...
let uu____6747 = (FStar_List.hd bs)
in (maybe_extend_subst subst1 uu____6747 e1))
...
| ([], (arg)::uu____6816) -> begin
(

let uu____6846 = (monadic_application head_info subst1 outargs arg_rets g fvs [])
...
let uu____6869 = (FStar_Syntax_Subst.compress tres)
in (FStar_All.pipe_right uu____6869 FStar_Syntax_Util.unrefine))
in (match (tres1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (bs1, cres') -> begin
(

let uu____6885 = (FStar_Syntax_Subst.open_comp bs1 cres')
...
let uu____6899 = (FStar_TypeChecker_Env.debug env FStar_Options.Low)
in (match (uu____6899) with
| true -> begin
(

let uu____6900 = (FStar_Range.string_of_range tres1.FStar_Syntax_Syntax.pos)
...
| uu____6922 when (not (norm1)) -> begin
(

let uu____6923 = (FStar_TypeChecker_Normalize.unfold_whnf env tres1)
in (aux true uu____6923))
end
| uu____6924 -> begin
(
...
let uu____6930 = (FStar_TypeChecker_Normalize.term_to_string env thead)
in (

let uu____6931 = (FStar_Util.string_of_int n_args)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s arguments" uu____6930 uu____6931)))
in (

let uu____6935 = (FStar_Syntax_Syntax.argpos arg)
in ((uu____6929), (uu____6935))))
in FStar_Errors.Error (uu____6926))
in (FStar_Pervasives.raise uu____6925))
end)))
...
let uu____6949 = (FStar_TypeChecker_Normalize.unfold_whnf env tf)
in uu____6949.FStar_Syntax_Syntax.n)
in (match (uu____6948) with
| FStar_Syntax_Syntax.Tm_uvar (uu____6957) -> begin
(
...
let uu____7021 = (tc_term env1 e)
in (match (uu____7021) with
| (e1, c, g_e) -> begin
(

let uu____7034 = (tc_args1 env1 tl1)
in (match (uu____7034) with
| (args2, comps, g_rest) -> begin
(

let uu____7056 = (FStar_TypeChecker_Rel.conj_guard g_e g_rest)
in (((((e1), (imp)))::args2), ((((e1.FStar_Syntax_Syntax.pos), (c)))::comps), (uu____7056)))
end))
end))
end))
in (

let uu____7067 = (tc_args1 env args)
...
let uu____7089 = (FStar_All.pipe_right comps (FStar_List.map (fun uu____7109 -> (match (uu____7109) with
| (uu____7117, c) -> begin
((c.FStar_Syntax_Syntax.res_typ), (FStar_Pervasives_Native.None))
end))))
in (FStar_Syntax_Util.null_binders_of_tks uu____7089))
in (

let ml_or_tot = (fun t r1 -> (

let uu____7133 = (FStar_Options.ml_ish ())
...
let uu____7140 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right uu____7140 FStar_Pervasives_Native.fst))
in (FStar_TypeChecker_Util.new_uvar env uu____7139))
in (ml_or_tot uu____7136 r))
in (

let bs_cres = (FStar_Syntax_Util.arrow bs cres)
in ((

let uu____7149 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme)
in (match (uu____7149) with
| true -> begin
(

let uu____7150 = (FStar_Syntax_Print.term_to_string head1)
in (

let uu____7151 = (FStar_Syntax_Print.term_to_string tf)
in (

let uu____7152 = (FStar_Syntax_Print.term_to_string bs_cres)
...
let uu____7155 = (FStar_TypeChecker_Rel.teq env tf bs_cres)
in (FStar_All.pipe_left (FStar_TypeChecker_Rel.force_trivial_guard env) uu____7155));
(

let comp = (

let uu____7157 = (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun uu____7162 out -> (match (uu____7162) with
| (r1, c) -> begin
(FStar_TypeChecker_Util.bind r1 env FStar_Pervasives_Native.None c ((FStar_Pervasives_Native.None), (out)))
end)) ((((head1.FStar_Syntax_Syntax.pos), (chead)))::comps) uu____7157))
in (

let uu____7171 = ((FStar_Syntax_Syntax.mk_Tm_app head1 args1) (FStar_Pervasives_Native.Some (comp.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (

let uu____7178 = (FStar_TypeChecker_Rel.conj_guard ghead g_args)
in ((uu____7171), (comp), (uu____7178)))));
)))))
end)))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uu____7181); FStar_Syntax_Syntax.tk = uu____7182; FStar_Syntax_Syntax.pos = uu____7183; FStar_Syntax_Syntax.vars = uu____7184}, uu____7185) -> begin
(
...
let uu____7263 = (tc_term env1 e)
in (match (uu____7263) with
| (e1, c, g_e) -> begin
(

let uu____7276 = (tc_args1 env1 tl1)
in (match (uu____7276) with
| (args2, comps, g_rest) -> begin
(

let uu____7298 = (FStar_TypeChecker_Rel.conj_guard g_e g_rest)
in (((((e1), (imp)))::args2), ((((e1.FStar_Syntax_Syntax.pos), (c)))::comps), (uu____7298)))
end))
end))
end))
in (

let uu____7309 = (tc_args1 env args)
...
let uu____7331 = (FStar_All.pipe_right comps (FStar_List.map (fun uu____7351 -> (match (uu____7351) with
| (uu____7359, c) -> begin
((c.FStar_Syntax_Syntax.res_typ), (FStar_Pervasives_Native.None))
end))))
in (FStar_Syntax_Util.null_binders_of_tks uu____7331))
in (

let ml_or_tot = (fun t r1 -> (

let uu____7375 = (FStar_Options.ml_ish ())
...
let uu____7382 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right uu____7382 FStar_Pervasives_Native.fst))
in (FStar_TypeChecker_Util.new_uvar env uu____7381))
in (ml_or_tot uu____7378 r))
in (

let bs_cres = (FStar_Syntax_Util.arrow bs cres)
in ((

let uu____7391 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme)
in (match (uu____7391) with
| true -> begin
(

let uu____7392 = (FStar_Syntax_Print.term_to_string head1)
in (

let uu____7393 = (FStar_Syntax_Print.term_to_string tf)
in (

let uu____7394 = (FStar_Syntax_Print.term_to_string bs_cres)
...
let uu____7397 = (FStar_TypeChecker_Rel.teq env tf bs_cres)
in (FStar_All.pipe_left (FStar_TypeChecker_Rel.force_trivial_guard env) uu____7397));
(

let comp = (

let uu____7399 = (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun uu____7404 out -> (match (uu____7404) with
| (r1, c) -> begin
(FStar_TypeChecker_Util.bind r1 env FStar_Pervasives_Native.None c ((FStar_Pervasives_Native.None), (out)))
end)) ((((head1.FStar_Syntax_Syntax.pos), (chead)))::comps) uu____7399))
in (

let uu____7413 = ((FStar_Syntax_Syntax.mk_Tm_app head1 args1) (FStar_Pervasives_Native.Some (comp.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (

let uu____7420 = (FStar_TypeChecker_Rel.conj_guard ghead g_args)
in ((uu____7413), (comp), (uu____7420)))));
)))))
end)))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
...
let uu____7435 = (FStar_Syntax_Subst.open_comp bs c)
...
| FStar_Syntax_Syntax.Tm_refine (bv, uu____7471) -> begin
(check_function_app bv.FStar_Syntax_Syntax.sort)
end
| FStar_Syntax_Syntax.Tm_ascribed (t, uu____7477, uu____7478) -> begin
...
let uu____7512 = (FStar_TypeChecker_Err.expected_function_typ env tf)
in ((uu____7512), (head1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____7509))
in (FStar_Pervasives.raise uu____7508))
end)))
...
let uu____7563 = (FStar_List.fold_left2 (fun uu____7576 uu____7577 uu____7578 -> (match (((uu____7576), (uu____7577), (uu____7578))) with
...
let uu____7622 = (tc_check_tot_or_gtot_term env e b.FStar_Syntax_Syntax.sort)
...
let uu____7634 = (FStar_TypeChecker_Rel.guard_of_guard_formula short)
in (FStar_TypeChecker_Rel.imp_guard uu____7634 g))
in (

let ghost1 = (ghost || ((

let uu____7636 = (FStar_Syntax_Util.is_total_lcomp c1)
in (not (uu____7636))) && (

let uu____7637 = (FStar_TypeChecker_Util.is_pure_effect env c1.FStar_Syntax_Syntax.eff_name)
in (not (uu____7637)))))
in (
...
let uu____7650 = (FStar_Syntax_Syntax.as_arg e1)
in (uu____7650)::[])
in (FStar_List.append seen uu____7644))
in (

let uu____7655 = (FStar_TypeChecker_Rel.conj_guard guard g1)
in ((uu____7638), (uu____7655), (ghost1)))))))
end));
)
...
let uu____7684 = (FStar_Syntax_Syntax.mk_GTotal res_t)
in (FStar_All.pipe_right uu____7684 FStar_Syntax_Util.lcomp_of_comp))
end
| uu____7685 -> begin
...
let uu____7686 = (FStar_TypeChecker_Util.strengthen_precondition FStar_Pervasives_Native.None env e c1 guard)
...
let uu____7720 = (FStar_Syntax_Subst.open_branch branch1)
in (match (uu____7720) with
| (pattern, when_clause, branch_exp) -> begin
(

let uu____7746 = branch1
in (match (uu____7746) with
| (cpat, uu____7766, cbr) -> begin
(

let tc_pat = (fun allow_implicits pat_t p0 -> (

let uu____7804 = (FStar_TypeChecker_Util.pat_as_exp allow_implicits env p0)
in (match (uu____7804) with
| (pat_bvs1, exp, p) -> begin
((

let uu____7821 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____7821) with
| true -> begin
(

let uu____7822 = (FStar_Syntax_Print.pat_to_string p0)
in (

let uu____7823 = (FStar_Syntax_Print.pat_to_string p)
...
let uu____7826 = (FStar_TypeChecker_Env.clear_expected_typ pat_env)
in (match (uu____7826) with
| (env1, uu____7837) -> begin
(

let env11 = (

let uu___114_7841 = env1
in {FStar_TypeChecker_Env.solver = uu___114_7841.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___114_7841.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___114_7841.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___114_7841.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___114_7841.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___114_7841.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___114_7841.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___114_7841.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = true; FStar_TypeChecker_Env.instantiate_imp = uu___114_7841.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___114_7841.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___114_7841.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___114_7841.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___114_7841.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___114_7841.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___114_7841.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___114_7841.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___114_7841.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___114_7841.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___114_7841.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___114_7841.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___114_7841.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___114_7841.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___114_7841.FStar_TypeChecker_Env.qname_and_index})
in (

let expected_pat_t = (FStar_TypeChecker_Rel.unrefine env pat_t)
in ((

let uu____7844 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____7844) with
| true -> begin
(

let uu____7845 = (FStar_Syntax_Print.term_to_string exp)
in (

let uu____7846 = (FStar_Syntax_Print.term_to_string pat_t)
...
let uu____7849 = (tc_tot_or_gtot_term env12 exp)
...
let uu___115_7863 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___115_7863.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___115_7863.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___115_7863.FStar_TypeChecker_Env.implicits})
in (
...
let uu____7868 = (FStar_TypeChecker_Rel.discharge_guard_no_smt env13 g2)
in (FStar_All.pipe_right uu____7868 FStar_TypeChecker_Rel.resolve_implicits)))))
in (
...
let uu____7880 = (FStar_Util.set_is_subset_of uvs1 uvs2)
in (FStar_All.pipe_left Prims.op_Negation uu____7880))
...
let uu____7887 = (FStar_Util.set_difference uvs1 uvs2)
in (FStar_All.pipe_right uu____7887 FStar_Util.set_elements))
in (
...
let uu____7906 = (FStar_TypeChecker_Normalize.term_to_string env norm_exp)
in (

let uu____7907 = (FStar_TypeChecker_Normalize.term_to_string env expected_pat_t)
in (

let uu____7908 = (

let uu____7909 = (FStar_All.pipe_right unresolved (FStar_List.map (fun uu____7921 -> (match (uu____7921) with
| (u, uu____7929) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right uu____7909 (FStar_String.concat ", ")))
in (FStar_Util.format3 "Implicit pattern variables in %s could not be resolved against expected type %s;Variables {%s} were unresolved; please bind them explicitly" uu____7906 uu____7907 uu____7908))))
in ((uu____7905), (p.FStar_Syntax_Syntax.p)))
in FStar_Errors.Error (uu____7902))
in (FStar_Pervasives.raise uu____7901)))
end
| uu____7942 -> begin
()
end));
...
let uu____7944 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____7944) with
| true -> begin
(

let uu____7945 = (FStar_TypeChecker_Normalize.term_to_string env exp1)
...
let uu____7957 = (FStar_TypeChecker_Env.push_bv env scrutinee)
in (FStar_All.pipe_right uu____7957 FStar_TypeChecker_Env.clear_expected_typ))
in (match (uu____7953) with
| (scrutinee_env, uu____7970) -> begin
(

let uu____7973 = (tc_pat true pat_t pattern)
in (match (uu____7973) with
| (pattern1, pat_bvs1, pat_env, pat_exp, norm_pat_exp) -> begin
(

let uu____7995 = (match (when_clause) with
| FStar_Pervasives_Native.None -> begin
...
let uu____8010 = (FStar_TypeChecker_Env.should_verify env)
...
let uu____8022 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_TypeChecker_Common.t_bool)
in (tc_term uu____8022 e))
...
let uu____8042 = (tc_term pat_env branch_exp)
...
let uu____8061 = (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero FStar_Syntax_Util.t_bool w FStar_Syntax_Util.exp_true_bool)
in (FStar_All.pipe_left (fun _0_31 -> FStar_Pervasives_Native.Some (_0_31)) uu____8061))
end)
in (
...
let uu____8070 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____8070)))
...
| FStar_Syntax_Syntax.Tm_uvar (uu____8075) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Tm_constant (uu____8084) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Tm_fvar (uu____8085) -> begin
FStar_Pervasives_Native.None
end
| uu____8086 -> begin
(
...
let uu____8088 = (env.FStar_TypeChecker_Env.universe_of env pat_t)
in (FStar_Syntax_Util.mk_eq2 uu____8088 pat_t scrutinee_tm e))
in FStar_Pervasives_Native.Some (uu____8087))
end))
end))
in (

let uu____8089 = (FStar_TypeChecker_Util.strengthen_precondition FStar_Pervasives_Native.None env branch_exp1 c g_branch)
in (match (uu____8089) with
| (c1, g_branch1) -> begin
(

let uu____8099 = (match (((eqs), (when_condition))) with
| uu____8106 when (

let uu____8111 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____8111))) -> begin
((c1), (g_when))
end
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
((c1), (g_when))
...
let uu____8119 = (FStar_TypeChecker_Util.weaken_precondition env c1 gf)
in (

let uu____8120 = (FStar_TypeChecker_Rel.imp_guard g g_when)
in ((uu____8119), (uu____8120))))))
end
...
let uu____8127 = (FStar_Syntax_Util.mk_conj f w)
in FStar_TypeChecker_Common.NonTrivial (uu____8127))
in (

let uu____8128 = (FStar_TypeChecker_Util.weaken_precondition env c1 g_fw)
in (

let uu____8129 = (

let uu____8130 = (FStar_TypeChecker_Rel.guard_of_guard_formula g_f)
in (FStar_TypeChecker_Rel.imp_guard uu____8130 g_when))
in ((uu____8128), (uu____8129))))))
end
...
let uu____8136 = (FStar_TypeChecker_Util.weaken_precondition env c1 g_w)
in ((uu____8136), (g_when)))))
end)
...
let uu____8144 = (FStar_TypeChecker_Util.close_lcomp env pat_bvs1 c_weak)
in (

let uu____8145 = (FStar_TypeChecker_Rel.close_guard env binders g_when_weak)
in ((uu____8144), (uu____8145), (g_branch1)))))
end))
end)))
...
let uu____8159 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____8159)))
...
let uu____8198 = (FStar_TypeChecker_Env.typ_of_datacon env f.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.datacons_of_typ env uu____8198))
in (FStar_Pervasives_Native.snd uu____8194))
in (FStar_List.length uu____8192))
in (uu____8191 > (Prims.parse_int "1")))
...
let uu____8207 = (FStar_TypeChecker_Env.try_lookup_lid env discriminator)
...
let uu____8230 = (FStar_Syntax_Syntax.as_arg scrutinee_tm2)
in (uu____8230)::[])
in (FStar_Syntax_Syntax.mk_Tm_app disc uu____8229))
in (uu____8228 FStar_Pervasives_Native.None scrutinee_tm2.FStar_Syntax_Syntax.pos))
in (

let uu____8235 = (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero FStar_Syntax_Util.t_bool disc1 FStar_Syntax_Util.exp_true_bool)
in (uu____8235)::[])))
end)))
end
| uu____8236 -> begin
...
let fail = (fun uu____8243 -> (

let uu____8244 = (

let uu____8245 = (FStar_Range.string_of_range pat_exp1.FStar_Syntax_Syntax.pos)
in (

let uu____8246 = (FStar_Syntax_Print.term_to_string pat_exp1)
in (

let uu____8247 = (FStar_Syntax_Print.tag_of_term pat_exp1)
in (FStar_Util.format3 "tc_eqn: Impossible (%s) %s (%s)" uu____8245 uu____8246 uu____8247))))
in (failwith uu____8244)))
in (
...
| FStar_Syntax_Syntax.Tm_uinst (t1, uu____8268) -> begin
(head_constructor t1)
end
| uu____8274 -> begin
(fail ())
...
let uu____8277 = (FStar_Syntax_Subst.compress pat_exp1)
in (FStar_All.pipe_right uu____8277 FStar_Syntax_Util.unmeta))
in (match (pat_exp2.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uvar (uu____8279) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uu____8288); FStar_Syntax_Syntax.tk = uu____8289; FStar_Syntax_Syntax.pos = uu____8290; FStar_Syntax_Syntax.vars = uu____8291}, uu____8292) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_name (uu____8315) -> begin
[]
end
...
let uu____8318 = (tc_constant pat_exp2.FStar_Syntax_Syntax.pos c2)
in (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero uu____8318 scrutinee_tm1 pat_exp2))
in (uu____8317)::[])
end
| FStar_Syntax_Syntax.Tm_uinst (uu____8319) -> begin
(
...
let uu____8330 = (FStar_TypeChecker_Env.is_datacon env f.FStar_Syntax_Syntax.v)
in (not (uu____8330)))
...
let uu____8337 = (head_constructor pat_exp2)
in (discriminate scrutinee_tm1 uu____8337))
end)))
end
| FStar_Syntax_Syntax.Tm_fvar (uu____8343) -> begin
(
...
let uu____8350 = (FStar_TypeChecker_Env.is_datacon env f.FStar_Syntax_Syntax.v)
in (not (uu____8350)))
...
let uu____8357 = (head_constructor pat_exp2)
in (discriminate scrutinee_tm1 uu____8357))
end)))
end
| FStar_Syntax_Syntax.Tm_app (head1, args) -> begin
(
...
let uu____8385 = (FStar_TypeChecker_Env.is_datacon env f.FStar_Syntax_Syntax.v)
in (not (uu____8385)))
...
let uu____8394 = (FStar_All.pipe_right args (FStar_List.mapi (fun i uu____8410 -> (match (uu____8410) with
| (ei, uu____8417) -> begin
(
...
let uu____8427 = (FStar_TypeChecker_Env.try_lookup_lid env projector)
...
let uu____8448 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projector f.FStar_Syntax_Syntax.p) FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in (

let uu____8453 = (

let uu____8454 = (FStar_Syntax_Syntax.as_arg scrutinee_tm1)
in (uu____8454)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____8448 uu____8453)))
in (uu____8447 FStar_Pervasives_Native.None f.FStar_Syntax_Syntax.p))
in (build_branch_guard sub_term ei))
end)))
end))))
in (FStar_All.pipe_right uu____8394 FStar_List.flatten))
in (

let uu____8466 = (discriminate scrutinee_tm1 f)
in (FStar_List.append uu____8466 sub_term_guards)))
end)))
end
| uu____8470 -> begin
[]
...
let uu____8483 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____8483)))
...
let uu____8486 = (build_branch_guard scrutinee_tm1 pat)
in (FStar_All.pipe_left FStar_Syntax_Util.mk_conj_l uu____8486))
in (

let uu____8489 = (FStar_Syntax_Util.type_u ())
in (match (uu____8489) with
| (k, uu____8493) -> begin
(

let uu____8494 = (tc_check_tot_or_gtot_term scrutinee_env t k)
in (match (uu____8494) with
| (t1, uu____8499, uu____8500) -> begin
t1
end))
end)))
end)))
...
let uu____8506 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____8506) with
| true -> begin
(

let uu____8507 = (FStar_TypeChecker_Rel.guard_to_string env guard)
...
let uu____8509 = (FStar_Syntax_Subst.close_branch ((pattern1), (when_clause1), (branch_exp1)))
in ((uu____8509), (branch_guard), (c1), (guard)));
)))
end)))
end))
end))
...
let uu____8527 = (check_let_bound_def true env1 lb)
in (match (uu____8527) with
| (e1, univ_vars1, c1, g1, annotated) -> begin
(

let uu____8541 = (match ((annotated && (not (env1.FStar_TypeChecker_Env.generalize)))) with
| true -> begin
(

let uu____8550 = (FStar_TypeChecker_Normalize.reduce_uvar_solutions env1 e1)
in ((g1), (uu____8550), (univ_vars1), (c1)))
end
| uu____8551 -> begin
(
...
let uu____8553 = (FStar_TypeChecker_Rel.solve_deferred_constraints env1 g1)
in (FStar_All.pipe_right uu____8553 FStar_TypeChecker_Rel.resolve_implicits))
in (
...
let uu____8579 = (c1.FStar_Syntax_Syntax.comp ())
in ((lb.FStar_Syntax_Syntax.lbname), (e1), (uu____8579)))
in (uu____8571)::[])
in (FStar_TypeChecker_Util.generalize env1 uu____8566))
in (FStar_List.hd uu____8560))
in (match (uu____8555) with
| (uu____8608, univs1, e11, c11) -> begin
...
let uu____8624 = (FStar_TypeChecker_Env.should_verify env1)
in (match (uu____8624) with
| true -> begin
(

let uu____8629 = (FStar_TypeChecker_Util.check_top_level env1 g11 c11)
...
let uu____8646 = (FStar_TypeChecker_Env.get_range env1)
in (FStar_Errors.warn uu____8646 FStar_TypeChecker_Err.top_level_effect));
(

let uu____8647 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e2), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)))))) FStar_Pervasives_Native.None e2.FStar_Syntax_Syntax.pos)
in ((uu____8647), (c12)));
)
end)
end))
...
let uu____8665 = (c11.FStar_Syntax_Syntax.comp ())
in (FStar_All.pipe_right uu____8665 (FStar_TypeChecker_Normalize.normalize_comp ((FStar_TypeChecker_Normalize.Beta)::[]) env1)))
in (

let e21 = (

let uu____8673 = (FStar_Syntax_Util.is_pure_comp c)
...
let uu____8705 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((false), ((lb1)::[]))), (e21))))) (FStar_Pervasives_Native.Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
in ((uu____8705), ((FStar_Syntax_Util.lcomp_of_comp cres)), (FStar_TypeChecker_Rel.trivial_guard))));
))
end))
end))
end))
...
let uu___116_8745 = env1
in {FStar_TypeChecker_Env.solver = uu___116_8745.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___116_8745.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___116_8745.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___116_8745.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___116_8745.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___116_8745.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___116_8745.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___116_8745.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___116_8745.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___116_8745.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___116_8745.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___116_8745.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___116_8745.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___116_8745.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___116_8745.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___116_8745.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___116_8745.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___116_8745.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___116_8745.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___116_8745.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___116_8745.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___116_8745.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___116_8745.FStar_TypeChecker_Env.qname_and_index})
in (
...
let uu____8753 = (FStar_TypeChecker_Env.clear_expected_typ env2)
in (FStar_All.pipe_right uu____8753 FStar_Pervasives_Native.fst))
in (check_let_bound_def false uu____8752 lb))
in (match (uu____8746) with
| (e1, uu____8765, c1, g1, annotated) -> begin
(

let x = (

let uu___117_8770 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___117_8770.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___117_8770.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = c1.FStar_Syntax_Syntax.res_typ})
in (
...
let uu____8775 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____8775)::[])
in (FStar_Syntax_Subst.open_term uu____8774 e2))
...
let uu____8791 = (FStar_TypeChecker_Env.push_bv env2 x1)
in (tc_term uu____8791 e21))
...
let uu____8818 = (FStar_Syntax_Subst.close xb e23)
in ((((false), ((lb1)::[]))), (uu____8818)))
in FStar_Syntax_Syntax.Tm_let (uu____8810))
in (FStar_Syntax_Syntax.mk uu____8809))
in (uu____8806 (FStar_Pervasives_Native.Some (cres.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos))
in (
...
let uu____8834 = (env2.FStar_TypeChecker_Env.universe_of env2 c1.FStar_Syntax_Syntax.res_typ)
in (

let uu____8835 = (FStar_Syntax_Syntax.bv_to_name x1)
in (FStar_Syntax_Util.mk_eq2 uu____8834 c1.FStar_Syntax_Syntax.res_typ uu____8835 e11)))
in (FStar_All.pipe_left (fun _0_32 -> FStar_TypeChecker_Common.NonTrivial (_0_32)) uu____8833))
in (
...
let uu____8838 = (FStar_TypeChecker_Rel.guard_of_guard_formula x_eq_e1)
in (FStar_TypeChecker_Rel.imp_guard uu____8838 g2))
in (FStar_TypeChecker_Rel.close_guard env2 xb uu____8837))
in (
...
let uu____8841 = (FStar_TypeChecker_Env.expected_typ env2)
in (FStar_Option.isSome uu____8841))
...
let uu____8847 = (FStar_TypeChecker_Env.expected_typ env2)
in (FStar_All.pipe_right uu____8847 FStar_Option.get))
in ((

let uu____8851 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("Exports")))
in (match (uu____8851) with
| true -> begin
(

let uu____8852 = (FStar_Syntax_Print.term_to_string tt)
in (

let uu____8853 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
...
let uu____8858 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("Exports")))
in (match (uu____8858) with
| true -> begin
(

let uu____8859 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
in (
...
let uu___118_8862 = cres
in {FStar_Syntax_Syntax.eff_name = uu___118_8862.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___118_8862.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___118_8862.FStar_Syntax_Syntax.comp})), (guard));
))
end)))))))))))
end))))
end)))
...
let uu____8884 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (uu____8884) with
| (lbs1, e21) -> begin
(

let uu____8895 = (FStar_TypeChecker_Env.clear_expected_typ env1)
in (match (uu____8895) with
| (env0, topt) -> begin
(

let uu____8906 = (build_let_rec_env true env0 lbs1)
in (match (uu____8906) with
| (lbs2, rec_env) -> begin
(

let uu____8917 = (check_let_recs rec_env lbs2)
...
let uu____8929 = (FStar_TypeChecker_Rel.solve_deferred_constraints env1 g_lbs)
in (FStar_All.pipe_right uu____8929 FStar_TypeChecker_Rel.resolve_implicits))
in (

let all_lb_names = (

let uu____8933 = (FStar_All.pipe_right lbs3 (FStar_List.map (fun lb -> (FStar_Util.right lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right uu____8933 (fun _0_33 -> FStar_Pervasives_Native.Some (_0_33))))
in (
...
let uu____8958 = (FStar_All.pipe_right lbs3 (FStar_List.map (fun lb -> (

let uu____8980 = (FStar_Syntax_Syntax.mk_Total lb.FStar_Syntax_Syntax.lbtyp)
in ((lb.FStar_Syntax_Syntax.lbname), (lb.FStar_Syntax_Syntax.lbdef), (uu____8980))))))
in (FStar_TypeChecker_Util.generalize env1 uu____8958))
in (FStar_All.pipe_right ecs (FStar_List.map (fun uu____9000 -> (match (uu____9000) with
| (x, uvs, e, c) -> begin
...
let uu____9025 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____9025))
in ((FStar_ST.write e21.FStar_Syntax_Syntax.tk (FStar_Pervasives_Native.Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)));
(

let uu____9034 = (FStar_Syntax_Subst.close_let_rec lbs4 e21)
in (match (uu____9034) with
| (lbs5, e22) -> begin
((

let uu____9046 = (FStar_TypeChecker_Rel.discharge_guard env1 g_lbs1)
in (FStar_All.pipe_right uu____9046 (FStar_TypeChecker_Rel.force_trivial_guard env1)));
(

let uu____9047 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((true), (lbs5))), (e22))))) (FStar_Pervasives_Native.Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)) top.FStar_Syntax_Syntax.pos)
in ((uu____9047), (cres), (FStar_TypeChecker_Rel.trivial_guard)));
)
end));
)))))
end))
...
let uu____9085 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (uu____9085) with
| (lbs1, e21) -> begin
(

let uu____9096 = (FStar_TypeChecker_Env.clear_expected_typ env1)
in (match (uu____9096) with
| (env0, topt) -> begin
(

let uu____9107 = (build_let_rec_env false env0 lbs1)
in (match (uu____9107) with
| (lbs2, rec_env) -> begin
(

let uu____9118 = (check_let_recs rec_env lbs2)
in (match (uu____9118) with
| (lbs3, g_lbs) -> begin
(

let uu____9129 = (FStar_All.pipe_right lbs3 (FStar_Util.fold_map (fun env2 lb -> (

let x = (

let uu___119_9140 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___119_9140.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___119_9140.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lb.FStar_Syntax_Syntax.lbtyp})
in (

let lb1 = (

let uu___120_9142 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___120_9142.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___120_9142.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___120_9142.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___120_9142.FStar_Syntax_Syntax.lbdef})
in (
...
let uu____9159 = (tc_term env2 e21)
...
let uu____9171 = (FStar_List.map FStar_Syntax_Syntax.mk_binder bvs)
in (FStar_TypeChecker_Rel.close_guard env2 uu____9171 g2))
in (FStar_TypeChecker_Rel.conj_guard g_lbs uu____9170))
in (
...
let uu___121_9175 = cres1
in {FStar_Syntax_Syntax.eff_name = uu___121_9175.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres; FStar_Syntax_Syntax.cflags = uu___121_9175.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___121_9175.FStar_Syntax_Syntax.comp})
in (

let uu____9176 = (FStar_Syntax_Subst.close_let_rec lbs4 e22)
...
in (match (topt) with
| FStar_Pervasives_Native.Some (uu____9205) -> begin
((e), (cres2), (guard))
end
| FStar_Pervasives_Native.None -> begin
(
...
let uu___122_9210 = cres2
in {FStar_Syntax_Syntax.eff_name = uu___122_9210.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres1; FStar_Syntax_Syntax.cflags = uu___122_9210.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___122_9210.FStar_Syntax_Syntax.comp})
in ((e), (cres3), (guard))))
end))
end))))))
end)))
...
let uu____9240 = (FStar_Syntax_Subst.compress t)
in uu____9240.FStar_Syntax_Syntax.n)
in (

let uu____9243 = (

let uu____9244 = (FStar_Syntax_Subst.compress lbdef)
in uu____9244.FStar_Syntax_Syntax.n)
in ((uu____9239), (uu____9243))))
in (match (uu____9236) with
| (FStar_Syntax_Syntax.Tm_arrow (formals, c), FStar_Syntax_Syntax.Tm_abs (actuals, uu____9250, uu____9251)) -> begin
(

let actuals1 = (

let uu____9285 = (FStar_TypeChecker_Env.set_expected_typ env lbtyp)
in (FStar_TypeChecker_Util.maybe_add_implicit_binders uu____9285 actuals))
...
let uu____9303 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "%s arguments were found" uu____9303))
end))
in (
...
let uu____9315 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "%s arguments" uu____9315))
end))
in (

let msg = (

let uu____9320 = (FStar_Syntax_Print.term_to_string lbtyp)
in (

let uu____9321 = (FStar_Syntax_Print.lbname_to_string lbname)
in (FStar_Util.format4 "From its type %s, the definition of `let rec %s` expects a function with %s, but %s" uu____9320 uu____9321 formals_msg actuals_msg)))
...
let uu____9334 = (FStar_Syntax_Print.term_to_string lbdef)
in (

let uu____9335 = (FStar_Syntax_Print.term_to_string lbtyp)
in (FStar_Util.format2 "Only function literals with arrow types can be defined recursively; got %s : %s" uu____9334 uu____9335)))
in ((uu____9333), (lbtyp.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____9330))
in (FStar_Pervasives.raise uu____9329))
end))))
in (

let uu____9336 = (FStar_List.fold_left (fun uu____9343 lb -> (match (uu____9343) with
| (lbs1, env1) -> begin
(

let uu____9355 = (FStar_TypeChecker_Util.extract_let_rec_annotation env1 lb)
...
let uu____9374 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____9374))
in (tc_check_tot_or_gtot_term (

let uu___123_9379 = env0
in {FStar_TypeChecker_Env.solver = uu___123_9379.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___123_9379.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___123_9379.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___123_9379.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___123_9379.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___123_9379.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___123_9379.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___123_9379.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___123_9379.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___123_9379.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___123_9379.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___123_9379.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___123_9379.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___123_9379.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = true; FStar_TypeChecker_Env.use_eq = uu___123_9379.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___123_9379.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___123_9379.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___123_9379.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___123_9379.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___123_9379.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___123_9379.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___123_9379.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___123_9379.FStar_TypeChecker_Env.qname_and_index}) t uu____9373))
in (match (uu____9369) with
| (t1, uu____9381, g) -> begin
(

let g1 = (FStar_TypeChecker_Rel.resolve_implicits g)
in ((

let uu____9385 = (FStar_TypeChecker_Rel.discharge_guard env2 g1)
in (FStar_All.pipe_left FStar_Pervasives.ignore uu____9385));
(norm env0 t1);
))
end))
end)
...
let uu____9387 = ((termination_check_enabled lb.FStar_Syntax_Syntax.lbname e t1) && (FStar_TypeChecker_Env.should_verify env2))
in (match (uu____9387) with
| true -> begin
(

let uu___124_9388 = env2
in {FStar_TypeChecker_Env.solver = uu___124_9388.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___124_9388.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___124_9388.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___124_9388.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___124_9388.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___124_9388.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___124_9388.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___124_9388.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___124_9388.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___124_9388.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___124_9388.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___124_9388.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = (((lb.FStar_Syntax_Syntax.lbname), (t1)))::env2.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___124_9388.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___124_9388.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___124_9388.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___124_9388.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___124_9388.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___124_9388.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___124_9388.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___124_9388.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___124_9388.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___124_9388.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___124_9388.FStar_TypeChecker_Env.qname_and_index})
end
| uu____9395 -> begin
...
let uu___125_9398 = lb
in {FStar_Syntax_Syntax.lbname = uu___125_9398.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = univ_vars1; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = uu___125_9398.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = e})
in (((lb1)::lbs1), (env3)))))))
end))
end)) (([]), (env)) lbs)
...
let uu____9417 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> ((

let uu____9429 = (

let uu____9430 = (FStar_Syntax_Subst.compress lb.FStar_Syntax_Syntax.lbdef)
in uu____9430.FStar_Syntax_Syntax.n)
in (match (uu____9429) with
| FStar_Syntax_Syntax.Tm_abs (uu____9433) -> begin
()
end
| uu____9448 -> begin
(
...
let uu____9453 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (("Only function literals may be defined recursively"), (uu____9453)))
in FStar_Errors.Error (uu____9450))
in (FStar_Pervasives.raise uu____9449))
end));
(

let uu____9454 = (

let uu____9458 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term uu____9458 lb.FStar_Syntax_Syntax.lbdef))
...
let uu____9466 = (FStar_Syntax_Util.is_total_lcomp c)
in (not (uu____9466)))
...
in (FStar_All.pipe_right uu____9417 FStar_List.unzip))
...
let uu____9495 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____9495) with
| (env1, uu____9505) -> begin
(

let e1 = lb.FStar_Syntax_Syntax.lbdef
in (

let uu____9511 = (check_lbtyp top_level env lb)
...
let uu____9537 = (tc_maybe_toplevel_term (

let uu___126_9541 = env11
in {FStar_TypeChecker_Env.solver = uu___126_9541.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___126_9541.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___126_9541.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___126_9541.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___126_9541.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___126_9541.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___126_9541.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___126_9541.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___126_9541.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___126_9541.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___126_9541.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___126_9541.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___126_9541.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = top_level; FStar_TypeChecker_Env.check_uvars = uu___126_9541.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___126_9541.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___126_9541.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___126_9541.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___126_9541.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___126_9541.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___126_9541.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___126_9541.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___126_9541.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___126_9541.FStar_TypeChecker_Env.qname_and_index}) e11)
...
let uu____9553 = (FStar_TypeChecker_Env.set_range env11 e12.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (FStar_Pervasives_Native.Some ((fun uu____9556 -> FStar_TypeChecker_Err.ill_kinded_type))) uu____9553 e12 c1 wf_annot))
...
let uu____9566 = (FStar_TypeChecker_Env.debug env FStar_Options.Extreme)
in (match (uu____9566) with
| true -> begin
(

let uu____9567 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (

let uu____9568 = (FStar_Syntax_Print.term_to_string c11.FStar_Syntax_Syntax.res_typ)
in (

let uu____9569 = (FStar_TypeChecker_Rel.guard_to_string env g11)
...
let uu____9596 = (FStar_Syntax_Subst.univ_var_opening lb.FStar_Syntax_Syntax.lbunivs)
...
let uu____9623 = (FStar_TypeChecker_Env.set_expected_typ env1 t1)
in ((FStar_Pervasives_Native.Some (t1)), (FStar_TypeChecker_Rel.trivial_guard), (univ_vars1), (univ_opening), (uu____9623)))
end
| uu____9627 -> begin
(

let uu____9628 = (FStar_Syntax_Util.type_u ())
in (match (uu____9628) with
| (k, uu____9639) -> begin
(

let uu____9640 = (tc_check_tot_or_gtot_term env1 t1 k)
in (match (uu____9640) with
| (t2, uu____9652, g) -> begin
((

let uu____9655 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
...
let uu____9657 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (FStar_Range.string_of_range uu____9657))
in (

let uu____9658 = (FStar_Syntax_Print.term_to_string t2)
in (FStar_Util.print2 "(%s) Checked type annotation %s\n" uu____9656 uu____9658)))
end
| uu____9659 -> begin
()
end));
...
let uu____9661 = (FStar_TypeChecker_Env.set_expected_typ env1 t3)
in ((FStar_Pervasives_Native.Some (t3)), (g), (univ_vars1), (univ_opening), (uu____9661))));
)
end))
end))
end)))
...
and tc_binder : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual)  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual) * FStar_TypeChecker_Env.env * FStar_TypeChecker_Env.guard_t * FStar_Syntax_Syntax.universe) = (fun env uu____9666 -> (match (uu____9666) with
| (x, imp) -> begin
(

let uu____9677 = (FStar_Syntax_Util.type_u ())
in (match (uu____9677) with
| (tu, u) -> begin
((

let uu____9689 = (FStar_TypeChecker_Env.debug env FStar_Options.Extreme)
in (match (uu____9689) with
| true -> begin
(

let uu____9690 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____9691 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____9692 = (FStar_Syntax_Print.term_to_string tu)
in (FStar_Util.print3 "Checking binders %s:%s at type %s\n" uu____9690 uu____9691 uu____9692))))
end
| uu____9693 -> begin
()
end));
...
let uu____9694 = (tc_check_tot_or_gtot_term env x.FStar_Syntax_Syntax.sort tu)
in (match (uu____9694) with
| (t, uu____9705, g) -> begin
(

let x1 = (((

let uu___127_9710 = x
in {FStar_Syntax_Syntax.ppname = uu___127_9710.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___127_9710.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (imp))
in ((

let uu____9712 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____9712) with
| true -> begin
(

let uu____9713 = (FStar_Syntax_Print.bv_to_string (FStar_Pervasives_Native.fst x1))
in (

let uu____9714 = (FStar_Syntax_Print.term_to_string t)
...
let uu____9716 = (push_binding env x1)
in ((x1), (uu____9716), (g), (u)));
))
end));
)
end))
...
let uu____9767 = (tc_binder env1 b)
in (match (uu____9767) with
| (b1, env', g, u) -> begin
(

let uu____9790 = (aux env' bs2)
...
let uu____9820 = (FStar_TypeChecker_Rel.close_guard_univs ((u)::[]) ((b1)::[]) g')
in (FStar_TypeChecker_Rel.conj_guard g uu____9820))
in (((b1)::bs3), (env'1), (uu____9819), ((u)::us)))
end))
end))
end))
in (aux env bs)))
...
let tc_args = (fun env1 args -> (FStar_List.fold_right (fun uu____9863 uu____9864 -> (match (((uu____9863), (uu____9864))) with
| ((t, imp), (args1, g)) -> begin
(

let uu____9901 = (tc_term env1 t)
in (match (uu____9901) with
| (t1, uu____9911, g') -> begin
(

let uu____9913 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((((t1), (imp)))::args1), (uu____9913)))
end))
end)) args (([]), (FStar_TypeChecker_Rel.trivial_guard))))
in (FStar_List.fold_right (fun p uu____9931 -> (match (uu____9931) with
| (pats1, g) -> begin
(

let uu____9945 = (tc_args env p)
in (match (uu____9945) with
| (args, g') -> begin
(

let uu____9953 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((args)::pats1), (uu____9953)))
end))
end)) pats (([]), (FStar_TypeChecker_Rel.trivial_guard)))))
and tc_tot_or_gtot_term : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.lcomp * FStar_TypeChecker_Env.guard_t) = (fun env e -> (

let uu____9961 = (tc_maybe_toplevel_term env e)
in (match (uu____9961) with
| (e1, c, g) -> begin
(

let uu____9971 = (FStar_Syntax_Util.is_tot_or_gtot_lcomp c)
...
let uu____9984 = (FStar_TypeChecker_Util.is_pure_effect env (FStar_Syntax_Util.comp_effect_name c2))
in (match (uu____9984) with
| true -> begin
(

let uu____9987 = (FStar_Syntax_Syntax.mk_Total (FStar_Syntax_Util.comp_result c2))
in ((uu____9987), (false)))
end
| uu____9988 -> begin
(

let uu____9989 = (FStar_Syntax_Syntax.mk_GTotal (FStar_Syntax_Util.comp_result c2))
in ((uu____9989), (true)))
end))
...
let uu____9995 = (FStar_TypeChecker_Rel.sub_comp env c2 target_comp)
in (match (uu____9995) with
| FStar_Pervasives_Native.Some (g') -> begin
(

let uu____10001 = (FStar_TypeChecker_Rel.conj_guard g1 g')
in ((e1), ((FStar_Syntax_Util.lcomp_of_comp target_comp)), (uu____10001)))
end
| uu____10002 -> begin
...
let uu____10011 = (FStar_TypeChecker_Err.expected_ghost_expression e1 c2)
in ((uu____10011), (e1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____10008))
in (FStar_Pervasives.raise uu____10007))
end
| uu____10015 -> begin
(
...
let uu____10020 = (FStar_TypeChecker_Err.expected_pure_expression e1 c2)
in ((uu____10020), (e1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____10017))
in (FStar_Pervasives.raise uu____10016))
end)
end))
end)))))
end))
...
let uu____10033 = (tc_tot_or_gtot_term env t)
...
let uu____10053 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck")))
in (match (uu____10053) with
| true -> begin
(

let uu____10054 = (FStar_Syntax_Print.term_to_string e)
...
let uu___128_10057 = env
in {FStar_TypeChecker_Env.solver = uu___128_10057.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___128_10057.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___128_10057.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___128_10057.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___128_10057.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___128_10057.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___128_10057.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___128_10057.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___128_10057.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___128_10057.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___128_10057.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___128_10057.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = []; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___128_10057.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___128_10057.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___128_10057.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___128_10057.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___128_10057.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___128_10057.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___128_10057.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___128_10057.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___128_10057.FStar_TypeChecker_Env.qname_and_index})
in (
...
with
| FStar_Errors.Error (msg, uu____10076) -> begin
(
...
let uu____10081 = (FStar_TypeChecker_Env.get_range env1)
in (((Prims.strcat "Implicit argument: " msg)), (uu____10081)))
in FStar_Errors.Error (uu____10078))
in (FStar_Pervasives.raise uu____10077))
end
in (match (uu____10060) with
| (t, c, g) -> begin
(

let uu____10091 = (FStar_Syntax_Util.is_total_lcomp c)
...
let uu____10103 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" uu____10103))
in (

let uu____10104 = (FStar_TypeChecker_Env.get_range env1)
in ((uu____10102), (uu____10104))))
in FStar_Errors.Error (uu____10099))
in (FStar_Pervasives.raise uu____10098))
end))
end)));
))
...
let uu____10130 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format2 "Expected a term of type \'Type\'; got %s : %s" uu____10130 t))
in (

let uu____10131 = (FStar_TypeChecker_Env.get_range env)
in ((uu____10129), (uu____10131))))
in FStar_Errors.Error (uu____10126))
in (FStar_Pervasives.raise uu____10125)))
...
let uu____10149 = (FStar_Syntax_Util.unrefine t1)
...
let uu____10156 = (FStar_Syntax_Util.type_u ())
in (match (uu____10156) with
| (t_u, u) -> begin
(

let env1 = (

let uu___131_10162 = env
in {FStar_TypeChecker_Env.solver = uu___131_10162.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___131_10162.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___131_10162.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___131_10162.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___131_10162.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___131_10162.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___131_10162.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___131_10162.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___131_10162.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___131_10162.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___131_10162.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___131_10162.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___131_10162.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___131_10162.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___131_10162.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___131_10162.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___131_10162.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___131_10162.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___131_10162.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___131_10162.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___131_10162.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___131_10162.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___131_10162.FStar_TypeChecker_Env.qname_and_index})
in (
...
let uu____10166 = (FStar_Syntax_Print.term_to_string t1)
in (level_of_type_fail env1 e uu____10166))
end
| uu____10167 -> begin
(FStar_TypeChecker_Rel.force_trivial_guard env1 g)
end);
...
let uu____10177 = (FStar_Syntax_Subst.compress e)
in uu____10177.FStar_Syntax_Syntax.n)
in (match (uu____10176) with
| FStar_Syntax_Syntax.Tm_bvar (uu____10182) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_delayed (uu____10187) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_let (uu____10210) -> begin
(

let e1 = (FStar_TypeChecker_Normalize.normalize [] env e)
in (universe_of_aux env e1))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t, uu____10221) -> begin
(level_of_type_fail env e "arrow type")
end
| FStar_Syntax_Syntax.Tm_uvar (uu____10246, t) -> begin
t
end
| FStar_Syntax_Syntax.Tm_meta (t, uu____10261) -> begin
...
let uu____10268 = (FStar_TypeChecker_Env.lookup_lid env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (uu____10268) with
| ((uu____10279, t), uu____10281) -> begin
t
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____10284, (FStar_Util.Inl (t), uu____10286), uu____10287) -> begin
t
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____10323, (FStar_Util.Inr (c), uu____10325), uu____10326) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = uu____10369; FStar_Syntax_Syntax.pos = uu____10370; FStar_Syntax_Syntax.vars = uu____10371}, us) -> begin
(

let uu____10377 = (FStar_TypeChecker_Env.lookup_lid env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (uu____10377) with
| ((us', t), uu____10390) -> begin
...
let uu____10402 = (FStar_TypeChecker_Env.get_range env)
in (("Unexpected number of universe instantiations"), (uu____10402)))
in FStar_Errors.Error (uu____10399))
in (FStar_Pervasives.raise uu____10398))
end
| uu____10403 -> begin
(FStar_List.iter2 (fun u' u -> (match (u') with
| FStar_Syntax_Syntax.U_unif (u'') -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (uu____10411) -> begin
(failwith "Impossible: Tm_uinst\'s head must be an fvar")
end
| FStar_Syntax_Syntax.Tm_refine (x, uu____10419) -> begin
(universe_of_aux env x.FStar_Syntax_Syntax.sort)
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let uu____10436 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____10436) with
| (bs1, c1) -> begin
(

let us = (FStar_List.map (fun uu____10447 -> (match (uu____10447) with
| (b, uu____10451) -> begin
(

let uu____10452 = (universe_of_aux env b.FStar_Syntax_Syntax.sort)
in (level_of_type env b.FStar_Syntax_Syntax.sort uu____10452))
end)) bs1)
in (
...
let uu____10457 = (universe_of_aux env res)
in (level_of_type env res uu____10457)))
in (

let u_c = (

let uu____10459 = (FStar_TypeChecker_Env.effect_repr env c1 u_res)
...
let uu____10462 = (universe_of_aux env trepr)
in (level_of_type env trepr uu____10462))
end))
in (
...
| FStar_Syntax_Syntax.Tm_bvar (uu____10532) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_delayed (uu____10542) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (uu____10572) -> begin
(

let uu____10573 = (universe_of_aux env hd3)
in ((uu____10573), (args1)))
end
| FStar_Syntax_Syntax.Tm_name (uu____10583) -> begin
(

let uu____10584 = (universe_of_aux env hd3)
in ((uu____10584), (args1)))
end
| FStar_Syntax_Syntax.Tm_uvar (uu____10594) -> begin
(

let uu____10603 = (universe_of_aux env hd3)
in ((uu____10603), (args1)))
end
| FStar_Syntax_Syntax.Tm_uinst (uu____10613) -> begin
(

let uu____10618 = (universe_of_aux env hd3)
in ((uu____10618), (args1)))
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____10628) -> begin
(

let uu____10646 = (universe_of_aux env hd3)
in ((uu____10646), (args1)))
end
| FStar_Syntax_Syntax.Tm_refine (uu____10656) -> begin
(

let uu____10661 = (universe_of_aux env hd3)
in ((uu____10661), (args1)))
end
| FStar_Syntax_Syntax.Tm_constant (uu____10671) -> begin
(

let uu____10672 = (universe_of_aux env hd3)
in ((uu____10672), (args1)))
end
| FStar_Syntax_Syntax.Tm_arrow (uu____10682) -> begin
(

let uu____10690 = (universe_of_aux env hd3)
in ((uu____10690), (args1)))
end
| FStar_Syntax_Syntax.Tm_meta (uu____10700) -> begin
(

let uu____10705 = (universe_of_aux env hd3)
in ((uu____10705), (args1)))
end
| FStar_Syntax_Syntax.Tm_type (uu____10715) -> begin
(

let uu____10716 = (universe_of_aux env hd3)
in ((uu____10716), (args1)))
end
| FStar_Syntax_Syntax.Tm_match (uu____10726, (hd4)::uu____10728) -> begin
(

let uu____10775 = (FStar_Syntax_Subst.open_branch hd4)
in (match (uu____10775) with
| (uu____10785, uu____10786, hd5) -> begin
(

let uu____10802 = (FStar_Syntax_Util.head_and_args hd5)
...
let uu____10839 = (FStar_Syntax_Util.head_and_args e1)
in (match (uu____10839) with
| (hd4, args2) -> begin
...
let uu____10875 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____10875) with
| (env1, uu____10889) -> begin
(

let env2 = (

let uu___132_10893 = env1
in {FStar_TypeChecker_Env.solver = uu___132_10893.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___132_10893.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___132_10893.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___132_10893.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___132_10893.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___132_10893.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___132_10893.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___132_10893.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___132_10893.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___132_10893.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___132_10893.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___132_10893.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___132_10893.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___132_10893.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___132_10893.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___132_10893.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___132_10893.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___132_10893.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___132_10893.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___132_10893.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___132_10893.FStar_TypeChecker_Env.qname_and_index})
in ((

let uu____10895 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("UniverseOf")))
in (match (uu____10895) with
| true -> begin
(

let uu____10896 = (

let uu____10897 = (FStar_TypeChecker_Env.get_range env2)
in (FStar_Range.string_of_range uu____10897))
in (

let uu____10898 = (FStar_Syntax_Print.term_to_string hd3)
...
let uu____10900 = (tc_term env2 hd3)
in (match (uu____10900) with
| (uu____10913, {FStar_Syntax_Syntax.eff_name = uu____10914; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu____10916; FStar_Syntax_Syntax.comp = uu____10917}, g) -> begin
((

let uu____10927 = (FStar_TypeChecker_Rel.solve_deferred_constraints env2 g)
in (FStar_All.pipe_right uu____10927 FStar_Pervasives.ignore));
((t), (args1));
)
end));
))
...
let uu____10935 = (type_of_head true hd1 args)
in (match (uu____10935) with
| (t, args1) -> begin
(
...
let uu____10964 = (FStar_Syntax_Util.arrow_formals_comp t1)
...
let uu____10997 = (FStar_Syntax_Print.term_to_string res1)
in (level_of_type_fail env e uu____10997))
end))
end)))
end)))
end
| FStar_Syntax_Syntax.Tm_match (uu____11000, (hd1)::uu____11002) -> begin
(

let uu____11049 = (FStar_Syntax_Subst.open_branch hd1)
in (match (uu____11049) with
| (uu____11052, uu____11053, hd2) -> begin
(universe_of_aux env hd2)
end))
end
| FStar_Syntax_Syntax.Tm_match (uu____11069, []) -> begin
...
let uu____11103 = (universe_of_aux env e)
in (level_of_type env e uu____11103)))
...
let uu____11116 = (tc_binders env tps)
