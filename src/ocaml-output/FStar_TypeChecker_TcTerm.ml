             ...
             (let uu____25239 =
                let uu____25245 =
                  ...
                  FStar_Util.format1
                    ...
                    uu____25247 in
                (FStar_Errors.Fatal_UnexpectedImplictArgument, uu____25245) in
    ...
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu____25605;_},
           us)
          ->
          let uu____25611 =
            FStar_TypeChecker_Env.lookup_lid env
            ...
            | FStar_Syntax_Syntax.Tm_match (uu____26079, hd4::uu____26081) ->
                ...
                (match uu____26146 with
                 | (uu____26161, uu____26162, hd5) ->
                     let uu____26180 = FStar_Syntax_Util.head_and_args hd5 in
                 ...
                 | (env1, uu____26320) ->
                     ...
                     ((let uu____26331 =
                      ...
                      (let uu____26344 = tc_term env2 hd3 in
                       ...
                       | (uu____26365,
                          { FStar_Syntax_Syntax.eff_name = uu____26366;
                            FStar_Syntax_Syntax.res_typ = t;
                            FStar_Syntax_Syntax.cflags = uu____26368;
                            FStar_Syntax_Syntax.comp_thunk = uu____26369;_},
                          g) ->
                           ((let uu____26383 =
                               FStar_TypeChecker_Rel.solve_deferred_constraints
                                 env2 g in
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu____26762;_},
           us)
          ->
          let uu____26768 =
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____27157;_},
           a::hd1::rest)
          ->
          let rest1 = hd1 :: rest in
          ...
          (match uu____27236 with
           | (unary_op1, uu____27256) ->
               let head1 =
                 ...
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (unary_op1, [a]))
                   FStar_Pervasives_Native.None uu____27284 in
               let t2 =
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (head1, rest1))
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____27333;_},
           a1::a2::hd1::rest)
          ->
          let rest1 = hd1 :: rest in
          ...
          (match uu____27429 with
           | (unary_op1, uu____27449) ->
               let head1 =
                 ...
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (unary_op1, [a1; a2]))
                   FStar_Pervasives_Native.None uu____27477 in
               let t2 =
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (head1, rest1))
                   FStar_Pervasives_Native.None t1.FStar_Syntax_Syntax.pos in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____27534;_},
           uu____27535::[])
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____27575;_},
           (t2, uu____27577)::uu____27578::[])
          -> type_of_well_typed_term env t2
      | FStar_Syntax_Syntax.Tm_app (hd1, args) ->
                ...
                let bs_t_opt =
                  ...
                  then
                    ...
                    | (bs1, rest) ->
                        ...
                        let uu____27836 =
                          let uu____27841 = FStar_Syntax_Syntax.mk_Total t2 in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____27895 = FStar_Syntax_Subst.open_comp bs c in
                     ...
                     | (bs1, t2) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args in
                         let uu____28074 = FStar_Syntax_Subst.subst subst1 t2 in
        ...
        fun k ->
          ...
          let slow_check uu____28349 =
            ...
            then
              ...
              (let uu____28363 = env2.FStar_TypeChecker_Env.tc_term env2 t in
               match uu____28363 with | (uu____28370, uu____28371, g) -> g) in
        ...
        fun k ->
          ...
          let slow_check uu____28453 =
            ...
            then
              ...
              (let uu____28467 = env2.FStar_TypeChecker_Env.tc_term env2 t in
               match uu____28467 with | (uu____28474, uu____28475, g) -> g) in
          let uu____28477 =
