...
let uu____12032 = (FStar_TypeChecker_Rel.teq_nosmt env12 lc.FStar_Syntax_Syntax.res_typ expected_pat_t)
...
let uu____12034 = (FStar_TypeChecker_Rel.discharge_guard_no_smt env13 g1)
in (FStar_All.pipe_right uu____12034 FStar_TypeChecker_Rel.resolve_implicits)))
end
| uu____12035 -> begin
(
...
let uu____12043 = (FStar_Syntax_Print.term_to_string lc.FStar_Syntax_Syntax.res_typ)
in (

let uu____12044 = (FStar_Syntax_Print.term_to_string expected_pat_t)
in (FStar_Util.format2 "Inferred type of pattern (%s) is incompatible with the type of the scrutinee (%s)" uu____12043 uu____12044)))
in ((uu____12042), (exp1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____12037))
in (FStar_Exn.raise uu____12036))
end))
in (
...
let uu____12062 = (FStar_Util.set_is_subset_of uvs1 uvs2)
in (FStar_All.pipe_left Prims.op_Negation uu____12062))
...
let uu____12074 = (FStar_Util.set_difference uvs1 uvs2)
in (FStar_All.pipe_right uu____12074 FStar_Util.set_elements))
in (
...
let uu____12108 = (FStar_TypeChecker_Normalize.term_to_string env norm_exp)
in (

let uu____12109 = (FStar_TypeChecker_Normalize.term_to_string env expected_pat_t)
in (

let uu____12110 = (

let uu____12111 = (FStar_All.pipe_right unresolved (FStar_List.map (fun uu____12129 -> (match (uu____12129) with
| (u, uu____12135) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right uu____12111 (FStar_String.concat ", ")))
in (FStar_Util.format3 "Implicit pattern variables in %s could not be resolved against expected type %s;Variables {%s} were unresolved; please bind them explicitly" uu____12108 uu____12109 uu____12110))))
in ((uu____12107), (p.FStar_Syntax_Syntax.p)))
in FStar_Errors.Error (uu____12102))
in (FStar_Exn.raise uu____12101)))
end
| uu____12138 -> begin
()
end));
...
let uu____12140 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____12140) with
| true -> begin
(

let uu____12141 = (FStar_TypeChecker_Normalize.term_to_string env exp1)
...
let uu____12157 = (FStar_TypeChecker_Env.push_bv env scrutinee)
in (FStar_All.pipe_right uu____12157 FStar_TypeChecker_Env.clear_expected_typ))
in (match (uu____12150) with
| (scrutinee_env, uu____12181) -> begin
(

let uu____12186 = (tc_pat true pat_t pattern)
in (match (uu____12186) with
| (pattern1, pat_bvs1, pat_env, pat_exp, norm_pat_exp) -> begin
(

let uu____12224 = (match (when_clause) with
| FStar_Pervasives_Native.None -> begin
...
let uu____12246 = (FStar_TypeChecker_Env.should_verify env)
...
let uu____12267 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_Syntax_Util.t_bool)
in (tc_term uu____12267 e))
...
let uu____12301 = (tc_term pat_env branch_exp)
...
let uu____12333 = (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero FStar_Syntax_Util.t_bool w FStar_Syntax_Util.exp_true_bool)
in (FStar_All.pipe_left (fun _0_41 -> FStar_Pervasives_Native.Some (_0_41)) uu____12333))
end)
in (
...
let uu____12347 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____12347)))
...
| FStar_Syntax_Syntax.Tm_uvar (uu____12354) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Tm_constant (uu____12371) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Tm_fvar (uu____12372) -> begin
FStar_Pervasives_Native.None
end
| uu____12373 -> begin
(
...
let uu____12375 = (env.FStar_TypeChecker_Env.universe_of env pat_t)
in (FStar_Syntax_Util.mk_eq2 uu____12375 pat_t scrutinee_tm e))
in FStar_Pervasives_Native.Some (uu____12374))
end))
end))
in (

let uu____12376 = (FStar_TypeChecker_Util.strengthen_precondition FStar_Pervasives_Native.None env branch_exp1 c g_branch)
in (match (uu____12376) with
| (c1, g_branch1) -> begin
(

let uu____12391 = (match (((eqs), (when_condition))) with
| uu____12404 when (

let uu____12413 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____12413))) -> begin
((c1), (g_when))
end
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
((c1), (g_when))
...
let uu____12425 = (FStar_TypeChecker_Util.weaken_precondition env c1 gf)
in (

let uu____12426 = (FStar_TypeChecker_Rel.imp_guard g g_when)
in ((uu____12425), (uu____12426))))))
end
...
let uu____12435 = (FStar_Syntax_Util.mk_conj f w)
in FStar_TypeChecker_Common.NonTrivial (uu____12435))
in (

let uu____12436 = (FStar_TypeChecker_Util.weaken_precondition env c1 g_fw)
in (

let uu____12437 = (

let uu____12438 = (FStar_TypeChecker_Rel.guard_of_guard_formula g_f)
in (FStar_TypeChecker_Rel.imp_guard uu____12438 g_when))
in ((uu____12436), (uu____12437))))))
end
...
let uu____12446 = (FStar_TypeChecker_Util.weaken_precondition env c1 g_w)
in ((uu____12446), (g_when)))))
end)
...
let uu____12458 = (FStar_TypeChecker_Util.close_lcomp env pat_bvs1 c_weak)
in (

let uu____12459 = (FStar_TypeChecker_Rel.close_guard env binders g_when_weak)
in ((uu____12458), (uu____12459), (g_branch1)))))
end))
end)))
...
let uu____12481 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____12481)))
...
let uu____12523 = (FStar_TypeChecker_Env.typ_of_datacon env f.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.datacons_of_typ env uu____12523))
in (FStar_Pervasives_Native.snd uu____12516))
in (FStar_List.length uu____12513))
in (uu____12512 > (Prims.parse_int "1")))
...
let uu____12529 = (FStar_TypeChecker_Env.try_lookup_lid env discriminator)
...
let uu____12567 = (FStar_Syntax_Syntax.as_arg scrutinee_tm2)
in (uu____12567)::[])
in (FStar_Syntax_Syntax.mk_Tm_app disc uu____12566))
in (uu____12565 FStar_Pervasives_Native.None scrutinee_tm2.FStar_Syntax_Syntax.pos))
in (

let uu____12570 = (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero FStar_Syntax_Util.t_bool disc1 FStar_Syntax_Util.exp_true_bool)
in (uu____12570)::[])))
end)))
end
| uu____12571 -> begin
...
let fail = (fun uu____12575 -> (

let uu____12576 = (

let uu____12577 = (FStar_Range.string_of_range pat_exp1.FStar_Syntax_Syntax.pos)
in (

let uu____12578 = (FStar_Syntax_Print.term_to_string pat_exp1)
in (

let uu____12579 = (FStar_Syntax_Print.tag_of_term pat_exp1)
in (FStar_Util.format3 "tc_eqn: Impossible (%s) %s (%s)" uu____12577 uu____12578 uu____12579))))
in (failwith uu____12576)))
in (
...
| FStar_Syntax_Syntax.Tm_uinst (t1, uu____12590) -> begin
(head_constructor t1)
end
| uu____12595 -> begin
(fail ())
...
let uu____12597 = (FStar_Syntax_Subst.compress pat_exp1)
in (FStar_All.pipe_right uu____12597 FStar_Syntax_Util.unmeta))
in (match (pat_exp2.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uvar (uu____12600) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uu____12617); FStar_Syntax_Syntax.pos = uu____12618; FStar_Syntax_Syntax.vars = uu____12619}, uu____12620) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_name (uu____12657) -> begin
[]
end
...
let uu____12660 = (tc_constant pat_exp2.FStar_Syntax_Syntax.pos c2)
in (FStar_Syntax_Util.mk_eq2 FStar_Syntax_Syntax.U_zero uu____12660 scrutinee_tm1 pat_exp2))
in (uu____12659)::[])
end
| FStar_Syntax_Syntax.Tm_uinst (uu____12661) -> begin
(
...
let uu____12674 = (head_constructor pat_exp2)
in (discriminate scrutinee_tm1 uu____12674))
end)))
end
| FStar_Syntax_Syntax.Tm_fvar (uu____12677) -> begin
(
...
let uu____12680 = (FStar_TypeChecker_Env.is_datacon env f.FStar_Syntax_Syntax.v)
in (not (uu____12680)))
...
let uu____12684 = (head_constructor pat_exp2)
in (discriminate scrutinee_tm1 uu____12684))
end)))
end
| FStar_Syntax_Syntax.Tm_app (head1, args) -> begin
(
...
let uu____12711 = (FStar_TypeChecker_Env.is_datacon env f.FStar_Syntax_Syntax.v)
in (not (uu____12711)))
...
let uu____12718 = (FStar_All.pipe_right args (FStar_List.mapi (fun i uu____12750 -> (match (uu____12750) with
| (ei, uu____12760) -> begin
(

let projector = (FStar_TypeChecker_Env.lookup_projector env f.FStar_Syntax_Syntax.v i)
in (

let uu____12766 = (FStar_TypeChecker_Env.try_lookup_lid env projector)
in (match (uu____12766) with
| FStar_Pervasives_Native.None -> begin
[]
end
| uu____12787 -> begin
...
let uu____12802 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projector f.FStar_Syntax_Syntax.p) FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in (

let uu____12803 = (

let uu____12804 = (FStar_Syntax_Syntax.as_arg scrutinee_tm1)
in (uu____12804)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____12802 uu____12803)))
in (uu____12801 FStar_Pervasives_Native.None f.FStar_Syntax_Syntax.p))
in (build_branch_guard sub_term ei))
end)))
end))))
in (FStar_All.pipe_right uu____12718 FStar_List.flatten))
in (

let uu____12813 = (discriminate scrutinee_tm1 f)
in (FStar_List.append uu____12813 sub_term_guards)))
end)))
end
| uu____12816 -> begin
[]
...
let uu____12829 = (FStar_TypeChecker_Env.should_verify env)
in (not (uu____12829)))
...
let uu____12832 = (build_branch_guard scrutinee_tm1 pat)
in (FStar_All.pipe_left FStar_Syntax_Util.mk_conj_l uu____12832))
in (

let uu____12837 = (FStar_Syntax_Util.type_u ())
in (match (uu____12837) with
| (k, uu____12843) -> begin
(

let uu____12844 = (tc_check_tot_or_gtot_term scrutinee_env t k)
in (match (uu____12844) with
| (t1, uu____12852, uu____12853) -> begin
t1
end))
end)))
end)))
...
let uu____12859 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____12859) with
| true -> begin
(

let uu____12860 = (FStar_TypeChecker_Rel.guard_to_string env guard)
...
let uu____12862 = (FStar_Syntax_Subst.close_branch ((pattern1), (when_clause1), (branch_exp1)))
in ((uu____12862), (branch_guard), (c1), (guard)));
)))
end)))
end))
end))
...
let uu____12888 = (check_let_bound_def true env1 lb)
in (match (uu____12888) with
| (e1, univ_vars1, c1, g1, annotated) -> begin
(

let uu____12910 = (match ((annotated && (not (env1.FStar_TypeChecker_Env.generalize)))) with
| true -> begin
(

let uu____12927 = (FStar_TypeChecker_Normalize.reduce_uvar_solutions env1 e1)
in ((g1), (uu____12927), (univ_vars1), (c1)))
end
| uu____12928 -> begin
(
...
let uu____12930 = (FStar_TypeChecker_Rel.solve_deferred_constraints env1 g1)
in (FStar_All.pipe_right uu____12930 FStar_TypeChecker_Rel.resolve_implicits))
in (
...
let uu____12984 = (c1.FStar_Syntax_Syntax.comp ())
in ((lb.FStar_Syntax_Syntax.lbname), (e1), (uu____12984)))
in (uu____12971)::[])
in (FStar_TypeChecker_Util.generalize env1 false uu____12962))
in (FStar_List.hd uu____12947))
in (match (uu____12934) with
| (uu____13037, univs1, e11, c11, gvs) -> begin
(
...
let uu____13067 = (FStar_TypeChecker_Env.should_verify env1)
in (match (uu____13067) with
| true -> begin
(

let uu____13074 = (FStar_TypeChecker_Util.check_top_level env1 g11 c11)
in (match (uu____13074) with
| (ok, c12) -> begin
(match (ok) with
| true -> begin
((e2), (c12))
...
let uu____13097 = (FStar_TypeChecker_Env.get_range env1)
in (FStar_Errors.warn uu____13097 FStar_TypeChecker_Err.top_level_effect));
(

let uu____13098 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e2), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect))))) FStar_Pervasives_Native.None e2.FStar_Syntax_Syntax.pos)
in ((uu____13098), (c12)));
)
end)
end))
...
let uu____13108 = (c11.FStar_Syntax_Syntax.comp ())
in (FStar_All.pipe_right uu____13108 (FStar_TypeChecker_Normalize.normalize_comp ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.NoFullNorm)::[]) env1)))
in (

let e21 = (

let uu____13116 = (FStar_Syntax_Util.is_pure_comp c)
...
let uu____13140 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((false), ((lb1)::[]))), (e21)))) FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos)
in ((uu____13140), ((FStar_Syntax_Util.lcomp_of_comp cres)), (FStar_TypeChecker_Rel.trivial_guard)))))
end))
end))
end))
end
...
let uu___146_13186 = env1
in {FStar_TypeChecker_Env.solver = uu___146_13186.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___146_13186.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___146_13186.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___146_13186.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___146_13186.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___146_13186.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___146_13186.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___146_13186.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___146_13186.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___146_13186.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___146_13186.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___146_13186.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___146_13186.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___146_13186.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___146_13186.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___146_13186.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___146_13186.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___146_13186.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___146_13186.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___146_13186.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___146_13186.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___146_13186.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___146_13186.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___146_13186.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___146_13186.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___146_13186.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___146_13186.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___146_13186.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___146_13186.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___146_13186.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___146_13186.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___146_13186.FStar_TypeChecker_Env.dsenv})
in (
...
let uu____13199 = (FStar_TypeChecker_Env.clear_expected_typ env2)
in (FStar_All.pipe_right uu____13199 FStar_Pervasives_Native.fst))
in (check_let_bound_def false uu____13198 lb))
in (match (uu____13187) with
| (e1, uu____13221, c1, g1, annotated) -> begin
(

let x = (

let uu___147_13226 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___147_13226.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___147_13226.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = c1.FStar_Syntax_Syntax.res_typ})
in (
...
let uu____13233 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____13233)::[])
in (FStar_Syntax_Subst.open_term uu____13232 e2))
...
let uu____13259 = (FStar_TypeChecker_Env.push_bv env2 x1)
in (tc_term uu____13259 e21))
...
let uu____13295 = (FStar_Syntax_Subst.close xb e23)
in ((((false), ((lb1)::[]))), (uu____13295)))
in FStar_Syntax_Syntax.Tm_let (uu____13282))
in (FStar_Syntax_Syntax.mk uu____13281))
in (uu____13278 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos))
in (
...
let uu____13310 = (env2.FStar_TypeChecker_Env.universe_of env2 c1.FStar_Syntax_Syntax.res_typ)
in (

let uu____13311 = (FStar_Syntax_Syntax.bv_to_name x1)
in (FStar_Syntax_Util.mk_eq2 uu____13310 c1.FStar_Syntax_Syntax.res_typ uu____13311 e11)))
in (FStar_All.pipe_left (fun _0_42 -> FStar_TypeChecker_Common.NonTrivial (_0_42)) uu____13309))
in (
...
let uu____13314 = (FStar_TypeChecker_Rel.guard_of_guard_formula x_eq_e1)
in (FStar_TypeChecker_Rel.imp_guard uu____13314 g2))
in (FStar_TypeChecker_Rel.close_guard env2 xb uu____13313))
in (
...
let uu____13317 = (FStar_TypeChecker_Env.expected_typ env2)
in (FStar_Option.isSome uu____13317))
...
let uu____13327 = (FStar_TypeChecker_Env.expected_typ env2)
in (FStar_All.pipe_right uu____13327 FStar_Option.get))
in ((

let uu____13333 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("Exports")))
in (match (uu____13333) with
| true -> begin
(

let uu____13334 = (FStar_Syntax_Print.term_to_string tt)
in (

let uu____13335 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
...
let uu____13340 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("Exports")))
in (match (uu____13340) with
| true -> begin
(

let uu____13341 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
in (

let uu____13342 = (FStar_Syntax_Print.term_to_string t)
...
let uu___148_13345 = cres
in {FStar_Syntax_Syntax.eff_name = uu___148_13345.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___148_13345.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___148_13345.FStar_Syntax_Syntax.comp})), (guard));
))
end)))))))))))
end))))
end)))
...
let uu____13378 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (uu____13378) with
| (lbs1, e21) -> begin
(

let uu____13397 = (FStar_TypeChecker_Env.clear_expected_typ env1)
in (match (uu____13397) with
| (env0, topt) -> begin
(

let uu____13416 = (build_let_rec_env true env0 lbs1)
in (match (uu____13416) with
| (lbs2, rec_env) -> begin
(

let uu____13435 = (check_let_recs rec_env lbs2)
...
let uu____13455 = (FStar_TypeChecker_Rel.solve_deferred_constraints env1 g_lbs)
in (FStar_All.pipe_right uu____13455 FStar_TypeChecker_Rel.resolve_implicits))
in (

let all_lb_names = (

let uu____13461 = (FStar_All.pipe_right lbs3 (FStar_List.map (fun lb -> (FStar_Util.right lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right uu____13461 (fun _0_43 -> FStar_Pervasives_Native.Some (_0_43))))
in (
...
let uu____13510 = (FStar_All.pipe_right lbs3 (FStar_List.map (fun lb -> (

let uu____13550 = (FStar_Syntax_Syntax.mk_Total lb.FStar_Syntax_Syntax.lbtyp)
in ((lb.FStar_Syntax_Syntax.lbname), (lb.FStar_Syntax_Syntax.lbdef), (uu____13550))))))
in (FStar_TypeChecker_Util.generalize env1 true uu____13510))
in (FStar_All.pipe_right ecs (FStar_List.map (fun uu____13599 -> (match (uu____13599) with
| (x, uvs, e, c, gvs) -> begin
...
let uu____13646 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Syntax.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____13646))
in (

let uu____13651 = (FStar_Syntax_Subst.close_let_rec lbs4 e21)
in (match (uu____13651) with
| (lbs5, e22) -> begin
((

let uu____13671 = (FStar_TypeChecker_Rel.discharge_guard env1 g_lbs1)
in (FStar_All.pipe_right uu____13671 (FStar_TypeChecker_Rel.force_trivial_guard env1)));
(

let uu____13672 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((true), (lbs5))), (e22)))) FStar_Pervasives_Native.None top.FStar_Syntax_Syntax.pos)
in ((uu____13672), (cres), (FStar_TypeChecker_Rel.trivial_guard)));
)
end))))))
end))
end))
...
let uu____13717 = (FStar_Syntax_Subst.open_let_rec lbs e2)
in (match (uu____13717) with
| (lbs1, e21) -> begin
(

let uu____13736 = (FStar_TypeChecker_Env.clear_expected_typ env1)
in (match (uu____13736) with
| (env0, topt) -> begin
(

let uu____13755 = (build_let_rec_env false env0 lbs1)
in (match (uu____13755) with
| (lbs2, rec_env) -> begin
(

let uu____13774 = (check_let_recs rec_env lbs2)
in (match (uu____13774) with
| (lbs3, g_lbs) -> begin
(

let uu____13793 = (FStar_All.pipe_right lbs3 (FStar_Util.fold_map (fun env2 lb -> (

let x = (

let uu___149_13816 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___149_13816.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___149_13816.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lb.FStar_Syntax_Syntax.lbtyp})
in (

let lb1 = (

let uu___150_13818 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___150_13818.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___150_13818.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___150_13818.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___150_13818.FStar_Syntax_Syntax.lbdef})
in (

let env3 = (FStar_TypeChecker_Env.push_let_binding env2 lb1.FStar_Syntax_Syntax.lbname (([]), (lb1.FStar_Syntax_Syntax.lbtyp)))
in ((env3), (lb1)))))) env1))
in (match (uu____13793) with
| (env2, lbs4) -> begin
(
...
let uu____13845 = (tc_term env2 e21)
...
let uu____13863 = (FStar_List.map FStar_Syntax_Syntax.mk_binder bvs)
in (FStar_TypeChecker_Rel.close_guard env2 uu____13863 g2))
in (FStar_TypeChecker_Rel.conj_guard g_lbs uu____13862))
in (
...
let uu___151_13867 = cres1
in {FStar_Syntax_Syntax.eff_name = uu___151_13867.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres; FStar_Syntax_Syntax.cflags = uu___151_13867.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___151_13867.FStar_Syntax_Syntax.comp})
in (

let uu____13868 = (FStar_Syntax_Subst.close_let_rec lbs4 e22)
...
in (match (topt) with
| FStar_Pervasives_Native.Some (uu____13904) -> begin
((e), (cres2), (guard))
end
| FStar_Pervasives_Native.None -> begin
(
...
let uu___152_13909 = cres2
in {FStar_Syntax_Syntax.eff_name = uu___152_13909.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = tres1; FStar_Syntax_Syntax.cflags = uu___152_13909.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___152_13909.FStar_Syntax_Syntax.comp})
in ((e), (cres3), (guard))))
end))
end))))))
end)))
...
let uu____13941 = (FStar_Options.ml_ish ())
in (match (uu____13941) with
| true -> begin
false
end
| uu____13942 -> begin
...
let uu____13950 = (FStar_Syntax_Subst.compress t)
in uu____13950.FStar_Syntax_Syntax.n)
in (

let uu____13953 = (

let uu____13954 = (FStar_Syntax_Subst.compress lbdef)
in uu____13954.FStar_Syntax_Syntax.n)
in ((uu____13949), (uu____13953))))
in (match (uu____13944) with
| (FStar_Syntax_Syntax.Tm_arrow (formals, c), FStar_Syntax_Syntax.Tm_abs (actuals, uu____13960, uu____13961)) -> begin
(

let actuals1 = (

let uu____13999 = (FStar_TypeChecker_Env.set_expected_typ env lbtyp)
in (FStar_TypeChecker_Util.maybe_add_implicit_binders uu____13999 actuals))
...
let uu____14020 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "%s arguments were found" uu____14020))
end))
in (
...
let uu____14038 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "%s arguments" uu____14038))
end))
in (

let msg = (

let uu____14046 = (FStar_Syntax_Print.term_to_string lbtyp)
in (

let uu____14047 = (FStar_Syntax_Print.lbname_to_string lbname)
in (FStar_Util.format4 "From its type %s, the definition of `let rec %s` expects a function with %s, but %s" uu____14046 uu____14047 formals_msg actuals_msg)))
...
let uu____14066 = (FStar_Syntax_Print.term_to_string lbdef)
in (

let uu____14067 = (FStar_Syntax_Print.term_to_string lbtyp)
in (FStar_Util.format2 "Only function literals with arrow types can be defined recursively; got %s : %s" uu____14066 uu____14067)))
in ((uu____14065), (lbtyp.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____14060))
in (FStar_Exn.raise uu____14059))
end)))
end)))
in (

let uu____14068 = (FStar_List.fold_left (fun uu____14094 lb -> (match (uu____14094) with
| (lbs1, env1) -> begin
(

let uu____14114 = (FStar_TypeChecker_Util.extract_let_rec_annotation env1 lb)
in (match (uu____14114) with
...
let uu____14142 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____14142))
in (tc_check_tot_or_gtot_term (

let uu___153_14153 = env0
in {FStar_TypeChecker_Env.solver = uu___153_14153.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___153_14153.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___153_14153.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___153_14153.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___153_14153.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___153_14153.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___153_14153.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___153_14153.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___153_14153.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___153_14153.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___153_14153.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___153_14153.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___153_14153.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___153_14153.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = true; FStar_TypeChecker_Env.use_eq = uu___153_14153.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___153_14153.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___153_14153.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___153_14153.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___153_14153.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___153_14153.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___153_14153.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___153_14153.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___153_14153.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___153_14153.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___153_14153.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___153_14153.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___153_14153.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___153_14153.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___153_14153.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___153_14153.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___153_14153.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___153_14153.FStar_TypeChecker_Env.dsenv}) t uu____14141))
in (match (uu____14134) with
| (t1, uu____14155, g) -> begin
(

let g1 = (FStar_TypeChecker_Rel.resolve_implicits g)
in ((

let uu____14159 = (FStar_TypeChecker_Rel.discharge_guard env2 g1)
in (FStar_All.pipe_left FStar_Pervasives.ignore uu____14159));
(norm env0 t1);
))
end))
end)
...
let uu____14161 = ((termination_check_enabled lb.FStar_Syntax_Syntax.lbname e t1) && (FStar_TypeChecker_Env.should_verify env2))
in (match (uu____14161) with
| true -> begin
(

let uu___154_14162 = env2
in {FStar_TypeChecker_Env.solver = uu___154_14162.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___154_14162.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___154_14162.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___154_14162.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___154_14162.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___154_14162.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___154_14162.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___154_14162.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___154_14162.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___154_14162.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___154_14162.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___154_14162.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = (((lb.FStar_Syntax_Syntax.lbname), (t1)))::env2.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___154_14162.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___154_14162.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___154_14162.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___154_14162.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___154_14162.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___154_14162.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___154_14162.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___154_14162.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___154_14162.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___154_14162.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___154_14162.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___154_14162.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___154_14162.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___154_14162.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___154_14162.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___154_14162.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___154_14162.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___154_14162.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___154_14162.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___154_14162.FStar_TypeChecker_Env.dsenv})
end
| uu____14175 -> begin
...
let uu___155_14179 = lb
in {FStar_Syntax_Syntax.lbname = uu___155_14179.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = univ_vars1; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = uu___155_14179.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = e})
in (((lb1)::lbs1), (env3)))))))
end))
end)) (([]), (env)) lbs)
...
let uu____14211 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> ((

let uu____14240 = (

let uu____14241 = (FStar_Syntax_Subst.compress lb.FStar_Syntax_Syntax.lbdef)
in uu____14241.FStar_Syntax_Syntax.n)
in (match (uu____14240) with
| FStar_Syntax_Syntax.Tm_abs (uu____14244) -> begin
()
end
| uu____14261 -> begin
(
...
let uu____14268 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (("Only function literals may be defined recursively"), (uu____14268)))
in FStar_Errors.Error (uu____14263))
in (FStar_Exn.raise uu____14262))
end));
(

let uu____14269 = (

let uu____14276 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term uu____14276 lb.FStar_Syntax_Syntax.lbdef))
...
let uu____14286 = (FStar_Syntax_Util.is_total_lcomp c)
in (not (uu____14286)))
in (match (uu____14285) with
| true -> begin
...
in (FStar_All.pipe_right uu____14211 FStar_List.unzip))
in (match (uu____14202) with
| (lbs1, gs) -> begin
(
...
let uu____14335 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____14335) with
| (env1, uu____14353) -> begin
(

let e1 = lb.FStar_Syntax_Syntax.lbdef
in (

let uu____14361 = (check_lbtyp top_level env lb)
...
let uu____14405 = (tc_maybe_toplevel_term (

let uu___156_14414 = env11
in {FStar_TypeChecker_Env.solver = uu___156_14414.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___156_14414.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___156_14414.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___156_14414.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___156_14414.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___156_14414.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___156_14414.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___156_14414.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___156_14414.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___156_14414.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___156_14414.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___156_14414.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___156_14414.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = top_level; FStar_TypeChecker_Env.check_uvars = uu___156_14414.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___156_14414.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___156_14414.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___156_14414.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___156_14414.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___156_14414.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___156_14414.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___156_14414.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___156_14414.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___156_14414.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___156_14414.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___156_14414.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___156_14414.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___156_14414.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___156_14414.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___156_14414.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___156_14414.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___156_14414.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___156_14414.FStar_TypeChecker_Env.dsenv}) e11)
...
let uu____14433 = (FStar_TypeChecker_Env.set_range env11 e12.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (FStar_Pervasives_Native.Some ((fun uu____14437 -> (FStar_Util.return_all FStar_TypeChecker_Err.ill_kinded_type)))) uu____14433 e12 c1 wf_annot))
...
let uu____14452 = (FStar_TypeChecker_Env.debug env FStar_Options.Extreme)
in (match (uu____14452) with
| true -> begin
(

let uu____14453 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (

let uu____14454 = (FStar_Syntax_Print.term_to_string c11.FStar_Syntax_Syntax.res_typ)
in (

let uu____14455 = (FStar_TypeChecker_Rel.guard_to_string env g11)
in (FStar_Util.print3 "checked top-level def %s, result type is %s, guard is %s\n" uu____14453 uu____14454 uu____14455))))
end
| uu____14456 -> begin
()
end));
...
let uu____14500 = (FStar_Syntax_Subst.univ_var_opening lb.FStar_Syntax_Syntax.lbunivs)
...
let uu____14549 = (FStar_TypeChecker_Env.set_expected_typ env1 t1)
in ((FStar_Pervasives_Native.Some (t1)), (FStar_TypeChecker_Rel.trivial_guard), (univ_vars1), (univ_opening), (uu____14549)))
end
| uu____14556 -> begin
(

let uu____14557 = (FStar_Syntax_Util.type_u ())
in (match (uu____14557) with
| (k, uu____14577) -> begin
(

let uu____14578 = (tc_check_tot_or_gtot_term env1 t1 k)
in (match (uu____14578) with
| (t2, uu____14600, g) -> begin
((

let uu____14603 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
...
let uu____14605 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (FStar_Range.string_of_range uu____14605))
in (

let uu____14606 = (FStar_Syntax_Print.term_to_string t2)
in (FStar_Util.print2 "(%s) Checked type annotation %s\n" uu____14604 uu____14606)))
end
| uu____14607 -> begin
()
end));
...
let uu____14609 = (FStar_TypeChecker_Env.set_expected_typ env1 t3)
in ((FStar_Pervasives_Native.Some (t3)), (g), (univ_vars1), (univ_opening), (uu____14609))));
)
end))
end))
end)))
...
and tc_binder : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual)  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual) * FStar_TypeChecker_Env.env * FStar_TypeChecker_Env.guard_t * FStar_Syntax_Syntax.universe) = (fun env uu____14617 -> (match (uu____14617) with
| (x, imp) -> begin
(

let uu____14636 = (FStar_Syntax_Util.type_u ())
in (match (uu____14636) with
| (tu, u) -> begin
((

let uu____14656 = (FStar_TypeChecker_Env.debug env FStar_Options.Extreme)
in (match (uu____14656) with
| true -> begin
(

let uu____14657 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____14658 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____14659 = (FStar_Syntax_Print.term_to_string tu)
in (FStar_Util.print3 "Checking binders %s:%s at type %s\n" uu____14657 uu____14658 uu____14659))))
end
| uu____14660 -> begin
()
end));
...
let uu____14661 = (tc_check_tot_or_gtot_term env x.FStar_Syntax_Syntax.sort tu)
in (match (uu____14661) with
| (t, uu____14681, g) -> begin
(

let x1 = (((

let uu___157_14689 = x
in {FStar_Syntax_Syntax.ppname = uu___157_14689.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___157_14689.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (imp))
in ((

let uu____14691 = (FStar_TypeChecker_Env.debug env FStar_Options.High)
in (match (uu____14691) with
| true -> begin
(

let uu____14692 = (FStar_Syntax_Print.bv_to_string (FStar_Pervasives_Native.fst x1))
in (

let uu____14693 = (FStar_Syntax_Print.term_to_string t)
...
let uu____14695 = (push_binding env x1)
in ((x1), (uu____14695), (g), (u)));
))
end));
)
end))
...
let uu____14785 = (tc_binder env1 b)
in (match (uu____14785) with
| (b1, env', g, u) -> begin
(

let uu____14826 = (aux env' bs2)
...
let uu____14880 = (FStar_TypeChecker_Rel.close_guard_univs ((u)::[]) ((b1)::[]) g')
in (FStar_TypeChecker_Rel.conj_guard g uu____14880))
in (((b1)::bs3), (env'1), (uu____14879), ((u)::us)))
end))
end))
end))
in (aux env bs)))
...
let tc_args = (fun env1 args -> (FStar_List.fold_right (fun uu____14965 uu____14966 -> (match (((uu____14965), (uu____14966))) with
| ((t, imp), (args1, g)) -> begin
(

let uu____15035 = (tc_term env1 t)
in (match (uu____15035) with
| (t1, uu____15053, g') -> begin
(

let uu____15055 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((((t1), (imp)))::args1), (uu____15055)))
end))
end)) args (([]), (FStar_TypeChecker_Rel.trivial_guard))))
in (FStar_List.fold_right (fun p uu____15097 -> (match (uu____15097) with
| (pats1, g) -> begin
(

let uu____15122 = (tc_args env p)
in (match (uu____15122) with
| (args, g') -> begin
(

let uu____15135 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((args)::pats1), (uu____15135)))
end))
end)) pats (([]), (FStar_TypeChecker_Rel.trivial_guard)))))
and tc_tot_or_gtot_term : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.lcomp * FStar_TypeChecker_Env.guard_t) = (fun env e -> (

let uu____15148 = (tc_maybe_toplevel_term env e)
in (match (uu____15148) with
| (e1, c, g) -> begin
(

let uu____15164 = (FStar_Syntax_Util.is_tot_or_gtot_lcomp c)
...
let uu____15182 = (FStar_TypeChecker_Util.is_pure_effect env (FStar_Syntax_Util.comp_effect_name c2))
in (match (uu____15182) with
| true -> begin
(

let uu____15187 = (FStar_Syntax_Syntax.mk_Total (FStar_Syntax_Util.comp_result c2))
in ((uu____15187), (false)))
end
| uu____15188 -> begin
(

let uu____15189 = (FStar_Syntax_Syntax.mk_GTotal (FStar_Syntax_Util.comp_result c2))
in ((uu____15189), (true)))
end))
...
let uu____15198 = (FStar_TypeChecker_Rel.sub_comp env c2 target_comp)
in (match (uu____15198) with
| FStar_Pervasives_Native.Some (g') -> begin
(

let uu____15208 = (FStar_TypeChecker_Rel.conj_guard g1 g')
in ((e1), ((FStar_Syntax_Util.lcomp_of_comp target_comp)), (uu____15208)))
end
| uu____15209 -> begin
...
let uu____15224 = (FStar_TypeChecker_Err.expected_ghost_expression e1 c2)
in ((uu____15224), (e1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____15219))
in (FStar_Exn.raise uu____15218))
end
| uu____15231 -> begin
(
...
let uu____15238 = (FStar_TypeChecker_Err.expected_pure_expression e1 c2)
in ((uu____15238), (e1.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____15233))
in (FStar_Exn.raise uu____15232))
end)
end))
end)))))
end))
...
let uu____15257 = (tc_tot_or_gtot_term env t)
...
let uu____15287 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck")))
in (match (uu____15287) with
| true -> begin
(

let uu____15288 = (FStar_Syntax_Print.term_to_string e)
...
let uu___158_15291 = env
in {FStar_TypeChecker_Env.solver = uu___158_15291.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___158_15291.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___158_15291.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___158_15291.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___158_15291.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___158_15291.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___158_15291.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___158_15291.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___158_15291.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___158_15291.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___158_15291.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___158_15291.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = []; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___158_15291.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___158_15291.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___158_15291.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___158_15291.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___158_15291.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___158_15291.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___158_15291.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___158_15291.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___158_15291.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___158_15291.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___158_15291.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___158_15291.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___158_15291.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___158_15291.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___158_15291.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___158_15291.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___158_15291.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___158_15291.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___158_15291.FStar_TypeChecker_Env.dsenv})
in (

let uu____15296 = (FStar_All.try_with (fun uu___160_15310 -> (match (()) with
| () -> begin
(tc_tot_or_gtot_term env1 e)
end)) (fun uu___159_15321 -> (match (uu___159_15321) with
| FStar_Errors.Error (msg, uu____15329) -> begin
(
...
let uu____15336 = (FStar_TypeChecker_Env.get_range env1)
in (((Prims.strcat "Implicit argument: " msg)), (uu____15336)))
in FStar_Errors.Error (uu____15331))
in (FStar_Exn.raise uu____15330))
end)))
in (match (uu____15296) with
| (t, c, g) -> begin
(

let uu____15352 = (FStar_Syntax_Util.is_total_lcomp c)
...
let uu____15369 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" uu____15369))
in (

let uu____15370 = (FStar_TypeChecker_Env.get_range env1)
in ((uu____15368), (uu____15370))))
in FStar_Errors.Error (uu____15363))
in (FStar_Exn.raise uu____15362))
end))
end)));
))


let level_of_type_fail : 'Auu____15385 . FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string  ->  'Auu____15385 = (fun env e t -> (
...
let uu____15405 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format2 "Expected a term of type \'Type\'; got %s : %s" uu____15405 t))
in (

let uu____15406 = (FStar_TypeChecker_Env.get_range env)
in ((uu____15404), (uu____15406))))
in FStar_Errors.Error (uu____15399))
in (FStar_Exn.raise uu____15398)))
...
let uu____15427 = (FStar_Syntax_Util.unrefine t1)
in uu____15427.FStar_Syntax_Syntax.n)
in (match (uu____15426) with
| FStar_Syntax_Syntax.Tm_type (u) -> begin
u
end
| uu____15431 -> begin
...
let uu____15434 = (FStar_Syntax_Util.type_u ())
...
let uu___161_15442 = env
in {FStar_TypeChecker_Env.solver = uu___161_15442.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___161_15442.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___161_15442.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___161_15442.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___161_15442.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___161_15442.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___161_15442.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___161_15442.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___161_15442.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___161_15442.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___161_15442.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___161_15442.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___161_15442.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___161_15442.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___161_15442.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___161_15442.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___161_15442.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___161_15442.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___161_15442.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___161_15442.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___161_15442.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___161_15442.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___161_15442.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___161_15442.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___161_15442.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___161_15442.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___161_15442.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___161_15442.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___161_15442.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___161_15442.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___161_15442.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___161_15442.FStar_TypeChecker_Env.dsenv})
in (
...
let uu____15446 = (FStar_Syntax_Print.term_to_string t1)
in (level_of_type_fail env1 e uu____15446))
end
| uu____15447 -> begin
(FStar_TypeChecker_Rel.force_trivial_guard env1 g)
end);
...
let uu____15459 = (FStar_Syntax_Subst.compress e)
in uu____15459.FStar_Syntax_Syntax.n)
in (match (uu____15458) with
| FStar_Syntax_Syntax.Tm_bvar (uu____15464) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_delayed (uu____15469) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_let (uu____15496) -> begin
(

let e1 = (FStar_TypeChecker_Normalize.normalize [] env e)
in (universe_of_aux env e1))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t, uu____15512) -> begin
(level_of_type_fail env e "arrow type")
end
| FStar_Syntax_Syntax.Tm_uvar (uu____15535, t) -> begin
t
end
| FStar_Syntax_Syntax.Tm_meta (t, uu____15562) -> begin
...
let uu____15569 = (FStar_TypeChecker_Env.lookup_lid env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (uu____15569) with
| ((uu____15580, t), uu____15582) -> begin
t
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____15587, (FStar_Util.Inl (t), uu____15589), uu____15590) -> begin
t
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____15637, (FStar_Util.Inr (c), uu____15639), uu____15640) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____15690; FStar_Syntax_Syntax.vars = uu____15691}, us) -> begin
(

let uu____15697 = (FStar_TypeChecker_Env.lookup_lid env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (uu____15697) with
| ((us', t), uu____15710) -> begin
...
let uu____15722 = (FStar_TypeChecker_Env.get_range env)
in (("Unexpected number of universe instantiations"), (uu____15722)))
in FStar_Errors.Error (uu____15717))
in (FStar_Exn.raise uu____15716))
end
| uu____15723 -> begin
(FStar_List.iter2 (fun u' u -> (match (u') with
| FStar_Syntax_Syntax.U_unif (u'') -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (uu____15739) -> begin
(failwith "Impossible: Tm_uinst\'s head must be an fvar")
end
| FStar_Syntax_Syntax.Tm_refine (x, uu____15749) -> begin
(universe_of_aux env x.FStar_Syntax_Syntax.sort)
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let uu____15772 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____15772) with
| (bs1, c1) -> begin
(

let us = (FStar_List.map (fun uu____15792 -> (match (uu____15792) with
| (b, uu____15798) -> begin
(

let uu____15799 = (universe_of_aux env b.FStar_Syntax_Syntax.sort)
in (level_of_type env b.FStar_Syntax_Syntax.sort uu____15799))
end)) bs1)
in (
...
let uu____15804 = (universe_of_aux env res)
in (level_of_type env res uu____15804)))
in (

let u_c = (

let uu____15806 = (FStar_TypeChecker_Env.effect_repr env c1 u_res)
...
let uu____15810 = (universe_of_aux env trepr)
in (level_of_type env trepr uu____15810))
end))
in (
...
| FStar_Syntax_Syntax.Tm_bvar (uu____15903) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_delayed (uu____15918) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (uu____15957) -> begin
(

let uu____15958 = (universe_of_aux env hd3)
in ((uu____15958), (args1)))
end
| FStar_Syntax_Syntax.Tm_name (uu____15971) -> begin
(

let uu____15972 = (universe_of_aux env hd3)
in ((uu____15972), (args1)))
end
| FStar_Syntax_Syntax.Tm_uvar (uu____15985) -> begin
(

let uu____16002 = (universe_of_aux env hd3)
in ((uu____16002), (args1)))
end
| FStar_Syntax_Syntax.Tm_uinst (uu____16015) -> begin
(

let uu____16022 = (universe_of_aux env hd3)
in ((uu____16022), (args1)))
end
| FStar_Syntax_Syntax.Tm_ascribed (uu____16035) -> begin
(

let uu____16062 = (universe_of_aux env hd3)
in ((uu____16062), (args1)))
end
| FStar_Syntax_Syntax.Tm_refine (uu____16075) -> begin
(

let uu____16082 = (universe_of_aux env hd3)
in ((uu____16082), (args1)))
end
| FStar_Syntax_Syntax.Tm_constant (uu____16095) -> begin
(

let uu____16096 = (universe_of_aux env hd3)
in ((uu____16096), (args1)))
end
| FStar_Syntax_Syntax.Tm_arrow (uu____16109) -> begin
(

let uu____16122 = (universe_of_aux env hd3)
in ((uu____16122), (args1)))
end
| FStar_Syntax_Syntax.Tm_meta (uu____16135) -> begin
(

let uu____16142 = (universe_of_aux env hd3)
in ((uu____16142), (args1)))
end
| FStar_Syntax_Syntax.Tm_type (uu____16155) -> begin
(

let uu____16156 = (universe_of_aux env hd3)
in ((uu____16156), (args1)))
end
| FStar_Syntax_Syntax.Tm_match (uu____16169, (hd4)::uu____16171) -> begin
(

let uu____16236 = (FStar_Syntax_Subst.open_branch hd4)
in (match (uu____16236) with
| (uu____16251, uu____16252, hd5) -> begin
(

let uu____16270 = (FStar_Syntax_Util.head_and_args hd5)
in (match (uu____16270) with
| (hd6, args2) -> begin
(type_of_head retry hd6 args2)
end))
end))
end
| uu____16321 when retry -> begin
(
...
let uu____16323 = (FStar_Syntax_Util.head_and_args e1)
...
let uu____16375 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____16375) with
| (env1, uu____16397) -> begin
(

let env2 = (

let uu___162_16403 = env1
in {FStar_TypeChecker_Env.solver = uu___162_16403.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___162_16403.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___162_16403.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___162_16403.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___162_16403.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___162_16403.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___162_16403.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___162_16403.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___162_16403.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___162_16403.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___162_16403.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___162_16403.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___162_16403.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = uu___162_16403.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___162_16403.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___162_16403.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___162_16403.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___162_16403.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___162_16403.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___162_16403.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___162_16403.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___162_16403.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___162_16403.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___162_16403.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___162_16403.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___162_16403.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___162_16403.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___162_16403.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___162_16403.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___162_16403.FStar_TypeChecker_Env.dsenv})
in ((

let uu____16405 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("UniverseOf")))
in (match (uu____16405) with
| true -> begin
(

let uu____16406 = (

let uu____16407 = (FStar_TypeChecker_Env.get_range env2)
in (FStar_Range.string_of_range uu____16407))
in (

let uu____16408 = (FStar_Syntax_Print.term_to_string hd3)
...
let uu____16410 = (tc_term env2 hd3)
in (match (uu____16410) with
| (uu____16431, {FStar_Syntax_Syntax.eff_name = uu____16432; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu____16434; FStar_Syntax_Syntax.comp = uu____16435}, g) -> begin
((

let uu____16446 = (FStar_TypeChecker_Rel.solve_deferred_constraints env2 g)
in (FStar_All.pipe_right uu____16446 FStar_Pervasives.ignore));
((t), (args1));
)
end));
))
...
let uu____16457 = (type_of_head true hd1 args)
...
let uu____16497 = (FStar_Syntax_Util.arrow_formals_comp t1)
...
let uu____16541 = (FStar_Syntax_Print.term_to_string res1)
in (level_of_type_fail env e uu____16541))
end))
end)))
end)))
end
| FStar_Syntax_Syntax.Tm_match (uu____16544, (hd1)::uu____16546) -> begin
(

let uu____16611 = (FStar_Syntax_Subst.open_branch hd1)
in (match (uu____16611) with
| (uu____16614, uu____16615, hd2) -> begin
(universe_of_aux env hd2)
end))
end
| FStar_Syntax_Syntax.Tm_match (uu____16633, []) -> begin
...
let uu____16678 = (universe_of_aux env e)
in (level_of_type env e uu____16678)))
...
let uu____16699 = (tc_binders env tps)
in (match (uu____16699) with
