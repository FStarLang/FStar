                         ...
                         (FStar_TypeChecker_Rel.force_trivial_guard env g2;
                          (let t =
                           ...
                           (let uu____9345 =
                              ...
                              FStar_All.pipe_left
                                FStar_Syntax_Util.lcomp_of_comp uu____9346
                               in
                            (t, uu____9345,
                              FStar_TypeChecker_Env.trivial_guard)))))))
    ...
    fun tau  ->
      let env1 =
        let uu___1213_9350 = env  in
        {
          ...
          FStar_TypeChecker_Env.try_solve_implicits_hook =
            (uu___1213_9350.FStar_TypeChecker_Env.try_solve_implicits_hook);
          FStar_TypeChecker_Env.splice =
                       ...
                       then FStar_Util.Inl t1
                         ...
                         (let uu____9748 =
                            let uu____9749 = FStar_Syntax_Syntax.mk_Total t1
                               in
                            FStar_All.pipe_left
                              FStar_Syntax_Util.lcomp_of_comp uu____9749
                             in
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___1762_12815 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.try_solve_implicits_hook
                                   =
                                   (uu___1762_12815.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                 FStar_TypeChecker_Env.splice =
                            ...
                            (let uu___1853_13531 = envbody1  in
                             {
                               ...
                               FStar_TypeChecker_Env.try_solve_implicits_hook
                                 =
                                 (uu___1853_13531.FStar_TypeChecker_Env.try_solve_implicits_hook);
                               FStar_TypeChecker_Env.splice =
                                  ...
                                  (let uu___1861_13573 = envbody1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___1861_13573.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                          ...
                          let cres1 =
                            let uu___1925_13920 = cres  in
                            {
                              FStar_Syntax_Syntax.eff_name =
                                (uu___1925_13920.FStar_Syntax_Syntax.eff_name);
                              FStar_Syntax_Syntax.res_typ = rt;
                              FStar_Syntax_Syntax.cflags =
                                (uu___1925_13920.FStar_Syntax_Syntax.cflags);
                              FStar_Syntax_Syntax.comp_thunk =
                                (uu___1925_13920.FStar_Syntax_Syntax.comp_thunk)
                            }  in
                          let uu____13921 =
                            match bs with
                            | [] ->
                             ...
                             | (targ1,g_ex) ->
                                 ...
                                 let env2 =
                                   let uu___2144_15970 = env1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___2144_15970.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
        ...
        (let uu____20475 =
           let uu____20486 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.try_solve_implicits_hook =
                 (uu___2612_20487.FStar_TypeChecker_Env.try_solve_implicits_hook);
               FStar_TypeChecker_Env.splice =
                 ...
                 then
                   ...
                   (let g11 =
                    ...
                    | (uu____22223,univs1,e11,c11,gvs) ->
                        ...
                        let uu____22237 = FStar_Syntax_Util.lcomp_of_comp c11
                           in
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___2935_22892 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___2935_22892.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
                          ...
                          let x_eq_e1 =
                            let uu____23094 =
                              ...
                              FStar_Syntax_Util.mk_eq2 uu____23095
                                c1.FStar_Syntax_Syntax.res_typ uu____23096
                                e11
                               in
                            FStar_All.pipe_left
                              (fun _23097  ->
                                  ...
                                  (let uu____23162 =
                                   ...
                                   (e4,
                                     (let uu___2983_23164 = cres  in
                                      {
                                        FStar_Syntax_Syntax.eff_name =
                                          (uu___2983_23164.FStar_Syntax_Syntax.eff_name);
                                        FStar_Syntax_Syntax.res_typ = t;
                                        FStar_Syntax_Syntax.cflags =
                                          (uu___2983_23164.FStar_Syntax_Syntax.cflags);
                                        FStar_Syntax_Syntax.comp_thunk =
                                          (uu___2983_23164.FStar_Syntax_Syntax.comp_thunk)
                                      }), uu____23162))))))))
      | uu____23165 ->
                              ...
                              let cres =
                                let uu____23460 =
                                  FStar_Syntax_Syntax.mk_Total
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____23460
                                 in
                              let uu____23461 =
                                   ...
                                   (match uu____23709 with
                                    | (e22,cres,g2) ->
                                        ...
                                        let cres5 =
                                          ...
                                          {
                                            FStar_Syntax_Syntax.eff_name =
                                              (uu___3082_23744.FStar_Syntax_Syntax.eff_name);
                                            FStar_Syntax_Syntax.res_typ =
                                              tres;
                                            FStar_Syntax_Syntax.cflags =
                                              (uu___3082_23744.FStar_Syntax_Syntax.cflags);
                                            FStar_Syntax_Syntax.comp_thunk =
                                              (uu___3082_23744.FStar_Syntax_Syntax.comp_thunk)
                                          }  in
                                        let guard1 =
                                          let bs =
                                            FStar_All.pipe_right lbs4
                                                   ...
                                                   | (tres1,g_ex) ->
                                                       let cres6 =
                                                           ...
                                                           = cres5  in
                                                         {
                                                           FStar_Syntax_Syntax.eff_name
                                                             =
                                                             (uu___3098_23809.FStar_Syntax_Syntax.eff_name);
                                                           FStar_Syntax_Syntax.res_typ
                                                             = tres1;
                                                           FStar_Syntax_Syntax.cflags
                                                             =
                                                             (uu___3098_23809.FStar_Syntax_Syntax.cflags);
                                                           FStar_Syntax_Syntax.comp_thunk
                                                             =
                                                             (uu___3098_23809.FStar_Syntax_Syntax.comp_thunk)
                                                         }  in
                                                       let uu____23810 =
                                                         FStar_TypeChecker_Env.conj_guard
                                                           g_ex guard1
                                   ...
                                   (let uu___3144_24138 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___3144_24138.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3154_24175 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___3154_24175.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                       ...
                       (let uu___3205_24453 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.try_solve_implicits_hook =
                            (uu___3205_24453.FStar_TypeChecker_Env.try_solve_implicits_hook);
                          FStar_TypeChecker_Env.splice =
...
and (tc_tot_or_gtot_term :
  ...
  fun env  ->
    fun e  ->
      ...
      | (e1,c,g) ->
          let uu____25455 = FStar_Syntax_Util.is_tot_or_gtot_lcomp c  in
          if uu____25455
          then (e1, c, g)
          else
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3349_25605 = env  in
         {
           ...
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___3349_25605.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
       ...
       | (t,c,g) ->
           let c1 = FStar_TypeChecker_Normalize.ghost_to_pure_lcomp env1 c
              in
           let uu____25669 = FStar_Syntax_Util.is_total_lcomp c1  in
           if uu____25669
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3385_25791 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3385_25791.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                 ...
                 | (env1,uu____26761) ->
                     let env2 =
                       let uu___3546_26767 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3546_26767.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3825_28783 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3825_28783.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3856_28887 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3856_28887.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
