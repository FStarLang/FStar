...
(let _156_420 = (let _156_419 = (let _156_418 = (FStar_Util.format1 "Universe variable \'%s\' not found" x.FStar_Ident.idText)
in (let _156_417 = (FStar_TypeChecker_Env.get_range env)
in ((_156_418), (_156_417))))
in FStar_Syntax_Syntax.Error (_156_419))
in (Prims.raise _156_420))
end
end)))
in (match (u) with
| FStar_Syntax_Syntax.U_unknown -> begin
(let _156_421 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _156_421 Prims.snd))
end
| _59_1143 -> begin
(aux u)
end)))
...
let fail = (fun msg t -> (let _156_430 = (let _156_429 = (let _156_428 = (FStar_TypeChecker_Errors.expected_a_term_of_type_t_got_a_function env msg t top)
in ((_156_428), (top.FStar_Syntax_Syntax.pos)))
in FStar_Syntax_Syntax.Error (_156_429))
in (Prims.raise _156_430)))
in (
...
(let _156_447 = (let _156_446 = (let _156_445 = (let _156_443 = (FStar_Syntax_Print.bv_to_string hd)
in (FStar_Util.format1 "Inconsistent implicit argument annotation on argument %s" _156_443))
in (let _156_444 = (FStar_Syntax_Syntax.range_of_bv hd)
in ((_156_445), (_156_444))))
in FStar_Syntax_Syntax.Error (_156_446))
in (Prims.raise _156_447))
end
| _59_1191 -> begin
()
end)
...
let _59_1209 = (match ((let _156_448 = (FStar_Syntax_Util.unmeta hd.FStar_Syntax_Syntax.sort)
in _156_448.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
((expected_t), (g))
end
| _59_1197 -> begin
...
(let _156_449 = (FStar_Syntax_Print.bv_to_string hd)
...
let g2 = (let _156_451 = (FStar_TypeChecker_Env.get_range env)
in (let _156_450 = (FStar_TypeChecker_Rel.teq env t expected_t)
in (FStar_TypeChecker_Util.label_guard _156_451 "Type annotation on parameter incompatible with the expected type" _156_450)))
in (

let g = (let _156_452 = (FStar_TypeChecker_Rel.conj_guard g1 g2)
in (FStar_TypeChecker_Rel.conj_guard g _156_452))
in ((t), (g))))
end)))
end)
...
let subst = (let _156_453 = (FStar_Syntax_Syntax.bv_to_name hd)
in (maybe_extend_subst subst b_expected _156_453))
...
let _59_1256 = (match ((let _156_460 = (FStar_Syntax_Subst.compress body)
in _156_460.FStar_Syntax_Syntax.n)) with
...
| (c, _59_1248, g') -> begin
(let _156_461 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((Some (c)), (body), (_156_461)))
end))
end
| _59_1252 -> begin
((None), (body), (g))
...
let rec as_function_typ = (fun norm t -> (match ((let _156_466 = (FStar_Syntax_Subst.compress t)
in _156_466.FStar_Syntax_Syntax.n)) with
...
(match (more) with
| None -> begin
(let _156_477 = (FStar_Syntax_Subst.subst_comp subst c_expected)
in ((env), (bs), (guard), (_156_477)))
end
| Some (FStar_Util.Inr (more_bs_expected)) -> begin
(

let c = (let _156_478 = (FStar_Syntax_Util.arrow more_bs_expected c_expected)
in (FStar_Syntax_Syntax.mk_Total _156_478))
in (let _156_479 = (FStar_Syntax_Subst.subst_comp subst c)
in ((env), (bs), (guard), (_156_479))))
end
...
| (env, bs', more, guard', subst) -> begin
(let _156_481 = (let _156_480 = (FStar_TypeChecker_Rel.conj_guard guard guard')
in ((env), ((FStar_List.append bs bs')), (more), (_156_480), (subst)))
in (handle_more _156_481 c_expected))
end))
end
| _59_1349 -> begin
(let _156_483 = (let _156_482 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "More arguments than annotated type (%s)" _156_482))
in (fail _156_483 t))
end))
end else begin
...
in (let _156_484 = (check_binders env bs bs_expected)
in (handle_more _156_484 c_expected))))
in (
...
let _59_1369 = (let _156_494 = (let _156_493 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (FStar_All.pipe_right _156_493 Prims.fst))
in (tc_term _156_494 t))
...
(let _156_495 = (FStar_Syntax_Syntax.mk_binder (
...
(let _156_496 = (unfold_whnf env t)
in (as_function_typ true _156_496))
end else begin
(
...
in (FStar_Util.print2 "!!!!!!!!!!!!!!!Expected type is %s, top_level=%s\n" _156_497 (if env.FStar_TypeChecker_Env.top_level then begin
"true"
end else begin
"false"
end)))
...
(let _156_500 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length guard_body.FStar_TypeChecker_Env.implicits))
in (let _156_499 = (let _156_498 = (cbody.FStar_Syntax_Syntax.comp ())
in (FStar_All.pipe_left FStar_Syntax_Print.comp_to_string _156_498))
...
(let _156_503 = (FStar_TypeChecker_Rel.conj_guard g guard)
in (FStar_TypeChecker_Rel.discharge_guard envbody _156_503))
end else begin
(

let guard = (let _156_504 = (FStar_TypeChecker_Rel.conj_guard g guard)
in (FStar_TypeChecker_Rel.close_guard (FStar_List.append bs letrec_binders) _156_504))
in guard)
end
in (
...
let e = (let _156_507 = (let _156_506 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp cbody) (fun _156_505 -> FStar_Util.Inl (_156_505)))
in Some (_156_506))
in (FStar_Syntax_Util.abs bs body _156_507))
in (
...
(let _156_508 = (FStar_TypeChecker_Rel.teq env t tfun_computed)
in ((e), (_156_508)))
end else begin
...
| (e, guard') -> begin
(let _156_509 = (FStar_TypeChecker_Rel.conj_guard guard guard')
in ((e), (t), (_156_509)))
end))
end))
end
...
(let _156_518 = (FStar_Range.string_of_range head.FStar_Syntax_Syntax.pos)
in (let _156_517 = (FStar_Syntax_Print.term_to_string thead)
...
(let _156_534 = (FStar_Syntax_Syntax.mk_Tm_app head (FStar_List.rev arg_rets) (Some (cres.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (FStar_TypeChecker_Util.maybe_assume_result_eq_pure_term env _156_534 cres))
end else begin
(

let _59_1505 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _156_537 = (FStar_Syntax_Print.term_to_string head)
in (let _156_536 = (FStar_Syntax_Print.lcomp_to_string cres)
in (let _156_535 = (FStar_TypeChecker_Rel.guard_to_string env g)
in (FStar_Util.print3 "Not refining result: f=%s; cres=%s; guard=%s\n" _156_537 _156_536 _156_535))))
end else begin
()
end
in cres)
...
let g = (let _156_538 = (FStar_TypeChecker_Rel.conj_guard ghead guard)
in (FStar_All.pipe_right _156_538 (FStar_TypeChecker_Rel.solve_deferred_constraints env)))
in (let _156_543 = (let _156_542 = (let _156_541 = (let _156_540 = (let _156_539 = (cres.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Util.arrow bs _156_539))
in (FStar_All.pipe_left (FStar_Syntax_Subst.subst subst) _156_540))
in (FStar_Syntax_Syntax.mk_Total _156_541))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _156_542))
in ((_156_543), (g))))
end)
...
(let _156_544 = (FStar_Syntax_Print.lcomp_to_string cres)
...
(let _156_549 = (let _156_548 = (let _156_547 = (FStar_TypeChecker_Util.maybe_lift env e eff_name out_c.FStar_Syntax_Syntax.eff_name)
in ((_156_547), (q)))
in (_156_548)::args)
in ((_156_549), (out_c), (monadic)))
end
...
let arg = (let _156_559 = (FStar_Syntax_Syntax.as_implicit true)
in ((varg), (_156_559)))
in (let _156_561 = (let _156_560 = (FStar_TypeChecker_Rel.conj_guard implicits g)
in ((subst), ((((arg), (None), (FStar_Util.Inl (FStar_Syntax_Const.effect_Tot_lid))))::outargs), ((arg)::arg_rets), (_156_560), (fvs)))
in (tc_args head_info _156_561 rest args))))
end))))
end
...
(let _156_562 = (FStar_Syntax_Print.term_to_string targ)
...
(let _156_565 = (FStar_Syntax_Print.tag_of_term e)
in (let _156_564 = (FStar_Syntax_Print.term_to_string e)
in (let _156_563 = (FStar_Syntax_Print.term_to_string targ)
in (FStar_Util.print3 "Checking arg (%s) %s at type %s\n" _156_565 _156_564 _156_563))))
end else begin
()
end
in (
...
let subst = (let _156_566 = (FStar_List.hd bs)
in (maybe_extend_subst subst _156_566 e))
...
let subst = (let _156_567 = (FStar_List.hd bs)
in (maybe_extend_subst subst _156_567 e))
in (tc_args head_info ((subst), ((((arg), (Some (x)), (FStar_Util.Inr (c))))::outargs), ((arg)::arg_rets), (g), (fvs)) rest rest'))
end else begin
if (let _156_568 = (FStar_List.hd bs)
in (FStar_Syntax_Syntax.is_null_binder _156_568)) then begin
(

let newx = (FStar_Syntax_Syntax.new_bv (Some (e.FStar_Syntax_Syntax.pos)) c.FStar_Syntax_Syntax.res_typ)
in (

let arg' = (let _156_569 = (FStar_Syntax_Syntax.bv_to_name newx)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _156_569))
in (tc_args head_info ((subst), ((((arg), (Some (newx)), (FStar_Util.Inr (c))))::outargs), ((arg')::arg_rets), (g), (fvs)) rest rest')))
end else begin
(let _156_573 = (let _156_572 = (let _156_571 = (let _156_570 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Syntax.as_arg _156_570))
in (_156_571)::arg_rets)
in ((subst), ((((arg), (Some (x)), (FStar_Util.Inr (c))))::outargs), (_156_572), (g), ((x)::fvs)))
in (tc_args head_info _156_573 rest rest'))
end
end
end))
end))))))))))
...
let tres = (let _156_578 = (FStar_Syntax_Subst.compress tres)
in (FStar_All.pipe_right _156_578 FStar_Syntax_Util.unrefine))
...
(let _156_579 = (FStar_Range.string_of_range tres.FStar_Syntax_Syntax.pos)
...
(let _156_580 = (unfold_whnf env tres)
in (aux true _156_580))
end
| _59_1664 -> begin
(let _156_586 = (let _156_585 = (let _156_584 = (let _156_582 = (FStar_TypeChecker_Normalize.term_to_string env thead)
in (let _156_581 = (FStar_Util.string_of_int n_args)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s arguments" _156_582 _156_581)))
in (let _156_583 = (FStar_Syntax_Syntax.argpos arg)
in ((_156_584), (_156_583))))
in FStar_Syntax_Syntax.Error (_156_585))
in (Prims.raise _156_586))
end)))
...
let rec check_function_app = (fun norm tf -> (match ((let _156_591 = (FStar_Syntax_Util.unrefine tf)
in _156_591.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_uvar (_)) | (FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (_); FStar_Syntax_Syntax.tk = _; FStar_Syntax_Syntax.pos = _; FStar_Syntax_Syntax.vars = _}, _)) -> begin
(
...
(let _156_596 = (FStar_TypeChecker_Rel.conj_guard g_e g_rest)
in (((((e), (imp)))::args), ((((e.FStar_Syntax_Syntax.pos), (c)))::comps), (_156_596)))
end))
end))
end))
in (
...
let bs = (let _156_598 = (FStar_All.pipe_right comps (FStar_List.map (fun _59_1709 -> (match (_59_1709) with
| (_59_1707, c) -> begin
((c.FStar_Syntax_Syntax.res_typ), (None))
end))))
in (FStar_Syntax_Util.null_binders_of_tks _156_598))
in (
...
| Some (t) -> begin
(match ((let _156_613 = (FStar_Syntax_Subst.compress t)
in _156_613.FStar_Syntax_Syntax.n)) with
...
let cres = (let _156_618 = (let _156_617 = (let _156_616 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _156_616 Prims.fst))
in (FStar_TypeChecker_Util.new_uvar env _156_617))
in (ml_or_tot _156_618 r))
in (
...
(let _156_621 = (FStar_Syntax_Print.term_to_string head)
in (let _156_620 = (FStar_Syntax_Print.term_to_string tf)
in (let _156_619 = (FStar_Syntax_Print.term_to_string bs_cres)
in (FStar_Util.print3 "Forcing the type of %s from %s to %s\n" _156_621 _156_620 _156_619))))
end else begin
()
end
in (

let _59_1732 = (let _156_622 = (FStar_TypeChecker_Rel.teq env tf bs_cres)
in (FStar_All.pipe_left (FStar_TypeChecker_Rel.force_trivial_guard env) _156_622))
in (

let comp = (let _156_625 = (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun _59_1736 out -> (match (_59_1736) with
| (r1, c) -> begin
(FStar_TypeChecker_Util.bind r1 env None c ((None), (out)))
end)) ((((head.FStar_Syntax_Syntax.pos), (chead)))::comps) _156_625))
in (let _156_627 = (FStar_Syntax_Syntax.mk_Tm_app head args (Some (comp.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (let _156_626 = (FStar_TypeChecker_Rel.conj_guard ghead g_args)
in ((_156_627), (comp), (_156_626))))))))))))
end)))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(
...
| _59_1748 -> begin
if (not (norm)) then begin
(let _156_628 = (unfold_whnf env tf)
in (check_function_app true _156_628))
end else begin
(let _156_631 = (let _156_630 = (let _156_629 = (FStar_TypeChecker_Errors.expected_function_typ env tf)
in ((_156_629), (head.FStar_Syntax_Syntax.pos)))
in FStar_Syntax_Syntax.Error (_156_630))
in (Prims.raise _156_631))
end
end))
in (let _156_633 = (let _156_632 = (FStar_Syntax_Util.unrefine thead)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.WHNF)::[]) env _156_632))
in (check_function_app false _156_633))))))))))
...
let g = (let _156_643 = (FStar_TypeChecker_Rel.guard_of_guard_formula short)
in (FStar_TypeChecker_Rel.imp_guard _156_643 g))
in (

let ghost = (ghost || ((not ((FStar_Syntax_Util.is_total_lcomp c))) && (not ((FStar_TypeChecker_Util.is_pure_effect env c.FStar_Syntax_Syntax.eff_name)))))
in (let _156_647 = (let _156_645 = (let _156_644 = (FStar_Syntax_Syntax.as_arg e)
in (_156_644)::[])
in (FStar_List.append seen _156_645))
in (let _156_646 = (FStar_TypeChecker_Rel.conj_guard guard g)
in ((_156_647), (_156_646), (ghost)))))))
end)))
...
(let _156_648 = (FStar_Syntax_Syntax.mk_GTotal res_t)
in (FStar_All.pipe_right _156_648 FStar_Syntax_Util.lcomp_of_comp))
end else begin
...
(let _156_660 = (FStar_Syntax_Print.pat_to_string p0)
in (let _156_659 = (FStar_Syntax_Print.pat_to_string p)
...
let _59_1858 = (let _156_683 = (FStar_All.pipe_right exps (FStar_List.map (fun e -> (

let _59_1824 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
(let _156_663 = (FStar_Syntax_Print.term_to_string e)
in (let _156_662 = (FStar_Syntax_Print.term_to_string pat_t)
...
(let _156_665 = (FStar_TypeChecker_Normalize.term_to_string env e)
in (let _156_664 = (FStar_TypeChecker_Normalize.term_to_string env lc.FStar_Syntax_Syntax.res_typ)
...
let _59_1836 = (let _156_666 = (FStar_TypeChecker_Rel.discharge_guard env (
...
in (FStar_All.pipe_right _156_666 FStar_TypeChecker_Rel.resolve_implicits))
in (

let e' = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env e)
in (

let uvars_to_string = (fun uvs -> (let _156_671 = (let _156_670 = (FStar_All.pipe_right uvs FStar_Util.set_elements)
in (FStar_All.pipe_right _156_670 (FStar_List.map (fun _59_1844 -> (match (_59_1844) with
| (u, _59_1843) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end)))))
in (FStar_All.pipe_right _156_671 (FStar_String.concat ", "))))
in (
...
let _59_1852 = if (let _156_672 = (FStar_Util.set_is_subset_of uvs1 uvs2)
in (FStar_All.pipe_left Prims.op_Negation _156_672)) then begin
(

let unresolved = (let _156_673 = (FStar_Util.set_difference uvs1 uvs2)
in (FStar_All.pipe_right _156_673 FStar_Util.set_elements))
in (let _156_681 = (let _156_680 = (let _156_679 = (let _156_678 = (FStar_TypeChecker_Normalize.term_to_string env e')
in (let _156_677 = (FStar_TypeChecker_Normalize.term_to_string env expected_pat_t)
in (let _156_676 = (let _156_675 = (FStar_All.pipe_right unresolved (FStar_List.map (fun _59_1851 -> (match (_59_1851) with
| (u, _59_1850) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _156_675 (FStar_String.concat ", ")))
in (FStar_Util.format3 "Implicit pattern variables in %s could not be resolved against expected type %s;Variables {%s} were unresolved; please bind them explicitly" _156_678 _156_677 _156_676))))
in ((_156_679), (p.FStar_Syntax_Syntax.p)))
in FStar_Syntax_Syntax.Error (_156_680))
in (Prims.raise _156_681)))
end else begin
()
end
in (
...
(let _156_682 = (FStar_TypeChecker_Normalize.term_to_string env e)
...
in (FStar_All.pipe_right _156_683 FStar_List.unzip))
...
let _59_1865 = (let _156_684 = (FStar_TypeChecker_Env.push_bv env scrutinee)
in (FStar_All.pipe_right _156_684 FStar_TypeChecker_Env.clear_expected_typ))
...
let _59_1878 = (let _156_685 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_TypeChecker_Common.t_bool)
in (tc_term _156_685 e))
...
| Some (w) -> begin
(let _156_687 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Util.t_bool FStar_Syntax_Util.t_bool w FStar_Syntax_Const.exp_true_bool)
in (FStar_All.pipe_left (fun _156_686 -> Some (_156_686)) _156_687))
end)
in (
...
| Some (f) -> begin
(let _156_691 = (FStar_Syntax_Util.mk_disj clause f)
in (FStar_All.pipe_left (fun _156_690 -> Some (_156_690)) _156_691))
end))
end))) None))
end
in (
...
in (let _156_694 = (FStar_TypeChecker_Util.weaken_precondition env c gf)
in (let _156_693 = (FStar_TypeChecker_Rel.imp_guard g g_when)
in ((_156_694), (_156_693))))))
end
| (Some (f), Some (w)) -> begin
(
...
let g_fw = (let _156_695 = (FStar_Syntax_Util.mk_conj f w)
in FStar_TypeChecker_Common.NonTrivial (_156_695))
in (let _156_698 = (FStar_TypeChecker_Util.weaken_precondition env c g_fw)
in (let _156_697 = (let _156_696 = (FStar_TypeChecker_Rel.guard_of_guard_formula g_f)
in (FStar_TypeChecker_Rel.imp_guard _156_696 g_when))
in ((_156_698), (_156_697))))))
end
| (None, Some (w)) -> begin
(
...
in (let _156_699 = (FStar_TypeChecker_Util.weaken_precondition env c g_w)
in ((_156_699), (g_when)))))
end)
...
in (let _156_701 = (FStar_TypeChecker_Util.close_comp env pat_bvs c_weak)
in (let _156_700 = (FStar_TypeChecker_Rel.close_guard binders g_when_weak)
in ((_156_701), (_156_700), (g_branch)))))
end))
end)))
...
let discriminate = (fun scrutinee_tm f -> if ((let _156_711 = (let _156_710 = (FStar_TypeChecker_Env.typ_of_datacon env f.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.datacons_of_typ env _156_710))
in (FStar_List.length _156_711)) > (Prims.parse_int "1")) then begin
(

let disc = (let _156_712 = (FStar_Syntax_Util.mk_discriminator f.FStar_Syntax_Syntax.v)
in (FStar_Syntax_Syntax.fvar _156_712 FStar_Syntax_Syntax.Delta_equational None))
in (

let disc = (let _156_714 = (let _156_713 = (FStar_Syntax_Syntax.as_arg scrutinee_tm)
in (_156_713)::[])
in (FStar_Syntax_Syntax.mk_Tm_app disc _156_714 None scrutinee_tm.FStar_Syntax_Syntax.pos))
in (let _156_715 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Util.t_bool FStar_Syntax_Util.t_bool disc FStar_Syntax_Const.exp_true_bool)
in (_156_715)::[])))
end else begin
[]
end)
...
| () -> begin
(let _156_721 = (let _156_720 = (FStar_Range.string_of_range pat_exp.FStar_Syntax_Syntax.pos)
in (let _156_719 = (FStar_Syntax_Print.term_to_string pat_exp)
in (let _156_718 = (FStar_Syntax_Print.tag_of_term pat_exp)
in (FStar_Util.format3 "tc_eqn: Impossible (%s) %s (%s)" _156_720 _156_719 _156_718))))
in (FStar_All.failwith _156_721))
end))
in (
...
let pat_exp = (let _156_724 = (FStar_Syntax_Subst.compress pat_exp)
in (FStar_All.pipe_right _156_724 FStar_Syntax_Util.unmeta))
in (match (pat_exp.FStar_Syntax_Syntax.n) with
| (FStar_Syntax_Syntax.Tm_uvar (_)) | (FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (_); FStar_Syntax_Syntax.tk = _; FStar_Syntax_Syntax.pos = _; FStar_Syntax_Syntax.vars = _}, _)) | (FStar_Syntax_Syntax.Tm_name (_)) | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_constant (_59_1989) -> begin
(let _156_729 = (let _156_728 = (let _156_727 = (FStar_Syntax_Syntax.as_arg scrutinee_tm)
in (let _156_726 = (let _156_725 = (FStar_Syntax_Syntax.as_arg pat_exp)
in (_156_725)::[])
in (_156_727)::_156_726))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.teq _156_728 None scrutinee_tm.FStar_Syntax_Syntax.pos))
in (_156_729)::[])
end
...
(let _156_730 = (head_constructor pat_exp)
in (discriminate scrutinee_tm _156_730))
end)
end
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(
...
let sub_term_guards = (let _156_736 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _59_2007 -> (match (_59_2007) with
| (ei, _59_2006) -> begin
(
...
let sub_term = (let _156_735 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projector f.FStar_Syntax_Syntax.p) FStar_Syntax_Syntax.Delta_equational None)
in (let _156_734 = (let _156_733 = (FStar_Syntax_Syntax.as_arg scrutinee_tm)
in (_156_733)::[])
in (FStar_Syntax_Syntax.mk_Tm_app _156_735 _156_734 None f.FStar_Syntax_Syntax.p)))
in (build_branch_guard sub_term ei))
end))
end))))
in (FStar_All.pipe_right _156_736 FStar_List.flatten))
in (let _156_737 = (discriminate scrutinee_tm f)
in (FStar_List.append _156_737 sub_term_guards)))
end)
end
| _59_2015 -> begin
[]
...
let t = (let _156_742 = (build_branch_guard scrutinee_tm pat)
in (FStar_All.pipe_left FStar_Syntax_Util.mk_conj_l _156_742))
in (
...
let branch_guard = (let _156_743 = (FStar_All.pipe_right norm_disj_exps (FStar_List.map (build_and_check_branch_guard scrutinee_tm)))
in (FStar_All.pipe_right _156_743 FStar_Syntax_Util.mk_disj_l))
in (
...
(let _156_744 = (FStar_TypeChecker_Rel.guard_to_string env guard)
in (FStar_All.pipe_left (FStar_Util.print1 "Carrying guard from match: %s\n") _156_744))
end else begin
()
end
in (let _156_745 = (FStar_Syntax_Subst.close_branch ((pattern), (when_clause), (branch_exp)))
in ((_156_745), (branch_guard), (c), (guard))))))
end)))
end))
end))
end))
...
let g1 = (let _156_748 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g1)
in (FStar_All.pipe_right _156_748 FStar_TypeChecker_Rel.resolve_implicits))
in (

let _59_2061 = (let _156_752 = (let _156_751 = (let _156_750 = (let _156_749 = (c1.FStar_Syntax_Syntax.comp ())
in ((lb.FStar_Syntax_Syntax.lbname), (e1), (_156_749)))
in (_156_750)::[])
in (FStar_TypeChecker_Util.generalize env _156_751))
in (FStar_List.hd _156_752))
...
(let _156_753 = (FStar_TypeChecker_Env.get_range env)
in (FStar_TypeChecker_Errors.warn _156_753 FStar_TypeChecker_Errors.top_level_effect))
end else begin
()
end
in (let _156_754 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e2), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect))))) None e2.FStar_Syntax_Syntax.pos)
in ((_156_754), (c1))))
end
end))
end else begin
...
let c = (let _156_755 = (c1.FStar_Syntax_Syntax.comp ())
in (FStar_All.pipe_right _156_755 (FStar_TypeChecker_Normalize.normalize_comp ((FStar_TypeChecker_Normalize.Beta)::[]) env)))
in ((e2), (c))))
end
...
let cres = (let _156_756 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit e.FStar_Syntax_Syntax.pos)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _156_756))
in (
...
in (let _156_757 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((false), ((lb)::[]))), (e2)))) (Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
in ((_156_757), (cres), (FStar_TypeChecker_Rel.trivial_guard))))))
end))
end))
end))
end
...
let _59_2103 = (let _156_761 = (let _156_760 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (FStar_All.pipe_right _156_760 Prims.fst))
in (check_let_bound_def false _156_761 lb))
...
let _59_2109 = (let _156_763 = (let _156_762 = (FStar_Syntax_Syntax.mk_binder x)
in (_156_762)::[])
in (FStar_Syntax_Subst.open_term _156_763 e2))
...
let _59_2115 = (let _156_764 = (FStar_TypeChecker_Env.push_bv env x)
in (tc_term _156_764 e2))
...
let e = (let _156_767 = (let _156_766 = (let _156_765 = (FStar_Syntax_Subst.close xb e2)
in ((((false), ((lb)::[]))), (_156_765)))
in FStar_Syntax_Syntax.Tm_let (_156_766))
in (FStar_Syntax_Syntax.mk _156_767 (Some (cres.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos))
in (

let e = (FStar_TypeChecker_Util.maybe_monadic env e cres.FStar_Syntax_Syntax.eff_name cres.FStar_Syntax_Syntax.res_typ)
in (

let x_eq_e1 = (let _156_770 = (let _156_769 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_eq c1.FStar_Syntax_Syntax.res_typ c1.FStar_Syntax_Syntax.res_typ _156_769 e1))
in (FStar_All.pipe_left (fun _156_768 -> FStar_TypeChecker_Common.NonTrivial (_156_768)) _156_770))
in (

let g2 = (let _156_772 = (let _156_771 = (FStar_TypeChecker_Rel.guard_of_guard_formula x_eq_e1)
in (FStar_TypeChecker_Rel.imp_guard _156_771 g2))
in (FStar_TypeChecker_Rel.close_guard xb _156_772))
in (

let guard = (FStar_TypeChecker_Rel.conj_guard g1 g2)
in if (let _156_773 = (FStar_TypeChecker_Env.expected_typ env)
in (FStar_Option.isSome _156_773)) then begin
(

let tt = (let _156_774 = (FStar_TypeChecker_Env.expected_typ env)
in (FStar_All.pipe_right _156_774 FStar_Option.get))
in (

let _59_2126 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Exports"))) then begin
(let _156_776 = (FStar_Syntax_Print.term_to_string tt)
in (let _156_775 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
...
(let _156_778 = (FStar_Syntax_Print.term_to_string cres.FStar_Syntax_Syntax.res_typ)
in (let _156_777 = (FStar_Syntax_Print.term_to_string t)
...
let g_lbs = (let _156_781 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g_lbs)
in (FStar_All.pipe_right _156_781 FStar_TypeChecker_Rel.resolve_implicits))
in (

let all_lb_names = (let _156_784 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (FStar_Util.right lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right _156_784 (fun _156_783 -> Some (_156_783))))
in (
...
let ecs = (let _156_788 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (let _156_787 = (FStar_Syntax_Syntax.mk_Total lb.FStar_Syntax_Syntax.lbtyp)
in ((lb.FStar_Syntax_Syntax.lbname), (lb.FStar_Syntax_Syntax.lbdef), (_156_787))))))
in (FStar_TypeChecker_Util.generalize env _156_788))
...
let cres = (let _156_790 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _156_790))
in (
...
| (lbs, e2) -> begin
(let _156_792 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((((true), (lbs))), (e2)))) (Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)) top.FStar_Syntax_Syntax.pos)
in (let _156_791 = (FStar_TypeChecker_Rel.discharge_guard env g_lbs)
in ((_156_792), (cres), (_156_791))))
end)))))))
end))
end))
end))
...
let _59_2287 = (let _156_811 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _59_2281 = (let _156_810 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term _156_810 lb.FStar_Syntax_Syntax.lbdef))
...
in (FStar_All.pipe_right _156_811 FStar_List.unzip))
...
let _59_2313 = (let _156_818 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (Some ((fun _59_2310 -> (match (()) with
| () -> begin
FStar_TypeChecker_Errors.ill_kinded_type
end)))) _156_818 e1 c1 wf_annot))
...
(let _156_821 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _156_820 = (FStar_Syntax_Print.term_to_string c1.FStar_Syntax_Syntax.res_typ)
in (let _156_819 = (FStar_TypeChecker_Rel.guard_to_string env g1)
in (FStar_Util.print3 "checked top-level def %s, result type is %s, guard is %s\n" _156_821 _156_820 _156_819))))
end else begin
()
end
in (let _156_822 = (FStar_Option.isSome topt)
in ((e1), (univ_vars), (c1), (g1), (_156_822)))))
end))
end)))
end)))
end)))
...
(let _156_826 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in ((Some (t)), (FStar_TypeChecker_Rel.trivial_guard), (univ_vars), (_156_826)))
end else begin
(
...
(let _156_829 = (let _156_827 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (FStar_Range.string_of_range _156_827))
in (let _156_828 = (FStar_Syntax_Print.term_to_string t)
...
let t = (norm env1 t)
in (let _156_830 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in ((Some (t)), (g), (univ_vars), (_156_830)))))
end))
end))
end)
end))
...
(let _156_835 = (FStar_Syntax_Print.bv_to_string x)
in (let _156_834 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _156_833 = (FStar_Syntax_Print.term_to_string tu)
in (FStar_Util.print3 "Checking binders %s:%s at type %s\n" _156_835 _156_834 _156_833))))
end else begin
()
end
in (
...
(let _156_837 = (FStar_Syntax_Print.bv_to_string (Prims.fst x))
in (let _156_836 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print2 "Pushing binder %s at type %s\n" _156_837 _156_836)))
end else begin
()
end
in (let _156_838 = (push_binding env x)
in ((x), (_156_838), (g), (u)))))
end)))
end))
end))
...
| (bs, env', g', us) -> begin
(let _156_846 = (let _156_845 = (FStar_TypeChecker_Rel.close_guard ((b)::[]) g')
in (FStar_TypeChecker_Rel.conj_guard g _156_845))
in (((b)::bs), (env'), (_156_846), ((u)::us)))
end))
end))
end))
in (aux env bs)))
...
| (args, g') -> begin
(let _156_858 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((args)::pats), (_156_858)))
end))
...
(let _156_861 = (FStar_Syntax_Syntax.mk_Total (FStar_Syntax_Util.comp_result c))
in ((_156_861), (false)))
end else begin
(let _156_862 = (FStar_Syntax_Syntax.mk_GTotal (FStar_Syntax_Util.comp_result c))
in ((_156_862), (true)))
end
...
| Some (g') -> begin
(let _156_863 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((e), ((FStar_Syntax_Util.lcomp_of_comp target_comp)), (_156_863)))
end
| _59_2418 -> begin
if allow_ghost then begin
(let _156_866 = (let _156_865 = (let _156_864 = (FStar_TypeChecker_Errors.expected_ghost_expression e c)
in ((_156_864), (e.FStar_Syntax_Syntax.pos)))
in FStar_Syntax_Syntax.Error (_156_865))
in (Prims.raise _156_866))
end else begin
(let _156_869 = (let _156_868 = (let _156_867 = (FStar_TypeChecker_Errors.expected_pure_expression e c)
in ((_156_867), (e.FStar_Syntax_Syntax.pos)))
...
(let _156_879 = (FStar_Syntax_Print.term_to_string e)
...
(let _156_884 = (let _156_883 = (let _156_882 = (FStar_TypeChecker_Env.get_range env)
in (((Prims.strcat "Implicit argument: " msg)), (_156_882)))
in FStar_Syntax_Syntax.Error (_156_883))
in (Prims.raise _156_884))
end
...
(let _156_889 = (let _156_888 = (let _156_887 = (let _156_885 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" _156_885))
in (let _156_886 = (FStar_TypeChecker_Env.get_range env)
in ((_156_887), (_156_886))))
in FStar_Syntax_Syntax.Error (_156_888))
in (Prims.raise _156_889))
end
end)))))
...
(let _156_894 = (FStar_Syntax_Print.term_to_string e)
...
let fail = (fun e t -> (let _156_904 = (let _156_903 = (let _156_902 = (let _156_900 = (FStar_Syntax_Print.term_to_string e)
in (let _156_899 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "Expected a term of type \'Type\'; got %s : %s" _156_900 _156_899)))
in (let _156_901 = (FStar_TypeChecker_Env.get_range env)
in ((_156_902), (_156_901))))
in FStar_Syntax_Syntax.Error (_156_903))
in (Prims.raise _156_904)))
in (

let ok = (fun u -> (

let _59_2468 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
(let _156_909 = (FStar_Syntax_Print.tag_of_term e)
in (let _156_908 = (FStar_Syntax_Print.term_to_string e)
in (let _156_907 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.print3 "<end> universe_of (%s) %s is %s\n" _156_909 _156_908 _156_907))))
end else begin
()
end
in u))
...
let universe_of_type = (fun e t -> (match ((let _156_914 = (FStar_Syntax_Util.unrefine t)
in _156_914.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (u) -> begin
(ok u)
end
| _59_2476 -> begin
...
| (head, args) -> begin
(match ((let _156_915 = (FStar_Syntax_Subst.compress head)
in _156_915.FStar_Syntax_Syntax.n)) with
...
in (match ((let _156_916 = (FStar_Syntax_Subst.compress t)
in _156_916.FStar_Syntax_Syntax.n)) with
...
let _59_2511 = (let _156_918 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_right _156_918 Prims.ignore))
in t)
end)))
end
| Some (t) -> begin
...
in (let _156_919 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env t)
in (FStar_All.pipe_left (universe_of_type e) _156_919)))
end)
end))))))
end))))
