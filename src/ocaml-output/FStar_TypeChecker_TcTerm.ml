        ...
        | letrecs ->
            ...
            let env1 =
              let uu___350_2258 = env  in
              {
                ...
                FStar_TypeChecker_Env.try_solve_implicits_hook =
                  (uu___350_2258.FStar_TypeChecker_Env.try_solve_implicits_hook);
                FStar_TypeChecker_Env.splice =
                ...
                (let uu___436_3534 = env  in
                 {
                   ...
                   FStar_TypeChecker_Env.try_solve_implicits_hook =
                     (uu___436_3534.FStar_TypeChecker_Env.try_solve_implicits_hook);
                   FStar_TypeChecker_Env.splice =
                         ...
                         (let uu___546_4233 = env'  in
                          {
                            ...
                            FStar_TypeChecker_Env.try_solve_implicits_hook =
                              (uu___546_4233.FStar_TypeChecker_Env.try_solve_implicits_hook);
                            FStar_TypeChecker_Env.splice =
    ...
    fun tau  ->
      let env1 =
        let uu___1204_9336 = env  in
        {
          ...
          FStar_TypeChecker_Env.try_solve_implicits_hook =
            (uu___1204_9336.FStar_TypeChecker_Env.try_solve_implicits_hook);
          FStar_TypeChecker_Env.splice =
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___1753_12802 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.try_solve_implicits_hook
                                   =
                                   (uu___1753_12802.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                 FStar_TypeChecker_Env.splice =
                            ...
                            (let uu___1844_13518 = envbody1  in
                             {
                               ...
                               FStar_TypeChecker_Env.try_solve_implicits_hook
                                 =
                                 (uu___1844_13518.FStar_TypeChecker_Env.try_solve_implicits_hook);
                               FStar_TypeChecker_Env.splice =
                                  ...
                                  (let uu___1852_13560 = envbody1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___1852_13560.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                             ...
                             | (targ1,g_ex) ->
                                 ...
                                 let env2 =
                                   let uu___2135_15957 = env1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___2135_15957.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
        ...
        (let uu____20462 =
           let uu____20473 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.try_solve_implicits_hook =
                 (uu___2603_20474.FStar_TypeChecker_Env.try_solve_implicits_hook);
               FStar_TypeChecker_Env.splice =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___2915_22538 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___2915_22538.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___2915_22538.FStar_TypeChecker_Env.strict_args_tab)
            }  in
          let uu____22540 =
            let uu____22552 =
                                   ...
                                   (let uu___3124_23784 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___3124_23784.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                                      ...
                                      FStar_TypeChecker_Env.strict_args_tab =
                                        (uu___3124_23784.FStar_TypeChecker_Env.strict_args_tab)
                                    }) t uu____23772
                                  in
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3134_23821 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___3134_23821.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                                     ...
                                     FStar_TypeChecker_Env.strict_args_tab =
                                       (uu___3134_23821.FStar_TypeChecker_Env.strict_args_tab)
                                   }
                                 else
                                   FStar_TypeChecker_Env.push_let_binding
                       ...
                       (let uu___3185_24099 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.try_solve_implicits_hook =
                            (uu___3185_24099.FStar_TypeChecker_Env.try_solve_implicits_hook);
                          FStar_TypeChecker_Env.splice =
                          ...
                          FStar_TypeChecker_Env.strict_args_tab =
                            (uu___3185_24099.FStar_TypeChecker_Env.strict_args_tab)
                        }) e11
                      in
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3329_25251 = env  in
         {
           ...
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___3329_25251.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
           ...
           FStar_TypeChecker_Env.strict_args_tab =
             (uu___3329_25251.FStar_TypeChecker_Env.strict_args_tab)
         }  in
       let uu____25259 =
         try
           (fun uu___3333_25273  ->
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3365_25437 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3365_25437.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                         ...
                         FStar_TypeChecker_Env.strict_args_tab =
                           (uu___3365_25437.FStar_TypeChecker_Env.strict_args_tab)
                       }  in
                 ...
                 | (env1,uu____26407) ->
                     let env2 =
                       let uu___3526_26413 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3526_26413.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                         ...
                         FStar_TypeChecker_Env.strict_args_tab =
                           (uu___3526_26413.FStar_TypeChecker_Env.strict_args_tab)
                       }  in
                     ((let uu____26418 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3805_28429 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3805_28429.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___3805_28429.FStar_TypeChecker_Env.strict_args_tab)
            }  in
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3836_28533 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3836_28533.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___3836_28533.FStar_TypeChecker_Env.strict_args_tab)
            }  in
