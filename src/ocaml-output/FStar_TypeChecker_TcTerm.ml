            ...
            fun expected_topt  ->
              ...
              (let uu____9615 =
               ...
               then
                 ...
                 let uu____9617 = FStar_Syntax_Print.term_to_string thead in
                 FStar_Util.print2 "(%s) Type of head is %s\n" uu____9616
                   uu____9617
               else ());
              (let monadic_application uu____9674 subst1 arg_comps_rev
                 ...
                 | (head2,chead1,ghead1,cres) ->
                     ...
                     let cres1 =
                       let uu___90_9733 = cres in
                       {
                         FStar_Syntax_Syntax.eff_name =
                           (uu___90_9733.FStar_Syntax_Syntax.eff_name);
                         FStar_Syntax_Syntax.res_typ = rt;
                         FStar_Syntax_Syntax.cflags =
                           (uu___90_9733.FStar_Syntax_Syntax.cflags);
                         FStar_Syntax_Syntax.comp =
                           (uu___90_9733.FStar_Syntax_Syntax.comp)
                       } in
                     let uu____9734 =
                       match bs with
                       | [] ->
                       ...
                       | uu____9749 ->
                           let g =
                             let uu____9757 =
                               FStar_TypeChecker_Rel.conj_guard ghead1 guard in
                             FStar_All.pipe_right uu____9757
                               (FStar_TypeChecker_Rel.solve_deferred_constraints
                                  env) in
                           let uu____9758 =
                             let uu____9759 =
                               let uu____9762 =
                                 let uu____9763 =
                                   ...
                                   FStar_Syntax_Util.arrow bs uu____9764 in
                                 FStar_All.pipe_left
                                   (FStar_Syntax_Subst.subst subst1)
                                   uu____9763 in
                               FStar_Syntax_Syntax.mk_Total uu____9762 in
                             FStar_All.pipe_left
                               FStar_Syntax_Util.lcomp_of_comp uu____9759 in
                           (uu____9758, g) in
                                ...
                                (let uu____9912 =
                                       ...
                                       let uu____10151 =
                                         let uu____10166 =
                                           ...
                                           (uu____10175,
                                             FStar_Pervasives_Native.None,
                                             chead1) in
                                         uu____10166 :: arg_comps_rev in
                                       FStar_List.map map_fun uu____10151 in
                                   ...
                                   | (lifted_args,reverse_args) ->
                                       ...
                                       let uu____10358 =
                                         ...
                                         FStar_List.rev uu____10365 in
                                       (lifted_args, uu____10348,
                                         uu____10358) in
                                 ...
                                 | (lifted_args,head3,args1) ->
                                     ...
                                     let app2 =
                                       FStar_TypeChecker_Util.maybe_monadic
                                         ...
                                         comp1.FStar_Syntax_Syntax.eff_name
                                         comp1.FStar_Syntax_Syntax.res_typ in
                                     let bind_lifted_args e uu___63_10468 =
                                       match uu___63_10468 with
               ...
               let rec tc_args head_info uu____10663 bs args1 =
                 match uu____10663 with
                 | (subst1,outargs,arg_rets,g,fvs) ->
                     (match (bs, args1) with
                      | ((x,FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Implicit uu____10810))::rest,
                         (uu____10812,FStar_Pervasives_Native.None )::uu____10813)
                          ->
                          let t =
                            FStar_Syntax_Subst.subst subst1
                              x.FStar_Syntax_Syntax.sort in
                                 ...
                                 let uu____10952 =
                                   let uu____10967 =
                                     ...
                                     (arg, FStar_Pervasives_Native.None,
                                       uu____10980) in
                                   uu____10967 :: outargs in
                                 let uu____11000 =
                                   FStar_TypeChecker_Rel.conj_guard implicits
                                     g in
                                 (subst2, uu____10952, (arg :: arg_rets),
                                   uu____11000, fvs) in
                               tc_args head_info uu____10917 rest args1)
                      | ((x,aqual)::rest,(e,aq)::rest') ->
                          ((match (aqual, aq) with
                            | (FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit
                               uu____11102),FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11103)) ->
                                ()
                            | (FStar_Pervasives_Native.None
                               ,FStar_Pervasives_Native.None ) -> ()
                            | (FStar_Pervasives_Native.Some
                           ...
                           (let targ =
                              FStar_Syntax_Subst.subst subst1
                                x.FStar_Syntax_Syntax.sort in
                            let x1 =
                              let uu___91_11127 = x in
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___91_11127.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index =
                                  (uu___91_11127.FStar_Syntax_Syntax.index);
                            ...
                            (let targ1 =
                             ...
                             let env1 =
                               FStar_TypeChecker_Env.set_expected_typ env
                                 targ1 in
                             let env2 =
                               let uu___92_11135 = env1 in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___92_11135.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___92_11135.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___92_11135.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___92_11135.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___92_11135.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___92_11135.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___92_11135.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___92_11135.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern =
                                   (uu___92_11135.FStar_TypeChecker_Env.is_pattern);
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___92_11135.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___92_11135.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___92_11135.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs =
                                   (uu___92_11135.FStar_TypeChecker_Env.letrecs);
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___92_11135.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___92_11135.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq = (is_eq aqual);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___92_11135.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___92_11135.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax =
                                   (uu___92_11135.FStar_TypeChecker_Env.lax);
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___92_11135.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.failhard =
                                   (uu___92_11135.FStar_TypeChecker_Env.failhard);
                                 FStar_TypeChecker_Env.nosynth =
                                   (uu___92_11135.FStar_TypeChecker_Env.nosynth);
                                 FStar_TypeChecker_Env.tc_term =
                                   (uu___92_11135.FStar_TypeChecker_Env.tc_term);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___92_11135.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___92_11135.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___92_11135.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___92_11135.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
                                   (uu___92_11135.FStar_TypeChecker_Env.proof_ns);
                                 FStar_TypeChecker_Env.synth =
                                   (uu___92_11135.FStar_TypeChecker_Env.synth);
                                 FStar_TypeChecker_Env.is_native_tactic =
                                   (uu___92_11135.FStar_TypeChecker_Env.is_native_tactic);
                                 FStar_TypeChecker_Env.identifier_info =
                                   (uu___92_11135.FStar_TypeChecker_Env.identifier_info);
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___92_11135.FStar_TypeChecker_Env.tc_hooks);
                                 FStar_TypeChecker_Env.dsenv =
                                   (uu___92_11135.FStar_TypeChecker_Env.dsenv);
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___92_11135.FStar_TypeChecker_Env.dep_graph)
                               } in
                             (let uu____11137 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.High in
                              ...
                              then
                                ...
                                FStar_Util.print3
                                  ...
                                  uu____11138 uu____11139 uu____11140
                              else ());
                             (let uu____11142 = tc_term env2 e in
                              ...
                              | (e1,c,g_e) ->
                                  ...
                                  let xterm =
                                    let uu____11177 =
                                      let uu____11180 =
                                        ...
                                        FStar_Syntax_Syntax.as_arg
                                          uu____11187 in
                                      FStar_Pervasives_Native.fst uu____11180 in
                                    (uu____11177, aq) in
                                  let uu____11194 =
                                  ...
                                  then
                                    let subst2 =
                                      let uu____11202 = FStar_List.hd bs in
                                      maybe_extend_subst subst1 uu____11202
                                        e1 in
                                    tc_args head_info
                                      (subst2,
                                        ((arg,
                     ...
                     (match uu____11791 with
                      | (args1,comps,g_args) ->
                                ...
                                (FStar_List.map
                                   (fun uu____11866  ->
                                      ...
                                      | (uu____11879,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____11828 in
                          let ml_or_tot t r1 =
                          ...
                          let cres =
                            let uu____11899 =
                              let uu____11902 =
                                let uu____11903 = FStar_Syntax_Util.type_u () in
                                FStar_All.pipe_right uu____11903
                                  FStar_Pervasives_Native.fst in
                              FStar_TypeChecker_Util.new_uvar env uu____11902 in
                                ...
                                (FStar_List.map
                                   (fun uu____12237  ->
                                      ...
                                      | (uu____12250,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None))) in
                            FStar_Syntax_Util.null_binders_of_tks uu____12199 in
                          let ml_or_tot t r1 =
                     ...
                     (match uu____12344 with
                      | (bs1,c1) ->
                          ...
                          tc_args head_info
                            ([], [], [], FStar_TypeChecker_Rel.trivial_guard,
                              []) bs1 args)
                 | FStar_Syntax_Syntax.Tm_refine (bv,uu____12409) ->
                     check_function_app bv.FStar_Syntax_Syntax.sort
                 | FStar_Syntax_Syntax.Tm_ascribed
                     (t,uu____12415,uu____12416) -> check_function_app t
                 | uu____12457 ->
                     let uu____12458 =
                       FStar_TypeChecker_Err.expected_function_typ env tf in
                     FStar_Errors.raise_error uu____12458
                  ...
                  let uu____12532 =
                    FStar_List.fold_left2
                      (fun uu____12575  ->
                         fun uu____12576  ->
                           fun uu____12577  ->
                             match (uu____12575, uu____12576, uu____12577)
                             with
                                   ...
                                   | (e1,c1,g) ->
                                       ...
                                       let uu____12670 =
                                         let uu____12679 =
                                           ...
                                           [uu____12688] in
                                         FStar_List.append seen uu____12679 in
                                       let uu____12695 =
                                         FStar_TypeChecker_Rel.conj_guard
                                           guard g1 in
                                       (uu____12670, uu____12695, ghost1))))
                   ...
                   | (args1,guard,ghost) ->
                       ...
                       let c1 =
                         ...
                         then
                           ...
                           FStar_All.pipe_right uu____12731
                             FStar_Syntax_Util.lcomp_of_comp
                         else FStar_Syntax_Util.lcomp_of_comp c in
                       let uu____12733 =
                         FStar_TypeChecker_Util.strengthen_precondition
                           FStar_Pervasives_Native.None env e c1 guard in
                       (match uu____12733 with | (c2,g) -> (e, c2, g)))
              | uu____12750 ->
...
and tc_eqn:
  ...
  fun scrutinee  ->
    fun env  ->
      fun branch1  ->
        let uu____12784 = FStar_Syntax_Subst.open_branch branch1 in
        match uu____12784 with
        | (pattern,when_clause,branch_exp) ->
            let uu____12820 = branch1 in
            (match uu____12820 with
             | (cpat,uu____12852,cbr) ->
                 let tc_pat allow_implicits pat_t p0 =
                   let tc_annot env1 t =
                     let uu____12919 = FStar_Syntax_Util.type_u () in
                     match uu____12919 with
                     | (tu,u) ->
                         let uu____12930 =
                           tc_check_tot_or_gtot_term env1 t tu in
                         (match uu____12930 with
                          | (t1,uu____12942,g) -> (t1, g)) in
                   let uu____12944 =
                   ...
                   | (pat_bvs1,exp,guard_pat_annots,p) ->
                       ((let uu____12978 =
                        ...
                        (let pat_env =
                         ...
                         | (env1,uu____13005) ->
                             let env11 =
                               let uu___93_13011 = env1 in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___93_13011.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___93_13011.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___93_13011.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___93_13011.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___93_13011.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___93_13011.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___93_13011.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___93_13011.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern = true;
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___93_13011.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___93_13011.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___93_13011.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs =
                                   (uu___93_13011.FStar_TypeChecker_Env.letrecs);
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___93_13011.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___93_13011.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq =
                                   (uu___93_13011.FStar_TypeChecker_Env.use_eq);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___93_13011.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___93_13011.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax =
                                   (uu___93_13011.FStar_TypeChecker_Env.lax);
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___93_13011.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.failhard =
                                   (uu___93_13011.FStar_TypeChecker_Env.failhard);
                                 FStar_TypeChecker_Env.nosynth =
                                   (uu___93_13011.FStar_TypeChecker_Env.nosynth);
                                 FStar_TypeChecker_Env.tc_term =
                                   (uu___93_13011.FStar_TypeChecker_Env.tc_term);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___93_13011.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___93_13011.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___93_13011.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___93_13011.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
                                   (uu___93_13011.FStar_TypeChecker_Env.proof_ns);
                                 FStar_TypeChecker_Env.synth =
                                   (uu___93_13011.FStar_TypeChecker_Env.synth);
                                 FStar_TypeChecker_Env.is_native_tactic =
                                   (uu___93_13011.FStar_TypeChecker_Env.is_native_tactic);
                                 FStar_TypeChecker_Env.identifier_info =
                                   (uu___93_13011.FStar_TypeChecker_Env.identifier_info);
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___93_13011.FStar_TypeChecker_Env.tc_hooks);
                                 FStar_TypeChecker_Env.dsenv =
                                   (uu___93_13011.FStar_TypeChecker_Env.dsenv);
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___93_13011.FStar_TypeChecker_Env.dep_graph)
                               } in
                             let expected_pat_t =
                             ...
                             ((let uu____13014 =
                              ...
                              (let env12 =
                               ...
                               | (exp1,lc,g) ->
                                   let g1 =
                                     let uu___94_13044 = g in
                                     {
                                       FStar_TypeChecker_Env.guard_f =
                                         FStar_TypeChecker_Common.Trivial;
                                       FStar_TypeChecker_Env.deferred =
                                         (uu___94_13044.FStar_TypeChecker_Env.deferred);
                                       FStar_TypeChecker_Env.univ_ineqs =
                                         (uu___94_13044.FStar_TypeChecker_Env.univ_ineqs);
                                       FStar_TypeChecker_Env.implicits =
                                         (uu___94_13044.FStar_TypeChecker_Env.implicits)
                                     } in
                                   let uu____13045 =
                                     let uu____13046 =
                                       ...
                                       (let uu____13050 =
                                          let uu____13055 =
                                            ...
                                            FStar_Util.format2
                                              ...
                                              uu____13056 uu____13057 in
                                          (FStar_Errors.Fatal_MismatchedPatternType,
                                            uu____13055) in
                                        FStar_Errors.raise_error uu____13050
                                     ...
                                     then
                                       ...
                                       let uu____13114 =
                                         ...
                                         (FStar_Errors.Fatal_UnresolvedPatternVar,
                                           uu____13119) in
                                       FStar_Errors.raise_error uu____13114
                 ...
                 let uu____13162 =
                   ...
                   FStar_All.pipe_right uu____13169
                     FStar_TypeChecker_Env.clear_expected_typ in
                 (match uu____13162 with
                  | (scrutinee_env,uu____13193) ->
                      let uu____13198 = tc_pat true pat_t pattern in
                      (match uu____13198 with
                       | (pattern1,pat_bvs1,pat_env,pat_exp,guard_pat_annots,norm_pat_exp)
                           ...
                           (match uu____13239 with
                            | (when_clause1,g_when) ->
                                let uu____13316 = tc_term pat_env branch_exp in
                                          ...
                                          let branch_guard =
                                            let uu____13496 =
                                              let uu____13497 =
                                                FStar_TypeChecker_Env.should_verify
                                                  env in
                                              Prims.op_Negation uu____13497 in
                                            if uu____13496
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let uu____13904 = check_let_bound_def true env1 lb in
                 ...
                 then
                   let uu____13943 =
                     FStar_TypeChecker_Normalize.reduce_uvar_solutions env1
                       e1 in
                   (g1, uu____13943, univ_vars1, c1)
                 else
                   (let g11 =
                      let uu____13946 =
                        FStar_TypeChecker_Rel.solve_deferred_constraints env1
                          g1 in
                      FStar_All.pipe_right uu____13946
                        FStar_TypeChecker_Rel.resolve_implicits in
                    let uu____13950 =
                      let uu____13963 =
                        let uu____13978 =
                          let uu____13987 =
                            let uu____14000 = c1.FStar_Syntax_Syntax.comp () in
                            ((lb.FStar_Syntax_Syntax.lbname), e1,
                              uu____14000) in
                          [uu____13987] in
                        FStar_TypeChecker_Util.generalize env1 false
                          uu____13978 in
                      FStar_List.hd uu____13963 in
                    match uu____13950 with
                    | (uu____14053,univs1,e11,c11,gvs) ->
                        let g12 =
                          FStar_All.pipe_left
                    ...
                    let uu____14076 =
                      ...
                      then
                            ...
                            (if ok
                             then (e2, c12)
                               ...
                               ((let uu____14113 =
                                 ...
                                 FStar_Errors.log_issue uu____14113
                        ...
                        (FStar_TypeChecker_Rel.force_trivial_guard env1 g11;
                         (let c =
                            let uu____14124 = c11.FStar_Syntax_Syntax.comp () in
                            FStar_All.pipe_right uu____14124
                    ...
                    (match uu____14076 with
                     | (e21,c12) ->
                         ...
                         (uu____14156,
                           ...
                           FStar_TypeChecker_Rel.trivial_guard))))
      | uu____14171 -> failwith "Impossible"
and check_inner_let:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.term,FStar_Syntax_Syntax.lcomp,FStar_TypeChecker_Env.guard_t)
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___95_14202 = env1 in
            {
              FStar_TypeChecker_Env.solver =
                (uu___95_14202.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___95_14202.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___95_14202.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___95_14202.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___95_14202.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___95_14202.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___95_14202.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___95_14202.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___95_14202.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___95_14202.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___95_14202.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___95_14202.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___95_14202.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level = false;
              FStar_TypeChecker_Env.check_uvars =
                (uu___95_14202.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___95_14202.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___95_14202.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___95_14202.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___95_14202.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___95_14202.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___95_14202.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___95_14202.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___95_14202.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___95_14202.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___95_14202.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___95_14202.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___95_14202.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___95_14202.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth =
                (uu___95_14202.FStar_TypeChecker_Env.synth);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___95_14202.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___95_14202.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___95_14202.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___95_14202.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___95_14202.FStar_TypeChecker_Env.dep_graph)
            } in
          let uu____14203 =
            let uu____14214 =
              let uu____14215 = FStar_TypeChecker_Env.clear_expected_typ env2 in
              FStar_All.pipe_right uu____14215 FStar_Pervasives_Native.fst in
            check_let_bound_def false uu____14214 lb in
          (match uu____14203 with
           | (e1,uu____14237,c1,g1,annotated) ->
               let x =
                 let uu___96_14242 =
                   FStar_Util.left lb.FStar_Syntax_Syntax.lbname in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___96_14242.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___96_14242.FStar_Syntax_Syntax.index);
                   FStar_Syntax_Syntax.sort =
                     (c1.FStar_Syntax_Syntax.res_typ)
                 } in
               let uu____14243 =
                 let uu____14248 =
                   let uu____14249 = FStar_Syntax_Syntax.mk_binder x in
                   [uu____14249] in
                 FStar_Syntax_Subst.open_term uu____14248 e2 in
               (match uu____14243 with
                | (xb,e21) ->
                    let xbinder = FStar_List.hd xb in
                    let x1 = FStar_Pervasives_Native.fst xbinder in
                    let env_x = FStar_TypeChecker_Env.push_bv env2 x1 in
                    let uu____14269 = tc_term env_x e21 in
                     ...
                     | (e22,c2,g2) ->
                           ...
                           let uu____14299 =
                             let uu____14302 =
                               let uu____14303 =
                                 ...
                                 ((false, [lb1]), uu____14316) in
                               FStar_Syntax_Syntax.Tm_let uu____14303 in
                         ...
                         let x_eq_e1 =
                           let uu____14330 =
                             ...
                             let uu____14332 =
                               FStar_Syntax_Syntax.bv_to_name x1 in
                             FStar_Syntax_Util.mk_eq2 uu____14331
                               c1.FStar_Syntax_Syntax.res_typ uu____14332 e11 in
                           FStar_All.pipe_left
                             (fun _0_42  ->
                         ...
                         let g21 =
                           let uu____14334 =
                             let uu____14335 =
                               FStar_TypeChecker_Rel.guard_of_guard_formula
                                 x_eq_e1 in
                             FStar_TypeChecker_Rel.imp_guard uu____14335 g2 in
                         ...
                         let uu____14337 =
                           ...
                           FStar_Option.isSome uu____14338 in
                         if uu____14337
                         then
                           let tt =
                             let uu____14348 =
                            ...
                            (let uu____14361 =
                             ...
                             then
                               ...
                               FStar_Util.print2
                                 ...
                                 uu____14362 uu____14363
                             else ());
                            (e4,
                              ((let uu___97_14366 = cres in
                                {
                                  FStar_Syntax_Syntax.eff_name =
                                    (uu___97_14366.FStar_Syntax_Syntax.eff_name);
                                  FStar_Syntax_Syntax.res_typ = t;
                                  FStar_Syntax_Syntax.cflags =
                                    (uu___97_14366.FStar_Syntax_Syntax.cflags);
                                  FStar_Syntax_Syntax.comp =
                                    (uu___97_14366.FStar_Syntax_Syntax.comp)
                                })), guard)))))
      | uu____14367 -> failwith "Impossible"
  ...
  fun env  ->
    fun top  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          let uu____14399 = FStar_Syntax_Subst.open_let_rec lbs e2 in
          (match uu____14399 with
           | (lbs1,e21) ->
               ...
               (match uu____14418 with
                | (env0,topt) ->
                    let uu____14437 = build_let_rec_env true env0 lbs1 in
                    (match uu____14437 with
                     | (lbs2,rec_env) ->
                         let uu____14456 = check_let_recs rec_env lbs2 in
                              ...
                              let cres =
                                let uu____14667 =
                                  FStar_Syntax_Syntax.mk_Total
                                    FStar_Syntax_Syntax.t_unit in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____14667 in
                              let uu____14672 =
                               ...
                               | (lbs5,e22) ->
                                   ((let uu____14692 =
                                    ...
                                    (let uu____14693 =
                                     ...
                                     (uu____14693, cres,
                                       FStar_TypeChecker_Rel.trivial_guard))))))))
      | uu____14706 -> failwith "Impossible"
and check_inner_let_rec:
  ...
  fun env  ->
    fun top  ->
      ...
      match top.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          let uu____14738 = FStar_Syntax_Subst.open_let_rec lbs e2 in
          (match uu____14738 with
           | (lbs1,e21) ->
               ...
               (match uu____14757 with
                | (env0,topt) ->
                    let uu____14776 = build_let_rec_env false env0 lbs1 in
                    (match uu____14776 with
                     | (lbs2,rec_env) ->
                         let uu____14795 = check_let_recs rec_env lbs2 in
                                     ...
                                     (fun env2  ->
                                        fun lb  ->
                                          let x =
                                            ...
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___98_14837.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___98_14837.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort =
                                                (lb.FStar_Syntax_Syntax.lbtyp)
                                            } in
                                          let lb1 =
                                            let uu___99_14839 = lb in
                                            {
                                              FStar_Syntax_Syntax.lbname =
                                                (FStar_Util.Inl x);
                                              FStar_Syntax_Syntax.lbunivs =
                                                (uu___99_14839.FStar_Syntax_Syntax.lbunivs);
                                              FStar_Syntax_Syntax.lbtyp =
                                                (uu___99_14839.FStar_Syntax_Syntax.lbtyp);
                                              FStar_Syntax_Syntax.lbeff =
                                                (uu___99_14839.FStar_Syntax_Syntax.lbeff);
                                              FStar_Syntax_Syntax.lbdef =
                                                (uu___99_14839.FStar_Syntax_Syntax.lbdef)
                                            } in
                                          let env3 =
                                            FStar_TypeChecker_Env.push_let_binding
                                              env2
                               ...
                               | (env2,lbs4) ->
                                     ...
                                     FStar_All.pipe_right lbs4
                                       (FStar_List.map
                                          (fun lb  ->
                                             FStar_Util.left
                                               lb.FStar_Syntax_Syntax.lbname)) in
                                   let uu____14866 = tc_term env2 e21 in
                                   (match uu____14866 with
                                    | (e22,cres,g2) ->
                                          ...
                                          let uu____14883 =
                                            let uu____14884 =
                                              FStar_List.map
                                                ...
                                                bvs in
                                            FStar_TypeChecker_Rel.close_guard
                                              env2 uu____14884 g2 in
                                          FStar_TypeChecker_Rel.conj_guard
                                            g_lbs uu____14883 in
                                        let cres1 =
                                          FStar_TypeChecker_Util.close_lcomp
                                            env2 bvs cres in
                                        let tres =
                                        ...
                                        let cres2 =
                                          let uu___100_14888 = cres1 in
                                          {
                                            FStar_Syntax_Syntax.eff_name =
                                              (uu___100_14888.FStar_Syntax_Syntax.eff_name);
                                            FStar_Syntax_Syntax.res_typ =
                                              tres;
                                            FStar_Syntax_Syntax.cflags =
                                              (uu___100_14888.FStar_Syntax_Syntax.cflags);
                                            FStar_Syntax_Syntax.comp =
                                              (uu___100_14888.FStar_Syntax_Syntax.comp)
                                          } in
                                        let uu____14889 =
                                              ...
                                              | FStar_Pervasives_Native.None 
                                                  ...
                                                  let cres3 =
                                                      ...
                                                      cres2 in
                                                    {
                                                      FStar_Syntax_Syntax.eff_name
                                                        =
                                                        (uu___101_14930.FStar_Syntax_Syntax.eff_name);
                                                      FStar_Syntax_Syntax.res_typ
                                                        = tres1;
                                                      FStar_Syntax_Syntax.cflags
                                                        =
                                                        (uu___101_14930.FStar_Syntax_Syntax.cflags);
                                                      FStar_Syntax_Syntax.comp
                                                        =
                                                        (uu___101_14930.FStar_Syntax_Syntax.comp)
                                                    } in
                                                  (e, cres3, guard)))))))))
      | uu____14933 -> failwith "Impossible"
    ...
    fun env  ->
      fun lbs  ->
        ...
        let termination_check_enabled lbname lbdef lbtyp =
          let uu____14962 = FStar_Options.ml_ish () in
          if uu____14962
          then false
          else
            (let t = FStar_TypeChecker_Normalize.unfold_whnf env lbtyp in
             let uu____14965 = FStar_Syntax_Util.arrow_formals_comp t in
             match uu____14965 with
             | (formals,c) ->
                 let uu____14990 = FStar_Syntax_Util.abs_formals lbdef in
                 (match uu____14990 with
                  | (actuals,uu____15000,uu____15001) ->
                      if
                      ...
                      then
                        let uu____15014 =
                          ...
                          (FStar_Errors.Fatal_RecursiveFunctionLiteral,
                            uu____15019) in
                        FStar_Errors.raise_error uu____15014
                           ...
                           (let actuals_msg =
                            ...
                            let msg =
                              ...
                              FStar_Util.format4
                                ...
                                uu____15071 uu____15072 formals_msg
                                actuals_msg in
                            FStar_Errors.raise_error
                              ...
                              (let uu____15145 =
                                 let uu____15152 =
                                   let uu____15153 =
                                     FStar_Syntax_Util.type_u () in
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____15153 in
                                 tc_check_tot_or_gtot_term
                                   (let uu___102_15164 = env0 in
                                    {
                                      FStar_TypeChecker_Env.solver =
                                        (uu___102_15164.FStar_TypeChecker_Env.solver);
                                      FStar_TypeChecker_Env.range =
                                        (uu___102_15164.FStar_TypeChecker_Env.range);
                                      FStar_TypeChecker_Env.curmodule =
                                        (uu___102_15164.FStar_TypeChecker_Env.curmodule);
                                      FStar_TypeChecker_Env.gamma =
                                        (uu___102_15164.FStar_TypeChecker_Env.gamma);
                                      FStar_TypeChecker_Env.gamma_cache =
                                        (uu___102_15164.FStar_TypeChecker_Env.gamma_cache);
                                      FStar_TypeChecker_Env.modules =
                                        (uu___102_15164.FStar_TypeChecker_Env.modules);
                                      FStar_TypeChecker_Env.expected_typ =
                                        (uu___102_15164.FStar_TypeChecker_Env.expected_typ);
                                      FStar_TypeChecker_Env.sigtab =
                                        (uu___102_15164.FStar_TypeChecker_Env.sigtab);
                                      FStar_TypeChecker_Env.is_pattern =
                                        (uu___102_15164.FStar_TypeChecker_Env.is_pattern);
                                      FStar_TypeChecker_Env.instantiate_imp =
                                        (uu___102_15164.FStar_TypeChecker_Env.instantiate_imp);
                                      FStar_TypeChecker_Env.effects =
                                        (uu___102_15164.FStar_TypeChecker_Env.effects);
                                      FStar_TypeChecker_Env.generalize =
                                        (uu___102_15164.FStar_TypeChecker_Env.generalize);
                                      FStar_TypeChecker_Env.letrecs =
                                        (uu___102_15164.FStar_TypeChecker_Env.letrecs);
                                      FStar_TypeChecker_Env.top_level =
                                        (uu___102_15164.FStar_TypeChecker_Env.top_level);
                                      FStar_TypeChecker_Env.check_uvars =
                                        true;
                                      FStar_TypeChecker_Env.use_eq =
                                        (uu___102_15164.FStar_TypeChecker_Env.use_eq);
                                      FStar_TypeChecker_Env.is_iface =
                                        (uu___102_15164.FStar_TypeChecker_Env.is_iface);
                                      FStar_TypeChecker_Env.admit =
                                        (uu___102_15164.FStar_TypeChecker_Env.admit);
                                      FStar_TypeChecker_Env.lax =
                                        (uu___102_15164.FStar_TypeChecker_Env.lax);
                                      FStar_TypeChecker_Env.lax_universes =
                                        (uu___102_15164.FStar_TypeChecker_Env.lax_universes);
                                      FStar_TypeChecker_Env.failhard =
                                        (uu___102_15164.FStar_TypeChecker_Env.failhard);
                                      FStar_TypeChecker_Env.nosynth =
                                        (uu___102_15164.FStar_TypeChecker_Env.nosynth);
                                      FStar_TypeChecker_Env.tc_term =
                                        (uu___102_15164.FStar_TypeChecker_Env.tc_term);
                                      FStar_TypeChecker_Env.type_of =
                                        (uu___102_15164.FStar_TypeChecker_Env.type_of);
                                      FStar_TypeChecker_Env.universe_of =
                                        (uu___102_15164.FStar_TypeChecker_Env.universe_of);
                                      FStar_TypeChecker_Env.use_bv_sorts =
                                        (uu___102_15164.FStar_TypeChecker_Env.use_bv_sorts);
                                      FStar_TypeChecker_Env.qname_and_index =
                                        (uu___102_15164.FStar_TypeChecker_Env.qname_and_index);
                                      FStar_TypeChecker_Env.proof_ns =
                                        (uu___102_15164.FStar_TypeChecker_Env.proof_ns);
                                      FStar_TypeChecker_Env.synth =
                                        (uu___102_15164.FStar_TypeChecker_Env.synth);
                                      FStar_TypeChecker_Env.is_native_tactic
                                        =
                                        (uu___102_15164.FStar_TypeChecker_Env.is_native_tactic);
                                      FStar_TypeChecker_Env.identifier_info =
                                        (uu___102_15164.FStar_TypeChecker_Env.identifier_info);
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___102_15164.FStar_TypeChecker_Env.tc_hooks);
                                      FStar_TypeChecker_Env.dsenv =
                                        (uu___102_15164.FStar_TypeChecker_Env.dsenv);
                                      FStar_TypeChecker_Env.dep_graph =
                                        (uu___102_15164.FStar_TypeChecker_Env.dep_graph)
                                    }) t uu____15152 in
                               ...
                               | (t1,uu____15166,g) ->
                                   ...
                                   ((let uu____15170 =
                                       FStar_TypeChecker_Rel.discharge_guard
                                         env2 g1 in
                                     FStar_All.pipe_left
                                       FStar_Pervasives.ignore uu____15170);
                                    norm env0 t1)) in
                          let env3 =
                            let uu____15172 =
                            ...
                            if uu____15172
                            then
                              let uu___103_15173 = env2 in
                              {
                                FStar_TypeChecker_Env.solver =
                                  (uu___103_15173.FStar_TypeChecker_Env.solver);
                                FStar_TypeChecker_Env.range =
                                  (uu___103_15173.FStar_TypeChecker_Env.range);
                                FStar_TypeChecker_Env.curmodule =
                                  (uu___103_15173.FStar_TypeChecker_Env.curmodule);
                                FStar_TypeChecker_Env.gamma =
                                  (uu___103_15173.FStar_TypeChecker_Env.gamma);
                                FStar_TypeChecker_Env.gamma_cache =
                                  (uu___103_15173.FStar_TypeChecker_Env.gamma_cache);
                                FStar_TypeChecker_Env.modules =
                                  (uu___103_15173.FStar_TypeChecker_Env.modules);
                                FStar_TypeChecker_Env.expected_typ =
                                  (uu___103_15173.FStar_TypeChecker_Env.expected_typ);
                                FStar_TypeChecker_Env.sigtab =
                                  (uu___103_15173.FStar_TypeChecker_Env.sigtab);
                                FStar_TypeChecker_Env.is_pattern =
                                  (uu___103_15173.FStar_TypeChecker_Env.is_pattern);
                                FStar_TypeChecker_Env.instantiate_imp =
                                  (uu___103_15173.FStar_TypeChecker_Env.instantiate_imp);
                                FStar_TypeChecker_Env.effects =
                                  (uu___103_15173.FStar_TypeChecker_Env.effects);
                                FStar_TypeChecker_Env.generalize =
                                  (uu___103_15173.FStar_TypeChecker_Env.generalize);
                                FStar_TypeChecker_Env.letrecs =
                                  (((lb.FStar_Syntax_Syntax.lbname), t1,
                                     univ_vars1) ::
                                  (env2.FStar_TypeChecker_Env.letrecs));
                                FStar_TypeChecker_Env.top_level =
                                  (uu___103_15173.FStar_TypeChecker_Env.top_level);
                                FStar_TypeChecker_Env.check_uvars =
                                  (uu___103_15173.FStar_TypeChecker_Env.check_uvars);
                                FStar_TypeChecker_Env.use_eq =
                                  (uu___103_15173.FStar_TypeChecker_Env.use_eq);
                                FStar_TypeChecker_Env.is_iface =
                                  (uu___103_15173.FStar_TypeChecker_Env.is_iface);
                                FStar_TypeChecker_Env.admit =
                                  (uu___103_15173.FStar_TypeChecker_Env.admit);
                                FStar_TypeChecker_Env.lax =
                                  (uu___103_15173.FStar_TypeChecker_Env.lax);
                                FStar_TypeChecker_Env.lax_universes =
                                  (uu___103_15173.FStar_TypeChecker_Env.lax_universes);
                                FStar_TypeChecker_Env.failhard =
                                  (uu___103_15173.FStar_TypeChecker_Env.failhard);
                                FStar_TypeChecker_Env.nosynth =
                                  (uu___103_15173.FStar_TypeChecker_Env.nosynth);
                                FStar_TypeChecker_Env.tc_term =
                                  (uu___103_15173.FStar_TypeChecker_Env.tc_term);
                                FStar_TypeChecker_Env.type_of =
                                  (uu___103_15173.FStar_TypeChecker_Env.type_of);
                                FStar_TypeChecker_Env.universe_of =
                                  (uu___103_15173.FStar_TypeChecker_Env.universe_of);
                                FStar_TypeChecker_Env.use_bv_sorts =
                                  (uu___103_15173.FStar_TypeChecker_Env.use_bv_sorts);
                                FStar_TypeChecker_Env.qname_and_index =
                                  (uu___103_15173.FStar_TypeChecker_Env.qname_and_index);
                                FStar_TypeChecker_Env.proof_ns =
                                  (uu___103_15173.FStar_TypeChecker_Env.proof_ns);
                                FStar_TypeChecker_Env.synth =
                                  (uu___103_15173.FStar_TypeChecker_Env.synth);
                                FStar_TypeChecker_Env.is_native_tactic =
                                  (uu___103_15173.FStar_TypeChecker_Env.is_native_tactic);
                                FStar_TypeChecker_Env.identifier_info =
                                  (uu___103_15173.FStar_TypeChecker_Env.identifier_info);
                                FStar_TypeChecker_Env.tc_hooks =
                                  (uu___103_15173.FStar_TypeChecker_Env.tc_hooks);
                                FStar_TypeChecker_Env.dsenv =
                                  (uu___103_15173.FStar_TypeChecker_Env.dsenv);
                                FStar_TypeChecker_Env.dep_graph =
                                  (uu___103_15173.FStar_TypeChecker_Env.dep_graph)
                              }
                            else
                              FStar_TypeChecker_Env.push_let_binding env2
                                ...
                                (univ_vars1, t1) in
                          let lb1 =
                            let uu___104_15190 = lb in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___104_15190.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs = univ_vars1;
                              FStar_Syntax_Syntax.lbtyp = t1;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___104_15190.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = e
                            } in
                          ((lb1 :: lbs1), env3))) ([], env) lbs in
        match uu____15079 with | (lbs1,env1) -> ((FStar_List.rev lbs1), env1)
and check_let_recs:
               ...
               (fun lb  ->
                  ...
                  | (bs,t,lcomp) ->
                      (match bs with
                       ...
                       | uu____15281 ->
                           let lb1 =
                             let uu___105_15284 = lb in
                             let uu____15285 =
                               FStar_Syntax_Util.abs bs t lcomp in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___105_15284.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___105_15284.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___105_15284.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___105_15284.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = uu____15285
                             } in
                           let uu____15288 =
                             let uu____15295 =
                               FStar_TypeChecker_Env.set_expected_typ env
                                 lb1.FStar_Syntax_Syntax.lbtyp in
                             tc_tot_or_gtot_term uu____15295
                           ...
                           (match uu____15288 with
                            | (e,c,g) ->
                                ((let uu____15304 =
                                    ...
                                    Prims.op_Negation uu____15305 in
                                  if uu____15304
                                  then
                                    FStar_Errors.raise_error
                                 ...
                                 (let lb2 =
                                  ...
                                  (lb2, g))))))) in
        FStar_All.pipe_right uu____15222 FStar_List.unzip in
...
and check_let_bound_def:
  ...
  fun top_level  ->
    fun env  ->
      fun lb  ->
        let uu____15354 = FStar_TypeChecker_Env.clear_expected_typ env in
        match uu____15354 with
        | (env1,uu____15372) ->
            let e1 = lb.FStar_Syntax_Syntax.lbdef in
            let uu____15380 = check_lbtyp top_level env lb in
             ...
             | (topt,wf_annot,univ_vars1,univ_opening,env11) ->
                 (if (Prims.op_Negation top_level) && (univ_vars1 <> [])
                  ...
                  (let e11 = FStar_Syntax_Subst.subst univ_opening e1 in
                   let uu____15424 =
                     tc_maybe_toplevel_term
                       (let uu___106_15433 = env11 in
                        {
                          FStar_TypeChecker_Env.solver =
                            (uu___106_15433.FStar_TypeChecker_Env.solver);
                          FStar_TypeChecker_Env.range =
                            (uu___106_15433.FStar_TypeChecker_Env.range);
                          FStar_TypeChecker_Env.curmodule =
                            (uu___106_15433.FStar_TypeChecker_Env.curmodule);
                          FStar_TypeChecker_Env.gamma =
                            (uu___106_15433.FStar_TypeChecker_Env.gamma);
                          FStar_TypeChecker_Env.gamma_cache =
                            (uu___106_15433.FStar_TypeChecker_Env.gamma_cache);
                          FStar_TypeChecker_Env.modules =
                            (uu___106_15433.FStar_TypeChecker_Env.modules);
                          FStar_TypeChecker_Env.expected_typ =
                            (uu___106_15433.FStar_TypeChecker_Env.expected_typ);
                          FStar_TypeChecker_Env.sigtab =
                            (uu___106_15433.FStar_TypeChecker_Env.sigtab);
                          FStar_TypeChecker_Env.is_pattern =
                            (uu___106_15433.FStar_TypeChecker_Env.is_pattern);
                          FStar_TypeChecker_Env.instantiate_imp =
                            (uu___106_15433.FStar_TypeChecker_Env.instantiate_imp);
                          FStar_TypeChecker_Env.effects =
                            (uu___106_15433.FStar_TypeChecker_Env.effects);
                          FStar_TypeChecker_Env.generalize =
                            (uu___106_15433.FStar_TypeChecker_Env.generalize);
                          FStar_TypeChecker_Env.letrecs =
                            (uu___106_15433.FStar_TypeChecker_Env.letrecs);
                          FStar_TypeChecker_Env.top_level = top_level;
                          FStar_TypeChecker_Env.check_uvars =
                            (uu___106_15433.FStar_TypeChecker_Env.check_uvars);
                          FStar_TypeChecker_Env.use_eq =
                            (uu___106_15433.FStar_TypeChecker_Env.use_eq);
                          FStar_TypeChecker_Env.is_iface =
                            (uu___106_15433.FStar_TypeChecker_Env.is_iface);
                          FStar_TypeChecker_Env.admit =
                            (uu___106_15433.FStar_TypeChecker_Env.admit);
                          FStar_TypeChecker_Env.lax =
                            (uu___106_15433.FStar_TypeChecker_Env.lax);
                          FStar_TypeChecker_Env.lax_universes =
                            (uu___106_15433.FStar_TypeChecker_Env.lax_universes);
                          FStar_TypeChecker_Env.failhard =
                            (uu___106_15433.FStar_TypeChecker_Env.failhard);
                          FStar_TypeChecker_Env.nosynth =
                            (uu___106_15433.FStar_TypeChecker_Env.nosynth);
                          FStar_TypeChecker_Env.tc_term =
                            (uu___106_15433.FStar_TypeChecker_Env.tc_term);
                          FStar_TypeChecker_Env.type_of =
                            (uu___106_15433.FStar_TypeChecker_Env.type_of);
                          FStar_TypeChecker_Env.universe_of =
                            (uu___106_15433.FStar_TypeChecker_Env.universe_of);
                          FStar_TypeChecker_Env.use_bv_sorts =
                            (uu___106_15433.FStar_TypeChecker_Env.use_bv_sorts);
                          FStar_TypeChecker_Env.qname_and_index =
                            (uu___106_15433.FStar_TypeChecker_Env.qname_and_index);
                          FStar_TypeChecker_Env.proof_ns =
                            (uu___106_15433.FStar_TypeChecker_Env.proof_ns);
                          FStar_TypeChecker_Env.synth =
                            (uu___106_15433.FStar_TypeChecker_Env.synth);
                          FStar_TypeChecker_Env.is_native_tactic =
                            (uu___106_15433.FStar_TypeChecker_Env.is_native_tactic);
                          FStar_TypeChecker_Env.identifier_info =
                            (uu___106_15433.FStar_TypeChecker_Env.identifier_info);
                          FStar_TypeChecker_Env.tc_hooks =
                            (uu___106_15433.FStar_TypeChecker_Env.tc_hooks);
                          FStar_TypeChecker_Env.dsenv =
                            (uu___106_15433.FStar_TypeChecker_Env.dsenv);
                          FStar_TypeChecker_Env.dep_graph =
                            (uu___106_15433.FStar_TypeChecker_Env.dep_graph)
                        }) e11 in
                         ...
                         FStar_TypeChecker_Util.strengthen_precondition
                           (FStar_Pervasives_Native.Some
                              (fun uu____15456  ->
                                 FStar_Util.return_all
                                   FStar_TypeChecker_Err.ill_kinded_type))
                           uu____15452 e12 c1 wf_annot in
                            ...
                            ((let uu____15471 =
                              ...
                              then
                                ...
                                FStar_Util.print3
                                  ...
                                  uu____15472 uu____15473 uu____15474
                              else ());
             ...
             | (univ_opening,univ_vars1) ->
                 ...
                 then
                   ...
                   ((FStar_Pervasives_Native.Some t1),
                     FStar_TypeChecker_Rel.trivial_guard, univ_vars1,
                     univ_opening, uu____15597)
                 else
                   (let uu____15605 = FStar_Syntax_Util.type_u () in
                    match uu____15605 with
                    | (k,uu____15625) ->
                        let uu____15626 = tc_check_tot_or_gtot_term env1 t1 k in
                             ...
                             ((let uu____15651 =
                               ...
                               then
                                 let uu____15652 =
                                   let uu____15653 =
                                     FStar_Syntax_Syntax.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname in
                                   FStar_Range.string_of_range uu____15653 in
                                 let uu____15654 =
                                   FStar_Syntax_Print.term_to_string t2 in
                                 FStar_Util.print2
                                   "(%s) Checked type annotation %s\n"
                                   uu____15652 uu____15654
                               else ());
                              (let t3 = norm env1 t2 in
                               ...
                               ((FStar_Pervasives_Native.Some t3), g,
                                 univ_vars1, univ_opening, uu____15657))))))
and tc_binder:
  FStar_TypeChecker_Env.env ->
          ...
          (match uu____15684 with
           | (tu,u) ->
               ((let uu____15704 =
                 ...
                 if uu____15704
                 then
                   let uu____15705 = FStar_Syntax_Print.bv_to_string x in
                   let uu____15706 =
                     FStar_Syntax_Print.term_to_string
                       x.FStar_Syntax_Syntax.sort in
                   let uu____15707 = FStar_Syntax_Print.term_to_string tu in
                ...
                (let uu____15709 =
                 ...
                 | (t,uu____15729,g) ->
                     let x1 =
                       ((let uu___107_15737 = x in
                         {
                           FStar_Syntax_Syntax.ppname =
                             (uu___107_15737.FStar_Syntax_Syntax.ppname);
                           FStar_Syntax_Syntax.index =
                             (uu___107_15737.FStar_Syntax_Syntax.index);
                           FStar_Syntax_Syntax.sort = t
                         }), imp) in
                     ((let uu____15739 =
                         FStar_TypeChecker_Env.debug env FStar_Options.High in
                      ...
                      (let uu____15743 = push_binding env x1 in
                       (x1, uu____15743, g, u))))))
and tc_binders:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.binders ->
  ...
  fun env  ->
    fun bs  ->
      let rec aux env1 bs1 =
        ...
        | b::bs2 ->
            let uu____15833 = tc_binder env1 b in
            (match uu____15833 with
             | (b1,env',g,u) ->
                 let uu____15874 = aux env' bs2 in
                 (match uu____15874 with
                  | (bs3,env'1,g',us) ->
                      let uu____15927 =
                        let uu____15928 =
                          FStar_TypeChecker_Rel.close_guard_univs [u] [b1] g' in
                        FStar_TypeChecker_Rel.conj_guard g uu____15928 in
                      ((b1 :: bs3), env'1, uu____15927, (u :: us)))) in
      aux env bs
and tc_pats:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax,FStar_Syntax_Syntax.aqual)
        ...
        FStar_List.fold_right
          (fun uu____16013  ->
             fun uu____16014  ->
               ...
               | ((t,imp),(args1,g)) ->
                   let uu____16083 = tc_term env1 t in
                   (match uu____16083 with
                    | (t1,uu____16101,g') ->
                        let uu____16103 =
                          FStar_TypeChecker_Rel.conj_guard g g' in
                        (((t1, imp) :: args1), uu____16103))) args
          ([], FStar_TypeChecker_Rel.trivial_guard) in
      FStar_List.fold_right
        (fun p  ->
           fun uu____16145  ->
             ...
             | (pats1,g) ->
                 let uu____16170 = tc_args env p in
                 (match uu____16170 with
                  | (args,g') ->
                      let uu____16183 = FStar_TypeChecker_Rel.conj_guard g g' in
                      ((args :: pats1), uu____16183))) pats
        ([], FStar_TypeChecker_Rel.trivial_guard)
and tc_tot_or_gtot_term:
  ...
  fun env  ->
    fun e  ->
      let uu____16196 = tc_maybe_toplevel_term env e in
      match uu____16196 with
      | (e1,c,g) ->
          let uu____16212 = FStar_Syntax_Util.is_tot_or_gtot_lcomp c in
          if uu____16212
          then (e1, c, g)
          else
                      ...
                      then
                        let uu____16266 =
                          FStar_TypeChecker_Err.expected_ghost_expression e1
                            c2 in
                        FStar_Errors.raise_error uu____16266
                          e1.FStar_Syntax_Syntax.pos
                      else
                        (let uu____16278 =
                           FStar_TypeChecker_Err.expected_pure_expression e1
                             c2 in
                         FStar_Errors.raise_error uu____16278
                           e1.FStar_Syntax_Syntax.pos)))
...
and tc_trivial_guard:
  ...
  fun env  ->
    fun t  ->
      let uu____16301 = tc_tot_or_gtot_term env t in
  ...
  fun env  ->
    fun e  ->
      (let uu____16329 =
       ...
       if uu____16329
       then
         let uu____16330 = FStar_Syntax_Print.term_to_string e in
         FStar_Util.print1 "Checking term %s\n" uu____16330
       else ());
      (let env1 =
         let uu___108_16333 = env in
         {
           FStar_TypeChecker_Env.solver =
             (uu___108_16333.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___108_16333.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___108_16333.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___108_16333.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___108_16333.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___108_16333.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___108_16333.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___108_16333.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.is_pattern =
             (uu___108_16333.FStar_TypeChecker_Env.is_pattern);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___108_16333.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___108_16333.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___108_16333.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs = [];
           FStar_TypeChecker_Env.top_level = false;
           FStar_TypeChecker_Env.check_uvars =
             (uu___108_16333.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___108_16333.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.is_iface =
             (uu___108_16333.FStar_TypeChecker_Env.is_iface);
           FStar_TypeChecker_Env.admit =
             (uu___108_16333.FStar_TypeChecker_Env.admit);
           FStar_TypeChecker_Env.lax =
             (uu___108_16333.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___108_16333.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.failhard =
             (uu___108_16333.FStar_TypeChecker_Env.failhard);
           FStar_TypeChecker_Env.nosynth =
             (uu___108_16333.FStar_TypeChecker_Env.nosynth);
           FStar_TypeChecker_Env.tc_term =
             (uu___108_16333.FStar_TypeChecker_Env.tc_term);
           FStar_TypeChecker_Env.type_of =
             (uu___108_16333.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___108_16333.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___108_16333.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qname_and_index =
             (uu___108_16333.FStar_TypeChecker_Env.qname_and_index);
           FStar_TypeChecker_Env.proof_ns =
             (uu___108_16333.FStar_TypeChecker_Env.proof_ns);
           FStar_TypeChecker_Env.synth =
             (uu___108_16333.FStar_TypeChecker_Env.synth);
           FStar_TypeChecker_Env.is_native_tactic =
             (uu___108_16333.FStar_TypeChecker_Env.is_native_tactic);
           FStar_TypeChecker_Env.identifier_info =
             (uu___108_16333.FStar_TypeChecker_Env.identifier_info);
           FStar_TypeChecker_Env.tc_hooks =
             (uu___108_16333.FStar_TypeChecker_Env.tc_hooks);
           FStar_TypeChecker_Env.dsenv =
             (uu___108_16333.FStar_TypeChecker_Env.dsenv);
           FStar_TypeChecker_Env.dep_graph =
             (uu___108_16333.FStar_TypeChecker_Env.dep_graph)
         } in
       let uu____16340 =
         try tc_tot_or_gtot_term env1 e
         with
         | FStar_Errors.Error (e1,msg,uu____16375) ->
             let uu____16376 = FStar_TypeChecker_Env.get_range env1 in
             FStar_Errors.raise_error (e1, msg) uu____16376 in
       match uu____16340 with
       | (t,c,g) ->
           let uu____16392 = FStar_Syntax_Util.is_total_lcomp c in
           if uu____16392
           then (t, (c.FStar_Syntax_Syntax.res_typ), g)
           else
             (let uu____16402 =
                let uu____16407 =
                  let uu____16408 = FStar_Syntax_Print.term_to_string e in
                  FStar_Util.format1
                    "Implicit argument: Expected a total term; got a ghost term: %s"
                    uu____16408 in
                (FStar_Errors.Fatal_UnexpectedImplictArgument, uu____16407) in
              let uu____16409 = FStar_TypeChecker_Env.get_range env1 in
              FStar_Errors.raise_error uu____16402 uu____16409))
let level_of_type_fail:
  'Auu____16420 .
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.term -> Prims.string -> 'Auu____16420
  =
  fun env  ->
    fun e  ->
      fun t  ->
        let uu____16433 =
          let uu____16438 =
            let uu____16439 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format2 "Expected a term of type 'Type'; got %s : %s"
              uu____16439 t in
          (FStar_Errors.Fatal_UnexpectedTermType, uu____16438) in
        let uu____16440 = FStar_TypeChecker_Env.get_range env in
        FStar_Errors.raise_error uu____16433 uu____16440
let level_of_type:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
    ...
    fun e  ->
      fun t  ->
        let rec aux retry t1 =
          let uu____16457 =
            let uu____16458 = FStar_Syntax_Util.unrefine t1 in
          ...
          | uu____16462 ->
              ...
              then
                ...
                (let uu____16465 = FStar_Syntax_Util.type_u () in
                 match uu____16465 with
                 | (t_u,u) ->
                     let env1 =
                       let uu___111_16473 = env in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___111_16473.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___111_16473.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___111_16473.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___111_16473.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___111_16473.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___111_16473.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___111_16473.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___111_16473.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___111_16473.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___111_16473.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___111_16473.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize =
                           (uu___111_16473.FStar_TypeChecker_Env.generalize);
                         FStar_TypeChecker_Env.letrecs =
                           (uu___111_16473.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level =
                           (uu___111_16473.FStar_TypeChecker_Env.top_level);
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___111_16473.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___111_16473.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___111_16473.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___111_16473.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax = true;
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___111_16473.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.failhard =
                           (uu___111_16473.FStar_TypeChecker_Env.failhard);
                         FStar_TypeChecker_Env.nosynth =
                           (uu___111_16473.FStar_TypeChecker_Env.nosynth);
                         FStar_TypeChecker_Env.tc_term =
                           (uu___111_16473.FStar_TypeChecker_Env.tc_term);
                         FStar_TypeChecker_Env.type_of =
                           (uu___111_16473.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___111_16473.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.use_bv_sorts =
                           (uu___111_16473.FStar_TypeChecker_Env.use_bv_sorts);
                         FStar_TypeChecker_Env.qname_and_index =
                           (uu___111_16473.FStar_TypeChecker_Env.qname_and_index);
                         FStar_TypeChecker_Env.proof_ns =
                           (uu___111_16473.FStar_TypeChecker_Env.proof_ns);
                         FStar_TypeChecker_Env.synth =
                           (uu___111_16473.FStar_TypeChecker_Env.synth);
                         FStar_TypeChecker_Env.is_native_tactic =
                           (uu___111_16473.FStar_TypeChecker_Env.is_native_tactic);
                         FStar_TypeChecker_Env.identifier_info =
                           (uu___111_16473.FStar_TypeChecker_Env.identifier_info);
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___111_16473.FStar_TypeChecker_Env.tc_hooks);
                         FStar_TypeChecker_Env.dsenv =
                           (uu___111_16473.FStar_TypeChecker_Env.dsenv);
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___111_16473.FStar_TypeChecker_Env.dep_graph)
                       } in
                     ...
                     ((match g.FStar_TypeChecker_Env.guard_f with
                       | FStar_TypeChecker_Common.NonTrivial f ->
                           let uu____16477 =
                             FStar_Syntax_Print.term_to_string t1 in
                           level_of_type_fail env1 e uu____16477
                       | uu____16478 ->
...
let rec universe_of_aux:
  ...
  fun env  ->
    fun e  ->
      let uu____16487 =
        let uu____16488 = FStar_Syntax_Subst.compress e in
        uu____16488.FStar_Syntax_Syntax.n in
      match uu____16487 with
      | FStar_Syntax_Syntax.Tm_bvar uu____16493 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_unknown  -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_delayed uu____16498 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_let uu____16525 ->
          let e1 = FStar_TypeChecker_Normalize.normalize [] env e in
          universe_of_aux env e1
      | FStar_Syntax_Syntax.Tm_abs (bs,t,uu____16541) ->
          level_of_type_fail env e "arrow type"
      | FStar_Syntax_Syntax.Tm_uvar (uu____16564,t) -> t
      | FStar_Syntax_Syntax.Tm_meta (t,uu____16591) -> universe_of_aux env t
      | FStar_Syntax_Syntax.Tm_name n1 -> n1.FStar_Syntax_Syntax.sort
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let uu____16598 =
            FStar_TypeChecker_Env.lookup_lid env
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
          (match uu____16598 with | ((uu____16609,t),uu____16611) -> t)
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____16616,(FStar_Util.Inl t,uu____16618),uu____16619) -> t
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____16666,(FStar_Util.Inr c,uu____16668),uu____16669) ->
          FStar_Syntax_Util.comp_result c
      | FStar_Syntax_Syntax.Tm_type u ->
          FStar_Syntax_Syntax.mk
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu____16720;_},us)
          ->
          let uu____16726 =
            FStar_TypeChecker_Env.lookup_lid env
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                  ...
                  FStar_List.iter2
                    (fun u'  ->
                       fun u  ->
                         ...
                         | FStar_Syntax_Syntax.U_unif u'' ->
                             FStar_Syntax_Unionfind.univ_change u'' u
                         | uu____16761 -> failwith "Impossible") us' us;
                t))
      | FStar_Syntax_Syntax.Tm_uinst uu____16762 ->
          failwith "Impossible: Tm_uinst's head must be an fvar"
      | FStar_Syntax_Syntax.Tm_refine (x,uu____16772) ->
          universe_of_aux env x.FStar_Syntax_Syntax.sort
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____16795 = FStar_Syntax_Subst.open_comp bs c in
          (match uu____16795 with
           | (bs1,c1) ->
               ...
               let u_res =
                 ...
                 let uu____16827 = universe_of_aux env res in
                 level_of_type env res uu____16827 in
               let u_c =
                 let uu____16829 =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     let uu____16833 = universe_of_aux env trepr in
                     level_of_type env trepr uu____16833 in
               let u =
      ...
      | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
          let rec type_of_head retry hd2 args1 =
            ...
            | FStar_Syntax_Syntax.Tm_unknown  -> failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_bvar uu____16926 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_delayed uu____16941 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_fvar uu____16980 ->
                let uu____16981 = universe_of_aux env hd3 in
                (uu____16981, args1)
            | FStar_Syntax_Syntax.Tm_name uu____16994 ->
                let uu____16995 = universe_of_aux env hd3 in
                (uu____16995, args1)
            | FStar_Syntax_Syntax.Tm_uvar uu____17008 ->
                let uu____17025 = universe_of_aux env hd3 in
                (uu____17025, args1)
            | FStar_Syntax_Syntax.Tm_uinst uu____17038 ->
                let uu____17045 = universe_of_aux env hd3 in
                (uu____17045, args1)
            | FStar_Syntax_Syntax.Tm_ascribed uu____17058 ->
                let uu____17085 = universe_of_aux env hd3 in
                (uu____17085, args1)
            | FStar_Syntax_Syntax.Tm_refine uu____17098 ->
                let uu____17105 = universe_of_aux env hd3 in
                (uu____17105, args1)
            | FStar_Syntax_Syntax.Tm_constant uu____17118 ->
                let uu____17119 = universe_of_aux env hd3 in
                (uu____17119, args1)
            | FStar_Syntax_Syntax.Tm_arrow uu____17132 ->
                let uu____17145 = universe_of_aux env hd3 in
                (uu____17145, args1)
            | FStar_Syntax_Syntax.Tm_meta uu____17158 ->
                let uu____17165 = universe_of_aux env hd3 in
                (uu____17165, args1)
            | FStar_Syntax_Syntax.Tm_type uu____17178 ->
                let uu____17179 = universe_of_aux env hd3 in
                (uu____17179, args1)
            | FStar_Syntax_Syntax.Tm_match (uu____17192,hd4::uu____17194) ->
                let uu____17259 = FStar_Syntax_Subst.open_branch hd4 in
                (match uu____17259 with
                 | (uu____17274,uu____17275,hd5) ->
                     let uu____17293 = FStar_Syntax_Util.head_and_args hd5 in
                     (match uu____17293 with
                      | (hd6,args2) -> type_of_head retry hd6 args2))
            | uu____17344 when retry ->
                let e1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.NoDeltaSteps] env e in
                let uu____17346 = FStar_Syntax_Util.head_and_args e1 in
            ...
            | uu____17397 ->
                ...
                (match uu____17398 with
                 | (env1,uu____17420) ->
                     let env2 =
                       let uu___112_17426 = env1 in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___112_17426.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___112_17426.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___112_17426.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___112_17426.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___112_17426.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___112_17426.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___112_17426.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___112_17426.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___112_17426.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___112_17426.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___112_17426.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize =
                           (uu___112_17426.FStar_TypeChecker_Env.generalize);
                         FStar_TypeChecker_Env.letrecs =
                           (uu___112_17426.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level = false;
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___112_17426.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___112_17426.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___112_17426.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___112_17426.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax = true;
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___112_17426.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.failhard =
                           (uu___112_17426.FStar_TypeChecker_Env.failhard);
                         FStar_TypeChecker_Env.nosynth =
                           (uu___112_17426.FStar_TypeChecker_Env.nosynth);
                         FStar_TypeChecker_Env.tc_term =
                           (uu___112_17426.FStar_TypeChecker_Env.tc_term);
                         FStar_TypeChecker_Env.type_of =
                           (uu___112_17426.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___112_17426.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.use_bv_sorts = true;
                         FStar_TypeChecker_Env.qname_and_index =
                           (uu___112_17426.FStar_TypeChecker_Env.qname_and_index);
                         FStar_TypeChecker_Env.proof_ns =
                           (uu___112_17426.FStar_TypeChecker_Env.proof_ns);
                         FStar_TypeChecker_Env.synth =
                           (uu___112_17426.FStar_TypeChecker_Env.synth);
                         FStar_TypeChecker_Env.is_native_tactic =
                           (uu___112_17426.FStar_TypeChecker_Env.is_native_tactic);
                         FStar_TypeChecker_Env.identifier_info =
                           (uu___112_17426.FStar_TypeChecker_Env.identifier_info);
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___112_17426.FStar_TypeChecker_Env.tc_hooks);
                         FStar_TypeChecker_Env.dsenv =
                           (uu___112_17426.FStar_TypeChecker_Env.dsenv);
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___112_17426.FStar_TypeChecker_Env.dep_graph)
                       } in
                     ((let uu____17428 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
                       ...
                       then
                         let uu____17429 =
                           ...
                           FStar_Range.string_of_range uu____17430 in
                         let uu____17431 =
                           FStar_Syntax_Print.term_to_string hd3 in
                         FStar_Util.print2 "%s: About to type-check %s\n"
                           uu____17429 uu____17431
                       else ());
                      (let uu____17433 = tc_term env2 hd3 in
                       ...
                       | (uu____17454,{
                           ...
                           ((let uu____17469 =
                               FStar_TypeChecker_Rel.solve_deferred_constraints
                                 env2 g in
                             FStar_All.pipe_right uu____17469
                               FStar_Pervasives.ignore);
                            (t, args1))))) in
          let uu____17480 = type_of_head true hd1 args in
          (match uu____17480 with
           | (t,args1) ->
               ...
               let uu____17520 = FStar_Syntax_Util.arrow_formals_comp t1 in
                ...
                | (bs,res) ->
                    ...
                    then
                      ...
                      (let uu____17564 =
                       ...
                       level_of_type_fail env e uu____17564)))
      | FStar_Syntax_Syntax.Tm_match (uu____17567,hd1::uu____17569) ->
          let uu____17634 = FStar_Syntax_Subst.open_branch hd1 in
          (match uu____17634 with
           | (uu____17637,uu____17638,hd2) -> universe_of_aux env hd2)
      | FStar_Syntax_Syntax.Tm_match (uu____17656,[]) ->
...
let universe_of:
  ...
  fun env  ->
    fun e  ->
      let uu____17699 = universe_of_aux env e in
      level_of_type env e uu____17699
let tc_tparams:
  FStar_TypeChecker_Env.env_t ->
    FStar_Syntax_Syntax.binders ->
  ...
  fun env  ->
    fun tps  ->
      let uu____17718 = tc_binders env tps in
