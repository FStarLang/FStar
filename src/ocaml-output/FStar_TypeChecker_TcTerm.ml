              ...
              | FStar_Pervasives_Native.None ->
                  let uu___2 =
                    let uu___3 =
                      ...
                      let uu___5 =
                        let uu___6 = FStar_Parser_Const.effect_ALL_lid () in
                    ...
                    let uu___4 =
                      let uu___5 =
                        ...
                        uu___6 && env.FStar_TypeChecker_Env.lax in
                      let uu___6 =
                        let uu___7 =
...
let (print_expected_ty : FStar_TypeChecker_Env.env -> unit) =
  fun env ->
    ...
    match uu___ with
    | FStar_Pervasives_Native.None ->
        FStar_Compiler_Util.print_string "Expected type is None\n"
    | FStar_Pervasives_Native.Some t ->
        let uu___1 = FStar_Syntax_Print.term_to_string t in
        FStar_Compiler_Util.print1 "Expected type is %s" uu___1
                      ...
                      (let uu___2 =
                       ...
                       | (FStar_Syntax_Syntax.Tm_app (h1, args1),
                          FStar_Syntax_Syntax.Tm_app (h2, args2)) ->
                           let uu___3 =
                             let uu___4 = warn h1 h2 in
                             uu___4 ||
                               ((FStar_Compiler_List.length args1) <>
                                  (FStar_Compiler_List.length args2)) in
                           let uu___4 =
                             let uu___5 = FStar_Compiler_List.zip args1 args2 in
                          ...
                          FStar_Syntax_Syntax.Tm_refine (t22, phi2)) ->
                           let uu___3 =
                             warn t12.FStar_Syntax_Syntax.sort
                               t22.FStar_Syntax_Syntax.sort in
                           let uu___4 = warn phi1 phi2 in uu___3 || uu___4
    ...
    fun e ->
      ...
      (match top.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_app
           ...
           let uu___1 = FStar_Syntax_Util.is_synth_by_tactic head in
           uu___1 && (Prims.op_Negation env1.FStar_TypeChecker_Env.phase1) ->
           ...
           (head,
            (uu___1, FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Implicit uu___2))::(tau,
                                                      FStar_Pervasives_Native.None)::[])
           when
           let uu___3 = FStar_Syntax_Util.is_synth_by_tactic head in
           uu___3 && (Prims.op_Negation env1.FStar_TypeChecker_Env.phase1) ->
           let uu___3 = FStar_Syntax_Util.head_and_args top in
           (match uu___3 with
            | (head1, args) ->
                tc_synth head1 env1 args top.FStar_Syntax_Syntax.pos)
          ...
          let uu___1 =
            let uu___2 =
              let uu___3 =
                ...
                FStar_Compiler_Effect.op_Bar_Greater uu___4
                  FStar_Pervasives_Native.fst in
              FStar_Compiler_Effect.op_Bar_Greater uu___3 instantiate_both in
                             ...
                             | FStar_Pervasives_Native.Some uu___5 ->
                                 let uu___6 =
                                   let uu___7 =
                                     let uu___8 =
                                       FStar_Compiler_Effect.op_Bar_Greater
                                         e12 FStar_Syntax_Util.unascribe in
                                     FStar_Compiler_Effect.op_Bar_Greater
                                               ...
                                               (FStar_Compiler_List.map
                                                  (fun uu___9 ->
                                                     ...
                                                     | (uu___10, f, uu___11,
                                                        ...
                                                        uu___14) -> (f, g2))) in
                                           FStar_Compiler_Effect.op_Bar_Greater
                                             uu___8 FStar_Compiler_List.unzip in
                                         (match uu___7 with
                                          | (fmls, gs) ->
                                              let uu___8 =
  ...
  fun env ->
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ...
          when
          let uu___3 =
            FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.synth_lid in
          uu___3 && (Prims.op_Negation env1.FStar_TypeChecker_Env.phase1) ->
          let uu___3 = FStar_TypeChecker_Env.get_range env1 in
          FStar_Errors.raise_error
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu___ =
            FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.synth_lid in
          uu___ && (Prims.op_Negation env1.FStar_TypeChecker_Env.phase1) ->
    ...
    fun u ->
      let rec aux u1 =
        ...
        | FStar_Syntax_Syntax.U_name x ->
            let uu___ =
              let uu___1 = FStar_TypeChecker_Env.lookup_univ env x in
              env.FStar_TypeChecker_Env.use_bv_sorts || uu___1 in
            if uu___
            then u2
            else
              (let uu___2 =
               ...
               | ({ FStar_Syntax_Syntax.binder_bv = hd;
                  ...
                  { FStar_Syntax_Syntax.binder_bv = hd_expected;
                   ...
                   ((let special q1 q2 =
                     ...
                     let uu___2 =
                       let uu___3 =
                         let uu___4 = FStar_Syntax_Util.eq_aqual imp imp' in
                         uu___4 <> FStar_Syntax_Util.Equal in
                       (Prims.op_Negation (special imp imp')) && uu___3 in
                     if uu___2
                     then
                       let uu___3 =
                         let uu___4 =
                          ...
                          let uu___7 =
                            ...
                            let uu___9 =
                              ...
                              | FStar_Syntax_Syntax.Tm_app (head, args) when
                                  ...
                                  (match uu___11 with
                                   | FStar_Syntax_Syntax.Tm_constant
                                       (FStar_Const.Const_reflect uu___12) ->
                                       true
                                   | uu___12 -> false)
                              | uu___11 -> false in
                            uu___8 && uu___9 in
                          ...
                          let guard =
                            let uu___6 =
                              let uu___7 =
                                ...
                                Prims.op_Negation uu___8 in
                              env1.FStar_TypeChecker_Env.top_level || uu___7 in
                            if uu___6
                            then
                              let uu___7 =
                                                   ...
                                                   (let warn_effectful_args =
                                                      let uu___12 =
                                                        FStar_TypeChecker_Util.must_erase_for_extraction
                                                          env
                                                          chead2.FStar_TypeChecker_Common.res_typ in
                                                      let uu___13 =
                                                        let uu___14 =
                                                          let uu___15 =
                                                            let uu___16 =
                                             ...
                                             let uu___9 =
                                               let uu___10 =
                                                 ...
                                                 (uu___11,
                                                   FStar_Pervasives_Native.None,
                                                   chead2) in
                                               uu___10 :: arg_comps_rev in
                                             FStar_Compiler_List.map map_fun
                                               uu___9 in
                                           FStar_Compiler_Effect.op_Less_Bar
                             ...
                             | (targ1, g_ex) ->
                                 ...
                                 ((let uu___7 =
                                  ...
                                  (let uu___7 = tc_term env2 e in
                                   ...
                                   | (e1, c, g_e) ->
                                       ((let uu___9 =
                                           let uu___10 = head_info in
                                           match uu___10 with
                                           | (head1, uu___11, uu___12,
                                              uu___13) ->
                                               let uu___14 =
                                                 let uu___15 =
                                        ...
                                        (let g1 =
                                         ...
                                         then
                                           let subst1 =
                                             ...
                                             maybe_extend_subst subst uu___10
                                               e1 in
                                           tc_args head_info
                                             (subst1,
                                               ((arg,
                         ...
                         (let uu___6 =
                          ...
                          | (comp1, g_comp1) ->
                              (FStar_TypeChecker_Rel.force_trivial_guard env1
                                 g_comp1;
                               (let c =
                                  FStar_Compiler_Effect.op_Bar_Greater comp1
                          ...
                          (let e12 =
                           ...
                           (let cres =
                              ...
                              then
                                ...
                                (let c1_comp_typ =
                                   FStar_Compiler_Effect.op_Bar_Greater c12
                     ...
                     let uu___5 =
                       let uu___6 =
                         FStar_TypeChecker_Env.is_erasable_effect env2
                           c1.FStar_TypeChecker_Common.eff_name in
                       pure_or_ghost || uu___6 in
                     Prims.op_Negation uu___5 in
                   is_inline_let && uu___4 in
                 if uu___3
                 then
                   let uu___4 =
                     let uu___5 =
                              ...
                              let add_inline_let =
                                let uu___5 =
                                  ...
                                  let uu___7 =
                                    ...
                                    uu___8 && uu___9 in
                                  uu___6 || uu___7 in
                                (Prims.op_Negation is_inline_let) && uu___5 in
                              if add_inline_let
                              then FStar_Syntax_Util.inline_let_attr ::
                                (lb.FStar_Syntax_Syntax.lbattrs)
      ...
      fun must_tot ->
        let mk_tm_type u =
          FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type u)
            t.FStar_Syntax_Syntax.pos in
        let effect_ok k =
          let uu___ = FStar_TypeChecker_Normalize.non_info_norm env k in
          (Prims.op_Negation must_tot) || uu___ in
        let t1 = FStar_Syntax_Subst.compress t in
        match t1.FStar_Syntax_Syntax.n with
        ...
        | FStar_Syntax_Syntax.Tm_app (hd, args) ->
            ...
            let rec aux args1 t_hd1 =
              ...
              match uu___ with
              | FStar_Syntax_Syntax.Tm_arrow (bs, c) ->
                  let n_args = FStar_Compiler_List.length args1 in
                  let n_bs = FStar_Compiler_List.length bs in
                  let bs_t_opt =
                    if n_args < n_bs
                    then
                      let uu___1 = FStar_Compiler_Util.first_N n_args bs in
                      match uu___1 with
                      | (bs1, rest) ->
                          let t2 =
                            FStar_Syntax_Syntax.mk
                      ...
                      (let uu___2 = FStar_Syntax_Subst.open_comp bs c in
                       ...
                       | (bs1, c1) ->
                           let uu___3 =
                             FStar_Compiler_List.splitAt n_bs args1 in
                           (match uu___3 with
                            | (args2, remaining_args) ->
                                FStar_Pervasives_Native.Some
                                  (bs1, args2,
                                    (FStar_Syntax_Util.comp_result c1),
                                    remaining_args))) in
                  FStar_Compiler_Util.bind_opt bs_t_opt
                    (fun uu___1 ->
                       match uu___1 with
                       | (bs1, args2, t2, remaining_args) ->
                           ...
                           if
                             (FStar_Compiler_List.length remaining_args) =
                               Prims.int_zero
                               ...
                               | (a, uu___5) ->
                                   let uu___6 =
                                     typeof_tot_or_gtot_term_fastpath env a
                                       must_tot in
                                   FStar_Compiler_Effect.op_Bar_Greater
                                     uu___6 FStar_Compiler_Util.is_some) args in
                        uu___2 || uu___3 in
                      if uu___1
        ...
        | FStar_Syntax_Syntax.Tm_ascribed
            ...
            let uu___3 =
              let uu___4 =
                ...
                (Prims.op_Negation must_tot) || uu___5 in
              let uu___5 = FStar_TypeChecker_Normalize.non_info_norm env k in
              uu___4 || uu___5 in
            if uu___3
            then FStar_Pervasives_Native.Some k
            else FStar_Pervasives_Native.None
  ...
  fun env ->
    fun t ->
          ...
          let join_effects eff1 eff2 =
            ...
            | (eff11, eff21) ->
                ...
                (match uu___2 with
                 | (pure, ghost) ->
                     let uu___3 =
                       let uu___4 = FStar_Ident.lid_equals eff11 pure in
                       let uu___5 = FStar_Ident.lid_equals eff21 pure in
                       uu___4 && uu___5 in
                     if uu___3
                     then FStar_Pervasives_Native.Some pure
                       ...
                       (let uu___5 =
                          let uu___6 =
                            let uu___7 = FStar_Ident.lid_equals eff11 ghost in
                            let uu___8 = FStar_Ident.lid_equals eff11 pure in
                            uu___7 || uu___8 in
                          let uu___7 =
                            let uu___8 = FStar_Ident.lid_equals eff21 ghost in
                            let uu___9 = FStar_Ident.lid_equals eff21 pure in
                            uu___8 || uu___9 in
                          uu___6 && uu___7 in
                        if uu___5
      ...
      | FStar_Syntax_Syntax.Tm_ascribed
          ...
          let uu___4 =
            let uu___5 =
              FStar_Ident.lid_equals c_eff FStar_Parser_Const.effect_PURE_lid in
            let uu___6 =
