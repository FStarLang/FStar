                  ...
                  let t1 =
                    let uu___ =
                      FStar_All.pipe_right e1
                        (FStar_TypeChecker_Env.tc_tot_or_gtot_term_maybe_fastpath
                           env2) in
                         ...
                         let mk_letrec_env envbody bs1 c =
                           ...
                           let envbody1 =
                             let uu___2 = envbody in
                             {
                               ...
                               FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                 =
                                 (uu___2.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                               FStar_TypeChecker_Env.universeof_well_typed_term
                                 =
                                 (uu___2.FStar_TypeChecker_Env.universeof_well_typed_term);
                               FStar_TypeChecker_Env.use_bv_sorts =
                                ...
                                (let uu___8 = envbody2 in
                                 {
                                   ...
                                   FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                     =
                                     (uu___8.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                   FStar_TypeChecker_Env.universeof_well_typed_term
                                     =
                                     (uu___8.FStar_TypeChecker_Env.universeof_well_typed_term);
                                   FStar_TypeChecker_Env.use_bv_sorts =
                                            ...
                                            (let uu___10 = envbody2 in
                                             {
                                               ...
                                               FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                                 =
                                                 (uu___10.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                               FStar_TypeChecker_Env.universeof_well_typed_term
                                                 =
                                                 (uu___10.FStar_TypeChecker_Env.universeof_well_typed_term);
                                               FStar_TypeChecker_Env.use_bv_sorts
                                                 =
                                                          ...
                                                          let pat_bv_tms2 =
                                                            let env1 =
                                                                  ...
                                                                  scrutinee in
                                                              {
                                                                ...
                                                                FStar_TypeChecker_Env.typeof_tot_or_gtot_term
                                                                  =
                                                                  (uu___15.FStar_TypeChecker_Env.typeof_tot_or_gtot_term);
                                                                FStar_TypeChecker_Env.universe_of
                                                                  =
                                                                  (uu___15.FStar_TypeChecker_Env.universe_of);
                                                                FStar_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term
                                                                  =
                                                                  (uu___15.FStar_TypeChecker_Env.typeof_well_typed_tot_or_gtot_term);
                                                                FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                                                  =
                                                                  (uu___15.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                                                FStar_TypeChecker_Env.universeof_well_typed_term
                                                                  =
                                                                  (uu___15.FStar_TypeChecker_Env.universeof_well_typed_term);
                                                                FStar_TypeChecker_Env.use_bv_sorts
                                                                  =
                                   ...
                                   (let uu___7 = env01 in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                        =
                                        (uu___7.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                      FStar_TypeChecker_Env.universeof_well_typed_term
                                        =
                                        (uu___7.FStar_TypeChecker_Env.universeof_well_typed_term);
                                      FStar_TypeChecker_Env.use_bv_sorts =
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_lazy i ->
          ...
          typeof_tot_or_gtot_term_fastpath env uu___
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let uu___ =
                     ...
                     (match uu___1 with
                      | (bs1, body1) ->
                          let uu___2 =
                            ...
                            typeof_tot_or_gtot_term_fastpath uu___3 body1 in
           ...
           | (unary_op, uu___3) ->
               ...
               let t2 =
                 FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_app (head, rest1))
                   t1.FStar_Syntax_Syntax.pos in
               typeof_tot_or_gtot_term_fastpath env t2)
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_set_range_of);
...
and (universeof_fastpath :
  ...
  fun env ->
    fun t ->
      let uu___ = typeof_tot_or_gtot_term_fastpath env t in
      FStar_Util.bind_opt uu___
        (fun k ->
...
let rec (effectof_tot_or_gtot_term_fastpath :
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_app (hd, args) ->
          ...
          FStar_Util.bind_opt uu___1
            (fun eff_hd ->
               ...
               FStar_Util.bind_opt uu___2
                 (fun eff_hd_and_args ->
                    let uu___3 = typeof_tot_or_gtot_term_fastpath env hd in
      ...
      | uu___1 -> FStar_Pervasives_Native.None
let (tc_check_tot_or_gtot_term_maybe_fastpath_aux :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.typ ->
        Prims.bool -> Prims.bool -> unit -> FStar_TypeChecker_Common.guard_t)
  =
  fun env ->
    fun t ->
      fun k ->
            ...
            fun uu___ ->
              ...
              let slow_path reason =
                (let uu___2 =
                 ...
                 then
                   let uu___3 = FStar_Syntax_Print.term_to_string t in
                   let uu___4 = FStar_Syntax_Print.term_to_string k in
                   FStar_Util.print3
                     "Fast check for %s <: %s failed, since %s\n" uu___3
                     uu___4 reason
                 else ());
                (let uu___2 =
              ...
              let continue_fast_path t1 =
                (let uu___1 = FStar_All.pipe_right t1 FStar_Syntax_Free.uvars in
                 FStar_All.pipe_right uu___1 FStar_Util.set_is_empty) &&
                  (let uu___1 =
                     FStar_All.pipe_right t1 FStar_Syntax_Free.univs in
                   FStar_All.pipe_right uu___1 FStar_Util.set_is_empty) in
              let finish_fast_path env2 t1 k' k1 =
                FStar_TypeChecker_Util.check_has_type env2 t1 k' k1 in
              if from_tac
              then
                let uu___1 = typeof_tot_or_gtot_term_fastpath env1 t in
                match uu___1 with
                | FStar_Pervasives_Native.None ->
                    slow_path "could not compute type (from_tac)"
                | FStar_Pervasives_Native.Some k' ->
                    let uu___2 =
                      FStar_TypeChecker_Rel.subtype_nosmt env1 k' k in
                    (match uu___2 with
                     | FStar_Pervasives_Native.None ->
                         slow_path "subtype_nosmt returned None"
                     | FStar_Pervasives_Native.Some g -> g)
              else
                (let uu___2 =
                   ...
                   Prims.op_Negation uu___3 in
                 if uu___2
                 then slow_path "t has uvars"
                 else
                   (let uu___4 =
                      let uu___5 = continue_fast_path k in
                      Prims.op_Negation uu___5 in
                    if uu___4
                    then slow_path "k has uvars"
                    else
                      (let uu___6 = typeof_tot_or_gtot_term_fastpath env1 t in
                       match uu___6 with
                       | FStar_Pervasives_Native.None ->
                           slow_path "could not compute type"
                       | FStar_Pervasives_Native.Some k' ->
                           let uu___7 =
                               ...
                               (let uu___10 =
                                  (Prims.op_Negation must_tot) ||
                                    (FStar_TypeChecker_Normalize.non_info_norm
                                       env1 k) in
                                if uu___10
                                then finish_fast_path env1 t k' k
                                else
                                  (let eff_opt =
                                     effectof_tot_or_gtot_term_fastpath env1
                                       t in
                                   match eff_opt with
                                   | FStar_Pervasives_Native.None ->
                                       slow_path "could not compute effect"
                                   | FStar_Pervasives_Native.Some eff when
                                       FStar_Ident.lid_equals eff
                                         FStar_Parser_Const.effect_PURE_lid
                                       -> finish_fast_path env1 t k' k
                                   | uu___12 ->
                                       let uu___13 =
                                         let uu___14 =
                                           let uu___15 =
...
let (tc_check_tot_or_gtot_term_maybe_fastpath :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.typ ->
              ...
              let uu___1 =
                let uu___2 =
                  FStar_All.pipe_right env
                    FStar_TypeChecker_Env.current_module in
                FStar_All.pipe_right uu___2 FStar_Ident.string_of_lid in
              FStar_All.pipe_right uu___1
                (fun uu___2 -> FStar_Pervasives_Native.Some uu___2) in
            FStar_Profiling.profile
              (tc_check_tot_or_gtot_term_maybe_fastpath_aux env t k must_tot
                 from_tac) uu___ "FStar.TypeChecker.TcTerm.check_implicits"