           ...
           | uu____2529 ->
               ...
               (match uu____2530 with
                | (e2,c,g) ->
                    ...
                    (e3, c, g)))
      | FStar_Syntax_Syntax.Tm_meta
          (e1,FStar_Syntax_Syntax.Meta_monadic uu____2552) -> tc_term env1 e1
      | FStar_Syntax_Syntax.Tm_meta
                         ...
                         (match uu____2709 with
                          | (e3,expected_c2,g'') ->
                              ...
                              let f =
                                ...
                                FStar_TypeChecker_Rel.conj_guard g uu____2769
                                 in
                              let f1 =
                                match topt1 with
                           ...
                           let uu____4297 =
                             ...
                             | (t1,uu____4389,g) ->
                                 ...
                                 (match uu____4391 with
                                  | FStar_Syntax_Syntax.Tm_app
                                      (uu____4407,(res,uu____4409)::(wp,uu____4411)::[])
                                      -> (t1, res, wp, g)
                     ...
                     | (bs2,env3,g,us) ->
                         ...
                         (match uu____6930 with
                          | (c2,uc,f) ->
                              ...
                              let uu____6952 = check_smt_pat env3 e1 bs2 c2
                                 in
                              ...
                              let g1 =
                                let uu____6958 =
                                  FStar_TypeChecker_Rel.close_guard_univs us
                                    bs2 f
                                   in
                                FStar_TypeChecker_Rel.conj_guard g uu____6958
                                 in
                       ...
                       (match uu____8087 with
                        | (t,g1) ->
                            ...
                            let subst2 =
                              ...
                              maybe_extend_subst subst1 b_expected uu____8175
                               in
                ...
                let rec as_function_typ norm1 t2 =
                  ...
                  | FStar_Syntax_Syntax.Tm_uvar uu____8440 ->
                      let uu____8457 =
                        match env1.FStar_TypeChecker_Env.letrecs with
                        | [] -> ()
                        | uu____8464 -> failwith "Impossible"  in
                         ...
                         | (e1,tfun,guard2) ->
                             ...
                             let uu____9945 =
                               ...
                               FStar_TypeChecker_Util.strengthen_precondition
                                 ...
                                 uu____9950 guard2
                                in
                             (match uu____9945 with | (c1,g1) -> (e1, c1, g1)))))
          ...
          fun args  ->
            fun expected_topt  ->
                               ...
                               FStar_List.fold_left
                                 (fun args1  ->
                                    fun uu____10324  ->
                                      ...
                                      | (arg,uu____10338,uu____10339) -> arg
                                          :: args1) [] arg_comps_rev
                                in
                             let app =
                             ...
                             (let uu____10349 =
                                ...
                                | (lifted_args,reverse_args) ->
                                    let uu____10787 =
                                      ...
                                      FStar_Pervasives_Native.fst uu____10788
                                       in
                                    let uu____10797 =
                                      let uu____10804 =
                                        FStar_List.tl reverse_args  in
                                      FStar_List.rev uu____10804  in
                                    (lifted_args, uu____10787, uu____10797)
                                 in
                          ...
                          | (e1,c,g_e) ->
                              ...
                              let xterm =
                                let uu____11624 =
                                  let uu____11627 =
                                    ...
                                    FStar_Syntax_Syntax.as_arg uu____11634
                                     in
                              ...
                              then
                                let subst2 =
                                  ...
                                  maybe_extend_subst subst1 uu____11649 e1
                                   in
                                tc_args head_info
                                  (subst2,
                                    ...
                                    let rec norm_tres tres2 =
                                      ...
                                      | FStar_Syntax_Syntax.Tm_refine
                                          ({
                                             ...
                                             FStar_Syntax_Syntax.index =
                                               uu____11992;
                                             FStar_Syntax_Syntax.sort = tres4;_},uu____11994)
                                          -> norm_tres tres4
              ...
              let rec check_function_app tf =
                ...
                | FStar_Syntax_Syntax.Tm_ascribed (t,uu____12320,uu____12321)
                         ...
                         let x_eq_e1 =
                           let uu____14414 =
                             ...
                             FStar_Syntax_Util.mk_eq2 uu____14415
                               c1.FStar_Syntax_Syntax.res_typ uu____14416 e11
                              in
                           FStar_All.pipe_left
                             (fun _0_19  ->
                             ...
                             let actuals_msg =
                               ...
                               then "1 argument was found"
                                 ...
                                 (let uu____15123 =
                                  ...
                                  FStar_Util.format1
                                    "%s arguments were found" uu____15123)
                                in
                             let formals_msg =
...
and (tc_trivial_guard :
  ...
  fun env  ->
    fun t  ->
      ...
      | (t1,c,g) ->
          let uu____16401 = FStar_TypeChecker_Rel.force_trivial_guard env g
             in
          (t1, c)
...
let (tc_tparams :
  ...
  fun env  ->
    fun tps  ->
      ...
      | (tps1,env1,g,us) ->
          let uu____17880 = FStar_TypeChecker_Rel.force_trivial_guard env1 g
             in
          (tps1, env1, us)
