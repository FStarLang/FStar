                ...
                (let uu___445_3558 = env  in
                 {
                   ...
                   FStar_TypeChecker_Env.try_solve_implicits_hook =
                     (uu___445_3558.FStar_TypeChecker_Env.try_solve_implicits_hook);
                   FStar_TypeChecker_Env.splice =
                         ...
                         (let uu___555_4257 = env'  in
                          {
                            ...
                            FStar_TypeChecker_Env.try_solve_implicits_hook =
                              (uu___555_4257.FStar_TypeChecker_Env.try_solve_implicits_hook);
                            FStar_TypeChecker_Env.splice =
    ...
    fun tau  ->
      let env1 =
        let uu___1223_9442 = env  in
        {
          ...
          FStar_TypeChecker_Env.try_solve_implicits_hook =
            (uu___1223_9442.FStar_TypeChecker_Env.try_solve_implicits_hook);
          FStar_TypeChecker_Env.splice =
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___1772_12907 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.try_solve_implicits_hook
                                   =
                                   (uu___1772_12907.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                 FStar_TypeChecker_Env.splice =
                            ...
                            (let uu___1863_13623 = envbody1  in
                             {
                               ...
                               FStar_TypeChecker_Env.try_solve_implicits_hook
                                 =
                                 (uu___1863_13623.FStar_TypeChecker_Env.try_solve_implicits_hook);
                               FStar_TypeChecker_Env.splice =
                                  ...
                                  (let uu___1871_13665 = envbody1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___1871_13665.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                             ...
                             | (targ1,g_ex) ->
                                 ...
                                 let env2 =
                                   let uu___2154_16087 = env1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___2154_16087.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
        ...
        (let uu____20724 =
           let uu____20738 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.try_solve_implicits_hook =
                 (uu___2629_20739.FStar_TypeChecker_Env.try_solve_implicits_hook);
               FStar_TypeChecker_Env.splice =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___2954_23182 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___2954_23182.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
                                   ...
                                   (let uu___3163_24428 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___3163_24428.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3173_24465 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___3173_24465.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                       ...
                       (let uu___3224_24743 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.try_solve_implicits_hook =
                            (uu___3224_24743.FStar_TypeChecker_Env.try_solve_implicits_hook);
                          FStar_TypeChecker_Env.splice =
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3368_25895 = env  in
         {
           ...
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___3368_25895.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3404_26081 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3404_26081.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                 ...
                 | (env1,uu____27051) ->
                     let env2 =
                       let uu___3565_27057 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3565_27057.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3844_29073 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3844_29073.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3875_29177 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3875_29177.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
