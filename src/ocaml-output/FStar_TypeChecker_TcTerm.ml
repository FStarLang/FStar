                ...
                (let uu___479_3956 = env  in
                 {
                   ...
                   FStar_TypeChecker_Env.try_solve_implicits_hook =
                     (uu___479_3956.FStar_TypeChecker_Env.try_solve_implicits_hook);
                   FStar_TypeChecker_Env.splice =
                         ...
                         (let uu___589_4649 = env'  in
                          {
                            ...
                            FStar_TypeChecker_Env.try_solve_implicits_hook =
                              (uu___589_4649.FStar_TypeChecker_Env.try_solve_implicits_hook);
                            FStar_TypeChecker_Env.splice =
        ...
        fun tau  ->
          let env1 =
            let uu___1329_10466 = env  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___1329_10466.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___1878_13938 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.try_solve_implicits_hook
                                   =
                                   (uu___1878_13938.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                 FStar_TypeChecker_Env.splice =
                            ...
                            (let uu___1969_14654 = envbody1  in
                             {
                               ...
                               FStar_TypeChecker_Env.try_solve_implicits_hook
                                 =
                                 (uu___1969_14654.FStar_TypeChecker_Env.try_solve_implicits_hook);
                               FStar_TypeChecker_Env.splice =
                                       ...
                                       (let uu___1980_14707 = envbody1  in
                                        {
                                          ...
                                          FStar_TypeChecker_Env.try_solve_implicits_hook
                                            =
                                            (uu___1980_14707.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                          FStar_TypeChecker_Env.splice =
                             ...
                             | (targ1,g_ex) ->
                                 ...
                                 let env2 =
                                   let uu___2268_17151 = env1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___2268_17151.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
        ...
        (let uu____22129 =
           let uu____22147 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.try_solve_implicits_hook =
                 (uu___2762_22148.FStar_TypeChecker_Env.try_solve_implicits_hook);
               FStar_TypeChecker_Env.splice =
                                                             ...
                                                             (fun acc  ->
                                                                fun pat_bv_tm
                                                                  ...
                                                                  fun bv  ->
                                                                    ...
                                                                    FStar_TypeChecker_Env.try_solve_implicits_hook
                                                                    =
                                                                    (uu___3003_23768.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                                                    FStar_TypeChecker_Env.splice
                                                                    =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___3126_24836 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3126_24836.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
                                   ...
                                   (let uu___3335_26087 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___3335_26087.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3345_26124 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___3345_26124.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                       ...
                       (let uu___3396_26402 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.try_solve_implicits_hook =
                            (uu___3396_26402.FStar_TypeChecker_Env.try_solve_implicits_hook);
                          FStar_TypeChecker_Env.splice =
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3550_27581 = env  in
         {
           ...
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___3550_27581.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3586_27767 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3586_27767.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                 ...
                 | (env1,uu____28737) ->
                     let env2 =
                       let uu___3747_28743 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3747_28743.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___4026_30763 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___4026_30763.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___4057_30867 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___4057_30867.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
