...
let e = (let _153_503 = (let _153_502 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp cbody) (fun _153_501 -> FStar_Util.Inl (_153_501)))
in Some (_153_502))
in (FStar_Syntax_Util.abs bs body _153_503))
in (
...
(let _153_504 = (FStar_TypeChecker_Rel.teq env t tfun_computed)
in ((e), (_153_504)))
end else begin
...
| (e, guard') -> begin
(let _153_505 = (FStar_TypeChecker_Rel.conj_guard guard guard')
in ((e), (t), (_153_505)))
end))
end))
end
...
(let _153_514 = (FStar_Range.string_of_range head.FStar_Syntax_Syntax.pos)
in (let _153_513 = (FStar_Syntax_Print.term_to_string thead)
...
(let _153_530 = (FStar_Syntax_Syntax.mk_Tm_app head (FStar_List.rev arg_rets) (Some (cres.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (FStar_TypeChecker_Util.maybe_assume_result_eq_pure_term env _153_530 cres))
end else begin
(

let _58_1505 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _153_533 = (FStar_Syntax_Print.term_to_string head)
in (let _153_532 = (FStar_Syntax_Print.lcomp_to_string cres)
in (let _153_531 = (FStar_TypeChecker_Rel.guard_to_string env g)
in (FStar_Util.print3 "Not refining result: f=%s; cres=%s; guard=%s\n" _153_533 _153_532 _153_531))))
end else begin
()
end
in cres)
...
let g = (let _153_534 = (FStar_TypeChecker_Rel.conj_guard ghead guard)
in (FStar_All.pipe_right _153_534 (FStar_TypeChecker_Rel.solve_deferred_constraints env)))
in (let _153_539 = (let _153_538 = (let _153_537 = (let _153_536 = (let _153_535 = (cres.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Util.arrow bs _153_535))
in (FStar_All.pipe_left (FStar_Syntax_Subst.subst subst) _153_536))
in (FStar_Syntax_Syntax.mk_Total _153_537))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _153_538))
in ((_153_539), (g))))
end)
...
(let _153_540 = (FStar_Syntax_Print.lcomp_to_string cres)
...
(let _153_545 = (let _153_544 = (let _153_543 = (FStar_TypeChecker_Util.maybe_lift env e eff_name out_c.FStar_Syntax_Syntax.eff_name)
in ((_153_543), (q)))
in (_153_544)::args)
in ((_153_545), (out_c), (monadic)))
end
...
let arg = (let _153_555 = (FStar_Syntax_Syntax.as_implicit true)
in ((varg), (_153_555)))
in (let _153_557 = (let _153_556 = (FStar_TypeChecker_Rel.conj_guard implicits g)
in ((subst), ((((arg), (None), (FStar_Util.Inl (FStar_Syntax_Const.effect_Tot_lid))))::outargs), ((arg)::arg_rets), (_153_556), (fvs)))
in (tc_args head_info _153_557 rest args))))
end))))
end
...
(let _153_558 = (FStar_Syntax_Print.term_to_string targ)
...
(let _153_561 = (FStar_Syntax_Print.tag_of_term e)
in (let _153_560 = (FStar_Syntax_Print.term_to_string e)
in (let _153_559 = (FStar_Syntax_Print.term_to_string targ)
in (FStar_Util.print3 "Checking arg (%s) %s at type %s\n" _153_561 _153_560 _153_559))))
end else begin
()
end
in (
...
if (let _153_564 = (FStar_List.hd bs)
in (FStar_Syntax_Syntax.is_null_binder _153_564)) then begin
(

let newx = (FStar_Syntax_Syntax.new_bv (Some (e.FStar_Syntax_Syntax.pos)) c.FStar_Syntax_Syntax.res_typ)
in (

let arg' = (let _153_565 = (FStar_Syntax_Syntax.bv_to_name newx)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _153_565))
in (tc_args head_info ((subst), ((((arg), (Some (newx)), (FStar_Util.Inr (c))))::outargs), ((arg')::arg_rets), (g), (fvs)) rest rest')))
end else begin
(let _153_569 = (let _153_568 = (let _153_567 = (let _153_566 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Syntax.as_arg _153_566))
in (_153_567)::arg_rets)
in ((subst), ((((arg), (Some (x)), (FStar_Util.Inr (c))))::outargs), (_153_568), (g), ((x)::fvs)))
in (tc_args head_info _153_569 rest rest'))
end
end
end))
end))))))))))
...
let tres = (let _153_574 = (FStar_Syntax_Subst.compress tres)
in (FStar_All.pipe_right _153_574 FStar_Syntax_Util.unrefine))
...
(let _153_575 = (FStar_Range.string_of_range tres.FStar_Syntax_Syntax.pos)
...
(let _153_576 = (unfold_whnf env tres)
in (aux true _153_576))
end
| _58_1664 -> begin
(let _153_582 = (let _153_581 = (let _153_580 = (let _153_578 = (FStar_TypeChecker_Normalize.term_to_string env thead)
in (let _153_577 = (FStar_Util.string_of_int n_args)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s arguments" _153_578 _153_577)))
in (let _153_579 = (FStar_Syntax_Syntax.argpos arg)
in ((_153_580), (_153_579))))
in FStar_Syntax_Syntax.Error (_153_581))
in (Prims.raise _153_582))
end)))
...
let rec check_function_app = (fun norm tf -> (match ((let _153_587 = (FStar_Syntax_Util.unrefine tf)
in _153_587.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_uvar (_)) | (FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (_); FStar_Syntax_Syntax.tk = _; FStar_Syntax_Syntax.pos = _; FStar_Syntax_Syntax.vars = _}, _)) -> begin
(
...
(let _153_592 = (FStar_TypeChecker_Rel.conj_guard g_e g_rest)
in (((((e), (imp)))::args), ((((e.FStar_Syntax_Syntax.pos), (c)))::comps), (_153_592)))
end))
end))
end))
in (
...
let bs = (let _153_594 = (FStar_All.pipe_right comps (FStar_List.map (fun _58_1709 -> (match (_58_1709) with
| (_58_1707, c) -> begin
((c.FStar_Syntax_Syntax.res_typ), (None))
end))))
in (FStar_Syntax_Util.null_binders_of_tks _153_594))
in (
...
| Some (t) -> begin
(match ((let _153_609 = (FStar_Syntax_Subst.compress t)
in _153_609.FStar_Syntax_Syntax.n)) with
...
let cres = (let _153_614 = (let _153_613 = (let _153_612 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _153_612 Prims.fst))
in (FStar_TypeChecker_Util.new_uvar env _153_613))
in (ml_or_tot _153_614 r))
in (
...
(let _153_617 = (FStar_Syntax_Print.term_to_string head)
in (let _153_616 = (FStar_Syntax_Print.term_to_string tf)
in (let _153_615 = (FStar_Syntax_Print.term_to_string bs_cres)
in (FStar_Util.print3 "Forcing the type of %s from %s to %s\n" _153_617 _153_616 _153_615))))
end else begin
()
end
in (

let _58_1732 = (let _153_618 = (FStar_TypeChecker_Rel.teq env tf bs_cres)
in (FStar_All.pipe_left (FStar_TypeChecker_Rel.force_trivial_guard env) _153_618))
in (

let comp = (let _153_621 = (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun _58_1736 out -> (match (_58_1736) with
| (r1, c) -> begin
(FStar_TypeChecker_Util.bind r1 env None c ((None), (out)))
end)) ((((head.FStar_Syntax_Syntax.pos), (chead)))::comps) _153_621))
in (let _153_623 = (FStar_Syntax_Syntax.mk_Tm_app head args (Some (comp.FStar_Syntax_Syntax.res_typ.FStar_Syntax_Syntax.n)) r)
in (let _153_622 = (FStar_TypeChecker_Rel.conj_guard ghead g_args)
in ((_153_623), (comp), (_153_622))))))))))))
end)))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(
...
| _58_1748 -> begin
if (not (norm)) then begin
(let _153_624 = (unfold_whnf env tf)
in (check_function_app true _153_624))
end else begin
(let _153_627 = (let _153_626 = (let _153_625 = (FStar_TypeChecker_Errors.expected_function_typ env tf)
in ((_153_625), (head.FStar_Syntax_Syntax.pos)))
in FStar_Syntax_Syntax.Error (_153_626))
in (Prims.raise _153_627))
end
end))
in (let _153_629 = (let _153_628 = (FStar_Syntax_Util.unrefine thead)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.WHNF)::[]) env _153_628))
in (check_function_app false _153_629))))))))))
...
let g = (let _153_639 = (FStar_TypeChecker_Rel.guard_of_guard_formula short)
in (FStar_TypeChecker_Rel.imp_guard _153_639 g))
in (

let ghost = (ghost || ((not ((FStar_Syntax_Util.is_total_lcomp c))) && (not ((FStar_TypeChecker_Util.is_pure_effect env c.FStar_Syntax_Syntax.eff_name)))))
in (let _153_643 = (let _153_641 = (let _153_640 = (FStar_Syntax_Syntax.as_arg e)
in (_153_640)::[])
in (FStar_List.append seen _153_641))
in (let _153_642 = (FStar_TypeChecker_Rel.conj_guard guard g)
in ((_153_643), (_153_642), (ghost)))))))
end)))
...
(let _153_644 = (FStar_Syntax_Syntax.mk_GTotal res_t)
in (FStar_All.pipe_right _153_644 FStar_Syntax_Util.lcomp_of_comp))
end else begin
...
(let _153_656 = (FStar_Syntax_Print.pat_to_string p0)
in (let _153_655 = (FStar_Syntax_Print.pat_to_string p)
...
let _58_1858 = (let _153_679 = (FStar_All.pipe_right exps (FStar_List.map (fun e -> (

let _58_1824 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
(let _153_659 = (FStar_Syntax_Print.term_to_string e)
in (let _153_658 = (FStar_Syntax_Print.term_to_string pat_t)
...
(let _153_661 = (FStar_TypeChecker_Normalize.term_to_string env e)
in (let _153_660 = (FStar_TypeChecker_Normalize.term_to_string env lc.FStar_Syntax_Syntax.res_typ)
...
let _58_1836 = (let _153_662 = (FStar_TypeChecker_Rel.discharge_guard env (
...
in (FStar_All.pipe_right _153_662 FStar_TypeChecker_Rel.resolve_implicits))
in (

let e' = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env e)
in (

let uvars_to_string = (fun uvs -> (let _153_667 = (let _153_666 = (FStar_All.pipe_right uvs FStar_Util.set_elements)
in (FStar_All.pipe_right _153_666 (FStar_List.map (fun _58_1844 -> (match (_58_1844) with
| (u, _58_1843) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end)))))
in (FStar_All.pipe_right _153_667 (FStar_String.concat ", "))))
in (
...
let _58_1852 = if (let _153_668 = (FStar_Util.set_is_subset_of uvs1 uvs2)
in (FStar_All.pipe_left Prims.op_Negation _153_668)) then begin
(

let unresolved = (let _153_669 = (FStar_Util.set_difference uvs1 uvs2)
in (FStar_All.pipe_right _153_669 FStar_Util.set_elements))
in (let _153_677 = (let _153_676 = (let _153_675 = (let _153_674 = (FStar_TypeChecker_Normalize.term_to_string env e')
in (let _153_673 = (FStar_TypeChecker_Normalize.term_to_string env expected_pat_t)
in (let _153_672 = (let _153_671 = (FStar_All.pipe_right unresolved (FStar_List.map (fun _58_1851 -> (match (_58_1851) with
| (u, _58_1850) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _153_671 (FStar_String.concat ", ")))
in (FStar_Util.format3 "Implicit pattern variables in %s could not be resolved against expected type %s;Variables {%s} were unresolved; please bind them explicitly" _153_674 _153_673 _153_672))))
in ((_153_675), (p.FStar_Syntax_Syntax.p)))
in FStar_Syntax_Syntax.Error (_153_676))
in (Prims.raise _153_677)))
end else begin
()
end
in (
...
(let _153_678 = (FStar_TypeChecker_Normalize.term_to_string env e)
...
in (FStar_All.pipe_right _153_679 FStar_List.unzip))
...
let _58_1865 = (let _153_680 = (FStar_TypeChecker_Env.push_bv env scrutinee)
in (FStar_All.pipe_right _153_680 FStar_TypeChecker_Env.clear_expected_typ))
...
let _58_1878 = (let _153_681 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_TypeChecker_Common.t_bool)
in (tc_term _153_681 e))
...
| Some (w) -> begin
(let _153_683 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Util.t_bool FStar_Syntax_Util.t_bool w FStar_Syntax_Const.exp_true_bool)
in (FStar_All.pipe_left (fun _153_682 -> Some (_153_682)) _153_683))
end)
in (
...
| Some (f) -> begin
(let _153_687 = (FStar_Syntax_Util.mk_disj clause f)
...
in (let _153_690 = (FStar_TypeChecker_Util.weaken_precondition env c gf)
in (let _153_689 = (FStar_TypeChecker_Rel.imp_guard g g_when)
...
let g_fw = (let _153_691 = (FStar_Syntax_Util.mk_conj f w)
in FStar_TypeChecker_Common.NonTrivial (_153_691))
in (let _153_694 = (FStar_TypeChecker_Util.weaken_precondition env c g_fw)
in (let _153_693 = (let _153_692 = (FStar_TypeChecker_Rel.guard_of_guard_formula g_f)
in (FStar_TypeChecker_Rel.imp_guard _153_692 g_when))
...
in (let _153_695 = (FStar_TypeChecker_Util.weaken_precondition env c g_w)
in ((_153_695), (g_when)))))
end)
...
in (let _153_697 = (FStar_TypeChecker_Util.close_comp env pat_bvs c_weak)
in (let _153_696 = (FStar_TypeChecker_Rel.close_guard binders g_when_weak)
in ((_153_697), (_153_696), (g_branch)))))
end))
end)))
...
let discriminate = (fun scrutinee_tm f -> if ((let _153_707 = (let _153_706 = (FStar_TypeChecker_Env.typ_of_datacon env f.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.datacons_of_typ env _153_706))
in (FStar_List.length _153_707)) > (Prims.parse_int "1")) then begin
(

let disc = (let _153_708 = (FStar_Syntax_Util.mk_discriminator f.FStar_Syntax_Syntax.v)
...
let sub_term_guards = (let _153_732 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _58_2007 -> (match (_58_2007) with
| (ei, _58_2006) -> begin
(
...
let _58_2061 = (let _153_748 = (let _153_747 = (let _153_746 = (let _153_745 = (c1.FStar_Syntax_Syntax.comp ())
...
let _58_2103 = (let _153_757 = (let _153_756 = (FStar_TypeChecker_Env.clear_expected_typ env)
...
let _58_2109 = (let _153_759 = (let _153_758 = (FStar_Syntax_Syntax.mk_binder x)
in (_153_758)::[])
...
let _58_2115 = (let _153_760 = (FStar_TypeChecker_Env.push_bv env x)
...
let _58_2287 = (let _153_807 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _58_2281 = (let _153_806 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
...
let _58_2313 = (let _153_814 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
...
in ((Some (t)), (FStar_TypeChecker_Rel.trivial_guard), (univ_vars), (_153_822)))
end else begin
(
...
in ((Some (t)), (g), (univ_vars), (_153_826)))))
end))
end))
end)
end))
...
let _58_2511 = (let _153_914 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
