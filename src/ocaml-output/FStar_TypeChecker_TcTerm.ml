                    ...
                    let uu___3 =
                      ...
                      | uu___4 ->
                          ...
                          FStar_Errors.raise_error
                            ...
                            uu___5 in
                    (match uu___3 with
                     | (env_branches, ret_or_res_typ, g11) ->
                         let guard_x =
                           FStar_Syntax_Syntax.new_bv
                             (FStar_Pervasives_Native.Some
                         ...
                         let uu___4 =
                           ...
                           | (cases, g, erasable) ->
                               (match ret_or_res_typ with
                                | FStar_Util.Inr res_t ->
                                    let uu___6 =
                                      FStar_TypeChecker_Util.bind_cases env
                                        res_t cases guard_x in
                                    (uu___6, g, erasable)
                                | FStar_Util.Inl (FStar_Util.Inl t, uu___6)
                                    ->
                                    let cases1 =
                                      FStar_List.map
                                        (fun uu___7 ->
                                               ...
                                               (f, eff_label, cflags,
                                                 ((fun b ->
                                                     ...
                                                     FStar_TypeChecker_Common.set_result_typ_lc
                                                       uu___8 t)))) cases in
                                    let uu___7 =
                                      FStar_TypeChecker_Util.bind_cases env t
                                        cases1 guard_x in
                                    (uu___7, g, erasable)
                                | FStar_Util.Inl (FStar_Util.Inr c, uu___6)
                                    ->
                              ...
                              let cres1 =
                                ...
                                then
                                  ...
                                  FStar_TypeChecker_Util.bind
                                    ...
                                    (FStar_Pervasives_Native.Some e) uu___5
