                                                             ...
                                                             (fun uu____23747
                                                                ...
                                                                fun pat_bv_tm
                                                                  ...
                                                                  fun bv  ->
                                                                    ...
                                                                    FStar_TypeChecker_Env.try_solve_implicits_hook
                                                                    =
                                                                    (uu___3012_23810.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                                                    FStar_TypeChecker_Env.splice
                                                                    =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___3137_24889 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___3137_24889.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
                                   ...
                                   (let uu___3346_26140 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___3346_26140.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3356_26177 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.try_solve_implicits_hook
                                       =
                                       (uu___3356_26177.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                     FStar_TypeChecker_Env.splice =
                       ...
                       (let uu___3407_26455 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.try_solve_implicits_hook =
                            (uu___3407_26455.FStar_TypeChecker_Env.try_solve_implicits_hook);
                          FStar_TypeChecker_Env.splice =
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3561_27647 = env  in
         {
           ...
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___3561_27647.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3597_27833 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3597_27833.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
                 ...
                 | (env1,uu____28803) ->
                     let env2 =
                       let uu___3758_28809 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.try_solve_implicits_hook =
                           (uu___3758_28809.FStar_TypeChecker_Env.try_solve_implicits_hook);
                         FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___4037_30829 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___4037_30829.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
        ...
        fun k  ->
          ...
          let env2 =
            let uu___4068_30933 = env1  in
            {
              ...
              FStar_TypeChecker_Env.try_solve_implicits_hook =
                (uu___4068_30933.FStar_TypeChecker_Env.try_solve_implicits_hook);
              FStar_TypeChecker_Env.splice =
