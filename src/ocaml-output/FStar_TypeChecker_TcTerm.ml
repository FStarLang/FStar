      ...
      (let top = FStar_Syntax_Subst.compress e  in
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_unknown ;
              ...
              FStar_Syntax_Syntax.vars = uu____1866;_},FStar_Syntax_Syntax.Meta_alien
            (uu____1867,uu____1868,ty))
           ->
           let uu____1878 =
             let uu____1879 = FStar_Syntax_Syntax.mk_Total ty  in
             FStar_All.pipe_right uu____1879 FStar_Syntax_Util.lcomp_of_comp
              in
           (top, uu____1878, FStar_TypeChecker_Rel.trivial_guard)
       | FStar_Syntax_Syntax.Tm_meta
           (e1,FStar_Syntax_Syntax.Meta_desugared
            (FStar_Syntax_Syntax.Meta_smt_pat ))
           ->
           let uu____1885 = tc_tot_or_gtot_term env1 e1  in
           (match uu____1885 with
            | (e2,c,g) ->
                let g1 =
                  let uu___71_1902 = g  in
                  {
                    FStar_TypeChecker_Env.guard_f =
                      FStar_TypeChecker_Common.Trivial;
                    FStar_TypeChecker_Env.deferred =
                      (uu___71_1902.FStar_TypeChecker_Env.deferred);
                    FStar_TypeChecker_Env.univ_ineqs =
                      (uu___71_1902.FStar_TypeChecker_Env.univ_ineqs);
                    FStar_TypeChecker_Env.implicits =
                      (uu___71_1902.FStar_TypeChecker_Env.implicits)
                  }  in
                let uu____1903 =
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           let uu____1924 = FStar_Syntax_Util.type_u ()  in
           (match uu____1924 with
            | (t,u) ->
                let uu____1937 = tc_check_tot_or_gtot_term env1 e1 t  in
                (match uu____1937 with
                 | (e2,c,g) ->
                     let uu____1953 =
                       ...
                       | (env2,uu____1990) -> tc_pats env2 pats  in
                     (match uu____1953 with
                      | (pats1,g') ->
                          let g'1 =
                            let uu___72_2024 = g'  in
                            {
                              FStar_TypeChecker_Env.guard_f =
                                FStar_TypeChecker_Common.Trivial;
                              FStar_TypeChecker_Env.deferred =
                                (uu___72_2024.FStar_TypeChecker_Env.deferred);
                              FStar_TypeChecker_Env.univ_ineqs =
                                (uu___72_2024.FStar_TypeChecker_Env.univ_ineqs);
                              FStar_TypeChecker_Env.implicits =
                                (uu___72_2024.FStar_TypeChecker_Env.implicits)
                            }  in
                          let uu____2025 =
                            FStar_Syntax_Syntax.mk
                              (FStar_Syntax_Syntax.Tm_meta
                          ...
                          (uu____2025, c, uu____2028))))
       | FStar_Syntax_Syntax.Tm_meta
           (e1,FStar_Syntax_Syntax.Meta_desugared
            (FStar_Syntax_Syntax.Sequence ))
           ->
           let uu____2036 =
             let uu____2037 = FStar_Syntax_Subst.compress e1  in
             uu____2037.FStar_Syntax_Syntax.n  in
           (match uu____2036 with
            | FStar_Syntax_Syntax.Tm_let
                ((uu____2046,{ FStar_Syntax_Syntax.lbname = x;
                               FStar_Syntax_Syntax.lbunivs = uu____2048;
                               FStar_Syntax_Syntax.lbtyp = uu____2049;
                               FStar_Syntax_Syntax.lbeff = uu____2050;
                               FStar_Syntax_Syntax.lbdef = e11;
                               FStar_Syntax_Syntax.lbattrs = uu____2052;_}::[]),e2)
                ->
                let uu____2080 =
                  let uu____2087 =
                           ...
                           | (e3,expected_c2,g'') ->
                               ...
                               (match uu____2420 with
                                | (e5,c,f2) ->
                                    ...
                                    (e5, c, final_guard))))))
       | FStar_Syntax_Syntax.Tm_ascribed
           (e1,(FStar_Util.Inl t,topt),uu____2440) ->
           let uu____2487 = FStar_Syntax_Util.type_u ()  in
           (match uu____2487 with
            | (k,u) ->
                let uu____2500 = tc_check_tot_or_gtot_term env1 t k  in
                (match uu____2500 with
                 | (t1,uu____2514,f) ->
                     let uu____2516 =
                       let uu____2523 =
                         FStar_TypeChecker_Env.set_expected_typ env1 t1  in
                       tc_term uu____2523 e1  in
                               ...
                               let uu____2551 =
                                 let uu____2558 =
                                   FStar_Syntax_Syntax.mk
                                     ...
                                     top.FStar_Syntax_Syntax.pos
                                    in
                                 comp_check_expected_typ env1 uu____2558 c1
                                  in
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu____2600;
              FStar_Syntax_Syntax.vars = uu____2601;_},a::hd1::rest)
           ->
           let rest1 = hd1 :: rest  in
           let uu____2664 = FStar_Syntax_Util.head_and_args top  in
            ...
            | (unary_op,uu____2686) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    ...
                    FStar_Pervasives_Native.None uu____2710
                   in
                let t =
                  FStar_Syntax_Syntax.mk
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____2749;_},a::hd1::rest)
           ->
           let rest1 = hd1 :: rest  in
           let uu____2812 = FStar_Syntax_Util.head_and_args top  in
           (match uu____2812 with
            | (unary_op,uu____2834) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (unary_op, [a]))
                    FStar_Pervasives_Native.None uu____2858
                   in
                let t =
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (head1, rest1))
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____2896);
              FStar_Syntax_Syntax.pos = uu____2897;
              FStar_Syntax_Syntax.vars = uu____2898;_},a::hd1::rest)
           ->
           let rest1 = hd1 :: rest  in
           let uu____2961 = FStar_Syntax_Util.head_and_args top  in
           (match uu____2961 with
            | (unary_op,uu____2983) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (unary_op, [a]))
                    FStar_Pervasives_Native.None uu____3007
                   in
                let t =
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (head1, rest1))
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu____3045;
              FStar_Syntax_Syntax.vars = uu____3046;_},a1::a2::hd1::rest)
           ->
           let rest1 = hd1 :: rest  in
           let uu____3122 = FStar_Syntax_Util.head_and_args top  in
            ...
            | (unary_op,uu____3144) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    ...
                    FStar_Pervasives_Native.None uu____3168
                   in
                let t =
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (head1, rest1))
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____3213;_},(e1,FStar_Pervasives_Native.None
                                                        )::[])
           ->
           let uu____3251 =
             let uu____3258 =
               let uu____3259 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
               FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3259  in
             tc_term uu____3258 e1  in
           (match uu____3251 with
            | (e2,c,g) ->
                let uu____3283 = FStar_Syntax_Util.head_and_args top  in
                       ...
                       let uu____3354 =
                         let uu____3357 =
                           FStar_Syntax_Syntax.tabbrev
                            ...
                            in
                         FStar_Syntax_Syntax.mk_Total uu____3357  in
                       FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp
                         uu____3354
                        in
                     (uu____3326, uu____3353, g)))
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____3362;
              FStar_Syntax_Syntax.vars = uu____3363;_},(t,FStar_Pervasives_Native.None
                                                        )::(r,FStar_Pervasives_Native.None
                                                            )::[])
           ->
           let uu____3416 = FStar_Syntax_Util.head_and_args top  in
                ...
                let env' =
                  let uu____3460 =
                    FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid
                     in
                  FStar_TypeChecker_Env.set_expected_typ env1 uu____3460  in
                let uu____3461 = tc_term env' r  in
                (match uu____3461 with
                 | (er,uu____3475,gr) ->
                     let uu____3477 = tc_term env1 t  in
                            ...
                            let uu____3497 =
                              let uu____3498 =
                                ...
                                let uu____3500 =
                                  ...
                                  [uu____3503]  in
                                uu____3499 :: uu____3500  in
                              FStar_Syntax_Syntax.mk_Tm_app head1 uu____3498
                               in
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_range_of );
              FStar_Syntax_Syntax.pos = uu____3508;
              FStar_Syntax_Syntax.vars = uu____3509;_},uu____3510)
           ->
           let uu____3531 =
             let uu____3536 =
               let uu____3537 = FStar_Syntax_Print.term_to_string top  in
               FStar_Util.format1 "Ill-applied constant %s" uu____3537  in
             (FStar_Errors.Fatal_IllAppliedConstant, uu____3536)  in
           FStar_Errors.raise_error uu____3531 e.FStar_Syntax_Syntax.pos
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____3544;
              FStar_Syntax_Syntax.vars = uu____3545;_},uu____3546)
           ->
           let uu____3567 =
             let uu____3572 =
               let uu____3573 = FStar_Syntax_Print.term_to_string top  in
               FStar_Util.format1 "Ill-applied constant %s" uu____3573  in
             (FStar_Errors.Fatal_IllAppliedConstant, uu____3572)  in
           FStar_Errors.raise_error uu____3567 e.FStar_Syntax_Syntax.pos
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reify );
              FStar_Syntax_Syntax.pos = uu____3580;
              FStar_Syntax_Syntax.vars = uu____3581;_},(e1,aqual)::[])
           ->
           (if FStar_Option.isSome aqual
            ...
            (let uu____3614 = FStar_TypeChecker_Env.clear_expected_typ env1
                in
             match uu____3614 with
             | (env0,uu____3628) ->
                 let uu____3633 = tc_term env0 e1  in
                 (match uu____3633 with
                  | (e2,c,g) ->
                      let uu____3649 = FStar_Syntax_Util.head_and_args top
                         in
                      (match uu____3649 with
                       | (reify_op,uu____3671) ->
                           ...
                           let repr =
                             let uu____3726 =
                               FStar_Syntax_Syntax.lcomp_comp c  in
                             FStar_TypeChecker_Env.reify_comp env1 uu____3726
                               u_c
                              in
                           let e3 =
                             FStar_Syntax_Syntax.mk
                           ...
                           let c1 =
                             ...
                             FStar_All.pipe_right uu____3747
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu____3766;
              FStar_Syntax_Syntax.vars = uu____3767;_},(e1,aqual)::[])
           ->
           (if FStar_Option.isSome aqual
            then
              FStar_Errors.log_issue e1.FStar_Syntax_Syntax.pos
            ...
            (let no_reflect uu____3809 =
               let uu____3810 =
                 let uu____3815 =
                   FStar_Util.format1 "Effect %s cannot be reified"
                     l.FStar_Ident.str
                    in
                 (FStar_Errors.Fatal_EffectCannotBeReified, uu____3815)  in
               FStar_Errors.raise_error uu____3810 e1.FStar_Syntax_Syntax.pos
                in
             let uu____3822 = FStar_Syntax_Util.head_and_args top  in
             match uu____3822 with
             | (reflect_op,uu____3844) ->
                 let uu____3865 =
                             ...
                             let uu____3928 =
                                 ...
                                 let uu____3948 =
                                   let uu____3951 =
                                     let uu____3952 =
                                       ...
                                       (repr, uu____3967)  in
                                     FStar_Syntax_Syntax.Tm_app uu____3952
                                      in
                                   FStar_Syntax_Syntax.mk uu____3951  in
                                 uu____3948 FStar_Pervasives_Native.None
                                   top.FStar_Syntax_Syntax.pos
                                  in
                               let uu____3980 =
                                 let uu____3987 =
                                   ...
                                   FStar_All.pipe_right uu____3988
                                    ...
                                    in
                                 tc_tot_or_gtot_term uu____3987 t  in
                               ...
                               | (t1,uu____4016,g) ->
                                   ...
                                   (match uu____4018 with
                                    | FStar_Syntax_Syntax.Tm_app
                                        (uu____4034,(res,uu____4036)::
                                         (wp,uu____4038)::[])
                                        -> (t1, res, wp, g)
                                    | uu____4081 -> failwith "Impossible")
                                in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           ...
           let env2 =
             let uu____4295 =
               let uu____4296 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
               FStar_All.pipe_right uu____4296 FStar_Pervasives_Native.fst
                in
             FStar_All.pipe_right uu____4295 instantiate_both  in
           ((let uu____4312 =
             ...
             then
               ...
               let uu____4314 = FStar_Syntax_Print.term_to_string top  in
               FStar_Util.print2 "(%s) Checking app %s\n" uu____4313
                 uu____4314
             else ());
            (let isquote =
               let uu____4317 = FStar_Syntax_Util.head_and_args head1  in
               match uu____4317 with
               | (head2,uu____4333) ->
                   let uu____4354 =
                     let uu____4355 = FStar_Syntax_Util.un_uinst head2  in
                   ...
                   (match uu____4354 with
                    ...
                    | uu____4359 -> false)
                in
             let uu____4360 = tc_term (no_inst env2) head1  in
                   ...
                   then
                     let uu____4390 =
                       ...
                       check_short_circuit_args env2 head2 chead g_head args
                         uu____4397
                        in
                     match uu____4390 with | (e1,c,g) -> (e1, c, g)
                   else
                   ...
                   (let uu___76_5579 = env1  in
                    {
                      ...
                      FStar_TypeChecker_Env.qname_and_index =
                        (uu___76_5579.FStar_TypeChecker_Env.qname_and_index);
                      FStar_TypeChecker_Env.proof_ns =
                   ...
                   (let uu___77_5674 = env1  in
                    {
                      ...
                      FStar_TypeChecker_Env.qname_and_index =
                        (uu___77_5674.FStar_TypeChecker_Env.qname_and_index);
                      FStar_TypeChecker_Env.proof_ns =
    ...
    fun tau  ->
      let env1 =
        let uu___78_6118 = env  in
        {
          ...
          FStar_TypeChecker_Env.qname_and_index =
            (uu___78_6118.FStar_TypeChecker_Env.qname_and_index);
          FStar_TypeChecker_Env.proof_ns =
    ...
    fun tau  ->
      let env1 =
        let uu___79_6122 = env  in
        {
          ...
          FStar_TypeChecker_Env.qname_and_index =
            (uu___79_6122.FStar_TypeChecker_Env.qname_and_index);
          FStar_TypeChecker_Env.proof_ns =
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___87_9120 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___87_9120.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
                          ...
                          (let uu___89_9619 = envbody  in
                           {
                             ...
                             FStar_TypeChecker_Env.qname_and_index =
                               (uu___89_9619.FStar_TypeChecker_Env.qname_and_index);
                             FStar_TypeChecker_Env.proof_ns =
                                ...
                                (let uu___90_9651 = envbody  in
                                 {
                                   ...
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___90_9651.FStar_TypeChecker_Env.qname_and_index);
                                   FStar_TypeChecker_Env.proof_ns =
                            ...
                            (let targ1 =
                             ...
                             let env2 =
                               let uu___93_11353 = env1  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___93_11353.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
                         ...
                         | (env1,uu____13237) ->
                             let env11 =
                               let uu___94_13243 = env1  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___94_13243.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___96_14512 = env1  in
            {
              ...
              FStar_TypeChecker_Env.qname_and_index =
                (uu___96_14512.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                                   ...
                                   (let uu___103_15470 = env0  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.qname_and_index =
                                        (uu___103_15470.FStar_TypeChecker_Env.qname_and_index);
                                      FStar_TypeChecker_Env.proof_ns =
                          ...
                          let env3 =
                            ...
                            then
                              let uu___104_15479 = env2  in
                              {
                                ...
                                FStar_TypeChecker_Env.qname_and_index =
                                  (uu___104_15479.FStar_TypeChecker_Env.qname_and_index);
                                FStar_TypeChecker_Env.proof_ns =
                       ...
                       (let uu___107_15739 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.qname_and_index =
                            (uu___107_15739.FStar_TypeChecker_Env.qname_and_index);
                          FStar_TypeChecker_Env.proof_ns =
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___109_16638 = env  in
         {
           ...
           FStar_TypeChecker_Env.qname_and_index =
             (uu___109_16638.FStar_TypeChecker_Env.qname_and_index);
           FStar_TypeChecker_Env.proof_ns =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___112_16778 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.qname_and_index =
                           (uu___112_16778.FStar_TypeChecker_Env.qname_and_index);
                         FStar_TypeChecker_Env.proof_ns =
...
let rec (universe_of_aux :
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____16921,(FStar_Util.Inl t,uu____16923),uu____16924) -> t
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____16971,(FStar_Util.Inr c,uu____16973),uu____16974) ->
          FStar_Syntax_Util.comp_result c
      | FStar_Syntax_Syntax.Tm_type u ->
          FStar_Syntax_Syntax.mk
      ...
      | FStar_Syntax_Syntax.Tm_uinst
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____17024;
             FStar_Syntax_Syntax.vars = uu____17025;_},us)
          ->
          let uu____17031 =
            FStar_TypeChecker_Env.lookup_lid env
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
          ...
          (match uu____17031 with
           | ((us',t),uu____17044) ->
               (if (FStar_List.length us) <> (FStar_List.length us')
                then
                  (let uu____17050 = FStar_TypeChecker_Env.get_range env  in
                   FStar_Errors.raise_error
                     (FStar_Errors.Fatal_UnexpectedNumberOfUniverse,
                  ...
                  FStar_List.iter2
                    (fun u'  ->
                       fun u  ->
                         ...
                         | FStar_Syntax_Syntax.U_unif u'' ->
                             FStar_Syntax_Unionfind.univ_change u'' u
                         | uu____17066 -> failwith "Impossible") us' us;
                t))
      | FStar_Syntax_Syntax.Tm_uinst uu____17067 ->
          failwith "Impossible: Tm_uinst's head must be an fvar"
      | FStar_Syntax_Syntax.Tm_refine (x,uu____17077) ->
          universe_of_aux env x.FStar_Syntax_Syntax.sort
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____17100 = FStar_Syntax_Subst.open_comp bs c  in
          (match uu____17100 with
           | (bs1,c1) ->
               ...
               let u_res =
                 ...
                 let uu____17132 = universe_of_aux env res  in
                 level_of_type env res uu____17132  in
               let u_c =
                 let uu____17134 =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     let uu____17138 = universe_of_aux env trepr  in
                     level_of_type env trepr uu____17138
                  in
               let u =
      ...
      | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
          let rec type_of_head retry hd2 args1 =
            ...
            | FStar_Syntax_Syntax.Tm_unknown  -> failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_bvar uu____17231 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_delayed uu____17246 ->
                failwith "Impossible"
            | FStar_Syntax_Syntax.Tm_fvar uu____17285 ->
                let uu____17286 = universe_of_aux env hd3  in
                (uu____17286, args1)
            | FStar_Syntax_Syntax.Tm_name uu____17299 ->
                let uu____17300 = universe_of_aux env hd3  in
                (uu____17300, args1)
            | FStar_Syntax_Syntax.Tm_uvar uu____17313 ->
                let uu____17330 = universe_of_aux env hd3  in
                (uu____17330, args1)
            | FStar_Syntax_Syntax.Tm_uinst uu____17343 ->
                let uu____17350 = universe_of_aux env hd3  in
                (uu____17350, args1)
            | FStar_Syntax_Syntax.Tm_ascribed uu____17363 ->
                let uu____17390 = universe_of_aux env hd3  in
                (uu____17390, args1)
            | FStar_Syntax_Syntax.Tm_refine uu____17403 ->
                let uu____17410 = universe_of_aux env hd3  in
                (uu____17410, args1)
            | FStar_Syntax_Syntax.Tm_constant uu____17423 ->
                let uu____17424 = universe_of_aux env hd3  in
                (uu____17424, args1)
            | FStar_Syntax_Syntax.Tm_arrow uu____17437 ->
                let uu____17450 = universe_of_aux env hd3  in
                (uu____17450, args1)
            | FStar_Syntax_Syntax.Tm_meta uu____17463 ->
                let uu____17470 = universe_of_aux env hd3  in
                (uu____17470, args1)
            | FStar_Syntax_Syntax.Tm_type uu____17483 ->
                let uu____17484 = universe_of_aux env hd3  in
                (uu____17484, args1)
            | FStar_Syntax_Syntax.Tm_match (uu____17497,hd4::uu____17499) ->
                let uu____17564 = FStar_Syntax_Subst.open_branch hd4  in
                (match uu____17564 with
                 | (uu____17579,uu____17580,hd5) ->
                     let uu____17598 = FStar_Syntax_Util.head_and_args hd5
                        in
                     (match uu____17598 with
                      | (hd6,args2) -> type_of_head retry hd6 args2))
            | uu____17649 when retry ->
                let e1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.NoDeltaSteps] env e
                   in
                let uu____17651 = FStar_Syntax_Util.head_and_args e1  in
            ...
            | uu____17702 ->
                ...
                (match uu____17703 with
                 | (env1,uu____17725) ->
                     let env2 =
                       let uu___113_17731 = env1  in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___113_17731.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___113_17731.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___113_17731.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___113_17731.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___113_17731.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___113_17731.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___113_17731.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___113_17731.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___113_17731.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___113_17731.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___113_17731.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize =
                           (uu___113_17731.FStar_TypeChecker_Env.generalize);
                         FStar_TypeChecker_Env.letrecs =
                           (uu___113_17731.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level = false;
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___113_17731.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___113_17731.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___113_17731.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___113_17731.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax = true;
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___113_17731.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.failhard =
                           (uu___113_17731.FStar_TypeChecker_Env.failhard);
                         FStar_TypeChecker_Env.nosynth =
                           (uu___113_17731.FStar_TypeChecker_Env.nosynth);
                         FStar_TypeChecker_Env.tc_term =
                           (uu___113_17731.FStar_TypeChecker_Env.tc_term);
                         FStar_TypeChecker_Env.type_of =
                           (uu___113_17731.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___113_17731.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.check_type_of =
                           (uu___113_17731.FStar_TypeChecker_Env.check_type_of);
                         FStar_TypeChecker_Env.use_bv_sorts = true;
                         FStar_TypeChecker_Env.qname_and_index =
                           (uu___113_17731.FStar_TypeChecker_Env.qname_and_index);
                         FStar_TypeChecker_Env.proof_ns =
                           (uu___113_17731.FStar_TypeChecker_Env.proof_ns);
                         FStar_TypeChecker_Env.synth =
                           (uu___113_17731.FStar_TypeChecker_Env.synth);
                         FStar_TypeChecker_Env.is_native_tactic =
                           (uu___113_17731.FStar_TypeChecker_Env.is_native_tactic);
                         FStar_TypeChecker_Env.identifier_info =
                           (uu___113_17731.FStar_TypeChecker_Env.identifier_info);
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___113_17731.FStar_TypeChecker_Env.tc_hooks);
                         FStar_TypeChecker_Env.dsenv =
                           (uu___113_17731.FStar_TypeChecker_Env.dsenv);
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___113_17731.FStar_TypeChecker_Env.dep_graph)
                       }  in
                     ((let uu____17733 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
                       ...
                       then
                         let uu____17734 =
                           ...
                           FStar_Range.string_of_range uu____17735  in
                         let uu____17736 =
                           FStar_Syntax_Print.term_to_string hd3  in
                         FStar_Util.print2 "%s: About to type-check %s\n"
                           uu____17734 uu____17736
                       else ());
                      (let uu____17738 = tc_term env2 hd3  in
                       ...
                       | (uu____17759,{
                           ...
                           ((let uu____17782 =
                            ...
                            (t, args1)))))
             in
          let uu____17793 = type_of_head true hd1 args  in
           ...
           | (t,args1) ->
               let t1 =
                 FStar_TypeChecker_Normalize.normalize
                  ...
                  in
               let uu____17833 = FStar_Syntax_Util.arrow_formals_comp t1  in
                ...
                | (bs,res) ->
                    ...
                    then
                      ...
                      (let uu____17877 =
                       ...
                       level_of_type_fail env e uu____17877)))
      | FStar_Syntax_Syntax.Tm_match (uu____17880,hd1::uu____17882) ->
          let uu____17947 = FStar_Syntax_Subst.open_branch hd1  in
          (match uu____17947 with
           | (uu____17950,uu____17951,hd2) -> universe_of_aux env hd2)
      | FStar_Syntax_Syntax.Tm_match (uu____17969,[]) ->
...
let (universe_of :
  ...
  fun env  ->
    fun e  ->
      let uu____18012 = universe_of_aux env e  in
      level_of_type env e uu____18012
...
let (tc_tparams :
  ...
  fun env  ->
    fun tps  ->
      let uu____18031 = tc_binders env tps  in
...
let rec (type_of_well_typed_term :
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_delayed uu____18081 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_bvar uu____18108 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_name x ->
      ...
      | FStar_Syntax_Syntax.Tm_abs
          ...
          FStar_Util.bind_opt mk_comp
            (fun f  ->
               let uu____18268 = universe_of_well_typed_term env tbody  in
               FStar_Util.bind_opt uu____18268
                 (fun u  ->
                    let uu____18276 =
                      let uu____18279 =
                        let uu____18282 =
                          let uu____18283 =
                            ...
                            (bs, uu____18296)  in
                          FStar_Syntax_Syntax.Tm_arrow uu____18283  in
                        FStar_Syntax_Syntax.mk uu____18282  in
                      uu____18279 FStar_Pervasives_Native.None
                        t.FStar_Syntax_Syntax.pos
                       in
                    FStar_Pervasives_Native.Some uu____18276))
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
                 ...
                 | [] ->
                     let uu____18373 =
                       universe_of_well_typed_term env1
                         (FStar_Syntax_Util.comp_result c1)
                        in
                     FStar_Util.bind_opt uu____18373
                       (fun uc  ->
                          let uu____18381 =
                            mk_tm_type (FStar_Syntax_Syntax.U_max (uc :: us))
                             in
                          FStar_Pervasives_Native.Some uu____18381)
                 | (x,imp)::bs3 ->
                     let uu____18399 =
                       universe_of_well_typed_term env1
                         x.FStar_Syntax_Syntax.sort
                  ...
                  in
               aux env [] bs1)
      | FStar_Syntax_Syntax.Tm_abs uu____18408 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_refine (x,uu____18426) ->
          let uu____18431 =
            universe_of_well_typed_term env x.FStar_Syntax_Syntax.sort  in
          FStar_Util.bind_opt uu____18431
            (fun u_x  ->
               let uu____18439 = mk_tm_type u_x  in
          ...
          let rec aux t_hd1 =
            ...
            | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
                ...
                let bs_t_opt =
                  if n_args < n_bs
                  then
                    let uu____18538 = FStar_Util.first_N n_args bs  in
                    ...
                    | (bs1,rest) ->
                        let t1 =
                          FStar_Syntax_Syntax.mk
                           ...
                           in
                        let uu____18608 =
                          let uu____18613 = FStar_Syntax_Syntax.mk_Total t1
                             in
                          FStar_Syntax_Subst.open_comp bs1 uu____18613  in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____18649 = FStar_Syntax_Subst.open_comp bs c
                          in
                     ...
                     | (bs1,t1) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args
                            in
                         let uu____18752 = FStar_Syntax_Subst.subst subst1 t1
                            in
                         FStar_Pervasives_Native.Some uu____18752)
            | FStar_Syntax_Syntax.Tm_refine (x,uu____18754) ->
                aux x.FStar_Syntax_Syntax.sort
            | FStar_Syntax_Syntax.Tm_ascribed (t1,uu____18760,uu____18761) ->
                aux t1
            | uu____18802 -> FStar_Pervasives_Native.None  in
          FStar_Util.bind_opt t_hd aux
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____18803,(FStar_Util.Inl t1,uu____18805),uu____18806) ->
          FStar_Pervasives_Native.Some t1
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____18855,(FStar_Util.Inr c,uu____18857),uu____18858) ->
          FStar_Pervasives_Native.Some (FStar_Syntax_Util.comp_result c)
      | FStar_Syntax_Syntax.Tm_uvar (uu____18907,t1) ->
          FStar_Pervasives_Native.Some t1
      | FStar_Syntax_Syntax.Tm_meta (t1,uu____18936) ->
          type_of_well_typed_term env t1
      | FStar_Syntax_Syntax.Tm_match uu____18941 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_let uu____18964 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_uinst uu____18977 ->
          FStar_Pervasives_Native.None
...
and (universe_of_well_typed_term :
  ...
  fun env  ->
    fun t  ->
      let uu____18988 = type_of_well_typed_term env t  in
    ...
    fun env  ->
      fun t  ->
        fun k  ->
          ...
          let env2 =
            let uu___114_19017 = env1  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___114_19017.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___114_19017.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___114_19017.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___114_19017.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___114_19017.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___114_19017.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___114_19017.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___114_19017.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___114_19017.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___114_19017.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___114_19017.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___114_19017.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___114_19017.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___114_19017.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___114_19017.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___114_19017.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___114_19017.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___114_19017.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___114_19017.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___114_19017.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___114_19017.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___114_19017.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___114_19017.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___114_19017.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___114_19017.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___114_19017.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts = true;
              FStar_TypeChecker_Env.qname_and_index =
                (uu___114_19017.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___114_19017.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth =
                (uu___114_19017.FStar_TypeChecker_Env.synth);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___114_19017.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___114_19017.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___114_19017.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___114_19017.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___114_19017.FStar_TypeChecker_Env.dep_graph)
            }  in
          let slow_check uu____19021 =
            if must_total
            then
              let uu____19022 = env2.FStar_TypeChecker_Env.type_of env2 t  in
              match uu____19022 with | (uu____19029,uu____19030,g) -> g
            else
              (let uu____19033 = env2.FStar_TypeChecker_Env.tc_term env2 t
                  in
               match uu____19033 with | (uu____19040,uu____19041,g) -> g)
             in
          let uu____19043 =
            let uu____19044 = FStar_Options.__temp_fast_implicits ()  in
            FStar_All.pipe_left Prims.op_Negation uu____19044  in
          if uu____19043
          then slow_check ()
          else
            (let uu____19046 = type_of_well_typed_term env2 t  in
                   ...
                   then
                     let uu____19052 =
                       FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos
                        in
                     let uu____19053 = FStar_Syntax_Print.term_to_string t
                        in
                     let uu____19054 = FStar_Syntax_Print.term_to_string k'
                        in
                     let uu____19055 = FStar_Syntax_Print.term_to_string k
                        in
                   ...
                   (let uu____19059 =
                    ...
                    then
                      let uu____19060 =
                        FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos
                         in
                      let uu____19061 = FStar_Syntax_Print.term_to_string t
                         in
                      let uu____19062 = FStar_Syntax_Print.term_to_string k'
                         in
                      let uu____19063 = FStar_Syntax_Print.term_to_string k
                         in
                      FStar_Util.print5 "(%s) Fast check %s: %s : %s <: %s\n"
                        uu____19060 (if b then "succeeded" else "failed")
                        uu____19061 uu____19062 uu____19063
                    else ());
                   if b
