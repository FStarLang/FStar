           ...
           | (lbs1, e21) ->
               ...
               (match uu___1 with
                | (env0, topt) ->
                    ...
                    (match uu___2 with
                     | (lbts, rec_env, g_t) ->
                         let uu___3 = check_let_recs rec_env lbts in
                         (match uu___3 with
                          | (lbs2, g_lbs) ->
                              let g_lbs1 =
                                let uu___4 =
                              ...
                              let cres =
                                ...
                                FStar_All.pipe_left
                                  ...
                                  uu___4 in
                              let uu___4 =
                                FStar_Syntax_Subst.close_let_rec lbs3 e21 in
                              (match uu___4 with
                               | (lbs4, e22) ->
                                   ((let uu___6 =
                                       FStar_TypeChecker_Rel.discharge_guard
               ...
               (match uu___1 with
                | (env0, topt) ->
                    ...
                    (match uu___2 with
                     | (lbts, rec_env, g_t) ->
                         let uu___3 =
                           let uu___4 = check_let_recs rec_env lbts in
                           FStar_All.pipe_right uu___4
                             (fun uu___5 ->
                                match uu___5 with
                                | (lbs2, g) ->
  ...
  Prims.bool ->
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.letbinding Prims.list ->
        ((FStar_Syntax_Syntax.letbinding * FStar_Syntax_Syntax.typ)
                          ...
                          let uu___3 =
                            ...
                            | FStar_Pervasives.Inl t ->
                                ...
                                then (g_acc, t, t)
                                  ...
                                  (let uu___5 = check_annot univ_vars t in
                                   match uu___5 with
                                   | (uu___6, g, t1) ->
                                       let uu___7 =
                                         FStar_TypeChecker_Env.conj_guard
                               ...
                               let uu___4 =
                                 let uu___5 =
                                   termination_check_enabled
                                     lb.FStar_Syntax_Syntax.lbname e t in
                                 match uu___5 with
...
and (check_let_recs :
  FStar_TypeChecker_Env.env_t ->
    (FStar_Syntax_Syntax.letbinding * FStar_Syntax_Syntax.typ) Prims.list ->
      (FStar_Syntax_Syntax.letbinding Prims.list *
        FStar_TypeChecker_Env.guard_t))
  =
  fun env ->
                       ...
                       | (bs, t, lcomp) ->
                           (match bs with
                            ...
                            | uu___4 ->
                                let arity =
                                  let uu___6 =
                                    FStar_TypeChecker_Env.get_letrec_arity
                                      env lb.FStar_Syntax_Syntax.lbname in
                                  match uu___6 with
                                  | FStar_Pervasives_Native.Some n -> n
                                  | FStar_Pervasives_Native.None ->
                                      FStar_List.length bs in
                                let uu___6 = FStar_List.splitAt arity bs in
                                (match uu___6 with
                                 | (bs0, bs1) ->
                                     let def =
