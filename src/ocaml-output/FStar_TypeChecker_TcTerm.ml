  ...
  fun env  ->
    let uu___119_5 = env in
    {
      ...
      FStar_TypeChecker_Env.dep_graph =
        (uu___119_5.FStar_TypeChecker_Env.dep_graph)
    }
let no_inst: FStar_TypeChecker_Env.env -> FStar_TypeChecker_Env.env =
  fun env  ->
    let uu___120_10 = env in
    {
      ...
      FStar_TypeChecker_Env.dep_graph =
        (uu___120_10.FStar_TypeChecker_Env.dep_graph)
    }
let mk_lex_list:
           ...
           | letrecs ->
               ...
               let env1 =
                 let uu___122_1032 = env in
                 {
                   ...
                   FStar_TypeChecker_Env.dep_graph =
                     (uu___122_1032.FStar_TypeChecker_Env.dep_graph)
                 } in
               let precedes =
        ...
        (let uu___124_1815 = env in
         {
           ...
           FStar_TypeChecker_Env.dep_graph =
             (uu___124_1815.FStar_TypeChecker_Env.dep_graph)
         }) e
    ...
    fun tau  ->
      let env1 =
        let uu___128_5779 = env in
        {
          ...
          FStar_TypeChecker_Env.dep_graph =
            (uu___128_5779.FStar_TypeChecker_Env.dep_graph)
        } in
    ...
    fun tau  ->
      let env1 =
        let uu___129_5783 = env in
        {
          ...
          FStar_TypeChecker_Env.dep_graph =
            (uu___129_5783.FStar_TypeChecker_Env.dep_graph)
        } in
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___137_8748 = envbody in
                               {
                                 ...
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___137_8748.FStar_TypeChecker_Env.dep_graph)
                               } in
                          ...
                          (let uu___139_9228 = envbody in
                           {
                             ...
                             FStar_TypeChecker_Env.dep_graph =
                               (uu___139_9228.FStar_TypeChecker_Env.dep_graph)
                           }) body1 in
                                ...
                                (let uu___140_9264 = envbody in
                                 {
                                   ...
                                   FStar_TypeChecker_Env.dep_graph =
                                     (uu___140_9264.FStar_TypeChecker_Env.dep_graph)
                                 }) c_opt uu____9252 in
                            ...
                            (let targ1 =
                             ...
                             let env2 =
                               let uu___143_10937 = env1 in
                               {
                                 ...
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___143_10937.FStar_TypeChecker_Env.dep_graph)
                               } in
                             (let uu____10939 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.High in
                         ...
                         | (env1,uu____12712) ->
                             let env11 =
                               let uu___144_12718 = env1 in
                               {
                                 ...
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___144_12718.FStar_TypeChecker_Env.dep_graph)
                               } in
                             let expected_pat_t =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___146_13905 = env1 in
            {
              ...
              FStar_TypeChecker_Env.dep_graph =
                (uu___146_13905.FStar_TypeChecker_Env.dep_graph)
            } in
          let uu____13906 =
            let uu____13917 =
                                   ...
                                   (let uu___153_14872 = env0 in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.dep_graph =
                                        (uu___153_14872.FStar_TypeChecker_Env.dep_graph)
                                    }) t uu____14860 in
                          ...
                          let env3 =
                            ...
                            then
                              let uu___154_14881 = env2 in
                              {
                                ...
                                FStar_TypeChecker_Env.dep_graph =
                                  (uu___154_14881.FStar_TypeChecker_Env.dep_graph)
                              }
                            else
                       ...
                       (let uu___156_15133 = env11 in
                        {
                          ...
                          FStar_TypeChecker_Env.dep_graph =
                            (uu___156_15133.FStar_TypeChecker_Env.dep_graph)
                        }) e11 in
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___158_16010 = env in
         {
           ...
           FStar_TypeChecker_Env.dep_graph =
             (uu___158_16010.FStar_TypeChecker_Env.dep_graph)
         } in
       let uu____16015 =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___161_16161 = env in
                       {
                         ...
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___161_16161.FStar_TypeChecker_Env.dep_graph)
                       } in
                 ...
                 | (env1,uu____17116) ->
                     let env2 =
                       let uu___162_17122 = env1 in
                       {
                         ...
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___162_17122.FStar_TypeChecker_Env.dep_graph)
                       } in
                     ((let uu____17124 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
