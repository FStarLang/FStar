  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          let uu____14489 =
            let uu____14500 =
              let uu____14501 = FStar_TypeChecker_Env.clear_expected_typ env2 in
              FStar_All.pipe_right uu____14501 FStar_Pervasives_Native.fst in
                         ...
                         let x_eq_e1 =
                           let uu____14611 =
                             ...
                             FStar_Syntax_Util.mk_eq2 uu____14612
                               c1.FStar_Syntax_Syntax.res_typ uu____14613 e11 in
                           FStar_All.pipe_left
                             (fun _0_42  ->
                         ...
                         let g21 =
                           let uu____14615 =
                             let uu____14616 =
                               FStar_TypeChecker_Rel.guard_of_guard_formula
                                 x_eq_e1 in
                             FStar_TypeChecker_Rel.imp_guard uu____14616 g2 in
                              ...
                              let cres =
                                let uu____14948 =
                                  FStar_Syntax_Syntax.mk_Total
                                    FStar_Syntax_Syntax.t_unit in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____14948 in
                              let uu____14953 =
                                          ...
                                          let uu____15166 =
                                            let uu____15167 =
                                              FStar_List.map
                                                ...
                                                bvs in
                                            FStar_TypeChecker_Rel.close_guard
                                              env2 uu____15167 g2 in
                                          FStar_TypeChecker_Rel.conj_guard
                                            g_lbs uu____15166 in
                                        let cres3 =
                                          FStar_TypeChecker_Util.close_lcomp
                                            env2 bvs cres2 in
                                        let tres =
                              ...
                              (let uu____15428 =
                                 let uu____15435 =
                                   let uu____15436 =
                                     FStar_Syntax_Util.type_u () in
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____15436 in
                                 tc_check_tot_or_gtot_term
                         ...
                         FStar_TypeChecker_Util.strengthen_precondition
                           (FStar_Pervasives_Native.Some
                              (fun uu____15739  ->
                                 FStar_Util.return_all
                                   FStar_TypeChecker_Err.ill_kinded_type))
                           uu____15735 e12 c1 wf_annot in
             ...
             | (univ_opening,univ_vars1) ->
                 ...
                 then
                   ...
                   (let uu____15888 = FStar_Syntax_Util.type_u () in
                    ...
                    | (k,uu____15908) ->
                        let uu____15909 = tc_check_tot_or_gtot_term env1 t1 k in
                               ...
                               then
                                 let uu____15935 =
                                   let uu____15936 =
                                     FStar_Syntax_Syntax.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname in
                                   FStar_Range.string_of_range uu____15936 in
                                 let uu____15937 =
             ...
             | (b1,env',g,u) ->
                 ...
                 (match uu____16157 with
                  | (bs3,env'1,g',us) ->
                      ...
                      ((b1 :: bs3), env'1, uu____16210, (u :: us)))) in
      aux env bs
and tc_pats:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax,FStar_Syntax_Syntax.aqual)
           ...
           fun uu____16428  ->
             ...
             | (pats1,g) ->
                 ...
                 (match uu____16453 with
                  | (args,g') ->
                      let uu____16466 = FStar_TypeChecker_Rel.conj_guard g g' in
      ...
      (let env1 =
       ...
       let uu____16622 =
         ...
         | FStar_Errors.Error (e1,msg,uu____16657) ->
             ...
             FStar_Errors.raise_error (e1, msg) uu____16658 in
             ...
             (let uu____16684 =
                let uu____16689 =
                  ...
                  FStar_Util.format1
                    ...
                    uu____16690 in
                (FStar_Errors.Fatal_UnexpectedImplictArgument, uu____16689) in
           ...
           | (bs1,c1) ->
               ...
               let u_c =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     ...
                     level_of_type env trepr uu____17115 in
               let u =
            ...
            | FStar_Syntax_Syntax.Tm_match (uu____17474,hd4::uu____17476) ->
                ...
                (match uu____17541 with
                 | (uu____17556,uu____17557,hd5) ->
                     let uu____17575 = FStar_Syntax_Util.head_and_args hd5 in
                ...
                let bs_t_opt =
                  ...
                  then
                    ...
                    | (bs1,rest) ->
                        ...
                        let uu____18585 =
                          let uu____18590 = FStar_Syntax_Syntax.mk_Total t1 in
                    ...
                    if n_args = n_bs
                    then
                      (let uu____18626 = FStar_Syntax_Subst.open_comp bs c in
                     ...
                     | (bs1,t1) ->
                         let subst1 =
                           FStar_List.map2
                             ...
                             args in
                         let uu____18729 = FStar_Syntax_Subst.subst subst1 t1 in
        ...
        fun k  ->
          ...
          let slow_check uu____18998 =
            ...
            then
              ...
              (let uu____19010 = env2.FStar_TypeChecker_Env.tc_term env2 t in
               match uu____19010 with | (uu____19017,uu____19018,g) -> g) in
          let uu____19020 =
             ...
             | FStar_Pervasives_Native.Some k' ->
                 ((let uu____19028 =
                   ...
                   then
                     ...
                     let uu____19030 = FStar_Syntax_Print.term_to_string t in
                     let uu____19031 = FStar_Syntax_Print.term_to_string k' in
                     let uu____19032 = FStar_Syntax_Print.term_to_string k in
                  ...
                  (let b = FStar_TypeChecker_Rel.subtype_nosmt env2 k' k in
                   (let uu____19036 =
                    ...
                    then
                      let uu____19037 =
                        FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos in
                      let uu____19038 = FStar_Syntax_Print.term_to_string t in
                      let uu____19039 = FStar_Syntax_Print.term_to_string k' in
                      let uu____19040 = FStar_Syntax_Print.term_to_string k in
