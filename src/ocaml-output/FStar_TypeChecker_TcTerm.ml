...
let guard = (let _0_581 = (let _0_580 = (FStar_List.map FStar_Syntax_Syntax.mk_binder bvs)
in (FStar_TypeChecker_Rel.close_guard _0_580 g2))
in (FStar_TypeChecker_Rel.conj_guard g_lbs _0_581))
in (
...
let uu____8284 = (let _0_586 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let uu____8303 = (let _0_585 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term _0_585 lb.FStar_Syntax_Syntax.lbdef))
...
in (FStar_All.pipe_right _0_586 FStar_List.unzip))
...
let uu____8390 = (let _0_587 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (Some ((fun uu____8395 -> FStar_TypeChecker_Err.ill_kinded_type))) _0_587 e1 c1 wf_annot))
...
| true -> begin
(let _0_590 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _0_589 = (FStar_Syntax_Print.term_to_string c1.FStar_Syntax_Syntax.res_typ)
in (let _0_588 = (FStar_TypeChecker_Rel.guard_to_string env g1)
...
| true -> begin
(let _0_591 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in ((Some (t)), (FStar_TypeChecker_Rel.trivial_guard), (univ_vars), (univ_opening), (_0_591)))
end
| uu____8462 -> begin
(
...
| true -> begin
(let _0_593 = (FStar_Range.string_of_range (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname))
in (let _0_592 = (FStar_Syntax_Print.term_to_string t)
...
let t = (norm env1 t)
in (let _0_594 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in ((Some (t)), (g), (univ_vars), (univ_opening), (_0_594))));
)
end))
end))
end)))
...
| true -> begin
(let _0_597 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_596 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_595 = (FStar_Syntax_Print.term_to_string tu)
...
| true -> begin
(let _0_599 = (FStar_Syntax_Print.bv_to_string (Prims.fst x))
...
| (bs, env', g', us) -> begin
(let _0_602 = (let _0_601 = (FStar_TypeChecker_Rel.close_guard ((b)::[]) g')
in (FStar_TypeChecker_Rel.conj_guard g _0_601))
in (((b)::bs), (env'), (_0_602), ((u)::us)))
end))
end))
end))
in (aux env bs)))
...
| true -> begin
(let _0_605 = (FStar_Syntax_Syntax.mk_Total (FStar_Syntax_Util.comp_result c))
in ((_0_605), (false)))
end
| uu____8808 -> begin
(let _0_606 = (FStar_Syntax_Syntax.mk_GTotal (FStar_Syntax_Util.comp_result c))
in ((_0_606), (true)))
end))
...
in ((e), ((FStar_Syntax_Util.lcomp_of_comp target_comp)), (_0_607)))
end
| uu____8820 -> begin
(match (allow_ghost) with
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_608 = (FStar_TypeChecker_Err.expected_ghost_expression e c)
in ((_0_608), (e.FStar_Syntax_Syntax.pos))))))
end
| uu____8828 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_609 = (FStar_TypeChecker_Err.expected_pure_expression e c)
in ((_0_609), (e.FStar_Syntax_Syntax.pos))))))
end)
end))
end)))))
end))
...
| true -> begin
(let _0_610 = (FStar_Syntax_Print.term_to_string e)
...
(Prims.raise (FStar_Errors.Error ((let _0_611 = (FStar_TypeChecker_Env.get_range env)
in (((Prims.strcat "Implicit argument: " msg)), (_0_611))))))
end
...
| uu____8897 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_614 = (let _0_612 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" _0_612))
...
let level_of_type_fail = (fun env e t -> (Prims.raise (FStar_Errors.Error ((let _0_617 = (let _0_615 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format2 "Expected a term of type \'Type\'; got %s : %s" _0_615 t))
in (let _0_616 = (FStar_TypeChecker_Env.get_range env)
in ((_0_617), (_0_616))))))))
...
| FStar_TypeChecker_Common.NonTrivial (f) -> begin
(let _0_618 = (FStar_Syntax_Print.term_to_string t)
in (level_of_type_fail env e _0_618))
end
| uu____8949 -> begin
(FStar_TypeChecker_Rel.force_trivial_guard env g)
end);
...
((match (((FStar_List.length us) <> (FStar_List.length us'))) with
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_619 = (FStar_TypeChecker_Env.get_range env)
in (("Unexpected number of universe instantiations"), (_0_619))))))
end
| uu____9111 -> begin
(FStar_List.iter2 (fun u' u -> (match (u') with
| FStar_Syntax_Syntax.U_unif (u'') -> begin
...
| (b, uu____9159) -> begin
(let _0_620 = (universe_of_aux env b.FStar_Syntax_Syntax.sort)
in (level_of_type env b.FStar_Syntax_Syntax.sort _0_620))
end)) bs)
in (
...
in (let _0_621 = (universe_of_aux env res)
in (level_of_type env res _0_621)))
in (
...
| Some (trepr) -> begin
(let _0_622 = (universe_of_aux env trepr)
in (level_of_type env trepr _0_622))
end))
in (
...
(let _0_623 = (universe_of_aux env hd)
in ((_0_623), (args)))
end
...
| true -> begin
(let _0_625 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_624 = (FStar_Syntax_Print.term_to_string hd)
...
((let _0_626 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
...
in (level_of_type_fail env e _0_627))
end))
end)))
end)))
end
...
let universe_of : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.universe = (fun env e -> (let _0_628 = (universe_of_aux env e)
in (level_of_type env e _0_628)))
...
let uu____9644 = (tc_binders env tps)
