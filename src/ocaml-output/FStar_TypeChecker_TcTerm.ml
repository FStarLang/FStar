                      ...
                      | FStar_Pervasives_Native.Some (b, asc) ->
                          ...
                          (match uu___5 with
                           | (env1, uu___6) ->
                               let uu___7 =
                                 let uu___8 =
                                   FStar_Syntax_Subst.open_ascription [b] asc in
                                 match uu___8 with
                                 | (bs, asc1) ->
                                ...
                                | (b1, asc1) ->
                                    ...
                                    let uu___8 =
                                      ...
                                      | (FStar_Pervasives.Inr c,
                                         FStar_Pervasives_Native.None) ->
                                          let uu___9 = tc_comp env_asc c in
                                          (match uu___9 with
                                           | (c2, uu___10, g) ->
                    ...
                    (match uu___4 with
                     | (env_branches, ret_opt1, g11) ->
                         ...
                         let uu___5 =
                           match ret_opt1 with
                           | FStar_Pervasives_Native.Some
                               (b, (FStar_Pervasives.Inr c, uu___6)) ->
                               let c2 =
                                 ...
                                 let uu___8 =
                                   FStar_Compiler_Effect.op_Bar_Greater
                                     ...
                                     (FStar_Compiler_List.map
                                        (fun uu___9 ->
                                           match uu___9 with
                                           | (uu___10, f, uu___11, uu___12,
                                              uu___13, g, b1) -> (f, g, b1))) in
                                         ...
                                         let res_t =
                                           let uu___8 =
                                             FStar_TypeChecker_Env.expected_typ
                                               env_branches in
                                           FStar_Compiler_Effect.op_Bar_Greater
                                             uu___8 FStar_Compiler_Util.must in
                                         let uu___8 =
                               ...
                               (fun attr' ->
                                  let uu___3 =
                                    FStar_Compiler_List.existsb
                                      (fun attr ->
                                         let uu___4 =
                                           FStar_Syntax_Util.eq_tm attr attr' in
