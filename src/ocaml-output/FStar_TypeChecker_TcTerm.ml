                           ...
                           ((let uu____265 =
                            ...
                            (let msg =
                             ...
                             | (lc,g) ->
                                 ...
                                 (_0_271, (set_lcomp_result lc t'), g)))))) in
                 ...
                 ((let uu____379 =
                  ...
                  (let c = norm_c env c in
                   ...
                   (let uu____385 =
                    ...
                    | (e,uu____393,g) ->
                        let g =
                          let _0_280 = FStar_TypeChecker_Env.get_range env in
        ...
        (match uu____516 with
         ...
         | Some (x,uu____536) ->
             let _0_287 =
               ...
               FStar_Util.format1
                 "Pattern misses at least one bound variable: %s" _0_286 in
                 ...
                 | (e,c,g) ->
                     ...
                     (match uu____1149 with
                      | (pats,g') ->
                          ...
                          let _0_303 = FStar_TypeChecker_Rel.conj_guard g g' in
                          (_0_304, c, _0_303))))
       | FStar_Syntax_Syntax.Tm_meta
           (e,FStar_Syntax_Syntax.Meta_desugared
                          ...
                          let e =
                            (FStar_Syntax_Syntax.mk
                              ...
                              (Some
                                 ((c.FStar_Syntax_Syntax.res_typ).FStar_Syntax_Syntax.n))
                              top.FStar_Syntax_Syntax.pos in
                          let _0_309 = FStar_TypeChecker_Rel.conj_guard g1 g2 in
                          (e, c, _0_309)))
            | uu____1295 ->
                          ...
                          (match uu____1413 with
                           | (e,expected_c,g'') ->
                               ...
                               let f =
                                 ...
                                 FStar_TypeChecker_Rel.conj_guard g _0_313 in
                               let uu____1449 =
                 ...
                 (match uu____1748 with
                  | (reify_op,uu____1762) ->
                      ...
                      (match uu____1810 with
                       | (e,c,g') ->
                           let _0_322 = FStar_TypeChecker_Rel.conj_guard g g' in
                           (e, c, _0_322)))))
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               ...
               Prims.raise
                 (FStar_Errors.Error
                    (let _0_323 =
                     ...
                     (_0_323, (e.FStar_Syntax_Syntax.pos)))) in
             ...
             | (head,chead,g_head) ->
                 let uu____2125 =
                   ...
                   then
                     ...
                     (let _0_350 = FStar_TypeChecker_Env.expected_typ env0 in
    ...
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_name x ->
          ...
          (FStar_TypeChecker_Common.insert_bv x t;
           (let e = FStar_Syntax_Syntax.bv_to_name x in
            let uu____2887 = FStar_TypeChecker_Util.maybe_instantiate env e t in
            match uu____2887 with
            | (e,t,implicits) ->
                let tc =
                  let uu____2900 = FStar_TypeChecker_Env.should_verify env in
                  if uu____2900
                  then FStar_Util.Inl t
                  else
                    FStar_Util.Inr
      ...
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          ...
          (match uu____3053 with
           | (bs,c) ->
               let env0 = env in
               let uu____3062 = FStar_TypeChecker_Env.clear_expected_typ env in
                              ...
                              (check_smt_pat env e bs c;
                               (let u = FStar_Syntax_Syntax.U_max (uc :: us) in
                                ...
                                let g =
                                  ...
                                  FStar_TypeChecker_Rel.conj_guard g _0_386 in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          ...
          (match uu____3153 with
           | (x,phi) ->
               let env0 = env in
               let uu____3162 = FStar_TypeChecker_Env.clear_expected_typ env in
               (match uu____3162 with
                | (env,uu____3170) ->
                    let uu____3173 =
                      let _0_389 = FStar_List.hd x in tc_binder env _0_389 in
          ...
          (match uu____3370 with
           | (k,u) ->
               ...
               (match uu____3378 with
                | (t,uu____3386,g) ->
                    let _0_398 = FStar_Syntax_Syntax.mk_GTotal' t (Some u) in
                    (_0_398, u, g)))
                                    ...
                                    (FStar_List.map
                                       (fun uu___81_3554  ->
                                          ...
                                          | f ->
                                              (f,
                                                FStar_TypeChecker_Rel.trivial_guard))) in
                                FStar_All.pipe_right _0_403 FStar_List.unzip in
              ...
              (FStar_Errors.Error
                 (let _0_406 =
                    FStar_TypeChecker_Err.expected_a_term_of_type_t_got_a_function
                      env msg t top in
                  (_0_406, (top.FStar_Syntax_Syntax.pos)))) in
                       ...
                       ((match (imp, imp') with
                        ...
                        (let expected_t =
                         ...
                         | (t,g) ->
                             ...
                             let subst =
                               let _0_414 = FStar_Syntax_Syntax.bv_to_name hd in
                ...
                let rec as_function_typ norm t =
                                    ...
                                    | Some (FStar_Util.Inl more_bs) ->
                                        ...
                                        then
                                          ...
                                          fail
                                            ...
                                            t) in
                             let _0_422 = check_binders env bs bs_expected in
                  ...
                  | uu____4576 ->
                      ...
                      then
                        ...
                        (let uu____4590 = expected_function_typ env None body in
                     ...
                     | (body,cbody,guard_body) ->
                         ...
                         ((let uu____4696 =
                           ...
                           then
                             ...
                             let _0_429 =
                               let _0_428 = cbody.FStar_Syntax_Syntax.comp () in
                               FStar_All.pipe_left
                                 FStar_Syntax_Print.comp_to_string _0_428 in
                             FStar_Util.print2
                          ...
                          (let uu____4706 =
                             let _0_432 =
                               let _0_431 = cbody.FStar_Syntax_Syntax.comp () in
                               (body, _0_431) in
                                   ...
                                   Some
                                     (let _0_436 =
                                      ...
                                      FStar_All.pipe_right _0_436
                                        (fun _0_435  -> FStar_Util.Inl _0_435)) in
                             ...
                             let _0_449 =
                               FStar_Syntax_Syntax.mk_Total
                                 (let _0_448 =
                                  ...
                                  FStar_All.pipe_left
                                    (FStar_Syntax_Subst.subst subst) _0_448) in
                             FStar_All.pipe_left
                               FStar_Syntax_Util.lcomp_of_comp _0_449 in
                           (_0_450, g) in
                           ...
                           (let targ =
                            ...
                            (let targ =
                             ...
                             (let uu____5484 =
                              ...
                              if uu____5484
                              then
                                let _0_461 = FStar_Syntax_Print.tag_of_term e in
                                let _0_460 =
                                  FStar_Syntax_Print.term_to_string e in
                                let _0_459 =
                                  FStar_Syntax_Print.term_to_string targ in
                                    ...
                                    (let uu____5562 =
                                     ...
                                     then
                                       let subst =
                                         ...
                                         maybe_extend_subst subst _0_463 e in
                                       tc_args head_info
                                         (subst,
                                           ((arg, (Some x),
                                              (FStar_Util.Inr c)) ::
                         ...
                         (FStar_Errors.Error
                            (let _0_487 =
                               FStar_TypeChecker_Err.expected_function_typ
                                 env tf in
                             (_0_487, (head.FStar_Syntax_Syntax.pos)))) in
               let _0_489 =
                 let _0_488 = FStar_Syntax_Util.unrefine thead in
                 FStar_TypeChecker_Normalize.normalize
                   [FStar_TypeChecker_Normalize.Beta;
                   FStar_TypeChecker_Normalize.WHNF] env _0_488 in
                  ...
                  (match uu____6174 with
                   | (args,guard,ghost) ->
                       ...
                       let c =
                         if ghost
                         then
                           let _0_495 = FStar_Syntax_Syntax.mk_GTotal res_t in
        ...
        | (pattern,when_clause,branch_exp) ->
            ...
            (match uu____6339 with
             | (cpat,uu____6359,cbr) ->
                 let tc_pat allow_implicits pat_t p0 =
                   ...
                   | (pat_bvs,exps,p) ->
                       ((let uu____6423 =
                         ...
                         if uu____6423
                         then
                           let _0_497 = FStar_Syntax_Print.pat_to_string p0 in
                           let _0_496 = FStar_Syntax_Print.pat_to_string p in
                                          ...
                                          | (e,lc,g) ->
                                              ((let uu____6477 =
                                               ...
                                               (let g' =
                                                ...
                                                (e, e')))))) in
                               FStar_All.pipe_right _0_513 FStar_List.unzip in
                 ...
                 let uu____6607 =
                   let _0_514 = FStar_TypeChecker_Env.push_bv env scrutinee in
                      ...
                      (match uu____6626 with
                       | (pattern,pat_bvs,pat_env,disj_exps,norm_disj_exps)
                           ...
                           (match uu____6654 with
                            | (when_clause,g_when) ->
                                let uu____6700 = tc_term pat_env branch_exp in
                      ...
                      FStar_List.hd
                        (let _0_553 =
                           let _0_552 =
                             ...
                             ((lb.FStar_Syntax_Syntax.lbname), e1, _0_551) in
                           [_0_552] in
                         FStar_TypeChecker_Util.generalize env _0_553) in
                      ...
                      then
                        ...
                        (FStar_TypeChecker_Rel.force_trivial_guard env g1;
                         (let c =
                          ...
                          let e2 =
                            let uu____7209 = FStar_Syntax_Util.is_pure_comp c in
                            if uu____7209
                            then e2
                            else
                              (FStar_Syntax_Syntax.mk
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          (match uu____7283 with
           | (e1,uu____7297,c1,g1,annotated) ->
               ...
               let uu____7303 =
                 let _0_561 =
                   let _0_560 = FStar_Syntax_Syntax.mk_binder x in [_0_560] in
                    ...
                    (match uu____7317 with
                     | (e2,c2,g2) ->
                         ...
                         let e =
                           (FStar_Syntax_Syntax.mk
                              (FStar_Syntax_Syntax.Tm_let
                                 (let _0_563 = FStar_Syntax_Subst.close xb e2 in
                                  ((false, [lb]), _0_563))))
                             (Some
                                ((cres.FStar_Syntax_Syntax.res_typ).FStar_Syntax_Syntax.n))
                             e.FStar_Syntax_Syntax.pos in
                           ...
                           let _0_567 =
                             let _0_566 =
                               env.FStar_TypeChecker_Env.universe_of env
                                 c1.FStar_Syntax_Syntax.res_typ in
                             let _0_565 = FStar_Syntax_Syntax.bv_to_name x in
                             FStar_Syntax_Util.mk_eq2 _0_566
                               c1.FStar_Syntax_Syntax.res_typ _0_565 e1 in
                           FStar_All.pipe_left
                             (fun _0_564  ->
    ...
    fun top  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          ...
          (match uu____7387 with
           | (lbs,e2) ->
               let uu____7398 = FStar_TypeChecker_Env.clear_expected_typ env in
                              ...
                              let cres =
                                let _0_580 =
                                  FStar_Syntax_Syntax.mk_Total
                                    FStar_TypeChecker_Common.t_unit in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp _0_580 in
                              (FStar_ST.write e2.FStar_Syntax_Syntax.tk
                                 (Some
                                    (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n));
                               (let uu____7524 =
    ...
    fun top  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((true ,lbs),e2) ->
          ...
          (match uu____7574 with
           | (lbs,e2) ->
               let uu____7585 = FStar_TypeChecker_Env.clear_expected_typ env in
                      ...
                      | (univ_vars,t,check_t) ->
                          ...
                          let t =
                            ...
                            then t
                              ...
                              (let uu____7766 =
                                 let _0_584 =
                                   let _0_583 = FStar_Syntax_Util.type_u () in
               ...
               (fun lb  ->
                  let uu____7823 =
                    let _0_586 =
                      FStar_TypeChecker_Env.set_expected_typ env
                        lb.FStar_Syntax_Syntax.lbtyp in
                    tc_tot_or_gtot_term _0_586 lb.FStar_Syntax_Syntax.lbdef in
             ...
             | (univ_opening,univ_vars) ->
                 ...
                 if
                   top_level &&
                     (Prims.op_Negation env.FStar_TypeChecker_Env.generalize)
                 then
                   let _0_592 = FStar_TypeChecker_Env.set_expected_typ env1 t in
                   ...
                   (let uu____7983 = FStar_Syntax_Util.type_u () in
                    ...
                    | (k,uu____7994) ->
                        let uu____7995 = tc_check_tot_or_gtot_term env1 t k in
            ...
            (match uu____8112 with
             | (b,env',g,u) ->
                 ...
                 (match uu____8135 with
                  | (bs,env',g',us) ->
                      let _0_603 =
                        let _0_602 = FStar_TypeChecker_Rel.close_guard [b] g' in
                        FStar_TypeChecker_Rel.conj_guard g _0_602 in
                      ((b :: bs), env', _0_603, (u :: us)))) in
      aux env bs
and tc_pats:
  FStar_TypeChecker_Env.env ->
    ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
             ...
             Prims.raise
               (FStar_Errors.Error
                  (let _0_612 = FStar_TypeChecker_Env.get_range env in
                   ((Prims.strcat "Implicit argument: " msg), _0_612))) in
...
let rec universe_of_aux:
  ...
  fun env  ->
    fun e  ->
      let uu____8480 = (FStar_Syntax_Subst.compress e).FStar_Syntax_Syntax.n in
           ...
           | (bs,c) ->
               ...
               let u_c =
                 ...
                 | Some trepr ->
                     ...
                     level_of_type env trepr _0_623 in
               let u =
      ...
      | FStar_Syntax_Syntax.Tm_app (hd,args) ->
          let rec type_of_head retry hd args =
            ...
            | uu____8930 ->
                let uu____8931 = FStar_TypeChecker_Env.clear_expected_typ env in
                     ...
                     ((let uu____8951 =
                       ...
                       then
                         let _0_626 =
                           FStar_Range.string_of_range
                             (FStar_TypeChecker_Env.get_range env) in
                         let _0_625 = FStar_Syntax_Print.term_to_string hd in
