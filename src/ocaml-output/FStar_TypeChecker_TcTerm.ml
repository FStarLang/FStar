                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___1753_12801 = envbody  in
                               {
                                 ...
                                 FStar_TypeChecker_Env.strict_args_tab =
                                   (uu___1753_12801.FStar_TypeChecker_Env.strict_args_tab)
                               }  in
                             let uu____12808 =
                            ...
                            (let uu___1844_13517 = envbody1  in
                             {
                               ...
                               FStar_TypeChecker_Env.strict_args_tab =
                                 (uu___1844_13517.FStar_TypeChecker_Env.strict_args_tab)
                             }) body1
                           in
                                  ...
                                  (let uu___1852_13559 = envbody1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.strict_args_tab =
                                       (uu___1852_13559.FStar_TypeChecker_Env.strict_args_tab)
                                   }) c_opt uu____13551
                                 in
                             ...
                             | (targ1,g_ex) ->
                                 ...
                                 let env2 =
                                   let uu___2135_15956 = env1  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.strict_args_tab =
                                       (uu___2135_15956.FStar_TypeChecker_Env.strict_args_tab)
                                   }  in
                                 ((let uu____15958 =
                                     FStar_TypeChecker_Env.debug env2
                                       FStar_Options.High
        ...
        (let uu____20461 =
           let uu____20472 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.strict_args_tab =
                 (uu___2603_20473.FStar_TypeChecker_Env.strict_args_tab)
             }  in
           let uu____20490 =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___2915_22537 = env1  in
            {
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___2915_22537.FStar_TypeChecker_Env.strict_args_tab)
            }  in
          let uu____22539 =
            let uu____22551 =
                                   ...
                                   (let uu___3124_23783 = env01  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.strict_args_tab =
                                        (uu___3124_23783.FStar_TypeChecker_Env.strict_args_tab)
                                    }) t uu____23771
                                  in
                               ...
                               let env3 =
                                 ...
                                 then
                                   let uu___3134_23820 = env2  in
                                   {
                                     ...
                                     FStar_TypeChecker_Env.strict_args_tab =
                                       (uu___3134_23820.FStar_TypeChecker_Env.strict_args_tab)
                                   }
                                 else
                                   FStar_TypeChecker_Env.push_let_binding
                       ...
                       (let uu___3185_24098 = env11  in
                        {
                          ...
                          FStar_TypeChecker_Env.strict_args_tab =
                            (uu___3185_24098.FStar_TypeChecker_Env.strict_args_tab)
                        }) e11
                      in
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___3329_25250 = env  in
         {
           ...
           FStar_TypeChecker_Env.strict_args_tab =
             (uu___3329_25250.FStar_TypeChecker_Env.strict_args_tab)
         }  in
       let uu____25258 =
         try
           (fun uu___3333_25272  ->
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___3365_25436 = env  in
                       {
                         ...
                         FStar_TypeChecker_Env.strict_args_tab =
                           (uu___3365_25436.FStar_TypeChecker_Env.strict_args_tab)
                       }  in
                 ...
                 | (env1,uu____26406) ->
                     let env2 =
                       let uu___3526_26412 = env1  in
                       {
                         ...
                         FStar_TypeChecker_Env.strict_args_tab =
                           (uu___3526_26412.FStar_TypeChecker_Env.strict_args_tab)
                       }  in
                     ((let uu____26417 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3805_28428 = env1  in
            {
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___3805_28428.FStar_TypeChecker_Env.strict_args_tab)
            }  in
        ...
        fun k  ->
          ...
          let env2 =
            let uu___3836_28532 = env1  in
            {
              ...
              FStar_TypeChecker_Env.strict_args_tab =
                (uu___3836_28532.FStar_TypeChecker_Env.strict_args_tab)
            }  in
