                    ...
                    let uu___3 =
                          ...
                          (match uu___4 with
                           | FStar_Pervasives_Native.Some t ->
                               (env, FStar_Pervasives_Native.None,
                                 (FStar_Pervasives_Native.Some t), g1)
                           | FStar_Pervasives_Native.None ->
                      ...
                      | uu___4 ->
                          ...
                          FStar_Errors.raise_error
                            ...
                            uu___5 in
                    (match uu___3 with
                     | (env_branches, asc_opt, res_t_opt, g11) ->
                         let guard_x =
                           FStar_Syntax_Syntax.new_bv
                             (FStar_Pervasives_Native.Some
                         ...
                         let t_eqns =
                           ...
                           FStar_All.pipe_right eqns
                             (FStar_List.map
                                (tc_eqn guard_x env_branches asc_opt1)) in
                         let uu___4 =
                           let uu___5 =
                             FStar_List.fold_right
                               (fun uu___6 ->
                           ...
                           | (cases, g, erasable) ->
                               (match asc_opt with
                                | FStar_Pervasives_Native.None ->
                                    let uu___6 =
                                      let uu___7 =
                                        FStar_All.pipe_right res_t_opt
                                          FStar_Util.must in
                                      FStar_TypeChecker_Util.bind_cases env
                                        uu___7 cases guard_x in
                                    (uu___6, g, erasable)
                                | FStar_Pervasives_Native.Some
                                    (FStar_Util.Inl t, uu___6) ->
                                    let cases1 =
                                      FStar_List.map
                                        (fun uu___7 ->
                                           match uu___7 with
                          ...
                          | (c_branches, g_branches, erasable) ->
                              ...
                              let e =
                                let mk_match scrutinee =
                                  ...
                                  | FStar_Pervasives_Native.Some uu___5 -> e3 in
                                let uu___5 =
                                  FStar_TypeChecker_Util.is_pure_or_ghost_effect
                                            ...
                                            (let uu___10 = envbody2 in
                                             {
                                               ...
                                               FStar_TypeChecker_Env.type_of_well_typed
                                                 =
                                                 (uu___10.FStar_TypeChecker_Env.type_of_well_typed);
                                               FStar_TypeChecker_Env.universe_of
                                                 =
                                                              ...
                                                              let env1 =
                                                                    ...
                                                                    scrutinee in
                                                                {
                                                                  ...
                                                                  FStar_TypeChecker_Env.type_of_well_typed
                                                                    =
                                                                    (
                                                                    uu___15.FStar_TypeChecker_Env.type_of_well_typed);
                                                                  FStar_TypeChecker_Env.universe_of
                                                                    =
                                                                    (
