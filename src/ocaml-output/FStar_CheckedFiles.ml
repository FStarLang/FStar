open Prims
let (cache_version_number : Prims.int) = (Prims.parse_int "12")
type tc_result =
  {
                ...
                let uu____395 =
                  (FStar_Parser_Dep.is_interface fn2) &&
                    (let uu____398 =
                     ...
                     uu____398 = module_name) in
                Prims.op_Negation uu____395)) in
      let binary_deps1 =
        FStar_List.sortWith
          (fun fn11 ->
             fun fn2 ->
               let uu____414 = FStar_Parser_Dep.lowercase_module_name fn11 in
               let uu____416 = FStar_Parser_Dep.lowercase_module_name fn2 in
               FStar_String.compare uu____414 uu____416) binary_deps in
    ...
    fun fn ->
      fun checked_fn ->
        ...
        | (Valid uu____925, uu____926) ->
            let uu____938 =
              let uu____939 = FStar_All.pipe_right checked_fn load_tc_result in
    ...
    let cache_file =
      try
        (fun uu___165_1405 ->
           match () with
           | () ->
               let uu____1409 = FStar_Parser_Dep.cache_file_name file_name in
  ...
  fun env ->
    fun fn ->
      let load_it uu____1477 =
        ...
        let uu____1561 =
          let uu____1567 =
            FStar_TypeChecker_Env.dep_graph
              env.FStar_Extraction_ML_UEnv.env_tcenv in
        ...
        | uu____1583 ->
            failwith
              "load_checked_file_tc_result must have an Invalid or Valid entry" in
...
let (store_value_to_cache : Prims.string -> checked_file_entry -> unit) =
  fun cache_file -> fun data -> FStar_Util.save_value_to_file cache_file data
