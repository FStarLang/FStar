  ...
  fun deps  ->
    fun fn  ->
      ...
      let interface_checked_file_name =
        let uu___ = (FStar_Parser_Dep.is_implementation fn1) && has_interface
           in
        if uu___
        then
          let uu___1 =
             ...
             (fun fn2  ->
                let uu___1 =
                  (FStar_Parser_Dep.is_interface fn2) &&
                    (let uu___2 = FStar_Parser_Dep.lowercase_module_name fn2
                        in
                     uu___2 = module_name)
                   in
        ...
        FStar_List.sortWith
          (fun fn11  ->
             fun fn2  ->
               ...
               FStar_String.compare uu___ uu___1) binary_deps
         in
        ...
        | fn2::deps1 ->
            ...
            (match digest with
             ...
             | FStar_Util.Inr dig ->
                 let uu___1 =
                   let uu___2 =
                     let uu___3 = FStar_Parser_Dep.lowercase_module_name fn2
                        in
                     (uu___3, dig)  in
                   uu___2 :: out  in
                 hash_deps uu___1 deps1)
         in
      ...
      fun checked_fn  ->
        ...
        | (Valid uu___,uu___1) ->
            ...
            FStar_All.pipe_right uu___2
              (fun uu___3  -> FStar_Util.Inr uu___3)
        | (Unknown ,parsing_data) ->
            ...
            (match uu___ with
             ...
             | FStar_Util.Inr deps_dig' ->
                 let uu___1 = FStar_All.pipe_right checked_fn load_tc_result
                    in
                 (match uu___1 with
                  | (deps_dig,tc_result1) ->
                      ...
                      then
                        let elt1 =
                          let uu___2 =
                            let uu___3 = FStar_Util.digest_of_file checked_fn
                               in
                            Valid uu___3  in
        ...
        let fail msg cache_file1 =
          ...
          then
            (FStar_ST.op_Colon_Equals already_failed true;
             (let uu___2 =
                let uu___3 = FStar_Range.mk_pos Prims.int_zero Prims.int_zero
                   in
                let uu___4 = FStar_Range.mk_pos Prims.int_zero Prims.int_zero
                   in
