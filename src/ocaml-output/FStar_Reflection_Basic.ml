...
| FStar_Const.Const_string (bs, uu____1519) -> begin
...
let uu____1526 = (FStar_Syntax_Print.const_to_string c)
in (FStar_Util.format1 "unknown constant: %s" uu____1526))
in (failwith uu____1525))
end))
...
| FStar_Syntax_Syntax.Tm_meta (t2, uu____1533) -> begin
(inspect t2)
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____1539 = (FStar_Syntax_Syntax.mk_binder bv)
in FStar_Reflection_Data.Tv_Var (uu____1539))
end
...
let uu____1582 = (last args)
in (match (uu____1582) with
| (a, q) -> begin
(

let q' = (match (q) with
| FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____1602)) -> begin
FStar_Reflection_Data.Q_Implicit
end
...
let uu____1612 = (init args)
in (FStar_Syntax_Syntax.mk_Tm_app hd1 uu____1612))
in (uu____1611 FStar_Pervasives_Native.None t1.FStar_Syntax_Syntax.pos))
in ((uu____1608), (((a), (q')))))
in FStar_Reflection_Data.Tv_App (uu____1603)))
end))
end
| FStar_Syntax_Syntax.Tm_abs ([], uu____1631, uu____1632) -> begin
(failwith "inspect: empty arguments on Tm_abs")
end
| FStar_Syntax_Syntax.Tm_abs (bs, t2, k) -> begin
(

let uu____1674 = (FStar_Syntax_Subst.open_term bs t2)
...
let uu____1706 = (FStar_Syntax_Util.abs bs2 t3 k)
in ((b), (uu____1706)))
in FStar_Reflection_Data.Tv_Abs (uu____1701))
end)
end))
end
| FStar_Syntax_Syntax.Tm_type (uu____1711) -> begin
FStar_Reflection_Data.Tv_Type (())
end
...
let uu____1745 = (FStar_Syntax_Subst.open_comp bs k)
...
let uu____1777 = (FStar_Syntax_Util.arrow bs2 k1)
in ((b), (uu____1777)))
in FStar_Reflection_Data.Tv_Arrow (uu____1772))
end)
end))
end
...
let uu____1793 = (FStar_Syntax_Subst.open_term ((b)::[]) t2)
...
let uu____1832 = (inspect_const c)
in FStar_Reflection_Data.Tv_Const (uu____1832))
end
...
let uu____1864 = (FStar_Syntax_Unionfind.uvar_id u)
in ((uu____1864), (t2)))
in FStar_Reflection_Data.Tv_Uvar (uu____1859))
end
...
let uu____1914 = (inspect_const c)
in FStar_Reflection_Data.Pat_Constant (uu____1914))
end
...
let uu____1940 = (FStar_List.map (fun uu____1952 -> (match (uu____1952) with
| (p1, uu____1960) -> begin
(inspect_pat p1)
end)) ps)
in ((fv), (uu____1940)))
in FStar_Reflection_Data.Pat_Cons (uu____1933))
end
...
| FStar_Syntax_Syntax.Pat_dot_term (uu____1969) -> begin
...
let brs2 = (FStar_List.map (fun uu___80_2013 -> (match (uu___80_2013) with
| (pat, uu____2035, t3) -> begin
(

let uu____2053 = (inspect_pat pat)
in ((uu____2053), (t3)))
end)) brs1)
...
let uu____2068 = (FStar_Syntax_Print.tag_of_term t1)
in (

let uu____2069 = (FStar_Syntax_Print.term_to_string t1)
...
let uu____2086 = (FStar_Util.string_of_int i)
in ((uu____2086), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____2075))
end
| FStar_Reflection_Data.C_True -> begin
...
| FStar_Reflection_Data.Tv_Var (bv, uu____2105) -> begin
...
let uu____2123 = (FStar_Syntax_Syntax.as_arg r)
in (uu____2123)::[])
in (FStar_Syntax_Util.mk_app l uu____2114))
end
| FStar_Reflection_Data.Q_Implicit -> begin
(
...
let uu____2133 = (FStar_Syntax_Syntax.iarg r)
in (uu____2133)::[])
in (FStar_Syntax_Util.mk_app l uu____2124))
end)
end
...
let uu____2138 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow ((b)::[]) uu____2138))
end
| FStar_Reflection_Data.Tv_Type (()) -> begin
FStar_Syntax_Util.ktype
end
| FStar_Reflection_Data.Tv_Refine ((bv, uu____2142), t) -> begin
...
let uu____2153 = (pack_const c)
in FStar_Syntax_Syntax.Tm_constant (uu____2153))
in (FStar_Syntax_Syntax.mk uu____2152))
in (uu____2149 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____2177 = (pack_const c)
in FStar_Syntax_Syntax.Pat_constant (uu____2177))
in (FStar_All.pipe_left wrap uu____2176))
end
| FStar_Reflection_Data.Pat_Cons (fv, ps) -> begin
(
...
let uu____2200 = (FStar_List.map (fun p1 -> (

let uu____2214 = (pack_pat p1)
in ((uu____2214), (false)))) ps)
in ((fv), (uu____2200)))
in FStar_Syntax_Syntax.Pat_cons (uu____2187))
in (FStar_All.pipe_left wrap uu____2186))
end
| FStar_Reflection_Data.Pat_Var (bv) -> begin
...
let brs1 = (FStar_List.map (fun uu___81_2260 -> (match (uu___81_2260) with
| (pat, t1) -> begin
(

let uu____2277 = (pack_pat pat)
in ((uu____2277), (FStar_Pervasives_Native.None), (t1)))
end)) brs)
in (
...
let uu____2299 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____2350 = (FStar_Syntax_Util.un_uinst hd1)
...
let uu____2448 = (FStar_Syntax_Embeddings.embed_list embed_fvar FStar_Reflection_Data.fstar_refl_fvar l)
in (FStar_Syntax_Syntax.as_arg uu____2448))
in (uu____2447)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_UnfoldOnly uu____2446))
in (uu____2445 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end))
...
let uu____2456 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____2507 = (FStar_Syntax_Util.un_uinst hd1)
in uu____2507.FStar_Syntax_Syntax.n)
in ((uu____2506), (args)))
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((l, uu____2580))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_UnfoldOnly_lid) -> begin
(

let uu____2605 = (FStar_Syntax_Embeddings.unembed_list unembed_fvar l)
in FStar_Reflection_Data.UnfoldOnly (uu____2605))
end
| uu____2608 -> begin
...
| FStar_Pervasives_Native.Some (FStar_Util.Inl (uu____2673), rng) -> begin
FStar_Reflection_Data.Unk
end
| FStar_Pervasives_Native.Some (FStar_Util.Inr (se, us), rng) -> begin
(match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid1, us1, bs, t, uu____2774, dc_lids) -> begin
(
...
let uu____2791 = (FStar_TypeChecker_Env.lookup_qname env dc_lid)
in (match (uu____2791) with
| FStar_Pervasives_Native.Some (FStar_Util.Inr (se1, us2), rng1) -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (lid2, us3, t1, uu____2864, n1, uu____2866) -> begin
(

let uu____2871 = (

let uu____2876 = (FStar_Ident.path_of_lid lid2)
in ((uu____2876), (t1)))
in FStar_Reflection_Data.Ctor (uu____2871))
end
| uu____2881 -> begin
(failwith "wat 1")
end)
...
let uu____2920 = (FStar_Syntax_Embeddings.embed_string_list nm)
in (FStar_Syntax_Syntax.as_arg uu____2920))
in (
...
let uu____2925 = (embed_term t)
in (FStar_Syntax_Syntax.as_arg uu____2925))
in (uu____2924)::[])
in (uu____2919)::uu____2921))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Ctor uu____2918))
in (uu____2917 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end))
...
let uu____2933 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____2984 = (FStar_Syntax_Util.un_uinst hd1)
in uu____2984.FStar_Syntax_Syntax.n)
in ((uu____2983), (args)))
in (match (uu____2970) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((nm, uu____2997))::((t2, uu____2999))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_Ctor_lid) -> begin
(

let uu____3034 = (

let uu____3039 = (FStar_Syntax_Embeddings.unembed_string_list nm)
in (

let uu____3042 = (unembed_term t2)
in ((uu____3039), (uu____3042))))
in FStar_Reflection_Data.Ctor (uu____3034))
end
| uu____3045 -> begin
...
let uu____3077 = (FStar_Syntax_Embeddings.embed_string_list nm)
in (FStar_Syntax_Syntax.as_arg uu____3077))
in (
...
let uu____3082 = (embed_binders bs)
in (FStar_Syntax_Syntax.as_arg uu____3082))
in (
...
let uu____3087 = (embed_term t)
in (FStar_Syntax_Syntax.as_arg uu____3087))
in (
...
let uu____3092 = (FStar_Syntax_Embeddings.embed_list embed_ctor FStar_Reflection_Data.fstar_refl_ctor dcs)
in (FStar_Syntax_Syntax.as_arg uu____3092))
in (uu____3091)::[])
in (uu____3086)::uu____3088))
in (uu____3081)::uu____3083))
in (uu____3076)::uu____3078))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Sg_Inductive uu____3075))
in (uu____3074 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____3100 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____3151 = (FStar_Syntax_Util.un_uinst hd1)
in uu____3151.FStar_Syntax_Syntax.n)
in ((uu____3150), (args)))
in (match (uu____3137) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((nm, uu____3164))::((bs, uu____3166))::((t2, uu____3168))::((dcs, uu____3170))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_Sg_Inductive_lid) -> begin
(

let uu____3225 = (

let uu____3238 = (FStar_Syntax_Embeddings.unembed_string_list nm)
in (

let uu____3241 = (unembed_binders bs)
in (

let uu____3244 = (unembed_term t2)
in (

let uu____3245 = (FStar_Syntax_Embeddings.unembed_list unembed_ctor dcs)
in ((uu____3238), (uu____3241), (uu____3244), (uu____3245))))))
in FStar_Reflection_Data.Sg_Inductive (uu____3225))
end
...
let type_of_binder : 'Auu____3290 . (FStar_Syntax_Syntax.bv * 'Auu____3290)  ->  FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax = (fun b -> (match (b) with
| (b1, uu____3306) -> begin
...
let fresh_binder : 'Auu____3321 . FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.bv * 'Auu____3321 FStar_Pervasives_Native.option) = (fun t -> (

let uu____3332 = (FStar_Syntax_Syntax.gen_bv "__refl" FStar_Pervasives_Native.None t)
in ((uu____3332), (FStar_Pervasives_Native.None))))
