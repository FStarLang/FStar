        ...
        (match uu____3671 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3700)::(t2,uu____3702)::[]) when
             ...
             ->
             let uu____3737 = FStar_Syntax_Embeddings.unembed_string_list nm
                in
         ...
         | uu____3758 ->
             ((let uu____3772 =
                 let uu____3777 =
                   ...
                   FStar_Util.format1 "Not an embedded ctor: %s" uu____3778
                    in
    ...
    fun sev  ->
      ...
      | FStar_Reflection_Data.Sg_Inductive (nm,bs,t,dcs) ->
          let uu____3797 =
            ...
            FStar_Syntax_Syntax.mk_Tm_app
              FStar_Reflection_Data.ref_Sg_Inductive uu____3798
             in
        ...
        (match uu____3893 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3922)::(bs,uu____3924)::(t2,uu____3926)::(dcs,uu____3928)::[])
             ...
             ->
             let uu____3983 = FStar_Syntax_Embeddings.unembed_string_list nm
                in
