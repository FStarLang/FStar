...
let (set_sigelt_attrs :
  ...
  fun attrs  ->
    fun se  ->
      let uu___241_1579 = se  in
      {
        FStar_Syntax_Syntax.sigel = (uu___241_1579.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___241_1579.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals =
          (uu___241_1579.FStar_Syntax_Syntax.sigquals);
        FStar_Syntax_Syntax.sigmeta =
          (uu___241_1579.FStar_Syntax_Syntax.sigmeta);
