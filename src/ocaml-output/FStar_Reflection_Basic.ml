...
let (pack_fv : Prims.string Prims.list -> FStar_Syntax_Syntax.fv) =
  fun ns ->
    ...
    let attr =
      let uu____35 = FStar_Ident.lid_equals lid FStar_Parser_Const.cons_lid in
      if uu____35
      then FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
      else
        (let uu____39 = FStar_Ident.lid_equals lid FStar_Parser_Const.nil_lid in
         if uu____39
         then FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
         else
           (let uu____43 =
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_match (t3, brs) ->
                ...
                let uu____529 =
                  FStar_List.map
                    (fun uu____541 ->
                       ...
                       | (p1, uu____549) -> inspect_pat p1) ps in
                (fv, uu____529) in
        ...
        let brs1 =
          FStar_List.map
            (fun uu___59_600 ->
               match uu___59_600 with
               | (pat, uu____622, t4) ->
                   let uu____640 = inspect_pat pat in (uu____640, t4)) brs in
          ...
          (let uu____731 =
           ...
           then
             let maybe_dec =
               FStar_List.tryFind
                 (fun uu___60_737 ->
                    match uu___60_737 with
                    | FStar_Syntax_Syntax.DECREASES uu____738 -> true
                    | uu____741 -> false) ct.FStar_Syntax_Syntax.flags in
             let md =
  ...
  fun tv ->
    ...
    | FStar_Reflection_Data.Tv_Match (t, brs) ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___61_1005 ->
               match uu___61_1005 with
               | (pat, t1) ->
                   let uu____1022 = pack_pat pat in
                   (uu____1022, FStar_Pervasives_Native.None, t1)) brs in
...
let (inspect_sigelt :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, us, t, uu____1326, n1, uu____1328) ->
        let uu____1333 =
          let uu____1338 = FStar_Ident.path_of_lid lid in (uu____1338, t) in
