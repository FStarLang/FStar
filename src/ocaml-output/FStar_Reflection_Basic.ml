...
| FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____4)) -> begin
...
let uu____15 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (FStar_Ident.path_of_lid uu____15)))
...
let attr = (match ((FStar_Ident.lid_equals lid FStar_Parser_Const.cons_lid)) with
| true -> begin
FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)
end
| uu____29 -> begin
(match ((FStar_Ident.lid_equals lid FStar_Parser_Const.nil_lid)) with
| true -> begin
FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)
end
| uu____32 -> begin
(match ((FStar_Ident.lid_equals lid FStar_Parser_Const.some_lid)) with
| true -> begin
FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)
end
| uu____35 -> begin
(match ((FStar_Ident.lid_equals lid FStar_Parser_Const.none_lid)) with
| true -> begin
FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)
end
| uu____38 -> begin
...
let uu____39 = (FStar_Parser_Const.p2l ns)
in (FStar_Syntax_Syntax.lid_as_fv uu____39 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "999"))) attr)))))
...
| FStar_Const.Const_int (s, uu____85) -> begin
(

let uu____98 = (FStar_BigInt.big_int_of_string s)
in FStar_Reflection_Data.C_Int (uu____98))
end
...
| FStar_Const.Const_string (s, uu____100) -> begin
...
let uu____103 = (FStar_Syntax_Print.const_to_string c)
in (FStar_Util.format1 "unknown constant: %s" uu____103))
in (failwith uu____102))
end))
...
| FStar_Syntax_Syntax.Tm_meta (t3, uu____110) -> begin
(inspect_ln t3)
end
...
let uu____188 = (init args)
in (FStar_Syntax_Syntax.mk_Tm_app hd1 uu____188))
in (uu____187 FStar_Pervasives_Native.None t2.FStar_Syntax_Syntax.pos))
in ((uu____184), (((a), (q')))))
in FStar_Reflection_Data.Tv_App (uu____179)))
end))
end
| FStar_Syntax_Syntax.Tm_abs ([], uu____207, uu____208) -> begin
...
| FStar_Syntax_Syntax.Tm_type (uu____291) -> begin
FStar_Reflection_Data.Tv_Type (())
end
| FStar_Syntax_Syntax.Tm_arrow ([], k) -> begin
(failwith "inspect_ln: empty binders on arrow")
end
| FStar_Syntax_Syntax.Tm_arrow (uu____307) -> begin
(

let uu____320 = (FStar_Syntax_Util.arrow_one t2)
...
let uu____346 = (inspect_const c)
in FStar_Reflection_Data.Tv_Const (uu____346))
end
...
let uu____379 = (FStar_Syntax_Unionfind.uvar_id u)
in (FStar_BigInt.of_int_fs uu____379))
in ((uu____378), (t3)))
in FStar_Reflection_Data.Tv_Uvar (uu____373))
end
...
| FStar_Util.Inr (uu____399) -> begin
FStar_Reflection_Data.Tv_Unknown
end
...
| uu____421 -> begin
(match (lb.FStar_Syntax_Syntax.lbname) with
| FStar_Util.Inr (uu____422) -> begin
FStar_Reflection_Data.Tv_Unknown
end
| FStar_Util.Inl (bv) -> begin
...
let uu____475 = (inspect_const c)
in FStar_Reflection_Data.Pat_Constant (uu____475))
end
...
let uu____501 = (FStar_List.map (fun uu____513 -> (match (uu____513) with
| (p1, uu____521) -> begin
(inspect_pat p1)
end)) ps)
in ((fv), (uu____501)))
in FStar_Reflection_Data.Pat_Cons (uu____494))
end
...
let brs1 = (FStar_List.map (fun uu___57_572 -> (match (uu___57_572) with
| (pat, uu____594, t4) -> begin
(

let uu____612 = (inspect_pat pat)
in ((uu____612), (t4)))
end)) brs)
...
let uu____633 = (FStar_Syntax_Print.tag_of_term t2)
in (

let uu____634 = (FStar_Syntax_Print.term_to_string t2)
in (FStar_Util.format2 "inspect_ln: outside of expected syntax (%s, %s)\n" uu____633 uu____634)))
in ((FStar_Errors.Warning_CantInspect), (uu____632)))
in (FStar_Errors.log_issue t2.FStar_Syntax_Syntax.pos uu____627));
FStar_Reflection_Data.Tv_Unknown;
)
end))))
...
| FStar_Syntax_Syntax.Total (t, uu____639) -> begin
...
| ((pre, uu____654))::((post, uu____656))::uu____657 -> begin
...
| uu____699 -> begin
(match ((FStar_Ident.lid_equals ct.FStar_Syntax_Syntax.effect_name FStar_Parser_Const.effect_Tot_lid)) with
| true -> begin
(

let maybe_dec = (FStar_List.tryFind (fun uu___58_705 -> (match (uu___58_705) with
| FStar_Syntax_Syntax.DECREASES (uu____706) -> begin
true
end
| uu____709 -> begin
false
...
let uu____774 = (FStar_BigInt.string_of_big_int i)
in ((uu____774), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____763))
end
...
let uu____819 = (pack_const c)
in FStar_Syntax_Syntax.Tm_constant (uu____819))
in (FStar_Syntax_Syntax.mk uu____818))
in (uu____815 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| FStar_Reflection_Data.Tv_Uvar (u, t) -> begin
(

let uu____825 = (FStar_BigInt.to_int_fs u)
in (FStar_Syntax_Util.uvar_from_id uu____825 t))
end
...
let uu____872 = (pack_const c)
in FStar_Syntax_Syntax.Pat_constant (uu____872))
in (FStar_All.pipe_left wrap uu____871))
end
...
let uu____895 = (FStar_List.map (fun p1 -> (

let uu____909 = (pack_pat p1)
in ((uu____909), (false)))) ps)
in ((fv), (uu____895)))
in FStar_Syntax_Syntax.Pat_cons (uu____882))
in (FStar_All.pipe_left wrap uu____881))
end
...
let brs1 = (FStar_List.map (fun uu___59_959 -> (match (uu___59_959) with
| (pat, t1) -> begin
(

let uu____976 = (pack_pat pat)
in ((uu____976), (FStar_Pervasives_Native.None), (t1)))
end)) brs)
...
let uu____1087 = (FStar_TypeChecker_Env.lookup_qname env lid)
in (match (uu____1087) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
| FStar_Pervasives_Native.Some (FStar_Util.Inl (uu____1108), rng) -> begin
FStar_Pervasives_Native.None
end
...
| FStar_Syntax_Syntax.Sig_let ((r, (lb)::[]), uu____1210) -> begin
(
...
| FStar_Util.Inl (uu____1225) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, bs, t, uu____1234, c_lids) -> begin
(
...
let uu____1260 = (FStar_List.map FStar_Ident.path_of_lid c_lids)
in ((nm), (bs), (t), (uu____1260)))
in FStar_Reflection_Data.Sg_Inductive (uu____1247)))
end
| FStar_Syntax_Syntax.Sig_datacon (lid, us, t, uu____1276, n1, uu____1278) -> begin
(

let uu____1283 = (

let uu____1288 = (FStar_Ident.path_of_lid lid)
in ((uu____1288), (t)))
in FStar_Reflection_Data.Sg_Constructor (uu____1283))
end
| uu____1293 -> begin
...
let uu____1315 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (uu____1315)::[])
in ((((r), ((lb)::[]))), (uu____1312)))
in FStar_Syntax_Syntax.Sig_let (uu____1305))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_sigelt uu____1304)))
end
| FStar_Reflection_Data.Sg_Constructor (uu____1326) -> begin
(failwith "packing Sg_Constructor, sorry")
end
| FStar_Reflection_Data.Sg_Inductive (uu____1331) -> begin
...
let uu____1347 = (FStar_BigInt.of_int_fs bv.FStar_Syntax_Syntax.index)
in {FStar_Reflection_Data.bv_ppname = (FStar_Ident.string_of_ident bv.FStar_Syntax_Syntax.ppname); FStar_Reflection_Data.bv_index = uu____1347; FStar_Reflection_Data.bv_sort = bv.FStar_Syntax_Syntax.sort}))


let pack_bv : FStar_Reflection_Data.bv_view  ->  FStar_Syntax_Syntax.bv = (fun bvv -> (

let uu____1351 = (FStar_BigInt.to_int_fs bvv.FStar_Reflection_Data.bv_index)
in {FStar_Syntax_Syntax.ppname = (FStar_Ident.mk_ident ((bvv.FStar_Reflection_Data.bv_ppname), (FStar_Range.dummyRange))); FStar_Syntax_Syntax.index = uu____1351; FStar_Syntax_Syntax.sort = bvv.FStar_Reflection_Data.bv_sort}))
...
let uu____1370 = (inspect_aqual aq)
in ((bv), (uu____1370)))
end)))
...
let uu____1387 = (FStar_Syntax_Util.un_uinst t1)
in (

let uu____1388 = (FStar_Syntax_Util.un_uinst t2)
in (FStar_Syntax_Util.term_eq uu____1387 uu____1388))))
