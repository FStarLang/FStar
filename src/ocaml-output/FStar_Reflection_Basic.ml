...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,t,uu____1234,c_lids)
        ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,t,uu____1276,n1,uu____1278) ->
        let uu____1283 =
          let uu____1288 = FStar_Ident.path_of_lid lid  in (uu____1288, t)
           in
