    ...
    | FStar_Reflection_Data.C_Lemma (pre,post) ->
        let ct =
          let uu____911 =
            ...
            let uu____931 =
              let uu____942 = FStar_Syntax_Syntax.as_arg post  in [uu____942]
               in
  ...
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___238_1220  ->
               match uu___238_1220 with
               | (pat,t1) ->
                   let uu____1237 = pack_pat pat  in
                   (uu____1237, FStar_Pervasives_Native.None, t1)) brs
           in
...
let (set_sigelt_attrs :
  ...
  fun attrs  ->
    fun se  ->
      let uu___239_1450 = se  in
      {
        FStar_Syntax_Syntax.sigel = (uu___239_1450.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___239_1450.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals =
          (uu___239_1450.FStar_Syntax_Syntax.sigquals);
        FStar_Syntax_Syntax.sigmeta =
          (uu___239_1450.FStar_Syntax_Syntax.sigmeta);
...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,ty,uu____1495,c_lids)
        ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,ty,uu____1556,n1,uu____1558) ->
