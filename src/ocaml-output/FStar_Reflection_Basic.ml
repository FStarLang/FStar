  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_match (t3,brs) ->
                ...
                let uu____2077 =
                  FStar_List.map
                    (fun uu____2089  ->
                       ...
                       | (p1,uu____2097) -> inspect_pat p1) ps
                   in
                (fv, uu____2077)  in
        ...
        let brs2 =
          FStar_List.map
            (fun uu___82_2150  ->
               match uu___82_2150 with
               | (pat,uu____2172,t4) ->
                   let uu____2190 = inspect_pat pat  in (uu____2190, t4))
            brs1
           in
  ...
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_App (l,(r,q)) ->
        (match q with
         | FStar_Reflection_Data.Q_Explicit  ->
             let uu____2249 =
               let uu____2258 = FStar_Syntax_Syntax.as_arg r  in [uu____2258]
                in
             FStar_Syntax_Util.mk_app l uu____2249
         | FStar_Reflection_Data.Q_Implicit  ->
             let uu____2259 =
               let uu____2268 = FStar_Syntax_Syntax.iarg r  in [uu____2268]
                in
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___83_2429  ->
               match uu___83_2429 with
               | (pat,t1) ->
                   let uu____2446 = pack_pat pat  in
                   (uu____2446, FStar_Pervasives_Native.None, t1)) brs
           in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3004)::(t2,uu____3006)::[]) when
             ...
             let uu____3041 =
               ...
               let uu____3049 = unembed_term t2  in (uu____3046, uu____3049)
                in
  ...
  fun sev  ->
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,bs,t,dcs) ->
        let uu____3081 =
          ...
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Sg_Inductive uu____3082
           in
