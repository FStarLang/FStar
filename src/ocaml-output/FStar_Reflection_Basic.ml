        ...
        | FStar_Reflection_Data.C_String s ->
            let uu____373 =
              ...
              FStar_Syntax_Syntax.mk_Tm_app
                FStar_Reflection_Data.ref_C_String uu____374
               in
            uu____373 FStar_Pervasives_Native.None FStar_Range.dummyRange
         in
        ...
        (match uu____428 with
         ...
         | uu____568 ->
             ((let uu____582 =
                 ...
                 FStar_Util.format1 "Not an embedded vconst: %s" uu____583
                  in
      ...
      | FStar_Reflection_Data.Pat_Constant c ->
          let uu____593 =
            let uu____594 =
              ...
              [uu____595]  in
            FStar_Syntax_Syntax.mk_Tm_app
              FStar_Reflection_Data.ref_Pat_Constant uu____594
             in
        ...
        (match uu____688 with
         ...
         | uu____896 ->
             ((let uu____910 =
                 ...
                 FStar_Util.format1 "Not an embedded pattern: %s" uu____911
                  in
        ...
        (match uu____987 with
         ...
         | uu____1044 ->
             ((let uu____1058 =
                 ...
                 FStar_Util.format1 "Not an embedded aqualv: %s" uu____1059
                  in
  ...
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_App (l,(r,q)) ->
        (match q with
         | FStar_Reflection_Data.Q_Explicit  ->
             let uu____2921 =
               let uu____2930 = FStar_Syntax_Syntax.as_arg r  in [uu____2930]
                in
             FStar_Syntax_Util.mk_app l uu____2921
         | FStar_Reflection_Data.Q_Implicit  ->
             let uu____2931 =
               let uu____2940 = FStar_Syntax_Syntax.iarg r  in [uu____2940]
                in
          ...
          FStar_List.map
            (fun uu___112_3098  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____3115, FStar_Pervasives_Native.None, t1)) brs
           in
        ...
        (match uu____3185 with
         ...
         | uu____3257 ->
             ((let uu____3271 =
                 ...
                 FStar_Util.format1 "Not an embedded order: %s" uu____3272
                  in
