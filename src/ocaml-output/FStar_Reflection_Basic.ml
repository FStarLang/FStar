...
let embed_term:
  ...
  fun rng  ->
    fun t  ->
      ...
      let uu___184_237 = t1 in
      {
        FStar_Syntax_Syntax.n = (uu___184_237.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___184_237.FStar_Syntax_Syntax.vars)
      }
let unembed_term:
  FStar_Syntax_Syntax.term ->
    FStar_Syntax_Syntax.term FStar_Pervasives_Native.option
...
let embed_const:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___191_380 = r in
      {
        FStar_Syntax_Syntax.n = (uu___191_380.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___191_380.FStar_Syntax_Syntax.vars)
      }
let unembed_const:
  FStar_Syntax_Syntax.term ->
...
let embed_aqualv:
  ...
  fun rng  ->
    fun q  ->
      ...
      let uu___192_943 = r in
      {
        FStar_Syntax_Syntax.n = (uu___192_943.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___192_943.FStar_Syntax_Syntax.vars)
      }
let unembed_aqualv:
  FStar_Syntax_Syntax.term ->
  ...
  fun rng  ->
    fun t  ->
      ...
      | FStar_Reflection_Data.Tv_Unknown  ->
          let uu___193_1237 = FStar_Reflection_Data.ref_Tv_Unknown in
          {
            FStar_Syntax_Syntax.n = (uu___193_1237.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___193_1237.FStar_Syntax_Syntax.vars)
          }
  ...
  fun rng  ->
    fun cv  ->
      ...
      | FStar_Reflection_Data.C_Unknown  ->
          let uu___194_1952 = FStar_Reflection_Data.ref_C_Unknown in
          {
            FStar_Syntax_Syntax.n = (uu___194_1952.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___194_1952.FStar_Syntax_Syntax.vars)
          }
...
let embed_order:
  ...
  fun rng  ->
    fun o  ->
      ...
      let uu___195_3138 = r in
      {
        FStar_Syntax_Syntax.n = (uu___195_3138.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___195_3138.FStar_Syntax_Syntax.vars)
      }
let unembed_order:
  FStar_Syntax_Syntax.term ->
...
let embed_sigelt_view:
  ...
  fun rng  ->
    fun sev  ->
      ...
      | FStar_Reflection_Data.Unk  ->
          let uu___196_3843 = FStar_Reflection_Data.ref_Unk in
          {
            FStar_Syntax_Syntax.n = (uu___196_3843.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___196_3843.FStar_Syntax_Syntax.vars)
          }
