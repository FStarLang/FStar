        ...
        let brs1 =
          FStar_List.map
            (fun uu___0_801 ->
               ...
               | (pat, uu____823, t5) ->
                   let uu____841 = inspect_pat pat in (uu____841, t5)) brs in
             ...
             let maybe_dec =
               FStar_List.tryFind
                 (fun uu___1_953 ->
                    ...
                    | uu____959 -> false) ct.FStar_Syntax_Syntax.flags in
             let md =
...
let (pack_const : FStar_Reflection_Data.vconst -> FStar_Syntax_Syntax.sconst)
  ...
  fun c ->
    ...
    | FStar_Reflection_Data.C_Reflect ns ->
        let uu____1108 = FStar_Ident.lid_of_path ns FStar_Range.dummyRange in
          ...
          FStar_List.map
            (fun uu___2_1373 ->
               ...
               | (pat, t1) ->
                   ...
                   (uu____1390, FStar_Pervasives_Native.None, t1)) brs in
        ...
        (fun l ->
           let ns =
             ...
             FStar_All.pipe_right uu____1615
               (FStar_List.map FStar_Ident.string_of_ident) in
           if ns = modul
           then
             let uu____1631 =
               FStar_Syntax_Syntax.lid_as_fv l
...
let (inspect_sigelt :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid, us, bs, ty, uu____1926, c_lids) ->
        ...
        (match uu____1937 with
         | (s, us1) ->
             ...
             let uu____1958 =
               let uu____1975 = FStar_List.map FStar_Ident.path_of_lid c_lids in
               (nm, us1, bs1, ty1, uu____1975) in
             FStar_Reflection_Data.Sg_Inductive uu____1958)
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, us, ty, uu____1987, n1, uu____1989) ->
