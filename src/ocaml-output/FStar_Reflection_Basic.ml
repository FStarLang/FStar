...
let (pack_comp : FStar_Reflection_Data.comp_view -> FStar_Syntax_Syntax.comp)
  ...
  fun cv  ->
    ...
    | FStar_Reflection_Data.C_Lemma (pre,post) ->
        let ct =
          let uu____1013 =
            let uu____1024 = FStar_Syntax_Syntax.as_arg pre  in
            let uu____1033 =
              let uu____1044 = FStar_Syntax_Syntax.as_arg post  in
              [uu____1044]  in
            uu____1024 :: uu____1033  in
          {
        ...
        FStar_Syntax_Syntax.mk_Comp ct
    | uu____1077 -> failwith "cannot pack a C_Unknown"
...
let (pack_const : FStar_Reflection_Data.vconst -> FStar_Syntax_Syntax.sconst)
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.C_Int i ->
        let uu____1086 =
          let uu____1098 = FStar_BigInt.string_of_big_int i  in
          (uu____1098, FStar_Pervasives_Native.None)  in
        FStar_Const.Const_int uu____1086
    ...
    | FStar_Reflection_Data.C_Reflect ns ->
        let uu____1118 = FStar_Ident.lid_of_path ns FStar_Range.dummyRange
           in
        FStar_Const.Const_reflect uu____1118
...
let (pack_ln : FStar_Reflection_Data.term_view -> FStar_Syntax_Syntax.term) =
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_Const c ->
        let uu____1183 =
          let uu____1190 =
            let uu____1191 = pack_const c  in
            FStar_Syntax_Syntax.Tm_constant uu____1191  in
          FStar_Syntax_Syntax.mk uu____1190  in
        uu____1183 FStar_Pervasives_Native.None FStar_Range.dummyRange
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let rec pack_pat p =
          ...
          | FStar_Reflection_Data.Pat_Constant c ->
              let uu____1263 =
                let uu____1264 = pack_const c  in
                FStar_Syntax_Syntax.Pat_constant uu____1264  in
              FStar_All.pipe_left wrap uu____1263
                  ...
                  let uu____1296 =
                    FStar_List.map
                      (fun uu____1320  ->
                         ...
                         | (p1,b) ->
                             let uu____1335 = pack_pat p1  in (uu____1335, b))
                      ps
                     in
                  (fv, uu____1296)  in
                FStar_Syntax_Syntax.Pat_cons uu____1282  in
              FStar_All.pipe_left wrap uu____1281
          | FStar_Reflection_Data.Pat_Var bv ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___2_1383  ->
               match uu___2_1383 with
               | (pat,t1) ->
                   let uu____1400 = pack_pat pat  in
                   (uu____1400, FStar_Pervasives_Native.None, t1)) brs
           in
...
let (lookup_attr :
  ...
  fun attr  ->
    fun env  ->
      let uu____1561 =
        let uu____1562 = FStar_Syntax_Subst.compress attr  in
        uu____1562.FStar_Syntax_Syntax.n  in
      match uu____1561 with
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let ses =
            let uu____1571 =
              let uu____1573 = FStar_Syntax_Syntax.lid_of_fv fv  in
              FStar_Ident.text_of_lid uu____1573  in
            FStar_TypeChecker_Env.lookup_attr env uu____1571  in
          FStar_List.concatMap
            (fun se  ->
               let uu____1577 = FStar_Syntax_Util.lid_of_sigelt se  in
...
let (all_defs_in_env :
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.fv Prims.list) =
  fun env  ->
    let uu____1596 = FStar_TypeChecker_Env.lidents env  in
    FStar_List.map
      (fun l  ->
         FStar_Syntax_Syntax.lid_as_fv l
           (FStar_Syntax_Syntax.Delta_constant_at_level (Prims.of_int (999)))
           FStar_Pervasives_Native.None) uu____1596
...
let (defs_in_module :
  ...
  fun env  ->
    fun modul  ->
      let uu____1617 = FStar_TypeChecker_Env.lidents env  in
      FStar_List.concatMap
        (fun l  ->
           let ns =
             let uu____1625 =
               let uu____1628 = FStar_Ident.ids_of_lid l  in
               FStar_All.pipe_right uu____1628 init  in
...
let (set_sigelt_attrs :
  ...
  fun attrs  ->
    fun se  ->
      let uu___382_1692 = se  in
      {
        FStar_Syntax_Syntax.sigel = (uu___382_1692.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___382_1692.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals =
          (uu___382_1692.FStar_Syntax_Syntax.sigquals);
        FStar_Syntax_Syntax.sigmeta =
          (uu___382_1692.FStar_Syntax_Syntax.sigmeta);
        FStar_Syntax_Syntax.sigattrs = attrs;
        FStar_Syntax_Syntax.sigopts =
          (uu___382_1692.FStar_Syntax_Syntax.sigopts)
      }
  
let (rd_to_syntax_qual :
  FStar_Reflection_Data.qualifier -> FStar_Syntax_Syntax.qualifier) =
  fun uu___3_1698  ->
    match uu___3_1698 with
...
let (set_sigelt_quals :
  ...
  fun quals  ->
    fun se  ->
      let uu___461_1800 = se  in
      let uu____1801 = FStar_List.map rd_to_syntax_qual quals  in
      {
        FStar_Syntax_Syntax.sigel = (uu___461_1800.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___461_1800.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals = uu____1801;
        FStar_Syntax_Syntax.sigmeta =
          (uu___461_1800.FStar_Syntax_Syntax.sigmeta);
        FStar_Syntax_Syntax.sigattrs =
          (uu___461_1800.FStar_Syntax_Syntax.sigattrs);
        FStar_Syntax_Syntax.sigopts =
          (uu___461_1800.FStar_Syntax_Syntax.sigopts)
      }
  ...
  fun se  ->
    ...
    | FStar_Pervasives_Native.Some o ->
        let uu____1834 =
          let uu____1835 =
            let uu____1842 =
              let uu____1845 = FStar_ST.op_Bang e_optionstate_hook  in
              FStar_All.pipe_right uu____1845 FStar_Util.must  in
            FStar_Syntax_Embeddings.embed uu____1842 o  in
          uu____1835 FStar_Range.dummyRange FStar_Pervasives_Native.None
...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let ((r,lb::[]),uu____1895) ->
        let fv =
          match lb.FStar_Syntax_Syntax.lbname with
          | FStar_Util.Inr fv -> fv
          | FStar_Util.Inl uu____1906 ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,ty,uu____1936,c_lids)
        ->
        let nm = FStar_Ident.path_of_lid lid  in
        let uu____1947 = FStar_Syntax_Subst.univ_var_opening us  in
        (match uu____1947 with
         | (s,us1) ->
             let bs1 = FStar_Syntax_Subst.subst_binders s bs  in
             let ty1 = FStar_Syntax_Subst.subst s ty  in
             let uu____1968 =
               let uu____1985 = FStar_List.map FStar_Ident.path_of_lid c_lids
                  in
               (nm, us1, bs1, ty1, uu____1985)  in
             FStar_Reflection_Data.Sg_Inductive uu____1968)
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,ty,uu____1997,n1,uu____1999) ->
        let uu____2006 = FStar_Syntax_Subst.univ_var_opening us  in
        (match uu____2006 with
         | (s,us1) ->
             let ty1 = FStar_Syntax_Subst.subst s ty  in
             let uu____2026 =
               let uu____2031 = FStar_Ident.path_of_lid lid  in
               (uu____2031, ty1)  in
             FStar_Reflection_Data.Sg_Constructor uu____2026)
    | uu____2032 -> FStar_Reflection_Data.Unk
  ...
  fun sv  ->
    ...
    | FStar_Reflection_Data.Sg_Let (r,fv,univs1,typ,def) ->
        ...
        let uu____2058 =
          let uu____2059 =
            let uu____2066 =
              let uu____2069 = FStar_Syntax_Syntax.lid_of_fv fv  in
              [uu____2069]  in
            ((r, [lb]), uu____2066)  in
          FStar_Syntax_Syntax.Sig_let uu____2059  in
        FStar_All.pipe_left FStar_Syntax_Syntax.mk_sigelt uu____2058
    | FStar_Reflection_Data.Sg_Constructor uu____2075 ->
        failwith "packing Sg_Constructor, sorry"
    | FStar_Reflection_Data.Sg_Inductive uu____2081 ->
...
let (inspect_bv : FStar_Syntax_Syntax.bv -> FStar_Reflection_Data.bv_view) =
  fun bv  ->
    ...
    let uu____2108 = FStar_BigInt.of_int_fs bv.FStar_Syntax_Syntax.index  in
    {
      FStar_Reflection_Data.bv_ppname = uu____2106;
      FStar_Reflection_Data.bv_index = uu____2108;
...
let (pack_bv : FStar_Reflection_Data.bv_view -> FStar_Syntax_Syntax.bv) =
  fun bvv  ->
      ...
      FStar_BigInt.to_int_fs bvv.FStar_Reflection_Data.bv_index  in
    {
      ...
      FStar_Syntax_Syntax.index = uu____2117;
...
let (inspect_binder :
  ...
  fun b  ->
    ...
    | (bv,aq) -> let uu____2144 = inspect_aqual aq  in (bv, uu____2144)
  
let (pack_binder :
  FStar_Syntax_Syntax.bv ->
    FStar_Reflection_Data.aqualv -> FStar_Syntax_Syntax.binder)
  =
  fun bv  -> fun aqv  -> let uu____2156 = pack_aqual aqv  in (bv, uu____2156) 
  ...
  fun e  ->
    ...
    FStar_List.map
      (fun uu____2201  ->
         ...
         | (l,m) ->
             let uu____2211 = FStar_Ident.ids_of_lid l  in
             FStar_List.map FStar_Ident.text_of_id uu____2211) uu____2183
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let uu____2233 = FStar_Syntax_Util.un_uinst t1  in
      let uu____2234 = FStar_Syntax_Util.un_uinst t2  in
      FStar_Syntax_Util.term_eq uu____2233 uu____2234
