...
let inspect_const: FStar_Syntax_Syntax.sconst -> FStar_Reflection_Data.vconst
  ...
  fun c  ->
    ...
    | FStar_Const.Const_string (s,uu____1519) ->
        FStar_Reflection_Data.C_String s
    | uu____1520 ->
        let uu____1521 =
          let uu____1522 = FStar_Syntax_Print.const_to_string c in
          FStar_Util.format1 "unknown constant: %s" uu____1522 in
        failwith uu____1521
let rec inspect: FStar_Syntax_Syntax.term -> FStar_Reflection_Data.term_view
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____1529) -> inspect t2
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____1535 = FStar_Syntax_Syntax.mk_binder bv in
        FStar_Reflection_Data.Tv_Var uu____1535
    | FStar_Syntax_Syntax.Tm_fvar fv -> FStar_Reflection_Data.Tv_FVar fv
    | FStar_Syntax_Syntax.Tm_app (hd1,[]) ->
        failwith "inspect: empty arguments on Tm_app"
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____1578 = last args in
        (match uu____1578 with
         | (a,q) ->
             let q' =
               match q with
               | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit
                   uu____1598) -> FStar_Reflection_Data.Q_Implicit
             ...
             let uu____1599 =
               let uu____1604 =
                 let uu____1607 =
                   let uu____1608 = init args in
                   FStar_Syntax_Syntax.mk_Tm_app hd1 uu____1608 in
                 uu____1607 FStar_Pervasives_Native.None
                   t1.FStar_Syntax_Syntax.pos in
               (uu____1604, (a, q')) in
             FStar_Reflection_Data.Tv_App uu____1599)
    | FStar_Syntax_Syntax.Tm_abs ([],uu____1627,uu____1628) ->
        failwith "inspect: empty arguments on Tm_abs"
    | FStar_Syntax_Syntax.Tm_abs (bs,t2,k) ->
        let uu____1670 = FStar_Syntax_Subst.open_term bs t2 in
        (match uu____1670 with
         | (bs1,t3) ->
             (match bs1 with
              ...
              | b::bs2 ->
                  let uu____1697 =
                    let uu____1702 = FStar_Syntax_Util.abs bs2 t3 k in
                    (b, uu____1702) in
                  FStar_Reflection_Data.Tv_Abs uu____1697))
    | FStar_Syntax_Syntax.Tm_type uu____1707 ->
        FStar_Reflection_Data.Tv_Type ()
    | FStar_Syntax_Syntax.Tm_arrow ([],k) ->
        failwith "inspect: empty binders on arrow"
    | FStar_Syntax_Syntax.Tm_arrow (bs,k) ->
        let uu____1741 = FStar_Syntax_Subst.open_comp bs k in
        (match uu____1741 with
         | (bs1,k1) ->
             (match bs1 with
              ...
              | b::bs2 ->
                  let uu____1768 =
                    let uu____1773 = FStar_Syntax_Util.arrow bs2 k1 in
                    (b, uu____1773) in
                  FStar_Reflection_Data.Tv_Arrow uu____1768))
    | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
        let b = FStar_Syntax_Syntax.mk_binder bv in
        let uu____1789 = FStar_Syntax_Subst.open_term [b] t2 in
    ...
    | FStar_Syntax_Syntax.Tm_constant c ->
        let uu____1828 = inspect_const c in
        FStar_Reflection_Data.Tv_Const uu____1828
    | FStar_Syntax_Syntax.Tm_uvar (u,t2) ->
        let uu____1855 =
          let uu____1860 = FStar_Syntax_Unionfind.uvar_id u in
          (uu____1860, t2) in
        FStar_Reflection_Data.Tv_Uvar uu____1855
    | FStar_Syntax_Syntax.Tm_match (t2,brs) ->
        let rec inspect_pat p =
          match p.FStar_Syntax_Syntax.v with
          | FStar_Syntax_Syntax.Pat_constant c ->
              let uu____1910 = inspect_const c in
              FStar_Reflection_Data.Pat_Constant uu____1910
                ...
                let uu____1936 =
                  FStar_List.map
                    (fun uu____1948  ->
                       ...
                       | (p1,uu____1956) -> inspect_pat p1) ps in
                (fv, uu____1936) in
              FStar_Reflection_Data.Pat_Cons uu____1929
          | FStar_Syntax_Syntax.Pat_var bv ->
              FStar_Reflection_Data.Pat_Var bv
          | FStar_Syntax_Syntax.Pat_wild bv ->
              FStar_Reflection_Data.Pat_Wild bv
          | FStar_Syntax_Syntax.Pat_dot_term uu____1965 ->
              failwith "NYI: Pat_dot_term" in
        let brs1 = FStar_List.map FStar_Syntax_Subst.open_branch brs in
        let brs2 =
          FStar_List.map
            (fun uu___80_2009  ->
               match uu___80_2009 with
               | (pat,uu____2031,t3) ->
                   let uu____2049 = inspect_pat pat in (uu____2049, t3)) brs1 in
        FStar_Reflection_Data.Tv_Match (t2, brs2)
    | uu____2062 ->
        ((let uu____2064 = FStar_Syntax_Print.tag_of_term t1 in
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.C_Int i ->
        let uu____2071 =
          ...
          (uu____2082, FStar_Pervasives_Native.None) in
        FStar_Const.Const_int uu____2071
...
let pack: FStar_Reflection_Data.term_view -> FStar_Syntax_Syntax.term =
  fun tv  ->
    match tv with
    | FStar_Reflection_Data.Tv_Var (bv,uu____2099) ->
    ...
    | FStar_Reflection_Data.Tv_App (l,(r,q)) ->
        (match q with
         | FStar_Reflection_Data.Q_Explicit  ->
             let uu____2108 =
               let uu____2117 = FStar_Syntax_Syntax.as_arg r in [uu____2117] in
             FStar_Syntax_Util.mk_app l uu____2108
         | FStar_Reflection_Data.Q_Implicit  ->
             let uu____2118 =
               let uu____2127 = FStar_Syntax_Syntax.iarg r in [uu____2127] in
             FStar_Syntax_Util.mk_app l uu____2118)
    | FStar_Reflection_Data.Tv_Abs (b,t) ->
        FStar_Syntax_Util.abs [b] t FStar_Pervasives_Native.None
    | FStar_Reflection_Data.Tv_Arrow (b,t) ->
        let uu____2132 = FStar_Syntax_Syntax.mk_Total t in
        FStar_Syntax_Util.arrow [b] uu____2132
    | FStar_Reflection_Data.Tv_Type () -> FStar_Syntax_Util.ktype
    | FStar_Reflection_Data.Tv_Refine ((bv,uu____2136),t) ->
        FStar_Syntax_Util.refine bv t
    | FStar_Reflection_Data.Tv_Const c ->
        let uu____2143 =
          let uu____2146 =
            let uu____2147 = pack_const c in
            FStar_Syntax_Syntax.Tm_constant uu____2147 in
          FStar_Syntax_Syntax.mk uu____2146 in
        uu____2143 FStar_Pervasives_Native.None FStar_Range.dummyRange
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let rec pack_pat p =
          ...
          | FStar_Reflection_Data.Pat_Constant c ->
              let uu____2170 =
                ...
                FStar_Syntax_Syntax.Pat_constant uu____2171 in
              FStar_All.pipe_left wrap uu____2170
          | FStar_Reflection_Data.Pat_Cons (fv,ps) ->
              let uu____2180 =
                let uu____2181 =
                  let uu____2194 =
                    FStar_List.map
                      (fun p1  ->
                         let uu____2208 = pack_pat p1 in (uu____2208, false))
                      ps in
                  (fv, uu____2194) in
                FStar_Syntax_Syntax.Pat_cons uu____2181 in
              FStar_All.pipe_left wrap uu____2180
          | FStar_Reflection_Data.Pat_Var bv ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___81_2254  ->
               match uu___81_2254 with
               | (pat,t1) ->
                   let uu____2271 = pack_pat pat in
                   (uu____2271, FStar_Pervasives_Native.None, t1)) brs in
        let brs2 = FStar_List.map FStar_Syntax_Subst.close_branch brs1 in
        FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (t, brs2))
          FStar_Pervasives_Native.None FStar_Range.dummyRange
    | uu____2283 -> failwith "pack: unexpected term view"
...
let unembed_order: FStar_Syntax_Syntax.term -> FStar_Order.order =
  fun t  ->
    let t1 = FStar_Syntax_Util.unascribe t in
    let uu____2293 = FStar_Syntax_Util.head_and_args t1 in
    match uu____2293 with
    | (hd1,args) ->
        let uu____2330 =
          let uu____2343 =
            let uu____2344 = FStar_Syntax_Util.un_uinst hd1 in
        ...
        (match uu____2330 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,[]) when
             ...
             -> FStar_Order.Gt
         | uu____2400 -> failwith "not an embedded order")
let compare_binder:
    ...
    | FStar_Reflection_Data.UnfoldOnly l ->
        let uu____2439 =
          ...
          FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_UnfoldOnly
            uu____2440 in
        uu____2439 FStar_Pervasives_Native.None FStar_Range.dummyRange
let unembed_norm_step:
  FStar_Syntax_Syntax.term -> FStar_Reflection_Data.norm_step =
  fun t  ->
    let t1 = FStar_Syntax_Util.unascribe t in
    let uu____2450 = FStar_Syntax_Util.head_and_args t1 in
    ...
    | (hd1,args) ->
        ...
        (match uu____2487 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____2574)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_Data.ref_UnfoldOnly_lid
             ->
             let uu____2599 =
               FStar_Syntax_Embeddings.unembed_list unembed_fvar l in
             FStar_Reflection_Data.UnfoldOnly uu____2599
         | uu____2602 -> failwith "not an embedded norm_step")
let lookup_typ:
  ...
  fun env  ->
    fun ns  ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Util.Inl uu____2667,rng) ->
          FStar_Reflection_Data.Unk
      | FStar_Pervasives_Native.Some (FStar_Util.Inr (se,us),rng) ->
          (match se.FStar_Syntax_Syntax.sigel with
           | FStar_Syntax_Syntax.Sig_inductive_typ
               (lid1,us1,bs,t,uu____2768,dc_lids) ->
                 ...
                 | FStar_Pervasives_Native.Some
                     ...
                     (match se1.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_datacon
                          (lid2,us3,t1,uu____2858,n1,uu____2860) ->
                          let uu____2865 =
                            let uu____2870 = FStar_Ident.path_of_lid lid2 in
                            (uu____2870, t1) in
                          FStar_Reflection_Data.Ctor uu____2865
                      | uu____2875 -> failwith "wat 1")
                 | uu____2876 -> failwith "wat 2" in
               let ctors = FStar_List.map ctor1 dc_lids in
               FStar_Reflection_Data.Sg_Inductive (nm, bs, t, ctors)
           | uu____2904 -> FStar_Reflection_Data.Unk)
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.Ctor (nm,t) ->
        let uu____2911 =
          let uu____2912 =
            let uu____2913 =
              let uu____2914 = FStar_Syntax_Embeddings.embed_string_list nm in
              FStar_Syntax_Syntax.as_arg uu____2914 in
            let uu____2915 =
              let uu____2918 =
                let uu____2919 = embed_term t in
                FStar_Syntax_Syntax.as_arg uu____2919 in
              [uu____2918] in
            uu____2913 :: uu____2915 in
          FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Ctor
            uu____2912 in
        uu____2911 FStar_Pervasives_Native.None FStar_Range.dummyRange
let unembed_ctor: FStar_Syntax_Syntax.term -> FStar_Reflection_Data.ctor =
  fun t  ->
    let t1 = FStar_Syntax_Util.unascribe t in
    let uu____2927 = FStar_Syntax_Util.head_and_args t1 in
    ...
    | (hd1,args) ->
        ...
        (match uu____2964 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____2991)::(t2,uu____2993)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             let uu____3028 =
               ...
               let uu____3036 = unembed_term t2 in (uu____3033, uu____3036) in
             FStar_Reflection_Data.Ctor uu____3028
         | uu____3039 -> failwith "not an embedded ctor")
  ...
  fun sev  ->
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,bs,t,dcs) ->
        let uu____3068 =
          let uu____3069 =
            let uu____3070 =
              let uu____3071 = FStar_Syntax_Embeddings.embed_string_list nm in
              FStar_Syntax_Syntax.as_arg uu____3071 in
            let uu____3072 =
              let uu____3075 =
                let uu____3076 = embed_binders bs in
                FStar_Syntax_Syntax.as_arg uu____3076 in
              let uu____3077 =
                let uu____3080 =
                  let uu____3081 = embed_term t in
                  FStar_Syntax_Syntax.as_arg uu____3081 in
                let uu____3082 =
                  let uu____3085 =
                    let uu____3086 =
            ...
            uu____3070 :: uu____3072 in
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Sg_Inductive uu____3069 in
        uu____3068 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let unembed_sigelt_view:
  ...
  fun t  ->
    let t1 = FStar_Syntax_Util.unascribe t in
    let uu____3094 = FStar_Syntax_Util.head_and_args t1 in
    match uu____3094 with
    | (hd1,args) ->
        let uu____3131 =
          let uu____3144 =
            let uu____3145 = FStar_Syntax_Util.un_uinst hd1 in
            uu____3145.FStar_Syntax_Syntax.n in
          (uu____3144, args) in
        (match uu____3131 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3158)::(bs,uu____3160)::(t2,uu____3162)::(dcs,uu____3164)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             let uu____3219 =
               let uu____3232 =
                 FStar_Syntax_Embeddings.unembed_string_list nm in
               let uu____3235 = unembed_binders bs in
               let uu____3238 = unembed_term t2 in
               let uu____3239 =
                 FStar_Syntax_Embeddings.unembed_list unembed_ctor dcs in
               (uu____3232, uu____3235, uu____3238, uu____3239) in
             FStar_Reflection_Data.Sg_Inductive uu____3219
         | (FStar_Syntax_Syntax.Tm_fvar fv,[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_Data.ref_Unk_lid
             -> FStar_Reflection_Data.Unk
         | uu____3263 -> failwith "not an embedded sigelt_view")
let binders_of_env: FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.binders
  = fun e  -> FStar_TypeChecker_Env.all_binders e
let type_of_binder:
  'Auu____3284 .
    (FStar_Syntax_Syntax.bv,'Auu____3284) FStar_Pervasives_Native.tuple2 ->
      FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  = fun b  -> match b with | (b1,uu____3300) -> b1.FStar_Syntax_Syntax.sort
let term_eq:
  FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax ->
...
let fresh_binder:
  'Auu____3315 .
    FStar_Syntax_Syntax.typ ->
      (FStar_Syntax_Syntax.bv,'Auu____3315 FStar_Pervasives_Native.option)
        FStar_Pervasives_Native.tuple2
  =
  fun t  ->
    let uu____3326 =
