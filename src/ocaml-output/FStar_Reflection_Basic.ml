...
let (pack_fv : Prims.string Prims.list -> FStar_Syntax_Syntax.fv) =
  fun ns ->
    ...
    let attr =
      let uu____27 = FStar_Ident.lid_equals lid FStar_Parser_Const.cons_lid in
      if uu____27
      then FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
      else
        (let uu____31 = FStar_Ident.lid_equals lid FStar_Parser_Const.nil_lid in
         if uu____31
         then FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
         else
           (let uu____35 =
                ...
                let uu____505 =
                  FStar_List.map
                    (fun uu____517 ->
                       ...
                       | (p1, uu____525) -> inspect_pat p1) ps in
                (fv, uu____505) in
        ...
        let brs1 =
          FStar_List.map
            (fun uu___56_576 ->
               ...
               | (pat, uu____598, t4) ->
                   let uu____616 = inspect_pat pat in (uu____616, t4)) brs in
             ...
             let maybe_dec =
               FStar_List.tryFind
                 (fun uu___57_711 ->
                    ...
                    | uu____715 -> false) ct.FStar_Syntax_Syntax.flags in
             let md =
          ...
          FStar_List.map
            (fun uu___58_965 ->
               ...
               | (pat, t1) ->
                   ...
                   (uu____982, FStar_Pervasives_Native.None, t1)) brs in
...
let (inspect_sigelt :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, us, t, uu____1272, n1, uu____1274) ->
        let uu____1279 =
          let uu____1284 = FStar_Ident.path_of_lid lid in (uu____1284, t) in
