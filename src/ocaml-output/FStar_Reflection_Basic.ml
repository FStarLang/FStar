      ...
      let r =
        ...
        | FStar_Reflection_Data.C_String s ->
            let uu____349 =
              let uu____350 =
                let uu____351 =
                  let uu____352 = FStar_Syntax_Embeddings.embed_string rng s
                     in
                  FStar_Syntax_Syntax.as_arg uu____352  in
                [uu____351]  in
              FStar_Syntax_Syntax.mk_Tm_app
                FStar_Reflection_Data.ref_C_String uu____350
               in
            uu____349 FStar_Pervasives_Native.None FStar_Range.dummyRange
         in
        ...
        (match uu____403 with
         ...
         | uu____543 ->
             ((let uu____557 =
                 ...
                 FStar_Util.format1 "Not an embedded vconst: %s" uu____558
                  in
      ...
      | FStar_Reflection_Data.Pat_Constant c ->
          let uu____566 =
            let uu____567 =
              ...
              [uu____568]  in
            FStar_Syntax_Syntax.mk_Tm_app
              FStar_Reflection_Data.ref_Pat_Constant uu____567
             in
        ...
        (match uu____660 with
         ...
         | uu____868 ->
             ((let uu____882 =
                 ...
                 FStar_Util.format1 "Not an embedded pattern: %s" uu____883
                  in
        ...
        (match uu____956 with
         ...
         | uu____1013 ->
             ((let uu____1027 =
                 ...
                 FStar_Util.format1 "Not an embedded aqualv: %s" uu____1028
                  in
    ...
    fun t  ->
      ...
      | FStar_Reflection_Data.Tv_Type u ->
          let uu____1106 =
            let uu____1107 =
              let uu____1108 =
                let uu____1109 = FStar_Syntax_Embeddings.embed_unit rng ()
                   in
                ...
                let uu____2629 =
                  FStar_List.map
                    (fun uu____2641  ->
                       ...
                       | (p1,uu____2649) -> inspect_pat p1) ps
                   in
                (fv, uu____2629)  in
        ...
        let brs2 =
          FStar_List.map
            (fun uu___178_2702  ->
               ...
               | (pat,uu____2724,t4) ->
                   let uu____2742 = inspect_pat pat  in (uu____2742, t4))
            brs1
           in
          ...
          FStar_List.map
            (fun uu___179_3052  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____3069, FStar_Pervasives_Native.None, t1)) brs
           in
        ...
        (match uu____3136 with
         ...
         | uu____3208 ->
             ((let uu____3222 =
                 ...
                 FStar_Util.format1 "Not an embedded order: %s" uu____3223
                  in
        ...
        (match uu____3614 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3643)::(t2,uu____3645)::[]) when
             ...
             ->
             let uu____3680 = FStar_Syntax_Embeddings.unembed_string_list nm
                in
