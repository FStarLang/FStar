...
let embed_term:
  ...
  fun rng  ->
    fun t  ->
      ...
      let uu___178_227 = t1 in
      {
        FStar_Syntax_Syntax.n = (uu___178_227.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___178_227.FStar_Syntax_Syntax.vars)
      }
let unembed_term:
  FStar_Syntax_Syntax.term ->
    FStar_Syntax_Syntax.term FStar_Pervasives_Native.option
...
let embed_const:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___185_355 = r in
      {
        FStar_Syntax_Syntax.n = (uu___185_355.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___185_355.FStar_Syntax_Syntax.vars)
      }
let unembed_const:
  FStar_Syntax_Syntax.term ->
...
let embed_aqualv:
  ...
  fun rng  ->
    fun q  ->
      ...
      let uu___186_908 = r in
      {
        FStar_Syntax_Syntax.n = (uu___186_908.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___186_908.FStar_Syntax_Syntax.vars)
      }
let unembed_aqualv:
  FStar_Syntax_Syntax.term ->
  ...
  fun rng  ->
    fun t  ->
      ...
      | FStar_Reflection_Data.Tv_Unknown  ->
          let uu___187_1197 = FStar_Reflection_Data.ref_Tv_Unknown in
          {
            FStar_Syntax_Syntax.n = (uu___187_1197.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___187_1197.FStar_Syntax_Syntax.vars)
          }
  ...
  fun rng  ->
    fun cv  ->
      ...
      | FStar_Reflection_Data.C_Unknown  ->
          let uu___188_1907 = FStar_Reflection_Data.ref_C_Unknown in
          {
            FStar_Syntax_Syntax.n = (uu___188_1907.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___188_1907.FStar_Syntax_Syntax.vars)
          }
...
let embed_order:
  ...
  fun rng  ->
    fun o  ->
      ...
      let uu___189_3088 = r in
      {
        FStar_Syntax_Syntax.n = (uu___189_3088.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___189_3088.FStar_Syntax_Syntax.vars)
      }
let unembed_order:
  FStar_Syntax_Syntax.term ->
...
let embed_sigelt_view:
  ...
  fun rng  ->
    fun sev  ->
      ...
      | FStar_Reflection_Data.Unk  ->
          let uu___190_3783 = FStar_Reflection_Data.ref_Unk in
          {
            FStar_Syntax_Syntax.n = (uu___190_3783.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars =
              (uu___190_3783.FStar_Syntax_Syntax.vars)
          }
