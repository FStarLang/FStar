        ...
        let brs1 =
          FStar_List.map
            (fun uu___0_810  ->
               ...
               | (pat,uu____832,t5) ->
                   let uu____850 = inspect_pat pat  in (uu____850, t5)) brs
           in
             ...
             (let uu____1032 =
              ...
              then
                ...
                (let inspect_arg uu____1059 =
                   ...
                   | (a,q) ->
                       let uu____1078 = inspect_aqual q  in (a, uu____1078)
                    in
                 let uu____1081 =
                   let uu____1094 =
...
let (pack_comp : FStar_Reflection_Data.comp_view -> FStar_Syntax_Syntax.comp)
  ...
  fun cv  ->
    ...
    | FStar_Reflection_Data.C_Eff (us,ef,res,args) ->
        ...
        let ct =
          let uu____1296 = FStar_Ident.lid_of_path ef FStar_Range.dummyRange
             in
...
let (pack_const : FStar_Reflection_Data.vconst -> FStar_Syntax_Syntax.sconst)
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.C_Reflect ns ->
        let uu____1355 = FStar_Ident.lid_of_path ns FStar_Range.dummyRange
           in
          ...
          FStar_List.map
            (fun uu___2_1637  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____1654, FStar_Pervasives_Native.None, t1)) brs
           in
...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,ty,uu____2190,c_lids)
        ->
        ...
        (match uu____2201 with
         | (s,us1) ->
             ...
             let uu____2222 =
               let uu____2239 = FStar_List.map FStar_Ident.path_of_lid c_lids
                  in
               (nm, us1, bs1, ty1, uu____2239)  in
             FStar_Reflection_Data.Sg_Inductive uu____2222)
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,ty,uu____2251,n,uu____2253) ->
...
let (inspect_bv : FStar_Syntax_Syntax.bv -> FStar_Reflection_Data.bv_view) =
  fun bv  ->
    let uu____2361 = FStar_Ident.string_of_id bv.FStar_Syntax_Syntax.ppname
       in
