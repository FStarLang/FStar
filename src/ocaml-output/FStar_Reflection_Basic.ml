...
let (pack_comp : FStar_Reflection_Data.comp_view -> FStar_Syntax_Syntax.comp)
  ...
  fun cv  ->
    ...
    | FStar_Reflection_Data.C_Lemma (pre,post) ->
        let ct =
          let uu____1124 =
            let uu____1135 = FStar_Syntax_Syntax.as_arg pre  in
            let uu____1144 =
              let uu____1155 = FStar_Syntax_Syntax.as_arg post  in
              [uu____1155]  in
            uu____1135 :: uu____1144  in
          {
            FStar_Syntax_Syntax.comp_univs = [];
            FStar_Syntax_Syntax.effect_name =
              FStar_Parser_Const.effect_Lemma_lid;
            FStar_Syntax_Syntax.result_typ = FStar_Syntax_Syntax.t_unit;
            FStar_Syntax_Syntax.effect_args = uu____1124;
            FStar_Syntax_Syntax.flags = []
          }  in
        FStar_Syntax_Syntax.mk_Comp ct
    | FStar_Reflection_Data.C_Eff (us,ef,res,args) ->
        let pack_arg uu____1217 =
          match uu____1217 with
          | (a,q) -> let uu____1236 = pack_aqual q  in (a, uu____1236)  in
        let ct =
          let uu____1240 = FStar_Ident.lid_of_path ef FStar_Range.dummyRange
             in
          let uu____1241 = FStar_List.map pack_arg args  in
          {
            FStar_Syntax_Syntax.comp_univs = [];
            FStar_Syntax_Syntax.effect_name = uu____1240;
            FStar_Syntax_Syntax.result_typ = res;
            FStar_Syntax_Syntax.effect_args = uu____1241;
            FStar_Syntax_Syntax.flags = []
          }  in
        FStar_Syntax_Syntax.mk_Comp ct
...
let (pack_const : FStar_Reflection_Data.vconst -> FStar_Syntax_Syntax.sconst)
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.C_Int i ->
        let uu____1267 =
          let uu____1279 = FStar_BigInt.string_of_big_int i  in
          (uu____1279, FStar_Pervasives_Native.None)  in
        FStar_Const.Const_int uu____1267
    ...
    | FStar_Reflection_Data.C_Reflect ns ->
        let uu____1299 = FStar_Ident.lid_of_path ns FStar_Range.dummyRange
           in
        FStar_Const.Const_reflect uu____1299
...
let (pack_ln : FStar_Reflection_Data.term_view -> FStar_Syntax_Syntax.term) =
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_Const c ->
        let uu____1364 =
          let uu____1371 =
            let uu____1372 = pack_const c  in
            FStar_Syntax_Syntax.Tm_constant uu____1372  in
          FStar_Syntax_Syntax.mk uu____1371  in
        uu____1364 FStar_Pervasives_Native.None FStar_Range.dummyRange
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let rec pack_pat p =
          ...
          | FStar_Reflection_Data.Pat_Constant c ->
              let uu____1444 =
                ...
                FStar_Syntax_Syntax.Pat_constant uu____1445  in
              FStar_All.pipe_left wrap uu____1444
                  ...
                  let uu____1477 =
                    FStar_List.map
                      (fun uu____1501  ->
                         ...
                         | (p1,b) ->
                             let uu____1516 = pack_pat p1  in (uu____1516, b))
                      ps
                     in
                  (fv, uu____1477)  in
                FStar_Syntax_Syntax.Pat_cons uu____1463  in
              FStar_All.pipe_left wrap uu____1462
          | FStar_Reflection_Data.Pat_Var bv ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___2_1564  ->
               match uu___2_1564 with
               | (pat,t1) ->
                   let uu____1581 = pack_pat pat  in
                   (uu____1581, FStar_Pervasives_Native.None, t1)) brs
           in
...
let (lookup_attr :
  ...
  fun attr  ->
    fun env  ->
      let uu____1742 =
        let uu____1743 = FStar_Syntax_Subst.compress attr  in
        uu____1743.FStar_Syntax_Syntax.n  in
      match uu____1742 with
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let ses =
            let uu____1752 =
              let uu____1754 = FStar_Syntax_Syntax.lid_of_fv fv  in
              FStar_Ident.text_of_lid uu____1754  in
            FStar_TypeChecker_Env.lookup_attr env uu____1752  in
          FStar_List.concatMap
            (fun se  ->
               let uu____1758 = FStar_Syntax_Util.lid_of_sigelt se  in
...
let (all_defs_in_env :
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.fv Prims.list) =
  fun env  ->
    let uu____1777 = FStar_TypeChecker_Env.lidents env  in
    FStar_List.map
      (fun l  ->
         FStar_Syntax_Syntax.lid_as_fv l
           (FStar_Syntax_Syntax.Delta_constant_at_level (Prims.of_int (999)))
           FStar_Pervasives_Native.None) uu____1777
...
let (defs_in_module :
  ...
  fun env  ->
    fun modul  ->
      let uu____1798 = FStar_TypeChecker_Env.lidents env  in
      FStar_List.concatMap
        (fun l  ->
           let ns =
             let uu____1806 =
               let uu____1809 = FStar_Ident.ids_of_lid l  in
               FStar_All.pipe_right uu____1809 init  in
...
let (set_sigelt_attrs :
  ...
  fun attrs  ->
    fun se  ->
      let uu___411_1873 = se  in
      {
        FStar_Syntax_Syntax.sigel = (uu___411_1873.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___411_1873.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals =
          (uu___411_1873.FStar_Syntax_Syntax.sigquals);
        FStar_Syntax_Syntax.sigmeta =
          (uu___411_1873.FStar_Syntax_Syntax.sigmeta);
        FStar_Syntax_Syntax.sigattrs = attrs;
        FStar_Syntax_Syntax.sigopts =
          (uu___411_1873.FStar_Syntax_Syntax.sigopts)
      }
...
let (set_sigelt_quals :
  ...
  fun quals  ->
    fun se  ->
      let uu___490_1981 = se  in
      let uu____1982 = FStar_List.map rd_to_syntax_qual quals  in
      {
        FStar_Syntax_Syntax.sigel = (uu___490_1981.FStar_Syntax_Syntax.sigel);
        FStar_Syntax_Syntax.sigrng =
          (uu___490_1981.FStar_Syntax_Syntax.sigrng);
        FStar_Syntax_Syntax.sigquals = uu____1982;
        FStar_Syntax_Syntax.sigmeta =
          (uu___490_1981.FStar_Syntax_Syntax.sigmeta);
        FStar_Syntax_Syntax.sigattrs =
          (uu___490_1981.FStar_Syntax_Syntax.sigattrs);
        FStar_Syntax_Syntax.sigopts =
          (uu___490_1981.FStar_Syntax_Syntax.sigopts)
      }
  ...
  fun se  ->
    ...
    | FStar_Pervasives_Native.Some o ->
        let uu____2015 =
          let uu____2016 =
            let uu____2023 =
              let uu____2026 = FStar_ST.op_Bang e_optionstate_hook  in
              FStar_All.pipe_right uu____2026 FStar_Util.must  in
            FStar_Syntax_Embeddings.embed uu____2023 o  in
          uu____2016 FStar_Range.dummyRange FStar_Pervasives_Native.None
...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let ((r,lb::[]),uu____2076) ->
        let fv =
          match lb.FStar_Syntax_Syntax.lbname with
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,ty,uu____2117,c_lids)
        ->
        let nm = FStar_Ident.path_of_lid lid  in
        let uu____2128 = FStar_Syntax_Subst.univ_var_opening us  in
        (match uu____2128 with
         | (s,us1) ->
             let bs1 = FStar_Syntax_Subst.subst_binders s bs  in
             let ty1 = FStar_Syntax_Subst.subst s ty  in
             let uu____2149 =
               let uu____2166 = FStar_List.map FStar_Ident.path_of_lid c_lids
                  in
               (nm, us1, bs1, ty1, uu____2166)  in
             FStar_Reflection_Data.Sg_Inductive uu____2149)
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,ty,uu____2178,n1,uu____2180) ->
        let uu____2187 = FStar_Syntax_Subst.univ_var_opening us  in
        (match uu____2187 with
         | (s,us1) ->
             let ty1 = FStar_Syntax_Subst.subst s ty  in
             let uu____2207 =
               let uu____2212 = FStar_Ident.path_of_lid lid  in
               (uu____2212, ty1)  in
             FStar_Reflection_Data.Sg_Constructor uu____2207)
    | uu____2213 -> FStar_Reflection_Data.Unk
  ...
  fun sv  ->
    ...
    | FStar_Reflection_Data.Sg_Let (r,fv,univs1,typ,def) ->
        ...
        let uu____2239 =
          let uu____2240 =
            let uu____2247 =
              let uu____2250 = FStar_Syntax_Syntax.lid_of_fv fv  in
              [uu____2250]  in
            ((r, [lb]), uu____2247)  in
          FStar_Syntax_Syntax.Sig_let uu____2240  in
        FStar_All.pipe_left FStar_Syntax_Syntax.mk_sigelt uu____2239
    | FStar_Reflection_Data.Sg_Constructor uu____2256 ->
        failwith "packing Sg_Constructor, sorry"
    | FStar_Reflection_Data.Sg_Inductive uu____2262 ->
...
let (inspect_bv : FStar_Syntax_Syntax.bv -> FStar_Reflection_Data.bv_view) =
  fun bv  ->
    ...
    let uu____2289 = FStar_BigInt.of_int_fs bv.FStar_Syntax_Syntax.index  in
    {
      FStar_Reflection_Data.bv_ppname = uu____2287;
      FStar_Reflection_Data.bv_index = uu____2289;
...
let (pack_bv : FStar_Reflection_Data.bv_view -> FStar_Syntax_Syntax.bv) =
  fun bvv  ->
    ...
    {
      FStar_Syntax_Syntax.ppname = uu____2296;
      FStar_Syntax_Syntax.index = uu____2298;
...
let (inspect_binder :
  ...
  fun b  ->
    ...
    | (bv,aq) -> let uu____2325 = inspect_aqual aq  in (bv, uu____2325)
  
let (pack_binder :
  FStar_Syntax_Syntax.bv ->
    FStar_Reflection_Data.aqualv -> FStar_Syntax_Syntax.binder)
  =
  fun bv  -> fun aqv  -> let uu____2337 = pack_aqual aqv  in (bv, uu____2337) 
  ...
  fun e  ->
    ...
    FStar_List.map
      (fun uu____2382  ->
         ...
         | (l,m) ->
             let uu____2392 = FStar_Ident.ids_of_lid l  in
             FStar_List.map FStar_Ident.text_of_id uu____2392) uu____2364
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let uu____2414 = FStar_Syntax_Util.un_uinst t1  in
      let uu____2415 = FStar_Syntax_Util.un_uinst t2  in
      FStar_Syntax_Util.term_eq uu____2414 uu____2415
