        ...
        (fun l ->
           ...
           then
             let uu____1563 =
               FStar_Syntax_Syntax.lid_as_fv l
                 (FStar_Syntax_Syntax.Delta_constant_at_level
                    (Prims.parse_int "999")) FStar_Pervasives_Native.None in
             [uu____1563]
           else []) uu____1539
let (lookup_typ :
  FStar_TypeChecker_Env.env ->
...
let (inspect_sigelt :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid, us, bs, ty, uu____1664, c_lids) ->
        ...
        (match uu____1675 with
         | (s, us1) ->
             ...
             let uu____1696 =
               let uu____1713 = FStar_List.map FStar_Ident.path_of_lid c_lids in
               (nm, us1, bs1, ty1, uu____1713) in
             FStar_Reflection_Data.Sg_Inductive uu____1696)
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, us, ty, uu____1725, n1, uu____1727) ->
