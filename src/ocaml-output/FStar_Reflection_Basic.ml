          ...
          FStar_List.map
            (fun uu___232_1153 ->
               ...
               | (pat, t1) ->
                   ...
                   (uu____1170, FStar_Pervasives_Native.None, t1)) brs in
...
let (inspect_sigelt :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid, us, bs, ty, uu____1428, c_lids) ->
        ...
        (match uu____1439 with
         | (s, us1) ->
             ...
             let uu____1460 =
               let uu____1477 = FStar_List.map FStar_Ident.path_of_lid c_lids in
               (nm, us1, bs1, ty1, uu____1477) in
             FStar_Reflection_Data.Sg_Inductive uu____1460)
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, us, ty, uu____1489, n1, uu____1491) ->
