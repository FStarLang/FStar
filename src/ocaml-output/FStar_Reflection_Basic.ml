    ...
    | FStar_Reflection_Data.Tv_Match (t, ret_opt, brs) ->
        ...
        let rec pack_pat p =
          ...
          | FStar_Reflection_Data.Pat_Constant c ->
              ...
              FStar_All.op_Less_Bar wrap uu___
          | FStar_Reflection_Data.Pat_Cons (fv, ps) ->
              ...
              FStar_All.op_Less_Bar wrap uu___
          | FStar_Reflection_Data.Pat_Var bv ->
              FStar_All.op_Less_Bar wrap (FStar_Syntax_Syntax.Pat_var bv)
          | FStar_Reflection_Data.Pat_Wild bv ->
              FStar_All.op_Less_Bar wrap (FStar_Syntax_Syntax.Pat_wild bv)
          | FStar_Reflection_Data.Pat_Dot_Term (bv, t1) ->
              FStar_All.op_Less_Bar wrap
        ...
        (fun l ->
           let ns =
             let uu___1 =
               ...
               FStar_All.op_Bar_Greater uu___2 init in
...
let (sigelt_quals :
  ...
  fun se ->
    FStar_All.op_Bar_Greater se.FStar_Syntax_Syntax.sigquals
...
let (pack_sigelt :
  ...
  fun sv ->
    ...
    | FStar_Reflection_Data.Sg_Let (r, fv, univs, typ, def) ->
        ...
        FStar_All.op_Less_Bar FStar_Syntax_Syntax.mk_sigelt uu___
    | FStar_Reflection_Data.Sg_Inductive (nm, us_names, param_bs, ty, ctors)
        ...
        let pack_ctor c =
          ...
          | (nm1, ty1) ->
              ...
              FStar_All.op_Less_Bar FStar_Syntax_Syntax.mk_sigelt
                (FStar_Syntax_Syntax.Sig_datacon
