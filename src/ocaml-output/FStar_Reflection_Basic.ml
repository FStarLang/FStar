...
let rec embed_list embed_a typ l =
  ...
  | [] ->
      let uu____260 =
        ...
        let uu____263 =
          let uu____264 = FStar_Syntax_Syntax.iarg typ in [uu____264] in
...
let embed_pair embed_a t_a embed_b t_b x =
  let uu____558 =
    let uu____559 =
      let uu____560 = FStar_Reflection_Data.lid_as_data_tm lid_Mktuple2 in
    ...
    let uu____561 =
      ...
      let uu____563 =
        ...
        let uu____567 =
          let uu____570 =
            let uu____571 = embed_a (FStar_Pervasives_Native.fst x) in
            FStar_Syntax_Syntax.as_arg uu____571 in
          let uu____572 =
            let uu____575 =
              let uu____576 = embed_b (FStar_Pervasives_Native.snd x) in
...
let unembed_pair unembed_a unembed_b pair =
  ...
  | (hd1,args) ->
      ...
      (match uu____659 with
       | (FStar_Syntax_Syntax.Tm_fvar
          fv,uu____689::uu____690::(a,uu____692)::(b,uu____694)::[]) when
      ...
      let uu____802 =
        let uu____803 =
          ...
          FStar_Syntax_Syntax.mk_Tm_uinst uu____804
            [FStar_Syntax_Syntax.U_zero] in
        let uu____805 =
          let uu____806 = FStar_Syntax_Syntax.iarg typ in [uu____806] in
  ...
  | (hd1,args) ->
      ...
      (match uu____883 with
       | (FStar_Syntax_Syntax.Tm_fvar fv,uu____911) when
           ...
           FStar_Pervasives_Native.None
       | (FStar_Syntax_Syntax.Tm_fvar fv,uu____929::(a,uu____931)::[]) when
    ...
    | FStar_Reflection_Data.Pat_Constant c ->
        let uu____1207 =
          ...
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Pat_Constant uu____1208 in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(l,uu____1729)::(r,uu____1731)::[]) when
             ...
             let uu____1766 =
               ...
               let uu____1772 = unembed_term r in (uu____1771, uu____1772) in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1775)::(t2,uu____1777)::[]) when
             ...
             let uu____1812 =
               ...
               let uu____1818 = unembed_term t2 in (uu____1817, uu____1818) in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1821)::(t2,uu____1823)::[]) when
             ...
             let uu____1858 =
               ...
               let uu____1864 = unembed_term t2 in (uu____1863, uu____1864) in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1895)::(t2,uu____1897)::[]) when
             ...
             let uu____1932 =
               ...
               let uu____1938 = unembed_term t2 in (uu____1937, uu____1938) in
                ...
                let uu____2597 =
                  FStar_List.map
                    (fun uu____2609  ->
                       ...
                       | (p1,uu____2617) -> inspect_pat p1) ps in
                (fv, uu____2597) in
        ...
        let brs2 =
          FStar_List.map
            (fun uu___76_2670  ->
               ...
               | (pat,uu____2692,t3) ->
                   let uu____2710 = inspect_pat pat in (uu____2710, t3)) brs1 in
          ...
          FStar_List.map
            (fun uu___77_2902  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____2919, FStar_Pervasives_Native.None, t1)) brs in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3600)::(t2,uu____3602)::[]) when
             ...
             let uu____3637 =
               ...
               let uu____3645 = unembed_term t2 in (uu____3642, uu____3645) in
  ...
  fun sev  ->
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,bs,t,dcs) ->
        let uu____3677 =
          ...
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Sg_Inductive uu____3678 in
