...
let uu____369 = (FStar_Util.string_of_int i)
...
in (FStar_Util.bind_opt uu____527 (fun i1 -> (FStar_All.pipe_left (fun _0_41 -> FStar_Pervasives_Native.Some (_0_41)) (FStar_Reflection_Data.C_Int (i1))))))
end
...
in (FStar_Util.bind_opt uu____561 (fun s1 -> (FStar_All.pipe_left (fun _0_42 -> FStar_Pervasives_Native.Some (_0_42)) (FStar_Reflection_Data.C_String (s1))))))
end
| uu____568 -> begin
((
...
in (FStar_Util.bind_opt uu____742 (fun c1 -> (FStar_All.pipe_left (fun _0_43 -> FStar_Pervasives_Native.Some (_0_43)) (FStar_Reflection_Data.Pat_Constant (c1))))))
end
...
in (uu____799 ps))
in (FStar_Util.bind_opt uu____794 (fun ps1 -> (FStar_All.pipe_left (fun _0_44 -> FStar_Pervasives_Native.Some (_0_44)) (FStar_Reflection_Data.Pat_Cons (((f1), (ps1)))))))))))
end
...
in (FStar_Util.bind_opt uu____1333 (fun b1 -> (FStar_All.pipe_left (fun _0_47 -> FStar_Pervasives_Native.Some (_0_47)) (FStar_Reflection_Data.Tv_Var (b1))))))
end
...
in (FStar_Util.bind_opt uu____1367 (fun f1 -> (FStar_All.pipe_left (fun _0_48 -> FStar_Pervasives_Native.Some (_0_48)) (FStar_Reflection_Data.Tv_FVar (f1))))))
end
...
in (FStar_Util.bind_opt uu____1419 (fun r1 -> (FStar_All.pipe_left (fun _0_49 -> FStar_Pervasives_Native.Some (_0_49)) (FStar_Reflection_Data.Tv_App (((l1), (r1)))))))))))
end
...
in (FStar_Util.bind_opt uu____1487 (fun t3 -> (FStar_All.pipe_left (fun _0_50 -> FStar_Pervasives_Native.Some (_0_50)) (FStar_Reflection_Data.Tv_Abs (((b1), (t3)))))))))))
end
...
in (FStar_Util.bind_opt uu____1539 (fun c -> (FStar_All.pipe_left (fun _0_51 -> FStar_Pervasives_Native.Some (_0_51)) (FStar_Reflection_Data.Tv_Arrow (((b1), (c)))))))))))
end
...
in (FStar_Util.bind_opt uu____1573 (fun u1 -> (FStar_All.pipe_left (fun _0_52 -> FStar_Pervasives_Native.Some (_0_52)) (FStar_Reflection_Data.Tv_Type (()))))))
end
...
in (FStar_Util.bind_opt uu____1625 (fun t3 -> (FStar_All.pipe_left (fun _0_53 -> FStar_Pervasives_Native.Some (_0_53)) (FStar_Reflection_Data.Tv_Refine (((b1), (t3)))))))))))
end
...
in (FStar_Util.bind_opt uu____1659 (fun c1 -> (FStar_All.pipe_left (fun _0_54 -> FStar_Pervasives_Native.Some (_0_54)) (FStar_Reflection_Data.Tv_Const (c1))))))
end
...
in (FStar_Util.bind_opt uu____1711 (fun t3 -> (FStar_All.pipe_left (fun _0_55 -> FStar_Pervasives_Native.Some (_0_55)) (FStar_Reflection_Data.Tv_Uvar (((u1), (t3)))))))))))
end
...
in (FStar_Util.bind_opt uu____1781 (fun t21 -> (FStar_All.pipe_left (fun _0_56 -> FStar_Pervasives_Native.Some (_0_56)) (FStar_Reflection_Data.Tv_Let (((b1), (t12), (t21))))))))))))))
end
...
in (uu____1842 brs))
in (FStar_Util.bind_opt uu____1833 (fun brs1 -> (FStar_All.pipe_left (fun _0_57 -> FStar_Pervasives_Native.Some (_0_57)) (FStar_Reflection_Data.Tv_Match (((t3), (brs1)))))))))))
end
...
in (FStar_Util.bind_opt uu____2046 (fun t3 -> (FStar_All.pipe_left (fun _0_59 -> FStar_Pervasives_Native.Some (_0_59)) (FStar_Reflection_Data.C_Total (t3))))))
end
...
in (FStar_Util.bind_opt uu____2098 (fun post1 -> (FStar_All.pipe_left (fun _0_60 -> FStar_Pervasives_Native.Some (_0_60)) (FStar_Reflection_Data.C_Lemma (((pre1), (post1)))))))))))
end
...
let uu____2221 = (FStar_Util.int_of_string s)
...
let uu____2536 = (FStar_Syntax_Unionfind.uvar_id u)
in ((uu____2536), (t3)))
...
| FStar_Util.Inr (uu____2556) -> begin
FStar_Reflection_Data.Tv_Unknown
end
...
let uu____2559 = (FStar_Syntax_Subst.open_term ((b)::[]) t21)
...
let uu____2646 = (inspect_const c)
in FStar_Reflection_Data.Pat_Constant (uu____2646))
end
...
let uu____2672 = (FStar_List.map (fun uu____2684 -> (match (uu____2684) with
| (p1, uu____2692) -> begin
(inspect_pat p1)
end)) ps)
in ((fv), (uu____2672)))
in FStar_Reflection_Data.Pat_Cons (uu____2665))
end
...
| FStar_Syntax_Syntax.Pat_dot_term (uu____2701) -> begin
...
let brs2 = (FStar_List.map (fun uu___111_2745 -> (match (uu___111_2745) with
| (pat, uu____2767, t4) -> begin
(

let uu____2785 = (inspect_pat pat)
in ((uu____2785), (t4)))
end)) brs1)
...
let uu____2800 = (FStar_Syntax_Print.tag_of_term t2)
in (

let uu____2801 = (FStar_Syntax_Print.term_to_string t2)
...
| FStar_Syntax_Syntax.Total (t, uu____2807) -> begin
...
| ((pre, uu____2818))::((post, uu____2820))::uu____2821 -> begin
...
| FStar_Syntax_Syntax.GTotal (uu____2864) -> begin
FStar_Reflection_Data.C_Unknown
end))
...
let uu____2895 = (FStar_Util.string_of_int i)
in ((uu____2895), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____2884))
end
| FStar_Reflection_Data.C_True -> begin
...
| FStar_Reflection_Data.Tv_Var (bv, uu____2912) -> begin
...
let uu____2930 = (FStar_Syntax_Syntax.as_arg r)
in (uu____2930)::[])
in (FStar_Syntax_Util.mk_app l uu____2921))
end
| FStar_Reflection_Data.Q_Implicit -> begin
(
...
let uu____2940 = (FStar_Syntax_Syntax.iarg r)
in (uu____2940)::[])
in (FStar_Syntax_Util.mk_app l uu____2931))
end)
end
...
| FStar_Reflection_Data.Tv_Refine ((bv, uu____2946), t) -> begin
...
let uu____2957 = (pack_const c)
in FStar_Syntax_Syntax.Tm_constant (uu____2957))
in (FStar_Syntax_Syntax.mk uu____2956))
in (uu____2953 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____2985 = (FStar_Syntax_Subst.close ((b)::[]) t2)
in ((((false), ((lb)::[]))), (uu____2985)))
in FStar_Syntax_Syntax.Tm_let (uu____2972))
in (FStar_Syntax_Syntax.mk uu____2971))
in (uu____2968 FStar_Pervasives_Native.None FStar_Range.dummyRange))))
end
...
let uu____3015 = (pack_const c)
in FStar_Syntax_Syntax.Pat_constant (uu____3015))
in (FStar_All.pipe_left wrap uu____3014))
end
| FStar_Reflection_Data.Pat_Cons (fv, ps) -> begin
(
...
let uu____3038 = (FStar_List.map (fun p1 -> (

let uu____3052 = (pack_pat p1)
in ((uu____3052), (false)))) ps)
in ((fv), (uu____3038)))
in FStar_Syntax_Syntax.Pat_cons (uu____3025))
in (FStar_All.pipe_left wrap uu____3024))
end
| FStar_Reflection_Data.Pat_Var (bv) -> begin
...
let brs1 = (FStar_List.map (fun uu___112_3098 -> (match (uu___112_3098) with
| (pat, t1) -> begin
(

let uu____3115 = (pack_pat pat)
in ((uu____3115), (FStar_Pervasives_Native.None), (t1)))
end)) brs)
in (
...
let uu___126_3136 = r
in {FStar_Syntax_Syntax.n = uu___126_3136.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = rng; FStar_Syntax_Syntax.vars = uu___126_3136.FStar_Syntax_Syntax.vars})))
...
let uu____3146 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____3199 = (FStar_Syntax_Util.un_uinst hd1)
in uu____3199.FStar_Syntax_Syntax.n)
in ((uu____3198), (args)))
...
let uu____3272 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format1 "Not an embedded order: %s" uu____3272))
in (FStar_Errors.warn t1.FStar_Syntax_Syntax.pos uu____3271));
FStar_Pervasives_Native.None;
)
end))
end))))
...
| FStar_Pervasives_Native.Some (FStar_Util.Inl (uu____3344), rng) -> begin
FStar_Reflection_Data.Unk
end
| FStar_Pervasives_Native.Some (FStar_Util.Inr (se, us), rng) -> begin
(match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid1, us1, bs, t, uu____3445, dc_lids) -> begin
(
...
let uu____3462 = (FStar_TypeChecker_Env.lookup_qname env dc_lid)
in (match (uu____3462) with
| FStar_Pervasives_Native.Some (FStar_Util.Inr (se1, us2), rng1) -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (lid2, us3, t1, uu____3535, n1, uu____3537) -> begin
(

let uu____3542 = (

let uu____3547 = (FStar_Ident.path_of_lid lid2)
in ((uu____3547), (t1)))
in FStar_Reflection_Data.Ctor (uu____3542))
end
| uu____3552 -> begin
(failwith "wat 1")
end)
...
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____3582) -> begin
(
...
| FStar_Util.Inl (uu____3597) -> begin
...
let uu____3616 = (FStar_Syntax_Embeddings.embed_string_list rng nm)
in (FStar_Syntax_Syntax.as_arg uu____3616))
in (
...
let uu____3621 = (embed_term rng t)
in (FStar_Syntax_Syntax.as_arg uu____3621))
in (uu____3620)::[])
in (uu____3615)::uu____3617))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Ctor uu____3614))
in (uu____3613 FStar_Pervasives_Native.None rng))
end))
...
let uu____3633 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____3686 = (FStar_Syntax_Util.un_uinst hd1)
in uu____3686.FStar_Syntax_Syntax.n)
in ((uu____3685), (args)))
in (match (uu____3672) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((nm, uu____3701))::((t2, uu____3703))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_Ctor_lid) -> begin
(

let uu____3738 = (FStar_Syntax_Embeddings.unembed_string_list nm)
in (FStar_Util.bind_opt uu____3738 (fun nm1 -> (

let uu____3750 = (unembed_term t2)
in (FStar_Util.bind_opt uu____3750 (fun t3 -> (FStar_All.pipe_left (fun _0_62 -> FStar_Pervasives_Native.Some (_0_62)) (FStar_Reflection_Data.Ctor (((nm1), (t3)))))))))))
end
| uu____3759 -> begin
((
...
let uu____3774 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format1 "Not an embedded ctor: %s" uu____3774))
in (FStar_Errors.warn t1.FStar_Syntax_Syntax.pos uu____3773));
FStar_Pervasives_Native.None;
)
end))
end))))
...
let uu____3798 = (FStar_Syntax_Embeddings.embed_string_list rng nm)
in (FStar_Syntax_Syntax.as_arg uu____3798))
in (
...
let uu____3803 = (embed_binders rng bs)
in (FStar_Syntax_Syntax.as_arg uu____3803))
in (
...
let uu____3808 = (embed_term rng t)
in (FStar_Syntax_Syntax.as_arg uu____3808))
in (
...
let uu____3814 = (FStar_Syntax_Embeddings.embed_list embed_ctor FStar_Reflection_Data.fstar_refl_ctor)
in (uu____3814 rng dcs))
in (FStar_Syntax_Syntax.as_arg uu____3813))
in (uu____3812)::[])
in (uu____3807)::uu____3809))
in (uu____3802)::uu____3804))
in (uu____3797)::uu____3799))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Sg_Inductive uu____3796))
in (uu____3795 FStar_Pervasives_Native.None rng))
end
...
let uu____3830 = (embed_fvar rng fv)
in (FStar_Syntax_Syntax.as_arg uu____3830))
in (
...
let uu____3835 = (embed_term rng ty)
...
let uu____3840 = (embed_term rng t)
in (FStar_Syntax_Syntax.as_arg uu____3840))
in (uu____3839)::[])
in (uu____3834)::uu____3836))
in (uu____3829)::uu____3831))
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Reflection_Data.ref_Sg_Let uu____3828))
in (uu____3827 FStar_Pervasives_Native.None rng))
end
| FStar_Reflection_Data.Unk -> begin
(

let uu___127_3843 = FStar_Reflection_Data.ref_Unk
in {FStar_Syntax_Syntax.n = uu___127_3843.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = rng; FStar_Syntax_Syntax.vars = uu___127_3843.FStar_Syntax_Syntax.vars})
end))
...
let uu____3853 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____3906 = (FStar_Syntax_Util.un_uinst hd1)
in uu____3906.FStar_Syntax_Syntax.n)
in ((uu____3905), (args)))
in (match (uu____3892) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((nm, uu____3921))::((bs, uu____3923))::((t2, uu____3925))::((dcs, uu____3927))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_Sg_Inductive_lid) -> begin
(

let uu____3982 = (FStar_Syntax_Embeddings.unembed_string_list nm)
in (FStar_Util.bind_opt uu____3982 (fun nm1 -> (

let uu____3994 = (unembed_binders bs)
in (FStar_Util.bind_opt uu____3994 (fun bs1 -> (

let uu____4006 = (unembed_term t2)
in (FStar_Util.bind_opt uu____4006 (fun t3 -> (

let uu____4012 = (

let uu____4017 = (FStar_Syntax_Embeddings.unembed_list unembed_ctor)
in (uu____4017 dcs))
in (FStar_Util.bind_opt uu____4012 (fun dcs1 -> (FStar_All.pipe_left (fun _0_63 -> FStar_Pervasives_Native.Some (_0_63)) (FStar_Reflection_Data.Sg_Inductive (((nm1), (bs1), (t3), (dcs1)))))))))))))))))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((fvar1, uu____4040))::((ty, uu____4042))::((t2, uu____4044))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ref_Sg_Let_lid) -> begin
(

let uu____4089 = (unembed_fvar fvar1)
in (FStar_Util.bind_opt uu____4089 (fun fvar2 -> (

let uu____4095 = (unembed_term ty)
in (FStar_Util.bind_opt uu____4095 (fun ty1 -> (

let uu____4101 = (unembed_term t2)
in (FStar_Util.bind_opt uu____4101 (fun t3 -> (FStar_All.pipe_left (fun _0_64 -> FStar_Pervasives_Native.Some (_0_64)) (FStar_Reflection_Data.Sg_Let (((fvar2), (ty1), (t3))))))))))))))
end
...
let uu____4138 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format1 "Not an embedded sigelt_view: %s" uu____4138))
in (FStar_Errors.warn t1.FStar_Syntax_Syntax.pos uu____4137));
FStar_Pervasives_Native.None;
)
end))
end))))
...
let type_of_binder : 'Auu____4147 . (FStar_Syntax_Syntax.bv * 'Auu____4147)  ->  FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax = (fun b -> (match (b) with
| (b1, uu____4163) -> begin
...
let fresh_binder : 'Auu____4174 . FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.bv * 'Auu____4174 FStar_Pervasives_Native.option) = (fun t -> (

let uu____4185 = (FStar_Syntax_Syntax.gen_bv "__refl" FStar_Pervasives_Native.None t)
in ((uu____4185), (FStar_Pervasives_Native.None))))
