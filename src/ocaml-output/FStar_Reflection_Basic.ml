...
let rec (inspect_ln :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_abs ([],uu____231,uu____232) ->
    ...
    | FStar_Syntax_Syntax.Tm_type uu____315 ->
        FStar_Reflection_Data.Tv_Type ()
    | FStar_Syntax_Syntax.Tm_arrow ([],k) ->
        failwith "inspect_ln: empty binders on arrow"
    | FStar_Syntax_Syntax.Tm_arrow uu____331 ->
        let uu____344 = FStar_Syntax_Util.arrow_one t2  in
    ...
    | FStar_Syntax_Syntax.Tm_constant c ->
        let uu____370 = inspect_const c  in
        FStar_Reflection_Data.Tv_Const uu____370
    | FStar_Syntax_Syntax.Tm_uvar (u,t3) ->
        let uu____397 =
          let uu____402 =
            let uu____403 = FStar_Syntax_Unionfind.uvar_id u  in
            FStar_BigInt.of_int_fs uu____403  in
          (uu____402, t3)  in
        FStar_Reflection_Data.Tv_Uvar uu____397
    | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t21) ->
        if lb.FStar_Syntax_Syntax.lbunivs <> []
        then FStar_Reflection_Data.Tv_Unknown
        else
          (match lb.FStar_Syntax_Syntax.lbname with
           | FStar_Util.Inr uu____423 -> FStar_Reflection_Data.Tv_Unknown
           | FStar_Util.Inl bv ->
    ...
    | FStar_Syntax_Syntax.Tm_let ((true ,lb::[]),t21) ->
        ...
        then FStar_Reflection_Data.Tv_Unknown
          ...
          (match lb.FStar_Syntax_Syntax.lbname with
           | FStar_Util.Inr uu____446 -> FStar_Reflection_Data.Tv_Unknown
           | FStar_Util.Inl bv ->
               FStar_Reflection_Data.Tv_Let
    ...
    | FStar_Syntax_Syntax.Tm_match (t3,brs) ->
        let rec inspect_pat p =
          ...
          | FStar_Syntax_Syntax.Pat_constant c ->
              let uu____500 = inspect_const c  in
              FStar_Reflection_Data.Pat_Constant uu____500
                ...
                let uu____526 =
                  FStar_List.map
                    (fun uu____538  ->
                       ...
                       | (p1,uu____546) -> inspect_pat p1) ps
                   in
                (fv, uu____526)  in
              FStar_Reflection_Data.Pat_Cons uu____519
        ...
        let brs1 =
          FStar_List.map
            (fun uu___56_597  ->
               match uu___56_597 with
               | (pat,uu____619,t4) ->
                   let uu____637 = inspect_pat pat  in (uu____637, t4)) brs
           in
    ...
    | uu____650 ->
        let uu____651 =
          let uu____652 =
            let uu____657 =
              let uu____658 = FStar_Syntax_Print.tag_of_term t2  in
              let uu____659 = FStar_Syntax_Print.term_to_string t2  in
              FStar_Util.format2
                "inspect_ln: outside of expected syntax (%s, %s)\n" uu____658
                uu____659
               in
            (FStar_Errors.Warning_CantInspect, uu____657)  in
          FStar_Errors.log_issue t2.FStar_Syntax_Syntax.pos uu____652  in
...
let (inspect_comp :
  ...
  fun c  ->
    ...
    | FStar_Syntax_Syntax.Total (t,uu____666) ->
          ...
          (let uu____728 =
           ...
           then
             let maybe_dec =
               FStar_List.tryFind
                 (fun uu___57_734  ->
                    match uu___57_734 with
                    | FStar_Syntax_Syntax.DECREASES uu____735 -> true
                    | uu____738 -> false) ct.FStar_Syntax_Syntax.flags
                in
             let md =
               ...
               | uu____755 -> failwith "impossible"  in
...
let (pack_ln : FStar_Reflection_Data.term_view -> FStar_Syntax_Syntax.term) =
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_Const c ->
        let uu____850 =
          let uu____855 =
            let uu____856 = pack_const c  in
            FStar_Syntax_Syntax.Tm_constant uu____856  in
          FStar_Syntax_Syntax.mk uu____855  in
        uu____850 FStar_Pervasives_Native.None FStar_Range.dummyRange
    | FStar_Reflection_Data.Tv_Uvar (u,t) ->
        let uu____862 = FStar_BigInt.to_int_fs u  in
        FStar_Syntax_Util.uvar_from_id uu____862 t
    ...
    | FStar_Reflection_Data.Tv_Match (t,brs) ->
        ...
        let rec pack_pat p =
          ...
          | FStar_Reflection_Data.Pat_Constant c ->
              let uu____910 =
                let uu____911 = pack_const c  in
                FStar_Syntax_Syntax.Pat_constant uu____911  in
              FStar_All.pipe_left wrap uu____910
              ...
              let uu____920 =
                let uu____921 =
                  let uu____934 =
                    FStar_List.map
                      (fun p1  ->
                         let uu____948 = pack_pat p1  in (uu____948, false))
                      ps
                     in
                  (fv, uu____934)  in
                FStar_Syntax_Syntax.Pat_cons uu____921  in
              FStar_All.pipe_left wrap uu____920
          | FStar_Reflection_Data.Pat_Var bv ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___58_998  ->
               match uu___58_998 with
               | (pat,t1) ->
                   let uu____1015 = pack_pat pat  in
                   (uu____1015, FStar_Pervasives_Native.None, t1)) brs
           in
...
let (lookup_typ :
  ...
  fun env  ->
    fun ns  ->
      let lid = FStar_Parser_Const.p2l ns  in
      let uu____1138 = FStar_TypeChecker_Env.lookup_qname env lid  in
      match uu____1138 with
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
      | FStar_Pervasives_Native.Some (FStar_Util.Inl uu____1159,rng) ->
          FStar_Pervasives_Native.None
...
let (inspect_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let ((r,lb::[]),uu____1263) ->
        let fv =
          match lb.FStar_Syntax_Syntax.lbname with
          | FStar_Util.Inr fv -> fv
          | FStar_Util.Inl uu____1278 -> failwith "global Sig_let has bv"  in
        FStar_Reflection_Data.Sg_Let
          (r, fv, (lb.FStar_Syntax_Syntax.lbtyp),
            (lb.FStar_Syntax_Syntax.lbdef))
    | FStar_Syntax_Syntax.Sig_inductive_typ (lid,us,bs,t,uu____1287,c_lids)
        ->
        let nm = FStar_Ident.path_of_lid lid  in
        let uu____1298 =
          let uu____1311 = FStar_List.map FStar_Ident.path_of_lid c_lids  in
          (nm, bs, t, uu____1311)  in
        FStar_Reflection_Data.Sg_Inductive uu____1298
    | FStar_Syntax_Syntax.Sig_datacon (lid,us,t,uu____1319,n1,uu____1321) ->
        let uu____1326 =
          let uu____1331 = FStar_Ident.path_of_lid lid  in (uu____1331, t)
           in
        FStar_Reflection_Data.Sg_Constructor uu____1326
    | uu____1332 -> FStar_Reflection_Data.Unk
...
let (inspect_bv : FStar_Syntax_Syntax.bv -> FStar_Reflection_Data.bv_view) =
  fun bv  ->
    ...
    let uu____1391 = FStar_BigInt.of_int_fs bv.FStar_Syntax_Syntax.index  in
    {
      FStar_Reflection_Data.bv_ppname = uu____1390;
      FStar_Reflection_Data.bv_index = uu____1391;
...
let (pack_bv : FStar_Reflection_Data.bv_view -> FStar_Syntax_Syntax.bv) =
  fun bvv  ->
    ...
    {
      FStar_Syntax_Syntax.ppname = uu____1397;
      FStar_Syntax_Syntax.index = uu____1398;
...
let (inspect_binder :
  ...
  fun b  ->
    ...
    | (bv,aq) -> let uu____1419 = inspect_aqual aq  in (bv, uu____1419)
  
let (pack_binder :
  FStar_Syntax_Syntax.bv ->
    FStar_Reflection_Data.aqualv -> FStar_Syntax_Syntax.binder)
  =
  fun bv  -> fun aqv  -> let uu____1430 = pack_aqual aqv  in (bv, uu____1430) 
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let uu____1455 = FStar_Syntax_Util.un_uinst t1  in
      let uu____1456 = FStar_Syntax_Util.un_uinst t2  in
      FStar_Syntax_Util.term_eq uu____1455 uu____1456
