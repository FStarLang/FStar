...
| Some (l) -> begin
(let _99_59 = (FStar_Absyn_Syntax.text_of_lid l)
in Some (_99_59))
end))
...
let modules_to_sigtables = (fun mods -> (let _99_66 = (FStar_List.collect (fun _30_41 -> (match (_30_41) with
| (_30_39, m) -> begin
m.FStar_Absyn_Syntax.declarations
end)) mods)
in (signature_to_sigtables _99_66)))
...
(let _99_292 = (FStar_All.pipe_left (fun _99_291 -> FStar_Util.Inl (_99_291)) (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_99_292)::[])
end
| Binding_var (x, t) -> begin
(let _99_294 = (FStar_All.pipe_left (fun _99_293 -> FStar_Util.Inr (_99_293)) (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_99_294)::[])
end
...
let debug = (fun env l -> ((let _99_305 = (FStar_ST.read FStar_Options.debug)
in (FStar_All.pipe_right _99_305 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Absyn_Syntax.str = x))))) && (FStar_Options.debug_level_geq l)))

let show = (fun env -> (let _99_309 = (FStar_ST.read FStar_Options.show_signatures)
in (FStar_All.pipe_right _99_309 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Absyn_Syntax.str = x))))))
...
in (let _30_114 = env
in (let _99_319 = (let _99_318 = (let _99_317 = (sigtab env)
in (FStar_Util.smap_copy _99_317))
in (_99_318)::env.sigtab)
in {solver = _30_114.solver; range = _30_114.range; curmodule = _30_114.curmodule; gamma = _30_114.gamma; modules = _30_114.modules; expected_typ = _30_114.expected_typ; level = _30_114.level; sigtab = _99_319; is_pattern = _30_114.is_pattern; instantiate_targs = _30_114.instantiate_targs; instantiate_vargs = _30_114.instantiate_vargs; effects = _30_114.effects; generalize = _30_114.generalize; letrecs = _30_114.letrecs; top_level = _30_114.top_level; check_uvars = _30_114.check_uvars; use_eq = _30_114.use_eq; is_iface = _30_114.is_iface; admit = _30_114.admit; default_effects = _30_114.default_effects}))))

let mark = (fun env -> (let _30_117 = (env.solver.mark "USER MARK")
in (let _30_119 = env
in (let _99_324 = (let _99_323 = (let _99_322 = (sigtab env)
in (FStar_Util.smap_copy _99_322))
in (_99_323)::env.sigtab)
in {solver = _30_119.solver; range = _30_119.range; curmodule = _30_119.curmodule; gamma = _30_119.gamma; modules = _30_119.modules; expected_typ = _30_119.expected_typ; level = _30_119.level; sigtab = _99_324; is_pattern = _30_119.is_pattern; instantiate_targs = _30_119.instantiate_targs; instantiate_vargs = _30_119.instantiate_vargs; effects = _30_119.effects; generalize = _30_119.generalize; letrecs = _30_119.letrecs; top_level = _30_119.top_level; check_uvars = _30_119.check_uvars; use_eq = _30_119.use_eq; is_iface = _30_119.is_iface; admit = _30_119.admit; default_effects = _30_119.default_effects}))))
...
in (let _30_138 = env
in (let _99_329 = (FStar_List.tl env.sigtab)
in {solver = _30_138.solver; range = _30_138.range; curmodule = _30_138.curmodule; gamma = _30_138.gamma; modules = _30_138.modules; expected_typ = _30_138.expected_typ; level = _30_138.level; sigtab = _99_329; is_pattern = _30_138.is_pattern; instantiate_targs = _30_138.instantiate_targs; instantiate_vargs = _30_138.instantiate_vargs; effects = _30_138.effects; generalize = _30_138.generalize; letrecs = _30_138.letrecs; top_level = _30_138.top_level; check_uvars = _30_138.check_uvars; use_eq = _30_138.use_eq; is_iface = _30_138.is_iface; admit = _30_138.admit; default_effects = _30_138.default_effects}))))
...
let variable_not_found = (fun v -> (let _99_348 = (FStar_Absyn_Print.strBvd v)
in (FStar_Util.format1 "Variable \"%s\" not found" _99_348)))

let get_effect_decl = (fun env l -> (match ((effect_decl_opt env l)) with
| None -> begin
(let _99_356 = (let _99_355 = (let _99_354 = (name_not_found l)
in (let _99_353 = (FStar_Absyn_Syntax.range_of_lid l)
in (_99_354, _99_353)))
in FStar_Absyn_Syntax.Error (_99_355))
in (Prims.raise _99_356))
end
| Some (md) -> begin
md
end))
...
| None -> begin
(let _99_412 = (let _99_411 = (let _99_410 = (let _99_409 = (FStar_Absyn_Print.sli l1)
in (let _99_408 = (FStar_Absyn_Print.sli l2)
in (FStar_Util.format2 "Effects %s and %s cannot be composed" _99_409 _99_408)))
in (_99_410, env.range))
in FStar_Absyn_Syntax.Error (_99_411))
in (Prims.raise _99_412))
end
...
| None -> begin
(let _99_427 = (FStar_Util.format1 "Impossible: declaration for monad %s not found" m.FStar_Absyn_Syntax.str)
in (FStar_All.failwith _99_427))
end
| Some (md) -> begin
...
(let compose_edges = (fun e1 e2 -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun r wp1 -> (let _99_448 = (e1.mlift r wp1)
in (e2.mlift r _99_448)))})
in (let mk_lift = (fun lift_t r wp1 -> (let _99_459 = (let _99_458 = (let _99_457 = (FStar_Absyn_Syntax.targ r)
in (let _99_456 = (let _99_455 = (FStar_Absyn_Syntax.targ wp1)
in (_99_455)::[])
in (_99_457)::_99_456))
in (lift_t, _99_458))
in (FStar_Absyn_Syntax.mk_Typ_app _99_459 None wp1.FStar_Absyn_Syntax.pos)))
...
in (let print_mlift = (fun l -> (let arg = (let _99_476 = (FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _99_476 FStar_Absyn_Syntax.mk_Kind_type))
in (let wp = (let _99_477 = (FStar_Absyn_Syntax.lid_of_path (("WP")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _99_477 FStar_Absyn_Syntax.mk_Kind_unknown))
in (let _99_478 = (l arg wp)
in (FStar_Absyn_Print.typ_to_string _99_478)))))
...
| true -> begin
(FStar_All.pipe_right (id_edge i) (fun _99_484 -> Some (_99_484)))
end
| false -> begin
...
in (let order = (FStar_All.pipe_right ms (FStar_List.fold_left (fun order k -> (let _99_492 = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> (match ((FStar_Absyn_Syntax.lid_equals i k)) with
| true -> begin
[]
end
| false -> begin
...
| false -> begin
(match ((let _99_491 = (find_edge order (i, k))
in (let _99_490 = (find_edge order (k, j))
in (_99_491, _99_490)))) with
...
in (FStar_List.append order _99_492))) order))
...
in (let joins = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> (FStar_All.pipe_right ms (FStar_List.collect (fun j -> (let join_opt = (FStar_All.pipe_right ms (FStar_List.fold_left (fun bopt k -> (match ((let _99_500 = (find_edge order (i, k))
in (let _99_499 = (find_edge order (j, k))
in (_99_500, _99_499)))) with
...
(match (((let _99_501 = (find_edge order (k, ub))
in (FStar_Util.is_some _99_501)) && (not ((let _99_502 = (find_edge order (ub, k))
in (FStar_Util.is_some _99_502)))))) with
| true -> begin
Some ((k, ik, jk))
end
| false -> begin
...
in (FStar_List.iter (fun l -> (let _99_510 = (sigtab env)
in (FStar_Util.smap_add _99_510 l.FStar_Absyn_Syntax.str se))) lids))
end))
and add_sigelts = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.iter (add_sigelt env))))

let empty_lid = (let _99_514 = (let _99_513 = (FStar_Absyn_Syntax.id_of_text "")
in (_99_513)::[])
in (FStar_Absyn_Syntax.lid_of_ids _99_514))
...
let find_in_sigtab = (fun env lid -> (let _99_547 = (sigtab env)
in (let _99_546 = (FStar_Absyn_Syntax.text_of_lid lid)
in (FStar_Util.smap_try_find _99_547 _99_546))))
...
| None -> begin
(let _99_559 = (let _99_558 = (let _99_557 = (variable_not_found bv.FStar_Absyn_Syntax.v)
in (_99_557, (FStar_Absyn_Util.range_of_bvd bv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_99_558))
in (Prims.raise _99_559))
end
| Some (t) -> begin
t
end))
...
(FStar_Util.find_map ses (fun se -> (match ((let _99_574 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _99_574 (FStar_Util.for_some (FStar_Absyn_Syntax.lid_equals lid))))) with
| true -> begin
...
(let _99_580 = (FStar_List.map (fun _30_491 -> (match (_30_491) with
| (x, _30_490) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _99_580 t))
end
| _30_493 -> begin
(let _99_584 = (let _99_583 = (let _99_582 = (name_not_found lid)
in (let _99_581 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_99_582, _99_581)))
in FStar_Absyn_Syntax.Error (_99_583))
in (Prims.raise _99_584))
end))
...
| _30_506 -> begin
(let _99_592 = (let _99_591 = (let _99_590 = (name_not_found lid)
in (let _99_589 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_99_590, _99_589)))
in FStar_Absyn_Syntax.Error (_99_591))
in (Prims.raise _99_592))
end))

let lookup_projector = (fun env lid i -> (let fail = (fun _30_511 -> (match (()) with
| () -> begin
(let _99_603 = (let _99_602 = (FStar_Util.string_of_int i)
in (let _99_601 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _99_602 _99_601)))
in (FStar_All.failwith _99_603))
end))
in (let t = (lookup_datacon env lid)
in (match ((let _99_604 = (FStar_Absyn_Util.compress_typ t)
in _99_604.FStar_Absyn_Syntax.n)) with
...
(let _99_605 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _99_605 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _99_606 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _99_606 Prims.fst))
end))
end)
end
| _30_524 -> begin
...
| _30_553 -> begin
(let _99_618 = (let _99_617 = (let _99_616 = (name_not_found lid)
in (let _99_615 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_99_616, _99_615)))
in FStar_Absyn_Syntax.Error (_99_617))
in (Prims.raise _99_618))
end))

let lookup_lid = (fun env lid -> (let not_found = (fun _30_557 -> (match (()) with
| () -> begin
(let _99_628 = (let _99_627 = (let _99_626 = (name_not_found lid)
in (let _99_625 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_99_626, _99_625)))
in FStar_Absyn_Syntax.Error (_99_627))
in (Prims.raise _99_628))
end))
...
(let _99_633 = (let _99_632 = (FStar_List.map (fun _30_580 -> (match (_30_580) with
| (x, _30_579) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _99_632 t))
in Some (_99_633))
end
...
in (match ((let _99_635 = (lookup_qname env lid)
in (FStar_Util.bind_opt _99_635 mapper))) with
| Some (t) -> begin
(let _30_635 = t
in (let _99_636 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _30_635.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _30_635.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _99_636; FStar_Absyn_Syntax.fvs = _30_635.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _30_635.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _99_653 = (FStar_List.map (fun l -> (let _99_652 = (lookup_lid env l)
in (l, _99_652))) datas)
in Some (_99_653))
end
| _30_723 -> begin
...
in (let _99_664 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_99_664)))
end)
end
| _30_762 -> begin
...
| None -> begin
(let _99_676 = (let _99_675 = (let _99_674 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in (_99_674, (FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_99_675))
in (Prims.raise _99_676))
end
| Some (k) -> begin
k
end))
...
| _30_805 -> begin
(let _99_684 = (let _99_683 = (let _99_682 = (name_not_found ftv)
in (let _99_681 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_99_682, _99_681)))
in FStar_Absyn_Syntax.Error (_99_683))
in (Prims.raise _99_684))
end))
...
(let _99_695 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _99_695 (fun _99_694 -> Some (_99_694))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _30_855, _30_857, _30_859))) -> begin
(let _99_697 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _99_697 (fun _99_696 -> Some (_99_696))))
end
| _30_865 -> begin
None
end))
...
| None -> begin
(let _99_705 = (let _99_704 = (let _99_703 = (name_not_found ftv)
in (let _99_702 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_99_703, _99_702)))
in FStar_Absyn_Syntax.Error (_99_704))
in (Prims.raise _99_705))
end
| Some (k) -> begin
k
end))
...
let uvars_in_env = (fun env -> (let no_uvs = (let _99_722 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _99_721 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _99_720 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _99_722; FStar_Absyn_Syntax.uvars_t = _99_721; FStar_Absyn_Syntax.uvars_e = _99_720})))
in (let ext = (fun out uvs -> (let _30_887 = out
in (let _99_729 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _99_728 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _99_727 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _99_729; FStar_Absyn_Syntax.uvars_t = _99_728; FStar_Absyn_Syntax.uvars_e = _99_727})))))
in (let rec aux = (fun out g -> (match (g) with
| [] -> begin
out
end
| (Binding_lid (_, t)::tl) | (Binding_var (_, t)::tl) -> begin
(let _99_735 = (let _99_734 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _99_734))
in (aux _99_735 tl))
end
| Binding_typ (_30_907, k)::tl -> begin
(let _99_737 = (let _99_736 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _99_736))
in (aux _99_737 tl))
end
...
| Binding_var (x, t) -> begin
(let _99_768 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_99_768)::out)
end
| Binding_typ (a, k) -> begin
(let _99_769 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_99_769)::out)
end
| _30_957 -> begin
out
...
| Binding_typ (a, k) -> begin
(let _99_774 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_99_774)::out)
end
| _30_969 -> begin
out
...
let idents = (fun env -> (let _99_778 = (let _99_777 = (binders env)
in (FStar_All.pipe_right _99_777 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _99_778)))

let lidents = (fun env -> (let keys = (FStar_List.fold_left (fun keys _30_13 -> (match (_30_13) with
| Binding_sig (s) -> begin
(let _99_783 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _99_783 keys))
end
| _30_977 -> begin
keys
end)) [] env.gamma)
in (let _99_788 = (sigtab env)
in (FStar_Util.smap_fold _99_788 (fun _30_979 v keys -> (let _99_787 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _99_787 keys))) keys))))
