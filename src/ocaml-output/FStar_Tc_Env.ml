...
in (let _96_577 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_96_578, _96_577)))
...
| _30_498 -> begin
(let _96_588 = (let _96_587 = (let _96_586 = (name_not_found lid)
in (let _96_585 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_96_586, _96_585)))
in FStar_Absyn_Syntax.Error (_96_587))
in (Prims.raise _96_588))
end))

let lookup_projector = (fun env lid i -> (let fail = (fun _30_503 -> (match (()) with
| () -> begin
(let _96_599 = (let _96_598 = (FStar_Util.string_of_int i)
in (let _96_597 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _96_598 _96_597)))
in (FStar_All.failwith _96_599))
end))
in (let t = (lookup_datacon env lid)
in (match ((let _96_600 = (FStar_Absyn_Util.compress_typ t)
in _96_600.FStar_Absyn_Syntax.n)) with
...
(let _96_601 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _96_601 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _96_602 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _96_602 Prims.fst))
end))
end)
end
| _30_516 -> begin
...
in (let _96_611 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_96_612, _96_611)))
...
| () -> begin
(let _96_624 = (let _96_623 = (let _96_622 = (name_not_found lid)
in (let _96_621 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_96_622, _96_621)))
in FStar_Absyn_Syntax.Error (_96_623))
in (Prims.raise _96_624))
end))
...
in (match ((let _96_628 = (lookup_qname env lid)
in (FStar_Util.bind_opt _96_628 mapper))) with
| Some (t) -> begin
(let _30_618 = t
in (let _96_629 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _30_618.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _30_618.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _96_629; FStar_Absyn_Syntax.fvs = _30_618.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _30_618.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _96_646 = (FStar_List.map (fun l -> (let _96_645 = (lookup_lid env l)
in (l, _96_645))) datas)
in Some (_96_646))
end
| _30_706 -> begin
...
in (let _96_657 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_96_657)))
end)
end
| _30_745 -> begin
...
| None -> begin
(let _96_669 = (let _96_668 = (let _96_667 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in (_96_667, (FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_96_668))
in (Prims.raise _96_669))
end
| Some (k) -> begin
k
end))
...
| _30_788 -> begin
(let _96_677 = (let _96_676 = (let _96_675 = (name_not_found ftv)
in (let _96_674 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_96_675, _96_674)))
in FStar_Absyn_Syntax.Error (_96_676))
in (Prims.raise _96_677))
end))
...
(let _96_688 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _96_688 (fun _96_687 -> Some (_96_687))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _30_838, _30_840, _30_842))) -> begin
(let _96_690 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _96_690 (fun _96_689 -> Some (_96_689))))
end
| _30_848 -> begin
None
end))
...
| None -> begin
(let _96_698 = (let _96_697 = (let _96_696 = (name_not_found ftv)
in (let _96_695 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_96_696, _96_695)))
in FStar_Absyn_Syntax.Error (_96_697))
in (Prims.raise _96_698))
end
| Some (k) -> begin
k
end))
...
let uvars_in_env = (fun env -> (let no_uvs = (let _96_715 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _96_714 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _96_713 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _96_715; FStar_Absyn_Syntax.uvars_t = _96_714; FStar_Absyn_Syntax.uvars_e = _96_713})))
in (let ext = (fun out uvs -> (let _30_870 = out
in (let _96_722 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _96_721 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _96_720 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
...
(let _96_728 = (let _96_727 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _96_727))
in (aux _96_728 tl))
end
| Binding_typ (_30_890, k)::tl -> begin
(let _96_730 = (let _96_729 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _96_729))
in (aux _96_730 tl))
end
...
| Binding_var (x, t) -> begin
(let _96_761 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_96_761)::out)
end
| Binding_typ (a, k) -> begin
...
let idents = (fun env -> (let _96_771 = (let _96_770 = (binders env)
in (FStar_All.pipe_right _96_770 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _96_771)))

let lidents = (fun env -> (let keys = (FStar_List.fold_left (fun keys _30_13 -> (match (_30_13) with
| Binding_sig (s) -> begin
(let _96_776 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _96_776 keys))
end
| _30_960 -> begin
keys
end)) [] env.gamma)
in (let _96_781 = (sigtab env)
in (FStar_Util.smap_fold _96_781 (fun _30_962 v keys -> (let _96_780 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _96_780 keys))) keys))))
