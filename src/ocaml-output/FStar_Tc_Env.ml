...
| Some (l) -> begin
(let _97_59 = (FStar_Absyn_Syntax.text_of_lid l)
in Some (_97_59))
end))
...
let modules_to_sigtables = (fun mods -> (let _97_66 = (FStar_List.collect (fun _30_41 -> (match (_30_41) with
| (_30_39, m) -> begin
m.FStar_Absyn_Syntax.declarations
end)) mods)
in (signature_to_sigtables _97_66)))
...
(let _97_292 = (FStar_All.pipe_left (fun _97_291 -> FStar_Util.Inl (_97_291)) (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_97_292)::[])
end
| Binding_var (x, t) -> begin
(let _97_294 = (FStar_All.pipe_left (fun _97_293 -> FStar_Util.Inr (_97_293)) (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_97_294)::[])
end
...
let debug = (fun env l -> ((let _97_305 = (FStar_ST.read FStar_Options.debug)
in (FStar_All.pipe_right _97_305 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Absyn_Syntax.str = x))))) && (FStar_Options.debug_level_geq l)))

let show = (fun env -> (let _97_309 = (FStar_ST.read FStar_Options.show_signatures)
in (FStar_All.pipe_right _97_309 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Absyn_Syntax.str = x))))))
...
in (let _30_114 = env
in (let _97_319 = (let _97_318 = (let _97_317 = (sigtab env)
in (FStar_Util.smap_copy _97_317))
in (_97_318)::env.sigtab)
in {solver = _30_114.solver; range = _30_114.range; curmodule = _30_114.curmodule; gamma = _30_114.gamma; modules = _30_114.modules; expected_typ = _30_114.expected_typ; level = _30_114.level; sigtab = _97_319; is_pattern = _30_114.is_pattern; instantiate_targs = _30_114.instantiate_targs; instantiate_vargs = _30_114.instantiate_vargs; effects = _30_114.effects; generalize = _30_114.generalize; letrecs = _30_114.letrecs; top_level = _30_114.top_level; check_uvars = _30_114.check_uvars; use_eq = _30_114.use_eq; is_iface = _30_114.is_iface; admit = _30_114.admit; default_effects = _30_114.default_effects}))))

let mark = (fun env -> (let _30_117 = (env.solver.mark "USER MARK")
in (let _30_119 = env
in (let _97_324 = (let _97_323 = (let _97_322 = (sigtab env)
in (FStar_Util.smap_copy _97_322))
in (_97_323)::env.sigtab)
in {solver = _30_119.solver; range = _30_119.range; curmodule = _30_119.curmodule; gamma = _30_119.gamma; modules = _30_119.modules; expected_typ = _30_119.expected_typ; level = _30_119.level; sigtab = _97_324; is_pattern = _30_119.is_pattern; instantiate_targs = _30_119.instantiate_targs; instantiate_vargs = _30_119.instantiate_vargs; effects = _30_119.effects; generalize = _30_119.generalize; letrecs = _30_119.letrecs; top_level = _30_119.top_level; check_uvars = _30_119.check_uvars; use_eq = _30_119.use_eq; is_iface = _30_119.is_iface; admit = _30_119.admit; default_effects = _30_119.default_effects}))))
...
in (let _30_138 = env
in (let _97_329 = (FStar_List.tl env.sigtab)
in {solver = _30_138.solver; range = _30_138.range; curmodule = _30_138.curmodule; gamma = _30_138.gamma; modules = _30_138.modules; expected_typ = _30_138.expected_typ; level = _30_138.level; sigtab = _97_329; is_pattern = _30_138.is_pattern; instantiate_targs = _30_138.instantiate_targs; instantiate_vargs = _30_138.instantiate_vargs; effects = _30_138.effects; generalize = _30_138.generalize; letrecs = _30_138.letrecs; top_level = _30_138.top_level; check_uvars = _30_138.check_uvars; use_eq = _30_138.use_eq; is_iface = _30_138.is_iface; admit = _30_138.admit; default_effects = _30_138.default_effects}))))
...
let variable_not_found = (fun v -> (let _97_348 = (FStar_Absyn_Print.strBvd v)
in (FStar_Util.format1 "Variable \"%s\" not found" _97_348)))

let get_effect_decl = (fun env l -> (match ((effect_decl_opt env l)) with
| None -> begin
(let _97_356 = (let _97_355 = (let _97_354 = (name_not_found l)
in (let _97_353 = (FStar_Absyn_Syntax.range_of_lid l)
in (_97_354, _97_353)))
in FStar_Absyn_Syntax.Error (_97_355))
in (Prims.raise _97_356))
end
| Some (md) -> begin
md
end))
...
| None -> begin
(let _97_412 = (let _97_411 = (let _97_410 = (let _97_409 = (FStar_Absyn_Print.sli l1)
in (let _97_408 = (FStar_Absyn_Print.sli l2)
in (FStar_Util.format2 "Effects %s and %s cannot be composed" _97_409 _97_408)))
in (_97_410, env.range))
in FStar_Absyn_Syntax.Error (_97_411))
in (Prims.raise _97_412))
end
...
| None -> begin
(let _97_427 = (FStar_Util.format1 "Impossible: declaration for monad %s not found" m.FStar_Absyn_Syntax.str)
in (FStar_All.failwith _97_427))
end
| Some (md) -> begin
...
(let compose_edges = (fun e1 e2 -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun r wp1 -> (let _97_448 = (e1.mlift r wp1)
in (e2.mlift r _97_448)))})
in (let mk_lift = (fun lift_t r wp1 -> (let _97_459 = (let _97_458 = (let _97_457 = (FStar_Absyn_Syntax.targ r)
in (let _97_456 = (let _97_455 = (FStar_Absyn_Syntax.targ wp1)
in (_97_455)::[])
in (_97_457)::_97_456))
in (lift_t, _97_458))
in (FStar_Absyn_Syntax.mk_Typ_app _97_459 None wp1.FStar_Absyn_Syntax.pos)))
...
in (let print_mlift = (fun l -> (let arg = (let _97_476 = (FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _97_476 FStar_Absyn_Syntax.mk_Kind_type))
in (let wp = (let _97_477 = (FStar_Absyn_Syntax.lid_of_path (("WP")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _97_477 FStar_Absyn_Syntax.mk_Kind_unknown))
in (let _97_478 = (l arg wp)
in (FStar_Absyn_Print.typ_to_string _97_478)))))
...
(FStar_All.pipe_right (id_edge i) (fun _97_484 -> Some (_97_484)))
end else begin
...
in (let order = (FStar_All.pipe_right ms (FStar_List.fold_left (fun order k -> (let _97_492 = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> if (FStar_Absyn_Syntax.lid_equals i k) then begin
[]
end else begin
(FStar_All.pipe_right ms (FStar_List.collect (fun j -> if (FStar_Absyn_Syntax.lid_equals j k) then begin
[]
end else begin
(match ((let _97_491 = (find_edge order (i, k))
in (let _97_490 = (find_edge order (k, j))
in (_97_491, _97_490)))) with
...
in (FStar_List.append order _97_492))) order))
...
in (let joins = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> (FStar_All.pipe_right ms (FStar_List.collect (fun j -> (let join_opt = (FStar_All.pipe_right ms (FStar_List.fold_left (fun bopt k -> (match ((let _97_500 = (find_edge order (i, k))
in (let _97_499 = (find_edge order (j, k))
in (_97_500, _97_499)))) with
...
if ((let _97_501 = (find_edge order (k, ub))
in (FStar_Util.is_some _97_501)) && (not ((let _97_502 = (find_edge order (ub, k))
in (FStar_Util.is_some _97_502))))) then begin
Some ((k, ik, jk))
end else begin
bopt
end
...
in (FStar_List.iter (fun l -> (let _97_510 = (sigtab env)
in (FStar_Util.smap_add _97_510 l.FStar_Absyn_Syntax.str se))) lids))
end))
and add_sigelts = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.iter (add_sigelt env))))

let empty_lid = (let _97_514 = (let _97_513 = (FStar_Absyn_Syntax.id_of_text "")
in (_97_513)::[])
in (FStar_Absyn_Syntax.lid_of_ids _97_514))
...
let find_in_sigtab = (fun env lid -> (let _97_547 = (sigtab env)
in (let _97_546 = (FStar_Absyn_Syntax.text_of_lid lid)
in (FStar_Util.smap_try_find _97_547 _97_546))))
...
| None -> begin
(let _97_559 = (let _97_558 = (let _97_557 = (variable_not_found bv.FStar_Absyn_Syntax.v)
in (_97_557, (FStar_Absyn_Util.range_of_bvd bv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_97_558))
in (Prims.raise _97_559))
end
| Some (t) -> begin
t
end))
...
(FStar_Util.find_map ses (fun se -> if (let _97_574 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _97_574 (FStar_Util.for_some (FStar_Absyn_Syntax.lid_equals lid)))) then begin
...
(let _97_580 = (FStar_List.map (fun _30_491 -> (match (_30_491) with
| (x, _30_490) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _97_580 t))
end
| _30_493 -> begin
(let _97_584 = (let _97_583 = (let _97_582 = (name_not_found lid)
in (let _97_581 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_97_582, _97_581)))
in FStar_Absyn_Syntax.Error (_97_583))
in (Prims.raise _97_584))
end))
...
| _30_506 -> begin
(let _97_592 = (let _97_591 = (let _97_590 = (name_not_found lid)
in (let _97_589 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_97_590, _97_589)))
in FStar_Absyn_Syntax.Error (_97_591))
in (Prims.raise _97_592))
end))

let lookup_projector = (fun env lid i -> (let fail = (fun _30_511 -> (match (()) with
| () -> begin
(let _97_603 = (let _97_602 = (FStar_Util.string_of_int i)
in (let _97_601 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _97_602 _97_601)))
in (FStar_All.failwith _97_603))
end))
in (let t = (lookup_datacon env lid)
in (match ((let _97_604 = (FStar_Absyn_Util.compress_typ t)
in _97_604.FStar_Absyn_Syntax.n)) with
...
(let _97_605 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _97_605 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _97_606 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _97_606 Prims.fst))
end))
end
end
| _30_524 -> begin
...
| _30_553 -> begin
(let _97_618 = (let _97_617 = (let _97_616 = (name_not_found lid)
in (let _97_615 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_97_616, _97_615)))
in FStar_Absyn_Syntax.Error (_97_617))
in (Prims.raise _97_618))
end))

let lookup_lid = (fun env lid -> (let not_found = (fun _30_557 -> (match (()) with
| () -> begin
(let _97_628 = (let _97_627 = (let _97_626 = (name_not_found lid)
in (let _97_625 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_97_626, _97_625)))
in FStar_Absyn_Syntax.Error (_97_627))
in (Prims.raise _97_628))
end))
...
(let _97_633 = (let _97_632 = (FStar_List.map (fun _30_580 -> (match (_30_580) with
| (x, _30_579) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _97_632 t))
in Some (_97_633))
end
...
in (match ((let _97_635 = (lookup_qname env lid)
in (FStar_Util.bind_opt _97_635 mapper))) with
| Some (t) -> begin
(let _30_635 = t
in (let _97_636 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _30_635.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _30_635.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _97_636; FStar_Absyn_Syntax.fvs = _30_635.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _30_635.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _97_653 = (FStar_List.map (fun l -> (let _97_652 = (lookup_lid env l)
in (l, _97_652))) datas)
in Some (_97_653))
end
| _30_723 -> begin
...
in (let _97_664 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_97_664)))
end
end
| _30_762 -> begin
...
(let t = (FStar_Absyn_Util.close_with_lam tps t)
in (let _97_669 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_97_669)))
end
| _30_779 -> begin
None
...
| None -> begin
(let _97_681 = (let _97_680 = (let _97_679 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in (_97_679, (FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_97_680))
in (Prims.raise _97_681))
end
| Some (k) -> begin
k
end))
...
| _30_822 -> begin
(let _97_689 = (let _97_688 = (let _97_687 = (name_not_found ftv)
in (let _97_686 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_97_687, _97_686)))
in FStar_Absyn_Syntax.Error (_97_688))
in (Prims.raise _97_689))
end))
...
(let _97_700 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _97_700 (fun _97_699 -> Some (_97_699))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _30_872, _30_874, _30_876))) -> begin
(let _97_702 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _97_702 (fun _97_701 -> Some (_97_701))))
end
| _30_882 -> begin
None
end))
...
| None -> begin
(let _97_710 = (let _97_709 = (let _97_708 = (name_not_found ftv)
in (let _97_707 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_97_708, _97_707)))
in FStar_Absyn_Syntax.Error (_97_709))
in (Prims.raise _97_710))
end
| Some (k) -> begin
k
end))
...
let uvars_in_env = (fun env -> (let no_uvs = (let _97_727 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _97_726 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _97_725 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _97_727; FStar_Absyn_Syntax.uvars_t = _97_726; FStar_Absyn_Syntax.uvars_e = _97_725})))
in (let ext = (fun out uvs -> (let _30_904 = out
in (let _97_734 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _97_733 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _97_732 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _97_734; FStar_Absyn_Syntax.uvars_t = _97_733; FStar_Absyn_Syntax.uvars_e = _97_732})))))
in (let rec aux = (fun out g -> (match (g) with
| [] -> begin
out
end
| (Binding_lid (_, t)::tl) | (Binding_var (_, t)::tl) -> begin
(let _97_740 = (let _97_739 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _97_739))
in (aux _97_740 tl))
end
| Binding_typ (_30_924, k)::tl -> begin
(let _97_742 = (let _97_741 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _97_741))
in (aux _97_742 tl))
end
...
| Binding_var (x, t) -> begin
(let _97_773 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_97_773)::out)
end
| Binding_typ (a, k) -> begin
(let _97_774 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_97_774)::out)
end
| _30_974 -> begin
out
...
| Binding_typ (a, k) -> begin
(let _97_779 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_97_779)::out)
end
| _30_986 -> begin
out
...
let idents = (fun env -> (let _97_783 = (let _97_782 = (binders env)
in (FStar_All.pipe_right _97_782 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _97_783)))

let lidents = (fun env -> (let keys = (FStar_List.fold_left (fun keys _30_13 -> (match (_30_13) with
| Binding_sig (s) -> begin
(let _97_788 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _97_788 keys))
end
| _30_994 -> begin
keys
end)) [] env.gamma)
in (let _97_793 = (sigtab env)
in (FStar_Util.smap_fold _97_793 (fun _30_996 v keys -> (let _97_792 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _97_792 keys))) keys))))
