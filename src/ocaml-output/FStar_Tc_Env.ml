...
let modules_to_sigtables = (fun mods -> (let _140_65 = (FStar_List.collect (fun _42_41 -> (match (_42_41) with
| (_42_39, m) -> begin
m.FStar_Absyn_Syntax.declarations
end)) mods)
in (signature_to_sigtables _140_65)))
...
(let _140_291 = (FStar_All.pipe_left (fun _140_290 -> FStar_Util.Inl (_140_290)) (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_140_291)::[])
end
| Binding_var (x, t) -> begin
(let _140_293 = (FStar_All.pipe_left (fun _140_292 -> FStar_Util.Inr (_140_292)) (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_140_293)::[])
end
...
let _42_117 = env
in (let _140_317 = (let _140_316 = (let _140_315 = (sigtab env)
in (FStar_Util.smap_copy _140_315))
in (_140_316)::env.sigtab)
in {solver = _42_117.solver; range = _42_117.range; curmodule = _42_117.curmodule; gamma = _42_117.gamma; modules = _42_117.modules; expected_typ = _42_117.expected_typ; level = _42_117.level; sigtab = _140_317; is_pattern = _42_117.is_pattern; instantiate_targs = _42_117.instantiate_targs; instantiate_vargs = _42_117.instantiate_vargs; effects = _42_117.effects; generalize = _42_117.generalize; letrecs = _42_117.letrecs; top_level = _42_117.top_level; check_uvars = _42_117.check_uvars; use_eq = _42_117.use_eq; is_iface = _42_117.is_iface; admit = _42_117.admit; default_effects = _42_117.default_effects}))))
...
let initial_env : solver_t  ->  FStar_Ident.lident  ->  env = (fun solver module_lid -> (let _140_332 = (let _140_331 = (new_sigtab ())
in (_140_331)::[])
in {solver = solver; range = FStar_Absyn_Syntax.dummyRange; curmodule = module_lid; gamma = []; modules = []; expected_typ = None; level = Expr; sigtab = _140_332; is_pattern = false; instantiate_targs = true; instantiate_vargs = true; effects = {decls = []; order = []; joins = []}; generalize = true; letrecs = []; top_level = true; check_uvars = false; use_eq = false; is_iface = false; admit = false; default_effects = []}))
...
let variable_not_found = (fun v -> (let _140_341 = (FStar_Absyn_Print.strBvd v)
in (FStar_Util.format1 "Variable \"%s\" not found" _140_341)))


let get_effect_decl : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.eff_decl = (fun env l -> (match ((effect_decl_opt env l)) with
| None -> begin
(let _140_348 = (let _140_347 = (let _140_346 = (name_not_found l)
in ((_140_346), ((FStar_Ident.range_of_lid l))))
in FStar_Absyn_Syntax.Error (_140_347))
in (Prims.raise _140_348))
end
| Some (md) -> begin
md
end))
...
| None -> begin
(let _140_404 = (let _140_403 = (let _140_402 = (let _140_401 = (FStar_Absyn_Print.sli l1)
in (let _140_400 = (FStar_Absyn_Print.sli l2)
in (FStar_Util.format2 "Effects %s and %s cannot be composed" _140_401 _140_400)))
in ((_140_402), (env.range)))
in FStar_Absyn_Syntax.Error (_140_403))
in (Prims.raise _140_404))
end
...
| None -> begin
(let _140_419 = (FStar_Util.format1 "Impossible: declaration for monad %s not found" m.FStar_Ident.str)
in (FStar_All.failwith _140_419))
end
| Some (md) -> begin
...
let compose_edges = (fun e1 e2 -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun r wp1 -> (let _140_440 = (e1.mlift r wp1)
in (e2.mlift r _140_440)))})
in (

let mk_lift = (fun lift_t r wp1 -> (let _140_451 = (let _140_450 = (let _140_449 = (FStar_Absyn_Syntax.targ r)
in (let _140_448 = (let _140_447 = (FStar_Absyn_Syntax.targ wp1)
in (_140_447)::[])
in (_140_449)::_140_448))
in ((lift_t), (_140_450)))
in (FStar_Absyn_Syntax.mk_Typ_app _140_451 None wp1.FStar_Absyn_Syntax.pos)))
in (
...
let arg = (let _140_468 = (FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _140_468 FStar_Absyn_Syntax.mk_Kind_type))
in (

let wp = (let _140_469 = (FStar_Absyn_Syntax.lid_of_path (("WP")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _140_469 FStar_Absyn_Syntax.mk_Kind_unknown))
in (let _140_470 = (l arg wp)
in (FStar_Absyn_Print.typ_to_string _140_470)))))
in (
...
(FStar_All.pipe_right (id_edge i) (fun _140_476 -> Some (_140_476)))
end else begin
...
let order = (FStar_All.pipe_right ms (FStar_List.fold_left (fun order k -> (let _140_484 = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> if (FStar_Ident.lid_equals i k) then begin
[]
end else begin
(FStar_All.pipe_right ms (FStar_List.collect (fun j -> if (FStar_Ident.lid_equals j k) then begin
[]
end else begin
(match ((let _140_483 = (find_edge order ((i), (k)))
in (let _140_482 = (find_edge order ((k), (j)))
in ((_140_483), (_140_482))))) with
...
in (FStar_List.append order _140_484))) order))
in (
...
let join_opt = (FStar_All.pipe_right ms (FStar_List.fold_left (fun bopt k -> (match ((let _140_492 = (find_edge order ((i), (k)))
in (let _140_491 = (find_edge order ((j), (k)))
in ((_140_492), (_140_491))))) with
...
if ((let _140_493 = (find_edge order ((k), (ub)))
in (FStar_Util.is_some _140_493)) && (not ((let _140_494 = (find_edge order ((ub), (k)))
in (FStar_Util.is_some _140_494))))) then begin
Some (((k), (ik), (jk)))
end else begin
bopt
end
...
let lids = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_List.iter (fun l -> (let _140_502 = (sigtab env)
in (FStar_Util.smap_add _140_502 l.FStar_Ident.str se))) lids))
end))
...
let empty_lid : FStar_Absyn_Syntax.lident = (let _140_506 = (let _140_505 = (FStar_Absyn_Syntax.id_of_text "")
in (_140_505)::[])
in (FStar_Absyn_Syntax.lid_of_ids _140_506))
...
let find_in_sigtab : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.sigelt Prims.option = (fun env lid -> (let _140_538 = (sigtab env)
in (FStar_Util.smap_try_find _140_538 (FStar_Ident.text_of_lid lid))))
...
| None -> begin
(let _140_550 = (let _140_549 = (let _140_548 = (variable_not_found bv.FStar_Absyn_Syntax.v)
in ((_140_548), ((FStar_Absyn_Util.range_of_bvd bv.FStar_Absyn_Syntax.v))))
in FStar_Absyn_Syntax.Error (_140_549))
in (Prims.raise _140_550))
end
| Some (t) -> begin
t
end))
...
(FStar_Util.find_map ses (fun se -> if (let _140_565 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _140_565 (FStar_Util.for_some (FStar_Ident.lid_equals lid)))) then begin
...
(let _140_571 = (FStar_List.map (fun _42_489 -> (match (_42_489) with
| (x, _42_488) -> begin
((x), (Some (FStar_Absyn_Syntax.Implicit (true))))
end)) tps)
in (FStar_Absyn_Util.close_typ _140_571 t))
end
| _42_491 -> begin
(let _140_574 = (let _140_573 = (let _140_572 = (name_not_found lid)
in ((_140_572), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_140_573))
in (Prims.raise _140_574))
end))
...
| _42_504 -> begin
(let _140_581 = (let _140_580 = (let _140_579 = (name_not_found lid)
in ((_140_579), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_140_580))
in (Prims.raise _140_581))
end))
...
| () -> begin
(let _140_592 = (let _140_591 = (FStar_Util.string_of_int i)
in (let _140_590 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _140_591 _140_590)))
in (FStar_All.failwith _140_592))
end))
in (

let t = (lookup_datacon env lid)
in (match ((let _140_593 = (FStar_Absyn_Util.compress_typ t)
in _140_593.FStar_Absyn_Syntax.n)) with
...
(let _140_594 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _140_594 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _140_595 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _140_595 Prims.fst))
end))
end
end
| _42_522 -> begin
...
| _42_551 -> begin
(let _140_606 = (let _140_605 = (let _140_604 = (name_not_found lid)
in ((_140_604), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_140_605))
in (Prims.raise _140_606))
end))
...
| () -> begin
(let _140_615 = (let _140_614 = (let _140_613 = (name_not_found lid)
in ((_140_613), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_140_614))
in (Prims.raise _140_615))
end))
in (
...
(let _140_620 = (let _140_619 = (FStar_List.map (fun _42_578 -> (match (_42_578) with
| (x, _42_577) -> begin
((x), (Some (FStar_Absyn_Syntax.Implicit (true))))
end)) tps)
in (FStar_Absyn_Util.close_typ _140_619 t))
in Some (_140_620))
end
...
in (match ((let _140_622 = (lookup_qname env lid)
in (FStar_Util.bind_opt _140_622 mapper))) with
| Some (t) -> begin
(

let _42_633 = t
in (let _140_623 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _42_633.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _42_633.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _140_623; FStar_Absyn_Syntax.fvs = _42_633.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _42_633.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _140_640 = (FStar_List.map (fun l -> (let _140_639 = (lookup_lid env l)
in ((l), (_140_639)))) datas)
in Some (_140_640))
end
| _42_721 -> begin
...
in (let _140_651 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named (((t), (lid)))))
in Some (_140_651)))
end
end
| _42_760 -> begin
...
let t = (FStar_Absyn_Util.close_with_lam tps t)
in (let _140_656 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named (((t), (lid)))))
in Some (_140_656)))
end
| _42_777 -> begin
None
...
| None -> begin
(let _140_668 = (let _140_667 = (let _140_666 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in ((_140_666), ((FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v))))
in FStar_Absyn_Syntax.Error (_140_667))
in (Prims.raise _140_668))
end
| Some (k) -> begin
k
end))
...
| _42_820 -> begin
(let _140_675 = (let _140_674 = (let _140_673 = (name_not_found ftv)
in ((_140_673), ((FStar_Ident.range_of_lid ftv))))
in FStar_Absyn_Syntax.Error (_140_674))
in (Prims.raise _140_675))
end))
...
(let _140_686 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _140_686 (fun _140_685 -> Some (_140_685))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _42_870, _42_872, _42_874))) -> begin
(let _140_688 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _140_688 (fun _140_687 -> Some (_140_687))))
end
| _42_880 -> begin
None
end))
...
| None -> begin
(let _140_695 = (let _140_694 = (let _140_693 = (name_not_found ftv)
in ((_140_693), ((FStar_Ident.range_of_lid ftv))))
in FStar_Absyn_Syntax.Error (_140_694))
in (Prims.raise _140_695))
end
| Some (k) -> begin
k
end))
...
let no_uvs = (let _140_712 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _140_711 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _140_710 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _140_712; FStar_Absyn_Syntax.uvars_t = _140_711; FStar_Absyn_Syntax.uvars_e = _140_710})))
in (

let ext = (fun out uvs -> (

let _42_902 = out
in (let _140_719 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _140_718 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _140_717 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _140_719; FStar_Absyn_Syntax.uvars_t = _140_718; FStar_Absyn_Syntax.uvars_e = _140_717})))))
in (
...
(let _140_725 = (let _140_724 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _140_724))
in (aux _140_725 tl))
end
| (Binding_typ (_42_922, k))::tl -> begin
(let _140_727 = (let _140_726 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _140_726))
in (aux _140_727 tl))
end
...
(let _140_737 = (let _140_736 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Setting expected type to %s with kind unknown" _140_736))
in (FStar_All.failwith _140_737))
end
| _42_967 -> begin
(
...
| Binding_var (x, t) -> begin
(let _140_760 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_140_760)::out)
end
| Binding_typ (a, k) -> begin
(let _140_761 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_140_761)::out)
end
| _42_999 -> begin
out
...
| Binding_typ (a, k) -> begin
(let _140_766 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_140_766)::out)
end
| _42_1011 -> begin
out
...
let idents : env  ->  FStar_Absyn_Syntax.freevars = (fun env -> (let _140_770 = (let _140_769 = (binders env)
in (FStar_All.pipe_right _140_769 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _140_770)))
...
| Binding_sig (s) -> begin
(let _140_775 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _140_775 keys))
end
| _42_1019 -> begin
keys
end)) [] env.gamma)
in (let _140_780 = (sigtab env)
in (FStar_Util.smap_fold _140_780 (fun _42_1021 v keys -> (let _140_779 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _140_779 keys))) keys))))
