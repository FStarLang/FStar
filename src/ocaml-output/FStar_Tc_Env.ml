...
let modules_to_sigtables = (fun mods -> (let _135_65 = (FStar_List.collect (fun _40_41 -> (match (_40_41) with
| (_40_39, m) -> begin
m.FStar_Absyn_Syntax.declarations
end)) mods)
in (signature_to_sigtables _135_65)))
...
(let _135_291 = (FStar_All.pipe_left (fun _135_290 -> FStar_Util.Inl (_135_290)) (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_135_291)::[])
end
| Binding_var (x, t) -> begin
(let _135_293 = (FStar_All.pipe_left (fun _135_292 -> FStar_Util.Inr (_135_292)) (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_135_293)::[])
end
...
let _40_136 = env
in (let _135_322 = (FStar_List.tl env.sigtab)
in {solver = _40_136.solver; range = _40_136.range; curmodule = _40_136.curmodule; gamma = _40_136.gamma; modules = _40_136.modules; expected_typ = _40_136.expected_typ; level = _40_136.level; sigtab = _135_322; is_pattern = _40_136.is_pattern; instantiate_targs = _40_136.instantiate_targs; instantiate_vargs = _40_136.instantiate_vargs; effects = _40_136.effects; generalize = _40_136.generalize; letrecs = _40_136.letrecs; top_level = _40_136.top_level; check_uvars = _40_136.check_uvars; use_eq = _40_136.use_eq; is_iface = _40_136.is_iface; admit = _40_136.admit; default_effects = _40_136.default_effects}))))
...
let initial_env : solver_t  ->  FStar_Ident.lident  ->  env = (fun solver module_lid -> (let _135_332 = (let _135_331 = (new_sigtab ())
in (_135_331)::[])
in {solver = solver; range = FStar_Absyn_Syntax.dummyRange; curmodule = module_lid; gamma = []; modules = []; expected_typ = None; level = Expr; sigtab = _135_332; is_pattern = false; instantiate_targs = true; instantiate_vargs = true; effects = {decls = []; order = []; joins = []}; generalize = true; letrecs = []; top_level = true; check_uvars = false; use_eq = false; is_iface = false; admit = false; default_effects = []}))
...
let variable_not_found = (fun v -> (let _135_341 = (FStar_Absyn_Print.strBvd v)
in (FStar_Util.format1 "Variable \"%s\" not found" _135_341)))


let get_effect_decl : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.eff_decl = (fun env l -> (match ((effect_decl_opt env l)) with
| None -> begin
(let _135_348 = (let _135_347 = (let _135_346 = (name_not_found l)
in ((_135_346), ((FStar_Ident.range_of_lid l))))
in FStar_Absyn_Syntax.Error (_135_347))
in (Prims.raise _135_348))
end
| Some (md) -> begin
md
end))
...
| None -> begin
(let _135_404 = (let _135_403 = (let _135_402 = (let _135_401 = (FStar_Absyn_Print.sli l1)
in (let _135_400 = (FStar_Absyn_Print.sli l2)
in (FStar_Util.format2 "Effects %s and %s cannot be composed" _135_401 _135_400)))
in ((_135_402), (env.range)))
in FStar_Absyn_Syntax.Error (_135_403))
in (Prims.raise _135_404))
end
...
| None -> begin
(let _135_419 = (FStar_Util.format1 "Impossible: declaration for monad %s not found" m.FStar_Ident.str)
in (FStar_All.failwith _135_419))
end
| Some (md) -> begin
...
let compose_edges = (fun e1 e2 -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun r wp1 -> (let _135_440 = (e1.mlift r wp1)
in (e2.mlift r _135_440)))})
in (

let mk_lift = (fun lift_t r wp1 -> (let _135_451 = (let _135_450 = (let _135_449 = (FStar_Absyn_Syntax.targ r)
in (let _135_448 = (let _135_447 = (FStar_Absyn_Syntax.targ wp1)
in (_135_447)::[])
in (_135_449)::_135_448))
in ((lift_t), (_135_450)))
in (FStar_Absyn_Syntax.mk_Typ_app _135_451 None wp1.FStar_Absyn_Syntax.pos)))
in (
...
let arg = (let _135_468 = (FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _135_468 FStar_Absyn_Syntax.mk_Kind_type))
in (

let wp = (let _135_469 = (FStar_Absyn_Syntax.lid_of_path (("WP")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _135_469 FStar_Absyn_Syntax.mk_Kind_unknown))
in (let _135_470 = (l arg wp)
in (FStar_Absyn_Print.typ_to_string _135_470)))))
in (
...
(FStar_All.pipe_right (id_edge i) (fun _135_476 -> Some (_135_476)))
end else begin
...
let order = (FStar_All.pipe_right ms (FStar_List.fold_left (fun order k -> (let _135_484 = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> if (FStar_Ident.lid_equals i k) then begin
[]
end else begin
(FStar_All.pipe_right ms (FStar_List.collect (fun j -> if (FStar_Ident.lid_equals j k) then begin
[]
end else begin
(match ((let _135_483 = (find_edge order ((i), (k)))
in (let _135_482 = (find_edge order ((k), (j)))
in ((_135_483), (_135_482))))) with
...
in (FStar_List.append order _135_484))) order))
in (
...
let join_opt = (FStar_All.pipe_right ms (FStar_List.fold_left (fun bopt k -> (match ((let _135_492 = (find_edge order ((i), (k)))
in (let _135_491 = (find_edge order ((j), (k)))
in ((_135_492), (_135_491))))) with
...
if ((let _135_493 = (find_edge order ((k), (ub)))
in (FStar_Util.is_some _135_493)) && (not ((let _135_494 = (find_edge order ((ub), (k)))
in (FStar_Util.is_some _135_494))))) then begin
Some (((k), (ik), (jk)))
end else begin
bopt
end
...
let lids = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_List.iter (fun l -> (let _135_502 = (sigtab env)
in (FStar_Util.smap_add _135_502 l.FStar_Ident.str se))) lids))
end))
...
let empty_lid : FStar_Absyn_Syntax.lident = (let _135_506 = (let _135_505 = (FStar_Absyn_Syntax.id_of_text "")
in (_135_505)::[])
in (FStar_Absyn_Syntax.lid_of_ids _135_506))
...
let find_in_sigtab : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.sigelt Prims.option = (fun env lid -> (let _135_538 = (sigtab env)
in (FStar_Util.smap_try_find _135_538 (FStar_Ident.text_of_lid lid))))
...
| None -> begin
(let _135_550 = (let _135_549 = (let _135_548 = (variable_not_found bv.FStar_Absyn_Syntax.v)
in ((_135_548), ((FStar_Absyn_Util.range_of_bvd bv.FStar_Absyn_Syntax.v))))
in FStar_Absyn_Syntax.Error (_135_549))
in (Prims.raise _135_550))
end
| Some (t) -> begin
t
end))
...
(FStar_Util.find_map ses (fun se -> if (let _135_565 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _135_565 (FStar_Util.for_some (FStar_Ident.lid_equals lid)))) then begin
...
(let _135_571 = (FStar_List.map (fun _40_489 -> (match (_40_489) with
| (x, _40_488) -> begin
((x), (Some (FStar_Absyn_Syntax.Implicit (true))))
end)) tps)
in (FStar_Absyn_Util.close_typ _135_571 t))
end
| _40_491 -> begin
(let _135_574 = (let _135_573 = (let _135_572 = (name_not_found lid)
in ((_135_572), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_135_573))
in (Prims.raise _135_574))
end))
...
| _40_504 -> begin
(let _135_581 = (let _135_580 = (let _135_579 = (name_not_found lid)
in ((_135_579), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_135_580))
in (Prims.raise _135_581))
end))
...
| () -> begin
(let _135_592 = (let _135_591 = (FStar_Util.string_of_int i)
in (let _135_590 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _135_591 _135_590)))
in (FStar_All.failwith _135_592))
end))
in (

let t = (lookup_datacon env lid)
in (match ((let _135_593 = (FStar_Absyn_Util.compress_typ t)
in _135_593.FStar_Absyn_Syntax.n)) with
...
(let _135_594 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _135_594 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _135_595 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _135_595 Prims.fst))
end))
end
end
| _40_522 -> begin
...
| _40_551 -> begin
(let _135_606 = (let _135_605 = (let _135_604 = (name_not_found lid)
in ((_135_604), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_135_605))
in (Prims.raise _135_606))
end))
...
| () -> begin
(let _135_615 = (let _135_614 = (let _135_613 = (name_not_found lid)
in ((_135_613), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_135_614))
in (Prims.raise _135_615))
end))
in (
...
(let _135_620 = (let _135_619 = (FStar_List.map (fun _40_578 -> (match (_40_578) with
| (x, _40_577) -> begin
((x), (Some (FStar_Absyn_Syntax.Implicit (true))))
end)) tps)
in (FStar_Absyn_Util.close_typ _135_619 t))
in Some (_135_620))
end
...
in (match ((let _135_622 = (lookup_qname env lid)
in (FStar_Util.bind_opt _135_622 mapper))) with
| Some (t) -> begin
(

let _40_633 = t
in (let _135_623 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _40_633.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _40_633.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _135_623; FStar_Absyn_Syntax.fvs = _40_633.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _40_633.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _135_640 = (FStar_List.map (fun l -> (let _135_639 = (lookup_lid env l)
in ((l), (_135_639)))) datas)
in Some (_135_640))
end
| _40_721 -> begin
...
in (let _135_651 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named (((t), (lid)))))
in Some (_135_651)))
end
end
| _40_760 -> begin
...
let t = (FStar_Absyn_Util.close_with_lam tps t)
in (let _135_656 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named (((t), (lid)))))
in Some (_135_656)))
end
| _40_777 -> begin
None
...
| None -> begin
(let _135_668 = (let _135_667 = (let _135_666 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in ((_135_666), ((FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v))))
in FStar_Absyn_Syntax.Error (_135_667))
in (Prims.raise _135_668))
end
| Some (k) -> begin
k
end))
...
| _40_820 -> begin
(let _135_675 = (let _135_674 = (let _135_673 = (name_not_found ftv)
in ((_135_673), ((FStar_Ident.range_of_lid ftv))))
in FStar_Absyn_Syntax.Error (_135_674))
in (Prims.raise _135_675))
end))
...
(let _135_686 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _135_686 (fun _135_685 -> Some (_135_685))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _40_870, _40_872, _40_874))) -> begin
(let _135_688 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _135_688 (fun _135_687 -> Some (_135_687))))
end
| _40_880 -> begin
None
end))
...
| None -> begin
(let _135_695 = (let _135_694 = (let _135_693 = (name_not_found ftv)
in ((_135_693), ((FStar_Ident.range_of_lid ftv))))
in FStar_Absyn_Syntax.Error (_135_694))
in (Prims.raise _135_695))
end
| Some (k) -> begin
k
end))
...
let no_uvs = (let _135_712 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _135_711 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _135_710 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _135_712; FStar_Absyn_Syntax.uvars_t = _135_711; FStar_Absyn_Syntax.uvars_e = _135_710})))
in (

let ext = (fun out uvs -> (

let _40_902 = out
in (let _135_719 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _135_718 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _135_717 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _135_719; FStar_Absyn_Syntax.uvars_t = _135_718; FStar_Absyn_Syntax.uvars_e = _135_717})))))
in (
...
(let _135_725 = (let _135_724 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _135_724))
in (aux _135_725 tl))
end
| (Binding_typ (_40_922, k))::tl -> begin
(let _135_727 = (let _135_726 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _135_726))
in (aux _135_727 tl))
end
...
(let _135_737 = (let _135_736 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Setting expected type to %s with kind unknown" _135_736))
in (FStar_All.failwith _135_737))
end
| _40_967 -> begin
(
...
| Binding_var (x, t) -> begin
(let _135_760 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_135_760)::out)
end
| Binding_typ (a, k) -> begin
(let _135_761 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_135_761)::out)
end
| _40_999 -> begin
out
...
| Binding_typ (a, k) -> begin
(let _135_766 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_135_766)::out)
end
| _40_1011 -> begin
out
...
let idents : env  ->  FStar_Absyn_Syntax.freevars = (fun env -> (let _135_770 = (let _135_769 = (binders env)
in (FStar_All.pipe_right _135_769 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _135_770)))
...
| Binding_sig (s) -> begin
(let _135_775 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _135_775 keys))
end
| _40_1019 -> begin
keys
end)) [] env.gamma)
in (let _135_780 = (sigtab env)
in (FStar_Util.smap_fold _135_780 (fun _40_1021 v keys -> (let _135_779 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _135_779 keys))) keys))))
