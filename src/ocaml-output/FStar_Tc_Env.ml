...
(let _95_578 = (FStar_List.map (fun _30_491 -> (match (_30_491) with
| (x, _30_490) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _95_578 t))
end
| _30_493 -> begin
(let _95_582 = (let _95_581 = (let _95_580 = (name_not_found lid)
in (let _95_579 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_95_580, _95_579)))
in FStar_Absyn_Syntax.Error (_95_581))
in (Prims.raise _95_582))
end))
...
| _30_506 -> begin
(let _95_590 = (let _95_589 = (let _95_588 = (name_not_found lid)
in (let _95_587 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_95_588, _95_587)))
in FStar_Absyn_Syntax.Error (_95_589))
in (Prims.raise _95_590))
end))

let lookup_projector = (fun env lid i -> (let fail = (fun _30_511 -> (match (()) with
| () -> begin
(let _95_601 = (let _95_600 = (FStar_Util.string_of_int i)
in (let _95_599 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _95_600 _95_599)))
in (FStar_All.failwith _95_601))
end))
in (let t = (lookup_datacon env lid)
in (match ((let _95_602 = (FStar_Absyn_Util.compress_typ t)
in _95_602.FStar_Absyn_Syntax.n)) with
...
(let _95_603 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _95_603 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _95_604 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _95_604 Prims.fst))
end))
end)
end
| _30_524 -> begin
...
| _30_553 -> begin
(let _95_616 = (let _95_615 = (let _95_614 = (name_not_found lid)
in (let _95_613 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_95_614, _95_613)))
in FStar_Absyn_Syntax.Error (_95_615))
in (Prims.raise _95_616))
end))

let lookup_lid = (fun env lid -> (let not_found = (fun _30_557 -> (match (()) with
| () -> begin
(let _95_626 = (let _95_625 = (let _95_624 = (name_not_found lid)
in (let _95_623 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_95_624, _95_623)))
in FStar_Absyn_Syntax.Error (_95_625))
in (Prims.raise _95_626))
end))
...
(let _95_631 = (let _95_630 = (FStar_List.map (fun _30_580 -> (match (_30_580) with
| (x, _30_579) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit))
end)) tps)
in (FStar_Absyn_Util.close_typ _95_630 t))
in Some (_95_631))
end
...
in (match ((let _95_633 = (lookup_qname env lid)
in (FStar_Util.bind_opt _95_633 mapper))) with
| Some (t) -> begin
(let _30_635 = t
in (let _95_634 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _30_635.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _30_635.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _95_634; FStar_Absyn_Syntax.fvs = _30_635.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _30_635.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _95_651 = (FStar_List.map (fun l -> (let _95_650 = (lookup_lid env l)
in (l, _95_650))) datas)
in Some (_95_651))
end
| _30_723 -> begin
...
in (let _95_662 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_95_662)))
end)
end
| _30_762 -> begin
...
| None -> begin
(let _95_674 = (let _95_673 = (let _95_672 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in (_95_672, (FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_95_673))
in (Prims.raise _95_674))
end
| Some (k) -> begin
k
end))
...
| _30_805 -> begin
(let _95_682 = (let _95_681 = (let _95_680 = (name_not_found ftv)
in (let _95_679 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_95_680, _95_679)))
in FStar_Absyn_Syntax.Error (_95_681))
in (Prims.raise _95_682))
end))
...
(let _95_693 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _95_693 (fun _95_692 -> Some (_95_692))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _30_855, _30_857, _30_859))) -> begin
(let _95_695 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _95_695 (fun _95_694 -> Some (_95_694))))
end
| _30_865 -> begin
None
end))
...
| None -> begin
(let _95_703 = (let _95_702 = (let _95_701 = (name_not_found ftv)
in (let _95_700 = (FStar_Absyn_Syntax.range_of_lid ftv)
in (_95_701, _95_700)))
in FStar_Absyn_Syntax.Error (_95_702))
in (Prims.raise _95_703))
end
| Some (k) -> begin
k
end))
...
let uvars_in_env = (fun env -> (let no_uvs = (let _95_720 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _95_719 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _95_718 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _95_720; FStar_Absyn_Syntax.uvars_t = _95_719; FStar_Absyn_Syntax.uvars_e = _95_718})))
in (let ext = (fun out uvs -> (let _30_887 = out
in (let _95_727 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _95_726 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _95_725 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
...
(let _95_733 = (let _95_732 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _95_732))
in (aux _95_733 tl))
end
| Binding_typ (_30_907, k)::tl -> begin
(let _95_735 = (let _95_734 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _95_734))
in (aux _95_735 tl))
end
...
| Binding_var (x, t) -> begin
(let _95_766 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_95_766)::out)
end
| Binding_typ (a, k) -> begin
...
| Binding_typ (a, k) -> begin
(let _95_772 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_95_772)::out)
end
| _30_969 -> begin
out
...
let idents = (fun env -> (let _95_776 = (let _95_775 = (binders env)
in (FStar_All.pipe_right _95_775 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _95_776)))

let lidents = (fun env -> (let keys = (FStar_List.fold_left (fun keys _30_13 -> (match (_30_13) with
| Binding_sig (s) -> begin
(let _95_781 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _95_781 keys))
end
| _30_977 -> begin
keys
end)) [] env.gamma)
in (let _95_786 = (sigtab env)
in (FStar_Util.smap_fold _95_786 (fun _30_979 v keys -> (let _95_785 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _95_785 keys))) keys))))
