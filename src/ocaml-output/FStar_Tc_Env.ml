...
# 46 "FStar.Tc.Env.fst"
let modules_to_sigtables = (fun mods -> (let _118_65 = (FStar_List.collect (fun _36_41 -> (match (_36_41) with
| (_36_39, m) -> begin
m.FStar_Absyn_Syntax.declarations
end)) mods)
in (signature_to_sigtables _118_65)))
...
(let _118_291 = (FStar_All.pipe_left (fun _118_290 -> FStar_Util.Inl (_118_290)) (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_118_291)::[])
end
| Binding_var (x, t) -> begin
(let _118_293 = (FStar_All.pipe_left (fun _118_292 -> FStar_Util.Inr (_118_292)) (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_118_293)::[])
end
...
let debug : env  ->  FStar_Options.debug_level_t  ->  Prims.bool = (fun env l -> ((let _118_304 = (FStar_ST.read FStar_Options.debug)
in (FStar_All.pipe_right _118_304 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Ident.str = x))))) && (FStar_Options.debug_level_geq l)))

# 173 "FStar.Tc.Env.fst"
let show : env  ->  Prims.bool = (fun env -> (let _118_308 = (FStar_ST.read FStar_Options.show_signatures)
in (FStar_All.pipe_right _118_308 (FStar_Util.for_some (fun x -> (env.curmodule.FStar_Ident.str = x))))))
...
let _36_115 = env
in (let _118_318 = (let _118_317 = (let _118_316 = (sigtab env)
in (FStar_Util.smap_copy _118_316))
in (_118_317)::env.sigtab)
in {solver = _36_115.solver; range = _36_115.range; curmodule = _36_115.curmodule; gamma = _36_115.gamma; modules = _36_115.modules; expected_typ = _36_115.expected_typ; level = _36_115.level; sigtab = _118_318; is_pattern = _36_115.is_pattern; instantiate_targs = _36_115.instantiate_targs; instantiate_vargs = _36_115.instantiate_vargs; effects = _36_115.effects; generalize = _36_115.generalize; letrecs = _36_115.letrecs; top_level = _36_115.top_level; check_uvars = _36_115.check_uvars; use_eq = _36_115.use_eq; is_iface = _36_115.is_iface; admit = _36_115.admit; default_effects = _36_115.default_effects}))))
...
let _36_139 = env
in (let _118_328 = (FStar_List.tl env.sigtab)
in {solver = _36_139.solver; range = _36_139.range; curmodule = _36_139.curmodule; gamma = _36_139.gamma; modules = _36_139.modules; expected_typ = _36_139.expected_typ; level = _36_139.level; sigtab = _118_328; is_pattern = _36_139.is_pattern; instantiate_targs = _36_139.instantiate_targs; instantiate_vargs = _36_139.instantiate_vargs; effects = _36_139.effects; generalize = _36_139.generalize; letrecs = _36_139.letrecs; top_level = _36_139.top_level; check_uvars = _36_139.check_uvars; use_eq = _36_139.use_eq; is_iface = _36_139.is_iface; admit = _36_139.admit; default_effects = _36_139.default_effects}))))
...
let initial_env : solver_t  ->  FStar_Ident.lident  ->  env = (fun solver module_lid -> (let _118_338 = (let _118_337 = (new_sigtab ())
in (_118_337)::[])
in {solver = solver; range = FStar_Absyn_Syntax.dummyRange; curmodule = module_lid; gamma = []; modules = []; expected_typ = None; level = Expr; sigtab = _118_338; is_pattern = false; instantiate_targs = true; instantiate_vargs = true; effects = {decls = []; order = []; joins = []}; generalize = true; letrecs = []; top_level = true; check_uvars = false; use_eq = false; is_iface = false; admit = false; default_effects = []}))
...
let variable_not_found = (fun v -> (let _118_347 = (FStar_Absyn_Print.strBvd v)
in (FStar_Util.format1 "Variable \"%s\" not found" _118_347)))
...
| None -> begin
(let _118_354 = (let _118_353 = (let _118_352 = (name_not_found l)
in (_118_352, (FStar_Ident.range_of_lid l)))
in FStar_Absyn_Syntax.Error (_118_353))
in (Prims.raise _118_354))
end
| Some (md) -> begin
md
end))
...
| None -> begin
(let _118_410 = (let _118_409 = (let _118_408 = (let _118_407 = (FStar_Absyn_Print.sli l1)
in (let _118_406 = (FStar_Absyn_Print.sli l2)
in (FStar_Util.format2 "Effects %s and %s cannot be composed" _118_407 _118_406)))
in (_118_408, env.range))
in FStar_Absyn_Syntax.Error (_118_409))
in (Prims.raise _118_410))
end
...
| None -> begin
(let _118_425 = (FStar_Util.format1 "Impossible: declaration for monad %s not found" m.FStar_Ident.str)
in (FStar_All.failwith _118_425))
end
| Some (md) -> begin
...
let compose_edges = (fun e1 e2 -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun r wp1 -> (let _118_446 = (e1.mlift r wp1)
in (e2.mlift r _118_446)))})
in (
# 277 "FStar.Tc.Env.fst"
let mk_lift = (fun lift_t r wp1 -> (let _118_457 = (let _118_456 = (let _118_455 = (FStar_Absyn_Syntax.targ r)
in (let _118_454 = (let _118_453 = (FStar_Absyn_Syntax.targ wp1)
in (_118_453)::[])
in (_118_455)::_118_454))
in (lift_t, _118_456))
in (FStar_Absyn_Syntax.mk_Typ_app _118_457 None wp1.FStar_Absyn_Syntax.pos)))
in (
...
let arg = (let _118_474 = (FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _118_474 FStar_Absyn_Syntax.mk_Kind_type))
in (
# 290 "FStar.Tc.Env.fst"
let wp = (let _118_475 = (FStar_Absyn_Syntax.lid_of_path (("WP")::[]) FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Util.ftv _118_475 FStar_Absyn_Syntax.mk_Kind_unknown))
in (let _118_476 = (l arg wp)
in (FStar_Absyn_Print.typ_to_string _118_476)))))
in (
...
(FStar_All.pipe_right (id_edge i) (fun _118_482 -> Some (_118_482)))
end else begin
...
let order = (FStar_All.pipe_right ms (FStar_List.fold_left (fun order k -> (let _118_490 = (FStar_All.pipe_right ms (FStar_List.collect (fun i -> if (FStar_Ident.lid_equals i k) then begin
[]
end else begin
(FStar_All.pipe_right ms (FStar_List.collect (fun j -> if (FStar_Ident.lid_equals j k) then begin
[]
end else begin
(match ((let _118_489 = (find_edge order (i, k))
in (let _118_488 = (find_edge order (k, j))
in (_118_489, _118_488)))) with
...
in (FStar_List.append order _118_490))) order))
in (
...
let join_opt = (FStar_All.pipe_right ms (FStar_List.fold_left (fun bopt k -> (match ((let _118_498 = (find_edge order (i, k))
in (let _118_497 = (find_edge order (j, k))
in (_118_498, _118_497)))) with
...
if ((let _118_499 = (find_edge order (k, ub))
in (FStar_Util.is_some _118_499)) && (not ((let _118_500 = (find_edge order (ub, k))
in (FStar_Util.is_some _118_500))))) then begin
Some ((k, ik, jk))
end else begin
bopt
end
...
let lids = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_List.iter (fun l -> (let _118_508 = (sigtab env)
in (FStar_Util.smap_add _118_508 l.FStar_Ident.str se))) lids))
end))
...
let empty_lid : FStar_Absyn_Syntax.lident = (let _118_512 = (let _118_511 = (FStar_Absyn_Syntax.id_of_text "")
in (_118_511)::[])
in (FStar_Absyn_Syntax.lid_of_ids _118_512))
...
let find_in_sigtab : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.sigelt Prims.option = (fun env lid -> (let _118_544 = (sigtab env)
in (FStar_Util.smap_try_find _118_544 (FStar_Ident.text_of_lid lid))))
...
| None -> begin
(let _118_556 = (let _118_555 = (let _118_554 = (variable_not_found bv.FStar_Absyn_Syntax.v)
in (_118_554, (FStar_Absyn_Util.range_of_bvd bv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_118_555))
in (Prims.raise _118_556))
end
| Some (t) -> begin
t
end))
...
(FStar_Util.find_map ses (fun se -> if (let _118_571 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _118_571 (FStar_Util.for_some (FStar_Ident.lid_equals lid)))) then begin
...
(let _118_577 = (FStar_List.map (fun _36_492 -> (match (_36_492) with
| (x, _36_491) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit (true)))
end)) tps)
in (FStar_Absyn_Util.close_typ _118_577 t))
end
| _36_494 -> begin
(let _118_580 = (let _118_579 = (let _118_578 = (name_not_found lid)
in (_118_578, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_118_579))
in (Prims.raise _118_580))
end))
...
| _36_507 -> begin
(let _118_587 = (let _118_586 = (let _118_585 = (name_not_found lid)
in (_118_585, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_118_586))
in (Prims.raise _118_587))
end))
...
| () -> begin
(let _118_598 = (let _118_597 = (FStar_Util.string_of_int i)
in (let _118_596 = (FStar_Absyn_Print.sli lid)
in (FStar_Util.format2 "Impossible: projecting field #%s from constructor %s is undefined" _118_597 _118_596)))
in (FStar_All.failwith _118_598))
end))
in (
# 440 "FStar.Tc.Env.fst"
let t = (lookup_datacon env lid)
in (match ((let _118_599 = (FStar_Absyn_Util.compress_typ t)
in _118_599.FStar_Absyn_Syntax.n)) with
...
(let _118_600 = (FStar_Absyn_Util.mk_field_projector_name lid a i)
in (FStar_All.pipe_right _118_600 Prims.fst))
end
| FStar_Util.Inr (x) -> begin
(let _118_601 = (FStar_Absyn_Util.mk_field_projector_name lid x i)
in (FStar_All.pipe_right _118_601 Prims.fst))
end))
end
end
| _36_525 -> begin
...
| _36_554 -> begin
(let _118_612 = (let _118_611 = (let _118_610 = (name_not_found lid)
in (_118_610, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_118_611))
in (Prims.raise _118_612))
end))
...
| () -> begin
(let _118_621 = (let _118_620 = (let _118_619 = (name_not_found lid)
in (_118_619, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_118_620))
in (Prims.raise _118_621))
end))
in (
...
(let _118_626 = (let _118_625 = (FStar_List.map (fun _36_581 -> (match (_36_581) with
| (x, _36_580) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit (true)))
end)) tps)
in (FStar_Absyn_Util.close_typ _118_625 t))
in Some (_118_626))
end
...
in (match ((let _118_628 = (lookup_qname env lid)
in (FStar_Util.bind_opt _118_628 mapper))) with
| Some (t) -> begin
(
# 489 "FStar.Tc.Env.fst"
let _36_636 = t
in (let _118_629 = (FStar_Absyn_Syntax.range_of_lid lid)
in {FStar_Absyn_Syntax.n = _36_636.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _36_636.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _118_629; FStar_Absyn_Syntax.fvs = _36_636.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _36_636.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
(let _118_646 = (FStar_List.map (fun l -> (let _118_645 = (lookup_lid env l)
in (l, _118_645))) datas)
in Some (_118_646))
end
| _36_724 -> begin
...
in (let _118_657 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_118_657)))
end
end
| _36_763 -> begin
...
let t = (FStar_Absyn_Util.close_with_lam tps t)
in (let _118_662 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, lid))))
in Some (_118_662)))
end
| _36_780 -> begin
None
...
| None -> begin
(let _118_674 = (let _118_673 = (let _118_672 = (variable_not_found btv.FStar_Absyn_Syntax.v)
in (_118_672, (FStar_Absyn_Util.range_of_bvd btv.FStar_Absyn_Syntax.v)))
in FStar_Absyn_Syntax.Error (_118_673))
in (Prims.raise _118_674))
end
| Some (k) -> begin
k
end))
...
| _36_823 -> begin
(let _118_681 = (let _118_680 = (let _118_679 = (name_not_found ftv)
in (_118_679, (FStar_Ident.range_of_lid ftv)))
in FStar_Absyn_Syntax.Error (_118_680))
in (Prims.raise _118_681))
end))
...
(let _118_692 = (FStar_Absyn_Util.close_kind ne.FStar_Absyn_Syntax.binders ne.FStar_Absyn_Syntax.signature)
in (FStar_All.pipe_right _118_692 (fun _118_691 -> Some (_118_691))))
end
| Some (FStar_Util.Inr (FStar_Absyn_Syntax.Sig_effect_abbrev (lid, binders, _36_873, _36_875, _36_877))) -> begin
(let _118_694 = (FStar_Absyn_Util.close_kind binders FStar_Absyn_Syntax.mk_Kind_effect)
in (FStar_All.pipe_right _118_694 (fun _118_693 -> Some (_118_693))))
end
| _36_883 -> begin
None
end))
...
| None -> begin
(let _118_701 = (let _118_700 = (let _118_699 = (name_not_found ftv)
in (_118_699, (FStar_Ident.range_of_lid ftv)))
in FStar_Absyn_Syntax.Error (_118_700))
in (Prims.raise _118_701))
end
| Some (k) -> begin
k
end))
...
let no_uvs = (let _118_718 = (FStar_Absyn_Syntax.new_uv_set ())
in (let _118_717 = (FStar_Absyn_Syntax.new_uvt_set ())
in (let _118_716 = (FStar_Absyn_Syntax.new_uvt_set ())
in {FStar_Absyn_Syntax.uvars_k = _118_718; FStar_Absyn_Syntax.uvars_t = _118_717; FStar_Absyn_Syntax.uvars_e = _118_716})))
in (
# 586 "FStar.Tc.Env.fst"
let ext = (fun out uvs -> (
# 587 "FStar.Tc.Env.fst"
let _36_905 = out
in (let _118_725 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_k uvs.FStar_Absyn_Syntax.uvars_k)
in (let _118_724 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_t uvs.FStar_Absyn_Syntax.uvars_t)
in (let _118_723 = (FStar_Util.set_union out.FStar_Absyn_Syntax.uvars_e uvs.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _118_725; FStar_Absyn_Syntax.uvars_t = _118_724; FStar_Absyn_Syntax.uvars_e = _118_723})))))
in (
...
(let _118_731 = (let _118_730 = (FStar_Absyn_Util.uvars_in_typ t)
in (ext out _118_730))
in (aux _118_731 tl))
end
| Binding_typ (_36_925, k)::tl -> begin
(let _118_733 = (let _118_732 = (FStar_Absyn_Util.uvars_in_kind k)
in (ext out _118_732))
in (aux _118_733 tl))
end
...
(let _118_743 = (let _118_742 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Setting expected type to %s with kind unknown" _118_742))
in (FStar_All.failwith _118_743))
end
| _36_970 -> begin
(
...
| Binding_var (x, t) -> begin
(let _118_766 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_118_766)::out)
end
| Binding_typ (a, k) -> begin
(let _118_767 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_118_767)::out)
end
| _36_1002 -> begin
out
...
| Binding_typ (a, k) -> begin
(let _118_772 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_118_772)::out)
end
| _36_1014 -> begin
out
...
let idents : env  ->  FStar_Absyn_Syntax.freevars = (fun env -> (let _118_776 = (let _118_775 = (binders env)
in (FStar_All.pipe_right _118_775 (FStar_List.map Prims.fst)))
in (FStar_Absyn_Syntax.freevars_of_list _118_776)))
...
| Binding_sig (s) -> begin
(let _118_781 = (FStar_Absyn_Util.lids_of_sigelt s)
in (FStar_List.append _118_781 keys))
end
| _36_1022 -> begin
keys
end)) [] env.gamma)
in (let _118_786 = (sigtab env)
in (FStar_Util.smap_fold _118_786 (fun _36_1024 v keys -> (let _118_785 = (FStar_Absyn_Util.lids_of_sigelt v)
in (FStar_List.append _118_785 keys))) keys))))
