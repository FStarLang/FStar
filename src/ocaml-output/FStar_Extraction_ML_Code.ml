...
let (uu___is_IRight : assoc -> Prims.bool) =
  fun projectee -> match projectee with | IRight -> true | uu____20 -> false
...
let (uu___is_Prefix : fixity -> Prims.bool) =
  fun projectee -> match projectee with | Prefix -> true | uu____69 -> false
let (uu___is_Postfix : fixity -> Prims.bool) =
  fun projectee -> match projectee with | Postfix -> true | uu____80 -> false
    ...
    fun x ->
      ...
      | uu____682 ->
          ...
          (match uu____684 with
           | (ns, x1) ->
               let uu____695 = path_of_ns currentModule ns in (uu____695, x1))
let (ptsym_of_symbol :
                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1838, uu____1839) -> false))) in
...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1981, FStar_Const.Int16)) ->
        s
    ...
    fun outer ->
      fun ty ->
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Tuple tys ->
            ...
            let doc2 =
              let uu____2086 =
                let uu____2087 = combine (text " * ") doc1 in hbox uu____2087 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   parens uu____2429) es in
            let docs1 =
              let uu____2431 = combine (text ", ") docs in parens uu____2431 in
            docs1
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____2563;_},
                          branches);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2625;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2639;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____3788 =
                   ...
                   [uu____3791; body2] in
                 combine hardline uu____3788) in
  ...
  fun currentModule ->
    fun s ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x, args) ->
          ...
          let args2 =
            let uu____3874 = combine (text " * ") args1 in parens uu____3874 in
  ...
  fun currentModule ->
    fun m ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Exn (x, args) ->
          ...
          let args3 =
            let uu____3958 = combine (text " * ") args2 in parens uu____3958 in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____4160 ->
                     ...
                     | (s, uu____4166) -> doc_of_sig x1 s) sigmod in
        ...
        and for1_mod istop uu____4199 =
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
                ...
                | uu____4281 ->
                    let pervasives1 =
                      FStar_Extraction_ML_Util.flatten_mlpath
                        (["FStar"], "Pervasives") in
                    [hardline; text (Prims.op_Hat "open " pervasives1)] in
              let head1 =
                let uu____4302 =
                  let uu____4305 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____4305
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____4336 ->
                     ...
                     | (uu____4341, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              let sub2 = FStar_List.map (for1_mod false) sub1 in
              let sub3 =
                FStar_List.map (fun x -> reduce [x; hardline; hardline]) sub2 in
              let prefix1 =
                let uu____4367 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____4367
              ...
              FStar_All.pipe_left reduce uu____4375 in
        let docs =
          FStar_List.map
            (fun uu____4437 ->
               match uu____4437 with
               | (x, s, m) ->
                   let uu____4494 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____4496 = for1_mod true (x, s, m) in
                   (uu____4494, uu____4496)) mllib in
        docs
