...
let (string_of_mlconstant :
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Bytes bytes ->
        let uu___ =
          let uu___1 = FStar_Compiler_Bytes.f_encode escape_byte_hex bytes
             in
              ...
              | uu___ ->
                  let args2 =
                    FStar_List.map
                     ...
                     in
                  let uu___1 =
                    let uu___2 = combine (text ", ") args2  in hbox uu___2
                     in
                  parens uu___1
               in
      ...
      fun e  ->
            ...
            let docs =
              FStar_List.map
                (fun x  ->
                   ...
                   parens uu___) es
               in
            let docs1 = let uu___ = combine (text ", ") docs  in parens uu___
               in
            docs1
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,lets),body) ->
            let pre =
              ...
              then
                let uu___ =
                  let uu___1 =
                    let uu___2 = doc_of_loc e.FStar_Extraction_ML_Syntax.loc
                       in
                    [uu___2]  in
                  hardline :: uu___1  in
                reduce uu___
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu___7;_},branches1);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu___1;_},unitVal::[]),e11::e2::[])
                 when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   FStar_Extraction_ML_Syntax.expr =
                     FStar_Extraction_ML_Syntax.MLE_Name p;
                   FStar_Extraction_ML_Syntax.mlty = uu___;
                   FStar_Extraction_ML_Syntax.loc = uu___1;_},unitVal::[]),e11::[])
                 when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
              ...
              then
                ...
                (let uu___2 =
                   let uu___3 =
                     let uu___4 =
                       let uu___5 =
                         let uu___6 = ptsym currentModule f  in text uu___6
                          in
                       [uu___5]  in
                     (text ".") :: uu___4  in
                   e2 :: uu___3  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Fun (ids,body) ->
            ...
            let doc1 =
              let uu___ =
                let uu___1 =
                  let uu___2 = reduce1 ids1  in [uu___2; text "->"; body1]
                   in
                (text "fun") :: uu___1  in
              reduce1 uu___  in
            parens doc1
        ...
        | FStar_Extraction_ML_Syntax.MLE_Match (cond,pats) ->
            ...
            let doc1 =
              let uu___ = reduce1 [text "match"; parens cond1; text "with"]
                 in
              uu___ :: pats1  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            let uu___ =
              let uu___1 =
                ...
                let uu___3 =
                  let uu___4 =
                    let uu___5 = combine (text ", ") args1  in parens uu___5
                     in
                  [uu___4]  in
                uu___2 :: uu___3  in
              (text "raise") :: uu___1  in
...
and (doc_of_binop :
  ...
  fun currentModule  ->
    fun p  ->
      fun e1  ->
        fun e2  ->
          let uu___ = let uu___1 = as_bin_op p  in FStar_Option.get uu___1
             in
          match uu___ with
          | (uu___1,prio,txt) ->
          ...
          let for1 uu___ =
            ...
            | (name,p) ->
                let uu___1 =
                  ...
                  let uu___3 =
                    let uu___4 =
                      let uu___5 = doc_of_pattern currentModule p  in
                      [uu___5]  in
                    (text "=") :: uu___4  in
                  uu___2 :: uu___3  in
                reduce1 uu___1
      ...
      | (p,cond,e) ->
          let case =
            ...
            | FStar_Pervasives_Native.None  ->
                let uu___1 =
                  let uu___2 =
                    let uu___3 = doc_of_pattern currentModule p  in [uu___3]
                     in
                  (text "|") :: uu___2  in
                reduce1 uu___1
          ...
          (let file1 = FStar_Util.basename file  in
           let uu___3 =
             let uu___4 =
               ...
               [uu___5; text (Prims.op_Hat "\"" (Prims.op_Hat file1 "\""))]
                in
             (text "#") :: uu___4  in
           reduce1 uu___3)
        ...
        | { FStar_Extraction_ML_Syntax.tydecl_assumed = uu___1;
            ...
            let tparams1 =
              ...
              | uu___3 ->
                  ...
                  let uu___4 = combine (text ", ") doc1  in parens uu___4
               in
            let forbody body1 =
              match body1 with
            ...
            let doc1 =
              let uu___3 =
                let uu___4 =
                  let uu___5 =
                    let uu___6 = ptsym currentModule ([], x1)  in text uu___6
                     in
                  [uu___5]  in
                tparams1 :: uu___4  in
              reduce1 uu___3  in
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu___3 =
                   let uu___4 = reduce1 [doc1; text "="]  in [uu___4; body2]
                    in
                 combine hardline uu___3)
         in
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x,args) ->
          let args1 =
            FStar_List.map
             ...
             in
          let args2 = let uu___ = combine (text " * ") args1  in parens uu___
             in
      ...
      | FStar_Extraction_ML_Syntax.MLM_Exn (x,args) ->
          ...
          let args2 =
            FStar_List.map
             ...
             in
          let args3 = let uu___ = combine (text " * ") args2  in parens uu___
             in
        ...
        let rec for1_sig uu___1 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    let uu___5 = reduce sub2  in [uu___5; cat tail hardline]
                     in
                  (match doc1 with
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu___2  ->
                     match uu___2 with
                     | (uu___3,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let prefix =
                ...
                if uu___2 then [cat (text "#light \"off\"") hardline] else []
                 in
              let uu___2 =
                let uu___3 =
                  let uu___4 =
              ...
              FStar_All.pipe_left reduce uu___2
         in
        let docs =
          FStar_List.map
            (fun uu___1  ->
