...
let uu____1307 = (FStar_Format.combine (FStar_Format.text " * ") doc1)
in (FStar_Format.hbox uu____1307))
in (FStar_Format.parens uu____1306))
in doc2))
end
...
let uu____1323 = (FStar_Format.combine (FStar_Format.text ", ") args1)
in (FStar_Format.hbox uu____1323))
...
let uu____1325 = (FStar_Format.reduce1 ((args1)::((FStar_Format.text name1))::[]))
in (FStar_Format.hbox uu____1325))))
end
| FStar_Extraction_ML_Syntax.MLTY_Fun (t1, uu____1327, t2) -> begin
(
...
let uu____1332 = (FStar_Format.reduce1 ((d1)::((FStar_Format.text " -> "))::(d2)::[]))
in (FStar_Format.hbox uu____1332))
in (maybe_paren outer t_prio_fun uu____1331))))
end
| FStar_Extraction_ML_Syntax.MLTY_Top -> begin
(

let uu____1333 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____1338 = (FStar_Extraction_ML_Util.resugar_mlty ty)
in (doc_of_mltype' currentModule outer uu____1338)))
...
let uu____1422 = (FStar_Extraction_ML_Util.codegen_fsharp ())
in (match (uu____1422) with
| true -> begin
(

let uu____1423 = (FStar_Format.reduce (((FStar_Format.text "Prims.unsafe_coerce "))::(doc1)::[]))
in (FStar_Format.parens uu____1423))
end
| uu____1424 -> begin
(

let uu____1425 = (FStar_Format.reduce (((FStar_Format.text "Obj.magic "))::((FStar_Format.parens doc1))::[]))
in (FStar_Format.parens uu____1425))
end)))
end
...
let uu____1437 = (FStar_Format.reduce docs1)
in (FStar_Format.parens uu____1437))))
end
| FStar_Extraction_ML_Syntax.MLE_Const (c) -> begin
(

let uu____1439 = (string_of_mlconstant c)
in (FStar_Format.text uu____1439))
end
...
let uu____1442 = (ptsym currentModule path)
in (FStar_Format.text uu____1442))
end
...
let uu____1482 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text uu____1482))
in (uu____1481)::((FStar_Format.text "="))::(doc1)::[])
in (FStar_Format.reduce1 uu____1478)))
end))
in (

let uu____1485 = (

let uu____1486 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____1486))
in (FStar_Format.cbrackets uu____1485)))
end
...
let uu____1497 = (is_standard_constructor ctor)
...
let uu____1503 = (as_standard_constructor ctor)
in (FStar_Option.get uu____1503))
in (FStar_Pervasives_Native.snd uu____1498))
end
| uu____1514 -> begin
...
let uu____1522 = (is_standard_constructor ctor)
...
let uu____1528 = (as_standard_constructor ctor)
in (FStar_Option.get uu____1528))
in (FStar_Pervasives_Native.snd uu____1523))
end
| uu____1539 -> begin
(ptctor currentModule ctor)
end))
...
let uu____1563 = (FStar_Format.combine (FStar_Format.text ", ") args1)
in (FStar_Format.parens uu____1563))
in (uu____1562)::[])
in ((FStar_Format.text name))::uu____1559)
in (FStar_Format.reduce1 uu____1556))
end)
...
let uu____1573 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) x)
in (FStar_Format.parens uu____1573))) es)
in (

let docs1 = (

let uu____1575 = (FStar_Format.combine (FStar_Format.text ", ") docs)
in (FStar_Format.parens uu____1575))
in docs1))
end
...
let uu____1596 = (doc_of_loc e.FStar_Extraction_ML_Syntax.loc)
in (uu____1596)::[])
in (FStar_Format.hardline)::uu____1593)
in (FStar_Format.reduce uu____1590))
end
| uu____1597 -> begin
FStar_Format.empty
end)
...
let uu____1612 = (FStar_Format.reduce1 (((FStar_Format.text "in"))::(body1)::[]))
in (uu____1612)::[])
in (doc1)::uu____1609)
in (pre)::uu____1606)
in (FStar_Format.combine FStar_Format.hardline uu____1603))
in (FStar_Format.parens uu____1602)))))
end
| FStar_Extraction_ML_Syntax.MLE_App (e1, args) -> begin
(match (((e1.FStar_Extraction_ML_Syntax.expr), (args))) with
| (FStar_Extraction_ML_Syntax.MLE_Name (p), ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Fun ((uu____1622)::[], scrutinee); FStar_Extraction_ML_Syntax.mlty = uu____1624; FStar_Extraction_ML_Syntax.loc = uu____1625})::({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Fun (((arg, uu____1627))::[], possible_match); FStar_Extraction_ML_Syntax.mlty = uu____1629; FStar_Extraction_ML_Syntax.loc = uu____1630})::[]) when (

let uu____1665 = (FStar_Extraction_ML_Syntax.string_of_mlpath p)
in (Prims.op_Equality uu____1665 "FStar.All.try_with")) -> begin
(

let branches = (match (possible_match) with
| {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Match ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Var (arg'); FStar_Extraction_ML_Syntax.mlty = uu____1688; FStar_Extraction_ML_Syntax.loc = uu____1689}, branches); FStar_Extraction_ML_Syntax.mlty = uu____1691; FStar_Extraction_ML_Syntax.loc = uu____1692} when (Prims.op_Equality arg arg') -> begin
branches
end
| e2 -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = uu____1748; FStar_Extraction_ML_Syntax.loc = uu____1749}, (unitVal)::[]), (e11)::(e2)::[]) when ((is_bin_op p) && (Prims.op_Equality unitVal FStar_Extraction_ML_Syntax.ml_unit)) -> begin
(doc_of_binop currentModule p e11 e2)
end
| (FStar_Extraction_ML_Syntax.MLE_Name (p), (e11)::[]) when (is_uni_op p) -> begin
(doc_of_uniop currentModule p e11)
end
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = uu____1762; FStar_Extraction_ML_Syntax.loc = uu____1763}, (unitVal)::[]), (e11)::[]) when ((is_uni_op p) && (Prims.op_Equality unitVal FStar_Extraction_ML_Syntax.ml_unit)) -> begin
(doc_of_uniop currentModule p e11)
end
| uu____1770 -> begin
(
...
let uu____1781 = (FStar_Format.reduce1 ((e2)::args1))
in (FStar_Format.parens uu____1781))))
end)
end
...
let uu____1786 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____1800 = (ptsym currentModule f)
in (FStar_Format.text uu____1800))
in (uu____1799)::[])
in ((FStar_Format.text "."))::uu____1796)
in (e2)::uu____1793)
in (FStar_Format.reduce uu____1790))
end))
in doc1))
end
...
let uu____1830 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____1848 = (doc_of_mltype currentModule outer xxt)
in (uu____1848)::[])
in ((FStar_Format.text " : "))::uu____1845)
in (FStar_Format.reduce1 uu____1842))
end
| uu____1849 -> begin
(FStar_Format.text "")
end)
in (uu____1840)::((FStar_Format.text ")"))::[])
in ((FStar_Format.text x))::uu____1837)
in ((FStar_Format.text "("))::uu____1834)
in (FStar_Format.reduce1 uu____1831))
end
| uu____1852 -> begin
(FStar_Format.text x)
end)))
...
let ids1 = (FStar_List.map (fun uu____1863 -> (match (uu____1863) with
| (x, xt) -> begin
...
let uu____1878 = (FStar_Format.reduce1 ids1)
in (uu____1878)::((FStar_Format.text "->"))::(body1)::[])
in ((FStar_Format.text "fun"))::uu____1875)
in (FStar_Format.reduce1 uu____1872))
...
let uu____1888 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond1)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1889 = (

let uu____1892 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (uu____1892)::((FStar_Format.text "end"))::[])
in (uu____1888)::uu____1889))
in (FStar_Format.combine FStar_Format.hardline uu____1885))
...
let uu____1903 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond1)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1904 = (

let uu____1907 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (

let uu____1908 = (

let uu____1911 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::((FStar_Format.text "else"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1912 = (

let uu____1915 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e2)
in (uu____1915)::((FStar_Format.text "end"))::[])
in (uu____1911)::uu____1912))
in (uu____1907)::uu____1908))
in (uu____1903)::uu____1904))
in (FStar_Format.combine FStar_Format.hardline uu____1900))
in (maybe_paren outer e_bin_prio_if doc1)))
end
...
let uu____1953 = (FStar_Format.reduce1 (((FStar_Format.text "match"))::((FStar_Format.parens cond1))::((FStar_Format.text "with"))::[]))
in (uu____1953)::pats1)
in (
...
let uu____1965 = (ptctor currentModule exn)
in (FStar_Format.text uu____1965))
in (uu____1964)::[])
in ((FStar_Format.text "raise"))::uu____1961)
...
let uu____1982 = (ptctor currentModule exn)
in (FStar_Format.text uu____1982))
in (
...
let uu____1987 = (FStar_Format.combine (FStar_Format.text ", ") args1)
in (FStar_Format.parens uu____1987))
in (uu____1986)::[])
in (uu____1981)::uu____1983))
in ((FStar_Format.text "raise"))::uu____1978)
in (FStar_Format.reduce1 uu____1975)))
end
...
let uu____2016 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (
...
let uu____2024 = (FStar_List.map (doc_of_branch currentModule) pats)
in (FStar_Format.combine FStar_Format.hardline uu____2024))
in (uu____2023)::[])
in ((FStar_Format.text "with"))::uu____2020)
in (uu____2016)::uu____2017))
in ((FStar_Format.text "try"))::uu____2013)
in (FStar_Format.combine FStar_Format.hardline uu____2010))
end
...
let uu____2056 = (as_bin_op p)
in (FStar_Option.get uu____2056))
in (match (uu____2045) with
| (uu____2079, prio, txt) -> begin
(
...
let uu____2101 = (as_uni_op p)
in (FStar_Option.get uu____2101))
in (match (uu____2096) with
| (uu____2112, txt) -> begin
(
...
let uu____2119 = (string_of_mlconstant c)
...
let for1 = (fun uu____2148 -> (match (uu____2148) with
| (name, p) -> begin
(
...
let uu____2159 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text uu____2159))
in (
...
let uu____2168 = (doc_of_pattern currentModule p)
in (uu____2168)::[])
in ((FStar_Format.text "="))::uu____2165)
in (uu____2158)::uu____2162))
in (FStar_Format.reduce1 uu____2155))
end))
in (

let uu____2169 = (

let uu____2170 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____2170))
in (FStar_Format.cbrackets uu____2169)))
end
...
let uu____2181 = (is_standard_constructor ctor)
...
let uu____2187 = (as_standard_constructor ctor)
in (FStar_Option.get uu____2187))
in (FStar_Pervasives_Native.snd uu____2182))
end
| uu____2198 -> begin
(ptctor currentModule ctor)
end))
...
let uu____2206 = (is_standard_constructor ctor)
...
let uu____2212 = (as_standard_constructor ctor)
in (FStar_Option.get uu____2212))
in (FStar_Pervasives_Native.snd uu____2207))
end
| uu____2223 -> begin
(ptctor currentModule ctor)
end))
...
let uu____2235 = (doc_of_pattern currentModule x)
in (FStar_Format.parens uu____2235))
in (
...
let uu____2242 = (doc_of_pattern currentModule xs)
in (uu____2242)::[])
in ((FStar_Format.text "::"))::uu____2239)
in (uu____2234)::uu____2236))
in (FStar_Format.reduce uu____2231))
end
| (uu____2243, (FStar_Extraction_ML_Syntax.MLP_Tuple (uu____2244))::[]) -> begin
(
...
let uu____2256 = (FStar_List.hd pats)
in (doc_of_pattern currentModule uu____2256))
in (uu____2255)::[])
in ((FStar_Format.text name))::uu____2252)
in (FStar_Format.reduce1 uu____2249))
end
| uu____2257 -> begin
(
...
let uu____2272 = (FStar_List.map (doc_of_pattern currentModule) pats)
in (FStar_Format.combine (FStar_Format.text ", ") uu____2272))
in (FStar_Format.parens uu____2271))
in (uu____2270)::[])
in ((FStar_Format.text name))::uu____2267)
in (FStar_Format.reduce1 uu____2264))
end)
...
and doc_of_branch : FStar_Extraction_ML_Syntax.mlsymbol  ->  FStar_Extraction_ML_Syntax.mlbranch  ->  FStar_Format.doc = (fun currentModule uu____2296 -> (match (uu____2296) with
| (p, cond, e) -> begin
(
...
let uu____2311 = (doc_of_pattern currentModule p)
in (uu____2311)::[])
in ((FStar_Format.text "|"))::uu____2308)
in (FStar_Format.reduce1 uu____2305))
end
...
let uu____2320 = (doc_of_pattern currentModule p)
in (uu____2320)::((FStar_Format.text "when"))::(c1)::[])
in ((FStar_Format.text "|"))::uu____2317)
in (FStar_Format.reduce1 uu____2314)))
end)
in (

let uu____2321 = (

let uu____2324 = (FStar_Format.reduce1 ((case)::((FStar_Format.text "->"))::((FStar_Format.text "begin"))::[]))
in (

let uu____2325 = (

let uu____2328 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (uu____2328)::((FStar_Format.text "end"))::[])
in (uu____2324)::uu____2325))
in (FStar_Format.combine FStar_Format.hardline uu____2321)))
end))
and doc_of_lets : FStar_Extraction_ML_Syntax.mlsymbol  ->  (FStar_Extraction_ML_Syntax.mlletflavor * Prims.bool * FStar_Extraction_ML_Syntax.mllb Prims.list)  ->  FStar_Format.doc = (fun currentModule uu____2330 -> (match (uu____2330) with
| (rec_, top_level, lets) -> begin
(

let for1 = (fun uu____2351 -> (match (uu____2351) with
| {FStar_Extraction_ML_Syntax.mllb_name = name; FStar_Extraction_ML_Syntax.mllb_tysc = tys; FStar_Extraction_ML_Syntax.mllb_add_unit = uu____2354; FStar_Extraction_ML_Syntax.mllb_def = e; FStar_Extraction_ML_Syntax.mllb_meta = uu____2356; FStar_Extraction_ML_Syntax.print_typ = pt} -> begin
(
...
let uu____2366 = ((FStar_Extraction_ML_Util.codegen_fsharp ()) && ((Prims.op_Equality rec_ FStar_Extraction_ML_Syntax.Rec) || top_level))
in (match (uu____2366) with
| true -> begin
(match (tys) with
| FStar_Pervasives_Native.Some ((uu____2367)::uu____2368, uu____2369) -> begin
(FStar_Format.text "")
end
| FStar_Pervasives_Native.None -> begin
(FStar_Format.text "")
...
let uu____2381 = (FStar_All.pipe_right vs (FStar_List.map (fun x -> (doc_of_mltype currentModule ((min_op_prec), (NonAssoc)) (FStar_Extraction_ML_Syntax.MLTY_Var (x))))))
in (FStar_All.pipe_right uu____2381 FStar_Format.reduce1))
...
let uu____2397 = (FStar_Format.reduce1 ids)
in (uu____2397)::(ty_annot)::((FStar_Format.text "="))::(e1)::[])
in ((FStar_Format.text name))::uu____2394)
in (FStar_Format.reduce1 uu____2391)))))
end))
in (
...
and doc_of_loc : FStar_Extraction_ML_Syntax.mlloc  ->  FStar_Format.doc = (fun uu____2411 -> (match (uu____2411) with
| (lineno, file) -> begin
(

let uu____2414 = (((FStar_Options.no_location_info ()) || (FStar_Extraction_ML_Util.codegen_fsharp ())) || (Prims.op_Equality file "<dummy>"))
...
let for1 = (fun uu____2450 -> (match (uu____2450) with
| (uu____2469, x, mangle_opt, tparams, uu____2473, body) -> begin
(
...
let uu____2499 = (FStar_Format.combine (FStar_Format.text ", ") doc1)
in (FStar_Format.parens uu____2499)))
end)
in (
...
let forfield = (fun uu____2523 -> (match (uu____2523) with
| (name, ty) -> begin
(
...
let uu____2533 = (FStar_List.map forfield fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____2533))
in (FStar_Format.cbrackets uu____2532)))
end
| FStar_Extraction_ML_Syntax.MLTD_DType (ctors) -> begin
(

let forctor = (fun uu____2568 -> (match (uu____2568) with
| (name, tys) -> begin
(

let uu____2593 = (FStar_List.split tys)
...
let uu____2645 = (ptsym currentModule (([]), (x1)))
in (FStar_Format.text uu____2645))
in (uu____2644)::[])
in (tparams1)::uu____2641)
...
let uu____2653 = (FStar_Format.reduce1 ((doc1)::((FStar_Format.text "="))::[]))
in (uu____2653)::(body2)::[])
in (FStar_Format.combine FStar_Format.hardline uu____2650)))
end)))))
end))
in (
...
let uu____2693 = (FStar_Format.reduce1 (((FStar_Format.text "module"))::((FStar_Format.text x))::((FStar_Format.text "="))::[]))
in (

let uu____2694 = (

let uu____2697 = (doc_of_sig currentModule subsig)
in (

let uu____2698 = (

let uu____2701 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::[]))
in (uu____2701)::[])
in (uu____2697)::uu____2698))
in (uu____2693)::uu____2694))
in (FStar_Format.combine FStar_Format.hardline uu____2690))
end
...
let uu____2715 = (FStar_Format.combine (FStar_Format.text " * ") args1)
in (FStar_Format.parens uu____2715))
in (FStar_Format.reduce1 (((FStar_Format.text "exception"))::((FStar_Format.text x))::((FStar_Format.text "of"))::(args2)::[]))))
end
| FStar_Extraction_ML_Syntax.MLS_Val (x, (uu____2717, ty)) -> begin
(
...
let uu____2777 = (FStar_Format.combine (FStar_Format.text " * ") args2)
in (FStar_Format.parens uu____2777))
...
let uu____2800 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (uu____2800)::[])
in ((FStar_Format.text "="))::uu____2797)
in ((FStar_Format.text "_"))::uu____2794)
in ((FStar_Format.text "let"))::uu____2791)
in (FStar_Format.reduce1 uu____2788))
end
...
| FStar_Extraction_ML_Syntax.MLM_Loc (uu____2824) -> begin
FStar_Format.empty
end
| uu____2825 -> begin
...
let rec doc_of_mllib_r : FStar_Extraction_ML_Syntax.mllib  ->  (Prims.string * FStar_Format.doc) Prims.list = (fun uu____2836 -> (match (uu____2836) with
| FStar_Extraction_ML_Syntax.MLLib (mllib) -> begin
(

let rec for1_sig = (fun uu____2902 -> (match (uu____2902) with
...
let doc1 = (FStar_Option.map (fun uu____2957 -> (match (uu____2957) with
| (s, uu____2963) -> begin
(doc_of_sig x1 s)
end)) sigmod)
in (
...
let uu____2993 = (FStar_Format.reduce sub3)
in (uu____2993)::((FStar_Format.cat tail1 FStar_Format.hardline))::[])
in ((match (doc1) with
| FStar_Pervasives_Native.None -> begin
FStar_Format.empty
end
...
in ((FStar_Format.cat head1 FStar_Format.hardline))::uu____2987)
in (FStar_Format.reduce uu____2984))))))))
end))
and for1_mod = (fun istop uu____2996 -> (match (uu____2996) with
...
let uu____3078 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
in (FStar_Format.reduce1 uu____3075))
in (
...
let doc1 = (FStar_Option.map (fun uu____3097 -> (match (uu____3097) with
| (uu____3102, m) -> begin
...
let uu____3127 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____3149 = (FStar_Format.reduce sub3)
in (uu____3149)::((FStar_Format.cat tail1 FStar_Format.hardline))::[])
in ((match (doc1) with
| FStar_Pervasives_Native.None -> begin
FStar_Format.empty
end
...
in (FStar_Format.hardline)::uu____3143)
in (FStar_List.append maybe_open_pervasives uu____3140))
in (FStar_List.append ((head1)::(FStar_Format.hardline)::((FStar_Format.text "open Prims"))::[]) uu____3137))
in (FStar_List.append prefix1 uu____3134))
in (FStar_All.pipe_left FStar_Format.reduce uu____3131))))))))))
end))
in (

let docs = (FStar_List.map (fun uu____3188 -> (match (uu____3188) with
| (x, s, m) -> begin
(

let uu____3238 = (FStar_Extraction_ML_Util.flatten_mlpath x)
in (

let uu____3239 = (for1_mod true ((x), (s), (m)))
in ((uu____3238), (uu____3239))))
end)) mllib)
in docs))
end))
...
let uu____3274 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_expr uu____3274 ((min_op_prec), (NonAssoc)) e))
...
let uu____3286 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_mltype uu____3286 ((min_op_prec), (NonAssoc)) e))
in (FStar_Format.pretty (Prims.parse_int "0") doc1)))
