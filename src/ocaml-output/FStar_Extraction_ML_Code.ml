...
let string_of_mlconstant:
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Char c ->
        let _0_223 =
          let _0_222 = escape_or escape_char_hex c in Prims.strcat _0_222 "'" in
        Prims.strcat "'" _0_223
    ...
    fun outer  ->
      fun e  ->
              ...
              | (name,e) ->
                  ...
                  FStar_Format.reduce1
                    (let _0_230 =
                     ...
                     [_0_230; FStar_Format.text "="; doc]) in
                       ...
                       let _0_232 =
                         FStar_Format.parens
                           (FStar_Format.combine (FStar_Format.text ", ")
                              args) in
                       [_0_232] in
                     (FStar_Format.text name) :: _0_233) in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,uu____819,lets),body) ->
            let pre =
              ...
              then
                FStar_Format.reduce
                  (let _0_235 =
                     let _0_234 = doc_of_loc e.FStar_Extraction_ML_Syntax.loc in
                     [_0_234] in
             ...
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____844;_}::{
                                                                    ...
                                                                    uu____849;_}::[])
                 when
                 let _0_240 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            let doc =
              ...
              then
                ...
                FStar_Format.reduce
                  (let _0_245 =
                     let _0_244 =
                       let _0_243 = FStar_Format.text (ptsym currentModule f) in
                       [_0_243] in
            ...
            let doc =
              FStar_Format.reduce1
                (let _0_252 =
                 ...
                 (FStar_Format.text "fun") :: _0_252) in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,[]) ->
            FStar_Format.reduce1
              (let _0_267 =
                 let _0_266 = FStar_Format.text (ptctor currentModule exn) in
                 [_0_266] in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            FStar_Format.reduce1
              (let _0_271 =
                 let _0_270 = FStar_Format.text (ptctor currentModule exn) in
                 let _0_269 =
                   let _0_268 =
                     FStar_Format.parens
                       (FStar_Format.combine (FStar_Format.text ", ") args) in
                       ...
                       FStar_Format.parens
                         (let _0_291 =
                          ...
                          FStar_Format.combine (FStar_Format.text ", ")
                            _0_291) in
                     [_0_292] in
                   (FStar_Format.text name) :: _0_293) in
      ...
      | (p,cond,e) ->
          let case =
            ...
            | None  ->
                FStar_Format.reduce1
                  (let _0_295 =
                     let _0_294 = doc_of_pattern currentModule p in [_0_294] in
            ...
            (match body with
             ...
             | Some body ->
                 ...
                 let _0_309 =
                   ...
                   [_0_308; body] in
                 FStar_Format.combine FStar_Format.hardline _0_309) in
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let _0_317 =
            ...
            let _0_315 =
              ...
              let _0_313 =
                let _0_312 = FStar_Format.reduce1 [FStar_Format.text "end"] in
                [_0_312] in
              _0_314 :: _0_313 in
            _0_316 :: _0_315 in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              FStar_Format.reduce
                (let _0_324 =
                   let _0_323 =
                     ...
                     [_0_322; FStar_Format.cat tail FStar_Format.hardline] in
                   (match doc with
        ...
        and for1_mod istop uu____1584 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              FStar_All.pipe_left FStar_Format.reduce _0_332 in
        let docs =
          FStar_List.map
            (fun uu____1670  ->
