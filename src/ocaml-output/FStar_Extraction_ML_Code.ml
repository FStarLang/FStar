        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path,fields) ->
            let for1 uu____824 =
              ...
              | (name,e1) ->
                  ...
                  FStar_Format.reduce1 uu____832
               in
            let uu____837 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            ...
            let doc1 =
              ...
              | (uu____881,uu____882) ->
                  ...
                  FStar_Format.reduce1 uu____885
               in
            ...
            let docs1 =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____896) es
               in
            let docs2 =
              let uu____900 =
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1051 =
                   ...
                   e2 :: uu____1053  in
                 FStar_Format.reduce uu____1051)
               in
            doc1
            ...
            let ids1 =
              FStar_List.map
                (fun uu____1099  ->
                   ...
                   | ((x,uu____1105),xt) -> bvar_annot x (Some xt)) ids
               in
            let body1 =
              doc_of_expr currentModule (min_op_prec, NonAssoc) body  in
            let doc1 =
                ...
                let uu____1223 =
                  let uu____1225 =
                    let uu____1227 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____1228
                       in
                    [uu____1227]  in
  ...
  fun currentModule  ->
    fun pattern  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____1304 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____1309
             in
          let uu____1319 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          ...
          let uu____1396 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____1447 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let ids1 =
                  FStar_List.map
                    (fun uu____1467  ->
                       ...
                       | (x,uu____1471) -> FStar_Format.text x) ids
                   in
                let ty_annot =
                ...
                let uu____1509 =
                  let uu____1511 =
                    let uu____1512 = FStar_Extraction_ML_Syntax.idsym name
                       in
        ...
        | (uu____1557,x,mangle_opt,tparams,body) ->
            ...
            let tparams1 =
              ...
              | uu____1573 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____1578 = FStar_Extraction_ML_Syntax.idsym x2
                            in
                         FStar_Format.text uu____1578) tparams
                     in
                  let uu____1579 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____1579
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____1605 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____1606
                     in
                  FStar_Format.cbrackets uu____1605
              | FStar_Extraction_ML_Syntax.MLTD_DType ctors ->
                  let forctor uu____1625 =
                    match uu____1625 with
                    | (name,tys) ->
                        let uu____1639 = FStar_List.split tys  in
            ...
            let doc1 =
              let uu____1668 =
                let uu____1670 =
                  let uu____1672 =
                    let uu____1673 = ptsym currentModule ([], x1)  in
                    FStar_Format.text uu____1673  in
                  [uu____1672]  in
                tparams1 :: uu____1670  in
              FStar_Format.reduce1 uu____1668  in
            (match body with
             | None  -> doc1
             | Some body1 ->
                 ...
                 let uu____1677 =
                   ...
                   [uu____1679; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____1677)
         in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1897  ->
                     ...
                     | (s,uu____1901) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____1918 =
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1920
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1918
                 in
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1982  ->
                     ...
                     | (uu____1985,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____2003 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____2003
                then
              ...
              let uu____2006 =
                let uu____2008 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____2010
                   in
                FStar_List.append prefix1 uu____2008  in
              FStar_All.pipe_left FStar_Format.reduce uu____2006
         in
        let docs1 =
          FStar_List.map
            (fun uu____2036  ->
               ...
               | (x,s,m) ->
                   let uu____2063 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____2064 = for1_mod true (x, s, m)  in
                   (uu____2063, uu____2064)) mllib
           in
        docs1
