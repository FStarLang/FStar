            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1715 =
                   ...
                   e2 :: uu____1718  in
                 FStar_Format.reduce uu____1715)
               in
            doc1
                ...
                let uu____1966 =
                  let uu____1969 =
                    let uu____1972 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____1973
                       in
                    [uu____1972]  in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____2099 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____2106
             in
          let uu____2120 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          ...
          let doc1 =
            ...
            | uu____2208 ->
                ...
                FStar_Format.reduce1 uu____2215
             in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps  in
          let uu____2236 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
        ...
        | (uu____2467,x,mangle_opt,tparams,uu____2471,body) ->
            ...
            let tparams1 =
              ...
              | uu____2489 ->
                  ...
                  let uu____2497 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____2497
               in
            let forbody body1 =
              match body1 with
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____2654 =
                   ...
                   [uu____2657; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____2654)
         in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3000  ->
                     ...
                     | (s,uu____3006) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____3036 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3039
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3036
                 in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3146  ->
                     ...
                     | (uu____3151,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let uu____3186 =
                let uu____3189 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3192
                   in
                FStar_List.append prefix1 uu____3189  in
              FStar_All.pipe_left FStar_Format.reduce uu____3186
         in
        let docs =
          FStar_List.map
            (fun uu____3243  ->
               ...
               | (x,s,m) ->
                   let uu____3293 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____3294 = for1_mod true (x, s, m)  in
                   (uu____3293, uu____3294)) mllib
           in
        docs
