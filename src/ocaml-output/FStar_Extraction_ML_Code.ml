    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
        ...
        and for1_mod istop uu____1887 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____1931 =
                  let uu____1933 = FStar_Extraction_ML_Util.codegen_fsharp ()
                     in
                  if uu____1933
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1944  ->
                     ...
                     | (uu____1947,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____1965 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____1965
                then
              ...
              let uu____1968 =
                let uu____1970 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____1972
                   in
                FStar_List.append prefix1 uu____1970  in
              FStar_All.pipe_left FStar_Format.reduce uu____1968
         in
        let docs1 =
          FStar_List.map
            (fun uu____1998  ->
               ...
               | (x,s,m) ->
                   let uu____2025 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____2026 = for1_mod true (x, s, m)  in
                   (uu____2025, uu____2026)) mllib
           in
        docs1
