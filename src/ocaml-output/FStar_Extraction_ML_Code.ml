...
let doc = (let _170_119 = (let _170_118 = (FStar_Format.combine (FStar_Format.text " * ") doc)
in (FStar_Format.hbox _170_118))
in (FStar_Format.parens _170_119))
in doc))
end
...
in (let _170_121 = (let _170_120 = (FStar_Format.combine (FStar_Format.text ", ") args)
in (FStar_Format.hbox _170_120))
in (FStar_Format.parens _170_121)))
end)
in (

let name = if (is_standard_type name) then begin
(let _170_123 = (let _170_122 = (as_standard_type name)
in (FStar_Option.get _170_122))
in (Prims.snd _170_123))
end else begin
(ptsym currentModule name)
end
in (let _170_124 = (FStar_Format.reduce1 ((args)::((FStar_Format.text name))::[]))
in (FStar_Format.hbox _170_124))))
end
...
in (let _170_126 = (let _170_125 = (FStar_Format.reduce1 ((d1)::((FStar_Format.text " -> "))::(d2)::[]))
in (FStar_Format.hbox _170_125))
in (maybe_paren outer t_prio_fun _170_126))))
end
...
and doc_of_mltype : FStar_Extraction_ML_Syntax.mlsymbol  ->  level  ->  FStar_Extraction_ML_Syntax.mlty  ->  FStar_Format.doc = (fun currentModule outer ty -> (let _170_130 = (FStar_Extraction_ML_Util.resugar_mlty ty)
in (doc_of_mltype' currentModule outer _170_130)))
...
(let _170_151 = (FStar_Format.reduce (((FStar_Format.text "Prims.checked_cast"))::(doc)::[]))
in (FStar_Format.parens _170_151))
end else begin
(let _170_152 = (FStar_Format.reduce (((FStar_Format.text "Obj.magic "))::((FStar_Format.parens doc))::[]))
in (FStar_Format.parens _170_152))
end)
end
...
(let _170_154 = (string_of_mlconstant c)
in (FStar_Format.text _170_154))
end
| FStar_Extraction_ML_Syntax.MLE_Var (x, _75_257) -> begin
(FStar_Format.text x)
end
| FStar_Extraction_ML_Syntax.MLE_Name (path) -> begin
(let _170_155 = (ptsym currentModule path)
in (FStar_Format.text _170_155))
end
...
let doc = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (let _170_160 = (let _170_159 = (let _170_158 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text _170_158))
in (_170_159)::((FStar_Format.text "="))::(doc)::[])
in (FStar_Format.reduce1 _170_160)))
end))
in (let _170_162 = (let _170_161 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") _170_161))
in (FStar_Format.cbrackets _170_162)))
end
| FStar_Extraction_ML_Syntax.MLE_CTor (ctor, []) -> begin
(

let name = if (is_standard_constructor ctor) then begin
(let _170_164 = (let _170_163 = (as_standard_constructor ctor)
in (FStar_Option.get _170_163))
in (Prims.snd _170_164))
end else begin
...
let name = if (is_standard_constructor ctor) then begin
(let _170_166 = (let _170_165 = (as_standard_constructor ctor)
in (FStar_Option.get _170_165))
in (Prims.snd _170_166))
end else begin
(ptctor currentModule ctor)
end
in (
...
(let _170_170 = (let _170_169 = (let _170_168 = (let _170_167 = (FStar_Format.combine (FStar_Format.text ", ") args)
in (FStar_Format.parens _170_167))
in (_170_168)::[])
in ((FStar_Format.text name))::_170_169)
in (FStar_Format.reduce1 _170_170))
end)
...
let docs = (FStar_List.map (fun x -> (let _170_172 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) x)
in (FStar_Format.parens _170_172))) es)
in (

let docs = (let _170_173 = (FStar_Format.combine (FStar_Format.text ", ") docs)
in (FStar_Format.parens _170_173))
in docs))
end
...
(let _170_176 = (let _170_175 = (let _170_174 = (doc_of_loc e.FStar_Extraction_ML_Syntax.loc)
in (_170_174)::[])
in (FStar_Format.hardline)::_170_175)
in (FStar_Format.reduce _170_176))
end else begin
FStar_Format.empty
end
in (
...
in (let _170_181 = (let _170_180 = (let _170_179 = (let _170_178 = (let _170_177 = (FStar_Format.reduce1 (((FStar_Format.text "in"))::(body)::[]))
in (_170_177)::[])
in (doc)::_170_178)
in (pre)::_170_179)
in (FStar_Format.combine FStar_Format.hardline _170_180))
in (FStar_Format.parens _170_181)))))
end
...
in (let _170_182 = (FStar_Format.reduce1 ((e)::args))
in (FStar_Format.parens _170_182))))
end)
end
...
(let _170_187 = (let _170_186 = (let _170_185 = (let _170_184 = (let _170_183 = (ptsym currentModule f)
in (FStar_Format.text _170_183))
in (_170_184)::[])
in ((FStar_Format.text "."))::_170_185)
in (e)::_170_186)
in (FStar_Format.reduce _170_187))
end
in doc))
end
...
(let _170_198 = (let _170_197 = (let _170_196 = (let _170_195 = (match (xt) with
| Some (xxt) -> begin
(let _170_194 = (let _170_193 = (let _170_192 = (doc_of_mltype currentModule outer xxt)
in (_170_192)::[])
in ((FStar_Format.text " : "))::_170_193)
in (FStar_Format.reduce1 _170_194))
end
| _75_418 -> begin
(FStar_Format.text "")
end)
in (_170_195)::((FStar_Format.text ")"))::[])
in ((FStar_Format.text x))::_170_196)
in ((FStar_Format.text "("))::_170_197)
in (FStar_Format.reduce1 _170_198))
end else begin
(FStar_Format.text x)
end)
in (
...
let doc = (let _170_202 = (let _170_201 = (let _170_200 = (FStar_Format.reduce1 ids)
in (_170_200)::((FStar_Format.text "->"))::(body)::[])
in ((FStar_Format.text "fun"))::_170_201)
in (FStar_Format.reduce1 _170_202))
...
let doc = (let _170_206 = (let _170_205 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (let _170_204 = (let _170_203 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (_170_203)::((FStar_Format.text "end"))::[])
in (_170_205)::_170_204))
in (FStar_Format.combine FStar_Format.hardline _170_206))
...
let doc = (let _170_214 = (let _170_213 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (let _170_212 = (let _170_211 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (let _170_210 = (let _170_209 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::((FStar_Format.text "else"))::((FStar_Format.text "begin"))::[]))
in (let _170_208 = (let _170_207 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e2)
in (_170_207)::((FStar_Format.text "end"))::[])
in (_170_209)::_170_208))
in (_170_211)::_170_210))
in (_170_213)::_170_212))
in (FStar_Format.combine FStar_Format.hardline _170_214))
in (maybe_paren outer e_bin_prio_if doc)))
end
...
let doc = (let _170_215 = (FStar_Format.reduce1 (((FStar_Format.text "match"))::((FStar_Format.parens cond))::((FStar_Format.text "with"))::[]))
in (_170_215)::pats)
in (
...
(let _170_219 = (let _170_218 = (let _170_217 = (let _170_216 = (ptctor currentModule exn)
in (FStar_Format.text _170_216))
in (_170_217)::[])
in ((FStar_Format.text "raise"))::_170_218)
in (FStar_Format.reduce1 _170_219))
end
| FStar_Extraction_ML_Syntax.MLE_Raise (exn, args) -> begin
(

let args = (FStar_List.map (doc_of_expr currentModule ((min_op_prec), (NonAssoc))) args)
in (let _170_226 = (let _170_225 = (let _170_224 = (let _170_220 = (ptctor currentModule exn)
in (FStar_Format.text _170_220))
in (let _170_223 = (let _170_222 = (let _170_221 = (FStar_Format.combine (FStar_Format.text ", ") args)
in (FStar_Format.parens _170_221))
in (_170_222)::[])
in (_170_224)::_170_223))
in ((FStar_Format.text "raise"))::_170_225)
in (FStar_Format.reduce1 _170_226)))
end
| FStar_Extraction_ML_Syntax.MLE_Try (e, pats) -> begin
(let _170_233 = (let _170_232 = (let _170_231 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (let _170_230 = (let _170_229 = (let _170_228 = (let _170_227 = (FStar_List.map (doc_of_branch currentModule) pats)
in (FStar_Format.combine FStar_Format.hardline _170_227))
in (_170_228)::[])
in ((FStar_Format.text "with"))::_170_229)
in (_170_231)::_170_230))
in ((FStar_Format.text "try"))::_170_232)
in (FStar_Format.combine FStar_Format.hardline _170_233))
end))
...
let _75_472 = (let _170_238 = (as_bin_op p)
in (FStar_Option.get _170_238))
...
let _75_482 = (let _170_242 = (as_uni_op p)
in (FStar_Option.get _170_242))
...
(let _170_245 = (string_of_mlconstant c)
in (FStar_Format.text _170_245))
end
...
| (name, p) -> begin
(let _170_253 = (let _170_252 = (let _170_248 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text _170_248))
in (let _170_251 = (let _170_250 = (let _170_249 = (doc_of_pattern currentModule p)
in (_170_249)::[])
in ((FStar_Format.text "="))::_170_250)
in (_170_252)::_170_251))
in (FStar_Format.reduce1 _170_253))
end))
in (let _170_255 = (let _170_254 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") _170_254))
...
let name = if (is_standard_constructor ctor) then begin
(let _170_257 = (let _170_256 = (as_standard_constructor ctor)
in (FStar_Option.get _170_256))
in (Prims.snd _170_257))
end else begin
(ptctor currentModule ctor)
end
in (FStar_Format.text name))
...
let name = if (is_standard_constructor ctor) then begin
(let _170_259 = (let _170_258 = (as_standard_constructor ctor)
in (FStar_Option.get _170_258))
in (Prims.snd _170_259))
end else begin
(ptctor currentModule ctor)
end
in (
...
| ("::", (x)::(xs)::[]) -> begin
(let _170_265 = (let _170_264 = (let _170_260 = (doc_of_pattern currentModule x)
in (FStar_Format.parens _170_260))
in (let _170_263 = (let _170_262 = (let _170_261 = (doc_of_pattern currentModule xs)
in (_170_261)::[])
in ((FStar_Format.text "::"))::_170_262)
in (_170_264)::_170_263))
in (FStar_Format.reduce _170_265))
end
| (_75_516, (FStar_Extraction_ML_Syntax.MLP_Tuple (_75_518))::[]) -> begin
(let _170_269 = (let _170_268 = (let _170_267 = (let _170_266 = (FStar_List.hd pats)
in (doc_of_pattern currentModule _170_266))
in (_170_267)::[])
in ((FStar_Format.text name))::_170_268)
in (FStar_Format.reduce1 _170_269))
end
| _75_523 -> begin
(let _170_274 = (let _170_273 = (let _170_272 = (let _170_271 = (let _170_270 = (FStar_List.map (doc_of_pattern currentModule) pats)
in (FStar_Format.combine (FStar_Format.text ", ") _170_270))
in (FStar_Format.parens _170_271))
in (_170_272)::[])
in ((FStar_Format.text name))::_170_273)
in (FStar_Format.reduce1 _170_274))
end)
...
in (let _170_275 = (FStar_Format.combine (FStar_Format.text ", ") ps)
in (FStar_Format.parens _170_275)))
end
...
| None -> begin
(let _170_280 = (let _170_279 = (let _170_278 = (doc_of_pattern currentModule p)
in (_170_278)::[])
in ((FStar_Format.text "|"))::_170_279)
in (FStar_Format.reduce1 _170_280))
end
| Some (c) -> begin
(

let c = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) c)
in (let _170_283 = (let _170_282 = (let _170_281 = (doc_of_pattern currentModule p)
in (_170_281)::((FStar_Format.text "when"))::(c)::[])
in ((FStar_Format.text "|"))::_170_282)
in (FStar_Format.reduce1 _170_283)))
end)
in (let _170_287 = (let _170_286 = (FStar_Format.reduce1 ((case)::((FStar_Format.text "->"))::((FStar_Format.text "begin"))::[]))
in (let _170_285 = (let _170_284 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (_170_284)::((FStar_Format.text "end"))::[])
in (_170_286)::_170_285))
in (FStar_Format.combine FStar_Format.hardline _170_287)))
end))
...
in (let _170_295 = (let _170_294 = (let _170_293 = (FStar_Format.reduce1 ids)
in (_170_293)::(ty_annot)::((FStar_Format.text "="))::(e)::[])
in ((FStar_Format.text (FStar_Extraction_ML_Syntax.idsym name)))::_170_294)
in (FStar_Format.reduce1 _170_295))))))
end))
in (
...
in (let _170_306 = (FStar_Format.combine (FStar_Format.text ", ") doc)
in (FStar_Format.parens _170_306)))
end)
in (
...
in (let _170_312 = (let _170_311 = (FStar_List.map forfield fields)
in (FStar_Format.combine (FStar_Format.text "; ") _170_311))
in (FStar_Format.cbrackets _170_312)))
end
...
let doc = (let _170_319 = (let _170_318 = (let _170_317 = (let _170_316 = (ptsym currentModule (([]), (x)))
in (FStar_Format.text _170_316))
in (_170_317)::[])
in (tparams)::_170_318)
...
in (let _170_321 = (let _170_320 = (FStar_Format.reduce1 ((doc)::((FStar_Format.text "="))::[]))
in (_170_320)::(body)::[])
in (FStar_Format.combine FStar_Format.hardline _170_321)))
end)))))
end))
in (
...
(let _170_324 = (let _170_323 = (let _170_322 = (FStar_Format.combine (FStar_Format.text " \n and ") doc)
in (_170_322)::[])
in ((FStar_Format.text "type"))::_170_323)
in (FStar_Format.reduce1 _170_324))
end else begin
(FStar_Format.text "")
end
in doc))))
...
(let _170_336 = (let _170_335 = (FStar_Format.reduce1 (((FStar_Format.text "module"))::((FStar_Format.text x))::((FStar_Format.text "="))::[]))
in (let _170_334 = (let _170_333 = (doc_of_sig currentModule subsig)
in (let _170_332 = (let _170_331 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::[]))
in (_170_331)::[])
in (_170_333)::_170_332))
in (_170_335)::_170_334))
in (FStar_Format.combine FStar_Format.hardline _170_336))
end
...
let args = (let _170_337 = (FStar_Format.combine (FStar_Format.text " * ") args)
in (FStar_Format.parens _170_337))
...
let args = (let _170_345 = (FStar_Format.combine (FStar_Format.text " * ") args)
in (FStar_Format.parens _170_345))
in (FStar_Format.reduce1 (((FStar_Format.text "exception"))::((FStar_Format.text x))::((FStar_Format.text "of"))::(args)::[]))))
end
...
(let _170_350 = (let _170_349 = (let _170_348 = (let _170_347 = (let _170_346 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (_170_346)::[])
in ((FStar_Format.text "="))::_170_347)
in ((FStar_Format.text "_"))::_170_348)
in ((FStar_Format.text "let"))::_170_349)
in (FStar_Format.reduce1 _170_350))
end
...
in (let _170_367 = (let _170_366 = (let _170_365 = (let _170_364 = (FStar_Format.reduce sub)
in (_170_364)::((FStar_Format.cat tail FStar_Format.hardline))::[])
in ((match (doc) with
| None -> begin
FStar_Format.empty
end
...
in ((FStar_Format.cat head FStar_Format.hardline))::_170_366)
in (FStar_Format.reduce _170_367))))))))
end))
...
let head = (let _170_370 = if (FStar_Extraction_ML_Util.codegen_fsharp ()) then begin
...
in (FStar_Format.reduce1 _170_370))
in (
...
in (let _170_380 = (let _170_379 = (let _170_378 = (let _170_377 = (let _170_376 = (let _170_375 = (let _170_374 = (let _170_373 = (FStar_Format.reduce sub)
in (_170_373)::((FStar_Format.cat tail FStar_Format.hardline))::[])
in ((match (doc) with
| None -> begin
FStar_Format.empty
end
...
in (FStar_Format.hardline)::_170_375)
in ((FStar_Format.text "open Prims"))::_170_376)
in (FStar_Format.hardline)::_170_377)
in (head)::_170_378)
in (FStar_List.append prefix _170_379))
in (FStar_All.pipe_left FStar_Format.reduce _170_380)))))))))
end))
in (

let docs = (FStar_List.map (fun _75_769 -> (match (_75_769) with
| (x, s, m) -> begin
(let _170_383 = (FStar_Extraction_ML_Util.flatten_mlpath x)
in (let _170_382 = (for1_mod true ((x), (s), (m)))
...
let doc = (let _170_390 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_expr _170_390 ((min_op_prec), (NonAssoc)) e))
...
let doc = (let _170_395 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_mltype _170_395 ((min_op_prec), (NonAssoc)) e))
in (FStar_Format.pretty (Prims.parse_int "0") doc)))
