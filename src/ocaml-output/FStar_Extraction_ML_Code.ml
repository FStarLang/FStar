...
type opprec = (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2
type level = (opprec,assoc) FStar_Pervasives_Native_Tuple2.tuple2
let (t_prio_fun : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
  ((Prims.parse_int "10"), (Infix Right)) 
let (t_prio_tpl : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
  ((Prims.parse_int "20"), (Infix NonAssoc)) 
let (t_prio_name : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2)
  = ((Prims.parse_int "30"), Postfix) 
let (e_bin_prio_lambda :
  (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
  ((Prims.parse_int "5"), Prefix) 
let (e_bin_prio_if :
  (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
  ((Prims.parse_int "15"), Prefix) 
let (e_bin_prio_letin :
  (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (e_app_prio : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2) =
  ((Prims.parse_int "10000"), (Infix Left)) 
let (min_op_prec : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2)
  = ((~- (Prims.parse_int "1")), (Infix NonAssoc)) 
let (max_op_prec : (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2)
  = (FStar_Util.max_int, (Infix NonAssoc)) 
let rec in_ns :
  'a .
    ('a Prims.list,'a Prims.list) FStar_Pervasives_Native_Tuple2.tuple2 ->
      Prims.bool
  =
  fun x  ->
    match x with
...
let (infix_prim_ops :
  (Prims.string,(Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2,
    Prims.string) FStar_Pervasives_Native_Tuple3.tuple3 Prims.list)
  =
...
let (as_bin_op :
  FStar_Extraction_ML_Syntax.mlpath ->
    (FStar_Extraction_ML_Syntax.mlsymbol,(Prims.int,fixity)
      ...
      Prims.string) FStar_Pervasives_Native_Tuple3.tuple3
...
let (maybe_paren :
  ((Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2,assoc)
    FStar_Pervasives_Native_Tuple2.tuple2 ->
    (Prims.int,fixity) FStar_Pervasives_Native_Tuple2.tuple2 ->
                ...
                then "\\n"
                  ...
                  then "\\'"
                    ...
                    then "\\\""
                      ...
                      if FStar_Util.is_letter_or_digit uu___275_1710
                      then FStar_Util.string_of_char uu___275_1710
                      else
                        if FStar_Util.is_punctuation uu___275_1710
                        then FStar_Util.string_of_char uu___275_1710
                        else
                          if FStar_Util.is_symbol uu___275_1710
                          then FStar_Util.string_of_char uu___275_1710
                          else fallback uu___275_1710
...
and (doc_of_lets :
  FStar_Extraction_ML_Syntax.mlsymbol ->
    (FStar_Extraction_ML_Syntax.mlletflavor,Prims.bool,FStar_Extraction_ML_Syntax.mllb
                                                         Prims.list)
      FStar_Pervasives_Native_Tuple3.tuple3 -> FStar_Format.doc)
  =
  fun currentModule  ->
    fun uu____3194  ->
...
let rec (doc_of_mllib_r :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string,FStar_Format.doc) FStar_Pervasives_Native_Tuple2.tuple2
      Prims.list)
  =
  fun uu____3877  ->
