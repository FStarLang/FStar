        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            ...
            let doc1 =
              ...
              | (uu____1458,uu____1459) ->
                  ...
                  FStar_Format.reduce1 uu____1464
               in
            ...
            let docs1 =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____1481) es
               in
            let docs2 =
              let uu____1487 =
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1723 =
                   ...
                   e2 :: uu____1726  in
                 FStar_Format.reduce uu____1723)
               in
            doc1
                ...
                let uu____1988 =
                  let uu____1991 =
                    let uu____1994 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____1995
                       in
                    [uu____1994]  in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____2121 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____2128
             in
          let uu____2142 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          ...
          let doc1 =
            ...
            | uu____2230 ->
                ...
                FStar_Format.reduce1 uu____2237
             in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps  in
          let uu____2258 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
      ...
      | (p,cond,e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____2291
             in
          let uu____2298 =
            let uu____2301 =
              FStar_Format.reduce1
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____2330 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let uu____2417 =
                  let uu____2420 =
                    let uu____2421 = FStar_Extraction_ML_Syntax.idsym name
                       in
                ...
                FStar_Format.reduce1 uu____2417
             in
          let letdoc =
            ...
            let tparams1 =
              ...
              | uu____2516 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____2525 = FStar_Extraction_ML_Syntax.idsym x2
                            in
                         FStar_Format.text uu____2525) tparams
                     in
                  let uu____2526 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____2526
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2563 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2564
                     in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3034  ->
                     ...
                     | (s,uu____3040) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____3070 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3073
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3070
                 in
        ...
        and for1_mod istop uu____3079 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3158 =
                  let uu____3161 = FStar_Extraction_ML_Util.codegen_fsharp ()
                     in
                  if uu____3161
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3180  ->
                     ...
                     | (uu____3185,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____3216 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____3216
                then
              ...
              let uu____3220 =
                let uu____3223 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3226
                   in
                FStar_List.append prefix1 uu____3223  in
              FStar_All.pipe_left FStar_Format.reduce uu____3220
         in
        let docs1 =
          FStar_List.map
            (fun uu____3277  ->
               ...
               | (x,s,m) ->
                   let uu____3327 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____3328 = for1_mod true (x, s, m)  in
                   (uu____3327, uu____3328)) mllib
           in
        docs1
