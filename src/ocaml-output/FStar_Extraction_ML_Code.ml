    ...
    fun x ->
      ...
      | uu____330 ->
          ...
          (match uu____331 with
           | (ns, x1) ->
               let uu____338 = path_of_ns currentModule ns in (uu____338, x1))
let (ptsym_of_symbol :
                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1091, uu____1092) -> false))) in
...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1210, FStar_Const.Int16)) ->
        s
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named (args, name) ->
            let args1 =
              ...
              | uu____1297 ->
                  ...
                  FStar_Format.parens uu____1303 in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path, fields) ->
            let for1 uu____1451 =
              ...
              | (name, e1) ->
                  ...
                  FStar_Format.reduce1 uu____1459 in
            let uu____1466 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor, args) ->
            ...
            let doc1 =
              ...
              | (uu____1531, uu____1532) ->
                  ...
                  FStar_Format.reduce1 uu____1537 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   FStar_Format.parens uu____1554) es in
            let docs1 =
              let uu____1556 =
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____1670;_},
                          branches);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1730;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1744;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1771 =
                   ...
                   e2 :: uu____1774 in
                 FStar_Format.reduce uu____1771) in
            doc1
                ...
                let uu____1998 =
                  let uu____2001 =
                    let uu____2004 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____2005 in
                    [uu____2004] in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path, fields) ->
          let for1 uu____2129 =
            ...
            | (name, p) ->
                ...
                FStar_Format.reduce1 uu____2136 in
          let uu____2150 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor, pats) ->
          ...
          let doc1 =
            ...
            | uu____2238 ->
                ...
                FStar_Format.reduce1 uu____2245 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____2266 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (p, cond, e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____2295 in
          let uu____2302 =
            let uu____2305 =
              FStar_Format.reduce1
        ...
        | (uu____2452, x, mangle_opt, tparams, uu____2456, body) ->
            ...
            let tparams1 =
              ...
              | uu____2474 ->
                  ...
                  let uu____2482 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____2482 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2515 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2516 in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____2940 ->
                     ...
                     | (s, uu____2946) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____2970 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____2973 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____2970 in
        ...
        and for1_mod istop uu____2979 =
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3058 =
                  let uu____3061 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____3061
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3080 ->
                     ...
                     | (uu____3085, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              ...
              let uu____3114 =
                let uu____3117 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3120 in
                FStar_List.append prefix1 uu____3117 in
              FStar_All.pipe_left FStar_Format.reduce uu____3114 in
        let docs =
          FStar_List.map
            (fun uu____3171 ->
               match uu____3171 with
               | (x, s, m) ->
                   let uu____3221 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____3222 = for1_mod true (x, s, m) in
                   (uu____3221, uu____3222)) mllib in
        docs
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string, FStar_Format.doc) FStar_Pervasives_Native.tuple2
