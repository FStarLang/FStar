...
| (x, s, m) -> begin
(let _166_595 = (FStar_Extraction_ML_Util.flatten_mlpath x)
in (let _166_594 = (for1_mod true ((x), (s), (m)))
in ((_166_595), (_166_594))))
end)) mllib)
in docs))
end))
...
let doc = (let _166_602 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_expr _166_602 ((min_op_prec), (NonAssoc)) e))
...
let doc = (let _166_607 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_mltype _166_607 ((min_op_prec), (NonAssoc)) e))
in (FStar_Format.pretty 0 doc)))
