    ...
    fun x  ->
      ...
      | uu____302 ->
          ...
          (match uu____303 with
           | (ns,x1) ->
               let uu____310 = path_of_ns currentModule ns  in
               (uu____310, x1))
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named (args,name) ->
            let args1 =
              ...
              | uu____1205 ->
                  ...
                  FStar_Format.parens uu____1215
               in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path,fields) ->
            let for1 uu____1343 =
              ...
              | (name,e1) ->
                  ...
                  FStar_Format.reduce1 uu____1355
               in
            let uu____1362 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            ...
            let doc1 =
              ...
              | (uu____1431,uu____1432) ->
                  ...
                  FStar_Format.reduce1 uu____1437
               in
            ...
            let docs =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____1454) es
               in
            let docs1 =
              let uu____1460 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____2078 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____2085
             in
          let uu____2099 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          ...
          let doc1 =
            ...
            | uu____2187 ->
                ...
                FStar_Format.reduce1 uu____2194
             in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps  in
          let uu____2215 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
        ...
        | (uu____2446,x,mangle_opt,tparams,uu____2450,body) ->
            ...
            let tparams1 =
              ...
              | uu____2468 ->
                  ...
                  let uu____2476 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____2476
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2513 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2514
                     in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____2979  ->
                     ...
                     | (s,uu____2985) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____3015 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3018
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3015
                 in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3125  ->
                     ...
                     | (uu____3130,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let uu____3165 =
                let uu____3168 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3171
                   in
                FStar_List.append prefix1 uu____3168  in
              FStar_All.pipe_left FStar_Format.reduce uu____3165
         in
        let docs =
          FStar_List.map
            (fun uu____3222  ->
               ...
               | (x,s,m) ->
                   let uu____3272 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____3273 = for1_mod true (x, s, m)  in
                   (uu____3272, uu____3273)) mllib
           in
        docs
