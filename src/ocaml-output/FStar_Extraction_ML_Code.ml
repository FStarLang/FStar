...
let uu____235 = (FStar_Util.first_N cg_len ns)
...
let uu____274 = (FStar_Extraction_ML_Util.flatten_ns sfx)
in (uu____274)::[])
in (FStar_List.append pfx uu____271))
in FStar_Pervasives_Native.Some (uu____268))
end
| uu____277 -> begin
...
let uu____298 = (FStar_Extraction_ML_Syntax.string_of_mlpath x)
...
let uu____311 = (path_of_ns currentModule ns)
in ((uu____311), (x1)))
end))
end)))
...
let uu____322 = (FStar_String.get s (Prims.parse_int "0"))
in (FStar_Char.lowercase uu____322))
in (

let uu____324 = (FStar_String.get s (Prims.parse_int "0"))
in (Prims.op_disEquality uu____320 uu____324)))
...
let uu____339 = (mlpath_of_mlpath currentModule mlp)
...
let uu____352 = (ptsym_of_symbol s)
in (uu____352)::[])
in (FStar_List.append p uu____349))
in (FStar_String.concat "." uu____346))
end))
end))
...
let uu____359 = (mlpath_of_mlpath currentModule mlp)
...
let uu____370 = (FStar_String.get s (Prims.parse_int "0"))
in (FStar_Char.uppercase uu____370))
in (

let uu____372 = (FStar_String.get s (Prims.parse_int "0"))
in (Prims.op_disEquality uu____368 uu____372)))
...
let prim_uni_ops : Prims.unit  ->  (Prims.string * Prims.string) Prims.list = (fun uu____602 -> (

let op_minus = (

let uu____604 = (

let uu____605 = (FStar_Options.codegen ())
in (Prims.op_Equality uu____605 (FStar_Pervasives_Native.Some (FStar_Options.FSharp))))
...
let prim_types : 'Auu____628 . Prims.unit  ->  'Auu____628 Prims.list = (fun uu____631 -> [])
...
let as_bin_op : FStar_Extraction_ML_Syntax.mlpath  ->  (FStar_Extraction_ML_Syntax.mlsymbol * (Prims.int * fixity) * Prims.string) FStar_Pervasives_Native.option = (fun uu____681 -> (match (uu____681) with
| (ns, x) -> begin
(match ((is_prims_ns ns)) with
| true -> begin
(FStar_List.tryFind (fun uu____726 -> (match (uu____726) with
| (y, uu____738, uu____739) -> begin
...
let uu____762 = (as_bin_op p)
in (Prims.op_disEquality uu____762 FStar_Pervasives_Native.None)))


let as_uni_op : FStar_Extraction_ML_Syntax.mlpath  ->  (FStar_Extraction_ML_Syntax.mlsymbol * Prims.string) FStar_Pervasives_Native.option = (fun uu____805 -> (match (uu____805) with
| (ns, x) -> begin
(match ((is_prims_ns ns)) with
| true -> begin
(

let uu____824 = (prim_uni_ops ())
in (FStar_List.tryFind (fun uu____838 -> (match (uu____838) with
| (y, uu____844) -> begin
(Prims.op_Equality x y)
end)) uu____824))
end
...
let uu____853 = (as_uni_op p)
in (Prims.op_disEquality uu____853 FStar_Pervasives_Native.None)))


let is_standard_type : FStar_Extraction_ML_Syntax.mlpath  ->  Prims.bool = (fun p -> false)


let as_standard_constructor : FStar_Extraction_ML_Syntax.mlpath  ->  (FStar_Extraction_ML_Syntax.mlsymbol * Prims.string) FStar_Pervasives_Native.option = (fun uu____881 -> (match (uu____881) with
| (ns, x) -> begin
(match ((is_prims_ns ns)) with
| true -> begin
(FStar_List.tryFind (fun uu____907 -> (match (uu____907) with
| (y, uu____913) -> begin
(Prims.op_Equality x y)
...
let uu____922 = (as_standard_constructor p)
in (Prims.op_disEquality uu____922 FStar_Pervasives_Native.None)))


let maybe_paren : ((Prims.int * fixity) * assoc)  ->  (Prims.int * fixity)  ->  FStar_Format.doc  ->  FStar_Format.doc = (fun uu____957 inner doc1 -> (match (uu____957) with
| (outer, side) -> begin
(

let noparens = (fun _inner _outer side1 -> (

let uu____1008 = _inner
in (match (uu____1008) with
| (pi, fi) -> begin
(

let uu____1015 = _outer
...
| (uu____1022, NonAssoc) -> begin
((Prims.op_Equality pi po) && (Prims.op_Equality fi fo))
end
| (uu____1023, uu____1024) -> begin
false
end))
end))
end)))
...
let escape_or : (FStar_Char.char  ->  Prims.string)  ->  FStar_Char.char  ->  Prims.string = (fun fallback uu___64_1042 -> (match (uu___64_1042) with
...
let uu____1092 = (FStar_Util.string_of_int nc)
in (Prims.strcat uu____1092 (match ((((nc >= (Prims.parse_int "32")) && (nc <= (Prims.parse_int "127"))) && (Prims.op_disEquality nc (Prims.parse_int "34")))) with
| true -> begin
...
let uu____1178 = (FStar_Compiler_Bytes.f_encode escape_byte_hex bytes)
...
let uu____1320 = (FStar_Format.reduce (((FStar_Format.text "Prims.unsafe_coerce "))::(doc1)::[]))
...
let uu____1338 = (FStar_Format.reduce docs1)
...
let uu____1343 = (ptsym currentModule path)
in (FStar_Format.text uu____1343))
end
| FStar_Extraction_ML_Syntax.MLE_Record (path, fields) -> begin
(

let for1 = (fun uu____1369 -> (match (uu____1369) with
| (name, e1) -> begin
(
...
let uu____1385 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text uu____1385))
in (uu____1384)::((FStar_Format.text "="))::(doc1)::[])
...
let uu____1389 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____1389))
in (FStar_Format.cbrackets uu____1388)))
end
...
let uu____1400 = (is_standard_constructor ctor)
...
let uu____1406 = (as_standard_constructor ctor)
in (FStar_Option.get uu____1406))
in (FStar_Pervasives_Native.snd uu____1401))
end
| uu____1417 -> begin
...
let uu____1425 = (is_standard_constructor ctor)
...
let uu____1431 = (as_standard_constructor ctor)
in (FStar_Option.get uu____1431))
in (FStar_Pervasives_Native.snd uu____1426))
end
| uu____1442 -> begin
(ptctor currentModule ctor)
end))
...
let uu____1470 = (FStar_Format.combine (FStar_Format.text ", ") args1)
in (FStar_Format.parens uu____1470))
in (uu____1469)::[])
in ((FStar_Format.text name))::uu____1466)
in (FStar_Format.reduce1 uu____1463))
end)
...
let uu____1480 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) x)
in (FStar_Format.parens uu____1480))) es)
in (

let docs1 = (

let uu____1486 = (FStar_Format.combine (FStar_Format.text ", ") docs)
in (FStar_Format.parens uu____1486))
in docs1))
end
...
let uu____1507 = (doc_of_loc e.FStar_Extraction_ML_Syntax.loc)
in (uu____1507)::[])
in (FStar_Format.hardline)::uu____1504)
in (FStar_Format.reduce uu____1501))
end
| uu____1508 -> begin
FStar_Format.empty
end)
...
let uu____1527 = (FStar_Format.reduce1 (((FStar_Format.text "in"))::(body1)::[]))
in (uu____1527)::[])
in (doc1)::uu____1524)
in (pre)::uu____1521)
in (FStar_Format.combine FStar_Format.hardline uu____1518))
in (FStar_Format.parens uu____1517)))))
end
| FStar_Extraction_ML_Syntax.MLE_App (e1, args) -> begin
(match (((e1.FStar_Extraction_ML_Syntax.expr), (args))) with
| (FStar_Extraction_ML_Syntax.MLE_Name (p), ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Fun ((uu____1537)::[], scrutinee); FStar_Extraction_ML_Syntax.mlty = uu____1539; FStar_Extraction_ML_Syntax.loc = uu____1540})::({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Fun (((arg, uu____1542))::[], possible_match); FStar_Extraction_ML_Syntax.mlty = uu____1544; FStar_Extraction_ML_Syntax.loc = uu____1545})::[]) when (

let uu____1580 = (FStar_Extraction_ML_Syntax.string_of_mlpath p)
in (Prims.op_Equality uu____1580 "FStar.All.try_with")) -> begin
(

let branches = (match (possible_match) with
| {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Match ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Var (arg'); FStar_Extraction_ML_Syntax.mlty = uu____1603; FStar_Extraction_ML_Syntax.loc = uu____1604}, branches); FStar_Extraction_ML_Syntax.mlty = uu____1606; FStar_Extraction_ML_Syntax.loc = uu____1607} when (Prims.op_Equality arg arg') -> begin
branches
end
| e2 -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = uu____1663; FStar_Extraction_ML_Syntax.loc = uu____1664}, (unitVal)::[]), (e11)::(e2)::[]) when ((is_bin_op p) && (Prims.op_Equality unitVal FStar_Extraction_ML_Syntax.ml_unit)) -> begin
(doc_of_binop currentModule p e11 e2)
end
| (FStar_Extraction_ML_Syntax.MLE_Name (p), (e11)::[]) when (is_uni_op p) -> begin
(doc_of_uniop currentModule p e11)
end
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = uu____1677; FStar_Extraction_ML_Syntax.loc = uu____1678}, (unitVal)::[]), (e11)::[]) when ((is_uni_op p) && (Prims.op_Equality unitVal FStar_Extraction_ML_Syntax.ml_unit)) -> begin
(doc_of_uniop currentModule p e11)
end
| uu____1685 -> begin
(
...
let uu____1704 = (FStar_Format.reduce1 ((e2)::args1))
in (FStar_Format.parens uu____1704))))
end)
end
...
let uu____1713 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____1727 = (ptsym currentModule f)
in (FStar_Format.text uu____1727))
in (uu____1726)::[])
in ((FStar_Format.text "."))::uu____1723)
in (e2)::uu____1720)
in (FStar_Format.reduce uu____1717))
end))
in doc1))
end
...
let uu____1753 = (FStar_Extraction_ML_Util.codegen_fsharp ())
...
let uu____1771 = (doc_of_mltype currentModule outer xxt)
in (uu____1771)::[])
in ((FStar_Format.text " : "))::uu____1768)
in (FStar_Format.reduce1 uu____1765))
end
| uu____1772 -> begin
(FStar_Format.text "")
end)
in (uu____1763)::((FStar_Format.text ")"))::[])
in ((FStar_Format.text x))::uu____1760)
in ((FStar_Format.text "("))::uu____1757)
in (FStar_Format.reduce1 uu____1754))
end
| uu____1775 -> begin
(FStar_Format.text x)
end)))
...
let ids1 = (FStar_List.map (fun uu____1786 -> (match (uu____1786) with
| (x, xt) -> begin
...
let uu____1805 = (FStar_Format.reduce1 ids1)
in (uu____1805)::((FStar_Format.text "->"))::(body1)::[])
in ((FStar_Format.text "fun"))::uu____1802)
...
let uu____1819 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond1)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1820 = (

let uu____1823 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (uu____1823)::((FStar_Format.text "end"))::[])
in (uu____1819)::uu____1820))
in (FStar_Format.combine FStar_Format.hardline uu____1816))
...
let uu____1842 = (FStar_Format.reduce1 (((FStar_Format.text "if"))::(cond1)::((FStar_Format.text "then"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1843 = (

let uu____1846 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (

let uu____1851 = (

let uu____1854 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::((FStar_Format.text "else"))::((FStar_Format.text "begin"))::[]))
in (

let uu____1855 = (

let uu____1858 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e2)
in (uu____1858)::((FStar_Format.text "end"))::[])
in (uu____1854)::uu____1855))
in (uu____1846)::uu____1851))
in (uu____1842)::uu____1843))
in (FStar_Format.combine FStar_Format.hardline uu____1839))
in (maybe_paren outer e_bin_prio_if doc1)))
end
...
let uu____1896 = (FStar_Format.reduce1 (((FStar_Format.text "match"))::((FStar_Format.parens cond1))::((FStar_Format.text "with"))::[]))
in (uu____1896)::pats1)
in (
...
let uu____1908 = (ptctor currentModule exn)
in (FStar_Format.text uu____1908))
in (uu____1907)::[])
in ((FStar_Format.text "raise"))::uu____1904)
in (FStar_Format.reduce1 uu____1901))
end
...
let uu____1929 = (ptctor currentModule exn)
in (FStar_Format.text uu____1929))
in (
...
let uu____1934 = (FStar_Format.combine (FStar_Format.text ", ") args1)
in (FStar_Format.parens uu____1934))
in (uu____1933)::[])
in (uu____1928)::uu____1930))
in ((FStar_Format.text "raise"))::uu____1925)
in (FStar_Format.reduce1 uu____1922)))
end
...
let uu____1963 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e1)
in (
...
let uu____1975 = (FStar_List.map (doc_of_branch currentModule) pats)
in (FStar_Format.combine FStar_Format.hardline uu____1975))
in (uu____1974)::[])
in ((FStar_Format.text "with"))::uu____1971)
in (uu____1963)::uu____1968))
in ((FStar_Format.text "try"))::uu____1960)
in (FStar_Format.combine FStar_Format.hardline uu____1957))
end
...
let uu____2052 = (as_uni_op p)
in (FStar_Option.get uu____2052))
in (match (uu____2047) with
| (uu____2063, txt) -> begin
(
...
let uu____2074 = (string_of_mlconstant c)
in (FStar_Format.text uu____2074))
end
...
let for1 = (fun uu____2101 -> (match (uu____2101) with
| (name, p) -> begin
(
...
let uu____2112 = (ptsym currentModule ((path), (name)))
in (FStar_Format.text uu____2112))
in (
...
let uu____2121 = (doc_of_pattern currentModule p)
in (uu____2121)::[])
in ((FStar_Format.text "="))::uu____2118)
in (uu____2111)::uu____2115))
in (FStar_Format.reduce1 uu____2108))
end))
in (

let uu____2122 = (

let uu____2123 = (FStar_List.map for1 fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____2123))
in (FStar_Format.cbrackets uu____2122)))
end
...
let uu____2134 = (is_standard_constructor ctor)
...
let uu____2140 = (as_standard_constructor ctor)
in (FStar_Option.get uu____2140))
in (FStar_Pervasives_Native.snd uu____2135))
end
| uu____2151 -> begin
(ptctor currentModule ctor)
end))
...
let uu____2188 = (doc_of_pattern currentModule x)
in (FStar_Format.parens uu____2188))
in (
...
let uu____2195 = (doc_of_pattern currentModule xs)
in (uu____2195)::[])
in ((FStar_Format.text "::"))::uu____2192)
in (uu____2187)::uu____2189))
in (FStar_Format.reduce uu____2184))
end
| (uu____2196, (FStar_Extraction_ML_Syntax.MLP_Tuple (uu____2197))::[]) -> begin
(
...
let uu____2209 = (FStar_List.hd pats)
in (doc_of_pattern currentModule uu____2209))
in (uu____2208)::[])
in ((FStar_Format.text name))::uu____2205)
in (FStar_Format.reduce1 uu____2202))
end
| uu____2210 -> begin
(
...
let uu____2225 = (FStar_List.map (doc_of_pattern currentModule) pats)
in (FStar_Format.combine (FStar_Format.text ", ") uu____2225))
in (FStar_Format.parens uu____2224))
in (uu____2223)::[])
...
and doc_of_branch : FStar_Extraction_ML_Syntax.mlsymbol  ->  FStar_Extraction_ML_Syntax.mlbranch  ->  FStar_Format.doc = (fun currentModule uu____2249 -> (match (uu____2249) with
| (p, cond, e) -> begin
(
...
let uu____2264 = (doc_of_pattern currentModule p)
in (uu____2264)::[])
in ((FStar_Format.text "|"))::uu____2261)
in (FStar_Format.reduce1 uu____2258))
end
...
let uu____2277 = (doc_of_pattern currentModule p)
in (uu____2277)::((FStar_Format.text "when"))::(c1)::[])
in ((FStar_Format.text "|"))::uu____2274)
in (FStar_Format.reduce1 uu____2271)))
end)
in (

let uu____2278 = (

let uu____2281 = (FStar_Format.reduce1 ((case)::((FStar_Format.text "->"))::((FStar_Format.text "begin"))::[]))
in (

let uu____2282 = (

let uu____2285 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (uu____2285)::((FStar_Format.text "end"))::[])
in (uu____2281)::uu____2282))
in (FStar_Format.combine FStar_Format.hardline uu____2278)))
end))
and doc_of_lets : FStar_Extraction_ML_Syntax.mlsymbol  ->  (FStar_Extraction_ML_Syntax.mlletflavor * Prims.bool * FStar_Extraction_ML_Syntax.mllb Prims.list)  ->  FStar_Format.doc = (fun currentModule uu____2291 -> (match (uu____2291) with
| (rec_, top_level, lets) -> begin
(

let for1 = (fun uu____2310 -> (match (uu____2310) with
| {FStar_Extraction_ML_Syntax.mllb_name = name; FStar_Extraction_ML_Syntax.mllb_tysc = tys; FStar_Extraction_ML_Syntax.mllb_add_unit = uu____2313; FStar_Extraction_ML_Syntax.mllb_def = e; FStar_Extraction_ML_Syntax.mllb_meta = uu____2315; FStar_Extraction_ML_Syntax.print_typ = pt} -> begin
(
...
let for1 = (fun uu____2451 -> (match (uu____2451) with
| (uu____2470, x, mangle_opt, tparams, uu____2474, body) -> begin
(
...
let uu____2500 = (FStar_Format.combine (FStar_Format.text ", ") doc1)
in (FStar_Format.parens uu____2500)))
end)
in (
...
let forfield = (fun uu____2524 -> (match (uu____2524) with
| (name, ty) -> begin
(
...
let uu____2538 = (FStar_List.map forfield fields)
in (FStar_Format.combine (FStar_Format.text "; ") uu____2538))
in (FStar_Format.cbrackets uu____2537)))
end
| FStar_Extraction_ML_Syntax.MLTD_DType (ctors) -> begin
(

let forctor = (fun uu____2571 -> (match (uu____2571) with
| (name, tys) -> begin
(

let uu____2596 = (FStar_List.split tys)
...
let uu____2689 = (FStar_Format.combine (FStar_Format.text " \n and ") doc1)
in (uu____2689)::[])
in ((FStar_Format.text "type"))::uu____2686)
in (FStar_Format.reduce1 uu____2683))
end
| uu____2690 -> begin
(FStar_Format.text "")
end)
...
let uu____2710 = (FStar_Format.reduce1 (((FStar_Format.text "module"))::((FStar_Format.text x))::((FStar_Format.text "="))::[]))
in (

let uu____2711 = (

let uu____2714 = (doc_of_sig currentModule subsig)
in (

let uu____2715 = (

let uu____2718 = (FStar_Format.reduce1 (((FStar_Format.text "end"))::[]))
in (uu____2718)::[])
in (uu____2714)::uu____2715))
in (uu____2710)::uu____2711))
in (FStar_Format.combine FStar_Format.hardline uu____2707))
end
...
let uu____2736 = (FStar_Format.combine (FStar_Format.text " * ") args1)
in (FStar_Format.parens uu____2736))
in (FStar_Format.reduce1 (((FStar_Format.text "exception"))::((FStar_Format.text x))::((FStar_Format.text "of"))::(args2)::[]))))
end
| FStar_Extraction_ML_Syntax.MLS_Val (x, (uu____2738, ty)) -> begin
(
...
let uu____2806 = (FStar_Format.combine (FStar_Format.text " * ") args2)
in (FStar_Format.parens uu____2806))
...
let uu____2829 = (doc_of_expr currentModule ((min_op_prec), (NonAssoc)) e)
in (uu____2829)::[])
in ((FStar_Format.text "="))::uu____2826)
in ((FStar_Format.text "_"))::uu____2823)
in ((FStar_Format.text "let"))::uu____2820)
in (FStar_Format.reduce1 uu____2817))
end
...
| FStar_Extraction_ML_Syntax.MLM_Loc (uu____2853) -> begin
FStar_Format.empty
end
| uu____2854 -> begin
...
let rec doc_of_mllib_r : FStar_Extraction_ML_Syntax.mllib  ->  (Prims.string * FStar_Format.doc) Prims.list = (fun uu____2863 -> (match (uu____2863) with
| FStar_Extraction_ML_Syntax.MLLib (mllib) -> begin
(

let rec for1_sig = (fun uu____2929 -> (match (uu____2929) with
...
let doc1 = (FStar_Option.map (fun uu____3002 -> (match (uu____3002) with
| (s, uu____3008) -> begin
(doc_of_sig x1 s)
end)) sigmod)
in (
...
let uu____3044 = (FStar_Format.reduce sub3)
in (uu____3044)::((FStar_Format.cat tail1 FStar_Format.hardline))::[])
in ((match (doc1) with
| FStar_Pervasives_Native.None -> begin
FStar_Format.empty
end
...
in ((FStar_Format.cat head1 FStar_Format.hardline))::uu____3038)
in (FStar_Format.reduce uu____3035))))))))
end))
and for1_mod = (fun istop uu____3047 -> (match (uu____3047) with
...
in (FStar_Format.reduce1 uu____3126))
in (
...
let doc1 = (FStar_Option.map (fun uu____3148 -> (match (uu____3148) with
| (uu____3153, m) -> begin
...
let uu____3206 = (FStar_Format.reduce sub3)
in (uu____3206)::((FStar_Format.cat tail1 FStar_Format.hardline))::[])
in ((match (doc1) with
| FStar_Pervasives_Native.None -> begin
FStar_Format.empty
end
...
in (FStar_Format.hardline)::uu____3200)
in (FStar_List.append maybe_open_pervasives uu____3197))
in (FStar_List.append ((head1)::(FStar_Format.hardline)::((FStar_Format.text "open Prims"))::[]) uu____3194))
in (FStar_List.append prefix1 uu____3191))
in (FStar_All.pipe_left FStar_Format.reduce uu____3188))))))))))
end))
in (

let docs = (FStar_List.map (fun uu____3245 -> (match (uu____3245) with
| (x, s, m) -> begin
(
...
let uu____3296 = (for1_mod true ((x), (s), (m)))
in ((uu____3295), (uu____3296))))
end)) mllib)
in docs))
end))
...
let uu____3325 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_expr uu____3325 ((min_op_prec), (NonAssoc)) e))
...
let uu____3337 = (FStar_Extraction_ML_Util.flatten_mlpath cmod)
in (doc_of_mltype uu____3337 ((min_op_prec), (NonAssoc)) e))
in (FStar_Format.pretty (Prims.parse_int "0") doc1)))
