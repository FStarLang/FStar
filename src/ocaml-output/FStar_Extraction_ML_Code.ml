...
let escape_or : (FStar_Char.char  ->  Prims.string)  ->  FStar_Char.char  ->  Prims.string = (fun fallback uu___148_1049 -> (match (uu___148_1049) with
...
let uu____1336 = (FStar_Format.reduce docs1)
...
let uu____1484 = (FStar_Format.combine (FStar_Format.text ", ") docs)
...
let docs = (FStar_List.map (fun uu____3253 -> (match (uu____3253) with
| (x, s, m) -> begin
(
