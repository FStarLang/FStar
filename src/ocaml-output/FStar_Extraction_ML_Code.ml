...
let ptsym_of_symbol :
  ...
  fun s  ->
    ...
    match uu____208 with | true  -> Prims.strcat "l__" s | uu____212 -> s
    ...
    | (ns,x) ->
        (match is_prims_ns ns with
         | true  ->
             FStar_List.tryFind
               (fun uu____480  ->
                  match uu____480 with | (y,uu____484) -> x = y) prim_uni_ops
         | uu____485 -> None)
    ...
    | (ns,x) ->
        (match is_prims_ns ns with
         | true  ->
             FStar_List.tryFind
               (fun uu____521  ->
                  match uu____521 with | (y,uu____525) -> x = y)
               prim_constructors
         | uu____526 -> None)
      ...
      fun doc  ->
        ...
        | (outer,side) ->
            ...
            (match noparens inner outer side with
             | true  -> doc
             | uu____599 -> FStar_Format.parens doc)
      ...
      fun ty  ->
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Top  ->
            ...
            (match uu____736 with
             ...
             | uu____737 -> FStar_Format.text "Obj.t")
      ...
      fun e  ->
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,[]) ->
            let name =
              ...
              | true  ->
                  ...
                  Prims.snd uu____845
              | uu____854 -> ptctor currentModule ctor  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            let name =
              ...
              | true  ->
                  ...
                  Prims.snd uu____861
              | uu____870 -> ptctor currentModule ctor  in
            let args =
              FStar_List.map
        ...
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,uu____901,lets),body) ->
            let pre =
              ...
              | uu____916 -> FStar_Format.empty  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Fun (ids,body) ->
            let bvar_annot x xt =
              ...
              | uu____1091 -> FStar_Format.text x  in
            let ids =
              FStar_List.map
                (fun uu____1098  ->
    ...
    fun pattern  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,[]) ->
          let name =
            ...
            | uu____1336 -> ptctor currentModule ctor  in
          FStar_Format.text name
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          let name =
            ...
            | uu____1352 -> ptctor currentModule ctor  in
          let doc =
    ...
    fun uu____1433  ->
      ...
      | (rec_,top_level,lets) ->
          ...
          let letdoc =
            ...
            | uu____1514 -> FStar_Format.text "let"  in
                 ...
                 fun doc  ->
                   FStar_Format.reduce1
                     [(match i = (Prims.parse_int "0") with
                       | true  -> letdoc
                       | uu____1521 -> FStar_Format.text "and");
                     doc]) lets
             in
              ...
              let uu____1878 =
                let uu____1880 =
                  let uu____1882 =
                    ...
                    [uu____1884; FStar_Format.cat tail FStar_Format.hardline]
                     in
                  (match doc with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1882
                   in
                (FStar_Format.cat head FStar_Format.hardline) :: uu____1880
                 in
        ...
        and for1_mod istop uu____1887 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              let tail =
                ...
                | uu____1929 -> FStar_Format.reduce1 []  in
              let doc =
                FStar_Option.map
                  (fun uu____1934  ->
