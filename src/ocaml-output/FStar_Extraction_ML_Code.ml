...
# 223 "FStar.Extraction.ML.Code.fst"
...
# 276 "FStar.Extraction.ML.Code.fst"
...
let lets = (FStar_List.mapi (fun i doc -> (let _167_415 = (let _167_414 = if (i = 0) then begin
letdoc
end else begin
...
# 781 "FStar.Extraction.ML.Code.fst"
...
# 784 "FStar.Extraction.ML.Code.fst"
...
# 788 "FStar.Extraction.ML.Code.fst"
