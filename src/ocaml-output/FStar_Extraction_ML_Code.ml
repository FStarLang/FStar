...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1230, FStar_Const.Int16)) ->
        s
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named (args, name) ->
            let args1 =
              ...
              | uu____1324 ->
                  ...
                  FStar_Format.parens uu____1334 in
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor, args) ->
            ...
            let doc1 =
              ...
              | (uu____1586, uu____1587) ->
                  ...
                  FStar_Format.reduce1 uu____1592 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   FStar_Format.parens uu____1609) es in
            let docs1 =
              let uu____1615 =
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1793;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1807;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1846 =
                   ...
                   e2 :: uu____1849 in
                 FStar_Format.reduce uu____1846) in
            doc1
                ...
                let uu____2101 =
                  let uu____2104 =
                    let uu____2107 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____2108 in
                    [uu____2107] in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path, fields) ->
          let for1 uu____2236 =
            ...
            | (name, p) ->
                ...
                FStar_Format.reduce1 uu____2243 in
          let uu____2257 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor, pats) ->
          ...
          let doc1 =
            ...
            | uu____2345 ->
                ...
                FStar_Format.reduce1 uu____2352 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____2373 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (p, cond, e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____2406 in
          let uu____2413 =
            let uu____2416 =
              FStar_Format.reduce1
      ...
      | (rec_, top_level, lets) ->
          let for1 uu____2447 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                FStar_Format.reduce1 uu____2535 in
          let letdoc =
        ...
        | (uu____2613, x, mangle_opt, tparams, uu____2617, body) ->
            ...
            let tparams1 =
              ...
              | uu____2635 ->
                  ...
                  let uu____2643 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____2643 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2684 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2685 in
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____2806 =
                   ...
                   [uu____2809; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____2806) in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3175 ->
                     ...
                     | (s, uu____3181) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____3211 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3214 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3211 in
        ...
        and for1_mod istop uu____3220 =
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3299 =
                  let uu____3302 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____3302
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3321 ->
                     ...
                     | (uu____3326, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____3357 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____3357
                then
              ...
              let uu____3361 =
                let uu____3364 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3367 in
                FStar_List.append prefix1 uu____3364 in
              FStar_All.pipe_left FStar_Format.reduce uu____3361 in
        let docs =
          FStar_List.map
            (fun uu____3418 ->
               match uu____3418 with
               | (x, s, m) ->
                   let uu____3468 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____3469 = for1_mod true (x, s, m) in
                   (uu____3468, uu____3469)) mllib in
        docs
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string, FStar_Format.doc) FStar_Pervasives_Native.tuple2
