    ...
    fun outer  ->
      fun ty  ->
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Tuple tys ->
            ...
            let doc1 =
              let uu____2089 =
                let uu____2090 = combine (text " * ") doc  in hbox uu____2090
                 in
    ...
    fun outer  ->
      fun e  ->
        ...
        | FStar_Extraction_ML_Syntax.MLE_Coerce (e1,t,t') ->
            ...
            if uu____2225
            then
              let uu____2228 = reduce [text "Prims.unsafe_coerce "; doc]  in
              parens uu____2228
            else
              (let uu____2232 = reduce [text "Obj.magic "; parens doc]  in
               parens uu____2232)
        ...
        | (uu____3558,x,mangle_opt,tparams,uu____3562,body) ->
            ...
            let tparams1 =
              ...
              | uu____3597 ->
                  ...
                  let uu____3608 = combine (text ", ") doc  in
                  parens uu____3608
               in
            let forbody body1 =
              match body1 with
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____3791 =
                   let uu____3794 = reduce1 [doc; text "="]  in
                   [uu____3794; body2]  in
...
let (pretty : Prims.int -> doc -> Prims.string) =
  fun sz  -> fun uu____4528  -> match uu____4528 with | Doc doc -> doc 
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib -> (Prims.string * doc) Prims.list) =
