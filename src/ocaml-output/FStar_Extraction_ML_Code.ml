...
let string_of_mlconstant :
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Char c ->
        let _0_244 =
          let _0_243 = escape_or escape_char_hex c  in
          Prims.strcat _0_243 "'"  in
        Prims.strcat "'" _0_244
    ...
    fun outer  ->
      fun e  ->
        ...
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,uu____819,lets),body) ->
            let pre =
              ...
              then
                FStar_Format.reduce
                  (let _0_256 =
                     let _0_255 = doc_of_loc e.FStar_Extraction_ML_Syntax.loc
                        in
                     [_0_255]  in
             ...
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____844;_}::{
                                                                    ...
                                                                    uu____849;_}::[])
                 when
                 let _0_261 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                    in
            ...
            let doc =
              ...
              then
                ...
                FStar_Format.reduce
                  (let _0_266 =
                     let _0_265 =
                       let _0_264 = FStar_Format.text (ptsym currentModule f)
                          in
                       [_0_264]  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,[]) ->
            FStar_Format.reduce1
              (let _0_288 =
                 let _0_287 = FStar_Format.text (ptctor currentModule exn)
                    in
                 [_0_287]  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            FStar_Format.reduce1
              (let _0_292 =
                 let _0_291 = FStar_Format.text (ptctor currentModule exn)
                    in
                 let _0_290 =
                   let _0_289 =
                     FStar_Format.parens
      ...
      | (p,cond,e) ->
          let case =
            ...
            | None  ->
                FStar_Format.reduce1
                  (let _0_316 =
                     let _0_315 = doc_of_pattern currentModule p  in [_0_315]
                      in
            ...
            (match body with
             ...
             | Some body ->
                 ...
                 let _0_330 =
                   ...
                   [_0_329; body]  in
                 FStar_Format.combine FStar_Format.hardline _0_330)
         in
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let _0_338 =
            ...
            let _0_336 =
              ...
              let _0_334 =
                let _0_333 = FStar_Format.reduce1 [FStar_Format.text "end"]
                   in
                [_0_333]  in
              _0_335 :: _0_334  in
            _0_337 :: _0_336  in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              FStar_Format.reduce
                (let _0_345 =
                   let _0_344 =
                     ...
                     [_0_343; FStar_Format.cat tail FStar_Format.hardline]
                      in
                   (match doc with
        ...
        and for1_mod istop uu____1584 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              FStar_All.pipe_left FStar_Format.reduce _0_353
         in
        let docs =
          FStar_List.map
            (fun uu____1670  ->
