    ...
    fun x ->
      ...
      | uu____331 ->
          ...
          (match uu____332 with
           | (ns, x1) ->
               let uu____339 = path_of_ns currentModule ns in (uu____339, x1))
let (ptsym_of_symbol :
...
let (infix_prim_ops :
  (Prims.string, (Prims.int, fixity) FStar_Pervasives_Native.tuple2,
    Prims.string) FStar_Pervasives_Native.tuple3 Prims.list)
  =
...
let (as_bin_op :
  FStar_Extraction_ML_Syntax.mlpath ->
    (FStar_Extraction_ML_Syntax.mlsymbol,
      (Prims.int, fixity) FStar_Pervasives_Native.tuple2, Prims.string)
                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1092, uu____1093) -> false))) in
                ...
                then "\\n"
                  ...
                  then "\\'"
                    ...
                    then "\\\""
                      ...
                      if FStar_Util.is_letter_or_digit uu___266_1123
                      then FStar_Util.string_of_char uu___266_1123
                      else
                        if FStar_Util.is_punctuation uu___266_1123
                        then FStar_Util.string_of_char uu___266_1123
                        else
                          if FStar_Util.is_symbol uu___266_1123
                          then FStar_Util.string_of_char uu___266_1123
                          else fallback uu___266_1123
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1211, FStar_Const.Int16)) ->
        s
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named (args, name) ->
            let args1 =
              ...
              | uu____1298 ->
                  ...
                  FStar_Format.parens uu____1304 in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path, fields) ->
            let for1 uu____1452 =
              ...
              | (name, e1) ->
                  ...
                  FStar_Format.reduce1 uu____1460 in
            let uu____1467 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor, args) ->
            ...
            let doc1 =
              ...
              | (uu____1532, uu____1533) ->
                  ...
                  FStar_Format.reduce1 uu____1538 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   FStar_Format.parens uu____1555) es in
            let docs1 =
              let uu____1557 =
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____1671;_},
                          branches);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1731;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1745;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1772 =
                   ...
                   e2 :: uu____1775 in
                 FStar_Format.reduce uu____1772) in
            doc1
                ...
                let uu____1999 =
                  let uu____2002 =
                    let uu____2005 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____2006 in
                    [uu____2005] in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path, fields) ->
          let for1 uu____2130 =
            ...
            | (name, p) ->
                ...
                FStar_Format.reduce1 uu____2137 in
          let uu____2151 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor, pats) ->
          ...
          let doc1 =
            ...
            | uu____2239 ->
                ...
                FStar_Format.reduce1 uu____2246 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____2267 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (p, cond, e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____2296 in
          let uu____2303 =
            let uu____2306 =
              FStar_Format.reduce1
        ...
        | (uu____2453, x, mangle_opt, tparams, uu____2457, body) ->
            ...
            let tparams1 =
              ...
              | uu____2475 ->
                  ...
                  let uu____2483 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____2483 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2516 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2517 in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____2941 ->
                     ...
                     | (s, uu____2947) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____2971 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____2974 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____2971 in
        ...
        and for1_mod istop uu____2980 =
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3059 =
                  let uu____3062 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____3062
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3081 ->
                     ...
                     | (uu____3086, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              ...
              let uu____3115 =
                let uu____3118 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3121 in
                FStar_List.append prefix1 uu____3118 in
              FStar_All.pipe_left FStar_Format.reduce uu____3115 in
        let docs =
          FStar_List.map
            (fun uu____3172 ->
               match uu____3172 with
               | (x, s, m) ->
                   let uu____3222 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____3223 = for1_mod true (x, s, m) in
                   (uu____3222, uu____3223)) mllib in
        docs
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string, FStar_Format.doc) FStar_Pervasives_Native.tuple2
