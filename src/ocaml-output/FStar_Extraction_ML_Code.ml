      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____2076 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____2083 in
          let uu____2097 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          ...
          let doc1 =
            ...
            | uu____2185 ->
                ...
                FStar_Format.reduce1 uu____2192 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____2213 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____2285 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let uu____2372 =
                  let uu____2375 =
                    let uu____2376 = FStar_Extraction_ML_Syntax.idsym name in
                ...
                FStar_Format.reduce1 uu____2372 in
          let letdoc =
            ...
            let tparams1 =
              ...
              | uu____2471 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____2480 = FStar_Extraction_ML_Syntax.idsym x2 in
                         FStar_Format.text uu____2480) tparams in
                  let uu____2481 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____2481 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2518 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2519 in
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____2638 =
                   ...
                   [uu____2641; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____2638) in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____2989  ->
                     ...
                     | (s,uu____2995) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____3025 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3028 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3025 in
        ...
        and for1_mod istop uu____3034 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3113 =
                  let uu____3116 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____3116
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3135  ->
                     ...
                     | (uu____3140,m) -> doc_of_mod target_mod_name m) sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____3171 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____3171
                then
              ...
              let uu____3175 =
                let uu____3178 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3181 in
                FStar_List.append prefix1 uu____3178 in
              FStar_All.pipe_left FStar_Format.reduce uu____3175 in
        let docs1 =
          FStar_List.map
            (fun uu____3232  ->
               match uu____3232 with
               | (x,s,m) ->
                   let uu____3282 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____3283 = for1_mod true (x, s, m) in
                   (uu____3282, uu____3283)) mllib in
        docs1
let doc_of_mllib:
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string,FStar_Format.doc) FStar_Pervasives_Native.tuple2 Prims.list
