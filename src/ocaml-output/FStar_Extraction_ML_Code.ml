...
let escape_or : (FStar_Char.char  ->  Prims.string)  ->  FStar_Char.char  ->  Prims.string = (fun fallback uu___121_614 -> (match (uu___121_614) with
| c when (c = '\\') -> begin
"\\\\"
end
| c when (c = ' ') -> begin
...
let uu____801 = (FStar_Format.reduce docs2)
...
let uu____899 = (FStar_Format.combine (FStar_Format.text ", ") docs1)
...
let docs1 = (FStar_List.map (fun uu____1990 -> (match (uu____1990) with
| (x, s, m) -> begin
(
