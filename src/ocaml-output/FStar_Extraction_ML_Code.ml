      ...
      | (rec_,top_level,lets) ->
          let for1 uu____1457 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let ids1 =
                  FStar_List.map
                    (fun uu____1477  ->
                       ...
                       | (x,uu____1481) -> FStar_Format.text x) ids in
                let ty_annot =
                  ...
                  then FStar_Format.text ""
                    ...
                    (let uu____1484 =
                     ...
                     then
                       match tys with
                       | Some (uu____1485::uu____1486,uu____1487) ->
                           FStar_Format.text ""
                       ...
                       then
                         (match tys with
                          | None  -> FStar_Format.text ""
                          | Some (uu____1502::uu____1503,uu____1504) ->
                              FStar_Format.text ""
                          | Some ([],ty) ->
                              let ty1 =
                                doc_of_mltype currentModule
                ...
                let uu____1519 =
                  let uu____1521 =
                    let uu____1522 = FStar_Extraction_ML_Syntax.idsym name in
                    FStar_Format.text uu____1522 in
                  let uu____1523 =
                    let uu____1525 = FStar_Format.reduce1 ids1 in
                    [uu____1525; ty_annot; FStar_Format.text "="; e1] in
                  uu____1521 :: uu____1523 in
                FStar_Format.reduce1 uu____1519 in
          let letdoc =
  ...
  fun currentModule  ->
    fun decls  ->
      let for1 uu____1558 =
        ...
        | (uu____1567,x,mangle_opt,tparams,body) ->
            let x1 = match mangle_opt with | None  -> x | Some y -> y in
            let tparams1 =
              match tparams with
              | [] -> FStar_Format.empty
              | x2::[] ->
                  let uu____1582 = FStar_Extraction_ML_Syntax.idsym x2 in
                  FStar_Format.text uu____1582
              | uu____1583 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____1588 = FStar_Extraction_ML_Syntax.idsym x2 in
                         FStar_Format.text uu____1588) tparams in
                  let uu____1589 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____1589 in
            let forbody body1 =
              match body1 with
              | FStar_Extraction_ML_Syntax.MLTD_Abbrev ty ->
                  doc_of_mltype currentModule (min_op_prec, NonAssoc) ty
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  let forfield uu____1606 =
            ...
            let doc1 =
              let uu____1678 =
                let uu____1680 =
                  let uu____1682 =
                    let uu____1683 = ptsym currentModule ([], x1) in
                    FStar_Format.text uu____1683 in
                  [uu____1682] in
                tparams1 :: uu____1680 in
              FStar_Format.reduce1 uu____1678 in
            (match body with
             | None  -> doc1
             | Some body1 ->
                 ...
                 let uu____1687 =
                   ...
                   [uu____1689; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____1687) in
          ...
          let uu____1707 =
            let uu____1709 =
              let uu____1711 =
                FStar_Format.combine (FStar_Format.text " \n and ") doc1 in
              [uu____1711] in
            (FStar_Format.text "type") :: uu____1709 in
          FStar_Format.reduce1 uu____1707
        else FStar_Format.text "" in
      doc2
let rec doc_of_sig1:
  FStar_Extraction_ML_Syntax.mlsymbol ->
    ...
    fun s  ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let uu____1727 =
            ...
            let uu____1730 =
              let uu____1732 = doc_of_sig currentModule subsig in
              let uu____1733 =
                let uu____1735 =
          ...
          FStar_Format.combine FStar_Format.hardline uu____1727
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x,args) ->
          ...
          let args2 =
            let uu____1747 =
              FStar_Format.combine (FStar_Format.text " * ") args1 in
            FStar_Format.parens uu____1747 in
          FStar_Format.reduce1
            [FStar_Format.text "exception";
            FStar_Format.text x;
            FStar_Format.text "of";
            args2]
      | FStar_Extraction_ML_Syntax.MLS_Val (x,(uu____1749,ty)) ->
    ...
    fun m  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Exn (x,args) ->
          ...
          let args3 =
            ...
            FStar_Format.parens uu____1793 in
          FStar_Format.reduce1
            [FStar_Format.text "exception";
            FStar_Format.text x;
            FStar_Format.text "of";
      ...
      | FStar_Extraction_ML_Syntax.MLM_Ty decls ->
          doc_of_mltydecl currentModule decls
      | FStar_Extraction_ML_Syntax.MLM_Let (rec_,uu____1796,lets) ->
              ...
              let uu____1806 =
                let uu____1808 =
                  let uu____1810 =
                    doc_of_expr currentModule (min_op_prec, NonAssoc) e in
                  [uu____1810] in
                (FStar_Format.text "=") :: uu____1808 in
              (FStar_Format.text "_") :: uu____1806 in
            (FStar_Format.text "let") :: uu____1804 in
          FStar_Format.reduce1 uu____1802
      ...
      let docs1 =
        FStar_List.map
          (fun x  ->
             ...
             [doc1;
             (match x with
              | FStar_Extraction_ML_Syntax.MLM_Loc uu____1826 ->
                  FStar_Format.empty
              | uu____1827 -> FStar_Format.hardline);
        ...
        let rec for1_sig uu____1871 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1910  ->
                     ...
                     | (s,uu____1914) -> doc_of_sig x1 s) sigmod in
              ...
              let uu____1929 =
                let uu____1931 =
                  let uu____1933 =
                    let uu____1935 = FStar_Format.reduce sub3 in
                    [uu____1935;
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1933 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1931 in
              FStar_Format.reduce uu____1929
        and for1_mod istop uu____1938 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____1982 =
                  let uu____1984 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____1984
                  then
                    [FStar_Format.text "module";
                ...
                FStar_Format.reduce1 uu____1982 in
              let tail1 =
                if Prims.op_Negation istop
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1995  ->
                     ...
                     | (uu____1998,m) -> doc_of_mod target_mod_name m) sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____2016 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____2016
                then
                ...
                let uu____2021 =
                  let uu____2023 =
                    let uu____2025 =
                      let uu____2027 =
                        let uu____2029 =
                          let uu____2031 = FStar_Format.reduce sub3 in
                          [uu____2031;
                          FStar_Format.cat tail1 FStar_Format.hardline] in
                        (match doc1 with
                         | None  -> FStar_Format.empty
                         | Some s -> FStar_Format.cat s FStar_Format.hardline)
                          :: uu____2029 in
                      FStar_Format.hardline :: uu____2027 in
                    FStar_List.append maybe_open_pervasives uu____2025 in
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____2023 in
                FStar_List.append prefix1 uu____2021 in
              FStar_All.pipe_left FStar_Format.reduce uu____2019 in
        let docs1 =
          FStar_List.map
            (fun uu____2049  ->
               match uu____2049 with
               | (x,s,m) ->
                   let uu____2076 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____2077 = for1_mod true (x, s, m) in
                   (uu____2076, uu____2077)) mllib in
        docs1
let doc_of_mllib:
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string* FStar_Format.doc) Prims.list
...
let string_of_mlexpr:
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        let uu____2097 = FStar_Extraction_ML_Util.flatten_mlpath cmod in
        doc_of_expr uu____2097 (min_op_prec, NonAssoc) e in
...
let string_of_mlty:
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        let uu____2107 = FStar_Extraction_ML_Util.flatten_mlpath cmod in
        doc_of_mltype uu____2107 (min_op_prec, NonAssoc) e in
      FStar_Format.pretty (Prims.parse_int "0") doc1