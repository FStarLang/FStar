        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path,fields) ->
            let for1 uu____825 =
              ...
              | (name,e1) ->
                  ...
                  FStar_Format.reduce1 uu____833
               in
            let uu____838 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            ...
            let doc1 =
              ...
              | (uu____882,uu____883) ->
                  ...
                  FStar_Format.reduce1 uu____886
               in
            ...
            let docs1 =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____897) es
               in
            let docs2 =
              let uu____901 =
                ...
                p,{
                 ...
                 let branches =
                   ...
                   | {
                       ...
                       let uu____992 = FStar_Extraction_ML_Syntax.idsym arg
                          in
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1052 =
                   ...
                   e2 :: uu____1054  in
                 FStar_Format.reduce uu____1052)
               in
            doc1
            ...
            let ids1 =
              FStar_List.map
                (fun uu____1100  ->
                   ...
                   | ((x,uu____1106),xt) -> bvar_annot x (Some xt)) ids
               in
            let body1 =
              doc_of_expr currentModule (min_op_prec, NonAssoc) body  in
            let doc1 =
                ...
                let uu____1224 =
                  let uu____1226 =
                    let uu____1228 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____1229
                       in
                    [uu____1228]  in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____1305 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____1310
             in
          let uu____1320 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          ...
          let doc1 =
            ...
            | uu____1379 ->
                ...
                FStar_Format.reduce1 uu____1383
             in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps  in
          let uu____1397 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____1448 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let ids1 =
                  FStar_List.map
                    (fun uu____1468  ->
                       ...
                       | (x,uu____1472) -> FStar_Format.text x) ids
                   in
                let ty_annot =
                  ...
                  then FStar_Format.text ""
                    ...
                    (let uu____1475 =
                     ...
                     then
                       match tys with
                       | Some (uu____1476::uu____1477,uu____1478) ->
                           FStar_Format.text ""
                       ...
                       then
                         (match tys with
                          | None  -> FStar_Format.text ""
                          | Some (uu____1493::uu____1494,uu____1495) ->
                              FStar_Format.text ""
                          | Some ([],ty) ->
                              let ty1 =
                                doc_of_mltype currentModule
                ...
                let uu____1510 =
                  let uu____1512 =
                    let uu____1513 = FStar_Extraction_ML_Syntax.idsym name
                       in
        ...
        | (uu____1558,x,mangle_opt,tparams,body) ->
            ...
            let tparams1 =
              ...
              | uu____1574 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____1579 = FStar_Extraction_ML_Syntax.idsym x2
                            in
                         FStar_Format.text uu____1579) tparams
                     in
                  let uu____1580 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
            ...
            let forbody body1 =
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____1606 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____1607
                     in
                  FStar_Format.cbrackets uu____1606
              | FStar_Extraction_ML_Syntax.MLTD_DType ctors ->
                  let forctor uu____1626 =
                    match uu____1626 with
                    | (name,tys) ->
                        let uu____1640 = FStar_List.split tys  in
            ...
            let doc1 =
              let uu____1669 =
                let uu____1671 =
                  let uu____1673 =
                    let uu____1674 = ptsym currentModule ([], x1)  in
                    FStar_Format.text uu____1674  in
                  [uu____1673]  in
                tparams1 :: uu____1671  in
              FStar_Format.reduce1 uu____1669  in
            (match body with
             | None  -> doc1
             | Some body1 ->
                 ...
                 let uu____1678 =
                   ...
                   [uu____1680; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____1678)
         in
          ...
          let uu____1695 =
            let uu____1697 =
              let uu____1699 =
                FStar_Format.combine (FStar_Format.text " \n and ") doc1  in
              [uu____1699]  in
            (FStar_Format.text "type") :: uu____1697  in
          FStar_Format.reduce1 uu____1695
  ...
  fun currentModule  ->
    fun s  ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let uu____1715 =
            let uu____1717 =
              FStar_Format.reduce1
               ...
               in
            let uu____1718 =
              let uu____1720 = doc_of_sig currentModule subsig  in
              let uu____1721 =
                let uu____1723 =
          ...
          FStar_Format.combine FStar_Format.hardline uu____1715
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x,args) ->
          ...
          let args2 =
            let uu____1735 =
              FStar_Format.combine (FStar_Format.text " * ") args1  in
            FStar_Format.parens uu____1735  in
          FStar_Format.reduce1
            [FStar_Format.text "exception";
            FStar_Format.text x;
            FStar_Format.text "of";
            args2]
      | FStar_Extraction_ML_Syntax.MLS_Val (x,(uu____1737,ty)) ->
    ...
    fun m  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Exn (x,args) ->
          ...
          let args3 =
            ...
            FStar_Format.parens uu____1781  in
          FStar_Format.reduce1
            [FStar_Format.text "exception";
            FStar_Format.text x;
            FStar_Format.text "of";
      ...
      | FStar_Extraction_ML_Syntax.MLM_Ty decls ->
          doc_of_mltydecl currentModule decls
      | FStar_Extraction_ML_Syntax.MLM_Let (rec_,uu____1784,lets) ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Top e ->
          let uu____1790 =
            let uu____1792 =
              ...
              (FStar_Format.text "_") :: uu____1794  in
            (FStar_Format.text "let") :: uu____1792  in
          FStar_Format.reduce1 uu____1790
      ...
      let docs1 =
        FStar_List.map
          (fun x  ->
             ...
             [doc1;
             (match x with
              | FStar_Extraction_ML_Syntax.MLM_Loc uu____1814 ->
                  FStar_Format.empty
              | uu____1815 -> FStar_Format.hardline);
        ...
        let rec for1_sig uu____1859 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1898  ->
                     ...
                     | (s,uu____1902) -> doc_of_sig x1 s) sigmod
                 in
              ...
              let uu____1917 =
                let uu____1919 =
                  let uu____1921 =
                    let uu____1923 = FStar_Format.reduce sub3  in
                    [uu____1923;
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1921
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1919
                 in
              FStar_Format.reduce uu____1917
        
        and for1_mod istop uu____1926 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____1970 =
                  let uu____1972 = FStar_Extraction_ML_Util.codegen_fsharp ()
                     in
                  if uu____1972
                  then
                    [FStar_Format.text "module";
                   ...
                   in
                FStar_Format.reduce1 uu____1970  in
              let tail1 =
                if Prims.op_Negation istop
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1983  ->
                     ...
                     | (uu____1986,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____2004 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____2004
                then
                ...
                let uu____2009 =
                  let uu____2011 =
                    let uu____2013 =
                      let uu____2015 =
                        let uu____2017 =
                          let uu____2019 = FStar_Format.reduce sub3  in
                          [uu____2019;
                          FStar_Format.cat tail1 FStar_Format.hardline]  in
                        (match doc1 with
                         | None  -> FStar_Format.empty
                         | Some s -> FStar_Format.cat s FStar_Format.hardline)
                          :: uu____2017
                         in
                      FStar_Format.hardline :: uu____2015  in
                    FStar_List.append maybe_open_pervasives uu____2013  in
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____2011
                   in
                FStar_List.append prefix1 uu____2009  in
              FStar_All.pipe_left FStar_Format.reduce uu____2007
         in
        let docs1 =
          FStar_List.map
            (fun uu____2037  ->
               ...
               | (x,s,m) ->
                   let uu____2064 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____2065 = for1_mod true (x, s, m)  in
                   (uu____2064, uu____2065)) mllib
           in
        docs1
...
let string_of_mlexpr :
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        let uu____2085 = FStar_Extraction_ML_Util.flatten_mlpath cmod  in
        doc_of_expr uu____2085 (min_op_prec, NonAssoc) e  in
...
let string_of_mlty :
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        let uu____2095 = FStar_Extraction_ML_Util.flatten_mlpath cmod  in
        doc_of_mltype uu____2095 (min_op_prec, NonAssoc) e  in
      FStar_Format.pretty (Prims.parse_int "0") doc1
