                ...
                then "\\n"
                  ...
                  then "\\'"
                    ...
                    then "\\\""
                      ...
                      if FStar_Util.is_letter_or_digit uu___274_1120
                      then FStar_Util.string_of_char uu___274_1120
                      else
                        if FStar_Util.is_punctuation uu___274_1120
                        then FStar_Util.string_of_char uu___274_1120
                        else
                          if FStar_Util.is_symbol uu___274_1120
                          then FStar_Util.string_of_char uu___274_1120
                          else fallback uu___274_1120
