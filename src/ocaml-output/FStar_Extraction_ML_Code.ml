                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1023, uu____1024) -> false))) in
...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1151, FStar_Const.Int16)) ->
        s
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____1604;_},
                          branches);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____1678;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1717 =
                   ...
                   e2 :: uu____1720 in
                 FStar_Format.reduce uu____1717) in
            doc1
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path, fields) ->
          let for1 uu____2101 =
            ...
            | (name, p) ->
                ...
                FStar_Format.reduce1 uu____2108 in
          let uu____2122 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor, pats) ->
          ...
          let doc1 =
            ...
            | uu____2210 ->
                ...
                FStar_Format.reduce1 uu____2217 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____2238 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (p, cond, e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____2271 in
          let uu____2278 =
            let uu____2281 =
              FStar_Format.reduce1
        ...
        | (uu____2470, x, mangle_opt, tparams, uu____2474, body) ->
            ...
            let tparams1 =
              ...
              | uu____2492 ->
                  ...
                  let uu____2500 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____2500 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____2537 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____2538 in
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____2657 =
                   ...
                   [uu____2660; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____2657) in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3002 ->
                     ...
                     | (s, uu____3008) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____3038 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3041 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3038 in
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3148 ->
                     ...
                     | (uu____3153, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____3184 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____3184
                then
              ...
              let uu____3188 =
                let uu____3191 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3194 in
                FStar_List.append prefix1 uu____3191 in
              FStar_All.pipe_left FStar_Format.reduce uu____3188 in
        let docs =
          FStar_List.map
            (fun uu____3245 ->
               match uu____3245 with
               | (x, s, m) ->
                   let uu____3295 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____3296 = for1_mod true (x, s, m) in
                   (uu____3295, uu____3296)) mllib in
        docs
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string, FStar_Format.doc) FStar_Pervasives_Native.tuple2
