...
let (uu___is_IRight : assoc -> Prims.bool) =
  fun projectee -> match projectee with | IRight -> true | uu____19 -> false
...
let (uu___is_Prefix : fixity -> Prims.bool) =
  fun projectee -> match projectee with | Prefix -> true | uu____68 -> false
let (uu___is_Postfix : fixity -> Prims.bool) =
  fun projectee -> match projectee with | Postfix -> true | uu____79 -> false
    ...
    fun x ->
      ...
      | uu____504 ->
          ...
          (match uu____506 with
           | (ns, x1) ->
               let uu____517 = path_of_ns currentModule ns in (uu____517, x1))
let (ptsym_of_symbol :
                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1660, uu____1661) -> false))) in
...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1803, FStar_Const.Int16)) ->
        s
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named (args, name) ->
            let args1 =
              ...
              | uu____1919 ->
                  ...
                  FStar_Format.parens uu____1925 in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path, fields) ->
            let for1 uu____2106 =
              ...
              | (name, e1) ->
                  ...
                  FStar_Format.reduce1 uu____2117 in
            let uu____2128 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor, args) ->
            ...
            let doc1 =
              ...
              | (uu____2225, uu____2226) ->
                  ...
                  FStar_Format.reduce1 uu____2233 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   FStar_Format.parens uu____2251) es in
            let docs1 =
              let uu____2253 =
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2447;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2461;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____2494 =
                   ...
                   e2 :: uu____2497 in
                 FStar_Format.reduce uu____2494) in
            doc1
                ...
                let uu____2758 =
                  let uu____2761 =
                    let uu____2764 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____2765 in
                    [uu____2764] in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path, fields) ->
          let for1 uu____2927 =
            ...
            | (name, p) ->
                ...
                FStar_Format.reduce1 uu____2937 in
          let uu____2955 =
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor, pats) ->
          ...
          let doc1 =
            ...
            | uu____3077 ->
                ...
                FStar_Format.reduce1 uu____3085 in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps in
          let uu____3108 = FStar_Format.combine (FStar_Format.text ", ") ps1 in
      ...
      | (p, cond, e) ->
          let case =
            ...
            | FStar_Pervasives_Native.Some c ->
                ...
                FStar_Format.reduce1 uu____3141 in
          let uu____3150 =
            let uu____3153 =
              FStar_Format.reduce1
      ...
      | (rec_, top_level, lets) ->
          let for1 uu____3187 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                FStar_Format.reduce1 uu____3256 in
          let letdoc =
        ...
        | (uu____3370, x, mangle_opt, tparams, uu____3374, body) ->
            ...
            let tparams1 =
              ...
              | uu____3409 ->
                  ...
                  let uu____3420 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1 in
                  FStar_Format.parens uu____3420 in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____3460 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____3461 in
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____3603 =
                   ...
                   [uu____3606; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____3603) in
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3975 ->
                     ...
                     | (s, uu____3981) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____4005 =
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____4008 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____4005 in
          ...
          | (mod_name1, sigmod, FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let maybe_open_pervasives =
                ...
                | uu____4096 ->
                    ...
                    FStar_Format.text (Prims.op_Hat "open " pervasives1)] in
              let head1 =
                let uu____4117 =
                  let uu____4120 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____4120
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____4151 ->
                     ...
                     | (uu____4156, m) -> doc_of_mod target_mod_name m)
                  sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____4182 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____4182
                then
              ...
              let uu____4190 =
                let uu____4193 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____4196 in
                FStar_List.append prefix1 uu____4193 in
              FStar_All.pipe_left FStar_Format.reduce uu____4190 in
        let docs =
          FStar_List.map
            (fun uu____4252 ->
               match uu____4252 with
               | (x, s, m) ->
                   let uu____4309 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____4311 = for1_mod true (x, s, m) in
                   (uu____4309, uu____4311)) mllib in
        docs
let (doc_of_mllib :
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string * FStar_Format.doc) Prims.list)
