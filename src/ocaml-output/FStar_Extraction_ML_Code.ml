                   ...
                   | (po, fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (uu____1839, uu____1840) -> false))) in
...
let (string_of_mlconstant :
  ...
  fun sctt ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some (uu____1984, FStar_Const.Int16)) ->
        s
    ...
    fun outer ->
      fun ty ->
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Tuple tys ->
            ...
            let doc2 =
              let uu____2090 =
                let uu____2091 = combine (text " * ") doc1 in hbox uu____2091 in
            ...
            let docs =
              FStar_List.map
                (fun x ->
                   ...
                   parens uu____2433) es in
            let docs1 =
              let uu____2435 = combine (text ", ") docs in parens uu____2435 in
            docs1
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____2567;_},
                          branches);
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2629;_},
                 unitVal::[]),
                e11::e2::[]) when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.loc = uu____2643;_},
                 unitVal::[]),
                e11::[]) when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
            ...
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____3792 =
                   ...
                   [uu____3795; body2] in
                 combine hardline uu____3792) in
  ...
  fun currentModule ->
    fun s ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x, args) ->
          ...
          let args2 =
            let uu____3878 = combine (text " * ") args1 in parens uu____3878 in
  ...
  fun currentModule ->
    fun m ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Exn (x, args) ->
          ...
          let args3 =
            let uu____3962 = combine (text " * ") args2 in parens uu____3962 in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____4164 ->
                     ...
                     | (s, uu____4170) -> doc_of_sig x1 s) sigmod in
        ...
        and for1_mod istop uu____4203 =
          ...
          | (mod_name, sigmod, FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              let head =
                let uu____4306 =
                  let uu____4309 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____4309
              ...
              FStar_All.pipe_left reduce uu____4379 in
        let docs =
          FStar_List.map
            (fun uu____4441 ->
               match uu____4441 with
               | (x, s, m) ->
                   let uu____4498 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____4500 = for1_mod true (x, s, m) in
                   (uu____4498, uu____4500)) mllib in
        docs
