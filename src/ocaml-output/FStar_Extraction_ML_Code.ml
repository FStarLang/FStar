...
let prim_types : 'Auu____668 . Prims.unit -> 'Auu____668 Prims.list =
  fun a246  -> (Obj.magic (fun uu____671  -> [])) a246 
      ...
      fun doc1  ->
        ...
        | (outer,side) ->
            let noparens _inner _outer side1 =
              let uu____1073 = _inner  in
              match uu____1073 with
              | (pi,fi) ->
                  let uu____1080 = _outer  in
                   ...
                   | (po,fo) ->
                       (pi > po) ||
                         ((match (fi, side1) with
                           ...
                           | (Infix (Right ),IRight ) ->
                               (pi = po) && (fo = (Infix Right))
                           | (uu____1087,NonAssoc ) -> (pi = po) && (fi = fo)
                           | (uu____1088,uu____1089) -> false)))
               in
...
let (string_of_mlconstant :
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Char c ->
        ...
        let uu____1167 = FStar_Util.string_of_int nc  in
        Prims.strcat uu____1167
          (if
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        ...
        -> Prims.strcat s "L"
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some (uu____1214,FStar_Const.Int8 )) -> s
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some (uu____1226,FStar_Const.Int16 )) -> s
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Tuple tys ->
            ...
            let doc2 =
              let uu____1305 =
                ...
                FStar_Format.hbox uu____1306  in
              FStar_Format.parens uu____1305  in
            doc2
            ...
            let args1 =
              ...
              | uu____1319 ->
                  ...
                  let uu____1329 =
                    ...
                    FStar_Format.hbox uu____1330  in
                  FStar_Format.parens uu____1329
               in
            let name1 = ptsym currentModule name  in
            let uu____1332 =
              FStar_Format.reduce1 [args1; FStar_Format.text name1]  in
            FStar_Format.hbox uu____1332
        | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,uu____1334,t2) ->
            let d1 = doc_of_mltype currentModule (t_prio_fun, Left) t1  in
            let d2 = doc_of_mltype currentModule (t_prio_fun, Right) t2  in
            let uu____1346 =
              let uu____1347 =
                FStar_Format.reduce1 [d1; FStar_Format.text " -> "; d2]  in
              FStar_Format.hbox uu____1347  in
            maybe_paren outer t_prio_fun uu____1346
        | FStar_Extraction_ML_Syntax.MLTY_Top  ->
            let uu____1348 = FStar_Extraction_ML_Util.codegen_fsharp ()  in
            if uu____1348
...
and (doc_of_mltype :
  ...
  fun currentModule  ->
    fun outer  ->
      fun ty  ->
        let uu____1353 = FStar_Extraction_ML_Util.resugar_mlty ty  in
        doc_of_mltype' currentModule outer uu____1353
      ...
      fun e  ->
        ...
        | FStar_Extraction_ML_Syntax.MLE_Coerce (e1,t,t') ->
            let doc1 = doc_of_expr currentModule (min_op_prec, NonAssoc) e1
               in
            let uu____1441 = FStar_Extraction_ML_Util.codegen_fsharp ()  in
            if uu____1441
            then
              let uu____1442 =
                FStar_Format.reduce
                 ...
                 in
              FStar_Format.parens uu____1442
            else
              (let uu____1444 =
                 FStar_Format.reduce
                   [FStar_Format.text "Obj.magic "; FStar_Format.parens doc1]
                  in
               FStar_Format.parens uu____1444)
        | FStar_Extraction_ML_Syntax.MLE_Seq es ->
            ...
            let docs1 =
              FStar_List.map
               ...
               in
            let uu____1460 = FStar_Format.reduce docs1  in
            FStar_Format.parens uu____1460
        | FStar_Extraction_ML_Syntax.MLE_Const c ->
            let uu____1462 = string_of_mlconstant c  in
            FStar_Format.text uu____1462
        | FStar_Extraction_ML_Syntax.MLE_Var x -> FStar_Format.text x
        | FStar_Extraction_ML_Syntax.MLE_Name path ->
            let uu____1465 = ptsym currentModule path  in
            FStar_Format.text uu____1465
        | FStar_Extraction_ML_Syntax.MLE_Record (path,fields) ->
            let for1 uu____1492 =
              ...
              | (name,e1) ->
                  ...
                  let uu____1504 =
                    let uu____1507 =
                      let uu____1508 = ptsym currentModule (path, name)  in
                      FStar_Format.text uu____1508  in
                    [uu____1507; FStar_Format.text "="; doc1]  in
                  FStar_Format.reduce1 uu____1504
               in
            let uu____1511 =
              let uu____1512 = FStar_List.map for1 fields  in
              FStar_Format.combine (FStar_Format.text "; ") uu____1512  in
            FStar_Format.cbrackets uu____1511
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            let name =
              let uu____1548 = is_standard_constructor ctor  in
              if uu____1548
              then
                let uu____1549 =
                  let uu____1554 = as_standard_constructor ctor  in
                  FStar_Option.get uu____1554  in
                FStar_Pervasives_Native.snd uu____1549
              else ptctor currentModule ctor  in
            let args1 =
              FStar_List.map
              ...
              | (uu____1580,uu____1581) ->
                  let uu____1586 =
                    let uu____1589 =
                      ...
                      [uu____1592]  in
                    (FStar_Format.text name) :: uu____1589  in
                  FStar_Format.reduce1 uu____1586
               in
            ...
            let docs =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____1603) es
               in
            let docs1 =
              let uu____1609 =
                FStar_Format.combine (FStar_Format.text ", ") docs  in
              FStar_Format.parens uu____1609  in
            docs1
              ...
              then
                let uu____1624 =
                  let uu____1627 =
                    ...
                    [uu____1630]  in
                  FStar_Format.hardline :: uu____1627  in
                FStar_Format.reduce uu____1624
            ...
            let uu____1640 =
              let uu____1641 =
                let uu____1644 =
                  ...
                  doc1 :: uu____1647  in
                pre :: uu____1644  in
              FStar_Format.combine FStar_Format.hardline uu____1641  in
            FStar_Format.parens uu____1640
            ...
            (match ((e1.FStar_Extraction_ML_Syntax.expr), args) with
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                    FStar_Extraction_ML_Syntax.expr =
                      ...
                      (uu____1660::[],scrutinee);
                    FStar_Extraction_ML_Syntax.mlty = uu____1662;
                    FStar_Extraction_ML_Syntax.loc = uu____1663;_}::{
                                                                    FStar_Extraction_ML_Syntax.expr
                                                                    =
                                                                    FStar_Extraction_ML_Syntax.MLE_Fun
                                                                    ((arg,uu____1665)::[],possible_match);
                   ...
                   | {
                       FStar_Extraction_ML_Syntax.expr =
                         ...
                         ({
                            ...
                            FStar_Extraction_ML_Syntax.loc = uu____1727;_},branches);
                       FStar_Extraction_ML_Syntax.mlty = uu____1729;
                       FStar_Extraction_ML_Syntax.loc = uu____1730;_} when
                       arg = arg' -> branches
                   | e2 ->
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   ...
                   FStar_Extraction_ML_Syntax.mlty = uu____1786;
                   FStar_Extraction_ML_Syntax.loc = uu____1787;_},unitVal::[]),e11::e2::[])
                 when
                 (is_bin_op p) &&
             ...
             | (FStar_Extraction_ML_Syntax.MLE_App
                ({
                   FStar_Extraction_ML_Syntax.expr =
                     FStar_Extraction_ML_Syntax.MLE_Name p;
                   FStar_Extraction_ML_Syntax.mlty = uu____1800;
                   FStar_Extraction_ML_Syntax.loc = uu____1801;_},unitVal::[]),e11::[])
                 when
                 (is_uni_op p) &&
                   (unitVal = FStar_Extraction_ML_Syntax.ml_unit)
             ...
             | uu____1808 ->
                 ...
                 let args1 =
                   FStar_List.map
                    ...
                    in
                 let uu____1827 = FStar_Format.reduce1 (e2 :: args1)  in
                 FStar_Format.parens uu____1827)
              ...
              then
                ...
                (let uu____1840 =
                   let uu____1843 =
                     let uu____1846 =
                       let uu____1849 =
                         let uu____1850 = ptsym currentModule f  in
                         FStar_Format.text uu____1850  in
                       [uu____1849]  in
                     (FStar_Format.text ".") :: uu____1846  in
                   e2 :: uu____1843  in
                 FStar_Format.reduce uu____1840)
               in
            doc1
        | FStar_Extraction_ML_Syntax.MLE_Fun (ids,body) ->
            let bvar_annot x xt =
              let uu____1878 = FStar_Extraction_ML_Util.codegen_fsharp ()  in
              if uu____1878
              then
                let uu____1879 =
                  let uu____1882 =
                    let uu____1885 =
                      let uu____1888 =
                        ...
                        | uu____1897 -> FStar_Format.text ""  in
                      [uu____1888; FStar_Format.text ")"]  in
                    (FStar_Format.text x) :: uu____1885  in
                  (FStar_Format.text "(") :: uu____1882  in
            ...
            let doc1 =
              let uu____1924 =
                let uu____1927 =
                  let uu____1930 = FStar_Format.reduce1 ids1  in
                  [uu____1930; FStar_Format.text "->"; body1]  in
                (FStar_Format.text "fun") :: uu____1927  in
              FStar_Format.reduce1 uu____1924  in
            ...
            let doc1 =
              let uu____1941 =
                ...
                let uu____1945 =
                  let uu____1948 =
                    doc_of_expr currentModule (min_op_prec, NonAssoc) e1  in
                  [uu____1948; FStar_Format.text "end"]  in
                uu____1944 :: uu____1945  in
              FStar_Format.combine FStar_Format.hardline uu____1941  in
                    ...
                    let uu____1980 =
                      let uu____1983 =
                        doc_of_expr currentModule (min_op_prec, NonAssoc) e2
                         in
                      [uu____1983; FStar_Format.text "end"]  in
                    uu____1979 :: uu____1980  in
                  uu____1971 :: uu____1976  in
                uu____1967 :: uu____1968  in
              FStar_Format.combine FStar_Format.hardline uu____1964  in
            maybe_paren outer e_bin_prio_if doc1
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,[]) ->
            let uu____2026 =
              let uu____2029 =
                let uu____2032 =
                  let uu____2033 = ptctor currentModule exn  in
                  FStar_Format.text uu____2033  in
                [uu____2032]  in
              (FStar_Format.text "raise") :: uu____2029  in
            FStar_Format.reduce1 uu____2026
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            let uu____2047 =
              let uu____2050 =
                let uu____2053 =
                  let uu____2054 = ptctor currentModule exn  in
                  FStar_Format.text uu____2054  in
                let uu____2055 =
                  let uu____2058 =
                    let uu____2059 =
                      FStar_Format.combine (FStar_Format.text ", ") args1  in
                    FStar_Format.parens uu____2059  in
                  [uu____2058]  in
                uu____2053 :: uu____2055  in
              (FStar_Format.text "raise") :: uu____2050  in
            FStar_Format.reduce1 uu____2047
                ...
                let uu____2093 =
                  let uu____2096 =
                    let uu____2099 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____2100
                       in
                    [uu____2099]  in
                  (FStar_Format.text "with") :: uu____2096  in
                uu____2088 :: uu____2093  in
              (FStar_Format.text "try") :: uu____2085  in
            FStar_Format.combine FStar_Format.hardline uu____2082
  ...
  fun currentModule  ->
    fun p  ->
      fun e1  ->
        fun e2  ->
          let uu____2113 =
            let uu____2124 = as_bin_op p  in FStar_Option.get uu____2124  in
...
and (doc_of_uniop :
  ...
  fun currentModule  ->
    fun p  ->
      fun e1  ->
        let uu____2172 =
          let uu____2177 = as_uni_op p  in FStar_Option.get uu____2177  in
  ...
  fun currentModule  ->
    fun pattern  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Const c ->
          let uu____2199 = string_of_mlconstant c  in
          FStar_Format.text uu____2199
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____2227 =
            ...
            | (name,p) ->
                let uu____2234 =
                  let uu____2237 =
                    let uu____2238 = ptsym currentModule (path, name)  in
                  ...
                  uu____2237 :: uu____2241  in
                FStar_Format.reduce1 uu____2234
             in
          let uu____2248 =
            let uu____2249 = FStar_List.map for1 fields  in
            FStar_Format.combine (FStar_Format.text "; ") uu____2249  in
          FStar_Format.cbrackets uu____2248
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,[]) ->
          let name =
            let uu____2260 = is_standard_constructor ctor  in
            if uu____2260
            then
              let uu____2261 =
                let uu____2266 = as_standard_constructor ctor  in
                FStar_Option.get uu____2266  in
              FStar_Pervasives_Native.snd uu____2261
            else ptctor currentModule ctor  in
          FStar_Format.text name
      | FStar_Extraction_ML_Syntax.MLP_CTor (ctor,pats) ->
          let name =
            let uu____2285 = is_standard_constructor ctor  in
            if uu____2285
            then
              let uu____2286 =
                let uu____2291 = as_standard_constructor ctor  in
                FStar_Option.get uu____2291  in
              FStar_Pervasives_Native.snd uu____2286
            else ptctor currentModule ctor  in
          let doc1 =
            ...
            | ("::",x::xs::[]) ->
                let uu____2310 =
                  let uu____2313 =
                    let uu____2314 = doc_of_pattern currentModule x  in
                    FStar_Format.parens uu____2314  in
                  let uu____2315 =
                    let uu____2318 =
                      let uu____2321 = doc_of_pattern currentModule xs  in
                      [uu____2321]  in
                    (FStar_Format.text "::") :: uu____2318  in
                  uu____2313 :: uu____2315  in
                FStar_Format.reduce uu____2310
            | (uu____2322,(FStar_Extraction_ML_Syntax.MLP_Tuple
               uu____2323)::[]) ->
                let uu____2328 =
                  let uu____2331 =
                    let uu____2334 =
                      let uu____2335 = FStar_List.hd pats  in
                      doc_of_pattern currentModule uu____2335  in
                    [uu____2334]  in
                  (FStar_Format.text name) :: uu____2331  in
                FStar_Format.reduce1 uu____2328
            | uu____2336 ->
                let uu____2343 =
                  let uu____2346 =
                    let uu____2349 =
                      let uu____2350 =
                        ...
                        FStar_Format.combine (FStar_Format.text ", ")
                          uu____2351
                         in
                      FStar_Format.parens uu____2350  in
                    [uu____2349]  in
                  (FStar_Format.text name) :: uu____2346  in
                FStar_Format.reduce1 uu____2343
             in
          maybe_paren (min_op_prec, NonAssoc) e_app_prio doc1
      | FStar_Extraction_ML_Syntax.MLP_Tuple ps ->
          let ps1 = FStar_List.map (doc_of_pattern currentModule) ps  in
          let uu____2364 = FStar_Format.combine (FStar_Format.text ", ") ps1
             in
          FStar_Format.parens uu____2364
      ...
      | (p,cond,e) ->
          let case =
            ...
            | FStar_Pervasives_Native.None  ->
                let uu____2384 =
                  let uu____2387 =
                    let uu____2390 = doc_of_pattern currentModule p  in
                    [uu____2390]  in
                  (FStar_Format.text "|") :: uu____2387  in
                FStar_Format.reduce1 uu____2384
            | FStar_Pervasives_Native.Some c ->
                let c1 = doc_of_expr currentModule (min_op_prec, NonAssoc) c
                   in
                let uu____2397 =
                  let uu____2400 =
                    let uu____2403 = doc_of_pattern currentModule p  in
                    [uu____2403; FStar_Format.text "when"; c1]  in
          ...
          let uu____2404 =
            ...
            let uu____2408 =
              ...
              [uu____2411; FStar_Format.text "end"]  in
            uu____2407 :: uu____2408  in
          FStar_Format.combine FStar_Format.hardline uu____2404
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____2437 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                FStar_Extraction_ML_Syntax.mllb_add_unit = uu____2440;
                FStar_Extraction_ML_Syntax.mllb_def = e;
                FStar_Extraction_ML_Syntax.mllb_meta = uu____2442;
                ...
                let uu____2525 =
                  let uu____2528 =
                    let uu____2531 = FStar_Format.reduce1 ids  in
                    [uu____2531; ty_annot; FStar_Format.text "="; e1]  in
                  (FStar_Format.text name) :: uu____2528  in
                FStar_Format.reduce1 uu____2525
             in
          let letdoc =
  ...
  fun currentModule  ->
    fun decls  ->
      let for1 uu____2583 =
        ...
        | (uu____2602,x,mangle_opt,tparams,uu____2606,body) ->
            let x1 =
            ...
            let tparams1 =
              ...
              | uu____2624 ->
                  ...
                  let uu____2632 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____2632
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  let forfield uu____2658 =
                    ...
                    | (name,ty) ->
                     ...
                     in
                  let uu____2671 =
                    let uu____2672 = FStar_List.map forfield fields  in
                    FStar_Format.combine (FStar_Format.text "; ") uu____2672
                     in
                  FStar_Format.cbrackets uu____2671
              | FStar_Extraction_ML_Syntax.MLTD_DType ctors ->
                  let forctor uu____2706 =
                    match uu____2706 with
                    | (name,tys) ->
                        let uu____2731 = FStar_List.split tys  in
            ...
            let doc1 =
              let uu____2780 =
                let uu____2783 =
                  let uu____2786 =
                    let uu____2787 = ptsym currentModule ([], x1)  in
                    FStar_Format.text uu____2787  in
                  [uu____2786]  in
                tparams1 :: uu____2783  in
              FStar_Format.reduce1 uu____2780  in
            (match body with
             ...
             | FStar_Pervasives_Native.Some body1 ->
                 ...
                 let uu____2792 =
                   ...
                   [uu____2795; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____2792)
         in
          ...
          let uu____2818 =
            let uu____2821 =
              let uu____2824 =
                FStar_Format.combine (FStar_Format.text " \n and ") doc1  in
              [uu____2824]  in
            (FStar_Format.text "type") :: uu____2821  in
          FStar_Format.reduce1 uu____2818
  ...
  fun currentModule  ->
    fun s  ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let uu____2850 =
            let uu____2853 =
              FStar_Format.reduce1
               ...
               in
            let uu____2854 =
              let uu____2857 = doc_of_sig currentModule subsig  in
              let uu____2858 =
                let uu____2861 =
          ...
          FStar_Format.combine FStar_Format.hardline uu____2850
      ...
      | FStar_Extraction_ML_Syntax.MLS_Exn (x,args) ->
          ...
          let args2 =
            let uu____2879 =
              FStar_Format.combine (FStar_Format.text " * ") args1  in
            FStar_Format.parens uu____2879  in
          FStar_Format.reduce1
            [FStar_Format.text "exception";
            FStar_Format.text x;
            FStar_Format.text "of";
            args2]
      | FStar_Extraction_ML_Syntax.MLS_Val (x,(uu____2881,ty)) ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Top e ->
          let uu____2964 =
            let uu____2967 =
              ...
              (FStar_Format.text "_") :: uu____2970  in
            (FStar_Format.text "let") :: uu____2967  in
          FStar_Format.reduce1 uu____2964
      ...
      let docs =
        FStar_List.map
          (fun x  ->
             ...
             [doc1;
             (match x with
              | FStar_Extraction_ML_Syntax.MLM_Loc uu____3004 ->
                  FStar_Format.empty
              | uu____3005 -> FStar_Format.hardline);
        ...
        let rec for1_sig uu____3085 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3158  ->
                     ...
                     | (s,uu____3164) -> doc_of_sig x1 s) sigmod
                 in
              ...
              let uu____3191 =
                let uu____3194 =
                  let uu____3197 =
                    let uu____3200 = FStar_Format.reduce sub3  in
                    [uu____3200;
                  ...
                  (match doc1 with
                   ...
                   | FStar_Pervasives_Native.Some s ->
                    ...
                    :: uu____3197
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____3194
                 in
              FStar_Format.reduce uu____3191
        
        and for1_mod istop uu____3203 =
          ...
          | (mod_name1,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____3282 =
                  let uu____3285 = FStar_Extraction_ML_Util.codegen_fsharp ()
                     in
                  if uu____3285
                  then
                    [FStar_Format.text "module";
                   ...
                   in
                FStar_Format.reduce1 uu____3282  in
              let tail1 =
                if Prims.op_Negation istop
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____3304  ->
                     ...
                     | (uu____3309,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____3340 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____3340
                then
                ...
                let uu____3347 =
                  let uu____3350 =
                    let uu____3353 =
                      let uu____3356 =
                        let uu____3359 =
                          let uu____3362 = FStar_Format.reduce sub3  in
                          [uu____3362;
                          FStar_Format.cat tail1 FStar_Format.hardline]  in
                        (match doc1 with
                         | FStar_Pervasives_Native.None  ->
                         ...
                         | FStar_Pervasives_Native.Some s ->
                          ...
                          :: uu____3359
                         in
                      FStar_Format.hardline :: uu____3356  in
                    FStar_List.append maybe_open_pervasives uu____3353  in
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____3350
                   in
                FStar_List.append prefix1 uu____3347  in
              FStar_All.pipe_left FStar_Format.reduce uu____3344
         in
        let docs =
          FStar_List.map
            (fun uu____3401  ->
               ...
               | (x,s,m) ->
                   let uu____3451 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____3452 = for1_mod true (x, s, m)  in
                   (uu____3451, uu____3452)) mllib
           in
        docs
...
let (string_of_mlexpr :
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        let uu____3487 = FStar_Extraction_ML_Util.flatten_mlpath cmod  in
        doc_of_expr uu____3487 (min_op_prec, NonAssoc) e  in
  ...
  fun cmod  ->
    fun e  ->
      let doc1 =
        ...
        doc_of_mltype uu____3503 (min_op_prec, NonAssoc) e  in
      FStar_Format.pretty (Prims.parse_int "0") doc1
