            ...
            (match body with
             ...
             | Some body1 ->
                 ...
                 let uu____1678 =
                   ...
                   [uu____1680; body2] in
                 FStar_Format.combine FStar_Format.hardline uu____1678) in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1898  ->
                     ...
                     | (s,uu____1902) -> doc_of_sig x1 s) sigmod in
                ...
                let uu____1919 =
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1921 in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1919 in
        ...
        and for1_mod istop uu____1926 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____1970 =
                  let uu____1972 = FStar_Extraction_ML_Util.codegen_fsharp () in
                  if uu____1972
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1983  ->
                     ...
                     | (uu____1986,m) -> doc_of_mod target_mod_name m) sigmod in
              ...
              let sub3 =
                FStar_List.map
                  ...
                  sub2 in
              let prefix1 =
                let uu____2004 = FStar_Extraction_ML_Util.codegen_fsharp () in
                if uu____2004
                then
              ...
              let uu____2007 =
                let uu____2009 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____2011 in
                FStar_List.append prefix1 uu____2009 in
              FStar_All.pipe_left FStar_Format.reduce uu____2007 in
        let docs1 =
          FStar_List.map
            (fun uu____2037  ->
               match uu____2037 with
               | (x,s,m) ->
                   let uu____2064 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let uu____2065 = for1_mod true (x, s, m) in
                   (uu____2064, uu____2065)) mllib in
        docs1
let doc_of_mllib:
  FStar_Extraction_ML_Syntax.mllib ->
    (Prims.string* FStar_Format.doc) Prims.list
