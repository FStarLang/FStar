                ...
                then "\\n"
                  ...
                  then "\\'"
                    ...
                    then "\\\""
                      ...
                      if FStar_Util.is_letter_or_digit uu___260_1123
                      then FStar_Util.string_of_char uu___260_1123
                      else
                        if FStar_Util.is_punctuation uu___260_1123
                        then FStar_Util.string_of_char uu___260_1123
                        else
                          if FStar_Util.is_symbol uu___260_1123
                          then FStar_Util.string_of_char uu___260_1123
                          else fallback uu___260_1123
