...
let string_of_mlconstant :
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Char c ->
        let _0_230 =
          let _0_229 = escape_or escape_char_hex c  in
          Prims.strcat _0_229 "'"  in
        Prims.strcat "'" _0_230
    ...
    fun outer  ->
      fun e  ->
        ...
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,uu____819,lets),body) ->
            let pre =
              ...
              then
                FStar_Format.reduce
                  (let _0_242 =
                     let _0_241 = doc_of_loc e.FStar_Extraction_ML_Syntax.loc
                        in
                     [_0_241]  in
             ...
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____844;_}::{
                                                                    ...
                                                                    uu____849;_}::[])
                 when
                 let _0_247 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                    in
            ...
            let doc =
              ...
              then
                ...
                FStar_Format.reduce
                  (let _0_252 =
                     let _0_251 =
                       let _0_250 = FStar_Format.text (ptsym currentModule f)
                          in
                       [_0_250]  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,[]) ->
            FStar_Format.reduce1
              (let _0_274 =
                 let _0_273 = FStar_Format.text (ptctor currentModule exn)
                    in
                 [_0_273]  in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            FStar_Format.reduce1
              (let _0_278 =
                 let _0_277 = FStar_Format.text (ptctor currentModule exn)
                    in
                 let _0_276 =
                   let _0_275 =
                     FStar_Format.parens
      ...
      | (p,cond,e) ->
          let case =
            ...
            | None  ->
                FStar_Format.reduce1
                  (let _0_302 =
                     let _0_301 = doc_of_pattern currentModule p  in [_0_301]
                      in
            ...
            (match body with
             ...
             | Some body ->
                 ...
                 let _0_316 =
                   ...
                   [_0_315; body]  in
                 FStar_Format.combine FStar_Format.hardline _0_316)
         in
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let _0_324 =
            ...
            let _0_322 =
              ...
              let _0_320 =
                let _0_319 = FStar_Format.reduce1 [FStar_Format.text "end"]
                   in
                [_0_319]  in
              _0_321 :: _0_320  in
            _0_323 :: _0_322  in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              FStar_Format.reduce
                (let _0_331 =
                   let _0_330 =
                     ...
                     [_0_329; FStar_Format.cat tail FStar_Format.hardline]
                      in
                   (match doc with
        ...
        and for1_mod istop uu____1584 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              FStar_All.pipe_left FStar_Format.reduce _0_339
         in
        let docs =
          FStar_List.map
            (fun uu____1670  ->
