    ...
    fun x  ->
      ...
      | uu____191 ->
          ...
          (match uu____192 with
           | (ns,x) ->
               let _0_232 = path_of_ns currentModule ns in (_0_232, x))
let ptsym_of_symbol:
  ...
  fun s  ->
    let uu____201 =
      ...
      let _0_233 = FStar_String.get s (Prims.parse_int "0") in
      _0_234 <> _0_233 in
    ...
    fun mlp  ->
      ...
      then ptsym_of_symbol (Prims.snd mlp)
        ...
        (let uu____212 = mlpath_of_mlpath currentModule mlp in
         ...
         | (p,s) ->
             let _0_237 =
               let _0_236 = let _0_235 = ptsym_of_symbol s in [_0_235] in
               FStar_List.append p _0_236 in
             FStar_String.concat "." _0_237)
let ptctor:
  FStar_Extraction_ML_Syntax.mlsymbol ->
    FStar_Extraction_ML_Syntax.mlpath -> FStar_Extraction_ML_Syntax.mlsymbol
  =
      ...
      | (p,s) ->
          let s =
            let uu____229 =
              ...
              let _0_238 = FStar_String.get s (Prims.parse_int "0") in
              _0_239 <> _0_238 in
...
let is_bin_op: FStar_Extraction_ML_Syntax.mlpath -> Prims.bool =
  fun p  -> let _0_240 = as_bin_op p in _0_240 <> None
let as_uni_op:
  FStar_Extraction_ML_Syntax.mlpath ->
...
let is_uni_op: FStar_Extraction_ML_Syntax.mlpath -> Prims.bool =
  fun p  -> let _0_241 = as_uni_op p in _0_241 <> None
...
let is_standard_constructor: FStar_Extraction_ML_Syntax.mlpath -> Prims.bool
  = fun p  -> let _0_242 = as_standard_constructor p in _0_242 <> None
let maybe_paren:
...
let string_of_mlconstant:
  ...
  fun sctt  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Char c ->
        let _0_244 =
          let _0_243 = escape_or escape_char_hex c in Prims.strcat _0_243 "'" in
        Prims.strcat "'" _0_244
    ...
    | FStar_Extraction_ML_Syntax.MLC_Bytes bytes ->
        let _0_246 =
          let _0_245 = FStar_Bytes.f_encode escape_byte_hex bytes in
          Prims.strcat _0_245 "\"" in
        Prims.strcat "\"" _0_246
    | FStar_Extraction_ML_Syntax.MLC_String chars ->
        let _0_248 =
          let _0_247 =
            FStar_String.collect (escape_or FStar_Util.string_of_char) chars in
          Prims.strcat _0_247 "\"" in
        Prims.strcat "\"" _0_248
    | uu____635 ->
    ...
    fun outer  ->
      fun ty  ->
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Var x ->
            ...
            FStar_Format.text
              (let _0_249 = FStar_Extraction_ML_Syntax.idsym x in
               FStar_All.pipe_left escape_tyvar _0_249)
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,uu____680,t2) ->
            ...
            maybe_paren outer t_prio_fun _0_250
      ...
      fun e  ->
              ...
              | (name,e) ->
                  ...
                  FStar_Format.reduce1
                    (let _0_251 =
                     ...
                     [_0_251; FStar_Format.text "="; doc]) in
            FStar_Format.cbrackets
              (let _0_252 = FStar_List.map for1 fields in
               FStar_Format.combine (FStar_Format.text "; ") _0_252)
                       ...
                       let _0_253 =
                         FStar_Format.parens
                           (FStar_Format.combine (FStar_Format.text ", ")
                              args) in
                       [_0_253] in
                     (FStar_Format.text name) :: _0_254) in
        ...
        | FStar_Extraction_ML_Syntax.MLE_Let ((rec_,uu____819,lets),body) ->
            let pre =
              ...
              then
                FStar_Format.reduce
                  (let _0_256 =
                     let _0_255 = doc_of_loc e.FStar_Extraction_ML_Syntax.loc in
                     [_0_255] in
                   FStar_Format.hardline :: _0_256)
            ...
            FStar_Format.parens
              (let _0_260 =
                 let _0_259 =
                   ...
                   doc :: _0_258 in
                 pre :: _0_259 in
               FStar_Format.combine FStar_Format.hardline _0_260)
             ...
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____844;_}::{
                                                                    ...
                                                                    uu____849;_}::[])
                 when
                 let _0_261 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
                 _0_261 = "FStar.All.try_with" ->
                 let branches =
                   ...
                   | {
                       ...
                       let _0_263 = FStar_Extraction_ML_Syntax.idsym arg in
                       let _0_262 = FStar_Extraction_ML_Syntax.idsym arg' in
                       _0_263 = _0_262 -> branches
            ...
            let doc =
              ...
              then
                ...
                FStar_Format.reduce
                  (let _0_266 =
                     let _0_265 =
                       let _0_264 = FStar_Format.text (ptsym currentModule f) in
                       [_0_264] in
                     (FStar_Format.text ".") :: _0_265 in
                   e :: _0_266) in
            doc
        | FStar_Extraction_ML_Syntax.MLE_Fun (ids,body) ->
                         ...
                         | Some xxt ->
                             FStar_Format.reduce1
                               (let _0_268 =
                                  ...
                                  [_0_267] in
                                (FStar_Format.text " : ") :: _0_268)
                         | uu____970 -> FStar_Format.text "" in
                       [_0_269; FStar_Format.text ")"] in
                     (FStar_Format.text x) :: _0_270 in
                   (FStar_Format.text "(") :: _0_271)
            ...
            let doc =
              FStar_Format.reduce1
                (let _0_273 =
                   let _0_272 = FStar_Format.reduce1 ids in
                   [_0_272; FStar_Format.text "->"; body] in
                 (FStar_Format.text "fun") :: _0_273) in
            ...
            let doc =
              let _0_277 =
                ...
                let _0_275 =
                  ...
                  [_0_274; FStar_Format.text "end"] in
                _0_276 :: _0_275 in
              FStar_Format.combine FStar_Format.hardline _0_277 in
                ...
                let _0_283 =
                  ...
                  let _0_281 =
                    ...
                    let _0_279 =
                      ...
                      [_0_278; FStar_Format.text "end"] in
                    _0_280 :: _0_279 in
                  _0_282 :: _0_281 in
                _0_284 :: _0_283 in
              FStar_Format.combine FStar_Format.hardline _0_285 in
            maybe_paren outer e_bin_prio_if doc
        ...
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,[]) ->
            FStar_Format.reduce1
              (let _0_288 =
                 let _0_287 = FStar_Format.text (ptctor currentModule exn) in
                 [_0_287] in
               (FStar_Format.text "raise") :: _0_288)
        | FStar_Extraction_ML_Syntax.MLE_Raise (exn,args) ->
            ...
            FStar_Format.reduce1
              (let _0_292 =
                 let _0_291 = FStar_Format.text (ptctor currentModule exn) in
                 let _0_290 =
                   let _0_289 =
                     FStar_Format.parens
                       (FStar_Format.combine (FStar_Format.text ", ") args) in
                   [_0_289] in
                 _0_291 :: _0_290 in
               (FStar_Format.text "raise") :: _0_292)
                ...
                let _0_296 =
                  let _0_295 =
                    let _0_294 =
                      ...
                      FStar_Format.combine FStar_Format.hardline _0_293 in
                    [_0_294] in
                  (FStar_Format.text "with") :: _0_295 in
                _0_297 :: _0_296 in
              (FStar_Format.text "try") :: _0_298 in
            FStar_Format.combine FStar_Format.hardline _0_299
and doc_of_binop:
  FStar_Extraction_ML_Syntax.mlsymbol ->
    FStar_Extraction_ML_Syntax.mlpath ->
            ...
            | (name,p) ->
                FStar_Format.reduce1
                  (let _0_303 =
                   ...
                   let _0_302 =
                     let _0_301 =
                       let _0_300 = doc_of_pattern currentModule p in
                       [_0_300] in
                     (FStar_Format.text "=") :: _0_301 in
                   _0_303 :: _0_302) in
          FStar_Format.cbrackets
            (let _0_304 = FStar_List.map for1 fields in
             FStar_Format.combine (FStar_Format.text "; ") _0_304)
            ...
            | ("::",x::xs::[]) ->
                FStar_Format.reduce
                  (let _0_308 =
                   ...
                   let _0_307 =
                     let _0_306 =
                       let _0_305 = doc_of_pattern currentModule xs in
                       [_0_305] in
                     (FStar_Format.text "::") :: _0_306 in
                   _0_308 :: _0_307)
            | (uu____1149,(FStar_Extraction_ML_Syntax.MLP_Tuple
               uu____1150)::[]) ->
                FStar_Format.reduce1
                  (let _0_311 =
                     let _0_310 =
                       let _0_309 = FStar_List.hd pats in
                       doc_of_pattern currentModule _0_309 in
                     [_0_310] in
                   (FStar_Format.text name) :: _0_311)
            | uu____1153 ->
                FStar_Format.reduce1
                  (let _0_314 =
                     let _0_313 =
                       FStar_Format.parens
                         (let _0_312 =
                          ...
                          FStar_Format.combine (FStar_Format.text ", ")
                            _0_312) in
                     [_0_313] in
                   (FStar_Format.text name) :: _0_314) in
      ...
      | (p,cond,e) ->
          let case =
            ...
            | None  ->
                FStar_Format.reduce1
                  (let _0_316 =
                     let _0_315 = doc_of_pattern currentModule p in [_0_315] in
                   (FStar_Format.text "|") :: _0_316)
            | Some c ->
                let c = doc_of_expr currentModule (min_op_prec, NonAssoc) c in
                FStar_Format.reduce1
                  (let _0_318 =
                     let _0_317 = doc_of_pattern currentModule p in
                     [_0_317; FStar_Format.text "when"; c] in
                   (FStar_Format.text "|") :: _0_318) in
          let _0_322 =
            let _0_321 =
              FStar_Format.reduce1
            ...
            let _0_320 =
              let _0_319 =
                doc_of_expr currentModule (min_op_prec, NonAssoc) e in
              [_0_319; FStar_Format.text "end"] in
            _0_321 :: _0_320 in
          FStar_Format.combine FStar_Format.hardline _0_322
and doc_of_lets:
  FStar_Extraction_ML_Syntax.mlsymbol ->
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                FStar_Format.reduce1
                  (let _0_325 =
                   ...
                   let _0_324 =
                     let _0_323 = FStar_Format.reduce1 ids in
                     [_0_323; ty_annot; FStar_Format.text "="; e] in
                   _0_325 :: _0_324) in
          let letdoc =
        ...
        | (uu____1298,x,mangle_opt,tparams,body) ->
            ...
            let forbody body =
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  FStar_Format.cbrackets
                    (let _0_326 = FStar_List.map forfield fields in
                     FStar_Format.combine (FStar_Format.text "; ") _0_326)
            ...
            (match body with
             ...
             | Some body ->
                 ...
                 let _0_330 =
                   ...
                   [_0_329; body] in
                 FStar_Format.combine FStar_Format.hardline _0_330) in
    ...
    fun s  ->
      ...
      | FStar_Extraction_ML_Syntax.MLS_Mod (x,subsig) ->
          let _0_338 =
            ...
            let _0_336 =
              let _0_335 = doc_of_sig currentModule subsig in
              let _0_334 =
                let _0_333 = FStar_Format.reduce1 [FStar_Format.text "end"] in
                [_0_333] in
              _0_335 :: _0_334 in
            _0_337 :: _0_336 in
          FStar_Format.combine FStar_Format.hardline _0_338
               ...
               let _0_341 =
                 let _0_340 =
                   let _0_339 =
                     doc_of_expr currentModule (min_op_prec, NonAssoc) e in
                   [_0_339] in
                 (FStar_Format.text "=") :: _0_340 in
               (FStar_Format.text "_") :: _0_341 in
             (FStar_Format.text "let") :: _0_342)
        ...
        let rec for1_sig uu____1524 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub) ->
              ...
              FStar_Format.reduce
                (let _0_345 =
                   let _0_344 =
                     let _0_343 = FStar_Format.reduce sub in
                     [_0_343; FStar_Format.cat tail FStar_Format.hardline] in
                   (match doc with
                    | None  -> FStar_Format.empty
                    | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                     _0_344 in
                 (FStar_Format.cat head FStar_Format.hardline) :: _0_345)
                  ...
                  let _0_351 =
                    let _0_350 =
                      let _0_349 =
                        let _0_348 =
                          let _0_347 =
                            let _0_346 = FStar_Format.reduce sub in
                            [_0_346;
                          ...
                          (match doc with
                           ...
                           | Some s ->
                            ...
                            :: _0_347 in
                        FStar_Format.hardline :: _0_348 in
                      (FStar_Format.text "open Prims") :: _0_349 in
                    FStar_Format.hardline :: _0_350 in
                  head :: _0_351 in
                FStar_List.append prefix _0_352 in
              FStar_All.pipe_left FStar_Format.reduce _0_353 in
        let docs =
          FStar_List.map
            (fun uu____1670  ->
               match uu____1670 with
               | (x,s,m) ->
                   let _0_355 = FStar_Extraction_ML_Util.flatten_mlpath x in
                   let _0_354 = for1_mod true (x, s, m) in (_0_355, _0_354))
            mllib in
        docs
let doc_of_mllib:
  FStar_Extraction_ML_Syntax.mllib ->
...
let string_of_mlexpr:
  ...
  fun cmod  ->
    fun e  ->
      let doc =
        let _0_356 = FStar_Extraction_ML_Util.flatten_mlpath cmod in
        doc_of_expr _0_356 (min_op_prec, NonAssoc) e in
...
let string_of_mlty:
  ...
  fun cmod  ->
    fun e  ->
      let doc =
        let _0_357 = FStar_Extraction_ML_Util.flatten_mlpath cmod in
        doc_of_mltype _0_357 (min_op_prec, NonAssoc) e in
      FStar_Format.pretty (Prims.parse_int "0") doc