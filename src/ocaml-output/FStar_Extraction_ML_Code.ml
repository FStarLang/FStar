      ...
      | (rec_,top_level,lets) ->
          let for1 uu____1448 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let uu____1497 =
                  let uu____1499 =
                    let uu____1500 = FStar_Extraction_ML_Syntax.idsym name
                       in
                ...
                FStar_Format.reduce1 uu____1497
             in
          let letdoc =
            ...
            let tparams1 =
              ...
              | uu____1561 ->
                  let doc1 =
                    FStar_List.map
                      (fun x2  ->
                         let uu____1566 = FStar_Extraction_ML_Syntax.idsym x2
                            in
                         FStar_Format.text uu____1566) tparams
                     in
                  let uu____1567 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____1567
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____1593 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____1594
                     in
            ...
            (match body with
             ...
             | Some body1 ->
                 ...
                 let uu____1665 =
                   ...
                   [uu____1667; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____1665)
         in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1885  ->
                     ...
                     | (s,uu____1889) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____1906 =
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1908
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1906
                 in
        ...
        and for1_mod istop uu____1913 =
          ...
          | (mod_name,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let head1 =
                let uu____1957 =
                  let uu____1959 = FStar_Extraction_ML_Util.codegen_fsharp ()
                     in
                  if uu____1959
                  then
                    [FStar_Format.text "module";
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1970  ->
                     ...
                     | (uu____1973,m) -> doc_of_mod target_mod_name m) sigmod
                 in
              ...
              let sub3 =
                FStar_List.map
                 ...
                 in
              let prefix1 =
                let uu____1991 = FStar_Extraction_ML_Util.codegen_fsharp ()
                   in
                if uu____1991
                then
              ...
              let uu____1994 =
                let uu____1996 =
                  ...
                  FStar_List.append
                    [head1;
                    FStar_Format.hardline;
                    FStar_Format.text "open Prims"] uu____1998
                   in
                FStar_List.append prefix1 uu____1996  in
              FStar_All.pipe_left FStar_Format.reduce uu____1994
         in
        let docs1 =
          FStar_List.map
            (fun uu____2024  ->
               ...
               | (x,s,m) ->
                   let uu____2051 = FStar_Extraction_ML_Util.flatten_mlpath x
                      in
                   let uu____2052 = for1_mod true (x, s, m)  in
                   (uu____2051, uu____2052)) mllib
           in
        docs1
