...
let has_cygpath : Prims.bool =
  try
    ...
    match uu____7 with uu____14, t_out, uu____16 ->
...
let try_convert_file_name_to_mixed : Prims.string -> Prims.string =
  ...
  fun s ->
    if has_cygpath && FStar_Util.starts_with s "/" then
      ...
      | FStar_Pervasives_Native.None ->
          ...
          in
          match uu____31 with uu____38, out, uu____40 ->
            let out1 = FStar_Util.trim_string out in
            FStar_Util.smap_add cache s out1 ;
            out1
    else s
