...
let has_cygpath : Prims.bool = (FStar_All.try_with (fun uu___27_6 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___26_19 -> (match (uu___26_19) with
| uu____20 -> begin
false
end)))
...
let uu____27 = (FStar_Util.smap_try_find cache s)
...
let uu____31 = (FStar_Util.run_proc "cygpath" (Prims.strcat "-m " s) "")
in (match (uu____31) with
| (uu____38, out, uu____40) -> begin
(
