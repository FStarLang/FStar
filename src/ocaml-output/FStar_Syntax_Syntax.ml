...
# 33 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 40 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type 't var =
(FStar_Ident.lident, 't) withinfo_t

# 41 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type fieldname =
FStar_Ident.lident

# 43 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type sconst =
FStar_Const.sconst

# 45 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 49 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type 'a memo =
'a Prims.option FStar_ST.ref

# 51 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 54 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type aqual =
arg_qualifier Prims.option

# 55 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 65 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type universe_uvar =
universe Prims.option FStar_Unionfind.uvar

# 66 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type univ_names =
univ_name Prims.list

# 67 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type universes =
universe Prims.list

# 69 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 183 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type tscheme =
(univ_name Prims.list * typ)

# 185 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type freenames_l =
bv Prims.list

# 186 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type formula =
typ

# 187 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type formulae =
typ Prims.list

# 188 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 208 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type tycon =
(FStar_Ident.lident * binders * typ)

# 209 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 214 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 219 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 284 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type sigelts =
sigelt Prims.list

# 286 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 292 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type path =
Prims.string Prims.list

# 293 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type subst_t =
subst_elt Prims.list

# 294 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type ('a, 'b) mk_t_a =
'b Prims.option  ->  FStar_Range.range  ->  ('a, 'b) syntax

# 295 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

type mk_t =
(term', term') mk_t_a

# 300 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let withinfo = (fun v s r -> {v = v; ty = s; p = r})

# 301 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let withsort = (fun v s -> (withinfo v s FStar_Range.dummyRange))

# 303 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let bv_eq : bv  ->  bv  ->  Prims.bool = (fun bv1 bv2 -> ((bv1.ppname.FStar_Ident.idText = bv2.ppname.FStar_Ident.idText) && (bv1.index = bv2.index)))

# 304 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 310 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 313 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let range_of_bv : bv  ->  FStar_Range.range = (fun x -> x.ppname.FStar_Ident.idRange)

# 314 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 321 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let syn = (fun p k f -> (f k p))

# 322 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 323 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 324 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 325 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 327 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 341 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let list_of_freenames : freenames  ->  bv Prims.list = (fun fvs -> (FStar_Util.set_elements fvs))

# 344 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 356 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 363 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 366 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 367 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 372 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let mk_subst : subst_t  ->  subst_t = (fun s -> s)

# 373 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let extend_subst : subst_elt  ->  subst_elt Prims.list  ->  subst_elt Prims.list = (fun x s -> (x)::s)

# 374 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let argpos : arg  ->  FStar_Range.range = (fun x -> (Prims.fst x).pos)

# 376 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let tun : (term', term') syntax = (mk Tm_unknown None FStar_Range.dummyRange)

# 377 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let teff : (term', term') syntax = (mk (Tm_constant (FStar_Const.Const_effect)) (Some (Tm_unknown)) FStar_Range.dummyRange)

# 378 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 381 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 396 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 397 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 398 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 399 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 401 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 413 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 418 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let next_id : Prims.unit  ->  Prims.int = (Prims.fst gen_reset)

# 419 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let reset_gensym : Prims.unit  ->  Prims.unit = (Prims.snd gen_reset)

# 420 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 421 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 424 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 427 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let new_bv : FStar_Range.range Prims.option  ->  typ  ->  bv = (fun ropt t -> (gen_bv "x" ropt t))

# 428 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 431 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let mkbv : FStar_Ident.ident  ->  Prims.int  ->  term  ->  bv = (fun x y t -> {ppname = x; index = y; sort = t})

# 432 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 436 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 437 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 438 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
...
# 439 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"

let fv_to_tm : fv  ->  (term', term') syntax = (fun fv -> (mk (Tm_fvar (fv)) None (FStar_Ident.range_of_lid (Prims.fst fv).v)))

# 440 "D:\\workspace\\universes\\FStar\\src\\syntax\\syntax.fs"
