...
let contains_reflectable : qualifier Prims.list  ->  Prims.bool = (fun l -> (FStar_Util.for_some (fun uu___88_3233 -> (match (uu___88_3233) with
...
let uu___95_3311 = x
in {ppname = (FStar_Ident.mk_ident ((x.ppname.FStar_Ident.idText), (r))); index = uu___95_3311.index; sort = uu___95_3311.sort}))
...
let mk_Tm_uinst : term  ->  universes  ->  term = (fun t uu___89_3658 -> (match (uu___89_3658) with
| [] -> begin
t
end
| us -> begin
...
let is_top_level : letbinding Prims.list  ->  Prims.bool = (fun uu___90_3956 -> (match (uu___90_3956) with
...
let is_implicit : aqual  ->  Prims.bool = (fun uu___91_4009 -> (match (uu___91_4009) with
...
let as_implicit : Prims.bool  ->  aqual = (fun uu___92_4014 -> (match (uu___92_4014) with
| true -> begin
Some (imp_tag)
end
| uu____4015 -> begin
...
let range_of_ropt : FStar_Range.range Prims.option  ->  FStar_Range.range = (fun uu___93_4130 -> (match (uu___93_4130) with
| None -> begin
...
in {ppname = uu___96_4162.ppname; index = uu____4163; sort = uu___96_4162.sort}))
end)))
...
let uu___97_4255 = bv
in {ppname = (FStar_Ident.mk_ident ((bv.ppname.FStar_Ident.idText), (r))); index = uu___97_4255.index; sort = uu___97_4255.sort}))
...
in {v = uu____4330; ty = uu___99_4325.ty; p = uu___99_4325.p}))
in {fv_name = uu____4321; fv_delta = uu___98_4320.fv_delta; fv_qual = uu___98_4320.fv_qual})))


let has_simple_attribute : term Prims.list  ->  Prims.string  ->  Prims.bool = (fun l s -> (FStar_List.existsb (fun uu___94_4355 -> (match (uu___94_4355) with
