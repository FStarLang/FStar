...
<<<<<<< HEAD
let mk = (fun t topt r -> (let _122_1214 = (FStar_Util.mk_ref topt)
in (let _122_1213 = (FStar_Util.mk_ref None)
in {n = t; tk = _122_1214; pos = r; vars = _122_1213})))


let bv_to_tm : bv  ->  term = (fun bv -> (let _122_1217 = (range_of_bv bv)
in (mk (Tm_bvar (bv)) (Some (bv.sort.n)) _122_1217)))


let bv_to_name : bv  ->  term = (fun bv -> (let _122_1220 = (range_of_bv bv)
in (mk (Tm_name (bv)) (Some (bv.sort.n)) _122_1220)))
=======
let mk = (fun t topt r -> (let _123_1213 = (FStar_Util.mk_ref topt)
in (let _123_1212 = (FStar_Util.mk_ref None)
in {n = t; tk = _123_1213; pos = r; vars = _123_1212})))


let bv_to_tm : bv  ->  term = (fun bv -> (let _123_1216 = (range_of_bv bv)
in (mk (Tm_bvar (bv)) (Some (bv.sort.n)) _123_1216)))


let bv_to_name : bv  ->  term = (fun bv -> (let _123_1219 = (range_of_bv bv)
in (mk (Tm_name (bv)) (Some (bv.sort.n)) _123_1219)))
>>>>>>> master
...
<<<<<<< HEAD
let mk_Tm_delayed : ((term * subst_ts), Prims.unit  ->  term) FStar_Util.either  ->  FStar_Range.range  ->  term = (fun lr pos -> (let _122_1255 = (let _122_1254 = (let _122_1253 = (FStar_Util.mk_ref None)
in (lr, _122_1253))
in Tm_delayed (_122_1254))
in (mk _122_1255 None pos)))
=======
let mk_Tm_delayed : ((term * subst_ts), Prims.unit  ->  term) FStar_Util.either  ->  FStar_Range.range  ->  term = (fun lr pos -> (let _123_1254 = (let _123_1253 = (let _123_1252 = (FStar_Util.mk_ref None)
in (lr, _123_1252))
in Tm_delayed (_123_1253))
in (mk _123_1254 None pos)))
>>>>>>> master
...
<<<<<<< HEAD
let null_binder : term  ->  binder = (fun t -> (let _122_1282 = (null_bv t)
in (_122_1282, None)))
=======
let null_binder : term  ->  binder = (fun t -> (let _123_1281 = (null_bv t)
in (_123_1281, None)))
>>>>>>> master
...
<<<<<<< HEAD
let binders_of_freenames : freenames  ->  binders = (fun fvs -> (let _122_1302 = (FStar_Util.set_elements fvs)
in (FStar_All.pipe_right _122_1302 binders_of_list)))
=======
let binders_of_freenames : freenames  ->  binders = (fun fvs -> (let _123_1301 = (FStar_Util.set_elements fvs)
in (FStar_All.pipe_right _123_1301 binders_of_list)))
>>>>>>> master
...
<<<<<<< HEAD
in (let _122_1315 = (aux [] p)
in (FStar_All.pipe_left FStar_List.rev _122_1315))))
=======
in (let _123_1314 = (aux [] p)
in (FStar_All.pipe_left FStar_List.rev _123_1314))))
>>>>>>> master
...
in {ppname = _33_478.ppname; index = _122_1334; sort = _33_478.sort})))
=======
in (let _123_1333 = (next_id ())
in {ppname = _33_478.ppname; index = _123_1333; sort = _33_478.sort})))
>>>>>>> master
...
<<<<<<< HEAD
in (let _122_1343 = (next_id ())
in {ppname = id; index = _122_1343; sort = t})))
=======
in (let _123_1342 = (next_id ())
in {ppname = id; index = _123_1342; sort = t})))
>>>>>>> master
...
let id = (next_id ())
<<<<<<< HEAD
in (let _122_1351 = (let _122_1350 = (FStar_Util.string_of_int id)
in (_122_1350, (range_of_ropt ropt)))
in (FStar_Ident.mk_ident _122_1351))))
=======
in (let _123_1350 = (let _123_1349 = (FStar_Util.string_of_int id)
in (_123_1349, (range_of_ropt ropt)))
in (FStar_Ident.mk_ident _123_1350))))
>>>>>>> master
...
<<<<<<< HEAD
let lid_as_fv : FStar_Ident.lident  ->  delta_depth  ->  fv_qual Prims.option  ->  fv = (fun l dd dq -> (let _122_1380 = (withinfo l tun (FStar_Ident.range_of_lid l))
in {fv_name = _122_1380; fv_delta = dd; fv_qual = dq}))
=======
let lid_as_fv : FStar_Ident.lident  ->  delta_depth  ->  fv_qual Prims.option  ->  fv = (fun l dd dq -> (let _123_1379 = (withinfo l tun (FStar_Ident.range_of_lid l))
in {fv_name = _123_1379; fv_delta = dd; fv_qual = dq}))
>>>>>>> master
...
<<<<<<< HEAD
let fvar : FStar_Ident.lident  ->  delta_depth  ->  fv_qual Prims.option  ->  term = (fun l dd dq -> (let _122_1389 = (lid_as_fv l dd dq)
in (fv_to_tm _122_1389)))
=======
let fvar : FStar_Ident.lident  ->  delta_depth  ->  fv_qual Prims.option  ->  term = (fun l dd dq -> (let _123_1388 = (lid_as_fv l dd dq)
in (fv_to_tm _123_1388)))
>>>>>>> master
