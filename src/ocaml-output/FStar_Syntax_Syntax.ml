...
let contains_reflectable : qualifier Prims.list  ->  Prims.bool = (fun l -> (FStar_Util.for_some (fun uu___96_5356 -> (match (uu___96_5356) with
...
let uu___103_5431 = x
in {ppname = (FStar_Ident.mk_ident ((x.ppname.FStar_Ident.idText), (r))); index = uu___103_5431.index; sort = uu___103_5431.sort}))
...
let mk_Tm_uinst : term  ->  universes  ->  term = (fun t uu___97_5651 -> (match (uu___97_5651) with
| [] -> begin
t
end
| us -> begin
...
let is_top_level : letbinding Prims.list  ->  Prims.bool = (fun uu___98_5963 -> (match (uu___98_5963) with
...
let is_implicit : aqual  ->  Prims.bool = (fun uu___99_6049 -> (match (uu___99_6049) with
...
let as_implicit : Prims.bool  ->  aqual = (fun uu___100_6055 -> (match (uu___100_6055) with
| true -> begin
...
let range_of_ropt : FStar_Range.range FStar_Pervasives_Native.option  ->  FStar_Range.range = (fun uu___101_6333 -> (match (uu___101_6333) with
...
let uu___104_6385 = bv
in (

let uu____6386 = (next_id ())
in {ppname = uu___104_6385.ppname; index = uu____6386; sort = uu___104_6385.sort}))
end)))
...
let uu___105_6508 = bv
in {ppname = (FStar_Ident.mk_ident ((bv.ppname.FStar_Ident.idText), (r))); index = uu___105_6508.index; sort = uu___105_6508.sort}))
...
let uu___106_6564 = fv
in (

let uu____6565 = (

let uu___107_6566 = fv.fv_name
in (
...
in {v = uu____6567; p = uu___107_6566.p}))
in {fv_name = uu____6565; fv_delta = uu___106_6564.fv_delta; fv_qual = uu___106_6564.fv_qual})))


let has_simple_attribute : term Prims.list  ->  Prims.string  ->  Prims.bool = (fun l s -> (FStar_List.existsb (fun uu___102_6588 -> (match (uu___102_6588) with
