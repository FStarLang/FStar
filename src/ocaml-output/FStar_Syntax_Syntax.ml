...
let set_range_of_bv: bv -> FStar_Range.range -> bv =
  fun x  ->
    fun r  ->
      let uu___143_5157 = x in
      {
        ppname = (FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r));
        index = (uu___143_5157.index);
        sort = (uu___143_5157.sort)
      }
let syn:
...
let freshen_bv: bv -> bv =
  fun bv  ->
    ...
    then
      ...
      (let uu___144_6042 = bv in
       let uu____6043 = next_id () in
       {
         ppname = (uu___144_6042.ppname);
         index = uu____6043;
         sort = (uu___144_6042.sort)
       })
let new_univ_name:
...
let set_bv_range: bv -> FStar_Range.range -> bv =
  fun bv  ->
    fun r  ->
      let uu___145_6153 = bv in
      {
        ppname = (FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r));
        index = (uu___145_6153.index);
        sort = (uu___145_6153.sort)
      }
let lid_as_fv:
  FStar_Ident.lident ->
...
let set_range_of_fv: fv -> FStar_Range.range -> fv =
  fun fv  ->
    fun r  ->
      let uu___146_6198 = fv in
      let uu____6199 =
        let uu___147_6200 = fv.fv_name in
        let uu____6201 =
          let uu____6202 = lid_of_fv fv in
          FStar_Ident.set_lid_range uu____6202 r in
        { v = uu____6201; p = (uu___147_6200.p) } in
      {
        fv_name = uu____6199;
        fv_delta = (uu___146_6198.fv_delta);
        fv_qual = (uu___146_6198.fv_qual)
      }
