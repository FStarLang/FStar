  ...
  fun bv1  ->
    fun aq  ->
      let uu____8424 =
        FStar_List.tryFind
          (fun uu____8442  ->
             match uu____8442 with | (bv',uu____8451) -> bv_eq bv1 bv') aq
         in
...
let (bv_to_tm : bv -> term) =
  fun bv1  ->
    let uu____8724 = range_of_bv bv1  in mk (Tm_bvar bv1) uu____8724
  
let (bv_to_name : bv -> term) =
  fun bv1  ->
    let uu____8731 = range_of_bv bv1  in mk (Tm_name bv1) uu____8731
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9244  ->
         fun out  ->
           match uu____9244 with | (x,uu____9257) -> FStar_Util.set_add x out)
      bs no_names
