...
let (uu___is_U_zero : universe -> Prims.bool) =
  fun projectee -> match projectee with | U_zero -> true | uu____202 -> false
...
let (uu___is_Delta_equational : delta_depth -> Prims.bool) =
  fun projectee ->
    match projectee with | Delta_equational -> true | uu____378 -> false
let (uu___is_Delta_abstract : delta_depth -> Prims.bool) =
  fun projectee ->
    match projectee with | Delta_abstract _0 -> true | uu____385 -> false
...
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_bv -> true | uu____404 -> false
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_binder -> true | uu____410 -> false
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_fvar -> true | uu____416 -> false
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_comp -> true | uu____422 -> false
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_env -> true | uu____428 -> false
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_proofstate -> true | uu____434 -> false
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_sigelt -> true | uu____440 -> false
type term' =
  | Tm_bvar of bv 
  | Tm_name of bv 
  | Tm_fvar of fv 
  ...
  | Tm_type of universe 
  | Tm_abs of ((bv, aqual) FStar_Pervasives_Native.tuple2 Prims.list,
  term' syntax, residual_comp FStar_Pervasives_Native.option)
  FStar_Pervasives_Native.tuple3 
  | Tm_arrow of ((bv, aqual) FStar_Pervasives_Native.tuple2 Prims.list,
...
and free_vars =
  ...
  free_uvars:
    ((term' syntax FStar_Pervasives_Native.option FStar_Unionfind.p_uvar,
       version) FStar_Pervasives_Native.tuple2,
      term' syntax) FStar_Pervasives_Native.tuple2 Prims.list
    ;
...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uinst _0 -> true | uu____1425 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_constant _0 -> true | uu____1457 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_type _0 -> true | uu____1471 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_arrow _0 -> true | uu____1575 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_refine _0 -> true | uu____1631 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_app _0 -> true | uu____1677 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_match _0 -> true | uu____1755 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_ascribed _0 -> true | uu____1861 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_let _0 -> true | uu____1965 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uvar _0 -> true | uu____2031 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_delayed _0 -> true | uu____2117 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_meta _0 -> true | uu____2209 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_lazy _0 -> true | uu____2241 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_quoted _0 -> true | uu____2261 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_unknown -> true | uu____2292 -> false
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_constant _0 -> true | uu____2299 -> false
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee -> match projectee with | Pat_constant _0 -> _0
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_cons _0 -> true | uu____2325 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_var _0 -> true | uu____2375 -> false
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee -> match projectee with | Pat_var _0 -> _0
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_wild _0 -> true | uu____2389 -> false
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee -> match projectee with | Pat_wild _0 -> _0
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_dot_term _0 -> true | uu____2409 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Total _0 -> true | uu____2847 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | GTotal _0 -> true | uu____2893 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Comp _0 -> true | uu____2931 -> false
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee -> match projectee with | Comp _0 -> _0
let (uu___is_TOTAL : cflags -> Prims.bool) =
  fun projectee -> match projectee with | TOTAL -> true | uu____2944 -> false
let (uu___is_MLEFFECT : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | MLEFFECT -> true | uu____2950 -> false
let (uu___is_RETURN : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | RETURN -> true | uu____2956 -> false
let (uu___is_PARTIAL_RETURN : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | PARTIAL_RETURN -> true | uu____2962 -> false
let (uu___is_SOMETRIVIAL : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | SOMETRIVIAL -> true | uu____2968 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | SHOULD_NOT_INLINE -> true | uu____2980 -> false
let (uu___is_LEMMA : cflags -> Prims.bool) =
  fun projectee -> match projectee with | LEMMA -> true | uu____2986 -> false
let (uu___is_CPS : cflags -> Prims.bool) =
  fun projectee -> match projectee with | CPS -> true | uu____2992 -> false
let (uu___is_DECREASES : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | DECREASES _0 -> true | uu____3001 -> false
let (__proj__DECREASES__item___0 : cflags -> term' syntax) =
  fun projectee -> match projectee with | DECREASES _0 -> _0
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_pattern _0 -> true | uu____3031 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_named _0 -> true | uu____3075 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_labeled _0 -> true | uu____3095 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_desugared _0 -> true | uu____3127 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic _0 -> true | uu____3147 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____3187 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Sequence -> true | uu____3224 -> false
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Primop -> true | uu____3230 -> false
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Masked_effect -> true | uu____3236 -> false
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_smt_pat -> true | uu____3242 -> false
let (uu___is_Mutable_alloc : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Mutable_alloc -> true | uu____3248 -> false
let (uu___is_Mutable_rval : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Mutable_rval -> true | uu____3254 -> false
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Data_ctor -> true | uu____3260 -> false
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_projector _0 -> true | uu____3271 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_ctor _0 -> true | uu____3303 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | DB _0 -> true | uu____3339 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NM _0 -> true | uu____3369 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NT _0 -> true | uu____3401 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UN _0 -> true | uu____3437 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UD _0 -> true | uu____3467 -> false
...
type branch =
  (pat' withinfo_t, term' syntax FStar_Pervasives_Native.option,
    term' syntax) FStar_Pervasives_Native.tuple3[@@deriving show]
...
type uvars =
  ((term' syntax FStar_Pervasives_Native.option FStar_Unionfind.p_uvar,
     version) FStar_Pervasives_Native.tuple2,
    term' syntax) FStar_Pervasives_Native.tuple2 FStar_Util.set[@@deriving
                                                                 show]
...
let (lcomp_comp : lcomp -> comp) =
  fun lc ->
    let uu____4604 = FStar_ST.op_Bang lc.comp_thunk in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Assumption -> true | uu____4817 -> false
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | New -> true | uu____4823 -> false
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Private -> true | uu____4829 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Visible_default -> true | uu____4841 -> false
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Irreducible -> true | uu____4847 -> false
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Abstract -> true | uu____4853 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | NoExtract -> true | uu____4865 -> false
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____4871 -> false
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Unopteq -> true | uu____4877 -> false
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | TotalEffect -> true | uu____4883 -> false
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reifiable -> true | uu____4889 -> false
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reflectable _0 -> true | uu____4896 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Discriminator _0 -> true | uu____4910 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Projector _0 -> true | uu____4928 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | RecordConstructor _0 -> true | uu____5008 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Action _0 -> true | uu____5046 -> false
...
let (uu___is_ExceptionConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | ExceptionConstructor -> true | uu____5059 -> false
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | HasMaskedEffect -> true | uu____5065 -> false
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Effect -> true | uu____5071 -> false
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | OnlyName -> true | uu____5077 -> false
type tycon =
  (FStar_Ident.lident, binders, typ) FStar_Pervasives_Native.tuple3[@@deriving
                                                                    show]
type monad_abbrev = {
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____6265 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_bundle _0 -> true | uu____6335 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_datacon _0 -> true | uu____6387 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_declare_typ _0 -> true | uu____6449 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_let _0 -> true | uu____6487 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_main _0 -> true | uu____6519 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_assume _0 -> true | uu____6539 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_new_effect _0 -> true | uu____6571 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_sub_effect _0 -> true | uu____6599 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____6625 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_pragma _0 -> true | uu____6675 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_splice _0 -> true | uu____6695 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l ->
    FStar_Util.for_some
      (fun uu___35_6895 ->
         match uu___35_6895 with
         | Reflectable uu____6896 -> true
         | uu____6897 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x ->
    fun r ->
      let uu___42_6983 = x in
      let uu____6984 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r) in
      {
        ppname = uu____6984;
        index = (uu___42_6983.index);
        sort = (uu___42_6983.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____7026 ->
             ...
             | (bv, b, t) -> let uu____7042 = f t in (bv, b, uu____7042))
          qi.antiquotes in
      let uu___43_7043 = qi in
      { qkind = (uu___43_7043.qkind); antiquotes = aq }
let (lookup_aq :
  bv ->
    antiquotations ->
      ...
      let uu____7066 =
        FStar_List.tryFind
          (fun uu____7089 ->
             ...
             | (bv', uu____7099, uu____7100) -> bv_eq bv bv') aq in
      match uu____7066 with
      | FStar_Pervasives_Native.Some (uu____7111, b, e) ->
          FStar_Pervasives_Native.Some (b, e)
      | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
let syn :
  'Auu____7158 'Auu____7159 'Auu____7160 .
    'Auu____7158 ->
      'Auu____7159 ->
        ('Auu____7159 -> 'Auu____7158 -> 'Auu____7160) -> 'Auu____7160
  = fun p -> fun k -> fun f -> f k p
let mk_fvs :
  'Auu____7225 .
    unit -> 'Auu____7225 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____7234 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let mk_uvs :
  'Auu____7276 .
    unit -> 'Auu____7276 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____7285 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____7294 -> FStar_Util.new_set order_bv
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____7303 -> FStar_Util.new_set order_fv
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x ->
    fun y ->
      let uu____7316 = FStar_Ident.text_of_id x in
      let uu____7317 = FStar_Ident.text_of_id y in
      FStar_String.compare uu____7316 uu____7317
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____7324 -> FStar_Util.new_set order_univ_name
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t ->
    fun uu____7377 ->
      fun r ->
        let uu____7381 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
        { n = t; pos = r; vars = uu____7381 }
let (bv_to_tm : bv -> term) =
  fun bv ->
    let uu____7461 = range_of_bv bv in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____7461
let (bv_to_name : bv -> term) =
  fun bv ->
    let uu____7467 = range_of_bv bv in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____7467
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t ->
    fun uu___36_7510 ->
      match uu___36_7510 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____7512 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____7513 -> failwith "Unexpected universe instantiation")
    ...
    fun args' ->
      fun kopt ->
        fun r ->
          ...
          | uu____7568 -> mk_Tm_app t args' kopt r
  ...
  fun lr ->
    fun pos ->
      let uu____7611 =
        let uu____7618 =
          let uu____7619 =
            let uu____7644 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
            (lr, uu____7644) in
          Tm_delayed uu____7619 in
        mk uu____7618 in
      uu____7611 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t -> match t.n with | Tm_type uu____7878 -> true | uu____7879 -> false
...
let (null_binder : term -> binder) =
  fun t ->
    let uu____7897 = null_bv t in (uu____7897, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___37_7930 ->
    match uu___37_7930 with
    | { lbname = FStar_Util.Inr uu____7933; lbunivs = uu____7934;
        lbtyp = uu____7935; lbeff = uu____7936; lbdef = uu____7937;
        lbattrs = uu____7938; lbpos = uu____7939;_}::uu____7940 -> true
    | uu____7953 -> false
    ...
    FStar_List.fold_right
      (fun uu____7971 ->
         fun out ->
           ...
           | (x, uu____7982) -> FStar_Util.set_add x out) bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs ->
    let uu____8017 = FStar_Util.set_elements fvs in
    FStar_All.pipe_right uu____8017 binders_of_list
let (is_implicit : aqual -> Prims.bool) =
  fun uu___38_8026 ->
    match uu___38_8026 with
    | FStar_Pervasives_Native.Some (Implicit uu____8027) -> true
    | uu____8028 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____8067 -> b
      | Pat_constant uu____8074 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____8077, pats) ->
          FStar_List.fold_left
            (fun b1 ->
               fun uu____8108 ->
                 match uu____8108 with | (p2, uu____8120) -> aux b1 p2) b
            pats in
    let uu____8125 = aux [] p in
    FStar_All.pipe_left FStar_List.rev uu____8125
let (gen_reset :
  (unit -> Prims.int, unit -> unit) FStar_Pervasives_Native.tuple2) =
  let x = FStar_Util.mk_ref (Prims.parse_int "0") in
  let gen1 uu____8150 = FStar_Util.incr x; FStar_ST.op_Bang x in
  let reset uu____8361 = FStar_ST.op_Colon_Equals x (Prims.parse_int "0") in
  (gen1, reset)
  ...
  fun s ->
    fun r ->
      fun t ->
        ...
        let uu____8528 = next_id () in
        { ppname = id1; index = uu____8528; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv ->
    let uu____8548 = is_null_bv bv in
    if uu____8548
    then
      let uu____8549 =
        let uu____8552 = range_of_bv bv in
        FStar_Pervasives_Native.Some uu____8552 in
      new_bv uu____8549 bv.sort
    else
      (let uu___44_8554 = bv in
       let uu____8555 = next_id () in
       {
         ppname = (uu___44_8554.ppname);
         index = uu____8555;
         sort = (uu___44_8554.sort)
       })
let (new_univ_name :
  ...
  fun ropt ->
    ...
    let uu____8566 =
      let uu____8571 =
        let uu____8572 = FStar_Util.string_of_int id1 in
        Prims.strcat FStar_Ident.reserved_prefix uu____8572 in
      (uu____8571, (range_of_ropt ropt)) in
    FStar_Ident.mk_ident uu____8566
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv ->
    fun r ->
      let uu___45_8689 = bv in
      let uu____8690 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r) in
      {
        ppname = uu____8690;
        index = (uu___45_8689.index);
        sort = (uu___45_8689.sort)
      }
let (lid_as_fv :
  FStar_Ident.lident ->
  ...
  fun l ->
    fun dd ->
      fun dq ->
        let uu____8710 =
          let uu____8711 = FStar_Ident.range_of_lid l in
          withinfo l uu____8711 in
        { fv_name = uu____8710; fv_delta = dd; fv_qual = dq }
let (fv_to_tm : fv -> term) =
  fun fv ->
    let uu____8717 = FStar_Ident.range_of_lid (fv.fv_name).v in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____8717
let (fvar :
  FStar_Ident.lident ->
  ...
  fun l ->
    fun dd ->
      fun dq -> let uu____8737 = lid_as_fv l dd dq in fv_to_tm uu____8737
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv -> (fv.fv_name).v
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv ->
    let uu____8748 = lid_of_fv fv in FStar_Ident.range_of_lid uu____8748
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv ->
    fun r ->
      let uu___46_8759 = fv in
      let uu____8760 =
        let uu___47_8761 = fv.fv_name in
        let uu____8762 =
          let uu____8763 = lid_of_fv fv in
          FStar_Ident.set_lid_range uu____8763 r in
        { v = uu____8762; p = (uu___47_8761.p) } in
      {
        fv_name = uu____8760;
        fv_delta = (uu___46_8759.fv_delta);
        fv_qual = (uu___46_8759.fv_qual)
      }
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l ->
    fun s ->
      FStar_List.existsb
        (fun uu___41_8785 ->
           match uu___41_8785 with
           | { n = Tm_constant (FStar_Const.Const_string (data, uu____8789));
               pos = uu____8790; vars = uu____8791;_} when data = s -> true
           | uu____8794 -> false) l
  ...
  fun p1 ->
    fun p2 ->
      ...
      | (Pat_cons (fv1, as1), Pat_cons (fv2, as2)) ->
          let uu____8845 = fv_eq fv1 fv2 in
          if uu____8845
          then
            let uu____8847 = FStar_List.zip as1 as2 in
      ...
      | (Pat_var uu____8939, Pat_var uu____8940) -> true
      | (Pat_wild uu____8941, Pat_wild uu____8942) -> true
      | (Pat_dot_term (bv1, t1), Pat_dot_term (bv2, t2)) -> true
      | (uu____8955, uu____8956) -> false
...
let (t_tactic_unit : term' syntax) =
  let uu____8999 =
    let uu____9004 =
      let uu____9005 = tabbrev FStar_Parser_Const.tactic_lid in
      mk_Tm_uinst uu____9005 [U_zero] in
    let uu____9006 = let uu____9007 = as_arg t_unit in [uu____9007] in
...
let (t_tac_unit : term' syntax) =
  let uu____9012 =
    let uu____9017 =
      let uu____9018 = tabbrev FStar_Parser_Const.u_tac_lid in
      mk_Tm_uinst uu____9018 [U_zero] in
    let uu____9019 = let uu____9020 = as_arg t_unit in [uu____9020] in
    mk_Tm_app uu____9017 uu____9019 in
  uu____9012 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_list_of : term -> term) =
  fun t ->
    let uu____9028 =
      let uu____9033 =
        let uu____9034 = tabbrev FStar_Parser_Const.list_lid in
        mk_Tm_uinst uu____9034 [U_zero] in
      let uu____9035 = let uu____9036 = as_arg t in [uu____9036] in
      mk_Tm_app uu____9033 uu____9035 in
    uu____9028 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_option_of : term -> term) =
  fun t ->
    let uu____9044 =
      let uu____9049 =
        let uu____9050 = tabbrev FStar_Parser_Const.option_lid in
        mk_Tm_uinst uu____9050 [U_zero] in
      let uu____9051 = let uu____9052 = as_arg t in [uu____9052] in
...
let (t_tuple2_of : term -> term -> term) =
  fun t1 ->
    fun t2 ->
      let uu____9065 =
        let uu____9070 =
          let uu____9071 = tabbrev FStar_Parser_Const.lid_tuple2 in
          mk_Tm_uinst uu____9071 [U_zero] in
        let uu____9072 =
          let uu____9073 = as_arg t1 in
          let uu____9074 = let uu____9077 = as_arg t2 in [uu____9077] in
          uu____9073 :: uu____9074 in
        mk_Tm_app uu____9070 uu____9072 in
      uu____9065 FStar_Pervasives_Native.None FStar_Range.dummyRange
