...
let set_range_of_bv: bv -> FStar_Range.range -> bv =
  fun x  ->
    fun r  ->
      let uu___117_5431 = x in
      {
        ppname = (FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r));
        index = (uu___117_5431.index);
        sort = (uu___117_5431.sort)
      }
let syn:
...
let freshen_bv: bv -> bv =
  fun bv  ->
    ...
    then
      ...
      (let uu___118_6385 = bv in
       let uu____6386 = next_id () in
       {
         ppname = (uu___118_6385.ppname);
         index = uu____6386;
         sort = (uu___118_6385.sort)
       })
let new_univ_name:
...
let set_bv_range: bv -> FStar_Range.range -> bv =
  fun bv  ->
    fun r  ->
      let uu___119_6508 = bv in
      {
        ppname = (FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r));
        index = (uu___119_6508.index);
        sort = (uu___119_6508.sort)
      }
let lid_as_fv:
  FStar_Ident.lident ->
...
let set_range_of_fv: fv -> FStar_Range.range -> fv =
  fun fv  ->
    fun r  ->
      let uu___120_6564 = fv in
      let uu____6565 =
        let uu___121_6566 = fv.fv_name in
        let uu____6567 =
          let uu____6568 = lid_of_fv fv in
          FStar_Ident.set_lid_range uu____6568 r in
        { v = uu____6567; p = (uu___121_6566.p) } in
      {
        fv_name = uu____6565;
        fv_delta = (uu___120_6564.fv_delta);
        fv_qual = (uu___120_6564.fv_qual)
      }
