...
let (freshen_bv : bv -> bv) =
  fun bv1  ->
    ...
    then
      let uu___1 =
        let uu___2 = range_of_bv bv1  in FStar_Pervasives_Native.Some uu___2
         in
  ...
  fun fv1  ->
    fun r  ->
      ...
      let uu___1 =
        ...
        let uu___3 =
          let uu___4 = lid_of_fv fv1  in FStar_Ident.set_lid_range uu___4 r
           in
  ...
  fun a  ->
    fun b  ->
      ...
      let uu___1 =
        ...
        let uu___3 = let uu___4 = as_arg b  in [uu___4]  in uu___2 :: uu___3
         in
  ...
  fun t1  ->
    fun t2  ->
      ...
      let uu___1 =
        ...
        let uu___3 = let uu___4 = as_arg t2  in [uu___4]  in uu___2 :: uu___3
         in
      mk_Tm_app uu___ uu___1 FStar_Range.dummyRange
