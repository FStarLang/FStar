...
type 'a withinfo_t = {v: 'a; p: FStar_Range.range} [@@deriving show]
...
let uu___is_LightOff : pragma -> Prims.bool =
  fun projectee -> match projectee with LightOff -> true | uu____86 -> false


type 'a memo = 'a FStar_Pervasives_Native.option FStar_ST.ref [@@deriving show]

type version = {major: Prims.int; minor: Prims.int} [@@deriving show]

let __proj__Mkversion__item__major : version -> Prims.int =
  fun projectee ->
    match projectee with {major= __fname__major; minor= __fname__minor; _} ->
      __fname__major
...
type arg_qualifier = Implicit of Prims.bool | Equality [@@deriving show]
...
let uu___is_Equality : arg_qualifier -> Prims.bool =
  fun projectee -> match projectee with Equality -> true | uu____132 -> false
...
let uu___is_U_max : universe -> Prims.bool =
  fun projectee -> match projectee with U_max _0 -> true | uu____187 -> false
...
type term' =
  ...
  | Tm_type of universe
  | Tm_abs of
      ( (bv, aqual) FStar_Pervasives_Native.tuple2 Prims.list
      , term' syntax
...
let __proj__Pat_cons__item___0
    : pat'
      -> ( fv
         , (pat' withinfo_t, Prims.bool) FStar_Pervasives_Native.tuple2
           Prims.list )
         FStar_Pervasives_Native.tuple2 =
...
let __proj__Mkletbinding__item__lbname
  ...
  fun projectee ->
    match projectee
    with
    | { lbname= __fname__lbname
      ; lbunivs= __fname__lbunivs
      ; lbtyp= __fname__lbtyp
      ; lbeff= __fname__lbeff
      ; lbdef= __fname__lbdef
      ; lbattrs= __fname__lbattrs; _ }
    -> __fname__lbname
...
let __proj__Mkletbinding__item__lbattrs : letbinding -> term' syntax Prims.list =
  fun projectee ->
    match projectee
    with
    | { lbname= __fname__lbname
...
let __proj__Mkcomp_typ__item__comp_univs : comp_typ -> universes =
  fun projectee ->
    match projectee
    with
    | { comp_univs= __fname__comp_univs
      ; effect_name= __fname__effect_name
      ; result_typ= __fname__result_typ
      ; effect_args= __fname__effect_args
      ; flags= __fname__flags; _ }
    -> __fname__comp_univs
...
let uu___is_Comp : comp' -> Prims.bool =
  fun projectee -> match projectee with Comp _0 -> true | uu____2357 -> false
...
let uu___is_TOTAL : cflags -> Prims.bool =
  fun projectee -> match projectee with TOTAL -> true | uu____2368 -> false
...
let uu___is_RETURN : cflags -> Prims.bool =
  fun projectee -> match projectee with RETURN -> true | uu____2376 -> false
...
let uu___is_TRIVIAL_POSTCONDITION : cflags -> Prims.bool =
  fun projectee ->
    match projectee with TRIVIAL_POSTCONDITION -> true | uu____2388 -> false
...
let uu___is_LEMMA : cflags -> Prims.bool =
  fun projectee -> match projectee with LEMMA -> true | uu____2396 -> false
...
let uu___is_Primop : meta_source_info -> Prims.bool =
  fun projectee -> match projectee with Primop -> true | uu____2668 -> false
...
let uu___is_DB : subst_elt -> Prims.bool =
  fun projectee -> match projectee with DB _0 -> true | uu____2761 -> false
...
let uu___is_NM : subst_elt -> Prims.bool =
  fun projectee -> match projectee with NM _0 -> true | uu____2789 -> false
...
let uu___is_NT : subst_elt -> Prims.bool =
  fun projectee -> match projectee with NT _0 -> true | uu____2819 -> false
...
let uu___is_UN : subst_elt -> Prims.bool =
  fun projectee -> match projectee with UN _0 -> true | uu____2853 -> false
...
let uu___is_UD : subst_elt -> Prims.bool =
  fun projectee -> match projectee with UD _0 -> true | uu____2881 -> false
...
let __proj__Mksyntax__item__n: 'a. 'a syntax -> 'a =
  fun projectee ->
    match projectee
    with {n= __fname__n; pos= __fname__pos; vars= __fname__vars; _} ->
      __fname__n
...
let __proj__Mkbv__item__ppname : bv -> FStar_Ident.ident =
  fun projectee ->
    match projectee
    with
    | {ppname= __fname__ppname; index= __fname__index; sort= __fname__sort; _}
    -> __fname__ppname
...
let __proj__Mkfv__item__fv_name : fv -> var =
  fun projectee ->
    match projectee
    with
    | { fv_name= __fname__fv_name
      ; fv_delta= __fname__fv_delta
      ; fv_qual= __fname__fv_qual; _ }
    -> __fname__fv_name
...
let __proj__Mkfree_vars__item__free_names : free_vars -> bv Prims.list =
  fun projectee ->
    match projectee
    with
    | { free_names= __fname__free_names
      ; free_uvars= __fname__free_uvars
...
let __proj__Mklcomp__item__eff_name : lcomp -> FStar_Ident.lident =
  fun projectee ->
    match projectee
    with
    | { eff_name= __fname__eff_name
      ; res_typ= __fname__res_typ
      ; cflags= __fname__cflags
      ; comp_thunk= __fname__comp_thunk; _ }
    -> __fname__eff_name
...
let __proj__Mklcomp__item__comp_thunk
    : lcomp
      -> (Prims.unit -> comp' syntax, comp' syntax) FStar_Util.either
         FStar_ST.ref =
  fun projectee ->
    match projectee
    with
...
type arg =
  (term' syntax, aqual) FStar_Pervasives_Native.tuple2
  [@@deriving show]
...
let mk_lcomp
    : FStar_Ident.lident -> typ -> cflags Prims.list -> (Prims.unit -> comp)
      -> lcomp =
  fun eff_name res_typ cflags comp_thunk ->
...
type tscheme =
  (univ_name Prims.list, typ) FStar_Pervasives_Native.tuple2
  [@@deriving show]
...
let uu___is_Private : qualifier -> Prims.bool =
  fun projectee -> match projectee with Private -> true | uu____3786 -> false
...
let uu___is_Inline_for_extraction : qualifier -> Prims.bool =
  fun projectee ->
    match projectee with Inline_for_extraction -> true | uu____3806 -> false
...
let uu___is_Noeq : qualifier -> Prims.bool =
  fun projectee -> match projectee with Noeq -> true | uu____3814 -> false


let uu___is_Unopteq : qualifier -> Prims.bool =
  fun projectee -> match projectee with Unopteq -> true | uu____3818 -> false
...
let uu___is_Logic : qualifier -> Prims.bool =
  fun projectee -> match projectee with Logic -> true | uu____3826 -> false
...
let uu___is_ExceptionConstructor : qualifier -> Prims.bool =
  fun projectee ->
    match projectee with ExceptionConstructor -> true | uu____3986 -> false
...
let uu___is_Effect : qualifier -> Prims.bool =
  fun projectee -> match projectee with Effect -> true | uu____3994 -> false
...
let __proj__Mkmonad_abbrev__item__mabbrev : monad_abbrev -> FStar_Ident.lident =
  fun projectee ->
    match projectee
    with
    | {mabbrev= __fname__mabbrev; parms= __fname__parms; def= __fname__def; _}
    -> __fname__mabbrev
...
let __proj__Mksub_eff__item__source : sub_eff -> FStar_Ident.lident =
  fun projectee ->
    match projectee
    with
    | { source= __fname__source
      ; target= __fname__target
      ; lift_wp= __fname__lift_wp
      ; lift= __fname__lift; _ }
    -> __fname__source
...
let __proj__Mkeff_decl__item__cattributes : eff_decl -> cflags Prims.list =
  fun projectee ->
    match projectee
    with
    | { cattributes= __fname__cattributes
      ; mname= __fname__mname
      ; univs= __fname__univs
      ; binders= __fname__binders
      ; signature= __fname__signature
      ; ret_wp= __fname__ret_wp
      ; bind_wp= __fname__bind_wp
      ; if_then_else= __fname__if_then_else
      ; ite_wp= __fname__ite_wp
      ; stronger= __fname__stronger
      ; close_wp= __fname__close_wp
      ; assert_p= __fname__assert_p
      ; assume_p= __fname__assume_p
      ; null_wp= __fname__null_wp
      ; trivial= __fname__trivial
      ; repr= __fname__repr
      ; return_repr= __fname__return_repr
      ; bind_repr= __fname__bind_repr
      ; actions= __fname__actions; _ }
...
let __proj__Mksigelt__item__sigel : sigelt -> sigelt' =
  fun projectee ->
    match projectee
    with
    | { sigel= __fname__sigel
      ; sigrng= __fname__sigrng
      ; sigquals= __fname__sigquals
      ; sigmeta= __fname__sigmeta
      ; sigattrs= __fname__sigattrs; _ }
    -> __fname__sigel
...
let __proj__Mkmodul__item__name : modul -> FStar_Ident.lident =
  fun projectee ->
    ...
    with
    | { name= __fname__name
      ; declarations= __fname__declarations
      ; exports= __fname__exports
      ; is_interface= __fname__is_interface; _ }
    -> __fname__name
...
let order_fv : FStar_Ident.lident -> FStar_Ident.lident -> Prims.int =
  fun x y -> FStar_String.compare x.FStar_Ident.str y.FStar_Ident.str
...
let syn:
      'Auu____5562 'Auu____5563 'Auu____5564. 'Auu____5564 -> 'Auu____5563
      -> ('Auu____5563 -> 'Auu____5564 -> 'Auu____5562) -> 'Auu____5562 =
  fun p k f -> f k p


let mk_fvs:
      'Auu____5600. Prims.unit
      -> 'Auu____5600 FStar_Pervasives_Native.option FStar_ST.ref =
  fun uu____5608 -> FStar_Util.mk_ref FStar_Pervasives_Native.None


let mk_uvs:
      'Auu____5624. Prims.unit
      -> 'Auu____5624 FStar_Pervasives_Native.option FStar_ST.ref =
...
let order_univ_name : univ_name -> univ_name -> Prims.int =
  fun x y ->
    FStar_String.compare (FStar_Ident.text_of_id x) (FStar_Ident.text_of_id y)
...
let mk_Tm_app : term -> args -> mk_t =
  fun t1 args k p ->
    match args with
    | [] -> t1
    | uu____5756 -> mk (Tm_app (t1, args)) FStar_Pervasives_Native.None p
...
let extend_app : term -> arg -> mk_t =
  fun t arg kopt r -> extend_app_n t [arg] kopt r


let mk_Tm_delayed
    : (term, subst_ts) FStar_Pervasives_Native.tuple2 -> FStar_Range.range
      -> term =
  fun lr pos ->
    let uu____5843 =
      let uu____5846 =
...
let mk_Total' : typ -> universe FStar_Pervasives_Native.option -> comp =
  fun t u -> mk (Total (t, u)) FStar_Pervasives_Native.None t.pos


let mk_GTotal' : typ -> universe FStar_Pervasives_Native.option -> comp =
  fun t u -> mk (GTotal (t, u)) FStar_Pervasives_Native.None t.pos
...
let mk_lb
  ...
  fun uu____5967 ->
    match uu____5967 with x, univs, eff, t, e ->
      {lbname= x; lbunivs= univs; lbtyp= t; lbeff= eff; lbdef= e; lbattrs= []}
...
let is_top_level : letbinding Prims.list -> Prims.bool =
  fun uu___32_6059 ->
    ...
    | { lbname= FStar_Util.Inr uu____6062
      ; lbunivs= uu____6063
      ; lbtyp= uu____6064
      ; lbeff= uu____6065
      ; lbdef= uu____6066
      ; lbattrs= uu____6067; _ }
      :: uu____6068 ->
        true
    | uu____6081 -> false
...
let as_implicit : Prims.bool -> aqual =
  fun uu___34_6151 ->
    if uu___34_6151 then FStar_Pervasives_Native.Some imp_tag
    ...
    let rec aux b p1 =
      ...
      | Pat_cons (uu____6189, pats) ->
          FStar_List.fold_left
            (fun b1 uu____6220 ->
              match uu____6220 with p2, uu____6232 -> aux b1 p2 )
            b pats
    in
...
let gen_bv
    : Prims.string -> FStar_Range.range FStar_Pervasives_Native.option -> typ
      -> bv =
  fun s r t ->
...
let new_bv : FStar_Range.range FStar_Pervasives_Native.option -> typ -> bv =
  fun ropt t -> gen_bv FStar_Ident.reserved_prefix ropt t
  ...
  fun bv ->
    ...
    if uu____6439 then
      let uu____6440 =
        ...
        FStar_Pervasives_Native.Some uu____6443
      in
      new_bv uu____6440 bv.sort
    else
      let uu___38_6445 = bv in
      let uu____6446 = next_id () in
      {ppname= uu___38_6445.ppname; index= uu____6446; sort= uu___38_6445.sort}
  ...
  fun ropt ->
    ...
    let uu____6455 =
      let uu____6460 =
        ...
        Prims.strcat FStar_Ident.reserved_prefix uu____6461
      in
      (uu____6460, range_of_ropt ropt)
    in
    FStar_Ident.mk_ident uu____6455


let mkbv : FStar_Ident.ident -> Prims.int -> term' syntax -> bv =
  fun x y t -> {ppname= x; index= y; sort= t}
...
let fv_eq : fv -> fv -> Prims.bool =
  fun fv1 fv2 -> FStar_Ident.lid_equals fv1.fv_name.v fv2.fv_name.v


let fv_eq_lid : fv -> FStar_Ident.lident -> Prims.bool =
  fun fv lid -> FStar_Ident.lid_equals fv.fv_name.v lid
...
let lid_as_fv
    : FStar_Ident.lident -> delta_depth
      -> fv_qual FStar_Pervasives_Native.option -> fv =
  fun l dd dq ->
...
let fvar
    : FStar_Ident.lident -> delta_depth
      -> fv_qual FStar_Pervasives_Native.option -> term =
  fun l dd dq ->
    let uu____6587 = lid_as_fv l dd dq in
    fv_to_tm uu____6587
...
let range_of_fv : fv -> FStar_Range.range =
  fun fv ->
    let uu____6594 = lid_of_fv fv in
    FStar_Ident.range_of_lid uu____6594
  ...
  fun fv r ->
    ...
    let uu____6602 =
      ...
      let uu____6604 =
        ...
        FStar_Ident.set_lid_range uu____6605 r
      in
      {v= uu____6604; p= uu___41_6603.p}
    in
    { fv_name= uu____6602
    ...
    | Pat_cons (fv1, as1), Pat_cons (fv2, as2) ->
        ...
        if uu____6679 then
          ...
          FStar_All.pipe_right uu____6683
            (FStar_List.for_all (fun uu____6749 ->
                 match uu____6749 with (p11, b1), (p21, b2) ->
                   b1 = b2 && eq_pat p11 p21 ))
        else false
...
let tconst : FStar_Ident.lident -> term =
  fun l ->
    let uu____6796 =
      let uu____6799 =
        let uu____6800 =
          lid_as_fv l Delta_constant FStar_Pervasives_Native.None
        in
        Tm_fvar uu____6800
      in
      mk uu____6799
...
let tdataconstr : FStar_Ident.lident -> term =
  fun l ->
    let uu____6818 =
      lid_as_fv l Delta_constant (FStar_Pervasives_Native.Some Data_ctor)
    in
    fv_to_tm uu____6818
...
let t_tactic_unit : term' syntax =
  let uu____6821 =
    let uu____6822 =
      ...
      mk_Tm_uinst uu____6823 [U_zero]
    in
    let uu____6824 =
      let uu____6825 = as_arg t_unit in
      [uu____6825]
    in
    mk_Tm_app uu____6822 uu____6824
  in
...
let t_tac_unit : term' syntax =
  let uu____6830 =
    let uu____6831 =
      ...
      mk_Tm_uinst uu____6832 [U_zero]
    in
    let uu____6833 =
      let uu____6834 = as_arg t_unit in
      [uu____6834]
    in
    mk_Tm_app uu____6831 uu____6833
  in
  ...
  fun t ->
    let uu____6840 =
      let uu____6841 =
        ...
        mk_Tm_uinst uu____6842 [U_zero]
      in
      let uu____6843 =
        let uu____6844 = as_arg t in
        [uu____6844]
      in
      mk_Tm_app uu____6841 uu____6843
    in
  ...
  fun t ->
    let uu____6850 =
      let uu____6851 =
        ...
        mk_Tm_uinst uu____6852 [U_zero]
      in
      let uu____6853 =
        let uu____6854 = as_arg t in
        [uu____6854]
      in
      mk_Tm_app uu____6851 uu____6853
    in
