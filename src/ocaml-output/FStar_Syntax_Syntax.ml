...
let contains_reflectable : qualifier Prims.list  ->  Prims.bool = (fun l -> (FStar_Util.for_some (fun uu___88_3224 -> (match (uu___88_3224) with
...
let uu___95_3302 = x
in {ppname = (FStar_Ident.mk_ident ((x.ppname.FStar_Ident.idText), (r))); index = uu___95_3302.index; sort = uu___95_3302.sort}))
...
let mk_Tm_uinst : term  ->  universes  ->  term = (fun t uu___89_3649 -> (match (uu___89_3649) with
| [] -> begin
t
end
| us -> begin
...
let is_top_level : letbinding Prims.list  ->  Prims.bool = (fun uu___90_3947 -> (match (uu___90_3947) with
...
let is_implicit : aqual  ->  Prims.bool = (fun uu___91_4000 -> (match (uu___91_4000) with
...
let as_implicit : Prims.bool  ->  aqual = (fun uu___92_4005 -> (match (uu___92_4005) with
| true -> begin
Some (imp_tag)
end
| uu____4006 -> begin
...
let range_of_ropt : FStar_Range.range Prims.option  ->  FStar_Range.range = (fun uu___93_4121 -> (match (uu___93_4121) with
| None -> begin
...
in {ppname = uu___96_4153.ppname; index = uu____4154; sort = uu___96_4153.sort}))
end)))
...
let uu___97_4246 = bv
in {ppname = (FStar_Ident.mk_ident ((bv.ppname.FStar_Ident.idText), (r))); index = uu___97_4246.index; sort = uu___97_4246.sort}))
...
in {v = uu____4321; ty = uu___99_4316.ty; p = uu___99_4316.p}))
in {fv_name = uu____4312; fv_delta = uu___98_4311.fv_delta; fv_qual = uu___98_4311.fv_qual})))


let has_simple_attribute : term Prims.list  ->  Prims.string  ->  Prims.bool = (fun l s -> (FStar_List.existsb (fun uu___94_4346 -> (match (uu___94_4346) with
