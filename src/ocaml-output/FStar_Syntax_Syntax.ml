...
let (uu___is_U_zero : universe -> Prims.bool) =
  fun projectee -> match projectee with | U_zero -> true | uu____485 -> false
...
let (uu___is_Strict : should_check_uvar -> Prims.bool) =
  fun projectee -> match projectee with | Strict -> true | uu____819 -> false
type term' =
  | Tm_bvar of bv 
  | Tm_name of bv 
  | Tm_fvar of fv 
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____5893 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____5926 -> false
...
let (uu___is_ExceptionConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | ExceptionConstructor -> true | uu____6142 -> false
  ...
  fun bv ->
    fun aq ->
      let uu____8156 =
        FStar_List.tryFind
          (fun uu____8174 ->
             match uu____8174 with | (bv', uu____8183) -> bv_eq bv bv') aq in
    ...
    FStar_List.fold_right
      (fun uu____9041 ->
         fun out ->
           ...
           | (x, uu____9054) -> FStar_Util.set_add x out) bs no_names
    ...
    let rec aux b p1 =
      ...
      | Pat_cons (uu____9159, pats) ->
          FStar_List.fold_left
            (fun b1 ->
               fun uu____9193 ->
                 match uu____9193 with | (p2, uu____9206) -> aux b1 p2) b
            pats in
