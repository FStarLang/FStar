...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7278 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7353 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7411 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7481 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7524 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7561 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7586 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7623 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7642 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7673 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7728 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7753 -> false
...
let (uu___is_Sig_fail : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_fail _0 -> true | uu____7912 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___0_8189  ->
         match uu___0_8189 with
         | Reflectable uu____8191 -> true
         | uu____8193 -> false) l
...
let (order_bv : bv -> bv -> Prims.int) =
  fun x  ->
    fun y  ->
      let i =
        let uu____8255 = FStar_Ident.text_of_id x.ppname  in
        let uu____8257 = FStar_Ident.text_of_id y.ppname  in
        FStar_String.compare uu____8255 uu____8257  in
      if i = Prims.int_zero then x.index - y.index else i
  
let (order_ident : FStar_Ident.ident -> FStar_Ident.ident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8277 = FStar_Ident.text_of_id x  in
      let uu____8279 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8277 uu____8279
  
let (order_fv : FStar_Ident.lident -> FStar_Ident.lident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8293 = FStar_Ident.string_of_lid x  in
      let uu____8295 = FStar_Ident.string_of_lid y  in
      FStar_String.compare uu____8293 uu____8295
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___415_8322 = x  in
      let uu____8323 = FStar_Ident.set_id_range r x.ppname  in
      {
        ppname = uu____8323;
        index = (uu___415_8322.index);
        sort = (uu___415_8322.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8359  ->
             ...
             | (bv1,t) -> let uu____8370 = f t  in (bv1, uu____8370))
          qi.antiquotes
         in
      let uu___423_8371 = qi  in
      { qkind = (uu___423_8371.qkind); antiquotes = aq }
  ...
  fun bv1  ->
    fun aq  ->
      let uu____8387 =
        FStar_List.tryFind
          (fun uu____8405  ->
             match uu____8405 with | (bv',uu____8414) -> bv_eq bv1 bv') aq
         in
      match uu____8387 with
      | FStar_Pervasives_Native.Some (uu____8421,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'uuuuuu8452 'uuuuuu8453 'uuuuuu8454 .
    'uuuuuu8452 ->
      'uuuuuu8453 ->
        ('uuuuuu8453 -> 'uuuuuu8452 -> 'uuuuuu8454) -> 'uuuuuu8454
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'uuuuuu8485 .
    unit -> 'uuuuuu8485 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8494  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'uuuuuu8502 .
    unit -> 'uuuuuu8502 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8511  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8521  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8531  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8541  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8556 = FStar_Ident.text_of_id x  in
      let uu____8558 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8556 uu____8558
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8567  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8586),Binding_lid (lid2,uu____8588)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8677  ->
      fun r  ->
        let uu____8681 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8681 }
  
let (bv_to_tm : bv -> term) =
  fun bv1  ->
    let uu____8692 = range_of_bv bv1  in
    mk (Tm_bvar bv1) FStar_Pervasives_Native.None uu____8692
  
let (bv_to_name : bv -> term) =
  fun bv1  ->
    let uu____8699 = range_of_bv bv1  in
    mk (Tm_name bv1) FStar_Pervasives_Native.None uu____8699
...
let (binders_to_names : binders -> term Prims.list) =
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____8729  ->
            match uu____8729 with | (x,uu____8737) -> bv_to_name x))
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun us  ->
      ...
      | uu____8797 -> failwith "Unexpected universe instantiation"
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8856 -> mk_Tm_app t args' kopt r
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9101 -> true | uu____9103 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9129 = null_bv t  in (uu____9129, FStar_Pervasives_Native.None)
...
let (is_null_bv : bv -> Prims.bool) =
  fun b  ->
    let uu____9161 = FStar_Ident.text_of_id b.ppname  in
    let uu____9163 = FStar_Ident.text_of_id null_id  in
    uu____9161 = uu____9163
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___1_9183  ->
    match uu___1_9183 with
    | { lbname = FStar_Util.Inr uu____9187; lbunivs = uu____9188;
        lbtyp = uu____9189; lbeff = uu____9190; lbdef = uu____9191;
        lbattrs = uu____9192; lbpos = uu____9193;_}::uu____9194 -> true
    | uu____9208 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9230  ->
         fun out  ->
           match uu____9230 with | (x,uu____9243) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9276 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9276 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___2_9287  ->
    match uu___2_9287 with
    | FStar_Pervasives_Native.Some (Implicit uu____9289) -> true
    | uu____9292 -> false
  
let (is_implicit_or_meta : aqual -> Prims.bool) =
  fun uu___3_9300  ->
    match uu___3_9300 with
    | FStar_Pervasives_Native.Some (Implicit uu____9302) -> true
    | FStar_Pervasives_Native.Some (Meta uu____9305) -> true
    | uu____9309 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9355 -> b
      | Pat_constant uu____9362 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9365,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9399  ->
                 match uu____9399 with | (p2,uu____9412) -> aux b1 p2) b pats
       in
    let uu____9419 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9419
  
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_9433  ->
    match uu___5_9433 with
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9473 = FStar_Ident.next_id ()  in
        { ppname = id; index = uu____9473; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv1  ->
    let uu____9496 = is_null_bv bv1  in
    if uu____9496
    then
      let uu____9499 =
        let uu____9502 = range_of_bv bv1  in
        FStar_Pervasives_Native.Some uu____9502  in
      new_bv uu____9499 bv1.sort
    else
      (let uu___613_9505 = bv1  in
       let uu____9506 = FStar_Ident.next_id ()  in
       {
         ppname = (uu___613_9505.ppname);
         index = uu____9506;
         sort = (uu___613_9505.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv1,aq) -> let uu____9521 = freshen_bv bv1  in (uu____9521, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9536 =
      let uu____9542 =
        let uu____9544 = FStar_Util.string_of_int id  in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____9544  in
      (uu____9542, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9536
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv1  ->
    fun r  ->
      let uu___640_9653 = bv1  in
      let uu____9654 = FStar_Ident.set_id_range r bv1.ppname  in
      {
        ppname = uu____9654;
        index = (uu___640_9653.index);
        sort = (uu___640_9653.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____9675 =
          let uu____9676 = FStar_Ident.range_of_lid l  in
          withinfo l uu____9676  in
        { fv_name = uu____9675; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv1  ->
    let uu____9683 = FStar_Ident.range_of_lid (fv1.fv_name).v  in
    mk (Tm_fvar fv1) FStar_Pervasives_Native.None uu____9683
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9704 = lid_as_fv l dd dq  in fv_to_tm uu____9704
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv1  -> (fv1.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv1  ->
    let uu____9717 = lid_of_fv fv1  in FStar_Ident.range_of_lid uu____9717
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv1  ->
    fun r  ->
      let uu___653_9729 = fv1  in
      let uu____9730 =
        let uu___655_9731 = fv1.fv_name  in
        let uu____9732 =
          let uu____9733 = lid_of_fv fv1  in
          FStar_Ident.set_lid_range uu____9733 r  in
        { v = uu____9732; p = (uu___655_9731.p) }  in
      {
        fv_name = uu____9730;
        fv_delta = (uu___653_9729.fv_delta);
        fv_qual = (uu___653_9729.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9759  ->
           match uu___6_9759 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9764));
               pos = uu____9765; vars = uu____9766;_} when data = s -> true
           | uu____9773 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9832 = fv_eq fv1 fv2  in
          if uu____9832
          then
            let uu____9837 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____9942,Pat_var uu____9943) -> true
      | (Pat_wild uu____9945,Pat_wild uu____9946) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____9961,uu____9962) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____9980 =
      let uu____9987 = let uu____9988 = fvconst l  in Tm_fvar uu____9988  in
      mk uu____9987  in
...
let (t_tac_of : term -> term -> term) =
  fun a  ->
    fun b  ->
      let uu____10041 =
        let uu____10046 =
          let uu____10047 = tabbrev FStar_Parser_Const.tac_lid  in
          mk_Tm_uinst uu____10047 [U_zero; U_zero]  in
        let uu____10048 =
          let uu____10049 = as_arg a  in
          let uu____10058 = let uu____10069 = as_arg b  in [uu____10069]  in
...
let (t_tactic_of : term -> term) =
  fun t  ->
    let uu____10108 =
      let uu____10113 =
        let uu____10114 = tabbrev FStar_Parser_Const.tactic_lid  in
        mk_Tm_uinst uu____10114 [U_zero]  in
      let uu____10115 = let uu____10116 = as_arg t  in [uu____10116]  in
      mk_Tm_app uu____10113 uu____10115  in
...
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10148 =
      let uu____10153 =
        let uu____10154 = tabbrev FStar_Parser_Const.list_lid  in
...
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10187 =
      let uu____10192 =
        let uu____10193 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10193 [U_zero]  in
      let uu____10194 = let uu____10195 = as_arg t  in [uu____10195]  in
      mk_Tm_app uu____10192 uu____10194  in
    uu____10187 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10231 =
        let uu____10236 =
          let uu____10237 = tabbrev FStar_Parser_Const.lid_tuple2  in
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10303 =
        let uu____10308 =
          let uu____10309 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10309 [U_zero; U_zero]  in
        let uu____10310 =
          let uu____10311 = as_arg t1  in
          let uu____10320 = let uu____10331 = as_arg t2  in [uu____10331]  in
          uu____10311 :: uu____10320  in
        mk_Tm_app uu____10308 uu____10310  in
      uu____10303 FStar_Pervasives_Native.None FStar_Range.dummyRange
