...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uinst _0 -> true | uu____1255 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_constant _0 -> true | uu____1285 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_type _0 -> true | uu____1297 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_abs _0 -> true | uu____1325 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_arrow _0 -> true | uu____1397 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_app _0 -> true | uu____1495 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_match _0 -> true | uu____1571 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_ascribed _0 -> true | uu____1675 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_let _0 -> true | uu____1777 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uvar _0 -> true | uu____1841 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_delayed _0 -> true | uu____1925 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_meta _0 -> true | uu____2015 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_lazy _0 -> true | uu____2045 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_quoted _0 -> true | uu____2063 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_unknown -> true | uu____2092 -> false
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_constant _0 -> true | uu____2097 -> false
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee -> match projectee with | Pat_constant _0 -> _0
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_cons _0 -> true | uu____2121 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_var _0 -> true | uu____2169 -> false
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee -> match projectee with | Pat_var _0 -> _0
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_wild _0 -> true | uu____2181 -> false
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee -> match projectee with | Pat_wild _0 -> _0
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee ->
    match projectee with | Pat_dot_term _0 -> true | uu____2199 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Total _0 -> true | uu____2607 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | GTotal _0 -> true | uu____2651 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Comp _0 -> true | uu____2687 -> false
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee -> match projectee with | Comp _0 -> _0
let (uu___is_TOTAL : cflags -> Prims.bool) =
  fun projectee -> match projectee with | TOTAL -> true | uu____2698 -> false
let (uu___is_MLEFFECT : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | MLEFFECT -> true | uu____2702 -> false
let (uu___is_RETURN : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | RETURN -> true | uu____2706 -> false
let (uu___is_PARTIAL_RETURN : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | PARTIAL_RETURN -> true | uu____2710 -> false
let (uu___is_SOMETRIVIAL : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | SOMETRIVIAL -> true | uu____2714 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | SHOULD_NOT_INLINE -> true | uu____2722 -> false
let (uu___is_LEMMA : cflags -> Prims.bool) =
  fun projectee -> match projectee with | LEMMA -> true | uu____2726 -> false
let (uu___is_CPS : cflags -> Prims.bool) =
  fun projectee -> match projectee with | CPS -> true | uu____2730 -> false
let (uu___is_DECREASES : cflags -> Prims.bool) =
  fun projectee ->
    match projectee with | DECREASES _0 -> true | uu____2737 -> false
let (__proj__DECREASES__item___0 : cflags -> term' syntax) =
  fun projectee -> match projectee with | DECREASES _0 -> _0
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_pattern _0 -> true | uu____2765 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_named _0 -> true | uu____2807 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_labeled _0 -> true | uu____2825 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_desugared _0 -> true | uu____2855 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic _0 -> true | uu____2873 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____2911 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Sequence -> true | uu____2946 -> false
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Primop -> true | uu____2950 -> false
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Masked_effect -> true | uu____2954 -> false
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_smt_pat -> true | uu____2958 -> false
let (uu___is_Mutable_alloc : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Mutable_alloc -> true | uu____2962 -> false
let (uu___is_Mutable_rval : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Mutable_rval -> true | uu____2966 -> false
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Data_ctor -> true | uu____2970 -> false
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_projector _0 -> true | uu____2979 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_ctor _0 -> true | uu____3009 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | DB _0 -> true | uu____3043 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NM _0 -> true | uu____3071 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NT _0 -> true | uu____3101 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UN _0 -> true | uu____3135 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UD _0 -> true | uu____3163 -> false
...
let (mk_lcomp :
  ...
  fun eff_name ->
    fun res_typ ->
      fun cflags ->
        fun comp_thunk ->
          let uu____4124 = FStar_Util.mk_ref (FStar_Util.Inl comp_thunk) in
          { eff_name; res_typ; cflags; comp_thunk = uu____4124 }
let (lcomp_comp : lcomp -> comp) =
  fun lc ->
    let uu____4222 = FStar_ST.op_Bang lc.comp_thunk in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Assumption -> true | uu____4410 -> false
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | New -> true | uu____4414 -> false
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Private -> true | uu____4418 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Visible_default -> true | uu____4426 -> false
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Irreducible -> true | uu____4430 -> false
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Abstract -> true | uu____4434 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | NoExtract -> true | uu____4442 -> false
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____4446 -> false
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Unopteq -> true | uu____4450 -> false
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | TotalEffect -> true | uu____4454 -> false
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reifiable -> true | uu____4458 -> false
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reflectable _0 -> true | uu____4463 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Discriminator _0 -> true | uu____4475 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Projector _0 -> true | uu____4491 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | RecordType _0 -> true | uu____4523 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | RecordConstructor _0 -> true | uu____4567 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Action _0 -> true | uu____4603 -> false
...
let (uu___is_ExceptionConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | ExceptionConstructor -> true | uu____4614 -> false
...
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Effect -> true | uu____4622 -> false
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | OnlyName -> true | uu____4626 -> false
type tycon =
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____5683 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_bundle _0 -> true | uu____5751 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_datacon _0 -> true | uu____5801 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_declare_typ _0 -> true | uu____5861 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_let _0 -> true | uu____5897 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_main _0 -> true | uu____5927 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_assume _0 -> true | uu____5945 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_new_effect _0 -> true | uu____5975 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_sub_effect _0 -> true | uu____5999 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____6023 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_pragma _0 -> true | uu____6071 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_splice _0 -> true | uu____6083 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l ->
    FStar_Util.for_some
      (fun uu___33_6235 ->
         match uu___33_6235 with
         | Reflectable uu____6236 -> true
         | uu____6237 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x ->
    fun r ->
      let uu___40_6295 = x in
      {
        ppname = (FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r));
        index = (uu___40_6295.index);
        sort = (uu___40_6295.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____6333 ->
             ...
             | (bv, b, t) -> let uu____6349 = f t in (bv, b, uu____6349))
          qi.antiquotes in
      let uu___41_6350 = qi in
      { qkind = (uu___41_6350.qkind); antiquotes = aq }
let (lookup_aq :
  bv ->
    antiquotations ->
      ...
      let uu____6369 =
        FStar_List.tryFind
          (fun uu____6392 ->
             ...
             | (bv', uu____6402, uu____6403) -> bv_eq bv bv') aq in
      match uu____6369 with
      | FStar_Pervasives_Native.Some (uu____6414, b, e) ->
          FStar_Pervasives_Native.Some (b, e)
      | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
let syn :
  'Auu____6455 'Auu____6456 'Auu____6457 .
    'Auu____6455 ->
      'Auu____6456 ->
        ('Auu____6456 -> 'Auu____6455 -> 'Auu____6457) -> 'Auu____6457
  = fun p -> fun k -> fun f -> f k p
let mk_fvs :
  'Auu____6517 .
    Prims.unit -> 'Auu____6517 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____6525 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let mk_uvs :
  'Auu____6565 .
    Prims.unit -> 'Auu____6565 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____6573 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let (new_bv_set : Prims.unit -> bv FStar_Util.set) =
  fun uu____6580 -> FStar_Util.new_set order_bv
let (new_fv_set : Prims.unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____6587 -> FStar_Util.new_set order_fv
...
let (new_universe_names_set : Prims.unit -> univ_name FStar_Util.set) =
  fun uu____6600 -> FStar_Util.new_set order_univ_name
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t ->
    fun uu____6640 ->
      fun r ->
        let uu____6644 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
        { n = t; pos = r; vars = uu____6644 }
let (bv_to_tm : bv -> term) =
  fun bv ->
    let uu____6722 = range_of_bv bv in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____6722
let (bv_to_name : bv -> term) =
  fun bv ->
    let uu____6726 = range_of_bv bv in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____6726
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t ->
    fun uu___34_6755 ->
      match uu___34_6755 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____6757 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____6758 -> failwith "Unexpected universe instantiation")
    ...
    fun args' ->
      fun kopt ->
        fun r ->
          ...
          | uu____6803 -> mk_Tm_app t args' kopt r
  ...
  fun lr ->
    fun pos ->
      let uu____6832 =
        let uu____6835 =
          let uu____6836 =
            let uu____6861 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
            (lr, uu____6861) in
          Tm_delayed uu____6836 in
        mk uu____6835 in
      uu____6832 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t -> match t.n with | Tm_type uu____7065 -> true | uu____7066 -> false
...
let (null_binder : term -> binder) =
  fun t ->
    let uu____7078 = null_bv t in (uu____7078, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___35_7101 ->
    match uu___35_7101 with
    | { lbname = FStar_Util.Inr uu____7104; lbunivs = uu____7105;
        lbtyp = uu____7106; lbeff = uu____7107; lbdef = uu____7108;
        lbattrs = uu____7109; lbpos = uu____7110;_}::uu____7111 -> true
    | uu____7124 -> false
    ...
    FStar_List.fold_right
      (fun uu____7140 ->
         fun out ->
           ...
           | (x, uu____7151) -> FStar_Util.set_add x out) bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs ->
    let uu____7182 = FStar_Util.set_elements fvs in
    FStar_All.pipe_right uu____7182 binders_of_list
let (is_implicit : aqual -> Prims.bool) =
  fun uu___36_7189 ->
    match uu___36_7189 with
    | FStar_Pervasives_Native.Some (Implicit uu____7190) -> true
    | uu____7191 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____7222 -> b
      | Pat_constant uu____7229 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____7232, pats) ->
          FStar_List.fold_left
            (fun b1 ->
               fun uu____7263 ->
                 match uu____7263 with | (p2, uu____7275) -> aux b1 p2) b
            pats in
    let uu____7280 = aux [] p in
    FStar_All.pipe_left FStar_List.rev uu____7280
let (gen_reset :
  (Prims.unit -> Prims.int, Prims.unit -> Prims.unit)
    FStar_Pervasives_Native.tuple2)
  =
  let x = FStar_Util.mk_ref (Prims.parse_int "0") in
  let gen1 uu____7301 = FStar_Util.incr x; FStar_ST.op_Bang x in
  let reset uu____7506 = FStar_ST.op_Colon_Equals x (Prims.parse_int "0") in
  (gen1, reset)
  ...
  fun s ->
    fun r ->
      fun t ->
        ...
        let uu____7648 = next_id () in
        { ppname = id1; index = uu____7648; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv ->
    let uu____7662 = is_null_bv bv in
    if uu____7662
    then
      let uu____7663 =
        let uu____7666 = range_of_bv bv in
        FStar_Pervasives_Native.Some uu____7666 in
      new_bv uu____7663 bv.sort
    else
      (let uu___42_7668 = bv in
       let uu____7669 = next_id () in
       {
         ppname = (uu___42_7668.ppname);
         index = uu____7669;
         sort = (uu___42_7668.sort)
       })
let (new_univ_name :
  ...
  fun ropt ->
    ...
    let uu____7678 =
      let uu____7683 =
        let uu____7684 = FStar_Util.string_of_int id1 in
        Prims.strcat FStar_Ident.reserved_prefix uu____7684 in
      (uu____7683, (range_of_ropt ropt)) in
    FStar_Ident.mk_ident uu____7678
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv ->
    fun r ->
      let uu___43_7779 = bv in
      {
        ppname = (FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r));
        index = (uu___43_7779.index);
        sort = (uu___43_7779.sort)
      }
let (lid_as_fv :
  FStar_Ident.lident ->
  ...
  fun l ->
    fun dd ->
      fun dq ->
        let uu____7793 = withinfo l (FStar_Ident.range_of_lid l) in
        { fv_name = uu____7793; fv_delta = dd; fv_qual = dq }
...
let (fvar :
  ...
  fun l ->
    fun dd ->
      fun dq -> let uu____7810 = lid_as_fv l dd dq in fv_to_tm uu____7810
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv -> (fv.fv_name).v
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv ->
    let uu____7817 = lid_of_fv fv in FStar_Ident.range_of_lid uu____7817
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv ->
    fun r ->
      let uu___44_7824 = fv in
      let uu____7825 =
        let uu___45_7826 = fv.fv_name in
        let uu____7827 =
          let uu____7828 = lid_of_fv fv in
          FStar_Ident.set_lid_range uu____7828 r in
        { v = uu____7827; p = (uu___45_7826.p) } in
      {
        fv_name = uu____7825;
        fv_delta = (uu___44_7824.fv_delta);
        fv_qual = (uu___44_7824.fv_qual)
      }
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l ->
    fun s ->
      FStar_List.existsb
        (fun uu___39_7846 ->
           match uu___39_7846 with
           | { n = Tm_constant (FStar_Const.Const_string (data, uu____7850));
               pos = uu____7851; vars = uu____7852;_} when data = s -> true
           | uu____7855 -> false) l
  ...
  fun p1 ->
    fun p2 ->
      ...
      | (Pat_cons (fv1, as1), Pat_cons (fv2, as2)) ->
          let uu____7902 = fv_eq fv1 fv2 in
          if uu____7902
          then
            let uu____7912 = FStar_List.zip as1 as2 in
            FStar_All.pipe_right uu____7912
              (FStar_List.for_all
                 (fun uu____7978 ->
                    match uu____7978 with
                    | ((p11, b1), (p21, b2)) -> (b1 = b2) && (eq_pat p11 p21)))
          else false
      | (Pat_var uu____8004, Pat_var uu____8005) -> true
      | (Pat_wild uu____8006, Pat_wild uu____8007) -> true
      | (Pat_dot_term (bv1, t1), Pat_dot_term (bv2, t2)) -> true
      | (uu____8020, uu____8021) -> false
  ...
  fun l ->
    let uu____8025 =
      let uu____8028 =
        ...
        Tm_fvar uu____8029 in
      mk uu____8028 in
    uu____8025 FStar_Pervasives_Native.None FStar_Range.dummyRange
  ...
  fun l ->
    let uu____8036 =
      let uu____8039 =
        ...
        Tm_fvar uu____8040 in
      mk uu____8039 in
    uu____8036 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term' syntax) =
  let uu____8050 =
    let uu____8051 =
      let uu____8052 = tabbrev FStar_Parser_Const.tactic_lid in
      mk_Tm_uinst uu____8052 [U_zero] in
    let uu____8053 = let uu____8054 = as_arg t_unit in [uu____8054] in
    mk_Tm_app uu____8051 uu____8053 in
  uu____8050 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_tac_unit : term' syntax) =
  let uu____8059 =
    let uu____8060 =
      let uu____8061 = tabbrev FStar_Parser_Const.u_tac_lid in
      mk_Tm_uinst uu____8061 [U_zero] in
    let uu____8062 = let uu____8063 = as_arg t_unit in [uu____8063] in
    mk_Tm_app uu____8060 uu____8062 in
  uu____8059 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_list_of : term -> term) =
  fun t ->
    let uu____8069 =
      let uu____8070 =
        let uu____8071 = tabbrev FStar_Parser_Const.list_lid in
        mk_Tm_uinst uu____8071 [U_zero] in
      let uu____8072 = let uu____8073 = as_arg t in [uu____8073] in
      mk_Tm_app uu____8070 uu____8072 in
    uu____8069 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_option_of : term -> term) =
  fun t ->
    let uu____8079 =
      let uu____8080 =
        let uu____8081 = tabbrev FStar_Parser_Const.option_lid in
        mk_Tm_uinst uu____8081 [U_zero] in
      let uu____8082 = let uu____8083 = as_arg t in [uu____8083] in
      mk_Tm_app uu____8080 uu____8082 in
    uu____8079 FStar_Pervasives_Native.None FStar_Range.dummyRange
let (t_tuple2_of : term -> term -> term) =
  fun t1 ->
    fun t2 ->
      let uu____8092 =
        let uu____8093 =
          let uu____8094 = tabbrev FStar_Parser_Const.lid_tuple2 in
          mk_Tm_uinst uu____8094 [U_zero] in
        let uu____8095 =
          let uu____8096 = as_arg t1 in
          let uu____8097 = let uu____8100 = as_arg t2 in [uu____8100] in
          uu____8096 :: uu____8097 in
        mk_Tm_app uu____8093 uu____8095 in
      uu____8092 FStar_Pervasives_Native.None FStar_Range.dummyRange
