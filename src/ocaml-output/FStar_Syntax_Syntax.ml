...
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_fvar  -> true | uu____4976 -> false
  
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_comp  -> true | uu____4987 -> false
  
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_env  -> true | uu____4998 -> false
  
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_proofstate  -> true | uu____5009 -> false
  
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_goal  -> true | uu____5020 -> false
  
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_sigelt  -> true | uu____5031 -> false
  
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_uvar  -> true | uu____5042 -> false
  
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_embedding _0 -> true | uu____5062 -> false
...
let (uu___is_Binding_var : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_var _0 -> true | uu____5105 -> false
  
let (__proj__Binding_var__item___0 : binding -> bv) =
  fun projectee  -> match projectee with | Binding_var _0 -> _0 
let (uu___is_Binding_lid : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_lid _0 -> true | uu____5136 -> false
...
let (mk_lcomp :
  ...
  fun eff_name  ->
    fun res_typ  ->
      fun cflags  ->
        fun comp_thunk  ->
          let uu____5619 = FStar_Util.mk_ref (FStar_Util.Inl comp_thunk)  in
          { eff_name; res_typ; cflags; comp_thunk = uu____5619 }
  
let (lcomp_comp : lcomp -> comp) =
  fun lc  ->
    let uu____5645 = FStar_ST.op_Bang lc.comp_thunk  in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____5798 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____5809 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____5820 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____5842 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____5853 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____5864 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____5886 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____5897 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____5908 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____5919 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____5930 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____5941 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____5953 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____5972 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____5995 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____6034 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____6085 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____6128 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____6157 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____6168 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____6179 -> false
...
let (__proj__Mkeff_decl__item__cattributes : eff_decl -> cflag Prims.list) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> cattributes
...
let (__proj__Mkeff_decl__item__mname : eff_decl -> FStar_Ident.lident) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> mname
...
let (__proj__Mkeff_decl__item__univs : eff_decl -> univ_names) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> univs
...
let (__proj__Mkeff_decl__item__binders : eff_decl -> binders) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> binders
...
let (__proj__Mkeff_decl__item__spec : eff_decl -> term_monad) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> spec
...
let (__proj__Mkeff_decl__item__signature : eff_decl -> term) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> signature
...
let (__proj__Mkeff_decl__item__if_then_else : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> if_then_else
...
let (__proj__Mkeff_decl__item__ite_wp : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> ite_wp
...
let (__proj__Mkeff_decl__item__stronger : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> stronger
...
let (__proj__Mkeff_decl__item__close_wp : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> close_wp
...
let (__proj__Mkeff_decl__item__trivial : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> trivial
...
let (__proj__Mkeff_decl__item__repr : eff_decl -> term_monad) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> repr
...
let (__proj__Mkeff_decl__item__elaborated : eff_decl -> Prims.bool) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> elaborated
...
let (__proj__Mkeff_decl__item__spec_dm4f : eff_decl -> Prims.bool) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> spec_dm4f
...
let (__proj__Mkeff_decl__item__interp :
  ...
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> interp
...
let (__proj__Mkeff_decl__item__mrelation :
  ...
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> mrelation
...
let (__proj__Mkeff_decl__item__actions : eff_decl -> action Prims.list) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> actions
...
let (__proj__Mkeff_decl__item__eff_attrs : eff_decl -> attribute Prims.list)
  ...
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; trivial; repr; elaborated; spec_dm4f;
        interp; mrelation; actions; eff_attrs;_} -> eff_attrs
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7471 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7546 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7604 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7674 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7717 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7754 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7779 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7816 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7835 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7866 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7921 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7946 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___0_8168  ->
         match uu___0_8168 with
         | Reflectable uu____8170 -> true
         | uu____8172 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___424_8290 = x  in
      let uu____8291 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____8291;
        index = (uu___424_8290.index);
        sort = (uu___424_8290.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8328  ->
             ...
             | (bv,t) -> let uu____8339 = f t  in (bv, uu____8339))
          qi.antiquotes
         in
      let uu___432_8340 = qi  in
      { qkind = (uu___432_8340.qkind); antiquotes = aq }
  ...
  fun bv  ->
    fun aq  ->
      let uu____8356 =
        FStar_List.tryFind
          (fun uu____8374  ->
             match uu____8374 with | (bv',uu____8383) -> bv_eq bv bv') aq
         in
      match uu____8356 with
      | FStar_Pervasives_Native.Some (uu____8390,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'Auu____8421 'Auu____8422 'Auu____8423 .
    'Auu____8421 ->
      'Auu____8422 ->
        ('Auu____8422 -> 'Auu____8421 -> 'Auu____8423) -> 'Auu____8423
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'Auu____8454 .
    unit -> 'Auu____8454 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8463  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'Auu____8471 .
    unit -> 'Auu____8471 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8480  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8490  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8500  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8510  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8525 = FStar_Ident.text_of_id x  in
      let uu____8527 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8525 uu____8527
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8536  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8555),Binding_lid (lid2,uu____8557)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8646  ->
      fun r  ->
        let uu____8650 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8650 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____8661 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____8661
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____8668 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____8668
...
let (binders_to_names : binders -> term Prims.list) =
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____8698  ->
            match uu____8698 with | (x,uu____8706) -> bv_to_name x))
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___1_8761  ->
      match uu___1_8761 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____8763 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____8766 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8825 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____8882 =
        let uu____8889 =
          let uu____8890 =
            let uu____8913 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____8913)  in
          Tm_delayed uu____8890  in
        mk uu____8889  in
      uu____8882 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9116 -> true | uu____9118 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9154 = null_bv t  in (uu____9154, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___2_9202  ->
    match uu___2_9202 with
    | { lbname = FStar_Util.Inr uu____9206; lbunivs = uu____9207;
        lbtyp = uu____9208; lbeff = uu____9209; lbdef = uu____9210;
        lbattrs = uu____9211; lbpos = uu____9212;_}::uu____9213 -> true
    | uu____9227 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9249  ->
         fun out  ->
           match uu____9249 with | (x,uu____9262) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9295 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9295 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___3_9306  ->
    match uu___3_9306 with
    | FStar_Pervasives_Native.Some (Implicit uu____9308) -> true
    | uu____9311 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9357 -> b
      | Pat_constant uu____9364 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9367,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9401  ->
                 match uu____9401 with | (p2,uu____9414) -> aux b1 p2) b pats
       in
    let uu____9421 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9421
  
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_9435  ->
    match uu___5_9435 with
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        { ppname = id1; index = uu____9475; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____9498 = is_null_bv bv  in
    if uu____9498
    then
      let uu____9501 =
        let uu____9504 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____9504  in
      new_bv uu____9501 bv.sort
    else
      (let uu___614_9507 = bv  in
       let uu____9508 = FStar_Ident.next_id ()  in
       {
         ppname = (uu___614_9507.ppname);
         index = uu____9508;
         sort = (uu___614_9507.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv,aq) -> let uu____9523 = freshen_bv bv  in (uu____9523, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9538 =
      let uu____9544 =
        let uu____9546 = FStar_Util.string_of_int id1  in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____9546  in
      (uu____9544, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9538
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___644_9677 = bv  in
      let uu____9678 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____9678;
        index = (uu___644_9677.index);
        sort = (uu___644_9677.sort)
      }
    ...
    fun dd  ->
      fun dq  ->
        let uu____9700 =
          ...
          withinfo l uu____9701  in
        { fv_name = uu____9700; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv  ->
    let uu____9708 = FStar_Ident.range_of_lid (fv.fv_name).v  in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____9708
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9729 = lid_as_fv l dd dq  in fv_to_tm uu____9729
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____9742 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____9742
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___657_9754 = fv  in
      let uu____9755 =
        let uu___659_9756 = fv.fv_name  in
        let uu____9757 =
          let uu____9758 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____9758 r  in
        { v = uu____9757; p = (uu___659_9756.p) }  in
      {
        fv_name = uu____9755;
        fv_delta = (uu___657_9754.fv_delta);
        fv_qual = (uu___657_9754.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9784  ->
           match uu___6_9784 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9789));
               pos = uu____9790; vars = uu____9791;_} when data = s -> true
           | uu____9798 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9857 = fv_eq fv1 fv2  in
          if uu____9857
          then
            let uu____9862 = FStar_List.zip as1 as2  in
            FStar_All.pipe_right uu____9862
              (FStar_List.for_all
                 (fun uu____9929  ->
                    match uu____9929 with
                    | ((p11,b1),(p21,b2)) -> (b1 = b2) && (eq_pat p11 p21)))
          else false
      | (Pat_var uu____9967,Pat_var uu____9968) -> true
      | (Pat_wild uu____9970,Pat_wild uu____9971) -> true
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____10005 =
      let uu____10012 = let uu____10013 = fvconst l  in Tm_fvar uu____10013
         in
      mk uu____10012  in
    uu____10005 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term) =
  let uu____10055 =
    let uu____10060 =
      let uu____10061 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____10061 [U_zero]  in
    let uu____10062 = let uu____10063 = as_arg t_unit  in [uu____10063]  in
...
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10094 =
      let uu____10099 =
        let uu____10100 = tabbrev FStar_Parser_Const.list_lid  in
...
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10133 =
      let uu____10138 =
        let uu____10139 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10139 [U_zero]  in
      let uu____10140 = let uu____10141 = as_arg t  in [uu____10141]  in
      mk_Tm_app uu____10138 uu____10140  in
    uu____10133 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10177 =
        let uu____10182 =
          let uu____10183 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10183 [U_zero; U_zero]  in
        let uu____10184 =
          let uu____10185 = as_arg t1  in
          let uu____10194 = let uu____10205 = as_arg t2  in [uu____10205]  in
          uu____10185 :: uu____10194  in
        mk_Tm_app uu____10182 uu____10184  in
      uu____10177 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10249 =
        let uu____10254 =
          let uu____10255 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10255 [U_zero; U_zero]  in
        let uu____10256 =
          let uu____10257 = as_arg t1  in
          let uu____10266 = let uu____10277 = as_arg t2  in [uu____10277]  in
          uu____10257 :: uu____10266  in
        mk_Tm_app uu____10254 uu____10256  in
      uu____10249 FStar_Pervasives_Native.None FStar_Range.dummyRange
