...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____1109 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____1139 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____1151 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____1179 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____1251 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____1305 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____1349 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____1425 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____1529 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____1631 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____1695 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____1779 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_meta _0 -> true | uu____1869 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_lazy _0 -> true | uu____1899 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_unknown  -> true | uu____1910 -> false
  
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____1915 -> false
  
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee  -> match projectee with | Pat_constant _0 -> _0 
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_cons _0 -> true | uu____1939 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_var _0 -> true | uu____1987 -> false
  
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_var _0 -> _0 
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_wild _0 -> true | uu____1999 -> false
  
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_wild _0 -> _0 
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_dot_term _0 -> true | uu____2017 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Total _0 -> true | uu____2375 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | GTotal _0 -> true | uu____2419 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comp _0 -> true | uu____2455 -> false
  
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee  -> match projectee with | Comp _0 -> _0 
let (uu___is_TOTAL : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | TOTAL  -> true | uu____2466 -> false
  
let (uu___is_MLEFFECT : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | MLEFFECT  -> true | uu____2470 -> false
  
let (uu___is_RETURN : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | RETURN  -> true | uu____2474 -> false
  
let (uu___is_PARTIAL_RETURN : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | PARTIAL_RETURN  -> true | uu____2478 -> false
  
let (uu___is_SOMETRIVIAL : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | SOMETRIVIAL  -> true | uu____2482 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | SHOULD_NOT_INLINE  -> true | uu____2490 -> false
  
let (uu___is_LEMMA : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | LEMMA  -> true | uu____2494 -> false
  
let (uu___is_CPS : cflags -> Prims.bool) =
  fun projectee  -> match projectee with | CPS  -> true | uu____2498 -> false 
let (uu___is_DECREASES : cflags -> Prims.bool) =
  fun projectee  ->
    match projectee with | DECREASES _0 -> true | uu____2505 -> false
  
let (__proj__DECREASES__item___0 : cflags -> term' syntax) =
  fun projectee  -> match projectee with | DECREASES _0 -> _0 
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_pattern _0 -> true | uu____2533 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____2575 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____2593 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____2623 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____2641 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____2679 -> false
...
let (uu___is_Meta_quoted : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_quoted _0 -> true | uu____2721 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____2750 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____2754 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____2758 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____2762 -> false
  
let (uu___is_Mutable_alloc : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Mutable_alloc  -> true | uu____2766 -> false
  
let (uu___is_Mutable_rval : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Mutable_rval  -> true | uu____2770 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____2774 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____2783 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____2813 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____2847 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____2875 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____2905 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____2939 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____2967 -> false
...
let (mk_lcomp :
  ...
  fun eff_name  ->
    fun res_typ  ->
      fun cflags  ->
        fun comp_thunk  ->
          let uu____3726 = FStar_Util.mk_ref (FStar_Util.Inl comp_thunk)  in
          { eff_name; res_typ; cflags; comp_thunk = uu____3726 }
  
let (lcomp_comp : lcomp -> comp) =
  fun lc  ->
    let uu____3776 = FStar_ST.op_Bang lc.comp_thunk  in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____3952 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____3956 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____3960 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____3968 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____3972 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____3976 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____3984 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____3988 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____3992 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____3996 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____4000 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____4004 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____4009 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____4021 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____4037 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____4069 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____4113 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____4149 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____4164 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____4168 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____4172 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____5225 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____5293 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____5343 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____5403 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____5439 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____5469 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____5487 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____5517 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____5541 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____5565 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____5613 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___30_5765  ->
         match uu___30_5765 with
         | Reflectable uu____5766 -> true
         | uu____5767 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___37_5825 = x  in
      {
        ppname = (FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r));
        index = (uu___37_5825.index);
        sort = (uu___37_5825.sort)
      }
  
let syn :
  'Auu____5832 'Auu____5833 'Auu____5834 .
    'Auu____5834 ->
      'Auu____5833 ->
        ('Auu____5833 -> 'Auu____5834 -> 'Auu____5832) -> 'Auu____5832
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'Auu____5870 .
    Prims.unit -> 'Auu____5870 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____5878  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'Auu____5894 .
...
let (new_bv_set : Prims.unit -> bv FStar_Util.set) =
  fun uu____5909  -> FStar_Util.new_set order_bv 
let (new_fv_set : Prims.unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____5916  -> FStar_Util.new_set order_fv 
...
let (new_universe_names_fifo_set :
  ...
  fun uu____5929  -> FStar_Util.new_fifo_set order_univ_name 
  ...
  fun t  ->
    fun uu____5969  ->
      fun r  ->
        ...
        { n = t; pos = r; vars = uu____5973 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____6003 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____6003
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____6007 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____6007
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___31_6036  ->
      match uu___31_6036 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____6038 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____6039 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____6084 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____6113 =
        let uu____6116 =
          let uu____6117 =
            let uu____6142 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____6142)  in
          Tm_delayed uu____6117  in
        mk uu____6116  in
      uu____6113 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____6298 -> true | uu____6299 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____6311 = null_bv t  in (uu____6311, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___32_6334  ->
    match uu___32_6334 with
    | { lbname = FStar_Util.Inr uu____6337; lbunivs = uu____6338;
        lbtyp = uu____6339; lbeff = uu____6340; lbdef = uu____6341;
        lbattrs = uu____6342; lbpos = uu____6343;_}::uu____6344 -> true
    | uu____6357 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____6373  ->
         fun out  ->
           match uu____6373 with | (x,uu____6384) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____6415 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____6415 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___33_6422  ->
    match uu___33_6422 with
    | FStar_Pervasives_Native.Some (Implicit uu____6423) -> true
    | uu____6424 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____6455 -> b
      | Pat_constant uu____6462 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____6465,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____6496  ->
                 match uu____6496 with | (p2,uu____6508) -> aux b1 p2) b pats
       in
    let uu____6513 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____6513
...
let (gen_reset :
  ...
  let gen1 uu____6534 = FStar_Util.incr x; FStar_ST.op_Bang x  in
  let reset uu____6613 = FStar_ST.op_Colon_Equals x (Prims.parse_int "0")  in
  (gen1, reset) 
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____6701 = next_id ()  in
        { ppname = id1; index = uu____6701; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____6715 = is_null_bv bv  in
    if uu____6715
    then
      let uu____6716 =
        let uu____6719 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____6719  in
      new_bv uu____6716 bv.sort
    else
      (let uu___38_6721 = bv  in
       let uu____6722 = next_id ()  in
       {
         ppname = (uu___38_6721.ppname);
         index = uu____6722;
         sort = (uu___38_6721.sort)
       })
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____6731 =
      let uu____6736 =
        let uu____6737 = FStar_Util.string_of_int id1  in
        Prims.strcat FStar_Ident.reserved_prefix uu____6737  in
      (uu____6736, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____6731
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___39_6832 = bv  in
      {
        ppname = (FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r));
        index = (uu___39_6832.index);
        sort = (uu___39_6832.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____6846 = withinfo l (FStar_Ident.range_of_lid l)  in
        { fv_name = uu____6846; fv_delta = dd; fv_qual = dq }
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____6863 = lid_as_fv l dd dq  in fv_to_tm uu____6863
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____6870 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____6870
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___40_6877 = fv  in
      let uu____6878 =
        let uu___41_6879 = fv.fv_name  in
        let uu____6880 =
          let uu____6881 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____6881 r  in
        { v = uu____6880; p = (uu___41_6879.p) }  in
      {
        fv_name = uu____6878;
        fv_delta = (uu___40_6877.fv_delta);
        fv_qual = (uu___40_6877.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___36_6899  ->
           match uu___36_6899 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____6903));
               pos = uu____6904; vars = uu____6905;_} when data = s -> true
           | uu____6908 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____6955 = fv_eq fv1 fv2  in
          if uu____6955
          then
            let uu____6959 = FStar_List.zip as1 as2  in
            FStar_All.pipe_right uu____6959
              (FStar_List.for_all
                 (fun uu____7025  ->
                    match uu____7025 with
                    | ((p11,b1),(p21,b2)) -> (b1 = b2) && (eq_pat p11 p21)))
          else false
      | (Pat_var uu____7051,Pat_var uu____7052) -> true
      | (Pat_wild uu____7053,Pat_wild uu____7054) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____7067,uu____7068) -> false
  ...
  fun l  ->
    let uu____7072 =
      let uu____7075 =
        ...
        Tm_fvar uu____7076  in
      mk uu____7075  in
    uu____7072 FStar_Pervasives_Native.None FStar_Range.dummyRange
      ...
      let uu____7086 =
        let uu____7087 =
          lid_as_fv l (Delta_defined_at_level (Prims.parse_int "1"))
           ...
           in
        Tm_fvar uu____7087  in
      mk uu____7086  in
    uu____7083 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term' syntax) =
  let uu____7097 =
    let uu____7098 =
      let uu____7099 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____7099 [U_zero]  in
    let uu____7100 = let uu____7101 = as_arg t_unit  in [uu____7101]  in
    mk_Tm_app uu____7098 uu____7100  in
  uu____7097 FStar_Pervasives_Native.None FStar_Range.dummyRange 
let (t_tac_unit : term' syntax) =
  let uu____7106 =
    let uu____7107 =
      let uu____7108 = tabbrev FStar_Parser_Const.u_tac_lid  in
      mk_Tm_uinst uu____7108 [U_zero]  in
    let uu____7109 = let uu____7110 = as_arg t_unit  in [uu____7110]  in
    mk_Tm_app uu____7107 uu____7109  in
  uu____7106 FStar_Pervasives_Native.None FStar_Range.dummyRange 
let (t_list_of : term -> term) =
  fun t  ->
    let uu____7116 =
      let uu____7117 =
        let uu____7118 = tabbrev FStar_Parser_Const.list_lid  in
        mk_Tm_uinst uu____7118 [U_zero]  in
      let uu____7119 = let uu____7120 = as_arg t  in [uu____7120]  in
      mk_Tm_app uu____7117 uu____7119  in
    uu____7116 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_option_of : term -> term) =
  fun t  ->
    let uu____7126 =
      let uu____7127 =
        let uu____7128 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____7128 [U_zero]  in
      let uu____7129 = let uu____7130 = as_arg t  in [uu____7130]  in
