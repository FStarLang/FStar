...
let (uu___is_U_zero : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_zero  -> true | uu____492 -> false
...
let (uu___is_Strict : should_check_uvar -> Prims.bool) =
  fun projectee  ->
    match projectee with | Strict  -> true | uu____836 -> false
...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____1825 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____1862 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____1881 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____1918 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____2005 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____2072 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____2125 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____2214 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____2325 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____2435 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____2505 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____2574 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_meta _0 -> true | uu____2641 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_lazy _0 -> true | uu____2678 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_quoted _0 -> true | uu____2703 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_unknown  -> true | uu____2739 -> false
...
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____3193 -> false
  
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee  -> match projectee with | Pat_constant _0 -> _0 
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_cons _0 -> true | uu____3225 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_var _0 -> true | uu____3283 -> false
  
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_var _0 -> _0 
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_wild _0 -> true | uu____3302 -> false
  
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_wild _0 -> _0 
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_dot_term _0 -> true | uu____3327 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Total _0 -> true | uu____3790 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | GTotal _0 -> true | uu____3841 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comp _0 -> true | uu____3884 -> false
  
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee  -> match projectee with | Comp _0 -> _0 
let (uu___is_TOTAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | TOTAL  -> true | uu____3902 -> false
  
let (uu___is_MLEFFECT : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | MLEFFECT  -> true | uu____3913 -> false
  
let (uu___is_LEMMA : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | LEMMA  -> true | uu____3924 -> false
  
let (uu___is_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | RETURN  -> true | uu____3935 -> false
  
let (uu___is_PARTIAL_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | PARTIAL_RETURN  -> true | uu____3946 -> false
  
let (uu___is_SOMETRIVIAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SOMETRIVIAL  -> true | uu____3957 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SHOULD_NOT_INLINE  -> true | uu____3979 -> false
  
let (uu___is_CPS : cflag -> Prims.bool) =
  fun projectee  -> match projectee with | CPS  -> true | uu____3990 -> false 
let (uu___is_DECREASES : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | DECREASES _0 -> true | uu____4004 -> false
  
let (__proj__DECREASES__item___0 : cflag -> term' syntax) =
  fun projectee  -> match projectee with | DECREASES _0 -> _0 
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_pattern _0 -> true | uu____4049 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____4128 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____4155 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____4198 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____4223 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____4268 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____4310 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____4321 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____4332 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____4343 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____4354 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____4370 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____4407 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____4449 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____4488 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____4528 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____4570 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____4609 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | BadLazy  -> true | uu____4980 -> false
  
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_bv  -> true | uu____4991 -> false
  
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_binder  -> true | uu____5002 -> false
  
let (uu___is_Lazy_optionstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_optionstate  -> true | uu____5013 -> false
  
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_fvar  -> true | uu____5024 -> false
  
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_comp  -> true | uu____5035 -> false
  
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_env  -> true | uu____5046 -> false
  
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_proofstate  -> true | uu____5057 -> false
  
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_goal  -> true | uu____5068 -> false
  
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_sigelt  -> true | uu____5079 -> false
  
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_uvar  -> true | uu____5090 -> false
  
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_embedding _0 -> true | uu____5110 -> false
...
let (uu___is_Binding_var : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_var _0 -> true | uu____5153 -> false
  
let (__proj__Binding_var__item___0 : binding -> bv) =
  fun projectee  -> match projectee with | Binding_var _0 -> _0 
let (uu___is_Binding_lid : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_lid _0 -> true | uu____5184 -> false
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____5546 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____5557 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____5568 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____5590 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____5601 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____5612 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____5634 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____5645 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____5656 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____5667 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____5678 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____5689 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____5701 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____5720 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____5743 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____5782 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____5833 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____5876 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____5905 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____5916 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____5927 -> false
...
let (uu___is_Primitive_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primitive_eff _0 -> true | uu____6762 -> false
...
let (uu___is_DM4F_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | DM4F_eff _0 -> true | uu____6781 -> false
...
let (uu___is_Layered_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | Layered_eff _0 -> true | uu____6800 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7336 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7411 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7469 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7539 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7582 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7625 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7662 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7681 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7712 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7767 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7792 -> false
...
let (uu___is_Sig_fail : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_fail _0 -> true | uu____7951 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___0_8228  ->
         match uu___0_8228 with
         | Reflectable uu____8230 -> true
         | uu____8232 -> false) l
...
let (order_bv : bv -> bv -> Prims.int) =
  fun x  ->
    fun y  ->
      let i =
        let uu____8294 = FStar_Ident.text_of_id x.ppname  in
        let uu____8296 = FStar_Ident.text_of_id y.ppname  in
        FStar_String.compare uu____8294 uu____8296  in
      if i = Prims.int_zero then x.index - y.index else i
  
let (order_ident : FStar_Ident.ident -> FStar_Ident.ident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8316 = FStar_Ident.text_of_id x  in
      let uu____8318 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8316 uu____8318
  
let (order_fv : FStar_Ident.lident -> FStar_Ident.lident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8332 = FStar_Ident.string_of_lid x  in
      let uu____8334 = FStar_Ident.string_of_lid y  in
      FStar_String.compare uu____8332 uu____8334
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___417_8361 = x  in
      let uu____8362 = FStar_Ident.set_id_range r x.ppname  in
      {
        ppname = uu____8362;
        index = (uu___417_8361.index);
        sort = (uu___417_8361.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8398  ->
             ...
             | (bv1,t) -> let uu____8409 = f t  in (bv1, uu____8409))
          qi.antiquotes
         in
      let uu___425_8410 = qi  in
      { qkind = (uu___425_8410.qkind); antiquotes = aq }
  ...
  fun bv1  ->
    fun aq  ->
      let uu____8426 =
        FStar_List.tryFind
          (fun uu____8444  ->
             match uu____8444 with | (bv',uu____8453) -> bv_eq bv1 bv') aq
         in
      match uu____8426 with
      | FStar_Pervasives_Native.Some (uu____8460,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'uuuuuu8491 'uuuuuu8492 'uuuuuu8493 .
    'uuuuuu8491 ->
      'uuuuuu8492 ->
        ('uuuuuu8492 -> 'uuuuuu8491 -> 'uuuuuu8493) -> 'uuuuuu8493
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'uuuuuu8524 .
    unit -> 'uuuuuu8524 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8533  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'uuuuuu8541 .
    unit -> 'uuuuuu8541 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8550  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8560  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8570  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8580  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8595 = FStar_Ident.text_of_id x  in
      let uu____8597 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8595 uu____8597
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8606  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8625),Binding_lid (lid2,uu____8627)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8716  ->
      fun r  ->
        let uu____8720 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8720 }
  
let (bv_to_tm : bv -> term) =
  fun bv1  ->
    let uu____8731 = range_of_bv bv1  in
    mk (Tm_bvar bv1) FStar_Pervasives_Native.None uu____8731
  
let (bv_to_name : bv -> term) =
  fun bv1  ->
    let uu____8738 = range_of_bv bv1  in
    mk (Tm_name bv1) FStar_Pervasives_Native.None uu____8738
...
let (binders_to_names : binders -> term Prims.list) =
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____8768  ->
            match uu____8768 with | (x,uu____8776) -> bv_to_name x))
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun us  ->
      ...
      | uu____8836 -> failwith "Unexpected universe instantiation"
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8895 -> mk_Tm_app t args' kopt r
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9141 -> true | uu____9143 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9169 = null_bv t  in (uu____9169, FStar_Pervasives_Native.None)
...
let (is_null_bv : bv -> Prims.bool) =
  fun b  ->
    let uu____9201 = FStar_Ident.text_of_id b.ppname  in
    let uu____9203 = FStar_Ident.text_of_id null_id  in
    uu____9201 = uu____9203
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___1_9223  ->
    match uu___1_9223 with
    | { lbname = FStar_Util.Inr uu____9227; lbunivs = uu____9228;
        lbtyp = uu____9229; lbeff = uu____9230; lbdef = uu____9231;
        lbattrs = uu____9232; lbpos = uu____9233;_}::uu____9234 -> true
    | uu____9248 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9270  ->
         fun out  ->
           match uu____9270 with | (x,uu____9283) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9316 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9316 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___2_9327  ->
    match uu___2_9327 with
    | FStar_Pervasives_Native.Some (Implicit uu____9329) -> true
    | uu____9332 -> false
  
let (is_implicit_or_meta : aqual -> Prims.bool) =
  fun uu___3_9340  ->
    match uu___3_9340 with
    | FStar_Pervasives_Native.Some (Implicit uu____9342) -> true
    | FStar_Pervasives_Native.Some (Meta uu____9345) -> true
    | uu____9349 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9395 -> b
      | Pat_constant uu____9402 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9405,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9439  ->
                 match uu____9439 with | (p2,uu____9452) -> aux b1 p2) b pats
       in
    let uu____9459 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9459
  
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_9473  ->
    match uu___5_9473 with
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9513 = FStar_Ident.next_id ()  in
        { ppname = id; index = uu____9513; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv1  ->
    let uu____9536 = is_null_bv bv1  in
    if uu____9536
    then
      let uu____9539 =
        let uu____9542 = range_of_bv bv1  in
        FStar_Pervasives_Native.Some uu____9542  in
      new_bv uu____9539 bv1.sort
    else
      (let uu___615_9545 = bv1  in
       let uu____9546 = FStar_Ident.next_id ()  in
       {
         ppname = (uu___615_9545.ppname);
         index = uu____9546;
         sort = (uu___615_9545.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv1,aq) -> let uu____9561 = freshen_bv bv1  in (uu____9561, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9576 =
      let uu____9582 =
        let uu____9584 = FStar_Util.string_of_int id  in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____9584  in
      (uu____9582, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9576
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv1  ->
    fun r  ->
      let uu___642_9693 = bv1  in
      let uu____9694 = FStar_Ident.set_id_range r bv1.ppname  in
      {
        ppname = uu____9694;
        index = (uu___642_9693.index);
        sort = (uu___642_9693.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____9715 =
          let uu____9716 = FStar_Ident.range_of_lid l  in
          withinfo l uu____9716  in
        { fv_name = uu____9715; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv1  ->
    let uu____9723 = FStar_Ident.range_of_lid (fv1.fv_name).v  in
    mk (Tm_fvar fv1) FStar_Pervasives_Native.None uu____9723
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9744 = lid_as_fv l dd dq  in fv_to_tm uu____9744
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv1  -> (fv1.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv1  ->
    let uu____9757 = lid_of_fv fv1  in FStar_Ident.range_of_lid uu____9757
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv1  ->
    fun r  ->
      let uu___655_9769 = fv1  in
      let uu____9770 =
        let uu___657_9771 = fv1.fv_name  in
        let uu____9772 =
          let uu____9773 = lid_of_fv fv1  in
          FStar_Ident.set_lid_range uu____9773 r  in
        { v = uu____9772; p = (uu___657_9771.p) }  in
      {
        fv_name = uu____9770;
        fv_delta = (uu___655_9769.fv_delta);
        fv_qual = (uu___655_9769.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9799  ->
           match uu___6_9799 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9804));
               pos = uu____9805; vars = uu____9806;_} when data = s -> true
           | uu____9813 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9872 = fv_eq fv1 fv2  in
          if uu____9872
          then
            let uu____9877 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____9982,Pat_var uu____9983) -> true
      | (Pat_wild uu____9985,Pat_wild uu____9986) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____10001,uu____10002) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____10020 =
      let uu____10027 = let uu____10028 = fvconst l  in Tm_fvar uu____10028
         in
      mk uu____10027  in
    uu____10020 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tac_of : term -> term -> term) =
  fun a  ->
    fun b  ->
      let uu____10081 =
        let uu____10086 =
          let uu____10087 = tabbrev FStar_Parser_Const.tac_lid  in
          mk_Tm_uinst uu____10087 [U_zero; U_zero]  in
        let uu____10088 =
          let uu____10089 = as_arg a  in
          let uu____10098 = let uu____10109 = as_arg b  in [uu____10109]  in
          uu____10089 :: uu____10098  in
        mk_Tm_app uu____10086 uu____10088  in
      uu____10081 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_tactic_of : term -> term) =
  fun t  ->
    let uu____10148 =
      let uu____10153 =
        let uu____10154 = tabbrev FStar_Parser_Const.tactic_lid  in
        mk_Tm_uinst uu____10154 [U_zero]  in
      let uu____10155 = let uu____10156 = as_arg t  in [uu____10156]  in
      mk_Tm_app uu____10153 uu____10155  in
    uu____10148 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10188 =
      let uu____10193 =
        let uu____10194 = tabbrev FStar_Parser_Const.list_lid  in
        mk_Tm_uinst uu____10194 [U_zero]  in
      let uu____10195 = let uu____10196 = as_arg t  in [uu____10196]  in
      mk_Tm_app uu____10193 uu____10195  in
    uu____10188 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10227 =
      let uu____10232 =
        let uu____10233 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10233 [U_zero]  in
      let uu____10234 = let uu____10235 = as_arg t  in [uu____10235]  in
      mk_Tm_app uu____10232 uu____10234  in
    uu____10227 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10271 =
        let uu____10276 =
          let uu____10277 = tabbrev FStar_Parser_Const.lid_tuple2  in
        ...
        mk_Tm_app uu____10276 uu____10278  in
      uu____10271 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10343 =
        let uu____10348 =
          let uu____10349 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10349 [U_zero; U_zero]  in
        let uu____10350 =
          let uu____10351 = as_arg t1  in
          let uu____10360 = let uu____10371 = as_arg t2  in [uu____10371]  in
          uu____10351 :: uu____10360  in
        mk_Tm_app uu____10348 uu____10350  in
      uu____10343 FStar_Pervasives_Native.None FStar_Range.dummyRange
