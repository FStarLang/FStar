...
let (uu___is_U_zero : universe -> Prims.bool) =
  fun projectee  ->
    match projectee with | U_zero  -> true | uu____491 -> false
...
let (uu___is_Strict : should_check_uvar -> Prims.bool) =
  fun projectee  ->
    match projectee with | Strict  -> true | uu____835 -> false
...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____1824 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____1861 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____1880 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____1917 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____2004 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____2071 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____2124 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____2213 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____2324 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____2434 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____2504 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____2573 -> false
...
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____3192 -> false
  
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee  -> match projectee with | Pat_constant _0 -> _0 
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_cons _0 -> true | uu____3224 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_var _0 -> true | uu____3282 -> false
  
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_var _0 -> _0 
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_wild _0 -> true | uu____3301 -> false
  
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_wild _0 -> _0 
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_dot_term _0 -> true | uu____3326 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Total _0 -> true | uu____3789 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | GTotal _0 -> true | uu____3840 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comp _0 -> true | uu____3883 -> false
  
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee  -> match projectee with | Comp _0 -> _0 
let (uu___is_TOTAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | TOTAL  -> true | uu____3901 -> false
  
let (uu___is_MLEFFECT : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | MLEFFECT  -> true | uu____3912 -> false
  
let (uu___is_LEMMA : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | LEMMA  -> true | uu____3923 -> false
  
let (uu___is_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | RETURN  -> true | uu____3934 -> false
  
let (uu___is_PARTIAL_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | PARTIAL_RETURN  -> true | uu____3945 -> false
  
let (uu___is_SOMETRIVIAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SOMETRIVIAL  -> true | uu____3956 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SHOULD_NOT_INLINE  -> true | uu____3978 -> false
  
let (uu___is_CPS : cflag -> Prims.bool) =
  fun projectee  -> match projectee with | CPS  -> true | uu____3989 -> false 
let (uu___is_DECREASES : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | DECREASES _0 -> true | uu____4003 -> false
  
let (__proj__DECREASES__item___0 : cflag -> term' syntax) =
  fun projectee  -> match projectee with | DECREASES _0 -> _0 
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_pattern _0 -> true | uu____4048 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____4127 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____4154 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____4197 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____4222 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____4267 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____4309 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____4320 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____4331 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____4342 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____4353 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____4369 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____4406 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____4448 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____4487 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____4527 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____4569 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____4608 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | BadLazy  -> true | uu____4979 -> false
  
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_bv  -> true | uu____4990 -> false
  
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_binder  -> true | uu____5001 -> false
  
let (uu___is_Lazy_optionstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_optionstate  -> true | uu____5012 -> false
  
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_fvar  -> true | uu____5023 -> false
  
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_comp  -> true | uu____5034 -> false
  
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_env  -> true | uu____5045 -> false
  
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_proofstate  -> true | uu____5056 -> false
  
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_goal  -> true | uu____5067 -> false
  
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_sigelt  -> true | uu____5078 -> false
  
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_uvar  -> true | uu____5089 -> false
  
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_embedding _0 -> true | uu____5109 -> false
...
let (uu___is_Binding_var : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_var _0 -> true | uu____5152 -> false
  
let (__proj__Binding_var__item___0 : binding -> bv) =
  fun projectee  -> match projectee with | Binding_var _0 -> _0 
let (uu___is_Binding_lid : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_lid _0 -> true | uu____5183 -> false
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____5545 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____5556 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____5567 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____5589 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____5600 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____5611 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____5633 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____5644 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____5655 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____5666 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____5677 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____5688 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____5700 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____5719 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____5742 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____5781 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____5832 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____5875 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____5904 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____5915 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____5926 -> false
...
let (uu___is_Primitive_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primitive_eff _0 -> true | uu____6761 -> false
...
let (uu___is_DM4F_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | DM4F_eff _0 -> true | uu____6780 -> false
...
let (uu___is_Layered_eff : eff_combinators -> Prims.bool) =
  fun projectee  ->
    match projectee with | Layered_eff _0 -> true | uu____6799 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7296 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7371 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7429 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7499 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7542 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7585 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7622 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7641 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7672 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7727 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7752 -> false
...
let (uu___is_Sig_fail : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_fail _0 -> true | uu____7860 -> false
...
let (order_bv : bv -> bv -> Prims.int) =
  fun x  ->
    fun y  ->
      let i =
        let uu____8203 = FStar_Ident.text_of_id x.ppname  in
        let uu____8205 = FStar_Ident.text_of_id y.ppname  in
        FStar_String.compare uu____8203 uu____8205  in
      if i = Prims.int_zero then x.index - y.index else i
  
let (order_ident : FStar_Ident.ident -> FStar_Ident.ident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8225 = FStar_Ident.text_of_id x  in
      let uu____8227 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8225 uu____8227
  
let (order_fv : FStar_Ident.lident -> FStar_Ident.lident -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8241 = FStar_Ident.string_of_lid x  in
      let uu____8243 = FStar_Ident.string_of_lid y  in
      FStar_String.compare uu____8241 uu____8243
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___413_8270 = x  in
      let uu____8271 = FStar_Ident.set_id_range r x.ppname  in
      {
        ppname = uu____8271;
        index = (uu___413_8270.index);
        sort = (uu___413_8270.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8307  ->
             ...
             | (bv1,t) -> let uu____8318 = f t  in (bv1, uu____8318))
          qi.antiquotes
         in
      let uu___421_8319 = qi  in
      { qkind = (uu___421_8319.qkind); antiquotes = aq }
  ...
  fun bv1  ->
    fun aq  ->
      let uu____8335 =
        FStar_List.tryFind
          (fun uu____8353  ->
             match uu____8353 with | (bv',uu____8362) -> bv_eq bv1 bv') aq
         in
      match uu____8335 with
      | FStar_Pervasives_Native.Some (uu____8369,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'uuuuuu8400 'uuuuuu8401 'uuuuuu8402 .
    'uuuuuu8400 ->
      'uuuuuu8401 ->
        ('uuuuuu8401 -> 'uuuuuu8400 -> 'uuuuuu8402) -> 'uuuuuu8402
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'uuuuuu8433 .
    unit -> 'uuuuuu8433 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8442  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'uuuuuu8450 .
    unit -> 'uuuuuu8450 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8459  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8469  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8479  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8489  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8504 = FStar_Ident.text_of_id x  in
      let uu____8506 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8504 uu____8506
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8515  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8534),Binding_lid (lid2,uu____8536)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8625  ->
      fun r  ->
        let uu____8629 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8629 }
  
let (bv_to_tm : bv -> term) =
  fun bv1  ->
    let uu____8640 = range_of_bv bv1  in
    mk (Tm_bvar bv1) FStar_Pervasives_Native.None uu____8640
  
let (bv_to_name : bv -> term) =
  fun bv1  ->
    let uu____8647 = range_of_bv bv1  in
    mk (Tm_name bv1) FStar_Pervasives_Native.None uu____8647
...
let (binders_to_names : binders -> term Prims.list) =
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____8677  ->
            match uu____8677 with | (x,uu____8685) -> bv_to_name x))
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun us  ->
      ...
      | uu____8745 -> failwith "Unexpected universe instantiation"
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8804 -> mk_Tm_app t args' kopt r
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9049 -> true | uu____9051 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9077 = null_bv t  in (uu____9077, FStar_Pervasives_Native.None)
...
let (is_null_bv : bv -> Prims.bool) =
  fun b  ->
    let uu____9109 = FStar_Ident.text_of_id b.ppname  in
    let uu____9111 = FStar_Ident.text_of_id null_id  in
    uu____9109 = uu____9111
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___1_9131  ->
    match uu___1_9131 with
    | { lbname = FStar_Util.Inr uu____9135; lbunivs = uu____9136;
        lbtyp = uu____9137; lbeff = uu____9138; lbdef = uu____9139;
        lbattrs = uu____9140; lbpos = uu____9141;_}::uu____9142 -> true
    | uu____9156 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9178  ->
         fun out  ->
           match uu____9178 with | (x,uu____9191) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9224 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9224 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___2_9235  ->
    match uu___2_9235 with
    | FStar_Pervasives_Native.Some (Implicit uu____9237) -> true
    | uu____9240 -> false
  
let (is_implicit_or_meta : aqual -> Prims.bool) =
  fun uu___3_9248  ->
    match uu___3_9248 with
    | FStar_Pervasives_Native.Some (Implicit uu____9250) -> true
    | FStar_Pervasives_Native.Some (Meta uu____9253) -> true
    | uu____9257 -> false
    ...
    let rec aux b p1 =
      ...
      | Pat_cons (uu____9313,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9347  ->
                 match uu____9347 with | (p2,uu____9360) -> aux b1 p2) b pats
       in
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        { ppname = id; index = uu____9421; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv1  ->
    let uu____9444 = is_null_bv bv1  in
    if uu____9444
    then
      let uu____9447 =
        let uu____9450 = range_of_bv bv1  in
        FStar_Pervasives_Native.Some uu____9450  in
      new_bv uu____9447 bv1.sort
    else
      (let uu___611_9453 = bv1  in
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv1,aq) -> let uu____9469 = freshen_bv bv1  in (uu____9469, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9484 =
      let uu____9490 =
        let uu____9492 = FStar_Util.string_of_int id  in
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv1  ->
    fun r  ->
      let uu___638_9601 = bv1  in
      let uu____9602 = FStar_Ident.set_id_range r bv1.ppname  in
      {
        ppname = uu____9602;
        index = (uu___638_9601.index);
        sort = (uu___638_9601.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____9623 =
          let uu____9624 = FStar_Ident.range_of_lid l  in
          withinfo l uu____9624  in
        { fv_name = uu____9623; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv1  ->
    let uu____9631 = FStar_Ident.range_of_lid (fv1.fv_name).v  in
    mk (Tm_fvar fv1) FStar_Pervasives_Native.None uu____9631
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9652 = lid_as_fv l dd dq  in fv_to_tm uu____9652
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv1  -> (fv1.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv1  ->
    let uu____9665 = lid_of_fv fv1  in FStar_Ident.range_of_lid uu____9665
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv1  ->
    fun r  ->
      let uu___651_9677 = fv1  in
      let uu____9678 =
        let uu___653_9679 = fv1.fv_name  in
        let uu____9680 =
          let uu____9681 = lid_of_fv fv1  in
          FStar_Ident.set_lid_range uu____9681 r  in
        { v = uu____9680; p = (uu___653_9679.p) }  in
      {
        fv_name = uu____9678;
        fv_delta = (uu___651_9677.fv_delta);
        fv_qual = (uu___651_9677.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9707  ->
           match uu___6_9707 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9712));
               pos = uu____9713; vars = uu____9714;_} when data = s -> true
           | uu____9721 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9780 = fv_eq fv1 fv2  in
          if uu____9780
          then
            let uu____9785 = FStar_List.zip as1 as2  in
            FStar_All.pipe_right uu____9785
              (FStar_List.for_all
                 (fun uu____9852  ->
                    match uu____9852 with
                    | ((p11,b1),(p21,b2)) -> (b1 = b2) && (eq_pat p11 p21)))
          else false
      | (Pat_var uu____9890,Pat_var uu____9891) -> true
      | (Pat_wild uu____9893,Pat_wild uu____9894) -> true
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____9928 =
      let uu____9935 = let uu____9936 = fvconst l  in Tm_fvar uu____9936  in
      mk uu____9935  in
    uu____9928 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tac_of : term -> term -> term) =
  fun a  ->
    fun b  ->
      let uu____9989 =
        let uu____9994 =
          let uu____9995 = tabbrev FStar_Parser_Const.tac_lid  in
          mk_Tm_uinst uu____9995 [U_zero; U_zero]  in
        let uu____9996 =
          let uu____9997 = as_arg a  in
          let uu____10006 = let uu____10017 = as_arg b  in [uu____10017]  in
          uu____9997 :: uu____10006  in
        mk_Tm_app uu____9994 uu____9996  in
      uu____9989 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_tactic_of : term -> term) =
  fun t  ->
    let uu____10056 =
      let uu____10061 =
        let uu____10062 = tabbrev FStar_Parser_Const.tactic_lid  in
        mk_Tm_uinst uu____10062 [U_zero]  in
      let uu____10063 = let uu____10064 = as_arg t  in [uu____10064]  in
      mk_Tm_app uu____10061 uu____10063  in
    uu____10056 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10135 =
      let uu____10140 =
        let uu____10141 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10141 [U_zero]  in
      let uu____10142 = let uu____10143 = as_arg t  in [uu____10143]  in
      mk_Tm_app uu____10140 uu____10142  in
    uu____10135 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10179 =
        let uu____10184 =
          let uu____10185 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10185 [U_zero; U_zero]  in
        let uu____10186 =
          let uu____10187 = as_arg t1  in
          let uu____10196 = let uu____10207 = as_arg t2  in [uu____10207]  in
          uu____10187 :: uu____10196  in
        mk_Tm_app uu____10184 uu____10186  in
      uu____10179 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10251 =
        let uu____10256 =
          let uu____10257 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10257 [U_zero; U_zero]  in
        let uu____10258 =
          let uu____10259 = as_arg t1  in
          let uu____10268 = let uu____10279 = as_arg t2  in [uu____10279]  in
          uu____10259 :: uu____10268  in
        mk_Tm_app uu____10256 uu____10258  in
      uu____10251 FStar_Pervasives_Native.None FStar_Range.dummyRange
