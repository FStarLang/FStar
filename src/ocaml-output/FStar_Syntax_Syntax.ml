...
let uu___is_Tm_uinst: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____745 -> false
...
let uu___is_Tm_constant: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____769 -> false
...
let uu___is_Tm_type: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____781 -> false
...
let uu___is_Tm_abs: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____807 -> false
...
let uu___is_Tm_arrow: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____868 -> false
...
let uu___is_Tm_refine: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____905 -> false
...
let uu___is_Tm_app: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____938 -> false
...
let uu___is_Tm_match: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____992 -> false
...
let uu___is_Tm_ascribed: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____1066 -> false
...
let uu___is_Tm_let: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____1136 -> false
...
let uu___is_Tm_uvar: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____1177 -> false
...
let uu___is_Tm_delayed: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____1233 -> false
...
let uu___is_Tm_meta: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_meta _0 -> true | uu____1309 -> false
...
let uu___is_Tm_unknown: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tm_unknown  -> true | uu____1332 -> false
let uu___is_Pat_constant: pat' -> Prims.bool =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____1337 -> false
...
let uu___is_Assumption: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____2283 -> false
let uu___is_New: qualifier -> Prims.bool =
  fun projectee  -> match projectee with | New  -> true | uu____2287 -> false
let uu___is_Private: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Private  -> true | uu____2291 -> false
...
let uu___is_Visible_default: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____2299 -> false
let uu___is_Irreducible: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____2303 -> false
let uu___is_Abstract: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____2307 -> false
...
let uu___is_NoExtract: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____2315 -> false
let uu___is_Noeq: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____2319 -> false
let uu___is_Unopteq: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____2323 -> false
let uu___is_TotalEffect: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____2327 -> false
let uu___is_Logic: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____2331 -> false
let uu___is_Reifiable: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____2335 -> false
let uu___is_Reflectable: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____2340 -> false
...
let uu___is_Discriminator: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____2352 -> false
...
let uu___is_Projector: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____2366 -> false
...
let uu___is_RecordType: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____2388 -> false
...
let uu___is_RecordConstructor: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____2416 -> false
...
let uu___is_Action: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____2440 -> false
...
let uu___is_HasMaskedEffect: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____2455 -> false
let uu___is_Effect: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____2459 -> false
let uu___is_OnlyName: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____2463 -> false
type attribute = term
...
let uu___is_Sig_inductive_typ: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____2816 -> false
...
let uu___is_Sig_bundle: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____2856 -> false
...
let uu___is_Sig_datacon: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____2887 -> false
...
let uu___is_Sig_declare_typ: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____2923 -> false
...
let uu___is_Sig_let: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____2949 -> false
...
let uu___is_Sig_main: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____2976 -> false
...
let uu___is_Sig_assume: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____2990 -> false
...
let uu___is_Sig_new_effect: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____3008 -> false
...
let uu___is_Sig_sub_effect: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____3032 -> false
...
let uu___is_Sig_effect_abbrev: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____3050 -> false
...
let uu___is_Sig_pragma: sigelt' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____3080 -> false
...
let contains_reflectable: qualifier Prims.list -> Prims.bool =
  fun l  ->
    FStar_Util.for_some
      (fun uu___87_3157  ->
         match uu___87_3157 with
         | Reflectable uu____3158 -> true
         | uu____3159 -> false) l
...
let set_range_of_bv: bv -> FStar_Range.range -> bv =
  fun x  ->
    fun r  ->
      let uu___94_3235 = x in
      {
        ppname = (FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r));
        index = (uu___94_3235.index);
        sort = (uu___94_3235.sort)
      }
let syn p k f = f k p
let mk_fvs uu____3276 = FStar_Util.mk_ref FStar_Pervasives_Native.None
let mk_uvs uu____3288 = FStar_Util.mk_ref FStar_Pervasives_Native.None
    ...
    FStar_Util.new_set
      (fun uu____3314  ->
         fun uu____3315  ->
           ...
           | ((x,uu____3349),(y,uu____3351)) ->
               let uu____3392 = FStar_Unionfind.uvar_id x in
               let uu____3396 = FStar_Unionfind.uvar_id y in
               uu____3392 - uu____3396)
      (fun uu____3400  ->
         match uu____3400 with | (x,uu____3410) -> FStar_Unionfind.uvar_id x)
let new_universe_uvar_set:
  ...
  fun uu____3429  ->
    FStar_Util.new_set
      (fun x  ->
         fun y  ->
           let uu____3439 = FStar_Unionfind.uvar_id x in
           let uu____3441 = FStar_Unionfind.uvar_id y in
           uu____3439 - uu____3441) (fun x  -> FStar_Unionfind.uvar_id x)
...
let mk t topt r =
  let uu____3514 = FStar_Util.mk_ref topt in
  let uu____3518 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  { n = t; tk = uu____3514; pos = r; vars = uu____3518 }
let bv_to_tm: bv -> (term',term') syntax =
  fun bv  ->
    let uu____3529 = range_of_bv bv in
    mk (Tm_bvar bv) (FStar_Pervasives_Native.Some ((bv.sort).n)) uu____3529
let bv_to_name: bv -> (term',term') syntax =
  fun bv  ->
    let uu____3537 = range_of_bv bv in
    mk (Tm_name bv) (FStar_Pervasives_Native.Some ((bv.sort).n)) uu____3537
let mk_Tm_app:
  typ ->
    arg Prims.list ->
    ...
    fun args  ->
      fun k  ->
        fun p  ->
          match args with
          | [] -> t1
          | uu____3558 -> mk (Tm_app (t1, args)) k p
let mk_Tm_uinst: term -> universes -> term =
  fun t  ->
    fun uu___88_3570  ->
      match uu___88_3570 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____3572 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____3577 -> failwith "Unexpected universe instantiation")
let extend_app_n:
  term ->
    args ->
      term' FStar_Pervasives_Native.option ->
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____3615 -> mk_Tm_app t args' kopt r
let extend_app:
  term ->
    arg ->
      term' FStar_Pervasives_Native.option ->
  ...
  fun lr  ->
    fun pos  ->
      let uu____3652 =
        let uu____3655 =
          let uu____3656 =
            let uu____3677 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
            (lr, uu____3677) in
          Tm_delayed uu____3656 in
        mk uu____3655 in
      uu____3652 FStar_Pervasives_Native.None pos
let mk_Total':
...
let is_type: term -> Prims.bool =
  fun t  -> match t.n with | Tm_type uu____3807 -> true | uu____3808 -> false
...
let null_binder:
  ...
  =
  fun t  ->
    let uu____3819 = null_bv t in (uu____3819, FStar_Pervasives_Native.None)
...
let is_top_level: letbinding Prims.list -> Prims.bool =
  fun uu___89_3838  ->
    match uu___89_3838 with
    | { lbname = FStar_Util.Inr uu____3840; lbunivs = uu____3841;
        lbtyp = uu____3842; lbeff = uu____3843; lbdef = uu____3844;_}::uu____3845
        -> true
    | uu____3852 -> false
let freenames_of_binders: binders -> bv FStar_Util.set =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____3860  ->
         fun out  ->
           match uu____3860 with | (x,uu____3867) -> FStar_Util.set_add x out)
      bs no_names
let binders_of_list:
  bv Prims.list ->
    (bv,arg_qualifier FStar_Pervasives_Native.option)
...
let binders_of_freenames: freenames -> binders =
  fun fvs  ->
    let uu____3886 = FStar_Util.set_elements fvs in
    FStar_All.pipe_right uu____3886 binders_of_list
let is_implicit: aqual -> Prims.bool =
  fun uu___90_3891  ->
    match uu___90_3891 with
    | FStar_Pervasives_Native.Some (Implicit uu____3892) -> true
    | uu____3893 -> false
...
let pat_bvs: pat -> bv Prims.list =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____3918 -> b
      | Pat_constant uu____3923 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____3926,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____3944  ->
                 match uu____3944 with | (p2,uu____3952) -> aux b1 p2) b pats in
    let uu____3957 = aux [] p in
    FStar_All.pipe_left FStar_List.rev uu____3957
let gen_reset:
  (Prims.unit -> Prims.int,Prims.unit -> Prims.unit)
    FStar_Pervasives_Native.tuple2
  =
  let x = FStar_Util.mk_ref (Prims.parse_int "0") in
  let gen1 uu____3973 = FStar_Util.incr x; FStar_ST.read x in
  let reset uu____3983 = FStar_ST.write x (Prims.parse_int "0") in
  (gen1, reset)
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____4020 = next_id () in
        { ppname = id; index = uu____4020; sort = t }
...
let freshen_bv: bv -> bv =
  fun bv  ->
    let uu____4032 = is_null_bv bv in
    if uu____4032
    then
      let uu____4033 =
        let uu____4035 = range_of_bv bv in
        FStar_Pervasives_Native.Some uu____4035 in
      new_bv uu____4033 bv.sort
    else
      (let uu___95_4037 = bv in
       let uu____4038 = next_id () in
       {
         ppname = (uu___95_4037.ppname);
         index = uu____4038;
         sort = (uu___95_4037.sort)
       })
let new_univ_name:
  ...
  fun ropt  ->
    ...
    let uu____4045 =
      let uu____4048 =
        let uu____4049 = FStar_Util.string_of_int id in
        Prims.strcat FStar_Ident.reserved_prefix uu____4049 in
      (uu____4048, (range_of_ropt ropt)) in
    FStar_Ident.mk_ident uu____4045
...
let set_bv_range: bv -> FStar_Range.range -> bv =
  fun bv  ->
    fun r  ->
      let uu___96_4130 = bv in
      {
        ppname = (FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r));
        index = (uu___96_4130.index);
        sort = (uu___96_4130.sort)
      }
let lid_as_fv:
  FStar_Ident.lident ->
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____4142 = withinfo l tun (FStar_Ident.range_of_lid l) in
        { fv_name = uu____4142; fv_delta = dd; fv_qual = dq }
...
let fvar:
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____4173 = lid_as_fv l dd dq in fv_to_tm uu____4173
let lid_of_fv: fv -> FStar_Ident.lident = fun fv  -> (fv.fv_name).v
let range_of_fv: fv -> FStar_Range.range =
  fun fv  ->
    let uu____4184 = lid_of_fv fv in FStar_Ident.range_of_lid uu____4184
let set_range_of_fv: fv -> FStar_Range.range -> fv =
  fun fv  ->
    fun r  ->
      let uu___97_4191 = fv in
      let uu____4192 =
        let uu___98_4196 = fv.fv_name in
        let uu____4201 =
          let uu____4202 = lid_of_fv fv in
          FStar_Ident.set_lid_range uu____4202 r in
        { v = uu____4201; ty = (uu___98_4196.ty); p = (uu___98_4196.p) } in
      {
        fv_name = uu____4192;
        fv_delta = (uu___97_4191.fv_delta);
        fv_qual = (uu___97_4191.fv_qual)
      }
let has_simple_attribute: term Prims.list -> Prims.string -> Prims.bool =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___93_4226  ->
           match uu___93_4226 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____4230));
               tk = uu____4231; pos = uu____4232; vars = uu____4233;_} when
