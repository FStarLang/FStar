...
let _75_19 = (let _166_27 = (FStar_Absyn_Print.format_error r msg)
in (FStar_All.pipe_left FStar_Util.print_string _166_27))
in (FStar_All.failwith msg)))


let err_uninst = (fun env e _75_25 -> (match (_75_25) with
| (vars, t) -> begin
(let _166_35 = (let _166_34 = (FStar_Absyn_Print.exp_to_string e)
in (let _166_33 = (let _166_31 = (FStar_All.pipe_right vars (FStar_List.map Prims.fst))
in (FStar_All.pipe_right _166_31 (FStar_String.concat ", ")))
in (let _166_32 = (FStar_Extraction_ML_Code.string_of_mlty env.FStar_Extraction_ML_Env.currentModule t)
in (FStar_Util.format3 "Variable %s has a polymorphic type (forall %s. %s); expected it to be fully instantiated" _166_34 _166_33 _166_32))))
in (fail e.FStar_Absyn_Syntax.pos _166_35))
end))


let err_ill_typed_application = (fun e args t -> (let _166_41 = (let _166_40 = (FStar_Absyn_Print.exp_to_string e)
in (let _166_39 = (FStar_Absyn_Print.args_to_string args)
in (FStar_Util.format2 "Ill-typed application: application is %s \n remaining args are %s\n" _166_40 _166_39)))
in (fail e.FStar_Absyn_Syntax.pos _166_41)))


let err_value_restriction = (fun e -> (fail e.FStar_Absyn_Syntax.pos "Refusing to generalize because of the value restriction"))


let err_unexpected_eff = (fun e f0 f1 -> (let _166_47 = (let _166_46 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s" _166_46 (FStar_Extraction_ML_Util.eff_to_string f0) (FStar_Extraction_ML_Util.eff_to_string f1)))
in (fail e.FStar_Absyn_Syntax.pos _166_47)))


let is_constructor : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun e -> (match ((let _166_50 = (FStar_Absyn_Util.compress_exp e)
in _166_50.FStar_Absyn_Syntax.n)) with
...
let rec is_value_or_type_app : FStar_Absyn_Syntax.exp  ->  Prims.bool = (fun e -> (match ((let _166_53 = (FStar_Absyn_Util.compress_exp e)
in _166_53.FStar_Absyn_Syntax.n)) with
...
(match ((let _166_55 = (FStar_Absyn_Util.compress_exp head)
in _166_55.FStar_Absyn_Syntax.n)) with
...
let translate_typ : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Extraction_ML_Syntax.mlty = (fun g t -> (let _166_64 = (FStar_Extraction_ML_ExtractTyp.extractTyp g t)
in (eraseTypeDeep g _166_64)))


let translate_typ_of_arg : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.arg  ->  FStar_Extraction_ML_Syntax.mlty = (fun g a -> (let _166_69 = (FStar_Extraction_ML_ExtractTyp.getTypeFromArg g a)
in (eraseTypeDeep g _166_69)))
...
| () -> begin
(let _166_90 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_Env.currentModule e)
in (let _166_89 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_Env.currentModule t)
...
let x = (let _166_111 = (FStar_Absyn_Util.new_bvd None)
in (FStar_Extraction_ML_Syntax.as_mlident _166_111))
in (

let when_clause = (let _166_120 = (let _166_119 = (let _166_118 = (let _166_117 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (let _166_116 = (let _166_115 = (let _166_114 = (let _166_113 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Absyn_Syntax.p i)
in (FStar_All.pipe_left (fun _166_112 -> FStar_Extraction_ML_Syntax.MLE_Const (_166_112)) _166_113))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) _166_114))
in (_166_115)::[])
in (_166_117)::_166_116))
in (FStar_Extraction_ML_Util.prims_op_equality, _166_118))
in FStar_Extraction_ML_Syntax.MLE_App (_166_119))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _166_120))
in (g, Some ((FStar_Extraction_ML_Syntax.MLP_Var (x), (when_clause)::[]))))))
end
| FStar_Absyn_Syntax.Pat_constant (s) -> begin
(let _166_124 = (let _166_123 = (let _166_122 = (let _166_121 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Absyn_Syntax.p s)
in FStar_Extraction_ML_Syntax.MLP_Const (_166_121))
in (_166_122, []))
in Some (_166_123))
in (g, _166_124))
end
...
let _75_236 = (let _166_130 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _75_2 -> (match (_75_2) with
| Some (x) -> begin
(x)::[]
end
| _75_233 -> begin
...
in (FStar_All.pipe_right _166_130 FStar_List.split))
in (match (_75_236) with
| (mlPats, when_clauses) -> begin
(let _166_134 = (let _166_133 = (let _166_132 = (FStar_All.pipe_left (FStar_Extraction_ML_Util.resugar_pat q) (FStar_Extraction_ML_Syntax.MLP_CTor ((d, mlPats))))
in (let _166_131 = (FStar_All.pipe_right when_clauses FStar_List.flatten)
in (_166_132, _166_131)))
in Some (_166_133))
in (g, _166_134))
end))
end))
...
| (hd)::tl -> begin
(let _166_143 = (FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd tl)
in Some (_166_143))
end))
...
let ps = (let _166_146 = (FStar_All.pipe_right pats (FStar_List.map (fun x -> (let _166_145 = (extract_one_pat true g x)
in (Prims.snd _166_145)))))
in (p)::_166_146)
in (
...
| (x, whens) -> begin
(let _166_149 = (mk_when_clause whens)
in (x, _166_149))
end))))
in (
...
| rest -> begin
(let _166_153 = (let _166_152 = (let _166_151 = (let _166_150 = (FStar_List.map Prims.fst rest)
in FStar_Extraction_ML_Syntax.MLP_Branch (_166_150))
in (_166_151, None))
in (_166_152)::ps)
in (g, _166_153))
end)
...
(let _166_162 = (FStar_Util.string_of_int n)
in (Prims.strcat "mktuple" _166_162))
end else begin
if (n = 2) then begin
"mkpair"
end else begin
...
let tup = (let _166_169 = (let _166_168 = (let _166_167 = (let _166_166 = (let _166_165 = (ffi_mltuple_mlp (FStar_List.length args))
in FStar_Extraction_ML_Syntax.MLE_Name (_166_165))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _166_166))
in (_166_167, args))
in FStar_Extraction_ML_Syntax.MLE_App (_166_168))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _166_169))
in (
...
let x = (let _166_182 = (FStar_Absyn_Util.gensym ())
in (_166_182, (- (1))))
in (let _166_185 = (let _166_184 = (let _166_183 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t0) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in ((x, t0), _166_183))
in (_166_184)::more_args)
in (eta_args _166_185 t1)))
end
...
(match (eargs) with
| [] -> begin
(let _166_194 = (as_record qual e)
in (FStar_Extraction_ML_Util.resugar_exp _166_194))
end
| _75_397 -> begin
(
...
let body = (let _166_196 = (let _166_195 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tres) (FStar_Extraction_ML_Syntax.MLE_CTor ((head, (FStar_List.append args eargs)))))
in (FStar_All.pipe_left (as_record qual) _166_195))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _166_196))
...
| _75_449 -> begin
(let _166_199 = (let _166_198 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) proj)
in (_166_198, args))
in FStar_Extraction_ML_Syntax.MLE_App (_166_199))
end)
...
(let _166_200 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor ((mlp, mlargs))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _166_200))
end
...
(let _166_201 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor ((mlp, []))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _166_201))
end
| _75_489 -> begin
mlAppExpr
end)))))
...
let _75_499 = (let _166_204 = (FStar_List.tl l)
in (FStar_List.hd _166_204))
...
let _75_529 = (let _166_221 = (check_exp' g e f t)
in (erase g _166_221 f t))
...
let _75_547 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _166_233 = (let _166_232 = (FStar_Absyn_Print.tag_of_exp e)
in (let _166_231 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format2 "now synthesizing expression (%s) :  %s \n" _166_232 _166_231)))
in (FStar_Util.print_string _166_233))))
in (match ((let _166_234 = (FStar_Absyn_Util.compress_exp e)
in _166_234.FStar_Absyn_Syntax.n)) with
...
in (let _166_238 = (let _166_237 = (let _166_236 = (FStar_Extraction_ML_Util.mlconst_of_const' e.FStar_Absyn_Syntax.pos c)
in (FStar_All.pipe_left (fun _166_235 -> FStar_Extraction_ML_Syntax.MLE_Const (_166_235)) _166_236))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _166_237))
in (_166_238, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))))
end
...
(match (mltys) with
| ([], t) -> begin
(let _166_239 = (maybe_lalloc_eta_data g qual t x)
in (_166_239, FStar_Extraction_ML_Syntax.E_PURE, t))
end
| _75_581 -> begin
...
(let _166_248 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in ([], _166_248))
end else begin
...
let x = (let _166_251 = (FStar_Absyn_Util.gensym ())
in (_166_251, (- (1))))
in (let _166_253 = (let _166_252 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_166_252)::out_args)
in (((x, arg))::lbs, _166_253)))
end
end)) ([], []) mlargs_f)
end
...
let app = (let _166_254 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App ((mlhead, mlargs))))
in (FStar_All.pipe_left (maybe_lalloc_eta_data g is_data t) _166_254))
in (
...
(let _166_258 = (let _166_257 = (FStar_Extraction_ML_Util.join f f')
in (_166_257, t))
in (synth_app is_data (mlhead, ((FStar_Extraction_ML_Syntax.ml_unit, FStar_Extraction_ML_Syntax.E_PURE))::mlargs_f) _166_258 rest))
end else begin
...
in (let _166_260 = (let _166_259 = (FStar_Extraction_ML_Util.join_l ((f)::(f')::(f0)::[]))
in (_166_259, t))
in (synth_app is_data (mlhead, ((e0, f0))::mlargs_f) _166_260 rest)))
end))
end
| _75_648 -> begin
...
(let _166_275 = (FStar_Extraction_ML_Util.join f f')
in (remove_implicits args _166_275 t))
end
| _75_685 -> begin
(args, f, t)
end))
...
(match (args) with
| [] -> begin
(let _166_276 = (maybe_lalloc_eta_data g qual head_t head_ml)
in (_166_276, FStar_Extraction_ML_Syntax.E_PURE, head_t))
end
| _75_762 -> begin
...
let ml_b = (let _166_279 = (FStar_Extraction_ML_Env.btvar_as_mlTermVar a)
in (_166_279, FStar_Extraction_ML_Syntax.ml_unit_ty))
in ((ml_b)::ml_bs, env)))
end
...
| (f, tfun) -> begin
(let _166_282 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun ((ml_bs, ml_body))))
in (_166_282, f, tfun))
end))
end)))
end))
...
(let _166_286 = (FStar_Absyn_Syntax.mk_Typ_fun ((b)::rest, c) None c.FStar_Absyn_Syntax.pos)
in (bs, _166_286))
end)
...
let polytype = (let _166_290 = (FStar_All.pipe_right targs (FStar_List.map FStar_Extraction_ML_Env.btvar_as_mltyvar))
in (_166_290, expected_t))
in (
...
let f = (let _166_300 = (let _166_299 = (FStar_List.map Prims.fst lbs)
in (f')::_166_299)
in (FStar_Extraction_ML_Util.join_l _166_300))
in (
...
in (let _166_306 = (let _166_305 = (let _166_303 = (let _166_302 = (let _166_301 = (FStar_List.map Prims.snd lbs)
in (is_rec, _166_301))
in (_166_302, e'))
in FStar_Extraction_ML_Syntax.MLE_Let (_166_303))
in (let _166_304 = (FStar_Extraction_ML_Util.mlloc_of_range e.FStar_Absyn_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _166_305 _166_304)))
in (_166_306, f, t'))))
end))))
end)))))
end
...
let _75_942 = (synth_exp g scrutinee)
in (match (_75_942) with
| (e, f_e, t_e) -> begin
(

let _75_946 = (check_pats_for_ite pats)
in (match (_75_946) with
...
let _75_958 = (synth_exp g then_e)
in (match (_75_958) with
| (then_mle, f_then, t_then) -> begin
(

let _75_962 = (synth_exp g else_e)
in (match (_75_962) with
| (else_mle, f_else, t_else) -> begin
(

let _75_965 = if (type_leq g t_then t_else) then begin
(t_else, no_lift)
end else begin
...
in (match (_75_965) with
| (t_branch, maybe_lift) -> begin
(let _166_337 = (let _166_335 = (let _166_334 = (let _166_333 = (maybe_lift then_mle t_then)
in (let _166_332 = (let _166_331 = (maybe_lift else_mle t_else)
in Some (_166_331))
in (e, _166_333, _166_332)))
in FStar_Extraction_ML_Syntax.MLE_If (_166_334))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _166_335))
in (let _166_336 = (FStar_Extraction_ML_Util.join f_then f_else)
in (_166_337, _166_336, t_branch)))
end))
end))
end))
end
...
let mlbranches = (FStar_All.pipe_right pats (FStar_List.collect (fun _75_971 -> (match (_75_971) with
| (pat, when_opt, branch) -> begin
(

let _75_974 = (extract_pat g pat)
in (match (_75_974) with
| (env, p) -> begin
(

let _75_985 = (match (when_opt) with
| None -> begin
...
in (match (_75_985) with
| (when_opt, f_when) -> begin
(

let _75_989 = (synth_exp env branch)
in (match (_75_989) with
| (mlbranch, f_branch, t_branch) -> begin
(FStar_All.pipe_right p (FStar_List.map (fun _75_992 -> (match (_75_992) with
| (p, wopt) -> begin
(
...
let _75_1001 = (FStar_Extraction_ML_Env.lookup_fv g (FStar_Absyn_Util.fv FStar_Absyn_Const.failwith_lid))
in (match (_75_1001) with
| (fw, _75_998, _75_1000) -> begin
(let _166_344 = (let _166_343 = (let _166_342 = (let _166_341 = (let _166_340 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_166_340)::[])
in (fw, _166_341))
in FStar_Extraction_ML_Syntax.MLE_App (_166_342))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _166_343))
in (_166_344, FStar_Extraction_ML_Syntax.E_PURE, FStar_Extraction_ML_Syntax.ml_unit_ty))
end))
end
| ((_75_1004, _75_1006, (_75_1008, f_first, t_first)))::rest -> begin
(

let _75_1034 = (FStar_List.fold_left (fun _75_1016 _75_1026 -> (match ((_75_1016, _75_1026)) with
| ((topt, f), (_75_1018, _75_1020, (_75_1022, f_branch, t_branch))) -> begin
(
...
in (match (_75_1034) with
| (topt, f_match) -> begin
(

let mlbranches = (FStar_All.pipe_right mlbranches (FStar_List.map (fun _75_1045 -> (match (_75_1045) with
| (p, (wopt, _75_1038), (b, _75_1042, t)) -> begin
(
...
in (let _166_348 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match ((e, mlbranches))))
in (_166_348, f_match, t_match))))
end))
end))
end)
end))
...
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _75_1058)) -> begin
(synth_exp g e)
end
...
let _75_1070 = (FStar_Util.incr c)
in (let _166_351 = (FStar_ST.read c)
in (x, _166_351)))))
...
| FStar_Absyn_Syntax.Typ_fun (binders, _75_1078) -> begin
(let _166_361 = (FStar_All.pipe_right binders (FStar_List.filter (fun _75_6 -> (match (_75_6) with
| (_75_1083, Some (FStar_Absyn_Syntax.Implicit (_75_1085))) -> begin
true
end
| _75_1090 -> begin
false
end))))
in (FStar_All.pipe_right _166_361 (FStar_List.map (fun _75_1091 -> (let _166_360 = (fresh "_")
in (_166_360, FStar_Extraction_ML_Syntax.MLTY_Top))))))
end
| _75_1094 -> begin
...
let discrBody = (let _166_376 = (let _166_375 = (let _166_374 = (let _166_373 = (let _166_372 = (let _166_371 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name (([], (FStar_Extraction_ML_Syntax.idsym mlid)))))
in (let _166_370 = (let _166_369 = (let _166_365 = (let _166_363 = (let _166_362 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in (_166_362, (FStar_Extraction_ML_Syntax.MLP_Wild)::[]))
in FStar_Extraction_ML_Syntax.MLP_CTor (_166_363))
in (let _166_364 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in (_166_365, None, _166_364)))
in (let _166_368 = (let _166_367 = (let _166_366 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in (FStar_Extraction_ML_Syntax.MLP_Wild, None, _166_366))
in (_166_367)::[])
in (_166_369)::_166_368))
in (_166_371, _166_370)))
in FStar_Extraction_ML_Syntax.MLE_Match (_166_372))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _166_373))
in ((FStar_List.append wildcards (((mlid, targ))::[])), _166_374))
in FStar_Extraction_ML_Syntax.MLE_Fun (_166_375))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _166_376))
