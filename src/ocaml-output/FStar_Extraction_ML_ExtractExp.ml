...
let rec check_exp = (fun g e f t -> (let _62_463 = (let _127_191 = (check_exp' g e f t)
...
and synth_exp' = (fun g e -> (let _62_508 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _127_206 = (let _127_205 = (FStar_Absyn_Print.exp_to_string e)
...
in (let _127_211 = (let _127_210 = (let _127_209 = (FStar_Extraction_ML_Util.mlconst_of_const' e.FStar_Absyn_Syntax.pos c)
in (FStar_All.pipe_left (fun _127_208 -> FStar_Extraction_ML_Syntax.MLE_Const (_127_208)) _127_209))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _127_210))
in (_127_211, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))))
end
...
in (_127_224, (- (1))))
in (let _127_226 = (let _127_225 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_127_225)::out_args)
in (((x, arg))::lbs, _127_226)))
end)
end)) ([], []) mlargs_f)
end)
in (match (_62_567) with
| (lbs, mlargs) -> begin
(let app = (let _127_227 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App ((mlhead, mlargs))))
in (FStar_All.pipe_left (maybe_lalloc_eta_data g is_data t) _127_227))
...
| true -> begin
(let _127_231 = (let _127_230 = (FStar_Extraction_ML_Util.join f f')
in (_127_230, t))
in (synth_app is_data (mlhead, ((FStar_Extraction_ML_Syntax.ml_unit, FStar_Extraction_ML_Syntax.E_PURE))::mlargs_f) _127_231 rest))
end
| false -> begin
...
in (let _127_233 = (let _127_232 = (FStar_Extraction_ML_Util.join_l ((f)::(f')::(f0)::[]))
in (_127_232, t))
in (synth_app is_data (mlhead, ((e0, f0))::mlargs_f) _127_233 rest)))
end))
end
| _62_607 -> begin
...
in (match (rest) with
| [] -> begin
(let _127_234 = (maybe_lalloc_eta_data g qual t head)
in (_127_234, FStar_Extraction_ML_Syntax.E_PURE, t))
end
| _62_656 -> begin
...
in (let ml_b = (let _127_237 = (FStar_Extraction_ML_Env.btvar_as_mlTermVar a)
in (_127_237, FStar_Extraction_ML_Syntax.ml_unit_ty))
in ((ml_b)::ml_bs, env)))
end
...
| (f, tfun) -> begin
(let _127_240 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun ((ml_bs, ml_body))))
in (_127_240, f, tfun))
end))
end)))
end))
...
(let _127_244 = (FStar_Absyn_Syntax.mk_Typ_fun ((b)::rest, c) None c.FStar_Absyn_Syntax.pos)
in (bs, _127_244))
end)
...
in (let polytype = (let _127_248 = (FStar_All.pipe_right targs (FStar_List.map FStar_Extraction_ML_Env.btvar_as_mltyvar))
in (_127_248, expected_t))
...
| (e', f', t') -> begin
(let f = (let _127_258 = (let _127_257 = (FStar_List.map Prims.fst lbs)
in (f')::_127_257)
in (FStar_Extraction_ML_Util.join_l _127_258))
in (let _127_263 = (let _127_262 = (let _127_261 = (let _127_260 = (let _127_259 = (FStar_List.map Prims.snd lbs)
in (is_rec, _127_259))
in (_127_260, e'))
in FStar_Extraction_ML_Syntax.MLE_Let (_127_261))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t') _127_262))
in (_127_263, f, t')))
end))))
end)))))
end
...
in (let _62_855 = (let _127_273 = (FStar_Absyn_Util.fv constrName)
...
in (let discrBody = (let _127_288 = (let _127_287 = (let _127_286 = (let _127_285 = (let _127_284 = (let _127_283 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name (([], (FStar_Extraction_ML_Syntax.idsym mlid)))))
in (let _127_282 = (let _127_281 = (let _127_277 = (let _127_275 = (let _127_274 = (FStar_Extraction_ML_Syntax.mlpath_of_lident rid)
in (_127_274, arg_pat))
in FStar_Extraction_ML_Syntax.MLP_CTor (_127_275))
in (let _127_276 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in (_127_277, None, _127_276)))
in (let _127_280 = (let _127_279 = (let _127_278 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in (FStar_Extraction_ML_Syntax.MLP_Wild, None, _127_278))
in (_127_279)::[])
in (_127_281)::_127_280))
in (_127_283, _127_282)))
in FStar_Extraction_ML_Syntax.MLE_Match (_127_284))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _127_285))
in (((mlid, targ))::[], _127_286))
in FStar_Extraction_ML_Syntax.MLE_Fun (_127_287))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _127_288))
