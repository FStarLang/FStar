...
let _77_19 = (let _172_27 = (FStar_Absyn_Print.format_error r msg)
in (FStar_All.pipe_left FStar_Util.print_string _172_27))
in (FStar_All.failwith msg)))


let err_uninst = (fun env e _77_25 -> (match (_77_25) with
| (vars, t) -> begin
(let _172_35 = (let _172_34 = (FStar_Absyn_Print.exp_to_string e)
in (let _172_33 = (let _172_31 = (FStar_All.pipe_right vars (FStar_List.map Prims.fst))
in (FStar_All.pipe_right _172_31 (FStar_String.concat ", ")))
in (let _172_32 = (FStar_Extraction_ML_Code.string_of_mlty env.FStar_Extraction_ML_Env.currentModule t)
in (FStar_Util.format3 "Variable %s has a polymorphic type (forall %s. %s); expected it to be fully instantiated" _172_34 _172_33 _172_32))))
in (fail e.FStar_Absyn_Syntax.pos _172_35))
end))


let err_ill_typed_application = (fun e args t -> (let _172_41 = (let _172_40 = (FStar_Absyn_Print.exp_to_string e)
in (let _172_39 = (FStar_Absyn_Print.args_to_string args)
in (FStar_Util.format2 "Ill-typed application: application is %s \n remaining args are %s\n" _172_40 _172_39)))
in (fail e.FStar_Absyn_Syntax.pos _172_41)))


let err_value_restriction = (fun e -> (fail e.FStar_Absyn_Syntax.pos "Refusing to generalize because of the value restriction"))


let err_unexpected_eff = (fun e f0 f1 -> (let _172_47 = (let _172_46 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s" _172_46 (FStar_Extraction_ML_Util.eff_to_string f0) (FStar_Extraction_ML_Util.eff_to_string f1)))
in (fail e.FStar_Absyn_Syntax.pos _172_47)))


let is_constructor : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun e -> (match ((let _172_50 = (FStar_Absyn_Util.compress_exp e)
in _172_50.FStar_Absyn_Syntax.n)) with
...
let rec is_value_or_type_app : FStar_Absyn_Syntax.exp  ->  Prims.bool = (fun e -> (match ((let _172_53 = (FStar_Absyn_Util.compress_exp e)
in _172_53.FStar_Absyn_Syntax.n)) with
...
(match ((let _172_55 = (FStar_Absyn_Util.compress_exp head)
in _172_55.FStar_Absyn_Syntax.n)) with
...
let translate_typ : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Extraction_ML_Syntax.mlty = (fun g t -> (let _172_64 = (FStar_Extraction_ML_ExtractTyp.extractTyp g t)
in (eraseTypeDeep g _172_64)))


let translate_typ_of_arg : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.arg  ->  FStar_Extraction_ML_Syntax.mlty = (fun g a -> (let _172_69 = (FStar_Extraction_ML_ExtractTyp.getTypeFromArg g a)
in (eraseTypeDeep g _172_69)))
...
| () -> begin
(let _172_90 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_Env.currentModule e)
in (let _172_89 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_Env.currentModule t)
...
let x = (let _172_111 = (FStar_Absyn_Util.new_bvd None)
in (FStar_Extraction_ML_Syntax.as_mlident _172_111))
in (

let when_clause = (let _172_120 = (let _172_119 = (let _172_118 = (let _172_117 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (let _172_116 = (let _172_115 = (let _172_114 = (let _172_113 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Absyn_Syntax.p i)
in (FStar_All.pipe_left (fun _172_112 -> FStar_Extraction_ML_Syntax.MLE_Const (_172_112)) _172_113))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) _172_114))
in (_172_115)::[])
in (_172_117)::_172_116))
in ((FStar_Extraction_ML_Util.prims_op_equality), (_172_118)))
in FStar_Extraction_ML_Syntax.MLE_App (_172_119))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _172_120))
in ((g), (Some (((FStar_Extraction_ML_Syntax.MLP_Var (x)), ((when_clause)::[]))))))))
end
| FStar_Absyn_Syntax.Pat_constant (s) -> begin
(let _172_124 = (let _172_123 = (let _172_122 = (let _172_121 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Absyn_Syntax.p s)
in FStar_Extraction_ML_Syntax.MLP_Const (_172_121))
in ((_172_122), ([])))
in Some (_172_123))
in ((g), (_172_124)))
end
...
let _77_236 = (let _172_130 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _77_2 -> (match (_77_2) with
| Some (x) -> begin
(x)::[]
end
| _77_233 -> begin
...
in (FStar_All.pipe_right _172_130 FStar_List.split))
in (match (_77_236) with
| (mlPats, when_clauses) -> begin
(let _172_134 = (let _172_133 = (let _172_132 = (FStar_All.pipe_left (FStar_Extraction_ML_Util.resugar_pat q) (FStar_Extraction_ML_Syntax.MLP_CTor (((d), (mlPats)))))
in (let _172_131 = (FStar_All.pipe_right when_clauses FStar_List.flatten)
in ((_172_132), (_172_131))))
in Some (_172_133))
in ((g), (_172_134)))
end))
end))
...
| (hd)::tl -> begin
(let _172_143 = (FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd tl)
in Some (_172_143))
end))
...
let ps = (let _172_146 = (FStar_All.pipe_right pats (FStar_List.map (fun x -> (let _172_145 = (extract_one_pat true g x)
in (Prims.snd _172_145)))))
in (p)::_172_146)
in (
...
| (x, whens) -> begin
(let _172_149 = (mk_when_clause whens)
in ((x), (_172_149)))
end))))
in (
...
| rest -> begin
(let _172_153 = (let _172_152 = (let _172_151 = (let _172_150 = (FStar_List.map Prims.fst rest)
in FStar_Extraction_ML_Syntax.MLP_Branch (_172_150))
in ((_172_151), (None)))
in (_172_152)::ps)
in ((g), (_172_153)))
end)
...
(let _172_162 = (FStar_Util.string_of_int n)
in (Prims.strcat "mktuple" _172_162))
end else begin
...
let tup = (let _172_169 = (let _172_168 = (let _172_167 = (let _172_166 = (let _172_165 = (ffi_mltuple_mlp (FStar_List.length args))
in FStar_Extraction_ML_Syntax.MLE_Name (_172_165))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _172_166))
in ((_172_167), (args)))
in FStar_Extraction_ML_Syntax.MLE_App (_172_168))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _172_169))
in (
...
let x = (let _172_182 = (FStar_Absyn_Util.gensym ())
in ((_172_182), ((~- ((Prims.parse_int "1"))))))
in (let _172_185 = (let _172_184 = (let _172_183 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t0) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in ((((x), (t0))), (_172_183)))
in (_172_184)::more_args)
in (eta_args _172_185 t1)))
end
...
(match (eargs) with
| [] -> begin
(let _172_194 = (as_record qual e)
in (FStar_Extraction_ML_Util.resugar_exp _172_194))
end
| _77_397 -> begin
(
...
let body = (let _172_196 = (let _172_195 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tres) (FStar_Extraction_ML_Syntax.MLE_CTor (((head), ((FStar_List.append args eargs))))))
in (FStar_All.pipe_left (as_record qual) _172_195))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _172_196))
...
| _77_449 -> begin
(let _172_199 = (let _172_198 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) proj)
in ((_172_198), (args)))
in FStar_Extraction_ML_Syntax.MLE_App (_172_199))
end)
...
(let _172_200 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), (mlargs)))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _172_200))
end
...
(let _172_201 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), ([])))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _172_201))
end
| _77_489 -> begin
mlAppExpr
end)))))
...
let _77_499 = (let _172_204 = (FStar_List.tl l)
in (FStar_List.hd _172_204))
...
let _77_529 = (let _172_221 = (check_exp' g e f t)
in (erase g _172_221 f t))
...
let _77_547 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _172_233 = (let _172_232 = (FStar_Absyn_Print.tag_of_exp e)
in (let _172_231 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format2 "now synthesizing expression (%s) :  %s \n" _172_232 _172_231)))
in (FStar_Util.print_string _172_233))))
in (

let top = e
in (match ((let _172_234 = (FStar_Absyn_Util.compress_exp e)
in _172_234.FStar_Absyn_Syntax.n)) with
...
in (let _172_238 = (let _172_237 = (let _172_236 = (FStar_Extraction_ML_Util.mlconst_of_const' e.FStar_Absyn_Syntax.pos c)
in (FStar_All.pipe_left (fun _172_235 -> FStar_Extraction_ML_Syntax.MLE_Const (_172_235)) _172_236))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _172_237))
in ((_172_238), (FStar_Extraction_ML_Syntax.E_PURE), (ml_ty)))))
end
...
(match (mltys) with
| ([], t) -> begin
(let _172_239 = (maybe_lalloc_eta_data g qual t x)
in ((_172_239), (FStar_Extraction_ML_Syntax.E_PURE), (t)))
end
| _77_582 -> begin
...
(let _172_248 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_172_248)))
end else begin
...
let x = (let _172_251 = (FStar_Absyn_Util.gensym ())
in ((_172_251), ((~- ((Prims.parse_int "1"))))))
in (let _172_253 = (let _172_252 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_172_252)::out_args)
in (((((x), (arg)))::lbs), (_172_253))))
end
end)) (([]), ([])) mlargs_f)
end
...
let app = (let _172_254 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App (((mlhead), (mlargs)))))
in (FStar_All.pipe_left (maybe_lalloc_eta_data g is_data t) _172_254))
in (
...
(let _172_258 = (let _172_257 = (FStar_Extraction_ML_Util.join tt.FStar_Absyn_Syntax.pos f f')
in ((_172_257), (t)))
in (synth_app is_data ((mlhead), ((((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE)))::mlargs_f)) _172_258 rest))
end else begin
...
in (let _172_260 = (let _172_259 = (FStar_Extraction_ML_Util.join_l e0_rng ((f)::(f')::(f0)::[]))
in ((_172_259), (t)))
in (synth_app is_data ((mlhead), ((((e0), (f0)))::mlargs_f)) _172_260 rest)))
end)))
end
| _77_649 -> begin
...
(let _172_275 = (FStar_Extraction_ML_Util.join ee.FStar_Absyn_Syntax.pos f f')
in (remove_implicits args _172_275 t))
end
| _77_685 -> begin
((args), (f), (t))
end))
...
(match (args) with
| [] -> begin
(let _172_276 = (maybe_lalloc_eta_data g qual head_t head_ml)
in ((_172_276), (FStar_Extraction_ML_Syntax.E_PURE), (head_t)))
end
| _77_762 -> begin
...
let ml_b = (let _172_279 = (FStar_Extraction_ML_Env.btvar_as_mlTermVar a)
in ((_172_279), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
in (((ml_b)::ml_bs), (env))))
end
...
| (f, tfun) -> begin
(let _172_282 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun (((ml_bs), (ml_body)))))
in ((_172_282), (f), (tfun)))
end))
end)))
end))
...
(let _172_286 = (FStar_Absyn_Syntax.mk_Typ_fun (((b)::rest), (c)) None c.FStar_Absyn_Syntax.pos)
in ((bs), (_172_286)))
end)
...
let polytype = (let _172_290 = (FStar_All.pipe_right targs (FStar_List.map FStar_Extraction_ML_Env.btvar_as_mltyvar))
in ((_172_290), (expected_t)))
in (
...
let f = (let _172_300 = (let _172_299 = (FStar_List.map Prims.fst lbs)
in (f')::_172_299)
in (FStar_Extraction_ML_Util.join_l e'_rng _172_300))
in (
...
in (let _172_306 = (let _172_305 = (let _172_303 = (let _172_302 = (let _172_301 = (FStar_List.map Prims.snd lbs)
in ((is_rec), ([]), (_172_301)))
in ((_172_302), (e')))
in FStar_Extraction_ML_Syntax.MLE_Let (_172_303))
in (let _172_304 = (FStar_Extraction_ML_Util.mlloc_of_range e.FStar_Absyn_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _172_305 _172_304)))
in ((_172_306), (f), (t')))))
end)))))
end)))))
end
...
(let _172_337 = (let _172_335 = (let _172_334 = (let _172_333 = (maybe_lift then_mle t_then)
in (let _172_332 = (let _172_331 = (maybe_lift else_mle t_else)
in Some (_172_331))
in ((e), (_172_333), (_172_332))))
in FStar_Extraction_ML_Syntax.MLE_If (_172_334))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _172_335))
in (let _172_336 = (FStar_Extraction_ML_Util.join top.FStar_Absyn_Syntax.pos f_then f_else)
in ((_172_337), (_172_336), (t_branch))))
end))
end))
end))
end
...
(let _172_344 = (let _172_343 = (let _172_342 = (let _172_341 = (let _172_340 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_172_340)::[])
in ((fw), (_172_341)))
in FStar_Extraction_ML_Syntax.MLE_App (_172_342))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _172_343))
in ((_172_344), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
end))
end
...
in (let _172_348 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match (((e), (mlbranches)))))
in ((_172_348), (f_match), (t_match)))))
end))
end))
end)
end))
...
in (let _172_351 = (FStar_ST.read c)
in ((x), (_172_351))))))
...
(let _172_361 = (FStar_All.pipe_right binders (FStar_List.filter (fun _77_6 -> (match (_77_6) with
...
in (FStar_All.pipe_right _172_361 (FStar_List.map (fun _77_1092 -> (let _172_360 = (fresh "_")
in ((_172_360), (FStar_Extraction_ML_Syntax.MLTY_Top)))))))
end
| _77_1095 -> begin
...
let discrBody = (let _172_376 = (let _172_375 = (let _172_374 = (let _172_373 = (let _172_372 = (let _172_371 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name ((([]), ((FStar_Extraction_ML_Syntax.idsym mlid))))))
in (let _172_370 = (let _172_369 = (let _172_365 = (let _172_363 = (let _172_362 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in ((_172_362), ((FStar_Extraction_ML_Syntax.MLP_Wild)::[])))
in FStar_Extraction_ML_Syntax.MLP_CTor (_172_363))
in (let _172_364 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in ((_172_365), (None), (_172_364))))
in (let _172_368 = (let _172_367 = (let _172_366 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in ((FStar_Extraction_ML_Syntax.MLP_Wild), (None), (_172_366)))
in (_172_367)::[])
in (_172_369)::_172_368))
in ((_172_371), (_172_370))))
in FStar_Extraction_ML_Syntax.MLE_Match (_172_372))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _172_373))
in (((FStar_List.append wildcards ((((mlid), (targ)))::[]))), (_172_374)))
in FStar_Extraction_ML_Syntax.MLE_Fun (_172_375))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _172_376))
