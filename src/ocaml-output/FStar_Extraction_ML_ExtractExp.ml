...
let fail = (fun r msg -> (let _62_10 = (let _131_5 = (FStar_Absyn_Print.format_error r msg)
in (FStar_All.pipe_left FStar_Util.print_string _131_5))
in (FStar_All.exit 1)))

let err_uninst = (fun e -> (let _131_8 = (let _131_7 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format1 "Variable %s has a polymorphic type; expected it to be fully instantiated" _131_7))
in (fail e.FStar_Absyn_Syntax.pos _131_8)))

let err_ill_typed_application = (fun e args t -> (let _131_14 = (let _131_13 = (FStar_Absyn_Print.exp_to_string e)
in (let _131_12 = (FStar_Absyn_Print.args_to_string args)
in (FStar_Util.format2 "Ill-typed application: application is %s \n remaining args are %s\n" _131_13 _131_12)))
in (fail e.FStar_Absyn_Syntax.pos _131_14)))

let err_value_restriction = (fun e -> (fail e.FStar_Absyn_Syntax.pos "Refusing to generalize because of the value restriction"))

let err_unexpected_eff = (fun e f0 f1 -> (let _131_20 = (let _131_19 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s" _131_19 (eff_to_string f0) (eff_to_string f1)))
in (fail e.FStar_Absyn_Syntax.pos _131_20)))

let is_constructor = (fun e -> (match ((let _131_23 = (FStar_Absyn_Util.compress_exp e)
in _131_23.FStar_Absyn_Syntax.n)) with
...
let rec is_value_or_type_app = (fun e -> (match ((let _131_26 = (FStar_Absyn_Util.compress_exp e)
in _131_26.FStar_Absyn_Syntax.n)) with
...
| false -> begin
(match ((let _131_28 = (FStar_Absyn_Util.compress_exp head)
...
let translate_typ = (fun g t -> (let _131_37 = (FStar_Extraction_ML_ExtractTyp.extractTyp g t)
in (FStar_Extraction_ML_Util.eraseTypeDeep g _131_37)))

let translate_typ_of_arg = (fun g a -> (let _131_42 = (FStar_Extraction_ML_ExtractTyp.getTypeFromArg g a)
in (FStar_Extraction_ML_Util.eraseTypeDeep g _131_42)))
...
| () -> begin
(let _131_63 = (FStar_Extraction_ML_Code.string_of_mlexpr g e)
in (let _131_62 = (FStar_Extraction_ML_Code.string_of_mlty g t)
...
| (g, p) -> begin
(let _131_101 = (let _131_100 = (let _131_99 = (let _131_98 = (FStar_List.collect (fun x -> (let _131_97 = (extract_pat true false g x)
in (Prims.snd _131_97))) pats)
in (FStar_List.append p _131_98))
in FStar_Extraction_ML_Syntax.MLP_Branch (_131_99))
in (_131_100)::[])
in (g, _131_101))
end))
end
| FStar_Absyn_Syntax.Pat_constant (s) -> begin
(let _131_104 = (let _131_103 = (let _131_102 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Absyn_Syntax.p s)
in FStar_Extraction_ML_Syntax.MLP_Const (_131_102))
in (_131_103)::[])
in (g, _131_104))
end
...
in (let _131_110 = (let _131_109 = (FStar_All.pipe_left (FStar_Extraction_ML_Util.resugar_pat q) (FStar_Extraction_ML_Syntax.MLP_CTor ((d, (FStar_List.flatten mlPats)))))
in (_131_109)::[])
in (g, _131_110)))
end))
end))
...
| true -> begin
(let _131_119 = (FStar_Util.string_of_int n)
in (Prims.strcat "mktuple" _131_119))
end
| false -> begin
(match ((n = 2)) with
| true -> begin
...
in (let tup = (let _131_124 = (let _131_123 = (let _131_122 = (ffi_mltuple_mlp (FStar_List.length args))
in FStar_Extraction_ML_Syntax.MLE_Name (_131_122))
in (_131_123, args))
in FStar_Extraction_ML_Syntax.MLE_App (_131_124))
...
(let x = (let _131_137 = (FStar_Absyn_Util.gensym ())
in (_131_137, (- (1))))
...
in (match (eargs) with
| [] -> begin
(let _131_146 = (as_record qual e)
in (FStar_Extraction_ML_Util.resugar_exp _131_146))
end
| _62_321 -> begin
...
(let body = (let _131_147 = (FStar_All.pipe_left (as_record qual) (FStar_Extraction_ML_Syntax.MLE_CTor ((head, (FStar_List.append args eargs)))))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _131_147))
...
let rec check_exp = (fun g e f t -> (let _62_402 = (let _131_165 = (check_exp' g e f t)
in (erase g _131_165 f t))
in (match (_62_402) with
| (e, _62_399, _62_401) -> begin
e
end)))
and check_exp' = (fun g e f t -> (match ((let _131_170 = (FStar_Absyn_Util.compress_exp e)
in _131_170.FStar_Absyn_Syntax.n)) with
...
| Some (w) -> begin
(let _131_172 = (check_exp env w FStar_Extraction_ML_Syntax.E_IMPURE FStar_Extraction_ML_Syntax.ml_bool_ty)
in Some (_131_172))
end)
in (let branch = (check_exp env branch f t)
in (let _131_173 = (FStar_List.hd p)
in (_131_173, when_opt, branch))))
end))
end))))
...
and synth_exp' = (fun g e -> (let _62_443 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _131_180 = (let _131_179 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format1 "now synthesizing expression :  %s \n" _131_179))
in (FStar_Util.print_string _131_180))))
in (match ((let _131_181 = (FStar_Absyn_Util.compress_exp e)
in _131_181.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Exp_constant (c) -> begin
(let t = (FStar_Tc_Recheck.typing_const e.FStar_Absyn_Syntax.pos c)
in (let _131_185 = (let _131_183 = (FStar_Extraction_ML_Util.mlconst_of_const' e.FStar_Absyn_Syntax.pos c)
in (FStar_All.pipe_left (fun _131_182 -> FStar_Extraction_ML_Syntax.MLE_Const (_131_182)) _131_183))
in (let _131_184 = (translate_typ g t)
in (_131_185, FStar_Extraction_ML_Syntax.E_PURE, _131_184))))
end
...
(match (mltys) with
| ([], t) -> begin
(let _131_186 = (maybe_lalloc_eta_data g qual t x)
in (_131_186, FStar_Extraction_ML_Syntax.E_PURE, t))
end
| _62_474 -> begin
(err_uninst e)
end)
...
| true -> begin
(let _131_195 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in ([], _131_195))
end
| false -> begin
...
| false -> begin
(let x = (let _131_198 = (FStar_Absyn_Util.gensym ())
in (_131_198, (- (1))))
...
in (let _131_202 = (let _131_201 = (join_l ((f)::(f')::(f0)::[]))
in (_131_201, t))
in (synth_app is_data (mlhead, ((e0, f0))::mlargs_f) _131_202 rest)))
end))
end
| _62_541 -> begin
...
in (match (rest) with
| [] -> begin
(let _131_203 = (maybe_lalloc_eta_data g qual t head)
in (_131_203, FStar_Extraction_ML_Syntax.E_PURE, t))
end
| _62_568 -> begin
...
in (let ml_b = (let _131_208 = (FStar_Extraction_ML_Env.btvar_as_mlTermVar a)
in (let _131_207 = (FStar_All.pipe_left (fun _131_206 -> Some (_131_206)) FStar_Extraction_ML_Syntax.ml_unit_ty)
in (_131_208, _131_207)))
in ((ml_b)::ml_bs, env)))
end
...
(let _131_213 = (let _131_212 = (let _131_211 = (FStar_Util.must targ)
in (_131_211, f, t))
in FStar_Extraction_ML_Syntax.MLTY_Fun (_131_212))
in (FStar_Extraction_ML_Syntax.E_PURE, _131_213))
end)) ml_bs (f, t))
...
(let _131_217 = (FStar_Absyn_Syntax.mk_Typ_fun ((b)::rest, c) None c.FStar_Absyn_Syntax.pos)
in (bs, _131_217))
end)
...
in (let polytype = (let _131_221 = (FStar_All.pipe_right targs (FStar_List.map FStar_Extraction_ML_Env.btvar_as_mltyvar))
in (_131_221, expected_t))
...
| (e', f', t') -> begin
(let f = (let _131_231 = (let _131_230 = (FStar_List.map Prims.fst lbs)
in (f')::_131_230)
in (join_l _131_231))
in (let _131_235 = (let _131_234 = (let _131_233 = (let _131_232 = (FStar_List.map Prims.snd lbs)
in (is_rec, _131_232))
in (_131_233, e'))
in FStar_Extraction_ML_Syntax.MLE_Let (_131_234))
in (_131_235, f, t')))
end))))
end)))))
end
...
in (let _131_238 = (FStar_ST.read c)
in (x, _131_238)))))

let ind_discriminator_body = (fun env discName constrName -> (let mlid = (fresh "_discr_")
in (let _62_767 = (let _131_245 = (FStar_Absyn_Util.fv constrName)
in (FStar_Extraction_ML_Env.lookup_fv env _131_245))
...
in (let discrBody = (let _131_253 = (let _131_252 = (let _131_251 = (let _131_250 = (let _131_249 = (let _131_248 = (let _131_247 = (let _131_246 = (FStar_Extraction_ML_Syntax.mlpath_of_lident rid)
in (_131_246, arg_pat))
in FStar_Extraction_ML_Syntax.MLP_CTor (_131_247))
in (_131_248, None, FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in (_131_249)::((FStar_Extraction_ML_Syntax.MLP_Wild, None, FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))::[])
in (FStar_Extraction_ML_Syntax.MLE_Name (([], (FStar_Extraction_ML_Syntax.idsym mlid))), _131_250))
in FStar_Extraction_ML_Syntax.MLE_Match (_131_251))
in (((mlid, None))::[], _131_252))
in FStar_Extraction_ML_Syntax.MLE_Fun (_131_253))
...
let dummyPatIdent = (fun n -> (let _131_257 = (let _131_256 = (FStar_Util.string_of_int n)
in (Prims.strcat "dummyPat" _131_256))
in (_131_257, 0)))

let dummyPatIdents = (fun n -> (let _131_260 = (FStar_Extraction_ML_ExtractTyp.firstNNats n)
in (FStar_List.map dummyPatIdent _131_260)))
