                                    ...
                                    | FStar_Pervasives_Native.Some
                                        ...
                                        let bs0 =
                                          FStar_Compiler_List.map
                                            ...
                                            bvs0 in
                                        let uu___15 = check_binders g' g bs0 in
                                        op_let_Bang uu___15
                                          (fun us ->
                                             let uu___16 =
           ...
           | (g', xs1, body1) ->
               let uu___2 =
                 with_context "abs binders" FStar_Pervasives_Native.None
                   (fun uu___3 -> check_binders g' g xs1) in
               op_let_Bang uu___2
                 (fun us ->
                    let uu___3 =
           ...
           | (g', xs1, c1) ->
               let uu___1 =
                 with_context "arrow binders" FStar_Pervasives_Native.None
                   (fun uu___2 -> check_binders g' g xs1) in
               op_let_Bang uu___1
                 (fun us ->
                    let uu___2 =
                      let uu___3 =
                               ...
                               | (g', (p1, uu___4, b1)) ->
                                   ...
                                   (match uu___5 with
                                    ...
                                    | FStar_Pervasives_Native.Some (e2, bvs)
                                        ...
                                        let uu___6 = check_binders g' g bs in
                                        op_let_Bang uu___6
                                          (fun us ->
                                             let msg =
                                               let uu___7 =
...
let (initial_env : FStar_TypeChecker_Env.env -> env) =
  fun g ->
    let max_index =
      FStar_Compiler_List.fold_left
        (fun index ->
