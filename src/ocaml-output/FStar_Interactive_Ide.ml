    ...
    fun check_kind ->
          ...
          (check_kind = SyntaxCheck) in
      {
        ...
        FStar_TypeChecker_Env.fv_delta_depths =
          (uu___451_163.FStar_TypeChecker_Env.fv_delta_depths);
        ...
        let rec aux st1 tasks1 previous =
          ...
          | (task::tasks2, []) ->
              (debug1 "Loading" task;
               ...
               (let uu____2415 = FStar_Options.restore_cmd_line_options false in
...
let (uu___is_Exit : query' -> Prims.bool) =
  fun projectee -> match projectee with | Exit -> true | uu____2877 -> false
  ...
  fun key ->
    fun a ->
      let uu____3276 =
        FStar_Util.try_find
          (fun uu____3290 ->
             match uu____3290 with | (k, uu____3296) -> k = key) a in
         ...
         | () ->
             ...
             let uu____3418 =
                       ...
                       FStar_All.pipe_right uu____3476
                         (FStar_Util.map_option
                            (fun loc ->
                               ...
                               (uu____3537, uu____3539, uu____3541))) in
                     let uu____3543 =
               ...
               | uu____3607 ->
                   ...
                   ProtocolViolation uu____3608 in
             { qq = uu____3418; qid }) ()
...
let (alist_of_protocol_info :
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_21 -> FStar_Util.JsonList _0_21) uu____3984 in
        ...
        let uu____4529 =
          let uu____4536 =
            let uu____4541 =
              ...
              json_of_opt (fun _0_23 -> FStar_Util.JsonStr _0_23) uu____4542 in
                ...
                FStar_All.pipe_right uu____4701
                  (FStar_Util.map_option
                     (fun default_value ->
                        ...
                        let uu____4714 = snippets_of_fstar_option name typ in
                        let uu____4717 =
                          let uu____4718 = FStar_Options.settable name in
                          if uu____4718
                          then OptSet
                          else
                            (let uu____4720 = FStar_Options.resettable name in
                             if uu____4720 then OptReset else OptReadOnly) in
                        {
                          opt_name = name;
                          opt_sig = uu____4713;
    ...
    let uu____4824 =
      let uu____4831 =
        let uu____4836 =
          let uu____4837 =
            ...
            FStar_List.map (fun _0_25 -> FStar_Util.JsonStr _0_25) uu____4840 in
      ...
      let uu____4851 =
        let uu____4858 =
          let uu____4863 =
            let uu____4864 =
              let uu____4867 = current_fstar_options (fun uu____4872 -> true) in
  ...
  fun tcenv ->
    fun t ->
      with_printed_effect_args
        (fun uu____4915 -> FStar_TypeChecker_Normalize.term_to_string tcenv t)
    ...
    fun code ->
      ...
      let collect_decls uu____5153 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____5166, decls, uu____5168)) -> decls in
      let uu____5173 =
        with_captured_errors st.repl_env FStar_Util.sigint_ignore
          (fun uu____5182 ->
             let uu____5183 = collect_decls () in
             FStar_All.pipe_left
               (fun _0_26 -> FStar_Pervasives_Native.Some _0_26) uu____5183) in
      match uu____5173 with
      | FStar_Pervasives_Native.None ->
          let errors =
            let uu____5211 = collect_errors () in
            FStar_All.pipe_right uu____5211 (FStar_List.map json_of_issue) in
...
let (load_deps :
  ...
  fun st ->
    let uu____5475 =
      with_captured_errors st.repl_env FStar_Util.sigint_ignore
        (fun _env ->
           let uu____5501 = deps_and_repl_ld_tasks_of_our_file st.repl_fname in
           FStar_All.pipe_left
             (fun _0_28 -> FStar_Pervasives_Native.Some _0_28) uu____5501) in
            ...
            (let uu___467_5684 = st1.repl_env in
             {
               ...
               FStar_TypeChecker_Env.fv_delta_depths =
                 (uu___467_5684.FStar_TypeChecker_Env.fv_delta_depths);
               FStar_TypeChecker_Env.proof_ns =
    ...
    fun deps ->
      fun table ->
        ...
        let loaded_mods_set =
          ...
          let uu____5790 =
            let uu____5793 = FStar_Options.prims () in uu____5793 :: deps in
          FStar_List.fold_left
            (fun acc ->
               fun dep1 ->
                 let uu____5803 = FStar_Parser_Dep.lowercase_module_name dep1 in
    ...
    fun query ->
      ...
      (let uu____5872 = load_deps st in
       ...
       | FStar_Util.Inl (st1, deps) ->
           ((let uu____5936 = FStar_Options.restore_cmd_line_options false in
      ...
      fun pos_opt ->
        fun requested_info ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____6066 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1 in
          ...
          let response =
            ...
            | FStar_Pervasives_Native.Some (name_or_lid, typ, rng) ->
                ...
                FStar_Pervasives_Native.Some uu____6565 in
          match response with
...
let (run_code_lookup :
  ...
  fun st ->
    fun symbol ->
      fun pos_opt ->
        fun requested_info ->
          let uu____6945 = run_symbol_lookup st symbol pos_opt requested_info in
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____7885,
                      { FStar_Syntax_Syntax.lbname = uu____7886;
                        ...
                        FStar_Syntax_Syntax.lbpos = uu____7892;_}::[]),
                     uu____7893);
...
let (json_of_search_result :
  ...
  fun tcenv ->
    fun sc ->
      let typ_str =
        let uu____8794 = sc_typ tcenv sc in term_to_string tcenv uu____8794 in
      let uu____8795 =
        let uu____8802 =
          let uu____8807 =
            let uu____8808 =
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____8887 in
  ...
  fun filename ->
    ...
    (let init1 = build_initial_repl_state filename in
     ...
     then interactive_mode' init1
       ...
       (try
          (fun uu___478_9744 -> match () with | () -> interactive_mode' init1)
            ()
        with
        | uu___477_9747 ->
            (FStar_Errors.set_handler FStar_Errors.default_handler;
             FStar_Exn.raise uu___477_9747)))