...
in {FStar_TypeChecker_Env.solver = uu___252_60.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___252_60.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___252_60.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___252_60.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___252_60.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___252_60.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___252_60.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___252_60.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___252_60.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___252_60.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___252_60.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___252_60.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___252_60.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___252_60.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___252_60.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___252_60.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___252_60.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___252_60.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = (Prims.op_Equality check_kind LaxCheck); FStar_TypeChecker_Env.lax_universes = uu___252_60.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___252_60.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___252_60.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___252_60.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___252_60.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___252_60.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___252_60.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___252_60.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___252_60.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___252_60.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___252_60.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___252_60.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___252_60.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu____61})))


let with_captured_errors' : 'Auu____68 . FStar_TypeChecker_Env.env  ->  (FStar_TypeChecker_Env.env  ->  'Auu____68 FStar_Pervasives_Native.option)  ->  'Auu____68 FStar_Pervasives_Native.option = (fun env f -> (FStar_All.try_with (fun uu___254_91 -> (match (()) with
| () -> begin
(f env)
end)) (fun uu___253_99 -> (match (uu___253_99) with
...
let uu___255_1255 = st
in {repl_line = uu___255_1255.repl_line; repl_column = uu___255_1255.repl_column; repl_fname = uu___255_1255.repl_fname; repl_deps_stack = uu___255_1255.repl_deps_stack; repl_curmod = uu___255_1255.repl_curmod; repl_env = uu___255_1255.repl_env; repl_stdin = uu___255_1255.repl_stdin; repl_names = names1})))
...
let string_of_repl_task : repl_task  ->  Prims.string = (fun uu___237_1674 -> (match (uu___237_1674) with
...
let update_task_timestamps : repl_task  ->  repl_task = (fun uu___238_1896 -> (match (uu___238_1896) with
| LDInterleaved (intf, impl) -> begin
(
...
in (FStar_All.pipe_left (fun _0_42 -> FStar_Pervasives_Native.Some (_0_42)) uu____1995))))
...
let uu___256_2058 = st
in {repl_line = uu___256_2058.repl_line; repl_column = uu___256_2058.repl_column; repl_fname = uu___256_2058.repl_fname; repl_deps_stack = uu___256_2058.repl_deps_stack; repl_curmod = curmod; repl_env = env2; repl_stdin = uu___256_2058.repl_stdin; repl_names = uu___256_2058.repl_names})
in (
...
let rec revert_many = (fun st1 uu___239_2099 -> (match (uu___239_2099) with
| [] -> begin
st1
end
...
let uu___257_2192 = st2
in (

let uu____2193 = (FStar_ST.op_Bang repl_stack)
in {repl_line = uu___257_2192.repl_line; repl_column = uu___257_2192.repl_column; repl_fname = uu___257_2192.repl_fname; repl_deps_stack = uu____2193; repl_curmod = uu___257_2192.repl_curmod; repl_env = uu___257_2192.repl_env; repl_stdin = uu___257_2192.repl_stdin; repl_names = uu___257_2192.repl_names}))
...
let json_to_str : FStar_Util.json  ->  Prims.string = (fun uu___240_2291 -> (match (uu___240_2291) with
...
let js_int : FStar_Util.json  ->  Prims.int = (fun uu___241_2362 -> (match (uu___241_2362) with
| FStar_Util.JsonInt (i) -> begin
i
end
| other -> begin
...
let js_str : FStar_Util.json  ->  Prims.string = (fun uu___242_2368 -> (match (uu___242_2368) with
| FStar_Util.JsonStr (s) -> begin
s
end
| other -> begin
...
let js_list : 'Auu____2377 . (FStar_Util.json  ->  'Auu____2377)  ->  FStar_Util.json  ->  'Auu____2377 Prims.list = (fun k uu___243_2390 -> (match (uu___243_2390) with
...
let js_assoc : FStar_Util.json  ->  (Prims.string * FStar_Util.json) Prims.list = (fun uu___244_2408 -> (match (uu___244_2408) with
...
let query_needs_current_module : query'  ->  Prims.bool = (fun uu___245_2887 -> (match (uu___245_2887) with
| Exit -> begin
false
end
| DescribeProtocol -> begin
...
| Push ({push_kind = uu____2888; push_code = uu____2889; push_line = uu____2890; push_column = uu____2891; push_peek_only = false}) -> begin
false
end
| VfsAdd (uu____2892) -> begin
false
end
| GenericError (uu____2899) -> begin
false
end
| ProtocolViolation (uu____2900) -> begin
false
end
| Push (uu____2901) -> begin
true
end
| AutoComplete (uu____2902) -> begin
true
end
| Lookup (uu____2907) -> begin
true
end
| Compute (uu____2920) -> begin
true
end
| Search (uu____2929) -> begin
true
end))
...
let interactive_protocol_features : Prims.string Prims.list = ("autocomplete")::("autocomplete/context")::("compute")::("compute/reify")::("compute/pure-subterms")::("describe-protocol")::("describe-repl")::("exit")::("vfs-add")::("lookup")::("lookup/context")::("lookup/documentation")::("lookup/definition")::("peek")::("pop")::("push")::("search")::[]
...
let try_assoc : 'Auu____2972 'Auu____2973 . 'Auu____2973  ->  ('Auu____2973 * 'Auu____2972) Prims.list  ->  'Auu____2972 FStar_Pervasives_Native.option = (fun key a -> (

let uu____2996 = (FStar_Util.try_find (fun uu____3010 -> (match (uu____3010) with
| (k, uu____3016) -> begin
(Prims.op_Equality k key)
end)) a)
in (FStar_Util.map_option FStar_Pervasives_Native.snd uu____2996)))
...
let uu____3035 = (json_to_str got)
in (FStar_Util.format2 "JSON decoding failed: expected %s, got %s" expected uu____3035))
in ProtocolViolation (uu____3034))
in {qq = uu____3033; qid = qid}))
...
let uu____3062 = (try_assoc key a)
...
let uu____3067 = (FStar_Util.format2 "Missing key [%s] in %s." key errloc)
in InvalidQuery (uu____3067))
in (FStar_Exn.raise uu____3066))
end)))
in (
...
let uu____3082 = (assoc1 "query" "query-id" request)
in (FStar_All.pipe_right uu____3082 js_str))
in (FStar_All.try_with (fun uu___259_3089 -> (match (()) with
| () -> begin
(

let query = (

let uu____3091 = (assoc1 "query" "query" request)
in (FStar_All.pipe_right uu____3091 js_str))
in (

let args = (

let uu____3099 = (assoc1 "query" "args" request)
in (FStar_All.pipe_right uu____3099 js_assoc))
in (
...
let uu____3116 = (try_assoc k args)
...
let uu____3124 = (match (query) with
| "exit" -> begin
Exit
end
| "pop" -> begin
...
let uu____3127 = (arg "kind")
in (FStar_All.pipe_right uu____3127 js_pushkind))
in (

let uu____3128 = (

let uu____3129 = (arg "code")
in (FStar_All.pipe_right uu____3129 js_str))
in (

let uu____3130 = (

let uu____3131 = (arg "line")
in (FStar_All.pipe_right uu____3131 js_int))
in (

let uu____3132 = (

let uu____3133 = (arg "column")
in (FStar_All.pipe_right uu____3133 js_int))
in {push_kind = uu____3126; push_code = uu____3128; push_line = uu____3130; push_column = uu____3132; push_peek_only = (Prims.op_Equality query "peek")}))))
in Push (uu____3125))
end
| "push" -> begin
(
...
let uu____3136 = (arg "kind")
in (FStar_All.pipe_right uu____3136 js_pushkind))
in (

let uu____3137 = (

let uu____3138 = (arg "code")
in (FStar_All.pipe_right uu____3138 js_str))
in (

let uu____3139 = (

let uu____3140 = (arg "line")
in (FStar_All.pipe_right uu____3140 js_int))
in (

let uu____3141 = (

let uu____3142 = (arg "column")
in (FStar_All.pipe_right uu____3142 js_int))
in {push_kind = uu____3135; push_code = uu____3137; push_line = uu____3139; push_column = uu____3141; push_peek_only = (Prims.op_Equality query "peek")}))))
in Push (uu____3134))
end
| "autocomplete" -> begin
(
...
let uu____3149 = (arg "partial-symbol")
in (FStar_All.pipe_right uu____3149 js_str))
in (

let uu____3150 = (

let uu____3151 = (try_arg "context")
in (FStar_All.pipe_right uu____3151 js_optional_completion_context))
in ((uu____3148), (uu____3150))))
in AutoComplete (uu____3143))
end
| "lookup" -> begin
(
...
in (FStar_All.pipe_right uu____3172 js_optional_lookup_context))
in (
...
let uu____3195 = (try_arg "location")
in (FStar_All.pipe_right uu____3195 (FStar_Util.map_option js_assoc)))
in (FStar_All.pipe_right uu____3186 (FStar_Util.map_option (fun loc -> (

let uu____3253 = (

let uu____3254 = (assoc1 "[location]" "filename" loc)
in (FStar_All.pipe_right uu____3254 js_str))
in (

let uu____3255 = (

let uu____3256 = (assoc1 "[location]" "line" loc)
in (FStar_All.pipe_right uu____3256 js_int))
in (

let uu____3257 = (

let uu____3258 = (assoc1 "[location]" "column" loc)
in (FStar_All.pipe_right uu____3258 js_int))
in ((uu____3253), (uu____3255), (uu____3257)))))))))
in (

let uu____3259 = (

let uu____3262 = (arg "requested-info")
in (FStar_All.pipe_right uu____3262 (js_list js_str)))
in ((uu____3169), (uu____3171), (uu____3177), (uu____3259))))))
in Lookup (uu____3156))
end
| "compute" -> begin
(
...
let uu____3285 = (arg "term")
in (FStar_All.pipe_right uu____3285 js_str))
in (

let uu____3286 = (

let uu____3291 = (try_arg "rules")
in (FStar_All.pipe_right uu____3291 (FStar_Util.map_option (js_list js_reductionrule))))
in ((uu____3284), (uu____3286))))
in Compute (uu____3275))
end
| "search" -> begin
(
...
let uu____3307 = (arg "terms")
in (FStar_All.pipe_right uu____3307 js_str))
in Search (uu____3306))
end
| "vfs-add" -> begin
(
...
let uu____3318 = (try_arg "filename")
in (FStar_All.pipe_right uu____3318 (FStar_Util.map_option js_str)))
in (

let uu____3325 = (

let uu____3326 = (arg "contents")
in (FStar_All.pipe_right uu____3326 js_str))
in ((uu____3315), (uu____3325))))
in VfsAdd (uu____3308))
end
| uu____3329 -> begin
(

let uu____3330 = (FStar_Util.format1 "Unknown query \'%s\'" query)
in ProtocolViolation (uu____3330))
end)
in {qq = uu____3124; qid = qid})))))
end)) (fun uu___258_3333 -> (match (uu___258_3333) with
...
let read_interactive_query : FStar_Util.stream_reader  ->  query = (fun stream -> (FStar_All.try_with (fun uu___261_3343 -> (match (()) with
| () -> begin
(

let uu____3344 = (FStar_Util.read_line stream)
...
let uu____3348 = (FStar_Util.json_of_string line)
...
end)) (fun uu___260_3354 -> (match (uu___260_3354) with
| InvalidQuery (msg) -> begin
...
let json_of_opt : 'Auu____3364 . ('Auu____3364  ->  FStar_Util.json)  ->  'Auu____3364 FStar_Pervasives_Native.option  ->  FStar_Util.json = (fun json_of_a opt_a -> (

let uu____3382 = (FStar_Util.map_option json_of_a opt_a)
in (FStar_Util.dflt FStar_Util.JsonNull uu____3382)))
...
let uu____3393 = (FStar_Range.line_of_pos pos)
in FStar_Util.JsonInt (uu____3393))
in (
...
let uu____3398 = (FStar_Range.col_of_pos pos)
in FStar_Util.JsonInt (uu____3398))
in (uu____3397)::[])
in (uu____3392)::uu____3394))
...
let uu____3443 = (json_of_pos e)
in (("end"), (uu____3443)))
in (uu____3438)::[])
in (uu____3425)::uu____3431))
in ((("fname"), (FStar_Util.JsonStr (file))))::uu____3418)
in FStar_Util.JsonAssoc (uu____3411)))


let json_of_use_range : FStar_Range.range  ->  FStar_Util.json = (fun r -> (

let uu____3464 = (FStar_Range.file_of_use_range r)
in (

let uu____3465 = (FStar_Range.start_of_use_range r)
in (

let uu____3466 = (FStar_Range.end_of_use_range r)
in (json_of_range_fields uu____3464 uu____3465 uu____3466)))))


let json_of_def_range : FStar_Range.range  ->  FStar_Util.json = (fun r -> (

let uu____3471 = (FStar_Range.file_of_range r)
in (

let uu____3472 = (FStar_Range.start_of_range r)
in (

let uu____3473 = (FStar_Range.end_of_range r)
in (json_of_range_fields uu____3471 uu____3472 uu____3473)))))
...
let uu____3512 = (match (issue.FStar_Errors.issue_range) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
let uu____3518 = (json_of_use_range r)
in (uu____3518)::[])
end)
in (

let uu____3519 = (match (issue.FStar_Errors.issue_range) with
| FStar_Pervasives_Native.Some (r) when (Prims.op_disEquality r.FStar_Range.def_range r.FStar_Range.use_range) -> begin
(

let uu____3525 = (json_of_def_range r)
in (uu____3525)::[])
end
| uu____3526 -> begin
[]
end)
in (FStar_List.append uu____3512 uu____3519)))
in FStar_Util.JsonList (uu____3509))
in (("ranges"), (uu____3508)))
in (uu____3503)::[])
in ((("message"), (FStar_Util.JsonStr (issue.FStar_Errors.issue_message))))::uu____3496)
in ((("level"), ((json_of_issue_level issue.FStar_Errors.issue_level))))::uu____3489)
in FStar_Util.JsonAssoc (uu____3482)))
...
let uu____3696 = (json_of_opt json_of_def_range lr.slr_def_range)
in (("defined-at"), (uu____3696)))
in (
...
let uu____3709 = (json_of_opt (fun _0_43 -> FStar_Util.JsonStr (_0_43)) lr.slr_typ)
in (("type"), (uu____3709)))
in (
...
let uu____3722 = (json_of_opt (fun _0_44 -> FStar_Util.JsonStr (_0_44)) lr.slr_doc)
in (("documentation"), (uu____3722)))
in (
...
let uu____3735 = (json_of_opt (fun _0_45 -> FStar_Util.JsonStr (_0_45)) lr.slr_def)
in (("definition"), (uu____3735)))
in (uu____3730)::[])
in (uu____3717)::uu____3723))
in (uu____3704)::uu____3710))
in (uu____3691)::uu____3697))
in ((("name"), (FStar_Util.JsonStr (lr.slr_name))))::uu____3684))
...
let uu____3768 = (FStar_List.map (fun _0_46 -> FStar_Util.JsonStr (_0_46)) interactive_protocol_features)
in (FStar_All.pipe_left (fun _0_47 -> FStar_Util.JsonList (_0_47)) uu____3768))
...
let string_of_option_permission_level : fstar_option_permission_level  ->  Prims.string = (fun uu___246_3803 -> (match (uu___246_3803) with
| OptSet -> begin
""
end
| OptReset -> begin
...
let rec kind_of_fstar_option_type : FStar_Options.opt_type  ->  Prims.string = (fun uu___247_3979 -> (match (uu___247_3979) with
| FStar_Options.Const (uu____3980) -> begin
"flag"
end
| FStar_Options.IntStr (uu____3981) -> begin
"int"
end
| FStar_Options.BoolStr -> begin
"bool"
end
| FStar_Options.PathStr (uu____3982) -> begin
"path"
end
| FStar_Options.SimpleStr (uu____3983) -> begin
"string"
end
| FStar_Options.EnumStr (uu____3984) -> begin
"enum"
end
| FStar_Options.OpenEnumStr (uu____3987) -> begin
"open enum"
end
| FStar_Options.PostProcessed (uu____3994, typ) -> begin
...
| FStar_Options.WithSideEffect (uu____4002, typ) -> begin
(kind_of_fstar_option_type typ)
end))
...
| FStar_Options.Const (uu____4038) -> begin
("")::[]
end
| FStar_Options.BoolStr -> begin
("true")::("false")::[]
...
| FStar_Options.PostProcessed (uu____4051, elem_spec) -> begin
...
| FStar_Options.WithSideEffect (uu____4059, elem_spec) -> begin
(arg_snippets_of_type elem_spec)
end))
in (

let uu____4065 = (arg_snippets_of_type typ)
in (FStar_List.map (mk_snippet name) uu____4065))))))


let rec json_of_fstar_option_value : FStar_Options.option_val  ->  FStar_Util.json = (fun uu___248_4071 -> (match (uu___248_4071) with
...
let uu____4079 = (FStar_List.map json_of_fstar_option_value vs)
in FStar_Util.JsonList (uu____4079))
end
...
let uu____4111 = (json_of_fstar_option_value opt.opt_value)
in (("value"), (uu____4111)))
in (
...
let uu____4124 = (json_of_fstar_option_value opt.opt_default)
in (("default"), (uu____4124)))
in (
...
let uu____4137 = (json_of_opt (fun _0_48 -> FStar_Util.JsonStr (_0_48)) opt.opt_documentation)
in (("documentation"), (uu____4137)))
in (
...
let uu____4151 = (kind_of_fstar_option_type opt.opt_type)
in FStar_Util.JsonStr (uu____4151))
in (("type"), (uu____4150)))
in (uu____4145)::((("permission-level"), (FStar_Util.JsonStr ((string_of_option_permission_level opt.opt_permission_level)))))::[])
in (uu____4132)::uu____4138))
in (uu____4119)::uu____4125))
in (uu____4106)::uu____4112))
in ((("signature"), (FStar_Util.JsonStr (opt.opt_sig))))::uu____4099)
in ((("name"), (FStar_Util.JsonStr (opt.opt_name))))::uu____4092))


let json_of_fstar_option : fstar_option  ->  FStar_Util.json = (fun opt -> (

let uu____4188 = (alist_of_fstar_option opt)
in FStar_Util.JsonAssoc (uu____4188)))


let write_json : FStar_Util.json  ->  Prims.unit = (fun json -> ((

let uu____4200 = (FStar_Util.string_of_json json)
in (FStar_Util.print_raw uu____4200));
...
let write_hello : Prims.unit  ->  Prims.unit = (fun uu____4262 -> (
...
let uu____4265 = (FStar_List.map (fun _0_49 -> FStar_Util.JsonStr (_0_49)) interactive_protocol_features)
in FStar_Util.JsonList (uu____4265))
...
let uu____4281 = (FStar_Options.desc_of_opt_type typ)
...
let uu____4290 = (FStar_All.pipe_right FStar_Options.all_specs_with_types (FStar_List.filter_map (fun uu____4319 -> (match (uu____4319) with
| (_shortname, name, typ, doc1) -> begin
(

let uu____4334 = (FStar_Util.smap_try_find defaults1 name)
in (FStar_All.pipe_right uu____4334 (FStar_Util.map_option (fun default_value -> (

let uu____4346 = (sig_of_fstar_option name typ)
in (

let uu____4347 = (snippets_of_fstar_option name typ)
in (

let uu____4350 = (

let uu____4351 = (FStar_Options.settable name)
...
let uu____4353 = (FStar_Options.resettable name)
...
in {opt_name = name; opt_sig = uu____4346; opt_value = FStar_Options.Unset; opt_default = default_value; opt_type = typ; opt_snippets = uu____4347; opt_documentation = (match ((Prims.op_Equality doc1 "")) with
| true -> begin
FStar_Pervasives_Native.None
end
| uu____4357 -> begin
FStar_Pervasives_Native.Some (doc1)
end); opt_permission_level = uu____4350})))))))
end))))
in (FStar_All.pipe_right uu____4290 (FStar_List.sortWith (fun o1 o2 -> (FStar_String.compare (FStar_String.lowercase o1.opt_name) (FStar_String.lowercase o2.opt_name)))))))
...
let uu___262_4378 = opt
in (

let uu____4379 = (FStar_Options.get_option opt.opt_name)
in {opt_name = uu___262_4378.opt_name; opt_sig = uu___262_4378.opt_sig; opt_value = uu____4379; opt_default = uu___262_4378.opt_default; opt_type = uu___262_4378.opt_type; opt_snippets = uu___262_4378.opt_snippets; opt_documentation = uu___262_4378.opt_documentation; opt_permission_level = uu___262_4378.opt_permission_level})))


let current_fstar_options : (fstar_option  ->  Prims.bool)  ->  fstar_option Prims.list = (fun filter1 -> (

let uu____4391 = (FStar_List.filter filter1 fstar_options_list_cache)
in (FStar_List.map update_option uu____4391)))
...
let uu____4407 = (FStar_Util.substring_from opt_name (FStar_String.length opt_prefix))
in ((opt_prefix), (uu____4407)))
end
| uu____4408 -> begin
((""), (opt_name))
end)))
...
let filenames = (fun uu____4422 -> (match (uu____4422) with
| (task, uu____4430) -> begin
(match (task) with
| LDInterleaved (intf, impl) -> begin
...
let uu____4454 = (FStar_List.concatMap filenames st.repl_deps_stack)
in (FStar_List.map (fun _0_50 -> FStar_Util.JsonStr (_0_50)) uu____4454))
in FStar_Util.JsonList (uu____4451))
in (("loaded-dependencies"), (uu____4450)))
in (
...
let uu____4477 = (current_fstar_options (fun uu____4482 -> true))
in (FStar_List.map json_of_fstar_option uu____4477))
in FStar_Util.JsonList (uu____4474))
in (("options"), (uu____4473)))
in (uu____4468)::[])
in (uu____4445)::uu____4461))
in FStar_Util.JsonAssoc (uu____4438))))


let with_printed_effect_args : 'Auu____4499 . (Prims.unit  ->  'Auu____4499)  ->  'Auu____4499 = (fun k -> (FStar_Options.with_saved_options (fun uu____4511 -> ((FStar_Options.set_option "print_effect_args" (FStar_Options.Bool (true)));
(k ());
))))


let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun tcenv t -> (with_printed_effect_args (fun uu____4522 -> (FStar_TypeChecker_Normalize.term_to_string tcenv t))))
...
let run_exit : 'Auu____4535 'Auu____4536 . 'Auu____4536  ->  ((query_status * FStar_Util.json) * ('Auu____4535, Prims.int) FStar_Util.either) = (fun st -> ((((QueryOK), (FStar_Util.JsonNull))), (FStar_Util.Inr ((Prims.parse_int "0")))))


let run_describe_protocol : 'Auu____4567 'Auu____4568 . 'Auu____4568  ->  ((query_status * FStar_Util.json) * ('Auu____4568, 'Auu____4567) FStar_Util.either) = (fun st -> ((((QueryOK), (FStar_Util.JsonAssoc (alist_of_protocol_info)))), (FStar_Util.Inl (st))))


let run_describe_repl : 'Auu____4597 . repl_state  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____4597) FStar_Util.either) = (fun st -> (

let uu____4614 = (

let uu____4619 = (json_of_repl_state st)
in ((QueryOK), (uu____4619)))
in ((uu____4614), (FStar_Util.Inl (st)))))


let run_protocol_violation : 'Auu____4636 'Auu____4637 . 'Auu____4637  ->  Prims.string  ->  ((query_status * FStar_Util.json) * ('Auu____4637, 'Auu____4636) FStar_Util.either) = (fun st message -> ((((QueryViolatesProtocol), (FStar_Util.JsonStr (message)))), (FStar_Util.Inl (st))))


let run_generic_error : 'Auu____4674 'Auu____4675 . 'Auu____4675  ->  Prims.string  ->  ((query_status * FStar_Util.json) * ('Auu____4675, 'Auu____4674) FStar_Util.either) = (fun st message -> ((((QueryNOK), (FStar_Util.JsonStr (message)))), (FStar_Util.Inl (st))))


let run_vfs_add : 'Auu____4712 . repl_state  ->  Prims.string FStar_Pervasives_Native.option  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____4712) FStar_Util.either) = (fun st opt_fname contents -> (
...
let run_pop : 'Auu____4755 . repl_state  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____4755) FStar_Util.either) = (fun st -> (

let uu____4772 = (nothing_left_to_pop st)
...
let collect_errors : Prims.unit  ->  FStar_Errors.issue Prims.list = (fun uu____4808 -> (
...
let uu____4827 = (with_captured_errors st.repl_env (fun _env -> (

let uu____4849 = (deps_and_repl_ld_tasks_of_our_file st.repl_fname)
in (FStar_All.pipe_left (fun _0_51 -> FStar_Pervasives_Native.Some (_0_51)) uu____4849))))
...
let uu____4926 = (run_repl_ld_transactions st tasks)
...
let uu___263_4961 = issue
in (

let uu____4962 = (FStar_Util.format1 "Error while computing or loading dependencies:\n%s" issue.FStar_Errors.issue_message)
in {FStar_Errors.issue_message = uu____4962; FStar_Errors.issue_level = uu___263_4961.FStar_Errors.issue_level; FStar_Errors.issue_range = uu___263_4961.FStar_Errors.issue_range})))


let run_push_without_deps : 'Auu____4969 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____4969) FStar_Util.either) = (fun st query -> (

let uu____4990 = query
...
let uu____5010 = (run_repl_transaction st push_kind peek_only (PushFragment (frag)))
...
let uu____5035 = (collect_errors ())
in (FStar_All.pipe_right uu____5035 (FStar_List.map json_of_issue)))
in FStar_Util.JsonList (uu____5032))
in (
...
let uu___264_5043 = st1
in {repl_line = line; repl_column = column; repl_fname = uu___264_5043.repl_fname; repl_deps_stack = uu___264_5043.repl_deps_stack; repl_curmod = uu___264_5043.repl_curmod; repl_env = uu___264_5043.repl_env; repl_stdin = uu___264_5043.repl_stdin; repl_names = uu___264_5043.repl_names})
end
| uu____5044 -> begin
st1
end)
in ((((status), (json_errors))), (FStar_Util.Inl (st2))))))
end)));
)
end)))
...
let uu____5059 = (FStar_String.substring str (Prims.parse_int "1") ((FStar_String.length str) - (Prims.parse_int "1")))
in (Prims.strcat (FStar_String.uppercase first) uu____5059)))
end))
...
let uu____5086 = (FStar_Util.psmap_empty ())
in (

let uu____5089 = (

let uu____5092 = (FStar_Options.prims ())
in (uu____5092)::deps)
in (FStar_List.fold_left (fun acc dep1 -> (

let uu____5102 = (FStar_Parser_Dep.lowercase_module_name dep1)
in (FStar_Util.psmap_add acc uu____5102 true))) uu____5086 uu____5089)))
in (
...
in (FStar_List.fold_left (fun table1 uu____5118 -> (match (uu____5118) with
...
let uu____5130 = (capitalize modname)
in (FStar_Util.split uu____5130 "."))
in (

let uu____5131 = (loaded mod_key)
in (FStar_Interactive_CompletionTable.register_module_path table1 uu____5131 mod_path ns_query)))
end))
end)) table (FStar_List.rev mods)))))))


let run_push_with_deps : 'Auu____5142 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____5142) FStar_Util.either) = (fun st query -> ((

let uu____5164 = (FStar_Options.debug_any ())
...
let uu____5200 = (collect_errors ())
in (FStar_List.map rephrase_dependency_error uu____5200))
in (
...
let uu____5231 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____5231 FStar_Pervasives.ignore));
(

let names1 = (add_module_completions st1.repl_fname deps st1.repl_names)
in (run_push_without_deps (

let uu___265_5234 = st1
in {repl_line = uu___265_5234.repl_line; repl_column = uu___265_5234.repl_column; repl_fname = uu___265_5234.repl_fname; repl_deps_stack = uu___265_5234.repl_deps_stack; repl_curmod = uu___265_5234.repl_curmod; repl_env = uu___265_5234.repl_env; repl_stdin = uu___265_5234.repl_stdin; repl_names = names1}) query));
)
end));
))


let run_push : 'Auu____5241 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____5241) FStar_Util.either) = (fun st query -> (

let uu____5262 = (nothing_left_to_pop st)
...
let uu____5344 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split lid_str "."))
in (FStar_Ident.lid_of_ids uu____5344))
in (

let lid1 = (

let uu____5348 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name tcenv.FStar_TypeChecker_Env.dsenv lid)
in (FStar_All.pipe_left (FStar_Util.dflt lid) uu____5348))
in (

let uu____5353 = (FStar_TypeChecker_Env.try_lookup_lid tcenv lid1)
in (FStar_All.pipe_right uu____5353 (FStar_Util.map_option (fun uu____5408 -> (match (uu____5408) with
| ((uu____5427, typ), r) -> begin
...
let uu____5444 = (FStar_ToSyntax_Env.try_lookup_doc tcenv.FStar_TypeChecker_Env.dsenv lid)
in (FStar_All.pipe_right uu____5444 (FStar_Util.map_option FStar_Pervasives_Native.fst))))
in (

let def_of_lid = (fun lid -> (

let uu____5473 = (FStar_TypeChecker_Env.lookup_qname tcenv lid)
in (FStar_Util.bind_opt uu____5473 (fun uu___249_5517 -> (match (uu___249_5517) with
| (FStar_Util.Inr (se, uu____5539), uu____5540) -> begin
(

let uu____5569 = (sigelt_to_string se)
...
let info_at_pos_opt = (FStar_Util.bind_opt pos_opt (fun uu____5622 -> (match (uu____5622) with
| (file, row, col) -> begin
...
| FStar_Pervasives_Native.Some (uu____5669) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
...
let uu____5797 = (term_to_string tcenv typ)
in FStar_Pervasives_Native.Some (uu____5797))
end
| uu____5798 -> begin
FStar_Pervasives_Native.None
end)
...
let uu____5839 = (alist_of_symbol_lookup_result result)
in (("symbol"), (uu____5839)))
in FStar_Pervasives_Native.Some (uu____5828))))))))
end)
...
let uu____5945 = (trim_option_name opt_name)
in (match (uu____5945) with
| (uu____5964, trimmed_name) -> begin
(

let uu____5966 = (FStar_Util.smap_try_find fstar_options_map_cache trimmed_name)
...
let uu____6012 = (update_option opt)
in (alist_of_fstar_option uu____6012))
in (("option"), (uu____6005)))
in FStar_Util.Inr (uu____5994))
end))
end)))
...
let uu____6054 = (FStar_Interactive_CompletionTable.find_module_or_ns st.repl_names query)
...
let uu____6093 = (FStar_Interactive_CompletionTable.alist_of_mod_info mod_info)
in (("module"), (uu____6093)))
in FStar_Util.Inr (uu____6082))
end
...
let uu____6128 = (FStar_Interactive_CompletionTable.alist_of_ns_info ns_info)
in (("namespace"), (uu____6128)))
in FStar_Util.Inr (uu____6117))
end))))
...
let uu____6201 = (run_symbol_lookup st symbol pos_opt requested_info)
in (match (uu____6201) with
| FStar_Util.Inr (alist) -> begin
FStar_Util.Inr (alist)
end
| FStar_Util.Inl (uu____6261) -> begin
(

let uu____6272 = (run_module_lookup st symbol)
...
let run_lookup : 'Auu____6433 . repl_state  ->  Prims.string  ->  lookup_context  ->  (Prims.string * Prims.int * Prims.int) FStar_Pervasives_Native.option  ->  Prims.string Prims.list  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6433) FStar_Util.either) = (fun st symbol context pos_opt requested_info -> (

let uu____6486 = (run_lookup' st symbol context pos_opt requested_info)
in (match (uu____6486) with
| FStar_Util.Inl (err_msg) -> begin
...
let code_autocomplete_mod_filter : 'Auu____6572 . ('Auu____6572 * FStar_Interactive_CompletionTable.mod_symbol)  ->  ('Auu____6572 * FStar_Interactive_CompletionTable.mod_symbol) FStar_Pervasives_Native.option = (fun uu___250_6586 -> (match (uu___250_6586) with
| (uu____6591, FStar_Interactive_CompletionTable.Namespace (uu____6592)) -> begin
FStar_Pervasives_Native.None
end
| (uu____6597, FStar_Interactive_CompletionTable.Module ({FStar_Interactive_CompletionTable.mod_name = uu____6598; FStar_Interactive_CompletionTable.mod_path = uu____6599; FStar_Interactive_CompletionTable.mod_loaded = true})) -> begin
FStar_Pervasives_Native.None
end
...
let uu___266_6613 = md
in (

let uu____6614 = (

let uu____6615 = (FStar_Interactive_CompletionTable.mod_name md)
in (Prims.strcat uu____6615 "."))
in {FStar_Interactive_CompletionTable.mod_name = uu____6614; FStar_Interactive_CompletionTable.mod_path = uu___266_6613.FStar_Interactive_CompletionTable.mod_path; FStar_Interactive_CompletionTable.mod_loaded = uu___266_6613.FStar_Interactive_CompletionTable.mod_loaded}))
in FStar_Interactive_CompletionTable.Module (uu____6612))
in ((pth), (uu____6611)))
in FStar_Pervasives_Native.Some (uu____6606))
end))


let run_code_autocomplete : 'Auu____6626 . repl_state  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6626) FStar_Util.either) = (fun st search_term -> (
...
let run_module_autocomplete : 'Auu____6681 'Auu____6682 'Auu____6683 . repl_state  ->  Prims.string  ->  'Auu____6683  ->  'Auu____6682  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6681) FStar_Util.either) = (fun st search_term modules1 namespaces -> (
...
let uu____6747 = (match (opt.opt_permission_level) with
| OptSet -> begin
((true), (""))
end
| OptReset -> begin
...
let run_option_autocomplete : 'Auu____6779 'Auu____6780 . 'Auu____6780  ->  Prims.string  ->  Prims.bool  ->  ((query_status * FStar_Util.json) * ('Auu____6780, 'Auu____6779) FStar_Util.either) = (fun st search_term is_reset -> (

let uu____6805 = (trim_option_name search_term)
...
| (uu____6856, uu____6857) -> begin
((((QueryNOK), (FStar_Util.JsonStr ("Options should start with \'--\'")))), (FStar_Util.Inl (st)))
end)))


let run_autocomplete : 'Auu____6874 . repl_state  ->  Prims.string  ->  completion_context  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6874) FStar_Util.either) = (fun st search_term context -> (match (context) with
| CKCode -> begin
...
let run_compute : 'Auu____6910 . repl_state  ->  Prims.string  ->  FStar_TypeChecker_Normalize.step Prims.list FStar_Pervasives_Native.option  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6910) FStar_Util.either) = (fun st term rules -> (
...
| ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let ((uu____7033, ({FStar_Syntax_Syntax.lbname = uu____7034; FStar_Syntax_Syntax.lbunivs = univs1; FStar_Syntax_Syntax.lbtyp = uu____7036; FStar_Syntax_Syntax.lbeff = uu____7037; FStar_Syntax_Syntax.lbdef = def})::[]), uu____7039); FStar_Syntax_Syntax.sigrng = uu____7040; FStar_Syntax_Syntax.sigquals = uu____7041; FStar_Syntax_Syntax.sigmeta = uu____7042; FStar_Syntax_Syntax.sigattrs = uu____7043})::[] -> begin
...
let uu____7101 = (FStar_Parser_ParseIt.parse (FStar_Util.Inr (frag)))
in (match (uu____7101) with
| FStar_Util.Inl (FStar_Util.Inr (decls), uu____7125) -> begin
...
let uu____7207 = (FStar_ToSyntax_ToSyntax.decls_to_sigelts decls)
in (uu____7207 env.FStar_TypeChecker_Env.dsenv))
in (FStar_Pervasives_Native.fst uu____7202)))
in (

let typecheck = (fun tcenv decls -> (

let uu____7225 = (FStar_TypeChecker_Tc.tc_decls tcenv decls)
in (match (uu____7225) with
| (ses, uu____7239, uu____7240) -> begin
ses
end)))
in (
...
let uu____7331 = (FStar_Syntax_Subst.open_univ_vars univs1 def)
...
let uu____7345 = (term_to_string tcenv1 normalized)
in FStar_Util.JsonStr (uu____7345))
in ((QueryOK), (uu____7344)))))
end))
end))))
in (

let uu____7346 = (FStar_Options.trace_error ())
in (match (uu____7346) with
| true -> begin
(aux ())
end
| uu____7351 -> begin
(FStar_All.try_with (fun uu___268_7357 -> (match (()) with
| () -> begin
(aux ())
end)) (fun uu___267_7365 -> (match (uu___267_7365) with
| e -> begin
(

let uu____7371 = (

let uu____7372 = (FStar_Errors.issue_of_exn e)
in (match (uu____7372) with
| FStar_Pervasives_Native.Some (issue) -> begin
(

let uu____7376 = (FStar_Errors.format_issue issue)
in FStar_Util.JsonStr (uu____7376))
end
| FStar_Pervasives_Native.None -> begin
(FStar_Exn.raise e)
end))
in ((QueryNOK), (uu____7371)))
end)))
end)))
end))
end))))))))))))))
...
let st_cost : search_term'  ->  Prims.int = (fun uu___251_7436 -> (match (uu___251_7436) with
...
let uu____7604 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____7611 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {sc_lid = lid; sc_typ = uu____7604; sc_fvars = uu____7611})))


let sc_typ : FStar_TypeChecker_Env.env  ->  search_candidate  ->  FStar_Syntax_Syntax.typ = (fun tcenv sc -> (

let uu____7660 = (FStar_ST.op_Bang sc.sc_typ)
in (match (uu____7660) with
...
let uu____7717 = (FStar_TypeChecker_Env.try_lookup_lid tcenv sc.sc_lid)
...
| FStar_Pervasives_Native.Some ((uu____7738, typ), uu____7740) -> begin
typ
end))
...
let uu____7816 = (FStar_ST.op_Bang sc.sc_fvars)
...
let uu____7887 = (sc_typ tcenv sc)
in (FStar_Syntax_Free.fvars uu____7887))
...
let uu____7954 = (sc_typ tcenv sc)
in (term_to_string tcenv uu____7954))
in (
...
let uu____7969 = (FStar_ToSyntax_Env.shorten_lid tcenv.FStar_TypeChecker_Env.dsenv sc.sc_lid)
in uu____7969.FStar_Ident.str)
in FStar_Util.JsonStr (uu____7968))
in (("lid"), (uu____7967)))
in (uu____7962)::((("type"), (FStar_Util.JsonStr (typ_str))))::[])
in FStar_Util.JsonAssoc (uu____7955))))

exception InvalidSearch of (Prims.string)


let uu___is_InvalidSearch : Prims.exn  ->  Prims.bool = (fun projectee -> (match (projectee) with
| InvalidSearch (uu____7989) -> begin
true
end
| uu____7990 -> begin
false
...
| InvalidSearch (uu____7998) -> begin
uu____7998
end))


let run_search : 'Auu____8005 . repl_state  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____8005) FStar_Util.either) = (fun st search_str -> (
...
let uu____8040 = (sc_fvars tcenv candidate)
in (FStar_Util.set_mem lid uu____8040))
end)
...
let uu____8065 = (FStar_Util.format1 "Improperly quoted search term: %s" term1)
in InvalidSearch (uu____8065))
in (FStar_Exn.raise uu____8064))
end
| uu____8066 -> begin
...
let uu____8067 = (strip_quotes term1)
in NameContainsStr (uu____8067))
end
| uu____8068 -> begin
(
...
let uu____8070 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name tcenv.FStar_TypeChecker_Env.dsenv lid)
...
let uu____8074 = (FStar_Util.format1 "Unknown identifier: %s" term1)
in InvalidSearch (uu____8074))
in (FStar_Exn.raise uu____8073))
end
...
let uu____8090 = (match (term.st_term) with
...
let results = (FStar_All.try_with (fun uu___270_8114 -> (match (()) with
| () -> begin
(
...
let uu____8153 = (FStar_List.map pprint_one terms)
in (FStar_Util.concat_l " " uu____8153))
in (

let uu____8156 = (

let uu____8157 = (FStar_Util.format1 "No results found for query [%s]" kwds)
in InvalidSearch (uu____8157))
in (FStar_Exn.raise uu____8156)))
end
| uu____8162 -> begin
((QueryOK), (FStar_Util.JsonList (js)))
end)))))))))
end)) (fun uu___269_8167 -> (match (uu___269_8167) with
...
| Push ({push_kind = SyntaxCheck; push_code = uu____8255; push_line = uu____8256; push_column = uu____8257; push_peek_only = false}) -> begin
...
let uu____8269 = (read_interactive_query st1.repl_stdin)
in (validate_query st1 uu____8269))
in (

let uu____8270 = (run_query st1 query.qq)
...
let uu____8301 = (FStar_Options.trace_error ())
in (match (uu____8301) with
| true -> begin
(loop st)
end
| uu____8302 -> begin
(FStar_All.try_with (fun uu___272_8304 -> (match (()) with
| () -> begin
(loop st)
end)) (fun uu___271_8307 -> (match (uu___271_8307) with
| ExitREPL (n1) -> begin
n1
end)))
end))))
...
let uu____8323 = (FStar_ST.op_Bang issues)
in (e)::uu____8323)
in (FStar_ST.op_Colon_Equals issues uu____8320)))
in (

let count_errors = (fun uu____8457 -> (

let uu____8458 = (

let uu____8461 = (FStar_ST.op_Bang issues)
in (FStar_List.filter (fun e -> (Prims.op_Equality e.FStar_Errors.issue_level FStar_Errors.EError)) uu____8461))
in (FStar_List.length uu____8458)))
in (

let report1 = (fun uu____8535 -> (

let uu____8536 = (FStar_ST.op_Bang issues)
in (FStar_List.sortWith FStar_Errors.compare_issues uu____8536)))
in (

let clear1 = (fun uu____8606 -> (FStar_ST.op_Colon_Equals issues []))
...
let uu____8693 = (get_json ())
in (write_message label1 uu____8693)))}


let initial_range : FStar_Range.range = (

let uu____8694 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____8695 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____8694 uu____8695)))
...
let uu____8704 = (FStar_Util.open_stdin ())
in {repl_line = (Prims.parse_int "1"); repl_column = (Prims.parse_int "0"); repl_fname = filename; repl_deps_stack = []; repl_curmod = FStar_Pervasives_Native.None; repl_env = env1; repl_stdin = uu____8704; repl_names = FStar_Interactive_CompletionTable.empty})
in (

let exit_code = (

let uu____8710 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____8712 = (FStar_Options.file_list ())
in (FStar_List.hd uu____8712))
in (FStar_SMTEncoding_Solver.with_hints_db uu____8711 (fun uu____8716 -> (go init_st))))
end
| uu____8717 -> begin
(go init_st)
end))
...
let uu____8725 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____8725))
...
let uu____8729 = (FStar_Options.trace_error ())
in (match (uu____8729) with
| true -> begin
(interactive_mode' filename)
end
| uu____8730 -> begin
(FStar_All.try_with (fun uu___274_8733 -> (match (()) with
| () -> begin
((FStar_Errors.set_handler interactive_error_handler);
(interactive_mode' filename);
)
end)) (fun uu___273_8738 -> (match (uu___273_8738) with
| e -> begin
