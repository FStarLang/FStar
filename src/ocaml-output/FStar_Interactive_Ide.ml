    ...
    fun check_kind  ->
         ...
         in
      {
        ...
        FStar_TypeChecker_Env.synth =
          (uu___86_49.FStar_TypeChecker_Env.synth);
            ...
            (let uu___100_4794 = st1.repl_env  in
             {
               ...
               FStar_TypeChecker_Env.lax =
                 (uu___100_4794.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
               ...
               FStar_TypeChecker_Env.splice =
                 (uu___100_4794.FStar_TypeChecker_Env.splice);
               FStar_TypeChecker_Env.is_native_tactic =
    ...
    fun task  ->
      ...
      (match results with
       | FStar_Util.Inl results1 ->
           (results1,
             (FStar_Util.Inl
                (let uu___106_6725 = st  in
                 {
                   repl_line = (uu___106_6725.repl_line);
                   repl_column = (uu___106_6725.repl_column);
                   repl_fname = (uu___106_6725.repl_fname);
                   repl_deps_stack = (uu___106_6725.repl_deps_stack);
                   repl_curmod = (uu___106_6725.repl_curmod);
                   repl_env = env';
                   repl_stdin = (uu___106_6725.repl_stdin);
                   repl_names = (uu___106_6725.repl_names)
                 })))
       | FStar_Util.Inr e -> FStar_Exn.raise e)
  
let run_with_parsed_and_tc_term :
  'Auu____6743 'Auu____6744 'Auu____6745 .
    repl_state ->
      Prims.string ->
        'Auu____6743 ->
          'Auu____6744 ->
            (FStar_TypeChecker_Env.env ->
              ...
              ->
              ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
                (repl_state,'Auu____6745) FStar_Util.either)
                FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
          ...
          fun continuation  ->
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____6829,{ FStar_Syntax_Syntax.lbname = uu____6830;
                                   FStar_Syntax_Syntax.lbunivs = univs1;
                                   FStar_Syntax_Syntax.lbtyp = uu____6832;
                                   FStar_Syntax_Syntax.lbeff = uu____6833;
                                   FStar_Syntax_Syntax.lbdef = def;
                                   FStar_Syntax_Syntax.lbattrs = uu____6835;
                                   FStar_Syntax_Syntax.lbpos = uu____6836;_}::[]),uu____6837);
            ...
            let parse1 frag =
              ...
              | FStar_Parser_ParseIt.ASTFragment
                  (FStar_Util.Inr decls,uu____6909) ->
                  FStar_Pervasives_Native.Some decls
              | uu____6934 -> FStar_Pervasives_Native.None  in
            let desugar env decls =
              let uu____6948 =
                let uu____6953 =
                  FStar_ToSyntax_ToSyntax.decls_to_sigelts decls  in
                uu____6953 env.FStar_TypeChecker_Env.dsenv  in
              FStar_Pervasives_Native.fst uu____6948  in
            let typecheck tcenv decls =
              let uu____6971 = FStar_TypeChecker_Tc.tc_decls tcenv decls  in
              match uu____6971 with | (ses,uu____6985,uu____6986) -> ses  in
            run_and_rewind st
              (fun st1  ->
                      ...
                      | FStar_Pervasives_Native.Some decls ->
                          let aux uu____7033 =
                            ...
                            | FStar_Pervasives_Native.Some (univs1,def) ->
                             ...
                             in
                          let uu____7080 = FStar_Options.trace_error ()  in
                          if uu____7080
                          then aux ()
                          else
                            (try aux ()
    ...
    repl_state ->
      Prims.string ->
        FStar_TypeChecker_Normalize.step Prims.list
          FStar_Pervasives_Native.option ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____7115) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
        ...
        run_with_parsed_and_tc_term st term (Prims.parse_int "0")
          ...
          (fun tcenv  ->
             fun def  ->
               ...
               let uu____7178 =
                 let uu____7179 = term_to_string tcenv normalized  in
                 FStar_Util.JsonStr uu____7179  in
               (QueryOK, uu____7178))
...
let (uu___is_NameContainsStr : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____7200 -> false
  
let (__proj__NameContainsStr__item___0 : search_term' -> Prims.string) =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0 
let (uu___is_TypeContainsLid : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____7212 -> false
...
let (sc_of_lid : FStar_Ident.lid -> search_candidate) =
  fun lid  ->
    let uu____7436 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    let uu____7443 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    { sc_lid = lid; sc_typ = uu____7436; sc_fvars = uu____7443 }
  
let (sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ) =
  fun tcenv  ->
    fun sc  ->
      let uu____7506 = FStar_ST.op_Bang sc.sc_typ  in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____7557,typ),uu____7559) ->
                typ
             in
...
let (sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____7606 = FStar_ST.op_Bang sc.sc_fvars  in
      match uu____7606 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____7650 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____7650  in
...
let (json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____7688 = sc_typ tcenv sc  in term_to_string tcenv uu____7688
         in
      let uu____7689 =
        let uu____7696 =
          let uu____7701 =
            let uu____7702 =
              let uu____7703 =
                FStar_Syntax_DsEnv.shorten_lid
                 ...
                 in
              uu____7703.FStar_Ident.str  in
            FStar_Util.JsonStr uu____7702  in
          ("lid", uu____7701)  in
        [uu____7696; ("type", (FStar_Util.JsonStr typ_str))]  in
      FStar_Util.JsonAssoc uu____7689
  
exception InvalidSearch of Prims.string 
let (uu___is_InvalidSearch : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____7722 -> true
    | uu____7723 -> false
  
let (__proj__InvalidSearch__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidSearch uu____7730 -> uu____7730
...
let run_search :
  'Auu____7734 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____7734) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_str  ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____7769 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____7769
           in
              ...
              let uu____7793 =
                let uu____7794 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____7794  in
              FStar_Exn.raise uu____7793
            else
              if beg_quote
              then
                (let uu____7796 = strip_quotes term1  in
                 NameContainsStr uu____7796)
              else
      ...
      let pprint_one term =
        let uu____7819 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.strcat (if term.st_negate then "-" else "") uu____7819  in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____7882 = FStar_List.map pprint_one terms  in
                FStar_Util.concat_l " " uu____7882  in
              let uu____7885 =
                let uu____7886 =
                  FStar_Util.format1 "No results found for query [%s]" kwds
                   in
                InvalidSearch uu____7886  in
              FStar_Exn.raise uu____7885
          | uu____7891 -> (QueryOK, (FStar_Util.JsonList js))
...
let (validate_query : repl_state -> query -> query) =
  fun st  ->
    fun q  ->
      match q.qq with
      | Push
          { push_kind = SyntaxCheck ; push_code = uu____7981;
            push_line = uu____7982; push_column = uu____7983;
            push_peek_only = false ;_}
          ->
          {
            qq =
...
let rec (go : repl_state -> Prims.int) =
  fun st  ->
    let rec loop st1 =
      let query =
        let uu____7994 = read_interactive_query st1.repl_stdin  in
        validate_query st1 uu____7994  in
      let uu____7995 = run_query st1 query.qq  in
      ...
      | ((status,response),state_opt) ->
       ...
       in
    let uu____8026 = FStar_Options.trace_error ()  in
    if uu____8026 then loop st else (try loop st with | ExitREPL n1 -> n1)
  
let (interactive_error_handler : FStar_Errors.error_handler) =
  let issues = FStar_Util.mk_ref []  in
  let add_one1 e =
    let uu____8045 =
      let uu____8048 = FStar_ST.op_Bang issues  in e :: uu____8048  in
    FStar_ST.op_Colon_Equals issues uu____8045  in
  let count_errors uu____8144 =
    let uu____8145 =
      let uu____8148 = FStar_ST.op_Bang issues  in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____8148
       in
    FStar_List.length uu____8145  in
  let report uu____8203 =
    let uu____8204 = FStar_ST.op_Bang issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____8204  in
  let clear1 uu____8255 = FStar_ST.op_Colon_Equals issues []  in
  {
...
let (interactive_printer : FStar_Util.printer) =
  {
    ...
    FStar_Util.printer_prgeneric =
      (fun label  ->
         fun get_string  ->
           fun get_json  ->
             let uu____8323 = get_json ()  in write_message label uu____8323)
  } 
let (initial_range : FStar_Range.range) =
  ...
  let uu____8325 =
    FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0")  in
  FStar_Range.mk_range "<input>" uu____8324 uu____8325 
let (interactive_mode' : Prims.string -> Prims.unit) =
  fun filename  ->
    ...
    (let env = FStar_Universal.init_env FStar_Parser_Dep.empty_deps  in
     ...
     let init_st =
       let uu____8333 = FStar_Util.open_stdin ()  in
       {
     ...
     let exit_code =
       ...
       then
         let uu____8340 =
           let uu____8341 = FStar_Options.file_list ()  in
           FStar_List.hd uu____8341  in
         FStar_SMTEncoding_Solver.with_hints_db uu____8340
           (fun uu____8345  -> go init_st)
       else go init_st  in
...
let (interactive_mode : Prims.string -> Prims.unit) =
  fun filename  ->
    ...
    (let uu____8352 =
       let uu____8353 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____8353  in
     if uu____8352
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
         (FStar_Errors.Warning_IDEIgnoreCodeGen, "--ide: ignoring --codegen")
     else ());
    (let uu____8357 = FStar_Options.trace_error ()  in
     if uu____8357
