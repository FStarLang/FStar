                ...
                let st'1 =
                  ...
                  let uu____727 =
                    FStar_TypeChecker_Env.set_dep_graph
                      st'.FStar_Interactive_JsonHelper.repl_env dep_graph1 in
                  {
                    FStar_Interactive_JsonHelper.repl_line =
    ...
    try
      (fun uu___259_1851 ->
         ...
         | () ->
             ...
             let try_arg k =
               let uu____1881 = FStar_Interactive_JsonHelper.try_assoc k args in
    ...
    fun query ->
      let set_nosynth_flag st1 flag =
        let uu___571_4544 = st1 in
        {
          ...
          FStar_Interactive_JsonHelper.repl_env =
            (let uu___573_4546 = st1.FStar_Interactive_JsonHelper.repl_env in
             {
    ...
    fun symbol ->
      ...
      let uu____5083 =
        FStar_Interactive_CompletionTable.find_module_or_ns
          st.FStar_Interactive_JsonHelper.repl_names query in
    ...
    FStar_Interactive_JsonHelper.repl_state ->
      'Auu____6058 ->
        (FStar_Interactive_JsonHelper.repl_state -> 'Auu____6058) ->
          ('Auu____6058 * (FStar_Interactive_JsonHelper.repl_state,
            'Auu____6059) FStar_Util.either)
  =
  fun st ->
    fun sigint_default ->
      fun task ->
