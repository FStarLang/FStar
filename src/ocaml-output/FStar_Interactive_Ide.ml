...
let set_check_kind:
  ...
  fun env  ->
    fun check_kind  ->
      let uu___274_49 = env in
      let uu____50 =
        FStar_ToSyntax_Env.set_syntax_only env.FStar_TypeChecker_Env.dsenv
          (check_kind = SyntaxCheck) in
      {
        FStar_TypeChecker_Env.solver =
          (uu___274_49.FStar_TypeChecker_Env.solver);
        FStar_TypeChecker_Env.range =
          (uu___274_49.FStar_TypeChecker_Env.range);
        FStar_TypeChecker_Env.curmodule =
          (uu___274_49.FStar_TypeChecker_Env.curmodule);
        FStar_TypeChecker_Env.gamma =
          (uu___274_49.FStar_TypeChecker_Env.gamma);
        FStar_TypeChecker_Env.gamma_cache =
          (uu___274_49.FStar_TypeChecker_Env.gamma_cache);
        FStar_TypeChecker_Env.modules =
          (uu___274_49.FStar_TypeChecker_Env.modules);
        FStar_TypeChecker_Env.expected_typ =
          (uu___274_49.FStar_TypeChecker_Env.expected_typ);
        FStar_TypeChecker_Env.sigtab =
          (uu___274_49.FStar_TypeChecker_Env.sigtab);
        FStar_TypeChecker_Env.is_pattern =
          (uu___274_49.FStar_TypeChecker_Env.is_pattern);
        FStar_TypeChecker_Env.instantiate_imp =
          (uu___274_49.FStar_TypeChecker_Env.instantiate_imp);
        FStar_TypeChecker_Env.effects =
          (uu___274_49.FStar_TypeChecker_Env.effects);
        FStar_TypeChecker_Env.generalize =
          (uu___274_49.FStar_TypeChecker_Env.generalize);
        FStar_TypeChecker_Env.letrecs =
          (uu___274_49.FStar_TypeChecker_Env.letrecs);
        FStar_TypeChecker_Env.top_level =
          (uu___274_49.FStar_TypeChecker_Env.top_level);
        FStar_TypeChecker_Env.check_uvars =
          (uu___274_49.FStar_TypeChecker_Env.check_uvars);
        FStar_TypeChecker_Env.use_eq =
          (uu___274_49.FStar_TypeChecker_Env.use_eq);
        FStar_TypeChecker_Env.is_iface =
          (uu___274_49.FStar_TypeChecker_Env.is_iface);
        FStar_TypeChecker_Env.admit =
          (uu___274_49.FStar_TypeChecker_Env.admit);
        FStar_TypeChecker_Env.lax = (check_kind = LaxCheck);
        FStar_TypeChecker_Env.lax_universes =
          (uu___274_49.FStar_TypeChecker_Env.lax_universes);
        FStar_TypeChecker_Env.failhard =
          (uu___274_49.FStar_TypeChecker_Env.failhard);
        FStar_TypeChecker_Env.nosynth =
          (uu___274_49.FStar_TypeChecker_Env.nosynth);
        FStar_TypeChecker_Env.tc_term =
          (uu___274_49.FStar_TypeChecker_Env.tc_term);
        FStar_TypeChecker_Env.type_of =
          (uu___274_49.FStar_TypeChecker_Env.type_of);
        FStar_TypeChecker_Env.universe_of =
          (uu___274_49.FStar_TypeChecker_Env.universe_of);
        FStar_TypeChecker_Env.use_bv_sorts =
          (uu___274_49.FStar_TypeChecker_Env.use_bv_sorts);
        FStar_TypeChecker_Env.qname_and_index =
          (uu___274_49.FStar_TypeChecker_Env.qname_and_index);
        FStar_TypeChecker_Env.proof_ns =
          (uu___274_49.FStar_TypeChecker_Env.proof_ns);
        FStar_TypeChecker_Env.synth =
          (uu___274_49.FStar_TypeChecker_Env.synth);
        FStar_TypeChecker_Env.is_native_tactic =
          (uu___274_49.FStar_TypeChecker_Env.is_native_tactic);
        FStar_TypeChecker_Env.identifier_info =
          (uu___274_49.FStar_TypeChecker_Env.identifier_info);
        FStar_TypeChecker_Env.tc_hooks =
          (uu___274_49.FStar_TypeChecker_Env.tc_hooks);
...
let commit_name_tracking:
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___277_1189 = st in
      {
        repl_line = (uu___277_1189.repl_line);
        repl_column = (uu___277_1189.repl_column);
        repl_fname = (uu___277_1189.repl_fname);
        repl_deps_stack = (uu___277_1189.repl_deps_stack);
        repl_curmod = (uu___277_1189.repl_curmod);
        repl_env = (uu___277_1189.repl_env);
        repl_stdin = (uu___277_1189.repl_stdin);
        repl_names = names1
      }
              ...
              (match uu____1891 with
               | (curmod,env2,success) ->
                   ...
                   (match uu____1957 with
                    | (env',name_events) ->
                        let st1 =
                          let uu___278_1975 = st in
                          {
                            repl_line = (uu___278_1975.repl_line);
                            repl_column = (uu___278_1975.repl_column);
                            repl_fname = (uu___278_1975.repl_fname);
                            repl_deps_stack = (uu___278_1975.repl_deps_stack);
                            repl_curmod = curmod;
                            repl_env = env2;
                            repl_stdin = (uu___278_1975.repl_stdin);
                            repl_names = (uu___278_1975.repl_names)
                          } in
                        let st2 =
                          if success
...
let run_repl_ld_transactions:
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___261_2014 =
        match uu___261_2014 with
        | [] -> st1
        | (task,_st')::entries ->
            ...
            (debug1 "Loading" task;
             ...
             (let timestamped_task = update_task_timestamps task in
              ...
              | (success,st2) ->
                  ...
                  then
                    let uu____2106 =
                      let uu___279_2107 = st2 in
                      let uu____2108 = FStar_ST.op_Bang repl_stack in
                      {
                        repl_line = (uu___279_2107.repl_line);
                        repl_column = (uu___279_2107.repl_column);
                        repl_fname = (uu___279_2107.repl_fname);
                        repl_deps_stack = uu____2108;
                        repl_curmod = (uu___279_2107.repl_curmod);
                        repl_env = (uu___279_2107.repl_env);
                        repl_stdin = (uu___279_2107.repl_stdin);
                        repl_names = (uu___279_2107.repl_names)
                      } in
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___263_2270  ->
    match uu___263_2270 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___264_2275  ->
    match uu___264_2275 with
...
let alist_of_protocol_info:
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_70  -> FStar_Util.JsonList _0_70) uu____3625 in
...
let update_option: fstar_option -> fstar_option =
  fun opt  ->
    let uu___284_4207 = opt in
    let uu____4208 = FStar_Options.get_option opt.opt_name in
    {
      opt_name = (uu___284_4207.opt_name);
      opt_sig = (uu___284_4207.opt_sig);
      opt_value = uu____4208;
      opt_default = (uu___284_4207.opt_default);
      opt_type = (uu___284_4207.opt_type);
      opt_snippets = (uu___284_4207.opt_snippets);
      opt_documentation = (uu___284_4207.opt_documentation);
      opt_permission_level = (uu___284_4207.opt_permission_level)
    }
      ...
      let uu____4568 =
        with_captured_errors st.repl_env
          (fun uu____4577  ->
             ...
             FStar_All.pipe_left
               (fun _0_74  -> FStar_Pervasives_Native.Some _0_74) uu____4578) in
    ...
    let uu____4779 =
      with_captured_errors st.repl_env
        (fun _env  ->
           ...
           FStar_All.pipe_left
             (fun _0_76  -> FStar_Pervasives_Native.Some _0_76) uu____4801) in
...
let rephrase_dependency_error: FStar_Errors.issue -> FStar_Errors.issue =
  fun issue  ->
    let uu___285_4912 = issue in
    let uu____4913 =
      FStar_Util.format1 "Error while computing or loading dependencies:\n%s"
        issue.FStar_Errors.issue_message in
    {
      FStar_Errors.issue_message = uu____4913;
      FStar_Errors.issue_level = (uu___285_4912.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___285_4912.FStar_Errors.issue_range)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___286_4945 = st1 in
        {
          repl_line = (uu___286_4945.repl_line);
          repl_column = (uu___286_4945.repl_column);
          repl_fname = (uu___286_4945.repl_fname);
          repl_deps_stack = (uu___286_4945.repl_deps_stack);
          repl_curmod = (uu___286_4945.repl_curmod);
          repl_env =
            (let uu___287_4947 = st1.repl_env in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___287_4947.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___287_4947.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___287_4947.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___287_4947.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___287_4947.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___287_4947.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___287_4947.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___287_4947.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___287_4947.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___287_4947.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___287_4947.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___287_4947.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___287_4947.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___287_4947.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___287_4947.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___287_4947.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___287_4947.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___287_4947.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___287_4947.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___287_4947.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___287_4947.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___287_4947.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___287_4947.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___287_4947.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___287_4947.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qname_and_index =
                 (uu___287_4947.FStar_TypeChecker_Env.qname_and_index);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___287_4947.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth =
                 (uu___287_4947.FStar_TypeChecker_Env.synth);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___287_4947.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___287_4947.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___287_4947.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___287_4947.FStar_TypeChecker_Env.dsenv)
             });
          repl_stdin = (uu___286_4945.repl_stdin);
          repl_names = (uu___286_4945.repl_names)
        } in
           ...
           (let st1 = set_nosynth_flag st peek_only in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___288_5003 = st3 in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___288_5003.repl_fname);
                      repl_deps_stack = (uu___288_5003.repl_deps_stack);
                      repl_curmod = (uu___288_5003.repl_curmod);
                      repl_env = (uu___288_5003.repl_env);
                      repl_stdin = (uu___288_5003.repl_stdin);
                      repl_names = (uu___288_5003.repl_names)
                    }
                  else st3 in
           ...
           ((let uu____5184 = FStar_Options.restore_cmd_line_options false in
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___289_5187 = st1 in
                {
                  repl_line = (uu___289_5187.repl_line);
                  repl_column = (uu___289_5187.repl_column);
                  repl_fname = (uu___289_5187.repl_fname);
                  repl_deps_stack = (uu___289_5187.repl_deps_stack);
                  repl_curmod = (uu___289_5187.repl_curmod);
                  repl_env = (uu___289_5187.repl_env);
                  repl_stdin = (uu___289_5187.repl_stdin);
                  repl_names = names1
                }) query)))
let run_push:
  'Auu____5191 .
            ...
            let uu____6538 =
                ...
                Prims.strcat uu____6541 "." in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___290_6539.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___290_6539.FStar_Interactive_CompletionTable.mod_loaded)
              } in
    ...
    fun task  ->
      ...
      let results =
        try
          ...
          FStar_All.pipe_left (fun _0_78  -> FStar_Util.Inl _0_78) uu____6850
...
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____8700 =
       let uu____8701 = FStar_Options.verify_module () in uu____8701 <> [] in
     if uu____8700
     then FStar_Util.print_warning "--ide: ignoring --verify_module"
     else ());
    (let uu____8708 =
       let uu____8709 = FStar_Options.codegen () in
       FStar_Option.isSome uu____8709 in
     if uu____8708
     then FStar_Util.print_warning "--ide: ignoring --codegen"
     else ());
    (let uu____8713 = FStar_Options.trace_error () in
     if uu____8713
