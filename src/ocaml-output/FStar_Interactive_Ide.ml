        ...
        FStar_Syntax_DsEnv.ds_push_open_hook =
          (fun dsenv1 ->
             fun op ->
               let uu____1205 =
                 let uu____1206 =
                   let uu____1211 = FStar_Syntax_DsEnv.current_module dsenv1 in
                   (uu____1211, op) in
        ...
        FStar_Syntax_DsEnv.ds_push_include_hook =
          (fun dsenv1 ->
             fun ns ->
               let uu____1217 =
                 let uu____1218 =
                   let uu____1223 = FStar_Syntax_DsEnv.current_module dsenv1 in
                   (uu____1223, ns) in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1283 =
        FStar_Universal.with_tcenv env1
          (fun dsenv1 ->
             let uu____1291 = FStar_Syntax_DsEnv.set_ds_hooks dsenv1 dshooks in
             ((), uu____1291)) in
...
let (alist_of_protocol_info :
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_45 -> FStar_Util.JsonList _0_45) uu____3369 in
                ...
                FStar_All.pipe_right uu____3908
                  (FStar_Util.map_option
                     (fun default_value ->
                        ...
                        let uu____3921 = snippets_of_fstar_option name typ in
                        let uu____3924 =
                          let uu____3925 = FStar_Options.settable name in
                          if uu____3925
                          then OptSet
                          else
                            (let uu____3927 = FStar_Options.resettable name in
                             if uu____3927 then OptReset else OptReadOnly) in
                        {
                          opt_name = name;
                          opt_sig = uu____3920;
    ...
    let uu____4008 =
      let uu____4015 =
        let uu____4020 =
          let uu____4021 =
            ...
            FStar_List.map (fun _0_48 -> FStar_Util.JsonStr _0_48) uu____4024 in
      ...
      let uu____4031 =
        let uu____4038 =
          let uu____4043 =
            let uu____4044 =
              let uu____4047 = current_fstar_options (fun uu____4052 -> true) in
  ...
  fun tcenv ->
    fun t ->
      with_printed_effect_args
        (fun uu____4088 -> FStar_TypeChecker_Normalize.term_to_string tcenv t)
    ...
    fun code ->
      ...
      let collect_decls uu____4292 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____4305, decls, uu____4307)) -> decls in
      let uu____4312 =
        with_captured_errors st.repl_env
          (fun uu____4321 ->
             let uu____4322 = collect_decls () in
             FStar_All.pipe_left
               (fun _0_49 -> FStar_Pervasives_Native.Some _0_49) uu____4322) in
      match uu____4312 with
      | FStar_Pervasives_Native.None ->
          let errors =
            let uu____4350 = collect_errors () in
            FStar_All.pipe_right uu____4350 (FStar_List.map json_of_issue) in
...
let (load_deps :
  ...
  fun st ->
    let uu____4523 =
      with_captured_errors st.repl_env
        (fun _env ->
           let uu____4549 = deps_and_repl_ld_tasks_of_our_file st.repl_fname in
           FStar_All.pipe_left
             (fun _0_51 -> FStar_Pervasives_Native.Some _0_51) uu____4549) in
    ...
    fun deps ->
      fun table ->
        ...
        let loaded_mods_set =
          ...
          let uu____4809 =
            let uu____4812 = FStar_Options.prims () in uu____4812 :: deps in
          FStar_List.fold_left
            (fun acc ->
               fun dep1 ->
                 let uu____4822 = FStar_Parser_Dep.lowercase_module_name dep1 in
    ...
    fun query ->
      ...
      (let uu____4884 = load_deps st in
       ...
       | FStar_Util.Inl (st1, deps) ->
           ((let uu____4948 = FStar_Options.restore_cmd_line_options false in
      ...
      fun pos_opt ->
        fun requested_info ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____5063 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1 in
          ...
          let response =
            ...
            | FStar_Pervasives_Native.Some (name_or_lid, typ, rng) ->
                ...
                FStar_Pervasives_Native.Some uu____5538 in
          match response with
...
let (run_code_lookup :
  ...
  fun st ->
    fun symbol ->
      fun pos_opt ->
        fun requested_info ->
          let uu____5904 = run_symbol_lookup st symbol pos_opt requested_info in
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____6746,
                      { FStar_Syntax_Syntax.lbname = uu____6747;
                        ...
                        FStar_Syntax_Syntax.lbpos = uu____6753;_}::[]),
                     uu____6754);
...
let (json_of_search_result :
  ...
  fun tcenv ->
    fun sc ->
      let typ_str =
        let uu____7605 = sc_typ tcenv sc in term_to_string tcenv uu____7605 in
      let uu____7606 =
        let uu____7613 =
          let uu____7618 =
            let uu____7619 =
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____7686 in
