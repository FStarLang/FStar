...
let (nothing_left_to_pop :
  ...
  fun st  ->
    let uu___ =
      let uu___1 = FStar_ST.op_Bang FStar_Interactive_PushHelper.repl_stack
         in
    ...
    fun tasks  ->
      fun progress_callback  ->
        ...
        let rec aux st1 tasks1 previous =
          ...
          | (tasks2,previous1) ->
              let uu___ = revert_many st1 previous1  in aux uu___ tasks2 []
           in
        aux st tasks
             ...
             let uu___1 =
               ...
               | "lookup" ->
                   let uu___2 =
                     ...
                     let uu___4 =
                       let uu___5 = try_arg "context"  in
                       FStar_All.pipe_right uu___5 js_optional_lookup_context
                        in
                     let uu___5 =
                       let uu___6 =
                            ...
                            (fun loc  ->
                               let uu___7 =
                                 ...
                                 FStar_All.pipe_right uu___8
                                  ...
                                  in
                               let uu___8 =
                                 let uu___9 = assoc "[location]" "line" loc
                                    in
        ...
        FStar_List.append
          (match issue.FStar_Errors.issue_number with
           ...
           | FStar_Pervasives_Native.Some n ->
               [("number", (FStar_Util.JsonInt n))]) uu___2
         in
      FStar_List.append
        ...
        let uu___1 =
          let uu___2 =
            let uu___3 =
              ...
              json_of_opt (fun uu___5  -> FStar_Util.JsonStr uu___5) uu___4
               in
            ("query-id", uu___3)  in
          [uu___2;
          ...
          let uu___3 =
            let uu___4 =
              FStar_List.concatMap filenames
               ...
               in
            FStar_List.map (fun uu___5  -> FStar_Util.JsonStr uu___5) uu___4
             in
...
let run_describe_protocol :
  'uuuuu 'uuuuu1 .
    'uuuuu ->
      ((query_status * FStar_Util.json) * ('uuuuu,'uuuuu1) FStar_Util.either)
  =
  fun st  ->
        ...
        (fun _env  ->
           let uu___1 =
             FStar_Interactive_PushHelper.deps_and_repl_ld_tasks_of_our_file
              ...
              in
           FStar_All.pipe_left
             (fun uu___2  -> FStar_Pervasives_Native.Some uu___2) uu___1)
       in
    match uu___ with
  ...
  fun st  ->
    fun symbol  ->
      fun context  ->
        fun pos_opt  ->
          fun requested_info  ->
            let uu___ = run_lookup' st symbol context pos_opt requested_info
               in
            match uu___ with
            | FStar_Util.Inl err_msg ->
        ...
        fun column  ->
          fun continuation  ->
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu___,{ FStar_Syntax_Syntax.lbname = uu___1;
            ...
            let desugar env decls =
              let uu___ =
                let uu___1 = FStar_ToSyntax_ToSyntax.decls_to_sigelts decls
                   in
...
let (sc_typ :
  ...
  fun tcenv  ->
    fun sc  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            let uu___1 = FStar_TypeChecker_Env.try_lookup_lid tcenv sc.sc_lid
               in
            match uu___1 with
            | FStar_Pervasives_Native.None  ->
...
let (sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu___1 = sc_typ tcenv sc  in FStar_Syntax_Free.fvars uu___1
             in
        ...
        try
          (fun uu___  ->
             ...
             | () ->
                 ...
                 let results1 = FStar_List.filter matches_all all_candidates
                    in
  ...
  fun printer  ->
    {
      ...
      FStar_Util.printer_prgeneric =
        (fun label  ->
           fun get_string  ->
             fun get_json  ->
               let uu___ = get_json ()  in
               forward_message printer label uu___)
    }
...
let interactive_mode' :
  ...
  fun init_st  ->
    ...
    (let exit_code =
       ...
       then
         let uu___2 =
           let uu___3 = FStar_Options.file_list ()  in FStar_List.hd uu___3
            in
...
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    ...
    (let uu___3 =
       let uu___4 = FStar_Options.codegen ()  in FStar_Option.isSome uu___4
        in
     if uu___3
     then
