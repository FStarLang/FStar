        ...
        fun task  ->
          let st1 =
            FStar_PushHelper.push_repl "run_repl_transaction" push_kind task
             ...
             in
          let uu____449 =
            FStar_PushHelper.track_name_changes st1.FStar_JsonHelper.repl_env
             in
          ...
          | (env,finish_name_tracking) ->
              ...
              let uu____501 =
                    ...
                    (fun env1  ->
                       let uu____523 =
                         FStar_PushHelper.run_repl_task
                           st1.FStar_JsonHelper.repl_curmod env1 task
                          in
                       FStar_All.pipe_left
                ...
                | uu____558 ->
                    ((st1.FStar_JsonHelper.repl_curmod), env, false)
                 in
      ...
      fun progress_callback  ->
        ...
        let rec revert_many st1 uu___1_673 =
          ...
          | (_id,(task,_st'))::entries ->
              (debug1 "Reverting" task;
               (let st' =
                  FStar_PushHelper.pop_repl "run_repl_ls_transactions" st1
                   in
                let dep_graph1 =
                ...
                let st'1 =
                  ...
                  let uu____727 =
                    FStar_TypeChecker_Env.set_dep_graph
                      st'.FStar_JsonHelper.repl_env dep_graph1
                     in
                  {
                    FStar_JsonHelper.repl_line =
        ...
        let rec aux st1 tasks1 previous =
          ...
          | (task::tasks2,prev::previous1) when
              let uu____855 = FStar_PushHelper.update_task_timestamps task
                 in
             ...
             let uu____1889 =
               ...
               | "segment" ->
                   let uu____1895 =
                     ...
                     FStar_All.pipe_right uu____1897 FStar_JsonHelper.js_str
                      in
                   Segment uu____1895
               | "peek" ->
                   let uu____1901 =
               ...
               | "search" ->
                   let uu____2100 =
                     ...
                     FStar_All.pipe_right uu____2102 FStar_JsonHelper.js_str
                      in
                   Search uu____2100
               | "vfs-add" ->
                   let uu____2106 =
      ...
      let uu____2347 =
        let uu____2353 =
          json_of_opt FStar_Range.json_of_def_range
            lr.FStar_QueryHelper.slr_def_range
           in
...
let (write_hello : unit -> unit) =
  fun uu____3336  -> FStar_JsonHelper.write_json json_of_hello 
          ...
          let uu____3612 =
            let uu____3615 =
              FStar_List.concatMap filenames
                st.FStar_JsonHelper.repl_deps_stack
               in
  ...
  'Auu____3751 .
    FStar_JsonHelper.repl_state ->
      ((query_status * FStar_Util.json) *
        (FStar_JsonHelper.repl_state,'Auu____3751) FStar_Util.either)
  =
  fun st  ->
    let uu____3769 =
...
let run_segment :
  'Auu____3888 .
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____3888) FStar_Util.either)
  =
  fun st  ->
    fun code  ->
      let frag =
  ...
  'Auu____4074 .
    FStar_JsonHelper.repl_state ->
      Prims.string FStar_Pervasives_Native.option ->
        Prims.string ->
          ((query_status * FStar_Util.json) *
            (FStar_JsonHelper.repl_state,'Auu____4074) FStar_Util.either)
  =
  fun st  ->
    fun opt_fname  ->
      fun contents  ->
        let fname = FStar_Util.dflt st.FStar_JsonHelper.repl_fname opt_fname
           in
...
let run_pop :
  'Auu____4127 .
    FStar_JsonHelper.repl_state ->
      ((query_status * FStar_Util.json) *
        (FStar_JsonHelper.repl_state,'Auu____4127) FStar_Util.either)
  =
  fun st  ->
...
let (write_progress :
  ...
  fun stage  ->
    fun contents_alist  ->
      ...
      FStar_JsonHelper.write_json uu____4232
  
let (write_repl_ld_task_progress : FStar_JsonHelper.repl_task -> unit) =
  fun task  ->
    match task with
    | FStar_JsonHelper.LDInterleaved (uu____4240,tf) ->
        let modname =
          FStar_Parser_Dep.module_name_of_file tf.FStar_JsonHelper.tf_fname
           in
...
let (load_deps :
  FStar_JsonHelper.repl_state ->
    ((FStar_JsonHelper.repl_state * Prims.string Prims.list),FStar_JsonHelper.repl_state)
      FStar_Util.either)
  =
  fun st  ->
    let uu____4310 =
    ...
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          ...
          {
            FStar_JsonHelper.repl_line =
              (uu___554_4440.FStar_JsonHelper.repl_line);
            FStar_JsonHelper.repl_column =
              (uu___554_4440.FStar_JsonHelper.repl_column);
            FStar_JsonHelper.repl_fname =
              (uu___554_4440.FStar_JsonHelper.repl_fname);
            FStar_JsonHelper.repl_deps_stack =
              (uu___554_4440.FStar_JsonHelper.repl_deps_stack);
            FStar_JsonHelper.repl_curmod =
              (uu___554_4440.FStar_JsonHelper.repl_curmod);
            FStar_JsonHelper.repl_env = uu____4441;
            FStar_JsonHelper.repl_stdin =
              (uu___554_4440.FStar_JsonHelper.repl_stdin);
            FStar_JsonHelper.repl_names =
              (uu___554_4440.FStar_JsonHelper.repl_names)
          }  in
        let uu____4442 =
...
let run_push_without_deps :
  'Auu____4508 .
    FStar_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____4508) FStar_Util.either)
  =
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        ...
        {
          FStar_JsonHelper.repl_line =
            (uu___571_4544.FStar_JsonHelper.repl_line);
          FStar_JsonHelper.repl_column =
            (uu___571_4544.FStar_JsonHelper.repl_column);
          FStar_JsonHelper.repl_fname =
            (uu___571_4544.FStar_JsonHelper.repl_fname);
          FStar_JsonHelper.repl_deps_stack =
            (uu___571_4544.FStar_JsonHelper.repl_deps_stack);
          FStar_JsonHelper.repl_curmod =
            (uu___571_4544.FStar_JsonHelper.repl_curmod);
          FStar_JsonHelper.repl_env =
            (let uu___573_4546 = st1.FStar_JsonHelper.repl_env  in
             {
               ...
               FStar_TypeChecker_Env.is_pattern =
                 (uu___573_4546.FStar_TypeChecker_Env.is_pattern);
          ...
          FStar_JsonHelper.repl_stdin =
            (uu___571_4544.FStar_JsonHelper.repl_stdin);
          FStar_JsonHelper.repl_names =
            (uu___571_4544.FStar_JsonHelper.repl_names)
        }  in
                ...
                let st4 =
                  ...
                  then
                    let uu___592_4615 = st3  in
                    {
                      ...
                      FStar_JsonHelper.repl_deps_stack =
                        (uu___592_4615.FStar_JsonHelper.repl_deps_stack);
                      FStar_JsonHelper.repl_curmod =
                        (uu___592_4615.FStar_JsonHelper.repl_curmod);
                      FStar_JsonHelper.repl_env =
                        (uu___592_4615.FStar_JsonHelper.repl_env);
                      FStar_JsonHelper.repl_stdin =
                        (uu___592_4615.FStar_JsonHelper.repl_stdin);
                      FStar_JsonHelper.repl_names =
                        (uu___592_4615.FStar_JsonHelper.repl_names)
                    }
                  else st3  in
...
let run_push_with_deps :
  'Auu____4633 .
    FStar_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____4633) FStar_Util.either)
  =
  fun st  ->
    fun query  ->
           ...
           ((let uu____4734 = FStar_Options.restore_cmd_line_options false
            ...
            (let names1 =
               FStar_PushHelper.add_module_completions
                 ...
                 st1.FStar_JsonHelper.repl_names
                in
             run_push_without_deps
               (let uu___610_4738 = st1  in
                {
                  FStar_JsonHelper.repl_line =
                    (uu___610_4738.FStar_JsonHelper.repl_line);
                  FStar_JsonHelper.repl_column =
                    (uu___610_4738.FStar_JsonHelper.repl_column);
                  FStar_JsonHelper.repl_fname =
                    (uu___610_4738.FStar_JsonHelper.repl_fname);
                  FStar_JsonHelper.repl_deps_stack =
                    (uu___610_4738.FStar_JsonHelper.repl_deps_stack);
                  FStar_JsonHelper.repl_curmod =
                    (uu___610_4738.FStar_JsonHelper.repl_curmod);
                  FStar_JsonHelper.repl_env =
                    (uu___610_4738.FStar_JsonHelper.repl_env);
                  FStar_JsonHelper.repl_stdin =
                    (uu___610_4738.FStar_JsonHelper.repl_stdin);
...
let run_push :
  'Auu____4746 .
    FStar_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____4746) FStar_Util.either)
  =
  fun st  ->
    fun query  ->
    ...
    fun symbol  ->
      ...
      let uu____5083 =
        FStar_Interactive_CompletionTable.find_module_or_ns
          st.FStar_JsonHelper.repl_names query
         in
      ...
      Prims.string ->
        lookup_context ->
          FStar_QueryHelper.position FStar_Pervasives_Native.option ->
            Prims.string Prims.list ->
              ((query_status * FStar_Util.json) *
                (FStar_JsonHelper.repl_state,'Auu____5532) FStar_Util.either)
  =
  fun st  ->
    fun symbol  ->
      fun context  ->
...
let run_code_autocomplete :
  'Auu____5688 .
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____5688) FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
    ...
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        'Auu____5742 ->
          'Auu____5743 ->
            ((query_status * FStar_Util.json) *
              (FStar_JsonHelper.repl_state,'Auu____5744) FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
      fun modules1  ->
  ...
  'Auu____6006 .
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        completion_context ->
          ((query_status * FStar_Util.json) *
            (FStar_JsonHelper.repl_state,'Auu____6006) FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
      fun context  ->
...
let run_and_rewind :
  'Auu____6058 'Auu____6059 .
    FStar_JsonHelper.repl_state ->
      'Auu____6058 ->
        (FStar_JsonHelper.repl_state -> 'Auu____6058) ->
          ('Auu____6058 * (FStar_JsonHelper.repl_state,'Auu____6059)
            FStar_Util.either)
  =
  fun st  ->
    fun sigint_default  ->
      fun task  ->
        let st1 =
          FStar_PushHelper.push_repl "run_and_rewind"
            FStar_PushHelper.FullCheck FStar_JsonHelper.Noop st
           in
        let results =
          try
            (fun uu___725_6100  ->
        ...
        'Auu____6166 ->
          'Auu____6167 ->
            (FStar_TypeChecker_Env.env ->
              ...
              ->
              ((query_status * FStar_Util.json) *
                (FStar_JsonHelper.repl_state,'Auu____6168) FStar_Util.either)
  =
  fun st  ->
    fun term  ->
      fun line  ->
    ...
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        FStar_TypeChecker_Env.step Prims.list FStar_Pervasives_Native.option
          ->
          ((query_status * FStar_Util.json) *
            (FStar_JsonHelper.repl_state,'Auu____6576) FStar_Util.either)
  =
  fun st  ->
    fun term  ->
      fun rules  ->
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        ...
        FStar_QueryHelper.term_to_string tcenv uu____7099  in
      let uu____7100 =
        let uu____7108 =
          let uu____7114 =
            let uu____7115 =
...
let run_search :
  'Auu____7172 .
    FStar_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_JsonHelper.repl_state,'Auu____7172) FStar_Util.either)
  =
  fun st  ->
    fun search_str  ->
...
let (run_query :
  FStar_JsonHelper.repl_state ->
    query' ->
      ((query_status * FStar_Util.json) *
        (FStar_JsonHelper.repl_state,Prims.int) FStar_Util.either))
  =
  fun st  ->
    fun q  ->
      match q with
...
let (validate_query : FStar_JsonHelper.repl_state -> query -> query) =
  fun st  ->
    fun q  ->
      match q.qq with
      | Push
          { push_kind = FStar_PushHelper.SyntaxCheck ;
...
let (build_initial_repl_state : Prims.string -> FStar_JsonHelper.repl_state)
  ...
  fun filename  ->
    ...
    let uu____8095 = FStar_Util.open_stdin ()  in
    {
      ...
      FStar_JsonHelper.repl_stdin = uu____8095;
      FStar_JsonHelper.repl_names = FStar_Interactive_CompletionTable.empty
    }
  
let interactive_mode' :
  'Auu____8111 . FStar_JsonHelper.repl_state -> 'Auu____8111 =
  fun init_st  ->
    write_hello ();
    (let exit_code =
       let uu____8120 =
