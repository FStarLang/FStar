    ...
    fun table ->
      fun evt ->
        ...
        | NTInclude (host, included) ->
            let uu____979 = if is_cur_mod host then [] else query_of_lid host in
        ...
        FStar_Syntax_DsEnv.ds_push_open_hook =
          (fun dsenv1 ->
             fun op ->
               let uu____1208 =
                 let uu____1209 =
                   let uu____1214 = FStar_Syntax_DsEnv.current_module dsenv1 in
                   (uu____1214, op) in
        ...
        FStar_Syntax_DsEnv.ds_push_include_hook =
          (fun dsenv1 ->
             fun ns ->
               let uu____1220 =
                 let uu____1221 =
                   let uu____1226 = FStar_Syntax_DsEnv.current_module dsenv1 in
                   (uu____1226, ns) in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1286 =
        FStar_Universal.with_tcenv env1
          (fun dsenv1 ->
             let uu____1294 = FStar_Syntax_DsEnv.set_ds_hooks dsenv1 dshooks in
             ((), uu____1294)) in
    ...
    | (old_dshooks, old_tchooks) ->
        ...
        (match uu____1317 with
         | (events, new_dshooks, new_tchooks) ->
             ...
             (uu____1351,
               ((fun env1 ->
                   let uu____1364 = set_hooks old_dshooks old_tchooks env1 in
                   let uu____1365 =
        ...
        (match uu____1596 with
         | (same_name, real_deps) ->
             let intf_tasks =
               ...
               | intf::impl::[] ->
                   ((let uu____1633 =
                       let uu____1634 = FStar_Parser_Dep.is_interface intf in
                     ...
                     then
                       let uu____1635 =
                         ...
                         (FStar_Errors.Fatal_MissingInterface, uu____1640) in
      ...
      let rec revert_many st1 uu___75_1871 =
        ...
        | (task, _st')::entries ->
            ((let uu____1896 = Obj.magic () in ());
             ...
             (let uu____1898 = pop_repl st1 in revert_many uu____1898 entries)) in
      let rec aux st1 tasks1 previous =
        match (tasks1, previous) with
        | ([], []) -> FStar_Util.Inl st1
        | (task::tasks2, []) ->
            (debug1 "Loading" task;
             (let uu____1943 = FStar_Options.restore_cmd_line_options false in
...
let (uu___is_Exit : query' -> Prims.bool) =
  fun projectee -> match projectee with | Exit -> true | uu____2347 -> false
  ...
  fun key ->
    fun a ->
      let uu____2701 =
        FStar_Util.try_find
          (fun uu____2715 ->
             match uu____2715 with | (k, uu____2721) -> k = key) a in
    ...
    try
      ...
      let uu____2825 =
        ...
        | "lookup" ->
            let uu____2859 =
              ...
              let uu____2874 =
                ...
                FStar_All.pipe_right uu____2875 js_optional_lookup_context in
              let uu____2880 =
                let uu____2889 =
                ...
                FStar_All.pipe_right uu____2889
                  (FStar_Util.map_option
                     (fun loc ->
                        let uu____2956 =
                          let uu____2957 = assoc1 "[location]" "filename" loc in
                        ...
                        let uu____2960 =
                          let uu____2961 = assoc1 "[location]" "column" loc in
                          FStar_All.pipe_right uu____2961 js_int in
                        (uu____2956, uu____2958, uu____2960))) in
              let uu____2962 =
        ...
        | "vfs-add" ->
            ...
            VfsAdd uu____3011
        | uu____3032 ->
            let uu____3033 = FStar_Util.format1 "Unknown query '%s'" query in
            ProtocolViolation uu____3033 in
      { qq = uu____2825; qid }
...
let (alist_of_protocol_info :
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_45 -> FStar_Util.JsonList _0_45) uu____3372 in
                ...
                FStar_All.pipe_right uu____3911
                  (FStar_Util.map_option
                     (fun default_value ->
                        ...
                        let uu____3924 = snippets_of_fstar_option name typ in
                        let uu____3927 =
                          let uu____3928 = FStar_Options.settable name in
                          if uu____3928
                          then OptSet
                          else
                            (let uu____3930 = FStar_Options.resettable name in
                             if uu____3930 then OptReset else OptReadOnly) in
                        {
                          opt_name = name;
                          opt_sig = uu____3923;
    ...
    let uu____4011 =
      let uu____4018 =
        let uu____4023 =
          let uu____4024 =
            ...
            FStar_List.map (fun _0_48 -> FStar_Util.JsonStr _0_48) uu____4027 in
      ...
      let uu____4034 =
        let uu____4041 =
          let uu____4046 =
            let uu____4047 =
              let uu____4050 = current_fstar_options (fun uu____4055 -> true) in
  ...
  fun tcenv ->
    fun t ->
      with_printed_effect_args
        (fun uu____4091 -> FStar_TypeChecker_Normalize.term_to_string tcenv t)
    ...
    fun code ->
      ...
      let collect_decls uu____4295 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____4308, decls, uu____4310)) -> decls in
      let uu____4315 =
        with_captured_errors st.repl_env
          (fun uu____4324 ->
             let uu____4325 = collect_decls () in
             FStar_All.pipe_left
               (fun _0_49 -> FStar_Pervasives_Native.Some _0_49) uu____4325) in
      match uu____4315 with
      | FStar_Pervasives_Native.None ->
          let errors =
            let uu____4353 = collect_errors () in
            FStar_All.pipe_right uu____4353 (FStar_List.map json_of_issue) in
...
let (load_deps :
  ...
  fun st ->
    let uu____4526 =
      with_captured_errors st.repl_env
        (fun _env ->
           let uu____4552 = deps_and_repl_ld_tasks_of_our_file st.repl_fname in
           FStar_All.pipe_left
             (fun _0_51 -> FStar_Pervasives_Native.Some _0_51) uu____4552) in
    ...
    fun deps ->
      fun table ->
        ...
        let loaded_mods_set =
          ...
          let uu____4812 =
            let uu____4815 = FStar_Options.prims () in uu____4815 :: deps in
          FStar_List.fold_left
            (fun acc ->
               fun dep1 ->
                 let uu____4825 = FStar_Parser_Dep.lowercase_module_name dep1 in
    ...
    fun query ->
      ...
      (let uu____4887 = load_deps st in
       ...
       | FStar_Util.Inl (st1, deps) ->
           ((let uu____4951 = FStar_Options.restore_cmd_line_options false in
      ...
      fun pos_opt ->
        fun requested_info ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____5066 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1 in
          ...
          let response =
            ...
            | FStar_Pervasives_Native.Some (name_or_lid, typ, rng) ->
                ...
                FStar_Pervasives_Native.Some uu____5541 in
          match response with
...
let (run_code_lookup :
  ...
  fun st ->
    fun symbol ->
      fun pos_opt ->
        fun requested_info ->
          let uu____5907 = run_symbol_lookup st symbol pos_opt requested_info in
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____6749,
                      { FStar_Syntax_Syntax.lbname = uu____6750;
                        ...
                        FStar_Syntax_Syntax.lbpos = uu____6756;_}::[]),
                     uu____6757);
...
let (json_of_search_result :
  ...
  fun tcenv ->
    fun sc ->
      let typ_str =
        let uu____7608 = sc_typ tcenv sc in term_to_string tcenv uu____7608 in
      let uu____7609 =
        let uu____7616 =
          let uu____7621 =
            let uu____7622 =
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____7689 in
