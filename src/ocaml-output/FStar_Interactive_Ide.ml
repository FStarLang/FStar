...
let (commit_name_tracking :
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___88_1050 = st  in
      {
        repl_line = (uu___88_1050.repl_line);
        repl_column = (uu___88_1050.repl_column);
        repl_fname = (uu___88_1050.repl_fname);
        repl_deps_stack = (uu___88_1050.repl_deps_stack);
        repl_curmod = (uu___88_1050.repl_curmod);
        repl_env = (uu___88_1050.repl_env);
        repl_stdin = (uu___88_1050.repl_stdin);
        repl_names = names1
      }
              ...
              (match uu____1745 with
               | (curmod,env2,success) ->
                   ...
                   (match uu____1811 with
                    | (env',name_events) ->
                        let st1 =
                          let uu___89_1829 = st  in
                          {
                            repl_line = (uu___89_1829.repl_line);
                            repl_column = (uu___89_1829.repl_column);
                            repl_fname = (uu___89_1829.repl_fname);
                            repl_deps_stack = (uu___89_1829.repl_deps_stack);
                            repl_curmod = curmod;
                            repl_env = env2;
                            repl_stdin = (uu___89_1829.repl_stdin);
                            repl_names = (uu___89_1829.repl_names)
                          }  in
                        let st2 =
                          if success
...
let (run_repl_ld_transactions :
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___72_1868 =
        match uu___72_1868 with
        | [] -> st1
        | (task,_st')::entries ->
            ...
            (debug1 "Loading" task;
             ...
             (let timestamped_task = update_task_timestamps task  in
              ...
              | (success,st2) ->
                  ...
                  then
                    let uu____1960 =
                      let uu___90_1961 = st2  in
                      let uu____1962 = FStar_ST.op_Bang repl_stack  in
                      {
                        repl_line = (uu___90_1961.repl_line);
                        repl_column = (uu___90_1961.repl_column);
                        repl_fname = (uu___90_1961.repl_fname);
                        repl_deps_stack = uu____1962;
                        repl_curmod = (uu___90_1961.repl_curmod);
                        repl_env = (uu___90_1961.repl_env);
                        repl_stdin = (uu___90_1961.repl_stdin);
                        repl_names = (uu___90_1961.repl_names)
                      }  in
...
let (js_int : FStar_Util.json -> Prims.int) =
  fun uu___74_2097  ->
    match uu___74_2097 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let (js_str : FStar_Util.json -> Prims.string) =
  fun uu___75_2102  ->
    match uu___75_2102 with
...
let (update_option : fstar_option -> fstar_option) =
  fun opt  ->
    let uu___95_4034 = opt  in
    let uu____4035 = FStar_Options.get_option opt.opt_name  in
    {
      opt_name = (uu___95_4034.opt_name);
      opt_sig = (uu___95_4034.opt_sig);
      opt_value = uu____4035;
      opt_default = (uu___95_4034.opt_default);
      opt_type = (uu___95_4034.opt_type);
      opt_snippets = (uu___95_4034.opt_snippets);
      opt_documentation = (uu___95_4034.opt_documentation);
      opt_permission_level = (uu___95_4034.opt_permission_level)
    }
...
let (load_deps :
  ...
  fun st  ->
    ...
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___96_4723 = st  in
          let uu____4724 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1  in
          {
            repl_line = (uu___96_4723.repl_line);
            repl_column = (uu___96_4723.repl_column);
            repl_fname = (uu___96_4723.repl_fname);
            repl_deps_stack = (uu___96_4723.repl_deps_stack);
            repl_curmod = (uu___96_4723.repl_curmod);
            repl_env = uu____4724;
            repl_stdin = (uu___96_4723.repl_stdin);
            repl_names = (uu___96_4723.repl_names)
          }  in
...
let (rephrase_dependency_error : FStar_Errors.issue -> FStar_Errors.issue) =
  fun issue  ->
       ...
       in
    {
      ...
      FStar_Errors.issue_level = (uu___97_4759.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___97_4759.FStar_Errors.issue_range);
      FStar_Errors.issue_number = (uu___97_4759.FStar_Errors.issue_number)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___98_4792 = st1  in
        {
          repl_line = (uu___98_4792.repl_line);
          repl_column = (uu___98_4792.repl_column);
          repl_fname = (uu___98_4792.repl_fname);
          repl_deps_stack = (uu___98_4792.repl_deps_stack);
          repl_curmod = (uu___98_4792.repl_curmod);
          repl_env =
            (let uu___99_4794 = st1.repl_env  in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___99_4794.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___99_4794.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___99_4794.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___99_4794.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___99_4794.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___99_4794.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___99_4794.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___99_4794.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___99_4794.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___99_4794.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___99_4794.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___99_4794.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___99_4794.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___99_4794.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___99_4794.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___99_4794.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___99_4794.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___99_4794.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___99_4794.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___99_4794.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___99_4794.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___99_4794.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___99_4794.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___99_4794.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.check_type_of =
                 (uu___99_4794.FStar_TypeChecker_Env.check_type_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___99_4794.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qname_and_index =
                 (uu___99_4794.FStar_TypeChecker_Env.qname_and_index);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___99_4794.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth =
                 (uu___99_4794.FStar_TypeChecker_Env.synth);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___99_4794.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___99_4794.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___99_4794.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___99_4794.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___99_4794.FStar_TypeChecker_Env.dep_graph)
             });
          repl_stdin = (uu___98_4792.repl_stdin);
          repl_names = (uu___98_4792.repl_names)
        }  in
           ...
           (let st1 = set_nosynth_flag st peek_only  in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___100_4850 = st3  in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___100_4850.repl_fname);
                      repl_deps_stack = (uu___100_4850.repl_deps_stack);
                      repl_curmod = (uu___100_4850.repl_curmod);
                      repl_env = (uu___100_4850.repl_env);
                      repl_stdin = (uu___100_4850.repl_stdin);
                      repl_names = (uu___100_4850.repl_names)
                    }
                  else st3  in
           ...
           ((let uu____5031 = FStar_Options.restore_cmd_line_options false
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___101_5034 = st1  in
                {
                  repl_line = (uu___101_5034.repl_line);
                  repl_column = (uu___101_5034.repl_column);
                  repl_fname = (uu___101_5034.repl_fname);
                  repl_deps_stack = (uu___101_5034.repl_deps_stack);
                  repl_curmod = (uu___101_5034.repl_curmod);
                  repl_env = (uu___101_5034.repl_env);
                  repl_stdin = (uu___101_5034.repl_stdin);
                  repl_names = names1
                }) query)))
            ...
            let uu____6385 =
                ...
                Prims.strcat uu____6388 "."  in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___102_6386.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___102_6386.FStar_Interactive_CompletionTable.mod_loaded)
              }  in
        ...
        fun column  ->
          fun continuation  ->
            ...
            let typecheck tcenv decls =
              ...
              match uu____6963 with | (ses,uu____6973) -> ses  in
            run_and_rewind st
              (fun st1  ->
                      ...
                      | FStar_Pervasives_Native.Some decls ->
                          let aux uu____7016 =
                            ...
                            | FStar_Pervasives_Native.Some (univs1,def) ->
                             ...
                             in
                          let uu____7063 = FStar_Options.trace_error ()  in
                          if uu____7063
                          then aux ()
                          else
                            (try aux ()
    ...
    repl_state ->
      Prims.string ->
        FStar_TypeChecker_Normalize.step Prims.list
          FStar_Pervasives_Native.option ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____7098) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
        ...
        run_with_parsed_and_tc_term st term (Prims.parse_int "0")
          ...
          (fun tcenv  ->
             fun def  ->
               ...
               let uu____7161 =
                 let uu____7162 = term_to_string tcenv normalized  in
                 FStar_Util.JsonStr uu____7162  in
               (QueryOK, uu____7161))
...
let (uu___is_NameContainsStr : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____7183 -> false
  
let (__proj__NameContainsStr__item___0 : search_term' -> Prims.string) =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0 
let (uu___is_TypeContainsLid : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____7195 -> false
...
let (sc_of_lid : FStar_Ident.lid -> search_candidate) =
  fun lid  ->
    let uu____7419 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    let uu____7426 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    { sc_lid = lid; sc_typ = uu____7419; sc_fvars = uu____7426 }
  
let (sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ) =
  fun tcenv  ->
    fun sc  ->
      let uu____7489 = FStar_ST.op_Bang sc.sc_typ  in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____7540,typ),uu____7542) ->
                typ
             in
...
let (sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____7589 = FStar_ST.op_Bang sc.sc_fvars  in
      match uu____7589 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____7633 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____7633  in
...
let (json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____7671 = sc_typ tcenv sc  in term_to_string tcenv uu____7671
         in
      let uu____7672 =
        let uu____7679 =
          let uu____7684 =
            let uu____7685 =
              let uu____7686 =
                FStar_ToSyntax_Env.shorten_lid
                 ...
                 in
              uu____7686.FStar_Ident.str  in
            FStar_Util.JsonStr uu____7685  in
          ("lid", uu____7684)  in
        [uu____7679; ("type", (FStar_Util.JsonStr typ_str))]  in
      FStar_Util.JsonAssoc uu____7672
  
exception InvalidSearch of Prims.string 
let (uu___is_InvalidSearch : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____7705 -> true
    | uu____7706 -> false
  
let (__proj__InvalidSearch__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidSearch uu____7713 -> uu____7713
...
let run_search :
  'Auu____7717 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____7717) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_str  ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____7752 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____7752
           in
              ...
              let uu____7776 =
                let uu____7777 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____7777  in
              FStar_Exn.raise uu____7776
            else
              if beg_quote
              then
                (let uu____7779 = strip_quotes term1  in
                 NameContainsStr uu____7779)
              else
      ...
      let pprint_one term =
        let uu____7802 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.strcat (if term.st_negate then "-" else "") uu____7802  in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____7865 = FStar_List.map pprint_one terms  in
                FStar_Util.concat_l " " uu____7865  in
              let uu____7868 =
                let uu____7869 =
                  FStar_Util.format1 "No results found for query [%s]" kwds
                   in
                InvalidSearch uu____7869  in
              FStar_Exn.raise uu____7868
          | uu____7874 -> (QueryOK, (FStar_Util.JsonList js))
...
let (validate_query : repl_state -> query -> query) =
  fun st  ->
    fun q  ->
      match q.qq with
      | Push
          { push_kind = SyntaxCheck ; push_code = uu____7964;
            push_line = uu____7965; push_column = uu____7966;
            push_peek_only = false ;_}
          ->
          {
            qq =
...
let rec (go : repl_state -> Prims.int) =
  fun st  ->
    let rec loop st1 =
      let query =
        let uu____7977 = read_interactive_query st1.repl_stdin  in
        validate_query st1 uu____7977  in
      let uu____7978 = run_query st1 query.qq  in
      ...
      | ((status,response),state_opt) ->
       ...
       in
    let uu____8009 = FStar_Options.trace_error ()  in
    if uu____8009 then loop st else (try loop st with | ExitREPL n1 -> n1)
  
let (interactive_error_handler : FStar_Errors.error_handler) =
  let issues = FStar_Util.mk_ref []  in
  let add_one1 e =
    let uu____8028 =
      let uu____8031 = FStar_ST.op_Bang issues  in e :: uu____8031  in
    FStar_ST.op_Colon_Equals issues uu____8028  in
  let count_errors uu____8127 =
    let uu____8128 =
      let uu____8131 = FStar_ST.op_Bang issues  in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____8131
       in
    FStar_List.length uu____8128  in
  let report uu____8186 =
    let uu____8187 = FStar_ST.op_Bang issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____8187  in
  let clear1 uu____8238 = FStar_ST.op_Colon_Equals issues []  in
  {
...
let (interactive_printer : FStar_Util.printer) =
  {
    ...
    FStar_Util.printer_prgeneric =
      (fun label  ->
         fun get_string  ->
           fun get_json  ->
             let uu____8306 = get_json ()  in write_message label uu____8306)
  } 
let (initial_range : FStar_Range.range) =
  ...
  let uu____8308 =
    FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0")  in
  FStar_Range.mk_range "<input>" uu____8307 uu____8308 
let (interactive_mode' : Prims.string -> Prims.unit) =
  fun filename  ->
    ...
    (let env = FStar_Universal.init_env FStar_Parser_Dep.empty_deps  in
     ...
     let init_st =
       let uu____8316 = FStar_Util.open_stdin ()  in
       {
     ...
     let exit_code =
       ...
       then
         let uu____8323 =
           let uu____8324 = FStar_Options.file_list ()  in
           FStar_List.hd uu____8324  in
         FStar_SMTEncoding_Solver.with_hints_db uu____8323
           (fun uu____8328  -> go init_st)
       else go init_st  in
...
let (interactive_mode : Prims.string -> Prims.unit) =
  fun filename  ->
    ...
    (let uu____8335 =
       let uu____8336 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____8336  in
     if uu____8335
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
         (FStar_Errors.Warning_IDEIgnoreCodeGen, "--ide: ignoring --codegen")
     else ());
    (let uu____8340 = FStar_Options.trace_error ()  in
     if uu____8340
