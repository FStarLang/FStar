...
let set_check_kind:
  ...
  fun env  ->
    fun check_kind  ->
      let uu___264_60 = env in
      let uu____61 =
        FStar_ToSyntax_Env.set_syntax_only env.FStar_TypeChecker_Env.dsenv
          (check_kind = SyntaxCheck) in
      {
        FStar_TypeChecker_Env.solver =
          (uu___264_60.FStar_TypeChecker_Env.solver);
        FStar_TypeChecker_Env.range =
          (uu___264_60.FStar_TypeChecker_Env.range);
        FStar_TypeChecker_Env.curmodule =
          (uu___264_60.FStar_TypeChecker_Env.curmodule);
        FStar_TypeChecker_Env.gamma =
          (uu___264_60.FStar_TypeChecker_Env.gamma);
        FStar_TypeChecker_Env.gamma_cache =
          (uu___264_60.FStar_TypeChecker_Env.gamma_cache);
        FStar_TypeChecker_Env.modules =
          (uu___264_60.FStar_TypeChecker_Env.modules);
        FStar_TypeChecker_Env.expected_typ =
          (uu___264_60.FStar_TypeChecker_Env.expected_typ);
        FStar_TypeChecker_Env.sigtab =
          (uu___264_60.FStar_TypeChecker_Env.sigtab);
        FStar_TypeChecker_Env.is_pattern =
          (uu___264_60.FStar_TypeChecker_Env.is_pattern);
        FStar_TypeChecker_Env.instantiate_imp =
          (uu___264_60.FStar_TypeChecker_Env.instantiate_imp);
        FStar_TypeChecker_Env.effects =
          (uu___264_60.FStar_TypeChecker_Env.effects);
        FStar_TypeChecker_Env.generalize =
          (uu___264_60.FStar_TypeChecker_Env.generalize);
        FStar_TypeChecker_Env.letrecs =
          (uu___264_60.FStar_TypeChecker_Env.letrecs);
        FStar_TypeChecker_Env.top_level =
          (uu___264_60.FStar_TypeChecker_Env.top_level);
        FStar_TypeChecker_Env.check_uvars =
          (uu___264_60.FStar_TypeChecker_Env.check_uvars);
        FStar_TypeChecker_Env.use_eq =
          (uu___264_60.FStar_TypeChecker_Env.use_eq);
        FStar_TypeChecker_Env.is_iface =
          (uu___264_60.FStar_TypeChecker_Env.is_iface);
        FStar_TypeChecker_Env.admit =
          (uu___264_60.FStar_TypeChecker_Env.admit);
        FStar_TypeChecker_Env.lax = (check_kind = LaxCheck);
        FStar_TypeChecker_Env.lax_universes =
          (uu___264_60.FStar_TypeChecker_Env.lax_universes);
        FStar_TypeChecker_Env.failhard =
          (uu___264_60.FStar_TypeChecker_Env.failhard);
        FStar_TypeChecker_Env.nosynth =
          (uu___264_60.FStar_TypeChecker_Env.nosynth);
        FStar_TypeChecker_Env.tc_term =
          (uu___264_60.FStar_TypeChecker_Env.tc_term);
        FStar_TypeChecker_Env.type_of =
          (uu___264_60.FStar_TypeChecker_Env.type_of);
        FStar_TypeChecker_Env.universe_of =
          (uu___264_60.FStar_TypeChecker_Env.universe_of);
        FStar_TypeChecker_Env.use_bv_sorts =
          (uu___264_60.FStar_TypeChecker_Env.use_bv_sorts);
        FStar_TypeChecker_Env.qname_and_index =
          (uu___264_60.FStar_TypeChecker_Env.qname_and_index);
        FStar_TypeChecker_Env.proof_ns =
          (uu___264_60.FStar_TypeChecker_Env.proof_ns);
        FStar_TypeChecker_Env.synth =
          (uu___264_60.FStar_TypeChecker_Env.synth);
        FStar_TypeChecker_Env.is_native_tactic =
          (uu___264_60.FStar_TypeChecker_Env.is_native_tactic);
        FStar_TypeChecker_Env.identifier_info =
          (uu___264_60.FStar_TypeChecker_Env.identifier_info);
        FStar_TypeChecker_Env.tc_hooks =
          (uu___264_60.FStar_TypeChecker_Env.tc_hooks);
...
let commit_name_tracking:
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___267_1255 = st in
      {
        repl_line = (uu___267_1255.repl_line);
        repl_column = (uu___267_1255.repl_column);
        repl_fname = (uu___267_1255.repl_fname);
        repl_deps_stack = (uu___267_1255.repl_deps_stack);
        repl_curmod = (uu___267_1255.repl_curmod);
        repl_env = (uu___267_1255.repl_env);
        repl_stdin = (uu___267_1255.repl_stdin);
        repl_names = names1
      }
              ...
              (match uu____1974 with
               | (curmod,env2,success) ->
                   ...
                   (match uu____2040 with
                    | (env',name_events) ->
                        let st1 =
                          let uu___268_2058 = st in
                          {
                            repl_line = (uu___268_2058.repl_line);
                            repl_column = (uu___268_2058.repl_column);
                            repl_fname = (uu___268_2058.repl_fname);
                            repl_deps_stack = (uu___268_2058.repl_deps_stack);
                            repl_curmod = curmod;
                            repl_env = env2;
                            repl_stdin = (uu___268_2058.repl_stdin);
                            repl_names = (uu___268_2058.repl_names)
                          } in
                        let st2 =
                          if success
...
let run_repl_ld_transactions:
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___251_2099 =
        match uu___251_2099 with
        | [] -> st1
        | (task,_st')::entries ->
            ...
            (debug1 "Loading" task;
             ...
             (let timestamped_task = update_task_timestamps task in
              ...
              | (success,st2) ->
                  ...
                  then
                    let uu____2191 =
                      let uu___269_2192 = st2 in
                      let uu____2193 = FStar_ST.op_Bang repl_stack in
                      {
                        repl_line = (uu___269_2192.repl_line);
                        repl_column = (uu___269_2192.repl_column);
                        repl_fname = (uu___269_2192.repl_fname);
                        repl_deps_stack = uu____2193;
                        repl_curmod = (uu___269_2192.repl_curmod);
                        repl_env = (uu___269_2192.repl_env);
                        repl_stdin = (uu___269_2192.repl_stdin);
                        repl_names = (uu___269_2192.repl_names)
                      } in
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___253_2362  ->
    match uu___253_2362 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___254_2368  ->
    match uu___254_2368 with
...
let update_option: fstar_option -> fstar_option =
  fun opt  ->
    let uu___274_4401 = opt in
    let uu____4402 = FStar_Options.get_option opt.opt_name in
    {
      opt_name = (uu___274_4401.opt_name);
      opt_sig = (uu___274_4401.opt_sig);
      opt_value = uu____4402;
      opt_default = (uu___274_4401.opt_default);
      opt_type = (uu___274_4401.opt_type);
      opt_snippets = (uu___274_4401.opt_snippets);
      opt_documentation = (uu___274_4401.opt_documentation);
      opt_permission_level = (uu___274_4401.opt_permission_level)
    }
...
let rephrase_dependency_error: FStar_Errors.issue -> FStar_Errors.issue =
  fun issue  ->
    let uu___275_5142 = issue in
    let uu____5143 =
      FStar_Util.format1 "Error while computing or loading dependencies:\n%s"
        issue.FStar_Errors.issue_message in
    {
      FStar_Errors.issue_message = uu____5143;
      FStar_Errors.issue_level = (uu___275_5142.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___275_5142.FStar_Errors.issue_range)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___276_5178 = st1 in
        {
          repl_line = (uu___276_5178.repl_line);
          repl_column = (uu___276_5178.repl_column);
          repl_fname = (uu___276_5178.repl_fname);
          repl_deps_stack = (uu___276_5178.repl_deps_stack);
          repl_curmod = (uu___276_5178.repl_curmod);
          repl_env =
            (let uu___277_5180 = st1.repl_env in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___277_5180.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___277_5180.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___277_5180.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___277_5180.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___277_5180.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___277_5180.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___277_5180.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___277_5180.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___277_5180.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___277_5180.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___277_5180.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___277_5180.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___277_5180.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___277_5180.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___277_5180.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___277_5180.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___277_5180.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___277_5180.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___277_5180.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___277_5180.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___277_5180.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___277_5180.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___277_5180.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___277_5180.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___277_5180.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qname_and_index =
                 (uu___277_5180.FStar_TypeChecker_Env.qname_and_index);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___277_5180.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth =
                 (uu___277_5180.FStar_TypeChecker_Env.synth);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___277_5180.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___277_5180.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___277_5180.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___277_5180.FStar_TypeChecker_Env.dsenv)
             });
          repl_stdin = (uu___276_5178.repl_stdin);
          repl_names = (uu___276_5178.repl_names)
        } in
           ...
           (let st1 = set_nosynth_flag st peek_only in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___278_5236 = st3 in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___278_5236.repl_fname);
                      repl_deps_stack = (uu___278_5236.repl_deps_stack);
                      repl_curmod = (uu___278_5236.repl_curmod);
                      repl_env = (uu___278_5236.repl_env);
                      repl_stdin = (uu___278_5236.repl_stdin);
                      repl_names = (uu___278_5236.repl_names)
                    }
                  else st3 in
           ...
           ((let uu____5424 = FStar_Options.restore_cmd_line_options false in
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___279_5427 = st1 in
                {
                  repl_line = (uu___279_5427.repl_line);
                  repl_column = (uu___279_5427.repl_column);
                  repl_fname = (uu___279_5427.repl_fname);
                  repl_deps_stack = (uu___279_5427.repl_deps_stack);
                  repl_curmod = (uu___279_5427.repl_curmod);
                  repl_env = (uu___279_5427.repl_env);
                  repl_stdin = (uu___279_5427.repl_stdin);
                  repl_names = names1
                }) query)))
let run_push:
  'Auu____5434 .
            ...
            let uu____6805 =
                ...
                Prims.strcat uu____6808 "." in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___280_6806.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___280_6806.FStar_Interactive_CompletionTable.mod_loaded)
              } in
