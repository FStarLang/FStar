...
let (unpack_interactive_query : FStar_Compiler_Util.json -> query) =
  fun json ->
    ...
    let request =
      FStar_Compiler_Effect.pipe_right json
               ...
               | "peek" ->
                   let uu___2 =
                     let uu___3 =
                       ...
                       FStar_Compiler_Effect.pipe_right uu___4 js_pushkind in
                     let uu___4 =
...
let (fstar_options_list_cache : fstar_option Prims.list) =
  ...
  let uu___ =
    FStar_Compiler_Effect.pipe_right FStar_Options.all_specs_with_types
    ...
    fun query1 ->
      ...
      (let uu___2 = load_deps st in
       ...
       | FStar_Pervasives.Inr st1 ->
           ...
           let js_errors =
             FStar_Compiler_Effect.pipe_right errors
               (FStar_Compiler_List.map json_of_issue) in
       ...
       | FStar_Pervasives.Inl (st1, deps) ->
           ((let uu___4 = FStar_Options.restore_cmd_line_options false in
             FStar_Compiler_Effect.pipe_right uu___4 (fun uu___5 -> ()));
            (let names =
    ...
    fun is_reset ->
      fun opt ->
        ...
        | (may_set, explanation) ->
            ...
            FStar_Compiler_Effect.pipe_right opt.opt_snippets
              (FStar_Compiler_List.map
                 (fun snippet ->
                    {
