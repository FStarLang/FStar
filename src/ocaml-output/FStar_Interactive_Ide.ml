...
let (commit_name_tracking :
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___446_1392 = st  in
      {
        repl_line = (uu___446_1392.repl_line);
        repl_column = (uu___446_1392.repl_column);
        repl_fname = (uu___446_1392.repl_fname);
        repl_deps_stack = (uu___446_1392.repl_deps_stack);
        repl_curmod = (uu___446_1392.repl_curmod);
        repl_env = (uu___446_1392.repl_env);
        repl_stdin = (uu___446_1392.repl_stdin);
        repl_names = names1
      }
                   ...
                   (match uu____2228 with
                    | (env2,name_events) ->
                        let st2 =
                          ...
                          then
                            let st2 =
                              let uu___447_2247 = st1  in
                              {
                                repl_line = (uu___447_2247.repl_line);
                                repl_column = (uu___447_2247.repl_column);
                                repl_fname = (uu___447_2247.repl_fname);
                                repl_deps_stack =
                                  (uu___447_2247.repl_deps_stack);
                                repl_curmod = curmod;
                                repl_env = env2;
                                repl_stdin = (uu___447_2247.repl_stdin);
                                repl_names = (uu___447_2247.repl_names)
                              }  in
  ...
  fun st  ->
    fun tasks  ->
      fun progress_callback  ->
        ...
        let rec revert_many st1 uu___429_2311 =
          match uu___429_2311 with
          | [] -> st1
          ...
          | (task::tasks2,[]) ->
              (debug1 "Loading" task;
               ...
               (let uu____2411 = FStar_Options.restore_cmd_line_options false
                   in
                FStar_All.pipe_right uu____2411 (fun a236  -> ()));
               (let timestamped_task = update_task_timestamps task  in
                ...
                | (success,st2) ->
                    ...
                    then
                      let uu____2431 =
                        let uu___448_2432 = st2  in
                        let uu____2433 = FStar_ST.op_Bang repl_stack  in
                        {
                          repl_line = (uu___448_2432.repl_line);
                          repl_column = (uu___448_2432.repl_column);
                          repl_fname = (uu___448_2432.repl_fname);
                          repl_deps_stack = uu____2433;
                          repl_curmod = (uu___448_2432.repl_curmod);
                          repl_env = (uu___448_2432.repl_env);
                          repl_stdin = (uu___448_2432.repl_stdin);
                          repl_names = (uu___448_2432.repl_names)
                        }  in
...
let (js_int : FStar_Util.json -> Prims.int) =
  fun uu___431_2580  ->
    match uu___431_2580 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let (js_str : FStar_Util.json -> Prims.string) =
  fun uu___432_2587  ->
    match uu___432_2587 with
...
let (update_option : fstar_option -> fstar_option) =
  fun opt  ->
    let uu___453_4740 = opt  in
    let uu____4741 = FStar_Options.get_option opt.opt_name  in
    {
      opt_name = (uu___453_4740.opt_name);
      opt_sig = (uu___453_4740.opt_sig);
      opt_value = uu____4741;
      opt_default = (uu___453_4740.opt_default);
      opt_type = (uu___453_4740.opt_type);
      opt_snippets = (uu___453_4740.opt_snippets);
      opt_documentation = (uu___453_4740.opt_documentation);
      opt_permission_level = (uu___453_4740.opt_permission_level)
    }
  
let (current_fstar_options :
  (fstar_option -> Prims.bool) -> fstar_option Prims.list) =
  fun filter1  ->
    let uu____4754 = FStar_List.filter filter1 fstar_options_list_cache  in
    FStar_List.map update_option uu____4754
    ...
    then
      let uu____4771 =
        FStar_Util.substring_from opt_name (FStar_String.length opt_prefix)
         in
      (opt_prefix, uu____4771)
    else ("", opt_name)
  
let (json_of_repl_state : repl_state -> FStar_Util.json) =
  fun st  ->
    let filenames uu____4793 =
      match uu____4793 with
      | (uu____4804,(task,uu____4806)) ->
          (match task with
        ...
        let uu____4830 =
          let uu____4831 =
            ...
            FStar_List.map (fun _0_25  -> FStar_Util.JsonStr _0_25)
              uu____4834
             in
          FStar_Util.JsonList uu____4831  in
        ("loaded-dependencies", uu____4830)  in
      let uu____4845 =
        let uu____4852 =
          let uu____4857 =
            let uu____4858 =
              let uu____4861 =
                current_fstar_options (fun uu____4866  -> true)  in
              FStar_List.map json_of_fstar_option uu____4861  in
            FStar_Util.JsonList uu____4858  in
          ("options", uu____4857)  in
        [uu____4852]  in
      uu____4825 :: uu____4845  in
    FStar_Util.JsonAssoc uu____4818
  
let with_printed_effect_args :
  'Auu____4883 . (unit -> 'Auu____4883) -> 'Auu____4883 =
  fun k  ->
...
let (sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string) =
  fun se  ->
    with_printed_effect_args
      (fun uu____4916  -> FStar_Syntax_Print.sigelt_to_string se)
  
let run_exit :
  'Auu____4923 'Auu____4924 .
    'Auu____4923 ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        ('Auu____4924,Prims.int) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
...
let run_describe_protocol :
  'Auu____4956 'Auu____4957 .
    'Auu____4956 ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        ('Auu____4956,'Auu____4957) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
...
let run_describe_repl :
  'Auu____4987 .
    repl_state ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        (repl_state,'Auu____4987) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    let uu____5005 =
      let uu____5010 = json_of_repl_state st  in (QueryOK, uu____5010)  in
    (uu____5005, (FStar_Util.Inl st))
  
let run_protocol_violation :
  'Auu____5027 'Auu____5028 .
    'Auu____5027 ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          ('Auu____5027,'Auu____5028) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun message  ->
...
let run_generic_error :
  'Auu____5067 'Auu____5068 .
    'Auu____5067 ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          ('Auu____5067,'Auu____5068) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun message  ->
...
let run_segment :
  'Auu____5116 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____5116) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun code  ->
      ...
      let collect_decls uu____5147 =
        let uu____5148 = FStar_Parser_Driver.parse_fragment frag  in
        match uu____5148 with
        | FStar_Parser_Driver.Empty  -> []
        | FStar_Parser_Driver.Decls decls -> decls
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Module
            (uu____5154,decls)) -> decls
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____5160,decls,uu____5162)) -> decls
         in
      let uu____5167 =
        with_captured_errors st.repl_env FStar_Util.sigint_ignore
          (fun uu____5176  ->
             let uu____5177 = collect_decls ()  in
             FStar_All.pipe_left
               (fun _0_26  -> FStar_Pervasives_Native.Some _0_26) uu____5177)
         in
      match uu____5167 with
      | FStar_Pervasives_Native.None  ->
          let errors =
            let uu____5205 = collect_errors ()  in
            FStar_All.pipe_right uu____5205 (FStar_List.map json_of_issue)
             in
              ...
              let uu____5238 =
                let uu____5243 =
                  FStar_Range.json_of_def_range
                   ...
                   in
                ("def_range", uu____5243)  in
              [uu____5238]  in
            FStar_Util.JsonAssoc uu____5231  in
          let js_decls =
            let uu____5253 = FStar_List.map json_of_decl decls  in
  ...
  'Auu____5282 .
    repl_state ->
      Prims.string FStar_Pervasives_Native.option ->
        Prims.string ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____5282) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun opt_fname  ->
...
let run_pop :
  'Auu____5328 .
    repl_state ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        (repl_state,'Auu____5328) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    let uu____5346 = nothing_left_to_pop st  in
    if uu____5346
    then
...
let (write_progress :
  ...
  fun stage  ->
    fun contents_alist  ->
      ...
      write_json uu____5416
  
let (write_repl_ld_task_progress : repl_task -> unit) =
  fun task  ->
    match task with
    | LDInterleaved (uu____5422,tf) ->
...
let (load_deps :
  ...
  fun st  ->
    let uu____5469 =
      with_captured_errors st.repl_env FStar_Util.sigint_ignore
        (fun _env  ->
           let uu____5495 = deps_and_repl_ld_tasks_of_our_file st.repl_fname
              in
           FStar_All.pipe_left
             (fun _0_28  -> FStar_Pervasives_Native.Some _0_28) uu____5495)
       in
    match uu____5469 with
    | FStar_Pervasives_Native.None  -> FStar_Util.Inr st
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___454_5586 = st  in
          let uu____5587 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1  in
          {
            repl_line = (uu___454_5586.repl_line);
            repl_column = (uu___454_5586.repl_column);
            repl_fname = (uu___454_5586.repl_fname);
            repl_deps_stack = (uu___454_5586.repl_deps_stack);
            repl_curmod = (uu___454_5586.repl_curmod);
            repl_env = uu____5587;
            repl_stdin = (uu___454_5586.repl_stdin);
            repl_names = (uu___454_5586.repl_names)
          }  in
        let uu____5588 =
...
let (rephrase_dependency_error : FStar_Errors.issue -> FStar_Errors.issue) =
  fun issue  ->
    let uu___455_5634 = issue  in
    let uu____5635 =
      FStar_Util.format1 "Error while computing or loading dependencies:\n%s"
        issue.FStar_Errors.issue_message
       in
    {
      FStar_Errors.issue_message = uu____5635;
      FStar_Errors.issue_level = (uu___455_5634.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___455_5634.FStar_Errors.issue_range);
      FStar_Errors.issue_number = (uu___455_5634.FStar_Errors.issue_number)
    }
...
let run_push_without_deps :
  'Auu____5642 .
    repl_state ->
      push_query ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____5642) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___456_5676 = st1  in
        {
          repl_line = (uu___456_5676.repl_line);
          repl_column = (uu___456_5676.repl_column);
          repl_fname = (uu___456_5676.repl_fname);
          repl_deps_stack = (uu___456_5676.repl_deps_stack);
          repl_curmod = (uu___456_5676.repl_curmod);
          repl_env =
            (let uu___457_5678 = st1.repl_env  in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___457_5678.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___457_5678.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___457_5678.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___457_5678.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_sig =
                 (uu___457_5678.FStar_TypeChecker_Env.gamma_sig);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___457_5678.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___457_5678.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___457_5678.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___457_5678.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.attrtab =
                 (uu___457_5678.FStar_TypeChecker_Env.attrtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___457_5678.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___457_5678.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___457_5678.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___457_5678.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___457_5678.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___457_5678.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___457_5678.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___457_5678.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___457_5678.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___457_5678.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___457_5678.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___457_5678.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.phase1 =
                 (uu___457_5678.FStar_TypeChecker_Env.phase1);
               FStar_TypeChecker_Env.failhard =
                 (uu___457_5678.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.uvar_subtyping =
                 (uu___457_5678.FStar_TypeChecker_Env.uvar_subtyping);
               FStar_TypeChecker_Env.tc_term =
                 (uu___457_5678.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___457_5678.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___457_5678.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.check_type_of =
                 (uu___457_5678.FStar_TypeChecker_Env.check_type_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___457_5678.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qtbl_name_and_index =
                 (uu___457_5678.FStar_TypeChecker_Env.qtbl_name_and_index);
               FStar_TypeChecker_Env.normalized_eff_names =
                 (uu___457_5678.FStar_TypeChecker_Env.normalized_eff_names);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___457_5678.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth_hook =
                 (uu___457_5678.FStar_TypeChecker_Env.synth_hook);
               FStar_TypeChecker_Env.splice =
                 (uu___457_5678.FStar_TypeChecker_Env.splice);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___457_5678.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___457_5678.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___457_5678.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___457_5678.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___457_5678.FStar_TypeChecker_Env.dep_graph);
               FStar_TypeChecker_Env.nbe =
                 (uu___457_5678.FStar_TypeChecker_Env.nbe)
             });
          repl_stdin = (uu___456_5676.repl_stdin);
          repl_names = (uu___456_5676.repl_names)
        }  in
      let uu____5679 = query  in
          ...
          (FStar_TypeChecker_Env.toggle_id_info st.repl_env true;
           (let st1 = set_nosynth_flag st peek_only  in
            ...
            | (success,st2) ->
                ...
                let json_errors =
                  let uu____5723 =
                    let uu____5726 = collect_errors ()  in
                    FStar_All.pipe_right uu____5726
                      (FStar_List.map json_of_issue)
                     in
                  FStar_Util.JsonList uu____5723  in
                let st4 =
                  if success
                  then
                    let uu___458_5734 = st3  in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___458_5734.repl_fname);
                      repl_deps_stack = (uu___458_5734.repl_deps_stack);
                      repl_curmod = (uu___458_5734.repl_curmod);
                      repl_env = (uu___458_5734.repl_env);
                      repl_stdin = (uu___458_5734.repl_stdin);
                      repl_names = (uu___458_5734.repl_names)
                    }
                  else st3  in
      ...
      (let first =
       ...
       let uu____5751 =
         FStar_String.substring str (Prims.parse_int "1")
          ...
          in
       Prims.strcat (FStar_String.uppercase first) uu____5751)
  ...
  fun this_fname  ->
    fun deps  ->
      fun table  ->
        ...
        let loaded_mods_set =
          let uu____5781 = FStar_Util.psmap_empty ()  in
          let uu____5784 =
            let uu____5787 = FStar_Options.prims ()  in uu____5787 :: deps
             in
          FStar_List.fold_left
            (fun acc  ->
               fun dep1  ->
                 let uu____5797 = FStar_Parser_Dep.lowercase_module_name dep1
                    in
                 FStar_Util.psmap_add acc uu____5797 true) uu____5781
            uu____5784
           in
        let loaded modname =
             ...
             fun uu____5815  ->
               ...
               | (modname,mod_path) ->
                   ...
                   then table1
                     ...
                     (let ns_query =
                        let uu____5827 = capitalize modname  in
                        FStar_Util.split uu____5827 "."  in
                      let uu____5828 = loaded mod_key  in
                      FStar_Interactive_CompletionTable.register_module_path
                        table1 uu____5828 mod_path ns_query)) table
          (FStar_List.rev mods)
...
let run_push_with_deps :
  'Auu____5839 .
    repl_state ->
      push_query ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____5839) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun query  ->
      (let uu____5863 = FStar_Options.debug_any ()  in
       if uu____5863
       then FStar_Util.print_string "Reloading dependencies"
       else ());
      FStar_TypeChecker_Env.toggle_id_info st.repl_env false;
      (let uu____5866 = load_deps st  in
       match uu____5866 with
       | FStar_Util.Inr st1 ->
           let errors =
             let uu____5899 = collect_errors ()  in
             FStar_List.map rephrase_dependency_error uu____5899  in
           let js_errors =
             FStar_All.pipe_right errors (FStar_List.map json_of_issue)  in
           ((QueryNOK, (FStar_Util.JsonList js_errors)),
             (FStar_Util.Inl st1))
       | FStar_Util.Inl (st1,deps) ->
           ((let uu____5930 = FStar_Options.restore_cmd_line_options false
                in
             FStar_All.pipe_right uu____5930 (fun a237  -> ()));
            (let names1 =
               add_module_completions st1.repl_fname deps st1.repl_names  in
             run_push_without_deps
               (let uu___459_5933 = st1  in
                {
                  repl_line = (uu___459_5933.repl_line);
                  repl_column = (uu___459_5933.repl_column);
                  repl_fname = (uu___459_5933.repl_fname);
                  repl_deps_stack = (uu___459_5933.repl_deps_stack);
                  repl_curmod = (uu___459_5933.repl_curmod);
                  repl_env = (uu___459_5933.repl_env);
                  repl_stdin = (uu___459_5933.repl_stdin);
                  repl_names = names1
                }) query)))
...
let run_push :
  'Auu____5940 .
    repl_state ->
      push_query ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____5940) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun query  ->
      let uu____5963 = nothing_left_to_pop st  in
      if uu____5963
      ...
      fun pos_opt  ->
        fun requested_info  ->
            ...
            let lid =
              let uu____6051 =
                FStar_List.map FStar_Ident.id_of_text
                 ...
                 in
              FStar_Ident.lid_of_ids uu____6051  in
            let lid1 =
              let uu____6055 =
                FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                  tcenv.FStar_TypeChecker_Env.dsenv lid
                 in
              FStar_All.pipe_left (FStar_Util.dflt lid) uu____6055  in
            let uu____6060 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1
               in
            FStar_All.pipe_right uu____6060
              (FStar_Util.map_option
                 (fun uu____6115  ->
                    match uu____6115 with
                    | ((uu____6134,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
             in
          let docs_of_lid lid =
            let uu____6153 =
            ...
            FStar_All.pipe_right uu____6153
             ...
             in
          let def_of_lid lid =
            let uu____6204 = FStar_TypeChecker_Env.lookup_qname tcenv lid  in
            FStar_Util.bind_opt uu____6204
              (fun uu___439_6248  ->
                 match uu___439_6248 with
                 | (FStar_Util.Inr (se,uu____6270),uu____6271) ->
                     let uu____6300 = sigelt_to_string se  in
          ...
          let info_opt =
            ...
            | FStar_Pervasives_Native.Some uu____6400 -> info_at_pos_opt
            | FStar_Pervasives_Native.None  ->
                if symbol = ""
                then FStar_Pervasives_Native.None
          ...
          let response =
            ...
            | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                ...
                let typ_str =
                  ...
                  then
                    let uu____6528 = term_to_string tcenv typ  in
                ...
                let doc_str =
                  ...
                  | FStar_Util.Inr lid when
                      ...
                      docs_of_lid lid
                  | uu____6536 -> FStar_Pervasives_Native.None  in
                let def_str =
                  match name_or_lid with
                  | FStar_Util.Inr lid when
                      FStar_List.mem "definition" requested_info ->
                      def_of_lid lid
                  | uu____6547 -> FStar_Pervasives_Native.None  in
                let def_range1 =
                ...
                let uu____6559 =
                  let uu____6570 = alist_of_symbol_lookup_result result  in
                  ("symbol", uu____6570)  in
...
let (run_option_lookup :
  ...
  =
  fun opt_name  ->
    let uu____6677 = trim_option_name opt_name  in
    match uu____6677 with
    | (uu____6696,trimmed_name) ->
        let uu____6698 =
        ...
        (match uu____6698 with
         ...
         | FStar_Pervasives_Native.Some opt ->
             let uu____6726 =
               let uu____6737 =
                 let uu____6744 = update_option opt  in
                 alist_of_fstar_option uu____6744  in
               ("option", uu____6737)  in
          ...
          let uu____6816 =
            let uu____6827 =
              FStar_Interactive_CompletionTable.alist_of_mod_info mod_info
               in
            ("module", uu____6827)  in
          FStar_Util.Inr uu____6816
      | FStar_Pervasives_Native.Some
          (FStar_Interactive_CompletionTable.Namespace ns_info) ->
          let uu____6851 =
            let uu____6862 =
              FStar_Interactive_CompletionTable.alist_of_ns_info ns_info  in
            ("namespace", uu____6862)  in
          FStar_Util.Inr uu____6851
...
let (run_code_lookup :
  ...
  fun st  ->
    fun symbol  ->
      fun pos_opt  ->
        fun requested_info  ->
          let uu____6939 = run_symbol_lookup st symbol pos_opt requested_info
             in
          match uu____6939 with
          | FStar_Util.Inr alist -> FStar_Util.Inr alist
          | FStar_Util.Inl uu____6999 ->
              let uu____7010 = run_module_lookup st symbol  in
      ...
      Prims.string ->
        lookup_context ->
          (Prims.string,Prims.int,Prims.int) FStar_Pervasives_Native.tuple3
            ...
            Prims.string Prims.list ->
              ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
                (repl_state,'Auu____7176) FStar_Util.either)
                FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun symbol  ->
...
let code_autocomplete_mod_filter :
  'Auu____7320 .
    ('Auu____7320,FStar_Interactive_CompletionTable.mod_symbol)
      FStar_Pervasives_Native.tuple2 ->
      ('Auu____7320,FStar_Interactive_CompletionTable.mod_symbol)
        FStar_Pervasives_Native.tuple2 FStar_Pervasives_Native.option
  =
  fun uu___440_7335  ->
    match uu___440_7335 with
    | (uu____7340,FStar_Interactive_CompletionTable.Namespace uu____7341) ->
        FStar_Pervasives_Native.None
    | (uu____7346,FStar_Interactive_CompletionTable.Module
       { FStar_Interactive_CompletionTable.mod_name = uu____7347;
         FStar_Interactive_CompletionTable.mod_path = uu____7348;
    ...
    | (pth,FStar_Interactive_CompletionTable.Module md) ->
        let uu____7355 =
          let uu____7360 =
            let uu____7361 =
              let uu___460_7362 = md  in
              let uu____7363 =
                let uu____7364 =
                  FStar_Interactive_CompletionTable.mod_name md  in
                Prims.strcat uu____7364 "."  in
              {
                FStar_Interactive_CompletionTable.mod_name = uu____7363;
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___460_7362.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___460_7362.FStar_Interactive_CompletionTable.mod_loaded)
              }  in
            FStar_Interactive_CompletionTable.Module uu____7361  in
          (pth, uu____7360)  in
        FStar_Pervasives_Native.Some uu____7355
...
let run_code_autocomplete :
  'Auu____7375 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____7375) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_term  ->
...
let run_module_autocomplete :
  'Auu____7432 'Auu____7433 'Auu____7434 .
    repl_state ->
      Prims.string ->
        'Auu____7432 ->
          'Auu____7433 ->
            ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
              (repl_state,'Auu____7434) FStar_Util.either)
              FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_term  ->
...
let run_option_autocomplete :
  'Auu____7537 'Auu____7538 .
    'Auu____7537 ->
      Prims.string ->
        Prims.bool ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            ('Auu____7537,'Auu____7538) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_term  ->
      fun is_reset  ->
        let uu____7566 = trim_option_name search_term  in
  ...
  'Auu____7639 .
    repl_state ->
      Prims.string ->
        completion_context ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____7639) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_term  ->
...
let run_and_rewind :
  'Auu____7680 'Auu____7681 .
    repl_state ->
      'Auu____7680 ->
        (repl_state -> 'Auu____7680) ->
          ('Auu____7680,(repl_state,'Auu____7681) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun sigint_default  ->
            ...
            (fun uu___462_7721  ->
               ...
               | () ->
                   FStar_Util.with_sigint_handler FStar_Util.sigint_raise
                     (fun uu____7732  ->
                        let uu____7733 = task st1  in
                        FStar_All.pipe_left
                          (fun _0_30  -> FStar_Util.Inl _0_30) uu____7733))
              ()
...
let run_with_parsed_and_tc_term :
  'Auu____7784 'Auu____7785 'Auu____7786 .
    repl_state ->
      Prims.string ->
        'Auu____7784 ->
          'Auu____7785 ->
            (FStar_TypeChecker_Env.env ->
              ...
              ->
              ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
                (repl_state,'Auu____7786) FStar_Util.either)
                FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____7879,{ FStar_Syntax_Syntax.lbname = uu____7880;
                                   FStar_Syntax_Syntax.lbunivs = univs1;
                                   FStar_Syntax_Syntax.lbtyp = uu____7882;
                                   FStar_Syntax_Syntax.lbeff = uu____7883;
                                   FStar_Syntax_Syntax.lbdef = def;
                                   FStar_Syntax_Syntax.lbattrs = uu____7885;
                                   FStar_Syntax_Syntax.lbpos = uu____7886;_}::[]),uu____7887);
                  FStar_Syntax_Syntax.sigrng = uu____7888;
                  FStar_Syntax_Syntax.sigquals = uu____7889;
                  FStar_Syntax_Syntax.sigmeta = uu____7890;
                  FStar_Syntax_Syntax.sigattrs = uu____7891;_}::[] ->
                  FStar_Pervasives_Native.Some (univs1, def)
              | uu____7928 -> FStar_Pervasives_Native.None  in
            let parse1 frag =
              let uu____7949 =
              ...
              | FStar_Parser_ParseIt.ASTFragment
                  (FStar_Util.Inr decls,uu____7955) ->
                  FStar_Pervasives_Native.Some decls
              | uu____7974 -> FStar_Pervasives_Native.None  in
            let desugar env decls =
              let uu____7992 =
                let uu____7997 =
                  FStar_ToSyntax_ToSyntax.decls_to_sigelts decls  in
                uu____7997 env.FStar_TypeChecker_Env.dsenv  in
              FStar_Pervasives_Native.fst uu____7992  in
            let typecheck tcenv decls =
              let uu____8021 = FStar_TypeChecker_Tc.tc_decls tcenv decls  in
              match uu____8021 with | (ses,uu____8035,uu____8036) -> ses  in
            run_and_rewind st
              (QueryNOK, (FStar_Util.JsonStr "Computation interrupted"))
              (fun st1  ->
                 let tcenv = st1.repl_env  in
                 let frag = dummy_let_fragment term  in
                 let uu____8056 = parse1 frag  in
                 ...
                 | FStar_Pervasives_Native.Some decls ->
                     let aux uu____8081 =
                       ...
                       | FStar_Pervasives_Native.Some (univs1,def) ->
                        ...
                        in
                     let uu____8128 = FStar_Options.trace_error ()  in
                     if uu____8128
                     then aux ()
                     else
                       (try
                          (fun uu___464_8139  -> match () with | () -> aux ())
                            ()
                        with
                        | uu___463_8148 ->
                            let uu____8153 =
                              FStar_Errors.issue_of_exn uu___463_8148  in
                            (match uu____8153 with
                             | FStar_Pervasives_Native.Some issue ->
                                 let uu____8161 =
                                   let uu____8162 =
                                     FStar_Errors.format_issue issue  in
                                   FStar_Util.JsonStr uu____8162  in
                                 (QueryNOK, uu____8161)
                             | FStar_Pervasives_Native.None  ->
                                 FStar_Exn.raise uu___463_8148)))
    ...
    repl_state ->
      Prims.string ->
        FStar_TypeChecker_Env.step Prims.list FStar_Pervasives_Native.option
          ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____8175) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
        ...
        run_with_parsed_and_tc_term st term (Prims.parse_int "0")
          ...
          (fun tcenv  ->
             fun def  ->
               ...
               let uu____8245 =
                 let uu____8246 = term_to_string tcenv normalized  in
                 FStar_Util.JsonStr uu____8246  in
               (QueryOK, uu____8245))
...
let (uu___is_NameContainsStr : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____8273 -> false
  
let (__proj__NameContainsStr__item___0 : search_term' -> Prims.string) =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0 
let (uu___is_TypeContainsLid : search_term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____8287 -> false
...
let (sc_of_lid : FStar_Ident.lid -> search_candidate) =
  fun lid  ->
    let uu____8528 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    let uu____8535 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    { sc_lid = lid; sc_typ = uu____8528; sc_fvars = uu____8535 }
  
let (sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ) =
  fun tcenv  ->
    fun sc  ->
      let uu____8602 = FStar_ST.op_Bang sc.sc_typ  in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____8649,typ),uu____8651) ->
                typ
             in
...
let (sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____8700 = FStar_ST.op_Bang sc.sc_fvars  in
      match uu____8700 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____8744 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____8744  in
...
let (json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____8786 = sc_typ tcenv sc  in term_to_string tcenv uu____8786
         in
      let uu____8787 =
        let uu____8794 =
          let uu____8799 =
            let uu____8800 =
              let uu____8801 =
                FStar_Syntax_DsEnv.shorten_lid
                 ...
                 in
              uu____8801.FStar_Ident.str  in
            FStar_Util.JsonStr uu____8800  in
          ("lid", uu____8799)  in
        [uu____8794; ("type", (FStar_Util.JsonStr typ_str))]  in
      FStar_Util.JsonAssoc uu____8787
  
exception InvalidSearch of Prims.string 
let (uu___is_InvalidSearch : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____8823 -> true
    | uu____8824 -> false
  
let (__proj__InvalidSearch__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidSearch uu____8831 -> uu____8831
...
let run_search :
  'Auu____8838 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____8838) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_str  ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____8879 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____8879
           in
              ...
              let uu____8909 =
                let uu____8910 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____8910  in
              FStar_Exn.raise uu____8909
            else
              if beg_quote
              then
                (let uu____8912 = strip_quotes term1  in
                 NameContainsStr uu____8912)
              else
                     ...
                     let uu____8918 =
                       let uu____8919 =
                         FStar_Util.format1 "Unknown identifier: %s" term1
                          in
                       InvalidSearch uu____8919  in
                     FStar_Exn.raise uu____8918
      ...
      let pprint_one term =
        let uu____8941 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.strcat (if term.st_negate then "-" else "") uu____8941  in
      let results =
        try
          (fun uu___466_8965  ->
             match () with
             | () ->
                 ...
                 (match results with
                  | [] ->
                      let kwds =
                        let uu____9010 = FStar_List.map pprint_one terms  in
                        FStar_Util.concat_l " " uu____9010  in
                      let uu____9013 =
                        let uu____9014 =
                          FStar_Util.format1
                            "No results found for query [%s]" kwds
                           in
                        InvalidSearch uu____9014  in
                      FStar_Exn.raise uu____9013
                  | uu____9019 -> (QueryOK, (FStar_Util.JsonList js)))) ()
...
let (validate_query : repl_state -> query -> query) =
  fun st  ->
    fun q  ->
      match q.qq with
      | Push
          { push_kind = SyntaxCheck ; push_code = uu____9117;
            push_line = uu____9118; push_column = uu____9119;
            push_peek_only = false ;_}
          ->
          {
            qq =
...
let (js_repl_eval :
  ...
  fun st  ->
    fun query  ->
      let uu____9187 = validate_and_run_query st query  in
...
let (js_repl_eval_js :
  ...
  fun st  ->
    fun query_js  ->
      let uu____9246 = deserialize_interactive_query query_js  in
      js_repl_eval st uu____9246
...
let (js_repl_eval_str :
  ...
  fun st  ->
    fun query_str  ->
      let uu____9265 =
        let uu____9274 = parse_interactive_query query_str  in
        js_repl_eval st uu____9274  in
      match uu____9265 with
      | (js_response,st_opt) ->
          let uu____9293 = FStar_Util.string_of_json js_response  in
          (uu____9293, st_opt)
  
let (js_repl_init_opts : unit -> unit) =
  fun uu____9302  ->
    let uu____9303 = FStar_Options.parse_cmd_line ()  in
...
let rec (go : repl_state -> Prims.int) =
  fun st  ->
    ...
    let uu____9331 = validate_and_run_query st query  in
...
let (interactive_error_handler : FStar_Errors.error_handler) =
  ...
  let add_one1 e =
    let uu____9375 =
      let uu____9378 = FStar_ST.op_Bang issues  in e :: uu____9378  in
    FStar_ST.op_Colon_Equals issues uu____9375  in
  let count_errors uu____9476 =
    let uu____9477 =
      let uu____9480 = FStar_ST.op_Bang issues  in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____9480
       in
    FStar_List.length uu____9477  in
  let report uu____9537 =
    let uu____9538 = FStar_ST.op_Bang issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____9538  in
  let clear1 uu____9591 = FStar_ST.op_Colon_Equals issues []  in
  {
  ...
  fun printer  ->
    {
      ...
      FStar_Util.printer_prgeneric =
        (fun label  ->
           fun get_string  ->
             fun get_json  ->
               let uu____9669 = get_json ()  in
               forward_message printer label uu____9669)
    }
...
let (initial_range : FStar_Range.range) =
  ...
  let uu____9682 =
    FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0")  in
  FStar_Range.mk_range "<input>" uu____9681 uu____9682 
let (build_initial_repl_state : Prims.string -> repl_state) =
  fun filename  ->
    let env = FStar_Universal.init_env FStar_Parser_Dep.empty_deps  in
    let env1 = FStar_TypeChecker_Env.set_range env initial_range  in
    let uu____9690 = FStar_Util.open_stdin ()  in
    {
      ...
      repl_env = env1;
      repl_stdin = uu____9690;
      repl_names = FStar_Interactive_CompletionTable.empty
    }
  
let interactive_mode' : 'Auu____9703 . repl_state -> 'Auu____9703 =
  fun init_st  ->
    write_hello ();
    (let exit_code =
       let uu____9711 =
       ...
       then
         let uu____9712 =
           let uu____9713 = FStar_Options.file_list ()  in
           FStar_List.hd uu____9713  in
         FStar_SMTEncoding_Solver.with_hints_db uu____9712
           (fun uu____9717  -> go init_st)
       else go init_st  in
...
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    ...
    (let uu____9727 =
       let uu____9728 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____9728  in
     if uu____9727
     then
    ...
    (let init1 = build_initial_repl_state filename  in
     let uu____9733 = FStar_Options.trace_error ()  in
     if uu____9733
