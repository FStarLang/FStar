        ...
        fun st  ->
          ...
          | (depth,env) ->
              ((let uu____995 =
               ...
               (let uu___114_1065 = st  in
                let uu____1066 = set_check_kind env push_kind  in
                {
                  repl_line = (uu___114_1065.repl_line);
                  repl_column = (uu___114_1065.repl_column);
                  repl_fname = (uu___114_1065.repl_fname);
                  repl_deps_stack = (uu___114_1065.repl_deps_stack);
                  repl_curmod = (uu___114_1065.repl_curmod);
                  repl_env = uu____1066;
                  repl_stdin = (uu___114_1065.repl_stdin);
                  repl_names = (uu___114_1065.repl_names)
                }))
...
let (commit_name_tracking :
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___115_1413 = st  in
      {
        repl_line = (uu___115_1413.repl_line);
        repl_column = (uu___115_1413.repl_column);
        repl_fname = (uu___115_1413.repl_fname);
        repl_deps_stack = (uu___115_1413.repl_deps_stack);
        repl_curmod = (uu___115_1413.repl_curmod);
        repl_env = (uu___115_1413.repl_env);
        repl_stdin = (uu___115_1413.repl_stdin);
        repl_names = names1
      }
                   ...
                   (match uu____2257 with
                    | (env2,name_events) ->
                        let st2 =
                          ...
                          then
                            let st2 =
                              let uu___116_2276 = st1  in
                              {
                                repl_line = (uu___116_2276.repl_line);
                                repl_column = (uu___116_2276.repl_column);
                                repl_fname = (uu___116_2276.repl_fname);
                                repl_deps_stack =
                                  (uu___116_2276.repl_deps_stack);
                                repl_curmod = curmod;
                                repl_env = env2;
                                repl_stdin = (uu___116_2276.repl_stdin);
                                repl_names = (uu___116_2276.repl_names)
                              }  in
  ...
  fun st  ->
    fun tasks  ->
      fun progress_callback  ->
        ...
        let rec revert_many st1 uu___98_2340 =
          match uu___98_2340 with
          | [] -> st1
              ...
              (debug1 "Loading" task;
               ...
               (let timestamped_task = update_task_timestamps task  in
                ...
                | (success,st2) ->
                    ...
                    then
                      let uu____2460 =
                        let uu___117_2461 = st2  in
                        let uu____2462 = FStar_ST.op_Bang repl_stack  in
                        {
                          repl_line = (uu___117_2461.repl_line);
                          repl_column = (uu___117_2461.repl_column);
                          repl_fname = (uu___117_2461.repl_fname);
                          repl_deps_stack = uu____2462;
                          repl_curmod = (uu___117_2461.repl_curmod);
                          repl_env = (uu___117_2461.repl_env);
                          repl_stdin = (uu___117_2461.repl_stdin);
                          repl_names = (uu___117_2461.repl_names)
                        }  in
...
let (js_int : FStar_Util.json -> Prims.int) =
  fun uu___100_2613  ->
    match uu___100_2613 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let (js_str : FStar_Util.json -> Prims.string) =
  fun uu___101_2620  ->
    match uu___101_2620 with
...
let (update_option : fstar_option -> fstar_option) =
  fun opt  ->
    let uu___122_4792 = opt  in
    let uu____4793 = FStar_Options.get_option opt.opt_name  in
    {
      opt_name = (uu___122_4792.opt_name);
      opt_sig = (uu___122_4792.opt_sig);
      opt_value = uu____4793;
      opt_default = (uu___122_4792.opt_default);
      opt_type = (uu___122_4792.opt_type);
      opt_snippets = (uu___122_4792.opt_snippets);
      opt_documentation = (uu___122_4792.opt_documentation);
      opt_permission_level = (uu___122_4792.opt_permission_level)
    }
...
let (load_deps :
  ...
  fun st  ->
    ...
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___123_5638 = st  in
          let uu____5639 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1  in
          {
            repl_line = (uu___123_5638.repl_line);
            repl_column = (uu___123_5638.repl_column);
            repl_fname = (uu___123_5638.repl_fname);
            repl_deps_stack = (uu___123_5638.repl_deps_stack);
            repl_curmod = (uu___123_5638.repl_curmod);
            repl_env = uu____5639;
            repl_stdin = (uu___123_5638.repl_stdin);
            repl_names = (uu___123_5638.repl_names)
          }  in
        let uu____5640 =
...
let (rephrase_dependency_error : FStar_Errors.issue -> FStar_Errors.issue) =
  fun issue  ->
       ...
       in
    {
      ...
      FStar_Errors.issue_level = (uu___124_5686.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___124_5686.FStar_Errors.issue_range);
      FStar_Errors.issue_number = (uu___124_5686.FStar_Errors.issue_number)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___125_5728 = st1  in
        {
          repl_line = (uu___125_5728.repl_line);
          repl_column = (uu___125_5728.repl_column);
          repl_fname = (uu___125_5728.repl_fname);
          repl_deps_stack = (uu___125_5728.repl_deps_stack);
          repl_curmod = (uu___125_5728.repl_curmod);
          repl_env =
            (let uu___126_5730 = st1.repl_env  in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___126_5730.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___126_5730.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___126_5730.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___126_5730.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___126_5730.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___126_5730.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___126_5730.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___126_5730.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___126_5730.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___126_5730.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___126_5730.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___126_5730.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___126_5730.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___126_5730.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___126_5730.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___126_5730.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___126_5730.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___126_5730.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___126_5730.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___126_5730.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___126_5730.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___126_5730.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___126_5730.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___126_5730.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.check_type_of =
                 (uu___126_5730.FStar_TypeChecker_Env.check_type_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___126_5730.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qtbl_name_and_index =
                 (uu___126_5730.FStar_TypeChecker_Env.qtbl_name_and_index);
               FStar_TypeChecker_Env.normalized_eff_names =
                 (uu___126_5730.FStar_TypeChecker_Env.normalized_eff_names);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___126_5730.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth_hook =
                 (uu___126_5730.FStar_TypeChecker_Env.synth_hook);
               FStar_TypeChecker_Env.splice =
                 (uu___126_5730.FStar_TypeChecker_Env.splice);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___126_5730.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___126_5730.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___126_5730.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___126_5730.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___126_5730.FStar_TypeChecker_Env.dep_graph)
             });
          repl_stdin = (uu___125_5728.repl_stdin);
          repl_names = (uu___125_5728.repl_names)
        }  in
           ...
           (let st1 = set_nosynth_flag st peek_only  in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___127_5786 = st3  in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___127_5786.repl_fname);
                      repl_deps_stack = (uu___127_5786.repl_deps_stack);
                      repl_curmod = (uu___127_5786.repl_curmod);
                      repl_env = (uu___127_5786.repl_env);
                      repl_stdin = (uu___127_5786.repl_stdin);
                      repl_names = (uu___127_5786.repl_names)
                    }
                  else st3  in
           ...
           ((let uu____5982 = FStar_Options.restore_cmd_line_options false
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___128_5985 = st1  in
                {
                  repl_line = (uu___128_5985.repl_line);
                  repl_column = (uu___128_5985.repl_column);
                  repl_fname = (uu___128_5985.repl_fname);
                  repl_deps_stack = (uu___128_5985.repl_deps_stack);
                  repl_curmod = (uu___128_5985.repl_curmod);
                  repl_env = (uu___128_5985.repl_env);
                  repl_stdin = (uu___128_5985.repl_stdin);
                  repl_names = names1
                }) query)))
            ...
            let uu____7393 =
                ...
                Prims.strcat uu____7396 "."  in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___129_7394.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___129_7394.FStar_Interactive_CompletionTable.mod_loaded)
              }  in
