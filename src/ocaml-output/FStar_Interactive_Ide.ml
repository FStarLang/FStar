...
let json_of_opt :
  'Auu____2208 .
    ('Auu____2208 -> FStar_Util.json) ->
      'Auu____2208 FStar_Pervasives_Native.option -> FStar_Util.json
  =
  fun json_of_a  ->
    fun opt_a  ->
...
let forward_message :
  'Auu____3292 .
    (FStar_Util.json -> 'Auu____3292) ->
      Prims.string -> FStar_Util.json -> 'Auu____3292
  =
  fun callback  ->
    fun level  ->
      fun contents  ->
...
let run_exit :
  'Auu____3682 'Auu____3683 .
    'Auu____3682 ->
      ((query_status * FStar_Util.json) * ('Auu____3683,Prims.int)
        FStar_Util.either)
  =
  fun st  ->
...
let run_describe_protocol :
  'Auu____3720 'Auu____3721 .
    'Auu____3720 ->
      ((query_status * FStar_Util.json) * ('Auu____3720,'Auu____3721)
        FStar_Util.either)
  =
  fun st  ->
  ...
  'Auu____3752 .
    FStar_Interactive_JsonHelper.repl_state ->
      ((query_status * FStar_Util.json) *
        (FStar_Interactive_JsonHelper.repl_state,'Auu____3752)
        FStar_Util.either)
  =
  fun st  ->
    let uu____3770 =
...
let run_protocol_violation :
  'Auu____3793 'Auu____3794 .
    'Auu____3793 ->
      Prims.string ->
        ((query_status * FStar_Util.json) * ('Auu____3793,'Auu____3794)
          FStar_Util.either)
  =
  fun st  ->
    fun message  ->
...
let run_generic_error :
  'Auu____3836 'Auu____3837 .
    'Auu____3836 ->
      Prims.string ->
        ((query_status * FStar_Util.json) * ('Auu____3836,'Auu____3837)
          FStar_Util.either)
  =
  fun st  ->
    fun message  ->
...
let run_segment :
  'Auu____3889 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____3889)
          FStar_Util.either)
  =
  fun st  ->
    fun code  ->
  ...
  'Auu____4075 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string FStar_Pervasives_Native.option ->
        Prims.string ->
          ((query_status * FStar_Util.json) *
            (FStar_Interactive_JsonHelper.repl_state,'Auu____4075)
            FStar_Util.either)
  =
  fun st  ->
    fun opt_fname  ->
...
let run_pop :
  'Auu____4128 .
    FStar_Interactive_JsonHelper.repl_state ->
      ((query_status * FStar_Util.json) *
        (FStar_Interactive_JsonHelper.repl_state,'Auu____4128)
        FStar_Util.either)
  =
  fun st  ->
...
let run_push_without_deps :
  'Auu____4509 .
    FStar_Interactive_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____4509)
          FStar_Util.either)
  =
  fun st  ->
    fun query  ->
...
let run_push_with_deps :
  'Auu____4634 .
    FStar_Interactive_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____4634)
          FStar_Util.either)
  =
  fun st  ->
    fun query  ->
...
let run_push :
  'Auu____4748 .
    FStar_Interactive_JsonHelper.repl_state ->
      push_query ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____4748)
          FStar_Util.either)
  =
  fun st  ->
    fun query  ->
      ...
      Prims.string ->
        lookup_context ->
          FStar_Interactive_QueryHelper.position
            ...
            Prims.string Prims.list ->
              ((query_status * FStar_Util.json) *
                (FStar_Interactive_JsonHelper.repl_state,'Auu____5534)
                FStar_Util.either)
  =
  fun st  ->
    fun symbol  ->
...
let run_code_autocomplete :
  'Auu____5690 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____5690)
          FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
...
let run_module_autocomplete :
  'Auu____5744 'Auu____5745 'Auu____5746 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        'Auu____5744 ->
          'Auu____5745 ->
            ((query_status * FStar_Util.json) *
              (FStar_Interactive_JsonHelper.repl_state,'Auu____5746)
              FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
...
let run_option_autocomplete :
  'Auu____5896 'Auu____5897 'Auu____5898 .
    'Auu____5896 ->
      Prims.string ->
        'Auu____5897 ->
          ((query_status * FStar_Util.json) * ('Auu____5896,'Auu____5898)
            FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
  ...
  'Auu____6008 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        completion_context ->
          ((query_status * FStar_Util.json) *
            (FStar_Interactive_JsonHelper.repl_state,'Auu____6008)
            FStar_Util.either)
  =
  fun st  ->
    fun search_term  ->
...
let run_and_rewind :
  'Auu____6060 'Auu____6061 .
    FStar_Interactive_JsonHelper.repl_state ->
      'Auu____6060 ->
        (FStar_Interactive_JsonHelper.repl_state -> 'Auu____6060) ->
          ('Auu____6060 *
            (FStar_Interactive_JsonHelper.repl_state,'Auu____6061)
            FStar_Util.either)
  =
  fun st  ->
    fun sigint_default  ->
...
let run_with_parsed_and_tc_term :
  'Auu____6168 'Auu____6169 'Auu____6170 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        'Auu____6168 ->
          'Auu____6169 ->
            (FStar_TypeChecker_Env.env ->
              ...
              ->
              ((query_status * FStar_Util.json) *
                (FStar_Interactive_JsonHelper.repl_state,'Auu____6170)
                FStar_Util.either)
  =
  fun st  ->
    fun term  ->
    ...
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        FStar_TypeChecker_Env.step Prims.list FStar_Pervasives_Native.option
          ->
          ((query_status * FStar_Util.json) *
            (FStar_Interactive_JsonHelper.repl_state,'Auu____6581)
            FStar_Util.either)
  =
  fun st  ->
    fun term  ->
...
let (sc_of_lid : FStar_Ident.lid -> search_candidate) =
  fun lid  ->
    ...
    let uu____6893 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    { sc_lid = lid; sc_typ = uu____6886; sc_fvars = uu____6893 }
  
let (sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ) =
  fun tcenv  ->
    fun sc  ->
      let uu____6917 = FStar_ST.op_Bang sc.sc_typ  in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____6964,typ),uu____6966) ->
                typ
             in
...
let (sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____7016 = FStar_ST.op_Bang sc.sc_fvars  in
      match uu____7016 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____7060 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____7060  in
...
let (json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____7104 = sc_typ tcenv sc  in
        FStar_Interactive_QueryHelper.term_to_string tcenv uu____7104  in
      let uu____7105 =
        let uu____7113 =
          let uu____7119 =
            let uu____7120 =
              let uu____7122 =
                FStar_Syntax_DsEnv.shorten_lid
                 ...
                 in
              uu____7122.FStar_Ident.str  in
            FStar_Util.JsonStr uu____7120  in
          ("lid", uu____7119)  in
        [uu____7113; ("type", (FStar_Util.JsonStr typ_str))]  in
      FStar_Util.JsonAssoc uu____7105
  
exception InvalidSearch of Prims.string 
let (uu___is_InvalidSearch : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____7155 -> true
    | uu____7158 -> false
...
let run_search :
  'Auu____7177 .
    FStar_Interactive_JsonHelper.repl_state ->
      Prims.string ->
        ((query_status * FStar_Util.json) *
          (FStar_Interactive_JsonHelper.repl_state,'Auu____7177)
          FStar_Util.either)
  =
  fun st  ->
    fun search_str  ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____7224 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____7224
           in
              ...
              let uu____7283 =
                let uu____7284 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____7284  in
              FStar_Exn.raise uu____7283
            else
              if beg_quote
              then
                (let uu____7290 = strip_quotes term1  in
                 NameContainsStr uu____7290)
              else
                     ...
                     let uu____7298 =
                       let uu____7299 =
                         FStar_Util.format1 "Unknown identifier: %s" term1
                          in
                       InvalidSearch uu____7299  in
                     FStar_Exn.raise uu____7298
      ...
      let pprint_one term =
        let uu____7327 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.op_Hat (if term.st_negate then "-" else "") uu____7327  in
      let results =
        try
          (fun uu___922_7361  ->
             match () with
             | () ->
                 ...
                 (match results with
                  | [] ->
                      let kwds =
                        let uu____7409 = FStar_List.map pprint_one terms  in
                        FStar_Util.concat_l " " uu____7409  in
                      let uu____7415 =
                        let uu____7416 =
                          FStar_Util.format1
                            "No results found for query [%s]" kwds
                           in
                        InvalidSearch uu____7416  in
                      FStar_Exn.raise uu____7415
                  | uu____7423 -> (QueryOK, (FStar_Util.JsonList js)))) ()
    ...
    fun q  ->
      ...
      | Push
          { push_kind = FStar_Interactive_PushHelper.SyntaxCheck ;
            push_code = uu____7554; push_line = uu____7555;
            push_column = uu____7556; push_peek_only = false ;_}
          ->
          {
            qq =
              (ProtocolViolation
...
let (js_repl_eval :
  ...
  fun st  ->
    fun query  ->
      let uu____7637 = validate_and_run_query st query  in
...
let (js_repl_eval_js :
  ...
  fun st  ->
    fun query_js  ->
      let uu____7703 = deserialize_interactive_query query_js  in
      js_repl_eval st uu____7703
...
let (js_repl_eval_str :
  ...
  fun st  ->
    fun query_str  ->
      let uu____7727 =
        let uu____7737 = parse_interactive_query query_str  in
        js_repl_eval st uu____7737  in
      match uu____7727 with
      | (js_response,st_opt) ->
          let uu____7760 = FStar_Util.string_of_json js_response  in
          (uu____7760, st_opt)
  
let (js_repl_init_opts : unit -> unit) =
  fun uu____7773  ->
    let uu____7774 = FStar_Options.parse_cmd_line ()  in
...
let rec (go : FStar_Interactive_JsonHelper.repl_state -> Prims.int) =
  fun st  ->
    ...
    let uu____7820 = validate_and_run_query st query  in
...
let (interactive_error_handler : FStar_Errors.error_handler) =
  ...
  let add_one1 e =
    let uu____7873 =
      let uu____7876 = FStar_ST.op_Bang issues  in e :: uu____7876  in
    FStar_ST.op_Colon_Equals issues uu____7873  in
  let count_errors uu____7930 =
    let uu____7931 =
      let uu____7934 = FStar_ST.op_Bang issues  in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____7934
       in
    FStar_List.length uu____7931  in
  let report uu____7969 =
    let uu____7970 = FStar_ST.op_Bang issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____7970  in
  let clear1 uu____8001 = FStar_ST.op_Colon_Equals issues []  in
  {
  ...
  fun printer  ->
    {
      ...
      FStar_Util.printer_prgeneric =
        (fun label  ->
           fun get_string  ->
             fun get_json  ->
               let uu____8062 = get_json ()  in
               forward_message printer label uu____8062)
    }
...
let (initial_range : FStar_Range.range) =
  let uu____8076 = FStar_Range.mk_pos Prims.int_one Prims.int_zero  in
  let uu____8079 = FStar_Range.mk_pos Prims.int_one Prims.int_zero  in
  FStar_Range.mk_range "<input>" uu____8076 uu____8079 
let (build_initial_repl_state :
  Prims.string -> FStar_Interactive_JsonHelper.repl_state) =
  fun filename  ->
    let env = FStar_Universal.init_env FStar_Parser_Dep.empty_deps  in
    let env1 = FStar_TypeChecker_Env.set_range env initial_range  in
    let uu____8093 = FStar_Util.open_stdin ()  in
    {
      ...
      FStar_Interactive_JsonHelper.repl_stdin = uu____8093;
      FStar_Interactive_JsonHelper.repl_names =
        FStar_Interactive_CompletionTable.empty
    }
  
let interactive_mode' :
  'Auu____8109 . FStar_Interactive_JsonHelper.repl_state -> 'Auu____8109 =
  fun init_st  ->
    write_hello ();
    (let exit_code =
       let uu____8118 =
       ...
       then
         let uu____8122 =
           let uu____8124 = FStar_Options.file_list ()  in
           FStar_List.hd uu____8124  in
         FStar_SMTEncoding_Solver.with_hints_db uu____8122
           (fun uu____8131  -> go init_st)
       else go init_st  in
...
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    ...
    (let uu____8145 =
       let uu____8147 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____8147  in
     if uu____8145
     then
    ...
    (let init1 = build_initial_repl_state filename  in
     let uu____8156 = FStar_Options.trace_error ()  in
     if uu____8156
       ...
       (try
        ...
        | uu___1069_8165 ->
            (FStar_Errors.set_handler FStar_Errors.default_handler;
             FStar_Exn.raise uu___1069_8165)))
