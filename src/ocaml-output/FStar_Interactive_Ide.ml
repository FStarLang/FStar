...
let uu____26 = (FStar_TypeChecker_Tc.snapshot_context env msg)
in (match (uu____26) with
| (ctx_depth, env1) -> begin
(

let uu____70 = (FStar_Options.snapshot ())
...
let rollback_env : FStar_TypeChecker_Env.solver_t  ->  Prims.string  ->  ((Prims.int * Prims.int * FStar_TypeChecker_Env.solver_depth_t * Prims.int) * Prims.int)  ->  FStar_TypeChecker_Env.env = (fun solver1 msg uu____116 -> (match (uu____116) with
...
let uu___498_218 = env
in (

let uu____219 = (FStar_Syntax_DsEnv.set_syntax_only env.FStar_TypeChecker_Env.dsenv (Prims.op_Equality check_kind SyntaxCheck))
in {FStar_TypeChecker_Env.solver = uu___498_218.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___498_218.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___498_218.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___498_218.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_sig = uu___498_218.FStar_TypeChecker_Env.gamma_sig; FStar_TypeChecker_Env.gamma_cache = uu___498_218.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___498_218.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___498_218.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___498_218.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.attrtab = uu___498_218.FStar_TypeChecker_Env.attrtab; FStar_TypeChecker_Env.is_pattern = uu___498_218.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___498_218.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___498_218.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___498_218.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___498_218.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___498_218.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___498_218.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___498_218.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___498_218.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___498_218.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = (Prims.op_Equality check_kind LaxCheck); FStar_TypeChecker_Env.lax_universes = uu___498_218.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.phase1 = uu___498_218.FStar_TypeChecker_Env.phase1; FStar_TypeChecker_Env.failhard = uu___498_218.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___498_218.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.uvar_subtyping = uu___498_218.FStar_TypeChecker_Env.uvar_subtyping; FStar_TypeChecker_Env.tc_term = uu___498_218.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___498_218.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___498_218.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___498_218.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___498_218.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___498_218.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.normalized_eff_names = uu___498_218.FStar_TypeChecker_Env.normalized_eff_names; FStar_TypeChecker_Env.fv_delta_depths = uu___498_218.FStar_TypeChecker_Env.fv_delta_depths; FStar_TypeChecker_Env.proof_ns = uu___498_218.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___498_218.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___498_218.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.postprocess = uu___498_218.FStar_TypeChecker_Env.postprocess; FStar_TypeChecker_Env.is_native_tactic = uu___498_218.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___498_218.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___498_218.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu____219; FStar_TypeChecker_Env.nbe = uu___498_218.FStar_TypeChecker_Env.nbe})))


let with_captured_errors' : 'Auu____229 . FStar_TypeChecker_Env.env  ->  FStar_Util.sigint_handler  ->  (FStar_TypeChecker_Env.env  ->  'Auu____229 FStar_Pervasives_Native.option)  ->  'Auu____229 FStar_Pervasives_Native.option = (fun env sigint_handler f -> (FStar_All.try_with (fun uu___500_259 -> (match (()) with
| () -> begin
(FStar_Util.with_sigint_handler sigint_handler (fun uu____265 -> (f env)))
end)) (fun uu___499_270 -> (match (uu___499_270) with
...
let uu____283 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Errors.log_issue uu____283 ((FStar_Errors.Error_IDEAssertionFailure), (msg1))));
...
let uu____331 = (FStar_TypeChecker_Env.get_range env)
in ((e), (msg), (uu____331)))
in (uu____323)::[])
in (FStar_TypeChecker_Err.add_errors env uu____313));
FStar_Pervasives_Native.None;
)
end
...
let with_captured_errors : 'Auu____356 . FStar_TypeChecker_Env.env  ->  FStar_Util.sigint_handler  ->  (FStar_TypeChecker_Env.env  ->  'Auu____356 FStar_Pervasives_Native.option)  ->  'Auu____356 FStar_Pervasives_Native.option = (fun env sigint_handler f -> (
...
let uu____430 = (FStar_Parser_ParseIt.get_file_last_modification_time fname)
in {tf_fname = fname; tf_modtime = uu____430}))


let dummy_tf_of_fname : Prims.string  ->  timed_fname = (fun fname -> {tf_fname = fname; tf_modtime = t0})


let string_of_timed_fname : timed_fname  ->  Prims.string = (fun uu____445 -> (match (uu____445) with
...
let uu____455 = (FStar_Util.string_of_time modtime)
in (FStar_Util.format2 "{ %s; %s }" fname uu____455))
end)
end))
...
let uu____1072 = (FStar_ST.op_Bang repl_stack)
in (match (uu____1072) with
| [] -> begin
(failwith "Too many pops")
end
| ((depth, (uu____1102, st')))::stack_tl -> begin
(
...
in (FStar_Common.runtime_assert uu____1149 "Inconsistent stack state"));
st';
))
end)))
...
let uu____1175 = (snapshot_env st.repl_env msg)
...
let uu____1184 = (FStar_ST.op_Bang repl_stack)
in (((depth), (((task), (st)))))::uu____1184)
in (FStar_ST.op_Colon_Equals repl_stack uu____1183));
(

let uu___501_1245 = st
in (

let uu____1246 = (set_check_kind env push_kind)
in {repl_line = uu___501_1245.repl_line; repl_column = uu___501_1245.repl_column; repl_fname = uu___501_1245.repl_fname; repl_deps_stack = uu___501_1245.repl_deps_stack; repl_curmod = uu___501_1245.repl_curmod; repl_env = uu____1246; repl_stdin = uu___501_1245.repl_stdin; repl_names = uu___501_1245.repl_names}));
)
end)))
...
let uu____1255 = (FStar_ST.op_Bang repl_stack)
in (FStar_List.length uu____1255))
in (Prims.op_Equality uu____1254 (FStar_List.length st.repl_deps_stack))))
...
let uu___502_1672 = st
in {repl_line = uu___502_1672.repl_line; repl_column = uu___502_1672.repl_column; repl_fname = uu___502_1672.repl_fname; repl_deps_stack = uu___502_1672.repl_deps_stack; repl_curmod = uu___502_1672.repl_curmod; repl_env = uu___502_1672.repl_env; repl_stdin = uu___502_1672.repl_stdin; repl_names = names1})))
...
in ((uu____1838), (op)))
in NTOpen (uu____1833))
in (push_event uu____1832))); FStar_Syntax_DsEnv.ds_push_include_hook = (fun dsenv1 ns -> (
...
in ((uu____1850), (ns)))
in NTInclude (uu____1845))
in (push_event uu____1844))); FStar_Syntax_DsEnv.ds_push_module_abbrev_hook = (fun dsenv1 x l -> (

let uu____1858 = (

let uu____1859 = (

let uu____1866 = (FStar_Syntax_DsEnv.current_module dsenv1)
in ((uu____1866), (x), (l)))
in NTAlias (uu____1859))
in (push_event uu____1858)))}), ({FStar_TypeChecker_Env.tc_push_in_gamma_hook = (fun uu____1871 s -> (push_event (NTBinding (s))))})))))
...
let uu____1925 = (FStar_Universal.with_dsenv_of_tcenv env1 (fun dsenv1 -> (
...
let uu____1940 = (FStar_Syntax_DsEnv.ds_hooks env.FStar_TypeChecker_Env.dsenv)
in (

let uu____1941 = (FStar_TypeChecker_Env.tc_hooks env)
in ((uu____1940), (uu____1941))))
in (match (uu____1935) with
| (old_dshooks, old_tchooks) -> begin
(

let uu____1957 = (fresh_name_tracking_hooks ())
in (match (uu____1957) with
| (events, new_dshooks, new_tchooks) -> begin
(

let uu____1992 = (set_hooks new_dshooks new_tchooks env)
in ((uu____1992), ((fun env1 -> (
...
let uu____2010 = (FStar_ST.op_Bang events)
in (FStar_List.rev uu____2010))
in ((uu____2006), (uu____2007))))))))
end))
end))))


let string_of_repl_task : repl_task  ->  Prims.string = (fun uu___483_2066 -> (match (uu___483_2066) with
| LDInterleaved (intf, impl) -> begin
(

let uu____2070 = (string_of_timed_fname intf)
in (

let uu____2072 = (string_of_timed_fname impl)
in (FStar_Util.format2 "LDInterleaved (%s, %s)" uu____2070 uu____2072)))
end
| LDSingle (intf_or_impl) -> begin
(

let uu____2076 = (string_of_timed_fname intf_or_impl)
in (FStar_Util.format1 "LDSingle %s" uu____2076))
end
| LDInterfaceOfCurrentFile (intf) -> begin
(

let uu____2080 = (string_of_timed_fname intf)
in (FStar_Util.format1 "LDInterfaceOfCurrentFile %s" uu____2080))
end
...
let uu____2110 = (FStar_Universal.tc_one_file_for_ide env intf_opt modf)
in (match (uu____2110) with
| (uu____2115, env1) -> begin
env1
end)))
...
let uu____2143 = (tc_one env (FStar_Pervasives_Native.Some (intf.tf_fname)) impl.tf_fname)
in ((curmod), (uu____2143)))
end
| LDSingle (intf_or_impl) -> begin
(

let uu____2146 = (tc_one env FStar_Pervasives_Native.None intf_or_impl.tf_fname)
in ((curmod), (uu____2146)))
end
| LDInterfaceOfCurrentFile (intf) -> begin
(

let uu____2149 = (FStar_Universal.load_interface_decls env intf.tf_fname)
in ((curmod), (uu____2149)))
end
| PushFragment (frag) -> begin
...
let uu____2215 = (aux deps' final_tasks1)
in (LDInterleaved ((((wrap intf)), ((wrap impl)))))::uu____2215)
end
| (intf_or_impl)::deps' -> begin
(

let uu____2225 = (aux deps' final_tasks1)
in (LDSingle ((wrap intf_or_impl)))::uu____2225)
end
| [] -> begin
final_tasks1
end))
...
let uu____2279 = (get_mod_name f)
in (Prims.op_Equality uu____2279 our_mod_name)))
in (

let uu____2282 = (FStar_Dependencies.find_deps_if_needed ((filename)::[]))
in (match (uu____2282) with
| (deps, dep_graph1) -> begin
(

let uu____2311 = (FStar_List.partition has_our_mod_name deps)
...
let uu____2372 = (FStar_Util.format1 "Expecting an interface, got %s" intf)
in ((FStar_Errors.Fatal_MissingInterface), (uu____2372)))
in (FStar_Errors.raise_err uu____2366))
end
| uu____2376 -> begin
()
end));
...
let uu____2381 = (FStar_Parser_Dep.is_implementation impl)
in (not (uu____2381)))
...
let uu____2390 = (FStar_Util.format1 "Expecting an implementation, got %s" impl)
in ((FStar_Errors.Fatal_MissingImplementation), (uu____2390)))
in (FStar_Errors.raise_err uu____2384))
end
| uu____2394 -> begin
()
end));
...
let uu____2417 = (FStar_Util.format message ((our_mod_name)::(mods_str)::[]))
in ((FStar_Errors.Fatal_TooManyOrTooFewFileMatch), (uu____2417)))
in (FStar_Errors.raise_err uu____2411));
[];
)))
end)
in (
...
let update_task_timestamps : repl_task  ->  repl_task = (fun uu___484_2436 -> (match (uu___484_2436) with
| LDInterleaved (intf, impl) -> begin
(

let uu____2439 = (

let uu____2444 = (tf_of_fname intf.tf_fname)
in (

let uu____2445 = (tf_of_fname impl.tf_fname)
in ((uu____2444), (uu____2445))))
in LDInterleaved (uu____2439))
end
| LDSingle (intf_or_impl) -> begin
(

let uu____2447 = (tf_of_fname intf_or_impl.tf_fname)
in LDSingle (uu____2447))
end
| LDInterfaceOfCurrentFile (intf) -> begin
(

let uu____2449 = (tf_of_fname intf.tf_fname)
in LDInterfaceOfCurrentFile (uu____2449))
end
| other -> begin
other
end))
...
let uu____2481 = (track_name_changes st1.repl_env)
in (match (uu____2481) with
| (env, finish_name_tracking) -> begin
(

let check_success = (fun uu____2526 -> ((

let uu____2529 = (FStar_Errors.get_err_count ())
in (Prims.op_Equality uu____2529 (Prims.parse_int "0"))) && (not (must_rollback))))
in (

let uu____2533 = (

let uu____2541 = (with_captured_errors env FStar_Util.sigint_raise (fun env1 -> (

let uu____2555 = (run_repl_task st1.repl_curmod env1 task)
in (FStar_All.pipe_left (fun _0_1 -> FStar_Pervasives_Native.Some (_0_1)) uu____2555))))
...
let uu____2608 = (finish_name_tracking env1)
...
let uu___503_2629 = st1
in {repl_line = uu___503_2629.repl_line; repl_column = uu___503_2629.repl_column; repl_fname = uu___503_2629.repl_fname; repl_deps_stack = uu___503_2629.repl_deps_stack; repl_curmod = curmod; repl_env = env2; repl_stdin = uu___503_2629.repl_stdin; repl_names = uu___503_2629.repl_names})
...
let uu____2676 = (FStar_Options.debug_any ())
in (match (uu____2676) with
| true -> begin
(

let uu____2679 = (string_of_repl_task task)
in (FStar_Util.print2 "%s %s" verb uu____2679))
end
| uu____2682 -> begin
()
end)))
...
let rec revert_many = (fun st1 uu___485_2704 -> (match (uu___485_2704) with
| [] -> begin
st1
end
...
let uu___504_2757 = st'
in (

let uu____2758 = (FStar_TypeChecker_Env.set_dep_graph st'.repl_env dep_graph1)
in {repl_line = uu___504_2757.repl_line; repl_column = uu___504_2757.repl_column; repl_fname = uu___504_2757.repl_fname; repl_deps_stack = uu___504_2757.repl_deps_stack; repl_curmod = uu___504_2757.repl_curmod; repl_env = uu____2758; repl_stdin = uu___504_2757.repl_stdin; repl_names = uu___504_2757.repl_names}))
...
in (FStar_All.pipe_right uu____2811 (fun a1 -> ())));
(
...
let uu____2815 = (FStar_Options.lax ())
...
let uu____2820 = (run_repl_transaction st1 push_kind false timestamped_task)
...
let uu___505_2841 = st2
in (

let uu____2842 = (FStar_ST.op_Bang repl_stack)
in {repl_line = uu___505_2841.repl_line; repl_column = uu___505_2841.repl_column; repl_fname = uu___505_2841.repl_fname; repl_deps_stack = uu____2842; repl_curmod = uu___505_2841.repl_curmod; repl_env = uu___505_2841.repl_env; repl_stdin = uu___505_2841.repl_stdin; repl_names = uu___505_2841.repl_names}))
in (aux uu____2840 tasks2 []))
end
| uu____2872 -> begin
FStar_Util.Inr (st2)
end)
...
let uu____2886 = (update_task_timestamps task)
in (Prims.op_Equality (FStar_Pervasives_Native.fst (FStar_Pervasives_Native.snd prev)) uu____2886)) -> begin
...
let uu____2903 = (revert_many st1 previous1)
in (aux uu____2903 tasks2 []))
end))
in (aux st tasks (FStar_List.rev st.repl_deps_stack))))))


let json_debug : FStar_Util.json  ->  Prims.string = (fun uu___486_2918 -> (match (uu___486_2918) with
...
let uu____2932 = (FStar_Util.string_of_int i)
in (FStar_Util.format1 "int (%s)" uu____2932))
end
| FStar_Util.JsonStr (s) -> begin
(FStar_Util.format1 "string (%s)" s)
end
| FStar_Util.JsonList (uu____2938) -> begin
"list (...)"
end
| FStar_Util.JsonAssoc (uu____2942) -> begin
"dictionary (...)"
end))
...
| UnexpectedJsonType (uu____2968) -> begin
true
end
| uu____2975 -> begin
false
...
| UnexpectedJsonType (uu____2994) -> begin
uu____2994
end))


let js_fail : 'Auu____3007 . Prims.string  ->  FStar_Util.json  ->  'Auu____3007 = (fun expected got -> (FStar_Exn.raise (UnexpectedJsonType (((expected), (got))))))


let js_int : FStar_Util.json  ->  Prims.int = (fun uu___487_3027 -> (match (uu___487_3027) with
| FStar_Util.JsonInt (i) -> begin
i
end
| other -> begin
...
let js_str : FStar_Util.json  ->  Prims.string = (fun uu___488_3040 -> (match (uu___488_3040) with
| FStar_Util.JsonStr (s) -> begin
s
end
| other -> begin
...
let js_list : 'Auu____3054 . (FStar_Util.json  ->  'Auu____3054)  ->  FStar_Util.json  ->  'Auu____3054 Prims.list = (fun k uu___489_3069 -> (match (uu___489_3069) with
...
let js_assoc : FStar_Util.json  ->  (Prims.string * FStar_Util.json) Prims.list = (fun uu___490_3091 -> (match (uu___490_3091) with
...
let query_needs_current_module : query'  ->  Prims.bool = (fun uu___491_3868 -> (match (uu___491_3868) with
| Exit -> begin
false
end
| DescribeProtocol -> begin
...
| Segment (uu____3873) -> begin
false
end
| Pop -> begin
false
end
| Push ({push_kind = uu____3877; push_code = uu____3878; push_line = uu____3879; push_column = uu____3880; push_peek_only = false}) -> begin
false
end
| VfsAdd (uu____3886) -> begin
false
end
| GenericError (uu____3896) -> begin
false
end
| ProtocolViolation (uu____3899) -> begin
false
end
| Push (uu____3902) -> begin
true
end
| AutoComplete (uu____3904) -> begin
true
end
| Lookup (uu____3911) -> begin
true
end
| Compute (uu____3927) -> begin
true
end
| Search (uu____3938) -> begin
true
end))
...
let try_assoc : 'Auu____4062 'Auu____4063 . 'Auu____4062  ->  ('Auu____4062 * 'Auu____4063) Prims.list  ->  'Auu____4063 FStar_Pervasives_Native.option = (fun key a -> (

let uu____4088 = (FStar_Util.try_find (fun uu____4102 -> (match (uu____4102) with
| (k, uu____4109) -> begin
(Prims.op_Equality k key)
end)) a)
in (FStar_Util.map_option FStar_Pervasives_Native.snd uu____4088)))
...
let uu____4137 = (json_debug got)
in (FStar_Util.format2 "JSON decoding failed: expected %s, got %s" expected uu____4137))
in ProtocolViolation (uu____4135))
in {qq = uu____4134; qid = qid}))
...
let uu____4180 = (try_assoc key a)
...
let uu____4186 = (FStar_Util.format2 "Missing key [%s] in %s." key errloc)
in InvalidQuery (uu____4186))
in (FStar_Exn.raise uu____4185))
end)))
in (
...
let uu____4206 = (assoc1 "query" "query-id" request)
in (FStar_All.pipe_right uu____4206 js_str))
in (FStar_All.try_with (fun uu___507_4216 -> (match (()) with
| () -> begin
(

let query = (

let uu____4219 = (assoc1 "query" "query" request)
in (FStar_All.pipe_right uu____4219 js_str))
in (

let args = (

let uu____4231 = (assoc1 "query" "args" request)
in (FStar_All.pipe_right uu____4231 js_assoc))
in (
...
let uu____4260 = (try_assoc k args)
...
let uu____4269 = (match (query) with
| "exit" -> begin
Exit
end
| "pop" -> begin
...
let uu____4277 = (arg "code")
in (FStar_All.pipe_right uu____4277 js_str))
in Segment (uu____4275))
end
| "peek" -> begin
(
...
let uu____4283 = (arg "kind")
in (FStar_All.pipe_right uu____4283 js_pushkind))
in (

let uu____4285 = (

let uu____4287 = (arg "code")
in (FStar_All.pipe_right uu____4287 js_str))
in (

let uu____4290 = (

let uu____4292 = (arg "line")
in (FStar_All.pipe_right uu____4292 js_int))
in (

let uu____4295 = (

let uu____4297 = (arg "column")
in (FStar_All.pipe_right uu____4297 js_int))
in {push_kind = uu____4282; push_code = uu____4285; push_line = uu____4290; push_column = uu____4295; push_peek_only = (Prims.op_Equality query "peek")}))))
in Push (uu____4281))
end
| "push" -> begin
(
...
let uu____4305 = (arg "kind")
in (FStar_All.pipe_right uu____4305 js_pushkind))
in (

let uu____4307 = (

let uu____4309 = (arg "code")
in (FStar_All.pipe_right uu____4309 js_str))
in (

let uu____4312 = (

let uu____4314 = (arg "line")
in (FStar_All.pipe_right uu____4314 js_int))
in (

let uu____4317 = (

let uu____4319 = (arg "column")
in (FStar_All.pipe_right uu____4319 js_int))
in {push_kind = uu____4304; push_code = uu____4307; push_line = uu____4312; push_column = uu____4317; push_peek_only = (Prims.op_Equality query "peek")}))))
in Push (uu____4303))
end
| "autocomplete" -> begin
(
...
let uu____4333 = (arg "partial-symbol")
in (FStar_All.pipe_right uu____4333 js_str))
in (

let uu____4336 = (

let uu____4337 = (try_arg "context")
in (FStar_All.pipe_right uu____4337 js_optional_completion_context))
in ((uu____4331), (uu____4336))))
in AutoComplete (uu____4325))
end
| "lookup" -> begin
(
...
let uu____4362 = (arg "symbol")
in (FStar_All.pipe_right uu____4362 js_str))
in (

let uu____4365 = (

let uu____4366 = (try_arg "context")
in (FStar_All.pipe_right uu____4366 js_optional_lookup_context))
in (
...
let uu____4385 = (try_arg "location")
in (FStar_All.pipe_right uu____4385 (FStar_Util.map_option js_assoc)))
in (FStar_All.pipe_right uu____4375 (FStar_Util.map_option (fun loc -> (

let uu____4446 = (

let uu____4448 = (assoc1 "[location]" "filename" loc)
in (FStar_All.pipe_right uu____4448 js_str))
in (

let uu____4452 = (

let uu____4454 = (assoc1 "[location]" "line" loc)
in (FStar_All.pipe_right uu____4454 js_int))
in (

let uu____4458 = (

let uu____4460 = (assoc1 "[location]" "column" loc)
in (FStar_All.pipe_right uu____4460 js_int))
in ((uu____4446), (uu____4452), (uu____4458)))))))))
in (

let uu____4467 = (

let uu____4471 = (arg "requested-info")
in (FStar_All.pipe_right uu____4471 (js_list js_str)))
in ((uu____4360), (uu____4365), (uu____4372), (uu____4467))))))
in Lookup (uu____4345))
end
| "compute" -> begin
(
...
let uu____4496 = (arg "term")
in (FStar_All.pipe_right uu____4496 js_str))
in (

let uu____4499 = (

let uu____4504 = (try_arg "rules")
in (FStar_All.pipe_right uu____4504 (FStar_Util.map_option (js_list js_reductionrule))))
in ((uu____4494), (uu____4499))))
in Compute (uu____4484))
end
| "search" -> begin
(
...
let uu____4524 = (arg "terms")
in (FStar_All.pipe_right uu____4524 js_str))
in Search (uu____4522))
end
| "vfs-add" -> begin
(
...
let uu____4541 = (try_arg "filename")
in (FStar_All.pipe_right uu____4541 (FStar_Util.map_option js_str)))
in (

let uu____4551 = (

let uu____4553 = (arg "contents")
in (FStar_All.pipe_right uu____4553 js_str))
in ((uu____4537), (uu____4551))))
in VfsAdd (uu____4528))
end
| uu____4560 -> begin
(

let uu____4562 = (FStar_Util.format1 "Unknown query \'%s\'" query)
in ProtocolViolation (uu____4562))
end)
in {qq = uu____4269; qid = qid})))))
end)) (fun uu___506_4567 -> (match (uu___506_4567) with
...
let deserialize_interactive_query : FStar_Util.json  ->  query = (fun js_query -> (FStar_All.try_with (fun uu___509_4581 -> (match (()) with
| () -> begin
(unpack_interactive_query js_query)
end)) (fun uu___508_4584 -> (match (uu___508_4584) with
| InvalidQuery (msg) -> begin
...
let uu____4601 = (FStar_Util.json_of_string query_str)
...
let uu____4613 = (FStar_Util.read_line stream)
...
let json_of_opt : 'Auu____4629 . ('Auu____4629  ->  FStar_Util.json)  ->  'Auu____4629 FStar_Pervasives_Native.option  ->  FStar_Util.json = (fun json_of_a opt_a -> (

let uu____4649 = (FStar_Util.map_option json_of_a opt_a)
in (FStar_Util.dflt FStar_Util.JsonNull uu____4649)))
...
let uu____4703 = (match (issue.FStar_Errors.issue_range) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
let uu____4709 = (FStar_Range.json_of_use_range r)
in (uu____4709)::[])
end)
in (

let uu____4710 = (match (issue.FStar_Errors.issue_range) with
| FStar_Pervasives_Native.Some (r) when (

let uu____4716 = (FStar_Range.def_range r)
in (

let uu____4717 = (FStar_Range.use_range r)
in (Prims.op_disEquality uu____4716 uu____4717))) -> begin
(

let uu____4718 = (FStar_Range.json_of_def_range r)
in (uu____4718)::[])
end
| uu____4719 -> begin
[]
end)
in (FStar_List.append uu____4703 uu____4710)))
in FStar_Util.JsonList (uu____4700))
in (("ranges"), (uu____4699)))
in (uu____4693)::[])
in ((("message"), (FStar_Util.JsonStr (issue.FStar_Errors.issue_message))))::uu____4685)
in ((("level"), ((json_of_issue_level issue.FStar_Errors.issue_level))))::uu____4677)
in FStar_Util.JsonAssoc (uu____4669)))
...
let uu____4951 = (json_of_opt FStar_Range.json_of_def_range lr.slr_def_range)
in (("defined-at"), (uu____4951)))
in (
...
let uu____4968 = (json_of_opt (fun _0_2 -> FStar_Util.JsonStr (_0_2)) lr.slr_typ)
in (("type"), (uu____4968)))
in (
...
let uu____4986 = (json_of_opt (fun _0_3 -> FStar_Util.JsonStr (_0_3)) lr.slr_doc)
in (("documentation"), (uu____4986)))
in (
...
let uu____5004 = (json_of_opt (fun _0_4 -> FStar_Util.JsonStr (_0_4)) lr.slr_def)
in (("definition"), (uu____5004)))
in (uu____4998)::[])
in (uu____4980)::uu____4990))
in (uu____4962)::uu____4972))
in (uu____4945)::uu____4954))
in ((("name"), (FStar_Util.JsonStr (lr.slr_name))))::uu____4937))
...
let uu____5050 = (FStar_List.map (fun _0_5 -> FStar_Util.JsonStr (_0_5)) interactive_protocol_features)
in (FStar_All.pipe_left (fun _0_6 -> FStar_Util.JsonList (_0_6)) uu____5050))
...
let string_of_option_permission_level : fstar_option_permission_level  ->  Prims.string = (fun uu___492_5114 -> (match (uu___492_5114) with
| OptSet -> begin
""
end
| OptReset -> begin
...
let rec kind_of_fstar_option_type : FStar_Options.opt_type  ->  Prims.string = (fun uu___493_5365 -> (match (uu___493_5365) with
| FStar_Options.Const (uu____5367) -> begin
"flag"
end
| FStar_Options.IntStr (uu____5369) -> begin
"int"
end
| FStar_Options.BoolStr -> begin
"bool"
end
| FStar_Options.PathStr (uu____5373) -> begin
"path"
end
| FStar_Options.SimpleStr (uu____5376) -> begin
"string"
end
| FStar_Options.EnumStr (uu____5379) -> begin
"enum"
end
| FStar_Options.OpenEnumStr (uu____5384) -> begin
"open enum"
end
| FStar_Options.PostProcessed (uu____5394, typ) -> begin
...
| FStar_Options.WithSideEffect (uu____5404, typ) -> begin
(kind_of_fstar_option_type typ)
end))
...
| FStar_Options.Const (uu____5476) -> begin
("")::[]
end
| FStar_Options.BoolStr -> begin
("true")::("false")::[]
...
| FStar_Options.PostProcessed (uu____5514, elem_spec) -> begin
...
| FStar_Options.WithSideEffect (uu____5524, elem_spec) -> begin
(arg_snippets_of_type elem_spec)
end))
in (

let uu____5532 = (arg_snippets_of_type typ)
in (FStar_List.map (mk_snippet name) uu____5532))))))


let rec json_of_fstar_option_value : FStar_Options.option_val  ->  FStar_Util.json = (fun uu___494_5543 -> (match (uu___494_5543) with
...
let uu____5555 = (FStar_List.map json_of_fstar_option_value vs)
in FStar_Util.JsonList (uu____5555))
end
...
let uu____5593 = (json_of_fstar_option_value opt.opt_value)
in (("value"), (uu____5593)))
in (
...
let uu____5610 = (json_of_fstar_option_value opt.opt_default)
in (("default"), (uu____5610)))
in (
...
let uu____5627 = (json_of_opt (fun _0_7 -> FStar_Util.JsonStr (_0_7)) opt.opt_documentation)
in (("documentation"), (uu____5627)))
in (
...
let uu____5646 = (kind_of_fstar_option_type opt.opt_type)
in FStar_Util.JsonStr (uu____5646))
in (("type"), (uu____5645)))
in (uu____5639)::((("permission-level"), (FStar_Util.JsonStr ((string_of_option_permission_level opt.opt_permission_level)))))::[])
in (uu____5621)::uu____5631))
in (uu____5604)::uu____5613))
in (uu____5587)::uu____5596))
in ((("signature"), (FStar_Util.JsonStr (opt.opt_sig))))::uu____5579)
in ((("name"), (FStar_Util.JsonStr (opt.opt_name))))::uu____5571))


let json_of_fstar_option : fstar_option  ->  FStar_Util.json = (fun opt -> (

let uu____5702 = (alist_of_fstar_option opt)
in FStar_Util.JsonAssoc (uu____5702)))


let write_json : FStar_Util.json  ->  unit = (fun json -> ((

let uu____5717 = (FStar_Util.string_of_json json)
in (FStar_Util.print_raw uu____5717));
...
let uu____5831 = (FStar_ST.op_Bang repl_current_qid)
in (json_of_opt (fun _0_8 -> FStar_Util.JsonStr (_0_8)) uu____5831))
in (("query-id"), (uu____5830)))
in (uu____5824)::((("level"), (FStar_Util.JsonStr (level))))::((("contents"), (js_contents)))::[])
in ((("kind"), (FStar_Util.JsonStr ("message"))))::uu____5816)
in FStar_Util.JsonAssoc (uu____5808)))


let forward_message : 'Auu____5904 . (FStar_Util.json  ->  'Auu____5904)  ->  Prims.string  ->  FStar_Util.json  ->  'Auu____5904 = (fun callback level contents -> (

let uu____5927 = (json_of_message level contents)
in (callback uu____5927)))
...
let uu____5931 = (FStar_List.map (fun _0_9 -> FStar_Util.JsonStr (_0_9)) interactive_protocol_features)
in FStar_Util.JsonList (uu____5931))
in FStar_Util.JsonAssoc (((("kind"), (FStar_Util.JsonStr ("protocol-info"))))::alist_of_protocol_info)))


let write_hello : unit  ->  unit = (fun uu____5948 -> (write_json json_of_hello))
...
let uu____5966 = (FStar_Options.desc_of_opt_type typ)
...
let uu____5982 = (FStar_All.pipe_right FStar_Options.all_specs_with_types (FStar_List.filter_map (fun uu____6017 -> (match (uu____6017) with
| (_shortname, name, typ, doc1) -> begin
(

let uu____6041 = (FStar_Util.smap_try_find defaults1 name)
in (FStar_All.pipe_right uu____6041 (FStar_Util.map_option (fun default_value -> (

let uu____6053 = (sig_of_fstar_option name typ)
in (
...
let uu____6060 = (FStar_Options.settable name)
...
in {opt_name = name; opt_sig = uu____6053; opt_value = FStar_Options.Unset; opt_default = default_value; opt_type = typ; opt_snippets = uu____6055; opt_documentation = (match ((Prims.op_Equality doc1 "")) with
| true -> begin
FStar_Pervasives_Native.None
end
| uu____6077 -> begin
FStar_Pervasives_Native.Some (doc1)
end); opt_permission_level = uu____6059})))))))
end))))
in (FStar_All.pipe_right uu____5982 (FStar_List.sortWith (fun o1 o2 -> (FStar_String.compare (FStar_String.lowercase o1.opt_name) (FStar_String.lowercase o2.opt_name)))))))
...
let uu___510_6104 = opt
in (

let uu____6105 = (FStar_Options.get_option opt.opt_name)
in {opt_name = uu___510_6104.opt_name; opt_sig = uu___510_6104.opt_sig; opt_value = uu____6105; opt_default = uu___510_6104.opt_default; opt_type = uu___510_6104.opt_type; opt_snippets = uu___510_6104.opt_snippets; opt_documentation = uu___510_6104.opt_documentation; opt_permission_level = uu___510_6104.opt_permission_level})))


let current_fstar_options : (fstar_option  ->  Prims.bool)  ->  fstar_option Prims.list = (fun filter1 -> (

let uu____6121 = (FStar_List.filter filter1 fstar_options_list_cache)
in (FStar_List.map update_option uu____6121)))
...
let uu____6148 = (FStar_Util.substring_from opt_name (FStar_String.length opt_prefix))
in ((opt_prefix), (uu____6148)))
end
| uu____6152 -> begin
((""), (opt_name))
end)))
...
let filenames = (fun uu____6179 -> (match (uu____6179) with
| (uu____6191, (task, uu____6193)) -> begin
(match (task) with
| LDInterleaved (intf, impl) -> begin
...
let uu____6232 = (FStar_List.concatMap filenames st.repl_deps_stack)
in (FStar_List.map (fun _0_10 -> FStar_Util.JsonStr (_0_10)) uu____6232))
in FStar_Util.JsonList (uu____6229))
in (("loaded-dependencies"), (uu____6228)))
in (
...
let uu____6266 = (current_fstar_options (fun uu____6271 -> true))
in (FStar_List.map json_of_fstar_option uu____6266))
in FStar_Util.JsonList (uu____6263))
in (("options"), (uu____6262)))
in (uu____6256)::[])
in (uu____6222)::uu____6248))
in FStar_Util.JsonAssoc (uu____6214))))


let with_printed_effect_args : 'Auu____6295 . (unit  ->  'Auu____6295)  ->  'Auu____6295 = (fun k -> (FStar_Options.with_saved_options (fun uu____6308 -> ((FStar_Options.set_option "print_effect_args" (FStar_Options.Bool (true)));
(k ());
))))


let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun tcenv t -> (with_printed_effect_args (fun uu____6326 -> (FStar_TypeChecker_Normalize.term_to_string tcenv t))))


let sigelt_to_string : FStar_Syntax_Syntax.sigelt  ->  Prims.string = (fun se -> (with_printed_effect_args (fun uu____6336 -> (FStar_Syntax_Print.sigelt_to_string se))))


let run_exit : 'Auu____6344 'Auu____6345 . 'Auu____6344  ->  ((query_status * FStar_Util.json) * ('Auu____6345, Prims.int) FStar_Util.either) = (fun st -> ((((QueryOK), (FStar_Util.JsonNull))), (FStar_Util.Inr ((Prims.parse_int "0")))))


let run_describe_protocol : 'Auu____6382 'Auu____6383 . 'Auu____6382  ->  ((query_status * FStar_Util.json) * ('Auu____6382, 'Auu____6383) FStar_Util.either) = (fun st -> ((((QueryOK), (FStar_Util.JsonAssoc (alist_of_protocol_info)))), (FStar_Util.Inl (st))))


let run_describe_repl : 'Auu____6414 . repl_state  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6414) FStar_Util.either) = (fun st -> (

let uu____6432 = (

let uu____6437 = (json_of_repl_state st)
in ((QueryOK), (uu____6437)))
in ((uu____6432), (FStar_Util.Inl (st)))))


let run_protocol_violation : 'Auu____6455 'Auu____6456 . 'Auu____6455  ->  Prims.string  ->  ((query_status * FStar_Util.json) * ('Auu____6455, 'Auu____6456) FStar_Util.either) = (fun st message -> ((((QueryViolatesProtocol), (FStar_Util.JsonStr (message)))), (FStar_Util.Inl (st))))


let run_generic_error : 'Auu____6498 'Auu____6499 . 'Auu____6498  ->  Prims.string  ->  ((query_status * FStar_Util.json) * ('Auu____6498, 'Auu____6499) FStar_Util.either) = (fun st message -> ((((QueryNOK), (FStar_Util.JsonStr (message)))), (FStar_Util.Inl (st))))


let collect_errors : unit  ->  FStar_Errors.issue Prims.list = (fun uu____6539 -> (
...
let run_segment : 'Auu____6551 . repl_state  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6551) FStar_Util.either) = (fun st code -> (
...
let collect_decls = (fun uu____6586 -> (

let uu____6587 = (FStar_Parser_Driver.parse_fragment frag)
...
| FStar_Parser_Driver.Modul (FStar_Parser_AST.Module (uu____6593, decls)) -> begin
decls
end
| FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface (uu____6599, decls, uu____6601)) -> begin
decls
end)))
in (

let uu____6608 = (with_captured_errors st.repl_env FStar_Util.sigint_ignore (fun uu____6617 -> (

let uu____6618 = (collect_decls ())
in (FStar_All.pipe_left (fun _0_11 -> FStar_Pervasives_Native.Some (_0_11)) uu____6618))))
...
let uu____6646 = (collect_errors ())
in (FStar_All.pipe_right uu____6646 (FStar_List.map json_of_issue)))
...
let uu____6686 = (FStar_Range.json_of_def_range (FStar_Parser_AST.decl_drange decl))
in (("def_range"), (uu____6686)))
in (uu____6680)::[])
in FStar_Util.JsonAssoc (uu____6672)))
in (

let js_decls = (

let uu____6700 = (FStar_List.map json_of_decl decls)
in (FStar_All.pipe_left (fun _0_12 -> FStar_Util.JsonList (_0_12)) uu____6700))
in ((((QueryOK), (FStar_Util.JsonAssoc (((("decls"), (js_decls)))::[])))), (FStar_Util.Inl (st)))))
end)))))


let run_vfs_add : 'Auu____6734 . repl_state  ->  Prims.string FStar_Pervasives_Native.option  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6734) FStar_Util.either) = (fun st opt_fname contents -> (
...
let run_pop : 'Auu____6787 . repl_state  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____6787) FStar_Util.either) = (fun st -> (

let uu____6805 = (nothing_left_to_pop st)
...
let uu____6892 = (json_of_message "progress" (FStar_Util.JsonAssoc (js_contents)))
in (write_json uu____6892)))))


let write_repl_ld_task_progress : repl_task  ->  unit = (fun task -> (match (task) with
| LDInterleaved (uu____6900, tf) -> begin
(
...
let uu____6970 = (with_captured_errors st.repl_env FStar_Util.sigint_ignore (fun _env -> (

let uu____6998 = (deps_and_repl_ld_tasks_of_our_file st.repl_fname)
in (FStar_All.pipe_left (fun _0_13 -> FStar_Pervasives_Native.Some (_0_13)) uu____6998))))
...
let uu___511_7099 = st
in (

let uu____7100 = (FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1)
in {repl_line = uu___511_7099.repl_line; repl_column = uu___511_7099.repl_column; repl_fname = uu___511_7099.repl_fname; repl_deps_stack = uu___511_7099.repl_deps_stack; repl_curmod = uu___511_7099.repl_curmod; repl_env = uu____7100; repl_stdin = uu___511_7099.repl_stdin; repl_names = uu___511_7099.repl_names}))
in (

let uu____7101 = (run_repl_ld_transactions st1 tasks write_repl_ld_task_progress)
...
let uu___512_7156 = issue
in (

let uu____7157 = (FStar_Util.format1 "Error while computing or loading dependencies:\n%s" issue.FStar_Errors.issue_message)
in {FStar_Errors.issue_message = uu____7157; FStar_Errors.issue_level = uu___512_7156.FStar_Errors.issue_level; FStar_Errors.issue_range = uu___512_7156.FStar_Errors.issue_range; FStar_Errors.issue_number = uu___512_7156.FStar_Errors.issue_number})))


let run_push_without_deps : 'Auu____7167 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____7167) FStar_Util.either) = (fun st query -> (

let set_nosynth_flag = (fun st1 flag -> (

let uu___513_7203 = st1
in {repl_line = uu___513_7203.repl_line; repl_column = uu___513_7203.repl_column; repl_fname = uu___513_7203.repl_fname; repl_deps_stack = uu___513_7203.repl_deps_stack; repl_curmod = uu___513_7203.repl_curmod; repl_env = (

let uu___514_7205 = st1.repl_env
in {FStar_TypeChecker_Env.solver = uu___514_7205.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___514_7205.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___514_7205.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___514_7205.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_sig = uu___514_7205.FStar_TypeChecker_Env.gamma_sig; FStar_TypeChecker_Env.gamma_cache = uu___514_7205.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___514_7205.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___514_7205.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___514_7205.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.attrtab = uu___514_7205.FStar_TypeChecker_Env.attrtab; FStar_TypeChecker_Env.is_pattern = uu___514_7205.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___514_7205.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___514_7205.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___514_7205.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___514_7205.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___514_7205.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___514_7205.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___514_7205.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___514_7205.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___514_7205.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___514_7205.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___514_7205.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.phase1 = uu___514_7205.FStar_TypeChecker_Env.phase1; FStar_TypeChecker_Env.failhard = uu___514_7205.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = flag; FStar_TypeChecker_Env.uvar_subtyping = uu___514_7205.FStar_TypeChecker_Env.uvar_subtyping; FStar_TypeChecker_Env.tc_term = uu___514_7205.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___514_7205.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___514_7205.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___514_7205.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___514_7205.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___514_7205.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.normalized_eff_names = uu___514_7205.FStar_TypeChecker_Env.normalized_eff_names; FStar_TypeChecker_Env.fv_delta_depths = uu___514_7205.FStar_TypeChecker_Env.fv_delta_depths; FStar_TypeChecker_Env.proof_ns = uu___514_7205.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___514_7205.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___514_7205.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.postprocess = uu___514_7205.FStar_TypeChecker_Env.postprocess; FStar_TypeChecker_Env.is_native_tactic = uu___514_7205.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___514_7205.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___514_7205.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___514_7205.FStar_TypeChecker_Env.dsenv; FStar_TypeChecker_Env.nbe = uu___514_7205.FStar_TypeChecker_Env.nbe}); repl_stdin = uu___513_7203.repl_stdin; repl_names = uu___513_7203.repl_names}))
in (

let uu____7206 = query
...
let uu____7232 = (run_repl_transaction st1 push_kind peek_only (PushFragment (frag)))
...
let uu____7264 = (collect_errors ())
in (FStar_All.pipe_right uu____7264 (FStar_List.map json_of_issue)))
in FStar_Util.JsonList (uu____7261))
in (
...
let uu___515_7273 = st3
in {repl_line = line; repl_column = column; repl_fname = uu___515_7273.repl_fname; repl_deps_stack = uu___515_7273.repl_deps_stack; repl_curmod = uu___515_7273.repl_curmod; repl_env = uu___515_7273.repl_env; repl_stdin = uu___515_7273.repl_stdin; repl_names = uu___515_7273.repl_names})
end
| uu____7274 -> begin
st3
end)
...
let uu____7303 = (FStar_String.substring str (Prims.parse_int "1") ((FStar_String.length str) - (Prims.parse_int "1")))
in (Prims.strcat (FStar_String.uppercase first) uu____7303)))
end))
...
let uu____7344 = (FStar_Util.psmap_empty ())
in (

let uu____7349 = (

let uu____7353 = (FStar_Options.prims ())
in (uu____7353)::deps)
in (FStar_List.fold_left (fun acc dep1 -> (

let uu____7369 = (FStar_Parser_Dep.lowercase_module_name dep1)
in (FStar_Util.psmap_add acc uu____7369 true))) uu____7344 uu____7349)))
in (
...
in (FStar_List.fold_left (fun table1 uu____7398 -> (match (uu____7398) with
...
let uu____7421 = (capitalize modname)
in (FStar_Util.split uu____7421 "."))
in (

let uu____7424 = (loaded mod_key)
in (FStar_Interactive_CompletionTable.register_module_path table1 uu____7424 mod_path ns_query)))
end))
end)) table (FStar_List.rev mods)))))))


let run_push_with_deps : 'Auu____7439 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____7439) FStar_Util.either) = (fun st query -> ((

let uu____7463 = (FStar_Options.debug_any ())
...
let uu____7506 = (collect_errors ())
in (FStar_List.map rephrase_dependency_error uu____7506))
in (
...
in (FStar_All.pipe_right uu____7540 (fun a2 -> ())));
(

let names1 = (add_module_completions st1.repl_fname deps st1.repl_names)
in (run_push_without_deps (

let uu___516_7544 = st1
in {repl_line = uu___516_7544.repl_line; repl_column = uu___516_7544.repl_column; repl_fname = uu___516_7544.repl_fname; repl_deps_stack = uu___516_7544.repl_deps_stack; repl_curmod = uu___516_7544.repl_curmod; repl_env = uu___516_7544.repl_env; repl_stdin = uu___516_7544.repl_stdin; repl_names = names1}) query));
)
end));
))


let run_push : 'Auu____7552 . repl_state  ->  push_query  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____7552) FStar_Util.either) = (fun st query -> (

let uu____7575 = (nothing_left_to_pop st)
...
let uu____7683 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split lid_str "."))
in (FStar_Ident.lid_of_ids uu____7683))
in (

let lid1 = (

let uu____7689 = (FStar_Syntax_DsEnv.resolve_to_fully_qualified_name tcenv.FStar_TypeChecker_Env.dsenv lid)
in (FStar_All.pipe_left (FStar_Util.dflt lid) uu____7689))
in (

let uu____7694 = (FStar_TypeChecker_Env.try_lookup_lid tcenv lid1)
in (FStar_All.pipe_right uu____7694 (FStar_Util.map_option (fun uu____7751 -> (match (uu____7751) with
| ((uu____7771, typ), r) -> begin
...
let uu____7793 = (FStar_Syntax_DsEnv.try_lookup_doc tcenv.FStar_TypeChecker_Env.dsenv lid)
in (FStar_All.pipe_right uu____7793 (FStar_Util.map_option FStar_Pervasives_Native.fst))))
in (

let def_of_lid = (fun lid -> (

let uu____7859 = (FStar_TypeChecker_Env.lookup_qname tcenv lid)
in (FStar_Util.bind_opt uu____7859 (fun uu___495_7904 -> (match (uu___495_7904) with
| (FStar_Util.Inr (se, uu____7927), uu____7928) -> begin
(

let uu____7957 = (sigelt_to_string se)
...
let info_at_pos_opt = (FStar_Util.bind_opt pos_opt (fun uu____8018 -> (match (uu____8018) with
| (file, row, col) -> begin
...
| FStar_Pervasives_Native.Some (uu____8077) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
...
let uu____8234 = (term_to_string tcenv typ)
in FStar_Pervasives_Native.Some (uu____8234))
end
| uu____8237 -> begin
FStar_Pervasives_Native.None
end)
...
let uu____8300 = (alist_of_symbol_lookup_result result)
in (("symbol"), (uu____8300)))
...
let uu____8435 = (trim_option_name opt_name)
in (match (uu____8435) with
| (uu____8459, trimmed_name) -> begin
(

let uu____8465 = (FStar_Util.smap_try_find fstar_options_map_cache trimmed_name)
...
let uu____8521 = (update_option opt)
in (alist_of_fstar_option uu____8521))
in (("option"), (uu____8513)))
in FStar_Util.Inr (uu____8500))
end))
end)))
...
let uu____8579 = (FStar_Interactive_CompletionTable.find_module_or_ns st.repl_names query)
...
let uu____8627 = (FStar_Interactive_CompletionTable.alist_of_mod_info mod_info)
in (("module"), (uu____8627)))
in FStar_Util.Inr (uu____8614))
end
...
let uu____8671 = (FStar_Interactive_CompletionTable.alist_of_ns_info ns_info)
in (("namespace"), (uu____8671)))
in FStar_Util.Inr (uu____8658))
end))))
...
| FStar_Util.Inl (uu____8843) -> begin
(

let uu____8858 = (run_module_lookup st symbol)
...
let run_lookup : 'Auu____9064 . repl_state  ->  Prims.string  ->  lookup_context  ->  (Prims.string * Prims.int * Prims.int) FStar_Pervasives_Native.option  ->  Prims.string Prims.list  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____9064) FStar_Util.either) = (fun st symbol context pos_opt requested_info -> (

let uu____9132 = (run_lookup' st symbol context pos_opt requested_info)
...
let code_autocomplete_mod_filter : 'Auu____9236 . ('Auu____9236 * FStar_Interactive_CompletionTable.mod_symbol)  ->  ('Auu____9236 * FStar_Interactive_CompletionTable.mod_symbol) FStar_Pervasives_Native.option = (fun uu___496_9251 -> (match (uu___496_9251) with
| (uu____9256, FStar_Interactive_CompletionTable.Namespace (uu____9257)) -> begin
FStar_Pervasives_Native.None
end
| (uu____9262, FStar_Interactive_CompletionTable.Module ({FStar_Interactive_CompletionTable.mod_name = uu____9263; FStar_Interactive_CompletionTable.mod_path = uu____9264; FStar_Interactive_CompletionTable.mod_loaded = true})) -> begin
FStar_Pervasives_Native.None
end
...
let uu___517_9281 = md
in (

let uu____9282 = (

let uu____9284 = (FStar_Interactive_CompletionTable.mod_name md)
in (Prims.strcat uu____9284 "."))
in {FStar_Interactive_CompletionTable.mod_name = uu____9282; FStar_Interactive_CompletionTable.mod_path = uu___517_9281.FStar_Interactive_CompletionTable.mod_path; FStar_Interactive_CompletionTable.mod_loaded = uu___517_9281.FStar_Interactive_CompletionTable.mod_loaded}))
in FStar_Interactive_CompletionTable.Module (uu____9280))
in ((pth), (uu____9279)))
in FStar_Pervasives_Native.Some (uu____9274))
end))


let run_code_autocomplete : 'Auu____9298 . repl_state  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____9298) FStar_Util.either) = (fun st search_term -> (
...
let run_module_autocomplete : 'Auu____9360 'Auu____9361 'Auu____9362 . repl_state  ->  Prims.string  ->  'Auu____9360  ->  'Auu____9361  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____9362) FStar_Util.either) = (fun st search_term modules1 namespaces -> (
...
let uu____9442 = (match (opt.opt_permission_level) with
| OptSet -> begin
((true), (""))
end
| OptReset -> begin
...
let run_option_autocomplete : 'Auu____9505 'Auu____9506 . 'Auu____9505  ->  Prims.string  ->  Prims.bool  ->  ((query_status * FStar_Util.json) * ('Auu____9505, 'Auu____9506) FStar_Util.either) = (fun st search_term is_reset -> (

let uu____9538 = (trim_option_name search_term)
...
| (uu____9600, uu____9601) -> begin
((((QueryNOK), (FStar_Util.JsonStr ("Options should start with \'--\'")))), (FStar_Util.Inl (st)))
end)))


let run_autocomplete : 'Auu____9624 . repl_state  ->  Prims.string  ->  completion_context  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____9624) FStar_Util.either) = (fun st search_term context -> (match (context) with
| CKCode -> begin
...
let run_and_rewind : 'Auu____9675 'Auu____9676 . repl_state  ->  'Auu____9675  ->  (repl_state  ->  'Auu____9675)  ->  ('Auu____9675 * (repl_state, 'Auu____9676) FStar_Util.either) = (fun st sigint_default task -> (

let st1 = (push_repl "run_and_rewind" FullCheck Noop st)
in (

let results = (FStar_All.try_with (fun uu___519_9717 -> (match (()) with
| () -> begin
(FStar_Util.with_sigint_handler FStar_Util.sigint_raise (fun uu____9728 -> (

let uu____9729 = (task st1)
in (FStar_All.pipe_left (fun _0_15 -> FStar_Util.Inl (_0_15)) uu____9729))))
end)) (fun uu___518_9735 -> (match (uu___518_9735) with
| FStar_Util.SigInt -> begin
...
let run_with_parsed_and_tc_term : 'Auu____9782 'Auu____9783 'Auu____9784 . repl_state  ->  Prims.string  ->  'Auu____9782  ->  'Auu____9783  ->  (FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  (query_status * FStar_Util.json))  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____9784) FStar_Util.either) = (fun st term line column continuation -> (
...
| ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let ((uu____9885, ({FStar_Syntax_Syntax.lbname = uu____9886; FStar_Syntax_Syntax.lbunivs = univs1; FStar_Syntax_Syntax.lbtyp = uu____9888; FStar_Syntax_Syntax.lbeff = uu____9889; FStar_Syntax_Syntax.lbdef = def; FStar_Syntax_Syntax.lbattrs = uu____9891; FStar_Syntax_Syntax.lbpos = uu____9892})::[]), uu____9893); FStar_Syntax_Syntax.sigrng = uu____9894; FStar_Syntax_Syntax.sigquals = uu____9895; FStar_Syntax_Syntax.sigmeta = uu____9896; FStar_Syntax_Syntax.sigattrs = uu____9897})::[] -> begin
...
let uu____9957 = (FStar_Parser_ParseIt.parse (FStar_Parser_ParseIt.Toplevel (frag)))
in (match (uu____9957) with
| FStar_Parser_ParseIt.ASTFragment (FStar_Util.Inr (decls), uu____9963) -> begin
...
let uu____10007 = (FStar_ToSyntax_ToSyntax.decls_to_sigelts decls)
in (uu____10007 env.FStar_TypeChecker_Env.dsenv))
in (FStar_Pervasives_Native.fst uu____10002)))
in (

let typecheck = (fun tcenv decls -> (

let uu____10031 = (FStar_TypeChecker_Tc.tc_decls tcenv decls)
in (match (uu____10031) with
| (ses, uu____10045, uu____10046) -> begin
ses
end)))
...
let uu____10129 = (FStar_Syntax_Subst.open_univ_vars univs1 def)
...
let uu____10141 = (FStar_Options.trace_error ())
in (match (uu____10141) with
| true -> begin
(aux ())
end
| uu____10148 -> begin
(FStar_All.try_with (fun uu___521_10155 -> (match (()) with
| () -> begin
(aux ())
end)) (fun uu___520_10164 -> (

let uu____10169 = (FStar_Errors.issue_of_exn uu___520_10164)
...
let uu____10178 = (FStar_Errors.format_issue issue)
in FStar_Util.JsonStr (uu____10178))
in ((QueryNOK), (uu____10177)))
end
| FStar_Pervasives_Native.None -> begin
(FStar_Exn.raise uu___520_10164)
end))))
end)))
end))))))))))))


let run_compute : 'Auu____10193 . repl_state  ->  Prims.string  ->  FStar_TypeChecker_Env.step Prims.list FStar_Pervasives_Native.option  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____10193) FStar_Util.either) = (fun st term rules -> (
...
let uu____10272 = (term_to_string tcenv normalized)
in FStar_Util.JsonStr (uu____10272))
in ((QueryOK), (uu____10271)))))))))
...
let st_cost : search_term'  ->  Prims.int = (fun uu___497_10366 -> (match (uu___497_10366) with
...
let uu____10588 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____10595 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {sc_lid = lid; sc_typ = uu____10588; sc_fvars = uu____10595})))


let sc_typ : FStar_TypeChecker_Env.env  ->  search_candidate  ->  FStar_Syntax_Syntax.typ = (fun tcenv sc -> (

let uu____10663 = (FStar_ST.op_Bang sc.sc_typ)
...
let uu____10691 = (FStar_TypeChecker_Env.try_lookup_lid tcenv sc.sc_lid)
in (match (uu____10691) with
| FStar_Pervasives_Native.None -> begin
(FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown FStar_Pervasives_Native.None FStar_Range.dummyRange)
end
| FStar_Pervasives_Native.Some ((uu____10710, typ), uu____10712) -> begin
typ
end))
...
let uu____10762 = (FStar_ST.op_Bang sc.sc_fvars)
...
let uu____10806 = (sc_typ tcenv sc)
in (FStar_Syntax_Free.fvars uu____10806))
...
let uu____10850 = (sc_typ tcenv sc)
in (term_to_string tcenv uu____10850))
in (
...
let uu____10868 = (FStar_Syntax_DsEnv.shorten_lid tcenv.FStar_TypeChecker_Env.dsenv sc.sc_lid)
in uu____10868.FStar_Ident.str)
in FStar_Util.JsonStr (uu____10866))
in (("lid"), (uu____10865)))
in (uu____10859)::((("type"), (FStar_Util.JsonStr (typ_str))))::[])
in FStar_Util.JsonAssoc (uu____10851))))

exception InvalidSearch of (Prims.string)


let uu___is_InvalidSearch : Prims.exn  ->  Prims.bool = (fun projectee -> (match (projectee) with
| InvalidSearch (uu____10901) -> begin
true
end
| uu____10904 -> begin
false
...
| InvalidSearch (uu____10915) -> begin
uu____10915
end))


let run_search : 'Auu____10924 . repl_state  ->  Prims.string  ->  ((query_status * FStar_Util.json) * (repl_state, 'Auu____10924) FStar_Util.either) = (fun st search_str -> (
...
let uu____10971 = (sc_fvars tcenv candidate)
in (FStar_Util.set_mem lid uu____10971))
end)
...
let uu____11031 = (FStar_Util.format1 "Improperly quoted search term: %s" term1)
in InvalidSearch (uu____11031))
in (FStar_Exn.raise uu____11030))
end
| uu____11034 -> begin
...
let uu____11037 = (strip_quotes term1)
in NameContainsStr (uu____11037))
end
| uu____11039 -> begin
(
...
let uu____11042 = (FStar_Syntax_DsEnv.resolve_to_fully_qualified_name tcenv.FStar_TypeChecker_Env.dsenv lid)
...
let uu____11046 = (FStar_Util.format1 "Unknown identifier: %s" term1)
in InvalidSearch (uu____11046))
in (FStar_Exn.raise uu____11045))
end
...
let uu____11074 = (match (term.st_term) with
...
let results = (FStar_All.try_with (fun uu___523_11108 -> (match (()) with
| () -> begin
(
...
let uu____11156 = (FStar_List.map pprint_one terms)
in (FStar_Util.concat_l " " uu____11156))
in (

let uu____11162 = (

let uu____11163 = (FStar_Util.format1 "No results found for query [%s]" kwds)
in InvalidSearch (uu____11163))
in (FStar_Exn.raise uu____11162)))
end
| uu____11170 -> begin
((QueryOK), (FStar_Util.JsonList (js)))
end)))))))))
end)) (fun uu___522_11175 -> (match (uu___522_11175) with
...
| Push ({push_kind = SyntaxCheck; push_code = uu____11301; push_line = uu____11302; push_column = uu____11303; push_peek_only = false}) -> begin
...
let uu____11384 = (validate_and_run_query st query)
...
let uu____11450 = (deserialize_interactive_query query_js)
in (js_repl_eval st uu____11450)))
...
let uu____11484 = (parse_interactive_query query_str)
in (js_repl_eval st uu____11484))
in (match (uu____11474) with
| (js_response, st_opt) -> begin
(

let uu____11507 = (FStar_Util.string_of_json js_response)
in ((uu____11507), (st_opt)))
end)))


let js_repl_init_opts : unit  ->  unit = (fun uu____11520 -> (

let uu____11521 = (FStar_Options.parse_cmd_line ())
...
| (h)::(uu____11544)::uu____11545 -> begin
...
let uu____11567 = (validate_and_run_query st query)
...
let uu____11623 = (FStar_ST.op_Bang issues)
in (e)::uu____11623)
in (FStar_ST.op_Colon_Equals issues uu____11620)))
in (

let count_errors = (fun uu____11721 -> (

let uu____11722 = (

let uu____11725 = (FStar_ST.op_Bang issues)
in (FStar_List.filter (fun e -> (Prims.op_Equality e.FStar_Errors.issue_level FStar_Errors.EError)) uu____11725))
in (FStar_List.length uu____11722)))
in (

let report = (fun uu____11782 -> (

let uu____11783 = (FStar_ST.op_Bang issues)
in (FStar_List.sortWith FStar_Errors.compare_issues uu____11783)))
in (

let clear1 = (fun uu____11836 -> (FStar_ST.op_Colon_Equals issues []))
...
let uu____11923 = (get_json ())
in (forward_message printer label uu____11923)))})
...
let uu____11937 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____11940 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____11937 uu____11940)))
...
let uu____11954 = (FStar_Util.open_stdin ())
in {repl_line = (Prims.parse_int "1"); repl_column = (Prims.parse_int "0"); repl_fname = filename; repl_deps_stack = []; repl_curmod = FStar_Pervasives_Native.None; repl_env = env1; repl_stdin = uu____11954; repl_names = FStar_Interactive_CompletionTable.empty}))))


let interactive_mode' : 'Auu____11970 . repl_state  ->  'Auu____11970 = (fun init_st -> ((write_hello ());
(

let exit_code = (

let uu____11979 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____11985 = (FStar_Options.file_list ())
in (FStar_List.hd uu____11985))
in (FStar_SMTEncoding_Solver.with_hints_db uu____11983 (fun uu____11992 -> (go init_st))))
end
| uu____11993 -> begin
(go init_st)
end))
...
let uu____12008 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____12008))
...
let uu____12017 = (FStar_Options.trace_error ())
in (match (uu____12017) with
| true -> begin
(interactive_mode' init1)
end
| uu____12020 -> begin
(FStar_All.try_with (fun uu___525_12023 -> (match (()) with
| () -> begin
(interactive_mode' init1)
end)) (fun uu___524_12026 -> ((FStar_Errors.set_handler FStar_Errors.default_handler);
(FStar_Exn.raise uu___524_12026);
)))
end)));
))
