        ...
        fun st  ->
          ...
          | (depth,env) ->
              ((let uu____965 =
               ...
               (let uu___445_1035 = st  in
                let uu____1036 = set_check_kind env push_kind  in
                {
                  repl_line = (uu___445_1035.repl_line);
                  repl_column = (uu___445_1035.repl_column);
                  repl_fname = (uu___445_1035.repl_fname);
                  repl_deps_stack = (uu___445_1035.repl_deps_stack);
                  repl_curmod = (uu___445_1035.repl_curmod);
                  repl_env = uu____1036;
                  repl_stdin = (uu___445_1035.repl_stdin);
                  repl_names = (uu___445_1035.repl_names)
                }))
...
let (commit_name_tracking :
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___446_1412 = st  in
      {
        repl_line = (uu___446_1412.repl_line);
        repl_column = (uu___446_1412.repl_column);
        repl_fname = (uu___446_1412.repl_fname);
        repl_deps_stack = (uu___446_1412.repl_deps_stack);
        repl_curmod = (uu___446_1412.repl_curmod);
        repl_env = (uu___446_1412.repl_env);
        repl_stdin = (uu___446_1412.repl_stdin);
        repl_names = names1
      }
                   ...
                   (match uu____2260 with
                    | (env2,name_events) ->
                        let st2 =
                          ...
                          then
                            let st2 =
                              let uu___447_2279 = st1  in
                              {
                                repl_line = (uu___447_2279.repl_line);
                                repl_column = (uu___447_2279.repl_column);
                                repl_fname = (uu___447_2279.repl_fname);
                                repl_deps_stack =
                                  (uu___447_2279.repl_deps_stack);
                                repl_curmod = curmod;
                                repl_env = env2;
                                repl_stdin = (uu___447_2279.repl_stdin);
                                repl_names = (uu___447_2279.repl_names)
                              }  in
  ...
  fun st  ->
    fun tasks  ->
      fun progress_callback  ->
        ...
        let rec revert_many st1 uu___429_2343 =
          match uu___429_2343 with
          | [] -> st1
              ...
              (debug1 "Loading" task;
               ...
               (let timestamped_task = update_task_timestamps task  in
                ...
                | (success,st2) ->
                    ...
                    then
                      let uu____2463 =
                        let uu___448_2464 = st2  in
                        let uu____2465 = FStar_ST.op_Bang repl_stack  in
                        {
                          repl_line = (uu___448_2464.repl_line);
                          repl_column = (uu___448_2464.repl_column);
                          repl_fname = (uu___448_2464.repl_fname);
                          repl_deps_stack = uu____2465;
                          repl_curmod = (uu___448_2464.repl_curmod);
                          repl_env = (uu___448_2464.repl_env);
                          repl_stdin = (uu___448_2464.repl_stdin);
                          repl_names = (uu___448_2464.repl_names)
                        }  in
...
let (js_int : FStar_Util.json -> Prims.int) =
  fun uu___431_2616  ->
    match uu___431_2616 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let (js_str : FStar_Util.json -> Prims.string) =
  fun uu___432_2623  ->
    match uu___432_2623 with
...
let (update_option : fstar_option -> fstar_option) =
  fun opt  ->
    let uu___453_4782 = opt  in
    let uu____4783 = FStar_Options.get_option opt.opt_name  in
    {
      opt_name = (uu___453_4782.opt_name);
      opt_sig = (uu___453_4782.opt_sig);
      opt_value = uu____4783;
      opt_default = (uu___453_4782.opt_default);
      opt_type = (uu___453_4782.opt_type);
      opt_snippets = (uu___453_4782.opt_snippets);
      opt_documentation = (uu___453_4782.opt_documentation);
      opt_permission_level = (uu___453_4782.opt_permission_level)
    }
...
let (load_deps :
  ...
  fun st  ->
    ...
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___454_5628 = st  in
          let uu____5629 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1  in
          {
            repl_line = (uu___454_5628.repl_line);
            repl_column = (uu___454_5628.repl_column);
            repl_fname = (uu___454_5628.repl_fname);
            repl_deps_stack = (uu___454_5628.repl_deps_stack);
            repl_curmod = (uu___454_5628.repl_curmod);
            repl_env = uu____5629;
            repl_stdin = (uu___454_5628.repl_stdin);
            repl_names = (uu___454_5628.repl_names)
          }  in
        let uu____5630 =
...
let (rephrase_dependency_error : FStar_Errors.issue -> FStar_Errors.issue) =
  fun issue  ->
       ...
       in
    {
      ...
      FStar_Errors.issue_level = (uu___455_5676.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___455_5676.FStar_Errors.issue_range);
      FStar_Errors.issue_number = (uu___455_5676.FStar_Errors.issue_number)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___456_5718 = st1  in
        {
          repl_line = (uu___456_5718.repl_line);
          repl_column = (uu___456_5718.repl_column);
          repl_fname = (uu___456_5718.repl_fname);
          repl_deps_stack = (uu___456_5718.repl_deps_stack);
          repl_curmod = (uu___456_5718.repl_curmod);
          repl_env =
            (let uu___457_5720 = st1.repl_env  in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___457_5720.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___457_5720.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___457_5720.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___457_5720.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_sig =
                 (uu___457_5720.FStar_TypeChecker_Env.gamma_sig);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___457_5720.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___457_5720.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___457_5720.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___457_5720.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.attrtab =
                 (uu___457_5720.FStar_TypeChecker_Env.attrtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___457_5720.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___457_5720.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___457_5720.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___457_5720.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___457_5720.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___457_5720.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___457_5720.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___457_5720.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___457_5720.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___457_5720.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___457_5720.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___457_5720.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.phase1 =
                 (uu___457_5720.FStar_TypeChecker_Env.phase1);
               FStar_TypeChecker_Env.failhard =
                 (uu___457_5720.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.uvar_subtyping =
                 (uu___457_5720.FStar_TypeChecker_Env.uvar_subtyping);
               FStar_TypeChecker_Env.tc_term =
                 (uu___457_5720.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___457_5720.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___457_5720.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.check_type_of =
                 (uu___457_5720.FStar_TypeChecker_Env.check_type_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___457_5720.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qtbl_name_and_index =
                 (uu___457_5720.FStar_TypeChecker_Env.qtbl_name_and_index);
               FStar_TypeChecker_Env.normalized_eff_names =
                 (uu___457_5720.FStar_TypeChecker_Env.normalized_eff_names);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___457_5720.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth_hook =
                 (uu___457_5720.FStar_TypeChecker_Env.synth_hook);
               FStar_TypeChecker_Env.splice =
                 (uu___457_5720.FStar_TypeChecker_Env.splice);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___457_5720.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___457_5720.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___457_5720.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___457_5720.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___457_5720.FStar_TypeChecker_Env.dep_graph)
             });
          repl_stdin = (uu___456_5718.repl_stdin);
          repl_names = (uu___456_5718.repl_names)
        }  in
           ...
           (let st1 = set_nosynth_flag st peek_only  in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___458_5776 = st3  in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___458_5776.repl_fname);
                      repl_deps_stack = (uu___458_5776.repl_deps_stack);
                      repl_curmod = (uu___458_5776.repl_curmod);
                      repl_env = (uu___458_5776.repl_env);
                      repl_stdin = (uu___458_5776.repl_stdin);
                      repl_names = (uu___458_5776.repl_names)
                    }
                  else st3  in
           ...
           ((let uu____5972 = FStar_Options.restore_cmd_line_options false
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___459_5975 = st1  in
                {
                  repl_line = (uu___459_5975.repl_line);
                  repl_column = (uu___459_5975.repl_column);
                  repl_fname = (uu___459_5975.repl_fname);
                  repl_deps_stack = (uu___459_5975.repl_deps_stack);
                  repl_curmod = (uu___459_5975.repl_curmod);
                  repl_env = (uu___459_5975.repl_env);
                  repl_stdin = (uu___459_5975.repl_stdin);
                  repl_names = names1
                }) query)))
            ...
            let uu____7403 =
                ...
                Prims.strcat uu____7406 "."  in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___460_7404.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___460_7404.FStar_Interactive_CompletionTable.mod_loaded)
              }  in
