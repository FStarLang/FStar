...
let commit_name_tracking:
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___93_1191 = st in
      {
        repl_line = (uu___93_1191.repl_line);
        repl_column = (uu___93_1191.repl_column);
        repl_fname = (uu___93_1191.repl_fname);
        repl_deps_stack = (uu___93_1191.repl_deps_stack);
        repl_curmod = (uu___93_1191.repl_curmod);
        repl_env = (uu___93_1191.repl_env);
        repl_stdin = (uu___93_1191.repl_stdin);
        repl_names = names1
      }
              ...
              (match uu____1941 with
               | (curmod,env2,success) ->
                   ...
                   (match uu____2007 with
                    | (env',name_events) ->
                        let st1 =
                          let uu___94_2025 = st in
                          {
                            repl_line = (uu___94_2025.repl_line);
                            repl_column = (uu___94_2025.repl_column);
                            repl_fname = (uu___94_2025.repl_fname);
                            repl_deps_stack = (uu___94_2025.repl_deps_stack);
                            repl_curmod = curmod;
                            repl_env = env2;
                            repl_stdin = (uu___94_2025.repl_stdin);
                            repl_names = (uu___94_2025.repl_names)
                          } in
                        let st2 =
                          if success
...
let run_repl_ld_transactions:
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___77_2064 =
        match uu___77_2064 with
        | [] -> st1
        | (task,_st')::entries ->
            ...
            (debug1 "Loading" task;
             ...
             (let timestamped_task = update_task_timestamps task in
              ...
              | (success,st2) ->
                  ...
                  then
                    let uu____2156 =
                      let uu___95_2157 = st2 in
                      let uu____2158 = FStar_ST.op_Bang repl_stack in
                      {
                        repl_line = (uu___95_2157.repl_line);
                        repl_column = (uu___95_2157.repl_column);
                        repl_fname = (uu___95_2157.repl_fname);
                        repl_deps_stack = uu____2158;
                        repl_curmod = (uu___95_2157.repl_curmod);
                        repl_env = (uu___95_2157.repl_env);
                        repl_stdin = (uu___95_2157.repl_stdin);
                        repl_names = (uu___95_2157.repl_names)
                      } in
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___79_2322  ->
    match uu___79_2322 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___80_2327  ->
    match uu___80_2327 with
...
let update_option: fstar_option -> fstar_option =
  fun opt  ->
    let uu___100_4259 = opt in
    let uu____4260 = FStar_Options.get_option opt.opt_name in
    {
      opt_name = (uu___100_4259.opt_name);
      opt_sig = (uu___100_4259.opt_sig);
      opt_value = uu____4260;
      opt_default = (uu___100_4259.opt_default);
      opt_type = (uu___100_4259.opt_type);
      opt_snippets = (uu___100_4259.opt_snippets);
      opt_documentation = (uu___100_4259.opt_documentation);
      opt_permission_level = (uu___100_4259.opt_permission_level)
    }
...
let load_deps:
  ...
  fun st  ->
    ...
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___101_4948 = st in
          let uu____4949 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1 in
          {
            repl_line = (uu___101_4948.repl_line);
            repl_column = (uu___101_4948.repl_column);
            repl_fname = (uu___101_4948.repl_fname);
            repl_deps_stack = (uu___101_4948.repl_deps_stack);
            repl_curmod = (uu___101_4948.repl_curmod);
            repl_env = uu____4949;
            repl_stdin = (uu___101_4948.repl_stdin);
            repl_names = (uu___101_4948.repl_names)
          } in
...
let rephrase_dependency_error: FStar_Errors.issue -> FStar_Errors.issue =
  fun issue  ->
    let uu___102_4984 = issue in
    let uu____4985 =
      FStar_Util.format1 "Error while computing or loading dependencies:\n%s"
        issue.FStar_Errors.issue_message in
    {
      FStar_Errors.issue_message = uu____4985;
      FStar_Errors.issue_level = (uu___102_4984.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___102_4984.FStar_Errors.issue_range);
      FStar_Errors.issue_number = (uu___102_4984.FStar_Errors.issue_number)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___103_5017 = st1 in
        {
          repl_line = (uu___103_5017.repl_line);
          repl_column = (uu___103_5017.repl_column);
          repl_fname = (uu___103_5017.repl_fname);
          repl_deps_stack = (uu___103_5017.repl_deps_stack);
          repl_curmod = (uu___103_5017.repl_curmod);
          repl_env =
            (let uu___104_5019 = st1.repl_env in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___104_5019.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___104_5019.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___104_5019.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___104_5019.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___104_5019.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___104_5019.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___104_5019.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___104_5019.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___104_5019.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___104_5019.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___104_5019.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___104_5019.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___104_5019.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___104_5019.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___104_5019.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___104_5019.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___104_5019.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___104_5019.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___104_5019.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___104_5019.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___104_5019.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___104_5019.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___104_5019.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___104_5019.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___104_5019.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qname_and_index =
                 (uu___104_5019.FStar_TypeChecker_Env.qname_and_index);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___104_5019.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth =
                 (uu___104_5019.FStar_TypeChecker_Env.synth);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___104_5019.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___104_5019.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___104_5019.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___104_5019.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___104_5019.FStar_TypeChecker_Env.dep_graph)
             });
          repl_stdin = (uu___103_5017.repl_stdin);
          repl_names = (uu___103_5017.repl_names)
        } in
           ...
           (let st1 = set_nosynth_flag st peek_only in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___105_5075 = st3 in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___105_5075.repl_fname);
                      repl_deps_stack = (uu___105_5075.repl_deps_stack);
                      repl_curmod = (uu___105_5075.repl_curmod);
                      repl_env = (uu___105_5075.repl_env);
                      repl_stdin = (uu___105_5075.repl_stdin);
                      repl_names = (uu___105_5075.repl_names)
                    }
                  else st3 in
           ...
           ((let uu____5256 = FStar_Options.restore_cmd_line_options false in
            ...
            (let names1 =
             ...
             run_push_without_deps
               (let uu___106_5259 = st1 in
                {
                  repl_line = (uu___106_5259.repl_line);
                  repl_column = (uu___106_5259.repl_column);
                  repl_fname = (uu___106_5259.repl_fname);
                  repl_deps_stack = (uu___106_5259.repl_deps_stack);
                  repl_curmod = (uu___106_5259.repl_curmod);
                  repl_env = (uu___106_5259.repl_env);
                  repl_stdin = (uu___106_5259.repl_stdin);
                  repl_names = names1
                }) query)))
let run_push:
  'Auu____5263 .
            ...
            let uu____6610 =
                ...
                Prims.strcat uu____6613 "." in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___107_6611.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___107_6611.FStar_Interactive_CompletionTable.mod_loaded)
              } in
