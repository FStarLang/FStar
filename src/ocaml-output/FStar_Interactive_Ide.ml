        ...
        let uu____3202 =
          let uu____3210 =
            let uu____3216 =
              ...
              json_of_opt (fun _3247 -> FStar_Util.JsonStr _3247) uu____3217 in
                ...
                FStar_All.pipe_right uu____3429
                  (FStar_Util.map_option
                     (fun default_value ->
                        ...
                        let uu____3443 = snippets_of_fstar_option name typ in
                        let uu____3447 =
    ...
    let uu____3597 =
      let uu____3605 =
        let uu____3611 =
          let uu____3612 =
            ...
            FStar_List.map (fun _3629 -> FStar_Util.JsonStr _3629) uu____3615 in
      ...
      let uu____3632 =
        let uu____3640 =
          let uu____3646 =
            let uu____3647 =
              let uu____3650 = current_fstar_options (fun uu____3655 -> true) in
    ...
    fun code ->
      ...
      let collect_decls uu____3924 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____3937, decls, uu____3939)) -> decls in
      let uu____3946 =
        with_captured_errors st.FStar_JsonHelper.repl_env
          ...
          (fun uu____3955 ->
             ...
             FStar_All.pipe_left
               (fun _3967 -> FStar_Pervasives_Native.Some _3967) uu____3956) in
      match uu____3946 with
      | FStar_Pervasives_Native.None ->
          let errors =
            let uu____3985 = collect_errors () in
            FStar_All.pipe_right uu____3985 (FStar_List.map json_of_issue) in
    ...
    let uu____4310 =
      with_captured_errors st.FStar_JsonHelper.repl_env
        ...
        (fun _env ->
           ...
           FStar_All.pipe_left
             (fun _4385 -> FStar_Pervasives_Native.Some _4385) uu____4338) in
    ...
    fun query ->
      ...
      (let uu____4665 = load_deps st in
       ...
       | FStar_Util.Inl (st1, deps) ->
           ((let uu____4734 = FStar_Options.restore_cmd_line_options false in
        ...
        fun requested_info ->
          let uu____4836 =
            FStar_Interactive_QueryHelper.symlookup
              st.FStar_JsonHelper.repl_env symbol pos_opt requested_info in
...
let (run_code_lookup :
  ...
  fun st ->
    fun symbol ->
      fun pos_opt ->
        fun requested_info ->
          let uu____5255 = run_symbol_lookup st symbol pos_opt requested_info in
          ...
          FStar_Interactive_QueryHelper.position
            ...
            Prims.string Prims.list ->
              ((query_status * FStar_Util.json) *
                (FStar_JsonHelper.repl_state, 'Auu____5532)
                FStar_Util.either)
  =
  fun st ->
    fun symbol ->
        ...
        fun namespaces ->
          ...
          let mods_and_nss =
            FStar_Interactive_CompletionTable.autocomplete_mod_or_ns
              ...
              (fun _5791 -> FStar_Pervasives_Native.Some _5791) in
          let json =
            FStar_List.map
      ...
      fun task ->
        let st1 =
          FStar_Interactive_PushHelper.push_repl "run_and_rewind"
            FStar_Interactive_PushHelper.FullCheck FStar_JsonHelper.Noop st in
        let results =
          try
            (fun uu___725_6100 ->
               match () with
        ...
        'Auu____6166 ->
          'Auu____6167 ->
            (FStar_TypeChecker_Env.env ->
              ...
              ->
              ((query_status * FStar_Util.json) *
                (FStar_JsonHelper.repl_state, 'Auu____6168)
                FStar_Util.either)
  =
  fun st ->
    fun term ->
            ...
            let find_let_body ses =
              ...
              | {
                  FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
                    ((uu____6270,
                      { FStar_Syntax_Syntax.lbname = uu____6271;
                        ...
                        FStar_Syntax_Syntax.lbpos = uu____6277;_}::[]),
                     uu____6278);
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____7219 in
