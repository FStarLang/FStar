        ...
        FStar_ToSyntax_Env.ds_push_include_hook =
          (fun dsenv  ->
             fun ns  ->
               let uu____1420 =
                 let uu____1421 =
                   let uu____1426 = FStar_ToSyntax_Env.current_module dsenv
                      in
                   (uu____1426, ns)  in
          ...
          (fun dsenv  ->
             fun x  ->
               fun l  ->
                 let uu____1434 =
                   let uu____1435 =
                     let uu____1442 = FStar_ToSyntax_Env.current_module dsenv
                        in
                     (uu____1442, x, l)  in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1486 =
        FStar_Universal.with_tcenv env1
          (fun dsenv  ->
             let uu____1494 = FStar_ToSyntax_Env.set_ds_hooks dsenv dshooks
                in
             ((), uu____1494))
         in
    ...
    | (old_dshooks,old_tchooks) ->
        ...
        (match uu____1517 with
         | (events,new_dshooks,new_tchooks) ->
             ...
             (uu____1551,
               ((fun env1  ->
                   let uu____1564 = set_hooks old_dshooks old_tchooks env1
                      in
                   let uu____1565 =
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___77_2100 =
        ...
        | (task,_st')::entries ->
            ((let uu____2125 = Obj.magic ()  in ());
             ...
             (let uu____2127 = pop_repl st1  in
              revert_many uu____2127 entries))
         in
      let rec aux st1 tasks1 previous =
        ...
        | (task::tasks2,[]) ->
            (debug1 "Loading" task;
             (let uu____2172 = FStar_Options.restore_cmd_line_options false
                 in
  ...
  fun key  ->
    fun a  ->
      let uu____2959 =
        FStar_Util.try_find
          (fun uu____2973  ->
             match uu____2973 with | (k,uu____2979) -> k = key) a
         in
    ...
    try
      ...
      let uu____3083 =
        ...
        | "lookup" ->
            let uu____3117 =
              ...
              let uu____3132 =
                ...
                FStar_All.pipe_right uu____3133 js_optional_lookup_context
                 in
              let uu____3138 =
                let uu____3147 =
                ...
                FStar_All.pipe_right uu____3147
                  (FStar_Util.map_option
                     (fun loc  ->
                        let uu____3214 =
                          let uu____3215 = assoc1 "[location]" "filename" loc
                             in
                        ...
                        let uu____3218 =
                          let uu____3219 = assoc1 "[location]" "column" loc
                             in
                          FStar_All.pipe_right uu____3219 js_int  in
                        (uu____3214, uu____3216, uu____3218)))
                 in
              let uu____3220 =
        ...
        | "vfs-add" ->
            ...
            VfsAdd uu____3269
        | uu____3290 ->
            let uu____3291 = FStar_Util.format1 "Unknown query '%s'" query
               in
            ProtocolViolation uu____3291
         in
      { qq = uu____3083; qid }
              ...
              let uu____3458 =
                let uu____3461 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____3467 = json_of_use_range r  in [uu____3467]
                   in
                let uu____3468 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____3713 =
      FStar_List.map (fun _0_68  -> FStar_Util.JsonStr _0_68)
       ...
       in
    FStar_All.pipe_left (fun _0_69  -> FStar_Util.JsonList _0_69) uu____3713
     in
                ...
                FStar_All.pipe_right uu____4252
                  (FStar_Util.map_option
                     (fun default_value  ->
                        ...
                        let uu____4265 = snippets_of_fstar_option name typ
                           in
                        let uu____4268 =
                          ...
                          then OptSet
                            ...
                            (let uu____4271 = FStar_Options.resettable name
                                in
                             if uu____4271 then OptReset else OptReadOnly)
                           in
                        {
                          opt_name = name;
                          opt_sig = uu____4264;
    ...
    fun code  ->
      ...
      let collect_decls uu____4636 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____4649,decls,uu____4651)) -> decls
         in
      let uu____4656 =
        with_captured_errors st.repl_env
          (fun uu____4665  ->
             ...
             FStar_All.pipe_left
               (fun _0_73  -> FStar_Pervasives_Native.Some _0_73) uu____4666)
         in
      match uu____4656 with
      | FStar_Pervasives_Native.None  ->
          let errors =
            let uu____4694 = collect_errors ()  in
            FStar_All.pipe_right uu____4694 (FStar_List.map json_of_issue)
             in
...
let load_deps :
  ...
  fun st  ->
    let uu____4867 =
      with_captured_errors st.repl_env
        (fun _env  ->
           let uu____4893 = deps_and_repl_ld_tasks_of_our_file st.repl_fname
              in
           FStar_All.pipe_left
             (fun _0_75  -> FStar_Pervasives_Native.Some _0_75) uu____4893)
       in
    ...
    fun deps  ->
      fun table  ->
        ...
        let loaded_mods_set =
          ...
          let uu____5153 =
            let uu____5156 = FStar_Options.prims ()  in uu____5156 :: deps
             in
          FStar_List.fold_left
            (fun acc  ->
               fun dep1  ->
                 let uu____5166 = FStar_Parser_Dep.lowercase_module_name dep1
                    in
    ...
    fun query  ->
      ...
      (let uu____5228 = load_deps st  in
       ...
       | FStar_Util.Inl (st1,deps) ->
           ((let uu____5292 = FStar_Options.restore_cmd_line_options false
                in
      ...
      fun pos_opt  ->
        fun requested_info  ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____5407 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1
               in
            FStar_All.pipe_right uu____5407
              (FStar_Util.map_option
                 (fun uu____5462  ->
                    match uu____5462 with
                    | ((uu____5481,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
             in
          let docs_of_lid lid =
            let uu____5498 =
...
let run_code_lookup :
  ...
  fun st  ->
    fun symbol  ->
      fun pos_opt  ->
        fun requested_info  ->
          let uu____6248 = run_symbol_lookup st symbol pos_opt requested_info
             in
...
let json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____8057 = sc_typ tcenv sc  in term_to_string tcenv uu____8057
         in
      let uu____8058 =
        let uu____8065 =
          let uu____8070 =
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____8138
           in
