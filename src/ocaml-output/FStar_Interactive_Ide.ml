    ...
    fun check_kind  ->
         ...
         in
      {
        FStar_TypeChecker_Env.solver =
          (uu___383_49.FStar_TypeChecker_Env.solver);
        FStar_TypeChecker_Env.range =
          (uu___383_49.FStar_TypeChecker_Env.range);
        FStar_TypeChecker_Env.curmodule =
          (uu___383_49.FStar_TypeChecker_Env.curmodule);
        FStar_TypeChecker_Env.gamma =
          (uu___383_49.FStar_TypeChecker_Env.gamma);
        FStar_TypeChecker_Env.gamma_cache =
          (uu___383_49.FStar_TypeChecker_Env.gamma_cache);
        FStar_TypeChecker_Env.modules =
          (uu___383_49.FStar_TypeChecker_Env.modules);
        FStar_TypeChecker_Env.expected_typ =
          (uu___383_49.FStar_TypeChecker_Env.expected_typ);
        FStar_TypeChecker_Env.sigtab =
          (uu___383_49.FStar_TypeChecker_Env.sigtab);
        FStar_TypeChecker_Env.is_pattern =
          (uu___383_49.FStar_TypeChecker_Env.is_pattern);
        FStar_TypeChecker_Env.instantiate_imp =
          (uu___383_49.FStar_TypeChecker_Env.instantiate_imp);
        FStar_TypeChecker_Env.effects =
          (uu___383_49.FStar_TypeChecker_Env.effects);
        FStar_TypeChecker_Env.generalize =
          (uu___383_49.FStar_TypeChecker_Env.generalize);
        FStar_TypeChecker_Env.letrecs =
          (uu___383_49.FStar_TypeChecker_Env.letrecs);
        FStar_TypeChecker_Env.top_level =
          (uu___383_49.FStar_TypeChecker_Env.top_level);
        FStar_TypeChecker_Env.check_uvars =
          (uu___383_49.FStar_TypeChecker_Env.check_uvars);
        FStar_TypeChecker_Env.use_eq =
          (uu___383_49.FStar_TypeChecker_Env.use_eq);
        FStar_TypeChecker_Env.is_iface =
          (uu___383_49.FStar_TypeChecker_Env.is_iface);
        FStar_TypeChecker_Env.admit =
          (uu___383_49.FStar_TypeChecker_Env.admit);
        FStar_TypeChecker_Env.lax = (check_kind = LaxCheck);
        FStar_TypeChecker_Env.lax_universes =
          (uu___383_49.FStar_TypeChecker_Env.lax_universes);
        FStar_TypeChecker_Env.failhard =
          (uu___383_49.FStar_TypeChecker_Env.failhard);
        FStar_TypeChecker_Env.nosynth =
          (uu___383_49.FStar_TypeChecker_Env.nosynth);
        FStar_TypeChecker_Env.tc_term =
          (uu___383_49.FStar_TypeChecker_Env.tc_term);
        FStar_TypeChecker_Env.type_of =
          (uu___383_49.FStar_TypeChecker_Env.type_of);
        FStar_TypeChecker_Env.universe_of =
          (uu___383_49.FStar_TypeChecker_Env.universe_of);
        FStar_TypeChecker_Env.use_bv_sorts =
          (uu___383_49.FStar_TypeChecker_Env.use_bv_sorts);
        FStar_TypeChecker_Env.qname_and_index =
          (uu___383_49.FStar_TypeChecker_Env.qname_and_index);
        FStar_TypeChecker_Env.proof_ns =
          (uu___383_49.FStar_TypeChecker_Env.proof_ns);
        FStar_TypeChecker_Env.synth =
          (uu___383_49.FStar_TypeChecker_Env.synth);
        FStar_TypeChecker_Env.is_native_tactic =
          (uu___383_49.FStar_TypeChecker_Env.is_native_tactic);
        FStar_TypeChecker_Env.identifier_info =
          (uu___383_49.FStar_TypeChecker_Env.identifier_info);
        FStar_TypeChecker_Env.tc_hooks =
          (uu___383_49.FStar_TypeChecker_Env.tc_hooks);
        FStar_TypeChecker_Env.dsenv = uu____50;
        FStar_TypeChecker_Env.dep_graph =
          (uu___383_49.FStar_TypeChecker_Env.dep_graph)
      }
...
let commit_name_tracking :
  ...
  fun st  ->
    fun name_events  ->
      ...
      let uu___386_1199 = st  in
      {
        repl_line = (uu___386_1199.repl_line);
        repl_column = (uu___386_1199.repl_column);
        repl_fname = (uu___386_1199.repl_fname);
        repl_deps_stack = (uu___386_1199.repl_deps_stack);
        repl_curmod = (uu___386_1199.repl_curmod);
        repl_env = (uu___386_1199.repl_env);
        repl_stdin = (uu___386_1199.repl_stdin);
        repl_names = names1
      }
        ...
        FStar_ToSyntax_Env.ds_push_open_hook =
          (fun dsenv  ->
             fun op  ->
               let uu____1388 =
                 let uu____1389 =
                   let uu____1394 = FStar_ToSyntax_Env.current_module dsenv
                      in
                   (uu____1394, op)  in
        ...
        FStar_ToSyntax_Env.ds_push_include_hook =
          (fun dsenv  ->
             fun ns  ->
               let uu____1400 =
                 let uu____1401 =
                   let uu____1406 = FStar_ToSyntax_Env.current_module dsenv
                      in
                   (uu____1406, ns)  in
          ...
          (fun dsenv  ->
             fun x  ->
               fun l  ->
                 let uu____1414 =
                   let uu____1415 =
                     let uu____1422 = FStar_ToSyntax_Env.current_module dsenv
                        in
                     (uu____1422, x, l)  in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1466 =
        FStar_Universal.with_tcenv env1
          (fun dsenv  ->
             let uu____1474 = FStar_ToSyntax_Env.set_ds_hooks dsenv dshooks
                in
             ((), uu____1474))
         in
    ...
    | (old_dshooks,old_tchooks) ->
        ...
        (match uu____1497 with
         | (events,new_dshooks,new_tchooks) ->
             ...
             (uu____1531,
               ((fun env1  ->
                   let uu____1544 = set_hooks old_dshooks old_tchooks env1
                      in
                   let uu____1545 =
        ...
        (match uu____1797 with
         | (same_name,real_deps) ->
             let intf_tasks =
               ...
               | intf::impl::[] ->
                   ((let uu____1834 =
                       let uu____1835 = FStar_Parser_Dep.is_interface intf
                          in
              ...
              (match uu____1937 with
               | (curmod,env2,success) ->
                   ...
                   (match uu____2003 with
                    | (env',name_events) ->
                        let st1 =
                          let uu___387_2021 = st  in
                          {
                            repl_line = (uu___387_2021.repl_line);
                            repl_column = (uu___387_2021.repl_column);
                            repl_fname = (uu___387_2021.repl_fname);
                            repl_deps_stack = (uu___387_2021.repl_deps_stack);
                            repl_curmod = curmod;
                            repl_env = env2;
                            repl_stdin = (uu___387_2021.repl_stdin);
                            repl_names = (uu___387_2021.repl_names)
                          }  in
                        let st2 =
                          if success
...
let run_repl_ld_transactions :
  ...
  fun st  ->
    fun tasks  ->
      ...
      let rec revert_many st1 uu___370_2060 =
        match uu___370_2060 with
        | [] -> st1
        | (task,_st')::entries ->
            ((let uu____2085 = Obj.magic ()  in ());
             debug1 "Reverting" task;
             (let uu____2087 = pop_repl st1  in
              revert_many uu____2087 entries))
         in
      let rec aux st1 tasks1 previous =
        ...
        | (task::tasks2,[]) ->
            (debug1 "Loading" task;
             (let uu____2132 = FStar_Options.restore_cmd_line_options false
                 in
             ...
             (let timestamped_task = update_task_timestamps task  in
              ...
              | (success,st2) ->
                  ...
                  then
                    let uu____2152 =
                      let uu___388_2153 = st2  in
                      let uu____2154 = FStar_ST.op_Bang repl_stack  in
                      {
                        repl_line = (uu___388_2153.repl_line);
                        repl_column = (uu___388_2153.repl_column);
                        repl_fname = (uu___388_2153.repl_fname);
                        repl_deps_stack = uu____2154;
                        repl_curmod = (uu___388_2153.repl_curmod);
                        repl_env = (uu___388_2153.repl_env);
                        repl_stdin = (uu___388_2153.repl_stdin);
                        repl_names = (uu___388_2153.repl_names)
                      }  in
...
let js_int : FStar_Util.json -> Prims.int =
  fun uu___372_2318  ->
    match uu___372_2318 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let js_str : FStar_Util.json -> Prims.string =
  fun uu___373_2323  ->
    match uu___373_2323 with
  ...
  fun key  ->
    fun a  ->
      let uu____2919 =
        FStar_Util.try_find
          (fun uu____2933  ->
             match uu____2933 with | (k,uu____2939) -> k = key) a
         in
    ...
    try
      ...
      let uu____3043 =
        ...
        | "lookup" ->
            let uu____3077 =
              ...
              let uu____3092 =
                ...
                FStar_All.pipe_right uu____3093 js_optional_lookup_context
                 in
              let uu____3098 =
                let uu____3107 =
                ...
                FStar_All.pipe_right uu____3107
                  (FStar_Util.map_option
                     (fun loc  ->
                        let uu____3174 =
                          let uu____3175 = assoc1 "[location]" "filename" loc
                             in
                        ...
                        let uu____3178 =
                          let uu____3179 = assoc1 "[location]" "column" loc
                             in
                          FStar_All.pipe_right uu____3179 js_int  in
                        (uu____3174, uu____3176, uu____3178)))
                 in
              let uu____3180 =
        ...
        | "vfs-add" ->
            ...
            VfsAdd uu____3229
        | uu____3250 ->
            let uu____3251 = FStar_Util.format1 "Unknown query '%s'" query
               in
            ProtocolViolation uu____3251
         in
      { qq = uu____3043; qid }
              ...
              let uu____3418 =
                let uu____3421 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____3427 = json_of_use_range r  in [uu____3427]
                   in
                let uu____3428 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____3673 =
      FStar_List.map (fun _0_68  -> FStar_Util.JsonStr _0_68)
       ...
       in
    FStar_All.pipe_left (fun _0_69  -> FStar_Util.JsonList _0_69) uu____3673
     in
                ...
                FStar_All.pipe_right uu____4212
                  (FStar_Util.map_option
                     (fun default_value  ->
                        ...
                        let uu____4225 = snippets_of_fstar_option name typ
                           in
                        let uu____4228 =
                          ...
                          then OptSet
                            ...
                            (let uu____4231 = FStar_Options.resettable name
                                in
                             if uu____4231 then OptReset else OptReadOnly)
                           in
                        {
                          opt_name = name;
                          opt_sig = uu____4224;
...
let update_option : fstar_option -> fstar_option =
  fun opt  ->
    let uu___393_4255 = opt  in
    let uu____4256 = FStar_Options.get_option opt.opt_name  in
    {
      opt_name = (uu___393_4255.opt_name);
      opt_sig = (uu___393_4255.opt_sig);
      opt_value = uu____4256;
      opt_default = (uu___393_4255.opt_default);
      opt_type = (uu___393_4255.opt_type);
      opt_snippets = (uu___393_4255.opt_snippets);
      opt_documentation = (uu___393_4255.opt_documentation);
      opt_permission_level = (uu___393_4255.opt_permission_level)
    }
    ...
    fun code  ->
      ...
      let collect_decls uu____4596 =
        ...
        | FStar_Parser_Driver.Modul (FStar_Parser_AST.Interface
            (uu____4609,decls,uu____4611)) -> decls
         in
      let uu____4616 =
        with_captured_errors st.repl_env
          (fun uu____4625  ->
             ...
             FStar_All.pipe_left
               (fun _0_73  -> FStar_Pervasives_Native.Some _0_73) uu____4626)
         in
      match uu____4616 with
      | FStar_Pervasives_Native.None  ->
          let errors =
            let uu____4654 = collect_errors ()  in
            FStar_All.pipe_right uu____4654 (FStar_List.map json_of_issue)
             in
...
let load_deps :
  ...
  fun st  ->
    let uu____4827 =
      with_captured_errors st.repl_env
        (fun _env  ->
           let uu____4853 = deps_and_repl_ld_tasks_of_our_file st.repl_fname
              in
           FStar_All.pipe_left
             (fun _0_75  -> FStar_Pervasives_Native.Some _0_75) uu____4853)
       in
    match uu____4827 with
    | FStar_Pervasives_Native.None  -> FStar_Util.Inr st
    | FStar_Pervasives_Native.Some (deps,tasks,dep_graph1) ->
        let st1 =
          let uu___394_4944 = st  in
          let uu____4945 =
            FStar_TypeChecker_Env.set_dep_graph st.repl_env dep_graph1  in
          {
            repl_line = (uu___394_4944.repl_line);
            repl_column = (uu___394_4944.repl_column);
            repl_fname = (uu___394_4944.repl_fname);
            repl_deps_stack = (uu___394_4944.repl_deps_stack);
            repl_curmod = (uu___394_4944.repl_curmod);
            repl_env = uu____4945;
            repl_stdin = (uu___394_4944.repl_stdin);
            repl_names = (uu___394_4944.repl_names)
          }  in
...
let rephrase_dependency_error : FStar_Errors.issue -> FStar_Errors.issue =
  fun issue  ->
       ...
       in
    {
      ...
      FStar_Errors.issue_level = (uu___395_4980.FStar_Errors.issue_level);
      FStar_Errors.issue_range = (uu___395_4980.FStar_Errors.issue_range)
    }
  ...
  fun st  ->
    fun query  ->
      let set_nosynth_flag st1 flag =
        let uu___396_5013 = st1  in
        {
          repl_line = (uu___396_5013.repl_line);
          repl_column = (uu___396_5013.repl_column);
          repl_fname = (uu___396_5013.repl_fname);
          repl_deps_stack = (uu___396_5013.repl_deps_stack);
          repl_curmod = (uu___396_5013.repl_curmod);
          repl_env =
            (let uu___397_5015 = st1.repl_env  in
             {
               FStar_TypeChecker_Env.solver =
                 (uu___397_5015.FStar_TypeChecker_Env.solver);
               FStar_TypeChecker_Env.range =
                 (uu___397_5015.FStar_TypeChecker_Env.range);
               FStar_TypeChecker_Env.curmodule =
                 (uu___397_5015.FStar_TypeChecker_Env.curmodule);
               FStar_TypeChecker_Env.gamma =
                 (uu___397_5015.FStar_TypeChecker_Env.gamma);
               FStar_TypeChecker_Env.gamma_cache =
                 (uu___397_5015.FStar_TypeChecker_Env.gamma_cache);
               FStar_TypeChecker_Env.modules =
                 (uu___397_5015.FStar_TypeChecker_Env.modules);
               FStar_TypeChecker_Env.expected_typ =
                 (uu___397_5015.FStar_TypeChecker_Env.expected_typ);
               FStar_TypeChecker_Env.sigtab =
                 (uu___397_5015.FStar_TypeChecker_Env.sigtab);
               FStar_TypeChecker_Env.is_pattern =
                 (uu___397_5015.FStar_TypeChecker_Env.is_pattern);
               FStar_TypeChecker_Env.instantiate_imp =
                 (uu___397_5015.FStar_TypeChecker_Env.instantiate_imp);
               FStar_TypeChecker_Env.effects =
                 (uu___397_5015.FStar_TypeChecker_Env.effects);
               FStar_TypeChecker_Env.generalize =
                 (uu___397_5015.FStar_TypeChecker_Env.generalize);
               FStar_TypeChecker_Env.letrecs =
                 (uu___397_5015.FStar_TypeChecker_Env.letrecs);
               FStar_TypeChecker_Env.top_level =
                 (uu___397_5015.FStar_TypeChecker_Env.top_level);
               FStar_TypeChecker_Env.check_uvars =
                 (uu___397_5015.FStar_TypeChecker_Env.check_uvars);
               FStar_TypeChecker_Env.use_eq =
                 (uu___397_5015.FStar_TypeChecker_Env.use_eq);
               FStar_TypeChecker_Env.is_iface =
                 (uu___397_5015.FStar_TypeChecker_Env.is_iface);
               FStar_TypeChecker_Env.admit =
                 (uu___397_5015.FStar_TypeChecker_Env.admit);
               FStar_TypeChecker_Env.lax =
                 (uu___397_5015.FStar_TypeChecker_Env.lax);
               FStar_TypeChecker_Env.lax_universes =
                 (uu___397_5015.FStar_TypeChecker_Env.lax_universes);
               FStar_TypeChecker_Env.failhard =
                 (uu___397_5015.FStar_TypeChecker_Env.failhard);
               FStar_TypeChecker_Env.nosynth = flag;
               FStar_TypeChecker_Env.tc_term =
                 (uu___397_5015.FStar_TypeChecker_Env.tc_term);
               FStar_TypeChecker_Env.type_of =
                 (uu___397_5015.FStar_TypeChecker_Env.type_of);
               FStar_TypeChecker_Env.universe_of =
                 (uu___397_5015.FStar_TypeChecker_Env.universe_of);
               FStar_TypeChecker_Env.use_bv_sorts =
                 (uu___397_5015.FStar_TypeChecker_Env.use_bv_sorts);
               FStar_TypeChecker_Env.qname_and_index =
                 (uu___397_5015.FStar_TypeChecker_Env.qname_and_index);
               FStar_TypeChecker_Env.proof_ns =
                 (uu___397_5015.FStar_TypeChecker_Env.proof_ns);
               FStar_TypeChecker_Env.synth =
                 (uu___397_5015.FStar_TypeChecker_Env.synth);
               FStar_TypeChecker_Env.is_native_tactic =
                 (uu___397_5015.FStar_TypeChecker_Env.is_native_tactic);
               FStar_TypeChecker_Env.identifier_info =
                 (uu___397_5015.FStar_TypeChecker_Env.identifier_info);
               FStar_TypeChecker_Env.tc_hooks =
                 (uu___397_5015.FStar_TypeChecker_Env.tc_hooks);
               FStar_TypeChecker_Env.dsenv =
                 (uu___397_5015.FStar_TypeChecker_Env.dsenv);
               FStar_TypeChecker_Env.dep_graph =
                 (uu___397_5015.FStar_TypeChecker_Env.dep_graph)
             });
          repl_stdin = (uu___396_5013.repl_stdin);
          repl_names = (uu___396_5013.repl_names)
        }  in
           ...
           (let st1 = set_nosynth_flag st peek_only  in
            ...
            | (success,st2) ->
                ...
                let st4 =
                  if success
                  then
                    let uu___398_5071 = st3  in
                    {
                      repl_line = line;
                      repl_column = column;
                      repl_fname = (uu___398_5071.repl_fname);
                      repl_deps_stack = (uu___398_5071.repl_deps_stack);
                      repl_curmod = (uu___398_5071.repl_curmod);
                      repl_env = (uu___398_5071.repl_env);
                      repl_stdin = (uu___398_5071.repl_stdin);
                      repl_names = (uu___398_5071.repl_names)
                    }
                  else st3  in
    ...
    fun deps  ->
      fun table  ->
        ...
        let loaded_mods_set =
          ...
          let uu____5113 =
            let uu____5116 = FStar_Options.prims ()  in uu____5116 :: deps
             in
          FStar_List.fold_left
            (fun acc  ->
               fun dep1  ->
                 let uu____5126 = FStar_Parser_Dep.lowercase_module_name dep1
                    in
    ...
    fun query  ->
      ...
      (let uu____5188 = load_deps st  in
       ...
       | FStar_Util.Inl (st1,deps) ->
           ((let uu____5252 = FStar_Options.restore_cmd_line_options false
                in
             FStar_All.pipe_right uu____5252 FStar_Pervasives.ignore);
            (let names1 =
               add_module_completions st1.repl_fname deps st1.repl_names  in
             run_push_without_deps
               (let uu___399_5255 = st1  in
                {
                  repl_line = (uu___399_5255.repl_line);
                  repl_column = (uu___399_5255.repl_column);
                  repl_fname = (uu___399_5255.repl_fname);
                  repl_deps_stack = (uu___399_5255.repl_deps_stack);
                  repl_curmod = (uu___399_5255.repl_curmod);
                  repl_env = (uu___399_5255.repl_env);
                  repl_stdin = (uu___399_5255.repl_stdin);
                  repl_names = names1
                }) query)))
      ...
      fun pos_opt  ->
        fun requested_info  ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____5367 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1
               in
            FStar_All.pipe_right uu____5367
              (FStar_Util.map_option
                 (fun uu____5422  ->
                    match uu____5422 with
                    | ((uu____5441,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
             in
          let docs_of_lid lid =
            let uu____5458 =
          ...
          let response =
            ...
            | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                ...
                FStar_Pervasives_Native.Some uu____5842
             in
          match response with
          | FStar_Pervasives_Native.None  ->
...
let run_code_lookup :
  ...
  fun st  ->
    fun symbol  ->
      fun pos_opt  ->
        fun requested_info  ->
          let uu____6208 = run_symbol_lookup st symbol pos_opt requested_info
             in
            ...
            let uu____6606 =
                ...
                Prims.strcat uu____6609 "."  in
              {
                ...
                FStar_Interactive_CompletionTable.mod_path =
                  (uu___400_6607.FStar_Interactive_CompletionTable.mod_path);
                FStar_Interactive_CompletionTable.mod_loaded =
                  (uu___400_6607.FStar_Interactive_CompletionTable.mod_loaded)
              }  in
...
let json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____7961 = sc_typ tcenv sc  in term_to_string tcenv uu____7961
         in
      let uu____7962 =
        let uu____7969 =
          let uu____7974 =
