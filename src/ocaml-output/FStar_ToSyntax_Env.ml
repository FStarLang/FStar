...
let qualify: env -> FStar_Ident.ident -> FStar_Ident.lident =
  fun env  ->
    fun id  ->
      ...
      | Some monad ->
          let _0_287 = let _0_286 = current_module env in qual _0_286 monad in
...
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  ...
  let rec aux uu___149_866 =
    ...
    | [] ->
        ...
        option_of_cont (fun uu____873  -> None) _0_295 in
  aux env.scope_mods
        ...
        let rec aux uu___150_1107 =
          ...
          | (Open_module_or_namespace (ns,Open_namespace ))::q when honor_ns
              ...
              let new_lid =
                ...
                FStar_Ident.lid_of_path _0_301 (FStar_Ident.range_of_lid lid) in
                     ...
                     Some
                       (Term_name
                          (let _0_312 =
                             ...
                             FStar_Syntax_Syntax.fvar source_lid
                               FStar_Syntax_Syntax.Delta_constant _0_311 in
                           (_0_312, false)))
                            ...
                            Some
                              (Term_name
                                 (let _0_315 =
                                    ...
                                    FStar_Syntax_Syntax.fvar lid dd _0_314 in
                                  (_0_315, false))))
                     else None
                         ...
                         | FStar_Syntax_Syntax.Sig_datacon
                             ...
                             (match uu____2705 with
                              | (formals,uu____2714) ->
                                  ...
                                  ((let _0_331 =
                                      let _0_330 = FStar_ST.read new_globs in
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map _0_337
              (fun record  ->
                 ...
                 option_of_cont (fun uu____2884  -> None) _0_336) in
      resolve_in_open_namespaces'' env fieldname Exported_id_field
        (fun uu____2886  -> Cont_ignore) (fun uu____2887  -> Cont_ignore)
        (fun r  -> Cont_ok r)
        (fun fn  ->
           let _0_338 = find_in_cache fn in cont_of_option Cont_ignore _0_338)
      ...
      fun env  ->
        fun lid  ->
          ...
          let this_env =
            ...
            let _0_343 = FStar_List.filter filter_scope_mods env.scope_mods in
            {
        ...
        Prims.raise
          (FStar_Errors.Error
             (let _0_344 =
              ...
              (_0_344, (FStar_Ident.range_of_lid l)))) in
    ...
    fun ns  ->
      ...
      | Some ns ->
          ...
          ((let uu____3295 = FStar_Util.smap_try_find env.includes curmod in
            ...
            | None  -> ()
            | Some incl ->
                let _0_354 = let _0_353 = FStar_ST.read incl in ns :: _0_353 in
                ...
                (match uu____3314 with
                 | Some ns_trans_exports ->
                     ((let uu____3327 =
                         ...
                         let _0_355 = get_trans_exported_id_set env curmod in
                         (_0_356, _0_355) in
                           ...
                           let update_exports k =
                             ...
                             (match () with
                              | () ->
                                  ...
                                  FStar_ST.write trans_ex _0_360) in
                       ...
                       then
                         FStar_Util.print_string
                           (let _0_365 =
                            ...
                            let _0_364 = FStar_Syntax_Print.lid_to_string l in
                            FStar_Util.format2
      ...
      let msg =
        ...
        then msg
          ...
          (let modul =
             ...
             FStar_Ident.set_lid_range _0_381 (FStar_Ident.range_of_lid lid) in
