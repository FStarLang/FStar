...
let set_iface: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___173_464 = env in
      {
        curmodule = (uu___173_464.curmodule);
        curmonad = (uu___173_464.curmonad);
        modules = (uu___173_464.modules);
        scope_mods = (uu___173_464.scope_mods);
        exported_ids = (uu___173_464.exported_ids);
        trans_exported_ids = (uu___173_464.trans_exported_ids);
        includes = (uu___173_464.includes);
        sigaccum = (uu___173_464.sigaccum);
        sigmap = (uu___173_464.sigmap);
        iface = b;
        admitted_iface = (uu___173_464.admitted_iface);
        expect_typ = (uu___173_464.expect_typ);
        docs = (uu___173_464.docs);
        remaining_iface_decls = (uu___173_464.remaining_iface_decls);
        syntax_only = (uu___173_464.syntax_only)
      }
let iface: env -> Prims.bool = fun e  -> e.iface
let set_admitted_iface: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___174_477 = e in
      {
        curmodule = (uu___174_477.curmodule);
        curmonad = (uu___174_477.curmonad);
        modules = (uu___174_477.modules);
        scope_mods = (uu___174_477.scope_mods);
        exported_ids = (uu___174_477.exported_ids);
        trans_exported_ids = (uu___174_477.trans_exported_ids);
        includes = (uu___174_477.includes);
        sigaccum = (uu___174_477.sigaccum);
        sigmap = (uu___174_477.sigmap);
        iface = (uu___174_477.iface);
        admitted_iface = b;
        expect_typ = (uu___174_477.expect_typ);
        docs = (uu___174_477.docs);
        remaining_iface_decls = (uu___174_477.remaining_iface_decls);
        syntax_only = (uu___174_477.syntax_only)
      }
let admitted_iface: env -> Prims.bool = fun e  -> e.admitted_iface
let set_expect_typ: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___175_490 = e in
      {
        curmodule = (uu___175_490.curmodule);
        curmonad = (uu___175_490.curmonad);
        modules = (uu___175_490.modules);
        scope_mods = (uu___175_490.scope_mods);
        exported_ids = (uu___175_490.exported_ids);
        trans_exported_ids = (uu___175_490.trans_exported_ids);
        includes = (uu___175_490.includes);
        sigaccum = (uu___175_490.sigaccum);
        sigmap = (uu___175_490.sigmap);
        iface = (uu___175_490.iface);
        admitted_iface = (uu___175_490.admitted_iface);
        expect_typ = b;
        docs = (uu___175_490.docs);
        remaining_iface_decls = (uu___175_490.remaining_iface_decls);
        syntax_only = (uu___175_490.syntax_only)
      }
...
let set_current_module: env -> FStar_Ident.lident -> env =
  fun e  ->
    fun l  ->
      let uu___176_532 = e in
      {
        curmodule = (Some l);
        curmonad = (uu___176_532.curmonad);
        modules = (uu___176_532.modules);
        scope_mods = (uu___176_532.scope_mods);
        exported_ids = (uu___176_532.exported_ids);
        trans_exported_ids = (uu___176_532.trans_exported_ids);
        includes = (uu___176_532.includes);
        sigaccum = (uu___176_532.sigaccum);
        sigmap = (uu___176_532.sigmap);
        iface = (uu___176_532.iface);
        admitted_iface = (uu___176_532.admitted_iface);
        expect_typ = (uu___176_532.expect_typ);
        docs = (uu___176_532.docs);
        remaining_iface_decls = (uu___176_532.remaining_iface_decls);
        syntax_only = (uu___176_532.syntax_only)
      }
  ...
  fun env  ->
    fun l  ->
      fun ds  ->
        ...
        | (uu____622,rest) ->
            let uu___177_640 = env in
            {
              curmodule = (uu___177_640.curmodule);
              curmonad = (uu___177_640.curmonad);
              modules = (uu___177_640.modules);
              scope_mods = (uu___177_640.scope_mods);
              exported_ids = (uu___177_640.exported_ids);
              trans_exported_ids = (uu___177_640.trans_exported_ids);
              includes = (uu___177_640.includes);
              sigaccum = (uu___177_640.sigaccum);
              sigmap = (uu___177_640.sigmap);
              iface = (uu___177_640.iface);
              admitted_iface = (uu___177_640.admitted_iface);
              expect_typ = (uu___177_640.expect_typ);
              docs = (uu___177_640.docs);
              remaining_iface_decls = ((l, ds) :: rest);
              syntax_only = (uu___177_640.syntax_only)
            }
...
let set_syntax_only: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___178_675 = env in
      {
        curmodule = (uu___178_675.curmodule);
        curmonad = (uu___178_675.curmonad);
        modules = (uu___178_675.modules);
        scope_mods = (uu___178_675.scope_mods);
        exported_ids = (uu___178_675.exported_ids);
        trans_exported_ids = (uu___178_675.trans_exported_ids);
        includes = (uu___178_675.includes);
        sigaccum = (uu___178_675.sigaccum);
        sigmap = (uu___178_675.sigmap);
        iface = (uu___178_675.iface);
        admitted_iface = (uu___178_675.admitted_iface);
        expect_typ = (uu___178_675.expect_typ);
        docs = (uu___178_675.docs);
        remaining_iface_decls = (uu___178_675.remaining_iface_decls);
        syntax_only = b
      }
...
let set_bv_range:
  ...
  fun bv  ->
    fun r  ->
      let id =
        let uu___179_740 = bv.FStar_Syntax_Syntax.ppname in
        {
          FStar_Ident.idText = (uu___179_740.FStar_Ident.idText);
          FStar_Ident.idRange = r
        } in
      let uu___180_741 = bv in
      {
        FStar_Syntax_Syntax.ppname = id;
        FStar_Syntax_Syntax.index = (uu___180_741.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___180_741.FStar_Syntax_Syntax.sort)
      }
let bv_to_name:
...
let option_of_cont k_ignore uu___146_901 =
  match uu___146_901 with
  | Cont_ok a -> Some a
  | Cont_fail  -> None
...
let find_in_module_with_includes eikind find_in_module find_in_module_default
  ...
  let rec aux uu___148_1053 =
    match uu___148_1053 with
...
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  ...
  let rec aux uu___153_1246 =
    match uu___153_1246 with
    | a::q ->
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___154_1522 =
          match uu___154_1522 with
          | [] ->
...
let cont_of_option k_none uu___156_1886 =
  match uu___156_1886 with | Some v1 -> Cont_ok v1 | None  -> k_none
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___161_2094 =
            match uu___161_2094 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___162_2517 =
        match uu___162_2517 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2600 =
        match uu___163_2600 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2649 =
        match uu___164_2649 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___181_2790 = env in
        {
          curmodule = (uu___181_2790.curmodule);
          curmonad = (uu___181_2790.curmonad);
          modules = (uu___181_2790.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___181_2790.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___181_2790.sigaccum);
          sigmap = (uu___181_2790.sigmap);
          iface = (uu___181_2790.iface);
          admitted_iface = (uu___181_2790.admitted_iface);
          expect_typ = (uu___181_2790.expect_typ);
          docs = (uu___181_2790.docs);
          remaining_iface_decls = (uu___181_2790.remaining_iface_decls);
          syntax_only = (uu___181_2790.syntax_only)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_2818 =
        match uu___166_2818 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___167_2876 =
        match uu___167_2876 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___172_3950 =
            match uu___172_3950 with
            | Rec_binding uu____3951 -> true
            | uu____3952 -> false in
          let this_env =
            let uu___182_3954 = env in
            let uu____3955 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___182_3954.curmodule);
              curmonad = (uu___182_3954.curmonad);
              modules = (uu___182_3954.modules);
              scope_mods = uu____3955;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___182_3954.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___182_3954.sigaccum);
              sigmap = (uu___182_3954.sigmap);
              iface = (uu___182_3954.iface);
              admitted_iface = (uu___182_3954.admitted_iface);
              expect_typ = (uu___182_3954.expect_typ);
              docs = (uu___182_3954.docs);
              remaining_iface_decls = (uu___182_3954.remaining_iface_decls);
              syntax_only = (uu___182_3954.syntax_only)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___183_3976 = env in
      {
        curmodule = (uu___183_3976.curmodule);
        curmonad = (uu___183_3976.curmonad);
        modules = (uu___183_3976.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___183_3976.exported_ids);
        trans_exported_ids = (uu___183_3976.trans_exported_ids);
        includes = (uu___183_3976.includes);
        sigaccum = (uu___183_3976.sigaccum);
        sigmap = (uu___183_3976.sigmap);
        iface = (uu___183_3976.iface);
        admitted_iface = (uu___183_3976.admitted_iface);
        expect_typ = (uu___183_3976.expect_typ);
        docs = (uu___183_3976.docs);
        remaining_iface_decls = (uu___183_3976.remaining_iface_decls);
        syntax_only = (uu___183_3976.syntax_only)
      }
let push_bv':
            ...
            (match uu____4087 with
             ...
             | uu____4096 ->
                 (extract_record env globals s;
                  (let uu___184_4101 = env in
                   {
                     curmodule = (uu___184_4101.curmodule);
                     curmonad = (uu___184_4101.curmonad);
                     modules = (uu___184_4101.modules);
                     scope_mods = (uu___184_4101.scope_mods);
                     exported_ids = (uu___184_4101.exported_ids);
                     trans_exported_ids = (uu___184_4101.trans_exported_ids);
                     includes = (uu___184_4101.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___184_4101.sigmap);
                     iface = (uu___184_4101.iface);
                     admitted_iface = (uu___184_4101.admitted_iface);
                     expect_typ = (uu___184_4101.expect_typ);
                     docs = (uu___184_4101.docs);
                     remaining_iface_decls =
                       (uu___184_4101.remaining_iface_decls);
                     syntax_only = (uu___184_4101.syntax_only)
                   }))) in
      let env2 =
        let uu___185_4103 = env1 in
        let uu____4104 = FStar_ST.read globals in
        {
          curmodule = (uu___185_4103.curmodule);
          curmonad = (uu___185_4103.curmonad);
          modules = (uu___185_4103.modules);
          scope_mods = uu____4104;
          exported_ids = (uu___185_4103.exported_ids);
          trans_exported_ids = (uu___185_4103.trans_exported_ids);
          includes = (uu___185_4103.includes);
          sigaccum = (uu___185_4103.sigaccum);
          sigmap = (uu___185_4103.sigmap);
          iface = (uu___185_4103.iface);
          admitted_iface = (uu___185_4103.admitted_iface);
          expect_typ = (uu___185_4103.expect_typ);
          docs = (uu___185_4103.docs);
          remaining_iface_decls = (uu___185_4103.remaining_iface_decls);
          syntax_only = (uu___185_4103.syntax_only)
        } in
      let uu____4109 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___186_4224 = env3 in
              let uu____4225 = FStar_ST.read globals in
              {
                curmodule = (uu___186_4224.curmodule);
                curmonad = (uu___186_4224.curmonad);
                modules = (uu___186_4224.modules);
                scope_mods = uu____4225;
                exported_ids = (uu___186_4224.exported_ids);
                trans_exported_ids = (uu___186_4224.trans_exported_ids);
                includes = (uu___186_4224.includes);
                sigaccum = (uu___186_4224.sigaccum);
                sigmap = (uu___186_4224.sigmap);
                iface = (uu___186_4224.iface);
                admitted_iface = (uu___186_4224.admitted_iface);
                expect_typ = (uu___186_4224.expect_typ);
                docs = (uu___186_4224.docs);
                remaining_iface_decls = (uu___186_4224.remaining_iface_decls);
                syntax_only = (uu___186_4224.syntax_only)
              } in
            env4))
                     ...
                     ((let uu____4495 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___187_4505 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___187_4505.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___187_4505.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___187_4505.FStar_Syntax_Syntax.sigmeta)
                           }), false)))
                 | Some uu____4506 -> ())
            | uu____4511 -> ()))
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___188_4595 = se in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___188_4595.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___188_4595.FStar_Syntax_Syntax.sigmeta)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___189_4689 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___189_4689.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___189_4689.exported_ids);
                    trans_exported_ids = (uu___189_4689.trans_exported_ids);
                    includes = (uu___189_4689.includes);
                    sigaccum = [];
                    sigmap = (uu___189_4689.sigmap);
                    iface = (uu___189_4689.iface);
                    admitted_iface = (uu___189_4689.admitted_iface);
                    expect_typ = (uu___189_4689.expect_typ);
                    docs = (uu___189_4689.docs);
                    remaining_iface_decls =
                      (uu___189_4689.remaining_iface_decls);
                    syntax_only = (uu___189_4689.syntax_only)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___190_4713 = env in
     let uu____4714 = FStar_Util.smap_copy (sigmap env) in
     let uu____4720 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___190_4713.curmodule);
       curmonad = (uu___190_4713.curmonad);
       modules = (uu___190_4713.modules);
       scope_mods = (uu___190_4713.scope_mods);
       exported_ids = (uu___190_4713.exported_ids);
       trans_exported_ids = (uu___190_4713.trans_exported_ids);
       includes = (uu___190_4713.includes);
       sigaccum = (uu___190_4713.sigaccum);
       sigmap = uu____4714;
       iface = (uu___190_4713.iface);
       admitted_iface = (uu___190_4713.admitted_iface);
       expect_typ = (uu___190_4713.expect_typ);
       docs = uu____4720;
       remaining_iface_decls = (uu___190_4713.remaining_iface_decls);
       syntax_only = (uu___190_4713.syntax_only)
     })
              ...
              | Some (se,true ) when sigelt_in_m se ->
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___191_4817 = se in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___191_4817.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___191_4817.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___191_4817.FStar_Syntax_Syntax.sigmeta)
                          }
                      | uu____4818 -> se in
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___192_4892.curmonad);
                               modules = (uu___192_4892.modules);
                               scope_mods = uu____4893;
                               exported_ids = (uu___192_4892.exported_ids);
                               trans_exported_ids =
                                 (uu___192_4892.trans_exported_ids);
                               includes = (uu___192_4892.includes);
                               sigaccum = (uu___192_4892.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___192_4892.expect_typ);
                               docs = (uu___192_4892.docs);
                               remaining_iface_decls =
                                 (uu___192_4892.remaining_iface_decls);
                               syntax_only = (uu___192_4892.syntax_only)
                             }))))) in
          let uu____4896 =
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___193_4942 = env in
          {
            curmodule = (uu___193_4942.curmodule);
            curmonad = (Some mname);
            modules = (uu___193_4942.modules);
            scope_mods = (uu___193_4942.scope_mods);
            exported_ids = (uu___193_4942.exported_ids);
            trans_exported_ids = (uu___193_4942.trans_exported_ids);
            includes = (uu___193_4942.includes);
            sigaccum = (uu___193_4942.sigaccum);
            sigmap = (uu___193_4942.sigmap);
            iface = (uu___193_4942.iface);
            admitted_iface = (uu___193_4942.admitted_iface);
            expect_typ = (uu___193_4942.expect_typ);
            docs = (uu___193_4942.docs);
            remaining_iface_decls = (uu___193_4942.remaining_iface_decls);
            syntax_only = (uu___193_4942.syntax_only)
          }
