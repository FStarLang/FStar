        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____1721  ->
                ...
                | (m,uu____1729) -> FStar_Ident.lid_equals l m))
         in
    ...
    fun id  ->
      fun k_global_def  ->
        fun k_not_found  ->
          ...
          | FStar_Pervasives_Native.None  ->
              let lid =
                let uu____3192 = current_module env  in qual uu____3192 id
                 in
        ...
        let uu____3506 =
          is_full_path &&
            (let uu____3508 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____3508)
           in
        if uu____3506
        then (ids, [])
        else
          ...
          let k_global_def source_lid uu___163_4026 =
            ...
            | (se,uu____4035) ->
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     let uu____4077 =
                       let uu____4078 =
                         let uu____4083 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____4084
                            in
                         (uu____4083, false)  in
                            ...
                            let uu____4163 =
                              let uu____4164 =
                                let uu____4169 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____4170
                                   in
                                (uu____4169, false)  in
                 ...
                 | uu____4189 -> FStar_Pervasives_Native.None)
             in
    ...
    fun lid  ->
      ...
      let uu____4696 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____4708  -> FStar_Pervasives_Native.None) k_global_def
         in
     ...
     | () ->
         ...
         let uu____5800 =
           let uu____5805 = FStar_ST.op_Bang record_cache  in filtered ::
             uu____5805
            in
         FStar_ST.op_Colon_Equals record_cache uu____5800)
     in
                                                             ...
                                                             let uu____6974 =
                                                               let uu____6975
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____6975.FStar_Ident.ident
                                                                in
                                                             uu____6974.FStar_Ident.idText
                                                              in
                                                           let uu____6977 =
                                                             let uu____6978 =
                                                               FStar_ST.op_Bang
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____7149 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____7153  -> Cont_ok ())
               in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____7560) ->
            let uu____7569 =
              FStar_List.map
               ...
               in
            (env2, uu____7569)
        | uu____7596 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____8330 =
                                 ...
                                 FStar_Util.set_difference uu____8331 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____8393 =
                                     ...
                                     FStar_Util.set_union uu____8394 ns_ex
                                      in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____8527 =
                    ...
                    FStar_Util.format3
                      ...
                      uu____8528 uu____8529 uu____8530
                     in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____8705 -> ()));
      (let curmod =
         let uu____8707 = current_module env  in uu____8707.FStar_Ident.str
          in
       (let uu____8709 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____8787 = cur_ex eikind  in
                FStar_ST.op_Bang uu____8787  in
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____9532  ->
                    ...
                    | (l,uu____9538) -> FStar_Ident.lid_equals l mname))
             in
          ...
          | FStar_Pervasives_Native.Some (uu____9548,m) ->
              ((let uu____9555 =
                ...
                then
                  ...
                  FStar_Exn.raise uu____9559
                else ());
               (let uu____9567 =
                  let uu____9568 = push env  in prep uu____9568  in
                (uu____9567, true)))
