        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___156_1843  ->
               ...
               | uu____1852 -> FStar_Pervasives_Native.None) in
        (match qopt with
         | FStar_Pervasives_Native.None  ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
         | x -> x)
        ...
        fun lid  ->
                       ...
                       let uu____1988 =
                         FStar_Util.find_map quals
                           (fun uu___159_1990  ->
                              ...
                              | uu____1993 -> FStar_Pervasives_Native.None) in
          ...
          let k_rec_binding uu____2047 =
            ...
            | (id,l,dd) ->
                ...
                FStar_Pervasives_Native.Some uu____2055 in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
            ...
            | FStar_Pervasives_Native.Some (s,uu____2279) ->
                (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 | FStar_Syntax_Syntax.Sig_effect_abbrev
                     ...
                     aux l''
                 | uu____2293 -> FStar_Pervasives_Native.None) in
          aux l'
    ...
    fun lid  ->
      ...
      let uu____2337 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____2343  -> FStar_Pervasives_Native.None) k_global_def in
      ...
      fun env  ->
        fun mname  ->
          let prep env1 =
            ...
            (let uu____4577 = exported_id_set_new () in
             FStar_Util.smap_add env1.exported_ids mname.FStar_Ident.str
               uu____4577);
            (match () with
             | () ->
                 ((let uu____4582 = exported_id_set_new () in
                   FStar_Util.smap_add env1.trans_exported_ids
                     mname.FStar_Ident.str uu____4582);
                  (match () with
                   | () ->
                       ((let uu____4587 = FStar_Util.mk_ref [] in
                         FStar_Util.smap_add env1.includes
                           mname.FStar_Ident.str uu____4587);
                        (match () with
                         | () ->
                             let uu___191_4596 = env1 in
                             let uu____4597 =
                               FStar_List.map
                                 (fun lid  ->
                                      ...
                                      (lid, Open_namespace)) open_ns in
                             {
                               ...
                               curmonad = (uu___191_4596.curmonad);
                               modules = (uu___191_4596.modules);
                               scope_mods = uu____4597;
                               exported_ids = (uu___191_4596.exported_ids);
                               trans_exported_ids =
                                 (uu___191_4596.trans_exported_ids);
                               includes = (uu___191_4596.includes);
                               sigaccum = (uu___191_4596.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___191_4596.expect_typ);
                               docs = (uu___191_4596.docs);
                               remaining_iface_decls =
                                 (uu___191_4596.remaining_iface_decls);
                               syntax_only = (uu___191_4596.syntax_only)
                             }))))) in
          let uu____4600 =
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4612  ->
                    ...
                    | (l,uu____4616) -> FStar_Ident.lid_equals l mname)) in
          match uu____4600 with
          | FStar_Pervasives_Native.None  ->
              let uu____4621 = prep env in (uu____4621, false)
          | FStar_Pervasives_Native.Some (uu____4622,m) ->
              ((let uu____4627 =
                  (let uu____4628 = FStar_Options.interactive () in
                   Prims.op_Negation uu____4628) &&
                ...
                then
                  let uu____4629 =
                    let uu____4630 =
                      ...
                      (uu____4633, (FStar_Ident.range_of_lid mname)) in
                    FStar_Errors.Error uu____4630 in
                  raise uu____4629
                else ());
               (let uu____4635 = let uu____4636 = push env in prep uu____4636 in
                (uu____4635, true)))
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___192_4644 = env in
          {
            curmodule = (uu___192_4644.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___192_4644.modules);
            scope_mods = (uu___192_4644.scope_mods);
            exported_ids = (uu___192_4644.exported_ids);
            trans_exported_ids = (uu___192_4644.trans_exported_ids);
            includes = (uu___192_4644.includes);
            sigaccum = (uu___192_4644.sigaccum);
            sigmap = (uu___192_4644.sigmap);
            iface = (uu___192_4644.iface);
            admitted_iface = (uu___192_4644.admitted_iface);
            expect_typ = (uu___192_4644.expect_typ);
            docs = (uu___192_4644.docs);
            remaining_iface_decls = (uu___192_4644.remaining_iface_decls);
            syntax_only = (uu___192_4644.syntax_only)
          }
let fail_or env lookup lid =
  let uu____4669 = lookup lid in
  ...
  | FStar_Pervasives_Native.None  ->
      let opened_modules =
        FStar_List.map
          (fun uu____4675  ->
             ...
             | (lid1,uu____4679) -> FStar_Ident.text_of_lid lid1) env.modules in
      let msg =
      ...
      let msg1 =
        ...
        then msg
          ...
          (let modul =
             let uu____4686 = FStar_Ident.lid_of_ids lid.FStar_Ident.ns in
             FStar_Ident.set_lid_range uu____4686
               (FStar_Ident.range_of_lid lid) in
           let uu____4687 = resolve_module_name env modul true in
