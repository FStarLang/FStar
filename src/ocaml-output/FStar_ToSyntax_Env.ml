        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____2003  ->
                ...
                | (m,uu____2011) -> FStar_Ident.lid_equals l m))
         in
    ...
    fun id1  ->
      ...
      | uu____3355 ->
          try_lookup_id'' env id1 Exported_id_term_type
            (fun r  ->
               let uu____3369 = found_local_binding id1.FStar_Ident.idRange r
                  in
    ...
    fun id1  ->
      fun k_global_def  ->
        fun k_not_found  ->
          ...
          | FStar_Pervasives_Native.None  ->
              let lid =
                let uu____3536 = current_module env  in qual uu____3536 id1
                 in
        ...
        let uu____3834 =
          is_full_path &&
            (let uu____3836 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____3836)
           in
        if uu____3834
        then (ids, [])
        else
        ...
        fun lid  ->
                     ...
                     let uu____4376 =
                       let uu____4377 =
                         let uu____4382 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____4383
                            in
                         (uu____4382, false)  in
          ...
          let k_rec_binding uu____4532 =
            ...
            | (id1,l,dd) ->
                ...
                FStar_Pervasives_Native.Some uu____4544
             in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
    ...
    fun lid  ->
      ...
      let uu____4988 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____5000  -> FStar_Pervasives_Native.None) k_global_def
         in
...
let try_lookup_lid' :
  ...
  fun any_val  ->
    fun exclude_interface  ->
      fun env  ->
        fun lid  ->
          let uu____5250 = try_lookup_name any_val exclude_interface env lid
             in
                                                             ...
                                                             let uu____7560 =
                                                               let uu____7561
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id1
                                                                  in
                                                               uu____7561.FStar_Ident.ident
                                                                in
                                                             uu____7560.FStar_Ident.idText
                                                              in
                                                           let uu____7563 =
                                                             let uu____7564 =
                                                               FStar_ST.op_Bang
...
let try_lookup_record_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____7790 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____7820 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____7824  -> Cont_ok ())
               in
...
let try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____7844 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | (any_val,exclude_interface) ->
            ...
            let uu____8129 =
              FStar_Util.find_map lids
                (fun l  ->
                   let uu____8135 =
                     let uu____8136 = unique any_val exclude_interface env l
                        in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____8273) ->
            let uu____8282 =
              FStar_List.map
               ...
               in
            (env2, uu____8282)
        | uu____8309 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
                   ...
                   | (lids,se) ->
                       FStar_All.pipe_right lids
                         (FStar_List.iter
                            (fun lid  ->
                               (let uu____8390 =
                                  let uu____8393 = FStar_ST.op_Bang globals
                                     in
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____8892 = FStar_Util.smap_try_find env1.includes curmod
                in
             ...
             | () ->
                 ...
                 (match uu____9070 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____9087 =
                          let uu____9104 = get_exported_id_set env1 curmod
                             in
                          let uu____9111 =
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____9436 =
                                 ...
                                 FStar_Util.set_difference uu____9437 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____9595 =
                                     ...
                                     FStar_Util.set_union uu____9596 ns_ex
                                      in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____9813 =
                    let uu____9818 =
                      ...
                      let uu____9821 = FStar_Parser_AST.string_of_fsdoc doc1
                         in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____9819 uu____9820 uu____9821
                       in
                       ...
                       then
                         let uu____9851 =
                           let uu____9856 =
                             ...
                             FStar_Util.format1
                               "Admitting %s without a definition" uu____9857
                              in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
                                          ...
                                          let uu____9957 =
                                            let uu____9960 =
                                              ...
                                              FStar_Syntax_Syntax.Tm_arrow
                                                uu____9961
                                               in
                                            FStar_Syntax_Syntax.mk uu____9960
                                             in
                                          uu____9957
                                            FStar_Pervasives_Native.None
                                            (FStar_Ident.range_of_lid lid)
                                 ...
                                 let uu____10022 =
                                   let uu____10025 =
                                     FStar_Util.right
                                      ...
                                      in
                                   uu____10025.FStar_Syntax_Syntax.fv_name
                                    in
              ...
              | uu____10057 -> ()));
      (let curmod =
         let uu____10059 = current_module env  in uu____10059.FStar_Ident.str
          in
       (let uu____10061 =
...
let as_exported_ids : exported_id_set -> exported_ids =
  fun e  ->
    ...
    let fields =
      let uu____11275 =
        let uu____11278 = e Exported_id_field  in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____12103  ->
                      ...
                      | (l,uu____12109) -> FStar_Ident.lid_equals l mname))
               in
