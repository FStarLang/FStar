...
let set_iface: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___176_1426 = env in
      {
        curmodule = (uu___176_1426.curmodule);
        curmonad = (uu___176_1426.curmonad);
        modules = (uu___176_1426.modules);
        scope_mods = (uu___176_1426.scope_mods);
        exported_ids = (uu___176_1426.exported_ids);
        trans_exported_ids = (uu___176_1426.trans_exported_ids);
        includes = (uu___176_1426.includes);
        sigaccum = (uu___176_1426.sigaccum);
        sigmap = (uu___176_1426.sigmap);
        iface = b;
        admitted_iface = (uu___176_1426.admitted_iface);
        expect_typ = (uu___176_1426.expect_typ);
        docs = (uu___176_1426.docs);
        remaining_iface_decls = (uu___176_1426.remaining_iface_decls);
        syntax_only = (uu___176_1426.syntax_only)
      }
let iface: env -> Prims.bool = fun e  -> e.iface
let set_admitted_iface: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___177_1439 = e in
      {
        curmodule = (uu___177_1439.curmodule);
        curmonad = (uu___177_1439.curmonad);
        modules = (uu___177_1439.modules);
        scope_mods = (uu___177_1439.scope_mods);
        exported_ids = (uu___177_1439.exported_ids);
        trans_exported_ids = (uu___177_1439.trans_exported_ids);
        includes = (uu___177_1439.includes);
        sigaccum = (uu___177_1439.sigaccum);
        sigmap = (uu___177_1439.sigmap);
        iface = (uu___177_1439.iface);
        admitted_iface = b;
        expect_typ = (uu___177_1439.expect_typ);
        docs = (uu___177_1439.docs);
        remaining_iface_decls = (uu___177_1439.remaining_iface_decls);
        syntax_only = (uu___177_1439.syntax_only)
      }
let admitted_iface: env -> Prims.bool = fun e  -> e.admitted_iface
let set_expect_typ: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___178_1452 = e in
      {
        curmodule = (uu___178_1452.curmodule);
        curmonad = (uu___178_1452.curmonad);
        modules = (uu___178_1452.modules);
        scope_mods = (uu___178_1452.scope_mods);
        exported_ids = (uu___178_1452.exported_ids);
        trans_exported_ids = (uu___178_1452.trans_exported_ids);
        includes = (uu___178_1452.includes);
        sigaccum = (uu___178_1452.sigaccum);
        sigmap = (uu___178_1452.sigmap);
        iface = (uu___178_1452.iface);
        admitted_iface = (uu___178_1452.admitted_iface);
        expect_typ = b;
        docs = (uu___178_1452.docs);
        remaining_iface_decls = (uu___178_1452.remaining_iface_decls);
        syntax_only = (uu___178_1452.syntax_only)
      }
...
let set_current_module: env -> FStar_Ident.lident -> env =
  fun e  ->
    fun l  ->
      let uu___179_1669 = e in
      {
        curmodule = (FStar_Pervasives_Native.Some l);
        curmonad = (uu___179_1669.curmonad);
        modules = (uu___179_1669.modules);
        scope_mods = (uu___179_1669.scope_mods);
        exported_ids = (uu___179_1669.exported_ids);
        trans_exported_ids = (uu___179_1669.trans_exported_ids);
        includes = (uu___179_1669.includes);
        sigaccum = (uu___179_1669.sigaccum);
        sigmap = (uu___179_1669.sigmap);
        iface = (uu___179_1669.iface);
        admitted_iface = (uu___179_1669.admitted_iface);
        expect_typ = (uu___179_1669.expect_typ);
        docs = (uu___179_1669.docs);
        remaining_iface_decls = (uu___179_1669.remaining_iface_decls);
  ...
  fun env  ->
    fun l  ->
      fun ds  ->
        ...
        | (uu____1819,rest) ->
            let uu___180_1853 = env in
            {
              curmodule = (uu___180_1853.curmodule);
              curmonad = (uu___180_1853.curmonad);
              modules = (uu___180_1853.modules);
              scope_mods = (uu___180_1853.scope_mods);
              exported_ids = (uu___180_1853.exported_ids);
              trans_exported_ids = (uu___180_1853.trans_exported_ids);
              includes = (uu___180_1853.includes);
              sigaccum = (uu___180_1853.sigaccum);
              sigmap = (uu___180_1853.sigmap);
              iface = (uu___180_1853.iface);
              admitted_iface = (uu___180_1853.admitted_iface);
              expect_typ = (uu___180_1853.expect_typ);
              docs = (uu___180_1853.docs);
              remaining_iface_decls = ((l, ds) :: rest);
              syntax_only = (uu___180_1853.syntax_only)
            }
...
let set_syntax_only: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___181_1892 = env in
      {
        curmodule = (uu___181_1892.curmodule);
        curmonad = (uu___181_1892.curmonad);
        modules = (uu___181_1892.modules);
        scope_mods = (uu___181_1892.scope_mods);
        exported_ids = (uu___181_1892.exported_ids);
        trans_exported_ids = (uu___181_1892.trans_exported_ids);
        includes = (uu___181_1892.includes);
        sigaccum = (uu___181_1892.sigaccum);
        sigmap = (uu___181_1892.sigmap);
        iface = (uu___181_1892.iface);
        admitted_iface = (uu___181_1892.admitted_iface);
        expect_typ = (uu___181_1892.expect_typ);
        docs = (uu___181_1892.docs);
        remaining_iface_decls = (uu___181_1892.remaining_iface_decls);
        syntax_only = b
      }
...
let set_bv_range:
  ...
  fun bv  ->
    fun r  ->
      let id =
        let uu___182_1986 = bv.FStar_Syntax_Syntax.ppname in
        {
          FStar_Ident.idText = (uu___182_1986.FStar_Ident.idText);
          FStar_Ident.idRange = r
        } in
      let uu___183_1987 = bv in
      {
        FStar_Syntax_Syntax.ppname = id;
        FStar_Syntax_Syntax.index = (uu___183_1987.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___183_1987.FStar_Syntax_Syntax.sort)
      }
let bv_to_name:
        ...
        fun env  ->
          fun ns  ->
            fun id  ->
              ...
              let rec aux uu___150_2407 =
                match uu___150_2407 with
            ...
            fun k_record  ->
              fun find_in_module  ->
                fun lookup_default_id  ->
                  let check_local_binding_id uu___152_2799 =
                    match uu___152_2799 with
                    | (id',uu____2801,uu____2802) ->
                        id'.FStar_Ident.idText = id.FStar_Ident.idText in
                  let check_rec_binding_id uu___153_2806 =
                    match uu___153_2806 with
                    | (id',uu____2808,uu____2809) ->
                        id'.FStar_Ident.idText = id.FStar_Ident.idText in
                  let curmod_ns =
                    let uu____2813 = current_module env in
                    FStar_Ident.ids_of_lid uu____2813 in
                  let proc uu___154_2819 =
                    match uu___154_2819 with
                  ...
                  let rec aux uu___155_2840 =
                    match uu___155_2840 with
                    | a::q ->
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___156_3239 =
          match uu___156_3239 with
          | [] ->
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___163_4026 =
            match uu___163_4026 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_4666 =
        match uu___164_4666 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___165_4798 =
        match uu___165_4798 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_4866 =
        match uu___166_4866 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
               (lbs,uu____4876);
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___184_5056 = env in
        {
          curmodule = (uu___184_5056.curmodule);
          curmonad = (uu___184_5056.curmonad);
          modules = (uu___184_5056.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___184_5056.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___184_5056.sigaccum);
          sigmap = (uu___184_5056.sigmap);
          iface = (uu___184_5056.iface);
          admitted_iface = (uu___184_5056.admitted_iface);
          expect_typ = (uu___184_5056.expect_typ);
          docs = (uu___184_5056.docs);
          remaining_iface_decls = (uu___184_5056.remaining_iface_decls);
          syntax_only = (uu___184_5056.syntax_only)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___168_5089 =
        match uu___168_5089 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___169_5178 =
        match uu___169_5178 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let record_cache_aux_with_filter:
  ...
  let push1 uu____5275 =
    let uu____5276 =
      let uu____5281 =
        let uu____5284 = FStar_ST.read record_cache in
        FStar_List.hd uu____5284 in
      let uu____5331 = FStar_ST.read record_cache in uu____5281 :: uu____5331 in
    FStar_ST.write record_cache uu____5276 in
  let pop1 uu____5421 =
    let uu____5422 =
      let uu____5427 = FStar_ST.read record_cache in FStar_List.tl uu____5427 in
    FStar_ST.write record_cache uu____5422 in
  let peek1 uu____5519 =
    let uu____5520 = FStar_ST.read record_cache in FStar_List.hd uu____5520 in
  let insert r =
    let uu____5571 =
      let uu____5576 = let uu____5579 = peek1 () in r :: uu____5579 in
      let uu____5582 =
        let uu____5587 = FStar_ST.read record_cache in
        FStar_List.tl uu____5587 in
      uu____5576 :: uu____5582 in
    FStar_ST.write record_cache uu____5571 in
  let commit1 uu____5679 =
    let uu____5680 = FStar_ST.read record_cache in
    match uu____5680 with
    | hd1::uu____5726::tl1 -> FStar_ST.write record_cache (hd1 :: tl1)
  ...
  let filter1 uu____5790 =
    ...
    (match () with
     | () ->
         ...
         let uu____5800 =
           let uu____5805 = FStar_ST.read record_cache in filtered ::
             uu____5805 in
         FStar_ST.write record_cache uu____5800) in
                             ...
                             (match uu____6638 with
                              | (formals,uu____6652) ->
                                  ...
                                  ((let uu____6799 =
                                    ...
                                    FStar_ST.write new_globs uu____6799);
                                   (match () with
                                    | () ->
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___174_7288 =
            match uu___174_7288 with
            | Rec_binding uu____7289 -> true
            | uu____7290 -> false in
          let this_env =
            let uu___185_7292 = env in
            let uu____7293 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___185_7292.curmodule);
              curmonad = (uu___185_7292.curmonad);
              modules = (uu___185_7292.modules);
              scope_mods = uu____7293;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___185_7292.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___185_7292.sigaccum);
              sigmap = (uu___185_7292.sigmap);
              iface = (uu___185_7292.iface);
              admitted_iface = (uu___185_7292.admitted_iface);
              expect_typ = (uu___185_7292.expect_typ);
              docs = (uu___185_7292.docs);
              remaining_iface_decls = (uu___185_7292.remaining_iface_decls);
              syntax_only = (uu___185_7292.syntax_only)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___186_7324 = env in
      {
        curmodule = (uu___186_7324.curmodule);
        curmonad = (uu___186_7324.curmonad);
        modules = (uu___186_7324.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___186_7324.exported_ids);
        trans_exported_ids = (uu___186_7324.trans_exported_ids);
        includes = (uu___186_7324.includes);
        sigaccum = (uu___186_7324.sigaccum);
        sigmap = (uu___186_7324.sigmap);
        iface = (uu___186_7324.iface);
        admitted_iface = (uu___186_7324.admitted_iface);
        expect_typ = (uu___186_7324.expect_typ);
        docs = (uu___186_7324.docs);
        remaining_iface_decls = (uu___186_7324.remaining_iface_decls);
        syntax_only = (uu___186_7324.syntax_only)
      }
let push_bv':
  env ->
    FStar_Ident.ident ->
            ...
            (match uu____7465 with
             ...
             | uu____7478 ->
                 (extract_record env globals s;
                  (let uu___187_7496 = env in
                   {
                     curmodule = (uu___187_7496.curmodule);
                     curmonad = (uu___187_7496.curmonad);
                     modules = (uu___187_7496.modules);
                     scope_mods = (uu___187_7496.scope_mods);
                     exported_ids = (uu___187_7496.exported_ids);
                     trans_exported_ids = (uu___187_7496.trans_exported_ids);
                     includes = (uu___187_7496.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___187_7496.sigmap);
                     iface = (uu___187_7496.iface);
                     admitted_iface = (uu___187_7496.admitted_iface);
                     expect_typ = (uu___187_7496.expect_typ);
                     docs = (uu___187_7496.docs);
                     remaining_iface_decls =
                       (uu___187_7496.remaining_iface_decls);
                     syntax_only = (uu___187_7496.syntax_only)
                   }))) in
      let env2 =
        let uu___188_7498 = env1 in
        let uu____7499 = FStar_ST.read globals in
        {
          curmodule = (uu___188_7498.curmodule);
          curmonad = (uu___188_7498.curmonad);
          modules = (uu___188_7498.modules);
          scope_mods = uu____7499;
          exported_ids = (uu___188_7498.exported_ids);
          trans_exported_ids = (uu___188_7498.trans_exported_ids);
          includes = (uu___188_7498.includes);
          sigaccum = (uu___188_7498.sigaccum);
          sigmap = (uu___188_7498.sigmap);
          iface = (uu___188_7498.iface);
          admitted_iface = (uu___188_7498.admitted_iface);
          expect_typ = (uu___188_7498.expect_typ);
          docs = (uu___188_7498.docs);
          remaining_iface_decls = (uu___188_7498.remaining_iface_decls);
                   ...
                   | (lids,se) ->
                       FStar_All.pipe_right lids
                         (FStar_List.iter
                            (fun lid  ->
                               (let uu____7676 =
                                  let uu____7679 = FStar_ST.read globals in
                                  (Top_level_def (lid.FStar_Ident.ident)) ::
                                    uu____7679 in
                                FStar_ST.write globals uu____7676);
                               (match () with
                                | () ->
                                    let modul =
                                      let uu____7747 =
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___189_7836 = env3 in
              let uu____7837 = FStar_ST.read globals in
              {
                curmodule = (uu___189_7836.curmodule);
                curmonad = (uu___189_7836.curmonad);
                modules = (uu___189_7836.modules);
                scope_mods = uu____7837;
                exported_ids = (uu___189_7836.exported_ids);
                trans_exported_ids = (uu___189_7836.trans_exported_ids);
                includes = (uu___189_7836.includes);
                sigaccum = (uu___189_7836.sigaccum);
                sigmap = (uu___189_7836.sigmap);
                iface = (uu___189_7836.iface);
                admitted_iface = (uu___189_7836.admitted_iface);
                expect_typ = (uu___189_7836.expect_typ);
                docs = (uu___189_7836.docs);
                remaining_iface_decls = (uu___189_7836.remaining_iface_decls);
                syntax_only = (uu___189_7836.syntax_only)
              } in
            env4))
           ...
           (let env1 =
            ...
            (let uu____7958 = FStar_Util.smap_try_find env1.includes curmod in
             ...
             | FStar_Pervasives_Native.Some incl ->
                 let uu____7982 =
                   let uu____7985 = FStar_ST.read incl in ns1 :: uu____7985 in
                 FStar_ST.write incl uu____7982);
            (match () with
             | () ->
                 let uu____8052 =
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              let ns_ex =
                                ...
                                FStar_ST.read uu____8147 in
                              let ex = cur_exports k in
                              (let uu____8330 =
                                 let uu____8331 = FStar_ST.read ex in
                                 FStar_Util.set_difference uu____8331 ns_ex in
                               FStar_ST.write ex uu____8330);
                              (match () with
                               | () ->
                                   let trans_ex = cur_trans_exports k in
                                   let uu____8393 =
                                     let uu____8394 = FStar_ST.read trans_ex in
                                     FStar_Util.set_union uu____8394 ns_ex in
                                   FStar_ST.write trans_ex uu____8393) in
                     ...
                     ((let uu____8559 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___190_8573 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___190_8573.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___190_8573.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___190_8573.FStar_Syntax_Syntax.sigmeta);
                             FStar_Syntax_Syntax.sigattrs =
                               (uu___190_8573.FStar_Syntax_Syntax.sigattrs)
                           }), false)))
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___191_8695 = se in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___191_8695.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___191_8695.FStar_Syntax_Syntax.sigattrs)
                               } in
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____8787 = cur_ex eikind in FStar_ST.read uu____8787 in
              let cur_trans_ex_set_ref = cur_trans_ex eikind in
              let uu____8969 =
                let uu____8970 = FStar_ST.read cur_trans_ex_set_ref in
                FStar_Util.set_union cur_ex_set uu____8970 in
              FStar_ST.write cur_trans_ex_set_ref uu____8969 in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___192_9039 = env in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___192_9039.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___192_9039.exported_ids);
                    trans_exported_ids = (uu___192_9039.trans_exported_ids);
                    includes = (uu___192_9039.includes);
                    sigaccum = [];
                    sigmap = (uu___192_9039.sigmap);
                    iface = (uu___192_9039.iface);
                    admitted_iface = (uu___192_9039.admitted_iface);
                    expect_typ = (uu___192_9039.expect_typ);
                    docs = (uu___192_9039.docs);
                    remaining_iface_decls =
                      (uu___192_9039.remaining_iface_decls);
                    syntax_only = (uu___192_9039.syntax_only)
                  }))))
...
let push: env -> env =
  fun env  ->
    push_record_cache ();
    (let uu____9063 =
       let uu____9066 = FStar_ST.read stack in env :: uu____9066 in
     FStar_ST.write stack uu____9063);
    (let uu___193_9105 = env in
     let uu____9106 = FStar_Util.smap_copy (sigmap env) in
     let uu____9117 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___193_9105.curmodule);
       curmonad = (uu___193_9105.curmonad);
       modules = (uu___193_9105.modules);
       scope_mods = (uu___193_9105.scope_mods);
       exported_ids = (uu___193_9105.exported_ids);
       trans_exported_ids = (uu___193_9105.trans_exported_ids);
       includes = (uu___193_9105.includes);
       sigaccum = (uu___193_9105.sigaccum);
       sigmap = uu____9106;
       iface = (uu___193_9105.iface);
       admitted_iface = (uu___193_9105.admitted_iface);
       expect_typ = (uu___193_9105.expect_typ);
       docs = uu____9117;
       remaining_iface_decls = (uu___193_9105.remaining_iface_decls);
       syntax_only = (uu___193_9105.syntax_only)
     })
let pop: Prims.unit -> env =
  fun uu____9123  ->
    let uu____9124 = FStar_ST.read stack in
...
let commit_mark: env -> env =
  fun env  ->
    commit_record_cache ();
    (let uu____9177 = FStar_ST.read stack in
     match uu____9177 with
     | uu____9198::tl1 -> (FStar_ST.write stack tl1; env)
              ...
              | FStar_Pervasives_Native.Some (se,true ) when sigelt_in_m se
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___194_9307 = se in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___194_9307.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                            ...
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___194_9307.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___194_9307.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____9308 -> se in
      ...
      fun env  ->
        fun mname  ->
          let prep env1 =
            ...
            let auto_open1 =
              let convert_kind uu___175_9372 =
                match uu___175_9372 with
            ...
            let namespace_of_module =
              ...
              then
                let uu____9408 =
                  ...
                  (uu____9413, Open_namespace) in
                [uu____9408]
              else [] in
            let auto_open2 =
              FStar_List.rev
                (FStar_List.append auto_open1 namespace_of_module) in
            (let uu____9443 = exported_id_set_new () in
             FStar_Util.smap_add env1.exported_ids mname.FStar_Ident.str
               uu____9443);
            (match () with
             | () ->
                 ((let uu____9459 = exported_id_set_new () in
                   FStar_Util.smap_add env1.trans_exported_ids
                     mname.FStar_Ident.str uu____9459);
                  (match () with
                   | () ->
                       ((let uu____9475 = FStar_Util.mk_ref [] in
                         FStar_Util.smap_add env1.includes
                           mname.FStar_Ident.str uu____9475);
                        (match () with
                         | () ->
                             let uu___195_9500 = env1 in
                             let uu____9501 =
                               FStar_List.map
                                 ...
                                 auto_open2 in
                             {
                               ...
                               curmonad = (uu___195_9500.curmonad);
                               modules = (uu___195_9500.modules);
                               scope_mods = uu____9501;
                               exported_ids = (uu___195_9500.exported_ids);
                               trans_exported_ids =
                                 (uu___195_9500.trans_exported_ids);
                               includes = (uu___195_9500.includes);
                               sigaccum = (uu___195_9500.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___195_9500.expect_typ);
                               docs = (uu___195_9500.docs);
                               remaining_iface_decls =
                                 (uu___195_9500.remaining_iface_decls);
                               syntax_only = (uu___195_9500.syntax_only)
                             }))))) in
          let uu____9506 =
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____9532  ->
                    ...
                    | (l,uu____9538) -> FStar_Ident.lid_equals l mname)) in
          match uu____9506 with
          | FStar_Pervasives_Native.None  ->
              let uu____9547 = prep env in (uu____9547, false)
          | FStar_Pervasives_Native.Some (uu____9548,m) ->
              ((let uu____9555 =
                  (let uu____9558 = FStar_Options.interactive () in
                ...
                then
                  let uu____9559 =
                    let uu____9560 =
                      ...
                      (uu____9565, (FStar_Ident.range_of_lid mname)) in
                    FStar_Errors.Error uu____9560 in
                  raise uu____9559
                else ());
               (let uu____9567 = let uu____9568 = push env in prep uu____9568 in
                (uu____9567, true)))
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___196_9578 = env in
          {
            curmodule = (uu___196_9578.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___196_9578.modules);
            scope_mods = (uu___196_9578.scope_mods);
            exported_ids = (uu___196_9578.exported_ids);
            trans_exported_ids = (uu___196_9578.trans_exported_ids);
            includes = (uu___196_9578.includes);
            sigaccum = (uu___196_9578.sigaccum);
            sigmap = (uu___196_9578.sigmap);
            iface = (uu___196_9578.iface);
            admitted_iface = (uu___196_9578.admitted_iface);
            expect_typ = (uu___196_9578.expect_typ);
            docs = (uu___196_9578.docs);
            remaining_iface_decls = (uu___196_9578.remaining_iface_decls);
            syntax_only = (uu___196_9578.syntax_only)
          }
let fail_or:
  'a .
    env ->
        ...
        | FStar_Pervasives_Native.None  ->
            let opened_modules =
              FStar_List.map
                (fun uu____9622  ->
                   ...
                   | (lid1,uu____9628) -> FStar_Ident.text_of_lid lid1)
                env.modules in
            let msg =
            ...
            let msg1 =
              ...
              then msg
                ...
                (let modul =
                   let uu____9633 = FStar_Ident.lid_of_ids lid.FStar_Ident.ns in
                   FStar_Ident.set_lid_range uu____9633
                     (FStar_Ident.range_of_lid lid) in
                 let uu____9634 = resolve_module_name env modul true in
