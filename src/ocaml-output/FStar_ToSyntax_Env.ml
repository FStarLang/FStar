...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___162_2283 =
        match uu___162_2283 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2362 =
        match uu___163_2362 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2409 =
        match uu___164_2409 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___181_2540 = env in
        {
          curmodule = (uu___181_2540.curmodule);
          curmonad = (uu___181_2540.curmonad);
          modules = (uu___181_2540.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___181_2540.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___181_2540.sigaccum);
          sigmap = (uu___181_2540.sigmap);
          iface = (uu___181_2540.iface);
          admitted_iface = (uu___181_2540.admitted_iface);
          expect_typ = (uu___181_2540.expect_typ);
          docs = (uu___181_2540.docs);
          remaining_iface_decls = (uu___181_2540.remaining_iface_decls);
          syntax_only = (uu___181_2540.syntax_only)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_2564 =
        match uu___166_2564 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___167_2620 =
        match uu___167_2620 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___172_3662 =
            match uu___172_3662 with
            | Rec_binding uu____3663 -> true
            | uu____3664 -> false in
          let this_env =
            let uu___182_3666 = env in
            let uu____3667 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___182_3666.curmodule);
              curmonad = (uu___182_3666.curmonad);
              modules = (uu___182_3666.modules);
              scope_mods = uu____3667;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___182_3666.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___182_3666.sigaccum);
              sigmap = (uu___182_3666.sigmap);
              iface = (uu___182_3666.iface);
              admitted_iface = (uu___182_3666.admitted_iface);
              expect_typ = (uu___182_3666.expect_typ);
              docs = (uu___182_3666.docs);
              remaining_iface_decls = (uu___182_3666.remaining_iface_decls);
              syntax_only = (uu___182_3666.syntax_only)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___183_3686 = env in
      {
        curmodule = (uu___183_3686.curmodule);
        curmonad = (uu___183_3686.curmonad);
        modules = (uu___183_3686.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___183_3686.exported_ids);
        trans_exported_ids = (uu___183_3686.trans_exported_ids);
        includes = (uu___183_3686.includes);
        sigaccum = (uu___183_3686.sigaccum);
        sigmap = (uu___183_3686.sigmap);
        iface = (uu___183_3686.iface);
        admitted_iface = (uu___183_3686.admitted_iface);
        expect_typ = (uu___183_3686.expect_typ);
        docs = (uu___183_3686.docs);
        remaining_iface_decls = (uu___183_3686.remaining_iface_decls);
        syntax_only = (uu___183_3686.syntax_only)
      }
let push_bv':
            ...
            (match uu____3785 with
             ...
             | uu____3794 ->
                 (extract_record env globals s;
                  (let uu___184_3799 = env in
                   {
                     curmodule = (uu___184_3799.curmodule);
                     curmonad = (uu___184_3799.curmonad);
                     modules = (uu___184_3799.modules);
                     scope_mods = (uu___184_3799.scope_mods);
                     exported_ids = (uu___184_3799.exported_ids);
                     trans_exported_ids = (uu___184_3799.trans_exported_ids);
                     includes = (uu___184_3799.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___184_3799.sigmap);
                     iface = (uu___184_3799.iface);
                     admitted_iface = (uu___184_3799.admitted_iface);
                     expect_typ = (uu___184_3799.expect_typ);
                     docs = (uu___184_3799.docs);
                     remaining_iface_decls =
                       (uu___184_3799.remaining_iface_decls);
                     syntax_only = (uu___184_3799.syntax_only)
                   }))) in
      let env2 =
        let uu___185_3801 = env1 in
        let uu____3802 = FStar_ST.read globals in
        {
          curmodule = (uu___185_3801.curmodule);
          curmonad = (uu___185_3801.curmonad);
          modules = (uu___185_3801.modules);
          scope_mods = uu____3802;
          exported_ids = (uu___185_3801.exported_ids);
          trans_exported_ids = (uu___185_3801.trans_exported_ids);
          includes = (uu___185_3801.includes);
          sigaccum = (uu___185_3801.sigaccum);
          sigmap = (uu___185_3801.sigmap);
          iface = (uu___185_3801.iface);
          admitted_iface = (uu___185_3801.admitted_iface);
          expect_typ = (uu___185_3801.expect_typ);
          docs = (uu___185_3801.docs);
          remaining_iface_decls = (uu___185_3801.remaining_iface_decls);
          syntax_only = (uu___185_3801.syntax_only)
        } in
      let uu____3807 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___186_3922 = env3 in
              let uu____3923 = FStar_ST.read globals in
              {
                curmodule = (uu___186_3922.curmodule);
                curmonad = (uu___186_3922.curmonad);
                modules = (uu___186_3922.modules);
                scope_mods = uu____3923;
                exported_ids = (uu___186_3922.exported_ids);
                trans_exported_ids = (uu___186_3922.trans_exported_ids);
                includes = (uu___186_3922.includes);
                sigaccum = (uu___186_3922.sigaccum);
                sigmap = (uu___186_3922.sigmap);
                iface = (uu___186_3922.iface);
                admitted_iface = (uu___186_3922.admitted_iface);
                expect_typ = (uu___186_3922.expect_typ);
                docs = (uu___186_3922.docs);
                remaining_iface_decls = (uu___186_3922.remaining_iface_decls);
                syntax_only = (uu___186_3922.syntax_only)
              } in
            env4))
                     ...
                     ((let uu____4182 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___187_4192 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___187_4192.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___187_4192.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___187_4192.FStar_Syntax_Syntax.sigmeta)
                           }), false)))
                 | Some uu____4193 -> ())
            | uu____4198 -> ()))
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___188_4280 = se in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___188_4280.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___188_4280.FStar_Syntax_Syntax.sigmeta)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___189_4374 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___189_4374.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___189_4374.exported_ids);
                    trans_exported_ids = (uu___189_4374.trans_exported_ids);
                    includes = (uu___189_4374.includes);
                    sigaccum = [];
                    sigmap = (uu___189_4374.sigmap);
                    iface = (uu___189_4374.iface);
                    admitted_iface = (uu___189_4374.admitted_iface);
                    expect_typ = (uu___189_4374.expect_typ);
                    docs = (uu___189_4374.docs);
                    remaining_iface_decls =
                      (uu___189_4374.remaining_iface_decls);
                    syntax_only = (uu___189_4374.syntax_only)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___190_4397 = env in
     let uu____4398 = FStar_Util.smap_copy (sigmap env) in
     let uu____4404 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___190_4397.curmodule);
       curmonad = (uu___190_4397.curmonad);
       modules = (uu___190_4397.modules);
       scope_mods = (uu___190_4397.scope_mods);
       exported_ids = (uu___190_4397.exported_ids);
       trans_exported_ids = (uu___190_4397.trans_exported_ids);
       includes = (uu___190_4397.includes);
       sigaccum = (uu___190_4397.sigaccum);
       sigmap = uu____4398;
       iface = (uu___190_4397.iface);
       admitted_iface = (uu___190_4397.admitted_iface);
       expect_typ = (uu___190_4397.expect_typ);
       docs = uu____4404;
       remaining_iface_decls = (uu___190_4397.remaining_iface_decls);
       syntax_only = (uu___190_4397.syntax_only)
     })
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      ...
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          ...
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___191_4495.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                            ...
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___191_4495.FStar_Syntax_Syntax.sigmeta)
                          }
                      | uu____4496 -> se in
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___192_4562.curmonad);
                               modules = (uu___192_4562.modules);
                               scope_mods = uu____4563;
                               exported_ids = (uu___192_4562.exported_ids);
                               trans_exported_ids =
                                 (uu___192_4562.trans_exported_ids);
                               includes = (uu___192_4562.includes);
                               sigaccum = (uu___192_4562.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___192_4562.expect_typ);
                               docs = (uu___192_4562.docs);
                               remaining_iface_decls =
                                 (uu___192_4562.remaining_iface_decls);
                               syntax_only = (uu___192_4562.syntax_only)
                             }))))) in
          let uu____4566 =
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___193_4610 = env in
          {
            curmodule = (uu___193_4610.curmodule);
            curmonad = (Some mname);
            modules = (uu___193_4610.modules);
            scope_mods = (uu___193_4610.scope_mods);
            exported_ids = (uu___193_4610.exported_ids);
            trans_exported_ids = (uu___193_4610.trans_exported_ids);
            includes = (uu___193_4610.includes);
            sigaccum = (uu___193_4610.sigaccum);
            sigmap = (uu___193_4610.sigmap);
            iface = (uu___193_4610.iface);
            admitted_iface = (uu___193_4610.admitted_iface);
            expect_typ = (uu___193_4610.expect_typ);
            docs = (uu___193_4610.docs);
            remaining_iface_decls = (uu___193_4610.remaining_iface_decls);
            syntax_only = (uu___193_4610.syntax_only)
          }
