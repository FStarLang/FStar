        ...
        FStar_All.pipe_right m.FStar_Syntax_Syntax.declarations
          (FStar_List.map
             (fun s  ->
                match s.FStar_Syntax_Syntax.sigel with
                | FStar_Syntax_Syntax.Sig_declare_typ
                    (lid,uu____11048,uu____11049) when
                    FStar_List.existsb
                      (fun l  -> FStar_Ident.lid_equals l lid)
                      admitted_sig_lids
                    ->
                    let uu___128_11052 = s  in
                    {
                      FStar_Syntax_Syntax.sigel =
                        (uu___128_11052.FStar_Syntax_Syntax.sigel);
                      FStar_Syntax_Syntax.sigrng =
                        (uu___128_11052.FStar_Syntax_Syntax.sigrng);
                      FStar_Syntax_Syntax.sigquals =
                        (FStar_Syntax_Syntax.Assumption ::
                        (s.FStar_Syntax_Syntax.sigquals));
                      FStar_Syntax_Syntax.sigmeta =
                        (uu___128_11052.FStar_Syntax_Syntax.sigmeta);
                      FStar_Syntax_Syntax.sigattrs =
                        (uu___128_11052.FStar_Syntax_Syntax.sigattrs)
                    }
                | uu____11053 -> s))
         in
      {
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              let quals = se.FStar_Syntax_Syntax.sigquals  in
              match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_bundle (ses,uu____11070) ->
                  if
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1  ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid,uu____11090,uu____11091,uu____11092,uu____11093,uu____11094)
                                ->
                                FStar_Util.smap_remove (sigmap env)
                                  lid.FStar_Ident.str
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid,univ_names,binders,typ,uu____11107,uu____11108)
                                ->
                                (FStar_Util.smap_remove (sigmap env)
                                   lid.FStar_Ident.str;
                                 if
                                      ...
                                      let uu____11123 =
                                        let uu____11130 =
                                          ...
                                          uu____11133
                                            ...
                                            (FStar_Ident.range_of_lid lid)
                                           in
                                        (lid, univ_names, uu____11130)  in
                                      FStar_Syntax_Syntax.Sig_declare_typ
                                        uu____11123
                                       in
                                    let se2 =
                                      let uu___129_11157 = se1  in
                                      {
                                        FStar_Syntax_Syntax.sigel = sigel;
                                        FStar_Syntax_Syntax.sigrng =
                                          (uu___129_11157.FStar_Syntax_Syntax.sigrng);
                                        FStar_Syntax_Syntax.sigquals =
                                          (FStar_Syntax_Syntax.Assumption ::
                                          quals);
                                        FStar_Syntax_Syntax.sigmeta =
                                          (uu___129_11157.FStar_Syntax_Syntax.sigmeta);
                                        FStar_Syntax_Syntax.sigattrs =
                                          (uu___129_11157.FStar_Syntax_Syntax.sigattrs)
                                      }  in
                                    FStar_Util.smap_add (sigmap env)
              ...
              | FStar_Syntax_Syntax.Sig_declare_typ
                  (lid,uu____11166,uu____11167) ->
                  if FStar_List.contains FStar_Syntax_Syntax.Private quals
                  then
                    FStar_Util.smap_remove (sigmap env) lid.FStar_Ident.str
                  else ()
              | FStar_Syntax_Syntax.Sig_let ((uu____11173,lbs),uu____11175)
                  ->
                  (if
                     (FStar_List.contains FStar_Syntax_Syntax.Private quals)
                       ||
                                 ...
                                 let uu____11198 =
                                   let uu____11201 =
                                     FStar_Util.right
                                      ...
                                      in
                                   uu____11201.FStar_Syntax_Syntax.fv_name
                                    in
                                 uu____11198.FStar_Syntax_Syntax.v  in
                               uu____11197.FStar_Ident.str  in
                             FStar_Util.smap_remove (sigmap env) uu____11196))
                   else ();
                   if
                     (FStar_List.contains FStar_Syntax_Syntax.Abstract quals)
                       &&
                               ...
                               let uu____11215 =
                                 let uu____11218 =
                                   FStar_Util.right
                                     lb.FStar_Syntax_Syntax.lbname
                                    in
                                 uu____11218.FStar_Syntax_Syntax.fv_name  in
                               uu____11215.FStar_Syntax_Syntax.v  in
                             let quals1 = FStar_Syntax_Syntax.Assumption ::
                               quals  in
                             let decl =
                               let uu___130_11223 = se  in
                               {
                                 FStar_Syntax_Syntax.sigel =
                                   (FStar_Syntax_Syntax.Sig_declare_typ
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___130_11223.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___130_11223.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___130_11223.FStar_Syntax_Syntax.sigattrs)
                               }  in
                             FStar_Util.smap_add (sigmap env)
              ...
              | uu____11233 -> ()));
      (let curmod =
         let uu____11235 = current_module env  in uu____11235.FStar_Ident.str
          in
       (let uu____11237 =
          let uu____11254 = get_exported_id_set env curmod  in
          let uu____11261 = get_trans_exported_id_set env curmod  in
          (uu____11254, uu____11261)  in
        match uu____11237 with
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____11315 = cur_ex eikind  in
                FStar_ST.op_Bang uu____11315  in
              let cur_trans_ex_set_ref = cur_trans_ex eikind  in
              let uu____11544 =
                let uu____11545 = FStar_ST.op_Bang cur_trans_ex_set_ref  in
                FStar_Util.set_union cur_ex_set uu____11545  in
              FStar_ST.op_Colon_Equals cur_trans_ex_set_ref uu____11544  in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___131_11752 = env  in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___131_11752.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___131_11752.exported_ids);
                    trans_exported_ids = (uu___131_11752.trans_exported_ids);
                    includes = (uu___131_11752.includes);
                    sigaccum = [];
                    sigmap = (uu___131_11752.sigmap);
                    iface = (uu___131_11752.iface);
                    admitted_iface = (uu___131_11752.admitted_iface);
                    expect_typ = (uu___131_11752.expect_typ);
                    docs = (uu___131_11752.docs);
                    remaining_iface_decls =
                      (uu___131_11752.remaining_iface_decls);
                    syntax_only = (uu___131_11752.syntax_only);
                    ds_hooks = (uu___131_11752.ds_hooks)
                  }))))
...
let (push : env -> env) =
  fun env  ->
    push_record_cache ();
    (let uu____11805 =
       let uu____11808 = FStar_ST.op_Bang stack  in env :: uu____11808  in
     FStar_ST.op_Colon_Equals stack uu____11805);
    (let uu___132_11857 = env  in
     let uu____11858 = FStar_Util.smap_copy (sigmap env)  in
     let uu____11869 = FStar_Util.smap_copy env.docs  in
     {
       curmodule = (uu___132_11857.curmodule);
       curmonad = (uu___132_11857.curmonad);
       modules = (uu___132_11857.modules);
       scope_mods = (uu___132_11857.scope_mods);
       exported_ids = (uu___132_11857.exported_ids);
       trans_exported_ids = (uu___132_11857.trans_exported_ids);
       includes = (uu___132_11857.includes);
       sigaccum = (uu___132_11857.sigaccum);
       sigmap = uu____11858;
       iface = (uu___132_11857.iface);
       admitted_iface = (uu___132_11857.admitted_iface);
       expect_typ = (uu___132_11857.expect_typ);
       docs = uu____11869;
       remaining_iface_decls = (uu___132_11857.remaining_iface_decls);
       syntax_only = (uu___132_11857.syntax_only);
       ds_hooks = (uu___132_11857.ds_hooks)
     })
  
let (pop : Prims.unit -> env) =
  fun uu____11874  ->
    let uu____11875 = FStar_ST.op_Bang stack  in
    match uu____11875 with
    | env::tl1 ->
        (pop_record_cache (); FStar_ST.op_Colon_Equals stack tl1; env)
    | uu____11930 -> failwith "Impossible: Too many pops"
  ...
  fun m  ->
    fun env  ->
      let sigelt_in_m se =
        ...
        | l::uu____11944 -> l.FStar_Ident.nsstr = m.FStar_Ident.str
      ...
      FStar_All.pipe_right keys
        (FStar_List.iter
           (fun k  ->
              let uu____11981 = FStar_Util.smap_try_find sm' k  in
              ...
              | FStar_Pervasives_Native.Some (se,true ) when sigelt_in_m se
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___133_12006 = se  in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___133_12006.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___133_12006.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___133_12006.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___133_12006.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____12007 -> se  in
...
let (finish_module_or_interface :
  ...
  fun env  ->
    fun modul  ->
      ...
      let uu____12031 = finish env modul1  in (uu____12031, modul1)
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e  ->
    let terms =
      let uu____12187 =
        let uu____12190 = e Exported_id_term_type  in
        FStar_ST.op_Bang uu____12190  in
      FStar_Util.set_elements uu____12187  in
    let fields =
      let uu____12382 =
        let uu____12385 = e Exported_id_field  in
        FStar_ST.op_Bang uu____12385  in
      FStar_Util.set_elements uu____12382  in
  ...
  fun e  ->
    ...
    | FStar_Pervasives_Native.Some e1 ->
        let terms =
          ...
          FStar_Util.mk_ref uu____12636  in
        let fields =
          let uu____12646 =
            FStar_Util.as_set e1.exported_id_fields FStar_Util.compare  in
          FStar_Util.mk_ref uu____12646  in
        (fun uu___108_12651  ->
           match uu___108_12651 with
...
let as_includes :
  'Auu____12849 .
    'Auu____12849 Prims.list FStar_Pervasives_Native.option ->
      'Auu____12849 Prims.list FStar_ST.ref
  =
  fun uu___109_12861  ->
    match uu___109_12861 with
...
let (inclusion_info : env -> FStar_Ident.lident -> module_inclusion_info) =
  fun env  ->
    fun l  ->
      ...
      let as_ids_opt m =
        let uu____12894 = FStar_Util.smap_try_find m mname  in
        FStar_Util.map_opt uu____12894 as_exported_ids  in
      let uu____12897 = as_ids_opt env.exported_ids  in
      let uu____12900 = as_ids_opt env.trans_exported_ids  in
      let uu____12903 =
        let uu____12908 = FStar_Util.smap_try_find env.includes mname  in
        FStar_Util.map_opt uu____12908 (fun r  -> FStar_ST.op_Bang r)  in
      {
        mii_exported_ids = uu____12897;
        mii_trans_exported_ids = uu____12900;
        mii_includes = uu____12903
      }
        ...
        fun mname  ->
          fun mii  ->
            let prep env1 =
              ...
              let auto_open1 =
                let convert_kind uu___110_13106 =
                  match uu___110_13106 with
              ...
              let auto_open2 =
                FStar_List.append namespace_of_module
                 ...
                 in
              (let uu____13177 = as_exported_id_set mii.mii_exported_ids  in
               ...
               | () ->
                   ((let uu____13253 =
                     ...
                     FStar_Util.smap_add env1.trans_exported_ids
                       mname.FStar_Ident.str uu____13253);
                    (match () with
                     | () ->
                         ((let uu____13329 = as_includes mii.mii_includes  in
                           FStar_Util.smap_add env1.includes
                             mname.FStar_Ident.str uu____13329);
                          (match () with
                           | () ->
                               let env' =
                                 let uu___134_13413 = env1  in
                                 let uu____13414 =
                                   FStar_List.map
                                    ...
                                    in
                                 {
                                   ...
                                   curmonad = (uu___134_13413.curmonad);
                                   modules = (uu___134_13413.modules);
                                   scope_mods = uu____13414;
                                   exported_ids =
                                     (uu___134_13413.exported_ids);
                                   trans_exported_ids =
                                     (uu___134_13413.trans_exported_ids);
                                   includes = (uu___134_13413.includes);
                                   sigaccum = (uu___134_13413.sigaccum);
                                   sigmap = (env1.sigmap);
                                   iface = intf;
                                   admitted_iface = admitted;
                                   expect_typ = (uu___134_13413.expect_typ);
                                   docs = (uu___134_13413.docs);
                                   remaining_iface_decls =
                                     (uu___134_13413.remaining_iface_decls);
                                   syntax_only = (uu___134_13413.syntax_only);
                                   ds_hooks = (uu___134_13413.ds_hooks)
                                 }  in
                               (FStar_List.iter
                                  (fun op  ->
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____13452  ->
                      ...
                      | (l,uu____13458) -> FStar_Ident.lid_equals l mname))
               in
            match uu____13426 with
            | FStar_Pervasives_Native.None  ->
                let uu____13467 = prep env  in (uu____13467, false)
            | FStar_Pervasives_Native.Some (uu____13468,m) ->
                ((let uu____13475 =
                    (let uu____13478 = FStar_Options.interactive ()  in
                  ...
                  then
                    let uu____13479 =
                      ...
                      (FStar_Errors.Fatal_DuplicateModuleOrInterface,
                        uu____13484)
                       in
                    FStar_Errors.raise_error uu____13479
                      (FStar_Ident.range_of_lid mname)
                  else ());
                 (let uu____13486 =
                    let uu____13487 = push env  in prep uu____13487  in
                  (uu____13486, true)))
...
let (enter_monad_scope : env -> FStar_Ident.ident -> env) =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___135_13495 = env  in
          {
            curmodule = (uu___135_13495.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___135_13495.modules);
            scope_mods = (uu___135_13495.scope_mods);
            exported_ids = (uu___135_13495.exported_ids);
            trans_exported_ids = (uu___135_13495.trans_exported_ids);
            includes = (uu___135_13495.includes);
            sigaccum = (uu___135_13495.sigaccum);
            sigmap = (uu___135_13495.sigmap);
            iface = (uu___135_13495.iface);
            admitted_iface = (uu___135_13495.admitted_iface);
            expect_typ = (uu___135_13495.expect_typ);
            docs = (uu___135_13495.docs);
            remaining_iface_decls = (uu___135_13495.remaining_iface_decls);
            syntax_only = (uu___135_13495.syntax_only);
            ds_hooks = (uu___135_13495.ds_hooks)
          }
            ...
            let opened_modules =
              FStar_List.map
                (fun uu____13535  ->
                   ...
                   | (lid1,uu____13541) -> FStar_Ident.text_of_lid lid1)
                env.modules
               in
            let msg =
            ...
            let msg1 =
              ...
              then msg
                ...
                (let modul =
                   let uu____13546 =
                     FStar_Ident.lid_of_ids lid.FStar_Ident.ns  in
                   FStar_Ident.set_lid_range uu____13546
                     (FStar_Ident.range_of_lid lid)
                    in
                 let uu____13547 = resolve_module_name env modul true  in
