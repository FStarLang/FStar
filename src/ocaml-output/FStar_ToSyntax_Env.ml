...
let set_current_module: env -> FStar_Ident.lident -> env =
  fun e  ->
    fun l  ->
      let uu___190_1934 = e in
      {
        curmodule = (FStar_Pervasives_Native.Some l);
        curmonad = (uu___190_1934.curmonad);
        modules = (uu___190_1934.modules);
        scope_mods = (uu___190_1934.scope_mods);
        exported_ids = (uu___190_1934.exported_ids);
        trans_exported_ids = (uu___190_1934.trans_exported_ids);
        includes = (uu___190_1934.includes);
        sigaccum = (uu___190_1934.sigaccum);
        sigmap = (uu___190_1934.sigmap);
        iface = (uu___190_1934.iface);
        admitted_iface = (uu___190_1934.admitted_iface);
        expect_typ = (uu___190_1934.expect_typ);
        docs = (uu___190_1934.docs);
        remaining_iface_decls = (uu___190_1934.remaining_iface_decls);
        syntax_only = (uu___190_1934.syntax_only);
        ds_hooks = (uu___190_1934.ds_hooks)
      }
  ...
  fun env  ->
    fun l  ->
      fun ds  ->
        ...
        | (uu____2078,rest) ->
            let uu___191_2112 = env in
            {
              curmodule = (uu___191_2112.curmodule);
              curmonad = (uu___191_2112.curmonad);
              modules = (uu___191_2112.modules);
              scope_mods = (uu___191_2112.scope_mods);
              exported_ids = (uu___191_2112.exported_ids);
              trans_exported_ids = (uu___191_2112.trans_exported_ids);
              includes = (uu___191_2112.includes);
              sigaccum = (uu___191_2112.sigaccum);
              sigmap = (uu___191_2112.sigmap);
              iface = (uu___191_2112.iface);
              admitted_iface = (uu___191_2112.admitted_iface);
              expect_typ = (uu___191_2112.expect_typ);
              docs = (uu___191_2112.docs);
              remaining_iface_decls = ((l, ds) :: rest);
              syntax_only = (uu___191_2112.syntax_only);
              ds_hooks = (uu___191_2112.ds_hooks)
            }
...
let set_syntax_only: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___192_2144 = env in
      {
        curmodule = (uu___192_2144.curmodule);
        curmonad = (uu___192_2144.curmonad);
        modules = (uu___192_2144.modules);
        scope_mods = (uu___192_2144.scope_mods);
        exported_ids = (uu___192_2144.exported_ids);
        trans_exported_ids = (uu___192_2144.trans_exported_ids);
        includes = (uu___192_2144.includes);
        sigaccum = (uu___192_2144.sigaccum);
        sigmap = (uu___192_2144.sigmap);
        iface = (uu___192_2144.iface);
        admitted_iface = (uu___192_2144.admitted_iface);
        expect_typ = (uu___192_2144.expect_typ);
        docs = (uu___192_2144.docs);
        remaining_iface_decls = (uu___192_2144.remaining_iface_decls);
        syntax_only = b;
        ds_hooks = (uu___192_2144.ds_hooks)
      }
let ds_hooks: env -> dsenv_hooks = fun env  -> env.ds_hooks
let set_ds_hooks: env -> dsenv_hooks -> env =
  fun env  ->
    fun hooks  ->
      let uu___193_2154 = env in
      {
        curmodule = (uu___193_2154.curmodule);
        curmonad = (uu___193_2154.curmonad);
        modules = (uu___193_2154.modules);
        scope_mods = (uu___193_2154.scope_mods);
        exported_ids = (uu___193_2154.exported_ids);
        trans_exported_ids = (uu___193_2154.trans_exported_ids);
        includes = (uu___193_2154.includes);
        sigaccum = (uu___193_2154.sigaccum);
        sigmap = (uu___193_2154.sigmap);
        iface = (uu___193_2154.iface);
        admitted_iface = (uu___193_2154.admitted_iface);
        expect_typ = (uu___193_2154.expect_typ);
        docs = (uu___193_2154.docs);
        remaining_iface_decls = (uu___193_2154.remaining_iface_decls);
        syntax_only = (uu___193_2154.syntax_only);
        ds_hooks = hooks
      }
...
let set_bv_range:
  ...
  fun bv  ->
    fun r  ->
      let id1 =
        let uu___194_2241 = bv.FStar_Syntax_Syntax.ppname in
        {
          FStar_Ident.idText = (uu___194_2241.FStar_Ident.idText);
          FStar_Ident.idRange = r
        } in
      let uu___195_2242 = bv in
      {
        FStar_Syntax_Syntax.ppname = id1;
        FStar_Syntax_Syntax.index = (uu___195_2242.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___195_2242.FStar_Syntax_Syntax.sort)
      }
let bv_to_name:
        ...
        fun env  ->
          fun ns  ->
            fun id1  ->
              ...
              let rec aux uu___158_2631 =
                match uu___158_2631 with
            ...
            fun k_record  ->
              fun find_in_module  ->
                fun lookup_default_id  ->
                  ...
                  let rec aux uu___163_3164 =
                    match uu___163_3164 with
                    | a::q ->
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___164_3542 =
          match uu___164_3542 with
          | [] ->
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___172_4289 =
            match uu___172_4289 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___173_4922 =
        match uu___173_4922 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___174_5050 =
        match uu___174_5050 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___175_5116 =
        match uu___175_5116 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
               (lbs,uu____5126);
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___196_5296 = env in
        {
          curmodule = (uu___196_5296.curmodule);
          curmonad = (uu___196_5296.curmonad);
          modules = (uu___196_5296.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___196_5296.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___196_5296.sigaccum);
          sigmap = (uu___196_5296.sigmap);
          iface = (uu___196_5296.iface);
          admitted_iface = (uu___196_5296.admitted_iface);
          expect_typ = (uu___196_5296.expect_typ);
          docs = (uu___196_5296.docs);
          remaining_iface_decls = (uu___196_5296.remaining_iface_decls);
          syntax_only = (uu___196_5296.syntax_only);
          ds_hooks = (uu___196_5296.ds_hooks)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___177_5325 =
        match uu___177_5325 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___178_5412 =
        match uu___178_5412 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_interface  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___183_7775 =
            match uu___183_7775 with
            | Rec_binding uu____7776 -> true
            | uu____7777 -> false in
          let this_env =
            let uu___197_7779 = env in
            let uu____7780 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___197_7779.curmodule);
              curmonad = (uu___197_7779.curmonad);
              modules = (uu___197_7779.modules);
              scope_mods = uu____7780;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___197_7779.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___197_7779.sigaccum);
              sigmap = (uu___197_7779.sigmap);
              iface = (uu___197_7779.iface);
              admitted_iface = (uu___197_7779.admitted_iface);
              expect_typ = (uu___197_7779.expect_typ);
              docs = (uu___197_7779.docs);
              remaining_iface_decls = (uu___197_7779.remaining_iface_decls);
              syntax_only = (uu___197_7779.syntax_only);
              ds_hooks = (uu___197_7779.ds_hooks)
            } in
          let uu____7783 =
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___198_7809 = env in
      {
        curmodule = (uu___198_7809.curmodule);
        curmonad = (uu___198_7809.curmonad);
        modules = (uu___198_7809.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___198_7809.exported_ids);
        trans_exported_ids = (uu___198_7809.trans_exported_ids);
        includes = (uu___198_7809.includes);
        sigaccum = (uu___198_7809.sigaccum);
        sigmap = (uu___198_7809.sigmap);
        iface = (uu___198_7809.iface);
        admitted_iface = (uu___198_7809.admitted_iface);
        expect_typ = (uu___198_7809.expect_typ);
        docs = (uu___198_7809.docs);
        remaining_iface_decls = (uu___198_7809.remaining_iface_decls);
        syntax_only = (uu___198_7809.syntax_only);
        ds_hooks = (uu___198_7809.ds_hooks)
      }
let push_bv':
  env ->
    FStar_Ident.ident ->
            ...
            (match uu____7937 with
             ...
             | uu____7949 ->
                 (extract_record env globals s;
                  (let uu___199_7967 = env in
                   {
                     curmodule = (uu___199_7967.curmodule);
                     curmonad = (uu___199_7967.curmonad);
                     modules = (uu___199_7967.modules);
                     scope_mods = (uu___199_7967.scope_mods);
                     exported_ids = (uu___199_7967.exported_ids);
                     trans_exported_ids = (uu___199_7967.trans_exported_ids);
                     includes = (uu___199_7967.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___199_7967.sigmap);
                     iface = (uu___199_7967.iface);
                     admitted_iface = (uu___199_7967.admitted_iface);
                     expect_typ = (uu___199_7967.expect_typ);
                     docs = (uu___199_7967.docs);
                     remaining_iface_decls =
                       (uu___199_7967.remaining_iface_decls);
                     syntax_only = (uu___199_7967.syntax_only);
                     ds_hooks = (uu___199_7967.ds_hooks)
                   }))) in
      let env2 =
        let uu___200_7969 = env1 in
        let uu____7970 = FStar_ST.op_Bang globals in
        {
          curmodule = (uu___200_7969.curmodule);
          curmonad = (uu___200_7969.curmonad);
          modules = (uu___200_7969.modules);
          scope_mods = uu____7970;
          exported_ids = (uu___200_7969.exported_ids);
          trans_exported_ids = (uu___200_7969.trans_exported_ids);
          includes = (uu___200_7969.includes);
          sigaccum = (uu___200_7969.sigaccum);
          sigmap = (uu___200_7969.sigmap);
          iface = (uu___200_7969.iface);
          admitted_iface = (uu___200_7969.admitted_iface);
          expect_typ = (uu___200_7969.expect_typ);
          docs = (uu___200_7969.docs);
          remaining_iface_decls = (uu___200_7969.remaining_iface_decls);
          syntax_only = (uu___200_7969.syntax_only);
          ds_hooks = (uu___200_7969.ds_hooks)
        } in
      let uu____8039 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___201_8487 = env3 in
              let uu____8488 = FStar_ST.op_Bang globals in
              {
                curmodule = (uu___201_8487.curmodule);
                curmonad = (uu___201_8487.curmonad);
                modules = (uu___201_8487.modules);
                scope_mods = uu____8488;
                exported_ids = (uu___201_8487.exported_ids);
                trans_exported_ids = (uu___201_8487.trans_exported_ids);
                includes = (uu___201_8487.includes);
                sigaccum = (uu___201_8487.sigaccum);
                sigmap = (uu___201_8487.sigmap);
                iface = (uu___201_8487.iface);
                admitted_iface = (uu___201_8487.admitted_iface);
                expect_typ = (uu___201_8487.expect_typ);
                docs = (uu___201_8487.docs);
                remaining_iface_decls = (uu___201_8487.remaining_iface_decls);
                syntax_only = (uu___201_8487.syntax_only);
                ds_hooks = (uu___201_8487.ds_hooks)
              } in
            env4))
                     ...
                     ((let uu____9533 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___202_9551 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___202_9551.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___202_9551.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___202_9551.FStar_Syntax_Syntax.sigmeta);
                             FStar_Syntax_Syntax.sigattrs =
                               (uu___202_9551.FStar_Syntax_Syntax.sigattrs)
                           }), false)))
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | FStar_Syntax_Syntax.Sig_declare_typ
                  (lid,uu____9614,uu____9615) ->
                  if FStar_List.contains FStar_Syntax_Syntax.Private quals
                  then
                    FStar_Util.smap_remove (sigmap env) lid.FStar_Ident.str
                  else ()
              | FStar_Syntax_Syntax.Sig_let ((uu____9621,lbs),uu____9623) ->
                  (if
                     (FStar_List.contains FStar_Syntax_Syntax.Private quals)
                       ||
                             ...
                             let uu____9644 =
                               let uu____9645 =
                                 let uu____9646 =
                                   ...
                                   uu____9649.FStar_Syntax_Syntax.fv_name in
                                 uu____9646.FStar_Syntax_Syntax.v in
                               uu____9645.FStar_Ident.str in
                             FStar_Util.smap_remove (sigmap env) uu____9644))
                   else ();
                   if
                     (FStar_List.contains FStar_Syntax_Syntax.Abstract quals)
                       &&
                             ...
                             let lid =
                               let uu____9663 =
                                 let uu____9666 =
                                   FStar_Util.right
                                     lb.FStar_Syntax_Syntax.lbname in
                                 uu____9666.FStar_Syntax_Syntax.fv_name in
                               uu____9663.FStar_Syntax_Syntax.v in
                             let quals1 = FStar_Syntax_Syntax.Assumption ::
                               quals in
                             let decl =
                               let uu___203_9671 = se in
                               {
                                 FStar_Syntax_Syntax.sigel =
                                   (FStar_Syntax_Syntax.Sig_declare_typ
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___203_9671.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___203_9671.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___203_9671.FStar_Syntax_Syntax.sigattrs)
                               } in
              ...
              | uu____9681 -> ()));
      (let curmod =
         let uu____9683 = current_module env in uu____9683.FStar_Ident.str in
       (let uu____9685 =
          let uu____9702 = get_exported_id_set env curmod in
          let uu____9709 = get_trans_exported_id_set env curmod in
          (uu____9702, uu____9709) in
        match uu____9685 with
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____9763 = cur_ex eikind in FStar_ST.op_Bang uu____9763 in
              let cur_trans_ex_set_ref = cur_trans_ex eikind in
              let uu____10021 =
                let uu____10022 = FStar_ST.op_Bang cur_trans_ex_set_ref in
                FStar_Util.set_union cur_ex_set uu____10022 in
              FStar_ST.op_Colon_Equals cur_trans_ex_set_ref uu____10021 in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___204_10167 = env in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___204_10167.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___204_10167.exported_ids);
                    trans_exported_ids = (uu___204_10167.trans_exported_ids);
                    includes = (uu___204_10167.includes);
                    sigaccum = [];
                    sigmap = (uu___204_10167.sigmap);
                    iface = (uu___204_10167.iface);
                    admitted_iface = (uu___204_10167.admitted_iface);
                    expect_typ = (uu___204_10167.expect_typ);
                    docs = (uu___204_10167.docs);
                    remaining_iface_decls =
                      (uu___204_10167.remaining_iface_decls);
                    syntax_only = (uu___204_10167.syntax_only);
                    ds_hooks = (uu___204_10167.ds_hooks)
                  }))))
...
let push: env -> env =
  fun env  ->
    push_record_cache ();
    (let uu____10190 =
       let uu____10193 = FStar_ST.op_Bang stack in env :: uu____10193 in
     FStar_ST.op_Colon_Equals stack uu____10190);
    (let uu___205_10300 = env in
     let uu____10301 = FStar_Util.smap_copy (sigmap env) in
     let uu____10312 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___205_10300.curmodule);
       curmonad = (uu___205_10300.curmonad);
       modules = (uu___205_10300.modules);
       scope_mods = (uu___205_10300.scope_mods);
       exported_ids = (uu___205_10300.exported_ids);
       trans_exported_ids = (uu___205_10300.trans_exported_ids);
       includes = (uu___205_10300.includes);
       sigaccum = (uu___205_10300.sigaccum);
       sigmap = uu____10301;
       iface = (uu___205_10300.iface);
       admitted_iface = (uu___205_10300.admitted_iface);
       expect_typ = (uu___205_10300.expect_typ);
       docs = uu____10312;
       remaining_iface_decls = (uu___205_10300.remaining_iface_decls);
       syntax_only = (uu___205_10300.syntax_only);
       ds_hooks = (uu___205_10300.ds_hooks)
     })
let pop: Prims.unit -> env =
  fun uu____10317  ->
    let uu____10318 = FStar_ST.op_Bang stack in
    match uu____10318 with
    | env::tl1 ->
        (pop_record_cache (); FStar_ST.op_Colon_Equals stack tl1; env)
    | uu____10431 -> failwith "Impossible: Too many pops"
let export_interface: FStar_Ident.lident -> env -> env =
  fun m  ->
    fun env  ->
      let sigelt_in_m se =
        match FStar_Syntax_Util.lids_of_sigelt se with
        | l::uu____10445 -> l.FStar_Ident.nsstr = m.FStar_Ident.str
        | uu____10448 -> false in
      ...
      FStar_All.pipe_right keys
        (FStar_List.iter
           (fun k  ->
              let uu____10482 = FStar_Util.smap_try_find sm' k in
              ...
              | FStar_Pervasives_Native.Some (se,true ) when sigelt_in_m se
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___206_10507 = se in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___206_10507.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___206_10507.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___206_10507.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___206_10507.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____10508 -> se in
...
let as_exported_ids: exported_id_set -> exported_ids =
  fun e  ->
    let terms =
      let uu____10593 =
        let uu____10596 = e Exported_id_term_type in
        FStar_ST.op_Bang uu____10596 in
      FStar_Util.set_elements uu____10593 in
    let fields =
      let uu____10847 =
        let uu____10850 = e Exported_id_field in FStar_ST.op_Bang uu____10850 in
      FStar_Util.set_elements uu____10847 in
  ...
  fun e  ->
    ...
    | FStar_Pervasives_Native.Some e1 ->
        let terms =
          ...
          FStar_Util.mk_ref uu____11130 in
        let fields =
          let uu____11140 =
            FStar_Util.as_set e1.exported_id_fields FStar_Util.compare in
          FStar_Util.mk_ref uu____11140 in
        (fun uu___184_11145  ->
           match uu___184_11145 with
...
let as_includes:
  'Auu____11253 .
    'Auu____11253 Prims.list FStar_Pervasives_Native.option ->
      'Auu____11253 Prims.list FStar_ST.ref
  =
  fun uu___185_11265  ->
    match uu___185_11265 with
...
let inclusion_info: env -> FStar_Ident.lident -> module_inclusion_info =
  fun env  ->
    fun l  ->
      ...
      let as_ids_opt m =
        let uu____11298 = FStar_Util.smap_try_find m mname in
        FStar_Util.map_opt uu____11298 as_exported_ids in
      let uu____11301 = as_ids_opt env.exported_ids in
      let uu____11304 = as_ids_opt env.trans_exported_ids in
      let uu____11307 =
        let uu____11312 = FStar_Util.smap_try_find env.includes mname in
        FStar_Util.map_opt uu____11312 (fun r  -> FStar_ST.op_Bang r) in
      {
        mii_exported_ids = uu____11301;
        mii_trans_exported_ids = uu____11304;
        mii_includes = uu____11307
      }
        ...
        fun mname  ->
          fun mii  ->
            let prep env1 =
              ...
              let auto_open1 =
                let convert_kind uu___186_11449 =
                  match uu___186_11449 with
              ...
              let namespace_of_module =
                ...
                then
                  let uu____11485 =
                    ...
                    (uu____11490, Open_namespace) in
                  [uu____11485]
                else [] in
              let auto_open2 =
                FStar_List.append namespace_of_module
                  (FStar_List.rev auto_open1) in
              (let uu____11520 = as_exported_id_set mii.mii_exported_ids in
               ...
               | () ->
                   ((let uu____11536 =
                     ...
                     FStar_Util.smap_add env1.trans_exported_ids
                       mname.FStar_Ident.str uu____11536);
                    (match () with
                     | () ->
                         ((let uu____11552 = as_includes mii.mii_includes in
                           FStar_Util.smap_add env1.includes
                             mname.FStar_Ident.str uu____11552);
                          (match () with
                           | () ->
                               let env' =
                                 let uu___207_11576 = env1 in
                                 let uu____11577 =
                                   FStar_List.map
                                     ...
                                     auto_open2 in
                                 {
                                   ...
                                   curmonad = (uu___207_11576.curmonad);
                                   modules = (uu___207_11576.modules);
                                   scope_mods = uu____11577;
                                   exported_ids =
                                     (uu___207_11576.exported_ids);
                                   trans_exported_ids =
                                     (uu___207_11576.trans_exported_ids);
                                   includes = (uu___207_11576.includes);
                                   sigaccum = (uu___207_11576.sigaccum);
                                   sigmap = (env1.sigmap);
                                   iface = intf;
                                   admitted_iface = admitted;
                                   expect_typ = (uu___207_11576.expect_typ);
                                   docs = (uu___207_11576.docs);
                                   remaining_iface_decls =
                                     (uu___207_11576.remaining_iface_decls);
                                   syntax_only = (uu___207_11576.syntax_only);
                                   ds_hooks = (uu___207_11576.ds_hooks)
                                 } in
                               (FStar_List.iter
                                  (fun op  ->
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____11615  ->
                      ...
                      | (l,uu____11621) -> FStar_Ident.lid_equals l mname)) in
            match uu____11589 with
            | FStar_Pervasives_Native.None  ->
                let uu____11630 = prep env in (uu____11630, false)
            | FStar_Pervasives_Native.Some (uu____11631,m) ->
                ((let uu____11638 =
                    (let uu____11641 = FStar_Options.interactive () in
                     Prims.op_Negation uu____11641) &&
                  ...
                  then
                    let uu____11642 =
                      ...
                      (FStar_Errors.Fatal_DuplicateModuleOrInterface,
                        uu____11647) in
                    FStar_Errors.raise_error uu____11642
                      (FStar_Ident.range_of_lid mname)
                  else ());
                 (let uu____11649 =
                    let uu____11650 = push env in prep uu____11650 in
                  (uu____11649, true)))
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___208_11658 = env in
          {
            curmodule = (uu___208_11658.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___208_11658.modules);
            scope_mods = (uu___208_11658.scope_mods);
            exported_ids = (uu___208_11658.exported_ids);
            trans_exported_ids = (uu___208_11658.trans_exported_ids);
            includes = (uu___208_11658.includes);
            sigaccum = (uu___208_11658.sigaccum);
            sigmap = (uu___208_11658.sigmap);
            iface = (uu___208_11658.iface);
            admitted_iface = (uu___208_11658.admitted_iface);
            expect_typ = (uu___208_11658.expect_typ);
            docs = (uu___208_11658.docs);
            remaining_iface_decls = (uu___208_11658.remaining_iface_decls);
            syntax_only = (uu___208_11658.syntax_only);
            ds_hooks = (uu___208_11658.ds_hooks)
          }
let fail_or:
  'a .
    env ->
            ...
            let opened_modules =
              FStar_List.map
                (fun uu____11698  ->
                   ...
                   | (lid1,uu____11704) -> FStar_Ident.text_of_lid lid1)
                env.modules in
            let msg =
            ...
            let msg1 =
              ...
              then msg
                ...
                (let modul =
                   let uu____11709 =
                     FStar_Ident.lid_of_ids lid.FStar_Ident.ns in
                   FStar_Ident.set_lid_range uu____11709
                     (FStar_Ident.range_of_lid lid) in
                 let uu____11710 = resolve_module_name env modul true in
