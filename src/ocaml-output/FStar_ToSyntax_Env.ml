    ...
    fun id  ->
      ...
      | uu____1239 ->
          try_lookup_id'' env id Exported_id_term_type
            (fun r  ->
               let uu____1246 = found_local_binding id.FStar_Ident.idRange r in
        ...
        let uu____1547 =
          is_full_path &&
            (let uu____1548 = FStar_Ident.lid_of_ids ids in
             module_is_defined env uu____1548) in
        if uu____1547
        then (ids, [])
        else
        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___157_1842  ->
               ...
               | uu____1851 -> FStar_Pervasives_Native.None) in
        (match qopt with
         | FStar_Pervasives_Native.None  ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
         | x -> x)
        ...
        fun lid  ->
          ...
          let k_global_def source_lid uu___161_1910 =
            ...
            | (se,uu____1916) ->
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     let uu____1940 =
                       let uu____1941 =
                         let uu____1944 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____1945 in
                         (uu____1944, false) in
                            ...
                            let uu____2006 =
                              let uu____2007 =
                                let uu____2010 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____2011 in
                                (uu____2010, false) in
                 ...
                 | uu____2023 -> FStar_Pervasives_Native.None) in
          ...
          let k_rec_binding uu____2046 =
            ...
            | (id,l,dd) ->
                ...
                FStar_Pervasives_Native.Some uu____2054 in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
            ...
            | FStar_Pervasives_Native.Some (s,uu____2278) ->
                (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 | FStar_Syntax_Syntax.Sig_effect_abbrev
                     ...
                     aux l''
                 | uu____2292 -> FStar_Pervasives_Native.None) in
          aux l'
    ...
    fun lid  ->
      ...
      let uu____2336 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____2342  -> FStar_Pervasives_Native.None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____2366  ->
             ...
             | (mlid,modul) ->
                 ...
                 uu____2371 = path) env.modules in
...
let record_cache_aux_with_filter:
  ...
  let push1 uu____2717 =
    let uu____2718 =
      ...
      let uu____2731 = FStar_ST.read record_cache in uu____2721 :: uu____2731 in
    FStar_ST.write record_cache uu____2718 in
  let pop1 uu____2746 =
    let uu____2747 =
      let uu____2750 = FStar_ST.read record_cache in FStar_List.tl uu____2750 in
    FStar_ST.write record_cache uu____2747 in
  let peek uu____2766 =
    let uu____2767 = FStar_ST.read record_cache in FStar_List.hd uu____2767 in
  let insert r =
    let uu____2779 =
     ...
     | () ->
         ...
         let uu____2840 =
           let uu____2843 = FStar_ST.read record_cache in filtered ::
             uu____2843 in
         FStar_ST.write record_cache uu____2840) in
                                                             ...
                                                             let uu____3536 =
                                                               let uu____3537
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id in
                                                               uu____3537.FStar_Ident.ident in
                                                             uu____3536.FStar_Ident.idText in
                                                           let uu____3539 =
                                                             let uu____3540 =
                                                               FStar_ST.read
                                                                 my_exported_ids in
...
let try_lookup_record_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3601 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____3625 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____3627  -> Cont_ok ()) in
...
let try_lookup_dc_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3642 = try_lookup_record_or_dc_by_field_name env fieldname in
    ...
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          ...
          let uu____3712 = try_lookup_lid' any_val exclude_if this_env lid in
    ...
    fun s  ->
      ...
      let uu____3850 =
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3864) ->
            ...
            (env2, uu____3869)
        | uu____3883 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          (fail_if_curmodule env ns0 ns1;
           (let env1 =
            ...
            (let uu____4028 = FStar_Util.smap_try_find env1.includes curmod in
             match uu____4028 with
             | FStar_Pervasives_Native.None  -> ()
             | FStar_Pervasives_Native.Some incl ->
                 let uu____4041 =
                   let uu____4043 = FStar_ST.read incl in ns1 :: uu____4043 in
             ...
             | () ->
                 ...
                 (match uu____4051 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____4064 =
                          let uu____4075 = get_exported_id_set env1 curmod in
                          let uu____4080 =
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____4129 =
                                 ...
                                 FStar_Util.set_difference uu____4130 ns_ex in
                               FStar_ST.write ex uu____4129);
                              (match () with
                               | () ->
                                   let trans_ex = cur_trans_exports k in
                                   let uu____4140 =
                                     let uu____4141 = FStar_ST.read trans_ex in
                                     FStar_Util.set_union uu____4141 ns_ex in
                                   FStar_ST.write trans_ex uu____4140) in
            ...
            ((let uu____4203 =
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____4206 =
                    ...
                    let uu____4208 = FStar_Parser_AST.string_of_fsdoc old_doc in
                    let uu____4209 = FStar_Parser_AST.string_of_fsdoc doc1 in
                    FStar_Util.format3
                      "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                      uu____4207 uu____4208 uu____4209 in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____4330 -> ()));
      (let curmod =
         let uu____4332 = current_module env in uu____4332.FStar_Ident.str in
       (let uu____4334 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____4390 = cur_ex eikind in FStar_ST.read uu____4390 in
        ...
        fun mname  ->
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4661  ->
                    ...
                    | (l,uu____4665) -> FStar_Ident.lid_equals l mname)) in
          ...
          | FStar_Pervasives_Native.Some (uu____4671,m) ->
              ((let uu____4676 =
               ...
               (let uu____4684 = let uu____4685 = push env in prep uu____4685 in
                (uu____4684, true)))
