...
let qualify: env -> FStar_Ident.ident -> FStar_Ident.lident =
  fun env  ->
    fun id  ->
      ...
      | Some monad ->
          let _0_294 = let _0_293 = current_module env in qual _0_293 monad in
...
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  ...
  let rec aux uu___149_866 =
    ...
    | [] ->
        ...
        option_of_cont (fun uu____873  -> None) _0_302 in
  aux env.scope_mods
...
let find_in_module env lid k_global_def k_not_found =
  let uu____935 = FStar_Util.smap_try_find (sigmap env) lid.FStar_Ident.str in
        ...
        let rec aux uu___150_1107 =
          ...
          | (Open_module_or_namespace (ns,Open_namespace ))::q when honor_ns
              ...
              let new_lid =
                ...
                FStar_Ident.lid_of_path _0_308 (FStar_Ident.range_of_lid lid) in
      ...
      let _0_315 =
        FStar_Util.find_map lbs
          (fun lb  ->
             ...
             if uu____1387 then Some fv else None) in
                     ...
                     Some
                       (Term_name
                          (let _0_319 =
                             ...
                             FStar_Syntax_Syntax.fvar source_lid
                               FStar_Syntax_Syntax.Delta_constant _0_318 in
                           (_0_319, false)))
                            ...
                            Some
                              (Term_name
                                 (let _0_322 =
                                    ...
                                    FStar_Syntax_Syntax.fvar lid dd _0_321 in
                                  (_0_322, false))))
                     else None
    ...
    fun lid  ->
      ...
      let uu____1759 =
        resolve_in_open_namespaces' env lid (fun uu____1763  -> None)
          (fun uu____1765  -> None) k_global_def in
  ...
  let filter uu____2164 =
    ...
    (match () with
     | () ->
         ...
         FStar_ST.write record_cache _0_334) in
                         ...
                         | FStar_Syntax_Syntax.Sig_datacon
                             ...
                             (match uu____2705 with
                              | (formals,uu____2714) ->
                                  ...
                                  ((let _0_338 =
                                      let _0_337 = FStar_ST.read new_globs in
                                    ...
                                    | () ->
                                        ((let add_field uu____2813 =
                                            ...
                                            | (id,uu____2819) ->
                                                let modul =
                                                  (FStar_Ident.lid_of_ids
                                                     constrname.FStar_Ident.ns).FStar_Ident.str in
                                                let uu____2825 =
                                                       ...
                                                       | () ->
                                                           let projname =
                                                             ((FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                 constrname
                                                                 id).FStar_Ident.ident).FStar_Ident.idText in
                                                           let _0_342 =
                                                             let _0_341 =
                                                               FStar_ST.read
                                                                 my_exported_ids in
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map _0_344
              (fun record  ->
                 ...
                 option_of_cont (fun uu____2884  -> None) _0_343) in
      resolve_in_open_namespaces'' env fieldname Exported_id_field
        (fun uu____2886  -> Cont_ignore) (fun uu____2887  -> Cont_ignore)
        (fun r  -> Cont_ok r)
        (fun fn  ->
           let _0_345 = find_in_cache fn in cont_of_option Cont_ignore _0_345)
        (fun k  -> fun uu____2891  -> k)
let try_lookup_record_by_field_name:
  env -> FStar_Ident.lident -> record_or_dc Prims.option =
  fun env  ->
    fun fieldname  ->
      let uu____2900 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | Some record' when
            ...
            let uu____2918 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____2920  -> Cont_ok ()) in
...
let try_lookup_dc_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____2935 = try_lookup_record_or_dc_by_field_name env fieldname in
      ...
      fun env  ->
        fun lid  ->
          ...
          let this_env =
            ...
            let _0_350 = FStar_List.filter filter_scope_mods env.scope_mods in
            {
          ...
          let uu____3002 = try_lookup_lid' any_val exclude_if this_env lid in
    ...
    fun s  ->
        ...
        Prims.raise
          (FStar_Errors.Error
             (let _0_351 =
              ...
              (_0_351, (FStar_Ident.range_of_lid l)))) in
            ...
            let uu____3119 =
              FStar_Util.find_map lids
                (fun l  ->
                   ...
                   if uu____3122 then Some l else None) in
      ...
      let uu____3137 =
        ...
        | FStar_Syntax_Syntax.Sig_bundle
            ...
            (env, _0_353)
        | uu____3169 -> (env, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                            ...
                            (fun lid  ->
                               ...
                               (match () with
                                | () ->
                                    let modul =
                                      (FStar_Ident.lid_of_ids
                                         lid.FStar_Ident.ns).FStar_Ident.str in
                                    ((let uu____3218 =
    ...
    fun ns  ->
      ...
      | Some ns ->
          ...
          ((let uu____3295 = FStar_Util.smap_try_find env.includes curmod in
            ...
            | None  -> ()
            | Some incl ->
                let _0_361 = let _0_360 = FStar_ST.read incl in ns :: _0_360 in
                ...
                (match uu____3314 with
                 | Some ns_trans_exports ->
                     ((let uu____3327 =
                         ...
                         let _0_362 = get_trans_exported_id_set env curmod in
                         (_0_363, _0_362) in
                       match uu____3327 with
                       | (Some cur_exports,Some cur_trans_exports) ->
                           let update_exports k =
                             let ns_ex = FStar_ST.read (ns_trans_exports k) in
                             ...
                             (match () with
                              | () ->
                                  ...
                                  FStar_ST.write trans_ex _0_367) in
                       ...
                       then
                         FStar_Util.print_string
                           (let _0_372 =
                            ...
                            let _0_371 = FStar_Syntax_Print.lid_to_string l in
                            FStar_Util.format2
                     ...
                     FStar_All.pipe_right lbs
                       (FStar_List.iter
                          (fun lb  ->
                             let _0_373 =
                               (((FStar_Util.right
                                    lb.FStar_Syntax_Syntax.lbname).FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v).FStar_Ident.str in
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____3793  ->
                    ...
                    | (l,uu____3797) -> FStar_Ident.lid_equals l mname)) in
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____3847  ->
             ...
             | (lid,uu____3851) -> FStar_Ident.text_of_lid lid) env.modules in
      let msg =
      ...
      let msg =
        ...
        then msg
          ...
          (let modul =
             ...
             FStar_Ident.set_lid_range _0_388 (FStar_Ident.range_of_lid lid) in
