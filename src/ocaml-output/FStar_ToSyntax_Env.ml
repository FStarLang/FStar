...
let set_iface: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___168_364 = env in
      {
        curmodule = (uu___168_364.curmodule);
        curmonad = (uu___168_364.curmonad);
        modules = (uu___168_364.modules);
        scope_mods = (uu___168_364.scope_mods);
        exported_ids = (uu___168_364.exported_ids);
        trans_exported_ids = (uu___168_364.trans_exported_ids);
        includes = (uu___168_364.includes);
        sigaccum = (uu___168_364.sigaccum);
        sigmap = (uu___168_364.sigmap);
        iface = b;
        admitted_iface = (uu___168_364.admitted_iface);
        expect_typ = (uu___168_364.expect_typ);
        docs = (uu___168_364.docs)
      }
...
let set_bv_range:
  ...
  fun bv  ->
    fun r  ->
      let id =
        let uu___169_463 = bv.FStar_Syntax_Syntax.ppname in
        {
          FStar_Ident.idText = (uu___169_463.FStar_Ident.idText);
          FStar_Ident.idRange = r
        } in
      let uu___170_464 = bv in
      {
        FStar_Syntax_Syntax.ppname = id;
        FStar_Syntax_Syntax.index = (uu___170_464.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___170_464.FStar_Syntax_Syntax.sort)
      }
let bv_to_name:
...
let option_of_cont k_ignore uu___141_609 =
  match uu___141_609 with
  | Cont_ok a -> Some a
  | Cont_fail  -> None
...
let find_in_module_with_includes eikind find_in_module find_in_module_default
  ...
  let rec aux uu___143_744 =
    match uu___143_744 with
    ...
    | modul::q ->
        ...
        (match look_into with
         ...
         | uu____798 -> look_into) in
  aux [ns]
let is_exported_id_field: exported_id_kind -> Prims.bool =
  fun uu___144_802  ->
    match uu___144_802 with | Exported_id_field  -> true | uu____803 -> false
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  find_in_module lookup_default_id =
  let check_local_binding_id uu___145_892 =
    match uu___145_892 with
    | (id',uu____894,uu____895) ->
        id'.FStar_Ident.idText = id.FStar_Ident.idText in
  let check_rec_binding_id uu___146_899 =
    match uu___146_899 with
    | (id',uu____901,uu____902) ->
        id'.FStar_Ident.idText = id.FStar_Ident.idText in
  let curmod_ns =
    let uu____905 = current_module env in FStar_Ident.ids_of_lid uu____905 in
  let proc uu___147_910 =
    match uu___147_910 with
...
let find_in_module env lid k_global_def k_not_found =
  let uu____1001 = FStar_Util.smap_try_find (sigmap env) lid.FStar_Ident.str in
    ...
    fun id  ->
      ...
      | uu____1037 ->
          try_lookup_id'' env id Exported_id_term_type
            (fun r  ->
               let uu____1044 = found_local_binding id.FStar_Ident.idRange r in
...
let lookup_default_id env id k_global_def k_not_found =
  ...
  | Some v1 -> v1
  | None  ->
      let lid = let uu____1148 = current_module env in qual uu____1148 id in
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___149_1181 =
          match uu___149_1181 with
          | [] ->
        ...
        let uu____1345 =
          is_full_path &&
            (let uu____1346 = FStar_Ident.lid_of_ids ids in
             module_is_defined env uu____1346) in
        if uu____1345
        then (ids, [])
        else
  ...
  | uu____1476::uu____1477 ->
      let uu____1479 =
        let uu____1481 =
          ...
          FStar_Ident.set_lid_range uu____1482 (FStar_Ident.range_of_lid lid) in
...
let cont_of_option k_none uu___151_1502 =
  match uu___151_1502 with | Some v1 -> Cont_ok v1 | None  -> k_none
let resolve_in_open_namespaces' env lid k_local_binding k_rec_binding
  k_global_def =
  let k_global_def' k lid1 def =
    let uu____1581 = k_global_def lid1 def in cont_of_option k uu____1581 in
  let f_module lid' =
      ...
      let uu____1654 =
        FStar_Util.find_map lbs
          (fun lb  ->
             ...
             if uu____1658 then Some fv else None) in
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___156_1697 =
            match uu___156_1697 with
                     ...
                     let uu____1731 =
                       let uu____1732 =
                         let uu____1735 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____1736 in
                         (uu____1735, false) in
                            ...
                            let uu____1803 =
                              let uu____1804 =
                                let uu____1807 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____1808 in
                                (uu____1807, false) in
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___157_2106 =
        match uu___157_2106 with
        | ({
      ...
      let uu____2124 =
        resolve_in_open_namespaces' env lid (fun uu____2128  -> None)
          (fun uu____2130  -> None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____2154  ->
             ...
             | (mlid,modul) ->
                 ...
                 uu____2159 = path) env.modules in
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___158_2185 =
        match uu___158_2185 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___159_2232 =
        match uu___159_2232 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___171_2363 = env in
        {
          curmodule = (uu___171_2363.curmodule);
          curmonad = (uu___171_2363.curmonad);
          modules = (uu___171_2363.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___171_2363.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___171_2363.sigaccum);
          sigmap = (uu___171_2363.sigmap);
          iface = (uu___171_2363.iface);
          admitted_iface = (uu___171_2363.admitted_iface);
          expect_typ = (uu___171_2363.expect_typ);
          docs = (uu___171_2363.docs)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___161_2387 =
        match uu___161_2387 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___162_2442 =
        match uu___162_2442 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let record_cache_aux_with_filter:
  ...
  let push1 uu____2504 =
    let uu____2505 =
      ...
      let uu____2518 = FStar_ST.read record_cache in uu____2508 :: uu____2518 in
    FStar_ST.write record_cache uu____2505 in
  let pop1 uu____2533 =
    let uu____2534 =
      let uu____2537 = FStar_ST.read record_cache in FStar_List.tl uu____2537 in
    FStar_ST.write record_cache uu____2534 in
  let peek uu____2553 =
    let uu____2554 = FStar_ST.read record_cache in FStar_List.hd uu____2554 in
  let insert r =
    let uu____2566 =
     ...
     | () ->
         ...
         let uu____2627 =
           let uu____2630 = FStar_ST.read record_cache in filtered ::
             uu____2630 in
         FStar_ST.write record_cache uu____2627) in
                                                             ...
                                                             let uu____3318 =
                                                               let uu____3319
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id in
                                                               uu____3319.FStar_Ident.ident in
                                                             uu____3318.FStar_Ident.idText in
                                                           let uu____3321 =
                                                             let uu____3322 =
                                                               FStar_ST.read
                                                                 my_exported_ids in
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map uu____3360
              (fun record  ->
                 ...
                 option_of_cont (fun uu____3366  -> None) uu____3363) in
...
let try_lookup_record_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3383 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | Some record' when
            ...
            let uu____3407 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____3409  -> Cont_ok ()) in
...
let try_lookup_dc_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3424 = try_lookup_record_or_dc_by_field_name env fieldname in
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___167_3487 =
            match uu___167_3487 with
            | Rec_binding uu____3488 -> true
            | uu____3489 -> false in
          let this_env =
            let uu___172_3491 = env in
            let uu____3492 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___172_3491.curmodule);
              curmonad = (uu___172_3491.curmonad);
              modules = (uu___172_3491.modules);
              scope_mods = uu____3492;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___172_3491.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___172_3491.sigaccum);
              sigmap = (uu___172_3491.sigmap);
              iface = (uu___172_3491.iface);
              admitted_iface = (uu___172_3491.admitted_iface);
              expect_typ = (uu___172_3491.expect_typ);
              docs = (uu___172_3491.docs)
            } in
          let uu____3494 = try_lookup_lid' any_val exclude_if this_env lid in
          match uu____3494 with | None  -> true | Some uu____3500 -> false
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___173_3511 = env in
      {
        curmodule = (uu___173_3511.curmodule);
        curmonad = (uu___173_3511.curmonad);
        modules = (uu___173_3511.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___173_3511.exported_ids);
        trans_exported_ids = (uu___173_3511.trans_exported_ids);
        includes = (uu___173_3511.includes);
        sigaccum = (uu___173_3511.sigaccum);
        sigmap = (uu___173_3511.sigmap);
        iface = (uu___173_3511.iface);
        admitted_iface = (uu___173_3511.admitted_iface);
        expect_typ = (uu___173_3511.expect_typ);
        docs = (uu___173_3511.docs)
      }
let push_bv':
            ...
            let uu____3614 =
              FStar_Util.find_map lids
                (fun l  ->
                   ...
                   if uu____3617 then Some l else None) in
            (match uu____3614 with
             | Some l when
                 let uu____3622 = FStar_Options.interactive () in
                 Prims.op_Negation uu____3622 -> err1 l
             | uu____3623 ->
                 (extract_record env globals s;
                  (let uu___174_3628 = env in
                   {
                     curmodule = (uu___174_3628.curmodule);
                     curmonad = (uu___174_3628.curmonad);
                     modules = (uu___174_3628.modules);
                     scope_mods = (uu___174_3628.scope_mods);
                     exported_ids = (uu___174_3628.exported_ids);
                     trans_exported_ids = (uu___174_3628.trans_exported_ids);
                     includes = (uu___174_3628.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___174_3628.sigmap);
                     iface = (uu___174_3628.iface);
                     admitted_iface = (uu___174_3628.admitted_iface);
                     expect_typ = (uu___174_3628.expect_typ);
                     docs = (uu___174_3628.docs)
                   }))) in
      let env2 =
        let uu___175_3630 = env1 in
        let uu____3631 = FStar_ST.read globals in
        {
          curmodule = (uu___175_3630.curmodule);
          curmonad = (uu___175_3630.curmonad);
          modules = (uu___175_3630.modules);
          scope_mods = uu____3631;
          exported_ids = (uu___175_3630.exported_ids);
          trans_exported_ids = (uu___175_3630.trans_exported_ids);
          includes = (uu___175_3630.includes);
          sigaccum = (uu___175_3630.sigaccum);
          sigmap = (uu___175_3630.sigmap);
          iface = (uu___175_3630.iface);
          admitted_iface = (uu___175_3630.admitted_iface);
          expect_typ = (uu___175_3630.expect_typ);
          docs = (uu___175_3630.docs)
        } in
      let uu____3636 =
        match s.FStar_Syntax_Syntax.sigel with
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3650,uu____3651) ->
            ...
            (env2, uu____3658)
        | uu____3672 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___176_3754 = env3 in
              let uu____3755 = FStar_ST.read globals in
              {
                curmodule = (uu___176_3754.curmodule);
                curmonad = (uu___176_3754.curmonad);
                modules = (uu___176_3754.modules);
                scope_mods = uu____3755;
                exported_ids = (uu___176_3754.exported_ids);
                trans_exported_ids = (uu___176_3754.trans_exported_ids);
                includes = (uu___176_3754.includes);
                sigaccum = (uu___176_3754.sigaccum);
                sigmap = (uu___176_3754.sigmap);
                iface = (uu___176_3754.iface);
                admitted_iface = (uu___176_3754.admitted_iface);
                expect_typ = (uu___176_3754.expect_typ);
                docs = (uu___176_3754.docs)
              } in
            env4))
      ...
      | Some ns1 ->
          (fail_if_curmodule env ns0 ns1;
           (let env1 =
            ...
            (let uu____3817 = FStar_Util.smap_try_find env1.includes curmod in
             match uu____3817 with
             | None  -> ()
             | Some incl ->
                 let uu____3830 =
                   let uu____3832 = FStar_ST.read incl in ns1 :: uu____3832 in
             ...
             | () ->
                 ...
                 (match uu____3840 with
                  | Some ns_trans_exports ->
                      ((let uu____3853 =
                          let uu____3864 = get_exported_id_set env1 curmod in
                          let uu____3869 =
                        ...
                        | (Some cur_exports,Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____3918 =
                                 ...
                                 FStar_Util.set_difference uu____3919 ns_ex in
                               FStar_ST.write ex uu____3918);
                              (match () with
                               | () ->
                                   let trans_ex = cur_trans_exports k in
                                   let uu____3929 =
                                     let uu____3930 = FStar_ST.read trans_ex in
                                     FStar_Util.set_union uu____3930 ns_ex in
                                   FStar_ST.write trans_ex uu____3929) in
            ...
            ((let uu____3992 =
              ...
              | Some old_doc ->
                  let uu____3995 =
                    ...
                    let uu____3997 = FStar_Parser_AST.string_of_fsdoc old_doc in
                    let uu____3998 = FStar_Parser_AST.string_of_fsdoc doc1 in
                    FStar_Util.format3
                      "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                      uu____3996 uu____3997 uu____3998 in
                        ...
                        ((let uu___177_4025 = se in
                          {
                            ...
                            FStar_Syntax_Syntax.sigrng =
                              (uu___177_4025.FStar_Syntax_Syntax.sigrng)
                          }), false))
                 | Some uu____4027 -> ())
            | uu____4032 -> ()))
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
                                 ...
                                 FStar_Syntax_Syntax.sigel =
                                   (FStar_Syntax_Syntax.Sig_declare_typ
                                      (lid, (lb.FStar_Syntax_Syntax.lbunivs),
                                        ...
                                        quals)));
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___178_4122.FStar_Syntax_Syntax.sigrng)
                               } in
              ...
              | uu____4130 -> ()));
      (let curmod =
         let uu____4132 = current_module env in uu____4132.FStar_Ident.str in
       (let uu____4134 =
        ...
        | (Some cur_ex,Some cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____4190 = cur_ex eikind in FStar_ST.read uu____4190 in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___179_4217 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___179_4217.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___179_4217.exported_ids);
                    trans_exported_ids = (uu___179_4217.trans_exported_ids);
                    includes = (uu___179_4217.includes);
                    sigaccum = [];
                    sigmap = (uu___179_4217.sigmap);
                    iface = (uu___179_4217.iface);
                    admitted_iface = (uu___179_4217.admitted_iface);
                    expect_typ = (uu___179_4217.expect_typ);
                    docs = (uu___179_4217.docs)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___180_4240 = env in
     let uu____4241 = FStar_Util.smap_copy (sigmap env) in
     let uu____4247 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___180_4240.curmodule);
       curmonad = (uu___180_4240.curmonad);
       modules = (uu___180_4240.modules);
       scope_mods = (uu___180_4240.scope_mods);
       exported_ids = (uu___180_4240.exported_ids);
       trans_exported_ids = (uu___180_4240.trans_exported_ids);
       includes = (uu___180_4240.includes);
       sigaccum = (uu___180_4240.sigaccum);
       sigmap = uu____4241;
       iface = (uu___180_4240.iface);
       admitted_iface = (uu___180_4240.admitted_iface);
       expect_typ = (uu___180_4240.expect_typ);
       docs = uu____4247
     })
                            ...
                            FStar_Syntax_Syntax.sigel =
                              (FStar_Syntax_Syntax.Sig_declare_typ
                                 (l, u, t, (FStar_Syntax_Syntax.Assumption ::
                                   q)));
                            FStar_Syntax_Syntax.sigrng =
                              (uu___181_4341.FStar_Syntax_Syntax.sigrng)
                          }
                      | uu____4343 -> se in
        ...
        fun mname  ->
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___182_4409.curmonad);
                               modules = (uu___182_4409.modules);
                               scope_mods = uu____4410;
                               exported_ids = (uu___182_4409.exported_ids);
                               trans_exported_ids =
                                 (uu___182_4409.trans_exported_ids);
                               includes = (uu___182_4409.includes);
                               sigaccum = (uu___182_4409.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___182_4409.expect_typ);
                               docs = (uu___182_4409.docs)
                             }))))) in
          let uu____4413 =
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4425  ->
                    ...
                    | (l,uu____4429) -> FStar_Ident.lid_equals l mname)) in
          ...
          | Some (uu____4435,m) ->
              ((let uu____4440 =
               ...
               (let uu____4448 = let uu____4449 = push env in prep uu____4449 in
                (uu____4448, true)))
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___183_4457 = env in
          {
            curmodule = (uu___183_4457.curmodule);
            curmonad = (Some mname);
            modules = (uu___183_4457.modules);
            scope_mods = (uu___183_4457.scope_mods);
            exported_ids = (uu___183_4457.exported_ids);
            trans_exported_ids = (uu___183_4457.trans_exported_ids);
            includes = (uu___183_4457.includes);
            sigaccum = (uu___183_4457.sigaccum);
            sigmap = (uu___183_4457.sigmap);
            iface = (uu___183_4457.iface);
            admitted_iface = (uu___183_4457.admitted_iface);
            expect_typ = (uu___183_4457.expect_typ);
            docs = (uu___183_4457.docs)
          }
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____4488  ->
             ...
             | (lid1,uu____4492) -> FStar_Ident.text_of_lid lid1) env.modules in
      let msg =
