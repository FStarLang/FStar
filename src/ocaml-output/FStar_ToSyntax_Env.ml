      ...
      fun env  ->
        fun mname  ->
          let prep env1 =
            ...
            let auto_open2 = FStar_List.append auto_open1 namespace_of_module
               in
            (let uu____4624 = exported_id_set_new ()  in
             FStar_Util.smap_add env1.exported_ids mname.FStar_Ident.str
               uu____4624);
            (match () with
             | () ->
                 ((let uu____4629 = exported_id_set_new ()  in
                   FStar_Util.smap_add env1.trans_exported_ids
                     mname.FStar_Ident.str uu____4629);
                  (match () with
                   | () ->
                       ((let uu____4634 = FStar_Util.mk_ref []  in
                         FStar_Util.smap_add env1.includes
                           mname.FStar_Ident.str uu____4634);
                        (match () with
                         | () ->
                             let uu___193_4643 = env1  in
                             let uu____4644 =
                               FStar_List.map
                                ...
                                in
                             {
                               ...
                               curmonad = (uu___193_4643.curmonad);
                               modules = (uu___193_4643.modules);
                               scope_mods = uu____4644;
                               exported_ids = (uu___193_4643.exported_ids);
                               trans_exported_ids =
                                 (uu___193_4643.trans_exported_ids);
                               includes = (uu___193_4643.includes);
                               sigaccum = (uu___193_4643.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___193_4643.expect_typ);
                               docs = (uu___193_4643.docs);
                               remaining_iface_decls =
                                 (uu___193_4643.remaining_iface_decls);
                               syntax_only = (uu___193_4643.syntax_only)
                             })))))
             in
          let uu____4647 =
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4659  ->
                    ...
                    | (l,uu____4663) -> FStar_Ident.lid_equals l mname))
             in
          match uu____4647 with
          | FStar_Pervasives_Native.None  ->
              let uu____4668 = prep env  in (uu____4668, false)
          | FStar_Pervasives_Native.Some (uu____4669,m) ->
              ((let uu____4674 =
                  (let uu____4675 = FStar_Options.interactive ()  in
                   Prims.op_Negation uu____4675) &&
                    ...
                    let uu____4677 =
                      let uu____4680 =
                        FStar_Util.format1
                         ...
                         in
                      (uu____4680, (FStar_Ident.range_of_lid mname))  in
                    FStar_Errors.Error uu____4677  in
                  raise uu____4676
                else ());
               (let uu____4682 =
                  let uu____4683 = push env  in prep uu____4683  in
                (uu____4682, true)))
...
let enter_monad_scope : env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___194_4691 = env  in
          {
            curmodule = (uu___194_4691.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___194_4691.modules);
            scope_mods = (uu___194_4691.scope_mods);
            exported_ids = (uu___194_4691.exported_ids);
            trans_exported_ids = (uu___194_4691.trans_exported_ids);
            includes = (uu___194_4691.includes);
            sigaccum = (uu___194_4691.sigaccum);
            sigmap = (uu___194_4691.sigmap);
            iface = (uu___194_4691.iface);
            admitted_iface = (uu___194_4691.admitted_iface);
            expect_typ = (uu___194_4691.expect_typ);
            docs = (uu___194_4691.docs);
            remaining_iface_decls = (uu___194_4691.remaining_iface_decls);
            syntax_only = (uu___194_4691.syntax_only)
          }
  
let fail_or env lookup lid =
  let uu____4716 = lookup lid  in
  ...
  | FStar_Pervasives_Native.None  ->
      let opened_modules =
        FStar_List.map
          (fun uu____4722  ->
             ...
             | (lid1,uu____4726) -> FStar_Ident.text_of_lid lid1) env.modules
         in
      let msg =
      ...
      let msg1 =
        ...
        then msg
          ...
          (let modul =
             let uu____4733 = FStar_Ident.lid_of_ids lid.FStar_Ident.ns  in
             FStar_Ident.set_lid_range uu____4733
               (FStar_Ident.range_of_lid lid)
              in
           let uu____4734 = resolve_module_name env modul true  in
