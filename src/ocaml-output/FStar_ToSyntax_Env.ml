                            ...
                            let uu____1973 =
                              let uu____1974 =
                                let uu____1977 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____1978
                                   in
                                (uu____1977, false)  in
    ...
    fun lid  ->
      ...
      let uu____2301 =
        resolve_in_open_namespaces' env lid (fun uu____2305  -> None)
          (fun uu____2307  -> None) k_global_def
         in
...
let record_cache_aux_with_filter :
  ...
  let push1 uu____2682 =
    let uu____2683 =
      ...
      let uu____2696 = FStar_ST.read record_cache  in uu____2686 ::
        uu____2696
       in
    FStar_ST.write record_cache uu____2683  in
  let pop1 uu____2711 =
    let uu____2712 =
      let uu____2715 = FStar_ST.read record_cache  in
      FStar_List.tl uu____2715  in
    FStar_ST.write record_cache uu____2712  in
  let peek uu____2731 =
    let uu____2732 = FStar_ST.read record_cache  in FStar_List.hd uu____2732
     in
  let insert r =
    let uu____2744 =
     ...
     | () ->
         ...
         let uu____2805 =
           let uu____2808 = FStar_ST.read record_cache  in filtered ::
             uu____2808
            in
         FStar_ST.write record_cache uu____2805)
     in
                                                             ...
                                                             let uu____3493 =
                                                               let uu____3494
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____3494.FStar_Ident.ident
                                                                in
                                                             uu____3493.FStar_Ident.idText
                                                              in
                                                           let uu____3496 =
                                                             let uu____3497 =
                                                               FStar_ST.read
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map uu____3535
              (fun record  ->
                 ...
                 option_of_cont (fun uu____3541  -> None) uu____3538)
         in
...
let try_lookup_record_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3558 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | Some record' when
            ...
            let uu____3582 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____3584  -> Cont_ok ())
               in
...
let try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3599 = try_lookup_record_or_dc_by_field_name env fieldname
         in
    ...
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          ...
          let uu____3669 = try_lookup_lid' any_val exclude_if this_env lid
             in
            ...
            let uu____3785 =
              FStar_Util.find_map lids
                (fun l  ->
                   ...
                   if uu____3788 then Some l else None)
               in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3821) ->
            let uu____3826 =
              FStar_List.map
               ...
               in
            (env2, uu____3826)
        | uu____3840 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
      ...
      | Some ns1 ->
          (fail_if_curmodule env ns0 ns1;
           (let env1 =
            ...
            (let uu____3985 = FStar_Util.smap_try_find env1.includes curmod
                in
             match uu____3985 with
             | None  -> ()
             | Some incl ->
                 let uu____3998 =
                   let uu____4000 = FStar_ST.read incl  in ns1 :: uu____4000
                    in
             ...
             | () ->
                 ...
                 (match uu____4008 with
                  | Some ns_trans_exports ->
                      ((let uu____4021 =
                          let uu____4032 = get_exported_id_set env1 curmod
                             in
                          let uu____4037 =
                        ...
                        | (Some cur_exports,Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____4086 =
                                 ...
                                 FStar_Util.set_difference uu____4087 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____4097 =
                                     let uu____4098 = FStar_ST.read trans_ex
                                        in
                                     FStar_Util.set_union uu____4098 ns_ex
                                      in
                                   FStar_ST.write trans_ex uu____4097)
                               in
            ...
            ((let uu____4160 =
              ...
              | Some old_doc ->
                  let uu____4163 =
                    ...
                    let uu____4165 = FStar_Parser_AST.string_of_fsdoc old_doc
                       in
                    let uu____4166 = FStar_Parser_AST.string_of_fsdoc doc1
                       in
                    FStar_Util.format3
                      "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                      uu____4164 uu____4165 uu____4166
                     in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____4287 -> ()));
      (let curmod =
         let uu____4289 = current_module env  in uu____4289.FStar_Ident.str
          in
       (let uu____4291 =
        ...
        | (Some cur_ex,Some cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____4347 = cur_ex eikind  in FStar_ST.read uu____4347
                 in
        ...
        fun mname  ->
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4578  ->
                    ...
                    | (l,uu____4582) -> FStar_Ident.lid_equals l mname))
             in
          ...
          | Some (uu____4588,m) ->
              ((let uu____4593 =
               ...
               (let uu____4601 =
                  let uu____4602 = push env  in prep uu____4602  in
                (uu____4601, true)))
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____4641  ->
             ...
             | (lid1,uu____4645) -> FStar_Ident.text_of_lid lid1) env.modules
         in
      let msg =
