...
let push = (fun uu____2149 -> (let _0_309 = (let _0_308 = (FStar_List.hd (FStar_ST.read record_cache))
in (let _0_307 = (FStar_ST.read record_cache)
in (_0_308)::_0_307))
in (FStar_ST.write record_cache _0_309)))
in (

let pop = (fun uu____2167 -> (let _0_310 = (FStar_List.tl (FStar_ST.read record_cache))
...
let uu____2759 = (let _0_317 = (find_dc dc)
...
in (option_of_cont (fun uu____2940 -> None) _0_325)))))
end)))
in (resolve_in_open_namespaces'' env fieldname Exported_id_field (fun uu____2942 -> Cont_ignore) (fun uu____2943 -> Cont_ignore) (fun r -> Cont_ok (r)) (fun fn -> (let _0_327 = (find_in_cache fn)
in (cont_of_option Cont_ignore _0_327))) (fun k uu____2947 -> k))))
...
in {curmodule = uu___174_3051.curmodule; curmonad = uu___174_3051.curmonad; modules = uu___174_3051.modules; scope_mods = _0_332; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___174_3051.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___174_3051.sigaccum; sigmap = uu___174_3051.sigmap; iface = uu___174_3051.iface; admitted_iface = uu___174_3051.admitted_iface; expect_typ = uu___174_3051.expect_typ}))
in (
...
let uu____3354 = (let _0_345 = (get_exported_id_set env curmod)
...
let uu____3524 = (let _0_357 = (get_exported_id_set env curmod)
