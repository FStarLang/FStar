    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___163_1885 =
            match uu___163_1885 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2294 =
        match uu___164_2294 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___165_2373 =
        match uu___165_2373 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_2420 =
        match uu___166_2420 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___183_2551 = env in
        {
          curmodule = (uu___183_2551.curmodule);
          curmonad = (uu___183_2551.curmonad);
          modules = (uu___183_2551.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___183_2551.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___183_2551.sigaccum);
          sigmap = (uu___183_2551.sigmap);
          iface = (uu___183_2551.iface);
          admitted_iface = (uu___183_2551.admitted_iface);
          expect_typ = (uu___183_2551.expect_typ);
          docs = (uu___183_2551.docs);
          remaining_iface_decls = (uu___183_2551.remaining_iface_decls);
          syntax_only = (uu___183_2551.syntax_only)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___168_2575 =
        match uu___168_2575 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___169_2630 =
        match uu___169_2630 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___174_3675 =
            match uu___174_3675 with
            | Rec_binding uu____3676 -> true
            | uu____3677 -> false in
          let this_env =
            let uu___184_3679 = env in
            let uu____3680 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___184_3679.curmodule);
              curmonad = (uu___184_3679.curmonad);
              modules = (uu___184_3679.modules);
              scope_mods = uu____3680;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___184_3679.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___184_3679.sigaccum);
              sigmap = (uu___184_3679.sigmap);
              iface = (uu___184_3679.iface);
              admitted_iface = (uu___184_3679.admitted_iface);
              expect_typ = (uu___184_3679.expect_typ);
              docs = (uu___184_3679.docs);
              remaining_iface_decls = (uu___184_3679.remaining_iface_decls);
              syntax_only = (uu___184_3679.syntax_only)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___185_3699 = env in
      {
        curmodule = (uu___185_3699.curmodule);
        curmonad = (uu___185_3699.curmonad);
        modules = (uu___185_3699.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___185_3699.exported_ids);
        trans_exported_ids = (uu___185_3699.trans_exported_ids);
        includes = (uu___185_3699.includes);
        sigaccum = (uu___185_3699.sigaccum);
        sigmap = (uu___185_3699.sigmap);
        iface = (uu___185_3699.iface);
        admitted_iface = (uu___185_3699.admitted_iface);
        expect_typ = (uu___185_3699.expect_typ);
        docs = (uu___185_3699.docs);
        remaining_iface_decls = (uu___185_3699.remaining_iface_decls);
        syntax_only = (uu___185_3699.syntax_only)
      }
let push_bv':
            ...
            (match uu____3802 with
             ...
             | uu____3811 ->
                 (extract_record env globals s;
                  (let uu___186_3816 = env in
                   {
                     curmodule = (uu___186_3816.curmodule);
                     curmonad = (uu___186_3816.curmonad);
                     modules = (uu___186_3816.modules);
                     scope_mods = (uu___186_3816.scope_mods);
                     exported_ids = (uu___186_3816.exported_ids);
                     trans_exported_ids = (uu___186_3816.trans_exported_ids);
                     includes = (uu___186_3816.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___186_3816.sigmap);
                     iface = (uu___186_3816.iface);
                     admitted_iface = (uu___186_3816.admitted_iface);
                     expect_typ = (uu___186_3816.expect_typ);
                     docs = (uu___186_3816.docs);
                     remaining_iface_decls =
                       (uu___186_3816.remaining_iface_decls);
                     syntax_only = (uu___186_3816.syntax_only)
                   }))) in
      let env2 =
        let uu___187_3818 = env1 in
        let uu____3819 = FStar_ST.read globals in
        {
          curmodule = (uu___187_3818.curmodule);
          curmonad = (uu___187_3818.curmonad);
          modules = (uu___187_3818.modules);
          scope_mods = uu____3819;
          exported_ids = (uu___187_3818.exported_ids);
          trans_exported_ids = (uu___187_3818.trans_exported_ids);
          includes = (uu___187_3818.includes);
          sigaccum = (uu___187_3818.sigaccum);
          sigmap = (uu___187_3818.sigmap);
          iface = (uu___187_3818.iface);
          admitted_iface = (uu___187_3818.admitted_iface);
          expect_typ = (uu___187_3818.expect_typ);
          docs = (uu___187_3818.docs);
          remaining_iface_decls = (uu___187_3818.remaining_iface_decls);
          syntax_only = (uu___187_3818.syntax_only)
        } in
      let uu____3824 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___188_3942 = env3 in
              let uu____3943 = FStar_ST.read globals in
              {
                curmodule = (uu___188_3942.curmodule);
                curmonad = (uu___188_3942.curmonad);
                modules = (uu___188_3942.modules);
                scope_mods = uu____3943;
                exported_ids = (uu___188_3942.exported_ids);
                trans_exported_ids = (uu___188_3942.trans_exported_ids);
                includes = (uu___188_3942.includes);
                sigaccum = (uu___188_3942.sigaccum);
                sigmap = (uu___188_3942.sigmap);
                iface = (uu___188_3942.iface);
                admitted_iface = (uu___188_3942.admitted_iface);
                expect_typ = (uu___188_3942.expect_typ);
                docs = (uu___188_3942.docs);
                remaining_iface_decls = (uu___188_3942.remaining_iface_decls);
                syntax_only = (uu___188_3942.syntax_only)
              } in
            env4))
                        ...
                        ((let uu___189_4213 = se in
                          {
                            ...
                            FStar_Syntax_Syntax.sigrng =
                              (uu___189_4213.FStar_Syntax_Syntax.sigrng)
                          }), false))
                 | Some uu____4215 -> ())
            | uu____4220 -> ()))
                                 ...
                                 FStar_Syntax_Syntax.sigel =
                                   (FStar_Syntax_Syntax.Sig_declare_typ
                                      (lid, (lb.FStar_Syntax_Syntax.lbunivs),
                                        ...
                                        quals)));
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___190_4310.FStar_Syntax_Syntax.sigrng)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___191_4405 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___191_4405.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___191_4405.exported_ids);
                    trans_exported_ids = (uu___191_4405.trans_exported_ids);
                    includes = (uu___191_4405.includes);
                    sigaccum = [];
                    sigmap = (uu___191_4405.sigmap);
                    iface = (uu___191_4405.iface);
                    admitted_iface = (uu___191_4405.admitted_iface);
                    expect_typ = (uu___191_4405.expect_typ);
                    docs = (uu___191_4405.docs);
                    remaining_iface_decls =
                      (uu___191_4405.remaining_iface_decls);
                    syntax_only = (uu___191_4405.syntax_only)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___192_4428 = env in
     let uu____4429 = FStar_Util.smap_copy (sigmap env) in
     let uu____4435 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___192_4428.curmodule);
       curmonad = (uu___192_4428.curmonad);
       modules = (uu___192_4428.modules);
       scope_mods = (uu___192_4428.scope_mods);
       exported_ids = (uu___192_4428.exported_ids);
       trans_exported_ids = (uu___192_4428.trans_exported_ids);
       includes = (uu___192_4428.includes);
       sigaccum = (uu___192_4428.sigaccum);
       sigmap = uu____4429;
       iface = (uu___192_4428.iface);
       admitted_iface = (uu___192_4428.admitted_iface);
       expect_typ = (uu___192_4428.expect_typ);
       docs = uu____4435;
       remaining_iface_decls = (uu___192_4428.remaining_iface_decls);
       syntax_only = (uu___192_4428.syntax_only)
     })
                            ...
                            FStar_Syntax_Syntax.sigel =
                              (FStar_Syntax_Syntax.Sig_declare_typ
                                 (l, u, t, (FStar_Syntax_Syntax.Assumption ::
                                   q)));
                            FStar_Syntax_Syntax.sigrng =
                              (uu___193_4529.FStar_Syntax_Syntax.sigrng)
                          }
                      | uu____4531 -> se in
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___194_4597.curmonad);
                               modules = (uu___194_4597.modules);
                               scope_mods = uu____4598;
                               exported_ids = (uu___194_4597.exported_ids);
                               trans_exported_ids =
                                 (uu___194_4597.trans_exported_ids);
                               includes = (uu___194_4597.includes);
                               sigaccum = (uu___194_4597.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___194_4597.expect_typ);
                               docs = (uu___194_4597.docs);
                               remaining_iface_decls =
                                 (uu___194_4597.remaining_iface_decls);
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___195_4645 = env in
          {
            curmodule = (uu___195_4645.curmodule);
            curmonad = (Some mname);
            modules = (uu___195_4645.modules);
            scope_mods = (uu___195_4645.scope_mods);
            exported_ids = (uu___195_4645.exported_ids);
            trans_exported_ids = (uu___195_4645.trans_exported_ids);
            includes = (uu___195_4645.includes);
            sigaccum = (uu___195_4645.sigaccum);
            sigmap = (uu___195_4645.sigmap);
            iface = (uu___195_4645.iface);
            admitted_iface = (uu___195_4645.admitted_iface);
            expect_typ = (uu___195_4645.expect_typ);
            docs = (uu___195_4645.docs);
            remaining_iface_decls = (uu___195_4645.remaining_iface_decls);
            syntax_only = (uu___195_4645.syntax_only)
          }
