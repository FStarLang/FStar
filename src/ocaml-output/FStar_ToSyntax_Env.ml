        ...
        fun env  ->
          fun ns  ->
            fun id  ->
              ...
              let rec aux uu___158_2748 =
                match uu___158_2748 with
            ...
            fun k_record  ->
              fun find_in_module  ->
                fun lookup_default_id  ->
                  let check_local_binding_id uu___160_3244 =
                    match uu___160_3244 with
                    | (id',uu____3246,uu____3247) ->
                        id'.FStar_Ident.idText = id.FStar_Ident.idText in
                  let check_rec_binding_id uu___161_3251 =
                    match uu___161_3251 with
                    | (id',uu____3253,uu____3254) ->
                        id'.FStar_Ident.idText = id.FStar_Ident.idText in
                  let curmod_ns =
                    let uu____3258 = current_module env in
                    FStar_Ident.ids_of_lid uu____3258 in
                  let proc uu___162_3264 =
                    match uu___162_3264 with
                  ...
                  let rec aux uu___163_3285 =
                    match uu___163_3285 with
                    | a::q ->
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___164_3684 =
          match uu___164_3684 with
          | [] ->
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___172_5111 =
        match uu___172_5111 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___173_5243 =
        match uu___173_5243 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___174_5311 =
        match uu___174_5311 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
               (lbs,uu____5321);
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___195_5501 = env in
        {
          curmodule = (uu___195_5501.curmodule);
          curmonad = (uu___195_5501.curmonad);
          modules = (uu___195_5501.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___195_5501.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___195_5501.sigaccum);
          sigmap = (uu___195_5501.sigmap);
          iface = (uu___195_5501.iface);
          admitted_iface = (uu___195_5501.admitted_iface);
          expect_typ = (uu___195_5501.expect_typ);
          docs = (uu___195_5501.docs);
          remaining_iface_decls = (uu___195_5501.remaining_iface_decls);
          syntax_only = (uu___195_5501.syntax_only);
          ds_hooks = (uu___195_5501.ds_hooks)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___176_5534 =
        match uu___176_5534 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___177_5623 =
        match uu___177_5623 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___182_7977 =
            match uu___182_7977 with
            | Rec_binding uu____7978 -> true
            | uu____7979 -> false in
          let this_env =
            let uu___196_7981 = env in
            let uu____7982 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___196_7981.curmodule);
              curmonad = (uu___196_7981.curmonad);
              modules = (uu___196_7981.modules);
              scope_mods = uu____7982;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___196_7981.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___196_7981.sigaccum);
              sigmap = (uu___196_7981.sigmap);
              iface = (uu___196_7981.iface);
              admitted_iface = (uu___196_7981.admitted_iface);
              expect_typ = (uu___196_7981.expect_typ);
              docs = (uu___196_7981.docs);
              remaining_iface_decls = (uu___196_7981.remaining_iface_decls);
              syntax_only = (uu___196_7981.syntax_only);
              ds_hooks = (uu___196_7981.ds_hooks)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___197_8013 = env in
      {
        curmodule = (uu___197_8013.curmodule);
        curmonad = (uu___197_8013.curmonad);
        modules = (uu___197_8013.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___197_8013.exported_ids);
        trans_exported_ids = (uu___197_8013.trans_exported_ids);
        includes = (uu___197_8013.includes);
        sigaccum = (uu___197_8013.sigaccum);
        sigmap = (uu___197_8013.sigmap);
        iface = (uu___197_8013.iface);
        admitted_iface = (uu___197_8013.admitted_iface);
        expect_typ = (uu___197_8013.expect_typ);
        docs = (uu___197_8013.docs);
        remaining_iface_decls = (uu___197_8013.remaining_iface_decls);
        syntax_only = (uu___197_8013.syntax_only);
        ds_hooks = (uu___197_8013.ds_hooks)
      }
let push_bv':
  env ->
    FStar_Ident.ident ->
            ...
            (match uu____8154 with
             ...
             | uu____8167 ->
                 (extract_record env globals s;
                  (let uu___198_8185 = env in
                   {
                     curmodule = (uu___198_8185.curmodule);
                     curmonad = (uu___198_8185.curmonad);
                     modules = (uu___198_8185.modules);
                     scope_mods = (uu___198_8185.scope_mods);
                     exported_ids = (uu___198_8185.exported_ids);
                     trans_exported_ids = (uu___198_8185.trans_exported_ids);
                     includes = (uu___198_8185.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___198_8185.sigmap);
                     iface = (uu___198_8185.iface);
                     admitted_iface = (uu___198_8185.admitted_iface);
                     expect_typ = (uu___198_8185.expect_typ);
                     docs = (uu___198_8185.docs);
                     remaining_iface_decls =
                       (uu___198_8185.remaining_iface_decls);
                     syntax_only = (uu___198_8185.syntax_only);
                     ds_hooks = (uu___198_8185.ds_hooks)
                   }))) in
      let env2 =
        let uu___199_8187 = env1 in
        let uu____8188 = FStar_ST.op_Bang globals in
        {
          curmodule = (uu___199_8187.curmodule);
          curmonad = (uu___199_8187.curmonad);
          modules = (uu___199_8187.modules);
          scope_mods = uu____8188;
          exported_ids = (uu___199_8187.exported_ids);
          trans_exported_ids = (uu___199_8187.trans_exported_ids);
          includes = (uu___199_8187.includes);
          sigaccum = (uu___199_8187.sigaccum);
          sigmap = (uu___199_8187.sigmap);
          iface = (uu___199_8187.iface);
          admitted_iface = (uu___199_8187.admitted_iface);
          expect_typ = (uu___199_8187.expect_typ);
          docs = (uu___199_8187.docs);
          remaining_iface_decls = (uu___199_8187.remaining_iface_decls);
          syntax_only = (uu___199_8187.syntax_only);
          ds_hooks = (uu___199_8187.ds_hooks)
        } in
      let uu____8255 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___200_8693 = env3 in
              let uu____8694 = FStar_ST.op_Bang globals in
              {
                curmodule = (uu___200_8693.curmodule);
                curmonad = (uu___200_8693.curmonad);
                modules = (uu___200_8693.modules);
                scope_mods = uu____8694;
                exported_ids = (uu___200_8693.exported_ids);
                trans_exported_ids = (uu___200_8693.trans_exported_ids);
                includes = (uu___200_8693.includes);
                sigaccum = (uu___200_8693.sigaccum);
                sigmap = (uu___200_8693.sigmap);
                iface = (uu___200_8693.iface);
                admitted_iface = (uu___200_8693.admitted_iface);
                expect_typ = (uu___200_8693.expect_typ);
                docs = (uu___200_8693.docs);
                remaining_iface_decls = (uu___200_8693.remaining_iface_decls);
                syntax_only = (uu___200_8693.syntax_only);
                ds_hooks = (uu___200_8693.ds_hooks)
              } in
            env4))
                     ...
                     ((let uu____9731 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___201_9744 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___201_9744.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___201_9744.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___201_9744.FStar_Syntax_Syntax.sigmeta);
                             FStar_Syntax_Syntax.sigattrs =
                               (uu___201_9744.FStar_Syntax_Syntax.sigattrs)
                           }), false)))
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___202_9866 = se in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___202_9866.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___202_9866.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___202_9866.FStar_Syntax_Syntax.sigattrs)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___203_10354 = env in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___203_10354.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___203_10354.exported_ids);
                    trans_exported_ids = (uu___203_10354.trans_exported_ids);
                    includes = (uu___203_10354.includes);
                    sigaccum = [];
                    sigmap = (uu___203_10354.sigmap);
                    iface = (uu___203_10354.iface);
                    admitted_iface = (uu___203_10354.admitted_iface);
                    expect_typ = (uu___203_10354.expect_typ);
                    docs = (uu___203_10354.docs);
                    remaining_iface_decls =
                      (uu___203_10354.remaining_iface_decls);
                    syntax_only = (uu___203_10354.syntax_only);
                    ds_hooks = (uu___203_10354.ds_hooks)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___204_10484 = env in
     let uu____10485 = FStar_Util.smap_copy (sigmap env) in
     let uu____10496 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___204_10484.curmodule);
       curmonad = (uu___204_10484.curmonad);
       modules = (uu___204_10484.modules);
       scope_mods = (uu___204_10484.scope_mods);
       exported_ids = (uu___204_10484.exported_ids);
       trans_exported_ids = (uu___204_10484.trans_exported_ids);
       includes = (uu___204_10484.includes);
       sigaccum = (uu___204_10484.sigaccum);
       sigmap = uu____10485;
       iface = (uu___204_10484.iface);
       admitted_iface = (uu___204_10484.admitted_iface);
       expect_typ = (uu___204_10484.expect_typ);
       docs = uu____10496;
       remaining_iface_decls = (uu___204_10484.remaining_iface_decls);
       syntax_only = (uu___204_10484.syntax_only);
       ds_hooks = (uu___204_10484.ds_hooks)
     })
              ...
              | FStar_Pervasives_Native.Some (se,true ) when sigelt_in_m se
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___205_10690 = se in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___205_10690.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___205_10690.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___205_10690.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___205_10690.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____10691 -> se in
        ...
        fun mname  ->
          fun mii  ->
            let prep env1 =
              ...
              let auto_open1 =
                let convert_kind uu___185_11640 =
                  match uu___185_11640 with
                           ...
                           | () ->
                               let env' =
                                     ...
                                     auto_open2 in
                                 {
                                   ...
                                   curmonad = (uu___206_11767.curmonad);
                                   modules = (uu___206_11767.modules);
                                   scope_mods = uu____11768;
                                   exported_ids =
                                     (uu___206_11767.exported_ids);
                                   trans_exported_ids =
                                     (uu___206_11767.trans_exported_ids);
                                   includes = (uu___206_11767.includes);
                                   sigaccum = (uu___206_11767.sigaccum);
                                   sigmap = (env1.sigmap);
                                   iface = intf;
                                   admitted_iface = admitted;
                                   expect_typ = (uu___206_11767.expect_typ);
                                   docs = (uu___206_11767.docs);
                                   remaining_iface_decls =
                                     (uu___206_11767.remaining_iface_decls);
                                   syntax_only = (uu___206_11767.syntax_only);
                                   ds_hooks = (uu___206_11767.ds_hooks)
                                 } in
                               (FStar_List.iter
                                  (fun op  ->
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___207_11852 = env in
          {
            curmodule = (uu___207_11852.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___207_11852.modules);
            scope_mods = (uu___207_11852.scope_mods);
            exported_ids = (uu___207_11852.exported_ids);
            trans_exported_ids = (uu___207_11852.trans_exported_ids);
            includes = (uu___207_11852.includes);
            sigaccum = (uu___207_11852.sigaccum);
            sigmap = (uu___207_11852.sigmap);
            iface = (uu___207_11852.iface);
            admitted_iface = (uu___207_11852.admitted_iface);
            expect_typ = (uu___207_11852.expect_typ);
            docs = (uu___207_11852.docs);
            remaining_iface_decls = (uu___207_11852.remaining_iface_decls);
            syntax_only = (uu___207_11852.syntax_only);
            ds_hooks = (uu___207_11852.ds_hooks)
          }
let fail_or:
  'a .
    env ->
