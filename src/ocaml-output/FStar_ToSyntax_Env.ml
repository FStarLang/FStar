        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____1537  ->
                ...
                | (m,uu____1545) -> FStar_Ident.lid_equals l m))
         in
    ...
    fun id  ->
      fun k_global_def  ->
        fun k_not_found  ->
          ...
          | FStar_Pervasives_Native.None  ->
              let lid =
                let uu____2814 = current_module env  in qual uu____2814 id
                 in
        ...
        let uu____3128 =
          is_full_path &&
            (let uu____3130 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____3130)
           in
        if uu____3128
        then (ids, [])
        else
        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___159_3554  ->
               ...
               | uu____3569 -> FStar_Pervasives_Native.None)
           in
        (match qopt with
         | FStar_Pervasives_Native.None  ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
                     ...
                     let uu____3699 =
                       let uu____3700 =
                         let uu____3705 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____3706
                            in
                         (uu____3705, false)  in
                       ...
                       let uu____3764 =
                         FStar_Util.find_map quals
                           (fun uu___162_3769  ->
                              ...
                              | uu____3773 -> FStar_Pervasives_Native.None)
                          in
                            ...
                            let uu____3785 =
                              let uu____3786 =
                                let uu____3791 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____3792
                                   in
                                (uu____3791, false)  in
    ...
    fun lid  ->
      ...
      let uu____4318 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____4330  -> FStar_Pervasives_Native.None) k_global_def
         in
...
let record_cache_aux_with_filter :
  ...
  let push1 uu____4897 =
    let uu____4898 =
      ...
      let uu____4919 = FStar_ST.read record_cache  in uu____4903 ::
        uu____4919
       in
    FStar_ST.write record_cache uu____4898  in
  let pop1 uu____4941 =
    let uu____4942 =
      let uu____4947 = FStar_ST.read record_cache  in
      FStar_List.tl uu____4947  in
    FStar_ST.write record_cache uu____4942  in
  let peek1 uu____4971 =
    let uu____4972 = FStar_ST.read record_cache  in FStar_List.hd uu____4972
     in
  let insert r =
    let uu____4989 =
     ...
     | () ->
         ...
         let uu____5082 =
           let uu____5087 = FStar_ST.read record_cache  in filtered ::
             uu____5087
            in
         FStar_ST.write record_cache uu____5082)
     in
                                                             ...
                                                             let uu____6070 =
                                                               let uu____6071
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____6071.FStar_Ident.ident
                                                                in
                                                             uu____6070.FStar_Ident.idText
                                                              in
                                                           let uu____6073 =
                                                             let uu____6074 =
                                                               FStar_ST.read
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____6201 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____6205  -> Cont_ok ())
               in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____6548) ->
            let uu____6557 =
              FStar_List.map
               ...
               in
            (env2, uu____6557)
        | uu____6584 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
           ...
           (let env1 =
            ...
            (let uu____6812 = FStar_Util.smap_try_find env1.includes curmod
             ...
             | FStar_Pervasives_Native.Some incl ->
                 let uu____6836 =
                   let uu____6839 = FStar_ST.read incl  in ns1 :: uu____6839
                    in
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____6956 =
                                 ...
                                 FStar_Util.set_difference uu____6957 ns_ex
                                  in
                               ...
                               | () ->
                                   ...
                                   let uu____6969 =
                                     let uu____6970 = FStar_ST.read trans_ex
                                        in
                                     FStar_Util.set_union uu____6970 ns_ex
                                      in
                                   FStar_ST.write trans_ex uu____6969)
                               in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____7059 =
                    ...
                    FStar_Util.format3
                      ...
                      uu____7060 uu____7061 uu____7062
                     in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____7237 -> ()));
      (let curmod =
         let uu____7239 = current_module env  in uu____7239.FStar_Ident.str
          in
       (let uu____7241 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____7319 = cur_ex eikind  in FStar_ST.read uu____7319
                 in
        ...
        fun mname  ->
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____7710  ->
                    ...
                    | (l,uu____7716) -> FStar_Ident.lid_equals l mname))
             in
          ...
          | FStar_Pervasives_Native.Some (uu____7726,m) ->
              ((let uu____7733 =
               ...
               (let uu____7745 =
                  let uu____7746 = push env  in prep uu____7746  in
                (uu____7745, true)))
