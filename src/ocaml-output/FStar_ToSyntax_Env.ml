        ...
        let uu____3798 =
          is_full_path &&
            (let uu____3800 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____3800)
           in
        if uu____3798
        then (ids, [])
        else
                     ...
                     let uu____4340 =
                       let uu____4341 =
                         let uu____4346 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____4347
                            in
                         (uu____4346, false)  in
    ...
    fun lid  ->
      ...
      let uu____4952 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____4964  -> FStar_Pervasives_Native.None) k_global_def
         in
...
let try_lookup_lid' :
  ...
  fun any_val  ->
    fun exclude_interface  ->
      fun env  ->
        fun lid  ->
          let uu____5214 = try_lookup_name any_val exclude_interface env lid
             in
                                                             ...
                                                             let uu____7400 =
                                                               let uu____7401
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id1
                                                                  in
                                                               uu____7401.FStar_Ident.ident
                                                                in
                                                             uu____7400.FStar_Ident.idText
                                                              in
                                                           let uu____7403 =
                                                             let uu____7404 =
                                                               FStar_ST.op_Bang
...
let try_lookup_record_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____7614 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____7644 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____7648  -> Cont_ok ())
               in
...
let try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____7668 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | (any_val,exclude_interface) ->
            ...
            let uu____7937 =
              FStar_Util.find_map lids
                (fun l  ->
                   let uu____7943 =
                     let uu____7944 = unique any_val exclude_interface env l
                        in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____8065) ->
            let uu____8074 =
              FStar_List.map
               ...
               in
            (env2, uu____8074)
        | uu____8101 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
                   ...
                   | (lids,se) ->
                       FStar_All.pipe_right lids
                         (FStar_List.iter
                            (fun lid  ->
                               (let uu____8182 =
                                  let uu____8185 = FStar_ST.op_Bang globals
                                     in
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____8640 = FStar_Util.smap_try_find env1.includes curmod
                in
             ...
             | () ->
                 ...
                 (match uu____8802 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____8819 =
                          let uu____8836 = get_exported_id_set env1 curmod
                             in
                          let uu____8843 =
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____9156 =
                                 ...
                                 FStar_Util.set_difference uu____9157 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____9295 =
                                     ...
                                     FStar_Util.set_union uu____9296 ns_ex
                                      in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____9497 =
                    let uu____9502 =
                      ...
                      let uu____9505 = FStar_Parser_AST.string_of_fsdoc doc1
                         in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____9503 uu____9504 uu____9505
                       in
                       ...
                       then
                         let uu____9535 =
                           let uu____9540 =
                             ...
                             FStar_Util.format1
                               "Admitting %s without a definition" uu____9541
                              in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___208_9671 = se  in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___208_9671.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___208_9671.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___208_9671.FStar_Syntax_Syntax.sigattrs)
                               }  in
              ...
              | uu____9681 -> ()));
      (let curmod =
         let uu____9683 = current_module env  in uu____9683.FStar_Ident.str
          in
       (let uu____9685 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____9763 = cur_ex eikind  in
                FStar_ST.op_Bang uu____9763  in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___209_10167 = env  in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___209_10167.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___209_10167.exported_ids);
                    trans_exported_ids = (uu___209_10167.trans_exported_ids);
                    includes = (uu___209_10167.includes);
                    sigaccum = [];
                    sigmap = (uu___209_10167.sigmap);
                    iface = (uu___209_10167.iface);
                    admitted_iface = (uu___209_10167.admitted_iface);
                    expect_typ = (uu___209_10167.expect_typ);
                    docs = (uu___209_10167.docs);
                    remaining_iface_decls =
                      (uu___209_10167.remaining_iface_decls);
                    syntax_only = (uu___209_10167.syntax_only);
                    ds_hooks = (uu___209_10167.ds_hooks)
                  }))))
...
let push : env -> env =
  fun env  ->
    ...
    (let uu___210_10300 = env  in
     let uu____10301 = FStar_Util.smap_copy (sigmap env)  in
     let uu____10312 = FStar_Util.smap_copy env.docs  in
     {
       curmodule = (uu___210_10300.curmodule);
       curmonad = (uu___210_10300.curmonad);
       modules = (uu___210_10300.modules);
       scope_mods = (uu___210_10300.scope_mods);
       exported_ids = (uu___210_10300.exported_ids);
       trans_exported_ids = (uu___210_10300.trans_exported_ids);
       includes = (uu___210_10300.includes);
       sigaccum = (uu___210_10300.sigaccum);
       sigmap = uu____10301;
       iface = (uu___210_10300.iface);
       admitted_iface = (uu___210_10300.admitted_iface);
       expect_typ = (uu___210_10300.expect_typ);
       docs = uu____10312;
       remaining_iface_decls = (uu___210_10300.remaining_iface_decls);
       syntax_only = (uu___210_10300.syntax_only);
       ds_hooks = (uu___210_10300.ds_hooks)
     })
              ...
              | FStar_Pervasives_Native.Some (se,true ) when sigelt_in_m se
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___211_10507 = se  in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___211_10507.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___211_10507.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___211_10507.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___211_10507.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____10508 -> se  in
...
let as_exported_ids : exported_id_set -> exported_ids =
  fun e  ->
    ...
    let fields =
      let uu____10847 =
        let uu____10850 = e Exported_id_field  in
        FStar_ST.op_Bang uu____10850  in
        ...
        fun mname  ->
          fun mii  ->
            let prep env1 =
              ...
              let auto_open1 =
                let convert_kind uu___191_11449 =
                  match uu___191_11449 with
                           ...
                           | () ->
                               let env' =
                                    ...
                                    in
                                 {
                                   ...
                                   curmonad = (uu___212_11576.curmonad);
                                   modules = (uu___212_11576.modules);
                                   scope_mods = uu____11577;
                                   exported_ids =
                                     (uu___212_11576.exported_ids);
                                   trans_exported_ids =
                                     (uu___212_11576.trans_exported_ids);
                                   includes = (uu___212_11576.includes);
                                   sigaccum = (uu___212_11576.sigaccum);
                                   sigmap = (env1.sigmap);
                                   iface = intf;
                                   admitted_iface = admitted;
                                   expect_typ = (uu___212_11576.expect_typ);
                                   docs = (uu___212_11576.docs);
                                   remaining_iface_decls =
                                     (uu___212_11576.remaining_iface_decls);
                                   syntax_only = (uu___212_11576.syntax_only);
                                   ds_hooks = (uu___212_11576.ds_hooks)
                                 }  in
                               (FStar_List.iter
                                  (fun op  ->
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____11615  ->
                      ...
                      | (l,uu____11621) -> FStar_Ident.lid_equals l mname))
               in
...
let enter_monad_scope : env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___213_11658 = env  in
          {
            curmodule = (uu___213_11658.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___213_11658.modules);
            scope_mods = (uu___213_11658.scope_mods);
            exported_ids = (uu___213_11658.exported_ids);
            trans_exported_ids = (uu___213_11658.trans_exported_ids);
            includes = (uu___213_11658.includes);
            sigaccum = (uu___213_11658.sigaccum);
            sigmap = (uu___213_11658.sigmap);
            iface = (uu___213_11658.iface);
            admitted_iface = (uu___213_11658.admitted_iface);
            expect_typ = (uu___213_11658.expect_typ);
            docs = (uu___213_11658.docs);
            remaining_iface_decls = (uu___213_11658.remaining_iface_decls);
            syntax_only = (uu___213_11658.syntax_only);
            ds_hooks = (uu___213_11658.ds_hooks)
          }
