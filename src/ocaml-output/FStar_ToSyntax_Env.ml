...
let uu___180_1426 = env
in {curmodule = uu___180_1426.curmodule; curmonad = uu___180_1426.curmonad; modules = uu___180_1426.modules; scope_mods = uu___180_1426.scope_mods; exported_ids = uu___180_1426.exported_ids; trans_exported_ids = uu___180_1426.trans_exported_ids; includes = uu___180_1426.includes; sigaccum = uu___180_1426.sigaccum; sigmap = uu___180_1426.sigmap; iface = b; admitted_iface = uu___180_1426.admitted_iface; expect_typ = uu___180_1426.expect_typ; docs = uu___180_1426.docs; remaining_iface_decls = uu___180_1426.remaining_iface_decls; syntax_only = uu___180_1426.syntax_only}))
...
let uu___181_1439 = e
in {curmodule = uu___181_1439.curmodule; curmonad = uu___181_1439.curmonad; modules = uu___181_1439.modules; scope_mods = uu___181_1439.scope_mods; exported_ids = uu___181_1439.exported_ids; trans_exported_ids = uu___181_1439.trans_exported_ids; includes = uu___181_1439.includes; sigaccum = uu___181_1439.sigaccum; sigmap = uu___181_1439.sigmap; iface = uu___181_1439.iface; admitted_iface = b; expect_typ = uu___181_1439.expect_typ; docs = uu___181_1439.docs; remaining_iface_decls = uu___181_1439.remaining_iface_decls; syntax_only = uu___181_1439.syntax_only}))
...
let uu___182_1452 = e
in {curmodule = uu___182_1452.curmodule; curmonad = uu___182_1452.curmonad; modules = uu___182_1452.modules; scope_mods = uu___182_1452.scope_mods; exported_ids = uu___182_1452.exported_ids; trans_exported_ids = uu___182_1452.trans_exported_ids; includes = uu___182_1452.includes; sigaccum = uu___182_1452.sigaccum; sigmap = uu___182_1452.sigmap; iface = uu___182_1452.iface; admitted_iface = uu___182_1452.admitted_iface; expect_typ = b; docs = uu___182_1452.docs; remaining_iface_decls = uu___182_1452.remaining_iface_decls; syntax_only = uu___182_1452.syntax_only}))
...
let uu___183_1669 = e
in {curmodule = FStar_Pervasives_Native.Some (l); curmonad = uu___183_1669.curmonad; modules = uu___183_1669.modules; scope_mods = uu___183_1669.scope_mods; exported_ids = uu___183_1669.exported_ids; trans_exported_ids = uu___183_1669.trans_exported_ids; includes = uu___183_1669.includes; sigaccum = uu___183_1669.sigaccum; sigmap = uu___183_1669.sigmap; iface = uu___183_1669.iface; admitted_iface = uu___183_1669.admitted_iface; expect_typ = uu___183_1669.expect_typ; docs = uu___183_1669.docs; remaining_iface_decls = uu___183_1669.remaining_iface_decls; syntax_only = uu___183_1669.syntax_only}))
...
let uu___184_1853 = env
in {curmodule = uu___184_1853.curmodule; curmonad = uu___184_1853.curmonad; modules = uu___184_1853.modules; scope_mods = uu___184_1853.scope_mods; exported_ids = uu___184_1853.exported_ids; trans_exported_ids = uu___184_1853.trans_exported_ids; includes = uu___184_1853.includes; sigaccum = uu___184_1853.sigaccum; sigmap = uu___184_1853.sigmap; iface = uu___184_1853.iface; admitted_iface = uu___184_1853.admitted_iface; expect_typ = uu___184_1853.expect_typ; docs = uu___184_1853.docs; remaining_iface_decls = (((l), (ds)))::rest; syntax_only = uu___184_1853.syntax_only})
end)))
...
let uu___185_1892 = env
in {curmodule = uu___185_1892.curmodule; curmonad = uu___185_1892.curmonad; modules = uu___185_1892.modules; scope_mods = uu___185_1892.scope_mods; exported_ids = uu___185_1892.exported_ids; trans_exported_ids = uu___185_1892.trans_exported_ids; includes = uu___185_1892.includes; sigaccum = uu___185_1892.sigaccum; sigmap = uu___185_1892.sigmap; iface = uu___185_1892.iface; admitted_iface = uu___185_1892.admitted_iface; expect_typ = uu___185_1892.expect_typ; docs = uu___185_1892.docs; remaining_iface_decls = uu___185_1892.remaining_iface_decls; syntax_only = b}))
...
let uu___186_1986 = bv.FStar_Syntax_Syntax.ppname
in {FStar_Ident.idText = uu___186_1986.FStar_Ident.idText; FStar_Ident.idRange = r})
in (

let uu___187_1987 = bv
in {FStar_Syntax_Syntax.ppname = id; FStar_Syntax_Syntax.index = uu___187_1987.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___187_1987.FStar_Syntax_Syntax.sort})))
...
let option_of_cont : 'a . (Prims.unit  ->  'a FStar_Pervasives_Native.option)  ->  'a cont_t  ->  'a FStar_Pervasives_Native.option = (fun k_ignore uu___150_2221 -> (match (uu___150_2221) with
| Cont_ok (a) -> begin
...
let string_of_exported_id_kind : exported_id_kind  ->  Prims.string = (fun uu___151_2344 -> (match (uu___151_2344) with
| Exported_id_field -> begin
"field"
end
| Exported_id_term_type -> begin
...
let rec aux = (fun uu___152_2407 -> (match (uu___152_2407) with
| [] -> begin
...
let is_exported_id_field : exported_id_kind  ->  Prims.bool = (fun uu___153_2687 -> (match (uu___153_2687) with
| Exported_id_field -> begin
true
end
| uu____2688 -> begin
...
let check_local_binding_id = (fun uu___154_2799 -> (match (uu___154_2799) with
| (id', uu____2801, uu____2802) -> begin
(id'.FStar_Ident.idText = id.FStar_Ident.idText)
end))
in (

let check_rec_binding_id = (fun uu___155_2806 -> (match (uu___155_2806) with
...
let proc = (fun uu___156_2819 -> (match (uu___156_2819) with
...
let rec aux = (fun uu___157_2840 -> (match (uu___157_2840) with
| (a)::q -> begin
(
...
let rec aux = (fun uu___158_3239 -> (match (uu___158_3239) with
| [] -> begin
(
...
| (Module_abbrev (name, modul))::uu____3268 when ((nslen = (Prims.parse_int "0")) && (name.FStar_Ident.idText = lid.FStar_Ident.ident.FStar_Ident.idText)) -> begin
...
let namespace_is_open : env  ->  FStar_Ident.lident  ->  Prims.bool = (fun env lid -> (FStar_List.existsb (fun uu___159_3331 -> (match (uu___159_3331) with
...
let cont_of_option : 'a . 'a cont_t  ->  'a FStar_Pervasives_Native.option  ->  'a cont_t = (fun k_none uu___160_3762 -> (match (uu___160_3762) with
| FStar_Pervasives_Native.Some (v1) -> begin
Cont_ok (v1)
end
| FStar_Pervasives_Native.None -> begin
...
let qopt = (FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals (fun uu___161_3932 -> (match (uu___161_3932) with
...
let k_global_def = (fun source_lid uu___165_4026 -> (match (uu___165_4026) with
...
let uu____4118 = (any_val || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___162_4122 -> (match (uu___162_4122) with
...
let uu____4128 = ((FStar_Syntax_Util.is_primop_lid lid2) || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___163_4133 -> (match (uu___163_4133) with
...
let uu____4142 = (FStar_Util.find_map quals (fun uu___164_4147 -> (match (uu___164_4147) with
...
let k_global_def = (fun lid1 uu___166_4666 -> (match (uu___166_4666) with
...
let k_global_def = (fun lid1 uu___167_4798 -> (match (uu___167_4798) with
...
let k_global_def = (fun lid1 uu___168_4866 -> (match (uu___168_4866) with
...
let uu___188_5056 = env
in {curmodule = uu___188_5056.curmodule; curmonad = uu___188_5056.curmonad; modules = uu___188_5056.modules; scope_mods = []; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___188_5056.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___188_5056.sigaccum; sigmap = uu___188_5056.sigmap; iface = uu___188_5056.iface; admitted_iface = uu___188_5056.admitted_iface; expect_typ = uu___188_5056.expect_typ; docs = uu___188_5056.docs; remaining_iface_decls = uu___188_5056.remaining_iface_decls; syntax_only = uu___188_5056.syntax_only})
...
let k_global_def = (fun lid1 uu___170_5089 -> (match (uu___170_5089) with
...
let uu____5108 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___169_5112 -> (match (uu___169_5112) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____5113 -> begin
...
let k_global_def = (fun lid1 uu___171_5178 -> (match (uu___171_5178) with
...
let is_record = (FStar_Util.for_some (fun uu___172_6498 -> (match (uu___172_6498) with
...
let find_dc = (fun dc -> (FStar_All.pipe_right sigs (FStar_Util.find_opt (fun uu___173_6539 -> (match (uu___173_6539) with
...
in (FStar_All.pipe_right sigs (FStar_List.iter (fun uu___174_6593 -> (match (uu___174_6593) with
...
in (uu____7141 = uu____7145))) -> begin
(
...
in (fun uu___175_7250 -> (match (uu___175_7250) with
| Exported_id_term_type -> begin
term_type_set
end
| Exported_id_field -> begin
...
let filter_scope_mods = (fun uu___176_7288 -> (match (uu___176_7288) with
...
let uu___189_7292 = env
in (

let uu____7293 = (FStar_List.filter filter_scope_mods env.scope_mods)
in {curmodule = uu___189_7292.curmodule; curmonad = uu___189_7292.curmonad; modules = uu___189_7292.modules; scope_mods = uu____7293; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___189_7292.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___189_7292.sigaccum; sigmap = uu___189_7292.sigmap; iface = uu___189_7292.iface; admitted_iface = uu___189_7292.admitted_iface; expect_typ = uu___189_7292.expect_typ; docs = uu___189_7292.docs; remaining_iface_decls = uu___189_7292.remaining_iface_decls; syntax_only = uu___189_7292.syntax_only}))
in (
...
let uu___190_7324 = env
in {curmodule = uu___190_7324.curmodule; curmonad = uu___190_7324.curmonad; modules = uu___190_7324.modules; scope_mods = (scope_mod)::env.scope_mods; exported_ids = uu___190_7324.exported_ids; trans_exported_ids = uu___190_7324.trans_exported_ids; includes = uu___190_7324.includes; sigaccum = uu___190_7324.sigaccum; sigmap = uu___190_7324.sigmap; iface = uu___190_7324.iface; admitted_iface = uu___190_7324.admitted_iface; expect_typ = uu___190_7324.expect_typ; docs = uu___190_7324.docs; remaining_iface_decls = uu___190_7324.remaining_iface_decls; syntax_only = uu___190_7324.syntax_only}))
...
let uu___191_7496 = env
in {curmodule = uu___191_7496.curmodule; curmonad = uu___191_7496.curmonad; modules = uu___191_7496.modules; scope_mods = uu___191_7496.scope_mods; exported_ids = uu___191_7496.exported_ids; trans_exported_ids = uu___191_7496.trans_exported_ids; includes = uu___191_7496.includes; sigaccum = (s)::env.sigaccum; sigmap = uu___191_7496.sigmap; iface = uu___191_7496.iface; admitted_iface = uu___191_7496.admitted_iface; expect_typ = uu___191_7496.expect_typ; docs = uu___191_7496.docs; remaining_iface_decls = uu___191_7496.remaining_iface_decls; syntax_only = uu___191_7496.syntax_only});
)
end)))
end))
in (
...
let uu___192_7498 = env1
in (

let uu____7499 = (FStar_ST.op_Bang globals)
in {curmodule = uu___192_7498.curmodule; curmonad = uu___192_7498.curmonad; modules = uu___192_7498.modules; scope_mods = uu____7499; exported_ids = uu___192_7498.exported_ids; trans_exported_ids = uu___192_7498.trans_exported_ids; includes = uu___192_7498.includes; sigaccum = uu___192_7498.sigaccum; sigmap = uu___192_7498.sigmap; iface = uu___192_7498.iface; admitted_iface = uu___192_7498.admitted_iface; expect_typ = uu___192_7498.expect_typ; docs = uu___192_7498.docs; remaining_iface_decls = uu___192_7498.remaining_iface_decls; syntax_only = uu___192_7498.syntax_only}))
in (
...
let uu___193_7836 = env3
in (

let uu____7837 = (FStar_ST.op_Bang globals)
in {curmodule = uu___193_7836.curmodule; curmonad = uu___193_7836.curmonad; modules = uu___193_7836.modules; scope_mods = uu____7837; exported_ids = uu___193_7836.exported_ids; trans_exported_ids = uu___193_7836.trans_exported_ids; includes = uu___193_7836.includes; sigaccum = uu___193_7836.sigaccum; sigmap = uu___193_7836.sigmap; iface = uu___193_7836.iface; admitted_iface = uu___193_7836.admitted_iface; expect_typ = uu___193_7836.expect_typ; docs = uu___193_7836.docs; remaining_iface_decls = uu___193_7836.remaining_iface_decls; syntax_only = uu___193_7836.syntax_only}))
in env4);
)
end)))))))
...
let uu____8562 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid l))
in (

let uu____8563 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" uu____8562 uu____8563)))
in (FStar_Util.print_string uu____8561))
end
| uu____8564 -> begin
()
end));
...
let uu___194_8573 = se
in {FStar_Syntax_Syntax.sigel = uu___194_8573.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___194_8573.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals; FStar_Syntax_Syntax.sigmeta = uu___194_8573.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___194_8573.FStar_Syntax_Syntax.sigattrs})), (false))));
)
end
| FStar_Pervasives_Native.Some (uu____8574) -> begin
()
end))
end
| uu____8583 -> begin
...
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____8602) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (lid, uu____8622, uu____8623, uu____8624, uu____8625, uu____8626) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____8638, uu____8639) -> begin
...
| FStar_Syntax_Syntax.Sig_let ((uu____8645, lbs), uu____8647) -> begin
((match (((FStar_List.contains FStar_Syntax_Syntax.Private quals) || (FStar_List.contains FStar_Syntax_Syntax.Abstract quals))) with
| true -> begin
...
let uu____8673 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____8673.FStar_Syntax_Syntax.fv_name)
in uu____8670.FStar_Syntax_Syntax.v)
in uu____8669.FStar_Ident.str)
in (FStar_Util.smap_remove (sigmap env) uu____8668)))))
end
| uu____8678 -> begin
()
end);
...
let uu____8690 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____8690.FStar_Syntax_Syntax.fv_name)
in uu____8687.FStar_Syntax_Syntax.v)
in (
...
let uu___195_8695 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp))); FStar_Syntax_Syntax.sigrng = uu___195_8695.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___195_8695.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___195_8695.FStar_Syntax_Syntax.sigattrs})
...
let uu____8707 = (current_module env)
in uu____8707.FStar_Ident.str)
in ((

let uu____8709 = (

let uu____8726 = (get_exported_id_set env curmod)
in (

let uu____8733 = (get_trans_exported_id_set env curmod)
in ((uu____8726), (uu____8733))))
...
let uu____8787 = (cur_ex eikind)
in (FStar_ST.op_Bang uu____8787))
in (
...
let uu____8970 = (FStar_ST.op_Bang cur_trans_ex_set_ref)
in (FStar_Util.set_union cur_ex_set uu____8970))
in (FStar_ST.op_Colon_Equals cur_trans_ex_set_ref uu____8969)))))
in (FStar_List.iter update_exports all_exported_id_kinds))
end
| uu____9021 -> begin
()
...
let uu___196_9039 = env
in {curmodule = FStar_Pervasives_Native.None; curmonad = uu___196_9039.curmonad; modules = (((modul.FStar_Syntax_Syntax.name), (modul)))::env.modules; scope_mods = []; exported_ids = uu___196_9039.exported_ids; trans_exported_ids = uu___196_9039.trans_exported_ids; includes = uu___196_9039.includes; sigaccum = []; sigmap = uu___196_9039.sigmap; iface = uu___196_9039.iface; admitted_iface = uu___196_9039.admitted_iface; expect_typ = uu___196_9039.expect_typ; docs = uu___196_9039.docs; remaining_iface_decls = uu___196_9039.remaining_iface_decls; syntax_only = uu___196_9039.syntax_only})
end);
)
end);
));
...
let uu____9066 = (FStar_ST.op_Bang stack)
in (env)::uu____9066)
in (FStar_ST.op_Colon_Equals stack uu____9063));
(

let uu___197_9105 = env
in (

let uu____9106 = (FStar_Util.smap_copy (sigmap env))
in (

let uu____9117 = (FStar_Util.smap_copy env.docs)
in {curmodule = uu___197_9105.curmodule; curmonad = uu___197_9105.curmonad; modules = uu___197_9105.modules; scope_mods = uu___197_9105.scope_mods; exported_ids = uu___197_9105.exported_ids; trans_exported_ids = uu___197_9105.trans_exported_ids; includes = uu___197_9105.includes; sigaccum = uu___197_9105.sigaccum; sigmap = uu____9106; iface = uu___197_9105.iface; admitted_iface = uu___197_9105.admitted_iface; expect_typ = uu___197_9105.expect_typ; docs = uu____9117; remaining_iface_decls = uu___197_9105.remaining_iface_decls; syntax_only = uu___197_9105.syntax_only})));
))


let pop : Prims.unit  ->  env = (fun uu____9123 -> (

let uu____9124 = (FStar_ST.op_Bang stack)
...
let uu____9177 = (FStar_ST.op_Bang stack)
in (match (uu____9177) with
| (uu____9198)::tl1 -> begin
((FStar_ST.op_Colon_Equals stack tl1);
env;
)
end
...
let uu____9282 = (FStar_Util.smap_try_find sm' k)
...
let uu___198_9307 = se
in {FStar_Syntax_Syntax.sigel = uu___198_9307.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___198_9307.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::se.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___198_9307.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___198_9307.FStar_Syntax_Syntax.sigattrs})
end
| uu____9308 -> begin
se
end)
...
let uu____9401 = (e Exported_id_term_type)
in (FStar_ST.op_Bang uu____9401))
in (FStar_Util.set_elements uu____9398))
in (
...
let uu____9579 = (e Exported_id_field)
in (FStar_ST.op_Bang uu____9579))
in (FStar_Util.set_elements uu____9576))
...
let uu____9784 = (FStar_Util.as_set e1.exported_id_terms FStar_Util.compare)
in (FStar_Util.mk_ref uu____9784))
in (

let fields = (

let uu____9794 = (FStar_Util.as_set e1.exported_id_fields FStar_Util.compare)
in (FStar_Util.mk_ref uu____9794))
in (fun uu___177_9799 -> (match (uu___177_9799) with
| Exported_id_term_type -> begin
terms
end
| Exported_id_field -> begin
...
let as_includes : 'Auu____9912 . 'Auu____9912 Prims.list FStar_Pervasives_Native.option  ->  'Auu____9912 Prims.list FStar_ST.ref = (fun uu___178_9924 -> (match (uu___178_9924) with
| FStar_Pervasives_Native.None -> begin
(FStar_Util.mk_ref [])
end
...
let uu____9959 = (FStar_Util.smap_try_find m mname)
in (FStar_Util.map_opt uu____9959 as_exported_ids)))
in (

let uu____9962 = (as_ids_opt env.exported_ids)
in (

let uu____9965 = (as_ids_opt env.trans_exported_ids)
in (

let uu____9968 = (

let uu____9973 = (FStar_Util.smap_try_find env.includes mname)
in (FStar_Util.map_opt uu____9973 (fun r -> (FStar_ST.op_Bang r))))
in {mii_exported_ids = uu____9962; mii_trans_exported_ids = uu____9965; mii_includes = uu____9968}))))))
...
let convert_kind = (fun uu___179_10081 -> (match (uu___179_10081) with
...
in (FStar_List.map (fun uu____10093 -> (match (uu____10093) with
| (lid, kind) -> begin
...
let uu____10122 = (FStar_Ident.lid_of_ids mname.FStar_Ident.ns)
in ((uu____10122), (Open_namespace)))
in (uu____10117)::[])
end
| uu____10131 -> begin
[]
...
let uu____10152 = (as_exported_id_set mii.mii_exported_ids)
in (FStar_Util.smap_add env1.exported_ids mname.FStar_Ident.str uu____10152));
(match (()) with
| () -> begin
((

let uu____10168 = (as_exported_id_set mii.mii_trans_exported_ids)
in (FStar_Util.smap_add env1.trans_exported_ids mname.FStar_Ident.str uu____10168));
(match (()) with
| () -> begin
((

let uu____10184 = (as_includes mii.mii_includes)
in (FStar_Util.smap_add env1.includes mname.FStar_Ident.str uu____10184));
(match (()) with
| () -> begin
(

let uu___199_10207 = env1
in (

let uu____10208 = (FStar_List.map (fun x -> Open_module_or_namespace (x)) auto_open2)
in {curmodule = FStar_Pervasives_Native.Some (mname); curmonad = uu___199_10207.curmonad; modules = uu___199_10207.modules; scope_mods = uu____10208; exported_ids = uu___199_10207.exported_ids; trans_exported_ids = uu___199_10207.trans_exported_ids; includes = uu___199_10207.includes; sigaccum = uu___199_10207.sigaccum; sigmap = env1.sigmap; iface = intf; admitted_iface = admitted; expect_typ = uu___199_10207.expect_typ; docs = uu___199_10207.docs; remaining_iface_decls = uu___199_10207.remaining_iface_decls; syntax_only = uu___199_10207.syntax_only}))
end);
)
end);
)
...
let uu____10213 = (FStar_All.pipe_right env.modules (FStar_Util.find_opt (fun uu____10239 -> (match (uu____10239) with
| (l, uu____10245) -> begin
...
let uu____10254 = (prep env)
in ((uu____10254), (false)))
end
| FStar_Pervasives_Native.Some (uu____10255, m) -> begin
((

let uu____10262 = ((

let uu____10265 = (FStar_Options.interactive ())
in (not (uu____10265))) && ((not (m.FStar_Syntax_Syntax.is_interface)) || intf))
...
let uu____10272 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in ((uu____10272), ((FStar_Ident.range_of_lid mname))))
in FStar_Errors.Error (uu____10267))
in (FStar_Exn.raise uu____10266))
end
| uu____10273 -> begin
()
end));
...
let uu___200_10285 = env
in {curmodule = uu___200_10285.curmodule; curmonad = FStar_Pervasives_Native.Some (mname); modules = uu___200_10285.modules; scope_mods = uu___200_10285.scope_mods; exported_ids = uu___200_10285.exported_ids; trans_exported_ids = uu___200_10285.trans_exported_ids; includes = uu___200_10285.includes; sigaccum = uu___200_10285.sigaccum; sigmap = uu___200_10285.sigmap; iface = uu___200_10285.iface; admitted_iface = uu___200_10285.admitted_iface; expect_typ = uu___200_10285.expect_typ; docs = uu___200_10285.docs; remaining_iface_decls = uu___200_10285.remaining_iface_decls; syntax_only = uu___200_10285.syntax_only})
end))


let fail_or : 'a . env  ->  (FStar_Ident.lident  ->  'a FStar_Pervasives_Native.option)  ->  FStar_Ident.lident  ->  'a = (fun env lookup lid -> (

let uu____10316 = (lookup lid)
in (match (uu____10316) with
| FStar_Pervasives_Native.None -> begin
(

let opened_modules = (FStar_List.map (fun uu____10329 -> (match (uu____10329) with
| (lid1, uu____10335) -> begin
...
let uu____10340 = (FStar_Ident.lid_of_ids lid.FStar_Ident.ns)
in (FStar_Ident.set_lid_range uu____10340 (FStar_Ident.range_of_lid lid)))
in (

let uu____10341 = (resolve_module_name env modul true)
