...
let uu___171_390 = env
in {curmodule = uu___171_390.curmodule; curmonad = uu___171_390.curmonad; modules = uu___171_390.modules; scope_mods = uu___171_390.scope_mods; exported_ids = uu___171_390.exported_ids; trans_exported_ids = uu___171_390.trans_exported_ids; includes = uu___171_390.includes; sigaccum = uu___171_390.sigaccum; sigmap = uu___171_390.sigmap; iface = b; admitted_iface = uu___171_390.admitted_iface; expect_typ = uu___171_390.expect_typ; docs = uu___171_390.docs; remaining_iface_decls = uu___171_390.remaining_iface_decls; syntax_only = uu___171_390.syntax_only}))
...
let uu___172_400 = e
in {curmodule = uu___172_400.curmodule; curmonad = uu___172_400.curmonad; modules = uu___172_400.modules; scope_mods = uu___172_400.scope_mods; exported_ids = uu___172_400.exported_ids; trans_exported_ids = uu___172_400.trans_exported_ids; includes = uu___172_400.includes; sigaccum = uu___172_400.sigaccum; sigmap = uu___172_400.sigmap; iface = uu___172_400.iface; admitted_iface = b; expect_typ = uu___172_400.expect_typ; docs = uu___172_400.docs; remaining_iface_decls = uu___172_400.remaining_iface_decls; syntax_only = uu___172_400.syntax_only}))
...
let uu___173_410 = e
in {curmodule = uu___173_410.curmodule; curmonad = uu___173_410.curmonad; modules = uu___173_410.modules; scope_mods = uu___173_410.scope_mods; exported_ids = uu___173_410.exported_ids; trans_exported_ids = uu___173_410.trans_exported_ids; includes = uu___173_410.includes; sigaccum = uu___173_410.sigaccum; sigmap = uu___173_410.sigmap; iface = uu___173_410.iface; admitted_iface = uu___173_410.admitted_iface; expect_typ = b; docs = uu___173_410.docs; remaining_iface_decls = uu___173_410.remaining_iface_decls; syntax_only = uu___173_410.syntax_only}))
...
let uu___174_446 = e
in {curmodule = Some (l); curmonad = uu___174_446.curmonad; modules = uu___174_446.modules; scope_mods = uu___174_446.scope_mods; exported_ids = uu___174_446.exported_ids; trans_exported_ids = uu___174_446.trans_exported_ids; includes = uu___174_446.includes; sigaccum = uu___174_446.sigaccum; sigmap = uu___174_446.sigmap; iface = uu___174_446.iface; admitted_iface = uu___174_446.admitted_iface; expect_typ = uu___174_446.expect_typ; docs = uu___174_446.docs; remaining_iface_decls = uu___174_446.remaining_iface_decls; syntax_only = uu___174_446.syntax_only}))
...
let uu___175_548 = env
in {curmodule = uu___175_548.curmodule; curmonad = uu___175_548.curmonad; modules = uu___175_548.modules; scope_mods = uu___175_548.scope_mods; exported_ids = uu___175_548.exported_ids; trans_exported_ids = uu___175_548.trans_exported_ids; includes = uu___175_548.includes; sigaccum = uu___175_548.sigaccum; sigmap = uu___175_548.sigmap; iface = uu___175_548.iface; admitted_iface = uu___175_548.admitted_iface; expect_typ = uu___175_548.expect_typ; docs = uu___175_548.docs; remaining_iface_decls = (((l), (ds)))::rest; syntax_only = uu___175_548.syntax_only})
end)))
...
let uu___176_576 = env
in {curmodule = uu___176_576.curmodule; curmonad = uu___176_576.curmonad; modules = uu___176_576.modules; scope_mods = uu___176_576.scope_mods; exported_ids = uu___176_576.exported_ids; trans_exported_ids = uu___176_576.trans_exported_ids; includes = uu___176_576.includes; sigaccum = uu___176_576.sigaccum; sigmap = uu___176_576.sigmap; iface = uu___176_576.iface; admitted_iface = uu___176_576.admitted_iface; expect_typ = uu___176_576.expect_typ; docs = uu___176_576.docs; remaining_iface_decls = uu___176_576.remaining_iface_decls; syntax_only = b}))
...
let uu___177_634 = bv.FStar_Syntax_Syntax.ppname
in {FStar_Ident.idText = uu___177_634.FStar_Ident.idText; FStar_Ident.idRange = r})
in (

let uu___178_635 = bv
in {FStar_Syntax_Syntax.ppname = id; FStar_Syntax_Syntax.index = uu___178_635.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___178_635.FStar_Syntax_Syntax.sort})))
...
let option_of_cont = (fun k_ignore uu___144_780 -> (match (uu___144_780) with
| Cont_ok (a) -> begin
Some (a)
end
| Cont_fail -> begin
...
let string_of_exported_id_kind : exported_id_kind  ->  Prims.string = (fun uu___145_866 -> (match (uu___145_866) with
| Exported_id_field -> begin
"field"
end
| Exported_id_term_type -> begin
...
let rec aux = (fun uu___146_915 -> (match (uu___146_915) with
| [] -> begin
...
let is_exported_id_field : exported_id_kind  ->  Prims.bool = (fun uu___147_973 -> (match (uu___147_973) with
| Exported_id_field -> begin
true
end
| uu____974 -> begin
...
let check_local_binding_id = (fun uu___148_1063 -> (match (uu___148_1063) with
| (id', uu____1065, uu____1066) -> begin
(id'.FStar_Ident.idText = id.FStar_Ident.idText)
end))
in (

let check_rec_binding_id = (fun uu___149_1070 -> (match (uu___149_1070) with
...
let proc = (fun uu___150_1081 -> (match (uu___150_1081) with
...
let rec aux = (fun uu___151_1098 -> (match (uu___151_1098) with
| (a)::q -> begin
(
...
let rec aux = (fun uu___152_1352 -> (match (uu___152_1352) with
| [] -> begin
(
...
let namespace_is_open : env  ->  FStar_Ident.lident  ->  Prims.bool = (fun env lid -> (FStar_List.existsb (fun uu___153_1418 -> (match (uu___153_1418) with
...
let cont_of_option = (fun k_none uu___154_1690 -> (match (uu___154_1690) with
| Some (v1) -> begin
Cont_ok (v1)
end
| None -> begin
...
let qopt = (FStar_Util.find_map quals (fun uu___155_1814 -> (match (uu___155_1814) with
...
let k_global_def = (fun source_lid uu___159_1885 -> (match (uu___159_1885) with
...
let uu____1954 = (any_val || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___156_1956 -> (match (uu___156_1956) with
...
let uu____1961 = ((FStar_Syntax_Util.is_primop_lid lid2) || ((ns_of_lid_equals lid2 FStar_Syntax_Const.prims_lid) && (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___157_1963 -> (match (uu___157_1963) with
...
let uu____1968 = (FStar_Util.find_map quals (fun uu___158_1970 -> (match (uu___158_1970) with
...
let k_global_def = (fun lid1 uu___160_2294 -> (match (uu___160_2294) with
...
let k_global_def = (fun lid1 uu___161_2373 -> (match (uu___161_2373) with
...
let k_global_def = (fun lid1 uu___162_2420 -> (match (uu___162_2420) with
...
let uu___179_2551 = env
in {curmodule = uu___179_2551.curmodule; curmonad = uu___179_2551.curmonad; modules = uu___179_2551.modules; scope_mods = []; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___179_2551.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___179_2551.sigaccum; sigmap = uu___179_2551.sigmap; iface = uu___179_2551.iface; admitted_iface = uu___179_2551.admitted_iface; expect_typ = uu___179_2551.expect_typ; docs = uu___179_2551.docs; remaining_iface_decls = uu___179_2551.remaining_iface_decls; syntax_only = uu___179_2551.syntax_only})
...
let k_global_def = (fun lid1 uu___164_2575 -> (match (uu___164_2575) with
...
let uu____2587 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___163_2589 -> (match (uu___163_2589) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____2590 -> begin
...
let k_global_def = (fun lid1 uu___165_2630 -> (match (uu___165_2630) with
...
let is_rec = (FStar_Util.for_some (fun uu___166_3300 -> (match (uu___166_3300) with
...
let find_dc = (fun dc -> (FStar_All.pipe_right sigs (FStar_Util.find_opt (fun uu___167_3311 -> (match (uu___167_3311) with
...
in (FStar_All.pipe_right sigs (FStar_List.iter (fun uu___168_3326 -> (match (uu___168_3326) with
...
in (fun uu___169_3655 -> (match (uu___169_3655) with
| Exported_id_term_type -> begin
term_type_set
end
| Exported_id_field -> begin
...
let filter_scope_mods = (fun uu___170_3675 -> (match (uu___170_3675) with
...
let uu___180_3679 = env
in (

let uu____3680 = (FStar_List.filter filter_scope_mods env.scope_mods)
in {curmodule = uu___180_3679.curmodule; curmonad = uu___180_3679.curmonad; modules = uu___180_3679.modules; scope_mods = uu____3680; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___180_3679.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___180_3679.sigaccum; sigmap = uu___180_3679.sigmap; iface = uu___180_3679.iface; admitted_iface = uu___180_3679.admitted_iface; expect_typ = uu___180_3679.expect_typ; docs = uu___180_3679.docs; remaining_iface_decls = uu___180_3679.remaining_iface_decls; syntax_only = uu___180_3679.syntax_only}))
in (
...
let uu___181_3699 = env
in {curmodule = uu___181_3699.curmodule; curmonad = uu___181_3699.curmonad; modules = uu___181_3699.modules; scope_mods = (scope_mod)::env.scope_mods; exported_ids = uu___181_3699.exported_ids; trans_exported_ids = uu___181_3699.trans_exported_ids; includes = uu___181_3699.includes; sigaccum = uu___181_3699.sigaccum; sigmap = uu___181_3699.sigmap; iface = uu___181_3699.iface; admitted_iface = uu___181_3699.admitted_iface; expect_typ = uu___181_3699.expect_typ; docs = uu___181_3699.docs; remaining_iface_decls = uu___181_3699.remaining_iface_decls; syntax_only = uu___181_3699.syntax_only}))
...
let uu___182_3816 = env
in {curmodule = uu___182_3816.curmodule; curmonad = uu___182_3816.curmonad; modules = uu___182_3816.modules; scope_mods = uu___182_3816.scope_mods; exported_ids = uu___182_3816.exported_ids; trans_exported_ids = uu___182_3816.trans_exported_ids; includes = uu___182_3816.includes; sigaccum = (s)::env.sigaccum; sigmap = uu___182_3816.sigmap; iface = uu___182_3816.iface; admitted_iface = uu___182_3816.admitted_iface; expect_typ = uu___182_3816.expect_typ; docs = uu___182_3816.docs; remaining_iface_decls = uu___182_3816.remaining_iface_decls; syntax_only = uu___182_3816.syntax_only});
)
end)))
end))
in (
...
let uu___183_3818 = env1
in (

let uu____3819 = (FStar_ST.read globals)
in {curmodule = uu___183_3818.curmodule; curmonad = uu___183_3818.curmonad; modules = uu___183_3818.modules; scope_mods = uu____3819; exported_ids = uu___183_3818.exported_ids; trans_exported_ids = uu___183_3818.trans_exported_ids; includes = uu___183_3818.includes; sigaccum = uu___183_3818.sigaccum; sigmap = uu___183_3818.sigmap; iface = uu___183_3818.iface; admitted_iface = uu___183_3818.admitted_iface; expect_typ = uu___183_3818.expect_typ; docs = uu___183_3818.docs; remaining_iface_decls = uu___183_3818.remaining_iface_decls; syntax_only = uu___183_3818.syntax_only}))
in (
...
let uu___184_3942 = env3
in (

let uu____3943 = (FStar_ST.read globals)
in {curmodule = uu___184_3942.curmodule; curmonad = uu___184_3942.curmonad; modules = uu___184_3942.modules; scope_mods = uu____3943; exported_ids = uu___184_3942.exported_ids; trans_exported_ids = uu___184_3942.trans_exported_ids; includes = uu___184_3942.includes; sigaccum = uu___184_3942.sigaccum; sigmap = uu___184_3942.sigmap; iface = uu___184_3942.iface; admitted_iface = uu___184_3942.admitted_iface; expect_typ = uu___184_3942.expect_typ; docs = uu___184_3942.docs; remaining_iface_decls = uu___184_3942.remaining_iface_decls; syntax_only = uu___184_3942.syntax_only}))
in env4);
)
end)))))))
...
let uu___185_4213 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (u), (t), ((FStar_Syntax_Syntax.Assumption)::quals))); FStar_Syntax_Syntax.sigrng = uu___185_4213.FStar_Syntax_Syntax.sigrng})), (false)));
)
end
...
let uu___186_4310 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp), ((FStar_Syntax_Syntax.Assumption)::quals))); FStar_Syntax_Syntax.sigrng = uu___186_4310.FStar_Syntax_Syntax.sigrng})
...
let uu___187_4405 = env
in {curmodule = None; curmonad = uu___187_4405.curmonad; modules = (((modul.FStar_Syntax_Syntax.name), (modul)))::env.modules; scope_mods = []; exported_ids = uu___187_4405.exported_ids; trans_exported_ids = uu___187_4405.trans_exported_ids; includes = uu___187_4405.includes; sigaccum = []; sigmap = uu___187_4405.sigmap; iface = uu___187_4405.iface; admitted_iface = uu___187_4405.admitted_iface; expect_typ = uu___187_4405.expect_typ; docs = uu___187_4405.docs; remaining_iface_decls = uu___187_4405.remaining_iface_decls; syntax_only = uu___187_4405.syntax_only})
end);
)
end);
));
...
in {curmodule = uu___188_4428.curmodule; curmonad = uu___188_4428.curmonad; modules = uu___188_4428.modules; scope_mods = uu___188_4428.scope_mods; exported_ids = uu___188_4428.exported_ids; trans_exported_ids = uu___188_4428.trans_exported_ids; includes = uu___188_4428.includes; sigaccum = uu___188_4428.sigaccum; sigmap = uu____4429; iface = uu___188_4428.iface; admitted_iface = uu___188_4428.admitted_iface; expect_typ = uu___188_4428.expect_typ; docs = uu____4435; remaining_iface_decls = uu___188_4428.remaining_iface_decls; syntax_only = uu___188_4428.syntax_only})));
))
...
let uu___189_4529 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (u), (t), ((FStar_Syntax_Syntax.Assumption)::q))); FStar_Syntax_Syntax.sigrng = uu___189_4529.FStar_Syntax_Syntax.sigrng})
end
| uu____4531 -> begin
se
end)
...
let uu___190_4597 = env1
in (

let uu____4598 = (FStar_List.map (fun lid -> Open_module_or_namespace (((lid), (Open_namespace)))) open_ns1)
in {curmodule = Some (mname); curmonad = uu___190_4597.curmonad; modules = uu___190_4597.modules; scope_mods = uu____4598; exported_ids = uu___190_4597.exported_ids; trans_exported_ids = uu___190_4597.trans_exported_ids; includes = uu___190_4597.includes; sigaccum = uu___190_4597.sigaccum; sigmap = env1.sigmap; iface = intf; admitted_iface = admitted; expect_typ = uu___190_4597.expect_typ; docs = uu___190_4597.docs; remaining_iface_decls = uu___190_4597.remaining_iface_decls; syntax_only = uu___190_4597.syntax_only}))
end);
)
end);
)
...
let uu___191_4645 = env
in {curmodule = uu___191_4645.curmodule; curmonad = Some (mname); modules = uu___191_4645.modules; scope_mods = uu___191_4645.scope_mods; exported_ids = uu___191_4645.exported_ids; trans_exported_ids = uu___191_4645.trans_exported_ids; includes = uu___191_4645.includes; sigaccum = uu___191_4645.sigaccum; sigmap = uu___191_4645.sigmap; iface = uu___191_4645.iface; admitted_iface = uu___191_4645.admitted_iface; expect_typ = uu___191_4645.expect_typ; docs = uu___191_4645.docs; remaining_iface_decls = uu___191_4645.remaining_iface_decls; syntax_only = uu___191_4645.syntax_only})
end))
