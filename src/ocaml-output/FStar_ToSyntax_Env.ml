...
let resolve_in_open_namespaces' env lid k_local_binding k_rec_binding
  ...
  let k_global_def' k lid1 def =
    let uu____1360 = k_global_def lid1 def in cont_of_option k uu____1360 in
  let f_module lid' =
                            ...
                            let uu____1588 =
                              let uu____1589 =
                                let uu____1592 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____1593 in
                                (uu____1592, false) in
    ...
    fun s  ->
      ...
      let uu____3394 =
        ...
        | FStar_Syntax_Syntax.Sig_bundle
            ...
            (env2, uu____3417)
        | uu____3431 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
  ...
  fun env  ->
    fun ns  ->
      ...
      | Some ns1 ->
          ...
          ((let uu____3573 = FStar_Util.smap_try_find env1.includes curmod in
            match uu____3573 with
            | None  -> ()
            | Some incl ->
                let uu____3586 =
                  let uu____3588 = FStar_ST.read incl in ns1 :: uu____3588 in
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____4223  ->
             ...
             | (lid1,uu____4227) -> FStar_Ident.text_of_lid lid1) env.modules in
      let msg =
