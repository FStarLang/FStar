...
let set_iface: env -> Prims.bool -> env =
  fun env  ->
    fun b  ->
      let uu___174_383 = env in
      {
        curmodule = (uu___174_383.curmodule);
        curmonad = (uu___174_383.curmonad);
        modules = (uu___174_383.modules);
        scope_mods = (uu___174_383.scope_mods);
        exported_ids = (uu___174_383.exported_ids);
        trans_exported_ids = (uu___174_383.trans_exported_ids);
        includes = (uu___174_383.includes);
        sigaccum = (uu___174_383.sigaccum);
        sigmap = (uu___174_383.sigmap);
        iface = b;
        admitted_iface = (uu___174_383.admitted_iface);
        expect_typ = (uu___174_383.expect_typ);
        docs = (uu___174_383.docs);
        remaining_iface_decls = (uu___174_383.remaining_iface_decls)
      }
let iface: env -> Prims.bool = fun e  -> e.iface
let set_admitted_iface: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___175_393 = e in
      {
        curmodule = (uu___175_393.curmodule);
        curmonad = (uu___175_393.curmonad);
        modules = (uu___175_393.modules);
        scope_mods = (uu___175_393.scope_mods);
        exported_ids = (uu___175_393.exported_ids);
        trans_exported_ids = (uu___175_393.trans_exported_ids);
        includes = (uu___175_393.includes);
        sigaccum = (uu___175_393.sigaccum);
        sigmap = (uu___175_393.sigmap);
        iface = (uu___175_393.iface);
        admitted_iface = b;
        expect_typ = (uu___175_393.expect_typ);
        docs = (uu___175_393.docs);
        remaining_iface_decls = (uu___175_393.remaining_iface_decls)
      }
let admitted_iface: env -> Prims.bool = fun e  -> e.admitted_iface
let set_expect_typ: env -> Prims.bool -> env =
  fun e  ->
    fun b  ->
      let uu___176_403 = e in
      {
        curmodule = (uu___176_403.curmodule);
        curmonad = (uu___176_403.curmonad);
        modules = (uu___176_403.modules);
        scope_mods = (uu___176_403.scope_mods);
        exported_ids = (uu___176_403.exported_ids);
        trans_exported_ids = (uu___176_403.trans_exported_ids);
        includes = (uu___176_403.includes);
        sigaccum = (uu___176_403.sigaccum);
        sigmap = (uu___176_403.sigmap);
        iface = (uu___176_403.iface);
        admitted_iface = (uu___176_403.admitted_iface);
        expect_typ = b;
        docs = (uu___176_403.docs);
        remaining_iface_decls = (uu___176_403.remaining_iface_decls)
      }
...
let set_current_module: env -> FStar_Ident.lident -> env =
  fun e  ->
    fun l  ->
      let uu___177_439 = e in
      {
        curmodule = (Some l);
        curmonad = (uu___177_439.curmonad);
        modules = (uu___177_439.modules);
        scope_mods = (uu___177_439.scope_mods);
        exported_ids = (uu___177_439.exported_ids);
        trans_exported_ids = (uu___177_439.trans_exported_ids);
        includes = (uu___177_439.includes);
        sigaccum = (uu___177_439.sigaccum);
        sigmap = (uu___177_439.sigmap);
        iface = (uu___177_439.iface);
        admitted_iface = (uu___177_439.admitted_iface);
        expect_typ = (uu___177_439.expect_typ);
        docs = (uu___177_439.docs);
        remaining_iface_decls = (uu___177_439.remaining_iface_decls)
      }
  ...
  fun env  ->
    fun l  ->
      fun ds  ->
        ...
        | (uu____523,rest) ->
            let uu___178_541 = env in
            {
              curmodule = (uu___178_541.curmodule);
              curmonad = (uu___178_541.curmonad);
              modules = (uu___178_541.modules);
              scope_mods = (uu___178_541.scope_mods);
              exported_ids = (uu___178_541.exported_ids);
              trans_exported_ids = (uu___178_541.trans_exported_ids);
              includes = (uu___178_541.includes);
              sigaccum = (uu___178_541.sigaccum);
              sigmap = (uu___178_541.sigmap);
              iface = (uu___178_541.iface);
              admitted_iface = (uu___178_541.admitted_iface);
              expect_typ = (uu___178_541.expect_typ);
              docs = (uu___178_541.docs);
...
let set_bv_range:
  ...
  fun bv  ->
    fun r  ->
      let id =
        let uu___179_617 = bv.FStar_Syntax_Syntax.ppname in
        {
          FStar_Ident.idText = (uu___179_617.FStar_Ident.idText);
          FStar_Ident.idRange = r
        } in
      let uu___180_618 = bv in
      {
        FStar_Syntax_Syntax.ppname = id;
        FStar_Syntax_Syntax.index = (uu___180_618.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___180_618.FStar_Syntax_Syntax.sort)
      }
let bv_to_name:
...
let option_of_cont k_ignore uu___147_763 =
  match uu___147_763 with
  | Cont_ok a -> Some a
  | Cont_fail  -> None
...
let find_in_module_with_includes eikind find_in_module find_in_module_default
  ...
  let rec aux uu___149_898 =
    match uu___149_898 with
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___155_1335 =
          match uu___155_1335 with
          | [] ->
...
let cont_of_option k_none uu___157_1656 =
  match uu___157_1656 with | Some v1 -> Cont_ok v1 | None  -> k_none
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___162_1851 =
            match uu___162_1851 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2260 =
        match uu___163_2260 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2339 =
        match uu___164_2339 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___165_2386 =
        match uu___165_2386 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___181_2517 = env in
        {
          curmodule = (uu___181_2517.curmodule);
          curmonad = (uu___181_2517.curmonad);
          modules = (uu___181_2517.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___181_2517.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___181_2517.sigaccum);
          sigmap = (uu___181_2517.sigmap);
          iface = (uu___181_2517.iface);
          admitted_iface = (uu___181_2517.admitted_iface);
          expect_typ = (uu___181_2517.expect_typ);
          docs = (uu___181_2517.docs);
          remaining_iface_decls = (uu___181_2517.remaining_iface_decls)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___167_2541 =
        match uu___167_2541 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___168_2596 =
        match uu___168_2596 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___173_3641 =
            match uu___173_3641 with
            | Rec_binding uu____3642 -> true
            | uu____3643 -> false in
          let this_env =
            let uu___182_3645 = env in
            let uu____3646 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___182_3645.curmodule);
              curmonad = (uu___182_3645.curmonad);
              modules = (uu___182_3645.modules);
              scope_mods = uu____3646;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___182_3645.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___182_3645.sigaccum);
              sigmap = (uu___182_3645.sigmap);
              iface = (uu___182_3645.iface);
              admitted_iface = (uu___182_3645.admitted_iface);
              expect_typ = (uu___182_3645.expect_typ);
              docs = (uu___182_3645.docs);
              remaining_iface_decls = (uu___182_3645.remaining_iface_decls)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___183_3665 = env in
      {
        curmodule = (uu___183_3665.curmodule);
        curmonad = (uu___183_3665.curmonad);
        modules = (uu___183_3665.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___183_3665.exported_ids);
        trans_exported_ids = (uu___183_3665.trans_exported_ids);
        includes = (uu___183_3665.includes);
        sigaccum = (uu___183_3665.sigaccum);
        sigmap = (uu___183_3665.sigmap);
        iface = (uu___183_3665.iface);
        admitted_iface = (uu___183_3665.admitted_iface);
        expect_typ = (uu___183_3665.expect_typ);
        docs = (uu___183_3665.docs);
        remaining_iface_decls = (uu___183_3665.remaining_iface_decls)
      }
let push_bv':
            ...
            (match uu____3768 with
             ...
             | uu____3777 ->
                 (extract_record env globals s;
                  (let uu___184_3782 = env in
                   {
                     curmodule = (uu___184_3782.curmodule);
                     curmonad = (uu___184_3782.curmonad);
                     modules = (uu___184_3782.modules);
                     scope_mods = (uu___184_3782.scope_mods);
                     exported_ids = (uu___184_3782.exported_ids);
                     trans_exported_ids = (uu___184_3782.trans_exported_ids);
                     includes = (uu___184_3782.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___184_3782.sigmap);
                     iface = (uu___184_3782.iface);
                     admitted_iface = (uu___184_3782.admitted_iface);
                     expect_typ = (uu___184_3782.expect_typ);
                     docs = (uu___184_3782.docs);
                     remaining_iface_decls =
                       (uu___184_3782.remaining_iface_decls)
                   }))) in
      let env2 =
        let uu___185_3784 = env1 in
        let uu____3785 = FStar_ST.read globals in
        {
          curmodule = (uu___185_3784.curmodule);
          curmonad = (uu___185_3784.curmonad);
          modules = (uu___185_3784.modules);
          scope_mods = uu____3785;
          exported_ids = (uu___185_3784.exported_ids);
          trans_exported_ids = (uu___185_3784.trans_exported_ids);
          includes = (uu___185_3784.includes);
          sigaccum = (uu___185_3784.sigaccum);
          sigmap = (uu___185_3784.sigmap);
          iface = (uu___185_3784.iface);
          admitted_iface = (uu___185_3784.admitted_iface);
          expect_typ = (uu___185_3784.expect_typ);
          docs = (uu___185_3784.docs);
          remaining_iface_decls = (uu___185_3784.remaining_iface_decls)
        } in
      let uu____3790 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___186_3908 = env3 in
              let uu____3909 = FStar_ST.read globals in
              {
                curmodule = (uu___186_3908.curmodule);
                curmonad = (uu___186_3908.curmonad);
                modules = (uu___186_3908.modules);
                scope_mods = uu____3909;
                exported_ids = (uu___186_3908.exported_ids);
                trans_exported_ids = (uu___186_3908.trans_exported_ids);
                includes = (uu___186_3908.includes);
                sigaccum = (uu___186_3908.sigaccum);
                sigmap = (uu___186_3908.sigmap);
                iface = (uu___186_3908.iface);
                admitted_iface = (uu___186_3908.admitted_iface);
                expect_typ = (uu___186_3908.expect_typ);
                docs = (uu___186_3908.docs);
                remaining_iface_decls = (uu___186_3908.remaining_iface_decls)
              } in
            env4))
                        ...
                        ((let uu___187_4179 = se in
                          {
                            ...
                            FStar_Syntax_Syntax.sigrng =
                              (uu___187_4179.FStar_Syntax_Syntax.sigrng)
                          }), false))
                 | Some uu____4181 -> ())
            | uu____4186 -> ()))
                                 ...
                                 FStar_Syntax_Syntax.sigel =
                                   (FStar_Syntax_Syntax.Sig_declare_typ
                                      (lid, (lb.FStar_Syntax_Syntax.lbunivs),
                                        ...
                                        quals)));
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___188_4276.FStar_Syntax_Syntax.sigrng)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___189_4371 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___189_4371.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___189_4371.exported_ids);
                    trans_exported_ids = (uu___189_4371.trans_exported_ids);
                    includes = (uu___189_4371.includes);
                    sigaccum = [];
                    sigmap = (uu___189_4371.sigmap);
                    iface = (uu___189_4371.iface);
                    admitted_iface = (uu___189_4371.admitted_iface);
                    expect_typ = (uu___189_4371.expect_typ);
                    docs = (uu___189_4371.docs);
                    remaining_iface_decls =
                      (uu___189_4371.remaining_iface_decls)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___190_4394 = env in
     let uu____4395 = FStar_Util.smap_copy (sigmap env) in
     let uu____4401 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___190_4394.curmodule);
       curmonad = (uu___190_4394.curmonad);
       modules = (uu___190_4394.modules);
       scope_mods = (uu___190_4394.scope_mods);
       exported_ids = (uu___190_4394.exported_ids);
       trans_exported_ids = (uu___190_4394.trans_exported_ids);
       includes = (uu___190_4394.includes);
       sigaccum = (uu___190_4394.sigaccum);
       sigmap = uu____4395;
       iface = (uu___190_4394.iface);
       admitted_iface = (uu___190_4394.admitted_iface);
       expect_typ = (uu___190_4394.expect_typ);
       docs = uu____4401;
       remaining_iface_decls = (uu___190_4394.remaining_iface_decls)
     })
                            ...
                            FStar_Syntax_Syntax.sigel =
                              (FStar_Syntax_Syntax.Sig_declare_typ
                                 (l, u, t, (FStar_Syntax_Syntax.Assumption ::
                                   q)));
                            FStar_Syntax_Syntax.sigrng =
                              (uu___191_4495.FStar_Syntax_Syntax.sigrng)
                          }
                      | uu____4497 -> se in
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___192_4563.curmonad);
                               modules = (uu___192_4563.modules);
                               scope_mods = uu____4564;
                               exported_ids = (uu___192_4563.exported_ids);
                               trans_exported_ids =
                                 (uu___192_4563.trans_exported_ids);
                               includes = (uu___192_4563.includes);
                               sigaccum = (uu___192_4563.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___192_4563.expect_typ);
                               docs = (uu___192_4563.docs);
                               remaining_iface_decls =
                                 (uu___192_4563.remaining_iface_decls)
                             }))))) in
          let uu____4567 =
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___193_4611 = env in
          {
            curmodule = (uu___193_4611.curmodule);
            curmonad = (Some mname);
            modules = (uu___193_4611.modules);
            scope_mods = (uu___193_4611.scope_mods);
            exported_ids = (uu___193_4611.exported_ids);
            trans_exported_ids = (uu___193_4611.trans_exported_ids);
            includes = (uu___193_4611.includes);
            sigaccum = (uu___193_4611.sigaccum);
            sigmap = (uu___193_4611.sigmap);
            iface = (uu___193_4611.iface);
            admitted_iface = (uu___193_4611.admitted_iface);
            expect_typ = (uu___193_4611.expect_typ);
            docs = (uu___193_4611.docs);
            remaining_iface_decls = (uu___193_4611.remaining_iface_decls)
          }
