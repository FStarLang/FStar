...
let uu___176_1426 = env
in {curmodule = uu___176_1426.curmodule; curmonad = uu___176_1426.curmonad; modules = uu___176_1426.modules; scope_mods = uu___176_1426.scope_mods; exported_ids = uu___176_1426.exported_ids; trans_exported_ids = uu___176_1426.trans_exported_ids; includes = uu___176_1426.includes; sigaccum = uu___176_1426.sigaccum; sigmap = uu___176_1426.sigmap; iface = b; admitted_iface = uu___176_1426.admitted_iface; expect_typ = uu___176_1426.expect_typ; docs = uu___176_1426.docs; remaining_iface_decls = uu___176_1426.remaining_iface_decls; syntax_only = uu___176_1426.syntax_only}))
...
let uu___177_1439 = e
in {curmodule = uu___177_1439.curmodule; curmonad = uu___177_1439.curmonad; modules = uu___177_1439.modules; scope_mods = uu___177_1439.scope_mods; exported_ids = uu___177_1439.exported_ids; trans_exported_ids = uu___177_1439.trans_exported_ids; includes = uu___177_1439.includes; sigaccum = uu___177_1439.sigaccum; sigmap = uu___177_1439.sigmap; iface = uu___177_1439.iface; admitted_iface = b; expect_typ = uu___177_1439.expect_typ; docs = uu___177_1439.docs; remaining_iface_decls = uu___177_1439.remaining_iface_decls; syntax_only = uu___177_1439.syntax_only}))
...
let uu___178_1452 = e
in {curmodule = uu___178_1452.curmodule; curmonad = uu___178_1452.curmonad; modules = uu___178_1452.modules; scope_mods = uu___178_1452.scope_mods; exported_ids = uu___178_1452.exported_ids; trans_exported_ids = uu___178_1452.trans_exported_ids; includes = uu___178_1452.includes; sigaccum = uu___178_1452.sigaccum; sigmap = uu___178_1452.sigmap; iface = uu___178_1452.iface; admitted_iface = uu___178_1452.admitted_iface; expect_typ = b; docs = uu___178_1452.docs; remaining_iface_decls = uu___178_1452.remaining_iface_decls; syntax_only = uu___178_1452.syntax_only}))
...
let uu___179_1669 = e
in {curmodule = FStar_Pervasives_Native.Some (l); curmonad = uu___179_1669.curmonad; modules = uu___179_1669.modules; scope_mods = uu___179_1669.scope_mods; exported_ids = uu___179_1669.exported_ids; trans_exported_ids = uu___179_1669.trans_exported_ids; includes = uu___179_1669.includes; sigaccum = uu___179_1669.sigaccum; sigmap = uu___179_1669.sigmap; iface = uu___179_1669.iface; admitted_iface = uu___179_1669.admitted_iface; expect_typ = uu___179_1669.expect_typ; docs = uu___179_1669.docs; remaining_iface_decls = uu___179_1669.remaining_iface_decls; syntax_only = uu___179_1669.syntax_only}))
...
let uu___180_1853 = env
in {curmodule = uu___180_1853.curmodule; curmonad = uu___180_1853.curmonad; modules = uu___180_1853.modules; scope_mods = uu___180_1853.scope_mods; exported_ids = uu___180_1853.exported_ids; trans_exported_ids = uu___180_1853.trans_exported_ids; includes = uu___180_1853.includes; sigaccum = uu___180_1853.sigaccum; sigmap = uu___180_1853.sigmap; iface = uu___180_1853.iface; admitted_iface = uu___180_1853.admitted_iface; expect_typ = uu___180_1853.expect_typ; docs = uu___180_1853.docs; remaining_iface_decls = (((l), (ds)))::rest; syntax_only = uu___180_1853.syntax_only})
end)))
...
let uu___181_1892 = env
in {curmodule = uu___181_1892.curmodule; curmonad = uu___181_1892.curmonad; modules = uu___181_1892.modules; scope_mods = uu___181_1892.scope_mods; exported_ids = uu___181_1892.exported_ids; trans_exported_ids = uu___181_1892.trans_exported_ids; includes = uu___181_1892.includes; sigaccum = uu___181_1892.sigaccum; sigmap = uu___181_1892.sigmap; iface = uu___181_1892.iface; admitted_iface = uu___181_1892.admitted_iface; expect_typ = uu___181_1892.expect_typ; docs = uu___181_1892.docs; remaining_iface_decls = uu___181_1892.remaining_iface_decls; syntax_only = b}))
...
let uu___182_1986 = bv.FStar_Syntax_Syntax.ppname
in {FStar_Ident.idText = uu___182_1986.FStar_Ident.idText; FStar_Ident.idRange = r})
in (

let uu___183_1987 = bv
in {FStar_Syntax_Syntax.ppname = id; FStar_Syntax_Syntax.index = uu___183_1987.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___183_1987.FStar_Syntax_Syntax.sort})))
...
let option_of_cont : 'a . (Prims.unit  ->  'a FStar_Pervasives_Native.option)  ->  'a cont_t  ->  'a FStar_Pervasives_Native.option = (fun k_ignore uu___148_2221 -> (match (uu___148_2221) with
| Cont_ok (a) -> begin
...
let string_of_exported_id_kind : exported_id_kind  ->  Prims.string = (fun uu___149_2344 -> (match (uu___149_2344) with
| Exported_id_field -> begin
"field"
end
| Exported_id_term_type -> begin
...
let rec aux = (fun uu___150_2407 -> (match (uu___150_2407) with
| [] -> begin
...
let is_exported_id_field : exported_id_kind  ->  Prims.bool = (fun uu___151_2687 -> (match (uu___151_2687) with
| Exported_id_field -> begin
true
end
| uu____2688 -> begin
...
let check_local_binding_id = (fun uu___152_2799 -> (match (uu___152_2799) with
| (id', uu____2801, uu____2802) -> begin
(id'.FStar_Ident.idText = id.FStar_Ident.idText)
end))
in (

let check_rec_binding_id = (fun uu___153_2806 -> (match (uu___153_2806) with
...
let proc = (fun uu___154_2819 -> (match (uu___154_2819) with
...
let rec aux = (fun uu___155_2840 -> (match (uu___155_2840) with
| (a)::q -> begin
(
...
let rec aux = (fun uu___156_3239 -> (match (uu___156_3239) with
| [] -> begin
(
...
let namespace_is_open : env  ->  FStar_Ident.lident  ->  Prims.bool = (fun env lid -> (FStar_List.existsb (fun uu___157_3331 -> (match (uu___157_3331) with
...
let cont_of_option : 'a . 'a cont_t  ->  'a FStar_Pervasives_Native.option  ->  'a cont_t = (fun k_none uu___158_3762 -> (match (uu___158_3762) with
| FStar_Pervasives_Native.Some (v1) -> begin
Cont_ok (v1)
end
| FStar_Pervasives_Native.None -> begin
...
let qopt = (FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals (fun uu___159_3932 -> (match (uu___159_3932) with
...
let k_global_def = (fun source_lid uu___163_4026 -> (match (uu___163_4026) with
...
let uu____4118 = (any_val || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___160_4122 -> (match (uu___160_4122) with
...
let uu____4128 = ((FStar_Syntax_Util.is_primop_lid lid2) || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___161_4133 -> (match (uu___161_4133) with
...
let uu____4142 = (FStar_Util.find_map quals (fun uu___162_4147 -> (match (uu___162_4147) with
...
let k_global_def = (fun lid1 uu___164_4666 -> (match (uu___164_4666) with
...
let k_global_def = (fun lid1 uu___165_4798 -> (match (uu___165_4798) with
...
let k_global_def = (fun lid1 uu___166_4866 -> (match (uu___166_4866) with
...
let uu___184_5056 = env
in {curmodule = uu___184_5056.curmodule; curmonad = uu___184_5056.curmonad; modules = uu___184_5056.modules; scope_mods = []; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___184_5056.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___184_5056.sigaccum; sigmap = uu___184_5056.sigmap; iface = uu___184_5056.iface; admitted_iface = uu___184_5056.admitted_iface; expect_typ = uu___184_5056.expect_typ; docs = uu___184_5056.docs; remaining_iface_decls = uu___184_5056.remaining_iface_decls; syntax_only = uu___184_5056.syntax_only})
...
let k_global_def = (fun lid1 uu___168_5089 -> (match (uu___168_5089) with
...
let uu____5108 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___167_5112 -> (match (uu___167_5112) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____5113 -> begin
...
let k_global_def = (fun lid1 uu___169_5178 -> (match (uu___169_5178) with
...
let is_record = (FStar_Util.for_some (fun uu___170_6498 -> (match (uu___170_6498) with
...
let find_dc = (fun dc -> (FStar_All.pipe_right sigs (FStar_Util.find_opt (fun uu___171_6539 -> (match (uu___171_6539) with
...
in (FStar_All.pipe_right sigs (FStar_List.iter (fun uu___172_6593 -> (match (uu___172_6593) with
...
let uu____7218 = (FStar_Util.new_set FStar_Util.compare FStar_Util.hashcode)
...
in (fun uu___173_7250 -> (match (uu___173_7250) with
| Exported_id_term_type -> begin
term_type_set
end
| Exported_id_field -> begin
...
let filter_scope_mods = (fun uu___174_7288 -> (match (uu___174_7288) with
...
let uu___185_7292 = env
in (

let uu____7293 = (FStar_List.filter filter_scope_mods env.scope_mods)
in {curmodule = uu___185_7292.curmodule; curmonad = uu___185_7292.curmonad; modules = uu___185_7292.modules; scope_mods = uu____7293; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___185_7292.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___185_7292.sigaccum; sigmap = uu___185_7292.sigmap; iface = uu___185_7292.iface; admitted_iface = uu___185_7292.admitted_iface; expect_typ = uu___185_7292.expect_typ; docs = uu___185_7292.docs; remaining_iface_decls = uu___185_7292.remaining_iface_decls; syntax_only = uu___185_7292.syntax_only}))
in (
...
let uu___186_7324 = env
in {curmodule = uu___186_7324.curmodule; curmonad = uu___186_7324.curmonad; modules = uu___186_7324.modules; scope_mods = (scope_mod)::env.scope_mods; exported_ids = uu___186_7324.exported_ids; trans_exported_ids = uu___186_7324.trans_exported_ids; includes = uu___186_7324.includes; sigaccum = uu___186_7324.sigaccum; sigmap = uu___186_7324.sigmap; iface = uu___186_7324.iface; admitted_iface = uu___186_7324.admitted_iface; expect_typ = uu___186_7324.expect_typ; docs = uu___186_7324.docs; remaining_iface_decls = uu___186_7324.remaining_iface_decls; syntax_only = uu___186_7324.syntax_only}))
...
let uu___187_7496 = env
in {curmodule = uu___187_7496.curmodule; curmonad = uu___187_7496.curmonad; modules = uu___187_7496.modules; scope_mods = uu___187_7496.scope_mods; exported_ids = uu___187_7496.exported_ids; trans_exported_ids = uu___187_7496.trans_exported_ids; includes = uu___187_7496.includes; sigaccum = (s)::env.sigaccum; sigmap = uu___187_7496.sigmap; iface = uu___187_7496.iface; admitted_iface = uu___187_7496.admitted_iface; expect_typ = uu___187_7496.expect_typ; docs = uu___187_7496.docs; remaining_iface_decls = uu___187_7496.remaining_iface_decls; syntax_only = uu___187_7496.syntax_only});
)
end)))
end))
in (
...
let uu___188_7498 = env1
in (

let uu____7499 = (FStar_ST.op_Bang globals)
in {curmodule = uu___188_7498.curmodule; curmonad = uu___188_7498.curmonad; modules = uu___188_7498.modules; scope_mods = uu____7499; exported_ids = uu___188_7498.exported_ids; trans_exported_ids = uu___188_7498.trans_exported_ids; includes = uu___188_7498.includes; sigaccum = uu___188_7498.sigaccum; sigmap = uu___188_7498.sigmap; iface = uu___188_7498.iface; admitted_iface = uu___188_7498.admitted_iface; expect_typ = uu___188_7498.expect_typ; docs = uu___188_7498.docs; remaining_iface_decls = uu___188_7498.remaining_iface_decls; syntax_only = uu___188_7498.syntax_only}))
in (
...
let uu___189_7836 = env3
in (

let uu____7837 = (FStar_ST.op_Bang globals)
in {curmodule = uu___189_7836.curmodule; curmonad = uu___189_7836.curmonad; modules = uu___189_7836.modules; scope_mods = uu____7837; exported_ids = uu___189_7836.exported_ids; trans_exported_ids = uu___189_7836.trans_exported_ids; includes = uu___189_7836.includes; sigaccum = uu___189_7836.sigaccum; sigmap = uu___189_7836.sigmap; iface = uu___189_7836.iface; admitted_iface = uu___189_7836.admitted_iface; expect_typ = uu___189_7836.expect_typ; docs = uu___189_7836.docs; remaining_iface_decls = uu___189_7836.remaining_iface_decls; syntax_only = uu___189_7836.syntax_only}))
in env4);
)
end)))))))
...
let uu___190_8573 = se
in {FStar_Syntax_Syntax.sigel = uu___190_8573.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___190_8573.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals; FStar_Syntax_Syntax.sigmeta = uu___190_8573.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___190_8573.FStar_Syntax_Syntax.sigattrs})), (false))));
)
end
...
let uu___191_8695 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp))); FStar_Syntax_Syntax.sigrng = uu___191_8695.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___191_8695.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___191_8695.FStar_Syntax_Syntax.sigattrs})
...
let uu___192_9039 = env
in {curmodule = FStar_Pervasives_Native.None; curmonad = uu___192_9039.curmonad; modules = (((modul.FStar_Syntax_Syntax.name), (modul)))::env.modules; scope_mods = []; exported_ids = uu___192_9039.exported_ids; trans_exported_ids = uu___192_9039.trans_exported_ids; includes = uu___192_9039.includes; sigaccum = []; sigmap = uu___192_9039.sigmap; iface = uu___192_9039.iface; admitted_iface = uu___192_9039.admitted_iface; expect_typ = uu___192_9039.expect_typ; docs = uu___192_9039.docs; remaining_iface_decls = uu___192_9039.remaining_iface_decls; syntax_only = uu___192_9039.syntax_only})
end);
)
end);
));
...
in {curmodule = uu___193_9105.curmodule; curmonad = uu___193_9105.curmonad; modules = uu___193_9105.modules; scope_mods = uu___193_9105.scope_mods; exported_ids = uu___193_9105.exported_ids; trans_exported_ids = uu___193_9105.trans_exported_ids; includes = uu___193_9105.includes; sigaccum = uu___193_9105.sigaccum; sigmap = uu____9106; iface = uu___193_9105.iface; admitted_iface = uu___193_9105.admitted_iface; expect_typ = uu___193_9105.expect_typ; docs = uu____9117; remaining_iface_decls = uu___193_9105.remaining_iface_decls; syntax_only = uu___193_9105.syntax_only})));
))
...
let uu___194_9307 = se
in {FStar_Syntax_Syntax.sigel = uu___194_9307.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___194_9307.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::se.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___194_9307.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___194_9307.FStar_Syntax_Syntax.sigattrs})
end
| uu____9308 -> begin
se
end)
...
let convert_kind = (fun uu___175_9372 -> (match (uu___175_9372) with
...
in (FStar_List.map (fun uu____9384 -> (match (uu____9384) with
| (lid, kind) -> begin
...
let uu____9413 = (FStar_Ident.lid_of_ids mname.FStar_Ident.ns)
in ((uu____9413), (Open_namespace)))
in (uu____9408)::[])
end
| uu____9422 -> begin
[]
...
let uu____9443 = (exported_id_set_new ())
in (FStar_Util.smap_add env1.exported_ids mname.FStar_Ident.str uu____9443));
(match (()) with
| () -> begin
((

let uu____9459 = (exported_id_set_new ())
in (FStar_Util.smap_add env1.trans_exported_ids mname.FStar_Ident.str uu____9459));
(match (()) with
| () -> begin
((

let uu____9475 = (FStar_Util.mk_ref [])
in (FStar_Util.smap_add env1.includes mname.FStar_Ident.str uu____9475));
(match (()) with
| () -> begin
(

let uu___195_9500 = env1
in (

let uu____9501 = (FStar_List.map (fun x -> Open_module_or_namespace (x)) auto_open2)
in {curmodule = FStar_Pervasives_Native.Some (mname); curmonad = uu___195_9500.curmonad; modules = uu___195_9500.modules; scope_mods = uu____9501; exported_ids = uu___195_9500.exported_ids; trans_exported_ids = uu___195_9500.trans_exported_ids; includes = uu___195_9500.includes; sigaccum = uu___195_9500.sigaccum; sigmap = env1.sigmap; iface = intf; admitted_iface = admitted; expect_typ = uu___195_9500.expect_typ; docs = uu___195_9500.docs; remaining_iface_decls = uu___195_9500.remaining_iface_decls; syntax_only = uu___195_9500.syntax_only}))
end);
)
end);
)
...
let uu____9506 = (FStar_All.pipe_right env.modules (FStar_Util.find_opt (fun uu____9532 -> (match (uu____9532) with
| (l, uu____9538) -> begin
...
let uu____9547 = (prep env)
in ((uu____9547), (false)))
end
| FStar_Pervasives_Native.Some (uu____9548, m) -> begin
((

let uu____9555 = ((

let uu____9558 = (FStar_Options.interactive ())
in (not (uu____9558))) && ((not (m.FStar_Syntax_Syntax.is_interface)) || intf))
...
let uu____9565 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in ((uu____9565), ((FStar_Ident.range_of_lid mname))))
in FStar_Errors.Error (uu____9560))
in (FStar_Exn.raise uu____9559))
end
| uu____9566 -> begin
()
end));
...
let uu___196_9578 = env
in {curmodule = uu___196_9578.curmodule; curmonad = FStar_Pervasives_Native.Some (mname); modules = uu___196_9578.modules; scope_mods = uu___196_9578.scope_mods; exported_ids = uu___196_9578.exported_ids; trans_exported_ids = uu___196_9578.trans_exported_ids; includes = uu___196_9578.includes; sigaccum = uu___196_9578.sigaccum; sigmap = uu___196_9578.sigmap; iface = uu___196_9578.iface; admitted_iface = uu___196_9578.admitted_iface; expect_typ = uu___196_9578.expect_typ; docs = uu___196_9578.docs; remaining_iface_decls = uu___196_9578.remaining_iface_decls; syntax_only = uu___196_9578.syntax_only})
end))


let fail_or : 'a . env  ->  (FStar_Ident.lident  ->  'a FStar_Pervasives_Native.option)  ->  FStar_Ident.lident  ->  'a = (fun env lookup lid -> (

let uu____9609 = (lookup lid)
in (match (uu____9609) with
| FStar_Pervasives_Native.None -> begin
(

let opened_modules = (FStar_List.map (fun uu____9622 -> (match (uu____9622) with
| (lid1, uu____9628) -> begin
...
let uu____9633 = (FStar_Ident.lid_of_ids lid.FStar_Ident.ns)
in (FStar_Ident.set_lid_range uu____9633 (FStar_Ident.range_of_lid lid)))
in (

let uu____9634 = (resolve_module_name env modul true)
