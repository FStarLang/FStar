...
let option_of_cont k_ignore uu___147_812 =
  match uu___147_812 with
  | Cont_ok a -> Some a
  | Cont_fail  -> None
...
let find_in_module_with_includes eikind find_in_module find_in_module_default
  ...
  let rec aux uu___149_947 =
    match uu___149_947 with
...
let is_exported_id_field : exported_id_kind -> Prims.bool =
  fun uu___150_1005  ->
    match uu___150_1005 with
    | Exported_id_field  -> true
    | uu____1006 -> false
  
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  find_in_module lookup_default_id =
  let check_local_binding_id uu___151_1095 =
    match uu___151_1095 with
    | (id',uu____1097,uu____1098) ->
        id'.FStar_Ident.idText = id.FStar_Ident.idText
     in
  let check_rec_binding_id uu___152_1102 =
    match uu___152_1102 with
  ...
  let curmod_ns =
    let uu____1108 = current_module env  in FStar_Ident.ids_of_lid uu____1108
     in
  let proc uu___153_1113 =
    match uu___153_1113 with
...
let find_in_module env lid k_global_def k_not_found =
  let uu____1204 = FStar_Util.smap_try_find (sigmap env) lid.FStar_Ident.str
     in
    ...
    fun id  ->
      ...
      | uu____1240 ->
          try_lookup_id'' env id Exported_id_term_type
            (fun r  ->
               let uu____1247 = found_local_binding id.FStar_Ident.idRange r
                  in
...
let lookup_default_id env id k_global_def k_not_found =
  ...
  | Some v1 -> v1
  | None  ->
      let lid = let uu____1351 = current_module env  in qual uu____1351 id
         in
  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___155_1384 =
          match uu___155_1384 with
          | [] ->
        ...
        let uu____1548 =
          is_full_path &&
            (let uu____1549 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____1549)
           in
        if uu____1548
        then (ids, [])
        else
  ...
  | uu____1696::uu____1697 ->
      let uu____1699 =
        let uu____1701 =
          ...
          FStar_Ident.set_lid_range uu____1702 (FStar_Ident.range_of_lid lid)
           in
...
let cont_of_option k_none uu___157_1722 =
  match uu___157_1722 with | Some v1 -> Cont_ok v1 | None  -> k_none 
let resolve_in_open_namespaces' env lid k_local_binding k_rec_binding
  k_global_def =
  let k_global_def' k lid1 def =
    let uu____1801 = k_global_def lid1 def  in cont_of_option k uu____1801
     in
  let f_module lid' =
      ...
      let uu____1868 =
        FStar_Util.find_map lbs
          (fun lb  ->
             ...
             if uu____1872 then Some fv else None)
         in
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___162_1911 =
            match uu___162_1911 with
                     ...
                     let uu____1941 =
                       let uu____1942 =
                         let uu____1945 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____1946
                            in
                         (uu____1945, false)  in
                            ...
                            let uu____2007 =
                              let uu____2008 =
                                let uu____2011 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____2012
                                   in
                                (uu____2011, false)  in
...
let lookup_letbinding_quals :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2319 =
        match uu___163_2319 with
        | ({
      ...
      let uu____2337 =
        resolve_in_open_namespaces' env lid (fun uu____2341  -> None)
          (fun uu____2343  -> None) k_global_def
         in
...
let try_lookup_let :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2398 =
        match uu___164_2398 with
        | ({
...
let try_lookup_definition :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___165_2445 =
        match uu___165_2445 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve :
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___182_2576 = env  in
        {
          curmodule = (uu___182_2576.curmodule);
          curmonad = (uu___182_2576.curmonad);
          modules = (uu___182_2576.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___182_2576.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___182_2576.sigaccum);
          sigmap = (uu___182_2576.sigmap);
          iface = (uu___182_2576.iface);
          admitted_iface = (uu___182_2576.admitted_iface);
          expect_typ = (uu___182_2576.expect_typ);
          docs = (uu___182_2576.docs);
          remaining_iface_decls = (uu___182_2576.remaining_iface_decls);
          syntax_only = (uu___182_2576.syntax_only)
        }  in
...
let try_lookup_datacon :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___167_2600 =
        match uu___167_2600 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___168_2656 =
        match uu___168_2656 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let record_cache_aux_with_filter :
  ...
  let push1 uu____2718 =
    let uu____2719 =
      ...
      let uu____2732 = FStar_ST.read record_cache  in uu____2722 ::
        uu____2732
       in
    FStar_ST.write record_cache uu____2719  in
  let pop1 uu____2747 =
    let uu____2748 =
      let uu____2751 = FStar_ST.read record_cache  in
      FStar_List.tl uu____2751  in
    FStar_ST.write record_cache uu____2748  in
  let peek1 uu____2767 =
    let uu____2768 = FStar_ST.read record_cache  in FStar_List.hd uu____2768
     in
  let insert r =
    let uu____2780 =
      let uu____2783 = let uu____2785 = peek1 ()  in r :: uu____2785  in
      let uu____2787 =
     ...
     | () ->
         ...
         let uu____2841 =
           let uu____2844 = FStar_ST.read record_cache  in filtered ::
             uu____2844
            in
         FStar_ST.write record_cache uu____2841)
     in
...
let peek_record_cache : Prims.unit -> record_or_dc Prims.list =
  ...
  | (uu____3175,uu____3176,peek1,uu____3178,uu____3179) -> peek1 
      ...
      fun se  ->
        ...
        | FStar_Syntax_Syntax.Sig_bundle (sigs,uu____3314) ->
            ...
            FStar_All.pipe_right sigs
              (FStar_List.iter
                 (fun uu___171_3357  ->
                    match uu___171_3357 with
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename,univs1,parms,uu____3361,uu____3362,dc::[]);
                                                             ...
                                                             let uu____3537 =
                                                               let uu____3538
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____3538.FStar_Ident.ident
                                                                in
                                                             uu____3537.FStar_Ident.idText
                                                              in
                                                           let uu____3540 =
                                                             let uu____3541 =
                                                               FStar_ST.read
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map uu____3579
              (fun record  ->
                 ...
                 option_of_cont (fun uu____3585  -> None) uu____3582)
         in
...
let try_lookup_record_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3602 = try_lookup_record_or_dc_by_field_name env fieldname
         in
        ...
        | Some record' when
            ...
            let uu____3626 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____3628  -> Cont_ok ())
               in
...
let try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3643 = try_lookup_record_or_dc_by_field_name env fieldname
         in
...
let unique :
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___173_3706 =
            match uu___173_3706 with
            | Rec_binding uu____3707 -> true
            | uu____3708 -> false  in
          let this_env =
            let uu___183_3710 = env  in
            let uu____3711 =
              FStar_List.filter filter_scope_mods env.scope_mods  in
            {
              curmodule = (uu___183_3710.curmodule);
              curmonad = (uu___183_3710.curmonad);
              modules = (uu___183_3710.modules);
              scope_mods = uu____3711;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___183_3710.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___183_3710.sigaccum);
              sigmap = (uu___183_3710.sigmap);
              iface = (uu___183_3710.iface);
              admitted_iface = (uu___183_3710.admitted_iface);
              expect_typ = (uu___183_3710.expect_typ);
              docs = (uu___183_3710.docs);
              remaining_iface_decls = (uu___183_3710.remaining_iface_decls);
              syntax_only = (uu___183_3710.syntax_only)
            }  in
          let uu____3713 = try_lookup_lid' any_val exclude_if this_env lid
             in
...
let push_scope_mod : env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___184_3730 = env  in
      {
        curmodule = (uu___184_3730.curmodule);
        curmonad = (uu___184_3730.curmonad);
        modules = (uu___184_3730.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___184_3730.exported_ids);
        trans_exported_ids = (uu___184_3730.trans_exported_ids);
        includes = (uu___184_3730.includes);
        sigaccum = (uu___184_3730.sigaccum);
        sigmap = (uu___184_3730.sigmap);
        iface = (uu___184_3730.iface);
        admitted_iface = (uu___184_3730.admitted_iface);
        expect_typ = (uu___184_3730.expect_typ);
        docs = (uu___184_3730.docs);
        remaining_iface_decls = (uu___184_3730.remaining_iface_decls);
        syntax_only = (uu___184_3730.syntax_only)
      }
            ...
            let uu____3829 =
              FStar_Util.find_map lids
                (fun l  ->
                   ...
                   if uu____3832 then Some l else None)
               in
            (match uu____3829 with
             ...
             | uu____3838 ->
                 (extract_record env globals s;
                  (let uu___185_3843 = env  in
                   {
                     curmodule = (uu___185_3843.curmodule);
                     curmonad = (uu___185_3843.curmonad);
                     modules = (uu___185_3843.modules);
                     scope_mods = (uu___185_3843.scope_mods);
                     exported_ids = (uu___185_3843.exported_ids);
                     trans_exported_ids = (uu___185_3843.trans_exported_ids);
                     includes = (uu___185_3843.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___185_3843.sigmap);
                     iface = (uu___185_3843.iface);
                     admitted_iface = (uu___185_3843.admitted_iface);
                     expect_typ = (uu___185_3843.expect_typ);
                     docs = (uu___185_3843.docs);
                     remaining_iface_decls =
                       (uu___185_3843.remaining_iface_decls);
                     syntax_only = (uu___185_3843.syntax_only)
                   })))
         in
      let env2 =
        let uu___186_3845 = env1  in
        let uu____3846 = FStar_ST.read globals  in
        {
          curmodule = (uu___186_3845.curmodule);
          curmonad = (uu___186_3845.curmonad);
          modules = (uu___186_3845.modules);
          scope_mods = uu____3846;
          exported_ids = (uu___186_3845.exported_ids);
          trans_exported_ids = (uu___186_3845.trans_exported_ids);
          includes = (uu___186_3845.includes);
          sigaccum = (uu___186_3845.sigaccum);
          sigmap = (uu___186_3845.sigmap);
          iface = (uu___186_3845.iface);
          admitted_iface = (uu___186_3845.admitted_iface);
          expect_typ = (uu___186_3845.expect_typ);
          docs = (uu___186_3845.docs);
          remaining_iface_decls = (uu___186_3845.remaining_iface_decls);
          syntax_only = (uu___186_3845.syntax_only)
        }  in
      let uu____3851 =
        match s.FStar_Syntax_Syntax.sigel with
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3865) ->
            let uu____3870 =
              FStar_List.map
               ...
               in
            (env2, uu____3870)
        | uu____3884 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___187_3966 = env3  in
              let uu____3967 = FStar_ST.read globals  in
              {
                curmodule = (uu___187_3966.curmodule);
                curmonad = (uu___187_3966.curmonad);
                modules = (uu___187_3966.modules);
                scope_mods = uu____3967;
                exported_ids = (uu___187_3966.exported_ids);
                trans_exported_ids = (uu___187_3966.trans_exported_ids);
                includes = (uu___187_3966.includes);
                sigaccum = (uu___187_3966.sigaccum);
                sigmap = (uu___187_3966.sigmap);
                iface = (uu___187_3966.iface);
                admitted_iface = (uu___187_3966.admitted_iface);
                expect_typ = (uu___187_3966.expect_typ);
                docs = (uu___187_3966.docs);
                remaining_iface_decls = (uu___187_3966.remaining_iface_decls);
                syntax_only = (uu___187_3966.syntax_only)
              }  in
            env4))
      ...
      | Some ns1 ->
          (fail_if_curmodule env ns0 ns1;
           (let env1 =
            ...
            (let uu____4029 = FStar_Util.smap_try_find env1.includes curmod
                in
             match uu____4029 with
             | None  -> ()
             | Some incl ->
                 let uu____4042 =
                   let uu____4044 = FStar_ST.read incl  in ns1 :: uu____4044
                    in
             ...
             | () ->
                 ...
                 (match uu____4052 with
                  | Some ns_trans_exports ->
                      ((let uu____4065 =
                          let uu____4076 = get_exported_id_set env1 curmod
                             in
                          let uu____4081 =
                        ...
                        | (Some cur_exports,Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____4130 =
                                 ...
                                 FStar_Util.set_difference uu____4131 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____4141 =
                                     let uu____4142 = FStar_ST.read trans_ex
                                        in
                                     FStar_Util.set_union uu____4142 ns_ex
                                      in
                                   FStar_ST.write trans_ex uu____4141)
                               in
            ...
            ((let uu____4204 =
              ...
              | Some old_doc ->
                  let uu____4207 =
                    ...
                    let uu____4209 = FStar_Parser_AST.string_of_fsdoc old_doc
                       in
                    let uu____4210 = FStar_Parser_AST.string_of_fsdoc doc1
                       in
                    FStar_Util.format3
                      "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                      uu____4208 uu____4209 uu____4210
                     in
                     ...
                     ((let uu____4226 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___188_4236 = se  in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___188_4236.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___188_4236.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___188_4236.FStar_Syntax_Syntax.sigmeta)
                           }), false)))
                 | Some uu____4237 -> ())
            | uu____4242 -> ()))
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___189_4324 = se  in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___189_4324.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___189_4324.FStar_Syntax_Syntax.sigmeta)
                               }  in
              ...
              | uu____4331 -> ()));
      (let curmod =
         let uu____4333 = current_module env  in uu____4333.FStar_Ident.str
          in
       (let uu____4335 =
        ...
        | (Some cur_ex,Some cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____4391 = cur_ex eikind  in FStar_ST.read uu____4391
                 in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___190_4418 = env  in
                  {
                    curmodule = None;
                    curmonad = (uu___190_4418.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___190_4418.exported_ids);
                    trans_exported_ids = (uu___190_4418.trans_exported_ids);
                    includes = (uu___190_4418.includes);
                    sigaccum = [];
                    sigmap = (uu___190_4418.sigmap);
                    iface = (uu___190_4418.iface);
                    admitted_iface = (uu___190_4418.admitted_iface);
                    expect_typ = (uu___190_4418.expect_typ);
                    docs = (uu___190_4418.docs);
                    remaining_iface_decls =
                      (uu___190_4418.remaining_iface_decls);
                    syntax_only = (uu___190_4418.syntax_only)
                  }))))
...
let push : env -> env =
  fun env  ->
    ...
    (let uu___191_4441 = env  in
     let uu____4442 = FStar_Util.smap_copy (sigmap env)  in
     let uu____4448 = FStar_Util.smap_copy env.docs  in
     {
       curmodule = (uu___191_4441.curmodule);
       curmonad = (uu___191_4441.curmonad);
       modules = (uu___191_4441.modules);
       scope_mods = (uu___191_4441.scope_mods);
       exported_ids = (uu___191_4441.exported_ids);
       trans_exported_ids = (uu___191_4441.trans_exported_ids);
       includes = (uu___191_4441.includes);
       sigaccum = (uu___191_4441.sigaccum);
       sigmap = uu____4442;
       iface = (uu___191_4441.iface);
       admitted_iface = (uu___191_4441.admitted_iface);
       expect_typ = (uu___191_4441.expect_typ);
       docs = uu____4448;
       remaining_iface_decls = (uu___191_4441.remaining_iface_decls);
       syntax_only = (uu___191_4441.syntax_only)
     })
              ...
              | Some (se,true ) when sigelt_in_m se ->
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___192_4539 = se  in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___192_4539.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___192_4539.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___192_4539.FStar_Syntax_Syntax.sigmeta)
                          }
                      | uu____4540 -> se  in
        ...
        fun mname  ->
                        ...
                        (match () with
                         | () ->
                                ...
                                in
                             {
                               ...
                               curmonad = (uu___193_4606.curmonad);
                               modules = (uu___193_4606.modules);
                               scope_mods = uu____4607;
                               exported_ids = (uu___193_4606.exported_ids);
                               trans_exported_ids =
                                 (uu___193_4606.trans_exported_ids);
                               includes = (uu___193_4606.includes);
                               sigaccum = (uu___193_4606.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___193_4606.expect_typ);
                               docs = (uu___193_4606.docs);
                               remaining_iface_decls =
                                 (uu___193_4606.remaining_iface_decls);
                               syntax_only = (uu___193_4606.syntax_only)
                             })))))
             in
          let uu____4610 =
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4622  ->
                    ...
                    | (l,uu____4626) -> FStar_Ident.lid_equals l mname))
             in
          ...
          | Some (uu____4632,m) ->
              ((let uu____4637 =
               ...
               (let uu____4645 =
                  let uu____4646 = push env  in prep uu____4646  in
                (uu____4645, true)))
...
let enter_monad_scope : env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___194_4654 = env  in
          {
            curmodule = (uu___194_4654.curmodule);
            curmonad = (Some mname);
            modules = (uu___194_4654.modules);
            scope_mods = (uu___194_4654.scope_mods);
            exported_ids = (uu___194_4654.exported_ids);
            trans_exported_ids = (uu___194_4654.trans_exported_ids);
            includes = (uu___194_4654.includes);
            sigaccum = (uu___194_4654.sigaccum);
            sigmap = (uu___194_4654.sigmap);
            iface = (uu___194_4654.iface);
            admitted_iface = (uu___194_4654.admitted_iface);
            expect_typ = (uu___194_4654.expect_typ);
            docs = (uu___194_4654.docs);
            remaining_iface_decls = (uu___194_4654.remaining_iface_decls);
            syntax_only = (uu___194_4654.syntax_only)
          }
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____4685  ->
             ...
             | (lid1,uu____4689) -> FStar_Ident.text_of_lid lid1) env.modules
         in
      let msg =
