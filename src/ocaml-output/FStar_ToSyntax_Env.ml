  ...
  fun env  ->
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___154_1384 =
          match uu___154_1384 with
          | [] ->
...
let cont_of_option k_none uu___156_1722 =
  match uu___156_1722 with | Some v1 -> Cont_ok v1 | None  -> k_none
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___161_1911 =
            match uu___161_1911 with
...
let lookup_letbinding_quals:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___162_2319 =
        match uu___162_2319 with
        | ({
...
let try_lookup_let:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2398 =
        match uu___163_2398 with
        | ({
...
let try_lookup_definition:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___164_2445 =
        match uu___164_2445 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
...
let try_lookup_lid_no_resolve:
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___181_2576 = env in
        {
          curmodule = (uu___181_2576.curmodule);
          curmonad = (uu___181_2576.curmonad);
          modules = (uu___181_2576.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___181_2576.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___181_2576.sigaccum);
          sigmap = (uu___181_2576.sigmap);
          iface = (uu___181_2576.iface);
          admitted_iface = (uu___181_2576.admitted_iface);
          expect_typ = (uu___181_2576.expect_typ);
          docs = (uu___181_2576.docs);
          remaining_iface_decls = (uu___181_2576.remaining_iface_decls);
          syntax_only = (uu___181_2576.syntax_only)
        } in
...
let try_lookup_datacon:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_2600 =
        match uu___166_2600 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
...
let find_all_datacons:
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___167_2656 =
        match uu___167_2656 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let unique:
  ...
  fun any_val  ->
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___172_3706 =
            match uu___172_3706 with
            | Rec_binding uu____3707 -> true
            | uu____3708 -> false in
          let this_env =
            let uu___182_3710 = env in
            let uu____3711 =
              FStar_List.filter filter_scope_mods env.scope_mods in
            {
              curmodule = (uu___182_3710.curmodule);
              curmonad = (uu___182_3710.curmonad);
              modules = (uu___182_3710.modules);
              scope_mods = uu____3711;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___182_3710.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___182_3710.sigaccum);
              sigmap = (uu___182_3710.sigmap);
              iface = (uu___182_3710.iface);
              admitted_iface = (uu___182_3710.admitted_iface);
              expect_typ = (uu___182_3710.expect_typ);
              docs = (uu___182_3710.docs);
              remaining_iface_decls = (uu___182_3710.remaining_iface_decls);
              syntax_only = (uu___182_3710.syntax_only)
            } in
...
let push_scope_mod: env -> scope_mod -> env =
  fun env  ->
    fun scope_mod  ->
      let uu___183_3730 = env in
      {
        curmodule = (uu___183_3730.curmodule);
        curmonad = (uu___183_3730.curmonad);
        modules = (uu___183_3730.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___183_3730.exported_ids);
        trans_exported_ids = (uu___183_3730.trans_exported_ids);
        includes = (uu___183_3730.includes);
        sigaccum = (uu___183_3730.sigaccum);
        sigmap = (uu___183_3730.sigmap);
        iface = (uu___183_3730.iface);
        admitted_iface = (uu___183_3730.admitted_iface);
        expect_typ = (uu___183_3730.expect_typ);
        docs = (uu___183_3730.docs);
        remaining_iface_decls = (uu___183_3730.remaining_iface_decls);
        syntax_only = (uu___183_3730.syntax_only)
      }
let push_bv':
            ...
            (match uu____3829 with
             ...
             | uu____3838 ->
                 (extract_record env globals s;
                  (let uu___184_3843 = env in
                   {
                     curmodule = (uu___184_3843.curmodule);
                     curmonad = (uu___184_3843.curmonad);
                     modules = (uu___184_3843.modules);
                     scope_mods = (uu___184_3843.scope_mods);
                     exported_ids = (uu___184_3843.exported_ids);
                     trans_exported_ids = (uu___184_3843.trans_exported_ids);
                     includes = (uu___184_3843.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___184_3843.sigmap);
                     iface = (uu___184_3843.iface);
                     admitted_iface = (uu___184_3843.admitted_iface);
                     expect_typ = (uu___184_3843.expect_typ);
                     docs = (uu___184_3843.docs);
                     remaining_iface_decls =
                       (uu___184_3843.remaining_iface_decls);
                     syntax_only = (uu___184_3843.syntax_only)
                   }))) in
      let env2 =
        let uu___185_3845 = env1 in
        let uu____3846 = FStar_ST.read globals in
        {
          curmodule = (uu___185_3845.curmodule);
          curmonad = (uu___185_3845.curmonad);
          modules = (uu___185_3845.modules);
          scope_mods = uu____3846;
          exported_ids = (uu___185_3845.exported_ids);
          trans_exported_ids = (uu___185_3845.trans_exported_ids);
          includes = (uu___185_3845.includes);
          sigaccum = (uu___185_3845.sigaccum);
          sigmap = (uu___185_3845.sigmap);
          iface = (uu___185_3845.iface);
          admitted_iface = (uu___185_3845.admitted_iface);
          expect_typ = (uu___185_3845.expect_typ);
          docs = (uu___185_3845.docs);
          remaining_iface_decls = (uu___185_3845.remaining_iface_decls);
          syntax_only = (uu___185_3845.syntax_only)
        } in
      let uu____3851 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___186_3966 = env3 in
              let uu____3967 = FStar_ST.read globals in
              {
                curmodule = (uu___186_3966.curmodule);
                curmonad = (uu___186_3966.curmonad);
                modules = (uu___186_3966.modules);
                scope_mods = uu____3967;
                exported_ids = (uu___186_3966.exported_ids);
                trans_exported_ids = (uu___186_3966.trans_exported_ids);
                includes = (uu___186_3966.includes);
                sigaccum = (uu___186_3966.sigaccum);
                sigmap = (uu___186_3966.sigmap);
                iface = (uu___186_3966.iface);
                admitted_iface = (uu___186_3966.admitted_iface);
                expect_typ = (uu___186_3966.expect_typ);
                docs = (uu___186_3966.docs);
                remaining_iface_decls = (uu___186_3966.remaining_iface_decls);
                syntax_only = (uu___186_3966.syntax_only)
              } in
            env4))
                     ...
                     ((let uu____4226 =
                      ...
                      (let quals = FStar_Syntax_Syntax.Assumption ::
                       ...
                       FStar_Util.smap_add (sigmap env) l.FStar_Ident.str
                         ((let uu___187_4236 = se in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (uu___187_4236.FStar_Syntax_Syntax.sigel);
                             FStar_Syntax_Syntax.sigrng =
                               (uu___187_4236.FStar_Syntax_Syntax.sigrng);
                             FStar_Syntax_Syntax.sigquals = quals;
                             FStar_Syntax_Syntax.sigmeta =
                               (uu___187_4236.FStar_Syntax_Syntax.sigmeta)
                           }), false)))
                 | Some uu____4237 -> ())
            | uu____4242 -> ()))
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___188_4324 = se in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___188_4324.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___188_4324.FStar_Syntax_Syntax.sigmeta)
                               } in
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___189_4418 = env in
                  {
                    curmodule = None;
                    curmonad = (uu___189_4418.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___189_4418.exported_ids);
                    trans_exported_ids = (uu___189_4418.trans_exported_ids);
                    includes = (uu___189_4418.includes);
                    sigaccum = [];
                    sigmap = (uu___189_4418.sigmap);
                    iface = (uu___189_4418.iface);
                    admitted_iface = (uu___189_4418.admitted_iface);
                    expect_typ = (uu___189_4418.expect_typ);
                    docs = (uu___189_4418.docs);
                    remaining_iface_decls =
                      (uu___189_4418.remaining_iface_decls);
                    syntax_only = (uu___189_4418.syntax_only)
                  }))))
...
let push: env -> env =
  fun env  ->
    ...
    (let uu___190_4441 = env in
     let uu____4442 = FStar_Util.smap_copy (sigmap env) in
     let uu____4448 = FStar_Util.smap_copy env.docs in
     {
       curmodule = (uu___190_4441.curmodule);
       curmonad = (uu___190_4441.curmonad);
       modules = (uu___190_4441.modules);
       scope_mods = (uu___190_4441.scope_mods);
       exported_ids = (uu___190_4441.exported_ids);
       trans_exported_ids = (uu___190_4441.trans_exported_ids);
       includes = (uu___190_4441.includes);
       sigaccum = (uu___190_4441.sigaccum);
       sigmap = uu____4442;
       iface = (uu___190_4441.iface);
       admitted_iface = (uu___190_4441.admitted_iface);
       expect_typ = (uu___190_4441.expect_typ);
       docs = uu____4448;
       remaining_iface_decls = (uu___190_4441.remaining_iface_decls);
       syntax_only = (uu___190_4441.syntax_only)
     })
              ...
              | Some (se,true ) when sigelt_in_m se ->
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      match se.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___191_4539 = se in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___191_4539.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___191_4539.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___191_4539.FStar_Syntax_Syntax.sigmeta)
                          }
                      | uu____4540 -> se in
                        ...
                        (match () with
                         | () ->
                                      ...
                                      (lid, Open_namespace)) open_ns1 in
                             {
                               ...
                               curmonad = (uu___192_4606.curmonad);
                               modules = (uu___192_4606.modules);
                               scope_mods = uu____4607;
                               exported_ids = (uu___192_4606.exported_ids);
                               trans_exported_ids =
                                 (uu___192_4606.trans_exported_ids);
                               includes = (uu___192_4606.includes);
                               sigaccum = (uu___192_4606.sigaccum);
                               sigmap = (env1.sigmap);
                               iface = intf;
                               admitted_iface = admitted;
                               expect_typ = (uu___192_4606.expect_typ);
                               docs = (uu___192_4606.docs);
                               remaining_iface_decls =
                                 (uu___192_4606.remaining_iface_decls);
                               syntax_only = (uu___192_4606.syntax_only)
                             }))))) in
          let uu____4610 =
...
let enter_monad_scope: env -> FStar_Ident.ident -> env =
  fun env  ->
    fun mname  ->
      ...
      | None  ->
          let uu___193_4654 = env in
          {
            curmodule = (uu___193_4654.curmodule);
            curmonad = (Some mname);
            modules = (uu___193_4654.modules);
            scope_mods = (uu___193_4654.scope_mods);
            exported_ids = (uu___193_4654.exported_ids);
            trans_exported_ids = (uu___193_4654.trans_exported_ids);
            includes = (uu___193_4654.includes);
            sigaccum = (uu___193_4654.sigaccum);
            sigmap = (uu___193_4654.sigmap);
            iface = (uu___193_4654.iface);
            admitted_iface = (uu___193_4654.admitted_iface);
            expect_typ = (uu___193_4654.expect_typ);
            docs = (uu___193_4654.docs);
            remaining_iface_decls = (uu___193_4654.remaining_iface_decls);
            syntax_only = (uu___193_4654.syntax_only)
          }
