      ...
      let uu____1603 =
        FStar_Util.find_map lbs
          (fun lb  ->
             ...
             if uu____1607 then Some fv else None) in
                     ...
                     let uu____1680 =
                       let uu____1681 =
                         let uu____1684 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____1685 in
                         (uu____1684, false) in
                            ...
                            let uu____1752 =
                              let uu____1753 =
                                let uu____1756 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____1757 in
                                (uu____1756, false) in
    ...
    fun lid  ->
      ...
      let uu____2087 =
        resolve_in_open_namespaces' env lid (fun uu____2091  -> None)
          (fun uu____2093  -> None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____2117  ->
             ...
             | (mlid,modul) ->
                 ...
                 uu____2122 = path) env.modules in
...
let record_cache_aux_with_filter:
  ...
  let push1 uu____2470 =
    let uu____2471 =
      ...
      let uu____2484 = FStar_ST.read record_cache in uu____2474 :: uu____2484 in
    FStar_ST.write record_cache uu____2471 in
  let pop1 uu____2499 =
    let uu____2500 =
      let uu____2503 = FStar_ST.read record_cache in FStar_List.tl uu____2503 in
    FStar_ST.write record_cache uu____2500 in
  let peek uu____2519 =
    let uu____2520 = FStar_ST.read record_cache in FStar_List.hd uu____2520 in
  let insert r =
    let uu____2532 =
     ...
     | () ->
         ...
         let uu____2593 =
           let uu____2596 = FStar_ST.read record_cache in filtered ::
             uu____2596 in
         FStar_ST.write record_cache uu____2593) in
                                                             ...
                                                             let uu____3290 =
                                                               let uu____3291
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id in
                                                               uu____3291.FStar_Ident.ident in
                                                             uu____3290.FStar_Ident.idText in
                                                           let uu____3293 =
                                                             let uu____3294 =
                                                               FStar_ST.read
                                                                 my_exported_ids in
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map uu____3332
              (fun record  ->
                 ...
                 option_of_cont (fun uu____3338  -> None) uu____3335) in
...
let try_lookup_record_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3355 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | Some record' when
            ...
            let uu____3379 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____3381  -> Cont_ok ()) in
...
let try_lookup_dc_by_field_name:
  ...
  fun env  ->
    fun fieldname  ->
      let uu____3396 = try_lookup_record_or_dc_by_field_name env fieldname in
    ...
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          ...
          let uu____3466 = try_lookup_lid' any_val exclude_if this_env lid in
    ...
    fun s  ->
            ...
            let uu____3586 =
              FStar_Util.find_map lids
                (fun l  ->
                   ...
                   if uu____3589 then Some l else None) in
      ...
      let uu____3608 =
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3622,uu____3623) ->
            ...
            (env2, uu____3630)
        | uu____3644 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
  ...
  fun env  ->
    fun ns  ->
      ...
      | Some ns1 ->
          ...
          ((let uu____3786 = FStar_Util.smap_try_find env1.includes curmod in
            match uu____3786 with
            | None  -> ()
            | Some incl ->
                let uu____3799 =
                  let uu____3801 = FStar_ST.read incl in ns1 :: uu____3801 in
                       ...
                       | (Some cur_exports,Some cur_trans_exports) ->
                           let update_exports k =
                             ...
                             (let uu____3887 =
                                ...
                                FStar_Util.set_difference uu____3888 ns_ex in
                              FStar_ST.write ex uu____3887);
                             (match () with
                              | () ->
                                  let trans_ex = cur_trans_exports k in
                                  let uu____3898 =
                                    let uu____3899 = FStar_ST.read trans_ex in
                                    FStar_Util.set_union uu____3899 ns_ex in
                                  FStar_ST.write trans_ex uu____3898) in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____4077 -> ()));
      (let curmod =
         let uu____4079 = current_module env in uu____4079.FStar_Ident.str in
       (let uu____4081 =
        ...
        | (Some cur_ex,Some cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____4137 = cur_ex eikind in FStar_ST.read uu____4137 in
        ...
        fun mname  ->
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____4370  ->
                    ...
                    | (l,uu____4374) -> FStar_Ident.lid_equals l mname)) in
          ...
          | Some (uu____4380,m) ->
              ((let uu____4385 =
               ...
               (let uu____4393 = let uu____4394 = push env in prep uu____4394 in
                (uu____4393, true)))
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____4433  ->
             ...
             | (lid1,uu____4437) -> FStar_Ident.text_of_lid lid1) env.modules in
      let msg =
