...
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  ...
  let rec aux uu___152_1130 =
    ...
    | [] ->
        ...
        option_of_cont (fun uu____1141  -> FStar_Pervasives_Native.None)
          uu____1139
     in
  aux env.scope_mods 
    ...
    | FStar_Pervasives_Native.Some uu____1323 ->
        ...
        (match uu____1325 with
         | FStar_Pervasives_Native.Some r ->
             let uu____1338 = k_global_def lid r  in
       ...
       | FStar_Pervasives_Native.Some modul ->
           let uu____1705 =
             find_in_module_with_includes eikind f_module Cont_fail env modul
              ...
              in
           option_of_cont (fun uu____1707  -> FStar_Pervasives_Native.None)
             uu____1705)
  | [] ->
...
let fv_qual_of_se :
  ...
  fun se  ->
        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___156_1843  ->
               ...
               | uu____1852 -> FStar_Pervasives_Native.None)
           in
        (match qopt with
         | FStar_Pervasives_Native.None  ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (uu____1856,uu____1857,uu____1858)
        -> FStar_Pervasives_Native.None
    | uu____1859 -> FStar_Pervasives_Native.None
      ...
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___160_1911 =
            ...
            | (uu____1915,true ) when exclude_interf ->
                FStar_Pervasives_Native.None
            | (se,uu____1917) ->
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     then
                       ...
                       let uu____1988 =
                         FStar_Util.find_map quals
                           (fun uu___159_1990  ->
                              ...
                              | uu____1993 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____1988 with
                        ...
                        | uu____2005 ->
                            ...
                            FStar_Pervasives_Native.Some uu____2007)
                     else FStar_Pervasives_Native.None
                 ...
                 | uu____2024 -> FStar_Pervasives_Native.None)
             in
          let k_local_binding r =
            ...
            FStar_Pervasives_Native.Some uu____2036  in
          let k_rec_binding uu____2047 =
            ...
            | (id,l,dd) ->
                ...
                FStar_Pervasives_Native.Some uu____2055
             in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
                ...
                (match uu____2063 with
                 ...
                 | uu____2073 -> FStar_Pervasives_Native.None)
            | uu____2077 -> FStar_Pervasives_Native.None  in
...
let try_lookup_effect_name :
  ...
  fun env  ->
    fun l  ->
      ...
      | uu____2126 -> FStar_Pervasives_Native.None
...
let try_lookup_effect_name_and_attributes :
  ...
  fun env  ->
    fun l  ->
      ...
      | uu____2190 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some
          ...
          -> FStar_Pervasives_Native.Some ne
      | uu____2225 -> FStar_Pervasives_Native.None
...
let is_effect_name : env -> FStar_Ident.lident -> Prims.bool =
  fun env  ->
    fun lid  ->
      ...
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some uu____2237 -> true
    ...
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some
          ...
          let rec aux new_name =
            ...
            | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some (s,uu____2279) ->
             ...
             in
          aux l'
      | FStar_Pervasives_Native.Some (uu____2294,l') ->
          FStar_Pervasives_Native.Some l'
      | uu____2298 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___161_2319 =
        ...
        | uu____2333 -> FStar_Pervasives_Native.None  in
      let uu____2337 =
        resolve_in_open_namespaces' env lid
          (fun uu____2341  -> FStar_Pervasives_Native.None)
          (fun uu____2343  -> FStar_Pervasives_Native.None) k_global_def
         in
...
let try_lookup_module :
  ...
  fun env  ->
    fun path  ->
      ...
      | FStar_Pervasives_Native.Some (uu____2376,modul) ->
          FStar_Pervasives_Native.Some modul
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___162_2398 =
        ...
        | uu____2422 -> FStar_Pervasives_Native.None  in
      resolve_in_open_namespaces' env lid
        (fun uu____2425  -> FStar_Pervasives_Native.None)
        (fun uu____2426  -> FStar_Pervasives_Native.None) k_global_def
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___163_2445 =
        ...
        | uu____2478 -> FStar_Pervasives_Native.None  in
      resolve_in_open_namespaces' env lid
        (fun uu____2485  -> FStar_Pervasives_Native.None)
        (fun uu____2488  -> FStar_Pervasives_Native.None) k_global_def
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          | uu____2524 -> FStar_Pervasives_Native.None
...
let resolve_to_fully_qualified_name :
  ...
  fun env  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
      | FStar_Pervasives_Native.Some (e,uu____2552) ->
          let uu____2555 =
          ...
          (match uu____2555 with
           ...
           | uu____2565 -> FStar_Pervasives_Native.None)
...
let try_lookup_datacon :
  ...
  fun env  ->
    fun lid  ->
            ...
            then
              let uu____2617 =
                FStar_Syntax_Syntax.lid_as_fv lid1
                  ...
                  FStar_Pervasives_Native.None
                 in
              FStar_Pervasives_Native.Some uu____2617
            else FStar_Pervasives_Native.None
        | ({
      ...
      resolve_in_open_namespaces' env lid
        (fun uu____2636  -> FStar_Pervasives_Native.None)
        (fun uu____2637  -> FStar_Pervasives_Native.None) k_global_def
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___166_2656 =
        ...
        | uu____2677 -> FStar_Pervasives_Native.None  in
      resolve_in_open_namespaces' env lid
        (fun uu____2682  -> FStar_Pervasives_Native.None)
        (fun uu____2684  -> FStar_Pervasives_Native.None) k_global_def
        ...
        | (ns,id) ->
            ...
            FStar_Util.find_map uu____3579
              (fun record  ->
                 ...
                 option_of_cont
                   (fun uu____3585  -> FStar_Pervasives_Native.None)
                   uu____3582)
         in
  ...
  fun env  ->
    fun fieldname  ->
      ...
      | FStar_Pervasives_Native.Some r when r.is_record ->
          FStar_Pervasives_Native.Some r
      | uu____3606 -> FStar_Pervasives_Native.None
...
let try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      ...
      | uu____3656 -> FStar_Pervasives_Native.None
    ...
    fun exclude_if  ->
      fun env  ->
        fun lid  ->
          ...
          | FStar_Pervasives_Native.None  -> true
          | FStar_Pervasives_Native.Some uu____3719 -> false
  ...
  fun env  ->
    fun s  ->
      let err1 l =
        ...
        let r =
          match sopt with
          | FStar_Pervasives_Native.Some (se,uu____3789) ->
              let uu____3792 =
    ...
    fun admitted  ->
      fun env  ->
        fun mname  ->
            ...
            let namespace_of_module =
              if
                (FStar_List.length mname.FStar_Ident.ns) >
                  (Prims.parse_int "0")
              then
                let uu____4580 = FStar_Ident.lid_of_ids mname.FStar_Ident.ns
                   in
                [uu____4580]
              else []  in
            let open_ns =
              ...
              FStar_List.append uu____4584 namespace_of_module  in
          ...
          | FStar_Pervasives_Native.None  ->
              let uu____4631 = prep env  in (uu____4631, false)
          | FStar_Pervasives_Native.Some (uu____4632,m) ->
              ((let uu____4637 =
