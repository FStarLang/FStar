        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____1110  ->
                ...
                | (m,uu____1115) -> FStar_Ident.lid_equals l m))
         in
...
let try_lookup_id'' env id eikind k_local_binding k_rec_binding k_record
  ...
  let check_rec_binding_id uu___153_1779 =
    ...
    | (id',uu____1781,uu____1782) ->
     ...
     in
  let curmod_ns =
    let uu____1785 = current_module env  in FStar_Ident.ids_of_lid uu____1785
     in
...
let lookup_default_id env id k_global_def k_not_found =
  ...
  | FStar_Pervasives_Native.None  ->
      let lid = let uu____2056 = current_module env  in qual uu____2056 id
         in
        ...
        let uu____2277 =
          is_full_path &&
            (let uu____2279 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____2279)
           in
        if uu____2277
        then (ids, [])
        else
  ...
  | uu____2437::uu____2438 ->
      let uu____2440 =
        let uu____2442 =
          ...
          FStar_Ident.set_lid_range uu____2443 (FStar_Ident.range_of_lid lid)
           in
...
let resolve_in_open_namespaces' env lid k_local_binding k_rec_binding
  ...
  let k_global_def' k lid1 def =
    let uu____2552 = k_global_def lid1 def  in cont_of_option k uu____2552
     in
  let f_module lid' =
        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___159_2603  ->
               ...
               | uu____2612 -> FStar_Pervasives_Native.None)
           in
        (match qopt with
         | FStar_Pervasives_Native.None  ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
                     ...
                     let uu____2717 =
                       let uu____2718 =
                         let uu____2721 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____2722
                            in
                         (uu____2721, false)  in
                            ...
                            let uu____2785 =
                              let uu____2786 =
                                let uu____2789 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____2790
                                   in
                                (uu____2789, false)  in
    ...
    fun lid  ->
      ...
      let uu____3144 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____3152  -> FStar_Pervasives_Native.None) k_global_def
         in
...
let record_cache_aux_with_filter :
  ...
  let push1 uu____3564 =
    let uu____3565 =
      ...
      let uu____3578 = FStar_ST.read record_cache  in uu____3568 ::
        uu____3578
       in
    FStar_ST.write record_cache uu____3565  in
  let pop1 uu____3593 =
    let uu____3594 =
      let uu____3597 = FStar_ST.read record_cache  in
      FStar_List.tl uu____3597  in
    FStar_ST.write record_cache uu____3594  in
  let peek1 uu____3613 =
    let uu____3614 = FStar_ST.read record_cache  in FStar_List.hd uu____3614
     in
  let insert r =
    let uu____3626 =
     ...
     | () ->
         ...
         let uu____3688 =
           let uu____3691 = FStar_ST.read record_cache  in filtered ::
             uu____3691
            in
         FStar_ST.write record_cache uu____3688)
     in
                                                             ...
                                                             let uu____4452 =
                                                               let uu____4453
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____4453.FStar_Ident.ident
                                                                in
                                                             uu____4452.FStar_Ident.idText
                                                              in
                                                           let uu____4455 =
                                                             let uu____4456 =
                                                               FStar_ST.read
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____4559 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____4562  -> Cont_ok ())
               in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____4821) ->
            let uu____4826 =
              FStar_List.map
               ...
               in
            (env2, uu____4826)
        | uu____4841 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
           ...
           (let env1 =
            ...
            (let uu____5000 = FStar_Util.smap_try_find env1.includes curmod
             ...
             | FStar_Pervasives_Native.Some incl ->
                 let uu____5013 =
                   let uu____5015 = FStar_ST.read incl  in ns1 :: uu____5015
                    in
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____5101 =
                                 ...
                                 FStar_Util.set_difference uu____5102 ns_ex
                                  in
                               ...
                               | () ->
                                   ...
                                   let uu____5112 =
                                     let uu____5113 = FStar_ST.read trans_ex
                                        in
                                     FStar_Util.set_union uu____5113 ns_ex
                                      in
                                   FStar_ST.write trans_ex uu____5112)
                               in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____5184 =
                    ...
                    FStar_Util.format3
                      ...
                      uu____5185 uu____5186 uu____5187
                     in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____5321 -> ()));
      (let curmod =
         let uu____5323 = current_module env  in uu____5323.FStar_Ident.str
          in
       (let uu____5325 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____5381 = cur_ex eikind  in FStar_ST.read uu____5381
                 in
        ...
        fun mname  ->
            ...
            FStar_All.pipe_right env.modules
              (FStar_Util.find_opt
                 (fun uu____5680  ->
                    ...
                    | (l,uu____5684) -> FStar_Ident.lid_equals l mname))
             in
          ...
          | FStar_Pervasives_Native.Some (uu____5690,m) ->
              ((let uu____5695 =
               ...
               (let uu____5705 =
                  let uu____5706 = push env  in prep uu____5706  in
                (uu____5705, true)))
      ...
      let opened_modules =
        FStar_List.map
          (fun uu____5754  ->
             ...
             | (lid1,uu____5758) -> FStar_Ident.text_of_lid lid1) env.modules
         in
      let msg =
