...
let mk_typ_projector_name : FStar_Ident.lident  ->  FStar_Absyn_Syntax.btvdef  ->  Prims.string = (fun lid a -> (let _128_14 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str (escape_null_name a))
in (FStar_All.pipe_left escape _128_14)))
...
let a = (let _128_19 = (FStar_Absyn_Util.unmangle_field_name a.FStar_Absyn_Syntax.ppname)
in {FStar_Absyn_Syntax.ppname = _128_19; FStar_Absyn_Syntax.realname = a.FStar_Absyn_Syntax.realname})
in (let _128_20 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str (escape_null_name a))
in (FStar_All.pipe_left escape _128_20))))
...
| () -> begin
(let _128_30 = (let _128_29 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "Projector %s on data constructor %s not found" _128_29 lid.FStar_Ident.str))
in (FStar_All.failwith _128_30))
end))
in (
# 50 "FStar.ToSMT.Encode.fst"
let t = (FStar_Tc_Env.lookup_datacon env lid)
in (match ((let _128_31 = (FStar_Absyn_Util.compress_typ t)
in _128_31.FStar_Absyn_Syntax.n)) with
...
let mk_term_projector_name_by_pos : FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun lid i -> (let _128_37 = (let _128_36 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str _128_36))
in (FStar_All.pipe_left escape _128_37)))

# 62 "FStar.ToSMT.Encode.fst"
let mk_typ_projector : FStar_Ident.lident  ->  FStar_Absyn_Syntax.btvdef  ->  FStar_ToSMT_Term.term = (fun lid a -> (let _128_43 = (let _128_42 = (mk_typ_projector_name lid a)
in (_128_42, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Type_sort))))
in (FStar_ToSMT_Term.mkFreeV _128_43)))

# 64 "FStar.ToSMT.Encode.fst"
let mk_term_projector : FStar_Ident.lident  ->  FStar_Absyn_Syntax.bvvdef  ->  FStar_ToSMT_Term.term = (fun lid a -> (let _128_49 = (let _128_48 = (mk_term_projector_name lid a)
in (_128_48, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Term_sort))))
in (FStar_ToSMT_Term.mkFreeV _128_49)))

# 66 "FStar.ToSMT.Encode.fst"
let mk_term_projector_by_pos : FStar_Ident.lident  ->  Prims.int  ->  FStar_ToSMT_Term.term = (fun lid i -> (let _128_55 = (let _128_54 = (mk_term_projector_name_by_pos lid i)
in (_128_54, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Term_sort))))
in (FStar_ToSMT_Term.mkFreeV _128_55)))
...
| () -> begin
(let _128_159 = (FStar_Util.smap_create 100)
in (let _128_158 = (FStar_Util.smap_create 100)
in (_128_159, _128_158)))
end))
in (
# 87 "FStar.ToSMT.Encode.fst"
let scopes = (let _128_161 = (let _128_160 = (new_scope ())
in (_128_160)::[])
in (FStar_Util.mk_ref _128_161))
in (
...
let y = (match ((let _128_165 = (FStar_ST.read scopes)
in (FStar_Util.find_map _128_165 (fun _46_108 -> (match (_46_108) with
| (names, _46_107) -> begin
...
in (let _128_167 = (let _128_166 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _128_166))
in (Prims.strcat (Prims.strcat y "__") _128_167)))
end)
in (
# 93 "FStar.ToSMT.Encode.fst"
let top_scope = (let _128_169 = (let _128_168 = (FStar_ST.read scopes)
in (FStar_List.hd _128_168))
in (FStar_All.pipe_left Prims.fst _128_169))
in (
...
let new_var = (fun pp rn -> (let _128_175 = (let _128_174 = (FStar_All.pipe_left mk_unique pp.FStar_Ident.idText)
in (Prims.strcat _128_174 "__"))
in (Prims.strcat _128_175 rn.FStar_Ident.idText)))
in (
...
let fresh = (fun pfx -> (let _128_183 = (let _128_182 = (next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _128_182))
in (FStar_Util.format2 "%s_%s" pfx _128_183)))
in (
# 99 "FStar.ToSMT.Encode.fst"
let string_const = (fun s -> (match ((let _128_187 = (FStar_ST.read scopes)
in (FStar_Util.find_map _128_187 (fun _46_135 -> (match (_46_135) with
...
let f = (let _128_188 = (FStar_ToSMT_Term.mk_String_const id)
in (FStar_All.pipe_left FStar_ToSMT_Term.boxString _128_188))
in (
# 104 "FStar.ToSMT.Encode.fst"
let top_scope = (let _128_190 = (let _128_189 = (FStar_ST.read scopes)
in (FStar_List.hd _128_189))
in (FStar_All.pipe_left Prims.snd _128_190))
in (
...
| () -> begin
(let _128_195 = (let _128_194 = (new_scope ())
in (let _128_193 = (FStar_ST.read scopes)
in (_128_194)::_128_193))
in (FStar_ST.op_Colon_Equals scopes _128_195))
end))
in (
# 108 "FStar.ToSMT.Encode.fst"
let pop = (fun _46_147 -> (match (()) with
| () -> begin
(let _128_199 = (let _128_198 = (FStar_ST.read scopes)
in (FStar_List.tl _128_198))
in (FStar_ST.op_Colon_Equals scopes _128_199))
end))
in (
...
let unmangle = (fun x -> (let _128_215 = (let _128_214 = (FStar_Absyn_Util.unmangle_field_name x.FStar_Absyn_Syntax.ppname)
in (let _128_213 = (FStar_Absyn_Util.unmangle_field_name x.FStar_Absyn_Syntax.realname)
in (_128_214, _128_213)))
in (FStar_Absyn_Util.mkbvd _128_215)))
...
let print_env : env_t  ->  Prims.string = (fun e -> (let _128_301 = (FStar_All.pipe_right e.bindings (FStar_List.map (fun _46_2 -> (match (_46_2) with
...
(let _128_311 = (FStar_Absyn_Print.typ_to_string t)
in Some (_128_311))
end else begin
None
end)
...
in (let _128_316 = (FStar_ToSMT_Term.mkFreeV (xsym, s))
in (xsym, _128_316))))
...
let ysym = (let _128_321 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@x" _128_321))
in (
...
| None -> begin
(let _128_336 = (let _128_335 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Bound term variable not found: %s" _128_335))
in (FStar_All.failwith _128_336))
end
| Some (b, t) -> begin
t
end))
...
let ysym = (let _128_341 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@a" _128_341))
in (
...
| None -> begin
(let _128_356 = (let _128_355 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Bound type variable not found: %s" _128_355))
in (FStar_All.failwith _128_356))
end
| Some (b, t) -> begin
t
end))
...
let _46_294 = env
in (let _128_366 = (let _128_365 = (let _128_364 = (let _128_363 = (let _128_362 = (FStar_ToSMT_Term.mkApp (ftok, []))
in (FStar_All.pipe_left (fun _128_361 -> Some (_128_361)) _128_362))
in (x, fname, _128_363, None))
in Binding_fvar (_128_364))
in (_128_365)::env.bindings)
in {bindings = _128_366; depth = _46_294.depth; tcenv = _46_294.tcenv; warn = _46_294.warn; cache = _46_294.cache; nolabels = _46_294.nolabels; use_zfuel_name = _46_294.use_zfuel_name; encode_non_total_function_typ = _46_294.encode_non_total_function_typ}))
in (fname, ftok, _128_367)))))
...
| None -> begin
(let _128_378 = (let _128_377 = (FStar_Absyn_Print.sli a)
in (FStar_Util.format1 "Name not found: %s" _128_377))
in (FStar_All.failwith _128_378))
end
| Some (s) -> begin
s
end))
...
let t3 = (let _128_395 = (let _128_394 = (let _128_393 = (FStar_ToSMT_Term.mkApp ("ZFuel", []))
in (_128_393)::[])
in (f, _128_394))
in (FStar_ToSMT_Term.mkApp _128_395))
in (
...
if (let _128_399 = (let _128_398 = (FStar_ToSMT_Term.fv_of_term fuel)
in (FStar_All.pipe_right _128_398 Prims.fst))
in (FStar_Util.starts_with _128_399 "fuel")) then begin
(let _128_400 = (FStar_ToSMT_Term.mkFreeV (name, FStar_ToSMT_Term.Term_sort))
in (FStar_ToSMT_Term.mk_ApplyEF _128_400 fuel))
end else begin
t
end
end
...
| _46_350 -> begin
(let _128_402 = (let _128_401 = (FStar_Absyn_Print.sli a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Name not found: %s" _128_401))
in (FStar_All.failwith _128_402))
end)
end)
end)))
...
let _46_391 = env
in (let _128_416 = (let _128_415 = (let _128_414 = (let _128_413 = (let _128_412 = (FStar_ToSMT_Term.mkApp (ftok, []))
in (FStar_All.pipe_left (fun _128_411 -> Some (_128_411)) _128_412))
in (x, fname, _128_413))
in Binding_ftvar (_128_414))
in (_128_415)::env.bindings)
in {bindings = _128_416; depth = _46_391.depth; tcenv = _46_391.tcenv; warn = _46_391.warn; cache = _46_391.cache; nolabels = _46_391.nolabels; use_zfuel_name = _46_391.use_zfuel_name; encode_non_total_function_typ = _46_391.encode_non_total_function_typ}))
in (fname, ftok, _128_417)))))
...
| None -> begin
(let _128_424 = (let _128_423 = (FStar_Absyn_Print.sli a)
in (FStar_Util.format1 "Type name not found: %s" _128_423))
in (FStar_All.failwith _128_424))
end
| Some (s) -> begin
s
end))
...
let lookup_free_tvar = (fun env a -> (match ((let _128_435 = (lookup_tlid env a.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _128_435 Prims.snd))) with
| None -> begin
(let _128_437 = (let _128_436 = (FStar_Absyn_Print.sli a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Type name not found: %s" _128_436))
in (FStar_All.failwith _128_437))
end
| Some (t) -> begin
t
end))
...
let lookup_free_tvar_name = (fun env a -> (let _128_440 = (lookup_tlid env a.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _128_440 Prims.fst)))
...
(let _128_453 = (add_fuel guards)
in (FStar_ToSMT_Term.mk_and_l _128_453))
end
| _46_468 -> begin
(let _128_454 = (add_fuel ((guard)::[]))
in (FStar_All.pipe_right _128_454 FStar_List.hd))
end)
...
(let _128_460 = (FStar_Tc_Env.lookup_typ_abbrev env.tcenv v.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _128_460 FStar_Option.isNone))
end
| _46_509 -> begin
false
end)))
...
let trivial_post : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun t -> (let _128_482 = (let _128_481 = (let _128_479 = (FStar_Absyn_Syntax.null_v_binder t)
in (_128_479)::[])
in (let _128_480 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.true_lid FStar_Absyn_Syntax.ktype)
in (_128_481, _128_480)))
in (FStar_Absyn_Syntax.mk_Typ_lam _128_482 None t.FStar_Absyn_Syntax.pos)))
...
(let _128_489 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyET out _128_489))
end
| FStar_ToSMT_Term.Fuel_sort -> begin
(let _128_490 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyEF out _128_490))
end
| _46_526 -> begin
(let _128_491 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyEE out _128_491))
end)) e)))
...
| FStar_ToSMT_Term.Type_sort -> begin
(let _128_504 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyTT out _128_504))
end
| _46_541 -> begin
(let _128_505 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyTE out _128_505))
end)) t)))
...
(let _128_561 = (FStar_ToSMT_Term.mkInteger' (FStar_Util.int_of_char c))
in (FStar_ToSMT_Term.boxInt _128_561))
end
| FStar_Const.Const_uint8 (i) -> begin
(let _128_562 = (FStar_ToSMT_Term.mkInteger' (FStar_Util.int_of_uint8 i))
in (FStar_ToSMT_Term.boxInt _128_562))
end
| FStar_Const.Const_int (i) -> begin
(let _128_563 = (FStar_ToSMT_Term.mkInteger i)
in (FStar_ToSMT_Term.boxInt _128_563))
end
| FStar_Const.Const_int32 (i) -> begin
(let _128_567 = (let _128_566 = (let _128_565 = (let _128_564 = (FStar_ToSMT_Term.mkInteger32 i)
in (FStar_ToSMT_Term.boxInt _128_564))
in (_128_565)::[])
in ("FStar.Int32.Int32", _128_566))
in (FStar_ToSMT_Term.mkApp _128_567))
end
| FStar_Const.Const_string (bytes, _46_626) -> begin
(let _128_568 = (FStar_All.pipe_left FStar_Util.string_of_bytes bytes)
in (varops.string_const _128_568))
end
| c -> begin
(let _128_570 = (let _128_569 = (FStar_Absyn_Print.const_to_string c)
in (FStar_Util.format1 "Unhandled constant: %s\n" _128_569))
in (FStar_All.failwith _128_570))
end))
...
(let _128_579 = (FStar_Absyn_Util.unrefine t)
in (aux true _128_579))
end
| _46_643 -> begin
if norm then begin
(let _128_580 = (whnf env t)
in (aux false _128_580))
end else begin
(let _128_583 = (let _128_582 = (FStar_Range.string_of_range t0.FStar_Absyn_Syntax.pos)
in (let _128_581 = (FStar_Absyn_Print.typ_to_string t0)
in (FStar_Util.format2 "(%s) Expected a function typ; got %s" _128_582 _128_581)))
in (FStar_All.failwith _128_583))
end
end)))
in (aux true t0)))

# 415 "FStar.ToSMT.Encode.fst"
let rec encode_knd_term : FStar_Absyn_Syntax.knd  ->  env_t  ->  (FStar_ToSMT_Term.term * FStar_ToSMT_Term.decls_t) = (fun k env -> (match ((let _128_620 = (FStar_Absyn_Util.compress_kind k)
in _128_620.FStar_Absyn_Syntax.n)) with
...
(let _128_622 = (FStar_Absyn_Print.kind_to_string k)
in (let _128_621 = (FStar_Absyn_Print.kind_to_string k0)
...
(let _128_624 = (let _128_623 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Kind_uvar _128_623))
in (_128_624, []))
end
| FStar_Absyn_Syntax.Kind_arrow (bs, kbody) -> begin
(
# 428 "FStar.ToSMT.Encode.fst"
let tsym = (let _128_625 = (varops.fresh "t")
in (_128_625, FStar_ToSMT_Term.Type_sort))
in (
...
| _46_694 -> begin
(let _128_634 = (let _128_633 = (let _128_632 = (FStar_ToSMT_Term.mk_PreKind app)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _128_632))
in (_128_633, body))
in (FStar_ToSMT_Term.mkAnd _128_634))
end)
in (let _128_636 = (let _128_635 = (FStar_ToSMT_Term.mkImp (g, body))
in (((app)::[])::[], (x)::[], _128_635))
in (FStar_ToSMT_Term.mkForall _128_636)))))
end
| _46_697 -> begin
...
let cvars = (let _128_638 = (FStar_ToSMT_Term.free_variables k_interp)
in (FStar_All.pipe_right _128_638 (FStar_List.filter (fun _46_702 -> (match (_46_702) with
| (x, _46_701) -> begin
(x <> (Prims.fst tsym))
end)))))
in (
...
(let _128_641 = (let _128_640 = (let _128_639 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (k', _128_639))
in (FStar_ToSMT_Term.mkApp _128_640))
in (_128_641, []))
end
| None -> begin
(
...
(let _128_642 = (FStar_Tc_Normalize.kind_norm_to_string env.tcenv k)
in Some (_128_642))
end else begin
None
end
...
let k = (let _128_644 = (let _128_643 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (ksym, _128_643))
in (FStar_ToSMT_Term.mkApp _128_644))
in (
# 464 "FStar.ToSMT.Encode.fst"
let t_has_k = (FStar_ToSMT_Term.mk_HasKind t k)
in (
# 465 "FStar.ToSMT.Encode.fst"
let k_interp = (let _128_653 = (let _128_652 = (let _128_651 = (let _128_650 = (let _128_649 = (let _128_648 = (let _128_647 = (let _128_646 = (let _128_645 = (FStar_ToSMT_Term.mk_PreKind t)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _128_645))
in (_128_646, k_interp))
in (FStar_ToSMT_Term.mkAnd _128_647))
in (t_has_k, _128_648))
in (FStar_ToSMT_Term.mkIff _128_649))
in (((t_has_k)::[])::[], (tsym)::cvars, _128_650))
in (FStar_ToSMT_Term.mkForall _128_651))
in (_128_652, Some ((Prims.strcat ksym " interpretation"))))
in FStar_ToSMT_Term.Assume (_128_653))
in (
...
| _46_723 -> begin
(let _128_655 = (let _128_654 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.format1 "Unknown kind: %s" _128_654))
in (FStar_All.failwith _128_655))
end))
...
| (k, decls) -> begin
(let _128_659 = (FStar_ToSMT_Term.mk_HasKind t k)
in (_128_659, decls))
end)))
...
(let _128_663 = (FStar_Absyn_Print.binders_to_string ", " bs)
...
(let _128_667 = (FStar_Absyn_Print.strBvd a)
in (let _128_666 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.print3 "Encoding type binder %s (%s) at kind %s\n" _128_667 aasym _128_666)))
end else begin
()
end
in (
...
let _46_771 = (let _128_668 = (norm_t env t)
in (encode_typ_pred fuel_opt _128_668 env xx))
...
| (t, decls) -> begin
(let _128_673 = (FStar_ToSMT_Term.mk_HasTypeWithFuel fuel_opt e t)
in (_128_673, decls))
end))))
and encode_typ_pred' : FStar_ToSMT_Term.term Prims.option  ->  FStar_Absyn_Syntax.typ  ->  env_t  ->  FStar_ToSMT_Term.term  ->  (FStar_ToSMT_Term.term * FStar_ToSMT_Term.decls_t) = (fun fuel_opt t env e -> (
...
(match (fuel_opt) with
| None -> begin
(let _128_678 = (FStar_ToSMT_Term.mk_HasTypeZ e t)
in (_128_678, decls))
end
| Some (f) -> begin
(let _128_679 = (FStar_ToSMT_Term.mk_HasTypeFuel f e t)
in (_128_679, decls))
end)
end))))
...
(let _128_682 = (lookup_typ_var env a)
in (_128_682, []))
end
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
(let _128_683 = (lookup_free_tvar env fv)
in (_128_683, []))
end
...
let fsym = (let _128_684 = (varops.fresh "f")
in (_128_684, FStar_ToSMT_Term.Term_sort))
in (
...
| None -> begin
(let _128_685 = (FStar_ToSMT_Term.mk_and_l guards)
in (_128_685, decls))
end
| Some (pre) -> begin
(
...
| (guard, decls0) -> begin
(let _128_686 = (FStar_ToSMT_Term.mk_and_l ((guard)::guards))
in (_128_686, (FStar_List.append decls decls0)))
end))
end)
...
let t_interp = (let _128_688 = (let _128_687 = (FStar_ToSMT_Term.mkImp (guards, res_pred))
in (((app)::[])::[], vars, _128_687))
in (FStar_ToSMT_Term.mkForall _128_688))
in (
# 566 "FStar.ToSMT.Encode.fst"
let cvars = (let _128_690 = (FStar_ToSMT_Term.free_variables t_interp)
in (FStar_All.pipe_right _128_690 (FStar_List.filter (fun _46_843 -> (match (_46_843) with
| (x, _46_842) -> begin
(x <> (Prims.fst fsym))
end)))))
in (
...
(let _128_693 = (let _128_692 = (let _128_691 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (t', _128_691))
in (FStar_ToSMT_Term.mkApp _128_692))
in (_128_693, []))
end
| None -> begin
(
...
let caption = if (FStar_ST.read FStar_Options.logQueries) then begin
(let _128_694 = (FStar_Tc_Normalize.typ_norm_to_string env.tcenv t0)
in Some (_128_694))
end else begin
None
end
...
let t = (let _128_696 = (let _128_695 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _128_695))
in (FStar_ToSMT_Term.mkApp _128_696))
in (
...
let k_assumption = (let _128_698 = (let _128_697 = (FStar_ToSMT_Term.mkForall (((t_has_kind)::[])::[], cvars, t_has_kind))
in (_128_697, Some ((Prims.strcat tsym " kinding"))))
in FStar_ToSMT_Term.Assume (_128_698))
in (
...
let pre_typing = (let _128_705 = (let _128_704 = (let _128_703 = (let _128_702 = (let _128_701 = (let _128_700 = (let _128_699 = (FStar_ToSMT_Term.mk_PreType f)
in (FStar_ToSMT_Term.mk_tester "Typ_fun" _128_699))
in (f_has_t, _128_700))
in (FStar_ToSMT_Term.mkImp _128_701))
in (((f_has_t)::[])::[], (fsym)::cvars, _128_702))
in (mkForall_fuel _128_703))
in (_128_704, Some ("pre-typing for functions")))
in FStar_ToSMT_Term.Assume (_128_705))
in (
# 590 "FStar.ToSMT.Encode.fst"
let t_interp = (let _128_709 = (let _128_708 = (let _128_707 = (let _128_706 = (FStar_ToSMT_Term.mkIff (f_has_t_z, t_interp))
in (((f_has_t_z)::[])::[], (fsym)::cvars, _128_706))
in (FStar_ToSMT_Term.mkForall _128_707))
in (_128_708, Some ((Prims.strcat tsym " interpretation"))))
in FStar_ToSMT_Term.Assume (_128_709))
in (
...
let t_kinding = (let _128_711 = (let _128_710 = (FStar_ToSMT_Term.mk_HasKind t FStar_ToSMT_Term.mk_Kind_type)
in (_128_710, None))
in FStar_ToSMT_Term.Assume (_128_711))
in (
...
let t_interp = (let _128_718 = (let _128_717 = (let _128_716 = (let _128_715 = (let _128_714 = (let _128_713 = (let _128_712 = (FStar_ToSMT_Term.mk_PreType f)
in (FStar_ToSMT_Term.mk_tester "Typ_fun" _128_712))
in (f_has_t, _128_713))
in (FStar_ToSMT_Term.mkImp _128_714))
in (((f_has_t)::[])::[], (fsym)::[], _128_715))
in (mkForall_fuel _128_716))
in (_128_717, Some ("pre-typing")))
in FStar_ToSMT_Term.Assume (_128_718))
...
let encoding = (let _128_720 = (let _128_719 = (FStar_ToSMT_Term.mk_HasTypeWithFuel (Some (fterm)) xtm base_t)
in (_128_719, refinement))
in (FStar_ToSMT_Term.mkAnd _128_720))
in (
# 624 "FStar.ToSMT.Encode.fst"
let cvars = (let _128_722 = (FStar_ToSMT_Term.free_variables encoding)
in (FStar_All.pipe_right _128_722 (FStar_List.filter (fun _46_913 -> (match (_46_913) with
| (y, _46_912) -> begin
((y <> x) && (y <> fsym))
end)))))
in (
...
(let _128_725 = (let _128_724 = (let _128_723 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (t, _128_723))
in (FStar_ToSMT_Term.mkApp _128_724))
in (_128_725, []))
end
| None -> begin
(
...
let t = (let _128_727 = (let _128_726 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _128_726))
in (FStar_ToSMT_Term.mkApp _128_727))
in (
...
let assumption = (let _128_729 = (let _128_728 = (FStar_ToSMT_Term.mkIff (x_has_t, encoding))
in (((x_has_t)::[])::[], (ffv)::(xfv)::cvars, _128_728))
in (FStar_ToSMT_Term.mkForall _128_729))
in (
# 645 "FStar.ToSMT.Encode.fst"
let t_decls = (let _128_736 = (let _128_735 = (let _128_734 = (let _128_733 = (let _128_732 = (let _128_731 = (let _128_730 = (FStar_Absyn_Print.typ_to_string t0)
in Some (_128_730))
in (assumption, _128_731))
in FStar_ToSMT_Term.Assume (_128_732))
in (_128_733)::[])
in (FStar_ToSMT_Term.Assume ((t_kinding, None)))::_128_734)
in (tdecl)::_128_735)
in (FStar_List.append (FStar_List.append decls decls') _128_736))
in (
...
let ttm = (let _128_737 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Typ_uvar _128_737))
in (
...
let t = (let _128_742 = (let _128_741 = (FStar_List.map (fun _46_10 -> (match (_46_10) with
| (FStar_Util.Inl (t)) | (FStar_Util.Inr (t)) -> begin
t
end)) args)
in (head, _128_741))
in (FStar_ToSMT_Term.mkApp _128_742))
in (t, decls)))
end else begin
(
...
let ttm = (let _128_743 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Typ_uvar _128_743))
in (
...
let key_body = (let _128_747 = (let _128_746 = (let _128_745 = (let _128_744 = (FStar_ToSMT_Term.mk_and_l guards)
in (_128_744, body))
in (FStar_ToSMT_Term.mkImp _128_745))
in ([], vars, _128_746))
in (FStar_ToSMT_Term.mkForall _128_747))
in (
...
(let _128_750 = (let _128_749 = (let _128_748 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (t, _128_748))
in (FStar_ToSMT_Term.mkApp _128_749))
in (_128_750, []))
end
| None -> begin
...
let t = (let _128_752 = (let _128_751 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _128_751))
in (FStar_ToSMT_Term.mkApp _128_752))
in (
# 719 "FStar.ToSMT.Encode.fst"
let app = (mk_ApplyT t vars)
in (
# 721 "FStar.ToSMT.Encode.fst"
let interp = (let _128_759 = (let _128_758 = (let _128_757 = (let _128_756 = (let _128_755 = (let _128_754 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _128_753 = (FStar_ToSMT_Term.mkEq (app, body))
in (_128_754, _128_753)))
in (FStar_ToSMT_Term.mkImp _128_755))
in (((app)::[])::[], (FStar_List.append vars cvars), _128_756))
in (FStar_ToSMT_Term.mkForall _128_757))
in (_128_758, Some ("Typ_lam interpretation")))
in FStar_ToSMT_Term.Assume (_128_759))
in (
# 724 "FStar.ToSMT.Encode.fst"
let kinding = (
# 725 "FStar.ToSMT.Encode.fst"
let _46_1026 = (let _128_760 = (FStar_Tc_Recheck.recompute_kind t0)
in (encode_knd _128_760 env t))
in (match (_46_1026) with
| (ktm, decls'') -> begin
(let _128_764 = (let _128_763 = (let _128_762 = (let _128_761 = (FStar_ToSMT_Term.mkForall (((t)::[])::[], cvars, ktm))
in (_128_761, Some ("Typ_lam kinding")))
in FStar_ToSMT_Term.Assume (_128_762))
in (_128_763)::[])
in (FStar_List.append decls'' _128_764))
end))
in (
...
(let _128_765 = (FStar_Absyn_Util.unmeta_typ t0)
in (encode_typ_term _128_765 env))
end
| (FStar_Absyn_Syntax.Typ_delayed (_)) | (FStar_Absyn_Syntax.Typ_unknown) -> begin
(let _128_770 = (let _128_769 = (FStar_All.pipe_left FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _128_768 = (FStar_Absyn_Print.tag_of_typ t0)
in (let _128_767 = (FStar_Absyn_Print.typ_to_string t0)
in (let _128_766 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" _128_769 _128_768 _128_767 _128_766)))))
in (FStar_All.failwith _128_770))
end)))
...
(let _128_773 = (FStar_Absyn_Util.compress_exp e)
in (encode_exp _128_773 env))
end
...
(let _128_774 = (lookup_free_var env v)
in (_128_774, []))
end
| FStar_Absyn_Syntax.Exp_constant (c) -> begin
(let _128_775 = (encode_const c)
in (_128_775, []))
end
...
let e = (let _128_776 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Exp_uvar _128_776))
in (e, []))
end
...
in (let _128_779 = (FStar_ToSMT_Term.mkFreeV (f, FStar_ToSMT_Term.Term_sort))
in (_128_779, (decl)::[]))))
end))
...
| Some (tfun) -> begin
if (let _128_780 = (FStar_Absyn_Util.is_pure_or_ghost_function tfun)
in (FStar_All.pipe_left Prims.op_Negation _128_780)) then begin
(fallback ())
end else begin
(
...
let e = (let _128_782 = (let _128_781 = (FStar_Absyn_Syntax.mk_Exp_abs (rest, body) (Some (res_t)) body.FStar_Absyn_Syntax.pos)
in (bs0, _128_781))
in (FStar_Absyn_Syntax.mk_Exp_abs _128_782 (Some (tfun)) e0.FStar_Absyn_Syntax.pos))
in (encode_exp e env)))
end))
end else begin
(
...
let key_body = (let _128_786 = (let _128_785 = (let _128_784 = (let _128_783 = (FStar_ToSMT_Term.mk_and_l guards)
in (_128_783, body))
in (FStar_ToSMT_Term.mkImp _128_784))
in ([], vars, _128_785))
in (FStar_ToSMT_Term.mkForall _128_786))
in (
...
(let _128_789 = (let _128_788 = (let _128_787 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (t, _128_787))
in (FStar_ToSMT_Term.mkApp _128_788))
in (_128_789, []))
end
| None -> begin
(match ((is_eta env vars body)) with
...
let f = (let _128_791 = (let _128_790 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (fsym, _128_790))
in (FStar_ToSMT_Term.mkApp _128_791))
in (
...
let typing_f = (let _128_793 = (let _128_792 = (FStar_ToSMT_Term.mkForall (((f)::[])::[], cvars, f_has_t))
in (_128_792, Some ((Prims.strcat fsym " typing"))))
in FStar_ToSMT_Term.Assume (_128_793))
in (
# 834 "FStar.ToSMT.Encode.fst"
let interp_f = (let _128_800 = (let _128_799 = (let _128_798 = (let _128_797 = (let _128_796 = (let _128_795 = (FStar_ToSMT_Term.mk_IsTyped app)
in (let _128_794 = (FStar_ToSMT_Term.mkEq (app, body))
in (_128_795, _128_794)))
in (FStar_ToSMT_Term.mkImp _128_796))
in (((app)::[])::[], (FStar_List.append vars cvars), _128_797))
in (FStar_ToSMT_Term.mkForall _128_798))
in (_128_799, Some ((Prims.strcat fsym " interpretation"))))
in FStar_ToSMT_Term.Assume (_128_800))
in (
...
| (v2, decls2) -> begin
(let _128_801 = (FStar_ToSMT_Term.mk_LexCons v1 v2)
in (_128_801, (FStar_List.append decls1 decls2)))
end))
end))
end
...
(let _128_802 = (whnf_e env e)
in (encode_exp _128_802 env))
end
...
let ty = (let _128_805 = (FStar_Absyn_Syntax.mk_Typ_fun (rest, c) (Some (FStar_Absyn_Syntax.ktype)) e0.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _128_805 (FStar_Absyn_Util.subst_typ subst)))
in (
...
let e_typing = (let _128_807 = (let _128_806 = (FStar_ToSMT_Term.mkForall (((has_type)::[])::[], cvars, has_type))
in (_128_806, None))
in FStar_ToSMT_Term.Assume (_128_807))
...
let tm = (let _128_813 = (let _128_812 = (let _128_811 = (FStar_List.map (fun _46_11 -> (match (_46_11) with
| (FStar_Util.Inl (t)) | (FStar_Util.Inr (t)) -> begin
t
end)) args)
in (FStar_List.append fuel_args _128_811))
in (fname, _128_812))
in (FStar_ToSMT_Term.mkApp' _128_813))
in (tm, decls))
end)))
in (
...
(let _128_815 = (FStar_Absyn_Print.exp_to_string head)
in (let _128_814 = (FStar_Absyn_Print.exp_to_string e)
...
let head_type = (let _128_818 = (let _128_817 = (let _128_816 = (FStar_Tc_Recheck.recompute_typ head)
in (FStar_Absyn_Util.unrefine _128_816))
in (whnf env _128_817))
in (FStar_All.pipe_left FStar_Absyn_Util.unrefine _128_818))
in (
...
(let _128_821 = (FStar_Absyn_Print.exp_to_string head)
in (let _128_820 = (FStar_Absyn_Print.tag_of_exp head)
in (let _128_819 = (FStar_Absyn_Print.typ_to_string head_type)
in (FStar_Util.print3 "Recomputed type of head %s (%s) to be %s\n" _128_821 _128_820 _128_819))))
end else begin
()
end
in (match ((FStar_Absyn_Util.function_formals head_type)) with
| None -> begin
(let _128_825 = (let _128_824 = (FStar_Range.string_of_range e0.FStar_Absyn_Syntax.pos)
in (let _128_823 = (FStar_Absyn_Print.exp_to_string e0)
in (let _128_822 = (FStar_Absyn_Print.typ_to_string head_type)
in (FStar_Util.format3 "(%s) term is %s; head type is %s\n" _128_824 _128_823 _128_822))))
in (FStar_All.failwith _128_825))
end
| Some (formals, c) -> begin
...
in (let _128_826 = (FStar_ToSMT_Term.mkFreeV (e, FStar_ToSMT_Term.Term_sort))
in (_128_826, (decl_e)::[])))))
end
...
| (w, decls2) -> begin
(let _128_837 = (let _128_836 = (let _128_835 = (let _128_834 = (let _128_833 = (FStar_ToSMT_Term.boxBool FStar_ToSMT_Term.mkTrue)
in (w, _128_833))
in (FStar_ToSMT_Term.mkEq _128_834))
in (guard, _128_835))
in (FStar_ToSMT_Term.mkAnd _128_836))
in (_128_837, decls2))
end))
end)
...
| (br, decls3) -> begin
(let _128_838 = (FStar_ToSMT_Term.mkITE (guard, br, else_case))
in (_128_838, (FStar_List.append (FStar_List.append decls decls2) decls3)))
end))
end)))))
...
(let _128_841 = (let _128_840 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _128_839 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format2 "(%s): Impossible: encode_exp got %s" _128_840 _128_839)))
in (FStar_All.failwith _128_841))
end))))
...
| _46_1357 -> begin
(let _128_844 = (encode_one_pat env pat)
in (_128_844)::[])
end))
...
(let _128_847 = (FStar_Absyn_Print.pat_to_string pat)
...
(let _128_855 = (let _128_854 = (encode_const c)
in (scrutinee, _128_854))
in (FStar_ToSMT_Term.mkEq _128_855))
end
...
in (let _128_858 = (FStar_ToSMT_Term.mkApp (proj, (scrutinee)::[]))
in (mk_guard arg _128_858)))
end))))
...
(let _128_866 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _46_1459 -> (match (_46_1459) with
| (arg, _46_1458) -> begin
(
# 993 "FStar.ToSMT.Encode.fst"
let proj = (primitive_projector_by_pos env.tcenv f.FStar_Absyn_Syntax.v i)
in (let _128_865 = (FStar_ToSMT_Term.mkApp (proj, (scrutinee)::[]))
in (mk_projections arg _128_865)))
end))))
in (FStar_All.pipe_right _128_866 FStar_List.flatten))
end))
in (
...
let rec list_elements = (fun e -> (match ((let _128_881 = (FStar_Absyn_Util.unmeta_exp e)
in _128_881.FStar_Absyn_Syntax.n)) with
...
let v_or_t_pat = (fun p -> (match ((let _128_885 = (FStar_Absyn_Util.unmeta_exp p)
in _128_885.FStar_Absyn_Syntax.n)) with
...
(let _128_890 = (list_elements e)
in (FStar_All.pipe_right _128_890 (FStar_List.map (fun branch -> (let _128_889 = (list_elements branch)
in (FStar_All.pipe_right _128_889 (FStar_List.map v_or_t_pat)))))))
end
| _46_1650 -> begin
(let _128_891 = (FStar_All.pipe_right elts (FStar_List.map v_or_t_pat))
in (_128_891)::[])
end)))
in (
# 1047 "FStar.ToSMT.Encode.fst"
let _46_1693 = (match ((let _128_892 = (FStar_Absyn_Util.compress_typ t)
in _128_892.FStar_Absyn_Syntax.n)) with
...
in (let _128_893 = (lemma_pats pats')
in (binders, pre, post, _128_893)))
end
| _46_1686 -> begin
...
let _46_1720 = (let _128_897 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (
# 1063 "FStar.ToSMT.Encode.fst"
let _46_1717 = (let _128_896 = (FStar_All.pipe_right branch (FStar_List.map (fun _46_12 -> (match (_46_12) with
...
in (FStar_All.pipe_right _128_896 FStar_List.unzip))
in (match (_46_1717) with
| (pats, decls) -> begin
(pats, decls)
end)))))
in (FStar_All.pipe_right _128_897 FStar_List.unzip))
...
| l::[] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _128_900 = (let _128_899 = (FStar_ToSMT_Term.mkFreeV l)
in (FStar_ToSMT_Term.mk_Precedes _128_899 e))
in (_128_900)::p))))
end
| _46_1730 -> begin
(
...
| [] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _128_906 = (FStar_ToSMT_Term.mk_Precedes tl e)
in (_128_906)::p))))
end
| (x, FStar_ToSMT_Term.Term_sort)::vars -> begin
(let _128_908 = (let _128_907 = (FStar_ToSMT_Term.mkFreeV (x, FStar_ToSMT_Term.Term_sort))
in (FStar_ToSMT_Term.mk_LexCons _128_907 tl))
in (aux _128_908 vars))
end
| _46_1742 -> begin
pats
end))
in (let _128_909 = (FStar_ToSMT_Term.mkFreeV ("Prims.LexTop", FStar_ToSMT_Term.Term_sort))
in (aux _128_909 vars)))
end)
end)
in (
...
let _46_1749 = (let _128_910 = (FStar_Absyn_Util.unmeta_typ pre)
in (encode_formula _128_910 env))
in (match (_46_1749) with
| (pre, decls'') -> begin
(
# 1087 "FStar.ToSMT.Encode.fst"
let _46_1752 = (let _128_911 = (FStar_Absyn_Util.unmeta_typ post)
in (encode_formula _128_911 env))
...
in (let _128_916 = (let _128_915 = (let _128_914 = (let _128_913 = (let _128_912 = (FStar_ToSMT_Term.mk_and_l ((pre)::guards))
in (_128_912, post))
in (FStar_ToSMT_Term.mkImp _128_913))
in (pats, vars, _128_914))
in (FStar_ToSMT_Term.mkForall _128_915))
in (_128_916, decls)))
end))
end)))))
end))
...
let un_op = (fun f l -> (let _128_964 = (FStar_List.hd l)
in (FStar_All.pipe_left f _128_964)))
in (
...
(let _128_978 = (FStar_ToSMT_Term.mkImp (l2, l1))
in (_128_978, (FStar_List.append labs1 labs2), (FStar_List.append decls1 decls2)))
end))
end)
end))
end
...
let unboxInt_l = (fun f l -> (let _128_990 = (FStar_List.map FStar_ToSMT_Term.unboxInt l)
in (f _128_990)))
in (
# 1141 "FStar.ToSMT.Encode.fst"
let connectives = (let _128_1051 = (let _128_999 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkAnd))
in (FStar_Absyn_Const.and_lid, _128_999))
in (let _128_1050 = (let _128_1049 = (let _128_1005 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkOr))
in (FStar_Absyn_Const.or_lid, _128_1005))
in (let _128_1048 = (let _128_1047 = (let _128_1046 = (let _128_1014 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkIff))
in (FStar_Absyn_Const.iff_lid, _128_1014))
in (let _128_1045 = (let _128_1044 = (let _128_1043 = (let _128_1023 = (FStar_All.pipe_left enc_prop_c (un_op FStar_ToSMT_Term.mkNot))
in (FStar_Absyn_Const.not_lid, _128_1023))
in (let _128_1042 = (let _128_1041 = (let _128_1029 = (FStar_All.pipe_left enc (bin_op FStar_ToSMT_Term.mkEq))
in (FStar_Absyn_Const.eqT_lid, _128_1029))
in (_128_1041)::((FStar_Absyn_Const.eq2_lid, eq_op))::((FStar_Absyn_Const.true_lid, (const_op FStar_ToSMT_Term.mkTrue)))::((FStar_Absyn_Const.false_lid, (const_op FStar_ToSMT_Term.mkFalse)))::[])
in (_128_1043)::_128_1042))
in ((FStar_Absyn_Const.ite_lid, mk_ite))::_128_1044)
in (_128_1046)::_128_1045))
in ((FStar_Absyn_Const.imp_lid, mk_imp))::_128_1047)
in (_128_1049)::_128_1048))
in (_128_1051)::_128_1050))
in (
...
let lvar = (let _128_1054 = (varops.fresh "label")
in (_128_1054, FStar_ToSMT_Term.Bool_sort))
in (
...
| (tt, decls) -> begin
(let _128_1055 = (FStar_ToSMT_Term.mk_Valid tt)
in (_128_1055, [], decls))
end))
end))
in (
...
let _46_2004 = (let _128_1067 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (
# 1188 "FStar.ToSMT.Encode.fst"
let _46_2001 = (let _128_1066 = (FStar_All.pipe_right p (FStar_List.map (fun _46_17 -> (match (_46_17) with
...
in (FStar_All.pipe_right _128_1066 FStar_List.unzip))
in (match (_46_2001) with
| (p, decls) -> begin
(p, (FStar_List.flatten decls))
end)))))
in (FStar_All.pipe_right _128_1067 FStar_List.unzip))
...
(let _128_1068 = (FStar_ToSMT_Term.mk_and_l guards)
in (vars, pats, _128_1068, body, labs, (FStar_List.append (FStar_List.append decls (FStar_List.flatten decls')) decls'')))
end))
end))
end)))
in (
...
(let _128_1069 = (FStar_Absyn_Print.formula_to_string phi)
...
(let _128_1086 = (FStar_All.pipe_right vars (FStar_Absyn_Print.binders_to_string "; "))
...
(let _128_1089 = (let _128_1088 = (let _128_1087 = (FStar_ToSMT_Term.mkImp (guard, body))
in (pats, vars, _128_1087))
in (FStar_ToSMT_Term.mkForall _128_1088))
in (_128_1089, labs, decls))
end)))
end
...
| (vars, pats, guard, body, labs, decls) -> begin
(let _128_1092 = (let _128_1091 = (let _128_1090 = (FStar_ToSMT_Term.mkAnd (guard, body))
in (pats, vars, _128_1090))
in (FStar_ToSMT_Term.mkExists _128_1091))
in (_128_1092, labs, decls))
end))
end))))))))))))))))
...
let deffun = (fun vars body x -> (let _128_1127 = (let _128_1126 = (let _128_1125 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (let _128_1124 = (FStar_ToSMT_Term.abstr vars body)
in (x, _128_1125, FStar_ToSMT_Term.Term_sort, _128_1124, None)))
in FStar_ToSMT_Term.DefineFun (_128_1126))
in (_128_1127)::[]))
in (
# 1235 "FStar.ToSMT.Encode.fst"
let quant = (fun vars body x -> (
# 1236 "FStar.ToSMT.Encode.fst"
let t1 = (let _128_1139 = (let _128_1138 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (x, _128_1138))
in (FStar_ToSMT_Term.mkApp _128_1139))
in (
# 1237 "FStar.ToSMT.Encode.fst"
let vname_decl = (let _128_1141 = (let _128_1140 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (x, _128_1140, FStar_ToSMT_Term.Term_sort, None))
in FStar_ToSMT_Term.DeclFun (_128_1141))
in (let _128_1147 = (let _128_1146 = (let _128_1145 = (let _128_1144 = (let _128_1143 = (let _128_1142 = (FStar_ToSMT_Term.mkEq (t1, body))
in (((t1)::[])::[], vars, _128_1142))
in (FStar_ToSMT_Term.mkForall _128_1143))
in (_128_1144, None))
in FStar_ToSMT_Term.Assume (_128_1145))
in (_128_1146)::[])
in (vname_decl)::_128_1147))))
in (
...
let prims = (let _128_1313 = (let _128_1162 = (let _128_1161 = (let _128_1160 = (FStar_ToSMT_Term.mkEq (x, y))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1160))
in (def_or_quant axy _128_1161))
in (FStar_Absyn_Const.op_Eq, _128_1162))
in (let _128_1312 = (let _128_1311 = (let _128_1169 = (let _128_1168 = (let _128_1167 = (let _128_1166 = (FStar_ToSMT_Term.mkEq (x, y))
in (FStar_ToSMT_Term.mkNot _128_1166))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1167))
in (def_or_quant axy _128_1168))
in (FStar_Absyn_Const.op_notEq, _128_1169))
in (let _128_1310 = (let _128_1309 = (let _128_1178 = (let _128_1177 = (let _128_1176 = (let _128_1175 = (let _128_1174 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1173 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1174, _128_1173)))
in (FStar_ToSMT_Term.mkLT _128_1175))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1176))
in (def_or_quant xy _128_1177))
in (FStar_Absyn_Const.op_LT, _128_1178))
in (let _128_1308 = (let _128_1307 = (let _128_1187 = (let _128_1186 = (let _128_1185 = (let _128_1184 = (let _128_1183 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1182 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1183, _128_1182)))
in (FStar_ToSMT_Term.mkLTE _128_1184))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1185))
in (def_or_quant xy _128_1186))
in (FStar_Absyn_Const.op_LTE, _128_1187))
in (let _128_1306 = (let _128_1305 = (let _128_1196 = (let _128_1195 = (let _128_1194 = (let _128_1193 = (let _128_1192 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1191 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1192, _128_1191)))
in (FStar_ToSMT_Term.mkGT _128_1193))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1194))
in (def_or_quant xy _128_1195))
in (FStar_Absyn_Const.op_GT, _128_1196))
in (let _128_1304 = (let _128_1303 = (let _128_1205 = (let _128_1204 = (let _128_1203 = (let _128_1202 = (let _128_1201 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1200 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1201, _128_1200)))
in (FStar_ToSMT_Term.mkGTE _128_1202))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1203))
in (def_or_quant xy _128_1204))
in (FStar_Absyn_Const.op_GTE, _128_1205))
in (let _128_1302 = (let _128_1301 = (let _128_1214 = (let _128_1213 = (let _128_1212 = (let _128_1211 = (let _128_1210 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1209 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1210, _128_1209)))
in (FStar_ToSMT_Term.mkSub _128_1211))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1212))
in (def_or_quant xy _128_1213))
in (FStar_Absyn_Const.op_Subtraction, _128_1214))
in (let _128_1300 = (let _128_1299 = (let _128_1221 = (let _128_1220 = (let _128_1219 = (let _128_1218 = (FStar_ToSMT_Term.unboxInt x)
in (FStar_ToSMT_Term.mkMinus _128_1218))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1219))
in (def_or_quant qx _128_1220))
in (FStar_Absyn_Const.op_Minus, _128_1221))
in (let _128_1298 = (let _128_1297 = (let _128_1230 = (let _128_1229 = (let _128_1228 = (let _128_1227 = (let _128_1226 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1225 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1226, _128_1225)))
in (FStar_ToSMT_Term.mkAdd _128_1227))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1228))
in (def_or_quant xy _128_1229))
in (FStar_Absyn_Const.op_Addition, _128_1230))
in (let _128_1296 = (let _128_1295 = (let _128_1239 = (let _128_1238 = (let _128_1237 = (let _128_1236 = (let _128_1235 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1234 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1235, _128_1234)))
in (FStar_ToSMT_Term.mkMul _128_1236))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1237))
in (def_or_quant xy _128_1238))
in (FStar_Absyn_Const.op_Multiply, _128_1239))
in (let _128_1294 = (let _128_1293 = (let _128_1248 = (let _128_1247 = (let _128_1246 = (let _128_1245 = (let _128_1244 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1243 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1244, _128_1243)))
in (FStar_ToSMT_Term.mkDiv _128_1245))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1246))
in (def_or_quant xy _128_1247))
in (FStar_Absyn_Const.op_Division, _128_1248))
in (let _128_1292 = (let _128_1291 = (let _128_1257 = (let _128_1256 = (let _128_1255 = (let _128_1254 = (let _128_1253 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1252 = (FStar_ToSMT_Term.unboxInt y)
in (_128_1253, _128_1252)))
in (FStar_ToSMT_Term.mkMod _128_1254))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _128_1255))
in (def_or_quant xy _128_1256))
in (FStar_Absyn_Const.op_Modulus, _128_1257))
in (let _128_1290 = (let _128_1289 = (let _128_1266 = (let _128_1265 = (let _128_1264 = (let _128_1263 = (let _128_1262 = (FStar_ToSMT_Term.unboxBool x)
in (let _128_1261 = (FStar_ToSMT_Term.unboxBool y)
in (_128_1262, _128_1261)))
in (FStar_ToSMT_Term.mkAnd _128_1263))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1264))
in (def_or_quant xy _128_1265))
in (FStar_Absyn_Const.op_And, _128_1266))
in (let _128_1288 = (let _128_1287 = (let _128_1275 = (let _128_1274 = (let _128_1273 = (let _128_1272 = (let _128_1271 = (FStar_ToSMT_Term.unboxBool x)
in (let _128_1270 = (FStar_ToSMT_Term.unboxBool y)
in (_128_1271, _128_1270)))
in (FStar_ToSMT_Term.mkOr _128_1272))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1273))
in (def_or_quant xy _128_1274))
in (FStar_Absyn_Const.op_Or, _128_1275))
in (let _128_1286 = (let _128_1285 = (let _128_1282 = (let _128_1281 = (let _128_1280 = (let _128_1279 = (FStar_ToSMT_Term.unboxBool x)
in (FStar_ToSMT_Term.mkNot _128_1279))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_1280))
in (def_or_quant qx _128_1281))
in (FStar_Absyn_Const.op_Negation, _128_1282))
in (_128_1285)::[])
in (_128_1287)::_128_1286))
in (_128_1289)::_128_1288))
in (_128_1291)::_128_1290))
in (_128_1293)::_128_1292))
in (_128_1295)::_128_1294))
in (_128_1297)::_128_1296))
in (_128_1299)::_128_1298))
in (_128_1301)::_128_1300))
in (_128_1303)::_128_1302))
in (_128_1305)::_128_1304))
in (_128_1307)::_128_1306))
in (_128_1309)::_128_1308))
in (_128_1311)::_128_1310))
in (_128_1313)::_128_1312))
in (
# 1264 "FStar.ToSMT.Encode.fst"
let mk = (fun l v -> (let _128_1345 = (FStar_All.pipe_right prims (FStar_List.filter (fun _46_2091 -> (match (_46_2091) with
| (l', _46_2090) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _128_1345 (FStar_List.collect (fun _46_2095 -> (match (_46_2095) with
| (_46_2093, b) -> begin
(b v)
end))))))
in (
...
in (let _128_1377 = (let _128_1368 = (let _128_1367 = (FStar_ToSMT_Term.mk_HasType FStar_ToSMT_Term.mk_Term_unit tt)
in (_128_1367, Some ("unit typing")))
in FStar_ToSMT_Term.Assume (_128_1368))
in (let _128_1376 = (let _128_1375 = (let _128_1374 = (let _128_1373 = (let _128_1372 = (let _128_1371 = (let _128_1370 = (let _128_1369 = (FStar_ToSMT_Term.mkEq (x, FStar_ToSMT_Term.mk_Term_unit))
in (typing_pred, _128_1369))
in (FStar_ToSMT_Term.mkImp _128_1370))
in (((typing_pred)::[])::[], (xx)::[], _128_1371))
in (mkForall_fuel _128_1372))
in (_128_1373, Some ("unit inversion")))
in FStar_ToSMT_Term.Assume (_128_1374))
in (_128_1375)::[])
in (_128_1377)::_128_1376))))
in (
...
in (let _128_1398 = (let _128_1387 = (let _128_1386 = (let _128_1385 = (let _128_1384 = (let _128_1383 = (let _128_1382 = (FStar_ToSMT_Term.mk_tester "BoxBool" x)
in (typing_pred, _128_1382))
in (FStar_ToSMT_Term.mkImp _128_1383))
in (((typing_pred)::[])::[], (xx)::[], _128_1384))
in (mkForall_fuel _128_1385))
in (_128_1386, Some ("bool inversion")))
in FStar_ToSMT_Term.Assume (_128_1387))
in (let _128_1397 = (let _128_1396 = (let _128_1395 = (let _128_1394 = (let _128_1393 = (let _128_1392 = (let _128_1389 = (let _128_1388 = (FStar_ToSMT_Term.boxBool b)
in (_128_1388)::[])
in (_128_1389)::[])
in (let _128_1391 = (let _128_1390 = (FStar_ToSMT_Term.boxBool b)
in (FStar_ToSMT_Term.mk_HasType _128_1390 tt))
in (_128_1392, (bb)::[], _128_1391)))
in (FStar_ToSMT_Term.mkForall _128_1393))
in (_128_1394, Some ("bool typing")))
in FStar_ToSMT_Term.Assume (_128_1395))
in (_128_1396)::[])
in (_128_1398)::_128_1397))))))
in (
...
let precedes = (let _128_1410 = (let _128_1409 = (let _128_1408 = (let _128_1407 = (let _128_1406 = (let _128_1405 = (FStar_ToSMT_Term.boxInt a)
in (let _128_1404 = (let _128_1403 = (FStar_ToSMT_Term.boxInt b)
in (_128_1403)::[])
in (_128_1405)::_128_1404))
in (tt)::_128_1406)
in (tt)::_128_1407)
in ("Prims.Precedes", _128_1408))
in (FStar_ToSMT_Term.mkApp _128_1409))
in (FStar_All.pipe_left FStar_ToSMT_Term.mk_Valid _128_1410))
in (
# 1296 "FStar.ToSMT.Encode.fst"
let precedes_y_x = (let _128_1411 = (FStar_ToSMT_Term.mkApp ("Precedes", (y)::(x)::[]))
in (FStar_All.pipe_left FStar_ToSMT_Term.mk_Valid _128_1411))
in (let _128_1453 = (let _128_1417 = (let _128_1416 = (let _128_1415 = (let _128_1414 = (let _128_1413 = (let _128_1412 = (FStar_ToSMT_Term.mk_tester "BoxInt" x)
in (typing_pred, _128_1412))
in (FStar_ToSMT_Term.mkImp _128_1413))
in (((typing_pred)::[])::[], (xx)::[], _128_1414))
in (mkForall_fuel _128_1415))
in (_128_1416, Some ("int inversion")))
in FStar_ToSMT_Term.Assume (_128_1417))
in (let _128_1452 = (let _128_1451 = (let _128_1425 = (let _128_1424 = (let _128_1423 = (let _128_1422 = (let _128_1419 = (let _128_1418 = (FStar_ToSMT_Term.boxInt b)
in (_128_1418)::[])
in (_128_1419)::[])
in (let _128_1421 = (let _128_1420 = (FStar_ToSMT_Term.boxInt b)
in (FStar_ToSMT_Term.mk_HasType _128_1420 tt))
in (_128_1422, (bb)::[], _128_1421)))
in (FStar_ToSMT_Term.mkForall _128_1423))
in (_128_1424, Some ("int typing")))
in FStar_ToSMT_Term.Assume (_128_1425))
in (let _128_1450 = (let _128_1449 = (let _128_1448 = (let _128_1447 = (let _128_1446 = (let _128_1445 = (let _128_1444 = (let _128_1443 = (let _128_1442 = (let _128_1441 = (let _128_1440 = (let _128_1439 = (let _128_1428 = (let _128_1427 = (FStar_ToSMT_Term.unboxInt x)
in (let _128_1426 = (FStar_ToSMT_Term.mkInteger' 0)
in (_128_1427, _128_1426)))
in (FStar_ToSMT_Term.mkGT _128_1428))
in (let _128_1438 = (let _128_1437 = (let _128_1431 = (let _128_1430 = (FStar_ToSMT_Term.unboxInt y)
in (let _128_1429 = (FStar_ToSMT_Term.mkInteger' 0)
in (_128_1430, _128_1429)))
in (FStar_ToSMT_Term.mkGTE _128_1431))
in (let _128_1436 = (let _128_1435 = (let _128_1434 = (let _128_1433 = (FStar_ToSMT_Term.unboxInt y)
in (let _128_1432 = (FStar_ToSMT_Term.unboxInt x)
in (_128_1433, _128_1432)))
in (FStar_ToSMT_Term.mkLT _128_1434))
in (_128_1435)::[])
in (_128_1437)::_128_1436))
in (_128_1439)::_128_1438))
in (typing_pred_y)::_128_1440)
in (typing_pred)::_128_1441)
in (FStar_ToSMT_Term.mk_and_l _128_1442))
in (_128_1443, precedes_y_x))
in (FStar_ToSMT_Term.mkImp _128_1444))
in (((typing_pred)::(typing_pred_y)::(precedes_y_x)::[])::[], (xx)::(yy)::[], _128_1445))
in (mkForall_fuel _128_1446))
in (_128_1447, Some ("well-founded ordering on nat (alt)")))
in FStar_ToSMT_Term.Assume (_128_1448))
in (_128_1449)::[])
in (_128_1451)::_128_1450))
in (_128_1453)::_128_1452)))))))))))
in (
# 1308 "FStar.ToSMT.Encode.fst"
let mk_int_alias = (fun _46_2131 tt -> (let _128_1462 = (let _128_1461 = (let _128_1460 = (let _128_1459 = (let _128_1458 = (FStar_ToSMT_Term.mkApp (FStar_Absyn_Const.int_lid.FStar_Ident.str, []))
in (tt, _128_1458))
in (FStar_ToSMT_Term.mkEq _128_1459))
in (_128_1460, Some ("mapping to int; for now")))
in FStar_ToSMT_Term.Assume (_128_1461))
in (_128_1462)::[]))
in (
...
let b = (FStar_ToSMT_Term.mkFreeV bb)
in (let _128_1483 = (let _128_1472 = (let _128_1471 = (let _128_1470 = (let _128_1469 = (let _128_1468 = (let _128_1467 = (FStar_ToSMT_Term.mk_tester "BoxString" x)
in (typing_pred, _128_1467))
in (FStar_ToSMT_Term.mkImp _128_1468))
in (((typing_pred)::[])::[], (xx)::[], _128_1469))
in (mkForall_fuel _128_1470))
in (_128_1471, Some ("string inversion")))
in FStar_ToSMT_Term.Assume (_128_1472))
in (let _128_1482 = (let _128_1481 = (let _128_1480 = (let _128_1479 = (let _128_1478 = (let _128_1477 = (let _128_1474 = (let _128_1473 = (FStar_ToSMT_Term.boxString b)
in (_128_1473)::[])
in (_128_1474)::[])
in (let _128_1476 = (let _128_1475 = (FStar_ToSMT_Term.boxString b)
in (FStar_ToSMT_Term.mk_HasType _128_1475 tt))
in (_128_1477, (bb)::[], _128_1476)))
in (FStar_ToSMT_Term.mkForall _128_1478))
in (_128_1479, Some ("string typing")))
in FStar_ToSMT_Term.Assume (_128_1480))
in (_128_1481)::[])
in (_128_1483)::_128_1482))))))
in (
...
let refa = (let _128_1490 = (let _128_1489 = (let _128_1488 = (FStar_ToSMT_Term.mkFreeV aa)
in (_128_1488)::[])
in (reft_name, _128_1489))
in (FStar_ToSMT_Term.mkApp _128_1490))
in (
# 1321 "FStar.ToSMT.Encode.fst"
let refb = (let _128_1493 = (let _128_1492 = (let _128_1491 = (FStar_ToSMT_Term.mkFreeV bb)
in (_128_1491)::[])
in (reft_name, _128_1492))
in (FStar_ToSMT_Term.mkApp _128_1493))
in (
...
in (let _128_1512 = (let _128_1499 = (let _128_1498 = (let _128_1497 = (let _128_1496 = (let _128_1495 = (let _128_1494 = (FStar_ToSMT_Term.mk_tester "BoxRef" x)
in (typing_pred, _128_1494))
in (FStar_ToSMT_Term.mkImp _128_1495))
in (((typing_pred)::[])::[], (xx)::(aa)::[], _128_1496))
in (mkForall_fuel _128_1497))
in (_128_1498, Some ("ref inversion")))
in FStar_ToSMT_Term.Assume (_128_1499))
in (let _128_1511 = (let _128_1510 = (let _128_1509 = (let _128_1508 = (let _128_1507 = (let _128_1506 = (let _128_1505 = (let _128_1504 = (FStar_ToSMT_Term.mkAnd (typing_pred, typing_pred_b))
in (let _128_1503 = (let _128_1502 = (let _128_1501 = (FStar_ToSMT_Term.mkFreeV aa)
in (let _128_1500 = (FStar_ToSMT_Term.mkFreeV bb)
in (_128_1501, _128_1500)))
in (FStar_ToSMT_Term.mkEq _128_1502))
in (_128_1504, _128_1503)))
in (FStar_ToSMT_Term.mkImp _128_1505))
in (((typing_pred)::(typing_pred_b)::[])::[], (xx)::(aa)::(bb)::[], _128_1506))
in (mkForall_fuel' 2 _128_1507))
in (_128_1508, Some ("ref typing is injective")))
in FStar_ToSMT_Term.Assume (_128_1509))
in (_128_1510)::[])
in (_128_1512)::_128_1511))))))))))
in (
...
in (let _128_1519 = (let _128_1518 = (let _128_1517 = (FStar_ToSMT_Term.mkIff (FStar_ToSMT_Term.mkFalse, valid))
in (_128_1517, Some ("False interpretation")))
in FStar_ToSMT_Term.Assume (_128_1518))
in (_128_1519)::[])))
in (
...
let valid = (let _128_1526 = (let _128_1525 = (let _128_1524 = (FStar_ToSMT_Term.mkApp (conj, (a)::(b)::[]))
in (_128_1524)::[])
in ("Valid", _128_1525))
in (FStar_ToSMT_Term.mkApp _128_1526))
in (
...
in (let _128_1533 = (let _128_1532 = (let _128_1531 = (let _128_1530 = (let _128_1529 = (let _128_1528 = (let _128_1527 = (FStar_ToSMT_Term.mkAnd (valid_a, valid_b))
in (_128_1527, valid))
in (FStar_ToSMT_Term.mkIff _128_1528))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1529))
in (FStar_ToSMT_Term.mkForall _128_1530))
in (_128_1531, Some ("/\\ interpretation")))
in FStar_ToSMT_Term.Assume (_128_1532))
in (_128_1533)::[])))))))))
in (
...
let valid = (let _128_1540 = (let _128_1539 = (let _128_1538 = (FStar_ToSMT_Term.mkApp (disj, (a)::(b)::[]))
in (_128_1538)::[])
in ("Valid", _128_1539))
in (FStar_ToSMT_Term.mkApp _128_1540))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _128_1547 = (let _128_1546 = (let _128_1545 = (let _128_1544 = (let _128_1543 = (let _128_1542 = (let _128_1541 = (FStar_ToSMT_Term.mkOr (valid_a, valid_b))
in (_128_1541, valid))
in (FStar_ToSMT_Term.mkIff _128_1542))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1543))
in (FStar_ToSMT_Term.mkForall _128_1544))
in (_128_1545, Some ("\\/ interpretation")))
in FStar_ToSMT_Term.Assume (_128_1546))
in (_128_1547)::[])))))))))
in (
...
let valid = (let _128_1554 = (let _128_1553 = (let _128_1552 = (FStar_ToSMT_Term.mkApp (eq2, (a)::(b)::(x)::(y)::[]))
in (_128_1552)::[])
in ("Valid", _128_1553))
in (FStar_ToSMT_Term.mkApp _128_1554))
in (let _128_1561 = (let _128_1560 = (let _128_1559 = (let _128_1558 = (let _128_1557 = (let _128_1556 = (let _128_1555 = (FStar_ToSMT_Term.mkEq (x, y))
in (_128_1555, valid))
in (FStar_ToSMT_Term.mkIff _128_1556))
in (((valid)::[])::[], (aa)::(bb)::(xx)::(yy)::[], _128_1557))
in (FStar_ToSMT_Term.mkForall _128_1558))
in (_128_1559, Some ("Eq2 interpretation")))
in FStar_ToSMT_Term.Assume (_128_1560))
in (_128_1561)::[])))))))))))
in (
...
let valid = (let _128_1568 = (let _128_1567 = (let _128_1566 = (FStar_ToSMT_Term.mkApp (imp, (a)::(b)::[]))
in (_128_1566)::[])
in ("Valid", _128_1567))
in (FStar_ToSMT_Term.mkApp _128_1568))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _128_1575 = (let _128_1574 = (let _128_1573 = (let _128_1572 = (let _128_1571 = (let _128_1570 = (let _128_1569 = (FStar_ToSMT_Term.mkImp (valid_a, valid_b))
in (_128_1569, valid))
in (FStar_ToSMT_Term.mkIff _128_1570))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1571))
in (FStar_ToSMT_Term.mkForall _128_1572))
in (_128_1573, Some ("==> interpretation")))
in FStar_ToSMT_Term.Assume (_128_1574))
in (_128_1575)::[])))))))))
in (
...
let valid = (let _128_1582 = (let _128_1581 = (let _128_1580 = (FStar_ToSMT_Term.mkApp (iff, (a)::(b)::[]))
in (_128_1580)::[])
in ("Valid", _128_1581))
in (FStar_ToSMT_Term.mkApp _128_1582))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _128_1589 = (let _128_1588 = (let _128_1587 = (let _128_1586 = (let _128_1585 = (let _128_1584 = (let _128_1583 = (FStar_ToSMT_Term.mkIff (valid_a, valid_b))
in (_128_1583, valid))
in (FStar_ToSMT_Term.mkIff _128_1584))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1585))
in (FStar_ToSMT_Term.mkForall _128_1586))
in (_128_1587, Some ("<==> interpretation")))
in FStar_ToSMT_Term.Assume (_128_1588))
in (_128_1589)::[])))))))))
in (
...
let valid = (let _128_1596 = (let _128_1595 = (let _128_1594 = (FStar_ToSMT_Term.mkApp (for_all, (a)::(b)::[]))
in (_128_1594)::[])
in ("Valid", _128_1595))
in (FStar_ToSMT_Term.mkApp _128_1596))
in (
# 1385 "FStar.ToSMT.Encode.fst"
let valid_b_x = (let _128_1599 = (let _128_1598 = (let _128_1597 = (FStar_ToSMT_Term.mk_ApplyTE b x)
in (_128_1597)::[])
in ("Valid", _128_1598))
in (FStar_ToSMT_Term.mkApp _128_1599))
in (let _128_1613 = (let _128_1612 = (let _128_1611 = (let _128_1610 = (let _128_1609 = (let _128_1608 = (let _128_1607 = (let _128_1606 = (let _128_1605 = (let _128_1601 = (let _128_1600 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_128_1600)::[])
in (_128_1601)::[])
in (let _128_1604 = (let _128_1603 = (let _128_1602 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_128_1602, valid_b_x))
in (FStar_ToSMT_Term.mkImp _128_1603))
in (_128_1605, (xx)::[], _128_1604)))
in (FStar_ToSMT_Term.mkForall _128_1606))
in (_128_1607, valid))
in (FStar_ToSMT_Term.mkIff _128_1608))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1609))
in (FStar_ToSMT_Term.mkForall _128_1610))
in (_128_1611, Some ("forall interpretation")))
in FStar_ToSMT_Term.Assume (_128_1612))
in (_128_1613)::[]))))))))))
in (
...
let valid = (let _128_1620 = (let _128_1619 = (let _128_1618 = (FStar_ToSMT_Term.mkApp (for_all, (a)::(b)::[]))
in (_128_1618)::[])
in ("Valid", _128_1619))
in (FStar_ToSMT_Term.mkApp _128_1620))
in (
# 1395 "FStar.ToSMT.Encode.fst"
let valid_b_x = (let _128_1623 = (let _128_1622 = (let _128_1621 = (FStar_ToSMT_Term.mk_ApplyTE b x)
in (_128_1621)::[])
in ("Valid", _128_1622))
in (FStar_ToSMT_Term.mkApp _128_1623))
in (let _128_1637 = (let _128_1636 = (let _128_1635 = (let _128_1634 = (let _128_1633 = (let _128_1632 = (let _128_1631 = (let _128_1630 = (let _128_1629 = (let _128_1625 = (let _128_1624 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_128_1624)::[])
in (_128_1625)::[])
in (let _128_1628 = (let _128_1627 = (let _128_1626 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_128_1626, valid_b_x))
in (FStar_ToSMT_Term.mkImp _128_1627))
in (_128_1629, (xx)::[], _128_1628)))
in (FStar_ToSMT_Term.mkExists _128_1630))
in (_128_1631, valid))
in (FStar_ToSMT_Term.mkIff _128_1632))
in (((valid)::[])::[], (aa)::(bb)::[], _128_1633))
in (FStar_ToSMT_Term.mkForall _128_1634))
in (_128_1635, Some ("exists interpretation")))
in FStar_ToSMT_Term.Assume (_128_1636))
in (_128_1637)::[]))))))))))
in (
...
let valid = (let _128_1644 = (let _128_1643 = (let _128_1642 = (FStar_ToSMT_Term.mkApp (for_all, (k)::(a)::[]))
in (_128_1642)::[])
in ("Valid", _128_1643))
in (FStar_ToSMT_Term.mkApp _128_1644))
in (
# 1405 "FStar.ToSMT.Encode.fst"
let valid_a_b = (let _128_1647 = (let _128_1646 = (let _128_1645 = (FStar_ToSMT_Term.mk_ApplyTE a b)
in (_128_1645)::[])
in ("Valid", _128_1646))
in (FStar_ToSMT_Term.mkApp _128_1647))
in (let _128_1661 = (let _128_1660 = (let _128_1659 = (let _128_1658 = (let _128_1657 = (let _128_1656 = (let _128_1655 = (let _128_1654 = (let _128_1653 = (let _128_1649 = (let _128_1648 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_128_1648)::[])
in (_128_1649)::[])
in (let _128_1652 = (let _128_1651 = (let _128_1650 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_128_1650, valid_a_b))
in (FStar_ToSMT_Term.mkImp _128_1651))
in (_128_1653, (bb)::[], _128_1652)))
in (FStar_ToSMT_Term.mkForall _128_1654))
in (_128_1655, valid))
in (FStar_ToSMT_Term.mkIff _128_1656))
in (((valid)::[])::[], (kk)::(aa)::[], _128_1657))
in (FStar_ToSMT_Term.mkForall _128_1658))
in (_128_1659, Some ("ForallTyp interpretation")))
in FStar_ToSMT_Term.Assume (_128_1660))
in (_128_1661)::[]))))))))))
in (
...
let valid = (let _128_1668 = (let _128_1667 = (let _128_1666 = (FStar_ToSMT_Term.mkApp (for_some, (k)::(a)::[]))
in (_128_1666)::[])
in ("Valid", _128_1667))
in (FStar_ToSMT_Term.mkApp _128_1668))
in (
# 1415 "FStar.ToSMT.Encode.fst"
let valid_a_b = (let _128_1671 = (let _128_1670 = (let _128_1669 = (FStar_ToSMT_Term.mk_ApplyTE a b)
in (_128_1669)::[])
in ("Valid", _128_1670))
in (FStar_ToSMT_Term.mkApp _128_1671))
in (let _128_1685 = (let _128_1684 = (let _128_1683 = (let _128_1682 = (let _128_1681 = (let _128_1680 = (let _128_1679 = (let _128_1678 = (let _128_1677 = (let _128_1673 = (let _128_1672 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_128_1672)::[])
in (_128_1673)::[])
in (let _128_1676 = (let _128_1675 = (let _128_1674 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_128_1674, valid_a_b))
in (FStar_ToSMT_Term.mkImp _128_1675))
in (_128_1677, (bb)::[], _128_1676)))
in (FStar_ToSMT_Term.mkExists _128_1678))
in (_128_1679, valid))
in (FStar_ToSMT_Term.mkIff _128_1680))
in (((valid)::[])::[], (kk)::(aa)::[], _128_1681))
in (FStar_ToSMT_Term.mkForall _128_1682))
in (_128_1683, Some ("ExistsTyp interpretation")))
in FStar_ToSMT_Term.Assume (_128_1684))
in (_128_1685)::[]))))))))))
in (
...
(let _128_1828 = (FStar_Absyn_Print.sigelt_to_string se)
...
(match (g) with
| [] -> begin
(let _128_1831 = (let _128_1830 = (let _128_1829 = (FStar_Util.format1 "<Skipped %s/>" nm)
in FStar_ToSMT_Term.Caption (_128_1829))
in (_128_1830)::[])
in (_128_1831, e))
end
| _46_2283 -> begin
(let _128_1838 = (let _128_1837 = (let _128_1833 = (let _128_1832 = (FStar_Util.format1 "<Start encoding %s>" nm)
in FStar_ToSMT_Term.Caption (_128_1832))
in (_128_1833)::g)
in (let _128_1836 = (let _128_1835 = (let _128_1834 = (FStar_Util.format1 "</end encoding %s>" nm)
in FStar_ToSMT_Term.Caption (_128_1834))
in (_128_1835)::[])
in (FStar_List.append _128_1837 _128_1836)))
in (_128_1838, e))
end)
end)))))
...
(let _128_1852 = (let _128_1851 = (encode_smt_lemma env lid t)
in (FStar_List.append decls _128_1851))
in (_128_1852, env))
end else begin
(decls, env)
end
...
let _46_2307 = (let _128_1861 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (encode_top_level_val env _128_1861 lb.FStar_Absyn_Syntax.lbtyp quals))
...
let valid_b2t_x = (let _128_1864 = (let _128_1863 = (let _128_1862 = (FStar_ToSMT_Term.mkApp ("Prims.b2t", (x)::[]))
in (_128_1862)::[])
in ("Valid", _128_1863))
in (FStar_ToSMT_Term.mkApp _128_1864))
in (
# 1484 "FStar.ToSMT.Encode.fst"
let decls = (let _128_1872 = (let _128_1871 = (let _128_1870 = (let _128_1869 = (let _128_1868 = (let _128_1867 = (let _128_1866 = (let _128_1865 = (FStar_ToSMT_Term.mkApp ("BoxBool_proj_0", (x)::[]))
in (valid_b2t_x, _128_1865))
in (FStar_ToSMT_Term.mkEq _128_1866))
in (((valid_b2t_x)::[])::[], (xx)::[], _128_1867))
in (FStar_ToSMT_Term.mkForall _128_1868))
in (_128_1869, Some ("b2t def")))
in FStar_ToSMT_Term.Assume (_128_1870))
in (_128_1871)::[])
in (FStar_ToSMT_Term.DeclFun ((tname, (FStar_ToSMT_Term.Term_sort)::[], FStar_ToSMT_Term.Type_sort, None)))::_128_1872)
in (decls, env)))))
end))
end
...
let tok_app = (let _128_1873 = (FStar_ToSMT_Term.mkApp (ttok, []))
in (mk_ApplyT _128_1873 vars))
in (
...
let app = (let _128_1875 = (let _128_1874 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _128_1874))
in (FStar_ToSMT_Term.mkApp _128_1875))
in (
...
| _46_2391 -> begin
(let _128_1877 = (let _128_1876 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _128_1876))
in (_128_1877)::[])
end)
in (
# 1502 "FStar.ToSMT.Encode.fst"
let decls = (let _128_1888 = (let _128_1881 = (let _128_1880 = (let _128_1879 = (let _128_1878 = (FStar_List.map Prims.snd vars)
in (tname, _128_1878, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_128_1879))
in (_128_1880)::(tok_decl)::[])
in (FStar_List.append _128_1881 fresh_tok))
in (let _128_1887 = (let _128_1886 = (let _128_1885 = (let _128_1884 = (let _128_1883 = (let _128_1882 = (FStar_ToSMT_Term.mkEq (tok_app, app))
in (((tok_app)::[])::[], vars, _128_1882))
in (FStar_ToSMT_Term.mkForall _128_1883))
in (_128_1884, Some ("name-token correspondence")))
in FStar_ToSMT_Term.Assume (_128_1885))
in (_128_1886)::[])
in (FStar_List.append _128_1888 _128_1887)))
in (
...
(let _128_1891 = (FStar_ToSMT_Term.mk_Valid app)
in (let _128_1890 = (encode_formula t env')
in (_128_1891, _128_1890)))
end else begin
(let _128_1892 = (encode_typ_term t env')
in (app, _128_1892))
end
...
let abbrev_def = (let _128_1899 = (let _128_1898 = (let _128_1897 = (let _128_1896 = (let _128_1895 = (let _128_1894 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _128_1893 = (FStar_ToSMT_Term.mkEq (def, body))
in (_128_1894, _128_1893)))
in (FStar_ToSMT_Term.mkImp _128_1895))
in (((def)::[])::[], vars, _128_1896))
in (FStar_ToSMT_Term.mkForall _128_1897))
in (_128_1898, Some ("abbrev. elimination")))
in FStar_ToSMT_Term.Assume (_128_1899))
in (
# 1514 "FStar.ToSMT.Encode.fst"
let kindingAx = (
# 1515 "FStar.ToSMT.Encode.fst"
let _46_2407 = (let _128_1900 = (FStar_Tc_Recheck.recompute_kind t)
in (encode_knd _128_1900 env' app))
in (match (_46_2407) with
| (k, decls) -> begin
(let _128_1908 = (let _128_1907 = (let _128_1906 = (let _128_1905 = (let _128_1904 = (let _128_1903 = (let _128_1902 = (let _128_1901 = (FStar_ToSMT_Term.mk_and_l guards)
in (_128_1901, k))
in (FStar_ToSMT_Term.mkImp _128_1902))
in (((app)::[])::[], vars, _128_1903))
in (FStar_ToSMT_Term.mkForall _128_1904))
in (_128_1905, Some ("abbrev. kinding")))
in FStar_ToSMT_Term.Assume (_128_1906))
in (_128_1907)::[])
in (FStar_List.append decls _128_1908))
end))
in (
# 1517 "FStar.ToSMT.Encode.fst"
let g = (let _128_1909 = (primitive_type_axioms lid tname app)
in (FStar_List.append (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls) decls1) ((abbrev_def)::kindingAx)) _128_1909))
in (g, env))))
end))))))))
end))
end))
...
let g = (let _128_1914 = (let _128_1913 = (let _128_1912 = (let _128_1911 = (let _128_1910 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format1 "Assumption: %s" _128_1910))
in Some (_128_1911))
in (f, _128_1912))
in FStar_ToSMT_Term.Assume (_128_1913))
in (_128_1914)::[])
...
in (let _128_1916 = (let _128_1915 = (primitive_type_axioms t tname tsym)
in (decl)::_128_1915)
in (_128_1916, (push_free_tvar env t tname (Some (tsym))))))))
end
...
(let _128_1922 = (let _128_1921 = (let _128_1920 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in (name, _128_1920, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_128_1921))
in (_128_1922)::[])
end))
end else begin
...
let inversion_axioms = (fun tapp vars -> if (((FStar_List.length datas) = 0) || (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _128_1928 = (FStar_Tc_Env.lookup_qname env.tcenv l)
in (FStar_All.pipe_right _128_1928 FStar_Option.isNone)))))) then begin
[]
end else begin
(
...
let indices = (match ((let _128_1931 = (FStar_Absyn_Util.compress_typ res)
in _128_1931.FStar_Absyn_Syntax.n)) with
...
| FStar_Util.Inl (a) -> begin
(let _128_1936 = (let _128_1935 = (let _128_1934 = (mk_typ_projector_name l a.FStar_Absyn_Syntax.v)
in (_128_1934, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _128_1935))
in (push_typ_var env a.FStar_Absyn_Syntax.v _128_1936))
end
| FStar_Util.Inr (x) -> begin
(let _128_1939 = (let _128_1938 = (let _128_1937 = (mk_term_projector_name l x.FStar_Absyn_Syntax.v)
in (_128_1937, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _128_1938))
in (push_term_var env x.FStar_Absyn_Syntax.v _128_1939))
end)) env))
in (
...
let eqs = (let _128_1946 = (FStar_List.map2 (fun v a -> (match (a) with
| FStar_Util.Inl (a) -> begin
(let _128_1943 = (let _128_1942 = (FStar_ToSMT_Term.mkFreeV v)
in (_128_1942, a))
in (FStar_ToSMT_Term.mkEq _128_1943))
end
| FStar_Util.Inr (a) -> begin
(let _128_1945 = (let _128_1944 = (FStar_ToSMT_Term.mkFreeV v)
in (_128_1944, a))
in (FStar_ToSMT_Term.mkEq _128_1945))
end)) vars indices)
in (FStar_All.pipe_right _128_1946 FStar_ToSMT_Term.mk_and_l))
in (let _128_1951 = (let _128_1950 = (let _128_1949 = (let _128_1948 = (let _128_1947 = (mk_data_tester env l xx)
in (_128_1947, eqs))
in (FStar_ToSMT_Term.mkAnd _128_1948))
in (out, _128_1949))
in (FStar_ToSMT_Term.mkOr _128_1950))
in (_128_1951, (FStar_List.append decls decls')))))
end))))
end)))
...
let xx_has_type = (let _128_1952 = (FStar_ToSMT_Term.mkApp ("SFuel", (ff)::[]))
in (FStar_ToSMT_Term.mk_HasTypeFuel _128_1952 xx tapp))
in (let _128_1959 = (let _128_1958 = (let _128_1957 = (let _128_1956 = (let _128_1955 = (let _128_1954 = (add_fuel (ffsym, FStar_ToSMT_Term.Fuel_sort) (((xxsym, FStar_ToSMT_Term.Term_sort))::vars))
in (let _128_1953 = (FStar_ToSMT_Term.mkImp (xx_has_type, data_ax))
in (((xx_has_type)::[])::[], _128_1954, _128_1953)))
in (FStar_ToSMT_Term.mkForall _128_1955))
in (_128_1956, Some ("inversion axiom")))
in FStar_ToSMT_Term.Assume (_128_1957))
in (_128_1958)::[])
in (FStar_List.append decls _128_1959)))
end))
end))
end))
end)
...
let _46_2552 = (match ((let _128_1960 = (FStar_Absyn_Util.compress_kind k)
in _128_1960.FStar_Absyn_Syntax.n)) with
...
let dproj_app = (let _128_1974 = (let _128_1973 = (let _128_1972 = (mk_typ_projector_name d a)
in (let _128_1971 = (let _128_1970 = (FStar_ToSMT_Term.mkFreeV xx)
in (_128_1970)::[])
in (_128_1972, _128_1971)))
in (FStar_ToSMT_Term.mkApp _128_1973))
in (mk_ApplyT _128_1974 suffix))
in (let _128_1979 = (let _128_1978 = (let _128_1977 = (let _128_1976 = (let _128_1975 = (FStar_ToSMT_Term.mkEq (tapp, dproj_app))
in (((tapp)::[])::[], vars, _128_1975))
in (FStar_ToSMT_Term.mkForall _128_1976))
in (_128_1977, Some ("projector axiom")))
in FStar_ToSMT_Term.Assume (_128_1978))
in (_128_1979)::[]))
end))))
end
| _46_2601 -> begin
...
in (let _128_1992 = (let _128_1991 = (let _128_1990 = (let _128_1989 = (let _128_1988 = (let _128_1987 = (let _128_1986 = (let _128_1985 = (let _128_1984 = (FStar_ToSMT_Term.mkApp ("PreType", (xx)::[]))
in (tapp, _128_1984))
in (FStar_ToSMT_Term.mkEq _128_1985))
in (xx_has_type, _128_1986))
in (FStar_ToSMT_Term.mkImp _128_1987))
in (((xx_has_type)::[])::[], ((xxsym, FStar_ToSMT_Term.Term_sort))::((ffsym, FStar_ToSMT_Term.Fuel_sort))::vars, _128_1988))
in (FStar_ToSMT_Term.mkForall _128_1989))
in (_128_1990, Some ("pretyping")))
in FStar_ToSMT_Term.Assume (_128_1991))
in (_128_1992)::[]))
end))
end)))
in (
...
let tapp = (let _128_1994 = (let _128_1993 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _128_1993))
in (FStar_ToSMT_Term.mkApp _128_1994))
in (
# 1613 "FStar.ToSMT.Encode.fst"
let _46_2636 = (
# 1614 "FStar.ToSMT.Encode.fst"
let tname_decl = (let _128_1998 = (let _128_1997 = (FStar_All.pipe_right vars (FStar_List.map (fun _46_2621 -> (match (_46_2621) with
| (n, s) -> begin
((Prims.strcat tname n), s)
end))))
in (let _128_1996 = (varops.next_id ())
in (tname, _128_1997, FStar_ToSMT_Term.Type_sort, _128_1996)))
in (constructor_or_logic_type_decl _128_1998))
in (
# 1615 "FStar.ToSMT.Encode.fst"
let _46_2633 = (match (vars) with
| [] -> begin
(let _128_2002 = (let _128_2001 = (let _128_2000 = (FStar_ToSMT_Term.mkApp (tname, []))
in (FStar_All.pipe_left (fun _128_1999 -> Some (_128_1999)) _128_2000))
in (push_free_tvar env t tname _128_2001))
in ([], _128_2002))
end
| _46_2625 -> begin
(
...
let ttok_fresh = (let _128_2003 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _128_2003))
in (
...
let name_tok_corr = (let _128_2007 = (let _128_2006 = (let _128_2005 = (let _128_2004 = (FStar_ToSMT_Term.mkEq (ttok_app, tapp))
in (pats, None, vars, _128_2004))
in (FStar_ToSMT_Term.mkForall' _128_2005))
in (_128_2006, Some ("name-token correspondence")))
in FStar_ToSMT_Term.Assume (_128_2007))
...
(let _128_2011 = (let _128_2010 = (let _128_2009 = (let _128_2008 = (FStar_ToSMT_Term.mk_PreKind ttok_tm)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _128_2008))
in (_128_2009, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_128_2010))
in (_128_2011)::[])
end else begin
[]
end
in (let _128_2017 = (let _128_2016 = (let _128_2015 = (let _128_2014 = (let _128_2013 = (let _128_2012 = (FStar_ToSMT_Term.mkImp (guard, k))
in (((tapp)::[])::[], vars, _128_2012))
in (FStar_ToSMT_Term.mkForall _128_2013))
in (_128_2014, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_128_2015))
in (_128_2016)::[])
in (FStar_List.append (FStar_List.append decls karr) _128_2017)))
end))
in (
# 1638 "FStar.ToSMT.Encode.fst"
let aux = if is_logical then begin
(let _128_2018 = (projection_axioms tapp vars)
in (FStar_List.append kindingAx _128_2018))
end else begin
(let _128_2025 = (let _128_2023 = (let _128_2021 = (let _128_2019 = (primitive_type_axioms t tname tapp)
in (FStar_List.append kindingAx _128_2019))
in (let _128_2020 = (inversion_axioms tapp vars)
in (FStar_List.append _128_2021 _128_2020)))
in (let _128_2022 = (projection_axioms tapp vars)
in (FStar_List.append _128_2023 _128_2022)))
in (let _128_2024 = (pretype_axioms tapp vars)
in (FStar_List.append _128_2025 _128_2024)))
end
in (
...
let t = (let _128_2027 = (FStar_List.map (fun _46_2674 -> (match (_46_2674) with
| (x, _46_2673) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit (true)))
end)) tps)
in (FStar_Absyn_Util.close_typ _128_2027 t))
in (
...
| FStar_Util.Inl (a) -> begin
(let _128_2029 = (mk_typ_projector_name d a)
in (_128_2029, FStar_ToSMT_Term.Type_sort))
end
| FStar_Util.Inr (x) -> begin
(let _128_2030 = (mk_term_projector_name d x)
in (_128_2030, FStar_ToSMT_Term.Term_sort))
end))))
in (
# 1667 "FStar.ToSMT.Encode.fst"
let datacons = (let _128_2032 = (let _128_2031 = (varops.next_id ())
in (ddconstrsym, projectors, FStar_ToSMT_Term.Term_sort, _128_2031))
in (FStar_All.pipe_right _128_2032 FStar_ToSMT_Term.constructor_to_decl))
in (
...
| _46_2728 -> begin
(let _128_2034 = (let _128_2033 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ddtok, FStar_ToSMT_Term.Term_sort) _128_2033))
in (_128_2034)::[])
end)
in (
...
| (head, args) -> begin
(match ((let _128_2037 = (FStar_Absyn_Util.compress_typ head)
in _128_2037.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
(
...
let _46_2752 = (let _128_2040 = (FStar_Absyn_Util.new_bvd None)
in (gen_typ_var env _128_2040))
in (match (_46_2752) with
| (_46_2749, tv, env) -> begin
(let _128_2042 = (let _128_2041 = (FStar_ToSMT_Term.mkEq (targ, tv))
in (_128_2041)::eqns)
in (env, (tv)::arg_vars, _128_2042))
end))
end
| FStar_Util.Inr (varg) -> begin
(
# 1697 "FStar.ToSMT.Encode.fst"
let _46_2759 = (let _128_2043 = (FStar_Absyn_Util.new_bvd None)
in (gen_term_var env _128_2043))
in (match (_46_2759) with
| (_46_2756, xv, env) -> begin
(let _128_2045 = (let _128_2044 = (FStar_ToSMT_Term.mkEq (varg, xv))
in (_128_2044)::eqns)
in (env, (xv)::arg_vars, _128_2045))
end))
end)
...
let typing_inversion = (let _128_2052 = (let _128_2051 = (let _128_2050 = (let _128_2049 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _128_2048 = (let _128_2047 = (let _128_2046 = (FStar_ToSMT_Term.mk_and_l (FStar_List.append eqns guards))
in (ty_pred, _128_2046))
in (FStar_ToSMT_Term.mkImp _128_2047))
in (((ty_pred)::[])::[], _128_2049, _128_2048)))
in (FStar_ToSMT_Term.mkForall _128_2050))
in (_128_2051, Some ("data constructor typing elim")))
in FStar_ToSMT_Term.Assume (_128_2052))
in (
...
let x = (let _128_2053 = (varops.fresh "x")
in (_128_2053, FStar_ToSMT_Term.Term_sort))
in (
# 1713 "FStar.ToSMT.Encode.fst"
let xtm = (FStar_ToSMT_Term.mkFreeV x)
in (let _128_2063 = (let _128_2062 = (let _128_2061 = (let _128_2060 = (let _128_2055 = (let _128_2054 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_128_2054)::[])
in (_128_2055)::[])
in (let _128_2059 = (let _128_2058 = (let _128_2057 = (FStar_ToSMT_Term.mk_tester "LexCons" xtm)
in (let _128_2056 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_128_2057, _128_2056)))
in (FStar_ToSMT_Term.mkImp _128_2058))
in (_128_2060, (x)::[], _128_2059)))
in (FStar_ToSMT_Term.mkForall _128_2061))
in (_128_2062, Some ("lextop is top")))
in FStar_ToSMT_Term.Assume (_128_2063))))
end else begin
(
...
(let _128_2066 = (let _128_2065 = (FStar_ToSMT_Term.mkFreeV v)
in (FStar_ToSMT_Term.mk_Precedes _128_2065 dapp))
in (_128_2066)::[])
end
| _46_2779 -> begin
(FStar_All.failwith "unexpected sort")
end))))
in (let _128_2073 = (let _128_2072 = (let _128_2071 = (let _128_2070 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _128_2069 = (let _128_2068 = (let _128_2067 = (FStar_ToSMT_Term.mk_and_l prec)
in (ty_pred, _128_2067))
in (FStar_ToSMT_Term.mkImp _128_2068))
in (((ty_pred)::[])::[], _128_2070, _128_2069)))
in (FStar_ToSMT_Term.mkForall _128_2071))
in (_128_2072, Some ("subterm ordering")))
in FStar_ToSMT_Term.Assume (_128_2073)))
end
...
let _46_2784 = (let _128_2076 = (let _128_2075 = (FStar_Absyn_Print.sli d)
in (let _128_2074 = (FStar_Absyn_Print.typ_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _128_2075 _128_2074)))
in (FStar_Tc_Errors.warn drange _128_2076))
in ([], []))
end)
end))
end))
...
let g = (let _128_2101 = (let _128_2100 = (let _128_2085 = (let _128_2084 = (let _128_2083 = (let _128_2082 = (let _128_2081 = (let _128_2080 = (let _128_2079 = (let _128_2078 = (let _128_2077 = (FStar_Absyn_Print.sli d)
in (FStar_Util.format1 "data constructor proxy: %s" _128_2077))
in Some (_128_2078))
in (ddtok, [], FStar_ToSMT_Term.Term_sort, _128_2079))
in FStar_ToSMT_Term.DeclFun (_128_2080))
in (_128_2081)::[])
in (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls2) decls3) _128_2082))
in (FStar_List.append _128_2083 proxy_fresh))
in (FStar_List.append _128_2084 decls_formals))
in (FStar_List.append _128_2085 decls_pred))
in (let _128_2099 = (let _128_2098 = (let _128_2097 = (let _128_2089 = (let _128_2088 = (let _128_2087 = (let _128_2086 = (FStar_ToSMT_Term.mkEq (app, dapp))
in (((app)::[])::[], vars, _128_2086))
in (FStar_ToSMT_Term.mkForall _128_2087))
in (_128_2088, Some ("equality for proxy")))
in FStar_ToSMT_Term.Assume (_128_2089))
in (let _128_2096 = (let _128_2095 = (let _128_2094 = (let _128_2093 = (let _128_2092 = (let _128_2091 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) vars')
in (let _128_2090 = (FStar_ToSMT_Term.mkImp (guard', ty_pred'))
in (((ty_pred')::[])::[], _128_2091, _128_2090)))
in (FStar_ToSMT_Term.mkForall _128_2092))
in (_128_2093, Some ("data constructor typing intro")))
in FStar_ToSMT_Term.Assume (_128_2094))
in (_128_2095)::[])
in (_128_2097)::_128_2096))
in (FStar_ToSMT_Term.Assume ((tok_typing, Some ("typing for data constructor proxy"))))::_128_2098)
in (FStar_List.append _128_2100 _128_2099)))
in (FStar_List.append _128_2101 elim))
...
(let _128_2116 = (let _128_2115 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _128_2115))
in FStar_Util.Inl (_128_2116))
end
| (FStar_Util.Inr (x), FStar_Util.Inr (y)) -> begin
(let _128_2118 = (let _128_2117 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _128_2117))
in FStar_Util.Inr (_128_2118))
end
| _46_2873 -> begin
(FStar_All.failwith "Impossible")
end)) formals binders)
...
let extra_formals = (let _128_2119 = (FStar_Absyn_Util.subst_binders subst extra_formals)
in (FStar_All.pipe_right _128_2119 FStar_Absyn_Util.name_binders))
in (
# 1765 "FStar.ToSMT.Encode.fst"
let body = (let _128_2125 = (let _128_2121 = (let _128_2120 = (FStar_Absyn_Util.args_of_binders extra_formals)
in (FStar_All.pipe_left Prims.snd _128_2120))
in (body, _128_2121))
in (let _128_2124 = (let _128_2123 = (FStar_Absyn_Util.subst_typ subst t)
in (FStar_All.pipe_left (fun _128_2122 -> Some (_128_2122)) _128_2123))
in (FStar_Absyn_Syntax.mk_Exp_app_flat _128_2125 _128_2124 body.FStar_Absyn_Syntax.pos)))
...
| _46_2922 -> begin
(let _128_2134 = (let _128_2133 = (FStar_Absyn_Print.exp_to_string e)
in (let _128_2132 = (FStar_Absyn_Print.typ_to_string t_norm)
in (FStar_Util.format3 "Impossible! let-bound lambda %s = %s has a type that\'s not a function: %s\n" flid.FStar_Ident.str _128_2133 _128_2132)))
in (FStar_All.failwith _128_2134))
end)
end
| _46_2924 -> begin
(match (t_norm.FStar_Absyn_Syntax.n) with
...
let t_norm = (let _128_2140 = (whnf env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_All.pipe_right _128_2140 FStar_Absyn_Util.compress_typ))
in (
# 1810 "FStar.ToSMT.Encode.fst"
let _46_2961 = (let _128_2141 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (declare_top_level_let env _128_2141 lb.FStar_Absyn_Syntax.lbtyp t_norm))
in (match (_46_2961) with
| (tok, decl, env) -> begin
(let _128_2144 = (let _128_2143 = (let _128_2142 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_128_2142, tok))
in (_128_2143)::toks)
in (_128_2144, (t_norm)::typs, (decl)::decls, env))
end))))
end)) ([], [], [], env)))
...
| _46_2973 -> begin
false
end)))) || (FStar_All.pipe_right typs (FStar_Util.for_some (fun t -> ((FStar_Absyn_Util.is_lemma t) || (let _128_2147 = (FStar_Absyn_Util.is_pure_or_ghost_function t)
in (FStar_All.pipe_left Prims.op_Negation _128_2147))))))) then begin
(decls, env)
end else begin
...
| _46_3007 -> begin
(let _128_2149 = (let _128_2148 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (f, _128_2148))
in (FStar_ToSMT_Term.mkApp _128_2149))
end)
in (
...
let eqn = (let _128_2158 = (let _128_2157 = (let _128_2154 = (let _128_2153 = (let _128_2152 = (let _128_2151 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _128_2150 = (FStar_ToSMT_Term.mkEq (app, body))
in (_128_2151, _128_2150)))
in (FStar_ToSMT_Term.mkImp _128_2152))
in (((app)::[])::[], vars, _128_2153))
in (FStar_ToSMT_Term.mkForall _128_2154))
in (let _128_2156 = (let _128_2155 = (FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str)
in Some (_128_2155))
in (_128_2157, _128_2156)))
in FStar_ToSMT_Term.Assume (_128_2158))
...
let fuel = (let _128_2159 = (varops.fresh "fuel")
in (_128_2159, FStar_ToSMT_Term.Fuel_sort))
in (
...
let env = (let _128_2164 = (let _128_2163 = (FStar_ToSMT_Term.mkApp (g, (fuel_tm)::[]))
in (FStar_All.pipe_left (fun _128_2162 -> Some (_128_2162)) _128_2163))
in (push_free_var env flid gtok _128_2164))
...
let decl_g = (let _128_2175 = (let _128_2174 = (let _128_2173 = (FStar_List.map Prims.snd vars)
in (FStar_ToSMT_Term.Fuel_sort)::_128_2173)
in (g, _128_2174, FStar_ToSMT_Term.Term_sort, Some ("Fuel-instrumented function name")))
in FStar_ToSMT_Term.DeclFun (_128_2175))
in (
...
let gsapp = (let _128_2178 = (let _128_2177 = (let _128_2176 = (FStar_ToSMT_Term.mkApp ("SFuel", (fuel_tm)::[]))
in (_128_2176)::vars_tm)
in (g, _128_2177))
in (FStar_ToSMT_Term.mkApp _128_2178))
in (
# 1846 "FStar.ToSMT.Encode.fst"
let gmax = (let _128_2181 = (let _128_2180 = (let _128_2179 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (_128_2179)::vars_tm)
in (g, _128_2180))
in (FStar_ToSMT_Term.mkApp _128_2181))
in (
...
let eqn_g = (let _128_2190 = (let _128_2189 = (let _128_2186 = (let _128_2185 = (let _128_2184 = (let _128_2183 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _128_2182 = (FStar_ToSMT_Term.mkEq (gsapp, body_tm))
in (_128_2183, _128_2182)))
in (FStar_ToSMT_Term.mkImp _128_2184))
in (((gsapp)::[])::[], (fuel)::vars, _128_2185))
in (FStar_ToSMT_Term.mkForall _128_2186))
in (let _128_2188 = (let _128_2187 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Ident.str)
in Some (_128_2187))
in (_128_2189, _128_2188)))
in FStar_ToSMT_Term.Assume (_128_2190))
in (
# 1849 "FStar.ToSMT.Encode.fst"
let eqn_f = (let _128_2194 = (let _128_2193 = (let _128_2192 = (let _128_2191 = (FStar_ToSMT_Term.mkEq (app, gmax))
in (((app)::[])::[], vars, _128_2191))
in (FStar_ToSMT_Term.mkForall _128_2192))
in (_128_2193, Some ("Correspondence of recursive function to instrumented version")))
in FStar_ToSMT_Term.Assume (_128_2194))
in (
# 1850 "FStar.ToSMT.Encode.fst"
let eqn_g' = (let _128_2203 = (let _128_2202 = (let _128_2201 = (let _128_2200 = (let _128_2199 = (let _128_2198 = (let _128_2197 = (let _128_2196 = (let _128_2195 = (FStar_ToSMT_Term.n_fuel 0)
in (_128_2195)::vars_tm)
in (g, _128_2196))
in (FStar_ToSMT_Term.mkApp _128_2197))
in (gsapp, _128_2198))
in (FStar_ToSMT_Term.mkEq _128_2199))
in (((gsapp)::[])::[], (fuel)::vars, _128_2200))
in (FStar_ToSMT_Term.mkForall _128_2201))
in (_128_2202, Some ("Fuel irrelevance")))
in FStar_ToSMT_Term.Assume (_128_2203))
in (
...
let tok_app = (let _128_2204 = (FStar_ToSMT_Term.mkFreeV (gtok, FStar_ToSMT_Term.Term_sort))
in (mk_ApplyE _128_2204 ((fuel)::vars)))
in (let _128_2208 = (let _128_2207 = (let _128_2206 = (let _128_2205 = (FStar_ToSMT_Term.mkEq (tok_app, gapp))
in (((tok_app)::[])::[], (fuel)::vars, _128_2205))
in (FStar_ToSMT_Term.mkForall _128_2206))
in (_128_2207, Some ("Fuel token correspondence")))
in FStar_ToSMT_Term.Assume (_128_2208)))
in (
...
| (g_typing, d3) -> begin
(let _128_2216 = (let _128_2215 = (let _128_2214 = (let _128_2213 = (let _128_2212 = (let _128_2211 = (let _128_2210 = (let _128_2209 = (FStar_ToSMT_Term.mk_and_l v_guards)
in (_128_2209, g_typing))
in (FStar_ToSMT_Term.mkImp _128_2210))
in (((gapp)::[])::[], (fuel)::vars, _128_2211))
in (FStar_ToSMT_Term.mkForall _128_2212))
in (_128_2213, None))
in FStar_ToSMT_Term.Assume (_128_2214))
in (_128_2215)::[])
in (d3, _128_2216))
end))
...
let _46_3110 = (let _128_2219 = (FStar_List.zip3 gtoks typs bindings)
...
end)) ((decls)::[], [], env0) _128_2219))
in (match (_46_3110) with
| (decls, eqns, env0) -> begin
(
# 1866 "FStar.ToSMT.Encode.fst"
let _46_3119 = (let _128_2221 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _128_2221 (FStar_List.partition (fun _46_28 -> (match (_46_28) with
...
let msg = (let _128_2224 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname))))
in (FStar_All.pipe_right _128_2224 (FStar_String.concat " and ")))
in (
...
(let _128_2239 = (FStar_Tc_Util.pure_or_ghost_pre_and_post env.tcenv comp)
in (args, _128_2239))
end else begin
...
in (let _128_2256 = (let _128_2255 = (let _128_2254 = (let _128_2253 = (let _128_2252 = (let _128_2251 = (let _128_2250 = (let _128_2249 = (FStar_ToSMT_Term.mk_tester (escape d.FStar_Ident.str) xx)
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _128_2249))
in (vapp, _128_2250))
in (FStar_ToSMT_Term.mkEq _128_2251))
in (((vapp)::[])::[], vars, _128_2252))
in (FStar_ToSMT_Term.mkForall _128_2253))
in (_128_2254, Some ("Discriminator equation")))
in FStar_ToSMT_Term.Assume (_128_2255))
in (_128_2256)::[]))
end))
end
...
let prim_app = (let _128_2258 = (let _128_2257 = (mk_term_projector_name d f)
in (_128_2257, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _128_2258))
in (let _128_2263 = (let _128_2262 = (let _128_2261 = (let _128_2260 = (let _128_2259 = (FStar_ToSMT_Term.mkEq (vapp, prim_app))
in (((vapp)::[])::[], vars, _128_2259))
in (FStar_ToSMT_Term.mkForall _128_2260))
in (_128_2261, Some ("Projector equation")))
in FStar_ToSMT_Term.Assume (_128_2262))
in (_128_2263)::[])))
end))
end
| _46_3245 -> begin
...
| None -> begin
(let _128_2264 = (FStar_ToSMT_Term.mk_and_l guards)
in (_128_2264, decls1))
end
| Some (p) -> begin
(
...
| (g, ds) -> begin
(let _128_2265 = (FStar_ToSMT_Term.mk_and_l ((g)::guards))
in (_128_2265, (FStar_List.append decls1 ds)))
end))
end)
...
let vapp = (let _128_2267 = (let _128_2266 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (vname, _128_2266))
in (FStar_ToSMT_Term.mkApp _128_2267))
in (
# 1943 "FStar.ToSMT.Encode.fst"
let _46_3292 = (
# 1944 "FStar.ToSMT.Encode.fst"
let vname_decl = (let _128_2270 = (let _128_2269 = (FStar_All.pipe_right formals (FStar_List.map (fun _46_31 -> (match (_46_31) with
...
in (vname, _128_2269, FStar_ToSMT_Term.Term_sort, None))
in FStar_ToSMT_Term.DeclFun (_128_2270))
in (
...
| [] -> begin
(let _128_2274 = (let _128_2273 = (let _128_2272 = (FStar_ToSMT_Term.mkFreeV (vname, FStar_ToSMT_Term.Term_sort))
in (FStar_All.pipe_left (fun _128_2271 -> Some (_128_2271)) _128_2272))
in (push_free_var env lid vname _128_2273))
in ((FStar_List.append decls2 ((tok_typing)::[])), _128_2274))
end
| _46_3283 -> begin
(
...
let vtok_fresh = (let _128_2275 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (vtok, FStar_ToSMT_Term.Term_sort) _128_2275))
in (
# 1956 "FStar.ToSMT.Encode.fst"
let name_tok_corr = (let _128_2279 = (let _128_2278 = (let _128_2277 = (let _128_2276 = (FStar_ToSMT_Term.mkEq (vtok_app, vapp))
in (((vtok_app)::[])::[], vars, _128_2276))
in (FStar_ToSMT_Term.mkForall _128_2277))
in (_128_2278, None))
in FStar_ToSMT_Term.Assume (_128_2279))
...
(let _128_2280 = (FStar_ToSMT_Term.mk_HasType vapp encoded_res_t)
in (encoded_res_t, _128_2280, decls))
end)))
in (match (_46_3300) with
| (encoded_res_t, ty_pred, decls3) -> begin
(
# 1963 "FStar.ToSMT.Encode.fst"
let typingAx = (let _128_2284 = (let _128_2283 = (let _128_2282 = (let _128_2281 = (FStar_ToSMT_Term.mkImp (guard, ty_pred))
in (((vapp)::[])::[], vars, _128_2281))
in (FStar_ToSMT_Term.mkForall _128_2282))
in (_128_2283, Some ("free var typing")))
in FStar_ToSMT_Term.Assume (_128_2284))
in (
# 1964 "FStar.ToSMT.Encode.fst"
let g = (let _128_2286 = (let _128_2285 = (mk_disc_proj_axioms guard encoded_res_t vapp vars)
in (typingAx)::_128_2285)
in (FStar_List.append (FStar_List.append (FStar_List.append decls1 decls2) decls3) _128_2286))
in (g, env)))
end))
end))))
end))
...
(let _128_2301 = (FStar_Absyn_Print.strBvd x)
in (let _128_2300 = (FStar_Absyn_Print.typ_to_string t0)
in (let _128_2299 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" _128_2301 _128_2300 _128_2299))))
end else begin
()
end
in (
...
let caption = if (FStar_ST.read FStar_Options.logQueries) then begin
(let _128_2305 = (let _128_2304 = (FStar_Absyn_Print.strBvd x)
in (let _128_2303 = (FStar_Absyn_Print.typ_to_string t0)
in (let _128_2302 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _128_2304 _128_2303 _128_2302))))
in Some (_128_2305))
end else begin
None
end
...
let g = (let _128_2311 = (let _128_2310 = (let _128_2309 = (let _128_2308 = (let _128_2307 = (let _128_2306 = (FStar_Absyn_Print.strBvd a)
in Some (_128_2306))
in (aasym, [], FStar_ToSMT_Term.Type_sort, _128_2307))
in FStar_ToSMT_Term.DeclFun (_128_2308))
in (_128_2309)::[])
in (FStar_List.append _128_2310 decls'))
in (FStar_List.append _128_2311 ((FStar_ToSMT_Term.Assume ((k, None)))::[])))
in ((FStar_List.append decls g), env'))
end))
end))
end
...
(let _128_2319 = (FStar_All.pipe_left (fun _128_2315 -> FStar_ToSMT_Term.Echo (_128_2315)) (Prims.fst l))
in (let _128_2318 = (let _128_2317 = (let _128_2316 = (FStar_ToSMT_Term.mkFreeV l)
in FStar_ToSMT_Term.Eval (_128_2316))
in (_128_2317)::[])
in (_128_2319)::_128_2318))
end))))
in (prefix, suffix))))
...
let init_env : FStar_Tc_Env.env  ->  Prims.unit = (fun tcenv -> (let _128_2324 = (let _128_2323 = (let _128_2322 = (FStar_Util.smap_create 100)
in {bindings = []; depth = 0; tcenv = tcenv; warn = true; cache = _128_2322; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_128_2323)::[])
in (FStar_ST.op_Colon_Equals last_env _128_2324)))
...
let _46_3427 = (let _128_2345 = (pop_env ())
in (FStar_All.pipe_left Prims.ignore _128_2345))
in (
...
(let _128_2359 = (let _128_2358 = (let _128_2357 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (Prims.strcat "encoding sigelt " _128_2357))
in FStar_ToSMT_Term.Caption (_128_2358))
in (_128_2359)::decls)
end else begin
decls
end)
...
in (let _128_2360 = (caption decls)
in (FStar_ToSMT_Z3.giveZ3 _128_2360)))
end)))))
...
(let _128_2365 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Absyn_Syntax.exports) FStar_Util.string_of_int)
...
let _46_3479 = (let _128_2374 = (let _128_2373 = (let _128_2372 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _128_2372))
in (FStar_Util.format1 "Starting query at %s" _128_2373))
in (push _128_2374))
in (
# 2115 "FStar.ToSMT.Encode.fst"
let pop = (fun _46_3482 -> (match (()) with
| () -> begin
(let _128_2379 = (let _128_2378 = (let _128_2377 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _128_2377))
in (FStar_Util.format1 "Ending query at %s" _128_2378))
in (pop _128_2379))
end))
in (
...
in (let _128_2385 = (let _128_2384 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_128_2384)::out)
in (_128_2385, rest)))
end))
end
...
| (out, rest) -> begin
(let _128_2387 = (let _128_2386 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_128_2386)::out)
in (_128_2387, rest))
end))
end
...
(let _128_2388 = (FStar_Absyn_Util.close_forall (FStar_List.rev closing) q)
in (_128_2388, bindings))
end)))
in (match (_46_3515) with
| (q, bindings) -> begin
(
# 2131 "FStar.ToSMT.Encode.fst"
let _46_3524 = (let _128_2390 = (FStar_List.filter (fun _46_32 -> (match (_46_32) with
...
let qry = (let _128_2393 = (let _128_2392 = (FStar_ToSMT_Term.mkNot phi)
in (_128_2392, Some ("query")))
in FStar_ToSMT_Term.Assume (_128_2393))
in (
...
| (n, i) -> begin
(let _128_2416 = (let _128_2415 = (let _128_2400 = (let _128_2399 = (FStar_Util.string_of_int n)
in (let _128_2398 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "<fuel=\'%s\' ifuel=\'%s\'>" _128_2399 _128_2398)))
in FStar_ToSMT_Term.Caption (_128_2400))
in (let _128_2414 = (let _128_2413 = (let _128_2405 = (let _128_2404 = (let _128_2403 = (let _128_2402 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (let _128_2401 = (FStar_ToSMT_Term.n_fuel n)
in (_128_2402, _128_2401)))
in (FStar_ToSMT_Term.mkEq _128_2403))
in (_128_2404, None))
in FStar_ToSMT_Term.Assume (_128_2405))
in (let _128_2412 = (let _128_2411 = (let _128_2410 = (let _128_2409 = (let _128_2408 = (let _128_2407 = (FStar_ToSMT_Term.mkApp ("MaxIFuel", []))
in (let _128_2406 = (FStar_ToSMT_Term.n_fuel i)
in (_128_2407, _128_2406)))
in (FStar_ToSMT_Term.mkEq _128_2408))
in (_128_2409, None))
in FStar_ToSMT_Term.Assume (_128_2410))
in (_128_2411)::(p)::(FStar_ToSMT_Term.CheckSat)::[])
in (_128_2413)::_128_2412))
in (_128_2415)::_128_2414))
in (FStar_List.append _128_2416 suffix))
end))
in (
# 2156 "FStar.ToSMT.Encode.fst"
let check = (fun p -> (
# 2157 "FStar.ToSMT.Encode.fst"
let initial_config = (let _128_2420 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _128_2419 = (FStar_ST.read FStar_Options.initial_ifuel)
in (_128_2420, _128_2419)))
in (
# 2158 "FStar.ToSMT.Encode.fst"
let alt_configs = (let _128_2439 = (let _128_2438 = if ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel)) then begin
(let _128_2423 = (let _128_2422 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _128_2421 = (FStar_ST.read FStar_Options.max_ifuel)
in (_128_2422, _128_2421)))
in (_128_2423)::[])
end else begin
[]
end
in (let _128_2437 = (let _128_2436 = if (((FStar_ST.read FStar_Options.max_fuel) / 2) > (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _128_2426 = (let _128_2425 = ((FStar_ST.read FStar_Options.max_fuel) / 2)
in (let _128_2424 = (FStar_ST.read FStar_Options.max_ifuel)
in (_128_2425, _128_2424)))
in (_128_2426)::[])
end else begin
[]
end
in (let _128_2435 = (let _128_2434 = if (((FStar_ST.read FStar_Options.max_fuel) > (FStar_ST.read FStar_Options.initial_fuel)) && ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel))) then begin
(let _128_2429 = (let _128_2428 = (FStar_ST.read FStar_Options.max_fuel)
in (let _128_2427 = (FStar_ST.read FStar_Options.max_ifuel)
in (_128_2428, _128_2427)))
in (_128_2429)::[])
end else begin
[]
end
in (let _128_2433 = (let _128_2432 = if ((FStar_ST.read FStar_Options.min_fuel) < (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _128_2431 = (let _128_2430 = (FStar_ST.read FStar_Options.min_fuel)
in (_128_2430, 1))
in (_128_2431)::[])
end else begin
[]
...
in (_128_2432)::[])
in (_128_2434)::_128_2433))
in (_128_2436)::_128_2435))
in (_128_2438)::_128_2437))
in (FStar_List.flatten _128_2439))
in (
...
(let _128_2447 = (let _128_2442 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _128_2442))
in (let _128_2446 = (let _128_2443 = (FStar_ST.read FStar_Options.max_fuel)
in (FStar_All.pipe_right _128_2443 FStar_Util.string_of_int))
in (let _128_2445 = (let _128_2444 = (FStar_ST.read FStar_Options.max_ifuel)
in (FStar_All.pipe_right _128_2444 FStar_Util.string_of_int))
in (FStar_Util.print3 "(%s) Query failed with maximum fuel %s and ifuel %s\n" _128_2447 _128_2446 _128_2445))))
end else begin
()
end
...
(match (errs) with
| [] -> begin
(let _128_2458 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _128_2458 (cb mi p [])))
end
| _46_3597 -> begin
(report errs)
end)
...
| mi::tl -> begin
(let _128_2460 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _128_2460 (fun _46_3603 -> (match (_46_3603) with
| (ok, errs') -> begin
(match (errs) with
| [] -> begin
(cb mi p tl (ok, errs'))
...
(let _128_2468 = (let _128_2465 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _128_2465))
in (let _128_2467 = (FStar_Util.string_of_int prev_fuel)
in (let _128_2466 = (FStar_Util.string_of_int prev_ifuel)
in (FStar_Util.print3 "(%s) Query succeeded with fuel %s and ifuel %s\n" _128_2468 _128_2467 _128_2466))))
end else begin
()
end
end else begin
...
in (let _128_2469 = (with_fuel p initial_config)
in (FStar_ToSMT_Z3.ask fresh labels _128_2469 (cb initial_config p alt_configs))))))))
in (
...
let _46_3619 = (let _128_2475 = (FStar_ST.read FStar_Options.split_cases)
in (FStar_ToSMT_SplitQueryCases.can_handle_query _128_2475 q))
