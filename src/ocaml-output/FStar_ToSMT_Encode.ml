...
let solve : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  Prims.unit = (fun tcenv q -> (let _58_3479 = (let _160_2372 = (let _160_2371 = (let _160_2370 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _160_2370))
in (FStar_Util.format1 "Starting query at %s" _160_2371))
in (push _160_2372))
in (let pop = (fun _58_3482 -> (match (()) with
| () -> begin
(let _160_2377 = (let _160_2376 = (let _160_2375 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _160_2375))
in (FStar_Util.format1 "Ending query at %s" _160_2376))
in (pop _160_2377))
end))
...
(let _160_2382 = (FStar_Absyn_Util.close_forall (FStar_List.rev closing) q)
in (_160_2382, bindings))
end)))
in (match (_58_3515) with
| (q, bindings) -> begin
(let _58_3524 = (let _160_2384 = (FStar_List.filter (fun _58_32 -> (match (_58_32) with
...
in (let qry = (let _160_2387 = (let _160_2386 = (FStar_ToSMT_Term.mkNot phi)
in (_160_2386, Some ("query")))
in FStar_ToSMT_Term.Assume (_160_2387))
...
| (n, i) -> begin
(let _160_2410 = (let _160_2409 = (let _160_2394 = (let _160_2393 = (FStar_Util.string_of_int n)
in (let _160_2392 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "<fuel=\'%s\' ifuel=\'%s\'>" _160_2393 _160_2392)))
in FStar_ToSMT_Term.Caption (_160_2394))
in (let _160_2408 = (let _160_2407 = (let _160_2399 = (let _160_2398 = (let _160_2397 = (let _160_2396 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (let _160_2395 = (FStar_ToSMT_Term.n_fuel n)
in (_160_2396, _160_2395)))
in (FStar_ToSMT_Term.mkEq _160_2397))
in (_160_2398, None))
in FStar_ToSMT_Term.Assume (_160_2399))
in (let _160_2406 = (let _160_2405 = (let _160_2404 = (let _160_2403 = (let _160_2402 = (let _160_2401 = (FStar_ToSMT_Term.mkApp ("MaxIFuel", []))
in (let _160_2400 = (FStar_ToSMT_Term.n_fuel i)
in (_160_2401, _160_2400)))
in (FStar_ToSMT_Term.mkEq _160_2402))
in (_160_2403, None))
in FStar_ToSMT_Term.Assume (_160_2404))
in (_160_2405)::(p)::(FStar_ToSMT_Term.CheckSat)::[])
in (_160_2407)::_160_2406))
in (_160_2409)::_160_2408))
in (FStar_List.append _160_2410 suffix))
end))
in (let check = (fun p -> (let initial_config = (let _160_2414 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _160_2413 = (FStar_ST.read FStar_Options.initial_ifuel)
in (_160_2414, _160_2413)))
in (let alt_configs = (let _160_2433 = (let _160_2432 = if ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel)) then begin
(let _160_2417 = (let _160_2416 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _160_2415 = (FStar_ST.read FStar_Options.max_ifuel)
in (_160_2416, _160_2415)))
in (_160_2417)::[])
end else begin
[]
end
in (let _160_2431 = (let _160_2430 = if (((FStar_ST.read FStar_Options.max_fuel) / 2) > (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _160_2420 = (let _160_2419 = ((FStar_ST.read FStar_Options.max_fuel) / 2)
in (let _160_2418 = (FStar_ST.read FStar_Options.max_ifuel)
in (_160_2419, _160_2418)))
in (_160_2420)::[])
end else begin
[]
end
in (let _160_2429 = (let _160_2428 = if (((FStar_ST.read FStar_Options.max_fuel) > (FStar_ST.read FStar_Options.initial_fuel)) && ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel))) then begin
(let _160_2423 = (let _160_2422 = (FStar_ST.read FStar_Options.max_fuel)
in (let _160_2421 = (FStar_ST.read FStar_Options.max_ifuel)
in (_160_2422, _160_2421)))
in (_160_2423)::[])
end else begin
[]
end
in (let _160_2427 = (let _160_2426 = if ((FStar_ST.read FStar_Options.min_fuel) < (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _160_2425 = (let _160_2424 = (FStar_ST.read FStar_Options.min_fuel)
in (_160_2424, 1))
in (_160_2425)::[])
end else begin
[]
...
in (_160_2432)::_160_2431))
in (FStar_List.flatten _160_2433))
...
(let _160_2441 = (let _160_2436 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _160_2436))
in (let _160_2440 = (let _160_2437 = (FStar_ST.read FStar_Options.max_fuel)
in (FStar_All.pipe_right _160_2437 FStar_Util.string_of_int))
in (let _160_2439 = (let _160_2438 = (FStar_ST.read FStar_Options.max_ifuel)
in (FStar_All.pipe_right _160_2438 FStar_Util.string_of_int))
in (FStar_Util.print3 "(%s) Query failed with maximum fuel %s and ifuel %s\n" _160_2441 _160_2440 _160_2439))))
end else begin
()
end
...
(match (errs) with
| [] -> begin
(let _160_2452 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _160_2452 (cb mi p [])))
end
| _58_3597 -> begin
(report errs)
end)
...
| mi::tl -> begin
(let _160_2454 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _160_2454 (fun _58_3603 -> (match (_58_3603) with
| (ok, errs') -> begin
(match (errs) with
| [] -> begin
(cb mi p tl (ok, errs'))
...
(let _160_2462 = (let _160_2459 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _160_2459))
in (let _160_2461 = (FStar_Util.string_of_int prev_fuel)
in (let _160_2460 = (FStar_Util.string_of_int prev_ifuel)
in (FStar_Util.print3 "(%s) Query succeeded with fuel %s and ifuel %s\n" _160_2462 _160_2461 _160_2460))))
end else begin
()
end
end else begin
...
in (let _160_2463 = (with_fuel p initial_config)
in (FStar_ToSMT_Z3.ask fresh labels _160_2463 (cb initial_config p alt_configs))))))))
in (let process_query = (fun q -> if ((FStar_ST.read FStar_Options.split_cases) > 0) then begin
(let _58_3619 = (let _160_2469 = (FStar_ST.read FStar_Options.split_cases)
in (FStar_ToSMT_SplitQueryCases.can_handle_query _160_2469 q))
