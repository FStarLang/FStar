...
in (let quant = (fun vars body -> (fun x -> (let t1 = (let _118_1124 = (let _118_1123 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (x, _118_1123))
...
in (let x = (FStar_ToSMT_Term.mkFreeV xx)
in (let valid_b2t_x = (let _118_1815 = (FStar_ToSMT_Term.mkApp ("Prims.b2t", (x)::[]))
in (FStar_ToSMT_Term.mk_Valid _118_1815))
in (let decls = (let _118_1823 = (let _118_1822 = (let _118_1821 = (let _118_1820 = (let _118_1819 = (let _118_1818 = (let _118_1817 = (let _118_1816 = (FStar_ToSMT_Term.mkApp ("BoxBool_proj_0", (x)::[]))
in (valid_b2t_x, _118_1816))
in (FStar_ToSMT_Term.mkEq _118_1817))
in ((valid_b2t_x)::[], (xx)::[], _118_1818))
in (FStar_ToSMT_Term.mkForall _118_1819))
in (_118_1820, Some ("b2t def")))
in FStar_ToSMT_Term.Assume (_118_1821))
in (_118_1822)::[])
in (FStar_ToSMT_Term.DeclFun ((tname, (FStar_ToSMT_Term.Term_sort)::[], FStar_ToSMT_Term.Type_sort, None)))::_118_1823)
in (decls, env)))))
end))
end
...
(let tok_app = (let _118_1824 = (FStar_ToSMT_Term.mkApp (ttok, []))
in (mk_ApplyT _118_1824 vars))
in (let tok_decl = FStar_ToSMT_Term.DeclFun ((ttok, [], FStar_ToSMT_Term.Type_sort, None))
in (let app = (let _118_1826 = (let _118_1825 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _118_1825))
in (FStar_ToSMT_Term.mkApp _118_1826))
in (let fresh_tok = (match (vars) with
| [] -> begin
[]
end
| _53_2263 -> begin
(let _118_1828 = (let _118_1827 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _118_1827))
in (_118_1828)::[])
end)
in (let decls = (let _118_1839 = (let _118_1832 = (let _118_1831 = (let _118_1830 = (let _118_1829 = (FStar_List.map Prims.snd vars)
in (tname, _118_1829, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_118_1830))
in (_118_1831)::(tok_decl)::[])
in (FStar_List.append _118_1832 fresh_tok))
in (let _118_1838 = (let _118_1837 = (let _118_1836 = (let _118_1835 = (let _118_1834 = (let _118_1833 = (FStar_ToSMT_Term.mkEq (tok_app, app))
in ((tok_app)::[], vars, _118_1833))
in (FStar_ToSMT_Term.mkForall _118_1834))
in (_118_1835, Some ("name-token correspondence")))
in FStar_ToSMT_Term.Assume (_118_1836))
in (_118_1837)::[])
in (FStar_List.append _118_1839 _118_1838)))
in (let t = (whnf env t)
...
| true -> begin
(let _118_1842 = (FStar_ToSMT_Term.mk_Valid app)
in (let _118_1841 = (encode_formula t env')
in (_118_1842, _118_1841)))
end
| false -> begin
(let _118_1843 = (encode_typ_term t env')
in (app, _118_1843))
end)
in (match (_53_2275) with
| (def, (body, decls1)) -> begin
(let abbrev_def = (let _118_1850 = (let _118_1849 = (let _118_1848 = (let _118_1847 = (let _118_1846 = (let _118_1845 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _118_1844 = (FStar_ToSMT_Term.mkEq (def, body))
in (_118_1845, _118_1844)))
in (FStar_ToSMT_Term.mkImp _118_1846))
in ((def)::[], vars, _118_1847))
in (FStar_ToSMT_Term.mkForall _118_1848))
in (_118_1849, Some ("abbrev. elimination")))
in FStar_ToSMT_Term.Assume (_118_1850))
in (let kindingAx = (let _53_2279 = (let _118_1851 = (FStar_Tc_Recheck.recompute_kind t)
in (encode_knd _118_1851 env' app))
in (match (_53_2279) with
| (k, decls) -> begin
(let _118_1859 = (let _118_1858 = (let _118_1857 = (let _118_1856 = (let _118_1855 = (let _118_1854 = (let _118_1853 = (let _118_1852 = (FStar_ToSMT_Term.mk_and_l guards)
in (_118_1852, k))
in (FStar_ToSMT_Term.mkImp _118_1853))
in ((app)::[], vars, _118_1854))
in (FStar_ToSMT_Term.mkForall _118_1855))
in (_118_1856, Some ("abbrev. kinding")))
in FStar_ToSMT_Term.Assume (_118_1857))
in (_118_1858)::[])
in (FStar_List.append decls _118_1859))
end))
in (let g = (let _118_1860 = (primitive_type_axioms lid tname app)
in (FStar_List.append (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls) decls1) ((abbrev_def)::kindingAx)) _118_1860))
in (g, env))))
end))))))))
end))
end))
...
| true -> begin
(let _118_1862 = (let _118_1861 = (encode_smt_lemma env lid t)
in (FStar_List.append decls _118_1861))
in (_118_1862, env))
end
| false -> begin
(decls, env)
...
| (f, decls) -> begin
(let g = (let _118_1867 = (let _118_1866 = (let _118_1865 = (let _118_1864 = (let _118_1863 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format1 "Assumption: %s" _118_1863))
in Some (_118_1864))
in (f, _118_1865))
in FStar_ToSMT_Term.Assume (_118_1866))
in (_118_1867)::[])
...
in (let _118_1869 = (let _118_1868 = (primitive_type_axioms t tname tsym)
in (decl)::_118_1868)
in (_118_1869, (push_free_tvar env t tname (Some (tsym))))))))
end
...
(let _118_1875 = (let _118_1874 = (let _118_1873 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in (name, _118_1873, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_118_1874))
in (_118_1875)::[])
end))
end
| false -> begin
...
in (let inversion_axioms = (fun tapp vars -> (match ((((FStar_List.length datas) = 0) || (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _118_1881 = (FStar_Tc_Env.lookup_qname env.tcenv l)
in (FStar_All.pipe_right _118_1881 FStar_Option.isNone))))))) with
| true -> begin
[]
end
| false -> begin
...
| (args, res) -> begin
(let indices = (match ((let _118_1884 = (FStar_Absyn_Util.compress_typ res)
in _118_1884.FStar_Absyn_Syntax.n)) with
...
| FStar_Util.Inl (a) -> begin
(let _118_1889 = (let _118_1888 = (let _118_1887 = (mk_typ_projector_name l a.FStar_Absyn_Syntax.v)
in (_118_1887, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _118_1888))
in (push_typ_var env a.FStar_Absyn_Syntax.v _118_1889))
end
| FStar_Util.Inr (x) -> begin
(let _118_1892 = (let _118_1891 = (let _118_1890 = (mk_term_projector_name l x.FStar_Absyn_Syntax.v)
in (_118_1890, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _118_1891))
in (push_term_var env x.FStar_Absyn_Syntax.v _118_1892))
end)) env))
...
in (let eqs = (let _118_1899 = (FStar_List.map2 (fun v a -> (match (a) with
| FStar_Util.Inl (a) -> begin
...
(let _118_1898 = (let _118_1897 = (FStar_ToSMT_Term.mkFreeV v)
in (_118_1897, a))
in (FStar_ToSMT_Term.mkEq _118_1898))
end)) vars indices)
in (FStar_All.pipe_right _118_1899 FStar_ToSMT_Term.mk_and_l))
in (let _118_1904 = (let _118_1903 = (let _118_1902 = (let _118_1901 = (let _118_1900 = (mk_data_tester env l xx)
in (_118_1900, eqs))
in (FStar_ToSMT_Term.mkAnd _118_1901))
in (out, _118_1902))
in (FStar_ToSMT_Term.mkOr _118_1903))
in (_118_1904, (FStar_List.append decls decls')))))
end))))
end)))
...
| (ffsym, ff) -> begin
(let xx_has_type = (let _118_1905 = (FStar_ToSMT_Term.mkApp ("SFuel", (ff)::[]))
in (FStar_ToSMT_Term.mk_HasTypeFuel _118_1905 xx tapp))
in (let _118_1912 = (let _118_1911 = (let _118_1910 = (let _118_1909 = (let _118_1908 = (let _118_1907 = (add_fuel (ffsym, FStar_ToSMT_Term.Fuel_sort) (((xxsym, FStar_ToSMT_Term.Term_sort))::vars))
in (let _118_1906 = (FStar_ToSMT_Term.mkImp (xx_has_type, data_ax))
in ((xx_has_type)::[], _118_1907, _118_1906)))
in (FStar_ToSMT_Term.mkForall _118_1908))
in (_118_1909, Some ("inversion axiom")))
in FStar_ToSMT_Term.Assume (_118_1910))
in (_118_1911)::[])
in (FStar_List.append decls _118_1912)))
end))
end))
end))
end))
in (let k = (FStar_Absyn_Util.close_kind tps k)
in (let _53_2428 = (match ((let _118_1913 = (FStar_Absyn_Util.compress_kind k)
in _118_1913.FStar_Absyn_Syntax.n)) with
...
| (xx, suffix) -> begin
(let dproj_app = (let _118_1927 = (let _118_1926 = (let _118_1925 = (mk_typ_projector_name d a)
in (let _118_1924 = (let _118_1923 = (FStar_ToSMT_Term.mkFreeV xx)
in (_118_1923)::[])
in (_118_1925, _118_1924)))
in (FStar_ToSMT_Term.mkApp _118_1926))
in (mk_ApplyT _118_1927 suffix))
in (let _118_1932 = (let _118_1931 = (let _118_1930 = (let _118_1929 = (let _118_1928 = (FStar_ToSMT_Term.mkEq (tapp, dproj_app))
in ((tapp)::[], vars, _118_1928))
in (FStar_ToSMT_Term.mkForall _118_1929))
in (_118_1930, Some ("projector axiom")))
in FStar_ToSMT_Term.Assume (_118_1931))
in (_118_1932)::[]))
end))))
end
| _53_2477 -> begin
...
in (let _118_1945 = (let _118_1944 = (let _118_1943 = (let _118_1942 = (let _118_1941 = (let _118_1940 = (let _118_1939 = (let _118_1938 = (let _118_1937 = (FStar_ToSMT_Term.mkApp ("PreType", (xx)::[]))
in (tapp, _118_1937))
in (FStar_ToSMT_Term.mkEq _118_1938))
in (xx_has_type, _118_1939))
in (FStar_ToSMT_Term.mkImp _118_1940))
in ((xx_has_type)::[], ((xxsym, FStar_ToSMT_Term.Term_sort))::((ffsym, FStar_ToSMT_Term.Fuel_sort))::vars, _118_1941))
in (FStar_ToSMT_Term.mkForall _118_1942))
in (_118_1943, Some ("pretyping")))
in FStar_ToSMT_Term.Assume (_118_1944))
in (_118_1945)::[]))
end))
end)))
...
in (let tapp = (let _118_1947 = (let _118_1946 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _118_1946))
in (FStar_ToSMT_Term.mkApp _118_1947))
in (let _53_2516 = (let tname_decl = (let _118_1951 = (let _118_1950 = (FStar_All.pipe_right vars (FStar_List.map (fun _53_2497 -> (match (_53_2497) with
| (n, s) -> begin
((Prims.strcat tname n), s)
end))))
in (let _118_1949 = (varops.next_id ())
in (tname, _118_1950, FStar_ToSMT_Term.Type_sort, _118_1949)))
in (constructor_or_logic_type_decl _118_1951))
in (let _53_2513 = (match (vars) with
| [] -> begin
(let _118_1955 = (let _118_1954 = (let _118_1953 = (FStar_ToSMT_Term.mkApp (tname, []))
in (FStar_All.pipe_left (fun _118_1952 -> Some (_118_1952)) _118_1953))
in (push_free_tvar env t tname _118_1954))
in ([], _118_1955))
end
| _53_2501 -> begin
(let ttok_decl = FStar_ToSMT_Term.DeclFun ((ttok, [], FStar_ToSMT_Term.Type_sort, Some ("token")))
in (let ttok_fresh = (let _118_1956 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _118_1956))
...
in (let name_tok_corr = (let _118_1961 = (let _118_1960 = (let _118_1959 = (let _118_1958 = (FStar_ToSMT_Term.mkEq (ttok_app, tapp))
in (pats, None, vars, _118_1958))
in (FStar_ToSMT_Term.mkForall' _118_1959))
in (_118_1960, Some ("name-token correspondence")))
...
| true -> begin
(let _118_1965 = (let _118_1964 = (let _118_1963 = (let _118_1962 = (FStar_ToSMT_Term.mk_PreKind ttok_tm)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _118_1962))
in (_118_1963, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_118_1964))
in (_118_1965)::[])
end
| false -> begin
[]
end)
in (let _118_1971 = (let _118_1970 = (let _118_1969 = (let _118_1968 = (let _118_1967 = (let _118_1966 = (FStar_ToSMT_Term.mkImp (guard, k))
in ((tapp)::[], vars, _118_1966))
in (FStar_ToSMT_Term.mkForall _118_1967))
in (_118_1968, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_118_1969))
in (_118_1970)::[])
in (FStar_List.append (FStar_List.append decls karr) _118_1971)))
end))
in (let aux = (match (is_logical) with
| true -> begin
(let _118_1972 = (projection_axioms tapp vars)
in (FStar_List.append kindingAx _118_1972))
end
| false -> begin
(let _118_1979 = (let _118_1977 = (let _118_1975 = (let _118_1973 = (primitive_type_axioms t tname tapp)
in (FStar_List.append kindingAx _118_1973))
in (let _118_1974 = (inversion_axioms tapp vars)
in (FStar_List.append _118_1975 _118_1974)))
in (let _118_1976 = (projection_axioms tapp vars)
in (FStar_List.append _118_1977 _118_1976)))
in (let _118_1978 = (pretype_axioms tapp vars)
in (FStar_List.append _118_1979 _118_1978)))
end)
...
| FStar_Absyn_Syntax.Sig_datacon (d, t, _53_2540, quals, _53_2543, drange) -> begin
(let _53_2550 = (new_term_constant_and_tok_from_lid env d)
in (match (_53_2550) with
| (ddconstrsym, ddtok, env) -> begin
(let ddtok_tm = (FStar_ToSMT_Term.mkApp (ddtok, []))
in (let _53_2559 = (match ((FStar_Absyn_Util.function_formals t)) with
| Some (f, c) -> begin
...
| (formals, t_res) -> begin
(let _53_2562 = (fresh_fvar "f" FStar_ToSMT_Term.Fuel_sort)
in (match (_53_2562) with
| (fuel_var, fuel_tm) -> begin
(let s_fuel_tm = (FStar_ToSMT_Term.mkApp ("SFuel", (fuel_tm)::[]))
in (let _53_2569 = (encode_binders (Some (fuel_tm)) formals env)
in (match (_53_2569) with
| (vars, guards, env', binder_decls, names) -> begin
(let projectors = (FStar_All.pipe_right names (FStar_List.map (fun _53_23 -> (match (_53_23) with
| FStar_Util.Inl (a) -> begin
(let _118_1981 = (mk_typ_projector_name d a)
in (_118_1981, FStar_ToSMT_Term.Type_sort))
end
| FStar_Util.Inr (x) -> begin
(let _118_1982 = (mk_term_projector_name d x)
in (_118_1982, FStar_ToSMT_Term.Term_sort))
end))))
in (let datacons = (let _118_1984 = (let _118_1983 = (varops.next_id ())
in (ddconstrsym, projectors, FStar_ToSMT_Term.Term_sort, _118_1983))
in (FStar_All.pipe_right _118_1984 FStar_ToSMT_Term.constructor_to_decl))
...
in (let _53_2583 = (encode_typ_pred None t env ddtok_tm)
in (match (_53_2583) with
| (tok_typing, decls3) -> begin
(let _53_2590 = (encode_binders (Some (fuel_tm)) formals env)
in (match (_53_2590) with
| (vars', guards', env'', decls_formals, _53_2589) -> begin
(let _53_2595 = (let xvars = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars')
in (let dapp = (FStar_ToSMT_Term.mkApp (ddconstrsym, xvars))
...
| _53_2599 -> begin
(let _118_1986 = (let _118_1985 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ddtok, FStar_ToSMT_Term.Term_sort) _118_1985))
in (_118_1986)::[])
end)
in (let encode_elim = (fun _53_2602 -> (match (()) with
| () -> begin
(let _53_2605 = (FStar_Absyn_Util.head_and_args t_res)
in (match (_53_2605) with
| (head, args) -> begin
(match ((let _118_1989 = (FStar_Absyn_Util.compress_typ head)
in _118_1989.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
(let encoded_head = (lookup_free_tvar_name env' fv)
in (let _53_2611 = (encode_args args env')
in (match (_53_2611) with
| (encoded_args, arg_decls) -> begin
(let _53_2635 = (FStar_List.fold_left (fun _53_2615 arg -> (match (_53_2615) with
| (env, arg_vars, eqns) -> begin
(match (arg) with
| FStar_Util.Inl (targ) -> begin
(let _53_2623 = (let _118_1992 = (FStar_Absyn_Util.new_bvd None)
in (gen_typ_var env _118_1992))
in (match (_53_2623) with
| (_53_2620, tv, env) -> begin
(let _118_1994 = (let _118_1993 = (FStar_ToSMT_Term.mkEq (targ, tv))
in (_118_1993)::eqns)
in (env, (tv)::arg_vars, _118_1994))
end))
end
| FStar_Util.Inr (varg) -> begin
(let _53_2630 = (let _118_1995 = (FStar_Absyn_Util.new_bvd None)
in (gen_term_var env _118_1995))
in (match (_53_2630) with
| (_53_2627, xv, env) -> begin
(let _118_1997 = (let _118_1996 = (FStar_ToSMT_Term.mkEq (varg, xv))
in (_118_1996)::eqns)
in (env, (xv)::arg_vars, _118_1997))
end))
end)
end)) (env', [], []) encoded_args)
in (match (_53_2635) with
| (_53_2632, arg_vars, eqns) -> begin
...
in (let typing_inversion = (let _118_2004 = (let _118_2003 = (let _118_2002 = (let _118_2001 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _118_2000 = (let _118_1999 = (let _118_1998 = (FStar_ToSMT_Term.mk_and_l (FStar_List.append eqns guards))
in (ty_pred, _118_1998))
in (FStar_ToSMT_Term.mkImp _118_1999))
in ((ty_pred)::[], _118_2001, _118_2000)))
in (FStar_ToSMT_Term.mkForall _118_2002))
in (_118_2003, Some ("data constructor typing elim")))
in FStar_ToSMT_Term.Assume (_118_2004))
in (let subterm_ordering = (match ((FStar_Absyn_Syntax.lid_equals d FStar_Absyn_Const.lextop_lid)) with
| true -> begin
(let x = (let _118_2005 = (varops.fresh "x")
in (_118_2005, FStar_ToSMT_Term.Term_sort))
in (let xtm = (FStar_ToSMT_Term.mkFreeV x)
in (let _118_2014 = (let _118_2013 = (let _118_2012 = (let _118_2011 = (let _118_2006 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_118_2006)::[])
in (let _118_2010 = (let _118_2009 = (let _118_2008 = (FStar_ToSMT_Term.mk_tester "LexCons" xtm)
in (let _118_2007 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_118_2008, _118_2007)))
in (FStar_ToSMT_Term.mkImp _118_2009))
in (_118_2011, (x)::[], _118_2010)))
in (FStar_ToSMT_Term.mkForall _118_2012))
in (_118_2013, Some ("lextop is top")))
in FStar_ToSMT_Term.Assume (_118_2014))))
end
| false -> begin
...
(let _118_2017 = (let _118_2016 = (FStar_ToSMT_Term.mkFreeV v)
in (FStar_ToSMT_Term.mk_Precedes _118_2016 dapp))
in (_118_2017)::[])
end
| _53_2650 -> begin
(FStar_All.failwith "unexpected sort")
end))))
in (let _118_2024 = (let _118_2023 = (let _118_2022 = (let _118_2021 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _118_2020 = (let _118_2019 = (let _118_2018 = (FStar_ToSMT_Term.mk_and_l prec)
in (ty_pred, _118_2018))
in (FStar_ToSMT_Term.mkImp _118_2019))
in ((ty_pred)::[], _118_2021, _118_2020)))
in (FStar_ToSMT_Term.mkForall _118_2022))
in (_118_2023, Some ("subterm ordering")))
in FStar_ToSMT_Term.Assume (_118_2024)))
end)
...
| _53_2654 -> begin
(let _53_2655 = (let _118_2027 = (let _118_2026 = (FStar_Absyn_Print.sli d)
in (let _118_2025 = (FStar_Absyn_Print.typ_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _118_2026 _118_2025)))
in (FStar_Tc_Errors.warn drange _118_2027))
in ([], []))
end)
end))
end))
in (let _53_2659 = (encode_elim ())
in (match (_53_2659) with
| (decls2, elim) -> begin
(let g = (let _118_2052 = (let _118_2051 = (let _118_2036 = (let _118_2035 = (let _118_2034 = (let _118_2033 = (let _118_2032 = (let _118_2031 = (let _118_2030 = (let _118_2029 = (let _118_2028 = (FStar_Absyn_Print.sli d)
in (FStar_Util.format1 "data constructor proxy: %s" _118_2028))
in Some (_118_2029))
in (ddtok, [], FStar_ToSMT_Term.Term_sort, _118_2030))
in FStar_ToSMT_Term.DeclFun (_118_2031))
in (_118_2032)::[])
in (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls2) decls3) _118_2033))
in (FStar_List.append _118_2034 proxy_fresh))
in (FStar_List.append _118_2035 decls_formals))
in (FStar_List.append _118_2036 decls_pred))
in (let _118_2050 = (let _118_2049 = (let _118_2048 = (let _118_2040 = (let _118_2039 = (let _118_2038 = (let _118_2037 = (FStar_ToSMT_Term.mkEq (app, dapp))
in ((app)::[], vars, _118_2037))
in (FStar_ToSMT_Term.mkForall _118_2038))
in (_118_2039, Some ("equality for proxy")))
in FStar_ToSMT_Term.Assume (_118_2040))
in (let _118_2047 = (let _118_2046 = (let _118_2045 = (let _118_2044 = (let _118_2043 = (let _118_2042 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) vars')
in (let _118_2041 = (FStar_ToSMT_Term.mkImp (guard', ty_pred'))
in ((ty_pred')::[], _118_2042, _118_2041)))
in (FStar_ToSMT_Term.mkForall _118_2043))
in (_118_2044, Some ("data constructor typing intro")))
in FStar_ToSMT_Term.Assume (_118_2045))
in (_118_2046)::[])
in (_118_2048)::_118_2047))
in (FStar_ToSMT_Term.Assume ((tok_typing, Some ("typing for data constructor proxy"))))::_118_2049)
in (FStar_List.append _118_2051 _118_2050)))
in (FStar_List.append _118_2052 elim))
...
| FStar_Absyn_Syntax.Sig_bundle (ses, _53_2663, _53_2665, _53_2667) -> begin
(let _53_2672 = (encode_signature env ses)
in (match (_53_2672) with
| (g, env) -> begin
(let _53_2684 = (FStar_All.pipe_right g (FStar_List.partition (fun _53_24 -> (match (_53_24) with
| FStar_ToSMT_Term.Assume (_53_2675, Some ("inversion axiom")) -> begin
false
end
| _53_2681 -> begin
true
...
| (g', inversions) -> begin
(let _53_2693 = (FStar_All.pipe_right g' (FStar_List.partition (fun _53_25 -> (match (_53_25) with
| FStar_ToSMT_Term.DeclFun (_53_2687) -> begin
true
end
| _53_2690 -> begin
false
...
| FStar_Absyn_Syntax.Sig_let (_53_2695, _53_2697, _53_2699, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun _53_26 -> (match (_53_26) with
...
| FStar_Absyn_Syntax.Sig_let ((is_rec, bindings), _53_2716, _53_2718, quals) -> begin
(let eta_expand = (fun binders formals body t -> (let nbinders = (FStar_List.length binders)
in (let _53_2730 = (FStar_Util.first_N nbinders formals)
...
(let _118_2067 = (let _118_2066 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _118_2066))
in FStar_Util.Inl (_118_2067))
end
| (FStar_Util.Inr (x), FStar_Util.Inr (y)) -> begin
(let _118_2069 = (let _118_2068 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _118_2068))
in FStar_Util.Inr (_118_2069))
end
| _53_2744 -> begin
(FStar_All.failwith "Impossible")
end)) formals binders)
in (let extra_formals = (let _118_2070 = (FStar_Absyn_Util.subst_binders subst extra_formals)
in (FStar_All.pipe_right _118_2070 FStar_Absyn_Util.name_binders))
in (let body = (let _118_2076 = (let _118_2072 = (let _118_2071 = (FStar_Absyn_Util.args_of_binders extra_formals)
in (FStar_All.pipe_left Prims.snd _118_2071))
in (body, _118_2072))
in (let _118_2075 = (let _118_2074 = (FStar_Absyn_Util.subst_typ subst t)
in (FStar_All.pipe_left (fun _118_2073 -> Some (_118_2073)) _118_2074))
in (FStar_Absyn_Syntax.mk_Exp_app_flat _118_2076 _118_2075 body.FStar_Absyn_Syntax.pos)))
...
| true -> begin
(let _53_2782 = (FStar_Util.first_N nformals binders)
in (match (_53_2782) with
| (bs0, rest) -> begin
...
| true -> begin
(let _53_2791 = (eta_expand binders formals body tres)
...
| _53_2793 -> begin
(let _118_2085 = (let _118_2084 = (FStar_Absyn_Print.exp_to_string e)
in (let _118_2083 = (FStar_Absyn_Print.typ_to_string t_norm)
in (FStar_Util.format3 "Impossible! let-bound lambda %s = %s has a type that\'s not a function: %s\n" flid.FStar_Absyn_Syntax.str _118_2084 _118_2083)))
in (FStar_All.failwith _118_2085))
end)
end
| _53_2795 -> begin
(match (t_norm.FStar_Absyn_Syntax.n) with
...
in (let _53_2803 = (eta_expand [] formals e tres)
in (match (_53_2803) with
| (binders, body) -> begin
(binders, body, formals, tres)
end)))
end
...
in (FStar_All.try_with (fun _53_2807 -> (match (()) with
| () -> begin
...
| true -> begin
(let _118_2091 = (FStar_All.pipe_right bindings (FStar_List.collect (fun lb -> (match ((FStar_Absyn_Util.is_smt_lemma lb.FStar_Absyn_Syntax.lbtyp)) with
| true -> begin
(let _118_2090 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (encode_smt_lemma env _118_2090 lb.FStar_Absyn_Syntax.lbtyp))
end
| false -> begin
...
| false -> begin
(let _53_2838 = (FStar_All.pipe_right bindings (FStar_List.fold_left (fun _53_2825 lb -> (match (_53_2825) with
| (toks, typs, decls, env) -> begin
(let _53_2827 = (match ((FStar_Absyn_Util.is_smt_lemma lb.FStar_Absyn_Syntax.lbtyp)) with
| true -> begin
(Prims.raise Let_rec_unencodeable)
end
| false -> begin
...
in (let t_norm = (let _118_2094 = (whnf env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_All.pipe_right _118_2094 FStar_Absyn_Util.compress_typ))
in (let _53_2833 = (let _118_2095 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (declare_top_level_let env _118_2095 lb.FStar_Absyn_Syntax.lbtyp t_norm))
in (match (_53_2833) with
| (tok, decl, env) -> begin
(let _118_2098 = (let _118_2097 = (let _118_2096 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_118_2096, tok))
in (_118_2097)::toks)
in (_118_2098, (t_norm)::typs, (decl)::decls, env))
end))))
end)) ([], [], [], env)))
in (match (_53_2838) with
| (toks, typs, decls, env) -> begin
...
| _53_2845 -> begin
false
end)))) || (FStar_All.pipe_right typs (FStar_Util.for_some (fun t -> ((FStar_Absyn_Util.is_lemma t) || (let _118_2101 = (FStar_Absyn_Util.is_pure_or_ghost_function t)
in (FStar_All.pipe_left Prims.op_Negation _118_2101)))))))) with
| true -> begin
(decls, env)
end
| false -> begin
...
| ({FStar_Absyn_Syntax.lbname = _53_2853; FStar_Absyn_Syntax.lbtyp = _53_2851; FStar_Absyn_Syntax.lbeff = _53_2849; FStar_Absyn_Syntax.lbdef = e}::[], t_norm::[], (flid, (f, ftok))::[]) -> begin
(let _53_2869 = (destruct_bound_function flid t_norm e)
in (match (_53_2869) with
| (binders, body, formals, tres) -> begin
(let _53_2876 = (encode_binders None binders env)
in (match (_53_2876) with
| (vars, guards, env', binder_decls, _53_2875) -> begin
(let app = (match (vars) with
| [] -> begin
(FStar_ToSMT_Term.mkFreeV (f, FStar_ToSMT_Term.Term_sort))
end
| _53_2879 -> begin
(let _118_2103 = (let _118_2102 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (f, _118_2102))
in (FStar_ToSMT_Term.mkApp _118_2103))
end)
in (let _53_2883 = (encode_exp body env')
in (match (_53_2883) with
| (body, decls2) -> begin
(let eqn = (let _118_2112 = (let _118_2111 = (let _118_2108 = (let _118_2107 = (let _118_2106 = (let _118_2105 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _118_2104 = (FStar_ToSMT_Term.mkEq (app, body))
in (_118_2105, _118_2104)))
in (FStar_ToSMT_Term.mkImp _118_2106))
in ((app)::[], vars, _118_2107))
in (FStar_ToSMT_Term.mkForall _118_2108))
in (let _118_2110 = (let _118_2109 = (FStar_Util.format1 "Equation for %s" flid.FStar_Absyn_Syntax.str)
in Some (_118_2109))
in (_118_2111, _118_2110)))
in FStar_ToSMT_Term.Assume (_118_2112))
...
| false -> begin
(let fuel = (let _118_2113 = (varops.fresh "fuel")
in (_118_2113, FStar_ToSMT_Term.Fuel_sort))
in (let fuel_tm = (FStar_ToSMT_Term.mkFreeV fuel)
in (let env0 = env
in (let _53_2903 = (FStar_All.pipe_right toks (FStar_List.fold_left (fun _53_2892 _53_2897 -> (match ((_53_2892, _53_2897)) with
| ((gtoks, env), (flid, (f, ftok))) -> begin
(let g = (varops.new_fvar flid)
in (let gtok = (varops.new_fvar flid)
in (let env = (let _118_2118 = (let _118_2117 = (FStar_ToSMT_Term.mkApp (g, (fuel_tm)::[]))
in (FStar_All.pipe_left (fun _118_2116 -> Some (_118_2116)) _118_2117))
in (push_free_var env flid gtok _118_2118))
in (((flid, f, ftok, g, gtok))::gtoks, env))))
end)) ([], env)))
in (match (_53_2903) with
| (gtoks, env) -> begin
(let gtoks = (FStar_List.rev gtoks)
in (let encode_one_binding = (fun env0 _53_2912 t_norm _53_2921 -> (match ((_53_2912, _53_2921)) with
| ((flid, f, ftok, g, gtok), {FStar_Absyn_Syntax.lbname = _53_2920; FStar_Absyn_Syntax.lbtyp = _53_2918; FStar_Absyn_Syntax.lbeff = _53_2916; FStar_Absyn_Syntax.lbdef = e}) -> begin
(let _53_2926 = (destruct_bound_function flid t_norm e)
in (match (_53_2926) with
| (binders, body, formals, tres) -> begin
(let _53_2933 = (encode_binders None binders env)
in (match (_53_2933) with
| (vars, guards, env', binder_decls, _53_2932) -> begin
(let decl_g = (let _118_2129 = (let _118_2128 = (let _118_2127 = (FStar_List.map Prims.snd vars)
in (FStar_ToSMT_Term.Fuel_sort)::_118_2127)
in (g, _118_2128, FStar_ToSMT_Term.Term_sort, Some ("Fuel-instrumented function name")))
in FStar_ToSMT_Term.DeclFun (_118_2129))
...
in (let gsapp = (let _118_2132 = (let _118_2131 = (let _118_2130 = (FStar_ToSMT_Term.mkApp ("SFuel", (fuel_tm)::[]))
in (_118_2130)::vars_tm)
in (g, _118_2131))
in (FStar_ToSMT_Term.mkApp _118_2132))
in (let gmax = (let _118_2135 = (let _118_2134 = (let _118_2133 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (_118_2133)::vars_tm)
in (g, _118_2134))
in (FStar_ToSMT_Term.mkApp _118_2135))
in (let _53_2943 = (encode_exp body env')
in (match (_53_2943) with
| (body_tm, decls2) -> begin
(let eqn_g = (let _118_2144 = (let _118_2143 = (let _118_2140 = (let _118_2139 = (let _118_2138 = (let _118_2137 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _118_2136 = (FStar_ToSMT_Term.mkEq (gsapp, body_tm))
in (_118_2137, _118_2136)))
in (FStar_ToSMT_Term.mkImp _118_2138))
in ((gsapp)::[], (fuel)::vars, _118_2139))
in (FStar_ToSMT_Term.mkForall _118_2140))
in (let _118_2142 = (let _118_2141 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Absyn_Syntax.str)
in Some (_118_2141))
in (_118_2143, _118_2142)))
in FStar_ToSMT_Term.Assume (_118_2144))
in (let eqn_f = (let _118_2148 = (let _118_2147 = (let _118_2146 = (let _118_2145 = (FStar_ToSMT_Term.mkEq (app, gmax))
in ((app)::[], vars, _118_2145))
in (FStar_ToSMT_Term.mkForall _118_2146))
in (_118_2147, Some ("Correspondence of recursive function to instrumented version")))
in FStar_ToSMT_Term.Assume (_118_2148))
in (let eqn_g' = (let _118_2157 = (let _118_2156 = (let _118_2155 = (let _118_2154 = (let _118_2153 = (let _118_2152 = (let _118_2151 = (let _118_2150 = (let _118_2149 = (FStar_ToSMT_Term.n_fuel 0)
in (_118_2149)::vars_tm)
in (g, _118_2150))
in (FStar_ToSMT_Term.mkApp _118_2151))
in (gsapp, _118_2152))
in (FStar_ToSMT_Term.mkEq _118_2153))
in ((gsapp)::[], (fuel)::vars, _118_2154))
in (FStar_ToSMT_Term.mkForall _118_2155))
in (_118_2156, Some ("Fuel irrelevance")))
in FStar_ToSMT_Term.Assume (_118_2157))
...
in (let tok_corr = (let tok_app = (let _118_2158 = (FStar_ToSMT_Term.mkFreeV (gtok, FStar_ToSMT_Term.Term_sort))
in (mk_ApplyE _118_2158 ((fuel)::vars)))
in (let _118_2162 = (let _118_2161 = (let _118_2160 = (let _118_2159 = (FStar_ToSMT_Term.mkEq (tok_app, gapp))
in ((tok_app)::[], (fuel)::vars, _118_2159))
in (FStar_ToSMT_Term.mkForall _118_2160))
in (_118_2161, Some ("Fuel token correspondence")))
in FStar_ToSMT_Term.Assume (_118_2162)))
in (let _53_2963 = (let _53_2960 = (encode_typ_pred None tres env gapp)
in (match (_53_2960) with
| (g_typing, d3) -> begin
(let _118_2170 = (let _118_2169 = (let _118_2168 = (let _118_2167 = (let _118_2166 = (let _118_2165 = (let _118_2164 = (let _118_2163 = (FStar_ToSMT_Term.mk_and_l v_guards)
in (_118_2163, g_typing))
in (FStar_ToSMT_Term.mkImp _118_2164))
in ((gapp)::[], (fuel)::vars, _118_2165))
in (FStar_ToSMT_Term.mkForall _118_2166))
in (_118_2167, None))
in FStar_ToSMT_Term.Assume (_118_2168))
in (_118_2169)::[])
in (d3, _118_2170))
end))
...
in (let _53_2982 = (let _118_2173 = (FStar_List.zip3 gtoks typs bindings)
in (FStar_List.fold_left (fun _53_2970 _53_2974 -> (match ((_53_2970, _53_2974)) with
| ((decls, eqns, env0), (gtok, ty, bs)) -> begin
(let _53_2978 = (encode_one_binding env0 gtok ty bs)
in (match (_53_2978) with
| (decls', eqns', env0) -> begin
((decls')::decls, (FStar_List.append eqns' eqns), env0)
end))
end)) ((decls)::[], [], env0) _118_2173))
in (match (_53_2982) with
| (decls, eqns, env0) -> begin
(let _53_2991 = (let _118_2175 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _118_2175 (FStar_List.partition (fun _53_29 -> (match (_53_29) with
...
end)) (fun _53_2806 -> (match (_53_2806) with
| Let_rec_unencodeable -> begin
(let msg = (let _118_2178 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname))))
in (FStar_All.pipe_right _118_2178 (FStar_String.concat " and ")))
...
| None -> begin
(let _53_3018 = (encode_free_var env x t t_norm [])
in (match (_53_3018) with
| (decls, env) -> begin
(let _53_3023 = (lookup_lid env x)
...
| Some (n, x, _53_3027) -> begin
((n, x), [], env)
end))
and encode_smt_lemma = (fun env lid t -> (let _53_3035 = (encode_function_type_as_formula None None t env)
in (match (_53_3035) with
| (form, decls) -> begin
(FStar_List.append decls ((FStar_ToSMT_Term.Assume ((form, Some ((Prims.strcat "Lemma: " lid.FStar_Absyn_Syntax.str)))))::[]))
end)))
and encode_free_var = (fun env lid tt t_norm quals -> (match (((let _118_2191 = (FStar_Absyn_Util.is_pure_or_ghost_function t_norm)
in (FStar_All.pipe_left Prims.op_Negation _118_2191)) || (FStar_Absyn_Util.is_lemma t_norm))) with
| true -> begin
(let _53_3044 = (new_term_constant_and_tok_from_lid env lid)
in (match (_53_3044) with
| (vname, vtok, env) -> begin
(let arg_sorts = (match (t_norm.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_fun (binders, _53_3047) -> begin
(FStar_All.pipe_right binders (FStar_List.map (fun _53_30 -> (match (_53_30) with
| (FStar_Util.Inl (_53_3052), _53_3055) -> begin
...
in (let _53_3077 = (match ((FStar_Absyn_Util.function_formals t_norm)) with
| Some (args, comp) -> begin
(match (encode_non_total_function_typ) with
| true -> begin
(let _118_2193 = (FStar_Tc_Util.pure_or_ghost_pre_and_post env.tcenv comp)
in (args, _118_2193))
end
| false -> begin
...
(let _53_3081 = (new_term_constant_and_tok_from_lid env lid)
in (match (_53_3081) with
| (vname, vtok, env) -> begin
...
(let _53_3100 = (FStar_Util.prefix vars)
in (match (_53_3100) with
| (_53_3095, (xxsym, _53_3098)) -> begin
(let xx = (FStar_ToSMT_Term.mkFreeV (xxsym, FStar_ToSMT_Term.Term_sort))
in (let _118_2210 = (let _118_2209 = (let _118_2208 = (let _118_2207 = (let _118_2206 = (let _118_2205 = (let _118_2204 = (let _118_2203 = (FStar_ToSMT_Term.mk_tester (escape d.FStar_Absyn_Syntax.str) xx)
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _118_2203))
in (vapp, _118_2204))
in (FStar_ToSMT_Term.mkEq _118_2205))
in ((vapp)::[], vars, _118_2206))
in (FStar_ToSMT_Term.mkForall _118_2207))
in (_118_2208, Some ("Discriminator equation")))
in FStar_ToSMT_Term.Assume (_118_2209))
in (_118_2210)::[]))
end))
end
| FStar_Absyn_Syntax.Projector (d, FStar_Util.Inr (f)) -> begin
(let _53_3113 = (FStar_Util.prefix vars)
in (match (_53_3113) with
| (_53_3108, (xxsym, _53_3111)) -> begin
(let xx = (FStar_ToSMT_Term.mkFreeV (xxsym, FStar_ToSMT_Term.Term_sort))
in (let prim_app = (let _118_2212 = (let _118_2211 = (mk_term_projector_name d f)
in (_118_2211, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _118_2212))
in (let _118_2217 = (let _118_2216 = (let _118_2215 = (let _118_2214 = (let _118_2213 = (FStar_ToSMT_Term.mkEq (vapp, prim_app))
in ((vapp)::[], vars, _118_2213))
in (FStar_ToSMT_Term.mkForall _118_2214))
in (_118_2215, Some ("Projector equation")))
in FStar_ToSMT_Term.Assume (_118_2216))
in (_118_2217)::[])))
end))
end
| _53_3117 -> begin
...
in (let _53_3124 = (encode_binders None formals env)
in (match (_53_3124) with
| (vars, guards, env', decls1, _53_3123) -> begin
(let _53_3133 = (match (pre_opt) with
| None -> begin
(let _118_2218 = (FStar_ToSMT_Term.mk_and_l guards)
in (_118_2218, decls1))
end
| Some (p) -> begin
(let _53_3130 = (encode_formula p env')
in (match (_53_3130) with
| (g, ds) -> begin
(let _118_2219 = (FStar_ToSMT_Term.mk_and_l ((g)::guards))
in (_118_2219, (FStar_List.append decls1 ds)))
end))
end)
in (match (_53_3133) with
| (guard, decls1) -> begin
(let vtok_app = (mk_ApplyE vtok_tm vars)
in (let vapp = (let _118_2221 = (let _118_2220 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (vname, _118_2220))
in (FStar_ToSMT_Term.mkApp _118_2221))
in (let _53_3164 = (let vname_decl = (let _118_2224 = (let _118_2223 = (FStar_All.pipe_right formals (FStar_List.map (fun _53_32 -> (match (_53_32) with
...
in (vname, _118_2223, FStar_ToSMT_Term.Term_sort, None))
in FStar_ToSMT_Term.DeclFun (_118_2224))
...
in (match (_53_3151) with
| (tok_typing, decls2) -> begin
(let tok_typing = FStar_ToSMT_Term.Assume ((tok_typing, Some ("function token typing")))
in (let _53_3161 = (match (formals) with
| [] -> begin
(let _118_2228 = (let _118_2227 = (let _118_2226 = (FStar_ToSMT_Term.mkFreeV (vname, FStar_ToSMT_Term.Term_sort))
in (FStar_All.pipe_left (fun _118_2225 -> Some (_118_2225)) _118_2226))
in (push_free_var env lid vname _118_2227))
in ((FStar_List.append decls2 ((tok_typing)::[])), _118_2228))
end
| _53_3155 -> begin
(let vtok_decl = FStar_ToSMT_Term.DeclFun ((vtok, [], FStar_ToSMT_Term.Term_sort, None))
in (let vtok_fresh = (let _118_2229 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (vtok, FStar_ToSMT_Term.Term_sort) _118_2229))
in (let name_tok_corr = (let _118_2233 = (let _118_2232 = (let _118_2231 = (let _118_2230 = (FStar_ToSMT_Term.mkEq (vtok_app, vapp))
in ((vtok_app)::[], vars, _118_2230))
in (FStar_ToSMT_Term.mkForall _118_2231))
in (_118_2232, None))
in FStar_ToSMT_Term.Assume (_118_2233))
in ((FStar_List.append decls2 ((vtok_decl)::(vtok_fresh)::(name_tok_corr)::(tok_typing)::[])), env))))
end)
in (match (_53_3161) with
| (tok_decl, env) -> begin
...
| (decls2, env) -> begin
(let _53_3172 = (let res_t = (FStar_Absyn_Util.compress_typ res_t)
in (let _53_3168 = (encode_typ_term res_t env')
in (match (_53_3168) with
| (encoded_res_t, decls) -> begin
(let _118_2234 = (FStar_ToSMT_Term.mk_HasType vapp encoded_res_t)
in (encoded_res_t, _118_2234, decls))
end)))
in (match (_53_3172) with
| (encoded_res_t, ty_pred, decls3) -> begin
(let typingAx = (let _118_2238 = (let _118_2237 = (let _118_2236 = (let _118_2235 = (FStar_ToSMT_Term.mkImp (guard, ty_pred))
in ((vapp)::[], vars, _118_2235))
in (FStar_ToSMT_Term.mkForall _118_2236))
in (_118_2237, Some ("free var typing")))
in FStar_ToSMT_Term.Assume (_118_2238))
in (let g = (let _118_2240 = (let _118_2239 = (mk_disc_proj_axioms guard encoded_res_t vapp vars)
in (typingAx)::_118_2239)
in (FStar_List.append (FStar_List.append (FStar_List.append decls1 decls2) decls3) _118_2240))
in (g, env)))
end))
end))))
end))
...
and encode_signature = (fun env ses -> (FStar_All.pipe_right ses (FStar_List.fold_left (fun _53_3179 se -> (match (_53_3179) with
| (g, env) -> begin
(let _53_3183 = (encode_sigelt env se)
in (match (_53_3183) with
| (g', env) -> begin
((FStar_List.append g g'), env)
end))
end)) ([], env))))

let encode_env_bindings = (fun env bindings -> (let encode_binding = (fun b _53_3190 -> (match (_53_3190) with
| (decls, env) -> begin
(match (b) with
| FStar_Tc_Env.Binding_var (x, t0) -> begin
(let _53_3198 = (new_term_constant env x)
in (match (_53_3198) with
| (xxsym, xx, env') -> begin
...
in (let _53_3200 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env.tcenv) (FStar_Options.Other ("Encoding")))) with
| true -> begin
(let _118_2255 = (FStar_Absyn_Print.strBvd x)
in (let _118_2254 = (FStar_Absyn_Print.typ_to_string t0)
in (let _118_2253 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.fprint3 "Normalized %s : %s to %s\n" _118_2255 _118_2254 _118_2253))))
end
| false -> begin
()
end)
in (let _53_3204 = (encode_typ_pred None t1 env xx)
in (match (_53_3204) with
| (t, decls') -> begin
(let caption = (match ((FStar_ST.read FStar_Options.logQueries)) with
| true -> begin
(let _118_2259 = (let _118_2258 = (FStar_Absyn_Print.strBvd x)
in (let _118_2257 = (FStar_Absyn_Print.typ_to_string t0)
in (let _118_2256 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _118_2258 _118_2257 _118_2256))))
in Some (_118_2259))
end
| false -> begin
None
...
(let _53_3214 = (new_typ_constant env a)
in (match (_53_3214) with
| (aasym, aa, env') -> begin
(let _53_3217 = (encode_knd k env aa)
in (match (_53_3217) with
| (k, decls') -> begin
(let g = (let _118_2265 = (let _118_2264 = (let _118_2263 = (let _118_2262 = (let _118_2261 = (let _118_2260 = (FStar_Absyn_Print.strBvd a)
in Some (_118_2260))
in (aasym, [], FStar_ToSMT_Term.Type_sort, _118_2261))
in FStar_ToSMT_Term.DeclFun (_118_2262))
in (_118_2263)::[])
in (FStar_List.append _118_2264 decls'))
in (FStar_List.append _118_2265 ((FStar_ToSMT_Term.Assume ((k, None)))::[])))
in ((FStar_List.append decls g), env'))
end))
end))
end
...
in (let _53_3226 = (encode_free_var env x t t_norm [])
...
(let _53_3231 = (encode_sigelt env se)
in (match (_53_3231) with
| (g, env') -> begin
((FStar_List.append decls g), env')
end))
end)
...
let encode_labels = (fun labs -> (let prefix = (FStar_All.pipe_right labs (FStar_List.map (fun _53_3238 -> (match (_53_3238) with
| (l, _53_3235, _53_3237) -> begin
...
(let _118_2273 = (FStar_All.pipe_left (fun _118_2269 -> FStar_ToSMT_Term.Echo (_118_2269)) (Prims.fst l))
in (let _118_2272 = (let _118_2271 = (let _118_2270 = (FStar_ToSMT_Term.mkFreeV l)
in FStar_ToSMT_Term.Eval (_118_2270))
in (_118_2271)::[])
in (_118_2273)::_118_2272))
end))))
in (prefix, suffix))))

let last_env = (FStar_Util.mk_ref [])

let init_env = (fun tcenv -> (let _118_2278 = (let _118_2277 = (let _118_2276 = (FStar_Util.smap_create 100)
in {bindings = []; depth = 0; tcenv = tcenv; warn = true; cache = _118_2276; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_118_2277)::[])
in (FStar_ST.op_Colon_Equals last_env _118_2278)))
...
| e::_53_3251 -> begin
(let _53_3254 = e
in {bindings = _53_3254.bindings; depth = _53_3254.depth; tcenv = tcenv; warn = _53_3254.warn; cache = _53_3254.cache; nolabels = _53_3254.nolabels; use_zfuel_name = _53_3254.use_zfuel_name; encode_non_total_function_typ = _53_3254.encode_non_total_function_typ})
end))
...
let push_env = (fun _53_3262 -> (match (()) with
| () -> begin
...
in (let top = (let _53_3268 = hd
in {bindings = _53_3268.bindings; depth = _53_3268.depth; tcenv = _53_3268.tcenv; warn = _53_3268.warn; cache = refs; nolabels = _53_3268.nolabels; use_zfuel_name = _53_3268.use_zfuel_name; encode_non_total_function_typ = _53_3268.encode_non_total_function_typ})
in (FStar_ST.op_Colon_Equals last_env ((top)::(hd)::tl))))
end)
end))

let pop_env = (fun _53_3271 -> (match (()) with
| () -> begin
(match ((FStar_ST.read last_env)) with
| [] -> begin
...
let mark_env = (fun _53_3277 -> (match (()) with
| () -> begin
(push_env ())
end))

let reset_mark_env = (fun _53_3278 -> (match (()) with
| () -> begin
(pop_env ())
end))

let commit_mark_env = (fun _53_3279 -> (match (()) with
| () -> begin
(match ((FStar_ST.read last_env)) with
| hd::_53_3282::tl -> begin
...
let init = (fun tcenv -> (let _53_3289 = (init_env tcenv)
in (let _53_3291 = (FStar_ToSMT_Z3.init ())
in (FStar_ToSMT_Z3.giveZ3 ((FStar_ToSMT_Term.DefPrelude)::[])))))

let push = (fun msg -> (let _53_3294 = (push_env ())
in (let _53_3296 = (varops.push ())
in (FStar_ToSMT_Z3.push msg))))

let pop = (fun msg -> (let _53_3299 = (let _118_2299 = (pop_env ())
in (FStar_All.pipe_left Prims.ignore _118_2299))
in (let _53_3301 = (varops.pop ())
in (FStar_ToSMT_Z3.pop msg))))

let mark = (fun msg -> (let _53_3304 = (mark_env ())
in (let _53_3306 = (varops.mark ())
in (FStar_ToSMT_Z3.mark msg))))

let reset_mark = (fun msg -> (let _53_3309 = (reset_mark_env ())
in (let _53_3311 = (varops.reset_mark ())
in (FStar_ToSMT_Z3.reset_mark msg))))

let commit_mark = (fun msg -> (let _53_3314 = (commit_mark_env ())
in (let _53_3316 = (varops.commit_mark ())
...
| true -> begin
(let _118_2313 = (let _118_2312 = (let _118_2311 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (Prims.strcat "encoding sigelt " _118_2311))
in FStar_ToSMT_Term.Caption (_118_2312))
in (_118_2313)::decls)
end
| false -> begin
decls
...
in (let _53_3325 = (encode_sigelt env se)
in (match (_53_3325) with
| (decls, env) -> begin
(let _53_3326 = (set_env env)
in (let _118_2314 = (caption decls)
in (FStar_ToSMT_Z3.giveZ3 _118_2314)))
end)))))
...
in (let _53_3331 = (match ((FStar_Tc_Env.debug tcenv FStar_Options.Low)) with
| true -> begin
(let _118_2319 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Absyn_Syntax.exports) FStar_Util.string_of_int)
...
in (let env = (get_env tcenv)
in (let _53_3338 = (encode_signature (let _53_3334 = env
in {bindings = _53_3334.bindings; depth = _53_3334.depth; tcenv = _53_3334.tcenv; warn = false; cache = _53_3334.cache; nolabels = _53_3334.nolabels; use_zfuel_name = _53_3334.use_zfuel_name; encode_non_total_function_typ = _53_3334.encode_non_total_function_typ}) modul.FStar_Absyn_Syntax.exports)
...
in (let _53_3344 = (set_env (let _53_3342 = env
in {bindings = _53_3342.bindings; depth = _53_3342.depth; tcenv = _53_3342.tcenv; warn = true; cache = _53_3342.cache; nolabels = _53_3342.nolabels; use_zfuel_name = _53_3342.use_zfuel_name; encode_non_total_function_typ = _53_3342.encode_non_total_function_typ}))
in (let _53_3346 = (match ((FStar_Tc_Env.debug tcenv FStar_Options.Low)) with
| true -> begin
...
let solve = (fun tcenv q -> (let _53_3351 = (let _118_2328 = (let _118_2327 = (let _118_2326 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _118_2326))
in (FStar_Util.format1 "Starting query at %s" _118_2327))
in (push _118_2328))
in (let pop = (fun _53_3354 -> (match (()) with
| () -> begin
(let _118_2333 = (let _118_2332 = (let _118_2331 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _118_2331))
in (FStar_Util.format1 "Ending query at %s" _118_2332))
in (pop _118_2333))
end))
in (let _53_3384 = (let env = (get_env tcenv)
in (let bindings = (FStar_Tc_Env.fold_env tcenv (fun bs b -> (b)::bs) [])
in (let _53_3367 = (let _118_2337 = (FStar_List.filter (fun _53_33 -> (match (_53_33) with
...
in (encode_env_bindings env _118_2337))
in (match (_53_3367) with
| (env_decls, env) -> begin
(let _53_3368 = (match ((FStar_Tc_Env.debug tcenv FStar_Options.Low)) with
| true -> begin
(let _118_2338 = (FStar_Absyn_Print.formula_to_string q)
in (FStar_Util.fprint1 "Encoding query formula: %s\n" _118_2338))
end
| false -> begin
()
end)
in (let _53_3373 = (encode_formula_with_labels q env)
in (match (_53_3373) with
| (phi, labels, qdecls) -> begin
(let _53_3376 = (encode_labels labels)
in (match (_53_3376) with
| (label_prefix, label_suffix) -> begin
(let query_prelude = (FStar_List.append (FStar_List.append env_decls label_prefix) qdecls)
in (let qry = (let _118_2340 = (let _118_2339 = (FStar_ToSMT_Term.mkNot phi)
in (_118_2339, Some ("query")))
in FStar_ToSMT_Term.Assume (_118_2340))
in (let suffix = (FStar_List.append label_suffix ((FStar_ToSMT_Term.Echo ("Done!"))::[]))
in (query_prelude, labels, qry, suffix))))
end))
end)))
end))))
in (match (_53_3384) with
| (prefix, labels, qry, suffix) -> begin
(match (qry) with
| FStar_ToSMT_Term.Assume ({FStar_ToSMT_Term.tm = FStar_ToSMT_Term.App (FStar_ToSMT_Term.False, _53_3391); FStar_ToSMT_Term.hash = _53_3388; FStar_ToSMT_Term.freevars = _53_3386}, _53_3396) -> begin
(let _53_3399 = (pop ())
in ())
end
| _53_3402 when tcenv.FStar_Tc_Env.admit -> begin
(let _53_3403 = (pop ())
in ())
end
| FStar_ToSMT_Term.Assume (q, _53_3407) -> begin
(let fresh = ((FStar_String.length q.FStar_ToSMT_Term.hash) >= 2048)
in (let _53_3411 = (FStar_ToSMT_Z3.giveZ3 prefix)
in (let with_fuel = (fun p _53_3417 -> (match (_53_3417) with
| (n, i) -> begin
(let _118_2363 = (let _118_2362 = (let _118_2347 = (let _118_2346 = (FStar_Util.string_of_int n)
in (let _118_2345 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "<fuel=\'%s\' ifuel=\'%s\'>" _118_2346 _118_2345)))
in FStar_ToSMT_Term.Caption (_118_2347))
in (let _118_2361 = (let _118_2360 = (let _118_2352 = (let _118_2351 = (let _118_2350 = (let _118_2349 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (let _118_2348 = (FStar_ToSMT_Term.n_fuel n)
in (_118_2349, _118_2348)))
in (FStar_ToSMT_Term.mkEq _118_2350))
in (_118_2351, None))
in FStar_ToSMT_Term.Assume (_118_2352))
in (let _118_2359 = (let _118_2358 = (let _118_2357 = (let _118_2356 = (let _118_2355 = (let _118_2354 = (FStar_ToSMT_Term.mkApp ("MaxIFuel", []))
in (let _118_2353 = (FStar_ToSMT_Term.n_fuel i)
in (_118_2354, _118_2353)))
in (FStar_ToSMT_Term.mkEq _118_2355))
in (_118_2356, None))
in FStar_ToSMT_Term.Assume (_118_2357))
in (_118_2358)::(p)::(FStar_ToSMT_Term.CheckSat)::[])
in (_118_2360)::_118_2359))
in (_118_2362)::_118_2361))
in (FStar_List.append _118_2363 suffix))
end))
in (let check = (fun p -> (let initial_config = (let _118_2367 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _118_2366 = (FStar_ST.read FStar_Options.initial_ifuel)
in (_118_2367, _118_2366)))
in (let alt_configs = (let _118_2386 = (let _118_2385 = (match (((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel))) with
| true -> begin
(let _118_2370 = (let _118_2369 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _118_2368 = (FStar_ST.read FStar_Options.max_ifuel)
...
in (let _118_2384 = (let _118_2383 = (match ((((FStar_ST.read FStar_Options.max_fuel) / 2) > (FStar_ST.read FStar_Options.initial_fuel))) with
| true -> begin
(let _118_2373 = (let _118_2372 = ((FStar_ST.read FStar_Options.max_fuel) / 2)
in (let _118_2371 = (FStar_ST.read FStar_Options.max_ifuel)
in (_118_2372, _118_2371)))
in (_118_2373)::[])
end
| false -> begin
[]
end)
in (let _118_2382 = (let _118_2381 = (match ((((FStar_ST.read FStar_Options.max_fuel) > (FStar_ST.read FStar_Options.initial_fuel)) && ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel)))) with
| true -> begin
(let _118_2376 = (let _118_2375 = (FStar_ST.read FStar_Options.max_fuel)
in (let _118_2374 = (FStar_ST.read FStar_Options.max_ifuel)
in (_118_2375, _118_2374)))
in (_118_2376)::[])
end
| false -> begin
[]
end)
in (let _118_2380 = (let _118_2379 = (match (((FStar_ST.read FStar_Options.min_fuel) < (FStar_ST.read FStar_Options.initial_fuel))) with
| true -> begin
(let _118_2378 = (let _118_2377 = (FStar_ST.read FStar_Options.min_fuel)
in (_118_2377, 1))
in (_118_2378)::[])
end
| false -> begin
...
in (FStar_List.flatten _118_2386))
...
in (let _53_3428 = (match ((FStar_ST.read FStar_Options.print_fuels)) with
| true -> begin
(let _118_2394 = (let _118_2389 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _118_2389))
in (let _118_2393 = (let _118_2390 = (FStar_ST.read FStar_Options.max_fuel)
in (FStar_All.pipe_right _118_2390 FStar_Util.string_of_int))
in (let _118_2392 = (let _118_2391 = (FStar_ST.read FStar_Options.max_ifuel)
in (FStar_All.pipe_right _118_2391 FStar_Util.string_of_int))
in (FStar_Util.fprint3 "(%s) Query failed with maximum fuel %s and ifuel %s\n" _118_2394 _118_2393 _118_2392))))
end
| false -> begin
()
end)
...
in (FStar_ToSMT_Z3.ask fresh labels _118_2405 (cb mi p [])))
end
| _53_3440 -> begin
(report errs)
end)
...
in (FStar_ToSMT_Z3.ask fresh labels _118_2407 (fun _53_3446 -> (match (_53_3446) with
| (ok, errs') -> begin
(match (errs) with
| [] -> begin
(cb mi p tl (ok, errs'))
...
and cb = (fun _53_3452 p alt _53_3457 -> (match ((_53_3452, _53_3457)) with
| ((prev_fuel, prev_ifuel), (ok, errs)) -> begin
(match (ok) with
| true -> begin
(match ((FStar_ST.read FStar_Options.print_fuels)) with
| true -> begin
(let _118_2415 = (let _118_2412 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _118_2412))
in (let _118_2414 = (FStar_Util.string_of_int prev_fuel)
in (let _118_2413 = (FStar_Util.string_of_int prev_ifuel)
in (FStar_Util.fprint3 "(%s) Query succeeded with fuel %s and ifuel %s\n" _118_2415 _118_2414 _118_2413))))
end
| false -> begin
()
end)
...
in (let _118_2416 = (with_fuel p initial_config)
in (FStar_ToSMT_Z3.ask fresh labels _118_2416 (cb initial_config p alt_configs))))))))
in (let process_query = (fun q -> (match (((FStar_ST.read FStar_Options.split_cases) > 0)) with
| true -> begin
(let _53_3462 = (let _118_2422 = (FStar_ST.read FStar_Options.split_cases)
in (FStar_ToSMT_SplitQueryCases.can_handle_query _118_2422 q))
...
in (let _53_3463 = (match ((FStar_ST.read FStar_Options.admit_smt_queries)) with
| true -> begin
()
end
| false -> begin
...
in (let _53_3468 = (push "query")
in (let _53_3475 = (encode_formula_with_labels q env)
in (match (_53_3475) with
| (f, _53_3472, _53_3474) -> begin
(let _53_3476 = (pop "query")
in (match (f.FStar_ToSMT_Term.tm) with
| FStar_ToSMT_Term.App (FStar_ToSMT_Term.True, _53_3480) -> begin
true
end
| _53_3484 -> begin
false
...
let dummy = {FStar_Tc_Env.init = (fun _53_3485 -> ()); FStar_Tc_Env.push = (fun _53_3487 -> ()); FStar_Tc_Env.pop = (fun _53_3489 -> ()); FStar_Tc_Env.mark = (fun _53_3491 -> ()); FStar_Tc_Env.reset_mark = (fun _53_3493 -> ()); FStar_Tc_Env.commit_mark = (fun _53_3495 -> ()); FStar_Tc_Env.encode_modul = (fun _53_3497 _53_3499 -> ()); FStar_Tc_Env.encode_sig = (fun _53_3501 _53_3503 -> ()); FStar_Tc_Env.solve = (fun _53_3505 _53_3507 -> ()); FStar_Tc_Env.is_trivial = (fun _53_3509 _53_3511 -> false); FStar_Tc_Env.finish = (fun _53_3513 -> ()); FStar_Tc_Env.refresh = (fun _53_3514 -> ())}
