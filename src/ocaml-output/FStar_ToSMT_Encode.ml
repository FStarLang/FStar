...
in (FStar_Util.find_map _151_165 (fun _51_109 -> (match (_51_109) with
| (names, _51_108) -> begin
...
in (FStar_Util.find_map _151_186 (fun _51_136 -> (match (_51_136) with
...
let print_env : env_t  ->  Prims.string = (fun e -> (let _151_300 = (FStar_All.pipe_right e.bindings (FStar_List.map (fun _51_2 -> (match (_51_2) with
...
in {bindings = _151_365; depth = _51_295.depth; tcenv = _51_295.tcenv; warn = _51_295.warn; cache = _51_295.cache; nolabels = _51_295.nolabels; use_zfuel_name = _51_295.use_zfuel_name; encode_non_total_function_typ = _51_295.encode_non_total_function_typ}))
...
in {bindings = _151_415; depth = _51_392.depth; tcenv = _51_392.tcenv; warn = _51_392.warn; cache = _51_392.cache; nolabels = _51_392.nolabels; use_zfuel_name = _51_392.use_zfuel_name; encode_non_total_function_typ = _51_392.encode_non_total_function_typ}))
...
in (FStar_All.pipe_right _151_642 (FStar_List.filter (fun _51_731 -> (match (_51_731) with
| (x, _51_730) -> begin
(x <> (Prims.fst tsym))
end)))))
in (
...
let _51_800 = (let _151_672 = (norm_t env t)
...
in (FStar_All.pipe_right _151_694 (FStar_List.filter (fun _51_872 -> (match (_51_872) with
| (x, _51_871) -> begin
(x <> (Prims.fst fsym))
end)))))
in (
...
in (FStar_All.pipe_right _151_726 (FStar_List.filter (fun _51_942 -> (match (_51_942) with
| (y, _51_941) -> begin
((y <> x) && (y <> fsym))
end)))))
in (
...
let t = (let _151_747 = (let _151_746 = (FStar_List.map (fun _51_11 -> (match (_51_11) with
...
let _51_1055 = (let _151_765 = (FStar_Tc_Recheck.recompute_kind t0)
...
let tm = (let _151_818 = (let _151_817 = (let _151_816 = (FStar_List.map (fun _51_12 -> (match (_51_12) with
| (FStar_Util.Inl (t)) | (FStar_Util.Inr (t)) -> begin
t
end)) args)
...
(let _151_871 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _51_1488 -> (match (_51_1488) with
| (arg, _51_1487) -> begin
(
...
let _51_1722 = (match ((let _151_897 = (FStar_Absyn_Util.compress_typ t)
...
let _51_1749 = (let _151_902 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (

let _51_1746 = (let _151_901 = (FStar_All.pipe_right branch (FStar_List.map (fun _51_13 -> (match (_51_13) with
...
let _51_1778 = (let _151_915 = (FStar_Absyn_Util.unmeta_typ pre)
in (encode_formula _151_915 env))
in (match (_51_1778) with
| (pre, decls'') -> begin
(

let _51_1781 = (let _151_916 = (FStar_Absyn_Util.unmeta_typ post)
...
let _51_2035 = (let _151_1072 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (

let _51_2032 = (let _151_1071 = (FStar_All.pipe_right p (FStar_List.map (fun _51_18 -> (match (_51_18) with
...
let mk = (fun l v -> (let _151_1350 = (FStar_All.pipe_right prims (FStar_List.filter (fun _51_2122 -> (match (_51_2122) with
| (l', _51_2121) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _151_1350 (FStar_List.collect (fun _51_2126 -> (match (_51_2126) with
| (_51_2124, b) -> begin
(b v)
end))))))
in (
...
let mk_int_alias = (fun _51_2162 tt -> (let _151_1467 = (let _151_1466 = (let _151_1465 = (let _151_1464 = (let _151_1463 = (FStar_ToSMT_Term.mkApp ((FStar_Absyn_Const.int_lid.FStar_Ident.str), ([])))
in ((tt), (_151_1463)))
...
let _51_2338 = (let _151_1854 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
...
let _51_2438 = (let _151_1893 = (FStar_Tc_Recheck.recompute_kind t)
...
let _51_2583 = (match ((let _151_1956 = (FStar_Absyn_Util.compress_kind k)
...
let tname_decl = (let _151_1994 = (let _151_1993 = (FStar_All.pipe_right vars (FStar_List.map (fun _51_2652 -> (match (_51_2652) with
| (n, s) -> begin
...
let t = (let _151_2024 = (FStar_List.map (fun _51_2705 -> (match (_51_2705) with
| (x, _51_2704) -> begin
...
let _51_2783 = (let _151_2037 = (FStar_Absyn_Util.new_bvd None)
...
let _51_2790 = (let _151_2040 = (FStar_Absyn_Util.new_bvd None)
...
let _51_2815 = (let _151_2073 = (let _151_2072 = (FStar_Absyn_Print.sli d)
...
let _51_2992 = (let _151_2140 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
...
let _51_3141 = (let _151_2218 = (FStar_List.zip3 gtoks typs bindings)
...
let _51_3150 = (let _151_2220 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _151_2220 (FStar_List.partition (fun _51_29 -> (match (_51_29) with
...
let vname_decl = (let _151_2269 = (let _151_2268 = (FStar_All.pipe_right formals (FStar_List.map (fun _51_32 -> (match (_51_32) with
...
let _51_3458 = (let _151_2345 = (pop_env ())
...
let _51_3510 = (let _151_2374 = (let _151_2373 = (let _151_2372 = (FStar_Tc_Env.get_range tcenv)
...
let _51_3555 = (let _151_2390 = (FStar_List.filter (fun _51_33 -> (match (_51_33) with
...
in (FStar_ToSMT_Z3.ask fresh labels _151_2460 (fun _51_3634 -> (match (_51_3634) with
| (ok, errs') -> begin
(match (errs) with
| [] -> begin
(cb mi p tl ((ok), (errs')))
...
let _51_3650 = (let _151_2475 = (FStar_Options.split_cases ())
