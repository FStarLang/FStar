...
let mk_typ_projector_name : FStar_Ident.lident  ->  FStar_Absyn_Syntax.btvdef  ->  Prims.string = (fun lid a -> (let _127_14 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str (escape_null_name a))
in (FStar_All.pipe_left escape _127_14)))
...
let a = (let _127_19 = (FStar_Absyn_Util.unmangle_field_name a.FStar_Absyn_Syntax.ppname)
in {FStar_Absyn_Syntax.ppname = _127_19; FStar_Absyn_Syntax.realname = a.FStar_Absyn_Syntax.realname})
in (let _127_20 = (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str (escape_null_name a))
in (FStar_All.pipe_left escape _127_20))))
...
| () -> begin
(let _127_30 = (let _127_29 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "Projector %s on data constructor %s not found" _127_29 lid.FStar_Ident.str))
in (FStar_All.failwith _127_30))
end))
in (
# 50 "FStar.ToSMT.Encode.fst"
let t = (FStar_Tc_Env.lookup_datacon env lid)
in (match ((let _127_31 = (FStar_Absyn_Util.compress_typ t)
in _127_31.FStar_Absyn_Syntax.n)) with
...
let mk_term_projector_name_by_pos : FStar_Ident.lident  ->  Prims.int  ->  Prims.string = (fun lid i -> (let _127_37 = (let _127_36 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "%s_%s" lid.FStar_Ident.str _127_36))
in (FStar_All.pipe_left escape _127_37)))

# 62 "FStar.ToSMT.Encode.fst"
let mk_typ_projector : FStar_Ident.lident  ->  FStar_Absyn_Syntax.btvdef  ->  FStar_ToSMT_Term.term = (fun lid a -> (let _127_43 = (let _127_42 = (mk_typ_projector_name lid a)
in (_127_42, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Type_sort))))
in (FStar_ToSMT_Term.mkFreeV _127_43)))

# 64 "FStar.ToSMT.Encode.fst"
let mk_term_projector : FStar_Ident.lident  ->  FStar_Absyn_Syntax.bvvdef  ->  FStar_ToSMT_Term.term = (fun lid a -> (let _127_49 = (let _127_48 = (mk_term_projector_name lid a)
in (_127_48, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Term_sort))))
in (FStar_ToSMT_Term.mkFreeV _127_49)))

# 66 "FStar.ToSMT.Encode.fst"
let mk_term_projector_by_pos : FStar_Ident.lident  ->  Prims.int  ->  FStar_ToSMT_Term.term = (fun lid i -> (let _127_55 = (let _127_54 = (mk_term_projector_name_by_pos lid i)
in (_127_54, FStar_ToSMT_Term.Arrow ((FStar_ToSMT_Term.Term_sort, FStar_ToSMT_Term.Term_sort))))
in (FStar_ToSMT_Term.mkFreeV _127_55)))
...
| () -> begin
(let _127_159 = (FStar_Util.smap_create 100)
in (let _127_158 = (FStar_Util.smap_create 100)
in (_127_159, _127_158)))
end))
in (
# 87 "FStar.ToSMT.Encode.fst"
let scopes = (let _127_161 = (let _127_160 = (new_scope ())
in (_127_160)::[])
in (FStar_Util.mk_ref _127_161))
in (
...
let y = (match ((let _127_165 = (FStar_ST.read scopes)
in (FStar_Util.find_map _127_165 (fun _46_108 -> (match (_46_108) with
| (names, _46_107) -> begin
...
in (let _127_167 = (let _127_166 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _127_166))
in (Prims.strcat (Prims.strcat y "__") _127_167)))
end)
in (
# 93 "FStar.ToSMT.Encode.fst"
let top_scope = (let _127_169 = (let _127_168 = (FStar_ST.read scopes)
in (FStar_List.hd _127_168))
in (FStar_All.pipe_left Prims.fst _127_169))
in (
...
let new_var = (fun pp rn -> (let _127_175 = (let _127_174 = (FStar_All.pipe_left mk_unique pp.FStar_Ident.idText)
in (Prims.strcat _127_174 "__"))
in (Prims.strcat _127_175 rn.FStar_Ident.idText)))
in (
...
let fresh = (fun pfx -> (let _127_183 = (let _127_182 = (next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _127_182))
in (FStar_Util.format2 "%s_%s" pfx _127_183)))
in (
# 99 "FStar.ToSMT.Encode.fst"
let string_const = (fun s -> (match ((let _127_187 = (FStar_ST.read scopes)
in (FStar_Util.find_map _127_187 (fun _46_135 -> (match (_46_135) with
...
let f = (let _127_188 = (FStar_ToSMT_Term.mk_String_const id)
in (FStar_All.pipe_left FStar_ToSMT_Term.boxString _127_188))
in (
# 104 "FStar.ToSMT.Encode.fst"
let top_scope = (let _127_190 = (let _127_189 = (FStar_ST.read scopes)
in (FStar_List.hd _127_189))
in (FStar_All.pipe_left Prims.snd _127_190))
in (
...
| () -> begin
(let _127_195 = (let _127_194 = (new_scope ())
in (let _127_193 = (FStar_ST.read scopes)
in (_127_194)::_127_193))
in (FStar_ST.op_Colon_Equals scopes _127_195))
end))
in (
# 108 "FStar.ToSMT.Encode.fst"
let pop = (fun _46_147 -> (match (()) with
| () -> begin
(let _127_199 = (let _127_198 = (FStar_ST.read scopes)
in (FStar_List.tl _127_198))
in (FStar_ST.op_Colon_Equals scopes _127_199))
end))
in (
...
let unmangle = (fun x -> (let _127_215 = (let _127_214 = (FStar_Absyn_Util.unmangle_field_name x.FStar_Absyn_Syntax.ppname)
in (let _127_213 = (FStar_Absyn_Util.unmangle_field_name x.FStar_Absyn_Syntax.realname)
in (_127_214, _127_213)))
in (FStar_Absyn_Util.mkbvd _127_215)))
...
let print_env : env_t  ->  Prims.string = (fun e -> (let _127_301 = (FStar_All.pipe_right e.bindings (FStar_List.map (fun _46_2 -> (match (_46_2) with
...
in (FStar_All.pipe_right _127_301 (FStar_String.concat ", "))))
...
(let _127_311 = (FStar_Absyn_Print.typ_to_string t)
in Some (_127_311))
end else begin
None
end)
...
in (let _127_316 = (FStar_ToSMT_Term.mkFreeV (xsym, s))
in (xsym, _127_316))))
...
let ysym = (let _127_321 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@x" _127_321))
in (
...
| None -> begin
(let _127_336 = (let _127_335 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Bound term variable not found: %s" _127_335))
in (FStar_All.failwith _127_336))
end
| Some (b, t) -> begin
t
end))
...
let ysym = (let _127_341 = (FStar_Util.string_of_int env.depth)
in (Prims.strcat "@a" _127_341))
in (
...
| None -> begin
(let _127_356 = (let _127_355 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Bound type variable not found: %s" _127_355))
in (FStar_All.failwith _127_356))
end
| Some (b, t) -> begin
t
end))
...
let _46_294 = env
in (let _127_366 = (let _127_365 = (let _127_364 = (let _127_363 = (let _127_362 = (FStar_ToSMT_Term.mkApp (ftok, []))
in (FStar_All.pipe_left (fun _127_361 -> Some (_127_361)) _127_362))
in (x, fname, _127_363, None))
in Binding_fvar (_127_364))
in (_127_365)::env.bindings)
in {bindings = _127_366; depth = _46_294.depth; tcenv = _46_294.tcenv; warn = _46_294.warn; cache = _46_294.cache; nolabels = _46_294.nolabels; use_zfuel_name = _46_294.use_zfuel_name; encode_non_total_function_typ = _46_294.encode_non_total_function_typ}))
in (fname, ftok, _127_367)))))
...
| None -> begin
(let _127_378 = (let _127_377 = (FStar_Absyn_Print.sli a)
in (FStar_Util.format1 "Name not found: %s" _127_377))
in (FStar_All.failwith _127_378))
end
| Some (s) -> begin
s
end))
...
let t3 = (let _127_395 = (let _127_394 = (let _127_393 = (FStar_ToSMT_Term.mkApp ("ZFuel", []))
in (_127_393)::[])
in (f, _127_394))
in (FStar_ToSMT_Term.mkApp _127_395))
in (
...
if (let _127_399 = (let _127_398 = (FStar_ToSMT_Term.fv_of_term fuel)
in (FStar_All.pipe_right _127_398 Prims.fst))
in (FStar_Util.starts_with _127_399 "fuel")) then begin
(let _127_400 = (FStar_ToSMT_Term.mkFreeV (name, FStar_ToSMT_Term.Term_sort))
in (FStar_ToSMT_Term.mk_ApplyEF _127_400 fuel))
end else begin
t
end
end
...
| _46_350 -> begin
(let _127_402 = (let _127_401 = (FStar_Absyn_Print.sli a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Name not found: %s" _127_401))
in (FStar_All.failwith _127_402))
end)
end)
end)))
...
let _46_391 = env
in (let _127_416 = (let _127_415 = (let _127_414 = (let _127_413 = (let _127_412 = (FStar_ToSMT_Term.mkApp (ftok, []))
in (FStar_All.pipe_left (fun _127_411 -> Some (_127_411)) _127_412))
in (x, fname, _127_413))
in Binding_ftvar (_127_414))
in (_127_415)::env.bindings)
in {bindings = _127_416; depth = _46_391.depth; tcenv = _46_391.tcenv; warn = _46_391.warn; cache = _46_391.cache; nolabels = _46_391.nolabels; use_zfuel_name = _46_391.use_zfuel_name; encode_non_total_function_typ = _46_391.encode_non_total_function_typ}))
in (fname, ftok, _127_417)))))
...
| None -> begin
(let _127_424 = (let _127_423 = (FStar_Absyn_Print.sli a)
in (FStar_Util.format1 "Type name not found: %s" _127_423))
in (FStar_All.failwith _127_424))
end
| Some (s) -> begin
s
end))
...
let lookup_free_tvar = (fun env a -> (match ((let _127_435 = (lookup_tlid env a.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _127_435 Prims.snd))) with
| None -> begin
(let _127_437 = (let _127_436 = (FStar_Absyn_Print.sli a.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 "Type name not found: %s" _127_436))
in (FStar_All.failwith _127_437))
end
| Some (t) -> begin
t
end))
...
let lookup_free_tvar_name = (fun env a -> (let _127_440 = (lookup_tlid env a.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _127_440 Prims.fst)))
...
(let _127_453 = (add_fuel guards)
in (FStar_ToSMT_Term.mk_and_l _127_453))
end
| _46_468 -> begin
(let _127_454 = (add_fuel ((guard)::[]))
in (FStar_All.pipe_right _127_454 FStar_List.hd))
end)
...
(let _127_460 = (FStar_Tc_Env.lookup_typ_abbrev env.tcenv v.FStar_Absyn_Syntax.v)
in (FStar_All.pipe_right _127_460 FStar_Option.isNone))
end
| _46_509 -> begin
false
end)))
...
let trivial_post : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun t -> (let _127_482 = (let _127_481 = (let _127_479 = (FStar_Absyn_Syntax.null_v_binder t)
in (_127_479)::[])
in (let _127_480 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.true_lid FStar_Absyn_Syntax.ktype)
in (_127_481, _127_480)))
in (FStar_Absyn_Syntax.mk_Typ_lam _127_482 None t.FStar_Absyn_Syntax.pos)))
...
(let _127_489 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyET out _127_489))
end
| FStar_ToSMT_Term.Fuel_sort -> begin
(let _127_490 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyEF out _127_490))
end
| _46_526 -> begin
(let _127_491 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyEE out _127_491))
end)) e)))
...
| FStar_ToSMT_Term.Type_sort -> begin
(let _127_504 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyTT out _127_504))
end
| _46_541 -> begin
(let _127_505 = (FStar_ToSMT_Term.mkFreeV var)
in (FStar_ToSMT_Term.mk_ApplyTE out _127_505))
end)) t)))
...
(let _127_561 = (FStar_ToSMT_Term.mkInteger' (FStar_Util.int_of_char c))
in (FStar_ToSMT_Term.boxInt _127_561))
end
| FStar_Const.Const_uint8 (i) -> begin
(let _127_562 = (FStar_ToSMT_Term.mkInteger' (FStar_Util.int_of_uint8 i))
in (FStar_ToSMT_Term.boxInt _127_562))
end
| FStar_Const.Const_int (i) -> begin
(let _127_563 = (FStar_ToSMT_Term.mkInteger i)
in (FStar_ToSMT_Term.boxInt _127_563))
end
| FStar_Const.Const_int32 (i) -> begin
(let _127_567 = (let _127_566 = (let _127_565 = (let _127_564 = (FStar_ToSMT_Term.mkInteger32 i)
in (FStar_ToSMT_Term.boxInt _127_564))
in (_127_565)::[])
in ("FStar.Int32.Int32", _127_566))
in (FStar_ToSMT_Term.mkApp _127_567))
end
| FStar_Const.Const_string (bytes, _46_626) -> begin
(let _127_568 = (FStar_All.pipe_left FStar_Util.string_of_bytes bytes)
in (varops.string_const _127_568))
end
| c -> begin
(let _127_570 = (let _127_569 = (FStar_Absyn_Print.const_to_string c)
in (FStar_Util.format1 "Unhandled constant: %s\n" _127_569))
in (FStar_All.failwith _127_570))
end))
...
(let _127_579 = (FStar_Absyn_Util.unrefine t)
in (aux true _127_579))
end
| _46_643 -> begin
if norm then begin
(let _127_580 = (whnf env t)
in (aux false _127_580))
end else begin
(let _127_583 = (let _127_582 = (FStar_Range.string_of_range t0.FStar_Absyn_Syntax.pos)
in (let _127_581 = (FStar_Absyn_Print.typ_to_string t0)
in (FStar_Util.format2 "(%s) Expected a function typ; got %s" _127_582 _127_581)))
in (FStar_All.failwith _127_583))
end
end)))
in (aux true t0)))

# 415 "FStar.ToSMT.Encode.fst"
let rec encode_knd_term : FStar_Absyn_Syntax.knd  ->  env_t  ->  (FStar_ToSMT_Term.term * FStar_ToSMT_Term.decls_t) = (fun k env -> (match ((let _127_620 = (FStar_Absyn_Util.compress_kind k)
in _127_620.FStar_Absyn_Syntax.n)) with
...
(let _127_622 = (FStar_Absyn_Print.kind_to_string k)
in (let _127_621 = (FStar_Absyn_Print.kind_to_string k0)
...
(let _127_624 = (let _127_623 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Kind_uvar _127_623))
in (_127_624, []))
end
| FStar_Absyn_Syntax.Kind_arrow (bs, kbody) -> begin
(
# 428 "FStar.ToSMT.Encode.fst"
let tsym = (let _127_625 = (varops.fresh "t")
in (_127_625, FStar_ToSMT_Term.Type_sort))
in (
...
| _46_694 -> begin
(let _127_634 = (let _127_633 = (let _127_632 = (FStar_ToSMT_Term.mk_PreKind app)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _127_632))
in (_127_633, body))
in (FStar_ToSMT_Term.mkAnd _127_634))
end)
in (let _127_636 = (let _127_635 = (FStar_ToSMT_Term.mkImp (g, body))
in (((app)::[])::[], (x)::[], _127_635))
in (FStar_ToSMT_Term.mkForall _127_636)))))
end
| _46_697 -> begin
...
let cvars = (let _127_638 = (FStar_ToSMT_Term.free_variables k_interp)
in (FStar_All.pipe_right _127_638 (FStar_List.filter (fun _46_702 -> (match (_46_702) with
| (x, _46_701) -> begin
(x <> (Prims.fst tsym))
end)))))
in (
...
(let _127_641 = (let _127_640 = (let _127_639 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (k', _127_639))
in (FStar_ToSMT_Term.mkApp _127_640))
in (_127_641, []))
end
| None -> begin
(
...
(let _127_642 = (FStar_Tc_Normalize.kind_norm_to_string env.tcenv k)
in Some (_127_642))
end else begin
None
end
...
let k = (let _127_644 = (let _127_643 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (ksym, _127_643))
in (FStar_ToSMT_Term.mkApp _127_644))
in (
# 464 "FStar.ToSMT.Encode.fst"
let t_has_k = (FStar_ToSMT_Term.mk_HasKind t k)
in (
# 465 "FStar.ToSMT.Encode.fst"
let k_interp = (let _127_653 = (let _127_652 = (let _127_651 = (let _127_650 = (let _127_649 = (let _127_648 = (let _127_647 = (let _127_646 = (let _127_645 = (FStar_ToSMT_Term.mk_PreKind t)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _127_645))
in (_127_646, k_interp))
in (FStar_ToSMT_Term.mkAnd _127_647))
in (t_has_k, _127_648))
in (FStar_ToSMT_Term.mkIff _127_649))
in (((t_has_k)::[])::[], (tsym)::cvars, _127_650))
in (FStar_ToSMT_Term.mkForall _127_651))
in (_127_652, Some ((Prims.strcat ksym " interpretation"))))
in FStar_ToSMT_Term.Assume (_127_653))
in (
...
| _46_723 -> begin
(let _127_655 = (let _127_654 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.format1 "Unknown kind: %s" _127_654))
in (FStar_All.failwith _127_655))
end))
...
| (k, decls) -> begin
(let _127_659 = (FStar_ToSMT_Term.mk_HasKind t k)
in (_127_659, decls))
end)))
...
(let _127_663 = (FStar_Absyn_Print.binders_to_string ", " bs)
...
(let _127_667 = (FStar_Absyn_Print.strBvd a)
in (let _127_666 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.print3 "Encoding type binder %s (%s) at kind %s\n" _127_667 aasym _127_666)))
end else begin
()
end
in (
...
let _46_771 = (let _127_668 = (norm_t env t)
in (encode_typ_pred fuel_opt _127_668 env xx))
...
| (t, decls) -> begin
(let _127_673 = (FStar_ToSMT_Term.mk_HasTypeWithFuel fuel_opt e t)
in (_127_673, decls))
end))))
and encode_typ_pred' : FStar_ToSMT_Term.term Prims.option  ->  FStar_Absyn_Syntax.typ  ->  env_t  ->  FStar_ToSMT_Term.term  ->  (FStar_ToSMT_Term.term * FStar_ToSMT_Term.decls_t) = (fun fuel_opt t env e -> (
...
(match (fuel_opt) with
| None -> begin
(let _127_678 = (FStar_ToSMT_Term.mk_HasTypeZ e t)
in (_127_678, decls))
end
| Some (f) -> begin
(let _127_679 = (FStar_ToSMT_Term.mk_HasTypeFuel f e t)
in (_127_679, decls))
end)
end))))
...
(let _127_682 = (lookup_typ_var env a)
in (_127_682, []))
end
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
(let _127_683 = (lookup_free_tvar env fv)
in (_127_683, []))
end
...
let fsym = (let _127_684 = (varops.fresh "f")
in (_127_684, FStar_ToSMT_Term.Term_sort))
in (
...
| None -> begin
(let _127_685 = (FStar_ToSMT_Term.mk_and_l guards)
in (_127_685, decls))
end
| Some (pre) -> begin
(
...
| (guard, decls0) -> begin
(let _127_686 = (FStar_ToSMT_Term.mk_and_l ((guard)::guards))
in (_127_686, (FStar_List.append decls decls0)))
end))
end)
...
let t_interp = (let _127_688 = (let _127_687 = (FStar_ToSMT_Term.mkImp (guards, res_pred))
in (((app)::[])::[], vars, _127_687))
in (FStar_ToSMT_Term.mkForall _127_688))
in (
# 566 "FStar.ToSMT.Encode.fst"
let cvars = (let _127_690 = (FStar_ToSMT_Term.free_variables t_interp)
in (FStar_All.pipe_right _127_690 (FStar_List.filter (fun _46_843 -> (match (_46_843) with
| (x, _46_842) -> begin
(x <> (Prims.fst fsym))
end)))))
in (
...
(let _127_693 = (let _127_692 = (let _127_691 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (t', _127_691))
in (FStar_ToSMT_Term.mkApp _127_692))
in (_127_693, []))
end
| None -> begin
(
...
let caption = if (FStar_ST.read FStar_Options.logQueries) then begin
(let _127_694 = (FStar_Tc_Normalize.typ_norm_to_string env.tcenv t0)
in Some (_127_694))
end else begin
None
end
...
let t = (let _127_696 = (let _127_695 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _127_695))
in (FStar_ToSMT_Term.mkApp _127_696))
in (
...
let k_assumption = (let _127_698 = (let _127_697 = (FStar_ToSMT_Term.mkForall (((t_has_kind)::[])::[], cvars, t_has_kind))
in (_127_697, Some ((Prims.strcat tsym " kinding"))))
in FStar_ToSMT_Term.Assume (_127_698))
in (
...
let pre_typing = (let _127_705 = (let _127_704 = (let _127_703 = (let _127_702 = (let _127_701 = (let _127_700 = (let _127_699 = (FStar_ToSMT_Term.mk_PreType f)
in (FStar_ToSMT_Term.mk_tester "Typ_fun" _127_699))
in (f_has_t, _127_700))
in (FStar_ToSMT_Term.mkImp _127_701))
in (((f_has_t)::[])::[], (fsym)::cvars, _127_702))
in (mkForall_fuel _127_703))
in (_127_704, Some ("pre-typing for functions")))
in FStar_ToSMT_Term.Assume (_127_705))
in (
# 590 "FStar.ToSMT.Encode.fst"
let t_interp = (let _127_709 = (let _127_708 = (let _127_707 = (let _127_706 = (FStar_ToSMT_Term.mkIff (f_has_t_z, t_interp))
in (((f_has_t_z)::[])::[], (fsym)::cvars, _127_706))
in (FStar_ToSMT_Term.mkForall _127_707))
in (_127_708, Some ((Prims.strcat tsym " interpretation"))))
in FStar_ToSMT_Term.Assume (_127_709))
in (
...
let t_kinding = (let _127_711 = (let _127_710 = (FStar_ToSMT_Term.mk_HasKind t FStar_ToSMT_Term.mk_Kind_type)
in (_127_710, None))
in FStar_ToSMT_Term.Assume (_127_711))
in (
...
let t_interp = (let _127_718 = (let _127_717 = (let _127_716 = (let _127_715 = (let _127_714 = (let _127_713 = (let _127_712 = (FStar_ToSMT_Term.mk_PreType f)
in (FStar_ToSMT_Term.mk_tester "Typ_fun" _127_712))
in (f_has_t, _127_713))
in (FStar_ToSMT_Term.mkImp _127_714))
in (((f_has_t)::[])::[], (fsym)::[], _127_715))
in (mkForall_fuel _127_716))
in (_127_717, Some ("pre-typing")))
in FStar_ToSMT_Term.Assume (_127_718))
...
let encoding = (let _127_720 = (let _127_719 = (FStar_ToSMT_Term.mk_HasTypeWithFuel (Some (fterm)) xtm base_t)
in (_127_719, refinement))
in (FStar_ToSMT_Term.mkAnd _127_720))
in (
# 624 "FStar.ToSMT.Encode.fst"
let cvars = (let _127_722 = (FStar_ToSMT_Term.free_variables encoding)
in (FStar_All.pipe_right _127_722 (FStar_List.filter (fun _46_913 -> (match (_46_913) with
| (y, _46_912) -> begin
((y <> x) && (y <> fsym))
end)))))
in (
...
(let _127_725 = (let _127_724 = (let _127_723 = (FStar_All.pipe_right cvars (FStar_List.map FStar_ToSMT_Term.mkFreeV))
in (t, _127_723))
in (FStar_ToSMT_Term.mkApp _127_724))
in (_127_725, []))
end
| None -> begin
(
...
let t = (let _127_727 = (let _127_726 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _127_726))
in (FStar_ToSMT_Term.mkApp _127_727))
in (
...
let assumption = (let _127_729 = (let _127_728 = (FStar_ToSMT_Term.mkIff (x_has_t, encoding))
in (((x_has_t)::[])::[], (ffv)::(xfv)::cvars, _127_728))
in (FStar_ToSMT_Term.mkForall _127_729))
in (
# 645 "FStar.ToSMT.Encode.fst"
let t_decls = (let _127_736 = (let _127_735 = (let _127_734 = (let _127_733 = (let _127_732 = (let _127_731 = (let _127_730 = (FStar_Absyn_Print.typ_to_string t0)
in Some (_127_730))
in (assumption, _127_731))
in FStar_ToSMT_Term.Assume (_127_732))
in (_127_733)::[])
in (FStar_ToSMT_Term.Assume ((t_kinding, None)))::_127_734)
in (tdecl)::_127_735)
in (FStar_List.append (FStar_List.append decls decls') _127_736))
in (
...
let ttm = (let _127_737 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Typ_uvar _127_737))
in (
...
let t = (let _127_742 = (let _127_741 = (FStar_List.map (fun _46_10 -> (match (_46_10) with
| (FStar_Util.Inl (t)) | (FStar_Util.Inr (t)) -> begin
t
end)) args)
in (head, _127_741))
in (FStar_ToSMT_Term.mkApp _127_742))
in (t, decls)))
end else begin
(
...
let ttm = (let _127_743 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Typ_uvar _127_743))
in (
...
let key_body = (let _127_747 = (let _127_746 = (let _127_745 = (let _127_744 = (FStar_ToSMT_Term.mk_and_l guards)
in (_127_744, body))
in (FStar_ToSMT_Term.mkImp _127_745))
in ([], vars, _127_746))
in (FStar_ToSMT_Term.mkForall _127_747))
in (
...
(let _127_750 = (let _127_749 = (let _127_748 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (t, _127_748))
in (FStar_ToSMT_Term.mkApp _127_749))
in (_127_750, []))
end
| None -> begin
...
let t = (let _127_752 = (let _127_751 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (tsym, _127_751))
in (FStar_ToSMT_Term.mkApp _127_752))
in (
# 719 "FStar.ToSMT.Encode.fst"
let app = (mk_ApplyT t vars)
in (
# 721 "FStar.ToSMT.Encode.fst"
let interp = (let _127_759 = (let _127_758 = (let _127_757 = (let _127_756 = (let _127_755 = (let _127_754 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _127_753 = (FStar_ToSMT_Term.mkEq (app, body))
in (_127_754, _127_753)))
in (FStar_ToSMT_Term.mkImp _127_755))
in (((app)::[])::[], (FStar_List.append vars cvars), _127_756))
in (FStar_ToSMT_Term.mkForall _127_757))
in (_127_758, Some ("Typ_lam interpretation")))
in FStar_ToSMT_Term.Assume (_127_759))
in (
# 724 "FStar.ToSMT.Encode.fst"
let kinding = (
# 725 "FStar.ToSMT.Encode.fst"
let _46_1026 = (let _127_760 = (FStar_Tc_Recheck.recompute_kind t0)
in (encode_knd _127_760 env t))
in (match (_46_1026) with
| (ktm, decls'') -> begin
(let _127_764 = (let _127_763 = (let _127_762 = (let _127_761 = (FStar_ToSMT_Term.mkForall (((t)::[])::[], cvars, ktm))
in (_127_761, Some ("Typ_lam kinding")))
in FStar_ToSMT_Term.Assume (_127_762))
in (_127_763)::[])
in (FStar_List.append decls'' _127_764))
end))
in (
...
(let _127_765 = (FStar_Absyn_Util.unmeta_typ t0)
in (encode_typ_term _127_765 env))
end
| (FStar_Absyn_Syntax.Typ_delayed (_)) | (FStar_Absyn_Syntax.Typ_unknown) -> begin
(let _127_770 = (let _127_769 = (FStar_All.pipe_left FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _127_768 = (FStar_Absyn_Print.tag_of_typ t0)
in (let _127_767 = (FStar_Absyn_Print.typ_to_string t0)
in (let _127_766 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" _127_769 _127_768 _127_767 _127_766)))))
in (FStar_All.failwith _127_770))
end)))
...
(let _127_773 = (FStar_Absyn_Util.compress_exp e)
in (encode_exp _127_773 env))
end
...
(let _127_774 = (lookup_free_var env v)
in (_127_774, []))
end
| FStar_Absyn_Syntax.Exp_constant (c) -> begin
(let _127_775 = (encode_const c)
in (_127_775, []))
end
...
let e = (let _127_776 = (FStar_Unionfind.uvar_id uv)
in (FStar_ToSMT_Term.mk_Exp_uvar _127_776))
in (e, []))
end
...
in (let _127_779 = (FStar_ToSMT_Term.mkFreeV (f, FStar_ToSMT_Term.Term_sort))
in (_127_779, (decl)::[]))))
end))
...
| Some (tfun) -> begin
if (let _127_780 = (FStar_Absyn_Util.is_pure_or_ghost_function tfun)
in (FStar_All.pipe_left Prims.op_Negation _127_780)) then begin
(fallback ())
end else begin
(
...
let e = (let _127_782 = (let _127_781 = (FStar_Absyn_Syntax.mk_Exp_abs (rest, body) (Some (res_t)) body.FStar_Absyn_Syntax.pos)
in (bs0, _127_781))
in (FStar_Absyn_Syntax.mk_Exp_abs _127_782 (Some (tfun)) e0.FStar_Absyn_Syntax.pos))
in (encode_exp e env)))
end))
end else begin
(
...
let key_body = (let _127_786 = (let _127_785 = (let _127_784 = (let _127_783 = (FStar_ToSMT_Term.mk_and_l guards)
in (_127_783, body))
in (FStar_ToSMT_Term.mkImp _127_784))
in ([], vars, _127_785))
in (FStar_ToSMT_Term.mkForall _127_786))
in (
...
(let _127_789 = (let _127_788 = (let _127_787 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (t, _127_787))
in (FStar_ToSMT_Term.mkApp _127_788))
in (_127_789, []))
end
| None -> begin
(match ((is_eta env vars body)) with
...
let f = (let _127_791 = (let _127_790 = (FStar_List.map FStar_ToSMT_Term.mkFreeV cvars)
in (fsym, _127_790))
in (FStar_ToSMT_Term.mkApp _127_791))
in (
...
let typing_f = (let _127_793 = (let _127_792 = (FStar_ToSMT_Term.mkForall (((f)::[])::[], cvars, f_has_t))
in (_127_792, Some ((Prims.strcat fsym " typing"))))
in FStar_ToSMT_Term.Assume (_127_793))
in (
# 834 "FStar.ToSMT.Encode.fst"
let interp_f = (let _127_800 = (let _127_799 = (let _127_798 = (let _127_797 = (let _127_796 = (let _127_795 = (FStar_ToSMT_Term.mk_IsTyped app)
in (let _127_794 = (FStar_ToSMT_Term.mkEq (app, body))
in (_127_795, _127_794)))
in (FStar_ToSMT_Term.mkImp _127_796))
in (((app)::[])::[], (FStar_List.append vars cvars), _127_797))
in (FStar_ToSMT_Term.mkForall _127_798))
in (_127_799, Some ((Prims.strcat fsym " interpretation"))))
in FStar_ToSMT_Term.Assume (_127_800))
in (
...
| (v2, decls2) -> begin
(let _127_801 = (FStar_ToSMT_Term.mk_LexCons v1 v2)
in (_127_801, (FStar_List.append decls1 decls2)))
end))
end))
end
...
(let _127_802 = (whnf_e env e)
in (encode_exp _127_802 env))
end
...
let ty = (let _127_805 = (FStar_Absyn_Syntax.mk_Typ_fun (rest, c) (Some (FStar_Absyn_Syntax.ktype)) e0.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _127_805 (FStar_Absyn_Util.subst_typ subst)))
in (
...
let e_typing = (let _127_807 = (let _127_806 = (FStar_ToSMT_Term.mkForall (((has_type)::[])::[], cvars, has_type))
in (_127_806, None))
in FStar_ToSMT_Term.Assume (_127_807))
...
let tm = (let _127_813 = (let _127_812 = (let _127_811 = (FStar_List.map (fun _46_11 -> (match (_46_11) with
| (FStar_Util.Inl (t)) | (FStar_Util.Inr (t)) -> begin
t
end)) args)
in (FStar_List.append fuel_args _127_811))
in (fname, _127_812))
in (FStar_ToSMT_Term.mkApp' _127_813))
in (tm, decls))
end)))
in (
...
(let _127_815 = (FStar_Absyn_Print.exp_to_string head)
in (let _127_814 = (FStar_Absyn_Print.exp_to_string e)
...
let head_type = (let _127_818 = (let _127_817 = (let _127_816 = (FStar_Tc_Recheck.recompute_typ head)
in (FStar_Absyn_Util.unrefine _127_816))
in (whnf env _127_817))
in (FStar_All.pipe_left FStar_Absyn_Util.unrefine _127_818))
in (
...
(let _127_821 = (FStar_Absyn_Print.exp_to_string head)
in (let _127_820 = (FStar_Absyn_Print.tag_of_exp head)
in (let _127_819 = (FStar_Absyn_Print.typ_to_string head_type)
in (FStar_Util.print3 "Recomputed type of head %s (%s) to be %s\n" _127_821 _127_820 _127_819))))
end else begin
()
end
in (match ((FStar_Absyn_Util.function_formals head_type)) with
| None -> begin
(let _127_825 = (let _127_824 = (FStar_Range.string_of_range e0.FStar_Absyn_Syntax.pos)
in (let _127_823 = (FStar_Absyn_Print.exp_to_string e0)
in (let _127_822 = (FStar_Absyn_Print.typ_to_string head_type)
in (FStar_Util.format3 "(%s) term is %s; head type is %s\n" _127_824 _127_823 _127_822))))
in (FStar_All.failwith _127_825))
end
| Some (formals, c) -> begin
...
in (let _127_826 = (FStar_ToSMT_Term.mkFreeV (e, FStar_ToSMT_Term.Term_sort))
in (_127_826, (decl_e)::[])))))
end
...
| (w, decls2) -> begin
(let _127_837 = (let _127_836 = (let _127_835 = (let _127_834 = (let _127_833 = (FStar_ToSMT_Term.boxBool FStar_ToSMT_Term.mkTrue)
in (w, _127_833))
in (FStar_ToSMT_Term.mkEq _127_834))
in (guard, _127_835))
in (FStar_ToSMT_Term.mkAnd _127_836))
in (_127_837, decls2))
end))
end)
...
| (br, decls3) -> begin
(let _127_838 = (FStar_ToSMT_Term.mkITE (guard, br, else_case))
in (_127_838, (FStar_List.append (FStar_List.append decls decls2) decls3)))
end))
end)))))
...
(let _127_841 = (let _127_840 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _127_839 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format2 "(%s): Impossible: encode_exp got %s" _127_840 _127_839)))
in (FStar_All.failwith _127_841))
end))))
...
| _46_1357 -> begin
(let _127_844 = (encode_one_pat env pat)
in (_127_844)::[])
end))
...
(let _127_847 = (FStar_Absyn_Print.pat_to_string pat)
...
(let _127_855 = (let _127_854 = (encode_const c)
in (scrutinee, _127_854))
in (FStar_ToSMT_Term.mkEq _127_855))
end
...
in (let _127_858 = (FStar_ToSMT_Term.mkApp (proj, (scrutinee)::[]))
in (mk_guard arg _127_858)))
end))))
...
(let _127_866 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _46_1459 -> (match (_46_1459) with
| (arg, _46_1458) -> begin
(
# 993 "FStar.ToSMT.Encode.fst"
let proj = (primitive_projector_by_pos env.tcenv f.FStar_Absyn_Syntax.v i)
in (let _127_865 = (FStar_ToSMT_Term.mkApp (proj, (scrutinee)::[]))
in (mk_projections arg _127_865)))
end))))
in (FStar_All.pipe_right _127_866 FStar_List.flatten))
end))
in (
...
let rec list_elements = (fun e -> (match ((let _127_881 = (FStar_Absyn_Util.unmeta_exp e)
in _127_881.FStar_Absyn_Syntax.n)) with
...
let v_or_t_pat = (fun p -> (match ((let _127_885 = (FStar_Absyn_Util.unmeta_exp p)
in _127_885.FStar_Absyn_Syntax.n)) with
...
(let _127_890 = (list_elements e)
in (FStar_All.pipe_right _127_890 (FStar_List.map (fun branch -> (let _127_889 = (list_elements branch)
in (FStar_All.pipe_right _127_889 (FStar_List.map v_or_t_pat)))))))
end
| _46_1650 -> begin
(let _127_891 = (FStar_All.pipe_right elts (FStar_List.map v_or_t_pat))
in (_127_891)::[])
end)))
in (
# 1047 "FStar.ToSMT.Encode.fst"
let _46_1693 = (match ((let _127_892 = (FStar_Absyn_Util.compress_typ t)
in _127_892.FStar_Absyn_Syntax.n)) with
...
in (let _127_893 = (lemma_pats pats')
in (binders, pre, post, _127_893)))
end
| _46_1686 -> begin
...
let _46_1720 = (let _127_897 = (FStar_All.pipe_right patterns (FStar_List.map (fun branch -> (
# 1063 "FStar.ToSMT.Encode.fst"
let _46_1717 = (let _127_896 = (FStar_All.pipe_right branch (FStar_List.map (fun _46_12 -> (match (_46_12) with
...
in (FStar_All.pipe_right _127_896 FStar_List.unzip))
in (match (_46_1717) with
| (pats, decls) -> begin
(pats, decls)
end)))))
in (FStar_All.pipe_right _127_897 FStar_List.unzip))
...
| l::[] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _127_900 = (let _127_899 = (FStar_ToSMT_Term.mkFreeV l)
in (FStar_ToSMT_Term.mk_Precedes _127_899 e))
in (_127_900)::p))))
end
| _46_1730 -> begin
(
...
| [] -> begin
(FStar_All.pipe_right pats (FStar_List.map (fun p -> (let _127_906 = (FStar_ToSMT_Term.mk_Precedes tl e)
in (_127_906)::p))))
end
| (x, FStar_ToSMT_Term.Term_sort)::vars -> begin
(let _127_908 = (let _127_907 = (FStar_ToSMT_Term.mkFreeV (x, FStar_ToSMT_Term.Term_sort))
in (FStar_ToSMT_Term.mk_LexCons _127_907 tl))
in (aux _127_908 vars))
end
| _46_1742 -> begin
pats
end))
in (let _127_909 = (FStar_ToSMT_Term.mkFreeV ("Prims.LexTop", FStar_ToSMT_Term.Term_sort))
in (aux _127_909 vars)))
end)
end)
in (
...
let _46_1749 = (let _127_910 = (FStar_Absyn_Util.unmeta_typ pre)
in (encode_formula _127_910 env))
in (match (_46_1749) with
| (pre, decls'') -> begin
(
# 1087 "FStar.ToSMT.Encode.fst"
let _46_1752 = (let _127_911 = (FStar_Absyn_Util.unmeta_typ post)
in (encode_formula _127_911 env))
...
in (let _127_916 = (let _127_915 = (let _127_914 = (let _127_913 = (let _127_912 = (FStar_ToSMT_Term.mk_and_l ((pre)::guards))
in (_127_912, post))
in (FStar_ToSMT_Term.mkImp _127_913))
in (pats, vars, _127_914))
in (FStar_ToSMT_Term.mkForall _127_915))
in (_127_916, decls)))
end))
end)))))
end))
...
let un_op = (fun f l -> (let _127_964 = (FStar_List.hd l)
in (FStar_All.pipe_left f _127_964)))
in (
...
(let _127_978 = (FStar_ToSMT_Term.mkImp (l2, l1))
in (_127_978, (FStar_List.append labs1 labs2), (FStar_List.append decls1 decls2)))
end))
end)
end))
end
...
let unboxInt_l = (fun f l -> (let _127_990 = (FStar_List.map FStar_ToSMT_Term.unboxInt l)
in (f _127_990)))
in (
# 1141 "FStar.ToSMT.Encode.fst"
let connectives = (let _127_1051 = (let _127_999 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkAnd))
in (FStar_Absyn_Const.and_lid, _127_999))
in (let _127_1050 = (let _127_1049 = (let _127_1005 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkOr))
in (FStar_Absyn_Const.or_lid, _127_1005))
in (let _127_1048 = (let _127_1047 = (let _127_1046 = (let _127_1014 = (FStar_All.pipe_left enc_prop_c (bin_op FStar_ToSMT_Term.mkIff))
in (FStar_Absyn_Const.iff_lid, _127_1014))
in (let _127_1045 = (let _127_1044 = (let _127_1043 = (let _127_1023 = (FStar_All.pipe_left enc_prop_c (un_op FStar_ToSMT_Term.mkNot))
in (FStar_Absyn_Const.not_lid, _127_1023))
in (let _127_1042 = (let _127_1041 = (let _127_1029 = (FStar_All.pipe_left enc (bin_op FStar_ToSMT_Term.mkEq))
in (FStar_Absyn_Const.eqT_lid, _127_1029))
in (_127_1041)::((FStar_Absyn_Const.eq2_lid, eq_op))::((FStar_Absyn_Const.true_lid, (const_op FStar_ToSMT_Term.mkTrue)))::((FStar_Absyn_Const.false_lid, (const_op FStar_ToSMT_Term.mkFalse)))::[])
in (_127_1043)::_127_1042))
in ((FStar_Absyn_Const.ite_lid, mk_ite))::_127_1044)
in (_127_1046)::_127_1045))
in ((FStar_Absyn_Const.imp_lid, mk_imp))::_127_1047)
in (_127_1049)::_127_1048))
...
let lvar = (let _127_1054 = (varops.fresh "label")
in (_127_1054, FStar_ToSMT_Term.Bool_sort))
in (
...
| (tt, decls) -> begin
(let _127_1055 = (FStar_ToSMT_Term.mk_Valid tt)
in (_127_1055, [], decls))
end))
end))
in (
...
let _46_2004 = (let _127_1067 = (FStar_All.pipe_right ps (FStar_List.map (fun p -> (
# 1188 "FStar.ToSMT.Encode.fst"
let _46_2001 = (let _127_1066 = (FStar_All.pipe_right p (FStar_List.map (fun _46_17 -> (match (_46_17) with
...
in (FStar_All.pipe_right _127_1066 FStar_List.unzip))
in (match (_46_2001) with
| (p, decls) -> begin
(p, (FStar_List.flatten decls))
end)))))
in (FStar_All.pipe_right _127_1067 FStar_List.unzip))
...
(let _127_1068 = (FStar_ToSMT_Term.mk_and_l guards)
in (vars, pats, _127_1068, body, labs, (FStar_List.append (FStar_List.append decls (FStar_List.flatten decls')) decls'')))
end))
end))
end)))
in (
...
(let _127_1069 = (FStar_Absyn_Print.formula_to_string phi)
...
(let _127_1086 = (FStar_All.pipe_right vars (FStar_Absyn_Print.binders_to_string "; "))
...
(let _127_1089 = (let _127_1088 = (let _127_1087 = (FStar_ToSMT_Term.mkImp (guard, body))
in (pats, vars, _127_1087))
in (FStar_ToSMT_Term.mkForall _127_1088))
in (_127_1089, labs, decls))
end)))
end
...
| (vars, pats, guard, body, labs, decls) -> begin
(let _127_1092 = (let _127_1091 = (let _127_1090 = (FStar_ToSMT_Term.mkAnd (guard, body))
in (pats, vars, _127_1090))
in (FStar_ToSMT_Term.mkExists _127_1091))
in (_127_1092, labs, decls))
end))
end))))))))))))))))
...
let deffun = (fun vars body x -> (let _127_1127 = (let _127_1126 = (let _127_1125 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (let _127_1124 = (FStar_ToSMT_Term.abstr vars body)
in (x, _127_1125, FStar_ToSMT_Term.Term_sort, _127_1124, None)))
in FStar_ToSMT_Term.DefineFun (_127_1126))
in (_127_1127)::[]))
in (
# 1235 "FStar.ToSMT.Encode.fst"
let quant = (fun vars body x -> (
# 1236 "FStar.ToSMT.Encode.fst"
let t1 = (let _127_1139 = (let _127_1138 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (x, _127_1138))
in (FStar_ToSMT_Term.mkApp _127_1139))
in (
# 1237 "FStar.ToSMT.Encode.fst"
let vname_decl = (let _127_1141 = (let _127_1140 = (FStar_All.pipe_right vars (FStar_List.map Prims.snd))
in (x, _127_1140, FStar_ToSMT_Term.Term_sort, None))
in FStar_ToSMT_Term.DeclFun (_127_1141))
in (let _127_1147 = (let _127_1146 = (let _127_1145 = (let _127_1144 = (let _127_1143 = (let _127_1142 = (FStar_ToSMT_Term.mkEq (t1, body))
in (((t1)::[])::[], vars, _127_1142))
in (FStar_ToSMT_Term.mkForall _127_1143))
in (_127_1144, None))
in FStar_ToSMT_Term.Assume (_127_1145))
in (_127_1146)::[])
in (vname_decl)::_127_1147))))
in (
...
let prims = (let _127_1313 = (let _127_1162 = (let _127_1161 = (let _127_1160 = (FStar_ToSMT_Term.mkEq (x, y))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1160))
in (def_or_quant axy _127_1161))
in (FStar_Absyn_Const.op_Eq, _127_1162))
in (let _127_1312 = (let _127_1311 = (let _127_1169 = (let _127_1168 = (let _127_1167 = (let _127_1166 = (FStar_ToSMT_Term.mkEq (x, y))
in (FStar_ToSMT_Term.mkNot _127_1166))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1167))
in (def_or_quant axy _127_1168))
in (FStar_Absyn_Const.op_notEq, _127_1169))
in (let _127_1310 = (let _127_1309 = (let _127_1178 = (let _127_1177 = (let _127_1176 = (let _127_1175 = (let _127_1174 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1173 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1174, _127_1173)))
in (FStar_ToSMT_Term.mkLT _127_1175))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1176))
in (def_or_quant xy _127_1177))
in (FStar_Absyn_Const.op_LT, _127_1178))
in (let _127_1308 = (let _127_1307 = (let _127_1187 = (let _127_1186 = (let _127_1185 = (let _127_1184 = (let _127_1183 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1182 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1183, _127_1182)))
in (FStar_ToSMT_Term.mkLTE _127_1184))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1185))
in (def_or_quant xy _127_1186))
in (FStar_Absyn_Const.op_LTE, _127_1187))
in (let _127_1306 = (let _127_1305 = (let _127_1196 = (let _127_1195 = (let _127_1194 = (let _127_1193 = (let _127_1192 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1191 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1192, _127_1191)))
in (FStar_ToSMT_Term.mkGT _127_1193))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1194))
in (def_or_quant xy _127_1195))
in (FStar_Absyn_Const.op_GT, _127_1196))
in (let _127_1304 = (let _127_1303 = (let _127_1205 = (let _127_1204 = (let _127_1203 = (let _127_1202 = (let _127_1201 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1200 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1201, _127_1200)))
in (FStar_ToSMT_Term.mkGTE _127_1202))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1203))
in (def_or_quant xy _127_1204))
in (FStar_Absyn_Const.op_GTE, _127_1205))
in (let _127_1302 = (let _127_1301 = (let _127_1214 = (let _127_1213 = (let _127_1212 = (let _127_1211 = (let _127_1210 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1209 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1210, _127_1209)))
in (FStar_ToSMT_Term.mkSub _127_1211))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1212))
in (def_or_quant xy _127_1213))
in (FStar_Absyn_Const.op_Subtraction, _127_1214))
in (let _127_1300 = (let _127_1299 = (let _127_1221 = (let _127_1220 = (let _127_1219 = (let _127_1218 = (FStar_ToSMT_Term.unboxInt x)
in (FStar_ToSMT_Term.mkMinus _127_1218))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1219))
in (def_or_quant qx _127_1220))
in (FStar_Absyn_Const.op_Minus, _127_1221))
in (let _127_1298 = (let _127_1297 = (let _127_1230 = (let _127_1229 = (let _127_1228 = (let _127_1227 = (let _127_1226 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1225 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1226, _127_1225)))
in (FStar_ToSMT_Term.mkAdd _127_1227))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1228))
in (def_or_quant xy _127_1229))
in (FStar_Absyn_Const.op_Addition, _127_1230))
in (let _127_1296 = (let _127_1295 = (let _127_1239 = (let _127_1238 = (let _127_1237 = (let _127_1236 = (let _127_1235 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1234 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1235, _127_1234)))
in (FStar_ToSMT_Term.mkMul _127_1236))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1237))
in (def_or_quant xy _127_1238))
in (FStar_Absyn_Const.op_Multiply, _127_1239))
in (let _127_1294 = (let _127_1293 = (let _127_1248 = (let _127_1247 = (let _127_1246 = (let _127_1245 = (let _127_1244 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1243 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1244, _127_1243)))
in (FStar_ToSMT_Term.mkDiv _127_1245))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1246))
in (def_or_quant xy _127_1247))
in (FStar_Absyn_Const.op_Division, _127_1248))
in (let _127_1292 = (let _127_1291 = (let _127_1257 = (let _127_1256 = (let _127_1255 = (let _127_1254 = (let _127_1253 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1252 = (FStar_ToSMT_Term.unboxInt y)
in (_127_1253, _127_1252)))
in (FStar_ToSMT_Term.mkMod _127_1254))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxInt _127_1255))
in (def_or_quant xy _127_1256))
in (FStar_Absyn_Const.op_Modulus, _127_1257))
in (let _127_1290 = (let _127_1289 = (let _127_1266 = (let _127_1265 = (let _127_1264 = (let _127_1263 = (let _127_1262 = (FStar_ToSMT_Term.unboxBool x)
in (let _127_1261 = (FStar_ToSMT_Term.unboxBool y)
in (_127_1262, _127_1261)))
in (FStar_ToSMT_Term.mkAnd _127_1263))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1264))
in (def_or_quant xy _127_1265))
in (FStar_Absyn_Const.op_And, _127_1266))
in (let _127_1288 = (let _127_1287 = (let _127_1275 = (let _127_1274 = (let _127_1273 = (let _127_1272 = (let _127_1271 = (FStar_ToSMT_Term.unboxBool x)
in (let _127_1270 = (FStar_ToSMT_Term.unboxBool y)
in (_127_1271, _127_1270)))
in (FStar_ToSMT_Term.mkOr _127_1272))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1273))
in (def_or_quant xy _127_1274))
in (FStar_Absyn_Const.op_Or, _127_1275))
in (let _127_1286 = (let _127_1285 = (let _127_1282 = (let _127_1281 = (let _127_1280 = (let _127_1279 = (FStar_ToSMT_Term.unboxBool x)
in (FStar_ToSMT_Term.mkNot _127_1279))
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_1280))
in (def_or_quant qx _127_1281))
in (FStar_Absyn_Const.op_Negation, _127_1282))
in (_127_1285)::[])
in (_127_1287)::_127_1286))
in (_127_1289)::_127_1288))
in (_127_1291)::_127_1290))
in (_127_1293)::_127_1292))
in (_127_1295)::_127_1294))
in (_127_1297)::_127_1296))
in (_127_1299)::_127_1298))
in (_127_1301)::_127_1300))
in (_127_1303)::_127_1302))
in (_127_1305)::_127_1304))
in (_127_1307)::_127_1306))
in (_127_1309)::_127_1308))
in (_127_1311)::_127_1310))
in (_127_1313)::_127_1312))
in (
# 1264 "FStar.ToSMT.Encode.fst"
let mk = (fun l v -> (let _127_1345 = (FStar_All.pipe_right prims (FStar_List.filter (fun _46_2091 -> (match (_46_2091) with
| (l', _46_2090) -> begin
(FStar_Ident.lid_equals l l')
end))))
in (FStar_All.pipe_right _127_1345 (FStar_List.collect (fun _46_2095 -> (match (_46_2095) with
| (_46_2093, b) -> begin
(b v)
end))))))
in (
...
in (let _127_1377 = (let _127_1368 = (let _127_1367 = (FStar_ToSMT_Term.mk_HasType FStar_ToSMT_Term.mk_Term_unit tt)
in (_127_1367, Some ("unit typing")))
in FStar_ToSMT_Term.Assume (_127_1368))
in (let _127_1376 = (let _127_1375 = (let _127_1374 = (let _127_1373 = (let _127_1372 = (let _127_1371 = (let _127_1370 = (let _127_1369 = (FStar_ToSMT_Term.mkEq (x, FStar_ToSMT_Term.mk_Term_unit))
in (typing_pred, _127_1369))
in (FStar_ToSMT_Term.mkImp _127_1370))
in (((typing_pred)::[])::[], (xx)::[], _127_1371))
in (mkForall_fuel _127_1372))
in (_127_1373, Some ("unit inversion")))
in FStar_ToSMT_Term.Assume (_127_1374))
in (_127_1375)::[])
in (_127_1377)::_127_1376))))
in (
...
in (let _127_1398 = (let _127_1387 = (let _127_1386 = (let _127_1385 = (let _127_1384 = (let _127_1383 = (let _127_1382 = (FStar_ToSMT_Term.mk_tester "BoxBool" x)
in (typing_pred, _127_1382))
in (FStar_ToSMT_Term.mkImp _127_1383))
in (((typing_pred)::[])::[], (xx)::[], _127_1384))
in (mkForall_fuel _127_1385))
in (_127_1386, Some ("bool inversion")))
in FStar_ToSMT_Term.Assume (_127_1387))
in (let _127_1397 = (let _127_1396 = (let _127_1395 = (let _127_1394 = (let _127_1393 = (let _127_1392 = (let _127_1389 = (let _127_1388 = (FStar_ToSMT_Term.boxBool b)
in (_127_1388)::[])
in (_127_1389)::[])
in (let _127_1391 = (let _127_1390 = (FStar_ToSMT_Term.boxBool b)
in (FStar_ToSMT_Term.mk_HasType _127_1390 tt))
in (_127_1392, (bb)::[], _127_1391)))
in (FStar_ToSMT_Term.mkForall _127_1393))
in (_127_1394, Some ("bool typing")))
in FStar_ToSMT_Term.Assume (_127_1395))
in (_127_1396)::[])
in (_127_1398)::_127_1397))))))
in (
...
let precedes = (let _127_1410 = (let _127_1409 = (let _127_1408 = (let _127_1407 = (let _127_1406 = (let _127_1405 = (FStar_ToSMT_Term.boxInt a)
in (let _127_1404 = (let _127_1403 = (FStar_ToSMT_Term.boxInt b)
in (_127_1403)::[])
in (_127_1405)::_127_1404))
in (tt)::_127_1406)
in (tt)::_127_1407)
in ("Prims.Precedes", _127_1408))
in (FStar_ToSMT_Term.mkApp _127_1409))
in (FStar_All.pipe_left FStar_ToSMT_Term.mk_Valid _127_1410))
in (
# 1296 "FStar.ToSMT.Encode.fst"
let precedes_y_x = (let _127_1411 = (FStar_ToSMT_Term.mkApp ("Precedes", (y)::(x)::[]))
in (FStar_All.pipe_left FStar_ToSMT_Term.mk_Valid _127_1411))
in (let _127_1453 = (let _127_1417 = (let _127_1416 = (let _127_1415 = (let _127_1414 = (let _127_1413 = (let _127_1412 = (FStar_ToSMT_Term.mk_tester "BoxInt" x)
in (typing_pred, _127_1412))
in (FStar_ToSMT_Term.mkImp _127_1413))
in (((typing_pred)::[])::[], (xx)::[], _127_1414))
in (mkForall_fuel _127_1415))
in (_127_1416, Some ("int inversion")))
in FStar_ToSMT_Term.Assume (_127_1417))
in (let _127_1452 = (let _127_1451 = (let _127_1425 = (let _127_1424 = (let _127_1423 = (let _127_1422 = (let _127_1419 = (let _127_1418 = (FStar_ToSMT_Term.boxInt b)
in (_127_1418)::[])
in (_127_1419)::[])
in (let _127_1421 = (let _127_1420 = (FStar_ToSMT_Term.boxInt b)
in (FStar_ToSMT_Term.mk_HasType _127_1420 tt))
in (_127_1422, (bb)::[], _127_1421)))
in (FStar_ToSMT_Term.mkForall _127_1423))
in (_127_1424, Some ("int typing")))
in FStar_ToSMT_Term.Assume (_127_1425))
in (let _127_1450 = (let _127_1449 = (let _127_1448 = (let _127_1447 = (let _127_1446 = (let _127_1445 = (let _127_1444 = (let _127_1443 = (let _127_1442 = (let _127_1441 = (let _127_1440 = (let _127_1439 = (let _127_1428 = (let _127_1427 = (FStar_ToSMT_Term.unboxInt x)
in (let _127_1426 = (FStar_ToSMT_Term.mkInteger' 0)
in (_127_1427, _127_1426)))
in (FStar_ToSMT_Term.mkGT _127_1428))
in (let _127_1438 = (let _127_1437 = (let _127_1431 = (let _127_1430 = (FStar_ToSMT_Term.unboxInt y)
in (let _127_1429 = (FStar_ToSMT_Term.mkInteger' 0)
in (_127_1430, _127_1429)))
in (FStar_ToSMT_Term.mkGTE _127_1431))
in (let _127_1436 = (let _127_1435 = (let _127_1434 = (let _127_1433 = (FStar_ToSMT_Term.unboxInt y)
in (let _127_1432 = (FStar_ToSMT_Term.unboxInt x)
in (_127_1433, _127_1432)))
in (FStar_ToSMT_Term.mkLT _127_1434))
in (_127_1435)::[])
in (_127_1437)::_127_1436))
in (_127_1439)::_127_1438))
in (typing_pred_y)::_127_1440)
in (typing_pred)::_127_1441)
in (FStar_ToSMT_Term.mk_and_l _127_1442))
in (_127_1443, precedes_y_x))
in (FStar_ToSMT_Term.mkImp _127_1444))
in (((typing_pred)::(typing_pred_y)::(precedes_y_x)::[])::[], (xx)::(yy)::[], _127_1445))
in (mkForall_fuel _127_1446))
in (_127_1447, Some ("well-founded ordering on nat (alt)")))
in FStar_ToSMT_Term.Assume (_127_1448))
in (_127_1449)::[])
in (_127_1451)::_127_1450))
in (_127_1453)::_127_1452)))))))))))
in (
# 1308 "FStar.ToSMT.Encode.fst"
let mk_int_alias = (fun _46_2131 tt -> (let _127_1462 = (let _127_1461 = (let _127_1460 = (let _127_1459 = (let _127_1458 = (FStar_ToSMT_Term.mkApp (FStar_Absyn_Const.int_lid.FStar_Ident.str, []))
in (tt, _127_1458))
in (FStar_ToSMT_Term.mkEq _127_1459))
in (_127_1460, Some ("mapping to int; for now")))
in FStar_ToSMT_Term.Assume (_127_1461))
in (_127_1462)::[]))
in (
...
let b = (FStar_ToSMT_Term.mkFreeV bb)
in (let _127_1483 = (let _127_1472 = (let _127_1471 = (let _127_1470 = (let _127_1469 = (let _127_1468 = (let _127_1467 = (FStar_ToSMT_Term.mk_tester "BoxString" x)
in (typing_pred, _127_1467))
in (FStar_ToSMT_Term.mkImp _127_1468))
in (((typing_pred)::[])::[], (xx)::[], _127_1469))
in (mkForall_fuel _127_1470))
in (_127_1471, Some ("string inversion")))
in FStar_ToSMT_Term.Assume (_127_1472))
in (let _127_1482 = (let _127_1481 = (let _127_1480 = (let _127_1479 = (let _127_1478 = (let _127_1477 = (let _127_1474 = (let _127_1473 = (FStar_ToSMT_Term.boxString b)
in (_127_1473)::[])
in (_127_1474)::[])
in (let _127_1476 = (let _127_1475 = (FStar_ToSMT_Term.boxString b)
in (FStar_ToSMT_Term.mk_HasType _127_1475 tt))
in (_127_1477, (bb)::[], _127_1476)))
in (FStar_ToSMT_Term.mkForall _127_1478))
in (_127_1479, Some ("string typing")))
in FStar_ToSMT_Term.Assume (_127_1480))
in (_127_1481)::[])
in (_127_1483)::_127_1482))))))
in (
...
let refa = (let _127_1490 = (let _127_1489 = (let _127_1488 = (FStar_ToSMT_Term.mkFreeV aa)
in (_127_1488)::[])
in (reft_name, _127_1489))
in (FStar_ToSMT_Term.mkApp _127_1490))
in (
# 1321 "FStar.ToSMT.Encode.fst"
let refb = (let _127_1493 = (let _127_1492 = (let _127_1491 = (FStar_ToSMT_Term.mkFreeV bb)
in (_127_1491)::[])
in (reft_name, _127_1492))
in (FStar_ToSMT_Term.mkApp _127_1493))
in (
...
in (let _127_1512 = (let _127_1499 = (let _127_1498 = (let _127_1497 = (let _127_1496 = (let _127_1495 = (let _127_1494 = (FStar_ToSMT_Term.mk_tester "BoxRef" x)
in (typing_pred, _127_1494))
in (FStar_ToSMT_Term.mkImp _127_1495))
in (((typing_pred)::[])::[], (xx)::(aa)::[], _127_1496))
in (mkForall_fuel _127_1497))
in (_127_1498, Some ("ref inversion")))
in FStar_ToSMT_Term.Assume (_127_1499))
in (let _127_1511 = (let _127_1510 = (let _127_1509 = (let _127_1508 = (let _127_1507 = (let _127_1506 = (let _127_1505 = (let _127_1504 = (FStar_ToSMT_Term.mkAnd (typing_pred, typing_pred_b))
in (let _127_1503 = (let _127_1502 = (let _127_1501 = (FStar_ToSMT_Term.mkFreeV aa)
in (let _127_1500 = (FStar_ToSMT_Term.mkFreeV bb)
in (_127_1501, _127_1500)))
in (FStar_ToSMT_Term.mkEq _127_1502))
in (_127_1504, _127_1503)))
in (FStar_ToSMT_Term.mkImp _127_1505))
in (((typing_pred)::(typing_pred_b)::[])::[], (xx)::(aa)::(bb)::[], _127_1506))
in (mkForall_fuel' 2 _127_1507))
in (_127_1508, Some ("ref typing is injective")))
in FStar_ToSMT_Term.Assume (_127_1509))
in (_127_1510)::[])
in (_127_1512)::_127_1511))))))))))
in (
...
in (let _127_1519 = (let _127_1518 = (let _127_1517 = (FStar_ToSMT_Term.mkIff (FStar_ToSMT_Term.mkFalse, valid))
in (_127_1517, Some ("False interpretation")))
in FStar_ToSMT_Term.Assume (_127_1518))
in (_127_1519)::[])))
in (
...
let valid = (let _127_1526 = (let _127_1525 = (let _127_1524 = (FStar_ToSMT_Term.mkApp (conj, (a)::(b)::[]))
in (_127_1524)::[])
in ("Valid", _127_1525))
in (FStar_ToSMT_Term.mkApp _127_1526))
in (
...
in (let _127_1533 = (let _127_1532 = (let _127_1531 = (let _127_1530 = (let _127_1529 = (let _127_1528 = (let _127_1527 = (FStar_ToSMT_Term.mkAnd (valid_a, valid_b))
in (_127_1527, valid))
in (FStar_ToSMT_Term.mkIff _127_1528))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1529))
in (FStar_ToSMT_Term.mkForall _127_1530))
in (_127_1531, Some ("/\\ interpretation")))
in FStar_ToSMT_Term.Assume (_127_1532))
in (_127_1533)::[])))))))))
in (
...
let valid = (let _127_1540 = (let _127_1539 = (let _127_1538 = (FStar_ToSMT_Term.mkApp (disj, (a)::(b)::[]))
in (_127_1538)::[])
in ("Valid", _127_1539))
in (FStar_ToSMT_Term.mkApp _127_1540))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _127_1547 = (let _127_1546 = (let _127_1545 = (let _127_1544 = (let _127_1543 = (let _127_1542 = (let _127_1541 = (FStar_ToSMT_Term.mkOr (valid_a, valid_b))
in (_127_1541, valid))
in (FStar_ToSMT_Term.mkIff _127_1542))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1543))
in (FStar_ToSMT_Term.mkForall _127_1544))
in (_127_1545, Some ("\\/ interpretation")))
in FStar_ToSMT_Term.Assume (_127_1546))
in (_127_1547)::[])))))))))
in (
...
let valid = (let _127_1554 = (let _127_1553 = (let _127_1552 = (FStar_ToSMT_Term.mkApp (eq2, (a)::(b)::(x)::(y)::[]))
in (_127_1552)::[])
in ("Valid", _127_1553))
in (FStar_ToSMT_Term.mkApp _127_1554))
in (let _127_1561 = (let _127_1560 = (let _127_1559 = (let _127_1558 = (let _127_1557 = (let _127_1556 = (let _127_1555 = (FStar_ToSMT_Term.mkEq (x, y))
in (_127_1555, valid))
in (FStar_ToSMT_Term.mkIff _127_1556))
in (((valid)::[])::[], (aa)::(bb)::(xx)::(yy)::[], _127_1557))
in (FStar_ToSMT_Term.mkForall _127_1558))
in (_127_1559, Some ("Eq2 interpretation")))
in FStar_ToSMT_Term.Assume (_127_1560))
in (_127_1561)::[])))))))))))
in (
...
let valid = (let _127_1568 = (let _127_1567 = (let _127_1566 = (FStar_ToSMT_Term.mkApp (imp, (a)::(b)::[]))
in (_127_1566)::[])
in ("Valid", _127_1567))
in (FStar_ToSMT_Term.mkApp _127_1568))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _127_1575 = (let _127_1574 = (let _127_1573 = (let _127_1572 = (let _127_1571 = (let _127_1570 = (let _127_1569 = (FStar_ToSMT_Term.mkImp (valid_a, valid_b))
in (_127_1569, valid))
in (FStar_ToSMT_Term.mkIff _127_1570))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1571))
in (FStar_ToSMT_Term.mkForall _127_1572))
in (_127_1573, Some ("==> interpretation")))
in FStar_ToSMT_Term.Assume (_127_1574))
in (_127_1575)::[])))))))))
in (
...
let valid = (let _127_1582 = (let _127_1581 = (let _127_1580 = (FStar_ToSMT_Term.mkApp (iff, (a)::(b)::[]))
in (_127_1580)::[])
in ("Valid", _127_1581))
in (FStar_ToSMT_Term.mkApp _127_1582))
in (
...
let valid_b = (FStar_ToSMT_Term.mkApp ("Valid", (b)::[]))
in (let _127_1589 = (let _127_1588 = (let _127_1587 = (let _127_1586 = (let _127_1585 = (let _127_1584 = (let _127_1583 = (FStar_ToSMT_Term.mkIff (valid_a, valid_b))
in (_127_1583, valid))
in (FStar_ToSMT_Term.mkIff _127_1584))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1585))
in (FStar_ToSMT_Term.mkForall _127_1586))
in (_127_1587, Some ("<==> interpretation")))
in FStar_ToSMT_Term.Assume (_127_1588))
in (_127_1589)::[])))))))))
in (
...
let valid = (let _127_1596 = (let _127_1595 = (let _127_1594 = (FStar_ToSMT_Term.mkApp (for_all, (a)::(b)::[]))
in (_127_1594)::[])
in ("Valid", _127_1595))
in (FStar_ToSMT_Term.mkApp _127_1596))
in (
# 1385 "FStar.ToSMT.Encode.fst"
let valid_b_x = (let _127_1599 = (let _127_1598 = (let _127_1597 = (FStar_ToSMT_Term.mk_ApplyTE b x)
in (_127_1597)::[])
in ("Valid", _127_1598))
in (FStar_ToSMT_Term.mkApp _127_1599))
in (let _127_1613 = (let _127_1612 = (let _127_1611 = (let _127_1610 = (let _127_1609 = (let _127_1608 = (let _127_1607 = (let _127_1606 = (let _127_1605 = (let _127_1601 = (let _127_1600 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_127_1600)::[])
in (_127_1601)::[])
in (let _127_1604 = (let _127_1603 = (let _127_1602 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_127_1602, valid_b_x))
in (FStar_ToSMT_Term.mkImp _127_1603))
in (_127_1605, (xx)::[], _127_1604)))
in (FStar_ToSMT_Term.mkForall _127_1606))
in (_127_1607, valid))
in (FStar_ToSMT_Term.mkIff _127_1608))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1609))
in (FStar_ToSMT_Term.mkForall _127_1610))
in (_127_1611, Some ("forall interpretation")))
in FStar_ToSMT_Term.Assume (_127_1612))
in (_127_1613)::[]))))))))))
in (
...
let valid = (let _127_1620 = (let _127_1619 = (let _127_1618 = (FStar_ToSMT_Term.mkApp (for_all, (a)::(b)::[]))
in (_127_1618)::[])
in ("Valid", _127_1619))
in (FStar_ToSMT_Term.mkApp _127_1620))
in (
# 1395 "FStar.ToSMT.Encode.fst"
let valid_b_x = (let _127_1623 = (let _127_1622 = (let _127_1621 = (FStar_ToSMT_Term.mk_ApplyTE b x)
in (_127_1621)::[])
in ("Valid", _127_1622))
in (FStar_ToSMT_Term.mkApp _127_1623))
in (let _127_1637 = (let _127_1636 = (let _127_1635 = (let _127_1634 = (let _127_1633 = (let _127_1632 = (let _127_1631 = (let _127_1630 = (let _127_1629 = (let _127_1625 = (let _127_1624 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_127_1624)::[])
in (_127_1625)::[])
in (let _127_1628 = (let _127_1627 = (let _127_1626 = (FStar_ToSMT_Term.mk_HasTypeZ x a)
in (_127_1626, valid_b_x))
in (FStar_ToSMT_Term.mkImp _127_1627))
in (_127_1629, (xx)::[], _127_1628)))
in (FStar_ToSMT_Term.mkExists _127_1630))
in (_127_1631, valid))
in (FStar_ToSMT_Term.mkIff _127_1632))
in (((valid)::[])::[], (aa)::(bb)::[], _127_1633))
in (FStar_ToSMT_Term.mkForall _127_1634))
in (_127_1635, Some ("exists interpretation")))
in FStar_ToSMT_Term.Assume (_127_1636))
in (_127_1637)::[]))))))))))
in (
...
let valid = (let _127_1644 = (let _127_1643 = (let _127_1642 = (FStar_ToSMT_Term.mkApp (for_all, (k)::(a)::[]))
in (_127_1642)::[])
in ("Valid", _127_1643))
in (FStar_ToSMT_Term.mkApp _127_1644))
in (
# 1405 "FStar.ToSMT.Encode.fst"
let valid_a_b = (let _127_1647 = (let _127_1646 = (let _127_1645 = (FStar_ToSMT_Term.mk_ApplyTE a b)
in (_127_1645)::[])
in ("Valid", _127_1646))
in (FStar_ToSMT_Term.mkApp _127_1647))
in (let _127_1661 = (let _127_1660 = (let _127_1659 = (let _127_1658 = (let _127_1657 = (let _127_1656 = (let _127_1655 = (let _127_1654 = (let _127_1653 = (let _127_1649 = (let _127_1648 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_127_1648)::[])
in (_127_1649)::[])
in (let _127_1652 = (let _127_1651 = (let _127_1650 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_127_1650, valid_a_b))
in (FStar_ToSMT_Term.mkImp _127_1651))
in (_127_1653, (bb)::[], _127_1652)))
in (FStar_ToSMT_Term.mkForall _127_1654))
in (_127_1655, valid))
in (FStar_ToSMT_Term.mkIff _127_1656))
in (((valid)::[])::[], (kk)::(aa)::[], _127_1657))
in (FStar_ToSMT_Term.mkForall _127_1658))
in (_127_1659, Some ("ForallTyp interpretation")))
in FStar_ToSMT_Term.Assume (_127_1660))
in (_127_1661)::[]))))))))))
in (
...
let valid = (let _127_1668 = (let _127_1667 = (let _127_1666 = (FStar_ToSMT_Term.mkApp (for_some, (k)::(a)::[]))
in (_127_1666)::[])
in ("Valid", _127_1667))
in (FStar_ToSMT_Term.mkApp _127_1668))
in (
# 1415 "FStar.ToSMT.Encode.fst"
let valid_a_b = (let _127_1671 = (let _127_1670 = (let _127_1669 = (FStar_ToSMT_Term.mk_ApplyTE a b)
in (_127_1669)::[])
in ("Valid", _127_1670))
in (FStar_ToSMT_Term.mkApp _127_1671))
in (let _127_1685 = (let _127_1684 = (let _127_1683 = (let _127_1682 = (let _127_1681 = (let _127_1680 = (let _127_1679 = (let _127_1678 = (let _127_1677 = (let _127_1673 = (let _127_1672 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_127_1672)::[])
in (_127_1673)::[])
in (let _127_1676 = (let _127_1675 = (let _127_1674 = (FStar_ToSMT_Term.mk_HasKind b k)
in (_127_1674, valid_a_b))
in (FStar_ToSMT_Term.mkImp _127_1675))
in (_127_1677, (bb)::[], _127_1676)))
in (FStar_ToSMT_Term.mkExists _127_1678))
in (_127_1679, valid))
in (FStar_ToSMT_Term.mkIff _127_1680))
in (((valid)::[])::[], (kk)::(aa)::[], _127_1681))
in (FStar_ToSMT_Term.mkForall _127_1682))
in (_127_1683, Some ("ExistsTyp interpretation")))
in FStar_ToSMT_Term.Assume (_127_1684))
in (_127_1685)::[]))))))))))
in (
...
(let _127_1828 = (FStar_Absyn_Print.sigelt_to_string se)
...
(match (g) with
| [] -> begin
(let _127_1831 = (let _127_1830 = (let _127_1829 = (FStar_Util.format1 "<Skipped %s/>" nm)
in FStar_ToSMT_Term.Caption (_127_1829))
in (_127_1830)::[])
in (_127_1831, e))
end
| _46_2283 -> begin
(let _127_1838 = (let _127_1837 = (let _127_1833 = (let _127_1832 = (FStar_Util.format1 "<Start encoding %s>" nm)
in FStar_ToSMT_Term.Caption (_127_1832))
in (_127_1833)::g)
in (let _127_1836 = (let _127_1835 = (let _127_1834 = (FStar_Util.format1 "</end encoding %s>" nm)
in FStar_ToSMT_Term.Caption (_127_1834))
in (_127_1835)::[])
in (FStar_List.append _127_1837 _127_1836)))
in (_127_1838, e))
end)
end)))))
...
(let _127_1852 = (let _127_1851 = (encode_smt_lemma env lid t)
in (FStar_List.append decls _127_1851))
in (_127_1852, env))
end else begin
(decls, env)
end
...
let _46_2307 = (let _127_1861 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (encode_top_level_val env _127_1861 lb.FStar_Absyn_Syntax.lbtyp quals))
...
let valid_b2t_x = (let _127_1864 = (let _127_1863 = (let _127_1862 = (FStar_ToSMT_Term.mkApp ("Prims.b2t", (x)::[]))
in (_127_1862)::[])
in ("Valid", _127_1863))
in (FStar_ToSMT_Term.mkApp _127_1864))
in (
# 1484 "FStar.ToSMT.Encode.fst"
let decls = (let _127_1872 = (let _127_1871 = (let _127_1870 = (let _127_1869 = (let _127_1868 = (let _127_1867 = (let _127_1866 = (let _127_1865 = (FStar_ToSMT_Term.mkApp ("BoxBool_proj_0", (x)::[]))
in (valid_b2t_x, _127_1865))
in (FStar_ToSMT_Term.mkEq _127_1866))
in (((valid_b2t_x)::[])::[], (xx)::[], _127_1867))
in (FStar_ToSMT_Term.mkForall _127_1868))
in (_127_1869, Some ("b2t def")))
in FStar_ToSMT_Term.Assume (_127_1870))
in (_127_1871)::[])
in (FStar_ToSMT_Term.DeclFun ((tname, (FStar_ToSMT_Term.Term_sort)::[], FStar_ToSMT_Term.Type_sort, None)))::_127_1872)
in (decls, env)))))
end))
end
...
let tok_app = (let _127_1873 = (FStar_ToSMT_Term.mkApp (ttok, []))
in (mk_ApplyT _127_1873 vars))
in (
...
let app = (let _127_1875 = (let _127_1874 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _127_1874))
in (FStar_ToSMT_Term.mkApp _127_1875))
in (
...
| _46_2391 -> begin
(let _127_1877 = (let _127_1876 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _127_1876))
in (_127_1877)::[])
end)
in (
# 1502 "FStar.ToSMT.Encode.fst"
let decls = (let _127_1888 = (let _127_1881 = (let _127_1880 = (let _127_1879 = (let _127_1878 = (FStar_List.map Prims.snd vars)
in (tname, _127_1878, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_127_1879))
in (_127_1880)::(tok_decl)::[])
in (FStar_List.append _127_1881 fresh_tok))
in (let _127_1887 = (let _127_1886 = (let _127_1885 = (let _127_1884 = (let _127_1883 = (let _127_1882 = (FStar_ToSMT_Term.mkEq (tok_app, app))
in (((tok_app)::[])::[], vars, _127_1882))
in (FStar_ToSMT_Term.mkForall _127_1883))
in (_127_1884, Some ("name-token correspondence")))
in FStar_ToSMT_Term.Assume (_127_1885))
in (_127_1886)::[])
in (FStar_List.append _127_1888 _127_1887)))
in (
...
(let _127_1891 = (FStar_ToSMT_Term.mk_Valid app)
in (let _127_1890 = (encode_formula t env')
in (_127_1891, _127_1890)))
end else begin
(let _127_1892 = (encode_typ_term t env')
in (app, _127_1892))
end
...
let abbrev_def = (let _127_1899 = (let _127_1898 = (let _127_1897 = (let _127_1896 = (let _127_1895 = (let _127_1894 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _127_1893 = (FStar_ToSMT_Term.mkEq (def, body))
in (_127_1894, _127_1893)))
in (FStar_ToSMT_Term.mkImp _127_1895))
in (((def)::[])::[], vars, _127_1896))
in (FStar_ToSMT_Term.mkForall _127_1897))
in (_127_1898, Some ("abbrev. elimination")))
in FStar_ToSMT_Term.Assume (_127_1899))
in (
# 1514 "FStar.ToSMT.Encode.fst"
let kindingAx = (
# 1515 "FStar.ToSMT.Encode.fst"
let _46_2407 = (let _127_1900 = (FStar_Tc_Recheck.recompute_kind t)
in (encode_knd _127_1900 env' app))
in (match (_46_2407) with
| (k, decls) -> begin
(let _127_1908 = (let _127_1907 = (let _127_1906 = (let _127_1905 = (let _127_1904 = (let _127_1903 = (let _127_1902 = (let _127_1901 = (FStar_ToSMT_Term.mk_and_l guards)
in (_127_1901, k))
in (FStar_ToSMT_Term.mkImp _127_1902))
in (((app)::[])::[], vars, _127_1903))
in (FStar_ToSMT_Term.mkForall _127_1904))
in (_127_1905, Some ("abbrev. kinding")))
in FStar_ToSMT_Term.Assume (_127_1906))
in (_127_1907)::[])
in (FStar_List.append decls _127_1908))
end))
in (
# 1517 "FStar.ToSMT.Encode.fst"
let g = (let _127_1909 = (primitive_type_axioms lid tname app)
in (FStar_List.append (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls) decls1) ((abbrev_def)::kindingAx)) _127_1909))
in (g, env))))
end))))))))
end))
end))
...
let g = (let _127_1914 = (let _127_1913 = (let _127_1912 = (let _127_1911 = (let _127_1910 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format1 "Assumption: %s" _127_1910))
in Some (_127_1911))
in (f, _127_1912))
in FStar_ToSMT_Term.Assume (_127_1913))
in (_127_1914)::[])
...
in (let _127_1916 = (let _127_1915 = (primitive_type_axioms t tname tsym)
in (decl)::_127_1915)
in (_127_1916, (push_free_tvar env t tname (Some (tsym))))))))
end
...
(let _127_1922 = (let _127_1921 = (let _127_1920 = (FStar_All.pipe_right args (FStar_List.map Prims.snd))
in (name, _127_1920, FStar_ToSMT_Term.Type_sort, None))
in FStar_ToSMT_Term.DeclFun (_127_1921))
in (_127_1922)::[])
end))
end else begin
...
let inversion_axioms = (fun tapp vars -> if (((FStar_List.length datas) = 0) || (FStar_All.pipe_right datas (FStar_Util.for_some (fun l -> (let _127_1928 = (FStar_Tc_Env.lookup_qname env.tcenv l)
in (FStar_All.pipe_right _127_1928 FStar_Option.isNone)))))) then begin
[]
end else begin
(
...
let indices = (match ((let _127_1931 = (FStar_Absyn_Util.compress_typ res)
in _127_1931.FStar_Absyn_Syntax.n)) with
...
| FStar_Util.Inl (a) -> begin
(let _127_1936 = (let _127_1935 = (let _127_1934 = (mk_typ_projector_name l a.FStar_Absyn_Syntax.v)
in (_127_1934, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _127_1935))
in (push_typ_var env a.FStar_Absyn_Syntax.v _127_1936))
end
| FStar_Util.Inr (x) -> begin
(let _127_1939 = (let _127_1938 = (let _127_1937 = (mk_term_projector_name l x.FStar_Absyn_Syntax.v)
in (_127_1937, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _127_1938))
in (push_term_var env x.FStar_Absyn_Syntax.v _127_1939))
end)) env))
in (
...
let eqs = (let _127_1946 = (FStar_List.map2 (fun v a -> (match (a) with
| FStar_Util.Inl (a) -> begin
(let _127_1943 = (let _127_1942 = (FStar_ToSMT_Term.mkFreeV v)
in (_127_1942, a))
in (FStar_ToSMT_Term.mkEq _127_1943))
end
| FStar_Util.Inr (a) -> begin
(let _127_1945 = (let _127_1944 = (FStar_ToSMT_Term.mkFreeV v)
in (_127_1944, a))
in (FStar_ToSMT_Term.mkEq _127_1945))
end)) vars indices)
in (FStar_All.pipe_right _127_1946 FStar_ToSMT_Term.mk_and_l))
in (let _127_1951 = (let _127_1950 = (let _127_1949 = (let _127_1948 = (let _127_1947 = (mk_data_tester env l xx)
in (_127_1947, eqs))
in (FStar_ToSMT_Term.mkAnd _127_1948))
in (out, _127_1949))
in (FStar_ToSMT_Term.mkOr _127_1950))
in (_127_1951, (FStar_List.append decls decls')))))
end))))
end)))
...
let xx_has_type = (let _127_1952 = (FStar_ToSMT_Term.mkApp ("SFuel", (ff)::[]))
in (FStar_ToSMT_Term.mk_HasTypeFuel _127_1952 xx tapp))
in (let _127_1959 = (let _127_1958 = (let _127_1957 = (let _127_1956 = (let _127_1955 = (let _127_1954 = (add_fuel (ffsym, FStar_ToSMT_Term.Fuel_sort) (((xxsym, FStar_ToSMT_Term.Term_sort))::vars))
in (let _127_1953 = (FStar_ToSMT_Term.mkImp (xx_has_type, data_ax))
in (((xx_has_type)::[])::[], _127_1954, _127_1953)))
in (FStar_ToSMT_Term.mkForall _127_1955))
in (_127_1956, Some ("inversion axiom")))
in FStar_ToSMT_Term.Assume (_127_1957))
in (_127_1958)::[])
in (FStar_List.append decls _127_1959)))
end))
end))
end))
end)
...
let _46_2552 = (match ((let _127_1960 = (FStar_Absyn_Util.compress_kind k)
in _127_1960.FStar_Absyn_Syntax.n)) with
...
let dproj_app = (let _127_1974 = (let _127_1973 = (let _127_1972 = (mk_typ_projector_name d a)
in (let _127_1971 = (let _127_1970 = (FStar_ToSMT_Term.mkFreeV xx)
in (_127_1970)::[])
in (_127_1972, _127_1971)))
in (FStar_ToSMT_Term.mkApp _127_1973))
in (mk_ApplyT _127_1974 suffix))
in (let _127_1979 = (let _127_1978 = (let _127_1977 = (let _127_1976 = (let _127_1975 = (FStar_ToSMT_Term.mkEq (tapp, dproj_app))
in (((tapp)::[])::[], vars, _127_1975))
in (FStar_ToSMT_Term.mkForall _127_1976))
in (_127_1977, Some ("projector axiom")))
in FStar_ToSMT_Term.Assume (_127_1978))
in (_127_1979)::[]))
end))))
end
| _46_2601 -> begin
...
in (let _127_1992 = (let _127_1991 = (let _127_1990 = (let _127_1989 = (let _127_1988 = (let _127_1987 = (let _127_1986 = (let _127_1985 = (let _127_1984 = (FStar_ToSMT_Term.mkApp ("PreType", (xx)::[]))
in (tapp, _127_1984))
in (FStar_ToSMT_Term.mkEq _127_1985))
in (xx_has_type, _127_1986))
in (FStar_ToSMT_Term.mkImp _127_1987))
in (((xx_has_type)::[])::[], ((xxsym, FStar_ToSMT_Term.Term_sort))::((ffsym, FStar_ToSMT_Term.Fuel_sort))::vars, _127_1988))
in (FStar_ToSMT_Term.mkForall _127_1989))
in (_127_1990, Some ("pretyping")))
in FStar_ToSMT_Term.Assume (_127_1991))
in (_127_1992)::[]))
end))
end)))
in (
...
let tapp = (let _127_1994 = (let _127_1993 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (tname, _127_1993))
in (FStar_ToSMT_Term.mkApp _127_1994))
in (
# 1613 "FStar.ToSMT.Encode.fst"
let _46_2636 = (
# 1614 "FStar.ToSMT.Encode.fst"
let tname_decl = (let _127_1998 = (let _127_1997 = (FStar_All.pipe_right vars (FStar_List.map (fun _46_2621 -> (match (_46_2621) with
| (n, s) -> begin
((Prims.strcat tname n), s)
end))))
in (let _127_1996 = (varops.next_id ())
in (tname, _127_1997, FStar_ToSMT_Term.Type_sort, _127_1996)))
in (constructor_or_logic_type_decl _127_1998))
in (
# 1615 "FStar.ToSMT.Encode.fst"
let _46_2633 = (match (vars) with
| [] -> begin
(let _127_2002 = (let _127_2001 = (let _127_2000 = (FStar_ToSMT_Term.mkApp (tname, []))
in (FStar_All.pipe_left (fun _127_1999 -> Some (_127_1999)) _127_2000))
in (push_free_tvar env t tname _127_2001))
in ([], _127_2002))
end
| _46_2625 -> begin
(
...
let ttok_fresh = (let _127_2003 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ttok, FStar_ToSMT_Term.Type_sort) _127_2003))
in (
...
let name_tok_corr = (let _127_2007 = (let _127_2006 = (let _127_2005 = (let _127_2004 = (FStar_ToSMT_Term.mkEq (ttok_app, tapp))
in (pats, None, vars, _127_2004))
in (FStar_ToSMT_Term.mkForall' _127_2005))
in (_127_2006, Some ("name-token correspondence")))
in FStar_ToSMT_Term.Assume (_127_2007))
...
(let _127_2011 = (let _127_2010 = (let _127_2009 = (let _127_2008 = (FStar_ToSMT_Term.mk_PreKind ttok_tm)
in (FStar_ToSMT_Term.mk_tester "Kind_arrow" _127_2008))
in (_127_2009, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_127_2010))
in (_127_2011)::[])
end else begin
[]
end
in (let _127_2017 = (let _127_2016 = (let _127_2015 = (let _127_2014 = (let _127_2013 = (let _127_2012 = (FStar_ToSMT_Term.mkImp (guard, k))
in (((tapp)::[])::[], vars, _127_2012))
in (FStar_ToSMT_Term.mkForall _127_2013))
in (_127_2014, Some ("kinding")))
in FStar_ToSMT_Term.Assume (_127_2015))
in (_127_2016)::[])
in (FStar_List.append (FStar_List.append decls karr) _127_2017)))
end))
in (
# 1638 "FStar.ToSMT.Encode.fst"
let aux = if is_logical then begin
(let _127_2018 = (projection_axioms tapp vars)
in (FStar_List.append kindingAx _127_2018))
end else begin
(let _127_2025 = (let _127_2023 = (let _127_2021 = (let _127_2019 = (primitive_type_axioms t tname tapp)
in (FStar_List.append kindingAx _127_2019))
in (let _127_2020 = (inversion_axioms tapp vars)
in (FStar_List.append _127_2021 _127_2020)))
in (let _127_2022 = (projection_axioms tapp vars)
in (FStar_List.append _127_2023 _127_2022)))
in (let _127_2024 = (pretype_axioms tapp vars)
in (FStar_List.append _127_2025 _127_2024)))
end
in (
...
let t = (let _127_2027 = (FStar_List.map (fun _46_2674 -> (match (_46_2674) with
| (x, _46_2673) -> begin
(x, Some (FStar_Absyn_Syntax.Implicit (true)))
end)) tps)
in (FStar_Absyn_Util.close_typ _127_2027 t))
in (
...
| FStar_Util.Inl (a) -> begin
(let _127_2029 = (mk_typ_projector_name d a)
in (_127_2029, FStar_ToSMT_Term.Type_sort))
end
| FStar_Util.Inr (x) -> begin
(let _127_2030 = (mk_term_projector_name d x)
in (_127_2030, FStar_ToSMT_Term.Term_sort))
end))))
in (
# 1667 "FStar.ToSMT.Encode.fst"
let datacons = (let _127_2032 = (let _127_2031 = (varops.next_id ())
in (ddconstrsym, projectors, FStar_ToSMT_Term.Term_sort, _127_2031))
in (FStar_All.pipe_right _127_2032 FStar_ToSMT_Term.constructor_to_decl))
in (
...
| _46_2728 -> begin
(let _127_2034 = (let _127_2033 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (ddtok, FStar_ToSMT_Term.Term_sort) _127_2033))
in (_127_2034)::[])
end)
in (
...
| (head, args) -> begin
(match ((let _127_2037 = (FStar_Absyn_Util.compress_typ head)
in _127_2037.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
(
...
let _46_2752 = (let _127_2040 = (FStar_Absyn_Util.new_bvd None)
in (gen_typ_var env _127_2040))
in (match (_46_2752) with
| (_46_2749, tv, env) -> begin
(let _127_2042 = (let _127_2041 = (FStar_ToSMT_Term.mkEq (targ, tv))
in (_127_2041)::eqns)
in (env, (tv)::arg_vars, _127_2042))
end))
end
| FStar_Util.Inr (varg) -> begin
(
# 1697 "FStar.ToSMT.Encode.fst"
let _46_2759 = (let _127_2043 = (FStar_Absyn_Util.new_bvd None)
in (gen_term_var env _127_2043))
in (match (_46_2759) with
| (_46_2756, xv, env) -> begin
(let _127_2045 = (let _127_2044 = (FStar_ToSMT_Term.mkEq (varg, xv))
in (_127_2044)::eqns)
in (env, (xv)::arg_vars, _127_2045))
end))
end)
...
let typing_inversion = (let _127_2052 = (let _127_2051 = (let _127_2050 = (let _127_2049 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _127_2048 = (let _127_2047 = (let _127_2046 = (FStar_ToSMT_Term.mk_and_l (FStar_List.append eqns guards))
in (ty_pred, _127_2046))
in (FStar_ToSMT_Term.mkImp _127_2047))
in (((ty_pred)::[])::[], _127_2049, _127_2048)))
in (FStar_ToSMT_Term.mkForall _127_2050))
in (_127_2051, Some ("data constructor typing elim")))
in FStar_ToSMT_Term.Assume (_127_2052))
in (
...
let x = (let _127_2053 = (varops.fresh "x")
in (_127_2053, FStar_ToSMT_Term.Term_sort))
in (
# 1713 "FStar.ToSMT.Encode.fst"
let xtm = (FStar_ToSMT_Term.mkFreeV x)
in (let _127_2063 = (let _127_2062 = (let _127_2061 = (let _127_2060 = (let _127_2055 = (let _127_2054 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_127_2054)::[])
in (_127_2055)::[])
in (let _127_2059 = (let _127_2058 = (let _127_2057 = (FStar_ToSMT_Term.mk_tester "LexCons" xtm)
in (let _127_2056 = (FStar_ToSMT_Term.mk_Precedes xtm dapp)
in (_127_2057, _127_2056)))
in (FStar_ToSMT_Term.mkImp _127_2058))
in (_127_2060, (x)::[], _127_2059)))
in (FStar_ToSMT_Term.mkForall _127_2061))
in (_127_2062, Some ("lextop is top")))
in FStar_ToSMT_Term.Assume (_127_2063))))
end else begin
(
...
(let _127_2066 = (let _127_2065 = (FStar_ToSMT_Term.mkFreeV v)
in (FStar_ToSMT_Term.mk_Precedes _127_2065 dapp))
in (_127_2066)::[])
end
| _46_2779 -> begin
(FStar_All.failwith "unexpected sort")
end))))
in (let _127_2073 = (let _127_2072 = (let _127_2071 = (let _127_2070 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) (FStar_List.append vars arg_binders))
in (let _127_2069 = (let _127_2068 = (let _127_2067 = (FStar_ToSMT_Term.mk_and_l prec)
in (ty_pred, _127_2067))
in (FStar_ToSMT_Term.mkImp _127_2068))
in (((ty_pred)::[])::[], _127_2070, _127_2069)))
in (FStar_ToSMT_Term.mkForall _127_2071))
in (_127_2072, Some ("subterm ordering")))
in FStar_ToSMT_Term.Assume (_127_2073)))
end
...
let _46_2784 = (let _127_2076 = (let _127_2075 = (FStar_Absyn_Print.sli d)
in (let _127_2074 = (FStar_Absyn_Print.typ_to_string head)
in (FStar_Util.format2 "Constructor %s builds an unexpected type %s\n" _127_2075 _127_2074)))
in (FStar_Tc_Errors.warn drange _127_2076))
in ([], []))
end)
end))
end))
...
let g = (let _127_2101 = (let _127_2100 = (let _127_2085 = (let _127_2084 = (let _127_2083 = (let _127_2082 = (let _127_2081 = (let _127_2080 = (let _127_2079 = (let _127_2078 = (let _127_2077 = (FStar_Absyn_Print.sli d)
in (FStar_Util.format1 "data constructor proxy: %s" _127_2077))
in Some (_127_2078))
in (ddtok, [], FStar_ToSMT_Term.Term_sort, _127_2079))
in FStar_ToSMT_Term.DeclFun (_127_2080))
in (_127_2081)::[])
in (FStar_List.append (FStar_List.append (FStar_List.append binder_decls decls2) decls3) _127_2082))
in (FStar_List.append _127_2083 proxy_fresh))
in (FStar_List.append _127_2084 decls_formals))
in (FStar_List.append _127_2085 decls_pred))
in (let _127_2099 = (let _127_2098 = (let _127_2097 = (let _127_2089 = (let _127_2088 = (let _127_2087 = (let _127_2086 = (FStar_ToSMT_Term.mkEq (app, dapp))
in (((app)::[])::[], vars, _127_2086))
in (FStar_ToSMT_Term.mkForall _127_2087))
in (_127_2088, Some ("equality for proxy")))
in FStar_ToSMT_Term.Assume (_127_2089))
in (let _127_2096 = (let _127_2095 = (let _127_2094 = (let _127_2093 = (let _127_2092 = (let _127_2091 = (add_fuel (fuel_var, FStar_ToSMT_Term.Fuel_sort) vars')
in (let _127_2090 = (FStar_ToSMT_Term.mkImp (guard', ty_pred'))
in (((ty_pred')::[])::[], _127_2091, _127_2090)))
in (FStar_ToSMT_Term.mkForall _127_2092))
in (_127_2093, Some ("data constructor typing intro")))
in FStar_ToSMT_Term.Assume (_127_2094))
in (_127_2095)::[])
in (_127_2097)::_127_2096))
in (FStar_ToSMT_Term.Assume ((tok_typing, Some ("typing for data constructor proxy"))))::_127_2098)
in (FStar_List.append _127_2100 _127_2099)))
in (FStar_List.append _127_2101 elim))
...
(let _127_2116 = (let _127_2115 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _127_2115))
in FStar_Util.Inl (_127_2116))
end
| (FStar_Util.Inr (x), FStar_Util.Inr (y)) -> begin
(let _127_2118 = (let _127_2117 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _127_2117))
in FStar_Util.Inr (_127_2118))
end
| _46_2873 -> begin
(FStar_All.failwith "Impossible")
end)) formals binders)
...
let extra_formals = (let _127_2119 = (FStar_Absyn_Util.subst_binders subst extra_formals)
in (FStar_All.pipe_right _127_2119 FStar_Absyn_Util.name_binders))
in (
# 1765 "FStar.ToSMT.Encode.fst"
let body = (let _127_2125 = (let _127_2121 = (let _127_2120 = (FStar_Absyn_Util.args_of_binders extra_formals)
in (FStar_All.pipe_left Prims.snd _127_2120))
in (body, _127_2121))
in (let _127_2124 = (let _127_2123 = (FStar_Absyn_Util.subst_typ subst t)
in (FStar_All.pipe_left (fun _127_2122 -> Some (_127_2122)) _127_2123))
in (FStar_Absyn_Syntax.mk_Exp_app_flat _127_2125 _127_2124 body.FStar_Absyn_Syntax.pos)))
...
| _46_2922 -> begin
(let _127_2134 = (let _127_2133 = (FStar_Absyn_Print.exp_to_string e)
in (let _127_2132 = (FStar_Absyn_Print.typ_to_string t_norm)
in (FStar_Util.format3 "Impossible! let-bound lambda %s = %s has a type that\'s not a function: %s\n" flid.FStar_Ident.str _127_2133 _127_2132)))
in (FStar_All.failwith _127_2134))
end)
end
| _46_2924 -> begin
(match (t_norm.FStar_Absyn_Syntax.n) with
...
let t_norm = (let _127_2140 = (whnf env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_All.pipe_right _127_2140 FStar_Absyn_Util.compress_typ))
in (
# 1810 "FStar.ToSMT.Encode.fst"
let _46_2961 = (let _127_2141 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (declare_top_level_let env _127_2141 lb.FStar_Absyn_Syntax.lbtyp t_norm))
in (match (_46_2961) with
| (tok, decl, env) -> begin
(let _127_2144 = (let _127_2143 = (let _127_2142 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_127_2142, tok))
in (_127_2143)::toks)
in (_127_2144, (t_norm)::typs, (decl)::decls, env))
end))))
end)) ([], [], [], env)))
...
| _46_2973 -> begin
false
end)))) || (FStar_All.pipe_right typs (FStar_Util.for_some (fun t -> ((FStar_Absyn_Util.is_lemma t) || (let _127_2147 = (FStar_Absyn_Util.is_pure_or_ghost_function t)
in (FStar_All.pipe_left Prims.op_Negation _127_2147))))))) then begin
(decls, env)
end else begin
...
| _46_3007 -> begin
(let _127_2149 = (let _127_2148 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (f, _127_2148))
in (FStar_ToSMT_Term.mkApp _127_2149))
end)
in (
...
let eqn = (let _127_2158 = (let _127_2157 = (let _127_2154 = (let _127_2153 = (let _127_2152 = (let _127_2151 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _127_2150 = (FStar_ToSMT_Term.mkEq (app, body))
in (_127_2151, _127_2150)))
in (FStar_ToSMT_Term.mkImp _127_2152))
in (((app)::[])::[], vars, _127_2153))
in (FStar_ToSMT_Term.mkForall _127_2154))
in (let _127_2156 = (let _127_2155 = (FStar_Util.format1 "Equation for %s" flid.FStar_Ident.str)
in Some (_127_2155))
in (_127_2157, _127_2156)))
in FStar_ToSMT_Term.Assume (_127_2158))
...
let fuel = (let _127_2159 = (varops.fresh "fuel")
in (_127_2159, FStar_ToSMT_Term.Fuel_sort))
in (
...
let env = (let _127_2164 = (let _127_2163 = (FStar_ToSMT_Term.mkApp (g, (fuel_tm)::[]))
in (FStar_All.pipe_left (fun _127_2162 -> Some (_127_2162)) _127_2163))
in (push_free_var env flid gtok _127_2164))
...
let decl_g = (let _127_2175 = (let _127_2174 = (let _127_2173 = (FStar_List.map Prims.snd vars)
in (FStar_ToSMT_Term.Fuel_sort)::_127_2173)
in (g, _127_2174, FStar_ToSMT_Term.Term_sort, Some ("Fuel-instrumented function name")))
in FStar_ToSMT_Term.DeclFun (_127_2175))
in (
...
let gsapp = (let _127_2178 = (let _127_2177 = (let _127_2176 = (FStar_ToSMT_Term.mkApp ("SFuel", (fuel_tm)::[]))
in (_127_2176)::vars_tm)
in (g, _127_2177))
in (FStar_ToSMT_Term.mkApp _127_2178))
in (
# 1846 "FStar.ToSMT.Encode.fst"
let gmax = (let _127_2181 = (let _127_2180 = (let _127_2179 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (_127_2179)::vars_tm)
in (g, _127_2180))
in (FStar_ToSMT_Term.mkApp _127_2181))
in (
...
let eqn_g = (let _127_2190 = (let _127_2189 = (let _127_2186 = (let _127_2185 = (let _127_2184 = (let _127_2183 = (FStar_ToSMT_Term.mk_and_l guards)
in (let _127_2182 = (FStar_ToSMT_Term.mkEq (gsapp, body_tm))
in (_127_2183, _127_2182)))
in (FStar_ToSMT_Term.mkImp _127_2184))
in (((gsapp)::[])::[], (fuel)::vars, _127_2185))
in (FStar_ToSMT_Term.mkForall _127_2186))
in (let _127_2188 = (let _127_2187 = (FStar_Util.format1 "Equation for fuel-instrumented recursive function: %s" flid.FStar_Ident.str)
in Some (_127_2187))
in (_127_2189, _127_2188)))
in FStar_ToSMT_Term.Assume (_127_2190))
in (
# 1849 "FStar.ToSMT.Encode.fst"
let eqn_f = (let _127_2194 = (let _127_2193 = (let _127_2192 = (let _127_2191 = (FStar_ToSMT_Term.mkEq (app, gmax))
in (((app)::[])::[], vars, _127_2191))
in (FStar_ToSMT_Term.mkForall _127_2192))
in (_127_2193, Some ("Correspondence of recursive function to instrumented version")))
in FStar_ToSMT_Term.Assume (_127_2194))
in (
# 1850 "FStar.ToSMT.Encode.fst"
let eqn_g' = (let _127_2203 = (let _127_2202 = (let _127_2201 = (let _127_2200 = (let _127_2199 = (let _127_2198 = (let _127_2197 = (let _127_2196 = (let _127_2195 = (FStar_ToSMT_Term.n_fuel 0)
in (_127_2195)::vars_tm)
in (g, _127_2196))
in (FStar_ToSMT_Term.mkApp _127_2197))
in (gsapp, _127_2198))
in (FStar_ToSMT_Term.mkEq _127_2199))
in (((gsapp)::[])::[], (fuel)::vars, _127_2200))
in (FStar_ToSMT_Term.mkForall _127_2201))
in (_127_2202, Some ("Fuel irrelevance")))
in FStar_ToSMT_Term.Assume (_127_2203))
in (
...
let tok_app = (let _127_2204 = (FStar_ToSMT_Term.mkFreeV (gtok, FStar_ToSMT_Term.Term_sort))
in (mk_ApplyE _127_2204 ((fuel)::vars)))
in (let _127_2208 = (let _127_2207 = (let _127_2206 = (let _127_2205 = (FStar_ToSMT_Term.mkEq (tok_app, gapp))
in (((tok_app)::[])::[], (fuel)::vars, _127_2205))
in (FStar_ToSMT_Term.mkForall _127_2206))
in (_127_2207, Some ("Fuel token correspondence")))
in FStar_ToSMT_Term.Assume (_127_2208)))
in (
...
| (g_typing, d3) -> begin
(let _127_2216 = (let _127_2215 = (let _127_2214 = (let _127_2213 = (let _127_2212 = (let _127_2211 = (let _127_2210 = (let _127_2209 = (FStar_ToSMT_Term.mk_and_l v_guards)
in (_127_2209, g_typing))
in (FStar_ToSMT_Term.mkImp _127_2210))
in (((gapp)::[])::[], (fuel)::vars, _127_2211))
in (FStar_ToSMT_Term.mkForall _127_2212))
in (_127_2213, None))
in FStar_ToSMT_Term.Assume (_127_2214))
in (_127_2215)::[])
in (d3, _127_2216))
end))
...
let _46_3110 = (let _127_2219 = (FStar_List.zip3 gtoks typs bindings)
...
end)) ((decls)::[], [], env0) _127_2219))
in (match (_46_3110) with
| (decls, eqns, env0) -> begin
(
# 1866 "FStar.ToSMT.Encode.fst"
let _46_3119 = (let _127_2221 = (FStar_All.pipe_right decls FStar_List.flatten)
in (FStar_All.pipe_right _127_2221 (FStar_List.partition (fun _46_28 -> (match (_46_28) with
...
let msg = (let _127_2224 = (FStar_All.pipe_right bindings (FStar_List.map (fun lb -> (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname))))
in (FStar_All.pipe_right _127_2224 (FStar_String.concat " and ")))
in (
...
(let _127_2239 = (FStar_Tc_Util.pure_or_ghost_pre_and_post env.tcenv comp)
in (args, _127_2239))
end else begin
...
in (let _127_2256 = (let _127_2255 = (let _127_2254 = (let _127_2253 = (let _127_2252 = (let _127_2251 = (let _127_2250 = (let _127_2249 = (FStar_ToSMT_Term.mk_tester (escape d.FStar_Ident.str) xx)
in (FStar_All.pipe_left FStar_ToSMT_Term.boxBool _127_2249))
in (vapp, _127_2250))
in (FStar_ToSMT_Term.mkEq _127_2251))
in (((vapp)::[])::[], vars, _127_2252))
in (FStar_ToSMT_Term.mkForall _127_2253))
in (_127_2254, Some ("Discriminator equation")))
in FStar_ToSMT_Term.Assume (_127_2255))
in (_127_2256)::[]))
end))
end
...
let prim_app = (let _127_2258 = (let _127_2257 = (mk_term_projector_name d f)
in (_127_2257, (xx)::[]))
in (FStar_ToSMT_Term.mkApp _127_2258))
in (let _127_2263 = (let _127_2262 = (let _127_2261 = (let _127_2260 = (let _127_2259 = (FStar_ToSMT_Term.mkEq (vapp, prim_app))
in (((vapp)::[])::[], vars, _127_2259))
in (FStar_ToSMT_Term.mkForall _127_2260))
in (_127_2261, Some ("Projector equation")))
in FStar_ToSMT_Term.Assume (_127_2262))
in (_127_2263)::[])))
end))
end
| _46_3245 -> begin
...
| None -> begin
(let _127_2264 = (FStar_ToSMT_Term.mk_and_l guards)
in (_127_2264, decls1))
end
| Some (p) -> begin
(
...
| (g, ds) -> begin
(let _127_2265 = (FStar_ToSMT_Term.mk_and_l ((g)::guards))
in (_127_2265, (FStar_List.append decls1 ds)))
end))
end)
...
let vapp = (let _127_2267 = (let _127_2266 = (FStar_List.map FStar_ToSMT_Term.mkFreeV vars)
in (vname, _127_2266))
in (FStar_ToSMT_Term.mkApp _127_2267))
in (
# 1943 "FStar.ToSMT.Encode.fst"
let _46_3292 = (
# 1944 "FStar.ToSMT.Encode.fst"
let vname_decl = (let _127_2270 = (let _127_2269 = (FStar_All.pipe_right formals (FStar_List.map (fun _46_31 -> (match (_46_31) with
...
in (vname, _127_2269, FStar_ToSMT_Term.Term_sort, None))
in FStar_ToSMT_Term.DeclFun (_127_2270))
in (
...
| [] -> begin
(let _127_2274 = (let _127_2273 = (let _127_2272 = (FStar_ToSMT_Term.mkFreeV (vname, FStar_ToSMT_Term.Term_sort))
in (FStar_All.pipe_left (fun _127_2271 -> Some (_127_2271)) _127_2272))
in (push_free_var env lid vname _127_2273))
in ((FStar_List.append decls2 ((tok_typing)::[])), _127_2274))
end
| _46_3283 -> begin
(
...
let vtok_fresh = (let _127_2275 = (varops.next_id ())
in (FStar_ToSMT_Term.fresh_token (vtok, FStar_ToSMT_Term.Term_sort) _127_2275))
in (
# 1956 "FStar.ToSMT.Encode.fst"
let name_tok_corr = (let _127_2279 = (let _127_2278 = (let _127_2277 = (let _127_2276 = (FStar_ToSMT_Term.mkEq (vtok_app, vapp))
in (((vtok_app)::[])::[], vars, _127_2276))
in (FStar_ToSMT_Term.mkForall _127_2277))
in (_127_2278, None))
in FStar_ToSMT_Term.Assume (_127_2279))
...
(let _127_2280 = (FStar_ToSMT_Term.mk_HasType vapp encoded_res_t)
in (encoded_res_t, _127_2280, decls))
end)))
in (match (_46_3300) with
| (encoded_res_t, ty_pred, decls3) -> begin
(
# 1963 "FStar.ToSMT.Encode.fst"
let typingAx = (let _127_2284 = (let _127_2283 = (let _127_2282 = (let _127_2281 = (FStar_ToSMT_Term.mkImp (guard, ty_pred))
in (((vapp)::[])::[], vars, _127_2281))
in (FStar_ToSMT_Term.mkForall _127_2282))
in (_127_2283, Some ("free var typing")))
in FStar_ToSMT_Term.Assume (_127_2284))
in (
# 1964 "FStar.ToSMT.Encode.fst"
let g = (let _127_2286 = (let _127_2285 = (mk_disc_proj_axioms guard encoded_res_t vapp vars)
in (typingAx)::_127_2285)
in (FStar_List.append (FStar_List.append (FStar_List.append decls1 decls2) decls3) _127_2286))
in (g, env)))
end))
end))))
end))
...
(let _127_2301 = (FStar_Absyn_Print.strBvd x)
in (let _127_2300 = (FStar_Absyn_Print.typ_to_string t0)
in (let _127_2299 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.print3 "Normalized %s : %s to %s\n" _127_2301 _127_2300 _127_2299))))
end else begin
()
end
in (
...
let caption = if (FStar_ST.read FStar_Options.logQueries) then begin
(let _127_2305 = (let _127_2304 = (FStar_Absyn_Print.strBvd x)
in (let _127_2303 = (FStar_Absyn_Print.typ_to_string t0)
in (let _127_2302 = (FStar_Absyn_Print.typ_to_string t1)
in (FStar_Util.format3 "%s : %s (%s)" _127_2304 _127_2303 _127_2302))))
in Some (_127_2305))
end else begin
None
end
...
let g = (let _127_2311 = (let _127_2310 = (let _127_2309 = (let _127_2308 = (let _127_2307 = (let _127_2306 = (FStar_Absyn_Print.strBvd a)
in Some (_127_2306))
in (aasym, [], FStar_ToSMT_Term.Type_sort, _127_2307))
in FStar_ToSMT_Term.DeclFun (_127_2308))
in (_127_2309)::[])
in (FStar_List.append _127_2310 decls'))
in (FStar_List.append _127_2311 ((FStar_ToSMT_Term.Assume ((k, None)))::[])))
in ((FStar_List.append decls g), env'))
end))
end))
end
...
(let _127_2319 = (FStar_All.pipe_left (fun _127_2315 -> FStar_ToSMT_Term.Echo (_127_2315)) (Prims.fst l))
in (let _127_2318 = (let _127_2317 = (let _127_2316 = (FStar_ToSMT_Term.mkFreeV l)
in FStar_ToSMT_Term.Eval (_127_2316))
in (_127_2317)::[])
in (_127_2319)::_127_2318))
end))))
in (prefix, suffix))))
...
let init_env : FStar_Tc_Env.env  ->  Prims.unit = (fun tcenv -> (let _127_2324 = (let _127_2323 = (let _127_2322 = (FStar_Util.smap_create 100)
in {bindings = []; depth = 0; tcenv = tcenv; warn = true; cache = _127_2322; nolabels = false; use_zfuel_name = false; encode_non_total_function_typ = true})
in (_127_2323)::[])
in (FStar_ST.op_Colon_Equals last_env _127_2324)))
...
let _46_3427 = (let _127_2345 = (pop_env ())
in (FStar_All.pipe_left Prims.ignore _127_2345))
in (
...
(let _127_2359 = (let _127_2358 = (let _127_2357 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (Prims.strcat "encoding sigelt " _127_2357))
in FStar_ToSMT_Term.Caption (_127_2358))
in (_127_2359)::decls)
end else begin
decls
end)
...
in (let _127_2360 = (caption decls)
in (FStar_ToSMT_Z3.giveZ3 _127_2360)))
end)))))
...
(let _127_2365 = (FStar_All.pipe_right (FStar_List.length modul.FStar_Absyn_Syntax.exports) FStar_Util.string_of_int)
...
let _46_3479 = (let _127_2374 = (let _127_2373 = (let _127_2372 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _127_2372))
in (FStar_Util.format1 "Starting query at %s" _127_2373))
in (push _127_2374))
in (
# 2115 "FStar.ToSMT.Encode.fst"
let pop = (fun _46_3482 -> (match (()) with
| () -> begin
(let _127_2379 = (let _127_2378 = (let _127_2377 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _127_2377))
in (FStar_Util.format1 "Ending query at %s" _127_2378))
in (pop _127_2379))
end))
in (
...
in (let _127_2385 = (let _127_2384 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_127_2384)::out)
in (_127_2385, rest)))
end))
end
...
| (out, rest) -> begin
(let _127_2387 = (let _127_2386 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_127_2386)::out)
in (_127_2387, rest))
end))
end
...
(let _127_2388 = (FStar_Absyn_Util.close_forall (FStar_List.rev closing) q)
in (_127_2388, bindings))
end)))
in (match (_46_3515) with
| (q, bindings) -> begin
(
# 2131 "FStar.ToSMT.Encode.fst"
let _46_3524 = (let _127_2390 = (FStar_List.filter (fun _46_32 -> (match (_46_32) with
...
let qry = (let _127_2393 = (let _127_2392 = (FStar_ToSMT_Term.mkNot phi)
in (_127_2392, Some ("query")))
in FStar_ToSMT_Term.Assume (_127_2393))
in (
...
| (n, i) -> begin
(let _127_2416 = (let _127_2415 = (let _127_2400 = (let _127_2399 = (FStar_Util.string_of_int n)
in (let _127_2398 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "<fuel=\'%s\' ifuel=\'%s\'>" _127_2399 _127_2398)))
in FStar_ToSMT_Term.Caption (_127_2400))
in (let _127_2414 = (let _127_2413 = (let _127_2405 = (let _127_2404 = (let _127_2403 = (let _127_2402 = (FStar_ToSMT_Term.mkApp ("MaxFuel", []))
in (let _127_2401 = (FStar_ToSMT_Term.n_fuel n)
in (_127_2402, _127_2401)))
in (FStar_ToSMT_Term.mkEq _127_2403))
in (_127_2404, None))
in FStar_ToSMT_Term.Assume (_127_2405))
in (let _127_2412 = (let _127_2411 = (let _127_2410 = (let _127_2409 = (let _127_2408 = (let _127_2407 = (FStar_ToSMT_Term.mkApp ("MaxIFuel", []))
in (let _127_2406 = (FStar_ToSMT_Term.n_fuel i)
in (_127_2407, _127_2406)))
in (FStar_ToSMT_Term.mkEq _127_2408))
in (_127_2409, None))
in FStar_ToSMT_Term.Assume (_127_2410))
in (_127_2411)::(p)::(FStar_ToSMT_Term.CheckSat)::[])
in (_127_2413)::_127_2412))
in (_127_2415)::_127_2414))
in (FStar_List.append _127_2416 suffix))
end))
in (
# 2156 "FStar.ToSMT.Encode.fst"
let check = (fun p -> (
# 2157 "FStar.ToSMT.Encode.fst"
let initial_config = (let _127_2420 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _127_2419 = (FStar_ST.read FStar_Options.initial_ifuel)
in (_127_2420, _127_2419)))
in (
# 2158 "FStar.ToSMT.Encode.fst"
let alt_configs = (let _127_2439 = (let _127_2438 = if ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel)) then begin
(let _127_2423 = (let _127_2422 = (FStar_ST.read FStar_Options.initial_fuel)
in (let _127_2421 = (FStar_ST.read FStar_Options.max_ifuel)
in (_127_2422, _127_2421)))
in (_127_2423)::[])
end else begin
[]
end
in (let _127_2437 = (let _127_2436 = if (((FStar_ST.read FStar_Options.max_fuel) / 2) > (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _127_2426 = (let _127_2425 = ((FStar_ST.read FStar_Options.max_fuel) / 2)
in (let _127_2424 = (FStar_ST.read FStar_Options.max_ifuel)
in (_127_2425, _127_2424)))
in (_127_2426)::[])
end else begin
[]
end
in (let _127_2435 = (let _127_2434 = if (((FStar_ST.read FStar_Options.max_fuel) > (FStar_ST.read FStar_Options.initial_fuel)) && ((FStar_ST.read FStar_Options.max_ifuel) > (FStar_ST.read FStar_Options.initial_ifuel))) then begin
(let _127_2429 = (let _127_2428 = (FStar_ST.read FStar_Options.max_fuel)
in (let _127_2427 = (FStar_ST.read FStar_Options.max_ifuel)
in (_127_2428, _127_2427)))
in (_127_2429)::[])
end else begin
[]
end
in (let _127_2433 = (let _127_2432 = if ((FStar_ST.read FStar_Options.min_fuel) < (FStar_ST.read FStar_Options.initial_fuel)) then begin
(let _127_2431 = (let _127_2430 = (FStar_ST.read FStar_Options.min_fuel)
in (_127_2430, 1))
in (_127_2431)::[])
end else begin
[]
...
in (_127_2432)::[])
in (_127_2434)::_127_2433))
in (_127_2436)::_127_2435))
in (_127_2438)::_127_2437))
in (FStar_List.flatten _127_2439))
in (
...
(let _127_2447 = (let _127_2442 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _127_2442))
in (let _127_2446 = (let _127_2443 = (FStar_ST.read FStar_Options.max_fuel)
in (FStar_All.pipe_right _127_2443 FStar_Util.string_of_int))
in (let _127_2445 = (let _127_2444 = (FStar_ST.read FStar_Options.max_ifuel)
in (FStar_All.pipe_right _127_2444 FStar_Util.string_of_int))
in (FStar_Util.print3 "(%s) Query failed with maximum fuel %s and ifuel %s\n" _127_2447 _127_2446 _127_2445))))
end else begin
()
end
...
(match (errs) with
| [] -> begin
(let _127_2458 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _127_2458 (cb mi p [])))
end
| _46_3597 -> begin
(report errs)
end)
...
| mi::tl -> begin
(let _127_2460 = (with_fuel p mi)
in (FStar_ToSMT_Z3.ask fresh labels _127_2460 (fun _46_3603 -> (match (_46_3603) with
| (ok, errs') -> begin
(match (errs) with
| [] -> begin
(cb mi p tl (ok, errs'))
...
(let _127_2468 = (let _127_2465 = (FStar_Tc_Env.get_range tcenv)
in (FStar_Range.string_of_range _127_2465))
in (let _127_2467 = (FStar_Util.string_of_int prev_fuel)
in (let _127_2466 = (FStar_Util.string_of_int prev_ifuel)
in (FStar_Util.print3 "(%s) Query succeeded with fuel %s and ifuel %s\n" _127_2468 _127_2467 _127_2466))))
end else begin
()
end
end else begin
...
in (let _127_2469 = (with_fuel p initial_config)
in (FStar_ToSMT_Z3.ask fresh labels _127_2469 (cb initial_config p alt_configs))))))))
in (
...
let _46_3619 = (let _127_2475 = (FStar_ST.read FStar_Options.split_cases)
in (FStar_ToSMT_SplitQueryCases.can_handle_query _127_2475 q))
