...
type deferred =
  (Prims.string, prob) FStar_Pervasives_Native.tuple2 Prims.list[@@deriving
                                                                  show]
type univ_ineq =
...
let (mk_by_tactic :
  ...
  fun tac ->
    fun f ->
      ...
      let tac1 =
        let uu____664 =
          let uu____669 =
            ...
            let uu____671 =
              let uu____674 = FStar_Syntax_Syntax.as_arg tac in [uu____674] in
      ...
      let uu____677 =
        let uu____682 =
          let uu____683 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
          let uu____684 =
  ...
  fun l ->
    fun m ->
      ...
      | (FStar_Syntax_Syntax.Delta_defined_at_level i,
         FStar_Syntax_Syntax.Delta_defined_at_level j) -> i > j
      | (FStar_Syntax_Syntax.Delta_defined_at_level uu____709,
...
let find_nearest_preceding_col_info :
  ...
  fun col ->
    fun col_infos ->
      let rec aux out uu___33_1083 =
        match uu___33_1083 with
        | [] -> out
        | (c, i)::rest ->
            if c > col
            then out
  ...
  fun ty_map ->
    fun db ->
      fun info ->
        ...
        let info1 =
          let uu___34_1230 = info in
          let uu____1231 = ty_map info.identifier_ty in
          {
            identifier = (uu___34_1230.identifier);
        ...
        | (row, col) ->
            ...
            let uu____1302 =
              ...
              FStar_All.pipe_right uu____1311 (FStar_Util.pimap_add rows row) in
    ...
    fun id1 ->
      fun ty ->
        fun range ->
          ...
          let uu___35_1393 = table in
          {
            id_info_enabled = (uu___35_1393.id_info_enabled);
            id_info_db = (uu___35_1393.id_info_db);
...
let (id_info_toggle : id_info_table -> Prims.bool -> id_info_table) =
  fun table ->
    fun enabled ->
      let uu___36_1438 = table in
      let uu____1439 = enabled && (FStar_Options.ide ()) in
      {
        id_info_enabled = uu____1439;
        id_info_db = (uu___36_1438.id_info_db);
        id_info_buffer = (uu___36_1438.id_info_buffer)
      }
let (id_info_promote :
  id_info_table ->
