...
let info_as_string: identifier_info -> Prims.string =
  fun info  ->
    let uu____385 =
      ...
      | FStar_Util.Inl bv ->
          let _0_178 = FStar_Syntax_Print.bv_to_string bv in
          let _0_177 = FStar_Syntax_Syntax.range_of_bv bv in (_0_178, _0_177)
      | FStar_Util.Inr fv ->
          let _0_180 =
            FStar_Syntax_Print.lid_to_string
              (FStar_Syntax_Syntax.lid_of_fv fv) in
          let _0_179 = FStar_Syntax_Syntax.range_of_fv fv in (_0_180, _0_179) in
    match uu____385 with
    | (id_string,range) ->
        let _0_182 = FStar_Syntax_Print.term_to_string info.identifier_ty in
        let _0_181 = FStar_Range.string_of_range range in
        FStar_Util.format3 "%s : %s (defined at %s)" id_string _0_182 _0_181
let rec insert_col_info col info col_infos =
  ...
  | (c,i)::rest ->
      ...
      else (let _0_183 = insert_col_info col info rest in (c, i) :: _0_183)
  ...
  fun id  ->
    fun ty  ->
      fun range  ->
        ...
        let uu____523 =
          let _0_185 = FStar_Range.line_of_pos start in
          let _0_184 = FStar_Range.col_of_pos start in (_0_185, _0_184) in
            ...
            (match uu____528 with
             ...
             | Some file_rows ->
                 ...
                 (match uu____559 with
                  ...
                  | Some col_infos ->
                      let _0_187 =
                        let _0_186 = FStar_ST.read col_infos in
                        insert_col_info col info _0_186 in
                      FStar_ST.write col_infos _0_187))
let info_at_pos:
      ...
      fun col  ->
        ...
        | Some rows ->
            ...
            (match uu____600 with
             ...
             | Some cols ->
                 let uu____609 =
                   let _0_188 = FStar_ST.read cols in
                   find_nearest_preceding_col_info col _0_188 in
...
let insert_bv:
  ...
  fun bv  ->
    fun ty  ->
      let _0_189 = FStar_Syntax_Syntax.range_of_bv bv in
      insert_identifier_info (FStar_Util.Inl bv) ty _0_189
let insert_fv:
  FStar_Syntax_Syntax.fv -> FStar_Syntax_Syntax.typ -> Prims.unit =
  fun fv  ->
    fun ty  ->
      let _0_190 = FStar_Syntax_Syntax.range_of_fv fv in
      insert_identifier_info (FStar_Util.Inr fv) ty _0_190