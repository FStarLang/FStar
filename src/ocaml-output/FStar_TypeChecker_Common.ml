...
let as_tprob : prob  ->  (FStar_Syntax_Syntax.typ, FStar_Syntax_Syntax.term) problem = (fun uu___133_567 -> (match (uu___133_567) with
| TProb (p) -> begin
p
end
| uu____577 -> begin
...
| FStar_Syntax_Syntax.Delta_defined_at_level (_0_39) when (_0_39 = (Prims.parse_int "1")) -> begin
...
let rec aux = (fun out uu___135_1023 -> (match (uu___135_1023) with
| [] -> begin
out
end
| ((c, i))::rest -> begin
...
let uu___136_1161 = info
in (

let uu____1162 = (ty_map info.identifier_ty)
in {identifier = uu___136_1161.identifier; identifier_ty = uu____1162; identifier_range = use_range1}))
in (
...
let uu___137_1320 = table
in {id_info_enabled = uu___137_1320.id_info_enabled; id_info_db = uu___137_1320.id_info_db; id_info_buffer = (info)::table.id_info_buffer})))
