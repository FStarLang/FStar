...
let (uu___is_SUBINV : rel -> Prims.bool) =
  fun projectee -> match projectee with | SUBINV -> true | uu____59 -> false
type rank_t =
  | Rigid_rigid 
  | Flex_rigid_eq 
      ...
      fun info ->
        ...
        | (row, col) ->
            ...
            let uu____1441 =
              ...
              FStar_All.pipe_right uu____1451 (FStar_Util.pimap_add rows row) in
          ...
          fun bs ->
                  ...
                  (FStar_List.map
                     (fun uu___3_1732 ->
                        ...
                        | FStar_Syntax_Syntax.Binding_lid (l, uu____1741) ->
                            ...
                            Prims.op_Hat "Binding_lid " uu____1758)) in
            ...
            let fail1 uu____1771 =
              let uu____1772 =
                ...
                let uu____1778 = FStar_Syntax_Print.binders_to_string ", " bs in
                FStar_Util.format5
                 ...
                 let uu____1816 =
                   FStar_Util.prefix_until
                     (fun uu___4_1831 ->
                        ...
                        | uu____1835 -> false) g in
                 (uu____1816, bs) in
               match uu____1791 with
               | (FStar_Pervasives_Native.None, []) -> ()
               | (FStar_Pervasives_Native.Some (uu____1893, hd1, gamma_tail),
