...
| (FStar_Syntax_Syntax.Delta_constant, uu____355) -> begin
false
end
| (FStar_Syntax_Syntax.Delta_equational, uu____356) -> begin
true
end
| (uu____357, FStar_Syntax_Syntax.Delta_equational) -> begin
false
end
| (FStar_Syntax_Syntax.Delta_defined_at_level (i), FStar_Syntax_Syntax.Delta_defined_at_level (j)) -> begin
(i > j)
end
| (FStar_Syntax_Syntax.Delta_defined_at_level (uu____360), FStar_Syntax_Syntax.Delta_constant) -> begin
true
end
| (FStar_Syntax_Syntax.Delta_abstract (d), uu____362) -> begin
(delta_depth_greater_than d m)
end
| (uu____363, FStar_Syntax_Syntax.Delta_abstract (d)) -> begin
(delta_depth_greater_than l d)
end))


let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth Prims.option = (fun uu___92_368 -> (match (uu___92_368) with
