      ...
      let uu____543 =
        let uu____548 =
          ...
          let uu____558 =
            ...
            let uu____578 =
              let uu____589 = FStar_Syntax_Syntax.as_arg f  in [uu____589]
               in
...
let (find_nearest_preceding_col_info :
  ...
  fun col  ->
    fun col_infos  ->
      let rec aux out uu___221_1008 =
        match uu___221_1008 with
        | [] -> out
        | (c,i)::rest ->
            if c > col
            then out
  ...
  fun ty_map  ->
    fun db  ->
      fun info  ->
        ...
        let info1 =
          let uu___224_1155 = info  in
          let uu____1156 = ty_map info.identifier_ty  in
          {
            identifier = (uu___224_1155.identifier);
        ...
        | (row,col) ->
            ...
            let uu____1227 =
              ...
              FStar_All.pipe_right uu____1236 (FStar_Util.pimap_add rows row)
               in
    ...
    fun id1  ->
      fun ty  ->
        fun range  ->
          ...
          let uu___225_1318 = table  in
          {
            id_info_enabled = (uu___225_1318.id_info_enabled);
            id_info_db = (uu___225_1318.id_info_db);
...
let (id_info_toggle : id_info_table -> Prims.bool -> id_info_table) =
  fun table  ->
    fun enabled  ->
      let uu___226_1363 = table  in
      let uu____1364 = enabled && (FStar_Options.ide ())  in
      {
        id_info_enabled = uu____1364;
        id_info_db = (uu___226_1363.id_info_db);
        id_info_buffer = (uu___226_1363.id_info_buffer)
      }
          ...
          fun bs  ->
                  ...
                  (FStar_List.map
                     (fun uu___222_1479  ->
                        ...
                        | FStar_Syntax_Syntax.Binding_lid (l,uu____1484) ->
                            ...
                            Prims.strcat "Binding_lid " uu____1501))
                 in
            ...
            then ()
              ...
              (let uu____1516 =
               ...
               | (FStar_Pervasives_Native.Some
                  (uu____1615,hd1,gamma_tail),uu____1618::uu____1619) ->
