  ...
  fun tac  ->
    fun f  ->
      let t_by_tactic =
        ...
        FStar_Syntax_Syntax.mk_Tm_uinst uu___ [FStar_Syntax_Syntax.U_zero]
         in
      let uu___ =
        let uu___1 = FStar_Syntax_Syntax.as_arg tac  in
        let uu___2 = let uu___3 = FStar_Syntax_Syntax.as_arg f  in [uu___3]
           in
        uu___1 :: uu___2  in
...
let rec (delta_depth_greater_than :
  ...
  fun l  ->
    fun m  ->
      ...
      | (uu___,FStar_Syntax_Syntax.Delta_equational_at_level uu___1) -> false
      ...
      fun row  ->
        fun col  ->
          ...
          | FStar_Pervasives_Native.Some info ->
              let last_col =
                let uu___1 = FStar_Range.end_of_range info.identifier_range
                   in
          ...
          fun bs  ->
                  ...
                  (FStar_List.map
                     (fun uu___1  ->
                        ...
                        | FStar_Syntax_Syntax.Binding_var x ->
                            let uu___2 = FStar_Syntax_Print.bv_to_string x
                               in
                        ...
                        | FStar_Syntax_Syntax.Binding_lid (l,uu___2) ->
                            ...
                            Prims.op_Hat "Binding_lid " uu___3))
                 in
            ...
            then ()
              ...
              (let uu___1 =
               ...
               | (FStar_Pervasives_Native.Some
                  (uu___2,hd,gamma_tail),uu___3::uu___4) ->
  ...
  fun debug  ->
    fun tm  ->
      ...
      let rec clearly_inhabited ty =
        ...
        | uu___1 -> false  in
      let simplify1 arg =
        let uu___ = simp_t (FStar_Pervasives_Native.fst arg)  in (uu___, arg)
         in
      let uu___ =
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu___5;_},args)
          ->
          let uu___6 =
            FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.and_lid  in
          if uu___6
          then
            let uu___7 = FStar_All.pipe_right args (FStar_List.map simplify1)
               in
            (match uu___7 with
                  ...
                  (let uu___12 =
                   ...
                   then
                     ...
                     | (uu___14,(arg,uu___15))::(FStar_Pervasives_Native.Some
                         ...
                         -> maybe_auto_squash arg
                     | (FStar_Pervasives_Native.Some (true ),uu___14)::
                         (uu___15,(arg,uu___16))::[] -> maybe_auto_squash arg
                     | (uu___14,(arg,uu___15))::(FStar_Pervasives_Native.Some
                                                 (false ),uu___16)::[]
                         ->
                      ...
                      then
                        ...
                        (let uu___16 =
                         ...
                         then
                           ...
                           | (t,uu___17)::[] ->
                               let uu___18 =
                                 let uu___19 = FStar_Syntax_Subst.compress t
                                    in
                           ...
                           | (ty,FStar_Pervasives_Native.Some
                              (FStar_Syntax_Syntax.Implicit uu___17))::
                               (t,uu___18)::[] ->
                               let uu___19 =
                                 let uu___20 = FStar_Syntax_Subst.compress t
                                    in
                              ...
                              (let uu___20 =
                               ...
                               then
                                 ...
                                 | ({
                                      ...
                                      FStar_Syntax_Syntax.vars = uu___22;_},uu___23)::[]
                                     -> w FStar_Syntax_Util.t_true
                                 | ({
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_constant
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu___1;
             FStar_Syntax_Syntax.vars = uu___2;_},args)
          ->
          let uu___3 =
            FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.and_lid  in
          if uu___3
          then
            let uu___4 = FStar_All.pipe_right args (FStar_List.map simplify1)
               in
            (match uu___4 with
                  ...
                  (let uu___9 =
                   ...
                   then
                     ...
                     | (uu___11,(arg,uu___12))::(FStar_Pervasives_Native.Some
                         ...
                         -> maybe_auto_squash arg
                     | (FStar_Pervasives_Native.Some (true ),uu___11)::
                         (uu___12,(arg,uu___13))::[] -> maybe_auto_squash arg
                     | (uu___11,(arg,uu___12))::(FStar_Pervasives_Native.Some
                                                 (false ),uu___13)::[]
                         ->
                      ...
                      then
                        ...
                        (let uu___13 =
                         ...
                         then
                           ...
                           | (t,uu___14)::[] ->
                               let uu___15 =
                                 let uu___16 = FStar_Syntax_Subst.compress t
                                    in
                           ...
                           | (ty,FStar_Pervasives_Native.Some
                              (FStar_Syntax_Syntax.Implicit uu___14))::
                               (t,uu___15)::[] ->
                               let uu___16 =
                                 let uu___17 = FStar_Syntax_Subst.compress t
                                    in
                              ...
                              (let uu___17 =
                               ...
                               then
                                 ...
                                 | ({
                                      ...
                                      FStar_Syntax_Syntax.vars = uu___19;_},uu___20)::[]
                                     -> w FStar_Syntax_Util.t_true
                                 | ({
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_constant
