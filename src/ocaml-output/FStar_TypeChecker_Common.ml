...
let tconst : FStar_Ident.lident  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun l -> (let _147_83 = (let _147_82 = (FStar_Syntax_Syntax.lid_as_fv l FStar_Syntax_Syntax.Delta_constant None)
in FStar_Syntax_Syntax.Tm_fvar (_147_82))
in (FStar_Syntax_Syntax.mk _147_83 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) FStar_Range.dummyRange)))
...
| (FStar_Syntax_Syntax.Delta_constant, _65_29) -> begin
false
end
| (FStar_Syntax_Syntax.Delta_equational, _65_33) -> begin
true
end
| (_65_36, FStar_Syntax_Syntax.Delta_equational) -> begin
false
end
| (FStar_Syntax_Syntax.Delta_unfoldable (i), FStar_Syntax_Syntax.Delta_unfoldable (j)) -> begin
(i > j)
end
| (FStar_Syntax_Syntax.Delta_unfoldable (_65_45), FStar_Syntax_Syntax.Delta_constant) -> begin
true
end
| (FStar_Syntax_Syntax.Delta_abstract (d), _65_52) -> begin
(delta_depth_greater_than d m)
end
| (_65_55, FStar_Syntax_Syntax.Delta_abstract (d)) -> begin
(delta_depth_greater_than l d)
end))

# 80 "FStar.TypeChecker.Common.fst"
let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth Prims.option = (fun _65_1 -> (match (_65_1) with
