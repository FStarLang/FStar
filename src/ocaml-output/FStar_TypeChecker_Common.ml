      ...
      let uu____621 =
        let uu____622 =
          ...
          let uu____624 =
            ...
            let uu____628 =
              let uu____631 = FStar_Syntax_Syntax.as_arg f  in [uu____631]
               in
  ...
  fun ty_map  ->
    fun db  ->
      fun info  ->
        ...
        let use_range =
          let uu___107_1137 = range  in
          {
            FStar_Range.def_range = (range.FStar_Range.use_range);
            FStar_Range.use_range = (uu___107_1137.FStar_Range.use_range)
          }  in
        let info1 =
          let uu___108_1139 = info  in
          let uu____1140 = ty_map info.identifier_ty  in
          {
            identifier = (uu___108_1139.identifier);
        ...
        fun range  ->
          let info =
            { identifier = id; identifier_ty = ty; identifier_range = range }
             in
          let uu___109_1298 = table  in
          {
            id_info_enabled = (uu___109_1298.id_info_enabled);
            id_info_db = (uu___109_1298.id_info_db);
...
let id_info_toggle : id_info_table -> Prims.bool -> id_info_table =
  fun table  ->
    fun enabled  ->
      let uu___110_1335 = table  in
      let uu____1336 = enabled && (FStar_Options.ide ())  in
      {
        id_info_enabled = uu____1336;
        id_info_db = (uu___110_1335.id_info_db);
        id_info_buffer = (uu___110_1335.id_info_buffer)
      }
