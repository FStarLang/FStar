...
let as_tprob : prob  ->  (FStar_Syntax_Syntax.typ, FStar_Syntax_Syntax.term) problem = (fun uu___123_567 -> (match (uu___123_567) with
| TProb (p) -> begin
p
end
| uu____577 -> begin
...
let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth FStar_Pervasives_Native.option = (fun uu___124_679 -> (match (uu___124_679) with
...
let rec aux = (fun out uu___125_1023 -> (match (uu___125_1023) with
| [] -> begin
out
end
| ((c, i))::rest -> begin
...
let uu___126_1159 = range
in {FStar_Range.def_range = range.FStar_Range.use_range; FStar_Range.use_range = uu___126_1159.FStar_Range.use_range})
in (

let info1 = (

let uu___127_1161 = info
in (

let uu____1162 = (ty_map info.identifier_ty)
in {identifier = uu___127_1161.identifier; identifier_ty = uu____1162; identifier_range = use_range}))
in (
...
let uu___128_1320 = table
in {id_info_enabled = uu___128_1320.id_info_enabled; id_info_db = uu___128_1320.id_info_db; id_info_buffer = (info)::table.id_info_buffer})))
