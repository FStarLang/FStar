...
let t_tactic_unit :
  ...
  let uu____351 =
    let uu____352 =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____353 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____354 =
    ...
    fun f  ->
      ...
      let tac1 =
        let uu____383 =
          ...
          let uu____385 =
            let uu____386 = FStar_Syntax_Syntax.as_arg tac  in [uu____386]
             in
...
let rec insert_col_info col info col_infos =
  ...
  | (c,i)::rest ->
      ...
      then (col, info) :: col_infos
        ...
        (let uu____490 = insert_col_info col info rest  in (c, i) ::
           uu____490)
  
let find_nearest_preceding_col_info col col_infos =
  let rec aux out uu___99_526 =
    match uu___99_526 with
    | [] -> out
  ...
  fun id  ->
    fun ty  ->
      fun range  ->
        ...
        let use_range =
          let uu___100_576 = range  in
          {
            FStar_Range.def_range = (range.FStar_Range.use_range);
            FStar_Range.use_range = (uu___100_576.FStar_Range.use_range)
          }  in
