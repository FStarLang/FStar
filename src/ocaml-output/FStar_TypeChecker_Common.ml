...
let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth FStar_Pervasives_Native.option = (fun uu___103_657 -> (match (uu___103_657) with
...
let rec aux = (fun out uu___104_1001 -> (match (uu___104_1001) with
| [] -> begin
out
end
| ((c, i))::rest -> begin
...
let uu___105_1137 = range
in {FStar_Range.def_range = range.FStar_Range.use_range; FStar_Range.use_range = uu___105_1137.FStar_Range.use_range})
in (

let info1 = (

let uu___106_1139 = info
in (

let uu____1140 = (ty_map info.identifier_ty)
in {identifier = uu___106_1139.identifier; identifier_ty = uu____1140; identifier_range = use_range}))
in (
...
let uu___107_1298 = table
in {id_info_enabled = uu___107_1298.id_info_enabled; id_info_db = uu___107_1298.id_info_db; id_info_buffer = (info)::table.id_info_buffer})))
