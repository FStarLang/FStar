...
let tabbrev : FStar_Ident.lident  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun l -> (let _145_87 = (let _145_86 = (FStar_Syntax_Syntax.lid_as_fv l (FStar_Syntax_Syntax.Delta_unfoldable ((Prims.parse_int "1"))) None)
in FStar_Syntax_Syntax.Tm_fvar (_145_86))
in (FStar_Syntax_Syntax.mk _145_87 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Delta_unfoldable (_145_94) when (_145_94 = (Prims.parse_int "1")) -> begin
