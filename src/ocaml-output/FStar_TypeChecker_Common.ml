...
let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth Prims.option = (fun uu___99_420 -> (match (uu___99_420) with
...
let rec aux = (fun out uu___100_526 -> (match (uu___100_526) with
| [] -> begin
out
end
| ((c, i))::rest -> begin
...
let uu___101_576 = range
in {FStar_Range.def_range = range.FStar_Range.use_range; FStar_Range.use_range = uu___101_576.FStar_Range.use_range})
in (
