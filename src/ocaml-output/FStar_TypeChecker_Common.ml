...
let find_nearest_preceding_col_info :
  ...
  fun col  ->
    fun col_infos  ->
      let rec aux out uu___27_967 =
        match uu___27_967 with
        | [] -> out
        | (c,i)::rest ->
            if c > col
            then out
    ...
    fun db  ->
      fun info  ->
        ...
        let info1 =
          ...
          {
            identifier = (uu___28_1099.identifier);
    ...
    fun id1  ->
      fun ty  ->
        fun range  ->
          ...
          {
            id_info_enabled = (uu___29_1254.id_info_enabled);
            id_info_db = (uu___29_1254.id_info_db);
  ...
  fun table  ->
    fun enabled  ->
      ...
      let uu____1284 = enabled && (FStar_Options.ide ())  in
      {
        ...
        id_info_db = (uu___30_1283.id_info_db);
        id_info_buffer = (uu___30_1283.id_info_buffer)
      }
    ...
    fun ty_map  ->
      ...
      let uu____1297 =
        FStar_List.fold_left (id_info__insert ty_map) table.id_info_db
         ...
         in
      {
        id_info_enabled = (uu___31_1296.id_info_enabled);
