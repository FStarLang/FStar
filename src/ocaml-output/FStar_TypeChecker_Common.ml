...
let (mk_by_tactic :
  ...
  fun tac ->
    fun f ->
      ...
      let uu____661 =
        let uu____666 =
          let uu____667 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
          let uu____676 =
            let uu____687 = FStar_Syntax_Syntax.as_arg tac in
            let uu____696 =
              let uu____707 = FStar_Syntax_Syntax.as_arg f in [uu____707] in
      ...
      fun info ->
        ...
        | (row, col) ->
            ...
            let uu____1457 =
              ...
              FStar_All.pipe_right uu____1467 (FStar_Util.pimap_add rows row) in
