...
let is_inr uu___179_173 =
  match uu___179_173 with
                 ...
                 (fun lb  ->
                    ...
                    | (us,td) ->
                        ...
                        (match uu____1313 with
                         | (t,d) ->
                             let uu___189_1385 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___189_1385.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs = us;
                               FStar_Syntax_Syntax.lbtyp = t;
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___189_1385.FStar_Syntax_Syntax.lbeff);
