...
let pats = (let _134_133 = (FStar_All.pipe_right ps (FStar_List.map (fun args -> (let _134_132 = (FStar_All.pipe_right args (FStar_List.map (fun _39_242 -> (match (_39_242) with
| (t, _39_241) -> begin
(term_to_string t)
end))))
...
| FStar_Syntax_Syntax.Tm_ascribed (e, FStar_Util.Inl (t), _39_319) -> begin
(let _134_164 = (term_to_string e)
in (let _134_163 = (term_to_string t)
in (FStar_Util.format2 "(%s <: %s)" _134_164 _134_163)))
end
| FStar_Syntax_Syntax.Tm_ascribed (e, FStar_Util.Inr (c), _39_326) -> begin
...
in (let _134_173 = (let _134_172 = (FStar_All.pipe_right branches (FStar_List.map (fun _39_336 -> (match (_39_336) with
| (p, wopt, e) -> begin
...
in (let _134_180 = (let _134_179 = (FStar_List.map (fun _39_353 -> (match (_39_353) with
| (x, b) -> begin
(
...
| FStar_Syntax_Syntax.Pat_dot_term (x, _39_357) -> begin
...
let _39_373 = (let _134_192 = (FStar_Syntax_Util.mk_conj lb.FStar_Syntax_Syntax.lbtyp lb.FStar_Syntax_Syntax.lbdef)
in (FStar_Syntax_Subst.open_univ_vars lb.FStar_Syntax_Syntax.lbunivs _134_192))
in (match (_39_373) with
| (us, td) -> begin
(

let _39_391 = (match ((let _134_193 = (FStar_Syntax_Subst.compress td)
in _134_193.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (_39_375, ((t, _39_382))::((d, _39_378))::[]) -> begin
((t), (d))
end
| _39_388 -> begin
...
let _39_392 = lb
in {FStar_Syntax_Syntax.lbname = _39_392.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _39_392.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = d})
end))
end)))))
...
| FStar_Syntax_Syntax.Total (t, _39_428) -> begin
(match ((let _134_230 = (FStar_Syntax_Subst.compress t)
in _134_230.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (_39_432) when (not ((FStar_Options.print_implicits ()))) -> begin
(term_to_string t)
end
| _39_435 -> begin
...
| FStar_Syntax_Syntax.GTotal (t, _39_438) -> begin
(match ((let _134_232 = (FStar_Syntax_Subst.compress t)
in _134_232.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (_39_442) when (not ((FStar_Options.print_implicits ()))) -> begin
(term_to_string t)
end
| _39_445 -> begin
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme  ->  Prims.string = (fun _39_467 -> (match (_39_467) with
| (us, t) -> begin
...
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (None), _39_477) -> begin
"#reset-options"
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (Some (s)), _39_484) -> begin
(FStar_Util.format1 "#reset-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions (s), _39_490) -> begin
(FStar_Util.format1 "#set-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, univs, tps, k, _39_498, _39_500, quals, _39_503) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (lid, univs, t, _39_510, _39_512, _39_514, _39_516, _39_518) -> begin
if (FStar_Options.print_universes ()) then begin
(

let _39_523 = (FStar_Syntax_Subst.open_univ_vars univs t)
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, univs, t, quals, _39_529) -> begin
(

let _39_534 = (FStar_Syntax_Subst.open_univ_vars univs t)
...
| FStar_Syntax_Syntax.Sig_assume (lid, f, _39_538, _39_540) -> begin
(let _134_319 = (term_to_string f)
in (FStar_Util.format2 "val %s : %s" lid.FStar_Ident.str _134_319))
end
| FStar_Syntax_Syntax.Sig_let (lbs, _39_545, _39_547, qs) -> begin
(lbs_to_string qs lbs)
end
| FStar_Syntax_Syntax.Sig_main (e, _39_553) -> begin
(let _134_320 = (term_to_string e)
in (FStar_Util.format1 "let _ = %s" _134_320))
end
| FStar_Syntax_Syntax.Sig_bundle (ses, _39_558, _39_560, _39_562) -> begin
(let _134_321 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right _134_321 (FStar_String.concat "\n")))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed, _39_567) -> begin
(eff_decl_to_string false ed)
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed, _39_572) -> begin
...
| (Some (lift_wp), _39_585) -> begin
lift_wp
end
| (_39_588, Some (lift)) -> begin
lift
end)
in (

let _39_595 = (FStar_Syntax_Subst.open_univ_vars (Prims.fst lift_wp) (Prims.snd lift_wp))
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (l, univs, tps, c, _39_601, _39_603) -> begin
if (FStar_Options.print_universes ()) then begin
(

let _39_608 = (let _134_326 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None FStar_Range.dummyRange)
in (FStar_Syntax_Subst.open_univ_vars univs _134_326))
in (match (_39_608) with
| (univs, t) -> begin
(

let _39_617 = (match ((let _134_327 = (FStar_Syntax_Subst.compress t)
