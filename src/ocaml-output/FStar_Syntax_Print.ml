...
let rec univ_to_string : FStar_Syntax_Syntax.universe -> Prims.string =
  fun u  ->
    let uu____914 =
      let uu____915 = FStar_Options.ugly ()  in Prims.op_Negation uu____915
       in
    if uu____914
    then
...
let quals_to_string' :
  ...
  fun quals  ->
    ...
    | [] -> ""
    | uu____1074 ->
        let uu____1077 = quals_to_string quals  in
        Prims.strcat uu____1077 " "
  
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____1133 =
      let uu____1134 = FStar_Options.ugly ()  in Prims.op_Negation uu____1134
       in
    if uu____1133
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1251  ->
                                 ...
                                 | (t1,uu____1257) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1552
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1647 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1649
                              in
                           let uu____1650 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1646
                             uu____1647 uu____1650))
                in
             FStar_Util.concat_l "\n\t|" uu____1594  in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1663 =
      let uu____1664 = FStar_Options.ugly ()  in Prims.op_Negation uu____1664
       in
    if uu____1663
    then
                 ...
                 (fun lb  ->
                    let uu____1773 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1778
                       in
                    ...
                    | (us,td) ->
                        ...
                        (match uu____1781 with
                         | (t,d) ->
                             let uu___215_1868 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___215_1868.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs = us;
                               FStar_Syntax_Syntax.lbtyp = t;
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___215_1868.FStar_Syntax_Syntax.lbeff);
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____1998 =
      let uu____1999 = FStar_Options.ugly ()  in Prims.op_Negation uu____1999
       in
    if uu____1998
    then
               ...
               let uu____2064 =
                 let uu____2065 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                    ...
                    in
                 FStar_All.pipe_right uu____2065 (FStar_String.concat ", ")
                  in
               let uu____2086 =
                 let uu____2087 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    in
                 FStar_All.pipe_right uu____2087 (FStar_String.concat " ")
                  in
           ...
           let dec =
             let uu____2128 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                 (FStar_List.collect
                    (fun uu___213_2138  ->
                       match uu___213_2138 with
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2144 =
                             let uu____2145 = term_to_string e  in
                             FStar_Util.format1 " (decreases %s)" uu____2145
                              in
                           [uu____2144]
                       | uu____2146 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____2166 =
      let uu____2167 = FStar_Options.ugly ()  in Prims.op_Negation uu____2167
       in
    if uu____2166
    then
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____2322 =
      let uu____2323 = FStar_Options.ugly ()  in Prims.op_Negation uu____2323
       in
    if uu____2322
    then
