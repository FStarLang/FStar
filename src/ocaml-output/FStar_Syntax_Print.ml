  ...
  fun x ->
    let basic =
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) ->
          let uu____4040 = quals_to_string' x.FStar_Syntax_Syntax.sigquals in
          let uu____4042 =
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect se ->
          ...
          (match uu____4156 with
           | (us, t) ->
               let uu____4168 = lid_to_string se.FStar_Syntax_Syntax.source in
               let uu____4170 = lid_to_string se.FStar_Syntax_Syntax.target in
      ...
      | FStar_Syntax_Syntax.Sig_splice (lids, t) ->
          let uu____4279 =
            let uu____4281 = FStar_List.map FStar_Ident.string_of_lid lids in
            FStar_All.pipe_left (FStar_String.concat "; ") uu____4281 in
          let uu____4291 = term_to_string t in
          FStar_Util.format2 "splice[%s] (%s)" uu____4279 uu____4291 in
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____4326,
          { FStar_Syntax_Syntax.lbname = lb;
            ...
            FStar_Syntax_Syntax.lbpos = uu____4333;_}::[]),
         uu____4334)
        ->
