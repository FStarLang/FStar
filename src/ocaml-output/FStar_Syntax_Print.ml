...
let is_inr = (fun uu___182_173 -> (match (uu___182_173) with
...
let filter_imp = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___183_208 -> (match (uu___183_208) with
...
let lbname_to_string : FStar_Syntax_Syntax.lbname  ->  Prims.string = (fun uu___184_448 -> (match (uu___184_448) with
...
let qual_to_string : FStar_Syntax_Syntax.qualifier  ->  Prims.string = (fun uu___185_701 -> (match (uu___185_701) with
...
let uu___192_1385 = lb
in {FStar_Syntax_Syntax.lbname = uu___192_1385.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = uu___192_1385.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = d})
end))
end)))))
...
and imp_to_string : Prims.string  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option  ->  Prims.string = (fun s uu___186_1416 -> (match (uu___186_1416) with
...
and arg_to_string : (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  Prims.string = (fun uu___187_1464 -> (match (uu___187_1464) with
| (a, imp) -> begin
(
...
let uu____1544 = ((FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___188_1546 -> (match (uu___188_1546) with
...
in (not (uu____1556))) && (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___189_1558 -> (match (uu___189_1558) with
...
let uu____1565 = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.collect (fun uu___190_1569 -> (match (uu___190_1569) with
...
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.LightOff, uu____1684) -> begin
"#light \"off\""
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (None), uu____1685) -> begin
"#reset-options"
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (Some (s)), uu____1687) -> begin
(FStar_Util.format1 "#reset-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions (s), uu____1689) -> begin
(FStar_Util.format1 "#set-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.LightOff, uu____1690) -> begin
"#light \"off\""
end
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, univs, tps, k, uu____1695, uu____1696, quals, uu____1698) -> begin
(

let uu____1705 = (quals_to_string' quals)
in (

let uu____1706 = (binders_to_string " " tps)
in (

let uu____1707 = (term_to_string k)
in (FStar_Util.format4 "%stype %s %s : %s" uu____1705 lid.FStar_Ident.str uu____1706 uu____1707))))
end
| FStar_Syntax_Syntax.Sig_datacon (lid, univs, t, uu____1711, uu____1712, uu____1713, uu____1714, uu____1715) -> begin
(
...
let uu____1721 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (uu____1721) with
| (univs1, t1) -> begin
(

let uu____1726 = (univ_names_to_string univs1)
in (

let uu____1727 = (term_to_string t1)
in (FStar_Util.format3 "datacon<%s> %s : %s" uu____1726 lid.FStar_Ident.str uu____1727)))
end))
end
| uu____1728 -> begin
(

let uu____1729 = (term_to_string t)
in (FStar_Util.format2 "datacon %s : %s" lid.FStar_Ident.str uu____1729))
end))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, univs, t, quals, uu____1734) -> begin
(

let uu____1737 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (uu____1737) with
| (univs1, t1) -> begin
(

let uu____1742 = (quals_to_string' quals)
in (

let uu____1743 = (

let uu____1744 = (FStar_Options.print_universes ())
in (match (uu____1744) with
| true -> begin
(

let uu____1745 = (univ_names_to_string univs1)
in (FStar_Util.format1 "<%s>" uu____1745))
end
| uu____1746 -> begin
""
end))
...
let uu____1747 = (term_to_string t1)
in (FStar_Util.format4 "%sval %s %s : %s" uu____1742 lid.FStar_Ident.str uu____1743 uu____1747))))
end))
end
| FStar_Syntax_Syntax.Sig_assume (lid, f, uu____1750, uu____1751) -> begin
(

let uu____1754 = (term_to_string f)
in (FStar_Util.format2 "val %s : %s" lid.FStar_Ident.str uu____1754))
end
| FStar_Syntax_Syntax.Sig_let (lbs, uu____1756, uu____1757, qs, uu____1759) -> begin
(lbs_to_string qs lbs)
end
| FStar_Syntax_Syntax.Sig_main (e, uu____1767) -> begin
(

let uu____1768 = (term_to_string e)
in (FStar_Util.format1 "let _ = %s" uu____1768))
end
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____1770, uu____1771, uu____1772) -> begin
(

let uu____1779 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right uu____1779 (FStar_String.concat "\n")))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed, uu____1783) -> begin
(eff_decl_to_string false ed)
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed, uu____1785) -> begin
...
| (Some (lift_wp), uu____1794) -> begin
lift_wp
end
| (uu____1798, Some (lift)) -> begin
lift
end)
in (

let uu____1803 = (FStar_Syntax_Subst.open_univ_vars (Prims.fst lift_wp) (Prims.snd lift_wp))
in (match (uu____1803) with
| (us, t) -> begin
(

let uu____1810 = (lid_to_string se.FStar_Syntax_Syntax.source)
in (

let uu____1811 = (lid_to_string se.FStar_Syntax_Syntax.target)
in (

let uu____1812 = (univ_names_to_string us)
in (

let uu____1813 = (term_to_string t)
in (FStar_Util.format4 "sub_effect %s ~> %s : <%s> %s" uu____1810 uu____1811 uu____1812 uu____1813)))))
end)))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (l, univs, tps, c, uu____1818, flags, uu____1820) -> begin
(

let uu____1825 = (FStar_Options.print_universes ())
...
let uu____1829 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c))))) None FStar_Range.dummyRange)
in (FStar_Syntax_Subst.open_univ_vars univs uu____1829))
...
let uu____1849 = (FStar_Syntax_Subst.compress t)
...
let uu____1896 = (sli l)
in (

let uu____1897 = (univ_names_to_string univs1)
in (

let uu____1898 = (binders_to_string " " tps1)
in (

let uu____1899 = (comp_to_string c1)
in (FStar_Util.format4 "effect %s<%s> %s = %s" uu____1896 uu____1897 uu____1898 uu____1899)))))
end))
end))
end
| uu____1900 -> begin
...
let uu____1901 = (sli l)
in (

let uu____1902 = (binders_to_string " " tps)
in (

let uu____1903 = (comp_to_string c)
in (FStar_Util.format3 "effect %s %s = %s" uu____1901 uu____1902 uu____1903))))
end))
end))
...
let uu____1910 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "%s: %s\n" uu____1910 msg)))


let rec sigelt_to_string_short : FStar_Syntax_Syntax.sigelt  ->  Prims.string = (fun x -> (match (x) with
| FStar_Syntax_Syntax.Sig_let ((uu____1914, ({FStar_Syntax_Syntax.lbname = lb; FStar_Syntax_Syntax.lbunivs = uu____1916; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = uu____1918; FStar_Syntax_Syntax.lbdef = uu____1919})::[]), uu____1920, uu____1921, uu____1922, uu____1923) -> begin
(

let uu____1941 = (lbname_to_string lb)
in (

let uu____1942 = (term_to_string t)
in (FStar_Util.format2 "let %s : %s" uu____1941 uu____1942)))
end
| uu____1943 -> begin
(

let uu____1944 = (FStar_All.pipe_right (FStar_Syntax_Util.lids_of_sigelt x) (FStar_List.map (fun l -> l.FStar_Ident.str)))
in (FStar_All.pipe_right uu____1944 (FStar_String.concat ", ")))
end))


let rec modul_to_string : FStar_Syntax_Syntax.modul  ->  Prims.string = (fun m -> (

let uu____1953 = (sli m.FStar_Syntax_Syntax.name)
in (

let uu____1954 = (

let uu____1955 = (FStar_List.map sigelt_to_string m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right uu____1955 (FStar_String.concat "\n")))
in (FStar_Util.format2 "module %s\n%s" uu____1953 uu____1954))))


let subst_elt_to_string : FStar_Syntax_Syntax.subst_elt  ->  Prims.string = (fun uu___191_1960 -> (match (uu___191_1960) with
...
in (FStar_Util.format2 "DB (%s, %s)" uu____1963 uu____1964)))
end
| FStar_Syntax_Syntax.NM (x, i) -> begin
(

let uu____1967 = (bv_to_string x)
in (

let uu____1968 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "NM (%s, %s)" uu____1967 uu____1968)))
end
| FStar_Syntax_Syntax.NT (x, t) -> begin
(

let uu____1975 = (bv_to_string x)
in (

let uu____1976 = (term_to_string t)
in (FStar_Util.format2 "DB (%s, %s)" uu____1975 uu____1976)))
end
| FStar_Syntax_Syntax.UN (i, u) -> begin
(

let uu____1979 = (FStar_Util.string_of_int i)
in (

let uu____1980 = (univ_to_string u)
in (FStar_Util.format2 "UN (%s, %s)" uu____1979 uu____1980)))
end
| FStar_Syntax_Syntax.UD (u, i) -> begin
(

let uu____1983 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "UD (%s, %s)" u.FStar_Ident.idText uu____1983))
end))


let subst_to_string : FStar_Syntax_Syntax.subst_t  ->  Prims.string = (fun s -> (

let uu____1987 = (FStar_All.pipe_right s (FStar_List.map subst_elt_to_string))
in (FStar_All.pipe_right uu____1987 (FStar_String.concat "; "))))
...
let uu____2037 = (f x)
in (FStar_Util.string_builder_append strb uu____2037));
(FStar_List.iter (fun x1 -> ((FStar_Util.string_builder_append strb "; ");
(

let uu____2041 = (f x1)
in (FStar_Util.string_builder_append strb uu____2041));
)) xs);
...
let uu____2070 = (f x)
in (FStar_Util.string_builder_append strb uu____2070));
(FStar_List.iter (fun x1 -> ((FStar_Util.string_builder_append strb ", ");
(

let uu____2074 = (f x1)
in (FStar_Util.string_builder_append strb uu____2074));
)) xs);
(FStar_Util.string_builder_append strb "}");
(FStar_Util.string_of_string_builder strb);
))
