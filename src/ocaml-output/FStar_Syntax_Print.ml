...
let rec delta_depth_to_string : FStar_Syntax_Syntax.delta_depth -> Prims.string =
  fun uu___66_3 ->
    ...
    | FStar_Syntax_Syntax.Delta_abstract d ->
        let uu____7 =
          let uu____8 = delta_depth_to_string d in
          Prims.strcat uu____8 ")"
        in
...
let sli : FStar_Ident.lident -> Prims.string =
  fun l ->
    ...
    if uu____12 then l.FStar_Ident.str
...
let fv_to_string : FStar_Syntax_Syntax.fv -> Prims.string =
  fun fv -> lid_to_string fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
...
let nm_to_string : FStar_Syntax_Syntax.bv -> Prims.string =
  fun bv ->
    ...
    if uu____28 then bv_to_string bv
...
let is_infix_prim_op : FStar_Syntax_Syntax.term -> Prims.bool =
  fun e ->
    is_prim_op
      (FStar_Pervasives_Native.fst (FStar_List.split infix_prim_ops))
      e
...
let is_unary_prim_op : FStar_Syntax_Syntax.term -> Prims.bool =
  fun e ->
    is_prim_op
      (FStar_Pervasives_Native.fst (FStar_List.split unary_prim_ops))
      e
...
let is_quant : FStar_Syntax_Syntax.typ -> Prims.bool =
  fun t -> is_prim_op (FStar_Pervasives_Native.fst (FStar_List.split quants)) t
...
let is_inr:
      'Auu____232 'Auu____233. ('Auu____233, 'Auu____232) FStar_Util.either
      -> Prims.bool =
  fun uu___67_241 ->
...
let filter_imp:
  ...
  fun a ->
    FStar_All.pipe_right a
      (FStar_List.filter (fun uu___68_304 ->
           match uu___68_304 with
           | ( uu____311
             , FStar_Pervasives_Native.Some
                 FStar_Syntax_Syntax.Implicit uu____312 ) ->
               false
           | uu____315 -> true ))
...
let rec reconstruct_lex
  ...
  fun e ->
    let uu____331 =
      ...
      uu____332.FStar_Syntax_Syntax.n
    in
    ...
    | FStar_Syntax_Syntax.Tm_app (f, args) ->
        ...
        let uu____395 =
          is_lex_cons f && FStar_List.length exps = Prims.parse_int "2"
        in
        if uu____395 then
          let uu____404 =
            let uu____411 = FStar_List.nth exps (Prims.parse_int "1") in
            reconstruct_lex uu____411
          in
    ...
    | uu____458 ->
        ...
        if uu____459 then FStar_Pervasives_Native.Some []
        else FStar_Pervasives_Native.None
...
let rec find: 'a. ('a -> Prims.bool) -> 'a Prims.list -> 'a =
  fun f l ->
    ...
    | [] -> failwith "blah"
    | hd1 :: tl1 ->
        let uu____503 = f hd1 in
        if uu____503 then hd1 else find f tl1
...
let infix_prim_op_to_string
  ...
  fun e ->
    let uu____545 = get_lid e in
    find_lid uu____545 infix_prim_ops


let unary_prim_op_to_string
    : FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax -> Prims.string =
  fun e ->
    let uu____553 = get_lid e in
    find_lid uu____553 unary_prim_ops


let quant_to_string
    : FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax -> Prims.string =
  fun t ->
    let uu____561 = get_lid t in
    find_lid uu____561 quants
  ...
  fun u ->
    ...
    if uu____573 then "?"
      ...
      let uu____575 =
        ...
        FStar_All.pipe_right uu____576 FStar_Util.string_of_int
      in
  ...
  fun u ->
    ...
    if uu____585 then "?"
      ...
      let uu____587 =
        ...
        in
        Prims.strcat uu____588 uu____590
      in
...
let rec univ_to_string : FStar_Syntax_Syntax.universe -> Prims.string =
  fun u ->
    let uu____624 =
      let uu____625 = FStar_Options.ugly () in
      Prims.op_Negation uu____625
    in
    if uu____624 then
      ...
      | FStar_Syntax_Syntax.U_max us ->
          let uu____662 =
            ...
            FStar_All.pipe_right uu____663 (FStar_String.concat ", ")
          in
  ...
  fun uu___70_696 ->
    ...
    | FStar_Syntax_Syntax.RecordType (ns, fns) ->
        let uu____712 =
          ...
          FStar_Ident.text_of_path uu____713
        in
        let uu____716 =
          let uu____717 =
            FStar_All.pipe_right fns (FStar_List.map FStar_Ident.text_of_id)
          in
          FStar_All.pipe_right uu____717 (FStar_String.concat ", ")
        in
        FStar_Util.format2 "(RecordType %s %s)" uu____712 uu____716
    | FStar_Syntax_Syntax.RecordConstructor (ns, fns) ->
        let uu____736 =
          let uu____737 = FStar_Ident.path_of_ns ns in
          FStar_Ident.text_of_path uu____737
        in
        let uu____740 =
          let uu____741 =
            FStar_All.pipe_right fns (FStar_List.map FStar_Ident.text_of_id)
...
let quals_to_string : FStar_Syntax_Syntax.qualifier Prims.list -> Prims.string =
  fun quals ->
    ...
    | uu____760 ->
        let uu____763 =
          FStar_All.pipe_right quals (FStar_List.map qual_to_string)
        in
...
let quals_to_string' : FStar_Syntax_Syntax.qualifier Prims.list -> Prims.string =
  fun quals ->
    ...
    | [] -> ""
    | uu____779 ->
        let uu____782 = quals_to_string quals in
        Prims.strcat uu____782 " "
...
let rec tag_of_term : FStar_Syntax_Syntax.term -> Prims.string =
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let uu____848 = db_to_string x in
        Prims.strcat "Tm_bvar: " uu____848
    | FStar_Syntax_Syntax.Tm_name x ->
        let uu____850 = nm_to_string x in
        Prims.strcat "Tm_name: " uu____850
...
and term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x ->
    let uu____1105 =
      let uu____1106 = FStar_Options.ugly () in
      Prims.op_Negation uu____1106
    in
    if uu____1105 then
      ...
      let x2 =
        ...
        if uu____1112 then x1 else FStar_Syntax_Util.unmeta x1
      in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_pattern ps) ->
          let pats =
            let uu____1175 =
              FStar_All.pipe_right ps
                (FStar_List.map (fun args ->
                     let uu____1205 =
                       FStar_All.pipe_right args
                         (FStar_List.map (fun uu____1223 ->
                              match uu____1223 with t1, uu____1229 ->
                                term_to_string t1 ))
                     in
                     FStar_All.pipe_right uu____1205 (FStar_String.concat "; ")
                 ))
            in
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          FStar_Util.format3 "Meta_labeled(%s, %s){%s}" l uu____1287 uu____1288
      ...
      | FStar_Syntax_Syntax.Tm_bvar x3 ->
          ...
          let uu____1307 =
            let uu____1308 =
              ...
              Prims.strcat uu____1309 ")"
            in
            Prims.strcat ":(" uu____1308
          in
      ...
      | FStar_Syntax_Syntax.Tm_abs (bs, t2, lc) -> (
        match lc with
        | FStar_Pervasives_Native.Some rc when FStar_Options.print_implicits () ->
            let uu____1387 = binders_to_string " " bs in
            let uu____1388 = term_to_string t2 in
            let uu____1389 =
              if FStar_Option.isNone rc.FStar_Syntax_Syntax.residual_typ then
                "None"
              else
                let uu____1393 =
            ...
            FStar_Util.format4 "(fun %s -> (%s $$ (residual) %s %s))"
              ...
              rc.FStar_Syntax_Syntax.residual_effect.FStar_Ident.str uu____1389
        | uu____1396 ->
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (e, (annot, topt), eff_name) ->
          let annot1 =
            ...
            | FStar_Util.Inl t ->
                let uu____1518 =
                  let uu____1519 =
                    FStar_Util.map_opt eff_name FStar_Ident.text_of_lid
                  in
                  FStar_All.pipe_right uu____1519 (FStar_Util.dflt "default")
                in
                let uu____1524 = term_to_string t in
                FStar_Util.format2 "[%s] %s" uu____1518 uu____1524
            | FStar_Util.Inr c -> comp_to_string c
          in
          let topt1 =
            match topt with
          ...
          let uu____1581 =
            let uu____1582 =
              FStar_All.pipe_right branches
                (FStar_List.map (fun uu____1618 ->
                     match uu____1618 with p, wopt, e ->
                       let uu____1634 = FStar_All.pipe_right p pat_to_string in
                       let uu____1635 =
                         match wopt with
                         | FStar_Pervasives_Native.None -> ""
                         | FStar_Pervasives_Native.Some w ->
                             let uu____1637 =
                               FStar_All.pipe_right w term_to_string
                             in
                       ...
                       in
                       FStar_Util.format3 "%s %s -> %s" uu____1634 uu____1635
                         uu____1638 ))
            in
            FStar_Util.concat_l "\n\t|" uu____1582
          in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x ->
    let uu____1651 =
      let uu____1652 = FStar_Options.ugly () in
      Prims.op_Negation uu____1652
    in
    if uu____1651 then
      ...
      | FStar_Syntax_Syntax.Pat_cons (l, pats) ->
          ...
          let uu____1675 =
            let uu____1676 =
              FStar_List.map
                (fun uu____1687 ->
                  match uu____1687 with x1, b ->
                    let p = pat_to_string x1 in
                    if b then Prims.strcat "#" p else p )
                pats
            in
            FStar_All.pipe_right uu____1676 (FStar_String.concat " ")
          in
      ...
      let uu____1731 =
        FStar_All.pipe_right
          ...
          (FStar_List.map (fun lb ->
               let uu____1747 =
                 attrs_to_string lb.FStar_Syntax_Syntax.lbattrs
               in
               let uu____1748 =
                 lbname_to_string lb.FStar_Syntax_Syntax.lbname
               in
               let uu____1749 =
                 ...
                 if uu____1750 then
                   let uu____1751 =
                     ...
                     in
                     Prims.strcat uu____1752 ">"
                   in
                   Prims.strcat "<" uu____1751
                 else ""
               in
               let uu____1754 = term_to_string lb.FStar_Syntax_Syntax.lbtyp in
               let uu____1755 =
                 FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbdef
                   term_to_string
               in
               FStar_Util.format5 "%s%s %s : %s = %s" uu____1747 uu____1748
                 uu____1749 uu____1754 uu____1755 ))
      in
      FStar_Util.concat_l "\n and " uu____1731
    in
    FStar_Util.format3 "%slet %s %s" uu____1729
      (if FStar_Pervasives_Native.fst lbs then "rec" else "")
      uu____1730
...
and imp_to_string : Prims.string -> FStar_Syntax_Syntax.aqual -> Prims.string =
  fun s aq ->
    let uu____1787 = aqual_to_string aq in
    Prims.strcat uu____1787 s
...
and binder_to_string'
  ...
  fun is_arrow b ->
    ...
    if uu____1790 then
      let uu____1792 =
        FStar_Syntax_Resugar.resugar_binder b FStar_Range.dummyRange
      in
        ...
        if uu____1801 then
          ...
          if uu____1804 then
            ...
            let uu____1809 =
              ...
              let uu____1811 =
                let uu____1812 = term_to_string a.FStar_Syntax_Syntax.sort in
                Prims.strcat ":" uu____1812
              in
              Prims.strcat uu____1810 uu____1811
            in
...
and binders_to_string
  ...
  fun sep bs ->
    let bs1 =
      ...
      if uu____1818 then bs else filter_imp bs
    in
    if sep = " -> " then
      let uu____1820 =
      ...
      let uu____1828 =
        FStar_All.pipe_right bs1 (FStar_List.map binder_to_string)
      in
...
and arg_to_string
    : ( FStar_Syntax_Syntax.term
      ...
      FStar_Pervasives_Native.tuple2 -> Prims.string =
  fun uu___73_1835 ->
    match uu___73_1835 with a, imp ->
      let uu____1842 = term_to_string a in
      imp_to_string uu____1842 imp
...
and args_to_string : FStar_Syntax_Syntax.args -> Prims.string =
  fun args ->
    let args1 =
      ...
      if uu____1845 then args else filter_imp args
    in
    let uu____1849 =
      FStar_All.pipe_right args1 (FStar_List.map arg_to_string)
    in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c ->
    let uu____1861 =
      let uu____1862 = FStar_Options.ugly () in
      Prims.op_Negation uu____1862
    in
    if uu____1861 then
      ...
      | FStar_Syntax_Syntax.Total (t, uopt) -> (
          let uu____1876 =
            ...
            uu____1877.FStar_Syntax_Syntax.n
          in
          match uu____1876 with
          | FStar_Syntax_Syntax.Tm_type uu____1880
            when let uu____1881 =
                   FStar_Options.print_implicits ()
                   || FStar_Options.print_universes ()
                 in
                 Prims.op_Negation uu____1881 ->
              term_to_string t
          | uu____1882 ->
            match uopt with
            | FStar_Pervasives_Native.Some u
              when FStar_Options.print_universes () ->
      ...
      | FStar_Syntax_Syntax.GTotal (t, uopt) -> (
          let uu____1900 =
            ...
            uu____1901.FStar_Syntax_Syntax.n
          in
          match uu____1900 with
          | FStar_Syntax_Syntax.Tm_type uu____1904
            when let uu____1905 =
                   FStar_Options.print_implicits ()
                   || FStar_Options.print_universes ()
                 in
                 Prims.op_Negation uu____1905 ->
              term_to_string t
          | uu____1906 ->
            match uopt with
            | FStar_Pervasives_Native.Some u
      ...
      | FStar_Syntax_Syntax.Comp c1 ->
          let basic =
            ...
            if uu____1916 then
              ...
              let uu____1958 =
                FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                  (FStar_Util.for_some (fun uu___74_1962 ->
              ...
              if uu____1958 then
                ...
                if uu____1968 then
                  ...
                  let uu____1975 =
                    ...
                    && FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                         (FStar_Util.for_some (fun uu___75_1982 ->
                  ...
                  if uu____1975 then
                    ...
                    let uu____1986 = sli c1.FStar_Syntax_Syntax.effect_name in
                    let uu____1987 =
                      term_to_string c1.FStar_Syntax_Syntax.result_typ
                    in
          ...
          let dec =
            let uu____1989 =
              FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                (FStar_List.collect (fun uu___76_1999 ->
          ...
          let uu____2030 =
            FStar_All.pipe_right ps
              (FStar_List.map (fun args ->
                   let uu____2060 =
                     FStar_All.pipe_right args
                       (FStar_List.map (fun uu____2078 ->
                            match uu____2078 with t, uu____2084 ->
                              term_to_string t ))
                   in
...
let binder_to_json : FStar_Syntax_Syntax.binder -> FStar_Util.json =
  fun b ->
    let uu____2125 = b in
    match uu____2125 with a, imp ->
      let n1 =
        let uu____2129 = FStar_Syntax_Syntax.is_null_binder b in
        if uu____2129 then FStar_Util.JsonNull
        else
          let uu____2131 =
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s ->
    let uu____2161 =
      let uu____2162 = FStar_Options.ugly () in
      Prims.op_Negation uu____2162
    in
    if uu____2161 then
      ...
      let uu____2166 = s in
      match uu____2166 with us, t ->
        let uu____2173 =
          let uu____2174 = univ_names_to_string us in
          FStar_All.pipe_left enclose_universes uu____2174
        in
...
let action_to_string : FStar_Syntax_Syntax.action -> Prims.string =
  fun a ->
    ...
    let uu____2181 =
      ...
      in
      FStar_All.pipe_left enclose_universes uu____2182
    in
        ...
        let uu____2226 =
          ...
          let uu____2230 =
            let uu____2233 =
              ...
              in
              FStar_All.pipe_left enclose_universes uu____2234
            in
            let uu____2235 =
              let uu____2238 =
                    ...
                    let uu____2251 =
                      ...
                      let uu____2255 =
                        ...
                        let uu____2259 =
                          ...
                          let uu____2263 =
                            let uu____2266 =
                              tscheme_to_string ed.FStar_Syntax_Syntax.close_wp
                            in
                            let uu____2267 =
                              let uu____2270 =
                                tscheme_to_string
                              ...
                              let uu____2271 =
                                ...
                                let uu____2275 =
                                  ...
                                  let uu____2279 =
                                    ...
                                    in
                                    uu____2282 :: uu____2283
                                  in
                                  uu____2278 :: uu____2279
                                in
                                uu____2274 :: uu____2275
                              in
                              uu____2270 :: uu____2271
                            in
          ...
          in
          uu____2229 :: uu____2230
        in
        (if for_free then "_for_free " else "") :: uu____2226
      in
      FStar_Util.format
...
let eff_decl_to_string
  ...
  fun for_free ed -> eff_decl_to_string' for_free FStar_Range.dummyRange [] ed


let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x ->
    let uu____2309 =
      let uu____2310 = FStar_Options.ugly () in
    ...
    if uu____2309 then
      ...
      let basic =
        ...
        | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) -> (
            ...
            match uu____2358 with univs2, t1 ->
              let uu____2365 =
                quals_to_string' x.FStar_Syntax_Syntax.sigquals
              in
              let uu____2366 =
        ...
        | FStar_Syntax_Syntax.Sig_sub_effect se -> (
            let lift_wp =
              match
                (se.FStar_Syntax_Syntax.lift_wp, se.FStar_Syntax_Syntax.lift)
              with
              | FStar_Pervasives_Native.None, FStar_Pervasives_Native.None ->
                  failwith "impossible"
              | FStar_Pervasives_Native.Some lift_wp, uu____2411 -> lift_wp
              | uu____2418, FStar_Pervasives_Native.Some lift -> lift
            in
            let uu____2426 =
            ...
            in
            match uu____2426 with us, t ->
              let uu____2437 = lid_to_string se.FStar_Syntax_Syntax.source in
              let uu____2438 = lid_to_string se.FStar_Syntax_Syntax.target in
              let uu____2439 = univ_names_to_string us in
              let uu____2440 = term_to_string t in
              FStar_Util.format4 "sub_effect %s ~> %s : <%s> %s" uu____2437
                uu____2438 uu____2439 uu____2440 )
        | FStar_Syntax_Syntax.Sig_effect_abbrev (l, univs1, tps, c, flags1) ->
            ...
            if uu____2450 then
              let uu____2451 =
                ...
                in
                FStar_Syntax_Subst.open_univ_vars univs1 uu____2456
              in
              match uu____2451 with univs2, t ->
                let uu____2459 =
                  let uu____2472 =
                ...
                match uu____2459 with tps1, c1 ->
                  ...
                  FStar_Util.format4 "effect %s<%s> %s = %s" uu____2545
                    uu____2546 uu____2547 uu____2548
            else
...
let rec sigelt_to_string_short : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x ->
    ...
    | FStar_Syntax_Syntax.Sig_let
        ( ( uu____2567
          , [ { FStar_Syntax_Syntax.lbname= lb
              ...
              ; FStar_Syntax_Syntax.lbattrs= uu____2573; _ } ] )
        , uu____2574 ) ->
    ...
    | uu____2603 ->
        let uu____2604 =
          FStar_All.pipe_right
            (FStar_Syntax_Util.lids_of_sigelt x)
...
let subst_to_string : FStar_Syntax_Syntax.subst_t -> Prims.string =
  fun s ->
    let uu____2654 =
      FStar_All.pipe_right s (FStar_List.map subst_elt_to_string)
    in
...
let list_to_string: 'a. ('a -> Prims.string) -> 'a Prims.list -> Prims.string =
  fun f elts ->
    match elts with
    | [] -> "[]"
    | x :: xs ->
        ...
        FStar_List.iter
          (fun x1 ->
            ...
            FStar_Util.string_builder_append strb uu____2729 )
          xs ;
        FStar_Util.string_builder_append strb "]" ;
        FStar_Util.string_of_string_builder strb
    ...
    | x :: xs ->
        ...
        FStar_List.iter
          (fun x1 ->
            ...
            FStar_Util.string_builder_append strb uu____2769 )
          xs ;
        FStar_Util.string_builder_append strb "}" ;
        FStar_Util.string_of_string_builder strb
