...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x ->
    let uu____1106 =
      let uu____1107 = FStar_Options.ugly () in Prims.op_Negation uu____1107 in
    if uu____1106
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x in
       ...
       | FStar_Syntax_Syntax.Tm_app (uu____1140, []) ->
           failwith "Empty args!"
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1273 ->
                                 ...
                                 | (t1, uu____1279) -> term_to_string t1)) in
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x ->
    let uu____1701 =
      let uu____1702 = FStar_Options.ugly () in Prims.op_Negation uu____1702 in
    if uu____1701
    then
      let e =
            ...
            (FStar_List.map
               (fun lb ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____1800
                    uu____1801 uu____1802 uu____1807 uu____1808)) in
        FStar_Util.concat_l "\n and " uu____1784 in
  ...
  fun uu___71_1814 ->
    ...
    | tms ->
        let uu____1820 =
          let uu____1821 =
            FStar_List.map
              (fun t -> let uu____1827 = term_to_string t in paren uu____1827)
              tms in
             ...
             then
               ...
               (let uu____1857 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1859 = FStar_Options.print_bound_var_types () in
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c ->
    let uu____1920 =
      let uu____1921 = FStar_Options.ugly () in Prims.op_Negation uu____1921 in
    if uu____1920
    then
           ...
           let basic =
             ...
             then
               ...
               let uu____1977 =
                 ...
                 FStar_All.pipe_right uu____1978 (FStar_String.concat ", ") in
               let uu____1985 =
               ...
               let uu____1986 =
                 ...
                 FStar_All.pipe_right uu____1987 (FStar_String.concat ", ") in
               let uu____2006 =
                 let uu____2007 =
                  ...
                  (let uu____2027 =
                     ((let uu____2030 = FStar_Options.print_effect_args () in
                       Prims.op_Negation uu____2030) &&
                        (let uu____2032 = FStar_Options.print_implicits () in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____2034 =
                        (let uu____2037 = FStar_Options.print_effect_args () in
                      ...
                      then
                        ...
                        (let uu____2045 =
                         ...
                         let uu____2046 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ in
                         FStar_Util.format2 "%s (%s)" uu____2045 uu____2046)))) in
           let dec =
             let uu____2048 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                 (FStar_List.collect
                    (fun uu___76_2058 ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2064 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2065 in
                           [uu____2064]
                       | uu____2066 -> [])) in
...
and (metadata_to_string : FStar_Syntax_Syntax.metadata -> Prims.string) =
  fun uu___77_2076 ->
                      ...
                      FStar_All.pipe_right args
                        (FStar_List.map
                           (fun uu____2137 ->
                              ...
                              | (t, uu____2143) -> term_to_string t)) in
    ...
    | FStar_Syntax_Syntax.Meta_quoted (qt, qi) ->
        let uu____2179 =
          let uu____2180 = term_to_string qt in Prims.strcat uu____2180 ")" in
  ...
  fun env ->
    fun b ->
      ...
      | (a, imp) ->
          ...
          let t =
            let uu____2206 = term_to_string' env a.FStar_Syntax_Syntax.sort in
...
let (tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string) =
  fun s ->
    let uu____2236 =
      let uu____2237 = FStar_Options.ugly () in Prims.op_Negation uu____2237 in
    if uu____2236
    then
        ...
        fun ed ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____2298 =
               let uu____2301 =
                 let uu____2304 = lid_to_string ed.FStar_Syntax_Syntax.mname in
                 let uu____2305 =
                   let uu____2308 =
                     let uu____2309 =
...
let rec (sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string) =
  fun x ->
    let uu____2384 =
      let uu____2385 = FStar_Options.ugly () in Prims.op_Negation uu____2385 in
    if uu____2384
    then
      ...
      (let basic =
         ...
         | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) ->
             let uu____2436 = quals_to_string' x.FStar_Syntax_Syntax.sigquals in
             let uu____2437 =
         ...
         | FStar_Syntax_Syntax.Sig_sub_effect se ->
             let lift_wp =
               ...
               | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
                   -> failwith "impossible"
               | (FStar_Pervasives_Native.Some lift_wp, uu____2482) ->
                   lift_wp
         ...
         | FStar_Syntax_Syntax.Sig_splice t ->
             ...
             FStar_Util.format1 "splice (%s)" uu____2625 in
       match x.FStar_Syntax_Syntax.sigattrs with
       | [] -> basic
       | uu____2626 ->
           let uu____2629 = attrs_to_string x.FStar_Syntax_Syntax.sigattrs in
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____2640,
          { FStar_Syntax_Syntax.lbname = lb;
            ...
            FStar_Syntax_Syntax.lbpos = uu____2647;_}::[]),
         uu____2648)
        ->
