    ...
    then
      ...
      (let basic =
         ...
         | FStar_Syntax_Syntax.Sig_assume (lid,us,f) ->
             let uu____2676 = FStar_Options.print_universes ()  in
             if uu____2676
             then
               let uu____2677 = univ_names_to_string us  in
               let uu____2678 = term_to_string f  in
