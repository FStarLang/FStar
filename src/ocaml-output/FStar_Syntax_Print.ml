...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x  ->
    let uu____1090 =
      let uu____1091 = FStar_Options.ugly ()  in Prims.op_Negation uu____1091
       in
    if uu____1090
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1208  ->
                                 ...
                                 | (t1,uu____1214) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1525
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1620 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1622
                              in
                           let uu____1623 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1619
                             uu____1620 uu____1623))
                in
             FStar_Util.concat_l "\n\t|" uu____1567  in
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x  ->
    let uu____1636 =
      let uu____1637 = FStar_Options.ugly ()  in Prims.op_Negation uu____1637
       in
    if uu____1636
    then
             ...
             then
               ...
               (let uu____1771 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1773 = FStar_Options.print_bound_var_types ()
                        in
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c  ->
    let uu____1828 =
      let uu____1829 = FStar_Options.ugly ()  in Prims.op_Negation uu____1829
       in
    if uu____1828
    then
             ...
             then
               ...
               let uu____1885 =
                 let uu____1886 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.comp_univs
                    ...
                    in
                 FStar_All.pipe_right uu____1886 (FStar_String.concat ", ")
                  in
               let uu____1893 =
               ...
               let uu____1894 =
                 let uu____1895 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                    ...
                    in
                 FStar_All.pipe_right uu____1895 (FStar_String.concat ", ")
                  in
               let uu____1914 =
                 let uu____1915 =
               ...
               (let uu____1925 =
                ...
                then
                  ...
                  (let uu____1935 =
                     ((let uu____1938 = FStar_Options.print_effect_args ()
                          in
                       Prims.op_Negation uu____1938) &&
                        (let uu____1940 = FStar_Options.print_implicits ()
                            in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____1942 =
                        (let uu____1945 = FStar_Options.print_effect_args ()
                            in
                    ...
                    (fun uu___74_1966  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____1972 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____1973
                              in
                           [uu____1972]
                       | uu____1974 -> []))
                in
...
let (tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string) =
  fun s  ->
    let uu____2128 =
      let uu____2129 = FStar_Options.ugly ()  in Prims.op_Negation uu____2129
       in
    if uu____2128
    then
        ...
        fun ed  ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____2190 =
               let uu____2193 =
                 let uu____2196 = lid_to_string ed.FStar_Syntax_Syntax.mname
                    in
                 let uu____2197 =
                   let uu____2200 =
                     let uu____2201 =
  ...
  fun x  ->
    let basic =
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          let uu____2293 = quals_to_string' x.FStar_Syntax_Syntax.sigquals
             in
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect se ->
          ...
          (match uu____2382 with
           | (us,t) ->
               let uu____2393 = lid_to_string se.FStar_Syntax_Syntax.source
                  in
               let uu____2394 = lid_to_string se.FStar_Syntax_Syntax.target
                  in
    ...
    | uu____2509 ->
        let attrs =
          FStar_All.pipe_right x.FStar_Syntax_Syntax.sigattrs
           ...
           in
        let uu____2519 = FStar_All.pipe_right attrs (FStar_String.concat " ")
           in
        FStar_Util.format2 "[@%s]\n%s" uu____2519 basic
