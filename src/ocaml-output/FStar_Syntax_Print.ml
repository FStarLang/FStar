...
let rec univ_to_string : FStar_Syntax_Syntax.universe -> Prims.string =
  fun u  ->
    let uu____913 =
      let uu____914 = FStar_Options.ugly ()  in Prims.op_Negation uu____914
       in
    if uu____913
    then
...
let quals_to_string' :
  ...
  fun quals  ->
    ...
    | [] -> ""
    | uu____1068 ->
        let uu____1071 = quals_to_string quals  in
        Prims.strcat uu____1071 " "
  
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____1127 =
      let uu____1128 = FStar_Options.ugly ()  in Prims.op_Negation uu____1128
       in
    if uu____1127
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1245  ->
                                 ...
                                 | (t1,uu____1251) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1562
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1657 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1659
                              in
                           let uu____1660 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1656
                             uu____1657 uu____1660))
                in
             FStar_Util.concat_l "\n\t|" uu____1604  in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1673 =
      let uu____1674 = FStar_Options.ugly ()  in Prims.op_Negation uu____1674
       in
    if uu____1673
    then
             ...
             then
               ...
               (let uu____1810 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1812 = FStar_Options.print_bound_var_types ()
                        in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____1875 =
      let uu____1876 = FStar_Options.ugly ()  in Prims.op_Negation uu____1876
       in
    if uu____1875
    then
             ...
             then
               ...
               (let uu____1974 =
                ...
                then
                  ...
                  (let uu____1984 =
                     ((let uu____1987 = FStar_Options.print_effect_args ()
                          in
                       Prims.op_Negation uu____1987) &&
                        (let uu____1989 = FStar_Options.print_implicits ()
                            in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____1991 =
                        (let uu____1994 = FStar_Options.print_effect_args ()
                            in
                    ...
                    (fun uu___71_2015  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2021 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2022
                              in
                           [uu____2021]
                       | uu____2023 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____2072 =
      let uu____2073 = FStar_Options.ugly ()  in Prims.op_Negation uu____2073
       in
    if uu____2072
    then
        ...
        fun ed  ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____2134 =
               let uu____2137 =
                 let uu____2140 = lid_to_string ed.FStar_Syntax_Syntax.mname
                    in
                 let uu____2141 =
                   let uu____2144 =
                     let uu____2145 =
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____2220 =
      let uu____2221 = FStar_Options.ugly ()  in Prims.op_Negation uu____2221
       in
    if uu____2220
    then
      ...
      (let basic =
         ...
         | FStar_Syntax_Syntax.Sig_inductive_typ
             ...
             let uu____2248 = quals_to_string' x.FStar_Syntax_Syntax.sigquals
                in
