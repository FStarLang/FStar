...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x ->
    let uu____1109 =
      let uu____1110 = FStar_Options.ugly () in Prims.op_Negation uu____1110 in
    if uu____1109
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x in
       ...
       | FStar_Syntax_Syntax.Tm_app (uu____1143, []) ->
           failwith "Empty args!"
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1310 ->
                                 ...
                                 | (t1, uu____1316) -> term_to_string t1)) in
            ...
            (FStar_List.map
               (fun lb ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____1824
                    uu____1825 uu____1826 uu____1831 uu____1832)) in
        FStar_Util.concat_l "\n and " uu____1808 in
  ...
  fun uu___73_1838 ->
    ...
    | tms ->
        let uu____1844 =
          let uu____1845 =
            FStar_List.map
              (fun t -> let uu____1851 = term_to_string t in paren uu____1851)
              tms in
             ...
             then
               ...
               (let uu____1881 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1883 = FStar_Options.print_bound_var_types () in
                     Prims.op_Negation uu____1883) in
                if uu____1881
                then
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c ->
    let uu____1944 =
      let uu____1945 = FStar_Options.ugly () in Prims.op_Negation uu____1945 in
    if uu____1944
    then
           ...
           let basic =
             ...
             then
               ...
               let uu____2001 =
                 ...
                 FStar_All.pipe_right uu____2002 (FStar_String.concat ", ") in
               let uu____2009 =
               ...
               let uu____2010 =
                 ...
                 FStar_All.pipe_right uu____2011 (FStar_String.concat ", ") in
               let uu____2030 =
                 let uu____2031 =
               ...
               (let uu____2041 =
                  (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (let uu____2048 = FStar_Options.print_effect_args () in
                     Prims.op_Negation uu____2048) in
                if uu____2041
                then
                  let uu____2049 =
                    term_to_string c1.FStar_Syntax_Syntax.result_typ in
                  ...
                  (let uu____2051 =
                     ((let uu____2054 = FStar_Options.print_effect_args () in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____2058 =
                        (let uu____2061 = FStar_Options.print_effect_args () in
                      ...
                      then
                        ...
                        (let uu____2069 =
                         ...
                         let uu____2070 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ in
                         FStar_Util.format2 "%s (%s)" uu____2069 uu____2070)))) in
           let dec =
             let uu____2072 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                 (FStar_List.collect
                    (fun uu___78_2082 ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2088 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2089 in
                           [uu____2088]
                       | uu____2090 -> [])) in
                      ...
                      FStar_All.pipe_right args
                        (FStar_List.map
                           (fun uu____2161 ->
                              ...
                              | (t, uu____2167) -> term_to_string t)) in
          ...
          let n1 =
            ...
            then FStar_Util.JsonNull
              ...
              (let uu____2219 =
               ...
               FStar_Util.JsonStr uu____2219) in
          let t =
            let uu____2222 = term_to_string' env a.FStar_Syntax_Syntax.sort in
        ...
        fun ed ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____2314 =
               let uu____2317 =
                 let uu____2320 = lid_to_string ed.FStar_Syntax_Syntax.mname in
                 let uu____2321 =
                   let uu____2324 =
                     let uu____2325 =
...
let rec (sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string) =
  fun x ->
    let uu____2400 =
      let uu____2401 = FStar_Options.ugly () in Prims.op_Negation uu____2401 in
    if uu____2400
    then
      ...
      (let basic =
         ...
         | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) ->
             let uu____2452 = quals_to_string' x.FStar_Syntax_Syntax.sigquals in
             let uu____2453 =
         ...
         | FStar_Syntax_Syntax.Sig_sub_effect se ->
             let lift_wp =
               ...
               | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
                   -> failwith "impossible"
               | (FStar_Pervasives_Native.Some lift_wp, uu____2498) ->
                   lift_wp
         ...
         | FStar_Syntax_Syntax.Sig_splice (lids, t) ->
             let uu____2646 =
               let uu____2647 = FStar_List.map FStar_Ident.string_of_lid lids in
               FStar_All.pipe_left (FStar_String.concat "; ") uu____2647 in
             let uu____2652 = term_to_string t in
             FStar_Util.format2 "splice[%s] (%s)" uu____2646 uu____2652 in
       match x.FStar_Syntax_Syntax.sigattrs with
       | [] -> basic
       | uu____2653 ->
           let uu____2656 = attrs_to_string x.FStar_Syntax_Syntax.sigattrs in
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____2667,
          { FStar_Syntax_Syntax.lbname = lb;
            ...
            FStar_Syntax_Syntax.lbpos = uu____2674;_}::[]),
         uu____2675)
        ->
