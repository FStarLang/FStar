...
| FStar_Util.Inl (_41_40) -> begin
false
end
| FStar_Util.Inr (_41_43) -> begin
true
end))


let filter_imp = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun _41_2 -> (match (_41_2) with
| (_41_48, Some (FStar_Syntax_Syntax.Implicit (_41_50))) -> begin
false
end
| _41_55 -> begin
true
...
| FStar_Const.Const_string (bytes, _41_90) -> begin
(FStar_Util.format1 "\"%s\"" (FStar_Util.string_of_bytes bytes))
end
| FStar_Const.Const_bytearray (_41_94) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x, _41_98) -> begin
x
end
...
let lbname_to_string : FStar_Syntax_Syntax.lbname  ->  Prims.string = (fun _41_3 -> (match (_41_3) with
...
| FStar_Syntax_Syntax.Tm_uinst (_41_121) -> begin
"Tm_uinst"
end
| FStar_Syntax_Syntax.Tm_constant (_41_124) -> begin
"Tm_constant"
end
| FStar_Syntax_Syntax.Tm_type (_41_127) -> begin
"Tm_type"
end
| FStar_Syntax_Syntax.Tm_abs (_41_130) -> begin
"Tm_abs"
end
| FStar_Syntax_Syntax.Tm_arrow (_41_133) -> begin
"Tm_arrow"
end
| FStar_Syntax_Syntax.Tm_refine (_41_136) -> begin
"Tm_refine"
end
| FStar_Syntax_Syntax.Tm_app (_41_139) -> begin
"Tm_app"
end
| FStar_Syntax_Syntax.Tm_match (_41_142) -> begin
"Tm_match"
end
| FStar_Syntax_Syntax.Tm_ascribed (_41_145) -> begin
"Tm_ascribed"
end
| FStar_Syntax_Syntax.Tm_let (_41_148) -> begin
"Tm_let"
end
| FStar_Syntax_Syntax.Tm_uvar (_41_151) -> begin
"Tm_uvar"
end
| FStar_Syntax_Syntax.Tm_delayed (_41_154, m) -> begin
...
| FStar_Syntax_Syntax.Tm_meta (_41_163) -> begin
"Tm_meta"
end
...
let qual_to_string : FStar_Syntax_Syntax.qualifier  ->  Prims.string = (fun _41_4 -> (match (_41_4) with
...
| FStar_Syntax_Syntax.Tm_delayed (_41_246) -> begin
(failwith "impossible")
end
| FStar_Syntax_Syntax.Tm_app (_41_249, []) -> begin
(failwith "Empty args!")
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_pattern (ps)) -> begin
(

let pats = (let _142_140 = (FStar_All.pipe_right ps (FStar_List.map (fun args -> (let _142_139 = (FStar_All.pipe_right args (FStar_List.map (fun _41_262 -> (match (_41_262) with
| (t, _41_261) -> begin
(term_to_string t)
end))))
...
| FStar_Syntax_Syntax.Tm_meta (t, _41_289) -> begin
(term_to_string t)
end
| FStar_Syntax_Syntax.Tm_bvar (x) -> begin
(db_to_string x)
...
| FStar_Syntax_Syntax.Tm_uvar (u, _41_300) -> begin
(uvar_to_string u)
end
...
| FStar_Syntax_Syntax.Tm_ascribed (e, FStar_Util.Inr (c), _41_348) -> begin
...
in (let _142_183 = (let _142_182 = (FStar_All.pipe_right branches (FStar_List.map (fun _41_358 -> (match (_41_358) with
| (p, wopt, e) -> begin
...
in (let _142_190 = (let _142_189 = (FStar_List.map (fun _41_375 -> (match (_41_375) with
| (x, b) -> begin
(
...
| FStar_Syntax_Syntax.Pat_dot_term (x, _41_379) -> begin
...
let _41_395 = (let _142_202 = (FStar_Syntax_Util.mk_conj lb.FStar_Syntax_Syntax.lbtyp lb.FStar_Syntax_Syntax.lbdef)
in (FStar_Syntax_Subst.open_univ_vars lb.FStar_Syntax_Syntax.lbunivs _142_202))
in (match (_41_395) with
| (us, td) -> begin
(

let _41_413 = (match ((let _142_203 = (FStar_Syntax_Subst.compress td)
in _142_203.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (_41_397, ((t, _41_404))::((d, _41_400))::[]) -> begin
((t), (d))
end
| _41_410 -> begin
(failwith "Impossibe")
end)
in (match (_41_413) with
| (t, d) -> begin
(

let _41_414 = lb
in {FStar_Syntax_Syntax.lbname = _41_414.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _41_414.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = d})
end))
end)))))
...
and imp_to_string : Prims.string  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option  ->  Prims.string = (fun s _41_5 -> (match (_41_5) with
...
and arg_to_string : (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  Prims.string = (fun _41_6 -> (match (_41_6) with
| (a, imp) -> begin
...
| FStar_Syntax_Syntax.Total (t, _41_450) -> begin
...
| FStar_Syntax_Syntax.GTotal (t, _41_460) -> begin
(match ((let _142_242 = (FStar_Syntax_Subst.compress t)
in _142_242.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (_41_464) when (not ((FStar_Options.print_implicits ()))) -> begin
(term_to_string t)
end
| _41_467 -> begin
...
if ((FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun _41_7 -> (match (_41_7) with
...
if ((not ((FStar_Options.print_effect_args ()))) && (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun _41_8 -> (match (_41_8) with
...
let dec = (let _142_259 = (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_List.collect (fun _41_9 -> (match (_41_9) with
...
| FStar_Syntax_Syntax.DECREASES (_41_494) -> begin
""
end))
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme  ->  Prims.string = (fun _41_500 -> (match (_41_500) with
| (us, t) -> begin
...
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (None), _41_510) -> begin
"#reset-options"
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.ResetOptions (Some (s)), _41_517) -> begin
(FStar_Util.format1 "#reset-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions (s), _41_523) -> begin
(FStar_Util.format1 "#set-options \"%s\"" s)
end
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, univs, tps, k, _41_531, _41_533, quals, _41_536) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (lid, univs, t, _41_543, _41_545, _41_547, _41_549, _41_551) -> begin
if (FStar_Options.print_universes ()) then begin
(

let _41_556 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_41_556) with
| (univs, t) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, univs, t, quals, _41_562) -> begin
(

let _41_567 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_41_567) with
| (univs, t) -> begin
...
| FStar_Syntax_Syntax.Sig_assume (lid, f, _41_571, _41_573) -> begin
(let _142_332 = (term_to_string f)
in (FStar_Util.format2 "val %s : %s" lid.FStar_Ident.str _142_332))
end
| FStar_Syntax_Syntax.Sig_let (lbs, _41_578, _41_580, qs, _41_583) -> begin
(lbs_to_string qs lbs)
end
| FStar_Syntax_Syntax.Sig_main (e, _41_588) -> begin
(let _142_333 = (term_to_string e)
in (FStar_Util.format1 "let _ = %s" _142_333))
end
| FStar_Syntax_Syntax.Sig_bundle (ses, _41_593, _41_595, _41_597) -> begin
(let _142_334 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right _142_334 (FStar_String.concat "\n")))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed, _41_602) -> begin
(eff_decl_to_string false ed)
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed, _41_607) -> begin
...
| (Some (lift_wp), _41_620) -> begin
lift_wp
end
| (_41_623, Some (lift)) -> begin
lift
end)
in (

let _41_630 = (FStar_Syntax_Subst.open_univ_vars (Prims.fst lift_wp) (Prims.snd lift_wp))
in (match (_41_630) with
| (us, t) -> begin
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (l, univs, tps, c, _41_636, flags, _41_639) -> begin
if (FStar_Options.print_universes ()) then begin
(

let _41_644 = (let _142_339 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None FStar_Range.dummyRange)
in (FStar_Syntax_Subst.open_univ_vars univs _142_339))
in (match (_41_644) with
| (univs, t) -> begin
(

let _41_653 = (match ((let _142_340 = (FStar_Syntax_Subst.compress t)
...
| FStar_Syntax_Syntax.Sig_let ((_41_658, ({FStar_Syntax_Syntax.lbname = lb; FStar_Syntax_Syntax.lbunivs = _41_665; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _41_662; FStar_Syntax_Syntax.lbdef = _41_660})::[]), _41_671, _41_673, _41_675, _41_677) -> begin
...
let subst_elt_to_string : FStar_Syntax_Syntax.subst_elt  ->  Prims.string = (fun _41_10 -> (match (_41_10) with
...
let _41_719 = (match (ascription) with
| None -> begin
...
let _41_712 = (FStar_Util.string_builder_append strb "Some Inr ")
...
let _41_717 = (FStar_Util.string_builder_append strb "Some Inr ")
...
let _41_729 = (FStar_Util.string_builder_append strb "{")
in (

let _41_731 = (let _142_385 = (f x)
in (FStar_Util.string_builder_append strb _142_385))
in (

let _41_736 = (FStar_List.iter (fun x -> (

let _41_734 = (FStar_Util.string_builder_append strb ", ")
in (let _142_387 = (f x)
in (FStar_Util.string_builder_append strb _142_387)))) xs)
in (

let _41_738 = (FStar_Util.string_builder_append strb "}")
in (FStar_Util.string_of_string_builder strb))))))
end)))
...
let _41_747 = (FStar_Util.string_builder_append strb "[")
in (

let _41_749 = (let _142_393 = (f x)
in (FStar_Util.string_builder_append strb _142_393))
in (

let _41_754 = (FStar_List.iter (fun x -> (

let _41_752 = (FStar_Util.string_builder_append strb "; ")
in (let _142_395 = (f x)
in (FStar_Util.string_builder_append strb _142_395)))) xs)
in (

let _41_756 = (FStar_Util.string_builder_append strb "]")
in (FStar_Util.string_of_string_builder strb))))))
end))
