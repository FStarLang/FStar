...
| FStar_Syntax_Syntax.Tm_type (_39_387) when (not ((FStar_ST.read FStar_Options.print_implicits))) -> begin
(term_to_string t)
end
| _39_390 -> begin
...
| FStar_Syntax_Syntax.Tm_type (_39_394) when (not ((FStar_ST.read FStar_Options.print_implicits))) -> begin
(term_to_string t)
end
| _39_397 -> begin
