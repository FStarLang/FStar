...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x  ->
    let uu____1639 =
      let uu____1641 = FStar_Options.ugly ()  in Prims.op_Negation uu____1641
       in
    if uu____1639
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x  in
       ...
       | FStar_Syntax_Syntax.Tm_app (uu____1680,[]) -> failwith "Empty args!"
            ...
            | FStar_Syntax_Syntax.Quote_static  ->
                let print_aq uu____1813 =
                  ...
                  | (bv,t) ->
                      ...
                      FStar_Util.format2 "%s -> %s" uu____1821 uu____1823
                   in
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1943  ->
                                 ...
                                 | (t1,uu____1952) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____2413
              in
    ...
    | (p,wopt,e) ->
        ...
        let uu____2516 =
          ...
          | FStar_Pervasives_Native.Some w ->
              ...
              FStar_Util.format1 "when %s" uu____2527
           in
...
and (ctx_uvar_to_string : FStar_Syntax_Syntax.ctx_uvar -> Prims.string) =
  fun ctx_uvar  ->
    ...
    let uu____2541 = term_to_string ctx_uvar.FStar_Syntax_Syntax.ctx_uvar_typ
       in
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x  ->
    let uu____2610 =
      let uu____2612 = FStar_Options.ugly ()  in Prims.op_Negation uu____2612
       in
    if uu____2610
    then
      let e =
            ...
            (FStar_List.map
               (fun lb  ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____2761
                    uu____2763 uu____2765 uu____2780 uu____2782))
           in
        FStar_Util.concat_l "\n and " uu____2741  in
    ...
    | tms ->
        let uu____2805 =
          let uu____2807 =
            FStar_List.map
              (fun t  ->
                 let uu____2815 = term_to_string t  in paren uu____2815) tms
             in
             ...
             then
               ...
               (let uu____2911 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____2914 = FStar_Options.print_bound_var_types ()
                        in
                     Prims.op_Negation uu____2914)
                   in
                if uu____2911
                then
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c  ->
    let uu____3069 =
      let uu____3071 = FStar_Options.ugly ()  in Prims.op_Negation uu____3071
       in
    if uu____3069
    then
             ...
             then
               ...
               let uu____3174 =
                 let uu____3176 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                    ...
                    in
                 FStar_All.pipe_right uu____3176 (FStar_String.concat ", ")
                  in
               let uu____3203 = cflags_to_string c1.FStar_Syntax_Syntax.flags
                  in
               ...
               (let uu____3208 =
                ...
                then
                  ...
                  (let uu____3229 =
                     ((let uu____3233 = FStar_Options.print_effect_args ()
                          in
                       Prims.op_Negation uu____3233) &&
                        (let uu____3236 = FStar_Options.print_implicits ()
                            in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____3242 =
                        (let uu____3246 = FStar_Options.print_effect_args ()
                            in
                      ...
                      then
                        ...
                        (let uu____3264 =
                         ...
                         let uu____3266 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ
                            in
                         FStar_Util.format2 "%s (%s)" uu____3264 uu____3266))))
              in
           let dec =
             let uu____3271 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (fun uu___11_3284  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____3291 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____3293
                              in
                           [uu____3291]
                       | uu____3298 -> []))
                in
          ...
          let n =
            ...
            then FStar_Util.JsonNull
              ...
              (let uu____3569 =
               ...
               FStar_Util.JsonStr uu____3569)
             in
          let t =
            let uu____3574 = term_to_string' env a.FStar_Syntax_Syntax.sort
               in
...
let (tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string) =
  fun s  ->
    let uu____3640 =
      let uu____3642 = FStar_Options.ugly ()  in Prims.op_Negation uu____3642
       in
    if uu____3640
    then
...
let (wp_eff_combinators_to_string :
  ...
  fun combs  ->
    ...
    let uu____3717 =
      ...
      let uu____3723 =
        let uu____3727 = tscheme_to_string combs.FStar_Syntax_Syntax.bind_wp
           in
        let uu____3729 =
          let uu____3733 =
  ...
  fun combs  ->
    let to_str uu____3806 =
      ...
      | (ts_t,ts_ty) ->
          ...
          FStar_Util.format2 "(%s) : (%s)" uu____3814 uu____3816
       in
    let uu____3819 =
      let uu____3823 =
