       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1625
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1720 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1722
                              in
                           let uu____1723 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1719
                             uu____1720 uu____1723))
                in
             FStar_Util.concat_l "\n\t|" uu____1667  in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1736 =
      let uu____1737 = FStar_Options.ugly ()  in Prims.op_Negation uu____1737
       in
    if uu____1736
    then
                 ...
                 (fun lb  ->
                    let uu____1846 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1851
                       in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____2071 =
      let uu____2072 = FStar_Options.ugly ()  in Prims.op_Negation uu____2072
       in
    if uu____2071
    then
               ...
               let uu____2159 =
                 let uu____2160 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    in
                 FStar_All.pipe_right uu____2160 (FStar_String.concat " ")
                  in
                      ...
                      then
                        ...
                        (let uu____2198 =
                         ...
                         let uu____2199 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ
                            in
                         FStar_Util.format2 "%s (%s)" uu____2198 uu____2199))))
              in
           let dec =
             let uu____2201 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (fun uu___218_2211  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2217 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2218
                              in
                           [uu____2217]
                       | uu____2219 -> []))
                in
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____2428 =
      let uu____2429 = FStar_Options.ugly ()  in Prims.op_Negation uu____2429
       in
    if uu____2428
    then
