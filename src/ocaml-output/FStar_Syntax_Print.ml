...
let rec univ_to_string : FStar_Syntax_Syntax.universe -> Prims.string =
  fun u  ->
    let uu____944 =
      let uu____945 = FStar_Options.ugly ()  in Prims.op_Negation uu____945
       in
    if uu____944
    then
...
let quals_to_string' :
  ...
  fun quals  ->
    ...
    | [] -> ""
    | uu____1104 ->
        let uu____1107 = quals_to_string quals  in
        Prims.strcat uu____1107 " "
  
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____1163 =
      let uu____1164 = FStar_Options.ugly ()  in Prims.op_Negation uu____1164
       in
    if uu____1163
    then
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1582
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1677 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1679
                              in
                           let uu____1680 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1676
                             uu____1677 uu____1680))
                in
             FStar_Util.concat_l "\n\t|" uu____1624  in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1693 =
      let uu____1694 = FStar_Options.ugly ()  in Prims.op_Negation uu____1694
       in
    if uu____1693
    then
                 ...
                 (fun lb  ->
                    let uu____1803 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1808
                       in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____2028 =
      let uu____2029 = FStar_Options.ugly ()  in Prims.op_Negation uu____2029
       in
    if uu____2028
    then
               ...
               let uu____2094 =
                 let uu____2095 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                    ...
                    in
                 FStar_All.pipe_right uu____2095 (FStar_String.concat ", ")
                  in
               let uu____2116 =
                 let uu____2117 =
                      ...
                      then
                        ...
                        (let uu____2155 =
                         ...
                         let uu____2156 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ
                            in
                         FStar_Util.format2 "%s (%s)" uu____2155 uu____2156))))
              in
           let dec =
             let uu____2158 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (fun uu___212_2168  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2174 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2175
                              in
                           [uu____2174]
                       | uu____2176 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____2229 =
      let uu____2230 = FStar_Options.ugly ()  in Prims.op_Negation uu____2230
       in
    if uu____2229
    then
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____2385 =
      let uu____2386 = FStar_Options.ugly ()  in Prims.op_Negation uu____2386
       in
    if uu____2385
    then
