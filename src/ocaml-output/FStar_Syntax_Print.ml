...
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
                 ...
                 (fun args  ->
                    let _0_343 =
                      FStar_All.pipe_right args
                       ...
                       in
                    FStar_All.pipe_right _0_343 (FStar_String.concat "; ")))
             in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,FStar_Util.Inl t,eff_name) ->
        ...
        let _0_377 =
          let _0_375 = FStar_Util.map_opt eff_name FStar_Ident.text_of_lid
             in
                    ...
                    | (p,wopt,e) ->
                        ...
                        let _0_383 =
                          ...
                          | Some w ->
                              ...
                              FStar_Util.format1 "when %s" _0_381
                           in
                        let _0_382 = FStar_All.pipe_right e term_to_string
                           in
  ...
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Pat_dot_term (x,uu____1127) ->
        ...
        then
          ...
          (let _0_395 = bv_to_string x  in FStar_Util.format1 ".%s" _0_395)
                 ...
                 (fun lb  ->
                    let uu____1165 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs _0_400
                       in
      ...
      let _0_409 =
        let _0_408 =
          FStar_All.pipe_right (Prims.snd lbs)
            (FStar_List.map
               (fun lb  ->
                  let _0_407 = lbname_to_string lb.FStar_Syntax_Syntax.lbname
                     in
                  let _0_406 =
                  ...
                  let _0_405 = term_to_string lb.FStar_Syntax_Syntax.lbtyp
                     in
                  let _0_404 =
            ...
            (let uu____1270 =
             ...
             then let _0_414 = nm_to_string a  in imp_to_string _0_414 imp
               ...
               (let _0_418 =
                  ...
                  let _0_416 =
                    let _0_415 = term_to_string a.FStar_Syntax_Syntax.sort
                       in
        ...
        let basic =
          ...
          then
            ...
            (let uu____1351 =
             ...
             if uu____1351
             then
               let _0_431 = term_to_string c.FStar_Syntax_Syntax.result_typ
                  in
                  ...
                  (let uu____1358 =
                   ...
                   then
                     ...
                     (let _0_434 = sli c.FStar_Syntax_Syntax.effect_name  in
                      let _0_433 =
                        term_to_string c.FStar_Syntax_Syntax.result_typ  in
                      FStar_Util.format2 "%s (%s)" _0_434 _0_433))))
           in
        let dec =
          let _0_437 =
            FStar_All.pipe_right c.FStar_Syntax_Syntax.flags
    ...
    fun ed  ->
      ...
      let _0_484 =
        let _0_483 =
          ...
          let _0_481 =
            let _0_480 =
              let _0_447 = univ_names_to_string ed.FStar_Syntax_Syntax.univs
                 in
            ...
            let _0_479 =
              ...
              let _0_477 =
                let _0_476 = term_to_string ed.FStar_Syntax_Syntax.signature
                   in
                let _0_475 =
                  let _0_474 =
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Sig_pragma
        (FStar_Syntax_Syntax.LightOff ,uu____1418) -> "#light \"off\""
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid,univs,tps,k,uu____1423,uu____1424,quals,uu____1426) ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon
        (lid,univs,t,uu____1436,uu____1437,uu____1438,uu____1439,uu____1440)
        ->
        let uu____1445 = FStar_Options.print_universes ()  in
        if uu____1445
        then
          let uu____1446 = FStar_Syntax_Subst.open_univ_vars univs t  in
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,univs,t,quals,uu____1456) ->
        let uu____1459 = FStar_Syntax_Subst.open_univ_vars univs t  in
        (match uu____1459 with
         | (univs,t) ->
             let _0_494 = quals_to_string' quals  in
             let _0_493 =
               let uu____1464 = FStar_Options.print_universes ()  in
               if uu____1464
               then
             ...
             FStar_Util.format4 "%sval %s %s : %s" _0_494 lid.FStar_Ident.str
               _0_493 _0_492)
    | FStar_Syntax_Syntax.Sig_assume (lid,f,uu____1468,uu____1469) ->
        let _0_495 = term_to_string f  in
        FStar_Util.format2 "val %s : %s" lid.FStar_Ident.str _0_495
    | FStar_Syntax_Syntax.Sig_let (lbs,uu____1473,uu____1474,qs,uu____1476)
        -> lbs_to_string qs lbs
    | FStar_Syntax_Syntax.Sig_main (e,uu____1484) ->
        let _0_496 = term_to_string e  in
        FStar_Util.format1 "let _ = %s" _0_496
    | FStar_Syntax_Syntax.Sig_bundle (ses,uu____1486,uu____1487,uu____1488)
        ->
        let _0_497 = FStar_List.map sigelt_to_string ses  in
        FStar_All.pipe_right _0_497 (FStar_String.concat "\n")
    | FStar_Syntax_Syntax.Sig_new_effect (ed,uu____1497) ->
        eff_decl_to_string false ed
    | FStar_Syntax_Syntax.Sig_new_effect_for_free (ed,uu____1499) ->
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect (se,r) ->
        let lift_wp =
          ...
          | (Some lift_wp,uu____1508) -> lift_wp
          | (uu____1512,Some lift) -> lift  in
        let uu____1517 =
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev
        (l,univs,tps,c,uu____1528,flags,uu____1530) ->
        let uu____1535 = FStar_Options.print_universes ()  in
        if uu____1535
        then
          let uu____1536 =
            let _0_502 =
...
let rec sigelt_to_string_short : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____1616,{ FStar_Syntax_Syntax.lbname = lb;
                       FStar_Syntax_Syntax.lbunivs = uu____1618;
                       FStar_Syntax_Syntax.lbtyp = t;
                       FStar_Syntax_Syntax.lbeff = uu____1620;
                       FStar_Syntax_Syntax.lbdef = uu____1621;_}::[]),uu____1622,uu____1623,uu____1624,uu____1625)
        ->
...
let subst_to_string : FStar_Syntax_Syntax.subst_t -> Prims.string =
  fun s  ->
    let _0_526 = FStar_All.pipe_right s (FStar_List.map subst_elt_to_string)
       in
      ...
      (FStar_Util.string_builder_append strb "[";
       ...
       FStar_List.iter
         (fun x  ->
            FStar_Util.string_builder_append strb "; ";
            (let _0_528 = f x  in
             FStar_Util.string_builder_append strb _0_528)) xs;
       FStar_Util.string_builder_append strb "]";
       FStar_Util.string_of_string_builder strb)
      ...
      (FStar_Util.string_builder_append strb "{";
       ...
       FStar_List.iter
         (fun x  ->
            FStar_Util.string_builder_append strb ", ";
            (let _0_530 = f x  in
             FStar_Util.string_builder_append strb _0_530)) xs;
       FStar_Util.string_builder_append strb "}";
       FStar_Util.string_of_string_builder strb)
