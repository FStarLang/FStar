...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x ->
    let uu____1654 =
      let uu____1656 = FStar_Options.ugly () in Prims.op_Negation uu____1656 in
    if uu____1654
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x in
       ...
       | FStar_Syntax_Syntax.Tm_app (uu____1703, []) ->
           failwith "Empty args!"
            ...
            | FStar_Syntax_Syntax.Quote_static ->
                let print_aq uu____1836 =
                  ...
                  | (bv, t) ->
                      ...
                      FStar_Util.format2 "%s -> %s" uu____1844 uu____1846 in
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1966 ->
                                 ...
                                 | (t1, uu____1975) -> term_to_string t1)) in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e, (annot, topt), eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____2434 in
    ...
    | (p, wopt, e) ->
        ...
        let uu____2537 =
          ...
          | FStar_Pervasives_Native.Some w ->
              ...
              FStar_Util.format1 "when %s" uu____2548 in
...
and (ctx_uvar_to_string : FStar_Syntax_Syntax.ctx_uvar -> Prims.string) =
  fun ctx_uvar ->
    ...
    let uu____2562 = term_to_string ctx_uvar.FStar_Syntax_Syntax.ctx_uvar_typ in
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x ->
    let uu____2629 =
      let uu____2631 = FStar_Options.ugly () in Prims.op_Negation uu____2631 in
    if uu____2629
    then
      let e =
            ...
            (FStar_List.map
               (fun lb ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____2780
                    uu____2782 uu____2784 uu____2799 uu____2801)) in
        FStar_Util.concat_l "\n and " uu____2760 in
  ...
  fun uu___6_2816 ->
    ...
    | tms ->
        let uu____2824 =
          let uu____2826 =
            FStar_List.map
              (fun t -> let uu____2834 = term_to_string t in paren uu____2834)
              tms in
             ...
             then
               ...
               (let uu____2921 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____2924 = FStar_Options.print_bound_var_types () in
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c ->
    let uu____3079 =
      let uu____3081 = FStar_Options.ugly () in Prims.op_Negation uu____3081 in
    if uu____3079
    then
           ...
           let basic =
             ...
             then
               ...
               let uu____3165 =
                 ...
                 FStar_All.pipe_right uu____3167 (FStar_String.concat ", ") in
               let uu____3182 =
               ...
               let uu____3184 =
                 ...
                 FStar_All.pipe_right uu____3186 (FStar_String.concat ", ") in
               let uu____3213 = cflags_to_string c1.FStar_Syntax_Syntax.flags in
                  ...
                  (let uu____3239 =
                     ((let uu____3243 = FStar_Options.print_effect_args () in
                       Prims.op_Negation uu____3243) &&
                        (let uu____3246 = FStar_Options.print_implicits () in
                     ...
                     (let uu____3252 =
                      ...
                      then
                        ...
                        (let uu____3274 =
                         ...
                         let uu____3276 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ in
                         FStar_Util.format2 "%s (%s)" uu____3274 uu____3276)))) in
           let dec =
             let uu____3281 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                 (FStar_List.collect
                    (fun uu___11_3294 ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____3301 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____3303 in
                           [uu____3301]
                       | uu____3308 -> [])) in
                      ...
                      FStar_All.pipe_right args
                        (FStar_List.map
                           (fun uu____3437 ->
                              ...
                              | (t, uu____3446) -> term_to_string t)) in
          ...
          let n1 =
            ...
            then FStar_Util.JsonNull
              ...
              (let uu____3579 =
               ...
               FStar_Util.JsonStr uu____3579) in
          let t =
            let uu____3584 = term_to_string' env a.FStar_Syntax_Syntax.sort in
...
let (tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string) =
  fun s ->
    let uu____3650 =
      let uu____3652 = FStar_Options.ugly () in Prims.op_Negation uu____3652 in
    if uu____3650
    then
...
let (wp_eff_combinators_to_string :
  ...
  fun combs ->
    ...
    let uu____3727 =
      ...
      let uu____3733 =
        let uu____3737 = tscheme_to_string combs.FStar_Syntax_Syntax.bind_wp in
        let uu____3739 =
          let uu____3743 =
  ...
  fun combs ->
    let to_str uu____3816 =
      ...
      | (ts_t, ts_ty) ->
          ...
          FStar_Util.format2 "(%s) : (%s)" uu____3824 uu____3826 in
    let uu____3829 =
      let uu____3833 =
  ...
  fun x ->
    let basic =
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) ->
          let uu____4163 = quals_to_string' x.FStar_Syntax_Syntax.sigquals in
          let uu____4165 =
      ...
      | FStar_Syntax_Syntax.Sig_splice (lids, t) ->
          let uu____4336 =
            let uu____4338 = FStar_List.map FStar_Ident.string_of_lid lids in
            FStar_All.pipe_left (FStar_String.concat "; ") uu____4338 in
          let uu____4348 = term_to_string t in
          FStar_Util.format2 "splice[%s] (%s)" uu____4336 uu____4348 in
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____4385,
          { FStar_Syntax_Syntax.lbname = lb;
            ...
            FStar_Syntax_Syntax.lbpos = uu____4392;_}::[]),
         uu____4393)
        ->
