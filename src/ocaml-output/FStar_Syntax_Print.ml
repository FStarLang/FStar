...
let is_inr uu___212_173 =
  match uu___212_173 with
  ...
  fun quals  ->
    fun lbs  ->
                 ...
                 (fun lb  ->
                    ...
                    | (us,td) ->
                        ...
                        (match uu____1322 with
                         | (t,d) ->
                             let uu___222_1394 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___222_1394.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs = us;
                               FStar_Syntax_Syntax.lbtyp = t;
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___222_1394.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = d
                             }))) in
          ((Prims.fst lbs), uu____1310)
        else lbs in
      ...
      FStar_Util.format3 "%slet %s %s" uu____1398
        (if Prims.fst lbs1 then "rec" else "") uu____1399
