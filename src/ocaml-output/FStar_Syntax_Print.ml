    ...
    | FStar_Syntax_Syntax.ET_app (h,args) ->
        let uu____3310 =
          let uu____3311 =
            let uu____3312 =
              let uu____3313 =
                let uu____3314 = FStar_List.map emb_typ_to_string args  in
                FStar_All.pipe_right uu____3314 (FStar_String.concat " ")  in
              Prims.strcat uu____3313 ")"  in
            Prims.strcat " " uu____3312  in
          Prims.strcat h uu____3311  in
        Prims.strcat "(" uu____3310
    | FStar_Syntax_Syntax.ET_fun (a,b) ->
        let uu____3321 =
          let uu____3322 = emb_typ_to_string a  in
          let uu____3323 =
            let uu____3324 = emb_typ_to_string b  in
            Prims.strcat ") -> " uu____3324  in
          Prims.strcat uu____3322 uu____3323  in
        Prims.strcat "(" uu____3321
