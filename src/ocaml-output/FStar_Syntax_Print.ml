...
| FStar_Syntax_Syntax.Sig_let (lbs, _40_577, _40_579, qs) -> begin
(lbs_to_string qs lbs)
end
| FStar_Syntax_Syntax.Sig_main (e, _40_585) -> begin
(let _137_333 = (term_to_string e)
in (FStar_Util.format1 "let _ = %s" _137_333))
end
| FStar_Syntax_Syntax.Sig_bundle (ses, _40_590, _40_592, _40_594) -> begin
(let _137_334 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right _137_334 (FStar_String.concat "\n")))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed, _40_599) -> begin
(eff_decl_to_string false ed)
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed, _40_604) -> begin
...
| (Some (lift_wp), _40_617) -> begin
lift_wp
end
| (_40_620, Some (lift)) -> begin
lift
end)
in (

let _40_627 = (FStar_Syntax_Subst.open_univ_vars (Prims.fst lift_wp) (Prims.snd lift_wp))
in (match (_40_627) with
| (us, t) -> begin
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (l, univs, tps, c, _40_633, flags, _40_636) -> begin
if (FStar_Options.print_universes ()) then begin
(

let _40_641 = (let _137_339 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None FStar_Range.dummyRange)
in (FStar_Syntax_Subst.open_univ_vars univs _137_339))
in (match (_40_641) with
| (univs, t) -> begin
(

let _40_650 = (match ((let _137_340 = (FStar_Syntax_Subst.compress t)
...
| FStar_Syntax_Syntax.Sig_let ((_40_655, ({FStar_Syntax_Syntax.lbname = lb; FStar_Syntax_Syntax.lbunivs = _40_662; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _40_659; FStar_Syntax_Syntax.lbdef = _40_657})::[]), _40_668, _40_670, _40_672) -> begin
(let _137_356 = (lbname_to_string lb)
in (let _137_355 = (term_to_string t)
in (FStar_Util.format2 "let %s : %s" _137_356 _137_355)))
end
| _40_676 -> begin
(let _137_359 = (let _137_358 = (FStar_Syntax_Util.lids_of_sigelt x)
in (FStar_All.pipe_right _137_358 (FStar_List.map (fun l -> l.FStar_Ident.str))))
in (FStar_All.pipe_right _137_359 (FStar_String.concat ", ")))
end))


let rec modul_to_string : FStar_Syntax_Syntax.modul  ->  Prims.string = (fun m -> (let _137_364 = (sli m.FStar_Syntax_Syntax.name)
in (let _137_363 = (let _137_362 = (FStar_List.map sigelt_to_string m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right _137_362 (FStar_String.concat "\n")))
...
in (let _137_367 = (bv_to_string x)
in (FStar_Util.format2 "DB (%s, %s)" _137_368 _137_367)))
end
| FStar_Syntax_Syntax.NM (x, i) -> begin
(let _137_370 = (bv_to_string x)
in (let _137_369 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "NM (%s, %s)" _137_370 _137_369)))
end
| FStar_Syntax_Syntax.NT (x, t) -> begin
(let _137_372 = (bv_to_string x)
in (let _137_371 = (term_to_string t)
in (FStar_Util.format2 "DB (%s, %s)" _137_372 _137_371)))
end
| FStar_Syntax_Syntax.UN (i, u) -> begin
(let _137_374 = (FStar_Util.string_of_int i)
in (let _137_373 = (univ_to_string u)
in (FStar_Util.format2 "UN (%s, %s)" _137_374 _137_373)))
end
| FStar_Syntax_Syntax.UD (u, i) -> begin
(let _137_375 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "UD (%s, %s)" u.FStar_Ident.idText _137_375))
end))


let subst_to_string : FStar_Syntax_Syntax.subst_t  ->  Prims.string = (fun s -> (let _137_378 = (FStar_All.pipe_right s (FStar_List.map subst_elt_to_string))
in (FStar_All.pipe_right _137_378 (FStar_String.concat "; "))))
...
let _40_714 = (match (ascription) with
| None -> begin
...
let _40_707 = (FStar_Util.string_builder_append strb "Some Inr ")
...
let _40_726 = (let _137_386 = (f x)
in (FStar_Util.string_builder_append strb _137_386))
in (
...
in (let _137_388 = (f x)
in (FStar_Util.string_builder_append strb _137_388)))) xs)
in (
...
let _40_742 = (FStar_Util.string_builder_append strb "[")
in (

let _40_744 = (let _137_394 = (f x)
in (FStar_Util.string_builder_append strb _137_394))
in (

let _40_749 = (FStar_List.iter (fun x -> (

let _40_747 = (FStar_Util.string_builder_append strb "; ")
in (let _137_396 = (f x)
in (FStar_Util.string_builder_append strb _137_396)))) xs)
in (
