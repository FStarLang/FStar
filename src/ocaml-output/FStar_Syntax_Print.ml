...
let is_inr = (fun uu___184_173 -> (match (uu___184_173) with
...
let filter_imp = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___185_208 -> (match (uu___185_208) with
...
let lbname_to_string : FStar_Syntax_Syntax.lbname  ->  Prims.string = (fun uu___186_448 -> (match (uu___186_448) with
...
let qual_to_string : FStar_Syntax_Syntax.qualifier  ->  Prims.string = (fun uu___187_701 -> (match (uu___187_701) with
...
let uu___194_1385 = lb
in {FStar_Syntax_Syntax.lbname = uu___194_1385.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = uu___194_1385.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = d})
end))
end)))))
...
and imp_to_string : Prims.string  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option  ->  Prims.string = (fun s uu___188_1416 -> (match (uu___188_1416) with
...
and arg_to_string : (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  Prims.string = (fun uu___189_1464 -> (match (uu___189_1464) with
| (a, imp) -> begin
(
...
let uu____1544 = ((FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___190_1546 -> (match (uu___190_1546) with
...
in (not (uu____1556))) && (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___191_1558 -> (match (uu___191_1558) with
...
let uu____1565 = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.collect (fun uu___192_1569 -> (match (uu___192_1569) with
...
let subst_elt_to_string : FStar_Syntax_Syntax.subst_elt  ->  Prims.string = (fun uu___193_1944 -> (match (uu___193_1944) with
