...
let rec (delta_depth_to_string :
  ...
  fun uu___206_5 ->
    ...
    | FStar_Syntax_Syntax.Delta_abstract d ->
        let uu____11 =
          let uu____12 = delta_depth_to_string d in Prims.strcat uu____12 ")" in
...
let (bv_to_string : FStar_Syntax_Syntax.bv -> Prims.string) =
  fun bv ->
    let uu____35 =
      let uu____36 = FStar_Util.string_of_int bv.FStar_Syntax_Syntax.index in
...
let (db_to_string : FStar_Syntax_Syntax.bv -> Prims.string) =
  fun bv ->
    let uu____49 =
      let uu____50 = FStar_Util.string_of_int bv.FStar_Syntax_Syntax.index in
        ...
        then
          ...
          (match uu____441 with
           | FStar_Pervasives_Native.Some xs ->
               let uu____456 =
                 let uu____459 = FStar_List.nth exps (Prims.parse_int "0") in
                 uu____459 :: xs in
  ...
  fun u ->
    ...
    then "?"
      ...
      (let uu____631 =
         ...
         let uu____634 =
           let uu____635 = version_to_string (FStar_Pervasives_Native.snd u) in
...
and (term_to_string : FStar_Syntax_Syntax.term -> Prims.string) =
  fun x ->
    let uu____1254 =
      let uu____1255 = FStar_Options.ugly () in Prims.op_Negation uu____1255 in
    if uu____1254
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x in
       ...
       | FStar_Syntax_Syntax.Tm_app (uu____1290, []) ->
           failwith "Empty args!"
            ...
            | FStar_Syntax_Syntax.Quote_static ->
                let print_aq uu____1451 =
                  ...
                  | (bv, t) ->
                      ...
                      FStar_Util.format2 "%s -> %s" uu____1458 uu____1459 in
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1544 ->
                                 ...
                                 | (t1, uu____1552) -> term_to_string t1)) in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e, (annot, topt), eff_name) ->
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1894 in
                       ...
                       | (p, wopt, e) ->
                           ...
                           let uu____1983 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1985 in
                           let uu____1986 =
                             FStar_All.pipe_right e term_to_string in
                           FStar_Util.format3 "%s %s -> %s" uu____1982
                             uu____1983 uu____1986)) in
             FStar_Util.concat_l "\n\t|" uu____1936 in
...
and (ctx_uvar_to_string : FStar_Syntax_Syntax.ctx_uvar -> Prims.string) =
  fun ctx_uvar ->
    ...
    let uu____2000 = term_to_string ctx_uvar.FStar_Syntax_Syntax.ctx_uvar_typ in
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x ->
    let uu____2036 =
      let uu____2037 = FStar_Options.ugly () in Prims.op_Negation uu____2037 in
    if uu____2036
    then
      let e =
            ...
            (FStar_List.map
               (fun lb ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____2136
                    uu____2137 uu____2138 uu____2143 uu____2144)) in
        FStar_Util.concat_l "\n and " uu____2120 in
  ...
  fun uu___212_2148 ->
    ...
    | tms ->
        let uu____2154 =
          let uu____2155 =
            FStar_List.map
              (fun t -> let uu____2161 = term_to_string t in paren uu____2161)
              tms in
             ...
             then
               ...
               (let uu____2207 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____2209 = FStar_Options.print_bound_var_types () in
...
and (comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string) =
  fun c ->
    let uu____2314 =
      let uu____2315 = FStar_Options.ugly () in Prims.op_Negation uu____2315 in
    if uu____2314
    then
           ...
           let basic =
             ...
             then
               ...
               let uu____2371 =
                 ...
                 FStar_All.pipe_right uu____2372 (FStar_String.concat ", ") in
               let uu____2381 =
               ...
               let uu____2382 =
                 ...
                 FStar_All.pipe_right uu____2383 (FStar_String.concat ", ") in
               let uu____2400 =
                 let uu____2401 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                     (FStar_List.map cflags_to_string) in
                 FStar_All.pipe_right uu____2401 (FStar_String.concat " ") in
               ...
               (let uu____2411 =
                ...
                then
                  ...
                  (let uu____2421 =
                     ((let uu____2424 = FStar_Options.print_effect_args () in
                       Prims.op_Negation uu____2424) &&
                        (let uu____2426 = FStar_Options.print_implicits () in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____2428 =
                        (let uu____2431 = FStar_Options.print_effect_args () in
                      ...
                      then
                        ...
                        (let uu____2439 =
                         ...
                         let uu____2440 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ in
                         FStar_Util.format2 "%s (%s)" uu____2439 uu____2440)))) in
           let dec =
             let uu____2442 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                 (FStar_List.collect
                    (fun uu___217_2452 ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2458 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2459 in
                           [uu____2458]
                       | uu____2460 -> [])) in
                      ...
                      FStar_All.pipe_right args
                        (FStar_List.map
                           (fun uu____2541 ->
                              ...
                              | (t, uu____2549) -> term_to_string t)) in
          ...
          let n1 =
            ...
            then FStar_Util.JsonNull
              ...
              (let uu____2617 =
               ...
               FStar_Util.JsonStr uu____2617) in
          let t =
            let uu____2620 = term_to_string' env a.FStar_Syntax_Syntax.sort in
...
let (tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string) =
  fun s ->
    let uu____2664 =
      let uu____2665 = FStar_Options.ugly () in Prims.op_Negation uu____2665 in
    if uu____2664
    then
        ...
        fun ed ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____2742 =
               let uu____2745 =
                 let uu____2748 = lid_to_string ed.FStar_Syntax_Syntax.mname in
                 let uu____2749 =
                   let uu____2752 =
                     let uu____2753 =
  ...
  fun x ->
    let basic =
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs1, t) ->
          let uu____2876 = quals_to_string' x.FStar_Syntax_Syntax.sigquals in
          let uu____2877 =
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect se ->
          ...
          (match uu____2960 with
           | (us, t) ->
               let uu____2971 = lid_to_string se.FStar_Syntax_Syntax.source in
               let uu____2972 = lid_to_string se.FStar_Syntax_Syntax.target in
      ...
      | FStar_Syntax_Syntax.Sig_splice (lids, t) ->
          let uu____3059 =
            let uu____3060 = FStar_List.map FStar_Ident.string_of_lid lids in
            FStar_All.pipe_left (FStar_String.concat "; ") uu____3060 in
          let uu____3065 = term_to_string t in
          FStar_Util.format2 "splice[%s] (%s)" uu____3059 uu____3065 in
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____3086,
          { FStar_Syntax_Syntax.lbname = lb;
            ...
            FStar_Syntax_Syntax.lbpos = uu____3093;_}::[]),
         uu____3094)
        ->
