    ...
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x  in
       ...
       | FStar_Syntax_Syntax.Tm_quoted
           ...
           ->
           let uu____1220 = term_to_string tm  in
           FStar_Util.format1 "`(%s)" uu____1220
       | FStar_Syntax_Syntax.Tm_quoted
           (tm,{
                 FStar_Syntax_Syntax.qkind =
                   FStar_Syntax_Syntax.Quote_dynamic ;_})
           ->
           let uu____1226 = term_to_string tm  in
           FStar_Util.format1 "quote (%s)" uu____1226
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1292  ->
                                 ...
                                 | (t1,uu____1298) -> term_to_string t1))
                          in
                       FStar_All.pipe_right uu____1274
                         (FStar_String.concat "; ")))
                in
             FStar_All.pipe_right uu____1244 (FStar_String.concat "\\/")  in
           let uu____1303 = term_to_string t  in
           FStar_Util.format2 "{:pattern %s} %s" pats uu____1303
       | FStar_Syntax_Syntax.Tm_meta
           (t,FStar_Syntax_Syntax.Meta_monadic (m,t')) ->
           let uu____1315 = tag_of_term t  in
           let uu____1316 = sli m  in
           let uu____1317 = term_to_string t'  in
           let uu____1318 = term_to_string t  in
           FStar_Util.format4 "(Monadic-%s{%s %s} %s)" uu____1315 uu____1316
             uu____1317 uu____1318
       | FStar_Syntax_Syntax.Tm_meta
           (t,FStar_Syntax_Syntax.Meta_monadic_lift (m0,m1,t')) ->
           let uu____1331 = tag_of_term t  in
           let uu____1332 = term_to_string t'  in
           let uu____1333 = sli m0  in
           let uu____1334 = sli m1  in
           let uu____1335 = term_to_string t  in
           FStar_Util.format5 "(MonadicLift-%s{%s : %s -> %s} %s)" uu____1331
             uu____1332 uu____1333 uu____1334 uu____1335
       | FStar_Syntax_Syntax.Tm_meta
       ...
       | FStar_Syntax_Syntax.Tm_meta (t,FStar_Syntax_Syntax.Meta_named l) ->
           let uu____1352 = lid_to_string l  in
           let uu____1353 =
             FStar_Range.string_of_range t.FStar_Syntax_Syntax.pos  in
           let uu____1354 = term_to_string t  in
           FStar_Util.format3 "Meta_named(%s, %s){%s}" uu____1352 uu____1353
             uu____1354
       | FStar_Syntax_Syntax.Tm_meta
           (t,FStar_Syntax_Syntax.Meta_desugared uu____1356) ->
           let uu____1361 = term_to_string t  in
           FStar_Util.format1 "Meta_desugared{%s}" uu____1361
       | FStar_Syntax_Syntax.Tm_bvar x3 ->
           let uu____1363 = db_to_string x3  in
           let uu____1364 =
             let uu____1365 =
               let uu____1366 = tag_of_term x3.FStar_Syntax_Syntax.sort  in
               Prims.strcat uu____1366 ")"  in
             Prims.strcat ":(" uu____1365  in
           Prims.strcat uu____1363 uu____1364
       | FStar_Syntax_Syntax.Tm_name x3 -> nm_to_string x3
       | FStar_Syntax_Syntax.Tm_fvar f -> fv_to_string f
       | FStar_Syntax_Syntax.Tm_uvar (u,uu____1370) -> uvar_to_string u
       | FStar_Syntax_Syntax.Tm_constant c -> const_to_string c
       | FStar_Syntax_Syntax.Tm_type u ->
           let uu____1397 = FStar_Options.print_universes ()  in
           if uu____1397
           then
             let uu____1398 = univ_to_string u  in
             FStar_Util.format1 "Type u#(%s)" uu____1398
           else "Type"
       | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
           let uu____1418 = binders_to_string " -> " bs  in
           let uu____1419 = comp_to_string c  in
           ...
           (match lc with
            | FStar_Pervasives_Native.Some rc when
                ...
                FStar_Util.format4 "(fun %s -> (%s $$ (residual) %s %s))"
                  ...
                  uu____1446
            | uu____1453 ->
                let uu____1456 = binders_to_string " " bs  in
                let uu____1457 = term_to_string t2  in
                FStar_Util.format2 "(fun %s -> %s)" uu____1456 uu____1457)
       | FStar_Syntax_Syntax.Tm_refine (xt,f) ->
           let uu____1464 = bv_to_string xt  in
           let uu____1465 =
             FStar_All.pipe_right xt.FStar_Syntax_Syntax.sort term_to_string
              in
           let uu____1468 = FStar_All.pipe_right f formula_to_string  in
           FStar_Util.format3 "(%s:%s{%s})" uu____1464 uu____1465 uu____1468
       | FStar_Syntax_Syntax.Tm_app (t,args) ->
           let uu____1493 = term_to_string t  in
           let uu____1494 = args_to_string args  in
           FStar_Util.format2 "(%s %s)" uu____1493 uu____1494
       | FStar_Syntax_Syntax.Tm_let (lbs,e) ->
           let uu____1513 = lbs_to_string [] lbs  in
           let uu____1514 = term_to_string e  in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           let annot1 =
             ...
             | FStar_Util.Inl t ->
                 ...
                 FStar_Util.format2 "[%s] %s" uu____1575 uu____1581
           ...
           let topt1 =
             ...
             | FStar_Pervasives_Native.Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1597
              in
           let uu____1598 = term_to_string e  in
           FStar_Util.format3 "(%s <ascribed: %s %s)" uu____1598 annot1 topt1
       | FStar_Syntax_Syntax.Tm_match (head1,branches) ->
           let uu____1637 = term_to_string head1  in
           let uu____1638 =
             let uu____1639 =
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1692 =
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1694
                              in
                           let uu____1695 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1691
                             uu____1692 uu____1695))
                in
             FStar_Util.concat_l "\n\t|" uu____1639  in
           FStar_Util.format2 "(match %s with\n\t| %s)" uu____1637 uu____1638
       | FStar_Syntax_Syntax.Tm_uinst (t,us) ->
           let uu____1702 = FStar_Options.print_universes ()  in
           if uu____1702
           then
             let uu____1703 = term_to_string t  in
             let uu____1704 = univs_to_string us  in
             FStar_Util.format2 "%s<%s>" uu____1703 uu____1704
...
and (pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string) =
  fun x  ->
    let uu____1707 =
      let uu____1708 = FStar_Options.ugly ()  in Prims.op_Negation uu____1708
       in
    if uu____1707
    then
      let e =
        let uu____1710 = FStar_Syntax_Syntax.new_bv_set ()  in
        FStar_Syntax_Resugar.resugar_pat x uu____1710  in
      ...
      (match x.FStar_Syntax_Syntax.v with
       | FStar_Syntax_Syntax.Pat_cons (l,pats) ->
           let uu____1733 = fv_to_string l  in
           let uu____1734 =
             let uu____1735 =
               FStar_List.map
                 (fun uu____1746  ->
                ...
                in
             FStar_All.pipe_right uu____1735 (FStar_String.concat " ")  in
           FStar_Util.format2 "(%s %s)" uu____1733 uu____1734
       | FStar_Syntax_Syntax.Pat_dot_term (x1,uu____1758) ->
           ...
           then
             ...
             (let uu____1767 = bv_to_string x1  in
              FStar_Util.format1 ".%s" uu____1767)
       | FStar_Syntax_Syntax.Pat_var x1 ->
           let uu____1769 = FStar_Options.print_bound_var_types ()  in
           if uu____1769
           then
             let uu____1770 = bv_to_string x1  in
             let uu____1771 = term_to_string x1.FStar_Syntax_Syntax.sort  in
             FStar_Util.format2 "%s:%s" uu____1770 uu____1771
           else bv_to_string x1
       | FStar_Syntax_Syntax.Pat_constant c -> const_to_string c
       | FStar_Syntax_Syntax.Pat_wild x1 ->
           let uu____1775 = FStar_Options.print_real_names ()  in
           if uu____1775
           then
             let uu____1776 = bv_to_string x1  in
             Prims.strcat "Pat_wild " uu____1776
           else "_")
...
and (lbs_to_string :
  ...
  fun quals  ->
    fun lbs  ->
      let uu____1788 = quals_to_string' quals  in
      let uu____1789 =
        let uu____1790 =
               ...
               (fun lb  ->
                  ...
                  let uu____1814 =
                    FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbdef
                      term_to_string
                     in
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____1806
                    uu____1807 uu____1808 uu____1813 uu____1814))
           in
        FStar_Util.concat_l "\n and " uu____1790  in
      FStar_Util.format3 "%slet %s %s" uu____1788
        (if FStar_Pervasives_Native.fst lbs then "rec" else "") uu____1789

and (attrs_to_string :
  FStar_Syntax_Syntax.attribute Prims.list -> Prims.string) =
  fun uu___71_1820  ->
    match uu___71_1820 with
    | [] -> ""
    | tms ->
        let uu____1826 =
          let uu____1827 =
            FStar_List.map
              (fun t  ->
                 let uu____1833 = term_to_string t  in paren uu____1833) tms
             in
          FStar_All.pipe_right uu____1827 (FStar_String.concat "; ")  in
        FStar_Util.format1 "[@ %s]" uu____1826

and (lcomp_to_string : FStar_Syntax_Syntax.lcomp -> Prims.string) =
  fun lc  ->
    let uu____1837 = FStar_Options.print_effect_args ()  in
    if uu____1837
    then
      let uu____1838 = FStar_Syntax_Syntax.lcomp_comp lc  in
      comp_to_string uu____1838
    else
      (let uu____1840 = sli lc.FStar_Syntax_Syntax.eff_name  in
       let uu____1841 = term_to_string lc.FStar_Syntax_Syntax.res_typ  in
       FStar_Util.format2 "%s %s" uu____1840 uu____1841)

and (aqual_to_string : FStar_Syntax_Syntax.aqual -> Prims.string) =
  fun uu___72_1842  ->
    match uu___72_1842 with
...
and (imp_to_string :
  ...
  fun s  ->
    fun aq  ->
      let uu____1846 = aqual_to_string aq  in Prims.strcat uu____1846 s
...
and (binder_to_string' :
  ...
  fun is_arrow  ->
    fun b  ->
      let uu____1849 =
        let uu____1850 = FStar_Options.ugly ()  in
      ...
      then
        ...
        (let uu____1857 = b  in
         ...
         | (a,imp) ->
             let uu____1860 = FStar_Syntax_Syntax.is_null_binder b  in
             if uu____1860
             then
               let uu____1861 = term_to_string a.FStar_Syntax_Syntax.sort  in
               Prims.strcat "_:" uu____1861
             else
               (let uu____1863 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1865 = FStar_Options.print_bound_var_types ()
                        in
                     Prims.op_Negation uu____1865)
                   in
                if uu____1863
                then
                  let uu____1866 = nm_to_string a  in
                  imp_to_string uu____1866 imp
                else
                  (let uu____1868 =
                     let uu____1869 = nm_to_string a  in
                     let uu____1870 =
                       let uu____1871 =
                         term_to_string a.FStar_Syntax_Syntax.sort  in
                       Prims.strcat ":" uu____1871  in
                     Prims.strcat uu____1869 uu____1870  in
  ...
  fun sep  ->
    fun bs  ->
      let bs1 =
        ...
        if uu____1877 then bs else filter_imp bs  in
      if sep = " -> "
      then
        let uu____1879 =
          FStar_All.pipe_right bs1 (FStar_List.map arrow_binder_to_string)
           in
        FStar_All.pipe_right uu____1879 (FStar_String.concat sep)
      else
        (let uu____1887 =
           FStar_All.pipe_right bs1 (FStar_List.map binder_to_string)  in
         FStar_All.pipe_right uu____1887 (FStar_String.concat sep))
...
and (arg_to_string :
  ...
  =
  fun uu___73_1894  ->
    match uu___73_1894 with
    | (a,imp) ->
        let uu____1901 = term_to_string a  in imp_to_string uu____1901 imp

and (args_to_string : FStar_Syntax_Syntax.args -> Prims.string) =
  fun args  ->
    let args1 =
      let uu____1904 = FStar_Options.print_implicits ()  in
      if uu____1904 then args else filter_imp args  in
    let uu____1908 =
      FStar_All.pipe_right args1 (FStar_List.map arg_to_string)  in
    FStar_All.pipe_right uu____1908 (FStar_String.concat " ")

and (comp_to_string' :
  FStar_Syntax_DsEnv.env -> FStar_Syntax_Syntax.comp -> Prims.string) =
  fun env  ->
    fun c  ->
      let uu____1921 = FStar_Options.ugly ()  in
      if uu____1921
