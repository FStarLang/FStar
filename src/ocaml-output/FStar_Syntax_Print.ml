...
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____811 =
      let uu____812 = FStar_Options.ugly ()  in Prims.op_Negation uu____812
       in
    if uu____811
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____892  ->
                                 ...
                                 | (t1,uu____896) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1160
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1221 =
                             ...
                             | Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1223
                              in
                           let uu____1224 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1220
                             uu____1221 uu____1224))
                in
             FStar_Util.concat_l "\n\t|" uu____1192  in
                 ...
                 (fun lb  ->
                    ...
                    | (us,td) ->
                        ...
                        (match uu____1316 with
                         | (t,d) ->
                             let uu___217_1388 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___217_1388.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs = us;
                               FStar_Syntax_Syntax.lbtyp = t;
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___217_1388.FStar_Syntax_Syntax.lbeff);
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        let basic =
          ...
          then
            ...
            let uu____1522 = term_to_string c1.FStar_Syntax_Syntax.result_typ
               in
            let uu____1523 =
              let uu____1524 =
                ...
                then term_to_string c1.FStar_Syntax_Syntax.result_typ
                  ...
                  (let uu____1554 =
                   ...
                   then
                     ...
                     (let uu____1561 = sli c1.FStar_Syntax_Syntax.effect_name
                         in
                      let uu____1562 =
                        term_to_string c1.FStar_Syntax_Syntax.result_typ  in
                      FStar_Util.format2 "%s (%s)" uu____1561 uu____1562))))
           in
        let dec =
          let uu____1564 =
            FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
            ...
            (FStar_List.map
               (fun a  ->
                  ...
                  FStar_Util.format5 "%s%s %s : %s = %s" uu____1616
                    uu____1617 uu____1618 uu____1620 uu____1621))
           in
  ...
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,univs1,t) ->
        ...
        (match uu____1720 with
         | (univs2,t1) ->
             let uu____1725 = quals_to_string' x.FStar_Syntax_Syntax.sigquals
                in
             let uu____1726 =
