...
let find_lid :
  ...
  fun x  ->
    fun xs  ->
      let uu____376 = find (fun p  -> FStar_Ident.lid_equals x (fst p)) xs
         in
      snd uu____376
                 ...
                 (fun lb  ->
                    let uu____1316 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1319
                       in
                    match uu____1316 with
                    | (us,td) ->
                        let uu____1322 =
                          let uu____1329 =
                            let uu____1330 = FStar_Syntax_Subst.compress td
                               in
             ...
             then
               ...
               (let uu____1442 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1443 = FStar_Options.print_bound_var_types ()
                        in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____1489 =
      let uu____1490 = FStar_Options.ugly ()  in Prims.op_Negation uu____1490
       in
    if uu____1489
    then
                  ...
                  (let uu____1558 =
                     ((let uu____1559 = FStar_Options.print_effect_args ()
                       ...
                       Prims.op_Negation uu____1559) &&
                        (let uu____1560 = FStar_Options.print_implicits ()
                            in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____1562 =
                        (let uu____1563 = FStar_Options.print_effect_args ()
                            in
                      ...
                      then
                        ...
                        (let uu____1569 =
                         ...
                         let uu____1570 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ
                            in
                         FStar_Util.format2 "%s (%s)" uu____1569 uu____1570))))
              in
           let dec =
             let uu____1572 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (fun uu___217_1576  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____1581 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____1582
                              in
                           [uu____1581]
                       | uu____1583 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____1600 =
      let uu____1601 = FStar_Options.ugly ()  in Prims.op_Negation uu____1601
       in
    if uu____1600
    then
                   ...
                   (FStar_List.map
                      (fun a  ->
                         ...
                         let uu____1645 =
                           let uu____1646 =
                             univ_names_to_string
                              ...
                              in
                           FStar_All.pipe_left enclose_universes uu____1646
                            in
                         let uu____1647 =
                         ...
                         FStar_Util.format5 "%s%s %s : %s = %s" uu____1643
                           uu____1644 uu____1645 uu____1647 uu____1648))
                  in
               FStar_All.pipe_right uu____1638 (FStar_String.concat ",\n\t")
                in
             let uu____1650 =
               let uu____1652 =
                 let uu____1654 = lid_to_string ed.FStar_Syntax_Syntax.mname
                    in
                 let uu____1655 =
                   let uu____1657 =
                     let uu____1658 =
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____1717 =
      let uu____1718 = FStar_Options.ugly ()  in Prims.op_Negation uu____1718
       in
    if uu____1717
    then
      ...
      (match x.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_inductive_typ
           ...
           let uu____1738 = quals_to_string' x.FStar_Syntax_Syntax.sigquals
              in
       ...
       | FStar_Syntax_Syntax.Sig_sub_effect se ->
           ...
           (match uu____1812 with
            | (us,t) ->
                let uu____1819 = lid_to_string se.FStar_Syntax_Syntax.source
                   in
                let uu____1820 = lid_to_string se.FStar_Syntax_Syntax.target
                   in
