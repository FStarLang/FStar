    ...
    | FStar_Syntax_Syntax.Tm_app (f,args) ->
        ...
        then
          ...
          (match uu____275 with
           | Some xs ->
               Some
                 (let _0_308 = FStar_List.nth exps (Prims.parse_int "0") in
                  _0_308 :: xs)
           | None  -> None)
        else None
    | uu____310 ->
...
let rec term_to_string: FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
            ...
            FStar_All.pipe_right ps
              (FStar_List.map
                 (fun args  ->
                    ...
                    FStar_All.pipe_right _0_336 (FStar_String.concat "; "))) in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,FStar_Util.Inl t,eff_name) ->
        ...
        let _0_370 =
          let _0_368 = FStar_Util.map_opt eff_name FStar_Ident.text_of_lid in
                    ...
                    | (p,wopt,e) ->
                        ...
                        let _0_376 =
                          ...
                          | Some w ->
                              ...
                              FStar_Util.format1 "when %s" _0_374 in
                        let _0_375 = FStar_All.pipe_right e term_to_string in
                        FStar_Util.format3 "%s %s -> %s" _0_377 _0_376 _0_375)) in
          FStar_Util.concat_l "\n\t|" _0_378 in
...
and pat_to_string: FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Pat_dot_term (x,uu____1127) ->
        ...
        else (let _0_388 = bv_to_string x in FStar_Util.format1 ".%s" _0_388)
    ...
    | FStar_Syntax_Syntax.Pat_wild x ->
        ...
        if uu____1139
        then let _0_391 = bv_to_string x in Prims.strcat "Pat_wild " _0_391
        else "_"
  ...
  fun quals  ->
    fun lbs  ->
                 ...
                 (fun lb  ->
                    let uu____1165 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs _0_393 in
      ...
      let _0_402 =
        let _0_401 =
          FStar_All.pipe_right (Prims.snd lbs)
            (FStar_List.map
               (fun lb  ->
                  let _0_400 = lbname_to_string lb.FStar_Syntax_Syntax.lbname in
                  let _0_399 =
                  ...
                  let _0_398 = term_to_string lb.FStar_Syntax_Syntax.lbtyp in
                  let _0_397 =
      ...
      FStar_Util.format3 "%slet %s %s" _0_403
        (if Prims.fst lbs then "rec" else "") _0_402
      ...
      | (a,imp) ->
          ...
          then
            ...
            (let uu____1270 =
             ...
             if uu____1270
             then let _0_407 = nm_to_string a in imp_to_string _0_407 imp
             else
               (let _0_411 =
                  let _0_410 = nm_to_string a in
                  let _0_409 =
                    let _0_408 = term_to_string a.FStar_Syntax_Syntax.sort in
    ...
    | FStar_Syntax_Syntax.Comp c ->
        let basic =
          ...
          then
            ...
            let _0_422 = term_to_string c.FStar_Syntax_Syntax.result_typ in
            let _0_421 =
              let _0_418 =
            ...
            (let uu____1351 =
             ...
             if uu____1351
             then
               let _0_424 = term_to_string c.FStar_Syntax_Syntax.result_typ in
                ...
                then term_to_string c.FStar_Syntax_Syntax.result_typ
                  ...
                  (let uu____1358 =
                   ...
                   then
                     ...
                     (let _0_427 = sli c.FStar_Syntax_Syntax.effect_name in
                      let _0_426 =
                        term_to_string c.FStar_Syntax_Syntax.result_typ in
                      FStar_Util.format2 "%s (%s)" _0_427 _0_426)))) in
        let dec =
          let _0_430 =
            FStar_All.pipe_right c.FStar_Syntax_Syntax.flags
              (FStar_List.collect
    ...
    fun ed  ->
      ...
      let _0_477 =
        let _0_476 =
          ...
          let _0_474 =
            let _0_473 =
              let _0_440 = univ_names_to_string ed.FStar_Syntax_Syntax.univs in
              FStar_All.pipe_left enclose_universes _0_440 in
            let _0_472 =
              let _0_471 =
                binders_to_string " " ed.FStar_Syntax_Syntax.binders in
              let _0_470 =
                let _0_469 = term_to_string ed.FStar_Syntax_Syntax.signature in
                let _0_468 =
                  let _0_467 =
            ...
            _0_473 :: _0_472 in
          _0_475 :: _0_474 in
        (if for_free then "_for_free " else "") :: _0_476 in
      FStar_Util.format
           ...
           | (univs,t) ->
               ...
               (match uu____1552 with
                | (tps,c) ->
                    ...
                    FStar_Util.format4 "effect %s<%s> %s = %s" _0_499 _0_498
                      _0_497 _0_496))
        else
          (let _0_502 = sli l in
...
let subst_to_string: FStar_Syntax_Syntax.subst_t -> Prims.string =
  fun s  ->
    let _0_519 = FStar_All.pipe_right s (FStar_List.map subst_elt_to_string) in
  ...
  | x::xs ->
      ...
      (FStar_Util.string_builder_append strb "[";
       ...
       FStar_List.iter
         (fun x  ->
            FStar_Util.string_builder_append strb "; ";
            (let _0_521 = f x in FStar_Util.string_builder_append strb _0_521))
         xs;
       FStar_Util.string_builder_append strb "]";
       FStar_Util.string_of_string_builder strb)
  ...
  | x::xs ->
      ...
      (FStar_Util.string_builder_append strb "{";
       ...
       FStar_List.iter
         (fun x  ->
            FStar_Util.string_builder_append strb ", ";
            (let _0_523 = f x in FStar_Util.string_builder_append strb _0_523))
         xs;
       FStar_Util.string_builder_append strb "}";
       FStar_Util.string_of_string_builder strb)