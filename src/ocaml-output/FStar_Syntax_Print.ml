...
let qual_to_string : FStar_Syntax_Syntax.qualifier  ->  Prims.string = (fun uu___183_701 -> (match (uu___183_701) with
...
let uu___190_1385 = lb
in {FStar_Syntax_Syntax.lbname = uu___190_1385.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = uu___190_1385.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = d})
end))
end)))))
...
and imp_to_string : Prims.string  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option  ->  Prims.string = (fun s uu___184_1416 -> (match (uu___184_1416) with
...
and arg_to_string : (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  Prims.string = (fun uu___185_1464 -> (match (uu___185_1464) with
| (a, imp) -> begin
(
...
let uu____1544 = ((FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___186_1546 -> (match (uu___186_1546) with
...
in (not (uu____1556))) && (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___187_1558 -> (match (uu___187_1558) with
...
let uu____1565 = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.collect (fun uu___188_1569 -> (match (uu___188_1569) with
...
let subst_elt_to_string : FStar_Syntax_Syntax.subst_elt  ->  Prims.string = (fun uu___189_1944 -> (match (uu___189_1944) with
