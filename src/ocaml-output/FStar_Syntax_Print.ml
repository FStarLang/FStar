...
let bv_to_string : FStar_Syntax_Syntax.bv -> Prims.string =
  fun bv  ->
    let uu____32 =
      let uu____33 = FStar_Util.string_of_int bv.FStar_Syntax_Syntax.index
         in
...
let db_to_string : FStar_Syntax_Syntax.bv -> Prims.string =
  fun bv  ->
    let uu____44 =
      let uu____45 = FStar_Util.string_of_int bv.FStar_Syntax_Syntax.index
         in
    ...
    | FStar_Syntax_Syntax.Tm_app (f,args) ->
        ...
        then
          ...
          (match uu____317 with
           | Some xs ->
               let uu____336 =
                 let uu____340 = FStar_List.nth exps (Prims.parse_int "0")
                    in
                 uu____340 :: xs  in
               Some uu____336
           | None  -> None)
...
let find_lid :
  ...
  fun x  ->
    fun xs  ->
      let uu____416 = find (fun p  -> FStar_Ident.lid_equals x (fst p)) xs
         in
      snd uu____416
...
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____854 =
      let uu____855 = FStar_Options.ugly ()  in Prims.op_Negation uu____855
       in
    if uu____854
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____929  ->
                                 ...
                                 | (t1,uu____933) -> term_to_string t1))
                          in
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e,(annot,topt),eff_name) ->
           ...
           let topt1 =
             ...
             | Some t ->
                 ...
                 FStar_Util.format1 "by %s" uu____1169
              in
                       ...
                       | (p,wopt,e) ->
                           ...
                           let uu____1230 =
                             ...
                             | Some w ->
                                 ...
                                 FStar_Util.format1 "when %s" uu____1232
                              in
                           let uu____1233 =
                             FStar_All.pipe_right e term_to_string  in
                           FStar_Util.format3 "%s %s -> %s" uu____1229
                             uu____1230 uu____1233))
                in
             FStar_Util.concat_l "\n\t|" uu____1201  in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1246 =
      let uu____1247 = FStar_Options.ugly ()  in Prims.op_Negation uu____1247
       in
    if uu____1246
    then
                 ...
                 (fun lb  ->
                    let uu____1318 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1321
                       in
                    match uu____1318 with
                    | (us,td) ->
                        let uu____1324 =
                          let uu____1331 =
                            let uu____1332 = FStar_Syntax_Subst.compress td
                               in
             ...
             then
               ...
               (let uu____1444 =
                  (Prims.op_Negation is_arrow) &&
                    (let uu____1445 = FStar_Options.print_bound_var_types ()
                        in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____1491 =
      let uu____1492 = FStar_Options.ugly ()  in Prims.op_Negation uu____1492
       in
    if uu____1491
    then
             ...
             then
               ...
               (let uu____1553 =
                ...
                then
                  ...
                  (let uu____1560 =
                     ((let uu____1561 = FStar_Options.print_effect_args ()
                          in
                       Prims.op_Negation uu____1561) &&
                        (let uu____1562 = FStar_Options.print_implicits ()
                            in
                   ...
                   then term_to_string c1.FStar_Syntax_Syntax.result_typ
                     ...
                     (let uu____1564 =
                        (let uu____1565 = FStar_Options.print_effect_args ()
                            in
                      ...
                      then
                        ...
                        (let uu____1571 =
                         ...
                         let uu____1572 =
                           term_to_string c1.FStar_Syntax_Syntax.result_typ
                            in
                         FStar_Util.format2 "%s (%s)" uu____1571 uu____1572))))
              in
           let dec =
             let uu____1574 =
               FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    (fun uu___219_1578  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____1583 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____1584
                              in
                           [uu____1583]
                       | uu____1585 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____1604 =
      let uu____1605 = FStar_Options.ugly ()  in Prims.op_Negation uu____1605
       in
    if uu____1604
    then
        ...
        fun ed  ->
          ...
          then
            ...
            (let actions_to_string actions =
             ...
             let uu____1661 =
               let uu____1663 =
                 let uu____1665 = lid_to_string ed.FStar_Syntax_Syntax.mname
                    in
                 let uu____1666 =
                   let uu____1668 =
                     let uu____1669 =
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____1731 =
      let uu____1732 = FStar_Options.ugly ()  in Prims.op_Negation uu____1732
       in
    if uu____1731
    then
      ...
      (match x.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_inductive_typ
           ...
           let uu____1752 = quals_to_string' x.FStar_Syntax_Syntax.sigquals
              in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1791) ->
           lbs_to_string x.FStar_Syntax_Syntax.sigquals lbs
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____1795 = term_to_string e  in
           FStar_Util.format1 "let _ = %s" uu____1795
       | FStar_Syntax_Syntax.Sig_bundle (ses,uu____1797) ->
           let uu____1802 = FStar_List.map sigelt_to_string ses  in
           FStar_All.pipe_right uu____1802 (FStar_String.concat "\n")
       ...
       | FStar_Syntax_Syntax.Sig_sub_effect se ->
           let lift_wp =
             ...
             | (Some lift_wp,uu____1814) -> lift_wp
             | (uu____1818,Some lift) -> lift  in
           let uu____1823 =
             FStar_Syntax_Subst.open_univ_vars (fst lift_wp) (snd lift_wp)
              in
           (match uu____1823 with
            | (us,t) ->
                let uu____1830 = lid_to_string se.FStar_Syntax_Syntax.source
                   in
                let uu____1831 = lid_to_string se.FStar_Syntax_Syntax.target
                   in
                let uu____1832 = univ_names_to_string us  in
                let uu____1833 = term_to_string t  in
                FStar_Util.format4 "sub_effect %s ~> %s : <%s> %s" uu____1830
                  uu____1831 uu____1832 uu____1833)
       | FStar_Syntax_Syntax.Sig_effect_abbrev (l,univs1,tps,c,flags) ->
           let uu____1841 = FStar_Options.print_universes ()  in
           if uu____1841
           then
             let uu____1842 =
               let uu____1845 =
                 (FStar_Syntax_Syntax.mk
                  ...
                  in
               FStar_Syntax_Subst.open_univ_vars univs1 uu____1845  in
             (match uu____1842 with
              | (univs2,t) ->
                  let uu____1856 =
                    ...
                    | uu____1892 -> failwith "impossible"  in
                  (match uu____1856 with
                   | (tps1,c1) ->
                       let uu____1912 = sli l  in
                       let uu____1913 = univ_names_to_string univs2  in
                       let uu____1914 = binders_to_string " " tps1  in
                       let uu____1915 = comp_to_string c1  in
                       FStar_Util.format4 "effect %s<%s> %s = %s" uu____1912
                         uu____1913 uu____1914 uu____1915))
           else
             (let uu____1917 = sli l  in
              let uu____1918 = binders_to_string " " tps  in
              let uu____1919 = comp_to_string c  in
              FStar_Util.format3 "effect %s %s = %s" uu____1917 uu____1918
                uu____1919))
  
let format_error : FStar_Range.range -> Prims.string -> Prims.string =
  fun r  ->
    fun msg  ->
      let uu____1928 = FStar_Range.string_of_range r  in
...
let rec sigelt_to_string_short : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    ...
    | FStar_Syntax_Syntax.Sig_let
        ((uu____1933,{ FStar_Syntax_Syntax.lbname = lb;
                       FStar_Syntax_Syntax.lbunivs = uu____1935;
                       FStar_Syntax_Syntax.lbtyp = t;
                       FStar_Syntax_Syntax.lbeff = uu____1937;
                       FStar_Syntax_Syntax.lbdef = uu____1938;_}::[]),uu____1939)
        ->
        let uu____1953 = lbname_to_string lb  in
        let uu____1954 = term_to_string t  in
        FStar_Util.format2 "let %s : %s" uu____1953 uu____1954
    | uu____1955 ->
        let uu____1956 =
...
let rec modul_to_string : FStar_Syntax_Syntax.modul -> Prims.string =
  fun m  ->
    let uu____1966 = sli m.FStar_Syntax_Syntax.name  in
    let uu____1967 =
      let uu____1968 =
        FStar_List.map sigelt_to_string m.FStar_Syntax_Syntax.declarations
         in
      FStar_All.pipe_right uu____1968 (FStar_String.concat "\n")  in
    FStar_Util.format2 "module %s\n%s" uu____1966 uu____1967
  
let subst_elt_to_string : FStar_Syntax_Syntax.subst_elt -> Prims.string =
  fun uu___220_1974  ->
    match uu___220_1974 with
    ...
    | FStar_Syntax_Syntax.NM (x,i) ->
        let uu____1981 = bv_to_string x  in
        let uu____1982 = FStar_Util.string_of_int i  in
        FStar_Util.format2 "NM (%s, %s)" uu____1981 uu____1982
    | FStar_Syntax_Syntax.NT (x,t) ->
        let uu____1989 = bv_to_string x  in
        let uu____1990 = term_to_string t  in
        FStar_Util.format2 "DB (%s, %s)" uu____1989 uu____1990
    | FStar_Syntax_Syntax.UN (i,u) ->
        let uu____1993 = FStar_Util.string_of_int i  in
        let uu____1994 = univ_to_string u  in
        FStar_Util.format2 "UN (%s, %s)" uu____1993 uu____1994
    | FStar_Syntax_Syntax.UD (u,i) ->
        let uu____1997 = FStar_Util.string_of_int i  in
        FStar_Util.format2 "UD (%s, %s)" u.FStar_Ident.idText uu____1997
...
let list_to_string f elts =
  ...
  | x::xs ->
      let strb = FStar_Util.new_string_builder ()  in
      (FStar_Util.string_builder_append strb "[";
       (let uu____2056 = f x  in
        FStar_Util.string_builder_append strb uu____2056);
       FStar_List.iter
         (fun x1  ->
            FStar_Util.string_builder_append strb "; ";
            (let uu____2060 = f x1  in
             FStar_Util.string_builder_append strb uu____2060)) xs;
       FStar_Util.string_builder_append strb "]";
       FStar_Util.string_of_string_builder strb)
...
let set_to_string f s =
  ...
  | x::xs ->
      let strb = FStar_Util.new_string_builder ()  in
      (FStar_Util.string_builder_append strb "{";
       (let uu____2092 = f x  in
        FStar_Util.string_builder_append strb uu____2092);
       FStar_List.iter
         (fun x1  ->
            FStar_Util.string_builder_append strb ", ";
            (let uu____2096 = f x1  in
             FStar_Util.string_builder_append strb uu____2096)) xs;
       FStar_Util.string_builder_append strb "}";
       FStar_Util.string_of_string_builder strb)
