            ...
            | FStar_Syntax_Syntax.Tm_match (sc, brs) ->
                ...
                let uu____4200 =
                  let uu____4219 =
                    FStar_List.map
                      (fun br ->
                         let uu____4234 = FStar_Syntax_Subst.open_branch br in
                 ...
                 (fun uu____4630 ->
                    fun g ->
                      ...
                      | (n1, gs1) ->
                          let phi =
                            let uu____4675 =
                              let uu____4678 = FStar_Tactics_Types.goal_env g in
                              let uu____4679 =
                          ...
                          ((let uu____4690 = FStar_ST.op_Bang tacdbg in
                            if uu____4690
                            then
                              let uu____4710 = FStar_Util.string_of_int n1 in
                              let uu____4711 =
                                let uu____4712 =
                                  FStar_Tactics_Types.goal_type g in
                                FStar_Syntax_Print.term_to_string uu____4712 in
                              FStar_Util.print2 "Got goal #%s: %s\n"
                                uu____4710 uu____4711
                            else ());
                           (let gt' =
                              let uu____4715 =
                                let uu____4716 = FStar_Util.string_of_int n1 in
              ...
              ((let uu____4985 =
                  FStar_List.existsML
                    (fun g ->
                       let uu____4989 =
                         let uu____4990 =
                           let uu____4993 = FStar_Tactics_Types.goal_env g in
                           let uu____4994 = FStar_Tactics_Types.goal_type g in
                           getprop uu____4993 uu____4994 in
                         FStar_Option.isSome uu____4990 in
                       Prims.op_Negation uu____4989) gs in
                if uu____4985
                then
                  FStar_Errors.raise_error
                    (FStar_Errors.Fatal_OpenGoalsInSynthesis,
