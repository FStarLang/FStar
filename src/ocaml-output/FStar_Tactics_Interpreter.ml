              ...
              (match uu____2669 with
               | (ps,w) ->
                   ((let uu____2683 = FStar_ST.op_Bang tacdbg  in
                     if uu____2683
                     then
                       let uu____2732 = FStar_Syntax_Print.term_to_string typ
                          in
            ...
            (match uu____3072 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(rett,FStar_Pervasives_Native.Some
                 ...
                 (match pol with
                  | Pos  ->
                      let uu____3162 = run_tactic_on_typ tactic e assertion
                         in
                      (match uu____3162 with
                       | (gs,uu____3170) ->
                           Simplified (FStar_Syntax_Util.t_true, gs))
                  | Both  ->
                      let uu____3177 = run_tactic_on_typ tactic e assertion
                         in
    ...
    fun x  ->
      fun y  ->
        ...
        | (Unchanged t1,Simplified (t2,gs)) ->
            let uu____3482 = let uu____3489 = f t1 t2  in (uu____3489, gs)
               in
                 ...
                 (match uu____3566 with
                  | (n2,p2,gs2) ->
                      let uu____3584 =
                        ...
                        (uu____3593, uu____3594, (FStar_List.append gs1 gs2))
                         in
                      Dual uu____3584))
                ...
                (match uu____4132 with
                 | (bs1,topen) ->
                     ...
                     comb2
                       (fun bs2  ->
                          fun t2  ->
                            let uu____4224 = FStar_Syntax_Util.abs bs2 t2 k
                               in
                    ...
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____4720 = FStar_ST.op_Bang tacdbg  in
                            if uu____4720
                            then
                              let uu____4769 = FStar_Util.string_of_int n1
                                 in
                              let uu____4770 =
                           ...
                           (let gt' =
                              let uu____4773 =
                                let uu____4774 = FStar_Util.string_of_int n1
                                   in
...
let reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____4846 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____4848 =
      let uu____4849 =
        let uu____4850 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit
           in
        let uu____4851 =
             ...
             let uu____4930 =
               FStar_List.existsML
                 (fun g  ->
                    ...
                    Prims.op_Negation uu____4934) gs
                in
             if uu____4930
             then
