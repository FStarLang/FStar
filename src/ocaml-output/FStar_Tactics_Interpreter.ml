...
let uu____2974 = (mktac3 "launch_process" FStar_Tactics_Basic.launch_process FStar_Syntax_Embeddings.e_string FStar_Syntax_Embeddings.e_string FStar_Syntax_Embeddings.e_string FStar_Syntax_Embeddings.e_string)
in (

let uu____2975 = (

let uu____2978 = (mktac2 "fresh_bv_named" FStar_Tactics_Basic.fresh_bv_named FStar_Syntax_Embeddings.e_string FStar_Reflection_Embeddings.e_term FStar_Reflection_Embeddings.e_bv)
in (

let uu____2979 = (

let uu____2982 = (mktac1 "change" FStar_Tactics_Basic.change FStar_Reflection_Embeddings.e_term FStar_Syntax_Embeddings.e_unit)
in (

let uu____2983 = (

let uu____2986 = (mktac1 "get_guard_policy" FStar_Tactics_Basic.get_guard_policy FStar_Syntax_Embeddings.e_unit FStar_Tactics_Embedding.e_guard_policy)
in (

let uu____2987 = (

let uu____2990 = (mktac1 "set_guard_policy" FStar_Tactics_Basic.set_guard_policy FStar_Tactics_Embedding.e_guard_policy FStar_Syntax_Embeddings.e_unit)
in (uu____2990)::(decr_depth_step)::(incr_depth_step)::(tracepoint_step)::(set_proofstate_range_step)::(push_binder_step)::[])
in (uu____2986)::uu____2987))
in (uu____2982)::uu____2983))
in (uu____2978)::uu____2979))
...
let uu____3019 = (FStar_Syntax_Syntax.as_arg x_tm)
in (uu____3019)::[])
in (FStar_Syntax_Syntax.mk_Tm_app f uu____3018))
in (uu____3013 FStar_Pervasives_Native.None rng))
...
let uu____3049 = (FStar_Syntax_Embeddings.embed FStar_Tactics_Embedding.e_proofstate rng proof_state)
in (FStar_Syntax_Syntax.as_arg uu____3049))
in (uu____3048)::[])
in (FStar_Syntax_Syntax.mk_Tm_app embedded_tac_b uu____3047))
in (uu____3042 FStar_Pervasives_Native.None rng))
in (
...
let uu____3056 = (FStar_TypeChecker_Env.debug proof_state.FStar_Tactics_Types.main_context (FStar_Options.Other ("TacVerbose")))
in (match (uu____3056) with
| true -> begin
(

let uu____3057 = (FStar_Syntax_Print.term_to_string tm)
...
let uu____3060 = (primitive_steps ())
in (FStar_TypeChecker_Normalize.normalize_with_primitive_steps uu____3060 steps proof_state.FStar_Tactics_Types.main_context tm))
in ((

let uu____3064 = (FStar_TypeChecker_Env.debug proof_state.FStar_Tactics_Types.main_context (FStar_Options.Other ("TacVerbose")))
in (match (uu____3064) with
| true -> begin
(

let uu____3065 = (FStar_Syntax_Print.term_to_string result)
...
let uu____3072 = (FStar_Tactics_Embedding.e_result eb)
in (FStar_Syntax_Embeddings.unembed uu____3072 result))
in (match (res) with
| FStar_Pervasives_Native.Some (FStar_Tactics_Result.Success (b, ps)) -> begin
(

let uu____3085 = (FStar_Tactics_Basic.set ps)
in (FStar_Tactics_Basic.bind uu____3085 (fun uu____3089 -> (FStar_Tactics_Basic.ret b))))
end
| FStar_Pervasives_Native.Some (FStar_Tactics_Result.Failed (msg, ps)) -> begin
(

let uu____3094 = (FStar_Tactics_Basic.set ps)
in (FStar_Tactics_Basic.bind uu____3094 (fun uu____3098 -> (FStar_Tactics_Basic.fail msg))))
end
...
let uu____3107 = (FStar_Syntax_Print.term_to_string result)
in (FStar_Util.format1 "Tactic got stuck! Please file a bug report with a minimal reproduction of this issue.\n%s" uu____3107))
in ((FStar_Errors.Fatal_TacticGotStuck), (uu____3106)))
in (FStar_Errors.raise_error uu____3101 proof_state.FStar_Tactics_Types.main_context.FStar_TypeChecker_Env.range))
end));
));
)))))))
...
let uu____3114 = (unembed_tactic_0 eb embedded_tac_b)
in (FStar_All.pipe_left (fun _0_18 -> FStar_Pervasives_Native.Some (_0_18)) uu____3114)))


let report_implicits : FStar_Tactics_Types.proofstate  ->  FStar_TypeChecker_Env.implicits  ->  unit = (fun ps is -> (

let errs = (FStar_List.map (fun uu____3170 -> (match (uu____3170) with
| (r, uu____3190, uv, uu____3192, ty, rng) -> begin
(

let uu____3195 = (

let uu____3196 = (FStar_Syntax_Print.uvar_to_string uv)
in (

let uu____3197 = (FStar_Syntax_Print.term_to_string ty)
in (FStar_Util.format3 "Tactic left uninstantiated unification variable %s of type %s (reason = \"%s\")" uu____3196 uu____3197 r)))
in ((FStar_Errors.Fatal_UninstantiatedUnificationVarInTactic), (uu____3195), (rng)))
end)) is)
in (match (errs) with
| [] -> begin
()
...
let uu____3252 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3252) with
| true -> begin
(

let uu____3282 = (FStar_Syntax_Print.term_to_string tactic)
...
let uu____3286 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3286) with
| true -> begin
(

let uu____3316 = (FStar_Syntax_Print.term_to_string tactic1)
...
let uu____3318 = (FStar_TypeChecker_TcTerm.tc_reified_tactic env tactic1)
in (match (uu____3318) with
| (uu____3331, uu____3332, g) -> begin
...
| (env1, uu____3353) -> begin
(

let env2 = (

let uu___63_3359 = env1
in {FStar_TypeChecker_Env.solver = uu___63_3359.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___63_3359.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___63_3359.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___63_3359.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___63_3359.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___63_3359.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___63_3359.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___63_3359.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___63_3359.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = false; FStar_TypeChecker_Env.effects = uu___63_3359.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___63_3359.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___63_3359.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___63_3359.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___63_3359.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___63_3359.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___63_3359.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___63_3359.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___63_3359.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___63_3359.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___63_3359.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___63_3359.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___63_3359.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___63_3359.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___63_3359.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___63_3359.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___63_3359.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___63_3359.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.normalized_eff_names = uu___63_3359.FStar_TypeChecker_Env.normalized_eff_names; FStar_TypeChecker_Env.proof_ns = uu___63_3359.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___63_3359.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___63_3359.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.is_native_tactic = uu___63_3359.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___63_3359.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___63_3359.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___63_3359.FStar_TypeChecker_Env.dsenv; FStar_TypeChecker_Env.dep_graph = uu___63_3359.FStar_TypeChecker_Env.dep_graph})
in (

let env3 = (

let uu___64_3361 = env2
in {FStar_TypeChecker_Env.solver = uu___64_3361.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___64_3361.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___64_3361.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___64_3361.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___64_3361.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___64_3361.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___64_3361.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___64_3361.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___64_3361.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___64_3361.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___64_3361.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___64_3361.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___64_3361.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___64_3361.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___64_3361.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___64_3361.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___64_3361.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___64_3361.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___64_3361.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.failhard = uu___64_3361.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___64_3361.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___64_3361.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___64_3361.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___64_3361.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___64_3361.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___64_3361.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___64_3361.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.normalized_eff_names = uu___64_3361.FStar_TypeChecker_Env.normalized_eff_names; FStar_TypeChecker_Env.proof_ns = uu___64_3361.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___64_3361.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___64_3361.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.is_native_tactic = uu___64_3361.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___64_3361.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___64_3361.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___64_3361.FStar_TypeChecker_Env.dsenv; FStar_TypeChecker_Env.dep_graph = uu___64_3361.FStar_TypeChecker_Env.dep_graph})
in (

let uu____3362 = (FStar_Tactics_Basic.proofstate_of_goal_ty env3 typ)
in (match (uu____3362) with
| (ps, w) -> begin
((

let uu____3376 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3376) with
| true -> begin
(

let uu____3406 = (FStar_Syntax_Print.term_to_string typ)
...
let uu____3408 = (FStar_Util.record_time (fun uu____3418 -> (FStar_Tactics_Basic.run tau ps)))
in (match (uu____3408) with
| (res, ms) -> begin
((

let uu____3432 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3432) with
| true -> begin
(

let uu____3462 = (FStar_Syntax_Print.term_to_string tactic1)
in (

let uu____3463 = (FStar_Util.string_of_int ms)
in (

let uu____3464 = (FStar_Syntax_Print.lid_to_string env3.FStar_TypeChecker_Env.curmodule)
...
(match (res) with
| FStar_Tactics_Result.Success (uu____3472, ps1) -> begin
((

let uu____3475 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3475) with
| true -> begin
(

let uu____3505 = (FStar_Syntax_Print.term_to_string w)
...
let uu____3512 = (FStar_Tactics_Basic.is_irrelevant g1)
in (match (uu____3512) with
| true -> begin
(

let uu____3513 = (FStar_TypeChecker_Rel.teq_nosmt g1.FStar_Tactics_Types.context g1.FStar_Tactics_Types.witness FStar_Syntax_Util.exp_unit)
...
let uu____3516 = (FStar_Syntax_Print.term_to_string g1.FStar_Tactics_Types.witness)
in (FStar_Util.format1 "Irrelevant tactic witness does not unify with (): %s" uu____3516))
...
let uu___65_3519 = FStar_TypeChecker_Rel.trivial_guard
in {FStar_TypeChecker_Env.guard_f = uu___65_3519.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___65_3519.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___65_3519.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = ps1.FStar_Tactics_Types.all_implicits})
in (

let g2 = (

let uu____3521 = (FStar_TypeChecker_Rel.solve_deferred_constraints env3 g1)
in (FStar_All.pipe_right uu____3521 FStar_TypeChecker_Rel.resolve_implicits_tac))
...
let uu____3529 = (FStar_TypeChecker_Normalize.psc_subst ps1.FStar_Tactics_Types.psc)
in (FStar_Tactics_Types.subst_proof_state uu____3529 ps1))
in (FStar_Tactics_Basic.dump_proofstate uu____3528 "at the time of failure"));
(

let uu____3530 = (

let uu____3535 = (FStar_Util.format1 "user tactic failed: %s" s)
in ((FStar_Errors.Fatal_ArgumentLengthMismatch), (uu____3535)))
in (FStar_Errors.raise_error uu____3530 typ.FStar_Syntax_Syntax.pos));
)
end);
)
end));
...
let tpure : 'Auu____3749 . 'Auu____3749  ->  'Auu____3749 tres_m = (fun x -> Unchanged (x))
...
let uu____3777 = (FStar_Syntax_Util.head_and_args t)
...
let uu____3828 = (FStar_Syntax_Util.un_uinst hd1)
in uu____3828.FStar_Syntax_Syntax.n)
in ((uu____3827), (args)))
in (match (uu____3814) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((rett, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____3841))))::((tactic, FStar_Pervasives_Native.None))::((assertion, FStar_Pervasives_Native.None))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.by_tactic_lid) -> begin
(match (pol) with
| Pos -> begin
(

let uu____3904 = (run_tactic_on_typ tactic e assertion)
...
let uu____3919 = (run_tactic_on_typ tactic e assertion)
...
let uu____3989 = (FStar_Tactics_Basic.goal_of_goal_ty e assertion)
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3989))
in (uu____3988)::[])
in ((FStar_Syntax_Util.t_true), (uu____3985)))
in Simplified (uu____3978))
end
| Both -> begin
(
...
let uu____4017 = (FStar_Tactics_Basic.goal_of_goal_ty e assertion)
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____4017))
in (uu____4016)::[])
in ((assertion), (FStar_Syntax_Util.t_true), (uu____4013)))
in Dual (uu____4000))
end
| Neg -> begin
Simplified (((assertion), ([])))
...
let comb1 : 'a 'b . ('a  ->  'b)  ->  'a tres_m  ->  'b tres_m = (fun f uu___62_4126 -> (match (uu___62_4126) with
| Unchanged (t) -> begin
(

let uu____4132 = (f t)
in Unchanged (uu____4132))
end
...
let uu____4229 = (f t1 t2)
in Unchanged (uu____4229))
end
...
let uu____4248 = (f t1 t2)
in ((uu____4248), (gs)))
in Simplified (uu____4241))
end
...
let uu____4269 = (f t1 t2)
in ((uu____4269), (gs)))
in Simplified (uu____4262))
end
...
let uu____4295 = (f t1 t2)
in ((uu____4295), ((FStar_List.append gs1 gs2))))
in Simplified (uu____4288))
end
| uu____4298 -> begin
(

let uu____4307 = (explode x)
in (match (uu____4307) with
| (n1, p1, gs1) -> begin
(

let uu____4325 = (explode y)
...
let uu____4352 = (f n1 n2)
in (

let uu____4353 = (f p1 p2)
in ((uu____4352), (uu____4353), ((FStar_List.append gs1 gs2)))))
in Dual (uu____4343))
end))
end))
end))
...
let uu____4425 = (comb2 (fun l r -> (l)::r) hd1 acc)
in (aux tl1 uu____4425))
end))
in (aux (FStar_List.rev rs) (tpure []))))


let emit : 'a . FStar_Tactics_Basic.goal Prims.list  ->  'a tres_m  ->  'a tres_m = (fun gs m -> (comb2 (fun uu____4473 x -> x) (Simplified (((()), (gs)))) m))
...
let uu____4516 = (FStar_Syntax_Subst.compress t)
...
let uu____4528 = (comb1 (fun t' -> FStar_Syntax_Syntax.Tm_uinst (((t'), (us)))))
in (uu____4528 tr)))
end
...
let uu____4554 = (comb1 (fun t' -> FStar_Syntax_Syntax.Tm_meta (((t'), (m)))))
in (uu____4554 tr)))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____4574; FStar_Syntax_Syntax.vars = uu____4575}, ((p, uu____4577))::((q, uu____4579))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.imp_lid) -> begin
(

let x = (

let uu____4619 = (FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero p)
in (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____4619))
in (
...
let uu____4622 = (FStar_TypeChecker_Env.push_bv e x)
in (traverse f pol uu____4622 q))
in (comb2 (fun l r -> (

let uu____4628 = (FStar_Syntax_Util.mk_imp l r)
in uu____4628.FStar_Syntax_Syntax.n)) r1 r2))))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____4632; FStar_Syntax_Syntax.vars = uu____4633}, ((p, uu____4635))::((q, uu____4637))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.iff_lid) -> begin
(

let xp = (

let uu____4677 = (FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero p)
in (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____4677))
in (

let xq = (

let uu____4679 = (FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero q)
in (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____4679))
in (

let r1 = (

let uu____4681 = (FStar_TypeChecker_Env.push_bv e xq)
in (traverse f Both uu____4681 p))
in (

let r2 = (

let uu____4683 = (FStar_TypeChecker_Env.push_bv e xp)
in (traverse f Both uu____4683 q))
in (match (((r1), (r2))) with
| (Unchanged (uu____4686), Unchanged (uu____4687)) -> begin
(comb2 (fun l r -> (

let uu____4697 = (FStar_Syntax_Util.mk_iff l r)
in uu____4697.FStar_Syntax_Syntax.n)) r1 r2)
end
| uu____4700 -> begin
(

let uu____4705 = (explode r1)
in (match (uu____4705) with
| (pn, pp, gs1) -> begin
(

let uu____4723 = (explode r2)
...
let uu____4744 = (FStar_Syntax_Util.mk_imp pn qp)
in (

let uu____4745 = (FStar_Syntax_Util.mk_imp qn pp)
in (FStar_Syntax_Util.mk_conj uu____4744 uu____4745)))
...
let r1 = (FStar_List.fold_right (fun uu____4797 r -> (match (uu____4797) with
| (a, q) -> begin
(
...
let uu____4915 = (FStar_Syntax_Subst.open_term bs t1)
...
let r0 = (FStar_List.map (fun uu____4949 -> (match (uu____4949) with
| (bv, aq) -> begin
(
...
let uu____4963 = (comb1 (fun s' -> (((

let uu___66_4989 = bv
in {FStar_Syntax_Syntax.ppname = uu___66_4989.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___66_4989.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s'})), (aq))))
in (uu____4963 r)))
end)) bs1)
in (
...
let uu____5009 = (FStar_Syntax_Util.abs bs2 t2 k)
in uu____5009.FStar_Syntax_Syntax.n)) rbs rt)))))
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, asc, ef) -> begin
(

let uu____5055 = (traverse f pol e t1)
in (

let uu____5060 = (comb1 (fun t2 -> FStar_Syntax_Syntax.Tm_ascribed (((t2), (asc), (ef)))))
in (uu____5060 uu____5055)))
end
| x -> begin
(tpure x)
end))
...
let uu___67_5100 = t
in {FStar_Syntax_Syntax.n = tn'; FStar_Syntax_Syntax.pos = uu___67_5100.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___67_5100.FStar_Syntax_Syntax.vars}))
end
| Simplified (tn', gs) -> begin
(

let uu____5107 = (f pol e (

let uu___68_5111 = t
in {FStar_Syntax_Syntax.n = tn'; FStar_Syntax_Syntax.pos = uu___68_5111.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___68_5111.FStar_Syntax_Syntax.vars}))
in (emit gs uu____5107))
end
| Dual (tn, tp, gs) -> begin
(
...
let uu___69_5121 = t
in {FStar_Syntax_Syntax.n = tp; FStar_Syntax_Syntax.pos = uu___69_5121.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___69_5121.FStar_Syntax_Syntax.vars}))
in (

let uu____5122 = (explode rp)
in (match (uu____5122) with
| (uu____5131, p', gs') -> begin
Dual ((((

let uu___70_5145 = t
in {FStar_Syntax_Syntax.n = tn; FStar_Syntax_Syntax.pos = uu___70_5145.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___70_5145.FStar_Syntax_Syntax.vars})), (p'), ((FStar_List.append gs gs'))))
end)))
end)))
...
let uu____5188 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("Tac")))
in (FStar_ST.op_Colon_Equals tacdbg uu____5188));
(

let uu____5219 = (FStar_ST.op_Bang tacdbg)
...
let uu____5250 = (FStar_TypeChecker_Env.all_binders env)
in (FStar_All.pipe_right uu____5250 (FStar_Syntax_Print.binders_to_string ",")))
in (

let uu____5251 = (FStar_Syntax_Print.term_to_string goal)
in (FStar_Util.print2 "About to preprocess %s |= %s\n" uu____5249 uu____5251)))
end
| uu____5252 -> begin
()
end));
...
let uu____5287 = (traverse by_tactic_interp Pos env goal)
...
let uu____5327 = (FStar_ST.op_Bang tacdbg)
...
let uu____5358 = (FStar_TypeChecker_Env.all_binders env)
in (FStar_All.pipe_right uu____5358 (FStar_Syntax_Print.binders_to_string ", ")))
in (

let uu____5359 = (FStar_Syntax_Print.term_to_string t')
...
let s1 = (FStar_List.fold_left (fun uu____5406 g -> (match (uu____5406) with
| (n1, gs1) -> begin
(

let phi = (

let uu____5451 = (getprop g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
...
let uu____5460 = (FStar_Syntax_Print.term_to_string g.FStar_Tactics_Types.goal_ty)
in (FStar_Util.format1 "Tactic returned proof-relevant goal: %s" uu____5460))
in ((FStar_Errors.Fatal_TacticProofRelevantGoal), (uu____5459)))
in (FStar_Errors.raise_error uu____5454 env.FStar_TypeChecker_Env.range))
end
...
let uu____5463 = (FStar_ST.op_Bang tacdbg)
in (match (uu____5463) with
| true -> begin
(

let uu____5493 = (FStar_Util.string_of_int n1)
in (

let uu____5494 = (FStar_Tactics_Basic.goal_to_string g)
...
let uu____5498 = (FStar_Util.string_of_int n1)
in (Prims.strcat "Could not prove goal #" uu____5498))
in (FStar_TypeChecker_Util.label uu____5497 goal.FStar_Syntax_Syntax.pos phi))
...
| (uu____5534, gs1) -> begin
(

let uu____5552 = (

let uu____5559 = (FStar_Options.peek ())
in ((env), (t'), (uu____5559)))
in (uu____5552)::gs1)
end))));
)
...
let uu____5573 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.reify_tactic_lid FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in (FStar_Syntax_Syntax.fv_to_tm uu____5573))
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____5572 ((FStar_Syntax_Syntax.U_zero)::[])))
in (
...
let uu____5584 = (FStar_Syntax_Syntax.as_arg a)
in (uu____5584)::[])
in (uu____5580)::uu____5581))
in (FStar_Syntax_Syntax.mk_Tm_app r uu____5579))
in (uu____5574 FStar_Pervasives_Native.None a.FStar_Syntax_Syntax.pos))))
...
let uu____5603 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("Tac")))
in (FStar_ST.op_Colon_Equals tacdbg uu____5603));
(

let uu____5633 = (

let uu____5640 = (reify_tactic tau)
in (run_tactic_on_typ uu____5640 env typ))
in (match (uu____5633) with
| (gs, w) -> begin
(

let uu____5647 = (FStar_List.existsML (fun g -> (

let uu____5651 = (

let uu____5652 = (getprop g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (FStar_Option.isSome uu____5652))
in (not (uu____5651)))) gs)
...
let uu____5671 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("Tac")))
in (FStar_ST.op_Colon_Equals tacdbg uu____5671));
(
...
let uu____5709 = (reify_tactic tau)
in (run_tactic_on_typ uu____5709 env typ))
in (match (uu____5702) with
| (gs, w) -> begin
((

let uu____5719 = (FStar_List.existsML (fun g -> (

let uu____5723 = (

let uu____5724 = (getprop g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (FStar_Option.isSome uu____5724))
in (not (uu____5723)))) gs)
...
let uu____5734 = (FStar_Syntax_Embeddings.e_list FStar_Reflection_Embeddings.e_sigelt)
in (FStar_Syntax_Embeddings.unembed uu____5734 w1))
in (FStar_All.pipe_left FStar_Util.must uu____5729)));
)
end)));
))
