           ...
           (match r with
            | FStar_Tactics_Basic.Success (uu____1432,ps1) ->
                ((let uu____1435 = FStar_ST.read tacdbg in
                 ...
                 (let g =
                    let uu___115_1452 = FStar_TypeChecker_Rel.trivial_guard in
                    {
  ...
  fun env  ->
    fun typ  ->
      fun tau  ->
        (let uu____2361 =
           FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac") in
         FStar_ST.write tacdbg uu____2361);
        (let uu____2364 =
           let uu____2368 =
             let uu____2370 = reify_tactic tau in
             unembed_tactic_0 FStar_Reflection_Basic.unembed_unit uu____2370 in
           run_tactic_on_typ uu____2368 env typ in
         match uu____2364 with
         | (gs,w) ->
             (match gs with
              | [] -> w
              | uu____2375::uu____2376 ->
                  raise
                    (FStar_Errors.Error
