              ...
              | (embedded_state,uu____57)::[] ->
                  (FStar_Tactics_Basic.log ps
                     (fun uu____78  ->
                        ...
                        let uu____80 = FStar_Syntax_Print.args_to_string args
                           in
              ...
              fun args  ->
                ...
                | (b,uu____159)::(embedded_state,uu____161)::[] ->
                    (FStar_Tactics_Basic.log ps
                     ...
                     (let ps1 =
                      ...
                      let res =
                        let uu____199 =
                          let uu____202 = unembed_b b  in t uu____202  in
                ...
                | uu____204 ->
                    let uu____205 =
                      ...
                      let uu____207 = FStar_Syntax_Print.args_to_string args
                         in
                      FStar_Util.format2
                       ...
                       (let ps1 =
                        ...
                        let res =
                          let uu____351 =
                            ...
                            let uu____355 = unembed_b b  in
                            t uu____354 uu____355  in
                ...
                fun nm  ->
                  fun args  ->
                    ...
                    | (a,uu____471)::(b,uu____473)::(c,uu____475)::(embedded_state,uu____477)::[]
                        ...
                        (FStar_Tactics_Basic.log ps
                           (fun uu____528  ->
                              let uu____529 = FStar_Ident.string_of_lid nm
                                 in
                              let uu____530 =
                                FStar_Syntax_Print.term_to_string
                                  embedded_state
                         ...
                         (let ps1 =
                          ...
                          let res =
                            let uu____535 =
                              ...
                              let uu____540 = unembed_c c  in
                              t uu____538 uu____539 uu____540  in
                ...
                fun embed_f  ->
                  fun t_f  ->
                    fun nm  ->
                      fun args  ->
                        match args with
                        | (a,uu____694)::(b,uu____696)::(c,uu____698)::
                            (d,uu____700)::(e,uu____702)::(embedded_state,uu____704)::[]
                            ->
                            (FStar_Tactics_Basic.log ps
                               (fun uu____775  ->
                                  let uu____776 =
                             ...
                             (let ps1 =
                              ...
                              let res =
                                let uu____782 =
                                  ...
                                  t uu____785 uu____786 uu____787 uu____788
                                    uu____789
                                   in
                        ...
                        | uu____791 ->
                            let uu____792 =
                              let uu____793 = FStar_Ident.string_of_lid nm
                                 in
                              let uu____794 =
                                FStar_Syntax_Print.args_to_string args  in
                              FStar_Util.format2
...
let step_from_native_step :
  ...
  fun ps  ->
    fun s  ->
      (let uu____806 = FStar_Ident.string_of_lid s.FStar_Tactics_Native.name
          in
            ...
            let uu____1279 =
              ...
              mktac0 "__intro_rec" FStar_Tactics_Basic.intro_rec
                (FStar_Reflection_Basic.embed_pair
                   ...
                   FStar_Reflection_Data.fstar_refl_binder
                   FStar_Reflection_Basic.embed_binder
                   FStar_Reflection_Data.fstar_refl_binder) uu____1280
               in
            let uu____1289 =
              let uu____1292 =
      ...
      FStar_Tactics_Basic.bind FStar_Tactics_Basic.get
        (fun proof_state  ->
           let tm =
             ...
             uu____1450 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let steps =
                ...
                (match uu____2131 with
                 | (p',gs1) ->
                     ...
                     (match uu____2150 with
                      | (q',gs2) ->
                          let uu____2170 =
                            let uu____2171 = FStar_Syntax_Util.mk_imp p' q'
                               in
                    ...
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____2875 = FStar_ST.read tacdbg  in
                            if uu____2875
                            then
                              let uu____2876 = FStar_Util.string_of_int n1
                                 in
                              let uu____2877 =
                           ...
                           (let gt' =
                              let uu____2880 =
                                let uu____2881 = FStar_Util.string_of_int n1
                                   in
...
let reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____2954 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____2956 =
      let uu____2957 =
      ...
      fun tau  ->
        ...
        (let uu____2979 =
           let uu____2986 =
             ...
             unembed_tactic_0 FStar_Reflection_Basic.unembed_unit uu____2989
              in
