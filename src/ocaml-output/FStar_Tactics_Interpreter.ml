                   ...
                   ((let uu____2526 = FStar_ST.op_Bang tacdbg in
                    ...
                    (let uu____2548 =
                       FStar_Util.record_time
                         (fun uu____2558  -> FStar_Tactics_Basic.run tau ps) in
    ...
    fun x  ->
      fun y  ->
        ...
        | (Unchanged t1,Simplified (t2,gs)) ->
            let uu____3310 = let uu____3317 = f t1 t2 in (uu____3317, gs) in
            Simplified uu____3310
        | (Simplified (t1,gs),Unchanged t2) ->
            let uu____3331 = let uu____3338 = f t1 t2 in (uu____3338, gs) in
                 ...
                 (match uu____3394 with
                  | (n2,p2,gs2) ->
                      let uu____3412 =
                        ...
                        (uu____3421, uu____3422, (FStar_List.append gs1 gs2)) in
                      Dual uu____3412))
...
let reify_tactic: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____4558 [FStar_Syntax_Syntax.U_zero] in
    let uu____4560 =
      let uu____4561 =
             ...
             let uu____4613 =
               FStar_List.existsML
                 (fun g  ->
                    ...
                    Prims.op_Negation uu____4617) gs in
             if uu____4613
             then
