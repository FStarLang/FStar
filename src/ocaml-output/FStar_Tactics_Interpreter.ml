                                 ...
                                 FStar_Util.bind_opt uu____588
                                   (fun b1  ->
                                      let res =
                                        ...
                                        FStar_Tactics_Basic.run uu____600 ps1
                                         in
                                      let uu____603 =
                                        let uu____604 =
                             ...
                             let uu____2800 =
                               let uu____2805 =
                                 FStar_Util.format1 "user tactic failed: %s"
                                   s
                                  in
                               (uu____2805, (typ.FStar_Syntax_Syntax.pos))
                                in
                ...
                (match uu____3269 with
                 | (p',gs1) ->
                     ...
                     (match uu____3288 with
                      | (q',gs2) ->
                          let uu____3308 =
                            let uu____3309 = FStar_Syntax_Util.mk_imp p' q'
                               in
                    ...
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____4151 = FStar_ST.op_Bang tacdbg  in
                            if uu____4151
                            then
                              let uu____4198 = FStar_Util.string_of_int n1
                                 in
                              let uu____4199 =
                           ...
                           (let gt' =
                              let uu____4202 =
                                let uu____4203 = FStar_Util.string_of_int n1
                                   in
...
let reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____4276 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____4278 =
      let uu____4279 =
        let uu____4280 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit
           in
        let uu____4281 =
