  ...
  | (b,uu____144)::(embedded_state,uu____146)::[] ->
      (FStar_Tactics_Basic.log ps
         (fun uu____168  ->
            ...
            let uu____170 = FStar_Syntax_Print.term_to_string embedded_state
               in
  ...
  | (a,uu____269)::(b,uu____271)::(embedded_state,uu____273)::[] ->
      (FStar_Tactics_Basic.log ps
         (fun uu____303  ->
            ...
            let uu____305 = FStar_Syntax_Print.term_to_string embedded_state
               in
            FStar_Util.print2 "Reached %s, goals are: %s\n" uu____304
              uu____305);
       (let ps1 =
  ...
  | (a,uu____424)::(b,uu____426)::(c,uu____428)::(embedded_state,uu____430)::[]
      ...
      (FStar_Tactics_Basic.log ps
         (fun uu____468  ->
            ...
            let uu____470 = FStar_Syntax_Print.term_to_string embedded_state
               in
            FStar_Util.print2 "Reached %s, goals are: %s\n" uu____469
              uu____470);
       (let ps1 =
        ...
        let res =
          let uu____474 =
            ...
            let uu____478 = unembed_c c  in t uu____476 uu____477 uu____478
             in
  ...
  | (a,uu____628)::(b,uu____630)::(c,uu____632)::(d,uu____634)::(e,uu____636)::
      ...
      (FStar_Tactics_Basic.log ps
         (fun uu____692  ->
            ...
            let uu____694 = FStar_Syntax_Print.term_to_string embedded_state
               in
            FStar_Util.print2 "Reached %s, goals are: %s\n" uu____693
              uu____694);
       (let ps1 =
...
let step_from_native_step :
  ...
  fun ps  ->
    fun s  ->
      (let uu____720 = FStar_Ident.string_of_lid s.FStar_Tactics_Native.name
          in
           ...
           (match r with
            | FStar_Tactics_Basic.Success (uu____1413,ps1) ->
                ((let uu____1416 = FStar_ST.read tacdbg  in
                 ...
                 FStar_List.iter
                   (fun g  ->
                      let uu____1423 = FStar_Tactics_Basic.is_irrelevant g
                         in
                      if uu____1423
                      then
                        let uu____1424 =
                 ...
                 (let g =
                    let uu___111_1430 = FStar_TypeChecker_Rel.trivial_guard
                       in
                    {
                ...
                (match uu____1760 with
                 | (p',gs1) ->
                     ...
                     (match uu____1772 with
                      | (q',gs2) ->
                          let uu____1784 =
                            let uu____1785 = FStar_Syntax_Util.mk_imp p' q'
                               in
                    ...
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____2241 = FStar_ST.read tacdbg  in
                            if uu____2241
                            then
                              let uu____2244 = FStar_Util.string_of_int n1
                                 in
                              let uu____2245 =
                           ...
                           (let gt' =
                              let uu____2248 =
                                let uu____2249 = FStar_Util.string_of_int n1
                                   in
...
let reify_tactic :
  ...
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____2291 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____2293 =
      let uu____2294 =
      ...
      fun tau  ->
        let uu____2315 =
          let uu____2319 =
            ...
            unembed_tactic_0 FStar_Reflection_Basic.unembed_unit uu____2321
             in
