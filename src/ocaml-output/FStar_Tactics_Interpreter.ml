...
let uu____1561 = (mktac2 "__rename_to" FStar_Tactics_Basic.rename_to FStar_Reflection_Basic.unembed_binder FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1562 = (

let uu____1565 = (mktac1 "__binder_retype" FStar_Tactics_Basic.binder_retype FStar_Reflection_Basic.unembed_binder FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1566 = (

let uu____1569 = (mktac0 "__revert" FStar_Tactics_Basic.revert FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1570 = (

let uu____1573 = (mktac0 "__clear_top" FStar_Tactics_Basic.clear_top FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1574 = (

let uu____1577 = (mktac1 "__clear" FStar_Tactics_Basic.clear FStar_Reflection_Basic.unembed_binder FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1578 = (

let uu____1581 = (mktac1 "__rewrite" FStar_Tactics_Basic.rewrite FStar_Reflection_Basic.unembed_binder FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1582 = (

let uu____1585 = (mktac0 "__smt" FStar_Tactics_Basic.smt FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1586 = (

let uu____1589 = (mktac1 "__exact" FStar_Tactics_Basic.exact FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1590 = (

let uu____1593 = (mktac1 "__apply" (FStar_Tactics_Basic.apply true) FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1594 = (

let uu____1597 = (mktac1 "__apply_raw" (FStar_Tactics_Basic.apply false) FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1598 = (

let uu____1601 = (mktac1 "__apply_lemma" FStar_Tactics_Basic.apply_lemma FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1602 = (

let uu____1605 = (mktac5 "__divide" (fun uu____1616 uu____1617 -> FStar_Tactics_Basic.divide) (fun _0_67 -> FStar_Pervasives_Native.Some (_0_67)) (fun _0_68 -> FStar_Pervasives_Native.Some (_0_68)) FStar_Syntax_Embeddings.unembed_int (unembed_tactic_0' (fun _0_69 -> FStar_Pervasives_Native.Some (_0_69))) (unembed_tactic_0' (fun _0_70 -> FStar_Pervasives_Native.Some (_0_70))) (FStar_Syntax_Embeddings.embed_pair (fun t -> t) FStar_Syntax_Syntax.t_unit (fun t -> t) FStar_Syntax_Syntax.t_unit) FStar_Syntax_Syntax.t_unit)
in (

let uu____1622 = (

let uu____1625 = (mktac1 "__set_options" FStar_Tactics_Basic.set_options FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1626 = (

let uu____1629 = (mktac2 "__seq" FStar_Tactics_Basic.seq (unembed_tactic_0' FStar_Syntax_Embeddings.unembed_unit) (unembed_tactic_0' FStar_Syntax_Embeddings.unembed_unit) FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1634 = (

let uu____1637 = (mktac1 "__tc" FStar_Tactics_Basic.tc FStar_Reflection_Basic.unembed_term FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term)
in (

let uu____1638 = (

let uu____1641 = (mktac1 "__unshelve" FStar_Tactics_Basic.unshelve FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1642 = (

let uu____1645 = (mktac2 "__unquote" FStar_Tactics_Basic.unquote (fun _0_71 -> FStar_Pervasives_Native.Some (_0_71)) FStar_Reflection_Basic.unembed_term (fun t -> t) FStar_Syntax_Syntax.t_unit)
in (

let uu____1648 = (

let uu____1651 = (mktac1 "__prune" FStar_Tactics_Basic.prune FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1652 = (

let uu____1655 = (mktac1 "__addns" FStar_Tactics_Basic.addns FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1656 = (

let uu____1659 = (mktac1 "__print" (fun x -> ((FStar_Tactics_Basic.tacprint x);
...
let uu____1667 = (mktac1 "__dump" FStar_Tactics_Basic.print_proof_state FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1668 = (

let uu____1671 = (mktac1 "__dump1" FStar_Tactics_Basic.print_proof_state1 FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1672 = (

let uu____1675 = (mktac2 "__pointwise" FStar_Tactics_Basic.pointwise FStar_Tactics_Embedding.unembed_direction (unembed_tactic_0' FStar_Syntax_Embeddings.unembed_unit) FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1678 = (

let uu____1681 = (mktac0 "__trefl" FStar_Tactics_Basic.trefl FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1682 = (

let uu____1685 = (mktac0 "__later" FStar_Tactics_Basic.later FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1686 = (

let uu____1689 = (mktac0 "__dup" FStar_Tactics_Basic.dup FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1690 = (

let uu____1693 = (mktac0 "__flip" FStar_Tactics_Basic.flip FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (

let uu____1694 = (

let uu____1697 = (mktac0 "__qed" FStar_Tactics_Basic.qed FStar_Syntax_Embeddings.embed_unit FStar_Syntax_Syntax.t_unit)
in (
...
let uu____1702 = (FStar_Tactics_Embedding.pair_typ FStar_Syntax_Syntax.t_term FStar_Syntax_Syntax.t_term)
in (mktac1 "__cases" FStar_Tactics_Basic.cases FStar_Reflection_Basic.unembed_term (FStar_Syntax_Embeddings.embed_pair FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term) uu____1702))
in (

let uu____1707 = (

let uu____1710 = (mktac0 "__top_env" FStar_Tactics_Basic.top_env FStar_Reflection_Basic.embed_env FStar_Reflection_Data.fstar_refl_env)
in (

let uu____1711 = (

let uu____1714 = (mktac0 "__cur_env" FStar_Tactics_Basic.cur_env FStar_Reflection_Basic.embed_env FStar_Reflection_Data.fstar_refl_env)
in (

let uu____1715 = (

let uu____1718 = (mktac0 "__cur_goal" FStar_Tactics_Basic.cur_goal' FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term)
in (

let uu____1719 = (

let uu____1722 = (mktac0 "__cur_witness" FStar_Tactics_Basic.cur_witness FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term)
in (

let uu____1723 = (

let uu____1726 = (mktac2 "__uvar_env" FStar_Tactics_Basic.uvar_env FStar_Reflection_Basic.unembed_env (FStar_Syntax_Embeddings.unembed_option FStar_Reflection_Basic.unembed_term) FStar_Reflection_Basic.embed_term FStar_Syntax_Syntax.t_term)
in (

let uu____1729 = (

let uu____1732 = (mktac2 "__unify" FStar_Tactics_Basic.unify FStar_Reflection_Basic.unembed_term FStar_Reflection_Basic.unembed_term FStar_Syntax_Embeddings.embed_bool FStar_Syntax_Syntax.t_bool)
in (

let uu____1733 = (

let uu____1736 = (mktac3 "__launch_process" FStar_Tactics_Basic.launch_process FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.unembed_string FStar_Syntax_Embeddings.embed_string FStar_Syntax_Syntax.t_string)
in (uu____1736)::(decr_depth_step)::(incr_depth_step)::(tracepoint_step)::[])
in (uu____1732)::uu____1733))
in (uu____1726)::uu____1729))
in (uu____1722)::uu____1723))
in (uu____1718)::uu____1719))
in (uu____1714)::uu____1715))
in (uu____1710)::uu____1711))
in (uu____1701)::uu____1707))
in (uu____1697)::uu____1698))
in (uu____1693)::uu____1694))
in (uu____1689)::uu____1690))
in (uu____1685)::uu____1686))
in (uu____1681)::uu____1682))
in (uu____1675)::uu____1678))
in (uu____1671)::uu____1672))
in (uu____1667)::uu____1668))
in (uu____1659)::uu____1664))
in (uu____1655)::uu____1656))
in (uu____1651)::uu____1652))
in (uu____1645)::uu____1648))
in (uu____1641)::uu____1642))
in (uu____1637)::uu____1638))
in (uu____1629)::uu____1634))
in (uu____1625)::uu____1626))
in (uu____1605)::uu____1622))
in (uu____1601)::uu____1602))
in (uu____1597)::uu____1598))
in (uu____1593)::uu____1594))
in (uu____1589)::uu____1590))
in (uu____1585)::uu____1586))
in (uu____1581)::uu____1582))
in (uu____1577)::uu____1578))
in (uu____1573)::uu____1574))
in (uu____1569)::uu____1570))
in (uu____1565)::uu____1566))
in (uu____1561)::uu____1562))
...
let uu____1760 = (FStar_Tactics_Embedding.embed_proofstate proof_state)
in (FStar_Syntax_Syntax.as_arg uu____1760))
in (uu____1759)::[])
in (FStar_Syntax_Syntax.mk_Tm_app embedded_tac_b uu____1758))
in (uu____1757 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____1767 = (FStar_ST.op_Bang tacdbg)
in (match (uu____1767) with
| true -> begin
(

let uu____1814 = (FStar_Syntax_Print.term_to_string tm)
...
let uu____1817 = (primitive_steps ())
in (FStar_TypeChecker_Normalize.normalize_with_primitive_steps uu____1817 steps proof_state.FStar_Tactics_Types.main_context tm))
in ((

let uu____1821 = (FStar_ST.op_Bang tacdbg)
in (match (uu____1821) with
| true -> begin
(

let uu____1868 = (FStar_Syntax_Print.term_to_string result)
...
let uu____1870 = (FStar_Tactics_Embedding.unembed_result proof_state result unembed_b)
in (match (uu____1870) with
| FStar_Pervasives_Native.Some (FStar_Util.Inl (b, ps)) -> begin
(

let uu____1909 = (FStar_Tactics_Basic.set ps)
in (FStar_Tactics_Basic.bind uu____1909 (fun uu____1913 -> (FStar_Tactics_Basic.ret b))))
end
| FStar_Pervasives_Native.Some (FStar_Util.Inr (msg, ps)) -> begin
(

let uu____1936 = (FStar_Tactics_Basic.set ps)
in (FStar_Tactics_Basic.bind uu____1936 (fun uu____1940 -> (FStar_Tactics_Basic.fail msg))))
end
...
let uu____1960 = (FStar_Syntax_Print.term_to_string result)
in (FStar_Util.format1 "Tactic got stuck! Please file a bug report with a minimal reproduction of this issue.\n%s" uu____1960))
in ((uu____1959), (proof_state.FStar_Tactics_Types.main_context.FStar_TypeChecker_Env.range)))
in FStar_Errors.Error (uu____1954))
in (FStar_Exn.raise uu____1953))
end));
));
))))))
...
let uu____1969 = (unembed_tactic_0 unembed_b embedded_tac_b)
in (FStar_All.pipe_left (fun _0_72 -> FStar_Pervasives_Native.Some (_0_72)) uu____1969)))


let report_implicits : FStar_Tactics_Types.proofstate  ->  FStar_TypeChecker_Env.implicits  ->  Prims.unit = (fun ps is -> (

let errs = (FStar_List.map (fun uu____2019 -> (match (uu____2019) with
| (r, uu____2037, uv, uu____2039, ty, rng) -> begin
(

let uu____2042 = (

let uu____2043 = (FStar_Syntax_Print.uvar_to_string uv)
in (

let uu____2044 = (FStar_Syntax_Print.term_to_string ty)
in (FStar_Util.format3 "Tactic left uninstantiated unification variable %s of type %s (reason = \"%s\")" uu____2043 uu____2044 r)))
in ((uu____2042), (rng)))
end)) is)
in (match (errs) with
| [] -> begin
...
let uu____2092 = (FStar_ST.op_Bang tacdbg)
in (match (uu____2092) with
| true -> begin
(

let uu____2139 = (FStar_Syntax_Print.term_to_string tactic)
...
let uu____2190 = (FStar_Syntax_Print.term_to_string tactic1)
...
let uu____2192 = (FStar_TypeChecker_TcTerm.tc_reified_tactic env tactic1)
in (match (uu____2192) with
| (tactic2, uu____2206, g) -> begin
...
let uu____2213 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (uu____2213) with
| (env1, uu____2227) -> begin
(

let env2 = (

let uu___163_2233 = env1
in {FStar_TypeChecker_Env.solver = uu___163_2233.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___163_2233.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___163_2233.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___163_2233.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___163_2233.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___163_2233.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___163_2233.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___163_2233.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___163_2233.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = false; FStar_TypeChecker_Env.effects = uu___163_2233.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___163_2233.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___163_2233.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___163_2233.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___163_2233.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___163_2233.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___163_2233.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___163_2233.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___163_2233.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___163_2233.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___163_2233.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___163_2233.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___163_2233.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___163_2233.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___163_2233.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___163_2233.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___163_2233.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___163_2233.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___163_2233.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___163_2233.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___163_2233.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___163_2233.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___163_2233.FStar_TypeChecker_Env.dsenv})
in (

let uu____2234 = (FStar_Tactics_Basic.proofstate_of_goal_ty env2 typ)
...
let uu____2296 = (FStar_Tactics_Basic.run tau ps)
in (match (uu____2296) with
| FStar_Tactics_Result.Success (uu____2305, ps1) -> begin
((

let uu____2308 = (FStar_ST.op_Bang tacdbg)
in (match (uu____2308) with
| true -> begin
(

let uu____2355 = (FStar_Syntax_Print.term_to_string w)
...
let uu____2362 = (FStar_Tactics_Basic.is_irrelevant g1)
in (match (uu____2362) with
| true -> begin
(

let uu____2363 = (FStar_TypeChecker_Rel.teq_nosmt g1.FStar_Tactics_Types.context g1.FStar_Tactics_Types.witness FStar_Syntax_Util.exp_unit)
...
let uu____2366 = (FStar_Syntax_Print.term_to_string g1.FStar_Tactics_Types.witness)
in (FStar_Util.format1 "Irrelevant tactic witness does not unify with (): %s" uu____2366))
in (failwith uu____2365))
end))
end
| uu____2367 -> begin
()
...
let uu___164_2369 = FStar_TypeChecker_Rel.trivial_guard
in {FStar_TypeChecker_Env.guard_f = uu___164_2369.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___164_2369.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___164_2369.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = ps1.FStar_Tactics_Types.all_implicits})
in (

let g2 = (

let uu____2371 = (FStar_TypeChecker_Rel.solve_deferred_constraints env2 g1)
in (FStar_All.pipe_right uu____2371 FStar_TypeChecker_Rel.resolve_implicits_tac))
...
let uu____2384 = (FStar_Util.format1 "user tactic failed: %s" s)
in ((uu____2384), (typ.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____2379))
in (FStar_Exn.raise uu____2378));
)
end));
)
end)))
...
let uu____2429 = (FStar_Syntax_Util.head_and_args t)
...
let uu____2486 = (FStar_Syntax_Util.un_uinst hd1)
in uu____2486.FStar_Syntax_Syntax.n)
in ((uu____2485), (args)))
in (match (uu____2472) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((rett, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____2505))))::((tactic, FStar_Pervasives_Native.None))::((assertion, FStar_Pervasives_Native.None))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.by_tactic_lid) -> begin
(match ((Prims.op_Equality pol Pos)) with
| true -> begin
(

let uu____2574 = (run_tactic_on_typ tactic e assertion)
...
let uu____2644 = (FStar_Tactics_Basic.goal_of_goal_ty e assertion)
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____2644))
in (uu____2643)::[])
in ((FStar_Syntax_Util.t_true), (uu____2640)))
end
| uu____2655 -> begin
((assertion), ([]))
end)
...
let uu____2780 = (traverse f pol e t1)
in (match (uu____2780) with
| (t', gs) -> begin
((FStar_Syntax_Syntax.Tm_meta (((t'), (m)))), (gs))
end))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____2802; FStar_Syntax_Syntax.vars = uu____2803}, ((p, uu____2805))::((q, uu____2807))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.imp_lid) -> begin
(

let x = (

let uu____2847 = (FStar_Syntax_Util.mk_squash p)
in (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____2847))
in (

let uu____2848 = (traverse f (flip pol) e p)
...
let uu____2874 = (FStar_TypeChecker_Env.push_bv e x)
in (traverse f pol uu____2874 q))
...
let uu____2888 = (FStar_Syntax_Util.mk_imp p' q')
in uu____2888.FStar_Syntax_Syntax.n)
in ((uu____2887), ((FStar_List.append gs1 gs2))))
end))
end)))
end
...
let uu____2915 = (traverse f pol e hd1)
in (match (uu____2915) with
| (hd', gs1) -> begin
(

let uu____2934 = (FStar_List.fold_right (fun uu____2972 uu____2973 -> (match (((uu____2972), (uu____2973))) with
| ((a, q), (as', gs)) -> begin
(

let uu____3054 = (traverse f pol e a)
...
let uu____3158 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____3187 = (FStar_List.map (fun uu____3220 -> (match (uu____3220) with
| (bv, aq) -> begin
(

let uu____3237 = (traverse f (flip pol) e bv.FStar_Syntax_Syntax.sort)
in (match (uu____3237) with
| (s', gs) -> begin
(((((

let uu___165_3267 = bv
in {FStar_Syntax_Syntax.ppname = uu___165_3267.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___165_3267.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s'})), (aq))), (gs))
end))
end)) bs1)
in (FStar_All.pipe_left FStar_List.unzip uu____3187))
...
let uu____3331 = (traverse f pol e' topen)
...
let uu____3351 = (FStar_Syntax_Util.abs bs2 topen' k)
in uu____3351.FStar_Syntax_Syntax.n)
in ((uu____3350), ((FStar_List.append gs11 gs2))))
end)))
end)))
end))
end
...
let uu___166_3374 = t
in {FStar_Syntax_Syntax.n = tn'; FStar_Syntax_Syntax.pos = uu___166_3374.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___166_3374.FStar_Syntax_Syntax.vars})
in (

let uu____3375 = (f pol e t')
...
let uu____3434 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("Tac")))
in (FStar_ST.op_Colon_Equals tacdbg uu____3434));
(
...
let uu____3530 = (FStar_TypeChecker_Env.all_binders env)
in (FStar_All.pipe_right uu____3530 (FStar_Syntax_Print.binders_to_string ",")))
in (

let uu____3531 = (FStar_Syntax_Print.term_to_string goal)
...
let uu____3560 = (traverse by_tactic_interp Pos env goal)
in (match (uu____3560) with
| (t', gs) -> begin
((

let uu____3582 = (FStar_ST.op_Bang tacdbg)
...
let uu____3630 = (FStar_TypeChecker_Env.all_binders env)
in (FStar_All.pipe_right uu____3630 (FStar_Syntax_Print.binders_to_string ", ")))
in (

let uu____3631 = (FStar_Syntax_Print.term_to_string t')
...
let s1 = (FStar_List.fold_left (fun uu____3678 g -> (match (uu____3678) with
| (n1, gs1) -> begin
(

let phi = (

let uu____3723 = (getprop g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
...
let uu____3727 = (FStar_Syntax_Print.term_to_string g.FStar_Tactics_Types.goal_ty)
in (FStar_Util.format1 "Tactic returned proof-relevant goal: %s" uu____3727))
in (failwith uu____3726))
end
...
let uu____3730 = (FStar_ST.op_Bang tacdbg)
in (match (uu____3730) with
| true -> begin
(

let uu____3777 = (FStar_Util.string_of_int n1)
in (

let uu____3778 = (FStar_Tactics_Basic.goal_to_string g)
...
let uu____3782 = (FStar_Util.string_of_int n1)
in (Prims.strcat "Could not prove goal #" uu____3782))
in (FStar_TypeChecker_Util.label uu____3781 goal.FStar_Syntax_Syntax.pos phi))
...
| (uu____3818, gs1) -> begin
(

let uu____3836 = (

let uu____3843 = (FStar_Options.peek ())
in ((env), (t'), (uu____3843)))
in (uu____3836)::gs1)
end))));
)
...
let uu____3856 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.reify_tactic_lid FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in (FStar_Syntax_Syntax.fv_to_tm uu____3856))
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____3855 ((FStar_Syntax_Syntax.U_zero)::[])))
in (
...
let uu____3859 = (FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit)
in (

let uu____3860 = (

let uu____3863 = (FStar_Syntax_Syntax.as_arg a)
in (uu____3863)::[])
in (uu____3859)::uu____3860))
in (FStar_Syntax_Syntax.mk_Tm_app r uu____3858))
in (uu____3857 FStar_Pervasives_Native.None a.FStar_Syntax_Syntax.pos))))
...
let uu____3879 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("Tac")))
in (FStar_ST.op_Colon_Equals tacdbg uu____3879));
(

let uu____3926 = (

let uu____3933 = (reify_tactic tau)
in (run_tactic_on_typ uu____3933 env typ))
in (match (uu____3926) with
| (gs, w) -> begin
(

let uu____3940 = (FStar_List.existsML (fun g -> (

let uu____3944 = (

let uu____3945 = (getprop g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (FStar_Option.isSome uu____3945))
in (not (uu____3944)))) gs)
