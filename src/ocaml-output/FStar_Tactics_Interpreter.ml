...
let (uu___143 : unit) =
  let uu____1131 =
    ...
    FStar_All.pipe_left
      (fun uu____1770 -> FStar_Pervasives_Native.Some uu____1770) uu____1136 in
        ...
        fun ncb ->
          FStar_Pervasives_Native.Some
            (fun x ->
               ...
               let app =
                 let uu____1849 =
                   let uu____1850 = FStar_Syntax_Syntax.as_arg x_tm in
                   [uu____1850] in
                 FStar_Syntax_Syntax.mk_Tm_app f uu____1849 rng in
               unembed_tactic_0 er app ncb)
let e_tactic_1_alt :
  'a 'r .
    'a FStar_Syntax_Embeddings.embedding ->
  ...
  fun ea ->
    fun er ->
      let em uu____1939 uu____1940 uu____1941 uu____1942 =
        failwith "Impossible: embedding tactic (1)?" in
      let un t0 w n =
        let uu____1988 = unembed_tactic_1_alt ea er t0 n in
        match uu____1988 with
        | FStar_Pervasives_Native.Some f ->
            FStar_Pervasives_Native.Some
              ((fun x ->
                  let uu____2028 = f x in FStar_Tactics_Monad.run uu____2028))
        | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None in
      let uu____2044 =
        FStar_Syntax_Embeddings.term_as_fv FStar_Syntax_Syntax.t_unit in
      FStar_Syntax_Embeddings.mk_emb em un uu____2044
          ...
          fun e_res ->
            fun tactic ->
              fun ps ->
                ...
                (let uu____2156 = FStar_ST.op_Bang tacdbg in
                 if uu____2156
                 then
                   let uu____2163 = FStar_Syntax_Print.term_to_string tactic in
                   FStar_Util.print1 "Typechecking tactic: (%s) {\n"
                     uu____2163
                 else ());
                (let uu____2165 =
                   let uu____2172 = FStar_Syntax_Embeddings.type_of e_arg in
                   let uu____2173 = FStar_Syntax_Embeddings.type_of e_res in
                   FStar_TypeChecker_TcTerm.tc_tactic uu____2172 uu____2173
                     env tactic in
                 match uu____2165 with
                 | (uu____2180, uu____2181, g) ->
                     ((let uu____2184 = FStar_ST.op_Bang tacdbg in
                       if uu____2184
                      ...
                      (let tau =
                       ...
                       (let uu____2212 =
                          FStar_Util.record_time
                            (fun uu____2223 ->
                               let uu____2224 = tau arg in
                               FStar_Tactics_Monad.run_safe uu____2224 ps) in
                        match uu____2212 with
                        | (res, ms) ->
                            ((let uu____2240 = FStar_ST.op_Bang tacdbg in
                              if uu____2240
                              then FStar_Util.print_string "}\n"
                              else ());
                             (let uu____2249 =
                              ...
                              then
                                ...
                                let uu____2257 = FStar_Util.string_of_int ms in
                                let uu____2258 =
                                   ...
                                   (let g1 =
                                        ...
                                        FStar_TypeChecker_Env.trivial_guard in
                                      {
                                        FStar_TypeChecker_Common.guard_f =
                                          (uu___232_2295.FStar_TypeChecker_Common.guard_f);
                                        FStar_TypeChecker_Common.deferred_to_tac
                                          =
                                          (uu___232_2295.FStar_TypeChecker_Common.deferred_to_tac);
                                        FStar_TypeChecker_Common.deferred =
                                          (uu___232_2295.FStar_TypeChecker_Common.deferred);
                                        FStar_TypeChecker_Common.univ_ineqs =
                                          (uu___232_2295.FStar_TypeChecker_Common.univ_ineqs);
                              ...
                              | FStar_Tactics_Result.Failed (e, ps1) ->
                                  ((let uu____2341 =
                                      ...
                                      FStar_Tactics_Types.subst_proof_state
                                        uu____2342 ps1 in
                                    FStar_Tactics_Printing.do_dump_proofstate
                                      uu____2341 "at the time of failure");
                                   (let texn_to_string e1 =
                                    ...
                                    let uu____2353 =
                                      let uu____2358 =
                                        let uu____2359 = texn_to_string e in
                                        FStar_Util.format1
                                          "user tactic failed: %s" uu____2359 in
