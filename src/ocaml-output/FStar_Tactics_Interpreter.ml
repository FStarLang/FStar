      ...
      FStar_Tactics_Basic.bind FStar_Tactics_Basic.get
        (fun proof_state  ->
           let tm =
             ...
             uu____1451 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let steps =
                               ...
                               let uu____1677 =
                                 let uu____1682 =
                                   FStar_Util.format1
                                    ...
                                    in
                                 (uu____1682, (typ.FStar_Syntax_Syntax.pos))
                                  in
...
let reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____3009 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____3011 =
      let uu____3012 =
             ...
             let uu____3058 =
               FStar_List.existsML
                 (fun g  ->
                    ...
                    Prims.op_Negation uu____3062) gs
                in
             if uu____3058
             then
               FStar_Exn.raise
