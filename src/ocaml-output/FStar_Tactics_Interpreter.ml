...
let mk_tactic_interpretation_0:
      'r. 'r FStar_Tactics_Basic.tac -> 'r FStar_Syntax_Embeddings.embedder
      -> FStar_Syntax_Syntax.typ -> FStar_Ident.lid
      -> FStar_TypeChecker_Normalize.psc -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun t embed_r t_r nm psc args ->
    match args with
    | [(embedded_state, uu____63)] ->
        let uu____80 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____80 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____94 ->
                let uu____95 = FStar_Ident.string_of_lid nm in
                let uu____96 = FStar_Syntax_Print.args_to_string args in
                FStar_Util.print2 "Reached %s, args are: %s\n" uu____95
                  uu____96 ) ;
            let res = FStar_Tactics_Basic.run t ps1 in
            let uu____100 =
              let uu____101 = FStar_TypeChecker_Normalize.psc_range psc in
              let uu____102 =
                FStar_Tactics_Embedding.embed_result embed_r t_r
              in
              uu____102 uu____101 res
            in
            FStar_Pervasives_Native.Some uu____100 )
    | uu____116 -> failwith "Unexpected application of tactic primitive"


let mk_tactic_interpretation_1:
      'a 'r. ('a -> 'r FStar_Tactics_Basic.tac)
      -> 'a FStar_Syntax_Embeddings.unembedder
      -> 'r FStar_Syntax_Embeddings.embedder -> FStar_Syntax_Syntax.typ
      -> FStar_Ident.lid -> FStar_TypeChecker_Normalize.psc
      -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun t unembed_a embed_r t_r nm psc args ->
    match args with
    | [(a, uu____188); (embedded_state, uu____190)] ->
        let uu____217 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____217 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____230 ->
            ...
            FStar_Util.bind_opt uu____233 (fun a1 ->
                let res =
                  let uu____245 = t a1 in
                  FStar_Tactics_Basic.run uu____245 ps1
                in
                let uu____248 =
                  let uu____249 = FStar_TypeChecker_Normalize.psc_range psc in
                  let uu____250 =
                    FStar_Tactics_Embedding.embed_result embed_r t_r
                  in
                  uu____250 uu____249 res
                in
  ...
  fun t unembed_a embed_r t_r nm psc args ->
    ...
    | [(a, uu____344); (embedded_state, uu____346)] ->
        let uu____373 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____373 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____386 ->
            ...
            FStar_Util.bind_opt uu____389 (fun a1 ->
                let res =
                  let uu____401 = t psc a1 in
                  FStar_Tactics_Basic.run uu____401 ps1
                in
                let uu____404 =
                  let uu____405 = FStar_TypeChecker_Normalize.psc_range psc in
                  let uu____406 =
                    FStar_Tactics_Embedding.embed_result embed_r t_r
                  in
                  uu____406 uu____405 res
                in
...
let mk_tactic_interpretation_2:
      'a 'b 'r. ('a -> 'b -> 'r FStar_Tactics_Basic.tac)
      -> 'a FStar_Syntax_Embeddings.unembedder
      ...
      -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun t unembed_a unembed_b embed_r t_r nm psc args ->
    match args with
    | [(a, uu____515); (b, uu____517); (embedded_state, uu____519)] ->
        let uu____556 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____556 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____569 ->
            ...
            FStar_Util.bind_opt uu____572 (fun a1 ->
                let uu____580 = unembed_b b in
                FStar_Util.bind_opt uu____580 (fun b1 ->
                    let res =
...
let mk_tactic_interpretation_3:
      'a 'b 'c 'r. ('a -> 'b -> 'c -> 'r FStar_Tactics_Basic.tac)
      -> 'a FStar_Syntax_Embeddings.unembedder
      -> 'b FStar_Syntax_Embeddings.unembedder
      ...
      -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun t unembed_a unembed_b unembed_c embed_r t_r nm psc args ->
    match args with
    | [ (a, uu____726)
      ; (b, uu____728)
      ; (c, uu____730)
      ; (embedded_state, uu____732) ] ->
        let uu____779 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____779 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____792 ->
            ...
            FStar_Util.bind_opt uu____795 (fun a1 ->
                let uu____803 = unembed_b b in
                FStar_Util.bind_opt uu____803 (fun b1 ->
                    let uu____811 = unembed_c c in
                    FStar_Util.bind_opt uu____811 (fun c1 ->
                        let res =
                          let uu____823 = t a1 b1 c1 in
                          FStar_Tactics_Basic.run uu____823 ps1
                        in
                        let uu____826 =
                          let uu____827 =
                            FStar_TypeChecker_Normalize.psc_range psc
...
let mk_tactic_interpretation_5:
      ...
      -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun t unembed_a unembed_b unembed_c unembed_d unembed_e embed_r t_r nm psc
      args ->
    match args with
    | [ (a, uu____997)
      ; (b, uu____999)
      ...
      ; (d, uu____1003)
      ; (e, uu____1005)
      ; (embedded_state, uu____1007) ] ->
        let uu____1074 =
          FStar_Tactics_Embedding.unembed_proofstate embedded_state
        in
        FStar_Util.bind_opt uu____1074 (fun ps ->
            let ps1 = FStar_Tactics_Types.set_ps_psc psc ps in
            FStar_Tactics_Basic.log ps1 (fun uu____1087 ->
                let uu____1088 = FStar_Ident.string_of_lid nm in
                let uu____1089 =
                  FStar_Syntax_Print.term_to_string embedded_state
                in
                FStar_Util.print2 "Reached %s, goals are: %s\n" uu____1088
            ...
            FStar_Util.bind_opt uu____1090 (fun a1 ->
                let uu____1098 = unembed_b b in
                FStar_Util.bind_opt uu____1098 (fun b1 ->
                    let uu____1106 = unembed_c c in
                    FStar_Util.bind_opt uu____1106 (fun c1 ->
                        let uu____1114 = unembed_d d in
                        FStar_Util.bind_opt uu____1114 (fun d1 ->
                            let uu____1122 = unembed_e e in
                            FStar_Util.bind_opt uu____1122 (fun e1 ->
                                let res =
                                  let uu____1134 = t a1 b1 c1 d1 e1 in
                                  FStar_Tactics_Basic.run uu____1134 ps1
                                in
                                let uu____1137 =
                                  let uu____1138 =
                                    FStar_TypeChecker_Normalize.psc_range psc
                                  ...
                                  let uu____1139 =
                                    FStar_Tactics_Embedding.embed_result
                                      embed_r t_r
                                  in
                                  uu____1139 uu____1138 res
                                in
                                FStar_Pervasives_Native.Some uu____1137 ) ) )
                ) ) )
    | uu____1153 ->
        let uu____1154 =
          let uu____1155 = FStar_Ident.string_of_lid nm in
          let uu____1156 = FStar_Syntax_Print.args_to_string args in
          FStar_Util.format2 "Unexpected application of tactic primitive %s %s"
...
let rec primitive_steps
  ...
  fun uu____1208 ->
    let mk1 nm arity interpretation =
      ...
      ; FStar_TypeChecker_Normalize.arity
    ...
    let mktac1 a r name f u_a e_r tr =
      mk1 name (Prims.parse_int "2") (mk_tactic_interpretation_1 f u_a e_r tr)
    in
    ...
    let decr_depth_interp psc args =
      ...
      | [(ps, uu____1696)] ->
          ...
          FStar_Util.bind_opt uu____1713 (fun ps1 ->
              let ps2 = FStar_Tactics_Types.set_ps_psc psc ps1 in
              let uu____1721 =
                let uu____1722 = FStar_TypeChecker_Normalize.psc_range psc in
                let uu____1723 = FStar_Tactics_Types.decr_depth ps2 in
                FStar_Tactics_Embedding.embed_proofstate uu____1722 uu____1723
              in
              FStar_Pervasives_Native.Some uu____1721 )
      | uu____1724 -> failwith "Unexpected application of decr_depth"
    in
    let decr_depth_step =
      let uu____1728 =
        FStar_Ident.lid_of_str "FStar.Tactics.Types.decr_depth"
      in
    ...
    let incr_depth_interp psc args =
      ...
      | [(ps, uu____1741)] ->
          ...
          FStar_Util.bind_opt uu____1758 (fun ps1 ->
              let ps2 = FStar_Tactics_Types.set_ps_psc psc ps1 in
              let uu____1766 =
                let uu____1767 = FStar_TypeChecker_Normalize.psc_range psc in
                let uu____1768 = FStar_Tactics_Types.incr_depth ps2 in
                FStar_Tactics_Embedding.embed_proofstate uu____1767 uu____1768
              in
              FStar_Pervasives_Native.Some uu____1766 )
      | uu____1769 -> failwith "Unexpected application of incr_depth"
    in
    let incr_depth_step =
      let uu____1773 =
        FStar_Ident.lid_of_str "FStar.Tactics.Types.incr_depth"
      in
    ...
    let set_proofstate_range_interp psc args =
      ...
      | uu____1882 -> failwith "Unexpected application of set_proofstate_range"
    in
    let set_proofstate_range_step =
      let nm =
        FStar_Ident.lid_of_str "FStar.Tactics.Types.set_proofstate_range"
      in
      { FStar_TypeChecker_Normalize.name= nm
      ; FStar_TypeChecker_Normalize.arity= Prims.parse_int "2"
      ; FStar_TypeChecker_Normalize.strong_reduction_ok= false
      ; FStar_TypeChecker_Normalize.requires_binder_substitution= false
      ; FStar_TypeChecker_Normalize.interpretation= set_proofstate_range_interp
      }
    in
    let tracepoint_step =
    ...
    let uu____1903 =
      let uu____1906 =
        mktac2 () () () "__fail"
          (fun a434 a435 ->
            (Obj.magic (fun uu____1908 -> FStar_Tactics_Basic.fail)) a434 a435
            )
          (Obj.magic get1)
          (Obj.magic FStar_Syntax_Embeddings.unembed_string)
          (Obj.magic put1) FStar_Syntax_Syntax.t_unit
      in
      let uu____1909 =
        let uu____1912 =
          mktac0 () "__trivial"
            (Obj.magic FStar_Tactics_Basic.trivial)
            ...
            mktac2 () () () "__trytac"
              (fun a436 a437 ->
                (Obj.magic (fun uu____1923 -> FStar_Tactics_Basic.trytac))
                  a436 a437 )
              (Obj.magic get1)
              (Obj.magic (unembed_tactic_0' get1))
              (Obj.magic uu____1917) FStar_Syntax_Syntax.t_unit
          in
          let uu____1930 =
            let uu____1933 =
              mktac0 () "__intro"
                (Obj.magic FStar_Tactics_Basic.intro)
                  ...
                  let uu____1978 =
                    ...
                    let uu____1991 =
                      let uu____1994 =
                        mktac2 () () () "__rename_to"
                          (fun a444 a445 ->
                            (Obj.magic FStar_Tactics_Basic.rename_to) a444 a445
                            )
                          (Obj.magic FStar_Reflection_Basic.unembed_binder)
                          (Obj.magic FStar_Syntax_Embeddings.unembed_string)
                          (Obj.magic FStar_Syntax_Embeddings.embed_unit)
                          ...
                          let uu____2003 =
                            ...
                            let uu____2007 =
                              let uu____2010 =
                                mktac1 () () "__clear"
                                  (fun a447 ->
                                    (Obj.magic FStar_Tactics_Basic.clear) a447
                                    )
                                  (Obj.magic
                              ...
                              let uu____2011 =
                                        ...
                                        let uu____2031 =
                                          ...
                                          let uu____2035 =
                                            ...
                                            let uu____2039 =
                                              ...
                                              in
                                              uu____2042 :: uu____2060
                                            in
                                            uu____2038 :: uu____2039
                                          in
                                          uu____2034 :: uu____2035
                                        in
                                        uu____2030 :: uu____2031
                                      in
                                ...
                                in
                                uu____2014 :: uu____2015
                              in
                              uu____2010 :: uu____2011
                            in
                            uu____2006 :: uu____2007
                          in
                          uu____2002 :: uu____2003
                        in
                        uu____1998 :: uu____1999
                      in
                      uu____1994 :: uu____1995
                    in
                    uu____1981 :: uu____1991
                  in
                  uu____1968 :: uu____1978
                in
                uu____1955 :: uu____1965
              in
              uu____1937 :: uu____1952
            in
            uu____1933 :: uu____1934
          in
          uu____1916 :: uu____1930
        in
        uu____1912 :: uu____1913
      in
      uu____1906 :: uu____1909
    in
...
and unembed_tactic_0:
      'Ab. 'Ab FStar_Syntax_Embeddings.unembedder -> FStar_Syntax_Syntax.term
      -> 'Ab FStar_Tactics_Basic.tac =
  fun unembed_b embedded_tac_b ->
    FStar_Tactics_Basic.bind FStar_Tactics_Basic.get (fun proof_state ->
          ...
          let uu____2209 =
            let uu____2210 =
              let uu____2211 =
                ...
                in
                FStar_Syntax_Syntax.as_arg uu____2212
              in
              [uu____2211]
            in
            FStar_Syntax_Syntax.mk_Tm_app embedded_tac_b uu____2210
          in
          uu____2209 FStar_Pervasives_Native.None rng
        in
        let steps =
        ...
        let result =
          ...
          FStar_TypeChecker_Normalize.normalize_with_primitive_steps uu____2223
            steps proof_state.FStar_Tactics_Types.main_context tm
        in
        (let uu____2227 =
           FStar_TypeChecker_Env.debug
             proof_state.FStar_Tactics_Types.main_context
        ...
        let res = FStar_Tactics_Embedding.unembed_result result unembed_b in
        match res with
        | FStar_Pervasives_Native.Some FStar_Util.Inl (b, ps) ->
            let uu____2273 = FStar_Tactics_Basic.set ps in
            FStar_Tactics_Basic.bind uu____2273 (fun uu____2277 ->
                FStar_Tactics_Basic.ret b )
        | FStar_Pervasives_Native.Some FStar_Util.Inr (msg, ps) ->
            let uu____2300 = FStar_Tactics_Basic.set ps in
            FStar_Tactics_Basic.bind uu____2300 (fun uu____2304 ->
                FStar_Tactics_Basic.fail msg )
        | FStar_Pervasives_Native.None ->
            let uu____2317 =
              let uu____2322 =
                let uu____2323 = FStar_Syntax_Print.term_to_string result in
                FStar_Util.format1
                  "Tactic got stuck! Please file a bug report with a minimal reproduction of this issue.\n%s"
                  uu____2323
              in
              (FStar_Errors.Fatal_TacticGotStuck, uu____2322)
            in
...
let report_implicits
    : FStar_Tactics_Types.proofstate -> FStar_TypeChecker_Env.implicits
      -> Prims.unit =
  fun ps is ->
    let errs =
      FStar_List.map
        (fun uu____2388 ->
          match uu____2388 with r, uu____2408, uv, uu____2410, ty, rng ->
            let uu____2413 =
...
let run_tactic_on_typ
    : FStar_Syntax_Syntax.term -> FStar_TypeChecker_Env.env
      ...
      -> ( FStar_Tactics_Basic.goal Prims.list
  ...
  fun tactic env typ ->
    ...
    let tau = unembed_tactic_0 FStar_Syntax_Embeddings.unembed_unit tactic1 in
    let uu____2491 = FStar_TypeChecker_Env.clear_expected_typ env in
    match uu____2491 with env1, uu____2505 ->
      let env2 =
        let uu___61_2511 = env1 in
        { FStar_TypeChecker_Env.solver=
            uu___61_2511.FStar_TypeChecker_Env.solver
        ; FStar_TypeChecker_Env.range= uu___61_2511.FStar_TypeChecker_Env.range
        ; FStar_TypeChecker_Env.curmodule=
            uu___61_2511.FStar_TypeChecker_Env.curmodule
        ; FStar_TypeChecker_Env.gamma= uu___61_2511.FStar_TypeChecker_Env.gamma
        ...
        ; FStar_TypeChecker_Env.admit= uu___61_2511.FStar_TypeChecker_Env.admit
        ; FStar_TypeChecker_Env.lax= uu___61_2511.FStar_TypeChecker_Env.lax
        ...
        ; FStar_TypeChecker_Env.synth= uu___61_2511.FStar_TypeChecker_Env.synth
        ...
        ; FStar_TypeChecker_Env.dsenv= uu___61_2511.FStar_TypeChecker_Env.dsenv
        ; FStar_TypeChecker_Env.dep_graph=
            uu___61_2511.FStar_TypeChecker_Env.dep_graph }
      in
      let uu____2512 = FStar_Tactics_Basic.proofstate_of_goal_ty env2 typ in
      match uu____2512 with ps, w ->
        (let uu____2526 = FStar_ST.op_Bang tacdbg in
         if uu____2526 then
           let uu____2546 = FStar_Syntax_Print.term_to_string typ in
           FStar_Util.print1 "Running tactic with goal = %s\n" uu____2546
         else ()) ;
        let uu____2548 =
          FStar_Util.record_time (fun uu____2558 ->
              FStar_Tactics_Basic.run tau ps )
        in
        match uu____2548 with res, ms ->
          (let uu____2572 = FStar_ST.op_Bang tacdbg in
           if uu____2572 then
             let uu____2592 = FStar_Util.string_of_int ms in
             FStar_Util.print1 "Tactic ran in %s milliseconds\n" uu____2592
           else ()) ;
          match res with
          | FStar_Tactics_Result.Success (uu____2600, ps1) ->
              (let uu____2603 = FStar_ST.op_Bang tacdbg in
               if uu____2603 then
                 let uu____2623 = FStar_Syntax_Print.term_to_string w in
                 FStar_Util.print1 "Tactic generated proofterm %s\n" uu____2623
               else ()) ;
              FStar_List.iter
                (fun g ->
                  let uu____2630 = FStar_Tactics_Basic.is_irrelevant g in
                  if uu____2630 then
                    let uu____2631 =
              ...
              let g =
                let uu___62_2637 = FStar_TypeChecker_Rel.trivial_guard in
              ...
              in
              report_implicits ps1 g1.FStar_TypeChecker_Env.implicits ;
              ( FStar_List.append ps1.FStar_Tactics_Types.goals
                  ps1.FStar_Tactics_Types.smt_goals
              , w )
          | FStar_Tactics_Result.Failed (s, ps1) ->
              (let uu____2646 =
                 ...
                 in
                 FStar_Tactics_Types.subst_proof_state uu____2647 ps1
               in
               FStar_Tactics_Basic.dump_proofstate uu____2646
                 "at the time of failure") ;
              let uu____2648 =
                let uu____2653 =
                  FStar_Util.format1 "user tactic failed: %s" s
                in
                (FStar_Errors.Fatal_ArgumentLengthMismatch, uu____2653)
              in
              FStar_Errors.raise_error uu____2648 typ.FStar_Syntax_Syntax.pos


type pol = Pos | Neg | Both [@@deriving show]
...
let uu___is_Both : pol -> Prims.bool =
  fun projectee -> match projectee with Both -> true | uu____2671 -> false
...
let uu___is_Dual: 'a. 'a tres_m -> Prims.bool =
  fun projectee -> match projectee with Dual _0 -> true | uu____2806 -> false
...
let by_tactic_interp
  ...
  fun pol e t ->
    ...
    match uu____2863 with hd1, args ->
      let uu____2900 =
        let uu____2913 =
          let uu____2914 = FStar_Syntax_Util.un_uinst hd1 in
          uu____2914.FStar_Syntax_Syntax.n
        in
        (uu____2913, args)
      in
      ...
      | ( FStar_Syntax_Syntax.Tm_fvar fv
        , [ ( rett
            , FStar_Pervasives_Native.Some
                FStar_Syntax_Syntax.Implicit uu____2927 )
          ; (tactic, FStar_Pervasives_Native.None)
          ; (assertion, FStar_Pervasives_Native.None) ] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.by_tactic_lid
        -> (
        match pol with
        | Pos -> (
            let uu____2990 = run_tactic_on_typ tactic e assertion in
            match uu____2990 with gs, uu____2998 ->
              Simplified (FStar_Syntax_Util.t_true, gs) )
        | Both -> (
            let uu____3005 = run_tactic_on_typ tactic e assertion in
            match uu____3005 with gs, uu____3013 ->
              Dual (assertion, FStar_Syntax_Util.t_true, gs) )
        | Neg -> Simplified (assertion, []) )
      | ( FStar_Syntax_Syntax.Tm_fvar fv
        , [(assertion, FStar_Pervasives_Native.None)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.spinoff_lid
        -> (
        match pol with
        | Pos ->
            let uu____3064 =
              let uu____3071 =
                let uu____3074 =
                  ...
                  in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3075
                in
                [uu____3074]
              in
              (FStar_Syntax_Util.t_true, uu____3071)
            in
              ...
              let uu____3099 =
                let uu____3102 =
                  let uu____3103 =
                    FStar_Tactics_Basic.goal_of_goal_ty e assertion
                  in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3103
                in
                [uu____3102]
              in
              (assertion, FStar_Syntax_Util.t_true, uu____3099)
            in
            Dual uu____3086
        | Neg -> Simplified (assertion, []) )
...
let comb1: 'a 'b. ('a -> 'b) -> 'a tres_m -> 'b tres_m =
  fun f uu___59_3204 ->
    ...
    | Unchanged t ->
        let uu____3210 = f t in
        Unchanged uu____3210
    | Simplified (t, gs) ->
        let uu____3217 =
          let uu____3224 = f t in
          (uu____3224, gs)
        in
    ...
    | Dual (tn, tp, gs) ->
        let uu____3234 =
          ...
          let uu____3244 = f tp in
          (uu____3243, uu____3244, gs)
        in
        Dual uu____3234
...
let comb2: 'a 'b 'c. ('a -> 'b -> 'c) -> 'a tres_m -> 'b tres_m -> 'c tres_m =
  fun f x y ->
    ...
    | Unchanged t1, Unchanged t2 ->
        let uu____3298 = f t1 t2 in
        Unchanged uu____3298
    | Unchanged t1, Simplified (t2, gs) ->
        let uu____3310 =
          let uu____3317 = f t1 t2 in
          (uu____3317, gs)
        in
        Simplified uu____3310
    | Simplified (t1, gs), Unchanged t2 ->
        let uu____3331 =
          let uu____3338 = f t1 t2 in
          (uu____3338, gs)
        in
    ...
    | Simplified (t1, gs1), Simplified (t2, gs2) ->
        let uu____3357 =
          ...
          (uu____3364, FStar_List.append gs1 gs2)
        in
        Simplified uu____3357
    | uu____3367 ->
        let uu____3376 = explode x in
        match uu____3376 with n1, p1, gs1 ->
          let uu____3394 = explode y in
          match uu____3394 with n2, p2, gs2 ->
            let uu____3412 =
...
let comb_list: 'a. 'a tres_m Prims.list -> 'a Prims.list tres_m =
  fun rs ->
    let rec aux rs1 acc =
      ...
      | [] -> acc
      | hd1 :: tl1 ->
          let uu____3487 = comb2 (fun l r -> l :: r) hd1 acc in
          aux tl1 uu____3487
    in
...
let emit: 'a. FStar_Tactics_Basic.goal Prims.list -> 'a tres_m -> 'a tres_m =
  fun gs m -> comb2 (fun uu____3530 x -> x) (Simplified ((), gs)) m
  ...
  fun f pol e t ->
    let r =
      let uu____3564 =
        ...
        uu____3565.FStar_Syntax_Syntax.n
      in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let tr = traverse f pol e t1 in
          let uu____3601 =
            comb1 (fun t' -> FStar_Syntax_Syntax.Tm_meta (t', m))
          in
          uu____3601 tr
      | FStar_Syntax_Syntax.Tm_app
          ...
          , [(p, uu____3622); (q, uu____3624)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.imp_lid ->
          let x =
            let uu____3664 =
              FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero p
            in
            FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____3664
          in
          let r1 = traverse f (flip pol) e p in
          let r2 =
            let uu____3667 = FStar_TypeChecker_Env.push_bv e x in
            traverse f pol uu____3667 q
          in
          comb2
            (fun l r ->
              let uu____3673 = FStar_Syntax_Util.mk_imp l r in
              uu____3673.FStar_Syntax_Syntax.n )
            r1 r2
      | FStar_Syntax_Syntax.Tm_app
          ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
            ; FStar_Syntax_Syntax.pos= uu____3677
            ; FStar_Syntax_Syntax.vars= uu____3678; _ }
          , [(p, uu____3680); (q, uu____3682)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.iff_lid
        -> (
          let xp =
            let uu____3722 =
              FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero p
            in
            FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____3722
          in
          let xq =
            let uu____3724 =
              FStar_Syntax_Util.mk_squash FStar_Syntax_Syntax.U_zero q
            in
            FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None uu____3724
          in
          let r1 =
            let uu____3726 = FStar_TypeChecker_Env.push_bv e xq in
            traverse f Both uu____3726 p
          in
          let r2 =
            let uu____3728 = FStar_TypeChecker_Env.push_bv e xp in
            traverse f Both uu____3728 q
          in
          match (r1, r2) with
          | Unchanged uu____3731, Unchanged uu____3732 ->
              comb2
                (fun l r ->
                  ...
                  uu____3742.FStar_Syntax_Syntax.n )
                r1 r2
          | uu____3745 ->
              let uu____3750 = explode r1 in
              match uu____3750 with pn, pp, gs1 ->
                let uu____3768 = explode r2 in
                match uu____3768 with qn, qp, gs2 ->
                  let t1 =
                    let uu____3789 = FStar_Syntax_Util.mk_imp pn qp in
                    let uu____3790 = FStar_Syntax_Util.mk_imp qn pp in
                    FStar_Syntax_Util.mk_conj uu____3789 uu____3790
                  in
                  Simplified
                    (t1.FStar_Syntax_Syntax.n, FStar_List.append gs1 gs2) )
      | FStar_Syntax_Syntax.Tm_app (hd1, args) ->
          let r0 = traverse f pol e hd1 in
          let r1 =
            FStar_List.fold_right
              (fun uu____3842 r ->
                match uu____3842 with a, q ->
                  let r' = traverse f pol e a in
                  comb2 (fun a1 args1 -> (a1, q) :: args1) r' r )
              args (tpure [])
          in
          comb2
            (fun hd2 args1 -> FStar_Syntax_Syntax.Tm_app (hd2, args1))
            r0 r1
      | FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> (
          let uu____3960 = FStar_Syntax_Subst.open_term bs t1 in
          match uu____3960 with bs1, topen ->
            let e' = FStar_TypeChecker_Env.push_binders e bs1 in
            let r0 =
              FStar_List.map
                (fun uu____3994 ->
                  match uu____3994 with bv, aq ->
                    let r =
                      traverse f (flip pol) e bv.FStar_Syntax_Syntax.sort
                    in
                    let uu____4008 =
                      comb1 (fun s' ->
            ...
            comb2
              (fun bs2 t2 ->
                let uu____4052 = FStar_Syntax_Util.abs bs2 t2 k in
                uu____4052.FStar_Syntax_Syntax.n )
              rbs rt )
      | FStar_Syntax_Syntax.Tm_ascribed (t1, asc, ef) ->
          let uu____4098 = traverse f pol e t1 in
          let uu____4103 =
            comb1 (fun t2 -> FStar_Syntax_Syntax.Tm_ascribed (t2, asc, ef))
          in
    ...
    | Unchanged tn' ->
        f pol e
          (let uu___64_4141 = t in
           ...
           ; FStar_Syntax_Syntax.pos= uu___64_4141.FStar_Syntax_Syntax.pos
           ; FStar_Syntax_Syntax.vars= uu___64_4141.FStar_Syntax_Syntax.vars })
    | Simplified (tn', gs) ->
        let uu____4148 =
          f pol e
            (let uu___65_4152 = t in
             { FStar_Syntax_Syntax.n= tn'
             ; FStar_Syntax_Syntax.pos= uu___65_4152.FStar_Syntax_Syntax.pos
             ; FStar_Syntax_Syntax.vars= uu___65_4152.FStar_Syntax_Syntax.vars
             })
        in
        emit gs uu____4148
    | Dual (tn, tp, gs) ->
        let rp =
          f pol e
            (let uu___66_4162 = t in
             ...
             ; FStar_Syntax_Syntax.pos= uu___66_4162.FStar_Syntax_Syntax.pos
             ; FStar_Syntax_Syntax.vars= uu___66_4162.FStar_Syntax_Syntax.vars
             })
        in
        let uu____4163 = explode rp in
        match uu____4163 with uu____4172, p', gs' ->
          Dual
            ( (let uu___67_4186 = t in
               { FStar_Syntax_Syntax.n= tn
               ; FStar_Syntax_Syntax.pos= uu___67_4186.FStar_Syntax_Syntax.pos
               ; FStar_Syntax_Syntax.vars=
                   uu___67_4186.FStar_Syntax_Syntax.vars })
            , p'
            , FStar_List.append gs gs' )
...
let preprocess
  ...
  fun env goal ->
    ...
    let uu____4293 =
      ...
      | uu____4318 -> failwith "no"
    in
    match uu____4293 with t', gs ->
              ...
              let phi =
                ...
                | FStar_Pervasives_Native.None ->
                    let uu____4457 =
                      ...
                      in
                      FStar_Util.format1
                        "Tactic returned proof-relevant goal: %s" uu____4458
                    in
                    failwith uu____4457
                | FStar_Pervasives_Native.Some phi -> phi
              in
              (let uu____4461 = FStar_ST.op_Bang tacdbg in
               if uu____4461 then
                 let uu____4481 = FStar_Util.string_of_int n1 in
                 let uu____4482 = FStar_Tactics_Basic.goal_to_string g in
                 FStar_Util.print2 "Got goal #%s: %s\n" uu____4481 uu____4482
               else ()) ;
              let gt' =
                let uu____4485 =
                  let uu____4486 = FStar_Util.string_of_int n1 in
                  Prims.strcat "Could not prove goal #" uu____4486
                in
                FStar_TypeChecker_Util.label uu____4485
                  goal.FStar_Syntax_Syntax.pos phi
              in
              ( n1 + Prims.parse_int "1"
              , (g.FStar_Tactics_Types.context, gt', g.FStar_Tactics_Types.opts)
                :: gs1 ) )
          s gs
      in
      let uu____4501 = s1 in
      match uu____4501 with uu____4522, gs1 ->
        let uu____4540 =
  ...
  fun a ->
    let r =
      let uu____4558 =
        ...
        in
        FStar_Syntax_Syntax.fv_to_tm uu____4559
      in
      FStar_Syntax_Syntax.mk_Tm_uinst uu____4558 [FStar_Syntax_Syntax.U_zero]
    in
    let uu____4560 =
      let uu____4561 =
        let uu____4562 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
        let uu____4563 =
          let uu____4566 = FStar_Syntax_Syntax.as_arg a in
          [uu____4566]
        in
        uu____4562 :: uu____4563
      in
      FStar_Syntax_Syntax.mk_Tm_app r uu____4561
    in
...
let synth
  ...
  fun env typ tau ->
    ...
    let uu____4599 =
      ...
      run_tactic_on_typ uu____4606 env typ
    in
    match uu____4599 with gs, w ->
      let uu____4613 =
        FStar_List.existsML
          (fun g ->
            let uu____4617 =
              let uu____4618 =
                getprop g.FStar_Tactics_Types.context
                  g.FStar_Tactics_Types.goal_ty
              in
              FStar_Option.isSome uu____4618
            in
            Prims.op_Negation uu____4617 )
          gs
      in
      if uu____4613 then
        FStar_Errors.raise_error
          (FStar_Errors.Fatal_OpenGoalsInSynthesis, "synthesis left open goals")
