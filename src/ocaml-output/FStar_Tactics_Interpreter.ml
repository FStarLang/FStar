...
let e_tactic_1_alt :
  ...
  fun ea  ->
    fun er  ->
      ...
      let un t0 w n =
        let uu____2161 = unembed_tactic_1_alt ea er t0 n  in
    ...
    fun e  ->
      fun t  ->
        ...
        | (hd,args) ->
            let uu____3188 =
              let uu____3203 =
                let uu____3204 = FStar_Syntax_Util.un_uinst hd  in
...
let comb_list : 'a . 'a tres_m Prims.list -> 'a Prims.list tres_m =
  fun rs  ->
    let rec aux rs1 acc =
      ...
      | [] -> acc
      | hd::tl ->
          let uu____3773 = comb2 (fun l  -> fun r  -> l :: r) hd acc  in
          aux tl uu____3773
       in
          ...
          let r =
            ...
            | FStar_Syntax_Syntax.Tm_app
                ...
                let r2 =
                  ...
                  traverse f pol1 uu____3987 q  in
                comb2
                  (fun l  ->
                     fun r  ->
            ...
            | FStar_Syntax_Syntax.Tm_ascribed (t1,asc,ef) ->
                let uu____4534 = traverse f pol1 e t1  in
                let uu____4539 =
                  comb1
            ...
            | FStar_Syntax_Syntax.Tm_match (sc,brs) ->
                let uu____4614 = traverse f pol1 e sc  in
                let uu____4619 =
                  let uu____4638 =
                    FStar_List.map
                      (fun br  ->
                    ...
                    fun g  ->
                      ...
                      | (n,gs1) ->
                          ...
                          ((let uu____5158 = FStar_ST.op_Bang tacdbg  in
                            if uu____5158
                            then
                              let uu____5182 = FStar_Util.string_of_int n  in
                              let uu____5184 =
                                let uu____5186 =
                                  FStar_Tactics_Types.goal_type g  in
                           ...
                           (let label =
                              ...
                              if uu____5192
                              then
                                let uu____5200 = FStar_Util.string_of_int n
                                   in
                            ...
                            let uu____5219 =
                              let uu____5228 =
                                ...
                                (uu____5235, gt',
                                 ...
                                 in
                              uu____5228 :: gs1  in
                            ((n + Prims.int_one), uu____5219)))) s gs
                in
                      ...
                      | FStar_Pervasives_Native.Some vc ->
                          ((let uu____5427 = FStar_ST.op_Bang tacdbg  in
                           ...
                           (let guard =
                            ...
                            let uu____5466 = FStar_Tactics_Types.goal_env g
                               in
    ...
    fun tau  ->
      fun imps  ->
        ...
        then ()
          ...
          ((let uu____5489 =
              FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")  in
            FStar_ST.op_Colon_Equals tacdbg uu____5489);
           (let gs =
              let uu____5516 = FStar_TypeChecker_Env.get_range env  in
              run_tactic_on_all_implicits tau.FStar_Syntax_Syntax.pos
                uu____5516 tau env imps
               in
            FStar_All.pipe_right gs
              (FStar_List.iter
                 (fun g  ->
                    let uu____5527 =
                      let uu____5530 = FStar_Tactics_Types.goal_env g  in
                      let uu____5531 = FStar_Tactics_Types.goal_type g  in
                      getprop uu____5530 uu____5531  in
                    match uu____5527 with
                    | FStar_Pervasives_Native.Some vc ->
                        ((let uu____5534 = FStar_ST.op_Bang tacdbg  in
                          if uu____5534
                          then
                            let uu____5558 =
                              FStar_Syntax_Print.term_to_string vc  in
                         ...
                         (let guard =
                          ...
                          let uu____5573 = FStar_Tactics_Types.goal_env g  in
                          FStar_TypeChecker_Rel.force_trivial_guard
                            uu____5573 guard))
                    | FStar_Pervasives_Native.None  ->
                        let uu____5574 = FStar_TypeChecker_Env.get_range env
                           in
                        FStar_Errors.raise_error
                          (FStar_Errors.Fatal_OpenGoalsInSynthesis,
                            "synthesis left open goals") uu____5574))))
  ...
  fun env  ->
    fun tau  ->
      ...
      then []
        ...
        ((let uu____5596 =
            FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")  in
          FStar_ST.op_Colon_Equals tacdbg uu____5596);
         (let typ = FStar_Syntax_Syntax.t_decls  in
          ...
          | (gs,sigelts) ->
              ((let uu____5651 =
               ...
               (let uu____5669 = FStar_ST.op_Bang tacdbg  in
                if uu____5669
                then
                  let uu____5693 =
                    FStar_Common.string_of_list
    ...
    fun tau  ->
      fun tm  ->
        ...
        then tm
          ...
          ((let uu____5718 =
              FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")  in
            FStar_ST.op_Colon_Equals tacdbg uu____5718);
           (let ps =
              FStar_Tactics_Basic.proofstate_of_goals
            ...
            let uu____5743 =
              run_tactic_on_ps tau.FStar_Syntax_Syntax.pos
               ...
               in
            match uu____5743 with | (gs,tm1) -> tm1))
          ...
          then tm
            ...
            ((let uu____5781 =
                FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")
                 in
              FStar_ST.op_Colon_Equals tacdbg uu____5781);
             (let uu____5805 =
