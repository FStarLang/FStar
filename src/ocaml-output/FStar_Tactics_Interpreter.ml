                   ...
                   | (env1,uu____2160) ->
                       let env2 =
                         let uu___355_2166 = env1  in
                         {
                           ...
                           FStar_TypeChecker_Env.fv_delta_depths =
                             (uu___355_2166.FStar_TypeChecker_Env.fv_delta_depths);
                       ...
                       let env3 =
                         let uu___356_2168 = env2  in
                         {
                           ...
                           FStar_TypeChecker_Env.fv_delta_depths =
                             (uu___356_2168.FStar_TypeChecker_Env.fv_delta_depths);
                           FStar_TypeChecker_Env.proof_ns =
                       ...
                       let env4 =
                         let uu___357_2170 = env3  in
                         {
                           ...
                           FStar_TypeChecker_Env.fv_delta_depths =
                             (uu___357_2170.FStar_TypeChecker_Env.fv_delta_depths);
                           FStar_TypeChecker_Env.proof_ns =
    ...
    fun pol  ->
      fun e  ->
        fun t  ->
          ...
          | Unchanged tn' ->
              f pol e
                (let uu___360_4349 = t  in
                 {
                   FStar_Syntax_Syntax.n = tn';
                   FStar_Syntax_Syntax.pos =
                     (uu___360_4349.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___360_4349.FStar_Syntax_Syntax.vars)
                 })
          | Simplified (tn',gs) ->
              let uu____4356 =
                f pol e
                  (let uu___361_4360 = t  in
                   {
                     FStar_Syntax_Syntax.n = tn';
                     FStar_Syntax_Syntax.pos =
                       (uu___361_4360.FStar_Syntax_Syntax.pos);
                     FStar_Syntax_Syntax.vars =
                       (uu___361_4360.FStar_Syntax_Syntax.vars)
                   })
                 in
              emit gs uu____4356
          | Dual (tn,tp,gs) ->
              let rp =
                f pol e
                  (let uu___362_4370 = t  in
                   {
                     FStar_Syntax_Syntax.n = tp;
                     FStar_Syntax_Syntax.pos =
                       (uu___362_4370.FStar_Syntax_Syntax.pos);
                     FStar_Syntax_Syntax.vars =
                       (uu___362_4370.FStar_Syntax_Syntax.vars)
                   })
                 in
              ...
              (match uu____4371 with
               | (uu____4380,p',gs') ->
                   Dual
                     ((let uu___363_4390 = t  in
                       {
                         FStar_Syntax_Syntax.n = tn;
                         FStar_Syntax_Syntax.pos =
                           (uu___363_4390.FStar_Syntax_Syntax.pos);
                         FStar_Syntax_Syntax.vars =
                           (uu___363_4390.FStar_Syntax_Syntax.vars)
