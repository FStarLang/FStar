                          ...
                          let uu____614 =
                            ...
                            let uu____618 =
                              ...
                              let uu____623 =
                                ...
                                let uu____627 =
                                  let uu____629 =
                                    mk1 "quote" (Prims.parse_int "2") quote
                                     in
                                  let uu____630 =
                                    let uu____632 =
                                      mk1 "binders_of_env"
    ...
    (fun proof_state  ->
       ...
       (let result =
          ...
          FStar_TypeChecker_Normalize.normalize_with_primitive_steps
            uu____663 steps proof_state.FStar_Tactics_Basic.main_context tm
           in
        ...
        (let uu____668 =
           FStar_Tactics_Embedding.unembed_result
             proof_state.FStar_Tactics_Basic.main_context result unembed_b
            in
        ...
        (let uu____833 = FStar_TypeChecker_Env.current_module env  in
         FStar_Ident.lid_equals uu____833 FStar_Syntax_Const.prims_lid) ||
          (let uu____834 =
           ...
           FStar_Util.starts_with uu____834 "FStar.")
         in
      if uu____832
      then [(env, goal)]
      else
        ((let uu____845 = FStar_Syntax_Print.term_to_string goal  in
         ...
         (let p = FStar_Tactics_Basic.proofstate_of_goal_ty env goal  in
          let uu____847 =
            let uu____849 = FStar_Tactics_Basic.visit evaluate_user_tactic
               in
          ...
          | FStar_Tactics_Basic.Success (uu____854,p2) ->
              FStar_All.pipe_right
                ...
                (FStar_List.map
                   (fun g  ->
                      (let uu____864 = FStar_Tactics_Basic.goal_to_string g
                          in
