    ...
    let uu____2252 =
      let uu____2255 =
        mktac2 () () () "fail"
          (fun a438  ->
             fun a439  ->
               (Obj.magic (fun uu____2257  -> FStar_Tactics_Basic.fail)) a438
                 a439) (Obj.magic FStar_Syntax_Embeddings.e_any)
              ...
              (fun a441  ->
                 fun a442  ->
                   (Obj.magic (fun uu____2277  -> FStar_Tactics_Basic.trytac))
                     a441 a442) (Obj.magic FStar_Syntax_Embeddings.e_any)
                        ...
                        (fun a449  ->
                           fun a450  ->
                             (Obj.magic FStar_Tactics_Basic.norm_binder_type)
                               a449 a450) (Obj.magic uu____2315)
                        (Obj.magic FStar_Reflection_Embeddings.e_binder)
                        (Obj.magic FStar_Syntax_Embeddings.e_unit)
                       in
                    let uu____2320 =
