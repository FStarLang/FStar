                                    ...
                                    let uu____1302 =
                                      ...
                                      let uu____1330 =
                                        ...
                                        let uu____1334 =
                                          ...
                                          uu____1337 :: uu____1342 in
                                        uu____1333 :: uu____1334 in
                                      uu____1305 :: uu____1330 in
             ...
             let uu____1447 =
               let uu____1448 =
                 let uu____1449 =
                   ...
                   FStar_Syntax_Syntax.as_arg uu____1450 in
                 [uu____1449] in
               FStar_Syntax_Syntax.mk_Tm_app embedded_tac_b uu____1448 in
             uu____1447 FStar_Pervasives_Native.None FStar_Range.dummyRange in
           let steps =
             ...
             FStar_All.pipe_left FStar_Tactics_Basic.mlog
               (fun uu____1465  ->
                  ...
                  FStar_Util.print1 "Starting normalizer with %s\n"
                    uu____1466) in
           FStar_Tactics_Basic.bind uu____1456
             (fun uu____1470  ->
                let result =
                  let uu____1472 = primitive_steps proof_state in
                  ...
                  FStar_All.pipe_left FStar_Tactics_Basic.mlog
                    (fun uu____1484  ->
                       ...
                       FStar_Util.print1 "Reduced tactic: got %s\n"
                         uu____1485) in
                FStar_Tactics_Basic.bind uu____1475
                  (fun uu____1491  ->
                     let uu____1492 =
                     ...
                     | FStar_Util.Inl (b,ps) ->
                         let uu____1517 = FStar_Tactics_Basic.set ps in
                         FStar_Tactics_Basic.bind uu____1517
                           (fun uu____1521  -> FStar_Tactics_Basic.ret b)
                     | FStar_Util.Inr (msg,ps) ->
                         let uu____1532 = FStar_Tactics_Basic.set ps in
                         FStar_Tactics_Basic.bind uu____1532
                           (fun uu____1536  -> FStar_Tactics_Basic.fail msg))))
  ...
  fun tactic  ->
    fun env  ->
      fun typ  ->
        ...
        | (tactic1,uu____1575,uu____1576) ->
            let tau =
              unembed_tactic_0 FStar_Syntax_Embeddings.unembed_unit tactic1 in
            let uu____1580 = FStar_TypeChecker_Env.clear_expected_typ env in
            (match uu____1580 with
             | (env1,uu____1594) ->
                 let env2 =
                   let uu___123_1600 = env1 in
                   {
                     FStar_TypeChecker_Env.solver =
                       (uu___123_1600.FStar_TypeChecker_Env.solver);
                     FStar_TypeChecker_Env.range =
                       (uu___123_1600.FStar_TypeChecker_Env.range);
                     FStar_TypeChecker_Env.curmodule =
                       (uu___123_1600.FStar_TypeChecker_Env.curmodule);
                     FStar_TypeChecker_Env.gamma =
                       (uu___123_1600.FStar_TypeChecker_Env.gamma);
                     FStar_TypeChecker_Env.gamma_cache =
                       (uu___123_1600.FStar_TypeChecker_Env.gamma_cache);
                     FStar_TypeChecker_Env.modules =
                       (uu___123_1600.FStar_TypeChecker_Env.modules);
                     FStar_TypeChecker_Env.expected_typ =
                       (uu___123_1600.FStar_TypeChecker_Env.expected_typ);
                     FStar_TypeChecker_Env.sigtab =
                       (uu___123_1600.FStar_TypeChecker_Env.sigtab);
                     FStar_TypeChecker_Env.is_pattern =
                       (uu___123_1600.FStar_TypeChecker_Env.is_pattern);
                     FStar_TypeChecker_Env.instantiate_imp = false;
                     FStar_TypeChecker_Env.effects =
                       (uu___123_1600.FStar_TypeChecker_Env.effects);
                     FStar_TypeChecker_Env.generalize =
                       (uu___123_1600.FStar_TypeChecker_Env.generalize);
                     FStar_TypeChecker_Env.letrecs =
                       (uu___123_1600.FStar_TypeChecker_Env.letrecs);
                     FStar_TypeChecker_Env.top_level =
                       (uu___123_1600.FStar_TypeChecker_Env.top_level);
                     FStar_TypeChecker_Env.check_uvars =
                       (uu___123_1600.FStar_TypeChecker_Env.check_uvars);
                     FStar_TypeChecker_Env.use_eq =
                       (uu___123_1600.FStar_TypeChecker_Env.use_eq);
                     FStar_TypeChecker_Env.is_iface =
                       (uu___123_1600.FStar_TypeChecker_Env.is_iface);
                     FStar_TypeChecker_Env.admit =
                       (uu___123_1600.FStar_TypeChecker_Env.admit);
                     FStar_TypeChecker_Env.lax =
                       (uu___123_1600.FStar_TypeChecker_Env.lax);
                     FStar_TypeChecker_Env.lax_universes =
                       (uu___123_1600.FStar_TypeChecker_Env.lax_universes);
                     FStar_TypeChecker_Env.failhard =
                       (uu___123_1600.FStar_TypeChecker_Env.failhard);
                     FStar_TypeChecker_Env.nosynth =
                       (uu___123_1600.FStar_TypeChecker_Env.nosynth);
                     FStar_TypeChecker_Env.type_of =
                       (uu___123_1600.FStar_TypeChecker_Env.type_of);
                     FStar_TypeChecker_Env.universe_of =
                       (uu___123_1600.FStar_TypeChecker_Env.universe_of);
                     FStar_TypeChecker_Env.use_bv_sorts =
                       (uu___123_1600.FStar_TypeChecker_Env.use_bv_sorts);
                     FStar_TypeChecker_Env.qname_and_index =
                       (uu___123_1600.FStar_TypeChecker_Env.qname_and_index);
                     FStar_TypeChecker_Env.proof_ns =
                       (uu___123_1600.FStar_TypeChecker_Env.proof_ns);
                     FStar_TypeChecker_Env.synth =
                       (uu___123_1600.FStar_TypeChecker_Env.synth);
                     FStar_TypeChecker_Env.is_native_tactic =
                       (uu___123_1600.FStar_TypeChecker_Env.is_native_tactic);
                     FStar_TypeChecker_Env.identifier_info =
                       (uu___123_1600.FStar_TypeChecker_Env.identifier_info)
                   } in
                 let uu____1601 =
                 ...
                 (match uu____1601 with
                  | (ps,w) ->
                      ...
                      (match r with
                       | FStar_Tactics_Basic.Success (uu____1635,ps1) ->
                           ((let uu____1638 = FStar_ST.op_Bang tacdbg in
                             if uu____1638
                             then
                               let uu____1649 =
                            ...
                            (let g =
                                 ...
                                 FStar_TypeChecker_Rel.trivial_guard in
                               {
                                 FStar_TypeChecker_Env.guard_f =
                                   (uu___126_1663.FStar_TypeChecker_Env.guard_f);
                                 FStar_TypeChecker_Env.deferred =
                                   (uu___126_1663.FStar_TypeChecker_Env.deferred);
                                 FStar_TypeChecker_Env.univ_ineqs =
                                   (uu___126_1663.FStar_TypeChecker_Env.univ_ineqs);
                           ...
                           (FStar_Tactics_Basic.dump_proofstate ps1
                            ...
                            (let uu____1672 =
                               let uu____1673 =
                                 ...
                                 (uu____1678, (typ.FStar_Syntax_Syntax.pos)) in
                               FStar_Errors.Error uu____1673 in
                             FStar_Exn.raise uu____1672)))))
type pol =
  | Pos
  | Neg
let uu___is_Pos: pol -> Prims.bool =
  fun projectee  -> match projectee with | Pos  -> true | uu____1689 -> false
let uu___is_Neg: pol -> Prims.bool =
  fun projectee  -> match projectee with | Neg  -> true | uu____1694 -> false
...
let by_tactic_interp:
  ...
  fun pol  ->
    fun e  ->
      fun t  ->
        let uu____1723 = FStar_Syntax_Util.head_and_args t in
        match uu____1723 with
        | (hd1,args) ->
            let uu____1766 =
              let uu____1779 =
                let uu____1780 = FStar_Syntax_Util.un_uinst hd1 in
                uu____1780.FStar_Syntax_Syntax.n in
              (uu____1779, args) in
            (match uu____1766 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(rett,FStar_Pervasives_Native.Some
                    (FStar_Syntax_Syntax.Implicit uu____1799))::(tactic,FStar_Pervasives_Native.None
                 ...
                 if pol = Pos
                 then
                   let uu____1868 = run_tactic_on_typ tactic e assertion in
                   ...
                   let uu____1934 =
                     let uu____1937 =
                       ...
                       FStar_All.pipe_left FStar_Pervasives_Native.fst
                         uu____1938 in
                     [uu____1937] in
                   (FStar_Syntax_Util.t_true, uu____1934)
                 else (assertion, [])
             | uu____1954 -> (t, []))
let rec traverse:
  (pol ->
    ...
    fun pol  ->
      fun e  ->
        fun t  ->
          let uu____2024 =
            let uu____2031 =
              let uu____2032 = FStar_Syntax_Subst.compress t in
              uu____2032.FStar_Syntax_Syntax.n in
            match uu____2031 with
            | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
                let uu____2047 = traverse f pol e t1 in
                (match uu____2047 with
                 | (t',gs) -> ((FStar_Syntax_Syntax.Tm_uinst (t', us)), gs))
            | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
                let uu____2074 = traverse f pol e t1 in
                (match uu____2074 with
                 | (t',gs) -> ((FStar_Syntax_Syntax.Tm_meta (t', m)), gs))
            | FStar_Syntax_Syntax.Tm_app
                ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                   FStar_Syntax_Syntax.pos = uu____2096;
                   FStar_Syntax_Syntax.vars = uu____2097;_},(p,uu____2099)::
                 (q,uu____2101)::[])
                when
                FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.imp_lid
                ->
                let x =
                  let uu____2141 = FStar_Syntax_Util.mk_squash p in
                  FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None
                    uu____2141 in
                let uu____2142 = traverse f (flip pol) e p in
                (match uu____2142 with
                 | (p',gs1) ->
                     let uu____2161 =
                       let uu____2168 = FStar_TypeChecker_Env.push_bv e x in
                       traverse f pol uu____2168 q in
                     (match uu____2161 with
                      | (q',gs2) ->
                          let uu____2181 =
                            let uu____2182 = FStar_Syntax_Util.mk_imp p' q' in
                            uu____2182.FStar_Syntax_Syntax.n in
                          (uu____2181, (FStar_List.append gs1 gs2))))
            | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
                let uu____2209 = traverse f pol e hd1 in
                       ...
                       FStar_List.fold_right
                         (fun uu____2266  ->
                            fun uu____2267  ->
                              ...
                              | ((a,q),(as',gs)) ->
                                  let uu____2348 = traverse f pol e a in
            ...
            | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
                let uu____2452 = FStar_Syntax_Subst.open_term bs t1 in
                           ...
                           (fun uu____2514  ->
                              ...
                              | (bv,aq) ->
                                  ...
                                  (match uu____2531 with
                                   | (s',gs) ->
                                       (((let uu___127_2561 = bv in
                                          {
                                            FStar_Syntax_Syntax.ppname =
                                              (uu___127_2561.FStar_Syntax_Syntax.ppname);
                                            FStar_Syntax_Syntax.index =
                                              (uu___127_2561.FStar_Syntax_Syntax.index);
                                            FStar_Syntax_Syntax.sort = s'
                                          }), aq), gs))) bs1 in
                       FStar_All.pipe_left FStar_List.unzip uu____2481 in
                     (match uu____2466 with
                      | (bs2,gs1) ->
                          let gs11 = FStar_List.flatten gs1 in
                          let uu____2625 = traverse f pol e' topen in
                          (match uu____2625 with
                           | (topen',gs2) ->
                               ...
                               (uu____2644, (FStar_List.append gs11 gs2)))))
            | x -> (x, []) in
          match uu____2024 with
          | (tn',gs) ->
              let t' =
                let uu___128_2668 = t in
                {
                  FStar_Syntax_Syntax.n = tn';
                  FStar_Syntax_Syntax.pos =
                    (uu___128_2668.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
                    (uu___128_2668.FStar_Syntax_Syntax.vars)
                } in
              let uu____2669 = f pol e t' in
  ...
  fun env  ->
    fun goal  ->
      (let uu____2728 =
       ...
       FStar_ST.op_Colon_Equals tacdbg uu____2728);
      (let uu____2740 = FStar_ST.op_Bang tacdbg in
       if uu____2740
       then
         let uu____2751 =
           let uu____2752 = FStar_TypeChecker_Env.all_binders env in
           FStar_All.pipe_right uu____2752
             (FStar_Syntax_Print.binders_to_string ",") in
         let uu____2753 = FStar_Syntax_Print.term_to_string goal in
         FStar_Util.print2 "About to preprocess %s |= %s\n" uu____2751
           uu____2753
       else ());
      (let initial = ((Prims.parse_int "1"), []) in
       let uu____2782 = traverse by_tactic_interp Pos env goal in
       ...
       | (t',gs) ->
           ((let uu____2804 = FStar_ST.op_Bang tacdbg in
             ...
             then
               let uu____2815 =
                 let uu____2816 = FStar_TypeChecker_Env.all_binders env in
                 FStar_All.pipe_right uu____2816
                   (FStar_Syntax_Print.binders_to_string ", ") in
               let uu____2817 = FStar_Syntax_Print.term_to_string t' in
               FStar_Util.print2 "Main goal simplified to: %s |- %s\n"
                 uu____2815 uu____2817
             else ());
            (let s = initial in
             let s1 =
                 ...
                 (fun uu____2864  ->
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____2916 = FStar_ST.op_Bang tacdbg in
                            if uu____2916
                            then
                              let uu____2927 = FStar_Util.string_of_int n1 in
                              let uu____2928 =
  ...
  fun a  ->
    let r =
      let uu____3005 =
        ...
        FStar_Syntax_Syntax.fv_to_tm uu____3006 in
      FStar_Syntax_Syntax.mk_Tm_uinst uu____3005 [FStar_Syntax_Syntax.U_zero] in
    let uu____3007 =
      let uu____3008 =
        let uu____3009 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
        let uu____3010 =
          let uu____3013 = FStar_Syntax_Syntax.as_arg a in [uu____3013] in
        uu____3009 :: uu____3010 in
      FStar_Syntax_Syntax.mk_Tm_app r uu____3008 in
    uu____3007 FStar_Pervasives_Native.None a.FStar_Syntax_Syntax.pos
let synth:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun typ  ->
      fun tau  ->
        (let uu____3029 =
           FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac") in
         FStar_ST.op_Colon_Equals tacdbg uu____3029);
        (let uu____3040 =
           let uu____3047 = reify_tactic tau in
           run_tactic_on_typ uu____3047 env typ in
                 ...
                 (fun g  ->
                    let uu____3058 =
                      let uu____3059 =
                        getprop g.FStar_Tactics_Basic.context
                          g.FStar_Tactics_Basic.goal_ty in
                      FStar_Option.isSome uu____3059 in
                    Prims.op_Negation uu____3058) gs in
             if uu____3054
             then
               FStar_Exn.raise
                 (FStar_Errors.Error
