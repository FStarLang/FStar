                   ...
                   | (env1,uu____2399) ->
                       let env2 =
                         let uu___199_2405 = env1  in
                         {
                           ...
                           FStar_TypeChecker_Env.erasable_types_tab =
                             (uu___199_2405.FStar_TypeChecker_Env.erasable_types_tab)
                         }  in
                       let env3 =
                         let uu___202_2408 = env2  in
                         {
                           ...
                           FStar_TypeChecker_Env.erasable_types_tab =
                             (uu___202_2408.FStar_TypeChecker_Env.erasable_types_tab)
                         }  in
                       let env4 =
                         let uu___205_2411 = env3  in
                         {
                           ...
                           FStar_TypeChecker_Env.erasable_types_tab =
                             (uu___205_2411.FStar_TypeChecker_Env.erasable_types_tab)
                         }  in
                       let rng =
...
<<<<<<< HEAD
                                              FStar_TypeChecker_Common.guard_f
                                                =
                                                (uu___236_2663.FStar_TypeChecker_Common.guard_f);
                                              FStar_TypeChecker_Common.deferred
                                                =
                                                (uu___236_2663.FStar_TypeChecker_Common.deferred);
                                              FStar_TypeChecker_Common.univ_ineqs
                                                =
                                                (uu___236_2663.FStar_TypeChecker_Common.univ_ineqs);
              ...
              ((let uu____5462 =
                  FStar_List.existsML
                    (fun g  ->
                       let uu____5467 =
                         let uu____5469 =
                           let uu____5472 = FStar_Tactics_Types.goal_env g
                              in
                           let uu____5473 = FStar_Tactics_Types.goal_type g
                              in
                           getprop uu____5472 uu____5473  in
                         FStar_Option.isSome uu____5469  in
                       Prims.op_Negation uu____5467) gs
                   in
                if uu____5462
                then
                  FStar_Errors.raise_error
               ...
               (let w1 =
                ...
                (let uu____5481 = FStar_ST.op_Bang tacdbg  in
                 if uu____5481
                 then
                   let uu____5505 = FStar_Syntax_Print.term_to_string w1  in
                ...
                (let uu____5510 =
                   let uu____5515 =
                     FStar_Syntax_Embeddings.e_list
                      ...
                      in
                   FStar_Tactics_InterpFuns.unembed uu____5515 w1
                     FStar_Syntax_Embeddings.id_norm_cb
                    in
    ...
    fun tau  ->
      fun tm  ->
        ...
        then tm
          ...
          ((let uu____5555 =
              FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")  in
            FStar_ST.op_Colon_Equals tacdbg uu____5555);
           (let ps =
            ...
            let uu____5580 =
              run_tactic_on_ps tau.FStar_Syntax_Syntax.pos
               ...
               in
            match uu____5580 with | (gs,tm1) -> tm1))
          ...
          then tm
            ...
            ((let uu____5618 =
             ...
             (let uu____5642 =
              ...
              | (uvtm,uu____5661,g_imp) ->
                  let u = env.FStar_TypeChecker_Env.universe_of env typ  in
                  let goal =
                    let uu____5679 = FStar_Syntax_Util.mk_eq2 u typ tm uvtm
                       in
                    FStar_Syntax_Util.mk_squash u uu____5679  in
                  let uu____5680 =
                    run_tactic_on_typ tau.FStar_Syntax_Syntax.pos
                       ...
                       (FStar_List.iter
                          (fun g  ->
                             let uu____5701 =
                               ...
                               let uu____5705 =
                                 FStar_Tactics_Types.goal_type g  in
                               getprop uu____5704 uu____5705  in
                             match uu____5701 with
                             | FStar_Pervasives_Native.Some vc ->
                                 ((let uu____5708 = FStar_ST.op_Bang tacdbg
                                      in
                                   if uu____5708
                                   then
                                     let uu____5732 =
