    ...
    fun env  ->
      fun typ  ->
        (let uu____1688 = FStar_ST.op_Bang tacdbg in
         if uu____1688
         then
           let uu____1699 = FStar_Syntax_Print.term_to_string tactic in
           FStar_Util.print1 "About to reduce uvars on: %s\n" uu____1699
         else ());
        (let tactic1 =
           FStar_TypeChecker_Normalize.reduce_uvar_solutions env tactic in
         (let uu____1703 = FStar_ST.op_Bang tacdbg in
          if uu____1703
          then
            let uu____1714 = FStar_Syntax_Print.term_to_string tactic1 in
            FStar_Util.print1 "About to check tactic term: %s\n" uu____1714
          else ());
         (let uu____1716 =
            FStar_TypeChecker_TcTerm.tc_reified_tactic env tactic1 in
          match uu____1716 with
          | (tactic2,uu____1730,uu____1731) ->
              let tau =
                unembed_tactic_0 FStar_Syntax_Embeddings.unembed_unit tactic2 in
              let uu____1735 = FStar_TypeChecker_Env.clear_expected_typ env in
              (match uu____1735 with
               | (env1,uu____1749) ->
                   let env2 =
                     let uu___136_1755 = env1 in
                     {
                       FStar_TypeChecker_Env.solver =
                         (uu___136_1755.FStar_TypeChecker_Env.solver);
                       FStar_TypeChecker_Env.range =
                         (uu___136_1755.FStar_TypeChecker_Env.range);
                       FStar_TypeChecker_Env.curmodule =
                         (uu___136_1755.FStar_TypeChecker_Env.curmodule);
                       FStar_TypeChecker_Env.gamma =
                         (uu___136_1755.FStar_TypeChecker_Env.gamma);
                       FStar_TypeChecker_Env.gamma_cache =
                         (uu___136_1755.FStar_TypeChecker_Env.gamma_cache);
                       FStar_TypeChecker_Env.modules =
                         (uu___136_1755.FStar_TypeChecker_Env.modules);
                       FStar_TypeChecker_Env.expected_typ =
                         (uu___136_1755.FStar_TypeChecker_Env.expected_typ);
                       FStar_TypeChecker_Env.sigtab =
                         (uu___136_1755.FStar_TypeChecker_Env.sigtab);
                       FStar_TypeChecker_Env.is_pattern =
                         (uu___136_1755.FStar_TypeChecker_Env.is_pattern);
                       FStar_TypeChecker_Env.instantiate_imp = false;
                       FStar_TypeChecker_Env.effects =
                         (uu___136_1755.FStar_TypeChecker_Env.effects);
                       FStar_TypeChecker_Env.generalize =
                         (uu___136_1755.FStar_TypeChecker_Env.generalize);
                       FStar_TypeChecker_Env.letrecs =
                         (uu___136_1755.FStar_TypeChecker_Env.letrecs);
                       FStar_TypeChecker_Env.top_level =
                         (uu___136_1755.FStar_TypeChecker_Env.top_level);
                       FStar_TypeChecker_Env.check_uvars =
                         (uu___136_1755.FStar_TypeChecker_Env.check_uvars);
                       FStar_TypeChecker_Env.use_eq =
                         (uu___136_1755.FStar_TypeChecker_Env.use_eq);
                       FStar_TypeChecker_Env.is_iface =
                         (uu___136_1755.FStar_TypeChecker_Env.is_iface);
                       FStar_TypeChecker_Env.admit =
                         (uu___136_1755.FStar_TypeChecker_Env.admit);
                       FStar_TypeChecker_Env.lax =
                         (uu___136_1755.FStar_TypeChecker_Env.lax);
                       FStar_TypeChecker_Env.lax_universes =
                         (uu___136_1755.FStar_TypeChecker_Env.lax_universes);
                       FStar_TypeChecker_Env.failhard =
                         (uu___136_1755.FStar_TypeChecker_Env.failhard);
                       FStar_TypeChecker_Env.nosynth =
                         (uu___136_1755.FStar_TypeChecker_Env.nosynth);
                       FStar_TypeChecker_Env.tc_term =
                         (uu___136_1755.FStar_TypeChecker_Env.tc_term);
                       FStar_TypeChecker_Env.type_of =
                         (uu___136_1755.FStar_TypeChecker_Env.type_of);
                       FStar_TypeChecker_Env.universe_of =
                         (uu___136_1755.FStar_TypeChecker_Env.universe_of);
                       FStar_TypeChecker_Env.use_bv_sorts =
                         (uu___136_1755.FStar_TypeChecker_Env.use_bv_sorts);
                       FStar_TypeChecker_Env.qname_and_index =
                         (uu___136_1755.FStar_TypeChecker_Env.qname_and_index);
                       FStar_TypeChecker_Env.proof_ns =
                         (uu___136_1755.FStar_TypeChecker_Env.proof_ns);
                       FStar_TypeChecker_Env.synth =
                         (uu___136_1755.FStar_TypeChecker_Env.synth);
                       FStar_TypeChecker_Env.is_native_tactic =
                         (uu___136_1755.FStar_TypeChecker_Env.is_native_tactic);
                       FStar_TypeChecker_Env.identifier_info =
                         (uu___136_1755.FStar_TypeChecker_Env.identifier_info)
                     } in
                   let uu____1756 =
                     FStar_Tactics_Basic.proofstate_of_goal_ty env2 typ in
                   (match uu____1756 with
                    | (ps,w) ->
                        let uu____1769 = FStar_Tactics_Basic.run tau ps in
                        (match uu____1769 with
                         | FStar_Tactics_Result.Success (uu____1778,ps1) ->
                             ((let uu____1781 = FStar_ST.op_Bang tacdbg in
                               if uu____1781
                               then
                                 let uu____1792 =
                              ...
                              (let g =
                                   ...
                                   FStar_TypeChecker_Rel.trivial_guard in
                                 {
                                   FStar_TypeChecker_Env.guard_f =
                                     (uu___137_1806.FStar_TypeChecker_Env.guard_f);
                                   FStar_TypeChecker_Env.deferred =
                                     (uu___137_1806.FStar_TypeChecker_Env.deferred);
                                   FStar_TypeChecker_Env.univ_ineqs =
                                     (uu___137_1806.FStar_TypeChecker_Env.univ_ineqs);
                         ...
                         | FStar_Tactics_Result.Failed (s,ps1) ->
                             (FStar_Tactics_Basic.dump_proofstate ps1
                              ...
                              (let uu____1815 =
                                 ...
                                 FStar_Errors.Error uu____1816 in
                               FStar_Exn.raise uu____1815)))))))
type pol =
  | Pos
  | Neg[@@deriving show]
let uu___is_Pos: pol -> Prims.bool =
  fun projectee  -> match projectee with | Pos  -> true | uu____1832 -> false
let uu___is_Neg: pol -> Prims.bool =
  fun projectee  -> match projectee with | Neg  -> true | uu____1837 -> false
...
let by_tactic_interp:
  ...
  fun pol  ->
    fun e  ->
      fun t  ->
        let uu____1866 = FStar_Syntax_Util.head_and_args t in
        match uu____1866 with
        | (hd1,args) ->
            let uu____1909 =
              let uu____1922 =
                let uu____1923 = FStar_Syntax_Util.un_uinst hd1 in
                uu____1923.FStar_Syntax_Syntax.n in
              (uu____1922, args) in
            (match uu____1909 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(rett,FStar_Pervasives_Native.Some
                    (FStar_Syntax_Syntax.Implicit uu____1942))::(tactic,FStar_Pervasives_Native.None
                 ...
                 if pol = Pos
                 then
                   let uu____2011 = run_tactic_on_typ tactic e assertion in
                   (match uu____2011 with
                    | (gs,uu____2025) -> (FStar_Syntax_Util.t_true, gs))
                 else (assertion, [])
             | (FStar_Syntax_Syntax.Tm_fvar
                   ...
                   let uu____2077 =
                     let uu____2080 =
                       ...
                       FStar_All.pipe_left FStar_Pervasives_Native.fst
                         uu____2081 in
                     [uu____2080] in
                   (FStar_Syntax_Util.t_true, uu____2077)
                 else (assertion, [])
             | uu____2097 -> (t, []))
let rec traverse:
  (pol ->
    ...
    fun pol  ->
      fun e  ->
        fun t  ->
          let uu____2167 =
            let uu____2174 =
              let uu____2175 = FStar_Syntax_Subst.compress t in
              uu____2175.FStar_Syntax_Syntax.n in
            match uu____2174 with
            | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
                let uu____2190 = traverse f pol e t1 in
                (match uu____2190 with
                 | (t',gs) -> ((FStar_Syntax_Syntax.Tm_uinst (t', us)), gs))
            | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
                let uu____2217 = traverse f pol e t1 in
                (match uu____2217 with
                 | (t',gs) -> ((FStar_Syntax_Syntax.Tm_meta (t', m)), gs))
            | FStar_Syntax_Syntax.Tm_app
                ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                   FStar_Syntax_Syntax.pos = uu____2239;
                   FStar_Syntax_Syntax.vars = uu____2240;_},(p,uu____2242)::
                 (q,uu____2244)::[])
                when
                FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.imp_lid
                ->
                let x =
                  let uu____2284 = FStar_Syntax_Util.mk_squash p in
                  FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None
                    uu____2284 in
                let uu____2285 = traverse f (flip pol) e p in
                (match uu____2285 with
                 | (p',gs1) ->
                     let uu____2304 =
                       let uu____2311 = FStar_TypeChecker_Env.push_bv e x in
                       traverse f pol uu____2311 q in
                     (match uu____2304 with
                      | (q',gs2) ->
                          let uu____2324 =
                            let uu____2325 = FStar_Syntax_Util.mk_imp p' q' in
                            uu____2325.FStar_Syntax_Syntax.n in
                          (uu____2324, (FStar_List.append gs1 gs2))))
            | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
                let uu____2352 = traverse f pol e hd1 in
                 ...
                 | (hd',gs1) ->
                     let uu____2371 =
                       FStar_List.fold_right
                         (fun uu____2409  ->
                            fun uu____2410  ->
                              match (uu____2409, uu____2410) with
                              | ((a,q),(as',gs)) ->
                                  let uu____2491 = traverse f pol e a in
                           ...
                           (fun uu____2657  ->
                              ...
                              | (bv,aq) ->
                                  ...
                                  (match uu____2674 with
                                   | (s',gs) ->
                                       (((let uu___138_2704 = bv in
                                          {
                                            FStar_Syntax_Syntax.ppname =
                                              (uu___138_2704.FStar_Syntax_Syntax.ppname);
                                            FStar_Syntax_Syntax.index =
                                              (uu___138_2704.FStar_Syntax_Syntax.index);
                                            FStar_Syntax_Syntax.sort = s'
                                          }), aq), gs))) bs1 in
                       FStar_All.pipe_left FStar_List.unzip uu____2624 in
                     (match uu____2609 with
                      | (bs2,gs1) ->
                          let gs11 = FStar_List.flatten gs1 in
                          let uu____2768 = traverse f pol e' topen in
                          (match uu____2768 with
                           | (topen',gs2) ->
                               ...
                               (uu____2787, (FStar_List.append gs11 gs2)))))
            | x -> (x, []) in
          match uu____2167 with
          | (tn',gs) ->
              let t' =
                let uu___139_2811 = t in
                {
                  FStar_Syntax_Syntax.n = tn';
                  FStar_Syntax_Syntax.pos =
                    (uu___139_2811.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
                    (uu___139_2811.FStar_Syntax_Syntax.vars)
                } in
              let uu____2812 = f pol e t' in
  ...
  fun env  ->
    fun goal  ->
      (let uu____2871 =
       ...
       FStar_ST.op_Colon_Equals tacdbg uu____2871);
      (let uu____2883 = FStar_ST.op_Bang tacdbg in
       if uu____2883
       then
         let uu____2894 =
           let uu____2895 = FStar_TypeChecker_Env.all_binders env in
           FStar_All.pipe_right uu____2895
             (FStar_Syntax_Print.binders_to_string ",") in
         let uu____2896 = FStar_Syntax_Print.term_to_string goal in
         FStar_Util.print2 "About to preprocess %s |= %s\n" uu____2894
           uu____2896
       else ());
      (let initial = ((Prims.parse_int "1"), []) in
       let uu____2925 = traverse by_tactic_interp Pos env goal in
       match uu____2925 with
       | (t',gs) ->
           ((let uu____2947 = FStar_ST.op_Bang tacdbg in
             if uu____2947
             then
               let uu____2958 =
                 let uu____2959 = FStar_TypeChecker_Env.all_binders env in
                 FStar_All.pipe_right uu____2959
                   (FStar_Syntax_Print.binders_to_string ", ") in
               let uu____2960 = FStar_Syntax_Print.term_to_string t' in
               FStar_Util.print2 "Main goal simplified to: %s |- %s\n"
                 uu____2958 uu____2960
             else ());
            (let s = initial in
             let s1 =
                 ...
                 (fun uu____3007  ->
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____3059 = FStar_ST.op_Bang tacdbg in
                            if uu____3059
                            then
                              let uu____3070 = FStar_Util.string_of_int n1 in
                              let uu____3071 =
                           ...
                           (let gt' =
                              let uu____3074 =
                                let uu____3075 = FStar_Util.string_of_int n1 in
                                Prims.strcat "Could not prove goal #"
                                  uu____3075 in
                              FStar_TypeChecker_Util.label uu____3074
                                goal.FStar_Syntax_Syntax.pos phi in
                            ((n1 + (Prims.parse_int "1")),
                              (((g.FStar_Tactics_Types.context), gt',
                                 (g.FStar_Tactics_Types.opts)) :: gs1))))) s
                 gs in
             let uu____3090 = s1 in
             match uu____3090 with
             | (uu____3111,gs1) ->
                 let uu____3129 =
                   let uu____3136 = FStar_Options.peek () in
                   (env, t', uu____3136) in
                 uu____3129 :: gs1)))
  ...
  fun a  ->
    let r =
      let uu____3148 =
        ...
        FStar_Syntax_Syntax.fv_to_tm uu____3149 in
      FStar_Syntax_Syntax.mk_Tm_uinst uu____3148 [FStar_Syntax_Syntax.U_zero] in
    let uu____3150 =
      let uu____3151 =
        let uu____3152 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
        let uu____3153 =
          let uu____3156 = FStar_Syntax_Syntax.as_arg a in [uu____3156] in
        uu____3152 :: uu____3153 in
      FStar_Syntax_Syntax.mk_Tm_app r uu____3151 in
    uu____3150 FStar_Pervasives_Native.None a.FStar_Syntax_Syntax.pos
let synth:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun typ  ->
      fun tau  ->
        (let uu____3172 =
           FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac") in
         FStar_ST.op_Colon_Equals tacdbg uu____3172);
        (let uu____3183 =
           let uu____3190 = reify_tactic tau in
           run_tactic_on_typ uu____3190 env typ in
                 ...
                 (fun g  ->
                    let uu____3201 =
                      let uu____3202 =
                        getprop g.FStar_Tactics_Types.context
                          g.FStar_Tactics_Types.goal_ty in
                      FStar_Option.isSome uu____3202 in
                    Prims.op_Negation uu____3201) gs in
             if uu____3197
             then
               FStar_Exn.raise
                 (FStar_Errors.Error
