        ...
        | (embedded_env,uu____70)::[] ->
            let env =
              FStar_Tactics_Embedding.unembed_env
                ps.FStar_Tactics_Basic.main_context embedded_env
               in
            let uu____84 =
...
let mk_pure_interpretation_1 f unembed_a embed_b nm args =
  ...
  (match args with
   | a::[] ->
       let uu____319 =
         let uu____320 = let uu____321 = unembed_a (fst a)  in f uu____321
            in
      ...
      ((let uu____381 = FStar_ST.read FStar_Tactics_Basic.tacdbg  in
       ...
       (let uu____387 =
          FStar_Tactics_Embedding.unembed_state
            ps.FStar_Tactics_Basic.main_context embedded_state
           in
    ...
    let uu____762 =
      mk1 "__forall_intros" (Prims.parse_int "1")
        (mk_tactic_interpretation_0 ps FStar_Tactics_Basic.intros
           ...
           FStar_Tactics_Embedding.fstar_tactics_binders)
       in
    let uu____763 =
      let uu____765 =
        mk1 "__implies_intro" (Prims.parse_int "1")
          (mk_tactic_interpretation_0 ps FStar_Tactics_Basic.imp_intro
             ...
             FStar_Tactics_Embedding.fstar_tactics_binder)
         in
      let uu____766 =
        let uu____768 =
                                  ...
                                  mk1 "__term_as_formula"
                                    ...
                                    (mk_pure_interpretation_1
                                       ...
                                       (FStar_Tactics_Embedding.embed_option
                                          ...
                                          FStar_Tactics_Embedding.fstar_tactics_formula))
                                   in
                                let uu____810 =
                                  let uu____812 =
                                    mk1 "__inspect" (Prims.parse_int "1")
                                      (mk_pure_interpretation_1
                                         ...
                                         (FStar_Tactics_Embedding.embed_option
                                            ...
                                            FStar_Tactics_Embedding.fstar_tactics_term_view))
                                     in
                                  let uu____814 =
                                    let uu____816 =
                                        ...
                                        let uu____823 =
                                          mk1 "__pack_fv"
                                            ...
                                            (mk_pure_interpretation_1
                                               ...
                                               FStar_Tactics_Embedding.embed_fvar)
                                           in
                                        let uu____825 =
                                          let uu____827 =
                                            mk1 "__inspect_bv"
                                            ...
                                            let uu____830 =
                                              mk1 "__compare_binder"
                                                ...
                                                (mk_pure_interpretation_2
                                                   ...
                                                   FStar_Tactics_Embedding.unembed_binder
                                                   FStar_Tactics_Embedding.unembed_binder
                                                   FStar_Tactics_Embedding.embed_order)
                                               in
                                            let uu____831 =
                                              let uu____833 =
                     ...
                     FStar_Tactics_Basic.bind FStar_Tactics_Basic.dismiss
                       (fun uu____920  ->
                          ...
                          FStar_Tactics_Basic.bind uu____921
                            (fun uu____923  ->
                               let uu____924 =
                                 FStar_Tactics_Basic.add_smt_goals smt_goals
                                  in
         ...
         (fun proof_state  ->
            let uu____956 =
              FStar_Syntax_Util.head_and_args
                goal.FStar_Tactics_Basic.goal_ty
               in
                    ...
                    fv,(tactic,uu____1003)::(assertion,uu____1005)::[]) when
                     ...
                     let uu____1031 =
                       ...
                       FStar_Tactics_Basic.bind uu____1033
                         (fun uu____1036  ->
                            unembed_tactic_0
                              FStar_Tactics_Embedding.unembed_unit tactic)
                        in
