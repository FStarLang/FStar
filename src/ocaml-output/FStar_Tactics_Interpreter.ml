                       ...
                       FStar_Tactics_Basic.log ps1
                         (fun uu____87 ->
                            ...
                            FStar_Util.print2 "Reached %s, args are: %s\n"
                              uu____88 uu____89);
                       (let res =
                          let uu____91 = FStar_Tactics_Embedding.e_result er in
                          let uu____96 =
              ...
              fun args ->
                ...
                | (a, uu____164)::(embedded_state, uu____166)::[] ->
                    ...
                    FStar_Util.bind_opt uu____193
                      (fun ps ->
                         ...
                         FStar_Tactics_Basic.log ps1
                           (fun uu____206 ->
                              let uu____207 = FStar_Ident.string_of_lid nm in
                              let uu____208 =
                ...
                | uu____231 ->
                    let uu____232 =
                      ...
                      let uu____234 = FStar_Syntax_Print.args_to_string args in
                      FStar_Util.format2
              ...
              fun args ->
                ...
                | (a, uu____301)::(embedded_state, uu____303)::[] ->
                    ...
                    FStar_Util.bind_opt uu____330
                      (fun ps ->
                         ...
                         FStar_Tactics_Basic.log ps1
                           (fun uu____343 ->
                              let uu____344 = FStar_Ident.string_of_lid nm in
                              let uu____345 =
                                FStar_Syntax_Print.term_to_string
                                  embedded_state in
                              FStar_Util.print2 "Reached %s, goals are: %s\n"
                ...
                | uu____368 ->
                    let uu____369 =
                      ...
                      let uu____371 = FStar_Syntax_Print.args_to_string args in
                      FStar_Util.format2
                        "Unexpected application of tactic primitive %s %s"
          ...
          fun er ->
            fun nm ->
              fun psc ->
                fun args ->
                  match args with
                  | (a, uu____449)::(b, uu____451)::(embedded_state,
                                                     uu____453)::[]
                      ->
                      let uu____490 =
                        FStar_Syntax_Embeddings.unembed
                      ...
                      FStar_Util.bind_opt uu____490
                        (fun ps ->
                           ...
                           FStar_Tactics_Basic.log ps1
                             (fun uu____503 ->
                                let uu____504 = FStar_Ident.string_of_lid nm in
                                let uu____505 =
                                  FStar_Syntax_Print.term_to_string
                                    embedded_state in
                                FStar_Util.print2
                                 ...
                                 FStar_Util.bind_opt uu____512
                                   (fun b1 ->
                                      let res =
                                        ...
                                        FStar_Tactics_Basic.run uu____522 ps1 in
                                      let uu____525 =
                                        let uu____526 =
                                          FStar_Tactics_Embedding.e_result er in
                                        let uu____531 =
            ...
            fun er ->
              fun nm ->
                fun psc ->
                  fun args ->
                    match args with
                    | (a, uu____631)::(b, uu____633)::(c, uu____635)::
                        (embedded_state, uu____637)::[] ->
                        let uu____684 =
                          FStar_Syntax_Embeddings.unembed
                    ...
                    fun psc ->
                      fun args ->
                        ...
                        | (a, uu____1097)::(b, uu____1099)::(c, uu____1101)::
                            (d, uu____1103)::(e, uu____1105)::(embedded_state,
                                                               uu____1107)::[]
                            ->
                            let uu____1174 =
                              FStar_Syntax_Embeddings.unembed
                        ...
                        | uu____1236 ->
                            let uu____1237 =
                              let uu____1238 = FStar_Ident.string_of_lid nm in
                              let uu____1239 =
                                FStar_Syntax_Print.args_to_string args in
                              FStar_Util.format2
                                "Unexpected application of tactic primitive %s %s"
                    ...
                    fun nm ->
                      fun psc ->
                        fun args ->
                          ...
                          | uu____1538 ->
                              let uu____1539 =
                                let uu____1540 = FStar_Ident.string_of_lid nm in
                                let uu____1541 =
                                  FStar_Syntax_Print.args_to_string args in
                                FStar_Util.format2
                                  "Unexpected application of tactic primitive %s %s"
      ...
      | (ps, uu____1998)::[] ->
          ...
          FStar_Util.bind_opt uu____2015
            (fun ps1 ->
               ...
               let uu____2023 =
                 let uu____2024 = FStar_TypeChecker_Normalize.psc_range psc in
                 let uu____2025 = FStar_Tactics_Types.decr_depth ps2 in
                 FStar_Syntax_Embeddings.embed
                   FStar_Tactics_Embedding.e_proofstate uu____2024 uu____2025 in
      ...
      | (ps, uu____2043)::[] ->
          ...
          FStar_Util.bind_opt uu____2060
            (fun ps1 ->
               let ps2 = FStar_Tactics_Types.set_ps_psc psc ps1 in
               let uu____2068 =
                 let uu____2069 = FStar_TypeChecker_Normalize.psc_range psc in
                 let uu____2070 = FStar_Tactics_Types.incr_depth ps2 in
                 FStar_Syntax_Embeddings.embed
                   FStar_Tactics_Embedding.e_proofstate uu____2069 uu____2070 in
                 ...
                 (fun r1 ->
                    ...
                    let uu____2182 =
                      let uu____2183 =
                        FStar_TypeChecker_Normalize.psc_range psc in
                      FStar_Syntax_Embeddings.embed
                        FStar_Tactics_Embedding.e_proofstate uu____2183 ps' in
    ...
    let uu____2252 =
      let uu____2255 =
        mktac2 () () () "fail"
          (fun a445 ->
             fun a446 ->
               (Obj.magic (fun uu____2257 -> FStar_Tactics_Basic.fail)) a445
                 a446) (Obj.magic FStar_Syntax_Embeddings.e_any)
          (Obj.magic FStar_Syntax_Embeddings.e_string)
          (Obj.magic FStar_Syntax_Embeddings.e_any) in
      let uu____2258 =
        let uu____2261 =
          mktac1 () () "trivial"
            (fun a447 -> (Obj.magic FStar_Tactics_Basic.trivial) a447)
            (Obj.magic FStar_Syntax_Embeddings.e_unit)
            (Obj.magic FStar_Syntax_Embeddings.e_unit) in
        let uu____2262 =
          let uu____2265 =
              ...
              (fun a448 ->
                 fun a449 ->
                   (Obj.magic (fun uu____2277 -> FStar_Tactics_Basic.trytac))
                     a448 a449) (Obj.magic FStar_Syntax_Embeddings.e_any)
              (Obj.magic uu____2266) (Obj.magic uu____2271) in
          let uu____2278 =
            let uu____2281 =
              mktac1 () () "intro"
            ...
            let uu____2282 =
              let uu____2285 =
                ...
                mktac1 () () "intro_rec"
                  (fun a451 -> (Obj.magic FStar_Tactics_Basic.intro_rec) a451)
                  (Obj.magic FStar_Syntax_Embeddings.e_unit)
                  (Obj.magic uu____2286) in
              let uu____2293 =
                let uu____2296 =
                  let uu____2297 =
                        ...
                        (fun a456 ->
                           fun a457 ->
                             (Obj.magic FStar_Tactics_Basic.norm_binder_type)
                               a456 a457) (Obj.magic uu____2315)
          ...
          | (uu____2900, uu____2901, g) ->
              (FStar_TypeChecker_Rel.force_trivial_guard env g;
               ...
               (let tau =
                ...
                let uu____2908 = FStar_TypeChecker_Env.clear_expected_typ env in
...
let (uu___is_Both : pol -> Prims.bool) =
  fun projectee -> match projectee with | Both -> true | uu____3092 -> false
type 'a tres_m =
  | Unchanged of 'a 
            ...
            (match uu____3321 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (rett, FStar_Pervasives_Native.Some
                 (FStar_Syntax_Syntax.Implicit uu____3348))::(tactic,
                                                              FStar_Pervasives_Native.None)::
                (assertion, FStar_Pervasives_Native.None)::[]) when
                 ...
                 (match pol with
                  | Pos ->
                      let uu____3411 = run_tactic_on_typ tactic e assertion in
                      (match uu____3411 with
                       | (gs, uu____3419) ->
                           Simplified (FStar_Syntax_Util.t_true, gs))
                  | Both ->
                      let uu____3426 = run_tactic_on_typ tactic e assertion in
    ...
    fun x ->
      fun y ->
        ...
        | (Unchanged t1, Simplified (t2, gs)) ->
            let uu____3731 = let uu____3738 = f t1 t2 in (uu____3738, gs) in
            Simplified uu____3731
        | (Simplified (t1, gs), Unchanged t2) ->
            let uu____3752 = let uu____3759 = f t1 t2 in (uu____3759, gs) in
                 ...
                 (match uu____3815 with
                  | (n2, p2, gs2) ->
                      let uu____3833 =
                        ...
                        (uu____3842, uu____3843, (FStar_List.append gs1 gs2)) in
                      Dual uu____3833))
          ...
          let r =
            ...
            | FStar_Syntax_Syntax.Tm_app
                ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                   ...
                   FStar_Syntax_Syntax.vars = uu____4041;_},
                 (p, uu____4043)::(q, uu____4045)::[])
                when
            ...
            | FStar_Syntax_Syntax.Tm_app
                ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                   ...
                   FStar_Syntax_Syntax.vars = uu____4099;_},
                 (p, uu____4101)::(q, uu____4103)::[])
                when
                ...
                (match uu____4381 with
                 | (bs1, topen) ->
                     ...
                     comb2
                       (fun bs2 ->
                          fun t2 ->
                            let uu____4473 = FStar_Syntax_Util.abs bs2 t2 k in
                    ...
                    fun g ->
                      ...
                      | (n1, gs1) ->
                          ...
                          ((let uu____4887 = FStar_ST.op_Bang tacdbg in
                           ...
                           (let gt' =
                              let uu____4911 =
                                let uu____4912 = FStar_Util.string_of_int n1 in
...
let (reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) =
  fun a ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____4984 [FStar_Syntax_Syntax.U_zero] in
    let uu____4986 =
      let uu____4987 =
        let uu____4988 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit in
        let uu____4989 =
             ...
             let uu____5039 =
               FStar_List.existsML
                 (fun g ->
                    ...
                    Prims.op_Negation uu____5043) gs in
             if uu____5039
             then
           ...
           ((let uu____5097 =
               FStar_List.existsML
                 (fun g ->
                    ...
                    Prims.op_Negation uu____5101) gs in
             if uu____5097
             then
               FStar_Errors.raise_error
                 (FStar_Errors.Fatal_OpenGoalsInSynthesis,
