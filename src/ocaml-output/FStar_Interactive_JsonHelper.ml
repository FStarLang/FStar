...
let (try_assoc :
  ...
  fun key  ->
    fun d  ->
      let uu___ =
        FStar_Util.try_find
          (fun uu___1  -> match uu___1 with | (k,uu___2) -> k = key) d
         in
...
let (write_json : FStar_Util.json -> unit) =
  fun js  ->
    (let uu___1 = FStar_Util.string_of_json js  in
     FStar_Util.print_raw uu___1);
...
let (uri_to_path : Prims.string -> Prims.string) =
  fun u  ->
    ...
    if uu___
    then
      let uu___1 = FStar_Util.substring u (Prims.of_int (8)) Prims.int_one
         in
...
let (js_txdoc_item : FStar_Util.json -> txdoc_item) =
  fun uu___  ->
    ...
    | FStar_Util.JsonAssoc a ->
        ...
        let uu___1 =
          let uu___2 =
            let uu___3 = arg1 "uri"  in FStar_All.pipe_right uu___3 js_str
             in
        ...
        let uu___3 =
          let uu___4 = arg1 "version"  in FStar_All.pipe_right uu___4 js_int
           in
        let uu___4 =
...
let (js_txdoc_pos : assoct -> txdoc_pos) =
  fun r  ->
    let pos =
      let uu___ = arg "position" r  in FStar_All.pipe_right uu___ js_assoc
       in
    let uu___ = js_txdoc_id r  in
    let uu___1 =
      let uu___2 = assoc "line" pos  in FStar_All.pipe_right uu___2 js_int
       in
    let uu___2 =
          ...
          FStar_List.map
            (fun uu___2  ->
               ...
               | FStar_Util.JsonAssoc a ->
                   ...
                   FStar_All.pipe_right uu___3 js_str) l
           in
  ...
  fun err  ->
    fun msg  ->
      let uu___ =
        let uu___1 =
          let uu___2 =
            let uu___3 = errorcode_to_int err  in FStar_Util.JsonInt uu___3
             in
          ("code", uu___2)  in
  ...
  fun p  ->
    let uu___ =
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 = FStar_Range.line_of_pos p  in uu___4 - Prims.int_one
             in
      ...
      let uu___1 =
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = path_to_uri fname  in FStar_Util.JsonStr uu___6
                 in
              ("uri", uu___5)  in
