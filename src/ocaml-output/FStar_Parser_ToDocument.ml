  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var lid;
           ...
           FStar_Parser_AST.level = uu____772;_},
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_singleton_lid;
           ...
           FStar_Parser_AST.level = uu____781;_},
         {
           ...
           FStar_Parser_AST.range = uu____786;
           FStar_Parser_AST.level = uu____787;_},
        ...
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_union_lid;
                ...
                FStar_Parser_AST.level = uu____790;_},
              e1, FStar_Parser_AST.Nothing);
  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____804;
         ...
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____807;
                FStar_Parser_AST.range = uu____808;
                FStar_Parser_AST.level = uu____809;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____811;
           FStar_Parser_AST.level = uu____812;_},
         FStar_Parser_AST.Nothing)
        -> [e1]
    | FStar_Parser_AST.App
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____813;
                ...
                FStar_Parser_AST.level = uu____815;_},
              e1, FStar_Parser_AST.Nothing);
...
let (uu___is_Right : associativity -> Prims.bool) =
  fun projectee -> match projectee with | Right -> true | uu____926 -> false
...
let opinfix4 :
  'Auu____1055 .
    Prims.unit ->
      (associativity,
        ('Auu____1055, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix3 :
  'Auu____1082 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1082) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  =
  fun uu____1094 ->
...
let opinfix2 :
  'Auu____1129 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1129) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let minus_lvl :
  'Auu____1169 .
    Prims.unit ->
      (associativity,
        ('Auu____1169, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix1 :
  'Auu____1196 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1196) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let pipe_right :
  'Auu____1236 .
    Prims.unit ->
      (associativity,
        ('Auu____1236, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0d :
  'Auu____1263 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1263) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0c :
  'Auu____1296 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1296) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  =
  fun uu____1308 ->
...
let equal :
  'Auu____1343 .
    Prims.unit ->
      (associativity,
        ('Auu____1343, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0b :
  'Auu____1370 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1370) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0a :
  'Auu____1403 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1403) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let colon_equals :
  'Auu____1436 .
    Prims.unit ->
      (associativity,
        ('Auu____1436, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let amp :
  'Auu____1463 .
    Prims.unit ->
      (associativity,
        ('Auu____1463, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let colon_colon :
  'Auu____1490 .
    Prims.unit ->
      (associativity,
        ('Auu____1490, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  ...
  fun l ->
    let find_level_and_max n1 level =
      ...
      | FStar_Pervasives_Native.Some
          ((uu____2117, l1, uu____2119), uu____2120) -> max n1 l1
      | FStar_Pervasives_Native.None ->
          let uu____2175 =
            ...
            FStar_Util.format1 "Undefined associativity level %s" uu____2176 in
...
let operatorInfix0ad12 :
  'Auu____2235 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____2235) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun uu____2249 ->
    [opinfix0a ();
    ...
    fun tm ->
      fun tmrange ->
        let rec comments_before_pos acc print_pos lookahead_pos =
          ...
          | [] -> (acc, false)
          | (comment, crange)::cs ->
              let uu____2690 = FStar_Range.range_before_pos crange print_pos in
              if uu____2690
              then
      ...
      fun pos_end ->
        fun doc1 ->
          ...
          | uu____2857 ->
              ...
              let uu____2867 = FStar_Pprint.repeat lnum FStar_Pprint.hardline in
          ...
          fun extract_range ->
            let fold_fun uu____2922 x =
              ...
              | (last_line, doc1) ->
                  ...
                  (uu____2937, uu____2939) in
            let uu____2942 =
              let uu____2949 = FStar_List.hd xs in
              let uu____2950 = FStar_List.tl xs in (uu____2949, uu____2950) in
...
let rec (p_decl : FStar_Parser_AST.decl -> FStar_Pprint.document) =
  fun d ->
    let uu____3347 =
      let uu____3348 = FStar_Pprint.optional p_fsdoc d.FStar_Parser_AST.doc in
      let uu____3349 =
    ...
    | (doc1, kwd_args) ->
        let kwd_args_doc =
          ...
          | kwd_args1 ->
                ...
                | (kwd, arg) ->
                    ...
                    let uu____3402 =
                      ...
                      let uu____3404 =
                        ...
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3405 in
              ...
              FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu____3406 in
        let uu____3412 =
          let uu____3413 =
            let uu____3414 =
              let uu____3415 =
  ...
  fun d ->
    ...
    | FStar_Parser_AST.Tycon
        ...
        let uu____3544 =
          ...
          FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
            effect_prefix_doc uu____3545 FStar_Pprint.equals in
        ...
        let decl_keyword =
          ...
          then FStar_Pprint.empty
            ...
            (let uu____3621 = str "val" in
             FStar_Pprint.op_Hat_Hat uu____3621 FStar_Pprint.space) in
        let uu____3622 =
          let uu____3623 =
            ...
            let uu____3637 =
              FStar_Pprint.optional
                (fun t ->
                   ...
                   FStar_Pprint.op_Hat_Hat break1 uu____3641) t_opt in
    ...
    | FStar_Parser_AST.ResetOptions s_opt ->
        ...
        let uu____3695 =
          FStar_Pprint.optional
            (fun s ->
               let uu____3699 =
                 let uu____3700 = str s in FStar_Pprint.dquotes uu____3700 in
               FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3699) s_opt in
                   ...
                   (fun t ->
                      let uu____4040 =
                        let uu____4041 =
                          ...
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                            uu____4042 in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4041 in
                      FStar_Pprint.op_Hat_Hat break1 uu____4040) typ_opt in
          ...
          let uu____4099 =
            default_or_map uid_doc
              (fun t ->
                 ...
                 op_Hat_Slash_Plus_Hat uu____4104 uu____4106) t_opt in
                ...
                let uu____4150 =
                  let uu____4151 =
                    let uu____4152 =
                      ...
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4153 in
                  ...
                  let uu____4155 =
                    let uu____4156 =
                      ...
                      let uu____4158 =
                        ...
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4159 in
              ...
              | FStar_Parser_AST.PatApp
                  ({
                     FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                       (x, uu____4164);
                     FStar_Parser_AST.prange = uu____4165;_},
                   pats)
                  ->
                  let uu____4175 =
          ...
          let uu____4230 =
            let uu____4231 =
              let uu____4232 =
                ...
                FStar_Pprint.surround (Prims.parse_int "2")
                  (Prims.parse_int "1") uu____4233 uu____4234 uu____4235 in
    ...
    let lift_op_doc =
      ...
      let p_lift ps uu____4334 =
        ...
        | (kwd, t) ->
            ...
            prefix2 uu____4341 uu____4344 in
...
and (p_tuplePattern : FStar_Parser_AST.pattern -> FStar_Pprint.document) =
  fun p ->
    ...
    | FStar_Parser_AST.PatTuple (pats, false) ->
        let uu____4378 =
          let uu____4379 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
  ...
  fun p ->
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName maybe_cons_lid;
           FStar_Parser_AST.prange = uu____4383;_},
         hd1::tl1::[])
        when
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uid;
           FStar_Parser_AST.prange = uu____4392;_},
         pats)
        ->
  ...
  fun p ->
        ...
        (match ((pat.FStar_Parser_AST.pat), (t.FStar_Parser_AST.tm)) with
         | (FStar_Parser_AST.PatVar (lid, aqual), FStar_Parser_AST.Refine
            ({ FStar_Parser_AST.b = FStar_Parser_AST.Annotated (lid', t1);
               ...
               FStar_Parser_AST.aqual = uu____4418;_},
         ...
         | (FStar_Parser_AST.PatWild, FStar_Parser_AST.Refine
            ({ FStar_Parser_AST.b = FStar_Parser_AST.NoName t1;
               ...
               FStar_Parser_AST.aqual = uu____4429;_},
             phi)) ->
             let uu____4431 =
         ...
         | uu____4432 ->
             let uu____4437 =
               ...
               let uu____4439 =
                 let uu____4440 = FStar_Pprint.break_ (Prims.parse_int "0") in
                 let uu____4441 =
    ...
    | FStar_Parser_AST.PatRecord pats ->
        let p_recordFieldPat uu____4461 =
          ...
          | (lid, pat) ->
              ...
              infix2 FStar_Pprint.equals uu____4468 uu____4469 in
        let uu____4470 =
    ...
    | FStar_Parser_AST.PatOp op ->
        let uu____4493 =
          let uu____4494 =
            let uu____4495 =
              let uu____4496 = FStar_Ident.text_of_id op in str uu____4496 in
            let uu____4497 =
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uu____4511;
           FStar_Parser_AST.prange = uu____4512;_},
         uu____4513)
        ->
          ...
          let doc1 =
            ...
            | FStar_Parser_AST.Refine
                ({
                   ...
                   FStar_Parser_AST.aqual = uu____4541;_},
                 phi)
          ...
          (match t.FStar_Parser_AST.tm with
           | FStar_Parser_AST.Refine
               ({ FStar_Parser_AST.b = FStar_Parser_AST.NoName t1;
                  ...
                  FStar_Parser_AST.aqual = uu____4564;_},
                phi)
               ->
               if is_atomic
               then
                   ...
                   let uu____4567 =
                     let uu____4568 =
                       p_refinement b.FStar_Parser_AST.aqual
                         FStar_Pprint.underscore t1 phi in
                     FStar_Pprint.op_Hat_Hat uu____4568 FStar_Pprint.rparen in
  ...
  fun ps ->
    fun pb ->
      fun e ->
            ...
            let uu____4652 =
              ...
              let uu____4654 =
                let uu____4655 =
                  ...
                  FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____4656 in
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ".()<-";
               FStar_Ident.idRange = uu____4661;_},
             e1::e2::e3::[])
            ->
            let uu____4667 =
              let uu____4668 =
              ...
              let uu____4676 =
                let uu____4677 = p_noSeqTerm ps pb e3 in jump2 uu____4677 in
              FStar_Pprint.op_Hat_Hat uu____4668 uu____4676 in
            FStar_Pprint.group uu____4667
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ".[]<-";
               FStar_Ident.idRange = uu____4678;_},
             e1::e2::e3::[])
            ->
            let uu____4684 =
              let uu____4685 =
              ...
              let uu____4693 =
                let uu____4694 = p_noSeqTerm ps pb e3 in jump2 uu____4694 in
            ...
            let uu____4815 =
              let uu____4816 =
                let uu____4817 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____4818 uu____4819 uu____4820 in
                let uu____4821 =
                  separate_map_last FStar_Pprint.hardline p_patternBranch
                    branches in
            ...
            let uu____4835 =
              let uu____4836 =
                let uu____4837 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____4838 uu____4839 uu____4840 in
                  ...
                  let doc_let_or_and =
                    ...
                    | FStar_Pervasives_Native.Some (FStar_Parser_AST.Rec) ->
                        let uu____4931 =
                          ...
                          FStar_Pprint.op_Hat_Slash_Hat uu____4932 uu____4933 in
                    ...
                    then
                      ...
                      (let uu____4944 =
                         ...
                         FStar_Pprint.prefix (Prims.parse_int "2")
                           (Prims.parse_int "1") uu____4945 doc_expr in
                       FStar_Pprint.group uu____4944) in
                  FStar_Pprint.op_Hat_Hat attrs uu____4939 in
                     ...
                     then
                       ...
                       (let uu____4999 =
                          p_lb FStar_Pervasives_Native.None lb
                            (i = (l - (Prims.parse_int "1"))) in
                        FStar_Pprint.group uu____4999)) lbs in
            let lbs_doc =
            ...
            let uu____5008 =
              let uu____5009 =
                let uu____5010 =
                  ...
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu____5011 in
            ...
            ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, typ_opt);
               FStar_Parser_AST.prange = uu____5017;_}::[],
             {
               FStar_Parser_AST.tm = FStar_Parser_AST.Match
                 (maybe_x, branches);
               FStar_Parser_AST.range = uu____5020;
               FStar_Parser_AST.level = uu____5021;_})
      ...
      fun e ->
        ...
        | FStar_Parser_AST.QForall (bs, trigger, e1) ->
            let uu____5123 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5124 uu____5126 FStar_Pprint.dot in
            let uu____5127 =
        ...
        | FStar_Parser_AST.QExists (bs, trigger, e1) ->
            let uu____5145 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5146 uu____5148 FStar_Pprint.dot in
            let uu____5149 =
    ...
    | pats ->
        let uu____5193 =
          let uu____5194 =
            ...
            let uu____5196 =
              let uu____5197 =
                let uu____5198 = p_disjunctivePats pats in jump2 uu____5198 in
              let uu____5199 =
                ...
                let uu____5253 =
                  let uu____5254 =
                    ...
                    let uu____5256 =
                      ...
                      FStar_Pprint.op_Hat_Hat uu____5257 FStar_Pprint.rarrow in
...
and (p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "<==>"; FStar_Ident.idRange = uu____5267;_},
         e1::e2::[])
        ->
...
and (p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "==>"; FStar_Ident.idRange = uu____5277;_},
         e1::e2::[])
        ->
            ...
            let uu____5297 =
              separate_map_or_flow FStar_Pprint.empty
                (fun b ->
                   ...
                   FStar_Pprint.op_Hat_Hat uu____5302 uu____5303) bs in
...
and (p_tmFormula : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "\\/"; FStar_Ident.idRange = uu____5308;_},
         e1::e2::[])
        ->
...
and (p_tmConjunction : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "/\\"; FStar_Ident.idRange = uu____5318;_},
         e1::e2::[])
        ->
...
and (p_tmTuple' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_tuple_constructor lid ->
        let uu____5343 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
  ...
  fun p_X ->
    fun curr ->
      fun e ->
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ":="; FStar_Ident.idRange = uu____5445;_},
             e1::e2::[])
            ->
            let uu____5450 =
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = "-"; FStar_Ident.idRange = uu____5456;_},
             e1::[])
            ->
  ...
  fun p_X ->
    fun curr ->
      fun e ->
             ...
             | (left1, mine, right1) ->
                 let p_dsumfst b =
                   ...
                   let uu____5602 =
                     ...
                     FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5603 in
                   FStar_Pprint.op_Hat_Hat uu____5601 uu____5602 in
                 let uu____5605 =
                   let uu____5606 = FStar_Pprint.concat_map p_dsumfst binders in
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = "~"; FStar_Ident.idRange = uu____5654;_},
             e1::[])
            ->
            let uu____5658 =
      ...
      | (lid, e) ->
          let uu____5708 =
            ...
            let uu____5710 =
              ...
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.equals uu____5711 in
         ...
         | (head1, args) ->
             let uu____5745 =
               ...
               then
                 ...
                 (let uu____5868 = p_indexingTerm head1 in (uu____5868, args)) in
...
and (p_indexingTerm_aux :
  ...
  fun exit1 ->
    fun e ->
      match e.FStar_Parser_AST.tm with
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".()"; FStar_Ident.idRange = uu____5983;_},
           e1::e2::[])
          ->
          let uu____5988 =
      ...
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".[]"; FStar_Ident.idRange = uu____5993;_},
           e1::e2::[])
          ->
          let uu____5998 =
  ...
  fun e ->
    ...
    | FStar_Parser_AST.Op (op, []) ->
        let uu____6040 =
          let uu____6041 =
            let uu____6042 =
              let uu____6043 = FStar_Ident.text_of_id op in str uu____6043 in
            let uu____6044 =
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.rparen in
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_dtuple_constructor lid
        ...
        let uu____6059 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen FStar_Pprint.bar in
        let uu____6060 =
          let uu____6061 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          let uu____6062 = FStar_List.map FStar_Pervasives_Native.fst args in
...
and (p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | uu____6089 when is_array e ->
        ...
        let uu____6094 =
          let uu____6095 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
    ...
    | uu____6099 when is_list e ->
        let uu____6100 =
          let uu____6101 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____6102 = extract_from_list e in
          separate_map_or_flow_last uu____6101
            (fun ps -> p_noSeqTerm ps false) uu____6102 in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
    ...
    | uu____6107 when is_lex_list e ->
        ...
        let uu____6109 =
          let uu____6110 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____6111 = extract_from_list e in
          separate_map_or_flow_last uu____6110
            (fun ps -> p_noSeqTerm ps false) uu____6111 in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
    ...
    | uu____6116 when is_ref_set e ->
        ...
        let uu____6121 =
          let uu____6122 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
...
and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    ...
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6459;_},
         u1::u2::[])
        ->
        let uu____6464 =
                    ...
                    let uu____6503 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____6511 ->
                           ...
                           | (u1, uu____6517) -> p_atomicUniverse u1) args in
...
and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    ...
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6547;_},
    ...
    | uu____6561 ->
        let uu____6562 =
          ...
          FStar_Util.format1 "Invalid term in universe context %s" uu____6563 in
        failwith uu____6562
  ...
  fun m ->
    fun comments ->
      let decls =
        ...
        | FStar_Parser_AST.Interface (uu____6722, decls, uu____6724) -> decls in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
       ...
       | d::ds ->
           let uu____6769 =
             ...
             | {
                 ...
                 let uu____6792 =
                   let uu____6795 =
                     let uu____6798 = FStar_List.tl ds in d :: uu____6798 in
                   d0 :: uu____6795 in
           ...
           (match uu____6769 with
            | (decls1, first_range) ->
                ...
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    let uu____6861 = FStar_Range.start_of_range first_range in
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____6861 FStar_Pprint.empty in
                  let doc1 =
