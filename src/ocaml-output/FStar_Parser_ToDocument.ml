...
let token_to_string : (FStar_BaseTypes.char, Prims.string) FStar_Util.either  ->  Prims.string = (fun uu___124_577 -> (match (uu___124_577) with
...
let matches_token : Prims.string  ->  (FStar_Char.char, Prims.string) FStar_Util.either  ->  Prims.bool = (fun s uu___125_589 -> (match (uu___125_589) with
| FStar_Util.Inl (c) -> begin
(
...
let levels_from_associativity = (fun l uu___126_947 -> (match (uu___126_947) with
| Left -> begin
...
and p_pragma : FStar_Parser_AST.pragma  ->  FStar_Pprint.document = (fun uu___127_2009 -> (match (uu___127_2009) with
...
and p_typeDecl : FStar_Parser_AST.tycon  ->  FStar_Pprint.document = (fun uu___128_2037 -> (match (uu___128_2037) with
...
and p_newEffect : FStar_Parser_AST.effect_decl  ->  FStar_Pprint.document = (fun uu___129_2308 -> (match (uu___129_2308) with
...
and p_qualifier : FStar_Parser_AST.qualifier  ->  FStar_Pprint.document = (fun uu___130_2420 -> (match (uu___130_2420) with
...
and p_letqualifier : FStar_Parser_AST.let_qualifier  ->  FStar_Pprint.document = (fun uu___131_2423 -> (match (uu___131_2423) with
...
and p_aqual : FStar_Parser_AST.arg_qualifier  ->  FStar_Pprint.document = (fun uu___132_2426 -> (match (uu___132_2426) with
...
and p_trigger : FStar_Parser_AST.term Prims.list Prims.list  ->  FStar_Pprint.document = (fun uu___133_2892 -> (match (uu___133_2892) with
| [] -> begin
FStar_Pprint.empty
end
| pats -> begin
...
and p_maybeWhen : FStar_Parser_AST.term Prims.option  ->  FStar_Pprint.document = (fun uu___134_2980 -> (match (uu___134_2980) with
| None -> begin
FStar_Pprint.empty
end
| Some (e) -> begin
...
and p_constant : FStar_Const.sconst  ->  FStar_Pprint.document = (fun uu___137_3606 -> (match (uu___137_3606) with
...
let signedness = (fun uu___135_3634 -> (match (uu___135_3634) with
...
let width = (fun uu___136_3638 -> (match (uu___136_3638) with
