...
in (((op_starting_char = 33 (*!*)) || (op_starting_char = 63 (*?*))) || ((op_starting_char = 126 (*~*)) && ((FStar_Ident.text_of_id op) <> "~")))))
...
and p_pragma : FStar_Parser_AST.pragma  ->  FStar_Pprint.document = (fun uu___94_3327 -> (match (uu___94_3327) with
...
and p_typeDecl : FStar_Parser_AST.tycon  ->  FStar_Pprint.document = (fun uu___95_3372 -> (match (uu___95_3372) with
...
and p_newEffect : FStar_Parser_AST.effect_decl  ->  FStar_Pprint.document = (fun uu___96_3783 -> (match (uu___96_3783) with
...
and p_qualifier : FStar_Parser_AST.qualifier  ->  FStar_Pprint.document = (fun uu___97_3943 -> (match (uu___97_3943) with
...
and p_letqualifier : FStar_Parser_AST.let_qualifier  ->  FStar_Pprint.document = (fun uu___98_3946 -> (match (uu___98_3946) with
...
and p_aqual : FStar_Parser_AST.arg_qualifier  ->  FStar_Pprint.document = (fun uu___99_3949 -> (match (uu___99_3949) with
...
and p_trigger : FStar_Parser_AST.term Prims.list Prims.list  ->  FStar_Pprint.document = (fun uu___100_4569 -> (match (uu___100_4569) with
| [] -> begin
FStar_Pprint.empty
end
| pats -> begin
...
and p_maybeWhen : FStar_Parser_AST.term FStar_Pervasives_Native.option  ->  FStar_Pprint.document = (fun uu___101_4715 -> (match (uu___101_4715) with
| FStar_Pervasives_Native.None -> begin
FStar_Pprint.empty
end
...
(match (c) with
| FStar_Const.Const_char (x) when (x = 10) -> begin
(str "0x0Az")
end
| uu____5460 -> begin
(p_constant c)
...
and p_constant : FStar_Const.sconst  ->  FStar_Pprint.document = (fun uu___104_5799 -> (match (uu___104_5799) with
...
| FStar_Const.Const_string (s, uu____5805) -> begin
(

let uu____5806 = (str s)
in (FStar_Pprint.dquotes uu____5806))
end
| FStar_Const.Const_bytearray (bytes, uu____5808) -> begin
(

let uu____5813 = (

let uu____5814 = (str (FStar_Util.string_of_bytes bytes))
in (FStar_Pprint.dquotes uu____5814))
in (

let uu____5815 = (str "B")
in (FStar_Pprint.op_Hat_Hat uu____5813 uu____5815)))
end
| FStar_Const.Const_int (repr, sign_width_opt) -> begin
(

let signedness = (fun uu___102_5833 -> (match (uu___102_5833) with
...
let width = (fun uu___103_5837 -> (match (uu___103_5837) with
...
let ending = (default_or_map FStar_Pprint.empty (fun uu____5848 -> (match (uu____5848) with
| (s, w) -> begin
(

let uu____5855 = (signedness s)
in (

let uu____5856 = (width w)
in (FStar_Pprint.op_Hat_Hat uu____5855 uu____5856)))
end)) sign_width_opt)
in (

let uu____5857 = (str repr)
in (FStar_Pprint.op_Hat_Hat uu____5857 ending)))))
end
| FStar_Const.Const_range (r) -> begin
(

let uu____5859 = (FStar_Range.string_of_range r)
in (str uu____5859))
end
...
let uu____5864 = (str "reflect")
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5864))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____5863))
in (FStar_Pprint.op_Hat_Hat uu____5861 uu____5862)))
end))
and p_universe : FStar_Parser_AST.term  ->  FStar_Pprint.document = (fun u -> (

let uu____5866 = (str "u#")
in (

let uu____5867 = (p_atomicUniverse u)
in (FStar_Pprint.op_Hat_Hat uu____5866 uu____5867))))
and p_universeFrom : FStar_Parser_AST.term  ->  FStar_Pprint.document = (fun u -> (

let uu____5869 = (

let uu____5870 = (unparen u)
in uu____5870.FStar_Parser_AST.tm)
in (match (uu____5869) with
| FStar_Parser_AST.Op ({FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____5871}, (u1)::(u2)::[]) -> begin
(

let uu____5876 = (

let uu____5877 = (p_universeFrom u1)
in (

let uu____5878 = (

let uu____5879 = (p_universeFrom u2)
in (FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____5879))
in (FStar_Pprint.op_Hat_Slash_Hat uu____5877 uu____5878)))
in (FStar_Pprint.group uu____5876))
end
| FStar_Parser_AST.App (uu____5880) -> begin
(

let uu____5887 = (head_and_args u)
...
let uu____5913 = (unparen head1)
in uu____5913.FStar_Parser_AST.tm)
...
let uu____5916 = (p_qlident FStar_Parser_Const.max_lid)
in (

let uu____5917 = (FStar_Pprint.separate_map FStar_Pprint.space (fun uu____5925 -> (match (uu____5925) with
| (u1, uu____5931) -> begin
(p_atomicUniverse u1)
end)) args)
in (op_Hat_Slash_Plus_Hat uu____5916 uu____5917)))
in (FStar_Pprint.group uu____5915))
end
| uu____5932 -> begin
(
...
let uu____5934 = (FStar_Parser_AST.term_to_string u)
in (FStar_Util.format1 "Invalid term in universe context %s" uu____5934))
in (failwith uu____5933))
end))
end))
end
| uu____5935 -> begin
...
let uu____5938 = (unparen u)
in uu____5938.FStar_Parser_AST.tm)
...
let uu____5961 = (p_universeFrom u1)
in (soft_parens_with_nesting uu____5961))
end
| FStar_Parser_AST.Op ({FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____5962}, (uu____5963)::(uu____5964)::[]) -> begin
(

let uu____5967 = (p_universeFrom u)
in (soft_parens_with_nesting uu____5967))
end
| FStar_Parser_AST.App (uu____5968) -> begin
(

let uu____5975 = (p_universeFrom u)
in (soft_parens_with_nesting uu____5975))
end
| uu____5976 -> begin
(
...
let uu____5978 = (FStar_Parser_AST.term_to_string u)
in (FStar_Util.format1 "Invalid term in universe context %s" uu____5978))
in (failwith uu____5977))
end)))
...
| FStar_Parser_AST.Module (uu____6011, decls) -> begin
(

let uu____6017 = (FStar_All.pipe_right decls (FStar_List.map decl_to_document))
in (FStar_All.pipe_right uu____6017 (FStar_Pprint.separate FStar_Pprint.hardline)))
end
| FStar_Parser_AST.Interface (uu____6026, decls, uu____6028) -> begin
(

let uu____6033 = (FStar_All.pipe_right decls (FStar_List.map decl_to_document))
in (FStar_All.pipe_right uu____6033 (FStar_Pprint.separate FStar_Pprint.hardline)))
end)
...
let comments_to_document : (Prims.string * FStar_Range.range) Prims.list  ->  FStar_Pprint.document = (fun comments -> (FStar_Pprint.separate_map FStar_Pprint.hardline (fun uu____6076 -> (match (uu____6076) with
| (comment, range) -> begin
(str comment)
end)) comments))
...
| FStar_Parser_AST.Module (uu____6118, decls) -> begin
decls
end
| FStar_Parser_AST.Interface (uu____6124, decls, uu____6126) -> begin
decls
end)
in ((FStar_ST.op_Colon_Equals should_print_fs_typ_app false);
(match (decls) with
...
let uu____6162 = (match (ds) with
| ({FStar_Parser_AST.d = FStar_Parser_AST.Pragma (FStar_Parser_AST.LightOff); FStar_Parser_AST.drange = uu____6175; FStar_Parser_AST.doc = uu____6176; FStar_Parser_AST.quals = uu____6177; FStar_Parser_AST.attrs = uu____6178})::uu____6179 -> begin
(
...
let uu____6191 = (FStar_List.tl ds)
in (d)::uu____6191)
in (d0)::uu____6188)
in ((uu____6185), (d0.FStar_Parser_AST.drange))))
end
| uu____6196 -> begin
...
let uu____6257 = (FStar_Range.start_of_range first_range)
in (place_comments_until_pos (Prims.parse_int "0") (Prims.parse_int "1") uu____6257 FStar_Pprint.empty))
in (
...
let uu____6350 = (FStar_Pprint.op_Hat_Hat initial_comment doc1)
in ((uu____6350), (comments1)));
))));
))
end))
end);
