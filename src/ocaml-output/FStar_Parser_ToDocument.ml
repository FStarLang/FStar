...
let opinfix3 = (fun uu____659 -> ((Left), ((FStar_Util.Inl (42 (***)))::(FStar_Util.Inl (47 (*/*)))::(FStar_Util.Inl (37 (*%*)))::[])))


let opinfix2 = (fun uu____678 -> ((Left), ((FStar_Util.Inl (43 (*+*)))::(FStar_Util.Inl (45 (*-*)))::[])))


let minus_lvl = (fun uu____695 -> ((Left), ((FStar_Util.Inr ("-"))::[])))


let opinfix1 = (fun uu____710 -> ((Right), ((FStar_Util.Inl (64 (*@*)))::(FStar_Util.Inl (94 (*^*)))::[])))


let pipe_right = (fun uu____727 -> ((Left), ((FStar_Util.Inr ("|>"))::[])))


let opinfix0d = (fun uu____742 -> ((Left), ((FStar_Util.Inl (36 (*$*)))::[])))


let opinfix0c = (fun uu____757 -> ((Left), ((FStar_Util.Inl (61 (*=*)))::(FStar_Util.Inl (60 (*<*)))::(FStar_Util.Inl (62 (*>*)))::[])))


let equal = (fun uu____776 -> ((Left), ((FStar_Util.Inr ("="))::[])))


let opinfix0b = (fun uu____791 -> ((Left), ((FStar_Util.Inl (38 (*&*)))::[])))


let opinfix0a = (fun uu____806 -> ((Left), ((FStar_Util.Inl (124 (*|*)))::[])))
...
| FStar_Const.Const_string (s, uu____3821) -> begin
(

let uu____3822 = (str s)
in (FStar_Pprint.dquotes uu____3822))
end
| FStar_Const.Const_bytearray (bytes, uu____3824) -> begin
(

let uu____3827 = (

let uu____3828 = (str (FStar_Util.string_of_bytes bytes))
in (FStar_Pprint.dquotes uu____3828))
in (

let uu____3829 = (str "B")
in (FStar_Pprint.op_Hat_Hat uu____3827 uu____3829)))
end
| FStar_Const.Const_int (repr, sign_width_opt) -> begin
(

let signedness = (fun uu___106_3841 -> (match (uu___106_3841) with
...
let width = (fun uu___107_3845 -> (match (uu___107_3845) with
...
let ending = (default_or_map FStar_Pprint.empty (fun uu____3849 -> (match (uu____3849) with
| (s, w) -> begin
(

let uu____3854 = (signedness s)
in (

let uu____3855 = (width w)
in (FStar_Pprint.op_Hat_Hat uu____3854 uu____3855)))
end)) sign_width_opt)
in (

let uu____3856 = (str repr)
in (FStar_Pprint.op_Hat_Hat uu____3856 ending)))))
end
| FStar_Const.Const_range (r) -> begin
(

let uu____3858 = (FStar_Range.string_of_range r)
in (str uu____3858))
end
...
let uu____3863 = (str "reflect")
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____3863))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____3862))
in (FStar_Pprint.op_Hat_Hat uu____3860 uu____3861)))
end))
and p_universe : FStar_Parser_AST.term  ->  FStar_Pprint.document = (fun u -> (

let uu____3865 = (str "u#")
in (

let uu____3866 = (p_atomicUniverse u)
in (FStar_Pprint.op_Hat_Hat uu____3865 uu____3866))))
and p_universeFrom : FStar_Parser_AST.term  ->  FStar_Pprint.document = (fun u -> (

let uu____3868 = (

let uu____3869 = (unparen u)
in uu____3869.FStar_Parser_AST.tm)
in (match (uu____3868) with
| FStar_Parser_AST.Op ({FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____3870}, (u1)::(u2)::[]) -> begin
(

let uu____3874 = (

let uu____3875 = (p_universeFrom u1)
in (

let uu____3876 = (

let uu____3877 = (p_universeFrom u2)
in (FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____3877))
in (FStar_Pprint.op_Hat_Slash_Hat uu____3875 uu____3876)))
in (FStar_Pprint.group uu____3874))
end
| FStar_Parser_AST.App (uu____3878) -> begin
(

let uu____3882 = (head_and_args u)
...
let uu____3900 = (p_qlident FStar_Parser_Const.max_lid)
in (

let uu____3901 = (FStar_Pprint.separate_map FStar_Pprint.space (fun uu____3904 -> (match (uu____3904) with
| (u1, uu____3908) -> begin
(p_atomicUniverse u1)
end)) args)
in (op_Hat_Slash_Plus_Hat uu____3900 uu____3901)))
in (FStar_Pprint.group uu____3899))
end
| uu____3909 -> begin
(
...
let uu____3911 = (FStar_Parser_AST.term_to_string u)
in (FStar_Util.format1 "Invalid term in universe context %s" uu____3911))
in (failwith uu____3910))
end))
end))
end
| uu____3912 -> begin
...
let uu____3915 = (unparen u)
in uu____3915.FStar_Parser_AST.tm)
...
let uu____3929 = (p_universeFrom u1)
in (soft_parens_with_nesting uu____3929))
end
| FStar_Parser_AST.Op ({FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____3930}, (uu____3931)::(uu____3932)::[]) -> begin
(

let uu____3934 = (p_universeFrom u)
in (soft_parens_with_nesting uu____3934))
end
| FStar_Parser_AST.App (uu____3935) -> begin
(

let uu____3939 = (p_universeFrom u)
in (soft_parens_with_nesting uu____3939))
end
| uu____3940 -> begin
(
...
let uu____3942 = (FStar_Parser_AST.term_to_string u)
in (FStar_Util.format1 "Invalid term in universe context %s" uu____3942))
in (failwith uu____3941))
end)))
...
| FStar_Parser_AST.Module (uu____3962, decls) -> begin
(

let uu____3966 = (FStar_All.pipe_right decls (FStar_List.map decl_to_document))
in (FStar_All.pipe_right uu____3966 (FStar_Pprint.separate FStar_Pprint.hardline)))
end
| FStar_Parser_AST.Interface (uu____3971, decls, uu____3973) -> begin
(

let uu____3976 = (FStar_All.pipe_right decls (FStar_List.map decl_to_document))
in (FStar_All.pipe_right uu____3976 (FStar_Pprint.separate FStar_Pprint.hardline)))
end)
...
let comments_to_document : (Prims.string * FStar_Range.range) Prims.list  ->  FStar_Pprint.document = (fun comments -> (FStar_Pprint.separate_map FStar_Pprint.hardline (fun uu____3995 -> (match (uu____3995) with
| (comment, range) -> begin
(str comment)
end)) comments))
...
| FStar_Parser_AST.Module (uu____4020, decls) -> begin
decls
end
| FStar_Parser_AST.Interface (uu____4024, decls, uu____4026) -> begin
decls
end)
in ((FStar_ST.write should_print_fs_typ_app false);
(match (decls) with
...
let uu____4043 = (match (ds) with
| ({FStar_Parser_AST.d = FStar_Parser_AST.Pragma (FStar_Parser_AST.LightOff); FStar_Parser_AST.drange = uu____4050; FStar_Parser_AST.doc = uu____4051; FStar_Parser_AST.quals = uu____4052; FStar_Parser_AST.attrs = uu____4053})::uu____4054 -> begin
(
...
let uu____4062 = (FStar_List.tl ds)
in (d)::uu____4062)
in (d0)::uu____4060)
in ((uu____4058), (d0.FStar_Parser_AST.drange))))
end
| uu____4065 -> begin
...
let uu____4088 = (FStar_Range.start_of_range first_range)
in (place_comments_until_pos (Prims.parse_int "0") (Prims.parse_int "1") uu____4088 FStar_Pprint.empty))
in (
...
let uu____4110 = (FStar_Pprint.op_Hat_Hat initial_comment doc1)
in ((uu____4110), (comments1)));
))));
))
end))
end);
