                    ...
                    let uu____5917 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____5925  ->
                           ...
                           | (u1,uu____5931) -> p_atomicUniverse u1) args
                       in
  ...
  fun u  ->
    ...
    | uu____5976 ->
        let uu____5977 =
          ...
          FStar_Util.format1 "Invalid term in universe context %s" uu____5978
           in
        failwith uu____5977
  ...
  fun m  ->
    fun comments  ->
      let decls =
        ...
        | FStar_Parser_AST.Interface (uu____6124,decls,uu____6126) -> decls
         in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
       ...
       | d::ds ->
           let uu____6162 =
             ...
             | {
                 ...
                 let uu____6185 =
                   let uu____6188 =
                     let uu____6191 = FStar_List.tl ds  in d :: uu____6191
                      in
                   d0 :: uu____6188  in
                ...
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    ...
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____6257 FStar_Pprint.empty
                     in
                  let doc1 =
