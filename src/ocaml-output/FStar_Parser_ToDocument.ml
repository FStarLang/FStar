...
let (level_table :
  ((Prims.int,Prims.int,Prims.int) FStar_Pervasives_Native.tuple3,(FStar_Char.char,
    ...
    FStar_Pervasives_Native.tuple2 Prims.list)
  =
  let levels_from_associativity l uu___82_1944 =
    match uu___82_1944 with
          ...
          | (comment,crange)::cs when
              ...
              (FStar_ST.op_Colon_Equals comment_stack cs;
               (let lnum =
                ...
                place_comments_until_pos (Prims.parse_int "1") uu____3163
                  pos_end doc2))
          | uu____3165 ->
              let lnum =
                let uu____3173 =
                ...
                max (Prims.parse_int "1") uu____3173  in
...
and (p_attributes : FStar_Parser_AST.attributes_ -> FStar_Pprint.document) =
  fun attrs  ->
    ...
    soft_surround_map_or_flow (Prims.parse_int "0") (Prims.parse_int "2")
      FStar_Pprint.empty uu____3933 FStar_Pprint.space uu____3935
      p_atomicTerm attrs
...
and (p_list :
  ...
  fun f  ->
    fun sep  ->
      fun l  ->
        let rec p_list' uu___83_4051 =
          match uu___83_4051 with
          | [] -> FStar_Pprint.empty
          | x::[] -> f x
          | x::xs ->
  ...
  fun d  ->
    ...
    | FStar_Parser_AST.Tycon
        ...
        let uu____4124 =
          ...
          FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
            effect_prefix_doc uu____4125 FStar_Pprint.equals
           in
          ...
          then
            ...
            (let binders_doc =
             ...
             FStar_Pprint.surround (Prims.parse_int "2")
               (Prims.parse_int "1") uu____4643 binders_doc uu____4644)
...
and (p_constructorDecl :
  ...
  fun uu____4668  ->
    ...
    | (uid,t_opt,doc_opt,use_of) ->
        ...
        let uu____4697 =
          let uu____4698 = FStar_Pprint.break_ (Prims.parse_int "0")  in
          let uu____4699 =
  ...
  fun uid  ->
    fun bs  ->
      fun t  ->
        ...
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____4818 uu____4819 uu____4820
          ...
          let uu____4830 =
            let uu____4831 =
              let uu____4832 =
                ...
                FStar_Pprint.surround (Prims.parse_int "2")
                  (Prims.parse_int "1") uu____4833 uu____4834 uu____4835
                 in
...
and (p_atomicPattern : FStar_Parser_AST.pattern -> FStar_Pprint.document) =
  fun p  ->
        ...
        (match ((pat.FStar_Parser_AST.pat), (t.FStar_Parser_AST.tm)) with
         ...
         | uu____5036 ->
             let uu____5041 =
               ...
               let uu____5043 =
                 let uu____5044 = FStar_Pprint.break_ (Prims.parse_int "0")
                    in
                 let uu____5045 =
    ...
    | FStar_Parser_AST.PatList pats ->
        ...
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          FStar_Pprint.lbracket uu____5050 FStar_Pprint.rbracket
    ...
    | FStar_Parser_AST.PatTuple (pats,true ) ->
        ...
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____5086 uu____5087 uu____5088
            ...
            let uu____5418 =
              let uu____5419 =
                let uu____5420 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____5421 uu____5422 uu____5423
                   in
                let uu____5424 =
                  separate_map_last FStar_Pprint.hardline p_patternBranch
                    branches
            ...
            let uu____5440 =
              let uu____5441 =
                let uu____5442 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____5443 uu____5444 uu____5445
                   in
                  ...
                  let uu____5552 =
                    ...
                    then
                      let uu____5553 =
                        ...
                        FStar_Pprint.surround (Prims.parse_int "2")
                          (Prims.parse_int "1") uu____5554 doc_expr
                          uu____5555
                         in
                      ...
                      (let uu____5557 =
                         ...
                         FStar_Pprint.prefix (Prims.parse_int "2")
                           (Prims.parse_int "1") uu____5558 doc_expr
                          in
      ...
      fun e  ->
        ...
        | FStar_Parser_AST.QForall (bs,trigger,e1) ->
            let uu____5740 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5741 uu____5743 FStar_Pprint.dot
               in
            let uu____5744 =
        ...
        | FStar_Parser_AST.QExists (bs,trigger,e1) ->
            let uu____5762 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5763 uu____5765 FStar_Pprint.dot
               in
            let uu____5766 =
             ...
             (match uu____6366 with
              | (head_doc,args1) ->
                  let uu____6514 =
                    ...
                    soft_surround_map_or_flow (Prims.parse_int "2")
                      (Prims.parse_int "0") head_doc uu____6515 break1
    ...
    | (e,FStar_Parser_AST.FsTypApp ) ->
        (FStar_Errors.log_issue e.FStar_Parser_AST.range
         ...
         (let uu____6592 = p_indexingTerm e  in
          FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
            FStar_Pprint.langle uu____6592 FStar_Pprint.rangle))
  ...
  fun e  ->
    ...
    | FStar_Parser_AST.Construct (lid,args) when is_dtuple_constructor lid ->
        ...
        let uu____6694 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rparen  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____6684 uu____6685 uu____6694
...
and (p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    ...
    | uu____6714 when is_array e ->
        ...
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          uu____6718 uu____6719 uu____6723
    | uu____6724 when is_list e ->
        let uu____6725 =
          ...
          separate_map_or_flow_last uu____6726
           ...
           in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          FStar_Pprint.lbracket uu____6725 FStar_Pprint.rbracket
    | uu____6732 when is_lex_list e ->
        ...
        let uu____6734 =
          ...
          separate_map_or_flow_last uu____6735
           ...
           in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____6733 uu____6734 FStar_Pprint.rbracket
    | uu____6741 when is_ref_set e ->
        ...
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          uu____6745 uu____6746 FStar_Pprint.rbrace
...
and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___95_7014  ->
    ...
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___93_7050 =
          match uu___93_7050 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___94_7056 =
          match uu___94_7056 with
                ...
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    ...
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____7526 FStar_Pprint.empty
                     in
                  let doc1 =
