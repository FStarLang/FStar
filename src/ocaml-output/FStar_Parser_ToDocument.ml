...
let rec all : 'a . ('a -> Prims.bool) -> 'a Prims.list -> Prims.bool =
  fun f ->
    fun l ->
      match l with
      | [] -> true
      | x::xs -> let uu____228 = f x in if uu____228 then all f xs else false
let (all_explicit :
  ...
  fun args ->
    FStar_Util.for_all
      (fun uu___0_261 ->
         ...
         | (uu____267, FStar_Parser_AST.Nothing) -> true
         | uu____269 -> false) args
let (should_print_fs_typ_app : Prims.bool FStar_ST.ref) =
  FStar_Util.mk_ref false
let (unfold_tuples : Prims.bool FStar_ST.ref) = FStar_Util.mk_ref true
let with_fs_typ_app :
  'Auu____298 'Auu____299 .
    Prims.bool -> ('Auu____298 -> 'Auu____299) -> 'Auu____298 -> 'Auu____299
  =
  fun b ->
    fun printer ->
      fun t ->
...
let default_or_map :
  'Auu____409 'Auu____410 .
    'Auu____409 ->
      ('Auu____410 -> 'Auu____409) ->
        'Auu____410 FStar_Pervasives_Native.option -> 'Auu____409
  =
  fun n1 ->
    fun f ->
      fun x ->
...
let separate_break_map :
  'Auu____523 .
    FStar_Pprint.document ->
      ('Auu____523 -> FStar_Pprint.document) ->
        'Auu____523 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun l ->
        let uu____548 =
          let uu____549 =
            let uu____550 = FStar_Pprint.op_Hat_Hat sep break1 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____550 in
          FStar_Pprint.separate_map uu____549 f l in
        FStar_Pprint.group uu____548
let precede_break_separate_map :
  'Auu____562 .
    FStar_Pprint.document ->
      FStar_Pprint.document ->
        ('Auu____562 -> FStar_Pprint.document) ->
          'Auu____562 Prims.list -> FStar_Pprint.document
  =
  fun prec ->
    fun sep ->
      fun f ->
        fun l ->
          let uu____592 =
            let uu____593 = FStar_Pprint.op_Hat_Hat prec FStar_Pprint.space in
            let uu____594 =
              let uu____595 = FStar_List.hd l in
              FStar_All.pipe_right uu____595 f in
            FStar_Pprint.precede uu____593 uu____594 in
          let uu____596 =
            let uu____597 = FStar_List.tl l in
            FStar_Pprint.concat_map
              (fun x ->
                 let uu____603 =
                   let uu____604 =
                     let uu____605 = f x in
                     FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____605 in
                   FStar_Pprint.op_Hat_Hat sep uu____604 in
                 FStar_Pprint.op_Hat_Hat break1 uu____603) uu____597 in
          FStar_Pprint.op_Hat_Hat uu____592 uu____596
let concat_break_map :
  'Auu____613 .
    ('Auu____613 -> FStar_Pprint.document) ->
      'Auu____613 Prims.list -> FStar_Pprint.document
  =
  fun f ->
    fun l ->
      let uu____633 =
        FStar_Pprint.concat_map
          (fun x ->
             let uu____637 = f x in FStar_Pprint.op_Hat_Hat uu____637 break1)
          l in
      FStar_Pprint.group uu____633
...
let (soft_begin_end_with_nesting :
  FStar_Pprint.document -> FStar_Pprint.document) =
  fun contents ->
    let uu____700 = str "begin" in
    let uu____702 = str "end" in
    FStar_Pprint.soft_surround (Prims.of_int (2)) Prims.int_one uu____700
      contents uu____702
let separate_map_last :
  'Auu____715 .
    FStar_Pprint.document ->
      (Prims.bool -> 'Auu____715 -> FStar_Pprint.document) ->
        'Auu____715 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun es ->
...
let separate_break_map_last :
  'Auu____767 .
    FStar_Pprint.document ->
      (Prims.bool -> 'Auu____767 -> FStar_Pprint.document) ->
        'Auu____767 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun l ->
        let uu____799 =
          let uu____800 =
            let uu____801 = FStar_Pprint.op_Hat_Hat sep break1 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____801 in
          separate_map_last uu____800 f l in
        FStar_Pprint.group uu____799
let separate_map_or_flow :
  'Auu____811 .
    FStar_Pprint.document ->
      ('Auu____811 -> FStar_Pprint.document) ->
        'Auu____811 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun l ->
...
let flow_map_last :
  'Auu____849 .
    FStar_Pprint.document ->
      (Prims.bool -> 'Auu____849 -> FStar_Pprint.document) ->
        'Auu____849 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun es ->
...
let separate_map_or_flow_last :
  'Auu____901 .
    FStar_Pprint.document ->
      (Prims.bool -> 'Auu____901 -> FStar_Pprint.document) ->
        'Auu____901 Prims.list -> FStar_Pprint.document
  =
  fun sep ->
    fun f ->
      fun l ->
      ...
      fun doc1 ->
        fun doc2 ->
          fun doc3 ->
            ...
            then
              let uu____983 = FStar_Pprint.op_Hat_Slash_Hat doc1 doc3 in
              FStar_Pprint.group uu____983
      ...
      Prims.int ->
        FStar_Pprint.document ->
          FStar_Pprint.document ->
            FStar_Pprint.document ->
              FStar_Pprint.document ->
                ('Auu____1005 -> FStar_Pprint.document) ->
                  'Auu____1005 Prims.list -> FStar_Pprint.document
  =
  fun n1 ->
    fun b ->
      fun void_ ->
              ...
              fun f ->
                fun xs ->
                  ...
                  then void_
                    ...
                    (let uu____1064 = FStar_Pprint.separate_map sep f xs in
                     FStar_Pprint.soft_surround n1 b opening uu____1064
                       closing)
      ...
      Prims.int ->
        FStar_Pprint.document ->
          FStar_Pprint.document ->
            FStar_Pprint.document ->
              FStar_Pprint.document ->
                ('Auu____1084 -> FStar_Pprint.document) ->
                  'Auu____1084 Prims.list -> FStar_Pprint.document
  =
  fun n1 ->
    fun b ->
      fun void_ ->
              ...
              fun f ->
                fun xs ->
                  ...
                  then void_
                    ...
                    (let uu____1143 = separate_map_or_flow sep f xs in
                     FStar_Pprint.soft_surround n1 b opening uu____1143
                       closing)
let (doc_of_fsdoc :
                ...
                let uu____1207 =
                  FStar_Pprint.separate_map FStar_Pprint.comma
                    (fun uu____1218 ->
                       ...
                       | (k, v1) ->
                           let uu____1231 =
                             let uu____1234 = str k in
                             let uu____1235 =
                               let uu____1238 =
                                 let uu____1241 = str v1 in [uu____1241] in
                               FStar_Pprint.rarrow :: uu____1238 in
                             uu____1234 :: uu____1235 in
                           FStar_Pprint.concat uu____1231) keywords in
                [uu____1207] in
              FStar_Pprint.space :: uu____1204 in
            uu____1200 :: uu____1201 in
          FStar_Pprint.concat uu____1197 in
        FStar_Pprint.group uu____1196
  ...
  fun t ->
    fun x ->
      ...
      | FStar_Parser_AST.Var y ->
          let uu____1267 = FStar_Ident.text_of_lid y in
          x.FStar_Ident.idText = uu____1267
      | uu____1270 -> false
  ...
  fun cons_lid1 ->
    fun nil_lid1 ->
      let rec aux e =
        ...
        | FStar_Parser_AST.Construct (lid, uu____1321::(e2, uu____1323)::[])
...
let rec (extract_from_list :
  ...
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Construct (uu____1370, []) -> []
    | FStar_Parser_AST.Construct
        (uu____1381,
         (e1, FStar_Parser_AST.Nothing)::(e2, FStar_Parser_AST.Nothing)::[])
        -> let uu____1402 = extract_from_list e2 in e1 :: uu____1402
    | uu____1405 ->
        let uu____1406 =
          let uu____1408 = FStar_Parser_AST.term_to_string e in
          FStar_Util.format1 "Not a list %s" uu____1408 in
        failwith uu____1406
  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var lid;
           FStar_Parser_AST.range = uu____1422;
           FStar_Parser_AST.level = uu____1423;_},
  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_singleton_lid;
           FStar_Parser_AST.range = uu____1437;
           FStar_Parser_AST.level = uu____1438;_},
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_addr_of_lid;
                FStar_Parser_AST.range = uu____1440;
                FStar_Parser_AST.level = uu____1441;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____1443;
           FStar_Parser_AST.level = uu____1444;_},
        ...
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_union_lid;
                FStar_Parser_AST.range = uu____1446;
                FStar_Parser_AST.level = uu____1447;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____1449;
           FStar_Parser_AST.level = uu____1450;_},
...
let rec (extract_from_ref_set :
  ...
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Var uu____1464 -> []
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____1465;
           FStar_Parser_AST.range = uu____1466;
           FStar_Parser_AST.level = uu____1467;_},
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____1468;
                FStar_Parser_AST.range = uu____1469;
                FStar_Parser_AST.level = uu____1470;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____1472;
           FStar_Parser_AST.level = uu____1473;_},
         FStar_Parser_AST.Nothing)
        -> [e1]
    | FStar_Parser_AST.App
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____1474;
                FStar_Parser_AST.range = uu____1475;
                FStar_Parser_AST.level = uu____1476;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____1478;
           FStar_Parser_AST.level = uu____1479;_},
         e2, FStar_Parser_AST.Nothing)
        ->
        let uu____1481 = extract_from_ref_set e1 in
        let uu____1484 = extract_from_ref_set e2 in
        FStar_List.append uu____1481 uu____1484
    | uu____1487 ->
        let uu____1488 =
          let uu____1490 = FStar_Parser_AST.term_to_string e in
          FStar_Util.format1 "Not a ref set %s" uu____1490 in
        failwith uu____1488
let (is_general_application : FStar_Parser_AST.term -> Prims.bool) =
  fun e ->
    let uu____1502 = (is_array e) || (is_ref_set e) in
    Prims.op_Negation uu____1502
let (is_general_construction : FStar_Parser_AST.term -> Prims.bool) =
  fun e ->
    let uu____1511 = (is_list e) || (is_lex_list e) in
    Prims.op_Negation uu____1511
let (is_general_prefix_op : FStar_Ident.ident -> Prims.bool) =
  fun op ->
    let op_starting_char =
      let uu____1522 = FStar_Ident.text_of_id op in
      FStar_Util.char_at uu____1522 Prims.int_zero in
    ((op_starting_char = 33) || (op_starting_char = 63)) ||
      ((op_starting_char = 126) &&
         (let uu____1532 = FStar_Ident.text_of_id op in uu____1532 <> "~"))
let (head_and_args :
...
let (uu___is_Left : associativity -> Prims.bool) =
  fun projectee -> match projectee with | Left -> true | uu____1622 -> false
let (uu___is_Right : associativity -> Prims.bool) =
  fun projectee -> match projectee with | Right -> true | uu____1633 -> false
let (uu___is_NonAssoc : associativity -> Prims.bool) =
  fun projectee ->
    match projectee with | NonAssoc -> true | uu____1644 -> false
type token = (FStar_Char.char, Prims.string) FStar_Util.either
type associativity_level = (associativity * token Prims.list)
let (token_to_string :
  (FStar_BaseTypes.char, Prims.string) FStar_Util.either -> Prims.string) =
  fun uu___1_1670 ->
    match uu___1_1670 with
...
let (matches_token :
  ...
  fun s ->
    fun uu___2_1705 ->
      match uu___2_1705 with
      | FStar_Util.Inl c ->
          let uu____1718 = FStar_String.get s Prims.int_zero in
          uu____1718 = c
      | FStar_Util.Inr s' -> s = s'
let matches_level :
  'Auu____1734 .
    Prims.string ->
      ('Auu____1734 * (FStar_Char.char, Prims.string) FStar_Util.either
  ...
  fun s ->
    fun uu____1758 ->
      ...
      | (assoc_levels, tokens) ->
          let uu____1790 = FStar_List.tryFind (matches_token s) tokens in
...
let (level_table :
  ...
  let levels_from_associativity l uu___3_1962 =
    match uu___3_1962 with
...
let (assign_levels :
  ...
  fun token_associativity_spec ->
    fun s ->
      let uu____2087 = FStar_List.tryFind (matches_level s) level_table in
      match uu____2087 with
      | FStar_Pervasives_Native.Some (assoc_levels, uu____2139) ->
          assoc_levels
      | uu____2177 -> failwith (Prims.op_Hat "Unrecognized operator " s)
let max_level :
  'Auu____2210 . ('Auu____2210 * token Prims.list) Prims.list -> Prims.int =
  fun l ->
    let find_level_and_max n1 level =
      ...
      | FStar_Pervasives_Native.Some
          ((uu____2341, l1, uu____2343), uu____2344) -> max n1 l1
      | FStar_Pervasives_Native.None ->
          let uu____2394 =
            let uu____2396 =
              ...
              FStar_String.concat "," uu____2398 in
            FStar_Util.format1 "Undefined associativity level %s" uu____2396 in
          failwith uu____2394 in
    FStar_List.fold_left find_level_and_max Prims.int_zero l
let (levels : Prims.string -> (Prims.int * Prims.int * Prims.int)) =
  fun op ->
    let uu____2433 = assign_levels level_associativity_spec op in
...
let (is_operatorInfix0ad12 : FStar_Ident.ident -> Prims.bool) =
  fun op ->
    let uu____2492 =
      let uu____2495 =
        let uu____2501 = FStar_Ident.text_of_id op in
        FStar_All.pipe_left matches_level uu____2501 in
      FStar_List.tryFind uu____2495 operatorInfix0ad12 in
  ...
  fun op ->
    let uu____2568 =
      let uu____2583 =
        ...
        FStar_All.pipe_left matches_level uu____2601 in
      FStar_List.tryFind uu____2583 opinfix34 in
    uu____2568 <> FStar_Pervasives_Native.None
...
let handleable_op :
  'Auu____2726 . FStar_Ident.ident -> 'Auu____2726 Prims.list -> Prims.bool =
  fun op ->
    fun args ->
      match FStar_List.length args with
      | _2742 when _2742 = Prims.int_zero -> true
      | _2744 when _2744 = Prims.int_one ->
          (is_general_prefix_op op) ||
            (let uu____2746 = FStar_Ident.text_of_id op in
             FStar_List.mem uu____2746 ["-"; "~"])
      | _2754 when _2754 = (Prims.of_int (2)) ->
          ((is_operatorInfix0ad12 op) || (is_operatorInfix34 op)) ||
            (let uu____2756 = FStar_Ident.text_of_id op in
             FStar_List.mem uu____2756
               ["<==>"; "==>"; "\\/"; "/\\"; "="; "|>"; ":="; ".()"; ".[]"])
      | _2778 when _2778 = (Prims.of_int (3)) ->
          let uu____2779 = FStar_Ident.text_of_id op in
          FStar_List.mem uu____2779 [".()<-"; ".[]<-"]
      | uu____2787 -> false
...
let (uu___is_Binders : annotation_style -> Prims.bool) =
  fun projectee ->
    match projectee with | Binders _0 -> true | uu____2833 -> false
...
let (uu___is_Arrows : annotation_style -> Prims.bool) =
  fun projectee ->
    match projectee with | Arrows _0 -> true | uu____2885 -> false
...
let (all_binders_annot : FStar_Parser_AST.term -> Prims.bool) =
  fun e ->
    let is_binder_annot b =
      ...
      | FStar_Parser_AST.Annotated uu____2927 -> true
      | uu____2933 -> false in
    let rec all_binders e1 l =
      match e1.FStar_Parser_AST.tm with
      | FStar_Parser_AST.Product (bs, tgt) ->
          let uu____2966 = FStar_List.for_all is_binder_annot bs in
          if uu____2966
          then all_binders tgt (l + (FStar_List.length bs))
          else (false, Prims.int_zero)
      | uu____2981 -> (true, (l + Prims.int_one)) in
    let uu____2986 = all_binders e Prims.int_zero in
...
let (cat_with_colon :
  ...
  fun x ->
    fun y ->
      let uu____3025 = FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon y in
      FStar_Pprint.op_Hat_Hat x uu____3025
let (comment_stack :
...
let with_comment :
  'Auu____3174 .
    ('Auu____3174 -> FStar_Pprint.document) ->
      'Auu____3174 -> FStar_Range.range -> FStar_Pprint.document
  =
  fun printer ->
    fun tm ->
      fun tmrange ->
        let rec comments_before_pos acc print_pos lookahead_pos =
          let uu____3216 = FStar_ST.op_Bang comment_stack in
          match uu____3216 with
          | [] -> (acc, false)
          | (c, crange)::cs ->
              let comment =
                let uu____3287 = str c in
                FStar_Pprint.op_Hat_Hat uu____3287 FStar_Pprint.hardline in
              let uu____3288 = FStar_Range.range_before_pos crange print_pos in
              if uu____3288
              then
                (FStar_ST.op_Colon_Equals comment_stack cs;
                 (let uu____3330 = FStar_Pprint.op_Hat_Hat acc comment in
                  comments_before_pos uu____3330 print_pos lookahead_pos))
              else
                (let uu____3333 =
        ...
        let uu____3336 =
          let uu____3342 =
            let uu____3343 = FStar_Range.start_of_range tmrange in
            FStar_Range.end_of_line uu____3343 in
          let uu____3344 = FStar_Range.end_of_range tmrange in
          comments_before_pos FStar_Pprint.empty uu____3342 uu____3344 in
        ...
        | (comments, has_lookahead) ->
            ...
            let comments1 =
              ...
              then
                ...
                let uu____3353 = comments_before_pos comments pos pos in
                FStar_Pervasives_Native.fst uu____3353
              else comments in
            if comments1 = FStar_Pprint.empty
            then printed_e
            else
              (let uu____3365 = FStar_Pprint.op_Hat_Hat comments1 printed_e in
               FStar_Pprint.group uu____3365)
let with_comment_sep :
  'Auu____3377 'Auu____3378 .
    ('Auu____3377 -> 'Auu____3378) ->
      'Auu____3377 ->
        FStar_Range.range -> (FStar_Pprint.document * 'Auu____3378)
  =
  fun printer ->
    fun tm ->
      fun tmrange ->
        let rec comments_before_pos acc print_pos lookahead_pos =
          let uu____3424 = FStar_ST.op_Bang comment_stack in
          match uu____3424 with
          | [] -> (acc, false)
          | (c, crange)::cs ->
              let comment = str c in
              let uu____3495 = FStar_Range.range_before_pos crange print_pos in
              if uu____3495
              then
                (FStar_ST.op_Colon_Equals comment_stack cs;
                 (let uu____3537 =
                    ...
                    then comment
                      ...
                      (let uu____3541 =
                         FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                           comment in
                       FStar_Pprint.op_Hat_Hat acc uu____3541) in
                  comments_before_pos uu____3537 print_pos lookahead_pos))
              else
                (let uu____3544 =
                   FStar_Range.range_before_pos crange lookahead_pos in
                 (acc, uu____3544)) in
        let uu____3547 =
          let uu____3553 =
            let uu____3554 = FStar_Range.start_of_range tmrange in
            FStar_Range.end_of_line uu____3554 in
          let uu____3555 = FStar_Range.end_of_range tmrange in
          comments_before_pos FStar_Pprint.empty uu____3553 uu____3555 in
        ...
        | (comments, has_lookahead) ->
            ...
            let comments1 =
              ...
              then
                let pos = FStar_Range.end_of_range tmrange in
                let uu____3568 = comments_before_pos comments pos pos in
                FStar_Pervasives_Native.fst uu____3568
              else comments in
            (comments1, printed_e)
      ...
      fun pos ->
        fun meta_decl ->
          fun doc1 ->
            fun r ->
              fun init1 ->
                let uu____3621 = FStar_ST.op_Bang comment_stack in
                     ...
                     (let lnum =
                        let uu____3715 =
                          let uu____3717 =
                            ...
                            FStar_Range.line_of_pos uu____3719 in
                          uu____3717 - lbegin in
                        max k uu____3715 in
                      ...
                      let doc2 =
                        let uu____3724 =
                          ...
                          let uu____3726 = str comment in
                          FStar_Pprint.op_Hat_Hat uu____3725 uu____3726 in
                        FStar_Pprint.op_Hat_Hat doc1 uu____3724 in
                      let uu____3727 =
                        let uu____3729 = FStar_Range.end_of_range crange in
                        FStar_Range.line_of_pos uu____3729 in
                      place_comments_until_pos Prims.int_one uu____3727 pos
                ...
                | uu____3732 ->
                    ...
                    then FStar_Pprint.empty
                      ...
                      (let lnum =
                         let uu____3745 = FStar_Range.line_of_pos pos in
                         uu____3745 - lbegin in
                       ...
                       FStar_Pprint.op_Hat_Hat doc1 uu____3787)
let separate_map_with_comments :
  'Auu____3801 .
    FStar_Pprint.document ->
      FStar_Pprint.document ->
        ('Auu____3801 -> FStar_Pprint.document) ->
          'Auu____3801 Prims.list ->
            ('Auu____3801 -> decl_meta) -> FStar_Pprint.document
  =
  fun prefix1 ->
    fun sep ->
      fun f ->
        fun xs ->
          fun extract_meta ->
            let fold_fun uu____3860 x =
              match uu____3860 with
              | (last_line, doc1) ->
                  let meta_decl = extract_meta x in
                  let r = meta_decl.r in
                  let doc2 =
                    let uu____3879 = FStar_Range.start_of_range r in
                    place_comments_until_pos Prims.int_one last_line
                      uu____3879 meta_decl doc1 false false in
                  let uu____3883 =
                    let uu____3885 = FStar_Range.end_of_range r in
                    FStar_Range.line_of_pos uu____3885 in
                  let uu____3886 =
                    let uu____3887 =
                      let uu____3888 = f x in
                      FStar_Pprint.op_Hat_Hat sep uu____3888 in
                    FStar_Pprint.op_Hat_Hat doc2 uu____3887 in
                  (uu____3883, uu____3886) in
            let uu____3890 =
              let uu____3897 = FStar_List.hd xs in
              let uu____3898 = FStar_List.tl xs in (uu____3897, uu____3898) in
            match uu____3890 with
            | (x, xs1) ->
                let init1 =
                  let meta_decl = extract_meta x in
                  let uu____3916 =
                    let uu____3918 = FStar_Range.end_of_range meta_decl.r in
                    FStar_Range.line_of_pos uu____3918 in
                  let uu____3919 =
                    let uu____3920 = f x in
                    FStar_Pprint.op_Hat_Hat prefix1 uu____3920 in
                  (uu____3916, uu____3919) in
                let uu____3922 = FStar_List.fold_left fold_fun init1 xs1 in
                FStar_Pervasives_Native.snd uu____3922
let separate_map_with_comments_kw :
  'Auu____3949 'Auu____3950 .
    'Auu____3949 ->
      'Auu____3949 ->
        ('Auu____3949 -> 'Auu____3950 -> FStar_Pprint.document) ->
          'Auu____3950 Prims.list ->
            ('Auu____3950 -> decl_meta) -> FStar_Pprint.document
  =
  fun prefix1 ->
    fun sep ->
      fun f ->
        fun xs ->
          fun extract_meta ->
            let fold_fun uu____4014 x =
              match uu____4014 with
              | (last_line, doc1) ->
                  let meta_decl = extract_meta x in
                  let r = meta_decl.r in
                  let doc2 =
                    let uu____4033 = FStar_Range.start_of_range r in
                    place_comments_until_pos Prims.int_one last_line
                      uu____4033 meta_decl doc1 false false in
                  let uu____4037 =
                    let uu____4039 = FStar_Range.end_of_range r in
                    FStar_Range.line_of_pos uu____4039 in
                  let uu____4040 =
                    let uu____4041 = f sep x in
                    FStar_Pprint.op_Hat_Hat doc2 uu____4041 in
                  (uu____4037, uu____4040) in
            let uu____4043 =
              let uu____4050 = FStar_List.hd xs in
              let uu____4051 = FStar_List.tl xs in (uu____4050, uu____4051) in
            match uu____4043 with
            | (x, xs1) ->
                let init1 =
                  let meta_decl = extract_meta x in
                  let uu____4069 =
                    let uu____4071 = FStar_Range.end_of_range meta_decl.r in
                    FStar_Range.line_of_pos uu____4071 in
                  let uu____4072 = f prefix1 x in (uu____4069, uu____4072) in
                let uu____4074 = FStar_List.fold_left fold_fun init1 xs1 in
                FStar_Pervasives_Native.snd uu____4074
      ...
      | ((FStar_Parser_AST.Assumption)::[], FStar_Parser_AST.Assume
         (id1, uu____5060)) ->
          let uu____5063 =
            ...
            FStar_All.pipe_right uu____5065 FStar_Util.is_upper in
          if uu____5063
          then
            let uu____5071 = p_qualifier FStar_Parser_AST.Assumption in
            FStar_Pprint.op_Hat_Hat uu____5071 FStar_Pprint.space
          else p_qualifiers d.FStar_Parser_AST.quals
      | uu____5074 -> p_qualifiers d.FStar_Parser_AST.quals in
    let uu____5081 =
      FStar_Pprint.optional (fun d1 -> p_fsdoc d1) d.FStar_Parser_AST.doc in
    let uu____5084 =
      let uu____5085 = p_attributes d.FStar_Parser_AST.attrs in
      let uu____5086 =
        let uu____5087 = p_rawDecl d in
        FStar_Pprint.op_Hat_Hat qualifiers uu____5087 in
      FStar_Pprint.op_Hat_Hat uu____5085 uu____5086 in
    FStar_Pprint.op_Hat_Hat uu____5081 uu____5084
        ...
        let uu____5090 =
          ...
          let uu____5093 =
            let uu____5094 =
              let uu____5095 =
                let uu____5096 =
                  let uu____5097 = FStar_List.map p_atomicTerm attrs in
                  FStar_Pprint.flow break1 uu____5097 in
                FStar_Pprint.op_Hat_Hat uu____5096 FStar_Pprint.rbracket in
              FStar_Pprint.align uu____5095 in
            FStar_Pprint.op_Hat_Hat uu____5094 FStar_Pprint.hardline in
          FStar_Pprint.op_Hat_Hat uu____5091 uu____5093 in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lbracket uu____5090
  ...
  fun uu____5100 ->
    ...
    | (doc1, kwd_args) ->
        let kwd_args_doc =
          ...
          | [] -> FStar_Pprint.empty
          | kwd_args1 ->
              let process_kwd_arg uu____5148 =
                match uu____5148 with
                | (kwd, arg) ->
                    let uu____5161 = str "@" in
                    let uu____5163 =
                      let uu____5164 = str kwd in
                      let uu____5165 =
                        let uu____5166 = str arg in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5166 in
                      FStar_Pprint.op_Hat_Hat uu____5164 uu____5165 in
                    FStar_Pprint.op_Hat_Hat uu____5161 uu____5163 in
              let uu____5167 =
                FStar_Pprint.separate_map FStar_Pprint.hardline
                  process_kwd_arg kwd_args1 in
              FStar_Pprint.op_Hat_Hat uu____5167 FStar_Pprint.hardline in
        let uu____5174 =
          let uu____5175 =
            let uu____5176 =
              let uu____5177 = str doc1 in
              let uu____5178 =
                let uu____5179 =
                  let uu____5180 =
                    FStar_Pprint.op_Hat_Hat FStar_Pprint.rparen
                      FStar_Pprint.hardline in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5180 in
                FStar_Pprint.op_Hat_Hat kwd_args_doc uu____5179 in
              FStar_Pprint.op_Hat_Hat uu____5177 uu____5178 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5176 in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5175 in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____5174
and (p_justSig : FStar_Parser_AST.decl -> FStar_Pprint.document) =
  fun d ->
    match d.FStar_Parser_AST.d with
    | FStar_Parser_AST.Val (lid, t) ->
        let uu____5184 =
          let uu____5185 = str "val" in
          let uu____5187 =
            let uu____5188 =
              let uu____5189 = p_lident lid in
              let uu____5190 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.colon in
              FStar_Pprint.op_Hat_Hat uu____5189 uu____5190 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5188 in
          FStar_Pprint.op_Hat_Hat uu____5185 uu____5187 in
        let uu____5191 = p_typ false false t in
        FStar_Pprint.op_Hat_Hat uu____5184 uu____5191
    | FStar_Parser_AST.TopLevelLet (uu____5194, lbs) ->
        FStar_Pprint.separate_map FStar_Pprint.hardline
          (fun lb ->
             let uu____5219 =
               let uu____5220 = str "let" in p_letlhs uu____5220 lb false in
             FStar_Pprint.group uu____5219) lbs
    | uu____5223 -> FStar_Pprint.empty
and (p_list :
  ...
  fun f ->
    fun sep ->
      fun l ->
        let rec p_list' uu___4_5238 =
          match uu___4_5238 with
          | [] -> FStar_Pprint.empty
          | x::[] -> f x
          | x::xs ->
              let uu____5246 = f x in
              let uu____5247 =
                let uu____5248 = p_list' xs in
                FStar_Pprint.op_Hat_Hat sep uu____5248 in
              FStar_Pprint.op_Hat_Hat uu____5246 uu____5247 in
        let uu____5249 = str "[" in
        let uu____5251 =
          let uu____5252 = p_list' l in
          let uu____5253 = str "]" in
          FStar_Pprint.op_Hat_Hat uu____5252 uu____5253 in
...
and (p_rawDecl : FStar_Parser_AST.decl -> FStar_Pprint.document) =
  fun d ->
    ...
    | FStar_Parser_AST.Open uid ->
        let uu____5257 =
          let uu____5258 = str "open" in
          let uu____5260 = p_quident uid in
          FStar_Pprint.op_Hat_Slash_Hat uu____5258 uu____5260 in
        FStar_Pprint.group uu____5257
    | FStar_Parser_AST.Include uid ->
        let uu____5262 =
          let uu____5263 = str "include" in
          let uu____5265 = p_quident uid in
          FStar_Pprint.op_Hat_Slash_Hat uu____5263 uu____5265 in
        FStar_Pprint.group uu____5262
    | FStar_Parser_AST.Friend uid ->
        let uu____5267 =
          let uu____5268 = str "friend" in
          let uu____5270 = p_quident uid in
          FStar_Pprint.op_Hat_Slash_Hat uu____5268 uu____5270 in
        FStar_Pprint.group uu____5267
    | FStar_Parser_AST.ModuleAbbrev (uid1, uid2) ->
        let uu____5273 =
          let uu____5274 = str "module" in
          let uu____5276 =
            let uu____5277 =
              let uu____5278 = p_uident uid1 in
              let uu____5279 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                  FStar_Pprint.equals in
              FStar_Pprint.op_Hat_Hat uu____5278 uu____5279 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5277 in
          FStar_Pprint.op_Hat_Hat uu____5274 uu____5276 in
        let uu____5280 = p_quident uid2 in
        op_Hat_Slash_Plus_Hat uu____5273 uu____5280
    | FStar_Parser_AST.TopLevelModule uid ->
        let uu____5282 =
          let uu____5283 = str "module" in
          let uu____5285 =
            let uu____5286 = p_quident uid in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5286 in
          FStar_Pprint.op_Hat_Hat uu____5283 uu____5285 in
    ...
    | FStar_Parser_AST.Tycon
        ...
        let effect_prefix_doc =
          let uu____5324 = str "effect" in
          let uu____5326 =
            let uu____5327 = p_uident uid in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5327 in
          FStar_Pprint.op_Hat_Hat uu____5324 uu____5326 in
        let uu____5328 =
          let uu____5329 = p_typars tpars in
          FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one
            effect_prefix_doc uu____5329 FStar_Pprint.equals in
        let uu____5332 = p_typ false false t in
        op_Hat_Slash_Plus_Hat uu____5328 uu____5332
    | FStar_Parser_AST.Tycon (false, tc, tcdefs) ->
        let s = if tc then str "class" else str "type" in
        let uu____5363 =
          let uu____5364 = FStar_List.hd tcdefs in
          p_fsdocTypeDeclPairs s uu____5364 in
        let uu____5377 =
          let uu____5378 = FStar_List.tl tcdefs in
          FStar_All.pipe_left
            (FStar_Pprint.concat_map
               (fun x ->
                  let uu____5416 =
                    let uu____5417 = str "and" in
                    p_fsdocTypeDeclPairs uu____5417 x in
                  FStar_Pprint.op_Hat_Hat break1 uu____5416)) uu____5378 in
        FStar_Pprint.op_Hat_Hat uu____5363 uu____5377
    | FStar_Parser_AST.TopLevelLet (q, lbs) ->
        let let_doc =
          let uu____5434 = str "let" in
          let uu____5436 = p_letqualifier q in
          FStar_Pprint.op_Hat_Hat uu____5434 uu____5436 in
        let uu____5437 = str "and" in
        separate_map_with_comments_kw let_doc uu____5437 p_letbinding lbs
          (fun uu____5447 ->
    ...
    | FStar_Parser_AST.Val (lid, t) ->
        let uu____5460 =
          let uu____5461 = str "val" in
          let uu____5463 =
            let uu____5464 =
              let uu____5465 = p_lident lid in
              let uu____5466 = sig_as_binders_if_possible t false in
              FStar_Pprint.op_Hat_Hat uu____5465 uu____5466 in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5464 in
          FStar_Pprint.op_Hat_Hat uu____5461 uu____5463 in
        FStar_All.pipe_left FStar_Pprint.group uu____5460
    | FStar_Parser_AST.Assume (id1, t) ->
        let decl_keyword =
          let uu____5471 =
            let uu____5473 =
              FStar_Util.char_at id1.FStar_Ident.idText Prims.int_zero in
            FStar_All.pipe_right uu____5473 FStar_Util.is_upper in
          if uu____5471
          then FStar_Pprint.empty
          else
            (let uu____5481 = str "val" in
             FStar_Pprint.op_Hat_Hat uu____5481 FStar_Pprint.space) in
        let uu____5483 =
          let uu____5484 = p_ident id1 in
          let uu____5485 =
            let uu____5486 =
              let uu____5487 =
                let uu____5488 = p_typ false false t in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5488 in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____5487 in
            FStar_Pprint.group uu____5486 in
          FStar_Pprint.op_Hat_Hat uu____5484 uu____5485 in
        FStar_Pprint.op_Hat_Hat decl_keyword uu____5483
    | FStar_Parser_AST.Exception (uid, t_opt) ->
        let uu____5497 = str "exception" in
        let uu____5499 =
          let uu____5500 =
            let uu____5501 = p_uident uid in
            let uu____5502 =
              FStar_Pprint.optional
                (fun t ->
                   let uu____5506 =
                     let uu____5507 = str "of" in
                     let uu____5509 = p_typ false false t in
                     op_Hat_Slash_Plus_Hat uu____5507 uu____5509 in
                   FStar_Pprint.op_Hat_Hat break1 uu____5506) t_opt in
            FStar_Pprint.op_Hat_Hat uu____5501 uu____5502 in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5500 in
        FStar_Pprint.op_Hat_Hat uu____5497 uu____5499
    | FStar_Parser_AST.NewEffect ne ->
        let uu____5513 = str "new_effect" in
        let uu____5515 =
          let uu____5516 = p_newEffect ne in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5516 in
        FStar_Pprint.op_Hat_Hat uu____5513 uu____5515
    | FStar_Parser_AST.SubEffect se ->
        let uu____5518 = str "sub_effect" in
        let uu____5520 =
          let uu____5521 = p_subEffect se in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5521 in
        FStar_Pprint.op_Hat_Hat uu____5518 uu____5520
    | FStar_Parser_AST.Pragma p -> p_pragma p
    | FStar_Parser_AST.Fsdoc doc1 -> p_fsdoc doc1
    | FStar_Parser_AST.Main uu____5524 ->
        failwith "*Main declaration* : Is that really still in use ??"
    | FStar_Parser_AST.Tycon (true, uu____5526, uu____5527) ->
        failwith
          "Effect abbreviation is expected to be defined by an abbreviation"
    | FStar_Parser_AST.Splice (ids, t) ->
        let uu____5555 = str "%splice" in
        let uu____5557 =
          let uu____5558 =
            let uu____5559 = str ";" in p_list p_uident uu____5559 ids in
          let uu____5561 =
            let uu____5562 = p_term false false t in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5562 in
          FStar_Pprint.op_Hat_Hat uu____5558 uu____5561 in
        FStar_Pprint.op_Hat_Hat uu____5555 uu____5557
and (p_pragma : FStar_Parser_AST.pragma -> FStar_Pprint.document) =
  fun uu___5_5565 ->
    match uu___5_5565 with
    | FStar_Parser_AST.SetOptions s ->
        let uu____5568 = str "#set-options" in
        let uu____5570 =
          let uu____5571 =
            let uu____5572 = str s in FStar_Pprint.dquotes uu____5572 in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5571 in
        FStar_Pprint.op_Hat_Hat uu____5568 uu____5570
    | FStar_Parser_AST.ResetOptions s_opt ->
        let uu____5577 = str "#reset-options" in
        let uu____5579 =
          FStar_Pprint.optional
            (fun s ->
               let uu____5585 =
                 let uu____5586 = str s in FStar_Pprint.dquotes uu____5586 in
               FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5585) s_opt in
        FStar_Pprint.op_Hat_Hat uu____5577 uu____5579
    | FStar_Parser_AST.PushOptions s_opt ->
        let uu____5591 = str "#push-options" in
        let uu____5593 =
          FStar_Pprint.optional
            (fun s ->
               let uu____5599 =
                 let uu____5600 = str s in FStar_Pprint.dquotes uu____5600 in
               FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5599) s_opt in
        FStar_Pprint.op_Hat_Hat uu____5591 uu____5593
                    ...
                    let uu____5677 =
                      let uu____5678 =
                        let uu____5679 =
                          ...
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                            uu____5680 in
                        FStar_Pprint.nest (Prims.of_int (2)) uu____5679 in
  ...
  fun uid ->
    fun bs ->
      fun t ->
        ...
        surround_maybe_empty (Prims.of_int (2)) Prims.int_one uu____6442
          uu____6443 uu____6445
            ...
            let uu____6462 =
              let uu____6463 =
                ...
                surround_maybe_empty (Prims.of_int (2)) Prims.int_one
                  uu____6464 uu____6465 uu____6467 in
...
and (p_atomicPattern : FStar_Parser_AST.pattern -> FStar_Pprint.document) =
  fun p ->
    ...
    | FStar_Parser_AST.PatTuple (pats, true) ->
        ...
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one uu____6819
          ...
          | (comm, phi1) ->
              ...
              let uu____7180 =
                ...
                let uu____7182 =
                  ...
                  FStar_Pprint.jump (Prims.of_int (2)) jump_break uu____7183 in
            ...
            let uu____7560 =
              let uu____7561 =
                let uu____7562 =
                  ...
                  FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one
                    uu____7563 uu____7565 uu____7568 in
                let uu____7572 =
                  separate_map_last FStar_Pprint.hardline p_patternBranch
                    branches in
            ...
            let uu____7588 =
              let uu____7589 =
                let uu____7590 =
                  ...
                  FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one
                    uu____7591 uu____7593 uu____7594 in
                       ...
                       let uu____7721 =
                         ...
                         then
                           ...
                           FStar_Pprint.surround (Prims.of_int (2))
                             Prims.int_one uu____7723 doc_expr1 uu____7724
                         else
                           (let uu____7730 =
                              FStar_Pprint.flow break1
                                [doc_pat; FStar_Pprint.equals; doc_expr1] in
                            FStar_Pprint.hang (Prims.of_int (2)) uu____7730) in
             ...
             | [] ->
                 let uu____8005 =
                   let uu____8006 =
                     ...
                     FStar_Pprint.op_Hat_Hat uu____8007 FStar_Pprint.space in
                   FStar_Pprint.soft_surround (Prims.of_int (2))
                     Prims.int_zero uu____8006 binders_doc FStar_Pprint.dot in
                     ...
                     let uu____8017 =
                       let uu____8018 =
                         ...
                         FStar_Pprint.op_Hat_Hat uu____8019
                           FStar_Pprint.space in
                       FStar_Pprint.soft_surround (Prims.of_int (2))
                         Prims.int_zero uu____8018 binders_doc
                         FStar_Pprint.dot in
             ...
             | [] ->
                 let uu____8058 =
                   let uu____8059 =
                     ...
                     FStar_Pprint.op_Hat_Hat uu____8060 FStar_Pprint.space in
                   FStar_Pprint.soft_surround (Prims.of_int (2))
                     Prims.int_zero uu____8059 binders_doc FStar_Pprint.dot in
                     ...
                     let uu____8070 =
                       let uu____8071 =
                         ...
                         FStar_Pprint.op_Hat_Hat uu____8072
                           FStar_Pprint.space in
                       FStar_Pprint.soft_surround (Prims.of_int (2))
                         Prims.int_zero uu____8071 binders_doc
                         FStar_Pprint.dot in
                 ...
                 FStar_List.fold_left
                   (fun x ->
                      fun y ->
                        ...
                        FStar_Pprint.op_Hat_Hat x uu____8334) hd1 tl1 in
               cat_with_colon uu____8328 typ) in
...
and (pats_as_binders_if_possible :
  ...
  fun pats ->
          ...
          (match ((pat.FStar_Parser_AST.pat), (t.FStar_Parser_AST.tm)) with
           | (FStar_Parser_AST.PatVar (lid, aqual), FStar_Parser_AST.Refine
              ({ FStar_Parser_AST.b = FStar_Parser_AST.Annotated (lid', t1);
                 ...
                 FStar_Parser_AST.aqual = uu____8415;_},
               phi)) when lid.FStar_Ident.idText = lid'.FStar_Ident.idText ->
               let uu____8424 =
    ...
    | FStar_Pervasives_Native.Some bs ->
        ...
        (uu____8522, (Binders ((Prims.of_int (4)), Prims.int_zero, true)))
    | FStar_Pervasives_Native.None ->
        let uu____8539 = FStar_List.map p_atomicPattern pats in
        (uu____8539, (Binders ((Prims.of_int (4)), Prims.int_zero, false)))
                 ...
                 let uu____8653 =
                   ...
                   then
                     ...
                     (let uu____8660 = op_Hat_Slash_Plus_Hat prefix1 doc1 in
                      FStar_Pprint.group uu____8660) in
              ...
              | FStar_Pervasives_Native.None ->
                  let uu____8698 =
                    let uu____8699 =
                      ...
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____8700 in
                  ...
                  let uu____8704 =
                    let uu____8705 =
                      let uu____8706 =
                        ...
                        FStar_Pprint.op_Hat_Slash_Hat uu____8707 uu____8712 in
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____8706 in
                    FStar_Pprint.op_Hat_Hat FStar_Pprint.bar uu____8705 in
                  FStar_Pprint.hang (Prims.of_int (2)) uu____8704 in
                      ...
                      let uu____8755 =
                        let uu____8756 =
                          ...
                          FStar_Pprint.op_Hat_Slash_Hat uu____8757
                            last_pat_branch in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____8756 in
...
and (p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "<==>"; FStar_Ident.idRange = uu____8763;_},
         e1::e2::[])
        ->
...
and (p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "==>"; FStar_Ident.idRange = uu____8775;_},
         e1::e2::[])
        ->
              ...
              let uu____8824 =
                ...
                | Arrows (n1, ln) ->
                    let uu____8859 =
                      ...
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____8860 in
                    let uu____8861 =
                ...
                | Binders (n1, ln, parens1) ->
                    ...
                    let uu____8883 =
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.colon
                        FStar_Pprint.space in
                    (n1, ln, uu____8875, break1, uu____8883) in
              (match uu____8824 with
               | (n1, last_n, terms'1, sep, last_op) ->
                   ...
                   (match FStar_List.length terms with
                    | _8916 when _8916 = Prims.int_one -> FStar_List.hd terms
                    | uu____8917 ->
                        let uu____8918 =
                          let uu____8919 =
                            let uu____8920 =
                              ...
                              let uu____8922 =
                                ...
                                FStar_Pprint.op_Hat_Hat one_line_space
                                  uu____8923 in
                              FStar_Pprint.op_Hat_Hat uu____8921 uu____8922 in
                          ...
                          let uu____8924 =
                                ...
                                let uu____8929 =
                                  let uu____8930 =
                                    ...
                                    FStar_Pprint.op_Hat_Hat
                                      single_line_arg_indent uu____8931 in
                                  jump2 uu____8930 in
                            ...
                            FStar_Pprint.prefix n1 Prims.int_one uu____8925
                              uu____8941 in
  ...
  fun p_Tm ->
    fun e ->
      let rec accumulate_binders p_Tm1 e1 =
        match e1.FStar_Parser_AST.tm with
        | FStar_Parser_AST.Product (bs, tgt) ->
            let uu____9050 = FStar_List.map (fun b -> p_binder' false b) bs in
                        ...
                        FStar_List.fold_left
                          (fun x ->
                             fun y ->
                               let uu____9575 =
                                 FStar_Pprint.op_Hat_Hat FStar_Pprint.space y in
                               FStar_Pprint.op_Hat_Hat x uu____9575) hd1 tl1 in
                      f uu____9569 typ)) in
      let binders =
...
and (p_tmDisjunction :
  ...
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "\\/"; FStar_Ident.idRange = uu____9679;_},
         e1::e2::[])
        ->
        let uu____9685 = p_tmDisjunction e1 in
        let uu____9690 = let uu____9695 = p_tmConjunction e2 in [uu____9695] in
...
and (p_tmConjunction :
  ...
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "/\\"; FStar_Ident.idRange = uu____9715;_},
         e1::e2::[])
        ->
...
and (p_tmTuple' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | FStar_Parser_AST.Construct (lid, args) when
        ...
        let uu____9746 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
  ...
  fun p_X ->
    fun curr ->
      fun e ->
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ":="; FStar_Ident.idRange = uu____9825;_},
             e1::e2::[])
            ->
            let uu____9831 =
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = "-"; FStar_Ident.idRange = uu____9837;_},
             e1::[])
            ->
    ...
    fun p_X ->
      fun curr ->
        fun e ->
              ...
              (match uu____9980 with
               | (left1, mine, right1) ->
                   let p_dsumfst bt =
                     ...
                     | FStar_Util.Inr t ->
                         let uu____10020 = p_tmNoEqWith' false p_X left1 t in
                         let uu____10022 =
                           let uu____10023 =
                           ...
                           FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                             uu____10023 in
                         FStar_Pprint.op_Hat_Hat uu____10020 uu____10022 in
                   let uu____10025 =
                     let uu____10026 =
          ...
          | FStar_Parser_AST.Op
              ({ FStar_Ident.idText = "*";
                 FStar_Ident.idRange = uu____10033;_},
               e1::e2::[])
               ...
               | (left1, mine, right1) ->
                   ...
                   then
                     ...
                     (let uu____10090 =
                        ...
                        let uu____10094 = p_tmNoEqWith' true p_X right1 e2 in
          ...
          | FStar_Parser_AST.Op
              ({ FStar_Ident.idText = "~";
                 FStar_Ident.idRange = uu____10154;_},
               e1::[])
              ->
              let uu____10159 =
          ...
          | FStar_Parser_AST.Paren p when inside_tuple ->
              (match p.FStar_Parser_AST.tm with
               | FStar_Parser_AST.Op
                   ({ FStar_Ident.idText = "*";
                      FStar_Ident.idRange = uu____10164;_},
                    e1::e2::[])
                   ->
                   let op = "*" in
                   ...
                   (match uu____10173 with
                    | (left1, mine, right1) ->
                        let uu____10192 =
                          ...
                          let uu____10194 = p_tmNoEqWith' true p_X left1 e1 in
                          let uu____10196 = p_tmNoEqWith' true p_X right1 e2 in
      ...
      | (lid, e) ->
          let uu____10257 =
            ...
            let uu____10259 =
              ...
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.equals uu____10260 in
                    ...
                    then
                      ...
                      | (fs_typ_args, args1) ->
                          let uu____10448 =
                            ...
                            FStar_Pprint.op_Hat_Hat uu____10449 uu____10450 in
                          (uu____10448, args1)
                    else
                       ...
                       let uu____10487 =
                         let uu____10488 =
                           FStar_Pprint.op_Hat_Hat head_doc
                             FStar_Pprint.space in
                         soft_surround_map_or_flow (Prims.of_int (2))
                           Prims.int_zero head_doc uu____10488 break1
...
and (p_indexingTerm_aux :
  ...
  fun exit1 ->
    fun e ->
      match e.FStar_Parser_AST.tm with
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".()"; FStar_Ident.idRange = uu____10600;_},
           e1::e2::[])
          ->
          let uu____10606 =
            let uu____10607 = p_indexingTerm_aux p_atomicTermNotQUident e1 in
            let uu____10608 =
              let uu____10609 =
      ...
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".[]"; FStar_Ident.idRange = uu____10613;_},
           e1::e2::[])
          ->
          let uu____10619 =
            let uu____10620 = p_indexingTerm_aux p_atomicTermNotQUident e1 in
            let uu____10621 =
              let uu____10622 =
  ...
  fun e ->
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_dtuple_constructor lid
        ...
        then
          ...
          let uu____10699 =
            ...
            let uu____10701 = FStar_List.map FStar_Pervasives_Native.fst args in
            FStar_Pprint.separate_map uu____10700 p_tmEq uu____10701 in
          let uu____10708 =
            FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rparen in
          FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one uu____10698
            uu____10699 uu____10708
        else
          (match args with
           | [] -> p_quident lid
           | arg::[] ->
    ...
    | FStar_Parser_AST.Project (e1, lid) ->
        let uu____10762 =
          ...
          FStar_Pprint.prefix (Prims.of_int (2)) Prims.int_zero uu____10763
            uu____10764 in
...
and (p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | uu____10794 when is_array e ->
        ...
        let uu____10799 =
          let uu____10800 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          separate_map_or_flow_last uu____10800
            (fun ps -> p_noSeqTermAndComment ps false) es in
        let uu____10805 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rbracket in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_zero uu____10798
          uu____10799 uu____10805
    | uu____10808 when is_list e ->
        let uu____10809 =
          let uu____10810 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____10811 = extract_from_list e in
          separate_map_or_flow_last uu____10810
            (fun ps -> p_noSeqTermAndComment ps false) uu____10811 in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_zero
    ...
    | uu____10820 when is_lex_list e ->
        ...
        let uu____10822 =
          let uu____10823 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____10824 = extract_from_list e in
          separate_map_or_flow_last uu____10823
            (fun ps -> p_noSeqTermAndComment ps false) uu____10824 in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one uu____10821
          uu____10822 FStar_Pprint.rbracket
    | uu____10833 when is_ref_set e ->
        let es = extract_from_ref_set e in
        let uu____10837 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bang FStar_Pprint.lbrace in
        let uu____10838 =
          let uu____10839 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          separate_map_or_flow uu____10839 p_appTerm es in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_zero uu____10837
          uu____10838 FStar_Pprint.rbrace
...
and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___15_11215 ->
    ...
    | FStar_Const.Const_bytearray (bytes, uu____11232) ->
        let uu____11237 =
          let uu____11238 = str (FStar_Util.string_of_bytes bytes) in
          FStar_Pprint.dquotes uu____11238 in
        let uu____11239 = str "B" in
        FStar_Pprint.op_Hat_Hat uu____11237 uu____11239
    | FStar_Const.Const_int (repr, sign_width_opt) ->
        let signedness uu___13_11262 =
          match uu___13_11262 with
          | FStar_Const.Unsigned -> str "u"
          | FStar_Const.Signed -> FStar_Pprint.empty in
        let width uu___14_11269 =
          match uu___14_11269 with
        ...
        let ending =
          default_or_map FStar_Pprint.empty
            (fun uu____11284 ->
               ...
               | (s, w) ->
                   let uu____11291 = signedness s in
                   let uu____11292 = width w in
                   FStar_Pprint.op_Hat_Hat uu____11291 uu____11292)
            sign_width_opt in
        let uu____11293 = str repr in
        FStar_Pprint.op_Hat_Hat uu____11293 ending
    | FStar_Const.Const_range_of -> str "range_of"
    | FStar_Const.Const_set_range_of -> str "set_range_of"
    | FStar_Const.Const_range r ->
        let uu____11297 = FStar_Range.string_of_range r in str uu____11297
    | FStar_Const.Const_reify -> str "reify"
    | FStar_Const.Const_reflect lid ->
        let uu____11301 = p_quident lid in
        let uu____11302 =
          let uu____11303 =
            let uu____11304 = str "reflect" in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____11304 in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____11303 in
        FStar_Pprint.op_Hat_Hat uu____11301 uu____11302
and (p_universe : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    let uu____11307 = str "u#" in
    let uu____11309 = p_atomicUniverse u in
    FStar_Pprint.op_Hat_Hat uu____11307 uu____11309
and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    match u.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____11311;_},
         u1::u2::[])
        ->
        let uu____11317 =
          let uu____11318 = p_universeFrom u1 in
          let uu____11319 =
            let uu____11320 = p_universeFrom u2 in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____11320 in
          FStar_Pprint.op_Hat_Slash_Hat uu____11318 uu____11319 in
        FStar_Pprint.group uu____11317
    | FStar_Parser_AST.App uu____11321 ->
        let uu____11328 = head_and_args u in
         ...
         | (head1, args) ->
             (match head1.FStar_Parser_AST.tm with
              | FStar_Parser_AST.Var maybe_max_lid when
                  ...
                  ->
                  let uu____11354 =
                    let uu____11355 = p_qlident FStar_Parser_Const.max_lid in
                    let uu____11356 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____11364 ->
                           match uu____11364 with
                           | (u1, uu____11370) -> p_atomicUniverse u1) args in
                    op_Hat_Slash_Plus_Hat uu____11355 uu____11356 in
                  FStar_Pprint.group uu____11354
              | uu____11371 ->
                  let uu____11372 =
                    let uu____11374 = FStar_Parser_AST.term_to_string u in
                    FStar_Util.format1 "Invalid term in universe context %s"
                      uu____11374 in
                  failwith uu____11372))
    | uu____11377 -> p_atomicUniverse u
and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    ...
    | FStar_Parser_AST.Uvar id1 ->
        let uu____11403 = FStar_Ident.text_of_id id1 in str uu____11403
    | FStar_Parser_AST.Paren u1 ->
        let uu____11406 = p_universeFrom u1 in
        soft_parens_with_nesting uu____11406
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____11407;_},
         uu____11408::uu____11409::[])
        ->
        let uu____11413 = p_universeFrom u in
        soft_parens_with_nesting uu____11413
    | FStar_Parser_AST.App uu____11414 ->
        let uu____11421 = p_universeFrom u in
        soft_parens_with_nesting uu____11421
    | uu____11422 ->
        let uu____11423 =
          let uu____11425 = FStar_Parser_AST.term_to_string u in
          FStar_Util.format1 "Invalid term in universe context %s"
            uu____11425 in
...
let (modul_to_document : FStar_Parser_AST.modul -> FStar_Pprint.document) =
  fun m ->
    ...
    (let res =
       match m with
       | FStar_Parser_AST.Module (uu____11514, decls) ->
           let uu____11520 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document) in
           FStar_All.pipe_right uu____11520
             (FStar_Pprint.separate FStar_Pprint.hardline)
       | FStar_Parser_AST.Interface (uu____11529, decls, uu____11531) ->
           let uu____11538 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document) in
...
let (comments_to_document :
  ...
  fun comments ->
    FStar_Pprint.separate_map FStar_Pprint.hardline
      (fun uu____11598 ->
         match uu____11598 with | (comment, range) -> str comment) comments
let (extract_decl_range : FStar_Parser_AST.decl -> decl_meta) =
  fun d ->
    let has_qs =
      match ((d.FStar_Parser_AST.quals), (d.FStar_Parser_AST.d)) with
      | ((FStar_Parser_AST.Assumption)::[], FStar_Parser_AST.Assume
         (id1, uu____11620)) -> false
      | ([], uu____11624) -> false
      | uu____11628 -> true in
    {
      ...
      is_fsdoc =
        (match d.FStar_Parser_AST.d with
         | FStar_Parser_AST.Fsdoc uu____11638 -> true
         | uu____11640 -> false)
    }
let (modul_with_comments_to_document :
  ...
  fun m ->
    fun comments ->
      let decls =
        match m with
        | FStar_Parser_AST.Module (uu____11683, decls) -> decls
        | FStar_Parser_AST.Interface (uu____11689, decls, uu____11691) ->
            decls in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
           ...
           let uu____11743 =
             ...
             | {
                 FStar_Parser_AST.d = FStar_Parser_AST.Pragma
                   (FStar_Parser_AST.LightOff);
                 FStar_Parser_AST.drange = uu____11756;
                 FStar_Parser_AST.doc = uu____11757;
                 FStar_Parser_AST.quals = uu____11758;
                 FStar_Parser_AST.attrs = uu____11759;_}::uu____11760 ->
                 let d0 = FStar_List.hd ds in
                 let uu____11766 =
                   let uu____11769 =
                     let uu____11772 = FStar_List.tl ds in d :: uu____11772 in
                   d0 :: uu____11769 in
                 (uu____11766, (d0.FStar_Parser_AST.drange))
             | uu____11777 -> ((d :: ds), (d.FStar_Parser_AST.drange)) in
           (match uu____11743 with
            | (decls1, first_range) ->
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    let uu____11834 = FStar_Range.start_of_range first_range in
                    place_comments_until_pos Prims.int_zero Prims.int_one
                      uu____11834 dummy_meta FStar_Pprint.empty false true in
                  let doc1 =
