...
and p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e  ->
    ...
    | FStar_Parser_AST.Op (op,args) when
        let uu____3625 = handleable_op op args  in
        Prims.op_Negation uu____3625 ->
        let uu____3626 =
          let uu____3627 =
            let uu____3628 =
              let uu____3629 =
                ...
                Prims.strcat uu____3630
                  " arguments couldn't be handled by the pretty printer"
                 in
              Prims.strcat " with " uu____3629  in
            Prims.strcat (FStar_Ident.text_of_id op) uu____3628  in
          Prims.strcat "Operation " uu____3627  in
        failwith uu____3626
    | FStar_Parser_AST.Uvar uu____3634 ->
        failwith "Unexpected universe variable out of universe context"
    | FStar_Parser_AST.Labeled uu____3635 ->
        failwith "Not valid in universe (can't be parsed back)"
    | FStar_Parser_AST.Wild 
      |FStar_Parser_AST.Const _
       |FStar_Parser_AST.Op _
        ...
        -> let uu____3667 = p_term e  in soft_parens_with_nesting uu____3667
...
and p_constant : FStar_Const.sconst -> FStar_Pprint.document =
  fun uu___111_3668  ->
    ...
    | FStar_Const.Const_char x ->
        let uu____3672 = FStar_Pprint.doc_of_char x  in
        FStar_Pprint.squotes uu____3672
    | FStar_Const.Const_string (bytes,uu____3674) ->
        let uu____3677 = str (FStar_Util.string_of_bytes bytes)  in
        FStar_Pprint.dquotes uu____3677
    | FStar_Const.Const_bytearray (bytes,uu____3679) ->
        let uu____3682 =
          let uu____3683 = str (FStar_Util.string_of_bytes bytes)  in
          FStar_Pprint.dquotes uu____3683  in
        let uu____3684 = str "B"  in
        FStar_Pprint.op_Hat_Hat uu____3682 uu____3684
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___109_3696 =
          match uu___109_3696 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___110_3700 =
          match uu___110_3700 with
        ...
        let ending =
          default_or_map FStar_Pprint.empty
            (fun uu____3704  ->
               ...
               | (s,w) ->
                   let uu____3709 = signedness s  in
                   let uu____3710 = width w  in
                   FStar_Pprint.op_Hat_Hat uu____3709 uu____3710)
            sign_width_opt
           in
        let uu____3711 = str repr  in
        FStar_Pprint.op_Hat_Hat uu____3711 ending
    | FStar_Const.Const_range r ->
        let uu____3713 = FStar_Range.string_of_range r  in str uu____3713
    | FStar_Const.Const_reify  -> str "reify"
    | FStar_Const.Const_reflect lid ->
        let uu____3715 = p_quident lid  in
        let uu____3716 =
          let uu____3717 =
            let uu____3718 = str "reflect"  in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____3718  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____3717  in
        FStar_Pprint.op_Hat_Hat uu____3715 uu____3716

and p_universe : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u  ->
    let uu____3720 = str "u#"  in
    let uu____3721 = p_atomicUniverse u  in
    FStar_Pprint.op_Hat_Hat uu____3720 uu____3721

and p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u  ->
    let uu____3723 =
      let uu____3724 = unparen u  in uu____3724.FStar_Parser_AST.tm  in
    match uu____3723 with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____3725;_},u1::u2::[])
        ->
        let uu____3729 =
          let uu____3730 = p_universeFrom u1  in
          let uu____3731 =
            let uu____3732 = p_universeFrom u2  in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____3732  in
          FStar_Pprint.op_Hat_Slash_Hat uu____3730 uu____3731  in
        FStar_Pprint.group uu____3729
    | FStar_Parser_AST.App uu____3733 ->
        let uu____3737 = head_and_args u  in
        (match uu____3737 with
         | (head1,args) ->
             let uu____3751 =
               let uu____3752 = unparen head1  in
               uu____3752.FStar_Parser_AST.tm  in
             (match uu____3751 with
              | FStar_Parser_AST.Var maybe_max_lid when
                  ...
                  ->
                  let uu____3754 =
                    let uu____3755 = p_qlident FStar_Parser_Const.max_lid  in
                    let uu____3756 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____3759  ->
                           match uu____3759 with
                           | (u1,uu____3763) -> p_atomicUniverse u1) args
                       in
                    op_Hat_Slash_Plus_Hat uu____3755 uu____3756  in
                  FStar_Pprint.group uu____3754
              | uu____3764 ->
                  let uu____3765 =
                    let uu____3766 = FStar_Parser_AST.term_to_string u  in
                    FStar_Util.format1 "Invalid term in universe context %s"
                      uu____3766
                     in
                  failwith uu____3765))
    | uu____3767 -> p_atomicUniverse u

and p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u  ->
    let uu____3769 =
      let uu____3770 = unparen u  in uu____3770.FStar_Parser_AST.tm  in
    match uu____3769 with
    | FStar_Parser_AST.Wild  -> FStar_Pprint.underscore
    | FStar_Parser_AST.Const (FStar_Const.Const_int (r,sw)) ->
        p_constant (FStar_Const.Const_int (r, sw))
    | FStar_Parser_AST.Uvar uu____3782 -> p_univar u
    | FStar_Parser_AST.Paren u1 ->
        let uu____3784 = p_universeFrom u1  in
        soft_parens_with_nesting uu____3784
    | FStar_Parser_AST.Op
      ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = _;_},_::_::[])
      |FStar_Parser_AST.App _ ->
        let uu____3790 = p_universeFrom u  in
        soft_parens_with_nesting uu____3790
    | uu____3791 ->
        let uu____3792 =
          let uu____3793 = FStar_Parser_AST.term_to_string u  in
          FStar_Util.format1 "Invalid term in universe context %s" uu____3793
           in
        failwith uu____3792
...
and p_univar : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u  ->
    let uu____3795 =
      let uu____3796 = unparen u  in uu____3796.FStar_Parser_AST.tm  in
    ...
    | uu____3798 ->
        let uu____3799 =
          ...
          FStar_Util.format1 "Not a universe variable %s" uu____3800  in
        failwith uu____3799
...
let comments_to_document :
  ...
  fun comments  ->
    FStar_Pprint.separate_map FStar_Pprint.hardline
      (fun uu____3841  ->
         match uu____3841 with | (comment,range) -> str comment) comments
           ...
           let uu____3888 =
             ...
             | {
                 FStar_Parser_AST.d = FStar_Parser_AST.Pragma
                   (FStar_Parser_AST.LightOff );
                 FStar_Parser_AST.drange = uu____3895;
                 FStar_Parser_AST.doc = uu____3896;
                 FStar_Parser_AST.quals = uu____3897;
                 FStar_Parser_AST.attrs = uu____3898;_}::uu____3899 ->
                 let d0 = FStar_List.hd ds  in
                 let uu____3903 =
                   let uu____3905 =
                     let uu____3907 = FStar_List.tl ds  in d :: uu____3907
                      in
                   d0 :: uu____3905  in
                 (uu____3903, (d0.FStar_Parser_AST.drange))
             | uu____3910 -> ((d :: ds), (d.FStar_Parser_AST.drange))  in
           (match uu____3888 with
            | (decls1,first_range) ->
                let extract_decl_range d1 = d1.FStar_Parser_AST.drange  in
                (FStar_ST.write comment_stack comments;
                 (let initial_comment =
                    let uu____3933 = FStar_Range.start_of_range first_range
                       in
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____3933 FStar_Pprint.empty
                     in
                  let doc1 =
