...
let level_table:
  ...
  =
  let levels_from_associativity l uu___129_947 =
    match uu___129_947 with
...
and p_constant: FStar_Const.sconst -> FStar_Pprint.document =
  fun uu___140_3606  ->
    ...
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___138_3634 =
          match uu___138_3634 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty in
        let width uu___139_3638 =
          match uu___139_3638 with
