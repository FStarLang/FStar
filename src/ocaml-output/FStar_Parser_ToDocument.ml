  ...
  fun p  ->
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName maybe_cons_lid;
           FStar_Parser_AST.prange = uu____6228;_},hd1::tl1::[])
        when
        FStar_Ident.lid_equals maybe_cons_lid FStar_Parser_Const.cons_lid ->
        let uu____6233 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.colon FStar_Pprint.colon  in
        let uu____6234 = p_constructorPattern hd1  in
        let uu____6235 = p_constructorPattern tl1  in
      ...
      fun e  ->
        ...
        | FStar_Parser_AST.CalcProof (rel,init1,steps) ->
            ...
            let uu____7415 =
              let uu____7416 =
                let uu____7417 =
                  let uu____7418 = p_noSeqTermAndComment false false init1
                     in
                  let uu____7421 =
              ...
              FStar_All.pipe_left (FStar_Pprint.nest (Prims.of_int (2)))
                uu____7416
               in
            FStar_Pprint.enclose head1 uu____7414 uu____7415
                 ...
                 FStar_List.fold_left
                   (fun x  ->
                      fun y  ->
                        ...
                        FStar_Pprint.op_Hat_Hat x uu____7852) hd1 tl1
                  in
                   ...
                   then
                     let uu____8173 =
                       ...
                       FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                         uu____8174
                        in
                     FStar_Pprint.op_Hat_Hat prefix1 uu____8173
                   else
                     (let uu____8178 = op_Hat_Slash_Plus_Hat prefix1 doc  in
                ...
                | Arrows (n1,ln) ->
                    ...
                    let uu____8379 =
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.rarrow
                        FStar_Pprint.space
                       in
                    (n1, ln, terms', uu____8377, uu____8379)
                | Binders (n1,ln,parens1) ->
                    ...
                    let uu____8401 =
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.colon
                        FStar_Pprint.space
                       in
                    (n1, ln, uu____8393, break1, uu____8401)
                 in
              (match uu____8342 with
               | (n1,last_n,terms'1,sep,last_op) ->
                   ...
                   (match FStar_List.length terms with
                    | _8434 when _8434 = Prims.int_one -> FStar_List.hd terms
                    | uu____8435 ->
                        let uu____8436 =
                          let uu____8437 =
                            let uu____8438 =
                          ...
                          let uu____8442 =
                            ...
                            FStar_Pprint.prefix n1 Prims.int_one uu____8443
                              uu____8459
                             in
                             ...
                             fun y  ->
                               let uu____9093 =
                                 FStar_Pprint.op_Hat_Hat FStar_Pprint.space y
                                  in
                               FStar_Pprint.op_Hat_Hat x uu____9093) hd1 tl1
                         in
                      f uu____9087 typ))
         in
      let binders =
            ...
            (match uu____9319 with
             | (left1,mine,right1) ->
                 let uu____9338 =
                   ...
                   let uu____9341 = p_tmEqWith' p_X left1 e1  in
                   let uu____9342 = p_tmEqWith' p_X right1 e2  in
              ...
              (match uu____9456 with
               | (left1,mine,right1) ->
                   let uu____9475 =
                     ...
                     let uu____9477 = p_tmNoEqWith' false p_X left1 e1  in
                     let uu____9479 = p_tmNoEqWith' false p_X right1 e2  in
              ...
              (match uu____9498 with
               | (left1,mine,right1) ->
                   let p_dsumfst bt =
                     ...
                     | FStar_Util.Inr t ->
                         let uu____9538 = p_tmNoEqWith' false p_X left1 t  in
                         let uu____9540 =
                           let uu____9541 =
                   ...
                   let uu____9543 =
                     ...
                     let uu____9549 = p_tmNoEqWith' false p_X right1 res  in
              ...
              (match uu____9581 with
               | (left1,mine,right1) ->
                   ...
                   then
                     ...
                     let uu____9602 = p_tmNoEqWith' true p_X left1 e1  in
                     let uu____9604 = p_tmNoEqWith' true p_X right1 e2  in
                     infix0 uu____9601 uu____9602 uu____9604
                   else
                     (let uu____9608 =
                        let uu____9609 = str op  in
                        let uu____9610 = p_tmNoEqWith' true p_X left1 e1  in
                        let uu____9612 = p_tmNoEqWith' true p_X right1 e2  in
              ...
              (match uu____9621 with
               | (left1,mine,right1) ->
                   let uu____9640 =
                     ...
                     let uu____9642 = p_tmNoEqWith' false p_X left1 e1  in
                     let uu____9644 = p_tmNoEqWith' false p_X right1 e2  in
                   ...
                   (match uu____9691 with
                    | (left1,mine,right1) ->
                        let uu____9710 =
                          ...
                          let uu____9712 = p_tmNoEqWith' true p_X left1 e1
                             in
                          let uu____9714 = p_tmNoEqWith' true p_X right1 e2
                             in
                  ...
                  let uu____9836 =
                    let uu____9837 =
                      let uu____9838 =
                        ...
                        let uu____9841 =
                          let uu____9842 = p_indexingTerm head1  in
              ...
              | uu____9846 ->
                  let uu____9853 =
                    ...
                    then
                      ...
                      | (fs_typ_args,args1) ->
                          let uu____9966 =
                            let uu____9967 = p_indexingTerm head1  in
                            let uu____9968 =
                              let uu____9969 =
                      ...
                      (let uu____9984 = p_indexingTerm head1  in
                       (uu____9984, args))
                     in
             ...
             let uu____10066 =
               let uu____10067 =
                 let uu____10068 =
                   ...
                   let uu____10070 = p_argTerm hd1  in
...
and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___15_10688  ->
    ...
    | FStar_Const.Const_bytearray (bytes,uu____10705) ->
        let uu____10710 =
          let uu____10711 = str (FStar_Util.string_of_bytes bytes)  in
          FStar_Pprint.dquotes uu____10711  in
        let uu____10712 = str "B"  in
        FStar_Pprint.op_Hat_Hat uu____10710 uu____10712
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___13_10735 =
          match uu___13_10735 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___14_10742 =
          match uu___14_10742 with
        ...
        let ending =
          default_or_map FStar_Pprint.empty
            (fun uu____10757  ->
               ...
               | (s,w) ->
                   let uu____10764 = signedness s  in
                   let uu____10765 = width w  in
                   FStar_Pprint.op_Hat_Hat uu____10764 uu____10765)
            sign_width_opt
           in
        let uu____10766 = str repr  in
        FStar_Pprint.op_Hat_Hat uu____10766 ending
    | FStar_Const.Const_range_of  -> str "range_of"
    | FStar_Const.Const_set_range_of  -> str "set_range_of"
    | FStar_Const.Const_range r ->
        let uu____10770 = FStar_Range.string_of_range r  in str uu____10770
    | FStar_Const.Const_reify  -> str "reify"
    | FStar_Const.Const_reflect lid ->
        let uu____10774 = p_quident lid  in
        let uu____10775 =
          let uu____10776 =
            let uu____10777 = str "reflect"  in
...
and (p_universe : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    let uu____10780 = str "u#"  in
    let uu____10782 = p_atomicUniverse u  in
    FStar_Pprint.op_Hat_Hat uu____10780 uu____10782

and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    match u.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____10784;_},u1::u2::[])
        ->
        let uu____10790 =
          let uu____10791 = p_universeFrom u1  in
          let uu____10792 =
            let uu____10793 = p_universeFrom u2  in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____10793  in
          FStar_Pprint.op_Hat_Slash_Hat uu____10791 uu____10792  in
        FStar_Pprint.group uu____10790
    | FStar_Parser_AST.App uu____10794 ->
        let uu____10801 = head_and_args u  in
         ...
         | (head1,args) ->
             (match head1.FStar_Parser_AST.tm with
              | FStar_Parser_AST.Var maybe_max_lid when
                  ...
                  ->
                  let uu____10827 =
                    let uu____10828 = p_qlident FStar_Parser_Const.max_lid
                       in
                    let uu____10829 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____10837  ->
                           match uu____10837 with
                           | (u1,uu____10843) -> p_atomicUniverse u1) args
                       in
                    op_Hat_Slash_Plus_Hat uu____10828 uu____10829  in
                  FStar_Pprint.group uu____10827
              | uu____10844 ->
                  let uu____10845 =
                    let uu____10847 = FStar_Parser_AST.term_to_string u  in
                    FStar_Util.format1 "Invalid term in universe context %s"
                      uu____10847
                     in
                  failwith uu____10845))
    | uu____10850 -> p_atomicUniverse u
...
and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    ...
    | FStar_Parser_AST.Uvar id1 ->
        let uu____10876 = FStar_Ident.text_of_id id1  in str uu____10876
    | FStar_Parser_AST.Paren u1 ->
        let uu____10879 = p_universeFrom u1  in
        soft_parens_with_nesting uu____10879
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____10880;_},uu____10881::uu____10882::[])
        ->
        let uu____10886 = p_universeFrom u  in
        soft_parens_with_nesting uu____10886
    | FStar_Parser_AST.App uu____10887 ->
        let uu____10894 = p_universeFrom u  in
        soft_parens_with_nesting uu____10894
    | uu____10895 ->
        let uu____10896 =
          let uu____10898 = FStar_Parser_AST.term_to_string u  in
          FStar_Util.format1 "Invalid term in universe context %s"
            uu____10898
           in
...
let (modul_to_document : FStar_Parser_AST.modul -> FStar_Pprint.document) =
  fun m  ->
    ...
    (let res =
       match m with
       | FStar_Parser_AST.Module (uu____10987,decls) ->
           let uu____10993 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document)  in
           FStar_All.pipe_right uu____10993
             (FStar_Pprint.separate FStar_Pprint.hardline)
       | FStar_Parser_AST.Interface (uu____11002,decls,uu____11004) ->
           let uu____11011 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document)  in
...
let (comments_to_document :
  ...
  fun comments  ->
    FStar_Pprint.separate_map FStar_Pprint.hardline
      (fun uu____11071  ->
         match uu____11071 with | (comment,range) -> str comment) comments
...
let (modul_with_comments_to_document :
  ...
  fun m  ->
    fun comments  ->
      let decls =
        match m with
        | FStar_Parser_AST.Module (uu____11150,decls) -> decls
        | FStar_Parser_AST.Interface (uu____11156,decls,uu____11158) -> decls
         in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
           ...
           let uu____11210 =
             ...
             | {
                 FStar_Parser_AST.d = FStar_Parser_AST.Pragma
                   (FStar_Parser_AST.LightOff );
                 FStar_Parser_AST.drange = uu____11223;
                 FStar_Parser_AST.quals = uu____11224;
                 FStar_Parser_AST.attrs = uu____11225;_}::uu____11226 ->
                 let d0 = FStar_List.hd ds  in
                 let uu____11230 =
                   let uu____11233 =
                     let uu____11236 = FStar_List.tl ds  in d :: uu____11236
                      in
                   d0 :: uu____11233  in
                 (uu____11230, (d0.FStar_Parser_AST.drange))
             | uu____11241 -> ((d :: ds), (d.FStar_Parser_AST.drange))  in
           (match uu____11210 with
            | (decls1,first_range) ->
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    let uu____11298 = FStar_Range.start_of_range first_range
                       in
                    place_comments_until_pos Prims.int_zero Prims.int_one
                      uu____11298 dummy_meta FStar_Pprint.empty false true
                     in
                  let doc =
