...
let with_fs_typ_app:
      'Auu____19 'Auu____20. Prims.bool -> ('Auu____20 -> 'Auu____19)
      -> 'Auu____20 -> 'Auu____19 =
  fun b printer t ->
    let b0 = FStar_ST.op_Bang should_print_fs_typ_app in
    FStar_ST.op_Colon_Equals should_print_fs_typ_app b ;
    let res = printer t in
    FStar_ST.op_Colon_Equals should_print_fs_typ_app b0 ;
    res
...
let default_or_map:
      'Auu____147 'Auu____148. 'Auu____148 -> ('Auu____147 -> 'Auu____148)
...
let op_Hat_Slash_Plus_Hat
    : FStar_Pprint.document -> FStar_Pprint.document -> FStar_Pprint.document =
  fun prefix_ body -> prefix2 prefix_ body
...
let separate_break_map:
      ...
      -> ('Auu____202 -> FStar_Pprint.document) -> 'Auu____202 Prims.list
      -> FStar_Pprint.document =
  fun sep f l ->
    let uu____224 =
      let uu____225 =
        let uu____226 = FStar_Pprint.op_Hat_Hat sep break1 in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____226
      in
      FStar_Pprint.separate_map uu____225 f l
    in
    FStar_Pprint.group uu____224


let precede_break_separate_map:
      'Auu____232. FStar_Pprint.document -> FStar_Pprint.document
      -> ('Auu____232 -> FStar_Pprint.document) -> 'Auu____232 Prims.list
      -> FStar_Pprint.document =
  fun prec sep f l ->
    let uu____258 =
      ...
      let uu____260 =
        ...
        FStar_All.pipe_right uu____261 f
      in
      FStar_Pprint.precede uu____259 uu____260
    in
    let uu____262 =
        ...
        (fun x ->
          let uu____269 =
            let uu____270 =
              ...
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____271
            in
            FStar_Pprint.op_Hat_Hat sep uu____270
          in
          FStar_Pprint.op_Hat_Hat break1 uu____269 )
        uu____263
    in
...
let concat_break_map:
      'Auu____275. ('Auu____275 -> FStar_Pprint.document)
      -> 'Auu____275 Prims.list -> FStar_Pprint.document =
  fun f l ->
    let uu____293 =
      FStar_Pprint.concat_map
        (fun x ->
          let uu____297 = f x in
          FStar_Pprint.op_Hat_Hat uu____297 break1 )
        l
    in
...
let soft_brackets_with_nesting : FStar_Pprint.document -> FStar_Pprint.document =
  fun contents ->
    FStar_Pprint.soft_surround (Prims.parse_int "2") (Prims.parse_int "1")
      FStar_Pprint.lbracket contents FStar_Pprint.rbracket
...
let separate_map_or_flow:
      ...
      -> ('Auu____325 -> FStar_Pprint.document) -> 'Auu____325 Prims.list
      -> FStar_Pprint.document =
  fun sep f l ->
    if FStar_List.length l < Prims.parse_int "10" then
      FStar_Pprint.separate_map sep f l
    else FStar_Pprint.flow_map sep f l


let soft_surround_separate_map:
      'Auu____357. Prims.int -> Prims.int -> FStar_Pprint.document
      -> FStar_Pprint.document -> FStar_Pprint.document
      -> FStar_Pprint.document -> ('Auu____357 -> FStar_Pprint.document)
      -> 'Auu____357 Prims.list -> FStar_Pprint.document =
  fun n1 b void_ opening sep closing f xs ->
    if xs = [] then void_
    else
      let uu____402 = FStar_Pprint.separate_map sep f xs in
      FStar_Pprint.soft_surround n1 b opening uu____402 closing


let soft_surround_map_or_flow:
      'Auu____412. Prims.int -> Prims.int -> FStar_Pprint.document
      -> FStar_Pprint.document -> FStar_Pprint.document
      -> FStar_Pprint.document -> ('Auu____412 -> FStar_Pprint.document)
      -> 'Auu____412 Prims.list -> FStar_Pprint.document =
  fun n1 b void_ opening sep closing f xs ->
    if xs = [] then void_
    else
      let uu____457 = separate_map_or_flow sep f xs in
      FStar_Pprint.soft_surround n1 b opening uu____457 closing
...
let doc_of_fsdoc
  ...
  fun uu____470 ->
    match uu____470 with comment, keywords ->
      let uu____495 =
        let uu____496 =
            ...
            let uu____503 =
              let uu____506 =
                FStar_Pprint.separate_map FStar_Pprint.comma
                  (fun uu____515 ->
                    match uu____515 with k, v1 ->
                      let uu____522 =
                        let uu____525 = str k in
                        let uu____526 =
                          let uu____529 =
                            let uu____532 = str v1 in
                            [uu____532]
                          in
                          FStar_Pprint.rarrow :: uu____529
                        in
                        uu____525 :: uu____526
                      in
                      FStar_Pprint.concat uu____522 )
                  keywords
              in
              [uu____506]
            in
            FStar_Pprint.space :: uu____503
          in
          uu____499 :: uu____500
        in
        FStar_Pprint.concat uu____496
      in
...
let is_unit : FStar_Parser_AST.term -> Prims.bool =
  fun e ->
    let uu____536 =
      let uu____537 = unparen e in
      uu____537.FStar_Parser_AST.tm
    in
...
let matches_var : FStar_Parser_AST.term -> FStar_Ident.ident -> Prims.bool =
  fun t x ->
    let uu____545 =
      let uu____546 = unparen t in
      uu____546.FStar_Parser_AST.tm
    in
...
let is_list_structure
    : FStar_Ident.lident -> FStar_Ident.lident -> FStar_Parser_AST.term
      -> Prims.bool =
  fun cons_lid1 nil_lid1 ->
    let rec aux e =
      let uu____565 =
        let uu____566 = unparen e in
        uu____566.FStar_Parser_AST.tm
      in
...
let rec extract_from_list
  ...
  fun e ->
    let uu____614 =
      let uu____615 = unparen e in
      uu____615.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.Construct
        ...
        let uu____650 = extract_from_list e2 in
        e1 :: uu____650
    | uu____653 ->
        let uu____654 =
          let uu____655 = FStar_Parser_AST.term_to_string e in
          FStar_Util.format1 "Not a list %s" uu____655
        in
        failwith uu____654
...
let is_array : FStar_Parser_AST.term -> Prims.bool =
  fun e ->
    let uu____661 =
      let uu____662 = unparen e in
      uu____662.FStar_Parser_AST.tm
    in
    match uu____661 with
    | FStar_Parser_AST.App
        ( { FStar_Parser_AST.tm= FStar_Parser_AST.Var lid
          ; FStar_Parser_AST.range= uu____664
          ; FStar_Parser_AST.level= uu____665; _ }
        , l
...
let rec is_ref_set : FStar_Parser_AST.term -> Prims.bool =
  fun e ->
    let uu____671 =
      let uu____672 = unparen e in
      uu____672.FStar_Parser_AST.tm
    in
        ...
        , { FStar_Parser_AST.tm=
              FStar_Parser_AST.App
                ( { FStar_Parser_AST.tm= FStar_Parser_AST.Var maybe_addr_of_lid
                  ; FStar_Parser_AST.range= uu____678
                  ; FStar_Parser_AST.level= uu____679; _ }
                , e1
                , FStar_Parser_AST.Nothing )
          ; FStar_Parser_AST.range= uu____681
          ; FStar_Parser_AST.level= uu____682; _ }
        , FStar_Parser_AST.Nothing ) ->
        ...
        ( { FStar_Parser_AST.tm=
              FStar_Parser_AST.App
                ( { FStar_Parser_AST.tm= FStar_Parser_AST.Var maybe_union_lid
                  ...
                  ; FStar_Parser_AST.level= uu____685; _ }
                , e1
                , FStar_Parser_AST.Nothing )
          ; FStar_Parser_AST.range= uu____687
          ; FStar_Parser_AST.level= uu____688; _ }
        , e2
        , FStar_Parser_AST.Nothing ) ->
...
let rec extract_from_ref_set
  ...
  fun e ->
    let uu____696 =
      let uu____697 = unparen e in
      uu____697.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.App
        ...
        , { FStar_Parser_AST.tm=
              FStar_Parser_AST.App
                ( { FStar_Parser_AST.tm= FStar_Parser_AST.Var uu____704
                  ; FStar_Parser_AST.range= uu____705
                  ; FStar_Parser_AST.level= uu____706; _ }
                , e1
                , FStar_Parser_AST.Nothing )
          ; FStar_Parser_AST.range= uu____708
          ; FStar_Parser_AST.level= uu____709; _ }
        , FStar_Parser_AST.Nothing ) ->
        [e1]
    | FStar_Parser_AST.App
        ( { FStar_Parser_AST.tm=
              FStar_Parser_AST.App
                ( { FStar_Parser_AST.tm= FStar_Parser_AST.Var uu____710
                  ...
                  ; FStar_Parser_AST.level= uu____712; _ }
                , e1
                , FStar_Parser_AST.Nothing )
          ; FStar_Parser_AST.range= uu____714
          ; FStar_Parser_AST.level= uu____715; _ }
        , e2
        , FStar_Parser_AST.Nothing ) ->
    ...
    | uu____723 ->
        let uu____724 =
          ...
          FStar_Util.format1 "Not a ref set %s" uu____725
        in
        failwith uu____724
...
let head_and_args
  ...
  fun e ->
    let rec aux e1 acc =
      let uu____785 =
        let uu____786 = unparen e1 in
        uu____786.FStar_Parser_AST.tm
      in
...
type associativity = Left | Right | NonAssoc [@@deriving show]
...
let uu___is_Right : associativity -> Prims.bool =
  fun projectee -> match projectee with Right -> true | uu____822 -> false


let uu___is_NonAssoc : associativity -> Prims.bool =
  fun projectee -> match projectee with NonAssoc -> true | uu____826 -> false
...
let matches_token
    : Prims.string -> (FStar_Char.char, Prims.string) FStar_Util.either
      -> Prims.bool =
  fun s uu___52_861 ->
...
let matches_level:
      'Auu____878. Prims.string
      -> ( 'Auu____878
         , (FStar_Char.char, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 -> Prims.bool =
  fun s uu____897 ->
    match uu____897 with assoc_levels, tokens ->
      let uu____925 = FStar_List.tryFind (matches_token s) tokens in
      uu____925 <> FStar_Pervasives_Native.None


let opinfix4:
      'Auu____951. Prims.unit
      -> ( associativity
         , ('Auu____951, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____962 -> (Right, [FStar_Util.Inr "**"])


let opinfix3:
      'Auu____978. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____978) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____990 ->
...
let opinfix2:
      'Auu____1025. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1025) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1037 -> (Left, [FStar_Util.Inl 43; FStar_Util.Inl 45])


let minus_lvl:
      'Auu____1065. Prims.unit
      -> ( associativity
         , ('Auu____1065, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1076 -> (Left, [FStar_Util.Inr "-"])


let opinfix1:
      'Auu____1092. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1092) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1104 -> (Right, [FStar_Util.Inl 64; FStar_Util.Inl 94])


let pipe_right:
      'Auu____1132. Prims.unit
      -> ( associativity
         , ('Auu____1132, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1143 -> (Left, [FStar_Util.Inr "|>"])


let opinfix0d:
      'Auu____1159. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1159) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1171 -> (Left, [FStar_Util.Inl 36])


let opinfix0c:
      'Auu____1192. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1192) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1204 ->
...
let equal:
      'Auu____1239. Prims.unit
      -> ( associativity
         , ('Auu____1239, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1250 -> (Left, [FStar_Util.Inr "="])


let opinfix0b:
      'Auu____1266. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1266) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1278 -> (Left, [FStar_Util.Inl 38])


let opinfix0a:
      'Auu____1299. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____1299) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1311 -> (Left, [FStar_Util.Inl 124])


let colon_equals:
      'Auu____1332. Prims.unit
      -> ( associativity
         , ('Auu____1332, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun uu____1343 -> (NonAssoc, [FStar_Util.Inr ":="])


let amp:
      'Auu____1359. Prims.unit
      -> ( associativity
         , ('Auu____1359, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
...
let colon_colon:
      ...
      -> ( associativity
         , ('Auu____1386, Prims.string) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2 =
...
let level_table
  ...
  FStar_List.mapi
    (fun i uu____1644 ->
      match uu____1644 with assoc1, tokens ->
        (levels_from_associativity i assoc1, tokens) )
    level_associativity_spec


let assign_levels
    : associativity_level Prims.list -> Prims.string
      -> (Prims.int, Prims.int, Prims.int) FStar_Pervasives_Native.tuple3 =
  fun token_associativity_spec s ->
    let uu____1724 = FStar_List.tryFind (matches_level s) level_table in
    match uu____1724 with
    | FStar_Pervasives_Native.Some (assoc_levels, uu____1774) -> assoc_levels
    | uu____1818 -> failwith (Prims.strcat "Unrecognized operator " s)


let max : Prims.int -> Prims.int -> Prims.int =
  fun k1 k2 -> if k1 > k2 then k1 else k2
  ...
  fun l ->
    let find_level_and_max n1 level =
      let uu____1913 =
        FStar_List.tryFind
          (fun uu____1953 ->
            match uu____1953 with uu____1971, tokens ->
      ...
      | FStar_Pervasives_Native.None ->
          let uu____2071 =
            let uu____2072 =
              ...
              in
              FStar_String.concat "," uu____2073
            in
...
let operatorInfix0ad12:
      'Auu____2107. Prims.unit
      -> ( associativity
         , (FStar_Char.char, 'Auu____2107) FStar_Util.either Prims.list )
         FStar_Pervasives_Native.tuple2
         Prims.list =
  fun uu____2121 ->
    [ opinfix0a ()
...
let is_operatorInfix0ad12 : FStar_Ident.ident -> Prims.bool =
  fun op ->
    let uu____2202 =
      let uu____2216 =
        FStar_All.pipe_left matches_level (FStar_Ident.text_of_id op)
      in
      FStar_List.tryFind uu____2216 (operatorInfix0ad12 ())
    in
  ...
  fun op ->
    let uu____2329 =
      let uu____2343 =
        FStar_All.pipe_left matches_level (FStar_Ident.text_of_id op)
      in
      FStar_List.tryFind uu____2343 opinfix34
    in
...
let handleable_args_length : FStar_Ident.ident -> Prims.int =
  fun op ->
    ...
    let uu____2409 =
      is_general_prefix_op op || FStar_List.mem op_s ["-"; "~"]
    in
    if uu____2409 then Prims.parse_int "1"
    else
      let uu____2411 =
        ...
        || FStar_List.mem op_s
             ["<==>"; "==>"; "\\/"; "/\\"; "="; "|>"; ":="; ".()"; ".[]"]
      in
      if uu____2411 then Prims.parse_int "2"
      else if FStar_List.mem op_s [".()<-"; ".[]<-"] then Prims.parse_int "3"
...
let with_comment:
      'Auu____2464. ('Auu____2464 -> FStar_Pprint.document) -> 'Auu____2464
      -> FStar_Range.range -> FStar_Pprint.document =
  fun printer tm tmrange ->
          ...
          if uu____2555 then (
            ...
            let uu____2592 =
              let uu____2593 =
                ...
                FStar_Pprint.op_Hat_Hat uu____2594 FStar_Pprint.hardline
              in
              FStar_Pprint.op_Hat_Hat acc uu____2593
            in
            comments_before_pos uu____2592 print_pos lookahead_pos )
          else
            let uu____2596 =
              FStar_Range.range_before_pos crange lookahead_pos
            in
            (acc, uu____2596)
    in
    let uu____2597 =
      let uu____2602 =
        ...
        FStar_Range.end_of_line uu____2603
      in
      let uu____2604 = FStar_Range.end_of_range tmrange in
      comments_before_pos FStar_Pprint.empty uu____2602 uu____2604
    in
    match uu____2597 with comments, has_lookahead ->
      let printed_e = printer tm in
      let comments1 =
        if has_lookahead then
...
let rec place_comments_until_pos
    : Prims.int -> Prims.int -> FStar_Range.pos -> FStar_Pprint.document
      -> FStar_Pprint.document =
  fun k lbegin pos_end doc1 ->
    let uu____2629 = FStar_ST.op_Bang comment_stack in
    match uu____2629 with
    | (comment, crange) :: cs when FStar_Range.range_before_pos crange pos_end ->
        FStar_ST.op_Colon_Equals comment_stack cs ;
        let lnum =
          let uu____2713 =
            let uu____2714 =
              let uu____2715 = FStar_Range.start_of_range crange in
              FStar_Range.line_of_pos uu____2715
            in
            uu____2714 - lbegin
          in
          max k uu____2713
        ...
        let doc2 =
          let uu____2717 =
            let uu____2718 = FStar_Pprint.repeat lnum FStar_Pprint.hardline in
            let uu____2719 = str comment in
            FStar_Pprint.op_Hat_Hat uu____2718 uu____2719
          in
          FStar_Pprint.op_Hat_Hat doc1 uu____2717
        in
        let uu____2720 =
          let uu____2721 = FStar_Range.end_of_range crange in
          FStar_Range.line_of_pos uu____2721
        in
        place_comments_until_pos (Prims.parse_int "1") uu____2720 pos_end doc2
    | uu____2722 ->
        let lnum =
          let uu____2730 =
            ...
            uu____2731 - lbegin
          in
          max (Prims.parse_int "1") uu____2730
        in
...
let separate_map_with_comments:
      'Auu____2739. FStar_Pprint.document -> FStar_Pprint.document
      -> ('Auu____2739 -> FStar_Pprint.document) -> 'Auu____2739 Prims.list
      -> ('Auu____2739 -> FStar_Range.range) -> FStar_Pprint.document =
  fun prefix1 sep f xs extract_range ->
    let fold_fun uu____2787 x =
      match uu____2787 with last_line, doc1 ->
        let r = extract_range x in
        let doc2 =
          let uu____2801 = FStar_Range.start_of_range r in
          place_comments_until_pos (Prims.parse_int "1") last_line uu____2801
            doc1
        in
        let uu____2802 =
          let uu____2803 = FStar_Range.end_of_range r in
          FStar_Range.line_of_pos uu____2803
        in
        let uu____2804 =
          let uu____2805 =
            let uu____2806 = f x in
            FStar_Pprint.op_Hat_Hat sep uu____2806
          in
          FStar_Pprint.op_Hat_Hat doc2 uu____2805
        in
        (uu____2802, uu____2804)
    in
    let uu____2807 =
      let uu____2814 = FStar_List.hd xs in
      let uu____2815 = FStar_List.tl xs in
      (uu____2814, uu____2815)
    in
    match uu____2807 with x, xs1 ->
      let init1 =
        let uu____2831 =
          let uu____2832 =
            let uu____2833 = extract_range x in
            FStar_Range.end_of_range uu____2833
          in
          FStar_Range.line_of_pos uu____2832
        in
        let uu____2834 =
          let uu____2835 = f x in
          FStar_Pprint.op_Hat_Hat prefix1 uu____2835
        in
        (uu____2831, uu____2834)
      in
...
let rec p_decl : FStar_Parser_AST.decl -> FStar_Pprint.document =
  fun d ->
    let uu____3151 =
      let uu____3152 = FStar_Pprint.optional p_fsdoc d.FStar_Parser_AST.doc in
      let uu____3153 =
        ...
        let uu____3155 =
          ...
          let uu____3157 =
            ...
            FStar_Pprint.op_Hat_Hat
              ( if d.FStar_Parser_AST.quals = [] then FStar_Pprint.empty
              else break1 )
              uu____3158
          in
          FStar_Pprint.op_Hat_Hat uu____3156 uu____3157
        in
        FStar_Pprint.op_Hat_Hat uu____3154 uu____3155
      in
      FStar_Pprint.op_Hat_Hat uu____3152 uu____3153
    in
...
and p_attributes : FStar_Parser_AST.attributes_ -> FStar_Pprint.document =
  fun attrs ->
    let uu____3161 =
      ...
      FStar_Pprint.op_Hat_Hat FStar_Pprint.lbracket uu____3162
    in
    let uu____3163 =
      FStar_Pprint.op_Hat_Hat FStar_Pprint.rbracket FStar_Pprint.hardline
    in
    soft_surround_map_or_flow (Prims.parse_int "0") (Prims.parse_int "2")
      FStar_Pprint.empty uu____3161 FStar_Pprint.space uu____3163 p_atomicTerm
      attrs


and p_fsdoc : FStar_Parser_AST.fsdoc -> FStar_Pprint.document =
  fun uu____3164 ->
    match uu____3164 with doc1, kwd_args ->
      let kwd_args_doc =
        match kwd_args with
        | [] -> FStar_Pprint.empty
        | kwd_args1 ->
            let process_kwd_arg uu____3198 =
              match uu____3198 with kwd, arg ->
                ...
                let uu____3206 =
                  ...
                  in
                  FStar_Pprint.op_Hat_Hat uu____3207 uu____3208
                in
                FStar_Pprint.op_Hat_Hat uu____3205 uu____3206
            in
            let uu____3210 =
              let uu____3211 =
                FStar_Pprint.separate_map FStar_Pprint.hardline process_kwd_arg
                  kwd_args1
              in
              FStar_Pprint.op_Hat_Hat uu____3211 FStar_Pprint.hardline
            in
            ...
            let uu____3219 =
              ...
              let uu____3221 =
                let uu____3222 =
                  ...
                  in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____3223
                in
                FStar_Pprint.op_Hat_Hat kwd_args_doc uu____3222
              in
              FStar_Pprint.op_Hat_Hat uu____3220 uu____3221
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____3219
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____3218
        in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____3217
      in
    ...
    | FStar_Parser_AST.Val (lid, t) ->
        let uu____3227 =
          ...
          let uu____3229 =
            ...
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3230
          in
          FStar_Pprint.op_Hat_Hat uu____3228 uu____3229
        in
        ...
        FStar_Pprint.separate_map FStar_Pprint.hardline
          (fun lb ->
            let uu____3259 =
              ...
              FStar_Pprint.op_Hat_Slash_Hat uu____3260 uu____3261
            in
            FStar_Pprint.group uu____3259 )
          lbs
  ...
  fun d ->
    ...
    | FStar_Parser_AST.Open uid ->
        let uu____3265 =
          ...
          FStar_Pprint.op_Hat_Slash_Hat uu____3266 uu____3267
        in
    ...
    | FStar_Parser_AST.Include uid ->
        let uu____3269 =
          ...
          FStar_Pprint.op_Hat_Slash_Hat uu____3270 uu____3271
        in
        ...
        let uu____3274 =
          ...
          let uu____3276 =
            let uu____3277 =
              ...
              in
              FStar_Pprint.op_Hat_Hat uu____3278 uu____3279
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3277
          in
          FStar_Pprint.op_Hat_Hat uu____3275 uu____3276
        in
    ...
    | FStar_Parser_AST.TopLevelModule uid ->
        let uu____3282 =
          ...
          let uu____3284 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3285
          in
          FStar_Pprint.op_Hat_Hat uu____3283 uu____3284
        in
    ...
    | FStar_Parser_AST.Tycon
        ...
        let effect_prefix_doc =
          ...
          let uu____3319 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3320
          in
    ...
    | FStar_Parser_AST.TopLevelLet (q, lbs) ->
        let let_doc =
          ...
          let uu____3365 =
            ...
            FStar_Pprint.op_Hat_Hat uu____3366 FStar_Pprint.space
          in
          FStar_Pprint.op_Hat_Hat uu____3364 uu____3365
        in
        let uu____3367 =
          let uu____3368 = str "and" in
          FStar_Pprint.op_Hat_Hat uu____3368 FStar_Pprint.space
        in
        separate_map_with_comments let_doc uu____3367 p_letbinding lbs
          (fun uu____3376 ->
            match uu____3376 with p, t ->
          ...
          let uu____3387 =
            let uu____3388 =
              ...
              let uu____3390 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.colon
              in
              FStar_Pprint.op_Hat_Hat uu____3389 uu____3390
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3388
          in
          FStar_Pprint.op_Hat_Hat uu____3386 uu____3387
        in
    ...
    | FStar_Parser_AST.Assume (id1, t) ->
        let decl_keyword =
          let uu____3395 =
            ...
            in
            FStar_All.pipe_right uu____3396 FStar_Util.is_upper
          in
          if uu____3395 then FStar_Pprint.empty
          else
        ...
        let uu____3399 =
          ...
          in
          FStar_Pprint.op_Hat_Hat decl_keyword uu____3400
        in
            ...
            let uu____3414 =
              FStar_Pprint.optional
                (fun t ->
                  ...
                  op_Hat_Slash_Plus_Hat uu____3419 uu____3420 )
                t_opt
            in
            FStar_Pprint.op_Hat_Hat uu____3413 uu____3414
          in
    ...
    | FStar_Parser_AST.NewEffect ne ->
        ...
        let uu____3423 =
          ...
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3424
        in
    ...
    | FStar_Parser_AST.SubEffect se ->
        ...
        let uu____3427 =
          ...
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3428
        in
...
and p_pragma : FStar_Parser_AST.pragma -> FStar_Pprint.document =
  fun uu___54_3450 ->
    ...
    | FStar_Parser_AST.SetOptions s ->
        ...
        let uu____3453 =
          let uu____3454 =
            let uu____3455 = str s in
            FStar_Pprint.dquotes uu____3455
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3454
        in
    ...
    | FStar_Parser_AST.ResetOptions s_opt ->
        ...
        let uu____3460 =
          FStar_Pprint.optional
            (fun s ->
              let uu____3464 =
                let uu____3465 = str s in
                FStar_Pprint.dquotes uu____3465
              in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3464 )
            s_opt
        in
...
and p_fsdocTypeDeclPairs
    : ( FStar_Parser_AST.tycon
      ...
      FStar_Pervasives_Native.tuple2 -> FStar_Pprint.document =
  fun uu____3489 ->
    match uu____3489 with typedecl, fsdoc_opt ->
...
and p_typeDecl : FStar_Parser_AST.tycon -> FStar_Pprint.document =
  fun uu___55_3504 ->
    ...
    | FStar_Parser_AST.TyconAbbrev (lid, bs, typ_opt, t) ->
        let f uu____3535 =
          let uu____3536 = p_typ t in
          prefix2 FStar_Pprint.equals uu____3536
        in
        p_typeDeclPrefix lid bs typ_opt f
    | FStar_Parser_AST.TyconRecord (lid, bs, typ_opt, record_field_decls) ->
        let p_recordFieldAndComments uu____3580 =
          match uu____3580 with lid1, t, doc_opt ->
            let uu____3596 =
            ...
            let uu____3612 =
              let uu____3613 =
                ...
                FStar_Pprint.separate_map uu____3614 p_recordFieldAndComments
                  record_field_decls
              in
              braces_with_nesting uu____3613
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3612
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.equals uu____3611
        in
        p_typeDeclPrefix lid bs typ_opt p_fields
    | FStar_Parser_AST.TyconVariant (lid, bs, typ_opt, ct_decls) ->
        let p_constructorBranchAndComments uu____3678 =
          match uu____3678 with uid, t_opt, doc_opt, use_of ->
            let range =
              let uu____3704 =
                let uu____3705 =
                  FStar_Util.map_opt t_opt (fun t -> t.FStar_Parser_AST.range)
                in
                FStar_Util.dflt uid.FStar_Ident.idRange uu____3705
              in
              FStar_Range.extend_to_end_of_line uu____3704
            in
            let p_constructorBranch decl =
              let uu____3738 =
                let uu____3739 =
                  let uu____3740 = p_constructorDecl decl in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3740
                in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.bar uu____3739
              in
        ...
        in
        p_typeDeclPrefix lid bs typ_opt (fun uu____3776 ->
            let uu____3777 = datacon_doc () in
            prefix2 FStar_Pprint.equals uu____3777 )


and p_typeDeclPrefix
    : FStar_Ident.ident -> FStar_Parser_AST.binder Prims.list
      -> FStar_Parser_AST.knd FStar_Pervasives_Native.option
      -> (Prims.unit -> FStar_Pprint.document) -> FStar_Pprint.document =
  fun lid bs typ_opt cont ->
    if bs = [] && typ_opt = FStar_Pervasives_Native.None then
      let uu____3792 = p_ident lid in
      let uu____3793 =
        let uu____3794 = cont () in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3794
      in
            ...
            (fun t ->
              let uu____3802 =
                let uu____3803 =
                  ...
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3804
                in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____3803
              in
              FStar_Pprint.op_Hat_Hat break1 uu____3802 )
            typ_opt
        in
      ...
      FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
        uu____3805 binders_doc uu____3806
...
and p_recordFieldDecl
  ...
  fun uu____3807 ->
    match uu____3807 with lid, t, doc_opt ->
      let uu____3823 =
        ...
        let uu____3825 =
          ...
          let uu____3827 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____3828
          in
...
and p_constructorDecl
  ...
  fun uu____3829 ->
    match uu____3829 with uid, t_opt, doc_opt, use_of ->
        ...
        let uu____3860 =
          default_or_map uid_doc
            (fun t ->
              let uu____3865 =
                let uu____3866 =
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.space sep
                in
                FStar_Pprint.op_Hat_Hat uid_doc uu____3866
              in
              let uu____3867 = p_typ t in
              op_Hat_Slash_Plus_Hat uu____3865 uu____3867 )
            t_opt
        in
...
and p_letlhs
    : ( FStar_Parser_AST.pattern
      ...
      FStar_Pervasives_Native.tuple2 -> FStar_Pprint.document =
  fun uu____3868 ->
    match uu____3868 with pat, uu____3874 ->
      let uu____3875 =
            ...
            let uu____3886 =
              let uu____3887 =
                let uu____3888 =
                  ...
                  in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____3889
                in
                FStar_Pprint.group uu____3888
              in
              FStar_Pprint.op_Hat_Hat break1 uu____3887
            in
            (pat1, uu____3886)
        | uu____3891 -> (pat, FStar_Pprint.empty)
      in
      match uu____3875 with pat1, ascr_doc ->
        match pat1.FStar_Parser_AST.pat with
        | FStar_Parser_AST.PatApp
            ( { FStar_Parser_AST.pat= FStar_Parser_AST.PatVar (x, uu____3895)
              ; FStar_Parser_AST.prange= uu____3896; _ }
            , pats ) ->
            let uu____3906 =
              let uu____3907 = p_lident x in
              let uu____3908 =
                let uu____3909 =
                  separate_map_or_flow break1 p_atomicPattern pats
                in
                FStar_Pprint.op_Hat_Hat uu____3909 ascr_doc
              in
              FStar_Pprint.op_Hat_Slash_Hat uu____3907 uu____3908
            in
            FStar_Pprint.group uu____3906
        | uu____3910 ->
            let uu____3911 =
              let uu____3912 = p_tuplePattern pat1 in
              FStar_Pprint.op_Hat_Hat uu____3912 ascr_doc
            in
...
and p_letbinding
    : ( FStar_Parser_AST.pattern
      ...
      FStar_Pervasives_Native.tuple2 -> FStar_Pprint.document =
  fun uu____3913 ->
    match uu____3913 with pat, e ->
      let pat_doc = p_letlhs (pat, e) in
      let uu____3921 =
        let uu____3922 =
          FStar_Pprint.op_Hat_Slash_Hat pat_doc FStar_Pprint.equals
        in
        FStar_Pprint.group uu____3922
      in
      let uu____3923 = p_term e in
      prefix2 uu____3921 uu____3923
...
and p_effectRedefinition
  ...
  fun uid bs t ->
    ...
    let uu____3951 =
      ...
      prefix2 FStar_Pprint.equals uu____3952
    in
    FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
...
and p_effectDefinition
    : FStar_Ident.ident -> FStar_Parser_AST.binder Prims.list
      -> FStar_Parser_AST.term -> FStar_Parser_AST.decl Prims.list
      -> FStar_Pprint.document =
  fun uid bs t eff_decls ->
    let uu____3961 =
      let uu____3962 =
        let uu____3963 =
          ...
          let uu____3966 =
            ...
            prefix2 FStar_Pprint.colon uu____3967
          in
          FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
            uu____3964 uu____3965 uu____3966
        in
      ...
      let uu____3968 =
        ...
        in
        prefix2 uu____3969 uu____3970
      in
      FStar_Pprint.op_Hat_Slash_Hat uu____3962 uu____3968
    in
    ...
    | FStar_Parser_AST.Tycon
        ...
        let uu____4000 =
          ...
          let uu____4002 =
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.equals
          in
          FStar_Pprint.op_Hat_Hat uu____4001 uu____4002
        in
        let uu____4003 = p_simpleTerm e in
        prefix2 uu____4000 uu____4003
    | uu____4004 ->
        let uu____4005 =
  ...
  fun lift ->
    let lift_op_doc =
      let lifts =
        ...
        | FStar_Parser_AST.ReifiableLift (t1, t2) ->
            [("lif_wp", t1); ("lift", t2)]
        | FStar_Parser_AST.LiftForFree t -> [("lift", t)]
      in
      let p_lift uu____4061 =
        match uu____4061 with kwd, t ->
          let uu____4068 =
          ...
          in
          let uu____4071 = p_simpleTerm t in
          prefix2 uu____4068 uu____4071
      in
    ...
    let uu____4076 =
      let uu____4077 =
        ...
        in
        FStar_Pprint.op_Hat_Hat uu____4078 uu____4079
      in
      let uu____4081 = p_quident lift.FStar_Parser_AST.mdest in
      prefix2 uu____4077 uu____4081
    in
    let uu____4082 =
      let uu____4083 = braces_with_nesting lift_op_doc in
      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4083
    in
    ...
    | FStar_Parser_AST.PatOr pats ->
        let uu____4095 =
          let uu____4096 =
            ...
            in
            FStar_Pprint.op_Hat_Hat break1 uu____4097
          in
          FStar_Pprint.separate_map uu____4096 p_tuplePattern pats
        in
...
and p_tuplePattern : FStar_Parser_AST.pattern -> FStar_Pprint.document =
  fun p ->
    ...
    | FStar_Parser_AST.PatTuple (pats, false) ->
        let uu____4105 =
          let uu____4106 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          FStar_Pprint.separate_map uu____4106 p_constructorPattern pats
        in
  ...
  fun p ->
    ...
    | FStar_Parser_AST.PatApp
        ( { FStar_Parser_AST.pat= FStar_Parser_AST.PatName maybe_cons_lid
          ; FStar_Parser_AST.prange= uu____4110; _ }
        , [hd1; tl1] )
      when FStar_Ident.lid_equals maybe_cons_lid FStar_Parser_Const.cons_lid ->
        let uu____4115 =
    ...
    | FStar_Parser_AST.PatApp
        ( { FStar_Parser_AST.pat= FStar_Parser_AST.PatName uid
          ; FStar_Parser_AST.prange= uu____4119; _ }
        , pats ) ->
...
and p_atomicPattern : FStar_Parser_AST.pattern -> FStar_Pprint.document =
  fun p ->
    ...
    | FStar_Parser_AST.PatAscribed (pat, t) -> (
        let uu____4131 =
          let uu____4136 =
            let uu____4137 = unparen t in
            uu____4137.FStar_Parser_AST.tm
          in
          (pat.FStar_Parser_AST.pat, uu____4136)
        in
        ...
        | ( FStar_Parser_AST.PatVar (lid, aqual)
          , FStar_Parser_AST.Refine
              ( { FStar_Parser_AST.b= FStar_Parser_AST.Annotated (lid', t1)
                ...
                ; FStar_Parser_AST.aqual= uu____4144; _ }
              , phi ) )
          when lid.FStar_Ident.idText = lid'.FStar_Ident.idText ->
            let uu____4150 =
              let uu____4151 = p_ident lid in
              p_refinement aqual uu____4151 t1 phi
            in
        ...
        | ( FStar_Parser_AST.PatWild
          , FStar_Parser_AST.Refine
              ( { FStar_Parser_AST.b= FStar_Parser_AST.NoName t1
                ...
                ; FStar_Parser_AST.aqual= uu____4155; _ }
              , phi ) ) ->
            let uu____4157 =
              p_refinement FStar_Pervasives_Native.None FStar_Pprint.underscore
                t1 phi
            in
        ...
        | uu____4158 ->
            let uu____4163 =
              ...
              let uu____4165 =
                let uu____4166 = FStar_Pprint.break_ (Prims.parse_int "0") in
                let uu____4167 =
                  let uu____4168 = p_typ t in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4168
                in
                FStar_Pprint.op_Hat_Hat uu____4166 uu____4167
              in
              FStar_Pprint.op_Hat_Hat uu____4164 uu____4165
            in
            soft_parens_with_nesting uu____4163 )
    | FStar_Parser_AST.PatList pats ->
        let uu____4172 =
          separate_break_map FStar_Pprint.semi p_tuplePattern pats
        in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          FStar_Pprint.lbracket uu____4172 FStar_Pprint.rbracket
    | FStar_Parser_AST.PatRecord pats ->
        let p_recordFieldPat uu____4187 =
          match uu____4187 with lid, pat ->
    ...
    | FStar_Parser_AST.PatTuple (pats, true) ->
        ...
        in
        let uu____4207 =
          separate_break_map FStar_Pprint.comma p_constructorPattern pats
        in
        let uu____4208 =
    ...
    | FStar_Parser_AST.PatOp op ->
        let uu____4219 =
          let uu____4220 =
            ...
            in
            FStar_Pprint.op_Hat_Hat uu____4221 uu____4222
          in
    ...
    | FStar_Parser_AST.PatApp
        ( { FStar_Parser_AST.pat= FStar_Parser_AST.PatName uu____4236
          ; FStar_Parser_AST.prange= uu____4237; _ }
        , uu____4238 ) ->
    ...
    | uu____4250 ->
        let uu____4251 =
          ...
          FStar_Util.format1 "Invalid pattern %s" uu____4252
        in
        failwith uu____4251
...
and p_binder : Prims.bool -> FStar_Parser_AST.binder -> FStar_Pprint.document =
  fun is_atomic b ->
    ...
    | FStar_Parser_AST.Annotated (lid, t) ->
        let doc1 =
          let uu____4262 =
            let uu____4263 = unparen t in
            uu____4263.FStar_Parser_AST.tm
          in
          ...
          | FStar_Parser_AST.Refine
              ( { FStar_Parser_AST.b= FStar_Parser_AST.Annotated (lid', t1)
                ...
                ; FStar_Parser_AST.aqual= uu____4268; _ }
              , phi )
            when lid.FStar_Ident.idText = lid'.FStar_Ident.idText ->
          ...
          | uu____4271 ->
              ...
              let uu____4273 =
                ...
                let uu____4275 =
                  let uu____4276 =
                    let uu____4277 =
                      FStar_Pprint.break_ (Prims.parse_int "0")
                    in
                    let uu____4278 = p_tmFormula t in
                    FStar_Pprint.op_Hat_Hat uu____4277 uu____4278
                  in
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4276
                in
        ...
        if is_atomic then
          let uu____4279 =
            let uu____4280 =
              FStar_Pprint.op_Hat_Hat doc1 FStar_Pprint.rparen
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____4280
          in
          FStar_Pprint.group uu____4279
        else FStar_Pprint.group doc1
    | FStar_Parser_AST.TAnnotated uu____4282 -> failwith "Is this still used ?"
    | FStar_Parser_AST.NoName t ->
        let uu____4288 =
          let uu____4289 = unparen t in
          uu____4289.FStar_Parser_AST.tm
        in
        ...
        | FStar_Parser_AST.Refine
            ( { FStar_Parser_AST.b= FStar_Parser_AST.NoName t1
              ...
              ; FStar_Parser_AST.aqual= uu____4293; _ }
            , phi ) ->
            if is_atomic then
              let uu____4295 =
                let uu____4296 =
                ...
                in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____4296
              in
              FStar_Pprint.group uu____4295
            else
              let uu____4299 =
                p_refinement b.FStar_Parser_AST.aqual FStar_Pprint.underscore
                  t1 phi
              in
...
and p_refinement
    : FStar_Parser_AST.arg_qualifier FStar_Pervasives_Native.option
      -> FStar_Pprint.document -> FStar_Parser_AST.term
      -> FStar_Parser_AST.term -> FStar_Pprint.document =
  fun aqual_opt binder t phi ->
      ...
      let uu____4310 =
        let uu____4311 =
          ...
          let uu____4313 =
            ...
            soft_braces_with_nesting uu____4314
          in
          FStar_Pprint.op_Hat_Hat uu____4312 uu____4313
        in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4311
      in
      FStar_Pprint.op_Hat_Hat binder uu____4310
    in
...
and p_binders
  ...
  fun is_atomic bs -> separate_map_or_flow break1 (p_binder is_atomic) bs
...
and p_lidentOrUnderscore : FStar_Ident.ident -> FStar_Pprint.document =
  fun id1 ->
    if FStar_Util.starts_with FStar_Ident.reserved_prefix
...
and p_term : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____4328 =
      let uu____4329 = unparen e in
      uu____4329.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.Seq (e1, e2) ->
        let uu____4332 =
          let uu____4333 =
            ...
            FStar_Pprint.op_Hat_Hat uu____4334 FStar_Pprint.semi
          in
        ...
        let uu____4339 =
          let uu____4340 =
            ...
            let uu____4344 =
              ...
              in
              FStar_Pprint.op_Hat_Hat uu____4345 uu____4346
            in
            op_Hat_Slash_Plus_Hat uu____4341 uu____4344
          in
          FStar_Pprint.group uu____4340
        in
        let uu____4347 = p_term e2 in
        FStar_Pprint.op_Hat_Slash_Hat uu____4339 uu____4347
    | uu____4348 ->
        let uu____4349 = p_noSeqTerm e in
...
and p_noSeqTerm' : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____4352 =
      let uu____4353 = unparen e in
      uu____4353.FStar_Parser_AST.tm
    in
        ...
        let uu____4358 =
          ...
          let uu____4360 =
            let uu____4361 =
              ...
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____4362
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.langle uu____4361
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4359 uu____4360
        in
            ...
            let uu____4371 =
              let uu____4372 =
                ...
                let uu____4374 =
                  ...
                  FStar_Pprint.op_Hat_Slash_Hat uu____4375 uu____4376
                in
                FStar_Pprint.op_Hat_Slash_Hat uu____4373 uu____4374
              in
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____4372
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.langle uu____4371
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4369 uu____4370
        in
        FStar_Pprint.group uu____4368
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= ".()<-"; FStar_Ident.idRange= uu____4377; _}
        , [e1; e2; e3] ) ->
        let uu____4383 =
          let uu____4384 =
            let uu____4385 =
              ...
              let uu____4387 =
                let uu____4388 =
                  let uu____4389 =
                    ...
                    soft_parens_with_nesting uu____4390
                  in
                  let uu____4391 =
                    FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                      FStar_Pprint.larrow
                  in
                  FStar_Pprint.op_Hat_Hat uu____4389 uu____4391
                in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____4388
              in
              FStar_Pprint.op_Hat_Hat uu____4386 uu____4387
            in
            FStar_Pprint.group uu____4385
          in
          let uu____4392 =
            let uu____4393 = p_noSeqTerm e3 in
            jump2 uu____4393
          in
          FStar_Pprint.op_Hat_Hat uu____4384 uu____4392
        in
        FStar_Pprint.group uu____4383
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= ".[]<-"; FStar_Ident.idRange= uu____4394; _}
        , [e1; e2; e3] ) ->
        let uu____4400 =
          let uu____4401 =
            let uu____4402 =
              ...
              let uu____4404 =
                let uu____4405 =
                  let uu____4406 =
                    ...
                    soft_brackets_with_nesting uu____4407
                  in
                  let uu____4408 =
                    FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                      FStar_Pprint.larrow
                  in
                  FStar_Pprint.op_Hat_Hat uu____4406 uu____4408
                in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____4405
              in
              FStar_Pprint.op_Hat_Hat uu____4403 uu____4404
            in
            FStar_Pprint.group uu____4402
          in
          let uu____4409 =
            let uu____4410 = p_noSeqTerm e3 in
            jump2 uu____4410
          in
          FStar_Pprint.op_Hat_Hat uu____4401 uu____4409
        in
    ...
    | FStar_Parser_AST.Requires (e1, wtf) ->
        let uu____4420 =
          ...
          FStar_Pprint.op_Hat_Slash_Hat uu____4421 uu____4422
        in
    ...
    | FStar_Parser_AST.Ensures (e1, wtf) ->
        let uu____4432 =
          ...
          FStar_Pprint.op_Hat_Slash_Hat uu____4433 uu____4434
        in
        FStar_Pprint.group uu____4432
    | FStar_Parser_AST.Attributes es ->
        let uu____4438 =
          let uu____4439 = str "attributes" in
          let uu____4440 = FStar_Pprint.separate_map break1 p_atomicTerm es in
          FStar_Pprint.op_Hat_Slash_Hat uu____4439 uu____4440
        in
        ...
        if uu____4444 then
          let uu____4445 =
            let uu____4446 =
              ...
              op_Hat_Slash_Plus_Hat uu____4447 uu____4448
            in
            let uu____4449 =
              let uu____4450 = str "then" in
              let uu____4451 = p_noSeqTerm e2 in
              op_Hat_Slash_Plus_Hat uu____4450 uu____4451
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4446 uu____4449
          in
          FStar_Pprint.group uu____4445
        else
          let e2_doc =
            let uu____4454 =
              let uu____4455 = unparen e2 in
              uu____4455.FStar_Parser_AST.tm
            in
            match uu____4454 with
            | FStar_Parser_AST.If (uu____4456, uu____4457, e31)
              when is_unit e31 ->
                let uu____4459 = p_noSeqTerm e2 in
                soft_parens_with_nesting uu____4459
            | uu____4460 -> p_noSeqTerm e2
          in
          let uu____4461 =
            let uu____4462 =
              let uu____4463 = str "if" in
              let uu____4464 = p_noSeqTerm e1 in
              op_Hat_Slash_Plus_Hat uu____4463 uu____4464
            in
            let uu____4465 =
              let uu____4466 =
                let uu____4467 = str "then" in
                op_Hat_Slash_Plus_Hat uu____4467 e2_doc
              in
              let uu____4468 =
                let uu____4469 = str "else" in
                let uu____4470 = p_noSeqTerm e3 in
                op_Hat_Slash_Plus_Hat uu____4469 uu____4470
              in
              FStar_Pprint.op_Hat_Slash_Hat uu____4466 uu____4468
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4462 uu____4465
          in
    ...
    | FStar_Parser_AST.TryWith (e1, branches) ->
        let uu____4493 =
          let uu____4494 =
            ...
            let uu____4496 = p_noSeqTerm e1 in
            prefix2 uu____4495 uu____4496
          in
          let uu____4497 =
            ...
            let uu____4499 =
              FStar_Pprint.separate_map FStar_Pprint.hardline p_patternBranch
                branches
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4498 uu____4499
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4494 uu____4497
        in
        ...
        let uu____4530 =
          ...
          let uu____4535 =
            FStar_Pprint.separate_map FStar_Pprint.hardline p_patternBranch
              branches
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4531 uu____4535
        in
    ...
    | FStar_Parser_AST.LetOpen (uid, e1) ->
        let uu____4546 =
          ...
          FStar_Pprint.op_Hat_Slash_Hat uu____4547 uu____4551
        in
    ...
    | FStar_Parser_AST.Let (q, (a0, lb0) :: attr_letbindings, e1) ->
          ...
          let uu____4615 =
            let uu____4616 =
              ...
              let uu____4618 =
                ...
                FStar_Pprint.op_Hat_Slash_Hat uu____4619 uu____4620
              in
              FStar_Pprint.op_Hat_Slash_Hat uu____4617 uu____4618
            in
            FStar_Pprint.group uu____4616
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4614 uu____4615
        in
        let let_rest =
        ...
        let uu____4662 =
          let uu____4663 =
            ...
            FStar_Pprint.op_Hat_Slash_Hat uu____4664 uu____4665
          in
          FStar_Pprint.op_Hat_Slash_Hat let_rest uu____4663
        in
        FStar_Pprint.op_Hat_Slash_Hat let_first uu____4662
    | FStar_Parser_AST.Abs
        ( [ { FStar_Parser_AST.pat= FStar_Parser_AST.PatVar (x, typ_opt)
            ; FStar_Parser_AST.prange= uu____4668; _ } ]
        , { FStar_Parser_AST.tm= FStar_Parser_AST.Match (maybe_x, branches)
          ; FStar_Parser_AST.range= uu____4671
          ; FStar_Parser_AST.level= uu____4672; _ } )
        ...
        let uu____4699 =
          ...
          let uu____4701 =
            FStar_Pprint.separate_map FStar_Pprint.hardline p_patternBranch
              branches
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4700 uu____4701
        in
    ...
    | FStar_Parser_AST.Assign (id1, e1) ->
        let uu____4712 =
          ...
          let uu____4714 =
            ...
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.larrow uu____4715
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4713 uu____4714
        in
  ...
  fun uu___60_4717 ->
    ...
    | FStar_Pervasives_Native.Some terms ->
        let uu____4729 =
          ...
          let uu____4731 =
            let uu____4732 =
              FStar_Pprint.separate_map FStar_Pprint.semi p_term terms
            in
            let uu____4733 = str "]" in
            FStar_Pprint.op_Hat_Slash_Hat uu____4732 uu____4733
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____4730 uu____4731
        in
        ...
        let uu____4765 =
          let uu____4766 =
            ...
            let uu____4768 =
              FStar_Pprint.op_Hat_Slash_Hat pat_doc FStar_Pprint.equals
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4767 uu____4768
          in
          FStar_Pprint.group uu____4766
        in
        FStar_Pprint.op_Hat_Slash_Hat uu____4764 uu____4765
      in
      let uu____4769 = p_term e in
      prefix2 uu____4763 uu____4769
...
and p_typ' : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____4772 =
      let uu____4773 = unparen e in
      uu____4773.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.QForall (bs, trigger, e1) ->
        let uu____4789 =
          let uu____4790 =
            ...
            FStar_Pprint.op_Hat_Hat uu____4791 FStar_Pprint.space
          in
    ...
    | FStar_Parser_AST.QExists (bs, trigger, e1) ->
        let uu____4811 =
          let uu____4812 =
            ...
            FStar_Pprint.op_Hat_Hat uu____4813 FStar_Pprint.space
          in
        ...
        let uu____4815 =
          ...
          FStar_Pprint.op_Hat_Hat uu____4816 uu____4817
        in
...
and p_quantifier : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____4820 =
      let uu____4821 = unparen e in
      uu____4821.FStar_Parser_AST.tm
    in
    ...
    | pats ->
        let uu____4861 =
          let uu____4862 =
            ...
            let uu____4864 =
              let uu____4865 =
                let uu____4866 = p_disjunctivePats pats in
                jump2 uu____4866
              in
              let uu____4867 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.rbrace break1
              in
              FStar_Pprint.op_Hat_Slash_Hat uu____4865 uu____4867
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4863 uu____4864
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4862
        in
...
and p_simpleTerm : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____4881 =
      let uu____4882 = unparen e in
      uu____4882.FStar_Parser_AST.tm
    in
        ...
        let uu____4889 =
          ...
          let uu____4891 =
            let uu____4892 =
              FStar_Pprint.separate_map break1 p_atomicPattern pats
            in
            FStar_Pprint.op_Hat_Slash_Hat uu____4892 FStar_Pprint.rarrow
          in
          op_Hat_Slash_Plus_Hat uu____4890 uu____4891
        in
...
and p_patternBranch
    : ( FStar_Parser_AST.pattern
      ...
      FStar_Pervasives_Native.tuple3 -> FStar_Pprint.document =
  fun uu____4897 ->
    match uu____4897 with pat, when_opt, e ->
      let maybe_paren =
        let uu____4916 =
          let uu____4917 = unparen e in
          uu____4917.FStar_Parser_AST.tm
        in
        match uu____4916 with
        | FStar_Parser_AST.Match uu____4920 -> soft_begin_end_with_nesting
        | FStar_Parser_AST.TryWith uu____4935 -> soft_begin_end_with_nesting
        | FStar_Parser_AST.Abs
            ( [ { FStar_Parser_AST.pat= FStar_Parser_AST.PatVar (x, uu____4951)
                ; FStar_Parser_AST.prange= uu____4952; _ } ]
            , { FStar_Parser_AST.tm=
                  FStar_Parser_AST.Match (maybe_x, uu____4954)
              ; FStar_Parser_AST.range= uu____4955
              ; FStar_Parser_AST.level= uu____4956; _ } )
          when matches_var maybe_x x ->
          ...
          let uu____4987 =
            let uu____4988 =
              let uu____4989 =
                ...
                in
                op_Hat_Slash_Plus_Hat uu____4990 uu____4991
              in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4989
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.bar uu____4988
          in
          FStar_Pprint.group uu____4987
        in
        let uu____4993 =
          let uu____4994 = p_term e in
          maybe_paren uu____4994
        in
        op_Hat_Slash_Plus_Hat uu____4986 uu____4993
      in
  ...
  fun uu___62_4995 ->
    ...
    | FStar_Pervasives_Native.Some e ->
        ...
        let uu____5000 =
          ...
          FStar_Pprint.op_Hat_Hat uu____5001 FStar_Pprint.space
        in
...
and p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5003 =
      let uu____5004 = unparen e in
      uu____5004.FStar_Parser_AST.tm
    in
    match uu____5003 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "<==>"; FStar_Ident.idRange= uu____5005; _}
        , [e1; e2] ) ->
...
and p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5015 =
      let uu____5016 = unparen e in
      uu____5016.FStar_Parser_AST.tm
    in
    match uu____5015 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "==>"; FStar_Ident.idRange= uu____5017; _}
        , [e1; e2] ) ->
...
and p_tmArrow
    : (FStar_Parser_AST.term -> FStar_Pprint.document) -> FStar_Parser_AST.term
      -> FStar_Pprint.document =
  fun p_Tm e ->
    let uu____5030 =
      let uu____5031 = unparen e in
      uu____5031.FStar_Parser_AST.tm
    in
          ...
          let uu____5039 =
            separate_map_or_flow FStar_Pprint.empty
              (fun b ->
                ...
                in
                FStar_Pprint.op_Hat_Hat uu____5044 uu____5045 )
              bs
          in
          let uu____5047 = p_tmArrow p_Tm tgt in
          FStar_Pprint.op_Hat_Hat uu____5039 uu____5047
        in
...
and p_tmFormula : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5050 =
      let uu____5051 = unparen e in
      uu____5051.FStar_Parser_AST.tm
    in
    match uu____5050 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "\\/"; FStar_Ident.idRange= uu____5052; _}
        , [e1; e2] ) ->
...
and p_tmConjunction : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5062 =
      let uu____5063 = unparen e in
      uu____5063.FStar_Parser_AST.tm
    in
    match uu____5062 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "/\\"; FStar_Ident.idRange= uu____5064; _}
        , [e1; e2] ) ->
...
and p_tmTuple' : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5075 =
      let uu____5076 = unparen e in
      uu____5076.FStar_Parser_AST.tm
    in
    match uu____5075 with
    | FStar_Parser_AST.Construct (lid, args) when is_tuple_constructor lid ->
        let uu____5091 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
        FStar_Pprint.separate_map uu____5091
          (fun uu____5099 ->
            match uu____5099 with e1, uu____5105 -> p_tmEq e1 )
          args
    | uu____5106 -> p_tmEq e
...
and paren_if
  ...
  fun curr mine doc1 ->
    if mine <= curr then doc1
    else
      let uu____5111 =
        let uu____5112 = FStar_Pprint.op_Hat_Hat doc1 FStar_Pprint.rparen in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____5112
      in
...
and p_tmEq' : Prims.int -> FStar_Parser_AST.term -> FStar_Pprint.document =
  fun curr e ->
    let uu____5163 =
      let uu____5164 = unparen e in
      uu____5164.FStar_Parser_AST.tm
    in
    match uu____5163 with
    | FStar_Parser_AST.Op (op, [e1; e2])
      when (is_operatorInfix0ad12 op || FStar_Ident.text_of_id op = "=")
           || FStar_Ident.text_of_id op = "|>"
      -> (
        let op1 = FStar_Ident.text_of_id op in
        let uu____5171 = levels op1 in
        match uu____5171 with left1, mine, right1 ->
          let uu____5181 =
    ...
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= ":="; FStar_Ident.idRange= uu____5185; _}
        , [e1; e2] ) ->
        let uu____5190 =
          ...
          let uu____5192 =
            let uu____5193 =
              let uu____5194 =
                ...
                op_Hat_Slash_Plus_Hat FStar_Pprint.equals uu____5195
              in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____5194
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5193
          in
          FStar_Pprint.op_Hat_Hat uu____5191 uu____5192
        in
    ...
    | FStar_Parser_AST.Op
      ...
      -> (
        ...
        match uu____5200 with left1, mine, right1 ->
...
and p_tmNoEq' : Prims.int -> FStar_Parser_AST.term -> FStar_Pprint.document =
  fun curr e ->
    let uu____5274 =
      let uu____5275 = unparen e in
      uu____5275.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.Construct (lid, [(e1, uu____5278); (e2, uu____5280)])
      when FStar_Ident.lid_equals lid FStar_Parser_Const.cons_lid
           &&
           let uu____5300 = is_list e in
           Prims.op_Negation uu____5300
      -> (
        let op = "::" in
        let uu____5302 = levels op in
        match uu____5302 with left1, mine, right1 ->
          let uu____5312 =
    ...
    | FStar_Parser_AST.Sum (binders, res) -> (
        ...
        match uu____5323 with left1, mine, right1 ->
          let p_dsumfst b =
            let uu____5337 = p_binder false b in
            let uu____5338 =
              let uu____5339 =
                let uu____5340 = str op in
                FStar_Pprint.op_Hat_Hat uu____5340 break1
              in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5339
            in
            FStar_Pprint.op_Hat_Hat uu____5337 uu____5338
          in
          let uu____5341 =
            let uu____5342 = FStar_Pprint.concat_map p_dsumfst binders in
            let uu____5343 = p_tmNoEq' right1 res in
            FStar_Pprint.op_Hat_Hat uu____5342 uu____5343
          in
          paren_if curr mine uu____5341 )
    | FStar_Parser_AST.Op (op, [e1; e2]) when is_operatorInfix34 op -> (
        let op1 = FStar_Ident.text_of_id op in
        let uu____5350 = levels op1 in
        match uu____5350 with left1, mine, right1 ->
          let uu____5360 =
            let uu____5361 = str op1 in
            let uu____5362 = p_tmNoEq' left1 e1 in
            let uu____5363 = p_tmNoEq' right1 e2 in
            infix0 uu____5361 uu____5362 uu____5363
          in
    ...
    | FStar_Parser_AST.NamedTyp (lid, e1) ->
        let uu____5366 =
          ...
          let uu____5368 =
            ...
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____5369
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____5367 uu____5368
        in
    ...
    | FStar_Parser_AST.Record (with_opt, record_fields) ->
        let uu____5390 =
          ...
          in
          FStar_Pprint.op_Hat_Hat uu____5391 uu____5392
        in
  ...
  fun e ->
    ...
    let uu____5408 =
      let uu____5409 =
        ...
        FStar_Pprint.op_Hat_Hat uu____5410 break1
      in
      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5409
    in
  ...
  fun b phi ->
    ...
    | FStar_Parser_AST.Annotated (lid, t) ->
        let uu____5415 =
          ...
          p_refinement b.FStar_Parser_AST.aqual uu____5416 t phi
        in
        soft_parens_with_nesting uu____5415
    | FStar_Parser_AST.TAnnotated uu____5417 -> failwith "Is this still used ?"
    | FStar_Parser_AST.Variable uu____5422 ->
        let uu____5423 =
          let uu____5424 = FStar_Parser_AST.binder_to_string b in
          FStar_Util.format1
            "Imposible : a refined binder ought to be annotated %s" uu____5424
        in
        failwith uu____5423
    | FStar_Parser_AST.TVariable uu____5425 ->
        let uu____5426 =
          ...
          FStar_Util.format1
            "Imposible : a refined binder ought to be annotated %s" uu____5427
        in
        failwith uu____5426
    | FStar_Parser_AST.NoName uu____5428 ->
        let uu____5429 =
          ...
          FStar_Util.format1
            "Imposible : a refined binder ought to be annotated %s" uu____5430
        in
        failwith uu____5429
...
and p_simpleDef
    : (FStar_Ident.lid, FStar_Parser_AST.term) FStar_Pervasives_Native.tuple2
      -> FStar_Pprint.document =
  fun uu____5431 ->
    match uu____5431 with lid, e ->
      let uu____5438 =
        let uu____5439 = p_qlident lid in
        let uu____5440 =
          let uu____5441 = p_tmIff e in
          FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.equals uu____5441
        in
        FStar_Pprint.op_Hat_Slash_Hat uu____5439 uu____5440
      in
...
and p_appTerm : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
          ...
          let uu____5477 =
            ...
            if uu____5488 then
              let uu____5518 =
                FStar_Util.take
                  (fun uu____5542 ->
                    match uu____5542 with uu____5547, aq ->
                      aq = FStar_Parser_AST.FsTypApp )
                  args
              in
              match uu____5518 with fs_typ_args, args1 ->
                let uu____5585 =
                  ...
                  in
                  FStar_Pprint.op_Hat_Hat uu____5586 uu____5587
                in
                (uu____5585, args1)
            else
              ...
              (uu____5600, args)
          in
          match uu____5477 with head_doc, args1 ->
            let uu____5621 =
              let uu____5622 =
    ...
    | FStar_Parser_AST.Construct (lid, args)
      when is_general_construction e
           &&
      ...
      | [arg] ->
          let uu____5660 =
            ...
            FStar_Pprint.op_Hat_Slash_Hat uu____5661 uu____5662
          in
          ...
          let uu____5679 =
            let uu____5680 =
              let uu____5681 =
                ...
                prefix2 uu____5682 uu____5683
              in
              FStar_Pprint.group uu____5681
            in
            let uu____5684 =
              let uu____5685 =
                FStar_Pprint.separate_map break1 p_argTerm tl1
              in
              jump2 uu____5685
            in
            FStar_Pprint.op_Hat_Hat uu____5680 uu____5684
          in
...
and p_fsTypArg
    : ( FStar_Parser_AST.term
      , FStar_Parser_AST.imp )
      FStar_Pervasives_Native.tuple2 -> FStar_Pprint.document =
  fun uu____5704 -> match uu____5704 with e, uu____5710 -> p_indexingTerm e
...
and p_indexingTerm_aux
  ...
  fun exit1 e ->
    let uu____5715 =
      let uu____5716 = unparen e in
      uu____5716.FStar_Parser_AST.tm
    in
    match uu____5715 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= ".()"; FStar_Ident.idRange= uu____5717; _}
        , [e1; e2] ) ->
        let uu____5722 =
          ...
          let uu____5724 =
            let uu____5725 =
              ...
              soft_parens_with_nesting uu____5726
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5725
          in
          FStar_Pprint.op_Hat_Hat uu____5723 uu____5724
        in
        FStar_Pprint.group uu____5722
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= ".[]"; FStar_Ident.idRange= uu____5727; _}
        , [e1; e2] ) ->
        let uu____5732 =
          ...
          let uu____5734 =
            let uu____5735 =
              ...
              soft_brackets_with_nesting uu____5736
            in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5735
          in
          FStar_Pprint.op_Hat_Hat uu____5733 uu____5734
        in
...
and p_atomicTerm : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5740 =
      let uu____5741 = unparen e in
      uu____5741.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.LetOpen (lid, e1) ->
        ...
        let uu____5745 =
          let uu____5746 =
            ...
            soft_parens_with_nesting uu____5747
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5746
        in
...
and p_atomicTermNotQUident : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5757 =
      let uu____5758 = unparen e in
      uu____5758.FStar_Parser_AST.tm
    in
    match uu____5757 with
    | FStar_Parser_AST.Wild -> FStar_Pprint.underscore
    | FStar_Parser_AST.Var lid
      when FStar_Ident.lid_equals lid FStar_Parser_Const.assert_lid ->
        str "assert"
    ...
    | FStar_Parser_AST.Name lid
      when FStar_Ident.lid_equals lid FStar_Parser_Const.true_lid ->
        str "True"
    | FStar_Parser_AST.Name lid
      when FStar_Ident.lid_equals lid FStar_Parser_Const.false_lid ->
        str "False"
    | FStar_Parser_AST.Op (op, [e1]) when is_general_prefix_op op ->
        ...
        let uu____5776 =
          let uu____5777 =
            ...
            let uu____5779 =
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.rparen
            in
            FStar_Pprint.op_Hat_Hat uu____5778 uu____5779
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5777
        in
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_dtuple_constructor lid ->
        ...
        in
        let uu____5795 =
          let uu____5796 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          let uu____5797 = FStar_List.map FStar_Pervasives_Native.fst args in
          FStar_Pprint.separate_map uu____5796 p_tmEq uu____5797
        in
        let uu____5804 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rparen
        in
    ...
    | FStar_Parser_AST.Project (e1, lid) ->
        let uu____5807 =
          ...
          let uu____5809 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5810
          in
...
and p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e ->
    let uu____5813 =
      let uu____5814 = unparen e in
      uu____5814.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.Projector (constr_lid, field_lid) ->
        ...
        let uu____5819 =
          let uu____5820 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5821
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____5820
        in
    ...
    | FStar_Parser_AST.Paren e1 ->
        let uu____5825 = p_term e1 in
        soft_parens_with_nesting uu____5825
    | uu____5826 when is_array e ->
        let es = extract_from_list e in
        let uu____5830 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lbracket FStar_Pprint.bar
        in
        let uu____5831 =
          let uu____5832 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          separate_map_or_flow uu____5832 p_noSeqTerm es
        in
        let uu____5833 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rbracket
        in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          uu____5830 uu____5831 uu____5833
    | uu____5834 when is_list e ->
        let uu____5835 =
          let uu____5836 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____5837 = extract_from_list e in
          separate_map_or_flow uu____5836 p_noSeqTerm uu____5837
        in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
    ...
    | uu____5840 when is_lex_list e ->
        ...
        in
        let uu____5842 =
          let uu____5843 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____5844 = extract_from_list e in
          separate_map_or_flow uu____5843 p_noSeqTerm uu____5844
        in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
    ...
    | uu____5847 when is_ref_set e ->
        ...
        in
        let uu____5852 =
          let uu____5853 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          separate_map_or_flow uu____5853 p_appTerm es
        in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
    ...
    | FStar_Parser_AST.Op (op, args)
      when let uu____5865 = handleable_op op args in
  ...
  fun uu___65_6111 ->
    ...
    | FStar_Const.Const_int (repr, sign_width_opt) ->
        let signedness uu___63_6145 =
          ...
          | FStar_Const.Signed -> FStar_Pprint.empty
        in
        let width uu___64_6149 =
          ...
          | FStar_Const.Int64 -> str "L"
        in
        let ending =
          default_or_map FStar_Pprint.empty
            (fun uu____6160 ->
              match uu____6160 with s, w ->
    ...
    | FStar_Const.Const_range r ->
        let uu____6171 = FStar_Range.string_of_range r in
        str uu____6171
    ...
    | FStar_Const.Const_reflect lid ->
        ...
        let uu____6174 =
          let uu____6175 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____6176
          in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____6175
        in
...
and p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u ->
    let uu____6181 =
      let uu____6182 = unparen u in
      uu____6182.FStar_Parser_AST.tm
    in
    match uu____6181 with
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "+"; FStar_Ident.idRange= uu____6183; _}
        , [u1; u2] ) ->
        let uu____6188 =
          let uu____6189 = p_universeFrom u1 in
          let uu____6190 =
            let uu____6191 = p_universeFrom u2 in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____6191
          in
          FStar_Pprint.op_Hat_Slash_Hat uu____6189 uu____6190
        in
        FStar_Pprint.group uu____6188
    | FStar_Parser_AST.App uu____6192 -> (
        let uu____6199 = head_and_args u in
        match uu____6199 with head1, args ->
          let uu____6224 =
            let uu____6225 = unparen head1 in
            uu____6225.FStar_Parser_AST.tm
          in
          match uu____6224 with
          | FStar_Parser_AST.Var maybe_max_lid
            when FStar_Ident.lid_equals maybe_max_lid
              ...
              let uu____6227 =
                ...
                let uu____6229 =
                  FStar_Pprint.separate_map FStar_Pprint.space
                    (fun uu____6237 ->
                      match uu____6237 with u1, uu____6243 ->
                        p_atomicUniverse u1 )
                    args
                in
                op_Hat_Slash_Plus_Hat uu____6228 uu____6229
              in
...
and p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun u ->
    let uu____6249 =
      let uu____6250 = unparen u in
      uu____6250.FStar_Parser_AST.tm
    in
    ...
    | FStar_Parser_AST.Op
        ( {FStar_Ident.idText= "+"; FStar_Ident.idRange= uu____6274; _}
  ...
  fun m ->
    ...
    let res =
      ...
      | FStar_Parser_AST.Module (uu____6330, decls) ->
          let uu____6336 =
            FStar_All.pipe_right decls (FStar_List.map decl_to_document)
          in
...
let comments_to_document
    : (Prims.string, FStar_Range.range) FStar_Pervasives_Native.tuple2
      Prims.list -> FStar_Pprint.document =
  fun comments ->
    FStar_Pprint.separate_map FStar_Pprint.hardline
      (fun uu____6403 -> match uu____6403 with comment, range -> str comment)
      comments
  ...
  fun m comments ->
    ...
    | d :: ds ->
        let uu____6496 =
          match ds with
          | { FStar_Parser_AST.d=
                FStar_Parser_AST.Pragma FStar_Parser_AST.LightOff
            ; FStar_Parser_AST.drange= uu____6509
            ; FStar_Parser_AST.doc= uu____6510
            ; FStar_Parser_AST.quals= uu____6511
            ; FStar_Parser_AST.attrs= uu____6512; _ }
            :: uu____6513 ->
              let d0 = FStar_List.hd ds in
              let uu____6519 =
                let uu____6522 =
                  let uu____6525 = FStar_List.tl ds in
                  d :: uu____6525
                in
                d0 :: uu____6522
              in
              (uu____6519, d0.FStar_Parser_AST.drange)
          | uu____6530 -> (d :: ds, d.FStar_Parser_AST.drange)
        in
        match uu____6496 with decls1, first_range ->
          let extract_decl_range d1 = d1.FStar_Parser_AST.drange in
          FStar_ST.op_Colon_Equals comment_stack comments ;
          let initial_comment =
            let uu____6588 = FStar_Range.start_of_range first_range in
            place_comments_until_pos (Prims.parse_int "0")
              (Prims.parse_int "1") uu____6588 FStar_Pprint.empty
          in
          let doc1 =
            separate_map_with_comments FStar_Pprint.empty FStar_Pprint.empty
              decl_to_document decls1 extract_decl_range
          in
          let comments1 = FStar_ST.op_Bang comment_stack in
          FStar_ST.op_Colon_Equals comment_stack [] ;
          FStar_ST.op_Colon_Equals should_print_fs_typ_app false ;
          let uu____6684 = FStar_Pprint.op_Hat_Hat initial_comment doc1 in
