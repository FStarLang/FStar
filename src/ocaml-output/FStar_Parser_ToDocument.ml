    ...
    let uu____1110 =
      FStar_List.tryFind
        (fun uu____1128  ->
           ...
           | (uu____1137,tokens) -> tokens = (snd level)) level_table
       in
...
and p_atomicTerm : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e  ->
    ...
    | FStar_Parser_AST.LetOpen (lid,e1) ->
        ...
        let uu____3564 =
          let uu____3565 =
            let uu____3566 = p_term e1  in
            soft_parens_with_nesting uu____3566  in
  ...
  fun e  ->
    ...
    | FStar_Parser_AST.Construct (lid,args) when is_dtuple_constructor lid ->
        let uu____3603 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen FStar_Pprint.bar  in
        let uu____3604 =
          let uu____3605 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
             in
...
and p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e  ->
    ...
    | uu____3639 when is_list e ->
        let uu____3640 =
          let uu____3641 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
    ...
    | uu____3644 when is_lex_list e ->
        let uu____3645 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.percent FStar_Pprint.lbracket
           in
        let uu____3646 =
          let uu____3647 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
    ...
    | uu____3650 when is_ref_set e ->
        ...
        let uu____3654 =
          let uu____3655 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
             in
                    ...
                    let uu____3909 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____3912  ->
                           ...
                           | (u1,uu____3916) -> p_atomicUniverse u1) args
                       in
  ...
  fun u  ->
    ...
    | uu____3948 ->
        let uu____3949 =
          ...
          FStar_Util.format1 "Invalid term in universe context %s" uu____3950
           in
        failwith uu____3949
  ...
  fun m  ->
    fun comments  ->
      let decls =
        ...
        | FStar_Parser_AST.Interface (uu____4039,decls,uu____4041) -> decls
         in
      FStar_ST.write should_print_fs_typ_app false;
      (match decls with
       ...
       | d::ds ->
           let uu____4058 =
             ...
             | {
                 ...
                 let uu____4073 =
                   let uu____4075 =
                     let uu____4077 = FStar_List.tl ds  in d :: uu____4077
                      in
                   d0 :: uu____4075  in
           ...
           (match uu____4058 with
            | (decls1,first_range) ->
                ...
                (FStar_ST.write comment_stack comments;
                 (let initial_comment =
                    let uu____4103 = FStar_Range.start_of_range first_range
                       in
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____4103 FStar_Pprint.empty
                     in
                  let doc1 =
