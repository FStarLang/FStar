  ...
  fun e  ->
    ...
    | FStar_Parser_AST.Construct (lid,args) when is_dtuple_constructor lid ->
        let uu____3570 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen FStar_Pprint.bar  in
        let uu____3571 =
          let uu____3572 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
             in
...
and p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document =
  fun e  ->
    ...
    | uu____3599 when is_array e ->
        ...
        let uu____3603 =
          let uu____3604 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
    ...
    | uu____3606 when is_list e ->
        let uu____3607 =
          let uu____3608 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
    ...
    | uu____3611 when is_lex_list e ->
        let uu____3612 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.percent FStar_Pprint.lbracket
           in
        let uu____3613 =
          let uu____3614 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
                    ...
                    let uu____3761 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____3764  ->
                           ...
                           | (u1,uu____3768) -> p_atomicUniverse u1) args
                       in
  ...
  fun u  ->
    ...
    | uu____3796 ->
        let uu____3797 =
          ...
          FStar_Util.format1 "Invalid term in universe context %s" uu____3798
           in
        failwith uu____3797
       ...
       | d::ds ->
           let uu____3893 =
             ...
             | {
                 ...
                 let uu____3908 =
                   let uu____3910 =
                     let uu____3912 = FStar_List.tl ds  in d :: uu____3912
                      in
                   d0 :: uu____3910  in
           ...
           (match uu____3893 with
            | (decls1,first_range) ->
                ...
                (FStar_ST.write comment_stack comments;
                 (let initial_comment =
                    let uu____3938 = FStar_Range.start_of_range first_range
                       in
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____3938 FStar_Pprint.empty
                     in
                  let doc1 =
