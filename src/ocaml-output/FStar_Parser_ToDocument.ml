  ...
  fun f  ->
    fun l  ->
      let rec aux l1 acc =
        ...
        | [] -> acc
        | x::xs ->
            let uu___ = let uu___1 = f x  in uu___1 :: acc  in aux xs uu___
         in
      aux l []
      ...
      fun f  ->
        fun l  ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 = FStar_List.hd l  in FStar_All.pipe_right uu___3 f
               in
          ...
          let uu___1 =
            ...
            FStar_Pprint.concat_map
              (fun x  ->
                 ...
                 FStar_Pprint.op_Hat_Hat break1 uu___3) uu___2
             in
  ...
  fun f  ->
    fun l  ->
      let uu___ =
        FStar_Pprint.concat_map
          (fun x  ->
             let uu___1 = f x  in FStar_Pprint.op_Hat_Hat uu___1 break1) l
         in
      FStar_Pprint.group uu___
...
let rec (extract_from_list :
  ...
  fun e  ->
    ...
    | FStar_Parser_AST.Construct
        (uu___,(e1,FStar_Parser_AST.Nothing )::(e2,FStar_Parser_AST.Nothing )::[])
  ...
  fun e  ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var lid;
           FStar_Parser_AST.range = uu___; FStar_Parser_AST.level = uu___1;_},l,FStar_Parser_AST.Nothing
         )
        ->
           ...
           FStar_Parser_AST.range = uu___; FStar_Parser_AST.level = uu___1;_},
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_addr_of_lid;
                ...
                FStar_Parser_AST.level = uu___3;_},e1,FStar_Parser_AST.Nothing
              );
           FStar_Parser_AST.range = uu___4;
           FStar_Parser_AST.level = uu___5;_},FStar_Parser_AST.Nothing
         )
        ->
        ...
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_union_lid;
                ...
                FStar_Parser_AST.level = uu___1;_},e1,FStar_Parser_AST.Nothing
              );
           FStar_Parser_AST.range = uu___2;
           FStar_Parser_AST.level = uu___3;_},e2,FStar_Parser_AST.Nothing
         )
        ->
                                                ...
                                                FStar_Parser_AST.tm =
                                                  ...
                                                  ({
                                                     ...
                                                     FStar_Parser_AST.level =
                                                       uu___5;_},e1,FStar_Parser_AST.Nothing
                                                   );
                                                FStar_Parser_AST.range =
                                                  uu___6;
                                                FStar_Parser_AST.level =
                                                  uu___7;_},FStar_Parser_AST.Nothing
         )
        -> [e1]
    | FStar_Parser_AST.App
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu___;
                FStar_Parser_AST.range = uu___1;
                FStar_Parser_AST.level = uu___2;_},e1,FStar_Parser_AST.Nothing
              );
           FStar_Parser_AST.range = uu___3;
           FStar_Parser_AST.level = uu___4;_},e2,FStar_Parser_AST.Nothing
         )
        ->
...
let (handleable_args_length : FStar_Ident.ident -> Prims.int) =
  fun op  ->
    ...
    let uu___ = (is_general_prefix_op op) || (FStar_List.mem op_s ["-"; "~"])
       in
    if uu___
    then Prims.int_one
    else
                    ...
                    then comment
                      ...
                      (let uu___5 =
                         FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                           comment
                          in
                       FStar_Pprint.op_Hat_Hat acc uu___5)
                     in
                  comments_before_pos uu___3 print_pos lookahead_pos))
              else
                (let uu___3 =
                ...
                | (comment,crange)::cs when
                    ...
                    (FStar_ST.op_Colon_Equals comment_stack cs;
                     (let lnum =
                        let uu___2 =
                          let uu___3 =
                            let uu___4 = FStar_Range.start_of_range crange
                               in
          ...
          fun extract_meta  ->
            let fold_fun uu___ x =
              ...
              | (last_line,doc) ->
                  ...
                  let uu___2 =
                    let uu___3 =
                      let uu___4 = f x  in FStar_Pprint.op_Hat_Hat sep uu___4
                       in
            ...
            | (x,xs1) ->
                let init =
                  ...
                  let uu___2 =
                    let uu___3 = f x  in
                    FStar_Pprint.op_Hat_Hat prefix uu___3  in
                  (uu___1, uu___2)  in
...
let rec (p_decl : FStar_Parser_AST.decl -> FStar_Pprint.document) =
  fun d  ->
    ...
    let uu___1 =
      let uu___2 = p_rawDecl d  in FStar_Pprint.op_Hat_Hat qualifiers uu___2
       in
    FStar_Pprint.op_Hat_Hat uu___ uu___1
  ...
  fun d  ->
    ...
    | FStar_Parser_AST.TopLevelLet (uu___,lbs) ->
        FStar_Pprint.separate_map FStar_Pprint.hardline
          (fun lb  ->
             let uu___1 = let uu___2 = str "let"  in p_letlhs uu___2 lb false
                in
        ...
        let rec p_list' uu___ =
          ...
          | x::xs ->
              ...
              let uu___2 =
                ...
                FStar_Pprint.op_Hat_Hat sep uu___3  in
  ...
  fun d  ->
    ...
    | FStar_Parser_AST.Tycon
        ...
        let uu___1 =
          ...
          FStar_Pprint.surround (Prims.of_int (2)) Prims.int_one
            effect_prefix_doc uu___2 FStar_Pprint.equals
           in
            ...
            let uu___4 =
              FStar_Pprint.optional
                (fun t  ->
                   ...
                   FStar_Pprint.op_Hat_Hat break1 uu___5) t_opt
               in
            FStar_Pprint.op_Hat_Hat uu___3 uu___4  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu___2  in
        FStar_Pprint.op_Hat_Hat uu___ uu___1
                    ...
                    let uu___9 =
                      ...
                      let uu___11 =
                        ...
                        let uu___13 =
                          ...
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.equals uu___14
                           in
    ...
    | FStar_Parser_AST.Splice (ids,t) ->
        ...
        let uu___1 =
          let uu___2 = let uu___3 = str ";"  in p_list p_uident uu___3 ids
             in
          let uu___3 =
    ...
    | FStar_Parser_AST.ResetOptions s_opt ->
        ...
        let uu___2 =
          FStar_Pprint.optional
            (fun s  ->
               let uu___3 =
                 let uu___4 = str s  in FStar_Pprint.dquotes uu___4  in
               FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu___3) s_opt
           in
        FStar_Pprint.op_Hat_Hat uu___1 uu___2
                ...
                let uu___2 =
                  let uu___3 =
                    FStar_Range.extend_to_end_of_line
                      t.FStar_Parser_AST.range
                     in
                  with_comment_sep (p_recordFieldDecl ps) (lid1, t) uu___3
                   in
                (match uu___2 with
                 | (comm,field) ->
                     let sep =
          ...
          fun typ_opt  ->
            ...
            let typ =
              ...
              | FStar_Pervasives_Native.Some t ->
                  ...
                  FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu___
               in
            if bs = []
                      ...
                      let uu___5 =
                        let uu___6 =
                          let uu___7 =
                            ...
                            let uu___9 =
                              let uu___10 = p_atomicTerm (maybe_unthunk tac)
                                 in
                              FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                                uu___10
                               in
                            FStar_Pprint.op_Hat_Hat uu___8 uu___9  in
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu___7
                           in
                  ...
                  | FStar_Parser_AST.PatApp
                      ({
                         FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                           (lid,uu___3);
                         FStar_Parser_AST.prange = uu___4;_},pats)
                      ->
                      let ascr_doc =
                        match ascr with
                        | FStar_Pervasives_Native.Some (t,tac) ->
                            let uu___5 = sig_as_binders_if_possible t true
                               in
                      ...
                      let uu___8 =
                        let uu___9 =
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.semi
                            FStar_Pprint.space
                           in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu___9
                         in
            ...
            let uu___1 =
              ...
              let uu___3 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                 ...
                 in
              FStar_Pprint.op_Hat_Hat uu___2 uu___3  in
            let uu___2 = p_simpleTerm ps false t  in prefix2 uu___1 uu___2
         in
  ...
  fun uu___  ->
    ...
    | FStar_Parser_AST.Meta (FStar_Parser_AST.Arg_qualifier_meta_tac t) ->
        ...
        let uu___2 =
          ...
          let uu___4 =
            let uu___5 = str "]"  in FStar_Pprint.op_Hat_Hat uu___5 break1
             in
          FStar_Pprint.op_Hat_Hat uu___3 uu___4  in
        FStar_Pprint.op_Hat_Hat uu___1 uu___2
  ...
  fun p  ->
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName maybe_cons_lid;
           FStar_Parser_AST.prange = uu___;_},hd::tl::[])
        when
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uid;
           FStar_Parser_AST.prange = uu___;_},pats)
        ->
        let uu___1 = p_quident uid  in
        let uu___2 = FStar_Pprint.separate_map break1 p_atomicPattern pats
           in
...
and (p_atomicPattern : FStar_Parser_AST.pattern -> FStar_Pprint.document) =
  fun p  ->
        ...
        (match ((pat.FStar_Parser_AST.pat), (t.FStar_Parser_AST.tm)) with
         ...
         | (FStar_Parser_AST.PatWild aqual,FStar_Parser_AST.Refine
            ({ FStar_Parser_AST.b = FStar_Parser_AST.NoName t1;
               ...
               FStar_Parser_AST.aqual = uu___2;_},phi))
             ->
             let uu___3 = p_refinement aqual FStar_Pprint.underscore t1 phi
                in
             soft_parens_with_nesting uu___3
         | uu___ ->
             let uu___1 =
    ...
    | FStar_Parser_AST.PatList pats ->
        let uu___ = separate_break_map FStar_Pprint.semi p_tuplePattern pats
           in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_zero
    ...
    | FStar_Parser_AST.PatRecord pats ->
        let p_recordFieldPat uu___ =
          ...
          | (lid,pat) ->
              ...
              let uu___2 = p_tuplePattern pat  in
              infix2 FStar_Pprint.equals uu___1 uu___2
           in
        let uu___ =
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uu___;
           FStar_Parser_AST.prange = uu___1;_},uu___2)
          ...
          let uu___ =
            ...
            | FStar_Parser_AST.Refine
                ({ FStar_Parser_AST.b = FStar_Parser_AST.Annotated (lid',t1);
                   ...
                   FStar_Parser_AST.aqual = uu___3;_},phi)
                when
                     ...
                     fun y  ->
                       let uu___2 =
                         let uu___3 =
                           ...
                           FStar_Pprint.op_Hat_Hat uu___4 FStar_Pprint.rparen
                            in
                         FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu___3
                          in
                       FStar_Pprint.group uu___2
                 else
                   (fun x  ->
      ...
      fun e  ->
        ...
        | FStar_Parser_AST.Op (id,e1::e2::e3::[]) when
            ...
            let uu___ =
              let uu___1 =
                ...
                FStar_Pprint.group uu___2  in
              let uu___2 =
                let uu___3 = p_noSeqTermAndComment ps pb e3  in jump2 uu___3
                 in
              FStar_Pprint.op_Hat_Hat uu___1 uu___2  in
            FStar_Pprint.group uu___
        | FStar_Parser_AST.Op (id,e1::e2::e3::[]) when
        ...
        | FStar_Parser_AST.Attributes es ->
            let uu___ =
              ...
              let uu___2 = FStar_Pprint.separate_map break1 p_atomicTerm es
                 in
              FStar_Pprint.op_Hat_Slash_Hat uu___1 uu___2  in
            FStar_Pprint.group uu___
                         ...
                         then
                           ...
                           (let uu___4 =
                              FStar_Pprint.flow break1
                               ...
                               in
                            FStar_Pprint.hang (Prims.of_int (2)) uu___4)
                          in
                       FStar_Pprint.op_Hat_Hat attrs uu___2)
               in
                    ...
                    let uu___7 =
                      let uu___8 =
                        separate_map_last FStar_Pprint.hardline p_calcStep
                          steps
                         in
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu___8
                       in
                    FStar_Pprint.op_Hat_Hat uu___6 uu___7  in
                  FStar_Pprint.op_Hat_Hat uu___4 uu___5  in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu___3  in
                      ...
                      let uu___10 =
                        let uu___11 =
                          ...
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                            uu___12
                           in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.rbrace uu___11
                         in
             ...
             | [] ->
                 let uu___1 =
                   ...
                   FStar_Pprint.soft_surround (Prims.of_int (2))
                     Prims.int_zero uu___2 binders_doc FStar_Pprint.dot
                    in
                   ...
                   let uu___2 =
                     let uu___3 =
                       let uu___4 =
                         ...
                         FStar_Pprint.op_Hat_Hat uu___5 FStar_Pprint.space
                          in
                       FStar_Pprint.soft_surround (Prims.of_int (2))
                         Prims.int_zero uu___4 binders_doc FStar_Pprint.dot
                        in
                     let uu___4 = p_trigger trigger  in prefix2 uu___3 uu___4
                      in
                   FStar_Pprint.group uu___2  in
                 prefix2 uu___1 term_doc)
                 ...
                 FStar_List.fold_left
                   (fun x  ->
                      fun y  ->
                        ...
                        FStar_Pprint.op_Hat_Hat x uu___2) hd tl
                  in
               cat_with_colon uu___1 typ)
       in
            ...
            let uu___3 =
              ...
              let uu___5 =
                let uu___6 =
                  ...
                  FStar_Pprint.jump (Prims.of_int (2)) Prims.int_zero uu___7
                   in
                   ...
                   let uu___2 =
                     let uu___3 =
                       FStar_Pprint.separate_map break1 p_atomicPattern pats
                        in
                     FStar_Pprint.op_Hat_Slash_Hat uu___3 FStar_Pprint.rarrow
                      in
                       ...
                       let uu___3 =
                         let uu___4 =
                           FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline doc
                            in
                         FStar_Pprint.op_Hat_Hat comm uu___4  in
                       FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline uu___3
                        in
              ...
              | FStar_Pervasives_Native.Some f ->
                  let uu___1 =
                    let uu___2 =
                      ...
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu___3  in
                    FStar_Pprint.op_Hat_Hat FStar_Pprint.bar uu___2  in
                  FStar_Pprint.hang (Prims.of_int (2)) uu___1
               in
                   ...
                   (match FStar_List.length terms with
                    ...
                    | uu___2 ->
                        let uu___3 =
                          let uu___4 =
                            let uu___5 =
                              let uu___6 = FStar_Pprint.separate sep terms'1
                                 in
                              let uu___7 =
                                let uu___8 =
                                  FStar_Pprint.op_Hat_Hat last_op1 last1  in
                                FStar_Pprint.op_Hat_Hat one_line_space uu___8
                                 in
                              FStar_Pprint.op_Hat_Hat uu___6 uu___7  in
                          ...
                          let uu___5 =
                                    ...
                                    let uu___11 =
                                      ...
                                      let uu___13 =
                                        FStar_List.map
                                          ...
                                          terms'1
                                         in
                                      FStar_Pprint.separate uu___12 uu___13
                                       in
                                    FStar_Pprint.op_Hat_Hat
                                      single_line_arg_indent uu___11
                                     in
                                  jump2 uu___10  in
                            ...
                            FStar_Pprint.prefix n Prims.int_one uu___6 uu___7
                             in
                          FStar_Pprint.ifflat uu___4 uu___5  in
                        FStar_Pprint.group uu___3))
  ...
  fun inside_tuple  ->
    fun p_X  ->
      fun curr  ->
        fun e  ->
          match e.FStar_Parser_AST.tm with
          | FStar_Parser_AST.Construct (lid,(e1,uu___)::(e2,uu___1)::[]) when
                   ...
                   let p_dsumfst bt =
                     ...
                     | FStar_Util.Inl b ->
                         ...
                         let uu___2 =
                           ...
                           FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu___3
                            in
                         FStar_Pprint.op_Hat_Hat uu___1 uu___2
                     | FStar_Util.Inr t ->
                      ...
                      in
                   let uu___1 =
                     let uu___2 = FStar_Pprint.concat_map p_dsumfst binders
                        in
    ...
    fun phi  ->
      ...
      | FStar_Parser_AST.Variable uu___ ->
          let uu___1 =
            ...
            FStar_Util.format1
              "Imposible : a refined binder ought to be annotated %s" uu___2
             in
          failwith uu___1
  ...
  fun e  ->
              ...
              | uu___2 ->
                  let uu___3 =
                    ...
                    then
                      ...
                      (let uu___6 = p_indexingTerm head  in (uu___6, args))
                     in
                  (match uu___3 with
                   | (head_doc,args1) ->
                       let uu___4 =
    ...
    | FStar_Parser_AST.Construct (lid,args) when
        (is_general_construction e) &&
          (let uu___ = (is_dtuple_constructor lid) && (all1_explicit args)
              in
           Prims.op_Negation uu___)
        ->
        (match args with
         ...
         | hd::tl ->
             let uu___ =
               let uu___1 =
                 ...
                 FStar_Pprint.group uu___2  in
               let uu___2 =
                 let uu___3 = FStar_Pprint.separate_map break1 p_argTerm tl
                    in
                 jump2 uu___3  in
               FStar_Pprint.op_Hat_Hat uu___1 uu___2  in
             FStar_Pprint.group uu___)
...
and (p_atomicTerm : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    ...
    | FStar_Parser_AST.Op (op,e1::[]) when is_general_prefix_op op ->
        let uu___ = let uu___1 = FStar_Ident.string_of_id op  in str uu___1
           in
    ...
    | FStar_Parser_AST.Project (e1,lid) ->
        let uu___ =
          ...
          let uu___2 =
            ...
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu___3  in
          FStar_Pprint.prefix (Prims.of_int (2)) Prims.int_zero uu___1 uu___2
           in
        FStar_Pprint.group uu___
  ...
  fun e  ->
    ...
    | uu___ when is_list e ->
        let uu___1 =
          ...
          separate_map_or_flow_last uu___2
            (fun ps  -> p_noSeqTermAndComment ps false) uu___3
           in
        FStar_Pprint.surround (Prims.of_int (2)) Prims.int_zero
    ...
    | uu___ when is_lex_list e ->
        ...
        let uu___2 =
          ...
          separate_map_or_flow_last uu___3
            (fun ps  -> p_noSeqTermAndComment ps false) uu___4
           in
          ...
          default_or_map FStar_Pprint.empty
            (fun uu___1  ->
               ...
               | (s,w) ->
                   ...
                   FStar_Pprint.op_Hat_Hat uu___2 uu___3) sign_width_opt
           in
                  ...
                  let uu___2 =
                    ...
                    let uu___4 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu___5  ->
                           match uu___5 with
                           | (u1,uu___6) -> p_atomicUniverse u1) args
                       in
                    op_Hat_Slash_Plus_Hat uu___3 uu___4  in
                  FStar_Pprint.group uu___2
              | uu___2 ->
       ...
       | d::ds ->
           let uu___1 =
             ...
             | {
                 ...
                 let uu___6 =
                   let uu___7 = let uu___8 = FStar_List.tl ds  in d :: uu___8
                      in
                   d0 :: uu___7  in
                ...
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    ...
                    place_comments_until_pos Prims.int_zero Prims.int_one
                      uu___3 dummy_meta FStar_Pprint.empty false true
                     in
                  let doc =
                  ...
                  FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
                  (let uu___5 = FStar_Pprint.op_Hat_Hat initial_comment doc
                      in
                   (uu___5, comments1))))))
