...
let doc_of_fsdoc : (Prims.string * (Prims.string * Prims.string) Prims.list)  ->  FStar_Pprint.document = (fun _67_50 -> (match (_67_50) with
| (comment, keywords) -> begin
(let _165_81 = (let _165_80 = (let _165_79 = (str comment)
in (let _165_78 = (let _165_77 = (let _165_76 = (FStar_Pprint.separate_map FStar_Pprint.comma (fun _67_53 -> (match (_67_53) with
| (k, v) -> begin
...
| FStar_Parser_AST.Construct (lid, (_67_79)::((e2, _67_76))::[]) -> begin
...
| FStar_Parser_AST.Construct (_67_87, []) -> begin
[]
end
| FStar_Parser_AST.Construct (_67_92, ((e1, FStar_Parser_AST.Nothing))::((e2, FStar_Parser_AST.Nothing))::[]) -> begin
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (lid); FStar_Parser_AST.range = _67_108; FStar_Parser_AST.level = _67_106}, l, FStar_Parser_AST.Nothing) -> begin
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_singleton_lid); FStar_Parser_AST.range = _67_124; FStar_Parser_AST.level = _67_122}, {FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_ref_lid); FStar_Parser_AST.range = _67_135; FStar_Parser_AST.level = _67_133}, e, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = _67_131; FStar_Parser_AST.level = _67_129}, FStar_Parser_AST.Nothing) -> begin
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_union_lid); FStar_Parser_AST.range = _67_154; FStar_Parser_AST.level = _67_152}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = _67_150; FStar_Parser_AST.level = _67_148}, e2, FStar_Parser_AST.Nothing) -> begin
...
| FStar_Parser_AST.Var (_67_171) -> begin
[]
end
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (_67_178); FStar_Parser_AST.range = _67_176; FStar_Parser_AST.level = _67_174}, {FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (_67_190); FStar_Parser_AST.range = _67_188; FStar_Parser_AST.level = _67_186}, e, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = _67_184; FStar_Parser_AST.level = _67_182}, FStar_Parser_AST.Nothing) -> begin
(e)::[]
end
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (_67_210); FStar_Parser_AST.range = _67_208; FStar_Parser_AST.level = _67_206}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = _67_204; FStar_Parser_AST.level = _67_202}, e2, FStar_Parser_AST.Nothing) -> begin
...
let matches_level = (fun s _67_251 -> (match (_67_251) with
...
in (FStar_List.mapi (fun i _67_261 -> (match (_67_261) with
| (assoc, tokens) -> begin
...
| Some (assoc_levels, _67_266) -> begin
assoc_levels
end
| _67_270 -> begin
...
let find_level_and_max = (fun n level -> (match ((FStar_List.tryFind (fun _67_280 -> (match (_67_280) with
| (_67_278, tokens) -> begin
(tokens = (Prims.snd level))
end)) level_table)) with
| Some ((_67_282, l, _67_285), _67_288) -> begin
(max n l)
end
| None -> begin
...
and p_fsdoc : FStar_Parser_AST.fsdoc  ->  FStar_Pprint.document = (fun _67_307 -> (match (_67_307) with
| (doc, kwd_args) -> begin
(
...
let process_kwd_arg = (fun _67_313 -> (match (_67_313) with
| (kwd, arg) -> begin
(let _165_273 = (str "@")
...
| FStar_Parser_AST.KindAbbrev (_67_325) -> begin
...
| FStar_Parser_AST.Main (_67_384) -> begin
...
and p_fsdocTypeDeclPairs : (FStar_Parser_AST.tycon * FStar_Parser_AST.fsdoc Prims.option)  ->  FStar_Pprint.document = (fun _67_395 -> (match (_67_395) with
...
and p_recordFieldDecl : (FStar_Ident.ident * FStar_Parser_AST.term * FStar_Parser_AST.fsdoc Prims.option)  ->  FStar_Pprint.document = (fun _67_431 -> (match (_67_431) with
| (lid, t, doc_opt) -> begin
...
and p_constructorDecl : (FStar_Ident.ident * FStar_Parser_AST.term Prims.option * FStar_Parser_AST.fsdoc Prims.option * Prims.bool)  ->  FStar_Pprint.document = (fun _67_436 -> (match (_67_436) with
...
and p_letbinding : (FStar_Parser_AST.pattern * FStar_Parser_AST.term)  ->  FStar_Pprint.document = (fun _67_442 -> (match (_67_442) with
| (pat, e) -> begin
(

let pat_doc = (

let _67_451 = (match (pat.FStar_Parser_AST.pat) with
...
in (match (_67_451) with
| (pat, ascr_doc) -> begin
(match (pat.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, _67_456); FStar_Parser_AST.prange = _67_453}, pats) -> begin
...
let p_lift = (fun _67_518 -> (match (_67_518) with
| (kwd, t) -> begin
...
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatName (maybe_cons_lid); FStar_Parser_AST.prange = _67_562}, (hd)::(tl)::[]) when (FStar_Ident.lid_equals maybe_cons_lid FStar_Syntax_Const.cons_lid) -> begin
...
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatName (uid); FStar_Parser_AST.prange = _67_572}, pats) -> begin
...
let p_recordFieldPat = (fun _67_593 -> (match (_67_593) with
| (lid, pat) -> begin
...
| FStar_Parser_AST.PatOr (_67_616) -> begin
...
| FStar_Parser_AST.TAnnotated (_67_647) -> begin
...
| FStar_Parser_AST.If (_67_706, _67_708, e3) when (is_unit e3) -> begin
...
| FStar_Parser_AST.Abs (({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, typ_opt); FStar_Parser_AST.prange = _67_734})::[], {FStar_Parser_AST.tm = FStar_Parser_AST.Match (maybe_x, branches); FStar_Parser_AST.range = _67_744; FStar_Parser_AST.level = _67_742}) when (matches_var maybe_x x) -> begin
...
| FStar_Parser_AST.QForall (_67_770) -> begin
(str "forall")
end
| FStar_Parser_AST.QExists (_67_773) -> begin
(str "exists")
end
| _67_776 -> begin
...
and p_patternBranch : FStar_Parser_AST.branch  ->  FStar_Pprint.document = (fun _67_793 -> (match (_67_793) with
...
in (FStar_Pprint.separate_map _165_703 (fun _67_851 -> (match (_67_851) with
| (e, _67_850) -> begin
(p_tmEq e)
end)) args))
end
...
| FStar_Parser_AST.Construct (lid, ((e1, _67_890))::((e2, _67_886))::[]) when ((FStar_Ident.lid_equals lid FStar_Syntax_Const.cons_lid) && (not ((is_list e)))) -> begin
(

let op = "::"
in (

let _67_899 = (levels op)
...
| FStar_Parser_AST.TAnnotated (_67_957) -> begin
(FStar_All.failwith "Is this still used ?")
end
...
and p_simpleDef : (FStar_Ident.lid * FStar_Parser_AST.term)  ->  FStar_Pprint.document = (fun _67_970 -> (match (_67_970) with
| (lid, e) -> begin
...
| FStar_Parser_AST.App (_67_973) when (is_general_application e) -> begin
(

let _67_977 = (head_and_args e)
in (match (_67_977) with
| (head, args) -> begin
...
| ({FStar_Parser_AST.tm = FStar_Parser_AST.Uvar (_67_990); FStar_Parser_AST.range = _67_988; FStar_Parser_AST.level = _67_986}, FStar_Parser_AST.UnivApp) -> begin
...
| _67_1081 when (is_array e) -> begin
(
...
| _67_1086 when (is_lex_list e) -> begin
...
| _67_1088 when (is_ref_set e) -> begin
(
...
| FStar_Parser_AST.Labeled (_67_1176) -> begin
...
| FStar_Const.Const_string (bytes, _67_1189) -> begin
(let _165_844 = (str (FStar_Util.string_of_bytes bytes))
in (FStar_Pprint.dquotes _165_844))
end
| FStar_Const.Const_bytearray (bytes, _67_1194) -> begin
...
let ending = (default_or_map FStar_Pprint.empty (fun _67_1213 -> (match (_67_1213) with
| (s, w) -> begin
...
| FStar_Parser_AST.App (_67_1229) -> begin
(

let _67_1233 = (head_and_args u)
...
in (let _165_870 = (FStar_Pprint.separate_map FStar_Pprint.space (fun _67_1239 -> (match (_67_1239) with
| (u, _67_1238) -> begin
(p_atomicUniverse u)
end)) args)
...
| FStar_Parser_AST.Uvar (_67_1252) -> begin
(p_univar u)
end
...
let comments_to_document : (Prims.string * FStar_Range.range) Prims.list  ->  FStar_Pprint.document = (fun comments -> (FStar_Pprint.separate_map FStar_Pprint.hardline (fun _67_1291 -> (match (_67_1291) with
| (comment, range) -> begin
(str comment)
end)) comments))
...
let rec aux = (fun _67_1298 decl -> (match (_67_1298) with
...
let _67_1301 = if ((FStar_Range.file_of_range previous_range) <> (FStar_Range.file_of_range current_range)) then begin
...
let _67_1311 = (FStar_Util.take (fun _67_18 -> (match (_67_18) with
| (_67_1306, range) -> begin
(FStar_Range.range_contains_range inbetween_range range)
end)) comments)
in (match (_67_1311) with
| (preceding_comments, comments) -> begin
(

let range_line_diff = (fun range -> ((let _165_910 = (FStar_Range.end_of_range range)
in (FStar_Range.line_of_pos _165_910)) - (let _165_911 = (FStar_Range.start_of_range range)
in (FStar_Range.line_of_pos _165_911))))
in (
...
let line_count = (((range_line_diff inbetween_range) - (Prims.parse_int "1")) - (FStar_List.fold_left (fun n _67_1321 -> (match (_67_1321) with
| (_67_1319, r) -> begin
(n + (let _165_918 = (range_line_diff r)
in (max _165_918 (Prims.parse_int "1"))))
...
let doc = (let _165_924 = (let _165_923 = (FStar_Pprint.repeat line_count FStar_Pprint.hardline)
in (let _165_922 = (let _165_921 = (comments_to_document preceding_comments)
in (let _165_920 = (let _165_919 = (decl_to_document decl)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline _165_919))
in (FStar_Pprint.op_Hat_Hat _165_921 _165_920)))
in (FStar_Pprint.op_Hat_Hat _165_923 _165_922)))
in (FStar_Pprint.op_Hat_Hat doc _165_924))
...
let initial_range = (let _165_925 = (FStar_Range.file_of_range d.FStar_Parser_AST.drange)
in (FStar_Range.mk_range _165_925 FStar_Range.zeroPos FStar_Range.zeroPos))
in (

let _67_1347 = (FStar_List.fold_left aux ((initial_range), (comments), (FStar_Pprint.empty)) decls)
in (match (_67_1347) with
| (_67_1344, comments, doc) -> begin
((doc), (comments))
end)))
end))))
