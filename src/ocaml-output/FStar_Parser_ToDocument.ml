...
let (level_table :
  ((Prims.int,Prims.int,Prims.int) FStar_Pervasives_Native.tuple3,(FStar_Char.char,
    ...
    FStar_Pervasives_Native.tuple2 Prims.list)
  =
  let levels_from_associativity l uu___52_1604 =
    match uu___52_1604 with
...
and (p_noSeqTerm' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    ...
    | FStar_Parser_AST.Let (attrs_opt,q,lbs,e1) ->
        let let_doc =
          let uu____4557 = str "let"  in
          let uu____4558 = p_letqualifier q  in
          FStar_Pprint.op_Hat_Hat uu____4557 uu____4558  in
        let l =
          let uu____4560 =
            let uu____4561 =
              let uu____4562 =
                let uu____4563 = str "and"  in
                precede_break_separate_map let_doc uu____4563 p_letbinding
                  lbs
                 in
              let uu____4568 = str "in"  in
              FStar_Pprint.op_Hat_Slash_Hat uu____4562 uu____4568  in
            FStar_Pprint.group uu____4561  in
          let uu____4569 = p_term e1  in
          FStar_Pprint.op_Hat_Slash_Hat uu____4560 uu____4569  in
                 ...
                 let uu____4580 =
                   let uu____4581 =
                     FStar_Pprint.separate_map FStar_Pprint.semi p_term terms
                      in
                   let uu____4582 = str "]"  in
                   FStar_Pprint.op_Hat_Slash_Hat uu____4581 uu____4582  in
                 FStar_Pprint.op_Hat_Slash_Hat uu____4579 uu____4580  in
               FStar_Pprint.group uu____4578  in
             let uu____4583 =
               FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.hardline l  in
             FStar_Pprint.op_Hat_Slash_Hat attrs uu____4583)
    | FStar_Parser_AST.Abs
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x,typ_opt);
           FStar_Parser_AST.prange = uu____4586;_}::[],{
                                                         FStar_Parser_AST.tm
                                                           =
        ...
        let uu____4617 =
          let uu____4618 = str "function"  in
          let uu____4619 =
            FStar_Pprint.separate_map FStar_Pprint.hardline p_patternBranch
              branches
             in
          FStar_Pprint.op_Hat_Slash_Hat uu____4618 uu____4619  in
        FStar_Pprint.group uu____4617
    | FStar_Parser_AST.Assign (id1,e1) ->
        let uu____4630 =
          let uu____4631 = p_lident id1  in
          let uu____4632 =
            let uu____4633 = p_noSeqTerm e1  in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.larrow uu____4633  in
...
and (p_typ' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4637 =
      let uu____4638 = unparen e  in uu____4638.FStar_Parser_AST.tm  in
    match uu____4637 with
    | FStar_Parser_AST.QForall (bs,trigger,e1) ->
        let uu____4654 =
          let uu____4655 =
            let uu____4656 = p_quantifier e  in
            FStar_Pprint.op_Hat_Hat uu____4656 FStar_Pprint.space  in
          let uu____4657 = p_binders true bs  in
          FStar_Pprint.soft_surround (Prims.parse_int "2")
            (Prims.parse_int "0") uu____4655 uu____4657 FStar_Pprint.dot
           in
        let uu____4658 =
          let uu____4659 = p_trigger trigger  in
          let uu____4660 = p_noSeqTerm e1  in
          FStar_Pprint.op_Hat_Hat uu____4659 uu____4660  in
        prefix2 uu____4654 uu____4658
    | FStar_Parser_AST.QExists (bs,trigger,e1) ->
        let uu____4676 =
          let uu____4677 =
            let uu____4678 = p_quantifier e  in
            FStar_Pprint.op_Hat_Hat uu____4678 FStar_Pprint.space  in
          let uu____4679 = p_binders true bs  in
          FStar_Pprint.soft_surround (Prims.parse_int "2")
            (Prims.parse_int "0") uu____4677 uu____4679 FStar_Pprint.dot
           in
        let uu____4680 =
          let uu____4681 = p_trigger trigger  in
          let uu____4682 = p_noSeqTerm e1  in
          FStar_Pprint.op_Hat_Hat uu____4681 uu____4682  in
        prefix2 uu____4676 uu____4680
    | uu____4683 -> p_simpleTerm e

and (p_quantifier : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4685 =
      let uu____4686 = unparen e  in uu____4686.FStar_Parser_AST.tm  in
    match uu____4685 with
    | FStar_Parser_AST.QForall uu____4687 -> str "forall"
    | FStar_Parser_AST.QExists uu____4700 -> str "exists"
    | uu____4713 ->
...
and (p_trigger :
  ...
  fun uu___59_4714  ->
    match uu___59_4714 with
    | [] -> FStar_Pprint.empty
    | pats ->
        let uu____4726 =
          let uu____4727 =
            let uu____4728 = str "pattern"  in
            let uu____4729 =
              let uu____4730 =
                let uu____4731 = p_disjunctivePats pats  in jump2 uu____4731
                 in
              let uu____4732 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.rbrace break1  in
              FStar_Pprint.op_Hat_Slash_Hat uu____4730 uu____4732  in
            FStar_Pprint.op_Hat_Slash_Hat uu____4728 uu____4729  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4727  in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lbrace uu____4726

and (p_disjunctivePats :
  FStar_Parser_AST.term Prims.list Prims.list -> FStar_Pprint.document) =
  fun pats  ->
    let uu____4738 = str "\\/"  in
    FStar_Pprint.separate_map uu____4738 p_conjunctivePats pats
...
and (p_conjunctivePats :
  ...
  fun pats  ->
    ...
    FStar_Pprint.group uu____4744

and (p_simpleTerm : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4746 =
      let uu____4747 = unparen e  in uu____4747.FStar_Parser_AST.tm  in
    match uu____4746 with
    | FStar_Parser_AST.Abs (pats,e1) ->
        let uu____4754 =
          let uu____4755 = str "fun"  in
          let uu____4756 =
            let uu____4757 =
              FStar_Pprint.separate_map break1 p_atomicPattern pats  in
            FStar_Pprint.op_Hat_Slash_Hat uu____4757 FStar_Pprint.rarrow  in
          op_Hat_Slash_Plus_Hat uu____4755 uu____4756  in
        let uu____4758 = p_term e1  in
        op_Hat_Slash_Plus_Hat uu____4754 uu____4758
    | uu____4759 -> p_tmIff e
...
and (p_patternBranch :
  ...
  fun uu____4762  ->
    ...
    | (pat,when_opt,e) ->
        let maybe_paren =
          let uu____4781 =
            let uu____4782 = unparen e  in uu____4782.FStar_Parser_AST.tm  in
          match uu____4781 with
          | FStar_Parser_AST.Match uu____4785 -> soft_begin_end_with_nesting
          | FStar_Parser_AST.TryWith uu____4800 ->
              soft_begin_end_with_nesting
          | FStar_Parser_AST.Abs
              ({
                 FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                   (x,uu____4816);
                 FStar_Parser_AST.prange = uu____4817;_}::[],{
                                                               FStar_Parser_AST.tm
                                                                 =
                                                                 FStar_Parser_AST.Match
                                                                 (maybe_x,uu____4819);
          ...
          | uu____4848 -> (fun x  -> x)  in
        let uu____4850 =
          let uu____4851 =
            let uu____4852 =
              let uu____4853 =
                let uu____4854 =
                  let uu____4855 = p_disjunctivePattern pat  in
                  let uu____4856 =
                    let uu____4857 = p_maybeWhen when_opt  in
                    FStar_Pprint.op_Hat_Hat uu____4857 FStar_Pprint.rarrow
                     in
                  op_Hat_Slash_Plus_Hat uu____4855 uu____4856  in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4854  in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.bar uu____4853  in
            FStar_Pprint.group uu____4852  in
          let uu____4858 =
            let uu____4859 = p_term e  in maybe_paren uu____4859  in
          op_Hat_Slash_Plus_Hat uu____4851 uu____4858  in
...
and (p_maybeWhen :
  ...
  =
  fun uu___60_4860  ->
    match uu___60_4860 with
    | FStar_Pervasives_Native.None  -> FStar_Pprint.empty
    | FStar_Pervasives_Native.Some e ->
        let uu____4864 = str "when"  in
        let uu____4865 =
          let uu____4866 = p_tmFormula e  in
          FStar_Pprint.op_Hat_Hat uu____4866 FStar_Pprint.space  in
        op_Hat_Slash_Plus_Hat uu____4864 uu____4865

and (p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4868 =
      let uu____4869 = unparen e  in uu____4869.FStar_Parser_AST.tm  in
    match uu____4868 with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "<==>"; FStar_Ident.idRange = uu____4870;_},e1::e2::[])
        ->
        let uu____4875 = str "<==>"  in
        let uu____4876 = p_tmImplies e1  in
        let uu____4877 = p_tmIff e2  in
        infix0 uu____4875 uu____4876 uu____4877
    | uu____4878 -> p_tmImplies e
...
and (p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    ...
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "==>"; FStar_Ident.idRange = uu____4882;_},e1::e2::[])
        ->
        let uu____4887 = str "==>"  in
        let uu____4888 = p_tmArrow p_tmFormula e1  in
        let uu____4889 = p_tmImplies e2  in
        infix0 uu____4887 uu____4888 uu____4889
    | uu____4890 -> p_tmArrow p_tmFormula e
...
and (p_tmArrow :
  ...
  fun p_Tm  ->
    fun e  ->
      let uu____4895 =
        let uu____4896 = unparen e  in uu____4896.FStar_Parser_AST.tm  in
          ...
          let uu____4903 =
            let uu____4904 =
              separate_map_or_flow FStar_Pprint.empty
                (fun b  ->
                   let uu____4909 = p_binder false b  in
                   let uu____4910 =
                     let uu____4911 =
                       FStar_Pprint.op_Hat_Hat FStar_Pprint.rarrow break1  in
                     FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4911
                      in
                   FStar_Pprint.op_Hat_Hat uu____4909 uu____4910) bs
               in
            let uu____4912 = p_tmArrow p_Tm tgt  in
            FStar_Pprint.op_Hat_Hat uu____4904 uu____4912  in
...
and (p_tmFormula : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4915 =
      let uu____4916 = unparen e  in uu____4916.FStar_Parser_AST.tm  in
    match uu____4915 with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "\\/"; FStar_Ident.idRange = uu____4917;_},e1::e2::[])
        ->
        let uu____4922 = str "\\/"  in
        let uu____4923 = p_tmFormula e1  in
        let uu____4924 = p_tmConjunction e2  in
        infix0 uu____4922 uu____4923 uu____4924
    | uu____4925 -> p_tmConjunction e

and (p_tmConjunction : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4927 =
      let uu____4928 = unparen e  in uu____4928.FStar_Parser_AST.tm  in
    match uu____4927 with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "/\\"; FStar_Ident.idRange = uu____4929;_},e1::e2::[])
        ->
        let uu____4934 = str "/\\"  in
        let uu____4935 = p_tmConjunction e1  in
        let uu____4936 = p_tmTuple e2  in
        infix0 uu____4934 uu____4935 uu____4936
    | uu____4937 -> p_tmTuple e
...
and (p_tmTuple' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____4940 =
      let uu____4941 = unparen e  in uu____4941.FStar_Parser_AST.tm  in
    match uu____4940 with
    | FStar_Parser_AST.Construct (lid,args) when is_tuple_constructor lid ->
        let uu____4956 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
           in
        FStar_Pprint.separate_map uu____4956
          (fun uu____4964  ->
             match uu____4964 with | (e1,uu____4970) -> p_tmEq e1) args
    | uu____4971 -> p_tmEq e
      ...
      fun doc1  ->
        ...
        then doc1
          ...
          (let uu____4976 =
             let uu____4977 =
               FStar_Pprint.op_Hat_Hat doc1 FStar_Pprint.rparen  in
             FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____4977  in
...
and (p_tmEq' : Prims.int -> FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun curr  ->
    fun e  ->
      let uu____5028 =
        let uu____5029 = unparen e  in uu____5029.FStar_Parser_AST.tm  in
      ...
      | FStar_Parser_AST.Op (op,e1::e2::[]) when
          ...
          let uu____5036 = levels op1  in
          (match uu____5036 with
           | (left1,mine,right1) ->
               let uu____5046 =
                 let uu____5047 = FStar_All.pipe_left str op1  in
                 let uu____5048 = p_tmEq' left1 e1  in
                 let uu____5049 = p_tmEq' right1 e2  in
                 infix0 uu____5047 uu____5048 uu____5049  in
               paren_if curr mine uu____5046)
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ":="; FStar_Ident.idRange = uu____5050;_},e1::e2::[])
          ->
          let uu____5055 =
            let uu____5056 = p_tmEq e1  in
            let uu____5057 =
              let uu____5058 =
                let uu____5059 =
                  let uu____5060 = p_tmEq e2  in
                  op_Hat_Slash_Plus_Hat FStar_Pprint.equals uu____5060  in
                FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____5059  in
      ...
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = "-"; FStar_Ident.idRange = uu____5061;_},e1::[])
          ->
          let uu____5065 = levels "-"  in
          (match uu____5065 with
           | (left1,mine,right1) ->
               let uu____5075 = p_tmEq' mine e1  in
               FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.minus uu____5075)
      | uu____5076 -> p_tmNoEq e
...
and (p_tmNoEq' : Prims.int -> FStar_Parser_AST.term -> FStar_Pprint.document)
  ...
  fun curr  ->
    fun e  ->
      let uu____5139 =
        let uu____5140 = unparen e  in uu____5140.FStar_Parser_AST.tm  in
      match uu____5139 with
      | FStar_Parser_AST.Construct (lid,(e1,uu____5143)::(e2,uu____5145)::[])
          when
          (FStar_Ident.lid_equals lid FStar_Parser_Const.cons_lid) &&
            (let uu____5165 = is_list e  in Prims.op_Negation uu____5165)
          ->
          let op = "::"  in
          let uu____5167 = levels op  in
          (match uu____5167 with
           | (left1,mine,right1) ->
               let uu____5177 =
                 let uu____5178 = str op  in
                 let uu____5179 = p_tmNoEq' left1 e1  in
                 let uu____5180 = p_tmNoEq' right1 e2  in
                 infix0 uu____5178 uu____5179 uu____5180  in
               paren_if curr mine uu____5177)
      | FStar_Parser_AST.Sum (binders,res) ->
          let op = "&"  in
          let uu____5188 = levels op  in
          (match uu____5188 with
           | (left1,mine,right1) ->
               let p_dsumfst b =
                 ...
                 let uu____5203 =
                   let uu____5204 =
                     let uu____5205 = str op  in
                     FStar_Pprint.op_Hat_Hat uu____5205 break1  in
                   FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5204  in
                 FStar_Pprint.op_Hat_Hat uu____5202 uu____5203  in
               let uu____5206 =
                 let uu____5207 = FStar_Pprint.concat_map p_dsumfst binders
                    in
                 let uu____5208 = p_tmNoEq' right1 res  in
                 FStar_Pprint.op_Hat_Hat uu____5207 uu____5208  in
               paren_if curr mine uu____5206)
      | FStar_Parser_AST.Op (op,e1::e2::[]) when is_operatorInfix34 op ->
          let op1 = FStar_Ident.text_of_id op  in
          let uu____5215 = levels op1  in
          (match uu____5215 with
           | (left1,mine,right1) ->
               let uu____5225 =
                 let uu____5226 = str op1  in
                 let uu____5227 = p_tmNoEq' left1 e1  in
                 let uu____5228 = p_tmNoEq' right1 e2  in
                 infix0 uu____5226 uu____5227 uu____5228  in
               paren_if curr mine uu____5225)
      | FStar_Parser_AST.NamedTyp (lid,e1) ->
          let uu____5231 =
            let uu____5232 = p_lidentOrUnderscore lid  in
            let uu____5233 =
              let uu____5234 = p_appTerm e1  in
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____5234  in
            FStar_Pprint.op_Hat_Slash_Hat uu____5232 uu____5233  in
          FStar_Pprint.group uu____5231
      ...
      | FStar_Parser_AST.Record (with_opt,record_fields) ->
          let uu____5255 =
            ...
            let uu____5257 =
              let uu____5258 =
                FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1  in
              FStar_Pprint.separate_map uu____5258 p_simpleDef record_fields
               in
            FStar_Pprint.op_Hat_Hat uu____5256 uu____5257  in
          braces_with_nesting uu____5255
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = "~"; FStar_Ident.idRange = uu____5263;_},e1::[])
          ->
          let uu____5267 =
            let uu____5268 = str "~"  in
            let uu____5269 = p_atomicTerm e1  in
            FStar_Pprint.op_Hat_Hat uu____5268 uu____5269  in
          FStar_Pprint.group uu____5267
      | uu____5270 -> p_appTerm e

and (p_with_clause : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____5272 = p_appTerm e  in
    let uu____5273 =
      let uu____5274 =
        let uu____5275 = str "with"  in
        FStar_Pprint.op_Hat_Hat uu____5275 break1  in
      FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5274  in
    FStar_Pprint.op_Hat_Hat uu____5272 uu____5273
    ...
    fun phi  ->
      ...
      | FStar_Parser_AST.Annotated (lid,t) ->
          let uu____5280 =
            ...
            p_refinement b.FStar_Parser_AST.aqual uu____5281 t phi  in
          soft_parens_with_nesting uu____5280
      | FStar_Parser_AST.TAnnotated uu____5282 ->
          failwith "Is this still used ?"
      | FStar_Parser_AST.Variable uu____5287 ->
          let uu____5288 =
            let uu____5289 = FStar_Parser_AST.binder_to_string b  in
            FStar_Util.format1
              "Imposible : a refined binder ought to be annotated %s"
              uu____5289
             in
          failwith uu____5288
      | FStar_Parser_AST.TVariable uu____5290 ->
          let uu____5291 =
            let uu____5292 = FStar_Parser_AST.binder_to_string b  in
            FStar_Util.format1
              "Imposible : a refined binder ought to be annotated %s"
              uu____5292
             in
          failwith uu____5291
      | FStar_Parser_AST.NoName uu____5293 ->
          let uu____5294 =
            let uu____5295 = FStar_Parser_AST.binder_to_string b  in
            FStar_Util.format1
              "Imposible : a refined binder ought to be annotated %s"
              uu____5295
             in
...
and (p_simpleDef :
  ...
  fun uu____5296  ->
    ...
    | (lid,e) ->
        let uu____5303 =
          let uu____5304 = p_qlident lid  in
          let uu____5305 =
            let uu____5306 = p_tmIff e  in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.equals uu____5306  in
          FStar_Pprint.op_Hat_Slash_Hat uu____5304 uu____5305  in
        FStar_Pprint.group uu____5303

and (p_appTerm : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____5308 =
      let uu____5309 = unparen e  in uu____5309.FStar_Parser_AST.tm  in
    match uu____5308 with
    | FStar_Parser_AST.App uu____5310 when is_general_application e ->
        let uu____5317 = head_and_args e  in
        (match uu____5317 with
         | (head1,args) ->
             let uu____5342 =
               let uu____5353 = FStar_ST.op_Bang should_print_fs_typ_app  in
               if uu____5353
               then
                 let uu____5383 =
                   FStar_Util.take
                     (fun uu____5407  ->
                        ...
                        | (uu____5412,aq) -> aq = FStar_Parser_AST.FsTypApp)
                     args
                    in
                 match uu____5383 with
                 | (fs_typ_args,args1) ->
                     let uu____5450 =
                       let uu____5451 = p_indexingTerm head1  in
                       let uu____5452 =
                         let uu____5453 =
                         ...
                         soft_surround_map_or_flow (Prims.parse_int "2")
                           ...
                           FStar_Pprint.langle uu____5453 FStar_Pprint.rangle
                           p_fsTypArg fs_typ_args
                          in
                       FStar_Pprint.op_Hat_Hat uu____5451 uu____5452  in
                     (uu____5450, args1)
               else
                 (let uu____5465 = p_indexingTerm head1  in
                  (uu____5465, args))
                in
             (match uu____5342 with
              | (head_doc,args1) ->
                  let uu____5486 =
                    ...
                    soft_surround_map_or_flow (Prims.parse_int "2")
                      (Prims.parse_int "0") head_doc uu____5487 break1
                      FStar_Pprint.empty p_argTerm args1
                     in
                  FStar_Pprint.group uu____5486))
    | FStar_Parser_AST.Construct (lid,args) when
        (is_general_construction e) &&
          (let uu____5507 = is_dtuple_constructor lid  in
           Prims.op_Negation uu____5507)
        ->
        (match args with
         | [] -> p_quident lid
         | arg::[] ->
             let uu____5525 =
               let uu____5526 = p_quident lid  in
               let uu____5527 = p_argTerm arg  in
         ...
         | hd1::tl1 ->
             let uu____5544 =
               let uu____5545 =
                 let uu____5546 =
                   let uu____5547 = p_quident lid  in
                   let uu____5548 = p_argTerm hd1  in
                   prefix2 uu____5547 uu____5548  in
                 FStar_Pprint.group uu____5546  in
               let uu____5549 =
                 let uu____5550 =
                   FStar_Pprint.separate_map break1 p_argTerm tl1  in
                 jump2 uu____5550  in
               FStar_Pprint.op_Hat_Hat uu____5545 uu____5549  in
             FStar_Pprint.group uu____5544)
    | uu____5555 -> p_indexingTerm e
  ...
  fun arg_imp  ->
    ...
    | (e,FStar_Parser_AST.FsTypApp ) ->
        (FStar_Errors.log_issue e.FStar_Parser_AST.range
         ...
         (let uu____5564 = p_indexingTerm e  in
          FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
            FStar_Pprint.langle uu____5564 FStar_Pprint.rangle))
    | (e,FStar_Parser_AST.Hash ) ->
        let uu____5566 = str "#"  in
        let uu____5567 = p_indexingTerm e  in
...
and (p_fsTypArg :
  ...
  =
  fun uu____5569  ->
    match uu____5569 with | (e,uu____5575) -> p_indexingTerm e
...
and (p_indexingTerm_aux :
  ...
  fun exit1  ->
    fun e  ->
      let uu____5580 =
        let uu____5581 = unparen e  in uu____5581.FStar_Parser_AST.tm  in
      match uu____5580 with
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".()"; FStar_Ident.idRange = uu____5582;_},e1::e2::[])
          ->
          let uu____5587 =
            let uu____5588 = p_indexingTerm_aux p_atomicTermNotQUident e1  in
            let uu____5589 =
              let uu____5590 =
                let uu____5591 = p_term e2  in
                soft_parens_with_nesting uu____5591  in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5590  in
            FStar_Pprint.op_Hat_Hat uu____5588 uu____5589  in
          FStar_Pprint.group uu____5587
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".[]"; FStar_Ident.idRange = uu____5592;_},e1::e2::[])
          ->
          let uu____5597 =
            let uu____5598 = p_indexingTerm_aux p_atomicTermNotQUident e1  in
            let uu____5599 =
              let uu____5600 =
                let uu____5601 = p_term e2  in
                soft_brackets_with_nesting uu____5601  in
              FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5600  in
...
and (p_atomicTerm : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____5605 =
      let uu____5606 = unparen e  in uu____5606.FStar_Parser_AST.tm  in
    match uu____5605 with
    | FStar_Parser_AST.LetOpen (lid,e1) ->
        let uu____5609 = p_quident lid  in
        let uu____5610 =
          let uu____5611 =
            let uu____5612 = p_term e1  in
            soft_parens_with_nesting uu____5612  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5611  in
        FStar_Pprint.op_Hat_Hat uu____5609 uu____5610
    | FStar_Parser_AST.Name lid -> p_quident lid
    | FStar_Parser_AST.Op (op,e1::[]) when is_general_prefix_op op ->
        let uu____5618 = str (FStar_Ident.text_of_id op)  in
        let uu____5619 = p_atomicTerm e1  in
        FStar_Pprint.op_Hat_Hat uu____5618 uu____5619
    | uu____5620 -> p_atomicTermNotQUident e

and (p_atomicTermNotQUident : FStar_Parser_AST.term -> FStar_Pprint.document)
  =
  fun e  ->
    let uu____5622 =
      let uu____5623 = unparen e  in uu____5623.FStar_Parser_AST.tm  in
    ...
    | FStar_Parser_AST.Name lid when
        ...
        str "False"
    | FStar_Parser_AST.Op (op,e1::[]) when is_general_prefix_op op ->
        let uu____5636 = str (FStar_Ident.text_of_id op)  in
        let uu____5637 = p_atomicTermNotQUident e1  in
        FStar_Pprint.op_Hat_Hat uu____5636 uu____5637
    | FStar_Parser_AST.Op (op,[]) ->
        let uu____5641 =
          let uu____5642 =
            let uu____5643 = str (FStar_Ident.text_of_id op)  in
            let uu____5644 =
              FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.rparen
               in
            FStar_Pprint.op_Hat_Hat uu____5643 uu____5644  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5642  in
        FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____5641
    | FStar_Parser_AST.Construct (lid,args) when is_dtuple_constructor lid ->
        let uu____5659 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen FStar_Pprint.bar  in
        let uu____5660 =
          let uu____5661 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
             in
          let uu____5662 = FStar_List.map FStar_Pervasives_Native.fst args
             in
          FStar_Pprint.separate_map uu____5661 p_tmEq uu____5662  in
        let uu____5669 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rparen  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____5659 uu____5660 uu____5669
    | FStar_Parser_AST.Project (e1,lid) ->
        let uu____5672 =
          let uu____5673 = p_atomicTermNotQUident e1  in
          let uu____5674 =
            let uu____5675 = p_qlident lid  in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5675  in
          FStar_Pprint.prefix (Prims.parse_int "2") (Prims.parse_int "0")
            uu____5673 uu____5674
           in
        FStar_Pprint.group uu____5672
    | uu____5676 -> p_projectionLHS e

and (p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    let uu____5678 =
      let uu____5679 = unparen e  in uu____5679.FStar_Parser_AST.tm  in
    match uu____5678 with
    | FStar_Parser_AST.Var lid -> p_qlident lid
    | FStar_Parser_AST.Projector (constr_lid,field_lid) ->
        let uu____5683 = p_quident constr_lid  in
        let uu____5684 =
          let uu____5685 =
            let uu____5686 = p_lident field_lid  in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____5686  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____5685  in
        FStar_Pprint.op_Hat_Hat uu____5683 uu____5684
    | FStar_Parser_AST.Discrim constr_lid ->
        let uu____5688 = p_quident constr_lid  in
        FStar_Pprint.op_Hat_Hat uu____5688 FStar_Pprint.qmark
    | FStar_Parser_AST.Paren e1 ->
        let uu____5690 = p_term e1  in soft_parens_with_nesting uu____5690
    | uu____5691 when is_array e ->
        let es = extract_from_list e  in
        let uu____5695 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lbracket FStar_Pprint.bar  in
        let uu____5696 =
          let uu____5697 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
          separate_map_or_flow uu____5697 p_noSeqTerm es  in
        let uu____5698 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bar FStar_Pprint.rbracket  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          uu____5695 uu____5696 uu____5698
    | uu____5699 when is_list e ->
        let uu____5700 =
          let uu____5701 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
          let uu____5702 = extract_from_list e  in
          separate_map_or_flow uu____5701 p_noSeqTerm uu____5702  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          FStar_Pprint.lbracket uu____5700 FStar_Pprint.rbracket
    | uu____5705 when is_lex_list e ->
        let uu____5706 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.percent FStar_Pprint.lbracket
           in
        let uu____5707 =
          let uu____5708 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1
             in
          let uu____5709 = extract_from_list e  in
          separate_map_or_flow uu____5708 p_noSeqTerm uu____5709  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
          uu____5706 uu____5707 FStar_Pprint.rbracket
    | uu____5712 when is_ref_set e ->
        let es = extract_from_ref_set e  in
        let uu____5716 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.bang FStar_Pprint.lbrace  in
        let uu____5717 =
          let uu____5718 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1
             in
          separate_map_or_flow uu____5718 p_appTerm es  in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
          uu____5716 uu____5717 FStar_Pprint.rbrace
    | FStar_Parser_AST.Labeled (e1,s,b) ->
        let uu____5722 = str (Prims.strcat "(*" (Prims.strcat s "*)"))  in
        let uu____5723 = p_term e1  in
        FStar_Pprint.op_Hat_Slash_Hat uu____5722 uu____5723
    | FStar_Parser_AST.Op (op,args) when
        let uu____5730 = handleable_op op args  in
        Prims.op_Negation uu____5730 ->
        let uu____5731 =
          let uu____5732 =
            let uu____5733 =
              let uu____5734 =
                ...
                Prims.strcat uu____5735
                  " arguments couldn't be handled by the pretty printer"
                 in
              Prims.strcat " with " uu____5734  in
            Prims.strcat (FStar_Ident.text_of_id op) uu____5733  in
          Prims.strcat "Operation " uu____5732  in
        failwith uu____5731
    | FStar_Parser_AST.Uvar uu____5736 ->
        failwith "Unexpected universe variable out of universe context"
    | FStar_Parser_AST.Wild  ->
        let uu____5737 = p_term e  in soft_parens_with_nesting uu____5737
    | FStar_Parser_AST.Const uu____5738 ->
        let uu____5739 = p_term e  in soft_parens_with_nesting uu____5739
    | FStar_Parser_AST.Op uu____5740 ->
        let uu____5747 = p_term e  in soft_parens_with_nesting uu____5747
    | FStar_Parser_AST.Tvar uu____5748 ->
        let uu____5749 = p_term e  in soft_parens_with_nesting uu____5749
    | FStar_Parser_AST.Var uu____5750 ->
        let uu____5751 = p_term e  in soft_parens_with_nesting uu____5751
    | FStar_Parser_AST.Name uu____5752 ->
        let uu____5753 = p_term e  in soft_parens_with_nesting uu____5753
    | FStar_Parser_AST.Construct uu____5754 ->
        let uu____5765 = p_term e  in soft_parens_with_nesting uu____5765
    | FStar_Parser_AST.Abs uu____5766 ->
        let uu____5773 = p_term e  in soft_parens_with_nesting uu____5773
    | FStar_Parser_AST.App uu____5774 ->
        let uu____5781 = p_term e  in soft_parens_with_nesting uu____5781
    | FStar_Parser_AST.Let uu____5782 ->
        let uu____5801 = p_term e  in soft_parens_with_nesting uu____5801
    | FStar_Parser_AST.LetOpen uu____5802 ->
        let uu____5807 = p_term e  in soft_parens_with_nesting uu____5807
    | FStar_Parser_AST.Seq uu____5808 ->
        let uu____5813 = p_term e  in soft_parens_with_nesting uu____5813
    | FStar_Parser_AST.Bind uu____5814 ->
        let uu____5821 = p_term e  in soft_parens_with_nesting uu____5821
    | FStar_Parser_AST.If uu____5822 ->
        let uu____5829 = p_term e  in soft_parens_with_nesting uu____5829
    | FStar_Parser_AST.Match uu____5830 ->
        let uu____5845 = p_term e  in soft_parens_with_nesting uu____5845
    | FStar_Parser_AST.TryWith uu____5846 ->
        let uu____5861 = p_term e  in soft_parens_with_nesting uu____5861
    | FStar_Parser_AST.Ascribed uu____5862 ->
        let uu____5871 = p_term e  in soft_parens_with_nesting uu____5871
    | FStar_Parser_AST.Record uu____5872 ->
        let uu____5885 = p_term e  in soft_parens_with_nesting uu____5885
    | FStar_Parser_AST.Project uu____5886 ->
        let uu____5891 = p_term e  in soft_parens_with_nesting uu____5891
    | FStar_Parser_AST.Product uu____5892 ->
        let uu____5899 = p_term e  in soft_parens_with_nesting uu____5899
    | FStar_Parser_AST.Sum uu____5900 ->
        let uu____5907 = p_term e  in soft_parens_with_nesting uu____5907
    | FStar_Parser_AST.QForall uu____5908 ->
        let uu____5921 = p_term e  in soft_parens_with_nesting uu____5921
    | FStar_Parser_AST.QExists uu____5922 ->
        let uu____5935 = p_term e  in soft_parens_with_nesting uu____5935
    | FStar_Parser_AST.Refine uu____5936 ->
        let uu____5941 = p_term e  in soft_parens_with_nesting uu____5941
    | FStar_Parser_AST.NamedTyp uu____5942 ->
        let uu____5947 = p_term e  in soft_parens_with_nesting uu____5947
    | FStar_Parser_AST.Requires uu____5948 ->
        let uu____5955 = p_term e  in soft_parens_with_nesting uu____5955
    | FStar_Parser_AST.Ensures uu____5956 ->
        let uu____5963 = p_term e  in soft_parens_with_nesting uu____5963
    | FStar_Parser_AST.Assign uu____5964 ->
        let uu____5969 = p_term e  in soft_parens_with_nesting uu____5969
    | FStar_Parser_AST.Attributes uu____5970 ->
        let uu____5973 = p_term e  in soft_parens_with_nesting uu____5973

and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___63_5974  ->
    match uu___63_5974 with
    | FStar_Const.Const_effect  -> str "Effect"
    | FStar_Const.Const_unit  -> str "()"
    | FStar_Const.Const_bool b -> FStar_Pprint.doc_of_bool b
    | FStar_Const.Const_float x -> str (FStar_Util.string_of_float x)
    | FStar_Const.Const_char x ->
        let uu____5978 = FStar_Pprint.doc_of_char x  in
        FStar_Pprint.squotes uu____5978
    | FStar_Const.Const_string (s,uu____5980) ->
        let uu____5981 = str s  in FStar_Pprint.dquotes uu____5981
    | FStar_Const.Const_bytearray (bytes,uu____5983) ->
        let uu____5988 =
          let uu____5989 = str (FStar_Util.string_of_bytes bytes)  in
          FStar_Pprint.dquotes uu____5989  in
        let uu____5990 = str "B"  in
        FStar_Pprint.op_Hat_Hat uu____5988 uu____5990
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___61_6008 =
          match uu___61_6008 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___62_6012 =
          match uu___62_6012 with
        ...
        let ending =
          default_or_map FStar_Pprint.empty
            (fun uu____6023  ->
               ...
               | (s,w) ->
                   let uu____6030 = signedness s  in
                   let uu____6031 = width w  in
                   FStar_Pprint.op_Hat_Hat uu____6030 uu____6031)
            sign_width_opt
           in
        let uu____6032 = str repr  in
        FStar_Pprint.op_Hat_Hat uu____6032 ending
    | FStar_Const.Const_range_of  -> str "range_of"
    | FStar_Const.Const_set_range_of  -> str "set_range_of"
    | FStar_Const.Const_range r ->
        let uu____6034 = FStar_Range.string_of_range r  in str uu____6034
    | FStar_Const.Const_reify  -> str "reify"
    | FStar_Const.Const_reflect lid ->
        let uu____6036 = p_quident lid  in
        let uu____6037 =
          let uu____6038 =
            let uu____6039 = str "reflect"  in
            FStar_Pprint.op_Hat_Hat FStar_Pprint.dot uu____6039  in
          FStar_Pprint.op_Hat_Hat FStar_Pprint.qmark uu____6038  in
        FStar_Pprint.op_Hat_Hat uu____6036 uu____6037

and (p_universe : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    let uu____6041 = str "u#"  in
    let uu____6042 = p_atomicUniverse u  in
    FStar_Pprint.op_Hat_Hat uu____6041 uu____6042

and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    let uu____6044 =
      let uu____6045 = unparen u  in uu____6045.FStar_Parser_AST.tm  in
    match uu____6044 with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6046;_},u1::u2::[])
        ->
        let uu____6051 =
          let uu____6052 = p_universeFrom u1  in
          let uu____6053 =
            let uu____6054 = p_universeFrom u2  in
            FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.plus uu____6054  in
          FStar_Pprint.op_Hat_Slash_Hat uu____6052 uu____6053  in
        FStar_Pprint.group uu____6051
    | FStar_Parser_AST.App uu____6055 ->
        let uu____6062 = head_and_args u  in
        (match uu____6062 with
         | (head1,args) ->
             let uu____6087 =
               let uu____6088 = unparen head1  in
               uu____6088.FStar_Parser_AST.tm  in
             (match uu____6087 with
              | FStar_Parser_AST.Var maybe_max_lid when
                  ...
                  ->
                  let uu____6090 =
                    let uu____6091 = p_qlident FStar_Parser_Const.max_lid  in
                    let uu____6092 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____6100  ->
                           match uu____6100 with
                           | (u1,uu____6106) -> p_atomicUniverse u1) args
                       in
                    op_Hat_Slash_Plus_Hat uu____6091 uu____6092  in
                  FStar_Pprint.group uu____6090
              | uu____6107 ->
                  let uu____6108 =
                    let uu____6109 = FStar_Parser_AST.term_to_string u  in
                    FStar_Util.format1 "Invalid term in universe context %s"
                      uu____6109
                     in
                  failwith uu____6108))
    | uu____6110 -> p_atomicUniverse u

and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    let uu____6112 =
      let uu____6113 = unparen u  in uu____6113.FStar_Parser_AST.tm  in
    ...
    | FStar_Parser_AST.Paren u1 ->
        let uu____6136 = p_universeFrom u1  in
        soft_parens_with_nesting uu____6136
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6137;_},uu____6138::uu____6139::[])
        ->
        let uu____6142 = p_universeFrom u  in
        soft_parens_with_nesting uu____6142
    | FStar_Parser_AST.App uu____6143 ->
        let uu____6150 = p_universeFrom u  in
        soft_parens_with_nesting uu____6150
    | uu____6151 ->
        let uu____6152 =
          let uu____6153 = FStar_Parser_AST.term_to_string u  in
          FStar_Util.format1 "Invalid term in universe context %s" uu____6153
           in
        failwith uu____6152
...
let (modul_to_document : FStar_Parser_AST.modul -> FStar_Pprint.document) =
  fun m  ->
    ...
    (let res =
       match m with
       | FStar_Parser_AST.Module (uu____6193,decls) ->
           let uu____6199 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document)  in
           FStar_All.pipe_right uu____6199
             (FStar_Pprint.separate FStar_Pprint.hardline)
       | FStar_Parser_AST.Interface (uu____6208,decls,uu____6210) ->
           let uu____6215 =
             FStar_All.pipe_right decls (FStar_List.map decl_to_document)  in
...
let (comments_to_document :
  ...
  fun comments  ->
    FStar_Pprint.separate_map FStar_Pprint.hardline
      (fun uu____6266  ->
         match uu____6266 with | (comment,range) -> str comment) comments
...
let (modul_with_comments_to_document :
  ...
  fun m  ->
    fun comments  ->
      let decls =
        match m with
        | FStar_Parser_AST.Module (uu____6306,decls) -> decls
        | FStar_Parser_AST.Interface (uu____6312,decls,uu____6314) -> decls
         in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
           ...
           let uu____6359 =
             ...
             | {
                 FStar_Parser_AST.d = FStar_Parser_AST.Pragma
                   (FStar_Parser_AST.LightOff );
                 FStar_Parser_AST.drange = uu____6372;
                 FStar_Parser_AST.doc = uu____6373;
                 FStar_Parser_AST.quals = uu____6374;
                 FStar_Parser_AST.attrs = uu____6375;_}::uu____6376 ->
                 let d0 = FStar_List.hd ds  in
                 let uu____6382 =
                   let uu____6385 =
                     let uu____6388 = FStar_List.tl ds  in d :: uu____6388
                      in
                   d0 :: uu____6385  in
                 (uu____6382, (d0.FStar_Parser_AST.drange))
             | uu____6393 -> ((d :: ds), (d.FStar_Parser_AST.drange))  in
           (match uu____6359 with
            | (decls1,first_range) ->
                let extract_decl_range d1 = d1.FStar_Parser_AST.drange  in
                (FStar_ST.op_Colon_Equals comment_stack comments;
                 (let initial_comment =
                    let uu____6451 = FStar_Range.start_of_range first_range
                       in
                    place_comments_until_pos (Prims.parse_int "0")
                      (Prims.parse_int "1") uu____6451 FStar_Pprint.empty
                     in
                  let doc1 =
