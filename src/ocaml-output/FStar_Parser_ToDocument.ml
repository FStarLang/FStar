...
let level_table:
  ...
  =
  let levels_from_associativity l uu___130_948 =
    match uu___130_948 with
...
and p_constant: FStar_Const.sconst -> FStar_Pprint.document =
  fun uu___141_3659  ->
    ...
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___139_3687 =
          match uu___139_3687 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty in
        let width uu___140_3691 =
          match uu___140_3691 with
