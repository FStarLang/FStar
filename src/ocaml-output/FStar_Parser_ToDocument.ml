...
let (level_table :
  ...
  let levels_from_associativity l uu___14_1993 =
    match uu___14_1993 with
...
and (p_list :
  ...
  fun f  ->
    fun sep  ->
      fun l  ->
        let rec p_list' uu___15_5278 =
          match uu___15_5278 with
          | [] -> FStar_Pprint.empty
          | x::[] -> f x
          | x::xs ->
...
and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___26_11237  ->
    ...
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___24_11281 =
          match uu___24_11281 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___25_11288 =
          match uu___25_11288 with
