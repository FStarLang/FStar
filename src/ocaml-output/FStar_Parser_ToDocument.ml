  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var lid;
           ...
           FStar_Parser_AST.level = uu____771;_},
           ...
           FStar_Parser_AST.level = uu____780;_},
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_addr_of_lid;
                FStar_Parser_AST.range = uu____782;
                FStar_Parser_AST.level = uu____783;_},
              e1, FStar_Parser_AST.Nothing);
           FStar_Parser_AST.range = uu____785;
           FStar_Parser_AST.level = uu____786;_},
        ...
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var maybe_union_lid;
                ...
                FStar_Parser_AST.level = uu____789;_},
              e1, FStar_Parser_AST.Nothing);
  ...
  fun e ->
    ...
    | FStar_Parser_AST.App
        ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____803;
         ...
         {
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____806;
                FStar_Parser_AST.range = uu____807;
                FStar_Parser_AST.level = uu____808;_},
              e1, FStar_Parser_AST.Nothing);
        ...
        ({
           FStar_Parser_AST.tm = FStar_Parser_AST.App
             ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var uu____812;
                ...
                FStar_Parser_AST.level = uu____814;_},
              e1, FStar_Parser_AST.Nothing);
...
let (uu___is_Right : associativity -> Prims.bool) =
  fun projectee -> match projectee with | Right -> true | uu____922 -> false
...
let opinfix4 :
  'Auu____1051 .
    Prims.unit ->
      (associativity,
        ('Auu____1051, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix3 :
  'Auu____1078 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1078) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  =
  fun uu____1090 ->
...
let opinfix2 :
  'Auu____1125 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1125) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let minus_lvl :
  'Auu____1165 .
    Prims.unit ->
      (associativity,
        ('Auu____1165, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let pipe_right :
  'Auu____1232 .
    Prims.unit ->
      (associativity,
        ('Auu____1232, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0d :
  'Auu____1259 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1259) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0c :
  'Auu____1292 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1292) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  =
  fun uu____1304 ->
...
let equal :
  'Auu____1339 .
    Prims.unit ->
      (associativity,
        ('Auu____1339, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0b :
  'Auu____1366 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1366) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let opinfix0a :
  'Auu____1399 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____1399) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let colon_equals :
  'Auu____1432 .
    Prims.unit ->
      (associativity,
        ('Auu____1432, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let amp :
  'Auu____1459 .
    Prims.unit ->
      (associativity,
        ('Auu____1459, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
...
let colon_colon :
  'Auu____1486 .
    Prims.unit ->
      (associativity,
        ('Auu____1486, Prims.string) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2
  ...
  fun l ->
    let find_level_and_max n1 level =
      ...
      | FStar_Pervasives_Native.Some
          ((uu____2113, l1, uu____2115), uu____2116) -> max n1 l1
...
let operatorInfix0ad12 :
  'Auu____2231 .
    Prims.unit ->
      (associativity,
        (FStar_Char.char, 'Auu____2231) FStar_Util.either Prims.list)
        FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun uu____2245 ->
    [opinfix0a ();
    ...
    | FStar_Parser_AST.ResetOptions s_opt ->
        ...
        let uu____3652 =
          FStar_Pprint.optional
            (fun s ->
               let uu____3656 =
                 let uu____3657 = str s in FStar_Pprint.dquotes uu____3657 in
               FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____3656) s_opt in
                   ...
                   (fun t ->
                      let uu____3997 =
                        let uu____3998 =
                          ...
                          FStar_Pprint.op_Hat_Hat FStar_Pprint.space
                            uu____3999 in
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____3998 in
                      FStar_Pprint.op_Hat_Hat break1 uu____3997) typ_opt in
          ...
          let uu____4056 =
            default_or_map uid_doc
              (fun t ->
                 ...
                 op_Hat_Slash_Plus_Hat uu____4061 uu____4063) t_opt in
                  ...
                  let uu____4108 =
                    let uu____4109 =
                      let uu____4110 =
                        ...
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4111 in
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____4110 in
                  ...
                  let uu____4112 =
                    let uu____4113 =
                      ...
                      let uu____4115 =
                        ...
                        FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____4116 in
              ...
              | FStar_Parser_AST.PatApp
                  ({
                     FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                       (x, uu____4121);
                     FStar_Parser_AST.prange = uu____4122;_},
                   pats)
                  ->
                  let uu____4132 =
          ...
          let uu____4187 =
            let uu____4188 =
              let uu____4189 =
                ...
                FStar_Pprint.surround (Prims.parse_int "2")
                  (Prims.parse_int "1") uu____4190 uu____4191 uu____4192 in
    ...
    let lift_op_doc =
      ...
      let p_lift ps uu____4291 =
        ...
        | (kwd, t) ->
            ...
            prefix2 uu____4298 uu____4301 in
...
and (p_tuplePattern : FStar_Parser_AST.pattern -> FStar_Pprint.document) =
  fun p ->
    ...
    | FStar_Parser_AST.PatTuple (pats, false) ->
        let uu____4335 =
          let uu____4336 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
  ...
  fun p ->
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName maybe_cons_lid;
           FStar_Parser_AST.prange = uu____4340;_},
         hd1::tl1::[])
        when
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uid;
           FStar_Parser_AST.prange = uu____4349;_},
         pats)
        ->
  ...
  fun p ->
        ...
        (match ((pat.FStar_Parser_AST.pat), (t.FStar_Parser_AST.tm)) with
         | (FStar_Parser_AST.PatVar (lid, aqual), FStar_Parser_AST.Refine
            ({ FStar_Parser_AST.b = FStar_Parser_AST.Annotated (lid', t1);
               ...
               FStar_Parser_AST.aqual = uu____4375;_},
         ...
         | (FStar_Parser_AST.PatWild, FStar_Parser_AST.Refine
            ({ FStar_Parser_AST.b = FStar_Parser_AST.NoName t1;
               ...
               FStar_Parser_AST.aqual = uu____4386;_},
             phi)) ->
             let uu____4388 =
         ...
         | uu____4389 ->
             let uu____4394 =
               ...
               let uu____4396 =
                 let uu____4397 = FStar_Pprint.break_ (Prims.parse_int "0") in
                 let uu____4398 =
    ...
    | FStar_Parser_AST.PatRecord pats ->
        let p_recordFieldPat uu____4418 =
          ...
          | (lid, pat) ->
              ...
              infix2 FStar_Pprint.equals uu____4425 uu____4426 in
        let uu____4427 =
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName uu____4467;
           FStar_Parser_AST.prange = uu____4468;_},
         uu____4469)
        ->
          ...
          let doc1 =
            ...
            | FStar_Parser_AST.Refine
                ({
                   ...
                   FStar_Parser_AST.aqual = uu____4497;_},
                 phi)
          ...
          (match t.FStar_Parser_AST.tm with
           | FStar_Parser_AST.Refine
               ({ FStar_Parser_AST.b = FStar_Parser_AST.NoName t1;
                  ...
                  FStar_Parser_AST.aqual = uu____4520;_},
                phi)
               ->
               if is_atomic
               then
                   ...
                   let uu____4523 =
                     let uu____4524 =
                       p_refinement b.FStar_Parser_AST.aqual
                         FStar_Pprint.underscore t1 phi in
                     FStar_Pprint.op_Hat_Hat uu____4524 FStar_Pprint.rparen in
  ...
  fun ps ->
    fun pb ->
      fun e ->
            ...
            let uu____4592 =
              ...
              let uu____4594 =
                let uu____4595 =
                  ...
                  FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____4596 in
            ...
            let uu____4602 =
              ...
              let uu____4604 =
                let uu____4605 =
                  ...
                  FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon uu____4606 in
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ".()<-";
               FStar_Ident.idRange = uu____4611;_},
             e1::e2::e3::[])
            ->
            let uu____4617 =
              let uu____4618 =
              ...
              let uu____4626 =
                let uu____4627 = p_noSeqTerm ps pb e3 in jump2 uu____4627 in
              FStar_Pprint.op_Hat_Hat uu____4618 uu____4626 in
            FStar_Pprint.group uu____4617
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ".[]<-";
               FStar_Ident.idRange = uu____4628;_},
             e1::e2::e3::[])
            ->
            let uu____4634 =
              let uu____4635 =
              ...
              let uu____4643 =
                let uu____4644 = p_noSeqTerm ps pb e3 in jump2 uu____4644 in
            ...
            let uu____4765 =
              let uu____4766 =
                let uu____4767 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____4768 uu____4769 uu____4770 in
                let uu____4771 =
                  separate_map_last FStar_Pprint.hardline p_patternBranch
                    branches in
            ...
            let uu____4785 =
              let uu____4786 =
                let uu____4787 =
                  ...
                  FStar_Pprint.surround (Prims.parse_int "2")
                    (Prims.parse_int "1") uu____4788 uu____4789 uu____4790 in
        ...
        | FStar_Parser_AST.Let (q, (a0, lb0)::attr_letbindings, e1) ->
            ...
            let let_rest =
              ...
              | uu____4877 ->
                  ...
                  FStar_Pprint.group uu____4892 in
            let uu____4905 =
              let uu____4906 =
                let uu____4907 =
            ...
            ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, typ_opt);
               FStar_Parser_AST.prange = uu____4915;_}::[],
             {
               FStar_Parser_AST.tm = FStar_Parser_AST.Match
                 (maybe_x, branches);
               FStar_Parser_AST.range = uu____4918;
               FStar_Parser_AST.level = uu____4919;_})
      ...
      fun e ->
        ...
        | FStar_Parser_AST.QForall (bs, trigger, e1) ->
            let uu____5048 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5049 uu____5051 FStar_Pprint.dot in
            let uu____5052 =
        ...
        | FStar_Parser_AST.QExists (bs, trigger, e1) ->
            let uu____5070 =
              ...
              FStar_Pprint.soft_surround (Prims.parse_int "2")
                (Prims.parse_int "0") uu____5071 uu____5073 FStar_Pprint.dot in
            let uu____5074 =
    ...
    | pats ->
        let uu____5118 =
          let uu____5119 =
            ...
            let uu____5121 =
              let uu____5122 =
                let uu____5123 = p_disjunctivePats pats in jump2 uu____5123 in
              let uu____5124 =
                ...
                let uu____5178 =
                  let uu____5179 =
                    ...
                    let uu____5181 =
                      ...
                      FStar_Pprint.op_Hat_Hat uu____5182 FStar_Pprint.rarrow in
...
and (p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "<==>"; FStar_Ident.idRange = uu____5192;_},
         e1::e2::[])
        ->
...
and (p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "==>"; FStar_Ident.idRange = uu____5202;_},
         e1::e2::[])
        ->
              ...
              separate_map_or_flow FStar_Pprint.empty
                (fun b ->
                   ...
                   let uu____5228 =
                     ...
                     FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5229 in
                   FStar_Pprint.op_Hat_Hat uu____5227 uu____5228) bs in
...
and (p_tmFormula : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "\\/"; FStar_Ident.idRange = uu____5233;_},
         e1::e2::[])
        ->
...
and (p_tmConjunction : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "/\\"; FStar_Ident.idRange = uu____5243;_},
         e1::e2::[])
        ->
...
and (p_tmTuple' : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_tuple_constructor lid ->
        let uu____5268 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
  ...
  fun p_X ->
    fun curr ->
      fun e ->
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = ":="; FStar_Ident.idRange = uu____5366;_},
             e1::e2::[])
            ->
            let uu____5371 =
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = "-"; FStar_Ident.idRange = uu____5377;_},
             e1::[])
            ->
  ...
  fun p_X ->
    fun curr ->
      fun e ->
             ...
             | (left1, mine, right1) ->
                 let p_dsumfst b =
                   ...
                   let uu____5523 =
                     ...
                     FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5524 in
                   FStar_Pprint.op_Hat_Hat uu____5522 uu____5523 in
                 let uu____5526 =
                   let uu____5527 = FStar_Pprint.concat_map p_dsumfst binders in
        ...
        | FStar_Parser_AST.Op
            ({ FStar_Ident.idText = "~"; FStar_Ident.idRange = uu____5575;_},
             e1::[])
            ->
            let uu____5579 =
      ...
      | (lid, e) ->
          let uu____5629 =
            ...
            let uu____5631 =
              ...
              FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.equals uu____5632 in
         ...
         | (head1, args) ->
             let uu____5666 =
               ...
               then
                 ...
                 (let uu____5789 = p_indexingTerm head1 in (uu____5789, args)) in
...
and (p_indexingTerm_aux :
  ...
  fun exit1 ->
    fun e ->
      match e.FStar_Parser_AST.tm with
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".()"; FStar_Ident.idRange = uu____5904;_},
           e1::e2::[])
          ->
          let uu____5909 =
      ...
      | FStar_Parser_AST.Op
          ({ FStar_Ident.idText = ".[]"; FStar_Ident.idRange = uu____5914;_},
           e1::e2::[])
          ->
          let uu____5919 =
  ...
  fun e ->
    ...
    | FStar_Parser_AST.Construct (lid, args) when is_dtuple_constructor lid
        ...
        let uu____5977 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen FStar_Pprint.bar in
        let uu____5978 =
          let uu____5979 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
          let uu____5980 = FStar_List.map FStar_Pervasives_Native.fst args in
...
and (p_projectionLHS : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e ->
    ...
    | uu____6007 when is_array e ->
        ...
        let uu____6012 =
          let uu____6013 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
    ...
    | uu____6017 when is_list e ->
        let uu____6018 =
          let uu____6019 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____6020 = extract_from_list e in
          separate_map_or_flow_last uu____6019
            (fun ps -> p_noSeqTerm ps false) uu____6020 in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "0")
    ...
    | uu____6025 when is_lex_list e ->
        ...
        let uu____6027 =
          let uu____6028 = FStar_Pprint.op_Hat_Hat FStar_Pprint.semi break1 in
          let uu____6029 = extract_from_list e in
          separate_map_or_flow_last uu____6028
            (fun ps -> p_noSeqTerm ps false) uu____6029 in
        FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1")
    ...
    | uu____6034 when is_ref_set e ->
        ...
        let uu____6039 =
          let uu____6040 = FStar_Pprint.op_Hat_Hat FStar_Pprint.comma break1 in
...
and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    ...
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6370;_},
         u1::u2::[])
        ->
        let uu____6375 =
                    ...
                    let uu____6414 =
                      FStar_Pprint.separate_map FStar_Pprint.space
                        (fun uu____6422 ->
                           ...
                           | (u1, uu____6428) -> p_atomicUniverse u1) args in
...
and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u ->
    ...
    | FStar_Parser_AST.Op
        ({ FStar_Ident.idText = "+"; FStar_Ident.idRange = uu____6457;_},
    ...
    | uu____6471 ->
        let uu____6472 =
          ...
          FStar_Util.format1 "Invalid term in universe context %s" uu____6473 in
        failwith uu____6472
  ...
  fun m ->
    fun comments ->
      let decls =
        ...
        | FStar_Parser_AST.Interface (uu____6632, decls, uu____6634) -> decls in
      FStar_ST.op_Colon_Equals should_print_fs_typ_app false;
      (match decls with
       ...
       | d::ds ->
           let uu____6679 =
             ...
             | {
                 ...
                 let uu____6702 =
                   let uu____6705 =
                     let uu____6708 = FStar_List.tl ds in d :: uu____6708 in
                   d0 :: uu____6705 in
