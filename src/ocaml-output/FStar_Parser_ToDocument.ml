...
let map_if_all : 'a 'b . ('a  ->  'b FStar_Pervasives_Native.option)  ->  'a Prims.list  ->  'b Prims.list FStar_Pervasives_Native.option = (fun f l -> (
...
let all_explicit : (FStar_Parser_AST.term * FStar_Parser_AST.imp) Prims.list  ->  Prims.bool = (fun args -> (FStar_Util.for_all (fun uu___0_261 -> (match (uu___0_261) with
| (uu____267, FStar_Parser_AST.Nothing) -> begin
true
end
| uu____269 -> begin
false
...
let with_fs_typ_app : 'Auu____298 'Auu____299 . Prims.bool  ->  ('Auu____298  ->  'Auu____299)  ->  'Auu____298  ->  'Auu____299 = (fun b printer t -> (
...
let default_or_map : 'Auu____409 'Auu____410 . 'Auu____409  ->  ('Auu____410  ->  'Auu____409)  ->  'Auu____410 FStar_Pervasives_Native.option  ->  'Auu____409 = (fun n1 f x -> (match (x) with
| FStar_Pervasives_Native.None -> begin
n1
end
...
let separate_break_map : 'Auu____523 . FStar_Pprint.document  ->  ('Auu____523  ->  FStar_Pprint.document)  ->  'Auu____523 Prims.list  ->  FStar_Pprint.document = (fun sep f l -> (

let uu____548 = (

let uu____549 = (

let uu____550 = (FStar_Pprint.op_Hat_Hat sep break1)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____550))
in (FStar_Pprint.separate_map uu____549 f l))
in (FStar_Pprint.group uu____548)))


let precede_break_separate_map : 'Auu____562 . FStar_Pprint.document  ->  FStar_Pprint.document  ->  ('Auu____562  ->  FStar_Pprint.document)  ->  'Auu____562 Prims.list  ->  FStar_Pprint.document = (fun prec sep f l -> (

let uu____592 = (

let uu____593 = (FStar_Pprint.op_Hat_Hat prec FStar_Pprint.space)
in (

let uu____594 = (

let uu____595 = (FStar_List.hd l)
in (FStar_All.pipe_right uu____595 f))
in (FStar_Pprint.precede uu____593 uu____594)))
in (

let uu____596 = (

let uu____597 = (FStar_List.tl l)
...
let uu____605 = (f x)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____605))
in (FStar_Pprint.op_Hat_Hat sep uu____604))
in (FStar_Pprint.op_Hat_Hat break1 uu____603))) uu____597))
in (FStar_Pprint.op_Hat_Hat uu____592 uu____596))))


let concat_break_map : 'Auu____613 . ('Auu____613  ->  FStar_Pprint.document)  ->  'Auu____613 Prims.list  ->  FStar_Pprint.document = (fun f l -> (

let uu____633 = (FStar_Pprint.concat_map (fun x -> (

let uu____637 = (f x)
in (FStar_Pprint.op_Hat_Hat uu____637 break1))) l)
in (FStar_Pprint.group uu____633)))
...
let uu____700 = (str "begin")
in (

let uu____702 = (str "end")
in (FStar_Pprint.soft_surround (Prims.parse_int "2") (Prims.parse_int "1") uu____700 contents uu____702))))


let separate_map_last : 'Auu____715 . FStar_Pprint.document  ->  (Prims.bool  ->  'Auu____715  ->  FStar_Pprint.document)  ->  'Auu____715 Prims.list  ->  FStar_Pprint.document = (fun sep f es -> (
...
let separate_break_map_last : 'Auu____767 . FStar_Pprint.document  ->  (Prims.bool  ->  'Auu____767  ->  FStar_Pprint.document)  ->  'Auu____767 Prims.list  ->  FStar_Pprint.document = (fun sep f l -> (

let uu____799 = (

let uu____800 = (

let uu____801 = (FStar_Pprint.op_Hat_Hat sep break1)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____801))
in (separate_map_last uu____800 f l))
in (FStar_Pprint.group uu____799)))


let separate_map_or_flow : 'Auu____811 . FStar_Pprint.document  ->  ('Auu____811  ->  FStar_Pprint.document)  ->  'Auu____811 Prims.list  ->  FStar_Pprint.document = (fun sep f l -> (match (((FStar_List.length l) < (Prims.parse_int "10"))) with
| true -> begin
...
let flow_map_last : 'Auu____849 . FStar_Pprint.document  ->  (Prims.bool  ->  'Auu____849  ->  FStar_Pprint.document)  ->  'Auu____849 Prims.list  ->  FStar_Pprint.document = (fun sep f es -> (
...
let separate_map_or_flow_last : 'Auu____901 . FStar_Pprint.document  ->  (Prims.bool  ->  'Auu____901  ->  FStar_Pprint.document)  ->  'Auu____901 Prims.list  ->  FStar_Pprint.document = (fun sep f l -> (match (((FStar_List.length l) < (Prims.parse_int "10"))) with
| true -> begin
...
let uu____983 = (FStar_Pprint.op_Hat_Slash_Hat doc1 doc3)
in (FStar_Pprint.group uu____983))
end
| uu____984 -> begin
...
let soft_surround_separate_map : 'Auu____1005 . Prims.int  ->  Prims.int  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  ('Auu____1005  ->  FStar_Pprint.document)  ->  'Auu____1005 Prims.list  ->  FStar_Pprint.document = (fun n1 b void_ opening sep closing f xs -> (match ((Prims.op_Equality xs [])) with
| true -> begin
void_
end
| uu____1062 -> begin
...
let uu____1064 = (FStar_Pprint.separate_map sep f xs)
in (FStar_Pprint.soft_surround n1 b opening uu____1064 closing))
end))


let soft_surround_map_or_flow : 'Auu____1084 . Prims.int  ->  Prims.int  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  FStar_Pprint.document  ->  ('Auu____1084  ->  FStar_Pprint.document)  ->  'Auu____1084 Prims.list  ->  FStar_Pprint.document = (fun n1 b void_ opening sep closing f xs -> (match ((Prims.op_Equality xs [])) with
| true -> begin
void_
end
| uu____1141 -> begin
...
let uu____1143 = (separate_map_or_flow sep f xs)
in (FStar_Pprint.soft_surround n1 b opening uu____1143 closing))
end))


let doc_of_fsdoc : (Prims.string * (Prims.string * Prims.string) Prims.list)  ->  FStar_Pprint.document = (fun uu____1162 -> (match (uu____1162) with
...
let uu____1207 = (FStar_Pprint.separate_map FStar_Pprint.comma (fun uu____1218 -> (match (uu____1218) with
| (k, v1) -> begin
(

let uu____1231 = (

let uu____1234 = (str k)
in (
...
let uu____1241 = (str v1)
in (uu____1241)::[])
in (FStar_Pprint.rarrow)::uu____1238)
in (uu____1234)::uu____1235))
in (FStar_Pprint.concat uu____1231))
end)) keywords)
in (uu____1207)::[])
in (FStar_Pprint.space)::uu____1204)
in (uu____1200)::uu____1201))
in (FStar_Pprint.concat uu____1197))
in (FStar_Pprint.group uu____1196))
end))
...
let uu____1267 = (FStar_Ident.text_of_lid y)
in (Prims.op_Equality x.FStar_Ident.idText uu____1267))
end
| uu____1270 -> begin
false
end))
...
| FStar_Parser_AST.Construct (lid, (uu____1321)::((e2, uu____1323))::[]) -> begin
...
| FStar_Parser_AST.Construct (uu____1370, []) -> begin
[]
end
| FStar_Parser_AST.Construct (uu____1381, ((e1, FStar_Parser_AST.Nothing))::((e2, FStar_Parser_AST.Nothing))::[]) -> begin
(

let uu____1402 = (extract_from_list e2)
in (e1)::uu____1402)
end
| uu____1405 -> begin
(
...
let uu____1408 = (FStar_Parser_AST.term_to_string e)
in (FStar_Util.format1 "Not a list %s" uu____1408))
in (failwith uu____1406))
end))


let is_array : FStar_Parser_AST.term  ->  Prims.bool = (fun e -> (match (e.FStar_Parser_AST.tm) with
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (lid); FStar_Parser_AST.range = uu____1422; FStar_Parser_AST.level = uu____1423}, l, FStar_Parser_AST.Nothing) -> begin
((FStar_Ident.lid_equals lid FStar_Parser_Const.array_of_list_lid) && (is_list l))
end
| uu____1425 -> begin
false
end))
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_singleton_lid); FStar_Parser_AST.range = uu____1437; FStar_Parser_AST.level = uu____1438}, {FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_addr_of_lid); FStar_Parser_AST.range = uu____1440; FStar_Parser_AST.level = uu____1441}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = uu____1443; FStar_Parser_AST.level = uu____1444}, FStar_Parser_AST.Nothing) -> begin
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (maybe_union_lid); FStar_Parser_AST.range = uu____1446; FStar_Parser_AST.level = uu____1447}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = uu____1449; FStar_Parser_AST.level = uu____1450}, e2, FStar_Parser_AST.Nothing) -> begin
...
| FStar_Parser_AST.Var (uu____1464) -> begin
[]
end
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (uu____1465); FStar_Parser_AST.range = uu____1466; FStar_Parser_AST.level = uu____1467}, {FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (uu____1468); FStar_Parser_AST.range = uu____1469; FStar_Parser_AST.level = uu____1470}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = uu____1472; FStar_Parser_AST.level = uu____1473}, FStar_Parser_AST.Nothing) -> begin
(e1)::[]
end
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (uu____1474); FStar_Parser_AST.range = uu____1475; FStar_Parser_AST.level = uu____1476}, e1, FStar_Parser_AST.Nothing); FStar_Parser_AST.range = uu____1478; FStar_Parser_AST.level = uu____1479}, e2, FStar_Parser_AST.Nothing) -> begin
(

let uu____1481 = (extract_from_ref_set e1)
in (

let uu____1484 = (extract_from_ref_set e2)
in (FStar_List.append uu____1481 uu____1484)))
end
| uu____1487 -> begin
(
...
let uu____1490 = (FStar_Parser_AST.term_to_string e)
in (FStar_Util.format1 "Not a ref set %s" uu____1490))
in (failwith uu____1488))
end))


let is_general_application : FStar_Parser_AST.term  ->  Prims.bool = (fun e -> (

let uu____1502 = ((is_array e) || (is_ref_set e))
in (not (uu____1502))))


let is_general_construction : FStar_Parser_AST.term  ->  Prims.bool = (fun e -> (

let uu____1511 = ((is_list e) || (is_lex_list e))
in (not (uu____1511))))
...
let uu____1522 = (FStar_Ident.text_of_id op)
in (FStar_Util.char_at uu____1522 (Prims.parse_int "0")))
in (((Prims.op_Equality op_starting_char 33 (*!*)) || (Prims.op_Equality op_starting_char 63 (*?*))) || ((Prims.op_Equality op_starting_char 126 (*~*)) && (

let uu____1532 = (FStar_Ident.text_of_id op)
in (Prims.op_disEquality uu____1532 "~"))))))
...
let token_to_string : (FStar_BaseTypes.char, Prims.string) FStar_Util.either  ->  Prims.string = (fun uu___1_1670 -> (match (uu___1_1670) with
...
let matches_token : Prims.string  ->  (FStar_Char.char, Prims.string) FStar_Util.either  ->  Prims.bool = (fun s uu___2_1705 -> (match (uu___2_1705) with
| FStar_Util.Inl (c) -> begin
(

let uu____1718 = (FStar_String.get s (Prims.parse_int "0"))
in (Prims.op_Equality uu____1718 c))
end
| FStar_Util.Inr (s') -> begin
...
let matches_level : 'Auu____1734 . Prims.string  ->  ('Auu____1734 * (FStar_Char.char, Prims.string) FStar_Util.either Prims.list)  ->  Prims.bool = (fun s uu____1758 -> (match (uu____1758) with
| (assoc_levels, tokens) -> begin
(

let uu____1790 = (FStar_List.tryFind (matches_token s) tokens)
in (Prims.op_disEquality uu____1790 FStar_Pervasives_Native.None))
end))
...
let levels_from_associativity = (fun l uu___3_1962 -> (match (uu___3_1962) with
| Left -> begin
...
in (FStar_List.mapi (fun i uu____2012 -> (match (uu____2012) with
| (assoc1, tokens) -> begin
...
let uu____2087 = (FStar_List.tryFind (matches_level s) level_table)
in (match (uu____2087) with
| FStar_Pervasives_Native.Some (assoc_levels, uu____2139) -> begin
assoc_levels
end
| uu____2177 -> begin
...
let max_level : 'Auu____2210 . ('Auu____2210 * token Prims.list) Prims.list  ->  Prims.int = (fun l -> (

let find_level_and_max = (fun n1 level -> (

let uu____2259 = (FStar_List.tryFind (fun uu____2295 -> (match (uu____2295) with
| (uu____2312, tokens) -> begin
(Prims.op_Equality tokens (FStar_Pervasives_Native.snd level))
end)) level_table)
in (match (uu____2259) with
| FStar_Pervasives_Native.Some ((uu____2341, l1, uu____2343), uu____2344) -> begin
(max n1 l1)
end
| FStar_Pervasives_Native.None -> begin
(
...
let uu____2398 = (FStar_List.map token_to_string (FStar_Pervasives_Native.snd level))
in (FStar_String.concat "," uu____2398))
in (FStar_Util.format1 "Undefined associativity level %s" uu____2396))
in (failwith uu____2394))
end)))
...
let uu____2433 = (assign_levels level_associativity_spec op)
...
let uu____2501 = (FStar_Ident.text_of_id op)
in (FStar_All.pipe_left matches_level uu____2501))
in (FStar_List.tryFind uu____2495 operatorInfix0ad12))
in (Prims.op_disEquality uu____2492 FStar_Pervasives_Native.None)))
...
let uu____2601 = (FStar_Ident.text_of_id op)
in (FStar_All.pipe_left matches_level uu____2601))
in (FStar_List.tryFind uu____2583 opinfix34))
in (Prims.op_disEquality uu____2568 FStar_Pervasives_Native.None))))
...
let uu____2667 = ((is_general_prefix_op op) || (FStar_List.mem op_s (("-")::("~")::[])))
...
let uu____2680 = (((is_operatorInfix0ad12 op) || (is_operatorInfix34 op)) || (FStar_List.mem op_s (("<==>")::("==>")::("\\/")::("/\\")::("=")::("|>")::(":=")::(".()")::(".[]")::[])))
...
let handleable_op : 'Auu____2726 . FStar_Ident.ident  ->  'Auu____2726 Prims.list  ->  Prims.bool = (fun op args -> (match ((FStar_List.length args)) with
| _2742 when (_2742 = (Prims.parse_int "0")) -> begin
true
end
| _2744 when (_2744 = (Prims.parse_int "1")) -> begin
((is_general_prefix_op op) || (

let uu____2746 = (FStar_Ident.text_of_id op)
in (FStar_List.mem uu____2746 (("-")::("~")::[]))))
end
| _2754 when (_2754 = (Prims.parse_int "2")) -> begin
(((is_operatorInfix0ad12 op) || (is_operatorInfix34 op)) || (

let uu____2756 = (FStar_Ident.text_of_id op)
in (FStar_List.mem uu____2756 (("<==>")::("==>")::("\\/")::("/\\")::("=")::("|>")::(":=")::(".()")::(".[]")::[]))))
end
| _2778 when (_2778 = (Prims.parse_int "3")) -> begin
(

let uu____2779 = (FStar_Ident.text_of_id op)
in (FStar_List.mem uu____2779 ((".()<-")::(".[]<-")::[])))
end
| uu____2787 -> begin
false
end))
...
| FStar_Parser_AST.Annotated (uu____2927) -> begin
true
end
| uu____2933 -> begin
false
...
let uu____2966 = (FStar_List.for_all is_binder_annot bs)
...
let uu____2986 = (all_binders e (Prims.parse_int "0"))
...
let uu____3025 = (FStar_Pprint.op_Hat_Slash_Hat FStar_Pprint.colon y)
in (FStar_Pprint.op_Hat_Hat x uu____3025)))
...
let with_comment : 'Auu____3174 . ('Auu____3174  ->  FStar_Pprint.document)  ->  'Auu____3174  ->  FStar_Range.range  ->  FStar_Pprint.document = (fun printer tm tmrange -> (

let rec comments_before_pos = (fun acc print_pos lookahead_pos -> (

let uu____3216 = (FStar_ST.op_Bang comment_stack)
...
let uu____3287 = (str c)
in (FStar_Pprint.op_Hat_Hat uu____3287 FStar_Pprint.hardline))
in (

let uu____3288 = (FStar_Range.range_before_pos crange print_pos)
in (match (uu____3288) with
| true -> begin
((FStar_ST.op_Colon_Equals comment_stack cs);
(

let uu____3330 = (FStar_Pprint.op_Hat_Hat acc comment)
in (comments_before_pos uu____3330 print_pos lookahead_pos));
)
end
| uu____3331 -> begin
(

let uu____3333 = (FStar_Range.range_before_pos crange lookahead_pos)
in ((acc), (uu____3333)))
end)))
end)))
in (
...
let uu____3343 = (FStar_Range.start_of_range tmrange)
in (FStar_Range.end_of_line uu____3343))
in (

let uu____3344 = (FStar_Range.end_of_range tmrange)
in (comments_before_pos FStar_Pprint.empty uu____3342 uu____3344)))
...
let uu____3353 = (comments_before_pos comments pos pos)
in (FStar_Pervasives_Native.fst uu____3353)))
end
| uu____3360 -> begin
comments
end)
...
let uu____3365 = (FStar_Pprint.op_Hat_Hat comments1 printed_e)
in (FStar_Pprint.group uu____3365))
end)))
end))))


let with_comment_sep : 'Auu____3377 'Auu____3378 . ('Auu____3377  ->  'Auu____3378)  ->  'Auu____3377  ->  FStar_Range.range  ->  (FStar_Pprint.document * 'Auu____3378) = (fun printer tm tmrange -> (

let rec comments_before_pos = (fun acc print_pos lookahead_pos -> (

let uu____3424 = (FStar_ST.op_Bang comment_stack)
...
let uu____3495 = (FStar_Range.range_before_pos crange print_pos)
in (match (uu____3495) with
| true -> begin
((FStar_ST.op_Colon_Equals comment_stack cs);
(

let uu____3537 = (match ((Prims.op_Equality acc FStar_Pprint.empty)) with
| true -> begin
comment
end
| uu____3539 -> begin
...
let uu____3541 = (FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline comment)
in (FStar_Pprint.op_Hat_Hat acc uu____3541))
end)
in (comments_before_pos uu____3537 print_pos lookahead_pos));
)
end
| uu____3542 -> begin
(

let uu____3544 = (FStar_Range.range_before_pos crange lookahead_pos)
in ((acc), (uu____3544)))
end)))
end)))
in (
...
let uu____3554 = (FStar_Range.start_of_range tmrange)
in (FStar_Range.end_of_line uu____3554))
in (

let uu____3555 = (FStar_Range.end_of_range tmrange)
in (comments_before_pos FStar_Pprint.empty uu____3553 uu____3555)))
...
let uu____3568 = (comments_before_pos comments pos pos)
in (FStar_Pervasives_Native.fst uu____3568)))
end
| uu____3575 -> begin
comments
end)
...
let uu____3621 = (FStar_ST.op_Bang comment_stack)
...
let uu____3719 = (FStar_Range.start_of_range crange)
in (FStar_Range.line_of_pos uu____3719))
in (uu____3717 - lbegin))
in (max k uu____3715))
in (
...
let uu____3725 = (FStar_Pprint.repeat lnum1 FStar_Pprint.hardline)
in (

let uu____3726 = (str comment)
in (FStar_Pprint.op_Hat_Hat uu____3725 uu____3726)))
in (FStar_Pprint.op_Hat_Hat doc1 uu____3724))
in (

let uu____3727 = (

let uu____3729 = (FStar_Range.end_of_range crange)
in (FStar_Range.line_of_pos uu____3729))
in (place_comments_until_pos (Prims.parse_int "1") uu____3727 pos meta_decl doc2 true init1)))));
)
end
| uu____3732 -> begin
...
let uu____3745 = (FStar_Range.line_of_pos pos)
in (uu____3745 - lbegin))
in (
...
let uu____3787 = (FStar_Pprint.repeat lnum7 FStar_Pprint.hardline)
in (FStar_Pprint.op_Hat_Hat doc1 uu____3787))))))))))
end)
end)))


let separate_map_with_comments : 'Auu____3801 . FStar_Pprint.document  ->  FStar_Pprint.document  ->  ('Auu____3801  ->  FStar_Pprint.document)  ->  'Auu____3801 Prims.list  ->  ('Auu____3801  ->  decl_meta)  ->  FStar_Pprint.document = (fun prefix1 sep f xs extract_meta -> (

let fold_fun = (fun uu____3860 x -> (match (uu____3860) with
...
let uu____3879 = (FStar_Range.start_of_range r)
in (place_comments_until_pos (Prims.parse_int "1") last_line uu____3879 meta_decl doc1 false false))
in (

let uu____3883 = (

let uu____3885 = (FStar_Range.end_of_range r)
in (FStar_Range.line_of_pos uu____3885))
in (
...
let uu____3888 = (f x)
in (FStar_Pprint.op_Hat_Hat sep uu____3888))
in (FStar_Pprint.op_Hat_Hat doc2 uu____3887))
in ((uu____3883), (uu____3886)))))))
end))
in (

let uu____3890 = (

let uu____3897 = (FStar_List.hd xs)
in (

let uu____3898 = (FStar_List.tl xs)
in ((uu____3897), (uu____3898))))
...
let uu____3918 = (FStar_Range.end_of_range meta_decl.r)
in (FStar_Range.line_of_pos uu____3918))
in (

let uu____3919 = (

let uu____3920 = (f x)
in (FStar_Pprint.op_Hat_Hat prefix1 uu____3920))
in ((uu____3916), (uu____3919)))))
in (

let uu____3922 = (FStar_List.fold_left fold_fun init1 xs1)
in (FStar_Pervasives_Native.snd uu____3922)))
end))))


let separate_map_with_comments_kw : 'Auu____3949 'Auu____3950 . 'Auu____3949  ->  'Auu____3949  ->  ('Auu____3949  ->  'Auu____3950  ->  FStar_Pprint.document)  ->  'Auu____3950 Prims.list  ->  ('Auu____3950  ->  decl_meta)  ->  FStar_Pprint.document = (fun prefix1 sep f xs extract_meta -> (

let fold_fun = (fun uu____4014 x -> (match (uu____4014) with
| (last_line, doc1) -> begin
(
...
let uu____4033 = (FStar_Range.start_of_range r)
in (place_comments_until_pos (Prims.parse_int "1") last_line uu____4033 meta_decl doc1 false false))
in (

let uu____4037 = (

let uu____4039 = (FStar_Range.end_of_range r)
in (FStar_Range.line_of_pos uu____4039))
in (

let uu____4040 = (

let uu____4041 = (f sep x)
in (FStar_Pprint.op_Hat_Hat doc2 uu____4041))
in ((uu____4037), (uu____4040)))))))
end))
in (

let uu____4043 = (

let uu____4050 = (FStar_List.hd xs)
in (

let uu____4051 = (FStar_List.tl xs)
in ((uu____4050), (uu____4051))))
...
let uu____4071 = (FStar_Range.end_of_range meta_decl.r)
in (FStar_Range.line_of_pos uu____4071))
in (

let uu____4072 = (f prefix1 x)
in ((uu____4069), (uu____4072)))))
in (

let uu____4074 = (FStar_List.fold_left fold_fun init1 xs1)
in (FStar_Pervasives_Native.snd uu____4074)))
end))))
...
| ((FStar_Parser_AST.Assumption)::[], FStar_Parser_AST.Assume (id1, uu____5060)) -> begin
(

let uu____5063 = (

let uu____5065 = (FStar_Util.char_at id1.FStar_Ident.idText (Prims.parse_int "0"))
in (FStar_All.pipe_right uu____5065 FStar_Util.is_upper))
in (match (uu____5063) with
| true -> begin
(

let uu____5071 = (p_qualifier FStar_Parser_AST.Assumption)
in (FStar_Pprint.op_Hat_Hat uu____5071 FStar_Pprint.space))
end
| uu____5072 -> begin
...
let uu____5081 = (FStar_Pprint.optional (fun d1 -> (p_fsdoc d1)) d.FStar_Parser_AST.doc)
in (

let uu____5084 = (

let uu____5085 = (p_attributes d.FStar_Parser_AST.attrs)
in (

let uu____5086 = (

let uu____5087 = (p_rawDecl d)
in (FStar_Pprint.op_Hat_Hat qualifiers uu____5087))
in (FStar_Pprint.op_Hat_Hat uu____5085 uu____5086)))
in (FStar_Pprint.op_Hat_Hat uu____5081 uu____5084)))))
...
let uu____5097 = (FStar_List.map p_atomicTerm attrs)
in (FStar_Pprint.flow break1 uu____5097))
in (FStar_Pprint.op_Hat_Hat uu____5096 FStar_Pprint.rbracket))
in (FStar_Pprint.align uu____5095))
in (FStar_Pprint.op_Hat_Hat uu____5094 FStar_Pprint.hardline))
in (FStar_Pprint.op_Hat_Hat uu____5091 uu____5093)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.lbracket uu____5090))
end))
and p_fsdoc : FStar_Parser_AST.fsdoc  ->  FStar_Pprint.document = (fun uu____5100 -> (match (uu____5100) with
| (doc1, kwd_args) -> begin
(
...
let process_kwd_arg = (fun uu____5148 -> (match (uu____5148) with
| (kwd, arg) -> begin
(
...
let uu____5164 = (str kwd)
in (

let uu____5165 = (

let uu____5166 = (str arg)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5166))
in (FStar_Pprint.op_Hat_Hat uu____5164 uu____5165)))
in (FStar_Pprint.op_Hat_Hat uu____5161 uu____5163)))
end))
in (

let uu____5167 = (FStar_Pprint.separate_map FStar_Pprint.hardline process_kwd_arg kwd_args1)
in (FStar_Pprint.op_Hat_Hat uu____5167 FStar_Pprint.hardline)))
end)
in (
...
let uu____5180 = (FStar_Pprint.op_Hat_Hat FStar_Pprint.rparen FStar_Pprint.hardline)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5180))
in (FStar_Pprint.op_Hat_Hat kwd_args_doc uu____5179))
in (FStar_Pprint.op_Hat_Hat uu____5177 uu____5178)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5176))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.star uu____5175))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.lparen uu____5174)))
end))
...
let uu____5189 = (p_lident lid)
in (

let uu____5190 = (FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.colon)
in (FStar_Pprint.op_Hat_Hat uu____5189 uu____5190)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5188))
in (FStar_Pprint.op_Hat_Hat uu____5185 uu____5187)))
in (

let uu____5191 = (p_typ false false t)
in (FStar_Pprint.op_Hat_Hat uu____5184 uu____5191)))
end
| FStar_Parser_AST.TopLevelLet (uu____5194, lbs) -> begin
(FStar_Pprint.separate_map FStar_Pprint.hardline (fun lb -> (

let uu____5219 = (

let uu____5220 = (str "let")
in (p_letlhs uu____5220 lb false))
in (FStar_Pprint.group uu____5219))) lbs)
end
| uu____5223 -> begin
FStar_Pprint.empty
end))
...
let rec p_list' = (fun uu___4_5238 -> (match (uu___4_5238) with
| [] -> begin
FStar_Pprint.empty
end
| (x)::[] -> begin
...
let uu____5248 = (p_list' xs)
in (FStar_Pprint.op_Hat_Hat sep uu____5248))
in (FStar_Pprint.op_Hat_Hat uu____5246 uu____5247)))
end))
in (
...
let uu____5252 = (p_list' l)
in (

let uu____5253 = (str "]")
in (FStar_Pprint.op_Hat_Hat uu____5252 uu____5253)))
in (FStar_Pprint.op_Hat_Hat uu____5249 uu____5251)))))
...
let uu____5258 = (str "open")
in (

let uu____5260 = (p_quident uid)
in (FStar_Pprint.op_Hat_Slash_Hat uu____5258 uu____5260)))
...
let uu____5263 = (str "include")
in (

let uu____5265 = (p_quident uid)
in (FStar_Pprint.op_Hat_Slash_Hat uu____5263 uu____5265)))
in (FStar_Pprint.group uu____5262))
end
...
let uu____5268 = (str "friend")
in (

let uu____5270 = (p_quident uid)
in (FStar_Pprint.op_Hat_Slash_Hat uu____5268 uu____5270)))
...
let uu____5278 = (p_uident uid1)
in (

let uu____5279 = (FStar_Pprint.op_Hat_Hat FStar_Pprint.space FStar_Pprint.equals)
in (FStar_Pprint.op_Hat_Hat uu____5278 uu____5279)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5277))
in (FStar_Pprint.op_Hat_Hat uu____5274 uu____5276)))
in (

let uu____5280 = (p_quident uid2)
in (op_Hat_Slash_Plus_Hat uu____5273 uu____5280)))
end
...
let uu____5283 = (str "module")
in (

let uu____5285 = (

let uu____5286 = (p_quident uid)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5286))
in (FStar_Pprint.op_Hat_Hat uu____5283 uu____5285)))
in (FStar_Pprint.group uu____5282))
end
| FStar_Parser_AST.Tycon (true, uu____5287, ((FStar_Parser_AST.TyconAbbrev (uid, tpars, FStar_Pervasives_Native.None, t), FStar_Pervasives_Native.None))::[]) -> begin
(

let effect_prefix_doc = (

let uu____5324 = (str "effect")
in (

let uu____5326 = (

let uu____5327 = (p_uident uid)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5327))
in (FStar_Pprint.op_Hat_Hat uu____5324 uu____5326)))
in (

let uu____5328 = (

let uu____5329 = (p_typars tpars)
in (FStar_Pprint.surround (Prims.parse_int "2") (Prims.parse_int "1") effect_prefix_doc uu____5329 FStar_Pprint.equals))
in (

let uu____5332 = (p_typ false false t)
in (op_Hat_Slash_Plus_Hat uu____5328 uu____5332))))
end
...
let uu____5364 = (FStar_List.hd tcdefs)
in (p_fsdocTypeDeclPairs s uu____5364))
in (

let uu____5377 = (

let uu____5378 = (FStar_List.tl tcdefs)
in (FStar_All.pipe_left (FStar_Pprint.concat_map (fun x -> (

let uu____5416 = (

let uu____5417 = (str "and")
in (p_fsdocTypeDeclPairs uu____5417 x))
in (FStar_Pprint.op_Hat_Hat break1 uu____5416)))) uu____5378))
in (FStar_Pprint.op_Hat_Hat uu____5363 uu____5377))))
end
...
let uu____5434 = (str "let")
in (

let uu____5436 = (p_letqualifier q)
in (FStar_Pprint.op_Hat_Hat uu____5434 uu____5436)))
in (

let uu____5437 = (str "and")
in (separate_map_with_comments_kw let_doc uu____5437 p_letbinding lbs (fun uu____5447 -> (match (uu____5447) with
| (p, t) -> begin
(

let uu____5454 = (FStar_Range.union_ranges p.FStar_Parser_AST.prange t.FStar_Parser_AST.range)
in {r = uu____5454; has_qs = false; has_attrs = false; has_fsdoc = (FStar_Util.is_some d.FStar_Parser_AST.doc); is_fsdoc = false})
end)))))
end
| FStar_Parser_AST.Val (lid, t) -> begin
(
...
let uu____5465 = (p_lident lid)
in (

let uu____5466 = (sig_as_binders_if_possible t false)
in (FStar_Pprint.op_Hat_Hat uu____5465 uu____5466)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5464))
in (FStar_Pprint.op_Hat_Hat uu____5461 uu____5463)))
in (FStar_All.pipe_left FStar_Pprint.group uu____5460))
end
...
let uu____5473 = (FStar_Util.char_at id1.FStar_Ident.idText (Prims.parse_int "0"))
in (FStar_All.pipe_right uu____5473 FStar_Util.is_upper))
...
let uu____5481 = (str "val")
in (FStar_Pprint.op_Hat_Hat uu____5481 FStar_Pprint.space))
end))
in (

let uu____5483 = (

let uu____5484 = (p_ident id1)
in (
...
let uu____5488 = (p_typ false false t)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5488))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.colon uu____5487))
in (FStar_Pprint.group uu____5486))
in (FStar_Pprint.op_Hat_Hat uu____5484 uu____5485)))
in (FStar_Pprint.op_Hat_Hat decl_keyword uu____5483)))
end
| FStar_Parser_AST.Exception (uid, t_opt) -> begin
(

let uu____5497 = (str "exception")
in (
...
let uu____5501 = (p_uident uid)
in (

let uu____5502 = (FStar_Pprint.optional (fun t -> (

let uu____5506 = (

let uu____5507 = (str "of")
in (

let uu____5509 = (p_typ false false t)
in (op_Hat_Slash_Plus_Hat uu____5507 uu____5509)))
in (FStar_Pprint.op_Hat_Hat break1 uu____5506))) t_opt)
in (FStar_Pprint.op_Hat_Hat uu____5501 uu____5502)))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5500))
in (FStar_Pprint.op_Hat_Hat uu____5497 uu____5499)))
end
| FStar_Parser_AST.NewEffect (ne) -> begin
(

let uu____5513 = (str "new_effect")
in (

let uu____5515 = (

let uu____5516 = (p_newEffect ne)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5516))
in (FStar_Pprint.op_Hat_Hat uu____5513 uu____5515)))
end
| FStar_Parser_AST.SubEffect (se) -> begin
(

let uu____5518 = (str "sub_effect")
in (

let uu____5520 = (

let uu____5521 = (p_subEffect se)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5521))
in (FStar_Pprint.op_Hat_Hat uu____5518 uu____5520)))
end
...
| FStar_Parser_AST.Main (uu____5524) -> begin
(failwith "*Main declaration* : Is that really still in use ??")
end
| FStar_Parser_AST.Tycon (true, uu____5526, uu____5527) -> begin
(failwith "Effect abbreviation is expected to be defined by an abbreviation")
end
| FStar_Parser_AST.Splice (ids, t) -> begin
(

let uu____5555 = (str "%splice")
in (
...
let uu____5559 = (str ";")
in (p_list p_uident uu____5559 ids))
in (

let uu____5561 = (

let uu____5562 = (p_term false false t)
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5562))
in (FStar_Pprint.op_Hat_Hat uu____5558 uu____5561)))
in (FStar_Pprint.op_Hat_Hat uu____5555 uu____5557)))
end))
and p_pragma : FStar_Parser_AST.pragma  ->  FStar_Pprint.document = (fun uu___5_5565 -> (match (uu___5_5565) with
| FStar_Parser_AST.SetOptions (s) -> begin
(

let uu____5568 = (str "#set-options")
in (
...
let uu____5572 = (str s)
in (FStar_Pprint.dquotes uu____5572))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5571))
in (FStar_Pprint.op_Hat_Hat uu____5568 uu____5570)))
end
| FStar_Parser_AST.ResetOptions (s_opt) -> begin
(

let uu____5577 = (str "#reset-options")
in (

let uu____5579 = (FStar_Pprint.optional (fun s -> (

let uu____5585 = (

let uu____5586 = (str s)
in (FStar_Pprint.dquotes uu____5586))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5585))) s_opt)
in (FStar_Pprint.op_Hat_Hat uu____5577 uu____5579)))
end
| FStar_Parser_AST.PushOptions (s_opt) -> begin
(

let uu____5591 = (str "#push-options")
in (

let uu____5593 = (FStar_Pprint.optional (fun s -> (

let uu____5599 = (

let uu____5600 = (str s)
in (FStar_Pprint.dquotes uu____5600))
in (FStar_Pprint.op_Hat_Hat FStar_Pprint.space uu____5599))) s_opt)
in (FStar_Pprint.op_Hat_Hat uu____5591 uu____5593)))
end
