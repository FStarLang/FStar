...
and (p_list :
  ...
  fun f  ->
    fun sep  ->
      fun l  ->
        let rec p_list' uu___21_5278 =
          match uu___21_5278 with
          | [] -> FStar_Pprint.empty
          | x::[] -> f x
          | x::xs ->
...
and (p_constant : FStar_Const.sconst -> FStar_Pprint.document) =
  fun uu___32_11237  ->
    ...
    | FStar_Const.Const_int (repr,sign_width_opt) ->
        let signedness uu___30_11284 =
          match uu___30_11284 with
          | FStar_Const.Unsigned  -> str "u"
          | FStar_Const.Signed  -> FStar_Pprint.empty  in
        let width uu___31_11291 =
          match uu___31_11291 with
