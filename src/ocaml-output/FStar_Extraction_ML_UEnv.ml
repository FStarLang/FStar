...
let (__proj__Bv__item___0 :
  binding ->
    (FStar_Syntax_Syntax.bv,ty_or_exp_b)
      FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__Fv__item___0 :
  binding ->
    (FStar_Syntax_Syntax.fv,exp_binding)
      FStar_Pervasives_Native_Tuple2.tuple2)
  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___242_1088 = g  in
        {
          env_tcenv = tcenv;
          env_bindings = gamma;
          tydefs = (uu___242_1088.tydefs);
          type_names = (uu___242_1088.type_names);
          currentModule = (uu___242_1088.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___243_1327 = g  in
                {
                  env_tcenv = tcenv;
                  env_bindings = gamma;
                  tydefs = (uu___243_1327.tydefs);
                  type_names = (uu___243_1327.type_names);
                  currentModule = (uu___243_1327.currentModule)
                }), mlident, exp_binding)
            ...
            fun is_rec  ->
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    ((let uu___244_1536 = g  in
                      {
                        env_tcenv = (uu___244_1536.env_tcenv);
                        env_bindings = gamma;
                        tydefs = (uu___244_1536.tydefs);
                        type_names = (uu___244_1536.type_names);
                        currentModule = (uu___244_1536.currentModule)
  ...
  uenv ->
    FStar_Syntax_Syntax.fv ->
      FStar_Extraction_ML_Syntax.one_mltydecl ->
        (uenv,tydef) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        | (_assumed,name,mangled,vars,metadata,body_opt) ->
            ...
            ((let uu___245_1730 = g  in
              {
                env_tcenv = (uu___245_1730.env_tcenv);
                env_bindings = (uu___245_1730.env_bindings);
                tydefs = (tydef :: (g.tydefs));
                type_names = (fv :: (g.type_names));
                currentModule = (uu___245_1730.currentModule)
              }), tydef)
  
let (extend_type_name : uenv -> FStar_Syntax_Syntax.fv -> uenv) =
  fun g  ->
    fun fv  ->
      let uu___246_1742 = g  in
      {
        env_tcenv = (uu___246_1742.env_tcenv);
        env_bindings = (uu___246_1742.env_bindings);
        tydefs = (uu___246_1742.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___246_1742.currentModule)
      }
