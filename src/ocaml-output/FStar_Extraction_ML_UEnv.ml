...
let x = (FStar_Util.find_map g.gamma (fun uu___109_750 -> (match (uu___109_750) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___110_772 -> (match (uu___110_772) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___111_796 -> (match (uu___111_796) with
...
let uu___113_922 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___113_922.tydefs; type_names = uu___113_922.type_names; currentModule = uu___113_922.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___112_992 -> (match (uu___112_992) with
...
let uu___114_1204 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___114_1204.tydefs; type_names = uu___114_1204.type_names; currentModule = uu___114_1204.currentModule})), (mlident))))))))))
...
let uu___115_1395 = g
in {tcenv = uu___115_1395.tcenv; gamma = gamma; tydefs = uu___115_1395.tydefs; type_names = uu___115_1395.type_names; currentModule = uu___115_1395.currentModule})), (mlsymbol))))))
end)))
end
| uu____1396 -> begin
...
let uu___116_1492 = g
in {tcenv = uu___116_1492.tcenv; gamma = uu___116_1492.gamma; tydefs = (((m), (td)))::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___116_1492.currentModule})))


let extend_type_name : env  ->  FStar_Syntax_Syntax.fv  ->  env = (fun g fv -> (

let uu___117_1509 = g
in {tcenv = uu___117_1509.tcenv; gamma = uu___117_1509.gamma; tydefs = uu___117_1509.tydefs; type_names = (fv)::g.type_names; currentModule = uu___117_1509.currentModule}))
