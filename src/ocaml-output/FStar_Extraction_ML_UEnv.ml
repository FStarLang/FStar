            ...
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  let gamma =
                    ...
                    :: (g.gamma)  in
                  let tcenv =
                    let uu____717 = FStar_Syntax_Syntax.binders_of_list [x]
                       in
...
let rec mltyFvars :
  ...
  fun t  ->
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,f,t2) ->
        ...
        let uu____733 = mltyFvars t2  in
        FStar_List.append uu____731 uu____733
...
let tySchemeIsClosed : FStar_Extraction_ML_Syntax.mltyscheme -> Prims.bool =
  fun tys  ->
    let uu____757 = mltyFvars (snd tys)  in
    subsetMlidents uu____757 (fst tys)
...
let mkContext : FStar_TypeChecker_Env.env -> env =
  fun e  ->
    ...
    let uu____955 =
      ...
      extend_lb env uu____958 FStar_Syntax_Syntax.tun failwith_ty false false
       in
