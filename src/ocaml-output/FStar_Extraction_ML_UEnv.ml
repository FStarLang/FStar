  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___33_1088 = g  in
        {
          env_tcenv = tcenv;
          env_bindings = gamma;
          tydefs = (uu___33_1088.tydefs);
          type_names = (uu___33_1088.type_names);
          currentModule = (uu___33_1088.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___34_1327 = g  in
                {
                  env_tcenv = tcenv;
                  env_bindings = gamma;
                  tydefs = (uu___34_1327.tydefs);
                  type_names = (uu___34_1327.type_names);
                  currentModule = (uu___34_1327.currentModule)
                }), mlident, exp_binding)
            ...
            fun is_rec  ->
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    ((let uu___35_1536 = g  in
                      {
                        env_tcenv = (uu___35_1536.env_tcenv);
                        env_bindings = gamma;
                        tydefs = (uu___35_1536.tydefs);
                        type_names = (uu___35_1536.type_names);
                        currentModule = (uu___35_1536.currentModule)
    ...
    fun fv  ->
      fun td  ->
        ...
        | (_assumed,name,mangled,vars,metadata,body_opt) ->
            ...
            ((let uu___36_1730 = g  in
              {
                env_tcenv = (uu___36_1730.env_tcenv);
                env_bindings = (uu___36_1730.env_bindings);
                tydefs = (tydef :: (g.tydefs));
                type_names = (fv :: (g.type_names));
                currentModule = (uu___36_1730.currentModule)
              }), tydef)
  
let (extend_type_name : uenv -> FStar_Syntax_Syntax.fv -> uenv) =
  fun g  ->
    fun fv  ->
      let uu___37_1742 = g  in
      {
        env_tcenv = (uu___37_1742.env_tcenv);
        env_bindings = (uu___37_1742.env_bindings);
        tydefs = (uu___37_1742.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___37_1742.currentModule)
      }
