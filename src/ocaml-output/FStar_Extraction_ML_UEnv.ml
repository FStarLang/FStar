...
let tyscheme_of_td :
  'Auu____487 'Auu____488 'Auu____489 'Auu____490 .
    ('Auu____487, 'Auu____488, 'Auu____489,
      FStar_Extraction_ML_Syntax.mlidents, 'Auu____490,
                   ...
                   then
                     FStar_Util.find_map tds
                       (fun td ->
                          ...
                          | (uu____616, n1, uu____618, uu____619, uu____620,
                             uu____621) ->
                              if n1 = ty_name
           ...
           | (uu____702, m, tds) ->
               FStar_Util.find_map tds
                 (fun uu____722 ->
                    ...
                    | (uu____731, n1, mangle_opt, uu____734, uu____735,
                       uu____736) ->
                        if m = mname
                        then
                          (if n1 = ty_name
  ...
  fun g ->
    fun bv ->
      let x =
        FStar_Util.find_map g.gamma
          (fun uu___62_895 ->
             match uu___62_895 with
             | Bv (bv', r) when FStar_Syntax_Syntax.bv_eq bv bv' ->
                 FStar_Pervasives_Native.Some r
             | uu____900 -> FStar_Pervasives_Native.None) in
      match x with
      | FStar_Pervasives_Native.None ->
          let uu____901 =
            let uu____902 =
  ...
  fun g ->
    fun a ->
      fun mapped_to ->
        ...
        let uu___64_1028 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___64_1028.tydefs);
          type_names = (uu___64_1028.type_names);
          currentModule = (uu___64_1028.currentModule)
        }
      ...
      FStar_List.fold_right
        (fun c ->
           fun cs1 ->
             ...
             FStar_List.append uu____1058 cs1) cs [] in
    let cs'1 =
      match cs' with
        ...
        fun add_unit ->
          fun is_rec ->
            fun mk_unit ->
              ...
              let mlident =
                let uu____1295 = FStar_Extraction_ML_Syntax.bv_as_mlident x in
              ...
              ((let uu___65_1338 = g in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___65_1338.tydefs);
                  type_names = (uu___65_1338.type_names);
                  currentModule = (uu___65_1338.currentModule)
                }), mlident)
let rec (mltyFvars :
              ...
              then
                ...
                | (mlpath, mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___66_1539 = g in
                      {
                        tcenv = (uu___66_1539.tcenv);
                        gamma;
                        tydefs = (uu___66_1539.tydefs);
                        type_names = (uu___66_1539.type_names);
                        currentModule = (uu___66_1539.currentModule)
                      }), mlsymbol)
  ...
  fun g ->
    fun fv ->
      fun td ->
        ...
        let uu___67_1650 = g in
        {
          tcenv = (uu___67_1650.tcenv);
          gamma = (uu___67_1650.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___67_1650.currentModule)
        }
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g ->
    fun fv ->
      let uu___68_1671 = g in
      {
        tcenv = (uu___68_1671.tcenv);
        gamma = (uu___68_1671.gamma);
        tydefs = (uu___68_1671.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___68_1671.currentModule)
      }
