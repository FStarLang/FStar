  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___114_1001 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___114_1001.tydefs);
          type_names = (uu___114_1001.type_names);
          currentModule = (uu___114_1001.currentModule)
        }
          ...
          fun is_rec  ->
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  ((let uu___115_1298 = g in
                    {
                      tcenv;
                      gamma;
                      tydefs = (uu___115_1298.tydefs);
                      type_names = (uu___115_1298.type_names);
                      currentModule = (uu___115_1298.currentModule)
                    }), mlident1)
let rec mltyFvars:
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___116_1493 = g in
                      {
                        tcenv = (uu___116_1493.tcenv);
                        gamma;
                        tydefs = (uu___116_1493.tydefs);
                        type_names = (uu___116_1493.type_names);
                        currentModule = (uu___116_1493.currentModule)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___117_1590 = g in
        {
          tcenv = (uu___117_1590.tcenv);
          gamma = (uu___117_1590.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___117_1590.currentModule)
        }
let extend_type_name: env -> FStar_Syntax_Syntax.fv -> env =
  fun g  ->
    fun fv  ->
      let uu___118_1607 = g in
      {
        tcenv = (uu___118_1607.tcenv);
        gamma = (uu___118_1607.gamma);
        tydefs = (uu___118_1607.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___118_1607.currentModule)
      }
