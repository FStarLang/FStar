          ...
          fun is_rec  ->
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  ((let uu___109_755 = g  in
                    {
                      tcenv;
                      gamma;
                      tydefs = (uu___109_755.tydefs);
                      currentModule = (uu___109_755.currentModule)
                    }), mlident1)
...
let tySchemeIsClosed : FStar_Extraction_ML_Syntax.mltyscheme -> Prims.bool =
  fun tys  ->
    let uu____792 = mltyFvars (snd tys)  in
    subsetMlidents uu____792 (fst tys)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___110_876 = g  in
                      {
                        tcenv = (uu___110_876.tcenv);
                        gamma;
                        tydefs = (uu___110_876.tydefs);
                        currentModule = (uu___110_876.currentModule)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___111_953 = g  in
        {
          tcenv = (uu___111_953.tcenv);
          gamma = (uu___111_953.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          currentModule = (uu___111_953.currentModule)
        }
  ...
  fun e  ->
    ...
    let uu____990 =
      ...
      extend_lb env uu____993 FStar_Syntax_Syntax.tun failwith_ty false false
       in
    FStar_All.pipe_right uu____990 FStar_Pervasives.fst
