  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___63_964 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___63_964.tydefs);
          type_names = (uu___63_964.type_names);
          currentModule = (uu___63_964.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___64_1209 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___64_1209.tydefs);
                  type_names = (uu___64_1209.type_names);
                  currentModule = (uu___64_1209.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___65_1392 = g  in
                      {
                        tcenv = (uu___65_1392.tcenv);
                        gamma;
                        tydefs = (uu___65_1392.tydefs);
                        type_names = (uu___65_1392.type_names);
                        currentModule = (uu___65_1392.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___66_1503 = g  in
        {
          tcenv = (uu___66_1503.tcenv);
          gamma = (uu___66_1503.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___66_1503.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___67_1524 = g  in
      {
        tcenv = (uu___67_1524.tcenv);
        gamma = (uu___67_1524.gamma);
        tydefs = (uu___67_1524.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___67_1524.currentModule)
      }
