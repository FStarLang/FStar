  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___514_964 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___514_964.tydefs);
          type_names = (uu___514_964.type_names);
          currentModule = (uu___514_964.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___515_1213 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___515_1213.tydefs);
                  type_names = (uu___515_1213.type_names);
                  currentModule = (uu___515_1213.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___516_1366 = g  in
                      {
                        tcenv = (uu___516_1366.tcenv);
                        gamma;
                        tydefs = (uu___516_1366.tydefs);
                        type_names = (uu___516_1366.type_names);
                        currentModule = (uu___516_1366.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___517_1477 = g  in
        {
          tcenv = (uu___517_1477.tcenv);
          gamma = (uu___517_1477.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___517_1477.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___518_1498 = g  in
      {
        tcenv = (uu___518_1498.tcenv);
        gamma = (uu___518_1498.gamma);
        tydefs = (uu___518_1498.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___518_1498.currentModule)
      }
