...
let x = (FStar_Util.find_map g.gamma (fun uu___130_750 -> (match (uu___130_750) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___131_772 -> (match (uu___131_772) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___132_796 -> (match (uu___132_796) with
...
let uu___134_922 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___134_922.tydefs; type_names = uu___134_922.type_names; currentModule = uu___134_922.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___133_992 -> (match (uu___133_992) with
...
let uu___135_1204 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___135_1204.tydefs; type_names = uu___135_1204.type_names; currentModule = uu___135_1204.currentModule})), (mlident))))))))))
...
let uu___136_1395 = g
in {tcenv = uu___136_1395.tcenv; gamma = gamma; tydefs = uu___136_1395.tydefs; type_names = uu___136_1395.type_names; currentModule = uu___136_1395.currentModule})), (mlsymbol))))))
end)))
end
| uu____1396 -> begin
...
let uu___137_1492 = g
in {tcenv = uu___137_1492.tcenv; gamma = uu___137_1492.gamma; tydefs = (((m), (td)))::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___137_1492.currentModule})))


let extend_type_name : env  ->  FStar_Syntax_Syntax.fv  ->  env = (fun g fv -> (

let uu___138_1509 = g
in {tcenv = uu___138_1509.tcenv; gamma = uu___138_1509.gamma; tydefs = uu___138_1509.tydefs; type_names = (fv)::g.type_names; currentModule = uu___138_1509.currentModule}))
