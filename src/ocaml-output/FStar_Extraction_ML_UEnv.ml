...
let tyscheme_of_td :
  'Auu____443 'Auu____444 'Auu____445 'Auu____446 .
    ('Auu____443, 'Auu____444, 'Auu____445,
      FStar_Extraction_ML_Syntax.mlidents, 'Auu____446,
                   ...
                   then
                     FStar_Util.find_map tds
                       (fun td ->
                          ...
                          | (uu____568, n1, uu____570, uu____571, uu____572,
                             uu____573) ->
                              if n1 = ty_name
           ...
           | (uu____654, m, tds) ->
               FStar_Util.find_map tds
                 (fun uu____674 ->
                    ...
                    | (uu____683, n1, mangle_opt, uu____686, uu____687,
                       uu____688) ->
                        if m = mname
                        then
                          (if n1 = ty_name
    ...
    fun lid ->
      let x =
        FStar_Util.find_map g.gamma
          (fun uu___229_783 ->
             match uu___229_783 with
             | Fv (fv', x) when FStar_Syntax_Syntax.fv_eq_lid fv' lid ->
                 FStar_Pervasives_Native.Some x
             | uu____788 -> FStar_Pervasives_Native.None) in
      match x with
      | FStar_Pervasives_Native.None ->
          let uu____789 =
  ...
  fun g ->
    fun a ->
      fun mapped_to ->
        ...
        let uu___233_964 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___233_964.tydefs);
          type_names = (uu___233_964.type_names);
          currentModule = (uu___233_964.currentModule)
        }
      ...
      FStar_List.fold_right
        (fun c ->
           fun cs1 ->
             ...
             FStar_List.append uu____1003 cs1) cs [] in
    let cs'1 =
      match cs' with
        ...
        fun add_unit ->
          fun is_rec ->
            fun mk_unit ->
              ...
              let mlident =
                let uu____1186 = FStar_Extraction_ML_Syntax.bv_as_mlident x in
              ...
              ((let uu___234_1213 = g in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___234_1213.tydefs);
                  type_names = (uu___234_1213.type_names);
                  currentModule = (uu___234_1213.currentModule)
                }), mlident)
let rec (mltyFvars :
              ...
              then
                ...
                | (mlpath, mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___235_1366 = g in
                      {
                        tcenv = (uu___235_1366.tcenv);
                        gamma;
                        tydefs = (uu___235_1366.tydefs);
                        type_names = (uu___235_1366.type_names);
                        currentModule = (uu___235_1366.currentModule)
                      }), mlsymbol)
  ...
  fun g ->
    fun fv ->
      fun td ->
        ...
        let uu___236_1477 = g in
        {
          tcenv = (uu___236_1477.tcenv);
          gamma = (uu___236_1477.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___236_1477.currentModule)
        }
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g ->
    fun fv ->
      let uu___237_1498 = g in
      {
        tcenv = (uu___237_1498.tcenv);
        gamma = (uu___237_1498.gamma);
        tydefs = (uu___237_1498.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___237_1498.currentModule)
      }
    ...
    fun nm ->
      let lid =
        ...
        FStar_Syntax_Util.mk_field_projector_name_from_ident
          ed.FStar_Syntax_Syntax.mname uu____1611 in
