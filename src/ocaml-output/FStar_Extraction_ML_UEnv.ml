  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___237_884 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___237_884.tydefs);
          type_names = (uu___237_884.type_names);
          currentModule = (uu___237_884.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___238_1067 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___238_1067.tydefs);
                  type_names = (uu___238_1067.type_names);
                  currentModule = (uu___238_1067.currentModule)
                }), mlident, exp_binding)
            ...
            fun is_rec  ->
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    ((let uu___239_1217 = g  in
                      {
                        tcenv = (uu___239_1217.tcenv);
                        gamma;
                        tydefs = (uu___239_1217.tydefs);
                        type_names = (uu___239_1217.type_names);
                        currentModule = (uu___239_1217.currentModule)
    ...
    fun fv  ->
      fun td  ->
        ...
        | (_assumed,name,mangled,vars,metadata,body_opt) ->
            ...
            ((let uu___240_1375 = g  in
              {
                tcenv = (uu___240_1375.tcenv);
                gamma = (uu___240_1375.gamma);
                tydefs = (tydef :: (g.tydefs));
                type_names = (fv :: (g.type_names));
                currentModule = (uu___240_1375.currentModule)
              }), tydef)
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___241_1386 = g  in
      {
        tcenv = (uu___241_1386.tcenv);
        gamma = (uu___241_1386.gamma);
        tydefs = (uu___241_1386.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___241_1386.currentModule)
      }
