...
let _75_122 = (FStar_Util.prefix m)
in (match (_75_122) with
| (modul, _75_121) -> begin
Some (((modul), (mangled)))
end))
end)
...
let _75_188 = g
in {tcenv = tcenv; gamma = gamma; tydefs = _75_188.tydefs; currentModule = _75_188.currentModule}))))))
...
let _75_206 = g
in {tcenv = tcenv; gamma = gamma; tydefs = _75_206.tydefs; currentModule = _75_206.currentModule})))))))
...
let _75_248 = g
in {tcenv = _75_248.tcenv; gamma = gamma; tydefs = _75_248.tydefs; currentModule = _75_248.currentModule})))))
end else begin
...
let _75_268 = (FStar_Extraction_ML_Syntax.mlpath_of_lident f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (_75_268) with
| (p, y) -> begin
...
let _75_273 = g
in {tcenv = _75_273.tcenv; gamma = _75_273.gamma; tydefs = (((m), (td)))::g.tydefs; currentModule = _75_273.currentModule})))
...
let _75_283 = ((ed.FStar_Syntax_Syntax.mname.FStar_Ident.ns), (ed.FStar_Syntax_Syntax.mname.FStar_Ident.ident))
in (match (_75_283) with
