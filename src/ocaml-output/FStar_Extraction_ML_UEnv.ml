  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___168_1028 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___168_1028.tydefs);
          type_names = (uu___168_1028.type_names);
          currentModule = (uu___168_1028.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___169_1338 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___169_1338.tydefs);
                  type_names = (uu___169_1338.type_names);
                  currentModule = (uu___169_1338.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___170_1539 = g  in
                      {
                        tcenv = (uu___170_1539.tcenv);
                        gamma;
                        tydefs = (uu___170_1539.tydefs);
                        type_names = (uu___170_1539.type_names);
                        currentModule = (uu___170_1539.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___171_1650 = g  in
        {
          tcenv = (uu___171_1650.tcenv);
          gamma = (uu___171_1650.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___171_1650.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___172_1671 = g  in
      {
        tcenv = (uu___172_1671.tcenv);
        gamma = (uu___172_1671.gamma);
        tydefs = (uu___172_1671.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___172_1671.currentModule)
      }
