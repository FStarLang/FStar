  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___66_893 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___66_893.tydefs);
          type_names = (uu___66_893.type_names);
          currentModule = (uu___66_893.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___67_1179 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___67_1179.tydefs);
                  type_names = (uu___67_1179.type_names);
                  currentModule = (uu___67_1179.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___68_1360 = g  in
                      {
                        tcenv = (uu___68_1360.tcenv);
                        gamma;
                        tydefs = (uu___68_1360.tydefs);
                        type_names = (uu___68_1360.type_names);
                        currentModule = (uu___68_1360.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___69_1443 = g  in
        {
          tcenv = (uu___69_1443.tcenv);
          gamma = (uu___69_1443.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___69_1443.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___70_1458 = g  in
      {
        tcenv = (uu___70_1458.tcenv);
        gamma = (uu___70_1458.gamma);
        tydefs = (uu___70_1458.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___70_1458.currentModule)
      }
