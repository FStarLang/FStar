...
type env =
  ...
  tydefs:
    (FStar_Extraction_ML_Syntax.mlsymbol Prims.list,
      FStar_Extraction_ML_Syntax.mltydecl) FStar_Pervasives_Native.tuple2
      Prims.list
    ;
...
let tyscheme_of_td :
  'Auu____419 'Auu____420 'Auu____421 'Auu____422 .
    ('Auu____419, 'Auu____420, 'Auu____421,
      FStar_Extraction_ML_Syntax.mlidents, 'Auu____422,
                   ...
                   then
                     FStar_Util.find_map tds
                       (fun td ->
                          ...
                          | (uu____537, n1, uu____539, uu____540, uu____541,
                             uu____542) ->
                              if n1 = ty_name
           ...
           | (m, tds) ->
               FStar_Util.find_map tds
                 (fun uu____631 ->
                    ...
                    | (uu____640, n1, mangle_opt, uu____643, uu____644,
                       uu____645) ->
                        if m = mname
                        then
                          (if n1 = ty_name
  ...
  fun g ->
    fun a ->
      fun mapped_to ->
        ...
        let uu___62_893 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___62_893.tydefs);
          type_names = (uu___62_893.type_names);
          currentModule = (uu___62_893.currentModule)
        }
        ...
        fun add_unit ->
          fun is_rec ->
            fun mk_unit ->
              ...
              ((let uu___63_1179 = g in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___63_1179.tydefs);
                  type_names = (uu___63_1179.type_names);
                  currentModule = (uu___63_1179.currentModule)
                }), mlident)
let rec (mltyFvars :
              ...
              then
                ...
                | (mlpath, mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___64_1360 = g in
                      {
                        tcenv = (uu___64_1360.tcenv);
                        gamma;
                        tydefs = (uu___64_1360.tydefs);
                        type_names = (uu___64_1360.type_names);
                        currentModule = (uu___64_1360.currentModule)
                      }), mlsymbol)
  ...
  fun g ->
    fun fv ->
      fun td ->
        ...
        let uu___65_1443 = g in
        {
          tcenv = (uu___65_1443.tcenv);
          gamma = (uu___65_1443.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___65_1443.currentModule)
        }
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g ->
    fun fv ->
      let uu___66_1458 = g in
      {
        tcenv = (uu___66_1458.tcenv);
        gamma = (uu___66_1458.gamma);
        tydefs = (uu___66_1458.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___66_1458.currentModule)
      }
