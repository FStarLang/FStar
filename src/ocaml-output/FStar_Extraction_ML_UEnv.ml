              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    ((let uu___242_1536 = g  in
                      {
                        env_tcenv = (uu___242_1536.env_tcenv);
                        env_bindings = gamma;
      ...
      fun td  ->
        ...
        | (_assumed,name,mangled,vars,metadata,body_opt) ->
            ...
            ((let uu___243_1730 = g  in
              {
                env_tcenv = (uu___243_1730.env_tcenv);
                env_bindings = (uu___243_1730.env_bindings);
...
let (extend_type_name : uenv -> FStar_Syntax_Syntax.fv -> uenv) =
  fun g  ->
    fun fv  ->
      ...
      {
        env_tcenv = (uu___244_1742.env_tcenv);
        env_bindings = (uu___244_1742.env_bindings);
