          ...
          let eff_action =
            let bits =
              FStar_All.pipe_right
                ...
                (FStar_List.filter (fun x1  -> Prims.op_Negation (x1 = ""))) in
            if (FStar_List.length bits) = (Prims.parse_int "4")
            then
              let uu____468 =
                (let uu____469 = FStar_List.hd bits in uu____469 = "proj") &&
                  (let uu____470 = FStar_List.nth bits (Prims.parse_int "2") in
                   uu____470 = "item") in
              (if uu____468
               then
                 let uu____472 = FStar_List.nth bits (Prims.parse_int "1") in
            ...
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  let gamma =
                    ...
                    :: (g.gamma) in
                  let tcenv =
                    let uu____773 = FStar_Syntax_Syntax.binders_of_list [x] in
...
let rec mltyFvars:
  ...
  fun t  ->
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,f,t2) ->
        ...
        let uu____789 = mltyFvars t2 in FStar_List.append uu____787 uu____789
