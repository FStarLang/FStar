...
let x = (FStar_Util.find_map g.gamma (fun uu___107_813 -> (match (uu___107_813) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___108_835 -> (match (uu___108_835) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___109_859 -> (match (uu___109_859) with
...
let uu___111_1001 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___111_1001.tydefs; type_names = uu___111_1001.type_names; currentModule = uu___111_1001.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___110_1071 -> (match (uu___110_1071) with
...
let uu___112_1298 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___112_1298.tydefs; type_names = uu___112_1298.type_names; currentModule = uu___112_1298.currentModule})), (mlident1)))))))))
end))))
...
let uu___113_1493 = g
in {tcenv = uu___113_1493.tcenv; gamma = gamma; tydefs = uu___113_1493.tydefs; type_names = uu___113_1493.type_names; currentModule = uu___113_1493.currentModule})), (((mlsymbol), ((Prims.parse_int "0")))))))))
end)))
end
| uu____1494 -> begin
...
let uu___114_1590 = g
in {tcenv = uu___114_1590.tcenv; gamma = uu___114_1590.gamma; tydefs = (((m), (td)))::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___114_1590.currentModule})))


let extend_type_name : env  ->  FStar_Syntax_Syntax.fv  ->  env = (fun g fv -> (

let uu___115_1607 = g
in {tcenv = uu___115_1607.tcenv; gamma = uu___115_1607.gamma; tydefs = uu___115_1607.tydefs; type_names = (fv)::g.type_names; currentModule = uu___115_1607.currentModule}))
