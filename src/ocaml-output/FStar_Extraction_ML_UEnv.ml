...
let x = (FStar_Util.find_map g.gamma (fun uu___104_435 -> (match (uu___104_435) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___105_450 -> (match (uu___105_450) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___106_475 -> (match (uu___106_475) with
...
let uu___108_566 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___108_566.tydefs; currentModule = uu___108_566.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___107_586 -> (match (uu___107_586) with
...
let uu___109_718 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___109_718.tydefs; currentModule = uu___109_718.currentModule})), (mlident1))))))))
end))))
...
let uu___110_839 = g
in {tcenv = uu___110_839.tcenv; gamma = gamma; tydefs = uu___110_839.tydefs; currentModule = uu___110_839.currentModule})), (((mlsymbol), ((Prims.parse_int "0"))))))))
end)))
end
| uu____840 -> begin
...
let uu___111_916 = g
in {tcenv = uu___111_916.tcenv; gamma = uu___111_916.gamma; tydefs = (((m), (td)))::g.tydefs; currentModule = uu___111_916.currentModule})))
