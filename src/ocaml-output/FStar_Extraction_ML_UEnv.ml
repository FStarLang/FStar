              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    ((let uu___241_1217 = g  in
                      {
                        env_tcenv = (uu___241_1217.env_tcenv);
                        env_bindings = gamma;
      ...
      fun td  ->
        ...
        | (_assumed,name,mangled,vars,metadata,body_opt) ->
            ...
            ((let uu___242_1375 = g  in
              {
                env_tcenv = (uu___242_1375.env_tcenv);
                env_bindings = (uu___242_1375.env_bindings);
...
let (extend_type_name : uenv -> FStar_Syntax_Syntax.fv -> uenv) =
  fun g  ->
    fun fv  ->
      ...
      {
        env_tcenv = (uu___243_1386.env_tcenv);
        env_bindings = (uu___243_1386.env_bindings);
