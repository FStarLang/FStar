  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___105_558 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___105_558.tydefs);
          currentModule = (uu___105_558.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              let uu___106_603 = g  in
              {
                tcenv;
                gamma;
                tydefs = (uu___106_603.tydefs);
                currentModule = (uu___106_603.currentModule)
              }
            ...
            fun is_rec  ->
              ...
              then
                ...
                let gamma = (Fv (x, (FStar_Util.Inr (mly, t_x, is_rec)))) ::
                  (g.gamma)  in
                let uu___107_689 = g  in
                {
                  tcenv = (uu___107_689.tcenv);
                  gamma;
                  tydefs = (uu___107_689.tydefs);
                  currentModule = (uu___107_689.currentModule)
                }
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___108_769 = g  in
        {
          tcenv = (uu___108_769.tcenv);
          gamma = (uu___108_769.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          currentModule = (uu___108_769.currentModule)
        }
