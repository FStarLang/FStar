  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___111_1001 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___111_1001.tydefs);
          type_names = (uu___111_1001.type_names);
          currentModule = (uu___111_1001.currentModule)
        }
<<<<<<< HEAD
          ...
          fun is_rec  ->
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  ((let uu___112_1298 = g  in
                    {
                      tcenv;
                      gamma;
                      tydefs = (uu___112_1298.tydefs);
                      type_names = (uu___112_1298.type_names);
                      currentModule = (uu___112_1298.currentModule)
                    }), mlident1)
<<<<<<< HEAD
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___113_1493 = g  in
                      {
                        tcenv = (uu___113_1493.tcenv);
                        gamma;
                        tydefs = (uu___113_1493.tydefs);
                        type_names = (uu___113_1493.type_names);
                        currentModule = (uu___113_1493.currentModule)
...
let (extend_tydef
  :env ->
     FStar_Syntax_Syntax.fv -> FStar_Extraction_ML_Syntax.mltydecl -> env)=
>>>>>>> taramana_pointers_with_codes_modifies
  fun g  ->
    fun fv  ->
      fun td  ->
        let m = module_name_of_fv fv  in
        let uu___114_1590 = g  in
        {
          tcenv = (uu___114_1590.tcenv);
          gamma = (uu___114_1590.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___114_1590.currentModule)
        }
<<<<<<< HEAD
...
>>>>>>> taramana_pointers_with_codes_modifies
  fun g  ->
    fun fv  ->
      let uu___115_1607 = g  in
      {
        tcenv = (uu___115_1607.tcenv);
        gamma = (uu___115_1607.gamma);
        tydefs = (uu___115_1607.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___115_1607.currentModule)
      }
<<<<<<< HEAD
