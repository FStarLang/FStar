  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___136_893 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___136_893.tydefs);
          type_names = (uu___136_893.type_names);
          currentModule = (uu___136_893.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___137_1179 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___137_1179.tydefs);
                  type_names = (uu___137_1179.type_names);
                  currentModule = (uu___137_1179.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___138_1360 = g  in
                      {
                        tcenv = (uu___138_1360.tcenv);
                        gamma;
                        tydefs = (uu___138_1360.tydefs);
                        type_names = (uu___138_1360.type_names);
                        currentModule = (uu___138_1360.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___139_1443 = g  in
        {
          tcenv = (uu___139_1443.tcenv);
          gamma = (uu___139_1443.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___139_1443.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___140_1458 = g  in
      {
        tcenv = (uu___140_1458.tcenv);
        gamma = (uu___140_1458.gamma);
        tydefs = (uu___140_1458.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___140_1458.currentModule)
      }
