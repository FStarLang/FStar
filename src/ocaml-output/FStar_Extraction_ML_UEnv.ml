...
let x = (FStar_Util.find_map g.gamma (fun uu___107_435 -> (match (uu___107_435) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___108_450 -> (match (uu___108_450) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___109_475 -> (match (uu___109_475) with
...
let uu___111_566 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___111_566.tydefs; currentModule = uu___111_566.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___110_586 -> (match (uu___110_586) with
...
let uu___112_718 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___112_718.tydefs; currentModule = uu___112_718.currentModule})), (mlident1))))))))
end))))
...
let uu___113_839 = g
in {tcenv = uu___113_839.tcenv; gamma = gamma; tydefs = uu___113_839.tydefs; currentModule = uu___113_839.currentModule})), (((mlsymbol), ((Prims.parse_int "0"))))))))
end)))
end
| uu____840 -> begin
...
let uu___114_916 = g
in {tcenv = uu___114_916.tcenv; gamma = uu___114_916.gamma; tydefs = (((m), (td)))::g.tydefs; currentModule = uu___114_916.currentModule})))
