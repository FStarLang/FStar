  ...
  fun g  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar x ->
          let uu___ = let uu___1 = lookup_fv g x  in FStar_Util.Inr uu___1
             in
    ...
    | FStar_Pervasives_Native.None  ->
        let m =
          ...
          FStar_List.fold_right
            (fun x  -> fun m1  -> FStar_Util.psmap_add m1 x "") uu___2 uu___3
           in
    ...
    fun is_local_type_variable  ->
      ...
      let sanitize_typ uu___ =
        ...
        let aux cs1 =
          FStar_List.map
            (fun x  ->
               let uu___1 = valid_rest x  in if uu___1 then x else 117) cs1
           in
        ...
        let cs' =
          FStar_List.fold_right
            (fun c  ->
               fun cs1  ->
                 let uu___1 =
                   let uu___2 = valid c  in if uu___2 then [c] else [95; 95]
                    in
                 FStar_List.append uu___1 cs1) cs []
           in
        match cs' with
          ...
          let target_mlident =
            ...
            then root_name1
              ...
              (let uu___1 = FStar_Util.string_of_int i  in
               Prims.op_Hat root_name1 uu___1)
             in
          let uu___ = FStar_Util.psmap_try_find ml_ident_map target_mlident
             in
          match uu___ with
...
let (new_mlpath_of_lident :
  ...
  fun g  ->
    fun x  ->
      let uu___ =
        let uu___1 = FStar_Ident.lid_equals x FStar_Parser_Const.failwith_lid
           in
        if uu___1
        then
          let uu___2 =
        ...
        fun ts  ->
          let lid =
            ...
            FStar_Syntax_Util.mk_field_projector_name_from_ident
              ed.FStar_Syntax_Syntax.mname uu___
             in
          let uu___ =
            let uu___1 =
      ...
      fun a  ->
        fun ts  ->
          ...
          let lid =
            let uu___ =
              let uu___1 =
                let uu___2 = FStar_Ident.id_of_text nm  in [uu___2]  in
