  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___112_922 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___112_922.tydefs);
          type_names = (uu___112_922.type_names);
          currentModule = (uu___112_922.currentModule)
        }
        ...
        (fun c  ->
           fun cs1  ->
             let uu____946 =
               ...
               if uu____949 then [c] else ['_'; '_'] in
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___113_1204 = g in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___113_1204.tydefs);
                  type_names = (uu___113_1204.type_names);
                  currentModule = (uu___113_1204.currentModule)
                }), mlident)
let rec mltyFvars:
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___114_1395 = g in
                      {
                        tcenv = (uu___114_1395.tcenv);
                        gamma;
                        tydefs = (uu___114_1395.tydefs);
                        type_names = (uu___114_1395.type_names);
                        currentModule = (uu___114_1395.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___115_1492 = g in
        {
          tcenv = (uu___115_1492.tcenv);
          gamma = (uu___115_1492.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___115_1492.currentModule)
        }
let extend_type_name: env -> FStar_Syntax_Syntax.fv -> env =
  fun g  ->
    fun fv  ->
      let uu___116_1509 = g in
      {
        tcenv = (uu___116_1509.tcenv);
        gamma = (uu___116_1509.gamma);
        tydefs = (uu___116_1509.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___116_1509.currentModule)
      }
