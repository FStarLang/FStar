  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___253_964 = g  in
        {
          tcenv;
          gamma;
          tydefs = (uu___253_964.tydefs);
          type_names = (uu___253_964.type_names);
          currentModule = (uu___253_964.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___254_1213 = g  in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___254_1213.tydefs);
                  type_names = (uu___254_1213.type_names);
                  currentModule = (uu___254_1213.currentModule)
                }), mlident)
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma)  in
                    ((let uu___255_1366 = g  in
                      {
                        tcenv = (uu___255_1366.tcenv);
                        gamma;
                        tydefs = (uu___255_1366.tydefs);
                        type_names = (uu___255_1366.type_names);
                        currentModule = (uu___255_1366.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___256_1477 = g  in
        {
          tcenv = (uu___256_1477.tcenv);
          gamma = (uu___256_1477.gamma);
          tydefs = ((fv, m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___256_1477.currentModule)
        }
  
let (extend_type_name : env -> FStar_Syntax_Syntax.fv -> env) =
  fun g  ->
    fun fv  ->
      let uu___257_1498 = g  in
      {
        tcenv = (uu___257_1498.tcenv);
        gamma = (uu___257_1498.gamma);
        tydefs = (uu___257_1498.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___257_1498.currentModule)
      }
