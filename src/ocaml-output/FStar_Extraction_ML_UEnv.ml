  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___112_566 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___112_566.tydefs);
          currentModule = (uu___112_566.currentModule)
        }
          ...
          fun is_rec  ->
            fun mk_unit  ->
              ...
              | (mlident,nocluewhat) ->
                  ...
                  ((let uu___113_718 = g in
                    {
                      tcenv;
                      gamma;
                      tydefs = (uu___113_718.tydefs);
                      currentModule = (uu___113_718.currentModule)
                    }), mlident1)
let rec mltyFvars:
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___114_839 = g in
                      {
                        tcenv = (uu___114_839.tcenv);
                        gamma;
                        tydefs = (uu___114_839.tydefs);
                        currentModule = (uu___114_839.currentModule)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___115_916 = g in
        {
          tcenv = (uu___115_916.tcenv);
          gamma = (uu___115_916.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          currentModule = (uu___115_916.currentModule)
        }
let emptyMlPath:
