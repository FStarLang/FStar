...
let x = (FStar_Util.find_map g.gamma (fun uu___138_750 -> (match (uu___138_750) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___139_772 -> (match (uu___139_772) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___140_796 -> (match (uu___140_796) with
...
let uu___142_922 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___142_922.tydefs; type_names = uu___142_922.type_names; currentModule = uu___142_922.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___141_992 -> (match (uu___141_992) with
...
let uu___143_1204 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___143_1204.tydefs; type_names = uu___143_1204.type_names; currentModule = uu___143_1204.currentModule})), (mlident))))))))))
...
let uu___144_1395 = g
in {tcenv = uu___144_1395.tcenv; gamma = gamma; tydefs = uu___144_1395.tydefs; type_names = uu___144_1395.type_names; currentModule = uu___144_1395.currentModule})), (mlsymbol))))))
end)))
end
| uu____1396 -> begin
...
let uu___145_1492 = g
in {tcenv = uu___145_1492.tcenv; gamma = uu___145_1492.gamma; tydefs = (((m), (td)))::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___145_1492.currentModule})))


let extend_type_name : env  ->  FStar_Syntax_Syntax.fv  ->  env = (fun g fv -> (

let uu___146_1509 = g
in {tcenv = uu___146_1509.tcenv; gamma = uu___146_1509.gamma; tydefs = uu___146_1509.tydefs; type_names = (fv)::g.type_names; currentModule = uu___146_1509.currentModule}))
