  ...
  fun g  ->
    fun a  ->
      fun mapped_to  ->
        ...
        let uu___362_922 = g in
        {
          tcenv;
          gamma;
          tydefs = (uu___362_922.tydefs);
          type_names = (uu___362_922.type_names);
          currentModule = (uu___362_922.currentModule)
        }
        ...
        fun add_unit  ->
          fun is_rec  ->
            fun mk_unit  ->
              ...
              ((let uu___363_1204 = g in
                {
                  tcenv;
                  gamma;
                  tydefs = (uu___363_1204.tydefs);
                  type_names = (uu___363_1204.type_names);
                  currentModule = (uu___363_1204.currentModule)
                }), mlident)
let rec mltyFvars:
              ...
              then
                ...
                | (mlpath,mlsymbol) ->
                    ...
                    let gamma =
                      ...
                      :: (g.gamma) in
                    ((let uu___364_1395 = g in
                      {
                        tcenv = (uu___364_1395.tcenv);
                        gamma;
                        tydefs = (uu___364_1395.tydefs);
                        type_names = (uu___364_1395.type_names);
                        currentModule = (uu___364_1395.currentModule)
                      }), mlsymbol)
  ...
  fun g  ->
    fun fv  ->
      fun td  ->
        ...
        let uu___365_1492 = g in
        {
          tcenv = (uu___365_1492.tcenv);
          gamma = (uu___365_1492.gamma);
          tydefs = ((m, td) :: (g.tydefs));
          type_names = (fv :: (g.type_names));
          currentModule = (uu___365_1492.currentModule)
        }
let extend_type_name: env -> FStar_Syntax_Syntax.fv -> env =
  fun g  ->
    fun fv  ->
      let uu___366_1509 = g in
      {
        tcenv = (uu___366_1509.tcenv);
        gamma = (uu___366_1509.gamma);
        tydefs = (uu___366_1509.tydefs);
        type_names = (fv :: (g.type_names));
        currentModule = (uu___366_1509.currentModule)
      }
