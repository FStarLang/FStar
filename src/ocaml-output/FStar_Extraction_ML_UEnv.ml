...
let x = (FStar_Util.find_map g.gamma (fun uu___108_813 -> (match (uu___108_813) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___109_835 -> (match (uu___109_835) with
...
let x = (FStar_Util.find_map g.gamma (fun uu___110_859 -> (match (uu___110_859) with
...
let uu___112_1001 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___112_1001.tydefs; type_names = uu___112_1001.type_names; currentModule = uu___112_1001.currentModule}))))))
...
let valid = (fun c -> (((FStar_Util.is_letter_or_digit c) || (c = 95 (*_*))) || (c = 39 (*'*))))
in (
...
| (c)::cs1 when ((FStar_Util.is_digit c) || (c = 39 (*'*))) -> begin
(95 (*_*))::(c)::cs1
end
| uu____1041 -> begin
cs
...
let has_collision = (FStar_List.existsb (fun uu___111_1071 -> (match (uu___111_1071) with
...
let gamma = (Bv (((x), (FStar_Util.Inr (((mlsymbol), (mlx1), (t_x1), (is_rec)))))))::g.gamma
in (

let tcenv = (

let uu____1292 = (FStar_Syntax_Syntax.binders_of_list ((x)::[]))
in (FStar_TypeChecker_Env.push_binders g.tcenv uu____1292))
in (((

let uu___113_1298 = g
in {tcenv = tcenv; gamma = gamma; tydefs = uu___113_1298.tydefs; type_names = uu___113_1298.type_names; currentModule = uu___113_1298.currentModule})), (mlident1)))))))))
end))))
...
let uu____1311 = (mltyFvars t1)
in (

let uu____1314 = (mltyFvars t2)
in (FStar_List.append uu____1311 uu____1314)))
end
...
let uu____1350 = (mltyFvars (FStar_Pervasives_Native.snd tys))
in (subsetMlidents uu____1350 (FStar_Pervasives_Native.fst tys))))
...
let uu____1385 = (tySchemeIsClosed t_x)
...
let uu___114_1493 = g
in {tcenv = uu___114_1493.tcenv; gamma = gamma; tydefs = uu___114_1493.tydefs; type_names = uu___114_1493.type_names; currentModule = uu___114_1493.currentModule})), (((mlsymbol), ((Prims.parse_int "0")))))))))
end)))
end
| uu____1494 -> begin
...
let uu____1562 = (FStar_Extraction_ML_Syntax.mlpath_of_lident f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu___115_1590 = g
in {tcenv = uu___115_1590.tcenv; gamma = uu___115_1590.gamma; tydefs = (((m), (td)))::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___115_1590.currentModule})))


let extend_type_name : env  ->  FStar_Syntax_Syntax.fv  ->  env = (fun g fv -> (

let uu___116_1607 = g
in {tcenv = uu___116_1607.tcenv; gamma = uu___116_1607.gamma; tydefs = uu___116_1607.tydefs; type_names = (fv)::g.type_names; currentModule = uu___116_1607.currentModule}))
...
let uu____1683 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____1683))
in (extend_lb env uu____1682 FStar_Syntax_Syntax.tun failwith_ty false false))
in (FStar_All.pipe_right uu____1677 FStar_Pervasives_Native.fst))))))
...
let uu____1701 = (FStar_Extraction_ML_Syntax.mlpath_of_lident lid)
in ((uu____1701), (lid)))))
...
let uu____1719 = (FStar_Extraction_ML_Syntax.mlpath_of_lident lid)
in ((uu____1719), (lid)))))))
