...
let rec (t_to_string : t -> Prims.string) =
  fun x ->
    ...
    | Lam (b, args, arity, uu____2745) ->
        let uu____2790 = FStar_Util.string_of_int (FStar_List.length args) in
    ...
    | Refinement (f, t) ->
        let x1 =
          FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None
            FStar_Syntax_Syntax.t_unit in
        let t1 =
          let uu____3024 = t () in FStar_Pervasives_Native.fst uu____3024 in
        let uu____3029 =
    ...
    | Rec
        (uu____3106, uu____3107, l, uu____3109, uu____3110, uu____3111,
         uu____3112)
        ->
        let uu____3157 =
          let uu____3159 =
...
let (args_to_string : args -> Prims.string) =
  fun args ->
    let uu____3223 = FStar_All.pipe_right args (FStar_List.map arg_to_string) in
        ...
        (let uu____3843 = FStar_ST.op_Bang FStar_Options.eager_embedding in
         ...
         then f ()
           ...
           (let thunk1 = FStar_Common.mk_thunk f in
            let li = let uu____3877 = FStar_Dyn.mkdyn x in (uu____3877, et) in
        ...
        fun f ->
              ...
              then
                ...
                ((let uu____4007 =
                  ...
                  then
                    ...
                    let uu____4033 = FStar_Syntax_Print.emb_typ_to_string et' in
                    FStar_Util.print2
                ...
                (let a = FStar_Dyn.undyn b in
                 (let uu____4042 =
                  ...
                  if uu____4042
                  then
                    let uu____4066 = FStar_Syntax_Print.emb_typ_to_string et in
          ...
          | uu____4071 ->
              ...
              ((let uu____4076 =
                ...
                if uu____4076
                then
                  let uu____4100 = FStar_Syntax_Print.emb_typ_to_string et in
...
let e_option :
  ...
  fun ea ->
        ...
        (fun uu____4452 ->
           ...
           | FStar_Pervasives_Native.Some x ->
               ...
               lid_as_constr FStar_Parser_Const.some_lid
                 [FStar_Syntax_Syntax.U_zero] uu____4469) in
    let un cb trm =
    ...
    let uu____4595 =
      let uu____4596 =
        let uu____4597 = let uu____4602 = type_of ea in as_arg uu____4602 in
        [uu____4597] in
      ...
      let em cb x =
        lazy_embed etyp x
          (fun uu____4688 ->
             let uu____4689 =
               let uu____4690 =
                 let uu____4695 = embed eb cb (FStar_Pervasives_Native.snd x) in
      ...
      let un cb trm =
        lazy_unembed cb etyp trm
          (fun trm1 ->
             ...
             | Construct
                 (fvar1, us,
                  (b, uu____4802)::(a, uu____4804)::uu____4805::uu____4806::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
             ...
             | uu____4868 -> FStar_Pervasives_Native.None) in
      let uu____4873 =
        let uu____4874 =
          let uu____4875 = let uu____4880 = type_of eb in as_arg uu____4880 in
          let uu____4881 =
            let uu____4888 = let uu____4893 = type_of ea in as_arg uu____4893 in
            [uu____4888] in
          uu____4875 :: uu____4881 in
        lid_as_typ FStar_Parser_Const.lid_tuple2
          [FStar_Syntax_Syntax.U_zero; FStar_Syntax_Syntax.U_zero] uu____4874 in
...
let e_either :
  ...
  fun ea ->
    fun eb ->
             ...
             | FStar_Util.Inl a ->
                 let uu____4988 =
                   ...
                   let uu____4995 =
                     ...
                     let uu____5008 =
                       let uu____5015 =
                         let uu____5020 = type_of ea in as_iarg uu____5020 in
                       [uu____5015] in
             ...
             | FStar_Util.Inr b ->
                 let uu____5038 =
                   ...
                   let uu____5045 =
                     ...
                     let uu____5058 =
                       let uu____5065 =
                         let uu____5070 = type_of ea in as_iarg uu____5070 in
                       [uu____5065] in
      ...
      let un cb trm =
        lazy_unembed cb etyp trm
          (fun trm1 ->
             match trm1 with
             | Construct
                 (fvar1, us, (a, uu____5132)::uu____5133::uu____5134::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
             ...
             | Construct
                 (fvar1, us, (b, uu____5185)::uu____5186::uu____5187::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
      ...
      let uu____5240 =
        let uu____5241 =
          let uu____5242 = let uu____5247 = type_of eb in as_arg uu____5247 in
          let uu____5248 =
            let uu____5255 = let uu____5260 = type_of ea in as_arg uu____5260 in
            [uu____5255] in
          uu____5242 :: uu____5248 in
        lid_as_typ FStar_Parser_Const.either_lid
          [FStar_Syntax_Syntax.U_zero; FStar_Syntax_Syntax.U_zero] uu____5241 in
        ...
        (fun uu____5371 ->
           ...
           let cons1 hd1 tl1 =
             ...
             lid_as_constr FStar_Parser_Const.cons_lid
               [FStar_Syntax_Syntax.U_zero] uu____5394 in
               ...
               FStar_Util.bind_opt uu____5562
                 (fun hd2 ->
                    ...
                    FStar_Util.bind_opt uu____5570
                      (fun tl2 -> FStar_Pervasives_Native.Some (hd2 :: tl2)))
           | uu____5585 -> FStar_Pervasives_Native.None) in
    let uu____5588 =
      let uu____5589 =
        let uu____5590 = let uu____5595 = type_of ea in as_arg uu____5595 in
        [uu____5590] in
  ...
  fun ea ->
    fun eb ->
            ...
            (fun x ->
               let uu____5777 =
                 let uu____5780 =
                   let uu____5781 =
                     let uu____5782 =
                       let uu____5787 = embed ea cb x in as_arg uu____5787 in
                     [uu____5782] in
      ...
      let uu____5801 =
        ...
        let uu____5803 = let uu____5804 = type_of eb in as_iarg uu____5804 in
    ...
    | uu____6263 ->
        ((let uu____6265 =
            let uu____6271 =
              ...
              FStar_Util.format1 "Not an embedded norm_step: %s" uu____6273 in
  ...
  fun f ->
    fun aopts ->
      ...
      | (FStar_Pervasives_Native.Some a0)::(FStar_Pervasives_Native.Some
          a1)::[] ->
          let uu____6606 = f a0 a1 in FStar_Pervasives_Native.Some uu____6606
...
let binary_op :
  ...
  fun as_a ->
    fun f ->
      fun args ->
        let uu____6706 = FStar_List.map as_a args in lift_binary f uu____6706
let (unary_int_op :
...
let (binary_int_op :
  ...
  fun f ->
    binary_op arg_as_int
      (fun x ->
         fun y -> let uu____6763 = f x y in embed e_int bogus_cbs uu____6763)
let (unary_bool_op :
...
let (binary_bool_op :
  ...
  fun f ->
    binary_op arg_as_bool
      (fun x ->
         fun y -> let uu____6827 = f x y in embed e_bool bogus_cbs uu____6827)
...
let (interp_prop_eq2 : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    match args with
    | (_u, uu____7252)::(_typ, uu____7254)::(a1, uu____7256)::(a2,
                                                               uu____7258)::[]
        ->
                    ...
                    (match uu____8104 with
                     | (x, uu____8116) ->
                         ...
                         FStar_Util.map_opt uu____8117
                           (fun x1 ->
                              let uu____8123 = f x1 in embed eb cb uu____8123)) in
              f_wrapped
                                  ...
                                  (match uu____8545 with
                                   | (z, uu____8579) ->
                                       ...
                                       FStar_Util.bind_opt uu____8580
                                         (fun x1 ->
                                            let uu____8586 = unembed eb cb y in
