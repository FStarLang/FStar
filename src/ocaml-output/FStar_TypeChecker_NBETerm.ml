...
let (uu___is_Bool : constant -> Prims.bool) =
  fun projectee -> match projectee with | Bool _0 -> true | uu____43 -> false
...
and t =
  ...
  (t Prims.list ->
    ...
    Prims.list,
  Prims.int, (unit -> residual_comp) FStar_Pervasives_Native.option)
  FStar_Pervasives_Native.tuple4 
  | Accu of (atom,
  (t, FStar_Syntax_Syntax.aqual) FStar_Pervasives_Native.tuple2 Prims.list)
  FStar_Pervasives_Native.tuple2 
  | Construct of (FStar_Syntax_Syntax.fv,
  ...
  FStar_Pervasives_Native.tuple2 
  | Refinement of (t -> t,
  unit -> (t, FStar_Syntax_Syntax.aqual) FStar_Pervasives_Native.tuple2)
  FStar_Pervasives_Native.tuple2 
  | Reflect of t 
  ...
  ((FStar_Syntax_Syntax.lazyinfo,
     (FStar_Dyn.dyn, FStar_Syntax_Syntax.emb_typ)
       FStar_Pervasives_Native.tuple2)
     FStar_Util.either,
  t FStar_Common.thunk) FStar_Pervasives_Native.tuple2 
  | Rec of (FStar_Syntax_Syntax.letbinding,
  FStar_Syntax_Syntax.letbinding Prims.list, t Prims.list,
  (t, FStar_Syntax_Syntax.aqual) FStar_Pervasives_Native.tuple2 Prims.list,
...
let (uu___is_Var : atom -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____493 -> false
...
let (uu___is_Lam : t -> Prims.bool) =
  fun projectee -> match projectee with | Lam _0 -> true | uu____618 -> false
...
let (uu___is_TOTAL : cflags -> Prims.bool) =
  fun projectee -> match projectee with | TOTAL -> true | uu____1584 -> false
...
let (uu___is_LEMMA : cflags -> Prims.bool) =
  fun projectee -> match projectee with | LEMMA -> true | uu____1626 -> false
...
let (isNotAccu : t -> Prims.bool) =
  fun x ->
    match x with
    | Accu (uu____1725, uu____1726) -> false
    | uu____1739 -> true
let (mkConstruct :
  ...
  fun t1 ->
    fun t2 ->
      ...
      | (Refinement (r1, t11), Refinement (r2, t21)) ->
          ...
          eq_and uu____2288
            (fun uu____2304 ->
               let uu____2305 = let uu____2306 = mkAccuVar x in r1 uu____2306 in
               let uu____2307 = let uu____2308 = mkAccuVar x in r2 uu____2308 in
...
let rec (t_to_string : t -> Prims.string) =
  fun x ->
    ...
    | Lam (b, args, arity, uu____2460) ->
        let uu____2503 = FStar_Util.string_of_int (FStar_List.length args) in
    ...
    | Refinement (f, t) ->
        let x1 =
          FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None
            FStar_Syntax_Syntax.t_unit in
        let t1 =
          let uu____2682 = t () in FStar_Pervasives_Native.fst uu____2682 in
        let uu____2687 =
    ...
    | Rec
        (uu____2744, uu____2745, l, uu____2747, uu____2748, uu____2749,
         uu____2750)
        ->
        let uu____2791 =
          let uu____2792 =
...
and (args_to_string : args -> Prims.string) =
  fun args ->
    let uu____2832 = FStar_All.pipe_right args (FStar_List.map arg_to_string) in
        ...
        (let uu____3421 = FStar_ST.op_Bang FStar_Options.eager_embedding in
         ...
         then f ()
           ...
           (let thunk = FStar_Common.mk_thunk f in
            let li = let uu____3450 = FStar_Dyn.mkdyn x in (uu____3450, et) in
      ...
      fun x ->
        fun f ->
          ...
          | Lazy (FStar_Util.Inl li, thunk) ->
              let uu____3568 = FStar_Common.force_thunk thunk in f uu____3568
          | Lazy (FStar_Util.Inr (b, et'), thunk) ->
              ...
              then
                ...
                ((let uu____3695 =
                  ...
                  if uu____3695
                  then
                    let uu____3715 = FStar_Syntax_Print.emb_typ_to_string et in
                    let uu____3716 = FStar_Syntax_Print.emb_typ_to_string et' in
                    FStar_Util.print2
                ...
                (let a = FStar_Dyn.undyn b in
                 (let uu____3721 =
                  ...
                  if uu____3721
                  then
                    let uu____3741 = FStar_Syntax_Print.emb_typ_to_string et in
          ...
          | uu____3743 ->
              ...
              ((let uu____3748 =
                ...
                if uu____3748
                then
                  let uu____3768 = FStar_Syntax_Print.emb_typ_to_string et in
        ...
        (fun uu____4082 ->
           ...
           | FStar_Pervasives_Native.Some x ->
               ...
               lid_as_constr FStar_Parser_Const.some_lid
                 [FStar_Syntax_Syntax.U_zero] uu____4099) in
    let un cb trm =
      lazy_unembed cb etyp trm
        (fun trm1 ->
           ...
           | uu____4222 -> FStar_Pervasives_Native.None) in
    let uu____4225 =
      let uu____4226 =
        let uu____4227 = let uu____4232 = type_of ea in as_arg uu____4232 in
        [uu____4227] in
...
let e_tuple2 :
  ...
  fun ea ->
    fun eb ->
      ...
      let em cb x =
        lazy_embed etyp x
          (fun uu____4313 ->
             let uu____4314 =
               let uu____4315 =
                 let uu____4320 = embed eb cb (FStar_Pervasives_Native.snd x) in
      ...
      let un cb trm =
        lazy_unembed cb etyp trm
          (fun trm1 ->
             ...
             | Construct
                 (fvar1, us,
                  (b, uu____4427)::(a, uu____4429)::uu____4430::uu____4431::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
      ...
      let uu____4498 =
        let uu____4499 =
          let uu____4500 = let uu____4505 = type_of eb in as_arg uu____4505 in
          let uu____4506 =
            let uu____4513 = let uu____4518 = type_of ea in as_arg uu____4518 in
            [uu____4513] in
          uu____4500 :: uu____4506 in
        lid_as_typ FStar_Parser_Const.lid_tuple2
          [FStar_Syntax_Syntax.U_zero; FStar_Syntax_Syntax.U_zero] uu____4499 in
             ...
             | FStar_Util.Inl a ->
                 let uu____4608 =
                   ...
                   let uu____4615 =
                     ...
                     let uu____4628 =
                       let uu____4635 =
                         let uu____4640 = type_of ea in as_iarg uu____4640 in
                       [uu____4635] in
             ...
             | FStar_Util.Inr b ->
                 let uu____4658 =
                   ...
                   let uu____4665 =
                     ...
                     let uu____4678 =
                       let uu____4685 =
                         let uu____4690 = type_of ea in as_iarg uu____4690 in
                       [uu____4685] in
      ...
      let un cb trm =
        lazy_unembed cb etyp trm
          (fun trm1 ->
             match trm1 with
             | Construct
                 (fvar1, us, (a, uu____4752)::uu____4753::uu____4754::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
             ...
             | Construct
                 (fvar1, us, (b, uu____4805)::uu____4806::uu____4807::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fvar1
             ...
             | uu____4855 -> FStar_Pervasives_Native.None) in
      let uu____4860 =
        let uu____4861 =
          let uu____4862 = let uu____4867 = type_of eb in as_arg uu____4867 in
          let uu____4868 =
            let uu____4875 = let uu____4880 = type_of ea in as_arg uu____4880 in
            [uu____4875] in
          uu____4862 :: uu____4868 in
        lid_as_typ FStar_Parser_Const.either_lid
          [FStar_Syntax_Syntax.U_zero; FStar_Syntax_Syntax.U_zero] uu____4861 in
        ...
        (fun uu____4985 ->
           ...
           let cons1 hd1 tl1 =
             ...
             lid_as_constr FStar_Parser_Const.cons_lid
               [FStar_Syntax_Syntax.U_zero] uu____5008 in
               ...
               FStar_Util.bind_opt uu____5175
                 (fun hd2 ->
                    ...
                    FStar_Util.bind_opt uu____5183
                      (fun tl2 -> FStar_Pervasives_Native.Some (hd2 :: tl2)))
           | uu____5198 -> FStar_Pervasives_Native.None) in
    let uu____5201 =
      let uu____5202 =
        let uu____5203 = let uu____5208 = type_of ea in as_arg uu____5208 in
        [uu____5203] in
  ...
  fun ea ->
    fun eb ->
            ...
            (fun x ->
               let uu____5383 =
                 let uu____5386 =
                   let uu____5387 =
                     let uu____5388 =
                       let uu____5393 = embed ea cb x in as_arg uu____5393 in
                     [uu____5388] in
      ...
      let uu____5406 =
        ...
        let uu____5408 = let uu____5409 = type_of eb in as_iarg uu____5409 in
    ...
    | uu____5834 ->
        ((let uu____5836 =
            let uu____5841 =
              ...
              FStar_Util.format1 "Not an embedded norm_step: %s" uu____5842 in
  ...
  fun f ->
    fun aopts ->
      ...
      | (FStar_Pervasives_Native.Some a0)::(FStar_Pervasives_Native.Some
          a1)::[] ->
          let uu____6153 = f a0 a1 in FStar_Pervasives_Native.Some uu____6153
...
let binary_op :
  ...
  fun as_a ->
    fun f ->
      fun args ->
        let uu____6251 = FStar_List.map as_a args in lift_binary f uu____6251
let (unary_int_op :
...
let (binary_int_op :
  ...
  fun f ->
    binary_op arg_as_int
      (fun x ->
         fun y -> let uu____6306 = f x y in embed e_int bogus_cbs uu____6306)
let (unary_bool_op :
...
let (binary_bool_op :
  ...
  fun f ->
    binary_op arg_as_bool
      (fun x ->
         fun y -> let uu____6351 = f x y in embed e_bool bogus_cbs uu____6351)
...
let (decidable_eq : Prims.bool -> args -> t FStar_Pervasives_Native.option) =
  fun neg ->
    fun args ->
      ...
      match args with
      | (_univ, uu____6653)::(_typ, uu____6655)::(a1, uu____6657)::(a2,
                                                                    uu____6659)::[]
          ->
          let uu____6680 = eq_t a1 a2 in
          (match uu____6680 with
           | FStar_Syntax_Util.Equal ->
               FStar_Pervasives_Native.Some (if neg then fal else tru)
           | FStar_Syntax_Util.NotEqual ->
               FStar_Pervasives_Native.Some (if neg then tru else fal)
           | uu____6685 -> FStar_Pervasives_Native.None)
      | uu____6686 -> failwith "Unexpected number of arguments"
let (interp_prop : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    match args with
    | (_u, uu____6699)::(_typ, uu____6701)::(a1, uu____6703)::(a2,
                                                               uu____6705)::[]
        ->
        let uu____6726 = eq_t a1 a2 in
        (match uu____6726 with
         | FStar_Syntax_Util.Equal ->
             let uu____6729 = embed e_bool bogus_cbs true in
             FStar_Pervasives_Native.Some uu____6729
         | FStar_Syntax_Util.NotEqual ->
             let uu____6730 = embed e_bool bogus_cbs false in
             FStar_Pervasives_Native.Some uu____6730
         | FStar_Syntax_Util.Unknown -> FStar_Pervasives_Native.None)
    | uu____6731 -> failwith "Unexpected number of arguments"
let (dummy_interp :
  FStar_Ident.lid -> args -> t FStar_Pervasives_Native.option) =
  fun lid ->
    fun args ->
      let uu____6748 =
        let uu____6749 = FStar_Ident.string_of_lid lid in
        Prims.strcat "No interpretation for " uu____6749 in
      failwith uu____6748
let (prims_to_fstar_range_step : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    match args with
    | (a1, uu____6762)::[] ->
        let uu____6771 = unembed e_range bogus_cbs a1 in
        (match uu____6771 with
         | FStar_Pervasives_Native.Some r ->
             let uu____6777 = embed e_range bogus_cbs r in
             FStar_Pervasives_Native.Some uu____6777
         | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None)
    | uu____6778 -> failwith "Unexpected number of arguments"
let (string_split' : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    match args with
    | a1::a2::[] ->
        let uu____6812 = arg_as_list e_char a1 in
        (match uu____6812 with
         | FStar_Pervasives_Native.Some s1 ->
             let uu____6828 = arg_as_string a2 in
             (match uu____6828 with
              | FStar_Pervasives_Native.Some s2 ->
                  let r = FStar_String.split s1 s2 in
                  let uu____6837 =
                    let uu____6838 = e_list e_string in
                    embed uu____6838 bogus_cbs r in
...
let (string_substring' : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    ...
    | a1::a2::a3::[] ->
        let uu____6895 =
          let uu____6908 = arg_as_string a1 in
          let uu____6911 = arg_as_int a2 in
          let uu____6914 = arg_as_int a3 in
          (uu____6908, uu____6911, uu____6914) in
...
let (mk_range : args -> t FStar_Pervasives_Native.option) =
  fun args ->
    ...
    | fn::from_line::from_col::to_line::to_col::[] ->
        let uu____7022 =
          let uu____7043 = arg_as_string fn in
          let uu____7046 = arg_as_int from_line in
          let uu____7049 = arg_as_int from_col in
          let uu____7052 = arg_as_int to_line in
          let uu____7055 = arg_as_int to_col in
          (uu____7043, uu____7046, uu____7049, uu____7052, uu____7055) in
        (match uu____7022 with
         | (FStar_Pervasives_Native.Some fn1, FStar_Pervasives_Native.Some
            ...
            to_c) ->
             let r =
               let uu____7086 =
                 let uu____7087 = FStar_BigInt.to_int_fs from_l in
                 let uu____7088 = FStar_BigInt.to_int_fs from_c in
                 FStar_Range.mk_pos uu____7087 uu____7088 in
               let uu____7089 =
                 let uu____7090 = FStar_BigInt.to_int_fs to_l in
                 let uu____7091 = FStar_BigInt.to_int_fs to_c in
                 FStar_Range.mk_pos uu____7090 uu____7091 in
               FStar_Range.mk_range fn1 uu____7086 uu____7089 in
             let uu____7092 = embed e_range bogus_cbs r in
      ...
      fun f ->
        fun n_tvars ->
          fun _fv_lid ->
            fun cb ->
              let f_wrapped args =
                let uu____7201 = FStar_List.splitAt n_tvars args in
                match uu____7201 with
                | (_tvar_args, rest_args) ->
                    let uu____7250 = FStar_List.hd rest_args in
                    (match uu____7250 with
                     | (x, uu____7262) ->
                         let uu____7263 = unembed ea cb x in
                         FStar_Util.map_opt uu____7263
                           (fun x1 ->
                              let uu____7269 = f x1 in embed eb cb uu____7269)) in
              f_wrapped
        ...
        fun f ->
          fun n_tvars ->
            fun _fv_lid ->
              fun cb ->
                let f_wrapped args =
                  let uu____7375 = FStar_List.splitAt n_tvars args in
                  match uu____7375 with
                  | (_tvar_args, rest_args) ->
                      let uu____7424 = FStar_List.hd rest_args in
                      (match uu____7424 with
                       | (x, uu____7436) ->
                           let uu____7437 =
                             let uu____7442 = FStar_List.tl rest_args in
                             FStar_List.hd uu____7442 in
                           (match uu____7437 with
                            | (y, uu____7460) ->
                                let uu____7461 = unembed ea cb x in
                                FStar_Util.bind_opt uu____7461
                                  (fun x1 ->
                                     let uu____7467 = unembed eb cb y in
                                     FStar_Util.bind_opt uu____7467
                                       (fun y1 ->
                                          let uu____7473 =
                                            let uu____7474 = f x1 y1 in
                                            embed ec cb uu____7474 in
                                          FStar_Pervasives_Native.Some
                                            uu____7473)))) in
                f_wrapped
          ...
          fun f ->
            fun n_tvars ->
              fun _fv_lid ->
                fun cb ->
                  let f_wrapped args =
                    let uu____7599 = FStar_List.splitAt n_tvars args in
                    match uu____7599 with
                    | (_tvar_args, rest_args) ->
                        let uu____7648 = FStar_List.hd rest_args in
                        (match uu____7648 with
                         | (x, uu____7660) ->
                             let uu____7661 =
                               let uu____7666 = FStar_List.tl rest_args in
                               FStar_List.hd uu____7666 in
                              ...
                              | (y, uu____7684) ->
                                  let uu____7685 =
                                    let uu____7690 =
                                      ...
                                      FStar_List.tl uu____7697 in
                                    FStar_List.hd uu____7690 in
                                  (match uu____7685 with
                                   | (z, uu____7719) ->
                                       let uu____7720 = unembed ea cb x in
                                       FStar_Util.bind_opt uu____7720
                                         (fun x1 ->
                                            let uu____7726 = unembed eb cb y in
                                            FStar_Util.bind_opt uu____7726
                                              (fun y1 ->
                                                 let uu____7732 =
                                                   unembed ec cb z in
                                                 FStar_Util.bind_opt
