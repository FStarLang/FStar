  ...
  fun a  ->
    ...
    | UnreducedLetRec (uu___,body,lbs) ->
        let uu___1 =
          ...
          let uu___3 =
            let uu___4 =
              let uu___5 = t_to_string body  in
  ...
  fun em  ->
    fun un  ->
      mk_emb
        (fun cbs  ->
           fun t1  ->
             let uu___ = em cbs t1  in FStar_All.pipe_left mk_t uu___)
  ...
  fun ea  ->
    fun ab  ->
      fun ba  ->
        fun ot  ->
          mk_emb
            (fun cbs  -> fun x  -> let uu___ = ba x  in embed ea cbs uu___)
            (fun cbs  ->
               fun t1  ->
                 let uu___ = unembed ea cbs t1  in
                 FStar_Util.map_opt uu___ ab)
            (match ot with
      ...
      fun x  ->
        fun f  ->
          ...
          | Lazy (FStar_Util.Inr (b,et'),thunk) ->
              ...
              if uu___
              then
                let res = let uu___1 = FStar_Thunk.force thunk  in f uu___1
                   in
                ((let uu___2 = FStar_ST.op_Bang FStar_Options.debug_embedding
                     in
                  if uu___2
                  then
                ...
                (let a1 = FStar_Dyn.undyn b  in
                 (let uu___3 = FStar_ST.op_Bang FStar_Options.debug_embedding
                     in
                  if uu___3
                  then
                    let uu___4 = FStar_Syntax_Print.emb_typ_to_string et  in
...
let e_option :
  ...
  fun ea  ->
      ...
      lazy_embed etyp o
        (fun uu___  ->
           ...
           | FStar_Pervasives_Native.Some x ->
               let uu___1 =
                 let uu___2 = let uu___3 = embed ea cb x  in as_arg uu___3
                    in
                 let uu___3 =
                   let uu___4 = let uu___5 = type_of ea  in as_iarg uu___5
                      in
                   [uu___4]  in
                 uu___2 :: uu___3  in
    ...
    let uu___ =
      let uu___1 =
        let uu___2 = let uu___3 = type_of ea  in as_arg uu___3  in [uu___2]
         in
        ...
        lazy_embed etyp x
          (fun uu___  ->
             let uu___1 =
               ...
               let uu___3 =
                 let uu___4 =
                   let uu___5 = embed ea cb (FStar_Pervasives_Native.fst x)
                      in
                   as_arg uu___5  in
                 let uu___5 =
                   let uu___6 = let uu___7 = type_of eb  in as_iarg uu___7
                      in
                   let uu___7 =
                     let uu___8 = let uu___9 = type_of ea  in as_iarg uu___9
                        in
                     [uu___8]  in
                   uu___6 :: uu___7  in
                 uu___4 :: uu___5  in
      ...
      let un cb trm =
        lazy_unembed cb etyp trm
          (fun trm1  ->
             match trm1.nbe_t with
             | Construct
                 (fvar,us,(b1,uu___)::(a1,uu___1)::uu___2::uu___3::[]) when
      ...
      let em cb s =
        lazy_embed etyp s
          (fun uu___  ->
             ...
             | FStar_Util.Inl a1 ->
                 let uu___1 =
                   let uu___2 = let uu___3 = embed ea cb a1  in as_arg uu___3
                      in
                   let uu___3 =
                     let uu___4 = let uu___5 = type_of eb  in as_iarg uu___5
                        in
                     let uu___5 =
                       let uu___6 =
             ...
             | FStar_Util.Inr b1 ->
                 let uu___1 =
                   let uu___2 = let uu___3 = embed eb cb b1  in as_arg uu___3
                      in
                   let uu___3 =
                     let uu___4 = let uu___5 = type_of eb  in as_iarg uu___5
                        in
        ...
        (fun uu___  ->
           ...
           let cons hd tl =
             let uu___1 =
               ...
               let uu___3 =
                 let uu___4 = let uu___5 = embed ea cb hd  in as_arg uu___5
                    in
                 [uu___4; typ]  in
               uu___2 :: uu___3  in
      ...
      lazy_unembed cb etyp trm
        (fun trm1  ->
           ...
           | Construct (fv,uu___,uu___1) when
               ...
               FStar_Pervasives_Native.Some []
           | Construct
               (fv,uu___,(tl,FStar_Pervasives_Native.None )::(hd,FStar_Pervasives_Native.None
          ...
          (fun uu___  ->
             let uu___1 =
               let uu___2 =
                 let uu___3 =
                   let uu___4 =
                     let uu___5 = let uu___6 = type_of eb  in as_arg uu___6
                        in
                     [uu___5]  in
                   FStar_Util.Inr uu___4  in
                 ((fun tas  ->
                     let uu___4 =
                       let uu___5 = FStar_List.hd tas  in
                  ...
                  in
               Lam uu___2  in
             FStar_All.pipe_left mk_t uu___1)
         in
      let un cb lam =
        let k lam1 =
          FStar_Pervasives_Native.Some
...
let (e_norm_step : FStar_Syntax_Embeddings.norm_step embedding) =
  let em cb n =
    ...
    | FStar_Syntax_Embeddings.UnfoldOnly l ->
        ...
        let uu___1 =
          let uu___2 =
            let uu___3 = let uu___4 = e_list e_string  in embed uu___4 cb l
               in
            as_arg uu___3  in
          [uu___2]  in
        mkFV uu___ [] uu___1
...
let (arg_as_bounded_int :
  ...
  fun uu___  ->
    ...
    | (a,uu___1) ->
        (match a.nbe_t with
         | FV
             (fv1,[],({ nbe_t = Constant (Int i); nbe_r = uu___2;_},uu___3)::[])
             when
             let uu___4 =
               FStar_Ident.string_of_lid
...
let (binary_string_op :
  ...
  fun f  ->
    binary_op arg_as_string
      (fun x  ->
         fun y  -> let uu___ = f x y  in embed e_string bogus_cbs uu___)
  ...
  fun args1  ->
    ...
    | (_u,uu___)::(_v,uu___1)::(t1,uu___2)::(t2,uu___3)::(a1,uu___4)::
        ...
        let uu___6 =
          ...
          let uu___8 = eq_t a1 a2  in FStar_Syntax_Util.eq_inj uu___7 uu___8
           in
        (match uu___6 with
         | FStar_Syntax_Util.Equal  ->
         ...
         | FStar_Pervasives_Native.Some s1 ->
             ...
             (match uu___1 with
              | FStar_Pervasives_Native.Some s2 ->
                  ...
                  let uu___2 =
                    let uu___3 = e_list e_string  in embed uu___3 bogus_cbs r
                     in
                  FStar_Pervasives_Native.Some uu___2
              | uu___2 -> FStar_Pervasives_Native.None)
         | uu___1 -> FStar_Pervasives_Native.None)
                    ...
                    (match uu___1 with
                     | (x,uu___2) ->
                         ...
                         FStar_Util.map_opt uu___3
                           (fun x1  ->
                              let uu___4 = f x1  in embed eb cb uu___4))
                 in
              f_wrapped
                         ...
                         | (x,uu___2) ->
                             ...
                             (match uu___3 with
                              | (y,uu___4) ->
                                  let uu___5 =
                                    let uu___6 =
                                      let uu___7 = FStar_List.tl rest_args
                                         in
