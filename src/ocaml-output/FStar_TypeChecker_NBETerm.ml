...
and t' =
  ...
  (t * FStar_Syntax_Syntax.aqual) Prims.list) Prims.either * Prims.int) 
  ...
  ((t * FStar_Syntax_Syntax.aqual) Prims.list * comp)) Prims.either 
  ...
  (FStar_Compiler_Dyn.dyn * FStar_Syntax_Syntax.emb_typ)) Prims.either * t
  FStar_Thunk.t) 
...
let (__proj__Lazy__item___0 :
  t' ->
    ((FStar_Syntax_Syntax.lazyinfo,
      (FStar_Compiler_Dyn.dyn * FStar_Syntax_Syntax.emb_typ)) Prims.either *
      t FStar_Thunk.t))
...
let rec (t_to_string : t -> Prims.string) =
  fun x ->
    ...
    | Lazy (Prims.Inr (uu___, et), uu___1) ->
...
let (make_arrow1 : t -> arg -> t) =
  fun t1 ->
    fun a ->
      FStar_Compiler_Effect.op_Less_Bar mk_t
        (Arrow (Prims.Inr ([a], (Tot (t1, FStar_Pervasives_Native.None)))))
  ...
  fun cb ->
    fun et ->
      fun x ->
        fun f ->
          match x.nbe_t with
          | Lazy (Prims.Inl li, thunk) ->
              let uu___ = FStar_Thunk.force thunk in f uu___
          | Lazy (Prims.Inr (b, et'), thunk) ->
              let uu___ =
                (et <> et') ||
          ...
          (fun trm1 ->
             ...
             | Construct (fvar, us, (a1, uu___)::uu___1::uu___2::[]) when
                 ...
                 FStar_Compiler_Util.bind_opt uu___3
                   (fun a2 -> FStar_Pervasives_Native.Some (Prims.Inl a2))
             | Construct (fvar, us, (b1, uu___)::uu___1::uu___2::[]) when
                 ...
                 FStar_Compiler_Util.bind_opt uu___3
                   (fun b2 -> FStar_Pervasives_Native.Some (Prims.Inr b2))
             | uu___ -> FStar_Pervasives_Native.None) in
      let uu___ =
        let uu___1 =
          let uu___2 = let uu___3 = type_of eb in as_arg uu___3 in
