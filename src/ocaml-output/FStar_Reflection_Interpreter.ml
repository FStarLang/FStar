...
let unembed :
  'Auu____65807 .
    'Auu____65807 FStar_Syntax_Embeddings.embedding ->
      FStar_Syntax_Syntax.term ->
        FStar_Syntax_Embeddings.norm_cb ->
          'Auu____65807 FStar_Pervasives_Native.option
  =
  fun ea  ->
    fun a  ->
      fun norm_cb  ->
        let uu____65833 = FStar_Syntax_Embeddings.unembed ea a  in
        uu____65833 true norm_cb
  
let try_unembed :
  'Auu____65856 .
    'Auu____65856 FStar_Syntax_Embeddings.embedding ->
      FStar_Syntax_Syntax.term ->
        FStar_Syntax_Embeddings.norm_cb ->
          'Auu____65856 FStar_Pervasives_Native.option
  =
  fun ea  ->
    fun a  ->
      fun norm_cb  ->
        let uu____65882 = FStar_Syntax_Embeddings.unembed ea a  in
        uu____65882 false norm_cb
  
let embed :
  'Auu____65907 .
    'Auu____65907 FStar_Syntax_Embeddings.embedding ->
      FStar_Range.range ->
        'Auu____65907 ->
  ...
  fun ea  ->
    fun r  ->
      fun x  ->
        fun norm_cb  ->
          let uu____65936 = FStar_Syntax_Embeddings.embed ea x  in
          uu____65936 r FStar_Pervasives_Native.None norm_cb
          ...
          fun psc  ->
            fun n1  ->
              fun args  ->
                match args with
                | (a,uu____66046)::[] ->
                    let uu____66071 = try_unembed ea a n1  in
                    FStar_Util.bind_opt uu____66071
                      (fun a1  ->
                         let uu____66079 =
                           let uu____66080 =
                             FStar_TypeChecker_Cfg.psc_range psc  in
                           let uu____66081 = f a1  in
                           embed er uu____66080 uu____66081 n1  in
                         FStar_Pervasives_Native.Some uu____66079)
                | uu____66084 -> FStar_Pervasives_Native.None
          ...
          fun er  ->
            fun psc  ->
              fun n1  ->
                fun args  ->
                  match args with
                  | (a,uu____66180)::(b,uu____66182)::[] ->
                      let uu____66223 = try_unembed ea a n1  in
                      FStar_Util.bind_opt uu____66223
                        (fun a1  ->
                           let uu____66231 = try_unembed eb b n1  in
                           FStar_Util.bind_opt uu____66231
                             (fun b1  ->
                                let uu____66239 =
                                  let uu____66240 =
                                    FStar_TypeChecker_Cfg.psc_range psc  in
                                  let uu____66241 = f a1 b1  in
                                  embed er uu____66240 uu____66241 n1  in
                                FStar_Pervasives_Native.Some uu____66239))
        ...
        fun er  ->
          fun cb  ->
            fun args  ->
              match args with
              | (a,uu____66310)::[] ->
                  let uu____66319 = FStar_TypeChecker_NBETerm.unembed ea cb a
                     in
                  FStar_Util.bind_opt uu____66319
                    (fun a1  ->
                       let uu____66325 =
                         let uu____66326 = f a1  in
                         FStar_TypeChecker_NBETerm.embed er cb uu____66326
                          in
                       FStar_Pervasives_Native.Some uu____66325)
              | uu____66327 -> FStar_Pervasives_Native.None
        ...
        fun eb  ->
          fun er  ->
            fun cb  ->
              fun args  ->
                match args with
                | (a,uu____66412)::(b,uu____66414)::[] ->
                    let uu____66427 =
                      FStar_TypeChecker_NBETerm.unembed ea cb a  in
                    FStar_Util.bind_opt uu____66427
                      (fun a1  ->
                         let uu____66433 =
                           FStar_TypeChecker_NBETerm.unembed eb cb b  in
                         FStar_Util.bind_opt uu____66433
                           (fun b1  ->
                              let uu____66439 =
                                let uu____66440 = f a1 b1  in
                                FStar_TypeChecker_NBETerm.embed er cb
                                  uu____66440
                                 in
                              FStar_Pervasives_Native.Some uu____66439))
                | uu____66441 -> FStar_Pervasives_Native.None
  ...
  let uu____66741 =
    ...
    let uu____66746 =
      ...
      let uu____66757 =
                                          ...
                                          let uu____66887 =
                                            let uu____66890 =
                                              ...
                                              mk2 "lookup_typ"
                                               ...
                                               in
                                            [uu____66890]  in
                                          uu____66885 :: uu____66887  in
                                        uu____66878 :: uu____66882  in
                                      uu____66867 :: uu____66875  in
                                    uu____66860 :: uu____66864  in
                                  uu____66841 :: uu____66857  in
                                uu____66834 :: uu____66838  in
                              uu____66829 :: uu____66831  in
                            uu____66824 :: uu____66826  in
                          uu____66819 :: uu____66821  in
                        uu____66810 :: uu____66816  in
                      uu____66801 :: uu____66807  in
                    uu____66796 :: uu____66798  in
        ...
        uu____66760 :: uu____66768  in
      uu____66749 :: uu____66757  in
    uu____66744 :: uu____66746  in
  uu____66739 :: uu____66741 