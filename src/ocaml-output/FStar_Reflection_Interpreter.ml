      ...
      let uu____397 =
        let uu____400 =
          ...
          mk11 () () "pack_fv"
            ...
            (Obj.magic uu____401)
            (Obj.magic FStar_Reflection_Embeddings.embed_fv) in
        let uu____410 =
          let uu____413 =
            mk11 () () "inspect_comp"
              (fun a419 ->
              ...
              (Obj.magic FStar_Reflection_Embeddings.embed_comp_view) in
          let uu____414 =
            let uu____417 =
              mk11 () () "pack_comp"
                (fun a420 ->
                ...
                (Obj.magic FStar_Reflection_Embeddings.embed_comp) in
            let uu____418 =
              let uu____421 =
                mk11 () () "inspect_sigelt"
                  (fun a421 ->
                  ...
                  (Obj.magic FStar_Reflection_Embeddings.embed_sigelt_view) in
              let uu____422 =
                let uu____425 =
                  mk11 () () "pack_sigelt"
                    (fun a422 ->
                    ...
                    (Obj.magic FStar_Reflection_Embeddings.embed_sigelt) in
                let uu____426 =
                  let uu____429 =
                    mk11 () () "inspect_bv"
                      (fun a423 ->
                      ...
                      (Obj.magic FStar_Reflection_Embeddings.embed_bv_view) in
                  let uu____430 =
                    let uu____433 =
                      mk11 () () "pack_bv"
                        (fun a424 ->
                        ...
                        (Obj.magic FStar_Reflection_Embeddings.embed_bv) in
                    let uu____434 =
                      let uu____437 =
                        mk11 () () "inspect_binder"
                          (fun a425 ->
                          ...
                          (Obj.magic
                             FStar_Reflection_Embeddings.embed_binder_view) in
                      let uu____438 =
                        let uu____441 =
                          mk2 () () () "pack_binder"
                            (fun a426 ->
                            ...
                            (Obj.magic
                               FStar_Reflection_Embeddings.embed_binder) in
                        let uu____442 =
                          let uu____445 =
                            mk2 () () () "compare_bv"
                              (fun a428 ->
                              ...
                              (Obj.magic
                                 FStar_Reflection_Embeddings.unembed_bv)
                              (Obj.magic
                                 FStar_Reflection_Embeddings.embed_order) in
                          let uu____446 =
                            let uu____449 =
                              mk2 () () () "is_free"
                                (fun a430 ->
                                ...
                                let uu____458 =
                                  let uu____461 =
                                    mk11 () () "binders_of_env"
                                      ...
                                      (Obj.magic
                                         FStar_Reflection_Embeddings.embed_binders) in
                                  let uu____462 =
                                    let uu____465 =
                                      let uu____466 =
                                        FStar_Syntax_Embeddings.embed_option
                                          FStar_Reflection_Embeddings.embed_sigelt
                                          FStar_Reflection_Data.fstar_refl_sigelt in
                                      mk2 () () () "lookup_typ"
                                        (fun a436 ->
                                           fun a437 ->
                                             (Obj.magic
