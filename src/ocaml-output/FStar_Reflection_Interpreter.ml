              ...
              fun args  ->
                ...
                | (a1,uu___)::[] ->
                    ...
                    FStar_Util.bind_opt uu___1
                      (fun a2  ->
                         let uu___2 =
                           let uu___3 = FStar_TypeChecker_Cfg.psc_range psc
                              in
          ...
          fun er  ->
            fun cb  ->
              fun args  ->
                match args with
                | (a1,uu___)::(b1,uu___1)::[] ->
                    let uu___2 = FStar_TypeChecker_NBETerm.unembed ea cb a1
                       in
                    FStar_Util.bind_opt uu___2
                      (fun a2  ->
                         let uu___3 =
                         ...
                         FStar_Util.bind_opt uu___3
                           (fun b2  ->
                              let uu___4 =
                                ...
                                FStar_TypeChecker_NBETerm.embed er cb uu___5
                                 in
                              FStar_Pervasives_Native.Some uu___4))
                | uu___ -> FStar_Pervasives_Native.None
                    ...
                    let uu___19 =
                      let uu___20 =
                        ...
                        mk1 "sigelt_opts" FStar_Reflection_Basic.sigelt_opts
                          ...
                          FStar_Reflection_NBEEmbeddings.e_sigelt uu___22
                         in
                      let uu___21 =
                        let uu___22 =
                          mk1 "sigelt_attrs"
