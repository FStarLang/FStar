...
let (reflection_primops :
  ...
  let uu____304 =
    mk11 () () "inspect_ln"
      (fun a403  -> (Obj.magic FStar_Reflection_Basic.inspect_ln) a403)
  ...
  let uu____305 =
    let uu____308 =
      mk11 () () "pack_ln"
        (fun a404  -> (Obj.magic FStar_Reflection_Basic.pack_ln) a404)
        (Obj.magic FStar_Reflection_Embeddings.e_term_view)
        (Obj.magic FStar_Reflection_Embeddings.e_term)
       in
    let uu____309 =
      let uu____312 =
        mk11 () () "inspect_fv"
          (fun a405  -> (Obj.magic FStar_Reflection_Basic.inspect_fv) a405)
        ...
        let uu____316 =
          let uu____317 =
            FStar_Syntax_Embeddings.e_list FStar_Syntax_Embeddings.e_string
             in
          mk11 () () "pack_fv"
            (fun a406  -> (Obj.magic FStar_Reflection_Basic.pack_fv) a406)
            (Obj.magic uu____317)
            (Obj.magic FStar_Reflection_Embeddings.e_fv)
           in
        let uu____322 =
          let uu____325 =
            mk11 () () "inspect_comp"
              (fun a407  ->
                 (Obj.magic FStar_Reflection_Basic.inspect_comp) a407)
          ...
          let uu____326 =
            let uu____329 =
              mk11 () () "pack_comp"
                (fun a408  ->
                   (Obj.magic FStar_Reflection_Basic.pack_comp) a408)
                (Obj.magic FStar_Reflection_Embeddings.e_comp_view)
                (Obj.magic FStar_Reflection_Embeddings.e_comp)
               in
            let uu____330 =
              let uu____333 =
                mk11 () () "inspect_sigelt"
                  (fun a409  ->
                     (Obj.magic FStar_Reflection_Basic.inspect_sigelt) a409)
              ...
              let uu____334 =
                let uu____337 =
                  mk11 () () "pack_sigelt"
                    (fun a410  ->
                       (Obj.magic FStar_Reflection_Basic.pack_sigelt) a410)
                    (Obj.magic FStar_Reflection_Embeddings.e_sigelt_view)
                    (Obj.magic FStar_Reflection_Embeddings.e_sigelt)
                   in
                let uu____338 =
                  let uu____341 =
                    mk11 () () "inspect_bv"
                      (fun a411  ->
                         (Obj.magic FStar_Reflection_Basic.inspect_bv) a411)
                  ...
                  let uu____342 =
                    let uu____345 =
                      mk11 () () "pack_bv"
                        (fun a412  ->
                           (Obj.magic FStar_Reflection_Basic.pack_bv) a412)
                        (Obj.magic FStar_Reflection_Embeddings.e_bv_view)
                        (Obj.magic FStar_Reflection_Embeddings.e_bv)
                       in
                    let uu____346 =
                        ...
                        let uu____353 =
                          mk2 () () () "pack_binder"
                            (fun a414  ->
                               fun a415  ->
                                 (Obj.magic
                                    FStar_Reflection_Basic.pack_binder) a414
                                   a415)
                            (Obj.magic FStar_Reflection_Embeddings.e_bv)
                          ...
                          let uu____357 =
                            mk2 () () () "compare_bv"
                              (fun a416  ->
                                 fun a417  ->
                                   (Obj.magic
                                      FStar_Reflection_Basic.compare_bv) a416
                                     a417)
                              (Obj.magic FStar_Reflection_Embeddings.e_bv)
                              (Obj.magic FStar_Reflection_Embeddings.e_bv)
                            ...
                            let uu____361 =
                              mk2 () () () "is_free"
                                (fun a418  ->
                                   fun a419  ->
                                     (Obj.magic
                                        FStar_Reflection_Basic.is_free) a418
                                       a419)
                                (Obj.magic FStar_Reflection_Embeddings.e_bv)
                                (Obj.magic FStar_Reflection_Embeddings.e_term)
