...
let (reflection_primops :
  ...
  let uu____388 =
    mk11 () () "__inspect"
      (fun a413  -> (Obj.magic FStar_Reflection_Basic.inspect) a413)
  ...
  let uu____389 =
    let uu____392 =
      mk11 () () "__pack"
        (fun a414  -> (Obj.magic FStar_Reflection_Basic.pack) a414)
    ...
    let uu____393 =
      let uu____396 =
        mk11 () () "__inspect_fv"
          (fun a415  -> (Obj.magic FStar_Reflection_Basic.inspect_fv) a415)
      ...
      let uu____397 =
        let uu____400 =
          let uu____401 =
            FStar_Syntax_Embeddings.unembed_list
             ...
             in
          mk11 () () "__pack_fv"
            (fun a416  -> (Obj.magic FStar_Reflection_Basic.pack_fv) a416)
            (Obj.magic uu____401)
        ...
        let uu____410 =
          let uu____413 =
            mk11 () () "__inspect_comp"
              (fun a417  ->
                 (Obj.magic FStar_Reflection_Basic.inspect_comp) a417)
          ...
          let uu____414 =
            let uu____417 =
              mk11 () () "__pack_comp"
                (fun a418  ->
                   (Obj.magic FStar_Reflection_Basic.pack_comp) a418)
            ...
            let uu____418 =
              let uu____421 =
                mk11 () () "__inspect_bv"
                  (fun a419  ->
                     (Obj.magic FStar_Reflection_Basic.inspect_bv) a419)
                  ...
                  let uu____430 =
                    let uu____433 =
                      mk2 () () () "__is_free"
                        (fun a423  ->
                           fun a424  ->
                             (Obj.magic FStar_Reflection_Basic.is_free) a423
                               a424)
                        (Obj.magic FStar_Reflection_Basic.unembed_binder)
                        (Obj.magic FStar_Reflection_Basic.unembed_term)
                      ...
                      let uu____438 =
                        let uu____441 =
                          mk11 () () "__term_to_string"
                            (fun a427  ->
                               (Obj.magic
                                  FStar_Reflection_Basic.term_to_string) a427)
                            (Obj.magic FStar_Reflection_Basic.unembed_term)
                            (Obj.magic FStar_Syntax_Embeddings.embed_string)
                           in
                        let uu____442 =
