        ...
        fun r ->
          let pure_wp_t =
            let pure_wp_ts =
              ...
              FStar_All.op_Bar_Greater uu___ FStar_Util.must in
            let uu___ = FStar_TypeChecker_Env.inst_tscheme pure_wp_ts in
            match uu___ with
            | (uu___1, pure_wp_t1) ->
                let uu___2 =
                  let uu___3 =
                    FStar_All.op_Bar_Greater t FStar_Syntax_Syntax.as_arg in
                  [uu___3] in
        ...
        fun check_non_informatve_binders ->
          fun r ->
            ...
            let repr_names_args =
              FStar_List.collect
                (fun repr ->
                   let uu___ = FStar_All.op_Bar_Greater repr repr_args in
                   FStar_All.op_Bar_Greater uu___ head_names_in_args)
                repr_terms in
            (let uu___1 =
               FStar_All.op_Less_Bar (FStar_TypeChecker_Env.debug env)
                 (FStar_Options.Other "LayeredEffectsTc") in
      ...
      fun quals ->
        fun attrs ->
          ...
          FStar_Errors.with_ctx uu___
            (fun uu___1 ->
               (let uu___3 =
                  FStar_All.op_Less_Bar (FStar_TypeChecker_Env.debug env0)
                    (FStar_Options.Other "LayeredEffectsTc") in
                if uu___3
                then
               ...
               (let log_combinator s uu___4 =
                ...
                (let repr =
                   let repr_ts =
                     ...
                     FStar_All.op_Bar_Greater uu___5 FStar_Util.must in
                   let r =
                 ...
                 (let fresh_repr r env u a_tm =
                  ...
                  let return_repr =
                    let return_repr_ts =
                      ...
                      FStar_All.op_Bar_Greater uu___6 FStar_Util.must in
                    let r =
                  ...
                  (let bind_repr =
                     let bind_repr_ts =
                       ...
                       FStar_All.op_Bar_Greater uu___7 FStar_Util.must in
                     let r =
                   ...
                   (let stronger_repr =
                      let stronger_repr1 =
                        let ts =
                          ...
                          FStar_All.op_Bar_Greater uu___8 FStar_Util.must in
                        let uu___8 =
                          let uu___9 =
                            let uu___10 =
                              FStar_All.op_Bar_Greater ts
                                 ...
                                 (match uu___11 with
                                  | FStar_Syntax_Syntax.Tm_arrow
                                      ...
                                      let repr_t =
                                        ...
                                        FStar_All.op_Bar_Greater uu___13
                                          FStar_Pervasives_Native.snd in
                                      let repr_t_applied =
                                        let uu___13 =
                                          let uu___14 =
                                      ...
                                      let uu___13 =
                                        let uu___14 =
                                          FStar_List.op_At bs1 [f_b] in
                                        let uu___15 =
                                          FStar_All.op_Bar_Greater
                                            f_b.FStar_Syntax_Syntax.binder_bv
                                            FStar_Syntax_Syntax.bv_to_name in
                                        FStar_Syntax_Util.abs uu___14 uu___15
                    ...
                    (let if_then_else =
                       let if_then_else_ts =
                         let ts =
                           ...
                           FStar_All.op_Bar_Greater uu___9 FStar_Util.must in
                         let uu___9 =
                           let uu___10 =
                             let uu___11 =
                               FStar_All.op_Bar_Greater ts
                                       ...
                                       let repr_t =
                                         ...
                                         let uu___14 =
                                           FStar_TypeChecker_Env.inst_tscheme_with
                                             repr_ts
                                             [FStar_Syntax_Syntax.U_unknown] in
                                         FStar_All.op_Bar_Greater uu___14
                                           FStar_Pervasives_Native.snd in
                                       let repr_t_applied =
                                         let uu___14 =
                                           let uu___15 =
                                             ...
                                             let uu___20 =
                                               ...
                                               FStar_All.op_Bar_Greater
                                                 ...
                                                 (FStar_List.map
                                                    (fun b ->
                                                       b.FStar_Syntax_Syntax.binder_bv)) in
                                             FStar_All.op_Bar_Greater uu___20
                                               (FStar_List.map
                                                  FStar_Syntax_Syntax.bv_to_name) in
                                           FStar_All.op_Bar_Greater uu___19
                                             (fun l ->
                                                let uu___20 = l in
                                                match uu___20 with
                                                | f::g::p::[] -> (f, g, p)) in
                                                               ...
                                                               let args =
                                                                 FStar_List.fold_left2
                                                                   (fun args1
                                                                    ...
                                                                    FStar_Parser_Const.ite_soundness_forall_attr in
                                                                    if
                                                                    uu___22
                                                                    then
                                                                    let uu___23
                                             ...
                                             let uu___16 =
                                               let aux t =
                                                 ...
                                                 FStar_Syntax_Syntax.mk
                                                   uu___17 r in
                                               let uu___17 = aux subcomp_f in
                                               let uu___18 = aux subcomp_g in
                                               (uu___17, uu___18) in
                                             (match uu___16 with
                           ...
                           let uu___8 =
                             ...
                             | (us, tmp_t1) ->
                                 let uu___10 =
                                   let uu___11 =
                                     let uu___12 =
                                       FStar_All.op_Bar_Greater tmp_t1
                                ...
                                let check_and_gen' comb n env_opt uu___7 k =
                                  ...
                                  | (us1, t) ->
                                      let env1 =
                                        ...
                                        then
                                          FStar_All.op_Bar_Greater env_opt
                                            FStar_Util.must
                                        else env in
                                      let uu___8 =
  ...
  fun env0 ->
    fun sub ->
      ...
      (let lift_ts =
       ...
       let r =
         let uu___1 =
           FStar_All.op_Bar_Greater lift_ts FStar_Pervasives_Native.snd in
        ...
        (let ed_src =
         ...
         let ed_tgt =
           FStar_TypeChecker_Env.get_effect_decl env
             sub.FStar_Syntax_Syntax.target in
         let uu___1 =
           (FStar_All.op_Bar_Greater ed_src FStar_Syntax_Util.is_layered) ||
             (FStar_All.op_Bar_Greater ed_tgt FStar_Syntax_Util.is_layered) in
         if uu___1
         then
                     ...
                     (match uu___5 with
                      | (lift, lift_wp) ->
                          ...
                          ((let uu___7 =
                              let uu___8 =
                                let uu___9 =
                                  FStar_All.op_Bar_Greater lift_wp
                                    FStar_Pervasives_Native.fst in
                                FStar_All.op_Bar_Greater uu___9
                                  FStar_List.length in
                           ...
                           (let uu___8 =
                              (FStar_Util.is_some lift1) &&
                                (let uu___9 =
                                   let uu___10 =
                                     let uu___11 =
                                       FStar_All.op_Bar_Greater lift1
                                         FStar_Util.must in
                                     FStar_All.op_Bar_Greater uu___11
                                       FStar_Pervasives_Native.fst in
                                   FStar_All.op_Bar_Greater uu___10
                                    ...
                                    let uu___14 =
                                      let uu___15 =
                                        let uu___16 =
                                          FStar_All.op_Bar_Greater lift1
                                            FStar_Util.must in
                                        FStar_All.op_Bar_Greater uu___16
                                          FStar_Pervasives_Native.fst in
                                      FStar_All.op_Bar_Greater uu___15
                                        FStar_List.length in
                                    FStar_All.op_Bar_Greater uu___14
                                      FStar_Util.string_of_int in
                                  FStar_Util.format3
        ...
        fun p ->
          fun ts ->
            let eff_name =
              let uu___ =
                let uu___1 =
                  FStar_All.op_Bar_Greater m FStar_Ident.ident_of_lid in
                FStar_All.op_Bar_Greater uu___1 FStar_Ident.string_of_id in
              let uu___1 =
                let uu___2 =
                  FStar_All.op_Bar_Greater n FStar_Ident.ident_of_lid in
                FStar_All.op_Bar_Greater uu___2 FStar_Ident.string_of_id in
              let uu___2 =
                let uu___3 =
                  FStar_All.op_Bar_Greater p FStar_Ident.ident_of_lid in
                FStar_All.op_Bar_Greater uu___3 FStar_Ident.string_of_id in
          ...
          (let combinator_name =
             ...
             let uu___2 =
               let uu___3 =
                 let uu___4 =
                   FStar_All.op_Bar_Greater n FStar_Ident.ident_of_lid in
                 FStar_All.op_Bar_Greater uu___4 FStar_Ident.string_of_id in
                                ...
                                (match uu___7 with
                                 | { FStar_Syntax_Syntax.binder_bv = a';
                                     ...
                                     let uu___11 =
                                       ...
                                       FStar_Syntax_Subst.subst_binders
                                         uu___12 in
                                     FStar_All.op_Bar_Greater uu___10 uu___11)
                            | uu___6 ->
                                let uu___7 =
                                  let uu___8 =
                                    let uu___9 =
                                ...
                                | (ret_t, guard_ret_t) ->
                                    ...
                                    (match uu___7 with
                                     | (pure_wp_uvar1, guard_wp) ->
                                         ...
                                         let k =
                                           let uu___8 =
                                             FStar_List.op_At bs [f] in
                                           FStar_Syntax_Util.arrow uu___8 c in
                                         ((let uu___9 =
                                             FStar_All.op_Less_Bar
                                               (FStar_TypeChecker_Env.debug
                                                  env)
