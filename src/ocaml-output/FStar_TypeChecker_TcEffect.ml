                                  ...
                                  let uu___14 =
                                    let uu___15 =
                                          ...
                                          env1 act_typ1 in
                                      {
                                        ...
                                        FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                          =
                                          (uu___16.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                        FStar_TypeChecker_Env.universeof_well_typed_term
                                          =
                                          (uu___16.FStar_TypeChecker_Env.universeof_well_typed_term);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                                               ...
                                                               uu___23) ->
                                                                ...
                                                                let env2 =
                                                                  FStar_All.pipe_right
                                                                    ...
                                                                    FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                                                                    =
                                                                    (uu___24.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                                                                    FStar_TypeChecker_Env.universeof_well_typed_term
                                                                    =
                                                                    (uu___24.FStar_TypeChecker_Env.universeof_well_typed_term);
                                                                    FStar_TypeChecker_Env.use_bv_sorts
                                                                    =
                                          ...
                                          let uu___16 =
                                            let uu___17 =
                                              FStar_Syntax_Syntax.bv_to_name
                                                a.FStar_Syntax_Syntax.binder_bv in
                                            (a', uu___17) in
                                          FStar_Syntax_Syntax.NT uu___16 in
                                        [uu___15] in
                                      FStar_Syntax_Subst.subst_binders
                                        uu___14 in
                                    FStar_All.pipe_right uu___12 uu___13)
                           | uu___8 ->
                               let uu___9 =
                                 let uu___10 =
                                   lift_t_shape_error
                     ...
                     | (lift, lift_wp) ->
                         let env1 =
                           let uu___5 = env in
                           {
                             ...
                             FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback
                               =
                               (uu___5.FStar_TypeChecker_Env.tc_check_well_typed_tot_or_gtot_term_with_fallback);
                             FStar_TypeChecker_Env.universeof_well_typed_term
                               =
                           ...
                           | FStar_Syntax_Syntax.Tm_arrow (bs, uu___5) when
                               ...
                               (match uu___6 with
                                | { FStar_Syntax_Syntax.binder_bv = a';
                                    ...
                                    FStar_Syntax_Syntax.binder_attrs = uu___8;_}::bs1
                                    ->
                                    let uu___9 =
                                      let uu___10 =
                                        FStar_All.pipe_right bs1
                                    ...
                                    let uu___10 =
                                      ...
                                      FStar_Syntax_Subst.subst_binders
                                        uu___11 in
                                    FStar_All.pipe_right uu___9 uu___10)
                           | uu___5 ->
                               let uu___6 =
                                 let uu___7 =
                                   let uu___8 =
