         ...
         | () ->
             ...
             let uu___1 =
               ...
               | "workspace/didChangeWorkspaceFolders" ->
                   let uu___2 =
                     let uu___3 = FStar_Interactive_JsonHelper.arg "event" r
                        in
                     FStar_All.pipe_right uu___3
               ...
               | "workspace/symbol" ->
                   let uu___2 =
                     let uu___3 = FStar_Interactive_JsonHelper.arg "query" r
                        in
                     FStar_All.pipe_right uu___3
                       FStar_Interactive_JsonHelper.js_str
                      in
               ...
               | "textDocument/didChange" ->
                   let uu___2 =
                     let uu___3 = FStar_Interactive_JsonHelper.js_txdoc_id r
                        in
                     let uu___4 =
                       let uu___5 =
               ...
               | "textDocument/willSave" ->
                   let uu___2 = FStar_Interactive_JsonHelper.js_txdoc_id r
                      in
               ...
               | "textDocument/didSave" ->
                   let uu___2 =
                     let uu___3 = FStar_Interactive_JsonHelper.js_txdoc_id r
                        in
                     let uu___4 =
                       let uu___5 = FStar_Interactive_JsonHelper.arg "text" r
                          in
                       FStar_All.pipe_right uu___5
                         FStar_Interactive_JsonHelper.js_str
                        in
               ...
               | "textDocument/completion" ->
                   let uu___2 =
                     let uu___3 = FStar_Interactive_JsonHelper.js_txdoc_pos r
                        in
                     let uu___4 =
                       let uu___5 =
               ...
               | "textDocument/hover" ->
                   let uu___2 = FStar_Interactive_JsonHelper.js_txdoc_pos r
                      in
               ...
               | m ->
                   let uu___2 = FStar_Util.format1 "Unknown method '%s'" m
                      in
                   FStar_Interactive_JsonHelper.BadProtocolMsg uu___2
                in
             {
      ...
      | FStar_Interactive_JsonHelper.Completion (txpos,ctx) ->
          ...
          (match uu___ with
           | FStar_Pervasives_Native.Some st ->
               let uu___1 = FStar_Interactive_QueryHelper.complookup st txpos
                  in
  ...
  fun stream  ->
    fun len  ->
      ...
      | FStar_Pervasives_Native.Some s ->
          ...
          then
            let uu___1 =
              let uu___2 = FStar_Util.substring_from s (Prims.of_int (16))
                 in
