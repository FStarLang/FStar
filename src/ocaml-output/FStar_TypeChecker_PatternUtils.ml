      ...
      fun p  ->
        fun tc_annot  ->
          let check_bv env1 x =
            ...
            match uu____84 with
            | (t_x,guard) ->
                ((let uu___253_150 = x  in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___253_150.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___253_150.FStar_Syntax_Syntax.index);
                ...
                (match uu____238 with
                 | (k,uu____264) ->
                     ...
                     (match uu____265 with
                      | (t,uu____300,g) ->
                          let x1 =
                            let uu___254_315 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___254_315.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___254_315.FStar_Syntax_Syntax.index);
                          ...
                          (match uu____316 with
                           | (e,uu____351,g') ->
                               let p2 =
                                 let uu___255_368 = p1  in
                                 {
                                   FStar_Syntax_Syntax.v =
                                     (FStar_Syntax_Syntax.Pat_dot_term
                                        (x1, e));
                                   FStar_Syntax_Syntax.p =
                                     (uu___255_368.FStar_Syntax_Syntax.p)
                                 }  in
                               let uu____371 =
                ...
                (match uu____473 with
                 | (b,a,w,env2,args,guard,pats1) ->
                     ...
                     (uu____1040, uu____1051, uu____1062, env2, e, guard,
                       (let uu___256_1080 = p1  in
                        {
                          FStar_Syntax_Syntax.v =
                            (FStar_Syntax_Syntax.Pat_cons
                               (fv, (FStar_List.rev pats1)));
                          FStar_Syntax_Syntax.p =
                            (uu___256_1080.FStar_Syntax_Syntax.p)
                        })))
             in
                     ...
                     (match uu____1211 with
                      | (f,uu____1229) ->
                            ...
                            FStar_Syntax_Syntax.Pat_cons uu____1694  in
                          {
                            ...
                            FStar_Syntax_Syntax.p =
                              (uu___257_1690.FStar_Syntax_Syntax.p)
                          }))
            | uu____1724 -> p1  in
