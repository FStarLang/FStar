                ...
                | (f, uu____112) ->
                      ...
                      | (f1::formals', (p1, p_imp)::pats') ->
                          (match f1 with
                           ...
                           | (uu____617, imp) ->
                               ...
                               uu____623 :: uu____633) in
                    let uu___257_648 = p in
                    let uu____649 =
                      let uu____650 =
                      ...
                      FStar_Syntax_Syntax.Pat_cons uu____650 in
                    {
                      ...
                      FStar_Syntax_Syntax.p =
                        (uu___257_648.FStar_Syntax_Syntax.p)
                    }))
      | uu____680 -> p
let (pat_as_exp :
  Prims.bool ->
    ...
    fun env ->
      fun p ->
        let intro_bv env1 x =
          ...
          then
            ((let uu___258_740 = x in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___258_740.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___258_740.FStar_Syntax_Syntax.index);
            ...
            (let uu____742 = FStar_Syntax_Util.type_u () in
             ...
             | (t, uu____754) ->
                 ...
                 (match uu____755 with
                  | (t_x, uu____776, guard) ->
                      let x1 =
                        let uu___259_791 = x in
                        {
                          FStar_Syntax_Syntax.ppname =
                            (uu___259_791.FStar_Syntax_Syntax.ppname);
                          FStar_Syntax_Syntax.index =
                            (uu___259_791.FStar_Syntax_Syntax.index);
                          FStar_Syntax_Syntax.sort = t_x
                        } in
                      let uu____792 = FStar_TypeChecker_Env.push_bv env1 x1 in
                      (x1, guard, uu____792))) in
              ...
              (match uu____875 with
               | (k, uu____901) ->
                   ...
                   (match uu____902 with
                    | (t, uu____937, g) ->
                        let x1 =
                          let uu___260_952 = x in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___260_952.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___260_952.FStar_Syntax_Syntax.index);
                            FStar_Syntax_Syntax.sort = t
                          } in
                        let uu____953 =
                          let uu____966 = FStar_Syntax_Syntax.range_of_bv x1 in
                          FStar_TypeChecker_Env.new_implicit_var_aux
                        ...
                        (match uu____953 with
                         | (e, uu____988, g') ->
                             let p2 =
                               let uu___261_1005 = p1 in
                               {
                                 FStar_Syntax_Syntax.v =
                                   (FStar_Syntax_Syntax.Pat_dot_term (x1, e));
                                 FStar_Syntax_Syntax.p =
                                   (uu___261_1005.FStar_Syntax_Syntax.p)
                               } in
                             let uu____1008 =
                     ...
                     (fun uu____1247 ->
                        fun uu____1248 ->
                          ...
                          | ((b, a, w, env2, args, guard, pats1), (p2, imp))
                              ->
                              let uu____1446 = pat_as_arg_with_env env2 p2 in
               ...
               | (b, a, w, env2, args, guard, pats1) ->
                   let e =
                     let uu____1653 =
                       ...
                       FStar_Syntax_Syntax.mk_Tm_app uu____1658 uu____1659 in
                   ...
                   (uu____1664, uu____1675, uu____1686, env2, e, guard,
                     (let uu___262_1704 = p1 in
                      {
                        FStar_Syntax_Syntax.v =
                          (FStar_Syntax_Syntax.Pat_cons
                             (fv, (FStar_List.rev pats1)));
                        FStar_Syntax_Syntax.p =
                          (uu___262_1704.FStar_Syntax_Syntax.p)
                      }))) in
        let one_pat env1 p1 =
                   ...
                   let err =
                     let uu____1837 =
                       FStar_Util.format1
                         ...
                         m in
                     (FStar_Errors.Fatal_NonLinearPatternVars, uu____1837) in
                   FStar_Errors.raise_error err p3.FStar_Syntax_Syntax.p
               | uu____1856 -> (b, a, w, arg, guard, p3)) in
