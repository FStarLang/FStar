                ...
                | (f,uu____112) ->
                      ...
                      FStar_Syntax_Syntax.Pat_cons uu____650  in
                    {
                      ...
                      FStar_Syntax_Syntax.p =
                        (uu___266_648.FStar_Syntax_Syntax.p)
                    }))
      | uu____680 -> p
    ...
    fun env  ->
      fun p  ->
        let intro_bv env1 x =
          ...
          then
            ((let uu___267_740 = x  in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___267_740.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___267_740.FStar_Syntax_Syntax.index);
            ...
            (let uu____742 = FStar_Syntax_Util.type_u ()  in
             ...
             | (t,uu____754) ->
                 ...
                 (match uu____755 with
                  | (t_x,uu____776,guard) ->
                      let x1 =
                        let uu___268_791 = x  in
                        {
                          FStar_Syntax_Syntax.ppname =
                            (uu___268_791.FStar_Syntax_Syntax.ppname);
                          FStar_Syntax_Syntax.index =
                            (uu___268_791.FStar_Syntax_Syntax.index);
              ...
              (match uu____875 with
               | (k,uu____901) ->
                   ...
                   (match uu____902 with
                    | (t,uu____937,g) ->
                        let x1 =
                          let uu___269_952 = x  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___269_952.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___269_952.FStar_Syntax_Syntax.index);
                        ...
                        (match uu____953 with
                         | (e,uu____988,g') ->
                             let p2 =
                               let uu___270_1005 = p1  in
                               {
                                 FStar_Syntax_Syntax.v =
                                   (FStar_Syntax_Syntax.Pat_dot_term (x1, e));
                                 FStar_Syntax_Syntax.p =
                                   (uu___270_1005.FStar_Syntax_Syntax.p)
                               }  in
                             let uu____1008 =
              ...
              (match uu____1113 with
               | (b,a,w,env2,args,guard,pats1) ->
                   ...
                   (uu____1664, uu____1675, uu____1686, env2, e, guard,
                     (let uu___271_1704 = p1  in
                      {
                        FStar_Syntax_Syntax.v =
                          (FStar_Syntax_Syntax.Pat_cons
                             (fv, (FStar_List.rev pats1)));
                        FStar_Syntax_Syntax.p =
                          (uu___271_1704.FStar_Syntax_Syntax.p)
                      })))
           in
        let one_pat env1 p1 =
