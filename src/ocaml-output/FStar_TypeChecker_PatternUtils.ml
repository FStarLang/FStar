                ...
                | (f,uu____126) ->
                      ...
                      FStar_Syntax_Syntax.Pat_cons uu____731  in
                    {
                      ...
                      FStar_Syntax_Syntax.p =
                        (uu___47_729.FStar_Syntax_Syntax.p)
                    }))
      | uu____764 -> p
    ...
    fun env  ->
      fun p  ->
        let intro_bv env1 x =
          ...
          then
            ((let uu___48_828 = x  in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___48_828.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___48_828.FStar_Syntax_Syntax.index);
            ...
            (let uu____831 = FStar_Syntax_Util.type_u ()  in
             ...
             | (t,uu____843) ->
                 ...
                 (match uu____844 with
                  | (t_x,uu____870,guard) ->
                      let x1 =
                        let uu___49_885 = x  in
                        {
                          FStar_Syntax_Syntax.ppname =
                            (uu___49_885.FStar_Syntax_Syntax.ppname);
                          FStar_Syntax_Syntax.index =
                            (uu___49_885.FStar_Syntax_Syntax.index);
              ...
              (match uu____971 with
               | (k,uu____997) ->
                   ...
                   (match uu____998 with
                    | (t,uu____1038,g) ->
                        let x1 =
                          let uu___50_1053 = x  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___50_1053.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___50_1053.FStar_Syntax_Syntax.index);
                        ...
                        (match uu____1054 with
                         | (e,uu____1094,g') ->
                             let p2 =
                               let uu___51_1111 = p1  in
                               {
                                 FStar_Syntax_Syntax.v =
                                   (FStar_Syntax_Syntax.Pat_dot_term (x1, e));
                                 FStar_Syntax_Syntax.p =
                                   (uu___51_1111.FStar_Syntax_Syntax.p)
                               }  in
                             let uu____1114 =
              ...
              (match uu____1221 with
               | (b,a,w,env2,args,guard,pats1) ->
                   ...
                   (uu____1798, uu____1809, uu____1820, env2, e, guard,
                     (let uu___52_1838 = p1  in
                      {
                        FStar_Syntax_Syntax.v =
                          (FStar_Syntax_Syntax.Pat_cons
                             (fv, (FStar_List.rev pats1)));
                        FStar_Syntax_Syntax.p =
                          (uu___52_1838.FStar_Syntax_Syntax.p)
                      })))
           in
        let one_pat env1 p1 =
