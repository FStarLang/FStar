          ...
          let pats1 =
            FStar_List.map
              (fun uu___  ->
                 match uu___ with
                 | (p1,imp) ->
                     let uu___1 = elaborate_pat env p1  in (uu___1, imp))
              pats
             in
          let uu___ =
           ...
           | (uu___1,t) ->
               ...
               (match uu___2 with
                | (f,uu___3) ->
                                       ...
                                       | FStar_Pervasives_Native.Some
                                           ...
                                           let a =
                                             ...
                                             FStar_Syntax_Syntax.new_bv
                                               uu___7 FStar_Syntax_Syntax.tun
                                              in
                                           let r =
                                             FStar_Ident.range_of_lid
                                               (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                    ...
                    let uu___4 = p  in
                    let uu___5 =
                      let uu___6 = let uu___7 = aux f pats1  in (fv, uu___7)
                         in
              ...
              (match uu___ with
               | (b,a,w,env2,args,guard,pats1) ->
                   let e =
                     ...
                     let uu___2 = FStar_All.pipe_right args FStar_List.rev
                        in
