    ...
    fun lid ->
      let k_global_def lid1 uu___20_5721 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = attrs;_},
           uu____5744) -> FStar_Pervasives_Native.Some (quals, attrs)
        | uu____5763 -> FStar_Pervasives_Native.None in
      let uu____5777 =
        resolve_in_open_namespaces' env lid
          (fun uu____5797 -> FStar_Pervasives_Native.None)
          (fun uu____5807 -> FStar_Pervasives_Native.None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____5884 ->
             ...
             | (mlid, modul) ->
                 ...
                 uu____5892 = path) env.modules in
    ...
    fun lid ->
      let k_global_def lid1 uu___21_5935 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5949;_},
           uu____5950) ->
    ...
    fun lid ->
      let k_global_def lid1 uu___22_6011 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____6026;_},
           uu____6027) ->
...
let (try_lookup_lid' :
  ...
  fun any_val ->
    fun exclude_interface ->
      fun env ->
        fun lid ->
          let uu____6135 = try_lookup_name any_val exclude_interface env lid in
  ...
  fun env ->
    fun lid ->
      ...
      | uu____6344 ->
          ...
          let uu____6348 = resolve_to_fully_qualified_name env lid_without_ns in
    ...
    fun lid ->
      let k_global_def lid1 se =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____6476;_},
           uu____6477) ->
            let uu____6484 =
              FStar_All.pipe_right quals
                (FStar_Util.for_some
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____6505;_},
           uu____6506) ->
      ...
      let k_global_def lid1 uu___24_6577 =
        ...
        | ({
             FStar_Syntax_Syntax.sigel =
               ...
               (uu____6587, uu____6588, uu____6589, uu____6590, datas,
                uu____6592);
             FStar_Syntax_Syntax.sigrng = uu____6593;
             FStar_Syntax_Syntax.sigquals = uu____6594;
             FStar_Syntax_Syntax.sigmeta = uu____6595;
             FStar_Syntax_Syntax.sigattrs = uu____6596;_},
           uu____6597) -> FStar_Pervasives_Native.Some datas
                ...
                (FStar_Util.find_opt
                   (fun uu___26_8054 ->
                      ...
                      | {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_datacon
                            (lid, uu____8057, uu____8058, uu____8059,
              ...
              (FStar_List.iter
                 (fun uu___27_8112 ->
                    ...
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename, univs1, parms, uu____8116, uu____8117,
                           dc::[]);
                        ...
                        (match uu____8133 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
                               (constrname, uu____8140, t, uu____8142,
                                                             ...
                                                             let uu____8462 =
                                                               let uu____8463
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id1 in
                                                               uu____8463.FStar_Ident.ident in
                                                             uu____8462.FStar_Ident.idText in
                                                           let uu____8465 =
                                                             let uu____8466 =
                                                               FStar_ST.op_Bang
                                                                 my_exported_ids in
...
let (try_lookup_record_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8603 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____8641 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____8645 -> Cont_ok ()) in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8675 = try_lookup_record_or_dc_by_field_name env fieldname in
      ...
      fun s ->
        ...
        let uu____9073 =
          ...
          | FStar_Syntax_Syntax.Sig_bundle (ses, uu____9099) ->
              ...
              (env2, uu____9108)
          | uu____9135 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                ...
                (FStar_Util.for_some
                   (fun uu____9452 ->
                      ...
                      | (m, uu____9459) ->
                          ...
                          FStar_Util.starts_with uu____9460 uu____9465)) in
            if uu____9434
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____9523 = FStar_Util.smap_try_find env1.includes curmod in
             ...
             | () ->
                 ...
                 (match uu____9599 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____9619 =
                          let uu____9716 = get_exported_id_set env1 curmod in
                          let uu____9763 =
                           ...
                           FStar_Pervasives_Native.Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____10280 =
                                 ...
                                 FStar_Util.set_difference uu____10284 ns_ex in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____10376 =
                                     ...
                                     FStar_Util.set_union uu____10380 ns_ex in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  ...
                  let uu____10619 =
                    let uu____10625 =
                      ...
                      let uu____10631 = FStar_Parser_AST.string_of_fsdoc doc1 in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____10627 uu____10629 uu____10631 in
                      ...
                      (match uu____10682 with
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____10701;_},
                            uu____10702)
                           -> lids
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____10724;_},
                            uu____10725)
                           -> lids
                       | uu____10753 ->
                           ((let uu____10762 =
                               let uu____10764 = FStar_Options.interactive () in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se ->
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1 ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid, uu____10857, uu____10858, uu____10859,
                                 uu____10860, uu____10861)
                                ->
                                FStar_Util.smap_remove (sigmap env)
                                  lid.FStar_Ident.str
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid, univ_names, binders, typ, uu____10877,
                                 uu____10878)
                                ->
                                (FStar_Util.smap_remove (sigmap env)
                                   lid.FStar_Ident.str;
                             ...
                             let uu____10985 =
                               let uu____10987 =
                                 let uu____10988 =
                                   ...
                                   uu____10991.FStar_Syntax_Syntax.fv_name in
              ...
              | uu____11026 -> ()));
      (let curmod =
         let uu____11029 = current_module env in uu____11029.FStar_Ident.str in
       (let uu____11031 =
  ...
  fun env ->
    FStar_Util.atomically
      (fun uu____11878 ->
         push_record_cache ();
         (let uu____11881 =
            let uu____11884 = FStar_ST.op_Bang stack in env :: uu____11884 in
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e ->
    ...
    let fields =
      let uu____12335 =
        let uu____12339 = e Exported_id_field in FStar_ST.op_Bang uu____12339 in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____12874 ->
                      ...
                      | (l, uu____12881) -> FStar_Ident.lid_equals l mname)) in
