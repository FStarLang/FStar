...
let (uu___is_Exported_id_term_type : exported_id_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Exported_id_term_type -> true | uu____427 -> false
        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____2430 ->
                ...
                | (m, uu____2439) -> FStar_Ident.lid_equals l m)) in
    ...
    fun id1 ->
      fun record ->
        fun cont ->
          ...
          let uu____3096 = FStar_Ident.lid_equals typename' record.typename in
          if uu____3096
          then
            let fname =
              FStar_Ident.lid_of_ids
    ...
    fun id1 ->
      ...
      | uu____3838 ->
          try_lookup_id'' env id1 Exported_id_term_type
            (fun r ->
               let uu____3844 = found_local_binding id1.FStar_Ident.idRange r in
               Cont_ok uu____3844) (fun uu____3846 -> Cont_fail)
            (fun uu____3848 -> Cont_ignore)
            (fun i ->
               find_in_module env i
                 (fun uu____3855 -> fun uu____3856 -> Cont_fail) Cont_ignore)
    ...
    fun id1 ->
      fun k_global_def ->
        fun k_not_found ->
          ...
          | FStar_Pervasives_Native.None ->
              let lid =
                let uu____3993 = current_module env in qual uu____3993 id1 in
        ...
        let qopt =
          FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals
            (fun uu___12_4886 ->
               ...
               | uu____4901 -> FStar_Pervasives_Native.None) in
        (match qopt with
         | FStar_Pervasives_Native.None ->
             FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
         | x -> x)
    | FStar_Syntax_Syntax.Sig_declare_typ
        (uu____4907, uu____4908, uu____4909) -> FStar_Pervasives_Native.None
            ...
            | (se, uu____5095) ->
                (match se.FStar_Syntax_Syntax.sigel with
                 ...
                 | FStar_Syntax_Syntax.Sig_declare_typ
                     ...
                     then
                       let lid2 =
                         let uu____5204 = FStar_Ident.range_of_lid source_lid in
                            ...
                            let uu____5227 =
                              let uu____5228 =
                                let uu____5235 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____5236 in
                                (uu____5235,
                       ...
                       let uu____5245 =
                         let uu____5250 =
                           ...
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu____5251 in
                         (se, uu____5250) in
            ...
            | (id1, l, dd, used_marker) ->
                (FStar_ST.op_Colon_Equals used_marker true;
                 (let uu____5521 =
                  ...
                  FStar_Pervasives_Native.Some uu____5521)) in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____5685;_},
           l1)
          ->
          FStar_Pervasives_Native.Some
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____5714;_},
           l1)
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____5847;_},
           uu____5848)
          ->
            ...
            | FStar_Pervasives_Native.Some (s, uu____5892) ->
                (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 | FStar_Syntax_Syntax.Sig_effect_abbrev
                     ...
                     aux l''
                 | uu____5915 -> FStar_Pervasives_Native.None) in
          aux l'
    ...
    fun lid ->
      let k_global_def lid1 uu___20_5973 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____5996;_},
           uu____5997) -> FStar_Pervasives_Native.Some (quals, attrs)
        | uu____6018 -> FStar_Pervasives_Native.None in
      let uu____6032 =
        resolve_in_open_namespaces' env lid
          (fun uu____6052 -> FStar_Pervasives_Native.None)
          (fun uu____6062 -> FStar_Pervasives_Native.None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____6139 ->
             ...
             | (mlid, modul) ->
                 ...
                 uu____6147 = path) env.modules in
    ...
    fun lid ->
      let k_global_def lid1 uu___21_6190 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____6205;_},
           uu____6206) ->
...
let (try_lookup_lid' :
  ...
  fun any_val ->
    fun exclude_interface ->
      fun env ->
        fun lid ->
          let uu____6396 = try_lookup_name any_val exclude_interface env lid in
  ...
  fun env ->
    fun lid ->
      ...
      | uu____6605 ->
          ...
          let uu____6609 = resolve_to_fully_qualified_name env lid_without_ns in
    ...
    fun lid ->
      let k_global_def lid1 se =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____6738;_},
           uu____6739) ->
            let uu____6748 =
              FStar_All.pipe_right quals
                (FStar_Util.for_some
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu____6770;_},
           uu____6771) ->
      ...
      let k_global_def lid1 uu___24_6844 =
        ...
        | ({
             FStar_Syntax_Syntax.sigel =
               ...
               (uu____6854, uu____6855, uu____6856, uu____6857, datas,
                uu____6859);
           ...
           uu____6865) -> FStar_Pervasives_Native.Some datas
                ...
                (FStar_Util.find_opt
                   (fun uu___26_8325 ->
                      ...
                      | {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_datacon
                            (lid, uu____8328, uu____8329, uu____8330,
              ...
              (FStar_List.iter
                 (fun uu___27_8388 ->
                    ...
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename, univs1, parms, uu____8392, uu____8393,
                           dc::[]);
                        ...
                        (match uu____8412 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
                               (constrname, uu____8419, t, uu____8421,
                                                             ...
                                                             let uu____8744 =
                                                               let uu____8745
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id1 in
                                                               uu____8745.FStar_Ident.ident in
                                                             uu____8744.FStar_Ident.idText in
                                                           let uu____8747 =
                                                             let uu____8748 =
                                                               FStar_ST.op_Bang
                                                                 my_exported_ids in
...
let (try_lookup_record_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8885 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____8923 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____8927 -> Cont_ok ()) in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8957 = try_lookup_record_or_dc_by_field_name env fieldname in
      ...
      fun s ->
        ...
        let uu____9429 =
          ...
          | FStar_Syntax_Syntax.Sig_bundle (ses, uu____9455) ->
              ...
              (env2, uu____9464)
          | uu____9491 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                     ...
                     | (lids, se) ->
                         FStar_All.pipe_right lids
                           (FStar_List.iter
                              (fun lid ->
                                 (let uu____9572 =
                                    let uu____9575 = FStar_ST.op_Bang globals in
                ...
                (FStar_Util.for_some
                   (fun uu____9808 ->
                      ...
                      | (m, uu____9815) ->
                          ...
                          FStar_Util.starts_with uu____9816 uu____9821)) in
            if uu____9790
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____9879 = FStar_Util.smap_try_find env1.includes curmod in
             ...
             | () ->
                 ...
                 (match uu____9955 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____9975 =
                          let uu____10072 = get_exported_id_set env1 curmod in
                          let uu____10119 =
                           ...
                           FStar_Pervasives_Native.Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____10636 =
                                 ...
                                 FStar_Util.set_difference uu____10640 ns_ex in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____10732 =
                                     ...
                                     FStar_Util.set_union uu____10736 ns_ex in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  ...
                  let uu____10975 =
                    let uu____10981 =
                      ...
                      let uu____10987 = FStar_Parser_AST.string_of_fsdoc doc1 in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____10983 uu____10985 uu____10987 in
                      ...
                      (match uu____11039 with
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigopts = uu____11059;_},
                            uu____11060)
                           -> lids
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigopts = uu____11085;_},
                            uu____11086)
                           -> lids
                       | uu____11116 ->
                           ((let uu____11125 =
                               let uu____11127 = FStar_Options.interactive () in
                               Prims.op_Negation uu____11127 in
                             if uu____11125
                             then
                               let uu____11130 = FStar_Ident.range_of_lid l in
                               let uu____11131 =
                                 let uu____11137 =
                                   let uu____11139 =
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se ->
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1 ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid, uu____11220, uu____11221, uu____11222,
                                 uu____11223, uu____11224)
                                ->
                                FStar_Util.smap_remove (sigmap env)
                                  lid.FStar_Ident.str
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid, univ_names, binders, typ, uu____11240,
                                 uu____11241)
                                ->
                                (FStar_Util.smap_remove (sigmap env)
                                   lid.FStar_Ident.str;
                             ...
                             let uu____11348 =
                               let uu____11350 =
                                 let uu____11351 =
                                   ...
                                   uu____11354.FStar_Syntax_Syntax.fv_name in
              ...
              | uu____11389 -> ()));
      (let curmod =
         let uu____11392 = current_module env in uu____11392.FStar_Ident.str in
       (let uu____11394 =
  ...
  fun env ->
    FStar_Util.atomically
      (fun uu____12241 ->
         push_record_cache ();
         (let uu____12244 =
            let uu____12247 = FStar_ST.op_Bang stack in env :: uu____12247 in
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e ->
    ...
    let fields =
      let uu____12698 =
        let uu____12702 = e Exported_id_field in FStar_ST.op_Bang uu____12702 in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____13237 ->
                      ...
                      | (l, uu____13244) -> FStar_Ident.lid_equals l mname)) in
