        ...
        fun lid ->
            ...
            | (se, uu____4702) ->
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     let uu____4750 =
                       let uu____4751 =
                         let uu____4760 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.delta_constant uu____4761 in
                         (uu____4760, false,
                           (se.FStar_Syntax_Syntax.sigattrs)) in
                       Term_name uu____4751 in
                     FStar_Pervasives_Native.Some uu____4750
                 | FStar_Syntax_Syntax.Sig_let
                     ((uu____4766, lbs), uu____4768) ->
                 ...
                 | FStar_Syntax_Syntax.Sig_declare_typ
                     ...
                     then
                       let lid2 =
                         let uu____4806 = FStar_Ident.range_of_lid source_lid in
                                   ...
                                   FStar_All.pipe_right quals
                                     (FStar_Util.for_some
                                        (fun uu___182_4839 ->
                                           ...
                                           | uu____4840 -> false)) in
                                 Prims.op_Negation uu____4835)) in
                         if uu____4823
                       ...
                       let uu____4842 =
                         FStar_Util.find_map quals
                           (fun uu___183_4847 ->
                              ...
                              | uu____4851 -> FStar_Pervasives_Native.None) in
                       ...
                       let uu____4882 =
                         let uu____4887 =
                           ...
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu____4888 in
                         (se, uu____4887) in
                       ...
                       let uu____4891 =
                         let uu____4896 =
                           let uu____4897 =
                             FStar_Ident.range_of_lid source_lid in
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu____4897 in
                         (se, uu____4896) in
          ...
          let k_rec_binding uu____4976 =
            ...
            | (id1, l, dd) ->
                ...
                FStar_Pervasives_Native.Some uu____4988 in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5160;_},
           l1)
          ->
          FStar_Pervasives_Native.Some
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5182;_},
           l1)
          ->
          FStar_Pervasives_Native.Some
            (l1, (ne.FStar_Syntax_Syntax.cattributes))
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5208;_},
           l1)
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5268;_},
           uu____5269)
    ...
    fun lid ->
      let k_global_def lid1 uu___185_5449 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5464;_},
           uu____5465) -> FStar_Pervasives_Native.Some quals
        | uu____5472 -> FStar_Pervasives_Native.None in
      let uu____5479 =
        resolve_in_open_namespaces' env lid
          (fun uu____5487 -> FStar_Pervasives_Native.None)
          (fun uu____5491 -> FStar_Pervasives_Native.None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____5533 ->
             ...
             | (mlid, modul) ->
                 ...
                 uu____5540 = path) env.modules in
    ...
    fun lid ->
      let k_global_def lid1 uu___187_5649 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5663;_},
           uu____5664) ->
...
let (try_lookup_lid' :
  ...
  fun any_val ->
    fun exclude_interface ->
      fun env ->
        fun lid ->
          let uu____5765 = try_lookup_name any_val exclude_interface env lid in
  ...
  fun env ->
    fun lid ->
      ...
      | uu____6031 ->
          ...
          let uu____6035 = resolve_to_fully_qualified_name env lid_without_ns in
    ...
    fun lid ->
      let k_global_def lid1 se =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____6176;_},
           uu____6177) ->
            let uu____6182 =
              FStar_All.pipe_right quals
                (FStar_Util.for_some
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____6196;_},
           uu____6197) ->
      ...
      let k_global_def lid1 uu___189_6261 =
        ...
        | ({
             FStar_Syntax_Syntax.sigel =
               ...
               (uu____6270, uu____6271, uu____6272, uu____6273, datas,
                uu____6275);
             FStar_Syntax_Syntax.sigrng = uu____6276;
             FStar_Syntax_Syntax.sigquals = uu____6277;
             FStar_Syntax_Syntax.sigmeta = uu____6278;
             FStar_Syntax_Syntax.sigattrs = uu____6279;_},
           uu____6280) -> FStar_Pervasives_Native.Some datas
                ...
                (FStar_Util.find_opt
                   (fun uu___191_7958 ->
                      ...
                      | {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_datacon
                            (lid, uu____7960, uu____7961, uu____7962,
                             uu____7963, uu____7964);
              ...
              (FStar_List.iter
                 (fun uu___192_8012 ->
                    ...
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename, univs1, parms, uu____8016, uu____8017,
                           dc::[]);
                        ...
                        (match uu____8033 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
                               (constrname, uu____8040, t, uu____8042,
                                                             ...
                                                             let uu____8454 =
                                                               let uu____8455
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id1 in
                                                               uu____8455.FStar_Ident.ident in
                                                             uu____8454.FStar_Ident.idText in
                                                           let uu____8457 =
                                                             let uu____8458 =
                                                               FStar_ST.op_Bang
                                                                 my_exported_ids in
...
let (try_lookup_record_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8635 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____8667 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____8671 -> Cont_ok ()) in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____8695 = try_lookup_record_or_dc_by_field_name env fieldname in
      ...
      fun s ->
        ...
        let uu____9140 =
          ...
          | FStar_Syntax_Syntax.Sig_bundle (ses, uu____9166) ->
              ...
              (env2, uu____9175)
          | uu____9202 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                     ...
                     | (lids, se) ->
                         FStar_All.pipe_right lids
                           (FStar_List.iter
                              (fun lid ->
                                 (let uu____9283 =
                                    let uu____9286 = FStar_ST.op_Bang globals in
                ...
                (FStar_Util.for_some
                   (fun uu____9626 ->
                      ...
                      | (m, uu____9632) ->
                          ...
                          FStar_Util.starts_with uu____9633 uu____9635)) in
            if uu____9610
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____9680 = FStar_Util.smap_try_find env1.includes curmod in
             ...
             | () ->
                 ...
                 (match uu____9800 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____9820 =
                          let uu____9915 = get_exported_id_set env1 curmod in
                          let uu____9961 =
                           ...
                           FStar_Pervasives_Native.Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____10542 =
                                 ...
                                 FStar_Util.set_difference uu____10545 ns_ex in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____10737 =
                                     ...
                                     FStar_Util.set_union uu____10740 ns_ex in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  ...
                  let uu____11039 =
                    let uu____11044 =
                      ...
                      let uu____11047 = FStar_Parser_AST.string_of_fsdoc doc1 in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____11045 uu____11046 uu____11047 in
                      ...
                      (match uu____11092 with
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____11109;_},
                            uu____11110)
                           -> lids
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____11129;_},
                            uu____11130)
                           -> lids
                       | uu____11155 ->
                           ((let uu____11163 =
                               let uu____11164 = FStar_Options.interactive () in
                               Prims.op_Negation uu____11164 in
                             if uu____11163
                             then
                               let uu____11165 = FStar_Ident.range_of_lid l in
                               let uu____11166 =
                                 let uu____11171 =
                                   let uu____11172 =
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se ->
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1 ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid, uu____11244, uu____11245, uu____11246,
                                 uu____11247, uu____11248)
                                ->
                                FStar_Util.smap_remove (sigmap env)
                                  lid.FStar_Ident.str
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid, univ_names, binders, typ, uu____11261,
                                 uu____11262)
                                ->
                                (FStar_Util.smap_remove (sigmap env)
                                   lid.FStar_Ident.str;
              ...
              | uu____11392 -> ()));
      (let curmod =
         let uu____11394 = current_module env in uu____11394.FStar_Ident.str in
       (let uu____11396 =
  ...
  fun env ->
    FStar_Util.atomically
      (fun uu____12397 ->
         push_record_cache ();
         (let uu____12400 =
            let uu____12403 = FStar_ST.op_Bang stack in env :: uu____12403 in
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e ->
    ...
    let fields =
      let uu____12889 =
        let uu____12892 = e Exported_id_field in FStar_ST.op_Bang uu____12892 in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____13591 ->
                      ...
                      | (l, uu____13597) -> FStar_Ident.lid_equals l mname)) in
