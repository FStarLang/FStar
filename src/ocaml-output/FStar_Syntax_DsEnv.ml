...
let new_sigmap : 'uuuuuu2517 . unit -> 'uuuuuu2517 FStar_Util.smap =
...
let find_in_record :
  'uuuuuu2928 .
    FStar_Ident.ident Prims.list ->
      FStar_Ident.ident ->
        record_or_dc ->
          (record_or_dc -> 'uuuuuu2928 cont_t) -> 'uuuuuu2928 cont_t
  =
  fun ns  ->
    fun id1  ->
      fun record  ->
...
let found_local_binding :
  'uuuuuu3578 'uuuuuu3579 .
    FStar_Range.range ->
      ('uuuuuu3578 * FStar_Syntax_Syntax.bv * 'uuuuuu3579) ->
...
let find_in_module :
  'uuuuuu3616 .
    env ->
      FStar_Ident.lident ->
        (FStar_Ident.lident ->
           (FStar_Syntax_Syntax.sigelt * Prims.bool) -> 'uuuuuu3616)
          -> 'uuuuuu3616 -> 'uuuuuu3616
  =
  fun env  ->
    fun lid  ->
      fun k_global_def  ->
...
let as_includes :
  'uuuuuu12693 .
    'uuuuuu12693 Prims.list FStar_Pervasives_Native.option ->
      'uuuuuu12693 Prims.list FStar_ST.ref
  =
  fun uu___31_12706  ->
