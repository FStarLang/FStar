  ...
  fun env1 ->
    fun lid ->
      ...
      | FStar_Pervasives_Native.Some exported_id_set1 ->
          ...
          FStar_All.op_Bar_Greater uu___1 FStar_Util.set_elements
let (open_modules :
  env -> (FStar_Ident.lident * FStar_Syntax_Syntax.modul) Prims.list) =
  fun e -> e.modules
...
let (iface_decls :
  ...
  fun env1 ->
    fun l ->
      let uu___ =
        FStar_All.op_Bar_Greater env1.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu___1 ->
              ...
              let rec aux uu___ =
                ...
                | modul::q ->
                    ...
                    (match look_into with
                     | Cont_ignore ->
                         let uu___1 = FStar_List.op_At mincludes q in
                         aux uu___1
                     | uu___1 -> look_into) in
              aux [ns]
let try_lookup_id'' :
...
let (try_lookup_lid :
  ...
  fun env1 ->
    fun l ->
      ...
      FStar_All.op_Bar_Greater uu___ drop_attributes
                 ...
                 (fun uu___1 ->
                    ...
                    | {
                        ...
                        let uu___8 =
                          ...
                          FStar_All.op_Less_Bar FStar_Util.must uu___9 in
                        (match uu___8 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  ...
                  FStar_List.op_At uu___5 [r.constrname] in
            ...
            | FStar_Pervasives_Native.Some (se, uu___) ->
                ...
                (match uu___1 with
                 | FStar_Pervasives_Native.Some l1 ->
                     ...
                     FStar_All.op_Less_Bar FStar_Range.string_of_range uu___2
    ...
    fun ns ->
      let uu___ =
        ...
        | FStar_Pervasives_Native.None ->
            ...
            let uu___2 =
              FStar_All.op_Bar_Greater modules
                (FStar_Util.for_some
                   (fun uu___3 ->
                      match uu___3 with
                      | (m, uu___4) ->
  ...
  fun env1 ->
    fun m ->
      let admitted_sig_lids =
        FStar_All.op_Bar_Greater env1.sigaccum
      ...
      let uu___ = m in
      let uu___1 =
        FStar_All.op_Bar_Greater m.FStar_Syntax_Syntax.declarations
          (FStar_List.map
             (fun s ->
                match s.FStar_Syntax_Syntax.sigel with
...
let (finish : env -> FStar_Syntax_Syntax.modul -> env) =
  fun env1 ->
    fun modul ->
      FStar_All.op_Bar_Greater modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se ->
              let quals = se.FStar_Syntax_Syntax.sigquals in
              match se.FStar_Syntax_Syntax.sigel with
        ...
        fun mname ->
          fun mii ->
            let prep env2 =
              ...
              let auto_open2 =
                FStar_List.op_At namespace_of_module
