...
let (set_iface : env -> Prims.bool -> env) =
  fun env  ->
    fun b  ->
      let uu___143_1845 = env  in
      {
        curmodule = (uu___143_1845.curmodule);
        curmonad = (uu___143_1845.curmonad);
        modules = (uu___143_1845.modules);
        scope_mods = (uu___143_1845.scope_mods);
        exported_ids = (uu___143_1845.exported_ids);
        trans_exported_ids = (uu___143_1845.trans_exported_ids);
        includes = (uu___143_1845.includes);
        sigaccum = (uu___143_1845.sigaccum);
        sigmap = (uu___143_1845.sigmap);
        iface = b;
        admitted_iface = (uu___143_1845.admitted_iface);
        expect_typ = (uu___143_1845.expect_typ);
        docs = (uu___143_1845.docs);
        remaining_iface_decls = (uu___143_1845.remaining_iface_decls);
        syntax_only = (uu___143_1845.syntax_only);
        ds_hooks = (uu___143_1845.ds_hooks)
      }
...
let (set_admitted_iface : env -> Prims.bool -> env) =
  fun e  ->
    fun b  ->
      let uu___144_1861 = e  in
      {
        curmodule = (uu___144_1861.curmodule);
        curmonad = (uu___144_1861.curmonad);
        modules = (uu___144_1861.modules);
        scope_mods = (uu___144_1861.scope_mods);
        exported_ids = (uu___144_1861.exported_ids);
        trans_exported_ids = (uu___144_1861.trans_exported_ids);
        includes = (uu___144_1861.includes);
        sigaccum = (uu___144_1861.sigaccum);
        sigmap = (uu___144_1861.sigmap);
        iface = (uu___144_1861.iface);
        admitted_iface = b;
        expect_typ = (uu___144_1861.expect_typ);
        docs = (uu___144_1861.docs);
        remaining_iface_decls = (uu___144_1861.remaining_iface_decls);
        syntax_only = (uu___144_1861.syntax_only);
        ds_hooks = (uu___144_1861.ds_hooks)
      }
...
let (set_expect_typ : env -> Prims.bool -> env) =
  fun e  ->
    fun b  ->
      let uu___145_1877 = e  in
      {
        curmodule = (uu___145_1877.curmodule);
        curmonad = (uu___145_1877.curmonad);
        modules = (uu___145_1877.modules);
        scope_mods = (uu___145_1877.scope_mods);
        exported_ids = (uu___145_1877.exported_ids);
        trans_exported_ids = (uu___145_1877.trans_exported_ids);
        includes = (uu___145_1877.includes);
        sigaccum = (uu___145_1877.sigaccum);
        sigmap = (uu___145_1877.sigmap);
        iface = (uu___145_1877.iface);
        admitted_iface = (uu___145_1877.admitted_iface);
        expect_typ = b;
        docs = (uu___145_1877.docs);
        remaining_iface_decls = (uu___145_1877.remaining_iface_decls);
        syntax_only = (uu___145_1877.syntax_only);
        ds_hooks = (uu___145_1877.ds_hooks)
      }
...
let (set_current_module : env -> FStar_Ident.lident -> env) =
  fun e  ->
    fun l  ->
      let uu___146_2072 = e  in
      {
        curmodule = (FStar_Pervasives_Native.Some l);
        curmonad = (uu___146_2072.curmonad);
        modules = (uu___146_2072.modules);
        scope_mods = (uu___146_2072.scope_mods);
        exported_ids = (uu___146_2072.exported_ids);
        trans_exported_ids = (uu___146_2072.trans_exported_ids);
        includes = (uu___146_2072.includes);
        sigaccum = (uu___146_2072.sigaccum);
        sigmap = (uu___146_2072.sigmap);
        iface = (uu___146_2072.iface);
        admitted_iface = (uu___146_2072.admitted_iface);
        expect_typ = (uu___146_2072.expect_typ);
        docs = (uu___146_2072.docs);
        remaining_iface_decls = (uu___146_2072.remaining_iface_decls);
        syntax_only = (uu___146_2072.syntax_only);
        ds_hooks = (uu___146_2072.ds_hooks)
      }
  ...
  fun env  ->
    fun l  ->
      fun ds  ->
        ...
        | (uu____2228,rest) ->
            let uu___147_2262 = env  in
            {
              curmodule = (uu___147_2262.curmodule);
              curmonad = (uu___147_2262.curmonad);
              modules = (uu___147_2262.modules);
              scope_mods = (uu___147_2262.scope_mods);
              exported_ids = (uu___147_2262.exported_ids);
              trans_exported_ids = (uu___147_2262.trans_exported_ids);
              includes = (uu___147_2262.includes);
              sigaccum = (uu___147_2262.sigaccum);
              sigmap = (uu___147_2262.sigmap);
              iface = (uu___147_2262.iface);
              admitted_iface = (uu___147_2262.admitted_iface);
              expect_typ = (uu___147_2262.expect_typ);
              docs = (uu___147_2262.docs);
              remaining_iface_decls = ((l, ds) :: rest);
              syntax_only = (uu___147_2262.syntax_only);
              ds_hooks = (uu___147_2262.ds_hooks)
            }
...
let (set_syntax_only : env -> Prims.bool -> env) =
  fun env  ->
    fun b  ->
      let uu___148_2308 = env  in
      {
        curmodule = (uu___148_2308.curmodule);
        curmonad = (uu___148_2308.curmonad);
        modules = (uu___148_2308.modules);
        scope_mods = (uu___148_2308.scope_mods);
        exported_ids = (uu___148_2308.exported_ids);
        trans_exported_ids = (uu___148_2308.trans_exported_ids);
        includes = (uu___148_2308.includes);
        sigaccum = (uu___148_2308.sigaccum);
        sigmap = (uu___148_2308.sigmap);
        iface = (uu___148_2308.iface);
        admitted_iface = (uu___148_2308.admitted_iface);
        expect_typ = (uu___148_2308.expect_typ);
        docs = (uu___148_2308.docs);
        remaining_iface_decls = (uu___148_2308.remaining_iface_decls);
        syntax_only = b;
        ds_hooks = (uu___148_2308.ds_hooks)
      }
...
let (set_ds_hooks : env -> dsenv_hooks -> env) =
  fun env  ->
    fun hooks  ->
      let uu___149_2324 = env  in
      {
        curmodule = (uu___149_2324.curmodule);
        curmonad = (uu___149_2324.curmonad);
        modules = (uu___149_2324.modules);
        scope_mods = (uu___149_2324.scope_mods);
        exported_ids = (uu___149_2324.exported_ids);
        trans_exported_ids = (uu___149_2324.trans_exported_ids);
        includes = (uu___149_2324.includes);
        sigaccum = (uu___149_2324.sigaccum);
        sigmap = (uu___149_2324.sigmap);
        iface = (uu___149_2324.iface);
        admitted_iface = (uu___149_2324.admitted_iface);
        expect_typ = (uu___149_2324.expect_typ);
        docs = (uu___149_2324.docs);
        remaining_iface_decls = (uu___149_2324.remaining_iface_decls);
        syntax_only = (uu___149_2324.syntax_only);
        ds_hooks = hooks
      }
...
let (set_bv_range :
  ...
  fun bv  ->
    fun r  ->
      let id1 =
        let uu___150_2428 = bv.FStar_Syntax_Syntax.ppname  in
        {
          FStar_Ident.idText = (uu___150_2428.FStar_Ident.idText);
          FStar_Ident.idRange = r
        }  in
      let uu___151_2429 = bv  in
      {
        FStar_Syntax_Syntax.ppname = id1;
        FStar_Syntax_Syntax.index = (uu___151_2429.FStar_Syntax_Syntax.index);
        FStar_Syntax_Syntax.sort = (uu___151_2429.FStar_Syntax_Syntax.sort)
      }
        ...
        fun env  ->
          fun ns  ->
            fun id1  ->
              ...
              let rec aux uu___113_2881 =
                match uu___113_2881 with
            ...
            fun k_record  ->
              fun find_in_module  ->
                fun lookup_default_id  ->
                  let check_local_binding_id uu___115_3252 =
                    match uu___115_3252 with
                    | (id',uu____3254,uu____3255) ->
                        id'.FStar_Ident.idText = id1.FStar_Ident.idText
                     in
                  let check_rec_binding_id uu___116_3261 =
                    match uu___116_3261 with
                  ...
                  let proc uu___117_3276 =
                    match uu___117_3276 with
                  ...
                  let rec aux uu___118_3299 =
                    match uu___118_3299 with
                    | a::q ->
    ...
    fun exclude_interf  ->
      fun env  ->
        fun lid  ->
          ...
          let k_global_def source_lid uu___129_4614 =
            match uu___129_4614 with
...
let (lookup_letbinding_quals :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___130_5370 =
        match uu___130_5370 with
        | ({
...
let (try_lookup_let :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___131_5502 =
        match uu___131_5502 with
        | ({
...
let (try_lookup_definition :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___132_5570 =
        match uu___132_5570 with
        | ({
             FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
               (lbs,uu____5580);
...
let (try_lookup_lid_with_attributes_no_resolve :
  ...
  fun env  ->
    fun l  ->
      let env' =
        let uu___152_5994 = env  in
        {
          curmodule = (uu___152_5994.curmodule);
          curmonad = (uu___152_5994.curmonad);
          modules = (uu___152_5994.modules);
          scope_mods = [];
          exported_ids = empty_exported_id_smap;
          trans_exported_ids = (uu___152_5994.trans_exported_ids);
          includes = empty_include_smap;
          sigaccum = (uu___152_5994.sigaccum);
          sigmap = (uu___152_5994.sigmap);
          iface = (uu___152_5994.iface);
          admitted_iface = (uu___152_5994.admitted_iface);
          expect_typ = (uu___152_5994.expect_typ);
          docs = (uu___152_5994.docs);
          remaining_iface_decls = (uu___152_5994.remaining_iface_decls);
          syntax_only = (uu___152_5994.syntax_only);
          ds_hooks = (uu___152_5994.ds_hooks)
        }  in
...
let (find_all_datacons :
  ...
  fun env  ->
    fun lid  ->
      let k_global_def lid1 uu___134_6182 =
        match uu___134_6182 with
        | ({
             FStar_Syntax_Syntax.sigel =
...
let (unique :
  ...
  fun any_val  ->
    fun exclude_interface  ->
      fun env  ->
        fun lid  ->
          let filter_scope_mods uu___139_8813 =
            match uu___139_8813 with
            | Rec_binding uu____8814 -> true
            | uu____8815 -> false  in
          let this_env =
            let uu___153_8817 = env  in
            let uu____8818 =
              FStar_List.filter filter_scope_mods env.scope_mods  in
            {
              curmodule = (uu___153_8817.curmodule);
              curmonad = (uu___153_8817.curmonad);
              modules = (uu___153_8817.modules);
              scope_mods = uu____8818;
              exported_ids = empty_exported_id_smap;
              trans_exported_ids = (uu___153_8817.trans_exported_ids);
              includes = empty_include_smap;
              sigaccum = (uu___153_8817.sigaccum);
              sigmap = (uu___153_8817.sigmap);
              iface = (uu___153_8817.iface);
              admitted_iface = (uu___153_8817.admitted_iface);
              expect_typ = (uu___153_8817.expect_typ);
              docs = (uu___153_8817.docs);
              remaining_iface_decls = (uu___153_8817.remaining_iface_decls);
              syntax_only = (uu___153_8817.syntax_only);
              ds_hooks = (uu___153_8817.ds_hooks)
            }  in
          let uu____8821 =
...
let (push_scope_mod : env -> scope_mod -> env) =
  fun env  ->
    fun scope_mod  ->
      let uu___154_8867 = env  in
      {
        curmodule = (uu___154_8867.curmodule);
        curmonad = (uu___154_8867.curmonad);
        modules = (uu___154_8867.modules);
        scope_mods = (scope_mod :: (env.scope_mods));
        exported_ids = (uu___154_8867.exported_ids);
        trans_exported_ids = (uu___154_8867.trans_exported_ids);
        includes = (uu___154_8867.includes);
        sigaccum = (uu___154_8867.sigaccum);
        sigmap = (uu___154_8867.sigmap);
        iface = (uu___154_8867.iface);
        admitted_iface = (uu___154_8867.admitted_iface);
        expect_typ = (uu___154_8867.expect_typ);
        docs = (uu___154_8867.docs);
        remaining_iface_decls = (uu___154_8867.remaining_iface_decls);
        syntax_only = (uu___154_8867.syntax_only);
        ds_hooks = (uu___154_8867.ds_hooks)
      }
            ...
            (match uu____9025 with
             ...
             | uu____9037 ->
                 (extract_record env globals s;
                  (let uu___155_9063 = env  in
                   {
                     curmodule = (uu___155_9063.curmodule);
                     curmonad = (uu___155_9063.curmonad);
                     modules = (uu___155_9063.modules);
                     scope_mods = (uu___155_9063.scope_mods);
                     exported_ids = (uu___155_9063.exported_ids);
                     trans_exported_ids = (uu___155_9063.trans_exported_ids);
                     includes = (uu___155_9063.includes);
                     sigaccum = (s :: (env.sigaccum));
                     sigmap = (uu___155_9063.sigmap);
                     iface = (uu___155_9063.iface);
                     admitted_iface = (uu___155_9063.admitted_iface);
                     expect_typ = (uu___155_9063.expect_typ);
                     docs = (uu___155_9063.docs);
                     remaining_iface_decls =
                       (uu___155_9063.remaining_iface_decls);
                     syntax_only = (uu___155_9063.syntax_only);
                     ds_hooks = (uu___155_9063.ds_hooks)
                   })))
         in
      let env2 =
        let uu___156_9065 = env1  in
        let uu____9066 = FStar_ST.op_Bang globals  in
        {
          curmodule = (uu___156_9065.curmodule);
          curmonad = (uu___156_9065.curmonad);
          modules = (uu___156_9065.modules);
          scope_mods = uu____9066;
          exported_ids = (uu___156_9065.exported_ids);
          trans_exported_ids = (uu___156_9065.trans_exported_ids);
          includes = (uu___156_9065.includes);
          sigaccum = (uu___156_9065.sigaccum);
          sigmap = (uu___156_9065.sigmap);
          iface = (uu___156_9065.iface);
          admitted_iface = (uu___156_9065.admitted_iface);
          expect_typ = (uu___156_9065.expect_typ);
          docs = (uu___156_9065.docs);
          remaining_iface_decls = (uu___156_9065.remaining_iface_decls);
          syntax_only = (uu___156_9065.syntax_only);
          ds_hooks = (uu___156_9065.ds_hooks)
        }  in
      let uu____9118 =
        match s.FStar_Syntax_Syntax.sigel with
                                            ...
                                            (se,
                                              (env3.iface &&
                                                 (Prims.op_Negation
                                                    env3.admitted_iface))))))))));
           (let env4 =
              let uu___157_9506 = env3  in
              let uu____9507 = FStar_ST.op_Bang globals  in
              {
                curmodule = (uu___157_9506.curmodule);
                curmonad = (uu___157_9506.curmonad);
                modules = (uu___157_9506.modules);
                scope_mods = uu____9507;
                exported_ids = (uu___157_9506.exported_ids);
                trans_exported_ids = (uu___157_9506.trans_exported_ids);
                includes = (uu___157_9506.includes);
                sigaccum = (uu___157_9506.sigaccum);
                sigmap = (uu___157_9506.sigmap);
                iface = (uu___157_9506.iface);
                admitted_iface = (uu___157_9506.admitted_iface);
                expect_typ = (uu___157_9506.expect_typ);
                docs = (uu___157_9506.docs);
                remaining_iface_decls = (uu___157_9506.remaining_iface_decls);
                syntax_only = (uu___157_9506.syntax_only);
                ds_hooks = (uu___157_9506.ds_hooks)
              }  in
            env4))
                           ...
                           ((let uu____11237 =
                            ...
                            (let quals = FStar_Syntax_Syntax.Assumption ::
                             ...
                             FStar_Util.smap_add (sigmap env)
                               l.FStar_Ident.str
                               ((let uu___158_11257 = se  in
                                 {
                                   FStar_Syntax_Syntax.sigel =
                                     (uu___158_11257.FStar_Syntax_Syntax.sigel);
                                   FStar_Syntax_Syntax.sigrng =
                                     (uu___158_11257.FStar_Syntax_Syntax.sigrng);
                                   FStar_Syntax_Syntax.sigquals = quals;
                                   FStar_Syntax_Syntax.sigmeta =
                                     (uu___158_11257.FStar_Syntax_Syntax.sigmeta);
                                   FStar_Syntax_Syntax.sigattrs =
                                     (uu___158_11257.FStar_Syntax_Syntax.sigattrs)
                                 }), false);
                             l
                             ::
                             lids)))
             ...
             (fun s  ->
                ...
                | FStar_Syntax_Syntax.Sig_declare_typ
                    ...
                    FStar_List.existsb
                      ...
                      admitted_sig_lids
                    ->
                    let uu___160_11274 = s  in
                    {
                      FStar_Syntax_Syntax.sigel =
                        (uu___160_11274.FStar_Syntax_Syntax.sigel);
                      FStar_Syntax_Syntax.sigrng =
                        (uu___160_11274.FStar_Syntax_Syntax.sigrng);
                      FStar_Syntax_Syntax.sigquals =
                        (FStar_Syntax_Syntax.Assumption ::
                        (s.FStar_Syntax_Syntax.sigquals));
                      FStar_Syntax_Syntax.sigmeta =
                        (uu___160_11274.FStar_Syntax_Syntax.sigmeta);
                      FStar_Syntax_Syntax.sigattrs =
                        (uu___160_11274.FStar_Syntax_Syntax.sigattrs)
                    }
                | uu____11275 -> s))
         in
      {
        FStar_Syntax_Syntax.name = (uu___159_11259.FStar_Syntax_Syntax.name);
        FStar_Syntax_Syntax.declarations = uu____11260;
        FStar_Syntax_Syntax.exports =
          (uu___159_11259.FStar_Syntax_Syntax.exports);
        FStar_Syntax_Syntax.is_interface =
          (uu___159_11259.FStar_Syntax_Syntax.is_interface)
      }
                                 ...
                                 then
                                   (let sigel =
                                      ...
                                      FStar_Syntax_Syntax.Sig_declare_typ
                                       ...
                                       in
                                    let se2 =
                                      let uu___161_11396 = se1  in
                                      {
                                        FStar_Syntax_Syntax.sigel = sigel;
                                        FStar_Syntax_Syntax.sigrng =
                                          (uu___161_11396.FStar_Syntax_Syntax.sigrng);
                                        FStar_Syntax_Syntax.sigquals =
                                          (FStar_Syntax_Syntax.Assumption ::
                                          quals);
                                        FStar_Syntax_Syntax.sigmeta =
                                          (uu___161_11396.FStar_Syntax_Syntax.sigmeta);
                                        FStar_Syntax_Syntax.sigattrs =
                                          (uu___161_11396.FStar_Syntax_Syntax.sigattrs)
                                      }  in
                                    FStar_Util.smap_add (sigmap env)
                          ...
                          (fun lb  ->
                             ...
                             let decl =
                               let uu___162_11456 = se  in
                               {
                                 ...
                                 FStar_Syntax_Syntax.sigrng =
                                   (uu___162_11456.FStar_Syntax_Syntax.sigrng);
                                 FStar_Syntax_Syntax.sigquals = quals1;
                                 FStar_Syntax_Syntax.sigmeta =
                                   (uu___162_11456.FStar_Syntax_Syntax.sigmeta);
                                 FStar_Syntax_Syntax.sigattrs =
                                   (uu___162_11456.FStar_Syntax_Syntax.sigattrs)
                               }  in
                             FStar_Util.smap_add (sigmap env)
       ...
       (match () with
        | () ->
            (filter_record_cache ();
             (match () with
              | () ->
                  let uu___163_12507 = env  in
                  {
                    curmodule = FStar_Pervasives_Native.None;
                    curmonad = (uu___163_12507.curmonad);
                    modules = (((modul.FStar_Syntax_Syntax.name), modul) ::
                      (env.modules));
                    scope_mods = [];
                    exported_ids = (uu___163_12507.exported_ids);
                    trans_exported_ids = (uu___163_12507.trans_exported_ids);
                    includes = (uu___163_12507.includes);
                    sigaccum = [];
                    sigmap = (uu___163_12507.sigmap);
                    iface = (uu___163_12507.iface);
                    admitted_iface = (uu___163_12507.admitted_iface);
                    expect_typ = (uu___163_12507.expect_typ);
                    docs = (uu___163_12507.docs);
                    remaining_iface_decls =
                      (uu___163_12507.remaining_iface_decls);
                    syntax_only = (uu___163_12507.syntax_only);
                    ds_hooks = (uu___163_12507.ds_hooks)
                  }))))
    ...
    FStar_Util.atomically
      (fun uu____12543  ->
         ...
         (let uu___164_12606 = env  in
          ...
          {
            curmodule = (uu___164_12606.curmodule);
            curmonad = (uu___164_12606.curmonad);
            modules = (uu___164_12606.modules);
            scope_mods = (uu___164_12606.scope_mods);
            exported_ids = uu____12607;
            trans_exported_ids = uu____12612;
            includes = uu____12617;
            sigaccum = (uu___164_12606.sigaccum);
            sigmap = uu____12628;
            iface = (uu___164_12606.iface);
            admitted_iface = (uu___164_12606.admitted_iface);
            expect_typ = (uu___164_12606.expect_typ);
            docs = uu____12639;
            remaining_iface_decls = (uu___164_12606.remaining_iface_decls);
            syntax_only = (uu___164_12606.syntax_only);
            ds_hooks = (uu___164_12606.ds_hooks)
          }))
                  ...
                  (FStar_Util.smap_remove sm' k;
                   (let se1 =
                      ...
                      | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) ->
                          let uu___165_12817 = se  in
                          {
                            FStar_Syntax_Syntax.sigel =
                              (uu___165_12817.FStar_Syntax_Syntax.sigel);
                            FStar_Syntax_Syntax.sigrng =
                              (uu___165_12817.FStar_Syntax_Syntax.sigrng);
                            FStar_Syntax_Syntax.sigquals =
                              (FStar_Syntax_Syntax.Assumption ::
                              (se.FStar_Syntax_Syntax.sigquals));
                            FStar_Syntax_Syntax.sigmeta =
                              (uu___165_12817.FStar_Syntax_Syntax.sigmeta);
                            FStar_Syntax_Syntax.sigattrs =
                              (uu___165_12817.FStar_Syntax_Syntax.sigattrs)
                          }
                      | uu____12818 -> se  in
        ...
        fun mname  ->
          fun mii  ->
            let prep env1 =
              ...
              let auto_open1 =
                let convert_kind uu___142_13577 =
                  match uu___142_13577 with
                           ...
                           | () ->
                               let env' =
                                    ...
                                    in
                                 {
                                   ...
                                   curmonad = (uu___166_13734.curmonad);
                                   modules = (uu___166_13734.modules);
                                   scope_mods = uu____13735;
                                   exported_ids =
                                     (uu___166_13734.exported_ids);
                                   trans_exported_ids =
                                     (uu___166_13734.trans_exported_ids);
                                   includes = (uu___166_13734.includes);
                                   sigaccum = (uu___166_13734.sigaccum);
                                   sigmap = (env1.sigmap);
                                   iface = intf;
                                   admitted_iface = admitted;
                                   expect_typ = (uu___166_13734.expect_typ);
                                   docs = (uu___166_13734.docs);
                                   remaining_iface_decls =
                                     (uu___166_13734.remaining_iface_decls);
                                   syntax_only = (uu___166_13734.syntax_only);
                                   ds_hooks = (uu___166_13734.ds_hooks)
                                 }  in
                               (FStar_List.iter
                                  (fun op  ->
...
let (enter_monad_scope : env -> FStar_Ident.ident -> env) =
  fun env  ->
    fun mname  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___167_13821 = env  in
          {
            curmodule = (uu___167_13821.curmodule);
            curmonad = (FStar_Pervasives_Native.Some mname);
            modules = (uu___167_13821.modules);
            scope_mods = (uu___167_13821.scope_mods);
            exported_ids = (uu___167_13821.exported_ids);
            trans_exported_ids = (uu___167_13821.trans_exported_ids);
            includes = (uu___167_13821.includes);
            sigaccum = (uu___167_13821.sigaccum);
            sigmap = (uu___167_13821.sigmap);
            iface = (uu___167_13821.iface);
            admitted_iface = (uu___167_13821.admitted_iface);
            expect_typ = (uu___167_13821.expect_typ);
            docs = (uu___167_13821.docs);
            remaining_iface_decls = (uu___167_13821.remaining_iface_decls);
            syntax_only = (uu___167_13821.syntax_only);
            ds_hooks = (uu___167_13821.ds_hooks)
          }
