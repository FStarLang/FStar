    ...
    fun id1 ->
      fun record ->
        fun cont ->
          ...
          let uu____2403 = FStar_Ident.lid_equals typename' record.typename in
          if uu____2403
          then
            let fname =
              FStar_Ident.lid_of_ids
              ...
              let rec aux uu___85_2527 =
                ...
                | modul::q ->
                    ...
                    (match look_into with
                     ...
                     | uu____2753 -> look_into) in
              aux [ns]
let (is_exported_id_field : exported_id_kind -> Prims.bool) =
  fun uu___86_2758 ->
    match uu___86_2758 with | Exported_id_field -> true | uu____2759 -> false
let try_lookup_id'' :
  'a .
    env ->
      FStar_Ident.ident ->
    ...
    fun id1 ->
      ...
      | uu____3057 ->
          try_lookup_id'' env id1 Exported_id_term_type
            (fun r ->
               let uu____3071 = found_local_binding id1.FStar_Ident.idRange r in
               Cont_ok uu____3071) (fun uu____3081 -> Cont_fail)
            (fun uu____3087 -> Cont_ignore)
            (fun i ->
               find_in_module env i
                 (fun uu____3102 -> fun uu____3103 -> Cont_fail) Cont_ignore)
    ...
    fun id1 ->
      fun k_global_def ->
        fun k_not_found ->
          ...
          | FStar_Pervasives_Native.None ->
              let lid =
                let uu____3238 = current_module env in qual uu____3238 id1 in
...
let (fv_qual_of_se :
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ
        (uu____3993, uu____3994, uu____3995) -> FStar_Pervasives_Native.None
            ...
            | (se, uu____4077) ->
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     let uu____4125 =
                       let uu____4126 =
                         let uu____4135 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____4136 in
                         (uu____4135, false,
                           (se.FStar_Syntax_Syntax.sigattrs)) in
                       Term_name uu____4126 in
                     FStar_Pervasives_Native.Some uu____4125
                 | FStar_Syntax_Syntax.Sig_let
                     ((uu____4141, lbs), uu____4143) ->
                 ...
                 | FStar_Syntax_Syntax.Sig_declare_typ
                     ...
                     then
                       let lid2 =
                         let uu____4187 = FStar_Ident.range_of_lid source_lid in
                       ...
                       let uu____4211 =
                         FStar_Util.find_map quals
                           (fun uu___98_4216 ->
                              ...
                              | uu____4220 -> FStar_Pervasives_Native.None) in
                       ...
                       let uu____4253 =
                         let uu____4258 =
                           ...
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu____4259 in
                         (se, uu____4258) in
                       ...
                       let uu____4262 =
                         let uu____4267 =
                           let uu____4268 =
                             FStar_Ident.range_of_lid source_lid in
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu____4268 in
                         (se, uu____4267) in
                 ...
                 | uu____4301 -> FStar_Pervasives_Native.None) in
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4513;_},
           l1)
          ->
          FStar_Pervasives_Native.Some
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4535;_},
           l1)
          ->
          FStar_Pervasives_Native.Some
            (l1, (ne.FStar_Syntax_Syntax.cattributes))
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4561;_},
           l1)
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4617;_},
           uu____4618)
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4631;_},
           uu____4632)
          -> FStar_Pervasives_Native.Some ne
    ...
    fun l ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4683;_},
           uu____4684)
          ->
    ...
    fun lid ->
      let k_global_def lid1 uu___100_4780 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4795;_},
           uu____4796) -> FStar_Pervasives_Native.Some quals
        | uu____4803 -> FStar_Pervasives_Native.None in
      let uu____4810 =
        resolve_in_open_namespaces' env lid
          (fun uu____4818 -> FStar_Pervasives_Native.None)
          (fun uu____4822 -> FStar_Pervasives_Native.None) k_global_def in
        ...
        FStar_List.tryFind
          (fun uu____4860 ->
             ...
             | (mlid, modul) ->
                 ...
                 uu____4867 = path) env.modules in
    ...
    fun lid ->
      let k_global_def lid1 uu___101_4900 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4913;_},
           uu____4914) ->
    ...
    fun lid ->
      let k_global_def lid1 uu___102_4966 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____4980;_},
           uu____4981) ->
...
let (try_lookup_lid' :
  ...
  fun any_val ->
    fun exclude_interface ->
      fun env ->
        fun lid ->
          let uu____5072 = try_lookup_name any_val exclude_interface env lid in
  ...
  fun env ->
    fun lid ->
      ...
      | uu____5316 ->
          ...
          let uu____5320 = resolve_to_fully_qualified_name env lid_without_ns in
    ...
    fun lid ->
      let k_global_def lid1 uu___104_5428 =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5441;_},
           uu____5442) ->
            let uu____5447 =
              FStar_All.pipe_right quals
                (FStar_Util.for_some
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigattrs = uu____5461;_},
           uu____5462) ->
            let uu____5481 =
              FStar_Syntax_Syntax.lid_as_fv lid1
                FStar_Syntax_Syntax.Delta_constant
      ...
      let k_global_def lid1 uu___105_5515 =
        ...
        | ({
             FStar_Syntax_Syntax.sigel =
               ...
               (uu____5524, uu____5525, uu____5526, uu____5527, datas,
                uu____5529);
             FStar_Syntax_Syntax.sigrng = uu____5530;
             FStar_Syntax_Syntax.sigquals = uu____5531;
             FStar_Syntax_Syntax.sigmeta = uu____5532;
             FStar_Syntax_Syntax.sigattrs = uu____5533;_},
           uu____5534) -> FStar_Pervasives_Native.Some datas
...
let (push_record_cache : Prims.unit -> Prims.unit) =
  ...
  | (push1, uu____6457, uu____6458, uu____6459) -> push1
...
let (peek_record_cache : Prims.unit -> record_or_dc Prims.list) =
  ...
  | (uu____6554, uu____6555, peek1, uu____6557) -> peek1
let (insert_record_cache : record_or_dc -> Prims.unit) =
  let uu____6580 = record_cache_aux in
  match uu____6580 with
  | (uu____6601, uu____6602, uu____6603, insert) -> insert
let (extract_record :
  env ->
                ...
                (FStar_Util.find_opt
                   (fun uu___107_6722 ->
                      ...
                      | {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_datacon
                            (lid, uu____6724, uu____6725, uu____6726,
                             uu____6727, uu____6728);
              ...
              (FStar_List.iter
                 (fun uu___108_6776 ->
                    ...
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename, univs1, parms, uu____6780, uu____6781,
                           dc::[]);
                        ...
                        (match uu____6797 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
                               (constrname, uu____6804, t, uu____6806,
                                                             ...
                                                             let uu____7221 =
                                                               let uu____7222
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   constrname
                                                                   id1 in
                                                               uu____7222.FStar_Ident.ident in
                                                             uu____7221.FStar_Ident.idText in
                                                           let uu____7224 =
                                                             let uu____7225 =
                                                               FStar_ST.op_Bang
                                                                 my_exported_ids in
...
let (try_lookup_record_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____7393 = try_lookup_record_or_dc_by_field_name env fieldname in
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____7419 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____7423 -> Cont_ok ()) in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env ->
    fun fieldname ->
      let uu____7443 = try_lookup_record_or_dc_by_field_name env fieldname in
    ...
    fun s ->
        ...
        | (any_val, exclude_interface) ->
            ...
            let uu____7749 =
              FStar_Util.find_map lids
                (fun l ->
                   let uu____7755 =
                     let uu____7756 = unique any_val exclude_interface env l in
      ...
      let uu____7838 =
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses, uu____7864) ->
            ...
            (env2, uu____7873)
        | uu____7900 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)]) in
                   ...
                   | (lids, se) ->
                       FStar_All.pipe_right lids
                         (FStar_List.iter
                            (fun lid ->
                               (let uu____7981 =
                                  let uu____7984 = FStar_ST.op_Bang globals in
                ...
                (FStar_Util.for_some
                   (fun uu____8296 ->
                      ...
                      | (m, uu____8302) ->
                          ...
                          FStar_Util.starts_with uu____8303 uu____8305)) in
            if uu____8280
      ...
      | FStar_Pervasives_Native.Some ns1 ->
          ((env.ds_hooks).ds_push_include_hook env ns1;
           ...
           (let env1 =
            ...
            (let uu____8346 = FStar_Util.smap_try_find env1.includes curmod in
             ...
             | () ->
                 ...
                 (match uu____8466 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____8483 =
                          let uu____8500 = get_exported_id_set env1 curmod in
                          let uu____8507 =
                           ...
                           FStar_Pervasives_Native.Some cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____8687 =
                                 ...
                                 FStar_Util.set_difference uu____8688 ns_ex in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____8788 =
                                     ...
                                     FStar_Util.set_union uu____8789 ns_ex in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  ...
                  let uu____8953 =
                    let uu____8958 =
                      ...
                      let uu____8961 = FStar_Parser_AST.string_of_fsdoc doc1 in
                      FStar_Util.format3
                        "Overwriting doc of %s; old doc was [%s]; new doc are [%s]"
                        uu____8959 uu____8960 uu____8961 in
                      ...
                      (match uu____9000 with
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____9017;_},
                            uu____9018)
                           -> lids
                       | FStar_Pervasives_Native.Some
                           ({
                              ...
                              FStar_Syntax_Syntax.sigattrs = uu____9037;_},
                            uu____9038)
                           -> lids
                       | uu____9063 ->
                           ((let uu____9071 =
                               let uu____9072 = FStar_Options.interactive () in
                               Prims.op_Negation uu____9072 in
                             if uu____9071
                             then
                               let uu____9073 = FStar_Ident.range_of_lid l in
                               let uu____9074 =
                                 let uu____9079 =
                                   let uu____9080 =
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se ->
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1 ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid, uu____9146, uu____9147, uu____9148,
                                 uu____9149, uu____9150)
                                ->
                                FStar_Util.smap_remove (sigmap env)
                                  lid.FStar_Ident.str
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid, univ_names, binders, typ, uu____9163,
                                 uu____9164)
                                ->
                                (FStar_Util.smap_remove (sigmap env)
                                   lid.FStar_Ident.str;
              ...
              | uu____9290 -> ()));
      (let curmod =
         let uu____9292 = current_module env in uu____9292.FStar_Ident.str in
       (let uu____9294 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex, FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____9372 = cur_ex eikind in FStar_ST.op_Bang uu____9372 in
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e ->
    ...
    let fields =
      let uu____10049 =
        let uu____10052 = e Exported_id_field in FStar_ST.op_Bang uu____10052 in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____10704 ->
                      ...
                      | (l, uu____10710) -> FStar_Ident.lid_equals l mname)) in
