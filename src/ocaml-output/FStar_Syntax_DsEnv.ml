  ...
  fun env1  ->
    fun id  ->
      ...
      | FStar_Pervasives_Native.Some monad ->
          let uu___ = let uu___1 = current_module env1  in qual uu___1 monad
             in
...
let (is_exported_id_field : exported_id_kind -> Prims.bool) =
  fun uu___  ->
    match uu___ with | Exported_id_field  -> true | uu___1 -> false
          ...
          try_lookup_id'' env1 id Exported_id_term_type
            ...
            (fun i  ->
               find_in_module env1 i
                 (fun uu___2  -> fun uu___3  -> Cont_fail) Cont_ignore)
            (fun uu___2  -> fun uu___3  -> Cont_fail)
...
let (resolve_module_name :
  ...
  fun env1  ->
    fun lid  ->
      fun honor_ns  ->
        let nslen =
          let uu___ = FStar_Ident.ns_of_lid lid  in FStar_List.length uu___
           in
        let rec aux uu___ =
          match uu___ with
          | [] ->
        ...
        fun k_rec_binding  ->
          fun k_global_def  ->
            let k_global_def' k lid1 def =
              let uu___ = k_global_def lid1 def  in cont_of_option k uu___
               in
            let f_module lid' =
...
let (fv_qual_of_se :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_datacon (uu___,uu___1,uu___2,l,uu___3,uu___4)
        ->
        let qopt =
...
let (ns_of_lid_equals :
  ...
  fun lid  ->
    fun ns  ->
      (let uu___ =
         let uu___1 = FStar_Ident.ns_of_lid lid  in FStar_List.length uu___1
          in
       let uu___1 =
         let uu___2 = FStar_Ident.ids_of_lid ns  in FStar_List.length uu___2
          in
       uu___ = uu___1) &&
        (let uu___ =
                ...
                (match se.FStar_Syntax_Syntax.sigel with
                     ...
                     let uu___3 =
                       let uu___4 =
                         let uu___5 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.delta_constant uu___6
                            in
                         (uu___5, (se.FStar_Syntax_Syntax.sigattrs))  in
                       Term_name uu___4  in
                     FStar_Pervasives_Native.Some uu___3
                            ...
                            let uu___7 =
                              let uu___8 =
                                let uu___9 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu___10
                                   in
                                (uu___9, (se.FStar_Syntax_Syntax.sigattrs))
                                 in
                              Term_name uu___8  in
                 ...
                 | FStar_Syntax_Syntax.Sig_new_effect ne ->
                     let uu___2 =
                       let uu___3 =
                         let uu___4 =
                           let uu___5 = FStar_Ident.range_of_lid source_lid
                              in
                           FStar_Ident.set_lid_range
                             ne.FStar_Syntax_Syntax.mname uu___5
                            in
                         (se, uu___4)  in
                       Eff_name uu___3  in
                     FStar_Pervasives_Native.Some uu___2
    ...
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigopts = uu___5;_},l1)
          ->
          FStar_Pervasives_Native.Some
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigopts = uu___9;_},l1)
    ...
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigmeta = uu___3;
             FStar_Syntax_Syntax.sigattrs = uu___4;
             FStar_Syntax_Syntax.sigopts = uu___5;_},uu___6)
    ...
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some
          ({
             ...
             FStar_Syntax_Syntax.sigmeta = uu___7;
             FStar_Syntax_Syntax.sigattrs = uu___8;
             FStar_Syntax_Syntax.sigopts = uu___9;_},uu___10)
          ->
    ...
    fun lid  ->
      ...
      let uu___ =
        resolve_in_open_namespaces' env1 lid
          ...
          (fun uu___1  -> FStar_Pervasives_Native.None) k_global_def
         in
      match uu___ with
    ...
    fun lid  ->
      let k_global_def lid1 uu___ =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu___7;_},uu___8)
            ->
  ...
  fun env1  ->
    fun lid  ->
      ...
      | uu___ ->
          ...
          let uu___1 = resolve_to_fully_qualified_name env1 lid_without_ns
             in
          (match uu___1 with
    ...
    fun lid  ->
      let k_global_def lid1 uu___ =
        ...
        | ({
             ...
             FStar_Syntax_Syntax.sigopts = uu___10;_},uu___11)
...
let (record_cache_aux_with_filter :
  ...
  let push uu___ =
    let uu___1 =
      let uu___2 =
        let uu___3 = FStar_ST.op_Bang record_cache  in FStar_List.hd uu___3
         in
  ...
  let insert r =
    let uu___ =
      ...
      let uu___2 =
        let uu___3 = FStar_ST.op_Bang record_cache  in FStar_List.tl uu___3
         in
      uu___1 :: uu___2  in
                    ...
                    | {
                        ...
                        (match uu___8 with
                         | {
                             ...
                             let uu___17 = FStar_Syntax_Util.arrow_formals t
                                in
                             (match uu___17 with
                              | (all_formals,uu___18) ->
                                  let uu___19 =
      ...
      fun record  ->
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu___1 =
              ...
              find_in_record uu___2 uu___3 record (fun uu___4  -> Cont_ok ())
               in
      ...
      fun env1  ->
        fun lid  ->
          let filter_scope_mods uu___ =
            match uu___ with | Rec_binding uu___1 -> true | uu___1 -> false
             in
          let this_env =
            let uu___ = env1  in
            let uu___1 = FStar_List.filter filter_scope_mods env1.scope_mods
               in
            {
              curmodule = (uu___.curmodule);
              curmonad = (uu___.curmonad);
          ...
          let uu___ = try_lookup_lid' any_val exclude_interface this_env lid
             in
          match uu___ with
          | FStar_Pervasives_Native.None  -> true
          ...
          | (any_val,exclude_interface) ->
              ...
              let uu___1 =
                FStar_Util.find_map lids
                  (fun l  ->
                     let uu___2 =
                       let uu___3 = unique any_val exclude_interface env1 l
                          in
                ...
                (FStar_Util.for_some
                   (fun uu___3  ->
                      ...
                      | (m,uu___4) ->
                          ...
                          FStar_Util.starts_with uu___5 uu___6))
               in
            if uu___2
            then (ns, Open_namespace)
              ...
              (let uu___4 =
                 let uu___5 =
                   ...
                   FStar_Util.format1 "Namespace %s cannot be found" uu___6
                    in
                 ...
                 (match uu___3 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu___5 =
                          ...
                          let uu___7 = get_trans_exported_id_set env2 curmod
                             in
                          (uu___6, uu___7)  in
                        match uu___5 with
                        | (FStar_Pervasives_Native.Some
                            ...
                            let update_exports k =
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu___8 =
                                     let uu___9 = FStar_ST.op_Bang trans_ex
                                        in
                                     FStar_Util.set_union uu___9 ns_ex  in
                                   FStar_ST.op_Colon_Equals trans_ex uu___8)
                               in
                  ...
                  | FStar_Pervasives_Native.None  ->
                      let uu___4 =
                        let uu___5 =
                          ...
                          FStar_Util.format1
                            "include: Module %s was not prepared" uu___6
                           in
                        (FStar_Errors.Fatal_IncludeModuleNotPrepared, uu___5)
                         in
      ...
      | uu___1 ->
          let uu___2 =
            let uu___3 =
              ...
              FStar_Util.format1 "include: Module %s cannot be found" uu___4
               in
                    ...
                    FStar_All.pipe_right ses
                      (FStar_List.iter
                         (fun se1  ->
                            ...
                            | FStar_Syntax_Syntax.Sig_datacon
                                (lid,uu___2,uu___3,uu___4,uu___5,uu___6) ->
                                let uu___7 = FStar_Ident.string_of_lid lid
                                   in
                                FStar_Util.smap_remove (sigmap env1) uu___7
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                (lid,univ_names,binders,typ,uu___2,uu___3) ->
                                ((let uu___5 = FStar_Ident.string_of_lid lid
                                     in
...
let (push : env -> env) =
  fun env1  ->
    FStar_Util.atomically
      (fun uu___  ->
         push_record_cache ();
         (let uu___3 = let uu___4 = FStar_ST.op_Bang stack  in env1 :: uu___4
             in
...
let (as_exported_ids : exported_id_set -> exported_ids) =
  fun e  ->
    ...
    let fields =
      let uu___ =
        let uu___1 = e Exported_id_field  in FStar_ST.op_Bang uu___1  in
      FStar_Util.set_elements uu___  in
                  ...
                  then
                    let uu___4 =
                      let uu___5 =
                        ...
                        FStar_Util.format1
                          "Duplicate module or interface name: %s" uu___6
                         in
                      (FStar_Errors.Fatal_DuplicateModuleOrInterface, uu___5)
                       in
                ...
                (let modul =
                 ...
                 | FStar_Pervasives_Native.Some modul' when
                     Prims.op_Negation
                       (FStar_List.existsb
                          (fun m  ->
                             let uu___4 = FStar_Ident.string_of_lid modul'
                                in
