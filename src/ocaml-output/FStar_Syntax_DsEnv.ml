...
type 'a withenv = env -> ('a,env) FStar_Pervasives_Native_Tuple2.tuple2
...
let found_local_binding :
  'Auu____3726 .
    FStar_Range.range ->
      ('Auu____3726,FStar_Syntax_Syntax.bv)
  ...
  'Auu____3758 .
    env ->
      FStar_Ident.lident ->
        (FStar_Ident.lident ->
           (FStar_Syntax_Syntax.sigelt,Prims.bool)
             FStar_Pervasives_Native_Tuple2.tuple2 -> 'Auu____3758)
  ...
  'a .
    env ->
      FStar_Ident.ident ->
        (FStar_Ident.lident ->
           (FStar_Syntax_Syntax.sigelt,Prims.bool)
             FStar_Pervasives_Native_Tuple2.tuple2 -> 'a cont_t)
          -> 'a cont_t -> 'a cont_t
  =
  fun env  ->
    fun id1  ->
...
let (record_cache_aux_with_filter :
  (((unit -> unit,unit -> unit) FStar_Pervasives_Native_Tuple2.tuple2,
     ((unit -> (Prims.int,unit) FStar_Pervasives_Native_Tuple2.tuple2,
        Prims.int FStar_Pervasives_Native.option -> unit)
        FStar_Pervasives_Native_Tuple2.tuple2,(unit ->
                                                 record_or_dc Prims.list,
                                                record_or_dc -> unit)
                                                FStar_Pervasives_Native_Tuple2.tuple2)
       FStar_Pervasives_Native_Tuple2.tuple2)
     FStar_Pervasives_Native_Tuple2.tuple2,unit -> unit)
    FStar_Pervasives_Native_Tuple2.tuple2)
  =
...
let (record_cache_aux :
  ((unit -> unit,unit -> unit) FStar_Pervasives_Native_Tuple2.tuple2,
    ((unit -> (Prims.int,unit) FStar_Pervasives_Native_Tuple2.tuple2,
       Prims.int FStar_Pervasives_Native.option -> unit)
       FStar_Pervasives_Native_Tuple2.tuple2,(unit -> record_or_dc Prims.list,
                                               record_or_dc -> unit)
                                               FStar_Pervasives_Native_Tuple2.tuple2)
      FStar_Pervasives_Native_Tuple2.tuple2)
    FStar_Pervasives_Native_Tuple2.tuple2)
...
let (try_lookup_dc_by_field_name :
  env ->
    FStar_Ident.lident ->
      (FStar_Ident.lident,Prims.bool) FStar_Pervasives_Native_Tuple2.tuple2
        FStar_Pervasives_Native.option)
  =
  fun env  ->
    fun fieldname  ->
...
let (push_bv :
  env ->
    FStar_Ident.ident ->
      (env,FStar_Syntax_Syntax.bv) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun env  ->
    fun x  ->
      let bv =
...
let (snapshot : env -> (Prims.int,env) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (finish_module_or_interface :
  env ->
    FStar_Syntax_Syntax.modul ->
      (env,FStar_Syntax_Syntax.modul) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun env  ->
    fun modul  ->
      let modul1 =
  ...
  Prims.bool ->
    Prims.bool ->
      env ->
        FStar_Ident.lident ->
          module_inclusion_info ->
            (env,Prims.bool) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun intf  ->
    fun admitted  ->
      fun env  ->
