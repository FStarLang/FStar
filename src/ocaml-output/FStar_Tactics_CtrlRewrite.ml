                            ...
                            (fun uu____101 ->
                               let uu____102 =
                                 ...
                                 FStar_Tactics_Monad.add_irrelevant_goal g0
                                   "do_rewrite.eq" env uu____105 in
            ...
            fun tm ->
              ...
              let go uu____976 =
                              ...
                              | (t2, flag) ->
                                  let uu____1168 =
                                    let uu____1173 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_abs uu____1174 in
                                    (uu____1173, flag) in
                ...
                | FStar_Syntax_Syntax.Tm_let
                    ((false,
                      { FStar_Syntax_Syntax.lbname = FStar_Util.Inl bv;
                        ...
                        FStar_Syntax_Syntax.lbpos = uu____1489;_}::[]),
                     e)
                    ->
                    let lb =
                      let uu____1517 =
                    ...
                    (match uu____1540 with
                     | (bv1, e1) ->
                         let uu____1553 =
                           ...
                           uu____1564 ((lb.FStar_Syntax_Syntax.lbdef), e1) in
                              ...
                              | ((lbdef, e2), flag) ->
                                  ...
                                  let e3 =
                                    let uu____1622 =
                                      ...
                                      [uu____1623] in
                                    FStar_Syntax_Subst.close uu____1622 e2 in
                                  FStar_Tactics_Monad.ret
                                    ((FStar_Syntax_Syntax.Tm_let
                                        ((false, [lb1]), e3)), flag)))
                | FStar_Syntax_Syntax.Tm_let ((true, lbs), e) ->
                    ...
                    let uu____1733 = FStar_Syntax_Subst.open_let_rec lbs e in
               ...
               | (g, gs) ->
                   FStar_Tactics_Monad.bind FStar_Tactics_Monad.dismiss_all
                     (fun uu____2193 ->
                        ...
                        (let uu____2202 =
                           let uu____2205 = FStar_Tactics_Types.goal_env g in
                                    ...
                                    let uu____2223 =
                                      let uu____2226 =
                                        FStar_Tactics_Types.goal_with_type g
                                          gt' in
                                      [uu____2226] in
                                    FStar_Tactics_Monad.add_goals uu____2223)))))) in
