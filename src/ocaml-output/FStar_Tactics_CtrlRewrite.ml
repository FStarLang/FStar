                                 ...
                                 let uu___8 =
                                   let uu___9 =
                                     env.FStar_TypeChecker_Env.universe_of
                                       env typ
                                      in
                                   FStar_Syntax_Util.mk_eq2 uu___9 typ tm ut
                                    in
                                 FStar_Tactics_Monad.add_irrelevant_goal g0
                                   "do_rewrite.eq" env uu___8
                                  in
            ...
            fun tm  ->
              ...
              let go uu___ =
                ...
                | FStar_Syntax_Syntax.Tm_match (hd,brs) ->
                    ...
                    let uu___1 =
                      let uu___2 =
                        let uu___3 = map_ctac c_branch  in par_ctac rr uu___3
                         in
                      uu___2 (hd, brs)  in
                    FStar_Tactics_Monad.bind uu___1
                      (fun uu___2  ->
                ...
                | FStar_Syntax_Syntax.Tm_let
                    ((false
                      ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl bv;
                         ...
                         FStar_Syntax_Syntax.lbpos = uu___5;_}::[]),e)
                    ->
                    let lb =
                      let uu___6 =
                              ...
                              FStar_Tactics_Monad.log ps
                                (fun uu___6  ->
                                   ...
                                   FStar_Util.print1
                                     ...
                                     uu___7);
                              (let uu___6 = FStar_Tactics_Monad.push_goals gs
                                  in
                                    ...
                                    let uu___8 =
                                      let uu___9 =
                                        FStar_Tactics_Types.goal_with_type g
                                         ...
                                         in
                                      [uu___9]  in
                                    FStar_Tactics_Monad.add_goals uu___8))))))
           in
