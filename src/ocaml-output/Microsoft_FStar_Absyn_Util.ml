...
(let _25_34 = (let _91_8 = (let _91_7 = (Support.Microsoft.FStar.Range.string_of_range r)
...
in (Support.Microsoft.FStar.Util.print_string _91_8))
in ())
end
| Support.Microsoft.FStar.Util.NYI (s) -> begin
(let _25_38 = (let _91_9 = (Support.Microsoft.FStar.Util.format1 "Feature not yet implemented: %s" s)
in (Support.Microsoft.FStar.Util.print_string _91_9))
in ())
end
| Microsoft_FStar_Absyn_Syntax.Err (s) -> begin
(let _91_10 = (Support.Microsoft.FStar.Util.format1 "Error: %s" s)
in (Support.Microsoft.FStar.Util.print_string _91_10))
end
| _25_43 -> begin
(raise (e))
end))
...
| () -> begin
(let _91_38 = (let _91_35 = (let _91_34 = (let _91_33 = (Support.ST.read n_resets)
in (Support.Microsoft.FStar.Util.string_of_int _91_33))
in (Support.Prims.strcat "_" _91_34))
in (Support.Prims.strcat _91_35 "_"))
in (let _91_37 = (let _91_36 = (let _25_62 = (Support.Microsoft.FStar.Util.incr ctr)
in (Support.ST.read ctr))
in (Support.Microsoft.FStar.Util.string_of_int _91_36))
in (Support.Prims.strcat _91_38 _91_37)))
...
in Support.Microsoft.FStar.Util.Inl (_91_130))
in (_91_131, imp))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
(let _91_133 = (let _91_132 = (bvar_to_exp x)
in Support.Microsoft.FStar.Util.Inr (_91_132))
in (_91_133, imp))
end)
end))
...
let args_of_binders = (fun ( binders ) -> (let _91_147 = (Support.All.pipe_right binders (Support.List.map (fun ( b ) -> (match ((Microsoft_FStar_Absyn_Syntax.is_null_binder b)) with
| true -> begin
(let b = (match ((Support.Prims.fst b)) with
| Support.Microsoft.FStar.Util.Inl (a) -> begin
(let _91_142 = (let _91_141 = (gen_bvar a.Microsoft_FStar_Absyn_Syntax.sort)
in Support.Microsoft.FStar.Util.Inl (_91_141))
in (_91_142, (Support.Prims.snd b)))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
(let _91_144 = (let _91_143 = (gen_bvar x.Microsoft_FStar_Absyn_Syntax.sort)
in Support.Microsoft.FStar.Util.Inr (_91_143))
in (_91_144, (Support.Prims.snd b)))
end)
...
in (Support.All.pipe_right _91_147 Support.List.unzip)))
...
(let b = (let _91_153 = (let _91_152 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.Prims.strcat "_" _91_152))
...
(let x = (let _91_155 = (let _91_154 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.Prims.strcat "_" _91_154))
...
in Support.Microsoft.FStar.Util.Inl (_91_170))
in (_91_171, imp))
end
| (Support.Microsoft.FStar.Util.Inr (t), imp) -> begin
(let _91_173 = (let _91_172 = (gen_bvar_p t.Microsoft_FStar_Absyn_Syntax.pos t)
in Support.Microsoft.FStar.Util.Inr (_91_172))
in (_91_173, imp))
end)))))

let binders_of_freevars = (fun ( fvs ) -> (let _91_179 = (let _91_176 = (Support.Microsoft.FStar.Util.set_elements fvs.Microsoft_FStar_Absyn_Syntax.ftvs)
in (Support.All.pipe_right _91_176 (Support.List.map Microsoft_FStar_Absyn_Syntax.t_binder)))
in (let _91_178 = (let _91_177 = (Support.Microsoft.FStar.Util.set_elements fvs.Microsoft_FStar_Absyn_Syntax.fxvs)
in (Support.All.pipe_right _91_177 (Support.List.map Microsoft_FStar_Absyn_Syntax.v_binder)))
in (Support.List.append _91_179 _91_178))))

let subst_to_string = (fun ( s ) -> (let _91_182 = (Support.All.pipe_right s (Support.List.map (fun ( _25_4 ) -> (match (_25_4) with
...
in (Support.All.pipe_right _91_182 (Support.String.concat ", "))))
...
in (let _91_205 = (Support.Microsoft.FStar.Util.mk_ref None)
...
| _25_311 -> begin
(let _91_212 = (let _91_211 = (Support.Microsoft.FStar.Util.mk_ref None)
in (t0, s, _91_211))
...
in (let _91_215 = (Support.Microsoft.FStar.Util.mk_ref None)
...
| _25_345 -> begin
(let _91_221 = (let _91_220 = (Support.Microsoft.FStar.Util.mk_ref None)
in (e0, s, _91_220))
...
in (let _91_224 = (Support.Microsoft.FStar.Util.mk_ref None)
in (k, _91_225, _91_224)))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_delayed _91_226 k0.Microsoft_FStar_Absyn_Syntax.pos))
end
| _25_363 -> begin
(let _91_228 = (let _91_227 = (Support.Microsoft.FStar.Util.mk_ref None)
in (k0, s, _91_227))
...
in Support.Microsoft.FStar.Util.Inl (_91_273))
in (_91_274, imp))
end
...
in Support.Microsoft.FStar.Util.Inr (_91_276))
in (_91_277, imp))
end))
...
in Support.Microsoft.FStar.Util.Inl (_91_280))
in (_91_281, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _91_283 = (let _91_282 = (subst_exp s e)
in Support.Microsoft.FStar.Util.Inr (_91_282))
in (_91_283, imp))
end))
...
in Support.Microsoft.FStar.Util.Inl (_91_297))
in (_91_298)::[])
end)
end
| (Support.Microsoft.FStar.Util.Inr (x), Support.Microsoft.FStar.Util.Inr (y)) -> begin
...
in Support.Microsoft.FStar.Util.Inr (_91_300))
in (_91_301)::[])
end)
end
| _25_485 -> begin
...
in (Support.List.append _91_312 out))
...
in (Support.All.pipe_right _91_366 Support.Prims.fst))
...
in (Support.All.pipe_left Support.Prims.fst _91_439))
...
in Support.Microsoft.FStar.Util.Inl (_91_520))
...
in Support.Microsoft.FStar.Util.Inr (_91_533))
...
in (Support.All.pipe_left Support.Prims.fst _91_544))
in Support.Microsoft.FStar.Util.Inl (_91_545))
end
...
in (Support.All.pipe_left Support.Prims.fst _91_567))
in Support.Microsoft.FStar.Util.Inr (_91_568))
end)
...
in (Support.All.pipe_left compress_typ _91_569))
in (_91_570, ctrl))
end
...
in (Support.All.pipe_left Support.Prims.fst _91_602))
...
in (Support.All.pipe_left compress_exp _91_669))
in (_91_670, ctrl))
end
...
in (Support.All.pipe_left Support.Prims.fst _91_699))
...
in (Support.All.pipe_left Support.Prims.fst _91_724)))
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
...
let mk_discriminator = (fun ( lid ) -> (let _91_736 = (let _91_735 = (let _91_734 = (Microsoft_FStar_Absyn_Syntax.mk_ident ((Support.Prims.strcat "is_" lid.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText), lid.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idRange))
in (_91_734)::[])
in (Support.List.append lid.Microsoft_FStar_Absyn_Syntax.ns _91_735))
...
let mangle_field_name = (fun ( x ) -> (Microsoft_FStar_Absyn_Syntax.mk_ident ((Support.Prims.strcat "^fname^" x.Microsoft_FStar_Absyn_Syntax.idText), x.Microsoft_FStar_Absyn_Syntax.idRange)))
...
| true -> begin
(let _91_862 = (let _91_861 = (Support.Microsoft.FStar.Util.substring_from x.Microsoft_FStar_Absyn_Syntax.idText 7)
...
| true -> begin
(let _91_868 = (let _91_867 = (let _91_866 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.Prims.strcat "_" _91_866))
...
in (_91_869)::[])
in (Support.List.append _91_871 _91_870)))
...
(let _91_878 = (let _91_877 = (let _91_876 = (Support.Microsoft.FStar.Unionfind.uvar_id uv)
in (Support.All.pipe_left Support.Microsoft.FStar.Util.string_of_int _91_876))
in (Support.Microsoft.FStar.Util.format1 "Changing a fixed uvar! U%s\n" _91_877))
in (Support.All.failwith _91_878))
end
| _25_1411 -> begin
...
let union_uvs = (fun ( uvs1 ) ( uvs2 ) -> (let _91_907 = (Support.Microsoft.FStar.Util.set_union uvs1.Microsoft_FStar_Absyn_Syntax.uvars_k uvs2.Microsoft_FStar_Absyn_Syntax.uvars_k)
in (let _91_906 = (Support.Microsoft.FStar.Util.set_union uvs1.Microsoft_FStar_Absyn_Syntax.uvars_t uvs2.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (let _91_905 = (Support.Microsoft.FStar.Util.set_union uvs1.Microsoft_FStar_Absyn_Syntax.uvars_e uvs2.Microsoft_FStar_Absyn_Syntax.uvars_e)
...
let union_fvs = (fun ( fvs1 ) ( fvs2 ) -> (let _91_913 = (Support.Microsoft.FStar.Util.set_union fvs1.Microsoft_FStar_Absyn_Syntax.ftvs fvs2.Microsoft_FStar_Absyn_Syntax.ftvs)
in (let _91_912 = (Support.Microsoft.FStar.Util.set_union fvs1.Microsoft_FStar_Absyn_Syntax.fxvs fvs2.Microsoft_FStar_Absyn_Syntax.fxvs)
...
in (let _91_939 = (Support.Microsoft.FStar.Util.set_difference fvs.Microsoft_FStar_Absyn_Syntax.ftvs tvars)
in (let _91_938 = (Support.Microsoft.FStar.Util.set_difference fvs.Microsoft_FStar_Absyn_Syntax.fxvs vvars)
...
in (Support.Microsoft.FStar.Util.set_add x _91_951)))

let single_uv = (fun ( u ) -> (let _91_959 = (Microsoft_FStar_Absyn_Syntax.new_uv_set ())
in (Support.Microsoft.FStar.Util.set_add u _91_959)))

let single_uvt = (fun ( u ) -> (let _91_967 = (Microsoft_FStar_Absyn_Syntax.new_uvt_set ())
in (Support.Microsoft.FStar.Util.set_add u _91_967)))
...
(let _91_1140 = (let _91_1139 = (let _91_1137 = (Support.Microsoft.FStar.Util.set_add a tvars)
in (_91_1137, vvars))
...
| ((tvars, vvars), vs2) -> begin
(let _91_1164 = (let _91_1163 = (let _91_1161 = (Support.Microsoft.FStar.Util.set_add x vvars)
in (tvars, _91_1161))
...
and vs_typ = (fun ( t ) ( uvonly ) ( cont ) -> (match ((let _91_1174 = (Support.ST.read t.Microsoft_FStar_Absyn_Syntax.fvs)
in (let _91_1173 = (Support.ST.read t.Microsoft_FStar_Absyn_Syntax.uvs)
...
(let _91_1179 = (let _91_1178 = (Support.Microsoft.FStar.Range.string_of_range k.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Microsoft.FStar.Util.format1 "%s: Impossible ... found a Kind_lam bare" _91_1178))
in (Support.All.failwith _91_1179))
end
...
in (let _91_1181 = (Support.Microsoft.FStar.Util.set_add uv uvs.Microsoft_FStar_Absyn_Syntax.uvars_k)
...
and vs_kind = (fun ( k ) ( uvonly ) ( cont ) -> (match ((let _91_1190 = (Support.ST.read k.Microsoft_FStar_Absyn_Syntax.fvs)
in (let _91_1189 = (Support.ST.read k.Microsoft_FStar_Absyn_Syntax.uvs)
...
and vs_exp = (fun ( e ) ( uvonly ) ( cont ) -> (match ((let _91_1209 = (Support.ST.read e.Microsoft_FStar_Absyn_Syntax.fvs)
in (let _91_1208 = (Support.ST.read e.Microsoft_FStar_Absyn_Syntax.uvs)
...
and vs_comp = (fun ( c ) ( uvonly ) ( cont ) -> (match ((let _91_1218 = (Support.ST.read c.Microsoft_FStar_Absyn_Syntax.fvs)
in (let _91_1217 = (Support.ST.read c.Microsoft_FStar_Absyn_Syntax.uvs)
...
in (Support.All.pipe_left (union_fvs out) _91_1241))
end
| Support.Microsoft.FStar.Util.Inr (e) -> begin
(let _91_1242 = (freevars_exp e)
in (Support.All.pipe_left (union_fvs out) _91_1242))
...
let rec update_uvars = (fun ( s ) ( uvs ) -> (let out = (let _91_1316 = (Support.Microsoft.FStar.Util.set_elements uvs.Microsoft_FStar_Absyn_Syntax.uvars_k)
in (Support.All.pipe_right _91_1316 (Support.List.fold_left (fun ( out ) ( u ) -> (match ((Support.Microsoft.FStar.Unionfind.find u)) with
| Microsoft_FStar_Absyn_Syntax.Fixed (k) -> begin
...
| _25_1911 -> begin
(let _25_1912 = out
in (let _91_1315 = (Support.Microsoft.FStar.Util.set_add u out.Microsoft_FStar_Absyn_Syntax.uvars_k)
...
in (let out = (let _91_1321 = (Support.Microsoft.FStar.Util.set_elements uvs.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (Support.All.pipe_right _91_1321 (Support.List.fold_left (fun ( out ) ( _25_1918 ) -> (match (_25_1918) with
| (u, t) -> begin
...
| _25_1922 -> begin
(let _25_1923 = out
in (let _91_1320 = (Support.Microsoft.FStar.Util.set_add (u, t) out.Microsoft_FStar_Absyn_Syntax.uvars_t)
...
in (let out = (let _91_1326 = (Support.Microsoft.FStar.Util.set_elements uvs.Microsoft_FStar_Absyn_Syntax.uvars_e)
in (Support.All.pipe_right _91_1326 (Support.List.fold_left (fun ( out ) ( _25_1929 ) -> (match (_25_1929) with
| (u, t) -> begin
(match ((Support.Microsoft.FStar.Unionfind.find u)) with
...
| _25_1933 -> begin
(let _25_1934 = out
in (let _91_1325 = (Support.Microsoft.FStar.Util.set_add (u, t) out.Microsoft_FStar_Absyn_Syntax.uvars_e)
...
let mk_tuple_lid = (fun ( n ) ( r ) -> (let t = (let _91_1372 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "Tuple%s" _91_1372))
in (let _91_1373 = (Microsoft_FStar_Absyn_Const.pconst t)
in (set_lid_range _91_1373 r))))

let mk_tuple_data_lid = (fun ( n ) ( r ) -> (let t = (let _91_1378 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "MkTuple%s" _91_1378))
...
let mk_dtuple_lid = (fun ( n ) ( r ) -> (let t = (let _91_1391 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "DTuple%s" _91_1391))
in (let _91_1392 = (Microsoft_FStar_Absyn_Const.pconst t)
in (set_lid_range _91_1392 r))))

let mk_dtuple_data_lid = (fun ( n ) ( r ) -> (let t = (let _91_1397 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "MkDTuple%s" _91_1397))
...
in (Support.String.compare _91_1428 _91_1427)))
end)))))
...
let b2t_v = (let _91_1432 = (let _91_1431 = (let _91_1430 = (let _91_1429 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.null_v_binder t_bool)
in (_91_1429)::[])
...
in (tand, _91_1440))
in (let _91_1441 = (Support.Microsoft.FStar.Range.union_ranges phi1.Microsoft_FStar_Absyn_Syntax.pos phi2.Microsoft_FStar_Absyn_Syntax.pos)
...
in (op_t, _91_1453))
in (let _91_1454 = (Support.Microsoft.FStar.Range.union_ranges phi1.Microsoft_FStar_Absyn_Syntax.pos phi2.Microsoft_FStar_Absyn_Syntax.pos)
...
let b2t = (fun ( e ) -> (let _91_1488 = (let _91_1487 = (let _91_1486 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg e)
in (_91_1486)::[])
in (b2t_v, _91_1487))
...
in ((Support.Microsoft.FStar.Util.Inl (b), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_91_1496)
in ((Support.Microsoft.FStar.Util.Inl (a), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_91_1497)
...
in (teq, _91_1515))
in (let _91_1516 = (Support.Microsoft.FStar.Range.union_ranges e1.Microsoft_FStar_Absyn_Syntax.pos e2.Microsoft_FStar_Absyn_Syntax.pos)
...
in (eq_typ, _91_1525))
in (let _91_1526 = (Support.Microsoft.FStar.Range.union_ranges t1.Microsoft_FStar_Absyn_Syntax.pos t2.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.null_t_binder _91_1542))
in (_91_1543)::[])
in ((Support.Microsoft.FStar.Util.Inl (a), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_91_1544)
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.null_t_binder _91_1552))
in (_91_1553)::[])
...
let eqT_k = (fun ( k ) -> (let _91_1562 = (let _91_1561 = (let _91_1560 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.null_t_binder k)
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _91_1573))
in (_91_1574)::[])
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _91_1585))
in (_91_1586)::[])
in (tforall, _91_1587))
...
in (_91_1599)::[])
in ((Support.Microsoft.FStar.Util.Inl (x.Microsoft_FStar_Absyn_Syntax.sort), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_91_1600)
in (tforall, _91_1601))
...
| (t, args) -> begin
(let _91_1681 = (Support.All.pipe_right args (Support.List.map (fun ( _25_26 ) -> (match (_25_26) with
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _91_1678 = (let _91_1677 = (compress_typ t)
in Support.Microsoft.FStar.Util.Inl (_91_1677))
in (_91_1678, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _91_1680 = (let _91_1679 = (compress_exp e)
in Support.Microsoft.FStar.Util.Inr (_91_1679))
in (_91_1680, imp))
end))))
in (t, _91_1681))
end)))
