          ...
          let uu____192 =
            ...
            then ""
              ...
              (let uu____194 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____194)
             in
          (uu____190, uu____192)
       in
  ...
  fun i1  ->
    fun i2  ->
      ...
      | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some
         uu____211) -> ~- (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____214,FStar_Pervasives_Native.None
         ) -> (Prims.parse_int "1")
...
let default_handler : error_handler =
  ...
  let add_one e =
    ...
    | EError  ->
        let uu____230 = let uu____232 = FStar_ST.read errs  in e :: uu____232
           in
...
let report_all : Prims.unit -> issue Prims.list =
  fun uu____321  ->
    let uu____322 =
      let uu____326 = FStar_ST.read current_handler  in uu____326.eh_report
       in
    uu____322 ()
...
let clear : Prims.unit -> Prims.unit =
  fun uu____331  ->
    let uu____332 =
      let uu____335 = FStar_ST.read current_handler  in uu____335.eh_clear
       in
    uu____332 ()
  ...
  fun uu___59_465  ->
    ...
    | Error (msg,r) ->
        let uu____469 =
          ...
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____470  in
        FStar_Pervasives_Native.Some uu____469
    | FStar_Util.NYI msg ->
        let uu____472 =
          let uu____473 = message_prefix.append_prefix msg  in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____473  in
        FStar_Pervasives_Native.Some uu____472
    | Err msg ->
        let uu____475 =
          let uu____476 = message_prefix.append_prefix msg  in
          mk_issue EError FStar_Pervasives_Native.None uu____476  in
