...
let (uu___is_Warning_NoPatternInferred : raw_error -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | Warning_NoPatternInferred  -> true
    | uu____3572 -> false
...
let (default_flags : (raw_error * FStar_Options.error_flag) Prims.list) =
  ...
  (Warning_NoPatternInferred, FStar_Options.CWarning)] 
