...
let uu____309 = (match ((Prims.op_Equality r.FStar_Range.use_range r.FStar_Range.def_range)) with
| true -> begin
""
end
| uu____310 -> begin
...
let count_errors = (fun uu____500 -> (

let uu____501 = (FStar_ST.op_Bang errs)
in (FStar_List.length uu____501)))
in (

let report = (fun uu____573 -> (

let sorted1 = (

let uu____577 = (FStar_ST.op_Bang errs)
in (FStar_List.sortWith compare_issues uu____577))
in ((FStar_List.iter print_issue sorted1);
sorted1;
)))
in (

let clear1 = (fun uu____648 -> (FStar_ST.op_Colon_Equals errs []))
...
let get_err_count : Prims.unit  ->  Prims.int = (fun uu____745 -> (

let uu____746 = (

let uu____749 = (FStar_ST.op_Bang current_handler)
in uu____749.eh_count_errors)
in (uu____746 ())))


let add_one : issue  ->  Prims.unit = (fun issue -> (FStar_Util.atomically (fun uu____802 -> (

let uu____803 = (

let uu____806 = (FStar_ST.op_Bang current_handler)
in uu____806.eh_add_one)
in (uu____803 issue)))))


let add_many : issue Prims.list  ->  Prims.unit = (fun issues -> (FStar_Util.atomically (fun uu____863 -> (

let uu____864 = (

let uu____867 = (FStar_ST.op_Bang current_handler)
in uu____867.eh_add_one)
in (FStar_List.iter uu____864 issues)))))


let report_all : Prims.unit  ->  issue Prims.list = (fun uu____919 -> (

let uu____920 = (

let uu____925 = (FStar_ST.op_Bang current_handler)
in uu____925.eh_report)
in (uu____920 ())))


let clear : Prims.unit  ->  Prims.unit = (fun uu____975 -> (

let uu____976 = (

let uu____979 = (FStar_ST.op_Bang current_handler)
in uu____979.eh_clear)
in (uu____976 ())))
...
let uu____1089 = (FStar_Options.debug_any ())
...
let clear_prefix = (fun uu____1263 -> (FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None))
in (

let append_prefix = (fun s -> (

let uu____1332 = (FStar_ST.op_Bang pfx)
...
let add_errors : (Prims.string * FStar_Range.range) Prims.list  ->  Prims.unit = (fun errs -> (FStar_Util.atomically (fun uu____1417 -> (FStar_List.iter (fun uu____1426 -> (match (uu____1426) with
| (msg, r) -> begin
(

let uu____1433 = (message_prefix.append_prefix msg)
in (err r uu____1433))
end)) errs))))


let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___59_1439 -> (match (uu___59_1439) with
| Error (msg, r) -> begin
(

let uu____1444 = (

let uu____1445 = (message_prefix.append_prefix msg)
in (mk_issue EError (FStar_Pervasives_Native.Some (r)) uu____1445))
in FStar_Pervasives_Native.Some (uu____1444))
end
...
let uu____1448 = (message_prefix.append_prefix msg)
in (mk_issue ENotImplemented FStar_Pervasives_Native.None uu____1448))
in FStar_Pervasives_Native.Some (uu____1447))
end
| Err (msg) -> begin
(
...
let uu____1451 = (message_prefix.append_prefix msg)
in (mk_issue EError FStar_Pervasives_Native.None uu____1451))
in FStar_Pervasives_Native.Some (uu____1450))
end
| uu____1452 -> begin
...
let uu____1457 = (issue_of_exn exn)
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___60_1464 -> (match (uu___60_1464) with
| Error (uu____1465) -> begin
true
end
| FStar_Util.NYI (uu____1470) -> begin
true
end
| Err (uu____1471) -> begin
true
end
| uu____1472 -> begin
false
