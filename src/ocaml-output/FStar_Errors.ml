...
let default_handler: error_handler =
  ...
  let add_one e =
    ...
    | uu____2857 -> print_issue e in
  let count_errors uu____2861 =
    let uu____2862 = FStar_ST.op_Bang errs in FStar_List.length uu____2862 in
  let report uu____2936 =
    let sorted1 =
      let uu____2940 = FStar_ST.op_Bang errs in
      FStar_List.sortWith compare_issues uu____2940 in
    FStar_List.iter print_issue sorted1; sorted1 in
  let clear1 uu____3013 = FStar_ST.op_Colon_Equals errs [] in
  {
    eh_add_one = add_one;
...
let add_one: issue -> Prims.unit =
  fun issue  ->
    FStar_Util.atomically
      (fun uu____3173  ->
         let uu____3174 =
           let uu____3177 = FStar_ST.op_Bang current_handler in
           uu____3177.eh_add_one in
         uu____3174 issue)
let add_many: issue Prims.list -> Prims.unit =
  fun issues  ->
    FStar_Util.atomically
      (fun uu____3235  ->
         let uu____3236 =
           let uu____3239 = FStar_ST.op_Bang current_handler in
           uu____3239.eh_add_one in
         FStar_List.iter uu____3236 issues)
let report_all: Prims.unit -> issue Prims.list =
  fun uu____3292  ->
    let uu____3293 =
      let uu____3298 = FStar_ST.op_Bang current_handler in
      uu____3298.eh_report in
    uu____3293 ()
let clear: Prims.unit -> Prims.unit =
  fun uu____3349  ->
    let uu____3350 =
      let uu____3353 = FStar_ST.op_Bang current_handler in
      uu____3353.eh_clear in
    uu____3350 ()
...
let message_prefix: error_message_prefix =
  ...
  let clear_prefix uu____3610 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None in
  let append_prefix s =
    let uu____3681 = FStar_ST.op_Bang pfx in
...
let findIndex:
  'Auu____3755 'Auu____3756 .
    ('Auu____3756,'Auu____3755) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____3756 -> Prims.int
  =
  fun l  ->
    fun v1  ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___38_3790  ->
              match uu___38_3790 with
              | (e,uu____3796) when e = v1 -> true
              | uu____3797 -> false))
...
let init_warn_error_flags: Prims.unit =
  ...
  let uu____3862 = aux [] default_flags in
  FStar_ST.op_Colon_Equals flags uu____3862
let diag: FStar_Range.range -> Prims.string -> Prims.unit =
  fun r  ->
    fun msg  ->
      let uu____3923 = FStar_Options.debug_any () in
      if uu____3923
      then
        add_one
  ...
  fun r  ->
    fun uu____3934  ->
      ...
      | (e,msg) ->
          ...
          let uu____3942 =
            let uu____3943 = FStar_ST.op_Bang flags in
            FStar_List.nth uu____3943 errno in
          (match uu____3942 with
           ...
           | CFatal  ->
               ...
               let uu____3999 = FStar_Options.ide () in
               if uu____3999
               then add_one i
               else
                 (let uu____4001 =
                    let uu____4002 = format_issue i in
                    Prims.strcat
      ...
      (fun uu____4023  ->
         FStar_List.iter
           (fun uu____4035  ->
              ...
              | (e,msg,r) ->
                  let uu____4045 =
                    let uu____4050 = message_prefix.append_prefix msg in
                    (e, uu____4050) in
                  log_issue r uu____4045) errs)
let issue_of_exn: Prims.exn -> issue FStar_Pervasives_Native.option =
  fun uu___39_4055  ->
    match uu___39_4055 with
    | Error (e,msg,r) ->
        let errno = errno_of_error e in
        let uu____4062 =
          let uu____4063 = message_prefix.append_prefix msg in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____4063
            (FStar_Pervasives_Native.Some errno) in
        FStar_Pervasives_Native.Some uu____4062
    | FStar_Util.NYI msg ->
        let uu____4065 =
          let uu____4066 = message_prefix.append_prefix msg in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____4066
    ...
    | Err (e,msg) ->
        ...
        let uu____4070 =
          ...
          mk_issue EError FStar_Pervasives_Native.None uu____4071
            (FStar_Pervasives_Native.Some errno) in
...
let err_exn: Prims.exn -> Prims.unit =
  fun exn  ->
    ...
    then ()
      ...
      (let uu____4077 = issue_of_exn exn in
...
let handleable: Prims.exn -> Prims.bool =
  fun uu___40_4083  ->
    match uu___40_4083 with
    | Error uu____4084 -> true
    | FStar_Util.NYI uu____4091 -> true
    | Stop  -> true
    | Err uu____4092 -> true
    | uu____4097 -> false
let stop_if_err: Prims.unit -> Prims.unit =
  fun uu____4100  ->
    let uu____4101 =
      let uu____4102 = get_err_count () in uu____4102 > (Prims.parse_int "0") in
    if uu____4101 then FStar_Exn.raise Stop else ()
let raise_error:
  'Auu____4107 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____4107
  =
  fun uu____4118  ->
    fun r  ->
      match uu____4118 with | (e,msg) -> FStar_Exn.raise (Error (e, msg, r))
let raise_err:
  'Auu____4128 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____4128
  =
  fun uu____4136  ->
    match uu____4136 with | (e,msg) -> FStar_Exn.raise (Err (e, msg))
let update_flags:
  (flag,Prims.string) FStar_Pervasives_Native.tuple2 Prims.list -> Prims.unit
  =
  fun l  ->
    let compare1 uu____4179 uu____4180 =
      match (uu____4179, uu____4180) with
      | ((uu____4213,(a,uu____4215)),(uu____4216,(b,uu____4218))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____4286 = FStar_ST.op_Bang flags in
        FStar_List.nth uu____4286 i in
      match l1 with
      | [] -> d
      | (f,(l2,h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____4426 =
            let uu____4429 =
              let uu____4432 = set_flag i sorted1 in [uu____4432] in
            FStar_List.append f uu____4429 in
          aux uu____4426 (i + (Prims.parse_int "1")) tl1 sorted1 in
    let rec compute_range result l1 =
      ...
      | (f,s)::tl1 ->
          ...
          let uu____4512 =
            match r with
            | r1::r2::[] ->
                let uu____4523 = FStar_Util.int_of_string r1 in
                let uu____4524 = FStar_Util.int_of_string r2 in
                (uu____4523, uu____4524)
            | uu____4525 ->
                let uu____4528 =
                  let uu____4533 =
                    FStar_Util.format1 "Malformed warn-error range %s" s in
                  (Fatal_InvalidWarnErrorSetting, uu____4533) in
                raise_err uu____4528 in
           ...
           | (l2,h) ->
               (if
                ...
                then
                  (let uu____4555 =
                     let uu____4560 =
                       let uu____4561 = FStar_Util.string_of_int l2 in
                       let uu____4562 = FStar_Util.string_of_int h in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____4561 uu____4562 in
                     (Fatal_InvalidWarnErrorSetting, uu____4560) in
                   raise_err uu____4555)
                else ();
    ...
    let uu____4630 =
      let uu____4633 = FStar_ST.op_Bang flags in
      aux [] (Prims.parse_int "0") uu____4633 sorted1 in
    FStar_ST.op_Colon_Equals flags uu____4630