...
| true -> begin
(FStar_Util.print_string (let _0_119 = (FStar_Range.string_of_range r)
...
let warn : FStar_Range.range  ->  Prims.string  ->  Prims.unit = (fun r msg -> (let _0_120 = (FStar_Range.string_of_range r)
...
| (msg, r) -> begin
(let _0_121 = (message_prefix.append_prefix msg)
in ((r), (_0_121)))
end))))
in (

let n_errs = (FStar_List.length errs)
in (FStar_Util.atomically (fun uu____196 -> ((let _0_123 = (let _0_122 = (FStar_ST.read verification_errs)
in (FStar_List.append errs _0_122))
in (FStar_ST.write verification_errs _0_123));
(let _0_125 = (let _0_124 = (FStar_ST.read num_errs)
in (_0_124 + n_errs))
in (FStar_ST.write num_errs _0_125));
))))))
...
| true -> begin
(let _0_127 = (FStar_Range.string_of_use_range r)
in (let _0_126 = (FStar_Range.string_of_range r)
in (FStar_Util.format3 "%s: (Error) %s (see %s)\n" _0_127 msg _0_126)))
end
| uu____222 -> begin
(let _0_128 = (FStar_Range.string_of_range r)
