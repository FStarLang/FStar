...
let uu___is_Error_InvalidUniverseVar : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Error_InvalidUniverseVar -> true | uu____20 -> false
...
let uu___is_Error_UnexpectedInstance : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Error_UnexpectedInstance -> true | uu____64 -> false
...
let uu___is_Error_Z3InvocationError : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Error_Z3InvocationError -> true | uu____72 -> false
...
let uu___is_Fatal_AssertionFailure : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_AssertionFailure -> true | uu____100 -> false
...
let uu___is_Fatal_BadSignatureShape : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_BadSignatureShape -> true | uu____116 -> false
...
let uu___is_Fatal_DefaultQualifierNotAllowedOnEffects : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with
...
let uu___is_Fatal_EffectfulAndPureComputationMismatch : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with
...
let uu___is_Fatal_IncompatibleKinds : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_IncompatibleKinds -> true | uu____352 -> false
...
let uu___is_Fatal_InvalidIdentifier : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_InvalidIdentifier -> true | uu____412 -> false
...
let uu___is_Fatal_LetOpenModuleOnly : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_LetOpenModuleOnly -> true | uu____448 -> false
...
let uu___is_Fatal_MissingInterface : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_MissingInterface -> true | uu____488 -> false
...
let uu___is_Fatal_NameSpaceNotFound : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_NameSpaceNotFound -> true | uu____540 -> false
...
let uu___is_Fatal_NotTopLevelModule : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_NotTopLevelModule -> true | uu____604 -> false


let uu___is_Fatal_NotValidFStarFile : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_NotValidFStarFile -> true | uu____608 -> false
...
let uu___is_Fatal_OneModulePerFile : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_OneModulePerFile -> true | uu____616 -> false
...
let uu___is_Fatal_PolyTypeExpected : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_PolyTypeExpected -> true | uu____640 -> false
...
let uu___is_Fatal_PreModuleMismatch : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_PreModuleMismatch -> true | uu____648 -> false
...
let uu___is_Fatal_UnableToReadFile : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnableToReadFile -> true | uu____720 -> false
...
let uu___is_Fatal_UnexpectedBinder : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnexpectedBinder -> true | uu____728 -> false
...
let uu___is_Fatal_UnexpectedEffect : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnexpectedEffect -> true | uu____752 -> false
...
let uu___is_Fatal_UnexpectedPattern : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnexpectedPattern -> true | uu____816 -> false
...
let uu___is_Fatal_UnexpectedUniversePolymorphicReturn : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with
...
let uu___is_Fatal_UnknownAttribute : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnknownAttribute -> true | uu____884 -> false


let uu___is_Fatal_UnknownToolForDep : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UnknownToolForDep -> true | uu____888 -> false
...
let uu___is_Fatal_UserTacticFailure : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_UserTacticFailure -> true | uu____912 -> false


let uu___is_Fatal_ValueRestriction : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_ValueRestriction -> true | uu____916 -> false


let uu___is_Fatal_VariableNotFound : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Fatal_VariableNotFound -> true | uu____920 -> false
...
let uu___is_Warning_DependencyFound : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Warning_DependencyFound -> true | uu____968 -> false
...
let uu___is_Warning_FileNotWritten : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Warning_FileNotWritten -> true | uu____984 -> false
...
let uu___is_Warning_IllFormedGoal : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Warning_IllFormedGoal -> true | uu____1012 -> false
...
let uu___is_Warning_TopLevelEffect : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Warning_TopLevelEffect -> true | uu____1084 -> false
...
let uu___is_Warning_UnexpectedFile : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with Warning_UnexpectedFile -> true | uu____1092 -> false
...
let uu___is_Warning_UpperBoundCandidateAlreadyVisited : raw_error -> Prims.bool =
  fun projectee ->
    match projectee with
...
type flag = CError | CFatal | CWarning | CSilent [@@deriving show]

let uu___is_CError : flag -> Prims.bool =
  fun projectee -> match projectee with CError -> true | uu____1156 -> false


let uu___is_CFatal : flag -> Prims.bool =
  fun projectee -> match projectee with CFatal -> true | uu____1160 -> false
...
let uu___is_CSilent : flag -> Prims.bool =
  fun projectee -> match projectee with CSilent -> true | uu____1168 -> false
...
let uu___is_Stop : Prims.exn -> Prims.bool =
  fun projectee -> match projectee with Stop -> true | uu____2455 -> false
...
let uu___is_EInfo : issue_level -> Prims.bool =
  fun projectee -> match projectee with EInfo -> true | uu____2467 -> false
...
let uu___is_EError : issue_level -> Prims.bool =
  fun projectee -> match projectee with EError -> true | uu____2475 -> false
...
let __proj__Mkissue__item__issue_message : issue -> Prims.string =
  fun projectee ->
    ...
    | { issue_message= __fname__issue_message
      ...
      ; issue_number= __fname__issue_number; _ }
...
let __proj__Mkerror_handler__item__eh_add_one
  ...
  fun projectee ->
    ...
    | { eh_add_one= __fname__eh_add_one
      ...
      ; eh_report= __fname__eh_report
      ; eh_clear= __fname__eh_clear; _ }
    -> __fname__eh_add_one
...
let format_issue : issue -> Prims.string =
  fun issue ->
    ...
    let uu____2674 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____2684 =
            ...
            FStar_Util.format1 "%s: " uu____2685
          in
          let uu____2686 =
            let uu____2687 =
    ...
    in
    match uu____2674 with range_str, see_also_str ->
      let issue_number =
      ...
      in
      FStar_Util.format5 "%s(%s%s) %s%s\n" range_str level_header issue_number
...
let print_issue : issue -> Prims.unit =
  fun issue ->
    let printer =
      ...
      | ENotImplemented -> FStar_Util.print_error
    in
    let uu____2705 = format_issue issue in
    printer uu____2705
...
let compare_issues : issue -> issue -> Prims.int =
  fun i1 i2 ->
    ...
    | FStar_Pervasives_Native.None, FStar_Pervasives_Native.None ->
        Prims.parse_int "0"
    | FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some uu____2720 ->
        -Prims.parse_int "1"
...
let default_handler : error_handler =
  ...
  let add_one e =
    ...
    | EError ->
        let uu____2747 =
          let uu____2750 = FStar_ST.op_Bang errs in
          e :: uu____2750
        in
        FStar_ST.op_Colon_Equals errs uu____2747
    | uu____2843 -> print_issue e
  in
  let count_errors uu____2847 =
    let uu____2848 = FStar_ST.op_Bang errs in
    FStar_List.length uu____2848
  in
  let report uu____2901 =
    let sorted1 =
      let uu____2905 = FStar_ST.op_Bang errs in
      FStar_List.sortWith compare_issues uu____2905
    in
...
let mk_issue
    : issue_level -> FStar_Range.range FStar_Pervasives_Native.option
      -> Prims.string -> Prims.int FStar_Pervasives_Native.option -> issue =
  fun level range msg n1 ->
    { issue_message= msg
    ; issue_level= level
    ; issue_range= range
    ; issue_number= n1 }
...
let add_one : issue -> Prims.unit =
  fun issue ->
    FStar_Util.atomically (fun uu____3071 ->
        let uu____3072 =
          let uu____3075 = FStar_ST.op_Bang current_handler in
          uu____3075.eh_add_one
        in
        uu____3072 issue )
...
let add_many : issue Prims.list -> Prims.unit =
  fun issues ->
    FStar_Util.atomically (fun uu____3104 ->
        let uu____3105 =
          let uu____3108 = FStar_ST.op_Bang current_handler in
          uu____3108.eh_add_one
        in
...
let __proj__Mkerror_message_prefix__item__set_prefix
  ...
  fun projectee ->
    ...
    | { set_prefix= __fname__set_prefix
      ...
      ; clear_prefix= __fname__clear_prefix; _ }
    -> __fname__set_prefix
...
let message_prefix : error_message_prefix =
  ...
  let set_prefix s =
    FStar_ST.op_Colon_Equals pfx (FStar_Pervasives_Native.Some s)
  in
  let clear_prefix uu____3342 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None
  in
  let append_prefix s =
...
let findIndex:
  ...
  fun l v1 ->
    FStar_All.pipe_right l
      (FStar_List.index (fun uu___26_3480 ->
...
let add_errors
  ...
  fun errs ->
    FStar_Util.atomically (fun uu____3659 ->
        FStar_List.iter
          (fun uu____3671 ->
            match uu____3671 with e, msg, r ->
              let uu____3681 =
                let uu____3686 = message_prefix.append_prefix msg in
                (e, uu____3686)
              in
              log_issue r uu____3681 )
          errs )
...
let stop_if_err : Prims.unit -> Prims.unit =
  fun uu____3736 ->
    let uu____3737 =
      ...
      uu____3738 > Prims.parse_int "0"
    in
    if uu____3737 then FStar_Exn.raise Stop else ()


let raise_error:
      'Auu____3743. (raw_error, Prims.string) FStar_Pervasives_Native.tuple2
...
let raise_err:
      'Auu____3764. (raw_error, Prims.string) FStar_Pervasives_Native.tuple2
      -> 'Auu____3764 =
  fun uu____3772 ->
...
let update_flags
  ...
  fun l ->
    let compare1 uu____3815 uu____3816 =
      match (uu____3815, uu____3816)
      with (uu____3849, (a, uu____3851)), (uu____3852, (b, uu____3854)) ->
        if a > b then Prims.parse_int "1"
        else if a < b then -Prims.parse_int "1"
    ...
    let set_one_flag f d =
      ...
      | CWarning, CError ->
          raise_err
            (Fatal_InvalidWarnErrorSetting, "cannot turn an error into warning")
      | CSilent, CError ->
    ...
    let rec set_flag i l1 =
      let d =
        ...
        FStar_List.nth uu____3922 i
      in
      match l1 with
      | [] -> d
      | (f, (l2, h)) :: tl1 ->
          if i >= l2 && i <= h then set_one_flag f d
          else if i < l2 then d
          else set_flag i tl1
    in
    let rec aux f i l1 sorted1 =
      ...
      | hd1 :: tl1 ->
          let uu____4033 =
            let uu____4036 =
              let uu____4039 = set_flag i sorted1 in
              [uu____4039]
            in
            FStar_List.append f uu____4036
          in
          ...
          let uu____4119 =
            ...
            | uu____4132 ->
                let uu____4135 =
                  ...
                  in
                  (Fatal_InvalidWarnErrorSetting, uu____4140)
                in
                raise_err uu____4135
          in
          match uu____4119 with l2, h ->
            if l2 < Prims.parse_int "0" || h >= FStar_List.length default_flags
            then
              let uu____4162 =
                let uu____4167 =
                ...
                in
                (Fatal_InvalidWarnErrorSetting, uu____4167)
              in
    ...
    let uu____4237 =
      ...
      aux [] (Prims.parse_int "0") uu____4240 sorted1
    in
