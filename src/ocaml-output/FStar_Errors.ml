  ...
  fun i1  ->
    fun i2  ->
      ...
      | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some
         uu____197) -> - (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____200,FStar_Pervasives_Native.None
         ) -> Prims.parse_int "1"
  ...
  fun uu___59_445  ->
    ...
    | Error (msg,r) ->
        let uu____449 =
          ...
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____450 in
        FStar_Pervasives_Native.Some uu____449
    | FStar_Util.NYI msg ->
        let uu____452 =
          let uu____453 = message_prefix.append_prefix msg in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____453 in
        FStar_Pervasives_Native.Some uu____452
    | Err msg ->
        let uu____455 =
          let uu____456 = message_prefix.append_prefix msg in
          mk_issue EError FStar_Pervasives_Native.None uu____456 in
        FStar_Pervasives_Native.Some uu____455
