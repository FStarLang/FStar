...
let uu____3481 = (match (issue.issue_range) with
...
let uu____3492 = (FStar_Range.string_of_use_range r)
in (FStar_Util.format1 "%s: " uu____3492))
in (
...
let uu____3495 = (FStar_Range.use_range r)
in (

let uu____3496 = (FStar_Range.def_range r)
in (Prims.op_Equality uu____3495 uu____3496)))
...
let uu____3498 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 " (see also %s)" uu____3498))
end))
...
let uu____3503 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 " %s" uu____3503))
end)
...
let uu____3517 = (format_issue issue)
in (printer uu____3517))))
...
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some (uu____3536)) -> begin
(~- ((Prims.parse_int "1")))
end
| (FStar_Pervasives_Native.Some (uu____3541), FStar_Pervasives_Native.None) -> begin
(Prims.parse_int "1")
end
...
let uu____3568 = (FStar_ST.op_Bang errs)
in (e)::uu____3568)
in (FStar_ST.op_Colon_Equals errs uu____3565))
end
| uu____3669 -> begin
(print_issue e)
end))
...
let count_errors = (fun uu____3675 -> (

let uu____3676 = (FStar_ST.op_Bang errs)
in (FStar_List.length uu____3676)))
in (

let report = (fun uu____3735 -> (

let sorted1 = (

let uu____3739 = (FStar_ST.op_Bang errs)
in (FStar_List.sortWith compare_issues uu____3739))
in ((FStar_List.iter print_issue sorted1);
sorted1;
)))
in (

let clear1 = (fun uu____3797 -> (FStar_ST.op_Colon_Equals errs []))
...
let get_err_count : unit  ->  Prims.int = (fun uu____3896 -> (

let uu____3897 = (

let uu____3902 = (FStar_ST.op_Bang current_handler)
in uu____3902.eh_count_errors)
in (uu____3897 ())))


let add_one : issue  ->  unit = (fun issue -> (FStar_Util.atomically (fun uu____3933 -> (

let uu____3934 = (

let uu____3939 = (FStar_ST.op_Bang current_handler)
in uu____3939.eh_add_one)
in (uu____3934 issue)))))


let add_many : issue Prims.list  ->  unit = (fun issues -> (FStar_Util.atomically (fun uu____3974 -> (

let uu____3975 = (

let uu____3980 = (FStar_ST.op_Bang current_handler)
in uu____3980.eh_add_one)
in (FStar_List.iter uu____3975 issues)))))


let report_all : unit  ->  issue Prims.list = (fun uu____4010 -> (

let uu____4011 = (

let uu____4018 = (FStar_ST.op_Bang current_handler)
in uu____4018.eh_report)
in (uu____4011 ())))


let clear : unit  ->  unit = (fun uu____4046 -> (

let uu____4047 = (

let uu____4052 = (FStar_ST.op_Bang current_handler)
in uu____4052.eh_clear)
in (uu____4047 ())))
...
let clear_prefix = (fun uu____4278 -> (FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None))
in (

let append_prefix = (fun s -> (

let uu____4334 = (FStar_ST.op_Bang pfx)
...
let findIndex : 'Auu____4395 'Auu____4396 . ('Auu____4395 * 'Auu____4396) Prims.list  ->  'Auu____4395  ->  Prims.int = (fun l v1 -> (FStar_All.pipe_right l (FStar_List.index (fun uu___28_4432 -> (match (uu___28_4432) with
| (e, uu____4438) when (Prims.op_Equality e v1) -> begin
true
end
| uu____4439 -> begin
false
...
let uu____4514 = (aux [] default_flags)
in (FStar_ST.op_Colon_Equals flags uu____4514)))


let diag : FStar_Range.range  ->  Prims.string  ->  unit = (fun r msg -> (

let uu____4554 = (FStar_Options.debug_any ())
...
let uu____4570 = ((Prims.op_Equality errno defensive_errno) && (FStar_Options.defensive_fail ()))
...
let log_issue : FStar_Range.range  ->  (raw_error * Prims.string)  ->  unit = (fun r uu____4585 -> (match (uu____4585) with
| (e, msg) -> begin
(
...
let uu____4594 = (FStar_ST.op_Bang flags)
in (lookup uu____4594 errno))
...
let uu____4625 = (FStar_Options.ide ())
...
let uu____4628 = (format_issue i)
in (Prims.strcat "don\'t use log_issue to report fatal error, should use raise_error: " uu____4628))
...
let add_errors : (raw_error * Prims.string * FStar_Range.range) Prims.list  ->  unit = (fun errs -> (FStar_Util.atomically (fun uu____4651 -> (FStar_List.iter (fun uu____4663 -> (match (uu____4663) with
| (e, msg, r) -> begin
(

let uu____4673 = (

let uu____4678 = (message_prefix.append_prefix msg)
in ((e), (uu____4678)))
in (log_issue r uu____4673))
end)) errs))))


let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___29_4685 -> (match (uu___29_4685) with
| Error (e, msg, r) -> begin
(
...
let uu____4693 = (message_prefix.append_prefix msg)
in (mk_issue EError (FStar_Pervasives_Native.Some (r)) uu____4693 (FStar_Pervasives_Native.Some (errno))))
...
let uu____4696 = (message_prefix.append_prefix msg)
in (mk_issue ENotImplemented FStar_Pervasives_Native.None uu____4696 FStar_Pervasives_Native.None))
...
let uu____4701 = (message_prefix.append_prefix msg)
in (mk_issue EError FStar_Pervasives_Native.None uu____4701 (FStar_Pervasives_Native.Some (errno))))
...
let uu____4709 = (issue_of_exn exn)
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___30_4717 -> (match (uu___30_4717) with
| Error (uu____4718) -> begin
true
end
| FStar_Util.NYI (uu____4725) -> begin
true
end
| Stop -> begin
true
end
| Err (uu____4726) -> begin
true
end
| uu____4731 -> begin
false
...
let stop_if_err : unit  ->  unit = (fun uu____4736 -> (

let uu____4737 = (

let uu____4738 = (get_err_count ())
in (uu____4738 > (Prims.parse_int "0")))
...
let raise_error : 'Auu____4746 . (raw_error * Prims.string)  ->  FStar_Range.range  ->  'Auu____4746 = (fun uu____4759 r -> (match (uu____4759) with
| (e, msg) -> begin
(FStar_Exn.raise (Error (((e), (msg), (r)))))
end))


let raise_err : 'Auu____4771 . (raw_error * Prims.string)  ->  'Auu____4771 = (fun uu____4780 -> (match (uu____4780) with
| (e, msg) -> begin
...
let compare1 = (fun uu____4829 uu____4830 -> (match (((uu____4829), (uu____4830))) with
| ((uu____4863, (a, uu____4865)), (uu____4866, (b, uu____4868))) -> begin
(match ((a > b)) with
| true -> begin
(Prims.parse_int "1")
end
...
let uu____4944 = (FStar_ST.op_Bang flags)
in (FStar_List.nth uu____4944 i))
in (match (l1) with
| [] -> begin
d
end
...
let uu____5073 = (set_flag i sorted1)
in (uu____5073)::[])
in (FStar_List.append f uu____5070))
in (aux uu____5067 (i + (Prims.parse_int "1")) tl1 sorted1))
end))
in (
...
let uu____5157 = (match (r) with
| (r1)::(r2)::[] -> begin
(

let uu____5168 = (FStar_Util.int_of_string r1)
in (

let uu____5169 = (FStar_Util.int_of_string r2)
in ((uu____5168), (uu____5169))))
end
| uu____5170 -> begin
(
...
let uu____5178 = (FStar_Util.format1 "Malformed warn-error range %s" s)
in ((Fatal_InvalidWarnErrorSetting), (uu____5178)))
in (raise_err uu____5173))
end)
...
let uu____5206 = (FStar_Util.string_of_int l2)
in (

let uu____5207 = (FStar_Util.string_of_int h)
in (FStar_Util.format2 "No error for warn_error %s..%s" uu____5206 uu____5207)))
in ((Fatal_InvalidWarnErrorSetting), (uu____5205)))
in (raise_err uu____5200))
end
| uu____5208 -> begin
()
end);
...
let uu____5278 = (FStar_ST.op_Bang flags)
in (aux [] (Prims.parse_int "0") uu____5278 sorted1))
in (FStar_ST.op_Colon_Equals flags uu____5275))))))))))
