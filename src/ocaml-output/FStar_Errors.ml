          ...
          let uu____272 =
            ...
            then ""
              ...
              (let uu____274 = FStar_Range.string_of_range r in
               FStar_Util.format1 " (see also %s)" uu____274) in
          (uu____270, uu____272) in
...
let default_handler: error_handler =
  ...
  let add_one e =
    ...
    | EError  ->
        let uu____313 = let uu____315 = FStar_ST.read errs in e :: uu____315 in
...
let report_all: Prims.unit -> issue Prims.list =
  fun uu____414  ->
    let uu____415 =
      let uu____419 = FStar_ST.read current_handler in uu____419.eh_report in
    uu____415 ()
let clear: Prims.unit -> Prims.unit =
  fun uu____425  ->
    let uu____426 =
      let uu____429 = FStar_ST.read current_handler in uu____429.eh_clear in
    uu____426 ()
