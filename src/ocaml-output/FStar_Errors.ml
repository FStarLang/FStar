...
let (uu___is_Warning_UnusedLetRec : raw_error -> Prims.bool) =
  fun projectee ->
    match projectee with | Warning_UnusedLetRec -> true | uu____3627 -> false
...
let (uu___is_Stop : Prims.exn -> Prims.bool) =
  fun projectee -> match projectee with | Stop -> true | uu____5066 -> false
...
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee -> match projectee with | EInfo -> true | uu____5099 -> false
          ...
          let uu____5444 =
            ...
            then ""
              ...
              (let uu____5455 = FStar_Range.string_of_range r in
               FStar_Util.format1 " (see also %s)" uu____5455) in
          (uu____5439, uu____5444) in
    ...
    | (range_str, see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              ...
              FStar_Util.format1 " %s" uu____5475 in
...
let (mk_default_handler : Prims.bool -> error_handler) =
  fun print7 ->
    ...
    let count_errors uu____5616 =
      let uu____5617 = FStar_ST.op_Bang errs in FStar_List.length uu____5617 in
...
let (message_prefix : error_message_prefix) =
  ...
  let append_prefix s =
    ...
    | FStar_Pervasives_Native.Some p ->
        ...
        FStar_String.op_Hat p uu____6284 in
  ...
  fun l ->
    ...
    let compare1 uu____6718 uu____6719 =
      ...
      | ((uu____6761, (a, uu____6763)), (uu____6764, (b, uu____6766))) ->
          if a > b
          then Prims.int_one
          else if a < b then ~- Prims.int_one else Prims.int_zero in
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          ...
          aux uu____6996 (i + Prims.int_one) tl1 sorted1 in
...
let catch_errors :
  ...
  fun f ->
    ...
    (let r =
       ...
       with
       | uu___278_7355 ->
           (err_exn uu___278_7355; FStar_Pervasives_Native.None) in
