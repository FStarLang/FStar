          ...
          let uu____314 =
            ...
            then ""
              ...
              (let uu____319 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____319)
             in
          (uu____312, uu____314)
       in
...
let report_all : Prims.unit -> issue Prims.list =
  fun uu____927  ->
    let uu____928 =
      let uu____933 = FStar_ST.op_Bang current_handler  in
      uu____933.eh_report  in
    uu____928 ()
  
let clear : Prims.unit -> Prims.unit =
  fun uu____983  ->
    let uu____984 =
      let uu____987 = FStar_ST.op_Bang current_handler  in uu____987.eh_clear
       in
    uu____984 ()
  ...
  fun uu___70_1447  ->
    ...
    | FStar_Util.NYI msg ->
        let uu____1455 =
          ...
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____1456
           in
...
let stop_if_err : Prims.unit -> Prims.unit =
  fun uu____1485  ->
    let uu____1486 =
      let uu____1487 = get_err_count ()  in
      uu____1487 > (Prims.parse_int "0")  in
