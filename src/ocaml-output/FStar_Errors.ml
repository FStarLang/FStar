...
let (uu___is_Error_DidNotFail : raw_error -> Prims.bool) =
  fun projectee ->
    match projectee with | Error_DidNotFail -> true | uu____1818 -> false
...
let (uu___is_CFatal : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CFatal -> true | uu____1836 -> false
let (uu___is_CAlwaysError : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CAlwaysError -> true | uu____1842 -> false
let (uu___is_CError : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CError -> true | uu____1848 -> false
let (uu___is_CWarning : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CWarning -> true | uu____1854 -> false
let (uu___is_CSilent : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CSilent -> true | uu____1860 -> false
let (default_flags :
...
let (uu___is_ENotImplemented : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | ENotImplemented -> true | uu____3242 -> false
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee -> match projectee with | EInfo -> true | uu____3248 -> false
let (uu___is_EWarning : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | EWarning -> true | uu____3254 -> false
let (uu___is_EError : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | EError -> true | uu____3260 -> false
type issue =
  {
  ...
  fun issue ->
    ...
    let uu____3517 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____3527 =
            let uu____3528 = FStar_Range.string_of_use_range r in
            FStar_Util.format1 "%s: " uu____3528 in
          let uu____3529 =
            let uu____3530 =
              let uu____3531 = FStar_Range.use_range r in
              let uu____3532 = FStar_Range.def_range r in
              uu____3531 = uu____3532 in
            if uu____3530
            then ""
            else
              (let uu____3534 = FStar_Range.string_of_range r in
               FStar_Util.format1 " (see also %s)" uu____3534) in
          (uu____3527, uu____3529) in
    ...
    | (range_str, see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              let uu____3539 = FStar_Util.string_of_int n1 in
              FStar_Util.format1 " %s" uu____3539 in
...
let (print_issue : issue -> unit) =
  fun issue ->
    ...
    let uu____3553 = format_issue issue in printer uu____3553
  ...
  fun i1 ->
    fun i2 ->
      ...
      | (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some
         uu____3572) -> ~- (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____3577,
...
let (mk_default_handler : Prims.bool -> error_handler) =
  fun print7 ->
    ...
    let add_one e =
      ...
      | EError ->
          let uu____3606 =
            let uu____3609 = FStar_ST.op_Bang errs in e :: uu____3609 in
          FStar_ST.op_Colon_Equals errs uu____3606
      | uu____3818 -> print_issue e in
    let count_errors uu____3824 =
      let uu____3825 = FStar_ST.op_Bang errs in FStar_List.length uu____3825 in
    let report uu____3938 =
      let sorted1 =
        let uu____3942 = FStar_ST.op_Bang errs in
        FStar_List.sortWith compare_issues uu____3942 in
      if print7 then FStar_List.iter print_issue sorted1 else (); sorted1 in
    let clear1 uu____4055 = FStar_ST.op_Colon_Equals errs [] in
    {
      eh_add_one = add_one;
...
let (get_err_count : unit -> Prims.int) =
  fun uu____4232 ->
    let uu____4233 =
      let uu____4238 = FStar_ST.op_Bang current_handler in
      uu____4238.eh_count_errors in
    uu____4233 ()
let (add_one : issue -> unit) =
  fun issue ->
    FStar_Util.atomically
      (fun uu____4275 ->
         let uu____4276 =
           let uu____4281 = FStar_ST.op_Bang current_handler in
           uu____4281.eh_add_one in
         uu____4276 issue)
let (add_many : issue Prims.list -> unit) =
  fun issues ->
    FStar_Util.atomically
      (fun uu____4322 ->
         let uu____4323 =
           let uu____4328 = FStar_ST.op_Bang current_handler in
           uu____4328.eh_add_one in
         FStar_List.iter uu____4323 issues)
let (report_all : unit -> issue Prims.list) =
  fun uu____4364 ->
    let uu____4365 =
      let uu____4372 = FStar_ST.op_Bang current_handler in
      uu____4372.eh_report in
    uu____4365 ()
let (clear : unit -> unit) =
  fun uu____4406 ->
    let uu____4407 =
      let uu____4412 = FStar_ST.op_Bang current_handler in
      uu____4412.eh_clear in
    uu____4407 ()
...
let (message_prefix : error_message_prefix) =
  ...
  let clear_prefix uu____4704 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None in
  let append_prefix s =
    let uu____4814 = FStar_ST.op_Bang pfx in
...
let findIndex :
  'Auu____4929 'Auu____4930 .
    ('Auu____4929, 'Auu____4930) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____4929 -> Prims.int
  =
  fun l ->
    fun v1 ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___31_4966 ->
              match uu___31_4966 with
              | (e, uu____4972) when e = v1 -> true
              | uu____4973 -> false))
...
let (init_warn_error_flags : unit) =
  ...
  let uu____5072 = aux [] default_flags in
  FStar_ST.op_Colon_Equals flags uu____5072
...
let (lookup : flag Prims.list -> Prims.int -> flag) =
  fun flags1 ->
    fun errno ->
      ...
      if uu____5134 then CAlwaysError else FStar_List.nth flags1 errno
let (log_issue :
  FStar_Range.range ->
  ...
  fun r ->
    fun uu____5149 ->
      ...
      | (e, msg) ->
          ...
          let uu____5157 =
            let uu____5158 = FStar_ST.op_Bang flags in
            lookup uu____5158 errno in
          (match uu____5157 with
           ...
           | CFatal ->
               ...
               let uu____5195 = FStar_Options.ide () in
               if uu____5195
               then add_one i
               else
                 (let uu____5197 =
                    let uu____5198 = format_issue i in
                    Prims.strcat
      ...
      (fun uu____5221 ->
         FStar_List.iter
           (fun uu____5233 ->
              ...
              | (e, msg, r) ->
                  let uu____5243 =
                    let uu____5248 = message_prefix.append_prefix msg in
                    (e, uu____5248) in
                  log_issue r uu____5243) errs)
let (issue_of_exn : Prims.exn -> issue FStar_Pervasives_Native.option) =
  fun uu___32_5255 ->
    match uu___32_5255 with
    | Error (e, msg, r) ->
        let errno = errno_of_error e in
        let uu____5262 =
          let uu____5263 = message_prefix.append_prefix msg in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____5263
            (FStar_Pervasives_Native.Some errno) in
        FStar_Pervasives_Native.Some uu____5262
    | FStar_Util.NYI msg ->
        let uu____5265 =
          let uu____5266 = message_prefix.append_prefix msg in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____5266
            FStar_Pervasives_Native.None in
        FStar_Pervasives_Native.Some uu____5265
    | Err (e, msg) ->
        let errno = errno_of_error e in
        let uu____5270 =
          let uu____5271 = message_prefix.append_prefix msg in
          mk_issue EError FStar_Pervasives_Native.None uu____5271
            (FStar_Pervasives_Native.Some errno) in
        FStar_Pervasives_Native.Some uu____5270
...
let (err_exn : Prims.exn -> unit) =
  fun exn ->
    ...
    then ()
      ...
      (let uu____5279 = issue_of_exn exn in
...
let (handleable : Prims.exn -> Prims.bool) =
  fun uu___33_5287 ->
    match uu___33_5287 with
    | Error uu____5288 -> true
    | FStar_Util.NYI uu____5295 -> true
    | Stop -> true
    | Err uu____5296 -> true
    | uu____5301 -> false
let (stop_if_err : unit -> unit) =
  fun uu____5306 ->
    let uu____5307 =
      let uu____5308 = get_err_count () in uu____5308 > (Prims.parse_int "0") in
    if uu____5307 then FStar_Exn.raise Stop else ()
let raise_error :
  'Auu____5316 .
    (raw_error, Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____5316
  =
  fun uu____5329 ->
    fun r ->
      match uu____5329 with | (e, msg) -> FStar_Exn.raise (Error (e, msg, r))
let raise_err :
  'Auu____5341 .
    (raw_error, Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____5341
  =
  fun uu____5350 ->
    match uu____5350 with | (e, msg) -> FStar_Exn.raise (Err (e, msg))
let (update_flags :
  (flag, Prims.string) FStar_Pervasives_Native.tuple2 Prims.list -> unit) =
  fun l ->
    let compare1 uu____5399 uu____5400 =
      match (uu____5399, uu____5400) with
      | ((uu____5433, (a, uu____5435)), (uu____5436, (b, uu____5438))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____5514 = FStar_ST.op_Bang flags in
        FStar_List.nth uu____5514 i in
      match l1 with
      | [] -> d
      | (f, (l2, h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____5643 =
            let uu____5646 =
              let uu____5649 = set_flag i sorted1 in [uu____5649] in
            FStar_List.append f uu____5646 in
          aux uu____5643 (i + (Prims.parse_int "1")) tl1 sorted1 in
    let rec compute_range result l1 =
      ...
      | (f, s)::tl1 ->
          ...
          let uu____5733 =
            match r with
            | r1::r2::[] ->
                let uu____5744 = FStar_Util.int_of_string r1 in
                let uu____5745 = FStar_Util.int_of_string r2 in
                (uu____5744, uu____5745)
            | uu____5746 ->
                let uu____5749 =
                  let uu____5754 =
                    FStar_Util.format1 "Malformed warn-error range %s" s in
                  (Fatal_InvalidWarnErrorSetting, uu____5754) in
                raise_err uu____5749 in
           ...
           | (l2, h) ->
               (if
                ...
                then
                  (let uu____5776 =
                     let uu____5781 =
                       let uu____5782 = FStar_Util.string_of_int l2 in
                       let uu____5783 = FStar_Util.string_of_int h in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____5782 uu____5783 in
                     (Fatal_InvalidWarnErrorSetting, uu____5781) in
                   raise_err uu____5776)
                else ();
    ...
    let uu____5851 =
      let uu____5854 = FStar_ST.op_Bang flags in
      aux [] (Prims.parse_int "0") uu____5854 sorted1 in
    FStar_ST.op_Colon_Equals flags uu____5851
let catch_errors : 'a . (unit -> 'a) -> issue Prims.list =
  fun f ->
    ...
    (try let uu____6005 = f () in () with | ex -> err_exn ex);
