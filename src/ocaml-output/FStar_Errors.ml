...
| true -> begin
(FStar_Util.print_string (let _0_106 = (FStar_Range.string_of_range r)
...
let warn : FStar_Range.range  ->  Prims.string  ->  Prims.unit = (fun r msg -> (let _0_107 = (FStar_Range.string_of_range r)
...
| (msg, r) -> begin
(let _0_108 = (message_prefix.append_prefix msg)
in ((r), (_0_108)))
end))))
in (

let n_errs = (FStar_List.length errs)
in (FStar_Util.atomically (fun uu____196 -> ((let _0_110 = (let _0_109 = (FStar_ST.read verification_errs)
in (FStar_List.append errs _0_109))
in (FStar_ST.write verification_errs _0_110));
(let _0_112 = (let _0_111 = (FStar_ST.read num_errs)
in (_0_111 + n_errs))
in (FStar_ST.write num_errs _0_112));
))))))
...
| true -> begin
(let _0_114 = (FStar_Range.string_of_use_range r)
in (let _0_113 = (FStar_Range.string_of_range r)
in (FStar_Util.format3 "%s: (Error) %s (see %s)\n" _0_114 msg _0_113)))
end
| uu____222 -> begin
(let _0_115 = (FStar_Range.string_of_range r)
...
in (let _0_116 = (FStar_Range.string_of_range r)
in (FStar_Util.print3_error "%s : %s %s\n" _0_116 (match (warning) with
| true -> begin
"(Warning)"
end
| uu____299 -> begin
