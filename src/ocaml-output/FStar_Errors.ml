          ...
          let uu____178 =
            ...
            then ""
              ...
              (let uu____180 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____180)
             in
          (uu____176, uu____178)
       in
...
let default_handler : error_handler =
  ...
  let add_one e =
    ...
    | EError  ->
        let uu____216 = let uu____218 = FStar_ST.read errs  in e :: uu____218
           in
...
let report_all : Prims.unit -> issue Prims.list =
  fun uu____307  ->
    let uu____308 =
      let uu____312 = FStar_ST.read current_handler  in uu____312.eh_report
       in
    uu____308 ()
...
let clear : Prims.unit -> Prims.unit =
  fun uu____317  ->
    let uu____318 =
      let uu____321 = FStar_ST.read current_handler  in uu____321.eh_clear
       in
    uu____318 ()
