...
let (default_flags :
  (raw_error,flag) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list) =
...
let (__proj__Err__item__uu___ :
  Prims.exn -> (raw_error,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2)
...
let findIndex :
  'Auu____6476 'Auu____6477 .
    ('Auu____6476,'Auu____6477) FStar_Pervasives_Native_Tuple2.tuple2
      Prims.list -> 'Auu____6476 -> Prims.int
  =
  fun l  ->
    fun v1  ->
...
let (log_issue :
  FStar_Range.range ->
    (raw_error,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2 -> unit)
  =
  fun r  ->
    fun uu____6689  ->
...
let raise_error :
  'Auu____6905 .
    (raw_error,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2 ->
      FStar_Range.range -> 'Auu____6905
  =
  fun uu____6919  ->
    fun r  ->
...
let (update_flags :
  (flag,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list ->
    unit)
  =
  fun l  ->
...
let catch_errors :
  ...
  fun f  ->
    ...
    (let r =
       ...
       with
       | uu___87_7722 -> (err_exn uu___87_7722; FStar_Pervasives_Native.None)
        in
