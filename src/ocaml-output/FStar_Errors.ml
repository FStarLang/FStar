...
let uu____3567 = (match (issue.issue_range) with
...
let uu____3579 = (FStar_Range.string_of_use_range r)
in (FStar_Util.format1 "%s: " uu____3579))
in (
...
let uu____3582 = (FStar_Range.use_range r)
in (

let uu____3583 = (FStar_Range.def_range r)
in (Prims.op_Equality uu____3582 uu____3583)))
...
let uu____3585 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 " (see also %s)" uu____3585))
end))
in ((uu____3578), (uu____3580))))
end)
...
let uu____3590 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 " %s" uu____3590))
end)
...
let uu____3604 = (format_issue issue)
in (printer uu____3604))))
...
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some (uu____3623)) -> begin
(~- ((Prims.parse_int "1")))
end
| (FStar_Pervasives_Native.Some (uu____3628), FStar_Pervasives_Native.None) -> begin
(Prims.parse_int "1")
end
...
let uu____3660 = (FStar_ST.op_Bang errs)
in (e)::uu____3660)
in (FStar_ST.op_Colon_Equals errs uu____3657))
end
| uu____3753 -> begin
(print_issue e)
end))
...
let count_errors = (fun uu____3759 -> (

let uu____3760 = (FStar_ST.op_Bang errs)
in (FStar_List.length uu____3760)))
in (

let report = (fun uu____3815 -> (

let sorted1 = (

let uu____3819 = (FStar_ST.op_Bang errs)
in (FStar_List.sortWith compare_issues uu____3819))
...
let clear1 = (fun uu____3874 -> (FStar_ST.op_Colon_Equals errs []))
...
let get_err_count : unit  ->  Prims.int = (fun uu____3969 -> (

let uu____3970 = (

let uu____3975 = (FStar_ST.op_Bang current_handler)
in uu____3975.eh_count_errors)
in (uu____3970 ())))
...
let uu____4008 = (FStar_ST.op_Bang FStar_Options.abort_counter)
in (uu____4008 - (Prims.parse_int "1")))
in (FStar_ST.op_Colon_Equals FStar_Options.abort_counter uu____4007));
(

let uu____4047 = (

let uu____4048 = (FStar_ST.op_Bang FStar_Options.abort_counter)
in (Prims.op_Equality uu____4048 (Prims.parse_int "0")))
...
let add_one : issue  ->  unit = (fun issue -> (FStar_Util.atomically (fun uu____4077 -> (

let uu____4078 = (FStar_ST.op_Bang current_handler)
in (wrapped_eh_add_one uu____4078 issue)))))


let add_many : issue Prims.list  ->  unit = (fun issues -> (FStar_Util.atomically (fun uu____4109 -> (

let uu____4110 = (

let uu____4115 = (FStar_ST.op_Bang current_handler)
in (wrapped_eh_add_one uu____4115))
in (FStar_List.iter uu____4110 issues)))))


let report_all : unit  ->  issue Prims.list = (fun uu____4141 -> (

let uu____4142 = (

let uu____4149 = (FStar_ST.op_Bang current_handler)
in uu____4149.eh_report)
in (uu____4142 ())))


let clear : unit  ->  unit = (fun uu____4173 -> (

let uu____4174 = (

let uu____4179 = (FStar_ST.op_Bang current_handler)
in uu____4179.eh_clear)
in (uu____4174 ())))
...
let clear_prefix = (fun uu____4393 -> (FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None))
in (

let append_prefix = (fun s -> (

let uu____4445 = (FStar_ST.op_Bang pfx)
...
let findIndex : 'Auu____4502 'Auu____4503 . ('Auu____4502 * 'Auu____4503) Prims.list  ->  'Auu____4502  ->  Prims.int = (fun l v1 -> (FStar_All.pipe_right l (FStar_List.index (fun uu___88_4539 -> (match (uu___88_4539) with
| (e, uu____4545) when (Prims.op_Equality e v1) -> begin
true
end
| uu____4546 -> begin
false
...
let uu____4621 = (aux [] default_flags)
in (FStar_ST.op_Colon_Equals flags uu____4621)))
...
let uu____4673 = ((Prims.op_Equality errno defensive_errno) && (FStar_Options.defensive_fail ()))
...
let log_issue : FStar_Range.range  ->  (raw_error * Prims.string)  ->  unit = (fun r uu____4688 -> (match (uu____4688) with
| (e, msg) -> begin
(
...
let uu____4697 = (FStar_ST.op_Bang flags)
in (lookup uu____4697 errno))
...
let uu____4724 = (FStar_Options.ide ())
...
let uu____4727 = (format_issue i)
in (Prims.strcat "don\'t use log_issue to report fatal error, should use raise_error: " uu____4727))
in (failwith uu____4726))
end)))
end)))
end))


let add_errors : (raw_error * Prims.string * FStar_Range.range) Prims.list  ->  unit = (fun errs -> (FStar_Util.atomically (fun uu____4750 -> (FStar_List.iter (fun uu____4762 -> (match (uu____4762) with
| (e, msg, r) -> begin
(

let uu____4772 = (

let uu____4777 = (message_prefix.append_prefix msg)
in ((e), (uu____4777)))
in (log_issue r uu____4772))
end)) errs))))


let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___89_4784 -> (match (uu___89_4784) with
| Error (e, msg, r) -> begin
(
...
let uu____4792 = (message_prefix.append_prefix msg)
in (mk_issue EError (FStar_Pervasives_Native.Some (r)) uu____4792 (FStar_Pervasives_Native.Some (errno))))
...
let uu____4795 = (message_prefix.append_prefix msg)
in (mk_issue ENotImplemented FStar_Pervasives_Native.None uu____4795 FStar_Pervasives_Native.None))
in FStar_Pervasives_Native.Some (uu____4794))
end
| Err (e, msg) -> begin
(
...
let uu____4800 = (message_prefix.append_prefix msg)
in (mk_issue EError FStar_Pervasives_Native.None uu____4800 (FStar_Pervasives_Native.Some (errno))))
in FStar_Pervasives_Native.Some (uu____4799)))
end
| uu____4801 -> begin
...
let uu____4808 = (issue_of_exn exn)
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___90_4816 -> (match (uu___90_4816) with
| Error (uu____4817) -> begin
true
end
| FStar_Util.NYI (uu____4824) -> begin
true
end
| Stop -> begin
true
end
| Err (uu____4825) -> begin
true
end
| uu____4830 -> begin
false
...
let stop_if_err : unit  ->  unit = (fun uu____4835 -> (

let uu____4836 = (

let uu____4837 = (get_err_count ())
in (uu____4837 > (Prims.parse_int "0")))
...
let raise_error : 'Auu____4845 . (raw_error * Prims.string)  ->  FStar_Range.range  ->  'Auu____4845 = (fun uu____4858 r -> (match (uu____4858) with
| (e, msg) -> begin
(FStar_Exn.raise (Error (((e), (msg), (r)))))
end))


let raise_err : 'Auu____4870 . (raw_error * Prims.string)  ->  'Auu____4870 = (fun uu____4879 -> (match (uu____4879) with
| (e, msg) -> begin
...
let compare1 = (fun uu____4928 uu____4929 -> (match (((uu____4928), (uu____4929))) with
| ((uu____4962, (a, uu____4964)), (uu____4965, (b, uu____4967))) -> begin
(match ((a > b)) with
| true -> begin
(Prims.parse_int "1")
end
...
let uu____5043 = (FStar_ST.op_Bang flags)
in (FStar_List.nth uu____5043 i))
in (match (l1) with
| [] -> begin
d
end
...
let uu____5168 = (set_flag i sorted1)
in (uu____5168)::[])
in (FStar_List.append f uu____5165))
in (aux uu____5162 (i + (Prims.parse_int "1")) tl1 sorted1))
end))
in (
...
let uu____5252 = (match (r) with
| (r1)::(r2)::[] -> begin
(

let uu____5263 = (FStar_Util.int_of_string r1)
in (

let uu____5264 = (FStar_Util.int_of_string r2)
in ((uu____5263), (uu____5264))))
end
| uu____5265 -> begin
(
...
let uu____5273 = (FStar_Util.format1 "Malformed warn-error range %s" s)
in ((Fatal_InvalidWarnErrorSetting), (uu____5273)))
in (raise_err uu____5268))
end)
...
let uu____5301 = (FStar_Util.string_of_int l2)
in (

let uu____5302 = (FStar_Util.string_of_int h)
in (FStar_Util.format2 "No error for warn_error %s..%s" uu____5301 uu____5302)))
in ((Fatal_InvalidWarnErrorSetting), (uu____5300)))
in (raise_err uu____5295))
end
| uu____5303 -> begin
()
end);
...
let uu____5373 = (FStar_ST.op_Bang flags)
in (aux [] (Prims.parse_int "0") uu____5373 sorted1))
in (FStar_ST.op_Colon_Equals flags uu____5370))))))))))
...
let r = (FStar_All.try_with (fun uu___92_5493 -> (match (()) with
| () -> begin
(

let r = (f ())
in FStar_Pervasives_Native.Some (r))
end)) (fun uu___91_5500 -> (match (uu___91_5500) with
| ex -> begin
((err_exn ex);
FStar_Pervasives_Native.None;
)
