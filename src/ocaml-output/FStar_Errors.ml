...
let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___70_1447 -> (match (uu___70_1447) with
| Error (msg, r) -> begin
(
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___71_1473 -> (match (uu___71_1473) with
