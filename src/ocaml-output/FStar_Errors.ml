...
type raw_error =
  ...
  | Fatal_UnexpectedAntiquotation [@@deriving show]
...
let (uu___is_CError : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CError -> true | uu____1204 -> false
let (uu___is_CFatal : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CFatal -> true | uu____1208 -> false
let (uu___is_CWarning : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CWarning -> true | uu____1212 -> false
let (uu___is_CSilent : flag -> Prims.bool) =
  fun projectee ->
    match projectee with | CSilent -> true | uu____1216 -> false
let (default_flags :
...
let (uu___is_ENotImplemented : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | ENotImplemented -> true | uu____2563 -> false
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee -> match projectee with | EInfo -> true | uu____2567 -> false
let (uu___is_EWarning : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | EWarning -> true | uu____2571 -> false
let (uu___is_EError : issue_level -> Prims.bool) =
  fun projectee ->
    match projectee with | EError -> true | uu____2575 -> false
type issue =
  {
  ...
  fun issue ->
    ...
    let uu____2774 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____2784 =
            let uu____2785 = FStar_Range.string_of_use_range r in
            FStar_Util.format1 "%s: " uu____2785 in
          let uu____2786 =
            let uu____2787 =
              let uu____2788 = FStar_Range.use_range r in
              let uu____2789 = FStar_Range.def_range r in
              uu____2788 = uu____2789 in
            if uu____2787
            then ""
            else
              (let uu____2791 = FStar_Range.string_of_range r in
               FStar_Util.format1 " (see also %s)" uu____2791) in
    ...
    | (range_str, see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              let uu____2796 = FStar_Util.string_of_int n1 in
              FStar_Util.format1 " %s" uu____2796 in
...
let (print_issue : issue -> Prims.unit) =
  fun issue ->
    ...
    let uu____2805 = format_issue issue in printer uu____2805
...
let (default_handler : error_handler) =
  ...
  let add_one e =
    ...
    | EError ->
        let uu____2847 =
          let uu____2850 = FStar_ST.op_Bang errs in e :: uu____2850 in
        FStar_ST.op_Colon_Equals errs uu____2847
    | uu____3051 -> print_issue e in
  let count_errors uu____3055 =
    let uu____3056 = FStar_ST.op_Bang errs in FStar_List.length uu____3056 in
  let report uu____3163 =
    let sorted1 =
      let uu____3167 = FStar_ST.op_Bang errs in
      FStar_List.sortWith compare_issues uu____3167 in
    FStar_List.iter print_issue sorted1; sorted1 in
  let clear1 uu____3273 = FStar_ST.op_Colon_Equals errs [] in
  {
    eh_add_one = add_one;
...
let (get_err_count : Prims.unit -> Prims.int) =
  fun uu____3436 ->
    let uu____3437 =
      let uu____3440 = FStar_ST.op_Bang current_handler in
      uu____3440.eh_count_errors in
    uu____3437 ()
let (add_one : issue -> Prims.unit) =
  fun issue ->
    FStar_Util.atomically
      (fun uu____3471 ->
         let uu____3472 =
           let uu____3475 = FStar_ST.op_Bang current_handler in
           uu____3475.eh_add_one in
         uu____3472 issue)
let (add_many : issue Prims.list -> Prims.unit) =
  fun issues ->
    FStar_Util.atomically
      (fun uu____3510 ->
         let uu____3511 =
           let uu____3514 = FStar_ST.op_Bang current_handler in
           uu____3514.eh_add_one in
         FStar_List.iter uu____3511 issues)
let (report_all : Prims.unit -> issue Prims.list) =
  fun uu____3544 ->
    let uu____3545 =
      let uu____3550 = FStar_ST.op_Bang current_handler in
      uu____3550.eh_report in
    uu____3545 ()
let (clear : Prims.unit -> Prims.unit) =
  fun uu____3578 ->
    let uu____3579 =
      let uu____3582 = FStar_ST.op_Bang current_handler in
      uu____3582.eh_clear in
    uu____3579 ()
...
let (message_prefix : error_message_prefix) =
  ...
  let clear_prefix uu____3826 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None in
  let append_prefix s =
    let uu____3930 = FStar_ST.op_Bang pfx in
...
let findIndex :
  'Auu____4037 'Auu____4038 .
    ('Auu____4037, 'Auu____4038) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____4037 -> Prims.int
  =
  fun l ->
    fun v1 ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___29_4072 ->
              match uu___29_4072 with
              | (e, uu____4078) when e = v1 -> true
              | uu____4079 -> false))
...
let (init_warn_error_flags : Prims.unit) =
  ...
  let uu____4172 = aux [] default_flags in
  FStar_ST.op_Colon_Equals flags uu____4172
...
let (lookup : flag Prims.list -> Prims.int -> flag) =
  fun flags1 ->
    fun errno ->
      ...
      if uu____4222 then CError else FStar_List.nth flags1 errno
let (log_issue :
  FStar_Range.range ->
  ...
  fun r ->
    fun uu____4233 ->
      ...
      | (e, msg) ->
          ...
          let uu____4241 =
            let uu____4242 = FStar_ST.op_Bang flags in
            lookup uu____4242 errno in
          (match uu____4241 with
           ...
           | CFatal ->
               ...
               let uu____4275 = FStar_Options.ide () in
               if uu____4275
               then add_one i
               else
                 (let uu____4277 =
                    let uu____4278 = format_issue i in
                    Prims.strcat
      ...
      (fun uu____4299 ->
         FStar_List.iter
           (fun uu____4311 ->
              ...
              | (e, msg, r) ->
                  let uu____4321 =
                    let uu____4326 = message_prefix.append_prefix msg in
                    (e, uu____4326) in
                  log_issue r uu____4321) errs)
let (issue_of_exn : Prims.exn -> issue FStar_Pervasives_Native.option) =
  fun uu___30_4331 ->
    match uu___30_4331 with
    | Error (e, msg, r) ->
        let errno = errno_of_error e in
        let uu____4338 =
          let uu____4339 = message_prefix.append_prefix msg in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____4339
            (FStar_Pervasives_Native.Some errno) in
        FStar_Pervasives_Native.Some uu____4338
    | FStar_Util.NYI msg ->
        let uu____4341 =
          let uu____4342 = message_prefix.append_prefix msg in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____4342
            FStar_Pervasives_Native.None in
        FStar_Pervasives_Native.Some uu____4341
    | Err (e, msg) ->
        let errno = errno_of_error e in
        let uu____4346 =
          let uu____4347 = message_prefix.append_prefix msg in
          mk_issue EError FStar_Pervasives_Native.None uu____4347
            (FStar_Pervasives_Native.Some errno) in
...
let (err_exn : Prims.exn -> Prims.unit) =
  fun exn ->
    ...
    then ()
      ...
      (let uu____4353 = issue_of_exn exn in
...
let (handleable : Prims.exn -> Prims.bool) =
  fun uu___31_4359 ->
    match uu___31_4359 with
    | Error uu____4360 -> true
    | FStar_Util.NYI uu____4367 -> true
    | Stop -> true
    | Err uu____4368 -> true
    | uu____4373 -> false
let (stop_if_err : Prims.unit -> Prims.unit) =
  fun uu____4376 ->
    let uu____4377 =
      let uu____4378 = get_err_count () in uu____4378 > (Prims.parse_int "0") in
    if uu____4377 then FStar_Exn.raise Stop else ()
let raise_error :
  'Auu____4383 .
    (raw_error, Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____4383
  =
  fun uu____4394 ->
    fun r ->
      match uu____4394 with | (e, msg) -> FStar_Exn.raise (Error (e, msg, r))
let raise_err :
  'Auu____4404 .
    (raw_error, Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____4404
  =
  fun uu____4412 ->
    match uu____4412 with | (e, msg) -> FStar_Exn.raise (Err (e, msg))
let (update_flags :
  (flag, Prims.string) FStar_Pervasives_Native.tuple2 Prims.list ->
    Prims.unit)
  =
  fun l ->
    let compare1 uu____4455 uu____4456 =
      match (uu____4455, uu____4456) with
      | ((uu____4489, (a, uu____4491)), (uu____4492, (b, uu____4494))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____4562 = FStar_ST.op_Bang flags in
        FStar_List.nth uu____4562 i in
      match l1 with
      | [] -> d
      | (f, (l2, h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____4679 =
            let uu____4682 =
              let uu____4685 = set_flag i sorted1 in [uu____4685] in
            FStar_List.append f uu____4682 in
          aux uu____4679 (i + (Prims.parse_int "1")) tl1 sorted1 in
    let rec compute_range result l1 =
      ...
      | (f, s)::tl1 ->
          ...
          let uu____4765 =
            match r with
            | r1::r2::[] ->
                let uu____4776 = FStar_Util.int_of_string r1 in
                let uu____4777 = FStar_Util.int_of_string r2 in
                (uu____4776, uu____4777)
            | uu____4778 ->
                let uu____4781 =
                  let uu____4786 =
                    FStar_Util.format1 "Malformed warn-error range %s" s in
                  (Fatal_InvalidWarnErrorSetting, uu____4786) in
                raise_err uu____4781 in
           ...
           | (l2, h) ->
               (if
                ...
                then
                  (let uu____4808 =
                     let uu____4813 =
                       let uu____4814 = FStar_Util.string_of_int l2 in
                       let uu____4815 = FStar_Util.string_of_int h in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____4814 uu____4815 in
                     (Fatal_InvalidWarnErrorSetting, uu____4813) in
                   raise_err uu____4808)
                else ();
    ...
    let uu____4883 =
      let uu____4886 = FStar_ST.op_Bang flags in
      aux [] (Prims.parse_int "0") uu____4886 sorted1 in
    FStar_ST.op_Colon_Equals flags uu____4883