...
let uu____3517 = (match (issue.issue_range) with
...
let uu____3528 = (FStar_Range.string_of_use_range r)
in (FStar_Util.format1 "%s: " uu____3528))
in (
...
let uu____3531 = (FStar_Range.use_range r)
in (

let uu____3532 = (FStar_Range.def_range r)
in (Prims.op_Equality uu____3531 uu____3532)))
...
let uu____3534 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 " (see also %s)" uu____3534))
end))
in ((uu____3527), (uu____3529))))
end)
...
let uu____3539 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 " %s" uu____3539))
end)
...
let uu____3553 = (format_issue issue)
in (printer uu____3553))))
...
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some (uu____3572)) -> begin
(~- ((Prims.parse_int "1")))
end
| (FStar_Pervasives_Native.Some (uu____3577), FStar_Pervasives_Native.None) -> begin
(Prims.parse_int "1")
end
...
let uu____3609 = (FStar_ST.op_Bang errs)
in (e)::uu____3609)
in (FStar_ST.op_Colon_Equals errs uu____3606))
end
| uu____3818 -> begin
(print_issue e)
end))
...
let count_errors = (fun uu____3824 -> (

let uu____3825 = (FStar_ST.op_Bang errs)
in (FStar_List.length uu____3825)))
in (

let report = (fun uu____3938 -> (

let sorted1 = (

let uu____3942 = (FStar_ST.op_Bang errs)
in (FStar_List.sortWith compare_issues uu____3942))
...
let clear1 = (fun uu____4055 -> (FStar_ST.op_Colon_Equals errs []))
...
let get_err_count : unit  ->  Prims.int = (fun uu____4232 -> (

let uu____4233 = (

let uu____4238 = (FStar_ST.op_Bang current_handler)
in uu____4238.eh_count_errors)
in (uu____4233 ())))


let add_one : issue  ->  unit = (fun issue -> (FStar_Util.atomically (fun uu____4275 -> (

let uu____4276 = (

let uu____4281 = (FStar_ST.op_Bang current_handler)
in uu____4281.eh_add_one)
in (uu____4276 issue)))))


let add_many : issue Prims.list  ->  unit = (fun issues -> (FStar_Util.atomically (fun uu____4322 -> (

let uu____4323 = (

let uu____4328 = (FStar_ST.op_Bang current_handler)
in uu____4328.eh_add_one)
in (FStar_List.iter uu____4323 issues)))))


let report_all : unit  ->  issue Prims.list = (fun uu____4364 -> (

let uu____4365 = (

let uu____4372 = (FStar_ST.op_Bang current_handler)
in uu____4372.eh_report)
in (uu____4365 ())))


let clear : unit  ->  unit = (fun uu____4406 -> (

let uu____4407 = (

let uu____4412 = (FStar_ST.op_Bang current_handler)
in uu____4412.eh_clear)
in (uu____4407 ())))
...
let clear_prefix = (fun uu____4704 -> (FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None))
in (

let append_prefix = (fun s -> (

let uu____4814 = (FStar_ST.op_Bang pfx)
...
let findIndex : 'Auu____4929 'Auu____4930 . ('Auu____4929 * 'Auu____4930) Prims.list  ->  'Auu____4929  ->  Prims.int = (fun l v1 -> (FStar_All.pipe_right l (FStar_List.index (fun uu___31_4966 -> (match (uu___31_4966) with
| (e, uu____4972) when (Prims.op_Equality e v1) -> begin
true
end
| uu____4973 -> begin
false
...
let uu____5072 = (aux [] default_flags)
in (FStar_ST.op_Colon_Equals flags uu____5072)))


let diag : FStar_Range.range  ->  Prims.string  ->  unit = (fun r msg -> (

let uu____5118 = (FStar_Options.debug_any ())
...
let uu____5134 = ((Prims.op_Equality errno defensive_errno) && (FStar_Options.defensive_fail ()))
...
let log_issue : FStar_Range.range  ->  (raw_error * Prims.string)  ->  unit = (fun r uu____5149 -> (match (uu____5149) with
| (e, msg) -> begin
(
...
let uu____5158 = (FStar_ST.op_Bang flags)
in (lookup uu____5158 errno))
...
let uu____5195 = (FStar_Options.ide ())
...
let uu____5198 = (format_issue i)
in (Prims.strcat "don\'t use log_issue to report fatal error, should use raise_error: " uu____5198))
in (failwith uu____5197))
end)))
end)))
end))


let add_errors : (raw_error * Prims.string * FStar_Range.range) Prims.list  ->  unit = (fun errs -> (FStar_Util.atomically (fun uu____5221 -> (FStar_List.iter (fun uu____5233 -> (match (uu____5233) with
| (e, msg, r) -> begin
(

let uu____5243 = (

let uu____5248 = (message_prefix.append_prefix msg)
in ((e), (uu____5248)))
in (log_issue r uu____5243))
end)) errs))))


let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___32_5255 -> (match (uu___32_5255) with
| Error (e, msg, r) -> begin
(
...
let uu____5263 = (message_prefix.append_prefix msg)
in (mk_issue EError (FStar_Pervasives_Native.Some (r)) uu____5263 (FStar_Pervasives_Native.Some (errno))))
in FStar_Pervasives_Native.Some (uu____5262)))
end
...
let uu____5266 = (message_prefix.append_prefix msg)
in (mk_issue ENotImplemented FStar_Pervasives_Native.None uu____5266 FStar_Pervasives_Native.None))
in FStar_Pervasives_Native.Some (uu____5265))
end
| Err (e, msg) -> begin
(
...
let uu____5271 = (message_prefix.append_prefix msg)
in (mk_issue EError FStar_Pervasives_Native.None uu____5271 (FStar_Pervasives_Native.Some (errno))))
in FStar_Pervasives_Native.Some (uu____5270)))
end
| uu____5272 -> begin
...
let uu____5279 = (issue_of_exn exn)
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___33_5287 -> (match (uu___33_5287) with
| Error (uu____5288) -> begin
true
end
| FStar_Util.NYI (uu____5295) -> begin
true
end
| Stop -> begin
true
end
| Err (uu____5296) -> begin
true
end
| uu____5301 -> begin
false
...
let stop_if_err : unit  ->  unit = (fun uu____5306 -> (

let uu____5307 = (

let uu____5308 = (get_err_count ())
in (uu____5308 > (Prims.parse_int "0")))
...
let raise_error : 'Auu____5316 . (raw_error * Prims.string)  ->  FStar_Range.range  ->  'Auu____5316 = (fun uu____5329 r -> (match (uu____5329) with
| (e, msg) -> begin
(FStar_Exn.raise (Error (((e), (msg), (r)))))
end))


let raise_err : 'Auu____5341 . (raw_error * Prims.string)  ->  'Auu____5341 = (fun uu____5350 -> (match (uu____5350) with
| (e, msg) -> begin
...
let compare1 = (fun uu____5399 uu____5400 -> (match (((uu____5399), (uu____5400))) with
| ((uu____5433, (a, uu____5435)), (uu____5436, (b, uu____5438))) -> begin
(match ((a > b)) with
| true -> begin
(Prims.parse_int "1")
end
...
let uu____5514 = (FStar_ST.op_Bang flags)
in (FStar_List.nth uu____5514 i))
in (match (l1) with
| [] -> begin
d
end
...
let uu____5649 = (set_flag i sorted1)
in (uu____5649)::[])
in (FStar_List.append f uu____5646))
in (aux uu____5643 (i + (Prims.parse_int "1")) tl1 sorted1))
end))
in (
...
let uu____5733 = (match (r) with
| (r1)::(r2)::[] -> begin
(

let uu____5744 = (FStar_Util.int_of_string r1)
in (

let uu____5745 = (FStar_Util.int_of_string r2)
in ((uu____5744), (uu____5745))))
end
| uu____5746 -> begin
(
...
let uu____5754 = (FStar_Util.format1 "Malformed warn-error range %s" s)
in ((Fatal_InvalidWarnErrorSetting), (uu____5754)))
in (raise_err uu____5749))
end)
...
let uu____5782 = (FStar_Util.string_of_int l2)
in (

let uu____5783 = (FStar_Util.string_of_int h)
in (FStar_Util.format2 "No error for warn_error %s..%s" uu____5782 uu____5783)))
in ((Fatal_InvalidWarnErrorSetting), (uu____5781)))
in (raise_err uu____5776))
end
| uu____5784 -> begin
()
end);
...
let uu____5854 = (FStar_ST.op_Bang flags)
in (aux [] (Prims.parse_int "0") uu____5854 sorted1))
in (FStar_ST.op_Colon_Equals flags uu____5851))))))))))


let catch_errors : 'a . (unit  ->  'a)  ->  issue Prims.list = (fun f -> (
...
(FStar_All.try_with (fun uu___35_6004 -> (match (()) with
| () -> begin
(

let uu____6005 = (f ())
in ())
end)) (fun uu___34_6008 -> (match (uu___34_6008) with
| ex -> begin
(err_exn ex)
end)));
(
