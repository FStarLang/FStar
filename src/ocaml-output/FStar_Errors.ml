...
type raw_error =
  ...
  | Fatal_TacticProofRelevantGoal [@@deriving show]
...
let (uu___is_CError : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CError  -> true | uu____1188 -> false
  
let (uu___is_CFatal : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CFatal  -> true | uu____1192 -> false
  
let (uu___is_CWarning : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CWarning  -> true | uu____1196 -> false
  
let (uu___is_CSilent : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CSilent  -> true | uu____1200 -> false
...
let (uu___is_ENotImplemented : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | ENotImplemented  -> true | uu____2531 -> false
  
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EInfo  -> true | uu____2535 -> false
  
let (uu___is_EWarning : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EWarning  -> true | uu____2539 -> false
  
let (uu___is_EError : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EError  -> true | uu____2543 -> false
  ...
  fun issue  ->
    ...
    let uu____2742 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____2752 =
            let uu____2753 = FStar_Range.string_of_use_range r  in
            FStar_Util.format1 "%s: " uu____2753  in
          let uu____2754 =
            let uu____2755 =
              let uu____2756 = FStar_Range.use_range r  in
              let uu____2757 = FStar_Range.def_range r  in
              uu____2756 = uu____2757  in
            if uu____2755
            then ""
            else
              (let uu____2759 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____2759)
             in
          (uu____2752, uu____2754)
       in
    ...
    | (range_str,see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              let uu____2764 = FStar_Util.string_of_int n1  in
              FStar_Util.format1 " %s" uu____2764
           in
...
let (print_issue : issue -> Prims.unit) =
  fun issue  ->
    ...
    let uu____2773 = format_issue issue  in printer uu____2773
  ...
  fun i1  ->
    fun i2  ->
      ...
      | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some
         uu____2788) -> ~- (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____2793,FStar_Pervasives_Native.None
         ) -> (Prims.parse_int "1")
...
let (default_handler : error_handler) =
  ...
  let add_one e =
    ...
    | EError  ->
        let uu____2815 =
          let uu____2818 = FStar_ST.op_Bang errs  in e :: uu____2818  in
        FStar_ST.op_Colon_Equals errs uu____2815
    | uu____2911 -> print_issue e  in
  let count_errors uu____2915 =
    let uu____2916 = FStar_ST.op_Bang errs  in FStar_List.length uu____2916
     in
  let report uu____2969 =
    let sorted1 =
      let uu____2973 = FStar_ST.op_Bang errs  in
      FStar_List.sortWith compare_issues uu____2973  in
    FStar_List.iter print_issue sorted1; sorted1  in
  let clear1 uu____3025 = FStar_ST.op_Colon_Equals errs []  in
  {
    eh_add_one = add_one;
...
let (get_err_count : Prims.unit -> Prims.int) =
  fun uu____3110  ->
    let uu____3111 =
      let uu____3114 = FStar_ST.op_Bang current_handler  in
      uu____3114.eh_count_errors  in
    uu____3111 ()
...
let (add_one : issue -> Prims.unit) =
  fun issue  ->
    FStar_Util.atomically
      (fun uu____3139  ->
         let uu____3140 =
           let uu____3143 = FStar_ST.op_Bang current_handler  in
           uu____3143.eh_add_one  in
         uu____3140 issue)
...
let (add_many : issue Prims.list -> Prims.unit) =
  fun issues  ->
    FStar_Util.atomically
      (fun uu____3172  ->
         let uu____3173 =
           let uu____3176 = FStar_ST.op_Bang current_handler  in
           uu____3176.eh_add_one  in
         FStar_List.iter uu____3173 issues)
  
let (report_all : Prims.unit -> issue Prims.list) =
  fun uu____3200  ->
    let uu____3201 =
      let uu____3206 = FStar_ST.op_Bang current_handler  in
      uu____3206.eh_report  in
    uu____3201 ()
  
let (clear : Prims.unit -> Prims.unit) =
  fun uu____3228  ->
    let uu____3229 =
      let uu____3232 = FStar_ST.op_Bang current_handler  in
      uu____3232.eh_clear  in
    uu____3229 ()
...
let (message_prefix : error_message_prefix) =
  ...
  let clear_prefix uu____3410 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None  in
  let append_prefix s =
    let uu____3460 = FStar_ST.op_Bang pfx  in
...
let findIndex :
  'Auu____3513 'Auu____3514 .
    ('Auu____3513,'Auu____3514) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____3513 -> Prims.int
  =
  fun l  ->
    fun v1  ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___26_3548  ->
              match uu___26_3548 with
              | (e,uu____3554) when e = v1 -> true
              | uu____3555 -> false))
...
let (init_warn_error_flags : Prims.unit) =
  let rec aux r l =
    match l with | [] -> r | (e,f)::tl1 -> aux (FStar_List.append r [f]) tl1
     in
  let uu____3624 = aux [] default_flags  in
  FStar_ST.op_Colon_Equals flags uu____3624 
let (diag : FStar_Range.range -> Prims.string -> Prims.unit) =
  fun r  ->
    fun msg  ->
      let uu____3656 = FStar_Options.debug_any ()  in
      if uu____3656
      then
        add_one
...
let (lookup : flag Prims.list -> Prims.int -> flag) =
  fun flags1  ->
    fun errno  ->
      ...
      if uu____3668 then CError else FStar_List.nth flags1 errno
  ...
  fun r  ->
    fun uu____3679  ->
      ...
      | (e,msg) ->
          ...
          let uu____3687 =
            let uu____3688 = FStar_ST.op_Bang flags  in
            lookup uu____3688 errno  in
           ...
           | CFatal  ->
               let i =
                 mk_issue EError (FStar_Pervasives_Native.Some r) msg
                   (FStar_Pervasives_Native.Some errno)
                  in
               let uu____3715 = FStar_Options.ide ()  in
               if uu____3715
               then add_one i
               else
                 (let uu____3717 =
                    let uu____3718 = format_issue i  in
                    Prims.strcat
      ...
      (fun uu____3739  ->
         FStar_List.iter
           (fun uu____3751  ->
              ...
              | (e,msg,r) ->
                  let uu____3761 =
                    let uu____3766 = message_prefix.append_prefix msg  in
                    (e, uu____3766)  in
                  log_issue r uu____3761) errs)
  
let (issue_of_exn : Prims.exn -> issue FStar_Pervasives_Native.option) =
  fun uu___27_3771  ->
    match uu___27_3771 with
    | Error (e,msg,r) ->
        let errno = errno_of_error e  in
        let uu____3778 =
          let uu____3779 = message_prefix.append_prefix msg  in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____3779
            (FStar_Pervasives_Native.Some errno)
           in
        FStar_Pervasives_Native.Some uu____3778
    | FStar_Util.NYI msg ->
        let uu____3781 =
          let uu____3782 = message_prefix.append_prefix msg  in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____3782
            FStar_Pervasives_Native.None
           in
    ...
    | Err (e,msg) ->
        ...
        let uu____3786 =
          ...
          mk_issue EError FStar_Pervasives_Native.None uu____3787
            (FStar_Pervasives_Native.Some errno)
           in
        FStar_Pervasives_Native.Some uu____3786
    | uu____3788 -> FStar_Pervasives_Native.None
...
let (err_exn : Prims.exn -> Prims.unit) =
  fun exn  ->
    ...
    then ()
      ...
      (let uu____3793 = issue_of_exn exn  in
...
let (handleable : Prims.exn -> Prims.bool) =
  fun uu___28_3799  ->
    match uu___28_3799 with
    | Error uu____3800 -> true
    | FStar_Util.NYI uu____3807 -> true
    | Stop  -> true
    | Err uu____3808 -> true
    | uu____3813 -> false
...
let (stop_if_err : Prims.unit -> Prims.unit) =
  fun uu____3816  ->
    let uu____3817 =
      let uu____3818 = get_err_count ()  in
      uu____3818 > (Prims.parse_int "0")  in
    if uu____3817 then FStar_Exn.raise Stop else ()
  
let raise_error :
  'Auu____3823 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____3823
  =
  fun uu____3834  ->
    fun r  ->
      match uu____3834 with | (e,msg) -> FStar_Exn.raise (Error (e, msg, r))
  
let raise_err :
  'Auu____3844 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____3844
  =
  fun uu____3852  ->
    match uu____3852 with | (e,msg) -> FStar_Exn.raise (Err (e, msg))
  
let (update_flags :
  (flag,Prims.string) FStar_Pervasives_Native.tuple2 Prims.list -> Prims.unit)
  =
  fun l  ->
    let compare1 uu____3895 uu____3896 =
      match (uu____3895, uu____3896) with
      | ((uu____3929,(a,uu____3931)),(uu____3932,(b,uu____3934))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____4002 = FStar_ST.op_Bang flags  in
        FStar_List.nth uu____4002 i  in
      match l1 with
      | [] -> d
      | (f,(l2,h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____4113 =
            let uu____4116 =
              let uu____4119 = set_flag i sorted1  in [uu____4119]  in
            FStar_List.append f uu____4116  in
          aux uu____4113 (i + (Prims.parse_int "1")) tl1 sorted1
       in
    let rec compute_range result l1 =
      ...
      | (f,s)::tl1 ->
          ...
          let uu____4199 =
            match r with
            | r1::r2::[] ->
                let uu____4210 = FStar_Util.int_of_string r1  in
                let uu____4211 = FStar_Util.int_of_string r2  in
                (uu____4210, uu____4211)
            | uu____4212 ->
                let uu____4215 =
                  let uu____4220 =
                    FStar_Util.format1 "Malformed warn-error range %s" s  in
                  (Fatal_InvalidWarnErrorSetting, uu____4220)  in
                raise_err uu____4215
             in
           ...
           | (l2,h) ->
               (if
                ...
                then
                  (let uu____4242 =
                     let uu____4247 =
                       let uu____4248 = FStar_Util.string_of_int l2  in
                       let uu____4249 = FStar_Util.string_of_int h  in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____4248 uu____4249
                        in
                     (Fatal_InvalidWarnErrorSetting, uu____4247)  in
                   raise_err uu____4242)
                else ();
    ...
    let uu____4317 =
      let uu____4320 = FStar_ST.op_Bang flags  in
      aux [] (Prims.parse_int "0") uu____4320 sorted1  in
    FStar_ST.op_Colon_Equals flags uu____4317
