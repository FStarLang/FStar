...
let (uu___is_Stop : Prims.exn -> Prims.bool) =
  fun projectee -> match projectee with | Stop -> true | uu____5054 -> false
...
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee -> match projectee with | EInfo -> true | uu____5087 -> false
          ...
          let uu____5432 =
            ...
            then ""
              ...
              (let uu____5443 = FStar_Range.string_of_range r in
               FStar_Util.format1 " (see also %s)" uu____5443) in
          (uu____5427, uu____5432) in
    ...
    | (range_str, see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              ...
              FStar_Util.format1 " %s" uu____5463 in
...
let (mk_default_handler : Prims.bool -> error_handler) =
  fun print7 ->
    ...
    let count_errors uu____5604 =
      let uu____5605 = FStar_ST.op_Bang errs in FStar_List.length uu____5605 in
...
let (message_prefix : error_message_prefix) =
  ...
  let append_prefix s =
    ...
    | FStar_Pervasives_Native.Some p ->
        ...
        FStar_String.op_Hat p uu____6272 in
...
let (stop_if_err : unit -> unit) =
  fun uu____6588 ->
    let uu____6589 =
      let uu____6591 = get_err_count () in uu____6591 > (Prims.parse_int "0") in
  ...
  fun l ->
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          ...
          aux uu____6991 (i + (Prims.parse_int "1")) tl1 sorted1 in
...
let catch_errors :
  ...
  fun f ->
    ...
    (let r =
       ...
       with
       | uu___278_7350 ->
           (err_exn uu___278_7350; FStar_Pervasives_Native.None) in
