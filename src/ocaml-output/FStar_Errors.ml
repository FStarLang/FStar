...
let uu___is_Error_NonTopRecFunctionNotFullyEncoded : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Error_NonTopRecFunctionNotFullyEncoded -> begin
true
end
| uu____1581 -> begin
false
...
let uu___is_Warning_SMTErrorReason : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Warning_SMTErrorReason -> begin
true
end
| uu____3572 -> begin
false
...
let uu___is_Warning_CoercionNotFound : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Warning_CoercionNotFound -> begin
true
end
| uu____3583 -> begin
false
...
let uu___is_Error_QuakeFailed : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Error_QuakeFailed -> begin
true
end
| uu____3594 -> begin
false
...
let uu___is_Error_IllSMTPat : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Error_IllSMTPat -> begin
true
end
| uu____3605 -> begin
false
...
let uu___is_Error_IllScopedTerm : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Error_IllScopedTerm -> begin
true
end
| uu____3616 -> begin
false
...
let uu___is_Warning_UnusedLetRec : raw_error  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Warning_UnusedLetRec -> begin
true
end
| uu____3627 -> begin
false
...
let __proj__Error__item__uu___ : Prims.exn  ->  error = (fun projectee -> (match (projectee) with
| Error (uu____5033) -> begin
uu____5033
end))
...
let __proj__Warning__item__uu___ : Prims.exn  ->  error = (fun projectee -> (match (projectee) with
| Warning (uu____5056) -> begin
uu____5056
end))
...
let uu____5416 = (match (issue.issue_range) with
...
let uu____5441 = (FStar_Range.string_of_use_range r)
in (FStar_Util.format1 "%s: " uu____5441))
in (
...
let uu____5448 = (FStar_Range.use_range r)
in (

let uu____5449 = (FStar_Range.def_range r)
in (Prims.op_Equality uu____5448 uu____5449)))
...
let uu____5455 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 " (see also %s)" uu____5455))
end))
in ((uu____5439), (uu____5444))))
end)
...
in (FStar_Util.format1 " %s" uu____5475))
end)
...
let uu____5495 = (format_issue issue)
in (printer uu____5495))))
...
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.Some (uu____5519)) -> begin
(~- ((Prims.parse_int "1")))
end
| (FStar_Pervasives_Native.Some (uu____5525), FStar_Pervasives_Native.None) -> begin
(Prims.parse_int "1")
end
...
let uu____5561 = (FStar_ST.op_Bang errs)
in (e)::uu____5561)
in (FStar_ST.op_Colon_Equals errs uu____5558))
end
| uu____5610 -> begin
(print_issue e)
end))
...
let count_errors = (fun uu____5616 -> (

let uu____5617 = (FStar_ST.op_Bang errs)
in (FStar_List.length uu____5617)))
in (

let report = (fun uu____5650 -> (

let sorted1 = (

let uu____5654 = (FStar_ST.op_Bang errs)
in (FStar_List.sortWith compare_issues uu____5654))
...
let clear1 = (fun uu____5689 -> (FStar_ST.op_Colon_Equals errs []))
...
let get_err_count : unit  ->  Prims.int = (fun uu____5757 -> (

let uu____5758 = (

let uu____5764 = (FStar_ST.op_Bang current_handler)
in uu____5764.eh_count_errors)
in (uu____5758 ())))
...
let uu____5800 = (FStar_ST.op_Bang FStar_Options.abort_counter)
in (uu____5800 - (Prims.parse_int "1")))
in (FStar_ST.op_Colon_Equals FStar_Options.abort_counter uu____5798));
(

let uu____5845 = (

let uu____5847 = (FStar_ST.op_Bang FStar_Options.abort_counter)
in (Prims.op_Equality uu____5847 (Prims.parse_int "0")))
...
let add_one : issue  ->  unit = (fun issue -> (FStar_Util.atomically (fun uu____5886 -> (

let uu____5887 = (FStar_ST.op_Bang current_handler)
in (wrapped_eh_add_one uu____5887 issue)))))


let add_many : issue Prims.list  ->  unit = (fun issues -> (FStar_Util.atomically (fun uu____5919 -> (

let uu____5920 = (

let uu____5925 = (FStar_ST.op_Bang current_handler)
in (wrapped_eh_add_one uu____5925))
in (FStar_List.iter uu____5920 issues)))))


let report_all : unit  ->  issue Prims.list = (fun uu____5952 -> (

let uu____5953 = (

let uu____5960 = (FStar_ST.op_Bang current_handler)
in uu____5960.eh_report)
in (uu____5953 ())))


let clear : unit  ->  unit = (fun uu____5985 -> (

let uu____5986 = (

let uu____5991 = (FStar_ST.op_Bang current_handler)
in uu____5991.eh_clear)
in (uu____5986 ())))
...
let clear_prefix = (fun uu____6214 -> (FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None))
in (

let append_prefix = (fun s -> (

let uu____6250 = (FStar_ST.op_Bang pfx)
...
let uu____6284 = (FStar_String.op_Hat ": " s)
in (FStar_String.op_Hat p uu____6284))
end)))
in {set_prefix = set_prefix; append_prefix = append_prefix; clear_prefix = clear_prefix}))))


let findIndex : 'Auu____6296 'Auu____6297 . ('Auu____6296 * 'Auu____6297) Prims.list  ->  'Auu____6296  ->  Prims.int = (fun l v1 -> (FStar_All.pipe_right l (FStar_List.index (fun uu___0_6335 -> (match (uu___0_6335) with
| (e, uu____6342) when (Prims.op_Equality e v1) -> begin
true
end
| uu____6344 -> begin
false
...
let uu____6377 = (FStar_Options.debug_any ())
...
let uu____6402 = ((Prims.op_Equality errno defensive_errno) && (FStar_Options.defensive_fail ()))
...
let log_issue : FStar_Range.range  ->  (raw_error * Prims.string)  ->  unit = (fun r uu____6423 -> (match (uu____6423) with
| (e, msg) -> begin
(
...
let uu____6436 = (FStar_Options.error_flags ())
in (lookup uu____6436 errno))
...
let uu____6444 = (FStar_Options.ide ())
...
let uu____6451 = (format_issue i)
in (FStar_String.op_Hat "don\'t use log_issue to report fatal error, should use raise_error: " uu____6451))
in (failwith uu____6449))
end)))
end)))
end))


let add_errors : (raw_error * Prims.string * FStar_Range.range) Prims.list  ->  unit = (fun errs -> (FStar_Util.atomically (fun uu____6479 -> (FStar_List.iter (fun uu____6492 -> (match (uu____6492) with
| (e, msg, r) -> begin
(
...
in ((e), (uu____6511)))
in (log_issue r uu____6505))
end)) errs))))


let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___1_6521 -> (match (uu___1_6521) with
| Error (e, msg, r) -> begin
(
...
let uu____6532 = (message_prefix.append_prefix msg)
in (mk_issue EError (FStar_Pervasives_Native.Some (r)) uu____6532 (FStar_Pervasives_Native.Some (errno))))
in FStar_Pervasives_Native.Some (uu____6531)))
end
...
let uu____6538 = (message_prefix.append_prefix msg)
in (mk_issue ENotImplemented FStar_Pervasives_Native.None uu____6538 FStar_Pervasives_Native.None))
in FStar_Pervasives_Native.Some (uu____6537))
end
| Err (e, msg) -> begin
(
...
let uu____6548 = (message_prefix.append_prefix msg)
in (mk_issue EError FStar_Pervasives_Native.None uu____6548 (FStar_Pervasives_Native.Some (errno))))
...
let uu____6561 = (issue_of_exn exn)
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___2_6571 -> (match (uu___2_6571) with
| Error (uu____6573) -> begin
true
end
| FStar_Util.NYI (uu____6575) -> begin
true
end
| Stop -> begin
true
end
| Err (uu____6579) -> begin
true
end
| uu____6586 -> begin
false
...
let stop_if_err : unit  ->  unit = (fun uu____6593 -> (

let uu____6594 = (

let uu____6596 = (get_err_count ())
in (uu____6596 > (Prims.parse_int "0")))
...
let raise_error : 'Auu____6609 . (raw_error * Prims.string)  ->  FStar_Range.range  ->  'Auu____6609 = (fun uu____6623 r -> (match (uu____6623) with
| (e, msg) -> begin
(FStar_Exn.raise (Error (((e), (msg), (r)))))
end))


let raise_err : 'Auu____6640 . (raw_error * Prims.string)  ->  'Auu____6640 = (fun uu____6650 -> (match (uu____6650) with
| (e, msg) -> begin
...
let compare1 = (fun uu____6718 uu____6719 -> (match (((uu____6718), (uu____6719))) with
| ((uu____6761, (a, uu____6763)), (uu____6764, (b, uu____6766))) -> begin
(match ((a > b)) with
| true -> begin
(Prims.parse_int "1")
end
...
| (uu____6835, FStar_Options.CFatal) -> begin
...
let uu____7002 = (set_flag i sorted1)
in (uu____7002)::[])
in (FStar_List.append f uu____6999))
in (aux uu____6996 (i + (Prims.parse_int "1")) tl1 sorted1))
end))
in (
...
let uu____7104 = (match (r) with
| (r1)::(r2)::[] -> begin
(

let uu____7124 = (FStar_Util.int_of_string r1)
in (

let uu____7126 = (FStar_Util.int_of_string r2)
in ((uu____7124), (uu____7126))))
end
| uu____7130 -> begin
(
...
let uu____7140 = (FStar_Util.format1 "Malformed warn-error range %s" s)
in ((Fatal_InvalidWarnErrorSetting), (uu____7140)))
in (raise_err uu____7134))
end)
...
let uu____7183 = (FStar_Util.string_of_int l2)
in (

let uu____7185 = (FStar_Util.string_of_int h)
in (FStar_Util.format2 "No error for warn_error %s..%s" uu____7183 uu____7185)))
in ((Fatal_InvalidWarnErrorSetting), (uu____7181)))
in (raise_err uu____7175))
end
| uu____7189 -> begin
()
end);
...
let r = (FStar_All.try_with (fun uu___279_7349 -> (match (()) with
| () -> begin
(

let r = (f ())
in FStar_Pervasives_Native.Some (r))
end)) (fun uu___278_7355 -> ((err_exn uu___278_7355);
FStar_Pervasives_Native.None;
)))
in (
