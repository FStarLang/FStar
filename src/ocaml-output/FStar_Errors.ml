...
let (uu___is_CError : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CError  -> true | uu____1212 -> false
  
let (uu___is_CFatal : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CFatal  -> true | uu____1216 -> false
  
let (uu___is_CWarning : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CWarning  -> true | uu____1220 -> false
  
let (uu___is_CSilent : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CSilent  -> true | uu____1224 -> false
...
let (uu___is_ENotImplemented : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | ENotImplemented  -> true | uu____2579 -> false
  
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EInfo  -> true | uu____2583 -> false
  
let (uu___is_EWarning : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EWarning  -> true | uu____2587 -> false
  
let (uu___is_EError : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EError  -> true | uu____2591 -> false
  ...
  fun issue  ->
    ...
    let uu____2790 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____2800 =
            let uu____2801 = FStar_Range.string_of_use_range r  in
            FStar_Util.format1 "%s: " uu____2801  in
          let uu____2802 =
            let uu____2803 =
              let uu____2804 = FStar_Range.use_range r  in
              let uu____2805 = FStar_Range.def_range r  in
              uu____2804 = uu____2805  in
            if uu____2803
            then ""
            else
              (let uu____2807 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____2807)
             in
          (uu____2800, uu____2802)
       in
    ...
    | (range_str,see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              let uu____2812 = FStar_Util.string_of_int n1  in
              FStar_Util.format1 " %s" uu____2812
           in
...
let (print_issue : issue -> Prims.unit) =
  fun issue  ->
    ...
    let uu____2821 = format_issue issue  in printer uu____2821
  ...
  fun i1  ->
    fun i2  ->
      ...
      | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some
         uu____2836) -> ~- (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____2841,FStar_Pervasives_Native.None
         ) -> (Prims.parse_int "1")
...
let (default_handler : error_handler) =
  ...
  let add_one e =
    ...
    | EError  ->
        let uu____2863 =
          let uu____2866 = FStar_ST.op_Bang errs  in e :: uu____2866  in
        FStar_ST.op_Colon_Equals errs uu____2863
    | uu____2959 -> print_issue e  in
  let count_errors uu____2963 =
    let uu____2964 = FStar_ST.op_Bang errs  in FStar_List.length uu____2964
     in
  let report uu____3017 =
    let sorted1 =
      let uu____3021 = FStar_ST.op_Bang errs  in
      FStar_List.sortWith compare_issues uu____3021  in
    FStar_List.iter print_issue sorted1; sorted1  in
  let clear1 uu____3073 = FStar_ST.op_Colon_Equals errs []  in
  {
    eh_add_one = add_one;
...
let (get_err_count : Prims.unit -> Prims.int) =
  fun uu____3158  ->
    let uu____3159 =
      let uu____3162 = FStar_ST.op_Bang current_handler  in
      uu____3162.eh_count_errors  in
    uu____3159 ()
...
let (add_one : issue -> Prims.unit) =
  fun issue  ->
    FStar_Util.atomically
      (fun uu____3187  ->
         let uu____3188 =
           let uu____3191 = FStar_ST.op_Bang current_handler  in
           uu____3191.eh_add_one  in
         uu____3188 issue)
...
let (add_many : issue Prims.list -> Prims.unit) =
  fun issues  ->
    FStar_Util.atomically
      (fun uu____3220  ->
         let uu____3221 =
           let uu____3224 = FStar_ST.op_Bang current_handler  in
           uu____3224.eh_add_one  in
         FStar_List.iter uu____3221 issues)
  
let (report_all : Prims.unit -> issue Prims.list) =
  fun uu____3248  ->
    let uu____3249 =
      let uu____3254 = FStar_ST.op_Bang current_handler  in
      uu____3254.eh_report  in
    uu____3249 ()
  
let (clear : Prims.unit -> Prims.unit) =
  fun uu____3276  ->
    let uu____3277 =
      let uu____3280 = FStar_ST.op_Bang current_handler  in
      uu____3280.eh_clear  in
    uu____3277 ()
...
let (message_prefix : error_message_prefix) =
  ...
  let clear_prefix uu____3458 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None  in
  let append_prefix s =
    let uu____3508 = FStar_ST.op_Bang pfx  in
...
let findIndex :
  'Auu____3561 'Auu____3562 .
    ('Auu____3561,'Auu____3562) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____3561 -> Prims.int
  =
  fun l  ->
    fun v1  ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___28_3596  ->
              match uu___28_3596 with
              | (e,uu____3602) when e = v1 -> true
              | uu____3603 -> false))
...
let (init_warn_error_flags : Prims.unit) =
  let rec aux r l =
    match l with | [] -> r | (e,f)::tl1 -> aux (FStar_List.append r [f]) tl1
     in
  let uu____3672 = aux [] default_flags  in
  FStar_ST.op_Colon_Equals flags uu____3672 
...
let (lookup : flag Prims.list -> Prims.int -> flag) =
  fun flags1  ->
    fun errno  ->
      ...
      if uu____3716 then CError else FStar_List.nth flags1 errno
  ...
  fun r  ->
    fun uu____3727  ->
      ...
      | (e,msg) ->
          ...
          let uu____3735 =
            let uu____3736 = FStar_ST.op_Bang flags  in
            lookup uu____3736 errno  in
           ...
           | CFatal  ->
               let i =
                 mk_issue EError (FStar_Pervasives_Native.Some r) msg
                   (FStar_Pervasives_Native.Some errno)
                  in
               let uu____3763 = FStar_Options.ide ()  in
               if uu____3763
               then add_one i
               else
                 (let uu____3765 =
                    let uu____3766 = format_issue i  in
                    Prims.strcat
      ...
      (fun uu____3787  ->
         FStar_List.iter
           (fun uu____3799  ->
              ...
              | (e,msg,r) ->
                  let uu____3809 =
                    let uu____3814 = message_prefix.append_prefix msg  in
                    (e, uu____3814)  in
                  log_issue r uu____3809) errs)
  
let (issue_of_exn : Prims.exn -> issue FStar_Pervasives_Native.option) =
  fun uu___29_3819  ->
    match uu___29_3819 with
    | Error (e,msg,r) ->
        let errno = errno_of_error e  in
        let uu____3826 =
          let uu____3827 = message_prefix.append_prefix msg  in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____3827
            (FStar_Pervasives_Native.Some errno)
           in
        FStar_Pervasives_Native.Some uu____3826
    | FStar_Util.NYI msg ->
        let uu____3829 =
          let uu____3830 = message_prefix.append_prefix msg  in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____3830
            FStar_Pervasives_Native.None
           in
    ...
    | Err (e,msg) ->
        let errno = errno_of_error e  in
        let uu____3834 =
          let uu____3835 = message_prefix.append_prefix msg  in
          mk_issue EError FStar_Pervasives_Native.None uu____3835
            (FStar_Pervasives_Native.Some errno)
           in
...
let (err_exn : Prims.exn -> Prims.unit) =
  fun exn  ->
    ...
    then ()
      ...
      (let uu____3841 = issue_of_exn exn  in
...
let (handleable : Prims.exn -> Prims.bool) =
  fun uu___30_3847  ->
    match uu___30_3847 with
    | Error uu____3848 -> true
    | FStar_Util.NYI uu____3855 -> true
    | Stop  -> true
    | Err uu____3856 -> true
    | uu____3861 -> false
...
let (stop_if_err : Prims.unit -> Prims.unit) =
  fun uu____3864  ->
    let uu____3865 =
      let uu____3866 = get_err_count ()  in
      uu____3866 > (Prims.parse_int "0")  in
    if uu____3865 then FStar_Exn.raise Stop else ()
  
let raise_error :
  'Auu____3871 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____3871
  =
  fun uu____3882  ->
    fun r  ->
      match uu____3882 with | (e,msg) -> FStar_Exn.raise (Error (e, msg, r))
  
let raise_err :
  'Auu____3892 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____3892
  =
  fun uu____3900  ->
    match uu____3900 with | (e,msg) -> FStar_Exn.raise (Err (e, msg))
  
let (update_flags :
  (flag,Prims.string) FStar_Pervasives_Native.tuple2 Prims.list -> Prims.unit)
  =
  fun l  ->
    let compare1 uu____3943 uu____3944 =
      match (uu____3943, uu____3944) with
      | ((uu____3977,(a,uu____3979)),(uu____3980,(b,uu____3982))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____4050 = FStar_ST.op_Bang flags  in
        FStar_List.nth uu____4050 i  in
      match l1 with
      | [] -> d
      | (f,(l2,h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____4161 =
            let uu____4164 =
              let uu____4167 = set_flag i sorted1  in [uu____4167]  in
            FStar_List.append f uu____4164  in
          aux uu____4161 (i + (Prims.parse_int "1")) tl1 sorted1
       in
    let rec compute_range result l1 =
      ...
      | (f,s)::tl1 ->
          ...
          let uu____4247 =
            match r with
            | r1::r2::[] ->
                let uu____4258 = FStar_Util.int_of_string r1  in
                let uu____4259 = FStar_Util.int_of_string r2  in
                (uu____4258, uu____4259)
            | uu____4260 ->
                let uu____4263 =
                  let uu____4268 =
                    FStar_Util.format1 "Malformed warn-error range %s" s  in
                  (Fatal_InvalidWarnErrorSetting, uu____4268)  in
                raise_err uu____4263
             in
           ...
           | (l2,h) ->
               (if
                ...
                then
                  (let uu____4290 =
                     let uu____4295 =
                       let uu____4296 = FStar_Util.string_of_int l2  in
                       let uu____4297 = FStar_Util.string_of_int h  in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____4296 uu____4297
                        in
                     (Fatal_InvalidWarnErrorSetting, uu____4295)  in
                   raise_err uu____4290)
                else ();
    ...
    let uu____4365 =
      let uu____4368 = FStar_ST.op_Bang flags  in
      aux [] (Prims.parse_int "0") uu____4368 sorted1  in
    FStar_ST.op_Colon_Equals flags uu____4365
