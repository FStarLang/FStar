          ...
          let uu____2658 =
            ...
            then ""
              ...
              (let uu____2663 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____2663)
             in
...
let default_handler : error_handler =
  ...
  let count_errors uu____2861 =
    let uu____2862 = FStar_ST.op_Bang errs  in FStar_List.length uu____2862
     in
...
let stop_if_err : Prims.unit -> Prims.unit =
  fun uu____4100  ->
    let uu____4101 =
      let uu____4102 = get_err_count ()  in
      uu____4102 > (Prims.parse_int "0")  in
  ...
  fun l  ->
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          ...
          aux uu____4426 (i + (Prims.parse_int "1")) tl1 sorted1
       in
