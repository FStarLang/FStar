...
type raw_error =
  ...
  | Warning_QuantifierWithoutPattern [@@deriving show]
...
let (uu___is_Error_DidNotFail : raw_error -> Prims.bool) =
  fun projectee  ->
    match projectee with | Error_DidNotFail  -> true | uu____1212 -> false
...
let (uu___is_CFatal : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CFatal  -> true | uu____1224 -> false
  
let (uu___is_CAlwaysError : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CAlwaysError  -> true | uu____1228 -> false
  
let (uu___is_CError : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CError  -> true | uu____1232 -> false
  
let (uu___is_CWarning : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CWarning  -> true | uu____1236 -> false
  
let (uu___is_CSilent : flag -> Prims.bool) =
  fun projectee  ->
    match projectee with | CSilent  -> true | uu____1240 -> false
...
let (uu___is_ENotImplemented : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | ENotImplemented  -> true | uu____2607 -> false
  
let (uu___is_EInfo : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EInfo  -> true | uu____2611 -> false
  
let (uu___is_EWarning : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EWarning  -> true | uu____2615 -> false
  
let (uu___is_EError : issue_level -> Prims.bool) =
  fun projectee  ->
    match projectee with | EError  -> true | uu____2619 -> false
  ...
  fun issue  ->
    ...
    let uu____2818 =
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____2828 =
            let uu____2829 = FStar_Range.string_of_use_range r  in
            FStar_Util.format1 "%s: " uu____2829  in
          let uu____2830 =
            let uu____2831 =
              let uu____2832 = FStar_Range.use_range r  in
              let uu____2833 = FStar_Range.def_range r  in
              uu____2832 = uu____2833  in
            if uu____2831
            then ""
            else
              (let uu____2835 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____2835)
             in
    ...
    | (range_str,see_also_str) ->
        let issue_number =
          ...
          | FStar_Pervasives_Native.Some n1 ->
              let uu____2840 = FStar_Util.string_of_int n1  in
...
let (print_issue : issue -> Prims.unit) =
  fun issue  ->
    ...
    let uu____2849 = format_issue issue  in printer uu____2849
  ...
  fun i1  ->
    fun i2  ->
      ...
      | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some
         uu____2864) -> ~- (Prims.parse_int "1")
      | (FStar_Pervasives_Native.Some uu____2869,FStar_Pervasives_Native.None
         ) -> (Prims.parse_int "1")
...
let (mk_default_handler : Prims.bool -> error_handler) =
  fun print7  ->
    ...
    let add_one e =
      ...
      | EError  ->
          let uu____2894 =
            let uu____2897 = FStar_ST.op_Bang errs  in e :: uu____2897  in
          FStar_ST.op_Colon_Equals errs uu____2894
      | uu____2990 -> print_issue e  in
    let count_errors uu____2994 =
      let uu____2995 = FStar_ST.op_Bang errs  in FStar_List.length uu____2995
       in
    let report uu____3048 =
      let sorted1 =
        let uu____3052 = FStar_ST.op_Bang errs  in
        FStar_List.sortWith compare_issues uu____3052  in
      if print7 then FStar_List.iter print_issue sorted1 else (); sorted1  in
    let clear1 uu____3105 = FStar_ST.op_Colon_Equals errs []  in
    {
      eh_add_one = add_one;
...
let (get_err_count : Prims.unit -> Prims.int) =
  fun uu____3190  ->
    let uu____3191 =
      let uu____3194 = FStar_ST.op_Bang current_handler  in
      uu____3194.eh_count_errors  in
    uu____3191 ()
...
let (add_one : issue -> Prims.unit) =
  fun issue  ->
    FStar_Util.atomically
      (fun uu____3219  ->
         let uu____3220 =
           let uu____3223 = FStar_ST.op_Bang current_handler  in
           uu____3223.eh_add_one  in
         uu____3220 issue)
...
let (add_many : issue Prims.list -> Prims.unit) =
  fun issues  ->
    FStar_Util.atomically
      (fun uu____3252  ->
         let uu____3253 =
           let uu____3256 = FStar_ST.op_Bang current_handler  in
           uu____3256.eh_add_one  in
         FStar_List.iter uu____3253 issues)
  
let (report_all : Prims.unit -> issue Prims.list) =
  fun uu____3280  ->
    let uu____3281 =
      let uu____3286 = FStar_ST.op_Bang current_handler  in
      uu____3286.eh_report  in
    uu____3281 ()
  
let (clear : Prims.unit -> Prims.unit) =
  fun uu____3308  ->
    let uu____3309 =
      let uu____3312 = FStar_ST.op_Bang current_handler  in
      uu____3312.eh_clear  in
    uu____3309 ()
...
let (message_prefix : error_message_prefix) =
  ...
  let clear_prefix uu____3490 =
    FStar_ST.op_Colon_Equals pfx FStar_Pervasives_Native.None  in
  let append_prefix s =
    let uu____3540 = FStar_ST.op_Bang pfx  in
...
let findIndex :
  'Auu____3593 'Auu____3594 .
    ('Auu____3593,'Auu____3594) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____3593 -> Prims.int
  =
  fun l  ->
    fun v1  ->
      FStar_All.pipe_right l
        (FStar_List.index
           (fun uu___28_3628  ->
              match uu___28_3628 with
              | (e,uu____3634) when e = v1 -> true
              | uu____3635 -> false))
...
let (init_warn_error_flags : Prims.unit) =
  let rec aux r l =
    match l with | [] -> r | (e,f)::tl1 -> aux (FStar_List.append r [f]) tl1
     in
  let uu____3704 = aux [] default_flags  in
  FStar_ST.op_Colon_Equals flags uu____3704 
let (diag : FStar_Range.range -> Prims.string -> Prims.unit) =
  fun r  ->
    fun msg  ->
      let uu____3736 = FStar_Options.debug_any ()  in
      if uu____3736
      then
        add_one
...
let (lookup : flag Prims.list -> Prims.int -> flag) =
  fun flags1  ->
    fun errno  ->
      ...
      if uu____3748 then CAlwaysError else FStar_List.nth flags1 errno
  ...
  fun r  ->
    fun uu____3759  ->
      ...
      | (e,msg) ->
          ...
          let uu____3767 =
            let uu____3768 = FStar_ST.op_Bang flags  in
            lookup uu____3768 errno  in
           ...
           | CFatal  ->
               let i =
                 mk_issue EError (FStar_Pervasives_Native.Some r) msg
                   (FStar_Pervasives_Native.Some errno)
                  in
               let uu____3795 = FStar_Options.ide ()  in
               if uu____3795
               then add_one i
               else
                 (let uu____3797 =
                    let uu____3798 = format_issue i  in
                    Prims.strcat
      ...
      (fun uu____3819  ->
         FStar_List.iter
           (fun uu____3831  ->
              ...
              | (e,msg,r) ->
                  let uu____3841 =
                    let uu____3846 = message_prefix.append_prefix msg  in
                    (e, uu____3846)  in
                  log_issue r uu____3841) errs)
  
let (issue_of_exn : Prims.exn -> issue FStar_Pervasives_Native.option) =
  fun uu___29_3851  ->
    match uu___29_3851 with
    | Error (e,msg,r) ->
        let errno = errno_of_error e  in
        let uu____3858 =
          let uu____3859 = message_prefix.append_prefix msg  in
          mk_issue EError (FStar_Pervasives_Native.Some r) uu____3859
            (FStar_Pervasives_Native.Some errno)
           in
        FStar_Pervasives_Native.Some uu____3858
    | FStar_Util.NYI msg ->
        let uu____3861 =
          let uu____3862 = message_prefix.append_prefix msg  in
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____3862
            FStar_Pervasives_Native.None
           in
        FStar_Pervasives_Native.Some uu____3861
    | Err (e,msg) ->
        let errno = errno_of_error e  in
        let uu____3866 =
          let uu____3867 = message_prefix.append_prefix msg  in
          mk_issue EError FStar_Pervasives_Native.None uu____3867
            (FStar_Pervasives_Native.Some errno)
           in
...
let (err_exn : Prims.exn -> Prims.unit) =
  fun exn  ->
    ...
    then ()
      ...
      (let uu____3873 = issue_of_exn exn  in
...
let (handleable : Prims.exn -> Prims.bool) =
  fun uu___30_3879  ->
    match uu___30_3879 with
    | Error uu____3880 -> true
    | FStar_Util.NYI uu____3887 -> true
    | Stop  -> true
    | Err uu____3888 -> true
    | uu____3893 -> false
...
let (stop_if_err : Prims.unit -> Prims.unit) =
  fun uu____3896  ->
    let uu____3897 =
      let uu____3898 = get_err_count ()  in
      uu____3898 > (Prims.parse_int "0")  in
    if uu____3897 then FStar_Exn.raise Stop else ()
  
let raise_error :
  'Auu____3903 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 ->
      FStar_Range.range -> 'Auu____3903
  =
  fun uu____3914  ->
    fun r  ->
      match uu____3914 with | (e,msg) -> FStar_Exn.raise (Error (e, msg, r))
  
let raise_err :
  'Auu____3924 .
    (raw_error,Prims.string) FStar_Pervasives_Native.tuple2 -> 'Auu____3924
  =
  fun uu____3932  ->
    match uu____3932 with | (e,msg) -> FStar_Exn.raise (Err (e, msg))
  
let (update_flags :
  (flag,Prims.string) FStar_Pervasives_Native.tuple2 Prims.list -> Prims.unit)
  =
  fun l  ->
    let compare1 uu____3975 uu____3976 =
      match (uu____3975, uu____3976) with
      | ((uu____4009,(a,uu____4011)),(uu____4012,(b,uu____4014))) ->
          if a > b
    ...
    let rec set_flag i l1 =
      let d =
        let uu____4082 = FStar_ST.op_Bang flags  in
        FStar_List.nth uu____4082 i  in
      match l1 with
      | [] -> d
      | (f,(l2,h))::tl1 ->
          if (i >= l2) && (i <= h)
    ...
    let rec aux f i l1 sorted1 =
      ...
      | hd1::tl1 ->
          let uu____4193 =
            let uu____4196 =
              let uu____4199 = set_flag i sorted1  in [uu____4199]  in
            FStar_List.append f uu____4196  in
          aux uu____4193 (i + (Prims.parse_int "1")) tl1 sorted1
       in
    let rec compute_range result l1 =
      ...
      | (f,s)::tl1 ->
          ...
          let uu____4279 =
            match r with
            | r1::r2::[] ->
                let uu____4290 = FStar_Util.int_of_string r1  in
                let uu____4291 = FStar_Util.int_of_string r2  in
                (uu____4290, uu____4291)
            | uu____4292 ->
                let uu____4295 =
                  let uu____4300 =
                    FStar_Util.format1 "Malformed warn-error range %s" s  in
                  (Fatal_InvalidWarnErrorSetting, uu____4300)  in
                raise_err uu____4295
             in
           ...
           | (l2,h) ->
               (if
                ...
                then
                  (let uu____4322 =
                     let uu____4327 =
                       let uu____4328 = FStar_Util.string_of_int l2  in
                       let uu____4329 = FStar_Util.string_of_int h  in
                       FStar_Util.format2 "No error for warn_error %s..%s"
                         uu____4328 uu____4329
                        in
                     (Fatal_InvalidWarnErrorSetting, uu____4327)  in
                   raise_err uu____4322)
                else ();
    ...
    let uu____4397 =
      let uu____4400 = FStar_ST.op_Bang flags  in
      aux [] (Prims.parse_int "0") uu____4400 sorted1  in
    FStar_ST.op_Colon_Equals flags uu____4397
  
let catch_errors : 'a . (Prims.unit -> 'a) -> issue Prims.list =
  fun f  ->
    ...
    (try let uu____4508 = f ()  in () with | ex -> err_exn ex);
    (let errs = newh.eh_report ()  in
     FStar_ST.op_Colon_Equals current_handler old; errs)
