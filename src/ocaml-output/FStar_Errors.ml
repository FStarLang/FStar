...
let issue_of_exn : Prims.exn  ->  issue Prims.option = (fun uu___55_445 -> (match (uu___55_445) with
| Error (msg, r) -> begin
(
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___56_466 -> (match (uu___56_466) with
