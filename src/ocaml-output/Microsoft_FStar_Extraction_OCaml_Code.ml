...
| None -> begin
(match ((let _125_32 = (Support.ST.read Microsoft_FStar_Options.codegen_libs)
in (Support.List.tryPick chkin _125_32))) with
| None -> begin
(outsupport ns)
end
| _59_32 -> begin
...
let ptsym_of_symbol = (fun ( s ) -> (match (((let _125_40 = (Support.String.get s 0)
in (Support.Char.lowercase _125_40)) <> (Support.String.get s 0))) with
| true -> begin
...
in (_125_45)::[])
in (Support.List.append p _125_46))
in (Support.String.concat "." _125_47))
end))
end))
...
| (p, s) -> begin
(let s = (match (((let _125_52 = (Support.String.get s 0)
in (Support.Char.uppercase _125_52)) <> (Support.String.get s 0))) with
| true -> begin
...
in (Support.Prims.strcat "\'" _125_93))
in (Support.Prims.strcat _125_94 "\'"))
end
...
in (let _125_106 = (Support.All.pipe_left escape_tyvar (Microsoft_FStar_Extraction_ML_Syntax.idsym x))
...
in (Support.Option.get _125_113))
in (Support.Prims.snd _125_114))
end
| false -> begin
...
in (let docs = (Support.List.map (fun ( d ) -> (let _125_157 = (let _125_156 = (let _125_155 = (FSharp_Format.text ";")
...
in (let _125_167 = (Support.List.map for1 fields)
...
in (Support.Option.get _125_170))
in (Support.Prims.snd _125_171))
end
| false -> begin
...
in (Support.Option.get _125_172))
in (Support.Prims.snd _125_173))
end
| false -> begin
(ptctor currentModule ctor)
end)
...
in (let _125_279 = (let _125_278 = (let _125_277 = (Support.List.map (doc_of_branch currentModule) pats)
...
in (Support.Option.get _125_290))
...
in (Support.Option.get _125_297))
...
in (let _125_314 = (Support.List.map for1 fields)
...
in (Support.Option.get _125_317))
in (Support.Prims.snd _125_318))
end
| false -> begin
(ptctor currentModule ctor)
end)
...
in (Support.Option.get _125_319))
in (Support.Prims.snd _125_320))
end
| false -> begin
(ptctor currentModule ctor)
end)
...
in (let lets = (Support.List.mapi (fun ( i ) ( doc ) -> (let _125_374 = (let _125_373 = (match ((i = 0)) with
| true -> begin
letdoc
end
| false -> begin
...
in (let _125_391 = (Support.List.map forfield fields)
...
in (let ctors = (Support.List.map (fun ( d ) -> (let _125_403 = (let _125_402 = (FSharp_Format.text "|")
in (_125_402)::(d)::[])
