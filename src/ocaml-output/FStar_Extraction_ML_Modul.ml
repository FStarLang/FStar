...
let ml_params = (let _179_113 = (FStar_All.pipe_right indices (FStar_List.mapi (fun i _82_160 -> (let _179_112 = (let _179_111 = (FStar_Util.string_of_int i)
...
in (let _179_181 = (let _179_180 = (let _179_179 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_179_179))
in (_179_180)::(FStar_Extraction_ML_Syntax.MLM_Let (((flavor), ((FStar_List.append flags flags')), ((FStar_List.rev ml_lbs')))))::[])
in ((g), (_179_181)))))
end))
end
| _82_464 -> begin
(let _179_183 = (let _179_182 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" _179_182))
in (FStar_All.failwith _179_183))
end)
end)))
end
...
| (bs, t) -> begin
(let _179_184 = (fail_exp lid t)
in (FStar_Syntax_Util.abs bs _179_184 None))
end)
in (let _179_190 = (let _179_189 = (let _179_188 = (let _179_187 = (let _179_186 = (let _179_185 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in FStar_Util.Inr (_179_185))
in {FStar_Syntax_Syntax.lbname = _179_186; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (_179_187)::[])
in ((false), (_179_188)))
in ((_179_189), (r), ([]), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (_179_190)))
in (
...
| Some (l) -> begin
(let _179_196 = (let _179_195 = (let _179_192 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_179_192))
in (let _179_194 = (let _179_193 = (FStar_Extraction_ML_Term.ind_discriminator_body g lid l)
in (_179_193)::[])
...
(let _179_200 = (let _179_199 = (let _179_198 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_179_198))
in (_179_199)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (_179_200)))
end))
end
...
let extract_iface : FStar_Extraction_ML_UEnv.env  ->  FStar_Syntax_Syntax.modul  ->  env_t = (fun g m -> (let _179_205 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right _179_205 Prims.fst)))
...
let _82_542 = (let _179_210 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
