...
let as_pair uu___156_81 =
  match uu___156_81 with
  | a::b::[] -> (a, b)
    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1299,attrs) ->
           ...
           let uu____1318 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1380 =
                                        ...
                                        uu____1385.FStar_Syntax_Syntax.fv_name in
                                              ...
                                              (let uu___167_1412 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___167_1412.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___167_1412.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___167_1412.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___167_1412.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1415 =
                                           let uu____1416 =
                          ...
                          let flags =
                            FStar_List.choose
                              (fun uu___163_1439  ->
                                 ...
                                 | uu____1441 -> None) quals in
                          let flags' =
                            FStar_List.choose
                              (fun uu___164_1446  ->
                                 match uu___164_1446 with
                                 | {
                          ...
                          let uu____1463 =
                            let uu____1465 =
                              let uu____1466 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1466 in
                            [uu____1465;
                            FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t1) ->
                     ...
                     FStar_Syntax_Util.abs bs uu____1526 None in
               let uu___168_1532 = se in
               let uu____1533 =
                 let uu____1534 =
                   let uu____1540 =
                     let uu____1544 =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____1534 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___168_1532.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___168_1532.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___168_1532.FStar_Syntax_Syntax.sigmeta)
               } in
           ...
           (match uu____1606 with
            | (ml_main,uu____1614,uu____1615) ->
                let uu____1616 =
                  ...
                  [uu____1618; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____1616))
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1668 = FStar_Options.restore_cmd_line_options true in
       ...
       let g1 =
         let uu___169_1671 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___169_1671.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___169_1671.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___169_1671.FStar_Extraction_ML_UEnv.tydefs);
