                   ...
                   | (a_let,uu____2269,ty) ->
                       ((let uu____2272 =
                        ...
                        (let uu____2275 =
                           ...
                           | uu____2304 -> failwith "Impossible"  in
                      ...
                      | (g3,actions) ->
                          (g3,
                            (FStar_List.append [return_decl; bind_decl]
                               actions)))))
       | FStar_Syntax_Syntax.Sig_splice uu____2417 ->
           failwith "impossible: trying to extract splice"
       | FStar_Syntax_Syntax.Sig_new_effect uu____2430 -> (g, [])
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2434,t) when
           ...
           then (g, [])
             ...
             (let uu____2458 = FStar_Syntax_Util.arrow_formals t  in
              ...
              | (bs,uu____2478) ->
                  ...
                  let uu____2496 =
                    FStar_Syntax_Util.abs bs FStar_Syntax_Syntax.t_unit
                      FStar_Pervasives_Native.None
                     in
                  extract_typ_abbrev g fv quals attrs uu____2496)
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2498) when
           ...
           let uu____2514 =
             ...
             | (tcenv,uu____2547,def_typ) ->
                 let uu____2553 = as_pair def_typ  in (tcenv, uu____2553)
              in
           (match uu____2514 with
            | (tcenv,(lbdef,lbtyp)) ->
                ...
                let uu____2577 =
                  FStar_Util.right lb.FStar_Syntax_Syntax.lbname  in
                extract_typ_abbrev g uu____2577 quals
                  se.FStar_Syntax_Syntax.sigattrs lbdef1)
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2579) ->
           let attrs = se.FStar_Syntax_Syntax.sigattrs  in
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____2590 =
             let uu____2597 =
               FStar_Syntax_Syntax.mk
                ...
                in
             FStar_Extraction_ML_Term.term_as_mlexpr g uu____2597  in
           (match uu____2590 with
            | (ml_let,uu____2607,uu____2608) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,bindings),uu____2617) ->
                     ...
                     let uu____2634 =
                       FStar_List.fold_left2
                         (fun uu____2660  ->
                            fun ml_lb  ->
                              fun uu____2662  ->
                                match (uu____2660, uu____2662) with
                                | ((env,ml_lbs),{
                                    ...
                                    then (env, ml_lbs)
                                      ...
                                      (let lb_lid =
                                         let uu____2725 =
                                           ...
                                           uu____2728.FStar_Syntax_Syntax.fv_name
                                            in
                                         uu____2725.FStar_Syntax_Syntax.v  in
                                       let flags'' =
                                         let uu____2732 =
                                           let uu____2733 =
                                             FStar_Syntax_Subst.compress t
                                              in
                                           uu____2733.FStar_Syntax_Syntax.n
                                            in
                                       ...
                                       let meta =
                                         FStar_List.append flags1
                                          ...
                                          in
                                       let ml_lb1 =
                                         let uu___103_2780 = ml_lb  in
                                         {
                                           FStar_Extraction_ML_Syntax.mllb_name
                                             =
                                             (uu___103_2780.FStar_Extraction_ML_Syntax.mllb_name);
                                           FStar_Extraction_ML_Syntax.mllb_tysc
                                             =
                                             (uu___103_2780.FStar_Extraction_ML_Syntax.mllb_tysc);
                                           FStar_Extraction_ML_Syntax.mllb_add_unit
                                             =
                                             (uu___103_2780.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                           FStar_Extraction_ML_Syntax.mllb_def
                                             =
                                             (uu___103_2780.FStar_Extraction_ML_Syntax.mllb_def);
                                           FStar_Extraction_ML_Syntax.mllb_meta
                                             = meta;
                                           FStar_Extraction_ML_Syntax.print_typ
                                             =
                                             (uu___103_2780.FStar_Extraction_ML_Syntax.print_typ)
                                         }  in
                                       let uu____2781 =
                                         let uu____2786 =
                                           FStar_All.pipe_right quals
                                               ...
                                               (env1,
                                                 (let uu___104_2818 = ml_lb1
                                                     in
                                                  {
                                                    ...
                                                    FStar_Extraction_ML_Syntax.mllb_tysc
                                                      =
                                                      (uu___104_2818.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                    FStar_Extraction_ML_Syntax.mllb_add_unit
                                                      =
                                                      (uu___104_2818.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                    FStar_Extraction_ML_Syntax.mllb_def
                                                      =
                                                      (uu___104_2818.FStar_Extraction_ML_Syntax.mllb_def);
                                                    FStar_Extraction_ML_Syntax.mllb_meta
                                                      =
                                                      (uu___104_2818.FStar_Extraction_ML_Syntax.mllb_meta);
                                                    FStar_Extraction_ML_Syntax.print_typ
                                                      =
                                                      (uu___104_2818.FStar_Extraction_ML_Syntax.print_typ)
                                                  }))
                                         else
                                           (let uu____2822 =
                                              let uu____2823 =
                              ...
                              let uu____2865 =
                                let uu____2866 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2866
                                 in
                              [uu____2865;
                              FStar_Extraction_ML_Syntax.MLM_Let
                                (flavor, (FStar_List.rev ml_lbs'))]
                               in
                            let uu____2869 = maybe_register_plugin g1 se  in
                            FStar_List.append uu____2862 uu____2869  in
                          (g1, uu____2859))
                 | uu____2874 ->
                     let uu____2875 =
                       let uu____2876 =
                       ...
                       FStar_Util.format1
                        ...
                        in
                     failwith uu____2875))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2884,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____2889 =
             (FStar_All.pipe_right quals
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2954  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___105_2952.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___105_2952.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___105_2952.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___105_2952.FStar_Syntax_Syntax.sigattrs)
               }  in
             let uu____2990 = extract_sig g always_fail  in
             (match uu____2990 with
              | (g1,mlm) ->
                  let uu____3009 =
                    FStar_Util.find_map quals
                      (fun uu___101_3014  ->
                         match uu___101_3014 with
                  ...
                  (match uu____3009 with
                         ...
                         let uu____3029 =
                           let uu____3030 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng
                              in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____3030  in
                         let uu____3031 =
                           let uu____3034 =
                   ...
                   | uu____3037 ->
                       let uu____3040 =
                         FStar_Util.find_map quals
                           (fun uu___102_3046  ->
                              match uu___102_3046 with
                              | FStar_Syntax_Syntax.Projector (l,uu____3050)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3051 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____3040 with
                        | FStar_Pervasives_Native.Some uu____3058 -> (g1, [])
                        | uu____3061 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____3070 = FStar_Extraction_ML_Term.term_as_mlexpr g e  in
           (match uu____3070 with
            | (ml_main,uu____3084,uu____3085) ->
                let uu____3086 =
                  let uu____3089 =
                    let uu____3090 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng
                       in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____3090  in
                  [uu____3089; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____3086))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____3093 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____3100 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____3109 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____3112 -> (g, [])
    ...
    fun m  ->
      let uu____3141 =
        FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations
         in
      FStar_All.pipe_right uu____3141 FStar_Pervasives_Native.fst
...
let (extract' :
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____3187 = FStar_Options.restore_cmd_line_options true  in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name
          in
       let g1 =
         let uu___106_3190 = g  in
         let uu____3191 =
           FStar_TypeChecker_Env.set_current_module
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name
            in
         {
           FStar_Extraction_ML_UEnv.tcenv = uu____3191;
           FStar_Extraction_ML_UEnv.gamma =
             (uu___106_3190.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___106_3190.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___106_3190.FStar_Extraction_ML_UEnv.type_names);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____3221 = FStar_Options.codegen ()  in
             uu____3221 =
...
let (extract :
  ...
  fun g  ->
    fun m  ->
      let uu____3312 = FStar_Options.debug_any ()  in
      if uu____3312
      then
        let msg =
          let uu____3320 =
