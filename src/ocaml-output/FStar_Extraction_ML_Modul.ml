      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____4159) ->
           ...
           let uu____4170 =
             ...
             | FStar_Pervasives_Native.Some
                 (ats,(tau,FStar_Pervasives_Native.None )::uu____4208) ->
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___404_4292 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___404_4292.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___404_4292.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___404_4292.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___404_4292.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___404_4292.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___404_4292.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____4300 =
                    match post_tau with
                    ...
                    | FStar_Pervasives_Native.None  ->
                        FStar_Pervasives_Native.snd lbs
                     in
                  ((FStar_Pervasives_Native.fst lbs), uu____4300)  in
                let uu____4314 =
                  let uu____4321 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                     ...
                     in
                  FStar_Extraction_ML_Term.term_as_mlexpr g uu____4321  in
                (match uu____4314 with
                 | (ml_let,uu____4337,uu____4338) ->
                     (match ml_let.FStar_Extraction_ML_Syntax.expr with
                      | FStar_Extraction_ML_Syntax.MLE_Let
                          ((flavor,bindings),uu____4347) ->
                          ...
                          let uu____4364 =
                            FStar_List.fold_left2
                              (fun uu____4390  ->
                                 fun ml_lb  ->
                                   fun uu____4392  ->
                                     match (uu____4390, uu____4392) with
                                     | ((env,ml_lbs),{
                                                       FStar_Syntax_Syntax.lbname
                                                         = lbname;
                                                       FStar_Syntax_Syntax.lbunivs
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____4457 =
                                                ...
                                                uu____4460.FStar_Syntax_Syntax.fv_name
                                                 in
                                              uu____4457.FStar_Syntax_Syntax.v
                                               in
                                            let flags'' =
                                              let uu____4464 =
                                                let uu____4465 =
                                                  FStar_Syntax_Subst.compress
                                                    t
                                                   in
                                                uu____4465.FStar_Syntax_Syntax.n
                                                 in
                                            ...
                                            let meta =
                                              FStar_List.append flags1
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___405_4518 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___405_4518.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___405_4518.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___405_4518.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___405_4518.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___405_4518.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____4519 =
                                              let uu____4524 =
                                                FStar_All.pipe_right quals
                                              ...
                                              then
                                                ...
                                                let uu____4554 =
                                                  ...
                                                  FStar_Extraction_ML_UEnv.extend_fv'
                                                    env uu____4561 mname
                                                    uu____4562
                                                    ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                    false
                                                   in
                                                match uu____4554 with
                                                | (env1,uu____4568,uu____4569)
                                                    ->
                                                    (env1,
                                                      (let uu___406_4571 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___406_4571.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___406_4571.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___406_4571.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___406_4571.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___406_4571.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____4575 =
                                                   let uu____4582 =
                                                   ...
                                                   FStar_Extraction_ML_UEnv.extend_lb
                                                     env lbname t uu____4582
                                                     ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                     false
                                                    in
                                                 match uu____4575 with
                                                 | (env1,uu____4588,uu____4589)
                                                     -> (env1, ml_lb1))
                                               in
                               ...
                               let uu____4616 =
                                 let uu____4619 =
                                   ...
                                   FStar_Extraction_ML_Syntax.MLM_Let
                                    ...
                                    in
                                 let uu____4626 = maybe_register_plugin g1 se
                                    in
                                 FStar_List.append uu____4619 uu____4626  in
                               (g1, uu____4616))
                      | uu____4631 ->
                          let uu____4632 =
                            let uu____4633 =
                            ...
                            FStar_Util.format1
                             ...
                             in
                          failwith uu____4632)))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____4641,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____4646 =
             (FStar_All.pipe_right quals
                (FStar_List.contains FStar_Syntax_Syntax.Assumption))
           ...
           then
             let always_fail1 =
               let uu___407_4658 = se  in
               let uu____4659 =
                 let uu____4660 =
                   let uu____4667 =
                     let uu____4668 =
                       let uu____4671 = always_fail lid t  in [uu____4671]
                        in
                     (false, uu____4668)  in
                   (uu____4667, [])  in
                 FStar_Syntax_Syntax.Sig_let uu____4660  in
               {
                 FStar_Syntax_Syntax.sigel = uu____4659;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___407_4658.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___407_4658.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___407_4658.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___407_4658.FStar_Syntax_Syntax.sigattrs)
               }  in
             let uu____4676 = extract_sig g always_fail1  in
             (match uu____4676 with
              | (g1,mlm) ->
                  let uu____4695 =
                    FStar_Util.find_map quals
                      (fun uu___402_4700  ->
                         match uu___402_4700 with
                  ...
                  (match uu____4695 with
                         ...
                         let uu____4715 =
                           let uu____4716 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng
                              in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____4716  in
                         let uu____4717 =
                           let uu____4720 =
                   ...
                   | uu____4723 ->
                       let uu____4726 =
                         FStar_Util.find_map quals
                           (fun uu___403_4732  ->
                              match uu___403_4732 with
                              | FStar_Syntax_Syntax.Projector (l,uu____4736)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____4737 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____4726 with
                        | FStar_Pervasives_Native.Some uu____4744 -> (g1, [])
                        | uu____4747 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____4756 = FStar_Extraction_ML_Term.term_as_mlexpr g e  in
           (match uu____4756 with
            | (ml_main,uu____4770,uu____4771) ->
                let uu____4772 =
                  let uu____4775 =
                    let uu____4776 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng
                       in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____4776  in
                  [uu____4775; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____4772))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____4779 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____4786 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____4795 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____4798 -> (g, [])
       | FStar_Syntax_Syntax.Sig_pragma p ->
           (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
            (g, [])))
...
let (extract' :
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____4840 = FStar_Options.restore_cmd_line_options true  in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name
          in
       let g1 =
         let uu___408_4843 = g  in
         let uu____4844 =
           FStar_TypeChecker_Env.set_current_module
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name
            in
         {
           FStar_Extraction_ML_UEnv.tcenv = uu____4844;
           FStar_Extraction_ML_UEnv.gamma =
             (uu___408_4843.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___408_4843.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___408_4843.FStar_Extraction_ML_UEnv.type_names);
       ...
       if uu____4845
       then
         let uu____4853 = extract_iface g1 m.FStar_Syntax_Syntax.declarations
            in
         match uu____4853 with | (g2,uu____4865) -> (g2, [])
       else
         (let uu____4869 =
          ...
          | (g2,sigs) ->
              ...
              let is_kremlin =
                let uu____4898 = FStar_Options.codegen ()  in
                uu____4898 =
