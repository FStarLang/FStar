  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_635 =
         ...
         let _0_634 =
           let _0_633 = FStar_Syntax_Syntax.iarg t in
           let _0_632 =
             let _0_631 =
               let _0_630 =
                 (FStar_Syntax_Syntax.mk
                          ...
                          (let _0_629 =
                             FStar_Bytes.string_as_unicode_bytes
                               (let _0_628 =
                                ...
                                Prims.strcat "Not yet implemented:" _0_628) in
                           (_0_629, FStar_Range.dummyRange))))) None
                   FStar_Range.dummyRange in
               FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_630 in
             [_0_631] in
           _0_633 :: _0_632 in
         (_0_635, _0_634)))) None FStar_Range.dummyRange
       ...
       fun uu____70  ->
         ...
         | (bv,uu____78) ->
             let _0_638 =
               ...
               FStar_Extraction_ML_UEnv.extend_ty env bv _0_636 in
             let _0_637 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
             (_0_638, _0_637)) env bs
    ...
    fun fv  ->
      fun quals  ->
        fun def  ->
          ...
          let def =
            let _0_640 =
              let _0_639 = FStar_Syntax_Subst.compress def in
              FStar_All.pipe_right _0_639 FStar_Syntax_Util.unmeta in
            FStar_All.pipe_right _0_640 FStar_Syntax_Util.un_uinst in
          let def =
          ...
          | (bs,body) ->
              ...
              (match uu____165 with
               | (env,ml_bs) ->
                   ...
                   let td =
                     let _0_643 =
                       let _0_642 = lident_as_mlsymbol lid in
                       (assumed, _0_642, mangled_projector, ml_bs,
                   ...
                   let def =
                     ...
                     [_0_644; FStar_Extraction_ML_Syntax.MLM_Ty td] in
                   let env =
                     let uu____235 =
                       FStar_All.pipe_right quals
                         (FStar_Util.for_some
                            (fun uu___148_237  ->
                               match uu___148_237 with
...
let print_ifamily: inductive_family -> Prims.unit =
  fun i  ->
    let _0_652 = FStar_Syntax_Print.lid_to_string i.iname in
    let _0_651 = FStar_Syntax_Print.binders_to_string " " i.iparams in
    let _0_650 = FStar_Syntax_Print.term_to_string i.ityp in
    let _0_649 =
      let _0_648 =
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                let _0_647 = FStar_Syntax_Print.lid_to_string d.dname in
                let _0_646 =
                  let _0_645 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " _0_645 in
                Prims.strcat _0_647 _0_646)) in
      FStar_All.pipe_right _0_648 (FStar_String.concat "\n\t\t") in
    FStar_Util.print4 "\n\t%s %s : %s { %s }\n" _0_652 _0_651 _0_650 _0_649
let bundle_as_inductive_families env ses quals =
  FStar_All.pipe_right ses
    (FStar_List.collect
       (fun uu___150_327  ->
          match uu___150_327 with
  ...
  fun env  ->
    fun se  ->
      let extract_ctor ml_tyvars env ctor =
        let mlt =
          let _0_656 = FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env) _0_656 in
        let tys = (ml_tyvars, mlt) in
        let fvv = FStar_Extraction_ML_UEnv.mkFvvar ctor.dname ctor.dtyp in
        let _0_660 =
          FStar_Extraction_ML_UEnv.extend_fv env fvv tys false false in
        let _0_659 =
          let _0_658 = lident_as_mlsymbol ctor.dname in
          let _0_657 = FStar_Extraction_ML_Util.argTypes mlt in
          (_0_658, _0_657) in
        (_0_660, _0_659) in
                          ...
                          FStar_All.pipe_right indices
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____630  ->
                                    let _0_662 =
                                      let _0_661 = FStar_Util.string_of_int i in
                                      Prims.strcat "'dummyV" _0_661 in
                                    (_0_662, (Prims.parse_int "0")))) in
                        FStar_List.append vars _0_663 in
                      let tbody =
                        let uu____634 =
                          FStar_Util.find_opt
                            (fun uu___151_636  ->
                               match uu___151_636 with
                                   ...
                                   FStar_List.map2
                                     (fun id  ->
                                        fun ty  ->
                                          ...
                                          let _0_664 = lident_as_mlsymbol lid in
                                          (_0_664, ty)) ids c_ty in
                                 FStar_Extraction_ML_Syntax.MLTD_Record
                                   fields)
                        | uu____670 ->
                            FStar_Extraction_ML_Syntax.MLTD_DType ctors in
                      let _0_666 =
                        let _0_665 = lident_as_mlsymbol ind.iname in
                        (false, _0_665, None, ml_params, (Some tbody)) in
                      (env, _0_666))) in
      match se with
  ...
  fun g  ->
    fun se  ->
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let _0_667 = FStar_Syntax_Print.sigelt_to_string se in
       ...
       | FStar_Syntax_Syntax.Sig_new_effect (ed,uu____818) when
           ...
           let extend_env g lid ml_name tm tysc =
             ...
             let g =
               ...
               FStar_Extraction_ML_UEnv.extend_fv' g _0_668 ml_name tysc
                 false false in
             let lb =
               {
           ...
           let rec extract_fv tm =
             ...
             | FStar_Syntax_Syntax.Tm_fvar fv ->
                 ...
                 let uu____871 =
                   let _0_669 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                   FStar_All.pipe_left FStar_Util.right _0_669 in
           ...
           let uu____990 =
             let _0_671 =
               FStar_All.pipe_right quals
                 (FStar_Util.for_some
                    (fun uu___152_992  ->
                       match uu___152_992 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____993 -> false)) in
             FStar_All.pipe_right _0_671 Prims.op_Negation in
           if uu____990
           then (g, [])
           else
              ...
              | (bs,uu____1011) ->
                  ...
                  let _0_672 =
                    FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit
                      None in
                  extract_typ_abbrev g fv quals _0_672)
       | FStar_Syntax_Syntax.Sig_let
           ((false ,lb::[]),uu____1029,uu____1030,quals,uu____1032) when
           FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp
           ->
           let _0_673 = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
           extract_typ_abbrev g _0_673 quals lb.FStar_Syntax_Syntax.lbdef
                                      ...
                                      then
                                        ...
                                        let env =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env _0_676 mname _0_675
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        (env,
                                          (let uu___158_1145 = ml_lb in
                                           {
                                             FStar_Extraction_ML_Syntax.mllb_name
                                               =
                                               ((Prims.snd mname),
                                             ...
                                             FStar_Extraction_ML_Syntax.mllb_tysc
                                               =
                                               (uu___158_1145.FStar_Extraction_ML_Syntax.mllb_tysc);
                                             FStar_Extraction_ML_Syntax.mllb_add_unit
                                               =
                                               (uu___158_1145.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                             FStar_Extraction_ML_Syntax.mllb_def
                                               =
                                               (uu___158_1145.FStar_Extraction_ML_Syntax.mllb_def);
                                             FStar_Extraction_ML_Syntax.print_typ
                                               =
                                               (uu___158_1145.FStar_Extraction_ML_Syntax.print_typ)
                                           }))
                                      else
                                        (let _0_679 =
                                           let _0_678 =
           ...
           then
             let always_fail =
               let imp =
                 ...
                 | ([],t) -> fail_exp lid t
                 | (bs,t) ->
                     let _0_683 = fail_exp lid t in
                     FStar_Syntax_Util.abs bs _0_683 None in
               FStar_Syntax_Syntax.Sig_let
                 (let _0_687 =
                    let _0_686 =
                      let _0_685 =
                        let _0_684 =
                          FStar_Util.Inr
                            (FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant None) in
                        {
                          FStar_Syntax_Syntax.lbname = _0_684;
                          FStar_Syntax_Syntax.lbunivs = [];
            ...
            | (ml_main,uu____1309,uu____1310) ->
                let _0_693 =
                  let _0_692 =
                    FStar_Extraction_ML_Syntax.MLM_Loc
                      (FStar_Extraction_ML_Util.mlloc_of_range r) in
                  [_0_692; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, _0_693))
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right _0_694 Prims.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1353 = FStar_Options.restore_cmd_line_options true in
       ...
       let g =
         let uu___159_1356 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___159_1356.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___159_1356.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___159_1356.FStar_Extraction_ML_UEnv.tydefs);
