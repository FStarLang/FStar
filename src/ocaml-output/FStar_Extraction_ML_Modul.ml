      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_new_effect ed when
           ...
           let extract_action g1 a =
             ...
             (let uu____2100 = FStar_Extraction_ML_UEnv.action_name ed a  in
                      ...
                      | (g3,actions) ->
                          (g3,
                            (FStar_List.append [return_decl; bind_decl]
                               actions)))))
       | FStar_Syntax_Syntax.Sig_splice uu____2302 ->
           failwith "impossible: trying to extract splice"
       | FStar_Syntax_Syntax.Sig_new_effect uu____2315 -> (g, [])
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2319,t) when
              ...
              | (bs,uu____2363) ->
                  ...
                  let uu____2381 =
                    FStar_Syntax_Util.abs bs FStar_Syntax_Syntax.t_unit
                      FStar_Pervasives_Native.None
                     in
                  extract_typ_abbrev g fv quals attrs uu____2381)
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2383) when
           ...
           let uu____2399 =
             ...
             | (tcenv,uu____2432,def_typ) ->
                 let uu____2438 = as_pair def_typ  in (tcenv, uu____2438)
              in
           (match uu____2399 with
            | (tcenv,(lbdef,lbtyp)) ->
                ...
                let uu____2462 =
                  FStar_Util.right lb.FStar_Syntax_Syntax.lbname  in
                extract_typ_abbrev g uu____2462 quals
                  se.FStar_Syntax_Syntax.sigattrs lbdef1)
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2464) ->
           let attrs = se.FStar_Syntax_Syntax.sigattrs  in
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____2475 =
             let uu____2482 =
               FStar_Syntax_Syntax.mk
                ...
                in
             FStar_Extraction_ML_Term.term_as_mlexpr g uu____2482  in
           (match uu____2475 with
            | (ml_let,uu____2492,uu____2493) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,bindings),uu____2502) ->
                     let flags1 =
                       FStar_List.choose
                         (fun uu___73_2517  ->
                            match uu___73_2517 with
                            ...
                            | uu____2520 -> FStar_Pervasives_Native.None)
                         quals
                        in
                     ...
                     let uu____2524 =
                       FStar_List.fold_left2
                         (fun uu____2556  ->
                            fun ml_lb  ->
                              fun uu____2558  ->
                                match (uu____2556, uu____2558) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2611 =
                                        ...
                                        uu____2614.FStar_Syntax_Syntax.fv_name
                                         in
                                      uu____2611.FStar_Syntax_Syntax.v  in
                                    let flags'' =
                                      let uu____2618 =
                                        let uu____2619 =
                                    ...
                                    let meta =
                                      FStar_List.append flags1
                                       ...
                                       in
                                    let ml_lb1 =
                                      let uu___77_2666 = ml_lb  in
                                      {
                                        FStar_Extraction_ML_Syntax.mllb_name
                                          =
                                          (uu___77_2666.FStar_Extraction_ML_Syntax.mllb_name);
                                        FStar_Extraction_ML_Syntax.mllb_tysc
                                          =
                                          (uu___77_2666.FStar_Extraction_ML_Syntax.mllb_tysc);
                                        FStar_Extraction_ML_Syntax.mllb_add_unit
                                          =
                                          (uu___77_2666.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                        FStar_Extraction_ML_Syntax.mllb_def =
                                          (uu___77_2666.FStar_Extraction_ML_Syntax.mllb_def);
                                        FStar_Extraction_ML_Syntax.mllb_meta
                                          = meta;
                                        FStar_Extraction_ML_Syntax.print_typ
                                          =
                                          (uu___77_2666.FStar_Extraction_ML_Syntax.print_typ)
                                      }  in
                                    let uu____2667 =
                                      let uu____2672 =
                                        FStar_All.pipe_right quals
                                      ...
                                      then
                                        ...
                                        let uu____2690 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____2695 mname uu____2696
                                              ...
                                              (let uu___78_2704 = ml_lb1  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___78_2704.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___78_2704.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___78_2704.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.mllb_meta
                                                   =
                                                   (uu___78_2704.FStar_Extraction_ML_Syntax.mllb_meta);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___78_2704.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2708 =
                                           let uu____2709 =
                              ...
                              let uu____2751 =
                                let uu____2752 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2752
                                 in
                              [uu____2751;
                              FStar_Extraction_ML_Syntax.MLM_Let
                                (flavor, (FStar_List.rev ml_lbs'))]
                               in
                            let uu____2755 = maybe_register_plugin g1 se  in
                            FStar_List.append uu____2748 uu____2755  in
                          (g1, uu____2745))
                 | uu____2760 ->
                     let uu____2761 =
                       let uu____2762 =
                       ...
                       FStar_Util.format1
                        ...
                        in
                     failwith uu____2761))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2770,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____2775 =
             FStar_All.pipe_right quals
           ...
           then
             let always_fail =
               let imp =
                 let uu____2786 = FStar_Syntax_Util.arrow_formals t  in
                 ...
                 | ([],t1) ->
                     ...
                     FStar_Syntax_Util.abs [b] uu____2816
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____2835 = fail_exp lid t1  in
                     FStar_Syntax_Util.abs bs uu____2835
                       FStar_Pervasives_Native.None
                  in
               let uu___79_2836 = se  in
               let uu____2837 =
                 let uu____2838 =
                   let uu____2845 =
                     let uu____2852 =
                         ...
                         let uu____2856 =
                           let uu____2861 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               ...
                               FStar_Pervasives_Native.None
                              in
                           FStar_Util.Inr uu____2861  in
                         {
                           FStar_Syntax_Syntax.lbname = uu____2856;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____2852)  in
                   (uu____2845, [])  in
                 FStar_Syntax_Syntax.Sig_let uu____2838  in
               {
                 FStar_Syntax_Syntax.sigel = uu____2837;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___79_2836.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___79_2836.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___79_2836.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___79_2836.FStar_Syntax_Syntax.sigattrs)
               }  in
             let uu____2874 = extract_sig g always_fail  in
             (match uu____2874 with
              | (g1,mlm) ->
                  let uu____2893 =
                    FStar_Util.find_map quals
                      (fun uu___75_2898  ->
                         match uu___75_2898 with
                  ...
                  (match uu____2893 with
                         ...
                         let uu____2913 =
                           let uu____2914 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng
                              in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____2914  in
                         let uu____2915 =
                           let uu____2918 =
                   ...
                   | uu____2921 ->
                       let uu____2924 =
                         FStar_Util.find_map quals
                           (fun uu___76_2930  ->
                              match uu___76_2930 with
                              | FStar_Syntax_Syntax.Projector (l,uu____2934)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____2935 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____2924 with
                        | FStar_Pervasives_Native.Some uu____2942 -> (g1, [])
                        | uu____2945 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____2954 = FStar_Extraction_ML_Term.term_as_mlexpr g e  in
           (match uu____2954 with
            | (ml_main,uu____2968,uu____2969) ->
                let uu____2970 =
                  let uu____2973 =
                    let uu____2974 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                  ...
                  [uu____2973; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____2970))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____2977 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____2984 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____2993 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____2996 -> (g, [])
    ...
    fun m  ->
      let uu____3021 =
        FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations
         in
      FStar_All.pipe_right uu____3021 FStar_Pervasives_Native.fst
...
let (extract' :
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____3063 = FStar_Options.restore_cmd_line_options true  in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name
          in
       let g1 =
         let uu___80_3066 = g  in
         let uu____3067 =
           FStar_TypeChecker_Env.set_current_module
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name
            in
         {
           FStar_Extraction_ML_UEnv.tcenv = uu____3067;
           FStar_Extraction_ML_UEnv.gamma =
             (uu___80_3066.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___80_3066.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___80_3066.FStar_Extraction_ML_UEnv.type_names);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____3097 = FStar_Options.codegen ()  in
             uu____3097 =
...
let (extract :
  ...
  fun g  ->
    fun m  ->
      let uu____3184 = FStar_Options.debug_any ()  in
      if uu____3184
      then
        let msg =
          let uu____3192 =
