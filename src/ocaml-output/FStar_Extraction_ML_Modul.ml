       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____1351,uu____1352)
           ...
           let uu____1363 =
             ...
             | (tcenv,uu____1384,def_typ) ->
                 let uu____1388 = as_pair def_typ  in (tcenv, uu____1388)
              in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1405,attrs) ->
           ...
           let elet =
             FStar_Syntax_Syntax.mk
              ...
              in
           let uu____1420 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1482 =
                                        ...
                                        uu____1487.FStar_Syntax_Syntax.fv_name
                                         in
                                        ...
                                        (let uu____1517 =
                                           let uu____1518 =
                                             ...
                                             FStar_Extraction_ML_UEnv.extend_lb
                                              ...
                                              in
                                           FStar_All.pipe_left
                                             FStar_Pervasives.fst uu____1518
                                            in
                                         (uu____1517, ml_lb))
                                       in
                            ...
                            let uu____1567 =
                              let uu____1568 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng
                                 in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1568
                               in
                            [uu____1567;
                            FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t1) ->
                     ...
                     FStar_Syntax_Util.abs bs uu____1628 None
                  in
           ...
           (match uu____1708 with
            | (ml_main,uu____1716,uu____1717) ->
                let uu____1718 =
                  ...
                  [uu____1720; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____1718))
