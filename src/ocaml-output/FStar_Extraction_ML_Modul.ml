        ...
        (fun env1  ->
           fun uu____307  ->
             ...
             | (bv,uu____317) ->
                 ...
                 let uu____324 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv
                    in
          ...
          fun def  ->
            ...
            | (bs,body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___390_430  ->
                       match uu___390_430 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____431 -> false) quals
                   in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                let uu____734 =
                  let uu____735 = FStar_Syntax_Print.term_to_string d.dtyp
                     in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1104
           in
        let steps =
    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  let mlp =
                    FStar_Extraction_ML_Syntax.mlpath_of_lident
                     ...
                     in
                  let uu____1959 =
                    let uu____1968 = FStar_Extraction_ML_UEnv.lookup_fv g fv
                       in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2333) when
           ...
           let uu____2349 =
             ...
             | (tcenv,uu____2382,def_typ) ->
                 let uu____2388 = as_pair def_typ  in (tcenv, uu____2388)
              in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2414) ->
             ...
             let mk_registration tac_lid assm_lid t bs =
                   ...
                   let uu____2462 =
                     let uu____2463 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2463
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2462  in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2461
                  in
               let lid_arg =
                 let uu____2465 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2489
                      in
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             ...
                             let assm_lid =
                               ...
                               FStar_Ident.lid_of_ns_and_id
                                 tac_lid.FStar_Ident.ns uu____2579
                                in
                             let uu____2580 =
                               let uu____2581 = FStar_Syntax_Subst.compress h
                                  in
           ...
           let uu____2606 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2720 =
                                        ...
                                        uu____2723.FStar_Syntax_Syntax.fv_name
                                         in
                                              ...
                                              (let uu___399_2761 = ml_lb  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___399_2761.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___399_2761.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___399_2761.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___399_2761.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2765 =
                                           let uu____2766 =
                              ...
                              let uu____2819 =
                                let uu____2820 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2820
                                 in
                              [uu____2819;
                              FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2905  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___400_2903.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___400_2903.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___400_2903.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___400_2903.FStar_Syntax_Syntax.sigattrs)
               }  in
              ...
              | (g1,mlm) ->
                  let uu____2958 =
                    FStar_Util.find_map quals
                      (fun uu___397_2963  ->
                         match uu___397_2963 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____2967 -> FStar_Pervasives_Native.None)
                     in
           ...
           (match uu____3019 with
            | (ml_main,uu____3033,uu____3034) ->
                let uu____3035 =
                  ...
                  [uu____3038; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____3035))
        ...
        let g1 =
             ...
             in
          {
            ...
            FStar_Extraction_ML_UEnv.gamma =
              (uu___401_3143.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___401_3143.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___401_3143.FStar_Extraction_ML_UEnv.type_names);
