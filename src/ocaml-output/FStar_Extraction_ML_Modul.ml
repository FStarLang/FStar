            ...
            let b =
              let uu___1 =
                FStar_Syntax_Syntax.gen_bv "_" FStar_Pervasives_Native.None
                  t1 in
              FStar_Compiler_Effect.pipe_left FStar_Syntax_Syntax.mk_binder
                uu___1 in
...
let (print_ifamily : inductive_family -> unit) =
  fun i ->
    ...
    let uu___3 =
      let uu___4 =
        FStar_Compiler_Effect.pipe_right i.idatas
      ...
      FStar_Compiler_Effect.pipe_right uu___4 (FStar_String.concat "\n\t\t") in
...
let (iface_of_tydefs : FStar_Extraction_ML_UEnv.tydef Prims.list -> iface) =
  fun tds ->
    let uu___ = empty_iface in
    let uu___1 =
      FStar_Compiler_List.map (fun uu___2 -> FStar_Pervasives.Inl uu___2) tds in
    let uu___2 =
      FStar_Compiler_List.map
        (fun td ->
  ...
  fun env ->
    fun se ->
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            let uu___1 =
              FStar_Compiler_Effect.pipe_right ind.idatas
    ...
    fun ed ->
      ...
      let rec extract_fv tm =
        (let uu___1 =
           ...
           FStar_Compiler_Effect.pipe_left uu___2
      ...
      let extract_action g1 a =
        (let uu___2 =
           ...
           FStar_Compiler_Effect.pipe_left uu___3
             (FStar_Options.Other "ExtractionReify") in
         if uu___2
         then
           let uu___3 =
                  ...
                  (match uu___5 with
                   | (a_nm, a_lid, exp_b, g2) ->
                       ((let uu___7 =
                           ...
                           FStar_Compiler_Effect.pipe_left uu___8
                             (FStar_Options.Other "ExtractionReify") in
                         if uu___7
                         then
                           let uu___8 =
                        ...
                        (let uu___8 =
                           ...
                           FStar_Compiler_Effect.pipe_left uu___9
                             (FStar_Options.Other "ExtractionReify") in
                         if uu___8
                         then
                           ((let uu___10 =
      ...
      then (g, empty_iface)
        ...
        (let uu___2 = FStar_Options.restore_cmd_line_options true in
         ...
         (let uu___4 = FStar_Options.restore_cmd_line_options true in
          FStar_Compiler_Effect.pipe_left (fun uu___5 -> ()) uu___4);
         res)
let (extract_iface :
  FStar_Extraction_ML_UEnv.uenv ->
    FStar_Syntax_Syntax.modul -> (FStar_Extraction_ML_UEnv.uenv * iface))
             ...
             | (env2, ctors) ->
                 ...
                 (match uu___2 with
                  | (indices, uu___3) ->
                      let ml_params =
                        let uu___4 =
                          FStar_Compiler_Effect.pipe_right indices
              ...
              (match uu___5 with
               | (g2, mllib1) ->
                   ((let uu___7 = FStar_Options.restore_cmd_line_options true in
                     FStar_Compiler_Effect.pipe_left (fun uu___8 -> ())
                       uu___7);
