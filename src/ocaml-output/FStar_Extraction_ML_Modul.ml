    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____574 in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____735  ->
                                    ...
                                    (uu____738, (Prims.parse_int "0")))) in
                        FStar_List.append vars uu____720 in
                      let tbody =
                        let uu____743 =
                          FStar_Util.find_opt
                            (fun uu___155_745  ->
                               match uu___155_745 with
                               | FStar_Syntax_Syntax.RecordType uu____746 ->
                                   true
                               | uu____751 -> false) ind.iquals in
      ...
      | FStar_Syntax_Syntax.Sig_bundle (ses,quals,uu____851) ->
          ...
          let uu____861 = FStar_Util.fold_map extract_one_family env ifams in
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_new_effect ed when
           ...
           let rec extract_fv tm =
             let uu____975 =
               let uu____976 = FStar_Syntax_Subst.compress tm in
               uu____976.FStar_Syntax_Syntax.n in
             match uu____975 with
             | FStar_Syntax_Syntax.Tm_uinst (tm1,uu____982) -> extract_fv tm1
             | FStar_Syntax_Syntax.Tm_fvar fv ->
                 let mlp =
                   FStar_Extraction_ML_Syntax.mlpath_of_lident
                     (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                 let uu____993 =
                   let uu____998 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                   FStar_All.pipe_left FStar_Util.right uu____998 in
                 (match uu____993 with
                  | (uu____1027,uu____1028,tysc,uu____1030) ->
                      let uu____1031 =
                        FStar_All.pipe_left
                      ...
                      (uu____1031, tysc))
             | uu____1032 -> failwith "Not an fv" in
           let extract_action g1 a =
             let uu____1044 = extract_fv a.FStar_Syntax_Syntax.action_defn in
             match uu____1044 with
             | (a_tm,ty_sc) ->
                 let uu____1051 = FStar_Extraction_ML_UEnv.action_name ed a in
                      ...
                      | (g3,actions) ->
                          (g3,
                            (FStar_List.append [return_decl; bind_decl]
                               actions)))))
       | FStar_Syntax_Syntax.Sig_new_effect uu____1116 -> (g, [])
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____1119,t,quals) when
           ...
           let uu____1124 =
             let uu____1125 =
               FStar_All.pipe_right quals
                 (FStar_Util.for_some
                    (fun uu___156_1127  ->
                       match uu___156_1127 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____1128 -> false)) in
             Prims.op_Negation uu____1125 in
           if uu____1124
           then (g, [])
           else
             (let uu____1134 = FStar_Syntax_Util.arrow_formals t in
              ...
              | (bs,uu____1146) ->
                  ...
                  let uu____1158 =
                    FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit
                      None in
                  extract_typ_abbrev g fv quals uu____1158)
       | FStar_Syntax_Syntax.Sig_let
           ((false ,lb::[]),uu____1165,quals,uu____1167) when
           ...
           let uu____1178 =
             ...
             | (tcenv,uu____1199,def_typ) ->
                 let uu____1203 = as_pair def_typ in (tcenv, uu____1203) in
           (match uu____1178 with
            | (tcenv,(lbdef,lbtyp)) ->
                ...
                extract_typ_abbrev g uu____1218 quals lbdef1)
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1220,quals,attrs) ->
           let elet =
             (FStar_Syntax_Syntax.mk
                (FStar_Syntax_Syntax.Tm_let
                   (lbs, FStar_Syntax_Const.exp_false_bool))) None
               se.FStar_Syntax_Syntax.sigrng in
           let uu____1240 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
           (match uu____1240 with
            | (ml_let,uu____1248,uu____1249) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,uu____1254,bindings),uu____1256) ->
                     let uu____1263 =
                       FStar_List.fold_left2
                         (fun uu____1270  ->
                            fun ml_lb  ->
                              fun uu____1272  ->
                                match (uu____1270, uu____1272) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1302 =
                                        ...
                                        uu____1307.FStar_Syntax_Syntax.fv_name in
                                      uu____1302.FStar_Syntax_Syntax.v in
                                    let uu____1311 =
                                      let uu____1314 =
                                        FStar_All.pipe_right quals
                                          (FStar_Util.for_some
                                             (fun uu___157_1316  ->
                                                match uu___157_1316 with
                                      ...
                                      then
                                        ...
                                        let uu____1325 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____1328 mname uu____1329
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____1325 with
                                        | (env1,uu____1333) ->
                                            (env1,
                                              (let uu___162_1334 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___162_1334.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___162_1334.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___162_1334.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___162_1334.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1337 =
                                           let uu____1338 =
                          ...
                          let flags =
                            FStar_List.choose
                              (fun uu___158_1361  ->
                                 ...
                                 | uu____1363 -> None) quals in
                          let flags' =
                            FStar_List.choose
                              (fun uu___159_1368  ->
                                 match uu___159_1368 with
                                 | {
                                     FStar_Syntax_Syntax.n =
                                       FStar_Syntax_Syntax.Tm_constant
                                       (FStar_Const.Const_string
                                       (data,uu____1373));
                                     FStar_Syntax_Syntax.tk = uu____1374;
                                     FStar_Syntax_Syntax.pos = uu____1375;
                                     FStar_Syntax_Syntax.vars = uu____1376;_}
                                     ->
                                     Some
                          ...
                          let uu____1385 =
                            let uu____1387 =
                              let uu____1388 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1388 in
                            [uu____1387;
                            FStar_Extraction_ML_Syntax.MLM_Let
                 ...
                 | uu____1392 ->
                     let uu____1393 =
                       ...
                       FStar_Util.format1
                         ...
                         uu____1394 in
                     failwith uu____1393))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____1399,t,quals) ->
           let uu____1404 =
             FStar_All.pipe_right quals
           ...
           then
             let always_fail =
               let imp =
                 let uu____1411 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____1430 in
                     let uu____1431 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____1431 None
                 | (bs,t1) ->
                     let uu____1449 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____1449 None in
               let uu___163_1455 = se in
               let uu____1456 =
                 let uu____1457 =
                   let uu____1465 =
                     let uu____1469 =
                       let uu____1471 =
                         let uu____1472 =
                           let uu____1475 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant None in
                           FStar_Util.Inr uu____1475 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____1472;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____1469) in
                   (uu____1465, [], quals, []) in
                 FStar_Syntax_Syntax.Sig_let uu____1457 in
               {
                 FStar_Syntax_Syntax.sigel = uu____1456;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___163_1455.FStar_Syntax_Syntax.sigrng)
               } in
             let uu____1483 = extract_sig g always_fail in
             (match uu____1483 with
              | (g1,mlm) ->
                  let uu____1494 =
                    FStar_Util.find_map quals
                      (fun uu___160_1496  ->
                         match uu___160_1496 with
                  ...
                  (match uu____1494 with
                       ...
                       let uu____1504 =
                         let uu____1506 =
                           let uu____1507 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____1507 in
                         let uu____1508 =
                           let uu____1510 =
                   ...
                   | uu____1512 ->
                       let uu____1514 =
                         FStar_Util.find_map quals
                           (fun uu___161_1516  ->
                              match uu___161_1516 with
                              | FStar_Syntax_Syntax.Projector (l,uu____1519)
                                  -> Some l
                              | uu____1520 -> None) in
       ...
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____1532 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____1532 with
            | (ml_main,uu____1540,uu____1541) ->
                let uu____1542 =
                  let uu____1544 =
                    let uu____1545 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____1545 in
                  [uu____1544; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____1542))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____1547 ->
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____1565 Prims.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1594 = FStar_Options.restore_cmd_line_options true in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name in
       let g1 =
         let uu___164_1597 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___164_1597.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___164_1597.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___164_1597.FStar_Extraction_ML_UEnv.tydefs);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____1615 = FStar_Options.codegen () in
