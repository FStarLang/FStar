    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  let mlp =
                    FStar_Extraction_ML_Syntax.mlpath_of_lident
                     ...
                     in
                  let uu____1971 =
                    let uu____1980 = FStar_Extraction_ML_UEnv.lookup_fv g fv
                       in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2345) when
           ...
           let uu____2361 =
             ...
             | (tcenv,uu____2394,def_typ) ->
                 let uu____2400 = as_pair def_typ  in (tcenv, uu____2400)
              in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2426) ->
             ...
             let mk_registration tac_lid assm_lid t bs =
                   ...
                   let uu____2474 =
                     let uu____2475 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2475
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2474  in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2473
                  in
               let lid_arg =
                 let uu____2477 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2501
                      in
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             ...
                             let assm_lid =
                               ...
                               FStar_Ident.lid_of_ns_and_id
                                 tac_lid.FStar_Ident.ns uu____2591
                                in
                             let uu____2592 =
                               let uu____2593 = FStar_Syntax_Subst.compress h
                                  in
           ...
           let uu____2618 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                              ...
                                              (let uu___311_2773 = ml_lb  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___311_2773.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___311_2773.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___311_2773.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___311_2773.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2777 =
                                           let uu____2778 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2917  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___312_2915.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___312_2915.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___312_2915.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___312_2915.FStar_Syntax_Syntax.sigattrs)
               }  in
              ...
              | (g1,mlm) ->
                  let uu____2970 =
                    FStar_Util.find_map quals
                      (fun uu___309_2975  ->
                         match uu___309_2975 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____2979 -> FStar_Pervasives_Native.None)
                     in
                  (match uu____2970 with
                   ...
                   | uu____2998 ->
                       let uu____3001 =
                         FStar_Util.find_map quals
                           (fun uu___310_3007  ->
                              match uu___310_3007 with
                              | FStar_Syntax_Syntax.Projector (l,uu____3011)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3012 -> FStar_Pervasives_Native.None)
                          in
           ...
           (match uu____3031 with
            | (ml_main,uu____3045,uu____3046) ->
                let uu____3047 =
                  ...
                  [uu____3050; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____3047))
        ...
        let g1 =
             ...
             in
          {
            ...
            FStar_Extraction_ML_UEnv.gamma =
              (uu___313_3151.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___313_3151.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___313_3151.FStar_Extraction_ML_UEnv.type_names);
