                                              ...
                                              (let uu___163_1334 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___163_1334.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___163_1334.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___163_1334.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___163_1334.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1337 =
                                           let uu____1338 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____1457 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___164_1455.FStar_Syntax_Syntax.sigrng)
               } in
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1594 = FStar_Options.restore_cmd_line_options true in
       ...
       let g1 =
         let uu___165_1597 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___165_1597.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___165_1597.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___165_1597.FStar_Extraction_ML_UEnv.tydefs);
