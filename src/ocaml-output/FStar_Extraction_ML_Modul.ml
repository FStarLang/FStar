        ...
        (fun env1  ->
           fun uu____222  ->
             ...
             | (bv,uu____232) ->
                 ...
                 let uu____239 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv
                    in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                let uu____649 =
                  let uu____650 = FStar_Syntax_Print.term_to_string d.dtyp
                     in
                  Prims.strcat " : " uu____650  in
                Prims.strcat uu____648 uu____649))
         in
                                ...
                                (FStar_List.collect
                                   (fun se1  ->
                                      ...
                                      | FStar_Syntax_Syntax.Sig_datacon
                                          (d,uu____775,t2,l',nparams,uu____779)
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1019
           in
        let steps =
              ...
              FStar_List.map
                (fun uu____1060  ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____1067;_},uu____1068)
      ...
      let extract_one_family env1 ind =
        ...
        | (env2,vars) ->
            ...
            (match uu____1190 with
             | (env3,ctors) ->
                 let uu____1283 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____1358  ->
                                    ...
                                    Prims.strcat "'dummyV" uu____1363))
                           in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____1528;_}::[],uu____1529),(FStar_Syntax_Syntax.ExceptionConstructor
         )::[]) ->
             ...
             let mk_registration lb =
               ...
               | FStar_Pervasives_Native.Some (interp,arity,plugin1) ->
                   ...
                   let h =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____1809
                      in
                   let arity1 =
                     let uu____1813 =
                       let uu____1814 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  let mlp =
                    FStar_Extraction_ML_Syntax.mlpath_of_lident
                     ...
                     in
                  let uu____1987 =
                    let uu____1996 = FStar_Extraction_ML_UEnv.lookup_fv g fv
                       in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2365) when
           ...
           let uu____2381 =
             ...
             | (tcenv,uu____2414,def_typ) ->
                 let uu____2420 = as_pair def_typ  in (tcenv, uu____2420)
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2593 =
                                        ...
                                        uu____2596.FStar_Syntax_Syntax.fv_name
                                         in
                              ...
                              let uu____2733 =
                                let uu____2734 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2734
                                 in
                              [uu____2733;
                              FStar_Extraction_ML_Syntax.MLM_Let
           ...
           (match uu____2936 with
            | (ml_main,uu____2950,uu____2951) ->
                let uu____2952 =
                  ...
                  [uu____2955; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____2952))
