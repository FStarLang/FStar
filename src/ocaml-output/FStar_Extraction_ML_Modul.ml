...
in (FStar_All.pipe_left FStar_Syntax_Syntax.iarg _180_9))
in (_180_10)::[])
in (_180_12)::_180_11))
in ((_180_14), (_180_13))))
...
let binders_as_mlty_binders = (fun env bs -> (FStar_Util.fold_map (fun env _82_24 -> (match (_82_24) with
| (bv, _82_23) -> begin
...
| FStar_Syntax_Syntax.Tm_abs (_82_32) -> begin
...
let _82_47 = (match (def.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_abs (bs, body, _82_40) -> begin
...
let _82_55 = (binders_as_mlty_binders env bs)
in (match (_82_55) with
| (env, ml_bs) -> begin
(
...
| FStar_Syntax_Syntax.Projector (_82_59) -> begin
true
end
| _82_62 -> begin
false
...
let _82_100 = (FStar_Syntax_Subst.open_term bs t)
in (match (_82_100) with
| (bs, t) -> begin
(

let datas = (FStar_All.pipe_right ses (FStar_List.collect (fun _82_4 -> (match (_82_4) with
| FStar_Syntax_Syntax.Sig_datacon (d, _82_104, t, l', nparams, _82_109, _82_111, _82_113) when (FStar_Ident.lid_equals l l') -> begin
(

let _82_118 = (FStar_Syntax_Util.arrow_formals t)
in (match (_82_118) with
| (bs', body) -> begin
(

let _82_121 = (FStar_Util.first_N (FStar_List.length bs) bs')
in (match (_82_121) with
| (bs_params, rest) -> begin
(

let subst = (FStar_List.map2 (fun _82_125 _82_129 -> (match (((_82_125), (_82_129))) with
| ((b', _82_124), (b, _82_128)) -> begin
...
let _82_151 = (binders_as_mlty_binders env ind.iparams)
in (match (_82_151) with
| (env, vars) -> begin
(

let _82_154 = (FStar_All.pipe_right ind.idatas (FStar_Util.fold_map (extract_ctor vars) env))
in (match (_82_154) with
| (env, ctors) -> begin
(

let _82_158 = (FStar_Syntax_Util.arrow_formals ind.ityp)
in (match (_82_158) with
| (indices, _82_157) -> begin
(

let ml_params = (let _180_113 = (FStar_All.pipe_right indices (FStar_List.mapi (fun i _82_160 -> (let _180_112 = (let _180_111 = (FStar_Util.string_of_int i)
...
| FStar_Syntax_Syntax.RecordType (_82_165) -> begin
true
end
| _82_168 -> begin
false
...
let _82_177 = (FStar_List.hd ctors)
in (match (_82_177) with
| (_82_175, c_ty) -> begin
(
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_bundle ((FStar_Syntax_Syntax.Sig_datacon (l, _82_189, t, _82_192, _82_194, _82_196, _82_198, _82_200))::[], (FStar_Syntax_Syntax.ExceptionConstructor)::[], _82_207, r) -> begin
(

let _82_213 = (extract_ctor [] env {dname = l; dtyp = t})
in (match (_82_213) with
| (env, ctor) -> begin
((env), ((FStar_Extraction_ML_Syntax.MLM_Exn (ctor))::[]))
end))
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _82_217, r) -> begin
(

let ifams = (bundle_as_inductive_families env ses quals)
in (

let _82_224 = (FStar_Util.fold_map extract_one_family env ifams)
in (match (_82_224) with
| (env, td) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (lid, _82_245, t, quals, _82_249) -> begin
(let _180_126 = (FStar_Syntax_Print.lid_to_string lid)
in (let _180_125 = (let _180_124 = (let _180_123 = (FStar_Extraction_ML_Term.level g t)
in (FStar_All.pipe_left (FStar_Extraction_ML_Term.predecessor t) _180_123))
in (l _180_124))
in (FStar_Util.print2 "\t\t%s @ %s\n" _180_126 _180_125)))
end
| FStar_Syntax_Syntax.Sig_let ((_82_253, (lb)::_82_255), _82_260, _82_262, _82_264, _82_266) -> begin
(let _180_134 = (let _180_129 = (let _180_128 = (let _180_127 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _180_127.FStar_Syntax_Syntax.fv_name)
in _180_128.FStar_Syntax_Syntax.v)
in (FStar_All.pipe_right _180_129 FStar_Syntax_Print.lid_to_string))
in (let _180_133 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (let _180_132 = (let _180_131 = (let _180_130 = (FStar_Extraction_ML_Term.level g lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_All.pipe_left (FStar_Extraction_ML_Term.predecessor lb.FStar_Syntax_Syntax.lbtyp) _180_130))
in (l _180_131))
in (FStar_Util.print3 "\t\t%s : %s @ %s\n" _180_134 _180_133 _180_132))))
end
| _82_270 -> begin
...
let _82_274 = (let _180_141 = (let _180_140 = (FStar_Syntax_Print.sigelt_to_string se)
in (FStar_Util.format1 ">>>> extract_sig :  %s \n" _180_140))
in (FStar_Util.print_string _180_141))
...
let g = (let _180_152 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Extraction_ML_UEnv.extend_fv' g _180_152 ml_name tysc false false))
in (
...
let rec extract_fv = (fun tm -> (match ((let _180_155 = (FStar_Syntax_Subst.compress tm)
in _180_155.FStar_Syntax_Syntax.n)) with
...
let _82_316 = (let _180_156 = (FStar_Extraction_ML_UEnv.lookup_fv g fv)
in (FStar_All.pipe_left FStar_Util.right _180_156))
in (match (_82_316) with
| (_82_312, tysc, _82_315) -> begin
(let _180_157 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) (FStar_Extraction_ML_Syntax.MLE_Name (mlp)))
in ((_180_157), (tysc)))
end)))
end
| _82_318 -> begin
...
if (let _180_163 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun _82_8 -> (match (_82_8) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| _82_364 -> begin
...
in (FStar_All.pipe_right _180_163 Prims.op_Negation)) then begin
((g), ([]))
end else begin
(
...
in (let _180_164 = (FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit None)
in (extract_typ_abbrev g fv quals _180_164)))
end))
end
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _82_375, _82_377, quals, _82_380) when ((FStar_Extraction_ML_Term.level g lb.FStar_Syntax_Syntax.lbtyp) = FStar_Extraction_ML_Term.Kind_level) -> begin
(let _180_165 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (extract_typ_abbrev g _180_165 quals lb.FStar_Syntax_Syntax.lbdef))
end
| FStar_Syntax_Syntax.Sig_let (lbs, r, _82_386, quals, attrs) -> begin
(

let elet = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((lbs), (FStar_Syntax_Const.exp_false_bool)))) None r)
in (

let _82_397 = (FStar_Extraction_ML_Term.term_as_mlexpr g elet)
in (match (_82_397) with
| (ml_let, _82_394, _82_396) -> begin
(match (ml_let.FStar_Extraction_ML_Syntax.expr) with
| FStar_Extraction_ML_Syntax.MLE_Let ((flavor, _82_400, bindings), _82_404) -> begin
(

let _82_436 = (FStar_List.fold_left2 (fun _82_409 ml_lb _82_419 -> (match (((_82_409), (_82_419))) with
| ((env, ml_lbs), {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = _82_417; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _82_414; FStar_Syntax_Syntax.lbdef = _82_412}) -> begin
(

let lb_lid = (let _180_170 = (let _180_169 = (FStar_Util.right lbname)
in _180_169.FStar_Syntax_Syntax.fv_name)
in _180_170.FStar_Syntax_Syntax.v)
in (

let _82_433 = if (FStar_All.pipe_right quals (FStar_Util.for_some (fun _82_9 -> (match (_82_9) with
| FStar_Syntax_Syntax.Projector (_82_423) -> begin
true
end
| _82_426 -> begin
false
...
let env = (let _180_173 = (FStar_Util.right lbname)
in (let _180_172 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_fv' env _180_173 mname _180_172 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false)))
in ((env), ((

let _82_429 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = (((Prims.snd mname)), ((Prims.parse_int "0"))); FStar_Extraction_ML_Syntax.mllb_tysc = _82_429.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = _82_429.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = _82_429.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = _82_429.FStar_Extraction_ML_Syntax.print_typ})))))
end else begin
(let _180_176 = (let _180_175 = (let _180_174 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_lb env lbname t _180_174 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false))
in (FStar_All.pipe_left Prims.fst _180_175))
in ((_180_176), (ml_lb)))
end
...
let flags' = (FStar_List.choose (fun _82_11 -> (match (_82_11) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (data, _82_453)); FStar_Syntax_Syntax.tk = _82_450; FStar_Syntax_Syntax.pos = _82_448; FStar_Syntax_Syntax.vars = _82_446} -> begin
Some (FStar_Extraction_ML_Syntax.Attribute ((FStar_Util.string_of_unicode data)))
end
| _82_459 -> begin
(

let _82_460 = (FStar_Util.print_warning "Warning: unrecognized, non-string attribute, bother protz for a better error message")
in None)
end)) attrs)
in (let _180_181 = (let _180_180 = (let _180_179 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_180_179))
in (_180_180)::(FStar_Extraction_ML_Syntax.MLM_Let (((flavor), ((FStar_List.append flags flags')), ((FStar_List.rev ml_lbs')))))::[])
in ((g), (_180_181)))))
end))
end
| _82_464 -> begin
(let _180_183 = (let _180_182 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" _180_182))
in (FStar_All.failwith _180_183))
end)
end)))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, _82_467, t, quals, r) -> begin
...
| (bs, t) -> begin
(let _180_184 = (fail_exp lid t)
in (FStar_Syntax_Util.abs bs _180_184 None))
end)
in (let _180_190 = (let _180_189 = (let _180_188 = (let _180_187 = (let _180_186 = (let _180_185 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in FStar_Util.Inr (_180_185))
in {FStar_Syntax_Syntax.lbname = _180_186; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (_180_187)::[])
in ((false), (_180_188)))
in ((_180_189), (r), ([]), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (_180_190)))
in (

let _82_483 = (extract_sig g always_fail)
in (match (_82_483) with
| (g, mlm) -> begin
...
| Some (l) -> begin
(let _180_196 = (let _180_195 = (let _180_192 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_180_192))
in (let _180_194 = (let _180_193 = (FStar_Extraction_ML_Term.ind_discriminator_body g lid l)
in (_180_193)::[])
...
| FStar_Syntax_Syntax.Projector (l, _82_496) -> begin
Some (l)
end
| _82_500 -> begin
None
...
let _82_515 = (FStar_Extraction_ML_Term.term_as_mlexpr g e)
in (match (_82_515) with
| (ml_main, _82_512, _82_514) -> begin
(let _180_200 = (let _180_199 = (let _180_198 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_180_198))
in (_180_199)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (_180_200)))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_82_517) -> begin
...
let extract_iface : FStar_Extraction_ML_UEnv.env  ->  FStar_Syntax_Syntax.modul  ->  env_t = (fun g m -> (let _180_205 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right _180_205 Prims.fst)))
...
let _82_535 = (FStar_Syntax_Syntax.reset_gensym ())
in (
...
let _82_538 = g
in {FStar_Extraction_ML_UEnv.tcenv = _82_538.FStar_Extraction_ML_UEnv.tcenv; FStar_Extraction_ML_UEnv.gamma = _82_538.FStar_Extraction_ML_UEnv.gamma; FStar_Extraction_ML_UEnv.tydefs = _82_538.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.currentModule = name})
...
let _82_542 = (let _180_210 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
in (FStar_Util.print1 "Extracting module %s\n" _180_210))
in (

let _82_546 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (match (_82_546) with
| (g, sigs) -> begin
(
