          ...
          fun def  ->
            ...
            | (bs,body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___301_436  ->
                       match uu___301_436 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____437 -> false) quals
                   in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                Prims.strcat uu____739 uu____740))
         in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1110
           in
        let steps =
      ...
      let extract_one_family env1 ind =
        ...
        | (env2,vars) ->
            ...
            (match uu____1281 with
             | (env3,ctors) ->
                 let uu____1374 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
                  ...
                  | (indices,uu____1410) ->
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____1449  ->
                                    ...
                                    Prims.strcat "'dummyV" uu____1454))
                           in
                      ...
                      let tbody =
                        let uu____1456 =
                          FStar_Util.find_opt
                            (fun uu___304_1461  ->
                               match uu___304_1461 with
                               | FStar_Syntax_Syntax.RecordType uu____1462 ->
                                   true
                               | uu____1471 -> false) ind.iquals
                           in
    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  let mlp =
                    FStar_Extraction_ML_Syntax.mlpath_of_lident
                     ...
                     in
                  let uu____1965 =
                    let uu____1974 = FStar_Extraction_ML_UEnv.lookup_fv g fv
                       in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2339) when
           ...
           let uu____2355 =
             ...
             | (tcenv,uu____2388,def_typ) ->
                 let uu____2394 = as_pair def_typ  in (tcenv, uu____2394)
              in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2420) ->
             ...
             let mk_registration tac_lid assm_lid t bs =
                   ...
                   let uu____2468 =
                     let uu____2469 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2469
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2468  in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2467
                  in
               let lid_arg =
                 let uu____2471 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2495
                      in
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             ...
                             let assm_lid =
                               ...
                               FStar_Ident.lid_of_ns_and_id
                                 tac_lid.FStar_Ident.ns uu____2585
                                in
                             let uu____2586 =
           ...
           let uu____2612 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2726 =
                                        ...
                                        uu____2729.FStar_Syntax_Syntax.fv_name
                                         in
                                              ...
                                              (let uu___310_2767 = ml_lb  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___310_2767.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___310_2767.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___310_2767.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___310_2767.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2771 =
                                           let uu____2772 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2911  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___311_2909.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___311_2909.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___311_2909.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___311_2909.FStar_Syntax_Syntax.sigattrs)
               }  in
              ...
              | (g1,mlm) ->
                  let uu____2964 =
                    FStar_Util.find_map quals
                      (fun uu___308_2969  ->
                         match uu___308_2969 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____2973 -> FStar_Pervasives_Native.None)
                     in
           ...
           (match uu____3025 with
            | (ml_main,uu____3039,uu____3040) ->
                let uu____3041 =
                  ...
                  [uu____3044; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____3041))
        ...
        let g1 =
             ...
             in
          {
            ...
            FStar_Extraction_ML_UEnv.gamma =
              (uu___312_3145.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___312_3145.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___312_3145.FStar_Extraction_ML_UEnv.type_names);
