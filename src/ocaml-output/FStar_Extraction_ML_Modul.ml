      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2451) ->
           ...
           let tactic_registration_decl =
             let mk_registration tac_lid assm_lid t bs =
               ...
               | FStar_Pervasives_Native.None  -> [] in
             let uu____2539 =
               let uu____2540 = FStar_Options.codegen () in
               uu____2540 = (FStar_Pervasives_Native.Some "tactics") in
             if uu____2539
             then
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             let tac_lid =
                               let uu____2611 =
                                 ...
                                 uu____2614.FStar_Syntax_Syntax.fv_name in
                             ...
                             let assm_lid =
                               ...
                               FStar_Ident.lid_of_ns_and_id
                                 tac_lid.FStar_Ident.ns uu____2616 in
                             let uu____2617 =
                               let uu____2618 = FStar_Syntax_Subst.compress h in
                               is_tactic_decl assm_lid uu____2618
                                 g.FStar_Extraction_ML_UEnv.currentModule in
                             if uu____2617
                             then
                               let uu____2621 =
                                 let uu____2622 = FStar_List.hd args in
                                 FStar_Pervasives_Native.fst uu____2622 in
                               mk_registration tac_lid assm_lid uu____2621 bs
                             else []
                         | uu____2638 -> []))
               | uu____2639 -> []
             else [] in
           let uu____2643 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
           (match uu____2643 with
            | (ml_let,uu____2657,uu____2658) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,uu____2666,bindings),uu____2668) ->
                     let uu____2681 =
                       FStar_List.fold_left2
                         (fun uu____2708  ->
                            fun ml_lb  ->
                              fun uu____2710  ->
                                match (uu____2708, uu____2710) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2757 =
                                        ...
                                        uu____2760.FStar_Syntax_Syntax.fv_name in
                                      uu____2757.FStar_Syntax_Syntax.v in
                                    let uu____2761 =
                                      let uu____2766 =
                                        FStar_All.pipe_right quals
                                          (FStar_Util.for_some
                                             (fun uu___392_2771  ->
                                                match uu___392_2771 with
                                      ...
                                      then
                                        ...
                                        let uu____2784 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____2789 mname uu____2790
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____2784 with
                                        | (env1,uu____2796) ->
                                            (env1,
                                              (let uu___396_2798 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___396_2798.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___396_2798.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___396_2798.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___396_2798.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2802 =
                                           let uu____2803 =
                          ...
                          let uu____2850 =
                            let uu____2853 =
                              let uu____2856 =
                                ...
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2857 in
                              [uu____2856;
                              FStar_Extraction_ML_Syntax.MLM_Let
       ...
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2874,t) ->
           ...
           then
             let always_fail =
               let imp =
                 let uu____2890 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____2919 in
                     let uu____2920 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____2920
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____2939 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____2939
                       FStar_Pervasives_Native.None in
               let uu___397_2940 = se in
               let uu____2941 =
                 let uu____2942 =
                   let uu____2949 =
                     let uu____2956 =
                         ...
                         let uu____2960 =
                           let uu____2965 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant
                               FStar_Pervasives_Native.None in
                           FStar_Util.Inr uu____2965 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____2960;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____2956) in
                   (uu____2949, []) in
                 FStar_Syntax_Syntax.Sig_let uu____2942 in
               {
                 FStar_Syntax_Syntax.sigel = uu____2941;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___397_2940.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___397_2940.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___397_2940.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___397_2940.FStar_Syntax_Syntax.sigattrs)
               } in
             let uu____2976 = extract_sig g always_fail in
             (match uu____2976 with
              | (g1,mlm) ->
                  let uu____2995 =
                    FStar_Util.find_map quals
                      (fun uu___394_3000  ->
                         match uu___394_3000 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____3004 -> FStar_Pervasives_Native.None) in
                       ...
                       let uu____3012 =
                         let uu____3015 =
                           let uu____3016 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____3016 in
                         let uu____3017 =
                           let uu____3020 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                               g1 lid l in
                           [uu____3020] in
                         uu____3015 :: uu____3017 in
                       (g1, uu____3012)
                   | uu____3023 ->
                       let uu____3026 =
                         FStar_Util.find_map quals
                           (fun uu___395_3032  ->
                              match uu___395_3032 with
                              | FStar_Syntax_Syntax.Projector (l,uu____3036)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3037 -> FStar_Pervasives_Native.None) in
                       (match uu____3026 with
                        | FStar_Pervasives_Native.Some uu____3044 -> (g1, [])
                        | uu____3047 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____3056 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____3056 with
            | (ml_main,uu____3070,uu____3071) ->
                let uu____3072 =
                  let uu____3075 =
                    let uu____3076 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____3076 in
                  [uu____3075; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3072))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____3079 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____3086 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____3095 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____3098 -> (g, [])
  ...
  fun g  ->
    fun m  ->
      ...
      (let codegen_opt = FStar_Options.codegen () in
       let uu____3177 = FStar_Options.restore_cmd_line_options true in
       ...
       (let name =
        ...
        let g1 =
          let uu___398_3184 = g in
          let uu____3185 =
            FStar_TypeChecker_Env.set_current_module
              g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
          {
            FStar_Extraction_ML_UEnv.tcenv = uu____3185;
            FStar_Extraction_ML_UEnv.gamma =
              (uu___398_3184.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___398_3184.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___398_3184.FStar_Extraction_ML_UEnv.type_names);
        ...
        | (g2,sigs) ->
            ...
            let is_kremlin =
              let uu____3215 = FStar_Options.codegen () in
