...
let fail_exp = (fun lid t -> ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_478 = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (let _0_477 = (let _0_476 = (FStar_Syntax_Syntax.iarg t)
in (let _0_475 = (let _0_474 = (let _0_473 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string ((let _0_472 = (FStar_Bytes.string_as_unicode_bytes (let _0_471 = (FStar_Syntax_Print.lid_to_string lid)
in (Prims.strcat "Not yet implemented:" _0_471)))
in ((_0_472), (FStar_Range.dummyRange))))))) None FStar_Range.dummyRange)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_473))
in (_0_474)::[])
in (_0_476)::_0_475))
in ((_0_478), (_0_477))))))) None FStar_Range.dummyRange))
...
| (bv, uu____78) -> begin
(let _0_481 = (let _0_479 = Some (FStar_Extraction_ML_Syntax.MLTY_Var ((FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv)))
in (FStar_Extraction_ML_UEnv.extend_ty env bv _0_479))
in (let _0_480 = (FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv)
in ((_0_481), (_0_480))))
end)) env bs))
...
let def = (let _0_483 = (let _0_482 = (FStar_Syntax_Subst.compress def)
in (FStar_All.pipe_right _0_482 FStar_Syntax_Util.unmeta))
in (FStar_All.pipe_right _0_483 FStar_Syntax_Util.un_uinst))
in (
...
let body = (let _0_484 = (FStar_Extraction_ML_Term.term_as_mlty env body)
in (FStar_All.pipe_right _0_484 (FStar_Extraction_ML_Util.eraseTypeDeep (FStar_Extraction_ML_Util.udelta_unfold env))))
in (
...
let def = (let _0_485 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range (FStar_Ident.range_of_lid lid)))
in (_0_485)::(FStar_Extraction_ML_Syntax.MLM_Ty (td))::[])
in (
...
let print_ifamily : inductive_family  ->  Prims.unit = (fun i -> (let _0_493 = (FStar_Syntax_Print.lid_to_string i.iname)
in (let _0_492 = (FStar_Syntax_Print.binders_to_string " " i.iparams)
in (let _0_491 = (FStar_Syntax_Print.term_to_string i.ityp)
in (let _0_490 = (let _0_489 = (FStar_All.pipe_right i.idatas (FStar_List.map (fun d -> (let _0_488 = (FStar_Syntax_Print.lid_to_string d.dname)
in (let _0_487 = (let _0_486 = (FStar_Syntax_Print.term_to_string d.dtyp)
in (Prims.strcat " : " _0_486))
in (Prims.strcat _0_488 _0_487))))))
in (FStar_All.pipe_right _0_489 (FStar_String.concat "\n\t\t")))
in (FStar_Util.print4 "\n\t%s %s : %s { %s }\n" _0_493 _0_492 _0_491 _0_490))))))
...
FStar_Syntax_Syntax.NT ((let _0_494 = (FStar_Syntax_Syntax.bv_to_name b)
in ((b'), (_0_494))))
end)) bs_params bs)
in (

let t = (let _0_496 = (let _0_495 = (FStar_Syntax_Syntax.mk_Total body)
in (FStar_Syntax_Util.arrow rest _0_495))
in (FStar_All.pipe_right _0_496 (FStar_Syntax_Subst.subst subst)))
in ({dname = d; dtyp = t})::[]))
end))
end))
end
...
let mlt = (let _0_497 = (FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp)
in (FStar_Extraction_ML_Util.eraseTypeDeep (FStar_Extraction_ML_Util.udelta_unfold env) _0_497))
in (
...
in (let _0_500 = (FStar_Extraction_ML_UEnv.extend_fv env fvv tys false false)
in (let _0_499 = (let _0_498 = (FStar_Extraction_ML_Util.argTypes mlt)
in (((lident_as_mlsymbol ctor.dname)), (_0_498)))
in ((_0_500), (_0_499))))))))
in (
...
let ml_params = (let _0_503 = (FStar_All.pipe_right indices (FStar_List.mapi (fun i uu____630 -> (let _0_502 = (let _0_501 = (FStar_Util.string_of_int i)
in (Prims.strcat "\'dummyV" _0_501))
in ((_0_502), ((Prims.parse_int "0")))))))
in (FStar_List.append vars _0_503))
in (
...
let rec extract_sig : env_t  ->  FStar_Syntax_Syntax.sigelt  ->  (env_t * FStar_Extraction_ML_Syntax.mlmodule1 Prims.list) = (fun g se -> ((FStar_Extraction_ML_UEnv.debug g (fun u -> (let _0_504 = (FStar_Syntax_Print.sigelt_to_string se)
...
let g = (let _0_505 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Extraction_ML_UEnv.extend_fv' g _0_505 ml_name tysc false false))
in (
...
let uu____871 = (let _0_506 = (FStar_Extraction_ML_UEnv.lookup_fv g fv)
in (FStar_All.pipe_left FStar_Util.right _0_506))
in (match (uu____871) with
| (uu____892, tysc, uu____894) -> begin
(let _0_507 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) (FStar_Extraction_ML_Syntax.MLE_Name (mlp)))
in ((_0_507), (tysc)))
end)))
end
| uu____895 -> begin
...
let uu____990 = (let _0_508 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___130_992 -> (match (uu___130_992) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____993 -> begin
...
in (FStar_All.pipe_right _0_508 Prims.op_Negation))
...
in (let _0_509 = (FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit None)
in (extract_typ_abbrev g fv quals _0_509)))
end))
end))
end
...
(let _0_510 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (extract_typ_abbrev g _0_510 quals lb.FStar_Syntax_Syntax.lbdef))
end
...
let env = (let _0_512 = (FStar_Util.right lbname)
in (let _0_511 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_fv' env _0_512 mname _0_511 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false)))
in ((env), ((
...
| uu____1149 -> begin
(let _0_515 = (let _0_514 = (let _0_513 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_lb env lbname t _0_513 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false))
in (FStar_All.pipe_left Prims.fst _0_514))
in ((_0_515), (ml_lb)))
end))
...
in (let _0_517 = (let _0_516 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (_0_516)::(FStar_Extraction_ML_Syntax.MLM_Let (((flavor), ((FStar_List.append flags flags')), ((FStar_List.rev ml_lbs')))))::[])
in ((g), (_0_517)))))
end))
end
| uu____1196 -> begin
(failwith (let _0_518 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" _0_518)))
end)
end)))
end
...
| (bs, t) -> begin
(let _0_519 = (fail_exp lid t)
in (FStar_Syntax_Util.abs bs _0_519 None))
end))
in FStar_Syntax_Syntax.Sig_let ((let _0_523 = (let _0_522 = (let _0_521 = (let _0_520 = FStar_Util.Inr ((FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None))
in {FStar_Syntax_Syntax.lbname = _0_520; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (_0_521)::[])
in ((false), (_0_522)))
in ((_0_523), (r), ([]), (quals), ([])))))
in (
...
| Some (l) -> begin
(let _0_527 = (let _0_526 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (let _0_525 = (let _0_524 = (FStar_Extraction_ML_Term.ind_discriminator_body g lid l)
in (_0_524)::[])
in (_0_526)::_0_525))
in ((g), (_0_527)))
end
...
(let _0_529 = (let _0_528 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (_0_528)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (_0_529)))
end))
end
...
let extract_iface : FStar_Extraction_ML_UEnv.env  ->  FStar_Syntax_Syntax.modul  ->  env_t = (fun g m -> (let _0_530 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
