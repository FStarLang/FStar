  ...
  fun g ->
    fun se ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let ((uu____5444, lbs), uu____5446) when
           FStar_Util.for_some
             (fun uu___8_5456 ->
                match uu___8_5456 with
                | FStar_Syntax_Syntax.NoExtract -> true
                | uu____5457 -> false) se.FStar_Syntax_Syntax.sigquals
           ->
           let decl_of_lb lb =
             let fv = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
             let uu___898_5465 = se in
             let uu____5466 =
               let uu____5467 =
                 let uu____5474 = FStar_Syntax_Syntax.lid_of_fv fv in
                 (uu____5474, (lb.FStar_Syntax_Syntax.lbunivs),
                   (lb.FStar_Syntax_Syntax.lbtyp)) in
               FStar_Syntax_Syntax.Sig_declare_typ uu____5467 in
             let uu____5475 =
               let uu____5478 =
                 FStar_List.filter
                   (fun uu___9_5482 ->
                      match uu___9_5482 with
                      | FStar_Syntax_Syntax.NoExtract -> false
                      | uu____5483 -> true) se.FStar_Syntax_Syntax.sigquals in
               FStar_Syntax_Syntax.Assumption :: uu____5478 in
             {
               FStar_Syntax_Syntax.sigel = uu____5466;
               FStar_Syntax_Syntax.sigrng =
                 (uu___898_5465.FStar_Syntax_Syntax.sigrng);
               FStar_Syntax_Syntax.sigquals = uu____5475;
               FStar_Syntax_Syntax.sigmeta =
                 (uu___898_5465.FStar_Syntax_Syntax.sigmeta);
               FStar_Syntax_Syntax.sigattrs =
                 (uu___898_5465.FStar_Syntax_Syntax.sigattrs);
               FStar_Syntax_Syntax.sigopts =
                 (uu___898_5465.FStar_Syntax_Syntax.sigopts)
             } in
           let decls = FStar_List.map decl_of_lb lbs in
           let uu____5487 = FStar_Util.fold_map extract_sig g decls in
           (match uu____5487 with
            | (g1, out) -> (g1, (FStar_List.flatten out)))
       | FStar_Syntax_Syntax.Sig_let (lbs, uu____5517) ->
           ...
           let uu____5528 =
             ...
             | FStar_Pervasives_Native.Some
                 (ats, (tau, FStar_Pervasives_Native.None)::uu____5566) ->
           ...
           (match uu____5528 with
            | (attrs1, post_tau) ->
                let postprocess_lb tau lb =
                  let lbdef =
                    let uu____5650 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                    FStar_TypeChecker_Env.postprocess uu____5650 tau
                      lb.FStar_Syntax_Syntax.lbtyp
                      lb.FStar_Syntax_Syntax.lbdef in
                  let uu___934_5651 = lb in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___934_5651.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___934_5651.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___934_5651.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___934_5651.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___934_5651.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___934_5651.FStar_Syntax_Syntax.lbpos)
                  } in
                let lbs1 =
                  let uu____5659 =
                    match post_tau with
                  ...
                  ((FStar_Pervasives_Native.fst lbs), uu____5659) in
                let uu____5673 =
                  let uu____5680 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                  ...
                  FStar_Extraction_ML_Term.term_as_mlexpr g uu____5680 in
                (match uu____5673 with
                 | (ml_let, uu____5696, uu____5697) ->
                     (match ml_let.FStar_Extraction_ML_Syntax.expr with
                      | FStar_Extraction_ML_Syntax.MLE_Let
                          ((flavor, bindings), uu____5706) ->
                          ...
                          let uu____5723 =
                            FStar_List.fold_left2
                              (fun uu____5749 ->
                                 fun ml_lb ->
                                   fun uu____5751 ->
                                     match (uu____5749, uu____5751) with
                                     | ((env, ml_lbs),
                                        {
                                            ...
                                            let meta =
                                              FStar_List.append flags
                                                (FStar_List.append flags'
                                                   flags'') in
                                            let ml_lb1 =
                                              let uu___982_5877 = ml_lb in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___982_5877.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___982_5877.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___982_5877.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___982_5877.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___982_5877.FStar_Extraction_ML_Syntax.print_typ)
                                              } in
                                            let uu____5878 =
                                              let uu____5883 =
                                                FStar_All.pipe_right quals
                                                    ...
                                                    (env1,
                                                      (let uu___994_5916 =
                                                         ml_lb1 in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___994_5916.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___994_5916.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___994_5916.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___994_5916.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___994_5916.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____5918 =
                                                   let uu____5925 =
                          ...
                          (match uu____5723 with
                           | (g1, ml_lbs') ->
                               let uu____5959 =
                                 ...
                                 let uu____5969 = maybe_register_plugin g1 se in
                                 FStar_List.append uu____5962 uu____5969 in
                               (g1, uu____5959))
                      | uu____5974 ->
                          let uu____5975 =
                            let uu____5976 =
                              ...
                              FStar_Extraction_ML_Code.string_of_mlexpr
                                uu____5977 ml_let in
                            FStar_Util.format1
                              "Impossible: Translated a let to a non-let: %s"
                              uu____5976 in
                          failwith uu____5975)))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____5985, t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____5990 =
             (FStar_All.pipe_right quals
                (FStar_List.contains FStar_Syntax_Syntax.Assumption))
               &&
               (let uu____5994 =
                  let uu____5995 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                  FStar_TypeChecker_Util.must_erase_for_extraction uu____5995
                    t in
                Prims.op_Negation uu____5994) in
           if uu____5990
           then
             let always_fail1 =
               let uu___1014_6003 = se in
               let uu____6004 =
                 let uu____6005 =
                   let uu____6012 =
                     let uu____6013 =
                       let uu____6016 = always_fail lid t in [uu____6016] in
                     (false, uu____6013) in
                   (uu____6012, []) in
                 FStar_Syntax_Syntax.Sig_let uu____6005 in
               {
                 FStar_Syntax_Syntax.sigel = uu____6004;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___1014_6003.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___1014_6003.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___1014_6003.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___1014_6003.FStar_Syntax_Syntax.sigattrs);
                 FStar_Syntax_Syntax.sigopts =
                   (uu___1014_6003.FStar_Syntax_Syntax.sigopts)
               } in
             let uu____6021 = extract_sig g always_fail1 in
             (match uu____6021 with
              | (g1, mlm) ->
                  let uu____6040 =
                    FStar_Util.find_map quals
                      (fun uu___11_6045 ->
                         match uu___11_6045 with
                       ...
                       let uu____6057 =
                         let uu____6060 =
                           let uu____6061 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____6061 in
                         let uu____6062 =
                           let uu____6065 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                               g1 lid l in
                           [uu____6065] in
                         uu____6060 :: uu____6062 in
                       (g1, uu____6057)
                   | uu____6068 ->
                       let uu____6071 =
                         FStar_Util.find_map quals
                           (fun uu___12_6077 ->
                              match uu___12_6077 with
                              | FStar_Syntax_Syntax.Projector (l, uu____6081)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6082 -> FStar_Pervasives_Native.None) in
                       (match uu____6071 with
                        | FStar_Pervasives_Native.Some uu____6089 -> (g1, [])
                        | uu____6092 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_assume uu____6100 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____6109 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____6112 -> (g, [])
       | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____6127 -> (g, [])
       | FStar_Syntax_Syntax.Sig_polymonadic_subcomp uu____6140 -> (g, [])
       | FStar_Syntax_Syntax.Sig_pragma p ->
           (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
            (g, [])))
let (extract' :
  ...
  fun g ->
    fun m ->
      let uu____6177 = FStar_Options.restore_cmd_line_options true in
      let uu____6178 =
      ...
      | (name, g1) ->
          let g2 =
            let uu____6192 =
              let uu____6193 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g1 in
              FStar_TypeChecker_Env.set_current_module uu____6193
                m.FStar_Syntax_Syntax.name in
            FStar_Extraction_ML_UEnv.set_tcenv g1 uu____6192 in
              ...
              (fun g4 ->
                 fun se ->
                   let uu____6214 =
                     ...
                     FStar_Options.debug_module uu____6215 in
                   if uu____6214
                   then
                     let nm =
                       let uu____6223 =
                     ...
                     (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                      (let uu____6233 =
                       ...
                       FStar_Util.measure_execution_time uu____6233
                         (fun uu____6241 -> extract_sig g4 se)))
          ...
          (match uu____6195 with
           | (g4, sigs) ->
               ...
               let is_kremlin =
                 let uu____6261 = FStar_Options.codegen () in
                 uu____6261 =
               ...
               then
                 ((let uu____6277 =
                     let uu____6278 = FStar_Options.silent () in
                     Prims.op_Negation uu____6278 in
                   if uu____6277
                   then
                     let uu____6279 =
                       FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
...
let (extract :
  ...
  fun g ->
    fun m ->
      (let uu____6349 = FStar_Options.restore_cmd_line_options true in
       FStar_All.pipe_left (fun uu____6350 -> ()) uu____6349);
      (let uu____6352 =
         let uu____6353 =
           let uu____6354 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
           FStar_Options.should_extract uu____6354 in
      ...
      (let uu____6358 = FStar_Options.interactive () in
       if uu____6358
       then (g, FStar_Pervasives_Native.None)
         ...
         (let uu____6368 =
            FStar_Syntax_Unionfind.with_uf_enabled
              (fun uu____6384 ->
                 let uu____6385 = FStar_Options.debug_any () in
                 if uu____6385
                 then
                   let msg =
                     let uu____6393 =
                       FStar_Syntax_Print.lid_to_string
                         m.FStar_Syntax_Syntax.name in
                     FStar_Util.format1 "Extracting module %s" uu____6393 in
                   FStar_Util.measure_execution_time msg
                     (fun uu____6401 -> extract' g m)
                 else extract' g m) in
          match uu____6368 with
          | (g1, mllib) ->
              ((let uu____6416 = FStar_Options.restore_cmd_line_options true in
                FStar_All.pipe_left (fun uu____6417 -> ()) uu____6416);
               (let uu____6418 = FStar_Extraction_ML_UEnv.exit_module g1 in
                (uu____6418, mllib)))))