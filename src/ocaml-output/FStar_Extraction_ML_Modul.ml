...
let uu____1356 = (FStar_Syntax_Util.arrow_formals t)
...
let uu____1388 = (fail_exp lid t1)
in (FStar_Syntax_Util.abs bs uu____1388 None))
end))
in (

let uu___158_1394 = se
in (
...
let uu____1414 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in FStar_Util.Inr (uu____1414))
in {FStar_Syntax_Syntax.lbname = uu____1411; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (uu____1410)::[])
in ((false), (uu____1408)))
in ((uu____1404), ([]), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____1396))
in {FStar_Syntax_Syntax.sigel = uu____1395; FStar_Syntax_Syntax.sigrng = uu___158_1394.FStar_Syntax_Syntax.sigrng})))
in (

let uu____1422 = (extract_sig g always_fail)
in (match (uu____1422) with
| (g1, mlm) -> begin
(

let uu____1433 = (FStar_Util.find_map quals (fun uu___155_1435 -> (match (uu___155_1435) with
...
let uu____1446 = (FStar_Extraction_ML_Util.mlloc_of_range se.FStar_Syntax_Syntax.sigrng)
in FStar_Extraction_ML_Syntax.MLM_Loc (uu____1446))
in (

let uu____1447 = (

let uu____1449 = (FStar_Extraction_ML_Term.ind_discriminator_body g1 lid l)
in (uu____1449)::[])
in (uu____1445)::uu____1447))
in ((g1), (uu____1443)))
end
| uu____1451 -> begin
(

let uu____1453 = (FStar_Util.find_map quals (fun uu___156_1455 -> (match (uu___156_1455) with
| FStar_Syntax_Syntax.Projector (l, uu____1458) -> begin
Some (l)
end
| uu____1459 -> begin
None
...
let uu____1471 = (FStar_Extraction_ML_Term.term_as_mlexpr g e)
in (match (uu____1471) with
| (ml_main, uu____1479, uu____1480) -> begin
(
...
let uu____1484 = (FStar_Extraction_ML_Util.mlloc_of_range se.FStar_Syntax_Syntax.sigrng)
in FStar_Extraction_ML_Syntax.MLM_Loc (uu____1484))
in (uu____1483)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (uu____1481)))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____1486) -> begin
...
let uu____1504 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right uu____1504 Prims.fst)))
...
let uu____1529 = (FStar_Options.restore_cmd_line_options true)
in (
...
let uu___159_1532 = g
in {FStar_Extraction_ML_UEnv.tcenv = uu___159_1532.FStar_Extraction_ML_UEnv.tcenv; FStar_Extraction_ML_UEnv.gamma = uu___159_1532.FStar_Extraction_ML_UEnv.gamma; FStar_Extraction_ML_UEnv.tydefs = uu___159_1532.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.currentModule = name})
in (

let uu____1533 = (FStar_Util.fold_map extract_sig g1 m.FStar_Syntax_Syntax.declarations)
...
let uu____1550 = (FStar_Options.codegen ())
...
let uu____1554 = (((m.FStar_Syntax_Syntax.name.FStar_Ident.str <> "Prims") && (is_kremlin || (not (m.FStar_Syntax_Syntax.is_interface)))) && (FStar_Options.should_extract m.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (match (uu____1554) with
| true -> begin
((

let uu____1559 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
