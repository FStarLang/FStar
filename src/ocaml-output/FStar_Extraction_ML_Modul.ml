                       ...
                       | FStar_Syntax_Syntax.Tm_app (h,args) ->
                           ...
                           let tac_lid =
                             let uu____2672 =
                               ...
                               uu____2675.FStar_Syntax_Syntax.fv_name in
                           ...
                           let assm_lid =
                             ...
                             FStar_Ident.lid_of_ns_and_id
                               tac_lid.FStar_Ident.ns uu____2677 in
                           let uu____2678 = is_tactic_decl assm_lid h1 in
                           if uu____2678
                           then
                             let uu____2681 =
                               let uu____2682 =
                                 let uu____2683 = FStar_List.hd args in
                                 FStar_Pervasives_Native.fst uu____2683 in
                               mk_registration tac_lid assm_lid uu____2682 bs in
                             [uu____2681]
                           else []
                       | uu____2699 -> []))
             | uu____2700 -> [] in
           let uu____2703 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
           (match uu____2703 with
            | (ml_let,uu____2717,uu____2718) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,uu____2726,bindings),uu____2728) ->
                     let uu____2741 =
                       FStar_List.fold_left2
                         (fun uu____2768  ->
                            fun ml_lb  ->
                              fun uu____2770  ->
                                match (uu____2768, uu____2770) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2817 =
                                        ...
                                        uu____2820.FStar_Syntax_Syntax.fv_name in
                                      uu____2817.FStar_Syntax_Syntax.v in
                                    let uu____2821 =
                                      let uu____2826 =
                                        FStar_All.pipe_right quals
                                          (FStar_Util.for_some
                                             (fun uu___158_2831  ->
                                                match uu___158_2831 with
                                      ...
                                      then
                                        ...
                                        let uu____2844 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____2849 mname uu____2850
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____2844 with
                                        | (env1,uu____2856) ->
                                            (env1,
                                              (let uu___163_2858 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___163_2858.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___163_2858.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___163_2858.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___163_2858.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2862 =
                                           let uu____2863 =
                     ...
                     (match uu____2741 with
                      | (g1,ml_lbs') ->
                          ...
                          let flags' =
                            FStar_List.choose
                              (fun uu___160_2917  ->
                                 match uu___160_2917 with
                                 | {
                                     FStar_Syntax_Syntax.n =
                                       FStar_Syntax_Syntax.Tm_constant
                                       (FStar_Const.Const_string
                                       (s,uu____2923));
                                     FStar_Syntax_Syntax.pos = uu____2924;
                                     FStar_Syntax_Syntax.vars = uu____2925;_}
                                     ->
                                     FStar_Pervasives_Native.Some
                          ...
                          let uu____2932 =
                            let uu____2935 =
                              let uu____2938 =
                                ...
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2939 in
                              [uu____2938;
                              FStar_Extraction_ML_Syntax.MLM_Let
                                (flavor, (FStar_List.append flags flags'),
                                  (FStar_List.rev ml_lbs'))] in
                            FStar_List.append uu____2935
                 ...
                 | uu____2946 ->
                     let uu____2947 =
                       ...
                       FStar_Util.format1
                         ...
                         uu____2948 in
                     failwith uu____2947))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2956,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____2961 =
             FStar_All.pipe_right quals
           ...
           then
             let always_fail =
               let imp =
                 let uu____2972 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____3001 in
                     let uu____3002 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____3002
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____3021 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____3021
                       FStar_Pervasives_Native.None in
               let uu___164_3022 = se in
               let uu____3023 =
                 let uu____3024 =
                   let uu____3031 =
                     let uu____3038 =
                         ...
                         let uu____3042 =
                           let uu____3047 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant
                               FStar_Pervasives_Native.None in
                           FStar_Util.Inr uu____3047 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____3042;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____3038) in
                   (uu____3031, []) in
                 FStar_Syntax_Syntax.Sig_let uu____3024 in
               {
                 FStar_Syntax_Syntax.sigel = uu____3023;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___164_3022.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___164_3022.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___164_3022.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___164_3022.FStar_Syntax_Syntax.sigattrs)
               } in
             let uu____3058 = extract_sig g always_fail in
             (match uu____3058 with
              | (g1,mlm) ->
                  let uu____3077 =
                    FStar_Util.find_map quals
                      (fun uu___161_3082  ->
                         match uu___161_3082 with
                  ...
                  (match uu____3077 with
                       ...
                       let uu____3094 =
                         let uu____3097 =
                           let uu____3098 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____3098 in
                         let uu____3099 =
                           let uu____3102 =
                   ...
                   | uu____3105 ->
                       let uu____3108 =
                         FStar_Util.find_map quals
                           (fun uu___162_3114  ->
                              match uu___162_3114 with
                              | FStar_Syntax_Syntax.Projector (l,uu____3118)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3119 -> FStar_Pervasives_Native.None) in
                       (match uu____3108 with
                        | FStar_Pervasives_Native.Some uu____3126 -> (g1, [])
                        | uu____3129 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____3138 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____3138 with
            | (ml_main,uu____3152,uu____3153) ->
                let uu____3154 =
                  let uu____3157 =
                    let uu____3158 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____3158 in
                  [uu____3157; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3154))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____3161 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____3168 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____3177 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____3180 -> (g, [])
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____3208 FStar_Pervasives_Native.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____3253 = FStar_Options.debug_any () in
       if uu____3253
       then
         let uu____3254 =
      ...
      (let uu____3256 = FStar_Options.restore_cmd_line_options true in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name in
       let g1 =
         let uu___165_3259 = g in
         let uu____3260 =
           FStar_TypeChecker_Env.set_current_module
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
         {
           FStar_Extraction_ML_UEnv.tcenv = uu____3260;
           FStar_Extraction_ML_UEnv.gamma =
             (uu___165_3259.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___165_3259.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___165_3259.FStar_Extraction_ML_UEnv.type_names);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____3290 = FStar_Options.codegen () in
