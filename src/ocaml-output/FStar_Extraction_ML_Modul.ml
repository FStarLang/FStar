    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2340) when
           ...
           let uu____2356 =
             ...
             | (tcenv,uu____2389,def_typ) ->
                 let uu____2395 = as_pair def_typ in (tcenv, uu____2395) in
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____2421) ->
             ...
             let mk_registration tac_lid assm_lid t bs =
               let h =
                 let uu____2468 =
                   let uu____2469 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2470 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2469 in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2468 in
               let lid_arg =
                 let uu____2472 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2496 in
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             ...
                             let assm_lid =
                               ...
                               FStar_Ident.lid_of_ns_and_id
                                 tac_lid.FStar_Ident.ns uu____2586 in
                             let uu____2587 =
                               let uu____2588 = FStar_Syntax_Subst.compress h in
           ...
           let uu____2613 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2738 =
                                        ...
                                        uu____2741.FStar_Syntax_Syntax.fv_name in
                                    ...
                                    let ml_lb1 =
                                      let uu___77_2793 = ml_lb in
                                      {
                                        FStar_Extraction_ML_Syntax.mllb_name
                                          =
                                          (uu___77_2793.FStar_Extraction_ML_Syntax.mllb_name);
                                        FStar_Extraction_ML_Syntax.mllb_tysc
                                          =
                                          (uu___77_2793.FStar_Extraction_ML_Syntax.mllb_tysc);
                                        FStar_Extraction_ML_Syntax.mllb_add_unit
                                          =
                                          (uu___77_2793.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                        FStar_Extraction_ML_Syntax.mllb_def =
                                          (uu___77_2793.FStar_Extraction_ML_Syntax.mllb_def);
                                        FStar_Extraction_ML_Syntax.mllb_meta
                                          = meta;
                                        FStar_Extraction_ML_Syntax.print_typ
                                          =
                                          (uu___77_2793.FStar_Extraction_ML_Syntax.print_typ)
                                      } in
                                    let uu____2794 =
                                      let uu____2799 =
                                        FStar_All.pipe_right quals
                                      ...
                                      then
                                        ...
                                        let uu____2817 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____2822 mname uu____2823
                                            ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____2817 with
                                        | (env1,uu____2829) ->
                                            (env1,
                                              (let uu___78_2831 = ml_lb1 in
                                               {
                                                 FStar_Extraction_ML_Syntax.mllb_name
                                                   =
                                                   (FStar_Pervasives_Native.snd
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___78_2831.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___78_2831.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___78_2831.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.mllb_meta
                                                   =
                                                   (uu___78_2831.FStar_Extraction_ML_Syntax.mllb_meta);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___78_2831.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2835 =
                                           let uu____2836 =
                                             ...
                                             FStar_Extraction_ML_UEnv.extend_lb
                                               env lbname t uu____2841
                                               ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                               false in
                                           FStar_All.pipe_left
                                             FStar_Pervasives_Native.fst
                                             uu____2836 in
                                         (uu____2835, ml_lb1)) in
                          ...
                          let uu____2872 =
                            let uu____2875 =
                              let uu____2878 =
                                ...
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2879 in
                              [uu____2878;
                              FStar_Extraction_ML_Syntax.MLM_Let
                                (flavor, (FStar_List.rev ml_lbs'))] in
                            FStar_List.append uu____2875
                 ...
                 | uu____2884 ->
                     let uu____2885 =
                       ...
                       FStar_Util.format1
                         ...
                         uu____2886 in
                     failwith uu____2885))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2894,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____2899 =
             FStar_All.pipe_right quals
           ...
           then
             let always_fail =
               let imp =
                 let uu____2910 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     ...
                     FStar_Syntax_Util.abs [b] uu____2940
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____2959 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____2959
                       FStar_Pervasives_Native.None in
               let uu___79_2960 = se in
               let uu____2961 =
                 let uu____2962 =
                   let uu____2969 =
                     let uu____2976 =
                     ...
                     (false, uu____2976) in
                   (uu____2969, []) in
                 FStar_Syntax_Syntax.Sig_let uu____2962 in
               {
                 FStar_Syntax_Syntax.sigel = uu____2961;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___79_2960.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___79_2960.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___79_2960.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___79_2960.FStar_Syntax_Syntax.sigattrs)
               } in
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____3144 FStar_Pervasives_Native.fst
let extract':
  FStar_Extraction_ML_UEnv.env ->
    ...
    fun m  ->
      ...
      (let codegen_opt = FStar_Options.codegen () in
       ...
       (let name =
        ...
        let g1 =
          let uu___80_3196 = g in
          let uu____3197 =
            FStar_TypeChecker_Env.set_current_module
              g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
          {
            FStar_Extraction_ML_UEnv.tcenv = uu____3197;
            FStar_Extraction_ML_UEnv.gamma =
              (uu___80_3196.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___80_3196.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___80_3196.FStar_Extraction_ML_UEnv.type_names);
        ...
        | (g2,sigs) ->
            ...
            let is_kremlin =
              let uu____3227 = FStar_Options.codegen () in
...
let extract:
  ...
  fun g  ->
    fun m  ->
      let uu____3315 = FStar_Options.debug_any () in
      if uu____3315
      then
        let msg =
          let uu____3323 =
