    ...
    fun se ->
      ...
      (let uu____5243 =
         (FStar_List.contains FStar_Syntax_Syntax.NoExtract
            se.FStar_Syntax_Syntax.sigquals)
           &&
           (let uu____5245 = FStar_Options.codegen () in
            uu____5245 <>
       ...
       then (g, [])
         ...
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_bundle uu____5265 -> extract_bundle g se
          | FStar_Syntax_Syntax.Sig_inductive_typ uu____5274 ->
              extract_bundle g se
          | FStar_Syntax_Syntax.Sig_datacon uu____5291 -> extract_bundle g se
          | FStar_Syntax_Syntax.Sig_new_effect ed when
              let uu____5307 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
              FStar_TypeChecker_Env.is_reifiable_effect uu____5307
                ed.FStar_Syntax_Syntax.mname
              ->
              let uu____5308 = extract_reifiable_effect g ed in
              (match uu____5308 with | (env, _iface, impl) -> (env, impl))
          | FStar_Syntax_Syntax.Sig_splice uu____5332 ->
              failwith "impossible: trying to extract splice"
          | FStar_Syntax_Syntax.Sig_fail uu____5345 ->
              failwith "impossible: trying to extract Sig_fail"
          | FStar_Syntax_Syntax.Sig_new_effect uu____5362 -> (g, [])
          | FStar_Syntax_Syntax.Sig_declare_typ (lid, univs, t) when
              FStar_Extraction_ML_Term.is_arity g t ->
              let uu____5368 =
                extract_type_declaration g lid
                  se.FStar_Syntax_Syntax.sigquals
                  se.FStar_Syntax_Syntax.sigattrs univs t in
              (match uu____5368 with | (env, uu____5384, impl) -> (env, impl))
          | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____5393) when
              FStar_Extraction_ML_Term.is_arity g
          ...
          | FStar_Syntax_Syntax.Sig_let ((true, lbs), uu____5425) when
              FStar_Util.for_some
                (fun lb ->
                   FStar_Extraction_ML_Term.is_arity g
                     lb.FStar_Syntax_Syntax.lbtyp) lbs
               ...
               | (attrs1, post_tau) ->
                   let postprocess_lb tau lb =
                     let lbdef =
                       ...
                       FStar_TypeChecker_Env.postprocess uu____5594 tau
                         lb.FStar_Syntax_Syntax.lbtyp
                         lb.FStar_Syntax_Syntax.lbdef in
                     let uu___912_5595 = lb in
                     {
                       FStar_Syntax_Syntax.lbname =
                         (uu___912_5595.FStar_Syntax_Syntax.lbname);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___912_5595.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___912_5595.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___912_5595.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef = lbdef;
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___912_5595.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___912_5595.FStar_Syntax_Syntax.lbpos)
                     } in
                   let lbs1 =
                     let uu____5603 =
                       match post_tau with
                     ...
                     ((FStar_Pervasives_Native.fst lbs), uu____5603) in
                   let uu____5617 =
                     let uu____5624 =
                       FStar_Syntax_Syntax.mk
                         (FStar_Syntax_Syntax.Tm_let
                     ...
                     FStar_Extraction_ML_Term.term_as_mlexpr g uu____5624 in
                   (match uu____5617 with
                    | (ml_let, uu____5640, uu____5641) ->
                        (match ml_let.FStar_Extraction_ML_Syntax.expr with
                         | FStar_Extraction_ML_Syntax.MLE_Let
                             ((flavor, bindings), uu____5650) ->
                             ...
                             let uu____5667 =
                               FStar_List.fold_left2
                                 (fun uu____5693 ->
                                    fun ml_lb ->
                                      fun uu____5695 ->
                                        match (uu____5693, uu____5695) with
                                        | ((env, ml_lbs),
                                           {
                                             FStar_Syntax_Syntax.lbname =
                                               lbname;
                                               ...
                                               let meta =
                                                 FStar_List.append flags
                                                   (FStar_List.append flags'
                                                      flags'') in
                                               let ml_lb1 =
                                                 let uu___960_5821 = ml_lb in
                                                 {
                                                   FStar_Extraction_ML_Syntax.mllb_name
                                                     =
                                                     (uu___960_5821.FStar_Extraction_ML_Syntax.mllb_name);
                                                   FStar_Extraction_ML_Syntax.mllb_tysc
                                                     =
                                                     (uu___960_5821.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                   FStar_Extraction_ML_Syntax.mllb_add_unit
                                                     =
                                                     (uu___960_5821.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                   FStar_Extraction_ML_Syntax.mllb_def
                                                     =
                                                     (uu___960_5821.FStar_Extraction_ML_Syntax.mllb_def);
                                                   FStar_Extraction_ML_Syntax.mllb_meta
                                                     = meta;
                                                   FStar_Extraction_ML_Syntax.print_typ
                                                     =
                                                     (uu___960_5821.FStar_Extraction_ML_Syntax.print_typ)
                                                 } in
                                               let uu____5822 =
                                                 let uu____5827 =
                                                   FStar_All.pipe_right quals
                                                       ...
                                                       (env1,
                                                         (let uu___972_5860 =
                                                            ml_lb1 in
                                                          {
                                                            ...
                                                            FStar_Extraction_ML_Syntax.mllb_tysc
                                                              =
                                                              (uu___972_5860.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                            FStar_Extraction_ML_Syntax.mllb_add_unit
                                                              =
                                                              (uu___972_5860.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                            FStar_Extraction_ML_Syntax.mllb_def
                                                              =
                                                              (uu___972_5860.FStar_Extraction_ML_Syntax.mllb_def);
                                                            FStar_Extraction_ML_Syntax.mllb_meta
                                                              =
                                                              (uu___972_5860.FStar_Extraction_ML_Syntax.mllb_meta);
                                                            FStar_Extraction_ML_Syntax.print_typ
                                                              =
                                                              (uu___972_5860.FStar_Extraction_ML_Syntax.print_typ)
                                                          }))
                                                 else
                                                   (let uu____5862 =
                                                      let uu____5869 =
                             ...
                             (match uu____5667 with
                              | (g1, ml_lbs') ->
                                  let uu____5903 =
                                    ...
                                    FStar_List.append uu____5906 uu____5913 in
                                  (g1, uu____5903))
                         | uu____5918 ->
                             let uu____5919 =
                               let uu____5920 =
                                 ...
                                 FStar_Extraction_ML_Code.string_of_mlexpr
                                   uu____5921 ml_let in
                               FStar_Util.format1
                                 "Impossible: Translated a let to a non-let: %s"
                                 uu____5920 in
                             failwith uu____5919)))
          | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____5929, t) ->
              let quals = se.FStar_Syntax_Syntax.sigquals in
              let uu____5934 =
                (FStar_All.pipe_right quals
                   (FStar_List.contains FStar_Syntax_Syntax.Assumption))
                  ...
                  (let uu____5938 =
                     ...
                     FStar_TypeChecker_Util.must_erase_for_extraction
                       uu____5939 t in
                   Prims.op_Negation uu____5938) in
              if uu____5934
              then
                let always_fail1 =
                  let uu___992_5947 = se in
                  let uu____5948 =
                    let uu____5949 =
                      let uu____5956 =
                        let uu____5957 =
                          let uu____5960 = always_fail lid t in [uu____5960] in
                        (false, uu____5957) in
                      (uu____5956, []) in
                    FStar_Syntax_Syntax.Sig_let uu____5949 in
                  {
                    FStar_Syntax_Syntax.sigel = uu____5948;
                    FStar_Syntax_Syntax.sigrng =
                      (uu___992_5947.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___992_5947.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___992_5947.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___992_5947.FStar_Syntax_Syntax.sigattrs);
                    FStar_Syntax_Syntax.sigopts =
                      (uu___992_5947.FStar_Syntax_Syntax.sigopts)
                  } in
                let uu____5965 = extract_sig g always_fail1 in
                          ...
                          let uu____6001 =
                            let uu____6004 =
                              let uu____6005 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____6005 in
                            let uu____6006 =
                              let uu____6009 =
                                FStar_Extraction_ML_Term.ind_discriminator_body
                                  g1 lid l in
                              [uu____6009] in
                            uu____6004 :: uu____6006 in
                          (g1, uu____6001)
                      | uu____6012 ->
                          let uu____6015 =
                            FStar_Util.find_map quals
                              (fun uu___10_6021 ->
                                 match uu___10_6021 with
                                 | FStar_Syntax_Syntax.Projector
                                     (l, uu____6025) ->
                                     FStar_Pervasives_Native.Some l
          ...
          | FStar_Syntax_Syntax.Sig_assume uu____6044 -> (g, [])
          | FStar_Syntax_Syntax.Sig_sub_effect uu____6053 -> (g, [])
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____6056 -> (g, [])
          | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____6071 -> (g, [])
          | FStar_Syntax_Syntax.Sig_polymonadic_subcomp uu____6084 -> (g, [])
          | FStar_Syntax_Syntax.Sig_pragma p ->
...
let (extract' :
  ...
  fun g ->
    fun m ->
      let uu____6121 = FStar_Options.restore_cmd_line_options true in
      let uu____6122 =
      ...
      | (name, g1) ->
          let g2 =
            let uu____6136 =
              let uu____6137 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g1 in
              FStar_TypeChecker_Env.set_current_module uu____6137
                m.FStar_Syntax_Syntax.name in
            FStar_Extraction_ML_UEnv.set_tcenv g1 uu____6136 in
              ...
              (fun g4 ->
                 fun se ->
                   let uu____6158 =
                     ...
                     FStar_Options.debug_module uu____6159 in
                   if uu____6158
                   then
                     let nm =
                       let uu____6167 =
                     ...
                     (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                      (let uu____6177 =
                       ...
                       FStar_Util.measure_execution_time uu____6177
                         (fun uu____6185 -> extract_sig g4 se)))
          ...
          (match uu____6139 with
           | (g4, sigs) ->
               ...
               let is_kremlin =
                 let uu____6205 = FStar_Options.codegen () in
                 uu____6205 =
                   (FStar_Pervasives_Native.Some FStar_Options.Kremlin) in
               let uu____6210 =
                 (let uu____6213 =
               ...
               then
                 ((let uu____6221 =
                     let uu____6222 = FStar_Options.silent () in
                     Prims.op_Negation uu____6222 in
                   if uu____6221
                   then
                     let uu____6223 =
                       FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
...
let (extract :
  ...
  fun g ->
    fun m ->
      (let uu____6293 = FStar_Options.restore_cmd_line_options true in
       FStar_All.pipe_left (fun uu____6294 -> ()) uu____6293);
      (let uu____6296 =
         let uu____6297 =
           let uu____6298 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
           FStar_Options.should_extract uu____6298 in
         Prims.op_Negation uu____6297 in
       if uu____6296
       then
         let uu____6299 =
           let uu____6300 =
      ...
      (let uu____6302 = FStar_Options.interactive () in
       if uu____6302
       then (g, FStar_Pervasives_Native.None)
         ...
         (let uu____6312 =
            FStar_Syntax_Unionfind.with_uf_enabled
              (fun uu____6328 ->
                 let uu____6329 = FStar_Options.debug_any () in
                 if uu____6329
                 then
                   let msg =
                     let uu____6337 =
                       FStar_Syntax_Print.lid_to_string
                         m.FStar_Syntax_Syntax.name in
                     FStar_Util.format1 "Extracting module %s" uu____6337 in
                   FStar_Util.measure_execution_time msg
                     (fun uu____6345 -> extract' g m)
                 else extract' g m) in
          match uu____6312 with
          | (g1, mllib) ->
              ((let uu____6360 = FStar_Options.restore_cmd_line_options true in
                FStar_All.pipe_left (fun uu____6361 -> ()) uu____6360);
               (let uu____6362 = FStar_Extraction_ML_UEnv.exit_module g1 in
                (uu____6362, mllib)))))