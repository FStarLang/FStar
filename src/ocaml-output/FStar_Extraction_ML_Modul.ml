...
let (iface_of_type_names : FStar_Syntax_Syntax.fv Prims.list -> iface) =
  fun fvs  ->
    let uu___414_1241 = empty_iface  in
    {
      iface_module_name = (uu___414_1241.iface_module_name);
      iface_bindings = (uu___414_1241.iface_bindings);
      iface_tydefs = (uu___414_1241.iface_tydefs);
    ...
    fun modul  ->
      ...
      then (g, empty_iface)
        ...
        (let decls = modul.FStar_Syntax_Syntax.declarations  in
         let iface1 =
           let uu___415_3031 = empty_iface  in
           {
             iface_module_name = (g.FStar_Extraction_ML_UEnv.currentModule);
             iface_bindings = (uu___415_3031.iface_bindings);
             iface_tydefs = (uu___415_3031.iface_tydefs);
             iface_type_names = (uu___415_3031.iface_type_names)
           }  in
    ...
    fun iface1  ->
         ...
         in
      {
        FStar_Extraction_ML_UEnv.env_tcenv =
          (uu___416_3078.FStar_Extraction_ML_UEnv.env_tcenv);
        ...
        FStar_Extraction_ML_UEnv.currentModule =
          (uu___416_3078.FStar_Extraction_ML_UEnv.currentModule)
      }
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___417_4519 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___417_4519.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___417_4519.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___417_4519.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___417_4519.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___417_4519.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___417_4519.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____4527 =
                    match post_tau with
                                           ...
                                           (let lb_lid =
                                            ...
                                            let meta =
                                              FStar_List.append flags1
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___418_4745 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___418_4745.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___418_4745.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___418_4745.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___418_4745.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___418_4745.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____4746 =
                                              let uu____4751 =
                                                FStar_All.pipe_right quals
                                                    ...
                                                    (env1,
                                                      (let uu___419_4798 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___419_4798.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___419_4798.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___419_4798.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___419_4798.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___419_4798.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____4802 =
                                                   let uu____4809 =
             ...
             let always_fail1 =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____4887  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___420_4885.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___420_4885.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___420_4885.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___420_4885.FStar_Syntax_Syntax.sigattrs)
               }  in
       ...
       let g1 =
            ...
            in
         {
           ...
           FStar_Extraction_ML_UEnv.env_bindings =
             (uu___421_5070.FStar_Extraction_ML_UEnv.env_bindings);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___421_5070.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___421_5070.FStar_Extraction_ML_UEnv.type_names);
