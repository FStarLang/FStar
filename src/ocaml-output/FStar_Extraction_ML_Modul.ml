...
let (extract_sigelt_iface :
  ...
  fun g  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_assume uu____3704 -> (g, empty_iface)
      | FStar_Syntax_Syntax.Sig_sub_effect uu____3711 -> (g, empty_iface)
      | FStar_Syntax_Syntax.Sig_effect_abbrev uu____3712 -> (g, empty_iface)
      | FStar_Syntax_Syntax.Sig_pragma p ->
          (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
           (g, empty_iface))
      | FStar_Syntax_Syntax.Sig_splice uu____3727 ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          if uu____3740
          then
            let uu____3753 = extract_reifiable_effect g ed  in
            (match uu____3753 with | (env,iface1,uu____3768) -> (env, iface1))
          else (g, empty_iface)
...
let (extract_iface' :
  ...
  fun g  ->
    fun modul  ->
      let uu____3790 = FStar_Options.interactive ()  in
      if uu____3790
      then (g, empty_iface)
      else
        (let uu____3799 = FStar_Options.restore_cmd_line_options true  in
         let decls = modul.FStar_Syntax_Syntax.declarations  in
         let iface1 =
           let uu___610_3803 = empty_iface  in
           {
             iface_module_name = (g.FStar_Extraction_ML_UEnv.currentModule);
             iface_bindings = (uu___610_3803.iface_bindings);
             iface_tydefs = (uu___610_3803.iface_tydefs);
             iface_type_names = (uu___610_3803.iface_type_names)
           }  in
         let res =
           FStar_List.fold_left
             (fun uu____3821  ->
                fun se  ->
                  ...
                  | (g1,iface2) ->
                      let uu____3833 = extract_sigelt_iface g1 se  in
                      (match uu____3833 with
                       | (g2,iface') ->
                           let uu____3844 = iface_union iface2 iface'  in
                           (g2, uu____3844))) (g, iface1) decls
            in
         (let uu____3846 = FStar_Options.restore_cmd_line_options true  in
          FStar_All.pipe_left (fun a1  -> ()) uu____3846);
         res)
...
let (extract_iface :
  ...
  fun g  ->
    fun modul  ->
      let uu____3863 = FStar_Options.debug_any ()  in
      if uu____3863
      then
        let uu____3870 =
          FStar_Util.format1 "Extracted interface of %s"
           ...
           in
        FStar_Util.measure_execution_time uu____3870
          (fun uu____3878  -> extract_iface' g modul)
...
let (extend_with_iface :
  ...
  fun g  ->
    fun iface1  ->
      let uu___628_3892 = g  in
      let uu____3893 =
        let uu____3896 =
          FStar_List.map (fun _3903  -> FStar_Extraction_ML_UEnv.Fv _3903)
            iface1.iface_bindings
           in
        FStar_List.append uu____3896 g.FStar_Extraction_ML_UEnv.env_bindings
         in
      {
        FStar_Extraction_ML_UEnv.env_tcenv =
          (uu___628_3892.FStar_Extraction_ML_UEnv.env_tcenv);
        FStar_Extraction_ML_UEnv.env_bindings = uu____3893;
        ...
        FStar_Extraction_ML_UEnv.currentModule =
          (uu___628_3892.FStar_Extraction_ML_UEnv.currentModule)
      }
  ...
  fun env  ->
    fun se  ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____3981 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp  in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____3981
           in
        let steps =
            ...
            let uu____3990 =
              let uu____3993 =
                FStar_TypeChecker_Normalize.normalize steps
                 ...
                 in
              FStar_Syntax_Subst.compress uu____3993  in
            uu____3990.FStar_Syntax_Syntax.n  in
          match uu____3989 with
          | FStar_Syntax_Syntax.Tm_arrow (bs,uu____3998) ->
              FStar_List.map
                (fun uu____4031  ->
                   match uu____4031 with
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        FStar_Syntax_Syntax.index = uu____4040;
                        FStar_Syntax_Syntax.sort = uu____4041;_},uu____4042)
        ...
        | (env2,uu____4085,uu____4086) ->
            let uu____4089 =
              let uu____4102 = lident_as_mlsymbol ctor.dname  in
              let uu____4104 =
                let uu____4112 = FStar_Extraction_ML_Util.argTypes mlt  in
                FStar_List.zip names1 uu____4112  in
              (uu____4102, uu____4104)  in
            (env2, uu____4089)
         in
      let extract_one_family env1 ind =
        let uu____4173 = binders_as_mlty_binders env1 ind.iparams  in
        ...
        | (env_iparams,vars) ->
            ...
            (match uu____4217 with
             | (env2,ctors) ->
                 let uu____4324 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____4417  ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4425))
                           in
                        FStar_List.append vars uu____4391  in
                      let tbody =
                        let uu____4430 =
                          FStar_Util.find_opt
                            (fun uu___7_4435  ->
                               match uu___7_4435 with
                               | FStar_Syntax_Syntax.RecordType uu____4437 ->
                                   true
                               | uu____4447 -> false) ind.iquals
                           in
                        match uu____4430 with
                        | FStar_Pervasives_Native.Some
                            (FStar_Syntax_Syntax.RecordType (ns,ids)) ->
                            let uu____4459 = FStar_List.hd ctors  in
                        ...
                        | uu____4547 ->
                         ...
                         in
                      let uu____4550 =
                        let uu____4573 = lident_as_mlsymbol ind.iname  in
                        (false, uu____4573, FStar_Pervasives_Native.None,
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
              (l,uu____4618,t,uu____4620,uu____4621,uu____4622);
            FStar_Syntax_Syntax.sigrng = uu____4623;
            FStar_Syntax_Syntax.sigquals = uu____4624;
            FStar_Syntax_Syntax.sigmeta = uu____4625;
            FStar_Syntax_Syntax.sigattrs = uu____4626;_}::[],uu____4627),(FStar_Syntax_Syntax.ExceptionConstructor
         )::[]) ->
          let uu____4646 = extract_ctor env [] env { dname = l; dtyp = t }
             in
          (match uu____4646 with
           | (env1,ctor) -> (env1, [FStar_Extraction_ML_Syntax.MLM_Exn ctor]))
      | (FStar_Syntax_Syntax.Sig_bundle (ses,uu____4699),quals) ->
          let uu____4713 =
            bundle_as_inductive_families env ses quals
              se.FStar_Syntax_Syntax.sigattrs
             in
      ...
      | uu____4841 -> failwith "Unexpected signature element"
    ...
    fun se  ->
      ...
      let plugin_with_arity attrs =
        FStar_Util.find_map attrs
                 ...
                 let uu____4947 =
                   let uu____4949 =
                     FStar_Syntax_Util.is_fvar FStar_Parser_Const.plugin_attr
                       head1
                      in
                   Prims.op_Negation uu____4949  in
                 if uu____4947
                 then FStar_Pervasives_Native.None
                   ...
                   (match args with
                    | ({
                         FStar_Syntax_Syntax.n =
                           FStar_Syntax_Syntax.Tm_constant
                           (FStar_Const.Const_int (s,uu____4968));
                         FStar_Syntax_Syntax.pos = uu____4969;
                         FStar_Syntax_Syntax.vars = uu____4970;_},uu____4971)::[]
                        ->
                        let uu____5010 =
                          let uu____5014 = FStar_Util.int_of_string s  in
         ...
         in
      let uu____5035 =
        let uu____5037 = FStar_Options.codegen ()  in
        uu____5037 <> (FStar_Pervasives_Native.Some FStar_Options.Plugin)  in
      if uu____5035
      then []
      else
        (let uu____5047 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs
            in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs,lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____5089 =
                        let uu____5090 = FStar_Ident.string_of_lid fv_lid1
                           in
                        FStar_Extraction_ML_Syntax.MLC_String uu____5090  in
                      FStar_Extraction_ML_Syntax.MLE_Const uu____5089  in
                    let uu____5092 =
  ...
  fun g  ->
    fun se  ->
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let uu____5236 = FStar_Syntax_Print.sigelt_to_string se  in
           FStar_Util.print1 ">>>> extract_sig %s \n" uu____5236);
      (match se.FStar_Syntax_Syntax.sigel with
       | FStar_Syntax_Syntax.Sig_bundle uu____5245 -> extract_bundle g se
       | FStar_Syntax_Syntax.Sig_inductive_typ uu____5254 ->
           extract_bundle g se
       | FStar_Syntax_Syntax.Sig_datacon uu____5271 -> extract_bundle g se
       | FStar_Syntax_Syntax.Sig_new_effect ed when
           FStar_TypeChecker_Env.is_reifiable_effect
             g.FStar_Extraction_ML_UEnv.env_tcenv
             ed.FStar_Syntax_Syntax.mname
           ->
           let uu____5288 = extract_reifiable_effect g ed  in
           (match uu____5288 with | (env,_iface,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_splice uu____5312 ->
           failwith "impossible: trying to extract splice"
       | FStar_Syntax_Syntax.Sig_new_effect uu____5326 -> (g, [])
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,univs1,t) when
           FStar_Extraction_ML_Term.is_arity g t ->
           let uu____5332 =
             extract_type_declaration g lid se.FStar_Syntax_Syntax.sigquals
               se.FStar_Syntax_Syntax.sigattrs univs1 t
              in
           (match uu____5332 with | (env,uu____5348,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____5357) when
           FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp
           ->
           let uu____5366 =
             extract_typ_abbrev g se.FStar_Syntax_Syntax.sigquals
               se.FStar_Syntax_Syntax.sigattrs lb
              in
           (match uu____5366 with | (env,uu____5382,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_let ((true ,lbs),uu____5391) when
           FStar_Util.for_some
             (fun lb  ->
                FStar_Extraction_ML_Term.is_arity g
                  lb.FStar_Syntax_Syntax.lbtyp) lbs
           ->
           let uu____5404 = extract_let_rec_types se g lbs  in
           (match uu____5404 with | (env,uu____5420,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____5429) ->
           ...
           let uu____5440 =
             ...
             | FStar_Pervasives_Native.Some
                 (ats,(tau,FStar_Pervasives_Native.None )::uu____5478) ->
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___858_5564 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___858_5564.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___858_5564.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___858_5564.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___858_5564.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___858_5564.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___858_5564.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____5573 =
                    match post_tau with
                    ...
                    | FStar_Pervasives_Native.None  ->
                        FStar_Pervasives_Native.snd lbs
                     in
                  ((FStar_Pervasives_Native.fst lbs), uu____5573)  in
                let uu____5591 =
                  let uu____5598 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                      ...
                      se.FStar_Syntax_Syntax.sigrng
                     in
                  FStar_Extraction_ML_Term.term_as_mlexpr g uu____5598  in
                (match uu____5591 with
                 | (ml_let,uu____5615,uu____5616) ->
                     (match ml_let.FStar_Extraction_ML_Syntax.expr with
                      | FStar_Extraction_ML_Syntax.MLE_Let
                          ((flavor,bindings),uu____5625) ->
                          ...
                          let uu____5642 =
                            FStar_List.fold_left2
                              (fun uu____5668  ->
                                 fun ml_lb  ->
                                   fun uu____5670  ->
                                     match (uu____5668, uu____5670) with
                                     | ((env,ml_lbs),{
                                                       FStar_Syntax_Syntax.lbname
                                                         = lbname;
                                                       FStar_Syntax_Syntax.lbunivs
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____5739 =
                                                ...
                                                uu____5742.FStar_Syntax_Syntax.fv_name
                                                 in
                                              uu____5739.FStar_Syntax_Syntax.v
                                               in
                                            let flags'' =
                                              let uu____5746 =
                                                let uu____5747 =
                                                  FStar_Syntax_Subst.compress
                                                    t
                                                   in
                                                uu____5747.FStar_Syntax_Syntax.n
                                                 in
                                            ...
                                            let meta =
                                              FStar_List.append flags
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___906_5803 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___906_5803.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___906_5803.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___906_5803.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___906_5803.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___906_5803.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____5804 =
                                              let uu____5809 =
                                                FStar_All.pipe_right quals
                                              ...
                                              then
                                                ...
                                                let uu____5849 =
                                                  ...
                                                  FStar_Extraction_ML_UEnv.extend_fv'
                                                    env uu____5857 mname
                                                    uu____5858
                                                    ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                    false
                                                   in
                                                match uu____5849 with
                                                | (env1,uu____5865,uu____5866)
                                                    ->
                                                    (env1,
                                                      (let uu___919_5870 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___919_5870.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___919_5870.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___919_5870.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___919_5870.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___919_5870.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____5877 =
                                                   let uu____5885 =
                                                   ...
                                                   FStar_Extraction_ML_UEnv.extend_lb
                                                     env lbname t uu____5885
                                                     ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                     false
                                                    in
                                                 match uu____5877 with
                                                 | (env1,uu____5892,uu____5893)
                                                     -> (env1, ml_lb1))
                                               in
                               ...
                               let uu____5923 =
                                 let uu____5926 =
                                   ...
                                   FStar_Extraction_ML_Syntax.MLM_Let
                                    ...
                                    in
                                 let uu____5933 = maybe_register_plugin g1 se
                                    in
                                 FStar_List.append uu____5926 uu____5933  in
                               (g1, uu____5923))
                      | uu____5938 ->
                          let uu____5939 =
                            let uu____5941 =
                            ...
                            FStar_Util.format1
                             ...
                             in
                          failwith uu____5939)))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____5951,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____5956 =
             (FStar_All.pipe_right quals
                (FStar_List.contains FStar_Syntax_Syntax.Assumption))
           ...
           then
             let always_fail1 =
               let uu___939_5972 = se  in
               let uu____5973 =
                 let uu____5974 =
                   let uu____5981 =
                     let uu____5982 =
                       let uu____5985 = always_fail lid t  in [uu____5985]
                        in
                     (false, uu____5982)  in
                   (uu____5981, [])  in
                 FStar_Syntax_Syntax.Sig_let uu____5974  in
               {
                 FStar_Syntax_Syntax.sigel = uu____5973;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___939_5972.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___939_5972.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___939_5972.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___939_5972.FStar_Syntax_Syntax.sigattrs)
               }  in
             let uu____5992 = extract_sig g always_fail1  in
             (match uu____5992 with
              | (g1,mlm) ->
                  let uu____6011 =
                    FStar_Util.find_map quals
                      (fun uu___9_6016  ->
                         match uu___9_6016 with
                         ...
                         let uu____6031 =
                           let uu____6032 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng
                              in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____6032  in
                         let uu____6033 =
                           let uu____6036 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                              ...
                              in
                           [uu____6036]  in
                         uu____6031 :: uu____6033  in
                       (g1, uu____6028)
                   | uu____6039 ->
                       let uu____6042 =
                         FStar_Util.find_map quals
                           (fun uu___10_6048  ->
                              match uu___10_6048 with
                              | FStar_Syntax_Syntax.Projector (l,uu____6052)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6053 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____6042 with
                        | FStar_Pervasives_Native.Some uu____6060 -> (g1, [])
                        | uu____6063 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____6073 = FStar_Extraction_ML_Term.term_as_mlexpr g e  in
           (match uu____6073 with
            | (ml_main,uu____6087,uu____6088) ->
                let uu____6089 =
                  let uu____6092 =
                    let uu____6093 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng
                       in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____6093  in
                  [uu____6092; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____6089))
       | FStar_Syntax_Syntax.Sig_assume uu____6096 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____6105 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____6108 -> (g, [])
       | FStar_Syntax_Syntax.Sig_pragma p ->
           (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
            (g, [])))
...
let (extract' :
  ...
  fun g  ->
    fun m  ->
      let uu____6150 = FStar_Options.restore_cmd_line_options true  in
      let name =
        FStar_Extraction_ML_Syntax.mlpath_of_lident
          m.FStar_Syntax_Syntax.name
         in
      let g1 =
        let uu___980_6154 = g  in
        let uu____6155 =
          FStar_TypeChecker_Env.set_current_module
            g.FStar_Extraction_ML_UEnv.env_tcenv m.FStar_Syntax_Syntax.name
           in
        {
          FStar_Extraction_ML_UEnv.env_tcenv = uu____6155;
          FStar_Extraction_ML_UEnv.env_bindings =
            (uu___980_6154.FStar_Extraction_ML_UEnv.env_bindings);
          FStar_Extraction_ML_UEnv.tydefs =
            (uu___980_6154.FStar_Extraction_ML_UEnv.tydefs);
          FStar_Extraction_ML_UEnv.type_names =
            (uu___980_6154.FStar_Extraction_ML_UEnv.type_names);
             ...
             fun se  ->
               ...
               then
                 ...
                 (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                  (let uu____6203 = FStar_Util.format1 "---Extracted {%s}" nm
                      in
                   FStar_Util.measure_execution_time uu____6203
                     (fun uu____6213  -> extract_sig g2 se)))
      ...
      | (g2,sigs) ->
          ...
          let is_kremlin =
            let uu____6235 = FStar_Options.codegen ()  in
            uu____6235 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin)
             in
          if
          ...
          then
            ((let uu____6250 =
                let uu____6252 = FStar_Options.silent ()  in
...
let (extract :
  ...
  fun g  ->
    fun m  ->
      (let uu____6330 = FStar_Options.restore_cmd_line_options true  in
       FStar_All.pipe_left (fun a2  -> ()) uu____6330);
      (let uu____6333 =
         let uu____6335 =
           FStar_Options.should_extract
             (m.FStar_Syntax_Syntax.name).FStar_Ident.str
            in
         Prims.op_Negation uu____6335  in
       if uu____6333
       then
         let uu____6338 =
           let uu____6340 =
      ...
      (let uu____6345 = FStar_Options.interactive ()  in
       if uu____6345
         ...
         (let res =
            ...
            then
              ...
              FStar_Util.measure_execution_time msg
                (fun uu____6386  -> extract' g m)
            else extract' g m  in
          (let uu____6390 = FStar_Options.restore_cmd_line_options true  in
           FStar_All.pipe_left (fun a3  -> ()) uu____6390);
          res))
