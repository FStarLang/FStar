       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1299,attrs) ->
           ...
           let elet =
             FStar_Syntax_Syntax.mk
              ...
              in
           let uu____1314 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1376 =
                                        ...
                                        uu____1381.FStar_Syntax_Syntax.fv_name
                                         in
                                        ...
                                        (let uu____1411 =
                                           let uu____1412 =
                                             ...
                                             FStar_Extraction_ML_UEnv.extend_lb
                                              ...
                                              in
                                           FStar_All.pipe_left
                                             FStar_Pervasives.fst uu____1412
                                            in
                                         (uu____1411, ml_lb))
                                       in
                            ...
                            let uu____1461 =
                              let uu____1462 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng
                                 in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1462
                               in
                            [uu____1461;
                            FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t1) ->
                     ...
                     FStar_Syntax_Util.abs bs uu____1522 None
                  in
           ...
           (match uu____1602 with
            | (ml_main,uu____1610,uu____1611) ->
                let uu____1612 =
                  ...
                  [uu____1614; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____1612))
