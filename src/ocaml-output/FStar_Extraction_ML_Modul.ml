        ...
        (fun env1  ->
           fun uu____260  ->
             ...
             | (bv,uu____274) ->
                 ...
                 let uu____281 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv
                    in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                let uu____745 =
                  let uu____746 = FStar_Syntax_Print.term_to_string d.dtyp
                     in
                  Prims.strcat " : " uu____746  in
                Prims.strcat uu____744 uu____745))
         in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1130
           in
        let steps =
      ...
      let extract_one_family env1 ind =
        ...
        | (env2,vars) ->
            ...
            (match uu____1329 with
             | (env3,ctors) ->
                 let uu____1426 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2458) when
           ...
           let uu____2474 =
             ...
             | (tcenv,uu____2507,def_typ) ->
                 let uu____2513 = as_pair def_typ  in (tcenv, uu____2513)
              in
                        ...
                        let uu____2576 =
                          let uu____2577 =
                            FStar_Extraction_ML_Syntax.string_of_mlpath
                             ...
                             in
                          FStar_Util.starts_with uu____2577 "FStar.Tactics"
                           in
             ...
             let mk_registration tac_lid assm_lid t bs =
                   ...
                   let uu____2609 =
                     let uu____2610 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2610
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2609  in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2608
                  in
               let lid_arg =
                 let uu____2612 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2636
                      in
                 ...
                 (match uu____2654 with
                  | (bs,comp) ->
                      ...
                      (match uu____2684 with
                       | FStar_Syntax_Syntax.Tm_app (h,args) ->
                           ...
                           let assm_lid =
                             ...
                             FStar_Ident.lid_of_ns_and_id
                               tac_lid.FStar_Ident.ns uu____2719
                              in
                       ...
                       | uu____2740 -> []))
             | uu____2741 -> []  in
           let uu____2744 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2858 =
                                        ...
                                        uu____2861.FStar_Syntax_Syntax.fv_name
                                         in
                              ...
                              let uu____2957 =
                                let uu____2958 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2958
                                 in
                              [uu____2957;
                              FStar_Extraction_ML_Syntax.MLM_Let
                         ...
                         FStar_Util.find_map quals
                           (fun uu___163_3133  ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l,uu____3137)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3138 -> FStar_Pervasives_Native.None)
                          in
           ...
           (match uu____3157 with
            | (ml_main,uu____3171,uu____3172) ->
                let uu____3173 =
                  ...
                  [uu____3176; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____3173))
