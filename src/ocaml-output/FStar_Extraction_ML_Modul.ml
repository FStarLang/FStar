          ...
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
           ...
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_string (s, uu____366));
              FStar_Syntax_Syntax.pos = uu____367;
              FStar_Syntax_Syntax.vars = uu____368;_},
            uu____369)::[]);
        ...
        (fun env1 ->
           fun uu____520 ->
             ...
             | (bv, uu____531) ->
                 ...
                 let uu____539 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d ->
                ...
                let uu____765 =
                  let uu____767 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.op_Hat " : " uu____767 in
                Prims.op_Hat uu____763 uu____765)) in
...
let (iface_to_string : iface -> Prims.string) =
  fun iface1 ->
    ...
    let uu____1509 =
      let uu____1511 = FStar_List.map (print_tydef cm) iface1.iface_tydefs in
      FStar_All.pipe_right uu____1511 (FStar_String.concat "\n") in
    let uu____1521 =
      let uu____1523 = FStar_List.map print_type_name iface1.iface_type_names in
    ...
    let gamma =
      FStar_List.collect
        (fun uu___2_1556 ->
           ...
           | uu____1573 -> []) env.FStar_Extraction_ML_UEnv.env_bindings in
    let uu____1578 =
        ...
        fun lb ->
          let uu____1640 =
            ...
            | (tcenv, uu____1667, def_typ) ->
                let uu____1673 = as_pair def_typ in (tcenv, uu____1673) in
          ...
          | (tcenv, (lbdef, lbtyp)) ->
              ...
              let def =
                let uu____1704 =
                  ...
                  FStar_All.pipe_right uu____1705 FStar_Syntax_Util.unmeta in
                FStar_All.pipe_right uu____1704 FStar_Syntax_Util.un_uinst in
              let def1 =
                   ...
                   (match uu____1794 with
                    | (env1, ml_bs) ->
                        ...
                        let def2 =
                          let uu____1893 =
                            let uu____1894 =
                              let uu____1895 = FStar_Ident.range_of_lid lid in
              ...
              (match uu____2036 with
               | (env1, ml_bs) ->
                   ...
                   let metadata =
                     ...
                     let uu____2071 = FStar_List.choose flag_of_qual quals in
                   ...
                   let def =
                     let uu____2110 =
                       let uu____2111 =
                         ...
                         FStar_Extraction_ML_Util.mlloc_of_range uu____2112 in
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____2194 in
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____2287 with | (env2, ctors) -> (env2, ctors)) in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____2359;_}::[],
          uu____2360),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____2379 = extract_ctor env [] env { dname = l; dtyp = t } in
        ...
        (let uu____2774 =
         ...
         | uu____2802 ->
             let uu____2803 =
               ...
               FStar_Util.format2 "(%s) Not an fv: %s" uu____2805 uu____2807 in
             failwith uu____2803) in
                   ...
                   (let uu____2926 =
                    ...
                    | (exp, tysc) ->
                        ((let uu____3029 =
                         ...
                         (let uu____3051 = extend_env g1 a_lid a_nm exp tysc in
            ...
            (fun lb ->
               let uu____3271 =
                 FStar_Extraction_ML_Term.is_arity env
                   lb.FStar_Syntax_Syntax.lbtyp in
               Prims.op_Negation uu____3271) lbs in
        if uu____3266
        then
                         ...
                         | (env2, iface1, impl) ->
                             let iface_opt1 =
                               ...
                               | FStar_Pervasives_Native.Some iface' ->
                                   let uu____3404 = iface_union iface' iface1 in
  ...
  fun g ->
    fun se ->
      ...
      | FStar_Syntax_Syntax.Sig_let (lbs, uu____3666) ->
          let uu____3671 = FStar_Extraction_ML_Term.extract_lb_iface g lbs in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          then
            ...
            (match uu____3751 with
             | (env, iface1, uu____3766) -> (env, iface1))
          else (g, empty_iface)
let (extract_iface' :
  env_t ->
                  ...
                  | (g1, iface2) ->
                      ...
                      (match uu____3831 with
                       | (g2, iface') ->
                           ...
                           (g2, uu____3842))) (g, iface1) decls in
  ...
  fun g ->
    fun iface1 ->
      ...
      let uu____3891 =
        ...
        FStar_List.append uu____3894 g.FStar_Extraction_ML_UEnv.env_bindings in
      {
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____3979 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____3979 in
        let steps =
              ...
              FStar_List.map
                (fun uu____4029 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____4039;_},
                      uu____4040) -> ppname.FStar_Ident.idText) bs
          | uu____4048 -> [] in
        let tys = (ml_tyvars, mlt) in
        let fvv = FStar_Extraction_ML_UEnv.mkFvvar ctor.dname ctor.dtyp in
        let uu____4056 =
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____4215 with
             | (env2, ctors) ->
                 let uu____4322 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i ->
                                  fun uu____4415 ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4423)) in
                          ...
                          FStar_Util.find_opt
                            (fun uu___7_4433 ->
                               ...
                               | FStar_Syntax_Syntax.RecordType uu____4435 ->
                                   true
                               | uu____4445 -> false) ind.iquals in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____4624;_}::[],
          uu____4625),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____4644 = extract_ctor env [] env { dname = l; dtyp = t } in
  ...
  fun g ->
    fun se ->
      ...
      then []
        ...
        (let uu____5045 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs, lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____5087 =
                        let uu____5088 = FStar_Ident.string_of_lid fv_lid1 in
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____5737 =
                                                ...
                                                uu____5740.FStar_Syntax_Syntax.fv_name in
                                              uu____5737.FStar_Syntax_Syntax.v in
                                            let flags'' =
                                              let uu____5744 =
                                                let uu____5745 =
                          ...
                          (match uu____5640 with
                           | (g1, ml_lbs') ->
                               let uu____5921 =
                                 ...
                                 let uu____5931 = maybe_register_plugin g1 se in
             ...
             let always_fail1 =
               ...
               let uu____5971 =
                 let uu____5972 =
                   let uu____5979 =
                     let uu____5980 =
                       let uu____5983 = always_fail lid t in [uu____5983] in
                     (false, uu____5980) in
                   (uu____5979, []) in
                         ...
                         FStar_Util.find_map quals
                           (fun uu___10_6046 ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l, uu____6050)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6051 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____6071 with
            | (ml_main, uu____6085, uu____6086) ->
                let uu____6087 =
                  ...
                  [uu____6090; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____6087))
    ...
    fun m ->
             ...
             fun se ->
               ...
               then
                 let nm =
                   ...
                   FStar_All.pipe_right uu____6192 (FStar_String.concat ", ") in
                 (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                  (let uu____6209 = FStar_Util.format1 "---Extracted {%s}" nm in
      ...
      | (g2, sigs) ->
          ...
          let is_kremlin =
            ...
            uu____6241 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin) in
          if
