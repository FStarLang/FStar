...
let assumed = (FStar_Util.for_some (fun uu___144_203 -> (match (uu___144_203) with
...
let uu____226 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___145_228 -> (match (uu___145_228) with
...
let uu____290 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___146_292 -> (match (uu___146_292) with
...
let bundle_as_inductive_families = (fun env ses quals -> (FStar_All.pipe_right ses (FStar_List.collect (fun uu___148_391 -> (match (uu___148_391) with
...
let datas = (FStar_All.pipe_right ses (FStar_List.collect (fun uu___147_417 -> (match (uu___147_417) with
...
let uu____725 = (FStar_Util.find_opt (fun uu___149_727 -> (match (uu___149_727) with
...
let uu____1109 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___150_1111 -> (match (uu___150_1111) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____1112 -> begin
...
let uu____1260 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___151_1262 -> (match (uu___151_1262) with
...
let uu___156_1274 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = (((Prims.snd mname)), ((Prims.parse_int "0"))); FStar_Extraction_ML_Syntax.mllb_tysc = uu___156_1274.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = uu___156_1274.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = uu___156_1274.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = uu___156_1274.FStar_Extraction_ML_Syntax.print_typ})))))
end
| uu____1276 -> begin
(
...
let flags = (FStar_List.choose (fun uu___152_1301 -> (match (uu___152_1301) with
| FStar_Syntax_Syntax.Assumption -> begin
...
let flags' = (FStar_List.choose (fun uu___153_1308 -> (match (uu___153_1308) with
...
let uu____1430 = (FStar_Util.find_map quals (fun uu___154_1432 -> (match (uu___154_1432) with
...
let uu____1450 = (FStar_Util.find_map quals (fun uu___155_1452 -> (match (uu___155_1452) with
...
let uu___157_1533 = g
in {FStar_Extraction_ML_UEnv.tcenv = uu___157_1533.FStar_Extraction_ML_UEnv.tcenv; FStar_Extraction_ML_UEnv.gamma = uu___157_1533.FStar_Extraction_ML_UEnv.gamma; FStar_Extraction_ML_UEnv.tydefs = uu___157_1533.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.currentModule = name})
in (
...
let uu____1551 = (FStar_Options.codegen ())
...
let uu____1555 = (((m.FStar_Syntax_Syntax.name.FStar_Ident.str <> "Prims") && (is_kremlin || (not (m.FStar_Syntax_Syntax.is_interface)))) && (FStar_Options.should_extract m.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (match (uu____1555) with
| true -> begin
((

let uu____1560 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
