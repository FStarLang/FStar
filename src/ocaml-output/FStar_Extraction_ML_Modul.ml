...
let (iface_of_bindings :
  ...
  =
  fun fvs  ->
    let uu___410_1216 = empty_iface  in
    {
      iface_module_name = (uu___410_1216.iface_module_name);
      iface_bindings = fvs;
      iface_tydefs = (uu___410_1216.iface_tydefs);
      iface_type_names = (uu___410_1216.iface_type_names)
    }
  
let (iface_of_tydefs : FStar_Extraction_ML_UEnv.tydef Prims.list -> iface) =
  fun tds  ->
    let uu___411_1226 = empty_iface  in
    {
      iface_module_name = (uu___411_1226.iface_module_name);
      iface_bindings = (uu___411_1226.iface_bindings);
      iface_tydefs = tds;
      iface_type_names = (uu___411_1226.iface_type_names)
    }
  
let (iface_of_type_names : FStar_Syntax_Syntax.fv Prims.list -> iface) =
  fun fvs  ->
    let uu___412_1236 = empty_iface  in
    {
      iface_module_name = (uu___412_1236.iface_module_name);
      iface_bindings = (uu___412_1236.iface_bindings);
      iface_tydefs = (uu___412_1236.iface_tydefs);
...
let (extract_iface :
  ...
  fun g  ->
    fun modul  ->
      let iface1 =
        let uu___413_3022 = empty_iface  in
        {
          iface_module_name = (g.FStar_Extraction_ML_UEnv.currentModule);
          iface_bindings = (uu___413_3022.iface_bindings);
          iface_tydefs = (uu___413_3022.iface_tydefs);
          iface_type_names = (uu___413_3022.iface_type_names)
        }  in
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___414_4489 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___414_4489.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___414_4489.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___414_4489.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___414_4489.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___414_4489.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___414_4489.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____4497 =
                    match post_tau with
                                           ...
                                           (let lb_lid =
                                            ...
                                            let meta =
                                              FStar_List.append flags1
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___415_4715 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___415_4715.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___415_4715.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___415_4715.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___415_4715.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___415_4715.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____4716 =
                                              let uu____4721 =
                                                FStar_All.pipe_right quals
                                                    ...
                                                    (env1,
                                                      (let uu___416_4768 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___416_4768.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___416_4768.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___416_4768.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___416_4768.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___416_4768.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____4772 =
                                                   let uu____4779 =
             ...
             let always_fail1 =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____4857  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___417_4855.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___417_4855.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___417_4855.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___417_4855.FStar_Syntax_Syntax.sigattrs)
               }  in
       ...
       let g1 =
            ...
            in
         {
           ...
           FStar_Extraction_ML_UEnv.gamma =
             (uu___418_5040.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___418_5040.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___418_5040.FStar_Extraction_ML_UEnv.type_names);
