                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1247 =
                                        ...
                                        uu____1252.FStar_Syntax_Syntax.fv_name
                                         in
                            ...
                            let uu____1332 =
                              let uu____1333 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng
                                 in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1333
                               in
                            [uu____1332;
                            FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t1) ->
                     ...
                     FStar_Syntax_Util.abs bs uu____1390 None
                  in
           ...
           (match uu____1473 with
            | (ml_main,uu____1481,uu____1482) ->
                let uu____1483 =
                  ...
                  [uu____1485; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____1483))
