...
let ml_params = (let _174_112 = (FStar_All.pipe_right indices (FStar_List.mapi (fun i _80_154 -> (let _174_111 = (let _174_110 = (FStar_Util.string_of_int i)
...
let _80_263 = (let _174_140 = (let _174_139 = (FStar_Syntax_Print.sigelt_to_string se)
...
let _80_305 = (let _174_155 = (FStar_Extraction_ML_UEnv.lookup_fv g fv)
...
in (let _174_182 = (let _174_181 = (let _174_180 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_174_180))
in (_174_181)::(FStar_Extraction_ML_Syntax.MLM_Let (((qual), ((FStar_List.rev ml_lbs')))))::[])
in ((g), (_174_182))))
end))
end
| _80_424 -> begin
(let _174_184 = (let _174_183 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" _174_183))
in (FStar_All.failwith _174_184))
end)
end)))
end
...
| (bs, t) -> begin
(let _174_185 = (fail_exp lid t)
in (FStar_Syntax_Util.abs bs _174_185 None))
end)
in (let _174_191 = (let _174_190 = (let _174_189 = (let _174_188 = (let _174_187 = (let _174_186 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in FStar_Util.Inr (_174_186))
in {FStar_Syntax_Syntax.lbname = _174_187; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (_174_188)::[])
in ((false), (_174_189)))
in ((_174_190), (r), ([]), (quals)))
in FStar_Syntax_Syntax.Sig_let (_174_191)))
in (
...
| Some (l) -> begin
(let _174_197 = (let _174_196 = (let _174_193 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_174_193))
in (let _174_195 = (let _174_194 = (FStar_Extraction_ML_Term.ind_discriminator_body g lid l)
in (_174_194)::[])
in (_174_196)::_174_195))
in ((g), (_174_197)))
end
| _80_452 -> begin
...
(let _174_201 = (let _174_200 = (let _174_199 = (FStar_Extraction_ML_Util.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_174_199))
in (_174_200)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (_174_201)))
end))
end
...
let extract_iface : FStar_Extraction_ML_UEnv.env  ->  FStar_Syntax_Syntax.modul  ->  env_t = (fun g m -> (let _174_206 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right _174_206 Prims.fst)))
...
let _80_502 = (let _174_211 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
