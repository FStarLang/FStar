  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_618 =
         ...
         let _0_617 =
           let _0_616 = FStar_Syntax_Syntax.iarg t in
           let _0_615 =
             let _0_614 =
               let _0_613 =
                 (FStar_Syntax_Syntax.mk
                          ...
                          (let _0_612 =
                             FStar_Bytes.string_as_unicode_bytes
                               (let _0_611 =
                                ...
                                Prims.strcat "Not yet implemented:" _0_611) in
                           (_0_612, FStar_Range.dummyRange))))) None
                   FStar_Range.dummyRange in
               FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_613 in
             [_0_614] in
           _0_616 :: _0_615 in
         (_0_618, _0_617)))) None FStar_Range.dummyRange
       ...
       fun uu____70  ->
         ...
         | (bv,uu____78) ->
             let _0_621 =
               ...
               FStar_Extraction_ML_UEnv.extend_ty env bv _0_619 in
             let _0_620 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
             (_0_621, _0_620)) env bs
    ...
    fun fv  ->
      fun quals  ->
        fun def  ->
          ...
          let def =
            let _0_623 =
              let _0_622 = FStar_Syntax_Subst.compress def in
              FStar_All.pipe_right _0_622 FStar_Syntax_Util.unmeta in
            FStar_All.pipe_right _0_623 FStar_Syntax_Util.un_uinst in
          let def =
          ...
          | (bs,body) ->
              ...
              (match uu____165 with
               | (env,ml_bs) ->
                   ...
                   let td =
                     let _0_626 =
                       let _0_625 = lident_as_mlsymbol lid in
                       (assumed, _0_625, mangled_projector, ml_bs,
                   ...
                   let def =
                     ...
                     [_0_627; FStar_Extraction_ML_Syntax.MLM_Ty td] in
                   let env =
                     let uu____235 =
                       FStar_All.pipe_right quals
                         (FStar_Util.for_some
...
let print_ifamily: inductive_family -> Prims.unit =
  fun i  ->
    let _0_635 = FStar_Syntax_Print.lid_to_string i.iname in
    let _0_634 = FStar_Syntax_Print.binders_to_string " " i.iparams in
    let _0_633 = FStar_Syntax_Print.term_to_string i.ityp in
    let _0_632 =
      let _0_631 =
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                let _0_630 = FStar_Syntax_Print.lid_to_string d.dname in
                let _0_629 =
                  let _0_628 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " _0_628 in
                Prims.strcat _0_630 _0_629)) in
      FStar_All.pipe_right _0_631 (FStar_String.concat "\n\t\t") in
    FStar_Util.print4 "\n\t%s %s : %s { %s }\n" _0_635 _0_634 _0_633 _0_632
  ...
  fun env  ->
    fun se  ->
      let extract_ctor ml_tyvars env ctor =
        let mlt =
          let _0_639 = FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env) _0_639 in
        let tys = (ml_tyvars, mlt) in
        let fvv = FStar_Extraction_ML_UEnv.mkFvvar ctor.dname ctor.dtyp in
        let _0_643 =
          FStar_Extraction_ML_UEnv.extend_fv env fvv tys false false in
        let _0_642 =
          let _0_641 = lident_as_mlsymbol ctor.dname in
          let _0_640 = FStar_Extraction_ML_Util.argTypes mlt in
          (_0_641, _0_640) in
        (_0_643, _0_642) in
                          ...
                          FStar_All.pipe_right indices
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____630  ->
                                    let _0_645 =
                                      let _0_644 = FStar_Util.string_of_int i in
                                      Prims.strcat "'dummyV" _0_644 in
                                    (_0_645, (Prims.parse_int "0")))) in
                        FStar_List.append vars _0_646 in
                      let tbody =
                        let uu____634 =
                          FStar_Util.find_opt
                            (fun uu___149_636  ->
                                   ...
                                   FStar_List.map2
                                     (fun id  ->
                                        fun ty  ->
                                          ...
                                          let _0_647 = lident_as_mlsymbol lid in
                                          (_0_647, ty)) ids c_ty in
                                 FStar_Extraction_ML_Syntax.MLTD_Record
                                   fields)
                        | uu____670 ->
                            FStar_Extraction_ML_Syntax.MLTD_DType ctors in
                      let _0_649 =
                        let _0_648 = lident_as_mlsymbol ind.iname in
                        (false, _0_648, None, ml_params, (Some tbody)) in
                      (env, _0_649))) in
      match se with
  ...
  fun g  ->
    fun se  ->
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let _0_650 = FStar_Syntax_Print.sigelt_to_string se in
       ...
       | FStar_Syntax_Syntax.Sig_new_effect (ed,uu____818) when
           ...
           let extend_env g lid ml_name tm tysc =
             ...
             let g =
               ...
               FStar_Extraction_ML_UEnv.extend_fv' g _0_651 ml_name tysc
                 false false in
             let lb =
               {
           ...
           let rec extract_fv tm =
             ...
             | FStar_Syntax_Syntax.Tm_fvar fv ->
                 ...
                 let uu____871 =
                   let _0_652 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                   FStar_All.pipe_left FStar_Util.right _0_652 in
               ...
               FStar_All.pipe_right quals
                 (FStar_Util.for_some
                    (fun uu___150_992  ->
                       ...
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____993 -> false)) in
             FStar_All.pipe_right _0_654 Prims.op_Negation in
           if uu____990
           then (g, [])
           else
              ...
              | (bs,uu____1011) ->
                  ...
                  let _0_655 =
                    FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit
                      None in
                  extract_typ_abbrev g fv quals _0_655)
       | FStar_Syntax_Syntax.Sig_let
           ((false ,lb::[]),uu____1029,uu____1030,quals,uu____1032) when
           FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp
           ->
           let _0_656 = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
           extract_typ_abbrev g _0_656 quals lb.FStar_Syntax_Syntax.lbdef
           ...
           then
             let always_fail =
               let imp =
                 ...
                 | ([],t) -> fail_exp lid t
                 | (bs,t) ->
                     let _0_666 = fail_exp lid t in
                     FStar_Syntax_Util.abs bs _0_666 None in
               FStar_Syntax_Syntax.Sig_let
                 (let _0_670 =
                    let _0_669 =
                      let _0_668 =
            ...
            | (ml_main,uu____1309,uu____1310) ->
                let _0_676 =
                  let _0_675 =
                    FStar_Extraction_ML_Syntax.MLM_Loc
                      (FStar_Extraction_ML_Util.mlloc_of_range r) in
                  [_0_675; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, _0_676))
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right _0_677 Prims.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
