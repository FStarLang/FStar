                                              ...
                                              (let uu___166_2784 = ml_lb  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___166_2784.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___166_2784.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___166_2784.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___166_2784.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2788 =
                                           let uu____2789 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2928  in
               {
                 ...
                 FStar_Syntax_Syntax.sigquals =
                   (uu___167_2926.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___167_2926.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___167_2926.FStar_Syntax_Syntax.sigattrs)
               }  in
        ...
        let g1 =
             ...
             in
          {
            ...
            FStar_Extraction_ML_UEnv.gamma =
              (uu___168_3170.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___168_3170.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___168_3170.FStar_Extraction_ML_UEnv.type_names);
