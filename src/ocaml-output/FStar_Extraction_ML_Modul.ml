      ...
      (match se.FStar_Syntax_Syntax.sigel with
               ...
               let h =
                 let uu____2606 =
                   let uu____2607 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2608 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2607 in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2606 in
               let lid_arg =
                 let uu____2610 =
                   let uu____2611 = FStar_Ident.string_of_lid assm_lid in
                   FStar_Extraction_ML_Syntax.MLC_String uu____2611 in
                 FStar_Extraction_ML_Syntax.MLE_Const uu____2610 in
               ...
               let arity =
                 let uu____2618 =
                   let uu____2619 =
                     ...
                     FStar_Ident.lid_of_str uu____2620 in
                   FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2619 in
                 FStar_Extraction_ML_Syntax.MLE_Name uu____2618 in
               ...
               let app =
                 let uu____2629 =
                   let uu____2630 =
                     ...
                     (h, uu____2637) in
                   FStar_Extraction_ML_Syntax.MLE_App uu____2630 in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2629 in
                ...
                | hd1::[] ->
                    ...
                    (match uu____2650 with
                     | (bs,comp) ->
                         ...
                         let uu____2680 =
                           let uu____2681 = FStar_Syntax_Subst.compress t in
                          ...
                          | FStar_Syntax_Syntax.Tm_app (h,args) ->
                              ...
                              let tac_lid =
                                let uu____2710 =
                                  ...
                                  uu____2713.FStar_Syntax_Syntax.fv_name in
                                uu____2710.FStar_Syntax_Syntax.v in
                              let assm_lid =
                                let uu____2715 =
                                ...
                                FStar_Ident.lid_of_ns_and_id
                                  tac_lid.FStar_Ident.ns uu____2715 in
                              let uu____2716 = is_tactic_decl assm_lid h1 in
                              if uu____2716
                              then
                                let uu____2719 =
                                  let uu____2720 =
                                    let uu____2721 = FStar_List.hd args in
                                    FStar_Pervasives_Native.fst uu____2721 in
                                  mk_registration tac_lid assm_lid uu____2720
                                    bs in
                                [uu____2719]
                              else []
                          | uu____2737 -> []))
                | uu____2738 -> []) in
           let uu____2741 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
           (match uu____2741 with
            | (ml_let,uu____2755,uu____2756) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,uu____2764,bindings),uu____2766) ->
                     let uu____2779 =
                       FStar_List.fold_left2
                         (fun uu____2806  ->
                            fun ml_lb  ->
                              fun uu____2808  ->
                                match (uu____2806, uu____2808) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2855 =
                                        ...
                                        uu____2858.FStar_Syntax_Syntax.fv_name in
                                      uu____2855.FStar_Syntax_Syntax.v in
                                    let uu____2859 =
                                      let uu____2864 =
                                        FStar_All.pipe_right quals
                                          (FStar_Util.for_some
                                             (fun uu___158_2869  ->
                                                match uu___158_2869 with
                                      ...
                                      then
                                        ...
                                        let uu____2882 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____2887 mname uu____2888
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____2882 with
                                        | (env1,uu____2894) ->
                                            (env1,
                                              (let uu___162_2896 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___162_2896.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___162_2896.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___162_2896.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___162_2896.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2900 =
                                           let uu____2901 =
       ...
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____2972,t) ->
           ...
           then
             let always_fail =
               let imp =
                 let uu____2988 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____3017 in
                     let uu____3018 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____3018
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____3037 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____3037
                       FStar_Pervasives_Native.None in
               let uu___163_3038 = se in
               let uu____3039 =
                 let uu____3040 =
                   let uu____3047 =
                     let uu____3054 =
                         ...
                         let uu____3058 =
                           let uu____3063 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant
                               FStar_Pervasives_Native.None in
                           FStar_Util.Inr uu____3063 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____3058;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____3054) in
                   (uu____3047, []) in
                 FStar_Syntax_Syntax.Sig_let uu____3040 in
               {
                 FStar_Syntax_Syntax.sigel = uu____3039;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___163_3038.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___163_3038.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___163_3038.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___163_3038.FStar_Syntax_Syntax.sigattrs)
               } in
             let uu____3074 = extract_sig g always_fail in
             (match uu____3074 with
              | (g1,mlm) ->
                  let uu____3093 =
                    FStar_Util.find_map quals
                      (fun uu___160_3098  ->
                         match uu___160_3098 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____3102 -> FStar_Pervasives_Native.None) in
                       ...
                       let uu____3110 =
                         let uu____3113 =
                           let uu____3114 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____3114 in
                         let uu____3115 =
                           let uu____3118 =
                       ...
                       let uu____3124 =
                         FStar_Util.find_map quals
                           (fun uu___161_3130  ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l,uu____3134)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3135 -> FStar_Pervasives_Native.None) in
                       (match uu____3124 with
                        | FStar_Pervasives_Native.Some uu____3142 -> (g1, [])
                        | uu____3145 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____3154 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____3154 with
            | (ml_main,uu____3168,uu____3169) ->
                let uu____3170 =
                  let uu____3173 =
                    let uu____3174 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____3174 in
                  [uu____3173; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3170))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____3177 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____3184 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____3193 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____3196 -> (g, [])
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____3224 FStar_Pervasives_Native.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____3269 = FStar_Options.debug_any () in
       if uu____3269
       then
         let uu____3270 =
      ...
      (let codegen_opt = FStar_Options.codegen () in
       let uu____3275 = FStar_Options.restore_cmd_line_options true in
       ...
       (let name =
        ...
        let g1 =
          let uu___164_3282 = g in
          let uu____3283 =
            FStar_TypeChecker_Env.set_current_module
              g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
          {
            FStar_Extraction_ML_UEnv.tcenv = uu____3283;
            FStar_Extraction_ML_UEnv.gamma =
              (uu___164_3282.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___164_3282.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___164_3282.FStar_Extraction_ML_UEnv.type_names);
        ...
        | (g2,sigs) ->
            ...
            let is_kremlin =
              let uu____3313 = FStar_Options.codegen () in
