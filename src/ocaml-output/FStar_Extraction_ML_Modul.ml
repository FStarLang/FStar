    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        ...
        let uu____579 =
          ...
          FStar_Pervasives_Native.fst uu____580 in
        let uu____583 =
                 ...
                 (match uu____678 with
                  | (indices,uu____699) ->
                      ...
                      let uu____776 =
                        ...
                        (false, uu____787, FStar_Pervasives_Native.None,
    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____1320,attrs) ->
           ...
           let uu____1337 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
           (match uu____1337 with
            | (ml_let,uu____1345,uu____1346) ->
                (match ml_let.FStar_Extraction_ML_Syntax.expr with
                 | FStar_Extraction_ML_Syntax.MLE_Let
                     ((flavor,uu____1351,bindings),uu____1353) ->
                     let uu____1360 =
                       FStar_List.fold_left2
                         (fun uu____1367  ->
                            fun ml_lb  ->
                              fun uu____1369  ->
                                match (uu____1367, uu____1369) with
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1399 =
                                        ...
                                        uu____1404.FStar_Syntax_Syntax.fv_name in
                                      uu____1399.FStar_Syntax_Syntax.v in
                                    let uu____1408 =
                                      let uu____1411 =
                                        FStar_All.pipe_right quals
                                          (FStar_Util.for_some
                                             (fun uu___153_1413  ->
                                                match uu___153_1413 with
                                      ...
                                      then
                                        ...
                                        let uu____1422 =
                                          ...
                                          FStar_Extraction_ML_UEnv.extend_fv'
                                            env uu____1425 mname uu____1426
                                            ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit
                                            false in
                                        match uu____1422 with
                                        | (env1,uu____1430) ->
                                            (env1,
                                              (let uu___158_1431 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___158_1431.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___158_1431.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___158_1431.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___158_1431.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1434 =
                                           let uu____1435 =
                     ...
                     (match uu____1360 with
                      | (g1,ml_lbs') ->
                          ...
                          let flags' =
                            FStar_List.choose
                              (fun uu___155_1465  ->
                                 match uu___155_1465 with
                                 | {
                                     FStar_Syntax_Syntax.n =
                                       FStar_Syntax_Syntax.Tm_constant
                                       (FStar_Const.Const_string
                                       (data,uu____1470));
                                     FStar_Syntax_Syntax.tk = uu____1471;
                                     FStar_Syntax_Syntax.pos = uu____1472;
                                     FStar_Syntax_Syntax.vars = uu____1473;_}
                                     ->
                                     FStar_Pervasives_Native.Some
                          ...
                          let uu____1482 =
                            let uu____1484 =
                              ...
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1485 in
                            [uu____1484;
                            FStar_Extraction_ML_Syntax.MLM_Let
                 ...
                 | uu____1489 ->
                     let uu____1490 =
                       ...
                       FStar_Util.format1
                         ...
                         uu____1491 in
                     failwith uu____1490))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____1496,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____1500 =
             FStar_All.pipe_right quals
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____1526 in
                     let uu____1527 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____1527
                       FStar_Pervasives_Native.None
                 | (bs,t1) ->
                     let uu____1545 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____1545
                       FStar_Pervasives_Native.None in
               let uu___159_1551 = se in
               let uu____1552 =
                 let uu____1553 =
                   let uu____1559 =
                     let uu____1563 =
                         ...
                         let uu____1566 =
                           let uu____1569 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant
                               FStar_Pervasives_Native.None in
                           FStar_Util.Inr uu____1569 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____1566;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____1563) in
                   (uu____1559, [], []) in
                 FStar_Syntax_Syntax.Sig_let uu____1553 in
               {
                 FStar_Syntax_Syntax.sigel = uu____1552;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___159_1551.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___159_1551.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___159_1551.FStar_Syntax_Syntax.sigmeta)
               } in
             let uu____1576 = extract_sig g always_fail in
             (match uu____1576 with
              | (g1,mlm) ->
                  let uu____1587 =
                    FStar_Util.find_map quals
                      (fun uu___156_1589  ->
                         match uu___156_1589 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____1592 -> FStar_Pervasives_Native.None) in
                       ...
                       let uu____1597 =
                         let uu____1599 =
                           let uu____1600 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____1600 in
                         let uu____1601 =
                           let uu____1603 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                               g1 lid l in
                           [uu____1603] in
                         uu____1599 :: uu____1601 in
                       (g1, uu____1597)
                   | uu____1605 ->
                       let uu____1607 =
                         FStar_Util.find_map quals
                           (fun uu___157_1609  ->
                              match uu___157_1609 with
                              | FStar_Syntax_Syntax.Projector (l,uu____1612)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____1613 -> FStar_Pervasives_Native.None) in
                       (match uu____1607 with
                        | FStar_Pervasives_Native.Some uu____1617 -> (g1, [])
                        | uu____1619 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____1625 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____1625 with
            | (ml_main,uu____1633,uu____1634) ->
                let uu____1635 =
                  let uu____1637 =
                    let uu____1638 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____1638 in
                  [uu____1637; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____1635))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____1640 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____1644 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____1648 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____1650 -> (g, [])
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____1668 FStar_Pervasives_Native.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1694 = FStar_Options.debug_any () in
       if uu____1694
       then
         let uu____1695 =
      ...
      (let uu____1697 = FStar_Options.restore_cmd_line_options true in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name in
       let g1 =
         let uu___160_1700 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___160_1700.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___160_1700.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___160_1700.FStar_Extraction_ML_UEnv.tydefs);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____1718 = FStar_Options.codegen () in
