...
let (iface_to_string : iface -> Prims.string) =
  fun iface1 ->
    ...
    let uu____1512 =
      let uu____1514 = FStar_List.map (print_tydef cm) iface1.iface_tydefs in
      FStar_All.pipe_right uu____1514 (FStar_String.concat "\n") in
    let uu____1524 =
      let uu____1526 = FStar_List.map print_type_name iface1.iface_type_names in
    ...
    let gamma =
      FStar_List.collect
        (fun uu___2_1559 ->
           ...
           | uu____1576 -> []) env.FStar_Extraction_ML_UEnv.env_bindings in
    let uu____1581 =
        ...
        fun lb ->
          let uu____1643 =
            ...
            | (tcenv, uu____1670, def_typ) ->
                let uu____1676 = as_pair def_typ in (tcenv, uu____1676) in
          ...
          | (tcenv, (lbdef, lbtyp)) ->
              ...
              let def =
                let uu____1707 =
                  ...
                  FStar_All.pipe_right uu____1708 FStar_Syntax_Util.unmeta in
                FStar_All.pipe_right uu____1707 FStar_Syntax_Util.un_uinst in
              let def1 =
                   ...
                   (match uu____1797 with
                    | (env1, ml_bs) ->
                        ...
                        let def2 =
                          let uu____1896 =
                            let uu____1897 =
                              let uu____1898 = FStar_Ident.range_of_lid lid in
              ...
              (match uu____2039 with
               | (env1, ml_bs) ->
                   ...
                   let metadata =
                     ...
                     let uu____2074 = FStar_List.choose flag_of_qual quals in
                   ...
                   let def =
                     let uu____2113 =
                       let uu____2114 =
                         ...
                         FStar_Extraction_ML_Util.mlloc_of_range uu____2115 in
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____2197 in
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____2290 with | (env2, ctors) -> (env2, ctors)) in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____2362;_}::[],
          uu____2363),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____2382 = extract_ctor env [] env { dname = l; dtyp = t } in
        ...
        (let uu____2777 =
         ...
         | uu____2805 ->
             let uu____2806 =
               ...
               FStar_Util.format2 "(%s) Not an fv: %s" uu____2808 uu____2810 in
             failwith uu____2806) in
                   ...
                   (let uu____2929 =
                    ...
                    | (exp, tysc) ->
                        ((let uu____3032 =
                         ...
                         (let uu____3054 = extend_env g1 a_lid a_nm exp tysc in
            ...
            (fun lb ->
               let uu____3274 =
                 FStar_Extraction_ML_Term.is_arity env
                   lb.FStar_Syntax_Syntax.lbtyp in
               Prims.op_Negation uu____3274) lbs in
        if uu____3269
        then
                         ...
                         | (env2, iface1, impl) ->
                             let iface_opt1 =
                               ...
                               | FStar_Pervasives_Native.Some iface' ->
                                   let uu____3407 = iface_union iface' iface1 in
  ...
  fun g ->
    fun se ->
          ...
          let uu____3615 =
            (FStar_All.pipe_right quals
              ...
              (let uu____3621 =
               ...
               Prims.op_Negation uu____3621) in
          if uu____3615
          then
            let uu____3628 =
              let uu____3639 =
      ...
      | FStar_Syntax_Syntax.Sig_let (lbs, uu____3669) ->
          let uu____3674 = FStar_Extraction_ML_Term.extract_lb_iface g lbs in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          then
            ...
            (match uu____3754 with
             | (env, iface1, uu____3769) -> (env, iface1))
          else (g, empty_iface)
let (extract_iface' :
  env_t ->
  ...
  fun g ->
    fun iface1 ->
      ...
      let uu____3894 =
        ...
        FStar_List.append uu____3897 g.FStar_Extraction_ML_UEnv.env_bindings in
      {
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____3982 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____3982 in
        let steps =
              ...
              FStar_List.map
                (fun uu____4032 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____4042;_},
                      uu____4043) -> ppname.FStar_Ident.idText) bs
          | uu____4051 -> [] in
        let tys = (ml_tyvars, mlt) in
        let fvv = FStar_Extraction_ML_UEnv.mkFvvar ctor.dname ctor.dtyp in
        let uu____4059 =
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____4218 with
             | (env2, ctors) ->
                 let uu____4325 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i ->
                                  fun uu____4418 ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4426)) in
                          ...
                          FStar_Util.find_opt
                            (fun uu___7_4436 ->
                               ...
                               | FStar_Syntax_Syntax.RecordType uu____4438 ->
                                   true
                               | uu____4448 -> false) ind.iquals in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____4627;_}::[],
          uu____4628),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____4647 = extract_ctor env [] env { dname = l; dtyp = t } in
  ...
  fun g ->
    fun se ->
      ...
      then []
        ...
        (let uu____5048 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs, lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____5090 =
                        let uu____5091 = FStar_Ident.string_of_lid fv_lid1 in
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____5740 =
                                                ...
                                                uu____5743.FStar_Syntax_Syntax.fv_name in
                                              uu____5740.FStar_Syntax_Syntax.v in
                                            let flags'' =
                                              let uu____5747 =
                                                let uu____5748 =
                          ...
                          (match uu____5643 with
                           | (g1, ml_lbs') ->
                               let uu____5924 =
                                 ...
                                 let uu____5934 = maybe_register_plugin g1 se in
           ...
           let uu____5957 =
             (FStar_All.pipe_right quals
               ...
               (let uu____5963 =
                  FStar_TypeChecker_Util.must_erase_for_extraction
                    g.FStar_Extraction_ML_UEnv.env_tcenv t in
                Prims.op_Negation uu____5963) in
           if uu____5957
           then
             let always_fail1 =
               ...
               let uu____5974 =
                 let uu____5975 =
                   let uu____5982 =
                     let uu____5983 =
                       let uu____5986 = always_fail lid t in [uu____5986] in
                     (false, uu____5983) in
                   (uu____5982, []) in
                  ...
                  let uu____6012 =
                    FStar_Util.find_map quals
                      (fun uu___9_6017 ->
                         ...
                         | uu____6021 -> FStar_Pervasives_Native.None) in
                         ...
                         FStar_Util.find_map quals
                           (fun uu___10_6049 ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l, uu____6053)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6054 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____6074 with
            | (ml_main, uu____6088, uu____6089) ->
                let uu____6090 =
                  ...
                  [uu____6093; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____6090))
    ...
    fun m ->
             ...
             fun se ->
               ...
               then
                 let nm =
                   ...
                   FStar_All.pipe_right uu____6195 (FStar_String.concat ", ") in
                 (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                  (let uu____6212 = FStar_Util.format1 "---Extracted {%s}" nm in
      ...
      | (g2, sigs) ->
          ...
          let is_kremlin =
            ...
            uu____6244 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin) in
          if
