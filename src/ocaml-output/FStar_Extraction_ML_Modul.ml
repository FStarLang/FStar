                        ...
                        let uu____54 =
                          let uu____55 =
                            let uu____60 =
                              ...
                              Prims.strcat "Not yet implemented:" uu____61 in
          ...
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
           ...
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_string (s, uu____131));
        ...
        (fun env1 ->
           fun uu____255 ->
             ...
             | (bv, uu____265) ->
                 ...
                 let uu____272 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
          ...
          fun def ->
            ...
            | (bs, body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___71_388 ->
                       match uu___71_388 with
                       | FStar_Syntax_Syntax.Assumption -> true
                       | uu____389 -> false) quals in
                     ...
                     let def3 =
                       let uu____529 =
                         let uu____530 =
                           ...
                           FStar_Extraction_ML_Util.mlloc_of_range uu____531 in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d ->
                ...
                let uu____719 =
                  let uu____720 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " uu____720 in
                Prims.strcat uu____718 uu____719)) in
    ...
    fun se ->
              ...
              FStar_List.map
                (fun uu____1149 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                      ...
                      uu____1157) -> ppname.FStar_Ident.idText) bs
          | uu____1160 -> [] in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____1619;_}::[],
          uu____1620),
             ...
             let mk_registration lb =
               ...
               | FStar_Pervasives_Native.Some (interp, arity, plugin) ->
                   ...
                   let h =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____1908 in
                   let arity1 =
                     let uu____1912 =
                       let uu____1913 =
           ...
           let rec extract_fv tm =
             ...
             (let uu____2086 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  ...
                  let uu____2102 =
                    let uu____2111 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                  ...
                  (match uu____2102 with
                   | (uu____2168, uu____2169, tysc, uu____2171) ->
                       ...
                       (uu____2172, tysc))
              | uu____2173 -> failwith "Not an fv") in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____2482) when
           ...
           let uu____2498 =
             ...
             | (tcenv, uu____2531, def_typ) ->
                 let uu____2537 = as_pair def_typ in (tcenv, uu____2537) in
                              ...
                              fun uu____2651 ->
                                ...
                                | ((env, ml_lbs),
                                   { FStar_Syntax_Syntax.lbname = lbname;
                                     FStar_Syntax_Syntax.lbunivs = uu____2673;
                                     FStar_Syntax_Syntax.lbtyp = t;
                                     FStar_Syntax_Syntax.lbeff = uu____2675;
                                     FStar_Syntax_Syntax.lbdef = uu____2676;
                                     FStar_Syntax_Syntax.lbattrs = uu____2677;
                                     FStar_Syntax_Syntax.lbpos = uu____2678;_})
                                    ->
                                    let uu____2703 =
                                      FStar_All.pipe_right
                                    ...
                                    then (env, ml_lbs)
                                      ...
                                      (let lb_lid =
                                       ...
                                       let ml_lb1 =
                                         let uu___80_2769 = ml_lb in
                                         {
                                           FStar_Extraction_ML_Syntax.mllb_name
                                             =
                                             (uu___80_2769.FStar_Extraction_ML_Syntax.mllb_name);
                                           FStar_Extraction_ML_Syntax.mllb_tysc
                                             =
                                             (uu___80_2769.FStar_Extraction_ML_Syntax.mllb_tysc);
                                           FStar_Extraction_ML_Syntax.mllb_add_unit
                                             =
                                             (uu___80_2769.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                           FStar_Extraction_ML_Syntax.mllb_def
                                             =
                                             (uu___80_2769.FStar_Extraction_ML_Syntax.mllb_def);
                                           FStar_Extraction_ML_Syntax.mllb_meta
                                             = meta;
                                           FStar_Extraction_ML_Syntax.print_typ
                                             =
                                             (uu___80_2769.FStar_Extraction_ML_Syntax.print_typ)
                                         } in
                                       let uu____2770 =
                                         let uu____2775 =
                                           FStar_All.pipe_right quals
                                                 ...
                                                 (let uu___81_2807 = ml_lb1 in
                                                  {
                                                    ...
                                                    FStar_Extraction_ML_Syntax.mllb_tysc
                                                      =
                                                      (uu___81_2807.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                    FStar_Extraction_ML_Syntax.mllb_add_unit
                                                      =
                                                      (uu___81_2807.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                    FStar_Extraction_ML_Syntax.mllb_def
                                                      =
                                                      (uu___81_2807.FStar_Extraction_ML_Syntax.mllb_def);
                                                    FStar_Extraction_ML_Syntax.mllb_meta
                                                      =
                                                      (uu___81_2807.FStar_Extraction_ML_Syntax.mllb_meta);
                                                    FStar_Extraction_ML_Syntax.print_typ
                                                      =
                                                      (uu___81_2807.FStar_Extraction_ML_Syntax.print_typ)
                                                  }))
                                         else
                                           (let uu____2811 =
                                              let uu____2812 =
                          ...
                          let uu____2848 =
                            let uu____2851 =
                              let uu____2854 =
                                ...
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2855 in
                              [uu____2854;
                              FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2943 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___82_2941.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___82_2941.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___82_2941.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___82_2941.FStar_Syntax_Syntax.sigattrs)
               } in
           ...
           (match uu____3059 with
            | (ml_main, uu____3073, uu____3074) ->
                let uu____3075 =
                  ...
                  [uu____3078; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3075))
       ...
       let g1 =
             ...
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
         {
           ...
           FStar_Extraction_ML_UEnv.gamma =
             (uu___83_3179.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___83_3179.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___83_3179.FStar_Extraction_ML_UEnv.type_names);
