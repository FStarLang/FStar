...
let uu____726 = (FStar_Util.find_opt (fun uu___152_728 -> (match (uu___152_728) with
...
| FStar_Syntax_Syntax.Sig_bundle (({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (l, uu____796, t, uu____798, uu____799, uu____800, uu____801); FStar_Syntax_Syntax.sigrng = uu____802})::[], (FStar_Syntax_Syntax.ExceptionConstructor)::[], uu____803) -> begin
(
...
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, uu____834) -> begin
(
...
let uu____914 = (FStar_Syntax_Print.sigelt_to_string se)
...
let uu____944 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Extraction_ML_UEnv.extend_fv' g1 uu____944 ml_name tysc false false))
in (match (uu____941) with
| (g2, mangled_name) -> begin
(

let uu____949 = mangled_name
in (match (uu____949) with
| (n1, w) -> begin
((

let uu____955 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug g2.FStar_Extraction_ML_UEnv.tcenv) (FStar_Options.Other ("ExtractionReify")))
...
let uu____967 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug g.FStar_Extraction_ML_UEnv.tcenv) (FStar_Options.Other ("ExtractionReify")))
in (match (uu____967) with
| true -> begin
(

let uu____968 = (FStar_Syntax_Print.term_to_string tm)
...
let uu____971 = (FStar_Syntax_Subst.compress tm)
in uu____971.FStar_Syntax_Syntax.n)
in (match (uu____970) with
| FStar_Syntax_Syntax.Tm_uinst (tm1, uu____977) -> begin
(extract_fv tm1)
end
...
let uu____993 = (FStar_Extraction_ML_UEnv.lookup_fv g fv)
in (FStar_All.pipe_left FStar_Util.right uu____993))
in (match (uu____988) with
| (uu____1022, uu____1023, tysc, uu____1025) -> begin
(

let uu____1026 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) (FStar_Extraction_ML_Syntax.MLE_Name (mlp)))
in ((uu____1026), (tysc)))
end)))
end
| uu____1027 -> begin
...
let uu____1043 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug g1.FStar_Extraction_ML_UEnv.tcenv) (FStar_Options.Other ("ExtractionReify")))
in (match (uu____1043) with
| true -> begin
(

let uu____1044 = (FStar_Syntax_Print.term_to_string a.FStar_Syntax_Syntax.action_typ)
in (

let uu____1045 = (FStar_Syntax_Print.term_to_string a.FStar_Syntax_Syntax.action_defn)
...
let uu____1047 = (FStar_Extraction_ML_UEnv.action_name ed a)
...
let uu____1057 = (FStar_Syntax_Syntax.new_bv (Some (a.FStar_Syntax_Syntax.action_defn.FStar_Syntax_Syntax.pos)) FStar_Syntax_Const.exp_unit)
in FStar_Util.Inl (uu____1057))
in (
...
let uu____1080 = (FStar_Extraction_ML_Term.term_as_mlexpr g1 action_lb)
in (match (uu____1080) with
| (a_let, uu____1087, ty) -> begin
(

let uu____1089 = (match (a_let.FStar_Extraction_ML_Syntax.expr) with
| FStar_Extraction_ML_Syntax.MLE_Let ((uu____1094, uu____1095, (mllb)::[]), uu____1097) -> begin
...
let uu____1116 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug g1.FStar_Extraction_ML_UEnv.tcenv) (FStar_Options.Other ("ExtractionReify")))
in (match (uu____1116) with
| true -> begin
((

let uu____1118 = (FStar_Extraction_ML_Code.string_of_mlty a_nm (Prims.snd tysc))
in (FStar_Util.print1 "Action typescheme: %s\n" uu____1118));
(FStar_List.iter (fun x -> (FStar_Util.print1 "Action type binders: %s\n" (Prims.fst x))) (Prims.fst tysc));
)
end
| uu____1124 -> begin
()
...
let uu____1128 = (FStar_Extraction_ML_UEnv.monad_op_name ed "return")
in (match (uu____1128) with
| (return_nm, return_lid) -> begin
(

let uu____1135 = (extract_fv (Prims.snd ed.FStar_Syntax_Syntax.return_repr))
...
let uu____1151 = (FStar_Extraction_ML_UEnv.monad_op_name ed "bind")
in (match (uu____1151) with
| (bind_nm, bind_lid) -> begin
(

let uu____1158 = (extract_fv (Prims.snd ed.FStar_Syntax_Syntax.bind_repr))
...
let uu____1171 = (FStar_Util.fold_map extract_action g2 ed.FStar_Syntax_Syntax.actions)
...
| FStar_Syntax_Syntax.Sig_new_effect (uu____1183) -> begin
((g), ([]))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____1186, t, quals) when (FStar_Extraction_ML_Term.is_arity g t) -> begin
(

let uu____1191 = (

let uu____1192 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___153_1194 -> (match (uu___153_1194) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____1195 -> begin
...
in (FStar_All.pipe_right uu____1192 Prims.op_Negation))
...
let uu____1201 = (FStar_Syntax_Util.arrow_formals t)
...
let uu____1225 = (FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit None)
in (extract_typ_abbrev g fv quals uu____1225)))
end))
end))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____1232, quals, uu____1234) when (FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp) -> begin
(

let uu____1245 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (extract_typ_abbrev g uu____1245 quals lb.FStar_Syntax_Syntax.lbdef))
end
| FStar_Syntax_Syntax.Sig_let (lbs, uu____1247, quals, attrs) -> begin
(
...
let uu____1267 = (FStar_Extraction_ML_Term.term_as_mlexpr g elet)
in (match (uu____1267) with
| (ml_let, uu____1275, uu____1276) -> begin
(match (ml_let.FStar_Extraction_ML_Syntax.expr) with
| FStar_Extraction_ML_Syntax.MLE_Let ((flavor, uu____1281, bindings), uu____1283) -> begin
(

let uu____1290 = (FStar_List.fold_left2 (fun uu____1297 ml_lb uu____1299 -> (match (((uu____1297), (uu____1299))) with
| ((env, ml_lbs), {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu____1312; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = uu____1314; FStar_Syntax_Syntax.lbdef = uu____1315}) -> begin
(
...
let uu____1334 = (FStar_Util.right lbname)
in uu____1334.FStar_Syntax_Syntax.fv_name)
in uu____1329.FStar_Syntax_Syntax.v)
in (

let uu____1338 = (

let uu____1341 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___154_1343 -> (match (uu___154_1343) with
| FStar_Syntax_Syntax.Projector (uu____1344) -> begin
true
end
| uu____1347 -> begin
false
...
let uu____1351 = (mangle_projector_lid lb_lid)
in (FStar_All.pipe_right uu____1351 FStar_Extraction_ML_Syntax.mlpath_of_lident))
in (

let uu____1352 = (

let uu____1355 = (FStar_Util.right lbname)
in (

let uu____1356 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_fv' env uu____1355 mname uu____1356 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false)))
in (match (uu____1352) with
| (env1, uu____1360) -> begin
((env1), ((

let uu___159_1361 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = (((Prims.snd mname)), ((Prims.parse_int "0"))); FStar_Extraction_ML_Syntax.mllb_tysc = uu___159_1361.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = uu___159_1361.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = uu___159_1361.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = uu___159_1361.FStar_Extraction_ML_Syntax.print_typ})))
end)))
end
| uu____1363 -> begin
(
...
let uu____1368 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_lb env lbname t uu____1368 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false))
in (FStar_All.pipe_left Prims.fst uu____1365))
in ((uu____1364), (ml_lb)))
end))
...
let flags = (FStar_List.choose (fun uu___155_1388 -> (match (uu___155_1388) with
| FStar_Syntax_Syntax.Assumption -> begin
...
let flags' = (FStar_List.choose (fun uu___156_1395 -> (match (uu___156_1395) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (data, uu____1400)); FStar_Syntax_Syntax.tk = uu____1401; FStar_Syntax_Syntax.pos = uu____1402; FStar_Syntax_Syntax.vars = uu____1403} -> begin
...
let uu____1415 = (FStar_Extraction_ML_Util.mlloc_of_range se.FStar_Syntax_Syntax.sigrng)
in FStar_Extraction_ML_Syntax.MLM_Loc (uu____1415))
in (uu____1414)::(FStar_Extraction_ML_Syntax.MLM_Let (((flavor), ((FStar_List.append flags flags')), ((FStar_List.rev ml_lbs')))))::[])
in ((g1), (uu____1412)))))
end))
end
| uu____1419 -> begin
...
let uu____1421 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" uu____1421))
in (failwith uu____1420))
end)
end)))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____1426, t, quals) -> begin
(

let uu____1431 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Assumption))
...
let uu____1438 = (FStar_Syntax_Util.arrow_formals t)
...
let uu____1457 = (FStar_Syntax_Syntax.gen_bv "_" None t1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder uu____1457))
in (

let uu____1458 = (fail_exp lid t1)
in (FStar_Syntax_Util.abs ((b)::[]) uu____1458 None)))
end
| (bs, t1) -> begin
(

let uu____1476 = (fail_exp lid t1)
in (FStar_Syntax_Util.abs bs uu____1476 None))
end))
in (

let uu___160_1482 = se
in (
...
let uu____1502 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in FStar_Util.Inr (uu____1502))
in {FStar_Syntax_Syntax.lbname = uu____1499; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (uu____1498)::[])
in ((false), (uu____1496)))
in ((uu____1492), ([]), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____1484))
in {FStar_Syntax_Syntax.sigel = uu____1483; FStar_Syntax_Syntax.sigrng = uu___160_1482.FStar_Syntax_Syntax.sigrng})))
in (

let uu____1510 = (extract_sig g always_fail)
in (match (uu____1510) with
| (g1, mlm) -> begin
(

let uu____1521 = (FStar_Util.find_map quals (fun uu___157_1523 -> (match (uu___157_1523) with
...
let uu____1534 = (FStar_Extraction_ML_Util.mlloc_of_range se.FStar_Syntax_Syntax.sigrng)
in FStar_Extraction_ML_Syntax.MLM_Loc (uu____1534))
in (

let uu____1535 = (

let uu____1537 = (FStar_Extraction_ML_Term.ind_discriminator_body g1 lid l)
in (uu____1537)::[])
...
let uu____1541 = (FStar_Util.find_map quals (fun uu___158_1543 -> (match (uu___158_1543) with
| FStar_Syntax_Syntax.Projector (l, uu____1546) -> begin
Some (l)
end
| uu____1547 -> begin
None
...
let uu____1559 = (FStar_Extraction_ML_Term.term_as_mlexpr g e)
in (match (uu____1559) with
| (ml_main, uu____1567, uu____1568) -> begin
(
...
in (uu____1571)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (uu____1569)))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____1574) -> begin
...
let uu____1592 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
in (FStar_All.pipe_right uu____1592 Prims.fst)))
...
let uu____1617 = (FStar_Options.restore_cmd_line_options true)
in (
...
let uu___161_1620 = g
in {FStar_Extraction_ML_UEnv.tcenv = uu___161_1620.FStar_Extraction_ML_UEnv.tcenv; FStar_Extraction_ML_UEnv.gamma = uu___161_1620.FStar_Extraction_ML_UEnv.gamma; FStar_Extraction_ML_UEnv.tydefs = uu___161_1620.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.currentModule = name})
in (

let uu____1621 = (FStar_Util.fold_map extract_sig g1 m.FStar_Syntax_Syntax.declarations)
...
let uu____1638 = (FStar_Options.codegen ())
...
let uu____1642 = (((m.FStar_Syntax_Syntax.name.FStar_Ident.str <> "Prims") && (is_kremlin || (not (m.FStar_Syntax_Syntax.is_interface)))) && (FStar_Options.should_extract m.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (match (uu____1642) with
| true -> begin
((

let uu____1647 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
