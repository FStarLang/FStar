        ...
        (fun env1  ->
           fun uu____275  ->
             ...
             | (bv,uu____289) ->
                 ...
                 let uu____296 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
          ...
          fun def  ->
            ...
            | (bs,body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___153_415  ->
                       match uu___153_415 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____416 -> false) quals in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                let uu____760 =
                  let uu____761 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " uu____761 in
                Prims.strcat uu____759 uu____760)) in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1145 in
        let steps =
      ...
      let extract_one_family env1 ind =
        ...
        | (env2,vars) ->
            ...
            (match uu____1344 with
             | (env3,ctors) ->
                 let uu____1441 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____1536  ->
                                    ...
                                    (uu____1541, (Prims.parse_int "0")))) in
                        FStar_List.append vars uu____1505 in
                      let tbody =
                        let uu____1548 =
                          FStar_Util.find_opt
                            (fun uu___156_1553  ->
                               match uu___156_1553 with
                               | FStar_Syntax_Syntax.RecordType uu____1554 ->
                                   true
                               | uu____1563 -> false) ind.iquals in
           ...
           let rec extract_fv tm =
             ...
             (let uu____2075 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  ...
                  let uu____2091 =
                    let uu____2100 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                  ...
                  (match uu____2091 with
                   | (uu____2157,uu____2158,tysc,uu____2160) ->
                       ...
                       (uu____2161, tysc))
              | uu____2162 -> failwith "Not an fv") in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2473) when
           ...
           let uu____2489 =
             ...
             | (tcenv,uu____2522,def_typ) ->
                 let uu____2528 = as_pair def_typ in (tcenv, uu____2528) in
           ...
           let tactic_registration_decl =
                   ...
                   (match uu____2586 with
                    | FStar_Syntax_Syntax.Tm_fvar fv when
                        ...
                        let uu____2591 =
                          ...
                          FStar_Util.starts_with uu____2592 "FStar.Tactics" in
             ...
             let mk_registration tac_lid assm_lid t bs =
               let h =
                 let uu____2621 =
                   let uu____2622 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2623 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2622 in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2621 in
               let lid_arg =
                 let uu____2625 =
               ...
               let app =
                 ...
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2644 in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (h,args) ->
                           ...
                           let assm_lid =
                             ...
                             FStar_Ident.lid_of_ns_and_id
                               tac_lid.FStar_Ident.ns uu____2727 in
                           ...
                           then
                             let uu____2731 =
                               ...
                               mk_registration tac_lid assm_lid uu____2732 bs in
                             [uu____2731]
                           else []
                       | uu____2749 -> []))
             | uu____2750 -> [] in
           let uu____2753 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2867 =
                                        ...
                                        uu____2870.FStar_Syntax_Syntax.fv_name in
                                              ...
                                              (let uu___162_2908 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___162_2908.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___162_2908.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___162_2908.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___162_2908.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2912 =
                                           let uu____2913 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____3052 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___163_3050.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___163_3050.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___163_3050.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___163_3050.FStar_Syntax_Syntax.sigattrs)
               } in
              ...
              | (g1,mlm) ->
                  let uu____3105 =
                    FStar_Util.find_map quals
                      (fun uu___160_3110  ->
                         match uu___160_3110 with
                         | FStar_Syntax_Syntax.Discriminator l ->
                             FStar_Pervasives_Native.Some l
                         | uu____3114 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____3166 with
            | (ml_main,uu____3180,uu____3181) ->
                let uu____3182 =
                  ...
                  [uu____3185; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3182))
       ...
       let g1 =
             ...
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
         {
           ...
           FStar_Extraction_ML_UEnv.gamma =
             (uu___164_3287.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___164_3287.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___164_3287.FStar_Extraction_ML_UEnv.type_names);
