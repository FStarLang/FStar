    ...
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          then
            ...
            (match uu____4085 with | (env,iface1,uu____4100) -> (env, iface1))
          else (g, empty_iface)
      ...
      then (g, empty_iface)
        ...
        (let uu____4131 = FStar_Options.restore_cmd_line_options true  in
         ...
         let iface1 =
           ...
           let uu____4136 = FStar_Extraction_ML_UEnv.current_module_of_uenv g
              in
           {
               ...
               let uu____4217 =
                 let uu____4219 =
                   FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name
                    in
                 FStar_Util.format1 "Extracted interface of %s" uu____4219
                  in
    ...
    fun se  ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____4314 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp  in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____4314
           in
        let steps =
              ...
              FStar_List.map
                (fun uu____4365  ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____4375;_},uu____4376)
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams,vars) ->
            ...
            (match uu____4548 with
             | (env2,ctors) ->
                 let uu____4655 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____4724  ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4732))
                           in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigopts = uu____5165;_}::[],uu____5166),(FStar_Syntax_Syntax.ExceptionConstructor
         )::[]) ->
          let uu____5187 = extract_ctor env [] env { dname = l; dtyp = t }
             in
  ...
  fun g  ->
    fun se  ->
                 ...
                 then FStar_Pervasives_Native.None
                   ...
                   (match args with
                    | ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____5524;_},uu____5525)::[]
                        ->
                        let uu____5564 =
      ...
      then []
        ...
        (let uu____5601 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs
            in
           ...
           (match uu____6020 with
            | (attrs1,post_tau) ->
                let postprocess_lb tau lb =
                  let lbdef =
                    let uu____6144 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g
                       in
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____6320 =
                                                ...
                                                uu____6323.FStar_Syntax_Syntax.fv_name
                                                 in
                                              uu____6320.FStar_Syntax_Syntax.v
                                               in
                                            let flags'' =
                                              let uu____6327 =
                                                let uu____6328 =
                               ...
                               let uu____6480 =
                                 let uu____6483 =
                                   ...
                                   FStar_Extraction_ML_Syntax.MLM_Let
                                    ...
                                    in
                                 let uu____6490 = maybe_register_plugin g1 se
                                    in
       ...
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____6509,t) ->
           ...
           let uu____6514 =
             (FStar_All.pipe_right quals
               ...
               &&
               (let uu____6520 =
                  let uu____6522 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g
                     in
             ...
             let always_fail1 =
               ...
               let uu____6532 =
                 let uu____6533 =
                   let uu____6540 =
                     let uu____6541 =
                       let uu____6544 = always_fail lid t  in [uu____6544]
                        in
                     (false, uu____6541)  in
                   (uu____6540, [])  in
      ...
      (let uu____6928 = FStar_Options.interactive ()  in
       ...
       then (g, FStar_Pervasives_Native.None)
         ...
         (let uu____6941 =
          ...
          | (g1,mllib) ->
              ((let uu____6995 = FStar_Options.restore_cmd_line_options true
                   in
