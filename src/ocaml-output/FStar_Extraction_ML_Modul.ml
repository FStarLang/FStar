...
let fail_exp = (fun lid t -> ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_564 = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (let _0_563 = (let _0_562 = (FStar_Syntax_Syntax.iarg t)
in (let _0_561 = (let _0_560 = (let _0_559 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string ((let _0_558 = (FStar_Bytes.string_as_unicode_bytes (let _0_557 = (FStar_Syntax_Print.lid_to_string lid)
in (Prims.strcat "Not yet implemented:" _0_557)))
in ((_0_558), (FStar_Range.dummyRange))))))) None FStar_Range.dummyRange)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_559))
in (_0_560)::[])
in (_0_562)::_0_561))
in ((_0_564), (_0_563))))))) None FStar_Range.dummyRange))
...
| (bv, uu____78) -> begin
(let _0_567 = (let _0_565 = Some (FStar_Extraction_ML_Syntax.MLTY_Var ((FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv)))
in (FStar_Extraction_ML_UEnv.extend_ty env bv _0_565))
in (let _0_566 = (FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv)
in ((_0_567), (_0_566))))
end)) env bs))
...
let def = (let _0_569 = (let _0_568 = (FStar_Syntax_Subst.compress def)
in (FStar_All.pipe_right _0_568 FStar_Syntax_Util.unmeta))
in (FStar_All.pipe_right _0_569 FStar_Syntax_Util.un_uinst))
in (
...
let assumed = (FStar_Util.for_some (fun uu___138_163 -> (match (uu___138_163) with
...
let body = (let _0_570 = (FStar_Extraction_ML_Term.term_as_mlty env body)
in (FStar_All.pipe_right _0_570 (FStar_Extraction_ML_Util.eraseTypeDeep (FStar_Extraction_ML_Util.udelta_unfold env))))
in (

let mangled_projector = (

let uu____185 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___139_187 -> (match (uu___139_187) with
...
let def = (let _0_571 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range (FStar_Ident.range_of_lid lid)))
in (_0_571)::(FStar_Extraction_ML_Syntax.MLM_Ty (td))::[])
in (

let env = (

let uu____235 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___140_237 -> (match (uu___140_237) with
...
let print_ifamily : inductive_family  ->  Prims.unit = (fun i -> (let _0_579 = (FStar_Syntax_Print.lid_to_string i.iname)
in (let _0_578 = (FStar_Syntax_Print.binders_to_string " " i.iparams)
in (let _0_577 = (FStar_Syntax_Print.term_to_string i.ityp)
in (let _0_576 = (let _0_575 = (FStar_All.pipe_right i.idatas (FStar_List.map (fun d -> (let _0_574 = (FStar_Syntax_Print.lid_to_string d.dname)
in (let _0_573 = (let _0_572 = (FStar_Syntax_Print.term_to_string d.dtyp)
in (Prims.strcat " : " _0_572))
in (Prims.strcat _0_574 _0_573))))))
in (FStar_All.pipe_right _0_575 (FStar_String.concat "\n\t\t")))
in (FStar_Util.print4 "\n\t%s %s : %s { %s }\n" _0_579 _0_578 _0_577 _0_576))))))


let bundle_as_inductive_families = (fun env ses quals -> (FStar_All.pipe_right ses (FStar_List.collect (fun uu___142_327 -> (match (uu___142_327) with
...
let datas = (FStar_All.pipe_right ses (FStar_List.collect (fun uu___141_353 -> (match (uu___141_353) with
...
FStar_Syntax_Syntax.NT ((let _0_580 = (FStar_Syntax_Syntax.bv_to_name b)
in ((b'), (_0_580))))
end)) bs_params bs)
in (

let t = (let _0_582 = (let _0_581 = (FStar_Syntax_Syntax.mk_Total body)
in (FStar_Syntax_Util.arrow rest _0_581))
in (FStar_All.pipe_right _0_582 (FStar_Syntax_Subst.subst subst)))
in ({dname = d; dtyp = t})::[]))
end))
end))
end
...
let mlt = (let _0_583 = (FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp)
in (FStar_Extraction_ML_Util.eraseTypeDeep (FStar_Extraction_ML_Util.udelta_unfold env) _0_583))
in (
...
in (let _0_586 = (FStar_Extraction_ML_UEnv.extend_fv env fvv tys false false)
in (let _0_585 = (let _0_584 = (FStar_Extraction_ML_Util.argTypes mlt)
in (((lident_as_mlsymbol ctor.dname)), (_0_584)))
in ((_0_586), (_0_585))))))))
in (
...
let ml_params = (let _0_589 = (FStar_All.pipe_right indices (FStar_List.mapi (fun i uu____630 -> (let _0_588 = (let _0_587 = (FStar_Util.string_of_int i)
in (Prims.strcat "\'dummyV" _0_587))
in ((_0_588), ((Prims.parse_int "0")))))))
in (FStar_List.append vars _0_589))
in (

let tbody = (

let uu____634 = (FStar_Util.find_opt (fun uu___143_636 -> (match (uu___143_636) with
...
let rec extract_sig : env_t  ->  FStar_Syntax_Syntax.sigelt  ->  (env_t * FStar_Extraction_ML_Syntax.mlmodule1 Prims.list) = (fun g se -> ((FStar_Extraction_ML_UEnv.debug g (fun u -> (let _0_590 = (FStar_Syntax_Print.sigelt_to_string se)
...
let g = (let _0_591 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Extraction_ML_UEnv.extend_fv' g _0_591 ml_name tysc false false))
in (
...
let uu____871 = (let _0_592 = (FStar_Extraction_ML_UEnv.lookup_fv g fv)
in (FStar_All.pipe_left FStar_Util.right _0_592))
in (match (uu____871) with
| (uu____892, tysc, uu____894) -> begin
(let _0_593 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) (FStar_Extraction_ML_Syntax.MLE_Name (mlp)))
in ((_0_593), (tysc)))
end)))
end
| uu____895 -> begin
...
let uu____990 = (let _0_594 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___144_992 -> (match (uu___144_992) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____993 -> begin
...
in (FStar_All.pipe_right _0_594 Prims.op_Negation))
...
in (let _0_595 = (FStar_Syntax_Util.abs bs FStar_TypeChecker_Common.t_unit None)
in (extract_typ_abbrev g fv quals _0_595)))
end))
end))
end
...
(let _0_596 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (extract_typ_abbrev g _0_596 quals lb.FStar_Syntax_Syntax.lbdef))
end
...
let uu____1136 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___145_1138 -> (match (uu___145_1138) with
...
let env = (let _0_598 = (FStar_Util.right lbname)
in (let _0_597 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_fv' env _0_598 mname _0_597 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false)))
in ((env), ((

let uu___150_1147 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = (((Prims.snd mname)), ((Prims.parse_int "0"))); FStar_Extraction_ML_Syntax.mllb_tysc = uu___150_1147.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = uu___150_1147.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = uu___150_1147.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = uu___150_1147.FStar_Extraction_ML_Syntax.print_typ})))))
end
| uu____1149 -> begin
(let _0_601 = (let _0_600 = (let _0_599 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_UEnv.extend_lb env lbname t _0_599 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false))
in (FStar_All.pipe_left Prims.fst _0_600))
in ((_0_601), (ml_lb)))
end))
...
let flags = (FStar_List.choose (fun uu___146_1169 -> (match (uu___146_1169) with
| FStar_Syntax_Syntax.Assumption -> begin
...
let flags' = (FStar_List.choose (fun uu___147_1176 -> (match (uu___147_1176) with
...
in (let _0_603 = (let _0_602 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (_0_602)::(FStar_Extraction_ML_Syntax.MLM_Let (((flavor), ((FStar_List.append flags flags')), ((FStar_List.rev ml_lbs')))))::[])
in ((g), (_0_603)))))
end))
end
| uu____1196 -> begin
(failwith (let _0_604 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule ml_let)
in (FStar_Util.format1 "Impossible: Translated a let to a non-let: %s" _0_604)))
end)
end)))
end
...
| (bs, t) -> begin
(let _0_605 = (fail_exp lid t)
in (FStar_Syntax_Util.abs bs _0_605 None))
end))
in FStar_Syntax_Syntax.Sig_let ((let _0_609 = (let _0_608 = (let _0_607 = (let _0_606 = FStar_Util.Inr ((FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None))
in {FStar_Syntax_Syntax.lbname = _0_606; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_ML_lid; FStar_Syntax_Syntax.lbdef = imp})
in (_0_607)::[])
in ((false), (_0_608)))
in ((_0_609), (r), ([]), (quals), ([])))))
in (
...
let uu____1271 = (FStar_Util.find_map quals (fun uu___148_1273 -> (match (uu___148_1273) with
...
| Some (l) -> begin
(let _0_613 = (let _0_612 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (let _0_611 = (let _0_610 = (FStar_Extraction_ML_Term.ind_discriminator_body g lid l)
in (_0_610)::[])
in (_0_612)::_0_611))
in ((g), (_0_613)))
end
...
let uu____1284 = (FStar_Util.find_map quals (fun uu___149_1286 -> (match (uu___149_1286) with
...
(let _0_615 = (let _0_614 = FStar_Extraction_ML_Syntax.MLM_Loc ((FStar_Extraction_ML_Util.mlloc_of_range r))
in (_0_614)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in ((g), (_0_615)))
end))
end
...
let extract_iface : FStar_Extraction_ML_UEnv.env  ->  FStar_Syntax_Syntax.modul  ->  env_t = (fun g m -> (let _0_616 = (FStar_Util.fold_map extract_sig g m.FStar_Syntax_Syntax.declarations)
...
let uu___151_1353 = g
in {FStar_Extraction_ML_UEnv.tcenv = uu___151_1353.FStar_Extraction_ML_UEnv.tcenv; FStar_Extraction_ML_UEnv.gamma = uu___151_1353.FStar_Extraction_ML_UEnv.gamma; FStar_Extraction_ML_UEnv.tydefs = uu___151_1353.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.currentModule = name})
in (
...
| true -> begin
((let _0_617 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
