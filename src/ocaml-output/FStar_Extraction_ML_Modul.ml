...
let (iface_of_bindings :
  ...
  =
  fun fvs ->
    let uu___222_1295 = empty_iface in
    {
      iface_module_name = (uu___222_1295.iface_module_name);
      iface_bindings = fvs;
      iface_tydefs = (uu___222_1295.iface_tydefs);
      iface_type_names = (uu___222_1295.iface_type_names)
    }
let (iface_of_tydefs : FStar_Extraction_ML_UEnv.tydef Prims.list -> iface) =
  fun tds ->
    let uu___225_1306 = empty_iface in
    let uu____1307 =
      FStar_List.map
        (fun td ->
    ...
    {
      iface_module_name = (uu___225_1306.iface_module_name);
      iface_bindings = (uu___225_1306.iface_bindings);
      iface_tydefs = tds;
...
let (iface_of_type_names :
  ...
  =
  fun fvs ->
    let uu___229_1342 = empty_iface in
    {
      iface_module_name = (uu___229_1342.iface_module_name);
      iface_bindings = (uu___229_1342.iface_bindings);
      iface_tydefs = (uu___229_1342.iface_tydefs);
        ...
        fun lb ->
          let lbtyp =
            ...
            FStar_TypeChecker_Normalize.normalize
              ...
              FStar_TypeChecker_Env.UnfoldUntil
                FStar_Syntax_Syntax.delta_constant;
              FStar_TypeChecker_Env.ForExtraction] uu____2095
    ...
    fun modul ->
      ...
      then (g, empty_iface)
        ...
        (let uu____4134 = FStar_Options.restore_cmd_line_options true in
         ...
         let iface1 =
           let uu___650_4138 = empty_iface in
           let uu____4139 = FStar_Extraction_ML_UEnv.current_module_of_uenv g in
           {
             iface_module_name = uu____4139;
             iface_bindings = (uu___650_4138.iface_bindings);
             iface_tydefs = (uu___650_4138.iface_tydefs);
             iface_type_names = (uu___650_4138.iface_type_names)
           } in
         let res =
           FStar_List.fold_left
             (fun uu____4157 ->
  ...
  fun g ->
    fun se ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
       ...
       | FStar_Syntax_Syntax.Sig_let ((uu____6010, lbs), uu____6012) when
           FStar_Util.for_some
             (fun uu___8_6024 ->
                match uu___8_6024 with
                | FStar_Syntax_Syntax.NoExtract -> true
                | uu____6027 -> false) se.FStar_Syntax_Syntax.sigquals
           ->
           let decl_of_lb lb =
             let fv = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
             let uu___897_6036 = se in
             let uu____6037 =
               let uu____6038 =
                 let uu____6045 = FStar_Syntax_Syntax.lid_of_fv fv in
                 (uu____6045, (lb.FStar_Syntax_Syntax.lbunivs),
                   (lb.FStar_Syntax_Syntax.lbtyp)) in
               FStar_Syntax_Syntax.Sig_declare_typ uu____6038 in
             {
               FStar_Syntax_Syntax.sigel = uu____6037;
               FStar_Syntax_Syntax.sigrng =
                 (uu___897_6036.FStar_Syntax_Syntax.sigrng);
               FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption
                 :: (se.FStar_Syntax_Syntax.sigquals));
               FStar_Syntax_Syntax.sigmeta =
                 (uu___897_6036.FStar_Syntax_Syntax.sigmeta);
               FStar_Syntax_Syntax.sigattrs =
                 (uu___897_6036.FStar_Syntax_Syntax.sigattrs);
               FStar_Syntax_Syntax.sigopts =
                 (uu___897_6036.FStar_Syntax_Syntax.sigopts)
             } in
           let decls = FStar_List.map decl_of_lb lbs in
           let uu____6049 = FStar_Util.fold_map extract_sig g decls in
           (match uu____6049 with
            | (g1, out) -> (g1, (FStar_List.flatten out)))
       | FStar_Syntax_Syntax.Sig_let (lbs, uu____6079) ->
           ...
           let uu____6090 =
             ...
             | FStar_Pervasives_Native.Some
                 (ats, (tau, FStar_Pervasives_Native.None)::uu____6128) ->
           ...
           (match uu____6090 with
            | (attrs1, post_tau) ->
                let postprocess_lb tau lb =
                  let lbdef =
                    let uu____6214 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                    FStar_TypeChecker_Env.postprocess uu____6214 tau
                      lb.FStar_Syntax_Syntax.lbtyp
                      lb.FStar_Syntax_Syntax.lbdef in
                  let uu___930_6215 = lb in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___930_6215.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___930_6215.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___930_6215.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___930_6215.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___930_6215.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___930_6215.FStar_Syntax_Syntax.lbpos)
                  } in
                let lbs1 =
                  let uu____6224 =
                    match post_tau with
                  ...
                  ((FStar_Pervasives_Native.fst lbs), uu____6224) in
                let uu____6242 =
                  let uu____6249 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                  ...
                  FStar_Extraction_ML_Term.term_as_mlexpr g uu____6249 in
                (match uu____6242 with
                 | (ml_let, uu____6266, uu____6267) ->
                     (match ml_let.FStar_Extraction_ML_Syntax.expr with
                      | FStar_Extraction_ML_Syntax.MLE_Let
                          ((flavor, bindings), uu____6276) ->
                          ...
                          let uu____6293 =
                            FStar_List.fold_left2
                              (fun uu____6319 ->
                                 fun ml_lb ->
                                   fun uu____6321 ->
                                     match (uu____6319, uu____6321) with
                                     | ((env, ml_lbs),
                                        {
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____6390 =
                                                ...
                                                uu____6393.FStar_Syntax_Syntax.fv_name in
                                              uu____6390.FStar_Syntax_Syntax.v in
                                            let flags'' =
                                              let uu____6397 =
                                                let uu____6398 =
                                            ...
                                            let meta =
                                              FStar_List.append flags
                                                (FStar_List.append flags'
                                                   flags'') in
                                            let ml_lb1 =
                                              let uu___978_6454 = ml_lb in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___978_6454.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___978_6454.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___978_6454.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___978_6454.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___978_6454.FStar_Extraction_ML_Syntax.print_typ)
                                              } in
                                            let uu____6455 =
                                              let uu____6460 =
                                                FStar_All.pipe_right quals
                                                    ...
                                                    (env1,
                                                      (let uu___990_6502 =
                                                         ml_lb1 in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___990_6502.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___990_6502.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___990_6502.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___990_6502.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___990_6502.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____6505 =
                                                   let uu____6513 =
                          ...
                          (match uu____6293 with
                           | (g1, ml_lbs') ->
                               let uu____6550 =
                                 ...
                                 let uu____6560 = maybe_register_plugin g1 se in
                                 FStar_List.append uu____6553 uu____6560 in
                               (g1, uu____6550))
                      | uu____6565 ->
                          let uu____6566 =
                            let uu____6568 =
                              ...
                              FStar_Extraction_ML_Code.string_of_mlexpr
                                uu____6570 ml_let in
                            FStar_Util.format1
                              "Impossible: Translated a let to a non-let: %s"
                              uu____6568 in
                          failwith uu____6566)))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____6579, t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____6584 =
             (FStar_All.pipe_right quals
                (FStar_List.contains FStar_Syntax_Syntax.Assumption))
               &&
               (let uu____6590 =
                  let uu____6592 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                  FStar_TypeChecker_Util.must_erase_for_extraction uu____6592
                    t in
                Prims.op_Negation uu____6590) in
           if uu____6584
           then
             let always_fail1 =
               let uu___1010_6601 = se in
               let uu____6602 =
                 let uu____6603 =
                   let uu____6610 =
                     let uu____6611 =
                       let uu____6614 = always_fail lid t in [uu____6614] in
                     (false, uu____6611) in
                   (uu____6610, []) in
                 FStar_Syntax_Syntax.Sig_let uu____6603 in
               {
                 FStar_Syntax_Syntax.sigel = uu____6602;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___1010_6601.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___1010_6601.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___1010_6601.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___1010_6601.FStar_Syntax_Syntax.sigattrs);
                 FStar_Syntax_Syntax.sigopts =
                   (uu___1010_6601.FStar_Syntax_Syntax.sigopts)
               } in
             let uu____6621 = extract_sig g always_fail1 in
             (match uu____6621 with
              | (g1, mlm) ->
                  let uu____6640 =
                    FStar_Util.find_map quals
                      (fun uu___10_6645 ->
                         match uu___10_6645 with
                       ...
                       let uu____6657 =
                         let uu____6660 =
                           let uu____6661 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____6661 in
                         let uu____6662 =
                           let uu____6665 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                               g1 lid l in
                           [uu____6665] in
                         uu____6660 :: uu____6662 in
                       (g1, uu____6657)
                   | uu____6668 ->
                       let uu____6671 =
                         FStar_Util.find_map quals
                           (fun uu___11_6677 ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l, uu____6681)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6682 -> FStar_Pervasives_Native.None) in
                       (match uu____6671 with
                        | FStar_Pervasives_Native.Some uu____6689 -> (g1, [])
                        | uu____6692 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_assume uu____6701 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____6710 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____6713 -> (g, [])
       | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____6728 -> (g, [])
       | FStar_Syntax_Syntax.Sig_polymonadic_subcomp uu____6741 -> (g, [])
       | FStar_Syntax_Syntax.Sig_pragma p ->
           (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
            (g, [])))
let (extract' :
  ...
  fun g ->
    fun m ->
      let uu____6779 = FStar_Options.restore_cmd_line_options true in
      let uu____6781 =
      ...
      | (name, g1) ->
          let g2 =
            let uu____6795 =
              let uu____6796 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g1 in
              FStar_TypeChecker_Env.set_current_module uu____6796
                m.FStar_Syntax_Syntax.name in
            FStar_Extraction_ML_UEnv.set_tcenv g1 uu____6795 in
              ...
              (fun g4 ->
                 fun se ->
                   let uu____6817 =
                     ...
                     FStar_Options.debug_module uu____6819 in
                   if uu____6817
                   then
                     let nm =
                       let uu____6830 =
                     ...
                     (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                      (let uu____6847 =
                       ...
                       FStar_Util.measure_execution_time uu____6847
                         (fun uu____6857 -> extract_sig g4 se)))
          ...
          (match uu____6798 with
           | (g4, sigs) ->
               ...
               let is_kremlin =
                 let uu____6879 = FStar_Options.codegen () in
                 uu____6879 =
               ...
               then
                 ((let uu____6900 =
                     let uu____6902 = FStar_Options.silent () in
...
let (extract :
  ...
  fun g ->
    fun m ->
      (let uu____6980 = FStar_Options.restore_cmd_line_options true in
       FStar_All.pipe_left (fun uu____6982 -> ()) uu____6980);
      (let uu____6984 =
         let uu____6986 =
           let uu____6988 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
           FStar_Options.should_extract uu____6988 in
      ...
      (let uu____6998 = FStar_Options.interactive () in
       if uu____6998
       then (g, FStar_Pervasives_Native.None)
         ...
         (let uu____7011 =
            FStar_Syntax_Unionfind.with_uf_enabled
              (fun uu____7027 ->
                 let uu____7028 = FStar_Options.debug_any () in
                 if uu____7028
                 then
                   let msg =
                     let uu____7039 =
                       FStar_Syntax_Print.lid_to_string
                         m.FStar_Syntax_Syntax.name in
                     FStar_Util.format1 "Extracting module %s" uu____7039 in
                   FStar_Util.measure_execution_time msg
                     (fun uu____7049 -> extract' g m)
                 else extract' g m) in
          match uu____7011 with
          | (g1, mllib) ->
              ((let uu____7065 = FStar_Options.restore_cmd_line_options true in
                FStar_All.pipe_left (fun uu____7067 -> ()) uu____7065);
               (let uu____7068 = FStar_Extraction_ML_UEnv.exit_module g1 in
                (uu____7068, mllib)))))