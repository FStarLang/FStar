    ...
    let uu____9 =
      let uu____12 =
        let uu____13 =
                    ...
                    let uu____41 =
                      let uu____42 =
                        let uu____43 =
                          ...
                          in
                          (uu____48, FStar_Range.dummyRange)
                        in
                        FStar_Const.Const_string uu____43
                      in
                      FStar_Syntax_Syntax.Tm_constant uu____42
                    in
                    FStar_Syntax_Syntax.mk uu____41
                  in
                  uu____38 FStar_Pervasives_Native.None FStar_Range.dummyRange
                in
                FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____37
              in
              [uu____36]
            in
            uu____32 :: uu____33
          ...
          (uu____28, uu____29)
        in
        FStar_Syntax_Syntax.Tm_app uu____13
      in
      FStar_Syntax_Syntax.mk uu____12
    in
...
let as_pair:
      'Auu____66. 'Auu____66 Prims.list
    ...
    | FStar_Syntax_Syntax.Tm_uinst (h', uu____98) -> (
        ...
        | FStar_Syntax_Syntax.Tm_fvar fv
          when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.tactic_lid ->
            let uu____108 =
              let uu____109 =
                FStar_Extraction_ML_Syntax.string_of_mlpath current_module1
              in
              FStar_Util.starts_with uu____109 "FStar.Tactics"
            in
...
let rec extract_meta
  ...
  fun x ->
    ...
    | { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
      ...
      ; FStar_Syntax_Syntax.vars= uu____122; _ }
      when let uu____125 =
             let uu____126 = FStar_Syntax_Syntax.lid_of_fv fv in
             FStar_Ident.string_of_lid uu____126
           in
    ...
    | { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
      ...
      when let uu____132 =
             ...
             FStar_Ident.string_of_lid uu____133
           in
    ...
    | { FStar_Syntax_Syntax.n=
      ...
      ; FStar_Syntax_Syntax.vars= uu____235; _ }
      when data = "KremlinPrivate" ->
        FStar_Pervasives_Native.Some FStar_Extraction_ML_Syntax.Private
    | { FStar_Syntax_Syntax.n=
          FStar_Syntax_Syntax.Tm_constant
            FStar_Const.Const_string (data, uu____239)
      ; FStar_Syntax_Syntax.pos= uu____240
      ; FStar_Syntax_Syntax.vars= uu____241; _ }
      when data = "c_inline" ->
        FStar_Pervasives_Native.Some FStar_Extraction_ML_Syntax.CInline
    | { FStar_Syntax_Syntax.n=
          FStar_Syntax_Syntax.Tm_constant
...
let binders_as_mlty_binders:
      'Auu____273. FStar_Extraction_ML_UEnv.env
  ...
  fun env bs ->
    FStar_Util.fold_map
      (fun env1 uu____311 ->
        match uu____311 with bv, uu____321 ->
          let uu____322 =
            let uu____323 =
              let uu____326 =
                let uu____327 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
                FStar_Extraction_ML_Syntax.MLTY_Var uu____327
              in
              FStar_Pervasives_Native.Some uu____326
            in
            FStar_Extraction_ML_UEnv.extend_ty env1 bv uu____323
          in
...
let extract_typ_abbrev
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.fv
      ...
      -> ( FStar_Extraction_ML_UEnv.env
         ...
         FStar_Pervasives_Native.tuple2 =
  fun env fv quals attrs def ->
    let lid = fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v in
    let def1 =
      let uu____360 =
        let uu____361 = FStar_Syntax_Subst.compress def in
        FStar_All.pipe_right uu____361 FStar_Syntax_Util.unmeta
      in
      FStar_All.pipe_right uu____360 FStar_Syntax_Util.un_uinst
    in
    let def2 =
    ...
    match uu____381 with bs, body ->
      ...
      match uu____436 with env1, ml_bs ->
        let body1 =
          let uu____456 = FStar_Extraction_ML_Term.term_as_mlty env1 body in
        ...
        let mangled_projector =
          let uu____460 =
            FStar_All.pipe_right quals
              (FStar_Util.for_some (fun uu___71_465 ->
                   match uu___71_465 with
                   | FStar_Syntax_Syntax.Projector uu____466 -> true
                   | uu____471 -> false ))
          in
          if uu____460 then
        ...
        let def3 =
          let uu____575 =
            ...
            in
            FStar_Extraction_ML_Syntax.MLM_Loc uu____576
          in
          [uu____575; FStar_Extraction_ML_Syntax.MLM_Ty td]
        in
        let env2 =
          let uu____578 =
            FStar_All.pipe_right quals
              (FStar_Util.for_some (fun uu___72_582 ->
                   match uu___72_582 with
                   | FStar_Syntax_Syntax.Assumption -> true
                   | FStar_Syntax_Syntax.New -> true
                   | uu____583 -> false ))
          in
          if uu____578 then FStar_Extraction_ML_UEnv.extend_type_name env1 fv
...
let __proj__Mkdata_constructor__item__dname
  ...
  fun projectee ->
    match projectee with {dname= __fname__dname; dtyp= __fname__dtyp; _} ->
      __fname__dname
...
let __proj__Mkinductive_family__item__iname
  ...
  fun projectee ->
    match projectee
    with
    | { iname= __fname__iname
      ; iparams= __fname__iparams
      ; ityp= __fname__ityp
      ; idatas= __fname__idatas
      ; iquals= __fname__iquals
      ; imetadata= __fname__imetadata; _ }
    -> __fname__iname
...
let bundle_as_inductive_families:
      'Auu____747. FStar_Extraction_ML_UEnv.env
      -> FStar_Syntax_Syntax.sigelt Prims.list -> 'Auu____747
      -> FStar_Syntax_Syntax.attribute Prims.list
      -> ( FStar_Extraction_ML_UEnv.env
         , inductive_family Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun env ses quals attrs ->
    let uu____778 =
      FStar_Util.fold_map
        (fun env1 se ->
          ...
          | FStar_Syntax_Syntax.Sig_inductive_typ (l, _us, bs, t, _mut_i, datas)
            -> (
              ...
              match uu____825 with bs1, t1 ->
                let datas1 =
                  FStar_All.pipe_right ses
                    (FStar_List.collect (fun se1 ->
                         ...
                         | FStar_Syntax_Syntax.Sig_datacon
                           ...
                           -> (
                             ...
                             in
                             match uu____873 with bs', body ->
                               let uu____906 =
                                 FStar_Util.first_N (FStar_List.length bs1) bs'
                               in
                               match uu____906 with bs_params, rest ->
                                 let subst1 =
                                   FStar_List.map2
                                     (fun uu____977 uu____978 ->
                                       match (uu____977, uu____978)
                                       with
                                       | (b', uu____996), (b, uu____998)
                                       ->
                                         let uu____1007 =
                                           let uu____1014 =
                                           ...
                                           (b', uu____1014)
                                         in
                                         FStar_Syntax_Syntax.NT uu____1007 )
                                     bs_params bs1
                                 in
                                 let t3 =
                                   let uu____1016 =
                                     let uu____1019 =
                                       FStar_Syntax_Syntax.mk_Total body
                                     in
                                     FStar_Syntax_Util.arrow rest uu____1019
                                   in
                ...
                let metadata =
                  extract_metadata
                    (FStar_List.append se.FStar_Syntax_Syntax.sigattrs attrs)
                in
                let env2 =
                  let uu____1029 =
                  ...
                  in
                  FStar_Extraction_ML_UEnv.extend_type_name env1 uu____1029
                in
                ( env2
                , [ { iname= l
                    ; iparams= bs1
        ...
        env ses
    in
    match uu____778 with env1, ifams -> (env1, FStar_List.flatten ifams)
...
let extract_bundle
  ...
  fun env se ->
    let extract_ctor ml_tyvars env1 ctor =
      let mlt =
        let uu____1108 =
          FStar_Extraction_ML_Term.term_as_mlty env1 ctor.dtyp
        in
        FStar_Extraction_ML_Util.eraseTypeDeep
          (FStar_Extraction_ML_Util.udelta_unfold env1)
          uu____1108
      ...
      let names1 =
        let uu____1115 =
          let uu____1116 =
            ...
            in
            FStar_Syntax_Subst.compress uu____1119
          in
          uu____1116.FStar_Syntax_Syntax.n
        in
            ...
            FStar_List.map
              (fun uu____1149 ->
                ...
                | ( { FStar_Syntax_Syntax.ppname
                    ...
                    ; FStar_Syntax_Syntax.sort= uu____1156; _ }
                  , uu____1157 )
      ...
      let uu____1171 =
        let uu____1172 =
          FStar_Extraction_ML_UEnv.extend_fv env1 fvv tys false false
        in
        FStar_Pervasives_Native.fst uu____1172
      in
      let uu____1177 =
        let uu____1188 = lident_as_mlsymbol ctor.dname in
        let uu____1189 =
          let uu____1196 = FStar_Extraction_ML_Util.argTypes mlt in
          FStar_List.zip names1 uu____1196
        in
        (uu____1188, uu____1189)
      in
      (uu____1171, uu____1177)
    in
    let extract_one_family env1 ind =
      let uu____1244 = binders_as_mlty_binders env1 ind.iparams in
      match uu____1244 with env2, vars ->
        let uu____1279 =
          FStar_All.pipe_right ind.idatas
            (FStar_Util.fold_map (extract_ctor vars) env2)
        in
        match uu____1279 with env3, ctors ->
          let uu____1372 = FStar_Syntax_Util.arrow_formals ind.ityp in
          match uu____1372 with indices, uu____1408 ->
            let ml_params =
              let uu____1428 =
                FStar_All.pipe_right indices
                  (FStar_List.mapi (fun i uu____1447 ->
                       let uu____1452 = FStar_Util.string_of_int i in
                       Prims.strcat "'dummyV" uu____1452 ))
              in
              FStar_List.append vars uu____1428
            in
            let tbody =
              let uu____1454 =
                FStar_Util.find_opt
                  (fun uu___73_1459 ->
                    ...
                    | FStar_Syntax_Syntax.RecordType uu____1460 -> true
                    | uu____1469 -> false )
                  ind.iquals
              in
              ...
              | FStar_Pervasives_Native.Some
                ...
                -> (
                  ...
                  match uu____1480 with uu____1501, c_ty ->
                    let fields =
                      FStar_List.map2
                        (fun id1 uu____1540 ->
                          match uu____1540 with uu____1549, ty ->
                            let lid =
                              FStar_Ident.lid_of_ids
                                (FStar_List.append ns [id1])
                            in
                            let uu____1552 = lident_as_mlsymbol lid in
                            (uu____1552, ty) )
                        ids c_ty
                    in
                    FStar_Extraction_ML_Syntax.MLTD_Record fields )
              | uu____1553 -> FStar_Extraction_ML_Syntax.MLTD_DType ctors
            in
            let uu____1556 =
            ...
            (env3, uu____1556)
    in
    match (se.FStar_Syntax_Syntax.sigel, se.FStar_Syntax_Syntax.sigquals) with
    | ( FStar_Syntax_Syntax.Sig_bundle
          ( [ { FStar_Syntax_Syntax.sigel=
              ...
              ; FStar_Syntax_Syntax.sigattrs= uu____1617; _ } ]
          , uu____1618 )
      , [FStar_Syntax_Syntax.ExceptionConstructor] )
      -> (
        let uu____1635 = extract_ctor [] env {dname= l; dtyp= t} in
        match uu____1635 with env1, ctor ->
    ...
    | FStar_Syntax_Syntax.Sig_bundle (ses, uu____1681), quals -> (
        ...
        in
        match uu____1695 with env1, ifams ->
          let uu____1716 = FStar_Util.fold_map extract_one_family env1 ifams in
          match uu____1716 with env2, td ->
...
let rec extract_sig
  ...
  fun g se ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____1860 -> extract_bundle g se
    ...
    | FStar_Syntax_Syntax.Sig_new_effect ed
      ...
      -> (
        let extend_env g1 lid ml_name tm tysc =
          let uu____1915 =
            ...
            FStar_Extraction_ML_UEnv.extend_fv' g1 uu____1920 ml_name tysc
              false false
          in
          match uu____1915 with g2, mangled_name ->
            (let uu____1928 =
               FStar_All.pipe_left
                 (FStar_TypeChecker_Env.debug g2.FStar_Extraction_ML_UEnv.tcenv)
        ...
        let rec extract_fv tm =
          ...
          | FStar_Syntax_Syntax.Tm_uinst (tm1, uu____1954) -> extract_fv tm1
          | FStar_Syntax_Syntax.Tm_fvar fv -> (
              let mlp =
              ...
              let uu____1961 =
                ...
                FStar_All.pipe_left FStar_Util.right uu____1970
              in
              match uu____1961
              with uu____2027, uu____2028, tysc, uu____2030 ->
                let uu____2031 =
                  FStar_All.pipe_left
        ...
        let extract_action g1 a =
          ...
          match uu____2062 with a_nm, a_lid ->
            let lbname =
              let uu____2078 =
            ...
            in
            let uu____2104 =
              FStar_Extraction_ML_Term.term_as_mlexpr g1 action_lb
            in
            match uu____2104 with a_let, uu____2116, ty ->
              (let uu____2119 =
                 FStar_All.pipe_left
              ...
              in
              match uu____2122 with exp, tysc ->
                (let uu____2163 =
                   FStar_All.pipe_left
                     (FStar_TypeChecker_Env.debug
                        g1.FStar_Extraction_ML_UEnv.tcenv)
                 ...
                 if uu____2163 then (
                   ...
                   FStar_List.iter
                     (fun x -> FStar_Util.print1 "and binders: %s\n" x)
        ...
        let uu____2169 =
          ...
          in
          match uu____2174 with return_tm, ty_sc ->
            let uu____2187 =
              FStar_Extraction_ML_UEnv.monad_op_name ed "return"
            in
            match uu____2187 with return_nm, return_lid ->
              extend_env g return_lid return_nm return_tm ty_sc
        in
        match uu____2169 with g1, return_decl ->
          let uu____2206 =
            let uu____2211 =
              extract_fv
                (FStar_Pervasives_Native.snd ed.FStar_Syntax_Syntax.bind_repr)
            in
            match uu____2211 with bind_tm, ty_sc ->
              let uu____2224 =
                FStar_Extraction_ML_UEnv.monad_op_name ed "bind"
              in
              match uu____2224 with bind_nm, bind_lid ->
                extend_env g1 bind_lid bind_nm bind_tm ty_sc
          in
          match uu____2206 with g2, bind_decl ->
            let uu____2243 =
              FStar_Util.fold_map extract_action g2
                ed.FStar_Syntax_Syntax.actions
            in
            match uu____2243 with g3, actions ->
              (g3, FStar_List.append [return_decl; bind_decl] actions) )
    | FStar_Syntax_Syntax.Sig_new_effect uu____2264 -> (g, [])
    | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____2268, t)
      ...
      -> (
        ...
        let uu____2276 =
          let uu____2277 =
            FStar_All.pipe_right quals
              (FStar_Util.for_some (fun uu___74_2281 ->
                   match uu___74_2281 with
                   | FStar_Syntax_Syntax.Assumption -> true
                   | uu____2282 -> false ))
          in
          Prims.op_Negation uu____2277
        in
        if uu____2276 then (g, [])
        else
          let uu____2292 = FStar_Syntax_Util.arrow_formals t in
          match uu____2292 with bs, uu____2312 ->
            let fv =
              FStar_Syntax_Syntax.lid_as_fv lid
                FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None
            in
    ...
    | FStar_Syntax_Syntax.Sig_let ((false, [lb]), uu____2332)
      when FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp
      -> (
        let quals = se.FStar_Syntax_Syntax.sigquals in
        let uu____2348 =
          let uu____2357 =
            FStar_TypeChecker_Env.open_universes_in
              g.FStar_Extraction_ML_UEnv.tcenv lb.FStar_Syntax_Syntax.lbunivs
              [lb.FStar_Syntax_Syntax.lbdef; lb.FStar_Syntax_Syntax.lbtyp]
          in
          match uu____2357 with tcenv, uu____2381, def_typ ->
            let uu____2387 = as_pair def_typ in
            (tcenv, uu____2387)
        in
        match uu____2348 with tcenv, (lbdef, lbtyp) ->
          let lbtyp1 =
          ...
          in
          let lbdef1 =
            FStar_TypeChecker_Normalize.eta_expand_with_type tcenv lbdef lbtyp1
          in
          let uu____2411 = FStar_Util.right lb.FStar_Syntax_Syntax.lbname in
          extract_typ_abbrev g uu____2411 quals se.FStar_Syntax_Syntax.sigattrs
            lbdef1 )
    | FStar_Syntax_Syntax.Sig_let (lbs, uu____2413) -> (
        ...
        let elet =
          FStar_Syntax_Syntax.mk
            (FStar_Syntax_Syntax.Tm_let (lbs, FStar_Syntax_Util.exp_false_bool))
        ...
        let tactic_registration_decl =
          let mk_registration tac_lid assm_lid t bs =
            let h =
              let uu____2460 =
                ...
                in
                FStar_Extraction_ML_Syntax.MLE_Name uu____2461
              in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top)
            ...
            let lid_arg =
              let uu____2464 =
                ...
                FStar_Extraction_ML_Syntax.MLC_String uu____2465
              in
              FStar_Extraction_ML_Syntax.MLE_Const uu____2464
            in
            ...
            let arity =
              let uu____2472 =
                let uu____2473 =
                  let uu____2474 =
                    FStar_Util.string_of_int (tac_arity + Prims.parse_int "1")
                  in
                  FStar_Ident.lid_of_str uu____2474
                in
                FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2473
              in
              FStar_Extraction_ML_Syntax.MLE_Name uu____2472
            in
            let uu____2481 =
                ...
                let app =
                  let uu____2488 =
                    let uu____2489 =
                      ...
                      (h, uu____2496)
                    in
                    FStar_Extraction_ML_Syntax.MLE_App uu____2489
                  in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.MLTY_Top)
          ...
          let uu____2501 =
            ...
            uu____2502 = FStar_Pervasives_Native.Some "tactics"
          in
          if uu____2501 then
                  ...
                  | FStar_Syntax_Syntax.Tm_app (h, args) ->
                      let tac_lid =
                        let uu____2573 =
                          ...
                          in
                          uu____2576.FStar_Syntax_Syntax.fv_name
                        in
                        uu____2573.FStar_Syntax_Syntax.v
                      in
                      let assm_lid =
                        let uu____2578 =
                      ...
                      if uu____2579 then
                        let uu____2583 =
                          ...
                          FStar_Pervasives_Native.fst uu____2584
                        in
        ...
        match uu____2605 with ml_let, uu____2619, uu____2620 ->
          match ml_let.FStar_Extraction_ML_Syntax.expr with
          | FStar_Extraction_ML_Syntax.MLE_Let ((flavor, bindings), uu____2629)
            -> (
              let flags1 =
                FStar_List.choose
                  (fun uu___75_2644 ->
                    match uu___75_2644 with
              ...
              let uu____2651 =
                FStar_List.fold_left2
                  (fun uu____2682 ml_lb uu____2684 ->
                    match (uu____2682, uu____2684)
                    with
                    | ( (env, ml_lbs)
                      , { FStar_Syntax_Syntax.lbname
                        ; FStar_Syntax_Syntax.lbunivs= uu____2706
                        ; FStar_Syntax_Syntax.lbtyp= t
                        ; FStar_Syntax_Syntax.lbeff= uu____2708
                        ; FStar_Syntax_Syntax.lbdef= uu____2709
                        ; FStar_Syntax_Syntax.lbattrs= uu____2710; _ } )
                    ->
                      let lb_lid =
                        let uu____2736 =
                          let uu____2739 = FStar_Util.right lbname in
                          uu____2739.FStar_Syntax_Syntax.fv_name
                        in
                        uu____2736.FStar_Syntax_Syntax.v
                      in
                      let flags'' =
                        let uu____2743 =
                          let uu____2744 = FStar_Syntax_Subst.compress t in
                          uu____2744.FStar_Syntax_Syntax.n
                        in
                        ...
                        | FStar_Syntax_Syntax.Tm_arrow
                            ...
                            , { FStar_Syntax_Syntax.n=
                                  FStar_Syntax_Syntax.Comp
                                    { FStar_Syntax_Syntax.comp_univs= uu____2750
                                    ; FStar_Syntax_Syntax.effect_name= e
                                    ; FStar_Syntax_Syntax.result_typ=
                                        uu____2752
                                    ; FStar_Syntax_Syntax.effect_args=
                                        uu____2753
                                    ; FStar_Syntax_Syntax.flags= uu____2754; _
                                    }
                              ; FStar_Syntax_Syntax.pos= uu____2755
                              ; FStar_Syntax_Syntax.vars= uu____2756; _ } )
                          when let uu____2785 = FStar_Ident.string_of_lid e in
                               uu____2785 = "FStar.HyperStack.ST.StackInline" ->
                      ...
                      let ml_lb1 =
                        ...
                        { FStar_Extraction_ML_Syntax.mllb_name=
                            uu___79_2791.FStar_Extraction_ML_Syntax.mllb_name
                        ; FStar_Extraction_ML_Syntax.mllb_tysc=
                            uu___79_2791.FStar_Extraction_ML_Syntax.mllb_tysc
                        ; FStar_Extraction_ML_Syntax.mllb_add_unit=
                            uu___79_2791
                              .FStar_Extraction_ML_Syntax.mllb_add_unit
                        ; FStar_Extraction_ML_Syntax.mllb_def=
                            uu___79_2791.FStar_Extraction_ML_Syntax.mllb_def
                      ...
                      let uu____2792 =
                        let uu____2797 =
                          FStar_All.pipe_right quals
                            (FStar_Util.for_some (fun uu___76_2802 ->
                                 match uu___76_2802 with
                                 | FStar_Syntax_Syntax.Projector uu____2803 ->
                                     true
                                 | uu____2808 -> false ))
                        in
                        if uu____2797 then
                          let mname =
                            let uu____2814 = mangle_projector_lid lb_lid in
                            FStar_All.pipe_right uu____2814
                              FStar_Extraction_ML_Syntax.mlpath_of_lident
                          in
                          let uu____2815 =
                            let uu____2820 = FStar_Util.right lbname in
                            let uu____2821 =
                              FStar_Util.must
                                ml_lb1.FStar_Extraction_ML_Syntax.mllb_tysc
                            in
                            FStar_Extraction_ML_UEnv.extend_fv' env uu____2820
                              mname uu____2821
                              ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                              false
                          in
                          match uu____2815 with env1, uu____2827 ->
                            ( env1
                            , let uu___80_2829 = ml_lb1 in
                              { FStar_Extraction_ML_Syntax.mllb_name=
                                  FStar_Pervasives_Native.snd mname
                              ; FStar_Extraction_ML_Syntax.mllb_tysc=
                                  uu___80_2829
                                    .FStar_Extraction_ML_Syntax.mllb_tysc
                              ; FStar_Extraction_ML_Syntax.mllb_add_unit=
                            ...
                            let uu____2834 =
                              let uu____2839 =
                                FStar_Util.must
                                  ml_lb1.FStar_Extraction_ML_Syntax.mllb_tysc
                              in
                              FStar_Extraction_ML_UEnv.extend_lb env lbname t
                                uu____2839
                                ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                false
                            in
                          ...
                          (uu____2833, ml_lb1)
                      in
                      match uu____2792 with g1, ml_lb2 -> (g1, ml_lb2 :: ml_lbs)
                    )
                  (g, []) bindings
                  (FStar_Pervasives_Native.snd lbs)
              in
              match uu____2651 with g1, ml_lbs' ->
                let uu____2870 =
                  let uu____2873 =
                    let uu____2876 =
                      let uu____2877 =
                  ...
                  in
                  FStar_List.append uu____2873 tactic_registration_decl
                in
                (g1, uu____2870) )
          | uu____2882 ->
              let uu____2883 =
                ...
                in
                FStar_Util.format1
                  "Impossible: Translated a let to a non-let: %s" uu____2884
              in
              failwith uu____2883 )
    | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____2892, t) ->
        ...
        if uu____2897 then
          let always_fail =
            ...
            let uu____2959 =
              let uu____2960 =
                ...
                (uu____2967, [])
              in
              FStar_Syntax_Syntax.Sig_let uu____2960
            in
            { FStar_Syntax_Syntax.sigel= uu____2959
            ; FStar_Syntax_Syntax.sigrng=
                uu___81_2958.FStar_Syntax_Syntax.sigrng
            ; FStar_Syntax_Syntax.sigquals=
                uu___81_2958.FStar_Syntax_Syntax.sigquals
          ...
          match uu____2996 with g1, mlm ->
            let uu____3015 =
              FStar_Util.find_map quals (fun uu___77_3020 ->
                  ...
                  let uu____3035 =
                    let uu____3036 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng
                    in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____3036
                  in
                  let uu____3037 =
                    let uu____3040 =
                      FStar_Extraction_ML_Term.ind_discriminator_body g1 lid l
                    in
                    [uu____3040]
                  in
                  uu____3035 :: uu____3037
                in
                (g1, uu____3032)
            | uu____3043 ->
                let uu____3046 =
                  FStar_Util.find_map quals (fun uu___78_3052 ->
    ...
    | FStar_Syntax_Syntax.Sig_main e -> (
        ...
        match uu____3076 with ml_main, uu____3090, uu____3091 ->
          let uu____3092 =
            let uu____3095 =
              let uu____3096 =
                FStar_Extraction_ML_Util.mlloc_of_range
                  se.FStar_Syntax_Syntax.sigrng
              in
              FStar_Extraction_ML_Syntax.MLM_Loc uu____3096
            in
    ...
    | FStar_Syntax_Syntax.Sig_assume uu____3106 -> (g, [])
...
let extract'
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.modul
      -> ( FStar_Extraction_ML_UEnv.env
  ...
  fun g m ->
    ...
    | uu____3197 -> () ) ;
    let name =
      FStar_Extraction_ML_Syntax.mlpath_of_lident m.FStar_Syntax_Syntax.name
    in
    let g1 =
      ...
      ; FStar_Extraction_ML_UEnv.gamma=
          uu___82_3202.FStar_Extraction_ML_UEnv.gamma
      ; FStar_Extraction_ML_UEnv.tydefs=
          uu___82_3202.FStar_Extraction_ML_UEnv.tydefs
    ...
    match uu____3204 with g2, sigs ->
      ...
      let uu____3239 =
        ...
        && (is_kremlin || Prims.op_Negation m.FStar_Syntax_Syntax.is_interface)
        )
      ...
      if uu____3239 then (
        ...
        , [ FStar_Extraction_ML_Syntax.MLLib
              [ ( name
                , FStar_Pervasives_Native.Some ([], mlm)
                , FStar_Extraction_ML_Syntax.MLLib [] ) ] ] ) )
      else (g2, [])
...
let extract
  ...
  fun g m ->
    ...
    if uu____3321 then
      ...
      in
      FStar_Util.measure_execution_time msg (fun uu____3337 -> extract' g m)
    else extract' g m
