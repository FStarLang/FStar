        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d  ->
                ...
                let uu____373 =
                  let uu____374 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " uu____374 in
                Prims.strcat uu____372 uu____373)) in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____564 in
        let steps =
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____779  ->
                                    ...
                                    (uu____782, (Prims.parse_int "0")))) in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle (ses,uu____917),quals) ->
          ...
          let uu____928 = FStar_Util.fold_map extract_one_family env ifams in
           ...
           let rec extract_fv tm =
             ...
             (let uu____1071 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  ...
                  let uu____1089 =
                    let uu____1094 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                  ...
                  (match uu____1089 with
                   | (uu____1123,uu____1124,tysc,uu____1126) ->
                       ...
                       (uu____1127, tysc))
              | uu____1128 -> failwith "Not an fv") in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____1331,uu____1332)
           ...
           let uu____1343 =
             ...
             | (tcenv,uu____1364,def_typ) ->
                 let uu____1368 = as_pair def_typ in (tcenv, uu____1368) in
                   ...
                   (match uu____1415 with
                    | FStar_Syntax_Syntax.Tm_fvar fv when
                        ...
                        let uu____1420 =
                          ...
                          FStar_Util.starts_with uu____1421 "FStar.Tactics" in
               ...
               let h =
                 let uu____1448 =
                   let uu____1449 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____1450 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____1449 in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____1448 in
               let lid_arg =
                 let uu____1452 =
                       ...
                       | FStar_Syntax_Syntax.Tm_app (h,args) ->
                           ...
                           let assm_lid =
                             ...
                             FStar_Ident.lid_of_ns_and_id
                               tac_lid.FStar_Ident.ns uu____1529 in
                           ...
                           then
                             let uu____1532 =
                               let uu____1533 =
                                 ...
                                 fst uu____1536 in
                               mk_registration tac_lid assm_lid uu____1533 bs in
                             [uu____1532]
                           else []
                       | uu____1548 -> []))
             | uu____1549 -> [] in
           let uu____1551 = FStar_Extraction_ML_Term.term_as_mlexpr g elet in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____1613 =
                                        ...
                                        uu____1618.FStar_Syntax_Syntax.fv_name in
                                        ...
                                        (let uu____1648 =
                                           let uu____1649 =
                                             ...
                                             FStar_Extraction_ML_UEnv.extend_lb
                                               ...
                                               false in
                                           FStar_All.pipe_left
                                             FStar_Pervasives.fst uu____1649 in
                                         (uu____1648, ml_lb)) in
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t1) ->
                     ...
                     FStar_Syntax_Util.abs bs uu____1756 None in
           ...
           (match uu____1831 with
            | (ml_main,uu____1839,uu____1840) ->
                let uu____1841 =
                  ...
                  [uu____1843; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____1841))
