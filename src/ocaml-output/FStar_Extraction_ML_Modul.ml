          ...
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
           ...
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_string (s, uu____368));
        ...
        (fun env1 ->
           fun uu____523 ->
             ...
             | (bv, uu____534) ->
                 ...
                 let uu____542 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d ->
                ...
                let uu____768 =
                  let uu____770 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.op_Hat " : " uu____770 in
                Prims.op_Hat uu____766 uu____768)) in
                      ...
                      | (bs1, t1) ->
                          ...
                          let fv =
                            FStar_Syntax_Syntax.lid_as_fv l
                              ...
                              FStar_Pervasives_Native.None in
                          let env2 =
                            FStar_Extraction_ML_UEnv.extend_type_name env1 fv in
                          (env2,
                            [{
                               ifv = fv;
                               iname = l;
...
let (iface_to_string : iface -> Prims.string) =
  fun iface1 ->
    ...
    let uu____1503 =
      let uu____1505 = FStar_List.map (print_tydef cm) iface1.iface_tydefs in
      FStar_All.pipe_right uu____1505 (FStar_String.concat "\n") in
    let uu____1515 =
      let uu____1517 = FStar_List.map print_type_name iface1.iface_type_names in
    ...
    let gamma =
      FStar_List.collect
        (fun uu___2_1550 ->
           ...
           | uu____1567 -> []) env.FStar_Extraction_ML_UEnv.env_bindings in
    let uu____1572 =
        ...
        fun lb ->
          let uu____1634 =
            ...
            | (tcenv, uu____1661, def_typ) ->
                let uu____1667 = as_pair def_typ in (tcenv, uu____1667) in
          ...
          | (tcenv, (lbdef, lbtyp)) ->
              ...
              let def =
                let uu____1698 =
                  ...
                  FStar_All.pipe_right uu____1699 FStar_Syntax_Util.unmeta in
                FStar_All.pipe_right uu____1698 FStar_Syntax_Util.un_uinst in
              let def1 =
                   ...
                   (match uu____1788 with
                    | (env1, ml_bs) ->
                        ...
                        let def2 =
                          let uu____1887 =
                            let uu____1888 =
                              let uu____1889 = FStar_Ident.range_of_lid lid in
              ...
              (match uu____2030 with
               | (env1, ml_bs) ->
                   ...
                   let metadata =
                     ...
                     let uu____2065 = FStar_List.choose flag_of_qual quals in
                   ...
                   let def =
                     let uu____2104 =
                       let uu____2105 =
                         ...
                         FStar_Extraction_ML_Util.mlloc_of_range uu____2106 in
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____2188 in
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____2281 with | (env2, ctors) -> (env2, ctors)) in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigopts = uu____2354;_}::[],
          uu____2355),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____2376 = extract_ctor env [] env { dname = l; dtyp = t } in
        ...
        (let uu____2780 =
         ...
         | uu____2808 ->
             let uu____2809 =
               ...
               FStar_Util.format2 "(%s) Not an fv: %s" uu____2811 uu____2813 in
             failwith uu____2809) in
                   ...
                   (let uu____2932 =
                    ...
                    | (exp, tysc) ->
                        ((let uu____3035 =
                         ...
                         (let uu____3057 = extend_env g1 a_lid a_nm exp tysc in
          ...
          let uu____3197 =
            let uu____3204 =
              let uu____3209 =
                ...
                FStar_All.pipe_right uu____3212 FStar_Pervasives_Native.snd in
            ...
            (fun lb ->
               let uu____3415 =
                 FStar_Extraction_ML_Term.is_arity env
                   lb.FStar_Syntax_Syntax.lbtyp in
               Prims.op_Negation uu____3415) lbs in
        if uu____3410
        then
                         ...
                         | (env2, iface1, impl) ->
                             let iface_opt1 =
                               ...
                               | FStar_Pervasives_Native.Some iface' ->
                                   let uu____3548 = iface_union iface' iface1 in
                                   FStar_Pervasives_Native.Some uu____3548 in
  ...
  fun g ->
    fun se ->
          ...
          let uu____3756 =
            (FStar_All.pipe_right quals
              ...
              (let uu____3762 =
               ...
               Prims.op_Negation uu____3762) in
          if uu____3756
          then
            let uu____3769 =
              let uu____3780 =
      ...
      | FStar_Syntax_Syntax.Sig_let (lbs, uu____3810) ->
          let uu____3815 = FStar_Extraction_ML_Term.extract_lb_iface g lbs in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          then
            ...
            (match uu____3894 with
             | (env, iface1, uu____3909) -> (env, iface1))
          else (g, empty_iface)
let (extract_iface' :
  env_t ->
                  ...
                  | (g1, iface2) ->
                      ...
                      (match uu____3974 with
                       | (g2, iface') ->
                           ...
                           (g2, uu____3985))) (g, iface1) decls in
    ...
    fun iface1 ->
      let mlident_map =
        FStar_List.fold_left
          ...
          g.FStar_Extraction_ML_UEnv.env_mlident_map iface1.iface_bindings in
      let uu___634_4064 = g in
      let uu____4065 =
        let uu____4068 =
          FStar_List.map (fun _4075 -> FStar_Extraction_ML_UEnv.Fv _4075)
            iface1.iface_bindings in
        FStar_List.append uu____4068 g.FStar_Extraction_ML_UEnv.env_bindings in
      {
    ...
    fun se ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____4153 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____4153 in
        let steps =
              ...
              FStar_List.map
                (fun uu____4203 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____4213;_},
                      uu____4214) -> ppname.FStar_Ident.idText) bs
          | uu____4222 -> [] in
        let tys = (ml_tyvars, mlt) in
        let fvv = FStar_Extraction_ML_UEnv.mkFvvar ctor.dname ctor.dtyp in
        let uu____4230 =
      ...
      let extract_one_family env1 ind =
        ...
        | (env_iparams, vars) ->
            ...
            (match uu____4389 with
             | (env2, ctors) ->
                 let uu____4496 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i ->
                                  fun uu____4589 ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4597)) in
                          ...
                          FStar_Util.find_opt
                            (fun uu___7_4607 ->
                               ...
                               | FStar_Syntax_Syntax.RecordType uu____4609 ->
                                   true
                               | uu____4619 -> false) ind.iquals in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigopts = uu____4799;_}::[],
          uu____4800),
         (FStar_Syntax_Syntax.ExceptionConstructor)::[]) ->
          let uu____4821 = extract_ctor env [] env { dname = l; dtyp = t } in
  ...
  fun g ->
    fun se ->
                 ...
                 then FStar_Pervasives_Native.None
                   ...
                   (match args with
                    | ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____5158;_},
                       uu____5159)::[] ->
                        let uu____5198 =
      ...
      then []
        ...
        (let uu____5235 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs, lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____5277 =
                        let uu____5278 = FStar_Ident.string_of_lid fv_lid1 in
                             ...
                             let arity1 =
                               let uu____5354 =
                                 let uu____5355 =
                                   ...
                                   (uu____5367, FStar_Pervasives_Native.None) in
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____5927 =
                                                ...
                                                uu____5930.FStar_Syntax_Syntax.fv_name in
                                              uu____5927.FStar_Syntax_Syntax.v in
                                            let flags'' =
                                              let uu____5934 =
                                                let uu____5935 =
                          ...
                          (match uu____5830 with
                           | (g1, ml_lbs') ->
                               let uu____6111 =
                                 ...
                                 let uu____6121 = maybe_register_plugin g1 se in
           ...
           let uu____6144 =
             (FStar_All.pipe_right quals
               ...
               (let uu____6150 =
                  FStar_TypeChecker_Util.must_erase_for_extraction
                    g.FStar_Extraction_ML_UEnv.env_tcenv t in
                Prims.op_Negation uu____6150) in
           if uu____6144
           then
             let always_fail1 =
               ...
               let uu____6161 =
                 let uu____6162 =
                   let uu____6169 =
                     let uu____6170 =
                       let uu____6173 = always_fail lid t in [uu____6173] in
                     (false, uu____6170) in
                   (uu____6169, []) in
                  ...
                  let uu____6199 =
                    FStar_Util.find_map quals
                      (fun uu___9_6204 ->
                         ...
                         | uu____6208 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____6261 with
            | (ml_main, uu____6275, uu____6276) ->
                let uu____6277 =
                  ...
                  [uu____6280; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____6277))
    ...
    fun m ->
             ...
             fun se ->
               ...
               then
                 ...
                 (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                  (let uu____6391 = FStar_Util.format1 "---Extracted {%s}" nm in
      ...
      | (g2, sigs) ->
          ...
          let is_kremlin =
            ...
            uu____6423 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin) in
          if
