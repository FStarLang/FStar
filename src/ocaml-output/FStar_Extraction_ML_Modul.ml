      ...
      let extract_ctor ml_tyvars env1 ctor =
        ...
        let uu____628 =
          ...
          let uu____635 =
            ...
            FStar_List.zip names1 uu____639 in
                                              ...
                                              (let uu___159_1514 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___159_1514.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___159_1514.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___159_1514.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___159_1514.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1517 =
                                           let uu____1518 =
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____1636 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___160_1634.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___160_1634.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___160_1634.FStar_Syntax_Syntax.sigmeta)
               } in
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1780 = FStar_Options.restore_cmd_line_options true in
       ...
       let g1 =
         let uu___161_1783 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___161_1783.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___161_1783.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___161_1783.FStar_Extraction_ML_UEnv.tydefs);
