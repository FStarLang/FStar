                          ...
                          (let _0_629 =
                             FStar_Bytes.string_as_unicode_bytes
                               (let _0_628 =
                                ...
                                Prims.strcat "Not yet implemented:" _0_628)
                              in
  ...
  fun env  ->
    fun se  ->
      let extract_ctor ml_tyvars env ctor =
        let mlt =
          let _0_656 = FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp
             in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env) _0_656
           in
                          ...
                          FStar_All.pipe_right indices
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____630  ->
                                    let _0_662 =
                                      let _0_661 = FStar_Util.string_of_int i
                                         in
                                      Prims.strcat "'dummyV" _0_661  in
                                    (_0_662, (Prims.parse_int "0"))))
                           in
                                        ...
                                        fun ty  ->
                                          let lid =
                                            FStar_Ident.lid_of_ids
                                             ...
                                             in
                                          let _0_664 = lident_as_mlsymbol lid
                                             in
                                          (_0_664, ty)) ids c_ty
                                    in
             ...
             let always_fail =
               let imp =
                 ...
                 | (bs,t) ->
                     ...
                     FStar_Syntax_Util.abs bs _0_683 None
                  in
               FStar_Syntax_Syntax.Sig_let
                 (let _0_687 =
                    let _0_686 =
