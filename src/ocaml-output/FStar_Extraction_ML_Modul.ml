    ...
    fun se  ->
      ...
      (match se.FStar_Syntax_Syntax.sigel with
                                              ...
                                              (let uu___159_1516 = ml_lb in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___159_1516.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___159_1516.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___159_1516.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___159_1516.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____1519 =
                                           let uu____1520 =
                                             ...
                                             FStar_Extraction_ML_UEnv.extend_lb
                                               ...
                                               false in
                                           FStar_All.pipe_left
                                             FStar_Pervasives.fst uu____1520 in
                                         (uu____1519, ml_lb)) in
                          ...
                          let flags =
                            FStar_List.choose
                              (fun uu___155_1543  ->
                                 ...
                                 | uu____1545 -> None) quals in
                          let flags' =
                            FStar_List.choose
                              (fun uu___156_1550  ->
                                 match uu___156_1550 with
                                 | {
                          ...
                          let uu____1567 =
                            let uu____1569 =
                              let uu____1570 =
                                FStar_Extraction_ML_Util.mlloc_of_range
                                  se.FStar_Syntax_Syntax.sigrng in
                              FStar_Extraction_ML_Syntax.MLM_Loc uu____1570 in
                            [uu____1569;
                            FStar_Extraction_ML_Syntax.MLM_Let
                 ...
                 | uu____1574 ->
                     let uu____1575 =
                       ...
                       FStar_Util.format1
                         ...
                         uu____1576 in
                     failwith uu____1575))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____1581,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals in
           let uu____1585 =
             FStar_All.pipe_right quals
           ...
           then
             let always_fail =
               let imp =
                 let uu____1592 = FStar_Syntax_Util.arrow_formals t in
                 ...
                 | ([],t1) ->
                     let b =
                       ...
                       FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder
                         uu____1611 in
                     let uu____1612 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs [b] uu____1612 None
                 | (bs,t1) ->
                     let uu____1630 = fail_exp lid t1 in
                     FStar_Syntax_Util.abs bs uu____1630 None in
               let uu___160_1636 = se in
               let uu____1637 =
                 let uu____1638 =
                   let uu____1644 =
                     let uu____1648 =
                       let uu____1650 =
                         let uu____1651 =
                           let uu____1654 =
                             FStar_Syntax_Syntax.lid_as_fv lid
                               FStar_Syntax_Syntax.Delta_constant None in
                           FStar_Util.Inr uu____1654 in
                         {
                           FStar_Syntax_Syntax.lbname = uu____1651;
                           FStar_Syntax_Syntax.lbunivs = [];
                     ...
                     (false, uu____1648) in
                   (uu____1644, [], []) in
                 FStar_Syntax_Syntax.Sig_let uu____1638 in
               {
                 FStar_Syntax_Syntax.sigel = uu____1637;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___160_1636.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___160_1636.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___160_1636.FStar_Syntax_Syntax.sigmeta)
               } in
             let uu____1661 = extract_sig g always_fail in
             (match uu____1661 with
              | (g1,mlm) ->
                  let uu____1672 =
                    FStar_Util.find_map quals
                      (fun uu___157_1674  ->
                         match uu___157_1674 with
                       ...
                       let uu____1682 =
                         let uu____1684 =
                           let uu____1685 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____1685 in
                         let uu____1686 =
                           let uu____1688 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                               g1 lid l in
                           [uu____1688] in
                         uu____1684 :: uu____1686 in
                       (g1, uu____1682)
                   | uu____1690 ->
                       let uu____1692 =
                         FStar_Util.find_map quals
                           (fun uu___158_1694  ->
                              match uu___158_1694 with
                              | FStar_Syntax_Syntax.Projector (l,uu____1697)
                                  -> Some l
                              | uu____1698 -> None) in
       ...
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____1710 = FStar_Extraction_ML_Term.term_as_mlexpr g e in
           (match uu____1710 with
            | (ml_main,uu____1718,uu____1719) ->
                let uu____1720 =
                  let uu____1722 =
                    let uu____1723 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                  ...
                  [uu____1722; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____1720))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____1725 ->
           failwith "impossible -- removed by tc.fs"
       | FStar_Syntax_Syntax.Sig_assume uu____1729 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____1733 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____1735 -> (g, [])
...
let extract_iface:
  ...
  fun g  ->
    fun m  ->
      ...
      FStar_All.pipe_right uu____1753 FStar_Pervasives.fst
let extract:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun m  ->
      ...
      (let uu____1779 = FStar_Options.debug_any () in
       if uu____1779
       then
         let uu____1780 =
      ...
      (let uu____1782 = FStar_Options.restore_cmd_line_options true in
       let name =
         FStar_Extraction_ML_Syntax.mlpath_of_lident
           m.FStar_Syntax_Syntax.name in
       let g1 =
         let uu___161_1785 = g in
         {
           FStar_Extraction_ML_UEnv.tcenv =
             (uu___161_1785.FStar_Extraction_ML_UEnv.tcenv);
           FStar_Extraction_ML_UEnv.gamma =
             (uu___161_1785.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___161_1785.FStar_Extraction_ML_UEnv.tydefs);
       ...
       | (g2,sigs) ->
           ...
           let is_kremlin =
             let uu____1803 = FStar_Options.codegen () in
