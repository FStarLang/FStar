                          ...
                          (let _0_493 =
                             FStar_Bytes.string_as_unicode_bytes
                               (let _0_492 =
                                ...
                                Prims.strcat "Not yet implemented:" _0_492) in
  ...
  fun env  ->
    fun se  ->
      let extract_ctor ml_tyvars env ctor =
        let mlt =
          let _0_520 = FStar_Extraction_ML_Term.term_as_mlty env ctor.dtyp in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env) _0_520 in
                                   ...
                                   FStar_List.map2
                                     (fun id  ->
                                        fun ty  ->
                                          ...
                                          let _0_528 = lident_as_mlsymbol lid in
                                          (_0_528, ty)) ids c_ty in
                ...
                let always_fail =
                  let imp =
                    ...
                    | (bs,t) ->
                        ...
                        FStar_Syntax_Util.abs bs _0_547 None in
                  FStar_Syntax_Syntax.Sig_let
                    (let _0_551 =
                       let _0_550 =
                         let _0_549 =
