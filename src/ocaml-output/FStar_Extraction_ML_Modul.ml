                     ...
                     let def3 =
                       let uu____491 =
                         let uu____492 =
                           ...
                           FStar_Extraction_ML_Util.mlloc_of_range uu____493 in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d ->
                ...
                let uu____655 =
                  let uu____656 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " uu____656 in
                Prims.strcat uu____654 uu____655)) in
    ...
    fun se ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1025 in
        let steps =
              ...
              FStar_List.map
                (fun uu____1066 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____1073;_},
                      uu____1074) -> ppname.FStar_Ident.idText) bs
          | uu____1077 -> [] in
      ...
      let extract_one_family env1 ind =
        ...
        | (env2, vars) ->
            ...
            (match uu____1196 with
             | (env3, ctors) ->
                 let uu____1289 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i ->
                                  fun uu____1364 ->
                                    ...
                                    Prims.strcat "'dummyV" uu____1369)) in
                          ...
                          FStar_Util.find_opt
                            (fun uu___71_1376 ->
                               ...
                               | FStar_Syntax_Syntax.RecordType uu____1377 ->
                                   true
                               | uu____1386 -> false) ind.iquals in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____1534;_}::[],
          uu____1535),
        ...
        (let uu____1755 = FStar_Options.codegen () in
         uu____1755 <> (FStar_Pervasives_Native.Some FStar_Options.Plugin))
          ...
          (let uu____1761 =
           ...
           Prims.op_Negation uu____1761) in
      if uu____1752
      then []
      else
        (match se.FStar_Syntax_Syntax.sigel with
             ...
             let mk_registration lb =
               ...
               | FStar_Pervasives_Native.Some (interp, arity, plugin1) ->
                   ...
                   let h =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____1815 in
                   let arity1 =
                     let uu____1819 =
                       let uu____1820 =
           ...
           let rec extract_fv tm =
             ...
             (let uu____1977 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  ...
                  let uu____1993 =
                    let uu____2002 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                  ...
                  (match uu____1993 with
                   | (uu____2059, uu____2060, tysc, uu____2062) ->
                       ...
                       (uu____2063, tysc))
              | uu____2064 -> failwith "Not an fv") in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____2377) when
           ...
           let uu____2393 =
             ...
             | (tcenv, uu____2426, def_typ) ->
                 let uu____2432 = as_pair def_typ in (tcenv, uu____2432) in
                              ...
                              fun uu____2552 ->
                                ...
                                | ((env, ml_lbs),
                                   { FStar_Syntax_Syntax.lbname = lbname;
                                     ...
                                     FStar_Syntax_Syntax.lbdef = uu____2577;
                                     FStar_Syntax_Syntax.lbattrs = uu____2578;
                                     FStar_Syntax_Syntax.lbpos = uu____2579;_})
                                    ->
                                    let lb_lid =
                                      let uu____2605 =
                                        let uu____2608 =
                                          FStar_Util.right lbname in
                                        uu____2608.FStar_Syntax_Syntax.fv_name in
                         ...
                         FStar_Util.find_map quals
                           (fun uu___76_2924 ->
                              ...
                              | FStar_Syntax_Syntax.Projector (l, uu____2928)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____2929 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____2948 with
            | (ml_main, uu____2962, uu____2963) ->
                let uu____2964 =
                  ...
                  [uu____2967; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____2964))
