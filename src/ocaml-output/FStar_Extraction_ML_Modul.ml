                        ...
                        let uu____90 =
                          let uu____91 =
                            let uu____96 =
                              ...
                              Prims.strcat "Not yet implemented:" uu____97 in
          ...
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
           ...
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_string (s, uu____219));
              FStar_Syntax_Syntax.pos = uu____220;
              FStar_Syntax_Syntax.vars = uu____221;_},
            uu____222)::[]);
        ...
        (fun env1 ->
           fun uu____353 ->
             ...
             | (bv, uu____363) ->
                 ...
                 let uu____370 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv in
          ...
          fun def ->
            ...
            | (bs, body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___395_496 ->
                       match uu___395_496 with
                       | FStar_Syntax_Syntax.Assumption -> true
                       | uu____497 -> false) quals in
                ...
                (match uu____498 with
                 | (env1, ml_bs) ->
                     ...
                     let metadata =
                       ...
                       let uu____546 = FStar_List.choose flag_of_qual quals in
                     ...
                     let def3 =
                       let uu____561 =
                         let uu____562 =
                           ...
                           FStar_Extraction_ML_Util.mlloc_of_range uu____563 in
        ...
        FStar_All.pipe_right i.idatas
          (FStar_List.map
             (fun d ->
                ...
                let uu____751 =
                  let uu____752 = FStar_Syntax_Print.term_to_string d.dtyp in
                  Prims.strcat " : " uu____752 in
                Prims.strcat uu____750 uu____751)) in
    ...
    fun se ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1191 in
        let steps =
              ...
              FStar_List.map
                (fun uu____1238 ->
                   ...
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        ...
                        FStar_Syntax_Syntax.sort = uu____1247;_},
                      uu____1248) -> ppname.FStar_Ident.idText) bs
          | uu____1255 -> [] in
      ...
      let extract_one_family env1 ind =
        ...
        | (env2, vars) ->
            ...
            (match uu____1376 with
             | (env3, ctors) ->
                 let uu____1469 = FStar_Syntax_Util.arrow_formals ind.ityp in
                            ...
                            (FStar_List.mapi
                               (fun i ->
                                  fun uu____1554 ->
                                    ...
                                    Prims.strcat "'dummyV" uu____1561)) in
                        FStar_List.append vars uu____1531 in
                      let tbody =
                        let uu____1563 =
                          FStar_Util.find_opt
                            (fun uu___398_1568 ->
                               match uu___398_1568 with
                               | FStar_Syntax_Syntax.RecordType uu____1569 ->
                                   true
                               | uu____1578 -> false) ind.iquals in
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____1724;_}::[],
          uu____1725),
  ...
  fun g ->
    fun se ->
                 ...
                 then FStar_Pervasives_Native.None
                   ...
                   (match args with
                    | ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____2031;_},
                       uu____2032)::[] ->
                        let uu____2069 =
      ...
      then []
        ...
        (let uu____2097 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs, lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____2135 =
                        let uu____2136 = FStar_Ident.string_of_lid fv_lid1 in
                             ...
                             let arity1 =
                               let uu____2193 =
                                 let uu____2194 =
                                   ...
                                   (uu____2205, FStar_Pervasives_Native.None) in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv ->
                  let mlp =
                    FStar_Extraction_ML_Syntax.mlpath_of_lident
                      (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                  let uu____2383 =
                    let uu____2392 = FStar_Extraction_ML_UEnv.lookup_fv g fv in
                  ...
                  (match uu____2383 with
                   | (uu____2449, uu____2450, tysc, uu____2452) ->
                       ...
                       (uu____2453, tysc))
              | uu____2454 -> failwith "Not an fv") in
       ...
       | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____2805) when
           ...
           let uu____2815 =
             ...
             | (tcenv, uu____2842, def_typ) ->
                 let uu____2848 = as_pair def_typ in (tcenv, uu____2848) in
                              ...
                              fun uu____2963 ->
                                ...
                                | ((env, ml_lbs),
                                   { FStar_Syntax_Syntax.lbname = lbname;
                                     ...
                                     FStar_Syntax_Syntax.lbdef = uu____2988;
                                     FStar_Syntax_Syntax.lbattrs = uu____2989;
                                     FStar_Syntax_Syntax.lbpos = uu____2990;_})
                                    ->
                                    let uu____3015 =
                                      FStar_All.pipe_right
                                    ...
                                    then (env, ml_lbs)
                                      ...
                                      (let lb_lid =
                                         let uu____3028 =
                                           ...
                                           uu____3031.FStar_Syntax_Syntax.fv_name in
                                       ...
                                       let ml_lb1 =
                                         let uu___403_3089 = ml_lb in
                                         {
                                           FStar_Extraction_ML_Syntax.mllb_name
                                             =
                                             (uu___403_3089.FStar_Extraction_ML_Syntax.mllb_name);
                                           FStar_Extraction_ML_Syntax.mllb_tysc
                                             =
                                             (uu___403_3089.FStar_Extraction_ML_Syntax.mllb_tysc);
                                           FStar_Extraction_ML_Syntax.mllb_add_unit
                                             =
                                             (uu___403_3089.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                           FStar_Extraction_ML_Syntax.mllb_def
                                             =
                                             (uu___403_3089.FStar_Extraction_ML_Syntax.mllb_def);
                                           FStar_Extraction_ML_Syntax.mllb_meta
                                             = meta;
                                           FStar_Extraction_ML_Syntax.print_typ
                                             =
                                             (uu___403_3089.FStar_Extraction_ML_Syntax.print_typ)
                                         } in
                                       let uu____3090 =
                                         let uu____3095 =
                                           FStar_All.pipe_right quals
                                                 ...
                                                 (let uu___404_3139 = ml_lb1 in
                                                  {
                                                    ...
                                                    FStar_Extraction_ML_Syntax.mllb_tysc
                                                      =
                                                      (uu___404_3139.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                    FStar_Extraction_ML_Syntax.mllb_add_unit
                                                      =
                                                      (uu___404_3139.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                    FStar_Extraction_ML_Syntax.mllb_def
                                                      =
                                                      (uu___404_3139.FStar_Extraction_ML_Syntax.mllb_def);
                                                    FStar_Extraction_ML_Syntax.mllb_meta
                                                      =
                                                      (uu___404_3139.FStar_Extraction_ML_Syntax.mllb_meta);
                                                    FStar_Extraction_ML_Syntax.print_typ
                                                      =
                                                      (uu___404_3139.FStar_Extraction_ML_Syntax.print_typ)
                                                  }))
                                         else
                                           (let uu____3143 =
                                              let uu____3144 =
                          ...
                          let uu____3180 =
                            let uu____3183 =
                              let uu____3186 =
                                ...
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____3187 in
                              [uu____3186;
                              FStar_Extraction_ML_Syntax.MLM_Let
           ...
           let uu____3210 =
             (FStar_All.pipe_right quals
               ...
               (let uu____3214 =
                ...
                Prims.op_Negation uu____3214) in
           if uu____3210
           then
             let always_fail =
               let imp =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____3317 in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___405_3315.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___405_3315.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___405_3315.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___405_3315.FStar_Syntax_Syntax.sigattrs)
               } in
                  ...
                  (match uu____3360 with
                   ...
                   | uu____3388 ->
                       let uu____3391 =
                         FStar_Util.find_map quals
                           (fun uu___402_3397 ->
                              match uu___402_3397 with
                              | FStar_Syntax_Syntax.Projector (l, uu____3401)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____3402 -> FStar_Pervasives_Native.None) in
           ...
           (match uu____3421 with
            | (ml_main, uu____3435, uu____3436) ->
                let uu____3437 =
                  ...
                  [uu____3440; FStar_Extraction_ML_Syntax.MLM_Top ml_main] in
                (g, uu____3437))
       ...
       let g1 =
             ...
             g.FStar_Extraction_ML_UEnv.tcenv m.FStar_Syntax_Syntax.name in
         {
           ...
           FStar_Extraction_ML_UEnv.gamma =
             (uu___406_3541.FStar_Extraction_ML_UEnv.gamma);
           FStar_Extraction_ML_UEnv.tydefs =
             (uu___406_3541.FStar_Extraction_ML_UEnv.tydefs);
           FStar_Extraction_ML_UEnv.type_names =
             (uu___406_3541.FStar_Extraction_ML_UEnv.type_names);
