      ...
      then (g, empty_iface)
        ...
        (let uu____3997 = FStar_Options.restore_cmd_line_options true  in
         ...
         (let uu____4044 = FStar_Options.restore_cmd_line_options true  in
          FStar_All.pipe_left (fun a1  -> ()) uu____4044);
         res)
...
let (extract_iface :
  ...
  fun g  ->
    fun modul  ->
      let uu____4061 = FStar_Options.debug_any ()  in
      if uu____4061
      then
        let uu____4068 =
          FStar_Util.format1 "Extracted interface of %s"
           ...
           in
        FStar_Util.measure_execution_time uu____4068
          (fun uu____4076  -> extract_iface' g modul)
    ...
    fun iface1  ->
      let mlident_map =
        FStar_List.fold_left
         ...
         in
      let uu___644_4121 = g  in
      let uu____4122 =
        let uu____4125 =
          FStar_List.map (fun _4132  -> FStar_Extraction_ML_UEnv.Fv _4132)
            iface1.iface_bindings
           in
        FStar_List.append uu____4125 g.FStar_Extraction_ML_UEnv.env_bindings
         in
      {
        FStar_Extraction_ML_UEnv.env_tcenv =
          (uu___644_4121.FStar_Extraction_ML_UEnv.env_tcenv);
        FStar_Extraction_ML_UEnv.env_bindings = uu____4122;
        ...
        FStar_Extraction_ML_UEnv.currentModule =
          (uu___644_4121.FStar_Extraction_ML_UEnv.currentModule)
      }
  ...
  fun env  ->
    fun se  ->
      let extract_ctor env_iparams ml_tyvars env1 ctor =
        let mlt =
          let uu____4210 =
            FStar_Extraction_ML_Term.term_as_mlty env_iparams ctor.dtyp  in
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env_iparams) uu____4210
           in
        let steps =
            ...
            let uu____4219 =
              let uu____4222 =
                FStar_TypeChecker_Normalize.normalize steps
                 ...
                 in
              FStar_Syntax_Subst.compress uu____4222  in
            uu____4219.FStar_Syntax_Syntax.n  in
          match uu____4218 with
          | FStar_Syntax_Syntax.Tm_arrow (bs,uu____4227) ->
              FStar_List.map
                (fun uu____4260  ->
                   match uu____4260 with
                   | ({ FStar_Syntax_Syntax.ppname = ppname;
                        FStar_Syntax_Syntax.index = uu____4269;
                        FStar_Syntax_Syntax.sort = uu____4270;_},uu____4271)
        ...
        | (env2,uu____4314,uu____4315) ->
            let uu____4318 =
              let uu____4331 = lident_as_mlsymbol ctor.dname  in
              let uu____4333 =
                let uu____4341 = FStar_Extraction_ML_Util.argTypes mlt  in
                FStar_List.zip names1 uu____4341  in
              (uu____4331, uu____4333)  in
            (env2, uu____4318)
         in
      let extract_one_family env1 ind =
        let uu____4402 = binders_as_mlty_binders env1 ind.iparams  in
        ...
        | (env_iparams,vars) ->
            ...
            (match uu____4446 with
             | (env2,ctors) ->
                 let uu____4553 = FStar_Syntax_Util.arrow_formals ind.ityp
                    in
                            ...
                            (FStar_List.mapi
                               (fun i  ->
                                  fun uu____4646  ->
                                    ...
                                    Prims.op_Hat "'dummyV" uu____4654))
                           in
                        FStar_List.append vars uu____4620  in
                      let tbody =
                        let uu____4659 =
                          FStar_Util.find_opt
                            (fun uu___7_4664  ->
                               match uu___7_4664 with
                               | FStar_Syntax_Syntax.RecordType uu____4666 ->
                                   true
                               | uu____4676 -> false) ind.iquals
                           in
                        match uu____4659 with
                        | FStar_Pervasives_Native.Some
                            (FStar_Syntax_Syntax.RecordType (ns,ids)) ->
                            let uu____4688 = FStar_List.hd ctors  in
                        ...
                        | uu____4776 ->
                         ...
                         in
                      let uu____4779 =
                        let uu____4802 = lident_as_mlsymbol ind.iname  in
                        (false, uu____4802, FStar_Pervasives_Native.None,
      ...
      | (FStar_Syntax_Syntax.Sig_bundle
         ({
            FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
              (l,uu____4847,t,uu____4849,uu____4850,uu____4851);
            ...
            FStar_Syntax_Syntax.sigopts = uu____4856;_}::[],uu____4857),(FStar_Syntax_Syntax.ExceptionConstructor
         )::[]) ->
          let uu____4878 = extract_ctor env [] env { dname = l; dtyp = t }
             in
          (match uu____4878 with
           | (env1,ctor) -> (env1, [FStar_Extraction_ML_Syntax.MLM_Exn ctor]))
      | (FStar_Syntax_Syntax.Sig_bundle (ses,uu____4931),quals) ->
          let uu____4945 =
            FStar_Syntax_Util.has_attribute se.FStar_Syntax_Syntax.sigattrs
              FStar_Parser_Const.erasable_attr
             in
          ...
          then (env, [])
            ...
            (let uu____4958 = bundle_as_inductive_families env ses quals  in
      ...
      | uu____5086 -> failwith "Unexpected signature element"
    ...
    fun se  ->
      ...
      let plugin_with_arity attrs =
        FStar_Util.find_map attrs
          (fun t  ->
             let uu____5144 = FStar_Syntax_Util.head_and_args t  in
                 ...
                 let uu____5192 =
                   let uu____5194 =
                     FStar_Syntax_Util.is_fvar FStar_Parser_Const.plugin_attr
                       head1
                      in
                   Prims.op_Negation uu____5194  in
                 if uu____5192
         ...
         in
      let uu____5280 =
        let uu____5282 = FStar_Options.codegen ()  in
        uu____5282 <> (FStar_Pervasives_Native.Some FStar_Options.Plugin)  in
      if uu____5280
      then []
      else
        (let uu____5292 = plugin_with_arity se.FStar_Syntax_Syntax.sigattrs
            in
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_let (lbs,lids) ->
                  let mk_registration lb =
                    ...
                    let ml_name_str =
                      let uu____5334 =
                        let uu____5335 = FStar_Ident.string_of_lid fv_lid1
                           in
                        FStar_Extraction_ML_Syntax.MLC_String uu____5335  in
                      FStar_Extraction_ML_Syntax.MLE_Const uu____5334  in
                    let uu____5337 =
  ...
  fun g  ->
    fun se  ->
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let uu____5481 = FStar_Syntax_Print.sigelt_to_string se  in
           FStar_Util.print1 ">>>> extract_sig %s \n" uu____5481);
      (match se.FStar_Syntax_Syntax.sigel with
       | FStar_Syntax_Syntax.Sig_bundle uu____5490 -> extract_bundle g se
       | FStar_Syntax_Syntax.Sig_inductive_typ uu____5499 ->
           extract_bundle g se
       | FStar_Syntax_Syntax.Sig_datacon uu____5516 -> extract_bundle g se
       | FStar_Syntax_Syntax.Sig_new_effect ed when
           FStar_TypeChecker_Env.is_reifiable_effect
             g.FStar_Extraction_ML_UEnv.env_tcenv
             ed.FStar_Syntax_Syntax.mname
           ->
           let uu____5533 = extract_reifiable_effect g ed  in
           (match uu____5533 with | (env,_iface,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_splice uu____5557 ->
           failwith "impossible: trying to extract splice"
       | FStar_Syntax_Syntax.Sig_fail uu____5571 ->
           failwith "impossible: trying to extract Sig_fail"
       | FStar_Syntax_Syntax.Sig_new_effect uu____5591 -> (g, [])
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,univs1,t) when
           FStar_Extraction_ML_Term.is_arity g t ->
           let uu____5597 =
             extract_type_declaration g lid se.FStar_Syntax_Syntax.sigquals
               se.FStar_Syntax_Syntax.sigattrs univs1 t
              in
           (match uu____5597 with | (env,uu____5613,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____5622) when
           FStar_Extraction_ML_Term.is_arity g lb.FStar_Syntax_Syntax.lbtyp
           ->
           let uu____5631 =
             extract_typ_abbrev g se.FStar_Syntax_Syntax.sigquals
       ...
       | FStar_Syntax_Syntax.Sig_let ((true ,lbs),uu____5656) when
           FStar_Util.for_some
             (fun lb  ->
                FStar_Extraction_ML_Term.is_arity g
                  lb.FStar_Syntax_Syntax.lbtyp) lbs
           ->
           let uu____5669 = extract_let_rec_types se g lbs  in
           (match uu____5669 with | (env,uu____5685,impl) -> (env, impl))
       | FStar_Syntax_Syntax.Sig_let (lbs,uu____5694) ->
           ...
           let uu____5705 =
             ...
             | FStar_Pervasives_Native.Some
                 (ats,(tau,FStar_Pervasives_Native.None )::uu____5743) ->
                ...
                let postprocess_lb tau lb =
                  let lbdef =
                    FStar_TypeChecker_Env.postprocess
                     ...
                     in
                  let uu___878_5829 = lb  in
                  {
                    FStar_Syntax_Syntax.lbname =
                      (uu___878_5829.FStar_Syntax_Syntax.lbname);
                    FStar_Syntax_Syntax.lbunivs =
                      (uu___878_5829.FStar_Syntax_Syntax.lbunivs);
                    FStar_Syntax_Syntax.lbtyp =
                      (uu___878_5829.FStar_Syntax_Syntax.lbtyp);
                    FStar_Syntax_Syntax.lbeff =
                      (uu___878_5829.FStar_Syntax_Syntax.lbeff);
                    FStar_Syntax_Syntax.lbdef = lbdef;
                    FStar_Syntax_Syntax.lbattrs =
                      (uu___878_5829.FStar_Syntax_Syntax.lbattrs);
                    FStar_Syntax_Syntax.lbpos =
                      (uu___878_5829.FStar_Syntax_Syntax.lbpos)
                  }  in
                let lbs1 =
                  let uu____5838 =
                    match post_tau with
                    ...
                    | FStar_Pervasives_Native.None  ->
                        FStar_Pervasives_Native.snd lbs
                     in
                  ((FStar_Pervasives_Native.fst lbs), uu____5838)  in
                let uu____5856 =
                  let uu____5863 =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_let
                      ...
                      se.FStar_Syntax_Syntax.sigrng
                     in
                  FStar_Extraction_ML_Term.term_as_mlexpr g uu____5863  in
                (match uu____5856 with
                 | (ml_let,uu____5880,uu____5881) ->
                     (match ml_let.FStar_Extraction_ML_Syntax.expr with
                      | FStar_Extraction_ML_Syntax.MLE_Let
                          ((flavor,bindings),uu____5890) ->
                          ...
                          let uu____5907 =
                            FStar_List.fold_left2
                              (fun uu____5933  ->
                                 fun ml_lb  ->
                                   fun uu____5935  ->
                                     match (uu____5933, uu____5935) with
                                     | ((env,ml_lbs),{
                                                       FStar_Syntax_Syntax.lbname
                                                         = lbname;
                                                       FStar_Syntax_Syntax.lbunivs
                                         ...
                                         then (env, ml_lbs)
                                           ...
                                           (let lb_lid =
                                              let uu____6004 =
                                                ...
                                                uu____6007.FStar_Syntax_Syntax.fv_name
                                                 in
                                              uu____6004.FStar_Syntax_Syntax.v
                                               in
                                            let flags'' =
                                              let uu____6011 =
                                                let uu____6012 =
                                                  FStar_Syntax_Subst.compress
                                                    t
                                                   in
                                                uu____6012.FStar_Syntax_Syntax.n
                                                 in
                                            ...
                                            let meta =
                                              FStar_List.append flags
                                               ...
                                               in
                                            let ml_lb1 =
                                              let uu___926_6068 = ml_lb  in
                                              {
                                                FStar_Extraction_ML_Syntax.mllb_name
                                                  =
                                                  (uu___926_6068.FStar_Extraction_ML_Syntax.mllb_name);
                                                FStar_Extraction_ML_Syntax.mllb_tysc
                                                  =
                                                  (uu___926_6068.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                FStar_Extraction_ML_Syntax.mllb_add_unit
                                                  =
                                                  (uu___926_6068.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                FStar_Extraction_ML_Syntax.mllb_def
                                                  =
                                                  (uu___926_6068.FStar_Extraction_ML_Syntax.mllb_def);
                                                FStar_Extraction_ML_Syntax.mllb_meta
                                                  = meta;
                                                FStar_Extraction_ML_Syntax.print_typ
                                                  =
                                                  (uu___926_6068.FStar_Extraction_ML_Syntax.print_typ)
                                              }  in
                                            let uu____6069 =
                                              let uu____6074 =
                                                FStar_All.pipe_right quals
                                              ...
                                              then
                                                ...
                                                let uu____6114 =
                                                  ...
                                                  FStar_Extraction_ML_UEnv.extend_fv'
                                                    env uu____6122 mname
                                                    uu____6123
                                                    ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                    false
                                                   in
                                                match uu____6114 with
                                                | (env1,uu____6130,uu____6131)
                                                    ->
                                                    (env1,
                                                      (let uu___939_6135 =
                                                         ml_lb1  in
                                                       {
                                                         ...
                                                         FStar_Extraction_ML_Syntax.mllb_tysc
                                                           =
                                                           (uu___939_6135.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                         FStar_Extraction_ML_Syntax.mllb_add_unit
                                                           =
                                                           (uu___939_6135.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                         FStar_Extraction_ML_Syntax.mllb_def
                                                           =
                                                           (uu___939_6135.FStar_Extraction_ML_Syntax.mllb_def);
                                                         FStar_Extraction_ML_Syntax.mllb_meta
                                                           =
                                                           (uu___939_6135.FStar_Extraction_ML_Syntax.mllb_meta);
                                                         FStar_Extraction_ML_Syntax.print_typ
                                                           =
                                                           (uu___939_6135.FStar_Extraction_ML_Syntax.print_typ)
                                                       }))
                                              else
                                                (let uu____6142 =
                                                   let uu____6150 =
                                                   ...
                                                   FStar_Extraction_ML_UEnv.extend_lb
                                                     env lbname t uu____6150
                                                     ml_lb1.FStar_Extraction_ML_Syntax.mllb_add_unit
                                                     false
                                                    in
                                                 match uu____6142 with
                                                 | (env1,uu____6157,uu____6158)
                                                     -> (env1, ml_lb1))
                                               in
                               ...
                               let uu____6188 =
                                 let uu____6191 =
                                   ...
                                   FStar_Extraction_ML_Syntax.MLM_Let
                                    ...
                                    in
                                 let uu____6198 = maybe_register_plugin g1 se
                                    in
                                 FStar_List.append uu____6191 uu____6198  in
                               (g1, uu____6188))
                      | uu____6203 ->
                          let uu____6204 =
                            let uu____6206 =
                            ...
                            FStar_Util.format1
                             ...
                             in
                          failwith uu____6204)))
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____6216,t) ->
           let quals = se.FStar_Syntax_Syntax.sigquals  in
           let uu____6221 =
             (FStar_All.pipe_right quals
                (FStar_List.contains FStar_Syntax_Syntax.Assumption))
               ...
               (let uu____6227 =
                  FStar_TypeChecker_Util.must_erase_for_extraction
                    g.FStar_Extraction_ML_UEnv.env_tcenv t
                   in
                Prims.op_Negation uu____6227)
              in
           if uu____6221
           then
             let always_fail1 =
               let uu___959_6237 = se  in
               let uu____6238 =
                 let uu____6239 =
                   let uu____6246 =
                     let uu____6247 =
                       let uu____6250 = always_fail lid t  in [uu____6250]
                        in
                     (false, uu____6247)  in
                   (uu____6246, [])  in
                 FStar_Syntax_Syntax.Sig_let uu____6239  in
               {
                 FStar_Syntax_Syntax.sigel = uu____6238;
                 FStar_Syntax_Syntax.sigrng =
                   (uu___959_6237.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___959_6237.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___959_6237.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___959_6237.FStar_Syntax_Syntax.sigattrs);
                 FStar_Syntax_Syntax.sigopts =
                   (uu___959_6237.FStar_Syntax_Syntax.sigopts)
               }  in
             let uu____6257 = extract_sig g always_fail1  in
             (match uu____6257 with
              | (g1,mlm) ->
                  let uu____6276 =
                    FStar_Util.find_map quals
                      (fun uu___9_6281  ->
                         match uu___9_6281 with
                         ...
                         let uu____6296 =
                           let uu____6297 =
                             FStar_Extraction_ML_Util.mlloc_of_range
                               se.FStar_Syntax_Syntax.sigrng
                              in
                           FStar_Extraction_ML_Syntax.MLM_Loc uu____6297  in
                         let uu____6298 =
                           let uu____6301 =
                             FStar_Extraction_ML_Term.ind_discriminator_body
                              ...
                              in
                           [uu____6301]  in
                         uu____6296 :: uu____6298  in
                       (g1, uu____6293)
                   | uu____6304 ->
                       let uu____6307 =
                         FStar_Util.find_map quals
                           (fun uu___10_6313  ->
                              match uu___10_6313 with
                              | FStar_Syntax_Syntax.Projector (l,uu____6317)
                                  -> FStar_Pervasives_Native.Some l
                              | uu____6318 -> FStar_Pervasives_Native.None)
                          in
                       (match uu____6307 with
                        | FStar_Pervasives_Native.Some uu____6325 -> (g1, [])
                        | uu____6328 -> (g1, mlm))))
           else (g, [])
       | FStar_Syntax_Syntax.Sig_main e ->
           let uu____6338 = FStar_Extraction_ML_Term.term_as_mlexpr g e  in
           (match uu____6338 with
            | (ml_main,uu____6352,uu____6353) ->
                let uu____6354 =
                  let uu____6357 =
                    let uu____6358 =
                      FStar_Extraction_ML_Util.mlloc_of_range
                        se.FStar_Syntax_Syntax.sigrng
                       in
                    FStar_Extraction_ML_Syntax.MLM_Loc uu____6358  in
                  [uu____6357; FStar_Extraction_ML_Syntax.MLM_Top ml_main]
                   in
                (g, uu____6354))
       | FStar_Syntax_Syntax.Sig_assume uu____6361 -> (g, [])
       | FStar_Syntax_Syntax.Sig_sub_effect uu____6370 -> (g, [])
       | FStar_Syntax_Syntax.Sig_effect_abbrev uu____6373 -> (g, [])
       | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____6388 -> (g, [])
       | FStar_Syntax_Syntax.Sig_pragma p ->
           (FStar_Syntax_Util.process_pragma p se.FStar_Syntax_Syntax.sigrng;
            (g, [])))
...
let (extract' :
  ...
  fun g  ->
    fun m  ->
      let uu____6428 = FStar_Options.restore_cmd_line_options true  in
      let name =
        FStar_Extraction_ML_Syntax.mlpath_of_lident
          m.FStar_Syntax_Syntax.name
         in
      let g1 =
        let uu___1002_6432 = g  in
        let uu____6433 =
          FStar_TypeChecker_Env.set_current_module
            g.FStar_Extraction_ML_UEnv.env_tcenv m.FStar_Syntax_Syntax.name
           in
        {
          FStar_Extraction_ML_UEnv.env_tcenv = uu____6433;
          FStar_Extraction_ML_UEnv.env_bindings =
            (uu___1002_6432.FStar_Extraction_ML_UEnv.env_bindings);
          FStar_Extraction_ML_UEnv.env_mlident_map =
            (uu___1002_6432.FStar_Extraction_ML_UEnv.env_mlident_map);
          FStar_Extraction_ML_UEnv.tydefs =
            (uu___1002_6432.FStar_Extraction_ML_UEnv.tydefs);
          FStar_Extraction_ML_UEnv.type_names =
            (uu___1002_6432.FStar_Extraction_ML_UEnv.type_names);
          ...
          (fun g2  ->
             fun se  ->
               ...
               then
                 let nm =
                   let uu____6464 =
                     let uu____6468 = FStar_Syntax_Util.lids_of_sigelt se  in
                     FStar_All.pipe_right uu____6468
                       (FStar_List.map FStar_Ident.string_of_lid)
                      in
                   FStar_All.pipe_right uu____6464 (FStar_String.concat ", ")
                    in
                 (FStar_Util.print1 "+++About to extract {%s}\n" nm;
                  (let uu____6484 = FStar_Util.format1 "---Extracted {%s}" nm
                      in
                   FStar_Util.measure_execution_time uu____6484
                     (fun uu____6494  -> extract_sig g2 se)))
      ...
      | (g2,sigs) ->
          ...
          let is_kremlin =
            let uu____6516 = FStar_Options.codegen ()  in
            uu____6516 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin)
             in
          if
          ...
          then
            ((let uu____6531 =
                let uu____6533 = FStar_Options.silent ()  in
...
let (extract :
  ...
  fun g  ->
    fun m  ->
      (let uu____6611 = FStar_Options.restore_cmd_line_options true  in
       FStar_All.pipe_left (fun a2  -> ()) uu____6611);
      (let uu____6614 =
         let uu____6616 =
      ...
      (let uu____6626 = FStar_Options.interactive ()  in
       if uu____6626
       then (g, FStar_Pervasives_Native.None)
         ...
         (let res =
          ...
          (let uu____6671 = FStar_Options.restore_cmd_line_options true  in
           FStar_All.pipe_left (fun a3  -> ()) uu____6671);
          res))
