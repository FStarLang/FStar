...
let (__proj__InvalidQuery__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidQuery uu____133 -> uu____133
...
let (js_txdoc_item : FStar_Util.json -> txdoc_item) =
  fun uu___6_603  ->
    ...
    | FStar_Util.JsonAssoc a ->
        ...
        let uu____620 =
          let uu____622 = arg "uri"  in FStar_All.pipe_right uu____622 js_str
           in
        let uu____625 =
        ...
        let uu____635 =
          let uu____637 = arg "text"  in
          FStar_All.pipe_right uu____637 js_str  in
        {
          uri = uu____620;
          langId = uu____625;
          version = uu____630;
...
let (uu___is_Hover : lquery -> Prims.bool) =
  fun projectee  ->
    match projectee with | Hover  -> true | uu____1225 -> false
