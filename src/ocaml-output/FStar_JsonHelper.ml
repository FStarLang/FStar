          ...
          FStar_List.map
            (fun uu____889  ->
               ...
               | FStar_Util.JsonAssoc a ->
                   ...
                   FStar_All.pipe_right uu____899 js_str) l
           in
...
let (uu___is_Exit : lquery -> Prims.bool) =
  fun projectee  ->
    match projectee with | Exit  -> true | uu____1270 -> false
...
let (uu___is_Noop : repl_task -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noop  -> true | uu____2135 -> false
  ...
  fun r  ->
    let uu____3108 =
      ...
      let uu____3126 =
        let uu____3134 =
          let uu____3140 =
            let uu____3141 = FStar_Range.end_of_range r  in js_pos uu____3141
             in
          ("end", uu____3140)  in
        [uu____3134]  in
