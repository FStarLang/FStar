...
let (uu___is_C_Unit : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_Unit -> true | uu____20 -> false
...
let (uu___is_C_True : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_True -> true | uu____40 -> false
let (uu___is_C_False : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_False -> true | uu____46 -> false
...
let (uu___is_Unit : exp -> Prims.bool) =
  fun projectee -> match projectee with | Unit -> true | uu____1081 -> false
...
let (uu___32 : (refl_constant, refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___33 : (refl_constant, refl_constant) FStar_Pervasives_Native.tuple2)
