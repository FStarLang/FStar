...
| Tv_Const of vconst
| Tv_Uvar of (FStar_BigInt.t * FStar_Syntax_Syntax.gamma * binders * typ)
...
let __proj__Tv_Uvar__item___0 : term_view  ->  (FStar_BigInt.t * FStar_Syntax_Syntax.gamma * binders * typ) = (fun projectee -> (match (projectee) with
| Tv_Uvar (_0) -> begin
_0
end))
...
let uu____1215 = (FStar_Syntax_Syntax.tdataconstr lid)
in {lid = lid; t = uu____1215})))


let mk_refl_types_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1221 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.tconst uu____1221)))


let mk_refl_syntax_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1227 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.tconst uu____1227)))


let mk_refl_data_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1233 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.tconst uu____1233)))
...
let uu____1246 = (FStar_Syntax_Syntax.fvar inspect_lid (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None)
in {lid = inspect_lid; t = uu____1246})
in (

let pack = (

let uu____1248 = (FStar_Syntax_Syntax.fvar pack_lid (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None)
in {lid = pack_lid; t = uu____1248})
in ((inspect), (pack)))))))


let uu___25 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_ln")


let fstar_refl_inspect_ln : refl_constant = (match (uu___25) with
| (fstar_refl_inspect_ln, fstar_refl_pack_ln) -> begin
fstar_refl_inspect_ln
end)


let fstar_refl_pack_ln : refl_constant = (match (uu___25) with
| (fstar_refl_inspect_ln1, fstar_refl_pack_ln) -> begin
fstar_refl_pack_ln
end)


let uu___26 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_fv")


let fstar_refl_inspect_fv : refl_constant = (match (uu___26) with
| (fstar_refl_inspect_fv, fstar_refl_pack_fv) -> begin
fstar_refl_inspect_fv
end)


let fstar_refl_pack_fv : refl_constant = (match (uu___26) with
| (fstar_refl_inspect_fv1, fstar_refl_pack_fv) -> begin
fstar_refl_pack_fv
end)


let uu___27 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_bv")


let fstar_refl_inspect_bv : refl_constant = (match (uu___27) with
| (fstar_refl_inspect_bv, fstar_refl_pack_bv) -> begin
fstar_refl_inspect_bv
end)


let fstar_refl_pack_bv : refl_constant = (match (uu___27) with
| (fstar_refl_inspect_bv1, fstar_refl_pack_bv) -> begin
fstar_refl_pack_bv
end)


let uu___28 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_binder")


let fstar_refl_inspect_binder : refl_constant = (match (uu___28) with
| (fstar_refl_inspect_binder, fstar_refl_pack_binder) -> begin
fstar_refl_inspect_binder
end)


let fstar_refl_pack_binder : refl_constant = (match (uu___28) with
| (fstar_refl_inspect_binder1, fstar_refl_pack_binder) -> begin
fstar_refl_pack_binder
end)


let uu___29 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_comp")


let fstar_refl_inspect_comp : refl_constant = (match (uu___29) with
| (fstar_refl_inspect_comp, fstar_refl_pack_comp) -> begin
fstar_refl_inspect_comp
end)


let fstar_refl_pack_comp : refl_constant = (match (uu___29) with
| (fstar_refl_inspect_comp1, fstar_refl_pack_comp) -> begin
fstar_refl_pack_comp
end)


let uu___30 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_sigelt")


let fstar_refl_inspect_sigelt : refl_constant = (match (uu___30) with
| (fstar_refl_inspect_sigelt, fstar_refl_pack_sigelt) -> begin
fstar_refl_inspect_sigelt
end)


let fstar_refl_pack_sigelt : refl_constant = (match (uu___30) with
...
let uu____1306 = (fstar_refl_data_lid "bv_view")
in (

let uu____1307 = (

let uu____1310 = (FStar_Ident.mk_ident (("bv_ppname"), (FStar_Range.dummyRange)))
in (

let uu____1311 = (

let uu____1314 = (FStar_Ident.mk_ident (("bv_index"), (FStar_Range.dummyRange)))
in (

let uu____1315 = (

let uu____1318 = (FStar_Ident.mk_ident (("bv_sort"), (FStar_Range.dummyRange)))
in (uu____1318)::[])
in (uu____1314)::uu____1315))
in (uu____1310)::uu____1311))
in ((uu____1306), (uu____1307))))
in FStar_Syntax_Syntax.Record_ctor (uu____1299))
in (

let uu____1321 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (attr)))
in {lid = lid; t = uu____1321})))
...
let uu____1322 = (FStar_Ident.lid_of_path (("FStar")::("Reflection")::("Data")::("exp")::[]) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.tconst uu____1322))
