...
let uu____727 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.tconst uu____727)))


let mk_refl_syntax_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____732 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.tconst uu____732)))


let mk_refl_data_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____737 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.tconst uu____737)))


let fstar_refl_tdataconstr : Prims.string Prims.list  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____746 = (fstar_refl_lid s)
in (FStar_Syntax_Syntax.tdataconstr uu____746)))
...
let uu____747 = (fstar_refl_types_lid "binder")
in (FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____747))


let t_term : FStar_Syntax_Syntax.term = (

let uu____748 = (fstar_refl_types_lid "term")
in (FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____748))


let t_fv : FStar_Syntax_Syntax.term = (

let uu____749 = (fstar_refl_types_lid "fv")
in (FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____749))


let t_binders : FStar_Syntax_Syntax.term = (

let uu____750 = (fstar_refl_types_lid "binders")
in (FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____750))
