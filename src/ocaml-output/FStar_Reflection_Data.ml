...
let uu____1288 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in (

let uu____1289 = (FStar_Syntax_Syntax.tdataconstr lid)
in {lid = lid; fv = uu____1288; t = uu____1289}))))


let mk_refl_types_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1295 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.tconst uu____1295)))


let mk_refl_types_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1301 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1301)))


let mk_refl_syntax_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1307 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.tconst uu____1307)))


let mk_refl_syntax_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1313 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1313)))


let mk_refl_data_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1319 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.tconst uu____1319)))


let mk_refl_data_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1325 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1325)))
...
let uu____1340 = (FStar_Syntax_Syntax.fv_to_tm inspect_fv)
in {lid = inspect_lid; fv = inspect_fv; t = uu____1340})
in (

let pack = (

let uu____1342 = (FStar_Syntax_Syntax.fv_to_tm pack_fv)
in {lid = pack_lid; fv = pack_fv; t = uu____1342})
in ((inspect), (pack)))))))))
...
let uu____1400 = (fstar_refl_data_lid "bv_view")
in (

let uu____1401 = (

let uu____1404 = (FStar_Ident.mk_ident (("bv_ppname"), (FStar_Range.dummyRange)))
in (

let uu____1405 = (

let uu____1408 = (FStar_Ident.mk_ident (("bv_index"), (FStar_Range.dummyRange)))
in (

let uu____1409 = (

let uu____1412 = (FStar_Ident.mk_ident (("bv_sort"), (FStar_Range.dummyRange)))
in (uu____1412)::[])
in (uu____1408)::uu____1409))
in (uu____1404)::uu____1405))
in ((uu____1400), (uu____1401))))
in FStar_Syntax_Syntax.Record_ctor (uu____1393))
in (

let fv = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant (FStar_Pervasives_Native.Some (attr)))
in (

let uu____1416 = (FStar_Syntax_Syntax.fv_to_tm fv)
in {lid = lid; fv = fv; t = uu____1416}))))
...
let uu____1417 = (FStar_Ident.lid_of_path (("FStar")::("Reflection")::("Data")::("exp")::[]) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.tconst uu____1417))
