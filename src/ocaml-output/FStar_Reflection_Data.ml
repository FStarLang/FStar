...
let (uu___is_Var : exp -> Prims.bool) =
  fun projectee  ->
    match projectee with | Var _0 -> true | uu____981 -> false
...
let (uu___71 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___72 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___73 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___74 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___75 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
...
let (uu___76 : (refl_constant,refl_constant) FStar_Pervasives_Native.tuple2)
