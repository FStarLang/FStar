...
type universe_view =
  ...
  | Uv_Max of FStar_Syntax_Syntax.universes 
...
let (__proj__Uv_Max__item___0 :
  universe_view -> FStar_Syntax_Syntax.universes) =
...
type term_view =
  ...
  | Tv_UInst of (FStar_Syntax_Syntax.fv * FStar_Syntax_Syntax.universes) 
...
let (__proj__Tv_UInst__item___0 :
  term_view -> (FStar_Syntax_Syntax.fv * FStar_Syntax_Syntax.universes)) =
...
let (__proj__C_Total__item___0 :
  comp_view ->
    (typ * FStar_Syntax_Syntax.universe FStar_Pervasives_Native.option *
...
let (__proj__C_Eff__item___0 :
  comp_view ->
    (FStar_Syntax_Syntax.universes * name * FStar_Syntax_Syntax.term * argv
      Prims.list))
...
let (mk_inspect_pack_pair : Prims.string -> (refl_constant * refl_constant))
  ...
  fun s ->
    ...
    (inspect, pack)
let (uu___111 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_ln"
...
let (uu___118 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_fv"
...
let (uu___125 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_bv"
...
let (uu___132 : (refl_constant * refl_constant)) =
...
let (uu___139 : (refl_constant * refl_constant)) =
...
let (uu___146 : (refl_constant * refl_constant)) =
...
let (uu___153 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_lb"
