...
let (uu___1 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_ln" 
...
let (uu___2 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_fv" 
...
let (uu___3 : (refl_constant * refl_constant)) = mk_inspect_pack_pair "_bv" 
