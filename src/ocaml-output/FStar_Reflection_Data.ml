...
let uu___is_Simpl: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Simpl  -> true | uu____607 -> false
let uu___is_WHNF: norm_step -> Prims.bool =
  fun projectee  -> match projectee with | WHNF  -> true | uu____612 -> false
let uu___is_Primops: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Primops  -> true | uu____617 -> false
let uu___is_Delta: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Delta  -> true | uu____622 -> false
...
let mk_refl_types_lid_as_term: Prims.string -> FStar_Syntax_Syntax.term =
  fun s  ->
    let uu____651 = fstar_refl_types_lid s in
    FStar_Syntax_Syntax.tconst uu____651
let mk_refl_syntax_lid_as_term: Prims.string -> FStar_Syntax_Syntax.term =
  fun s  ->
    let uu____656 = fstar_refl_syntax_lid s in
    FStar_Syntax_Syntax.tconst uu____656
let mk_refl_data_lid_as_term: Prims.string -> FStar_Syntax_Syntax.term =
  fun s  ->
    let uu____661 = fstar_refl_data_lid s in
    FStar_Syntax_Syntax.tconst uu____661
let fstar_refl_tdataconstr:
  Prims.string Prims.list -> FStar_Syntax_Syntax.term =
  fun s  ->
    let uu____670 = fstar_refl_lid s in
    FStar_Syntax_Syntax.tdataconstr uu____670
...
let t_binder: FStar_Syntax_Syntax.term =
  ...
  FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____671
let t_term: FStar_Syntax_Syntax.term =
  let uu____672 = fstar_refl_types_lid "term" in
  FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____672
let t_fv: FStar_Syntax_Syntax.term =
  let uu____673 = fstar_refl_types_lid "fv" in
  FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____673
let t_binders: FStar_Syntax_Syntax.term =
  let uu____674 = fstar_refl_types_lid "binders" in
  FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____674
let t_norm_step: FStar_Syntax_Syntax.term =
  let uu____675 = fstar_refl_types_lid "norm_step" in
  FStar_All.pipe_left FStar_Syntax_Syntax.tabbrev uu____675
