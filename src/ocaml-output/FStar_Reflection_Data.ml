...
let (uu___is_C_Unit : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_Unit -> true | uu____16 -> false
...
let (uu___is_C_True : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_True -> true | uu____32 -> false
let (uu___is_C_False : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_False -> true | uu____36 -> false
...
let (uu___is_C_Total : comp_view -> Prims.bool) =
  fun projectee ->
    match projectee with | C_Total _0 -> true | uu____731 -> false
...
let (uu___is_C_Lemma : comp_view -> Prims.bool) =
  fun projectee ->
    match projectee with | C_Lemma _0 -> true | uu____765 -> false
...
let (uu___is_C_Unknown : comp_view -> Prims.bool) =
  fun projectee ->
    match projectee with | C_Unknown -> true | uu____788 -> false
type sigelt_view =
  | Sg_Let of (Prims.bool, FStar_Syntax_Syntax.fv, typ,
  FStar_Syntax_Syntax.term) FStar_Pervasives_Native.tuple4 
  | Sg_Inductive of (name, FStar_Syntax_Syntax.binder Prims.list, typ,
  name Prims.list) FStar_Pervasives_Native.tuple4 
  | Sg_Constructor of (name, typ) FStar_Pervasives_Native.tuple2 
  | Unk [@@deriving show]
let (uu___is_Sg_Let : sigelt_view -> Prims.bool) =
  fun projectee ->
    match projectee with | Sg_Let _0 -> true | uu____837 -> false
...
let (uu___is_Sg_Inductive : sigelt_view -> Prims.bool) =
  fun projectee ->
    match projectee with | Sg_Inductive _0 -> true | uu____885 -> false
...
let (uu___is_Sg_Constructor : sigelt_view -> Prims.bool) =
  fun projectee ->
    match projectee with | Sg_Constructor _0 -> true | uu____937 -> false
...
let (uu___is_Unk : sigelt_view -> Prims.bool) =
  fun projectee -> match projectee with | Unk -> true | uu____960 -> false
...
let (uu___is_Unit : exp -> Prims.bool) =
  fun projectee -> match projectee with | Unit -> true | uu____976 -> false
let (uu___is_Var : exp -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____981 -> false
let (__proj__Var__item___0 : exp -> var) =
  fun projectee -> match projectee with | Var _0 -> _0
let (uu___is_Mult : exp -> Prims.bool) =
  fun projectee ->
    match projectee with | Mult _0 -> true | uu____997 -> false
...
let (mk_inspect_pack_pair :
  ...
  fun s ->
    ...
    let inspect =
      ...
      { lid = inspect_lid; t = uu____1087 } in
    let pack =
      let uu____1089 =
        FStar_Syntax_Syntax.fvar pack_lid
          (FStar_Syntax_Syntax.Delta_defined_at_level (Prims.parse_int "1"))
          FStar_Pervasives_Native.None in
      { lid = pack_lid; t = uu____1089 } in
    (inspect, pack)
...
let (uu___31 : (refl_constant, refl_constant) FStar_Pervasives_Native.tuple2)
