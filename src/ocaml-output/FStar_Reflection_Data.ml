...
let (uu___is_C_Unit : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Unit  -> true | uu____37588 -> false
  
let (uu___is_C_Int : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Int _0 -> true | uu____37600 -> false
...
let (uu___is_C_True : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_True  -> true | uu____37618 -> false
  
let (uu___is_C_False : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_False  -> true | uu____37629 -> false
  
let (uu___is_C_String : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_String _0 -> true | uu____37642 -> false
...
let (uu___is_C_Range : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Range _0 -> true | uu____37664 -> false
...
let (uu___is_C_Reify : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Reify  -> true | uu____37682 -> false
  
let (uu___is_C_Reflect : vconst -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Reflect _0 -> true | uu____37694 -> false
...
let (uu___is_Pat_Constant : pattern -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_Constant _0 -> true | uu____37748 -> false
  
let (__proj__Pat_Constant__item___0 : pattern -> vconst) =
  fun projectee  -> match projectee with | Pat_Constant _0 -> _0 
let (uu___is_Pat_Cons : pattern -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_Cons _0 -> true | uu____37773 -> false
...
let (uu___is_Q_Implicit : aqualv -> Prims.bool) =
  fun projectee  ->
    match projectee with | Q_Implicit  -> true | uu____37891 -> false
  
let (uu___is_Q_Explicit : aqualv -> Prims.bool) =
  fun projectee  ->
    match projectee with | Q_Explicit  -> true | uu____37902 -> false
  
let (uu___is_Q_Meta : aqualv -> Prims.bool) =
  fun projectee  ->
    match projectee with | Q_Meta _0 -> true | uu____37914 -> false
...
let (uu___is_Tv_Var : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Var _0 -> true | uu____38058 -> false
...
let (uu___is_Tv_BVar : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_BVar _0 -> true | uu____38077 -> false
...
let (uu___is_Tv_FVar : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_FVar _0 -> true | uu____38096 -> false
...
let (uu___is_Tv_App : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_App _0 -> true | uu____38119 -> false
...
let (uu___is_Tv_Abs : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Abs _0 -> true | uu____38154 -> false
...
let (uu___is_Tv_Arrow : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Arrow _0 -> true | uu____38189 -> false
...
let (uu___is_Tv_Type : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Type _0 -> true | uu____38220 -> false
  

let (uu___is_Tv_Refine : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Refine _0 -> true | uu____38238 -> false
...
let (uu___is_Tv_Const : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Const _0 -> true | uu____38269 -> false
...
let (uu___is_Tv_Uvar : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Uvar _0 -> true | uu____38292 -> false
...
let (uu___is_Tv_Let : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Let _0 -> true | uu____38332 -> false
...
let (uu___is_Tv_Match : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Match _0 -> true | uu____38384 -> false
...
let (uu___is_Tv_AscribedT : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_AscribedT _0 -> true | uu____38429 -> false
...
let (uu___is_Tv_AscribedC : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_AscribedC _0 -> true | uu____38480 -> false
...
let (uu___is_Tv_Unknown : term_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tv_Unknown  -> true | uu____38522 -> false
...
let (uu___is_C_Total : comp_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Total _0 -> true | uu____38612 -> false
...
let (uu___is_C_Lemma : comp_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Lemma _0 -> true | uu____38653 -> false
...
let (uu___is_C_Unknown : comp_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | C_Unknown  -> true | uu____38683 -> false
...
let (uu___is_Sg_Let : sigelt_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sg_Let _0 -> true | uu____38756 -> false
...
let (uu___is_Sg_Inductive : sigelt_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sg_Inductive _0 -> true | uu____38830 -> false
...
let (uu___is_Sg_Constructor : sigelt_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sg_Constructor _0 -> true | uu____38901 -> false
...
let (uu___is_Unk : sigelt_view -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unk  -> true | uu____38931 -> false
...
let (uu___is_Unit : exp -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unit  -> true | uu____38956 -> false
  
let (uu___is_Var : exp -> Prims.bool) =
  fun projectee  ->
    match projectee with | Var _0 -> true | uu____38968 -> false
  
let (__proj__Var__item___0 : exp -> var) =
  fun projectee  -> match projectee with | Var _0 -> _0 
let (uu___is_Mult : exp -> Prims.bool) =
  fun projectee  ->
    match projectee with | Mult _0 -> true | uu____38991 -> false
  ...
  fun s  ->
    ...
    let uu____39141 =
      FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant
       ...
       in
    let uu____39142 = FStar_Syntax_Syntax.tdataconstr lid  in
    { lid; fv = uu____39141; t = uu____39142 }
  
let (mk_refl_types_lid_as_term : Prims.string -> FStar_Syntax_Syntax.term) =
  fun s  ->
    let uu____39151 = fstar_refl_types_lid s  in
    FStar_Syntax_Syntax.tconst uu____39151
  
let (mk_refl_types_lid_as_fv : Prims.string -> FStar_Syntax_Syntax.fv) =
  fun s  ->
    let uu____39160 = fstar_refl_types_lid s  in
    FStar_Syntax_Syntax.fvconst uu____39160
  
let (mk_refl_syntax_lid_as_term : Prims.string -> FStar_Syntax_Syntax.term) =
  fun s  ->
    let uu____39169 = fstar_refl_syntax_lid s  in
    FStar_Syntax_Syntax.tconst uu____39169
  
let (mk_refl_syntax_lid_as_fv : Prims.string -> FStar_Syntax_Syntax.fv) =
  fun s  ->
    let uu____39178 = fstar_refl_syntax_lid s  in
    FStar_Syntax_Syntax.fvconst uu____39178
  
let (mk_refl_data_lid_as_term : Prims.string -> FStar_Syntax_Syntax.term) =
  fun s  ->
    let uu____39187 = fstar_refl_data_lid s  in
    FStar_Syntax_Syntax.tconst uu____39187
  
let (mk_refl_data_lid_as_fv : Prims.string -> FStar_Syntax_Syntax.fv) =
  fun s  ->
    let uu____39196 = fstar_refl_data_lid s  in
    FStar_Syntax_Syntax.fvconst uu____39196
  ...
  fun s  ->
    ...
    let pack_fv =
      FStar_Syntax_Syntax.lid_as_fv pack_lid
       ...
       in
    let inspect =
      let uu____39218 = FStar_Syntax_Syntax.fv_to_tm inspect_fv  in
      { lid = inspect_lid; fv = inspect_fv; t = uu____39218 }  in
    let pack =
      let uu____39220 = FStar_Syntax_Syntax.fv_to_tm pack_fv  in
      { lid = pack_lid; fv = pack_fv; t = uu____39220 }  in
    (inspect, pack)
...
let (ref_Mk_bv : refl_constant) =
  ...
  let attr =
    let uu____39369 =
      let uu____39376 = fstar_refl_data_lid "bv_view"  in
      let uu____39378 =
        let uu____39381 =
        ...
        let uu____39384 =
          ...
          let uu____39390 =
            ...
            [uu____39393]  in
          uu____39387 :: uu____39390  in
        uu____39381 :: uu____39384  in
      (uu____39376, uu____39378)  in
    FStar_Syntax_Syntax.Record_ctor uu____39369  in
  let fv =
    FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant
      (FStar_Pervasives_Native.Some attr)
     in
  let uu____39399 = FStar_Syntax_Syntax.fv_to_tm fv  in
  { lid; fv; t = uu____39399 } 
...
let (t_exp : FStar_Syntax_Syntax.term) =
  let uu____39483 =
    FStar_Ident.lid_of_path ["FStar"; "Reflection"; "Data"; "exp"]
      FStar_Range.dummyRange
     in
  FStar_Syntax_Syntax.tconst uu____39483 
