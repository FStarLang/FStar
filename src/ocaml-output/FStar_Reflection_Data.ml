...
let fstar_refl_inspect_ln : refl_constant = (match (uu___88) with
| (fstar_refl_inspect_ln, fstar_refl_pack_ln) -> begin
fstar_refl_inspect_ln
end)


let fstar_refl_pack_ln : refl_constant = (match (uu___88) with
...
let fstar_refl_inspect_fv : refl_constant = (match (uu___89) with
| (fstar_refl_inspect_fv, fstar_refl_pack_fv) -> begin
fstar_refl_inspect_fv
end)


let fstar_refl_pack_fv : refl_constant = (match (uu___89) with
...
let fstar_refl_inspect_bv : refl_constant = (match (uu___90) with
| (fstar_refl_inspect_bv, fstar_refl_pack_bv) -> begin
fstar_refl_inspect_bv
end)


let fstar_refl_pack_bv : refl_constant = (match (uu___90) with
| (fstar_refl_inspect_bv1, fstar_refl_pack_bv) -> begin
fstar_refl_pack_bv
end)


let uu___91 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_binder")


let fstar_refl_inspect_binder : refl_constant = (match (uu___91) with
| (fstar_refl_inspect_binder, fstar_refl_pack_binder) -> begin
fstar_refl_inspect_binder
end)


let fstar_refl_pack_binder : refl_constant = (match (uu___91) with
| (fstar_refl_inspect_binder1, fstar_refl_pack_binder) -> begin
fstar_refl_pack_binder
end)


let uu___92 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_comp")


let fstar_refl_inspect_comp : refl_constant = (match (uu___92) with
| (fstar_refl_inspect_comp, fstar_refl_pack_comp) -> begin
fstar_refl_inspect_comp
end)


let fstar_refl_pack_comp : refl_constant = (match (uu___92) with
| (fstar_refl_inspect_comp1, fstar_refl_pack_comp) -> begin
fstar_refl_pack_comp
end)


let uu___93 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_sigelt")


let fstar_refl_inspect_sigelt : refl_constant = (match (uu___93) with
| (fstar_refl_inspect_sigelt, fstar_refl_pack_sigelt) -> begin
fstar_refl_inspect_sigelt
end)


let fstar_refl_pack_sigelt : refl_constant = (match (uu___93) with
