...
let (uu___is_C_Unit : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_Unit -> true | uu____25 -> false
...
let (uu___is_C_True : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_True -> true | uu____45 -> false
let (uu___is_C_False : vconst -> Prims.bool) =
  fun projectee -> match projectee with | C_False -> true | uu____51 -> false
...
let (__proj__Sg_Let__item___0 :
  sigelt_view ->
    (Prims.bool, FStar_Syntax_Syntax.fv,
      FStar_Syntax_Syntax.univ_name Prims.list, typ,
...
let (uu___is_Unit : exp -> Prims.bool) =
  fun projectee -> match projectee with | Unit -> true | uu____1159 -> false
