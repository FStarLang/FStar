...
let uu___is_C_Int : vconst -> Prims.bool =
  fun projectee -> match projectee with C_Int _0 -> true | uu____21 -> false
...
type aqualv = Q_Implicit | Q_Explicit [@@deriving show]
...
type argv =
  (FStar_Syntax_Syntax.term, aqualv) FStar_Pervasives_Native.tuple2
  [@@deriving show]
...
let fstar_refl_lid : Prims.string Prims.list -> FStar_Ident.lident =
  fun s ->
    FStar_Ident.lid_of_path
      (FStar_List.append ["FStar"; "Reflection"] s)
