...
let uu____1593 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in (

let uu____1594 = (FStar_Syntax_Syntax.tdataconstr lid)
in {lid = lid; fv = uu____1593; t = uu____1594}))))


let mk_refl_types_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1603 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.tconst uu____1603)))


let mk_refl_types_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1612 = (fstar_refl_types_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1612)))


let mk_refl_syntax_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1621 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.tconst uu____1621)))


let mk_refl_syntax_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1630 = (fstar_refl_syntax_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1630)))


let mk_refl_data_lid_as_term : Prims.string  ->  FStar_Syntax_Syntax.term = (fun s -> (

let uu____1639 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.tconst uu____1639)))


let mk_refl_data_lid_as_fv : Prims.string  ->  FStar_Syntax_Syntax.fv = (fun s -> (

let uu____1648 = (fstar_refl_data_lid s)
in (FStar_Syntax_Syntax.fvconst uu____1648)))
...
let uu____1670 = (FStar_Syntax_Syntax.fv_to_tm inspect_fv)
in {lid = inspect_lid; fv = inspect_fv; t = uu____1670})
in (

let pack = (

let uu____1672 = (FStar_Syntax_Syntax.fv_to_tm pack_fv)
in {lid = pack_lid; fv = pack_fv; t = uu____1672})
in ((inspect), (pack)))))))))
...
let fstar_refl_inspect_ln : refl_constant = (match (uu___71) with
| (fstar_refl_inspect_ln, fstar_refl_pack_ln) -> begin
fstar_refl_inspect_ln
end)


let fstar_refl_pack_ln : refl_constant = (match (uu___71) with
...
let fstar_refl_inspect_fv : refl_constant = (match (uu___78) with
| (fstar_refl_inspect_fv, fstar_refl_pack_fv) -> begin
fstar_refl_inspect_fv
end)


let fstar_refl_pack_fv : refl_constant = (match (uu___78) with
...
let fstar_refl_inspect_bv : refl_constant = (match (uu___85) with
| (fstar_refl_inspect_bv, fstar_refl_pack_bv) -> begin
fstar_refl_inspect_bv
end)


let fstar_refl_pack_bv : refl_constant = (match (uu___85) with
| (fstar_refl_inspect_bv1, fstar_refl_pack_bv) -> begin
fstar_refl_pack_bv
end)


let uu___92 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_binder")


let fstar_refl_inspect_binder : refl_constant = (match (uu___92) with
| (fstar_refl_inspect_binder, fstar_refl_pack_binder) -> begin
fstar_refl_inspect_binder
end)


let fstar_refl_pack_binder : refl_constant = (match (uu___92) with
| (fstar_refl_inspect_binder1, fstar_refl_pack_binder) -> begin
fstar_refl_pack_binder
end)


let uu___99 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_comp")


let fstar_refl_inspect_comp : refl_constant = (match (uu___99) with
| (fstar_refl_inspect_comp, fstar_refl_pack_comp) -> begin
fstar_refl_inspect_comp
end)


let fstar_refl_pack_comp : refl_constant = (match (uu___99) with
| (fstar_refl_inspect_comp1, fstar_refl_pack_comp) -> begin
fstar_refl_pack_comp
end)


let uu___106 : (refl_constant * refl_constant) = (mk_inspect_pack_pair "_sigelt")


let fstar_refl_inspect_sigelt : refl_constant = (match (uu___106) with
| (fstar_refl_inspect_sigelt, fstar_refl_pack_sigelt) -> begin
fstar_refl_inspect_sigelt
end)


let fstar_refl_pack_sigelt : refl_constant = (match (uu___106) with
...
let uu____1828 = (fstar_refl_data_lid "bv_view")
in (

let uu____1830 = (

let uu____1833 = (FStar_Ident.mk_ident (("bv_ppname"), (FStar_Range.dummyRange)))
in (

let uu____1836 = (

let uu____1839 = (FStar_Ident.mk_ident (("bv_index"), (FStar_Range.dummyRange)))
in (

let uu____1842 = (

let uu____1845 = (FStar_Ident.mk_ident (("bv_sort"), (FStar_Range.dummyRange)))
in (uu____1845)::[])
in (uu____1839)::uu____1842))
in (uu____1833)::uu____1836))
in ((uu____1828), (uu____1830))))
in FStar_Syntax_Syntax.Record_ctor (uu____1821))
in (

let fv = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.delta_constant (FStar_Pervasives_Native.Some (attr)))
in (

let uu____1851 = (FStar_Syntax_Syntax.fv_to_tm fv)
in {lid = lid; fv = fv; t = uu____1851}))))
...
let uu____1935 = (FStar_Ident.lid_of_path (("FStar")::("Reflection")::("Data")::("exp")::[]) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.tconst uu____1935))
