...
let modules_to_sigtables = (fun ( mods ) -> (let _52_7848 = (Support.List.collect (fun ( _27_37 ) -> (match (_27_37) with
| (_, m) -> begin
...
(let _52_8074 = (Support.Prims.pipe_left (fun ( _52_8073 ) -> Support.Microsoft.FStar.Util.Inl (_52_8073)) (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_52_8074)::[])
end
| Binding_var ((x, t)) -> begin
(let _52_8076 = (Support.Prims.pipe_left (fun ( _52_8075 ) -> Support.Microsoft.FStar.Util.Inr (_52_8075)) (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_52_8076)::[])
end
| Binding_lid (_) -> begin
[]
...
let debug = (fun ( env ) ( l ) -> (let _52_8089 = (let _52_8087 = (Support.ST.read Microsoft_FStar_Options.debug)
in (Support.Prims.pipe_right _52_8087 (Support.Microsoft.FStar.Util.for_some (fun ( x ) -> (env.curmodule.Microsoft_FStar_Absyn_Syntax.str = x)))))
in (let _52_8088 = (Microsoft_FStar_Options.debug_level_geq l)
in (_52_8089 && _52_8088))))

let show = (fun ( env ) -> (let _52_8093 = (Support.ST.read Microsoft_FStar_Options.show_signatures)
in (Support.Prims.pipe_right _52_8093 (Support.Microsoft.FStar.Util.for_some (fun ( x ) -> (env.curmodule.Microsoft_FStar_Absyn_Syntax.str = x))))))
...
let initial_env = (fun ( solver ) ( module_lid ) -> (let _52_8123 = (let _52_8122 = (new_sigtab ())
in (_52_8122)::[])
...
let variable_not_found = (fun ( v ) -> (let _52_8132 = (Microsoft_FStar_Absyn_Print.strBvd v)
...
(let compose_edges = (fun ( e1 ) ( e2 ) -> {msource = e1.msource; mtarget = e2.mtarget; mlift = (fun ( r ) ( wp1 ) -> (let _52_8232 = (e1.mlift r wp1)
in (e2.mlift r _52_8232)))})
in (let mk_lift = (fun ( lift_t ) ( r ) ( wp1 ) -> (let _52_8243 = (let _52_8242 = (let _52_8241 = (Microsoft_FStar_Absyn_Syntax.targ r)
...
in (let print_mlift = (fun ( l ) -> (let arg = (let _52_8260 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("ARG")::[]) Microsoft_FStar_Absyn_Syntax.dummyRange)
...
| true -> begin
(Support.Prims.pipe_right (id_edge i) (fun ( _52_8268 ) -> Some (_52_8268)))
end
| false -> begin
...
in (let order = (Support.Prims.pipe_right ms (Support.List.fold_left (fun ( order ) ( k ) -> (let _52_8276 = (Support.Prims.pipe_right ms (Support.List.collect (fun ( i ) -> (match ((Microsoft_FStar_Absyn_Syntax.lid_equals i k)) with
| true -> begin
[]
end
| false -> begin
...
in (let joins = (Support.Prims.pipe_right ms (Support.List.collect (fun ( i ) -> (Support.Prims.pipe_right ms (Support.List.collect (fun ( j ) -> (let join_opt = (Support.Prims.pipe_right ms (Support.List.fold_left (fun ( bopt ) ( k ) -> (match ((let _52_8284 = (find_edge order (i, k))
...
in (Support.List.iter (fun ( l ) -> (let _52_8297 = (sigtab env)
...
let find_in_sigtab = (fun ( env ) ( lid ) -> (let _52_8334 = (sigtab env)
...
(Support.Microsoft.FStar.Util.find_map ses (fun ( se ) -> (match ((let _52_8359 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt se)
...
(let _52_8434 = (Support.List.map (fun ( l ) -> (let _52_8433 = (lookup_lid env l)
in (l, _52_8433))) datas)
in Some (_52_8434))
end
| _ -> begin
...
in (Support.Prims.pipe_right _52_8476 (fun ( _52_8475 ) -> Some (_52_8475))))
end
...
in (Support.Prims.pipe_right _52_8478 (fun ( _52_8477 ) -> Some (_52_8477))))
end
| _ -> begin
None
end))
...
let uvars_in_env = (fun ( env ) -> (let no_uvs = (let _52_8503 = (Microsoft_FStar_Absyn_Syntax.new_uv_set ())
...
let clear_expected_typ = (fun ( env ) -> (let _52_8531 = (expected_typ env)
in ((let _27_912 = env
...
let idents = (fun ( env ) -> (let _52_8559 = (let _52_8558 = (binders env)
...
in (Support.Microsoft.FStar.Util.smap_fold _52_8569 (fun ( _27_958 ) ( v ) ( keys ) -> (let _52_8568 = (Microsoft_FStar_Absyn_Util.lids_of_sigelt v)
