...
let (delay :
  FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax ->
    (FStar_Syntax_Syntax.subst_elt Prims.list Prims.list,
      FStar_Syntax_Syntax.maybe_set_use_range) FStar_Pervasives_Native.tuple2
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_uvar
        ({ FStar_Syntax_Syntax.ctx_uvar_head = uv;
           ...
           FStar_Syntax_Syntax.ctx_uvar_range = uu____436;_},
         s)
        ->
  ...
  fun t ->
    fun s ->
      ...
      | FStar_Syntax_Syntax.SomeUseRange r ->
          let uu____1015 =
            let uu____1016 = FStar_Range.use_range t.FStar_Syntax_Syntax.pos in
          ...
          then t
            ...
            (let r1 =
               ...
               FStar_Range.set_use_range t.FStar_Syntax_Syntax.pos uu____1022 in
             let t' =
               match t.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_bvar bv ->
                   let uu____1025 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
                   FStar_Syntax_Syntax.Tm_bvar uu____1025
               | FStar_Syntax_Syntax.Tm_name bv ->
                   let uu____1027 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
...
let (subst_binder' :
  ...
  fun s ->
    fun uu____1650 ->
      ...
      | (x, imp) ->
          let uu____1677 =
            let uu___104_1678 = x in
            let uu____1679 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___104_1678.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___104_1678.FStar_Syntax_Syntax.index);
      ...
      let rec aux n1 p1 =
        ...
        | FStar_Syntax_Syntax.Pat_cons (fv, pats) ->
            ...
            (match uu____1956 with
             | (pats1, n2) ->
                 ((let uu___105_2146 = p1 in
                   {
                     FStar_Syntax_Syntax.v =
                       (FStar_Syntax_Syntax.Pat_cons
                          (fv, (FStar_List.rev pats1)));
                     FStar_Syntax_Syntax.p =
                       (uu___105_2146.FStar_Syntax_Syntax.p)
                   }), n2))
        | FStar_Syntax_Syntax.Pat_var x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___106_2170 = x in
              let uu____2171 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___106_2170.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___106_2170.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2171
              } in
            ((let uu___107_2175 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
                FStar_Syntax_Syntax.p = (uu___107_2175.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_wild x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___108_2187 = x in
              let uu____2188 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___108_2187.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___108_2187.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2188
              } in
            ((let uu___109_2192 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
                FStar_Syntax_Syntax.p = (uu___109_2192.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_dot_term (x, t0) ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___110_2209 = x in
              let uu____2210 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___110_2209.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___110_2209.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2210
              } in
            let t01 = subst' s1 t0 in
            ((let uu___111_2215 = p1 in
              {
                FStar_Syntax_Syntax.v =
                  (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
                FStar_Syntax_Syntax.p = (uu___111_2215.FStar_Syntax_Syntax.p)
              }), n1) in
  ...
  fun s ->
    fun lopt ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____2239 =
            let uu___112_2240 = rc in
            let uu____2241 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (subst' s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___112_2240.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____2241;
              FStar_Syntax_Syntax.residual_flags =
                (uu___112_2240.FStar_Syntax_Syntax.residual_flags)
            } in
          ...
          FStar_All.pipe_right u.FStar_Syntax_Syntax.ctx_uvar_binders
            (FStar_Util.for_some
               (fun uu____2288 ->
                  ...
                  | (x', uu____2296) -> FStar_Syntax_Syntax.bv_eq x x')) in
        let rec aux uu___98_2312 =
          match uu___98_2312 with
          | [] -> []
          | hd_subst::rest ->
              let hd1 =
                     ...
                     (fun uu___97_2343 ->
                        ...
                        | FStar_Syntax_Syntax.NM (x, i) ->
                            ...
                            then
                              let x_i =
                                FStar_Syntax_Syntax.bv_to_tm
                                  (let uu___113_2381 = x in
                                   {
                                     FStar_Syntax_Syntax.ppname =
                                       (uu___113_2381.FStar_Syntax_Syntax.ppname);
                                     FStar_Syntax_Syntax.index = i;
                                     FStar_Syntax_Syntax.sort =
                                       (uu___113_2381.FStar_Syntax_Syntax.sort)
                                   }) in
                              let t =
                        ...
                        | uu____2394 -> [])) in
              let uu____2395 = aux rest in FStar_List.append hd1 uu____2395 in
        let uu____2398 =
          aux
    ...
    fun t ->
               ...
               let uu____2598 =
                   ...
                   FStar_Syntax_Syntax.Tm_uvar uu____2605 in
                 {
                   ...
                   FStar_Syntax_Syntax.pos =
                     (uu___114_2601.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___114_2601.FStar_Syntax_Syntax.vars)
                 } in
      ...
      | FStar_Syntax_Syntax.Tm_app (t0, args) ->
          let uu____2691 =
            let uu____2692 =
              ...
              let uu____2712 = subst_args' s args in (uu____2709, uu____2712) in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0, (annot, topt), lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2827 = subst_comp' s c in FStar_Util.Inr uu____2827 in
          let uu____2834 =
            let uu____2835 =
      ...
      | FStar_Syntax_Syntax.Tm_refine (x, phi) ->
          let x1 =
            let uu___115_3102 = x in
            let uu____3103 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___115_3102.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___115_3102.FStar_Syntax_Syntax.index);
              ...
              (FStar_List.map
                 (fun lb ->
                    ...
                    let lbname =
                      ...
                      | FStar_Util.Inl x ->
                          FStar_Util.Inl
                            (let uu___116_3364 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___116_3364.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___116_3364.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = lbt
                             })
                      | FStar_Util.Inr fv -> FStar_Util.Inr fv in
                    let uu___117_3366 = lb in
                    {
                      FStar_Syntax_Syntax.lbname = lbname;
                      FStar_Syntax_Syntax.lbunivs =
                        (uu___117_3366.FStar_Syntax_Syntax.lbunivs);
                      FStar_Syntax_Syntax.lbtyp = lbt;
                      FStar_Syntax_Syntax.lbeff =
                        (uu___117_3366.FStar_Syntax_Syntax.lbeff);
                      FStar_Syntax_Syntax.lbdef = lbd;
                      FStar_Syntax_Syntax.lbattrs =
                        (uu___117_3366.FStar_Syntax_Syntax.lbattrs);
                      FStar_Syntax_Syntax.lbpos =
                        (uu___117_3366.FStar_Syntax_Syntax.lbpos)
                    })) in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let uu____3569 =
            let uu____3570 = let uu____3577 = subst' s t1 in (uu____3577, m) in
...
let (open_binders' :
  ...
  fun bs ->
    let rec aux bs1 o =
      ...
      | (x, imp)::bs' ->
          let x' =
            let uu___118_4007 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4008 = subst o x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___118_4007.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___118_4007.FStar_Syntax_Syntax.index);
          ...
          (match uu____4018 with | (bs'1, o2) -> (((x', imp1) :: bs'1), o2)) in
    aux bs []
let (open_binders :
  FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders) =
  fun bs ->
    ...
    let rec open_pat_aux sub1 p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv, pats) ->
          ...
          (match uu____4302 with
           | (pats1, sub2) ->
               ((let uu___119_4574 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___119_4574.FStar_Syntax_Syntax.p)
                 }), sub2))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x' =
            let uu___120_4593 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4594 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___120_4593.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___120_4593.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4600 in
          ((let uu___121_4608 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x');
              FStar_Syntax_Syntax.p = (uu___121_4608.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x' =
            let uu___122_4613 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4614 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___122_4613.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___122_4613.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4620 in
          ((let uu___123_4628 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x');
              FStar_Syntax_Syntax.p = (uu___123_4628.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_dot_term (x, t0) ->
          let x1 =
            let uu___124_4638 = x in
            let uu____4639 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___124_4638.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___124_4638.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____4639
            } in
          let t01 = subst sub1 t0 in
          ((let uu___125_4648 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___125_4648.FStar_Syntax_Syntax.p)
            }), sub1) in
    open_pat_aux [] p
let (open_branch' :
         ...
         | (p1, opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4714 in
...
let (close :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
  fun bs -> fun t -> let uu____4750 = closing_subst bs in subst uu____4750 t
let (close_comp :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp)
  =
...
let (close_binders :
  ...
  fun bs ->
    let rec aux s bs1 =
      ...
      | (x, imp)::tl1 ->
          let x1 =
            let uu___126_4830 = x in
            let uu____4831 = subst s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___126_4830.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___126_4830.FStar_Syntax_Syntax.index);
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4838 in
          let uu____4841 = aux s' tl1 in (x1, imp1) :: uu____4841 in
    aux [] bs
let (close_lcomp :
  FStar_Syntax_Syntax.binders ->
    ...
    let rec aux sub1 p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv, pats) ->
          ...
          (match uu____4944 with
           | (pats1, sub2) ->
               ((let uu___127_5216 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___127_5216.FStar_Syntax_Syntax.p)
                 }), sub2))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x1 =
            let uu___128_5235 = x in
            let uu____5236 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___128_5235.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___128_5235.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____5242 in
          ((let uu___129_5250 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
              FStar_Syntax_Syntax.p = (uu___129_5250.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x1 =
            let uu___130_5255 = x in
            let uu____5256 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___130_5255.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___130_5255.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____5262 in
          ((let uu___131_5270 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
              FStar_Syntax_Syntax.p = (uu___131_5270.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_dot_term (x, t0) ->
          let x1 =
            let uu___132_5280 = x in
            let uu____5281 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___132_5280.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___132_5280.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____5281
            } in
          let t01 = subst sub1 t0 in
          ((let uu___133_5290 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___133_5290.FStar_Syntax_Syntax.p)
            }), sub1) in
    aux [] p
         ...
         | (p1, closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____5356 in
            ...
            (fun lb ->
               fun uu____5598 ->
                 ...
                 | (i, lbs1, out) ->
                     ...
                     ((i + (Prims.parse_int "1")),
                       ((let uu___134_5637 = lb in
                         {
                           FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___134_5637.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp =
                             (uu___134_5637.FStar_Syntax_Syntax.lbtyp);
                           FStar_Syntax_Syntax.lbeff =
                             (uu___134_5637.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___134_5637.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___134_5637.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___134_5637.FStar_Syntax_Syntax.lbpos)
                    ...
                    | (uu____5744, us, u_let_rec_opening) ->
                            ...
                            lb.FStar_Syntax_Syntax.lbdef in
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___135_5755.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs = us;
                          FStar_Syntax_Syntax.lbtyp = uu____5756;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___135_5755.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = uu____5759;
                          FStar_Syntax_Syntax.lbattrs =
                            (uu___135_5755.FStar_Syntax_Syntax.lbattrs);
                          FStar_Syntax_Syntax.lbpos =
                            (uu___135_5755.FStar_Syntax_Syntax.lbpos)
                        })) in
              ...
              (FStar_List.map
                 (fun lb ->
                    ...
                    | (uu____5915, u_let_rec_closing) ->
                        ...
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___136_5921.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs =
                            (uu___136_5921.FStar_Syntax_Syntax.lbunivs);
                          FStar_Syntax_Syntax.lbtyp = uu____5922;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___136_5921.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = uu____5925;
                          FStar_Syntax_Syntax.lbattrs =
                            (uu___136_5921.FStar_Syntax_Syntax.lbattrs);
                          FStar_Syntax_Syntax.lbpos =
                            (uu___136_5921.FStar_Syntax_Syntax.lbpos)
                        })) in
