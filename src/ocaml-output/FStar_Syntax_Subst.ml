...
in {FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1); FStar_Syntax_Syntax.ty = uu___108_675.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___108_675.FStar_Syntax_Syntax.p})
in (

let fv1 = (

let uu___109_691 = fv
in {FStar_Syntax_Syntax.fv_name = v1; FStar_Syntax_Syntax.fv_delta = uu___109_691.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___109_691.FStar_Syntax_Syntax.fv_qual})
...
let uu___110_693 = t
in {FStar_Syntax_Syntax.n = t'; FStar_Syntax_Syntax.tk = uu___110_693.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu___110_693.FStar_Syntax_Syntax.vars})))
end))
...
let uu___113_1374 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___113_1374.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___113_1374.FStar_Syntax_Syntax.p})), (m)))
end))
end
...
let uu___114_1492 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___114_1492.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___114_1492.FStar_Syntax_Syntax.p})), (n2))
end))
end
...
let uu___116_1514 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___116_1514.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___116_1514.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
let uu___118_1531 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___118_1531.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___118_1531.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
let uu___120_1556 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___120_1556.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___120_1556.FStar_Syntax_Syntax.p})), (n1)))))
end))
...
in {FStar_Syntax_Syntax.ppname = uu___122_2002.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___122_2002.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2003}))
in (
...
let uu___123_2233 = x
in {FStar_Syntax_Syntax.ppname = uu___123_2233.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___123_2233.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
| FStar_Util.Inr (fv) -> begin
FStar_Util.Inr ((

let uu___124_2235 = fv
in {FStar_Syntax_Syntax.fv_name = (

let uu___125_2236 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = uu___125_2236.FStar_Syntax_Syntax.v; FStar_Syntax_Syntax.ty = lbt; FStar_Syntax_Syntax.p = uu___125_2236.FStar_Syntax_Syntax.p}); FStar_Syntax_Syntax.fv_delta = uu___124_2235.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___124_2235.FStar_Syntax_Syntax.fv_qual}))
end)
in (

let uu___126_2251 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___126_2251.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = uu___126_2251.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd})))))))
...
let uu___127_2510 = r
in {FStar_Range.def_range = r.FStar_Range.use_range; FStar_Range.use_range = uu___127_2510.FStar_Range.use_range})))) t))
...
let uu___128_2643 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2644 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___128_2643.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___128_2643.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2644}))
in (
...
in {FStar_Syntax_Syntax.v = uu____2831; FStar_Syntax_Syntax.ty = uu___129_2828.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___129_2828.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(

let yopt = (FStar_Util.find_map renaming (fun uu___106_2894 -> (match (uu___106_2894) with
...
let uu___130_2904 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2905 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___130_2904.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___130_2904.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2905}))
end
| Some (y) -> begin
y
end)
...
let uu___131_2909 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (y); FStar_Syntax_Syntax.ty = uu___131_2909.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___131_2909.FStar_Syntax_Syntax.p})))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___132_2914 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2915 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___132_2914.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___132_2914.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2915}))
in (

let uu___133_2918 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___133_2918.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___133_2918.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___134_2928.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___134_2928.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2929}))
in (

let t01 = (subst sub1 t0)
in (

let uu___135_2933 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___135_2933.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___135_2933.FStar_Syntax_Syntax.p})))
end))
in (
...
let uu___136_3051 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___136_3051.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___136_3051.FStar_Syntax_Syntax.p})), (sub2), (renaming1)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___137_3304 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___137_3304.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___137_3304.FStar_Syntax_Syntax.p})), (sub2), (renaming1))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___138_3318 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3319 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___138_3318.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___138_3318.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3319}))
in (
...
let uu___139_3332 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.ty = uu___139_3332.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___139_3332.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___140_3339 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3340 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___140_3339.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___140_3339.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3340}))
in (
...
let uu___141_3353 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___141_3353.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___141_3353.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___142_3365.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___142_3365.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3366}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___143_3376 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___143_3376.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___143_3376.FStar_Syntax_Syntax.p})), (sub1), (renaming))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___144_3496.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___144_3496.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3497}))
in (
...
let uu___145_3518 = lc
in (

let uu____3519 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___145_3518.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____3519; FStar_Syntax_Syntax.cflags = uu___145_3518.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____3522 -> (
...
let uu___146_3621 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___146_3621.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___146_3621.FStar_Syntax_Syntax.p})), (sub2)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___147_3804 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___147_3804.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___147_3804.FStar_Syntax_Syntax.p})), (sub2))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___148_3818.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___148_3818.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3819}))
in (
...
let uu___149_3829 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___149_3829.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___149_3829.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___150_3834.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___150_3834.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3835}))
in (
...
let uu___151_3845 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___151_3845.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___151_3845.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___152_3855.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___152_3855.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3856}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___153_3863 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___153_3863.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___153_3863.FStar_Syntax_Syntax.p})), (sub1))))
end))
in (aux [] p)))
...
let uu___154_4093 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___154_4093.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___154_4093.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___154_4093.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___154_4093.FStar_Syntax_Syntax.lbdef}))::lbs1), ((FStar_Syntax_Syntax.DB (((i), (x))))::out)))
...
let uu___155_4153 = lb
in (

let uu____4154 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___155_4153.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = uu___155_4153.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___155_4153.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4154}))
end)))))
in (
...
let uu___156_4241 = lb
in (

let uu____4242 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___156_4241.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___156_4241.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___156_4241.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___156_4241.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4242}))
end)))))
in (
