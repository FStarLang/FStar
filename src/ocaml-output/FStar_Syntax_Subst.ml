...
let map_some_curry f x uu___109_101 =
  match uu___109_101 with | None  -> x | Some (a,b) -> f a b
...
let subst_nm:
  ...
  fun a  ->
    fun s  ->
      FStar_Util.find_map s
        (fun uu___111_557  ->
           match uu___111_557 with
           | FStar_Syntax_Syntax.NM (x,i) when FStar_Syntax_Syntax.bv_eq a x
               ->
               let uu____561 =
                 FStar_Syntax_Syntax.bv_to_tm
                   (let uu___115_562 = a in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___115_562.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index = i;
                      FStar_Syntax_Syntax.sort =
                        (uu___115_562.FStar_Syntax_Syntax.sort)
                    }) in
               Some uu____561
  ...
  | Some r ->
      ...
      let t' =
        ...
        | FStar_Syntax_Syntax.Tm_fvar fv ->
            ...
            let v1 =
              let uu___116_665 = fv.FStar_Syntax_Syntax.fv_name in
              {
                FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1);
                FStar_Syntax_Syntax.ty =
                  (uu___116_665.FStar_Syntax_Syntax.ty);
                FStar_Syntax_Syntax.p = (uu___116_665.FStar_Syntax_Syntax.p)
              } in
            let fv1 =
              let uu___117_681 = fv in
              {
                FStar_Syntax_Syntax.fv_name = v1;
                FStar_Syntax_Syntax.fv_delta =
                  (uu___117_681.FStar_Syntax_Syntax.fv_delta);
                FStar_Syntax_Syntax.fv_qual =
                  (uu___117_681.FStar_Syntax_Syntax.fv_qual)
              } in
            FStar_Syntax_Syntax.Tm_fvar fv1
        | t' -> t' in
      let uu___118_683 = t in
      {
        FStar_Syntax_Syntax.n = t';
        FStar_Syntax_Syntax.tk = (uu___118_683.FStar_Syntax_Syntax.tk);
        FStar_Syntax_Syntax.pos = r1;
        FStar_Syntax_Syntax.vars = (uu___118_683.FStar_Syntax_Syntax.vars)
      }
...
let subst_binder' s uu____1179 =
  ...
  | (x,imp) ->
      let uu____1184 =
        let uu___120_1185 = x in
        let uu____1186 = subst' s x.FStar_Syntax_Syntax.sort in
        {
          FStar_Syntax_Syntax.ppname =
            (uu___120_1185.FStar_Syntax_Syntax.ppname);
          FStar_Syntax_Syntax.index =
            (uu___120_1185.FStar_Syntax_Syntax.index);
      ...
      let rec aux n1 p1 =
        ...
        | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
            ...
            (match uu____1358 with
             | (pats1,n2) ->
                 ((let uu___121_1463 = p1 in
                   {
                     FStar_Syntax_Syntax.v =
                       (FStar_Syntax_Syntax.Pat_cons
                          (fv, (FStar_List.rev pats1)));
                     FStar_Syntax_Syntax.ty =
                       (uu___121_1463.FStar_Syntax_Syntax.ty);
                     FStar_Syntax_Syntax.p =
                       (uu___121_1463.FStar_Syntax_Syntax.p)
                   }), n2))
        | FStar_Syntax_Syntax.Pat_var x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___122_1479 = x in
              let uu____1480 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___122_1479.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___122_1479.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____1480
              } in
            ((let uu___123_1485 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
                FStar_Syntax_Syntax.ty =
                  (uu___123_1485.FStar_Syntax_Syntax.ty);
                FStar_Syntax_Syntax.p = (uu___123_1485.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_wild x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___124_1496 = x in
              let uu____1497 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___124_1496.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___124_1496.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____1497
              } in
            ((let uu___125_1502 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
                FStar_Syntax_Syntax.ty =
                  (uu___125_1502.FStar_Syntax_Syntax.ty);
                FStar_Syntax_Syntax.p = (uu___125_1502.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___126_1518 = x in
              let uu____1519 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___126_1518.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___126_1518.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____1519
              } in
            let t01 = subst' s1 t0 in
            ((let uu___127_1527 = p1 in
              {
                FStar_Syntax_Syntax.v =
                  (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
                FStar_Syntax_Syntax.ty =
                  (uu___127_1527.FStar_Syntax_Syntax.ty);
                FStar_Syntax_Syntax.p = (uu___127_1527.FStar_Syntax_Syntax.p)
              }), n1) in
...
let push_subst_lcomp s lopt =
  ...
  | Some (FStar_Util.Inl l) ->
      let uu____1561 =
        let uu____1564 =
          let uu___128_1565 = l in
          let uu____1566 = subst' s l.FStar_Syntax_Syntax.res_typ in
          {
            FStar_Syntax_Syntax.eff_name =
              (uu___128_1565.FStar_Syntax_Syntax.eff_name);
            FStar_Syntax_Syntax.res_typ = uu____1566;
            FStar_Syntax_Syntax.cflags =
              (uu___128_1565.FStar_Syntax_Syntax.cflags);
  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          let x1 =
            let uu___129_1989 = x in
            let uu____1990 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___129_1989.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___129_1989.FStar_Syntax_Syntax.index);
              ...
              (FStar_List.map
                 (fun lb  ->
                    ...
                    let lbname =
                      ...
                      | FStar_Util.Inl x ->
                          FStar_Util.Inl
                            (let uu___130_2223 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___130_2223.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___130_2223.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = lbt
                             })
                      | FStar_Util.Inr fv ->
                          FStar_Util.Inr
                            (let uu___131_2225 = fv in
                             {
                               FStar_Syntax_Syntax.fv_name =
                                 (let uu___132_2226 =
                                  ...
                                  {
                                    FStar_Syntax_Syntax.v =
                                      (uu___132_2226.FStar_Syntax_Syntax.v);
                                    FStar_Syntax_Syntax.ty = lbt;
                                    FStar_Syntax_Syntax.p =
                                      (uu___132_2226.FStar_Syntax_Syntax.p)
                                  });
                               FStar_Syntax_Syntax.fv_delta =
                                 (uu___131_2225.FStar_Syntax_Syntax.fv_delta);
                               FStar_Syntax_Syntax.fv_qual =
                                 (uu___131_2225.FStar_Syntax_Syntax.fv_qual)
                             }) in
                    let uu___133_2241 = lb in
                    {
                      FStar_Syntax_Syntax.lbname = lbname;
                      FStar_Syntax_Syntax.lbunivs =
                        (uu___133_2241.FStar_Syntax_Syntax.lbunivs);
                      FStar_Syntax_Syntax.lbtyp = lbt;
                      FStar_Syntax_Syntax.lbeff =
                        (uu___133_2241.FStar_Syntax_Syntax.lbeff);
  ...
  fun r  ->
    fun t  ->
      subst'
        ([],
          (Some
             (let uu___134_2500 = r in
              {
                FStar_Range.def_range = (r.FStar_Range.use_range);
                FStar_Range.use_range = (uu___134_2500.FStar_Range.use_range)
              }))) t
let subst_comp:
  FStar_Syntax_Syntax.subst_elt Prims.list ->
    FStar_Syntax_Syntax.comp ->
...
let open_binders' bs =
  let rec aux bs1 o =
    ...
    | (x,imp)::bs' ->
        let x' =
          let uu___135_2633 = FStar_Syntax_Syntax.freshen_bv x in
          let uu____2634 = subst o x.FStar_Syntax_Syntax.sort in
          {
            FStar_Syntax_Syntax.ppname =
              (uu___135_2633.FStar_Syntax_Syntax.ppname);
            FStar_Syntax_Syntax.index =
              (uu___135_2633.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____2832 with
           | (pats1,sub2,renaming1) ->
               ((let uu___136_3068 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.ty =
                     (uu___136_3068.FStar_Syntax_Syntax.ty);
                   FStar_Syntax_Syntax.p =
                     (uu___136_3068.FStar_Syntax_Syntax.p)
                 }), sub2, renaming1))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x' =
            let uu___137_3082 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____3083 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___137_3082.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___137_3082.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____3088 in
          ((let uu___138_3096 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x');
              FStar_Syntax_Syntax.ty = (uu___138_3096.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___138_3096.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x' =
            let uu___139_3103 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____3104 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___139_3103.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___139_3103.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____3109 in
          ((let uu___140_3117 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x');
              FStar_Syntax_Syntax.ty = (uu___140_3117.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___140_3117.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___141_3129 = x in
            let uu____3130 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___141_3129.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___141_3129.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____3130
            } in
          let t01 = subst sub1 t0 in
          ((let uu___142_3140 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.ty = (uu___142_3140.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___142_3140.FStar_Syntax_Syntax.p)
            }), sub1, renaming) in
...
let close_binders:
  ...
  fun bs  ->
    let rec aux s bs1 =
      ...
      | (x,imp)::tl1 ->
          let x1 =
            let uu___143_3260 = x in
            let uu____3261 = subst s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___143_3260.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___143_3260.FStar_Syntax_Syntax.index);
...
let close_lcomp:
  ...
  fun bs  ->
    fun lc  ->
      ...
      let uu___144_3282 = lc in
      let uu____3283 = subst s lc.FStar_Syntax_Syntax.res_typ in
      {
        FStar_Syntax_Syntax.eff_name =
          (uu___144_3282.FStar_Syntax_Syntax.eff_name);
        FStar_Syntax_Syntax.res_typ = uu____3283;
        FStar_Syntax_Syntax.cflags =
          (uu___144_3282.FStar_Syntax_Syntax.cflags);
        FStar_Syntax_Syntax.comp =
          (fun uu____3286  ->
    ...
    let rec aux sub1 p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____3339 with
           | (pats1,sub2) ->
               ((let uu___145_3505 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.ty =
                     (uu___145_3505.FStar_Syntax_Syntax.ty);
                   FStar_Syntax_Syntax.p =
                     (uu___145_3505.FStar_Syntax_Syntax.p)
                 }), sub2))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x1 =
            let uu___146_3519 = x in
            let uu____3520 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___146_3519.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___146_3519.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____3525 in
          ((let uu___147_3530 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
              FStar_Syntax_Syntax.ty = (uu___147_3530.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___147_3530.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x1 =
            let uu___148_3535 = x in
            let uu____3536 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___148_3535.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___148_3535.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____3541 in
          ((let uu___149_3546 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
              FStar_Syntax_Syntax.ty = (uu___149_3546.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___149_3546.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___150_3556 = x in
            let uu____3557 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___150_3556.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___150_3556.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____3557
            } in
          let t01 = subst sub1 t0 in
          ((let uu___151_3564 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.ty = (uu___151_3564.FStar_Syntax_Syntax.ty);
              FStar_Syntax_Syntax.p = (uu___151_3564.FStar_Syntax_Syntax.p)
            }), sub1) in
    aux [] p
             ...
             (fun lb  ->
                fun uu____3781  ->
                  ...
                  | (i,lbs1,out) ->
                      ...
                      ((i + (Prims.parse_int "1")),
                        ((let uu___152_3803 = lb in
                          {
                            FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                            FStar_Syntax_Syntax.lbunivs =
                              (uu___152_3803.FStar_Syntax_Syntax.lbunivs);
                            FStar_Syntax_Syntax.lbtyp =
                              (uu___152_3803.FStar_Syntax_Syntax.lbtyp);
                            FStar_Syntax_Syntax.lbeff =
                              (uu___152_3803.FStar_Syntax_Syntax.lbeff);
                            FStar_Syntax_Syntax.lbdef =
                              (uu___152_3803.FStar_Syntax_Syntax.lbdef)
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____3856,us,u_let_rec_opening) ->
                           let uu___153_3863 = lb in
                           let uu____3864 =
                             subst u_let_rec_opening
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___153_3863.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs = us;
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___153_3863.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___153_3863.FStar_Syntax_Syntax.lbeff);
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____3947,u_let_rec_closing) ->
                           let uu___154_3951 = lb in
                           let uu____3952 =
                             subst u_let_rec_closing
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___154_3951.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___154_3951.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___154_3951.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___154_3951.FStar_Syntax_Syntax.lbeff);
