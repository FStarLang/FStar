  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_uvar
        ({ FStar_Syntax_Syntax.ctx_uvar_head = uv;
           ...
           FStar_Syntax_Syntax.ctx_uvar_meta = uu____429;_},
         s)
        ->
  ...
  fun t ->
    fun s ->
      ...
      | FStar_Syntax_Syntax.SomeUseRange r ->
          let uu____808 =
            let uu____810 = FStar_Range.use_range t.FStar_Syntax_Syntax.pos in
          ...
          then t
            ...
            (let r1 =
               ...
               FStar_Range.set_use_range t.FStar_Syntax_Syntax.pos uu____818 in
             let t' =
               match t.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_bvar bv ->
                   let uu____821 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
                   FStar_Syntax_Syntax.Tm_bvar uu____821
               | FStar_Syntax_Syntax.Tm_name bv ->
                   let uu____823 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
          ...
          FStar_All.pipe_right u.FStar_Syntax_Syntax.ctx_uvar_binders
            (FStar_Util.for_some
               (fun uu____2127 ->
                  ...
                  | (x', uu____2136) -> FStar_Syntax_Syntax.bv_eq x x')) in
                ...
                FStar_All.pipe_right hd_subst
                  (FStar_List.collect
                     (fun uu___6_2183 ->
                        ...
                        | uu____2243 -> [])) in
              let uu____2244 = aux rest in FStar_List.append hd uu____2244 in
        let uu____2247 =
          aux
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0, args) ->
          let uu____2540 =
            let uu____2541 =
              ...
              let uu____2561 = subst_args' s args in (uu____2558, uu____2561) in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0, (annot, topt), lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2676 = subst_comp' s c in FStar_Util.Inr uu____2676 in
          let uu____2683 =
            let uu____2684 =
                         ...
                         | (pat1, n) ->
                             ...
                             let wopt1 =
                               ...
                               | FStar_Pervasives_Native.Some w ->
                                   ...
                                   FStar_Pervasives_Native.Some uu____3125 in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let uu____3495 =
            let uu____3496 = let uu____3503 = subst' s t1 in (uu____3503, m) in
  ...
  fun bs ->
    let rec aux bs1 o =
      ...
      | (x, imp)::bs' ->
          ...
          (match uu____3910 with | (bs'1, o2) -> (((x', imp1) :: bs'1), o2)) in
    aux bs []
let (open_binders :
  FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders) =
  fun bs ->
...
let (close :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
  fun bs -> fun t -> let uu____4620 = closing_subst bs in subst uu____4620 t
let (close_comp :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp)
  =
  ...
  fun bs ->
    let rec aux s bs1 =
      ...
      | (x, imp)::tl ->
          ...
          let uu____4716 = aux s' tl in (x1, imp1) :: uu____4716 in
    aux [] bs
let (close_pat :
  FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t ->
    (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t *
