...
let uu___110_964 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1); FStar_Syntax_Syntax.p = uu___110_964.FStar_Syntax_Syntax.p})
in (

let fv1 = (

let uu___111_966 = fv
in {FStar_Syntax_Syntax.fv_name = v1; FStar_Syntax_Syntax.fv_delta = uu___111_966.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___111_966.FStar_Syntax_Syntax.fv_qual})
...
let uu___112_968 = t
in {FStar_Syntax_Syntax.n = t'; FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu___112_968.FStar_Syntax_Syntax.vars})))
end))
...
and subst_flags' : FStar_Syntax_Syntax.subst_ts  ->  FStar_Syntax_Syntax.cflags Prims.list  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun s flags -> (FStar_All.pipe_right flags (FStar_List.map (fun uu___108_1280 -> (match (uu___108_1280) with
...
in {FStar_Syntax_Syntax.ppname = uu___114_1593.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___114_1593.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1594}))
in ((uu____1592), (imp)))
end))
...
let uu___115_2040 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___115_2040.FStar_Syntax_Syntax.p})), (n2))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___116_2066.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___116_2066.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2067}))
in (((

let uu___117_2073 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___117_2073.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___118_2089.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___118_2089.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2090}))
in (((

let uu___119_2096 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___119_2096.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___120_2117.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___120_2117.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2118}))
in (

let t01 = (subst' s1 t0)
in (((

let uu___121_2127 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___121_2127.FStar_Syntax_Syntax.p})), (n1)))))
end))
...
let uu___122_2150 = rc
in (

let uu____2151 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (subst' s))
in {FStar_Syntax_Syntax.residual_effect = uu___122_2150.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____2151; FStar_Syntax_Syntax.residual_flags = uu___122_2150.FStar_Syntax_Syntax.residual_flags}))
...
in {FStar_Syntax_Syntax.ppname = uu___123_2679.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___123_2679.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2680}))
in (
...
let uu___124_3007 = x
in {FStar_Syntax_Syntax.ppname = uu___124_3007.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___124_3007.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
...
let uu___125_3009 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___125_3009.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = uu___125_3009.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd})))))))
...
let uu___126_3567 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3568 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___126_3567.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___126_3567.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3568}))
in (
...
let uu___127_4311 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___127_4311.FStar_Syntax_Syntax.p})), (sub2), (renaming1))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___128_4330 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____4331 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___128_4330.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___128_4330.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4331}))
in (
...
let uu___129_4351 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.p = uu___129_4351.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___130_4360 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____4361 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___130_4360.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___130_4360.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4361}))
in (
...
let uu___131_4381 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.p = uu___131_4381.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___132_4395.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___132_4395.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4396}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___133_4411 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___133_4411.FStar_Syntax_Syntax.p})), (sub1), (renaming))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___134_4583.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___134_4583.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4584}))
in (
...
let uu___135_4615 = lc
in (

let uu____4616 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___135_4615.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____4616; FStar_Syntax_Syntax.cflags = uu___135_4615.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____4621 -> (
...
let uu___136_4965 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___136_4965.FStar_Syntax_Syntax.p})), (sub2))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___137_4984.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___137_4984.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4985}))
in (
...
let uu___138_4999 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___138_4999.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___139_5004.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___139_5004.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5005}))
in (
...
let uu___140_5019 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___140_5019.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___141_5029.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___141_5029.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5030}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___142_5039 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___142_5039.FStar_Syntax_Syntax.p})), (sub1))))
end))
in (aux [] p)))
...
let uu___143_5347 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___143_5347.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___143_5347.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___143_5347.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___143_5347.FStar_Syntax_Syntax.lbdef}))::lbs1), ((FStar_Syntax_Syntax.DB (((i), (x))))::out)))
...
let uu___144_5462 = lb
in (

let uu____5463 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___144_5462.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = uu___144_5462.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___144_5462.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____5463}))
end)))))
in (
...
let uu___145_5622 = lb
in (

let uu____5623 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___145_5622.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___145_5622.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___145_5622.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___145_5622.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____5623}))
end)))))
in (
