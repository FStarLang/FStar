      ...
      | uu____1069 ->
          (match t.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Total (t1,uopt) ->
               ...
               let uu____1086 = FStar_Option.map (subst_univ (fst s)) uopt
                  in
               FStar_Syntax_Syntax.mk_Total' uu____1085 uu____1086
           | FStar_Syntax_Syntax.GTotal (t1,uopt) ->
               let uu____1099 = subst' s t1  in
               let uu____1100 = FStar_Option.map (subst_univ (fst s)) uopt
                  in
            ...
            (match uu____1355 with
             | (p3,m) ->
                 let ps1 =
                   FStar_List.map
                     (fun p4  ->
                        let uu____1369 = aux n1 p4  in fst uu____1369) ps
                    in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0,args) ->
          let uu____1692 =
            let uu____1693 =
              ...
              let uu____1706 = subst_args' s args  in
              (uu____1703, uu____1706)  in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0,(annot,topt),lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____1792 = subst_comp' s c  in
                FStar_Util.Inr uu____1792
             in
          let uu____1799 =
            let uu____1800 =
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
          let uu____2381 =
            let uu____2382 = let uu____2387 = subst' s t1  in (uu____2387, m)
               in
  ...
  let rec aux bs1 o =
    ...
    | (x,imp)::bs' ->
        ...
        let o1 =
          ...
          (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) :: uu____2645
           in
        let uu____2647 = aux bs' o1  in
        (match uu____2647 with | (bs'1,o2) -> (((x', imp) :: bs'1), o2))
     in
  aux bs [] 
let open_binders :
  FStar_Syntax_Syntax.binders ->
        ...
        (match uu____3427 with
         | (p1,opening) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3442 = subst opening w  in Some uu____3442
                in
      ...
      | (x,imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____3498
             in
          let uu____3500 = aux s' tl1  in (x1, imp) :: uu____3500
       in
    aux [] bs
          ...
          (match uu____3575 with
           | (p3,sub2) ->
               let ps1 =
                 FStar_List.map
                   (fun p4  ->
                      let uu____3605 = aux sub2 p4  in fst uu____3605) ps
                  in
        ...
        (match uu____3882 with
         | (p1,closing) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3906 = subst closing w  in Some uu____3906
                in
