  ...
  fun t ->
    fun s ->
      ...
      | FStar_Syntax_Syntax.SomeUseRange r ->
          let uu____1056 =
            let uu____1058 = FStar_Range.use_range t.FStar_Syntax_Syntax.pos in
          ...
          then t
            ...
            (let r1 =
               ...
               FStar_Range.set_use_range t.FStar_Syntax_Syntax.pos uu____1066 in
             let t' =
               match t.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_bvar bv ->
                   let uu____1069 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
                   FStar_Syntax_Syntax.Tm_bvar uu____1069
               | FStar_Syntax_Syntax.Tm_name bv ->
                   let uu____1071 = FStar_Syntax_Syntax.set_range_of_bv bv r1 in
          ...
          FStar_All.pipe_right u.FStar_Syntax_Syntax.ctx_uvar_binders
            (FStar_Util.for_some
               (fun uu____2434 ->
                  ...
                  | (x', uu____2443) -> FStar_Syntax_Syntax.bv_eq x x')) in
                ...
                FStar_All.pipe_right hd_subst
                  (FStar_List.collect
                     (fun uu___6_2490 ->
                        ...
                        | uu____2550 -> [])) in
              let uu____2551 = aux rest in FStar_List.append hd1 uu____2551 in
        let uu____2554 =
          aux
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0, args) ->
          let uu____2849 =
            let uu____2850 =
              ...
              let uu____2870 = subst_args' s args in (uu____2867, uu____2870) in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0, (annot, topt), lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2985 = subst_comp' s c in FStar_Util.Inr uu____2985 in
          let uu____2992 =
            let uu____2993 =
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let uu____3794 =
            let uu____3795 = let uu____3802 = subst' s t1 in (uu____3802, m) in
  ...
  fun bs ->
    let rec aux bs1 o =
      ...
      | (x, imp)::bs' ->
          ...
          (match uu____4249 with | (bs'1, o2) -> (((x', imp1) :: bs'1), o2)) in
    aux bs []
let (open_binders :
  FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders) =
  fun bs ->
         ...
         | (p1, opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4985 in
...
let (close :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
  fun bs -> fun t -> let uu____5023 = closing_subst bs in subst uu____5023 t
let (close_comp :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp)
  =
      ...
      | (x, imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____5113 in
          let uu____5119 = aux s' tl1 in (x1, imp1) :: uu____5119 in
    aux [] bs
let (close_lcomp :
  FStar_Syntax_Syntax.binders ->
         ...
         | (p1, closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____5671 in
