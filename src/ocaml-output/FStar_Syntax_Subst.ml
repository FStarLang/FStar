...
let subst_nm:
  ...
  fun a  ->
    fun s  ->
      FStar_Util.find_map s
        (fun uu___152_812  ->
           match uu___152_812 with
           | FStar_Syntax_Syntax.NM (x,i) when FStar_Syntax_Syntax.bv_eq a x
               ->
               let uu____817 =
                 FStar_Syntax_Syntax.bv_to_tm
                   (let uu___156_820 = a in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___156_820.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index = i;
                      FStar_Syntax_Syntax.sort =
                        (uu___156_820.FStar_Syntax_Syntax.sort)
                    }) in
      ...
      | FStar_Pervasives_Native.Some r ->
          ...
          let t' =
            ...
            | FStar_Syntax_Syntax.Tm_fvar fv ->
                ...
                let v1 =
                  let uu___157_964 = fv.FStar_Syntax_Syntax.fv_name in
                  {
                    FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1);
                    FStar_Syntax_Syntax.p =
                      (uu___157_964.FStar_Syntax_Syntax.p)
                  } in
                let fv1 =
                  let uu___158_966 = fv in
                  {
                    FStar_Syntax_Syntax.fv_name = v1;
                    FStar_Syntax_Syntax.fv_delta =
                      (uu___158_966.FStar_Syntax_Syntax.fv_delta);
                    FStar_Syntax_Syntax.fv_qual =
                      (uu___158_966.FStar_Syntax_Syntax.fv_qual)
                  } in
                FStar_Syntax_Syntax.Tm_fvar fv1
            | t' -> t' in
          let uu___159_968 = t in
          {
            FStar_Syntax_Syntax.n = t';
            FStar_Syntax_Syntax.pos = r1;
            FStar_Syntax_Syntax.vars =
              (uu___159_968.FStar_Syntax_Syntax.vars)
          }
...
let subst_binder':
  ...
  fun s  ->
    fun uu____1585  ->
      ...
      | (x,imp) ->
          let uu____1592 =
            let uu___161_1593 = x in
            let uu____1594 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___161_1593.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___161_1593.FStar_Syntax_Syntax.index);
      ...
      let rec aux n1 p1 =
        ...
        | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
            ...
            (match uu____1848 with
             | (pats1,n2) ->
                 ((let uu___162_2040 = p1 in
                   {
                     FStar_Syntax_Syntax.v =
                       (FStar_Syntax_Syntax.Pat_cons
                          (fv, (FStar_List.rev pats1)));
                     FStar_Syntax_Syntax.p =
                       (uu___162_2040.FStar_Syntax_Syntax.p)
                   }), n2))
        | FStar_Syntax_Syntax.Pat_var x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___163_2066 = x in
              let uu____2067 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___163_2066.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___163_2066.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2067
              } in
            ((let uu___164_2073 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
                FStar_Syntax_Syntax.p = (uu___164_2073.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_wild x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___165_2089 = x in
              let uu____2090 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___165_2089.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___165_2089.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2090
              } in
            ((let uu___166_2096 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
                FStar_Syntax_Syntax.p = (uu___166_2096.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___167_2117 = x in
              let uu____2118 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___167_2117.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___167_2117.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2118
              } in
            let t01 = subst' s1 t0 in
            ((let uu___168_2127 = p1 in
              {
                FStar_Syntax_Syntax.v =
                  (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
                FStar_Syntax_Syntax.p = (uu___168_2127.FStar_Syntax_Syntax.p)
              }), n1) in
  ...
  fun s  ->
    fun lopt  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____2149 =
            let uu___169_2150 = rc in
            let uu____2151 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (subst' s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___169_2150.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____2151;
              FStar_Syntax_Syntax.residual_flags =
                (uu___169_2150.FStar_Syntax_Syntax.residual_flags)
            } in
  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          let x1 =
            let uu___170_2679 = x in
            let uu____2680 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___170_2679.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___170_2679.FStar_Syntax_Syntax.index);
              ...
              (FStar_List.map
                 (fun lb  ->
                    ...
                    let lbname =
                      ...
                      | FStar_Util.Inl x ->
                          FStar_Util.Inl
                            (let uu___171_3007 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___171_3007.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___171_3007.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = lbt
                             })
                      | FStar_Util.Inr fv -> FStar_Util.Inr fv in
                    let uu___172_3009 = lb in
                    {
                      FStar_Syntax_Syntax.lbname = lbname;
                      FStar_Syntax_Syntax.lbunivs =
                        (uu___172_3009.FStar_Syntax_Syntax.lbunivs);
                      FStar_Syntax_Syntax.lbtyp = lbt;
                      FStar_Syntax_Syntax.lbeff =
                        (uu___172_3009.FStar_Syntax_Syntax.lbeff);
...
let open_binders':
  ...
  fun bs  ->
    let rec aux bs1 o =
      ...
      | (x,imp)::bs' ->
          let x' =
            let uu___173_3567 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____3568 = subst o x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___173_3567.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___173_3567.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____3900 with
           | (pats1,sub2,renaming1) ->
               ((let uu___174_4311 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___174_4311.FStar_Syntax_Syntax.p)
                 }), sub2, renaming1))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x' =
            let uu___175_4330 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4331 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___175_4330.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___175_4330.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4337 in
          ((let uu___176_4351 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x');
              FStar_Syntax_Syntax.p = (uu___176_4351.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x' =
            let uu___177_4360 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4361 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___177_4360.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___177_4360.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4367 in
          ((let uu___178_4381 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x');
              FStar_Syntax_Syntax.p = (uu___178_4381.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___179_4395 = x in
            let uu____4396 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___179_4395.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___179_4395.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____4396
            } in
          let t01 = subst sub1 t0 in
          ((let uu___180_4411 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___180_4411.FStar_Syntax_Syntax.p)
            }), sub1, renaming) in
...
let close_binders: FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders
  ...
  fun bs  ->
    let rec aux s bs1 =
      ...
      | (x,imp)::tl1 ->
          let x1 =
            let uu___181_4583 = x in
            let uu____4584 = subst s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___181_4583.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___181_4583.FStar_Syntax_Syntax.index);
...
let close_lcomp:
  ...
  fun bs  ->
    fun lc  ->
      ...
      let uu___182_4615 = lc in
      let uu____4616 = subst s lc.FStar_Syntax_Syntax.res_typ in
      {
        FStar_Syntax_Syntax.eff_name =
          (uu___182_4615.FStar_Syntax_Syntax.eff_name);
        FStar_Syntax_Syntax.res_typ = uu____4616;
        FStar_Syntax_Syntax.cflags =
          (uu___182_4615.FStar_Syntax_Syntax.cflags);
        FStar_Syntax_Syntax.comp =
          (fun uu____4621  ->
    ...
    let rec aux sub1 p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____4693 with
           | (pats1,sub2) ->
               ((let uu___183_4965 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___183_4965.FStar_Syntax_Syntax.p)
                 }), sub2))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x1 =
            let uu___184_4984 = x in
            let uu____4985 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___184_4984.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___184_4984.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4991 in
          ((let uu___185_4999 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
              FStar_Syntax_Syntax.p = (uu___185_4999.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x1 =
            let uu___186_5004 = x in
            let uu____5005 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___186_5004.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___186_5004.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____5011 in
          ((let uu___187_5019 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
              FStar_Syntax_Syntax.p = (uu___187_5019.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___188_5029 = x in
            let uu____5030 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___188_5029.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___188_5029.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____5030
            } in
          let t01 = subst sub1 t0 in
          ((let uu___189_5039 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___189_5039.FStar_Syntax_Syntax.p)
            }), sub1) in
    aux [] p
             ...
             (fun lb  ->
                fun uu____5308  ->
                  ...
                  | (i,lbs1,out) ->
                      ...
                      ((i + (Prims.parse_int "1")),
                        ((let uu___190_5347 = lb in
                          {
                            FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                            FStar_Syntax_Syntax.lbunivs =
                              (uu___190_5347.FStar_Syntax_Syntax.lbunivs);
                            FStar_Syntax_Syntax.lbtyp =
                              (uu___190_5347.FStar_Syntax_Syntax.lbtyp);
                            FStar_Syntax_Syntax.lbeff =
                              (uu___190_5347.FStar_Syntax_Syntax.lbeff);
                            FStar_Syntax_Syntax.lbdef =
                              (uu___190_5347.FStar_Syntax_Syntax.lbdef)
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____5451,us,u_let_rec_opening) ->
                           let uu___191_5462 = lb in
                           let uu____5463 =
                             subst u_let_rec_opening
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___191_5462.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs = us;
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___191_5462.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___191_5462.FStar_Syntax_Syntax.lbeff);
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____5616,u_let_rec_closing) ->
                           let uu___192_5622 = lb in
                           let uu____5623 =
                             subst u_let_rec_closing
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___192_5622.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___192_5622.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___192_5622.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___192_5622.FStar_Syntax_Syntax.lbeff);
