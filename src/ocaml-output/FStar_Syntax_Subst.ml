...
let subst_binders' : 'Auu____1544 . FStar_Syntax_Syntax.subst_ts  ->  (FStar_Syntax_Syntax.bv * 'Auu____1544) Prims.list  ->  (FStar_Syntax_Syntax.bv * 'Auu____1544) Prims.list = (fun s bs -> (FStar_All.pipe_right bs (FStar_List.mapi (fun i b -> (match ((i = (Prims.parse_int "0"))) with
| true -> begin
(subst_binder' s b)
end
| uu____1603 -> begin
