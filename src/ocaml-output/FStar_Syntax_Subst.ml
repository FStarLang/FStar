...
let open_let_rec :
  ...
  fun lbs  ->
    fun t  ->
      let uu____4111 = FStar_Syntax_Syntax.is_top_level lbs  in
      if uu____4111
      then (lbs, t)
      else
        (let uu____4117 =
                ...
                fun uu____4129  ->
                  ...
                  | (i,lbs1,out) ->
                      let x =
                        ...
                        FStar_Syntax_Syntax.freshen_bv uu____4148  in
                      ((i + (Prims.parse_int "1")),
                        ((let uu___155_4151 = lb  in
                          {
                            FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                            FStar_Syntax_Syntax.lbunivs =
                              (uu___155_4151.FStar_Syntax_Syntax.lbunivs);
                            FStar_Syntax_Syntax.lbtyp =
                              (uu___155_4151.FStar_Syntax_Syntax.lbtyp);
                            FStar_Syntax_Syntax.lbeff =
                              (uu___155_4151.FStar_Syntax_Syntax.lbeff);
                            FStar_Syntax_Syntax.lbdef =
                              (uu___155_4151.FStar_Syntax_Syntax.lbdef)
               ...
               FStar_All.pipe_right lbs1
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____4204,us,u_let_rec_opening) ->
                           let uu___156_4211 = lb  in
                           let uu____4212 =
                              ...
                              in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___156_4211.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs = us;
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___156_4211.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___156_4211.FStar_Syntax_Syntax.lbeff);
                             FStar_Syntax_Syntax.lbdef = uu____4212
                           }))
                in
...
let close_let_rec :
  ...
  fun lbs  ->
    fun t  ->
      let uu____4228 = FStar_Syntax_Syntax.is_top_level lbs  in
      if uu____4228
      then (lbs, t)
      else
        (let uu____4234 =
                          ...
                          let uu____4256 =
                            let uu____4259 =
                              FStar_Util.left lb.FStar_Syntax_Syntax.lbname
                               in
                            (uu____4259, i)  in
                          FStar_Syntax_Syntax.NM uu____4256  in
                        uu____4255 :: out  in
                      ((i + (Prims.parse_int "1")), uu____4253)) lbs
             ((Prims.parse_int "0"), [])
            in
               ...
               FStar_All.pipe_right lbs
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____4295,u_let_rec_closing) ->
                           let uu___157_4299 = lb  in
                           let uu____4300 =
                           ...
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___157_4299.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___157_4299.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___157_4299.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___157_4299.FStar_Syntax_Syntax.lbeff);
                             FStar_Syntax_Syntax.lbdef = uu____4300
                           }))
                in
      ...
      | (us',t) ->
          ...
          let s =
            FStar_List.mapi
              ...
              us
             in
          let uu____4361 = subst s t  in (us', uu____4361)
