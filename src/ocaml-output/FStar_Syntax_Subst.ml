      ...
      | uu____1085 ->
          (match t.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Total (t1,uopt) ->
               ...
               let uu____1102 = FStar_Option.map (subst_univ (fst s)) uopt
                  in
               FStar_Syntax_Syntax.mk_Total' uu____1101 uu____1102
           | FStar_Syntax_Syntax.GTotal (t1,uopt) ->
               let uu____1115 = subst' s t1  in
               let uu____1116 = FStar_Option.map (subst_univ (fst s)) uopt
                  in
        ...
        (match uu____3198 with
         | (p1,opening) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3213 = subst opening w  in Some uu____3213
                in
        ...
        (match uu____3590 with
         | (p1,closing) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3614 = subst closing w  in Some uu____3614
                in
