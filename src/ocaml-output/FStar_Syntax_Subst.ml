...
let subst_bv : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term Prims.option = (fun a s -> (FStar_Util.find_map s (fun uu___100_552 -> (match (uu___100_552) with
...
let subst_nm : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term Prims.option = (fun a s -> (FStar_Util.find_map s (fun uu___101_569 -> (match (uu___101_569) with
...
let uu___106_574 = a
in {FStar_Syntax_Syntax.ppname = uu___106_574.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___106_574.FStar_Syntax_Syntax.sort}))
in Some (uu____573))
end
...
let subst_univ_bv : Prims.int  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe Prims.option = (fun x s -> (FStar_Util.find_map s (fun uu___102_593 -> (match (uu___102_593) with
...
let subst_univ_nm : FStar_Syntax_Syntax.univ_name  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe Prims.option = (fun x s -> (FStar_Util.find_map s (fun uu___103_607 -> (match (uu___103_607) with
...
let uu___107_675 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r); FStar_Syntax_Syntax.ty = uu___107_675.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___107_675.FStar_Syntax_Syntax.p})
in (

let fv = (

let uu___108_691 = fv
in {FStar_Syntax_Syntax.fv_name = v; FStar_Syntax_Syntax.fv_delta = uu___108_691.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___108_691.FStar_Syntax_Syntax.fv_qual})
...
let uu___109_693 = t
in {FStar_Syntax_Syntax.n = t'; FStar_Syntax_Syntax.tk = uu___109_693.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___109_693.FStar_Syntax_Syntax.vars})))
end))
...
and subst_flags' : FStar_Syntax_Syntax.subst_ts  ->  FStar_Syntax_Syntax.cflags Prims.list  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun s flags -> (FStar_All.pipe_right flags (FStar_List.map (fun uu___104_972 -> (match (uu___104_972) with
...
in {FStar_Syntax_Syntax.ppname = uu___111_1181.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___111_1181.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1182}))
in ((uu____1180), (imp)))
end))
...
let uu___112_1374 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p)::ps); FStar_Syntax_Syntax.ty = uu___112_1374.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___112_1374.FStar_Syntax_Syntax.p})), (m)))
end))
end
...
let uu___113_1492 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___113_1492.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___113_1492.FStar_Syntax_Syntax.p})), (n))
end))
end
...
let uu___115_1514 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___115_1514.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___115_1514.FStar_Syntax_Syntax.p})), ((n + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___116_1525.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___116_1525.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1526}))
in (((

let uu___117_1531 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___117_1531.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___117_1531.FStar_Syntax_Syntax.p})), ((n + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___118_1547.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___118_1547.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1548}))
in (
...
let uu___119_1556 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t0))); FStar_Syntax_Syntax.ty = uu___119_1556.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___119_1556.FStar_Syntax_Syntax.p})), (n)))))
end))
...
in {FStar_Syntax_Syntax.eff_name = uu___120_1594.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____1595; FStar_Syntax_Syntax.cflags = uu___120_1594.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____1598 -> (
...
in {FStar_Syntax_Syntax.ppname = uu___121_1979.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___121_1979.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1980}))
in (
...
let uu___122_2210 = x
in {FStar_Syntax_Syntax.ppname = uu___122_2210.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___122_2210.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
| FStar_Util.Inr (fv) -> begin
FStar_Util.Inr ((

let uu___123_2212 = fv
in {FStar_Syntax_Syntax.fv_name = (

let uu___124_2213 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = uu___124_2213.FStar_Syntax_Syntax.v; FStar_Syntax_Syntax.ty = lbt; FStar_Syntax_Syntax.p = uu___124_2213.FStar_Syntax_Syntax.p}); FStar_Syntax_Syntax.fv_delta = uu___123_2212.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___123_2212.FStar_Syntax_Syntax.fv_qual}))
end)
in (

let uu___125_2228 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___125_2228.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = uu___125_2228.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd})))))))
...
let uu___126_2487 = r
in {FStar_Range.def_range = r.FStar_Range.use_range; FStar_Range.use_range = uu___126_2487.FStar_Range.use_range})))) t))
...
let uu___127_2620 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2621 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___127_2620.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___127_2620.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2621}))
in (
...
in {FStar_Syntax_Syntax.v = uu____2808; FStar_Syntax_Syntax.ty = uu___128_2805.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___128_2805.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(

let yopt = (FStar_Util.find_map renaming (fun uu___105_2871 -> (match (uu___105_2871) with
...
let uu___129_2881 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2882 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___129_2881.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___129_2881.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2882}))
end
| Some (y) -> begin
y
end)
...
let uu___130_2886 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (y); FStar_Syntax_Syntax.ty = uu___130_2886.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___130_2886.FStar_Syntax_Syntax.p})))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___131_2891 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2892 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___131_2891.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___131_2891.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2892}))
in (

let uu___132_2895 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___132_2895.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___132_2895.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___133_2905.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___133_2905.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2906}))
in (
...
let uu___134_2910 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t0))); FStar_Syntax_Syntax.ty = uu___134_2910.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___134_2910.FStar_Syntax_Syntax.p})))
end))
in (
...
let uu___135_3028 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p)::ps); FStar_Syntax_Syntax.ty = uu___135_3028.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___135_3028.FStar_Syntax_Syntax.p})), (sub), (renaming)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___136_3281 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___136_3281.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___136_3281.FStar_Syntax_Syntax.p})), (sub), (renaming))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___137_3295 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3296 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___137_3295.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___137_3295.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3296}))
in (
...
let uu___138_3309 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.ty = uu___138_3309.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___138_3309.FStar_Syntax_Syntax.p})), (sub), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___139_3316 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3317 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___139_3316.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___139_3316.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3317}))
in (
...
let uu___140_3330 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___140_3330.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___140_3330.FStar_Syntax_Syntax.p})), (sub), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___141_3342.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___141_3342.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3343}))
in (
...
let uu___142_3353 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t0))); FStar_Syntax_Syntax.ty = uu___142_3353.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___142_3353.FStar_Syntax_Syntax.p})), (sub), (renaming))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___143_3473.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___143_3473.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3474}))
in (
...
let uu___144_3495 = lc
in (

let uu____3496 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___144_3495.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____3496; FStar_Syntax_Syntax.cflags = uu___144_3495.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____3499 -> (
...
let uu___145_3598 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p)::ps); FStar_Syntax_Syntax.ty = uu___145_3598.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___145_3598.FStar_Syntax_Syntax.p})), (sub)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___146_3781 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___146_3781.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___146_3781.FStar_Syntax_Syntax.p})), (sub))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___147_3795.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___147_3795.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3796}))
in (
...
let uu___148_3806 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___148_3806.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___148_3806.FStar_Syntax_Syntax.p})), (sub))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___149_3811.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___149_3811.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3812}))
in (
...
let uu___150_3822 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___150_3822.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___150_3822.FStar_Syntax_Syntax.p})), (sub))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___151_3832.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_3832.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3833}))
in (
...
let uu___152_3840 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t0))); FStar_Syntax_Syntax.ty = uu___152_3840.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___152_3840.FStar_Syntax_Syntax.p})), (sub))))
end))
in (aux [] p)))
...
let uu___153_4070 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___153_4070.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___153_4070.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___153_4070.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___153_4070.FStar_Syntax_Syntax.lbdef}))::lbs), ((FStar_Syntax_Syntax.DB (((i), (x))))::out)))
...
let uu___154_4130 = lb
in (

let uu____4131 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___154_4130.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = uu___154_4130.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___154_4130.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4131}))
end)))))
in (
...
let uu___155_4218 = lb
in (

let uu____4219 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___155_4218.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___155_4218.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___155_4218.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___155_4218.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4219}))
end)))))
in (
