...
(let _116_174 = (let _116_173 = (let _116_172 = (subst' s t0)
in (let _116_171 = (let _116_170 = (subst' s t1)
in FStar_Util.Inl (_116_170))
in (_116_172, _116_171, lopt)))
in FStar_Syntax_Syntax.Tm_ascribed (_116_173))
in (FStar_Syntax_Syntax.mk _116_174 None t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_ascribed (t0, FStar_Util.Inr (c), lopt) -> begin
(let _116_179 = (let _116_178 = (let _116_177 = (subst' s t0)
in (let _116_176 = (let _116_175 = (subst_comp' s c)
in FStar_Util.Inr (_116_175))
in (_116_177, _116_176, lopt)))
in FStar_Syntax_Syntax.Tm_ascribed (_116_178))
in (FStar_Syntax_Syntax.mk _116_179 None t.FStar_Syntax_Syntax.pos))
end
...
let s' = (shift_subst' n s)
in (let _116_184 = (let _116_183 = (let _116_182 = (subst_binders' s bs)
in (let _116_181 = (subst' s' body)
in (let _116_180 = (push_subst_lcomp s' lopt)
in (_116_182, _116_181, _116_180))))
in FStar_Syntax_Syntax.Tm_abs (_116_183))
in (FStar_Syntax_Syntax.mk _116_184 None t.FStar_Syntax_Syntax.pos))))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, comp) -> begin
(
# 280 "FStar.Syntax.Subst.fst"
let n = (FStar_List.length bs)
in (let _116_189 = (let _116_188 = (let _116_187 = (subst_binders' s bs)
in (let _116_186 = (let _116_185 = (shift_subst' n s)
in (subst_comp' _116_185 comp))
in (_116_187, _116_186)))
in FStar_Syntax_Syntax.Tm_arrow (_116_188))
in (FStar_Syntax_Syntax.mk _116_189 None t.FStar_Syntax_Syntax.pos)))
end
...
# 284 "FStar.Syntax.Subst.fst"
let _31_380 = x
in (let _116_190 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_380.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_380.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_190}))
in (
# 285 "FStar.Syntax.Subst.fst"
let phi = (let _116_191 = (shift_subst' 1 s)
in (subst' _116_191 phi))
...
let pats = (FStar_All.pipe_right pats (FStar_List.map (fun _31_392 -> (match (_31_392) with
| (pat, wopt, branch) -> begin
(
# 291 "FStar.Syntax.Subst.fst"
let _31_395 = (subst_pat' s pat)
...
let _31_417 = x
in {FStar_Syntax_Syntax.ppname = _31_417.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_417.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
...
# 311 "FStar.Syntax.Subst.fst"
let _31_423 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = _31_423.FStar_Syntax_Syntax.v; FStar_Syntax_Syntax.ty = lbt; FStar_Syntax_Syntax.p = _31_423.FStar_Syntax_Syntax.p}); FStar_Syntax_Syntax.fv_delta = _31_421.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _31_421.FStar_Syntax_Syntax.fv_qual}))
end)
in (
# 312 "FStar.Syntax.Subst.fst"
let _31_426 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = _31_426.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = _31_426.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd})))))))
...
(let _116_199 = (let _116_198 = (let _116_197 = (subst' s t0)
in (let _116_196 = (let _116_195 = (FStar_All.pipe_right ps (FStar_List.map (subst_args' s)))
in FStar_Syntax_Syntax.Meta_pattern (_116_195))
in (_116_197, _116_196)))
in FStar_Syntax_Syntax.Tm_meta (_116_198))
in (FStar_Syntax_Syntax.mk _116_199 None t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t, m) -> begin
(let _116_202 = (let _116_201 = (let _116_200 = (subst' s t)
in (_116_200, m))
in FStar_Syntax_Syntax.Tm_meta (_116_201))
in (FStar_Syntax_Syntax.mk _116_202 None t.FStar_Syntax_Syntax.pos))
end))
...
let t' = (let _116_205 = (push_subst s t)
in (compress _116_205))
in (
# 326 "FStar.Syntax.Subst.fst"
let _31_448 = (FStar_Unionfind.update_in_tx memo (Some (t')))
in t'))
end
| _31_451 -> begin
(force_uvar t)
...
let closing_subst = (fun bs -> (let _116_217 = (FStar_List.fold_right (fun _31_460 _31_463 -> (match ((_31_460, _31_463)) with
| ((x, _31_459), (subst, n)) -> begin
((FStar_Syntax_Syntax.NM ((x, n)))::subst, (n + 1))
end)) bs ([], 0))
in (FStar_All.pipe_right _116_217 Prims.fst)))
...
let x' = (
# 340 "FStar.Syntax.Subst.fst"
let _31_474 = (FStar_Syntax_Syntax.freshen_bv x)
in (let _116_223 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_474.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_474.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_223}))
in (
# 341 "FStar.Syntax.Subst.fst"
let o = (let _116_224 = (shift_subst 1 o)
in (FStar_Syntax_Syntax.DB ((0, x')))::_116_224)
in (
# 342 "FStar.Syntax.Subst.fst"
let _31_480 = (aux bs' o)
...
let open_binders : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun bs -> (let _116_227 = (open_binders' bs)
in (Prims.fst _116_227)))
...
let _31_486 = (open_binders' bs)
in (match (_31_486) with
| (bs', opening) -> begin
(let _116_232 = (subst opening t)
in (bs', _116_232, opening))
end)))
...
let _31_493 = (open_term' bs t)
in (match (_31_493) with
| (b, t, _31_492) -> begin
(b, t)
end)))
...
let _31_498 = (open_binders' bs)
in (match (_31_498) with
| (bs', opening) -> begin
(let _116_241 = (subst_comp opening t)
in (bs', _116_241))
end)))
...
| FStar_Syntax_Syntax.Pat_disj (_31_505) -> begin
(FStar_All.failwith "impossible")
end
| FStar_Syntax_Syntax.Pat_constant (_31_508) -> begin
p
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let _31_514 = p
in (let _116_254 = (let _116_253 = (let _116_252 = (FStar_All.pipe_right pats (FStar_List.map (fun _31_518 -> (match (_31_518) with
| (p, b) -> begin
(let _116_251 = (aux_disj sub renaming p)
in (_116_251, b))
end))))
in (fv, _116_252))
in FStar_Syntax_Syntax.Pat_cons (_116_253))
in {FStar_Syntax_Syntax.v = _116_254; FStar_Syntax_Syntax.ty = _31_514.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_514.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in (let _116_256 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_529.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_529.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_256}))
end
| Some (y) -> begin
y
end)
...
let _31_534 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (y); FStar_Syntax_Syntax.ty = _31_534.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_534.FStar_Syntax_Syntax.p})))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let x' = (
# 378 "FStar.Syntax.Subst.fst"
let _31_538 = (FStar_Syntax_Syntax.freshen_bv x)
in (let _116_257 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_538.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_538.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_257}))
in (
# 379 "FStar.Syntax.Subst.fst"
let _31_541 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = _31_541.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_541.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
# 382 "FStar.Syntax.Subst.fst"
let _31_547 = x
in (let _116_258 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_547.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_547.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_258}))
in (
...
let _31_551 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term ((x, t0)); FStar_Syntax_Syntax.ty = _31_551.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_551.FStar_Syntax_Syntax.p})))
end))
in (
...
| FStar_Syntax_Syntax.Pat_constant (_31_560) -> begin
(p, sub, renaming)
end
| FStar_Syntax_Syntax.Pat_disj (p::ps) -> begin
(
...
let _31_571 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p)::ps); FStar_Syntax_Syntax.ty = _31_571.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_571.FStar_Syntax_Syntax.p}), sub, renaming))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
# 397 "FStar.Syntax.Subst.fst"
let _31_591 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _31_580 _31_583 -> (match ((_31_580, _31_583)) with
| ((pats, sub, renaming), (p, imp)) -> begin
(
# 398 "FStar.Syntax.Subst.fst"
let _31_587 = (aux sub renaming p)
in (match (_31_587) with
| (p, sub, renaming) -> begin
(((p, imp))::pats, sub, renaming)
end))
end)) ([], sub, renaming)))
in (match (_31_591) with
| (pats, sub, renaming) -> begin
((
# 400 "FStar.Syntax.Subst.fst"
let _31_592 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons ((fv, (FStar_List.rev pats))); FStar_Syntax_Syntax.ty = _31_592.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_592.FStar_Syntax_Syntax.p}), sub, renaming)
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let x' = (
# 403 "FStar.Syntax.Subst.fst"
let _31_596 = (FStar_Syntax_Syntax.freshen_bv x)
in (let _116_267 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_596.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_596.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_267}))
in (
# 404 "FStar.Syntax.Subst.fst"
let sub = (let _116_268 = (shift_subst 1 sub)
in (FStar_Syntax_Syntax.DB ((0, x')))::_116_268)
in ((
# 405 "FStar.Syntax.Subst.fst"
let _31_600 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.ty = _31_600.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_600.FStar_Syntax_Syntax.p}), sub, ((x, x'))::renaming)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let x' = (
# 408 "FStar.Syntax.Subst.fst"
let _31_604 = (FStar_Syntax_Syntax.freshen_bv x)
in (let _116_269 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_604.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_604.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_269}))
in (
# 409 "FStar.Syntax.Subst.fst"
let sub = (let _116_270 = (shift_subst 1 sub)
in (FStar_Syntax_Syntax.DB ((0, x')))::_116_270)
in ((
# 410 "FStar.Syntax.Subst.fst"
let _31_608 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = _31_608.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_608.FStar_Syntax_Syntax.p}), sub, ((x, x'))::renaming)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
# 413 "FStar.Syntax.Subst.fst"
let _31_614 = x
in (let _116_271 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_614.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_614.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_271}))
in (
...
let _31_618 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term ((x, t0)); FStar_Syntax_Syntax.ty = _31_618.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_618.FStar_Syntax_Syntax.p}), sub, renaming)))
end))
in (
...
let open_branch : FStar_Syntax_Syntax.branch  ->  FStar_Syntax_Syntax.branch = (fun _31_628 -> (match (_31_628) with
| (p, wopt, e) -> begin
(
# 421 "FStar.Syntax.Subst.fst"
let _31_631 = (open_pat p)
in (match (_31_631) with
| (p, opening) -> begin
(
...
let close : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun bs t -> (let _116_279 = (closing_subst bs)
in (subst _116_279 t)))

# 429 "FStar.Syntax.Subst.fst"
let close_comp : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun bs c -> (let _116_284 = (closing_subst bs)
in (subst_comp _116_284 c)))
...
# 434 "FStar.Syntax.Subst.fst"
let _31_651 = x
in (let _116_291 = (subst s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_651.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_651.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_291}))
in (
# 435 "FStar.Syntax.Subst.fst"
let s' = (let _116_292 = (shift_subst 1 s)
in (FStar_Syntax_Syntax.NM ((x, 0)))::_116_292)
in (let _116_293 = (aux s' tl)
in ((x, imp))::_116_293)))
end))
in (aux [] bs)))
...
let _31_658 = lc
in (let _116_300 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = _31_658.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _116_300; FStar_Syntax_Syntax.cflags = _31_658.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _31_660 -> (match (()) with
| () -> begin
(let _116_299 = (lc.FStar_Syntax_Syntax.comp ())
in (subst_comp s _116_299))
end))}))))
...
| FStar_Syntax_Syntax.Pat_constant (_31_668) -> begin
(p, sub)
end
| FStar_Syntax_Syntax.Pat_disj (p::ps) -> begin
(
...
let ps = (FStar_List.map (fun p -> (let _116_308 = (aux sub p)
in (Prims.fst _116_308))) ps)
in ((
# 453 "FStar.Syntax.Subst.fst"
let _31_679 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p)::ps); FStar_Syntax_Syntax.ty = _31_679.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_679.FStar_Syntax_Syntax.p}), sub))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
# 456 "FStar.Syntax.Subst.fst"
let _31_696 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _31_687 _31_690 -> (match ((_31_687, _31_690)) with
| ((pats, sub), (p, imp)) -> begin
(
# 457 "FStar.Syntax.Subst.fst"
let _31_693 = (aux sub p)
in (match (_31_693) with
| (p, sub) -> begin
(((p, imp))::pats, sub)
end))
end)) ([], sub)))
in (match (_31_696) with
| (pats, sub) -> begin
((
# 459 "FStar.Syntax.Subst.fst"
let _31_697 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons ((fv, (FStar_List.rev pats))); FStar_Syntax_Syntax.ty = _31_697.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_697.FStar_Syntax_Syntax.p}), sub)
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
# 462 "FStar.Syntax.Subst.fst"
let _31_701 = x
in (let _116_311 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_701.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_701.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_311}))
in (
# 463 "FStar.Syntax.Subst.fst"
let sub = (let _116_312 = (shift_subst 1 sub)
in (FStar_Syntax_Syntax.NM ((x, 0)))::_116_312)
in ((
# 464 "FStar.Syntax.Subst.fst"
let _31_705 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = _31_705.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_705.FStar_Syntax_Syntax.p}), sub)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
# 467 "FStar.Syntax.Subst.fst"
let _31_709 = x
in (let _116_313 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_709.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_709.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_313}))
in (
# 468 "FStar.Syntax.Subst.fst"
let sub = (let _116_314 = (shift_subst 1 sub)
in (FStar_Syntax_Syntax.NM ((x, 0)))::_116_314)
in ((
# 469 "FStar.Syntax.Subst.fst"
let _31_713 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = _31_713.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_713.FStar_Syntax_Syntax.p}), sub)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
# 472 "FStar.Syntax.Subst.fst"
let _31_719 = x
in (let _116_315 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _31_719.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _31_719.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _116_315}))
in (
...
let _31_723 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term ((x, t0)); FStar_Syntax_Syntax.ty = _31_723.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _31_723.FStar_Syntax_Syntax.p}), sub)))
end))
in (aux [] p)))

# 477 "FStar.Syntax.Subst.fst"
let close_branch : FStar_Syntax_Syntax.branch  ->  FStar_Syntax_Syntax.branch = (fun _31_728 -> (match (_31_728) with
| (p, wopt, e) -> begin
(
# 478 "FStar.Syntax.Subst.fst"
let _31_731 = (close_pat p)
...
let _31_744 = (let _116_323 = (FStar_All.pipe_right us (FStar_List.mapi (fun i u -> (
...
in (FStar_All.pipe_right _116_323 FStar_List.unzip))
in (match (_31_744) with
| (s, us') -> begin
(s, us')
end))))
...
let _31_749 = (univ_var_opening us)
in (match (_31_749) with
| (s, us') -> begin
(
...
let _31_755 = (univ_var_opening us)
in (match (_31_755) with
| (s, us') -> begin
(let _116_332 = (subst_comp s c)
in (us', _116_332))
end)))
...
let _31_781 = (FStar_List.fold_right (fun lb _31_774 -> (match (_31_774) with
| (i, lbs, out) -> begin
(
# 530 "FStar.Syntax.Subst.fst"
let x = (let _116_351 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_Syntax_Syntax.freshen_bv _116_351))
in ((i + 1), ((
# 531 "FStar.Syntax.Subst.fst"
let _31_776 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _31_776.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _31_776.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _31_776.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _31_776.FStar_Syntax_Syntax.lbdef}))::lbs, (FStar_Syntax_Syntax.DB ((i, x)))::out))
end)) lbs (0, [], []))
...
let _31_793 = (FStar_List.fold_right (fun u _31_787 -> (match (_31_787) with
| (i, us, out) -> begin
(
...
in (match (_31_793) with
| (_31_790, us, u_let_rec_opening) -> begin
(
# 539 "FStar.Syntax.Subst.fst"
let _31_794 = lb
in (let _116_355 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _31_794.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = _31_794.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _31_794.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _116_355}))
end)))))
in (
...
let _31_806 = (FStar_List.fold_right (fun lb _31_803 -> (match (_31_803) with
| (i, out) -> begin
(let _116_365 = (let _116_364 = (let _116_363 = (let _116_362 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (_116_362, i))
in FStar_Syntax_Syntax.NM (_116_363))
in (_116_364)::out)
in ((i + 1), _116_365))
end)) lbs (0, []))
in (match (_31_806) with
| (n_let_recs, let_rec_closing) -> begin
(
# 548 "FStar.Syntax.Subst.fst"
let lbs = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (
# 549 "FStar.Syntax.Subst.fst"
let _31_815 = (FStar_List.fold_right (fun u _31_811 -> (match (_31_811) with
| (i, out) -> begin
((i + 1), (FStar_Syntax_Syntax.UD ((u, i)))::out)
end)) lb.FStar_Syntax_Syntax.lbunivs (n_let_recs, let_rec_closing))
in (match (_31_815) with
| (_31_813, u_let_rec_closing) -> begin
(
# 550 "FStar.Syntax.Subst.fst"
let _31_816 = lb
in (let _116_369 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _31_816.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _31_816.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _31_816.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _31_816.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _116_369}))
end)))))
in (
...
let close_tscheme : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.tscheme  ->  FStar_Syntax_Syntax.tscheme = (fun binders _31_823 -> (match (_31_823) with
| (us, t) -> begin
(
...
let s = (FStar_List.mapi (fun i _31_830 -> (match (_31_830) with
| (x, _31_829) -> begin
...
let close_univ_vars_tscheme : FStar_Syntax_Syntax.univ_names  ->  FStar_Syntax_Syntax.tscheme  ->  FStar_Syntax_Syntax.tscheme = (fun us _31_836 -> (match (_31_836) with
| (us', t) -> begin
(
...
in (FStar_All.pipe_right bs (FStar_List.mapi (fun i _31_848 -> (match (_31_848) with
| (x, _31_847) -> begin
