          ...
          FStar_All.pipe_right u.FStar_Syntax_Syntax.ctx_uvar_binders
            (FStar_Util.for_some
               (fun uu____2374 ->
                  ...
                  | (x', uu____2383) -> FStar_Syntax_Syntax.bv_eq x x')) in
                ...
                FStar_All.pipe_right hd_subst
                  (FStar_List.collect
                     (fun uu___6_2430 ->
                        ...
                        | uu____2490 -> [])) in
              let uu____2491 = aux rest in FStar_List.append hd1 uu____2491 in
        let uu____2494 =
          aux
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0, args) ->
          let uu____2789 =
            let uu____2790 =
              ...
              let uu____2810 = subst_args' s args in (uu____2807, uu____2810) in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0, (annot, topt), lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2925 = subst_comp' s c in FStar_Util.Inr uu____2925 in
          let uu____2932 =
            let uu____2933 =
                         ...
                         | (pat1, n1) ->
                             ...
                             let wopt1 =
                               ...
                               | FStar_Pervasives_Native.Some w ->
                                   ...
                                   FStar_Pervasives_Native.Some uu____3374 in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let uu____3734 =
            let uu____3735 = let uu____3742 = subst' s t1 in (uu____3742, m) in
  ...
  fun bs ->
    let rec aux bs1 o =
      ...
      | (x, imp)::bs' ->
          ...
          (match uu____4223 with | (bs'1, o2) -> (((x', imp1) :: bs'1), o2)) in
    aux bs []
let (open_binders :
  FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders) =
  fun bs ->
         ...
         | (p1, opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4895 in
...
let (close :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
  fun bs -> fun t -> let uu____4933 = closing_subst bs in subst uu____4933 t
let (close_comp :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp)
  =
  ...
  fun bs ->
    let rec aux s bs1 =
      ...
      | (x, imp)::tl1 ->
          ...
          let uu____5029 = aux s' tl1 in (x1, imp1) :: uu____5029 in
    aux [] bs
let (close_pat :
  FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t ->
    (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t *
         ...
         | (p1, closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____5563 in
