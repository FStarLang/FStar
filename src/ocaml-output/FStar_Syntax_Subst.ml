    ...
    | FStar_Syntax_Syntax.Tm_uvar
        ...
        (match uu___7 with
         | FStar_Pervasives_Native.Some t' ->
             let uu___8 =
               let uu___9 = let uu___10 = delay t' s  in force_uvar' uu___10
                  in
      ...
      | uu___ ->
          ...
          (match t0.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_type u ->
               let uu___1 =
                 let uu___2 = subst_univ (FStar_Pervasives_Native.fst s) u
                    in
      ...
      | uu___ ->
          ...
          let uu___2 =
            FStar_List.map (subst_univ (FStar_Pervasives_Native.fst s))
             ...
             in
          let uu___3 = tag_lid_with_range t.FStar_Syntax_Syntax.effect_name s
             in
        ...
        let should_retain x =
          FStar_All.pipe_right u.FStar_Syntax_Syntax.ctx_uvar_binders
            (FStar_Util.for_some
               (fun uu___  ->
                  match uu___ with
                  | (x',uu___1) -> FStar_Syntax_Syntax.bv_eq x x'))
           in
        let rec aux uu___ =
          match uu___ with
          | [] -> []
                ...
                FStar_All.pipe_right hd_subst
                  (FStar_List.collect
                     (fun uu___1  ->
                        ...
                        | uu___2 -> []))
                 in
              let uu___1 = aux rest  in FStar_List.append hd uu___1
           in
        let uu___ =
          aux
    ...
    fun t  ->
          ...
          (match uu___ with
           | FStar_Pervasives_Native.None  ->
               let uu___1 =
                 ...
                 let uu___3 =
                   let uu___4 =
                     let uu___5 = compose_uvar_subst uv s0 s  in (uv, uu___5)
                      in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0,(annot,topt),lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu___ = subst_comp' s c  in FStar_Util.Inr uu___
             in
          let uu___ =
            let uu___1 =
              let uu___2 = subst' s t0  in
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu___ =
            let uu___1 =
              let uu___2 = subst' s t0  in
              let uu___3 =
                let uu___4 = let uu___5 = subst' s t1  in (m1, m2, uu___5)
                   in
  ...
  fun bs  ->
    let rec aux bs1 o =
      ...
      | (x,imp)::bs' ->
          ...
          (match uu___ with | (bs'1,o2) -> (((x', imp1) :: bs'1), o2))
       in
    aux bs []
  ...
  fun bs  ->
    let rec aux s bs1 =
      ...
      | (x,imp)::tl ->
          ...
          let uu___ = aux s' tl  in (x1, imp1) :: uu___
       in
    aux [] bs
               ...
               fun uu___3  ->
                 ...
                 | (i,out) ->
                     let uu___4 =
                       ...
                       uu___5 :: out  in
                     ((i + Prims.int_one), uu___4)) lbs (Prims.int_zero, [])
         in
      match uu___ with
...
let rec (deep_compress :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_lazy li ->
        let t2 =
          let uu___ =
            let uu___1 = FStar_ST.op_Bang FStar_Syntax_Syntax.lazy_chooser
               in
    ...
    | FStar_Syntax_Syntax.Tm_match (t2,branches) ->
        let rec elim_pat p =
          ...
          | FStar_Syntax_Syntax.Pat_var x ->
              let uu___ = p  in
              let uu___1 =
                let uu___2 = elim_bv x  in FStar_Syntax_Syntax.Pat_var uu___2
                 in
              {
          ...
          | FStar_Syntax_Syntax.Pat_wild x ->
              ...
              let uu___1 =
                ...
                FStar_Syntax_Syntax.Pat_wild uu___2  in
              {
                FStar_Syntax_Syntax.v = uu___1;
                FStar_Syntax_Syntax.p = (uu___.FStar_Syntax_Syntax.p)
              }
        ...
        let elim_branch uu___ =
          ...
          | (pat,wopt,t3) ->
              ...
              let uu___3 = deep_compress t3  in (uu___1, uu___2, uu___3)
           in
        let uu___ =
          let uu___1 =
            let uu___2 = deep_compress t2  in
            let uu___3 = FStar_List.map elim_branch branches  in
            (uu___2, uu___3)  in
        ...
        let elim_ascription uu___ =
          ...
          | (tc,topt) ->
              let uu___1 =
                match tc with
                | FStar_Util.Inl t3 ->
                    let uu___2 = deep_compress t3  in FStar_Util.Inl uu___2
                | FStar_Util.Inr c ->
                    let uu___2 = deep_compress_comp c  in
                    FStar_Util.Inr uu___2
                 in
    ...
    | FStar_Syntax_Syntax.Tm_let (lbs,t2) ->
        let elim_lb lb =
          let uu___ =
            match lb.FStar_Syntax_Syntax.lbname with
            | FStar_Util.Inl bv ->
                let uu___1 = elim_bv bv  in FStar_Util.Inl uu___1
            | FStar_Util.Inr fv -> FStar_Util.Inr fv  in
  ...
  fun c  ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let ct1 =
          ...
          let uu___2 = deep_compress_args ct.FStar_Syntax_Syntax.effect_args
             in
...
and (deep_compress_univ :
  ...
  fun u  ->
    ...
    | FStar_Syntax_Syntax.U_max us ->
        ...
        FStar_Syntax_Syntax.U_max uu___
    | FStar_Syntax_Syntax.U_succ u2 ->
        let uu___ = deep_compress_univ u2  in
    ...
    FStar_List.map
      (fun uu___  ->
         ...
         | (x,q) ->
             let x1 =
               let uu___1 = x  in
               let uu___2 = deep_compress x.FStar_Syntax_Syntax.sort  in
               {
                 FStar_Syntax_Syntax.ppname =
