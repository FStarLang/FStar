    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0,args) ->
          let uu____1543 =
            let uu____1544 =
              ...
              let uu____1557 = subst_args' s args  in
              (uu____1554, uu____1557)  in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0,(annot,topt),lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____1643 = subst_comp' s c  in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
          let uu____2213 =
            let uu____2214 = let uu____2219 = subst' s t1  in (uu____2219, m)
               in
  ...
  let rec aux bs1 o =
    ...
    | (x,imp)::bs' ->
        ...
        let o1 =
          ...
          (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) :: uu____2452
           in
        let uu____2454 = aux bs' o1  in
        (match uu____2454 with | (bs'1,o2) -> (((x', imp) :: bs'1), o2))
     in
  aux bs [] 
let open_binders :
  FStar_Syntax_Syntax.binders ->
        ...
        (match uu____3017 with
         | (p1,opening) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3032 = subst opening w  in Some uu____3032
                in
      ...
      | (x,imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____3093
             in
          let uu____3095 = aux s' tl1  in (x1, imp) :: uu____3095
       in
    aux [] bs
        ...
        (match uu____3418 with
         | (p1,closing) ->
             let wopt1 =
               ...
               | None  -> None
               | Some w ->
                   let uu____3442 = subst closing w  in Some uu____3442
                in
