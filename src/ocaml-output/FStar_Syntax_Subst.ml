...
let subst_nm:
  ...
  fun a  ->
    fun s  ->
      FStar_Util.find_map s
        (fun uu___50_779  ->
           match uu___50_779 with
           | FStar_Syntax_Syntax.NM (x,i) when FStar_Syntax_Syntax.bv_eq a x
               ->
               let uu____784 =
                 FStar_Syntax_Syntax.bv_to_tm
                   (let uu___54_787 = a in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___54_787.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index = i;
                      FStar_Syntax_Syntax.sort =
                        (uu___54_787.FStar_Syntax_Syntax.sort)
                    }) in
      ...
      | FStar_Pervasives_Native.Some r ->
          ...
          let t' =
            ...
            | FStar_Syntax_Syntax.Tm_fvar fv ->
                ...
                let v1 =
                  let uu___55_922 = fv.FStar_Syntax_Syntax.fv_name in
                  {
                    FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1);
                    FStar_Syntax_Syntax.p =
                      (uu___55_922.FStar_Syntax_Syntax.p)
                  } in
                let fv1 =
                  let uu___56_924 = fv in
                  {
                    FStar_Syntax_Syntax.fv_name = v1;
                    FStar_Syntax_Syntax.fv_delta =
                      (uu___56_924.FStar_Syntax_Syntax.fv_delta);
                    FStar_Syntax_Syntax.fv_qual =
                      (uu___56_924.FStar_Syntax_Syntax.fv_qual)
                  } in
                FStar_Syntax_Syntax.Tm_fvar fv1
            | t' -> t' in
          let uu___57_926 = t in
          {
            FStar_Syntax_Syntax.n = t';
            FStar_Syntax_Syntax.pos = r1;
            FStar_Syntax_Syntax.vars = (uu___57_926.FStar_Syntax_Syntax.vars)
          }
...
let subst_binder':
  ...
  fun s  ->
    fun uu____1528  ->
      ...
      | (x,imp) ->
          let uu____1535 =
            let uu___59_1536 = x in
            let uu____1537 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___59_1536.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___59_1536.FStar_Syntax_Syntax.index);
      ...
      let rec aux n1 p1 =
        ...
        | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
            ...
            (match uu____1778 with
             | (pats1,n2) ->
                 ((let uu___60_1970 = p1 in
                   {
                     FStar_Syntax_Syntax.v =
                       (FStar_Syntax_Syntax.Pat_cons
                          (fv, (FStar_List.rev pats1)));
                     FStar_Syntax_Syntax.p =
                       (uu___60_1970.FStar_Syntax_Syntax.p)
                   }), n2))
        | FStar_Syntax_Syntax.Pat_var x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___61_1996 = x in
              let uu____1997 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___61_1996.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___61_1996.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____1997
              } in
            ((let uu___62_2003 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
                FStar_Syntax_Syntax.p = (uu___62_2003.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_wild x ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___63_2019 = x in
              let uu____2020 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___63_2019.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___63_2019.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2020
              } in
            ((let uu___64_2026 = p1 in
              {
                FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
                FStar_Syntax_Syntax.p = (uu___64_2026.FStar_Syntax_Syntax.p)
              }), (n1 + (Prims.parse_int "1")))
        | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
            let s1 = shift_subst' n1 s in
            let x1 =
              let uu___65_2047 = x in
              let uu____2048 = subst' s1 x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___65_2047.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___65_2047.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____2048
              } in
            let t01 = subst' s1 t0 in
            ((let uu___66_2057 = p1 in
              {
                FStar_Syntax_Syntax.v =
                  (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
                FStar_Syntax_Syntax.p = (uu___66_2057.FStar_Syntax_Syntax.p)
              }), n1) in
  ...
  fun s  ->
    fun lopt  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____2077 =
            let uu___67_2078 = rc in
            let uu____2079 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (subst' s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___67_2078.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____2079;
              FStar_Syntax_Syntax.residual_flags =
                (uu___67_2078.FStar_Syntax_Syntax.residual_flags)
            } in
  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          let x1 =
            let uu___68_2605 = x in
            let uu____2606 = subst' s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___68_2605.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___68_2605.FStar_Syntax_Syntax.index);
              ...
              (FStar_List.map
                 (fun lb  ->
                    ...
                    let lbname =
                      ...
                      | FStar_Util.Inl x ->
                          FStar_Util.Inl
                            (let uu___69_2933 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___69_2933.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___69_2933.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = lbt
                             })
                      | FStar_Util.Inr fv -> FStar_Util.Inr fv in
                    let uu___70_2935 = lb in
                    {
                      FStar_Syntax_Syntax.lbname = lbname;
                      FStar_Syntax_Syntax.lbunivs =
                        (uu___70_2935.FStar_Syntax_Syntax.lbunivs);
                      FStar_Syntax_Syntax.lbtyp = lbt;
                      FStar_Syntax_Syntax.lbeff =
                        (uu___70_2935.FStar_Syntax_Syntax.lbeff);
...
let open_binders':
  ...
  fun bs  ->
    let rec aux bs1 o =
      ...
      | (x,imp)::bs' ->
          let x' =
            let uu___71_3483 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____3484 = subst o x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___71_3483.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___71_3483.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____3808 with
           | (pats1,sub2,renaming1) ->
               ((let uu___72_4219 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___72_4219.FStar_Syntax_Syntax.p)
                 }), sub2, renaming1))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x' =
            let uu___73_4238 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4239 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___73_4238.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___73_4238.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4245 in
          ((let uu___74_4259 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x');
              FStar_Syntax_Syntax.p = (uu___74_4259.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x' =
            let uu___75_4268 = FStar_Syntax_Syntax.freshen_bv x in
            let uu____4269 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___75_4268.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___75_4268.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) ::
              uu____4275 in
          ((let uu___76_4289 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x');
              FStar_Syntax_Syntax.p = (uu___76_4289.FStar_Syntax_Syntax.p)
            }), sub2, ((x, x') :: renaming))
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___77_4303 = x in
            let uu____4304 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___77_4303.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___77_4303.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____4304
            } in
          let t01 = subst sub1 t0 in
          ((let uu___78_4319 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___78_4319.FStar_Syntax_Syntax.p)
            }), sub1, renaming) in
...
let close_binders: FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders
  ...
  fun bs  ->
    let rec aux s bs1 =
      ...
      | (x,imp)::tl1 ->
          let x1 =
            let uu___79_4485 = x in
            let uu____4486 = subst s x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___79_4485.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___79_4485.FStar_Syntax_Syntax.index);
    ...
    let rec aux sub1 p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          ...
          (match uu____4592 with
           | (pats1,sub2) ->
               ((let uu___81_4864 = p1 in
                 {
                   FStar_Syntax_Syntax.v =
                     (FStar_Syntax_Syntax.Pat_cons
                        (fv, (FStar_List.rev pats1)));
                   FStar_Syntax_Syntax.p =
                     (uu___81_4864.FStar_Syntax_Syntax.p)
                 }), sub2))
      | FStar_Syntax_Syntax.Pat_var x ->
          let x1 =
            let uu___82_4883 = x in
            let uu____4884 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___82_4883.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___82_4883.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4890 in
          ((let uu___83_4898 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_var x1);
              FStar_Syntax_Syntax.p = (uu___83_4898.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x1 =
            let uu___84_4903 = x in
            let uu____4904 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___84_4903.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___84_4903.FStar_Syntax_Syntax.index);
          ...
          let sub2 =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4910 in
          ((let uu___85_4918 = p1 in
            {
              FStar_Syntax_Syntax.v = (FStar_Syntax_Syntax.Pat_wild x1);
              FStar_Syntax_Syntax.p = (uu___85_4918.FStar_Syntax_Syntax.p)
            }), sub2)
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            let uu___86_4928 = x in
            let uu____4929 = subst sub1 x.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___86_4928.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___86_4928.FStar_Syntax_Syntax.index);
              FStar_Syntax_Syntax.sort = uu____4929
            } in
          let t01 = subst sub1 t0 in
          ((let uu___87_4938 = p1 in
            {
              FStar_Syntax_Syntax.v =
                (FStar_Syntax_Syntax.Pat_dot_term (x1, t01));
              FStar_Syntax_Syntax.p = (uu___87_4938.FStar_Syntax_Syntax.p)
            }), sub1) in
    aux [] p
             ...
             (fun lb  ->
                fun uu____5194  ->
                  ...
                  | (i,lbs1,out) ->
                      ...
                      ((i + (Prims.parse_int "1")),
                        ((let uu___88_5233 = lb in
                          {
                            FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                            FStar_Syntax_Syntax.lbunivs =
                              (uu___88_5233.FStar_Syntax_Syntax.lbunivs);
                            FStar_Syntax_Syntax.lbtyp =
                              (uu___88_5233.FStar_Syntax_Syntax.lbtyp);
                            FStar_Syntax_Syntax.lbeff =
                              (uu___88_5233.FStar_Syntax_Syntax.lbeff);
                            FStar_Syntax_Syntax.lbdef =
                              (uu___88_5233.FStar_Syntax_Syntax.lbdef)
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____5337,us,u_let_rec_opening) ->
                           let uu___89_5348 = lb in
                           let uu____5349 =
                             subst u_let_rec_opening
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___89_5348.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs = us;
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___89_5348.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___89_5348.FStar_Syntax_Syntax.lbeff);
                 ...
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____5500,u_let_rec_closing) ->
                           let uu___90_5506 = lb in
                           let uu____5507 =
                             subst u_let_rec_closing
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___90_5506.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___90_5506.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___90_5506.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___90_5506.FStar_Syntax_Syntax.lbeff);
