    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0,args) ->
          let uu____2233 =
            let uu____2234 =
              ...
              let uu____2252 = subst_args' s args  in
              (uu____2249, uu____2252)  in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0,(annot,topt),lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2361 = subst_comp' s c  in
                FStar_Util.Inr uu____2361
             in
          let uu____2368 =
            let uu____2369 =
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
          let uu____3121 =
            let uu____3122 = let uu____3129 = subst' s t1  in (uu____3129, m)
               in
  ...
  fun bs  ->
    let rec aux bs1 o =
      ...
      | (x,imp)::bs' ->
          ...
          (match uu____3514 with | (bs'1,o2) -> (((x', imp) :: bs'1), o2))
       in
    aux bs []
      ...
      | (x,imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4527
             in
          let uu____4530 = aux s' tl1  in (x1, imp) :: uu____4530
       in
    aux [] bs
         ...
         | (p1,closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____5033
                in
