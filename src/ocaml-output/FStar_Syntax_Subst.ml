...
let tag_with_range t s =
  ...
  | FStar_Pervasives_Native.Some r ->
        ...
        | FStar_Syntax_Syntax.Tm_fvar fv ->
            ...
            let v1 =
              let uu___110_839 = fv.FStar_Syntax_Syntax.fv_name in
              {
                ...
                FStar_Syntax_Syntax.p = (uu___110_839.FStar_Syntax_Syntax.p)
              } in
            let fv1 =
      ...
      let uu___112_843 = t in
      {
        ...
        FStar_Syntax_Syntax.vars = (uu___112_843.FStar_Syntax_Syntax.vars)
      }
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t0,args) ->
          let uu____2165 =
            let uu____2166 =
              ...
              let uu____2184 = subst_args' s args in (uu____2181, uu____2184) in
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (t0,(annot,topt),lopt) ->
          let annot1 =
            ...
            | FStar_Util.Inr c ->
                let uu____2293 = subst_comp' s c in FStar_Util.Inr uu____2293 in
          let uu____2300 =
            let uu____2301 =
                         ...
                         | (pat1,n1) ->
                             ...
                             let wopt1 =
                               ...
                               | FStar_Pervasives_Native.Some w ->
                                   ...
                                   FStar_Pervasives_Native.Some uu____2780 in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
          let uu____3053 =
            let uu____3054 = let uu____3061 = subst' s t1 in (uu____3061, m) in
  ...
  let rec aux bs1 o =
    ...
    | (x,imp)::bs' ->
        ...
        let o1 =
          ...
          (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) :: uu____3431 in
        let uu____3434 = aux bs' o1 in
        (match uu____3434 with | (bs'1,o2) -> (((x', imp) :: bs'1), o2)) in
  aux bs []
let open_binders:
  FStar_Syntax_Syntax.binders ->
    (FStar_Syntax_Syntax.bv,FStar_Syntax_Syntax.aqual)
         ...
         | (p1,opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4365 in
      ...
      | (x,imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4447 in
          let uu____4450 = aux s' tl1 in (x1, imp) :: uu____4450 in
    aux [] bs
let close_lcomp:
  FStar_Syntax_Syntax.binders ->
         ...
         | (p1,closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4953 in
