  ...
  fun s ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1, m) ->
          let uu____3727 =
            let uu____3728 = let uu____3735 = subst' s t1 in (uu____3735, m) in
  ...
  fun bs ->
    let rec aux bs1 o =
      ...
      | (x, imp)::bs' ->
          ...
          (match uu____4182 with | (bs'1, o2) -> (((x', imp1) :: bs'1), o2)) in
    aux bs []
let (open_binders :
  FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders) =
  fun bs ->
         ...
         | (p1, opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4918 in
...
let (close :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
  fun bs -> fun t -> let uu____4956 = closing_subst bs in subst uu____4956 t
let (close_comp :
  FStar_Syntax_Syntax.binders ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp)
  =
      ...
      | (x, imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____5046 in
          let uu____5052 = aux s' tl1 in (x1, imp1) :: uu____5052 in
    aux [] bs
let (close_lcomp :
  FStar_Syntax_Syntax.binders ->
         ...
         | (p1, closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____5604 in
