...
let map_some_curry = (fun f x uu___103_101 -> (match (uu___103_101) with
| None -> begin
x
end
| Some (a, b) -> begin
...
let subst_bv : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term Prims.option = (fun a s -> (FStar_Util.find_map s (fun uu___104_552 -> (match (uu___104_552) with
...
let subst_nm : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term Prims.option = (fun a s -> (FStar_Util.find_map s (fun uu___105_569 -> (match (uu___105_569) with
...
let uu___110_574 = a
in {FStar_Syntax_Syntax.ppname = uu___110_574.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___110_574.FStar_Syntax_Syntax.sort}))
in Some (uu____573))
end
...
let subst_univ_bv : Prims.int  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe Prims.option = (fun x s -> (FStar_Util.find_map s (fun uu___106_593 -> (match (uu___106_593) with
...
let subst_univ_nm : FStar_Syntax_Syntax.univ_name  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe Prims.option = (fun x s -> (FStar_Util.find_map s (fun uu___107_607 -> (match (uu___107_607) with
...
let uu___111_675 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = (FStar_Ident.set_lid_range l r1); FStar_Syntax_Syntax.ty = uu___111_675.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___111_675.FStar_Syntax_Syntax.p})
in (

let fv1 = (

let uu___112_691 = fv
in {FStar_Syntax_Syntax.fv_name = v1; FStar_Syntax_Syntax.fv_delta = uu___112_691.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___112_691.FStar_Syntax_Syntax.fv_qual})
...
let uu___113_693 = t
in {FStar_Syntax_Syntax.n = t'; FStar_Syntax_Syntax.tk = uu___113_693.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu___113_693.FStar_Syntax_Syntax.vars})))
end))
...
and subst_flags' : FStar_Syntax_Syntax.subst_ts  ->  FStar_Syntax_Syntax.cflags Prims.list  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun s flags -> (FStar_All.pipe_right flags (FStar_List.map (fun uu___108_972 -> (match (uu___108_972) with
...
in {FStar_Syntax_Syntax.ppname = uu___115_1181.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___115_1181.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1182}))
in ((uu____1180), (imp)))
end))
...
let uu___116_1374 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___116_1374.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___116_1374.FStar_Syntax_Syntax.p})), (m)))
end))
end
...
let uu___117_1492 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___117_1492.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___117_1492.FStar_Syntax_Syntax.p})), (n2))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___118_1508.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___118_1508.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1509}))
in (((

let uu___119_1514 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___119_1514.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___119_1514.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___120_1525.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___120_1525.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1526}))
in (((

let uu___121_1531 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___121_1531.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___121_1531.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___122_1547.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___122_1547.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1548}))
in (

let t01 = (subst' s1 t0)
in (((

let uu___123_1556 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___123_1556.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___123_1556.FStar_Syntax_Syntax.p})), (n1)))))
end))
...
in {FStar_Syntax_Syntax.eff_name = uu___124_1594.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____1595; FStar_Syntax_Syntax.cflags = uu___124_1594.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____1598 -> (
...
in {FStar_Syntax_Syntax.ppname = uu___125_2002.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___125_2002.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2003}))
in (
...
let uu___126_2233 = x
in {FStar_Syntax_Syntax.ppname = uu___126_2233.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___126_2233.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
| FStar_Util.Inr (fv) -> begin
FStar_Util.Inr ((

let uu___127_2235 = fv
in {FStar_Syntax_Syntax.fv_name = (

let uu___128_2236 = fv.FStar_Syntax_Syntax.fv_name
in {FStar_Syntax_Syntax.v = uu___128_2236.FStar_Syntax_Syntax.v; FStar_Syntax_Syntax.ty = lbt; FStar_Syntax_Syntax.p = uu___128_2236.FStar_Syntax_Syntax.p}); FStar_Syntax_Syntax.fv_delta = uu___127_2235.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___127_2235.FStar_Syntax_Syntax.fv_qual}))
end)
in (

let uu___129_2251 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___129_2251.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = uu___129_2251.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd})))))))
...
let uu___130_2510 = r
in {FStar_Range.def_range = r.FStar_Range.use_range; FStar_Range.use_range = uu___130_2510.FStar_Range.use_range})))) t))
...
let uu___131_2643 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2644 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___131_2643.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___131_2643.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2644}))
in (
...
in {FStar_Syntax_Syntax.v = uu____2831; FStar_Syntax_Syntax.ty = uu___132_2828.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___132_2828.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(

let yopt = (FStar_Util.find_map renaming (fun uu___109_2894 -> (match (uu___109_2894) with
...
let uu___133_2904 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2905 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___133_2904.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___133_2904.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2905}))
end
| Some (y) -> begin
y
end)
...
let uu___134_2909 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (y); FStar_Syntax_Syntax.ty = uu___134_2909.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___134_2909.FStar_Syntax_Syntax.p})))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___135_2914 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____2915 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___135_2914.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___135_2914.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2915}))
in (

let uu___136_2918 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___136_2918.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___136_2918.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___137_2928.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___137_2928.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2929}))
in (

let t01 = (subst sub1 t0)
in (

let uu___138_2933 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___138_2933.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___138_2933.FStar_Syntax_Syntax.p})))
end))
in (
...
let uu___139_3051 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___139_3051.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___139_3051.FStar_Syntax_Syntax.p})), (sub2), (renaming1)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___140_3304 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___140_3304.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___140_3304.FStar_Syntax_Syntax.p})), (sub2), (renaming1))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___141_3318 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3319 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___141_3318.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___141_3318.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3319}))
in (
...
let uu___142_3332 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.ty = uu___142_3332.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___142_3332.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___143_3339 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____3340 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___143_3339.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___143_3339.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3340}))
in (
...
let uu___144_3353 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.ty = uu___144_3353.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___144_3353.FStar_Syntax_Syntax.p})), (sub2), ((((x), (x')))::renaming))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___145_3365.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___145_3365.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3366}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___146_3376 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___146_3376.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___146_3376.FStar_Syntax_Syntax.p})), (sub1), (renaming))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___147_3496.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___147_3496.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3497}))
in (
...
let uu___148_3518 = lc
in (

let uu____3519 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___148_3518.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____3519; FStar_Syntax_Syntax.cflags = uu___148_3518.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____3522 -> (
...
let uu___149_3621 = p3
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((p3)::ps1); FStar_Syntax_Syntax.ty = uu___149_3621.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___149_3621.FStar_Syntax_Syntax.p})), (sub2)))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___150_3804 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___150_3804.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___150_3804.FStar_Syntax_Syntax.p})), (sub2))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___151_3818.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_3818.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3819}))
in (
...
let uu___152_3829 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___152_3829.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___152_3829.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___153_3834.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___153_3834.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3835}))
in (
...
let uu___154_3845 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___154_3845.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___154_3845.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___155_3855.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___155_3855.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3856}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___156_3863 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.ty = uu___156_3863.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___156_3863.FStar_Syntax_Syntax.p})), (sub1))))
end))
in (aux [] p)))
...
let uu___157_4093 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___157_4093.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___157_4093.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___157_4093.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___157_4093.FStar_Syntax_Syntax.lbdef}))::lbs1), ((FStar_Syntax_Syntax.DB (((i), (x))))::out)))
...
let uu___158_4153 = lb
in (

let uu____4154 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___158_4153.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = uu___158_4153.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___158_4153.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4154}))
end)))))
in (
...
let uu___159_4241 = lb
in (

let uu____4242 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___159_4241.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___159_4241.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___159_4241.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___159_4241.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____4242}))
end)))))
in (
