...
let tag_lid_with_range l s =
  ...
  | None  -> l
  | Some r ->
      let _0_64 = FStar_Range.set_use_range (FStar_Ident.range_of_lid l) r in
  ...
  fun s  ->
    fun t  ->
      ...
      | uu____966 ->
          ...
          let _0_71 = tag_lid_with_range t.FStar_Syntax_Syntax.effect_name s in
          ...
          {
            FStar_Syntax_Syntax.comp_univs = _0_72;
            FStar_Syntax_Syntax.effect_name = _0_71;
            FStar_Syntax_Syntax.result_typ = _0_70;
            FStar_Syntax_Syntax.effect_args = _0_69;
            FStar_Syntax_Syntax.flags = _0_68
          }
and subst_comp':
  (FStar_Syntax_Syntax.subst_elt Prims.list Prims.list* FStar_Range.range
    Prims.option) ->
      ...
      | uu____1023 ->
          (match t.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Total (t,uopt) ->
               ...
               let _0_73 = FStar_Option.map (subst_univ (Prims.fst s)) uopt in
               FStar_Syntax_Syntax.mk_Total' _0_74 _0_73
           | FStar_Syntax_Syntax.GTotal (t,uopt) ->
               let _0_76 = subst' s t in
               let _0_75 = FStar_Option.map (subst_univ (Prims.fst s)) uopt in
          ...
          mk
            (FStar_Syntax_Syntax.Tm_abs
               (let _0_97 = subst_binders' s bs in
                ...
                let _0_95 = push_subst_lcomp s' lopt in (_0_97, _0_96, _0_95)))
              ...
              (FStar_List.map
                 (fun lb  ->
                    ...
                    let lbd =
                      ...
                      | uu____1981 -> subst' s lb.FStar_Syntax_Syntax.lbdef in
                    let lbname =
               ...
               (let _0_107 = subst' s t0 in
                let _0_106 =
                  FStar_Syntax_Syntax.Meta_monadic
                    (let _0_105 = subst' s t in (m, _0_105)) in
                (_0_107, _0_106)))
      | FStar_Syntax_Syntax.Tm_meta
               ...
               (let _0_110 = subst' s t0 in
                let _0_109 =
                  FStar_Syntax_Syntax.Meta_monadic_lift
                    (let _0_108 = subst' s t in (m1, m2, _0_108)) in
                (_0_110, _0_109)))
          ...
          let y =
            ...
            | None  ->
                ...
                let _0_120 = subst sub x.FStar_Syntax_Syntax.sort in
                {
                  ...
                  FStar_Syntax_Syntax.sort = _0_120
                }
            | Some y -> y in
    ...
    let rec aux sub renaming p =
      ...
      | FStar_Syntax_Syntax.Pat_var x ->
          ...
          let sub =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) :: _0_124 in
      ...
      | FStar_Syntax_Syntax.Pat_wild x ->
          ...
          let sub =
            ...
            (FStar_Syntax_Syntax.DB ((Prims.parse_int "0"), x')) :: _0_126 in
  ...
  fun bs  ->
    let rec aux s bs =
      ...
      | (x,imp)::tl ->
          ...
          let _0_132 = aux s' tl in (x, imp) :: _0_132 in
    aux [] bs
let close_lcomp:
  FStar_Syntax_Syntax.binders ->
  ...
  fun bs  ->
    fun lc  ->
      ...
      let _0_134 = subst s lc.FStar_Syntax_Syntax.res_typ in
      {
        ...
        FStar_Syntax_Syntax.res_typ = _0_134;
        FStar_Syntax_Syntax.cflags =
