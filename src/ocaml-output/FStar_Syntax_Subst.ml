...
let rec apply_until_some:
  'Auu____32 'Auu____33 .
    ('Auu____33 -> 'Auu____32 FStar_Pervasives_Native.option) ->
      'Auu____33 Prims.list ->
        ('Auu____33 Prims.list,'Auu____32) FStar_Pervasives_Native.tuple2
...
let map_some_curry:
  'Auu____78 'Auu____79 'Auu____80 .
    ('Auu____80 -> 'Auu____79 -> 'Auu____78) ->
      'Auu____78 ->
        ('Auu____80,'Auu____79) FStar_Pervasives_Native.tuple2
          FStar_Pervasives_Native.option -> 'Auu____78
  =
  fun f  ->
    fun x  ->
      fun uu___99_101  ->
        match uu___99_101 with
        | FStar_Pervasives_Native.None  -> x
        | FStar_Pervasives_Native.Some (a,b) -> f a b
let apply_until_some_then_map:
  'Auu____122 'Auu____123 'Auu____124 .
    ('Auu____124 -> 'Auu____123 FStar_Pervasives_Native.option) ->
      'Auu____124 Prims.list ->
        ('Auu____124 Prims.list -> 'Auu____123 -> 'Auu____122) ->
          'Auu____122 -> 'Auu____122
  =
  fun f  ->
    fun s  ->
      fun g  ->
...
let compose_subst:
  'Auu____176 'Auu____177 .
    ('Auu____177 Prims.list,'Auu____176 FStar_Pervasives_Native.option)
  ...
  fun s1  ->
    fun s2  ->
      ...
      let ropt =
        ...
        | uu____220 -> FStar_Pervasives_Native.snd s1 in
      (s, ropt)
let delay:
      ...
      FStar_Util.find_map s
        (fun uu___100_552  ->
           ...
           | FStar_Syntax_Syntax.DB (i,x) when
               ...
               FStar_Pervasives_Native.Some uu____556
           | uu____559 -> FStar_Pervasives_Native.None)
let subst_nm:
  FStar_Syntax_Syntax.bv ->
    FStar_Syntax_Syntax.subst_elt Prims.list ->
      FStar_Syntax_Syntax.term FStar_Pervasives_Native.option
      ...
      FStar_Util.find_map s
        (fun uu___101_569  ->
           ...
           | FStar_Syntax_Syntax.NT (x,t) when FStar_Syntax_Syntax.bv_eq a x
               -> FStar_Pervasives_Native.Some t
           | uu____583 -> FStar_Pervasives_Native.None)
let subst_univ_bv:
  Prims.int ->
    FStar_Syntax_Syntax.subst_elt Prims.list ->
      ...
      FStar_Util.find_map s
        (fun uu___102_593  ->
           ...
           | FStar_Syntax_Syntax.UN (y,t) when x = y ->
               FStar_Pervasives_Native.Some t
           | uu____597 -> FStar_Pervasives_Native.None)
let subst_univ_nm:
    ...
    fun s  ->
      FStar_Util.find_map s
        (fun uu___103_607  ->
           ...
           | uu____611 -> FStar_Pervasives_Native.None)
let rec subst_univ:
...
let tag_with_range:
  'Auu____640 'Auu____641 .
    (FStar_Syntax_Syntax.term','Auu____641) FStar_Syntax_Syntax.syntax ->
      ('Auu____640,FStar_Range.range FStar_Pervasives_Native.option)
        FStar_Pervasives_Native.tuple2 ->
        (FStar_Syntax_Syntax.term','Auu____641) FStar_Syntax_Syntax.syntax
  =
  fun t  ->
      ...
      | FStar_Pervasives_Native.Some r ->
                ...
                let v1 =
                  let uu___106_677 = fv.FStar_Syntax_Syntax.fv_name in
                  {
                    ...
                    FStar_Syntax_Syntax.p =
                      (uu___106_677.FStar_Syntax_Syntax.p)
                  } in
                let fv1 =
          ...
          let uu___108_695 = t in
          {
            ...
            FStar_Syntax_Syntax.vars =
              (uu___108_695.FStar_Syntax_Syntax.vars)
          }
let tag_lid_with_range:
  'Auu____705 .
    FStar_Ident.lident ->
      ('Auu____705,FStar_Range.range FStar_Pervasives_Native.option)
      ...
      | uu____804 ->
          ...
          (match t0.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_type u ->
               ...
               uu____957 FStar_Pervasives_Native.None uu____956
           | uu____973 ->
...
let shift_subst':
  'Auu____1151 .
    Prims.int ->
      (FStar_Syntax_Syntax.subst_t Prims.list,'Auu____1151)
        FStar_Pervasives_Native.tuple2 ->
        (FStar_Syntax_Syntax.subst_t Prims.list,'Auu____1151)
          FStar_Pervasives_Native.tuple2
  =
  fun n1  ->
    fun s  ->
      ...
      (uu____1169, (FStar_Pervasives_Native.snd s))
let subst_binder':
  'Auu____1179 .
    FStar_Syntax_Syntax.subst_ts ->
      (FStar_Syntax_Syntax.bv,'Auu____1179) FStar_Pervasives_Native.tuple2 ->
        (FStar_Syntax_Syntax.bv,'Auu____1179) FStar_Pervasives_Native.tuple2
  =
  fun s  ->
    fun uu____1191  ->
...
let subst_binders':
  'Auu____1204 .
    FStar_Syntax_Syntax.subst_ts ->
      (FStar_Syntax_Syntax.bv,'Auu____1204) FStar_Pervasives_Native.tuple2
        Prims.list ->
        (FStar_Syntax_Syntax.bv,'Auu____1204) FStar_Pervasives_Native.tuple2
          Prims.list
  =
...
let subst_arg':
  'Auu____1257 .
    FStar_Syntax_Syntax.subst_ts ->
      ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
         FStar_Syntax_Syntax.syntax,'Auu____1257)
        FStar_Pervasives_Native.tuple2 ->
        ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
           FStar_Syntax_Syntax.syntax,'Auu____1257)
          FStar_Pervasives_Native.tuple2
...
let subst_args':
  'Auu____1291 .
    FStar_Syntax_Syntax.subst_ts ->
      ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
         FStar_Syntax_Syntax.syntax,'Auu____1291)
...
let push_subst_lcomp:
  'Auu____1547 .
    FStar_Syntax_Syntax.subst_ts ->
      (FStar_Syntax_Syntax.lcomp,'Auu____1547) FStar_Util.either
        FStar_Pervasives_Native.option ->
        (FStar_Syntax_Syntax.lcomp,'Auu____1547) FStar_Util.either
          FStar_Pervasives_Native.option
  =
  fun s  ->
    fun lopt  ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Util.Inr uu____1567) -> lopt
      | FStar_Pervasives_Native.Some (FStar_Util.Inl l) ->
          ...
          FStar_Pervasives_Native.Some uu____1573
let push_subst:
  FStar_Syntax_Syntax.subst_ts ->
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      FStar_Syntax_Syntax.syntax ->
  ...
  fun s  ->
    fun t  ->
      let mk1 t' =
        ...
        FStar_Syntax_Syntax.mk t' FStar_Pervasives_Native.None uu____1605 in
      match t.FStar_Syntax_Syntax.n with
                         ...
                         | (pat1,n1) ->
                             ...
                             let wopt1 =
                               ...
                               | FStar_Pervasives_Native.Some w ->
                                   ...
                                   FStar_Pervasives_Native.Some uu____2156 in
...
let closing_subst:
  'Auu____2519 .
    (FStar_Syntax_Syntax.bv,'Auu____2519) FStar_Pervasives_Native.tuple2
  ...
  fun bs  ->
    ...
    FStar_All.pipe_right uu____2531 FStar_Pervasives_Native.fst
let open_binders':
  'Auu____2575 .
    (FStar_Syntax_Syntax.bv,'Auu____2575) FStar_Pervasives_Native.tuple2
      Prims.list ->
      ((FStar_Syntax_Syntax.bv,'Auu____2575) FStar_Pervasives_Native.tuple2
         Prims.list,FStar_Syntax_Syntax.subst_elt Prims.list)
        FStar_Pervasives_Native.tuple2
...
let open_binders: FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders
  =
  fun bs  ->
    let uu____2676 = open_binders' bs in
    FStar_Pervasives_Native.fst uu____2676
let open_term':
         ...
         | (p1,opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
               | FStar_Pervasives_Native.Some w ->
                   let uu____3213 = subst opening w in
                   FStar_Pervasives_Native.Some uu____3213 in
         ...
         | (p1,closing) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
               | FStar_Pervasives_Native.Some w ->
                   let uu____3614 = subst closing w in
                   FStar_Pervasives_Native.Some uu____3614 in
...
let open_univ_vars:
  ...
  fun us  ->
    fun t  ->
      let uu____3646 = univ_var_opening us in
      match uu____3646 with | (s,us') -> let t1 = subst s t in (us', t1)
let open_univ_vars_comp:
  ...
  fun us  ->
    fun c  ->
      let uu____3671 = univ_var_opening us in
      match uu____3671 with
      | (s,us') -> let uu____3684 = subst_comp s c in (us', uu____3684)
let close_univ_vars:
  FStar_Syntax_Syntax.univ_names ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
...
let open_let_rec:
  ...
  fun lbs  ->
    fun t  ->
      let uu____3727 = FStar_Syntax_Syntax.is_top_level lbs in
      if uu____3727
      then (lbs, t)
      else
        (let uu____3733 =
                ...
                fun uu____3745  ->
                  ...
                  | (i,lbs1,out) ->
                      let x =
                        ...
                        FStar_Syntax_Syntax.freshen_bv uu____3764 in
                      ((i + (Prims.parse_int "1")),
                        ((let uu___142_3767 = lb in
                          {
                            FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                            FStar_Syntax_Syntax.lbunivs =
                              (uu___142_3767.FStar_Syntax_Syntax.lbunivs);
                            FStar_Syntax_Syntax.lbtyp =
                              (uu___142_3767.FStar_Syntax_Syntax.lbtyp);
                            FStar_Syntax_Syntax.lbeff =
                              (uu___142_3767.FStar_Syntax_Syntax.lbeff);
                            FStar_Syntax_Syntax.lbdef =
                              (uu___142_3767.FStar_Syntax_Syntax.lbdef)
               ...
               FStar_All.pipe_right lbs1
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____3819,us,u_let_rec_opening) ->
                           let uu___143_3826 = lb in
                           let uu____3827 =
                             subst u_let_rec_opening
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___143_3826.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs = us;
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___143_3826.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___143_3826.FStar_Syntax_Syntax.lbeff);
                             FStar_Syntax_Syntax.lbdef = uu____3827
                           })) in
...
let close_let_rec:
  ...
  fun lbs  ->
    fun t  ->
      let uu____3843 = FStar_Syntax_Syntax.is_top_level lbs in
      if uu____3843
      then (lbs, t)
      else
        (let uu____3849 =
                        ...
                        let uu____3870 =
                          let uu____3871 =
                            let uu____3874 =
                              FStar_Util.left lb.FStar_Syntax_Syntax.lbname in
                            (uu____3874, i) in
                          FStar_Syntax_Syntax.NM uu____3871 in
                        uu____3870 :: out in
                      ((i + (Prims.parse_int "1")), uu____3868)) lbs
             ((Prims.parse_int "0"), []) in
               ...
               FStar_All.pipe_right lbs
                 (FStar_List.map
                    (fun lb  ->
                       ...
                       | (uu____3910,u_let_rec_closing) ->
                           let uu___144_3914 = lb in
                           let uu____3915 =
                             subst u_let_rec_closing
                               lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___144_3914.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___144_3914.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___144_3914.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___144_3914.FStar_Syntax_Syntax.lbeff);
                             FStar_Syntax_Syntax.lbdef = uu____3915
                           })) in
      ...
      | (us',t) ->
          ...
          let s =
            FStar_List.mapi
              ...
              us in
          let uu____3976 = subst s t in (us', uu____3976)
      ...
      (FStar_List.mapi
         (fun i  ->
            fun uu____3991  ->
              ...
              | (x,uu____3995) -> FStar_Syntax_Syntax.DB ((n1 - i), x)))