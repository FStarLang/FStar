...
| true -> begin
(let _65_21072 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _65_21072, negs, t))
end
| false -> begin
(match (t.Microsoft_FStar_ToSMT_Term.tm) with
| Microsoft_FStar_ToSMT_Term.App ((Microsoft_FStar_ToSMT_Term.ITE, g::t::e::_)) -> begin
(let _65_21077 = (let _65_21074 = (let _65_21073 = (Microsoft_FStar_ToSMT_Term.mkNot g)
in (negs, _65_21073))
in (Microsoft_FStar_ToSMT_Term.mkAnd _65_21074))
in (get_next_n_ite (n - 1) e _65_21077 (fun ( x ) -> (let _65_21076 = (Microsoft_FStar_ToSMT_Term.mkITE (g, t, x))
in (f _65_21076)))))
end
| Microsoft_FStar_ToSMT_Term.FreeV (_) -> begin
(let _65_21078 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _65_21078, negs, t))
end
| _ -> begin
...
(match (t.Microsoft_FStar_ToSMT_Term.tm) with
| Microsoft_FStar_ToSMT_Term.FreeV (_) -> begin
(let _65_21089 = (let _65_21088 = (let _65_21087 = (Microsoft_FStar_ToSMT_Term.mkNot t)
in (negs, _65_21087))
in (Microsoft_FStar_ToSMT_Term.mkAnd _65_21088))
in (true, l, _65_21089))
end
| _ -> begin
...
(match (b) with
| true -> begin
(let _65_21092 = (let _65_21091 = (Microsoft_FStar_ToSMT_Term.mkImp (negs, t))
in (_65_21091)::l)
in (is_ite_all_the_way n rest negs' _65_21092))
end
| false -> begin
...
(parse_query_for_split_cases n t (fun ( x ) -> (let _65_21119 = (Microsoft_FStar_ToSMT_Term.mkForall'' (l, opt, l', x))
in (f _65_21119))))
end
...
(parse_query_for_split_cases n t2 (fun ( x ) -> (let _65_21127 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _65_21127))))
end
...
| (b, l, negs) -> begin
(b, ((fun ( x ) -> (let _65_21136 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _65_21136))), l, negs))
end))
end
| _ -> begin
...
let rec check_split_cases = (fun ( f ) ( l ) ( check ) -> (Support.List.iter (fun ( t ) -> (let _65_21175 = (let _65_21174 = (let _65_21173 = (let _65_21172 = (f t)
in (Microsoft_FStar_ToSMT_Term.mkNot _65_21172))
in (_65_21173, None))
in Microsoft_FStar_ToSMT_Term.Assume (_65_21174))
in (check _65_21175))) (Support.List.rev l)))

let check_exhaustiveness = (fun ( f ) ( negs ) ( check ) -> (let _65_21196 = (let _65_21195 = (let _65_21194 = (let _65_21193 = (let _65_21192 = (Microsoft_FStar_ToSMT_Term.mkNot negs)
in (f _65_21192))
in (Microsoft_FStar_ToSMT_Term.mkNot _65_21193))
in (_65_21194, None))
in Microsoft_FStar_ToSMT_Term.Assume (_65_21195))
in (check _65_21196)))
