...
| true -> begin
(let _115_14 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _115_14, negs, t))
end
| false -> begin
...
(let _115_19 = (let _115_16 = (let _115_15 = (Microsoft_FStar_ToSMT_Term.mkNot g)
in (negs, _115_15))
in (Microsoft_FStar_ToSMT_Term.mkAnd _115_16))
in (get_next_n_ite (n - 1) e _115_19 (fun ( x ) -> (let _115_18 = (Microsoft_FStar_ToSMT_Term.mkITE (g, t, x))
in (f _115_18)))))
end
| Microsoft_FStar_ToSMT_Term.FreeV (_51_18) -> begin
(let _115_20 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _115_20, negs, t))
end
| _51_21 -> begin
...
(let _115_31 = (let _115_30 = (let _115_29 = (Microsoft_FStar_ToSMT_Term.mkNot t)
in (negs, _115_29))
in (Microsoft_FStar_ToSMT_Term.mkAnd _115_30))
in (true, l, _115_31))
end
| _51_30 -> begin
...
(match (b) with
| true -> begin
(let _115_34 = (let _115_33 = (Microsoft_FStar_ToSMT_Term.mkImp (negs, t))
in (_115_33)::l)
in (is_ite_all_the_way n rest negs' _115_34))
end
| false -> begin
...
(parse_query_for_split_cases n t (fun ( x ) -> (let _115_61 = (Microsoft_FStar_ToSMT_Term.mkForall'' (l, opt, l', x))
in (f _115_61))))
end
...
(parse_query_for_split_cases n t2 (fun ( x ) -> (let _115_69 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _115_69))))
end
...
| (b, l, negs) -> begin
(b, ((fun ( x ) -> (let _115_78 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _115_78))), l, negs))
end))
end
| _51_80 -> begin
...
let rec check_split_cases = (fun ( f ) ( l ) ( check ) -> (Support.List.iter (fun ( t ) -> (let _115_117 = (let _115_116 = (let _115_115 = (let _115_114 = (f t)
in (Microsoft_FStar_ToSMT_Term.mkNot _115_114))
in (_115_115, None))
in Microsoft_FStar_ToSMT_Term.Assume (_115_116))
in (check _115_117))) (Support.List.rev l)))

let check_exhaustiveness = (fun ( f ) ( negs ) ( check ) -> (let _115_138 = (let _115_137 = (let _115_136 = (let _115_135 = (let _115_134 = (Microsoft_FStar_ToSMT_Term.mkNot negs)
in (f _115_134))
in (Microsoft_FStar_ToSMT_Term.mkNot _115_135))
in (_115_136, None))
in Microsoft_FStar_ToSMT_Term.Assume (_115_137))
in (check _115_138)))
