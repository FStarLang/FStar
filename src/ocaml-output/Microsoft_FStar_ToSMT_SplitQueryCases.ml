...
| true -> begin
(let _70_23730 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _70_23730, negs, t))
end
| false -> begin
...
(let _70_23735 = (let _70_23732 = (let _70_23731 = (Microsoft_FStar_ToSMT_Term.mkNot g)
in (negs, _70_23731))
in (Microsoft_FStar_ToSMT_Term.mkAnd _70_23732))
in (get_next_n_ite (n - 1) e _70_23735 (fun ( x ) -> (let _70_23734 = (Microsoft_FStar_ToSMT_Term.mkITE (g, t, x))
in (f _70_23734)))))
end
| Microsoft_FStar_ToSMT_Term.FreeV (_51_18) -> begin
(let _70_23736 = (f Microsoft_FStar_ToSMT_Term.mkTrue)
in (true, _70_23736, negs, t))
end
| _51_21 -> begin
...
(let _70_23747 = (let _70_23746 = (let _70_23745 = (Microsoft_FStar_ToSMT_Term.mkNot t)
in (negs, _70_23745))
in (Microsoft_FStar_ToSMT_Term.mkAnd _70_23746))
in (true, l, _70_23747))
end
| _51_30 -> begin
...
(match (b) with
| true -> begin
(let _70_23750 = (let _70_23749 = (Microsoft_FStar_ToSMT_Term.mkImp (negs, t))
in (_70_23749)::l)
in (is_ite_all_the_way n rest negs' _70_23750))
end
| false -> begin
...
(parse_query_for_split_cases n t (fun ( x ) -> (let _70_23777 = (Microsoft_FStar_ToSMT_Term.mkForall'' (l, opt, l', x))
in (f _70_23777))))
end
...
(parse_query_for_split_cases n t2 (fun ( x ) -> (let _70_23785 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _70_23785))))
end
...
| (b, l, negs) -> begin
(b, ((fun ( x ) -> (let _70_23794 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _70_23794))), l, negs))
end))
end
| _51_80 -> begin
...
let rec check_split_cases = (fun ( f ) ( l ) ( check ) -> (Support.List.iter (fun ( t ) -> (let _70_23833 = (let _70_23832 = (let _70_23831 = (let _70_23830 = (f t)
in (Microsoft_FStar_ToSMT_Term.mkNot _70_23830))
in (_70_23831, None))
in Microsoft_FStar_ToSMT_Term.Assume (_70_23832))
in (check _70_23833))) (Support.List.rev l)))

let check_exhaustiveness = (fun ( f ) ( negs ) ( check ) -> (let _70_23854 = (let _70_23853 = (let _70_23852 = (let _70_23851 = (let _70_23850 = (Microsoft_FStar_ToSMT_Term.mkNot negs)
in (f _70_23850))
in (Microsoft_FStar_ToSMT_Term.mkNot _70_23851))
in (_70_23852, None))
in Microsoft_FStar_ToSMT_Term.Assume (_70_23853))
in (check _70_23854)))
