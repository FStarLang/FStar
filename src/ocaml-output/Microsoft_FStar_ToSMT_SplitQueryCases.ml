...
in (get_next_n_ite (n - 1) e _52_17812 (fun ( x ) -> (let _52_17811 = (Microsoft_FStar_ToSMT_Term.mkITE (g, t, x))
in (f _52_17811)))))
end
...
(parse_query_for_split_cases n t (fun ( x ) -> (let _52_17854 = (Microsoft_FStar_ToSMT_Term.mkForall'' (l, opt, l', x))
in (f _52_17854))))
end
...
(parse_query_for_split_cases n t2 (fun ( x ) -> (let _52_17862 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
in (f _52_17862))))
end
...
| (b, l, negs) -> begin
(b, ((fun ( x ) -> (let _52_17871 = (Microsoft_FStar_ToSMT_Term.mkImp (t1, x))
...
let rec check_split_cases = (fun ( f ) ( l ) ( check ) -> (Support.List.iter (fun ( t ) -> (let _52_17910 = (let _52_17909 = (let _52_17908 = (let _52_17907 = (f t)
...
let check_exhaustiveness = (fun ( f ) ( negs ) ( check ) -> (let _52_17931 = (let _52_17930 = (let _52_17929 = (let _52_17928 = (let _52_17927 = (Microsoft_FStar_ToSMT_Term.mkNot negs)
in (f _52_17927))
