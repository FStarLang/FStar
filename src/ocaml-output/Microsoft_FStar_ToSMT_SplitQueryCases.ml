...
let rec check_split_cases = (fun f l check -> (Microsoft_FStar_List.iter (fun t -> (let _117_117 = (let _117_116 = (let _117_115 = (let _117_114 = (f t)
in (Microsoft_FStar_ToSMT_Term.mkNot _117_114))
in (_117_115, None))
in Microsoft_FStar_ToSMT_Term.Assume (_117_116))
in (check _117_117))) (Microsoft_FStar_List.rev l)))
