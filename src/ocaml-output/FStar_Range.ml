...
let uu___25_139 = r2
in {def_range = uu___25_139.def_range; use_range = use_rng})
end
| uu____140 -> begin
r2
end))
...
let uu___26_151 = r2
in {def_range = def_rng; use_range = uu___26_151.use_range})
end
| uu____152 -> begin
r2
end))
...
let uu___27_345 = p
in {line = uu___27_345.line; col = FStar_Util.max_int}))
