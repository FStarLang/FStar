...
let uu___26_98 = r2
in {def_range = uu___26_98.def_range; use_range = use_rng})
end
| uu____99 -> begin
r2
end))
...
let uu___27_106 = r2
in {def_range = def_rng; use_range = uu___27_106.use_range})
end
| uu____107 -> begin
r2
end))
...
let uu____153 = (FStar_Util.string_of_int pos.line)
in (

let uu____154 = (FStar_Util.string_of_int pos.col)
in (FStar_Util.format2 "%s,%s" uu____153 uu____154))))


let string_of_rng : rng  ->  Prims.string = (fun r -> (

let uu____158 = (string_of_pos r.start_pos)
in (

let uu____159 = (string_of_pos r.end_pos)
in (FStar_Util.format3 "%s(%s-%s)" r.file_name uu____158 uu____159))))
...
let uu____226 = (end_of_range m1)
in (pos_geq p uu____226)))


let end_of_line : pos  ->  pos = (fun p -> (

let uu___28_230 = p
in {line = uu___28_230.line; col = FStar_Util.max_int}))


let extend_to_end_of_line : range  ->  range = (fun r -> (

let uu____234 = (file_of_range r)
in (

let uu____235 = (start_of_range r)
in (

let uu____236 = (

let uu____237 = (end_of_range r)
in (end_of_line uu____237))
in (mk_range uu____234 uu____235 uu____236)))))
...
let uu____477 = (line_of_pos pos)
in FStar_Util.JsonInt (uu____477))
in (
...
let uu____482 = (col_of_pos pos)
in FStar_Util.JsonInt (uu____482))
in (uu____481)::[])
in (uu____476)::uu____478))
in FStar_Util.JsonList (uu____473)))
...
let uu____524 = (json_of_pos e)
in (("end"), (uu____524)))
in (uu____519)::[])
in (uu____506)::uu____512))
in ((("fname"), (FStar_Util.JsonStr (file))))::uu____499)
in FStar_Util.JsonAssoc (uu____492)))


let json_of_use_range : range  ->  FStar_Util.json = (fun r -> (

let uu____544 = (file_of_use_range r)
in (

let uu____545 = (start_of_use_range r)
in (

let uu____546 = (end_of_use_range r)
in (json_of_range_fields uu____544 uu____545 uu____546)))))


let json_of_def_range : range  ->  FStar_Util.json = (fun r -> (

let uu____550 = (file_of_range r)
in (

let uu____551 = (start_of_range r)
in (

let uu____552 = (end_of_range r)
in (json_of_range_fields uu____550 uu____551 uu____552)))))
