             ...
             (fun uu____11632  ->
                ...
                | (u1,u2) ->
                    ...
                    let uu____11638 = FStar_Syntax_Print.univ_to_string u2
                       in
                    FStar_Util.format2 "%s < %s" uu____11637 uu____11638))
         in
        ...
        (let prob =
           let uu____12096 =
             ...
             new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None
              ...
              in
           FStar_All.pipe_left
             (fun _0_76  -> FStar_TypeChecker_Common.TProb _0_76) uu____12096
            in
         let g =
           let uu____12104 =
          ...
          (match implicits with
           | [] ->
               (match Prims.op_Negation changed with
                | true  -> out
                | uu____12627 -> until_fixpoint ([], false) out)
           | hd::tl ->
      ...
      | (reason,uu____12770,uu____12771,e,t,r)::uu____12775 ->
          let uu____12789 =
            ...
            FStar_Util.format3
              ...
              uu____12790 uu____12791 reason
             in
