    ...
    fun e  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              uu____144 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___166_142.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___166_142.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___166_142.FStar_TypeChecker_Env.implicits)
          }
let map_guard:
  FStar_TypeChecker_Env.guard_t ->
    ...
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            FStar_TypeChecker_Common.NonTrivial uu____189 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___167_187.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___167_187.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___167_187.FStar_TypeChecker_Env.implicits)
          }
    ...
    fun bs  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu___168_329 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___168_329.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___168_329.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___168_329.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____369 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___169_367.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___169_367.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___169_367.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___170_1091 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___170_1091.wl_deferred);
          ctr = (uu___170_1091.ctr);
          defer_ok = (uu___170_1091.defer_ok);
          smt_ok;
          tcenv = (uu___170_1091.tcenv)
        }
let singleton:
...
let wl_of_guard:
  ...
  fun env  ->
    fun g  ->
      let uu___171_1127 = empty_worklist env in
      let uu____1128 = FStar_List.map FStar_Pervasives_Native.snd g in
      {
        attempting = uu____1128;
        wl_deferred = (uu___171_1127.wl_deferred);
        ctr = (uu___171_1127.ctr);
        defer_ok = false;
        smt_ok = (uu___171_1127.smt_ok);
        tcenv = (uu___171_1127.tcenv)
      }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___172_1145 = wl in
        {
          attempting = (uu___172_1145.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___172_1145.ctr);
          defer_ok = (uu___172_1145.defer_ok);
          smt_ok = (uu___172_1145.smt_ok);
          tcenv = (uu___172_1145.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___173_1164 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___173_1164.wl_deferred);
        ctr = (uu___173_1164.ctr);
        defer_ok = (uu___173_1164.defer_ok);
        smt_ok = (uu___173_1164.smt_ok);
        tcenv = (uu___173_1164.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert:
  ...
  =
  fun p  ->
    let uu___174_1209 = p in
    {
      FStar_TypeChecker_Common.pid =
        (uu___174_1209.FStar_TypeChecker_Common.pid);
      FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
      FStar_TypeChecker_Common.relation =
        (invert_rel p.FStar_TypeChecker_Common.relation);
      FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
      FStar_TypeChecker_Common.element =
        (uu___174_1209.FStar_TypeChecker_Common.element);
      FStar_TypeChecker_Common.logical_guard =
        (uu___174_1209.FStar_TypeChecker_Common.logical_guard);
      FStar_TypeChecker_Common.scope =
        (uu___174_1209.FStar_TypeChecker_Common.scope);
      FStar_TypeChecker_Common.reason =
        (uu___174_1209.FStar_TypeChecker_Common.reason);
      FStar_TypeChecker_Common.loc =
        (uu___174_1209.FStar_TypeChecker_Common.loc);
      FStar_TypeChecker_Common.rank =
        (uu___174_1209.FStar_TypeChecker_Common.rank)
    }
let maybe_invert:
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___148_1354  ->
    match uu___148_1354 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___149_1368  ->
    match uu___149_1368 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1937  ->
              ...
              | (x,imp) ->
                  let uu____1948 =
                    let uu___175_1949 = x in
                    let uu____1950 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___175_1949.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___175_1949.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____3354,uv) ->
                ((let uu____3357 =
                 ...
                 commit uvis;
                 (let uu___176_3398 = wl in
                  {
                    attempting = (uu___176_3398.attempting);
                    wl_deferred = (uu___176_3398.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___176_3398.defer_ok);
                    smt_ok = (uu___176_3398.smt_ok);
                    tcenv = (uu___176_3398.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___177_3426 = wl in
         {
           attempting = (uu___177_3426.attempting);
           wl_deferred = (uu___177_3426.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___177_3426.defer_ok);
           smt_ok = (uu___177_3426.smt_ok);
           tcenv = (uu___177_3426.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
    FStar_Syntax_Syntax.term FStar_Pervasives_Native.option ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____6550))::tcs2) ->
                       aux
                         (((let uu___178_6585 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___178_6585.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___178_6585.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___155_6656 =
                 match uu___155_6656 with
                 | [] ->
                     FStar_List.rev
                   ...
                   | (tc,probs) ->
                       let uu____7655 =
                         ...
                         | ((FStar_Pervasives_Native.Some
                            ...
                            (t,uu____7721)) ->
                             let b1 =
                               ((let uu___179_7758 = b in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___179_7758.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___179_7758.FStar_Syntax_Syntax.index);
...
let compress_tprob:
  ...
  fun wl  ->
    fun p  ->
      ...
      {
        FStar_TypeChecker_Common.pid =
          (uu___180_8044.FStar_TypeChecker_Common.pid);
        FStar_TypeChecker_Common.lhs = uu____8049;
        FStar_TypeChecker_Common.relation =
          (uu___180_8044.FStar_TypeChecker_Common.relation);
        FStar_TypeChecker_Common.rhs = uu____8050;
        FStar_TypeChecker_Common.element =
          (uu___180_8044.FStar_TypeChecker_Common.element);
        FStar_TypeChecker_Common.logical_guard =
          (uu___180_8044.FStar_TypeChecker_Common.logical_guard);
        FStar_TypeChecker_Common.scope =
          (uu___180_8044.FStar_TypeChecker_Common.scope);
        FStar_TypeChecker_Common.reason =
          (uu___180_8044.FStar_TypeChecker_Common.reason);
        FStar_TypeChecker_Common.loc =
          (uu___180_8044.FStar_TypeChecker_Common.loc);
        FStar_TypeChecker_Common.rank =
          (uu___180_8044.FStar_TypeChecker_Common.rank)
      }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____8166) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8367 ->
                                    ...
                                    let uu____8379 =
                                      let uu___181_8384 = tp in
                                      let uu____8389 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___181_8384.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___181_8384.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___181_8384.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____8389;
                                        FStar_TypeChecker_Common.element =
                                          (uu___181_8384.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___181_8384.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___181_8384.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___181_8384.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___181_8384.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___181_8384.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____8379)))
                          ...
                          (match uu____8422 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8485 ->
                                    let uu____8494 =
                                      let uu___182_8501 = tp in
                                      let uu____8506 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___182_8501.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____8506;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___182_8501.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___182_8501.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___182_8501.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___182_8501.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___182_8501.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___182_8501.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___182_8501.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___182_8501.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____8187 with
                     | (rank,tp1) ->
                         let uu____8547 =
                           FStar_All.pipe_right
                             (let uu___183_8553 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___183_8553.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___183_8553.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___183_8553.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___183_8553.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___183_8553.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___183_8553.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___183_8553.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___183_8553.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___183_8553.FStar_TypeChecker_Common.loc);
                                FStar_TypeChecker_Common.rank =
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____8563 =
            FStar_All.pipe_right
              (let uu___184_8569 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___184_8569.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___184_8569.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___184_8569.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___184_8569.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___184_8569.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___184_8569.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___184_8569.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___184_8569.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___184_8569.FStar_TypeChecker_Common.loc);
                 FStar_TypeChecker_Common.rank =
    ...
    fun probs  ->
      ...
      (let uu____9612 = next_prob probs in
       ...
       | (FStar_Pervasives_Native.Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___185_9633 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___185_9633.wl_deferred);
               ctr = (uu___185_9633.ctr);
               defer_ok = (uu___185_9633.defer_ok);
               smt_ok = (uu___185_9633.smt_ok);
               tcenv = (uu___185_9633.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____9819 ->
                          let uu____9828 =
                                      ...
                                      | (uu____9858,uu____9859,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___186_9829.ctr);
                              defer_ok = (uu___186_9829.defer_ok);
                              smt_ok = (uu___186_9829.smt_ok);
                              tcenv = (uu___186_9829.tcenv)
                            } in
                       ...
                       (match uu____10665 with
                        ...
                        | FStar_Pervasives_Native.Some (lhs_bound,sub_probs)
                            ...
                            ((let uu____10713 =
                              ...
                              then
                                let wl' =
                                  let uu___187_10715 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred =
                                      (uu___187_10715.wl_deferred);
                                    ctr = (uu___187_10715.ctr);
                                    defer_ok = (uu___187_10715.defer_ok);
                                    smt_ok = (uu___187_10715.smt_ok);
                                    tcenv = (uu___187_10715.tcenv)
                                  } in
                             ...
                             (let uu____10718 =
                                solve_t env eq_prob
                                  (let uu___188_10720 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___188_10720.wl_deferred);
                                     ctr = (uu___188_10720.ctr);
                                     defer_ok = (uu___188_10720.defer_ok);
                                     smt_ok = (uu___188_10720.smt_ok);
                                     tcenv = (uu___188_10720.tcenv)
                                   }) in
                              match uu____10718 with
                              | Success uu____10723 ->
                                  let wl1 =
                                    let uu___189_10725 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___189_10725.wl_deferred);
                                      ctr = (uu___189_10725.ctr);
                                      defer_ok = (uu___189_10725.defer_ok);
                                      smt_ok = (uu___189_10725.smt_ok);
                                      tcenv = (uu___189_10725.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____11554 with
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 ((let uu____11614 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___190_11616 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___190_11616.wl_deferred);
                                         ctr = (uu___190_11616.ctr);
                                         defer_ok = (uu___190_11616.defer_ok);
                                         smt_ok = (uu___190_11616.smt_ok);
                                         tcenv = (uu___190_11616.tcenv)
                                       } in
                                  ...
                                  (let uu____11619 =
                                     solve_t env eq_prob
                                       (let uu___191_11621 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___191_11621.wl_deferred);
                                          ctr = (uu___191_11621.ctr);
                                          defer_ok =
                                            (uu___191_11621.defer_ok);
                                          smt_ok = (uu___191_11621.smt_ok);
                                          tcenv = (uu___191_11621.tcenv)
                                        }) in
                                   match uu____11619 with
                                   | Success uu____11624 ->
                                       let wl1 =
                                         let uu___192_11626 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___192_11626.wl_deferred);
                                           ctr = (uu___192_11626.ctr);
                                           defer_ok =
                                             (uu___192_11626.defer_ok);
                                           smt_ok = (uu___192_11626.smt_ok);
                                           tcenv = (uu___192_11626.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___193_11780 = hd1 in
                      let uu____11781 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___193_11780.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___193_11780.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____11781
                      } in
                    let hd21 =
                      let uu___194_11785 = hd2 in
                      let uu____11786 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___194_11785.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___194_11785.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____12114,FStar_Pervasives_Native.Some (t11,t21)) ->
                   solve_t env1
                     (let uu___195_12128 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___195_12128.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___195_12128.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___195_12128.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___195_12128.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___195_12128.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___195_12128.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___195_12128.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___195_12128.FStar_TypeChecker_Common.rank)
                      }) wl1
                                                  ...
                                                  solve_t env1
                                                    (let uu___196_12491 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___196_12491.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___161_13576 =
          match uu___161_13576 with
          | FStar_Pervasives_Native.None  ->
             ...
             ((let uu____16722 =
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed uu____16726,uu____16727) ->
                   let uu____16754 =
                     let uu___197_16755 = problem in
                     let uu____16756 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___197_16755.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16756;
                       FStar_TypeChecker_Common.relation =
                         (uu___197_16755.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___197_16755.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___197_16755.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___197_16755.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___197_16755.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___197_16755.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___197_16755.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___197_16755.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16754 wl
               | (FStar_Syntax_Syntax.Tm_meta uu____16757,uu____16758) ->
                   let uu____16765 =
                     let uu___197_16766 = problem in
                     let uu____16767 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___197_16766.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16767;
                       FStar_TypeChecker_Common.relation =
                         (uu___197_16766.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___197_16766.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___197_16766.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___197_16766.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___197_16766.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___197_16766.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___197_16766.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___197_16766.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16765 wl
               | (uu____16768,FStar_Syntax_Syntax.Tm_ascribed uu____16769) ->
                   let uu____16796 =
                     let uu___198_16797 = problem in
                     let uu____16798 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___198_16797.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___198_16797.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___198_16797.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16798;
                       FStar_TypeChecker_Common.element =
                         (uu___198_16797.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___198_16797.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___198_16797.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___198_16797.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___198_16797.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___198_16797.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16796 wl
               | (uu____16799,FStar_Syntax_Syntax.Tm_meta uu____16800) ->
                   let uu____16807 =
                     let uu___198_16808 = problem in
                     let uu____16809 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___198_16808.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___198_16808.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___198_16808.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16809;
                       FStar_TypeChecker_Common.element =
                         (uu___198_16808.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___198_16808.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___198_16808.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___198_16808.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___198_16808.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___198_16808.FStar_TypeChecker_Common.rank)
                     } in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___162_16868 =
                     match uu___162_16868 with
                     | [] -> c
                     | bs ->
                         let uu____16890 =
                           FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___163_17119 =
                     match uu___163_17119 with
                     | [] -> t
                     | bs ->
                         FStar_Syntax_Syntax.mk
                     ...
                     then t
                       ...
                       (let uu____17390 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___199_17398 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___199_17398.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___199_17398.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___199_17398.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___199_17398.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___199_17398.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___199_17398.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___199_17398.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___199_17398.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___199_17398.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___199_17398.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___199_17398.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___199_17398.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___199_17398.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___199_17398.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___199_17398.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___199_17398.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___199_17398.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___199_17398.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___199_17398.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___199_17398.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___199_17398.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___199_17398.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___199_17398.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___199_17398.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___199_17398.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___199_17398.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___199_17398.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___199_17398.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___199_17398.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___199_17398.FStar_TypeChecker_Env.dsenv)
                             }) t in
                        ...
                        | (uu____17401,ty,uu____17403) ->
                            ...
                            FStar_TypeChecker_Normalize.eta_expand_with_type
                              env t uu____17404) in
                   let uu____17405 =
                     let uu____17422 = maybe_eta t1 in
                     let uu____17429 = maybe_eta t2 in
                     (uu____17422, uu____17429) in
                   (match uu____17405 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___200_17471 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___200_17471.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___200_17471.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___200_17471.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___200_17471.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___200_17471.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___200_17471.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___200_17471.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___200_17471.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___201_17510 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___201_17510.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___201_17510.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___201_17510.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___201_17510.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___201_17510.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___201_17510.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___201_17510.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___201_17510.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____17534
                        then
                          let uu____17535 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____17535 t_abs wl
                        else
                          (let t11 = force_eta t1 in
                           let t21 = force_eta t2 in
                           if (is_abs t11) && (is_abs t21)
                           then
                             solve_t env
                               (let uu___201_17550 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___201_17550.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___201_17550.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___201_17550.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___201_17550.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___201_17550.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___201_17550.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___201_17550.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___201_17550.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
               ...
               | (uu____17571,FStar_Syntax_Syntax.Tm_abs uu____17572) ->
                   let is_abs t =
                     match t.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_abs uu____17597 -> true
                     | uu____17614 -> false in
                   let maybe_eta t =
                     if is_abs t
                     then FStar_Util.Inl t
                     else
                   ...
                   let force_eta t =
                     ...
                     then t
                       ...
                       (let uu____17661 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___199_17669 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___199_17669.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___199_17669.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___199_17669.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___199_17669.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___199_17669.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___199_17669.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___199_17669.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___199_17669.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___199_17669.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___199_17669.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___199_17669.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___199_17669.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___199_17669.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___199_17669.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___199_17669.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___199_17669.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___199_17669.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___199_17669.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___199_17669.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___199_17669.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___199_17669.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___199_17669.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___199_17669.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___199_17669.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___199_17669.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___199_17669.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___199_17669.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___199_17669.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___199_17669.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___199_17669.FStar_TypeChecker_Env.dsenv)
                             }) t in
                        match uu____17661 with
                        | (uu____17672,ty,uu____17674) ->
                            let uu____17675 =
                              FStar_TypeChecker_Normalize.unfold_whnf env ty in
                            FStar_TypeChecker_Normalize.eta_expand_with_type
                              env t uu____17675) in
                   let uu____17676 =
                     let uu____17693 = maybe_eta t1 in
                     let uu____17700 = maybe_eta t2 in
                     (uu____17693, uu____17700) in
                   (match uu____17676 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___200_17742 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___200_17742.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___200_17742.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___200_17742.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___200_17742.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___200_17742.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___200_17742.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___200_17742.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___200_17742.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        let uu____17765 =
                          (is_flex not_abs) &&
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___201_17781 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___201_17781.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___201_17781.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___201_17781.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___201_17781.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___201_17781.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___201_17781.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___201_17781.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___201_17781.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____17805
                        then
                          let uu____17806 = destruct_flex_pattern env not_abs in
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___201_17821 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___201_17821.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___201_17821.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___201_17821.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___201_17821.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___201_17821.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___201_17821.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___201_17821.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___201_17821.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                    ...
                    | uu____17825 ->
                        failwith
                          "Impossible: at least one side is an abstraction")
               | (FStar_Syntax_Syntax.Tm_refine
                  uu____17842,FStar_Syntax_Syntax.Tm_refine uu____17843) ->
                   let uu____17856 = as_refinement env wl t1 in
                   (match uu____17856 with
                    | (x1,phi1) ->
                        let uu____17863 = as_refinement env wl t2 in
                        (match uu____17863 with
                         | (x2,phi2) ->
                               ...
                               let guard =
                                 let uu____17919 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst in
                                 FStar_Syntax_Util.mk_conj uu____17919 impl in
                               let wl1 =
                                 solve_prob orig
                             ...
                             then
                               let ref_prob =
                                 let uu____17928 =
                                   let uu____17933 =
                                     ...
                                     uu____17934 :: (p_scope orig) in
                                   mk_problem uu____17933 orig phi11
                               ...
                               let uu____17939 =
                                 solve env1
                                   (let uu___202_17941 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___202_17941.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___202_17941.smt_ok);
                                      tcenv = (uu___202_17941.tcenv)
                                    }) in
                               (match uu____17939 with
                                | Failed uu____17948 -> fallback ()
                                | Success uu____17953 ->
                                    let guard =
                                      let uu____17957 =
                                        FStar_All.pipe_right
                                      ...
                                      let uu____17962 =
                                        let uu____17963 =
                                          FStar_All.pipe_right
                                            (p_guard ref_prob)
                                            FStar_Pervasives_Native.fst in
                                        FStar_All.pipe_right uu____17963
                                          (guard_on_element wl problem x11) in
                                      FStar_Syntax_Util.mk_conj uu____17957
                                        uu____17962 in
                                    let wl1 =
                                      solve_prob orig
                                        ...
                                        [] wl in
                                    let wl2 =
                                      let uu___203_17972 = wl1 in
                                      {
                                        attempting =
                                          (uu___203_17972.attempting);
                                        wl_deferred =
                                          (uu___203_17972.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___203_17972.defer_ok);
                                        smt_ok = (uu___203_17972.smt_ok);
                                        tcenv = (uu___203_17972.tcenv)
                                      } in
                                    solve env1 (attempt [base_prob] wl2))
                             else fallback ()))
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17974,FStar_Syntax_Syntax.Tm_uvar uu____17975) ->
                   let uu____18008 = destruct_flex_t t1 in
                   let uu____18009 = destruct_flex_t t2 in
                   flex_flex1 orig uu____18008 uu____18009
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18010;
                     FStar_Syntax_Syntax.pos = uu____18011;
                     FStar_Syntax_Syntax.vars = uu____18012;_},uu____18013),FStar_Syntax_Syntax.Tm_uvar
                  uu____18014) ->
                   let uu____18067 = destruct_flex_t t1 in
                   let uu____18068 = destruct_flex_t t2 in
                   flex_flex1 orig uu____18067 uu____18068
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18069,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18070;
                     FStar_Syntax_Syntax.pos = uu____18071;
                     FStar_Syntax_Syntax.vars = uu____18072;_},uu____18073))
                   ->
                   let uu____18126 = destruct_flex_t t1 in
                   let uu____18127 = destruct_flex_t t2 in
                   flex_flex1 orig uu____18126 uu____18127
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18128;
                     FStar_Syntax_Syntax.pos = uu____18129;
                     FStar_Syntax_Syntax.vars = uu____18130;_},uu____18131),FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18132;
                     FStar_Syntax_Syntax.pos = uu____18133;
                     FStar_Syntax_Syntax.vars = uu____18134;_},uu____18135))
                   ->
                   let uu____18208 = destruct_flex_t t1 in
                   let uu____18209 = destruct_flex_t t2 in
                   flex_flex1 orig uu____18208 uu____18209
               | (FStar_Syntax_Syntax.Tm_uvar uu____18210,uu____18211) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____18228 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____18228 t2 wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18235;
                     FStar_Syntax_Syntax.pos = uu____18236;
                     FStar_Syntax_Syntax.vars = uu____18237;_},uu____18238),uu____18239)
                   when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____18276 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____18276 t2 wl
               | (uu____18283,FStar_Syntax_Syntax.Tm_uvar uu____18284) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
               ...
               | (uu____18301,FStar_Syntax_Syntax.Tm_app
                  ({
                   ...
                   -> solve_t env (invert problem) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18342,FStar_Syntax_Syntax.Tm_type uu____18343) ->
                   solve_t' env
                     (let uu___204_18361 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___204_18361.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___204_18361.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___204_18361.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___204_18361.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___204_18361.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___204_18361.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___204_18361.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___204_18361.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___204_18361.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                     ...
                     FStar_Syntax_Syntax.vars = uu____18364;_},uu____18365),FStar_Syntax_Syntax.Tm_type
                  uu____18366) ->
                   solve_t' env
                     (let uu___204_18404 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___204_18404.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___204_18404.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___204_18404.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___204_18404.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___204_18404.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___204_18404.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___204_18404.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___204_18404.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___204_18404.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18405,FStar_Syntax_Syntax.Tm_arrow uu____18406) ->
                   solve_t' env
                     (let uu___204_18436 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___204_18436.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___204_18436.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___204_18436.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___204_18436.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___204_18436.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___204_18436.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___204_18436.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___204_18436.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___204_18436.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                     ...
                     FStar_Syntax_Syntax.vars = uu____18439;_},uu____18440),FStar_Syntax_Syntax.Tm_arrow
                  uu____18441) ->
                   solve_t' env
                     (let uu___204_18491 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___204_18491.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___204_18491.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___204_18491.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___204_18491.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___204_18491.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___204_18491.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___204_18491.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___204_18491.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___204_18491.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar uu____18492,uu____18493) ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____18512 =
                        let uu____18513 = is_top_level_prob orig in
                        FStar_All.pipe_left Prims.op_Negation uu____18513 in
                      if uu____18512
                      then
                        let uu____18514 =
                          FStar_All.pipe_left
                            ...
                            (let uu___205_18520 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___205_18520.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___205_18520.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___205_18520.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___205_18520.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___205_18520.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___205_18520.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___205_18520.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___205_18520.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___205_18520.FStar_TypeChecker_Common.rank)
                             }) in
                        let uu____18521 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____18514 uu____18521 t2
                          wl
                      else
                        (let uu____18529 = base_and_refinement env wl t2 in
                              ...
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18572 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___206_18578 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___206_18578.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___206_18578.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___206_18578.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___206_18578.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___206_18578.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___206_18578.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___206_18578.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___206_18578.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___206_18578.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18579 =
                                    destruct_flex_pattern env t1 in
                                  solve_t_flex_rigid false uu____18572
                                    uu____18579 t_base wl
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___207_18599 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___207_18599.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___207_18599.FStar_Syntax_Syntax.index);
                                  ...
                                  let guard =
                                    let uu____18614 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob)
                                        FStar_Pervasives_Native.fst in
                                    FStar_Syntax_Util.mk_conj uu____18614
                                      impl in
                                  let wl1 =
                                    solve_prob orig
                                      (FStar_Pervasives_Native.Some guard) []
               ...
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18622;
                     FStar_Syntax_Syntax.pos = uu____18623;
                     FStar_Syntax_Syntax.vars = uu____18624;_},uu____18625),uu____18626)
                   ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____18665 =
                        let uu____18666 = is_top_level_prob orig in
                        FStar_All.pipe_left Prims.op_Negation uu____18666 in
                      if uu____18665
                      then
                        let uu____18667 =
                          FStar_All.pipe_left
                            ...
                            (let uu___205_18673 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___205_18673.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___205_18673.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___205_18673.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___205_18673.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___205_18673.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___205_18673.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___205_18673.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___205_18673.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___205_18673.FStar_TypeChecker_Common.rank)
                             }) in
                        let uu____18674 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____18667 uu____18674 t2
                          wl
                      else
                        (let uu____18682 = base_and_refinement env wl t2 in
                              ...
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18725 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___206_18731 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___206_18731.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___206_18731.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___206_18731.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___206_18731.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___206_18731.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___206_18731.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___206_18731.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___206_18731.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___206_18731.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18732 =
                                    destruct_flex_pattern env t1 in
                                  solve_t_flex_rigid false uu____18725
                                    uu____18732 t_base wl
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___207_18752 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___207_18752.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___207_18752.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort = t1
                                    } in
                                  let impl =
                                    guard_on_element wl problem y' phi in
                                  ...
                                  let guard =
                                    let uu____18767 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob)
                                        FStar_Pervasives_Native.fst in
                                    FStar_Syntax_Util.mk_conj uu____18767
                                      impl in
                                  let wl1 =
                                    solve_prob orig
                                      (FStar_Pervasives_Native.Some guard) []
                                      wl in
                                  solve env (attempt [base_prob] wl1))))
               | (uu____18775,FStar_Syntax_Syntax.Tm_uvar uu____18776) ->
                   if wl.defer_ok
                   then
                     solve env
                       (defer "rigid-flex subtyping deferred" orig wl)
                   else
                     (let uu____18794 = base_and_refinement env wl t1 in
                      match uu____18794 with
                      | (t_base,uu____18810) ->
                          solve_t env
                            (let uu___208_18832 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___208_18832.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___208_18832.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___208_18832.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___208_18832.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___208_18832.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___208_18832.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___208_18832.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___208_18832.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (uu____18835,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18836;
                     FStar_Syntax_Syntax.pos = uu____18837;
                     FStar_Syntax_Syntax.vars = uu____18838;_},uu____18839))
                   ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let uu____18877 = base_and_refinement env wl t1 in
                      match uu____18877 with
                      | (t_base,uu____18893) ->
                          solve_t env
                            (let uu___208_18915 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___208_18915.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___208_18915.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___208_18915.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___208_18915.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___208_18915.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___208_18915.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___208_18915.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___208_18915.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____18918,uu____18919) ->
                   let t21 =
                     let uu____18929 = base_and_refinement env wl t2 in
                     FStar_All.pipe_left force_refinement uu____18929 in
                   solve_t env
                     (let uu___209_18953 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___209_18953.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___209_18953.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___209_18953.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___209_18953.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___209_18953.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___209_18953.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___209_18953.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___209_18953.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___209_18953.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____18954,FStar_Syntax_Syntax.Tm_refine uu____18955) ->
                   let t11 =
                     let uu____18965 = base_and_refinement env wl t1 in
                     FStar_All.pipe_left force_refinement uu____18965 in
                   solve_t env
                     (let uu___210_18989 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___210_18989.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___210_18989.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___210_18989.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___210_18989.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___210_18989.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___210_18989.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___210_18989.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___210_18989.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___210_18989.FStar_TypeChecker_Common.rank)
                      }) wl
          ...
          let lift_c1 uu____20828 =
            ...
            let uu____20865 =
              let uu____20874 =
                ...
                FStar_Syntax_Syntax.as_arg uu____20875 in
              [uu____20874] in
            {
              FStar_Syntax_Syntax.comp_univs =
              ...
              FStar_Syntax_Syntax.effect_args = uu____20865;
               ...
               | uu____20979 ->
                   let uu____21000 =
                     let uu____21001 =
                       ...
                       (uu____21006, (env.FStar_TypeChecker_Env.range)) in
                     FStar_Errors.Error uu____21001 in
                   FStar_Exn.raise uu____21000 in
             match uu____20884 with
             | (wpc1,wpc2) ->
                 let uu____21027 = FStar_Util.physical_equality wpc1 wpc2 in
                 if uu____21027
                 then
                   let uu____21030 =
                   ...
                   solve_t env uu____21030 wl
                 else
                   (let uu____21034 =
                      let uu____21041 =
                        FStar_TypeChecker_Env.effect_decl_opt env
                          c21.FStar_Syntax_Syntax.effect_name in
                      FStar_Util.must uu____21041 in
                    ...
                    | (c2_decl,qualifiers) ->
                        ...
                        then
                          let c1_repr =
                            let uu____21066 =
                              let uu____21067 =
                                let uu____21068 = lift_c1 () in
                                FStar_Syntax_Syntax.mk_Comp uu____21068 in
                              let uu____21069 =
                                env.FStar_TypeChecker_Env.universe_of env
                                  c11.FStar_Syntax_Syntax.result_typ in
                              FStar_TypeChecker_Env.reify_comp env
                                uu____21067 uu____21069 in
                            FStar_TypeChecker_Normalize.normalize
                              [FStar_TypeChecker_Normalize.UnfoldUntil
                                 FStar_Syntax_Syntax.Delta_constant;
                          ...
                          let prob =
                            let uu____21075 =
                              let uu____21080 =
                                ...
                                FStar_Util.format2
                                  "sub effect repr: %s <: %s" uu____21081
                                  uu____21082 in
                              sub_prob c1_repr
                                problem.FStar_TypeChecker_Common.relation
                                c2_repr uu____21080 in
                            FStar_TypeChecker_Common.TProb uu____21075 in
                          let wl1 =
                            let uu____21084 =
                              let uu____21087 =
                                FStar_All.pipe_right (p_guard prob)
                                  FStar_Pervasives_Native.fst in
                              FStar_Pervasives_Native.Some uu____21087 in
                            solve_prob orig uu____21084 [] wl in
                                    ...
                                    let uu____21138 =
                                      let uu____21139 =
                                        ...
                                        let uu____21157 =
                                          ...
                                          uu____21160 :: uu____21161 in
                                        (uu____21154, uu____21157) in
                             ...
                             let uu____21186 =
                               let uu____21189 =
                                 let uu____21192 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst in
                                 FStar_Syntax_Util.mk_conj uu____21192 g in
                               FStar_All.pipe_left
                                 (fun _0_92  ->
                                    FStar_Pervasives_Native.Some _0_92)
                                 uu____21189 in
                             solve_prob orig uu____21186 [] wl in
                           solve env (attempt [base_prob] wl1)))) in
        let uu____21205 = FStar_Util.physical_equality c1 c2 in
        if uu____21205
        then
          let uu____21206 =
            solve_prob orig FStar_Pervasives_Native.None [] wl in
          solve env uu____21206
        else
          ((let uu____21209 =
              FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                (FStar_Options.Other "Rel") in
            if uu____21209
            then
              let uu____21210 = FStar_Syntax_Print.comp_to_string c1 in
              let uu____21211 = FStar_Syntax_Print.comp_to_string c2 in
            ...
            | (c11,c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu____21223),FStar_Syntax_Syntax.Total
                    (t2,uu____21225)) when
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu____21332,FStar_Syntax_Syntax.Comp uu____21333) ->
                     let uu____21342 =
                       let uu___211_21347 = problem in
                       let uu____21352 =
                         let uu____21353 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___211_21347.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21352;
                         FStar_TypeChecker_Common.relation =
                           (uu___211_21347.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___211_21347.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___211_21347.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___211_21347.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___211_21347.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___211_21347.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___211_21347.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___211_21347.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21342 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____21354,FStar_Syntax_Syntax.Comp uu____21355) ->
                     let uu____21364 =
                       let uu___211_21369 = problem in
                       let uu____21374 =
                         let uu____21375 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___211_21369.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21374;
                         FStar_TypeChecker_Common.relation =
                           (uu___211_21369.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___211_21369.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___211_21369.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___211_21369.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___211_21369.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___211_21369.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___211_21369.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___211_21369.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21364 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21376,FStar_Syntax_Syntax.GTotal uu____21377) ->
                     let uu____21386 =
                       let uu___212_21391 = problem in
                       let uu____21396 =
                         let uu____21397 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___212_21391.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___212_21391.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___212_21391.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21396;
                         FStar_TypeChecker_Common.element =
                           (uu___212_21391.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___212_21391.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___212_21391.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___212_21391.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___212_21391.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___212_21391.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21386 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21398,FStar_Syntax_Syntax.Total uu____21399) ->
                     let uu____21408 =
                       let uu___212_21413 = problem in
                       let uu____21418 =
                         let uu____21419 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___212_21413.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___212_21413.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___212_21413.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21418;
                         FStar_TypeChecker_Common.element =
                           (uu___212_21413.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___212_21413.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___212_21413.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___212_21413.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___212_21413.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___212_21413.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21408 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21420,FStar_Syntax_Syntax.Comp uu____21421) ->
                     let uu____21422 =
...
let ineqs_to_string:
  ...
  fun ineqs  ->
    let vars =
      ...
      FStar_All.pipe_right uu____21553 (FStar_String.concat ", ") in
    let ineqs1 =
      let uu____21571 =
        FStar_All.pipe_right (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu____21599  ->
                ...
                | (u1,u2) ->
                    let uu____21606 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____21607 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____21606 uu____21607)) in
      FStar_All.pipe_right uu____21571 (FStar_String.concat ", ") in
...
let guard_to_string:
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____21626,[])) -> "{}"
      | uu____21651 ->
          let form =
            match g.FStar_TypeChecker_Env.guard_f with
            ...
            let uu____21671 =
              FStar_List.map
                (fun uu____21681  ->
                   ...
                   | (uu____21686,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred in
            FStar_All.pipe_right uu____21671 (FStar_String.concat ",\n") in
          let imps = print_pending_implicits g in
          let uu____21691 =
            ineqs_to_string g.FStar_TypeChecker_Env.univ_ineqs in
          FStar_Util.format4
            "\n\t{guard_f=%s;\n\t deferred={\n%s};\n\t univ_ineqs={%s};\n\t implicits={%s}}\n"
            form carry uu____21691 imps
let new_t_problem:
  'Auu____21706 .
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.term ->
        FStar_TypeChecker_Common.rel ->
          FStar_Syntax_Syntax.term ->
            'Auu____21706 FStar_Pervasives_Native.option ->
              FStar_Range.range ->
                (FStar_Syntax_Syntax.term,'Auu____21706)
                  FStar_TypeChecker_Common.problem
  =
  fun env  ->
    fun lhs  ->
          ...
          let x =
            let uu____21770 =
              ...
              FStar_All.pipe_left
                ...
                uu____21773 in
            FStar_Syntax_Syntax.new_bv uu____21770 t1 in
          let env1 = FStar_TypeChecker_Env.push_bv env x in
          let p =
            let uu____21782 =
              let uu____21785 = FStar_Syntax_Syntax.bv_to_name x in
              FStar_All.pipe_left
                (fun _0_94  -> FStar_Pervasives_Native.Some _0_94)
                uu____21785 in
            let uu____21788 = FStar_TypeChecker_Env.get_range env1 in
            new_t_problem env1 t1 rel t2 uu____21782 uu____21788 in
...
let solve_and_commit:
  ...
  fun env  ->
    fun probs  ->
      fun err1  ->
        let probs1 =
          let uu____21821 = FStar_Options.eager_inference () in
          if uu____21821
          then
            let uu___213_21822 = probs in
            {
              attempting = (uu___213_21822.attempting);
              wl_deferred = (uu___213_21822.wl_deferred);
              ctr = (uu___213_21822.ctr);
              defer_ok = false;
              smt_ok = (uu___213_21822.smt_ok);
              tcenv = (uu___213_21822.tcenv)
            }
          else probs in
        let tx = FStar_Syntax_Unionfind.new_transaction () in
        ...
        | Failed (d,s) ->
            (FStar_Syntax_Unionfind.rollback tx;
             (let uu____21834 =
              ...
              if uu____21834
              then
                let uu____21835 = explain env d s in
                FStar_All.pipe_left FStar_Util.print_string uu____21835
              else ());
             err1 (d, s))
let simplify_guard:
  FStar_TypeChecker_Env.env ->
          ...
          ((let uu____21847 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___214_21862 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___214_21862.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___214_21862.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___214_21862.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____21884 =
              let uu____21885 =
                ...
                {
                  FStar_TypeChecker_Env.guard_f = uu____21886;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____21885 in
            FStar_All.pipe_left
              (fun _0_96  -> FStar_Pervasives_Native.Some _0_96) uu____21884
      ...
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____21938 =
              ...
              {
                FStar_TypeChecker_Env.guard_f = uu____21939;
                FStar_TypeChecker_Env.deferred = d;
                FStar_TypeChecker_Env.univ_ineqs = ([], []);
                FStar_TypeChecker_Env.implicits = []
              } in
            FStar_Pervasives_Native.Some uu____21938
let try_teq:
  Prims.bool ->
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.typ ->
          ...
          (let prob =
             let uu____21987 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____21992 in
             FStar_All.pipe_left
...
let teq:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22026 = try_teq true env t1 t2 in
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____22029 =
              let uu____22030 =
                ...
                (uu____22035, uu____22036) in
              FStar_Errors.Error uu____22030 in
            FStar_Exn.raise uu____22029
        | FStar_Pervasives_Native.Some g ->
            ((let uu____22039 =
              ...
              if uu____22039
              then
                let uu____22040 = FStar_Syntax_Print.term_to_string t1 in
                let uu____22041 = FStar_Syntax_Print.term_to_string t2 in
                let uu____22042 = guard_to_string env g in
                FStar_Util.print3
        ...
        fun smt_ok  ->
          ...
          (let uu____22067 =
           ...
           | (prob,x) ->
               let g =
                 let uu____22079 =
                   let uu____22082 = singleton' env prob smt_ok in
                   solve_and_commit env uu____22082
                     (fun uu____22084  -> FStar_Pervasives_Native.None) in
                 FStar_All.pipe_left (with_guard env prob) uu____22079 in
               ((let uu____22094 =
                   (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                      (FStar_Options.Other "Rel"))
                 ...
                 then
                   ...
                   let uu____22096 =
                     FStar_TypeChecker_Normalize.term_to_string env t2 in
                   let uu____22097 =
                     let uu____22098 = FStar_Util.must g in
                     guard_to_string env uu____22098 in
                   FStar_Util.print3
    ...
    fun e  ->
      fun t1  ->
        fun t2  ->
          ...
          FStar_Errors.err uu____22130 uu____22131
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
      FStar_Syntax_Syntax.comp ->
    ...
    fun c1  ->
      fun c2  ->
        (let uu____22147 =
         ...
         if uu____22147
         then
           let uu____22148 = FStar_Syntax_Print.comp_to_string c1 in
           let uu____22149 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        (let rel =
         ...
         let prob =
           let uu____22154 =
             let uu____22159 = FStar_TypeChecker_Env.get_range env in
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____22159 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_99  -> FStar_TypeChecker_Common.CProb _0_99) uu____22154 in
         let uu____22164 =
           let uu____22167 = singleton env prob in
           solve_and_commit env uu____22167
             (fun uu____22169  -> FStar_Pervasives_Native.None) in
         FStar_All.pipe_left (with_guard env prob) uu____22164)
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____22240 =
                 let uu____22241 =
                   let uu____22246 =
                     let uu____22247 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____22248 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____22247 uu____22248 in
                   let uu____22249 = FStar_TypeChecker_Env.get_range env in
                   (uu____22246, uu____22249) in
                 FStar_Errors.Error uu____22241 in
               FStar_Exn.raise uu____22240) in
            let equiv1 v1 v' =
              let uu____22257 =
                let uu____22262 = FStar_Syntax_Subst.compress_univ v1 in
                let uu____22263 = FStar_Syntax_Subst.compress_univ v' in
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____22312 = FStar_Syntax_Subst.compress_univ v1 in
                      match uu____22312 with
                      | FStar_Syntax_Syntax.U_unif uu____22319 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____22348  ->
                                    ...
                                    | (u,v') ->
                                        let uu____22357 = equiv1 v1 v' in
                                        if uu____22357
                                        then
                                          let uu____22360 =
                                            FStar_All.pipe_right variables
                                              (FStar_Util.for_some (equiv1 u)) in
                                          (if uu____22360 then [] else [u])
                                        else [])) in
                          let lb =
            ...
            let uu____22381 =
              let wl =
                let uu___215_22385 = empty_worklist env in
                {
                  attempting = (uu___215_22385.attempting);
                  wl_deferred = (uu___215_22385.wl_deferred);
                  ctr = (uu___215_22385.ctr);
                  defer_ok = false;
                  smt_ok = (uu___215_22385.smt_ok);
                  tcenv = (uu___215_22385.tcenv)
                } in
                   ...
                   (fun uu____22403  ->
                      ...
                      | (lb,v1) ->
                          ...
                          (match uu____22410 with
                           | USolved wl1 -> ()
                           | uu____22412 -> fail lb v1))) in
            let rec check_ineq uu____22420 =
              ...
              | (u,v1) ->
                  ...
                  (match (u1, v2) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____22429) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu____22452,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu____22454,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_max us,uu____22465) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u2  -> check_ineq (u2, v2)))
                   | (uu____22472,FStar_Syntax_Syntax.U_max vs) ->
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____22500  ->
                      ...
                      | (u,v1) ->
                          let uu____22507 = check_ineq (u, v1) in
                          if uu____22507
                          then true
                          else
                            ((let uu____22510 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____22511
                                  uu____22512
                              else ());
                             false))) in
            if uu____22485
            then ()
              ...
              ((let uu____22516 =
                ...
                if uu____22516
                then
                  ((let uu____22518 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
                      "Partially solved inequality constraints are: %s\n"
                      uu____22518);
                   FStar_Syntax_Unionfind.rollback tx;
                   (let uu____22528 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
               ...
               (let uu____22538 =
                  let uu____22539 =
                    let uu____22544 = FStar_TypeChecker_Env.get_range env in
                    ("Failed to solve universe inequalities for inductives",
                      uu____22544) in
                  FStar_Errors.Error uu____22539 in
                FStar_Exn.raise uu____22538))
let solve_universe_inequalities:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.universe Prims.list,(FStar_Syntax_Syntax.universe,
                                               FStar_Syntax_Syntax.universe)
...
let rec solve_deferred_constraints:
  ...
  fun env  ->
    fun g  ->
      ...
      (let g1 =
         let uu____22627 = solve_and_commit env wl fail in
         match uu____22627 with
         | FStar_Pervasives_Native.Some [] ->
             let uu___216_22640 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___216_22640.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___216_22640.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___216_22640.FStar_TypeChecker_Env.implicits)
             }
         | uu____22645 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___217_22649 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___217_22649.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___217_22649.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___217_22649.FStar_TypeChecker_Env.implicits)
        }))
let last_proof_ns:
...
let maybe_update_proof_ns: FStar_TypeChecker_Env.env -> Prims.unit =
  fun env  ->
    ...
    let uu____22672 = FStar_ST.op_Bang last_proof_ns in
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___218_22859 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___218_22859.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___218_22859.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___218_22859.FStar_TypeChecker_Env.implicits)
            } in
          let uu____22860 =
            let uu____22861 = FStar_TypeChecker_Env.should_verify env in
            Prims.op_Negation uu____22861 in
          if uu____22860
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____22869 =
                   ...
                   if uu____22869
                   then
                     let uu____22870 = FStar_TypeChecker_Env.get_range env in
                     let uu____22871 =
                       let uu____22872 = FStar_Syntax_Print.term_to_string vc in
                  ...
                  (let vc1 =
                   ...
                   let uu____22875 = check_trivial vc1 in
                           ...
                           then
                             ...
                             let uu____22884 =
                               ...
                               FStar_Util.format1
                                 ...
                                 uu____22885 in
                             FStar_Errors.diag uu____22883 uu____22884
                           else ());
                          FStar_Pervasives_Native.None)
                       else
                         ((let uu____22890 =
                          ...
                          (let vcs =
                             let uu____22904 = FStar_Options.use_tactics () in
                             if uu____22904
                             then
                               FStar_Options.with_saved_options
                                 (fun uu____22923  ->
                                    (let uu____22925 =
                                     ...
                                     FStar_All.pipe_left
                                       FStar_Pervasives.ignore uu____22925);
                                    (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.preprocess
                                      env vc2)
                             else
                               (let uu____22927 =
                                  let uu____22934 = FStar_Options.peek () in
                                  (env, vc2, uu____22934) in
                                [uu____22927]) in
                                   ...
                                   | (env1,goal,opts) ->
                                       let goal1 =
                                         FStar_TypeChecker_Normalize.normalize
                                           ...
                                           env1 goal in
                                       let uu____22979 = check_trivial goal1 in
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____23010 =
            let uu____23011 =
              let uu____23016 = FStar_TypeChecker_Env.get_range env in
              ("Expected a trivial pre-condition", uu____23016) in
            FStar_Errors.Error uu____23011 in
          FStar_Exn.raise uu____23010
let discharge_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t
  =
...
let resolve_implicits':
  ...
  fun must_total  ->
    fun forcelax  ->
      fun g  ->
        let unresolved u =
          let uu____23047 = FStar_Syntax_Unionfind.find u in
          match uu____23047 with
          | FStar_Pervasives_Native.None  -> true
          | uu____23050 -> false in
        let rec until_fixpoint acc implicits =
          let uu____23068 = acc in
          ...
          | (out,changed) ->
              (match implicits with
               ...
               | hd1::tl1 ->
                   let uu____23154 = hd1 in
                   (match uu____23154 with
                    | (uu____23167,env,u,tm,k,r) ->
                        let uu____23173 = unresolved u in
                        if uu____23173
                           ...
                           (let uu____23204 =
                            ...
                            then
                              ...
                              FStar_Util.print3
                                ...
                                uu____23205 uu____23206 uu____23207
                            else ());
                           (let env2 =
                              if forcelax
                              then
                                let uu___219_23210 = env1 in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___219_23210.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___219_23210.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___219_23210.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___219_23210.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___219_23210.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___219_23210.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___219_23210.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___219_23210.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___219_23210.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___219_23210.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___219_23210.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___219_23210.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___219_23210.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___219_23210.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___219_23210.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___219_23210.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___219_23210.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___219_23210.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax = true;
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___219_23210.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.failhard =
                                    (uu___219_23210.FStar_TypeChecker_Env.failhard);
                                  FStar_TypeChecker_Env.nosynth =
                                    (uu___219_23210.FStar_TypeChecker_Env.nosynth);
                                  FStar_TypeChecker_Env.tc_term =
                                    (uu___219_23210.FStar_TypeChecker_Env.tc_term);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___219_23210.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___219_23210.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts =
                                    (uu___219_23210.FStar_TypeChecker_Env.use_bv_sorts);
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___219_23210.FStar_TypeChecker_Env.qname_and_index);
                                  FStar_TypeChecker_Env.proof_ns =
                                    (uu___219_23210.FStar_TypeChecker_Env.proof_ns);
                                  FStar_TypeChecker_Env.synth =
                                    (uu___219_23210.FStar_TypeChecker_Env.synth);
                                  FStar_TypeChecker_Env.is_native_tactic =
                                    (uu___219_23210.FStar_TypeChecker_Env.is_native_tactic);
                                  FStar_TypeChecker_Env.identifier_info =
                                    (uu___219_23210.FStar_TypeChecker_Env.identifier_info);
                                  FStar_TypeChecker_Env.tc_hooks =
                                    (uu___219_23210.FStar_TypeChecker_Env.tc_hooks);
                                  FStar_TypeChecker_Env.dsenv =
                                    (uu___219_23210.FStar_TypeChecker_Env.dsenv)
                                }
                              else env1 in
                            let g1 =
                              if must_total
                              then
                                let uu____23213 =
                                  env2.FStar_TypeChecker_Env.type_of
                                    (let uu___220_23221 = env2 in
                                     {
                                       FStar_TypeChecker_Env.solver =
                                         (uu___220_23221.FStar_TypeChecker_Env.solver);
                                       FStar_TypeChecker_Env.range =
                                         (uu___220_23221.FStar_TypeChecker_Env.range);
                                       FStar_TypeChecker_Env.curmodule =
                                         (uu___220_23221.FStar_TypeChecker_Env.curmodule);
                                       FStar_TypeChecker_Env.gamma =
                                         (uu___220_23221.FStar_TypeChecker_Env.gamma);
                                       FStar_TypeChecker_Env.gamma_cache =
                                         (uu___220_23221.FStar_TypeChecker_Env.gamma_cache);
                                       FStar_TypeChecker_Env.modules =
                                         (uu___220_23221.FStar_TypeChecker_Env.modules);
                                       FStar_TypeChecker_Env.expected_typ =
                                         (uu___220_23221.FStar_TypeChecker_Env.expected_typ);
                                       FStar_TypeChecker_Env.sigtab =
                                         (uu___220_23221.FStar_TypeChecker_Env.sigtab);
                                       FStar_TypeChecker_Env.is_pattern =
                                         (uu___220_23221.FStar_TypeChecker_Env.is_pattern);
                                       FStar_TypeChecker_Env.instantiate_imp
                                         =
                                         (uu___220_23221.FStar_TypeChecker_Env.instantiate_imp);
                                       FStar_TypeChecker_Env.effects =
                                         (uu___220_23221.FStar_TypeChecker_Env.effects);
                                       FStar_TypeChecker_Env.generalize =
                                         (uu___220_23221.FStar_TypeChecker_Env.generalize);
                                       FStar_TypeChecker_Env.letrecs =
                                         (uu___220_23221.FStar_TypeChecker_Env.letrecs);
                                       FStar_TypeChecker_Env.top_level =
                                         (uu___220_23221.FStar_TypeChecker_Env.top_level);
                                       FStar_TypeChecker_Env.check_uvars =
                                         (uu___220_23221.FStar_TypeChecker_Env.check_uvars);
                                       FStar_TypeChecker_Env.use_eq =
                                         (uu___220_23221.FStar_TypeChecker_Env.use_eq);
                                       FStar_TypeChecker_Env.is_iface =
                                         (uu___220_23221.FStar_TypeChecker_Env.is_iface);
                                       FStar_TypeChecker_Env.admit =
                                         (uu___220_23221.FStar_TypeChecker_Env.admit);
                                       FStar_TypeChecker_Env.lax =
                                         (uu___220_23221.FStar_TypeChecker_Env.lax);
                                       FStar_TypeChecker_Env.lax_universes =
                                         (uu___220_23221.FStar_TypeChecker_Env.lax_universes);
                                       FStar_TypeChecker_Env.failhard =
                                         (uu___220_23221.FStar_TypeChecker_Env.failhard);
                                       FStar_TypeChecker_Env.nosynth =
                                         (uu___220_23221.FStar_TypeChecker_Env.nosynth);
                                       FStar_TypeChecker_Env.tc_term =
                                         (uu___220_23221.FStar_TypeChecker_Env.tc_term);
                                       FStar_TypeChecker_Env.type_of =
                                         (uu___220_23221.FStar_TypeChecker_Env.type_of);
                                       FStar_TypeChecker_Env.universe_of =
                                         (uu___220_23221.FStar_TypeChecker_Env.universe_of);
                                       FStar_TypeChecker_Env.use_bv_sorts =
                                         true;
                                       FStar_TypeChecker_Env.qname_and_index
                                         =
                                         (uu___220_23221.FStar_TypeChecker_Env.qname_and_index);
                                       FStar_TypeChecker_Env.proof_ns =
                                         (uu___220_23221.FStar_TypeChecker_Env.proof_ns);
                                       FStar_TypeChecker_Env.synth =
                                         (uu___220_23221.FStar_TypeChecker_Env.synth);
                                       FStar_TypeChecker_Env.is_native_tactic
                                         =
                                         (uu___220_23221.FStar_TypeChecker_Env.is_native_tactic);
                                       FStar_TypeChecker_Env.identifier_info
                                         =
                                         (uu___220_23221.FStar_TypeChecker_Env.identifier_info);
                                       FStar_TypeChecker_Env.tc_hooks =
                                         (uu___220_23221.FStar_TypeChecker_Env.tc_hooks);
                                       FStar_TypeChecker_Env.dsenv =
                                         (uu___220_23221.FStar_TypeChecker_Env.dsenv)
                                     }) tm1 in
                                match uu____23213 with
                                | (uu____23222,uu____23223,g1) -> g1
                              else
                                (let uu____23226 =
                                   env2.FStar_TypeChecker_Env.tc_term
                                     (let uu___221_23234 = env2 in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___221_23234.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___221_23234.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___221_23234.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___221_23234.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___221_23234.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___221_23234.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___221_23234.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___221_23234.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.is_pattern =
                                          (uu___221_23234.FStar_TypeChecker_Env.is_pattern);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___221_23234.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___221_23234.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___221_23234.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___221_23234.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___221_23234.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___221_23234.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___221_23234.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___221_23234.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___221_23234.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax =
                                          (uu___221_23234.FStar_TypeChecker_Env.lax);
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___221_23234.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___221_23234.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___221_23234.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___221_23234.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___221_23234.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___221_23234.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          true;
                                        FStar_TypeChecker_Env.qname_and_index
                                          =
                                          (uu___221_23234.FStar_TypeChecker_Env.qname_and_index);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___221_23234.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth =
                                          (uu___221_23234.FStar_TypeChecker_Env.synth);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___221_23234.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___221_23234.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___221_23234.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___221_23234.FStar_TypeChecker_Env.dsenv)
                                      }) tm1 in
                                 match uu____23226 with
                                 | (uu____23235,uu____23236,g1) -> g1) in
                            let g2 =
                              if env2.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___222_23239 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___222_23239.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___222_23239.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___222_23239.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____23242 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
        let uu___223_23276 = g in
        let uu____23277 =
          until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___223_23276.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___223_23276.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs =
            (uu___223_23276.FStar_TypeChecker_Env.univ_ineqs);
          FStar_TypeChecker_Env.implicits = uu____23277
        }
let resolve_implicits:
  FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t =
...
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____23335 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____23335 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____23348 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____23348
      | (reason,uu____23350,uu____23351,e,t,r)::uu____23355 ->
          let uu____23382 =
            let uu____23383 =
              let uu____23388 =
                let uu____23389 = FStar_Syntax_Print.term_to_string t in
                let uu____23390 = FStar_Syntax_Print.term_to_string e in
                FStar_Util.format2
                  "Failed to resolve implicit argument of type '%s' introduced in %s"
                  uu____23389 uu____23390 in
              (uu____23388, r) in
            FStar_Errors.Error uu____23383 in
          FStar_Exn.raise uu____23382
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___224_23399 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___224_23399.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___224_23399.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___224_23399.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____23428 = try_teq false env t1 t2 in
        ...
        | FStar_Pervasives_Native.Some g ->
            ...
            (match uu____23432 with
             | FStar_Pervasives_Native.Some uu____23437 -> true
             | FStar_Pervasives_Native.None  -> false)