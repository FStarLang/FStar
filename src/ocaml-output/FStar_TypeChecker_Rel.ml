                               ...
                               then until_fixpoint (out, true) tl1
                                 ...
                                 (let env1 =
                                    let uu___4198_31160 = env  in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___4198_31160.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                                  ...
                                  let env2 =
                                    ...
                                    then
                                      let uu___4203_31164 = env1  in
                                      {
                                        ...
                                        FStar_TypeChecker_Env.try_solve_implicits_hook
                                          =
                                          (uu___4203_31164.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                        FStar_TypeChecker_Env.splice =
             ...
             let g =
               let uu____31443 =
                 solve_and_commit env (singleton wl prob true)
                   (fun uu____31452  -> FStar_Pervasives_Native.None)
                  in
             ...
             let g =
               let uu____31644 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____31653  -> FStar_Pervasives_Native.None)
                  in
