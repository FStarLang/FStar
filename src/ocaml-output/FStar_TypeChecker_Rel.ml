...
let term_to_string env t =
  ...
  | FStar_Syntax_Syntax.Tm_app
      ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (u,ty);
         FStar_Syntax_Syntax.tk = uu____307;
         FStar_Syntax_Syntax.pos = uu____308;
         FStar_Syntax_Syntax.vars = uu____309;_},args)
      ->
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        ...
        {
          attempting = [prob];
          wl_deferred = (uu___127_434.wl_deferred);
          ctr = (uu___127_434.ctr);
          defer_ok = (uu___127_434.defer_ok);
          smt_ok;
          tcenv = (uu___127_434.tcenv)
        }
...
let wl_of_guard env g =
  ...
  {
    attempting = _0_270;
    wl_deferred = (uu___128_459.wl_deferred);
    ctr = (uu___128_459.ctr);
    defer_ok = false;
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        ...
        {
          attempting = (uu___129_471.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___129_471.ctr);
          defer_ok = (uu___129_471.defer_ok);
          smt_ok = (uu___129_471.smt_ok);
          tcenv = (uu___129_471.tcenv)
        }
  ...
  fun probs  ->
    fun wl  ->
      let uu___130_483 = wl  in
      {
        ...
        wl_deferred = (uu___130_483.wl_deferred);
        ctr = (uu___130_483.ctr);
        defer_ok = (uu___130_483.defer_ok);
        smt_ok = (uu___130_483.smt_ok);
        tcenv = (uu___130_483.tcenv)
      }
...
let invert p =
  let uu___131_514 = p  in
  {
    FStar_TypeChecker_Common.pid =
      (uu___131_514.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
    FStar_TypeChecker_Common.relation =
      (invert_rel p.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
    FStar_TypeChecker_Common.element =
      (uu___131_514.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___131_514.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___131_514.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___131_514.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___131_514.FStar_TypeChecker_Common.loc);
...
let maybe_invert_p :
  ...
  fun uu___103_535  ->
    match uu___103_535 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_right (maybe_invert p)
          (fun _0_272  -> FStar_TypeChecker_Common.TProb _0_272)
    | FStar_TypeChecker_Common.CProb p ->
        FStar_All.pipe_right (maybe_invert p)
...
let p_invert : FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___111_614  ->
    match uu___111_614 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
          (fun _0_274  -> FStar_TypeChecker_Common.TProb _0_274) (invert p)
    | FStar_TypeChecker_Common.CProb p ->
        FStar_All.pipe_left
...
let mk_problem scope orig lhs rel rhs elt reason =
  ...
  let _0_277 = new_uvar FStar_Range.dummyRange scope FStar_Syntax_Util.ktype0
     in
  {
    FStar_TypeChecker_Common.pid = _0_278;
    FStar_TypeChecker_Common.lhs = lhs;
    FStar_TypeChecker_Common.relation = rel;
    FStar_TypeChecker_Common.rhs = rhs;
    FStar_TypeChecker_Common.element = elt;
    FStar_TypeChecker_Common.logical_guard = _0_277;
...
let problem_using_guard orig lhs rel rhs elt reason =
  ...
  {
    FStar_TypeChecker_Common.pid = _0_281;
    FStar_TypeChecker_Common.lhs = lhs;
    FStar_TypeChecker_Common.relation = rel;
    FStar_TypeChecker_Common.rhs = rhs;
    FStar_TypeChecker_Common.element = elt;
                  ...
                  let _0_292 =
                    ...
                    let _0_291 = sn env x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___132_962.FStar_Syntax_Syntax.ppname);
            ...
            | (uu____1610,uv) ->
                ((let uu____1613 =
                 ...
                 (let uu___133_1638 = wl  in
                  {
                    attempting = (uu___133_1638.attempting);
                    wl_deferred = (uu___133_1638.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___133_1638.defer_ok);
                    smt_ok = (uu___133_1638.smt_ok);
                    tcenv = (uu___133_1638.tcenv)
                  }))
    ...
    fun sol  ->
      fun wl  ->
        ...
        (let uu___134_1655 = wl  in
         {
           attempting = (uu___134_1655.attempting);
           wl_deferred = (uu___134_1655.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___134_1655.defer_ok);
           smt_ok = (uu___134_1655.smt_ok);
           tcenv = (uu___134_1655.tcenv)
         })
    ...
    fun logical_guard  ->
      fun uvis  ->
        fun wl  ->
          let conj_guard t g =
            match (t, g) with
            | (uu____1684,FStar_TypeChecker_Common.Trivial ) -> t
  ...
  let uu____1922 =
    FStar_All.pipe_right v2
      (FStar_List.fold_left
         (fun uu____1946  ->
            fun uu____1947  ->
              match (uu____1946, uu____1947) with
...
let binders_eq v1 v2 =
  ((FStar_List.length v1) = (FStar_List.length v2)) &&
    (FStar_List.forall2
       (fun uu____2080  ->
          fun uu____2081  ->
            match (uu____2080, uu____2081) with
            | ((a,uu____2091),(b,uu____2093)) ->
...
let destruct_flex_t t =
  ...
  | FStar_Syntax_Syntax.Tm_app
      ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uv,k);
         ...
         FStar_Syntax_Syntax.vars = uu____2297;_},args)
      -> (t, uv, k, args)
    ...
    fun fv  ->
      ...
      | FStar_Syntax_Syntax.Delta_abstract d ->
          (match (env.FStar_TypeChecker_Env.curmodule).FStar_Ident.str =
           ...
           with
           | true  -> d
           | uu____2615 -> FStar_Syntax_Syntax.Delta_constant)
      | d -> d
    ...
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_refine
           (x,uu____2750),FStar_Syntax_Syntax.Tm_refine (y,uu____2752)) ->
            let _0_338 =
        ...
        | (FStar_Syntax_Syntax.Tm_type _,FStar_Syntax_Syntax.Tm_type _)
          |(FStar_Syntax_Syntax.Tm_arrow _,FStar_Syntax_Syntax.Tm_arrow _) ->
            HeadMatch
        | (FStar_Syntax_Syntax.Tm_app
           (head,uu____2780),FStar_Syntax_Syntax.Tm_app (head',uu____2782))
            ->
           ...
           | (bs,c) ->
               let rebuild tcs =
                 let rec aux out bs tcs =
                   match (bs, tcs) with
                   | ((x,imp)::bs,(T (t,uu____3413))::tcs) ->
                       aux
                         (((let uu___135_3435 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___135_3435.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
...
let compress_tprob wl p =
  ...
  {
    FStar_TypeChecker_Common.pid =
      (uu___136_4259.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = _0_375;
    FStar_TypeChecker_Common.relation =
      (uu___136_4259.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = _0_374;
    FStar_TypeChecker_Common.element =
      (uu___136_4259.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___136_4259.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___136_4259.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___136_4259.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___136_4259.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
               ...
               (match uu____4320 with
                | (rh,uu____4333) ->
                    let uu____4348 =
                      ...
                      with
                      | (FStar_Syntax_Syntax.Tm_uvar
                         uu____4357,FStar_Syntax_Syntax.Tm_uvar uu____4358)
                          -> (flex_flex, tp)
                      | (FStar_Syntax_Syntax.Tm_uvar _,_)
                        |(_,FStar_Syntax_Syntax.Tm_uvar _) when
                          ...
                          -> (flex_rigid_eq, tp)
                      | (FStar_Syntax_Syntax.Tm_uvar uu____4383,uu____4384)
                          ->
                          let uu____4393 =
                               ...
                               (match ref_opt with
                                ...
                                | uu____4433 ->
                                    ...
                                    let _0_380 =
                                      ...
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___137_4444.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___137_4444.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___137_4444.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs = _0_379;
                                        FStar_TypeChecker_Common.element =
                                          (uu___137_4444.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___137_4444.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___137_4444.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___137_4444.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___137_4444.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                               ...
                               (match ref_opt with
                                ...
                                | uu____4504 ->
                                    let _0_382 =
                                      ...
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___138_4514.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs = _0_381;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___138_4514.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___138_4514.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___138_4514.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___138_4514.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___138_4514.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___138_4514.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___138_4514.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                         ...
                         let _0_384 =
                           FStar_All.pipe_right
                             (let uu___139_4540 = tp  in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___139_4540.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___139_4540.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___139_4540.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___139_4540.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___139_4540.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___139_4540.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___139_4540.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___139_4540.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___139_4540.FStar_TypeChecker_Common.loc);
          ...
          let _0_386 =
            FStar_All.pipe_right
              (let uu___140_4548 = cp  in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___140_4548.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___140_4548.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___140_4548.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___140_4548.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___140_4548.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___140_4548.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___140_4548.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___140_4548.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___140_4548.FStar_TypeChecker_Common.loc);
        ...
        fun u2  ->
          ...
          | (FStar_Syntax_Syntax.U_name x,FStar_Syntax_Syntax.U_name y) ->
              (match x.FStar_Ident.idText = y.FStar_Ident.idText with
               | true  -> USolved wl
               | uu____4828 -> UFailed "Incompatible universes")
          ...
          fun wl  ->
            ...
            | (FStar_Syntax_Syntax.Tm_uinst
               ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar f;
                  FStar_Syntax_Syntax.tk = uu____5356;
                  FStar_Syntax_Syntax.pos = uu____5357;
                  FStar_Syntax_Syntax.vars = uu____5358;_},us1),FStar_Syntax_Syntax.Tm_uinst
        ...
        (let uu____5397 =
         ...
         | (u,args) ->
             ...
             (match tt.FStar_Syntax_Syntax.n with
              | FStar_Syntax_Syntax.Tm_uvar (uv,uu____5641) ->
                  let uu____5654 =
                    FStar_All.pipe_right wl.attempting
                      (FStar_List.partition
                         (fun uu___121_5663  ->
                            match uu___121_5663 with
                            | FStar_TypeChecker_Common.TProb tp ->
                  ...
                  (match uu____5654 with
                   | (lower_bounds,rest) ->
                       let rec make_lower_bound uu____5736 tps =
         ...
         | (u,args) ->
             ...
             (match uu____5866 with
              | (ok,head_match,partial_match,fallback,failed_match) ->
                  ...
                  let tt = u  in
                  (match tt.FStar_Syntax_Syntax.n with
                   | FStar_Syntax_Syntax.Tm_uvar (uv,uu____6168) ->
                       let uu____6181 =
                         FStar_All.pipe_right wl.attempting
                           (FStar_List.partition
                              (fun uu___122_6190  ->
                                 match uu___122_6190 with
                                 | FStar_TypeChecker_Common.TProb tp ->
                       ...
                       (match uu____6181 with
                        | (upper_bounds,rest) ->
                            let rec make_upper_bound uu____6267 tps =
                                   ...
                                   | Success uu____6395 ->
                                       let wl =
                                         let uu___148_6397 = wl  in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___148_6397.wl_deferred);
                                           ctr = (uu___148_6397.ctr);
                                           defer_ok =
              ...
              let rec aux scope env subst xs ys =
                ...
                | ((hd1,imp)::xs,(hd2,imp')::ys) when imp = imp' ->
                    let hd1 =
                      ...
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___149_6500.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                    ...
                    let hd2 =
                      ...
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___150_6502.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
    ...
    fun problem  ->
      fun wl  ->
        ...
        let rigid_rigid_delta env orig wl head1 head2 t1 t2 =
          ...
          | (m,o) ->
              (match (m, o) with
               | (MisMatch uu____6623,uu____6624) ->
                   let may_relate head =
                     let uu____6639 =
                        ...
                        let guard =
                          ...
                          | uu____6650 ->
                              ...
                              (match problem.FStar_TypeChecker_Common.relation
                               ...
                               | uu____6666 -> has_type_guard t2 t1)
                           in
                        let _0_458 = solve_prob orig (Some guard) [] wl  in
                        solve env _0_458
                    | uu____6669 -> giveup env "head mismatch" orig)
               | (uu____6670,Some (t1,t2)) ->
                   solve_t env
                     (let uu___151_6678 = problem  in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___151_6678.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t1;
                        FStar_TypeChecker_Common.relation =
                          (uu___151_6678.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t2;
                        FStar_TypeChecker_Common.element =
                          (uu___151_6678.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___151_6678.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___151_6678.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___151_6678.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___151_6678.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___151_6678.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____6679,None ) ->
                   ((let uu____6686 =
                       FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                                                       ...
                                                       solve_t env
                                                         (let uu___152_6909 =
                                                            problem  in
                                                          {
                                                            FStar_TypeChecker_Common.pid
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.pid);
                                                            FStar_TypeChecker_Common.lhs
                                                              = lhs;
                                                            FStar_TypeChecker_Common.relation
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.relation);
                                                            FStar_TypeChecker_Common.rhs
                                                              = rhs;
                                                            FStar_TypeChecker_Common.element
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.element);
                                                            FStar_TypeChecker_Common.logical_guard
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.logical_guard);
                                                            FStar_TypeChecker_Common.scope
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.scope);
                                                            FStar_TypeChecker_Common.reason
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.reason);
                                                            FStar_TypeChecker_Common.loc
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.loc);
                                                            FStar_TypeChecker_Common.rank
                                                              =
                                                              (uu___152_6909.FStar_TypeChecker_Common.rank)
                                                          }) wl)))))))))
           in
        let imitate orig env wl p =
          let uu____6929 = p  in
          match uu____6929 with
          | (((u,k),xs,c),ps,(h,uu____6940,qs)) ->
              let xs = sn_binders env xs  in
              let r = FStar_TypeChecker_Env.get_range env  in
              let uu____6989 = imitation_sub_probs orig env xs ps qs  in
               ...
               | (sub_probs,gs_xs,formula) ->
                   ...
                   ((let uu____7028 =
                    ...
                    (let wl =
                     ...
                     solve env (attempt sub_probs wl))))
           in
        let imitate' orig env wl uu___123_7047 =
          match uu___123_7047 with
        ...
        let project orig env wl i p =
          ...
          | ((u,xs,c),ps,(h,matches,qs)) ->
              let r = FStar_TypeChecker_Env.get_range env  in
              let uu____7134 = FStar_List.nth ps i  in
              (match uu____7134 with
               | (pi,uu____7137) ->
                   let uu____7142 = FStar_List.nth xs i  in
                                ...
                                | (a,uu____7210)::tl ->
                                    let k_a =
                                      FStar_Syntax_Subst.subst subst
                                       ...
                                       in
                                    let uu____7218 = new_uvar r xs k_a  in
                                    (match uu____7218 with
                                     | (gi_xs,gi) ->
                                         ...
                                         let subst =
                                           ...
                                           :: subst  in
                                         let uu____7237 = aux subst tl  in
        ...
        let solve_t_flex_rigid patterns_only orig lhs t2 wl =
          ...
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
                                         ...
                                         (match uu____7545 with
                                          ...
                                          | Some scope ->
                                              ...
                                              (FStar_Unionfind.change uvar
                                               ...
                                               Some (xs, c)))
                                     | uu____7589 -> None))
                           | (FStar_Syntax_Syntax.Tm_arrow (xs,c),uu____7594)
                               ->
              ...
              let rec imitate_or_project n stopt i =
                ...
                | uu____7859 ->
                    ...
                    (match i = (~- (Prims.parse_int "1")) with
                     | true  ->
                         let uu____7862 = imitate orig env wl st  in
                         (match uu____7862 with
                          ...
                          | sol -> sol)
                     | uu____7872 ->
                         let uu____7873 = project orig env wl i st  in
              ...
              let check_head fvs1 t2 =
                let uu____7891 = FStar_Syntax_Util.head_and_args t2  in
              ...
              let imitate_ok t2 =
                ...
                let uu____7955 = FStar_Util.set_is_empty fvs_hd  in
                match uu____7955 with
                | true  -> ~- (Prims.parse_int "1")
                | uu____7956 -> (Prims.parse_int "0")  in
              (match maybe_pat_vars with
               | Some vars ->
                   ...
                   let uu____7964 = occurs_check env wl (uv, k_uv) t2  in
        ...
        let flex_flex orig lhs rhs =
          ...
          | uu____8025 ->
              let force_quasi_pattern xs_opt uu____8047 =
                match uu____8047 with
                | (t,u,k,args) ->
                    let uu____8077 = FStar_Syntax_Util.arrow_formals k  in
                    (match uu____8077 with
                     | (all_formals,uu____8088) ->
                         let rec aux pat_args pattern_vars pattern_var_set
                           ...
                           | ([],[]) ->
                               ...
                               (match uu____8199 with
                                | (t',tm_u1) ->
                                    let uu____8206 = destruct_flex_t t'  in
                                    (match uu____8206 with
                                     | (uu____8226,u1,k1,uu____8229) ->
                                         let sol =
                                           TERM
                                             (let _0_545 =
                                         ...
                                         (match uu____8355 with
                                          ...
                                          | uu____8358 ->
                                              ...
                                              aux (y :: pat_args) (formal ::
                                                ...
                                                tl)))
                           | uu____8363 -> failwith "Impossible"  in
                         let _0_547 = FStar_Syntax_Syntax.new_bv_set ()  in
                         aux [] [] _0_547 all_formals args)
                 in
              let solve_both_pats wl uu____8420 uu____8421 r =
                                      ...
                                      (match uu____8733 with
                                       | (FStar_Syntax_Syntax.Tm_type
                                          uu____8741,uu____8742) ->
                                           (k1', [sub_prob])
                                       | (uu____8746,FStar_Syntax_Syntax.Tm_type
                                          uu____8747) -> (k2', [sub_prob])
                                       | uu____8751 ->
                                           let uu____8754 =
                                                         ...
                                                         | uu____8855 ->
                                                             ...
                                                             solve env
                                                               (attempt
                                                                  ...
                                                                  wl))))))))))
                 in
              let solve_one_pat uu____8895 uu____8896 =
                ...
                | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                    ((let uu____9000 =
                      ...
                      | true  ->
                          ...
                          FStar_Util.print2
                            ...
                            _0_573 _0_572
                      | uu____9001 -> ());
                     (let uu____9002 = FStar_Unionfind.equivalent u1 u2  in
                 ...
                 in
              let uu____9101 = lhs  in
              (match uu____9101 with
               | (t1,u1,k1,args1) ->
                   let uu____9106 = rhs  in
        ...
        | uu____9156 ->
            ...
            let uu____9159 = FStar_Util.physical_equality t1 t2  in
                  ...
                  (let r = FStar_TypeChecker_Env.get_range env  in
                   ...
                   | (FStar_Syntax_Syntax.Tm_arrow
                      (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                       let mk_c c uu___124_9208 =
                         match uu___124_9208 with
                         | [] -> c
                         | bs ->
                             FStar_Syntax_Syntax.mk_Total
                               ((FStar_Syntax_Syntax.mk
                   ...
                   | (FStar_Syntax_Syntax.Tm_abs
                      ...
                      (bs2,tbody2,lopt2)) ->
                       let mk_t t l uu___125_9405 =
                         match uu___125_9405 with
                         | [] -> t
                         | bs ->
                             (FStar_Syntax_Syntax.mk
                   ...
                   | (FStar_Syntax_Syntax.Tm_abs _,_)
                     |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                       let is_abs t =
                         match t.FStar_Syntax_Syntax.n with
                         | FStar_Syntax_Syntax.Tm_abs uu____9541 -> true
                         | uu____9556 -> false  in
                       let maybe_eta t =
                         match is_abs t with
                       ...
                       (match uu____9584 with
                        | (FStar_Util.Inl t1,FStar_Util.Inl t2) ->
                            solve_t env
                              (let uu___153_9621 = problem  in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___153_9621.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t1;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___153_9621.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t2;
                                 FStar_TypeChecker_Common.element =
                                   (uu___153_9621.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___153_9621.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.scope =
                                   (uu___153_9621.FStar_TypeChecker_Common.scope);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___153_9621.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___153_9621.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___153_9621.FStar_TypeChecker_Common.rank)
                               }) wl
                   ...
                   | (FStar_Syntax_Syntax.Tm_refine
                      uu____9667,FStar_Syntax_Syntax.Tm_refine uu____9668) ->
                       let uu____9677 = as_refinement env wl t1  in
                       (match uu____9677 with
                        | (x1,phi1) ->
                            let uu____9682 = as_refinement env wl t2  in
                             ...
                             | (x2,phi2) ->
                                 ...
                                 (match problem.FStar_TypeChecker_Common.relation
                                  ...
                                  | true  ->
                                      ...
                                      let uu____9735 =
                                        solve env
                                          (let uu___154_9736 = wl  in
                                           {
                                             attempting = [ref_prob];
                                             wl_deferred = [];
                                             ctr = (uu___154_9736.ctr);
                                             defer_ok = false;
                                             smt_ok = (uu___154_9736.smt_ok);
                                             tcenv = (uu___154_9736.tcenv)
                                           })
                                         in
                                      (match uu____9735 with
                                       | Failed uu____9740 -> fallback ()
                                       | Success uu____9743 ->
                                           let guard =
                                             let _0_602 =
                                               FStar_All.pipe_right
                                           ...
                                           let wl =
                                             solve_prob orig (Some guard) []
                                              ...
                                              in
                                           let wl =
                                             let uu___155_9755 = wl  in
                                             {
                                               attempting =
                                                 (uu___155_9755.attempting);
                                               wl_deferred =
                                                 (uu___155_9755.wl_deferred);
                                               ctr =
                                                 (wl.ctr +
                                                    (Prims.parse_int "1"));
                                               defer_ok =
                                                 (uu___155_9755.defer_ok);
                                               smt_ok =
                                                 (uu___155_9755.smt_ok);
                                               tcenv = (uu___155_9755.tcenv)
                                             }  in
                   ...
                   | (FStar_Syntax_Syntax.Tm_uvar
                     ...
                     |(FStar_Syntax_Syntax.Tm_app
                      ...
                      |(FStar_Syntax_Syntax.Tm_uvar
                       ...
                       ->
                       solve_t' env
                         (let uu___156_9869 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___156_9869.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___156_9869.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.EQ;
                            FStar_TypeChecker_Common.rhs =
                              (uu___156_9869.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___156_9869.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___156_9869.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___156_9869.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___156_9869.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___156_9869.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___156_9869.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Syntax_Syntax.Tm_uvar _,_)
                     |(FStar_Syntax_Syntax.Tm_app
                       ({
                             ...
                             | true  ->
                                 let _0_609 =
                                   FStar_All.pipe_left
                                     ...
                                     (let uu___157_9890 = problem  in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___157_9890.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___157_9890.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          new_rel;
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___157_9890.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___157_9890.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___157_9890.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___157_9890.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___157_9890.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___157_9890.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___157_9890.FStar_TypeChecker_Common.rank)
                                      })
                                    in
                                 ...
                                 (match uu____9892 with
                                  | (t_base,ref_opt) ->
                                      (match ref_opt with
                                             ...
                                             FStar_All.pipe_left
                                               ...
                                               (let uu___158_9924 = problem
                                                   in
                                                {
                                                  FStar_TypeChecker_Common.pid
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.pid);
                                                  FStar_TypeChecker_Common.lhs
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.lhs);
                                                  FStar_TypeChecker_Common.relation
                                                    = new_rel;
                                                  FStar_TypeChecker_Common.rhs
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.rhs);
                                                  FStar_TypeChecker_Common.element
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.element);
                                                  FStar_TypeChecker_Common.logical_guard
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.logical_guard);
                                                  FStar_TypeChecker_Common.scope
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.scope);
                                                  FStar_TypeChecker_Common.reason
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.reason);
                                                  FStar_TypeChecker_Common.loc
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.loc);
                                                  FStar_TypeChecker_Common.rank
                                                    =
                                                    (uu___158_9924.FStar_TypeChecker_Common.rank)
                                                })
                                              in
                                           let _0_611 =
                                       ...
                                       | Some (y,phi) ->
                                           let y' =
                                             let uu___159_9936 = y  in
                                             {
                                               FStar_Syntax_Syntax.ppname =
                                                 (uu___159_9936.FStar_Syntax_Syntax.ppname);
                                               FStar_Syntax_Syntax.index =
                                                 (uu___159_9936.FStar_Syntax_Syntax.index);
                       ...
                       (match wl.defer_ok with
                        ...
                        | uu____9964 ->
                            ...
                            (match uu____9965 with
                             | (t_base,uu____9976) ->
                                 solve_t env
                                   (let uu___160_9991 = problem  in
                                    {
                                      FStar_TypeChecker_Common.pid =
                                        (uu___160_9991.FStar_TypeChecker_Common.pid);
                                      FStar_TypeChecker_Common.lhs = t_base;
                                      FStar_TypeChecker_Common.relation =
                                        FStar_TypeChecker_Common.EQ;
                                      FStar_TypeChecker_Common.rhs =
                                        (uu___160_9991.FStar_TypeChecker_Common.rhs);
                                      FStar_TypeChecker_Common.element =
                                        (uu___160_9991.FStar_TypeChecker_Common.element);
                                      FStar_TypeChecker_Common.logical_guard
                                        =
                                        (uu___160_9991.FStar_TypeChecker_Common.logical_guard);
                                      FStar_TypeChecker_Common.scope =
                                        (uu___160_9991.FStar_TypeChecker_Common.scope);
                                      FStar_TypeChecker_Common.reason =
                                        (uu___160_9991.FStar_TypeChecker_Common.reason);
                                      FStar_TypeChecker_Common.loc =
                                        (uu___160_9991.FStar_TypeChecker_Common.loc);
                                      FStar_TypeChecker_Common.rank =
                                        (uu___160_9991.FStar_TypeChecker_Common.rank)
                                    }) wl))
                   | (FStar_Syntax_Syntax.Tm_refine uu____9994,uu____9995) ->
                       let t2 =
                         let _0_616 = base_and_refinement env wl t2  in
                         FStar_All.pipe_left force_refinement _0_616  in
                       solve_t env
                         (let uu___161_10010 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___161_10010.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___161_10010.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              (uu___161_10010.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t2;
                            FStar_TypeChecker_Common.element =
                              (uu___161_10010.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___161_10010.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___161_10010.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___161_10010.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___161_10010.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___161_10010.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (uu____10011,FStar_Syntax_Syntax.Tm_refine uu____10012)
                       ->
                       let t1 =
                         let _0_617 = base_and_refinement env wl t1  in
                         FStar_All.pipe_left force_refinement _0_617  in
                       solve_t env
                         (let uu___162_10027 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___162_10027.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t1;
                            FStar_TypeChecker_Common.relation =
                              (uu___162_10027.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs =
                              (uu___162_10027.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___162_10027.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___162_10027.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___162_10027.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___162_10027.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___162_10027.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___162_10027.FStar_TypeChecker_Common.rank)
                          }) wl
                   ...
                   | (FStar_Syntax_Syntax.Tm_ascribed
                      (t1,uu____10131,uu____10132),uu____10133) ->
                       solve_t' env
                         (let uu___163_10152 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___163_10152.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t1;
                            FStar_TypeChecker_Common.relation =
                              (uu___163_10152.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs =
                              (uu___163_10152.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___163_10152.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___163_10152.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___163_10152.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___163_10152.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___163_10152.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___163_10152.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (uu____10155,FStar_Syntax_Syntax.Tm_ascribed
                      (t2,uu____10157,uu____10158)) ->
                       solve_t' env
                         (let uu___164_10177 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___164_10177.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___164_10177.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              (uu___164_10177.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t2;
                            FStar_TypeChecker_Common.element =
                              (uu___164_10177.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___164_10177.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___164_10177.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___164_10177.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___164_10177.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___164_10177.FStar_TypeChecker_Common.rank)
                          }) wl
                       ...
                       failwith
                         (let _0_625 = FStar_Syntax_Print.tag_of_term t1  in
                          ...
                          FStar_Util.format2 "Impossible: %s and %s" _0_625
                            _0_624)
                   | uu____10190 -> giveup env "head tag mismatch" orig)))
               ...
               (fun uu____10230  ->
                  fun uu____10231  ->
                    ...
                    | ((a1,uu____10241),(a2,uu____10243)) ->
                        ...
                        FStar_All.pipe_left
                          (fun _0_626  ->
                             FStar_TypeChecker_Common.TProb _0_626) _0_627)
        ...
        let solve_sub c1 edge c2 =
          ...
          | uu____10294 ->
              ...
              let uu____10299 =
                ...
                with
                | ((wp1,uu____10323)::uu____10324,(wp2,uu____10326)::uu____10327)
                    -> (wp1, wp2)
                | uu____10368 ->
                    failwith
                      (let _0_632 =
               ...
               | (wpc1,wpc2) ->
                   ...
                   (match uu____10397 with
                    ...
                    | uu____10402 ->
                        ...
                        solve env (attempt [base_prob] wl)))
           in
        let uu____10441 = FStar_Util.physical_equality c1 c2  in
              ...
              | (c1,c2) ->
                  (match ((c1.FStar_Syntax_Syntax.n),
                   ...
                   | (FStar_Syntax_Syntax.GTotal
                      (t1,uu____10452),FStar_Syntax_Syntax.Total
                      (t2,uu____10454)) when
                   ...
                   | (FStar_Syntax_Syntax.GTotal
                      uu____10469,FStar_Syntax_Syntax.Total uu____10470) ->
                   ...
                   | (FStar_Syntax_Syntax.GTotal _,FStar_Syntax_Syntax.Comp
                     ...
                     |(FStar_Syntax_Syntax.Total _,FStar_Syntax_Syntax.Comp
                       ...
                       let _0_667 =
                         ...
                         {
                           FStar_TypeChecker_Common.pid =
                             (uu___165_10525.FStar_TypeChecker_Common.pid);
                           FStar_TypeChecker_Common.lhs = _0_666;
                           FStar_TypeChecker_Common.relation =
                             (uu___165_10525.FStar_TypeChecker_Common.relation);
                           FStar_TypeChecker_Common.rhs =
                             (uu___165_10525.FStar_TypeChecker_Common.rhs);
                           FStar_TypeChecker_Common.element =
                             (uu___165_10525.FStar_TypeChecker_Common.element);
                           FStar_TypeChecker_Common.logical_guard =
                             (uu___165_10525.FStar_TypeChecker_Common.logical_guard);
                           FStar_TypeChecker_Common.scope =
                             (uu___165_10525.FStar_TypeChecker_Common.scope);
                           FStar_TypeChecker_Common.reason =
                             (uu___165_10525.FStar_TypeChecker_Common.reason);
                           FStar_TypeChecker_Common.loc =
                             (uu___165_10525.FStar_TypeChecker_Common.loc);
                           FStar_TypeChecker_Common.rank =
                             (uu___165_10525.FStar_TypeChecker_Common.rank)
                         }  in
                   ...
                   | (FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.GTotal
                     ...
                     |(FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.Total
                       ...
                       let _0_670 =
                         ...
                         {
                           FStar_TypeChecker_Common.pid =
                             (uu___166_10532.FStar_TypeChecker_Common.pid);
                           FStar_TypeChecker_Common.lhs =
                             (uu___166_10532.FStar_TypeChecker_Common.lhs);
                           FStar_TypeChecker_Common.relation =
                             (uu___166_10532.FStar_TypeChecker_Common.relation);
                           FStar_TypeChecker_Common.rhs = _0_669;
                           FStar_TypeChecker_Common.element =
                             (uu___166_10532.FStar_TypeChecker_Common.element);
                           FStar_TypeChecker_Common.logical_guard =
                             (uu___166_10532.FStar_TypeChecker_Common.logical_guard);
                           FStar_TypeChecker_Common.scope =
                             (uu___166_10532.FStar_TypeChecker_Common.scope);
                           FStar_TypeChecker_Common.reason =
                             (uu___166_10532.FStar_TypeChecker_Common.reason);
                           FStar_TypeChecker_Common.loc =
                             (uu___166_10532.FStar_TypeChecker_Common.loc);
                           FStar_TypeChecker_Common.rank =
                             (uu___166_10532.FStar_TypeChecker_Common.rank)
                         }  in
                       solve_c env _0_670 wl
                   | (FStar_Syntax_Syntax.Comp
                      uu____10535,FStar_Syntax_Syntax.Comp uu____10536) ->
                       let uu____10537 =
      ...
      FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits
        (FStar_List.map
           (fun uu____10579  ->
              ...
              | (uu____10590,uu____10591,u,uu____10593,uu____10594,uu____10595)
...
let guard_to_string :
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____10657,[])) -> "{}"
      | uu____10670 ->
          let form =
            ...
            let _0_680 =
              FStar_List.map
                (fun uu____10686  ->
                   ...
                   | (uu____10689,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred
               in
...
let is_trivial : FStar_TypeChecker_Env.guard_t -> Prims.bool =
  fun g  ->
    ...
    | { FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial ;
        FStar_TypeChecker_Env.deferred = [];
        FStar_TypeChecker_Env.univ_ineqs = uu____10711;
        FStar_TypeChecker_Env.implicits = uu____10712;_} -> true
    | uu____10726 -> false
    ...
    fun g  ->
      ...
      | Some g ->
          let f =
            ...
            | uu____10753 -> failwith "impossible"  in
          Some
            (let uu___167_10754 = g  in
             let _0_690 =
               let _0_689 =
                 let _0_688 =
                ...
                in
             {
               ...
               FStar_TypeChecker_Env.deferred =
                 (uu___167_10754.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___167_10754.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___167_10754.FStar_TypeChecker_Env.implicits)
             })
    ...
    fun e  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
             ...
             in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___168_10775.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___168_10775.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___168_10775.FStar_TypeChecker_Env.implicits)
          }
...
let trivial : FStar_TypeChecker_Common.guard_formula -> Prims.unit =
  fun t  ->
    ...
    | FStar_TypeChecker_Common.NonTrivial uu____10792 ->
        failwith "impossible"
...
let check_trivial :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar tc when
        ...
        FStar_TypeChecker_Common.Trivial
    | uu____10810 -> FStar_TypeChecker_Common.NonTrivial t
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
             ...
             in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___169_10878.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___169_10878.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___169_10878.FStar_TypeChecker_Env.implicits)
          }
...
let solve_and_commit :
  ...
  fun env  ->
    fun probs  ->
      fun err  ->
        let probs =
          let uu____10964 = FStar_Options.eager_inference ()  in
          match uu____10964 with
          | true  ->
              let uu___170_10965 = probs  in
              {
                attempting = (uu___170_10965.attempting);
                wl_deferred = (uu___170_10965.wl_deferred);
                ctr = (uu___170_10965.ctr);
                defer_ok = false;
                smt_ok = (uu___170_10965.smt_ok);
                tcenv = (uu___170_10965.tcenv)
              }
          | uu____10966 -> probs  in
        let tx = FStar_Unionfind.new_transaction ()  in
           ...
           (let f =
            ...
            (let f =
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____10995 -> FStar_TypeChecker_Common.NonTrivial f  in
             let uu___171_10996 = g  in
             {
               FStar_TypeChecker_Env.guard_f = f;
               FStar_TypeChecker_Env.deferred =
                 (uu___171_10996.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___171_10996.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___171_10996.FStar_TypeChecker_Env.implicits)
             })))
        ...
        (let prob =
         ...
         let g =
           let _0_724 =
             ...
             solve_and_commit env _0_723 (fun uu____11043  -> None)  in
...
let teq :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____11055 = try_teq env t1 t2  in
           ...
           | (prob,x) ->
               let g =
                 let _0_733 =
                   ...
                   solve_and_commit env _0_732 (fun uu____11087  -> None)  in
    ...
    fun c1  ->
      fun c2  ->
        ...
        (let rel =
           ...
           | true  -> FStar_TypeChecker_Common.EQ
           | uu____11129 -> FStar_TypeChecker_Common.SUB  in
         let prob =
           let _0_744 =
         ...
         let _0_746 =
           ...
           solve_and_commit env _0_745 (fun uu____11135  -> None)  in
    ...
    fun env  ->
      fun uu____11152  ->
        ...
        | (variables,ineqs) ->
              ...
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v  ->
                      ...
                      | FStar_Syntax_Syntax.U_unif uu____11212 ->
            ...
            let uu____11244 =
              let wl =
                let uu___172_11247 = empty_worklist env  in
                {
                  attempting = (uu___172_11247.attempting);
                  wl_deferred = (uu___172_11247.wl_deferred);
                  ctr = (uu___172_11247.ctr);
                  defer_ok = false;
                  smt_ok = (uu___172_11247.smt_ok);
                  tcenv = (uu___172_11247.tcenv)
                }  in
                   ...
                   (fun uu____11254  ->
                      ...
                      | (lb,v) ->
                          ...
                          (match uu____11259 with
                           | USolved wl -> ()
                           | uu____11261 -> fail lb v)))
               in
            let rec check_ineq uu____11267 =
              ...
              | (u,v) ->
                  ...
                  (match (u, v) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____11274) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_max us,uu____11290) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u  -> check_ineq (u, v)))
                   | (uu____11294,FStar_Syntax_Syntax.U_max vs) ->
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____11308  ->
                      ...
                      | (u,v) ->
                          let uu____11313 = check_ineq (u, v)  in
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____11374 =
       ...
       | uu____11384 -> ());
      (let g =
         let uu____11386 = solve_and_commit env wl fail  in
         match uu____11386 with
         | Some [] ->
             let uu___173_11393 = g  in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___173_11393.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___173_11393.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___173_11393.FStar_TypeChecker_Env.implicits)
             }
         | uu____11396 ->
             failwith "impossible: Unexpected deferred constraints remain"
          in
       solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___174_11399 = g  in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___174_11399.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___174_11399.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___174_11399.FStar_TypeChecker_Env.implicits)
        }))
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___175_11425 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___175_11425.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___175_11425.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___175_11425.FStar_TypeChecker_Env.implicits)
            }  in
          let uu____11426 =
...
let discharge_guard :
  ...
  fun env  ->
    fun g  ->
      let uu____11449 = discharge_guard' None env g true  in
          ...
          (match implicits with
           | [] ->
               (match Prims.op_Negation changed with
                | true  -> out
                | uu____11504 -> until_fixpoint ([], false) out)
           | hd::tl ->
               let uu____11539 = hd  in
               (match uu____11539 with
                | (uu____11546,env,u,tm,k,r) ->
                    let uu____11552 = unresolved u  in
                         ...
                         ((let uu____11570 =
                          ...
                          (let uu____11575 =
                             env.FStar_TypeChecker_Env.type_of
                               (let uu___176_11579 = env  in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___176_11579.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___176_11579.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___176_11579.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___176_11579.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___176_11579.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___176_11579.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___176_11579.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___176_11579.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___176_11579.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___176_11579.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___176_11579.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___176_11579.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___176_11579.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___176_11579.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___176_11579.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___176_11579.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___176_11579.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___176_11579.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax =
                                    (uu___176_11579.FStar_TypeChecker_Env.lax);
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___176_11579.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___176_11579.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___176_11579.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts = true;
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___176_11579.FStar_TypeChecker_Env.qname_and_index)
                                }) tm
                              in
                           match uu____11575 with
                           | (uu____11580,uu____11581,g) ->
                               let g =
                                 match env.FStar_TypeChecker_Env.is_pattern
                                 with
                                 | true  ->
                                     let uu___177_11584 = g  in
                                     {
                                       FStar_TypeChecker_Env.guard_f =
                                         FStar_TypeChecker_Common.Trivial;
                                       FStar_TypeChecker_Env.deferred =
                                         (uu___177_11584.FStar_TypeChecker_Env.deferred);
                                       FStar_TypeChecker_Env.univ_ineqs =
                                         (uu___177_11584.FStar_TypeChecker_Env.univ_ineqs);
                                       FStar_TypeChecker_Env.implicits =
                                         (uu___177_11584.FStar_TypeChecker_Env.implicits)
                                     }
                                 | uu____11585 -> g  in
                               let g' =
                                 let uu____11587 =
                               ...
                               until_fixpoint
                                 ((FStar_List.append
                                   ...
                                   true) tl)))))
       in
    let uu___178_11606 = g  in
    let _0_769 = until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits
       in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___178_11606.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___178_11606.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___178_11606.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = _0_769
    }
...
let force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      ...
      | (reason,uu____11634,uu____11635,e,t,r)::uu____11639 ->
          let _0_774 =
...
let universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___179_11659 = trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___179_11659.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___179_11659.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___179_11659.FStar_TypeChecker_Env.implicits)
      }
...
let teq_nosmt :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____11677 = try_teq env t1 t2  in
        match uu____11677 with
        | None  -> false
        | Some g ->
            let uu____11680 = discharge_guard' None env g false  in
            (match uu____11680 with
             | Some uu____11684 -> true
             | None  -> false)
