          ...
          let x =
            ...
            then "?"
              ...
              (let uu____704 = FStar_Unionfind.uvar_id u  in
               FStar_All.pipe_right uu____704 FStar_Util.string_of_int)
             in
    ...
    FStar_All.pipe_right args
      (FStar_List.map
         (fun uu____764  ->
            ...
            | (x,uu____768) -> FStar_Syntax_Print.term_to_string x))
     in
    ...
    fun t  ->
      let uu____1295 =
        ...
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.WHNF] env uu____1296
         in
      ...
      let uu____1793 =
        let uu____1795 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu____1805  ->
                  match uu____1805 with | (uu____1809,uu____1810,x) -> x))
           in
               ...
               let uu____2013 =
                 let uu____2020 =
                   FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c1)
                    ...
                    in
                 FStar_All.pipe_right uu____2020 (fun _0_36  -> Some _0_36)
                  in
        ...
        FStar_All.pipe_right seen
          (FStar_Util.for_some
             (fun uu____2640  ->
                ...
                | (b,uu____2644) -> FStar_Syntax_Syntax.bv_eq a b))
         in
      ...
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_fvar f,FStar_Syntax_Syntax.Tm_fvar g) ->
            ...
            then FullMatch
              ...
              (let uu____3217 =
                 let uu____3222 =
                   let uu____3224 = fv_delta_depth env f  in Some uu____3224
                    in
                 let uu____3225 =
                   let uu____3227 = fv_delta_depth env g  in Some uu____3227
                    in
      ...
      (_,Some (FStar_Syntax_Syntax.Delta_equational )) ->
        ...
        then fail r
          ...
          (let uu____3562 =
             ...
             let uu____3569 = maybe_inline t21  in (uu____3567, uu____3569)
              in
                        ...
                        let uu____4602 =
                          let uu____4607 =
                            FStar_List.map (sub_prob scope1 args) components1
                             in
                          FStar_All.pipe_right uu____4607 FStar_List.unzip
                           in
                        (match uu____4602 with
                         | (tcs,sub_probs) ->
                             let gi_xs =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Syntax.mk_Comp uu____4636
                                in
                             ((C gi_xs), sub_probs))
                    | uu____4652 ->
                             ...
                             | (sub_probs,tcs,f) ->
                                 let f1 =
                                   ...
                                   | Some b ->
                                       ...
                                       FStar_Syntax_Util.mk_conj_l uu____4813
                                    in
                     ...
                     (fun u3  ->
                        ...
                        | (k,uu____5370) ->
                            (match k with
                             ...
                             | uu____5375 -> false)))
            | uu____5376 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u])
             in
      ...
      (match uu____5600 with
       | (bs2,mk_cod2) ->
           let curry n1 bs mk_cod =
             ...
             | (bs3,rest) ->
                 let uu____5661 = mk_cod rest  in (bs3, uu____5661)
              in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____5915  ->
                          ...
                          | (c,uu____5920,uu____5921) -> c < probs.ctr))
                   in
                                     ...
                                     (match uu____6391 with
                                      | (u',uu____6402) ->
                                          let uu____6417 =
                                            ...
                                            uu____6418.FStar_Syntax_Syntax.n
                                             in
                                           ...
                                           | (u',uu____6962) ->
                                               let uu____6977 =
                                                 let uu____6978 = whnf env u'
                                                    in
                                                 uu____6978.FStar_Syntax_Syntax.n
                                                  in
                    ...
                    (match uu____7295 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi1 =
                           ...
                           FStar_Syntax_Util.mk_conj uu____7313 uu____7316
                            in
                         ((let uu____7322 =
                             FStar_All.pipe_left
                            ...
                            | None  ->
                                ...
                                let uu____7452 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t11
                                    uu____7453 t21
                                   in
                                FStar_Syntax_Util.mk_forall u_x x uu____7452
                             in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
                                   ...
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____7554 =
                                        FStar_Syntax_Util.eq_args args1 args2
                                         in
                                      uu____7554 = FStar_Syntax_Util.Equal)
                                    in
                                 if uu____7551
                                 then
                                   let uu____7555 =
                   ...
                   (match uu____7967 with
                    | (xi,uu____7974) ->
                        ...
                        let uu____8085 =
                          ...
                          FStar_All.pipe_left Prims.op_Negation uu____8086
                           in
                        if uu____8085
                        then None
                        else
                           ...
                           | (g_xs,uu____8096) ->
                               ...
                               ((let uu____8181 =
                                ...
                                (let wl2 =
                                 ...
                                 FStar_All.pipe_left
                                   (fun _0_54  -> Some _0_54) uu____8193)))))
           in
                         ...
                         | uu____8704 ->
                             let uu____8708 =
                               ...
                               FStar_Util.format3
                                 ...
                                 uu____8709 uu____8713 uu____8714
                                in
                             failwith uu____8708
                          in
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____8993 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____8994
                             in
                   ...
                   (match uu____9119 with
                    | (all_formals,uu____9130) ->
                        ...
                        let uu____9429 = FStar_Syntax_Syntax.new_bv_set ()
                           in
                        aux [] [] uu____9429 all_formals args)
                in
                           ...
                           then
                             ...
                             (let uu____9742 =
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____9743 uu____9744 uu____9745
                                 in
                              failwith uu____9742)
                          in
                       let uu____9746 =
                     ...
                     | bs ->
                         let uu____10347 =
                           (FStar_Syntax_Syntax.mk
                            ...
                            in
                         FStar_Syntax_Syntax.mk_Total uu____10347
                      in
                   let uu____10361 =
                               ...
                               fun subst1  ->
                                 let uu____10648 =
                                   ...
                                   mk_problem scope orig uu____10651
                                     problem.FStar_TypeChecker_Common.relation
                                     uu____10652 None "lambda co-domain"
                                    in
                                 FStar_All.pipe_left
                                   (fun _0_61  ->
                               ...
                               let guard =
                                 let uu____10871 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     Prims.fst
                                    in
                                 FStar_Syntax_Util.mk_conj uu____10871 impl
                                  in
                    ...
                    then
                      let c1_repr =
                        ...
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Normalize.UnfoldUntil
                             FStar_Syntax_Syntax.Delta_constant;
                          FStar_TypeChecker_Normalize.WHNF] env uu____11654
                         in
                      let c2_repr =
                        let uu____11659 =
             ...
             (fun uu____11999  ->
                ...
                | (u1,u2) ->
                    ...
                    let uu____12005 = FStar_Syntax_Print.univ_to_string u2
                       in
                    FStar_Util.format2 "%s < %s" uu____12004 uu____12005))
         in
          ...
          (let prob =
           ...
           let g =
             let uu____12245 =
               ...
               solve_and_commit env uu____12247 (fun uu____12248  -> None)
                in
      ...
      fun c2  ->
        ...
        (let rel =
         ...
         let prob =
           ...
           FStar_All.pipe_left
             (fun _0_76  -> FStar_TypeChecker_Common.CProb _0_76) uu____12360
            in
         let uu____12366 =
      ...
      | (reason,uu____12934,uu____12935,e,t,r)::uu____12939 ->
          let uu____12953 =
            ...
            FStar_Util.format3
              ...
              uu____12954 uu____12955 reason
             in
