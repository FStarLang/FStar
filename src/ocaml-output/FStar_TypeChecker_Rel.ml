    ...
    fun e  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              uu____222 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___158_220.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___158_220.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___158_220.FStar_TypeChecker_Env.implicits)
          }
let map_guard:
  FStar_TypeChecker_Env.guard_t ->
    ...
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            FStar_TypeChecker_Common.NonTrivial uu____267 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___159_265.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___159_265.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___159_265.FStar_TypeChecker_Env.implicits)
          }
    ...
    fun bs  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu___160_407 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___160_407.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___160_407.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___160_407.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
  FStar_TypeChecker_Env.env ->
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____447 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___161_445.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___161_445.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___161_445.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___162_1169 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___162_1169.wl_deferred);
          ctr = (uu___162_1169.ctr);
          defer_ok = (uu___162_1169.defer_ok);
          smt_ok;
          tcenv = (uu___162_1169.tcenv)
        }
let singleton:
...
let wl_of_guard:
  ...
  fun env  ->
    fun g  ->
      let uu___163_1205 = empty_worklist env in
      let uu____1206 = FStar_List.map FStar_Pervasives_Native.snd g in
      {
        attempting = uu____1206;
        wl_deferred = (uu___163_1205.wl_deferred);
        ctr = (uu___163_1205.ctr);
        defer_ok = false;
        smt_ok = (uu___163_1205.smt_ok);
        tcenv = (uu___163_1205.tcenv)
      }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___164_1223 = wl in
        {
          attempting = (uu___164_1223.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___164_1223.ctr);
          defer_ok = (uu___164_1223.defer_ok);
          smt_ok = (uu___164_1223.smt_ok);
          tcenv = (uu___164_1223.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___165_1242 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___165_1242.wl_deferred);
        ctr = (uu___165_1242.ctr);
        defer_ok = (uu___165_1242.defer_ok);
        smt_ok = (uu___165_1242.smt_ok);
        tcenv = (uu___165_1242.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert:
  ...
  =
  fun p  ->
    let uu___166_1287 = p in
    {
      FStar_TypeChecker_Common.pid =
        (uu___166_1287.FStar_TypeChecker_Common.pid);
      FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
      FStar_TypeChecker_Common.relation =
        (invert_rel p.FStar_TypeChecker_Common.relation);
      FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
      FStar_TypeChecker_Common.element =
        (uu___166_1287.FStar_TypeChecker_Common.element);
      FStar_TypeChecker_Common.logical_guard =
        (uu___166_1287.FStar_TypeChecker_Common.logical_guard);
      FStar_TypeChecker_Common.scope =
        (uu___166_1287.FStar_TypeChecker_Common.scope);
      FStar_TypeChecker_Common.reason =
        (uu___166_1287.FStar_TypeChecker_Common.reason);
      FStar_TypeChecker_Common.loc =
        (uu___166_1287.FStar_TypeChecker_Common.loc);
      FStar_TypeChecker_Common.rank =
        (uu___166_1287.FStar_TypeChecker_Common.rank)
    }
let maybe_invert:
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___140_1432  ->
    match uu___140_1432 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___141_1446  ->
    match uu___141_1446 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____2015  ->
              ...
              | (x,imp) ->
                  let uu____2026 =
                    let uu___167_2027 = x in
                    let uu____2028 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___167_2027.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___167_2027.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____3432,uv) ->
                ((let uu____3435 =
                 ...
                 commit uvis;
                 (let uu___168_3476 = wl in
                  {
                    attempting = (uu___168_3476.attempting);
                    wl_deferred = (uu___168_3476.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___168_3476.defer_ok);
                    smt_ok = (uu___168_3476.smt_ok);
                    tcenv = (uu___168_3476.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___169_3504 = wl in
         {
           attempting = (uu___169_3504.attempting);
           wl_deferred = (uu___169_3504.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___169_3504.defer_ok);
           smt_ok = (uu___169_3504.smt_ok);
           tcenv = (uu___169_3504.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
    FStar_Syntax_Syntax.term FStar_Pervasives_Native.option ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____6628))::tcs2) ->
                       aux
                         (((let uu___170_6663 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___170_6663.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___170_6663.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___147_6734 =
                 match uu___147_6734 with
                 | [] ->
                     FStar_List.rev
                   ...
                   | (tc,probs) ->
                       let uu____7733 =
                         ...
                         | ((FStar_Pervasives_Native.Some
                            ...
                            (t,uu____7799)) ->
                             let b1 =
                               ((let uu___171_7836 = b in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___171_7836.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___171_7836.FStar_Syntax_Syntax.index);
...
let compress_tprob:
  ...
  fun wl  ->
    fun p  ->
      ...
      {
        FStar_TypeChecker_Common.pid =
          (uu___172_8122.FStar_TypeChecker_Common.pid);
        FStar_TypeChecker_Common.lhs = uu____8127;
        FStar_TypeChecker_Common.relation =
          (uu___172_8122.FStar_TypeChecker_Common.relation);
        FStar_TypeChecker_Common.rhs = uu____8128;
        FStar_TypeChecker_Common.element =
          (uu___172_8122.FStar_TypeChecker_Common.element);
        FStar_TypeChecker_Common.logical_guard =
          (uu___172_8122.FStar_TypeChecker_Common.logical_guard);
        FStar_TypeChecker_Common.scope =
          (uu___172_8122.FStar_TypeChecker_Common.scope);
        FStar_TypeChecker_Common.reason =
          (uu___172_8122.FStar_TypeChecker_Common.reason);
        FStar_TypeChecker_Common.loc =
          (uu___172_8122.FStar_TypeChecker_Common.loc);
        FStar_TypeChecker_Common.rank =
          (uu___172_8122.FStar_TypeChecker_Common.rank)
      }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____8244) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8445 ->
                                    ...
                                    let uu____8457 =
                                      let uu___173_8462 = tp in
                                      let uu____8467 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___173_8462.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___173_8462.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___173_8462.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____8467;
                                        FStar_TypeChecker_Common.element =
                                          (uu___173_8462.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___173_8462.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___173_8462.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___173_8462.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___173_8462.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___173_8462.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____8457)))
                          ...
                          (match uu____8500 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8563 ->
                                    let uu____8572 =
                                      let uu___174_8579 = tp in
                                      let uu____8584 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___174_8579.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____8584;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___174_8579.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___174_8579.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___174_8579.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___174_8579.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___174_8579.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___174_8579.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___174_8579.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___174_8579.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____8265 with
                     | (rank,tp1) ->
                         let uu____8625 =
                           FStar_All.pipe_right
                             (let uu___175_8631 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___175_8631.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___175_8631.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___175_8631.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___175_8631.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___175_8631.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___175_8631.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___175_8631.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___175_8631.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___175_8631.FStar_TypeChecker_Common.loc);
                                FStar_TypeChecker_Common.rank =
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____8641 =
            FStar_All.pipe_right
              (let uu___176_8647 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___176_8647.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___176_8647.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___176_8647.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___176_8647.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___176_8647.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___176_8647.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___176_8647.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___176_8647.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___176_8647.FStar_TypeChecker_Common.loc);
                 FStar_TypeChecker_Common.rank =
    ...
    fun probs  ->
      ...
      (let uu____9690 = next_prob probs in
       ...
       | (FStar_Pervasives_Native.Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___177_9711 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___177_9711.wl_deferred);
               ctr = (uu___177_9711.ctr);
               defer_ok = (uu___177_9711.defer_ok);
               smt_ok = (uu___177_9711.smt_ok);
               tcenv = (uu___177_9711.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____9897 ->
                          let uu____9906 =
                                      ...
                                      | (uu____9936,uu____9937,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___178_9907.ctr);
                              defer_ok = (uu___178_9907.defer_ok);
                              smt_ok = (uu___178_9907.smt_ok);
                              tcenv = (uu___178_9907.tcenv)
                            } in
                       ...
                       (match uu____10743 with
                        ...
                        | FStar_Pervasives_Native.Some (lhs_bound,sub_probs)
                            ...
                            ((let uu____10791 =
                              ...
                              then
                                let wl' =
                                  let uu___179_10793 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred =
                                      (uu___179_10793.wl_deferred);
                                    ctr = (uu___179_10793.ctr);
                                    defer_ok = (uu___179_10793.defer_ok);
                                    smt_ok = (uu___179_10793.smt_ok);
                                    tcenv = (uu___179_10793.tcenv)
                                  } in
                             ...
                             (let uu____10796 =
                                solve_t env eq_prob
                                  (let uu___180_10798 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___180_10798.wl_deferred);
                                     ctr = (uu___180_10798.ctr);
                                     defer_ok = (uu___180_10798.defer_ok);
                                     smt_ok = (uu___180_10798.smt_ok);
                                     tcenv = (uu___180_10798.tcenv)
                                   }) in
                              match uu____10796 with
                              | Success uu____10801 ->
                                  let wl1 =
                                    let uu___181_10803 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___181_10803.wl_deferred);
                                      ctr = (uu___181_10803.ctr);
                                      defer_ok = (uu___181_10803.defer_ok);
                                      smt_ok = (uu___181_10803.smt_ok);
                                      tcenv = (uu___181_10803.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____11632 with
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 ((let uu____11692 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___182_11694 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___182_11694.wl_deferred);
                                         ctr = (uu___182_11694.ctr);
                                         defer_ok = (uu___182_11694.defer_ok);
                                         smt_ok = (uu___182_11694.smt_ok);
                                         tcenv = (uu___182_11694.tcenv)
                                       } in
                                  ...
                                  (let uu____11697 =
                                     solve_t env eq_prob
                                       (let uu___183_11699 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___183_11699.wl_deferred);
                                          ctr = (uu___183_11699.ctr);
                                          defer_ok =
                                            (uu___183_11699.defer_ok);
                                          smt_ok = (uu___183_11699.smt_ok);
                                          tcenv = (uu___183_11699.tcenv)
                                        }) in
                                   match uu____11697 with
                                   | Success uu____11702 ->
                                       let wl1 =
                                         let uu___184_11704 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___184_11704.wl_deferred);
                                           ctr = (uu___184_11704.ctr);
                                           defer_ok =
                                             (uu___184_11704.defer_ok);
                                           smt_ok = (uu___184_11704.smt_ok);
                                           tcenv = (uu___184_11704.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___185_11858 = hd1 in
                      let uu____11859 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___185_11858.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___185_11858.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____11859
                      } in
                    let hd21 =
                      let uu___186_11863 = hd2 in
                      let uu____11864 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___186_11863.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___186_11863.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____12192,FStar_Pervasives_Native.Some (t11,t21)) ->
                   solve_t env1
                     (let uu___187_12206 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___187_12206.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___187_12206.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___187_12206.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___187_12206.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___187_12206.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___187_12206.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___187_12206.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___187_12206.FStar_TypeChecker_Common.rank)
                      }) wl1
                                                  ...
                                                  solve_t env1
                                                    (let uu___188_12569 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___188_12569.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___153_13654 =
          match uu___153_13654 with
          | FStar_Pervasives_Native.None  ->
             ...
             ((let uu____16800 =
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed uu____16804,uu____16805) ->
                   let uu____16832 =
                     let uu___189_16833 = problem in
                     let uu____16834 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___189_16833.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16834;
                       FStar_TypeChecker_Common.relation =
                         (uu___189_16833.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___189_16833.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___189_16833.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___189_16833.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___189_16833.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___189_16833.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___189_16833.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___189_16833.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16832 wl
               | (FStar_Syntax_Syntax.Tm_meta uu____16835,uu____16836) ->
                   let uu____16843 =
                     let uu___189_16844 = problem in
                     let uu____16845 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___189_16844.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16845;
                       FStar_TypeChecker_Common.relation =
                         (uu___189_16844.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___189_16844.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___189_16844.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___189_16844.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___189_16844.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___189_16844.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___189_16844.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___189_16844.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16843 wl
               | (uu____16846,FStar_Syntax_Syntax.Tm_ascribed uu____16847) ->
                   let uu____16874 =
                     let uu___190_16875 = problem in
                     let uu____16876 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___190_16875.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___190_16875.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___190_16875.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16876;
                       FStar_TypeChecker_Common.element =
                         (uu___190_16875.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___190_16875.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___190_16875.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___190_16875.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___190_16875.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___190_16875.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16874 wl
               | (uu____16877,FStar_Syntax_Syntax.Tm_meta uu____16878) ->
                   let uu____16885 =
                     let uu___190_16886 = problem in
                     let uu____16887 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___190_16886.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___190_16886.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___190_16886.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16887;
                       FStar_TypeChecker_Common.element =
                         (uu___190_16886.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___190_16886.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___190_16886.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___190_16886.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___190_16886.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___190_16886.FStar_TypeChecker_Common.rank)
                     } in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___154_16946 =
                     match uu___154_16946 with
                     | [] -> c
                     | bs ->
                         let uu____16968 =
                           FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___155_17197 =
                     match uu___155_17197 with
                     | [] -> t
                     | bs ->
                         FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs uu____17378,uu____17379) ->
                     ...
                     then t
                       ...
                       (let uu____17468 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___191_17476 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___191_17476.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___191_17476.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___191_17476.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___191_17476.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___191_17476.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___191_17476.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___191_17476.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___191_17476.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___191_17476.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___191_17476.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___191_17476.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___191_17476.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___191_17476.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___191_17476.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___191_17476.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___191_17476.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___191_17476.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___191_17476.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___191_17476.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___191_17476.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___191_17476.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___191_17476.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___191_17476.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___191_17476.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___191_17476.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___191_17476.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___191_17476.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___191_17476.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___191_17476.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___191_17476.FStar_TypeChecker_Env.dsenv)
                             }) t in
                   ...
                   (match uu____17483 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___192_17549 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___192_17549.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___192_17549.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___192_17549.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___192_17549.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___192_17549.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___192_17549.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___192_17549.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___192_17549.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___193_17588 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___193_17588.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___193_17588.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___193_17588.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___193_17588.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___193_17588.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___193_17588.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___193_17588.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___193_17588.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___193_17628 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___193_17628.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___193_17628.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___193_17628.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___193_17628.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___193_17628.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___193_17628.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___193_17628.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___193_17628.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
               ...
               | (uu____17649,FStar_Syntax_Syntax.Tm_abs uu____17650) ->
                   ...
                   let force_eta t =
                     ...
                     then t
                       ...
                       (let uu____17739 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___191_17747 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___191_17747.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___191_17747.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___191_17747.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___191_17747.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___191_17747.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___191_17747.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___191_17747.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___191_17747.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___191_17747.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___191_17747.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___191_17747.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___191_17747.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___191_17747.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___191_17747.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___191_17747.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___191_17747.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___191_17747.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___191_17747.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___191_17747.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___191_17747.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___191_17747.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___191_17747.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___191_17747.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___191_17747.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___191_17747.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___191_17747.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___191_17747.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___191_17747.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___191_17747.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___191_17747.FStar_TypeChecker_Env.dsenv)
                             }) t in
                   ...
                   (match uu____17754 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___192_17820 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___192_17820.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___192_17820.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___192_17820.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___192_17820.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___192_17820.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___192_17820.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___192_17820.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___192_17820.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        let uu____17843 =
                          (is_flex not_abs) &&
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___193_17859 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___193_17859.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___193_17859.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___193_17859.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___193_17859.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___193_17859.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___193_17859.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___193_17859.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___193_17859.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___193_17899 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___193_17899.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___193_17899.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___193_17899.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___193_17899.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___193_17899.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___193_17899.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___193_17899.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___193_17899.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                        ...
                        (match uu____17941 with
                         | (x2,phi2) ->
                             ...
                             then
                               ...
                               let uu____18017 =
                                 solve env1
                                   (let uu___194_18019 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___194_18019.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___194_18019.smt_ok);
                                      tcenv = (uu___194_18019.tcenv)
                                    }) in
                                ...
                                | Success uu____18031 ->
                                    ...
                                    let wl1 =
                                      solve_prob orig
                                        ...
                                        [] wl in
                                    let wl2 =
                                      let uu___195_18050 = wl1 in
                                      {
                                        attempting =
                                          (uu___195_18050.attempting);
                                        wl_deferred =
                                          (uu___195_18050.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___195_18050.defer_ok);
                                        smt_ok = (uu___195_18050.smt_ok);
                                        tcenv = (uu___195_18050.tcenv)
                                      } in
               ...
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18420,FStar_Syntax_Syntax.Tm_type uu____18421) ->
                   solve_t' env
                     (let uu___196_18439 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___196_18439.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___196_18439.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___196_18439.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___196_18439.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___196_18439.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___196_18439.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___196_18439.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___196_18439.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___196_18439.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                  ...
                  uu____18444) ->
                   solve_t' env
                     (let uu___196_18482 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___196_18482.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___196_18482.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___196_18482.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___196_18482.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___196_18482.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___196_18482.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___196_18482.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___196_18482.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___196_18482.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18483,FStar_Syntax_Syntax.Tm_arrow uu____18484) ->
                   solve_t' env
                     (let uu___196_18514 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___196_18514.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___196_18514.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___196_18514.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___196_18514.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___196_18514.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___196_18514.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___196_18514.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___196_18514.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___196_18514.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                  ...
                  uu____18519) ->
                   solve_t' env
                     (let uu___196_18569 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___196_18569.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___196_18569.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___196_18569.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___196_18569.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___196_18569.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___196_18569.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___196_18569.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___196_18569.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___196_18569.FStar_TypeChecker_Common.rank)
                      }) wl
                      ...
                      then
                        let uu____18592 =
                          FStar_All.pipe_left
                            ...
                            (let uu___197_18598 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___197_18598.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___197_18598.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___197_18598.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___197_18598.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___197_18598.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___197_18598.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___197_18598.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___197_18598.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___197_18598.FStar_TypeChecker_Common.rank)
                             }) in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18650 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___198_18656 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___198_18656.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___198_18656.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___198_18656.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___198_18656.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___198_18656.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___198_18656.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___198_18656.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___198_18656.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___198_18656.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18657 =
                              ...
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___199_18677 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___199_18677.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___199_18677.FStar_Syntax_Syntax.index);
                      ...
                      then
                        let uu____18745 =
                          FStar_All.pipe_left
                            ...
                            (let uu___197_18751 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___197_18751.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___197_18751.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___197_18751.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___197_18751.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___197_18751.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___197_18751.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___197_18751.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___197_18751.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___197_18751.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____18760 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18803 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___198_18809 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___198_18809.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___198_18809.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___198_18809.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___198_18809.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___198_18809.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___198_18809.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___198_18809.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___198_18809.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___198_18809.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18810 =
                                    destruct_flex_pattern env t1 in
                              ...
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___199_18830 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___199_18830.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___199_18830.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort = t1
                                    } in
                                  let impl =
                                    guard_on_element wl problem y' phi in
               ...
               | (uu____18853,FStar_Syntax_Syntax.Tm_uvar uu____18854) ->
                   ...
                   then
                     ...
                     (let uu____18872 = base_and_refinement env wl t1 in
                      ...
                      | (t_base,uu____18888) ->
                          solve_t env
                            (let uu___200_18910 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___200_18910.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___200_18910.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___200_18910.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___200_18910.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___200_18910.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___200_18910.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___200_18910.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___200_18910.FStar_TypeChecker_Common.rank)
                             }) wl)
                  ...
                  ({
                   ...
                   then
                     ...
                     (let uu____18955 = base_and_refinement env wl t1 in
                      ...
                      | (t_base,uu____18971) ->
                          solve_t env
                            (let uu___200_18993 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___200_18993.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___200_18993.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___200_18993.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___200_18993.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___200_18993.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___200_18993.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___200_18993.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___200_18993.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____18996,uu____18997) ->
                   ...
                   solve_t env
                     (let uu___201_19031 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___201_19031.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___201_19031.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___201_19031.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___201_19031.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___201_19031.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___201_19031.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___201_19031.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___201_19031.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___201_19031.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____19032,FStar_Syntax_Syntax.Tm_refine uu____19033) ->
                   ...
                   solve_t env
                     (let uu___202_19067 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___202_19067.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___202_19067.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___202_19067.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___202_19067.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___202_19067.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___202_19067.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___202_19067.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___202_19067.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___202_19067.FStar_TypeChecker_Common.rank)
                      }) wl
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu____21410,FStar_Syntax_Syntax.Comp uu____21411) ->
                     let uu____21420 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___203_21425.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21430;
                         FStar_TypeChecker_Common.relation =
                           (uu___203_21425.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___203_21425.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___203_21425.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___203_21425.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___203_21425.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___203_21425.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___203_21425.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___203_21425.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21420 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____21432,FStar_Syntax_Syntax.Comp uu____21433) ->
                     let uu____21442 =
                       let uu___203_21447 = problem in
                       let uu____21452 =
                         let uu____21453 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___203_21447.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21452;
                         FStar_TypeChecker_Common.relation =
                           (uu___203_21447.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___203_21447.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___203_21447.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___203_21447.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___203_21447.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___203_21447.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___203_21447.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___203_21447.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21442 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21454,FStar_Syntax_Syntax.GTotal uu____21455) ->
                     let uu____21464 =
                       let uu___204_21469 = problem in
                       let uu____21474 =
                         let uu____21475 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___204_21469.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___204_21469.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___204_21469.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21474;
                         FStar_TypeChecker_Common.element =
                           (uu___204_21469.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___204_21469.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___204_21469.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___204_21469.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___204_21469.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___204_21469.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____21464 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21476,FStar_Syntax_Syntax.Total uu____21477) ->
                     let uu____21486 =
                       let uu___204_21491 = problem in
                       let uu____21496 =
                         let uu____21497 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___204_21491.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___204_21491.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___204_21491.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21496;
                         FStar_TypeChecker_Common.element =
                           (uu___204_21491.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___204_21491.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___204_21491.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___204_21491.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___204_21491.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___204_21491.FStar_TypeChecker_Common.rank)
                       } in
    ...
    fun probs  ->
      fun err1  ->
        let probs1 =
          ...
          if uu____21899
          then
            let uu___205_21900 = probs in
            {
              attempting = (uu___205_21900.attempting);
              wl_deferred = (uu___205_21900.wl_deferred);
              ctr = (uu___205_21900.ctr);
              defer_ok = false;
              smt_ok = (uu___205_21900.smt_ok);
              tcenv = (uu___205_21900.tcenv)
            }
          else probs in
        let tx = FStar_Syntax_Unionfind.new_transaction () in
          ...
          ((let uu____21925 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___206_21940 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___206_21940.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___206_21940.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___206_21940.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
    ...
    fun env  ->
      fun uu____22279  ->
        ...
        | (variables,ineqs) ->
            ...
            let uu____22459 =
              let wl =
                let uu___207_22463 = empty_worklist env in
                {
                  attempting = (uu___207_22463.attempting);
                  wl_deferred = (uu___207_22463.wl_deferred);
                  ctr = (uu___207_22463.ctr);
                  defer_ok = false;
                  smt_ok = (uu___207_22463.smt_ok);
                  tcenv = (uu___207_22463.tcenv)
                } in
  ...
  fun env  ->
    fun g  ->
      ...
      (let g1 =
         ...
         | FStar_Pervasives_Native.Some [] ->
             let uu___208_22718 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___208_22718.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___208_22718.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___208_22718.FStar_TypeChecker_Env.implicits)
             }
         | uu____22723 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___209_22727 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___209_22727.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___209_22727.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___209_22727.FStar_TypeChecker_Env.implicits)
        }))
let last_proof_ns:
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___210_22937 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___210_22937.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___210_22937.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___210_22937.FStar_TypeChecker_Env.implicits)
            } in
          let uu____22938 =
                        ...
                        then until_fixpoint ((hd1 :: out), changed) tl1
                          ...
                          (let env1 =
                           ...
                           (let env2 =
                              if forcelax
                              then
                                let uu___211_23288 = env1 in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___211_23288.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___211_23288.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___211_23288.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___211_23288.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___211_23288.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___211_23288.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___211_23288.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___211_23288.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___211_23288.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___211_23288.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___211_23288.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___211_23288.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___211_23288.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___211_23288.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___211_23288.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___211_23288.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___211_23288.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___211_23288.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax = true;
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___211_23288.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.failhard =
                                    (uu___211_23288.FStar_TypeChecker_Env.failhard);
                                  FStar_TypeChecker_Env.nosynth =
                                    (uu___211_23288.FStar_TypeChecker_Env.nosynth);
                                  FStar_TypeChecker_Env.tc_term =
                                    (uu___211_23288.FStar_TypeChecker_Env.tc_term);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___211_23288.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___211_23288.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts =
                                    (uu___211_23288.FStar_TypeChecker_Env.use_bv_sorts);
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___211_23288.FStar_TypeChecker_Env.qname_and_index);
                                  FStar_TypeChecker_Env.proof_ns =
                                    (uu___211_23288.FStar_TypeChecker_Env.proof_ns);
                                  FStar_TypeChecker_Env.synth =
                                    (uu___211_23288.FStar_TypeChecker_Env.synth);
                                  FStar_TypeChecker_Env.is_native_tactic =
                                    (uu___211_23288.FStar_TypeChecker_Env.is_native_tactic);
                                  FStar_TypeChecker_Env.identifier_info =
                                    (uu___211_23288.FStar_TypeChecker_Env.identifier_info);
                                  FStar_TypeChecker_Env.tc_hooks =
                                    (uu___211_23288.FStar_TypeChecker_Env.tc_hooks);
                                  FStar_TypeChecker_Env.dsenv =
                                    (uu___211_23288.FStar_TypeChecker_Env.dsenv)
                                }
                              else env1 in
                            let g1 =
                              if must_total
                              then
                                let uu____23291 =
                                  env2.FStar_TypeChecker_Env.type_of
                                    (let uu___212_23299 = env2 in
                                     {
                                       FStar_TypeChecker_Env.solver =
                                         (uu___212_23299.FStar_TypeChecker_Env.solver);
                                       FStar_TypeChecker_Env.range =
                                         (uu___212_23299.FStar_TypeChecker_Env.range);
                                       FStar_TypeChecker_Env.curmodule =
                                         (uu___212_23299.FStar_TypeChecker_Env.curmodule);
                                       FStar_TypeChecker_Env.gamma =
                                         (uu___212_23299.FStar_TypeChecker_Env.gamma);
                                       FStar_TypeChecker_Env.gamma_cache =
                                         (uu___212_23299.FStar_TypeChecker_Env.gamma_cache);
                                       FStar_TypeChecker_Env.modules =
                                         (uu___212_23299.FStar_TypeChecker_Env.modules);
                                       FStar_TypeChecker_Env.expected_typ =
                                         (uu___212_23299.FStar_TypeChecker_Env.expected_typ);
                                       FStar_TypeChecker_Env.sigtab =
                                         (uu___212_23299.FStar_TypeChecker_Env.sigtab);
                                       FStar_TypeChecker_Env.is_pattern =
                                         (uu___212_23299.FStar_TypeChecker_Env.is_pattern);
                                       FStar_TypeChecker_Env.instantiate_imp
                                         =
                                         (uu___212_23299.FStar_TypeChecker_Env.instantiate_imp);
                                       FStar_TypeChecker_Env.effects =
                                         (uu___212_23299.FStar_TypeChecker_Env.effects);
                                       FStar_TypeChecker_Env.generalize =
                                         (uu___212_23299.FStar_TypeChecker_Env.generalize);
                                       FStar_TypeChecker_Env.letrecs =
                                         (uu___212_23299.FStar_TypeChecker_Env.letrecs);
                                       FStar_TypeChecker_Env.top_level =
                                         (uu___212_23299.FStar_TypeChecker_Env.top_level);
                                       FStar_TypeChecker_Env.check_uvars =
                                         (uu___212_23299.FStar_TypeChecker_Env.check_uvars);
                                       FStar_TypeChecker_Env.use_eq =
                                         (uu___212_23299.FStar_TypeChecker_Env.use_eq);
                                       FStar_TypeChecker_Env.is_iface =
                                         (uu___212_23299.FStar_TypeChecker_Env.is_iface);
                                       FStar_TypeChecker_Env.admit =
                                         (uu___212_23299.FStar_TypeChecker_Env.admit);
                                       FStar_TypeChecker_Env.lax =
                                         (uu___212_23299.FStar_TypeChecker_Env.lax);
                                       FStar_TypeChecker_Env.lax_universes =
                                         (uu___212_23299.FStar_TypeChecker_Env.lax_universes);
                                       FStar_TypeChecker_Env.failhard =
                                         (uu___212_23299.FStar_TypeChecker_Env.failhard);
                                       FStar_TypeChecker_Env.nosynth =
                                         (uu___212_23299.FStar_TypeChecker_Env.nosynth);
                                       FStar_TypeChecker_Env.tc_term =
                                         (uu___212_23299.FStar_TypeChecker_Env.tc_term);
                                       FStar_TypeChecker_Env.type_of =
                                         (uu___212_23299.FStar_TypeChecker_Env.type_of);
                                       FStar_TypeChecker_Env.universe_of =
                                         (uu___212_23299.FStar_TypeChecker_Env.universe_of);
                                       FStar_TypeChecker_Env.use_bv_sorts =
                                         true;
                                       FStar_TypeChecker_Env.qname_and_index
                                         =
                                         (uu___212_23299.FStar_TypeChecker_Env.qname_and_index);
                                       FStar_TypeChecker_Env.proof_ns =
                                         (uu___212_23299.FStar_TypeChecker_Env.proof_ns);
                                       FStar_TypeChecker_Env.synth =
                                         (uu___212_23299.FStar_TypeChecker_Env.synth);
                                       FStar_TypeChecker_Env.is_native_tactic
                                         =
                                         (uu___212_23299.FStar_TypeChecker_Env.is_native_tactic);
                                       FStar_TypeChecker_Env.identifier_info
                                         =
                                         (uu___212_23299.FStar_TypeChecker_Env.identifier_info);
                                       FStar_TypeChecker_Env.tc_hooks =
                                         (uu___212_23299.FStar_TypeChecker_Env.tc_hooks);
                                       FStar_TypeChecker_Env.dsenv =
                                         (uu___212_23299.FStar_TypeChecker_Env.dsenv)
                                     }) tm1 in
                                ...
                                (let uu____23304 =
                                   env2.FStar_TypeChecker_Env.tc_term
                                     (let uu___213_23312 = env2 in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___213_23312.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___213_23312.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___213_23312.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___213_23312.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___213_23312.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___213_23312.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___213_23312.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___213_23312.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.is_pattern =
                                          (uu___213_23312.FStar_TypeChecker_Env.is_pattern);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___213_23312.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___213_23312.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___213_23312.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___213_23312.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___213_23312.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___213_23312.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___213_23312.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___213_23312.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___213_23312.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax =
                                          (uu___213_23312.FStar_TypeChecker_Env.lax);
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___213_23312.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___213_23312.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___213_23312.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___213_23312.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___213_23312.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___213_23312.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          true;
                                        FStar_TypeChecker_Env.qname_and_index
                                          =
                                          (uu___213_23312.FStar_TypeChecker_Env.qname_and_index);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___213_23312.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth =
                                          (uu___213_23312.FStar_TypeChecker_Env.synth);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___213_23312.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___213_23312.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___213_23312.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___213_23312.FStar_TypeChecker_Env.dsenv)
                                      }) tm1 in
                            ...
                            let g2 =
                              ...
                              then
                                let uu___214_23317 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___214_23317.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___214_23317.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___214_23317.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____23320 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
        let uu___215_23354 = g in
        let uu____23355 =
          until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___215_23354.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___215_23354.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs =
            (uu___215_23354.FStar_TypeChecker_Env.univ_ineqs);
...
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___216_23477 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___216_23477.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___216_23477.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___216_23477.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
