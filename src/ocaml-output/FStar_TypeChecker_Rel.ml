...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___138_765 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___138_765.wl_deferred);
          ctr = (uu___138_765.ctr);
          defer_ok = (uu___138_765.defer_ok);
          smt_ok;
          tcenv = (uu___138_765.tcenv)
        }
let singleton:
  FStar_TypeChecker_Env.env -> FStar_TypeChecker_Common.prob -> worklist =
  fun env  -> fun prob  -> singleton' env prob true
let wl_of_guard env g =
  let uu___139_790 = empty_worklist env in
  let uu____791 = FStar_List.map FStar_Pervasives.snd g in
  {
    attempting = uu____791;
    wl_deferred = (uu___139_790.wl_deferred);
    ctr = (uu___139_790.ctr);
    defer_ok = false;
    smt_ok = (uu___139_790.smt_ok);
    tcenv = (uu___139_790.tcenv)
  }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___140_803 = wl in
        {
          attempting = (uu___140_803.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___140_803.ctr);
          defer_ok = (uu___140_803.defer_ok);
          smt_ok = (uu___140_803.smt_ok);
          tcenv = (uu___140_803.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___141_815 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___141_815.wl_deferred);
        ctr = (uu___141_815.ctr);
        defer_ok = (uu___141_815.defer_ok);
        smt_ok = (uu___141_815.smt_ok);
        tcenv = (uu___141_815.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert_rel: FStar_TypeChecker_Common.rel -> FStar_TypeChecker_Common.rel
  =
  fun uu___108_831  ->
    match uu___108_831 with
    | FStar_TypeChecker_Common.EQ  -> FStar_TypeChecker_Common.EQ
    | FStar_TypeChecker_Common.SUB  -> FStar_TypeChecker_Common.SUBINV
    | FStar_TypeChecker_Common.SUBINV  -> FStar_TypeChecker_Common.SUB
let invert p =
  let uu___142_847 = p in
  {
    FStar_TypeChecker_Common.pid =
      (uu___142_847.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
    FStar_TypeChecker_Common.relation =
      (invert_rel p.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
    FStar_TypeChecker_Common.element =
      (uu___142_847.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___142_847.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___142_847.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___142_847.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___142_847.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___142_847.FStar_TypeChecker_Common.rank)
  }
let maybe_invert p =
...
let vary_rel:
  ...
  fun rel  ->
    fun uu___110_884  ->
      match uu___110_884 with
      | INVARIANT  -> FStar_TypeChecker_Common.EQ
      | CONTRAVARIANT  -> invert_rel rel
      | COVARIANT  -> rel
let p_pid: FStar_TypeChecker_Common.prob -> Prims.int =
  fun uu___111_887  ->
    match uu___111_887 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.pid
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.pid
let p_rel: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.rel =
  fun uu___112_896  ->
    match uu___112_896 with
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___116_938  ->
    match uu___116_938 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___117_947  ->
    match uu___117_947 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1297  ->
              ...
              | (x,imp) ->
                  let uu____1304 =
                    let uu___143_1305 = x in
                    let uu____1306 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___143_1305.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___143_1305.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____2365,uv) ->
                ((let uu____2368 =
                 ...
                 commit uvis;
                 (let uu___144_2397 = wl in
                  {
                    attempting = (uu___144_2397.attempting);
                    wl_deferred = (uu___144_2397.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___144_2397.defer_ok);
                    smt_ok = (uu___144_2397.smt_ok);
                    tcenv = (uu___144_2397.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___145_2418 = wl in
         {
           attempting = (uu___145_2418.attempting);
           wl_deferred = (uu___145_2418.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___145_2418.defer_ok);
           smt_ok = (uu___145_2418.smt_ok);
           tcenv = (uu___145_2418.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
...
let rec decompose:
  ...
  fun env  ->
    fun t  ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____4412))::tcs2) ->
                       aux
                         (((let uu___146_4434 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___146_4434.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___146_4434.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___123_4475 =
                 match uu___123_4475 with
      ...
      | uu____4566 ->
          let rebuild uu___124_4571 =
            match uu___124_4571 with
            | [] -> t1
            | uu____4573 -> failwith "Bad reconstruction" in
          (rebuild, ((fun t2  -> true)), [])
let un_T: tc -> FStar_Syntax_Syntax.term =
  fun uu___125_4592  ->
    match uu___125_4592 with
    | T (t,uu____4594) -> t
    | uu____4603 -> failwith "Impossible"
let arg_of_tc: tc -> FStar_Syntax_Syntax.arg =
  fun uu___126_4606  ->
    match uu___126_4606 with
...
let compress_tprob wl p =
  ...
  {
    FStar_TypeChecker_Common.pid =
      (uu___147_5296.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = uu____5299;
    FStar_TypeChecker_Common.relation =
      (uu___147_5296.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = uu____5300;
    FStar_TypeChecker_Common.element =
      (uu___147_5296.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___147_5296.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___147_5296.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___147_5296.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___147_5296.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___147_5296.FStar_TypeChecker_Common.rank)
  }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____5376) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5494 ->
                                    ...
                                    let uu____5503 =
                                      let uu___148_5506 = tp in
                                      let uu____5509 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___148_5506.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___148_5506.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___148_5506.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____5509;
                                        FStar_TypeChecker_Common.element =
                                          (uu___148_5506.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___148_5506.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___148_5506.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___148_5506.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___148_5506.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___148_5506.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____5503)))
                                ...
                                | uu____5569 ->
                                    let uu____5575 =
                                        ...
                                        force_refinement (b, ref_opt) in
                                      {
                                        ...
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___149_5580.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                    ...
                    (match uu____5391 with
                     | (rank,tp1) ->
                         let uu____5611 =
                           FStar_All.pipe_right
                             (let uu___150_5614 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___150_5614.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___150_5614.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___150_5614.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___150_5614.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___150_5614.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___150_5614.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___150_5614.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___150_5614.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___150_5614.FStar_TypeChecker_Common.loc);
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____5620 =
            FStar_All.pipe_right
              (let uu___151_5623 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___151_5623.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___151_5623.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___151_5623.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___151_5623.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___151_5623.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___151_5623.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___151_5623.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___151_5623.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___151_5623.FStar_TypeChecker_Common.loc);
  ...
  fun env  ->
    fun probs  ->
      ...
      (let uu____6327 = next_prob probs in
       ...
       | (Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___152_6340 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___152_6340.wl_deferred);
               ctr = (uu___152_6340.ctr);
               defer_ok = (uu___152_6340.defer_ok);
               smt_ok = (uu___152_6340.smt_ok);
               tcenv = (uu___152_6340.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____6441 ->
                          let uu____6446 =
                                      ...
                                      | (uu____6461,uu____6462,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___153_6447.ctr);
                              defer_ok = (uu___153_6447.defer_ok);
                              smt_ok = (uu___153_6447.smt_ok);
                              tcenv = (uu___153_6447.tcenv)
                            } in
                       ...
                       (match uu____7006 with
                        ...
                        | Some (lhs_bound,sub_probs) ->
                            ...
                            ((let uu____7035 =
                              ...
                              then
                                let wl' =
                                  let uu___154_7037 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred = (uu___154_7037.wl_deferred);
                                    ctr = (uu___154_7037.ctr);
                                    defer_ok = (uu___154_7037.defer_ok);
                                    smt_ok = (uu___154_7037.smt_ok);
                                    tcenv = (uu___154_7037.tcenv)
                                  } in
                             ...
                             (let uu____7040 =
                                solve_t env eq_prob
                                  (let uu___155_7041 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___155_7041.wl_deferred);
                                     ctr = (uu___155_7041.ctr);
                                     defer_ok = (uu___155_7041.defer_ok);
                                     smt_ok = (uu___155_7041.smt_ok);
                                     tcenv = (uu___155_7041.tcenv)
                                   }) in
                              match uu____7040 with
                              | Success uu____7043 ->
                                  let wl1 =
                                    let uu___156_7045 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___156_7045.wl_deferred);
                                      ctr = (uu___156_7045.ctr);
                                      defer_ok = (uu___156_7045.defer_ok);
                                      smt_ok = (uu___156_7045.smt_ok);
                                      tcenv = (uu___156_7045.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____7601 with
                             ...
                             | Some (rhs_bound,sub_probs) ->
                                 ...
                                 ((let uu____7642 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___157_7644 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___157_7644.wl_deferred);
                                         ctr = (uu___157_7644.ctr);
                                         defer_ok = (uu___157_7644.defer_ok);
                                         smt_ok = (uu___157_7644.smt_ok);
                                         tcenv = (uu___157_7644.tcenv)
                                       } in
                                  ...
                                  (let uu____7647 =
                                     solve_t env eq_prob
                                       (let uu___158_7648 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___158_7648.wl_deferred);
                                          ctr = (uu___158_7648.ctr);
                                          defer_ok = (uu___158_7648.defer_ok);
                                          smt_ok = (uu___158_7648.smt_ok);
                                          tcenv = (uu___158_7648.tcenv)
                                        }) in
                                   match uu____7647 with
                                   | Success uu____7650 ->
                                       let wl1 =
                                         let uu___159_7652 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___159_7652.wl_deferred);
                                           ctr = (uu___159_7652.ctr);
                                           defer_ok =
                                             (uu___159_7652.defer_ok);
                                           smt_ok = (uu___159_7652.smt_ok);
                                           tcenv = (uu___159_7652.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___160_7756 = hd1 in
                      let uu____7757 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___160_7756.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___160_7756.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____7757
                      } in
                    let hd21 =
                      let uu___161_7761 = hd2 in
                      let uu____7762 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___161_7761.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___161_7761.FStar_Syntax_Syntax.index);
      ...
      fun wl  ->
        ...
        let rigid_rigid_delta env1 orig wl1 head1 head2 t1 t2 =
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____7957,Some (t11,t21)) ->
                   solve_t env1
                     (let uu___162_7965 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___162_7965.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___162_7965.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___162_7965.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___162_7965.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___162_7965.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___162_7965.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___162_7965.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___162_7965.FStar_TypeChecker_Common.rank)
                      }) wl1
               | (uu____7966,None ) ->
                   ((let uu____7973 =
                     ...
                     if uu____7973
                     then
                       let uu____7974 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____7975 = FStar_Syntax_Print.tag_of_term t1 in
                       let uu____7976 = FStar_Syntax_Print.term_to_string t2 in
                       let uu____7977 = FStar_Syntax_Print.tag_of_term t2 in
                       FStar_Util.print4
                         "Head matches: %s (%s) and %s (%s)\n" uu____7974
                         uu____7975 uu____7976 uu____7977
                     else ());
                    (let uu____7979 = FStar_Syntax_Util.head_and_args t1 in
                     match uu____7979 with
                     | (head11,args1) ->
                         let uu____8005 = FStar_Syntax_Util.head_and_args t2 in
                          ...
                          | (head21,args2) ->
                              ...
                              then
                                let uu____8045 =
                                  ...
                                  let uu____8047 = args_to_string args1 in
                                  let uu____8048 =
                                    FStar_Syntax_Print.term_to_string head21 in
                                  let uu____8049 = args_to_string args2 in
                                  FStar_Util.format4
                                    "unequal number of arguments: %s[%s] and %s[%s]"
                                    uu____8046 uu____8047 uu____8048
                                    uu____8049 in
                                giveup env1 uu____8045 orig
                              else
                                (let uu____8051 =
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____8054 =
                                        FStar_Syntax_Util.eq_args args1 args2 in
                                      uu____8054 = FStar_Syntax_Util.Equal) in
                                 if uu____8051
                                 then
                                   let uu____8055 =
                                                  ...
                                                  solve_t env1
                                                    (let uu___163_8212 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___163_8212.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        let imitate orig env1 wl1 p =
          let uu____8232 = p in
          match uu____8232 with
          | (((u,k),xs,c),ps,(h,uu____8243,qs)) ->
              let xs1 = sn_binders env1 xs in
              let r = FStar_TypeChecker_Env.get_range env1 in
              let uu____8292 = imitation_sub_probs orig env1 xs1 ps qs in
              (match uu____8292 with
               | (sub_probs,gs_xs,formula) ->
                   let im =
                     let uu____8306 = h gs_xs in
                     let uu____8307 =
                       let uu____8314 =
                         FStar_All.pipe_right
                     ...
                     FStar_Syntax_Util.abs xs1 uu____8306 uu____8307 in
                   ((let uu____8345 =
                       FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1)
                         (FStar_Options.Other "Rel") in
                     if uu____8345
                     then
                       ...
                       let uu____8347 = FStar_Syntax_Print.comp_to_string c in
                       let uu____8348 = FStar_Syntax_Print.term_to_string im in
                       let uu____8349 = FStar_Syntax_Print.tag_of_term im in
                       let uu____8350 =
                         let uu____8351 =
                       ...
                       FStar_Util.print6
                         ...
                         uu____8346 uu____8347 uu____8348 uu____8349
                         uu____8350 uu____8354
                     else ());
                    (let wl2 =
                       solve_prob orig (Some formula) [TERM ((u, k), im)] wl1 in
                     solve env1 (attempt sub_probs wl2)))) in
        let imitate' orig env1 wl1 uu___129_8372 =
          match uu___129_8372 with
        ...
        let project orig env1 wl1 i p =
          ...
          | ((u,xs,c),ps,(h,matches,qs)) ->
              let r = FStar_TypeChecker_Env.get_range env1 in
              let uu____8459 = FStar_List.nth ps i in
              (match uu____8459 with
               | (pi,uu____8462) ->
                   let uu____8467 = FStar_List.nth xs i in
                   (match uu____8467 with
                    | (xi,uu____8474) ->
                        let rec gs k =
                          let uu____8483 = FStar_Syntax_Util.arrow_formals k in
                          ...
                          | (bs,k1) ->
                              let rec aux subst1 bs1 =
                                ...
                                | (a,uu____8535)::tl1 ->
                                    ...
                                    let uu____8543 = new_uvar r xs k_a in
                                     ...
                                     | (gi_xs,gi) ->
                                         ...
                                         let subst2 =
                                           (FStar_Syntax_Syntax.NT
                                              (a, gi_xs1))
                                           :: subst1 in
                                         let uu____8562 = aux subst2 tl1 in
                                              ...
                                              let uu____8580 =
                                                let uu____8582 =
                                                  FStar_Syntax_Syntax.as_arg
                                                    gi_ps in
                                                uu____8582 :: gi_ps' in
                                              (uu____8577, uu____8580))) in
                              aux [] bs in
                        let uu____8585 =
                          let uu____8586 = matches pi in
                          FStar_All.pipe_left Prims.op_Negation uu____8586 in
                        if uu____8585
                        then None
                        else
                          (let uu____8589 = gs xi.FStar_Syntax_Syntax.sort in
                           ...
                           | (g_xs,uu____8596) ->
                               ...
                               let proj =
                                 ...
                                 FStar_Syntax_Util.abs xs uu____8603
                                   uu____8608 in
                               let sub1 =
                                 let uu____8646 =
                                   let uu____8649 =
                                     ...
                                     let uu____8659 =
                                       FStar_List.map
                                         (fun uu____8665  ->
                                            ...
                                            | (uu____8670,uu____8671,y) -> y)
                                         qs in
                                     FStar_All.pipe_left h uu____8659 in
                                   mk_problem (p_scope orig) orig uu____8649
                                     (p_rel orig) uu____8656 None
                                     "projection" in
                                 FStar_All.pipe_left
                                   (fun _0_54  ->
                               ...
                               ((let uu____8681 =
                                 ...
                                 then
                                   ...
                                   let uu____8683 = prob_to_string env1 sub1 in
                                   FStar_Util.print2
                                     "Projecting %s\n\tsubprob=%s\n"
                                ...
                                (let wl2 =
                                   let uu____8686 =
                                     ...
                                     Some uu____8688 in
                                   solve_prob orig uu____8686
                                     [TERM (u, proj)] wl1 in
                                 let uu____8693 =
                                   solve env1 (attempt [sub1] wl2) in
                                 FStar_All.pipe_left
                                   (fun _0_55  -> Some _0_55) uu____8693))))) in
        let solve_t_flex_rigid patterns_only orig lhs t2 wl1 =
          let uu____8717 = lhs in
          match uu____8717 with
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
              let subterms ps =
                let uu____8740 = FStar_Syntax_Util.arrow_formals_comp k_uv in
                match uu____8740 with
                | (xs,c) ->
                    if (FStar_List.length xs) = (FStar_List.length ps)
                    then
                      let uu____8762 =
                        let uu____8788 = decompose env t2 in
                        (((uv, k_uv), xs, c), ps, uu____8788) in
                      Some uu____8762
                    else
                      (let k_uv1 =
                         FStar_TypeChecker_Normalize.normalize
                       ...
                       let rec elim k args =
                         let uu____8871 =
                           let uu____8875 =
                             let uu____8876 = FStar_Syntax_Subst.compress k in
                                       ...
                                       (match uu____8964 with
                                        ...
                                        | Some scope ->
                                            ...
                                            (FStar_Syntax_Unionfind.change
                                             ...
                                             Some (xs1, c1)))
                                   | uu____9043 -> None))
                         | (FStar_Syntax_Syntax.Tm_app uu____9046,uu____9047)
                             ->
                             let uu____9059 =
                               FStar_Syntax_Util.head_and_args k in
                                       ...
                                       (match uu____9109 with
                                        ...
                                        | Some scope ->
                                            ...
                                            (FStar_Syntax_Unionfind.change
                                             ...
                                             Some (xs1, c1)))
                                   | uu____9188 -> None))
                         | (FStar_Syntax_Syntax.Tm_arrow (xs1,c1),uu____9193)
                             ->
                                           ...
                                           let uu____9262 =
                                             elim
                                               (FStar_Syntax_Util.comp_result
                                                  c2) rest in
                                           FStar_Util.bind_opt uu____9262
                                             (fun uu____9273  ->
                         ...
                         | uu____9352 ->
                             let uu____9356 =
                               ...
                               FStar_Util.format3
                                 ...
                                 uu____9357 uu____9358 uu____9359 in
                             failwith uu____9356 in
                       let uu____9363 = elim k_uv1 ps in
                       FStar_Util.bind_opt uu____9363
                         (fun uu____9391  ->
                            match uu____9391 with
                            | (xs1,c1) ->
                                let uu____9419 =
                                  let uu____9442 = decompose env t2 in
                                  (((uv, k_uv1), xs1, c1), ps, uu____9442) in
                                Some uu____9419)) in
              let rec imitate_or_project n1 stopt i =
                ...
                then
                  ...
                  (let st = FStar_Option.get stopt in
                   ...
                   if i = (- (Prims.parse_int "1"))
                   then
                     let uu____9514 = imitate orig env wl1 st in
                     ...
                     (let uu____9525 = project orig env wl1 i st in
                      match uu____9525 with
                      | None  ->
                          (FStar_Syntax_Unionfind.rollback tx;
                           imitate_or_project n1 stopt
                             (i + (Prims.parse_int "1")))
                      | Some (Failed uu____9532) ->
                          (FStar_Syntax_Unionfind.rollback tx;
                           imitate_or_project n1 stopt
                             (i + (Prims.parse_int "1")))
                      | Some sol -> sol)) in
              let check_head fvs1 t21 =
                let uu____9546 = FStar_Syntax_Util.head_and_args t21 in
                match uu____9546 with
                | (hd1,uu____9557) ->
                    (match hd1.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_arrow uu____9572 -> true
                     | FStar_Syntax_Syntax.Tm_constant uu____9580 -> true
                     | FStar_Syntax_Syntax.Tm_abs uu____9581 -> true
                     | uu____9596 ->
                         ...
                         then true
                           ...
                           ((let uu____9602 =
                             ...
                             if uu____9602
                             then
                               let uu____9603 = names_to_string fvs_hd in
              ...
              let imitate_ok t21 =
                let fvs_hd =
                  let uu____9611 =
                    let uu____9614 = FStar_Syntax_Util.head_and_args t21 in
                    FStar_All.pipe_right uu____9614 FStar_Pervasives.fst in
                  FStar_All.pipe_right uu____9611 FStar_Syntax_Free.names in
                let uu____9645 = FStar_Util.set_is_empty fvs_hd in
                if uu____9645
              ...
              (match maybe_pat_vars with
               | Some vars ->
                   ...
                   let uu____9654 = occurs_check env wl1 (uv, k_uv) t21 in
                   (match uu____9654 with
                    | (occurs_ok,msg) ->
                        if Prims.op_Negation occurs_ok
                        then
                          let uu____9662 =
                            let uu____9663 = FStar_Option.get msg in
                            Prims.strcat "occurs-check failed: " uu____9663 in
                          giveup_or_defer1 orig uu____9662
                        else
                          (let uu____9665 =
                           ...
                           then
                             ...
                             (if uu____9666
                              then
                                let uu____9667 = subterms args_lhs in
                                imitate' orig env wl1 uu____9667
                              else
                                ((let uu____9671 =
                                    FStar_All.pipe_left
                                      (FStar_TypeChecker_Env.debug env)
                                  ...
                                  then
                                    ...
                                    let uu____9673 = names_to_string fvs1 in
                                    let uu____9674 = names_to_string fvs2 in
                                    FStar_Util.print3
                                      "Pattern %s with fvars=%s succeeded fvar check: %s\n"
                                      uu____9672 uu____9673 uu____9674
                                  else ());
                                 (let sol =
                                    match vars with
                                    | [] -> t21
                                    | uu____9679 ->
                                        let uu____9680 = sn_binders env vars in
                                        u_abs k_uv uu____9680 t21 in
                                  let wl2 =
                                ...
                                then
                                  ((let uu____9691 =
                                    ...
                                    then
                                      let uu____9692 =
                                        FStar_Syntax_Print.term_to_string t11 in
                                      let uu____9693 = names_to_string fvs1 in
                                      let uu____9694 = names_to_string fvs2 in
                                      FStar_Util.print3
                                        "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n"
                                        uu____9692 uu____9693 uu____9694
                                    else ());
                                   (let uu____9696 = subterms args_lhs in
                                    imitate_or_project
                                      (FStar_List.length args_lhs) uu____9696
                                      (- (Prims.parse_int "1"))))
                                else
                                  giveup env
               ...
               | None  ->
                   ...
                   then solve env (defer "not a pattern" orig wl1)
                     ...
                     (let uu____9707 =
                        let uu____9708 = FStar_Syntax_Free.names t1 in
                        check_head uu____9708 t2 in
                      if uu____9707
                      then
                        ...
                        ((let uu____9712 =
                         ...
                         (let uu____9716 = subterms args_lhs in
        ...
        let flex_flex1 orig lhs rhs =
          ...
          then solve env (defer "flex-flex deferred" orig wl)
            ...
            (let force_quasi_pattern xs_opt uu____9758 =
               match uu____9758 with
               | (t,u,k,args) ->
                   let uu____9788 = FStar_Syntax_Util.arrow_formals k in
                   (match uu____9788 with
                    | (all_formals,uu____9799) ->
                        let rec aux pat_args pattern_vars pattern_var_set
                          ...
                          | ([],[]) ->
                              ...
                              (match uu____9914 with
                               | (t',tm_u1) ->
                                   let uu____9921 = destruct_flex_t t' in
                                   (match uu____9921 with
                                    | (uu____9941,u1,k1,uu____9944) ->
                                        let sol =
                                          let uu____9972 =
                                            let uu____9977 =
                          ...
                          | (formal::formals1,hd1::tl1) ->
                              let uu____10037 = pat_var_opt env pat_args hd1 in
                                      ...
                                      let uu____10076 =
                                        let uu____10077 =
                                          FStar_Util.set_is_subset_of fvs
                                            pattern_var_set in
                                        Prims.op_Negation uu____10077 in
                                      if uu____10076
                                      then
                                        aux pat_args pattern_vars
                                          pattern_var_set formals1 tl1
                                        ...
                                        (let uu____10081 =
                                         ...
                                         aux (y :: pat_args) (formal ::
                                           pattern_vars) uu____10081 formals1
                                           tl1)))
                          | uu____10087 -> failwith "Impossible" in
                        let uu____10098 = FStar_Syntax_Syntax.new_bv_set () in
                        aux [] [] uu____10098 all_formals args) in
             let solve_both_pats wl1 uu____10138 uu____10139 r =
               match (uu____10138, uu____10139) with
               | ((u1,k1,xs,args1),(u2,k2,ys,args2)) ->
                   ...
                   if uu____10253
                   then
                     let uu____10254 = solve_prob orig None [] wl1 in
                     ...
                     (let xs1 = sn_binders env xs in
                      ...
                      (let uu____10269 =
                       ...
                       then
                         ...
                         FStar_Util.print5
                           ...
                           uu____10270 uu____10271 uu____10272 uu____10273
                           uu____10274
                       else ());
                      (let subst_k k xs2 args =
                         ...
                         then
                           ...
                           FStar_Syntax_Subst.subst uu____10316 k
                         else
                           if args_len < xs_len
                           then
                             (let uu____10324 =
                              ...
                              | (xs3,xs_rest) ->
                                  ...
                                  FStar_Syntax_Subst.subst uu____10357 k3)
                           else
                             (let uu____10360 =
                                let uu____10361 =
                                  FStar_Syntax_Print.term_to_string k in
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____10361 uu____10362 uu____10363 in
                              failwith uu____10360) in
                       let uu____10364 =
                         let uu____10370 =
                           let uu____10378 =
                             FStar_TypeChecker_Normalize.normalize
                               [FStar_TypeChecker_Normalize.Beta] env k1 in
                           FStar_Syntax_Util.arrow_formals uu____10378 in
                         ...
                         | (bs,k1') ->
                             let uu____10396 =
                               ...
                               FStar_Syntax_Util.arrow_formals uu____10404 in
                             (match uu____10396 with
                              | (cs,k2') ->
                                  ...
                                  let uu____10430 =
                                    ...
                                    (uu____10433, uu____10437) in
                                  (match uu____10430 with
                                   | (FStar_Syntax_Syntax.Tm_type
                                      uu____10446,uu____10447) ->
                                       (k1', [sub_prob])
                                   | (uu____10451,FStar_Syntax_Syntax.Tm_type
                                      uu____10452) -> (k2', [sub_prob])
                                   | uu____10456 ->
                                       let uu____10459 =
                                         FStar_Syntax_Util.type_u () in
                                       (match uu____10459 with
                                        | (t,uu____10468) ->
                                            let uu____10469 = new_uvar r zs t in
                                             ...
                                             | (k_zs,uu____10478) ->
                                                 let kprob =
                                                   ...
                                                   FStar_All.pipe_left
                                                     (fun _0_59  ->
                                                        FStar_TypeChecker_Common.TProb
                                                          _0_59) uu____10480 in
                                                 (k_zs, [sub_prob; kprob]))))) in
                       match uu____10364 with
                       | (k_u',sub_probs) ->
                           let uu____10494 =
                             let uu____10502 =
                               let uu____10503 = new_uvar r zs k_u' in
                               FStar_All.pipe_left FStar_Pervasives.fst
                                 uu____10503 in
                             let uu____10508 =
                               let uu____10511 =
                                 FStar_Syntax_Syntax.mk_Total k_u' in
                               FStar_Syntax_Util.arrow xs1 uu____10511 in
                             let uu____10514 =
                               let uu____10517 =
                                 FStar_Syntax_Syntax.mk_Total k_u' in
                               FStar_Syntax_Util.arrow ys1 uu____10517 in
                             (uu____10502, uu____10508, uu____10514) in
             ...
             let solve_one_pat uu____10584 uu____10585 =
               match (uu____10584, uu____10585) with
               | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                   ((let uu____10649 =
                     ...
                     if uu____10649
                     then
                       let uu____10650 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____10651 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.print2
                         "Trying flex-flex one pattern (%s) with %s\n"
                         uu____10650 uu____10651
                     else ());
                    (let uu____10653 = FStar_Syntax_Unionfind.equiv u1 u2 in
                     if uu____10653
                     then
                       let sub_probs =
                         FStar_List.map2
                           (fun uu____10660  ->
                              fun uu____10661  ->
                                match (uu____10660, uu____10661) with
                                | ((a,uu____10671),(t21,uu____10673)) ->
                                    let uu____10678 =
                                      let uu____10681 =
                       ...
                       let guard =
                         ...
                         FStar_Syntax_Util.mk_conj_l uu____10685 in
                       let wl1 = solve_prob orig (Some guard) [] wl in
                       solve env (attempt sub_probs wl1)
                     else
                       (let t21 = sn env t2 in
                        let rhs_vars = FStar_Syntax_Free.names t21 in
                        let uu____10695 = occurs_check env wl (u1, k1) t21 in
                        match uu____10695 with
                        | (occurs_ok,uu____10700) ->
                            let lhs_vars =
                            ...
                            then
                              let sol =
                                let uu____10707 =
                                  let uu____10712 = u_abs k1 xs t21 in
                                  ((u1, k1), uu____10712) in
                                TERM uu____10707 in
             ...
             let uu____10746 = lhs in
             match uu____10746 with
             | (t1,u1,k1,args1) ->
                 let uu____10751 = rhs in
                             ...
                             (let uu____10783 =
                              ...
                              | (sol,uu____10790) ->
                                  ...
                                  ((let uu____10793 =
                                    ...
                                    if uu____10793
                                    then
                                      let uu____10794 = uvi_to_string env sol in
                                      FStar_Util.print1
        ...
        if uu____10801
        then
          let uu____10802 = solve_prob orig None [] wl in
          solve env uu____10802
        else
          (let t1 = problem.FStar_TypeChecker_Common.lhs in
           let t2 = problem.FStar_TypeChecker_Common.rhs in
           let uu____10806 = FStar_Util.physical_equality t1 t2 in
           if uu____10806
           then
             let uu____10807 = solve_prob orig None [] wl in
             solve env uu____10807
           else
             ((let uu____10810 =
                 FStar_TypeChecker_Env.debug env
                   (FStar_Options.Other "RelCheck") in
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               with
               | (FStar_Syntax_Syntax.Tm_bvar uu____10814,uu____10815) ->
                   failwith
                     "Only locally nameless! We should never see a de Bruijn variable"
               | (uu____10816,FStar_Syntax_Syntax.Tm_bvar uu____10817) ->
                   failwith
                     "Only locally nameless! We should never see a de Bruijn variable"
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___130_10857 =
                     match uu___130_10857 with
                     | [] -> c
                     | bs ->
                         let uu____10871 =
                           FStar_Syntax_Syntax.mk
                         ...
                         FStar_Syntax_Syntax.mk_Total uu____10871 in
                   let uu____10881 =
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___131_11046 =
                     match uu___131_11046 with
                     | [] -> t
                     | bs ->
                         FStar_Syntax_Syntax.mk
                             ...
                             fun env1  ->
                               fun subst1  ->
                                 let uu____11164 =
                                   ...
                                   mk_problem scope orig uu____11167
                                     problem.FStar_TypeChecker_Common.relation
                                     uu____11168 None "lambda co-domain" in
                                 FStar_All.pipe_left
                                   (fun _0_62  ->
                                      FStar_TypeChecker_Common.TProb _0_62)
                                   uu____11164))
               | (FStar_Syntax_Syntax.Tm_abs uu____11171,uu____11172) ->
                   let is_abs t =
                     match t.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_abs uu____11195 -> true
                   ...
                   let uu____11238 =
                     let uu____11249 = maybe_eta t1 in
                     let uu____11254 = maybe_eta t2 in
                     (uu____11249, uu____11254) in
                   (match uu____11238 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___164_11285 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___164_11285.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___164_11285.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___164_11285.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___164_11285.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___164_11285.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___164_11285.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___164_11285.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___164_11285.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        if uu____11304
                        then
                          let uu____11305 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____11305 t_abs wl
                        else
                          giveup env
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____11326
                        then
                          let uu____11327 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____11327 t_abs wl
                        else
                          giveup env
                            "head tag mismatch: RHS is an abstraction" orig
                    | uu____11332 ->
               ...
               | (uu____11343,FStar_Syntax_Syntax.Tm_abs uu____11344) ->
                   let is_abs t =
                     match t.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_abs uu____11367 -> true
                   ...
                   let uu____11410 =
                     let uu____11421 = maybe_eta t1 in
                     let uu____11426 = maybe_eta t2 in
                     (uu____11421, uu____11426) in
                   (match uu____11410 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___164_11457 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___164_11457.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___164_11457.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___164_11457.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___164_11457.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___164_11457.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___164_11457.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___164_11457.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___164_11457.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        let uu____11476 =
                          (is_flex not_abs) &&
                        ...
                        if uu____11476
                        then
                          let uu____11477 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____11477 t_abs wl
                        else
                          giveup env
                            "head tag mismatch: RHS is an abstraction" orig
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____11498
                        then
                          let uu____11499 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____11499 t_abs wl
                        else
                          giveup env
                            "head tag mismatch: RHS is an abstraction" orig
                    | uu____11504 ->
                        failwith
                          "Impossible: at least one side is an abstraction")
               | (FStar_Syntax_Syntax.Tm_refine
                  uu____11515,FStar_Syntax_Syntax.Tm_refine uu____11516) ->
                   let uu____11525 = as_refinement env wl t1 in
                   (match uu____11525 with
                    | (x1,phi1) ->
                        let uu____11530 = as_refinement env wl t2 in
                        (match uu____11530 with
                         | (x2,phi2) ->
                               ...
                               let guard =
                                 let uu____11579 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives.fst in
                                 FStar_Syntax_Util.mk_conj uu____11579 impl in
                               let wl1 = solve_prob orig (Some guard) [] wl in
                             ...
                             then
                               let ref_prob =
                                 let uu____11586 =
                                   let uu____11589 =
                                     ...
                                     uu____11590 :: (p_scope orig) in
                                   mk_problem uu____11589 orig phi11
                               ...
                               let uu____11593 =
                                 solve env1
                                   (let uu___165_11594 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___165_11594.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___165_11594.smt_ok);
                                      tcenv = (uu___165_11594.tcenv)
                                    }) in
                               (match uu____11593 with
                                | Failed uu____11598 -> fallback ()
                                | Success uu____11601 ->
                                    let guard =
                                      let uu____11605 =
                                        FStar_All.pipe_right
                                      ...
                                      let uu____11608 =
                                        ...
                                        FStar_All.pipe_right uu____11609
                                          (guard_on_element wl problem x11) in
                                      FStar_Syntax_Util.mk_conj uu____11605
                                        uu____11608 in
                                    let wl1 =
                                      solve_prob orig (Some guard) [] wl in
                                    let wl2 =
                                      let uu___166_11616 = wl1 in
                                      {
                                        attempting =
                                          (uu___166_11616.attempting);
                                        wl_deferred =
                                          (uu___166_11616.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___166_11616.defer_ok);
                                        smt_ok = (uu___166_11616.smt_ok);
                                        tcenv = (uu___166_11616.tcenv)
                                      } in
                                    solve env1 (attempt [base_prob] wl2))
                             else fallback ()))
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____11618,FStar_Syntax_Syntax.Tm_uvar uu____11619) ->
                   let uu____11636 = destruct_flex_t t1 in
                   let uu____11637 = destruct_flex_t t2 in
                   flex_flex1 orig uu____11636 uu____11637
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11638;
                     FStar_Syntax_Syntax.tk = uu____11639;
                     FStar_Syntax_Syntax.pos = uu____11640;
                     FStar_Syntax_Syntax.vars = uu____11641;_},uu____11642),FStar_Syntax_Syntax.Tm_uvar
                  uu____11643) ->
                   let uu____11674 = destruct_flex_t t1 in
                   let uu____11675 = destruct_flex_t t2 in
                   flex_flex1 orig uu____11674 uu____11675
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____11676,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11677;
                     FStar_Syntax_Syntax.tk = uu____11678;
                     FStar_Syntax_Syntax.pos = uu____11679;
                     FStar_Syntax_Syntax.vars = uu____11680;_},uu____11681))
                   ->
                   let uu____11712 = destruct_flex_t t1 in
                   let uu____11713 = destruct_flex_t t2 in
                   flex_flex1 orig uu____11712 uu____11713
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11714;
                     FStar_Syntax_Syntax.tk = uu____11715;
                     FStar_Syntax_Syntax.pos = uu____11716;
                     FStar_Syntax_Syntax.vars = uu____11717;_},uu____11718),FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11719;
                     FStar_Syntax_Syntax.tk = uu____11720;
                     FStar_Syntax_Syntax.pos = uu____11721;
                     FStar_Syntax_Syntax.vars = uu____11722;_},uu____11723))
                   ->
                   let uu____11768 = destruct_flex_t t1 in
                   let uu____11769 = destruct_flex_t t2 in
                   flex_flex1 orig uu____11768 uu____11769
               | (FStar_Syntax_Syntax.Tm_uvar uu____11770,uu____11771) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____11780 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____11780 t2 wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11784;
                     ...
                     FStar_Syntax_Syntax.vars = uu____11787;_},uu____11788),uu____11789)
                   when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____11812 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____11812 t2 wl
               | (uu____11816,FStar_Syntax_Syntax.Tm_uvar uu____11817) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   -> solve_t env (invert problem) wl
               | (uu____11826,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11827;
                     FStar_Syntax_Syntax.tk = uu____11828;
                   ...
                   -> solve_t env (invert problem) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____11854,FStar_Syntax_Syntax.Tm_type uu____11855) ->
                   solve_t' env
                     (let uu___167_11864 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___167_11864.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___167_11864.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___167_11864.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___167_11864.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___167_11864.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___167_11864.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___167_11864.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___167_11864.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___167_11864.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11865;
                     FStar_Syntax_Syntax.tk = uu____11866;
                     FStar_Syntax_Syntax.pos = uu____11867;
                     FStar_Syntax_Syntax.vars = uu____11868;_},uu____11869),FStar_Syntax_Syntax.Tm_type
                  uu____11870) ->
                   solve_t' env
                     (let uu___167_11893 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___167_11893.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___167_11893.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___167_11893.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___167_11893.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___167_11893.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___167_11893.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___167_11893.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___167_11893.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___167_11893.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____11894,FStar_Syntax_Syntax.Tm_arrow uu____11895) ->
                   solve_t' env
                     (let uu___167_11911 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___167_11911.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___167_11911.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___167_11911.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___167_11911.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___167_11911.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___167_11911.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___167_11911.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___167_11911.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___167_11911.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____11912;
                     FStar_Syntax_Syntax.tk = uu____11913;
                     FStar_Syntax_Syntax.pos = uu____11914;
                     FStar_Syntax_Syntax.vars = uu____11915;_},uu____11916),FStar_Syntax_Syntax.Tm_arrow
                  uu____11917) ->
                   solve_t' env
                     (let uu___167_11947 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___167_11947.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___167_11947.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___167_11947.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___167_11947.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___167_11947.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___167_11947.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___167_11947.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___167_11947.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___167_11947.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar uu____11948,uu____11949) ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____11960 =
                        let uu____11961 = is_top_level_prob orig in
                        FStar_All.pipe_left Prims.op_Negation uu____11961 in
                      if uu____11960
                      then
                        let uu____11962 =
                          FStar_All.pipe_left
                            ...
                            (let uu___168_11965 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___168_11965.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___168_11965.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___168_11965.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___168_11965.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___168_11965.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___168_11965.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___168_11965.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___168_11965.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___168_11965.FStar_TypeChecker_Common.rank)
                             }) in
                        let uu____11966 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____11962 uu____11966 t2
                          wl
                      else
                        (let uu____11971 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | None  ->
                                  ...
                                  solve_t_flex_rigid false uu____12001
                                    uu____12005 t_base wl
                              | Some (y,phi) ->
                                  let y' =
                                    let uu___170_12020 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___170_12020.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___170_12020.FStar_Syntax_Syntax.index);
                                  ...
                                  let guard =
                                    let uu____12031 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob)
                                        FStar_Pervasives.fst in
                                    FStar_Syntax_Util.mk_conj uu____12031
                                      impl in
                                  let wl1 =
                                    solve_prob orig (Some guard) [] wl in
                      ...
                      then
                        let uu____12069 =
                          FStar_All.pipe_left
                            ...
                            (let uu___168_12072 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___168_12072.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___168_12072.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___168_12072.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___168_12072.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___168_12072.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___168_12072.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___168_12072.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___168_12072.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___168_12072.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____12078 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              ...
                              | Some (y,phi) ->
                                  let y' =
                                    let uu___170_12127 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___170_12127.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___170_12127.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort = t1
                                    } in
                                  let impl =
                                    guard_on_element wl problem y' phi in
                                  ...
                                  let wl1 =
                                    solve_prob orig (Some guard) [] wl in
                                  solve env (attempt [base_prob] wl1))))
               | (uu____12144,FStar_Syntax_Syntax.Tm_uvar uu____12145) ->
                   if wl.defer_ok
                   then
                     solve env
                       (defer "rigid-flex subtyping deferred" orig wl)
                   else
                     (let uu____12155 = base_and_refinement env wl t1 in
                      match uu____12155 with
                      | (t_base,uu____12166) ->
                          solve_t env
                            (let uu___171_12181 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___171_12181.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___171_12181.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___171_12181.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___171_12181.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___171_12181.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___171_12181.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___171_12181.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___171_12181.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (uu____12184,FStar_Syntax_Syntax.Tm_app
                  ({
                   ...
                   then
                     ...
                     (let uu____12213 = base_and_refinement env wl t1 in
                      match uu____12213 with
                      | (t_base,uu____12224) ->
                          solve_t env
                            (let uu___171_12239 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___171_12239.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___171_12239.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___171_12239.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___171_12239.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___171_12239.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___171_12239.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___171_12239.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___171_12239.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____12242,uu____12243) ->
                   let t21 =
                     let uu____12251 = base_and_refinement env wl t2 in
                     FStar_All.pipe_left force_refinement uu____12251 in
                   solve_t env
                     (let uu___172_12264 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___172_12264.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___172_12264.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___172_12264.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___172_12264.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___172_12264.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___172_12264.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___172_12264.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___172_12264.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___172_12264.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____12265,FStar_Syntax_Syntax.Tm_refine uu____12266) ->
                   let t11 =
                     let uu____12274 = base_and_refinement env wl t1 in
                     FStar_All.pipe_left force_refinement uu____12274 in
                   solve_t env
                     (let uu___173_12287 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___173_12287.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___173_12287.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___173_12287.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___173_12287.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___173_12287.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___173_12287.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___173_12287.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___173_12287.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___173_12287.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_match uu____12290,uu____12291) ->
                   let head1 =
                     let uu____12310 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____12310 FStar_Pervasives.fst in
                   let head2 =
                     let uu____12341 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____12341 FStar_Pervasives.fst in
                   let uu____12369 =
                   ...
                   then
                     ...
                     (if uu____12378
                      then
                        let guard =
                          let uu____12385 =
                            let uu____12386 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____12386 = FStar_Syntax_Util.Equal in
                          if uu____12385
                          then None
                          else
                            (let uu____12389 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_71  -> Some _0_71)
                               uu____12389) in
                        let uu____12391 = solve_prob orig guard [] wl in
                        solve env uu____12391
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_uinst uu____12394,uu____12395) ->
                   let head1 =
                     let uu____12403 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____12403 FStar_Pervasives.fst in
                   let head2 =
                     let uu____12434 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____12434 FStar_Pervasives.fst in
                   let uu____12462 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                        && wl.smt_ok)
                   ...
                   then
                     ...
                     (if uu____12471
                      then
                        let guard =
                          let uu____12478 =
                            let uu____12479 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____12479 = FStar_Syntax_Util.Equal in
                          if uu____12478
                          then None
                          else
                            (let uu____12482 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_72  -> Some _0_72)
                               uu____12482) in
                        let uu____12484 = solve_prob orig guard [] wl in
                        solve env uu____12484
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_name uu____12487,uu____12488) ->
                   let head1 =
               ...
               | (FStar_Syntax_Syntax.Tm_constant uu____12576,uu____12577) ->
                   let head1 =
               ...
               | (FStar_Syntax_Syntax.Tm_fvar uu____12665,uu____12666) ->
                   let head1 =
               ...
               | (FStar_Syntax_Syntax.Tm_app uu____12754,uu____12755) ->
                   let head1 =
                     let uu____12768 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____12768 FStar_Pervasives.fst in
                   let head2 =
                     let uu____12799 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____12799 FStar_Pervasives.fst in
                   let uu____12827 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                        && wl.smt_ok)
                   ...
                   then
                     ...
                     (if uu____12836
                      then
                        let guard =
                          let uu____12843 =
                            let uu____12844 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____12844 = FStar_Syntax_Util.Equal in
                          if uu____12843
                          then None
                          else
                            (let uu____12847 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_76  -> Some _0_76)
                               uu____12847) in
                        let uu____12849 = solve_prob orig guard [] wl in
                        solve env uu____12849
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____12852,FStar_Syntax_Syntax.Tm_match uu____12853) ->
                   let head1 =
                     let uu____12872 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____12872 FStar_Pervasives.fst in
                   let head2 =
                     let uu____12903 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____12903 FStar_Pervasives.fst in
                   let uu____12931 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                        && wl.smt_ok)
                   ...
                   then
                     ...
                     (if uu____12940
                      then
                        let guard =
                          let uu____12947 =
                            let uu____12948 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____12948 = FStar_Syntax_Util.Equal in
                          if uu____12947
                          then None
                          else
                            (let uu____12951 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_77  -> Some _0_77)
                               uu____12951) in
                        let uu____12953 = solve_prob orig guard [] wl in
                        solve env uu____12953
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____12956,FStar_Syntax_Syntax.Tm_uinst uu____12957) ->
                   let head1 =
                     let uu____12965 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____12965 FStar_Pervasives.fst in
                   let head2 =
                     let uu____12996 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____12996 FStar_Pervasives.fst in
                   let uu____13024 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                        && wl.smt_ok)
                   ...
                   then
                     ...
                     (if uu____13033
                      then
                        let guard =
                          let uu____13040 =
                            let uu____13041 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____13041 = FStar_Syntax_Util.Equal in
                          if uu____13040
                          then None
                          else
                            (let uu____13044 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_78  -> Some _0_78)
                               uu____13044) in
                        let uu____13046 = solve_prob orig guard [] wl in
                        solve env uu____13046
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____13049,FStar_Syntax_Syntax.Tm_name uu____13050) ->
                   let head1 =
               ...
               | (uu____13138,FStar_Syntax_Syntax.Tm_constant uu____13139) ->
                   let head1 =
               ...
               | (uu____13227,FStar_Syntax_Syntax.Tm_fvar uu____13228) ->
                   let head1 =
               ...
               | (uu____13316,FStar_Syntax_Syntax.Tm_app uu____13317) ->
                   let head1 =
                     let uu____13330 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____13330 FStar_Pervasives.fst in
                   let head2 =
                     let uu____13361 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____13361 FStar_Pervasives.fst in
                   let uu____13389 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                        && wl.smt_ok)
                   ...
                   then
                     ...
                     (if uu____13398
                      then
                        let guard =
                          let uu____13405 =
                            let uu____13406 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____13406 = FStar_Syntax_Util.Equal in
                          if uu____13405
                          then None
                          else
                            (let uu____13409 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left (fun _0_82  -> Some _0_82)
                               uu____13409) in
                        let uu____13411 = solve_prob orig guard [] wl in
                        solve env uu____13411
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_ascribed
                  (t11,uu____13415,uu____13416),uu____13417) ->
                   solve_t' env
                     (let uu___174_13446 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___174_13446.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___174_13446.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___174_13446.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___174_13446.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___174_13446.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___174_13446.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___174_13446.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___174_13446.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___174_13446.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____13449,FStar_Syntax_Syntax.Tm_ascribed
                  (t21,uu____13451,uu____13452)) ->
                   solve_t' env
                     (let uu___175_13481 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___175_13481.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___175_13481.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___175_13481.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___175_13481.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___175_13481.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___175_13481.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___175_13481.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___175_13481.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___175_13481.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_let uu____13482,uu____13483) ->
                   let uu____13491 =
                     let uu____13492 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13493 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13492
                       uu____13493 in
                   failwith uu____13491
               | (FStar_Syntax_Syntax.Tm_meta uu____13494,uu____13495) ->
                   let uu____13500 =
                     let uu____13501 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13502 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13501
                       uu____13502 in
                   failwith uu____13500
               | (FStar_Syntax_Syntax.Tm_delayed uu____13503,uu____13504) ->
                   let uu____13525 =
                     let uu____13526 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13527 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13526
                       uu____13527 in
                   failwith uu____13525
               | (uu____13528,FStar_Syntax_Syntax.Tm_meta uu____13529) ->
                   let uu____13534 =
                     let uu____13535 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13536 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13535
                       uu____13536 in
                   failwith uu____13534
               | (uu____13537,FStar_Syntax_Syntax.Tm_delayed uu____13538) ->
                   let uu____13559 =
                     let uu____13560 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13561 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13560
                       uu____13561 in
                   failwith uu____13559
               | (uu____13562,FStar_Syntax_Syntax.Tm_let uu____13563) ->
                   let uu____13571 =
                     let uu____13572 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____13573 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____13572
                       uu____13573 in
                   failwith uu____13571
               | uu____13574 -> giveup env "head tag mismatch" orig)))
and solve_c:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.comp,Prims.unit) FStar_TypeChecker_Common.problem ->
      worklist -> solution
        ...
        let solve_eq c1_comp c2_comp =
          ...
          (let sub_probs =
             FStar_List.map2
               (fun uu____13614  ->
                  fun uu____13615  ->
                    match (uu____13614, uu____13615) with
                    | ((a1,uu____13625),(a2,uu____13627)) ->
                        let uu____13632 =
           ...
           let guard =
             let uu____13638 =
               FStar_List.map
                 ...
                 sub_probs in
             FStar_Syntax_Util.mk_conj_l uu____13638 in
           let wl1 = solve_prob orig (Some guard) [] wl in
           solve env (attempt sub_probs wl1)) in
        let solve_sub c11 edge c21 =
          let r = FStar_TypeChecker_Env.get_range env in
          let lift_c1 uu____13658 =
            let wp =
              ...
              | uu____13678 ->
                  let uu____13684 =
                    ...
                    FStar_Util.format1
                      ...
                      uu____13685 in
                  failwith uu____13684 in
            let uu____13688 =
              let uu____13694 =
                let uu____13695 =
                  (edge.FStar_TypeChecker_Env.mlift).FStar_TypeChecker_Env.mlift_wp
                    c11.FStar_Syntax_Syntax.result_typ wp in
                FStar_Syntax_Syntax.as_arg uu____13695 in
              [uu____13694] in
            {
              FStar_Syntax_Syntax.comp_univs =
              ...
              FStar_Syntax_Syntax.effect_args = uu____13688;
              FStar_Syntax_Syntax.flags = (c11.FStar_Syntax_Syntax.flags)
            } in
          if
            problem.FStar_TypeChecker_Common.relation =
              FStar_TypeChecker_Common.EQ
          then let uu____13696 = lift_c1 () in solve_eq uu____13696 c21
          else
            (let is_null_wp_2 =
             ...
             let uu____13702 =
               ...
               with
               | ((wp1,uu____13726)::uu____13727,(wp2,uu____13729)::uu____13730)
                   -> (wp1, wp2)
               | uu____13771 ->
                   let uu____13784 =
                     let uu____13785 =
                       ...
                       (uu____13788, (env.FStar_TypeChecker_Env.range)) in
                     FStar_Errors.Error uu____13785 in
                   raise uu____13784 in
             match uu____13702 with
             | (wpc1,wpc2) ->
                 let uu____13807 = FStar_Util.physical_equality wpc1 wpc2 in
                 if uu____13807
                 then
                   let uu____13810 =
                   ...
                   solve_t env uu____13810 wl
                 else
                   (let uu____13814 =
                      let uu____13818 =
                        FStar_TypeChecker_Env.effect_decl_opt env
                          c21.FStar_Syntax_Syntax.effect_name in
                      FStar_Util.must uu____13818 in
                    ...
                    | (c2_decl,qualifiers) ->
                        ...
                        then
                          let c1_repr =
                            let uu____13833 =
                              let uu____13834 =
                                let uu____13835 = lift_c1 () in
                                FStar_Syntax_Syntax.mk_Comp uu____13835 in
                              let uu____13836 =
                                env.FStar_TypeChecker_Env.universe_of env
                                  c11.FStar_Syntax_Syntax.result_typ in
                              FStar_TypeChecker_Env.reify_comp env
                                uu____13834 uu____13836 in
                            FStar_TypeChecker_Normalize.normalize
                              [FStar_TypeChecker_Normalize.UnfoldUntil
                          ...
                          let prob =
                            let uu____13842 =
                              let uu____13845 =
                                ...
                                FStar_Util.format2
                                  "sub effect repr: %s <: %s" uu____13846
                                  uu____13847 in
                              sub_prob c1_repr
                                problem.FStar_TypeChecker_Common.relation
                                c2_repr uu____13845 in
                            FStar_TypeChecker_Common.TProb uu____13842 in
                          let wl1 =
                            let uu____13849 =
                              let uu____13851 =
                                FStar_All.pipe_right (p_guard prob)
                                  FStar_Pervasives.fst in
                              Some uu____13851 in
                            solve_prob orig uu____13849 [] wl in
                                  ...
                                  (let uu____13860 =
                                     let uu____13863 =
                                       let uu____13864 =
                                         ...
                                         (uu____13874, uu____13877) in
                                       FStar_Syntax_Syntax.Tm_app uu____13864 in
                                     FStar_Syntax_Syntax.mk uu____13863 in
                                   uu____13860
                                     (Some
                                    ...
                                    let uu____13897 =
                                      let uu____13898 =
                                        ...
                                        let uu____13911 =
                                          ...
                                          uu____13913 :: uu____13914 in
                                        (uu____13908, uu____13911) in
                                      FStar_Syntax_Syntax.Tm_app uu____13898 in
                                    FStar_Syntax_Syntax.mk uu____13897 in
                                  uu____13894
                                    (Some
                                       (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n))
                                    r) in
                             ...
                             let uu____13937 =
                               let uu____13939 =
                                 let uu____13942 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives.fst in
                                 FStar_Syntax_Util.mk_conj uu____13942 g in
                               FStar_All.pipe_left (fun _0_85  -> Some _0_85)
                                 uu____13939 in
                             solve_prob orig uu____13937 [] wl in
                           solve env (attempt [base_prob] wl1)))) in
        let uu____13952 = FStar_Util.physical_equality c1 c2 in
        if uu____13952
        then
          let uu____13953 = solve_prob orig None [] wl in
          solve env uu____13953
        else
          ((let uu____13956 =
              FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                (FStar_Options.Other "Rel") in
            if uu____13956
            then
              let uu____13957 = FStar_Syntax_Print.comp_to_string c1 in
              let uu____13958 = FStar_Syntax_Print.comp_to_string c2 in
            ...
            | (c11,c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu____13968),FStar_Syntax_Syntax.Total
                    (t2,uu____13970)) when
                     ...
                     let uu____13983 =
                       problem_using_guard orig t1
                         ...
                         "result type" in
                     solve_t env uu____13983 wl
                 | (FStar_Syntax_Syntax.GTotal
                    uu____13986,FStar_Syntax_Syntax.Total uu____13987) ->
                     giveup env "incompatible monad ordering: GTot </: Tot"
                       orig
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu____13999),FStar_Syntax_Syntax.Total
                    (t2,uu____14001)) ->
                     let uu____14014 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2 None
                         "result type" in
                     solve_t env uu____14014 wl
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu____14018),FStar_Syntax_Syntax.GTotal
                    (t2,uu____14020)) ->
                     let uu____14033 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2 None
                         "result type" in
                     solve_t env uu____14033 wl
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu____14037),FStar_Syntax_Syntax.GTotal
                    (t2,uu____14039)) ->
                     let uu____14052 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2 None
                         "result type" in
                     solve_t env uu____14052 wl
                 | (FStar_Syntax_Syntax.GTotal
                    uu____14055,FStar_Syntax_Syntax.Comp uu____14056) ->
                     let uu____14062 =
                       let uu___176_14065 = problem in
                       let uu____14068 =
                         let uu____14069 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___176_14065.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____14068;
                         FStar_TypeChecker_Common.relation =
                           (uu___176_14065.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___176_14065.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___176_14065.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___176_14065.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___176_14065.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___176_14065.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___176_14065.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___176_14065.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____14062 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____14070,FStar_Syntax_Syntax.Comp uu____14071) ->
                     let uu____14077 =
                       let uu___176_14080 = problem in
                       let uu____14083 =
                         let uu____14084 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___176_14080.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____14083;
                         FStar_TypeChecker_Common.relation =
                           (uu___176_14080.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___176_14080.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___176_14080.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___176_14080.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___176_14080.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___176_14080.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___176_14080.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___176_14080.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____14077 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____14085,FStar_Syntax_Syntax.GTotal uu____14086) ->
                     let uu____14092 =
                       let uu___177_14095 = problem in
                       let uu____14098 =
                         let uu____14099 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___177_14095.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___177_14095.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___177_14095.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____14098;
                         FStar_TypeChecker_Common.element =
                           (uu___177_14095.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___177_14095.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___177_14095.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___177_14095.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___177_14095.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___177_14095.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____14092 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____14100,FStar_Syntax_Syntax.Total uu____14101) ->
                     let uu____14107 =
                       let uu___177_14110 = problem in
                       let uu____14113 =
                         let uu____14114 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___177_14110.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___177_14110.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___177_14110.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____14113;
                         FStar_TypeChecker_Common.element =
                           (uu___177_14110.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___177_14110.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___177_14110.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___177_14110.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___177_14110.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___177_14110.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____14107 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____14115,FStar_Syntax_Syntax.Comp uu____14116) ->
                     let uu____14117 =
      ...
      FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits
        (FStar_List.map
           (fun uu____14159  ->
              ...
              | (uu____14166,uu____14167,u,uu____14169,uu____14170,uu____14171)
                  -> FStar_Syntax_Print.uvar_to_string u)) in
    FStar_All.pipe_right uu____14143 (FStar_String.concat ", ")
let ineqs_to_string:
  ...
  fun ineqs  ->
    let vars =
      ...
      FStar_All.pipe_right uu____14189 (FStar_String.concat ", ") in
    let ineqs1 =
      let uu____14199 =
        FStar_All.pipe_right (snd ineqs)
          (FStar_List.map
             (fun uu____14211  ->
                ...
                | (u1,u2) ->
                    let uu____14216 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____14217 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____14216 uu____14217)) in
      FStar_All.pipe_right uu____14199 (FStar_String.concat ", ") in
...
let guard_to_string:
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____14229,[])) -> "{}"
      | uu____14242 ->
          let form =
            match g.FStar_TypeChecker_Env.guard_f with
            ...
            let uu____14255 =
              FStar_List.map
                (fun uu____14259  ->
                   ...
                   | (uu____14262,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred in
            FStar_All.pipe_right uu____14255 (FStar_String.concat ",\n") in
          let imps = print_pending_implicits g in
          let uu____14266 =
            ineqs_to_string g.FStar_TypeChecker_Env.univ_ineqs in
          FStar_Util.format4
            "\n\t{guard_f=%s;\n\t deferred={\n%s};\n\t univ_ineqs={%s};\n\t implicits={%s}}\n"
            form carry uu____14266 imps
let new_t_problem env lhs rel rhs elt loc =
  let reason =
    ...
    if uu____14304
    then
      let uu____14305 = FStar_TypeChecker_Normalize.term_to_string env lhs in
      let uu____14306 = FStar_TypeChecker_Normalize.term_to_string env rhs in
      FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" uu____14305
        (rel_to_string rel) uu____14306
    else "TOP" in
    ...
    fun t1  ->
      fun rel  ->
        fun t2  ->
          let x =
            let uu____14326 =
              let uu____14328 = FStar_TypeChecker_Env.get_range env in
              FStar_All.pipe_left (fun _0_86  -> Some _0_86) uu____14328 in
            FStar_Syntax_Syntax.new_bv uu____14326 t1 in
          let env1 = FStar_TypeChecker_Env.push_bv env x in
          let p =
            let uu____14334 =
              let uu____14336 = FStar_Syntax_Syntax.bv_to_name x in
              FStar_All.pipe_left (fun _0_87  -> Some _0_87) uu____14336 in
            let uu____14338 = FStar_TypeChecker_Env.get_range env1 in
            new_t_problem env1 t1 rel t2 uu____14334 uu____14338 in
...
let solve_and_commit:
  ...
  fun env  ->
    fun probs  ->
      fun err1  ->
        let probs1 =
          let uu____14361 = FStar_Options.eager_inference () in
          if uu____14361
          then
            let uu___178_14362 = probs in
            {
              attempting = (uu___178_14362.attempting);
              wl_deferred = (uu___178_14362.wl_deferred);
              ctr = (uu___178_14362.ctr);
              defer_ok = false;
              smt_ok = (uu___178_14362.smt_ok);
              tcenv = (uu___178_14362.tcenv)
            }
          else probs in
        let tx = FStar_Syntax_Unionfind.new_transaction () in
        ...
        | Failed (d,s) ->
            (FStar_Syntax_Unionfind.rollback tx;
             (let uu____14373 =
              ...
              if uu____14373
              then
                let uu____14374 = explain env d s in
                FStar_All.pipe_left FStar_Util.print_string uu____14374
              else ());
             err1 (d, s))
let simplify_guard:
  FStar_TypeChecker_Env.env ->
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____14384 =
            ...
            if uu____14384
            then
              let uu____14385 = FStar_Syntax_Print.term_to_string f in
           ...
           (let f1 =
            ...
            (let uu____14389 =
             ...
             if uu____14389
             then
               let uu____14390 = FStar_Syntax_Print.term_to_string f1 in
               FStar_Util.print1 "Simplified guard to %s\n" uu____14390
             else ());
            (let f2 =
               let uu____14393 =
                 let uu____14394 = FStar_Syntax_Util.unmeta f1 in
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____14398 -> FStar_TypeChecker_Common.NonTrivial f1 in
             let uu___179_14399 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___179_14399.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___179_14399.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___179_14399.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
        ...
        | Some d ->
            let uu____14414 =
              let uu____14415 =
                ...
                {
                  FStar_TypeChecker_Env.guard_f = uu____14416;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____14415 in
            FStar_All.pipe_left (fun _0_89  -> Some _0_89) uu____14414
let with_guard_no_simp env prob dopt =
  ...
  | Some d ->
      let uu____14450 =
        ...
        {
          FStar_TypeChecker_Env.guard_f = uu____14451;
          FStar_TypeChecker_Env.deferred = d;
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits = []
        } in
      ...
      fun t1  ->
        fun t2  ->
          (let uu____14478 =
           ...
           if uu____14478
           then
             let uu____14479 = FStar_Syntax_Print.term_to_string t1 in
             let uu____14480 = FStar_Syntax_Print.term_to_string t2 in
             FStar_Util.print2 "try_teq of %s and %s\n" uu____14479
               uu____14480
           else ());
          (let prob =
             let uu____14483 =
               let uu____14486 = FStar_TypeChecker_Env.get_range env in
           ...
           let g =
             let uu____14491 =
               let uu____14493 = singleton' env prob smt_ok in
               solve_and_commit env uu____14493 (fun uu____14494  -> None) in
             FStar_All.pipe_left (with_guard env prob) uu____14491 in
           g)
let teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____14508 = try_teq true env t1 t2 in
        ...
        | None  ->
            let uu____14510 =
              let uu____14511 =
                ...
                let uu____14515 = FStar_TypeChecker_Env.get_range env in
                (uu____14514, uu____14515) in
              FStar_Errors.Error uu____14511 in
            raise uu____14510
        | Some g ->
            ((let uu____14518 =
                FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
              ...
              if uu____14518
              then
                let uu____14519 = FStar_Syntax_Print.term_to_string t1 in
                let uu____14520 = FStar_Syntax_Print.term_to_string t2 in
                let uu____14521 = guard_to_string env g in
                FStar_Util.print3
                  "teq of %s and %s succeeded with guard %s\n" uu____14519
                  uu____14520 uu____14521
              else ());
             g)
let try_subtype':
  FStar_TypeChecker_Env.env ->
        ...
        fun smt_ok  ->
          ...
          (let uu____14541 =
           ...
           | (prob,x) ->
               let g =
                 let uu____14549 =
                   let uu____14551 = singleton' env prob smt_ok in
                   solve_and_commit env uu____14551
                     (fun uu____14552  -> None) in
                 FStar_All.pipe_left (with_guard env prob) uu____14549 in
               ((let uu____14558 =
                   (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                      (FStar_Options.Other "Rel"))
                 ...
                 then
                   ...
                   let uu____14560 =
                     FStar_TypeChecker_Normalize.term_to_string env t2 in
                   let uu____14561 =
                     let uu____14562 = FStar_Util.must g in
                     guard_to_string env uu____14562 in
                   FStar_Util.print3
                     "try_subtype succeeded: %s <: %s\n\tguard is %s\n"
                     uu____14559 uu____14560 uu____14561
                 else ());
                abstract_guard x g))
let try_subtype:
  FStar_TypeChecker_Env.env ->
...
let subtype_fail:
  ...
  fun env  ->
    fun e  ->
      fun t1  ->
        fun t2  ->
          let uu____14586 = FStar_TypeChecker_Env.get_range env in
          let uu____14587 =
            FStar_TypeChecker_Err.basic_type_error env (Some e) t2 t1 in
          FStar_Errors.err uu____14586 uu____14587
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
    ...
    fun c1  ->
      fun c2  ->
        (let uu____14599 =
         ...
         if uu____14599
         then
           let uu____14600 = FStar_Syntax_Print.comp_to_string c1 in
           let uu____14601 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        (let rel =
         ...
         let prob =
           let uu____14606 =
             let uu____14609 = FStar_TypeChecker_Env.get_range env in
             new_problem env c1 rel c2 None uu____14609 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_92  -> FStar_TypeChecker_Common.CProb _0_92) uu____14606 in
         let uu____14612 =
           let uu____14614 = singleton env prob in
           solve_and_commit env uu____14614 (fun uu____14615  -> None) in
         FStar_All.pipe_left (with_guard env prob) uu____14612)
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____14659 =
                 let uu____14660 =
                   let uu____14663 =
                     let uu____14664 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____14665 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____14664 uu____14665 in
                   let uu____14666 = FStar_TypeChecker_Env.get_range env in
                   (uu____14663, uu____14666) in
                 FStar_Errors.Error uu____14660 in
               raise uu____14659) in
            let equiv1 v1 v' =
              let uu____14674 =
                let uu____14677 = FStar_Syntax_Subst.compress_univ v1 in
                let uu____14678 = FStar_Syntax_Subst.compress_univ v' in
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____14699 = FStar_Syntax_Subst.compress_univ v1 in
                      match uu____14699 with
                      | FStar_Syntax_Syntax.U_unif uu____14703 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____14714  ->
                                    ...
                                    | (u,v') ->
                                        let uu____14720 = equiv1 v1 v' in
                                        if uu____14720
                                        then
                                          let uu____14722 =
                                            FStar_All.pipe_right variables
                                              (FStar_Util.for_some (equiv1 u)) in
                                          (if uu____14722 then [] else [u])
                                        else [])) in
                          let lb =
            ...
            let uu____14735 =
              let wl =
                let uu___180_14738 = empty_worklist env in
                {
                  attempting = (uu___180_14738.attempting);
                  wl_deferred = (uu___180_14738.wl_deferred);
                  ctr = (uu___180_14738.ctr);
                  defer_ok = false;
                  smt_ok = (uu___180_14738.smt_ok);
                  tcenv = (uu___180_14738.tcenv)
                } in
                   ...
                   (fun uu____14745  ->
                      ...
                      | (lb,v1) ->
                          ...
                          (match uu____14750 with
                           | USolved wl1 -> ()
                           | uu____14752 -> fail lb v1))) in
            let rec check_ineq uu____14758 =
              ...
              | (u,v1) ->
                  ...
                  (match (u1, v2) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____14765) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu____14776,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu____14778,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_max us,uu____14783) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u2  -> check_ineq (u2, v2)))
                   | (uu____14787,FStar_Syntax_Syntax.U_max vs) ->
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____14801  ->
                      ...
                      | (u,v1) ->
                          let uu____14806 = check_ineq (u, v1) in
                          if uu____14806
                          then true
                          else
                            ((let uu____14809 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____14810
                                  uu____14811
                              else ());
                             false))) in
            if uu____14795
            then ()
              ...
              ((let uu____14815 =
                ...
                if uu____14815
                then
                  ((let uu____14817 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
                      "Partially solved inequality constraints are: %s\n"
                      uu____14817);
                   FStar_Syntax_Unionfind.rollback tx;
                   (let uu____14823 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
               ...
               (let uu____14829 =
                  let uu____14830 =
                    let uu____14833 = FStar_TypeChecker_Env.get_range env in
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____14876 =
       ...
       if uu____14876
       then
         let uu____14877 = wl_to_string wl in
         let uu____14878 =
           FStar_Util.string_of_int
      ...
      (let g1 =
         let uu____14890 = solve_and_commit env wl fail in
         match uu____14890 with
         | Some [] ->
             let uu___181_14897 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___181_14897.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
       ...
       (let uu___182_14903 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___182_14903.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___182_14903.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___182_14903.FStar_TypeChecker_Env.implicits)
        }))
let discharge_guard':
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___183_14929 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___183_14929.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___183_14929.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___183_14929.FStar_TypeChecker_Env.implicits)
            } in
          let uu____14930 =
            let uu____14931 = FStar_TypeChecker_Env.should_verify env in
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____14937 =
                   ...
                   then
                     ...
                     let uu____14939 =
                       let uu____14940 = FStar_Syntax_Print.term_to_string vc in
                       FStar_Util.format1 "Before normalization VC=\n%s\n"
                         uu____14940 in
                     FStar_Errors.diag uu____14938 uu____14939
                   else ());
                  (let vc1 =
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Normalize.Eager_unfolding;
                           ...
                           then
                             ...
                             let uu____14951 =
                               ...
                               FStar_Util.format1 "Checking VC=\n%s\n"
                                 uu____14952 in
                             FStar_Errors.diag uu____14950 uu____14951
                           else ());
                          (let vcs =
                             let uu____14958 = FStar_Options.use_tactics () in
                             if uu____14958
                             then
...
let discharge_guard_no_smt:
  ...
  fun env  ->
    fun g  ->
      let uu____14983 = discharge_guard' None env g false in
      match uu____14983 with
      | Some g1 -> g1
      | None  ->
          let uu____14988 =
            let uu____14989 =
              let uu____14992 = FStar_TypeChecker_Env.get_range env in
              ("Expected a trivial pre-condition", uu____14992) in
            FStar_Errors.Error uu____14989 in
          raise uu____14988
let discharge_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t
  ...
  fun env  ->
    fun g  ->
      let uu____14999 = discharge_guard' None env g true in
...
let resolve_implicits:
  ...
  fun g  ->
    let unresolved u =
      let uu____15011 = FStar_Syntax_Unionfind.find u in
      match uu____15011 with | None  -> true | uu____15013 -> false in
    let rec until_fixpoint acc implicits =
      let uu____15026 = acc in
      ...
      | (out,changed) ->
          (match implicits with
           ...
           | hd1::tl1 ->
               let uu____15072 = hd1 in
               (match uu____15072 with
                | (uu____15079,env,u,tm,k,r) ->
                    let uu____15085 = unresolved u in
                    if uu____15085
                       ...
                       (let uu____15103 =
                        ...
                        then
                          ...
                          FStar_Util.print3
                            ...
                            uu____15104 uu____15105 uu____15106
                        else ());
                       (let uu____15108 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___184_15112 = env1 in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___184_15112.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___184_15112.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___184_15112.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___184_15112.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___184_15112.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___184_15112.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___184_15112.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___184_15112.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___184_15112.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___184_15112.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___184_15112.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___184_15112.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___184_15112.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___184_15112.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___184_15112.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___184_15112.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___184_15112.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___184_15112.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___184_15112.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___184_15112.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___184_15112.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___184_15112.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___184_15112.FStar_TypeChecker_Env.qname_and_index)
                             }) tm1 in
                        match uu____15108 with
                        | (uu____15113,uu____15114,g1) ->
                            let g2 =
                              if env1.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___185_15117 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___185_15117.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___185_15117.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___185_15117.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____15120 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
    let uu___186_15139 = g in
    let uu____15140 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___186_15139.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___186_15139.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___186_15139.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____15140
    }
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____15168 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____15168 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____15175 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____15175
      | (reason,uu____15177,uu____15178,e,t,r)::uu____15182 ->
          let uu____15196 =
            let uu____15197 = FStar_Syntax_Print.term_to_string t in
            let uu____15198 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____15197 uu____15198 reason in
          FStar_Errors.err r uu____15196
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___187_15205 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___187_15205.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___187_15205.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___187_15205.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____15223 = try_teq false env t1 t2 in
        match uu____15223 with
        | None  -> false
        | Some g ->
            let uu____15226 = discharge_guard' None env g false in
            (match uu____15226 with
             | Some uu____15230 -> true
             | None  -> false)