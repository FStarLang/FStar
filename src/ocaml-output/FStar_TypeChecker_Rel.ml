...
let _61_407 = (match ((let _145_332 = (FStar_Syntax_Subst.compress k)
in _145_332.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if ((FStar_List.length bs) = (FStar_List.length ys)) then begin
(let _145_333 = (FStar_Syntax_Subst.open_comp bs c)
in ((ys, t), _145_333))
end else begin
(
# 421 "FStar.TypeChecker.Rel.fst"
let _61_398 = (FStar_Syntax_Util.abs_formals t)
in (match (_61_398) with
| (ys', t) -> begin
(let _145_334 = (FStar_Syntax_Util.arrow_formals_comp k)
in (((FStar_List.append ys ys'), t), _145_334))
end))
end
end
| _61_400 -> begin
(let _145_336 = (let _145_335 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _145_335))
in ((ys, t), _145_336))
end)
...
let c = (let _145_337 = (FStar_Syntax_Util.rename_binders xs ys)
in (FStar_Syntax_Subst.subst_comp _145_337 c))
in (let _145_339 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _145_338 -> Some (_145_338)))
...
let _61_421 = (p_guard prob)
in (match (_61_421) with
| (_61_419, uv) -> begin
(
# 434 "FStar.TypeChecker.Rel.fst"
let _61_434 = (match ((let _145_350 = (FStar_Syntax_Subst.compress uv)
...
let bs = (FStar_All.pipe_right bs (FStar_List.filter (fun x -> (let _145_352 = (FStar_Syntax_Syntax.is_null_binder x)
in (FStar_All.pipe_right _145_352 Prims.op_Negation)))))
in (
# 438 "FStar.TypeChecker.Rel.fst"
let phi = (u_abs k bs phi)
in (
# 439 "FStar.TypeChecker.Rel.fst"
let _61_430 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("Rel"))) then begin
(let _145_355 = (FStar_Util.string_of_int (p_pid prob))
in (let _145_354 = (FStar_Syntax_Print.term_to_string uv)
in (let _145_353 = (FStar_Syntax_Print.term_to_string phi)
in (FStar_Util.print3 "Solving %s (%s) with formula %s\n" _145_355 _145_354 _145_353))))
end else begin
()
end
...
let _61_436 = (commit uvis)
in (
# 447 "FStar.TypeChecker.Rel.fst"
let _61_438 = wl
in {attempting = _61_438.attempting; wl_deferred = _61_438.wl_deferred; ctr = (wl.ctr + 1); defer_ok = _61_438.defer_ok; smt_ok = _61_438.smt_ok; tcenv = _61_438.tcenv})))
end))))
...
let _61_443 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("RelCheck"))) then begin
(let _145_364 = (FStar_Util.string_of_int pid)
in (let _145_363 = (let _145_362 = (FStar_List.map (uvi_to_string wl.tcenv) sol)
in (FStar_All.pipe_right _145_362 (FStar_String.concat ", ")))
...
let _61_445 = (commit sol)
in (
# 453 "FStar.TypeChecker.Rel.fst"
let _61_447 = wl
in {attempting = _61_447.attempting; wl_deferred = _61_447.wl_deferred; ctr = (wl.ctr + 1); defer_ok = _61_447.defer_ok; smt_ok = _61_447.smt_ok; tcenv = _61_447.tcenv}))))
...
| (_61_457, FStar_TypeChecker_Common.Trivial) -> begin
t
end
...
(let _145_377 = (FStar_Syntax_Util.mk_conj t f)
in Some (_145_377))
end))
in (
# 460 "FStar.TypeChecker.Rel.fst"
let _61_469 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("RelCheck"))) then begin
(let _145_380 = (FStar_All.pipe_left FStar_Util.string_of_int (p_pid prob))
in (let _145_379 = (let _145_378 = (FStar_List.map (uvi_to_string wl.tcenv) uvis)
in (FStar_All.pipe_right _145_378 (FStar_String.concat ", ")))
in (FStar_Util.print2 "Solving %s: with %s\n" _145_380 _145_379)))
end else begin
()
end
...
let rec occurs = (fun wl uk t -> (let _145_390 = (let _145_388 = (FStar_Syntax_Free.uvars t)
in (FStar_All.pipe_right _145_388 FStar_Util.set_elements))
in (FStar_All.pipe_right _145_390 (FStar_Util.for_some (fun _61_478 -> (match (_61_478) with
| (uv, _61_477) -> begin
...
(let _145_397 = (let _145_396 = (FStar_Syntax_Print.uvar_to_string (Prims.fst uk))
in (let _145_395 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "occurs-check failed (%s occurs in %s)" _145_396 _145_395)))
in Some (_145_397))
end
in (occurs_ok, msg))))
...
let _61_493 = (occurs_check env wl uk t)
in (match (_61_493) with
| (occurs_ok, msg) -> begin
(let _145_429 = (FStar_Util.set_is_subset_of fvs_t fvs)
in (occurs_ok, _145_429, (msg, fvs, fvs_t)))
end))))
...
let _61_511 = (FStar_All.pipe_right v2 (FStar_List.fold_left (fun _61_503 _61_506 -> (match ((_61_503, _61_506)) with
| ((isect, isect_set), (x, imp)) -> begin
if (let _145_438 = (FStar_Util.set_mem x v1_set)
in (FStar_All.pipe_left Prims.op_Negation _145_438)) then begin
(isect, isect_set)
end else begin
(
...
(let _145_439 = (FStar_Util.set_add x isect_set)
in (((x, imp))::isect, _145_439))
end else begin
(isect, isect_set)
end)
end
...
let binders_eq = (fun v1 v2 -> (((FStar_List.length v1) = (FStar_List.length v2)) && (FStar_List.forall2 (fun _61_517 _61_521 -> (match ((_61_517, _61_521)) with
| ((a, _61_516), (b, _61_520)) -> begin
...
if (FStar_All.pipe_right seen (FStar_Util.for_some (fun _61_531 -> (match (_61_531) with
| (b, _61_530) -> begin
(FStar_Syntax_Syntax.bv_eq a b)
end)))) then begin
None
...
let _61_542 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_454 = (FStar_All.pipe_left FStar_Syntax_Print.term_to_string (Prims.fst hd))
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uv, k); FStar_Syntax_Syntax.tk = _61_556; FStar_Syntax_Syntax.pos = _61_554; FStar_Syntax_Syntax.vars = _61_552}, args) -> begin
(t, uv, k, args)
end
| _61_566 -> begin
...
let _61_573 = (destruct_flex_t t)
in (match (_61_573) with
| (t, uv, k, args) -> begin
...
| (FStar_Syntax_Syntax.Tm_uinst (f, _61_673), FStar_Syntax_Syntax.Tm_uinst (g, _61_678)) -> begin
(let _145_490 = (head_matches env f g)
in (FStar_All.pipe_right _145_490 head_match))
end
...
| (FStar_Syntax_Syntax.Tm_uvar (uv, _61_689), FStar_Syntax_Syntax.Tm_uvar (uv', _61_694)) -> begin
...
| (FStar_Syntax_Syntax.Tm_refine (x, _61_700), FStar_Syntax_Syntax.Tm_refine (y, _61_705)) -> begin
(let _145_491 = (head_matches env x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _145_491 head_match))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _61_711), _61_715) -> begin
(let _145_492 = (head_matches env x.FStar_Syntax_Syntax.sort t2)
in (FStar_All.pipe_right _145_492 head_match))
end
| (_61_718, FStar_Syntax_Syntax.Tm_refine (x, _61_721)) -> begin
(let _145_493 = (head_matches env t1 x.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _145_493 head_match))
end
...
| (FStar_Syntax_Syntax.Tm_app (head, _61_741), FStar_Syntax_Syntax.Tm_app (head', _61_746)) -> begin
(head_matches env head head')
end
| (FStar_Syntax_Syntax.Tm_app (head, _61_752), _61_756) -> begin
(head_matches env head t2)
end
| (_61_759, FStar_Syntax_Syntax.Tm_app (head, _61_762)) -> begin
(head_matches env t1 head)
end
| _61_767 -> begin
(let _145_496 = (let _145_495 = (delta_depth_of_term env t1)
in (let _145_494 = (delta_depth_of_term env t2)
in (_145_495, _145_494)))
in MisMatch (_145_496))
end))))
...
let _61_818 = if d1_greater_than_d2 then begin
(
...
in (let _145_517 = (normalize_refinement ((FStar_TypeChecker_Normalize.UnfoldUntil (d1))::(FStar_TypeChecker_Normalize.WHNF)::[]) env wl t2)
in (t1, _145_517)))
end
...
let tcs = (FStar_All.pipe_right args (FStar_List.map (fun _61_861 -> (match (_61_861) with
| (t, _61_860) -> begin
(None, INVARIANT, T (t))
end))))
...
let fail = (fun _61_868 -> (match (()) with
| () -> begin
(FStar_All.failwith "Bad reconstruction")
end))
in (
# 734 "FStar.TypeChecker.Rel.fst"
let _61_871 = (FStar_Syntax_Subst.open_comp bs c)
...
let _61_888 = x
in {FStar_Syntax_Syntax.ppname = _61_888.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _61_888.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}), imp))::out) bs tcs)
end
| ([], C (c)::[]) -> begin
...
in (let _145_599 = (decompose [] bs)
in (rebuild, matches, _145_599))))
end)))
end
| _61_906 -> begin
(
...
| (_61_935, variance, T (ti)) -> begin
(
# 778 "FStar.TypeChecker.Rel.fst"
let k = (
# 779 "FStar.TypeChecker.Rel.fst"
let _61_943 = (FStar_Syntax_Util.type_u ())
in (match (_61_943) with
| (t, _61_942) -> begin
(let _145_621 = (new_uvar r scope t)
in (Prims.fst _145_621))
end))
in (
# 781 "FStar.TypeChecker.Rel.fst"
let _61_947 = (new_uvar r scope k)
in (match (_61_947) with
| (gi_xs, gi) -> begin
(
...
in (let _145_624 = (let _145_623 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (FStar_All.pipe_left (fun _145_622 -> FStar_TypeChecker_Common.TProb (_145_622)) _145_623))
in (T (gi_xs), _145_624)))
end)))
end
| (_61_953, _61_955, C (_61_957)) -> begin
...
let _61_1035 = (match (q) with
| (bopt, variance, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (ti); FStar_Syntax_Syntax.tk = _61_975; FStar_Syntax_Syntax.pos = _61_973; FStar_Syntax_Syntax.vars = _61_971})) -> begin
(match ((sub_prob scope args (bopt, variance, T (ti)))) with
| (T (gi_xs), prob) -> begin
(let _145_633 = (let _145_632 = (FStar_Syntax_Syntax.mk_Total gi_xs)
in (FStar_All.pipe_left (fun _145_631 -> C (_145_631)) _145_632))
in (_145_633, (prob)::[]))
end
| _61_986 -> begin
(FStar_All.failwith "impossible")
...
| (bopt, variance, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.GTotal (ti); FStar_Syntax_Syntax.tk = _61_994; FStar_Syntax_Syntax.pos = _61_992; FStar_Syntax_Syntax.vars = _61_990})) -> begin
(match ((sub_prob scope args (bopt, variance, T (ti)))) with
| (T (gi_xs), prob) -> begin
(let _145_636 = (let _145_635 = (FStar_Syntax_Syntax.mk_GTotal gi_xs)
in (FStar_All.pipe_left (fun _145_634 -> C (_145_634)) _145_635))
in (_145_636, (prob)::[]))
end
| _61_1005 -> begin
(FStar_All.failwith "impossible")
...
| (_61_1007, _61_1009, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (c); FStar_Syntax_Syntax.tk = _61_1015; FStar_Syntax_Syntax.pos = _61_1013; FStar_Syntax_Syntax.vars = _61_1011})) -> begin
(
...
let _61_1026 = (let _145_638 = (FStar_List.map (sub_prob scope args) components)
in (FStar_All.pipe_right _145_638 FStar_List.unzip))
in (match (_61_1026) with
| (tcs, sub_probs) -> begin
(
# 811 "FStar.TypeChecker.Rel.fst"
let gi_xs = (let _145_643 = (let _145_642 = (let _145_639 = (FStar_List.hd tcs)
in (FStar_All.pipe_right _145_639 un_T))
in (let _145_641 = (let _145_640 = (FStar_List.tl tcs)
in (FStar_All.pipe_right _145_640 (FStar_List.map arg_of_tc)))
in {FStar_Syntax_Syntax.effect_name = c.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _145_642; FStar_Syntax_Syntax.effect_args = _145_641; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp _145_643))
...
let _61_1032 = (sub_prob scope args q)
in (match (_61_1032) with
| (ktec, prob) -> begin
(ktec, (prob)::[])
end))
end)
in (match (_61_1035) with
| (tc, probs) -> begin
(
# 823 "FStar.TypeChecker.Rel.fst"
let _61_1048 = (match (q) with
| (Some (b), _61_1039, _61_1041) -> begin
(let _145_645 = (let _145_644 = (FStar_Syntax_Util.arg_of_non_null_binder b)
in (_145_644)::args)
in (Some (b), (b)::scope, _145_645))
end
| _61_1044 -> begin
(None, scope, args)
end)
...
let _61_1052 = (aux scope args qs)
in (match (_61_1052) with
| (sub_probs, tcs, f) -> begin
(
# 828 "FStar.TypeChecker.Rel.fst"
let f = (match (bopt) with
| None -> begin
(let _145_648 = (let _145_647 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (f)::_145_647)
in (FStar_Syntax_Util.mk_conj_l _145_648))
end
| Some (b) -> begin
(let _145_652 = (let _145_651 = (FStar_Syntax_Util.mk_forall (Prims.fst b) f)
in (let _145_650 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (_145_651)::_145_650))
in (FStar_Syntax_Util.mk_conj_l _145_652))
end)
...
| (FStar_Syntax_Syntax.Tm_uvar (u1, _61_1080), FStar_Syntax_Syntax.Tm_uvar (u2, _61_1085)) -> begin
...
and eq_args : FStar_Syntax_Syntax.args  ->  FStar_Syntax_Syntax.args  ->  Prims.bool = (fun a1 a2 -> (((FStar_List.length a1) = (FStar_List.length a2)) && (FStar_List.forall2 (fun _61_1105 _61_1109 -> (match ((_61_1105, _61_1109)) with
| ((a1, _61_1104), (a2, _61_1108)) -> begin
(eq_tm a1 a2)
end)) a1 a2)))
...
# 873 "FStar.TypeChecker.Rel.fst"
let _61_1112 = p
in (let _145_674 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _145_673 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in {FStar_TypeChecker_Common.pid = _61_1112.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _145_674; FStar_TypeChecker_Common.relation = _61_1112.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _145_673; FStar_TypeChecker_Common.element = _61_1112.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1112.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1112.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1112.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1112.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_1112.FStar_TypeChecker_Common.rank}))))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _145_680 = (compress_tprob wl p)
in (FStar_All.pipe_right _145_680 (fun _145_679 -> FStar_TypeChecker_Common.TProb (_145_679))))
end
| FStar_TypeChecker_Common.CProb (_61_1119) -> begin
p
end))
...
let prob = (let _145_685 = (compress_prob wl pr)
in (FStar_All.pipe_right _145_685 maybe_invert_p))
in (match (prob) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(
# 886 "FStar.TypeChecker.Rel.fst"
let _61_1129 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_61_1129) with
| (lh, _61_1128) -> begin
(
# 887 "FStar.TypeChecker.Rel.fst"
let _61_1133 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.rhs)
in (match (_61_1133) with
| (rh, _61_1132) -> begin
(
# 888 "FStar.TypeChecker.Rel.fst"
let _61_1189 = (match ((lh.FStar_Syntax_Syntax.n, rh.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_uvar (_61_1135), FStar_Syntax_Syntax.Tm_uvar (_61_1138)) -> begin
(flex_flex, tp)
end
...
| (FStar_Syntax_Syntax.Tm_uvar (_61_1154), _61_1157) -> begin
(
# 895 "FStar.TypeChecker.Rel.fst"
let _61_1161 = (base_and_refinement wl.tcenv wl tp.FStar_TypeChecker_Common.rhs)
in (match (_61_1161) with
| (b, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(flex_rigid, tp)
...
let _61_1166 = tp
in (let _145_686 = (force_refinement (b, ref_opt))
in {FStar_TypeChecker_Common.pid = _61_1166.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_1166.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_1166.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _145_686; FStar_TypeChecker_Common.element = _61_1166.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1166.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1166.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1166.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1166.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_1166.FStar_TypeChecker_Common.rank}))
in (rank, _145_687)))
end)
end))
end
| (_61_1169, FStar_Syntax_Syntax.Tm_uvar (_61_1171)) -> begin
(
# 907 "FStar.TypeChecker.Rel.fst"
let _61_1176 = (base_and_refinement wl.tcenv wl tp.FStar_TypeChecker_Common.lhs)
in (match (_61_1176) with
| (b, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(rigid_flex, tp)
...
let _61_1180 = tp
in (let _145_688 = (force_refinement (b, ref_opt))
in {FStar_TypeChecker_Common.pid = _61_1180.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _145_688; FStar_TypeChecker_Common.relation = _61_1180.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_1180.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_1180.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1180.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1180.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1180.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1180.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_1180.FStar_TypeChecker_Common.rank}))
in (refine_flex, _145_689))
end)
end))
end
| (_61_1183, _61_1185) -> begin
(rigid_rigid, tp)
end)
in (match (_61_1189) with
| (rank, tp) -> begin
(let _145_691 = (FStar_All.pipe_right (
# 915 "FStar.TypeChecker.Rel.fst"
let _61_1190 = tp
in {FStar_TypeChecker_Common.pid = _61_1190.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_1190.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_1190.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_1190.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_1190.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1190.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1190.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1190.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1190.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = Some (rank)}) (fun _145_690 -> FStar_TypeChecker_Common.TProb (_145_690)))
in (rank, _145_691))
end))
end))
end))
...
(let _145_693 = (FStar_All.pipe_right (
# 917 "FStar.TypeChecker.Rel.fst"
let _61_1194 = cp
in {FStar_TypeChecker_Common.pid = _61_1194.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_1194.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_1194.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_1194.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_1194.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1194.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1194.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1194.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1194.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = Some (rigid_rigid)}) (fun _145_692 -> FStar_TypeChecker_Common.CProb (_145_692)))
in (rigid_rigid, _145_693))
end)))
...
let rec aux = (fun _61_1201 probs -> (match (_61_1201) with
...
let _61_1242 = (FStar_Syntax_Util.univ_kernel u)
in (match (_61_1242) with
| (k, _61_1241) -> begin
(match (k) with
...
| (FStar_Syntax_Syntax.U_max (_61_1254), FStar_Syntax_Syntax.U_max (_61_1257)) -> begin
(let _145_767 = (let _145_766 = (FStar_Syntax_Print.univ_to_string u1)
in (let _145_765 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Unable to unify universes: %s and %s" _145_766 _145_765)))
in UFailed (_145_767))
end
...
| _61_1277 -> begin
(let _145_774 = (let _145_773 = (FStar_Syntax_Print.univ_to_string u1)
in (let _145_772 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Unable to unify universes: %s and %s (%s)" _145_773 _145_772 msg)))
in UFailed (_145_774))
end))
in (match ((u1, u2)) with
...
(let _145_777 = (let _145_776 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (v1)))
in (let _145_775 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.format2 "Failed occurs check: %s occurs in %s" _145_776 _145_775)))
in (try_umax_components u1 u2 _145_777))
end else begin
(let _145_778 = (extend_solution orig ((UNIV ((v1, u)))::[]) wl)
in USolved (_145_778))
end)
end
...
let _61_1372 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _145_824 = (wl_to_string probs)
...
# 1039 "FStar.TypeChecker.Rel.fst"
let _61_1379 = probs
in {attempting = tl; wl_deferred = _61_1379.wl_deferred; ctr = _61_1379.ctr; defer_ok = _61_1379.defer_ok; smt_ok = _61_1379.smt_ok; tcenv = _61_1379.tcenv})
in (match (hd) with
| FStar_TypeChecker_Common.CProb (cp) -> begin
...
let _61_1409 = (FStar_All.pipe_right probs.wl_deferred (FStar_List.partition (fun _61_1406 -> (match (_61_1406) with
| (c, _61_1403, _61_1405) -> begin
(c < probs.ctr)
end))))
in (match (_61_1409) with
| (attempt, rest) -> begin
(match (attempt) with
| [] -> begin
(let _145_827 = (FStar_List.map (fun _61_1415 -> (match (_61_1415) with
| (_61_1412, x, y) -> begin
(x, y)
...
let _61_1418 = probs
in (let _145_829 = (FStar_All.pipe_right attempt (FStar_List.map (fun _61_1425 -> (match (_61_1425) with
| (_61_1421, _61_1423, y) -> begin
y
end))))
in {attempting = _145_829; wl_deferred = rest; ctr = _61_1418.ctr; defer_ok = _61_1418.defer_ok; smt_ok = _61_1418.smt_ok; tcenv = _61_1418.tcenv}))
in (solve env _145_830))
end)
end))
end)
end)))
...
| USolved (wl) -> begin
(let _145_836 = (solve_prob orig None [] wl)
in (solve env _145_836))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
in (match ((let _145_851 = (let _145_848 = (whnf env t1)
in _145_848.FStar_Syntax_Syntax.n)
in (let _145_850 = (let _145_849 = (whnf env t2)
in _145_849.FStar_Syntax_Syntax.n)
in (_145_851, _145_850)))) with
| (FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (f); FStar_Syntax_Syntax.tk = _61_1466; FStar_Syntax_Syntax.pos = _61_1464; FStar_Syntax_Syntax.vars = _61_1462}, us1), FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (g); FStar_Syntax_Syntax.tk = _61_1478; FStar_Syntax_Syntax.pos = _61_1476; FStar_Syntax_Syntax.vars = _61_1474}, us2)) -> begin
(
...
let _61_1507 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_856 = (prob_to_string env orig)
...
let _61_1512 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _145_860 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
let _61_1516 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.rhs)
in (match (_61_1516) with
| (u, args) -> begin
(
# 1129 "FStar.TypeChecker.Rel.fst"
let disjoin = (fun t1 t2 -> (
# 1130 "FStar.TypeChecker.Rel.fst"
let _61_1522 = (head_matches_delta env () t1 t2)
in (match (_61_1522) with
| (mr, ts) -> begin
(match (mr) with
| MisMatch (_61_1524) -> begin
None
end
| FullMatch -> begin
(match (ts) with
...
let _61_1540 = (match (ts) with
| Some (t1, t2) -> begin
(let _145_866 = (FStar_Syntax_Subst.compress t1)
in (let _145_865 = (FStar_Syntax_Subst.compress t2)
...
let eq_prob = (fun t1 t2 -> (let _145_874 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "meeting refinements")
in (FStar_All.pipe_left (fun _145_873 -> FStar_TypeChecker_Common.TProb (_145_873)) _145_874)))
in (match ((t1.FStar_Syntax_Syntax.n, t2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_refine (x, phi1), FStar_Syntax_Syntax.Tm_refine (y, phi2)) -> begin
(let _145_881 = (let _145_880 = (let _145_877 = (let _145_876 = (let _145_875 = (FStar_Syntax_Util.mk_disj phi1 phi2)
in (x, _145_875))
in FStar_Syntax_Syntax.Tm_refine (_145_876))
in (FStar_Syntax_Syntax.mk _145_877 None t1.FStar_Syntax_Syntax.pos))
in (let _145_879 = (let _145_878 = (eq_prob x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (_145_878)::[])
in (_145_880, _145_879)))
in Some (_145_881))
end
| (_61_1554, FStar_Syntax_Syntax.Tm_refine (x, _61_1557)) -> begin
(let _145_884 = (let _145_883 = (let _145_882 = (eq_prob x.FStar_Syntax_Syntax.sort t1)
in (_145_882)::[])
in (t1, _145_883))
in Some (_145_884))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _61_1563), _61_1567) -> begin
(let _145_887 = (let _145_886 = (let _145_885 = (eq_prob x.FStar_Syntax_Syntax.sort t2)
in (_145_885)::[])
in (t2, _145_886))
in Some (_145_887))
end
...
| FStar_Syntax_Syntax.Tm_uvar (uv, _61_1574) -> begin
(
# 1166 "FStar.TypeChecker.Rel.fst"
let _61_1599 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun _61_23 -> (match (_61_23) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(match (tp.FStar_TypeChecker_Common.rank) with
| Some (rank) when (is_rigid_flex rank) -> begin
(
# 1170 "FStar.TypeChecker.Rel.fst"
let _61_1585 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.rhs)
in (match (_61_1585) with
| (u', _61_1584) -> begin
(match ((let _145_889 = (whnf env u')
in _145_889.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (uv', _61_1588) -> begin
...
let rec make_lower_bound = (fun _61_1603 tps -> (match (_61_1603) with
...
(match ((let _145_894 = (whnf env hd.FStar_TypeChecker_Common.lhs)
in (disjoin bound _145_894))) with
...
in (match ((let _145_896 = (let _145_895 = (whnf env tp.FStar_TypeChecker_Common.lhs)
in (_145_895, []))
in (make_lower_bound _145_896 lower_bounds))) with
| None -> begin
(
# 1190 "FStar.TypeChecker.Rel.fst"
let _61_1618 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
# 1197 "FStar.TypeChecker.Rel.fst"
let _61_1625 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = _61_1625.wl_deferred; ctr = _61_1625.ctr; defer_ok = _61_1625.defer_ok; smt_ok = _61_1625.smt_ok; tcenv = _61_1625.tcenv})
in (let _145_897 = (wl_to_string wl')
...
let _61_1630 = wl
in {attempting = sub_probs; wl_deferred = _61_1630.wl_deferred; ctr = _61_1630.ctr; defer_ok = _61_1630.defer_ok; smt_ok = _61_1630.smt_ok; tcenv = _61_1630.tcenv}))) with
| Success (_61_1633) -> begin
(
# 1201 "FStar.TypeChecker.Rel.fst"
let wl = (
# 1201 "FStar.TypeChecker.Rel.fst"
let _61_1635 = wl
in {attempting = rest; wl_deferred = _61_1635.wl_deferred; ctr = _61_1635.ctr; defer_ok = _61_1635.defer_ok; smt_ok = _61_1635.smt_ok; tcenv = _61_1635.tcenv})
in (
...
let _61_1641 = (FStar_List.fold_left (fun wl p -> (solve_prob' true p None [] wl)) wl lower_bounds)
in Some (wl))))
end
| _61_1644 -> begin
None
...
let _61_1650 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _145_903 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
let _61_1654 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_61_1654) with
| (u, args) -> begin
(
# 1217 "FStar.TypeChecker.Rel.fst"
let _61_1660 = (0, 1, 2, 3, 4)
in (match (_61_1660) with
...
let _61_1669 = (FStar_Syntax_Util.head_and_args t1)
in (match (_61_1669) with
| (h1, args1) -> begin
(
# 1222 "FStar.TypeChecker.Rel.fst"
let _61_1673 = (FStar_Syntax_Util.head_and_args t2)
in (match (_61_1673) with
| (h2, _61_1672) -> begin
...
(let _145_915 = (let _145_914 = (let _145_913 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _145_912 -> FStar_TypeChecker_Common.TProb (_145_912)) _145_913))
in (_145_914)::[])
in Some (_145_915))
end
end else begin
...
in (let _145_922 = (let _145_921 = (let _145_920 = (FStar_Syntax_Util.mk_conj phi1 phi2)
in (FStar_Syntax_Util.refine x _145_920))
in (_145_921, m))
in Some (_145_922))))))
end))
end
| (_61_1707, FStar_Syntax_Syntax.Tm_refine (y, _61_1710)) -> begin
(
...
| (FStar_Syntax_Syntax.Tm_refine (x, _61_1720), _61_1724) -> begin
(
...
let tt = u
in (match (tt.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uvar (uv, _61_1739) -> begin
(
# 1276 "FStar.TypeChecker.Rel.fst"
let _61_1764 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun _61_24 -> (match (_61_24) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(match (tp.FStar_TypeChecker_Common.rank) with
| Some (rank) when (is_flex_rigid rank) -> begin
(
# 1280 "FStar.TypeChecker.Rel.fst"
let _61_1750 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_61_1750) with
| (u', _61_1749) -> begin
(match ((let _145_924 = (whnf env u')
in _145_924.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (uv', _61_1753) -> begin
(FStar_Unionfind.equivalent uv uv')
end
| _61_1757 -> begin
false
...
in (match (_61_1764) with
| (upper_bounds, rest) -> begin
(
# 1289 "FStar.TypeChecker.Rel.fst"
let rec make_upper_bound = (fun _61_1768 tps -> (match (_61_1768) with
| (bound, sub_probs) -> begin
(match (tps) with
| [] -> begin
Some ((bound, sub_probs))
...
| FStar_TypeChecker_Common.TProb (hd)::tl -> begin
(match ((let _145_929 = (whnf env hd.FStar_TypeChecker_Common.rhs)
in (conjoin bound _145_929))) with
| Some (bound, sub) -> begin
...
in (match ((let _145_931 = (let _145_930 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in (_145_930, []))
in (make_upper_bound _145_931 upper_bounds))) with
| None -> begin
(
# 1300 "FStar.TypeChecker.Rel.fst"
let _61_1783 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
# 1315 "FStar.TypeChecker.Rel.fst"
let _61_1790 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = _61_1790.wl_deferred; ctr = _61_1790.ctr; defer_ok = _61_1790.defer_ok; smt_ok = _61_1790.smt_ok; tcenv = _61_1790.tcenv})
in (let _145_932 = (wl_to_string wl')
...
let _61_1795 = wl
in {attempting = sub_probs; wl_deferred = _61_1795.wl_deferred; ctr = _61_1795.ctr; defer_ok = _61_1795.defer_ok; smt_ok = _61_1795.smt_ok; tcenv = _61_1795.tcenv}))) with
| Success (_61_1798) -> begin
(
# 1319 "FStar.TypeChecker.Rel.fst"
let wl = (
# 1319 "FStar.TypeChecker.Rel.fst"
let _61_1800 = wl
in {attempting = rest; wl_deferred = _61_1800.wl_deferred; ctr = _61_1800.ctr; defer_ok = _61_1800.defer_ok; smt_ok = _61_1800.smt_ok; tcenv = _61_1800.tcenv})
in (
# 1320 "FStar.TypeChecker.Rel.fst"
let wl = (solve_prob' false (FStar_TypeChecker_Common.TProb (tp)) None [] wl)
in (
# 1321 "FStar.TypeChecker.Rel.fst"
let _61_1806 = (FStar_List.fold_left (fun wl p -> (solve_prob' true p None [] wl)) wl upper_bounds)
in Some (wl))))
end
| _61_1809 -> begin
None
...
let _61_1828 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_960 = (prob_to_string env rhs_prob)
...
# 1341 "FStar.TypeChecker.Rel.fst"
let _61_1842 = hd1
in (let _145_961 = (FStar_Syntax_Subst.subst subst hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _61_1842.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _61_1842.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _145_961}))
in (
# 1342 "FStar.TypeChecker.Rel.fst"
let hd2 = (
# 1342 "FStar.TypeChecker.Rel.fst"
let _61_1845 = hd2
in (let _145_962 = (FStar_Syntax_Subst.subst subst hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _61_1845.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _61_1845.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _145_962}))
in (
# 1343 "FStar.TypeChecker.Rel.fst"
let prob = (let _145_965 = (let _145_964 = (FStar_All.pipe_left invert_rel (p_rel orig))
in (mk_problem scope orig hd1.FStar_Syntax_Syntax.sort _145_964 hd2.FStar_Syntax_Syntax.sort None "Formal parameter"))
in (FStar_All.pipe_left (fun _145_963 -> FStar_TypeChecker_Common.TProb (_145_963)) _145_965))
in (
# 1344 "FStar.TypeChecker.Rel.fst"
let hd1 = (FStar_Syntax_Syntax.freshen_bv hd1)
in (
# 1345 "FStar.TypeChecker.Rel.fst"
let subst = (let _145_966 = (FStar_Syntax_Subst.shift_subst 1 subst)
in (FStar_Syntax_Syntax.DB ((0, hd1)))::_145_966)
in (
...
let phi = (let _145_968 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (let _145_967 = (FStar_Syntax_Util.close_forall (((hd1, imp))::[]) phi)
in (FStar_Syntax_Util.mk_conj _145_968 _145_967)))
in (
# 1350 "FStar.TypeChecker.Rel.fst"
let _61_1857 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_970 = (FStar_Syntax_Print.term_to_string phi)
in (let _145_969 = (FStar_Syntax_Print.bv_to_string hd1)
...
and solve_t : FStar_TypeChecker_Env.env  ->  tprob  ->  worklist  ->  solution = (fun env problem wl -> (let _145_974 = (compress_tprob wl problem)
in (solve_t' env _145_974 wl)))
...
let _61_1889 = (head_matches_delta env wl t1 t2)
in (match (_61_1889) with
| (m, o) -> begin
(match ((m, o)) with
| (MisMatch (_61_1891), _61_1894) -> begin
(
...
in (let _145_1003 = (let _145_1002 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_has_type t1 _145_1002 t2))
in (FStar_Syntax_Util.mk_forall x _145_1003)))
end))
...
in (let _145_1004 = (solve_prob orig (Some (guard)) [] wl)
in (solve env _145_1004)))
end else begin
(giveup env "head mismatch" orig)
end)
end
| (_61_1917, Some (t1, t2)) -> begin
(solve_t env (
# 1399 "FStar.TypeChecker.Rel.fst"
let _61_1923 = problem
in {FStar_TypeChecker_Common.pid = _61_1923.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _61_1923.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _61_1923.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1923.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1923.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1923.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1923.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_1923.FStar_TypeChecker_Common.rank}) wl)
end
| (_61_1926, None) -> begin
(
# 1402 "FStar.TypeChecker.Rel.fst"
let _61_1929 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1008 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1007 = (FStar_Syntax_Print.tag_of_term t1)
in (let _145_1006 = (FStar_Syntax_Print.term_to_string t2)
in (let _145_1005 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.print4 "Head matches: %s (%s) and %s (%s)\n" _145_1008 _145_1007 _145_1006 _145_1005)))))
end else begin
()
end
in (
# 1406 "FStar.TypeChecker.Rel.fst"
let _61_1933 = (FStar_Syntax_Util.head_and_args t1)
in (match (_61_1933) with
| (head, args) -> begin
(
# 1407 "FStar.TypeChecker.Rel.fst"
let _61_1936 = (FStar_Syntax_Util.head_and_args t2)
in (match (_61_1936) with
| (head', args') -> begin
(
# 1408 "FStar.TypeChecker.Rel.fst"
let nargs = (FStar_List.length args)
in if (nargs <> (FStar_List.length args')) then begin
(let _145_1013 = (let _145_1012 = (FStar_Syntax_Print.term_to_string head)
in (let _145_1011 = (args_to_string args)
in (let _145_1010 = (FStar_Syntax_Print.term_to_string head')
in (let _145_1009 = (args_to_string args')
in (FStar_Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _145_1012 _145_1011 _145_1010 _145_1009)))))
in (giveup env _145_1013 orig))
end else begin
if ((nargs = 0) || (eq_args args args')) then begin
(match ((solve_maybe_uinsts env orig head head' wl)) with
| USolved (wl) -> begin
(let _145_1014 = (solve_prob orig None [] wl)
in (solve env _145_1014))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
let _61_1946 = (base_and_refinement env wl t1)
in (match (_61_1946) with
| (base1, refinement1) -> begin
(
# 1430 "FStar.TypeChecker.Rel.fst"
let _61_1949 = (base_and_refinement env wl t2)
in (match (_61_1949) with
...
let subprobs = (FStar_List.map2 (fun _61_1962 _61_1966 -> (match ((_61_1962, _61_1966)) with
| ((a, _61_1961), (a', _61_1965)) -> begin
(let _145_1018 = (mk_problem (p_scope orig) orig a FStar_TypeChecker_Common.EQ a' None "index")
in (FStar_All.pipe_left (fun _145_1017 -> FStar_TypeChecker_Common.TProb (_145_1017)) _145_1018))
end)) args args')
in (
# 1438 "FStar.TypeChecker.Rel.fst"
let formula = (let _145_1020 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
in (FStar_Syntax_Util.mk_conj_l _145_1020))
in (
...
let _61_1975 = problem
in {FStar_TypeChecker_Common.pid = _61_1975.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = _61_1975.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = _61_1975.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_1975.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_1975.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_1975.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_1975.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_1975.FStar_TypeChecker_Common.rank}) wl)))
end)
end))
end))
end
...
let _61_1994 = p
in (match (_61_1994) with
| (((u, k), xs, c), ps, (h, _61_1991, qs)) -> begin
(
...
let _61_2000 = (imitation_sub_probs orig env xs ps qs)
in (match (_61_2000) with
| (sub_probs, gs_xs, formula) -> begin
(
# 1461 "FStar.TypeChecker.Rel.fst"
let im = (let _145_1033 = (h gs_xs)
in (let _145_1032 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _145_1031 -> Some (_145_1031)))
in (FStar_Syntax_Util.abs xs _145_1033 _145_1032)))
in (
# 1462 "FStar.TypeChecker.Rel.fst"
let _61_2002 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1038 = (FStar_Syntax_Print.term_to_string im)
in (let _145_1037 = (FStar_Syntax_Print.tag_of_term im)
in (let _145_1036 = (let _145_1034 = (FStar_List.map (prob_to_string env) sub_probs)
in (FStar_All.pipe_right _145_1034 (FStar_String.concat ", ")))
in (let _145_1035 = (FStar_TypeChecker_Normalize.term_to_string env formula)
in (FStar_Util.print4 "Imitating %s (%s)\nsub_probs = %s\nformula=%s\n" _145_1038 _145_1037 _145_1036 _145_1035)))))
end else begin
()
end
in (
...
let _61_2025 = (FStar_List.nth ps i)
in (match (_61_2025) with
| (pi, _61_2024) -> begin
(
# 1479 "FStar.TypeChecker.Rel.fst"
let _61_2029 = (FStar_List.nth xs i)
...
let _61_2034 = (FStar_Syntax_Util.arrow_formals k)
in (match (_61_2034) with
| (bs, k) -> begin
(
...
let _61_2048 = (new_uvar r xs k_a)
in (match (_61_2048) with
| (gi_xs, gi) -> begin
(
...
let _61_2054 = (aux subst tl)
in (match (_61_2054) with
| (gi_xs', gi_ps') -> begin
(let _145_1060 = (let _145_1057 = (FStar_Syntax_Syntax.as_arg gi_xs)
in (_145_1057)::gi_xs')
in (let _145_1059 = (let _145_1058 = (FStar_Syntax_Syntax.as_arg gi_ps)
in (_145_1058)::gi_ps')
in (_145_1060, _145_1059)))
end)))))
end)))
end))
in (aux [] bs))
end)))
in if (let _145_1061 = (matches pi)
in (FStar_All.pipe_left Prims.op_Negation _145_1061)) then begin
None
end else begin
(
# 1497 "FStar.TypeChecker.Rel.fst"
let _61_2058 = (gs xi.FStar_Syntax_Syntax.sort)
in (match (_61_2058) with
| (g_xs, _61_2057) -> begin
(
...
in (let _145_1063 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _145_1062 -> Some (_145_1062)))
...
in (let _145_1068 = (let _145_1067 = (FStar_List.map (fun _61_2066 -> (match (_61_2066) with
| (_61_2062, _61_2064, y) -> begin
y
end)) qs)
...
let _61_2068 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
| Failed (_61_2094) -> begin
(
# 1520 "FStar.TypeChecker.Rel.fst"
let _61_2096 = (FStar_Unionfind.rollback tx)
...
let _61_2104 = (FStar_Unionfind.rollback tx)
in (imitate_or_project n st (i + 1)))
end
| Some (sol) -> begin
sol
...
let _61_2114 = (FStar_Syntax_Util.head_and_args t2)
...
let _61_2127 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1102 = (names_to_string fvs_hd)
in (FStar_Util.print1 "Free variables are %s" _145_1102))
end else begin
()
end
in false)
...
let fvs_hd = (let _145_1106 = (let _145_1105 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _145_1105 Prims.fst))
in (FStar_All.pipe_right _145_1106 FStar_Syntax_Free.names))
...
let _61_2140 = (occurs_check env wl (uv, k_uv) t2)
in (match (_61_2140) with
| (occurs_ok, msg) -> begin
if (not (occurs_ok)) then begin
(let _145_1108 = (let _145_1107 = (FStar_Option.get msg)
in (Prims.strcat "occurs-check failed: " _145_1107))
in (giveup_or_defer orig _145_1108))
end else begin
...
(let _145_1109 = (subterms args_lhs)
in (imitate orig env wl _145_1109))
end else begin
(
# 1563 "FStar.TypeChecker.Rel.fst"
let _61_2141 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1112 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1111 = (names_to_string fvs1)
in (let _145_1110 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s succeeded fvar check: %s\n" _145_1112 _145_1111 _145_1110))))
end else begin
()
end
in (
...
| _61_2145 -> begin
(let _145_1113 = (sn_binders env vars)
in (u_abs k_uv _145_1113 t2))
end)
in (
...
let _61_2148 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1116 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1115 = (names_to_string fvs1)
in (let _145_1114 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _145_1116 _145_1115 _145_1114))))
end else begin
()
end
in (let _145_1117 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _145_1117 (- (1)))))
end else begin
...
if (let _145_1118 = (FStar_Syntax_Free.names t1)
in (check_head _145_1118 t2)) then begin
(
...
in (imitate_or_project (FStar_List.length args_lhs) _145_1120 im_ok))))
end else begin
...
let force_quasi_pattern = (fun xs_opt _61_2164 -> (match (_61_2164) with
| (t, u, k, args) -> begin
(
# 1620 "FStar.TypeChecker.Rel.fst"
let _61_2168 = (FStar_Syntax_Util.arrow_formals k)
in (match (_61_2168) with
| (all_formals, _61_2167) -> begin
(
...
let pat_args = (FStar_All.pipe_right (FStar_List.rev pat_args) (FStar_List.map (fun _61_2182 -> (match (_61_2182) with
| (x, imp) -> begin
(let _145_1142 = (FStar_Syntax_Syntax.bv_to_name x)
in (_145_1142, imp))
end))))
in (
...
let _61_2188 = (FStar_Syntax_Util.type_u ())
in (match (_61_2188) with
| (t, _61_2187) -> begin
(let _145_1143 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars t)
in (Prims.fst _145_1143))
end))
in (
# 1636 "FStar.TypeChecker.Rel.fst"
let _61_2192 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars kk)
in (match (_61_2192) with
| (t', tm_u1) -> begin
(
# 1637 "FStar.TypeChecker.Rel.fst"
let _61_2199 = (destruct_flex_t t')
in (match (_61_2199) with
| (_61_2194, u1, k1, _61_2198) -> begin
(
# 1638 "FStar.TypeChecker.Rel.fst"
let sol = (let _145_1145 = (let _145_1144 = (u_abs k all_formals t')
in ((u, k), _145_1144))
in TERM (_145_1145))
in (
...
| Some (xs) -> begin
(FStar_All.pipe_right xs (FStar_Util.for_some (fun _61_2218 -> (match (_61_2218) with
| (x, _61_2217) -> begin
...
(let _145_1147 = (FStar_Util.set_add (Prims.fst formal) pattern_var_set)
in (aux ((y)::pat_args) ((formal)::pattern_vars) _145_1147 formals tl))
end)
end)
end)
end
...
in (let _145_1148 = (FStar_Syntax_Syntax.new_bv_set ())
in (aux [] [] _145_1148 all_formals args))))
end))
end))
in (
# 1667 "FStar.TypeChecker.Rel.fst"
let solve_both_pats = (fun wl _61_2228 _61_2232 r -> (match ((_61_2228, _61_2232)) with
| ((u1, k1, xs), (u2, k2, ys)) -> begin
if ((FStar_Unionfind.equivalent u1 u2) && (binders_eq xs ys)) then begin
(let _145_1157 = (solve_prob orig None [] wl)
in (solve env _145_1157))
end else begin
(
...
let _61_2237 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1160 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _145_1159 = (FStar_Syntax_Print.binders_to_string ", " ys)
in (let _145_1158 = (FStar_Syntax_Print.binders_to_string ", " zs)
in (FStar_Util.print3 "Flex-flex patterns: intersected %s and %s; got %s\n" _145_1160 _145_1159 _145_1158))))
end else begin
()
end
in (
...
let _61_2242 = (FStar_Syntax_Util.type_u ())
in (match (_61_2242) with
| (t, _61_2241) -> begin
(
# 1683 "FStar.TypeChecker.Rel.fst"
let _61_2246 = (new_uvar r zs t)
...
let _61_2254 = (occurs_check env wl (u1, k1) sub1)
...
let _61_2260 = (occurs_check env wl (u2, k2) sub2)
in (match (_61_2260) with
| (occurs_ok, msg) -> begin
if (not (occurs_ok)) then begin
...
let solve_one_pat = (fun _61_2268 _61_2273 -> (match ((_61_2268, _61_2273)) with
| ((t1, u1, k1, xs), (t2, u2, k2, args2)) -> begin
(
# 1703 "FStar.TypeChecker.Rel.fst"
let _61_2274 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1166 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1165 = (FStar_Syntax_Print.term_to_string t2)
...
let sub_probs = (FStar_List.map2 (fun _61_2279 _61_2283 -> (match ((_61_2279, _61_2283)) with
| ((a, _61_2278), (t2, _61_2282)) -> begin
(let _145_1171 = (let _145_1169 = (FStar_Syntax_Syntax.bv_to_name a)
in (mk_problem (p_scope orig) orig _145_1169 FStar_TypeChecker_Common.EQ t2 None "flex-flex index"))
in (FStar_All.pipe_right _145_1171 (fun _145_1170 -> FStar_TypeChecker_Common.TProb (_145_1170))))
end)) xs args2)
in (
# 1709 "FStar.TypeChecker.Rel.fst"
let guard = (let _145_1173 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _145_1173))
in (
...
let _61_2293 = (occurs_check env wl (u1, k1) t2)
in (match (_61_2293) with
| (occurs_ok, _61_2292) -> begin
(
...
let sol = (let _145_1175 = (let _145_1174 = (u_abs k1 xs t2)
in ((u1, k1), _145_1174))
in TERM (_145_1175))
in (
...
let _61_2304 = (force_quasi_pattern (Some (xs)) (t2, u2, k2, args2))
in (match (_61_2304) with
| (sol, (_61_2299, u2, k2, ys)) -> begin
(
# 1724 "FStar.TypeChecker.Rel.fst"
let wl = (extend_solution (p_pid orig) ((sol)::[]) wl)
in (
# 1725 "FStar.TypeChecker.Rel.fst"
let _61_2306 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
...
let _61_2343 = (force_quasi_pattern None (t1, u1, k1, args1))
...
let _61_2345 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
(let _145_1177 = (uvi_to_string env sol)
...
(let _145_1179 = (solve_prob orig None [] wl)
in (solve env _145_1179))
end else begin
(
# 1760 "FStar.TypeChecker.Rel.fst"
let _61_2354 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("RelCheck"))) then begin
(let _145_1180 = (FStar_Util.string_of_int problem.FStar_TypeChecker_Common.pid)
...
let match_num_binders = (fun _61_2359 _61_2362 -> (match ((_61_2359, _61_2362)) with
| ((bs1, mk_cod1), (bs2, mk_cod2)) -> begin
(
# 1767 "FStar.TypeChecker.Rel.fst"
let curry = (fun n bs mk_cod -> (
# 1768 "FStar.TypeChecker.Rel.fst"
let _61_2369 = (FStar_Util.first_N n bs)
in (match (_61_2369) with
| (bs, rest) -> begin
(let _145_1210 = (mk_cod rest)
in (bs, _145_1210))
end)))
in (
...
(let _145_1214 = (let _145_1211 = (mk_cod1 [])
in (bs1, _145_1211))
in (let _145_1213 = (let _145_1212 = (mk_cod2 [])
in (bs2, _145_1212))
in (_145_1214, _145_1213)))
end else begin
if (l1 > l2) then begin
(let _145_1217 = (curry l2 bs1 mk_cod1)
in (let _145_1216 = (let _145_1215 = (mk_cod2 [])
in (bs2, _145_1215))
in (_145_1217, _145_1216)))
end else begin
(let _145_1220 = (let _145_1218 = (mk_cod1 [])
in (bs1, _145_1218))
in (let _145_1219 = (curry l1 bs2 mk_cod2)
...
| bs -> begin
(let _145_1225 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((bs, c))) None c.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk_Total _145_1225))
end))
in (
# 1794 "FStar.TypeChecker.Rel.fst"
let _61_2412 = (match_num_binders (bs1, (mk_c c1)) (bs2, (mk_c c2)))
in (match (_61_2412) with
| ((bs1, c1), (bs2, c2)) -> begin
...
in (let _145_1232 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (FStar_All.pipe_left (fun _145_1231 -> FStar_TypeChecker_Common.CProb (_145_1231)) _145_1232)))))))
end)))
end
| (FStar_Syntax_Syntax.Tm_abs (bs1, tbody1, _61_2422), FStar_Syntax_Syntax.Tm_abs (bs2, tbody2, _61_2428)) -> begin
(
...
let _61_2443 = (match_num_binders (bs1, (mk_t tbody1)) (bs2, (mk_t tbody2)))
in (match (_61_2443) with
| ((bs1, tbody1), (bs2, tbody2)) -> begin
(solve_binders env bs1 bs2 orig wl (fun scope env subst -> (let _145_1245 = (let _145_1244 = (FStar_Syntax_Subst.subst subst tbody1)
in (let _145_1243 = (FStar_Syntax_Subst.subst subst tbody2)
in (mk_problem scope orig _145_1244 problem.FStar_TypeChecker_Common.relation _145_1243 None "lambda co-domain")))
in (FStar_All.pipe_left (fun _145_1242 -> FStar_TypeChecker_Common.TProb (_145_1242)) _145_1245))))
end)))
end
| (FStar_Syntax_Syntax.Tm_refine (_61_2448), FStar_Syntax_Syntax.Tm_refine (_61_2451)) -> begin
(
# 1817 "FStar.TypeChecker.Rel.fst"
let _61_2456 = (as_refinement env wl t1)
in (match (_61_2456) with
| (x1, phi1) -> begin
(
# 1818 "FStar.TypeChecker.Rel.fst"
let _61_2459 = (as_refinement env wl t2)
in (match (_61_2459) with
| (x2, phi2) -> begin
(
# 1819 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _145_1247 = (mk_problem (p_scope orig) orig x1.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.relation x2.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "refinement base type")
in (FStar_All.pipe_left (fun _145_1246 -> FStar_TypeChecker_Common.TProb (_145_1246)) _145_1247))
in (
...
let mk_imp = (fun imp phi1 phi2 -> (let _145_1264 = (imp phi1 phi2)
in (FStar_All.pipe_right _145_1264 (guard_on_element problem x1))))
in (
# 1826 "FStar.TypeChecker.Rel.fst"
let fallback = (fun _61_2471 -> (match (()) with
| () -> begin
(
...
let guard = (let _145_1267 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _145_1267 impl))
in (
...
let ref_prob = (let _145_1271 = (let _145_1270 = (let _145_1269 = (FStar_Syntax_Syntax.mk_binder x1)
in (_145_1269)::(p_scope orig))
in (mk_problem _145_1270 orig phi1 FStar_TypeChecker_Common.EQ phi2 None "refinement formula"))
in (FStar_All.pipe_left (fun _145_1268 -> FStar_TypeChecker_Common.TProb (_145_1268)) _145_1271))
in (match ((solve env (
# 1836 "FStar.TypeChecker.Rel.fst"
let _61_2476 = wl
in {attempting = (ref_prob)::[]; wl_deferred = []; ctr = _61_2476.ctr; defer_ok = false; smt_ok = _61_2476.smt_ok; tcenv = _61_2476.tcenv}))) with
| Failed (_61_2479) -> begin
(fallback ())
end
| Success (_61_2482) -> begin
(
# 1839 "FStar.TypeChecker.Rel.fst"
let guard = (let _145_1274 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (let _145_1273 = (let _145_1272 = (FStar_All.pipe_right (p_guard ref_prob) Prims.fst)
in (FStar_All.pipe_right _145_1272 (guard_on_element problem x1)))
in (FStar_Syntax_Util.mk_conj _145_1274 _145_1273)))
in (
...
# 1841 "FStar.TypeChecker.Rel.fst"
let _61_2486 = wl
in {attempting = _61_2486.attempting; wl_deferred = _61_2486.wl_deferred; ctr = (wl.ctr + 1); defer_ok = _61_2486.defer_ok; smt_ok = _61_2486.smt_ok; tcenv = _61_2486.tcenv})
in (solve env (attempt ((base_prob)::[]) wl)))))
end))
end else begin
(fallback ())
...
(let _145_1276 = (destruct_flex_t t1)
in (let _145_1275 = (destruct_flex_t t2)
in (flex_flex orig _145_1276 _145_1275)))
end
...
(let _145_1277 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid orig _145_1277 t2 wl))
end
...
in if (let _145_1278 = (is_top_level_prob orig)
in (FStar_All.pipe_left Prims.op_Negation _145_1278)) then begin
(let _145_1281 = (FStar_All.pipe_left (fun _145_1279 -> FStar_TypeChecker_Common.TProb (_145_1279)) (
# 1871 "FStar.TypeChecker.Rel.fst"
let _61_2631 = problem
in {FStar_TypeChecker_Common.pid = _61_2631.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_2631.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _61_2631.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2631.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2631.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2631.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2631.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2631.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2631.FStar_TypeChecker_Common.rank}))
in (let _145_1280 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _145_1281 _145_1280 t2 wl)))
end else begin
(
# 1872 "FStar.TypeChecker.Rel.fst"
let _61_2635 = (base_and_refinement env wl t2)
in (match (_61_2635) with
...
let _61_2637 = problem
in {FStar_TypeChecker_Common.pid = _61_2637.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_2637.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _61_2637.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2637.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2637.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2637.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2637.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2637.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2637.FStar_TypeChecker_Common.rank}))
in (let _145_1283 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _145_1284 _145_1283 t_base wl)))
end
| Some (y, phi) -> begin
(
...
# 1878 "FStar.TypeChecker.Rel.fst"
let _61_2643 = y
in {FStar_Syntax_Syntax.ppname = _61_2643.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _61_2643.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
# 1879 "FStar.TypeChecker.Rel.fst"
let impl = (guard_on_element problem y' phi)
in (
# 1880 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _145_1286 = (mk_problem problem.FStar_TypeChecker_Common.scope orig t1 new_rel y.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _145_1285 -> FStar_TypeChecker_Common.TProb (_145_1285)) _145_1286))
in (
# 1882 "FStar.TypeChecker.Rel.fst"
let guard = (let _145_1287 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _145_1287 impl))
in (
...
let _61_2676 = (base_and_refinement env wl t1)
in (match (_61_2676) with
| (t_base, _61_2675) -> begin
(solve_t env (
# 1893 "FStar.TypeChecker.Rel.fst"
let _61_2677 = problem
in {FStar_TypeChecker_Common.pid = _61_2677.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = _61_2677.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2677.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2677.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2677.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2677.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2677.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2677.FStar_TypeChecker_Common.rank}) wl)
end))
end
end
| (FStar_Syntax_Syntax.Tm_refine (_61_2680), _61_2683) -> begin
(
# 1896 "FStar.TypeChecker.Rel.fst"
let t2 = (let _145_1288 = (base_and_refinement env wl t2)
in (FStar_All.pipe_left force_refinement _145_1288))
in (solve_t env (
# 1897 "FStar.TypeChecker.Rel.fst"
let _61_2686 = problem
in {FStar_TypeChecker_Common.pid = _61_2686.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_2686.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_2686.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _61_2686.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2686.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2686.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2686.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2686.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2686.FStar_TypeChecker_Common.rank}) wl))
end
| (_61_2689, FStar_Syntax_Syntax.Tm_refine (_61_2691)) -> begin
(
# 1900 "FStar.TypeChecker.Rel.fst"
let t1 = (let _145_1289 = (base_and_refinement env wl t1)
in (FStar_All.pipe_left force_refinement _145_1289))
in (solve_t env (
# 1901 "FStar.TypeChecker.Rel.fst"
let _61_2695 = problem
in {FStar_TypeChecker_Common.pid = _61_2695.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _61_2695.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_2695.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2695.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2695.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2695.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2695.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2695.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2695.FStar_TypeChecker_Common.rank}) wl))
end
...
| FStar_Syntax_Syntax.Tm_abs (_61_2712) -> begin
t
end
| _61_2715 -> begin
...
let _61_2716 = problem
in (let _145_1293 = (maybe_eta t1)
in (let _145_1292 = (maybe_eta t2)
in {FStar_TypeChecker_Common.pid = _61_2716.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _145_1293; FStar_TypeChecker_Common.relation = _61_2716.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _145_1292; FStar_TypeChecker_Common.element = _61_2716.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2716.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2716.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2716.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2716.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2716.FStar_TypeChecker_Common.rank})))
in (solve_t env _145_1294 wl)))
end
...
let head1 = (let _145_1295 = (FStar_Syntax_Util.head_and_args t1)
in (FStar_All.pipe_right _145_1295 Prims.fst))
in (
# 1923 "FStar.TypeChecker.Rel.fst"
let head2 = (let _145_1296 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _145_1296 Prims.fst))
...
(let _145_1298 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Syntax.tun FStar_Syntax_Syntax.tun t1 t2)
in (FStar_All.pipe_left (fun _145_1297 -> Some (_145_1297)) _145_1298))
end
in (let _145_1299 = (solve_prob orig guard [] wl)
in (solve env _145_1299)))
end else begin
...
| (FStar_Syntax_Syntax.Tm_ascribed (t1, _61_2797, _61_2799), _61_2803) -> begin
(solve_t' env (
# 1939 "FStar.TypeChecker.Rel.fst"
let _61_2805 = problem
in {FStar_TypeChecker_Common.pid = _61_2805.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _61_2805.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_2805.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2805.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2805.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2805.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2805.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2805.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2805.FStar_TypeChecker_Common.rank}) wl)
end
| (_61_2808, FStar_Syntax_Syntax.Tm_ascribed (t2, _61_2811, _61_2813)) -> begin
(solve_t' env (
# 1942 "FStar.TypeChecker.Rel.fst"
let _61_2817 = problem
in {FStar_TypeChecker_Common.pid = _61_2817.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_2817.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_2817.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _61_2817.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2817.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2817.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2817.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2817.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2817.FStar_TypeChecker_Common.rank}) wl)
end
...
(let _145_1302 = (let _145_1301 = (FStar_Syntax_Print.tag_of_term t1)
in (let _145_1300 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.format2 "Impossible: %s and %s" _145_1301 _145_1300)))
in (FStar_All.failwith _145_1302))
end
| _61_2856 -> begin
...
let _61_2873 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("EQ"))) then begin
...
let sub_probs = (FStar_List.map2 (fun _61_2878 _61_2882 -> (match ((_61_2878, _61_2882)) with
| ((a1, _61_2877), (a2, _61_2881)) -> begin
(let _145_1317 = (sub_prob a1 FStar_TypeChecker_Common.EQ a2 "effect arg")
in (FStar_All.pipe_left (fun _145_1316 -> FStar_TypeChecker_Common.TProb (_145_1316)) _145_1317))
end)) c1_comp.FStar_Syntax_Syntax.effect_args c2_comp.FStar_Syntax_Syntax.effect_args)
in (
# 1965 "FStar.TypeChecker.Rel.fst"
let guard = (let _145_1319 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _145_1319))
in (
# 1966 "FStar.TypeChecker.Rel.fst"
let wl = (solve_prob orig (Some (guard)) [] wl)
in (solve env (attempt sub_probs wl)))))))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _145_1320 = (solve_prob orig None [] wl)
in (solve env _145_1320))
end else begin
(
# 1970 "FStar.TypeChecker.Rel.fst"
let _61_2887 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1322 = (FStar_Syntax_Print.comp_to_string c1)
in (let _145_1321 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _145_1322 (rel_to_string problem.FStar_TypeChecker_Common.relation) _145_1321)))
end else begin
()
end
in (
...
let _61_2892 = (c1, c2)
in (match (_61_2892) with
| (c1_0, c2_0) -> begin
(match ((c1.FStar_Syntax_Syntax.n, c2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.GTotal (_61_2894), FStar_Syntax_Syntax.Total (_61_2897)) -> begin
...
(let _145_1323 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _145_1323 wl))
end
...
let _61_2925 = problem
in (let _145_1324 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c1))
in {FStar_TypeChecker_Common.pid = _61_2925.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _145_1324; FStar_TypeChecker_Common.relation = _61_2925.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _61_2925.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _61_2925.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2925.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2925.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2925.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2925.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2925.FStar_TypeChecker_Common.rank}))
in (solve_c env _145_1325 wl))
end
...
let _61_2941 = problem
in (let _145_1326 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c2))
in {FStar_TypeChecker_Common.pid = _61_2941.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _61_2941.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _61_2941.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _145_1326; FStar_TypeChecker_Common.element = _61_2941.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _61_2941.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _61_2941.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _61_2941.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _61_2941.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _61_2941.FStar_TypeChecker_Common.rank}))
in (solve_c env _145_1327 wl))
end
| (FStar_Syntax_Syntax.Comp (_61_2944), FStar_Syntax_Syntax.Comp (_61_2947)) -> begin
...
(let _145_1328 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _145_1328 wl))
end else begin
(
...
let _61_2954 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
| None -> begin
(let _145_1331 = (let _145_1330 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _145_1329 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _145_1330 _145_1329)))
in (giveup env _145_1331 orig))
end
| Some (edge) -> begin
if (problem.FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ) then begin
(
# 2012 "FStar.TypeChecker.Rel.fst"
let _61_2972 = (match (c1.FStar_Syntax_Syntax.effect_args) with
| (wp1, _61_2965)::(wlp1, _61_2961)::[] -> begin
(wp1, wlp1)
end
| _61_2969 -> begin
(let _145_1333 = (let _145_1332 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid c1.FStar_Syntax_Syntax.effect_name))
in (FStar_Util.format1 "Unexpected number of indices on a normalized effect (%s)" _145_1332))
in (FStar_All.failwith _145_1333))
end)
in (match (_61_2972) with
| (wp, wlp) -> begin
(
# 2015 "FStar.TypeChecker.Rel.fst"
let c1 = (let _145_1339 = (let _145_1338 = (let _145_1334 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _145_1334))
in (let _145_1337 = (let _145_1336 = (let _145_1335 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wlp)
in (FStar_Syntax_Syntax.as_arg _145_1335))
in (_145_1336)::[])
in (_145_1338)::_145_1337))
in {FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _145_1339; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2))
end))
end else begin
(
...
let _61_3000 = (match ((c1.FStar_Syntax_Syntax.effect_args, c2.FStar_Syntax_Syntax.effect_args)) with
| ((wp1, _61_2985)::_61_2982, (wp2, _61_2992)::_61_2989) -> begin
(wp1, wp2)
end
| _61_2997 -> begin
(let _145_1343 = (let _145_1342 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _145_1341 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _145_1342 _145_1341)))
in (FStar_All.failwith _145_1343))
end)
in (match (_61_3000) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _145_1344 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _145_1344 wl))
end else begin
(
...
let _61_3002 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(FStar_Util.print_string "Using trivial wp ... \n")
end else begin
()
end
in (let _145_1354 = (let _145_1353 = (let _145_1352 = (let _145_1346 = (let _145_1345 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_145_1345)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1346 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _145_1351 = (let _145_1350 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _145_1349 = (let _145_1348 = (let _145_1347 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1347))
in (_145_1348)::[])
in (_145_1350)::_145_1349))
in (_145_1352, _145_1351)))
in FStar_Syntax_Syntax.Tm_app (_145_1353))
in (FStar_Syntax_Syntax.mk _145_1354 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(
# 2037 "FStar.TypeChecker.Rel.fst"
let wp2_imp_wp1 = (let _145_1370 = (let _145_1369 = (let _145_1368 = (let _145_1356 = (let _145_1355 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_145_1355)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1356 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_binop))
in (let _145_1367 = (let _145_1366 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _145_1365 = (let _145_1364 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _145_1363 = (let _145_1362 = (let _145_1358 = (let _145_1357 = (FStar_Ident.set_lid_range FStar_Syntax_Const.imp_lid r)
in (FStar_Syntax_Syntax.fvar _145_1357 (FStar_Syntax_Syntax.Delta_unfoldable (1)) None))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1358))
in (let _145_1361 = (let _145_1360 = (let _145_1359 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1359))
in (_145_1360)::[])
in (_145_1362)::_145_1361))
in (_145_1364)::_145_1363))
in (_145_1366)::_145_1365))
in (_145_1368, _145_1367)))
in FStar_Syntax_Syntax.Tm_app (_145_1369))
in (FStar_Syntax_Syntax.mk _145_1370 None r))
in (let _145_1379 = (let _145_1378 = (let _145_1377 = (let _145_1372 = (let _145_1371 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_145_1371)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1372 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_as_type))
in (let _145_1376 = (let _145_1375 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _145_1374 = (let _145_1373 = (FStar_Syntax_Syntax.as_arg wp2_imp_wp1)
in (_145_1373)::[])
in (_145_1375)::_145_1374))
in (_145_1377, _145_1376)))
in FStar_Syntax_Syntax.Tm_app (_145_1378))
in (FStar_Syntax_Syntax.mk _145_1379 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end
in (
# 2044 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _145_1381 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _145_1380 -> FStar_TypeChecker_Common.TProb (_145_1380)) _145_1381))
in (
# 2045 "FStar.TypeChecker.Rel.fst"
let wl = (let _145_1385 = (let _145_1384 = (let _145_1383 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _145_1383 g))
in (FStar_All.pipe_left (fun _145_1382 -> Some (_145_1382)) _145_1384))
in (solve_prob orig _145_1385 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _145_1389 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _61_3018 -> (match (_61_3018) with
| (_61_3010, u, _61_3013, _61_3015, _61_3017) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _145_1389 (FStar_String.concat ", "))))
...
let carry = (let _145_1395 = (FStar_List.map (fun _61_3033 -> (match (_61_3033) with
| (_61_3031, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _145_1395 (FStar_String.concat ",\n")))
in (
...
| {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _61_3042; FStar_TypeChecker_Env.implicits = _61_3040} -> begin
true
end
| _61_3047 -> begin
false
...
let _61_3067 = g
in (let _145_1413 = (let _145_1412 = (let _145_1411 = (let _145_1407 = (FStar_Syntax_Syntax.mk_binder x)
in (_145_1407)::[])
in (let _145_1410 = (let _145_1409 = (let _145_1408 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _145_1408 FStar_Syntax_Util.lcomp_of_comp))
in Some (_145_1409))
in (FStar_Syntax_Util.abs _145_1411 f _145_1410)))
in (FStar_All.pipe_left (fun _145_1406 -> FStar_TypeChecker_Common.NonTrivial (_145_1406)) _145_1412))
in {FStar_TypeChecker_Env.guard_f = _145_1413; FStar_TypeChecker_Env.deferred = _61_3067.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3067.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3067.FStar_TypeChecker_Env.implicits}))
in Some (_145_1414)))
end))
...
in {FStar_TypeChecker_Env.guard_f = _145_1425; FStar_TypeChecker_Env.deferred = _61_3074.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3074.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3074.FStar_TypeChecker_Env.implicits}))
end))
...
| FStar_TypeChecker_Common.NonTrivial (_61_3079) -> begin
(FStar_All.failwith "impossible")
end))
...
in {FStar_TypeChecker_Env.guard_f = _145_1470; FStar_TypeChecker_Env.deferred = _61_3124.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3124.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3124.FStar_TypeChecker_Env.implicits}))
end))
...
# 2144 "FStar.TypeChecker.Rel.fst"
let _61_3144 = probs
in {attempting = _61_3144.attempting; wl_deferred = _61_3144.wl_deferred; ctr = _61_3144.ctr; defer_ok = false; smt_ok = _61_3144.smt_ok; tcenv = _61_3144.tcenv})
end else begin
probs
end
in (
...
let _61_3151 = (FStar_Unionfind.commit tx)
in Some (deferred))
end
| Failed (d, s) -> begin
(
# 2152 "FStar.TypeChecker.Rel.fst"
let _61_3157 = (FStar_Unionfind.rollback tx)
in (
# 2153 "FStar.TypeChecker.Rel.fst"
let _61_3159 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("ExplainRel"))) then begin
...
let _61_3166 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
...
let _61_3169 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
...
let _61_3176 = g
in {FStar_TypeChecker_Env.guard_f = f; FStar_TypeChecker_Env.deferred = _61_3176.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3176.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3176.FStar_TypeChecker_Env.implicits})))))
end))
...
let _61_3187 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let g = (let _145_1537 = (solve_and_commit env (singleton env prob) (fun _61_3190 -> None))
...
let _61_3199 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let _61_3204 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let _61_3208 = (new_t_prob env t1 FStar_TypeChecker_Common.SUB t2)
in (match (_61_3208) with
| (prob, x) -> begin
(
# 2195 "FStar.TypeChecker.Rel.fst"
let g = (let _145_1560 = (solve_and_commit env (singleton env prob) (fun _61_3209 -> None))
in (FStar_All.pipe_left (with_guard env prob) _145_1560))
in (
# 2196 "FStar.TypeChecker.Rel.fst"
let _61_3212 = if ((FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) && (FStar_Util.is_some g)) then begin
...
let _61_3220 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (let _145_1584 = (solve_and_commit env (singleton env prob) (fun _61_3224 -> None))
...
let _61_3233 = (FStar_Unionfind.rollback tx)
in (
...
let ad_hoc_fallback = (fun _61_3266 -> (match (()) with
| () -> begin
(match (ineqs) with
| [] -> begin
()
...
let wl = (
# 2254 "FStar.TypeChecker.Rel.fst"
let _61_3270 = (empty_worklist env)
in {attempting = _61_3270.attempting; wl_deferred = _61_3270.wl_deferred; ctr = _61_3270.ctr; defer_ok = true; smt_ok = _61_3270.smt_ok; tcenv = _61_3270.tcenv})
in (FStar_All.pipe_right ineqs (FStar_List.iter (fun _61_3275 -> (match (_61_3275) with
| (u1, u2) -> begin
(
...
let _61_3302 = (FStar_Syntax_Util.univ_kernel u)
in (match (_61_3302) with
| (k_u, n) -> begin
...
let wl = (
# 2284 "FStar.TypeChecker.Rel.fst"
let _61_3312 = (empty_worklist env)
in {attempting = _61_3312.attempting; wl_deferred = _61_3312.wl_deferred; ctr = _61_3312.ctr; defer_ok = false; smt_ok = _61_3312.smt_ok; tcenv = _61_3312.tcenv})
in (
...
let _61_3332 = (solve_universe_inequalities' tx env ineqs)
...
let fail = (fun _61_3339 -> (match (_61_3339) with
| (d, s) -> begin
(
...
let _61_3342 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _61_3346 = g
in {FStar_TypeChecker_Env.guard_f = _61_3346.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _61_3346.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3346.FStar_TypeChecker_Env.implicits})
end
| _61_3349 -> begin
...
let _61_3351 = (solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs)
in (
# 2313 "FStar.TypeChecker.Rel.fst"
let _61_3353 = g
in {FStar_TypeChecker_Env.guard_f = _61_3353.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _61_3353.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = _61_3353.FStar_TypeChecker_Env.implicits})))))))
...
let _61_3368 = if (not ((FStar_Options.should_verify env.FStar_TypeChecker_Env.curmodule.FStar_Ident.str))) then begin
()
end else begin
...
let _61_3366 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let _61_3370 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _61_3370.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3370.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3370.FStar_TypeChecker_Env.implicits}))))
...
let rec until_fixpoint = (fun _61_3383 implicits -> (match (_61_3383) with
| (out, changed) -> begin
...
let _61_3397 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _61_3404 = (env.FStar_TypeChecker_Env.type_of (
# 2350 "FStar.TypeChecker.Rel.fst"
let _61_3399 = env
in {FStar_TypeChecker_Env.solver = _61_3399.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _61_3399.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _61_3399.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _61_3399.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _61_3399.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _61_3399.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _61_3399.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _61_3399.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _61_3399.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _61_3399.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _61_3399.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _61_3399.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _61_3399.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _61_3399.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _61_3399.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _61_3399.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _61_3399.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _61_3399.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.default_effects = _61_3399.FStar_TypeChecker_Env.default_effects; FStar_TypeChecker_Env.type_of = _61_3399.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _61_3399.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true}) tm)
in (match (_61_3404) with
| (_61_3402, g) -> begin
(
...
let _61_3405 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _61_3405.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3405.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _61_3405.FStar_TypeChecker_Env.implicits})
end else begin
g
end
in (
# 2354 "FStar.TypeChecker.Rel.fst"
let g' = (discharge_guard' (Some ((fun _61_3408 -> (match (()) with
| () -> begin
...
in {FStar_TypeChecker_Env.guard_f = _61_3410.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _61_3410.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _61_3410.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _145_1672})))))
...
| (_61_3419, _61_3421, _61_3423, _61_3425, r)::_61_3417 -> begin
...
let _61_3431 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = _61_3431.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _61_3431.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((u1, u2))::[]; FStar_TypeChecker_Env.implicits = _61_3431.FStar_TypeChecker_Env.implicits}))
