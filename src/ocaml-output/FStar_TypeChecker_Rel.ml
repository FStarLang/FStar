...
let c1 = (let _145_1418 = (let _145_1417 = (let _145_1413 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _145_1413))
in (let _145_1416 = (let _145_1415 = (let _145_1414 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wlp)
in (FStar_Syntax_Syntax.as_arg _145_1414))
in (_145_1415)::[])
in (_145_1417)::_145_1416))
in {FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _145_1418; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2))
end))
end else begin
(
...
| _55_3052 -> begin
(let _145_1422 = (let _145_1421 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _145_1420 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _145_1421 _145_1420)))
in (FStar_All.failwith _145_1422))
end)
in (match (_55_3055) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _145_1423 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _145_1423 wl))
end else begin
(
...
in (let _145_1433 = (let _145_1432 = (let _145_1431 = (let _145_1425 = (let _145_1424 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_145_1424)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1425 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _145_1430 = (let _145_1429 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _145_1428 = (let _145_1427 = (let _145_1426 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1426))
in (_145_1427)::[])
in (_145_1429)::_145_1428))
in (_145_1431, _145_1430)))
in FStar_Syntax_Syntax.Tm_app (_145_1432))
in (FStar_Syntax_Syntax.mk _145_1433 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(

let wp2_imp_wp1 = (let _145_1449 = (let _145_1448 = (let _145_1447 = (let _145_1435 = (let _145_1434 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_145_1434)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1435 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_binop))
in (let _145_1446 = (let _145_1445 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _145_1444 = (let _145_1443 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _145_1442 = (let _145_1441 = (let _145_1437 = (let _145_1436 = (FStar_Ident.set_lid_range FStar_Syntax_Const.imp_lid r)
in (FStar_Syntax_Syntax.fvar _145_1436 (FStar_Syntax_Syntax.Delta_unfoldable (1)) None))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1437))
in (let _145_1440 = (let _145_1439 = (let _145_1438 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _145_1438))
in (_145_1439)::[])
in (_145_1441)::_145_1440))
in (_145_1443)::_145_1442))
in (_145_1445)::_145_1444))
in (_145_1447, _145_1446)))
in FStar_Syntax_Syntax.Tm_app (_145_1448))
in (FStar_Syntax_Syntax.mk _145_1449 None r))
in (let _145_1458 = (let _145_1457 = (let _145_1456 = (let _145_1451 = (let _145_1450 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_145_1450)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _145_1451 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_as_type))
in (let _145_1455 = (let _145_1454 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _145_1453 = (let _145_1452 = (FStar_Syntax_Syntax.as_arg wp2_imp_wp1)
in (_145_1452)::[])
in (_145_1454)::_145_1453))
in (_145_1456, _145_1455)))
in FStar_Syntax_Syntax.Tm_app (_145_1457))
in (FStar_Syntax_Syntax.mk _145_1458 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end
in (

let base_prob = (let _145_1460 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _145_1459 -> FStar_TypeChecker_Common.TProb (_145_1459)) _145_1460))
in (

let wl = (let _145_1464 = (let _145_1463 = (let _145_1462 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _145_1462 g))
in (FStar_All.pipe_left (fun _145_1461 -> Some (_145_1461)) _145_1463))
in (solve_prob orig _145_1464 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _145_1465 = (solve_prob orig None [] wl)
in (solve env _145_1465))
end else begin
(

let _55_3063 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1467 = (FStar_Syntax_Print.comp_to_string c1)
in (let _145_1466 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _145_1467 (rel_to_string problem.FStar_TypeChecker_Common.relation) _145_1466)))
end else begin
()
end
in (

let _55_3067 = (let _145_1469 = (FStar_TypeChecker_Normalize.ghost_to_pure env c1)
in (let _145_1468 = (FStar_TypeChecker_Normalize.ghost_to_pure env c2)
in (_145_1469, _145_1468)))
...
(let _145_1470 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _145_1470 wl))
end
...
(let _145_1471 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _145_1471 wl))
end
...
in (let _145_1474 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c2))
in {FStar_TypeChecker_Common.pid = _55_3121.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_3121.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _55_3121.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _145_1474; FStar_TypeChecker_Common.element = _55_3121.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_3121.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_3121.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_3121.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_3121.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_3121.FStar_TypeChecker_Common.rank}))
in (solve_c env _145_1475 wl))
end
...
(let _145_1476 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _145_1476 wl))
end else begin
(
...
| None -> begin
if (((FStar_Syntax_Util.is_ghost_effect c1.FStar_Syntax_Syntax.effect_name) && (FStar_Syntax_Util.is_pure_effect c2.FStar_Syntax_Syntax.effect_name)) && (let _145_1477 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Inline)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env c2.FStar_Syntax_Syntax.result_typ)
in (FStar_Syntax_Util.non_informative _145_1477))) then begin
(
...
(let _145_1482 = (let _145_1481 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _145_1480 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _145_1481 _145_1480)))
in (giveup env _145_1482 orig))
end
end
| Some (edge) -> begin
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _145_1486 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _55_3154 -> (match (_55_3154) with
| (_55_3144, _55_3146, u, _55_3149, _55_3151, _55_3153) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _145_1486 (FStar_String.concat ", "))))
...
let carry = (let _145_1492 = (FStar_List.map (fun _55_3169 -> (match (_55_3169) with
| (_55_3167, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _145_1492 (FStar_String.concat ",\n")))
in (
...
let _55_3203 = g
in (let _145_1512 = (let _145_1511 = (let _145_1510 = (let _145_1504 = (FStar_Syntax_Syntax.mk_binder x)
in (_145_1504)::[])
in (let _145_1509 = (let _145_1508 = (let _145_1507 = (let _145_1505 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _145_1505 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _145_1507 (fun _145_1506 -> FStar_Util.Inl (_145_1506))))
in Some (_145_1508))
in (FStar_Syntax_Util.abs _145_1510 f _145_1509)))
in (FStar_All.pipe_left (fun _145_1503 -> FStar_TypeChecker_Common.NonTrivial (_145_1503)) _145_1511))
in {FStar_TypeChecker_Env.guard_f = _145_1512; FStar_TypeChecker_Env.deferred = _55_3203.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3203.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3203.FStar_TypeChecker_Env.implicits}))
in Some (_145_1513)))
end))
...
let _55_3210 = g
in (let _145_1524 = (let _145_1523 = (let _145_1522 = (let _145_1521 = (let _145_1520 = (let _145_1519 = (FStar_Syntax_Syntax.as_arg e)
in (_145_1519)::[])
in (f, _145_1520))
in FStar_Syntax_Syntax.Tm_app (_145_1521))
in (FStar_Syntax_Syntax.mk _145_1522 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _145_1518 -> FStar_TypeChecker_Common.NonTrivial (_145_1518)) _145_1523))
in {FStar_TypeChecker_Env.guard_f = _145_1524; FStar_TypeChecker_Env.deferred = _55_3210.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3210.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3210.FStar_TypeChecker_Env.implicits}))
end))
...
(let _145_1531 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_145_1531))
end))
...
let binop_guard : (FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula)  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t = (fun f g1 g2 -> (let _145_1554 = (f g1.FStar_TypeChecker_Env.guard_f g2.FStar_TypeChecker_Env.guard_f)
in {FStar_TypeChecker_Env.guard_f = _145_1554; FStar_TypeChecker_Env.deferred = (FStar_List.append g1.FStar_TypeChecker_Env.deferred g2.FStar_TypeChecker_Env.deferred); FStar_TypeChecker_Env.univ_ineqs = (FStar_List.append g1.FStar_TypeChecker_Env.univ_ineqs g2.FStar_TypeChecker_Env.univ_ineqs); FStar_TypeChecker_Env.implicits = (FStar_List.append g1.FStar_TypeChecker_Env.implicits g2.FStar_TypeChecker_Env.implicits)}))
...
let _55_3260 = g
in (let _145_1569 = (let _145_1568 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _145_1568 (fun _145_1567 -> FStar_TypeChecker_Common.NonTrivial (_145_1567))))
in {FStar_TypeChecker_Env.guard_f = _145_1569; FStar_TypeChecker_Env.deferred = _55_3260.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3260.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3260.FStar_TypeChecker_Env.implicits}))
end))
...
(let _145_1577 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _145_1576 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _145_1577 (rel_to_string rel) _145_1576)))
end else begin
"TOP"
end
in (
...
let x = (let _145_1588 = (let _145_1587 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _145_1586 -> Some (_145_1586)) _145_1587))
in (FStar_Syntax_Syntax.new_bv _145_1588 t1))
in (

let env = (FStar_TypeChecker_Env.push_bv env x)
in (

let p = (let _145_1592 = (let _145_1590 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _145_1589 -> Some (_145_1589)) _145_1590))
in (let _145_1591 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _145_1592 _145_1591)))
...
(let _145_1604 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _145_1604))
end else begin
()
end
in (err (d, s))))
...
(let _145_1609 = (FStar_Syntax_Print.term_to_string f)
...
(let _145_1610 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _145_1611 = (FStar_Syntax_Util.unmeta f)
in _145_1611.FStar_Syntax_Syntax.n)) with
...
| Some (d) -> begin
(let _145_1623 = (let _145_1622 = (let _145_1621 = (let _145_1620 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _145_1620 (fun _145_1619 -> FStar_TypeChecker_Common.NonTrivial (_145_1619))))
in {FStar_TypeChecker_Env.guard_f = _145_1621; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _145_1622))
in (FStar_All.pipe_left (fun _145_1618 -> Some (_145_1618)) _145_1623))
end))
...
(let _145_1631 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1630 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _145_1634 = (let _145_1633 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _145_1633))
in (FStar_All.pipe_left (fun _145_1632 -> FStar_TypeChecker_Common.TProb (_145_1632)) _145_1634))
in (

let g = (let _145_1636 = (solve_and_commit env (singleton env prob) (fun _55_3326 -> None))
in (FStar_All.pipe_left (with_guard env prob) _145_1636))
in g))))
...
| None -> begin
(let _145_1646 = (let _145_1645 = (let _145_1644 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _145_1643 = (FStar_TypeChecker_Env.get_range env)
in (_145_1644, _145_1643)))
in FStar_Syntax_Syntax.Error (_145_1645))
in (Prims.raise _145_1646))
end
| Some (g) -> begin
(

let _55_3335 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _145_1649 = (FStar_Syntax_Print.term_to_string t1)
in (let _145_1648 = (FStar_Syntax_Print.term_to_string t2)
in (let _145_1647 = (guard_to_string env g)
...
(let _145_1657 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _145_1656 = (FStar_TypeChecker_Normalize.term_to_string env t2)
...
let g = (let _145_1659 = (solve_and_commit env (singleton env prob) (fun _55_3345 -> None))
in (FStar_All.pipe_left (with_guard env prob) _145_1659))
in (
...
(let _145_1663 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _145_1662 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _145_1661 = (let _145_1660 = (FStar_Util.must g)
in (guard_to_string env _145_1660))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _145_1663 _145_1662 _145_1661))))
end else begin
()
end
...
let subtype_fail = (fun env t1 t2 -> (let _145_1670 = (let _145_1669 = (let _145_1668 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _145_1667 = (FStar_TypeChecker_Env.get_range env)
in (_145_1668, _145_1667)))
in FStar_Syntax_Syntax.Error (_145_1669))
in (Prims.raise _145_1670)))
...
(let _145_1678 = (FStar_Syntax_Print.comp_to_string c1)
in (let _145_1677 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _145_1681 = (let _145_1680 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _145_1680 "sub_comp"))
in (FStar_All.pipe_left (fun _145_1679 -> FStar_TypeChecker_Common.CProb (_145_1679)) _145_1681))
in (let _145_1683 = (solve_and_commit env (singleton env prob) (fun _55_3360 -> None))
in (FStar_All.pipe_left (with_guard env prob) _145_1683))))))
...
in (let _145_1701 = (let _145_1700 = (let _145_1699 = (let _145_1697 = (FStar_Syntax_Print.univ_to_string u1)
in (let _145_1696 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _145_1697 _145_1696 msg)))
in (let _145_1698 = (FStar_TypeChecker_Env.get_range env)
in (_145_1699, _145_1698)))
in FStar_Syntax_Syntax.Error (_145_1700))
in (Prims.raise _145_1701)))))
in (
...
(let _145_1713 = (insert uv u1 out)
in (group_by _145_1713 rest))
end)
end
| _55_3400 -> begin
None
...
(let _145_1734 = (wl_to_string wl)
in (let _145_1733 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
(let _145_1751 = (FStar_TypeChecker_Env.get_range env)
in (let _145_1750 = (let _145_1749 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _145_1749))
in (FStar_TypeChecker_Errors.diag _145_1751 _145_1750)))
end else begin
()
end
...
(let _145_1767 = (FStar_Syntax_Print.uvar_to_string u)
in (let _145_1766 = (FStar_Syntax_Print.term_to_string tm)
in (let _145_1765 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _145_1767 _145_1766 _145_1765))))
end else begin
()
end
in (
...
let _55_3550 = g
in (let _145_1771 = (until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _55_3550.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _55_3550.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3550.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _145_1771})))))


let force_trivial_guard : FStar_TypeChecker_Env.env  ->  FStar_TypeChecker_Env.guard_t  ->  Prims.unit = (fun env g -> (

let g = (let _145_1776 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _145_1776 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _145_1777 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _145_1777))
end
| (reason, _55_3560, _55_3562, e, t, r)::_55_3557 -> begin
(let _145_1782 = (let _145_1781 = (let _145_1780 = (let _145_1779 = (FStar_Syntax_Print.term_to_string t)
in (let _145_1778 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format3 "Failed to resolve implicit argument of type \'%s\' introduced in %s because %s" _145_1779 _145_1778 reason)))
in (_145_1780, r))
in FStar_Syntax_Syntax.Error (_145_1781))
in (Prims.raise _145_1782))
end)))
