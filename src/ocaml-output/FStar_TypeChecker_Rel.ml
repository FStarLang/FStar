        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            let f1 =
              FStar_List.fold_right2
                ...
                us bs f in
            let uu___136_248 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___136_248.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___136_248.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___136_248.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____277 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___137_275.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___137_275.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___137_275.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___138_784 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___138_784.wl_deferred);
          ctr = (uu___138_784.ctr);
          defer_ok = (uu___138_784.defer_ok);
          smt_ok;
          tcenv = (uu___138_784.tcenv)
        }
let singleton:
  FStar_TypeChecker_Env.env -> FStar_TypeChecker_Common.prob -> worklist =
  fun env  -> fun prob  -> singleton' env prob true
let wl_of_guard env g =
  let uu___139_809 = empty_worklist env in
  let uu____810 = FStar_List.map Prims.snd g in
  {
    attempting = uu____810;
    wl_deferred = (uu___139_809.wl_deferred);
    ctr = (uu___139_809.ctr);
    defer_ok = false;
    smt_ok = (uu___139_809.smt_ok);
    tcenv = (uu___139_809.tcenv)
  }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___140_822 = wl in
        {
          attempting = (uu___140_822.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___140_822.ctr);
          defer_ok = (uu___140_822.defer_ok);
          smt_ok = (uu___140_822.smt_ok);
          tcenv = (uu___140_822.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___141_834 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___141_834.wl_deferred);
        ctr = (uu___141_834.ctr);
        defer_ok = (uu___141_834.defer_ok);
        smt_ok = (uu___141_834.smt_ok);
        tcenv = (uu___141_834.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert_rel: FStar_TypeChecker_Common.rel -> FStar_TypeChecker_Common.rel
  =
  fun uu___108_850  ->
    match uu___108_850 with
    | FStar_TypeChecker_Common.EQ  -> FStar_TypeChecker_Common.EQ
    | FStar_TypeChecker_Common.SUB  -> FStar_TypeChecker_Common.SUBINV
    | FStar_TypeChecker_Common.SUBINV  -> FStar_TypeChecker_Common.SUB
let invert p =
  let uu___142_866 = p in
  {
    FStar_TypeChecker_Common.pid =
      (uu___142_866.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
    FStar_TypeChecker_Common.relation =
      (invert_rel p.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
    FStar_TypeChecker_Common.element =
      (uu___142_866.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___142_866.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___142_866.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___142_866.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___142_866.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___142_866.FStar_TypeChecker_Common.rank)
  }
let maybe_invert p =
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___116_957  ->
    match uu___116_957 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___117_966  ->
    match uu___117_966 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1336  ->
              ...
              | (x,imp) ->
                  let uu____1343 =
                    let uu___143_1344 = x in
                    let uu____1345 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___143_1344.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___143_1344.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____2071,uv) ->
                ((let uu____2074 =
                 ...
                 commit uvis;
                 (let uu___144_2105 = wl in
                  {
                    attempting = (uu___144_2105.attempting);
                    wl_deferred = (uu___144_2105.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___144_2105.defer_ok);
                    smt_ok = (uu___144_2105.smt_ok);
                    tcenv = (uu___144_2105.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___145_2126 = wl in
         {
           attempting = (uu___145_2126.attempting);
           wl_deferred = (uu___145_2126.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___145_2126.defer_ok);
           smt_ok = (uu___145_2126.smt_ok);
           tcenv = (uu___145_2126.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
    FStar_Syntax_Syntax.term Prims.option ->
...
let rec decompose:
  ...
  fun env  ->
    fun t  ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____3978))::tcs2) ->
                       aux
                         (((let uu___146_4000 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___146_4000.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___146_4000.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___123_4041 =
                 match uu___123_4041 with
      ...
      | uu____4132 ->
          let rebuild uu___124_4137 =
            match uu___124_4137 with
            | [] -> t1
            | uu____4139 -> failwith "Bad reconstruction" in
          (rebuild, ((fun t2  -> true)), [])
let un_T: tc -> FStar_Syntax_Syntax.term =
  fun uu___125_4158  ->
    match uu___125_4158 with
    | T (t,uu____4160) -> t
    | uu____4169 -> failwith "Impossible"
let arg_of_tc: tc -> FStar_Syntax_Syntax.arg =
  fun uu___126_4172  ->
    match uu___126_4172 with
...
let compress_tprob wl p =
  ...
  {
    FStar_TypeChecker_Common.pid =
      (uu___147_4866.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = uu____4869;
    FStar_TypeChecker_Common.relation =
      (uu___147_4866.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = uu____4870;
    FStar_TypeChecker_Common.element =
      (uu___147_4866.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___147_4866.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___147_4866.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___147_4866.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___147_4866.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___147_4866.FStar_TypeChecker_Common.rank)
  }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____4946) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5046 ->
                                    ...
                                    let uu____5055 =
                                      let uu___148_5058 = tp in
                                      let uu____5061 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___148_5058.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___148_5058.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___148_5058.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____5061;
                                        FStar_TypeChecker_Common.element =
                                          (uu___148_5058.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___148_5058.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___148_5058.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___148_5058.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___148_5058.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___148_5058.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____5055)))
                          ...
                          (match uu____5081 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5121 ->
                                    let uu____5127 =
                                      let uu___149_5132 = tp in
                                      let uu____5135 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___149_5132.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____5135;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___149_5132.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___149_5132.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___149_5132.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___149_5132.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___149_5132.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___149_5132.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___149_5132.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___149_5132.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____4961 with
                     | (rank,tp1) ->
                         let uu____5163 =
                           FStar_All.pipe_right
                             (let uu___150_5166 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___150_5166.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___150_5166.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___150_5166.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___150_5166.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___150_5166.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___150_5166.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___150_5166.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___150_5166.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___150_5166.FStar_TypeChecker_Common.loc);
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____5172 =
            FStar_All.pipe_right
              (let uu___151_5175 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___151_5175.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___151_5175.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___151_5175.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___151_5175.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___151_5175.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___151_5175.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___151_5175.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___151_5175.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___151_5175.FStar_TypeChecker_Common.loc);
  ...
  fun env  ->
    fun probs  ->
      ...
      (let uu____5841 = next_prob probs in
       ...
       | (Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___152_5854 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___152_5854.wl_deferred);
               ctr = (uu___152_5854.ctr);
               defer_ok = (uu___152_5854.defer_ok);
               smt_ok = (uu___152_5854.smt_ok);
               tcenv = (uu___152_5854.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____5955 ->
                          let uu____5960 =
                                      ...
                                      | (uu____5975,uu____5976,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___153_5961.ctr);
                              defer_ok = (uu___153_5961.defer_ok);
                              smt_ok = (uu___153_5961.smt_ok);
                              tcenv = (uu___153_5961.tcenv)
                            } in
                       ...
                       (match uu____6515 with
                        ...
                        | Some (lhs_bound,sub_probs) ->
                            ...
                            ((let uu____6544 =
                              ...
                              then
                                let wl' =
                                  let uu___154_6546 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred = (uu___154_6546.wl_deferred);
                                    ctr = (uu___154_6546.ctr);
                                    defer_ok = (uu___154_6546.defer_ok);
                                    smt_ok = (uu___154_6546.smt_ok);
                                    tcenv = (uu___154_6546.tcenv)
                                  } in
                             ...
                             (let uu____6549 =
                                solve_t env eq_prob
                                  (let uu___155_6550 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___155_6550.wl_deferred);
                                     ctr = (uu___155_6550.ctr);
                                     defer_ok = (uu___155_6550.defer_ok);
                                     smt_ok = (uu___155_6550.smt_ok);
                                     tcenv = (uu___155_6550.tcenv)
                                   }) in
                            ...
                            (match uu____7113 with
                             ...
                             | Some (rhs_bound,sub_probs) ->
                                 ...
                                 ((let uu____7154 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___157_7156 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___157_7156.wl_deferred);
                                         ctr = (uu___157_7156.ctr);
                                         defer_ok = (uu___157_7156.defer_ok);
                                         smt_ok = (uu___157_7156.smt_ok);
                                         tcenv = (uu___157_7156.tcenv)
                                       } in
                                  ...
                                  (let uu____7159 =
                                     solve_t env eq_prob
                                       (let uu___158_7160 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___158_7160.wl_deferred);
                                          ctr = (uu___158_7160.ctr);
                                          defer_ok = (uu___158_7160.defer_ok);
                                          smt_ok = (uu___158_7160.smt_ok);
                                          tcenv = (uu___158_7160.tcenv)
                                        }) in
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___160_7268 = hd1 in
                      let uu____7269 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___160_7268.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___160_7268.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____7269
                      } in
                    let hd21 =
                      let uu___161_7273 = hd2 in
                      let uu____7274 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___161_7273.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___161_7273.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____7454,Some (t11,t21)) ->
                   solve_t env1
                     (let uu___162_7462 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___162_7462.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___162_7462.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___162_7462.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___162_7462.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___162_7462.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___162_7462.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___162_7462.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___162_7462.FStar_TypeChecker_Common.rank)
                      }) wl1
               | (uu____7463,None ) ->
                   ((let uu____7470 =
                                                  ...
                                                  solve_t env1
                                                    (let uu___163_7709 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___163_7709.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___129_7869 =
          match uu___129_7869 with
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___130_10330 =
                     match uu___130_10330 with
                     | [] -> c
                     | bs ->
                         let uu____10344 =
                           (FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___131_10523 =
                     match uu___131_10523 with
                     | [] -> t
                     | bs ->
                         (FStar_Syntax_Syntax.mk
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                   ...
                   (match uu____10707 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___164_10754 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___164_10754.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___164_10754.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___164_10754.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___164_10754.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___164_10754.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___164_10754.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___164_10754.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___164_10754.FStar_TypeChecker_Common.rank)
                           }) wl
                        ...
                        (match uu____10819 with
                         | (x2,phi2) ->
                             ...
                             then
                               ...
                               let uu____10882 =
                                 solve env1
                                   (let uu___165_10883 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___165_10883.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___165_10883.smt_ok);
                                      tcenv = (uu___165_10883.tcenv)
                                    }) in
                               (match uu____10882 with
                                ...
                                | Success uu____10890 ->
                                    ...
                                    let wl2 =
                                      let uu___166_10905 = wl1 in
                                      {
                                        attempting =
                                          (uu___166_10905.attempting);
                                        wl_deferred =
                                          (uu___166_10905.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___166_10905.defer_ok);
                                        smt_ok = (uu___166_10905.smt_ok);
                                        tcenv = (uu___166_10905.tcenv)
                                      } in
               ...
               | (FStar_Syntax_Syntax.Tm_uvar _,FStar_Syntax_Syntax.Tm_type
                 ...
                 |(FStar_Syntax_Syntax.Tm_app
                  ...
                  |(FStar_Syntax_Syntax.Tm_uvar
                   ...
                   ->
                   solve_t' env
                     (let uu___167_11025 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___167_11025.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___167_11025.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___167_11025.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___167_11025.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___167_11025.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___167_11025.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___167_11025.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___167_11025.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___167_11025.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar _,_)
                 |(FStar_Syntax_Syntax.Tm_app
                   ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar _;
                      ...
                      then
                        let uu____11045 =
                          FStar_All.pipe_left
                            ...
                            (let uu___168_11048 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___168_11048.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___168_11048.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___168_11048.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___168_11048.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___168_11048.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___168_11048.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___168_11048.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___168_11048.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___168_11048.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____11054 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | None  ->
                                  let uu____11084 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___169_11087 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___169_11087.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___169_11087.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___169_11087.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___169_11087.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___169_11087.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___169_11087.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___169_11087.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___169_11087.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___169_11087.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____11088 =
                              ...
                              | Some (y,phi) ->
                                  let y' =
                                    let uu___170_11103 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___170_11103.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___170_11103.FStar_Syntax_Syntax.index);
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_app
                   ...
                   then
                     ...
                     (let uu____11136 = base_and_refinement env wl t1 in
                      ...
                      | (t_base,uu____11147) ->
                          solve_t env
                            (let uu___171_11162 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___171_11162.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___171_11162.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___171_11162.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___171_11162.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___171_11162.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___171_11162.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___171_11162.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___171_11162.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____11165,uu____11166) ->
                   ...
                   solve_t env
                     (let uu___172_11187 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___172_11187.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___172_11187.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___172_11187.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___172_11187.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___172_11187.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___172_11187.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___172_11187.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___172_11187.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___172_11187.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11188,FStar_Syntax_Syntax.Tm_refine uu____11189) ->
                   ...
                   solve_t env
                     (let uu___173_11210 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___173_11210.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___173_11210.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___173_11210.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___173_11210.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___173_11210.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___173_11210.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___173_11210.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___173_11210.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___173_11210.FStar_TypeChecker_Common.rank)
                      }) wl
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed
                  (t11,uu____11325,uu____11326),uu____11327) ->
                   solve_t' env
                     (let uu___174_11356 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___174_11356.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___174_11356.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___174_11356.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___174_11356.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___174_11356.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___174_11356.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___174_11356.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___174_11356.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___174_11356.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11359,FStar_Syntax_Syntax.Tm_ascribed
                  (t21,uu____11361,uu____11362)) ->
                   solve_t' env
                     (let uu___175_11391 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___175_11391.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___175_11391.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___175_11391.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___175_11391.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___175_11391.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___175_11391.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___175_11391.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___175_11391.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___175_11391.FStar_TypeChecker_Common.rank)
                      }) wl
                 ...
                 | (FStar_Syntax_Syntax.GTotal _,FStar_Syntax_Syntax.Comp _)
                   |(FStar_Syntax_Syntax.Total _,FStar_Syntax_Syntax.Comp _)
                     ...
                     let uu____11861 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___176_11864.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____11867;
                         FStar_TypeChecker_Common.relation =
                           (uu___176_11864.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___176_11864.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___176_11864.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___176_11864.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___176_11864.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___176_11864.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___176_11864.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___176_11864.FStar_TypeChecker_Common.rank)
                       } in
                 ...
                 | (FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.GTotal _)
                   |(FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.Total _)
                     ...
                     let uu____11873 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___177_11876.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___177_11876.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___177_11876.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____11879;
                         FStar_TypeChecker_Common.element =
                           (uu___177_11876.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___177_11876.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___177_11876.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___177_11876.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___177_11876.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___177_11876.FStar_TypeChecker_Common.rank)
                       } in
    ...
    fun probs  ->
      fun err  ->
        let probs1 =
          ...
          if uu____12146
          then
            let uu___178_12147 = probs in
            {
              attempting = (uu___178_12147.attempting);
              wl_deferred = (uu___178_12147.wl_deferred);
              ctr = (uu___178_12147.ctr);
              defer_ok = false;
              smt_ok = (uu___178_12147.smt_ok);
              tcenv = (uu___178_12147.tcenv)
            }
          else probs in
        let tx = FStar_Unionfind.new_transaction () in
          ...
          ((let uu____12169 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___179_12184 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___179_12184.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___179_12184.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___179_12184.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
    ...
    fun env  ->
      fun uu____12385  ->
        ...
        | (variables,ineqs) ->
            ...
            let uu____12487 =
              let wl =
                let uu___180_12490 = empty_worklist env in
                {
                  attempting = (uu___180_12490.attempting);
                  wl_deferred = (uu___180_12490.wl_deferred);
                  ctr = (uu___180_12490.ctr);
                  defer_ok = false;
                  smt_ok = (uu___180_12490.smt_ok);
                  tcenv = (uu___180_12490.tcenv)
                } in
  ...
  fun env  ->
    fun g  ->
      ...
      (let g1 =
         ...
         | Some [] ->
             let uu___181_12647 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___181_12647.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___181_12647.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___181_12647.FStar_TypeChecker_Env.implicits)
             }
         | uu____12650 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___182_12653 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___182_12653.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___182_12653.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___182_12653.FStar_TypeChecker_Env.implicits)
        }))
let discharge_guard':
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___183_12679 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___183_12679.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___183_12679.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___183_12679.FStar_TypeChecker_Env.implicits)
            } in
          let uu____12680 =
                      ...
                      (let env1 =
                       ...
                       (let uu____12862 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___184_12866 = env1 in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___184_12866.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___184_12866.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___184_12866.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___184_12866.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___184_12866.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___184_12866.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___184_12866.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___184_12866.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___184_12866.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___184_12866.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___184_12866.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___184_12866.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___184_12866.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___184_12866.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___184_12866.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___184_12866.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___184_12866.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___184_12866.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___184_12866.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___184_12866.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___184_12866.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___184_12866.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___184_12866.FStar_TypeChecker_Env.qname_and_index)
                             }) tm1 in
                        ...
                        | (uu____12867,uu____12868,g1) ->
                            let g2 =
                              ...
                              then
                                let uu___185_12871 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___185_12871.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___185_12871.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___185_12871.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____12874 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
    let uu___186_12893 = g in
    let uu____12894 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___186_12893.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___186_12893.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___186_12893.FStar_TypeChecker_Env.univ_ineqs);
...
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___187_12959 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___187_12959.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___187_12959.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___187_12959.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
