                                  ...
                                  (let g1 =
                                         ...
                                         (FStar_Pervasives_Native.Some
                                            (fun uu____29673  ->
                                               ...
                                               FStar_Util.format4
                                                 ...
                                                 uu____29674 uu____29676
                                                 reason uu____29678)) env2 g1
                                         true
                                        in
                                   ...
                                   until_fixpoint
                                     ((FStar_List.append
                                         ...
                                         out), true) tl1)))))
             in
          let uu___4048_29686 = g  in
          let uu____29687 =
            until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits  in
          {
            FStar_TypeChecker_Env.guard_f =
              (uu___4048_29686.FStar_TypeChecker_Env.guard_f);
            FStar_TypeChecker_Env.deferred =
              (uu___4048_29686.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___4048_29686.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits = uu____29687
          }
...
let (force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____29729 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____29729 (resolve_implicits env)  in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____29730 = discharge_guard env g1  in
          FStar_All.pipe_left (fun a2  -> ()) uu____29730
      | imp::uu____29732 ->
          let uu____29735 =
            let uu____29741 =
              let uu____29743 =
              ...
              FStar_Util.format3
                ...
                uu____29743 uu____29745 imp.FStar_TypeChecker_Env.imp_reason
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____29741)
             in
          FStar_Errors.raise_error uu____29735
...
let (teq_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____29767 = teq_nosmt env t1 t2  in
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___4070_29786 = FStar_TypeChecker_Env.trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___4070_29786.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___4070_29786.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___4070_29786.FStar_TypeChecker_Env.implicits)
      }
             ...
             let g =
               let uu____29853 =
                 solve_and_commit env (singleton wl prob true)
                   (fun uu____29864  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____29853  in
             ((let uu____29885 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____29892 =
                   FStar_TypeChecker_Normalize.term_to_string env t2  in
                 let uu____29894 =
                   let uu____29896 = FStar_Util.must g  in
                   guard_to_string env uu____29896  in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____29890 uu____29892 uu____29894
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
...
let (get_subtyping_predicate :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____29933 = check_subtyping env t1 t2  in
        match uu____29933 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____29952 =
              let uu____29953 = FStar_Syntax_Syntax.mk_binder x  in
              FStar_TypeChecker_Env.abstract_guard uu____29953 g  in
            FStar_Pervasives_Native.Some uu____29952
        ...
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____29991 =
              let uu____29992 =
                ...
                [uu____29993]  in
              FStar_TypeChecker_Env.close_guard env uu____29992 g  in
             ...
             let g =
               let uu____30058 =
                 solve_and_commit env (singleton wl prob false)
                  ...
                  in
               FStar_All.pipe_left (with_guard env prob) uu____30058  in
             (match g with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____30093 =
                      ...
                      [uu____30094]  in
                    FStar_TypeChecker_Env.close_guard env uu____30093 g1  in
...
let (subtype_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30135 = subtype_nosmt env t1 t2  in
