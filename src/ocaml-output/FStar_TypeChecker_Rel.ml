    ...
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_refine (x,uu____5202),uu____5203) ->
            let uu____5208 = head_matches env x.FStar_Syntax_Syntax.sort t21
               in
            FStar_All.pipe_right uu____5208 head_match
        | (uu____5209,FStar_Syntax_Syntax.Tm_refine (x,uu____5211)) ->
            let uu____5216 = head_matches env t11 x.FStar_Syntax_Syntax.sort
               in
                     ...
                     let uu____5446 =
                       let uu____5447 =
                         FStar_TypeChecker_Env.lookup_definition
                           ...
                           (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                          in
                       FStar_All.pipe_right uu____5447 FStar_Option.isSome
                        in
                     if uu____5446
                     then
                       let uu____5466 =
          ...
          let rec aux retry n_delta t11 t21 =
            ...
            | MisMatch
                (FStar_Pervasives_Native.Some d1,FStar_Pervasives_Native.Some
                 d2)
                when d1 = d2 ->
                let uu____5713 = FStar_TypeChecker_Common.decr_delta_depth d1
                   in
                        ...
                        let uu____7245 =
                          let uu____7254 =
                            FStar_List.map (sub_prob scope1 args) components1
                             in
                          FStar_All.pipe_right uu____7254 FStar_List.unzip
                           in
                        (match uu____7245 with
                         | (tcs,sub_probs) ->
                             let gi_xs =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Syntax.mk_Comp uu____7308
                                in
                             ((C gi_xs), sub_probs))
                    | uu____7331 ->
                             ...
                             | (sub_probs,tcs,f) ->
                                 let f1 =
                                   ...
                                   | FStar_Pervasives_Native.Some b ->
                                       ...
                                       FStar_Syntax_Util.mk_conj_l uu____7668
                                    in
                          ...
                          (match uu____8017 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8066 ->
                                    let rank =
                                      let uu____8074 = is_top_level_prob prob
                                         in
                                      if uu____8074
                                      then flex_refine
                     ...
                     (fun u3  ->
                        ...
                        | (k,uu____8527) ->
                            (match k with
                             ...
                             | uu____8537 -> false)))
            | uu____8538 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u])
             in
          let try_umax_components u12 u22 msg =
            ...
            | (FStar_Syntax_Syntax.U_max us1,FStar_Syntax_Syntax.U_max us2)
                ...
                then
                  ...
                  (let uu____8602 =
                     let uu____8603 = FStar_Syntax_Print.univ_to_string u12
                        in
                     let uu____8604 = FStar_Syntax_Print.univ_to_string u22
                        in
                     FStar_Util.format2
              ...
              then
                let uu____8721 =
                  ...
                  FStar_Util.format2 "Failed occurs check: %s occurs in %s"
                    uu____8722 uu____8723
                   in
                try_umax_components u11 u21 uu____8721
              else
                (let uu____8725 = extend_solution pid_orig [UNIV (v1, u3)] wl
                    in
                 USolved uu____8725)
          | (u,FStar_Syntax_Syntax.U_unif v1) ->
              ...
              then
                let uu____8746 =
                  ...
                  FStar_Util.format2 "Failed occurs check: %s occurs in %s"
                    uu____8747 uu____8748
                   in
                try_umax_components u11 u21 uu____8746
              else
                (let uu____8750 = extend_solution pid_orig [UNIV (v1, u3)] wl
                    in
                 USolved uu____8750)
          ...
          (match uu____8911 with
           | (bs2,mk_cod2) ->
               let curry n1 bs mk_cod =
                 ...
                 | (bs3,rest) ->
                     let uu____9006 = mk_cod rest  in (bs3, uu____9006)
                  in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____9392  ->
                          ...
                          | (c,uu____9400,uu____9401) -> c < probs.ctr))
                   in
        ...
        fun t2  ->
          fun wl  ->
            let rec aux wl1 us1 us2 =
              ...
              | ([],[]) -> USolved wl1
              | (u1::us11,u2::us21) ->
                  let uu____9566 = solve_universe_eq (p_pid orig) wl1 u1 u2
                     in
                   ...
                   (match mr with
                    ...
                    | HeadMatch  ->
                        let uu____9791 =
                          ...
                          | FStar_Pervasives_Native.None  ->
                              let uu____9812 = FStar_Syntax_Subst.compress t1
                                 in
                              let uu____9813 = FStar_Syntax_Subst.compress t2
                                 in
                                       ...
                                       let uu____10019 =
                                         let uu____10020 =
                                           FStar_Syntax_Util.un_uinst head1
                                            in
                                         uu____10020.FStar_Syntax_Syntax.n
                                          in
                             ...
                             (match tps with
                              ...
                              | (FStar_TypeChecker_Common.TProb hd1)::tl1 ->
                                  ...
                                  (match uu____10264 with
                                   ...
                                   | FStar_Pervasives_Native.None  ->
                                       FStar_Pervasives_Native.None)
                              | uu____10308 -> FStar_Pervasives_Native.None)
                          in
                       let uu____10317 =
                         let uu____10326 =
                           let uu____10333 =
             ...
             (match uu____10436 with
              | (ok,head_match1,partial_match,fallback,failed_match) ->
                  ...
                  let base_types_match t1 t2 =
                    ...
                    | (h1,args1) ->
                        let uu____10518 = FStar_Syntax_Util.head_and_args t2
                           in
                                          ...
                                          (match uu____10962 with
                                           | (u',uu____10978) ->
                                               let uu____10999 =
                                                 let uu____11000 =
                                                   whnf env u'  in
                                                 uu____11000.FStar_Syntax_Syntax.n
                                                  in
                    ...
                    (match uu____11446 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi1 =
                           ...
                           FStar_Syntax_Util.mk_conj uu____11484 uu____11489
                            in
                         ((let uu____11499 =
                             FStar_All.pipe_left
      ...
      fun wl  ->
              ...
              (match (m, o) with
               | (MisMatch uu____11622,uu____11623) ->
                   let rec may_relate head3 =
                     let uu____11648 =
                       let uu____11649 = FStar_Syntax_Subst.compress head3
                          in
                            ...
                            | FStar_Pervasives_Native.None  ->
                                ...
                                let uu____11758 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t11
                                    uu____11759 t21
                                   in
                                FStar_Syntax_Util.mk_forall u_x x uu____11758
                             in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
               ...
               | (uu____11781,FStar_Pervasives_Native.None ) ->
                   ((let uu____11793 =
                     ...
                     if uu____11793
                     then
                       let uu____11794 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____11795 = FStar_Syntax_Print.tag_of_term t1
                          in
                       let uu____11796 = FStar_Syntax_Print.term_to_string t2
                          in
                       let uu____11797 = FStar_Syntax_Print.tag_of_term t2
                          in
                       FStar_Util.print4
                    ...
                    (let uu____11799 = FStar_Syntax_Util.head_and_args t1  in
                     ...
                     | (head11,args1) ->
                         let uu____11836 = FStar_Syntax_Util.head_and_args t2
                            in
                                   ...
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____11902 =
                                        FStar_Syntax_Util.eq_args args1 args2
                                         in
                                      uu____11902 = FStar_Syntax_Util.Equal)
                                    in
                                 if uu____11896
                                 then
                                   let uu____11903 =
                       ...
                       | (t1,uu____12365) ->
                           let uu____12366 =
                             new_uvar t1.FStar_Syntax_Syntax.pos
                               pattern_vars1 t1
                              in
                           FStar_Pervasives_Native.fst uu____12366
                        in
                     let uu____12371 =
                      ...
                      | (t',tm_u1) ->
                          ...
                          (match uu____12384 with
                           | (uu____12421,u1,k1,uu____12424) ->
                               ...
                               let sol =
                                 let uu____12487 =
                                   let uu____12496 = u_abs k2 all_formals t'
                                      in
                                   ((u, k2), uu____12496)  in
                                 TERM uu____12487  in
                               let t_app =
                                     ...
                                     | (gi_xs,gi) ->
                                         ...
                                         (match uu____13507 with
                                          | (gi_xs',gi_ps') ->
                                              ...
                                              (uu____13534, uu____13538)))
                                 in
                              aux [] bs
                           in
                        let uu____13546 =
                          let uu____13547 = matches pi  in
                          FStar_All.pipe_left Prims.op_Negation uu____13547
                           in
                        if uu____13546
                        then FStar_Pervasives_Native.None
                        else
                          (let uu____13551 = gs xi.FStar_Syntax_Syntax.sort
                              in
                                 ...
                                 then
                                   let uu____13633 =
                                     FStar_Syntax_Print.term_to_string proj
                                      in
                                   let uu____13634 = prob_to_string env1 sub1
                                      in
                                   FStar_Util.print2
                                     "Projecting %s\n\tsubprob=%s\n"
        ...
        let solve_t_flex_rigid patterns_only orig lhs t2 wl1 =
          ...
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
              let subterms ps =
                let uu____13716 = FStar_Syntax_Util.arrow_formals_comp k_uv
                   in
                ...
                | (xs,c) ->
                    ...
                    then
                      ...
                      (let rec elim k args =
                         ...
                         let uu____13940 =
                           let uu____13947 =
                             let uu____13948 = FStar_Syntax_Subst.compress k1
                                in
                             ...
                             let uu____14666 =
                               let uu____14671 =
                                 ...
                                 FStar_Util.format3
                                   ...
                                   uu____14672 uu____14673 uu____14674
                                  in
                         ...
                         (fun uu____14736  ->
                            ...
                            | (xs1,c1) ->
                                let uu____14785 =
                                  ...
                                  (((uv, k_uv), xs1, c1), ps, uu____14826)
                                   in
                                FStar_Pervasives_Native.Some uu____14785))
                 in
                           ...
                           then
                             ((let uu____15079 =
                               ...
                               then
                                 ...
                                 let uu____15081 = names_to_string rhs_vars
                                    in
                                 let uu____15082 = names_to_string lhs_vars
                                    in
                                 FStar_Util.print3
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____15219 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____15220
                             in
                                ...
                                ((let uu____15229 =
                                  ...
                                  then
                                    let uu____15230 =
                                      FStar_Syntax_Print.term_to_string t11
                                       in
                                    let uu____15231 = names_to_string fvs1
                                       in
                                    let uu____15232 = names_to_string fvs2
                                       in
                                    FStar_Util.print3
                             ...
                             let uu____15766 =
                               let uu____15779 =
                                 FStar_TypeChecker_Normalize.normalize
                                  ...
                                  in
                               FStar_Syntax_Util.arrow_formals uu____15779
                                in
                                  ...
                                  (match uu____15816 with
                                   ...
                                   | uu____15843 ->
                                       ...
                                       (match uu____15848 with
                                        | (t,uu____15860) ->
                                            let uu____15861 = new_uvar r zs t
                                               in
             ...
             let solve_one_pat uu____16017 uu____16018 =
               ...
               | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                   ((let uu____16136 =
                     ...
                     if uu____16136
                     then
                       let uu____16137 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____16138 = FStar_Syntax_Print.term_to_string t2
                          in
                       FStar_Util.print2
                    ...
                    (let uu____16140 = FStar_Syntax_Unionfind.equiv u1 u2  in
                     ...
                     then
                       ...
                       (let t21 = sn env t2  in
                        ...
                        let uu____16215 = occurs_check env wl (u1, k1) t21
                           in
                             ...
                             (let uu____16365 =
                              ...
                              | FStar_Pervasives_Native.Some
                                  ...
                                  ((let uu____16390 =
                                    ...
                                    if uu____16390
                                    then
                                      let uu____16391 = uvi_to_string env sol
                                         in
                                      FStar_Util.print1
                     ...
                     | bs ->
                         let uu____16577 =
                           FStar_Syntax_Syntax.mk
                            ...
                            in
                         FStar_Syntax_Syntax.mk_Total uu____16577
                      in
                   let uu____16586 =
               ...
               | (FStar_Syntax_Syntax.Tm_abs uu____16987,uu____16988) ->
                            ...
                            (let uu___146_17085 = env  in
                             {
                               ...
                               FStar_TypeChecker_Env.check_type_of =
                                 (uu___146_17085.FStar_TypeChecker_Env.check_type_of);
                   ...
                   (match uu____17092 with
                    ...
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        if uu____17181
                        then
                          let uu____17182 = destruct_flex_pattern env not_abs
                             in
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____17221
                        then
                          let uu____17222 = destruct_flex_pattern env not_abs
                             in
               ...
               | (uu____17258,FStar_Syntax_Syntax.Tm_abs uu____17259) ->
                            ...
                            (let uu___146_17356 = env  in
                             {
                               ...
                               FStar_TypeChecker_Env.check_type_of =
                                 (uu___146_17356.FStar_TypeChecker_Env.check_type_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                   ...
                   (match uu____17363 with
                    ...
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        if uu____17452
                        then
                          let uu____17453 = destruct_flex_pattern env not_abs
                             in
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____17492
                        then
                          let uu____17493 = destruct_flex_pattern env not_abs
                             in
                               ...
                               let guard =
                                 let uu____17648 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst
                                    in
                                 FStar_Syntax_Util.mk_conj uu____17648 impl
                                  in
                               let wl1 =
                                 solve_prob orig
                   ...
                   then
                     ...
                     (if uu____18925
                      then
                        let guard =
                          let uu____18937 =
                            let uu____18938 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19053
                      then
                        let guard =
                          let uu____19065 =
                            let uu____19066 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19181
                      then
                        let guard =
                          let uu____19193 =
                            let uu____19194 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19309
                      then
                        let guard =
                          let uu____19321 =
                            let uu____19322 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19451
                      then
                        let guard =
                          let uu____19463 =
                            let uu____19464 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19601
                      then
                        let guard =
                          let uu____19613 =
                            let uu____19614 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____19991
                      then
                        let guard =
                          let uu____20003 =
                            let uu____20004 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                   ...
                   then
                     ...
                     (if uu____20261
                      then
                        let guard =
                          let uu____20273 =
                            let uu____20274 = FStar_Syntax_Util.eq_tm t1 t2
                               in
              ...
              let uu____20553 =
                let uu____20554 =
                  ...
                  (edge.FStar_TypeChecker_Env.mlift).FStar_TypeChecker_Env.mlift_wp
                    uu____20555 c11.FStar_Syntax_Syntax.result_typ wp
                   in
                   ...
                   let uu____20680 =
                     let uu____20685 =
                       ...
                       FStar_Util.format2
                         ...
                         uu____20686 uu____20687
                        in
                     (FStar_Errors.Fatal_ExpectNormalizedEffect, uu____20685)
                      in
                                  ...
                                  (let c1_univ =
                                   ...
                                   let uu____20778 =
                                     let uu____20781 =
                                       ...
                                       FStar_Syntax_Syntax.Tm_app uu____20782
                                        in
                                 ...
                                 (let c1_univ =
                                  ...
                                  let uu____20815 =
                                    let uu____20818 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_app uu____20819
                                       in
                                    FStar_Syntax_Syntax.mk uu____20818  in
                                  uu____20815 FStar_Pervasives_Native.None r)
                              in
                           let base_prob =
                             let uu____20854 =
        ...
        FStar_All.pipe_right (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu____21270  ->
                ...
                | (u1,u2) ->
                    let uu____21277 = FStar_Syntax_Print.univ_to_string u1
                       in
                    let uu____21278 = FStar_Syntax_Print.univ_to_string u2
                       in
                    FStar_Util.format2 "%s < %s" uu____21277 uu____21278))
         in
          ...
          (let prob =
             let uu____21632 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____21637
                in
             FStar_All.pipe_left
           ...
           let g =
             let uu____21645 =
               ...
               solve_and_commit env uu____21648
                 (fun uu____21650  -> FStar_Pervasives_Native.None)
                in
         ...
         let prob =
           let uu____21722 =
             ...
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____21727 "sub_comp"
              in
           FStar_All.pipe_left
             (fun _0_97  -> FStar_TypeChecker_Common.CProb _0_97) uu____21722
            in
         let uu____21732 =
           let uu____21735 = singleton env prob  in
           solve_and_commit env uu____21735
             (fun uu____21737  -> FStar_Pervasives_Native.None)
            in
        ...
        | (variables,ineqs) ->
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____21876 = FStar_Syntax_Subst.compress_univ v1
                         in
          ...
          then FStar_Pervasives_Native.Some ret_g
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 (if debug1
                  then
                    (let uu____22342 = FStar_TypeChecker_Env.get_range env
                        in
                     let uu____22343 =
                       let uu____22344 = FStar_Syntax_Print.term_to_string vc
                          in
                  ...
                  (let vc1 =
                   ...
                   if debug1
                   then
                     (let uu____22348 = FStar_TypeChecker_Env.get_range env
                         in
                      let uu____22349 =
                        let uu____22350 =
                    ...
                    | FStar_TypeChecker_Common.NonTrivial vc2 ->
                        ...
                        then
                          ...
                          (if debug1
                           ...
                           (let vcs =
                              let uu____22379 = FStar_Options.use_tactics ()
                                 in
                              if uu____22379
                              then
                                ...
                                (let uu____22402 =
                                   let uu____22409 = FStar_Options.peek ()
                                      in
                                    ...
                                    | (env1,goal,opts) ->
                                        let goal1 =
                                          FStar_TypeChecker_Normalize.normalize
                                            ...
                                            env1 goal
                                           in
                                        let uu____22454 = check_trivial goal1
                                           in
                        ...
                        then until_fixpoint ((hd1 :: out), changed) tl1
                          ...
                          (let tm1 =
                           ...
                           let env1 =
                             if forcelax
                             then
                               let uu___166_22668 = env  in
                               {
                                 FStar_TypeChecker_Env.solver =
                                   (uu___166_22668.FStar_TypeChecker_Env.solver);
                                 FStar_TypeChecker_Env.range =
                                   (uu___166_22668.FStar_TypeChecker_Env.range);
                                 FStar_TypeChecker_Env.curmodule =
                                   (uu___166_22668.FStar_TypeChecker_Env.curmodule);
                                 FStar_TypeChecker_Env.gamma =
                                   (uu___166_22668.FStar_TypeChecker_Env.gamma);
                                 FStar_TypeChecker_Env.gamma_cache =
                                   (uu___166_22668.FStar_TypeChecker_Env.gamma_cache);
                                 FStar_TypeChecker_Env.modules =
                                   (uu___166_22668.FStar_TypeChecker_Env.modules);
                                 FStar_TypeChecker_Env.expected_typ =
                                   (uu___166_22668.FStar_TypeChecker_Env.expected_typ);
                                 FStar_TypeChecker_Env.sigtab =
                                   (uu___166_22668.FStar_TypeChecker_Env.sigtab);
                                 FStar_TypeChecker_Env.is_pattern =
                                   (uu___166_22668.FStar_TypeChecker_Env.is_pattern);
                                 FStar_TypeChecker_Env.instantiate_imp =
                                   (uu___166_22668.FStar_TypeChecker_Env.instantiate_imp);
                                 FStar_TypeChecker_Env.effects =
                                   (uu___166_22668.FStar_TypeChecker_Env.effects);
                                 FStar_TypeChecker_Env.generalize =
                                   (uu___166_22668.FStar_TypeChecker_Env.generalize);
                                 FStar_TypeChecker_Env.letrecs =
                                   (uu___166_22668.FStar_TypeChecker_Env.letrecs);
                                 FStar_TypeChecker_Env.top_level =
                                   (uu___166_22668.FStar_TypeChecker_Env.top_level);
                                 FStar_TypeChecker_Env.check_uvars =
                                   (uu___166_22668.FStar_TypeChecker_Env.check_uvars);
                                 FStar_TypeChecker_Env.use_eq =
                                   (uu___166_22668.FStar_TypeChecker_Env.use_eq);
                                 FStar_TypeChecker_Env.is_iface =
                                   (uu___166_22668.FStar_TypeChecker_Env.is_iface);
                                 FStar_TypeChecker_Env.admit =
                                   (uu___166_22668.FStar_TypeChecker_Env.admit);
                                 FStar_TypeChecker_Env.lax = true;
                                 FStar_TypeChecker_Env.lax_universes =
                                   (uu___166_22668.FStar_TypeChecker_Env.lax_universes);
                                 FStar_TypeChecker_Env.failhard =
                                   (uu___166_22668.FStar_TypeChecker_Env.failhard);
                                 FStar_TypeChecker_Env.nosynth =
                                   (uu___166_22668.FStar_TypeChecker_Env.nosynth);
                                 FStar_TypeChecker_Env.tc_term =
                                   (uu___166_22668.FStar_TypeChecker_Env.tc_term);
                                 FStar_TypeChecker_Env.type_of =
                                   (uu___166_22668.FStar_TypeChecker_Env.type_of);
                                 FStar_TypeChecker_Env.universe_of =
                                   (uu___166_22668.FStar_TypeChecker_Env.universe_of);
                                 FStar_TypeChecker_Env.check_type_of =
                                   (uu___166_22668.FStar_TypeChecker_Env.check_type_of);
                                 FStar_TypeChecker_Env.use_bv_sorts =
                                   (uu___166_22668.FStar_TypeChecker_Env.use_bv_sorts);
                                 FStar_TypeChecker_Env.qname_and_index =
                                   (uu___166_22668.FStar_TypeChecker_Env.qname_and_index);
                                 FStar_TypeChecker_Env.proof_ns =
                                   (uu___166_22668.FStar_TypeChecker_Env.proof_ns);
                                 FStar_TypeChecker_Env.synth =
                                   (uu___166_22668.FStar_TypeChecker_Env.synth);
                                 FStar_TypeChecker_Env.is_native_tactic =
                                   (uu___166_22668.FStar_TypeChecker_Env.is_native_tactic);
                                 FStar_TypeChecker_Env.identifier_info =
                                   (uu___166_22668.FStar_TypeChecker_Env.identifier_info);
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___166_22668.FStar_TypeChecker_Env.tc_hooks);
                                 FStar_TypeChecker_Env.dsenv =
                                   (uu___166_22668.FStar_TypeChecker_Env.dsenv);
                                 FStar_TypeChecker_Env.dep_graph =
                                   (uu___166_22668.FStar_TypeChecker_Env.dep_graph)
                               }
                             else env  in
                           (let uu____22671 =
                              FStar_All.pipe_left
                           ...
                           (let g1 =
                            ...
                            let g2 =
                              ...
                              then
                                let uu___167_22678 = g1  in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___167_22678.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___167_22678.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___167_22678.FStar_TypeChecker_Env.implicits)
                                }
                              else g1  in
                            let g' =
                              let uu____22681 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1))))
           in
        let uu___168_22715 = g  in
        let uu____22716 =
          until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits  in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___168_22715.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___168_22715.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs =
            (uu___168_22715.FStar_TypeChecker_Env.univ_ineqs);
...
let (force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____22770 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____22770 resolve_implicits  in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____22783 = discharge_guard env g1  in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____22783
      | (reason,uu____22785,uu____22786,e,t,r)::uu____22790 ->
          let uu____22817 =
            let uu____22822 =
              let uu____22823 = FStar_Syntax_Print.term_to_string t  in
              let uu____22824 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format2
                "Failed to resolve implicit argument of type '%s' introduced in %s"
                uu____22823 uu____22824
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____22822)
             in
          FStar_Errors.raise_error uu____22817 r
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___169_22831 = trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___169_22831.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___169_22831.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___169_22831.FStar_TypeChecker_Env.implicits)
      }
...
let (discharge_guard_nosmt :
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.Some uu____22859 -> true
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____22893 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2
            in
         match uu____22893 with
         | (prob,x) ->
             let g =
               let uu____22909 =
                 let uu____22912 = singleton' env prob true  in
                 solve_and_commit env uu____22912
                   (fun uu____22914  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____22909  in
             ((let uu____22924 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____22926 =
                   FStar_TypeChecker_Normalize.term_to_string env t2  in
                 let uu____22927 =
                   let uu____22928 = FStar_Util.must g  in
                   guard_to_string env uu____22928  in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____22925 uu____22926 uu____22927
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
...
let (get_subtyping_predicate :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22956 = check_subtyping env t1 t2  in
        match uu____22956 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____22975 =
              let uu____22976 = FStar_Syntax_Syntax.mk_binder x  in
              abstract_guard uu____22976 g  in
...
let (get_subtyping_prop :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22988 = check_subtyping env t1 t2  in
        ...
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____23007 =
              let uu____23008 =
                ...
                [uu____23009]  in
              close_guard env uu____23008 g  in
            FStar_Pervasives_Native.Some uu____23007
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____23024 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2
            in
         match uu____23024 with
         | (prob,x) ->
             let g =
               let uu____23034 =
                 let uu____23037 = singleton' env prob false  in
                 solve_and_commit env uu____23037
                   (fun uu____23039  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____23034  in
             (match g with
              | FStar_Pervasives_Native.None  -> false
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____23050 =
                      let uu____23051 = FStar_Syntax_Syntax.mk_binder x  in
                      [uu____23051]  in
                    close_guard env uu____23050 g1  in
