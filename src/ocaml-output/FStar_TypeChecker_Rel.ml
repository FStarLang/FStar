           ...
           (let uu____27105 =
            ...
            | (c11, c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 | (FStar_Syntax_Syntax.GTotal uu____27241,
                    FStar_Syntax_Syntax.Comp uu____27242) ->
                     let uu____27251 =
                 ...
                 | (FStar_Syntax_Syntax.Total uu____27259,
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27277,
                    FStar_Syntax_Syntax.GTotal uu____27278) ->
                     let uu____27287 =
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27295,
                    FStar_Syntax_Syntax.Total uu____27296) ->
                     let uu____27305 =
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27313,
                    FStar_Syntax_Syntax.Comp uu____27314) ->
                     let uu____27315 =
          ...
          (FStar_List.map
             (fun uu____27480 ->
                ...
                | (u1, u2) ->
                    ...
                    let uu____27490 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____27488 uu____27490)) in
               ...
               | Success (deferred, implicits) ->
                   let uu____27881 =
                     FStar_Util.record_time
                       (fun uu____27888 -> FStar_Syntax_Unionfind.commit tx) in
                   (match uu____27881 with
                    | ((), ms1) ->
                        ((let uu____27899 =
                          ...
                          if uu____27899
                          then
                            let uu____27904 = FStar_Util.string_of_int ms1 in
    ...
    fun prob ->
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some (deferred, implicits) ->
              ...
              let uu____28037 =
                let uu____28038 =
                  FStar_All.pipe_right (p_guard prob)
                    (fun _28039 -> FStar_TypeChecker_Common.NonTrivial _28039) in
                {
            ...
            FStar_All.pipe_left
              (fun _28046 -> FStar_Pervasives_Native.Some _28046) uu____28036
      ...
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____28079 =
              let uu____28080 =
                FStar_All.pipe_right (p_guard prob)
                  (fun _28081 -> FStar_TypeChecker_Common.NonTrivial _28081) in
              {
               ...
               let g =
                 let uu____28139 =
                   solve_and_commit env (singleton wl prob smt_ok)
                     (fun uu____28149 -> FStar_Pervasives_Native.None) in
      ...
      fun c2 ->
        ...
        (let uu____28282 =
           ...
           new_problem (empty_worklist env) env c1 rel c2
             FStar_Pervasives_Native.None uu____28289 "sub_comp" in
              ...
              (let uu____28302 =
                   ...
                   (fun uu____28314 ->
                      let uu____28315 =
                        solve_and_commit env (singleton wl prob1 true)
                          (fun uu____28326 -> FStar_Pervasives_Native.None) in
                      FStar_All.pipe_left (with_guard env prob1) uu____28315) in
               ...
               | (r, ms) ->
                   ((let uu____28357 =
                     ...
                     if uu____28357
                     then
                       let uu____28362 = FStar_Syntax_Print.comp_to_string c1 in
                       let uu____28364 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        | (variables, ineqs) ->
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1 ->
                      let uu____28531 = FStar_Syntax_Subst.compress_univ v1 in
            ...
            let rec check_ineq uu____28651 =
              ...
              | (u, v1) ->
                  ...
                  (match (u1, v2) with
                   ...
                   | (FStar_Syntax_Syntax.U_name uu____28687,
                      FStar_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif uu____28689,
                      FStar_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
          ...
          then FStar_Pervasives_Native.Some ret_g
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 (if debug1
                  then
                    (let uu____29153 = FStar_TypeChecker_Env.get_range env in
                     let uu____29154 =
                       let uu____29156 = FStar_Syntax_Print.term_to_string vc in
                  ...
                  (let vc1 =
                   ...
                   if debug1
                   then
                     (let uu____29164 = FStar_TypeChecker_Env.get_range env in
                      let uu____29165 =
                        let uu____29167 =
                   ...
                   (let uu____29175 = FStar_TypeChecker_Env.check_trivial vc1 in
                    ...
                    | FStar_TypeChecker_Common.NonTrivial vc2 ->
                        ...
                        then
                          ...
                          (if debug1
                           ...
                           (let vcs =
                              let uu____29214 = FStar_Options.use_tactics () in
                              if uu____29214
                              then
                                ...
                                (let uu____29301 =
                                   let uu____29308 = FStar_Options.peek () in
                                   ...
                                   ((let uu____29620 =
                                    ...
                                    (let t =
                                       env1.FStar_TypeChecker_Env.synth_hook
                                         ...
                                         tau in
                                     let extra =
                                       let uu____29633 = teq_nosmt env1 t tm in
          ...
          let uu____29818 =
            let uu____29824 =
              ...
              FStar_Util.format3
                ...
                uu____29826 uu____29828 imp.FStar_TypeChecker_Env.imp_reason in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____29824) in
             ...
             let g =
               let uu____30141 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____30152 -> FStar_Pervasives_Native.None) in
