...
let (singleton :
  ...
  fun wl  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___158_1844 = wl  in
        {
          attempting = [prob];
          wl_deferred = (uu___158_1844.wl_deferred);
          ctr = (uu___158_1844.ctr);
          defer_ok = (uu___158_1844.defer_ok);
          smt_ok;
          tcenv = (uu___158_1844.tcenv);
          wl_implicits = (uu___158_1844.wl_implicits)
        }
...
let wl_of_guard :
  ...
  fun env  ->
    fun g  ->
      let uu___159_1874 = empty_worklist env  in
      let uu____1875 = FStar_List.map FStar_Pervasives_Native.snd g  in
      {
        attempting = uu____1875;
        wl_deferred = (uu___159_1874.wl_deferred);
        ctr = (uu___159_1874.ctr);
        defer_ok = (uu___159_1874.defer_ok);
        smt_ok = (uu___159_1874.smt_ok);
        tcenv = (uu___159_1874.tcenv);
        wl_implicits = (uu___159_1874.wl_implicits)
      }
...
let (defer :
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___160_1895 = wl  in
        {
          attempting = (uu___160_1895.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___160_1895.ctr);
          defer_ok = (uu___160_1895.defer_ok);
          smt_ok = (uu___160_1895.smt_ok);
          tcenv = (uu___160_1895.tcenv);
          wl_implicits = (uu___160_1895.wl_implicits)
        }
...
let (attempt :
  ...
  fun probs  ->
    fun wl  ->
      ...
      (let uu___161_1917 = wl  in
       {
         attempting = (FStar_List.append probs wl.attempting);
         wl_deferred = (uu___161_1917.wl_deferred);
         ctr = (uu___161_1917.ctr);
         defer_ok = (uu___161_1917.defer_ok);
         smt_ok = (uu___161_1917.smt_ok);
         tcenv = (uu___161_1917.tcenv);
         wl_implicits = (uu___161_1917.wl_implicits)
       })
                ...
                fun reason  ->
                  ...
                  let uu____2425 =
                    ...
                    new_uvar
                      ...
                      (let uu___162_2440 = wl  in
                       {
                         attempting = (uu___162_2440.attempting);
                         wl_deferred = (uu___162_2440.wl_deferred);
                         ctr = (uu___162_2440.ctr);
                         defer_ok = (uu___162_2440.defer_ok);
                         smt_ok = (uu___162_2440.smt_ok);
                         tcenv = env;
                         wl_implicits = (uu___162_2440.wl_implicits)
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____2831  ->
              ...
              | (x,imp) ->
                  let uu____2842 =
                    let uu___163_2843 = x  in
                    let uu____2844 = sn env x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___163_2843.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___163_2843.FStar_Syntax_Syntax.index);
            ...
            (let phi =
             ...
             let wl1 =
               ...
               then (if resolve_ok then wl else (fail1 (); wl))
                ...
                in
             commit uvis;
             (let uu___164_5034 = wl1  in
              {
                attempting = (uu___164_5034.attempting);
                wl_deferred = (uu___164_5034.wl_deferred);
                ctr = (wl1.ctr + (Prims.parse_int "1"));
                defer_ok = (uu___164_5034.defer_ok);
                smt_ok = (uu___164_5034.smt_ok);
                tcenv = (uu___164_5034.tcenv);
                wl_implicits = (uu___164_5034.wl_implicits)
              }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___165_5065 = wl  in
         {
           attempting = (uu___165_5065.attempting);
           wl_deferred = (uu___165_5065.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___165_5065.defer_ok);
           smt_ok = (uu___165_5065.smt_ok);
           tcenv = (uu___165_5065.tcenv);
           wl_implicits = (uu___165_5065.wl_implicits)
         })
...
let (compress_tprob :
  ...
  fun tcenv  ->
    fun p  ->
      let uu___166_7645 = p  in
      let uu____7648 = whnf tcenv p.FStar_TypeChecker_Common.lhs  in
      let uu____7649 = whnf tcenv p.FStar_TypeChecker_Common.rhs  in
      {
        FStar_TypeChecker_Common.pid =
          (uu___166_7645.FStar_TypeChecker_Common.pid);
        FStar_TypeChecker_Common.lhs = uu____7648;
        FStar_TypeChecker_Common.relation =
          (uu___166_7645.FStar_TypeChecker_Common.relation);
        FStar_TypeChecker_Common.rhs = uu____7649;
        FStar_TypeChecker_Common.element =
          (uu___166_7645.FStar_TypeChecker_Common.element);
        FStar_TypeChecker_Common.logical_guard =
          (uu___166_7645.FStar_TypeChecker_Common.logical_guard);
        FStar_TypeChecker_Common.logical_guard_uvar =
          (uu___166_7645.FStar_TypeChecker_Common.logical_guard_uvar);
        FStar_TypeChecker_Common.reason =
          (uu___166_7645.FStar_TypeChecker_Common.reason);
        FStar_TypeChecker_Common.loc =
          (uu___166_7645.FStar_TypeChecker_Common.loc);
        FStar_TypeChecker_Common.rank =
          (uu___166_7645.FStar_TypeChecker_Common.rank)
      }
  ...
  fun tcenv  ->
    fun pr  ->
                      ...
                      | (FStar_Syntax_Syntax.Tm_uvar
                         uu____7934,FStar_Syntax_Syntax.Tm_arrow uu____7935)
                          ...
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                            (let uu___167_7965 = tp  in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___167_7965.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___167_7965.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___167_7965.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___167_7965.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___167_7965.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.logical_guard_uvar =
                                 (uu___167_7965.FStar_TypeChecker_Common.logical_guard_uvar);
                               FStar_TypeChecker_Common.reason =
                                 (uu___167_7965.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___167_7965.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___167_7965.FStar_TypeChecker_Common.rank)
                             }))
                      | (FStar_Syntax_Syntax.Tm_uvar
                         uu____7968,FStar_Syntax_Syntax.Tm_type uu____7969)
                          ->
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                            (let uu___167_7987 = tp  in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___167_7987.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___167_7987.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___167_7987.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___167_7987.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___167_7987.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.logical_guard_uvar =
                                 (uu___167_7987.FStar_TypeChecker_Common.logical_guard_uvar);
                               FStar_TypeChecker_Common.reason =
                                 (uu___167_7987.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___167_7987.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___167_7987.FStar_TypeChecker_Common.rank)
                             }))
                      | (FStar_Syntax_Syntax.Tm_type
                         uu____7990,FStar_Syntax_Syntax.Tm_uvar uu____7991)
                          ->
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                            (let uu___167_8009 = tp  in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___167_8009.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___167_8009.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___167_8009.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___167_8009.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___167_8009.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.logical_guard_uvar =
                                 (uu___167_8009.FStar_TypeChecker_Common.logical_guard_uvar);
                               FStar_TypeChecker_Common.reason =
                                 (uu___167_8009.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___167_8009.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___167_8009.FStar_TypeChecker_Common.rank)
                             }))
                     ...
                     | (rank,tp1) ->
                         let uu____8080 =
                           FStar_All.pipe_right
                             (let uu___168_8084 = tp1  in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___168_8084.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___168_8084.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___168_8084.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___168_8084.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___168_8084.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___168_8084.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.logical_guard_uvar =
                                  (uu___168_8084.FStar_TypeChecker_Common.logical_guard_uvar);
                                FStar_TypeChecker_Common.reason =
                                  (uu___168_8084.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___168_8084.FStar_TypeChecker_Common.loc);
                                FStar_TypeChecker_Common.rank =
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____8090 =
            FStar_All.pipe_right
              (let uu___169_8094 = cp  in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___169_8094.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___169_8094.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___169_8094.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___169_8094.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___169_8094.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___169_8094.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.logical_guard_uvar =
                   (uu___169_8094.FStar_TypeChecker_Common.logical_guard_uvar);
                 FStar_TypeChecker_Common.reason =
                   (uu___169_8094.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___169_8094.FStar_TypeChecker_Common.loc);
                 FStar_TypeChecker_Common.rank =
                   (FStar_Pervasives_Native.Some
                ...
                (match uu____9816 with
                 | FStar_Syntax_Syntax.Tm_name x ->
                     ...
                     then
                       ...
                       (let x1 =
                          let uu___170_9856 = x  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___170_9856.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___170_9856.FStar_Syntax_Syntax.index);
                        ...
                        let t_res1 = FStar_Syntax_Subst.subst subst1 t_res
                           in
                        aux
                          (((let uu___171_9880 = x1  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___171_9880.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___171_9880.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort =
                                 (formal.FStar_Syntax_Syntax.sort)
    ...
    fun probs  ->
      ...
      (let uu____10292 = next_prob probs  in
       ...
       | FStar_Pervasives_Native.Some (hd1,tl1,rank1) ->
           let probs1 =
             let uu___172_10319 = probs  in
             {
               attempting = tl1;
               wl_deferred = (uu___172_10319.wl_deferred);
               ctr = (uu___172_10319.ctr);
               defer_ok = (uu___172_10319.defer_ok);
               smt_ok = (uu___172_10319.smt_ok);
               tcenv = (uu___172_10319.tcenv);
               wl_implicits = (uu___172_10319.wl_implicits)
             }  in
                 ...
                 then
                   ...
                   then solve_t' env tp probs1
                     ...
                     then
                       ...
                       then
                         solve_t' env
                           (let uu___173_10333 = tp  in
                            {
                              FStar_TypeChecker_Common.pid =
                                (uu___173_10333.FStar_TypeChecker_Common.pid);
                              FStar_TypeChecker_Common.lhs =
                                (uu___173_10333.FStar_TypeChecker_Common.lhs);
                              FStar_TypeChecker_Common.relation =
                                FStar_TypeChecker_Common.EQ;
                              FStar_TypeChecker_Common.rhs =
                                (uu___173_10333.FStar_TypeChecker_Common.rhs);
                              FStar_TypeChecker_Common.element =
                                (uu___173_10333.FStar_TypeChecker_Common.element);
                              FStar_TypeChecker_Common.logical_guard =
                                (uu___173_10333.FStar_TypeChecker_Common.logical_guard);
                              FStar_TypeChecker_Common.logical_guard_uvar =
                                (uu___173_10333.FStar_TypeChecker_Common.logical_guard_uvar);
                              FStar_TypeChecker_Common.reason =
                                (uu___173_10333.FStar_TypeChecker_Common.reason);
                              FStar_TypeChecker_Common.loc =
                                (uu___173_10333.FStar_TypeChecker_Common.loc);
                              FStar_TypeChecker_Common.rank =
                                (uu___173_10333.FStar_TypeChecker_Common.rank)
                            }) probs1
                       else
                      ...
                      | uu____10507 ->
                          let uu____10516 =
                               ...
                               in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___174_10517.ctr);
                              defer_ok = (uu___174_10517.defer_ok);
                              smt_ok = (uu___174_10517.smt_ok);
                              tcenv = (uu___174_10517.tcenv);
                              wl_implicits = (uu___174_10517.wl_implicits)
                            }  in
                                                     ...
                                                     (FStar_Syntax_Unionfind.commit
                                                      ...
                                                      FStar_Pervasives_Native.Some
                                                        ((let uu___176_11275
                                                          ...
                                                          {
                                                            attempting =
                                                              (uu___176_11275.attempting);
                                                            wl_deferred =
                                                              (uu___176_11275.wl_deferred);
                                                            ctr =
                                                              (uu___176_11275.ctr);
                                                            defer_ok =
                                                              (uu___176_11275.defer_ok);
                                                            smt_ok =
                                                              (uu___176_11275.smt_ok);
                                                            tcenv =
                                                              (uu___176_11275.tcenv);
                                                            wl_implicits =
                                                              (FStar_List.append
                                                                 wl4.wl_implicits
                                                                 imps)
                ...
                | FStar_Syntax_Syntax.Tm_arrow (_bs,comp) ->
                    ...
                    then
                      ...
                      (let uu____12015 =
                         attempt
                           [FStar_TypeChecker_Common.TProb
                              ((let uu___177_12018 = tp  in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___177_12018.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs =
                                    (uu___177_12018.FStar_TypeChecker_Common.lhs);
                                  FStar_TypeChecker_Common.relation =
                                    FStar_TypeChecker_Common.EQ;
                                  FStar_TypeChecker_Common.rhs =
                                    (uu___177_12018.FStar_TypeChecker_Common.rhs);
                                  FStar_TypeChecker_Common.element =
                                    (uu___177_12018.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___177_12018.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.logical_guard_uvar
                                    =
                                    (uu___177_12018.FStar_TypeChecker_Common.logical_guard_uvar);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___177_12018.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___177_12018.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___177_12018.FStar_TypeChecker_Common.rank)
                                }))] wl
                          in
                                          ...
                                          | (bound_typ,(eq_prob,wl')) ->
                                              (def_check_prob "meet_or_join2"
                                                  ...
                                                  let wl'1 =
                                                       ...
                                                       in
                                                    {
                                                      attempting =
                                                        ...
                                                        sub_probs);
                                                      wl_deferred =
                                                        (uu___178_12322.wl_deferred);
                                                      ctr =
                                                        (uu___178_12322.ctr);
                                                      defer_ok =
                                                        (uu___178_12322.defer_ok);
                                                      smt_ok =
                                                        (uu___178_12322.smt_ok);
                                                      tcenv =
                                                        (uu___178_12322.tcenv);
                                                      wl_implicits =
                                                        (uu___178_12322.wl_implicits)
                                                    }  in
                                                  let uu____12323 =
                                               ...
                                               (let tx =
                                                ...
                                                let uu____12326 =
                                                  solve_t env eq_prob
                                                    (let uu___179_12328 = wl'
                                                        in
                                                     {
                                                       attempting = sub_probs;
                                                       wl_deferred =
                                                         (uu___179_12328.wl_deferred);
                                                       ctr =
                                                         (uu___179_12328.ctr);
                                                       defer_ok = false;
                                                       smt_ok =
                                                         (uu___179_12328.smt_ok);
                                                       tcenv =
                                                         (uu___179_12328.tcenv);
                                                       wl_implicits =
                                                         (uu___179_12328.wl_implicits)
                                                     })
                                                   in
                                                ...
                                                | Success uu____12329 ->
                                                    let wl2 =
                                                        ...
                                                        wl'  in
                                                      {
                                                        attempting = rest;
                                                        wl_deferred =
                                                          (uu___180_12335.wl_deferred);
                                                        ctr =
                                                          (uu___180_12335.ctr);
                                                        defer_ok =
                                                          (uu___180_12335.defer_ok);
                                                        smt_ok =
                                                          (uu___180_12335.smt_ok);
                                                        tcenv =
                                                          (uu___180_12335.tcenv);
                                                        wl_implicits =
                                                          (uu___180_12335.wl_implicits)
                                                      }  in
                                                    let g =
                                                      FStar_List.fold_left
                                                        (fun g  ->
                                 ...
                                 let ct' =
                                      ...
                                      in
                                   {
                                     FStar_Syntax_Syntax.comp_univs =
                                       (uu___181_12961.FStar_Syntax_Syntax.comp_univs);
                                     FStar_Syntax_Syntax.effect_name =
                                       (uu___181_12961.FStar_Syntax_Syntax.effect_name);
                                     FStar_Syntax_Syntax.result_typ =
                                       uu____12962;
                                     FStar_Syntax_Syntax.effect_args =
                                       uu____12974;
                                     FStar_Syntax_Syntax.flags =
                                       (uu___181_12961.FStar_Syntax_Syntax.flags)
                                   }  in
                                 ((let uu___182_12988 = c  in
                                   {
                                     FStar_Syntax_Syntax.n =
                                       (FStar_Syntax_Syntax.Comp ct');
                                     FStar_Syntax_Syntax.pos =
                                       (uu___182_12988.FStar_Syntax_Syntax.pos);
                                     FStar_Syntax_Syntax.vars =
                                       (uu___182_12988.FStar_Syntax_Syntax.vars)
                                   }), wl2))
                         in
                      let uu____12991 =
              ...
              (let rec aux wl1 scope env1 subst1 xs ys =
                 ...
                 | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                     let hd11 =
                       ...
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___183_13352.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___183_13352.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = uu____13353
                       }  in
                     let hd21 =
                       let uu___184_13357 = hd2  in
                       let uu____13358 =
                         FStar_Syntax_Subst.subst subst1
                       ...
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___184_13357.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___184_13357.FStar_Syntax_Syntax.index);
                                     ...
                                     | uu____15121 ->
                                         ...
                                         let rhs =
                                           force_refinement
                                            ...
                                            in
                                         solve_t env1
                                           (let uu___185_15161 = problem  in
                                            {
                                              FStar_TypeChecker_Common.pid =
                                                (uu___185_15161.FStar_TypeChecker_Common.pid);
                                              FStar_TypeChecker_Common.lhs =
                                                lhs;
                                              FStar_TypeChecker_Common.relation
                                                =
                                                (uu___185_15161.FStar_TypeChecker_Common.relation);
                                              FStar_TypeChecker_Common.rhs =
                                                rhs;
                                              FStar_TypeChecker_Common.element
                                                =
                                                (uu___185_15161.FStar_TypeChecker_Common.element);
                                              FStar_TypeChecker_Common.logical_guard
                                                =
                                                (uu___185_15161.FStar_TypeChecker_Common.logical_guard);
                                              FStar_TypeChecker_Common.logical_guard_uvar
                                                =
                                                (uu___185_15161.FStar_TypeChecker_Common.logical_guard_uvar);
                                              FStar_TypeChecker_Common.reason
                                                =
                                                (uu___185_15161.FStar_TypeChecker_Common.reason);
                                              FStar_TypeChecker_Common.loc =
                                                (uu___185_15161.FStar_TypeChecker_Common.loc);
                                              FStar_TypeChecker_Common.rank =
                                                (uu___185_15161.FStar_TypeChecker_Common.rank)
                                            }) wl1))))))
            in
            ...
            | (m,o) ->
                (match (m, o) with
                 ...
                 | (uu____15396,FStar_Pervasives_Native.Some (t11,t21)) ->
                     solve_t env1
                       (let uu___186_15410 = problem  in
                        {
                          FStar_TypeChecker_Common.pid =
                            (uu___186_15410.FStar_TypeChecker_Common.pid);
                          FStar_TypeChecker_Common.lhs = t11;
                          FStar_TypeChecker_Common.relation =
                            (uu___186_15410.FStar_TypeChecker_Common.relation);
                          FStar_TypeChecker_Common.rhs = t21;
                          FStar_TypeChecker_Common.element =
                            (uu___186_15410.FStar_TypeChecker_Common.element);
                          FStar_TypeChecker_Common.logical_guard =
                            (uu___186_15410.FStar_TypeChecker_Common.logical_guard);
                          FStar_TypeChecker_Common.logical_guard_uvar =
                            (uu___186_15410.FStar_TypeChecker_Common.logical_guard_uvar);
                          FStar_TypeChecker_Common.reason =
                            (uu___186_15410.FStar_TypeChecker_Common.reason);
                          FStar_TypeChecker_Common.loc =
                            (uu___186_15410.FStar_TypeChecker_Common.loc);
                          FStar_TypeChecker_Common.rank =
                            (uu___186_15410.FStar_TypeChecker_Common.rank)
                        }) wl1
            ...
            (let t1 = problem.FStar_TypeChecker_Common.lhs  in
             ...
             (let r = FStar_TypeChecker_Env.get_range env  in
              ...
              | (FStar_Syntax_Syntax.Tm_ascribed uu____15534,uu____15535) ->
                  let uu____15562 =
                    let uu___187_15563 = problem  in
                    let uu____15564 = FStar_Syntax_Util.unascribe t1  in
                    {
                      FStar_TypeChecker_Common.pid =
                        (uu___187_15563.FStar_TypeChecker_Common.pid);
                      FStar_TypeChecker_Common.lhs = uu____15564;
                      FStar_TypeChecker_Common.relation =
                        (uu___187_15563.FStar_TypeChecker_Common.relation);
                      FStar_TypeChecker_Common.rhs =
                        (uu___187_15563.FStar_TypeChecker_Common.rhs);
                      FStar_TypeChecker_Common.element =
                        (uu___187_15563.FStar_TypeChecker_Common.element);
                      FStar_TypeChecker_Common.logical_guard =
                        (uu___187_15563.FStar_TypeChecker_Common.logical_guard);
                      FStar_TypeChecker_Common.logical_guard_uvar =
                        (uu___187_15563.FStar_TypeChecker_Common.logical_guard_uvar);
                      FStar_TypeChecker_Common.reason =
                        (uu___187_15563.FStar_TypeChecker_Common.reason);
                      FStar_TypeChecker_Common.loc =
                        (uu___187_15563.FStar_TypeChecker_Common.loc);
                      FStar_TypeChecker_Common.rank =
                        (uu___187_15563.FStar_TypeChecker_Common.rank)
                    }  in
                  solve_t' env uu____15562 wl
              | (FStar_Syntax_Syntax.Tm_meta uu____15565,uu____15566) ->
                  let uu____15573 =
                    let uu___188_15574 = problem  in
                    let uu____15575 = FStar_Syntax_Util.unmeta t1  in
                    {
                      FStar_TypeChecker_Common.pid =
                        (uu___188_15574.FStar_TypeChecker_Common.pid);
                      FStar_TypeChecker_Common.lhs = uu____15575;
                      FStar_TypeChecker_Common.relation =
                        (uu___188_15574.FStar_TypeChecker_Common.relation);
                      FStar_TypeChecker_Common.rhs =
                        (uu___188_15574.FStar_TypeChecker_Common.rhs);
                      FStar_TypeChecker_Common.element =
                        (uu___188_15574.FStar_TypeChecker_Common.element);
                      FStar_TypeChecker_Common.logical_guard =
                        (uu___188_15574.FStar_TypeChecker_Common.logical_guard);
                      FStar_TypeChecker_Common.logical_guard_uvar =
                        (uu___188_15574.FStar_TypeChecker_Common.logical_guard_uvar);
                      FStar_TypeChecker_Common.reason =
                        (uu___188_15574.FStar_TypeChecker_Common.reason);
                      FStar_TypeChecker_Common.loc =
                        (uu___188_15574.FStar_TypeChecker_Common.loc);
                      FStar_TypeChecker_Common.rank =
                        (uu___188_15574.FStar_TypeChecker_Common.rank)
                    }  in
                  solve_t' env uu____15573 wl
              | (uu____15576,FStar_Syntax_Syntax.Tm_ascribed uu____15577) ->
                  let uu____15604 =
                    let uu___189_15605 = problem  in
                    let uu____15606 = FStar_Syntax_Util.unascribe t2  in
                    {
                      FStar_TypeChecker_Common.pid =
                        (uu___189_15605.FStar_TypeChecker_Common.pid);
                      FStar_TypeChecker_Common.lhs =
                        (uu___189_15605.FStar_TypeChecker_Common.lhs);
                      FStar_TypeChecker_Common.relation =
                        (uu___189_15605.FStar_TypeChecker_Common.relation);
                      FStar_TypeChecker_Common.rhs = uu____15606;
                      FStar_TypeChecker_Common.element =
                        (uu___189_15605.FStar_TypeChecker_Common.element);
                      FStar_TypeChecker_Common.logical_guard =
                        (uu___189_15605.FStar_TypeChecker_Common.logical_guard);
                      FStar_TypeChecker_Common.logical_guard_uvar =
                        (uu___189_15605.FStar_TypeChecker_Common.logical_guard_uvar);
                      FStar_TypeChecker_Common.reason =
                        (uu___189_15605.FStar_TypeChecker_Common.reason);
                      FStar_TypeChecker_Common.loc =
                        (uu___189_15605.FStar_TypeChecker_Common.loc);
                      FStar_TypeChecker_Common.rank =
                        (uu___189_15605.FStar_TypeChecker_Common.rank)
                    }  in
                  solve_t' env uu____15604 wl
              | (uu____15607,FStar_Syntax_Syntax.Tm_meta uu____15608) ->
                  let uu____15615 =
                    let uu___190_15616 = problem  in
                    let uu____15617 = FStar_Syntax_Util.unmeta t2  in
                    {
                      FStar_TypeChecker_Common.pid =
                        (uu___190_15616.FStar_TypeChecker_Common.pid);
                      FStar_TypeChecker_Common.lhs =
                        (uu___190_15616.FStar_TypeChecker_Common.lhs);
                      FStar_TypeChecker_Common.relation =
                        (uu___190_15616.FStar_TypeChecker_Common.relation);
                      FStar_TypeChecker_Common.rhs = uu____15617;
                      FStar_TypeChecker_Common.element =
                        (uu___190_15616.FStar_TypeChecker_Common.element);
                      FStar_TypeChecker_Common.logical_guard =
                        (uu___190_15616.FStar_TypeChecker_Common.logical_guard);
                      FStar_TypeChecker_Common.logical_guard_uvar =
                        (uu___190_15616.FStar_TypeChecker_Common.logical_guard_uvar);
                      FStar_TypeChecker_Common.reason =
                        (uu___190_15616.FStar_TypeChecker_Common.reason);
                      FStar_TypeChecker_Common.loc =
                        (uu___190_15616.FStar_TypeChecker_Common.loc);
                      FStar_TypeChecker_Common.rank =
                        (uu___190_15616.FStar_TypeChecker_Common.rank)
                    }  in
              ...
              | (FStar_Syntax_Syntax.Tm_arrow
                 (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                  let mk_c c uu___144_15693 =
                    match uu___144_15693 with
                    | [] -> c
                    | bs ->
                        let uu____15715 =
                          FStar_Syntax_Syntax.mk
              ...
              | (FStar_Syntax_Syntax.Tm_abs
                 ...
                 (bs2,tbody2,lopt2)) ->
                  let mk_t t l uu___145_15922 =
                    match uu___145_15922 with
                    | [] -> t
                    | bs ->
                        FStar_Syntax_Syntax.mk
              ...
              | (FStar_Syntax_Syntax.Tm_abs uu____16077,uu____16078) ->
                    ...
                    then t
                      ...
                      (let uu____16175 =
                         env.FStar_TypeChecker_Env.type_of
                           (let uu___191_16183 = env  in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___191_16183.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___191_16183.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___191_16183.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___191_16183.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_sig =
                                (uu___191_16183.FStar_TypeChecker_Env.gamma_sig);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___191_16183.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___191_16183.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                FStar_Pervasives_Native.None;
                              FStar_TypeChecker_Env.sigtab =
                                (uu___191_16183.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___191_16183.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___191_16183.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___191_16183.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___191_16183.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___191_16183.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___191_16183.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___191_16183.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___191_16183.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___191_16183.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___191_16183.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___191_16183.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___191_16183.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___191_16183.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.uvar_subtyping =
                                (uu___191_16183.FStar_TypeChecker_Env.uvar_subtyping);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___191_16183.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___191_16183.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___191_16183.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___191_16183.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts = true;
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___191_16183.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.normalized_eff_names =
                                (uu___191_16183.FStar_TypeChecker_Env.normalized_eff_names);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___191_16183.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth_hook =
                                (uu___191_16183.FStar_TypeChecker_Env.synth_hook);
                              FStar_TypeChecker_Env.splice =
                                (uu___191_16183.FStar_TypeChecker_Env.splice);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___191_16183.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___191_16183.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___191_16183.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___191_16183.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___191_16183.FStar_TypeChecker_Env.dep_graph)
                            }) t
                          in
                  ...
                  (match uu____16190 with
                   | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                       solve_t env
                         (let uu___192_16256 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___192_16256.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t11;
                            FStar_TypeChecker_Common.relation =
                              (uu___192_16256.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t21;
                            FStar_TypeChecker_Common.element =
                              (uu___192_16256.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___192_16256.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.logical_guard_uvar =
                              (uu___192_16256.FStar_TypeChecker_Common.logical_guard_uvar);
                            FStar_TypeChecker_Common.reason =
                              (uu___192_16256.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___192_16256.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___192_16256.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                       ...
                       then
                         ...
                         (let t11 = force_eta t1  in
                          ...
                          then
                            solve_t env
                              (let uu___193_16293 = problem  in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___193_16293.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t11;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___193_16293.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t21;
                                 FStar_TypeChecker_Common.element =
                                   (uu___193_16293.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___193_16293.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.logical_guard_uvar
                                   =
                                   (uu___193_16293.FStar_TypeChecker_Common.logical_guard_uvar);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___193_16293.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___193_16293.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___193_16293.FStar_TypeChecker_Common.rank)
                               }) wl
                          else
                            giveup env
                   ...
                   | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                       ...
                       then
                         ...
                         (let t11 = force_eta t1  in
                          ...
                          then
                            solve_t env
                              (let uu___193_16331 = problem  in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___193_16331.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t11;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___193_16331.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t21;
                                 FStar_TypeChecker_Common.element =
                                   (uu___193_16331.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___193_16331.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.logical_guard_uvar
                                   =
                                   (uu___193_16331.FStar_TypeChecker_Common.logical_guard_uvar);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___193_16331.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___193_16331.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___193_16331.FStar_TypeChecker_Common.rank)
                               }) wl
                          else
                            giveup env
                              "head tag mismatch: RHS is an abstraction" orig)
              ...
              | (uu____16350,FStar_Syntax_Syntax.Tm_abs uu____16351) ->
                  ...
                  let force_eta t =
                    ...
                    then t
                      ...
                      (let uu____16448 =
                         env.FStar_TypeChecker_Env.type_of
                           (let uu___191_16456 = env  in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___191_16456.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___191_16456.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___191_16456.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___191_16456.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_sig =
                                (uu___191_16456.FStar_TypeChecker_Env.gamma_sig);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___191_16456.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___191_16456.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                FStar_Pervasives_Native.None;
                              FStar_TypeChecker_Env.sigtab =
                                (uu___191_16456.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___191_16456.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___191_16456.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___191_16456.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___191_16456.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___191_16456.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___191_16456.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___191_16456.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___191_16456.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___191_16456.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___191_16456.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___191_16456.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.failhard =
                                (uu___191_16456.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___191_16456.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.uvar_subtyping =
                                (uu___191_16456.FStar_TypeChecker_Env.uvar_subtyping);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___191_16456.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___191_16456.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___191_16456.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___191_16456.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts = true;
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___191_16456.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.normalized_eff_names =
                                (uu___191_16456.FStar_TypeChecker_Env.normalized_eff_names);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___191_16456.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth_hook =
                                (uu___191_16456.FStar_TypeChecker_Env.synth_hook);
                              FStar_TypeChecker_Env.splice =
                                (uu___191_16456.FStar_TypeChecker_Env.splice);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___191_16456.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___191_16456.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___191_16456.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___191_16456.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___191_16456.FStar_TypeChecker_Env.dep_graph)
                            }) t
                          in
                  ...
                  (match uu____16463 with
                   | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                       solve_t env
                         (let uu___192_16529 = problem  in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___192_16529.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t11;
                            FStar_TypeChecker_Common.relation =
                              (uu___192_16529.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t21;
                            FStar_TypeChecker_Common.element =
                              (uu___192_16529.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___192_16529.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.logical_guard_uvar =
                              (uu___192_16529.FStar_TypeChecker_Common.logical_guard_uvar);
                            FStar_TypeChecker_Common.reason =
                              (uu___192_16529.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___192_16529.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___192_16529.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                       let uu____16550 =
                         (is_flex not_abs) &&
                       ...
                       then
                         ...
                         (let t11 = force_eta t1  in
                          ...
                          then
                            solve_t env
                              (let uu___193_16566 = problem  in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___193_16566.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t11;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___193_16566.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t21;
                                 FStar_TypeChecker_Common.element =
                                   (uu___193_16566.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___193_16566.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.logical_guard_uvar
                                   =
                                   (uu___193_16566.FStar_TypeChecker_Common.logical_guard_uvar);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___193_16566.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___193_16566.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___193_16566.FStar_TypeChecker_Common.rank)
                               }) wl
                          else
                            giveup env
                              "head tag mismatch: RHS is an abstraction" orig)
                   | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                       ...
                       then
                         ...
                         (let t11 = force_eta t1  in
                          ...
                          then
                            solve_t env
                              (let uu___193_16604 = problem  in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___193_16604.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t11;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___193_16604.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t21;
                                 FStar_TypeChecker_Common.element =
                                   (uu___193_16604.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___193_16604.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.logical_guard_uvar
                                   =
                                   (uu___193_16604.FStar_TypeChecker_Common.logical_guard_uvar);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___193_16604.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___193_16604.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___193_16604.FStar_TypeChecker_Common.rank)
                               }) wl
                          else
                            giveup env
                              "head tag mismatch: RHS is an abstraction" orig)
                      ...
                      (let uu____16649 =
                       ...
                       | MisMatch
                           (FStar_Pervasives_Native.Some
                            d1,FStar_Pervasives_Native.Some d2)
                           ->
                           let is_unfoldable uu___146_16661 =
                             match uu___146_16661 with
                                 ...
                                 then
                                   ...
                                   (match uu____16823 with
                                    | (ref_prob,wl2) ->
                                        let uu____16844 =
                                          solve env1
                                            (let uu___194_16846 = wl2  in
                                             {
                                               attempting = [ref_prob];
                                               wl_deferred = [];
                                               ctr = (uu___194_16846.ctr);
                                               defer_ok = false;
                                               smt_ok =
                                                 (uu___194_16846.smt_ok);
                                               tcenv = (uu___194_16846.tcenv);
                                               wl_implicits =
                                                 (uu___194_16846.wl_implicits)
                                             })
                                           in
                                         ...
                                         | Success uu____16856 ->
                                             ...
                                             let wl3 =
                                               solve_prob orig
                                                ...
                                                in
                                             let wl4 =
                                               let uu___195_16873 = wl3  in
                                               {
                                                 attempting =
                                                   (uu___195_16873.attempting);
                                                 wl_deferred =
                                                   (uu___195_16873.wl_deferred);
                                                 ctr =
                                                   (wl3.ctr +
                                                      (Prims.parse_int "1"));
                                                 defer_ok =
                                                   (uu___195_16873.defer_ok);
                                                 smt_ok =
                                                   (uu___195_16873.smt_ok);
                                                 tcenv =
                                                   (uu___195_16873.tcenv);
                                                 wl_implicits =
                                                   (uu___195_16873.wl_implicits)
                                               }  in
                                             let uu____16874 =
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ...
                 uu____17302) ->
                  solve_t' env
                    (let uu___196_17350 = problem  in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___196_17350.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___196_17350.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         FStar_TypeChecker_Common.EQ;
                       FStar_TypeChecker_Common.rhs =
                         (uu___196_17350.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___196_17350.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___196_17350.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.logical_guard_uvar =
                         (uu___196_17350.FStar_TypeChecker_Common.logical_guard_uvar);
                       FStar_TypeChecker_Common.reason =
                         (uu___196_17350.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___196_17350.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___196_17350.FStar_TypeChecker_Common.rank)
                     }) wl
              ...
              | (FStar_Syntax_Syntax.Tm_refine uu____17465,uu____17466) ->
                  ...
                  solve_t env
                    (let uu___197_17500 = problem  in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___197_17500.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___197_17500.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___197_17500.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = t21;
                       FStar_TypeChecker_Common.element =
                         (uu___197_17500.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___197_17500.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.logical_guard_uvar =
                         (uu___197_17500.FStar_TypeChecker_Common.logical_guard_uvar);
                       FStar_TypeChecker_Common.reason =
                         (uu___197_17500.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___197_17500.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___197_17500.FStar_TypeChecker_Common.rank)
                     }) wl
              | (uu____17501,FStar_Syntax_Syntax.Tm_refine uu____17502) ->
                  ...
                  solve_t env
                    (let uu___198_17536 = problem  in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___198_17536.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = t11;
                       FStar_TypeChecker_Common.relation =
                         (uu___198_17536.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___198_17536.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___198_17536.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___198_17536.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.logical_guard_uvar =
                         (uu___198_17536.FStar_TypeChecker_Common.logical_guard_uvar);
                       FStar_TypeChecker_Common.reason =
                         (uu___198_17536.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___198_17536.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___198_17536.FStar_TypeChecker_Common.rank)
                     }) wl
              | (FStar_Syntax_Syntax.Tm_match
                       ...
                       (match uu____18322 with
                        | (sc_prob,wl2) ->
                            ...
                            let uu____18348 =
                              let uu____18349 =
                                attempt sub_probs1
                                  (let uu___199_18351 = wl3  in
                                   {
                                     attempting = (uu___199_18351.attempting);
                                     wl_deferred =
                                       (uu___199_18351.wl_deferred);
                                     ctr = (uu___199_18351.ctr);
                                     defer_ok = (uu___199_18351.defer_ok);
                                     smt_ok = false;
                                     tcenv = (uu___199_18351.tcenv);
                                     wl_implicits =
                                       (uu___199_18351.wl_implicits)
                                   })
                                 in
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu____21016,FStar_Syntax_Syntax.Comp uu____21017) ->
                     let uu____21026 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___200_21029.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21032;
                         FStar_TypeChecker_Common.relation =
                           (uu___200_21029.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___200_21029.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___200_21029.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___200_21029.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.logical_guard_uvar =
                           (uu___200_21029.FStar_TypeChecker_Common.logical_guard_uvar);
                         FStar_TypeChecker_Common.reason =
                           (uu___200_21029.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___200_21029.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___200_21029.FStar_TypeChecker_Common.rank)
                       }  in
                     solve_c env uu____21026 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____21034,FStar_Syntax_Syntax.Comp uu____21035) ->
                     let uu____21044 =
                       let uu___200_21047 = problem  in
                       let uu____21050 =
                         let uu____21051 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11  in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___200_21047.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____21050;
                         FStar_TypeChecker_Common.relation =
                           (uu___200_21047.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___200_21047.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___200_21047.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___200_21047.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.logical_guard_uvar =
                           (uu___200_21047.FStar_TypeChecker_Common.logical_guard_uvar);
                         FStar_TypeChecker_Common.reason =
                           (uu___200_21047.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___200_21047.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___200_21047.FStar_TypeChecker_Common.rank)
                       }  in
                     solve_c env uu____21044 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21052,FStar_Syntax_Syntax.GTotal uu____21053) ->
                     let uu____21062 =
                       let uu___201_21065 = problem  in
                       let uu____21068 =
                         let uu____21069 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___201_21065.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___201_21065.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___201_21065.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21068;
                         FStar_TypeChecker_Common.element =
                           (uu___201_21065.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___201_21065.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.logical_guard_uvar =
                           (uu___201_21065.FStar_TypeChecker_Common.logical_guard_uvar);
                         FStar_TypeChecker_Common.reason =
                           (uu___201_21065.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___201_21065.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___201_21065.FStar_TypeChecker_Common.rank)
                       }  in
                     solve_c env uu____21062 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____21070,FStar_Syntax_Syntax.Total uu____21071) ->
                     let uu____21080 =
                       let uu___201_21083 = problem  in
                       let uu____21086 =
                         let uu____21087 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21  in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___201_21083.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___201_21083.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___201_21083.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____21086;
                         FStar_TypeChecker_Common.element =
                           (uu___201_21083.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___201_21083.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.logical_guard_uvar =
                           (uu___201_21083.FStar_TypeChecker_Common.logical_guard_uvar);
                         FStar_TypeChecker_Common.reason =
                           (uu___201_21083.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___201_21083.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___201_21083.FStar_TypeChecker_Common.rank)
                       }  in
          ...
          ((let uu____21575 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___202_21590 = g  in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___202_21590.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___202_21590.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___202_21590.FStar_TypeChecker_Env.implicits)
             })))
    ...
    fun env  ->
      fun uu____22005  ->
        ...
        | (variables,ineqs) ->
            ...
            let uu____22192 =
              let wl =
                let uu___203_22196 = empty_worklist env  in
                {
                  attempting = (uu___203_22196.attempting);
                  wl_deferred = (uu___203_22196.wl_deferred);
                  ctr = (uu___203_22196.ctr);
                  defer_ok = false;
                  smt_ok = (uu___203_22196.smt_ok);
                  tcenv = (uu___203_22196.tcenv);
                  wl_implicits = (uu___203_22196.wl_implicits)
                }  in
    ...
    fun env  ->
      fun g  ->
        ...
        let wl =
          ...
          {
            attempting = (uu___204_22439.attempting);
            wl_deferred = (uu___204_22439.wl_deferred);
            ctr = (uu___204_22439.ctr);
            defer_ok;
            smt_ok = (uu___204_22439.smt_ok);
            tcenv = (uu___204_22439.tcenv);
            wl_implicits = (uu___204_22439.wl_implicits)
          }  in
        (let uu____22441 =
           FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
             (FStar_Options.Other "Rel")
        ...
        (let g1 =
           ...
           | FStar_Pervasives_Native.Some (deferred,imps) ->
               let uu___205_22489 = g  in
               {
                 FStar_TypeChecker_Env.guard_f =
                   (uu___205_22489.FStar_TypeChecker_Env.guard_f);
                 FStar_TypeChecker_Env.deferred = deferred;
                 FStar_TypeChecker_Env.univ_ineqs =
                   (uu___205_22489.FStar_TypeChecker_Env.univ_ineqs);
                 FStar_TypeChecker_Env.implicits =
         ...
         (let uu___206_22506 = g1  in
          {
            FStar_TypeChecker_Env.guard_f =
              (uu___206_22506.FStar_TypeChecker_Env.guard_f);
            FStar_TypeChecker_Env.deferred =
              (uu___206_22506.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs = ([], []);
            FStar_TypeChecker_Env.implicits =
              (uu___206_22506.FStar_TypeChecker_Env.implicits)
          }))
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___207_22677 = g1  in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___207_22677.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___207_22677.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___207_22677.FStar_TypeChecker_Env.implicits)
            }  in
          let uu____22678 =
                            ...
                            (let uu____23051 = unresolved ctx_u  in
                             ...
                             then until_fixpoint ((hd1 :: out), changed) tl1
                               ...
                               then until_fixpoint (out, true) tl1
                                 ...
                                 (let env1 =
                                    let uu___208_23063 = env  in
                                    {
                                      FStar_TypeChecker_Env.solver =
                                        (uu___208_23063.FStar_TypeChecker_Env.solver);
                                      FStar_TypeChecker_Env.range =
                                        (uu___208_23063.FStar_TypeChecker_Env.range);
                                      FStar_TypeChecker_Env.curmodule =
                                        (uu___208_23063.FStar_TypeChecker_Env.curmodule);
                                      FStar_TypeChecker_Env.gamma =
                                        (ctx_u.FStar_Syntax_Syntax.ctx_uvar_gamma);
                                      FStar_TypeChecker_Env.gamma_sig =
                                        (uu___208_23063.FStar_TypeChecker_Env.gamma_sig);
                                      FStar_TypeChecker_Env.gamma_cache =
                                        (uu___208_23063.FStar_TypeChecker_Env.gamma_cache);
                                      FStar_TypeChecker_Env.modules =
                                        (uu___208_23063.FStar_TypeChecker_Env.modules);
                                      FStar_TypeChecker_Env.expected_typ =
                                        (uu___208_23063.FStar_TypeChecker_Env.expected_typ);
                                      FStar_TypeChecker_Env.sigtab =
                                        (uu___208_23063.FStar_TypeChecker_Env.sigtab);
                                      FStar_TypeChecker_Env.is_pattern =
                                        (uu___208_23063.FStar_TypeChecker_Env.is_pattern);
                                      FStar_TypeChecker_Env.instantiate_imp =
                                        (uu___208_23063.FStar_TypeChecker_Env.instantiate_imp);
                                      FStar_TypeChecker_Env.effects =
                                        (uu___208_23063.FStar_TypeChecker_Env.effects);
                                      FStar_TypeChecker_Env.generalize =
                                        (uu___208_23063.FStar_TypeChecker_Env.generalize);
                                      FStar_TypeChecker_Env.letrecs =
                                        (uu___208_23063.FStar_TypeChecker_Env.letrecs);
                                      FStar_TypeChecker_Env.top_level =
                                        (uu___208_23063.FStar_TypeChecker_Env.top_level);
                                      FStar_TypeChecker_Env.check_uvars =
                                        (uu___208_23063.FStar_TypeChecker_Env.check_uvars);
                                      FStar_TypeChecker_Env.use_eq =
                                        (uu___208_23063.FStar_TypeChecker_Env.use_eq);
                                      FStar_TypeChecker_Env.is_iface =
                                        (uu___208_23063.FStar_TypeChecker_Env.is_iface);
                                      FStar_TypeChecker_Env.admit =
                                        (uu___208_23063.FStar_TypeChecker_Env.admit);
                                      FStar_TypeChecker_Env.lax =
                                        (uu___208_23063.FStar_TypeChecker_Env.lax);
                                      FStar_TypeChecker_Env.lax_universes =
                                        (uu___208_23063.FStar_TypeChecker_Env.lax_universes);
                                      FStar_TypeChecker_Env.failhard =
                                        (uu___208_23063.FStar_TypeChecker_Env.failhard);
                                      FStar_TypeChecker_Env.nosynth =
                                        (uu___208_23063.FStar_TypeChecker_Env.nosynth);
                                      FStar_TypeChecker_Env.uvar_subtyping =
                                        (uu___208_23063.FStar_TypeChecker_Env.uvar_subtyping);
                                      FStar_TypeChecker_Env.tc_term =
                                        (uu___208_23063.FStar_TypeChecker_Env.tc_term);
                                      FStar_TypeChecker_Env.type_of =
                                        (uu___208_23063.FStar_TypeChecker_Env.type_of);
                                      FStar_TypeChecker_Env.universe_of =
                                        (uu___208_23063.FStar_TypeChecker_Env.universe_of);
                                      FStar_TypeChecker_Env.check_type_of =
                                        (uu___208_23063.FStar_TypeChecker_Env.check_type_of);
                                      FStar_TypeChecker_Env.use_bv_sorts =
                                        (uu___208_23063.FStar_TypeChecker_Env.use_bv_sorts);
                                      FStar_TypeChecker_Env.qtbl_name_and_index
                                        =
                                        (uu___208_23063.FStar_TypeChecker_Env.qtbl_name_and_index);
                                      FStar_TypeChecker_Env.normalized_eff_names
                                        =
                                        (uu___208_23063.FStar_TypeChecker_Env.normalized_eff_names);
                                      FStar_TypeChecker_Env.proof_ns =
                                        (uu___208_23063.FStar_TypeChecker_Env.proof_ns);
                                      FStar_TypeChecker_Env.synth_hook =
                                        (uu___208_23063.FStar_TypeChecker_Env.synth_hook);
                                      FStar_TypeChecker_Env.splice =
                                        (uu___208_23063.FStar_TypeChecker_Env.splice);
                                      FStar_TypeChecker_Env.is_native_tactic
                                        =
                                        (uu___208_23063.FStar_TypeChecker_Env.is_native_tactic);
                                      FStar_TypeChecker_Env.identifier_info =
                                        (uu___208_23063.FStar_TypeChecker_Env.identifier_info);
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___208_23063.FStar_TypeChecker_Env.tc_hooks);
                                      FStar_TypeChecker_Env.dsenv =
                                        (uu___208_23063.FStar_TypeChecker_Env.dsenv);
                                      FStar_TypeChecker_Env.dep_graph =
                                        (uu___208_23063.FStar_TypeChecker_Env.dep_graph)
                                    }  in
                                  let tm1 =
                                    FStar_TypeChecker_Normalize.normalize
                                  ...
                                  let env2 =
                                    if forcelax
                                    then
                                      let uu___209_23066 = env1  in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___209_23066.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___209_23066.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___209_23066.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___209_23066.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_sig =
                                          (uu___209_23066.FStar_TypeChecker_Env.gamma_sig);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___209_23066.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___209_23066.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___209_23066.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___209_23066.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.is_pattern =
                                          (uu___209_23066.FStar_TypeChecker_Env.is_pattern);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___209_23066.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___209_23066.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___209_23066.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___209_23066.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___209_23066.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___209_23066.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___209_23066.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___209_23066.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax = true;
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___209_23066.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___209_23066.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___209_23066.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.uvar_subtyping
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.uvar_subtyping);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___209_23066.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___209_23066.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___209_23066.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.check_type_of =
                                          (uu___209_23066.FStar_TypeChecker_Env.check_type_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          (uu___209_23066.FStar_TypeChecker_Env.use_bv_sorts);
                                        FStar_TypeChecker_Env.qtbl_name_and_index
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.qtbl_name_and_index);
                                        FStar_TypeChecker_Env.normalized_eff_names
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.normalized_eff_names);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___209_23066.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth_hook =
                                          (uu___209_23066.FStar_TypeChecker_Env.synth_hook);
                                        FStar_TypeChecker_Env.splice =
                                          (uu___209_23066.FStar_TypeChecker_Env.splice);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___209_23066.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___209_23066.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___209_23066.FStar_TypeChecker_Env.dsenv);
                                        FStar_TypeChecker_Env.dep_graph =
                                          (uu___209_23066.FStar_TypeChecker_Env.dep_graph)
                                      }
                                    else env1  in
                                  (let uu____23069 =
                                     FStar_All.pipe_left
                                  ...
                                  (let g1 =
                                   ...
                                   let g2 =
                                     ...
                                     then
                                       let uu___212_23117 = g1  in
                                       {
                                         FStar_TypeChecker_Env.guard_f =
                                           FStar_TypeChecker_Common.Trivial;
                                         FStar_TypeChecker_Env.deferred =
                                           (uu___212_23117.FStar_TypeChecker_Env.deferred);
                                         FStar_TypeChecker_Env.univ_ineqs =
                                           (uu___212_23117.FStar_TypeChecker_Env.univ_ineqs);
                                         FStar_TypeChecker_Env.implicits =
                                           (uu___212_23117.FStar_TypeChecker_Env.implicits)
                                       }
                                     else g1  in
                                   let g' =
                                     let uu____23120 =
                                   ...
                                   until_fixpoint
                                     ((FStar_List.append
                                         ...
                                         out), true) tl1)))))
             in
          let uu___213_23143 = g  in
          let uu____23144 =
            until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits  in
          {
            FStar_TypeChecker_Env.guard_f =
              (uu___213_23143.FStar_TypeChecker_Env.guard_f);
            FStar_TypeChecker_Env.deferred =
              (uu___213_23143.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___213_23143.FStar_TypeChecker_Env.univ_ineqs);
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___214_23245 = trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___214_23245.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___214_23245.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___214_23245.FStar_TypeChecker_Env.implicits)
      }
