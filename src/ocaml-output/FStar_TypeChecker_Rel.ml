      ...
      | FStar_TypeChecker_Common.TProb p ->
          let uu___1 =
            ...
            let uu___3 =
              ...
              let uu___5 =
                let uu___6 =
                  let uu___7 = term_to_string p.FStar_TypeChecker_Common.rhs
                     in
                  [uu___7]  in
                (rel_to_string p.FStar_TypeChecker_Common.relation) :: uu___6
                 in
              uu___4 :: uu___5  in
            uu___2 :: uu___3  in
          FStar_Util.format "\n%s:\t%s \n\t\t%s\n\t%s\n" uu___1
    ...
    let uu___ =
      FStar_All.pipe_right args
        (FStar_List.map
           (fun uu___1  ->
              match uu___1 with
              | (x,uu___2) -> FStar_Syntax_Print.term_to_string x))
       in
    FStar_All.pipe_right uu___ (FStar_String.concat " ")
      ...
      | FStar_TypeChecker_Common.TProb p ->
          let uu___ =
            ...
            | FStar_Pervasives_Native.Some x ->
                let uu___1 = FStar_Syntax_Syntax.mk_binder x  in [uu___1]
             in
          FStar_List.append
...
let (def_check_prob : Prims.string -> FStar_TypeChecker_Common.prob -> unit)
  ...
  fun msg  ->
    fun prob  ->
      let uu___ =
        let uu___1 = FStar_Options.defensive ()  in Prims.op_Negation uu___1
         in
      if uu___
      then ()
      else
                    ...
                    | FStar_Pervasives_Native.Some x ->
                        ...
                        let uu___ =
                          FStar_Syntax_Syntax.mk_Total
                            FStar_Syntax_Util.ktype0
                           in
                        FStar_Syntax_Util.arrow bs uu___
                     in
                  let uu___ =
                  ...
                  | (ctx_uvar,lg,wl1) ->
                      let lg1 =
                        ...
                        | FStar_Pervasives_Native.Some x ->
                            let uu___1 =
                              let uu___2 =
                                let uu___3 = FStar_Syntax_Syntax.bv_to_name x
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.as_arg uu___3
                                 in
                              [uu___2]  in
                            FStar_Syntax_Syntax.mk_Tm_app lg uu___1 loc
                         in
                      let prob =
                        let uu___1 = next_pid ()  in
                        {
      ...
      let uu___ =
        let uu___1 =
          ...
          FStar_TypeChecker_Normalize.normalize
            ...
            FStar_TypeChecker_Env.HNF] env uu___2
           in
      ...
      let uu___1 =
        let uu___2 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu___3  -> match uu___3 with | (uu___4,uu___5,x) -> x))
           in
    ...
    fun ys  ->
      fun t  ->
        let uu___ =
          ...
          | uu___2 ->
              let uu___3 =
                let uu___4 = FStar_Syntax_Syntax.mk_Total k  in ([], uu___4)
                 in
              ((ys, t), uu___3)
           in
        match uu___ with
               ...
               (let phi2 =
                ...
                (let uu___3 =
                 ...
                 let uu___4 =
                   ...
                   FStar_All.pipe_left
                     (FStar_List.map FStar_Pervasives_Native.fst) uu___5
                    in
        ...
        fun src  ->
          fun wl  ->
            ...
            | (pfx,uu___1) ->
                ...
                then
                  aux src.FStar_Syntax_Syntax.ctx_uvar_typ
                    (fun src'  -> src')
                else
                  (let uu___3 =
                     let uu___4 =
          ...
          FStar_List.fold_left
            (fun out  ->
               fun b  ->
                 ...
                 | uu___ -> out) FStar_Syntax_Syntax.no_names g
           in
        let uu___ =
...
let name_exists_in_binders :
  ...
  fun x  ->
    fun bs  ->
      FStar_Util.for_some
        (fun uu___  ->
           match uu___ with | (y,uu___1) -> FStar_Syntax_Syntax.bv_eq x y) bs
...
let rec (delta_depth_of_term :
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst (t2,uu___) -> delta_depth_of_term env t2
      ...
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_lazy
           { FStar_Syntax_Syntax.blob = uu___;
             ...
             FStar_Syntax_Syntax.rng = uu___3;_},uu___4)
            ->
        ...
        | (FStar_Syntax_Syntax.Tm_uinst
           (f,uu___),FStar_Syntax_Syntax.Tm_uinst (g,uu___1)) ->
        ...
        | (FStar_Syntax_Syntax.Tm_constant c,FStar_Syntax_Syntax.Tm_constant
           d) ->
            ...
            then FullMatch
              ...
              MisMatch
                (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
        | (FStar_Syntax_Syntax.Tm_uvar (uv,uu___),FStar_Syntax_Syntax.Tm_uvar
           (uv',uu___1)) ->
            let uu___2 =
              FStar_Syntax_Unionfind.equiv
                uv.FStar_Syntax_Syntax.ctx_uvar_head
            ...
            then FullMatch
              ...
              MisMatch
                (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
        | (FStar_Syntax_Syntax.Tm_refine
           (x,uu___),FStar_Syntax_Syntax.Tm_refine (y,uu___1)) ->
            let uu___2 =
        ...
        | (FStar_Syntax_Syntax.Tm_arrow uu___,FStar_Syntax_Syntax.Tm_arrow
           uu___1) -> HeadMatch false
        | (FStar_Syntax_Syntax.Tm_app (head,uu___),FStar_Syntax_Syntax.Tm_app
           (head',uu___1)) ->
        ...
        | uu___ ->
            let uu___1 =
              ...
              let uu___3 = delta_depth_of_term env t21  in (uu___2, uu___3)
               in
            MisMatch uu___1
    ...
    fun wl  ->
      fun t1  ->
        fun t2  ->
          let maybe_inline t =
            let head =
              let uu___ = unrefine env t  in FStar_Syntax_Util.head_of uu___
               in
            (let uu___1 =
               FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                 ...
                 (match uu___2 with
                  | FStar_Pervasives_Native.None  ->
                      ((let uu___4 =
                        ...
                        if uu___4
                        then
                          let uu___5 = FStar_Syntax_Print.term_to_string head
                             in
                  ...
                  | FStar_Pervasives_Native.Some uu___3 ->
                      ...
                      then FStar_Pervasives_Native.None
                        ...
                        ((let uu___7 =
                          ...
                          if uu___7
                          then
                            let uu___8 = FStar_Syntax_Print.term_to_string t
                               in
                            let uu___9 = FStar_Syntax_Print.term_to_string t'
                               in
          ...
          let rec aux retry n_delta t11 t21 =
            ...
            (let reduce_one_and_try_again d1 d2 =
             ...
             | uu___1 -> success n_delta r t11 t21)
             in
                 ...
                 (let uu___7 =
                  ...
                  FStar_All.pipe_right uu___7
                    (fun uu___8  ->
                       match uu___8 with
                       | (t11,t21) ->
                           let uu___9 = FStar_Syntax_Print.term_to_string t11
                              in
                           let uu___10 =
                             let uu___11 =
                               FStar_Syntax_Print.term_to_string t21  in
                             Prims.op_Hat "; " uu___11  in
                           Prims.op_Hat uu___9 uu___10))
                in
                ...
                | (rh,rhs_args) ->
                    let uu___2 =
                      ...
                      | (uu___3,FStar_Syntax_Syntax.Tm_uvar uu___4) when
                          ...
                          -> (FStar_TypeChecker_Common.Flex_rigid_eq, tp)
                      | (FStar_Syntax_Syntax.Tm_uvar
                         uu___3,FStar_Syntax_Syntax.Tm_arrow uu___4) ->
                      ...
                      | (FStar_Syntax_Syntax.Tm_uvar
                         uu___3,FStar_Syntax_Syntax.Tm_type uu___4) ->
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                            (let uu___5 = tp  in
                             {
                               FStar_TypeChecker_Common.pid =
                     ...
                     | (rank1,tp1) ->
                         let uu___3 =
                           FStar_All.pipe_right
                             ...
                             (fun uu___4  ->
                                FStar_TypeChecker_Common.TProb uu___4)
                            in
                         (rank1, uu___3))))
      | FStar_TypeChecker_Common.CProb cp ->
          let uu___ =
                      ...
                      fun uv1  ->
                        let uu___ =
                          FStar_All.pipe_right u22
                           ...
                           in
                        if uu___ then uv1 :: uvs else uvs) [])
               in
            let filter =
              FStar_List.filter
                (fun u  ->
                   ...
                   ufailed_thunk
                     (fun uu___2  ->
                        let uu___3 = FStar_Syntax_Print.univ_to_string u12
                           in
                        let uu___4 = FStar_Syntax_Print.univ_to_string u22
                           in
                        FStar_Util.format3
                 ...
                 | (x::xs,y::ys) ->
                     ...
                     (match uu___2 with
                      | ((xs1,xr),(ys1,yr)) ->
                          (((x :: xs1), xr), ((y :: ys1), yr)))
                 | (xs,ys) ->
                     let uu___2 = let uu___3 = mk_cod1 xs  in ([], uu___3)
                        in
                     let uu___3 = let uu___4 = mk_cod2 ys  in ([], uu___4)
                        in
                     (uu___2, uu___3)
                  in
               aux bs1 bs2)
          ...
          fun t2  ->
            let has_type_guard t11 t21 =
              ...
              | FStar_Pervasives_Native.None  ->
                  ...
                  FStar_Syntax_Util.mk_forall u_x x uu___
               in
...
let (quasi_pattern :
  ...
  fun env  ->
    fun f  ->
      ...
      match uu___ with
      | Flex
          (uu___1,{ FStar_Syntax_Syntax.ctx_uvar_head = uu___2;
                    ...
                    FStar_Syntax_Syntax.ctx_uvar_meta = uu___7;_},args)
          ->
          let name_exists_in x bs =
            FStar_Util.for_some
              (fun uu___8  ->
                 match uu___8 with
                 | (y,uu___9) -> FStar_Syntax_Syntax.bv_eq x y) bs
             in
                     ...
                     then
                       ...
                       (let x1 =
                        ...
                        let subst =
                          let uu___11 =
                            let uu___12 =
                              let uu___13 = FStar_Syntax_Syntax.bv_to_name x1
                                 in
                              (formal, uu___13)  in
                ...
                (match uu___8 with
                 | (more_formals,t_res1) ->
                     (match more_formals with
                      | [] -> FStar_Pervasives_Native.None
                      | uu___9 -> aux pat_binders more_formals t_res1 args2))
             in
          (match args with
                     ...
                     (match attempt1 with
                      | [] ->
                          let uu___5 =
                            ...
                            let uu___7 = as_deferred probs.wl_deferred_to_tac
                               in
          ...
          fun wl  ->
            ...
            | (FStar_Syntax_Syntax.Tm_uinst
               ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar f;
                  ...
                  FStar_Syntax_Syntax.vars = uu___1;_},us1),FStar_Syntax_Syntax.Tm_uinst
               ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar g;
                  FStar_Syntax_Syntax.pos = uu___2;
                  FStar_Syntax_Syntax.vars = uu___3;_},us2))
              ...
              let should_defer_tac t =
                ...
                | (head,uu___1) ->
                    ...
                    (match uu___2 with
                     ...
                     | uu___3 -> (false, ""))
                 in
              let uu___ = should_defer_tac prob.FStar_TypeChecker_Common.lhs
                 in
              (match uu___ with
               | (l1,r1) ->
                   let uu___1 =
                    ...
                    (match mr with
                     ...
                     | HeadMatch (false ) ->
                         let uu___3 =
                           match ts1 with
                           | FStar_Pervasives_Native.Some (t11,t21) ->
                               let uu___4 = FStar_Syntax_Subst.compress t11
                                  in
                               let uu___5 = FStar_Syntax_Subst.compress t21
                                  in
                               (uu___4, uu___5)
                           | FStar_Pervasives_Native.None  ->
                               let uu___4 = FStar_Syntax_Subst.compress t1
                                  in
                        ...
                        (match uu___2 with
                         | (out1,probs',wl3) ->
                             aux
                               ...
                               ts2))
                in
             let uu___1 = let uu___2 = FStar_List.hd ts  in (uu___2, [], wl1)
                in
           ...
           | (this_flex,this_rigid) ->
               ...
               (match uu___2 with
                | FStar_Syntax_Syntax.Tm_arrow (_bs,comp) ->
                    let uu___3 = FStar_Syntax_Util.is_tot_or_gtot_comp comp
                       in
                    if uu___3
                    then
                ...
                | uu___3 ->
                    ((let uu___5 =
                     ...
                     (let uu___5 = FStar_Syntax_Util.head_and_args this_flex
                         in
                      match uu___5 with
                      | (u,_args) ->
                          let uu___6 =
                  ...
                  let bs_lhs_args =
                    FStar_List.map
                      (fun uu___  ->
                         match uu___ with
                         | (x,i) ->
                             let uu___1 = FStar_Syntax_Syntax.bv_to_name x
                                in
                             (uu___1, i)) bs_lhs
                     in
                  let uu___ = lhs  in
                  ...
                  | Flex (uu___1,u_lhs,uu___2) ->
                      let imitate_comp bs bs_terms c wl1 =
                        ...
                        | FStar_Syntax_Syntax.Comp ct ->
                         ...
                         in
                      let uu___3 = FStar_Syntax_Util.arrow_formals_comp arrow
                         in
                      (match uu___3 with
                       | (formals,c) ->
                           let rec aux bs bs_terms formals1 wl1 =
                             match formals1 with
                             | [] ->
                                 let uu___4 = imitate_comp bs bs_terms c wl1
                                    in
                                 (match uu___4 with
                                  | (c',wl2) ->
                                      let lhs' =
                             ...
                             | (x,imp)::formals2 ->
                                 let uu___4 =
                                   let uu___5 =
                                     let uu___6 = FStar_Syntax_Util.type_u ()
                                        in
                                     FStar_All.pipe_right uu___6
                                       FStar_Pervasives_Native.fst
                                      in
                                   copy_uvar u_lhs
                                     (FStar_List.append bs_lhs bs) uu___5 wl1
                                    in
                                 (match uu___4 with
                                  | (_ctx_u_x,u_x,wl2) ->
                                      let y =
                                        let uu___5 =
                                          ...
                                          FStar_Pervasives_Native.Some uu___6
                                           in
                                        FStar_Syntax_Syntax.new_bv uu___5 u_x
                                         in
                                      let uu___5 =
                                        let uu___6 =
                                          let uu___7 =
                            ...
                            | (uu___5,occurs_ok,msg) ->
                                ...
                                then
                                  let uu___6 =
                                    mklstr
                                      (fun uu___7  ->
                                         let uu___8 = FStar_Option.get msg
                                            in
          ...
          fun wl  ->
            fun rhs  ->
              (let uu___1 =
               ...
               if uu___1
               then
                 let uu___2 = FStar_Syntax_Print.binders_to_string ", " bs1
                    in
                 let uu___3 = FStar_Syntax_Print.binders_to_string ", " bs2
                    in
            ...
            (let uu___1 = should_defer_flex_to_user_tac env wl lhs  in
             ...
             then defer_to_user_tac env orig (flex_reason lhs) wl
               ...
               (let binders_as_bv_set bs =
                  let uu___3 = FStar_List.map FStar_Pervasives_Native.fst bs
                     in
                                ...
                                let uu___6 =
                                  let uu___7 =
                                    let uu___8 =
                                      ...
                                      FStar_All.pipe_left
                                        FStar_Pervasives_Native.fst uu___9
                                       in
                ...
                let first_order orig1 env1 wl1 lhs1 rhs1 =
                  ...
                  (let is_app rhs2 =
                     ...
                     match uu___4 with
                     | (uu___5,args) ->
                         (match args with | [] -> false | uu___6 -> true)
                      in
                   let is_arrow rhs2 =
                     let uu___4 =
                         ...
                         (let uu___7 = is_arrow rhs1  in
                          ...
                          then
                            ...
                            (let msg =
                               mklstr
                                 (fun uu___9  ->
                                    let uu___10 = prob_to_string env1 orig1
                                       in
                                    FStar_Util.format1
                     ...
                     | Flex (_t1,ctx_uv,args_lhs) ->
                         ...
                         (match uu___4 with
                              ...
                              ((let uu___6 =
                               ...
                               (let rhs1 = sn env rhs  in
                                let names_to_string1 fvs =
                                  let uu___6 =
                                    let uu___7 = FStar_Util.set_elements fvs
                                       in
                                    FStar_List.map
                                      FStar_Syntax_Print.bv_to_string uu___7
                                     in
                                  FStar_All.pipe_right uu___6
                                    (FStar_String.concat ", ")
                                   in
                                ...
                                | (uvars,occurs_ok,msg) ->
                                    ...
                                    then
                                      let uu___7 =
                                        let uu___8 =
                                          let uu___9 = FStar_Option.get msg
                                             in
                                          Prims.op_Hat
                                            "occurs-check failed: " uu___9
                                           in
                                         ...
                                         then
                                           (let msg1 =
                                              mklstr
                                                (fun uu___10  ->
                                                   let uu___11 =
                                                     names_to_string1 fvs2
                                                      in
                                                   let uu___12 =
                                                     names_to_string1 fvs1
                                                      in
                                                   let uu___13 =
                          ...
                          | uu___5 ->
                              if wl.defer_ok
                              then
                                let uu___6 = FStar_Thunk.mkv "Not a pattern"
                                   in
                                giveup_or_defer env orig wl uu___6
                              else
                                (let uu___7 =
            ...
            | FStar_TypeChecker_Common.EQ  ->
                let uu___ =
                  (should_defer_flex_to_user_tac env wl lhs) ||
                    (should_defer_flex_to_user_tac env wl rhs)
                   in
                if uu___
                then
                  ...
                  then
                    ...
                    (let uu___3 =
                       ...
                       let uu___5 = quasi_pattern env rhs  in
                       (uu___4, uu___5)  in
                     match uu___3 with
                     | (FStar_Pervasives_Native.Some
                         ...
                         (match uu___4 with
                          | Flex
                              ({ FStar_Syntax_Syntax.n = uu___5;
                                 ...
                                 FStar_Syntax_Syntax.vars = uu___6;_},u_lhs,uu___7)
                              ->
                              let uu___8 = rhs  in
                              (match uu___8 with
      ...
      fun wl  ->
        ...
        (let giveup_or_defer1 orig msg = giveup_or_defer env orig wl msg  in
                       ...
                       (let uu___5 =
                          (nargs = Prims.int_zero) ||
                            (let uu___6 =
                             ...
                             uu___6 = FStar_Syntax_Util.Equal)
                           in
                        if uu___5
                        then
                          (if need_unif
         ...
         let try_match_heuristic env1 orig wl1 s1 s2 t1t2_opt =
                            ...
                            | (prob,wl4) ->
                                ...
                                (match uu___7 with
                                 | Success (uu___8,defer_to_tac,imps) ->
                                     ...
                                     (match uu___9 with
                                      | Success (uu___10,defer_to_tac',imps')
                                          ->
                                          (FStar_Syntax_Unionfind.commit tx;
                                           (let uu___12 =
                                              extend_wl wl4
           ...
           | FStar_Pervasives_Native.Some (t1,t2) ->
               ((let uu___2 =
                ...
                (let uu___2 =
                   let uu___3 =
                     let uu___4 = FStar_Syntax_Util.unmeta t1  in
                     (s1, uu___4)  in
                   let uu___4 =
                     let uu___5 = FStar_Syntax_Util.unmeta t2  in
                     (s2, uu___5)  in
                   (uu___3, uu___4)  in
                 match uu___2 with
                 | ((uu___3,{
                              ...
                              FStar_Syntax_Syntax.vars = uu___5;_}),(s,t))
                     ->
                     let uu___6 =
                         ...
                         ((let uu___10 =
                          ...
                          (let pat_discriminates uu___10 =
                             ...
                             | ({
                                  ...
                                  FStar_Syntax_Syntax.p = uu___12;_},FStar_Pervasives_Native.None
                                ,uu___13) -> true
                             | ({
                                  FStar_Syntax_Syntax.v =
                           ...
                           | FStar_Pervasives_Native.Some b ->
                               let uu___10 = FStar_Syntax_Subst.open_branch b
                                  in
                               (match uu___10 with
                                | (p,uu___11,e) ->
                                    ((let uu___13 =
                 ...
                 | (MisMatch uu___3,uu___4) ->
                     let rec may_relate head =
                       ...
                       | FStar_Syntax_Syntax.Tm_meta (t,uu___6) ->
                           may_relate t
                       | uu___6 -> false  in
                     let uu___5 = try_match_heuristic env1 orig wl1 t1 t2 o
                        in
                     (match uu___5 with
                      ...
                      | FStar_Util.Inr (FStar_Pervasives_Native.None ) ->
                          ...
                          if uu___6
                          then
                            let uu___7 = guard_of_prob env1 wl1 problem t1 t2
                               in
                            (match uu___7 with
                             | (guard,wl2) ->
                                 let uu___8 =
         ...
         (let uu___2 =
          ...
          if uu___2
          then
            let uu___3 = solve_prob orig FStar_Pervasives_Native.None [] wl
               in
            solve env uu___3
          else
            (let t1 = problem.FStar_TypeChecker_Common.lhs  in
             ...
             (let r = FStar_TypeChecker_Env.get_range env  in
              ...
              | (FStar_Syntax_Syntax.Tm_quoted
                 (t11,uu___7),FStar_Syntax_Syntax.Tm_quoted (t21,uu___8)) ->
                  let uu___9 =
                               ...
                               let uu___16 =
                                 let uu___17 =
                                   FStar_TypeChecker_Normalize.unfold_whnf
                                     env ty1
                                    in
                                 FStar_Syntax_Print.term_to_string uu___17
                                  in
                               let uu___17 =
                                         ...
                                         (let uu___12 =
                                            let uu___13 =
                                              FStar_Syntax_Free.uvars phi12
                                               in
                                            FStar_Util.set_is_empty uu___13
                                             in
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu___9;_},uu___10),FStar_Syntax_Syntax.Tm_uvar
                 uu___11) ->
              ...
              | (FStar_Syntax_Syntax.Tm_uvar
                 ...
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu___10;_},uu___11))
                  ->
                  let uu___12 = ensure_no_uvar_subst t1 wl  in
                  (match uu___12 with
                   | (t11,wl1) ->
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                      uu___7;
                    FStar_Syntax_Syntax.pos = uu___8;
                    FStar_Syntax_Syntax.vars = uu___9;_},uu___10),FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                      uu___11;
                    FStar_Syntax_Syntax.pos = uu___12;
                    FStar_Syntax_Syntax.vars = uu___13;_},uu___14))
                  ->
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                      uu___7;
                    FStar_Syntax_Syntax.pos = uu___8;
                    FStar_Syntax_Syntax.vars = uu___9;_},uu___10),uu___11)
                  when
                  problem.FStar_TypeChecker_Common.relation =
                    FStar_TypeChecker_Common.EQ
                  ->
              ...
              | (uu___7,FStar_Syntax_Syntax.Tm_app
                 ({
                  ...
                  -> solve_t env (invert problem) wl
              | (FStar_Syntax_Syntax.Tm_uvar
                 uu___7,FStar_Syntax_Syntax.Tm_arrow uu___8) ->
                  solve_t' env
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                      uu___7;
                    FStar_Syntax_Syntax.pos = uu___8;
                    FStar_Syntax_Syntax.vars = uu___9;_},uu___10),FStar_Syntax_Syntax.Tm_arrow
                 uu___11) ->
                  solve_t' env
                    (let uu___12 = problem  in
                     {
                                         ...
                                         (match uu___14 with
                                          | (p21,w21,e2) ->
                                              ...
                                              let uu___15 =
                                                match (w11, w22) with
                                                | (FStar_Pervasives_Native.Some
                                                   uu___16,FStar_Pervasives_Native.None
                                                   ) ->
                                                    FStar_Pervasives_Native.None
                                                | (FStar_Pervasives_Native.None
                                                   ,FStar_Pervasives_Native.Some
              ...
              | (FStar_Syntax_Syntax.Tm_match uu___7,uu___8) ->
                  let head1 =
                    ...
                    FStar_All.pipe_right uu___9 FStar_Pervasives_Native.fst
                     in
                  let head2 =
                    ...
                    then
                      let uu___11 =
                        FStar_Util.string_of_int
                          problem.FStar_TypeChecker_Common.pid
                         in
                      let uu___12 = FStar_Syntax_Print.term_to_string head1
                         in
                      let uu___13 = FStar_Syntax_Print.term_to_string head2
                         in
                      FStar_Util.print3
                        ">> (%s)\n>>> head1 = %s\n>>> head2 = %s\n" uu___11
                        uu___12 uu___13
                  ...
                  let uu___9 =
                    let uu___10 =
                      ...
                      FStar_Util.format4
                       ...
                       in
                    (FStar_Errors.Fatal_UnificationNotWellFormed, uu___10)
                     in
      ...
      fun wl  ->
                             ...
                             (fun uu___7  ->
                                fun uu___8  ->
                                  fun uu___9  ->
                                    ...
                                    | ((a1,uu___10),(a2,uu___11),(arg_sub_probs,wl3))
                                        ->
                                        let uu___12 =
                                          sub_prob wl3 a1
                          ...
                          | (arg_sub_probs,wl3) ->
                                    ...
                                    let uu___9 =
                                      FStar_All.pipe_right
                                        ...
                                        (FStar_List.map
                                           FStar_Pervasives_Native.snd)
                                       in
                                    FStar_List.append arg_sub_probs uu___9
                                     in
                              ...
                              let guard =
                                ...
                                | FStar_TypeChecker_Common.NonTrivial f ->
                                    FStar_Syntax_Util.mk_conj guard1 f
                                 in
                              let wl4 =
                                let uu___7 = wl3  in
                                {
          ...
          (let uu___1 =
           ...
           then
             let uu___2 =
               ...
               FStar_All.pipe_right uu___3 FStar_Syntax_Print.comp_to_string
                in
             let uu___3 =
               let uu___4 =
                 FStar_All.pipe_right c21 FStar_Syntax_Syntax.mk_Comp  in
               FStar_All.pipe_right uu___4 FStar_Syntax_Print.comp_to_string
                in
               ...
               | FStar_Pervasives_Native.Some t ->
                   let uu___4 =
                     ...
                     FStar_All.pipe_right uu___5
                      ...
                      in
                   (c11, FStar_TypeChecker_Env.trivial_guard, uu___4, true)
                in
             match uu___2 with
                           ...
                           (fun uu___6  ->
                              fun uu___7  ->
                                fun uu___8  ->
                                  ...
                                  | ((a1,uu___9),(a2,uu___10),(is_sub_probs,wl2))
                                      ->
                                             ...
                                             let uu___10 =
                                               let uu___11 =
                                                 FStar_All.pipe_right f_b
                                                   FStar_Pervasives_Native.fst
                                                  in
                                               uu___11.FStar_Syntax_Syntax.sort
                                                in
                                             let uu___11 =
                                                   ...
                                                   let uu___10 =
                                                     let uu___11 =
                                                       ...
                                                       FStar_List.append
                                                        ...
                                                        in
                                                     FStar_List.append
                                                       is_sub_probs uu___11
                                                      in
                                                   ret_sub_prob :: uu___10
                                                    in
                                                 let guard =
                                                   let guard1 =
                                                     let uu___10 =
                           ...
                           let c1_repr =
                             ...
                             norm_with_steps
                               ...
                               [FStar_TypeChecker_Env.UnfoldUntil
                                  FStar_Syntax_Syntax.delta_constant;
                               FStar_TypeChecker_Env.Weak;
                               FStar_TypeChecker_Env.HNF] env uu___8
                              in
                           let c2_repr =
                             let uu___8 =
                               let uu___9 = FStar_Syntax_Syntax.mk_Comp c21
                                  in
                               let uu___10 =
                                 env.FStar_TypeChecker_Env.universe_of env
                                   c21.FStar_Syntax_Syntax.result_typ
                               ...
                               let uu___11 =
                                 let uu___12 =
                                   FStar_TypeChecker_Normalize.normalize
                                    ...
                                    in
                                 FStar_Syntax_Print.term_to_string uu___12
                                  in
                               FStar_Util.print1
        ...
        then
          ...
          ((let uu___3 =
           ...
           (let uu___3 =
              let uu___4 = FStar_TypeChecker_Normalize.ghost_to_pure env c1
                 in
              let uu___5 = FStar_TypeChecker_Normalize.ghost_to_pure env c2
                 in
              (uu___4, uu___5)  in
            match uu___3 with
            | (c11,c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu___4),FStar_Syntax_Syntax.Total (t2,uu___5)) when
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu___4,FStar_Syntax_Syntax.Total uu___5) ->
                     let uu___6 =
                       FStar_Thunk.mkv
                 ...
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu___4),FStar_Syntax_Syntax.Total (t2,uu___5)) ->
                     let uu___6 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type"
                     ...
                     solve_t env uu___6 wl
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu___4),FStar_Syntax_Syntax.GTotal (t2,uu___5)) ->
                     let uu___6 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type"
                     ...
                     solve_t env uu___6 wl
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu___4),FStar_Syntax_Syntax.GTotal (t2,uu___5)) when
                     problem.FStar_TypeChecker_Common.relation =
                       FStar_TypeChecker_Common.SUB
                     ->
                     let uu___6 =
                 ...
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu___4),FStar_Syntax_Syntax.GTotal (t2,uu___5)) ->
                     ...
                     giveup env uu___6 orig
                 | (FStar_Syntax_Syntax.GTotal
                    uu___4,FStar_Syntax_Syntax.Comp uu___5) ->
                     let uu___6 =
                 ...
                 | (FStar_Syntax_Syntax.Total uu___4,FStar_Syntax_Syntax.Comp
                    uu___5) ->
                     ...
                     solve_c env uu___6 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu___4,FStar_Syntax_Syntax.GTotal uu___5) ->
                     let uu___6 =
                       let uu___7 = problem  in
                       let uu___8 =
                         let uu___9 =
  ...
  fun env  ->
    fun g  ->
      ...
      | uu___ ->
          ...
          let uu___3 = ineqs_to_string g.FStar_TypeChecker_Common.univ_ineqs
             in
          FStar_Util.format5
            "\n\t{guard_f=%s;\n\t deferred={\n%s};\n\t deferred_to_tac={\n%s};\n\t univ_ineqs={%s};\n\t implicits={%s}}\n"
  ...
  fun env  ->
    fun probs  ->
      fun err  ->
        ...
        (let uu___1 = FStar_Util.record_time (fun uu___2  -> solve env probs)
            in
         match uu___1 with
         | (sol,ms) ->
             ((let uu___3 =
               ...
               | Success (deferred,defer_to_tac,implicits) ->
                   let uu___3 =
                     FStar_Util.record_time
                       (fun uu___4  -> FStar_Syntax_Unionfind.commit tx)
                      in
                   (match uu___3 with
                    | ((),ms1) ->
                        ((let uu___5 =
              ...
              let uu___1 =
                let uu___2 =
                  FStar_All.pipe_right (p_guard prob)
                    (fun uu___3  ->
                       FStar_TypeChecker_Common.NonTrivial uu___3)
                   in
                {
      ...
      fun c2  ->
        ...
        (let uu___1 =
           ...
           new_problem (empty_worklist env) env c1 rel c2
             FStar_Pervasives_Native.None uu___2 "sub_comp"
            in
         match uu___1 with
         | (prob,wl) ->
             let wl1 =
                   ...
                   (fun uu___4  ->
                      let uu___5 =
                        solve_and_commit env (singleton wl1 prob1 true)
                         ...
                         in
                      FStar_All.pipe_left (with_guard env prob1) uu___5)
                  in
               match uu___3 with
               | (r,ms) ->
                   ((let uu___5 =
            ...
            let rec check_ineq uu___2 =
              ...
              | (u,v) ->
                  ...
                  (match (u1, v1) with
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu___3,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu___3,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
        ...
        fun g  ->
          let fail uu___ =
            ...
            | (d,s) ->
             ...
             in
          let wl =
            let uu___ = wl_of_guard env g.FStar_TypeChecker_Common.deferred
               in
            {
              attempting = (uu___.attempting);
              wl_deferred = (uu___.wl_deferred);
                  ...
                  (if debug
                   ...
                   (let vc1 =
                    ...
                    then
                      (let uu___5 = FStar_TypeChecker_Env.get_range env  in
                       let uu___6 =
                         let uu___7 = FStar_Syntax_Print.term_to_string vc1
                            in
                    ...
                    (let uu___6 = FStar_TypeChecker_Common.check_trivial vc1
                        in
                     match uu___6 with
                     | FStar_TypeChecker_Common.Trivial  ->
                         FStar_Pervasives_Native.Some ret_g
...
let (discharge_guard_no_smt :
  ...
  fun env  ->
    fun g  ->
      let uu___ = discharge_guard' FStar_Pervasives_Native.None env g false
         in
      match uu___ with
...
let (discharge_guard :
  ...
  fun env  ->
    fun g  ->
      let uu___ = discharge_guard' FStar_Pervasives_Native.None env g true
         in
      match uu___ with
      | FStar_Pervasives_Native.Some g1 -> g1
      | FStar_Pervasives_Native.None  ->
        ...
        let uu___ =
          ...
          then (false, true)
            ...
            (((Prims.op_Negation env.FStar_TypeChecker_Env.phase1) &&
                (Prims.op_Negation env.FStar_TypeChecker_Env.lax)), false)
           in
        match uu___ with
        | (must_total,forcelax) ->
              ...
              | (out,changed) ->
                  (match implicits with
                   | [] ->
                       ...
                       then
                         let uu___2 =
                           try_solve_single_valued_implicits env is_tac out
                            in
                         (match uu___2 with
                          | (out1,changed1) ->
                              if changed1
           ...
           let uu___2 =
             let uu___3 =
               ...
               FStar_Util.format3
                 ...
                 uu___4 uu___5 imp.FStar_TypeChecker_Common.imp_reason
                in
      ...
      fun t2  ->
        fun reason  ->
          (let uu___1 =
           ...
           then
             let uu___2 =
               let uu___3 = FStar_All.pipe_right reason FStar_Util.is_none
                  in
               if uu___3
               then "_"
