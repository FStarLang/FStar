...
let norm_arg env t =
  let uu____1335 = sn env (fst t)  in (uu____1335, (snd t)) 
let sn_binders :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.binders ->
               ...
               let uu____2359 =
                 let uu____2366 =
                   FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c1)
                    ...
                    in
                 FStar_All.pipe_right uu____2366 (fun _0_37  -> Some _0_37)
                  in
      ...
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_fvar f,FStar_Syntax_Syntax.Tm_fvar g) ->
            ...
            then FullMatch
              ...
              (let uu____3685 =
                 let uu____3690 =
                   let uu____3692 = fv_delta_depth env f  in Some uu____3692
                    in
                 let uu____3693 =
                   let uu____3695 = fv_delta_depth env g  in Some uu____3695
                    in
                           ...
                           | (g_xs,uu____8694) ->
                               ...
                               ((let uu____8779 =
                                ...
                                (let wl2 =
                                 ...
                                 FStar_All.pipe_left
                                   (fun _0_55  -> Some _0_55) uu____8791)))))
           in
              ...
              (let r = FStar_TypeChecker_Env.get_range env  in
                               ...
                               fun subst1  ->
                                 let uu____11417 =
                                   ...
                                   mk_problem scope orig uu____11420
                                     problem.FStar_TypeChecker_Common.relation
                                     uu____11421 None "lambda co-domain"
                                    in
                                 FStar_All.pipe_left
                                   (fun _0_62  ->
               ...
               | (FStar_Syntax_Syntax.Tm_match uu____12543,uu____12544) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____12563 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____12594 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____12594 FStar_Pervasives.fst
                      in
                   let uu____12622 =
               ...
               | (FStar_Syntax_Syntax.Tm_fvar uu____12918,uu____12919) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____12923 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____12954 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____12954 FStar_Pervasives.fst
                      in
                   let uu____12982 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
               ...
               | (FStar_Syntax_Syntax.Tm_app uu____13007,uu____13008) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____13021 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____13052 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____13052 FStar_Pervasives.fst
                      in
                   let uu____13080 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
               ...
               | (uu____13105,FStar_Syntax_Syntax.Tm_match uu____13106) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____13125 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____13156 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____13156 FStar_Pervasives.fst
                      in
                   let uu____13184 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
               ...
               | (uu____13480,FStar_Syntax_Syntax.Tm_fvar uu____13481) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____13485 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____13516 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____13516 FStar_Pervasives.fst
                      in
                   let uu____13544 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
               ...
               | (uu____13569,FStar_Syntax_Syntax.Tm_app uu____13570) ->
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____13583 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____13614 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____13614 FStar_Pervasives.fst
                      in
                   let uu____13642 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
          ...
          (let prob =
           ...
           let g =
             let uu____14763 =
               ...
               solve_and_commit env uu____14765 (fun uu____14766  -> None)
                in
