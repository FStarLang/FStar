          ...
          let x =
            ...
            then "?"
              ...
              (let uu____795 = FStar_Syntax_Unionfind.univ_uvar_id u  in
               FStar_All.pipe_right uu____795 FStar_Util.string_of_int)
             in
          ...
          let x =
            ...
            then "?"
              ...
              (let uu____805 = FStar_Syntax_Unionfind.uvar_id u  in
               FStar_All.pipe_right uu____805 FStar_Util.string_of_int)
             in
    ...
    FStar_All.pipe_right args
      (FStar_List.map
         (fun uu____859  ->
            ...
            | (x,uu____863) -> FStar_Syntax_Print.term_to_string x))
     in
    ...
    fun t  ->
      let uu____1463 =
        ...
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.WHNF] env uu____1464
         in
      ...
      let uu____2318 =
        let uu____2320 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu____2334  ->
                  match uu____2334 with | (uu____2338,uu____2339,x) -> x))
           in
    ...
    then FStar_Pervasives_Native.None
      ...
      (let uu____2771 =
         ...
         FStar_Util.format2 "occurs-check failed (%s occurs in %s)"
          ...
          in
       FStar_Pervasives_Native.Some uu____2771)
     in
  (occurs_ok, msg) 
        ...
        FStar_All.pipe_right seen
          (FStar_Util.for_some
             (fun uu____3168  ->
                ...
                | (b,uu____3172) -> FStar_Syntax_Syntax.bv_eq a b))
         in
      if uu____3159
      then FStar_Pervasives_Native.None
      else
    ...
    | MisMatch
        ...
        then fail r
          ...
          (let uu____4272 =
             ...
             let uu____4279 = maybe_inline t21  in (uu____4277, uu____4279)
              in
    ...
    | MisMatch
        ...
        then fail r
          ...
          (let uu____4310 =
             ...
             let uu____4317 = maybe_inline t21  in (uu____4315, uu____4317)
              in
                        ...
                        let uu____5365 =
                          let uu____5370 =
                            FStar_List.map (sub_prob scope1 args) components1
                             in
                          FStar_All.pipe_right uu____5370 FStar_List.unzip
                           in
                        (match uu____5365 with
                         | (tcs,sub_probs) ->
                             let gi_xs =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Syntax.mk_Comp uu____5399
                                in
                             ((C gi_xs), sub_probs))
                    | uu____5415 ->
                             ...
                             | (sub_probs,tcs,f) ->
                                 let f1 =
                                   ...
                                   | FStar_Pervasives_Native.Some b ->
                                       ...
                                       FStar_Syntax_Util.mk_conj_l uu____5577
                                    in
                     ...
                     (fun u3  ->
                        ...
                        | (k,uu____6191) ->
                            (match k with
                             ...
                             | uu____6197 -> false)))
            | uu____6198 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u])
             in
      ...
      (match uu____6491 with
       | (bs2,mk_cod2) ->
           let curry n1 bs mk_cod =
             ...
             | (bs3,rest) ->
                 let uu____6552 = mk_cod rest  in (bs3, uu____6552)
              in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____6827  ->
                          ...
                          | (c,uu____6832,uu____6833) -> c < probs.ctr))
                   in
                                     ...
                                     (match uu____7330 with
                                      | (u',uu____7341) ->
                                          let uu____7356 =
                                            ...
                                            uu____7357.FStar_Syntax_Syntax.n
                                             in
                             ...
                             (match tps with
                              ...
                              | (FStar_TypeChecker_Common.TProb hd1)::tl1 ->
                                  ...
                                  (match uu____7429 with
                                   ...
                                   | FStar_Pervasives_Native.None  ->
                                       FStar_Pervasives_Native.None)
                              | uu____7453 -> FStar_Pervasives_Native.None)
                          in
                       let uu____7458 =
                         let uu____7463 =
                           let uu____7467 =
                        ...
                        (match uu____7602 with
                         | (h2,uu____7615) ->
                             (match ((h1.FStar_Syntax_Syntax.n),
                              ...
                              | uu____7687 -> FStar_Pervasives_Native.None))
                     in
                  let conjoin t1 t2 =
                    ...
                    (match uu____8255 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi1 =
                           ...
                           FStar_Syntax_Util.mk_conj uu____8273 uu____8276
                            in
                         ((let uu____8282 =
                             FStar_All.pipe_left
                            ...
                            | FStar_Pervasives_Native.None  ->
                                ...
                                let uu____8426 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t11
                                    uu____8427 t21
                                   in
                                FStar_Syntax_Util.mk_forall u_x x uu____8426
                             in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
                                   ...
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____8540 =
                                        FStar_Syntax_Util.eq_args args1 args2
                                         in
                                      uu____8540 = FStar_Syntax_Util.Equal)
                                    in
                                 if uu____8534
                                 then
                                   let uu____8541 =
                                              ...
                                              let uu____9039 =
                                                let uu____9041 =
                                                  FStar_Syntax_Syntax.as_arg
                                                   ...
                                                   in
                                                uu____9041 :: gi_ps'  in
                                              (uu____9036, uu____9039)))
                                 in
                              aux [] bs
                           in
                        let uu____9044 =
                          let uu____9045 = matches pi  in
                          FStar_All.pipe_left Prims.op_Negation uu____9045
                           in
                        if uu____9044
                        then FStar_Pervasives_Native.None
                        else
                                   ...
                                   let uu____9111 =
                                     let uu____9113 =
                                       FStar_All.pipe_left
                                         ...
                                         (p_guard sub1)
                                        in
                                     FStar_Pervasives_Native.Some uu____9113
                                      in
                ...
                let fvs_hd =
                  let uu____10023 =
                    ...
                    FStar_All.pipe_right uu____10026
                      FStar_Pervasives_Native.fst
                     in
                  FStar_All.pipe_right uu____10023 FStar_Syntax_Free.names
                   in
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____10074 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____10075
                             in
                   ...
                   (match uu____10207 with
                    | (all_formals,uu____10218) ->
                                ...
                                | (t1,uu____10332) ->
                                    let uu____10333 =
                                      new_uvar t1.FStar_Syntax_Syntax.pos
                                        pattern_vars1 t1
                                       in
                                    FStar_Pervasives_Native.fst uu____10333
                                 in
                              let uu____10336 =
                        ...
                        let uu____10531 = FStar_Syntax_Syntax.new_bv_set ()
                           in
                        aux [] [] uu____10531 all_formals args)
                in
                           ...
                           then
                             ...
                             (let uu____10806 =
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____10807 uu____10808 uu____10809
                                 in
                             ...
                             let uu____10842 =
                               let uu____10850 =
                                 FStar_TypeChecker_Normalize.normalize
                                  ...
                                  in
                               FStar_Syntax_Util.arrow_formals uu____10850
                                in
                       ...
                       | (k_u',sub_probs) ->
                           let uu____10940 =
                             let uu____10948 =
                               ...
                               FStar_All.pipe_left
                                 FStar_Pervasives_Native.fst uu____10949
                                in
                             let uu____10954 =
                               let uu____10957 =
                     ...
                     | bs ->
                         let uu____11325 =
                           FStar_Syntax_Syntax.mk
                            ...
                            in
                         FStar_Syntax_Syntax.mk_Total uu____11325
                      in
                   let uu____11335 =
                               ...
                               let guard =
                                 let uu____11991 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst
                                    in
                                 FStar_Syntax_Util.mk_conj uu____11991 impl
                                  in
                               let wl1 =
                                 solve_prob orig
                               ...
                               then
                                 ((let uu____14320 =
                                  ...
                                  (let uu____14322 =
                                     let uu____14325 =
                                       ...
                                       FStar_Syntax_Syntax.Tm_app uu____14326
                                        in
                                 ...
                                 (let uu____14356 =
                                    let uu____14359 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_app uu____14360
                                       in
             ...
             (fun uu____14688  ->
                ...
                | (u1,u2) ->
                    ...
                    let uu____14694 = FStar_Syntax_Print.univ_to_string u2
                       in
                    FStar_Util.format2 "%s < %s" uu____14693 uu____14694))
         in
          ...
          (let prob =
             let uu____14992 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____14995
                in
             FStar_All.pipe_left
           ...
           let g =
             let uu____15000 =
               ...
               solve_and_commit env uu____15002
                 (fun uu____15004  -> FStar_Pervasives_Native.None)
                in
               ...
               let g =
                 let uu____15066 =
                   ...
                   solve_and_commit env uu____15068
                     (fun uu____15070  -> FStar_Pervasives_Native.None)
                    in
         ...
         let prob =
           let uu____15134 =
             ...
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____15137 "sub_comp"
              in
           FStar_All.pipe_left
             (fun _0_97  -> FStar_TypeChecker_Common.CProb _0_97) uu____15134
            in
         let uu____15140 =
           let uu____15142 = singleton env prob  in
           solve_and_commit env uu____15142
             (fun uu____15144  -> FStar_Pervasives_Native.None)
            in
