...
in {FStar_Syntax_Syntax.ppname = uu___133_962.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___133_962.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_280}))
in ((_0_281), (imp)))
end)))))
...
let wl_to_string : worklist  ->  Prims.string = (fun wl -> (let _0_299 = (let _0_298 = (let _0_297 = (FStar_All.pipe_right wl.wl_deferred (FStar_List.map (fun uu____1376 -> (match (uu____1376) with
...
in (FStar_All.pipe_right _0_319 (FStar_Util.for_some (fun uu____1736 -> (match (uu____1736) with
| (uv, uu____1744) -> begin
...
let uu____1990 = (let _0_323 = (FStar_Util.set_mem x v1_set)
...
let uu____2912 = (let _0_335 = (FStar_TypeChecker_Env.lookup_definition ((FStar_TypeChecker_Env.Eager_unfolding_only)::[]) env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu____3005 = (let _0_339 = (maybe_inline t1)
...
let uu____4026 = (let _0_352 = (FStar_List.map (sub_prob scope args) components)
...
in {FStar_TypeChecker_Common.pid = uu___138_4444.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___138_4444.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___138_4444.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _0_368; FStar_TypeChecker_Common.element = uu___138_4444.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___138_4444.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___138_4444.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___138_4444.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___138_4444.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___138_4444.FStar_TypeChecker_Common.rank}))
in ((rank), (_0_369))))
end)
end))
end
...
in (let _0_397 = (FStar_All.pipe_right attempt (FStar_List.map (fun uu____5298 -> (match (uu____5298) with
| (uu____5302, uu____5303, y) -> begin
y
end))))
in {attempting = _0_397; wl_deferred = rest; ctr = uu___143_5289.ctr; defer_ok = uu___143_5289.defer_ok; smt_ok = uu___143_5289.smt_ok; tcenv = uu___143_5289.tcenv}))
in (solve env _0_398))
end)
end))
end)
...
let uu____5763 = (let _0_416 = (whnf env hd.FStar_TypeChecker_Common.lhs)
...
let uu____5791 = (let _0_418 = (let _0_417 = (whnf env tp.FStar_TypeChecker_Common.lhs)
in ((_0_417), ([])))
...
let uu____6308 = (let _0_429 = (whnf env hd.FStar_TypeChecker_Common.rhs)
...
let uu____6354 = (let _0_431 = (let _0_430 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in ((_0_430), ([])))
...
in {FStar_Syntax_Syntax.ppname = uu___150_6500.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___150_6500.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_434}))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___151_6502.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_6502.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_435}))
in (
...
let uu____6757 = ((nargs = (Prims.parse_int "0")) || (let _0_457 = (FStar_Syntax_Util.eq_args args1 args2)
...
let uu____7256 = (let _0_477 = (matches pi)
...
in (let _0_485 = (let _0_484 = (FStar_List.map (fun uu____7319 -> (match (uu____7319) with
...
let uu____7474 = (let _0_494 = (FStar_Syntax_Subst.compress k).FStar_Syntax_Syntax.n
in ((_0_494), (args)))
...
let xs = (FStar_All.pipe_right args (FStar_List.map (fun uu____7561 -> (let _0_499 = (let _0_498 = (Prims.fst (let _0_497 = (let _0_496 = (FStar_Syntax_Util.type_u ())
...
in (FStar_Util.bind_opt _0_507 (fun uu____7669 -> (match (uu____7669) with
| (xs', c) -> begin
...
in (FStar_Util.bind_opt _0_515 (fun uu____7778 -> (match (uu____7778) with
| (xs, c) -> begin
...
let uu____8003 = (let _0_530 = (FStar_Syntax_Free.names t1)
...
let uu____8735 = (let _0_552 = (FStar_Syntax_Subst.compress k1').FStar_Syntax_Syntax.n
...
let uu____8788 = (let _0_560 = (let _0_555 = (new_uvar r zs k_u')
...
let uu____9586 = (let _0_579 = (maybe_eta t1)
...
let uu____9889 = (let _0_595 = (is_top_level_prob orig)
...
let uu____10116 = (let _0_609 = (FStar_Syntax_Util.eq_tm t1 t2)
...
let uu____10448 = (let _0_651 = (FStar_TypeChecker_Normalize.ghost_to_pure env c1)
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _0_664 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun uu____10581 -> (match (uu____10581) with
...
let carry = (let _0_665 = (FStar_List.map (fun uu____10631 -> (match (uu____10631) with
| (uu____10634, x) -> begin
...
in {FStar_TypeChecker_Env.guard_f = _0_674; FStar_TypeChecker_Env.deferred = uu___168_10692.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___168_10692.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___168_10692.FStar_TypeChecker_Env.implicits}))))
end))
...
in {FStar_TypeChecker_Env.guard_f = _0_679; FStar_TypeChecker_Env.deferred = uu___169_10713.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___169_10713.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___169_10713.FStar_TypeChecker_Env.implicits}))
end))
...
in {FStar_TypeChecker_Env.guard_f = _0_683; FStar_TypeChecker_Env.deferred = uu___170_10806.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___170_10806.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___170_10806.FStar_TypeChecker_Env.implicits}))
end))
...
in (solve_and_commit env _0_707 (fun uu____10969 -> None)))
...
in (solve_and_commit env _0_716 (fun uu____11013 -> None)))
...
in (solve_and_commit env _0_729 (fun uu____11061 -> None)))
...
in {FStar_TypeChecker_Env.guard_f = uu___180_11681.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___180_11681.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___180_11681.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _0_748})))))
