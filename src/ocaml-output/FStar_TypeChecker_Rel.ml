    ...
    fun e  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              uu____177 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___246_175.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___246_175.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___246_175.FStar_TypeChecker_Env.implicits)
          }
let map_guard:
  FStar_TypeChecker_Env.guard_t ->
    ...
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            FStar_TypeChecker_Common.NonTrivial uu____220 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___247_218.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___247_218.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___247_218.FStar_TypeChecker_Env.implicits)
          }
    ...
    fun bs  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu___248_344 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___248_344.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___248_344.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___248_344.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.binder Prims.list ->
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____378 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___249_376.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___249_376.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___249_376.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___250_1062 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___250_1062.wl_deferred);
          ctr = (uu___250_1062.ctr);
          defer_ok = (uu___250_1062.defer_ok);
          smt_ok;
          tcenv = (uu___250_1062.tcenv)
        }
let singleton:
...
let wl_of_guard:
  ...
  fun env  ->
    fun g  ->
      let uu___251_1093 = empty_worklist env in
      let uu____1094 = FStar_List.map FStar_Pervasives_Native.snd g in
      {
        attempting = uu____1094;
        wl_deferred = (uu___251_1093.wl_deferred);
        ctr = (uu___251_1093.ctr);
        defer_ok = false;
        smt_ok = (uu___251_1093.smt_ok);
        tcenv = (uu___251_1093.tcenv)
      }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___252_1108 = wl in
        {
          attempting = (uu___252_1108.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___252_1108.ctr);
          defer_ok = (uu___252_1108.defer_ok);
          smt_ok = (uu___252_1108.smt_ok);
          tcenv = (uu___252_1108.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___253_1125 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___253_1125.wl_deferred);
        ctr = (uu___253_1125.ctr);
        defer_ok = (uu___253_1125.defer_ok);
        smt_ok = (uu___253_1125.smt_ok);
        tcenv = (uu___253_1125.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert:
  ...
  =
  fun p  ->
    let uu___254_1163 = p in
    {
      FStar_TypeChecker_Common.pid =
        (uu___254_1163.FStar_TypeChecker_Common.pid);
      FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
      FStar_TypeChecker_Common.relation =
        (invert_rel p.FStar_TypeChecker_Common.relation);
      FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
      FStar_TypeChecker_Common.element =
        (uu___254_1163.FStar_TypeChecker_Common.element);
      FStar_TypeChecker_Common.logical_guard =
        (uu___254_1163.FStar_TypeChecker_Common.logical_guard);
      FStar_TypeChecker_Common.scope =
        (uu___254_1163.FStar_TypeChecker_Common.scope);
      FStar_TypeChecker_Common.reason =
        (uu___254_1163.FStar_TypeChecker_Common.reason);
      FStar_TypeChecker_Common.loc =
        (uu___254_1163.FStar_TypeChecker_Common.loc);
      FStar_TypeChecker_Common.rank =
        (uu___254_1163.FStar_TypeChecker_Common.rank)
    }
let maybe_invert:
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___228_1296  ->
    match uu___228_1296 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___229_1309  ->
    match uu___229_1309 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1828  ->
              ...
              | (x,imp) ->
                  let uu____1839 =
                    let uu___255_1840 = x in
                    let uu____1841 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___255_1840.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___255_1840.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____3085,uv) ->
                ((let uu____3088 =
                 ...
                 commit uvis;
                 (let uu___256_3129 = wl in
                  {
                    attempting = (uu___256_3129.attempting);
                    wl_deferred = (uu___256_3129.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___256_3129.defer_ok);
                    smt_ok = (uu___256_3129.smt_ok);
                    tcenv = (uu___256_3129.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___257_3154 = wl in
         {
           attempting = (uu___257_3154.attempting);
           wl_deferred = (uu___257_3154.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___257_3154.defer_ok);
           smt_ok = (uu___257_3154.smt_ok);
           tcenv = (uu___257_3154.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
    FStar_Syntax_Syntax.term FStar_Pervasives_Native.option ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____6212))::tcs2) ->
                       aux
                         (((let uu___258_6247 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___258_6247.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___258_6247.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___235_6318 =
                 match uu___235_6318 with
                 | [] ->
                     FStar_List.rev
                   ...
                   | (tc,probs) ->
                       let uu____7310 =
                         ...
                         | ((FStar_Pervasives_Native.Some
                            ...
                            (t,uu____7376)) ->
                             let b1 =
                               ((let uu___259_7413 = b in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___259_7413.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___259_7413.FStar_Syntax_Syntax.index);
...
let compress_tprob:
  ...
  fun wl  ->
    fun p  ->
      ...
      {
        FStar_TypeChecker_Common.pid =
          (uu___260_7696.FStar_TypeChecker_Common.pid);
        FStar_TypeChecker_Common.lhs = uu____7701;
        FStar_TypeChecker_Common.relation =
          (uu___260_7696.FStar_TypeChecker_Common.relation);
        FStar_TypeChecker_Common.rhs = uu____7702;
        FStar_TypeChecker_Common.element =
          (uu___260_7696.FStar_TypeChecker_Common.element);
        FStar_TypeChecker_Common.logical_guard =
          (uu___260_7696.FStar_TypeChecker_Common.logical_guard);
        FStar_TypeChecker_Common.scope =
          (uu___260_7696.FStar_TypeChecker_Common.scope);
        FStar_TypeChecker_Common.reason =
          (uu___260_7696.FStar_TypeChecker_Common.reason);
        FStar_TypeChecker_Common.loc =
          (uu___260_7696.FStar_TypeChecker_Common.loc);
        FStar_TypeChecker_Common.rank =
          (uu___260_7696.FStar_TypeChecker_Common.rank)
      }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____7814) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8001 ->
                                    ...
                                    let uu____8011 =
                                      let uu___261_8016 = tp in
                                      let uu____8021 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___261_8016.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___261_8016.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___261_8016.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____8021;
                                        FStar_TypeChecker_Common.element =
                                          (uu___261_8016.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___261_8016.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___261_8016.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___261_8016.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___261_8016.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___261_8016.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____8011)))
                          ...
                          (match uu____8050 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____8099 ->
                                    let uu____8106 =
                                      let uu___262_8113 = tp in
                                      let uu____8118 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___262_8113.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____8118;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___262_8113.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___262_8113.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___262_8113.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___262_8113.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___262_8113.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___262_8113.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___262_8113.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___262_8113.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____7835 with
                     | (rank,tp1) ->
                         let uu____8155 =
                           FStar_All.pipe_right
                             (let uu___263_8161 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___263_8161.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___263_8161.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___263_8161.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___263_8161.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___263_8161.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___263_8161.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___263_8161.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___263_8161.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___263_8161.FStar_TypeChecker_Common.loc);
                                FStar_TypeChecker_Common.rank =
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____8171 =
            FStar_All.pipe_right
              (let uu___264_8177 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___264_8177.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___264_8177.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___264_8177.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___264_8177.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___264_8177.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___264_8177.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___264_8177.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___264_8177.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___264_8177.FStar_TypeChecker_Common.loc);
                 FStar_TypeChecker_Common.rank =
    ...
    fun probs  ->
      ...
      (let uu____9199 = next_prob probs in
       ...
       | (FStar_Pervasives_Native.Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___265_9220 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___265_9220.wl_deferred);
               ctr = (uu___265_9220.ctr);
               defer_ok = (uu___265_9220.defer_ok);
               smt_ok = (uu___265_9220.smt_ok);
               tcenv = (uu___265_9220.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____9406 ->
                          let uu____9415 =
                                      ...
                                      | (uu____9445,uu____9446,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___266_9416.ctr);
                              defer_ok = (uu___266_9416.defer_ok);
                              smt_ok = (uu___266_9416.smt_ok);
                              tcenv = (uu___266_9416.tcenv)
                            } in
                       ...
                       (match uu____10252 with
                        ...
                        | FStar_Pervasives_Native.Some (lhs_bound,sub_probs)
                            ...
                            ((let uu____10300 =
                              ...
                              then
                                let wl' =
                                  let uu___267_10302 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred =
                                      (uu___267_10302.wl_deferred);
                                    ctr = (uu___267_10302.ctr);
                                    defer_ok = (uu___267_10302.defer_ok);
                                    smt_ok = (uu___267_10302.smt_ok);
                                    tcenv = (uu___267_10302.tcenv)
                                  } in
                             ...
                             (let uu____10305 =
                                solve_t env eq_prob
                                  (let uu___268_10307 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___268_10307.wl_deferred);
                                     ctr = (uu___268_10307.ctr);
                                     defer_ok = (uu___268_10307.defer_ok);
                                     smt_ok = (uu___268_10307.smt_ok);
                                     tcenv = (uu___268_10307.tcenv)
                                   }) in
                              match uu____10305 with
                              | Success uu____10310 ->
                                  let wl1 =
                                    let uu___269_10312 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___269_10312.wl_deferred);
                                      ctr = (uu___269_10312.ctr);
                                      defer_ok = (uu___269_10312.defer_ok);
                                      smt_ok = (uu___269_10312.smt_ok);
                                      tcenv = (uu___269_10312.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____11141 with
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 ((let uu____11201 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___270_11203 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___270_11203.wl_deferred);
                                         ctr = (uu___270_11203.ctr);
                                         defer_ok = (uu___270_11203.defer_ok);
                                         smt_ok = (uu___270_11203.smt_ok);
                                         tcenv = (uu___270_11203.tcenv)
                                       } in
                                  ...
                                  (let uu____11206 =
                                     solve_t env eq_prob
                                       (let uu___271_11208 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___271_11208.wl_deferred);
                                          ctr = (uu___271_11208.ctr);
                                          defer_ok =
                                            (uu___271_11208.defer_ok);
                                          smt_ok = (uu___271_11208.smt_ok);
                                          tcenv = (uu___271_11208.tcenv)
                                        }) in
                                   match uu____11206 with
                                   | Success uu____11211 ->
                                       let wl1 =
                                         let uu___272_11213 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___272_11213.wl_deferred);
                                           ctr = (uu___272_11213.ctr);
                                           defer_ok =
                                             (uu___272_11213.defer_ok);
                                           smt_ok = (uu___272_11213.smt_ok);
                                           tcenv = (uu___272_11213.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___273_11351 = hd1 in
                      let uu____11352 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___273_11351.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___273_11351.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____11352
                      } in
                    let hd21 =
                      let uu___274_11356 = hd2 in
                      let uu____11357 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___274_11356.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___274_11356.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____11701,FStar_Pervasives_Native.Some (t11,t21)) ->
                   solve_t env1
                     (let uu___275_11715 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___275_11715.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___275_11715.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___275_11715.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___275_11715.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___275_11715.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___275_11715.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___275_11715.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___275_11715.FStar_TypeChecker_Common.rank)
                      }) wl1
                                                  ...
                                                  solve_t env1
                                                    (let uu___276_12030 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___276_12030.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___241_13109 =
          match uu___241_13109 with
          | FStar_Pervasives_Native.None  ->
             ...
             ((let uu____16255 =
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed uu____16259,uu____16260) ->
                   let uu____16287 =
                     let uu___277_16288 = problem in
                     let uu____16289 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___277_16288.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16289;
                       FStar_TypeChecker_Common.relation =
                         (uu___277_16288.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___277_16288.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___277_16288.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___277_16288.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___277_16288.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___277_16288.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___277_16288.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___277_16288.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16287 wl
               | (FStar_Syntax_Syntax.Tm_meta uu____16290,uu____16291) ->
                   let uu____16298 =
                     let uu___277_16299 = problem in
                     let uu____16300 = FStar_Syntax_Util.unmeta t1 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___277_16299.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs = uu____16300;
                       FStar_TypeChecker_Common.relation =
                         (uu___277_16299.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs =
                         (uu___277_16299.FStar_TypeChecker_Common.rhs);
                       FStar_TypeChecker_Common.element =
                         (uu___277_16299.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___277_16299.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___277_16299.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___277_16299.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___277_16299.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___277_16299.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16298 wl
               | (uu____16301,FStar_Syntax_Syntax.Tm_ascribed uu____16302) ->
                   let uu____16329 =
                     let uu___278_16330 = problem in
                     let uu____16331 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___278_16330.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___278_16330.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___278_16330.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16331;
                       FStar_TypeChecker_Common.element =
                         (uu___278_16330.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___278_16330.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___278_16330.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___278_16330.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___278_16330.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___278_16330.FStar_TypeChecker_Common.rank)
                     } in
                   solve_t' env uu____16329 wl
               | (uu____16332,FStar_Syntax_Syntax.Tm_meta uu____16333) ->
                   let uu____16340 =
                     let uu___278_16341 = problem in
                     let uu____16342 = FStar_Syntax_Util.unmeta t2 in
                     {
                       FStar_TypeChecker_Common.pid =
                         (uu___278_16341.FStar_TypeChecker_Common.pid);
                       FStar_TypeChecker_Common.lhs =
                         (uu___278_16341.FStar_TypeChecker_Common.lhs);
                       FStar_TypeChecker_Common.relation =
                         (uu___278_16341.FStar_TypeChecker_Common.relation);
                       FStar_TypeChecker_Common.rhs = uu____16342;
                       FStar_TypeChecker_Common.element =
                         (uu___278_16341.FStar_TypeChecker_Common.element);
                       FStar_TypeChecker_Common.logical_guard =
                         (uu___278_16341.FStar_TypeChecker_Common.logical_guard);
                       FStar_TypeChecker_Common.scope =
                         (uu___278_16341.FStar_TypeChecker_Common.scope);
                       FStar_TypeChecker_Common.reason =
                         (uu___278_16341.FStar_TypeChecker_Common.reason);
                       FStar_TypeChecker_Common.loc =
                         (uu___278_16341.FStar_TypeChecker_Common.loc);
                       FStar_TypeChecker_Common.rank =
                         (uu___278_16341.FStar_TypeChecker_Common.rank)
                     } in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___242_16401 =
                     match uu___242_16401 with
                     | [] -> c
                     | bs ->
                         let uu____16423 =
                           FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___243_16652 =
                     match uu___243_16652 with
                     | [] -> t
                     | bs ->
                         FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs uu____16833,uu____16834) ->
                     ...
                     then t
                       ...
                       (let uu____16923 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___279_16931 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___279_16931.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___279_16931.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___279_16931.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___279_16931.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___279_16931.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___279_16931.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___279_16931.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___279_16931.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___279_16931.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___279_16931.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___279_16931.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___279_16931.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___279_16931.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___279_16931.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___279_16931.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___279_16931.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___279_16931.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___279_16931.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___279_16931.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___279_16931.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___279_16931.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___279_16931.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___279_16931.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___279_16931.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___279_16931.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___279_16931.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___279_16931.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___279_16931.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___279_16931.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___279_16931.FStar_TypeChecker_Env.dsenv);
                               FStar_TypeChecker_Env.dep_graph =
                                 (uu___279_16931.FStar_TypeChecker_Env.dep_graph)
                             }) t in
                   ...
                   (match uu____16938 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___280_17004 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___280_17004.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___280_17004.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___280_17004.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___280_17004.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___280_17004.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___280_17004.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___280_17004.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___280_17004.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___281_17043 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___281_17043.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___281_17043.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___281_17043.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___281_17043.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___281_17043.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___281_17043.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___281_17043.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___281_17043.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___281_17083 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___281_17083.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___281_17083.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___281_17083.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___281_17083.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___281_17083.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___281_17083.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___281_17083.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___281_17083.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
               ...
               | (uu____17104,FStar_Syntax_Syntax.Tm_abs uu____17105) ->
                   ...
                   let force_eta t =
                     ...
                     then t
                       ...
                       (let uu____17194 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___279_17202 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___279_17202.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___279_17202.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___279_17202.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___279_17202.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___279_17202.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___279_17202.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 FStar_Pervasives_Native.None;
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___279_17202.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___279_17202.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___279_17202.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___279_17202.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___279_17202.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___279_17202.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___279_17202.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___279_17202.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___279_17202.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___279_17202.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___279_17202.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax = true;
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___279_17202.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.failhard =
                                 (uu___279_17202.FStar_TypeChecker_Env.failhard);
                               FStar_TypeChecker_Env.nosynth =
                                 (uu___279_17202.FStar_TypeChecker_Env.nosynth);
                               FStar_TypeChecker_Env.tc_term =
                                 (uu___279_17202.FStar_TypeChecker_Env.tc_term);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___279_17202.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___279_17202.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___279_17202.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___279_17202.FStar_TypeChecker_Env.proof_ns);
                               FStar_TypeChecker_Env.synth =
                                 (uu___279_17202.FStar_TypeChecker_Env.synth);
                               FStar_TypeChecker_Env.is_native_tactic =
                                 (uu___279_17202.FStar_TypeChecker_Env.is_native_tactic);
                               FStar_TypeChecker_Env.identifier_info =
                                 (uu___279_17202.FStar_TypeChecker_Env.identifier_info);
                               FStar_TypeChecker_Env.tc_hooks =
                                 (uu___279_17202.FStar_TypeChecker_Env.tc_hooks);
                               FStar_TypeChecker_Env.dsenv =
                                 (uu___279_17202.FStar_TypeChecker_Env.dsenv);
                               FStar_TypeChecker_Env.dep_graph =
                                 (uu___279_17202.FStar_TypeChecker_Env.dep_graph)
                             }) t in
                   ...
                   (match uu____17209 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___280_17275 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___280_17275.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___280_17275.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___280_17275.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___280_17275.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___280_17275.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___280_17275.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___280_17275.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___280_17275.FStar_TypeChecker_Common.rank)
                           }) wl
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        let uu____17298 =
                          (is_flex not_abs) &&
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___281_17314 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___281_17314.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___281_17314.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___281_17314.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___281_17314.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___281_17314.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___281_17314.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___281_17314.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___281_17314.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                    ...
                    | (FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        then
                          ...
                          (let t11 = force_eta t1 in
                           ...
                           then
                             solve_t env
                               (let uu___281_17354 = problem in
                                {
                                  FStar_TypeChecker_Common.pid =
                                    (uu___281_17354.FStar_TypeChecker_Common.pid);
                                  FStar_TypeChecker_Common.lhs = t11;
                                  FStar_TypeChecker_Common.relation =
                                    (uu___281_17354.FStar_TypeChecker_Common.relation);
                                  FStar_TypeChecker_Common.rhs = t21;
                                  FStar_TypeChecker_Common.element =
                                    (uu___281_17354.FStar_TypeChecker_Common.element);
                                  FStar_TypeChecker_Common.logical_guard =
                                    (uu___281_17354.FStar_TypeChecker_Common.logical_guard);
                                  FStar_TypeChecker_Common.scope =
                                    (uu___281_17354.FStar_TypeChecker_Common.scope);
                                  FStar_TypeChecker_Common.reason =
                                    (uu___281_17354.FStar_TypeChecker_Common.reason);
                                  FStar_TypeChecker_Common.loc =
                                    (uu___281_17354.FStar_TypeChecker_Common.loc);
                                  FStar_TypeChecker_Common.rank =
                                    (uu___281_17354.FStar_TypeChecker_Common.rank)
                                }) wl
                           else
                             giveup env
                               "head tag mismatch: RHS is an abstraction"
                        ...
                        (match uu____17396 with
                         | (x2,phi2) ->
                             ...
                             then
                               ...
                               let uu____17483 =
                                 solve env1
                                   (let uu___282_17485 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___282_17485.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___282_17485.smt_ok);
                                      tcenv = (uu___282_17485.tcenv)
                                    }) in
                                ...
                                | Success uu____17497 ->
                                    ...
                                    let wl1 =
                                      solve_prob orig
                                        ...
                                        [] wl in
                                    let wl2 =
                                      let uu___283_17516 = wl1 in
                                      {
                                        attempting =
                                          (uu___283_17516.attempting);
                                        wl_deferred =
                                          (uu___283_17516.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___283_17516.defer_ok);
                                        smt_ok = (uu___283_17516.smt_ok);
                                        tcenv = (uu___283_17516.tcenv)
                                      } in
               ...
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17886,FStar_Syntax_Syntax.Tm_type uu____17887) ->
                   solve_t' env
                     (let uu___284_17905 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___284_17905.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___284_17905.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___284_17905.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___284_17905.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___284_17905.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___284_17905.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___284_17905.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___284_17905.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___284_17905.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                  ...
                  uu____17910) ->
                   solve_t' env
                     (let uu___284_17948 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___284_17948.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___284_17948.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___284_17948.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___284_17948.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___284_17948.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___284_17948.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___284_17948.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___284_17948.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___284_17948.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17949,FStar_Syntax_Syntax.Tm_arrow uu____17950) ->
                   solve_t' env
                     (let uu___284_17980 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___284_17980.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___284_17980.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___284_17980.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___284_17980.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___284_17980.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___284_17980.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___284_17980.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___284_17980.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___284_17980.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                  ...
                  uu____17985) ->
                   solve_t' env
                     (let uu___284_18035 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___284_18035.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___284_18035.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___284_18035.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___284_18035.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___284_18035.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___284_18035.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___284_18035.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___284_18035.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___284_18035.FStar_TypeChecker_Common.rank)
                      }) wl
                      ...
                      then
                        let uu____18058 =
                          FStar_All.pipe_left
                            ...
                            (let uu___285_18064 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___285_18064.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___285_18064.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___285_18064.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___285_18064.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___285_18064.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___285_18064.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___285_18064.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___285_18064.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___285_18064.FStar_TypeChecker_Common.rank)
                             }) in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18102 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___286_18108 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___286_18108.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___286_18108.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___286_18108.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___286_18108.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___286_18108.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___286_18108.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___286_18108.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___286_18108.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___286_18108.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18109 =
                              ...
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___287_18123 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___287_18123.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___287_18123.FStar_Syntax_Syntax.index);
                      ...
                      then
                        let uu____18191 =
                          FStar_All.pipe_left
                            ...
                            (let uu___285_18197 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___285_18197.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___285_18197.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___285_18197.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___285_18197.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___285_18197.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___285_18197.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___285_18197.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___285_18197.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___285_18197.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____18206 = base_and_refinement env t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18235 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___286_18241 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___286_18241.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___286_18241.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___286_18241.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___286_18241.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___286_18241.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___286_18241.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___286_18241.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___286_18241.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___286_18241.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18242 =
                                    destruct_flex_pattern env t1 in
                              ...
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___287_18256 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___287_18256.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___287_18256.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort = t1
                                    } in
                                  let impl =
                                    guard_on_element wl problem y' phi in
               ...
               | (uu____18279,FStar_Syntax_Syntax.Tm_uvar uu____18280) ->
                   ...
                   then
                     ...
                     (let uu____18298 = base_and_refinement env t1 in
                      ...
                      | (t_base,uu____18310) ->
                          solve_t env
                            (let uu___288_18324 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___288_18324.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___288_18324.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___288_18324.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___288_18324.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___288_18324.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___288_18324.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___288_18324.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___288_18324.FStar_TypeChecker_Common.rank)
                             }) wl)
                  ...
                  ({
                   ...
                   then
                     ...
                     (let uu____18367 = base_and_refinement env t1 in
                      ...
                      | (t_base,uu____18379) ->
                          solve_t env
                            (let uu___288_18393 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___288_18393.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___288_18393.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___288_18393.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___288_18393.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___288_18393.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___288_18393.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___288_18393.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___288_18393.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____18394,uu____18395) ->
                   ...
                   solve_t env
                     (let uu___289_18429 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___289_18429.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___289_18429.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___289_18429.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___289_18429.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___289_18429.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___289_18429.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___289_18429.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___289_18429.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___289_18429.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____18430,FStar_Syntax_Syntax.Tm_refine uu____18431) ->
                   ...
                   solve_t env
                     (let uu___290_18465 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___290_18465.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___290_18465.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___290_18465.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___290_18465.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___290_18465.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___290_18465.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___290_18465.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___290_18465.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___290_18465.FStar_TypeChecker_Common.rank)
                      }) wl
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu____20808,FStar_Syntax_Syntax.Comp uu____20809) ->
                     let uu____20818 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___291_20823.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____20828;
                         FStar_TypeChecker_Common.relation =
                           (uu___291_20823.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___291_20823.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___291_20823.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___291_20823.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___291_20823.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___291_20823.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___291_20823.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___291_20823.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20818 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____20830,FStar_Syntax_Syntax.Comp uu____20831) ->
                     let uu____20840 =
                       let uu___291_20845 = problem in
                       let uu____20850 =
                         let uu____20851 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___291_20845.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____20850;
                         FStar_TypeChecker_Common.relation =
                           (uu___291_20845.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___291_20845.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___291_20845.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___291_20845.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___291_20845.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___291_20845.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___291_20845.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___291_20845.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20840 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____20852,FStar_Syntax_Syntax.GTotal uu____20853) ->
                     let uu____20862 =
                       let uu___292_20867 = problem in
                       let uu____20872 =
                         let uu____20873 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___292_20867.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___292_20867.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___292_20867.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____20872;
                         FStar_TypeChecker_Common.element =
                           (uu___292_20867.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___292_20867.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___292_20867.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___292_20867.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___292_20867.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___292_20867.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20862 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____20874,FStar_Syntax_Syntax.Total uu____20875) ->
                     let uu____20884 =
                       let uu___292_20889 = problem in
                       let uu____20894 =
                         let uu____20895 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___292_20889.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___292_20889.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___292_20889.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____20894;
                         FStar_TypeChecker_Common.element =
                           (uu___292_20889.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___292_20889.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___292_20889.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___292_20889.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___292_20889.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___292_20889.FStar_TypeChecker_Common.rank)
                       } in
    ...
    fun probs  ->
      fun err1  ->
        let probs1 =
          ...
          if uu____21279
          then
            let uu___293_21280 = probs in
            {
              attempting = (uu___293_21280.attempting);
              wl_deferred = (uu___293_21280.wl_deferred);
              ctr = (uu___293_21280.ctr);
              defer_ok = false;
              smt_ok = (uu___293_21280.smt_ok);
              tcenv = (uu___293_21280.tcenv)
            }
          else probs in
        let tx = FStar_Syntax_Unionfind.new_transaction () in
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____21306 =
            ...
            if uu____21306
            then
              let uu____21307 = FStar_Syntax_Print.term_to_string f in
           ...
           (let f1 =
            ...
            (let uu____21311 =
             ...
             if uu____21311
             then
               let uu____21312 = FStar_Syntax_Print.term_to_string f1 in
               FStar_Util.print1 "Simplified guard to %s\n" uu____21312
             else ());
            (let f2 =
               let uu____21315 =
                 let uu____21316 = FStar_Syntax_Util.unmeta f1 in
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____21320 -> FStar_TypeChecker_Common.NonTrivial f1 in
             let uu___294_21321 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___294_21321.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___294_21321.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___294_21321.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____21340 =
              let uu____21341 =
                ...
                {
                  FStar_TypeChecker_Env.guard_f = uu____21342;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____21341 in
            FStar_All.pipe_left
              (fun _0_94  -> FStar_Pervasives_Native.Some _0_94) uu____21340
      ...
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____21390 =
              ...
              {
                FStar_TypeChecker_Env.guard_f = uu____21391;
                FStar_TypeChecker_Env.deferred = d;
                FStar_TypeChecker_Env.univ_ineqs = ([], []);
                FStar_TypeChecker_Env.implicits = []
              } in
            FStar_Pervasives_Native.Some uu____21390
let try_teq:
  Prims.bool ->
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.typ ->
      ...
      fun t1  ->
        fun t2  ->
          (let uu____21430 =
           ...
           if uu____21430
           then
             let uu____21431 = FStar_Syntax_Print.term_to_string t1 in
             let uu____21432 = FStar_Syntax_Print.term_to_string t2 in
          ...
          (let prob =
             let uu____21435 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____21440 in
             FStar_All.pipe_left
               (fun _0_96  -> FStar_TypeChecker_Common.TProb _0_96)
               uu____21435 in
           let g =
             let uu____21448 =
               let uu____21451 = singleton' env prob smt_ok in
               solve_and_commit env uu____21451
                 (fun uu____21453  -> FStar_Pervasives_Native.None) in
             FStar_All.pipe_left (with_guard env prob) uu____21448 in
           g)
let teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____21471 = try_teq true env t1 t2 in
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____21474 =
              let uu____21475 =
                ...
                let uu____21481 = FStar_TypeChecker_Env.get_range env in
                (uu____21480, uu____21481) in
              FStar_Errors.Error uu____21475 in
            FStar_Exn.raise uu____21474
        | FStar_Pervasives_Native.Some g ->
            ((let uu____21484 =
              ...
              if uu____21484
              then
                let uu____21485 = FStar_Syntax_Print.term_to_string t1 in
                let uu____21486 = FStar_Syntax_Print.term_to_string t2 in
                let uu____21487 = guard_to_string env g in
                FStar_Util.print3
    ...
    fun e  ->
      fun t1  ->
        fun t2  ->
          ...
          FStar_Errors.err uu____21501 uu____21502
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
      FStar_Syntax_Syntax.comp ->
         ...
         let prob =
           let uu____21522 =
             ...
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____21527 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_97  -> FStar_TypeChecker_Common.CProb _0_97) uu____21522 in
         let uu____21532 =
           let uu____21535 = singleton env prob in
           solve_and_commit env uu____21535
             (fun uu____21537  -> FStar_Pervasives_Native.None) in
         FStar_All.pipe_left (with_guard env prob) uu____21532)
    ...
    fun env  ->
      fun uu____21566  ->
        ...
        | (variables,ineqs) ->
                 ...
                 let uu____21606 =
                   let uu____21611 =
                     ...
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____21612 uu____21613 in
                   let uu____21614 = FStar_TypeChecker_Env.get_range env in
                   (uu____21611, uu____21614) in
                 FStar_Errors.Error uu____21606 in
               FStar_Exn.raise uu____21605) in
            let equiv1 v1 v' =
              let uu____21622 =
                let uu____21627 = FStar_Syntax_Subst.compress_univ v1 in
                let uu____21628 = FStar_Syntax_Subst.compress_univ v' in
                (uu____21627, uu____21628) in
              match uu____21622 with
              | (FStar_Syntax_Syntax.U_unif v0,FStar_Syntax_Syntax.U_unif
                 v0') -> FStar_Syntax_Unionfind.univ_equiv v0 v0'
              | uu____21647 -> false in
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____21677 = FStar_Syntax_Subst.compress_univ v1 in
                      match uu____21677 with
                      | FStar_Syntax_Syntax.U_unif uu____21684 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____21713  ->
                                    ...
                                    | (u,v') ->
                                        let uu____21722 = equiv1 v1 v' in
                                        if uu____21722
                                        then
                                          let uu____21725 =
                                            FStar_All.pipe_right variables
                                              (FStar_Util.for_some (equiv1 u)) in
                                          (if uu____21725 then [] else [u])
                                        else [])) in
                          let lb =
            ...
            let uu____21746 =
              let wl =
                let uu___295_21750 = empty_worklist env in
                {
                  attempting = (uu___295_21750.attempting);
                  wl_deferred = (uu___295_21750.wl_deferred);
                  ctr = (uu___295_21750.ctr);
                  defer_ok = false;
                  smt_ok = (uu___295_21750.smt_ok);
                  tcenv = (uu___295_21750.tcenv)
                } in
                   ...
                   (fun uu____21768  ->
                      ...
                      | (lb,v1) ->
                          ...
                          (match uu____21775 with
                           | USolved wl1 -> ()
                           | uu____21777 -> fail lb v1))) in
            let rec check_ineq uu____21785 =
              ...
              | (u,v1) ->
                  ...
                  (match (u1, v2) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____21794) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu____21817,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu____21819,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_max us,uu____21830) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u2  -> check_ineq (u2, v2)))
                   | (uu____21837,FStar_Syntax_Syntax.U_max vs) ->
                       FStar_All.pipe_right vs
                         (FStar_Util.for_some
                            (fun v3  -> check_ineq (u1, v3)))
                   | uu____21845 -> false) in
            let uu____21850 =
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____21865  ->
                      ...
                      | (u,v1) ->
                          let uu____21872 = check_ineq (u, v1) in
                          if uu____21872
                          then true
                          else
                            ((let uu____21875 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____21876
                                  uu____21877
                              else ());
                             false))) in
            if uu____21850
            then ()
              ...
              ((let uu____21881 =
                ...
                if uu____21881
                then
                  ((let uu____21883 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
                      "Partially solved inequality constraints are: %s\n"
                      uu____21883);
                   FStar_Syntax_Unionfind.rollback tx;
                   (let uu____21893 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
               ...
               (let uu____21903 =
                  let uu____21904 =
                    ...
                    ("Failed to solve universe inequalities for inductives",
                      uu____21909) in
                  FStar_Errors.Error uu____21904 in
                FStar_Exn.raise uu____21903))
let solve_universe_inequalities:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.universe Prims.list,(FStar_Syntax_Syntax.universe,
                                               FStar_Syntax_Syntax.universe)
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____21971 =
       ...
       if uu____21971
       then
         let uu____21972 = wl_to_string wl in
         let uu____21973 =
           FStar_Util.string_of_int
             (FStar_List.length g.FStar_TypeChecker_Env.implicits) in
         FStar_Util.print2
           "Trying to solve carried problems: begin\n\t%s\nend\n and %s implicits\n"
           uu____21972 uu____21973
       else ());
      (let g1 =
         let uu____21988 = solve_and_commit env wl fail in
         match uu____21988 with
         | FStar_Pervasives_Native.Some [] ->
             let uu___296_22001 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___296_22001.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___296_22001.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___296_22001.FStar_TypeChecker_Env.implicits)
             }
         | uu____22006 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___297_22010 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___297_22010.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___297_22010.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___297_22010.FStar_TypeChecker_Env.implicits)
        }))
let last_proof_ns:
...
let maybe_update_proof_ns: FStar_TypeChecker_Env.env -> Prims.unit =
  fun env  ->
    ...
    let uu____22032 = FStar_ST.op_Bang last_proof_ns in
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___298_22216 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___298_22216.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___298_22216.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___298_22216.FStar_TypeChecker_Env.implicits)
            } in
          let uu____22217 =
            let uu____22218 = FStar_TypeChecker_Env.should_verify env in
            Prims.op_Negation uu____22218 in
          if uu____22217
                 ...
                 (if debug1
                  then
                    (let uu____22226 = FStar_TypeChecker_Env.get_range env in
                     let uu____22227 =
                       let uu____22228 = FStar_Syntax_Print.term_to_string vc in
                       FStar_Util.format1 "Before normalization VC=\n%s\n"
                         uu____22228 in
                     FStar_Errors.diag uu____22226 uu____22227)
                  else ();
                  (let vc1 =
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Normalize.Eager_unfolding;
                   ...
                   if debug1
                   then
                     (let uu____22232 = FStar_TypeChecker_Env.get_range env in
                      let uu____22233 =
                        let uu____22234 =
                          FStar_Syntax_Print.term_to_string vc1 in
                        FStar_Util.format1 "After normalization VC=\n%s\n"
                          uu____22234 in
                      FStar_Errors.diag uu____22232 uu____22233)
                   else ();
                   (let uu____22236 = check_trivial vc1 in
                             ...
                             (let uu____22243 =
                              ...
                              let uu____22244 =
                                ...
                                FStar_Util.format1
                                  ...
                                  uu____22245 in
                              FStar_Errors.diag uu____22243 uu____22244)
                           else ();
                           FStar_Pervasives_Native.None)
                        else
                          (if debug1
                           ...
                           (let vcs =
                              let uu____22263 = FStar_Options.use_tactics () in
                              if uu____22263
                              then
                                FStar_Options.with_saved_options
                                  (fun uu____22282  ->
                                     (let uu____22284 =
                                      ...
                                      FStar_All.pipe_left
                                        FStar_Pervasives.ignore uu____22284);
                                     (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.preprocess
                                       env vc2)
                              else
                                (let uu____22286 =
                                   let uu____22293 = FStar_Options.peek () in
                                   (env, vc2, uu____22293) in
                                 [uu____22286]) in
                                    ...
                                    | (env1,goal,opts) ->
                                        let goal1 =
                                          FStar_TypeChecker_Normalize.normalize
                                            ...
                                            env1 goal in
                                        let uu____22338 = check_trivial goal1 in
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____22370 =
            let uu____22371 =
              let uu____22376 = FStar_TypeChecker_Env.get_range env in
              ("Expected a trivial pre-condition", uu____22376) in
            FStar_Errors.Error uu____22371 in
          FStar_Exn.raise uu____22370
let discharge_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t
  =
...
let resolve_implicits':
  ...
  fun must_total  ->
    fun forcelax  ->
      fun g  ->
        let unresolved u =
          let uu____22402 = FStar_Syntax_Unionfind.find u in
          match uu____22402 with
          | FStar_Pervasives_Native.None  -> true
          | uu____22405 -> false in
        let rec until_fixpoint acc implicits =
          let uu____22423 = acc in
          ...
          | (out,changed) ->
              (match implicits with
               ...
               | hd1::tl1 ->
                   let uu____22509 = hd1 in
                   (match uu____22509 with
                    | (uu____22522,env,u,tm,k,r) ->
                        let uu____22528 = unresolved u in
                        if uu____22528
                           ...
                           (let uu____22559 =
                            ...
                            then
                              ...
                              FStar_Util.print3
                                ...
                                uu____22560 uu____22561 uu____22562
                            else ());
                           (let env2 =
                              if forcelax
                              then
                                let uu___299_22565 = env1 in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___299_22565.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___299_22565.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___299_22565.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___299_22565.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___299_22565.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___299_22565.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___299_22565.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___299_22565.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___299_22565.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___299_22565.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___299_22565.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___299_22565.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___299_22565.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___299_22565.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___299_22565.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___299_22565.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___299_22565.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___299_22565.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax = true;
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___299_22565.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.failhard =
                                    (uu___299_22565.FStar_TypeChecker_Env.failhard);
                                  FStar_TypeChecker_Env.nosynth =
                                    (uu___299_22565.FStar_TypeChecker_Env.nosynth);
                                  FStar_TypeChecker_Env.tc_term =
                                    (uu___299_22565.FStar_TypeChecker_Env.tc_term);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___299_22565.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___299_22565.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts =
                                    (uu___299_22565.FStar_TypeChecker_Env.use_bv_sorts);
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___299_22565.FStar_TypeChecker_Env.qname_and_index);
                                  FStar_TypeChecker_Env.proof_ns =
                                    (uu___299_22565.FStar_TypeChecker_Env.proof_ns);
                                  FStar_TypeChecker_Env.synth =
                                    (uu___299_22565.FStar_TypeChecker_Env.synth);
                                  FStar_TypeChecker_Env.is_native_tactic =
                                    (uu___299_22565.FStar_TypeChecker_Env.is_native_tactic);
                                  FStar_TypeChecker_Env.identifier_info =
                                    (uu___299_22565.FStar_TypeChecker_Env.identifier_info);
                                  FStar_TypeChecker_Env.tc_hooks =
                                    (uu___299_22565.FStar_TypeChecker_Env.tc_hooks);
                                  FStar_TypeChecker_Env.dsenv =
                                    (uu___299_22565.FStar_TypeChecker_Env.dsenv);
                                  FStar_TypeChecker_Env.dep_graph =
                                    (uu___299_22565.FStar_TypeChecker_Env.dep_graph)
                                }
                              else env1 in
                            let g1 =
                              try
                                ...
                                then
                                  let uu____22574 =
                                    env2.FStar_TypeChecker_Env.type_of
                                      (let uu___302_22582 = env2 in
                                       {
                                         FStar_TypeChecker_Env.solver =
                                           (uu___302_22582.FStar_TypeChecker_Env.solver);
                                         FStar_TypeChecker_Env.range =
                                           (uu___302_22582.FStar_TypeChecker_Env.range);
                                         FStar_TypeChecker_Env.curmodule =
                                           (uu___302_22582.FStar_TypeChecker_Env.curmodule);
                                         FStar_TypeChecker_Env.gamma =
                                           (uu___302_22582.FStar_TypeChecker_Env.gamma);
                                         FStar_TypeChecker_Env.gamma_cache =
                                           (uu___302_22582.FStar_TypeChecker_Env.gamma_cache);
                                         FStar_TypeChecker_Env.modules =
                                           (uu___302_22582.FStar_TypeChecker_Env.modules);
                                         FStar_TypeChecker_Env.expected_typ =
                                           (uu___302_22582.FStar_TypeChecker_Env.expected_typ);
                                         FStar_TypeChecker_Env.sigtab =
                                           (uu___302_22582.FStar_TypeChecker_Env.sigtab);
                                         FStar_TypeChecker_Env.is_pattern =
                                           (uu___302_22582.FStar_TypeChecker_Env.is_pattern);
                                         FStar_TypeChecker_Env.instantiate_imp
                                           =
                                           (uu___302_22582.FStar_TypeChecker_Env.instantiate_imp);
                                         FStar_TypeChecker_Env.effects =
                                           (uu___302_22582.FStar_TypeChecker_Env.effects);
                                         FStar_TypeChecker_Env.generalize =
                                           (uu___302_22582.FStar_TypeChecker_Env.generalize);
                                         FStar_TypeChecker_Env.letrecs =
                                           (uu___302_22582.FStar_TypeChecker_Env.letrecs);
                                         FStar_TypeChecker_Env.top_level =
                                           (uu___302_22582.FStar_TypeChecker_Env.top_level);
                                         FStar_TypeChecker_Env.check_uvars =
                                           (uu___302_22582.FStar_TypeChecker_Env.check_uvars);
                                         FStar_TypeChecker_Env.use_eq =
                                           (uu___302_22582.FStar_TypeChecker_Env.use_eq);
                                         FStar_TypeChecker_Env.is_iface =
                                           (uu___302_22582.FStar_TypeChecker_Env.is_iface);
                                         FStar_TypeChecker_Env.admit =
                                           (uu___302_22582.FStar_TypeChecker_Env.admit);
                                         FStar_TypeChecker_Env.lax =
                                           (uu___302_22582.FStar_TypeChecker_Env.lax);
                                         FStar_TypeChecker_Env.lax_universes
                                           =
                                           (uu___302_22582.FStar_TypeChecker_Env.lax_universes);
                                         FStar_TypeChecker_Env.failhard =
                                           (uu___302_22582.FStar_TypeChecker_Env.failhard);
                                         FStar_TypeChecker_Env.nosynth =
                                           (uu___302_22582.FStar_TypeChecker_Env.nosynth);
                                         FStar_TypeChecker_Env.tc_term =
                                           (uu___302_22582.FStar_TypeChecker_Env.tc_term);
                                         FStar_TypeChecker_Env.type_of =
                                           (uu___302_22582.FStar_TypeChecker_Env.type_of);
                                         FStar_TypeChecker_Env.universe_of =
                                           (uu___302_22582.FStar_TypeChecker_Env.universe_of);
                                         FStar_TypeChecker_Env.use_bv_sorts =
                                           true;
                                         FStar_TypeChecker_Env.qname_and_index
                                           =
                                           (uu___302_22582.FStar_TypeChecker_Env.qname_and_index);
                                         FStar_TypeChecker_Env.proof_ns =
                                           (uu___302_22582.FStar_TypeChecker_Env.proof_ns);
                                         FStar_TypeChecker_Env.synth =
                                           (uu___302_22582.FStar_TypeChecker_Env.synth);
                                         FStar_TypeChecker_Env.is_native_tactic
                                           =
                                           (uu___302_22582.FStar_TypeChecker_Env.is_native_tactic);
                                         FStar_TypeChecker_Env.identifier_info
                                           =
                                           (uu___302_22582.FStar_TypeChecker_Env.identifier_info);
                                         FStar_TypeChecker_Env.tc_hooks =
                                           (uu___302_22582.FStar_TypeChecker_Env.tc_hooks);
                                         FStar_TypeChecker_Env.dsenv =
                                           (uu___302_22582.FStar_TypeChecker_Env.dsenv);
                                         FStar_TypeChecker_Env.dep_graph =
                                           (uu___302_22582.FStar_TypeChecker_Env.dep_graph)
                                       }) tm1 in
                                  match uu____22574 with
                                  | (uu____22583,uu____22584,g1) -> g1
                                else
                                  (let uu____22587 =
                                     env2.FStar_TypeChecker_Env.tc_term
                                       (let uu___303_22595 = env2 in
                                        {
                                          FStar_TypeChecker_Env.solver =
                                            (uu___303_22595.FStar_TypeChecker_Env.solver);
                                          FStar_TypeChecker_Env.range =
                                            (uu___303_22595.FStar_TypeChecker_Env.range);
                                          FStar_TypeChecker_Env.curmodule =
                                            (uu___303_22595.FStar_TypeChecker_Env.curmodule);
                                          FStar_TypeChecker_Env.gamma =
                                            (uu___303_22595.FStar_TypeChecker_Env.gamma);
                                          FStar_TypeChecker_Env.gamma_cache =
                                            (uu___303_22595.FStar_TypeChecker_Env.gamma_cache);
                                          FStar_TypeChecker_Env.modules =
                                            (uu___303_22595.FStar_TypeChecker_Env.modules);
                                          FStar_TypeChecker_Env.expected_typ
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.expected_typ);
                                          FStar_TypeChecker_Env.sigtab =
                                            (uu___303_22595.FStar_TypeChecker_Env.sigtab);
                                          FStar_TypeChecker_Env.is_pattern =
                                            (uu___303_22595.FStar_TypeChecker_Env.is_pattern);
                                          FStar_TypeChecker_Env.instantiate_imp
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.instantiate_imp);
                                          FStar_TypeChecker_Env.effects =
                                            (uu___303_22595.FStar_TypeChecker_Env.effects);
                                          FStar_TypeChecker_Env.generalize =
                                            (uu___303_22595.FStar_TypeChecker_Env.generalize);
                                          FStar_TypeChecker_Env.letrecs =
                                            (uu___303_22595.FStar_TypeChecker_Env.letrecs);
                                          FStar_TypeChecker_Env.top_level =
                                            (uu___303_22595.FStar_TypeChecker_Env.top_level);
                                          FStar_TypeChecker_Env.check_uvars =
                                            (uu___303_22595.FStar_TypeChecker_Env.check_uvars);
                                          FStar_TypeChecker_Env.use_eq =
                                            (uu___303_22595.FStar_TypeChecker_Env.use_eq);
                                          FStar_TypeChecker_Env.is_iface =
                                            (uu___303_22595.FStar_TypeChecker_Env.is_iface);
                                          FStar_TypeChecker_Env.admit =
                                            (uu___303_22595.FStar_TypeChecker_Env.admit);
                                          FStar_TypeChecker_Env.lax =
                                            (uu___303_22595.FStar_TypeChecker_Env.lax);
                                          FStar_TypeChecker_Env.lax_universes
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.lax_universes);
                                          FStar_TypeChecker_Env.failhard =
                                            (uu___303_22595.FStar_TypeChecker_Env.failhard);
                                          FStar_TypeChecker_Env.nosynth =
                                            (uu___303_22595.FStar_TypeChecker_Env.nosynth);
                                          FStar_TypeChecker_Env.tc_term =
                                            (uu___303_22595.FStar_TypeChecker_Env.tc_term);
                                          FStar_TypeChecker_Env.type_of =
                                            (uu___303_22595.FStar_TypeChecker_Env.type_of);
                                          FStar_TypeChecker_Env.universe_of =
                                            (uu___303_22595.FStar_TypeChecker_Env.universe_of);
                                          FStar_TypeChecker_Env.use_bv_sorts
                                            = true;
                                          FStar_TypeChecker_Env.qname_and_index
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.qname_and_index);
                                          FStar_TypeChecker_Env.proof_ns =
                                            (uu___303_22595.FStar_TypeChecker_Env.proof_ns);
                                          FStar_TypeChecker_Env.synth =
                                            (uu___303_22595.FStar_TypeChecker_Env.synth);
                                          FStar_TypeChecker_Env.is_native_tactic
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.is_native_tactic);
                                          FStar_TypeChecker_Env.identifier_info
                                            =
                                            (uu___303_22595.FStar_TypeChecker_Env.identifier_info);
                                          FStar_TypeChecker_Env.tc_hooks =
                                            (uu___303_22595.FStar_TypeChecker_Env.tc_hooks);
                                          FStar_TypeChecker_Env.dsenv =
                                            (uu___303_22595.FStar_TypeChecker_Env.dsenv);
                                          FStar_TypeChecker_Env.dep_graph =
                                            (uu___303_22595.FStar_TypeChecker_Env.dep_graph)
                                        }) tm1 in
                                   match uu____22587 with
                                   | (uu____22596,uu____22597,g1) -> g1)
                              with
                              | e ->
                                  ((let uu____22605 =
                                      let uu____22612 =
                                        let uu____22617 =
                                          ...
                                          FStar_Util.format2
                                            ...
                                            uu____22618 uu____22619 in
                                        (uu____22617, r) in
                                      [uu____22612] in
                                    FStar_Errors.add_errors uu____22605);
                                   FStar_Exn.raise e) in
                            let g2 =
                              if env2.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___304_22629 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___304_22629.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___304_22629.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___304_22629.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____22632 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
        let uu___305_22666 = g in
        let uu____22667 =
          until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___305_22666.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___305_22666.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs =
            (uu___305_22666.FStar_TypeChecker_Env.univ_ineqs);
          FStar_TypeChecker_Env.implicits = uu____22667
        }
let resolve_implicits:
  FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t =
...
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____22721 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____22721 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____22734 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____22734
      | (reason,uu____22736,uu____22737,e,t,r)::uu____22741 ->
          let uu____22768 =
            let uu____22769 =
              let uu____22774 =
                let uu____22775 = FStar_Syntax_Print.term_to_string t in
                let uu____22776 = FStar_Syntax_Print.term_to_string e in
                FStar_Util.format2
                  "Failed to resolve implicit argument of type '%s' introduced in %s"
                  uu____22775 uu____22776 in
              (uu____22774, r) in
            FStar_Errors.Error uu____22769 in
          FStar_Exn.raise uu____22768
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___306_22783 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___306_22783.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___306_22783.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___306_22783.FStar_TypeChecker_Env.implicits)
      }
let discharge_guard_nosmt:
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.Some uu____22811 -> true
...
let teq_nosmt:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22821 = try_teq false env t1 t2 in
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____22845 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2 in
         match uu____22845 with
         | (prob,x) ->
             let g =
               let uu____22861 =
                 let uu____22864 = singleton' env prob true in
                 solve_and_commit env uu____22864
                   (fun uu____22866  -> FStar_Pervasives_Native.None) in
               FStar_All.pipe_left (with_guard env prob) uu____22861 in
             ((let uu____22876 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____22878 =
                   FStar_TypeChecker_Normalize.term_to_string env t2 in
                 let uu____22879 =
                   let uu____22880 = FStar_Util.must g in
                   guard_to_string env uu____22880 in
                 FStar_Util.print3
...
let get_subtyping_predicate:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22908 = check_subtyping env t1 t2 in
        match uu____22908 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____22927 =
              let uu____22928 = FStar_Syntax_Syntax.mk_binder x in
              abstract_guard uu____22928 g in
            FStar_Pervasives_Native.Some uu____22927
let get_subtyping_prop:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22940 = check_subtyping env t1 t2 in
        match uu____22940 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____22959 =
              let uu____22960 =
                let uu____22961 = FStar_Syntax_Syntax.mk_binder x in
                [uu____22961] in
              close_guard env uu____22960 g in
            FStar_Pervasives_Native.Some uu____22959
let subtype_nosmt:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ -> Prims.bool
  =
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____22976 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2 in
         match uu____22976 with
         | (prob,x) ->
             let g =
               let uu____22986 =
                 let uu____22989 = singleton' env prob false in
                 solve_and_commit env uu____22989
                   (fun uu____22991  -> FStar_Pervasives_Native.None) in
               FStar_All.pipe_left (with_guard env prob) uu____22986 in
             (match g with
              | FStar_Pervasives_Native.None  -> false
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____23002 =
                      let uu____23003 = FStar_Syntax_Syntax.mk_binder x in
                      [uu____23003] in
                    close_guard env uu____23002 g1 in
