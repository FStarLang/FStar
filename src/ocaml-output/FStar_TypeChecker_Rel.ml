...
let args_to_string = (fun args -> (let _146_131 = (FStar_All.pipe_right args (FStar_List.map (fun _55_96 -> (match (_55_96) with
| (x, _55_95) -> begin
...
in (let _146_146 = (FStar_List.map Prims.snd g)
in {attempting = _146_146; wl_deferred = _55_107.wl_deferred; ctr = _55_107.ctr; defer_ok = false; smt_ok = _55_107.smt_ok; tcenv = _55_107.tcenv})))
...
(let _146_163 = (prob_to_string env prob)
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(FStar_All.pipe_right (maybe_invert p) (fun _146_170 -> FStar_TypeChecker_Common.TProb (_146_170)))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(FStar_All.pipe_right (maybe_invert p) (fun _146_171 -> FStar_TypeChecker_Common.CProb (_146_171)))
end))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(FStar_All.pipe_left (fun _146_190 -> FStar_TypeChecker_Common.TProb (_146_190)) (invert p))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(FStar_All.pipe_left (fun _146_191 -> FStar_TypeChecker_Common.CProb (_146_191)) (invert p))
end))
...
let mk_problem = (fun scope orig lhs rel rhs elt reason -> (let _146_204 = (next_pid ())
in (let _146_203 = (new_uvar (p_loc orig) scope FStar_Syntax_Util.ktype0)
in {FStar_TypeChecker_Common.pid = _146_204; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = _146_203; FStar_TypeChecker_Common.scope = scope; FStar_TypeChecker_Common.reason = (reason)::(p_reason orig); FStar_TypeChecker_Common.loc = (p_loc orig); FStar_TypeChecker_Common.rank = None})))


let new_problem = (fun env lhs rel rhs elt loc reason -> (

let scope = (FStar_TypeChecker_Env.all_binders env)
in (let _146_214 = (next_pid ())
in (let _146_213 = (let _146_212 = (FStar_TypeChecker_Env.get_range env)
in (new_uvar _146_212 scope FStar_Syntax_Util.ktype0))
in {FStar_TypeChecker_Common.pid = _146_214; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = _146_213; FStar_TypeChecker_Common.scope = scope; FStar_TypeChecker_Common.reason = (reason)::[]; FStar_TypeChecker_Common.loc = loc; FStar_TypeChecker_Common.rank = None}))))


let problem_using_guard = (fun orig lhs rel rhs elt reason -> (let _146_221 = (next_pid ())
in {FStar_TypeChecker_Common.pid = _146_221; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = (p_guard orig); FStar_TypeChecker_Common.scope = (p_scope orig); FStar_TypeChecker_Common.reason = (reason)::(p_reason orig); FStar_TypeChecker_Common.loc = (p_loc orig); FStar_TypeChecker_Common.rank = None}))
...
(let _146_233 = (FStar_All.pipe_left FStar_Range.string_of_range (p_loc d))
in (let _146_232 = (prob_to_string env d)
in (let _146_231 = (FStar_All.pipe_right (p_reason d) (FStar_String.concat "\n\t>"))
in (FStar_Util.format4 "(%s) Failed to solve the sub-problem\n%s\nWhich arose because:\n\t%s\nFailed because:%s\n" _146_233 _146_232 _146_231 s))))
end else begin
(
...
(let _146_235 = (FStar_Syntax_Print.term_to_string tp.FStar_TypeChecker_Common.lhs)
in (let _146_234 = (FStar_Syntax_Print.term_to_string tp.FStar_TypeChecker_Common.rhs)
in (_146_235, _146_234)))
end
| FStar_TypeChecker_Common.CProb (cp) -> begin
(let _146_237 = (FStar_Syntax_Print.comp_to_string cp.FStar_TypeChecker_Common.lhs)
in (let _146_236 = (FStar_Syntax_Print.comp_to_string cp.FStar_TypeChecker_Common.rhs)
in (_146_237, _146_236)))
end)
...
let whnf : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _146_256 = (let _146_255 = (FStar_Syntax_Util.unmeta t)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.WHNF)::[]) env _146_255))
in (FStar_Syntax_Subst.compress _146_256)))


let sn : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _146_261 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env t)
in (FStar_Syntax_Subst.compress _146_261)))


let norm_arg = (fun env t -> (let _146_264 = (sn env (Prims.fst t))
in (_146_264, (Prims.snd t))))
...
let _55_274 = x
in (let _146_270 = (sn env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_274.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_274.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_270}))
in (_146_271, imp))
end)))))
...
(let _146_278 = (aux u)
in FStar_Syntax_Syntax.U_succ (_146_278))
end
| FStar_Syntax_Syntax.U_max (us) -> begin
(let _146_279 = (FStar_List.map aux us)
in FStar_Syntax_Syntax.U_max (_146_279))
end
| _55_286 -> begin
u
end)))
in (let _146_280 = (aux u)
in (FStar_TypeChecker_Normalize.normalize_universe wl.tcenv _146_280))))
...
| tt -> begin
(let _146_294 = (let _146_293 = (FStar_Syntax_Print.term_to_string tt)
in (let _146_292 = (FStar_Syntax_Print.tag_of_term tt)
in (FStar_Util.format2 "impossible: Got %s ... %s\n" _146_293 _146_292)))
in (FStar_All.failwith _146_294))
end)
end
end
...
in (match ((let _146_295 = (FStar_Syntax_Subst.compress t1')
in _146_295.FStar_Syntax_Syntax.n)) with
...
(let _146_298 = (let _146_297 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_296 = (FStar_Syntax_Print.tag_of_term t1)
in (FStar_Util.format2 "impossible (outer): Got %s ... %s\n" _146_297 _146_296)))
in (FStar_All.failwith _146_298))
end))
in (let _146_299 = (whnf env t1)
in (aux false _146_299))))


let unrefine : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ = (fun env t -> (let _146_304 = (base_and_refinement env (empty_worklist env) t)
in (FStar_All.pipe_right _146_304 Prims.fst)))


let trivial_refinement : FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.term) = (fun t -> (let _146_307 = (FStar_Syntax_Syntax.null_bv t)
in (_146_307, FStar_Syntax_Util.t_true)))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _146_320 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _146_319 = (let _146_316 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (FStar_Syntax_Print.term_to_string _146_316))
in (let _146_318 = (let _146_317 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Syntax_Print.term_to_string _146_317))
in (FStar_Util.format4 "%s: %s  (%s)  %s" _146_320 _146_319 (rel_to_string p.FStar_TypeChecker_Common.relation) _146_318))))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(let _146_323 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _146_322 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _146_321 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Util.format4 "%s: %s  (%s)  %s" _146_323 _146_322 (rel_to_string p.FStar_TypeChecker_Common.relation) _146_321))))
end))


let wl_to_string : worklist  ->  Prims.string = (fun wl -> (let _146_329 = (let _146_328 = (let _146_327 = (FStar_All.pipe_right wl.wl_deferred (FStar_List.map (fun _55_402 -> (match (_55_402) with
| (_55_398, _55_400, x) -> begin
x
end))))
in (FStar_List.append wl.attempting _146_327))
in (FStar_List.map (wl_prob_to_string wl) _146_328))
in (FStar_All.pipe_right _146_329 (FStar_String.concat "\n\t"))))
...
let _55_421 = (match ((let _146_336 = (FStar_Syntax_Subst.compress k)
in _146_336.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if ((FStar_List.length bs) = (FStar_List.length ys)) then begin
(let _146_337 = (FStar_Syntax_Subst.open_comp bs c)
in ((ys, t), _146_337))
end else begin
(
...
| (ys', t) -> begin
(let _146_338 = (FStar_Syntax_Util.arrow_formals_comp k)
in (((FStar_List.append ys ys'), t), _146_338))
end))
end
end
| _55_414 -> begin
(let _146_340 = (let _146_339 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _146_339))
in ((ys, t), _146_340))
end)
...
let c = (let _146_341 = (FStar_Syntax_Util.rename_binders xs ys)
in (FStar_Syntax_Subst.subst_comp _146_341 c))
in (let _146_345 = (let _146_344 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_342 -> FStar_Util.Inl (_146_342)))
in (FStar_All.pipe_right _146_344 (fun _146_343 -> Some (_146_343))))
in (FStar_Syntax_Util.abs ys t _146_345)))
end
end)))
...
let _55_446 = (match ((let _146_356 = (FStar_Syntax_Subst.compress uv)
in _146_356.FStar_Syntax_Syntax.n)) with
...
(let _146_359 = (FStar_Util.string_of_int (p_pid prob))
in (let _146_358 = (FStar_Syntax_Print.term_to_string uv)
in (let _146_357 = (FStar_Syntax_Print.term_to_string phi)
in (FStar_Util.print3 "Solving %s (%s) with formula %s\n" _146_359 _146_358 _146_357))))
end else begin
()
end
...
(let _146_368 = (FStar_Util.string_of_int pid)
in (let _146_367 = (let _146_366 = (FStar_List.map (uvi_to_string wl.tcenv) sol)
in (FStar_All.pipe_right _146_366 (FStar_String.concat ", ")))
...
(let _146_381 = (FStar_Syntax_Util.mk_conj t f)
in Some (_146_381))
end))
in (

let _55_481 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("RelCheck"))) then begin
(let _146_384 = (FStar_All.pipe_left FStar_Util.string_of_int (p_pid prob))
in (let _146_383 = (let _146_382 = (FStar_List.map (uvi_to_string wl.tcenv) uvis)
in (FStar_All.pipe_right _146_382 (FStar_String.concat ", ")))
in (FStar_Util.print2 "Solving %s: with %s\n" _146_384 _146_383)))
end else begin
()
end
...
let rec occurs = (fun wl uk t -> (let _146_394 = (let _146_392 = (FStar_Syntax_Free.uvars t)
in (FStar_All.pipe_right _146_392 FStar_Util.set_elements))
in (FStar_All.pipe_right _146_394 (FStar_Util.for_some (fun _55_490 -> (match (_55_490) with
| (uv, _55_489) -> begin
...
(let _146_401 = (let _146_400 = (FStar_Syntax_Print.uvar_to_string (Prims.fst uk))
in (let _146_399 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "occurs-check failed (%s occurs in %s)" _146_400 _146_399)))
in Some (_146_401))
end
in (occurs_ok, msg))))
...
| (occurs_ok, msg) -> begin
(let _146_407 = (FStar_Util.set_is_subset_of fvs_t fvs)
in (occurs_ok, _146_407, (msg, fvs, fvs_t)))
end))))
...
if (let _146_416 = (FStar_Util.set_mem x v1_set)
in (FStar_All.pipe_left Prims.op_Negation _146_416)) then begin
(isect, isect_set)
end else begin
(
...
(let _146_417 = (FStar_Util.set_add x isect_set)
in (((x, imp))::isect, _146_417))
end else begin
(isect, isect_set)
end)
end
...
(let _146_432 = (FStar_All.pipe_left FStar_Syntax_Print.term_to_string (Prims.fst hd))
...
(let _146_468 = (head_matches env f g)
...
(let _146_469 = (head_matches env x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _146_469 head_match))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _55_723), _55_727) -> begin
(let _146_470 = (head_matches env x.FStar_Syntax_Syntax.sort t2)
in (FStar_All.pipe_right _146_470 head_match))
end
| (_55_730, FStar_Syntax_Syntax.Tm_refine (x, _55_733)) -> begin
(let _146_471 = (head_matches env t1 x.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _146_471 head_match))
end
...
(let _146_472 = (head_matches env head head')
in (FStar_All.pipe_right _146_472 head_match))
end
| (FStar_Syntax_Syntax.Tm_app (head, _55_764), _55_768) -> begin
(let _146_473 = (head_matches env head t2)
in (FStar_All.pipe_right _146_473 head_match))
end
| (_55_771, FStar_Syntax_Syntax.Tm_app (head, _55_774)) -> begin
(let _146_474 = (head_matches env t1 head)
in (FStar_All.pipe_right _146_474 head_match))
end
| _55_779 -> begin
(let _146_477 = (let _146_476 = (delta_depth_of_term env t1)
in (let _146_475 = (delta_depth_of_term env t2)
in (_146_476, _146_475)))
in MisMatch (_146_477))
end))))
...
in (let _146_498 = (normalize_refinement ((FStar_TypeChecker_Normalize.UnfoldUntil (d1))::(FStar_TypeChecker_Normalize.WHNF)::[]) env wl t2)
in (t1, _146_498)))
end
...
in (let _146_580 = (decompose [] bs)
in (rebuild, matches, _146_580))))
end)))
end
| _55_917 -> begin
(
...
| (t, _55_953) -> begin
(let _146_602 = (new_uvar r scope t)
in (Prims.fst _146_602))
end))
in (
...
in (let _146_605 = (let _146_604 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (FStar_All.pipe_left (fun _146_603 -> FStar_TypeChecker_Common.TProb (_146_603)) _146_604))
in (T (gi_xs), _146_605)))
end)))
end
...
| (T (gi_xs), prob) -> begin
(let _146_614 = (let _146_613 = (FStar_Syntax_Syntax.mk_Total gi_xs)
in (FStar_All.pipe_left (fun _146_612 -> C (_146_612)) _146_613))
in (_146_614, (prob)::[]))
end
| _55_997 -> begin
(FStar_All.failwith "impossible")
...
(match ((sub_prob scope args (bopt, variance, T (ti)))) with
| (T (gi_xs), prob) -> begin
(let _146_617 = (let _146_616 = (FStar_Syntax_Syntax.mk_GTotal gi_xs)
in (FStar_All.pipe_left (fun _146_615 -> C (_146_615)) _146_616))
in (_146_617, (prob)::[]))
end
| _55_1016 -> begin
(FStar_All.failwith "impossible")
...
let _55_1037 = (let _146_619 = (FStar_List.map (sub_prob scope args) components)
in (FStar_All.pipe_right _146_619 FStar_List.unzip))
in (match (_55_1037) with
| (tcs, sub_probs) -> begin
(

let gi_xs = (let _146_624 = (let _146_623 = (let _146_620 = (FStar_List.hd tcs)
in (FStar_All.pipe_right _146_620 un_T))
in (let _146_622 = (let _146_621 = (FStar_List.tl tcs)
in (FStar_All.pipe_right _146_621 (FStar_List.map arg_of_tc)))
in {FStar_Syntax_Syntax.effect_name = c.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _146_623; FStar_Syntax_Syntax.effect_args = _146_622; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp _146_624))
...
(let _146_626 = (let _146_625 = (FStar_Syntax_Util.arg_of_non_null_binder b)
in (_146_625)::args)
in (Some (b), (b)::scope, _146_626))
end
| _55_1055 -> begin
(None, scope, args)
end)
...
| None -> begin
(let _146_629 = (let _146_628 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (f)::_146_628)
in (FStar_Syntax_Util.mk_conj_l _146_629))
end
| Some (b) -> begin
(let _146_633 = (let _146_632 = (FStar_Syntax_Util.mk_forall (Prims.fst b) f)
in (let _146_631 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (_146_632)::_146_631))
in (FStar_Syntax_Util.mk_conj_l _146_633))
end)
...
let _55_1123 = p
in (let _146_655 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _146_654 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in {FStar_TypeChecker_Common.pid = _55_1123.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _146_655; FStar_TypeChecker_Common.relation = _55_1123.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_654; FStar_TypeChecker_Common.element = _55_1123.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_1123.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_1123.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_1123.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_1123.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_1123.FStar_TypeChecker_Common.rank}))))


let compress_prob : worklist  ->  FStar_TypeChecker_Common.prob  ->  FStar_TypeChecker_Common.prob = (fun wl p -> (match (p) with
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _146_661 = (compress_tprob wl p)
in (FStar_All.pipe_right _146_661 (fun _146_660 -> FStar_TypeChecker_Common.TProb (_146_660))))
end
...
let prob = (let _146_666 = (compress_prob wl pr)
in (FStar_All.pipe_right _146_666 maybe_invert_p))
in (match (prob) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(
...
(let _146_754 = (let _146_753 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_752 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Unable to unify universes: %s and %s" _146_753 _146_752)))
in UFailed (_146_754))
end
end
...
| _55_1302 -> begin
(let _146_761 = (let _146_760 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_759 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Unable to unify universes: %s and %s (%s)" _146_760 _146_759 msg)))
in UFailed (_146_761))
end))
in (match ((u1, u2)) with
...
(let _146_764 = (let _146_763 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (v1)))
in (let _146_762 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.format2 "Failed occurs check: %s occurs in %s" _146_763 _146_762)))
in (try_umax_components u1 u2 _146_764))
end else begin
(let _146_765 = (extend_solution orig ((UNIV ((v1, u)))::[]) wl)
in USolved (_146_765))
end)
end
...
(let _146_811 = (wl_to_string probs)
...
(match (attempt) with
| [] -> begin
(let _146_814 = (FStar_List.map (fun _55_1442 -> (match (_55_1442) with
| (_55_1439, x, y) -> begin
(x, y)
...
let _55_1445 = probs
in (let _146_816 = (FStar_All.pipe_right attempt (FStar_List.map (fun _55_1452 -> (match (_55_1452) with
| (_55_1448, _55_1450, y) -> begin
y
end))))
in {attempting = _146_816; wl_deferred = rest; ctr = _55_1445.ctr; defer_ok = _55_1445.defer_ok; smt_ok = _55_1445.smt_ok; tcenv = _55_1445.tcenv}))
...
| USolved (wl) -> begin
(let _146_823 = (solve_prob orig None [] wl)
in (solve env _146_823))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _146_839 = (prob_to_string env orig)
...
(let _146_843 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
| Some (t1, t2) -> begin
(let _146_849 = (FStar_Syntax_Subst.compress t1)
in (let _146_848 = (FStar_Syntax_Subst.compress t2)
in (_146_849, _146_848)))
end
| None -> begin
(let _146_851 = (FStar_Syntax_Subst.compress t1)
in (let _146_850 = (FStar_Syntax_Subst.compress t2)
in (_146_851, _146_850)))
end)
in (match (_55_1569) with
| (t1, t2) -> begin
(

let eq_prob = (fun t1 t2 -> (let _146_857 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "meeting refinements")
in (FStar_All.pipe_left (fun _146_856 -> FStar_TypeChecker_Common.TProb (_146_856)) _146_857)))
in (match ((t1.FStar_Syntax_Syntax.n, t2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_refine (x, phi1), FStar_Syntax_Syntax.Tm_refine (y, phi2)) -> begin
(let _146_864 = (let _146_863 = (let _146_860 = (let _146_859 = (let _146_858 = (FStar_Syntax_Util.mk_disj phi1 phi2)
in (x, _146_858))
in FStar_Syntax_Syntax.Tm_refine (_146_859))
in (FStar_Syntax_Syntax.mk _146_860 None t1.FStar_Syntax_Syntax.pos))
in (let _146_862 = (let _146_861 = (eq_prob x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (_146_861)::[])
in (_146_863, _146_862)))
in Some (_146_864))
end
| (_55_1583, FStar_Syntax_Syntax.Tm_refine (x, _55_1586)) -> begin
(let _146_867 = (let _146_866 = (let _146_865 = (eq_prob x.FStar_Syntax_Syntax.sort t1)
in (_146_865)::[])
in (t1, _146_866))
in Some (_146_867))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _55_1592), _55_1596) -> begin
(let _146_870 = (let _146_869 = (let _146_868 = (eq_prob x.FStar_Syntax_Syntax.sort t2)
in (_146_868)::[])
in (t2, _146_869))
in Some (_146_870))
end
...
(match ((let _146_871 = (FStar_Syntax_Util.un_uinst head1)
in _146_871.FStar_Syntax_Syntax.n)) with
...
| (u', _55_1630) -> begin
(match ((let _146_873 = (whnf env u')
in _146_873.FStar_Syntax_Syntax.n)) with
...
(match ((let _146_878 = (whnf env hd.FStar_TypeChecker_Common.lhs)
in (disjoin bound _146_878))) with
...
in (match ((let _146_880 = (let _146_879 = (whnf env tp.FStar_TypeChecker_Common.lhs)
in (_146_879, []))
in (make_lower_bound _146_880 lower_bounds))) with
| None -> begin
(
...
in (let _146_881 = (wl_to_string wl')
...
(let _146_887 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
(let _146_899 = (let _146_898 = (let _146_897 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _146_896 -> FStar_TypeChecker_Common.TProb (_146_896)) _146_897))
in (_146_898)::[])
in Some (_146_899))
end
end else begin
...
(let _146_903 = (let _146_902 = (let _146_901 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _146_900 -> FStar_TypeChecker_Common.TProb (_146_900)) _146_901))
in (_146_902)::[])
in Some (_146_903))
end
end else begin
...
in (let _146_910 = (let _146_909 = (let _146_908 = (FStar_Syntax_Util.mk_conj phi1 phi2)
in (FStar_Syntax_Util.refine x _146_908))
in (_146_909, m))
in Some (_146_910))))))
end))
end
...
| (FStar_TypeChecker_Common.TProb (hd))::tl -> begin
(match ((let _146_917 = (whnf env hd.FStar_TypeChecker_Common.rhs)
in (conjoin bound _146_917))) with
| Some (bound, sub) -> begin
...
in (match ((let _146_919 = (let _146_918 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in (_146_918, []))
in (make_upper_bound _146_919 upper_bounds))) with
| None -> begin
(
...
in (let _146_920 = (wl_to_string wl')
...
(let _146_948 = (prob_to_string env rhs_prob)
...
let _55_1888 = hd1
in (let _146_949 = (FStar_Syntax_Subst.subst subst hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_1888.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_1888.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_949}))
in (

let hd2 = (

let _55_1891 = hd2
in (let _146_950 = (FStar_Syntax_Subst.subst subst hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_1891.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_1891.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_950}))
in (

let prob = (let _146_953 = (let _146_952 = (FStar_All.pipe_left invert_rel (p_rel orig))
in (mk_problem scope orig hd1.FStar_Syntax_Syntax.sort _146_952 hd2.FStar_Syntax_Syntax.sort None "Formal parameter"))
in (FStar_All.pipe_left (fun _146_951 -> FStar_TypeChecker_Common.TProb (_146_951)) _146_953))
in (

let hd1 = (FStar_Syntax_Syntax.freshen_bv hd1)
in (

let subst = (let _146_954 = (FStar_Syntax_Subst.shift_subst 1 subst)
in (FStar_Syntax_Syntax.DB ((0, hd1)))::_146_954)
in (
...
let phi = (let _146_956 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (let _146_955 = (FStar_Syntax_Util.close_forall (((hd1, imp))::[]) phi)
in (FStar_Syntax_Util.mk_conj _146_956 _146_955)))
in (

let _55_1903 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_958 = (FStar_Syntax_Print.term_to_string phi)
in (let _146_957 = (FStar_Syntax_Print.bv_to_string hd1)
...
and solve_t : FStar_TypeChecker_Env.env  ->  tprob  ->  worklist  ->  solution = (fun env problem wl -> (let _146_962 = (compress_tprob wl problem)
in (solve_t' env _146_962 wl)))
...
in (let _146_991 = (let _146_990 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_has_type t1 _146_990 t2))
in (FStar_Syntax_Util.mk_forall x _146_991)))
end))
...
in (let _146_992 = (solve_prob orig (Some (guard)) [] wl)
in (solve env _146_992)))
end else begin
...
(let _146_996 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_995 = (FStar_Syntax_Print.tag_of_term t1)
in (let _146_994 = (FStar_Syntax_Print.term_to_string t2)
in (let _146_993 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.print4 "Head matches: %s (%s) and %s (%s)\n" _146_996 _146_995 _146_994 _146_993)))))
end else begin
()
end
in (
...
(let _146_1001 = (let _146_1000 = (FStar_Syntax_Print.term_to_string head1)
in (let _146_999 = (args_to_string args1)
in (let _146_998 = (FStar_Syntax_Print.term_to_string head2)
in (let _146_997 = (args_to_string args2)
in (FStar_Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _146_1000 _146_999 _146_998 _146_997)))))
in (giveup env _146_1001 orig))
end else begin
if ((nargs = 0) || (eq_args args1 args2)) then begin
(match ((solve_maybe_uinsts env orig head1 head2 wl)) with
| USolved (wl) -> begin
(let _146_1002 = (solve_prob orig None [] wl)
in (solve env _146_1002))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _146_1006 = (mk_problem (p_scope orig) orig a FStar_TypeChecker_Common.EQ a' None "index")
in (FStar_All.pipe_left (fun _146_1005 -> FStar_TypeChecker_Common.TProb (_146_1005)) _146_1006))
end)) args1 args2)
in (

let formula = (let _146_1008 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
in (FStar_Syntax_Util.mk_conj_l _146_1008))
in (
...
let im = (let _146_1023 = (h gs_xs)
in (let _146_1022 = (let _146_1021 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_1019 -> FStar_Util.Inl (_146_1019)))
in (FStar_All.pipe_right _146_1021 (fun _146_1020 -> Some (_146_1020))))
in (FStar_Syntax_Util.abs xs _146_1023 _146_1022)))
in (

let _55_2048 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1030 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _146_1029 = (FStar_Syntax_Print.comp_to_string c)
in (let _146_1028 = (FStar_Syntax_Print.term_to_string im)
in (let _146_1027 = (FStar_Syntax_Print.tag_of_term im)
in (let _146_1026 = (let _146_1024 = (FStar_List.map (prob_to_string env) sub_probs)
in (FStar_All.pipe_right _146_1024 (FStar_String.concat ", ")))
in (let _146_1025 = (FStar_TypeChecker_Normalize.term_to_string env formula)
in (FStar_Util.print6 "Imitating  binders are %s, comp=%s\n\t%s (%s)\nsub_probs = %s\nformula=%s\n" _146_1030 _146_1029 _146_1028 _146_1027 _146_1026 _146_1025)))))))
end else begin
()
end
in (
...
| (gi_xs', gi_ps') -> begin
(let _146_1060 = (let _146_1057 = (FStar_Syntax_Syntax.as_arg gi_xs)
in (_146_1057)::gi_xs')
in (let _146_1059 = (let _146_1058 = (FStar_Syntax_Syntax.as_arg gi_ps)
in (_146_1058)::gi_ps')
in (_146_1060, _146_1059)))
end)))))
end)))
end))
in (aux [] bs))
end)))
in if (let _146_1061 = (matches pi)
in (FStar_All.pipe_left Prims.op_Negation _146_1061)) then begin
None
end else begin
(
...
let proj = (let _146_1066 = (FStar_Syntax_Syntax.mk_Tm_app xi g_xs None r)
in (let _146_1065 = (let _146_1064 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_1062 -> FStar_Util.Inl (_146_1062)))
in (FStar_All.pipe_right _146_1064 (fun _146_1063 -> Some (_146_1063))))
in (FStar_Syntax_Util.abs xs _146_1066 _146_1065)))
in (

let sub = (let _146_1072 = (let _146_1071 = (FStar_Syntax_Syntax.mk_Tm_app proj ps None r)
in (let _146_1070 = (let _146_1069 = (FStar_List.map (fun _55_2120 -> (match (_55_2120) with
| (_55_2116, _55_2118, y) -> begin
y
end)) qs)
in (FStar_All.pipe_left h _146_1069))
in (mk_problem (p_scope orig) orig _146_1071 (p_rel orig) _146_1070 None "projection")))
in (FStar_All.pipe_left (fun _146_1067 -> FStar_TypeChecker_Common.TProb (_146_1067)) _146_1072))
in (

let _55_2122 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1074 = (FStar_Syntax_Print.term_to_string proj)
in (let _146_1073 = (prob_to_string env sub)
...
let wl = (let _146_1076 = (let _146_1075 = (FStar_All.pipe_left Prims.fst (p_guard sub))
in Some (_146_1075))
in (solve_prob orig _146_1076 ((TERM ((u, proj)))::[]) wl))
in (let _146_1078 = (solve env (attempt ((sub)::[]) wl))
in (FStar_All.pipe_left (fun _146_1077 -> Some (_146_1077)) _146_1078)))))))
end))
end)
end))
end)))
...
(let _146_1100 = (let _146_1099 = (decompose env t2)
in (((uv, k_uv), xs, c), ps, _146_1099))
in Some (_146_1100))
end else begin
(
...
let rec elim = (fun k args -> (match ((let _146_1106 = (let _146_1105 = (FStar_Syntax_Subst.compress k)
in _146_1105.FStar_Syntax_Syntax.n)
in (_146_1106, args))) with
| (_55_2147, []) -> begin
(let _146_1108 = (let _146_1107 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _146_1107))
in Some (_146_1108))
end
...
| (uv, uv_args) -> begin
(match ((let _146_1109 = (FStar_Syntax_Subst.compress uv)
in _146_1109.FStar_Syntax_Syntax.n)) with
...
let xs = (FStar_All.pipe_right args (FStar_List.map (fun _55_2173 -> (let _146_1115 = (let _146_1114 = (let _146_1113 = (let _146_1112 = (let _146_1111 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1111 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _146_1112))
in (Prims.fst _146_1113))
in (FStar_Syntax_Syntax.new_bv (Some (k.FStar_Syntax_Syntax.pos)) _146_1114))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _146_1115)))))
in (

let c = (let _146_1119 = (let _146_1118 = (let _146_1117 = (let _146_1116 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1116 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _146_1117))
in (Prims.fst _146_1118))
in (FStar_Syntax_Syntax.mk_Total _146_1119))
in (

let k' = (FStar_Syntax_Util.arrow xs c)
in (

let uv_sol = (let _146_1125 = (let _146_1124 = (let _146_1123 = (let _146_1122 = (let _146_1121 = (let _146_1120 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1120 Prims.fst))
in (FStar_Syntax_Syntax.mk_Total _146_1121))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _146_1122))
in FStar_Util.Inl (_146_1123))
in Some (_146_1124))
in (FStar_Syntax_Util.abs scope k' _146_1125))
in (
...
(let _146_1127 = (FStar_Syntax_Subst.open_comp xs c)
in (FStar_All.pipe_right _146_1127 (fun _146_1126 -> Some (_146_1126))))
end else begin
...
| (xs, c) -> begin
(let _146_1129 = (elim (FStar_Syntax_Util.comp_result c) rest)
in (FStar_Util.bind_opt _146_1129 (fun _55_2200 -> (match (_55_2200) with
| (xs', c) -> begin
...
in (let _146_1132 = (let _146_1130 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Subst.open_comp xs _146_1130))
in (FStar_All.pipe_right _146_1132 (fun _146_1131 -> Some (_146_1131)))))
end))
end
end))
end
| _55_2206 -> begin
(let _146_1136 = (let _146_1135 = (FStar_Syntax_Print.uvar_to_string uv)
in (let _146_1134 = (FStar_Syntax_Print.term_to_string k)
in (let _146_1133 = (FStar_Syntax_Print.term_to_string k_uv)
in (FStar_Util.format3 "Impossible: ill-typed application %s : %s\n\t%s" _146_1135 _146_1134 _146_1133))))
in (FStar_All.failwith _146_1136))
end))
in (let _146_1174 = (elim k_uv ps)
in (FStar_Util.bind_opt _146_1174 (fun _55_2209 -> (match (_55_2209) with
| (xs, c) -> begin
(let _146_1173 = (let _146_1172 = (decompose env t2)
in (((uv, k_uv), xs, c), ps, _146_1172))
in Some (_146_1173))
end))))))
end
end)))
...
(let _146_1185 = (names_to_string fvs_hd)
in (FStar_Util.print1 "Free variables are %s" _146_1185))
end else begin
()
end
in false)
...
let fvs_hd = (let _146_1189 = (let _146_1188 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _146_1188 Prims.fst))
in (FStar_All.pipe_right _146_1189 FStar_Syntax_Free.names))
...
(let _146_1191 = (let _146_1190 = (FStar_Option.get msg)
in (Prims.strcat "occurs-check failed: " _146_1190))
in (giveup_or_defer orig _146_1191))
end else begin
...
(let _146_1192 = (subterms args_lhs)
in (imitate' orig env wl _146_1192))
end else begin
(

let _55_2264 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1195 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1194 = (names_to_string fvs1)
in (let _146_1193 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s succeeded fvar check: %s\n" _146_1195 _146_1194 _146_1193))))
end else begin
()
end
in (
...
| _55_2268 -> begin
(let _146_1196 = (sn_binders env vars)
in (u_abs k_uv _146_1196 t2))
end)
in (
...
(let _146_1199 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1198 = (names_to_string fvs1)
in (let _146_1197 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _146_1199 _146_1198 _146_1197))))
end else begin
()
end
in (let _146_1200 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _146_1200 (- (1)))))
end else begin
...
if (let _146_1201 = (FStar_Syntax_Free.names t1)
in (check_head _146_1201 t2)) then begin
(
...
(let _146_1202 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print2 "Not a pattern (%s) ... %s\n" _146_1202 (if (im_ok < 0) then begin
"imitating"
end else begin
"projecting"
end)))
...
in (let _146_1203 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _146_1203 im_ok))))
end else begin
...
| (x, imp) -> begin
(let _146_1225 = (FStar_Syntax_Syntax.bv_to_name x)
in (_146_1225, imp))
end))))
in (
...
| (t, _55_2310) -> begin
(let _146_1226 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars t)
in (Prims.fst _146_1226))
end))
in (
...
let sol = (let _146_1228 = (let _146_1227 = (u_abs k all_formals t')
in ((u, k), _146_1227))
in TERM (_146_1228))
in (
...
(let _146_1230 = (FStar_Util.set_add (Prims.fst formal) pattern_var_set)
in (aux ((y)::pat_args) ((formal)::pattern_vars) _146_1230 formals tl))
end)
end)
end)
end
...
in (let _146_1231 = (FStar_Syntax_Syntax.new_bv_set ())
in (aux [] [] _146_1231 all_formals args))))
end))
end))
in (
...
(let _146_1240 = (solve_prob orig None [] wl)
in (solve env _146_1240))
end else begin
(
...
(let _146_1245 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _146_1244 = (FStar_Syntax_Print.binders_to_string ", " ys)
in (let _146_1243 = (FStar_Syntax_Print.binders_to_string ", " zs)
in (let _146_1242 = (FStar_Syntax_Print.term_to_string k1)
in (let _146_1241 = (FStar_Syntax_Print.term_to_string k2)
in (FStar_Util.print5 "Flex-flex patterns: intersected %s and %s; got %s\n\tk1=%s\n\tk2=%s\n" _146_1245 _146_1244 _146_1243 _146_1242 _146_1241))))))
end else begin
()
end
in (
...
| (k, _55_2370) -> begin
(let _146_1251 = (let _146_1246 = (new_uvar r zs k)
in (FStar_All.pipe_left Prims.fst _146_1246))
in (let _146_1250 = (let _146_1247 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow xs _146_1247))
in (let _146_1249 = (let _146_1248 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow ys _146_1248))
in (_146_1251, _146_1250, _146_1249))))
end))
end))
...
(let _146_1257 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1256 = (FStar_Syntax_Print.term_to_string t2)
...
(let _146_1262 = (let _146_1260 = (FStar_Syntax_Syntax.bv_to_name a)
in (mk_problem (p_scope orig) orig _146_1260 FStar_TypeChecker_Common.EQ t2 None "flex-flex index"))
in (FStar_All.pipe_right _146_1262 (fun _146_1261 -> FStar_TypeChecker_Common.TProb (_146_1261))))
end)) xs args2)
in (

let guard = (let _146_1264 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _146_1264))
in (
...
let sol = (let _146_1266 = (let _146_1265 = (u_abs k1 xs t2)
in ((u1, k1), _146_1265))
in TERM (_146_1266))
in (
...
(let _146_1267 = (uvi_to_string env sol)
...
(let _146_1268 = (uvi_to_string env sol)
...
(let _146_1269 = (solve_prob orig None [] wl)
in (solve env _146_1269))
end else begin
(
...
(let _146_1270 = (solve_prob orig None [] wl)
in (solve env _146_1270))
end else begin
(

let _55_2479 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("RelCheck"))) then begin
(let _146_1271 = (FStar_Util.string_of_int problem.FStar_TypeChecker_Common.pid)
...
(let _146_1305 = (let _146_1302 = (mk_cod1 [])
in (bs1, _146_1302))
in (let _146_1304 = (let _146_1303 = (mk_cod2 [])
in (bs2, _146_1303))
in (_146_1305, _146_1304)))
end else begin
if (l1 > l2) then begin
(let _146_1308 = (curry l2 bs1 mk_cod1)
in (let _146_1307 = (let _146_1306 = (mk_cod2 [])
in (bs2, _146_1306))
in (_146_1308, _146_1307)))
end else begin
(let _146_1311 = (let _146_1309 = (mk_cod1 [])
in (bs1, _146_1309))
in (let _146_1310 = (curry l1 bs2 mk_cod2)
...
| bs -> begin
(let _146_1316 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((bs, c))) None c.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk_Total _146_1316))
end))
in (
...
in (let _146_1323 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (FStar_All.pipe_left (fun _146_1322 -> FStar_TypeChecker_Common.CProb (_146_1322)) _146_1323)))))))
end)))
end
...
(solve_binders env bs1 bs2 orig wl (fun scope env subst -> (let _146_1338 = (let _146_1337 = (FStar_Syntax_Subst.subst subst tbody1)
in (let _146_1336 = (FStar_Syntax_Subst.subst subst tbody2)
in (mk_problem scope orig _146_1337 problem.FStar_TypeChecker_Common.relation _146_1336 None "lambda co-domain")))
in (FStar_All.pipe_left (fun _146_1335 -> FStar_TypeChecker_Common.TProb (_146_1335)) _146_1338))))
end)))
end
...
let base_prob = (let _146_1340 = (mk_problem (p_scope orig) orig x1.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.relation x2.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "refinement base type")
in (FStar_All.pipe_left (fun _146_1339 -> FStar_TypeChecker_Common.TProb (_146_1339)) _146_1340))
in (
...
let mk_imp = (fun imp phi1 phi2 -> (let _146_1357 = (imp phi1 phi2)
...
let guard = (let _146_1360 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1360 impl))
in (
...
let ref_prob = (let _146_1364 = (let _146_1363 = (let _146_1362 = (FStar_Syntax_Syntax.mk_binder x1)
in (_146_1362)::(p_scope orig))
in (mk_problem _146_1363 orig phi1 FStar_TypeChecker_Common.EQ phi2 None "refinement formula"))
in (FStar_All.pipe_left (fun _146_1361 -> FStar_TypeChecker_Common.TProb (_146_1361)) _146_1364))
in (match ((solve env (
...
let guard = (let _146_1367 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (let _146_1366 = (let _146_1365 = (FStar_All.pipe_right (p_guard ref_prob) Prims.fst)
in (FStar_All.pipe_right _146_1365 (guard_on_element problem x1)))
in (FStar_Syntax_Util.mk_conj _146_1367 _146_1366)))
in (
...
(let _146_1369 = (destruct_flex_t t1)
in (let _146_1368 = (destruct_flex_t t2)
in (flex_flex orig _146_1369 _146_1368)))
end
...
(let _146_1370 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid orig _146_1370 t2 wl))
end
...
| ((FStar_Syntax_Syntax.Tm_uvar (_), FStar_Syntax_Syntax.Tm_type (_))) | ((FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (_); FStar_Syntax_Syntax.tk = _; FStar_Syntax_Syntax.pos = _; FStar_Syntax_Syntax.vars = _}, _), FStar_Syntax_Syntax.Tm_type (_))) -> begin
(solve_t' env (

let _55_2756 = problem
in {FStar_TypeChecker_Common.pid = _55_2756.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_2756.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = _55_2756.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2756.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2756.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2756.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2756.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2756.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2756.FStar_TypeChecker_Common.rank}) wl)
end
...
in if (let _146_1371 = (is_top_level_prob orig)
in (FStar_All.pipe_left Prims.op_Negation _146_1371)) then begin
(let _146_1374 = (FStar_All.pipe_left (fun _146_1372 -> FStar_TypeChecker_Common.TProb (_146_1372)) (

let _55_2782 = problem
in {FStar_TypeChecker_Common.pid = _55_2782.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_2782.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _55_2782.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2782.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2782.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2782.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2782.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2782.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2782.FStar_TypeChecker_Common.rank}))
in (let _146_1373 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _146_1374 _146_1373 t2 wl)))
end else begin
(

let _55_2786 = (base_and_refinement env wl t2)
in (match (_55_2786) with
| (t_base, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(let _146_1377 = (FStar_All.pipe_left (fun _146_1375 -> FStar_TypeChecker_Common.TProb (_146_1375)) (

let _55_2788 = problem
in {FStar_TypeChecker_Common.pid = _55_2788.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_2788.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _55_2788.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2788.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2788.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2788.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2788.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2788.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2788.FStar_TypeChecker_Common.rank}))
in (let _146_1376 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _146_1377 _146_1376 t_base wl)))
end
| Some (y, phi) -> begin
(
...
let _55_2794 = y
in {FStar_Syntax_Syntax.ppname = _55_2794.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_2794.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (

let impl = (guard_on_element problem y' phi)
in (

let base_prob = (let _146_1379 = (mk_problem problem.FStar_TypeChecker_Common.scope orig t1 new_rel y.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _146_1378 -> FStar_TypeChecker_Common.TProb (_146_1378)) _146_1379))
in (

let guard = (let _146_1380 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1380 impl))
in (
...
let _55_2827 = (base_and_refinement env wl t1)
in (match (_55_2827) with
| (t_base, _55_2826) -> begin
(solve_t env (

let _55_2828 = problem
in {FStar_TypeChecker_Common.pid = _55_2828.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = _55_2828.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2828.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2828.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2828.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2828.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2828.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2828.FStar_TypeChecker_Common.rank}) wl)
end))
end
end
| (FStar_Syntax_Syntax.Tm_refine (_55_2831), _55_2834) -> begin
(

let t2 = (let _146_1381 = (base_and_refinement env wl t2)
in (FStar_All.pipe_left force_refinement _146_1381))
in (solve_t env (

let _55_2837 = problem
in {FStar_TypeChecker_Common.pid = _55_2837.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_2837.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _55_2837.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _55_2837.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2837.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2837.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2837.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2837.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2837.FStar_TypeChecker_Common.rank}) wl))
end
| (_55_2840, FStar_Syntax_Syntax.Tm_refine (_55_2842)) -> begin
(

let t1 = (let _146_1382 = (base_and_refinement env wl t1)
in (FStar_All.pipe_left force_refinement _146_1382))
in (solve_t env (

let _55_2846 = problem
in {FStar_TypeChecker_Common.pid = _55_2846.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _55_2846.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _55_2846.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2846.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2846.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2846.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2846.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2846.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2846.FStar_TypeChecker_Common.rank}) wl))
end
...
| FStar_Syntax_Syntax.Tm_abs (_55_2863) -> begin
t
end
| _55_2866 -> begin
...
let _55_2867 = problem
in (let _146_1386 = (maybe_eta t1)
in (let _146_1385 = (maybe_eta t2)
in {FStar_TypeChecker_Common.pid = _55_2867.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _146_1386; FStar_TypeChecker_Common.relation = _55_2867.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_1385; FStar_TypeChecker_Common.element = _55_2867.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2867.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2867.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2867.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2867.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2867.FStar_TypeChecker_Common.rank})))
in (solve_t env _146_1387 wl)))
end
...
let head1 = (let _146_1388 = (FStar_Syntax_Util.head_and_args t1)
in (FStar_All.pipe_right _146_1388 Prims.fst))
in (

let head2 = (let _146_1389 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _146_1389 Prims.fst))
...
(let _146_1391 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Syntax.tun FStar_Syntax_Syntax.tun t1 t2)
in (FStar_All.pipe_left (fun _146_1390 -> Some (_146_1390)) _146_1391))
end
in (let _146_1392 = (solve_prob orig guard [] wl)
in (solve env _146_1392)))
end else begin
...
| (FStar_Syntax_Syntax.Tm_ascribed (t1, _55_2948, _55_2950), _55_2954) -> begin
(solve_t' env (

let _55_2956 = problem
in {FStar_TypeChecker_Common.pid = _55_2956.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _55_2956.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _55_2956.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_2956.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2956.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2956.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2956.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2956.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2956.FStar_TypeChecker_Common.rank}) wl)
end
| (_55_2959, FStar_Syntax_Syntax.Tm_ascribed (t2, _55_2962, _55_2964)) -> begin
(solve_t' env (

let _55_2968 = problem
in {FStar_TypeChecker_Common.pid = _55_2968.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_2968.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _55_2968.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _55_2968.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2968.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2968.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2968.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2968.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2968.FStar_TypeChecker_Common.rank}) wl)
end
...
(let _146_1395 = (let _146_1394 = (FStar_Syntax_Print.tag_of_term t1)
in (let _146_1393 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.format2 "Impossible: %s and %s" _146_1394 _146_1393)))
in (FStar_All.failwith _146_1395))
end
| _55_3007 -> begin
...
let _55_3024 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("EQ"))) then begin
...
let sub_probs = (FStar_List.map2 (fun _55_3029 _55_3033 -> (match ((_55_3029, _55_3033)) with
| ((a1, _55_3028), (a2, _55_3032)) -> begin
(let _146_1410 = (sub_prob a1 FStar_TypeChecker_Common.EQ a2 "effect arg")
in (FStar_All.pipe_left (fun _146_1409 -> FStar_TypeChecker_Common.TProb (_146_1409)) _146_1410))
end)) c1_comp.FStar_Syntax_Syntax.effect_args c2_comp.FStar_Syntax_Syntax.effect_args)
in (

let guard = (let _146_1412 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _146_1412))
in (
...
| _55_3049 -> begin
(let _146_1420 = (let _146_1419 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid c1.FStar_Syntax_Syntax.effect_name))
in (FStar_Util.format1 "Unexpected number of indices on a normalized effect (%s)" _146_1419))
in (FStar_All.failwith _146_1420))
end)
in (

let c1 = (let _146_1423 = (let _146_1422 = (let _146_1421 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _146_1421))
in (_146_1422)::[])
in {FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _146_1423; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2)))
end else begin
(
...
let _55_3078 = (match ((c1.FStar_Syntax_Syntax.effect_args, c2.FStar_Syntax_Syntax.effect_args)) with
| (((wp1, _55_3063))::_55_3060, ((wp2, _55_3070))::_55_3067) -> begin
(wp1, wp2)
end
| _55_3075 -> begin
(let _146_1427 = (let _146_1426 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _146_1425 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _146_1426 _146_1425)))
in (FStar_All.failwith _146_1427))
end)
in (match (_55_3078) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _146_1428 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _146_1428 wl))
end else begin
(
...
let _55_3080 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(FStar_Util.print_string "Using trivial wp ... \n")
end else begin
()
end
in (let _146_1438 = (let _146_1437 = (let _146_1436 = (let _146_1430 = (let _146_1429 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_146_1429)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _146_1430 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _146_1435 = (let _146_1434 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _146_1433 = (let _146_1432 = (let _146_1431 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _146_1431))
in (_146_1432)::[])
in (_146_1434)::_146_1433))
in (_146_1436, _146_1435)))
in FStar_Syntax_Syntax.Tm_app (_146_1437))
in (FStar_Syntax_Syntax.mk _146_1438 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(let _146_1450 = (let _146_1449 = (let _146_1448 = (let _146_1440 = (let _146_1439 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_146_1439)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _146_1440 env c2_decl c2_decl.FStar_Syntax_Syntax.stronger))
in (let _146_1447 = (let _146_1446 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _146_1445 = (let _146_1444 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _146_1443 = (let _146_1442 = (let _146_1441 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _146_1441))
in (_146_1442)::[])
in (_146_1444)::_146_1443))
in (_146_1446)::_146_1445))
in (_146_1448, _146_1447)))
in FStar_Syntax_Syntax.Tm_app (_146_1449))
in (FStar_Syntax_Syntax.mk _146_1450 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r))
end
in (

let base_prob = (let _146_1452 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _146_1451 -> FStar_TypeChecker_Common.TProb (_146_1451)) _146_1452))
in (

let wl = (let _146_1456 = (let _146_1455 = (let _146_1454 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1454 g))
in (FStar_All.pipe_left (fun _146_1453 -> Some (_146_1453)) _146_1455))
in (solve_prob orig _146_1456 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _146_1457 = (solve_prob orig None [] wl)
in (solve env _146_1457))
end else begin
(

let _55_3085 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1459 = (FStar_Syntax_Print.comp_to_string c1)
in (let _146_1458 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _146_1459 (rel_to_string problem.FStar_TypeChecker_Common.relation) _146_1458)))
end else begin
()
end
in (

let _55_3089 = (let _146_1461 = (FStar_TypeChecker_Normalize.ghost_to_pure env c1)
in (let _146_1460 = (FStar_TypeChecker_Normalize.ghost_to_pure env c2)
in (_146_1461, _146_1460)))
in (match (_55_3089) with
| (c1, c2) -> begin
(match ((c1.FStar_Syntax_Syntax.n, c2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.GTotal (t1), FStar_Syntax_Syntax.Total (t2)) when (FStar_Syntax_Util.non_informative t2) -> begin
(let _146_1462 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _146_1462 wl))
end
| (FStar_Syntax_Syntax.GTotal (_55_3096), FStar_Syntax_Syntax.Total (_55_3099)) -> begin
...
(let _146_1463 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _146_1463 wl))
end
| ((FStar_Syntax_Syntax.GTotal (_), FStar_Syntax_Syntax.Comp (_))) | ((FStar_Syntax_Syntax.Total (_), FStar_Syntax_Syntax.Comp (_))) -> begin
(let _146_1465 = (

let _55_3127 = problem
in (let _146_1464 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c1))
in {FStar_TypeChecker_Common.pid = _55_3127.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _146_1464; FStar_TypeChecker_Common.relation = _55_3127.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _55_3127.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _55_3127.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_3127.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_3127.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_3127.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_3127.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_3127.FStar_TypeChecker_Common.rank}))
in (solve_c env _146_1465 wl))
end
| ((FStar_Syntax_Syntax.Comp (_), FStar_Syntax_Syntax.GTotal (_))) | ((FStar_Syntax_Syntax.Comp (_), FStar_Syntax_Syntax.Total (_))) -> begin
(let _146_1467 = (

let _55_3143 = problem
in (let _146_1466 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c2))
in {FStar_TypeChecker_Common.pid = _55_3143.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_3143.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _55_3143.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_1466; FStar_TypeChecker_Common.element = _55_3143.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_3143.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_3143.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_3143.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_3143.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_3143.FStar_TypeChecker_Common.rank}))
in (solve_c env _146_1467 wl))
end
| (FStar_Syntax_Syntax.Comp (_55_3146), FStar_Syntax_Syntax.Comp (_55_3149)) -> begin
...
(let _146_1468 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _146_1468 wl))
end else begin
(
...
let _55_3156 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
| None -> begin
if (((FStar_Syntax_Util.is_ghost_effect c1.FStar_Syntax_Syntax.effect_name) && (FStar_Syntax_Util.is_pure_effect c2.FStar_Syntax_Syntax.effect_name)) && (let _146_1469 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Inline)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env c2.FStar_Syntax_Syntax.result_typ)
in (FStar_Syntax_Util.non_informative _146_1469))) then begin
(
...
(let _146_1474 = (let _146_1473 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _146_1472 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _146_1473 _146_1472)))
in (giveup env _146_1474 orig))
end
end
| Some (edge) -> begin
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _146_1478 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _55_3176 -> (match (_55_3176) with
| (_55_3166, _55_3168, u, _55_3171, _55_3173, _55_3175) -> begin
...
let carry = (let _146_1484 = (FStar_List.map (fun _55_3191 -> (match (_55_3191) with
| (_55_3189, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _146_1484 (FStar_String.concat ",\n")))
in (
...
| {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _55_3200; FStar_TypeChecker_Env.implicits = _55_3198} -> begin
true
end
| _55_3205 -> begin
false
...
let _55_3225 = g
in (let _146_1504 = (let _146_1503 = (let _146_1502 = (let _146_1496 = (FStar_Syntax_Syntax.mk_binder x)
in (_146_1496)::[])
in (let _146_1501 = (let _146_1500 = (let _146_1499 = (let _146_1497 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _146_1497 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _146_1499 (fun _146_1498 -> FStar_Util.Inl (_146_1498))))
in Some (_146_1500))
in (FStar_Syntax_Util.abs _146_1502 f _146_1501)))
in (FStar_All.pipe_left (fun _146_1495 -> FStar_TypeChecker_Common.NonTrivial (_146_1495)) _146_1503))
in {FStar_TypeChecker_Env.guard_f = _146_1504; FStar_TypeChecker_Env.deferred = _55_3225.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3225.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3225.FStar_TypeChecker_Env.implicits}))
in Some (_146_1505)))
end))
...
let _55_3232 = g
in (let _146_1516 = (let _146_1515 = (let _146_1514 = (let _146_1513 = (let _146_1512 = (let _146_1511 = (FStar_Syntax_Syntax.as_arg e)
in (_146_1511)::[])
in (f, _146_1512))
in FStar_Syntax_Syntax.Tm_app (_146_1513))
in (FStar_Syntax_Syntax.mk _146_1514 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _146_1510 -> FStar_TypeChecker_Common.NonTrivial (_146_1510)) _146_1515))
in {FStar_TypeChecker_Env.guard_f = _146_1516; FStar_TypeChecker_Env.deferred = _55_3232.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3232.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3232.FStar_TypeChecker_Env.implicits}))
end))
...
| FStar_TypeChecker_Common.NonTrivial (_55_3237) -> begin
(FStar_All.failwith "impossible")
end))
...
(let _146_1523 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_146_1523))
end))
...
let binop_guard : (FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula)  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t = (fun f g1 g2 -> (let _146_1546 = (f g1.FStar_TypeChecker_Env.guard_f g2.FStar_TypeChecker_Env.guard_f)
in {FStar_TypeChecker_Env.guard_f = _146_1546; FStar_TypeChecker_Env.deferred = (FStar_List.append g1.FStar_TypeChecker_Env.deferred g2.FStar_TypeChecker_Env.deferred); FStar_TypeChecker_Env.univ_ineqs = (FStar_List.append g1.FStar_TypeChecker_Env.univ_ineqs g2.FStar_TypeChecker_Env.univ_ineqs); FStar_TypeChecker_Env.implicits = (FStar_List.append g1.FStar_TypeChecker_Env.implicits g2.FStar_TypeChecker_Env.implicits)}))
...
let _55_3282 = g
in (let _146_1561 = (let _146_1560 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _146_1560 (fun _146_1559 -> FStar_TypeChecker_Common.NonTrivial (_146_1559))))
in {FStar_TypeChecker_Env.guard_f = _146_1561; FStar_TypeChecker_Env.deferred = _55_3282.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3282.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3282.FStar_TypeChecker_Env.implicits}))
end))
...
(let _146_1569 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _146_1568 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _146_1569 (rel_to_string rel) _146_1568)))
end else begin
"TOP"
end
in (
...
let x = (let _146_1580 = (let _146_1579 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _146_1578 -> Some (_146_1578)) _146_1579))
in (FStar_Syntax_Syntax.new_bv _146_1580 t1))
in (

let env = (FStar_TypeChecker_Env.push_bv env x)
in (

let p = (let _146_1584 = (let _146_1582 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _146_1581 -> Some (_146_1581)) _146_1582))
in (let _146_1583 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _146_1584 _146_1583)))
...
let _55_3302 = probs
in {attempting = _55_3302.attempting; wl_deferred = _55_3302.wl_deferred; ctr = _55_3302.ctr; defer_ok = false; smt_ok = _55_3302.smt_ok; tcenv = _55_3302.tcenv})
end else begin
probs
end
in (
...
let _55_3309 = (FStar_Unionfind.commit tx)
in Some (deferred))
end
| Failed (d, s) -> begin
(

let _55_3315 = (FStar_Unionfind.rollback tx)
in (

let _55_3317 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("ExplainRel"))) then begin
(let _146_1596 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _146_1596))
end else begin
()
end
in (err (d, s))))
...
let _55_3324 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _146_1601 = (FStar_Syntax_Print.term_to_string f)
...
let _55_3327 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _146_1602 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _146_1603 = (FStar_Syntax_Util.unmeta f)
in _146_1603.FStar_Syntax_Syntax.n)) with
...
let _55_3334 = g
in {FStar_TypeChecker_Env.guard_f = f; FStar_TypeChecker_Env.deferred = _55_3334.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3334.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3334.FStar_TypeChecker_Env.implicits})))))
end))
...
| Some (d) -> begin
(let _146_1615 = (let _146_1614 = (let _146_1613 = (let _146_1612 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _146_1612 (fun _146_1611 -> FStar_TypeChecker_Common.NonTrivial (_146_1611))))
in {FStar_TypeChecker_Env.guard_f = _146_1613; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _146_1614))
in (FStar_All.pipe_left (fun _146_1610 -> Some (_146_1610)) _146_1615))
end))
...
let _55_3345 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1623 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1622 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _146_1626 = (let _146_1625 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _146_1625))
in (FStar_All.pipe_left (fun _146_1624 -> FStar_TypeChecker_Common.TProb (_146_1624)) _146_1626))
in (

let g = (let _146_1628 = (solve_and_commit env (singleton env prob) (fun _55_3348 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1628))
in g))))
...
| None -> begin
(let _146_1638 = (let _146_1637 = (let _146_1636 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _146_1635 = (FStar_TypeChecker_Env.get_range env)
in (_146_1636, _146_1635)))
in FStar_Syntax_Syntax.Error (_146_1637))
in (Prims.raise _146_1638))
end
| Some (g) -> begin
(

let _55_3357 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1641 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1640 = (FStar_Syntax_Print.term_to_string t2)
in (let _146_1639 = (guard_to_string env g)
in (FStar_Util.print3 "teq of %s and %s succeeded with guard %s\n" _146_1641 _146_1640 _146_1639))))
end else begin
()
end
in g)
...
let _55_3363 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1651 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _146_1650 = (FStar_TypeChecker_Normalize.term_to_string env t2)
...
let _55_3367 = (new_t_prob env t1 FStar_TypeChecker_Common.SUB t2)
in (match (_55_3367) with
| (prob, x) -> begin
(

let g = (let _146_1653 = (solve_and_commit env (singleton' env prob smt_ok) (fun _55_3368 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1653))
in (

let _55_3371 = if ((FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) && (FStar_Util.is_some g)) then begin
(let _146_1657 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _146_1656 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _146_1655 = (let _146_1654 = (FStar_Util.must g)
in (guard_to_string env _146_1654))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _146_1657 _146_1656 _146_1655))))
end else begin
()
end
...
let subtype_fail : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ  ->  Prims.unit = (fun env t1 t2 -> (let _146_1671 = (FStar_TypeChecker_Env.get_range env)
in (let _146_1670 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (FStar_TypeChecker_Errors.report _146_1671 _146_1670))))
...
let _55_3382 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1679 = (FStar_Syntax_Print.comp_to_string c1)
in (let _146_1678 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _146_1682 = (let _146_1681 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _146_1681 "sub_comp"))
in (FStar_All.pipe_left (fun _146_1680 -> FStar_TypeChecker_Common.CProb (_146_1680)) _146_1682))
in (let _146_1684 = (solve_and_commit env (singleton env prob) (fun _55_3386 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1684))))))
...
let _55_3395 = (FStar_Unionfind.rollback tx)
in (
...
in (let _146_1702 = (let _146_1701 = (let _146_1700 = (let _146_1698 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_1697 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _146_1698 _146_1697 msg)))
in (let _146_1699 = (FStar_TypeChecker_Env.get_range env)
in (_146_1700, _146_1699)))
in FStar_Syntax_Syntax.Error (_146_1701))
in (Prims.raise _146_1702)))))
in (
...
let _55_3411 = hd
in (match (_55_3411) with
| (uv', lower_bounds) -> begin
if (FStar_Unionfind.equivalent uv uv') then begin
((uv', (u1)::lower_bounds))::tl
end else begin
(let _146_1709 = (insert uv u1 tl)
in (hd)::_146_1709)
end
end))
end))
...
(let _146_1714 = (insert uv u1 out)
in (group_by _146_1714 rest))
end)
end
| _55_3426 -> begin
None
...
let ad_hoc_fallback = (fun _55_3428 -> (match (()) with
| () -> begin
(match (ineqs) with
| [] -> begin
()
...
let _55_3432 = (empty_worklist env)
in {attempting = _55_3432.attempting; wl_deferred = _55_3432.wl_deferred; ctr = _55_3432.ctr; defer_ok = true; smt_ok = _55_3432.smt_ok; tcenv = _55_3432.tcenv})
in (FStar_All.pipe_right ineqs (FStar_List.iter (fun _55_3437 -> (match (_55_3437) with
| (u1, u2) -> begin
(
...
let _55_3464 = (FStar_Syntax_Util.univ_kernel u)
in (match (_55_3464) with
| (k_u, n) -> begin
(FStar_All.pipe_right us2 (FStar_Util.for_some (fun u' -> (

let _55_3468 = (FStar_Syntax_Util.univ_kernel u')
in (match (_55_3468) with
| (k_u', n') -> begin
...
let _55_3474 = (empty_worklist env)
in {attempting = _55_3474.attempting; wl_deferred = _55_3474.wl_deferred; ctr = _55_3474.ctr; defer_ok = false; smt_ok = _55_3474.smt_ok; tcenv = _55_3474.tcenv})
in (
...
let _55_3494 = (solve_universe_inequalities' tx env ineqs)
...
let fail = (fun _55_3501 -> (match (_55_3501) with
| (d, s) -> begin
(
...
let _55_3504 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _146_1735 = (wl_to_string wl)
in (let _146_1734 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
let _55_3508 = g
in {FStar_TypeChecker_Env.guard_f = _55_3508.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _55_3508.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3508.FStar_TypeChecker_Env.implicits})
end
| _55_3511 -> begin
...
let _55_3513 = (solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs)
in (

let _55_3515 = g
in {FStar_TypeChecker_Env.guard_f = _55_3515.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _55_3515.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = _55_3515.FStar_TypeChecker_Env.implicits})))))))
...
let _55_3530 = if (not ((FStar_TypeChecker_Env.should_verify env))) then begin
()
end else begin
...
let _55_3528 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1752 = (FStar_TypeChecker_Env.get_range env)
in (let _146_1751 = (let _146_1750 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _146_1750))
in (FStar_TypeChecker_Errors.diag _146_1752 _146_1751)))
end else begin
()
end
...
let rec until_fixpoint = (fun _55_3545 implicits -> (match (_55_3545) with
| (out, changed) -> begin
...
let _55_3558 = hd
in (match (_55_3558) with
| (_55_3552, env, u, tm, k, r) -> begin
...
let _55_3561 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _146_1768 = (FStar_Syntax_Print.uvar_to_string u)
in (let _146_1767 = (FStar_Syntax_Print.term_to_string tm)
in (let _146_1766 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _146_1768 _146_1767 _146_1766))))
end else begin
()
end
in (

let _55_3570 = (env.FStar_TypeChecker_Env.type_of (

let _55_3563 = env
in {FStar_TypeChecker_Env.solver = _55_3563.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _55_3563.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _55_3563.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _55_3563.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _55_3563.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _55_3563.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _55_3563.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _55_3563.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _55_3563.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _55_3563.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _55_3563.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _55_3563.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _55_3563.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _55_3563.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _55_3563.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _55_3563.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _55_3563.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _55_3563.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _55_3563.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _55_3563.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _55_3563.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true}) tm)
in (match (_55_3570) with
| (_55_3566, _55_3568, g) -> begin
(
...
let _55_3571 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _55_3571.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3571.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3571.FStar_TypeChecker_Env.implicits})
end else begin
g
end
in (

let g' = (discharge_guard' (Some ((fun _55_3574 -> (match (()) with
| () -> begin
...
let _55_3576 = g
in (let _146_1772 = (until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _55_3576.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _55_3576.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3576.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _146_1772})))))


let force_trivial_guard : FStar_TypeChecker_Env.env  ->  FStar_TypeChecker_Env.guard_t  ->  Prims.unit = (fun env g -> (

let g = (let _146_1777 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _146_1777 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _146_1778 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _146_1778))
end
| ((reason, _55_3586, _55_3588, e, t, r))::_55_3583 -> begin
(let _146_1781 = (let _146_1780 = (FStar_Syntax_Print.term_to_string t)
in (let _146_1779 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format3 "Failed to resolve implicit argument of type \'%s\' introduced in %s because %s" _146_1780 _146_1779 reason)))
in (FStar_TypeChecker_Errors.report r _146_1781))
end)))
...
let _55_3596 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = _55_3596.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _55_3596.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((u1, u2))::[]; FStar_TypeChecker_Env.implicits = _55_3596.FStar_TypeChecker_Env.implicits}))
