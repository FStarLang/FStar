...
let commit : uvi Prims.list  ->  Prims.unit = (fun uvis -> (FStar_All.pipe_right uvis (FStar_List.iter (fun uu___126_1775 -> (match (uu___126_1775) with
| UNIV (u, t) -> begin
(match (t) with
...
let find_term_uvar : FStar_Syntax_Syntax.uvar  ->  uvi Prims.list  ->  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option = (fun uv s -> (FStar_Util.find_map s (fun uu___127_1811 -> (match (uu___127_1811) with
...
let find_univ_uvar : FStar_Syntax_Syntax.universe_uvar  ->  uvi Prims.list  ->  FStar_Syntax_Syntax.universe FStar_Pervasives_Native.option = (fun u s -> (FStar_Util.find_map s (fun uu___128_1848 -> (match (uu___128_1848) with
| UNIV (u', t) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___151_1949.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_1949.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1950}))
in ((uu____1948), (imp)))
end)))))
...
let uu___152_3433 = wl
in {attempting = uu___152_3433.attempting; wl_deferred = uu___152_3433.wl_deferred; ctr = (wl.ctr + (Prims.parse_int "1")); defer_ok = uu___152_3433.defer_ok; smt_ok = uu___152_3433.smt_ok; tcenv = uu___152_3433.tcenv});
)
end))))
...
let uu___153_3461 = wl
in {attempting = uu___153_3461.attempting; wl_deferred = uu___153_3461.wl_deferred; ctr = (wl.ctr + (Prims.parse_int "1")); defer_ok = uu___153_3461.defer_ok; smt_ok = uu___153_3461.smt_ok; tcenv = uu___153_3461.tcenv});
))
...
let head_match : match_result  ->  match_result = (fun uu___129_5091 -> (match (uu___129_5091) with
| MisMatch (i, j) -> begin
MisMatch (((i), (j)))
end
| uu____5106 -> begin
...
let tc_to_string : tc  ->  Prims.string = (fun uu___130_6152 -> (match (uu___130_6152) with
...
let uu___154_6620 = x
in {FStar_Syntax_Syntax.ppname = uu___154_6620.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___154_6620.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})), (imp)))::out) bs3 tcs2)
end
| ([], (C (c2))::[]) -> begin
...
let rec decompose1 = (fun out uu___131_6691 -> (match (uu___131_6691) with
| [] -> begin
...
let rebuild = (fun uu___132_6863 -> (match (uu___132_6863) with
| [] -> begin
t1
end
| uu____6866 -> begin
...
let un_T : tc  ->  FStar_Syntax_Syntax.term = (fun uu___133_6898 -> (match (uu___133_6898) with
...
let arg_of_tc : tc  ->  FStar_Syntax_Syntax.arg = (fun uu___134_6913 -> (match (uu___134_6913) with
...
let uu___155_7793 = b
in {FStar_Syntax_Syntax.ppname = uu___155_7793.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___155_7793.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (imp))
in (
...
in {FStar_TypeChecker_Common.pid = uu___156_8079.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____8084; FStar_TypeChecker_Common.relation = uu___156_8079.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____8085; FStar_TypeChecker_Common.element = uu___156_8079.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___156_8079.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___156_8079.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___156_8079.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___156_8079.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___156_8079.FStar_TypeChecker_Common.rank}))))
...
let uu___157_8419 = tp
in (

let uu____8424 = (force_refinement ((b), (ref_opt)))
in {FStar_TypeChecker_Common.pid = uu___157_8419.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___157_8419.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___157_8419.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____8424; FStar_TypeChecker_Common.element = uu___157_8419.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___157_8419.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___157_8419.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___157_8419.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___157_8419.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___157_8419.FStar_TypeChecker_Common.rank}))
in ((rank), (uu____8414))))
end)
end))
end
...
let uu___158_8536 = tp
in (

let uu____8541 = (force_refinement ((b), (ref_opt)))
in {FStar_TypeChecker_Common.pid = uu___158_8536.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____8541; FStar_TypeChecker_Common.relation = uu___158_8536.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___158_8536.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___158_8536.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___158_8536.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___158_8536.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___158_8536.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___158_8536.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___158_8536.FStar_TypeChecker_Common.rank}))
...
let uu___159_8588 = tp1
in {FStar_TypeChecker_Common.pid = uu___159_8588.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___159_8588.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___159_8588.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___159_8588.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___159_8588.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___159_8588.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___159_8588.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___159_8588.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___159_8588.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = FStar_Pervasives_Native.Some (rank)}) (fun _0_52 -> FStar_TypeChecker_Common.TProb (_0_52)))
in ((rank), (uu____8582)))
end))
end))
end))
...
let uu___160_8604 = cp
in {FStar_TypeChecker_Common.pid = uu___160_8604.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___160_8604.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___160_8604.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___160_8604.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___160_8604.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___160_8604.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___160_8604.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___160_8604.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___160_8604.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = FStar_Pervasives_Native.Some (rigid_rigid)}) (fun _0_53 -> FStar_TypeChecker_Common.CProb (_0_53)))
...
let uu___161_9668 = probs
in {attempting = tl1; wl_deferred = uu___161_9668.wl_deferred; ctr = uu___161_9668.ctr; defer_ok = uu___161_9668.defer_ok; smt_ok = uu___161_9668.smt_ok; tcenv = uu___161_9668.tcenv})
in (match (hd1) with
| FStar_TypeChecker_Common.CProb (cp) -> begin
...
in {attempting = uu____9865; wl_deferred = rest; ctr = uu___162_9864.ctr; defer_ok = uu___162_9864.defer_ok; smt_ok = uu___162_9864.smt_ok; tcenv = uu___162_9864.tcenv}))
...
let uu____10461 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun uu___135_10487 -> (match (uu___135_10487) with
...
let uu___163_10750 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = uu___163_10750.wl_deferred; ctr = uu___163_10750.ctr; defer_ok = uu___163_10750.defer_ok; smt_ok = uu___163_10750.smt_ok; tcenv = uu___163_10750.tcenv})
in (
...
let uu___164_10755 = wl
in {attempting = sub_probs; wl_deferred = uu___164_10755.wl_deferred; ctr = uu___164_10755.ctr; defer_ok = uu___164_10755.defer_ok; smt_ok = uu___164_10755.smt_ok; tcenv = uu___164_10755.tcenv}))
...
let uu___165_10760 = wl
in {attempting = rest; wl_deferred = uu___165_10760.wl_deferred; ctr = uu___165_10760.ctr; defer_ok = uu___165_10760.defer_ok; smt_ok = uu___165_10760.smt_ok; tcenv = uu___165_10760.tcenv})
in (
...
let uu____11312 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun uu___136_11338 -> (match (uu___136_11338) with
| FStar_TypeChecker_Common.TProb (tp1) -> begin
(match (tp1.FStar_TypeChecker_Common.rank) with
...
let uu___166_11651 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = uu___166_11651.wl_deferred; ctr = uu___166_11651.ctr; defer_ok = uu___166_11651.defer_ok; smt_ok = uu___166_11651.smt_ok; tcenv = uu___166_11651.tcenv})
in (
...
let uu___167_11656 = wl
in {attempting = sub_probs; wl_deferred = uu___167_11656.wl_deferred; ctr = uu___167_11656.ctr; defer_ok = uu___167_11656.defer_ok; smt_ok = uu___167_11656.smt_ok; tcenv = uu___167_11656.tcenv}))
...
let uu___168_11661 = wl
in {attempting = rest; wl_deferred = uu___168_11661.wl_deferred; ctr = uu___168_11661.ctr; defer_ok = uu___168_11661.defer_ok; smt_ok = uu___168_11661.smt_ok; tcenv = uu___168_11661.tcenv})
in (
...
let uu___169_11815 = hd1
in (

let uu____11816 = (FStar_Syntax_Subst.subst subst1 hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___169_11815.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___169_11815.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____11816}))
in (

let hd21 = (

let uu___170_11820 = hd2
in (

let uu____11821 = (FStar_Syntax_Subst.subst subst1 hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___170_11820.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___170_11820.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____11821}))
in (
...
let uu___171_12163 = problem
in {FStar_TypeChecker_Common.pid = uu___171_12163.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___171_12163.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___171_12163.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___171_12163.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___171_12163.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___171_12163.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___171_12163.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___171_12163.FStar_TypeChecker_Common.rank}) wl1)
end
...
let uu___172_12526 = problem
in {FStar_TypeChecker_Common.pid = uu___172_12526.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = uu___172_12526.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = uu___172_12526.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___172_12526.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___172_12526.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___172_12526.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___172_12526.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___172_12526.FStar_TypeChecker_Common.rank}) wl1)))
end)
end))
end))
end))
...
let imitate' = (fun orig env1 wl1 uu___137_13611 -> (match (uu___137_13611) with
| FStar_Pervasives_Native.None -> begin
...
let uu___173_16804 = problem
in (

let uu____16805 = (FStar_Syntax_Util.unmeta t1)
in {FStar_TypeChecker_Common.pid = uu___173_16804.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____16805; FStar_TypeChecker_Common.relation = uu___173_16804.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___173_16804.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___173_16804.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___173_16804.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___173_16804.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___173_16804.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___173_16804.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___173_16804.FStar_TypeChecker_Common.rank}))
...
let uu___173_16815 = problem
in (

let uu____16816 = (FStar_Syntax_Util.unmeta t1)
in {FStar_TypeChecker_Common.pid = uu___173_16815.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____16816; FStar_TypeChecker_Common.relation = uu___173_16815.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___173_16815.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___173_16815.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___173_16815.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___173_16815.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___173_16815.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___173_16815.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___173_16815.FStar_TypeChecker_Common.rank}))
...
let uu___174_16846 = problem
in (

let uu____16847 = (FStar_Syntax_Util.unmeta t2)
in {FStar_TypeChecker_Common.pid = uu___174_16846.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___174_16846.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___174_16846.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____16847; FStar_TypeChecker_Common.element = uu___174_16846.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___174_16846.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___174_16846.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___174_16846.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___174_16846.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___174_16846.FStar_TypeChecker_Common.rank}))
...
let uu___174_16857 = problem
in (

let uu____16858 = (FStar_Syntax_Util.unmeta t2)
in {FStar_TypeChecker_Common.pid = uu___174_16857.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___174_16857.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___174_16857.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____16858; FStar_TypeChecker_Common.element = uu___174_16857.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___174_16857.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___174_16857.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___174_16857.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___174_16857.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___174_16857.FStar_TypeChecker_Common.rank}))
...
let mk_c = (fun c uu___138_16917 -> (match (uu___138_16917) with
| [] -> begin
c
end
| bs -> begin
...
let mk_t = (fun t l uu___139_17168 -> (match (uu___139_17168) with
| [] -> begin
t
end
| bs -> begin
...
let uu___175_17492 = problem
in {FStar_TypeChecker_Common.pid = uu___175_17492.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___175_17492.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___175_17492.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___175_17492.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___175_17492.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___175_17492.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___175_17492.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___175_17492.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___175_17713 = problem
in {FStar_TypeChecker_Common.pid = uu___175_17713.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___175_17713.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___175_17713.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___175_17713.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___175_17713.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___175_17713.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___175_17713.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___175_17713.FStar_TypeChecker_Common.rank}) wl)
end
| (FStar_Util.Inl (t_abs), FStar_Util.Inr (not_abs)) -> begin
(
...
let uu___176_17890 = wl
in {attempting = (ref_prob)::[]; wl_deferred = []; ctr = uu___176_17890.ctr; defer_ok = false; smt_ok = uu___176_17890.smt_ok; tcenv = uu___176_17890.tcenv}))
...
let uu___177_17921 = wl1
in {attempting = uu___177_17921.attempting; wl_deferred = uu___177_17921.wl_deferred; ctr = (wl1.ctr + (Prims.parse_int "1")); defer_ok = uu___177_17921.defer_ok; smt_ok = uu___177_17921.smt_ok; tcenv = uu___177_17921.tcenv})
...
let uu___178_18310 = problem
in {FStar_TypeChecker_Common.pid = uu___178_18310.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___178_18310.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___178_18310.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___178_18310.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___178_18310.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___178_18310.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___178_18310.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___178_18310.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___178_18310.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___178_18353 = problem
in {FStar_TypeChecker_Common.pid = uu___178_18353.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___178_18353.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___178_18353.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___178_18353.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___178_18353.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___178_18353.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___178_18353.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___178_18353.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___178_18353.FStar_TypeChecker_Common.rank}) wl)
end
| (FStar_Syntax_Syntax.Tm_uvar (uu____18354), FStar_Syntax_Syntax.Tm_arrow (uu____18355)) -> begin
(solve_t' env (

let uu___178_18385 = problem
in {FStar_TypeChecker_Common.pid = uu___178_18385.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___178_18385.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___178_18385.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___178_18385.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___178_18385.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___178_18385.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___178_18385.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___178_18385.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___178_18385.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___178_18440 = problem
in {FStar_TypeChecker_Common.pid = uu___178_18440.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___178_18440.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___178_18440.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___178_18440.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___178_18440.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___178_18440.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___178_18440.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___178_18440.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___178_18440.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___179_18469 = problem
in {FStar_TypeChecker_Common.pid = uu___179_18469.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___179_18469.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___179_18469.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___179_18469.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___179_18469.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___179_18469.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___179_18469.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___179_18469.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___179_18469.FStar_TypeChecker_Common.rank}))
in (
...
let uu___180_18527 = problem
in {FStar_TypeChecker_Common.pid = uu___180_18527.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___180_18527.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___180_18527.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___180_18527.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___180_18527.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___180_18527.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___180_18527.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___180_18527.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___180_18527.FStar_TypeChecker_Common.rank}))
in (
...
let uu___181_18548 = y
in {FStar_Syntax_Syntax.ppname = uu___181_18548.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___181_18548.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
...
let uu___179_18622 = problem
in {FStar_TypeChecker_Common.pid = uu___179_18622.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___179_18622.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___179_18622.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___179_18622.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___179_18622.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___179_18622.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___179_18622.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___179_18622.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___179_18622.FStar_TypeChecker_Common.rank}))
in (
...
let uu___180_18680 = problem
in {FStar_TypeChecker_Common.pid = uu___180_18680.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___180_18680.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___180_18680.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___180_18680.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___180_18680.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___180_18680.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___180_18680.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___180_18680.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___180_18680.FStar_TypeChecker_Common.rank}))
in (
...
let uu___181_18701 = y
in {FStar_Syntax_Syntax.ppname = uu___181_18701.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___181_18701.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
...
let uu___182_18781 = problem
in {FStar_TypeChecker_Common.pid = uu___182_18781.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___182_18781.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___182_18781.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___182_18781.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___182_18781.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___182_18781.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___182_18781.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___182_18781.FStar_TypeChecker_Common.rank}) wl)
end))
end)
end
...
let uu___182_18864 = problem
in {FStar_TypeChecker_Common.pid = uu___182_18864.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___182_18864.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___182_18864.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___182_18864.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___182_18864.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___182_18864.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___182_18864.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___182_18864.FStar_TypeChecker_Common.rank}) wl)
end))
end)
end
...
let uu___183_18902 = problem
in {FStar_TypeChecker_Common.pid = uu___183_18902.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___183_18902.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___183_18902.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___183_18902.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___183_18902.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___183_18902.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___183_18902.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___183_18902.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___183_18902.FStar_TypeChecker_Common.rank}) wl))
end
...
let uu___184_18938 = problem
in {FStar_TypeChecker_Common.pid = uu___184_18938.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___184_18938.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___184_18938.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___184_18938.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___184_18938.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___184_18938.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___184_18938.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___184_18938.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___184_18938.FStar_TypeChecker_Common.rank}) wl))
end
...
let is_null_wp_2 = (FStar_All.pipe_right c21.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___140_20831 -> (match (uu___140_20831) with
...
in {FStar_TypeChecker_Common.pid = uu___185_21296.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____21301; FStar_TypeChecker_Common.relation = uu___185_21296.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___185_21296.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___185_21296.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___185_21296.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___185_21296.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___185_21296.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___185_21296.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___185_21296.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___185_21318.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____21323; FStar_TypeChecker_Common.relation = uu___185_21318.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___185_21318.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___185_21318.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___185_21318.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___185_21318.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___185_21318.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___185_21318.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___185_21318.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___186_21340.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___186_21340.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___186_21340.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____21345; FStar_TypeChecker_Common.element = uu___186_21340.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___186_21340.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___186_21340.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___186_21340.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___186_21340.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___186_21340.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___186_21362.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___186_21362.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___186_21362.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____21367; FStar_TypeChecker_Common.element = uu___186_21362.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___186_21362.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___186_21362.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___186_21362.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___186_21362.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___186_21362.FStar_TypeChecker_Common.rank}))
...
let uu___187_21771 = probs
in {attempting = uu___187_21771.attempting; wl_deferred = uu___187_21771.wl_deferred; ctr = uu___187_21771.ctr; defer_ok = false; smt_ok = uu___187_21771.smt_ok; tcenv = uu___187_21771.tcenv})
end
| uu____21772 -> begin
probs
end))
...
let uu___188_21811 = g
in {FStar_TypeChecker_Env.guard_f = f2; FStar_TypeChecker_Env.deferred = uu___188_21811.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___188_21811.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___188_21811.FStar_TypeChecker_Env.implicits}));
));
)
end))
...
let uu___189_22334 = (empty_worklist env)
in {attempting = uu___189_22334.attempting; wl_deferred = uu___189_22334.wl_deferred; ctr = uu___189_22334.ctr; defer_ok = false; smt_ok = uu___189_22334.smt_ok; tcenv = uu___189_22334.tcenv})
...
let uu___190_22589 = g
in {FStar_TypeChecker_Env.guard_f = uu___190_22589.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = uu___190_22589.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___190_22589.FStar_TypeChecker_Env.implicits})
end
| uu____22594 -> begin
...
let uu___191_22598 = g1
in {FStar_TypeChecker_Env.guard_f = uu___191_22598.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___191_22598.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = (([]), ([])); FStar_TypeChecker_Env.implicits = uu___191_22598.FStar_TypeChecker_Env.implicits});
));
))))
...
let uu___192_22808 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___192_22808.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___192_22808.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___192_22808.FStar_TypeChecker_Env.implicits})
in (
...
let uu___193_23146 = env1
in {FStar_TypeChecker_Env.solver = uu___193_23146.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___193_23146.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___193_23146.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___193_23146.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___193_23146.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___193_23146.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___193_23146.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___193_23146.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___193_23146.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___193_23146.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___193_23146.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___193_23146.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___193_23146.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___193_23146.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___193_23146.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___193_23146.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___193_23146.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___193_23146.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___193_23146.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___193_23146.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___193_23146.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___193_23146.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___193_23146.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___193_23146.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___193_23146.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___193_23146.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___193_23146.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___193_23146.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___193_23146.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___193_23146.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___193_23146.FStar_TypeChecker_Env.tc_hooks})
end
| uu____23147 -> begin
env1
end)
...
let uu___194_23157 = env2
in {FStar_TypeChecker_Env.solver = uu___194_23157.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___194_23157.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___194_23157.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___194_23157.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___194_23157.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___194_23157.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___194_23157.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___194_23157.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___194_23157.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___194_23157.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___194_23157.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___194_23157.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___194_23157.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___194_23157.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___194_23157.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___194_23157.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___194_23157.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___194_23157.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___194_23157.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___194_23157.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___194_23157.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___194_23157.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___194_23157.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___194_23157.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___194_23157.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___194_23157.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___194_23157.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___194_23157.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___194_23157.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___194_23157.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___194_23157.FStar_TypeChecker_Env.tc_hooks}) tm1)
...
let uu___195_23170 = env2
in {FStar_TypeChecker_Env.solver = uu___195_23170.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___195_23170.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___195_23170.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___195_23170.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___195_23170.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___195_23170.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___195_23170.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___195_23170.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___195_23170.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___195_23170.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___195_23170.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___195_23170.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___195_23170.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___195_23170.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___195_23170.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___195_23170.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___195_23170.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___195_23170.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___195_23170.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___195_23170.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___195_23170.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___195_23170.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___195_23170.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___195_23170.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___195_23170.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___195_23170.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___195_23170.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___195_23170.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___195_23170.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___195_23170.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___195_23170.FStar_TypeChecker_Env.tc_hooks}) tm1)
...
let uu___196_23175 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___196_23175.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___196_23175.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___196_23175.FStar_TypeChecker_Env.implicits})
end
| uu____23176 -> begin
g1
end)
...
let uu___197_23212 = g
in (

let uu____23213 = (until_fixpoint (([]), (false)) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = uu___197_23212.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___197_23212.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___197_23212.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu____23213})))))
...
let uu___198_23335 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = uu___198_23335.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___198_23335.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = (([]), ((((u1), (u2)))::[])); FStar_TypeChecker_Env.implicits = uu___198_23335.FStar_TypeChecker_Env.implicits}))
