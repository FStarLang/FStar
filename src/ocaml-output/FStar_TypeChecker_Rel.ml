...
in (let _149_1269 = (let _149_1268 = (let _149_1267 = (let _149_1261 = (let _149_1260 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_149_1260)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _149_1261 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _149_1266 = (let _149_1265 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _149_1264 = (let _149_1263 = (let _149_1262 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _149_1262))
in (_149_1263)::[])
in (_149_1265)::_149_1264))
in (_149_1267, _149_1266)))
in FStar_Syntax_Syntax.Tm_app (_149_1268))
in (FStar_Syntax_Syntax.mk _149_1269 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(
# 1860 "FStar.TypeChecker.Rel.fst"
let wp2_imp_wp1 = (let _149_1284 = (let _149_1283 = (let _149_1282 = (let _149_1271 = (let _149_1270 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_149_1270)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _149_1271 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_binop))
in (let _149_1281 = (let _149_1280 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _149_1279 = (let _149_1278 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _149_1277 = (let _149_1276 = (let _149_1272 = (FStar_Syntax_Syntax.fvar None FStar_Syntax_Const.imp_lid r)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _149_1272))
in (let _149_1275 = (let _149_1274 = (let _149_1273 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _149_1273))
in (_149_1274)::[])
...
in (FStar_Syntax_Syntax.mk _149_1284 None r))
in (let _149_1293 = (let _149_1292 = (let _149_1291 = (let _149_1286 = (let _149_1285 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_149_1285)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _149_1286 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_as_type))
in (let _149_1290 = (let _149_1289 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _149_1288 = (let _149_1287 = (FStar_Syntax_Syntax.as_arg wp2_imp_wp1)
in (_149_1287)::[])
in (_149_1289)::_149_1288))
in (_149_1291, _149_1290)))
in FStar_Syntax_Syntax.Tm_app (_149_1292))
in (FStar_Syntax_Syntax.mk _149_1293 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end
in (
# 1867 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _149_1295 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _149_1294 -> FStar_TypeChecker_Common.TProb (_149_1294)) _149_1295))
in (
# 1868 "FStar.TypeChecker.Rel.fst"
let wl = (let _149_1299 = (let _149_1298 = (let _149_1297 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _149_1297 g))
in (FStar_All.pipe_left (fun _149_1296 -> Some (_149_1296)) _149_1298))
in (solve_prob orig _149_1299 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _149_1303 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _70_2709 -> (match (_70_2709) with
...
let carry = (let _149_1309 = (FStar_List.map (fun _70_2724 -> (match (_70_2724) with
| (_70_2722, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _149_1309 (FStar_String.concat ",\n")))
in (
...
let _70_2758 = g
in (let _149_1324 = (let _149_1323 = (let _149_1322 = (let _149_1321 = (FStar_Syntax_Syntax.mk_binder x)
in (_149_1321)::[])
in (u_abs _149_1322 f))
in (FStar_All.pipe_left (fun _149_1320 -> FStar_TypeChecker_Common.NonTrivial (_149_1320)) _149_1323))
in {FStar_TypeChecker_Env.guard_f = _149_1324; FStar_TypeChecker_Env.deferred = _70_2758.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _70_2758.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _70_2758.FStar_TypeChecker_Env.implicits}))
in Some (_149_1325)))
end))
...
let _70_2765 = g
in (let _149_1336 = (let _149_1335 = (let _149_1334 = (let _149_1333 = (let _149_1332 = (let _149_1331 = (FStar_Syntax_Syntax.as_arg e)
in (_149_1331)::[])
in (f, _149_1332))
in FStar_Syntax_Syntax.Tm_app (_149_1333))
in (FStar_Syntax_Syntax.mk _149_1334 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _149_1330 -> FStar_TypeChecker_Common.NonTrivial (_149_1330)) _149_1335))
in {FStar_TypeChecker_Env.guard_f = _149_1336; FStar_TypeChecker_Env.deferred = _70_2765.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _70_2765.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _70_2765.FStar_TypeChecker_Env.implicits}))
end))
...
(let _149_1343 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_149_1343))
end))
...
let binop_guard : (FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula)  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t = (fun f g1 g2 -> (let _149_1366 = (f g1.FStar_TypeChecker_Env.guard_f g2.FStar_TypeChecker_Env.guard_f)
in {FStar_TypeChecker_Env.guard_f = _149_1366; FStar_TypeChecker_Env.deferred = (FStar_List.append g1.FStar_TypeChecker_Env.deferred g2.FStar_TypeChecker_Env.deferred); FStar_TypeChecker_Env.univ_ineqs = (FStar_List.append g1.FStar_TypeChecker_Env.univ_ineqs g2.FStar_TypeChecker_Env.univ_ineqs); FStar_TypeChecker_Env.implicits = (FStar_List.append g1.FStar_TypeChecker_Env.implicits g2.FStar_TypeChecker_Env.implicits)}))
...
let _70_2818 = g
in (let _149_1381 = (let _149_1380 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _149_1380 (fun _149_1379 -> FStar_TypeChecker_Common.NonTrivial (_149_1379))))
in {FStar_TypeChecker_Env.guard_f = _149_1381; FStar_TypeChecker_Env.deferred = _70_2818.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _70_2818.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _70_2818.FStar_TypeChecker_Env.implicits}))
end))
...
(let _149_1389 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _149_1388 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _149_1389 (rel_to_string rel) _149_1388)))
end else begin
"TOP"
end
in (
...
let x = (let _149_1400 = (let _149_1399 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _149_1398 -> Some (_149_1398)) _149_1399))
in (FStar_Syntax_Syntax.new_bv _149_1400 t1))
in (
# 1962 "FStar.TypeChecker.Rel.fst"
let env = (FStar_TypeChecker_Env.push_bv env x)
in (
# 1963 "FStar.TypeChecker.Rel.fst"
let p = (let _149_1404 = (let _149_1402 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _149_1401 -> Some (_149_1401)) _149_1402))
in (let _149_1403 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _149_1404 _149_1403)))
...
(let _149_1416 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _149_1416))
end else begin
()
end
in (err (d, s))))
...
(let _149_1421 = (FStar_Syntax_Print.term_to_string f)
...
(let _149_1422 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _149_1423 = (FStar_Syntax_Util.unmeta f)
in _149_1423.FStar_Syntax_Syntax.n)) with
...
| Some (d) -> begin
(let _149_1435 = (let _149_1434 = (let _149_1433 = (let _149_1432 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _149_1432 (fun _149_1431 -> FStar_TypeChecker_Common.NonTrivial (_149_1431))))
in {FStar_TypeChecker_Env.guard_f = _149_1433; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _149_1434))
in (FStar_All.pipe_left (fun _149_1430 -> Some (_149_1430)) _149_1435))
end))
...
(let _149_1443 = (FStar_Syntax_Print.term_to_string t1)
in (let _149_1442 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _149_1446 = (let _149_1445 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _149_1445))
in (FStar_All.pipe_left (fun _149_1444 -> FStar_TypeChecker_Common.TProb (_149_1444)) _149_1446))
in (
# 2000 "FStar.TypeChecker.Rel.fst"
let g = (let _149_1448 = (solve_and_commit env (singleton env prob) (fun _70_2887 -> None))
in (FStar_All.pipe_left (with_guard env prob) _149_1448))
in g))))
...
| None -> begin
(let _149_1458 = (let _149_1457 = (let _149_1456 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _149_1455 = (FStar_TypeChecker_Env.get_range env)
in (_149_1456, _149_1455)))
in FStar_Syntax_Syntax.Error (_149_1457))
in (Prims.raise _149_1458))
end
| Some (g) -> begin
(
...
in (let _149_1459 = (guard_to_string env g)
in (FStar_Util.print3 "teq of %s and %s succeeded with guard %s\n" _149_1461 _149_1460 _149_1459))))
end else begin
()
end
in g)
...
let g = (let _149_1471 = (solve_and_commit env (singleton env prob) (fun _70_2906 -> None))
...
(let _149_1475 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _149_1474 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _149_1473 = (let _149_1472 = (FStar_Util.must g)
in (guard_to_string env _149_1472))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _149_1475 _149_1474 _149_1473))))
end else begin
()
end
...
let subtype_fail = (fun env t1 t2 -> (let _149_1482 = (let _149_1481 = (let _149_1480 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _149_1479 = (FStar_TypeChecker_Env.get_range env)
in (_149_1480, _149_1479)))
in FStar_Syntax_Syntax.Error (_149_1481))
in (Prims.raise _149_1482)))
...
(let _149_1490 = (FStar_Syntax_Print.comp_to_string c1)
in (let _149_1489 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _149_1493 = (let _149_1492 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _149_1492 "sub_comp"))
in (FStar_All.pipe_left (fun _149_1491 -> FStar_TypeChecker_Common.CProb (_149_1491)) _149_1493))
in (let _149_1495 = (solve_and_commit env (singleton env prob) (fun _70_2921 -> None))
in (FStar_All.pipe_left (with_guard env prob) _149_1495))))))
...
in (let _149_1513 = (let _149_1512 = (let _149_1511 = (let _149_1509 = (FStar_Syntax_Print.univ_to_string u1)
in (let _149_1508 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _149_1509 _149_1508 msg)))
in (let _149_1510 = (FStar_TypeChecker_Env.get_range env)
in (_149_1511, _149_1510)))
in FStar_Syntax_Syntax.Error (_149_1512))
in (Prims.raise _149_1513)))))
in (
...
(let _149_1525 = (insert uv u1 out)
in (group_by _149_1525 rest))
end)
end
| _70_2961 -> begin
None
...
(let _149_1546 = (wl_to_string wl)
in (let _149_1545 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
(let _149_1553 = (FStar_TypeChecker_Env.get_range env)
in (let _149_1552 = (let _149_1551 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _149_1551))
in (FStar_TypeChecker_Errors.diag _149_1553 _149_1552)))
end else begin
()
end
...
let _70_3093 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _149_1564 = (FStar_Syntax_Print.uvar_to_string u)
in (let _149_1563 = (FStar_Syntax_Print.term_to_string tm)
in (let _149_1562 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _149_1564 _149_1563 _149_1562))))
end else begin
()
end
in (
# 2172 "FStar.TypeChecker.Rel.fst"
let _70_3100 = (env.FStar_TypeChecker_Env.type_of (
# 2172 "FStar.TypeChecker.Rel.fst"
let _70_3095 = env
in {FStar_TypeChecker_Env.solver = _70_3095.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _70_3095.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _70_3095.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _70_3095.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _70_3095.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _70_3095.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _70_3095.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _70_3095.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _70_3095.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _70_3095.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _70_3095.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _70_3095.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _70_3095.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _70_3095.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _70_3095.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _70_3095.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _70_3095.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _70_3095.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.default_effects = _70_3095.FStar_TypeChecker_Env.default_effects; FStar_TypeChecker_Env.type_of = _70_3095.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _70_3095.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true}) tm)
in (match (_70_3100) with
| (_70_3098, g) -> begin
(
...
let _70_3102 = g
in (let _149_1565 = (until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _70_3102.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _70_3102.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _70_3102.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _149_1565})))))
...
let g = (let _149_1570 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _149_1570 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _149_1571 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _149_1571))
end
| (_70_3111, _70_3113, _70_3115, _70_3117, r)::_70_3109 -> begin
...
let _70_3123 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = _70_3123.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _70_3123.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((u1, u2))::[]; FStar_TypeChecker_Env.implicits = _70_3123.FStar_TypeChecker_Env.implicits}))
