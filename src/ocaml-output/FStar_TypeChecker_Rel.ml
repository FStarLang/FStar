                       ...
                       | (args_rhs, last_arg_rhs) ->
                           ...
                           (match uu___5 with
                            | Flex (t_lhs, u_lhs, _lhs_args) ->
                                let uu___6 =
                                  let t_last_arg =
                                    env1.FStar_TypeChecker_Env.type_of_well_typed_tot_or_gtot_term
                                      (let uu___7 = env1 in
                                       {
                                         FStar_TypeChecker_Env.solver =
                                  ...
                                  let uu___7 =
                                    ...
                                    let uu___8 =
                                      let uu___9 =
                                        let uu___10 =
                                          let uu___11 =
                                            FStar_All.pipe_right t_res_lhs
                                    ...
                                    copy_uvar u_lhs
                                      (FStar_List.append bs_lhs [b]) uu___8
                                      wl1 in
                                  match uu___7 with
                                  | (uu___8, lhs', wl2) ->
                                      let uu___9 =
              ...
              | (FStar_Syntax_Syntax.Tm_abs uu___7, uu___8) ->
                  ...
                  let force_eta t =
                    ...
                    then t
                      ...
                      (let uu___10 =
                         env.FStar_TypeChecker_Env.type_of_tot_or_gtot_term
                           (let uu___11 = env in
                            {
                              FStar_TypeChecker_Env.solver =
                              ...
                              FStar_TypeChecker_Env.type_of_tot_or_gtot_term
                                =
                                (uu___11.FStar_TypeChecker_Env.type_of_tot_or_gtot_term);
                              FStar_TypeChecker_Env.type_of_well_typed_tot_or_gtot_term
                                =
                                (uu___11.FStar_TypeChecker_Env.type_of_well_typed_tot_or_gtot_term);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___11.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_and_effect_of_well_typed_tot_or_gtot_term
                                =
                                (uu___11.FStar_TypeChecker_Env.check_type_and_effect_of_well_typed_tot_or_gtot_term);
           ...
           then
             ...
             (let is_null_wp_2 =
              ...
              | (wpc1, wpc2) ->
                  ...
                  (match uu___4 with
                   | (univ_sub_probs, wl1) ->
                       let uu___5 = FStar_Util.physical_equality wpc1 wpc2 in
                       if uu___5
                       then
                         let tprob1 =
                           let uu___6 =
                           ...
                           FStar_TypeChecker_Common.TProb uu___6 in
                         let uu___6 =
                           attempt
                             (FStar_List.append univ_sub_probs [tprob1]) wl1 in
                         solve env uu___6
                       else
                         (let uu___7 =
                            let uu___8 =
                          ...
                          | (c2_decl, qualifiers) ->
                              ...
                              then
                                let c1_repr =
                                  let uu___9 =
                                    let uu___10 =
                                      let uu___11 = lift_c1 () in
                                      FStar_Syntax_Syntax.mk_Comp uu___11 in
                                    let uu___11 =
                                  ...
                                  norm_with_steps
                                    ...
                                    [FStar_TypeChecker_Env.UnfoldUntil
                                       FStar_Syntax_Syntax.delta_constant;
                                    FStar_TypeChecker_Env.Weak;
                                    FStar_TypeChecker_Env.HNF] env uu___9 in
                                let c2_repr =
                                  let uu___9 =
                                    let uu___10 =
                                  ...
                                  let uu___10 =
                                    ...
                                    let uu___12 =
                                      FStar_Syntax_Print.term_to_string
                                        c2_repr in
                                    FStar_Util.format2
                                      "sub effect repr: %s <: %s" uu___11
                                      uu___12 in
                                  sub_prob wl1 c1_repr
                                    problem.FStar_TypeChecker_Common.relation
                                    c2_repr uu___10 in
                                (match uu___9 with
                                 | (prob, wl2) ->
                                     ...
                                     let uu___10 =
                                       attempt
                                         (FStar_List.append univ_sub_probs
                                            [prob]) wl3 in
                                     solve env uu___10)
                              else
                                (let g =
                                        ...
                                        ((let uu___12 =
                                         ...
                                         (let c1_univ =
                                          ...
                                          let uu___12 =
                                            ...
                                            FStar_Syntax_Syntax.Tm_app
                                              uu___13 in
                                          FStar_Syntax_Syntax.mk uu___12 r))
                                      else
                                        (let c2_univ =
                                           env.FStar_TypeChecker_Env.universe_of
                                             env
                                         ...
                                         FStar_Syntax_Syntax.mk uu___12 r)) in
                                 (let uu___11 =
                                    FStar_All.pipe_left
                                      (FStar_TypeChecker_Env.debug env)
                                      (FStar_Options.Other "Rel") in
                                    ...
                                    let uu___12 =
                                      let uu___13 =
                                        FStar_TypeChecker_Normalize.normalize
                                          ...
                                          FStar_TypeChecker_Env.Eager_unfolding;
                                          FStar_TypeChecker_Env.Primops;
                                          FStar_TypeChecker_Env.Simplify] env
                                          g in
                                      FStar_Syntax_Print.term_to_string
                                        uu___13 in
                                    FStar_Util.print1
                                        ...
                                        let uu___12 =
                                          ...
                                          FStar_All.pipe_left
                                            (fun uu___14 ->
                                               FStar_Pervasives_Native.Some
                                                 uu___14) uu___13 in
                                        solve_prob orig uu___12 [] wl2 in
                                      let uu___12 =
                                        attempt
                                          (FStar_List.append univ_sub_probs
                                             [base_prob]) wl3 in
          ...
          ((let uu___3 =
           ...
           (let uu___3 =
            ...
            | (c11, c21) ->
                let uu___4 = ([], wl) in
                (match uu___4 with
                 | (univ_subprobs, wl_univs) ->
                     (match ((c11.FStar_Syntax_Syntax.n),
                              (c21.FStar_Syntax_Syntax.n))
                      with
                      | (FStar_Syntax_Syntax.GTotal (t1, uu___5),
                         FStar_Syntax_Syntax.Total (t2, uu___6)) when
                          ...
                          let tprob1 =
                            let uu___7 =
                              problem_using_guard orig t1
                                ...
                                FStar_Pervasives_Native.None "result type" in
                            FStar_TypeChecker_Common.TProb uu___7 in
                          let uu___7 =
                            attempt
                              (FStar_List.append univ_subprobs [tprob1])
                              wl_univs in
                          solve env uu___7
                      | (FStar_Syntax_Syntax.GTotal uu___5,
                         FStar_Syntax_Syntax.Total uu___6) ->
                          let uu___7 =
                            FStar_Thunk.mkv
                              "incompatible monad ordering: GTot </: Tot" in
                          giveup env uu___7 orig
                      | (FStar_Syntax_Syntax.Total (t1, uu___5),
                         FStar_Syntax_Syntax.Total (t2, uu___6)) ->
                          let tprob1 =
                            let uu___7 =
                              problem_using_guard orig t1
                                problem.FStar_TypeChecker_Common.relation t2
                          ...
                          solve env uu___7
                      | (FStar_Syntax_Syntax.GTotal (t1, uu___5),
                         FStar_Syntax_Syntax.GTotal (t2, uu___6)) ->
                          let tprob1 =
                            let uu___7 =
                              problem_using_guard orig t1
                                problem.FStar_TypeChecker_Common.relation t2
                          ...
                          solve env uu___7
                      | (FStar_Syntax_Syntax.Total (t1, uu___5),
                         FStar_Syntax_Syntax.GTotal (t2, uu___6)) when
                          problem.FStar_TypeChecker_Common.relation =
                            FStar_TypeChecker_Common.SUB
                          ->
                          let tprob1 =
                      ...
                      | (FStar_Syntax_Syntax.Total (t1, uu___5),
                         FStar_Syntax_Syntax.GTotal (t2, uu___6)) ->
                          let uu___7 = FStar_Thunk.mkv "GTot =/= Tot" in
                          giveup env uu___7 orig
                      | (FStar_Syntax_Syntax.GTotal uu___5,
                         FStar_Syntax_Syntax.Comp uu___6) ->
                          let uu___7 =
                            let uu___8 = problem in
                            let uu___9 =
                              let uu___10 =
                                ...
                                uu___10 in
                            {
                              FStar_TypeChecker_Common.pid =
                                (uu___8.FStar_TypeChecker_Common.pid);
                              FStar_TypeChecker_Common.lhs = uu___9;
                              FStar_TypeChecker_Common.relation =
                                (uu___8.FStar_TypeChecker_Common.relation);
                              FStar_TypeChecker_Common.rhs =
                                (uu___8.FStar_TypeChecker_Common.rhs);
                              FStar_TypeChecker_Common.element =
                                (uu___8.FStar_TypeChecker_Common.element);
                      ...
                      | (FStar_Syntax_Syntax.Comp uu___5,
                         FStar_Syntax_Syntax.GTotal uu___6) ->
                          let uu___7 =
                            let uu___8 = problem in
                            let uu___9 =
                              let uu___10 =
                            ...
                            let tprob1 =
                              let uu___8 =
                                problem_using_guard orig
                                  ...
                                  FStar_Pervasives_Native.None "result type" in
                              FStar_TypeChecker_Common.TProb uu___8 in
                            let uu___8 =
                              attempt
                                (FStar_List.append univ_subprobs [tprob1])
                                wl_univs in
                            ...
                            (let c1_comp =
                             ...
                             then
                               ...
                               (let c12 =
                                ...
                                (let uu___11 =
                                   FStar_TypeChecker_Env.is_layered_effect
                                     env c22.FStar_Syntax_Syntax.effect_name in
                                 if uu___11
                                   ...
                                   let hd1 =
                                     let uu___5 = hd in
                                     {
                                       FStar_TypeChecker_Common.imp_reason =
                                         (uu___5.FStar_TypeChecker_Common.imp_reason);
                                       FStar_TypeChecker_Common.imp_uvar =
                                         ctx_u1;
                                       FStar_TypeChecker_Common.imp_tm =
                                         (uu___5.FStar_TypeChecker_Common.imp_tm);
                                  ...
                                  ((let uu___8 =
                                   ...
                                   (let g1 =
                                      ...
                                      FStar_Errors.with_ctx uu___8
                                        (fun uu___9 ->
                                           env1.FStar_TypeChecker_Env.check_type_and_effect_of_well_typed_tot_or_gtot_term
                                             env1 tm1
                                             ...
                                             ((Prims.op_Negation
                                                ...
                                                &&
                                                (Prims.op_Negation
                                                   env1.FStar_TypeChecker_Env.lax))) in
                                    let g' =
                                      let uu___8 =
                                        discharge_guard'
                                          (FStar_Pervasives_Native.Some
