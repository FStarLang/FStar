      ...
      fun defer_to_tac ->
        fun imps ->
          ...
          let uu___1 =
            ...
            FStar_List.op_At wl.wl_deferred uu___2 in
          let uu___2 =
            let uu___3 = as_wl_deferred wl defer_to_tac in
            FStar_List.op_At wl.wl_deferred_to_tac uu___3 in
          let uu___3 = FStar_List.op_At wl.wl_implicits imps in
          {
...
let (maybe_invert_p :
  ...
  fun uu___ ->
    match uu___ with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.op_Bar_Greater (maybe_invert p)
          ...
          (let rec aux prev next =
             ...
             | { FStar_Syntax_Syntax.binder_bv = bv;
                 ...
                 (FStar_TypeChecker_Env.def_check_closed_in rng msg prev
                  ...
                  (let uu___5 = FStar_List.op_At prev [bv] in aux uu___5 bs)) in
           aux [] r)
let (p_scope :
...
let (attempt :
  ...
  fun probs ->
    fun wl ->
      ...
      (let uu___1 = wl in
       let uu___2 = FStar_List.op_At probs wl.attempting in
       {
         attempting = uu___2;
...
let (is_top_level_prob : FStar_TypeChecker_Common.prob -> Prims.bool) =
  fun p ->
    let uu___ = FStar_All.op_Bar_Greater (p_reason p) FStar_List.length in
    uu___ = Prims.int_one
                  ...
                  let scope1 =
                    ...
                    | FStar_Pervasives_Native.Some x ->
                        let uu___ =
                          ...
                          [uu___1] in
                        FStar_List.op_At scope uu___ in
                  let bs =
                    FStar_List.op_At
  ...
  fun env ->
    fun d ->
      fun s ->
        ...
        then
          let uu___1 =
            FStar_All.op_Less_Bar FStar_Range.string_of_range (p_loc d) in
          let uu___2 = prob_to_string env d in
          let uu___3 =
            FStar_All.op_Bar_Greater (p_reason d)
              (FStar_String.concat "\n\t>") in
...
let (whnf' :
  ...
  fun env ->
    fun t ->
      ...
      FStar_All.op_Bar_Greater uu___ FStar_Syntax_Util.unlazy_emb
let (sn' :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
      ...
      FStar_Profiling.profile
        (fun uu___1 ->
           ...
           then
             ...
             FStar_All.op_Bar_Greater uu___3 FStar_Syntax_Util.unlazy_emb
...
let (wl_to_string : worklist -> Prims.string) =
  fun wl ->
    let uu___ =
      let uu___1 =
        let uu___2 =
          FStar_All.op_Bar_Greater wl.wl_deferred
            (FStar_List.map
               (fun uu___3 ->
                  match uu___3 with | (uu___4, uu___5, uu___6, x) -> x)) in
        FStar_List.op_At wl.attempting uu___2 in
                          ...
                          | (v, t_v, wl1) ->
                              ...
                              (FStar_Syntax_Util.set_uvar
                               ...
                               (let args_sol_s =
                                ...
                                let t =
                                  let uu___6 =
                                    FStar_List.op_At args_sol_s args in
                                  FStar_Syntax_Syntax.mk_Tm_app t_v uu___6
                                    t0.FStar_Syntax_Syntax.pos in
                                (t, wl1))))))
           | uu___2 ->
               let uu___3 =
...
let (no_free_uvars : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t ->
    (let uu___ = FStar_Syntax_Free.uvars t in FStar_Util.set_is_empty uu___)
      &&
      (let uu___ = FStar_Syntax_Free.univs t in FStar_Util.set_is_empty uu___)
let rec (may_relate :
  FStar_TypeChecker_Env.env ->
          ...
          | FStar_Syntax_Syntax.Tm_arrow (bs, c) ->
              ...
              then
                ...
                (let uu___3 = FStar_Syntax_Util.abs_formals t in
                 ...
                 | (ys', t1, uu___4) ->
                     let uu___5 =
                       let uu___6 = FStar_List.op_At ys ys' in (uu___6, t1) in
                     let uu___6 = FStar_Syntax_Util.arrow_formals_comp k in
                     (uu___5, uu___6))
          | uu___2 ->
              let uu___3 =
...
let (extend_universe_solution :
  ...
  fun pid ->
    fun sol ->
      fun wl ->
        (let uu___1 =
           FStar_All.op_Less_Bar (FStar_TypeChecker_Env.debug wl.tcenv)
             (FStar_Options.Other "Rel") in
         if uu___1
         then
      ...
      fun uvis ->
        fun wl ->
          ...
          (let uu___3 =
           ...
           then
             let uu___4 =
               FStar_All.op_Less_Bar FStar_Util.string_of_int (p_pid prob) in
...
let (occurs :
  ...
  fun uk ->
    fun t ->
      ...
      let occurs1 =
        FStar_All.op_Bar_Greater uvars
          (FStar_Util.for_some
             (fun uv ->
                        ...
                        (match uu___2 with
                         | (x, imp) ->
                             let uu___3 =
                               ...
                               FStar_All.op_Less_Bar Prims.op_Negation uu___4 in
                             if uu___3
      ...
      fun t2 ->
        ...
        | (FStar_Syntax_Syntax.Tm_uinst (f, uu___),
           FStar_Syntax_Syntax.Tm_uinst (g, uu___1)) ->
            ...
            FStar_All.op_Bar_Greater uu___2 head_match
          ...
          let made_progress t t' =
            let uu___ =
              ...
              let uu___2 =
                ...
                FStar_All.op_Bar_Greater uu___3 FStar_Pervasives_Native.fst in
              (uu___1, uu___2) in
            match uu___ with
            | (head, head') ->
                let uu___1 =
           ...
           then
             ...
             let uu___5 =
               ...
               then "None"
                 ...
                 (let uu___7 =
                    FStar_All.op_Bar_Greater (FStar_Pervasives_Native.snd r)
                      FStar_Util.must in
  ...
  fun tcenv ->
    fun pr ->
      let prob =
        ...
        FStar_All.op_Bar_Greater uu___ maybe_invert_p in
      match prob with
      | FStar_TypeChecker_Common.TProb tp ->
          let uu___ =
                ...
                | (rank1, hd1) ->
                    ...
                    then
                      (match min with
                       | FStar_Pervasives_Native.None ->
                           let uu___2 =
                             let uu___3 = FStar_List.op_At out tl in
                             (hd1, uu___3, rank1) in
                           FStar_Pervasives_Native.Some uu___2
                       | FStar_Pervasives_Native.Some m ->
                           let uu___2 =
                             let uu___3 = FStar_List.op_At out (m :: tl) in
                             (hd1, uu___3, rank1) in
                           FStar_Pervasives_Native.Some uu___2)
                    else
                      (let uu___3 =
      ...
      fun u1 ->
        fun u2 ->
          ...
          let rec filter_out_common_univs u12 u22 =
            let common_elts =
              FStar_All.op_Bar_Greater u12
                (FStar_List.fold_left
                   (fun uvs ->
                      fun uv1 ->
                        let uu___ =
                          FStar_All.op_Bar_Greater u22
                            (FStar_List.existsML
            ...
            let filter =
              FStar_List.filter
                (fun u ->
                   let uu___ =
                     FStar_All.op_Bar_Greater common_elts
                       (FStar_List.existsML
      ...
      (let uu___2 = next_prob probs in
       ...
       | FStar_Pervasives_Native.None ->
           (match probs.wl_deferred with
            ...
            | uu___3 ->
                let uu___4 =
                  FStar_All.op_Bar_Greater probs.wl_deferred
                     ...
                     (match attempt1 with
                      ...
                      | uu___5 ->
                          let uu___6 =
                            let uu___7 = probs in
                            let uu___8 =
                              FStar_All.op_Bar_Greater attempt1
                                (FStar_List.map
                                   (fun uu___9 ->
                                      match uu___9 with
                   ...
                   (match ts1 with
                    ...
                    | t::ts2 ->
                        ...
                        (match uu___2 with
                         | (out1, probs', wl3) ->
                             let uu___3 =
                               let uu___4 = FStar_List.op_At probs probs' in
                               (out1, uu___4, wl3) in
                             aux uu___3 ts2)) in
                               ...
                               let equiv t =
                                 ...
                                 | (u', uu___8) ->
                                     ...
                                     (match uu___9 with
                                      ...
                                      | uu___10 -> false) in
                               let uu___7 =
                                 FStar_All.op_Bar_Greater wl.attempting
                                   (FStar_List.partition
                                      (fun uu___8 ->
                                         match uu___8 with
                  ...
                  | Flex (uu___1, u_lhs, uu___2) ->
                      let imitate_comp bs bs_terms c wl1 =
                        let imitate_tot_or_gtot t uopt f wl2 =
                          ...
                          | (k, univ) ->
                              let uu___4 =
                                let uu___5 = FStar_List.op_At bs_lhs bs in
                                copy_uvar u_lhs uu___5 k wl2 in
                              (match uu___4 with
                               | (uu___5, u, wl3) ->
                                   let uu___6 =
                           ...
                           let rec aux bs bs_terms formals1 wl1 =
                             ...
                             | { FStar_Syntax_Syntax.binder_bv = x;
                                 ...
                                 let uu___4 =
                                   ...
                                   copy_uvar u_lhs uu___5 uu___6 wl1 in
                                 (match uu___4 with
                                  | (_ctx_u_x, u_x, wl2) ->
                                      let y =
                                        let uu___5 =
                                      ...
                                      let uu___6 =
                                        let uu___7 =
                                          let uu___8 =
                                            ...
                                            (uu___9, imp) in
                                          [uu___8] in
                                        FStar_List.op_At bs_terms uu___7 in
                      ...
                      | (hd1, imp) ->
                          ...
                          (match uu___2 with
                           | (hd2, imp') ->
                               ...
                               let uu___3 =
                                 let uu___4 =
                                   FStar_All.op_Less_Bar invert_rel
                                     (p_rel orig) in
                               ...
                               (match uu___3 with
                                | (prob, wl2) ->
                                    ...
                                    let uu___4 =
                                      ...
                                      aux wl2 uu___5 env2 subst1 xs1 ys1 in
                                    (match uu___4 with
                                ...
                                let uu___6 =
                                  ...
                                  | (t_last_arg, uu___8) ->
                                      let uu___9 =
                                        ...
                                        copy_uvar u_lhs uu___10 uu___11 wl1 in
                                      (match uu___9 with
                                       | (uu___10, lhs', wl2) ->
                                           let uu___11 =
                                ...
                                | (uvars, occurs_ok, msg) ->
                                    ...
                                    then
                                      let uu___7 =
                                        ...
                                        FStar_All.op_Less_Bar FStar_Thunk.mkv
                                          uu___8 in
                                      giveup_or_defer env orig wl
                                        FStar_TypeChecker_Common.Deferred_occur_check_failed
                                        uu___7
                                   ...
                                   then
                                     ...
                                     (let uu___13 =
                                      ...
                                      | (ctx_w, (ctx_l, ctx_r)) ->
                                          ...
                                          let zs =
                                            let uu___14 =
                                              FStar_List.op_At ctx_l
                                                binders_lhs in
                                            let uu___15 =
                                              FStar_List.op_At ctx_r
                                                binders_rhs in
                                            intersect_binders gamma_w uu___14
                                              uu___15 in
                                          let uu___14 =
                                            let uu___15 =
                                              let uu___16 =
                                     ...
                                     (match uu___9 with
                                      | Success
                                          ...
                                          (FStar_Syntax_Unionfind.commit tx;
                                           (let uu___12 =
                                              let uu___13 =
                                                FStar_List.op_At defer_to_tac
                                                  defer_to_tac' in
                                              let uu___14 =
                                                FStar_List.op_At imps imps' in
                                              extend_wl wl4 [] uu___13
                                                uu___14 in
                                            FStar_Pervasives_Native.Some
                                              uu___12))
                                      | Failed uu___10 ->
             ...
             (let r = FStar_TypeChecker_Env.get_range env in
              ...
              | (FStar_Syntax_Syntax.Tm_refine uu___7, uu___8) ->
                  let t21 =
                    ...
                    FStar_All.op_Less_Bar force_refinement uu___9 in
                  solve_t env
                    (let uu___9 = problem in
                     {
                       FStar_TypeChecker_Common.pid =
                         ...
                         fun u2 ->
                           ...
                           | (univ_sub_probs, wl1) ->
                               ...
                               (match uu___6 with
                                | (p, wl2) ->
                                    let uu___7 =
                                      FStar_List.op_At univ_sub_probs [p] in
                                    (uu___7, wl2))) ([], wl)
                              ...
                              let sub_probs =
                                let uu___7 =
                                  let uu___8 =
                                    ...
                                    FStar_List.op_At arg_sub_probs uu___9 in
                                  FStar_List.op_At [ret_sub_prob] uu___8 in
                                FStar_List.op_At univ_sub_probs uu___7 in
                              let guard =
                                let guard1 =
                                  let uu___7 =
        ...
        let solve_layered_sub c11 c21 =
          (let uu___1 =
           ...
           then
             let uu___2 =
               let uu___3 =
                 FStar_All.op_Bar_Greater c11 FStar_Syntax_Syntax.mk_Comp in
               FStar_All.op_Bar_Greater uu___3
                 FStar_Syntax_Print.comp_to_string in
             let uu___3 =
               let uu___4 =
                 FStar_All.op_Bar_Greater c21 FStar_Syntax_Syntax.mk_Comp in
               FStar_All.op_Bar_Greater uu___4
                 FStar_Syntax_Print.comp_to_string in
            ...
            (let r = FStar_TypeChecker_Env.get_range env in
             ...
             | (c12, g_lift, stronger_t_opt, is_polymonadic) ->
                 ...
                 then
                   ...
                   (let stronger_t =
                      FStar_All.op_Bar_Greater stronger_t_opt FStar_Util.must in
                    let wl1 =
                                                    ...
                                                    let uu___11 =
                                                      let uu___12 =
                                                        FStar_List.op_At
                                                          ...
                                                          g_sub_probs in
                                                      FStar_List.op_At
                                                        is_sub_probs uu___12 in
                                                    ret_sub_prob :: uu___11 in
                                                  let guard =
                                                    let guard1 =
                                                      let uu___11 =
                                                        FStar_List.map
        ...
        let solve_sub c11 edge c21 =
          ...
          (let r = FStar_TypeChecker_Env.get_range env in
           ...
           then
             ...
             (let is_null_wp_2 =
                FStar_All.op_Bar_Greater c21.FStar_Syntax_Syntax.flags
                  (FStar_Util.for_some
                     (fun uu___3 ->
                        match uu___3 with
                                 ...
                                 then
                                   ((let uu___11 =
                                    ...
                                    (let c1_univ =
                                     ...
                                     let trivial =
                                       let uu___11 =
                                         FStar_All.op_Bar_Greater c2_decl
                    ...
                    FStar_Syntax_Syntax.Comp uu___5) ->
                     let uu___6 =
                       ...
                       let uu___8 =
                         ...
                         FStar_All.op_Less_Bar FStar_Syntax_Syntax.mk_Comp
                           uu___9 in
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___7.FStar_TypeChecker_Common.pid);
...
let (print_pending_implicits :
  ...
  fun g ->
    let uu___ =
      FStar_All.op_Bar_Greater g.FStar_TypeChecker_Common.implicits
        (FStar_List.map
           (fun i ->
              FStar_Syntax_Print.term_to_string
...
let (ineqs_to_string :
  ...
  fun ineqs ->
    let vars =
      let uu___ =
        FStar_All.op_Bar_Greater (FStar_Pervasives_Native.fst ineqs)
          (FStar_List.map FStar_Syntax_Print.univ_to_string) in
      FStar_All.op_Bar_Greater uu___ (FStar_String.concat ", ") in
    let ineqs1 =
      let uu___ =
        FStar_All.op_Bar_Greater (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu___1 ->
                match uu___1 with
                | (u1, u2) ->
               ...
               | Failed (d, s) ->
                   ((let uu___4 =
                     ...
                     then
                       ...
                       FStar_All.op_Less_Bar FStar_Util.print_string uu___5
                     else ());
      ...
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some (deferred, defer_to_tac, implicits) ->
            let uu___ =
              let uu___1 =
                let uu___2 =
                  FStar_All.op_Bar_Greater (p_guard prob)
               ...
               (let uu___3 =
                ...
                | (prob, wl) ->
                    let g =
                      ...
                      FStar_All.op_Less_Bar (with_guard env prob) uu___4 in
                    ((let uu___5 =
                        FStar_All.op_Less_Bar
                          (FStar_TypeChecker_Env.debug env)
                          (FStar_Options.Other "Rel") in
        ...
        (let uu___1 =
         ...
         | (prob, x, wl) ->
             let g =
               ...
               FStar_All.op_Less_Bar (with_guard env prob) uu___2 in
             ((let uu___3 =
                 FStar_All.op_Less_Bar (FStar_TypeChecker_Env.debug env)
                   (FStar_Options.Other "Rel") in
               if uu___3
                   ...
                   (let uu___5 =
                      FStar_Util.record_time
                        (fun uu___6 ->
                           ...
                           FStar_All.op_Less_Bar (with_guard env prob1)
                             uu___7) in
                    match uu___5 with
                    | (r, ms) ->
                        ((let uu___7 =
      ...
      fun uu___ ->
        ...
        | (variables, ineqs) ->
            ...
            let equiv v v' =
              ...
              | uu___2 -> false in
            let sols =
              FStar_All.op_Bar_Greater variables
                (FStar_List.collect
                   (fun v ->
                      ...
                      | FStar_Syntax_Syntax.U_unif uu___2 ->
                          let lower_bounds_of_v =
                            FStar_All.op_Bar_Greater ineqs
                              (FStar_List.collect
                                 (fun uu___3 ->
                                    match uu___3 with
                                    | (u, v') ->
                 ...
                 (let g1 =
                    ...
                    | FStar_Pervasives_Native.Some
                            ...
                            g.FStar_TypeChecker_Common.implicits imps in
                        {
                          ...
                          FStar_TypeChecker_Common.deferred_to_tac = uu___5;
                          FStar_TypeChecker_Common.deferred = deferred;
                          FStar_TypeChecker_Common.univ_ineqs =
               ...
               (fun b1 ->
                  fun imp ->
                    let uu___1 =
                      ...
                      FStar_All.op_Bar_Greater uu___2 FStar_Util.is_none in
                    if uu___1
                    then
                                  ...
                                  | FStar_Pervasives_Native.Some imp ->
                                      ...
                                      let imps1 =
                                        ...
                                        FStar_All.op_Bar_Greater uu___4
                                          FStar_Util.must in
                                      let uu___4 =
                                        FStar_List.op_At imps1 rest in
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 ((let uu___5 =
                                  ...
                                  (let t =
                                   ...
                                   let uu___5 = FStar_List.op_At extra tl in
                                   until_fixpoint (out, true) uu___5))
                             | uu___4 ->
                                 until_fixpoint
                                   ...
                                   | FStar_Pervasives_Native.Some imps ->
                                       let uu___7 =
                                         let uu___8 =
                                           ...
                                           FStar_List.op_At uu___9 out in
                                         (uu___8, true) in
    ...
    fun g ->
      ...
      (let g1 = solve_deferred_constraints env g in
       ...
       | [] ->
           ...
           FStar_All.op_Less_Bar (fun uu___2 -> ()) uu___1
       | imp::uu___1 ->
           let uu___2 =
             let uu___3 =
               let uu___4 =
        ...
        fun reason ->
          (let uu___1 =
           ...
           then
             let uu___2 =
               let uu___3 =
                 FStar_All.op_Bar_Greater reason FStar_Util.is_none in
               if uu___3
               then "_"
               else FStar_All.op_Bar_Greater reason FStar_Util.must in
             let uu___3 = FStar_Syntax_Print.term_to_string t1 in
             let uu___4 = FStar_Syntax_Print.term_to_string t2 in
