                    ...
                    (match rank <= flex_rigid_eq with
                     ...
                     | uu____4635 ->
                         (match rank < min_rank with
                          ...
                          | uu____4651 -> aux (min_rank, min, (hd :: out)) tl)))) in
              ...
              (match uu____4850 with
               | true  ->
                   let _0_395 =
                     ...
                     FStar_Util.format2
                       "Failed occurs check: %s occurs in %s" _0_394 _0_393 in
                        ...
                        let guard =
                          ...
                          | uu____6652 ->
                              ...
                              (match problem.FStar_TypeChecker_Common.relation
                               ...
                               | uu____6668 -> has_type_guard t2 t1) in
                     ...
                     |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                       ...
                       let maybe_eta t =
                         ...
                         | uu____9577 ->
                             ...
                             (match is_abs t with
                              | true  -> FStar_Util.Inl t
                              | uu____9583 -> FStar_Util.Inr t) in
                       let uu____9586 =
                             ...
                             | true  ->
                                 let guard =
                                   ...
                                   | uu____10122 ->
                                       ...
                                       FStar_All.pipe_left
                                         (fun _0_621  -> Some _0_621) _0_622 in
                   ...
                   (match uu____10399 with
                    ...
                    | uu____10404 ->
                        ...
                        let base_prob =
                          ...
                          FStar_All.pipe_left
                            (fun _0_652  ->
                               FStar_TypeChecker_Common.TProb _0_652) _0_653 in
                        let wl =
                          let _0_657 =
                            let _0_656 =
                              let _0_655 =
