                    ...
                    (match rank <= flex_rigid_eq with
                     ...
                     | uu____4930 ->
                         (match rank < min_rank with
                          ...
                          | uu____4946 -> aux (min_rank, min, (hd :: out)) tl)))) in
      ...
      fun wl  ->
                                ...
                                | None  ->
                                    ...
                                    let uu____7119 =
                                      ...
                                      FStar_Syntax_Util.mk_has_type t1
                                        uu____7120 t2 in
                                    FStar_Syntax_Util.mk_forall x uu____7119 in
                              (match problem.FStar_TypeChecker_Common.relation
                                       = FStar_TypeChecker_Common.SUB
                               with
                               | true  -> has_type_guard t1 t2
                               | uu____7123 -> has_type_guard t2 t1) in
                        let uu____7124 = solve_prob orig (Some guard) [] wl in
                        solve env uu____7124
                    | uu____7127 -> giveup env "head mismatch" orig)
               | (uu____7128,Some (t1,t2)) ->
                   solve_t env
                     (let uu___151_7136 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___151_7136.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t1;
                        FStar_TypeChecker_Common.relation =
                          (uu___151_7136.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t2;
                        FStar_TypeChecker_Common.element =
                          (uu___151_7136.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___151_7136.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___151_7136.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___151_7136.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___151_7136.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___151_7136.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____7137,None ) ->
                   ((let uu____7144 =
                       FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                     ...
                     | true  ->
                         ...
                         let uu____7146 = FStar_Syntax_Print.tag_of_term t1 in
                         let uu____7147 =
                           FStar_Syntax_Print.term_to_string t2 in
                         let uu____7148 = FStar_Syntax_Print.tag_of_term t2 in
                         FStar_Util.print4
                           "Head matches: %s (%s) and %s (%s)\n" uu____7145
                           uu____7146 uu____7147 uu____7148
                     | uu____7149 -> ());
                    (let uu____7150 = FStar_Syntax_Util.head_and_args t1 in
                     match uu____7150 with
                     | (head1,args1) ->
                         let uu____7176 = FStar_Syntax_Util.head_and_args t2 in
                                   ...
                                   let uu____7216 =
                                     let uu____7217 =
                                       FStar_Syntax_Print.term_to_string
                                         head1 in
                                     let uu____7218 = args_to_string args1 in
                                     let uu____7219 =
                                       FStar_Syntax_Print.term_to_string
                                         head2 in
                                     let uu____7220 = args_to_string args2 in
                                     FStar_Util.format4
                                       "unequal number of arguments: %s[%s] and %s[%s]"
                                       uu____7217 uu____7218 uu____7219
                                       uu____7220 in
                                   giveup env uu____7216 orig
                               | uu____7221 ->
                                   let uu____7222 =
                                     (nargs = (Prims.parse_int "0")) ||
                                       (let uu____7225 =
                                          FStar_Syntax_Util.eq_args args1
                                            args2 in
                                        uu____7225 = FStar_Syntax_Util.Equal) in
                                                       ...
                                                       solve_t env
                                                         (let uu___152_7383 =
                                                            problem in
                                                          {
                                                            FStar_TypeChecker_Common.pid
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.pid);
                                                            FStar_TypeChecker_Common.lhs
                                                              = lhs;
                                                            FStar_TypeChecker_Common.relation
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.relation);
                                                            FStar_TypeChecker_Common.rhs
                                                              = rhs;
                                                            FStar_TypeChecker_Common.element
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.element);
                                                            FStar_TypeChecker_Common.logical_guard
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.logical_guard);
                                                            FStar_TypeChecker_Common.scope
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.scope);
                                                            FStar_TypeChecker_Common.reason
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.reason);
                                                            FStar_TypeChecker_Common.loc
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.loc);
                                                            FStar_TypeChecker_Common.rank
                                                              =
                                                              (uu___152_7383.FStar_TypeChecker_Common.rank)
                                                          }) wl))))))))) in
        let imitate orig env wl p =
          let uu____7403 = p in
          match uu____7403 with
          | (((u,k),xs,c),ps,(h,uu____7414,qs)) ->
              let xs = sn_binders env xs in
              let r = FStar_TypeChecker_Env.get_range env in
              let uu____7463 = imitation_sub_probs orig env xs ps qs in
              (match uu____7463 with
               | (sub_probs,gs_xs,formula) ->
                   let im =
                     let uu____7477 = h gs_xs in
                     let uu____7478 =
                       let uu____7485 =
                         FStar_All.pipe_right
                           (FStar_Syntax_Util.lcomp_of_comp c)
                           (fun _0_46  -> FStar_Util.Inl _0_46) in
                       FStar_All.pipe_right uu____7485
                         (fun _0_47  -> Some _0_47) in
                     FStar_Syntax_Util.abs xs uu____7477 uu____7478 in
                   ((let uu____7516 =
                       FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                         (FStar_Options.Other "Rel") in
                     ...
                     | true  ->
                         ...
                         let uu____7518 = FStar_Syntax_Print.comp_to_string c in
                         let uu____7519 =
                           FStar_Syntax_Print.term_to_string im in
                         let uu____7520 = FStar_Syntax_Print.tag_of_term im in
                         let uu____7521 =
                           let uu____7522 =
                         ...
                         FStar_Util.print6
                           ...
                           uu____7517 uu____7518 uu____7519 uu____7520
                           uu____7521 uu____7525
                     | uu____7526 -> ());
                    (let wl =
                       solve_prob orig (Some formula) [TERM ((u, k), im)] wl in
                     solve env (attempt sub_probs wl)))) in
        let imitate' orig env wl uu___123_7543 =
          match uu___123_7543 with
        ...
        let project orig env wl i p =
          ...
          | ((u,xs,c),ps,(h,matches,qs)) ->
              let r = FStar_TypeChecker_Env.get_range env in
              let uu____7630 = FStar_List.nth ps i in
              (match uu____7630 with
               | (pi,uu____7633) ->
                   let uu____7638 = FStar_List.nth xs i in
                   (match uu____7638 with
                    | (xi,uu____7645) ->
                        let rec gs k =
                          let uu____7654 = FStar_Syntax_Util.arrow_formals k in
                          ...
                          | (bs,k) ->
                              let rec aux subst bs =
                                ...
                                | (a,uu____7706)::tl ->
                                    ...
                                    let uu____7714 = new_uvar r xs k_a in
                                    (match uu____7714 with
                                     | (gi_xs,gi) ->
                                         ...
                                         let subst =
                                           ...
                                           :: subst in
                                         let uu____7733 = aux subst tl in
                              ...
                              aux [] bs in
                        let uu____7756 =
                          let uu____7757 = matches pi in
                          FStar_All.pipe_left Prims.op_Negation uu____7757 in
                        (match uu____7756 with
                         | true  -> None
                         | uu____7759 ->
                             let uu____7760 = gs xi.FStar_Syntax_Syntax.sort in
                             (match uu____7760 with
                              | (g_xs,uu____7767) ->
                                  ...
                                  let proj =
                                    ...
                                    FStar_Syntax_Util.abs xs uu____7774
                                      uu____7779 in
                                  let sub =
                                    let uu____7817 =
                                      let uu____7820 =
                                        ...
                                        let uu____7830 =
                                          FStar_List.map
                                            (fun uu____7836  ->
                                               ...
                                               | (uu____7841,uu____7842,y) ->
                                                   y) qs in
                                        FStar_All.pipe_left h uu____7830 in
                                      mk_problem (p_scope orig) orig
                                        uu____7820 (p_rel orig) uu____7827
                                        None "projection" in
                                    FStar_All.pipe_left
                                      (fun _0_50  ->
                                      ...
                                      let uu____7857 =
                                        let uu____7859 =
                                          FStar_All.pipe_left Prims.fst
                                            (p_guard sub) in
                                        Some uu____7859 in
                                      solve_prob orig uu____7857
                                        [TERM (u, proj)] wl in
                                    let uu____7864 =
                                      solve env (attempt [sub] wl) in
                                    FStar_All.pipe_left
                                      (fun _0_51  -> Some _0_51) uu____7864)))))) in
        let solve_t_flex_rigid patterns_only orig lhs t2 wl =
          let uu____7888 = lhs in
          match uu____7888 with
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
              let subterms ps =
                let uu____7911 = FStar_Syntax_Util.arrow_formals_comp k_uv in
                ...
                | (xs,c) ->
                    (match (FStar_List.length xs) = (FStar_List.length ps)
                     ...
                     | true  ->
                         let uu____7933 =
                           let uu____7959 = decompose env t2 in
                           (((uv, k_uv), xs, c), ps, uu____7959) in
                         Some uu____7933
                     | uu____8025 ->
                         let k_uv =
                           FStar_TypeChecker_Normalize.normalize
                         ...
                         let rec elim k args =
                           let uu____8042 =
                             let uu____8046 =
                               let uu____8047 = FStar_Syntax_Subst.compress k in
                                         ...
                                         (match uu____8129 with
                                          ...
                                          | Some scope ->
                                                    ...
                                                    let uu____8160 =
                                                      let uu____8161 =
                                                        FStar_Syntax_Util.type_u
                                                          () in
                                                      FStar_All.pipe_right
                                                        uu____8161 Prims.fst in
                                                    new_uvar
                                                      k.FStar_Syntax_Syntax.pos
                                                      scope uu____8160 in
                                                  Prims.fst uu____8157 in
                                              ...
                                              (FStar_Unionfind.change uvar
                                               ...
                                               Some (xs, c)))
                                     | uu____8211 -> None))
                           | (FStar_Syntax_Syntax.Tm_arrow (xs,c),uu____8216)
                               ->
                           ...
                           | uu____8375 ->
                               let uu____8379 =
                                 ...
                                 FStar_Util.format3
                                   ...
                                   uu____8380 uu____8384 uu____8385 in
                               failwith uu____8379 in
                         let uu____8389 = elim k_uv ps in
                         FStar_Util.bind_opt uu____8389
                           (fun uu____8417  ->
                              match uu____8417 with
                              | (xs,c) ->
                                  let uu____8445 =
                                    let uu____8468 = decompose env t2 in
                                    (((uv, k_uv), xs, c), ps, uu____8468) in
                                  Some uu____8445)) in
              let rec imitate_or_project n stopt i =
                ...
                | uu____8537 ->
                    ...
                    (match i = (- (Prims.parse_int "1")) with
                     | true  ->
                         let uu____8540 = imitate orig env wl st in
                         (match uu____8540 with
                          ...
                          | sol -> sol)
                     | uu____8550 ->
                         let uu____8551 = project orig env wl i st in
              ...
              let check_head fvs1 t2 =
                let uu____8569 = FStar_Syntax_Util.head_and_args t2 in
                         ...
                         (match uu____8601 with
                          ...
                          | uu____8602 ->
                              ((let uu____8604 =
                                ...
                                | true  ->
                                    let uu____8605 = names_to_string fvs_hd in
              ...
              let imitate_ok t2 =
                let fvs_hd =
                  let uu____8613 =
                    let uu____8616 = FStar_Syntax_Util.head_and_args t2 in
                    FStar_All.pipe_right uu____8616 Prims.fst in
                  FStar_All.pipe_right uu____8613 FStar_Syntax_Free.names in
                let uu____8647 = FStar_Util.set_is_empty fvs_hd in
                match uu____8647 with
                | true  -> - (Prims.parse_int "1")
                | uu____8648 -> Prims.parse_int "0" in
              (match maybe_pat_vars with
               | Some vars ->
                   ...
                   let uu____8656 = occurs_check env wl (uv, k_uv) t2 in
                   (match uu____8656 with
                    | (occurs_ok,msg) ->
                        (match Prims.op_Negation occurs_ok with
                         | true  ->
                             let uu____8664 =
                               let uu____8665 = FStar_Option.get msg in
                               Prims.strcat "occurs-check failed: "
                                 uu____8665 in
                             giveup_or_defer orig uu____8664
                         | uu____8666 ->
                             let uu____8667 =
                             ...
                             (match uu____8667 with
                              | true  ->
                                  ...
                                  (match uu____8668 with
                                   | true  ->
                                       let uu____8669 = subterms args_lhs in
                                       imitate' orig env wl uu____8669
                                   | uu____8671 ->
                                       ((let uu____8673 =
                                           FStar_All.pipe_left
                                             (FStar_TypeChecker_Env.debug env)
               ...
               | None  ->
                   (match wl.defer_ok with
                    ...
                    | uu____8708 ->
                        let uu____8709 =
                          let uu____8710 = FStar_Syntax_Free.names t1 in
                          check_head uu____8710 t2 in
                               ...
                               | true  ->
                                   ...
                                   FStar_Util.print2
                                     ...
                                     (match im_ok < (Prims.parse_int "0")
                                      with
                                      | true  -> "imitating"
                                      | uu____8716 -> "projecting")
                               | uu____8717 -> ());
                              (let uu____8718 = subterms args_lhs in
                               imitate_or_project
                                 (FStar_List.length args_lhs) uu____8718
                                 im_ok))
                         | uu____8727 ->
        ...
        let flex_flex orig lhs rhs =
          ...
          | uu____8738 ->
              let force_quasi_pattern xs_opt uu____8760 =
                match uu____8760 with
                | (t,u,k,args) ->
                    let uu____8790 = FStar_Syntax_Util.arrow_formals k in
                    (match uu____8790 with
                     | (all_formals,uu____8801) ->
                         let rec aux pat_args pattern_vars pattern_var_set
                           ...
                           | ([],[]) ->
                               ...
                               let kk =
                                 let uu____8908 = FStar_Syntax_Util.type_u () in
                                 match uu____8908 with
                                 | (t,uu____8912) ->
                                     let uu____8913 =
                                       new_uvar t.FStar_Syntax_Syntax.pos
                                         pattern_vars t in
                                     Prims.fst uu____8913 in
                               let uu____8916 =
                                 new_uvar t.FStar_Syntax_Syntax.pos
                                   pattern_vars kk in
                               (match uu____8916 with
                                | (t',tm_u1) ->
                                    let uu____8923 = destruct_flex_t t' in
                                    (match uu____8923 with
                                     | (uu____8943,u1,k1,uu____8946) ->
                                         let sol =
                                           let uu____8974 =
                                             let uu____8979 =
                           ...
                           | (formal::formals,hd::tl) ->
                               let uu____9039 = pat_var_opt env pat_args hd in
                                         ...
                                         let uu____9078 =
                                           let uu____9079 =
                                             FStar_Util.set_is_subset_of fvs
                                               pattern_var_set in
                                           Prims.op_Negation uu____9079 in
                                         (match uu____9078 with
                                          ...
                                          | uu____9082 ->
                                              ...
                                              aux (y :: pat_args) (formal ::
                                                pattern_vars) uu____9083
                                                formals tl)))
                           | uu____9089 -> failwith "Impossible" in
                         let uu____9100 = FStar_Syntax_Syntax.new_bv_set () in
                         aux [] [] uu____9100 all_formals args) in
              let solve_both_pats wl uu____9148 uu____9149 r =
                match (uu____9148, uu____9149) with
                | ((u1,k1,xs,args1),(u2,k2,ys,args2)) ->
                    ...
                    (match uu____9303 with
                     | true  ->
                         let uu____9307 = solve_prob orig None [] wl in
                         solve env uu____9307
                     | uu____9308 ->
                         let xs = sn_binders env xs in
                         ...
                         ((let uu____9322 =
                           ...
                           | true  ->
                               ...
                               FStar_Util.print5
                                 ...
                                 uu____9323 uu____9324 uu____9325 uu____9326
                                 uu____9327
                           | uu____9328 -> ());
                          (let subst_k k xs args =
                             ...
                             | true  ->
                                 ...
                                 FStar_Syntax_Subst.subst uu____9369 k
                             | uu____9371 ->
                                  ...
                                  | uu____9412 ->
                                      let uu____9413 =
                                        ...
                                        FStar_Util.format3
                                          ...
                                          uu____9414 uu____9415 uu____9416 in
                                      failwith uu____9413) in
                           let uu____9417 =
                             let uu____9423 =
                               let uu____9431 =
                                 FStar_TypeChecker_Normalize.normalize
                                   [FStar_TypeChecker_Normalize.Beta] env k1 in
                               FStar_Syntax_Util.arrow_formals uu____9431 in
                                 ...
                                 let uu____9449 =
                                   let uu____9457 =
                                     FStar_TypeChecker_Normalize.normalize
                                       ...
                                       k2 in
                                   FStar_Syntax_Util.arrow_formals uu____9457 in
                                  ...
                                  | (cs,k2') ->
                                      ...
                                      let uu____9483 =
                                        ...
                                        let uu____9490 =
                                          ...
                                          uu____9491.FStar_Syntax_Syntax.n in
                                        (uu____9486, uu____9490) in
                                      (match uu____9483 with
                                       | (FStar_Syntax_Syntax.Tm_type
                                          uu____9499,uu____9500) ->
                                           (k1', [sub_prob])
                                       | (uu____9504,FStar_Syntax_Syntax.Tm_type
                                          uu____9505) -> (k2', [sub_prob])
                                       | uu____9509 ->
                                           let uu____9512 =
                           ...
                           | (k_u',sub_probs) ->
                               let uu____9547 =
                                 let uu____9555 =
                                   let uu____9556 = new_uvar r zs k_u' in
                                   FStar_All.pipe_left Prims.fst uu____9556 in
                                 let uu____9561 =
                                   let uu____9564 =
                                     FStar_Syntax_Syntax.mk_Total k_u' in
                                   FStar_Syntax_Util.arrow xs uu____9564 in
                                 let uu____9567 =
                                   let uu____9570 =
                                     FStar_Syntax_Syntax.mk_Total k_u' in
                                   FStar_Syntax_Util.arrow ys uu____9570 in
                                 (uu____9555, uu____9561, uu____9567) in
                                                         ...
                                                         | uu____9632 ->
                                                             ...
                                                             solve env
                                                               (attempt
                                                                  sub_probs
                                                                  wl)))))))))) in
              let solve_one_pat uu____9672 uu____9673 =
                match (uu____9672, uu____9673) with
                | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                    ((let uu____9777 =
                      ...
                      | uu____9780 -> ());
                     (let uu____9781 = FStar_Unionfind.equivalent u1 u2 in
                          ...
                          let guard =
                            let uu____9816 =
                              FStar_List.map
                                ...
                                sub_probs in
                            FStar_Syntax_Util.mk_conj_l uu____9816 in
                          let wl = solve_prob orig (Some guard) [] wl in
                          solve env (attempt sub_probs wl)
                      | uu____9822 ->
                          let t2 = sn env t2 in
                          let rhs_vars = FStar_Syntax_Free.names t2 in
                          let uu____9826 = occurs_check env wl (u1, k1) t2 in
                          (match uu____9826 with
                           | (occurs_ok,uu____9835) ->
                               let lhs_vars =
                               ...
                               (match uu____9840 with
                                | true  ->
                                    let sol =
                                      let uu____9842 =
                                        let uu____9847 = u_abs k1 xs t2 in
                                        ((u1, k1), uu____9847) in
                                      TERM uu____9842 in
              ...
              let uu____9893 = lhs in
              (match uu____9893 with
               | (t1,u1,k1,args1) ->
                   let uu____9898 = rhs in
        ...
        | true  ->
            let uu____9949 = solve_prob orig None [] wl in
            solve env uu____9949
        | uu____9950 ->
            let t1 = problem.FStar_TypeChecker_Common.lhs in
            let t2 = problem.FStar_TypeChecker_Common.rhs in
            let uu____9953 = FStar_Util.physical_equality t1 t2 in
            (match uu____9953 with
             | true  ->
                 let uu____9954 = solve_prob orig None [] wl in
                 solve env uu____9954
             | uu____9955 ->
                 ((let uu____9957 =
                     FStar_TypeChecker_Env.debug env
                       (FStar_Options.Other "RelCheck") in
                  ...
                  (let r = FStar_TypeChecker_Env.get_range env in
                   ...
                   | (FStar_Syntax_Syntax.Tm_arrow
                      (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                       let mk_c c uu___124_10004 =
                         match uu___124_10004 with
                         | [] -> c
                         | bs ->
                             let uu____10018 =
                               (FStar_Syntax_Syntax.mk
                             ...
                             FStar_Syntax_Syntax.mk_Total uu____10018 in
                       let uu____10032 =
                   ...
                   | (FStar_Syntax_Syntax.Tm_abs
                      ...
                      (bs2,tbody2,lopt2)) ->
                       let mk_t t l uu___125_10197 =
                         match uu___125_10197 with
                         | [] -> t
                         | bs ->
                             (FStar_Syntax_Syntax.mk
                                   ...
                                   fun subst  ->
                                     let uu____10319 =
                                       ...
                                       let uu____10323 =
                                         FStar_Syntax_Subst.subst subst
                                           tbody2 in
                                       mk_problem scope orig uu____10322
                                         problem.FStar_TypeChecker_Common.relation
                                         uu____10323 None "lambda co-domain" in
                                     FStar_All.pipe_left
                                       (fun _0_58  ->
                                          FStar_TypeChecker_Common.TProb
                                            _0_58) uu____10319))
                   | (FStar_Syntax_Syntax.Tm_abs _,_)
                     |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                       let is_abs t =
                         match t.FStar_Syntax_Syntax.n with
                         | FStar_Syntax_Syntax.Tm_abs uu____10338 -> true
                       ...
                       let maybe_eta t =
                         ...
                         | uu____10372 ->
                             ...
                             (match is_abs t with
                              | true  -> FStar_Util.Inl t
                              | uu____10378 -> FStar_Util.Inr t) in
                       let uu____10381 =
                         let uu____10392 = maybe_eta t1 in
                         let uu____10397 = maybe_eta t2 in
                         (uu____10392, uu____10397) in
                       (match uu____10381 with
                        | (FStar_Util.Inl t1,FStar_Util.Inl t2) ->
                            solve_t env
                              (let uu___153_10428 = problem in
                               {
                                 FStar_TypeChecker_Common.pid =
                                   (uu___153_10428.FStar_TypeChecker_Common.pid);
                                 FStar_TypeChecker_Common.lhs = t1;
                                 FStar_TypeChecker_Common.relation =
                                   (uu___153_10428.FStar_TypeChecker_Common.relation);
                                 FStar_TypeChecker_Common.rhs = t2;
                                 FStar_TypeChecker_Common.element =
                                   (uu___153_10428.FStar_TypeChecker_Common.element);
                                 FStar_TypeChecker_Common.logical_guard =
                                   (uu___153_10428.FStar_TypeChecker_Common.logical_guard);
                                 FStar_TypeChecker_Common.scope =
                                   (uu___153_10428.FStar_TypeChecker_Common.scope);
                                 FStar_TypeChecker_Common.reason =
                                   (uu___153_10428.FStar_TypeChecker_Common.reason);
                                 FStar_TypeChecker_Common.loc =
                                   (uu___153_10428.FStar_TypeChecker_Common.loc);
                                 FStar_TypeChecker_Common.rank =
                                   (uu___153_10428.FStar_TypeChecker_Common.rank)
                               }) wl
                          ...
                          |(FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                            ...
                            (match uu____10461 with
                             | true  ->
                                 ...
                                 solve_t_flex_rigid true orig uu____10462
                                   t_abs wl
                             | uu____10466 ->
                                 giveup env
                   ...
                   | (FStar_Syntax_Syntax.Tm_refine
                      uu____10478,FStar_Syntax_Syntax.Tm_refine uu____10479)
                       ->
                       let uu____10488 = as_refinement env wl t1 in
                       (match uu____10488 with
                        | (x1,phi1) ->
                            let uu____10493 = as_refinement env wl t2 in
                             ...
                             | (x2,phi2) ->
                                 ...
                                 let fallback uu____10536 =
                                   ...
                                   let guard =
                                     ...
                                     FStar_Syntax_Util.mk_conj uu____10542
                                       impl in
                                   let wl =
                                        ...
                                        let uu____10549 =
                                          let uu____10552 =
                                            let uu____10553 =
                                              FStar_Syntax_Syntax.mk_binder
                                                x1 in
                                            uu____10553 :: (p_scope orig) in
                                          mk_problem uu____10552 orig phi1
                                            FStar_TypeChecker_Common.EQ phi2
                                            None "refinement formula" in
                                        FStar_All.pipe_left
                                          (fun _0_60  ->
                                             FStar_TypeChecker_Common.TProb
                                               _0_60) uu____10549 in
                                      let uu____10556 =
                                        solve env
                                          (let uu___154_10557 = wl in
                                           {
                                             attempting = [ref_prob];
                                             wl_deferred = [];
                                             ctr = (uu___154_10557.ctr);
                                             defer_ok = false;
                                             smt_ok = (uu___154_10557.smt_ok);
                                             tcenv = (uu___154_10557.tcenv)
                                           }) in
                                      (match uu____10556 with
                                       | Failed uu____10561 -> fallback ()
                                       | Success uu____10564 ->
                                           let guard =
                                             let uu____10568 =
                                               FStar_All.pipe_right
                                             ...
                                             FStar_Syntax_Util.mk_conj
                                               uu____10568 uu____10571 in
                                           let wl =
                                             solve_prob orig (Some guard) []
                                               wl in
                                           let wl =
                                             let uu___155_10579 = wl in
                                             {
                                               attempting =
                                                 (uu___155_10579.attempting);
                                               wl_deferred =
                                                 (uu___155_10579.wl_deferred);
                                               ctr =
                                                 (wl.ctr +
                                                    (Prims.parse_int "1"));
                                               defer_ok =
                                                 (uu___155_10579.defer_ok);
                                               smt_ok =
                                                 (uu___155_10579.smt_ok);
                                               tcenv = (uu___155_10579.tcenv)
                                             } in
                                           solve env (attempt [base_prob] wl))
                                  | uu____10580 -> fallback ())))
                   | (FStar_Syntax_Syntax.Tm_uvar
                      ...
                      |(FStar_Syntax_Syntax.Tm_uvar
                       ...
                       |(FStar_Syntax_Syntax.Tm_app
                         ...
                         ({
                            ...
                            FStar_Syntax_Syntax.vars = _;_},_))
                       ->
                       let uu____10633 = destruct_flex_t t1 in
                       let uu____10634 = destruct_flex_t t2 in
                       flex_flex orig uu____10633 uu____10634
                   | (FStar_Syntax_Syntax.Tm_uvar _,_)
                     |(FStar_Syntax_Syntax.Tm_app
                       ({
                          FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       ...
                       problem.FStar_TypeChecker_Common.relation =
                         FStar_TypeChecker_Common.EQ
                       ->
                       let uu____10650 = destruct_flex_pattern env t1 in
                       solve_t_flex_rigid false orig uu____10650 t2 wl
                   | (_,FStar_Syntax_Syntax.Tm_uvar _)
                     |(_,FStar_Syntax_Syntax.Tm_app
                       ({
                          FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                   ...
                   | (FStar_Syntax_Syntax.Tm_uvar
                     ...
                     |(FStar_Syntax_Syntax.Tm_app
                      ...
                      |(FStar_Syntax_Syntax.Tm_uvar
                       ...
                       ->
                       solve_t' env
                         (let uu___156_10699 = problem in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___156_10699.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___156_10699.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.EQ;
                            FStar_TypeChecker_Common.rhs =
                              (uu___156_10699.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___156_10699.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___156_10699.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___156_10699.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___156_10699.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___156_10699.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___156_10699.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Syntax_Syntax.Tm_uvar _,_)
                     |(FStar_Syntax_Syntax.Tm_app
                       ({
                       ...
                       (match wl.defer_ok with
                        ...
                        | uu____10715 ->
                            let new_rel =
                              problem.FStar_TypeChecker_Common.relation in
                            let uu____10717 =
                              let uu____10718 = is_top_level_prob orig in
                             ...
                             | true  ->
                                 let uu____10719 =
                                   FStar_All.pipe_left
                                     ...
                                     (let uu___157_10722 = problem in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___157_10722.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___157_10722.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          new_rel;
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___157_10722.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___157_10722.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___157_10722.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___157_10722.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___157_10722.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___157_10722.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___157_10722.FStar_TypeChecker_Common.rank)
                                      }) in
                                 let uu____10723 =
                                   destruct_flex_pattern env t1 in
                                 solve_t_flex_rigid false uu____10719
                                   uu____10723 t2 wl
                             | uu____10727 ->
                                 let uu____10728 =
                                   base_and_refinement env wl t2 in
                                           ...
                                           let uu____10758 =
                                             FStar_All.pipe_left
                                               (fun _0_62  ->
                                                  FStar_TypeChecker_Common.TProb
                                                    _0_62)
                                               (let uu___158_10761 = problem in
                                                {
                                                  FStar_TypeChecker_Common.pid
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.pid);
                                                  FStar_TypeChecker_Common.lhs
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.lhs);
                                                  FStar_TypeChecker_Common.relation
                                                    = new_rel;
                                                  FStar_TypeChecker_Common.rhs
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.rhs);
                                                  FStar_TypeChecker_Common.element
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.element);
                                                  FStar_TypeChecker_Common.logical_guard
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.logical_guard);
                                                  FStar_TypeChecker_Common.scope
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.scope);
                                                  FStar_TypeChecker_Common.reason
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.reason);
                                                  FStar_TypeChecker_Common.loc
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.loc);
                                                  FStar_TypeChecker_Common.rank
                                                    =
                                                    (uu___158_10761.FStar_TypeChecker_Common.rank)
                                                }) in
                                           let uu____10762 =
                                             destruct_flex_pattern env t1 in
                                           solve_t_flex_rigid false
                                             uu____10758 uu____10762 t_base
                                             wl
                                       | Some (y,phi) ->
                                           let y' =
                                             let uu___159_10777 = y in
                                             {
                                               FStar_Syntax_Syntax.ppname =
                                                 (uu___159_10777.FStar_Syntax_Syntax.ppname);
                                               FStar_Syntax_Syntax.index =
                                                 (uu___159_10777.FStar_Syntax_Syntax.index);
                   ...
                   | (_,FStar_Syntax_Syntax.Tm_uvar _)
                     |(_,FStar_Syntax_Syntax.Tm_app
                       ...
                       (match wl.defer_ok with
                        ...
                        | uu____10809 ->
                            let uu____10810 = base_and_refinement env wl t1 in
                            (match uu____10810 with
                             | (t_base,uu____10821) ->
                                 solve_t env
                                   (let uu___160_10836 = problem in
                                    {
                                      FStar_TypeChecker_Common.pid =
                                        (uu___160_10836.FStar_TypeChecker_Common.pid);
                                      FStar_TypeChecker_Common.lhs = t_base;
                                      FStar_TypeChecker_Common.relation =
                                        FStar_TypeChecker_Common.EQ;
                                      FStar_TypeChecker_Common.rhs =
                                        (uu___160_10836.FStar_TypeChecker_Common.rhs);
                                      FStar_TypeChecker_Common.element =
                                        (uu___160_10836.FStar_TypeChecker_Common.element);
                                      FStar_TypeChecker_Common.logical_guard
                                        =
                                        (uu___160_10836.FStar_TypeChecker_Common.logical_guard);
                                      FStar_TypeChecker_Common.scope =
                                        (uu___160_10836.FStar_TypeChecker_Common.scope);
                                      FStar_TypeChecker_Common.reason =
                                        (uu___160_10836.FStar_TypeChecker_Common.reason);
                                      FStar_TypeChecker_Common.loc =
                                        (uu___160_10836.FStar_TypeChecker_Common.loc);
                                      FStar_TypeChecker_Common.rank =
                                        (uu___160_10836.FStar_TypeChecker_Common.rank)
                                    }) wl))
                   | (FStar_Syntax_Syntax.Tm_refine uu____10839,uu____10840)
                       ->
                       let t2 =
                         let uu____10848 = base_and_refinement env wl t2 in
                         FStar_All.pipe_left force_refinement uu____10848 in
                       solve_t env
                         (let uu___161_10861 = problem in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___161_10861.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___161_10861.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              (uu___161_10861.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t2;
                            FStar_TypeChecker_Common.element =
                              (uu___161_10861.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___161_10861.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___161_10861.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___161_10861.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___161_10861.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___161_10861.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (uu____10862,FStar_Syntax_Syntax.Tm_refine uu____10863)
                       ->
                       let t1 =
                         let uu____10871 = base_and_refinement env wl t1 in
                         FStar_All.pipe_left force_refinement uu____10871 in
                       solve_t env
                         (let uu___162_10884 = problem in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___162_10884.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t1;
                            FStar_TypeChecker_Common.relation =
                              (uu___162_10884.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs =
                              (uu___162_10884.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___162_10884.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___162_10884.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___162_10884.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___162_10884.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___162_10884.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___162_10884.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Syntax_Syntax.Tm_match _,_)
                     |(FStar_Syntax_Syntax.Tm_uinst _,_)
                      |(FStar_Syntax_Syntax.Tm_name _,_)
                       ...
                       ->
                       let head1 =
                         let uu____10914 = FStar_Syntax_Util.head_and_args t1 in
                         FStar_All.pipe_right uu____10914 Prims.fst in
                       let head2 =
                         let uu____10945 = FStar_Syntax_Util.head_and_args t2 in
                         FStar_All.pipe_right uu____10945 Prims.fst in
                       let uu____10973 =
                             ...
                             | true  ->
                                 let guard =
                                   let uu____10991 =
                                     ...
                                     uu____10992 = FStar_Syntax_Util.Equal in
                   ...
                   | (FStar_Syntax_Syntax.Tm_ascribed
                      (t1,uu____11013,uu____11014),uu____11015) ->
                       solve_t' env
                         (let uu___163_11034 = problem in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___163_11034.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs = t1;
                            FStar_TypeChecker_Common.relation =
                              (uu___163_11034.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs =
                              (uu___163_11034.FStar_TypeChecker_Common.rhs);
                            FStar_TypeChecker_Common.element =
                              (uu___163_11034.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___163_11034.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___163_11034.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___163_11034.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___163_11034.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___163_11034.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (uu____11037,FStar_Syntax_Syntax.Tm_ascribed
                      (t2,uu____11039,uu____11040)) ->
                       solve_t' env
                         (let uu___164_11059 = problem in
                          {
                            FStar_TypeChecker_Common.pid =
                              (uu___164_11059.FStar_TypeChecker_Common.pid);
                            FStar_TypeChecker_Common.lhs =
                              (uu___164_11059.FStar_TypeChecker_Common.lhs);
                            FStar_TypeChecker_Common.relation =
                              (uu___164_11059.FStar_TypeChecker_Common.relation);
                            FStar_TypeChecker_Common.rhs = t2;
                            FStar_TypeChecker_Common.element =
                              (uu___164_11059.FStar_TypeChecker_Common.element);
                            FStar_TypeChecker_Common.logical_guard =
                              (uu___164_11059.FStar_TypeChecker_Common.logical_guard);
                            FStar_TypeChecker_Common.scope =
                              (uu___164_11059.FStar_TypeChecker_Common.scope);
                            FStar_TypeChecker_Common.reason =
                              (uu___164_11059.FStar_TypeChecker_Common.reason);
                            FStar_TypeChecker_Common.loc =
                              (uu___164_11059.FStar_TypeChecker_Common.loc);
                            FStar_TypeChecker_Common.rank =
                              (uu___164_11059.FStar_TypeChecker_Common.rank)
                          }) wl
                   | (FStar_Syntax_Syntax.Tm_let _,_)
                     |(FStar_Syntax_Syntax.Tm_meta _,_)
                      |(FStar_Syntax_Syntax.Tm_delayed _,_)
                       ...
                       ->
                       let uu____11072 =
                         let uu____11073 = FStar_Syntax_Print.tag_of_term t1 in
                         let uu____11074 = FStar_Syntax_Print.tag_of_term t2 in
                         FStar_Util.format2 "Impossible: %s and %s"
                           uu____11073 uu____11074 in
                       failwith uu____11072
                   | uu____11075 -> giveup env "head tag mismatch" orig)))
and solve_c:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.comp,Prims.unit) FStar_TypeChecker_Common.problem ->
      worklist -> solution
      ...
      fun wl  ->
           ...
           let guard =
             let uu____11139 =
               FStar_List.map
                 ...
                 sub_probs in
             FStar_Syntax_Util.mk_conj_l uu____11139 in
           let wl = solve_prob orig (Some guard) [] wl in
           solve env (attempt sub_probs wl)) in
              ...
              let c1 =
                let uu____11186 =
                  let uu____11192 =
                    ...
                    FStar_Syntax_Syntax.as_arg uu____11193 in
                  [uu____11192] in
                {
                  FStar_Syntax_Syntax.comp_univs =
                  ...
                  FStar_Syntax_Syntax.effect_args = uu____11186;
          ...
          | uu____11194 ->
              let is_null_wp_2 =
                FStar_All.pipe_right c2.FStar_Syntax_Syntax.flags
                  (FStar_Util.for_some
                     (fun uu___126_11197  ->
                        match uu___126_11197 with
                        | FStar_Syntax_Syntax.TOTAL 
                          |FStar_Syntax_Syntax.MLEFFECT 
                           |FStar_Syntax_Syntax.SOMETRIVIAL  -> true
                        | uu____11198 -> false)) in
              let uu____11199 =
                match ((c1.FStar_Syntax_Syntax.effect_args),
                        (c2.FStar_Syntax_Syntax.effect_args))
                with
                | ((wp1,uu____11223)::uu____11224,(wp2,uu____11226)::uu____11227)
                    -> (wp1, wp2)
                | uu____11268 ->
                    let uu____11281 =
                      let uu____11282 =
                      ...
                      FStar_Util.format2
                        ...
                        uu____11282 uu____11283 in
                    failwith uu____11281 in
              (match uu____11199 with
               | (wpc1,wpc2) ->
                   let uu____11300 = FStar_Util.physical_equality wpc1 wpc2 in
                                     ...
                                     let uu____11350 =
                                       let uu____11351 =
                                         ...
                                         let uu____11364 =
                                           ...
                                           uu____11366 :: uu____11367 in
                                         (uu____11361, uu____11364) in
                                       FStar_Syntax_Syntax.Tm_app uu____11351 in
                                     FStar_Syntax_Syntax.mk uu____11350 in
                                   uu____11347
                                     (Some
                                        (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n))
                                     r) in
                            ...
                            let uu____11392 =
                              let uu____11395 =
                                FStar_All.pipe_right (p_guard base_prob)
                                  Prims.fst in
                              FStar_Syntax_Util.mk_conj uu____11395 g in
                            FStar_All.pipe_left (fun _0_67  -> Some _0_67)
                              uu____11392 in
                          solve_prob orig uu____11390 [] wl in
                        solve env (attempt [base_prob] wl))) in
        let uu____11405 = FStar_Util.physical_equality c1 c2 in
        match uu____11405 with
        | true  ->
            let uu____11406 = solve_prob orig None [] wl in
        ...
        | uu____11407 ->
            ((let uu____11409 =
              ...
              | true  ->
                  let uu____11410 = FStar_Syntax_Print.comp_to_string c1 in
                  let uu____11411 = FStar_Syntax_Print.comp_to_string c2 in
              ...
              | (c1,c2) ->
                  (match ((c1.FStar_Syntax_Syntax.n),
                   ...
                   | (FStar_Syntax_Syntax.GTotal
                      (t1,uu____11421),FStar_Syntax_Syntax.Total
                      (t2,uu____11423)) when
                       ...
                       let uu____11436 =
                         problem_using_guard orig t1
                           ...
                           "result type" in
                       solve_t env uu____11436 wl
                   | (FStar_Syntax_Syntax.GTotal
                      uu____11439,FStar_Syntax_Syntax.Total uu____11440) ->
                   ...
                   | (FStar_Syntax_Syntax.GTotal _,FStar_Syntax_Syntax.Comp
                     ...
                     |(FStar_Syntax_Syntax.Total _,FStar_Syntax_Syntax.Comp
                       ...
                       let uu____11496 =
                         ...
                         {
                           FStar_TypeChecker_Common.pid =
                             (uu___165_11499.FStar_TypeChecker_Common.pid);
                           FStar_TypeChecker_Common.lhs = uu____11502;
                           FStar_TypeChecker_Common.relation =
                             (uu___165_11499.FStar_TypeChecker_Common.relation);
                           FStar_TypeChecker_Common.rhs =
                             (uu___165_11499.FStar_TypeChecker_Common.rhs);
                           FStar_TypeChecker_Common.element =
                             (uu___165_11499.FStar_TypeChecker_Common.element);
                           FStar_TypeChecker_Common.logical_guard =
                             (uu___165_11499.FStar_TypeChecker_Common.logical_guard);
                           FStar_TypeChecker_Common.scope =
                             (uu___165_11499.FStar_TypeChecker_Common.scope);
                           FStar_TypeChecker_Common.reason =
                             (uu___165_11499.FStar_TypeChecker_Common.reason);
                           FStar_TypeChecker_Common.loc =
                             (uu___165_11499.FStar_TypeChecker_Common.loc);
                           FStar_TypeChecker_Common.rank =
                             (uu___165_11499.FStar_TypeChecker_Common.rank)
                         } in
                       solve_c env uu____11496 wl
                   | (FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.GTotal
                      _)
                     |(FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.Total
                       _) ->
                       let uu____11508 =
                         let uu___166_11511 = problem in
                         let uu____11514 =
                           let uu____11515 =
                             FStar_TypeChecker_Normalize.comp_to_comp_typ env
                               c2 in
                         ...
                         {
                           FStar_TypeChecker_Common.pid =
                             (uu___166_11511.FStar_TypeChecker_Common.pid);
                           FStar_TypeChecker_Common.lhs =
                             (uu___166_11511.FStar_TypeChecker_Common.lhs);
                           FStar_TypeChecker_Common.relation =
                             (uu___166_11511.FStar_TypeChecker_Common.relation);
                           FStar_TypeChecker_Common.rhs = uu____11514;
                           FStar_TypeChecker_Common.element =
                             (uu___166_11511.FStar_TypeChecker_Common.element);
                           FStar_TypeChecker_Common.logical_guard =
                             (uu___166_11511.FStar_TypeChecker_Common.logical_guard);
                           FStar_TypeChecker_Common.scope =
                             (uu___166_11511.FStar_TypeChecker_Common.scope);
                           FStar_TypeChecker_Common.reason =
                             (uu___166_11511.FStar_TypeChecker_Common.reason);
                           FStar_TypeChecker_Common.loc =
                             (uu___166_11511.FStar_TypeChecker_Common.loc);
                           FStar_TypeChecker_Common.rank =
                             (uu___166_11511.FStar_TypeChecker_Common.rank)
                         } in
                       solve_c env uu____11508 wl
                   | (FStar_Syntax_Syntax.Comp
                      uu____11516,FStar_Syntax_Syntax.Comp uu____11517) ->
                       let uu____11518 =
                                        ...
                                        | uu____11538 ->
                                            let uu____11539 =
                                              ...
                                              FStar_Util.format2
                                                ...
                                                uu____11540 uu____11541 in
                                            giveup env uu____11539 orig)
      ...
      FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits
        (FStar_List.map
           (fun uu____11566  ->
              ...
              | (uu____11577,uu____11578,u,uu____11580,uu____11581,uu____11582)
                  -> FStar_Syntax_Print.uvar_to_string u)) in
    FStar_All.pipe_right uu____11546 (FStar_String.concat ", ")
let ineqs_to_string:
  ...
  fun ineqs  ->
    let vars =
      ...
      FStar_All.pipe_right uu____11611 (FStar_String.concat ", ") in
    let ineqs =
      let uu____11621 =
        FStar_All.pipe_right (Prims.snd ineqs)
          (FStar_List.map
             (fun uu____11633  ->
                ...
                | (u1,u2) ->
                    let uu____11638 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____11639 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____11638 uu____11639)) in
      FStar_All.pipe_right uu____11621 (FStar_String.concat ", ") in
...
let guard_to_string:
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____11651,[])) -> "{}"
      | uu____11664 ->
          let form =
            ...
            | FStar_TypeChecker_Common.NonTrivial f ->
                ...
                (match uu____11674 with
                 ...
                 | uu____11675 -> "non-trivial") in
          let carry =
            let uu____11677 =
              FStar_List.map
                (fun uu____11681  ->
                   match uu____11681 with
                   | (uu____11684,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred in
            FStar_All.pipe_right uu____11677 (FStar_String.concat ",\n") in
...
let is_trivial: FStar_TypeChecker_Env.guard_t -> Prims.bool =
  fun g  ->
    ...
    | { FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial ;
        FStar_TypeChecker_Env.deferred = [];
        FStar_TypeChecker_Env.univ_ineqs = uu____11708;
        FStar_TypeChecker_Env.implicits = uu____11709;_} -> true
    | uu____11723 -> false
    ...
    fun g  ->
      ...
      | Some g ->
          let f =
            ...
            | uu____11750 -> failwith "impossible" in
          let uu____11751 =
            let uu___167_11752 = g in
            let uu____11753 =
              let uu____11754 =
                let uu____11755 =
                  let uu____11759 = FStar_Syntax_Syntax.mk_binder x in
                  [uu____11759] in
                let uu____11760 =
                  let uu____11767 =
                    let uu____11773 =
                  ...
                  Some uu____11767 in
                FStar_Syntax_Util.abs uu____11755 f uu____11760 in
              FStar_All.pipe_left
                (fun _0_69  -> FStar_TypeChecker_Common.NonTrivial _0_69)
                uu____11754 in
            {
              FStar_TypeChecker_Env.guard_f = uu____11753;
              FStar_TypeChecker_Env.deferred =
                (uu___167_11752.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___167_11752.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___167_11752.FStar_TypeChecker_Env.implicits)
            } in
          Some uu____11751
let apply_guard:
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ...
          let uu____11796 =
            let uu____11797 =
              let uu____11798 =
                let uu____11801 =
                  let uu____11802 =
                    let uu____11812 =
                      let uu____11814 = FStar_Syntax_Syntax.as_arg e in
                      [uu____11814] in
                    (f, uu____11812) in
                  FStar_Syntax_Syntax.Tm_app uu____11802 in
            ...
            FStar_All.pipe_left
              ...
              uu____11797 in
          {
            FStar_TypeChecker_Env.guard_f = uu____11796;
            FStar_TypeChecker_Env.deferred =
              (uu___168_11795.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___168_11795.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___168_11795.FStar_TypeChecker_Env.implicits)
          }
let trivial: FStar_TypeChecker_Common.guard_formula -> Prims.unit =
  fun t  ->
    match t with
    | FStar_TypeChecker_Common.Trivial  -> ()
    | FStar_TypeChecker_Common.NonTrivial uu____11827 ->
        failwith "impossible"
let conj_guard_f:
    ...
    fun g2  ->
      ...
      | (FStar_TypeChecker_Common.NonTrivial
         f1,FStar_TypeChecker_Common.NonTrivial f2) ->
          let uu____11837 = FStar_Syntax_Util.mk_conj f1 f2 in
          FStar_TypeChecker_Common.NonTrivial uu____11837
let check_trivial:
  (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar tc when
        ...
        FStar_TypeChecker_Common.Trivial
    | uu____11846 -> FStar_TypeChecker_Common.NonTrivial t
let imp_guard_f:
  FStar_TypeChecker_Common.guard_formula ->
    FStar_TypeChecker_Common.guard_formula ->
      FStar_TypeChecker_Common.guard_formula
  ...
  fun f  ->
    fun g1  ->
      fun g2  ->
        ...
        {
          FStar_TypeChecker_Env.guard_f = uu____11877;
          FStar_TypeChecker_Env.deferred =
...
let close_guard:
  ...
  fun binders  ->
    fun g  ->
      ...
      | FStar_TypeChecker_Common.Trivial  -> g
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___169_11915 = g in
          let uu____11916 =
            let uu____11917 = FStar_Syntax_Util.close_forall binders f in
            FStar_All.pipe_right uu____11917
              (fun _0_71  -> FStar_TypeChecker_Common.NonTrivial _0_71) in
          {
            FStar_TypeChecker_Env.guard_f = uu____11916;
            FStar_TypeChecker_Env.deferred =
              (uu___169_11915.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___169_11915.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___169_11915.FStar_TypeChecker_Env.implicits)
          }
let new_t_problem env lhs rel rhs elt loc =
  let reason =
    ...
    | true  ->
        let uu____11956 = FStar_TypeChecker_Normalize.term_to_string env lhs in
        let uu____11957 = FStar_TypeChecker_Normalize.term_to_string env rhs in
        FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" uu____11956
          (rel_to_string rel) uu____11957
    | uu____11958 -> "TOP" in
    ...
    fun t1  ->
      fun rel  ->
        fun t2  ->
          let x =
            let uu____11977 =
              let uu____11979 = FStar_TypeChecker_Env.get_range env in
              FStar_All.pipe_left (fun _0_72  -> Some _0_72) uu____11979 in
            FStar_Syntax_Syntax.new_bv uu____11977 t1 in
          let env = FStar_TypeChecker_Env.push_bv env x in
          let p =
            let uu____11985 =
              let uu____11987 = FStar_Syntax_Syntax.bv_to_name x in
              FStar_All.pipe_left (fun _0_73  -> Some _0_73) uu____11987 in
            let uu____11989 = FStar_TypeChecker_Env.get_range env in
            new_t_problem env t1 rel t2 uu____11985 uu____11989 in
...
let solve_and_commit:
  ...
  fun env  ->
    fun probs  ->
      fun err  ->
        let probs =
          let uu____12012 = FStar_Options.eager_inference () in
          match uu____12012 with
          | true  ->
              let uu___170_12013 = probs in
              {
                attempting = (uu___170_12013.attempting);
                wl_deferred = (uu___170_12013.wl_deferred);
                ctr = (uu___170_12013.ctr);
                defer_ok = false;
                smt_ok = (uu___170_12013.smt_ok);
                tcenv = (uu___170_12013.tcenv)
              }
          | uu____12014 -> probs in
        let tx = FStar_Unionfind.new_transaction () in
        ...
        | Failed (d,s) ->
            (FStar_Unionfind.rollback tx;
             (let uu____12024 =
              ...
              | true  ->
                  let uu____12025 = explain env d s in
                  FStar_All.pipe_left FStar_Util.print_string uu____12025
              | uu____12026 -> ());
             err (d, s))
let simplify_guard:
  FStar_TypeChecker_Env.env ->
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____12035 =
            ...
            | true  ->
                let uu____12036 = FStar_Syntax_Print.term_to_string f in
           ...
           (let f =
            ...
            (let uu____12040 =
             ...
             | true  ->
                 let uu____12041 = FStar_Syntax_Print.term_to_string f in
                 FStar_Util.print1 "Simplified guard to %s\n" uu____12041
             | uu____12042 -> ());
            (let f =
               let uu____12044 =
                 let uu____12045 = FStar_Syntax_Util.unmeta f in
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____12049 -> FStar_TypeChecker_Common.NonTrivial f in
             let uu___171_12050 = g in
             {
               FStar_TypeChecker_Env.guard_f = f;
               FStar_TypeChecker_Env.deferred =
                 (uu___171_12050.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___171_12050.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___171_12050.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
            ...
            let uu____12065 =
              let uu____12066 =
                let uu____12067 =
                  let uu____12068 =
                    FStar_All.pipe_right (p_guard prob) Prims.fst in
                  FStar_All.pipe_right uu____12068
                    (fun _0_74  -> FStar_TypeChecker_Common.NonTrivial _0_74) in
                {
                  FStar_TypeChecker_Env.guard_f = uu____12067;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____12066 in
            FStar_All.pipe_left (fun _0_75  -> Some _0_75) uu____12065
let try_teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
    ...
    fun t1  ->
      fun t2  ->
        (let uu____12092 =
         ...
         | true  ->
             let uu____12093 = FStar_Syntax_Print.term_to_string t1 in
             let uu____12094 = FStar_Syntax_Print.term_to_string t2 in
             FStar_Util.print2 "try_teq of %s and %s\n" uu____12093
               uu____12094
         | uu____12095 -> ());
        (let prob =
           let uu____12097 =
             let uu____12100 = FStar_TypeChecker_Env.get_range env in
             new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None
               uu____12100 in
           FStar_All.pipe_left
             (fun _0_76  -> FStar_TypeChecker_Common.TProb _0_76) uu____12097 in
         let g =
           let uu____12105 =
             let uu____12107 = singleton env prob in
             solve_and_commit env uu____12107 (fun uu____12108  -> None) in
           FStar_All.pipe_left (with_guard env prob) uu____12105 in
         g)
let teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____12122 = try_teq env t1 t2 in
        ...
        | None  ->
            let uu____12124 =
              let uu____12125 =
                ...
                let uu____12129 = FStar_TypeChecker_Env.get_range env in
                (uu____12128, uu____12129) in
              FStar_Errors.Error uu____12125 in
            Prims.raise uu____12124
        | Some g ->
            ((let uu____12132 =
                FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                  (FStar_Options.Other "Rel") in
              ...
              | true  ->
                  ...
                  let uu____12134 = FStar_Syntax_Print.term_to_string t2 in
                  let uu____12135 = guard_to_string env g in
                  FStar_Util.print3
        ...
        fun smt_ok  ->
          ...
          (let uu____12155 =
           ...
           | (prob,x) ->
               let g =
                 let uu____12163 =
                   let uu____12165 = singleton' env prob smt_ok in
                   solve_and_commit env uu____12165
                     (fun uu____12166  -> None) in
                 FStar_All.pipe_left (with_guard env prob) uu____12163 in
               ((let uu____12172 =
                   (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                      (FStar_Options.Other "Rel"))
                 ...
                 | true  ->
                     ...
                     let uu____12174 =
                       FStar_TypeChecker_Normalize.term_to_string env t2 in
                     let uu____12175 =
                       let uu____12176 = FStar_Util.must g in
                       guard_to_string env uu____12176 in
                     FStar_Util.print3
...
let subtype_fail:
  ...
  fun env  ->
    fun e  ->
      fun t1  ->
        fun t2  ->
          let uu____12200 = FStar_TypeChecker_Env.get_range env in
          let uu____12201 =
            FStar_TypeChecker_Err.basic_type_error env (Some e) t2 t1 in
          FStar_Errors.report uu____12200 uu____12201
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
    ...
    fun c1  ->
      fun c2  ->
        (let uu____12213 =
         ...
         | true  ->
             let uu____12214 = FStar_Syntax_Print.comp_to_string c1 in
             let uu____12215 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        (let rel =
           ...
           | true  -> FStar_TypeChecker_Common.EQ
           | uu____12218 -> FStar_TypeChecker_Common.SUB in
         let prob =
           let uu____12220 =
             let uu____12223 = FStar_TypeChecker_Env.get_range env in
             new_problem env c1 rel c2 None uu____12223 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_77  -> FStar_TypeChecker_Common.CProb _0_77) uu____12220 in
         let uu____12226 =
           let uu____12228 = singleton env prob in
           solve_and_commit env uu____12228 (fun uu____12229  -> None) in
         FStar_All.pipe_left (with_guard env prob) uu____12226)
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____12273 =
                 let uu____12274 =
                   let uu____12277 =
                     let uu____12278 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____12279 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____12278 uu____12279 in
                   let uu____12280 = FStar_TypeChecker_Env.get_range env in
                   (uu____12277, uu____12280) in
                 FStar_Errors.Error uu____12274 in
               Prims.raise uu____12273) in
            let equiv v v' =
              let uu____12288 =
                let uu____12291 = FStar_Syntax_Subst.compress_univ v in
                let uu____12292 = FStar_Syntax_Subst.compress_univ v' in
                (uu____12291, uu____12292) in
              match uu____12288 with
              | (FStar_Syntax_Syntax.U_unif v0,FStar_Syntax_Syntax.U_unif
                 v0') -> FStar_Unionfind.equivalent v0 v0'
              | uu____12300 -> false in
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v  ->
                      let uu____12314 = FStar_Syntax_Subst.compress_univ v in
                      match uu____12314 with
                      | FStar_Syntax_Syntax.U_unif uu____12318 ->
            ...
            let uu____12350 =
              let wl =
                let uu___172_12353 = empty_worklist env in
                {
                  attempting = (uu___172_12353.attempting);
                  wl_deferred = (uu___172_12353.wl_deferred);
                  ctr = (uu___172_12353.ctr);
                  defer_ok = false;
                  smt_ok = (uu___172_12353.smt_ok);
                  tcenv = (uu___172_12353.tcenv)
                } in
                   ...
                   (fun uu____12360  ->
                      ...
                      | (lb,v) ->
                          ...
                          (match uu____12365 with
                           | USolved wl -> ()
                           | uu____12367 -> fail lb v))) in
            let rec check_ineq uu____12373 =
              ...
              | (u,v) ->
                  ...
                  (match (u, v) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____12380) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_max us,uu____12396) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u  -> check_ineq (u, v)))
                   | (uu____12400,FStar_Syntax_Syntax.U_max vs) ->
                       FStar_All.pipe_right vs
                         (FStar_Util.for_some (fun v  -> check_ineq (u, v)))
                   | uu____12405 -> false) in
            let uu____12408 =
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____12414  ->
                      ...
                      | (u,v) ->
                          let uu____12419 = check_ineq (u, v) in
            ...
            (match uu____12408 with
             ...
             | uu____12426 ->
                 ((let uu____12428 =
                   ...
                   | true  ->
                       ((let uu____12430 = ineqs_to_string (variables, ineqs) in
                         FStar_Util.print1
                           "Partially solved inequality constraints are: %s\n"
                           uu____12430);
                        FStar_Unionfind.rollback tx;
                        (let uu____12436 = ineqs_to_string (variables, ineqs) in
                         FStar_Util.print1
                  ...
                  (let uu____12442 =
                     let uu____12443 =
                       ...
                       ("Failed to solve universe inequalities for inductives",
                         uu____12446) in
                     FStar_Errors.Error uu____12443 in
                   Prims.raise uu____12442)))
let solve_universe_inequalities:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.universe Prims.list* (FStar_Syntax_Syntax.universe*
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____12489 =
       ...
       | true  ->
           let uu____12490 = wl_to_string wl in
           let uu____12491 =
             FStar_Util.string_of_int
       ...
       | uu____12501 -> ());
      (let g =
         let uu____12503 = solve_and_commit env wl fail in
         match uu____12503 with
         | Some [] ->
             let uu___173_12510 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___173_12510.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___173_12510.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___173_12510.FStar_TypeChecker_Env.implicits)
             }
         | uu____12513 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___174_12516 = g in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___174_12516.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___174_12516.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___174_12516.FStar_TypeChecker_Env.implicits)
        }))
let discharge_guard':
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___175_12542 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___175_12542.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___175_12542.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___175_12542.FStar_TypeChecker_Env.implicits)
            } in
          let uu____12543 =
            let uu____12544 = FStar_TypeChecker_Env.should_verify env in
               ...
               | FStar_TypeChecker_Common.NonTrivial vc ->
                   ((let uu____12550 =
                     ...
                     | true  ->
                         ...
                         FStar_Errors.diag uu____12551 uu____12552
                     | uu____12554 -> ());
                    (let vc =
                       FStar_TypeChecker_Normalize.normalize
                         [FStar_TypeChecker_Normalize.Eager_unfolding;
                                ...
                                | true  ->
                                    ...
                                    let uu____12564 =
                                      ...
                                      FStar_Util.format1 "Checking VC=\n%s\n"
                                        uu____12565 in
                                    FStar_Errors.diag uu____12563 uu____12564
                                | uu____12566 -> ());
...
let discharge_guard:
  ...
  fun env  ->
    fun g  ->
      let uu____12573 = discharge_guard' None env g true in
          ...
          (match implicits with
           | [] ->
               (match Prims.op_Negation changed with
                | true  -> out
                | uu____12628 -> until_fixpoint ([], false) out)
           | hd::tl ->
               let uu____12663 = hd in
               (match uu____12663 with
                | (uu____12670,env,u,tm,k,r) ->
                    let uu____12676 = unresolved u in
                         ...
                         ((let uu____12694 =
                          ...
                          (let uu____12702 =
                             env.FStar_TypeChecker_Env.type_of
                               (let uu___176_12706 = env in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___176_12706.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___176_12706.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___176_12706.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___176_12706.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___176_12706.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___176_12706.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___176_12706.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___176_12706.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___176_12706.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___176_12706.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___176_12706.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___176_12706.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___176_12706.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___176_12706.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___176_12706.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___176_12706.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___176_12706.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___176_12706.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax =
                                    (uu___176_12706.FStar_TypeChecker_Env.lax);
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___176_12706.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___176_12706.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___176_12706.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts = true;
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___176_12706.FStar_TypeChecker_Env.qname_and_index)
                                }) tm in
                           match uu____12702 with
                           | (uu____12707,uu____12708,g) ->
                               let g =
                                 match env.FStar_TypeChecker_Env.is_pattern
                                 with
                                 | true  ->
                                     let uu___177_12711 = g in
                                     {
                                       FStar_TypeChecker_Env.guard_f =
                                         FStar_TypeChecker_Common.Trivial;
                                       FStar_TypeChecker_Env.deferred =
                                         (uu___177_12711.FStar_TypeChecker_Env.deferred);
                                       FStar_TypeChecker_Env.univ_ineqs =
                                         (uu___177_12711.FStar_TypeChecker_Env.univ_ineqs);
                                       FStar_TypeChecker_Env.implicits =
                                         (uu___177_12711.FStar_TypeChecker_Env.implicits)
                                     }
                                 | uu____12712 -> g in
                               let g' =
                                 let uu____12714 =
                               ...
                               until_fixpoint
                                 ((FStar_List.append
                                   ...
                                   true) tl))))) in
    let uu___178_12733 = g in
    let uu____12734 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___178_12733.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___178_12733.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___178_12733.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____12734
    }
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g =
        let uu____12762 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____12762 resolve_implicits in
      match g.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____12769 = discharge_guard env g in
          FStar_All.pipe_left Prims.ignore uu____12769
      | (reason,uu____12771,uu____12772,e,t,r)::uu____12776 ->
          let uu____12790 =
            let uu____12791 = FStar_Syntax_Print.term_to_string t in
            let uu____12792 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____12791 uu____12792 reason in
          FStar_Errors.report r uu____12790
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___179_12799 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___179_12799.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___179_12799.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___179_12799.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____12817 = try_teq env t1 t2 in
        match uu____12817 with
        | None  -> false
        | Some g ->
            let uu____12820 = discharge_guard' None env g false in
            (match uu____12820 with
             | Some uu____12824 -> true
             | None  -> false)