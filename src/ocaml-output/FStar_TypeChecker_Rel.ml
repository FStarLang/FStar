...
let term_to_string = (fun env t -> (match ((let _146_91 = (FStar_Syntax_Subst.compress t)
in _146_91.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (u, t) -> begin
(let _146_93 = (FStar_Syntax_Print.uvar_to_string u)
in (let _146_92 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "(%s:%s)" _146_93 _146_92)))
end
...
(let _146_96 = (FStar_Syntax_Print.uvar_to_string u)
in (let _146_95 = (FStar_Syntax_Print.term_to_string ty)
in (let _146_94 = (FStar_Syntax_Print.args_to_string args)
in (FStar_Util.format3 "(%s:%s) %s" _146_96 _146_95 _146_94))))
end
| _55_87 -> begin
...
(let _146_115 = (let _146_114 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _146_113 = (let _146_112 = (term_to_string env p.FStar_TypeChecker_Common.lhs)
in (let _146_111 = (let _146_110 = (FStar_Syntax_Print.tag_of_term p.FStar_TypeChecker_Common.lhs)
in (let _146_109 = (let _146_108 = (let _146_107 = (term_to_string env p.FStar_TypeChecker_Common.rhs)
in (let _146_106 = (let _146_105 = (FStar_Syntax_Print.tag_of_term p.FStar_TypeChecker_Common.rhs)
in (let _146_104 = (let _146_103 = (FStar_TypeChecker_Normalize.term_to_string env (Prims.fst p.FStar_TypeChecker_Common.logical_guard))
in (let _146_102 = (let _146_101 = (FStar_All.pipe_right p.FStar_TypeChecker_Common.reason (FStar_String.concat "\n\t\t\t"))
in (_146_101)::[])
in (_146_103)::_146_102))
in (_146_105)::_146_104))
in (_146_107)::_146_106))
in ((rel_to_string p.FStar_TypeChecker_Common.relation))::_146_108)
in (_146_110)::_146_109))
in (_146_112)::_146_111))
in (_146_114)::_146_113))
in (FStar_Util.format "\t%s: %s (%s)\n\t\t%s\n\t%s (%s) (guard %s)\n\t\t<Reason>\n\t\t\t%s\n\t\t</Reason>" _146_115))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(let _146_117 = (FStar_TypeChecker_Normalize.comp_to_string env p.FStar_TypeChecker_Common.lhs)
in (let _146_116 = (FStar_TypeChecker_Normalize.comp_to_string env p.FStar_TypeChecker_Common.rhs)
in (FStar_Util.format3 "\t%s \n\t\t%s\n\t%s" _146_117 (rel_to_string p.FStar_TypeChecker_Common.relation) _146_116)))
end))
...
(let _146_122 = (FStar_Unionfind.uvar_id u)
in (FStar_All.pipe_right _146_122 FStar_Util.string_of_int))
end
in (let _146_123 = (FStar_Syntax_Print.univ_to_string t)
in (FStar_Util.format2 "UNIV %s %s" x _146_123)))
end
...
(let _146_124 = (FStar_Unionfind.uvar_id u)
in (FStar_All.pipe_right _146_124 FStar_Util.string_of_int))
end
in (let _146_125 = (FStar_TypeChecker_Normalize.term_to_string env t)
in (FStar_Util.format2 "TERM %s %s" x _146_125)))
end))


let uvis_to_string : FStar_TypeChecker_Env.env  ->  uvi Prims.list  ->  Prims.string = (fun env uvis -> (let _146_130 = (FStar_List.map (uvi_to_string env) uvis)
in (FStar_All.pipe_right _146_130 (FStar_String.concat ", "))))


let names_to_string : FStar_Syntax_Syntax.bv FStar_Util.set  ->  Prims.string = (fun nms -> (let _146_134 = (let _146_133 = (FStar_Util.set_elements nms)
in (FStar_All.pipe_right _146_133 (FStar_List.map FStar_Syntax_Print.bv_to_string)))
in (FStar_All.pipe_right _146_134 (FStar_String.concat ", "))))


let args_to_string = (fun args -> (let _146_137 = (FStar_All.pipe_right args (FStar_List.map (fun _55_116 -> (match (_55_116) with
| (x, _55_115) -> begin
(FStar_Syntax_Print.term_to_string x)
end))))
in (FStar_All.pipe_right _146_137 (FStar_String.concat " "))))
...
in (let _146_152 = (FStar_List.map Prims.snd g)
in {attempting = _146_152; wl_deferred = _55_127.wl_deferred; ctr = _55_127.ctr; defer_ok = false; smt_ok = _55_127.smt_ok; tcenv = _55_127.tcenv})))
...
(let _146_169 = (prob_to_string env prob)
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(FStar_All.pipe_right (maybe_invert p) (fun _146_176 -> FStar_TypeChecker_Common.TProb (_146_176)))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(FStar_All.pipe_right (maybe_invert p) (fun _146_177 -> FStar_TypeChecker_Common.CProb (_146_177)))
end))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(FStar_All.pipe_left (fun _146_196 -> FStar_TypeChecker_Common.TProb (_146_196)) (invert p))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(FStar_All.pipe_left (fun _146_197 -> FStar_TypeChecker_Common.CProb (_146_197)) (invert p))
end))
...
let mk_problem = (fun scope orig lhs rel rhs elt reason -> (let _146_210 = (next_pid ())
in (let _146_209 = (new_uvar (p_loc orig) scope FStar_Syntax_Util.ktype0)
in {FStar_TypeChecker_Common.pid = _146_210; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = _146_209; FStar_TypeChecker_Common.scope = scope; FStar_TypeChecker_Common.reason = (reason)::(p_reason orig); FStar_TypeChecker_Common.loc = (p_loc orig); FStar_TypeChecker_Common.rank = None})))


let new_problem = (fun env lhs rel rhs elt loc reason -> (

let scope = (FStar_TypeChecker_Env.all_binders env)
in (let _146_220 = (next_pid ())
in (let _146_219 = (let _146_218 = (FStar_TypeChecker_Env.get_range env)
in (new_uvar _146_218 scope FStar_Syntax_Util.ktype0))
in {FStar_TypeChecker_Common.pid = _146_220; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = _146_219; FStar_TypeChecker_Common.scope = scope; FStar_TypeChecker_Common.reason = (reason)::[]; FStar_TypeChecker_Common.loc = loc; FStar_TypeChecker_Common.rank = None}))))


let problem_using_guard = (fun orig lhs rel rhs elt reason -> (let _146_227 = (next_pid ())
in {FStar_TypeChecker_Common.pid = _146_227; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = (p_guard orig); FStar_TypeChecker_Common.scope = (p_scope orig); FStar_TypeChecker_Common.reason = (reason)::(p_reason orig); FStar_TypeChecker_Common.loc = (p_loc orig); FStar_TypeChecker_Common.rank = None}))
...
(let _146_239 = (FStar_All.pipe_left FStar_Range.string_of_range (p_loc d))
in (let _146_238 = (prob_to_string env d)
in (let _146_237 = (FStar_All.pipe_right (p_reason d) (FStar_String.concat "\n\t>"))
in (FStar_Util.format4 "(%s) Failed to solve the sub-problem\n%s\nWhich arose because:\n\t%s\nFailed because:%s\n" _146_239 _146_238 _146_237 s))))
end else begin
(
...
(let _146_241 = (FStar_TypeChecker_Normalize.term_to_string env tp.FStar_TypeChecker_Common.lhs)
in (let _146_240 = (FStar_TypeChecker_Normalize.term_to_string env tp.FStar_TypeChecker_Common.rhs)
in (_146_241, _146_240)))
end
| FStar_TypeChecker_Common.CProb (cp) -> begin
(let _146_243 = (FStar_TypeChecker_Normalize.comp_to_string env cp.FStar_TypeChecker_Common.lhs)
in (let _146_242 = (FStar_TypeChecker_Normalize.comp_to_string env cp.FStar_TypeChecker_Common.rhs)
in (_146_243, _146_242)))
end)
...
let whnf : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _146_262 = (let _146_261 = (FStar_Syntax_Util.unmeta t)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.WHNF)::[]) env _146_261))
in (FStar_Syntax_Subst.compress _146_262)))


let sn : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _146_267 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env t)
in (FStar_Syntax_Subst.compress _146_267)))


let norm_arg = (fun env t -> (let _146_270 = (sn env (Prims.fst t))
in (_146_270, (Prims.snd t))))
...
let _55_294 = x
in (let _146_276 = (sn env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_294.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_294.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_276}))
in (_146_277, imp))
end)))))
...
(let _146_284 = (aux u)
in FStar_Syntax_Syntax.U_succ (_146_284))
end
| FStar_Syntax_Syntax.U_max (us) -> begin
(let _146_285 = (FStar_List.map aux us)
in FStar_Syntax_Syntax.U_max (_146_285))
end
| _55_306 -> begin
u
end)))
in (let _146_286 = (aux u)
in (FStar_TypeChecker_Normalize.normalize_universe wl.tcenv _146_286))))
...
| tt -> begin
(let _146_300 = (let _146_299 = (FStar_Syntax_Print.term_to_string tt)
in (let _146_298 = (FStar_Syntax_Print.tag_of_term tt)
in (FStar_Util.format2 "impossible: Got %s ... %s\n" _146_299 _146_298)))
in (FStar_All.failwith _146_300))
end)
end
end
...
in (match ((let _146_301 = (FStar_Syntax_Subst.compress t1')
in _146_301.FStar_Syntax_Syntax.n)) with
...
(let _146_304 = (let _146_303 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_302 = (FStar_Syntax_Print.tag_of_term t1)
in (FStar_Util.format2 "impossible (outer): Got %s ... %s\n" _146_303 _146_302)))
in (FStar_All.failwith _146_304))
end))
in (let _146_305 = (whnf env t1)
in (aux false _146_305))))


let unrefine : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ = (fun env t -> (let _146_310 = (base_and_refinement env (empty_worklist env) t)
in (FStar_All.pipe_right _146_310 Prims.fst)))


let trivial_refinement : FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.term) = (fun t -> (let _146_313 = (FStar_Syntax_Syntax.null_bv t)
in (_146_313, FStar_Syntax_Util.t_true)))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _146_326 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _146_325 = (let _146_322 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (FStar_Syntax_Print.term_to_string _146_322))
in (let _146_324 = (let _146_323 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Syntax_Print.term_to_string _146_323))
in (FStar_Util.format4 "%s: %s  (%s)  %s" _146_326 _146_325 (rel_to_string p.FStar_TypeChecker_Common.relation) _146_324))))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(let _146_329 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _146_328 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _146_327 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Util.format4 "%s: %s  (%s)  %s" _146_329 _146_328 (rel_to_string p.FStar_TypeChecker_Common.relation) _146_327))))
end))


let wl_to_string : worklist  ->  Prims.string = (fun wl -> (let _146_335 = (let _146_334 = (let _146_333 = (FStar_All.pipe_right wl.wl_deferred (FStar_List.map (fun _55_422 -> (match (_55_422) with
| (_55_418, _55_420, x) -> begin
x
end))))
in (FStar_List.append wl.attempting _146_333))
in (FStar_List.map (wl_prob_to_string wl) _146_334))
in (FStar_All.pipe_right _146_335 (FStar_String.concat "\n\t"))))
...
let _55_441 = (match ((let _146_342 = (FStar_Syntax_Subst.compress k)
in _146_342.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if ((FStar_List.length bs) = (FStar_List.length ys)) then begin
(let _146_343 = (FStar_Syntax_Subst.open_comp bs c)
in ((ys, t), _146_343))
end else begin
(
...
| (ys', t) -> begin
(let _146_344 = (FStar_Syntax_Util.arrow_formals_comp k)
in (((FStar_List.append ys ys'), t), _146_344))
end))
end
end
| _55_434 -> begin
(let _146_346 = (let _146_345 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _146_345))
in ((ys, t), _146_346))
end)
...
let c = (let _146_347 = (FStar_Syntax_Util.rename_binders xs ys)
in (FStar_Syntax_Subst.subst_comp _146_347 c))
in (let _146_351 = (let _146_350 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_348 -> FStar_Util.Inl (_146_348)))
in (FStar_All.pipe_right _146_350 (fun _146_349 -> Some (_146_349))))
in (FStar_Syntax_Util.abs ys t _146_351)))
end
end)))
...
let _55_466 = (match ((let _146_362 = (FStar_Syntax_Subst.compress uv)
in _146_362.FStar_Syntax_Syntax.n)) with
...
(let _146_365 = (FStar_Util.string_of_int (p_pid prob))
in (let _146_364 = (FStar_Syntax_Print.term_to_string uv)
in (let _146_363 = (FStar_Syntax_Print.term_to_string phi)
in (FStar_Util.print3 "Solving %s (%s) with formula %s\n" _146_365 _146_364 _146_363))))
end else begin
()
end
...
(let _146_374 = (FStar_Util.string_of_int pid)
in (let _146_373 = (let _146_372 = (FStar_List.map (uvi_to_string wl.tcenv) sol)
in (FStar_All.pipe_right _146_372 (FStar_String.concat ", ")))
...
(let _146_387 = (FStar_Syntax_Util.mk_conj t f)
in Some (_146_387))
end))
in (

let _55_501 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("RelCheck"))) then begin
(let _146_390 = (FStar_All.pipe_left FStar_Util.string_of_int (p_pid prob))
in (let _146_389 = (let _146_388 = (FStar_List.map (uvi_to_string wl.tcenv) uvis)
in (FStar_All.pipe_right _146_388 (FStar_String.concat ", ")))
in (FStar_Util.print2 "Solving %s: with %s\n" _146_390 _146_389)))
end else begin
()
end
...
let rec occurs = (fun wl uk t -> (let _146_400 = (let _146_398 = (FStar_Syntax_Free.uvars t)
in (FStar_All.pipe_right _146_398 FStar_Util.set_elements))
in (FStar_All.pipe_right _146_400 (FStar_Util.for_some (fun _55_510 -> (match (_55_510) with
| (uv, _55_509) -> begin
...
(let _146_407 = (let _146_406 = (FStar_Syntax_Print.uvar_to_string (Prims.fst uk))
in (let _146_405 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "occurs-check failed (%s occurs in %s)" _146_406 _146_405)))
in Some (_146_407))
end
in (occurs_ok, msg))))
...
| (occurs_ok, msg) -> begin
(let _146_413 = (FStar_Util.set_is_subset_of fvs_t fvs)
in (occurs_ok, _146_413, (msg, fvs, fvs_t)))
end))))
...
if (let _146_422 = (FStar_Util.set_mem x v1_set)
...
(let _146_423 = (FStar_Util.set_add x isect_set)
in (((x, imp))::isect, _146_423))
end else begin
(isect, isect_set)
end)
end
...
(let _146_438 = (FStar_All.pipe_left FStar_Syntax_Print.term_to_string (Prims.fst hd))
...
(let _146_474 = (head_matches env f g)
...
(let _146_475 = (head_matches env x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _146_475 head_match))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _55_743), _55_747) -> begin
(let _146_476 = (head_matches env x.FStar_Syntax_Syntax.sort t2)
in (FStar_All.pipe_right _146_476 head_match))
end
| (_55_750, FStar_Syntax_Syntax.Tm_refine (x, _55_753)) -> begin
(let _146_477 = (head_matches env t1 x.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _146_477 head_match))
end
...
(let _146_478 = (head_matches env head head')
in (FStar_All.pipe_right _146_478 head_match))
end
| (FStar_Syntax_Syntax.Tm_app (head, _55_784), _55_788) -> begin
(let _146_479 = (head_matches env head t2)
in (FStar_All.pipe_right _146_479 head_match))
end
| (_55_791, FStar_Syntax_Syntax.Tm_app (head, _55_794)) -> begin
(let _146_480 = (head_matches env t1 head)
in (FStar_All.pipe_right _146_480 head_match))
end
| _55_799 -> begin
(let _146_483 = (let _146_482 = (delta_depth_of_term env t1)
in (let _146_481 = (delta_depth_of_term env t2)
in (_146_482, _146_481)))
in MisMatch (_146_483))
end))))
...
in (let _146_504 = (normalize_refinement ((FStar_TypeChecker_Normalize.UnfoldUntil (d1))::(FStar_TypeChecker_Normalize.WHNF)::[]) env wl t2)
in (t1, _146_504)))
end
...
| (t, _55_866) -> begin
(let _146_575 = (new_uvar r binders t)
in (Prims.fst _146_575))
end)))


let kind_type : FStar_Syntax_Syntax.binders  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.typ = (fun binders r -> (let _146_580 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_580 Prims.fst)))
...
in (let _146_642 = (decompose [] bs)
in (rebuild, matches, _146_642))))
end)))
end
| _55_951 -> begin
(
...
in (let _146_674 = (let _146_673 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (FStar_All.pipe_left (fun _146_672 -> FStar_TypeChecker_Common.TProb (_146_672)) _146_673))
in (T ((gi_xs, mk_kind)), _146_674)))
end)))
end
...
(let _146_687 = (let _146_686 = (FStar_Syntax_Syntax.mk_Total gi_xs)
in (FStar_All.pipe_left (fun _146_685 -> C (_146_685)) _146_686))
in (_146_687, (prob)::[]))
end
| _55_1038 -> begin
(FStar_All.failwith "impossible")
...
(let _146_694 = (let _146_693 = (FStar_Syntax_Syntax.mk_GTotal gi_xs)
in (FStar_All.pipe_left (fun _146_692 -> C (_146_692)) _146_693))
in (_146_694, (prob)::[]))
end
| _55_1060 -> begin
(FStar_All.failwith "impossible")
...
let _55_1081 = (let _146_700 = (FStar_List.map (sub_prob scope args) components)
in (FStar_All.pipe_right _146_700 FStar_List.unzip))
in (match (_55_1081) with
| (tcs, sub_probs) -> begin
(

let gi_xs = (let _146_705 = (let _146_704 = (let _146_701 = (FStar_List.hd tcs)
in (FStar_All.pipe_right _146_701 un_T))
in (let _146_703 = (let _146_702 = (FStar_List.tl tcs)
in (FStar_All.pipe_right _146_702 (FStar_List.map arg_of_tc)))
in {FStar_Syntax_Syntax.effect_name = c.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _146_704; FStar_Syntax_Syntax.effect_args = _146_703; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp _146_705))
...
(let _146_707 = (let _146_706 = (FStar_Syntax_Util.arg_of_non_null_binder b)
in (_146_706)::args)
in (Some (b), (b)::scope, _146_707))
end
| _55_1099 -> begin
(None, scope, args)
end)
...
| None -> begin
(let _146_710 = (let _146_709 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (f)::_146_709)
in (FStar_Syntax_Util.mk_conj_l _146_710))
end
| Some (b) -> begin
(let _146_714 = (let _146_713 = (FStar_Syntax_Util.mk_forall (Prims.fst b) f)
in (let _146_712 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (_146_713)::_146_712))
in (FStar_Syntax_Util.mk_conj_l _146_714))
end)
...
let _55_1167 = p
in (let _146_736 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _146_735 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in {FStar_TypeChecker_Common.pid = _55_1167.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _146_736; FStar_TypeChecker_Common.relation = _55_1167.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_735; FStar_TypeChecker_Common.element = _55_1167.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_1167.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_1167.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_1167.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_1167.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_1167.FStar_TypeChecker_Common.rank}))))


let compress_prob : worklist  ->  FStar_TypeChecker_Common.prob  ->  FStar_TypeChecker_Common.prob = (fun wl p -> (match (p) with
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _146_742 = (compress_tprob wl p)
in (FStar_All.pipe_right _146_742 (fun _146_741 -> FStar_TypeChecker_Common.TProb (_146_741))))
end
...
let prob = (let _146_747 = (compress_prob wl pr)
in (FStar_All.pipe_right _146_747 maybe_invert_p))
in (match (prob) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(
...
(let _146_835 = (let _146_834 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_833 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Unable to unify universes: %s and %s" _146_834 _146_833)))
in UFailed (_146_835))
end
end
...
| _55_1346 -> begin
(let _146_842 = (let _146_841 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_840 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Unable to unify universes: %s and %s (%s)" _146_841 _146_840 msg)))
in UFailed (_146_842))
end))
in (match ((u1, u2)) with
...
(let _146_845 = (let _146_844 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (v1)))
in (let _146_843 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.format2 "Failed occurs check: %s occurs in %s" _146_844 _146_843)))
in (try_umax_components u1 u2 _146_845))
end else begin
(let _146_846 = (extend_solution orig ((UNIV ((v1, u)))::[]) wl)
in USolved (_146_846))
end)
end
...
(let _146_892 = (wl_to_string probs)
...
(match (attempt) with
| [] -> begin
(let _146_895 = (FStar_List.map (fun _55_1486 -> (match (_55_1486) with
| (_55_1483, x, y) -> begin
(x, y)
...
let _55_1489 = probs
in (let _146_897 = (FStar_All.pipe_right attempt (FStar_List.map (fun _55_1496 -> (match (_55_1496) with
| (_55_1492, _55_1494, y) -> begin
y
end))))
in {attempting = _146_897; wl_deferred = rest; ctr = _55_1489.ctr; defer_ok = _55_1489.defer_ok; smt_ok = _55_1489.smt_ok; tcenv = _55_1489.tcenv}))
in (solve env _146_898))
end)
end))
end)
end)))
...
| USolved (wl) -> begin
(let _146_904 = (solve_prob orig None [] wl)
in (solve env _146_904))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _146_920 = (prob_to_string env orig)
...
(let _146_924 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
| Some (t1, t2) -> begin
(let _146_930 = (FStar_Syntax_Subst.compress t1)
in (let _146_929 = (FStar_Syntax_Subst.compress t2)
in (_146_930, _146_929)))
end
| None -> begin
(let _146_932 = (FStar_Syntax_Subst.compress t1)
in (let _146_931 = (FStar_Syntax_Subst.compress t2)
...
let eq_prob = (fun t1 t2 -> (let _146_938 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "meeting refinements")
in (FStar_All.pipe_left (fun _146_937 -> FStar_TypeChecker_Common.TProb (_146_937)) _146_938)))
in (match ((t1.FStar_Syntax_Syntax.n, t2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_refine (x, phi1), FStar_Syntax_Syntax.Tm_refine (y, phi2)) -> begin
(let _146_945 = (let _146_944 = (let _146_941 = (let _146_940 = (let _146_939 = (FStar_Syntax_Util.mk_disj phi1 phi2)
in (x, _146_939))
in FStar_Syntax_Syntax.Tm_refine (_146_940))
in (FStar_Syntax_Syntax.mk _146_941 None t1.FStar_Syntax_Syntax.pos))
in (let _146_943 = (let _146_942 = (eq_prob x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (_146_942)::[])
in (_146_944, _146_943)))
in Some (_146_945))
end
| (_55_1627, FStar_Syntax_Syntax.Tm_refine (x, _55_1630)) -> begin
(let _146_948 = (let _146_947 = (let _146_946 = (eq_prob x.FStar_Syntax_Syntax.sort t1)
in (_146_946)::[])
in (t1, _146_947))
in Some (_146_948))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _55_1636), _55_1640) -> begin
(let _146_951 = (let _146_950 = (let _146_949 = (eq_prob x.FStar_Syntax_Syntax.sort t2)
in (_146_949)::[])
in (t2, _146_950))
in Some (_146_951))
end
...
(match ((let _146_952 = (FStar_Syntax_Util.un_uinst head1)
in _146_952.FStar_Syntax_Syntax.n)) with
...
| (u', _55_1674) -> begin
(match ((let _146_954 = (whnf env u')
in _146_954.FStar_Syntax_Syntax.n)) with
...
(match ((let _146_959 = (whnf env hd.FStar_TypeChecker_Common.lhs)
in (disjoin bound _146_959))) with
...
in (match ((let _146_961 = (let _146_960 = (whnf env tp.FStar_TypeChecker_Common.lhs)
in (_146_960, []))
in (make_lower_bound _146_961 lower_bounds))) with
| None -> begin
(
...
in (let _146_962 = (wl_to_string wl')
...
(let _146_968 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
(let _146_980 = (let _146_979 = (let _146_978 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _146_977 -> FStar_TypeChecker_Common.TProb (_146_977)) _146_978))
in (_146_979)::[])
in Some (_146_980))
end
end else begin
...
(let _146_984 = (let _146_983 = (let _146_982 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _146_981 -> FStar_TypeChecker_Common.TProb (_146_981)) _146_982))
in (_146_983)::[])
in Some (_146_984))
end
end else begin
...
in (let _146_991 = (let _146_990 = (let _146_989 = (FStar_Syntax_Util.mk_conj phi1 phi2)
in (FStar_Syntax_Util.refine x _146_989))
in (_146_990, m))
in Some (_146_991))))))
end))
end
...
| (u', _55_1839) -> begin
(match ((let _146_993 = (whnf env u')
in _146_993.FStar_Syntax_Syntax.n)) with
...
| (FStar_TypeChecker_Common.TProb (hd))::tl -> begin
(match ((let _146_998 = (whnf env hd.FStar_TypeChecker_Common.rhs)
in (conjoin bound _146_998))) with
| Some (bound, sub) -> begin
...
in (match ((let _146_1000 = (let _146_999 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in (_146_999, []))
in (make_upper_bound _146_1000 upper_bounds))) with
| None -> begin
(
...
in (let _146_1001 = (wl_to_string wl')
...
(let _146_1029 = (prob_to_string env rhs_prob)
...
let _55_1932 = hd1
in (let _146_1030 = (FStar_Syntax_Subst.subst subst hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_1932.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_1932.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_1030}))
in (

let hd2 = (

let _55_1935 = hd2
in (let _146_1031 = (FStar_Syntax_Subst.subst subst hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _55_1935.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _55_1935.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _146_1031}))
in (

let prob = (let _146_1034 = (let _146_1033 = (FStar_All.pipe_left invert_rel (p_rel orig))
in (mk_problem scope orig hd1.FStar_Syntax_Syntax.sort _146_1033 hd2.FStar_Syntax_Syntax.sort None "Formal parameter"))
in (FStar_All.pipe_left (fun _146_1032 -> FStar_TypeChecker_Common.TProb (_146_1032)) _146_1034))
in (

let hd1 = (FStar_Syntax_Syntax.freshen_bv hd1)
in (

let subst = (let _146_1035 = (FStar_Syntax_Subst.shift_subst 1 subst)
in (FStar_Syntax_Syntax.DB ((0, hd1)))::_146_1035)
in (
...
let phi = (let _146_1037 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (let _146_1036 = (FStar_Syntax_Util.close_forall (((hd1, imp))::[]) phi)
in (FStar_Syntax_Util.mk_conj _146_1037 _146_1036)))
in (

let _55_1947 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1039 = (FStar_Syntax_Print.term_to_string phi)
in (let _146_1038 = (FStar_Syntax_Print.bv_to_string hd1)
...
and solve_t : FStar_TypeChecker_Env.env  ->  tprob  ->  worklist  ->  solution = (fun env problem wl -> (let _146_1043 = (compress_tprob wl problem)
in (solve_t' env _146_1043 wl)))
...
in (let _146_1072 = (let _146_1071 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_has_type t1 _146_1071 t2))
in (FStar_Syntax_Util.mk_forall x _146_1072)))
end))
...
in (let _146_1073 = (solve_prob orig (Some (guard)) [] wl)
in (solve env _146_1073)))
end else begin
...
(let _146_1077 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1076 = (FStar_Syntax_Print.tag_of_term t1)
in (let _146_1075 = (FStar_Syntax_Print.term_to_string t2)
in (let _146_1074 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.print4 "Head matches: %s (%s) and %s (%s)\n" _146_1077 _146_1076 _146_1075 _146_1074)))))
end else begin
()
end
in (
...
(let _146_1082 = (let _146_1081 = (FStar_Syntax_Print.term_to_string head1)
in (let _146_1080 = (args_to_string args1)
in (let _146_1079 = (FStar_Syntax_Print.term_to_string head2)
in (let _146_1078 = (args_to_string args2)
in (FStar_Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _146_1081 _146_1080 _146_1079 _146_1078)))))
in (giveup env _146_1082 orig))
end else begin
if ((nargs = 0) || (eq_args args1 args2)) then begin
(match ((solve_maybe_uinsts env orig head1 head2 wl)) with
| USolved (wl) -> begin
(let _146_1083 = (solve_prob orig None [] wl)
in (solve env _146_1083))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _146_1087 = (mk_problem (p_scope orig) orig a FStar_TypeChecker_Common.EQ a' None "index")
in (FStar_All.pipe_left (fun _146_1086 -> FStar_TypeChecker_Common.TProb (_146_1086)) _146_1087))
end)) args1 args2)
in (

let formula = (let _146_1089 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
in (FStar_Syntax_Util.mk_conj_l _146_1089))
in (
...
let im = (let _146_1104 = (h gs_xs)
in (let _146_1103 = (let _146_1102 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_1100 -> FStar_Util.Inl (_146_1100)))
in (FStar_All.pipe_right _146_1102 (fun _146_1101 -> Some (_146_1101))))
in (FStar_Syntax_Util.abs xs _146_1104 _146_1103)))
in (

let _55_2092 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1111 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _146_1110 = (FStar_Syntax_Print.comp_to_string c)
in (let _146_1109 = (FStar_Syntax_Print.term_to_string im)
in (let _146_1108 = (FStar_Syntax_Print.tag_of_term im)
in (let _146_1107 = (let _146_1105 = (FStar_List.map (prob_to_string env) sub_probs)
in (FStar_All.pipe_right _146_1105 (FStar_String.concat ", ")))
in (let _146_1106 = (FStar_TypeChecker_Normalize.term_to_string env formula)
in (FStar_Util.print6 "Imitating  binders are {%s}, comp=%s\n\t%s (%s)\nsub_probs = %s\nformula=%s\n" _146_1111 _146_1110 _146_1109 _146_1108 _146_1107 _146_1106)))))))
end else begin
()
end
in (
...
| (gi_xs', gi_ps') -> begin
(let _146_1141 = (let _146_1138 = (FStar_Syntax_Syntax.as_arg gi_xs)
in (_146_1138)::gi_xs')
in (let _146_1140 = (let _146_1139 = (FStar_Syntax_Syntax.as_arg gi_ps)
in (_146_1139)::gi_ps')
in (_146_1141, _146_1140)))
end)))))
end)))
end))
in (aux [] bs))
end)))
in if (let _146_1142 = (matches pi)
in (FStar_All.pipe_left Prims.op_Negation _146_1142)) then begin
None
end else begin
(
...
let proj = (let _146_1147 = (FStar_Syntax_Syntax.mk_Tm_app xi g_xs None r)
in (let _146_1146 = (let _146_1145 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _146_1143 -> FStar_Util.Inl (_146_1143)))
in (FStar_All.pipe_right _146_1145 (fun _146_1144 -> Some (_146_1144))))
in (FStar_Syntax_Util.abs xs _146_1147 _146_1146)))
in (

let sub = (let _146_1153 = (let _146_1152 = (FStar_Syntax_Syntax.mk_Tm_app proj ps None r)
in (let _146_1151 = (let _146_1150 = (FStar_List.map (fun _55_2164 -> (match (_55_2164) with
| (_55_2160, _55_2162, y) -> begin
y
end)) qs)
in (FStar_All.pipe_left h _146_1150))
in (mk_problem (p_scope orig) orig _146_1152 (p_rel orig) _146_1151 None "projection")))
in (FStar_All.pipe_left (fun _146_1148 -> FStar_TypeChecker_Common.TProb (_146_1148)) _146_1153))
in (

let _55_2166 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1155 = (FStar_Syntax_Print.term_to_string proj)
in (let _146_1154 = (prob_to_string env sub)
...
let wl = (let _146_1157 = (let _146_1156 = (FStar_All.pipe_left Prims.fst (p_guard sub))
in Some (_146_1156))
in (solve_prob orig _146_1157 ((TERM ((u, proj)))::[]) wl))
in (let _146_1159 = (solve env (attempt ((sub)::[]) wl))
in (FStar_All.pipe_left (fun _146_1158 -> Some (_146_1158)) _146_1159)))))))
end))
end)
end))
end)))
...
(let _146_1181 = (let _146_1180 = (decompose env t2)
in (((uv, k_uv), xs, c), ps, _146_1180))
in Some (_146_1181))
end else begin
(
...
let rec elim = (fun k args -> (match ((let _146_1187 = (let _146_1186 = (FStar_Syntax_Subst.compress k)
in _146_1186.FStar_Syntax_Syntax.n)
in (_146_1187, args))) with
| (_55_2191, []) -> begin
(let _146_1189 = (let _146_1188 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _146_1188))
in Some (_146_1189))
end
...
| (uv, uv_args) -> begin
(match ((let _146_1190 = (FStar_Syntax_Subst.compress uv)
in _146_1190.FStar_Syntax_Syntax.n)) with
...
let xs = (FStar_All.pipe_right args (FStar_List.map (fun _55_2217 -> (let _146_1196 = (let _146_1195 = (let _146_1194 = (let _146_1193 = (let _146_1192 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1192 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _146_1193))
in (Prims.fst _146_1194))
in (FStar_Syntax_Syntax.new_bv (Some (k.FStar_Syntax_Syntax.pos)) _146_1195))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _146_1196)))))
in (

let c = (let _146_1200 = (let _146_1199 = (let _146_1198 = (let _146_1197 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1197 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _146_1198))
in (Prims.fst _146_1199))
in (FStar_Syntax_Syntax.mk_Total _146_1200))
in (

let k' = (FStar_Syntax_Util.arrow xs c)
in (

let uv_sol = (let _146_1206 = (let _146_1205 = (let _146_1204 = (let _146_1203 = (let _146_1202 = (let _146_1201 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _146_1201 Prims.fst))
in (FStar_Syntax_Syntax.mk_Total _146_1202))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _146_1203))
in FStar_Util.Inl (_146_1204))
in Some (_146_1205))
in (FStar_Syntax_Util.abs scope k' _146_1206))
in (
...
(let _146_1208 = (FStar_Syntax_Subst.open_comp xs c)
in (FStar_All.pipe_right _146_1208 (fun _146_1207 -> Some (_146_1207))))
end else begin
...
| (xs, c) -> begin
(let _146_1210 = (elim (FStar_Syntax_Util.comp_result c) rest)
in (FStar_Util.bind_opt _146_1210 (fun _55_2244 -> (match (_55_2244) with
| (xs', c) -> begin
...
in (let _146_1213 = (let _146_1211 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Subst.open_comp xs _146_1211))
in (FStar_All.pipe_right _146_1213 (fun _146_1212 -> Some (_146_1212)))))
end))
end
end))
end
| _55_2250 -> begin
(let _146_1217 = (let _146_1216 = (FStar_Syntax_Print.uvar_to_string uv)
in (let _146_1215 = (FStar_Syntax_Print.term_to_string k)
in (let _146_1214 = (FStar_Syntax_Print.term_to_string k_uv)
in (FStar_Util.format3 "Impossible: ill-typed application %s : %s\n\t%s" _146_1216 _146_1215 _146_1214))))
in (FStar_All.failwith _146_1217))
end))
in (let _146_1255 = (elim k_uv ps)
in (FStar_Util.bind_opt _146_1255 (fun _55_2253 -> (match (_55_2253) with
| (xs, c) -> begin
(let _146_1254 = (let _146_1253 = (decompose env t2)
in (((uv, k_uv), xs, c), ps, _146_1253))
in Some (_146_1254))
end))))))
end
end)))
...
(let _146_1266 = (names_to_string fvs_hd)
in (FStar_Util.print1 "Free variables are %s" _146_1266))
end else begin
()
end
in false)
...
let fvs_hd = (let _146_1270 = (let _146_1269 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _146_1269 Prims.fst))
in (FStar_All.pipe_right _146_1270 FStar_Syntax_Free.names))
...
(let _146_1272 = (let _146_1271 = (FStar_Option.get msg)
in (Prims.strcat "occurs-check failed: " _146_1271))
in (giveup_or_defer orig _146_1272))
end else begin
...
(let _146_1273 = (subterms args_lhs)
in (imitate' orig env wl _146_1273))
end else begin
(

let _55_2308 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1276 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1275 = (names_to_string fvs1)
in (let _146_1274 = (names_to_string fvs2)
...
| _55_2312 -> begin
(let _146_1277 = (sn_binders env vars)
in (u_abs k_uv _146_1277 t2))
end)
in (
...
(let _146_1280 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1279 = (names_to_string fvs1)
in (let _146_1278 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _146_1280 _146_1279 _146_1278))))
end else begin
()
end
in (let _146_1281 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _146_1281 (- (1)))))
end else begin
...
if (let _146_1282 = (FStar_Syntax_Free.names t1)
in (check_head _146_1282 t2)) then begin
(
...
(let _146_1283 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print2 "Not a pattern (%s) ... %s\n" _146_1283 (if (im_ok < 0) then begin
"imitating"
end else begin
"projecting"
end)))
...
in (let _146_1284 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _146_1284 im_ok))))
end else begin
...
| (x, imp) -> begin
(let _146_1306 = (FStar_Syntax_Syntax.bv_to_name x)
in (_146_1306, imp))
end))))
in (
...
| (t, _55_2354) -> begin
(let _146_1307 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars t)
in (Prims.fst _146_1307))
end))
in (
...
let sol = (let _146_1309 = (let _146_1308 = (u_abs k all_formals t')
in ((u, k), _146_1308))
in TERM (_146_1309))
in (
...
(let _146_1311 = (FStar_Util.set_add (Prims.fst formal) pattern_var_set)
in (aux ((y)::pat_args) ((formal)::pattern_vars) _146_1311 formals tl))
end)
end)
end)
end
...
in (let _146_1312 = (FStar_Syntax_Syntax.new_bv_set ())
in (aux [] [] _146_1312 all_formals args))))
end))
end))
in (
...
(let _146_1321 = (solve_prob orig None [] wl)
in (solve env _146_1321))
end else begin
(
...
(let _146_1326 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _146_1325 = (FStar_Syntax_Print.binders_to_string ", " ys)
in (let _146_1324 = (FStar_Syntax_Print.binders_to_string ", " zs)
in (let _146_1323 = (FStar_Syntax_Print.term_to_string k1)
in (let _146_1322 = (FStar_Syntax_Print.term_to_string k2)
in (FStar_Util.print5 "Flex-flex patterns: intersected %s and %s; got %s\n\tk1=%s\n\tk2=%s\n" _146_1326 _146_1325 _146_1324 _146_1323 _146_1322))))))
end else begin
()
end
in (
...
(let _146_1336 = (let _146_1335 = (FStar_Syntax_Print.term_to_string k)
in (let _146_1334 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _146_1333 = (FStar_Syntax_Print.args_to_string args)
in (FStar_Util.format3 "k=%s\nxs=%s\nargs=%s\nIll-formed substitutution" _146_1335 _146_1334 _146_1333))))
in (FStar_All.failwith _146_1336))
end)))
in (

let _55_2448 = (

let _55_2416 = (let _146_1337 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env k1)
in (FStar_Syntax_Util.arrow_formals _146_1337))
in (match (_55_2416) with
| (bs, k1') -> begin
(

let _55_2419 = (let _146_1338 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env k2)
in (FStar_Syntax_Util.arrow_formals _146_1338))
in (match (_55_2419) with
| (cs, k2') -> begin
(

let k1'_xs = (let _146_1339 = (subst_of_list k1 bs args1)
in (FStar_Syntax_Subst.subst _146_1339 k1'))
in (

let k2'_ys = (let _146_1340 = (subst_of_list k2 cs args2)
in (FStar_Syntax_Subst.subst _146_1340 k2'))
in (

let sub_prob = (let _146_1342 = (mk_problem (p_scope orig) orig k1'_xs FStar_TypeChecker_Common.EQ k2'_ys None "flex-flex kinding")
in (FStar_All.pipe_left (fun _146_1341 -> FStar_TypeChecker_Common.TProb (_146_1341)) _146_1342))
in (match ((let _146_1346 = (let _146_1343 = (FStar_Syntax_Subst.compress k1')
in _146_1343.FStar_Syntax_Syntax.n)
in (let _146_1345 = (let _146_1344 = (FStar_Syntax_Subst.compress k2')
in _146_1344.FStar_Syntax_Syntax.n)
in (_146_1346, _146_1345)))) with
...
let kprob = (let _146_1348 = (mk_problem (p_scope orig) orig k1'_xs FStar_TypeChecker_Common.EQ k_zs None "flex-flex kinding")
in (FStar_All.pipe_left (fun _146_1347 -> FStar_TypeChecker_Common.TProb (_146_1347)) _146_1348))
...
let _55_2452 = (let _146_1354 = (let _146_1349 = (new_uvar r zs k_u')
in (FStar_All.pipe_left Prims.fst _146_1349))
in (let _146_1353 = (let _146_1350 = (FStar_Syntax_Syntax.mk_Total k_u')
in (FStar_Syntax_Util.arrow xs _146_1350))
in (let _146_1352 = (let _146_1351 = (FStar_Syntax_Syntax.mk_Total k_u')
in (FStar_Syntax_Util.arrow ys _146_1351))
in (_146_1354, _146_1353, _146_1352))))
...
(let _146_1360 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1359 = (FStar_Syntax_Print.term_to_string t2)
...
(let _146_1365 = (let _146_1363 = (FStar_Syntax_Syntax.bv_to_name a)
in (mk_problem (p_scope orig) orig _146_1363 FStar_TypeChecker_Common.EQ t2 None "flex-flex index"))
in (FStar_All.pipe_right _146_1365 (fun _146_1364 -> FStar_TypeChecker_Common.TProb (_146_1364))))
end)) xs args2)
in (

let guard = (let _146_1367 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _146_1367))
in (
...
let sol = (let _146_1369 = (let _146_1368 = (u_abs k1 xs t2)
in ((u1, k1), _146_1368))
in TERM (_146_1369))
in (
...
(let _146_1370 = (uvi_to_string env sol)
...
(let _146_1371 = (uvi_to_string env sol)
...
(let _146_1372 = (solve_prob orig None [] wl)
in (solve env _146_1372))
end else begin
(
...
(let _146_1373 = (solve_prob orig None [] wl)
in (solve env _146_1373))
end else begin
(

let _55_2556 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("RelCheck"))) then begin
(let _146_1374 = (FStar_Util.string_of_int problem.FStar_TypeChecker_Common.pid)
...
(let _146_1408 = (let _146_1405 = (mk_cod1 [])
in (bs1, _146_1405))
in (let _146_1407 = (let _146_1406 = (mk_cod2 [])
in (bs2, _146_1406))
in (_146_1408, _146_1407)))
end else begin
if (l1 > l2) then begin
(let _146_1411 = (curry l2 bs1 mk_cod1)
in (let _146_1410 = (let _146_1409 = (mk_cod2 [])
in (bs2, _146_1409))
in (_146_1411, _146_1410)))
end else begin
(let _146_1414 = (let _146_1412 = (mk_cod1 [])
in (bs1, _146_1412))
in (let _146_1413 = (curry l1 bs2 mk_cod2)
in (_146_1414, _146_1413)))
end
end)))
end))
in (match ((t1.FStar_Syntax_Syntax.n, t2.FStar_Syntax_Syntax.n)) with
...
| bs -> begin
(let _146_1419 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((bs, c))) None c.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk_Total _146_1419))
end))
in (
...
in (let _146_1426 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (FStar_All.pipe_left (fun _146_1425 -> FStar_TypeChecker_Common.CProb (_146_1425)) _146_1426)))))))
end)))
end
...
(solve_binders env bs1 bs2 orig wl (fun scope env subst -> (let _146_1441 = (let _146_1440 = (FStar_Syntax_Subst.subst subst tbody1)
in (let _146_1439 = (FStar_Syntax_Subst.subst subst tbody2)
in (mk_problem scope orig _146_1440 problem.FStar_TypeChecker_Common.relation _146_1439 None "lambda co-domain")))
in (FStar_All.pipe_left (fun _146_1438 -> FStar_TypeChecker_Common.TProb (_146_1438)) _146_1441))))
end)))
end
...
let base_prob = (let _146_1443 = (mk_problem (p_scope orig) orig x1.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.relation x2.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "refinement base type")
in (FStar_All.pipe_left (fun _146_1442 -> FStar_TypeChecker_Common.TProb (_146_1442)) _146_1443))
in (
...
let mk_imp = (fun imp phi1 phi2 -> (let _146_1460 = (imp phi1 phi2)
in (FStar_All.pipe_right _146_1460 (guard_on_element problem x1))))
in (
...
let guard = (let _146_1463 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1463 impl))
in (
...
let ref_prob = (let _146_1467 = (let _146_1466 = (let _146_1465 = (FStar_Syntax_Syntax.mk_binder x1)
in (_146_1465)::(p_scope orig))
in (mk_problem _146_1466 orig phi1 FStar_TypeChecker_Common.EQ phi2 None "refinement formula"))
in (FStar_All.pipe_left (fun _146_1464 -> FStar_TypeChecker_Common.TProb (_146_1464)) _146_1467))
in (match ((solve env (
...
let guard = (let _146_1470 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (let _146_1469 = (let _146_1468 = (FStar_All.pipe_right (p_guard ref_prob) Prims.fst)
in (FStar_All.pipe_right _146_1468 (guard_on_element problem x1)))
in (FStar_Syntax_Util.mk_conj _146_1470 _146_1469)))
in (
...
(let _146_1472 = (destruct_flex_t t1)
in (let _146_1471 = (destruct_flex_t t2)
in (flex_flex orig _146_1472 _146_1471)))
end
...
(let _146_1473 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid orig _146_1473 t2 wl))
end
...
in if (let _146_1474 = (is_top_level_prob orig)
in (FStar_All.pipe_left Prims.op_Negation _146_1474)) then begin
(let _146_1477 = (FStar_All.pipe_left (fun _146_1475 -> FStar_TypeChecker_Common.TProb (_146_1475)) (
...
in (let _146_1476 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _146_1477 _146_1476 t2 wl)))
end else begin
(
...
(match (ref_opt) with
| None -> begin
(let _146_1480 = (FStar_All.pipe_left (fun _146_1478 -> FStar_TypeChecker_Common.TProb (_146_1478)) (
...
in (let _146_1479 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _146_1480 _146_1479 t_base wl)))
end
| Some (y, phi) -> begin
(
...
let base_prob = (let _146_1482 = (mk_problem problem.FStar_TypeChecker_Common.scope orig t1 new_rel y.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _146_1481 -> FStar_TypeChecker_Common.TProb (_146_1481)) _146_1482))
in (

let guard = (let _146_1483 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1483 impl))
in (
...
let t2 = (let _146_1484 = (base_and_refinement env wl t2)
in (FStar_All.pipe_left force_refinement _146_1484))
in (solve_t env (
...
let t1 = (let _146_1485 = (base_and_refinement env wl t1)
in (FStar_All.pipe_left force_refinement _146_1485))
in (solve_t env (
...
in (let _146_1489 = (maybe_eta t1)
in (let _146_1488 = (maybe_eta t2)
in {FStar_TypeChecker_Common.pid = _55_2969.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _146_1489; FStar_TypeChecker_Common.relation = _55_2969.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_1488; FStar_TypeChecker_Common.element = _55_2969.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_2969.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_2969.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_2969.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_2969.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_2969.FStar_TypeChecker_Common.rank})))
in (solve_t env _146_1490 wl)))
end
...
let head1 = (let _146_1491 = (FStar_Syntax_Util.head_and_args t1)
in (FStar_All.pipe_right _146_1491 Prims.fst))
in (

let head2 = (let _146_1492 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _146_1492 Prims.fst))
...
(let _146_1494 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Syntax.tun FStar_Syntax_Syntax.tun t1 t2)
in (FStar_All.pipe_left (fun _146_1493 -> Some (_146_1493)) _146_1494))
end
in (let _146_1495 = (solve_prob orig guard [] wl)
in (solve env _146_1495)))
end else begin
...
(let _146_1498 = (let _146_1497 = (FStar_Syntax_Print.tag_of_term t1)
in (let _146_1496 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.format2 "Impossible: %s and %s" _146_1497 _146_1496)))
in (FStar_All.failwith _146_1498))
end
| _55_3109 -> begin
...
(let _146_1513 = (sub_prob a1 FStar_TypeChecker_Common.EQ a2 "effect arg")
in (FStar_All.pipe_left (fun _146_1512 -> FStar_TypeChecker_Common.TProb (_146_1512)) _146_1513))
end)) c1_comp.FStar_Syntax_Syntax.effect_args c2_comp.FStar_Syntax_Syntax.effect_args)
in (

let guard = (let _146_1515 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _146_1515))
in (
...
| _55_3151 -> begin
(let _146_1523 = (let _146_1522 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid c1.FStar_Syntax_Syntax.effect_name))
in (FStar_Util.format1 "Unexpected number of indices on a normalized effect (%s)" _146_1522))
in (FStar_All.failwith _146_1523))
end)
in (

let c1 = (let _146_1526 = (let _146_1525 = (let _146_1524 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _146_1524))
in (_146_1525)::[])
in {FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _146_1526; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2)))
end else begin
(
...
| _55_3177 -> begin
(let _146_1530 = (let _146_1529 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _146_1528 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _146_1529 _146_1528)))
in (FStar_All.failwith _146_1530))
end)
in (match (_55_3180) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _146_1531 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _146_1531 wl))
end else begin
(
...
in (let _146_1541 = (let _146_1540 = (let _146_1539 = (let _146_1533 = (let _146_1532 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_146_1532)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _146_1533 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _146_1538 = (let _146_1537 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _146_1536 = (let _146_1535 = (let _146_1534 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _146_1534))
in (_146_1535)::[])
in (_146_1537)::_146_1536))
in (_146_1539, _146_1538)))
in FStar_Syntax_Syntax.Tm_app (_146_1540))
in (FStar_Syntax_Syntax.mk _146_1541 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(let _146_1553 = (let _146_1552 = (let _146_1551 = (let _146_1543 = (let _146_1542 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_146_1542)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _146_1543 env c2_decl c2_decl.FStar_Syntax_Syntax.stronger))
in (let _146_1550 = (let _146_1549 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _146_1548 = (let _146_1547 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _146_1546 = (let _146_1545 = (let _146_1544 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _146_1544))
in (_146_1545)::[])
in (_146_1547)::_146_1546))
in (_146_1549)::_146_1548))
in (_146_1551, _146_1550)))
in FStar_Syntax_Syntax.Tm_app (_146_1552))
in (FStar_Syntax_Syntax.mk _146_1553 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r))
end
in (

let base_prob = (let _146_1555 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _146_1554 -> FStar_TypeChecker_Common.TProb (_146_1554)) _146_1555))
in (

let wl = (let _146_1559 = (let _146_1558 = (let _146_1557 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _146_1557 g))
in (FStar_All.pipe_left (fun _146_1556 -> Some (_146_1556)) _146_1558))
in (solve_prob orig _146_1559 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _146_1560 = (solve_prob orig None [] wl)
in (solve env _146_1560))
end else begin
(

let _55_3187 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1562 = (FStar_Syntax_Print.comp_to_string c1)
in (let _146_1561 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _146_1562 (rel_to_string problem.FStar_TypeChecker_Common.relation) _146_1561)))
end else begin
()
end
in (

let _55_3191 = (let _146_1564 = (FStar_TypeChecker_Normalize.ghost_to_pure env c1)
in (let _146_1563 = (FStar_TypeChecker_Normalize.ghost_to_pure env c2)
in (_146_1564, _146_1563)))
...
(let _146_1565 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _146_1565 wl))
end
...
(let _146_1566 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _146_1566 wl))
end
...
in (let _146_1569 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c2))
in {FStar_TypeChecker_Common.pid = _55_3245.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _55_3245.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _55_3245.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _146_1569; FStar_TypeChecker_Common.element = _55_3245.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _55_3245.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _55_3245.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _55_3245.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _55_3245.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _55_3245.FStar_TypeChecker_Common.rank}))
in (solve_c env _146_1570 wl))
end
...
(let _146_1571 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _146_1571 wl))
end else begin
(
...
| None -> begin
if (((FStar_Syntax_Util.is_ghost_effect c1.FStar_Syntax_Syntax.effect_name) && (FStar_Syntax_Util.is_pure_effect c2.FStar_Syntax_Syntax.effect_name)) && (let _146_1572 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Inline)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env c2.FStar_Syntax_Syntax.result_typ)
in (FStar_Syntax_Util.non_informative _146_1572))) then begin
(
...
(let _146_1577 = (let _146_1576 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _146_1575 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _146_1576 _146_1575)))
in (giveup env _146_1577 orig))
end
end
| Some (edge) -> begin
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _146_1581 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _55_3278 -> (match (_55_3278) with
| (_55_3268, _55_3270, u, _55_3273, _55_3275, _55_3277) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _146_1581 (FStar_String.concat ", "))))
...
let carry = (let _146_1587 = (FStar_List.map (fun _55_3293 -> (match (_55_3293) with
| (_55_3291, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _146_1587 (FStar_String.concat ",\n")))
in (
...
let _55_3327 = g
in (let _146_1607 = (let _146_1606 = (let _146_1605 = (let _146_1599 = (FStar_Syntax_Syntax.mk_binder x)
in (_146_1599)::[])
in (let _146_1604 = (let _146_1603 = (let _146_1602 = (let _146_1600 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _146_1600 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _146_1602 (fun _146_1601 -> FStar_Util.Inl (_146_1601))))
in Some (_146_1603))
in (FStar_Syntax_Util.abs _146_1605 f _146_1604)))
in (FStar_All.pipe_left (fun _146_1598 -> FStar_TypeChecker_Common.NonTrivial (_146_1598)) _146_1606))
in {FStar_TypeChecker_Env.guard_f = _146_1607; FStar_TypeChecker_Env.deferred = _55_3327.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3327.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3327.FStar_TypeChecker_Env.implicits}))
in Some (_146_1608)))
end))
...
let _55_3334 = g
in (let _146_1619 = (let _146_1618 = (let _146_1617 = (let _146_1616 = (let _146_1615 = (let _146_1614 = (FStar_Syntax_Syntax.as_arg e)
in (_146_1614)::[])
in (f, _146_1615))
in FStar_Syntax_Syntax.Tm_app (_146_1616))
in (FStar_Syntax_Syntax.mk _146_1617 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _146_1613 -> FStar_TypeChecker_Common.NonTrivial (_146_1613)) _146_1618))
in {FStar_TypeChecker_Env.guard_f = _146_1619; FStar_TypeChecker_Env.deferred = _55_3334.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3334.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3334.FStar_TypeChecker_Env.implicits}))
end))
...
(let _146_1626 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_146_1626))
end))
...
let _55_3384 = g
in (let _146_1664 = (let _146_1663 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _146_1663 (fun _146_1662 -> FStar_TypeChecker_Common.NonTrivial (_146_1662))))
in {FStar_TypeChecker_Env.guard_f = _146_1664; FStar_TypeChecker_Env.deferred = _55_3384.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3384.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _55_3384.FStar_TypeChecker_Env.implicits}))
end))
...
(let _146_1672 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _146_1671 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _146_1672 (rel_to_string rel) _146_1671)))
end else begin
"TOP"
end
in (
...
let x = (let _146_1683 = (let _146_1682 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _146_1681 -> Some (_146_1681)) _146_1682))
in (FStar_Syntax_Syntax.new_bv _146_1683 t1))
in (

let env = (FStar_TypeChecker_Env.push_bv env x)
in (

let p = (let _146_1687 = (let _146_1685 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _146_1684 -> Some (_146_1684)) _146_1685))
in (let _146_1686 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _146_1687 _146_1686)))
...
(let _146_1699 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _146_1699))
end else begin
()
end
in (err (d, s))))
...
(let _146_1704 = (FStar_Syntax_Print.term_to_string f)
...
(let _146_1705 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _146_1706 = (FStar_Syntax_Util.unmeta f)
in _146_1706.FStar_Syntax_Syntax.n)) with
...
| Some (d) -> begin
(let _146_1718 = (let _146_1717 = (let _146_1716 = (let _146_1715 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _146_1715 (fun _146_1714 -> FStar_TypeChecker_Common.NonTrivial (_146_1714))))
in {FStar_TypeChecker_Env.guard_f = _146_1716; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _146_1717))
in (FStar_All.pipe_left (fun _146_1713 -> Some (_146_1713)) _146_1718))
end))
...
(let _146_1726 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1725 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _146_1729 = (let _146_1728 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _146_1728))
in (FStar_All.pipe_left (fun _146_1727 -> FStar_TypeChecker_Common.TProb (_146_1727)) _146_1729))
in (

let g = (let _146_1731 = (solve_and_commit env (singleton env prob) (fun _55_3450 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1731))
in g))))
...
| None -> begin
(let _146_1741 = (let _146_1740 = (let _146_1739 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _146_1738 = (FStar_TypeChecker_Env.get_range env)
in (_146_1739, _146_1738)))
in FStar_Syntax_Syntax.Error (_146_1740))
in (Prims.raise _146_1741))
end
| Some (g) -> begin
(

let _55_3459 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _146_1744 = (FStar_Syntax_Print.term_to_string t1)
in (let _146_1743 = (FStar_Syntax_Print.term_to_string t2)
in (let _146_1742 = (guard_to_string env g)
in (FStar_Util.print3 "teq of %s and %s succeeded with guard %s\n" _146_1744 _146_1743 _146_1742))))
end else begin
()
end
in g)
...
(let _146_1754 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _146_1753 = (FStar_TypeChecker_Normalize.term_to_string env t2)
...
let g = (let _146_1756 = (solve_and_commit env (singleton' env prob smt_ok) (fun _55_3471 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1756))
in (
...
(let _146_1760 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _146_1759 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _146_1758 = (let _146_1757 = (FStar_Util.must g)
in (guard_to_string env _146_1757))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _146_1760 _146_1759 _146_1758))))
end else begin
()
end
...
let subtype_fail : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ  ->  Prims.unit = (fun env t1 t2 -> (let _146_1774 = (FStar_TypeChecker_Env.get_range env)
in (let _146_1773 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (FStar_TypeChecker_Errors.report _146_1774 _146_1773))))
...
(let _146_1782 = (FStar_Syntax_Print.comp_to_string c1)
in (let _146_1781 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _146_1785 = (let _146_1784 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _146_1784 "sub_comp"))
in (FStar_All.pipe_left (fun _146_1783 -> FStar_TypeChecker_Common.CProb (_146_1783)) _146_1785))
in (let _146_1787 = (solve_and_commit env (singleton env prob) (fun _55_3489 -> None))
in (FStar_All.pipe_left (with_guard env prob) _146_1787))))))
...
in (let _146_1805 = (let _146_1804 = (let _146_1803 = (let _146_1801 = (FStar_Syntax_Print.univ_to_string u1)
in (let _146_1800 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _146_1801 _146_1800 msg)))
in (let _146_1802 = (FStar_TypeChecker_Env.get_range env)
in (_146_1803, _146_1802)))
in FStar_Syntax_Syntax.Error (_146_1804))
in (Prims.raise _146_1805)))))
in (
...
(let _146_1817 = (insert uv u1 out)
in (group_by _146_1817 rest))
end)
end
| _55_3529 -> begin
None
...
(let _146_1838 = (wl_to_string wl)
in (let _146_1837 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
(let _146_1855 = (FStar_TypeChecker_Env.get_range env)
in (let _146_1854 = (let _146_1853 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _146_1853))
in (FStar_TypeChecker_Errors.diag _146_1855 _146_1854)))
end else begin
()
end
...
(let _146_1871 = (FStar_Syntax_Print.uvar_to_string u)
in (let _146_1870 = (FStar_Syntax_Print.term_to_string tm)
in (let _146_1869 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _146_1871 _146_1870 _146_1869))))
end else begin
()
end
in (
...
let _55_3679 = g
in (let _146_1875 = (until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _55_3679.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _55_3679.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _55_3679.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _146_1875})))))


let force_trivial_guard : FStar_TypeChecker_Env.env  ->  FStar_TypeChecker_Env.guard_t  ->  Prims.unit = (fun env g -> (

let g = (let _146_1880 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _146_1880 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _146_1881 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _146_1881))
end
| ((reason, _55_3689, _55_3691, e, t, r))::_55_3686 -> begin
(let _146_1884 = (let _146_1883 = (FStar_Syntax_Print.term_to_string t)
in (let _146_1882 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format3 "Failed to resolve implicit argument of type \'%s\' introduced in %s because %s" _146_1883 _146_1882 reason)))
in (FStar_TypeChecker_Errors.report r _146_1884))
end)))
