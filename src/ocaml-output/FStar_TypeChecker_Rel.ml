...
let (force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____30135 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____30135 (resolve_implicits env)  in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____30136 = discharge_guard env g1  in
          FStar_All.pipe_left (fun a2  -> ()) uu____30136
      | imp::uu____30138 ->
          let uu____30141 =
            let uu____30147 =
              let uu____30149 =
              ...
              FStar_Util.format3
                ...
                uu____30149 uu____30151 imp.FStar_TypeChecker_Env.imp_reason
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____30147)
             in
          FStar_Errors.raise_error uu____30141
...
let (teq_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30173 = teq_nosmt env t1 t2  in
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___4101_30192 = FStar_TypeChecker_Env.trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___4101_30192.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___4101_30192.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___4101_30192.FStar_TypeChecker_Env.implicits)
      }
             ...
             let g =
               let uu____30259 =
                 solve_and_commit env (singleton wl prob true)
                  ...
                  in
               FStar_All.pipe_left (with_guard env prob) uu____30259  in
             ((let uu____30291 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____30298 =
                   FStar_TypeChecker_Normalize.term_to_string env t2  in
                 let uu____30300 =
                   let uu____30302 = FStar_Util.must g  in
                   guard_to_string env uu____30302  in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____30296 uu____30298 uu____30300
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
...
let (get_subtyping_predicate :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30339 = check_subtyping env t1 t2  in
        match uu____30339 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____30358 =
              let uu____30359 = FStar_Syntax_Syntax.mk_binder x  in
              FStar_TypeChecker_Env.abstract_guard uu____30359 g  in
...
let (get_subtyping_prop :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30378 = check_subtyping env t1 t2  in
        match uu____30378 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____30397 =
              let uu____30398 =
                let uu____30399 = FStar_Syntax_Syntax.mk_binder x  in
                [uu____30399]  in
              FStar_TypeChecker_Env.close_guard env uu____30398 g  in
            FStar_Pervasives_Native.Some uu____30397
             ...
             let g =
               let uu____30464 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____30475  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____30464  in
             (match g with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____30499 =
                      let uu____30500 = FStar_Syntax_Syntax.mk_binder x  in
                      [uu____30500]  in
                    FStar_TypeChecker_Env.close_guard env uu____30499 g1  in
...
let (subtype_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30541 = subtype_nosmt env t1 t2  in
