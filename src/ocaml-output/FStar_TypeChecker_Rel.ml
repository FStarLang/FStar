...
let discharge_guard :
  ...
  fun env  ->
    fun g  ->
      let gs = guard_to_string env g  in
      let uu____12734 = discharge_guard' None env g true  in
    ...
    let rec until_fixpoint acc implicits =
      ...
      | (out,changed) ->
          (match implicits with
           ...
           | hd1::tl1 ->
               let uu____12824 = hd1  in
               (match uu____12824 with
                | (uu____12831,env,u,tm,k,r) ->
                    let uu____12837 = unresolved u  in
                    if uu____12837
                       ...
                       (let uu____12855 =
                        ...
                        then
                          ...
                          FStar_Util.print3
                            ...
                            uu____12856 uu____12860 uu____12861
                        else ());
                       (let uu____12863 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___183_12867 = env1  in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___183_12867.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___183_12867.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___183_12867.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___183_12867.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___183_12867.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___183_12867.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___183_12867.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___183_12867.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___183_12867.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___183_12867.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___183_12867.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___183_12867.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___183_12867.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___183_12867.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___183_12867.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___183_12867.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___183_12867.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___183_12867.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___183_12867.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___183_12867.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___183_12867.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___183_12867.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___183_12867.FStar_TypeChecker_Env.qname_and_index)
                             }) tm1
                           in
                        match uu____12863 with
                        | (uu____12868,uu____12869,g1) ->
                            let g2 =
                              if env1.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___184_12872 = g1  in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___184_12872.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___184_12872.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___184_12872.FStar_TypeChecker_Env.implicits)
                                }
                              else g1  in
                            let g' =
                              let uu____12875 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1))))
       in
    let uu___185_12894 = g  in
    let uu____12895 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits  in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___185_12894.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___185_12894.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___185_12894.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____12895
    }
...
let force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____12923 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____12923 resolve_implicits  in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____12930 = discharge_guard env g1  in
          FStar_All.pipe_left Prims.ignore uu____12930
      | (reason,uu____12932,uu____12933,e,t,r)::uu____12937 ->
          let uu____12951 =
            let uu____12952 = FStar_Syntax_Print.term_to_string t  in
            let uu____12953 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____12952 uu____12953 reason
             in
          FStar_Errors.err r uu____12951
...
let universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___186_12960 = trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___186_12960.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___186_12960.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___186_12960.FStar_TypeChecker_Env.implicits)
      }
...
let teq_nosmt :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____12978 = try_teq false env t1 t2  in
        match uu____12978 with
        | None  -> false
        | Some g ->
            let uu____12981 = discharge_guard' None env g false  in
            (match uu____12981 with
             | Some uu____12985 -> true
             | None  -> false)
