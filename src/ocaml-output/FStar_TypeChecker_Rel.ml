        ...
        fun t2 ->
          let maybe_inline t =
            ...
            (let uu____7813 =
             ...
             | uu____7882 -> FStar_Pervasives_Native.None) in
          ...
          let rec aux retry n_delta t11 t21 =
            ...
            (let reduce_one_and_try_again d1 d2 =
             ...
             let reduce_both_and_try_again d r1 =
               let uu____8119 = FStar_TypeChecker_Common.decr_delta_depth d in
             ...
             | MisMatch
                 (FStar_Pervasives_Native.Some
                  (FStar_Syntax_Syntax.Delta_equational_at_level uu____8157),
                  uu____8158)
                 ->
             ...
             | uu____8332 -> success n_delta r t11 t21) in
                  ...
                  FStar_All.pipe_right uu____8381
                    (fun uu____8416 ->
                       ...
                       | (t11, t21) ->
                           ...
                           Prims.op_Hat uu____8424 uu____8426)) in
                ...
                | (rh, rhs_args) ->
                    let uu____8659 =
                      ...
                      | (FStar_Syntax_Syntax.Tm_uvar uu____8672,
                         FStar_Syntax_Syntax.Tm_uvar uu____8673) ->
                      ...
                      | (uu____8805, FStar_Syntax_Syntax.Tm_uvar uu____8806)
                          ...
                          tp.FStar_TypeChecker_Common.relation =
                            FStar_TypeChecker_Common.EQ
                          -> (FStar_TypeChecker_Common.Flex_rigid_eq, tp)
                      | (FStar_Syntax_Syntax.Tm_uvar uu____8821,
                      ...
                      | (FStar_Syntax_Syntax.Tm_uvar uu____8855,
                         FStar_Syntax_Syntax.Tm_type uu____8856) ->
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                      ...
                      | (FStar_Syntax_Syntax.Tm_type uu____8875,
                         FStar_Syntax_Syntax.Tm_uvar uu____8876) ->
                          (FStar_TypeChecker_Common.Flex_rigid_eq,
                     ...
                     | (rank, tp1) ->
                         let uu____8957 =
                           FStar_All.pipe_right
                             ...
                             (fun _8964 ->
                                FStar_TypeChecker_Common.TProb _8964) in
                         (rank, uu____8957))))
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____8968 =
            FStar_All.pipe_right
              (let uu___1279_8972 = cp in
               ...
               }) (fun _8975 -> FStar_TypeChecker_Common.CProb _8975) in
                      ...
                      (let uu____9198 =
                         (min_rank = FStar_Pervasives_Native.None) ||
                           (let uu____9203 = FStar_Option.get min_rank in
                            rank_less_than rank1 uu____9203) in
                       if uu____9198
                       then
                         match min1 with
                         | FStar_Pervasives_Native.None ->
    ...
    fun wl ->
      fun u1 ->
        fun u2 ->
                     ...
                     (fun u3 ->
                        ...
                        | (k, uu____9564) ->
                            (match k with
                             ...
                             | uu____9577 -> false)))
            | uu____9579 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u]) in
                          ...
                          FStar_All.pipe_right u22
                            (FStar_List.existsML
                               (fun uv2 ->
                                  ...
                                  uu____9639 = (Prims.parse_int "0"))) in
                        if uu____9631 then uv1 :: uvs else uvs) []) in
            let filter1 =
              FStar_List.filter
                (fun u ->
                   let uu____9660 =
                     FStar_All.pipe_right common_elts
                       (FStar_List.existsML
                          (fun u' ->
                             ...
                             uu____9668 = (Prims.parse_int "0"))) in
                   Prims.op_Negation uu____9660) in
          ...
          let try_umax_components u12 u22 msg =
            ...
            then UFailed "Unable to unify universe terms with umax"
              ...
              (match (u12, u22) with
               ...
               | uu____9843 ->
                   let uu____9848 =
                     let uu____9850 = FStar_Syntax_Print.univ_to_string u12 in
                     let uu____9852 = FStar_Syntax_Print.univ_to_string u22 in
                     FStar_Util.format3
                       "Unable to unify universes: %s and %s (%s)" uu____9850
                       uu____9852 msg in
                   UFailed uu____9848) in
          match (u11, u21) with
              ...
              then
                let uu____9938 =
                  ...
                  FStar_Util.format2 "Failed occurs check: %s occurs in %s"
                    uu____9940 uu____9942 in
                try_umax_components u11 u21 uu____9938
              else
                (let uu____9947 = extend_solution pid_orig [UNIV (v1, u3)] wl in
                 USolved uu____9947)
          | (u, FStar_Syntax_Syntax.U_unif v1) ->
              ...
              then
                let uu____9962 =
                  ...
                  FStar_Util.format2 "Failed occurs check: %s occurs in %s"
                    uu____9964 uu____9966 in
                try_umax_components u11 u21 uu____9962
              else
                (let uu____9971 = extend_solution pid_orig [UNIV (v1, u3)] wl in
                 USolved uu____9971)
          ...
          | (FStar_Syntax_Syntax.U_succ uu____10002,
             FStar_Syntax_Syntax.U_zero) -> UFailed "Incompatible universes"
          | (FStar_Syntax_Syntax.U_succ uu____10004,
             FStar_Syntax_Syntax.U_name uu____10005) ->
              UFailed "Incompatible universes"
          | (FStar_Syntax_Syntax.U_zero, FStar_Syntax_Syntax.U_succ
             uu____10007) -> UFailed "Incompatible universes"
          | (FStar_Syntax_Syntax.U_zero, FStar_Syntax_Syntax.U_name
             uu____10009) -> UFailed "Incompatible universes"
          | (FStar_Syntax_Syntax.U_name uu____10011,
             FStar_Syntax_Syntax.U_succ uu____10012) ->
              UFailed "Incompatible universes"
          | (FStar_Syntax_Syntax.U_name uu____10014,
             FStar_Syntax_Syntax.U_zero) -> UFailed "Incompatible universes"
          ...
          fun t2 ->
            let has_type_guard t11 t21 =
              ...
              | FStar_Pervasives_Native.None ->
                  ...
                  FStar_Syntax_Util.mk_forall u_x x uu____10448 in
...
let (quasi_pattern :
  ...
  fun env ->
    fun f ->
      ...
      | (uu____10535,
         { FStar_Syntax_Syntax.ctx_uvar_head = uu____10536;
           FStar_Syntax_Syntax.ctx_uvar_gamma = uu____10537;
           FStar_Syntax_Syntax.ctx_uvar_binders = ctx;
           FStar_Syntax_Syntax.ctx_uvar_typ = t_hd;
           FStar_Syntax_Syntax.ctx_uvar_reason = uu____10540;
           FStar_Syntax_Syntax.ctx_uvar_should_check = uu____10541;
           FStar_Syntax_Syntax.ctx_uvar_range = uu____10542;
           FStar_Syntax_Syntax.ctx_uvar_meta = uu____10543;_},
         args) ->
          let name_exists_in x bs =
            FStar_Util.for_some
              (fun uu____10613 ->
                 match uu____10613 with
                 | (y, uu____10622) -> FStar_Syntax_Syntax.bv_eq x y) bs in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____11702 ->
                          ...
                          | (c, uu____11713, uu____11714) -> c < probs.ctr)) in
                              ...
                              FStar_All.pipe_right attempt1
                                (FStar_List.map
                                   (fun uu____11850 ->
                                      ...
                                      | (uu____11859, uu____11860, y) -> y)) in
                            {
        ...
        fun t2 ->
          fun wl ->
            let rec aux wl1 us1 us2 =
              ...
              | ([], []) -> USolved wl1
              | (u1::us11, u2::us21) ->
                  let uu____11927 = solve_universe_eq (p_pid orig) wl1 u1 u2 in
            ...
            | (FStar_Syntax_Syntax.Tm_uinst
               ...
               ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar g;
                  ...
                  FStar_Syntax_Syntax.vars = uu____11948;_},
                us2)) ->
                        ...
                        (match uu____13240 with
                         | (out1, probs', wl3) ->
                             aux
                               ...
                               ts2)) in
             let uu____13276 =
               let uu____13287 = FStar_List.hd ts in (uu____13287, [], wl1) in
                ...
                | uu____13400 ->
                    ((let uu____13402 =
                     ...
                     (let uu____13412 =
                      ...
                      | (u, _args) ->
                          let uu____13455 =
                            let uu____13456 = FStar_Syntax_Subst.compress u in
                          ...
                          (match uu____13455 with
                           | FStar_Syntax_Syntax.Tm_uvar (ctx_uvar, _subst)
                               ...
                               (match uu____13553 with
                                | (bounds_probs, rest) ->
                                    let bounds_typs =
                                      let uu____13609 = whnf env this_rigid in
                                      let uu____13610 =
                                        FStar_List.collect
                                          (fun uu___27_13616 ->
                                             ...
                                             let uu____13675 =
                                               let uu____13676 =
                                                 FStar_Syntax_Subst.compress
                                                   bound in
                                               uu____13676.FStar_Syntax_Syntax.n in
                                         ...
                                         let uu____14374 =
                                           let uu____14381 =
                                             ...
                                             FStar_All.pipe_left
                                               ...
                                               uu____14384 in
                                           copy_uvar u_lhs [] uu____14381 wl2 in
                            ...
                            (match uu____14197 with
                             | (out_args, wl2) ->
                                 let ct' =
                                   ...
                                   let uu____14492 =
                                     let uu____14495 = FStar_List.hd out_args in
                                     FStar_Pervasives_Native.fst uu____14495 in
                                   let uu____14510 = FStar_List.tl out_args in
                                   {
                       ...
                       | (formals, c) ->
                                           ...
                                           let uu____14624 =
                                             let uu____14625 =
                                               solve_prob orig
                                                 FStar_Pervasives_Native.None
                                                 [sol] wl3 in
                                             attempt [sub_prob] uu____14625 in
                           ...
                           (match uu____14716 with
                            | (uu____14729, occurs_ok, msg) ->
                                ...
                                then
                                  let uu____14745 =
                                    let uu____14747 = FStar_Option.get msg in
                     ...
                     (match uu____14915 with
                      | (rhs_prob, wl2) ->
                          ((let uu____14936 =
                            ...
                            if uu____14936
                            then
                              let uu____14941 = prob_to_string env1 rhs_prob in
                              FStar_Util.print1 "rhs_prob = %s\n" uu____14941
                            else ());
                           (let formula = p_guard rhs_prob in
                            ((FStar_Util.Inl ([rhs_prob], formula)), wl2))))
                 | ((hd1, imp)::xs1, (hd2, imp')::ys1) when
                     let uu____15019 = FStar_Syntax_Util.eq_aqual imp imp' in
        ...
        fun lhs ->
          fun rhs ->
            let binders_as_bv_set bs =
              let uu____15344 = FStar_List.map FStar_Pervasives_Native.fst bs in
                              ...
                              let uu____15801 =
                                let uu____15808 =
                                  let uu____15811 =
                                    FStar_Syntax_Util.type_u () in
                                  FStar_All.pipe_left
                                    FStar_Pervasives_Native.fst uu____15811 in
                                      ...
                                      let uu____15849 =
                                        let uu____15858 =
                                          FStar_Syntax_Syntax.null_binder
                                            t_last_arg in
                                        [uu____15858] in
                                      FStar_List.append bs_lhs uu____15849 in
                                    copy_uvar u_lhs uu____15848 t_res_lhs wl2 in
                     ...
                     then
                       ...
                       (let uu____16197 =
                          ...
                          FStar_Util.format1
                            ...
                            uu____16199 in
                        giveup_or_defer env1 orig1 wl1 uu____16197)) in
                     ...
                     (match uu____16214 with
                      | FStar_Pervasives_Native.Some lhs_binders ->
                          ...
                          let names_to_string1 fvs =
                            let uu____16232 =
                              let uu____16236 = FStar_Util.set_elements fvs in
                      ...
                      FStar_Pervasives_Native.Some (binders_rhs, t_res_rhs))
                       ...
                       (match uu____16470 with
                        | ({ FStar_Syntax_Syntax.n = uu____16471;
                             ...
                             FStar_Syntax_Syntax.vars = uu____16473;_},
                           u_lhs, uu____16475) ->
                     ...
                     then
                       let uu____16906 =
                         ...
                         FStar_Util.format4
                           ...
                           uu____16908 uu____16910 uu____16914 uu____16916 in
                       ...
                       (let uu____16923 =
                          (nargs = (Prims.parse_int "0")) ||
                            (let uu____16928 =
                             ...
                             uu____16928 = FStar_Syntax_Util.Equal) in
                        if uu____16923
                        then
                          (if need_unif
                           then
                          ...
                          (let uu____16947 = base_and_refinement env1 t1 in
                           ...
                           | (base1, refinement1) ->
                               let uu____16972 = base_and_refinement env1 t2 in
                             ...
                             fun x ->
                               ...
                               | (subst1, wl3) ->
                                   let t_x =
                                     FStar_Syntax_Subst.subst subst1
                                       x.FStar_Syntax_Syntax.sort in
                                   let uu____17849 = copy_uvar uv [] t_x wl3 in
                ...
                (let uu____17975 =
                          ...
                          (let pat_discriminates uu___28_18210 =
                             ...
                             | ({
                                  FStar_Syntax_Syntax.v =
                                    ...
                                    uu____18226;
                                  FStar_Syntax_Syntax.p = uu____18227;_},
                                FStar_Pervasives_Native.None, uu____18228) ->
                                 true
                             | ({
                                  FStar_Syntax_Syntax.v =
                                    FStar_Syntax_Syntax.Pat_cons uu____18242;
                                  FStar_Syntax_Syntax.p = uu____18243;_},
                                FStar_Pervasives_Native.None, uu____18244) ->
                                 true
                    ...
                    (uu____18905,
                     {
                       ...
                       FStar_Syntax_Syntax.vars = uu____18909;_}))
                     ->
                     let uu____18978 =
                          ...
                          (let pat_discriminates uu___28_19062 =
                             ...
                             | ({
                                  FStar_Syntax_Syntax.v =
                                    FStar_Syntax_Syntax.Pat_constant
                                    uu____19078;
                                  FStar_Syntax_Syntax.p = uu____19079;_},
                                FStar_Pervasives_Native.None, uu____19080) ->
                                 true
                             | ({
                                  FStar_Syntax_Syntax.v =
                                    FStar_Syntax_Syntax.Pat_cons uu____19094;
                                  FStar_Syntax_Syntax.p = uu____19095;_},
                                FStar_Pervasives_Native.None, uu____19096) ->
                                 true
                 ...
                 | uu____19755 ->
                     ((let uu____19777 =
                       ...
                       if uu____19777
                       then
                         let uu____19782 = FStar_Syntax_Print.tag_of_term t1 in
                         let uu____19784 = FStar_Syntax_Print.tag_of_term t2 in
                         FStar_Util.print2
                ...
                (match (m, o) with
                 | (MisMatch uu____19877, uu____19878) ->
                     let rec may_relate head3 =
                       let uu____19906 =
                         let uu____19907 = FStar_Syntax_Subst.compress head3 in
                 ...
                 | (HeadMatch (true), uu____20080) when
                     ...
                     if wl1.smt_ok
                     then
                       let uu____20095 = guard_of_prob env1 wl1 problem t1 t2 in
          ...
          then
            ...
            (let t1 = problem.FStar_TypeChecker_Common.lhs in
             ...
             (let r = FStar_TypeChecker_Env.get_range env in
              ...
              | (FStar_Syntax_Syntax.Tm_quoted (t11, uu____20369),
                 FStar_Syntax_Syntax.Tm_quoted (t21, uu____20371)) ->
                  let uu____20380 =
                    solve_prob orig FStar_Pervasives_Native.None [] wl in
                 ...
                 FStar_Syntax_Syntax.Tm_arrow (bs2, c2)) ->
                  let mk_c c uu___29_20455 =
                    ...
                    | bs ->
                        ...
                        FStar_Syntax_Syntax.mk_Total uu____20483 in
                  let uu____20494 =
                                  ...
                                  (let uu____21723 =
                                   ...
                                   | (base_prob, wl1) ->
                                       ...
                                       let mk_imp1 imp phi13 phi23 =
                                         let uu____21794 = imp phi13 phi23 in
                                       ...
                                       let fallback uu____21806 =
                                         ...
                                         (let uu____21819 =
                                            let uu____21822 = p_scope orig in
                                            FStar_List.map
                                              FStar_Pervasives_Native.fst
                                              uu____21822 in
                                          FStar_TypeChecker_Env.def_check_closed_in
                                            ...
                                            (p_guard base_prob));
                                         (let uu____21841 =
                                            let uu____21844 = p_scope orig in
                                            FStar_List.map
                                              FStar_Pervasives_Native.fst
                                              uu____21844 in
                                          FStar_TypeChecker_Env.def_check_closed_in
                                         ...
                                         (let uu____21868 =
                                          ...
                                          Prims.op_Negation uu____21868) ||
                                           (let uu____21874 =
                                              ...
                                              FStar_Util.set_is_empty
                                                uu____21876 in
                                            Prims.op_Negation uu____21874) in
                                       if
                                         (problem.FStar_TypeChecker_Common.relation
                                            = FStar_TypeChecker_Common.EQ)
                                           ||
              ...
              | (FStar_Syntax_Syntax.Tm_uvar uu____21957,
                 FStar_Syntax_Syntax.Tm_uvar uu____21958) ->
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____21999;_},
                  uu____22000),
                 FStar_Syntax_Syntax.Tm_uvar uu____22001) ->
                  ...
                  (match uu____22050 with
                   | (f1, wl1) ->
                       ...
                       (match uu____22057 with
                        | (f2, wl2) -> solve_t_flex_flex env orig wl2 f1 f2))
              | (FStar_Syntax_Syntax.Tm_uvar uu____22064,
                 FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                      uu____22065;
                    FStar_Syntax_Syntax.pos = uu____22066;
                    FStar_Syntax_Syntax.vars = uu____22067;_},
                  uu____22068)) ->
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22133;_},
                  uu____22134),
                 FStar_Syntax_Syntax.Tm_app
                 ({
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                    ...
                    FStar_Syntax_Syntax.vars = uu____22137;_},
                  uu____22138)) ->
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22248;_},
                  uu____22249),
                 uu____22250) when
                  problem.FStar_TypeChecker_Common.relation =
                    FStar_TypeChecker_Common.EQ
              ...
              | (uu____22308, FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22311;_},
                  uu____22312)) when
                  problem.FStar_TypeChecker_Common.relation =
                    FStar_TypeChecker_Common.EQ
                  -> solve_t env (invert problem) wl
              | (FStar_Syntax_Syntax.Tm_uvar uu____22349,
                 FStar_Syntax_Syntax.Tm_arrow uu____22350) ->
                  solve_t' env
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22381;_},
                  uu____22382),
                 FStar_Syntax_Syntax.Tm_arrow uu____22383) ->
                  solve_t' env
              ...
              | (uu____22451, FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22454;_},
                  uu____22455)) ->
                  let uu____22492 =
                    attempt [FStar_TypeChecker_Common.TProb problem] wl in
              ...
              | (FStar_Syntax_Syntax.Tm_app
                 ({
                    ...
                    FStar_Syntax_Syntax.vars = uu____22510;_},
                  uu____22511),
                 uu____22512) ->
                  let uu____22549 =
                    attempt [FStar_TypeChecker_Common.TProb problem] wl in
                      ...
                      (let uu____23835 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____23835) &&
                        (let uu____23839 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____23839) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____23869 =
                          ...
                          | (guard, wl1) ->
                              let uu____23910 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____24036 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____24036) &&
                        (let uu____24040 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____24040) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____24070 =
                          ...
                          | (guard, wl1) ->
                              let uu____24111 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____24231 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____24231) &&
                        (let uu____24235 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____24235) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____24265 =
                          ...
                          | (guard, wl1) ->
                              let uu____24306 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____24426 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____24426) &&
                        (let uu____24430 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____24430) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____24460 =
                          ...
                          | (guard, wl1) ->
                              let uu____24501 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____24621 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____24621) &&
                        (let uu____24625 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____24625) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____24655 =
                          ...
                          | (guard, wl1) ->
                              let uu____24696 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____24832 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____24832) &&
                        (let uu____24836 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____24836) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____24866 =
                          ...
                          | (guard, wl1) ->
                              let uu____24907 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25049 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25049) &&
                        (let uu____25053 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25053) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____25083 =
                          ...
                          | (guard, wl1) ->
                              let uu____25124 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25238 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25238) &&
                        (let uu____25242 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25242) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____25272 =
                          ...
                          | (guard, wl1) ->
                              let uu____25313 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25421 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25421) &&
                        (let uu____25425 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25425) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____25455 =
                          ...
                          | (guard, wl1) ->
                              let uu____25496 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25604 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25604) &&
                        (let uu____25608 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25608) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____25638 =
                          ...
                          | (guard, wl1) ->
                              let uu____25679 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25787 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25787) &&
                        (let uu____25791 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25791) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____25821 =
                          ...
                          | (guard, wl1) ->
                              let uu____25862 = solve_prob orig guard [] wl1 in
                      ...
                      (let uu____25986 = FStar_Syntax_Free.uvars t in
                       FStar_Util.set_is_empty uu____25986) &&
                        (let uu____25990 = FStar_Syntax_Free.univs t in
                         FStar_Util.set_is_empty uu____25990) in
                    let equal t11 t21 =
                      let t12 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.UnfoldUntil
                      ...
                      (if Prims.op_Negation wl.smt_ok
                       then
                         ...
                         (let uu____26020 =
                          ...
                          | (guard, wl1) ->
                              let uu____26061 = solve_prob orig guard [] wl1 in
                              solve env uu____26061))
                    else rigid_rigid_delta env problem wl head1 head2 t1 t2))
              | (FStar_Syntax_Syntax.Tm_let uu____26064,
                 FStar_Syntax_Syntax.Tm_let uu____26065) ->
              ...
              | (FStar_Syntax_Syntax.Tm_let uu____26099, uu____26100) ->
                  let uu____26114 =
                    let uu____26120 =
                      ...
                      let uu____26126 = FStar_Syntax_Print.term_to_string t1 in
                      let uu____26128 = FStar_Syntax_Print.term_to_string t2 in
                      FStar_Util.format4
                        "Internal error: unexpected flex-flex of %s and %s\n>>> (%s) -- (%s)"
                        uu____26122 uu____26124 uu____26126 uu____26128 in
              ...
              | (uu____26132, FStar_Syntax_Syntax.Tm_let uu____26133) ->
                  let uu____26147 =
                    let uu____26153 =
                      ...
                      let uu____26159 = FStar_Syntax_Print.term_to_string t1 in
                      let uu____26161 = FStar_Syntax_Print.term_to_string t2 in
                      FStar_Util.format4
                        "Internal error: unexpected flex-flex of %s and %s\n>>> (%s) -- (%s)"
                        uu____26155 uu____26157 uu____26159 uu____26161 in
                    (FStar_Errors.Fatal_UnificationNotWellFormed,
                      uu____26153) in
              ...
              let uu____26507 =
                let uu____26516 =
                  ...
                  (edge.FStar_TypeChecker_Env.mlift).FStar_TypeChecker_Env.mlift_wp
                    uu____26517 c11.FStar_Syntax_Syntax.result_typ wp in
               ...
               FStar_All.pipe_right c21.FStar_Syntax_Syntax.flags
                 (FStar_Util.for_some
                    (fun uu___31_26544 ->
                       ...
                       | uu____26549 -> false)) in
             let uu____26551 =
               match ((c11.FStar_Syntax_Syntax.effect_args),
                       (c21.FStar_Syntax_Syntax.effect_args))
               with
               | ((wp1, uu____26581)::uu____26582,
                  (wp2, uu____26584)::uu____26585) -> (wp1, wp2)
               | uu____26658 ->
                   let uu____26683 =
                     let uu____26689 =
                       let uu____26691 =
                       ...
                       FStar_Util.format2
                         ...
                         uu____26691 uu____26693 in
                     (FStar_Errors.Fatal_ExpectNormalizedEffect, uu____26689) in
                          ...
                          let c1_repr =
                            let uu____26747 =
                              ...
                              FStar_TypeChecker_Env.reify_comp env
                                uu____26748 uu____26750 in
                            FStar_TypeChecker_Normalize.normalize
                              [FStar_TypeChecker_Env.UnfoldUntil
                                 FStar_Syntax_Syntax.delta_constant;
                              FStar_TypeChecker_Env.Weak;
                              FStar_TypeChecker_Env.HNF] env uu____26747 in
                          let c2_repr =
                            let uu____26752 =
                              let uu____26753 =
                          ...
                          let uu____26755 =
                            let uu____26760 =
                              ...
                              FStar_Util.format2 "sub effect repr: %s <: %s"
                                uu____26762 uu____26764 in
                            sub_prob wl c1_repr
                              problem.FStar_TypeChecker_Common.relation
                              c2_repr uu____26760 in
                                  ...
                                  (let c1_univ =
                                   ...
                                   let uu____26794 =
                                     let uu____26801 =
                                       ...
                                       FStar_Syntax_Syntax.Tm_app uu____26802 in
                                 ...
                                 (let c1_univ =
                                  ...
                                  let uu____26911 =
                                    let uu____26918 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_app uu____26919 in
                                    FStar_Syntax_Syntax.mk uu____26918 in
                                  uu____26911 FStar_Pervasives_Native.None r) in
                           (let uu____27053 =
                              FStar_All.pipe_left
                                (FStar_TypeChecker_Env.debug env)
                                (FStar_Options.Other "Rel") in
                            ...
                            then
                              let uu____27058 =
                                ...
                                FStar_Syntax_Print.term_to_string uu____27060 in
                              FStar_Util.print1
           ...
           (let uu____27100 =
            ...
            | (c11, c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 with
                 | (FStar_Syntax_Syntax.GTotal (t1, uu____27130),
                    FStar_Syntax_Syntax.Total (t2, uu____27132)) when
                 ...
                 | (FStar_Syntax_Syntax.GTotal uu____27151,
                    FStar_Syntax_Syntax.Total uu____27152) ->
                     giveup env "incompatible monad ordering: GTot </: Tot"
                       orig
                 | (FStar_Syntax_Syntax.Total (t1, uu____27171),
                    FStar_Syntax_Syntax.Total (t2, uu____27173)) ->
                     let uu____27190 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____27190 wl
                 | (FStar_Syntax_Syntax.GTotal (t1, uu____27193),
                    FStar_Syntax_Syntax.GTotal (t2, uu____27195)) ->
                     let uu____27212 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____27212 wl
                 | (FStar_Syntax_Syntax.Total (t1, uu____27215),
                    FStar_Syntax_Syntax.GTotal (t2, uu____27217)) ->
                     let uu____27234 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____27234 wl
                 | (FStar_Syntax_Syntax.GTotal uu____27236,
                    FStar_Syntax_Syntax.Comp uu____27237) ->
                     let uu____27246 =
                 ...
                 | (FStar_Syntax_Syntax.Total uu____27254,
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27272,
                    FStar_Syntax_Syntax.GTotal uu____27273) ->
                     let uu____27282 =
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27290,
                    FStar_Syntax_Syntax.Total uu____27291) ->
                     let uu____27300 =
                 ...
                 | (FStar_Syntax_Syntax.Comp uu____27308,
                    FStar_Syntax_Syntax.Comp uu____27309) ->
                     let uu____27310 =
        ...
        FStar_All.pipe_right (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu____27475 ->
                ...
                | (u1, u2) ->
                    let uu____27483 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____27485 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____27483 uu____27485)) in
               ...
               | Success (deferred, implicits) ->
                   let uu____27876 =
                     FStar_Util.record_time
                       (fun uu____27883 -> FStar_Syntax_Unionfind.commit tx) in
                   (match uu____27876 with
                    | ((), ms1) ->
                        ((let uu____27894 =
                          ...
                          if uu____27894
                          then
                            let uu____27899 = FStar_Util.string_of_int ms1 in
    ...
    fun prob ->
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some (deferred, implicits) ->
              ...
              let uu____28032 =
                let uu____28033 =
                  FStar_All.pipe_right (p_guard prob)
                    (fun _28034 -> FStar_TypeChecker_Common.NonTrivial _28034) in
                {
            ...
            FStar_All.pipe_left
              (fun _28041 -> FStar_Pervasives_Native.Some _28041) uu____28031
      ...
      fun dopt ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____28074 =
              let uu____28075 =
                FStar_All.pipe_right (p_guard prob)
                  (fun _28076 -> FStar_TypeChecker_Common.NonTrivial _28076) in
              {
              ...
              (let uu____28297 =
                   ...
                   (fun uu____28309 ->
                      let uu____28310 =
                        solve_and_commit env (singleton wl prob1 true)
                          (fun uu____28321 -> FStar_Pervasives_Native.None) in
                      FStar_All.pipe_left (with_guard env prob1) uu____28310) in
               ...
               | (r, ms) ->
                   ((let uu____28352 =
                     ...
                     if uu____28352
                     then
                       let uu____28357 = FStar_Syntax_Print.comp_to_string c1 in
                       let uu____28359 = FStar_Syntax_Print.comp_to_string c2 in
            ...
            let rec check_ineq uu____28646 =
              ...
              | (u, v1) ->
                  ...
                  (match (u1, v2) with
                   ...
                   | (FStar_Syntax_Syntax.U_name uu____28682,
                      FStar_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif uu____28684,
                      FStar_Syntax_Syntax.U_succ v0) -> check_ineq (u1, v0)
          ...
          then FStar_Pervasives_Native.Some ret_g
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 (if debug1
                  then
                    (let uu____29148 = FStar_TypeChecker_Env.get_range env in
                     let uu____29149 =
                       let uu____29151 = FStar_Syntax_Print.term_to_string vc in
                  ...
                  (let vc1 =
                   ...
                   if debug1
                   then
                     (let uu____29159 = FStar_TypeChecker_Env.get_range env in
                      let uu____29160 =
                        let uu____29162 =
                   ...
                   (let uu____29170 = FStar_TypeChecker_Env.check_trivial vc1 in
                    ...
                    | FStar_TypeChecker_Common.NonTrivial vc2 ->
                        ...
                        then
                          ...
                          (if debug1
                           ...
                           (let vcs =
                              let uu____29209 = FStar_Options.use_tactics () in
                              if uu____29209
                              then
                                ...
                                (let uu____29296 =
                                   let uu____29303 = FStar_Options.peek () in
                                   ...
                                   ((let uu____29615 =
                                    ...
                                    (let t =
                                       env1.FStar_TypeChecker_Env.synth_hook
                                         ...
                                         tau in
                                     let extra =
                                       let uu____29628 = teq_nosmt env1 t tm in
          ...
          let uu____29813 =
            let uu____29819 =
              ...
              FStar_Util.format3
                ...
                uu____29821 uu____29823 imp.FStar_TypeChecker_Env.imp_reason in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____29819) in
             ...
             let g =
               let uu____29931 =
                 solve_and_commit env (singleton wl prob true)
                   (fun uu____29942 -> FStar_Pervasives_Native.None) in
             ...
             let g =
               let uu____30136 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____30147 -> FStar_Pervasives_Native.None) in
