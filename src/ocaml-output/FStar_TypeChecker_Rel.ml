...
let discharge_guard:
  ...
  fun env  ->
    fun g  ->
      let uu____12771 = discharge_guard' None env g true in
    ...
    let rec until_fixpoint acc implicits =
      ...
      | (out,changed) ->
          (match implicits with
           ...
           | hd1::tl1 ->
               let uu____12861 = hd1 in
               (match uu____12861 with
                | (uu____12868,env,u,tm,k,r) ->
                    let uu____12874 = unresolved u in
                    if uu____12874
                       ...
                       (let uu____12892 =
                        ...
                        then
                          ...
                          FStar_Util.print3
                            ...
                            uu____12893 uu____12897 uu____12898
                        else ());
                       (let uu____12900 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___185_12904 = env1 in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___185_12904.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___185_12904.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___185_12904.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___185_12904.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___185_12904.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___185_12904.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___185_12904.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___185_12904.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___185_12904.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___185_12904.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___185_12904.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___185_12904.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___185_12904.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___185_12904.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___185_12904.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___185_12904.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___185_12904.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___185_12904.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___185_12904.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___185_12904.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___185_12904.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___185_12904.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___185_12904.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___185_12904.FStar_TypeChecker_Env.proof_ns)
                             }) tm1 in
                        match uu____12900 with
                        | (uu____12905,uu____12906,g1) ->
                            let g2 =
                              if env1.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___186_12909 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___186_12909.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___186_12909.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___186_12909.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____12912 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
    let uu___187_12931 = g in
    let uu____12932 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___187_12931.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___187_12931.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___187_12931.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____12932
    }
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____12960 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____12960 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____12967 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____12967
      | (reason,uu____12969,uu____12970,e,t,r)::uu____12974 ->
          let uu____12988 =
            let uu____12989 = FStar_Syntax_Print.term_to_string t in
            let uu____12990 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____12989 uu____12990 reason in
          FStar_Errors.err r uu____12988
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___188_12997 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___188_12997.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___188_12997.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___188_12997.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____13015 = try_teq false env t1 t2 in
        match uu____13015 with
        | None  -> false
        | Some g ->
            let uu____13018 = discharge_guard' None env g false in
            (match uu____13018 with
             | Some uu____13022 -> true
             | None  -> false)