    ...
    fun prob  ->
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some d ->
            ...
            FStar_All.pipe_left
              (fun _0_95  -> FStar_Pervasives_Native.Some _0_95) uu____21474
      ...
      fun c2  ->
        ...
        (let rel =
         ...
         let prob =
           ...
           FStar_All.pipe_left
             (fun _0_98  -> FStar_TypeChecker_Common.CProb _0_98) uu____21744 in
         let uu____21754 =
