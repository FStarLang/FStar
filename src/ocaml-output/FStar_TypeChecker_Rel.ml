...
let commit : uvi Prims.list  ->  Prims.unit = (fun uvis -> (FStar_All.pipe_right uvis (FStar_List.iter (fun uu___144_1739 -> (match (uu___144_1739) with
| UNIV (u, t) -> begin
(match (t) with
...
let find_term_uvar : FStar_Syntax_Syntax.uvar  ->  uvi Prims.list  ->  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option = (fun uv s -> (FStar_Util.find_map s (fun uu___145_1775 -> (match (uu___145_1775) with
...
let find_univ_uvar : FStar_Syntax_Syntax.universe_uvar  ->  uvi Prims.list  ->  FStar_Syntax_Syntax.universe FStar_Pervasives_Native.option = (fun u s -> (FStar_Util.find_map s (fun uu___146_1812 -> (match (uu___146_1812) with
| UNIV (u', t) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___169_1913.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___169_1913.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1914}))
in ((uu____1912), (imp)))
end)))))
...
let uu___170_3397 = wl
in {attempting = uu___170_3397.attempting; wl_deferred = uu___170_3397.wl_deferred; ctr = (wl.ctr + (Prims.parse_int "1")); defer_ok = uu___170_3397.defer_ok; smt_ok = uu___170_3397.smt_ok; tcenv = uu___170_3397.tcenv});
)
end))))
...
let uu___171_3425 = wl
in {attempting = uu___171_3425.attempting; wl_deferred = uu___171_3425.wl_deferred; ctr = (wl.ctr + (Prims.parse_int "1")); defer_ok = uu___171_3425.defer_ok; smt_ok = uu___171_3425.smt_ok; tcenv = uu___171_3425.tcenv});
))
...
let head_match : match_result  ->  match_result = (fun uu___147_5055 -> (match (uu___147_5055) with
| MisMatch (i, j) -> begin
MisMatch (((i), (j)))
end
| uu____5070 -> begin
...
let tc_to_string : tc  ->  Prims.string = (fun uu___148_6116 -> (match (uu___148_6116) with
...
let uu___172_6584 = x
in {FStar_Syntax_Syntax.ppname = uu___172_6584.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___172_6584.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})), (imp)))::out) bs3 tcs2)
end
| ([], (C (c2))::[]) -> begin
...
let rec decompose1 = (fun out uu___149_6655 -> (match (uu___149_6655) with
| [] -> begin
...
let rebuild = (fun uu___150_6827 -> (match (uu___150_6827) with
| [] -> begin
t1
end
| uu____6830 -> begin
...
let un_T : tc  ->  FStar_Syntax_Syntax.term = (fun uu___151_6862 -> (match (uu___151_6862) with
...
let arg_of_tc : tc  ->  FStar_Syntax_Syntax.arg = (fun uu___152_6877 -> (match (uu___152_6877) with
...
let uu___173_7757 = b
in {FStar_Syntax_Syntax.ppname = uu___173_7757.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___173_7757.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (imp))
in (
...
in {FStar_TypeChecker_Common.pid = uu___174_8043.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____8048; FStar_TypeChecker_Common.relation = uu___174_8043.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____8049; FStar_TypeChecker_Common.element = uu___174_8043.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___174_8043.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___174_8043.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___174_8043.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___174_8043.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___174_8043.FStar_TypeChecker_Common.rank}))))
...
let uu___175_8383 = tp
in (

let uu____8388 = (force_refinement ((b), (ref_opt)))
in {FStar_TypeChecker_Common.pid = uu___175_8383.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___175_8383.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___175_8383.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____8388; FStar_TypeChecker_Common.element = uu___175_8383.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___175_8383.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___175_8383.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___175_8383.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___175_8383.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___175_8383.FStar_TypeChecker_Common.rank}))
in ((rank), (uu____8378))))
end)
end))
end
...
let uu___176_8500 = tp
in (

let uu____8505 = (force_refinement ((b), (ref_opt)))
in {FStar_TypeChecker_Common.pid = uu___176_8500.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____8505; FStar_TypeChecker_Common.relation = uu___176_8500.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___176_8500.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___176_8500.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___176_8500.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___176_8500.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___176_8500.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___176_8500.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___176_8500.FStar_TypeChecker_Common.rank}))
...
let uu___177_8552 = tp1
in {FStar_TypeChecker_Common.pid = uu___177_8552.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___177_8552.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___177_8552.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___177_8552.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___177_8552.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___177_8552.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___177_8552.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___177_8552.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___177_8552.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = FStar_Pervasives_Native.Some (rank)}) (fun _0_52 -> FStar_TypeChecker_Common.TProb (_0_52)))
in ((rank), (uu____8546)))
end))
end))
end))
...
let uu___178_8568 = cp
in {FStar_TypeChecker_Common.pid = uu___178_8568.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___178_8568.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___178_8568.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___178_8568.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___178_8568.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___178_8568.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___178_8568.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___178_8568.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___178_8568.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = FStar_Pervasives_Native.Some (rigid_rigid)}) (fun _0_53 -> FStar_TypeChecker_Common.CProb (_0_53)))
...
let uu___179_9632 = probs
in {attempting = tl1; wl_deferred = uu___179_9632.wl_deferred; ctr = uu___179_9632.ctr; defer_ok = uu___179_9632.defer_ok; smt_ok = uu___179_9632.smt_ok; tcenv = uu___179_9632.tcenv})
in (match (hd1) with
| FStar_TypeChecker_Common.CProb (cp) -> begin
...
in {attempting = uu____9829; wl_deferred = rest; ctr = uu___180_9828.ctr; defer_ok = uu___180_9828.defer_ok; smt_ok = uu___180_9828.smt_ok; tcenv = uu___180_9828.tcenv}))
...
let uu____10425 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun uu___153_10451 -> (match (uu___153_10451) with
...
let uu___181_10714 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = uu___181_10714.wl_deferred; ctr = uu___181_10714.ctr; defer_ok = uu___181_10714.defer_ok; smt_ok = uu___181_10714.smt_ok; tcenv = uu___181_10714.tcenv})
in (
...
let uu___182_10719 = wl
in {attempting = sub_probs; wl_deferred = uu___182_10719.wl_deferred; ctr = uu___182_10719.ctr; defer_ok = uu___182_10719.defer_ok; smt_ok = uu___182_10719.smt_ok; tcenv = uu___182_10719.tcenv}))
...
let uu___183_10724 = wl
in {attempting = rest; wl_deferred = uu___183_10724.wl_deferred; ctr = uu___183_10724.ctr; defer_ok = uu___183_10724.defer_ok; smt_ok = uu___183_10724.smt_ok; tcenv = uu___183_10724.tcenv})
in (
...
let uu____11276 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun uu___154_11302 -> (match (uu___154_11302) with
| FStar_TypeChecker_Common.TProb (tp1) -> begin
(match (tp1.FStar_TypeChecker_Common.rank) with
...
let uu___184_11615 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = uu___184_11615.wl_deferred; ctr = uu___184_11615.ctr; defer_ok = uu___184_11615.defer_ok; smt_ok = uu___184_11615.smt_ok; tcenv = uu___184_11615.tcenv})
in (
...
let uu___185_11620 = wl
in {attempting = sub_probs; wl_deferred = uu___185_11620.wl_deferred; ctr = uu___185_11620.ctr; defer_ok = uu___185_11620.defer_ok; smt_ok = uu___185_11620.smt_ok; tcenv = uu___185_11620.tcenv}))
...
let uu___186_11625 = wl
in {attempting = rest; wl_deferred = uu___186_11625.wl_deferred; ctr = uu___186_11625.ctr; defer_ok = uu___186_11625.defer_ok; smt_ok = uu___186_11625.smt_ok; tcenv = uu___186_11625.tcenv})
in (
...
let uu___187_11779 = hd1
in (

let uu____11780 = (FStar_Syntax_Subst.subst subst1 hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___187_11779.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___187_11779.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____11780}))
in (

let hd21 = (

let uu___188_11784 = hd2
in (

let uu____11785 = (FStar_Syntax_Subst.subst subst1 hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___188_11784.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___188_11784.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____11785}))
in (
...
let uu___189_12127 = problem
in {FStar_TypeChecker_Common.pid = uu___189_12127.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___189_12127.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___189_12127.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___189_12127.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___189_12127.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___189_12127.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___189_12127.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___189_12127.FStar_TypeChecker_Common.rank}) wl1)
end
...
let uu___190_12490 = problem
in {FStar_TypeChecker_Common.pid = uu___190_12490.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = uu___190_12490.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = uu___190_12490.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___190_12490.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___190_12490.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___190_12490.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___190_12490.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___190_12490.FStar_TypeChecker_Common.rank}) wl1)))
end)
end))
end))
end))
...
let imitate' = (fun orig env1 wl1 uu___155_13575 -> (match (uu___155_13575) with
| FStar_Pervasives_Native.None -> begin
...
let uu___191_16768 = problem
in (

let uu____16769 = (FStar_Syntax_Util.unmeta t1)
in {FStar_TypeChecker_Common.pid = uu___191_16768.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____16769; FStar_TypeChecker_Common.relation = uu___191_16768.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___191_16768.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___191_16768.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___191_16768.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___191_16768.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___191_16768.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___191_16768.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___191_16768.FStar_TypeChecker_Common.rank}))
...
let uu___191_16779 = problem
in (

let uu____16780 = (FStar_Syntax_Util.unmeta t1)
in {FStar_TypeChecker_Common.pid = uu___191_16779.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____16780; FStar_TypeChecker_Common.relation = uu___191_16779.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___191_16779.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___191_16779.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___191_16779.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___191_16779.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___191_16779.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___191_16779.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___191_16779.FStar_TypeChecker_Common.rank}))
...
let uu___192_16810 = problem
in (

let uu____16811 = (FStar_Syntax_Util.unmeta t2)
in {FStar_TypeChecker_Common.pid = uu___192_16810.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___192_16810.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___192_16810.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____16811; FStar_TypeChecker_Common.element = uu___192_16810.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___192_16810.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___192_16810.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___192_16810.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___192_16810.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___192_16810.FStar_TypeChecker_Common.rank}))
...
let uu___192_16821 = problem
in (

let uu____16822 = (FStar_Syntax_Util.unmeta t2)
in {FStar_TypeChecker_Common.pid = uu___192_16821.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___192_16821.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___192_16821.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____16822; FStar_TypeChecker_Common.element = uu___192_16821.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___192_16821.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___192_16821.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___192_16821.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___192_16821.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___192_16821.FStar_TypeChecker_Common.rank}))
...
let mk_c = (fun c uu___156_16881 -> (match (uu___156_16881) with
| [] -> begin
c
end
| bs -> begin
...
let mk_t = (fun t l uu___157_17132 -> (match (uu___157_17132) with
| [] -> begin
t
end
| bs -> begin
...
let uu___193_17456 = problem
in {FStar_TypeChecker_Common.pid = uu___193_17456.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___193_17456.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___193_17456.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___193_17456.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___193_17456.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___193_17456.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___193_17456.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___193_17456.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___193_17677 = problem
in {FStar_TypeChecker_Common.pid = uu___193_17677.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___193_17677.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___193_17677.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___193_17677.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___193_17677.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___193_17677.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___193_17677.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___193_17677.FStar_TypeChecker_Common.rank}) wl)
end
| (FStar_Util.Inl (t_abs), FStar_Util.Inr (not_abs)) -> begin
(
...
let uu___194_17854 = wl
in {attempting = (ref_prob)::[]; wl_deferred = []; ctr = uu___194_17854.ctr; defer_ok = false; smt_ok = uu___194_17854.smt_ok; tcenv = uu___194_17854.tcenv}))
...
let uu___195_17885 = wl1
in {attempting = uu___195_17885.attempting; wl_deferred = uu___195_17885.wl_deferred; ctr = (wl1.ctr + (Prims.parse_int "1")); defer_ok = uu___195_17885.defer_ok; smt_ok = uu___195_17885.smt_ok; tcenv = uu___195_17885.tcenv})
...
let uu___196_18274 = problem
in {FStar_TypeChecker_Common.pid = uu___196_18274.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___196_18274.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___196_18274.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___196_18274.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___196_18274.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___196_18274.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___196_18274.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___196_18274.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___196_18274.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___196_18317 = problem
in {FStar_TypeChecker_Common.pid = uu___196_18317.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___196_18317.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___196_18317.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___196_18317.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___196_18317.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___196_18317.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___196_18317.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___196_18317.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___196_18317.FStar_TypeChecker_Common.rank}) wl)
end
| (FStar_Syntax_Syntax.Tm_uvar (uu____18318), FStar_Syntax_Syntax.Tm_arrow (uu____18319)) -> begin
(solve_t' env (

let uu___196_18349 = problem
in {FStar_TypeChecker_Common.pid = uu___196_18349.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___196_18349.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___196_18349.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___196_18349.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___196_18349.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___196_18349.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___196_18349.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___196_18349.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___196_18349.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___196_18404 = problem
in {FStar_TypeChecker_Common.pid = uu___196_18404.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___196_18404.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___196_18404.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___196_18404.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___196_18404.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___196_18404.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___196_18404.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___196_18404.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___196_18404.FStar_TypeChecker_Common.rank}) wl)
end
...
let uu___197_18433 = problem
in {FStar_TypeChecker_Common.pid = uu___197_18433.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___197_18433.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___197_18433.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___197_18433.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___197_18433.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___197_18433.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___197_18433.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___197_18433.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___197_18433.FStar_TypeChecker_Common.rank}))
in (
...
let uu___198_18491 = problem
in {FStar_TypeChecker_Common.pid = uu___198_18491.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___198_18491.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___198_18491.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___198_18491.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___198_18491.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___198_18491.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___198_18491.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___198_18491.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___198_18491.FStar_TypeChecker_Common.rank}))
in (
...
let uu___199_18512 = y
in {FStar_Syntax_Syntax.ppname = uu___199_18512.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___199_18512.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
...
let uu___197_18586 = problem
in {FStar_TypeChecker_Common.pid = uu___197_18586.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___197_18586.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___197_18586.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___197_18586.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___197_18586.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___197_18586.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___197_18586.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___197_18586.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___197_18586.FStar_TypeChecker_Common.rank}))
in (
...
let uu___198_18644 = problem
in {FStar_TypeChecker_Common.pid = uu___198_18644.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___198_18644.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = uu___198_18644.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___198_18644.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___198_18644.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___198_18644.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___198_18644.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___198_18644.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___198_18644.FStar_TypeChecker_Common.rank}))
in (
...
let uu___199_18665 = y
in {FStar_Syntax_Syntax.ppname = uu___199_18665.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___199_18665.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
...
let uu___200_18745 = problem
in {FStar_TypeChecker_Common.pid = uu___200_18745.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___200_18745.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___200_18745.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___200_18745.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___200_18745.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___200_18745.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___200_18745.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___200_18745.FStar_TypeChecker_Common.rank}) wl)
end))
end)
end
...
let uu___200_18828 = problem
in {FStar_TypeChecker_Common.pid = uu___200_18828.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = uu___200_18828.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___200_18828.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___200_18828.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___200_18828.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___200_18828.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___200_18828.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___200_18828.FStar_TypeChecker_Common.rank}) wl)
end))
end)
end
...
let uu___201_18866 = problem
in {FStar_TypeChecker_Common.pid = uu___201_18866.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___201_18866.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___201_18866.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t21; FStar_TypeChecker_Common.element = uu___201_18866.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___201_18866.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___201_18866.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___201_18866.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___201_18866.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___201_18866.FStar_TypeChecker_Common.rank}) wl))
end
...
let uu___202_18902 = problem
in {FStar_TypeChecker_Common.pid = uu___202_18902.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t11; FStar_TypeChecker_Common.relation = uu___202_18902.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___202_18902.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___202_18902.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___202_18902.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___202_18902.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___202_18902.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___202_18902.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___202_18902.FStar_TypeChecker_Common.rank}) wl))
end
...
let is_null_wp_2 = (FStar_All.pipe_right c21.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___158_20795 -> (match (uu___158_20795) with
...
in {FStar_TypeChecker_Common.pid = uu___203_21260.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____21265; FStar_TypeChecker_Common.relation = uu___203_21260.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___203_21260.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___203_21260.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___203_21260.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___203_21260.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___203_21260.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___203_21260.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___203_21260.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___203_21282.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu____21287; FStar_TypeChecker_Common.relation = uu___203_21282.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu___203_21282.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = uu___203_21282.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___203_21282.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___203_21282.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___203_21282.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___203_21282.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___203_21282.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___204_21304.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___204_21304.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___204_21304.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____21309; FStar_TypeChecker_Common.element = uu___204_21304.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___204_21304.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___204_21304.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___204_21304.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___204_21304.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___204_21304.FStar_TypeChecker_Common.rank}))
...
in {FStar_TypeChecker_Common.pid = uu___204_21326.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = uu___204_21326.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = uu___204_21326.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = uu____21331; FStar_TypeChecker_Common.element = uu___204_21326.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = uu___204_21326.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = uu___204_21326.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = uu___204_21326.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = uu___204_21326.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = uu___204_21326.FStar_TypeChecker_Common.rank}))
...
let uu___205_21735 = probs
in {attempting = uu___205_21735.attempting; wl_deferred = uu___205_21735.wl_deferred; ctr = uu___205_21735.ctr; defer_ok = false; smt_ok = uu___205_21735.smt_ok; tcenv = uu___205_21735.tcenv})
end
| uu____21736 -> begin
probs
end))
...
let uu___206_21775 = g
in {FStar_TypeChecker_Env.guard_f = f2; FStar_TypeChecker_Env.deferred = uu___206_21775.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___206_21775.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___206_21775.FStar_TypeChecker_Env.implicits}));
));
)
end))
...
let uu___207_22298 = (empty_worklist env)
in {attempting = uu___207_22298.attempting; wl_deferred = uu___207_22298.wl_deferred; ctr = uu___207_22298.ctr; defer_ok = false; smt_ok = uu___207_22298.smt_ok; tcenv = uu___207_22298.tcenv})
...
let uu___208_22553 = g
in {FStar_TypeChecker_Env.guard_f = uu___208_22553.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = uu___208_22553.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___208_22553.FStar_TypeChecker_Env.implicits})
end
| uu____22558 -> begin
...
let uu___209_22562 = g1
in {FStar_TypeChecker_Env.guard_f = uu___209_22562.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___209_22562.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = (([]), ([])); FStar_TypeChecker_Env.implicits = uu___209_22562.FStar_TypeChecker_Env.implicits});
));
))))
...
let uu___210_22676 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___210_22676.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___210_22676.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___210_22676.FStar_TypeChecker_Env.implicits})
in (
...
let uu___211_23010 = env1
in {FStar_TypeChecker_Env.solver = uu___211_23010.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___211_23010.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___211_23010.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___211_23010.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___211_23010.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___211_23010.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___211_23010.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___211_23010.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___211_23010.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___211_23010.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___211_23010.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___211_23010.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___211_23010.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___211_23010.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___211_23010.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___211_23010.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___211_23010.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___211_23010.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___211_23010.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___211_23010.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___211_23010.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.type_of = uu___211_23010.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___211_23010.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___211_23010.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___211_23010.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___211_23010.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___211_23010.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___211_23010.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___211_23010.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.dsenv = uu___211_23010.FStar_TypeChecker_Env.dsenv})
end
| uu____23011 -> begin
env1
end)
...
let uu___212_23020 = env2
in {FStar_TypeChecker_Env.solver = uu___212_23020.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___212_23020.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___212_23020.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___212_23020.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___212_23020.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___212_23020.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___212_23020.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___212_23020.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___212_23020.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___212_23020.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___212_23020.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___212_23020.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___212_23020.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___212_23020.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___212_23020.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___212_23020.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___212_23020.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___212_23020.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___212_23020.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___212_23020.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___212_23020.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___212_23020.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.type_of = uu___212_23020.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___212_23020.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___212_23020.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___212_23020.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___212_23020.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___212_23020.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___212_23020.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.dsenv = uu___212_23020.FStar_TypeChecker_Env.dsenv}) tm1)
...
let uu___213_23025 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___213_23025.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___213_23025.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___213_23025.FStar_TypeChecker_Env.implicits})
end
| uu____23026 -> begin
g1
end)
...
let uu___214_23062 = g
in (

let uu____23063 = (until_fixpoint (([]), (false)) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = uu___214_23062.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___214_23062.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___214_23062.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu____23063})))))
...
let uu___215_23185 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = uu___215_23185.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___215_23185.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = (([]), ((((u1), (u2)))::[])); FStar_TypeChecker_Env.implicits = uu___215_23185.FStar_TypeChecker_Env.implicits}))
