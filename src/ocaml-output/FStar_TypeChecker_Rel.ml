        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            let f1 =
              FStar_List.fold_right2
                ...
                us bs f in
            let uu___134_248 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___134_248.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___134_248.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___134_248.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____277 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___135_275.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___135_275.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___135_275.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___136_784 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___136_784.wl_deferred);
          ctr = (uu___136_784.ctr);
          defer_ok = (uu___136_784.defer_ok);
          smt_ok;
          tcenv = (uu___136_784.tcenv)
        }
let singleton:
  FStar_TypeChecker_Env.env -> FStar_TypeChecker_Common.prob -> worklist =
  fun env  -> fun prob  -> singleton' env prob true
let wl_of_guard env g =
  let uu___137_809 = empty_worklist env in
  let uu____810 = FStar_List.map Prims.snd g in
  {
    attempting = uu____810;
    wl_deferred = (uu___137_809.wl_deferred);
    ctr = (uu___137_809.ctr);
    defer_ok = false;
    smt_ok = (uu___137_809.smt_ok);
    tcenv = (uu___137_809.tcenv)
  }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___138_822 = wl in
        {
          attempting = (uu___138_822.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___138_822.ctr);
          defer_ok = (uu___138_822.defer_ok);
          smt_ok = (uu___138_822.smt_ok);
          tcenv = (uu___138_822.tcenv)
        }
let attempt: FStar_TypeChecker_Common.prob Prims.list -> worklist -> worklist
  =
  fun probs  ->
    fun wl  ->
      let uu___139_834 = wl in
      {
        attempting = (FStar_List.append probs wl.attempting);
        wl_deferred = (uu___139_834.wl_deferred);
        ctr = (uu___139_834.ctr);
        defer_ok = (uu___139_834.defer_ok);
        smt_ok = (uu___139_834.smt_ok);
        tcenv = (uu___139_834.tcenv)
      }
let giveup:
  FStar_TypeChecker_Env.env ->
...
let invert_rel: FStar_TypeChecker_Common.rel -> FStar_TypeChecker_Common.rel
  =
  fun uu___106_850  ->
    match uu___106_850 with
    | FStar_TypeChecker_Common.EQ  -> FStar_TypeChecker_Common.EQ
    | FStar_TypeChecker_Common.SUB  -> FStar_TypeChecker_Common.SUBINV
    | FStar_TypeChecker_Common.SUBINV  -> FStar_TypeChecker_Common.SUB
let invert p =
  let uu___140_866 = p in
  {
    FStar_TypeChecker_Common.pid =
      (uu___140_866.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
    FStar_TypeChecker_Common.relation =
      (invert_rel p.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
    FStar_TypeChecker_Common.element =
      (uu___140_866.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___140_866.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___140_866.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___140_866.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___140_866.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___140_866.FStar_TypeChecker_Common.rank)
  }
let maybe_invert p =
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___114_957  ->
    match uu___114_957 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___115_966  ->
    match uu___115_966 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1336  ->
              ...
              | (x,imp) ->
                  let uu____1343 =
                    let uu___141_1344 = x in
                    let uu____1345 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___141_1344.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___141_1344.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____2071,uv) ->
                ((let uu____2074 =
                 ...
                 commit uvis;
                 (let uu___142_2105 = wl in
                  {
                    attempting = (uu___142_2105.attempting);
                    wl_deferred = (uu___142_2105.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___142_2105.defer_ok);
                    smt_ok = (uu___142_2105.smt_ok);
                    tcenv = (uu___142_2105.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___143_2126 = wl in
         {
           attempting = (uu___143_2126.attempting);
           wl_deferred = (uu___143_2126.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___143_2126.defer_ok);
           smt_ok = (uu___143_2126.smt_ok);
           tcenv = (uu___143_2126.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
    FStar_Syntax_Syntax.term Prims.option ->
...
let rec decompose:
  ...
  fun env  ->
    fun t  ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____3978))::tcs2) ->
                       aux
                         (((let uu___144_4000 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___144_4000.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___144_4000.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___121_4041 =
                 match uu___121_4041 with
      ...
      | uu____4132 ->
          let rebuild uu___122_4137 =
            match uu___122_4137 with
            | [] -> t1
            | uu____4139 -> failwith "Bad reconstruction" in
          (rebuild, ((fun t2  -> true)), [])
let un_T: tc -> FStar_Syntax_Syntax.term =
  fun uu___123_4158  ->
    match uu___123_4158 with
    | T (t,uu____4160) -> t
    | uu____4169 -> failwith "Impossible"
let arg_of_tc: tc -> FStar_Syntax_Syntax.arg =
  fun uu___124_4172  ->
    match uu___124_4172 with
...
let compress_tprob wl p =
  ...
  {
    FStar_TypeChecker_Common.pid =
      (uu___145_4866.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = uu____4869;
    FStar_TypeChecker_Common.relation =
      (uu___145_4866.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = uu____4870;
    FStar_TypeChecker_Common.element =
      (uu___145_4866.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___145_4866.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___145_4866.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___145_4866.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___145_4866.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___145_4866.FStar_TypeChecker_Common.rank)
  }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____4946) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5046 ->
                                    ...
                                    let uu____5055 =
                                      let uu___146_5058 = tp in
                                      let uu____5061 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___146_5058.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___146_5058.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___146_5058.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____5061;
                                        FStar_TypeChecker_Common.element =
                                          (uu___146_5058.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___146_5058.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___146_5058.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___146_5058.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___146_5058.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___146_5058.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____5055)))
                          ...
                          (match uu____5081 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5121 ->
                                    let uu____5127 =
                                      let uu___147_5132 = tp in
                                      let uu____5135 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___147_5132.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____5135;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___147_5132.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___147_5132.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___147_5132.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___147_5132.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___147_5132.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___147_5132.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___147_5132.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___147_5132.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____4961 with
                     | (rank,tp1) ->
                         let uu____5163 =
                           FStar_All.pipe_right
                             (let uu___148_5166 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___148_5166.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___148_5166.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___148_5166.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___148_5166.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___148_5166.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___148_5166.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___148_5166.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___148_5166.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___148_5166.FStar_TypeChecker_Common.loc);
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____5172 =
            FStar_All.pipe_right
              (let uu___149_5175 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___149_5175.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___149_5175.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___149_5175.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___149_5175.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___149_5175.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___149_5175.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___149_5175.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___149_5175.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___149_5175.FStar_TypeChecker_Common.loc);
  ...
  fun env  ->
    fun probs  ->
      ...
      (let uu____5841 = next_prob probs in
       ...
       | (Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___150_5854 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___150_5854.wl_deferred);
               ctr = (uu___150_5854.ctr);
               defer_ok = (uu___150_5854.defer_ok);
               smt_ok = (uu___150_5854.smt_ok);
               tcenv = (uu___150_5854.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____5955 ->
                          let uu____5960 =
                                      ...
                                      | (uu____5975,uu____5976,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___151_5961.ctr);
                              defer_ok = (uu___151_5961.defer_ok);
                              smt_ok = (uu___151_5961.smt_ok);
                              tcenv = (uu___151_5961.tcenv)
                            } in
                       ...
                       (match uu____6515 with
                        ...
                        | Some (lhs_bound,sub_probs) ->
                            ...
                            ((let uu____6544 =
                              ...
                              then
                                let wl' =
                                  let uu___152_6546 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred = (uu___152_6546.wl_deferred);
                                    ctr = (uu___152_6546.ctr);
                                    defer_ok = (uu___152_6546.defer_ok);
                                    smt_ok = (uu___152_6546.smt_ok);
                                    tcenv = (uu___152_6546.tcenv)
                                  } in
                             ...
                             (let uu____6549 =
                                solve_t env eq_prob
                                  (let uu___153_6550 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___153_6550.wl_deferred);
                                     ctr = (uu___153_6550.ctr);
                                     defer_ok = (uu___153_6550.defer_ok);
                                     smt_ok = (uu___153_6550.smt_ok);
                                     tcenv = (uu___153_6550.tcenv)
                                   }) in
                              match uu____6549 with
                              | Success uu____6552 ->
                                  let wl1 =
                                    let uu___154_6554 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___154_6554.wl_deferred);
                                      ctr = (uu___154_6554.ctr);
                                      defer_ok = (uu___154_6554.defer_ok);
                                      smt_ok = (uu___154_6554.smt_ok);
                                      tcenv = (uu___154_6554.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____7113 with
                             ...
                             | Some (rhs_bound,sub_probs) ->
                                 ...
                                 ((let uu____7154 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___155_7156 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___155_7156.wl_deferred);
                                         ctr = (uu___155_7156.ctr);
                                         defer_ok = (uu___155_7156.defer_ok);
                                         smt_ok = (uu___155_7156.smt_ok);
                                         tcenv = (uu___155_7156.tcenv)
                                       } in
                                  ...
                                  (let uu____7159 =
                                     solve_t env eq_prob
                                       (let uu___156_7160 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___156_7160.wl_deferred);
                                          ctr = (uu___156_7160.ctr);
                                          defer_ok = (uu___156_7160.defer_ok);
                                          smt_ok = (uu___156_7160.smt_ok);
                                          tcenv = (uu___156_7160.tcenv)
                                        }) in
                                   match uu____7159 with
                                   | Success uu____7162 ->
                                       let wl1 =
                                         let uu___157_7164 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___157_7164.wl_deferred);
                                           ctr = (uu___157_7164.ctr);
                                           defer_ok =
                                             (uu___157_7164.defer_ok);
                                           smt_ok = (uu___157_7164.smt_ok);
                                           tcenv = (uu___157_7164.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___158_7268 = hd1 in
                      let uu____7269 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___158_7268.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___158_7268.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____7269
                      } in
                    let hd21 =
                      let uu___159_7273 = hd2 in
                      let uu____7274 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___159_7273.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___159_7273.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____7454,Some (t11,t21)) ->
                   solve_t env1
                     (let uu___160_7462 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___160_7462.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___160_7462.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___160_7462.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___160_7462.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___160_7462.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___160_7462.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___160_7462.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___160_7462.FStar_TypeChecker_Common.rank)
                      }) wl1
               | (uu____7463,None ) ->
                   ((let uu____7470 =
                                                  ...
                                                  solve_t env1
                                                    (let uu___161_7709 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___161_7709.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___127_7869 =
          match uu___127_7869 with
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___128_10330 =
                     match uu___128_10330 with
                     | [] -> c
                     | bs ->
                         let uu____10344 =
                           (FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___129_10523 =
                     match uu___129_10523 with
                     | [] -> t
                     | bs ->
                         (FStar_Syntax_Syntax.mk
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                   ...
                   (match uu____10707 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___162_10754 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___162_10754.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___162_10754.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___162_10754.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___162_10754.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___162_10754.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___162_10754.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___162_10754.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___162_10754.FStar_TypeChecker_Common.rank)
                           }) wl
                        ...
                        (match uu____10819 with
                         | (x2,phi2) ->
                             ...
                             then
                               ...
                               let uu____10882 =
                                 solve env1
                                   (let uu___163_10883 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___163_10883.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___163_10883.smt_ok);
                                      tcenv = (uu___163_10883.tcenv)
                                    }) in
                               (match uu____10882 with
                                ...
                                | Success uu____10890 ->
                                    ...
                                    let wl2 =
                                      let uu___164_10905 = wl1 in
                                      {
                                        attempting =
                                          (uu___164_10905.attempting);
                                        wl_deferred =
                                          (uu___164_10905.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___164_10905.defer_ok);
                                        smt_ok = (uu___164_10905.smt_ok);
                                        tcenv = (uu___164_10905.tcenv)
                                      } in
               ...
               | (FStar_Syntax_Syntax.Tm_uvar _,FStar_Syntax_Syntax.Tm_type
                 ...
                 |(FStar_Syntax_Syntax.Tm_app
                  ...
                  |(FStar_Syntax_Syntax.Tm_uvar
                   ...
                   ->
                   solve_t' env
                     (let uu___165_11025 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___165_11025.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___165_11025.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___165_11025.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___165_11025.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___165_11025.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___165_11025.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___165_11025.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___165_11025.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___165_11025.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar _,_)
                 |(FStar_Syntax_Syntax.Tm_app
                   ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar _;
                      ...
                      then
                        let uu____11045 =
                          FStar_All.pipe_left
                            ...
                            (let uu___166_11048 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___166_11048.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___166_11048.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___166_11048.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___166_11048.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___166_11048.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___166_11048.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___166_11048.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___166_11048.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___166_11048.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____11054 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | None  ->
                                  let uu____11084 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___167_11087 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___167_11087.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___167_11087.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___167_11087.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___167_11087.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___167_11087.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___167_11087.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___167_11087.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___167_11087.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___167_11087.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____11088 =
                              ...
                              | Some (y,phi) ->
                                  let y' =
                                    let uu___168_11103 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___168_11103.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___168_11103.FStar_Syntax_Syntax.index);
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_app
                   ...
                   then
                     ...
                     (let uu____11136 = base_and_refinement env wl t1 in
                      ...
                      | (t_base,uu____11147) ->
                          solve_t env
                            (let uu___169_11162 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___169_11162.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___169_11162.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___169_11162.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___169_11162.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___169_11162.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___169_11162.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___169_11162.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___169_11162.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____11165,uu____11166) ->
                   ...
                   solve_t env
                     (let uu___170_11187 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___170_11187.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___170_11187.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___170_11187.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___170_11187.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___170_11187.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___170_11187.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___170_11187.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___170_11187.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___170_11187.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11188,FStar_Syntax_Syntax.Tm_refine uu____11189) ->
                   ...
                   solve_t env
                     (let uu___171_11210 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___171_11210.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___171_11210.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___171_11210.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___171_11210.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___171_11210.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___171_11210.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___171_11210.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___171_11210.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___171_11210.FStar_TypeChecker_Common.rank)
                      }) wl
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed
                  (t11,uu____11325,uu____11326),uu____11327) ->
                   solve_t' env
                     (let uu___172_11356 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___172_11356.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___172_11356.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___172_11356.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___172_11356.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___172_11356.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___172_11356.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___172_11356.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___172_11356.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___172_11356.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11359,FStar_Syntax_Syntax.Tm_ascribed
                  (t21,uu____11361,uu____11362)) ->
                   solve_t' env
                     (let uu___173_11391 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___173_11391.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___173_11391.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___173_11391.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___173_11391.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___173_11391.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___173_11391.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___173_11391.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___173_11391.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___173_11391.FStar_TypeChecker_Common.rank)
                      }) wl
                 ...
                 | (FStar_Syntax_Syntax.GTotal _,FStar_Syntax_Syntax.Comp _)
                   |(FStar_Syntax_Syntax.Total _,FStar_Syntax_Syntax.Comp _)
                     ...
                     let uu____11861 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___174_11864.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____11867;
                         FStar_TypeChecker_Common.relation =
                           (uu___174_11864.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___174_11864.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___174_11864.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___174_11864.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___174_11864.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___174_11864.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___174_11864.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___174_11864.FStar_TypeChecker_Common.rank)
                       } in
                 ...
                 | (FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.GTotal _)
                   |(FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.Total _)
                     ...
                     let uu____11873 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___175_11876.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___175_11876.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___175_11876.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____11879;
                         FStar_TypeChecker_Common.element =
                           (uu___175_11876.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___175_11876.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___175_11876.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___175_11876.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___175_11876.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___175_11876.FStar_TypeChecker_Common.rank)
                       } in
    ...
    fun probs  ->
      fun err  ->
        let probs1 =
          ...
          if uu____12146
          then
            let uu___176_12147 = probs in
            {
              attempting = (uu___176_12147.attempting);
              wl_deferred = (uu___176_12147.wl_deferred);
              ctr = (uu___176_12147.ctr);
              defer_ok = false;
              smt_ok = (uu___176_12147.smt_ok);
              tcenv = (uu___176_12147.tcenv)
            }
          else probs in
        let tx = FStar_Unionfind.new_transaction () in
          ...
          ((let uu____12169 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___177_12184 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___177_12184.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___177_12184.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___177_12184.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
    ...
    fun env  ->
      fun uu____12385  ->
        ...
        | (variables,ineqs) ->
            ...
            let uu____12487 =
              let wl =
                let uu___178_12490 = empty_worklist env in
                {
                  attempting = (uu___178_12490.attempting);
                  wl_deferred = (uu___178_12490.wl_deferred);
                  ctr = (uu___178_12490.ctr);
                  defer_ok = false;
                  smt_ok = (uu___178_12490.smt_ok);
                  tcenv = (uu___178_12490.tcenv)
                } in
  ...
  fun env  ->
    fun g  ->
      ...
      (let g1 =
         ...
         | Some [] ->
             let uu___179_12647 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___179_12647.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___179_12647.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___179_12647.FStar_TypeChecker_Env.implicits)
             }
         | uu____12650 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___180_12653 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___180_12653.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___180_12653.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___181_12679 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___181_12679.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___181_12679.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___181_12679.FStar_TypeChecker_Env.implicits)
            } in
          let uu____12680 =
                      ...
                      (let env1 =
                       ...
                       (let uu____12862 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___182_12866 = env1 in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___182_12866.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___182_12866.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___182_12866.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___182_12866.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___182_12866.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___182_12866.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___182_12866.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___182_12866.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___182_12866.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___182_12866.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___182_12866.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___182_12866.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___182_12866.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___182_12866.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___182_12866.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___182_12866.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___182_12866.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___182_12866.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___182_12866.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___182_12866.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___182_12866.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___182_12866.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___182_12866.FStar_TypeChecker_Env.qname_and_index)
                             }) tm1 in
                        ...
                        | (uu____12867,uu____12868,g1) ->
                            let g2 =
                              ...
                              then
                                let uu___183_12871 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___183_12871.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___183_12871.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___183_12871.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____12874 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
    let uu___184_12893 = g in
    let uu____12894 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___184_12893.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___184_12893.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___184_12893.FStar_TypeChecker_Env.univ_ineqs);
...
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___185_12959 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___185_12959.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___185_12959.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___185_12959.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
