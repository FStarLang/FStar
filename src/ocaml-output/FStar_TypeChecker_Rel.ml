          ...
          let x =
            ...
            then "?"
              ...
              (let uu____697 = FStar_Unionfind.uvar_id u  in
               FStar_All.pipe_right uu____697 FStar_Util.string_of_int)
             in
    ...
    FStar_All.pipe_right args
      (FStar_List.map
         (fun uu____757  ->
            ...
            | (x,uu____761) -> FStar_Syntax_Print.term_to_string x))
     in
    ...
    fun t  ->
      let uu____1288 =
        ...
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.WHNF] env uu____1289
         in
...
let norm_arg env t =
  let uu____1315 = sn env (fst t)  in (uu____1315, (snd t)) 
let sn_binders :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.binders ->
      ...
      let uu____1786 =
        let uu____1788 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu____1798  ->
                  match uu____1798 with | (uu____1802,uu____1803,x) -> x))
           in
          ...
          | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
              ...
              then
                ...
                (let uu____1887 = FStar_Syntax_Util.abs_formals t  in
                 ...
                 | (ys',t1,uu____1908) ->
                     let uu____1921 = FStar_Syntax_Util.arrow_formals_comp k
                        in
               ...
               let uu____2006 =
                 let uu____2013 =
                   FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c1)
                    ...
                    in
                 FStar_All.pipe_right uu____2013 (fun _0_37  -> Some _0_37)
                  in
        ...
        fun wl  ->
          ...
          (let uu____2165 =
           ...
           then
             ...
             let uu____2167 =
               let uu____2168 = FStar_List.map (uvi_to_string wl.tcenv) uvis
                  in
        ...
        FStar_All.pipe_right seen
          (FStar_Util.for_some
             (fun uu____2633  ->
                ...
                | (b,uu____2637) -> FStar_Syntax_Syntax.bv_eq a b))
         in
      ...
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_fvar f,FStar_Syntax_Syntax.Tm_fvar g) ->
            ...
            then FullMatch
              ...
              (let uu____3210 =
                 let uu____3215 =
                   let uu____3217 = fv_delta_depth env f  in Some uu____3217
                    in
                 let uu____3218 =
                   let uu____3220 = fv_delta_depth env g  in Some uu____3220
                    in
        ...
        | (FStar_Syntax_Syntax.Tm_refine (x,uu____3290),uu____3291) ->
            let uu____3296 = head_matches env x.FStar_Syntax_Syntax.sort t21
               in
            FStar_All.pipe_right uu____3296 head_match
        | (uu____3297,FStar_Syntax_Syntax.Tm_refine (x,uu____3299)) ->
            let uu____3304 = head_matches env t11 x.FStar_Syntax_Syntax.sort
               in
      ...
      (_,Some (FStar_Syntax_Syntax.Delta_equational )) ->
        ...
        then fail r
          ...
          (let uu____3555 =
             ...
             let uu____3562 = maybe_inline t21  in (uu____3560, uu____3562)
              in
                        ...
                        let uu____4587 =
                          let uu____4592 =
                            FStar_List.map (sub_prob scope1 args) components1
                             in
                          FStar_All.pipe_right uu____4592 FStar_List.unzip
                           in
                        (match uu____4587 with
                         | (tcs,sub_probs) ->
                             let gi_xs =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Syntax.mk_Comp uu____4621
                                in
                             ((C gi_xs), sub_probs))
                    | uu____4637 ->
                          ...
                          (match uu____4994 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5034 ->
                                    let rank =
                                      let uu____5041 = is_top_level_prob prob
                                         in
                                      if uu____5041
                                      then flex_refine
                     ...
                     (fun u3  ->
                        ...
                        | (k,uu____5355) ->
                            (match k with
                             ...
                             | uu____5360 -> false)))
            | uu____5361 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u])
             in
          let try_umax_components u12 u22 msg =
            ...
            | (FStar_Syntax_Syntax.U_max us1,FStar_Syntax_Syntax.U_max us2)
                ...
                then
                  ...
                  (let uu____5413 =
                     let uu____5414 = FStar_Syntax_Print.univ_to_string u12
                        in
                     let uu____5415 = FStar_Syntax_Print.univ_to_string u22
                        in
                     FStar_Util.format2
          ...
          | (FStar_Syntax_Syntax.U_unif v1,u)
            |(u,FStar_Syntax_Syntax.U_unif v1) ->
              ...
              then
                ...
                (let uu____5479 = extend_solution pid_orig [UNIV (v1, u3)] wl
                    in
                 USolved uu____5479)
      ...
      (match uu____5585 with
       | (bs2,mk_cod2) ->
           let curry n1 bs mk_cod =
             ...
             | (bs3,rest) ->
                 let uu____5646 = mk_cod rest  in (bs3, uu____5646)
              in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____5900  ->
                          ...
                          | (c,uu____5905,uu____5906) -> c < probs.ctr))
                   in
        ...
        fun t2  ->
          fun wl  ->
            let rec aux wl1 us1 us2 =
              ...
              | ([],[]) -> USolved wl1
              | (u1::us11,u2::us21) ->
                  let uu____6007 = solve_universe_eq (p_pid orig) wl1 u1 u2
                     in
                   ...
                   (match mr with
                    ...
                    | HeadMatch  ->
                        let uu____6151 =
                          ...
                          | None  ->
                              let uu____6164 = FStar_Syntax_Subst.compress t1
                                 in
                              let uu____6165 = FStar_Syntax_Subst.compress t2
                                 in
                                     ...
                                     (match uu____6376 with
                                      | (u',uu____6387) ->
                                          let uu____6402 =
                                            ...
                                            uu____6403.FStar_Syntax_Syntax.n
                                             in
             ...
             (match uu____6585 with
              | (ok,head_match1,partial_match,fallback,failed_match) ->
                  ...
                  let base_types_match t1 t2 =
                    ...
                    | (h1,args1) ->
                        let uu____6644 = FStar_Syntax_Util.head_and_args t2
                           in
                                     ...
                                     (match tp1.FStar_TypeChecker_Common.rank
                                      ...
                                      | Some rank1 when is_flex_rigid rank1
                                          ...
                                          (match uu____6936 with
                                           | (u',uu____6947) ->
                                               let uu____6962 =
                                                 let uu____6963 = whnf env u'
                                                    in
                                                 uu____6963.FStar_Syntax_Syntax.n
                                                  in
                    ...
                    (match uu____7280 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi1 =
                           ...
                           FStar_Syntax_Util.mk_conj uu____7298 uu____7301
                            in
                         ((let uu____7307 =
                             FStar_All.pipe_left
      ...
      fun wl  ->
              ...
              (match (m, o) with
                            ...
                            | None  ->
                                ...
                                let uu____7437 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t11
                                    uu____7438 t21
                                   in
                                FStar_Syntax_Util.mk_forall u_x x uu____7437
                             in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
               ...
               | (uu____7451,None ) ->
                   ((let uu____7458 =
                     ...
                     if uu____7458
                     then
                       let uu____7459 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____7460 = FStar_Syntax_Print.tag_of_term t1  in
                       let uu____7461 = FStar_Syntax_Print.term_to_string t2
                          in
                    ...
                    (let uu____7464 = FStar_Syntax_Util.head_and_args t1  in
                     ...
                     | (head11,args1) ->
                         let uu____7490 = FStar_Syntax_Util.head_and_args t2
                            in
                                   ...
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____7539 =
                                        FStar_Syntax_Util.eq_args args1 args2
                                         in
                                      uu____7539 = FStar_Syntax_Util.Equal)
                                    in
                                 if uu____7536
                                 then
                                   let uu____7540 =
               ...
               | (sub_probs,gs_xs,formula) ->
                   ...
                   ((let uu____7830 =
                     ...
                     then
                       ...
                       let uu____7832 = FStar_Syntax_Print.comp_to_string c
                          in
                       let uu____7833 = FStar_Syntax_Print.term_to_string im
                          in
              ...
              (match uu____7944 with
               | (pi,uu____7947) ->
                   ...
                   (match uu____7952 with
                    | (xi,uu____7959) ->
                        let rec gs k =
                          let uu____7968 = FStar_Syntax_Util.arrow_formals k
                             in
                                              ...
                                              let uu____8065 =
                                                let uu____8067 =
                                                  FStar_Syntax_Syntax.as_arg
                                                   ...
                                                   in
                                                uu____8067 :: gi_ps'  in
                                              (uu____8062, uu____8065)))
                                 in
                              aux [] bs
                           in
                        let uu____8070 =
                          let uu____8071 = matches pi  in
                          FStar_All.pipe_left Prims.op_Negation uu____8071
                           in
                        if uu____8070
                        then None
                        else
                          (let uu____8074 = gs xi.FStar_Syntax_Syntax.sort
                              in
                           ...
                           | (g_xs,uu____8081) ->
                               ...
                               ((let uu____8166 =
                                 ...
                                 then
                                   let uu____8167 =
                                     FStar_Syntax_Print.term_to_string proj
                                      in
                                   let uu____8168 = prob_to_string env1 sub1
                                      in
                                   FStar_Util.print2
                                     "Projecting %s\n\tsubprob=%s\n"
                                ...
                                (let wl2 =
                                 ...
                                 FStar_All.pipe_left
                                   (fun _0_55  -> Some _0_55) uu____8178)))))
           in
        let solve_t_flex_rigid patterns_only orig lhs t2 wl1 =
          ...
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
              let subterms ps =
                let uu____8225 = FStar_Syntax_Util.arrow_formals_comp k_uv
                   in
                    ...
                    then
                      ...
                      (let k_uv1 =
                       ...
                       let rec elim k args =
                         let uu____8356 =
                           let uu____8360 =
                             let uu____8361 = FStar_Syntax_Subst.compress k
                                in
                         ...
                         | uu____8689 ->
                             let uu____8693 =
                               ...
                               FStar_Util.format3
                                 ...
                                 uu____8694 uu____8698 uu____8699
                                in
                             failwith uu____8693
                          in
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____8978 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____8979
                             in
                              ...
                              then
                                ...
                                ((let uu____8987 =
                                 ...
                                 (let sol =
                                    ...
                                    | [] -> t21
                                    | uu____8995 ->
                                        let uu____8996 = sn_binders env vars
                                           in
                                        u_abs k_uv uu____8996 t21
                                     in
                                  let wl2 =
                    ...
                    | (all_formals,uu____9115) ->
                        let rec aux pat_args pattern_vars pattern_var_set
                          ...
                          | (formal::formals1,hd1::tl1) ->
                              let uu____9353 = pat_var_opt env pat_args hd1
                                 in
                        ...
                        let uu____9414 = FStar_Syntax_Syntax.new_bv_set ()
                           in
                        aux [] [] uu____9414 all_formals args)
                in
                           ...
                           then
                             ...
                             (let uu____9727 =
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____9728 uu____9729 uu____9730
                                 in
                              failwith uu____9727)
                          in
                       let uu____9731 =
                                  ...
                                  (match uu____9797 with
                                   ...
                                   | uu____9823 ->
                                       ...
                                       (match uu____9826 with
                                        | (t,uu____9835) ->
                                            let uu____9836 = new_uvar r zs t
                                               in
             ...
             let solve_one_pat uu____9986 uu____9987 =
               ...
               | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                   ((let uu____10091 =
                     ...
                     if uu____10091
                     then
                       let uu____10092 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____10093 = FStar_Syntax_Print.term_to_string t2
                          in
                       FStar_Util.print2
                    ...
                    (let uu____10095 = FStar_Unionfind.equivalent u1 u2  in
                     ...
                     then
                       ...
                       (let t21 = sn env t2  in
                        ...
                        let uu____10140 = occurs_check env wl (u1, k1) t21
                           in
                             ...
                             (let uu____10244 =
                              ...
                              | (sol,uu____10251) ->
                                  ...
                                  ((let uu____10254 =
                                    ...
                                    if uu____10254
                                    then
                                      let uu____10255 = uvi_to_string env sol
                                         in
                                      FStar_Util.print1
                     ...
                     | bs ->
                         let uu____10332 =
                           FStar_Syntax_Syntax.mk
                            ...
                            in
                         FStar_Syntax_Syntax.mk_Total uu____10332
                      in
                   let uu____10342 =
                               ...
                               fun subst1  ->
                                 let uu____10625 =
                                   ...
                                   mk_problem scope orig uu____10628
                                     problem.FStar_TypeChecker_Common.relation
                                     uu____10629 None "lambda co-domain"
                                    in
                                 FStar_All.pipe_left
                                   (fun _0_62  ->
                   ...
                   (match uu____10687 with
                    ...
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs)
                      |(FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____10767
                        then
                          let uu____10768 = destruct_flex_pattern env not_abs
                             in
                               ...
                               let guard =
                                 let uu____10848 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives.fst
                                    in
                                 FStar_Syntax_Util.mk_conj uu____10848 impl
                                  in
                 ...
                 |(FStar_Syntax_Syntax.Tm_uinst _,_)
                  |(FStar_Syntax_Syntax.Tm_name _,_)
                   ...
                   let head1 =
                     ...
                     FStar_All.pipe_right uu____11220 FStar_Pervasives.fst
                      in
                   let head2 =
                     let uu____11251 = FStar_Syntax_Util.head_and_args t2  in
                     FStar_All.pipe_right uu____11251 FStar_Pervasives.fst
                      in
                   let uu____11279 =
                   ...
                   then
                     ...
                     (if uu____11288
                      then
                        let guard =
                          let uu____11295 =
                            let uu____11296 = FStar_Syntax_Util.eq_tm t1 t2
                               in
                               ...
                               then
                                 ((let uu____11671 =
                                  ...
                                  (let uu____11673 =
                                     let uu____11676 =
                                       ...
                                       FStar_Syntax_Syntax.Tm_app uu____11677
                                        in
                                 ...
                                 (let uu____11707 =
                                    let uu____11710 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_app uu____11711
                                       in
        ...
        FStar_All.pipe_right (snd ineqs)
          (FStar_List.map
             (fun uu____11991  ->
                ...
                | (u1,u2) ->
                    let uu____11996 = FStar_Syntax_Print.univ_to_string u1
                       in
                    let uu____11997 = FStar_Syntax_Print.univ_to_string u2
                       in
                    FStar_Util.format2 "%s < %s" uu____11996 uu____11997))
         in
...
let new_t_problem env lhs rel rhs elt loc =
  let reason =
    ...
    if uu____12084
    then
      let uu____12085 = FStar_TypeChecker_Normalize.term_to_string env lhs
         in
      let uu____12086 = FStar_TypeChecker_Normalize.term_to_string env rhs
         in
          ...
          (let prob =
           ...
           let g =
             let uu____12271 =
               ...
               solve_and_commit env uu____12273 (fun uu____12274  -> None)
                in
      ...
      fun c2  ->
        ...
        (let rel =
         ...
         let prob =
           ...
           FStar_All.pipe_left
             (fun _0_78  -> FStar_TypeChecker_Common.CProb _0_78) uu____12386
            in
         let uu____12392 =
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____12439 =
                 let uu____12440 =
                   let uu____12443 =
                     let uu____12444 = FStar_Syntax_Print.univ_to_string u1
                        in
                     let uu____12445 = FStar_Syntax_Print.univ_to_string u2
                        in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____12444 uu____12445
                      in
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____12480 = FStar_Syntax_Subst.compress_univ v1
                         in
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____12716 =
                   ...
                   if uu____12716
                   then
                     let uu____12717 = FStar_TypeChecker_Env.get_range env
                        in
                     let uu____12718 =
                       let uu____12719 = FStar_Syntax_Print.term_to_string vc
                          in
                   ...
                   | FStar_TypeChecker_Common.NonTrivial vc2 ->
                       ...
                       then None
                         ...
                         ((let uu____12728 =
                          ...
                          (let vcs =
                             let uu____12737 = FStar_Options.use_tactics ()
                                in
                             if uu____12737
                             then
      ...
      | (reason,uu____12960,uu____12961,e,t,r)::uu____12965 ->
          let uu____12979 =
            ...
            FStar_Util.format3
              ...
              uu____12980 uu____12981 reason
             in
