      ...
      | Some g1 ->
          ...
          let uu____63 =
                ...
                uu____66 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___134_64.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___134_64.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___134_64.FStar_TypeChecker_Env.implicits)
            } in
          Some uu____63
let apply_guard:
    ...
    fun e  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              uu____106 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___135_104.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___135_104.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___135_104.FStar_TypeChecker_Env.implicits)
          }
let map_guard:
  FStar_TypeChecker_Env.guard_t ->
    ...
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            FStar_TypeChecker_Common.NonTrivial uu____147 in
          {
            ...
            FStar_TypeChecker_Env.deferred =
              (uu___136_145.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___136_145.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___136_145.FStar_TypeChecker_Env.implicits)
          }
...
let check_trivial:
  ...
  fun t  ->
    let uu____165 =
      let uu____166 = FStar_Syntax_Util.unmeta t in
    ...
    fun bs  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu___137_250 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (FStar_TypeChecker_Common.NonTrivial f1);
              FStar_TypeChecker_Env.deferred =
                (uu___137_250.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___137_250.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___137_250.FStar_TypeChecker_Env.implicits)
            }
let close_forall:
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____279 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___138_277.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___138_277.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___138_277.FStar_TypeChecker_Env.implicits)
            }
let new_uvar:
  FStar_Range.range ->
    FStar_Syntax_Syntax.binders ->
...
let singleton':
  ...
  fun env  ->
    fun prob  ->
      fun smt_ok  ->
        let uu___139_780 = empty_worklist env in
        {
          attempting = [prob];
          wl_deferred = (uu___139_780.wl_deferred);
          ctr = (uu___139_780.ctr);
          defer_ok = (uu___139_780.defer_ok);
          smt_ok;
          tcenv = (uu___139_780.tcenv)
        }
let singleton:
  FStar_TypeChecker_Env.env -> FStar_TypeChecker_Common.prob -> worklist =
  fun env  -> fun prob  -> singleton' env prob true
let wl_of_guard env g =
  let uu___140_805 = empty_worklist env in
  let uu____806 = FStar_List.map FStar_Pervasives.snd g in
  {
    attempting = uu____806;
    wl_deferred = (uu___140_805.wl_deferred);
    ctr = (uu___140_805.ctr);
    defer_ok = false;
    smt_ok = (uu___140_805.smt_ok);
    tcenv = (uu___140_805.tcenv)
  }
let defer:
  ...
  fun reason  ->
    fun prob  ->
      fun wl  ->
        let uu___141_818 = wl in
        {
          attempting = (uu___141_818.attempting);
          wl_deferred = (((wl.ctr), reason, prob) :: (wl.wl_deferred));
          ctr = (uu___141_818.ctr);
          defer_ok = (uu___141_818.defer_ok);
          smt_ok = (uu___141_818.smt_ok);
          tcenv = (uu___141_818.tcenv)
        }
  ...
  fun probs  ->
    fun wl  ->
      let uu___142_830 = wl in
      {
        ...
        wl_deferred = (uu___142_830.wl_deferred);
...
let invert_rel: FStar_TypeChecker_Common.rel -> FStar_TypeChecker_Common.rel
  =
  fun uu___109_846  ->
    match uu___109_846 with
    | FStar_TypeChecker_Common.EQ  -> FStar_TypeChecker_Common.EQ
    | FStar_TypeChecker_Common.SUB  -> FStar_TypeChecker_Common.SUBINV
    | FStar_TypeChecker_Common.SUBINV  -> FStar_TypeChecker_Common.SUB
let invert p =
  let uu___143_862 = p in
  {
    FStar_TypeChecker_Common.pid =
      (uu___143_862.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = (p.FStar_TypeChecker_Common.rhs);
    FStar_TypeChecker_Common.relation =
      (invert_rel p.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = (p.FStar_TypeChecker_Common.lhs);
    FStar_TypeChecker_Common.element =
      (uu___143_862.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___143_862.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___143_862.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___143_862.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___143_862.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___143_862.FStar_TypeChecker_Common.rank)
  }
let maybe_invert p =
...
let vary_rel:
  ...
  fun rel  ->
    fun uu___111_899  ->
      match uu___111_899 with
      | INVARIANT  -> FStar_TypeChecker_Common.EQ
      | CONTRAVARIANT  -> invert_rel rel
      | COVARIANT  -> rel
let p_pid: FStar_TypeChecker_Common.prob -> Prims.int =
  fun uu___112_902  ->
    match uu___112_902 with
...
let p_reason: FStar_TypeChecker_Common.prob -> Prims.string Prims.list =
  fun uu___114_921  ->
    match uu___114_921 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.reason
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.reason
let p_loc: FStar_TypeChecker_Common.prob -> FStar_Range.range =
  fun uu___115_931  ->
    match uu___115_931 with
...
let p_scope: FStar_TypeChecker_Common.prob -> FStar_Syntax_Syntax.binders =
  fun uu___117_953  ->
    match uu___117_953 with
    | FStar_TypeChecker_Common.TProb p -> p.FStar_TypeChecker_Common.scope
    | FStar_TypeChecker_Common.CProb p -> p.FStar_TypeChecker_Common.scope
let p_invert: FStar_TypeChecker_Common.prob -> FStar_TypeChecker_Common.prob
  =
  fun uu___118_962  ->
    match uu___118_962 with
    | FStar_TypeChecker_Common.TProb p ->
        FStar_All.pipe_left
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun uu____1332  ->
              ...
              | (x,imp) ->
                  let uu____1339 =
                    let uu___144_1340 = x in
                    let uu____1341 = sn env x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___144_1340.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___144_1340.FStar_Syntax_Syntax.index);
          ...
          fun wl  ->
            ...
            | (uu____2067,uv) ->
                ((let uu____2070 =
                 ...
                 commit uvis;
                 (let uu___145_2101 = wl in
                  {
                    attempting = (uu___145_2101.attempting);
                    wl_deferred = (uu___145_2101.wl_deferred);
                    ctr = (wl.ctr + (Prims.parse_int "1"));
                    defer_ok = (uu___145_2101.defer_ok);
                    smt_ok = (uu___145_2101.smt_ok);
                    tcenv = (uu___145_2101.tcenv)
                  }))
  ...
  fun pid  ->
    fun sol  ->
      fun wl  ->
        ...
        commit sol;
        (let uu___146_2122 = wl in
         {
           attempting = (uu___146_2122.attempting);
           wl_deferred = (uu___146_2122.wl_deferred);
           ctr = (wl.ctr + (Prims.parse_int "1"));
           defer_ok = (uu___146_2122.defer_ok);
           smt_ok = (uu___146_2122.smt_ok);
           tcenv = (uu___146_2122.tcenv)
         })
let solve_prob:
  FStar_TypeChecker_Common.prob ->
...
let rec decompose:
  ...
  fun env  ->
    fun t  ->
               ...
               let rebuild tcs =
                 let rec aux out bs2 tcs1 =
                   ...
                   | ((x,imp)::bs3,(T (t2,uu____3970))::tcs2) ->
                       aux
                         (((let uu___147_3992 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___147_3992.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___147_3992.FStar_Syntax_Syntax.index);
                 ...
                 aux [] bs1 tcs in
               let rec decompose1 out uu___124_4033 =
                 match uu___124_4033 with
      ...
      | uu____4124 ->
          let rebuild uu___125_4129 =
            match uu___125_4129 with
            | [] -> t1
            | uu____4131 -> failwith "Bad reconstruction" in
          (rebuild, ((fun t2  -> true)), [])
let un_T: tc -> FStar_Syntax_Syntax.term =
  fun uu___126_4150  ->
    match uu___126_4150 with
    | T (t,uu____4152) -> t
    | uu____4161 -> failwith "Impossible"
let arg_of_tc: tc -> FStar_Syntax_Syntax.arg =
  fun uu___127_4164  ->
    match uu___127_4164 with
...
let compress_tprob wl p =
  ...
  {
    FStar_TypeChecker_Common.pid =
      (uu___148_4854.FStar_TypeChecker_Common.pid);
    FStar_TypeChecker_Common.lhs = uu____4857;
    FStar_TypeChecker_Common.relation =
      (uu___148_4854.FStar_TypeChecker_Common.relation);
    FStar_TypeChecker_Common.rhs = uu____4858;
    FStar_TypeChecker_Common.element =
      (uu___148_4854.FStar_TypeChecker_Common.element);
    FStar_TypeChecker_Common.logical_guard =
      (uu___148_4854.FStar_TypeChecker_Common.logical_guard);
    FStar_TypeChecker_Common.scope =
      (uu___148_4854.FStar_TypeChecker_Common.scope);
    FStar_TypeChecker_Common.reason =
      (uu___148_4854.FStar_TypeChecker_Common.reason);
    FStar_TypeChecker_Common.loc =
      (uu___148_4854.FStar_TypeChecker_Common.loc);
    FStar_TypeChecker_Common.rank =
      (uu___148_4854.FStar_TypeChecker_Common.rank)
  }
let compress_prob:
  ...
  fun wl  ->
    fun pr  ->
                ...
                | (rh,uu____4934) ->
                           ...
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5034 ->
                                    ...
                                    let uu____5043 =
                                      let uu___149_5046 = tp in
                                      let uu____5049 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___149_5046.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          (uu___149_5046.FStar_TypeChecker_Common.lhs);
                                        FStar_TypeChecker_Common.relation =
                                          (uu___149_5046.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          uu____5049;
                                        FStar_TypeChecker_Common.element =
                                          (uu___149_5046.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___149_5046.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___149_5046.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___149_5046.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___149_5046.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___149_5046.FStar_TypeChecker_Common.rank)
                                      } in
                                    (rank, uu____5043)))
                          ...
                          (match uu____5069 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5109 ->
                                    let uu____5115 =
                                      let uu___150_5120 = tp in
                                      let uu____5123 =
                                        force_refinement (b, ref_opt) in
                                      {
                                        FStar_TypeChecker_Common.pid =
                                          (uu___150_5120.FStar_TypeChecker_Common.pid);
                                        FStar_TypeChecker_Common.lhs =
                                          uu____5123;
                                        FStar_TypeChecker_Common.relation =
                                          (uu___150_5120.FStar_TypeChecker_Common.relation);
                                        FStar_TypeChecker_Common.rhs =
                                          (uu___150_5120.FStar_TypeChecker_Common.rhs);
                                        FStar_TypeChecker_Common.element =
                                          (uu___150_5120.FStar_TypeChecker_Common.element);
                                        FStar_TypeChecker_Common.logical_guard
                                          =
                                          (uu___150_5120.FStar_TypeChecker_Common.logical_guard);
                                        FStar_TypeChecker_Common.scope =
                                          (uu___150_5120.FStar_TypeChecker_Common.scope);
                                        FStar_TypeChecker_Common.reason =
                                          (uu___150_5120.FStar_TypeChecker_Common.reason);
                                        FStar_TypeChecker_Common.loc =
                                          (uu___150_5120.FStar_TypeChecker_Common.loc);
                                        FStar_TypeChecker_Common.rank =
                                          (uu___150_5120.FStar_TypeChecker_Common.rank)
                                      } in
                    ...
                    (match uu____4949 with
                     | (rank,tp1) ->
                         let uu____5151 =
                           FStar_All.pipe_right
                             (let uu___151_5154 = tp1 in
                              {
                                FStar_TypeChecker_Common.pid =
                                  (uu___151_5154.FStar_TypeChecker_Common.pid);
                                FStar_TypeChecker_Common.lhs =
                                  (uu___151_5154.FStar_TypeChecker_Common.lhs);
                                FStar_TypeChecker_Common.relation =
                                  (uu___151_5154.FStar_TypeChecker_Common.relation);
                                FStar_TypeChecker_Common.rhs =
                                  (uu___151_5154.FStar_TypeChecker_Common.rhs);
                                FStar_TypeChecker_Common.element =
                                  (uu___151_5154.FStar_TypeChecker_Common.element);
                                FStar_TypeChecker_Common.logical_guard =
                                  (uu___151_5154.FStar_TypeChecker_Common.logical_guard);
                                FStar_TypeChecker_Common.scope =
                                  (uu___151_5154.FStar_TypeChecker_Common.scope);
                                FStar_TypeChecker_Common.reason =
                                  (uu___151_5154.FStar_TypeChecker_Common.reason);
                                FStar_TypeChecker_Common.loc =
                                  (uu___151_5154.FStar_TypeChecker_Common.loc);
      ...
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____5160 =
            FStar_All.pipe_right
              (let uu___152_5163 = cp in
               {
                 FStar_TypeChecker_Common.pid =
                   (uu___152_5163.FStar_TypeChecker_Common.pid);
                 FStar_TypeChecker_Common.lhs =
                   (uu___152_5163.FStar_TypeChecker_Common.lhs);
                 FStar_TypeChecker_Common.relation =
                   (uu___152_5163.FStar_TypeChecker_Common.relation);
                 FStar_TypeChecker_Common.rhs =
                   (uu___152_5163.FStar_TypeChecker_Common.rhs);
                 FStar_TypeChecker_Common.element =
                   (uu___152_5163.FStar_TypeChecker_Common.element);
                 FStar_TypeChecker_Common.logical_guard =
                   (uu___152_5163.FStar_TypeChecker_Common.logical_guard);
                 FStar_TypeChecker_Common.scope =
                   (uu___152_5163.FStar_TypeChecker_Common.scope);
                 FStar_TypeChecker_Common.reason =
                   (uu___152_5163.FStar_TypeChecker_Common.reason);
                 FStar_TypeChecker_Common.loc =
                   (uu___152_5163.FStar_TypeChecker_Common.loc);
  ...
  fun env  ->
    fun probs  ->
      ...
      (let uu____5829 = next_prob probs in
       ...
       | (Some hd1,tl1,rank1) ->
           let probs1 =
             let uu___153_5842 = probs in
             {
               attempting = tl1;
               wl_deferred = (uu___153_5842.wl_deferred);
               ctr = (uu___153_5842.ctr);
               defer_ok = (uu___153_5842.defer_ok);
               smt_ok = (uu___153_5842.smt_ok);
               tcenv = (uu___153_5842.tcenv)
             } in
           (match hd1 with
            | FStar_TypeChecker_Common.CProb cp ->
                      ...
                      | uu____5943 ->
                          let uu____5948 =
                                      ...
                                      | (uu____5963,uu____5964,y) -> y)) in
                            {
                              ...
                              wl_deferred = rest;
                              ctr = (uu___154_5949.ctr);
                              defer_ok = (uu___154_5949.defer_ok);
                              smt_ok = (uu___154_5949.smt_ok);
                              tcenv = (uu___154_5949.tcenv)
                            } in
                       ...
                       (match uu____6503 with
                        ...
                        | Some (lhs_bound,sub_probs) ->
                            ...
                            ((let uu____6532 =
                              ...
                              then
                                let wl' =
                                  let uu___155_6534 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred = (uu___155_6534.wl_deferred);
                                    ctr = (uu___155_6534.ctr);
                                    defer_ok = (uu___155_6534.defer_ok);
                                    smt_ok = (uu___155_6534.smt_ok);
                                    tcenv = (uu___155_6534.tcenv)
                                  } in
                             ...
                             (let uu____6537 =
                                solve_t env eq_prob
                                  (let uu___156_6538 = wl in
                                   {
                                     attempting = sub_probs;
                                     wl_deferred =
                                       (uu___156_6538.wl_deferred);
                                     ctr = (uu___156_6538.ctr);
                                     defer_ok = (uu___156_6538.defer_ok);
                                     smt_ok = (uu___156_6538.smt_ok);
                                     tcenv = (uu___156_6538.tcenv)
                                   }) in
                              match uu____6537 with
                              | Success uu____6540 ->
                                  let wl1 =
                                    let uu___157_6542 = wl in
                                    {
                                      attempting = rest;
                                      wl_deferred =
                                        (uu___157_6542.wl_deferred);
                                      ctr = (uu___157_6542.ctr);
                                      defer_ok = (uu___157_6542.defer_ok);
                                      smt_ok = (uu___157_6542.smt_ok);
                                      tcenv = (uu___157_6542.tcenv)
                                    } in
                                  let wl2 =
                                    solve_prob' false
                                      (FStar_TypeChecker_Common.TProb tp)
                            ...
                            (match uu____7101 with
                             ...
                             | Some (rhs_bound,sub_probs) ->
                                 ...
                                 ((let uu____7142 =
                                   ...
                                   then
                                     let wl' =
                                       let uu___158_7144 = wl in
                                       {
                                         attempting =
                                           ((FStar_TypeChecker_Common.TProb
                                               eq_prob) :: sub_probs);
                                         wl_deferred =
                                           (uu___158_7144.wl_deferred);
                                         ctr = (uu___158_7144.ctr);
                                         defer_ok = (uu___158_7144.defer_ok);
                                         smt_ok = (uu___158_7144.smt_ok);
                                         tcenv = (uu___158_7144.tcenv)
                                       } in
                                  ...
                                  (let uu____7147 =
                                     solve_t env eq_prob
                                       (let uu___159_7148 = wl in
                                        {
                                          attempting = sub_probs;
                                          wl_deferred =
                                            (uu___159_7148.wl_deferred);
                                          ctr = (uu___159_7148.ctr);
                                          defer_ok = (uu___159_7148.defer_ok);
                                          smt_ok = (uu___159_7148.smt_ok);
                                          tcenv = (uu___159_7148.tcenv)
                                        }) in
                                   match uu____7147 with
                                   | Success uu____7150 ->
                                       let wl1 =
                                         let uu___160_7152 = wl in
                                         {
                                           attempting = rest;
                                           wl_deferred =
                                             (uu___160_7152.wl_deferred);
                                           ctr = (uu___160_7152.ctr);
                                           defer_ok =
                                             (uu___160_7152.defer_ok);
                                           smt_ok = (uu___160_7152.smt_ok);
                                           tcenv = (uu___160_7152.tcenv)
                                         } in
                                       let wl2 =
                                         solve_prob' false
                                           (FStar_TypeChecker_Common.TProb tp)
            ...
            fun rhs  ->
              let rec aux scope env1 subst1 xs ys =
                ...
                | ((hd1,imp)::xs1,(hd2,imp')::ys1) when imp = imp' ->
                    let hd11 =
                      let uu___161_7256 = hd1 in
                      let uu____7257 =
                        FStar_Syntax_Subst.subst subst1
                          hd1.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___161_7256.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___161_7256.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = uu____7257
                      } in
                    let hd21 =
                      let uu___162_7261 = hd2 in
                      let uu____7262 =
                        FStar_Syntax_Subst.subst subst1
                          hd2.FStar_Syntax_Syntax.sort in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___162_7261.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___162_7261.FStar_Syntax_Syntax.index);
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
          ...
          | (m,o) ->
              (match (m, o) with
               ...
               | (uu____7442,Some (t11,t21)) ->
                   solve_t env1
                     (let uu___163_7450 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___163_7450.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___163_7450.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___163_7450.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___163_7450.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___163_7450.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___163_7450.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___163_7450.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___163_7450.FStar_TypeChecker_Common.rank)
                      }) wl1
               | (uu____7451,None ) ->
                   ((let uu____7458 =
                                                  ...
                                                  solve_t env1
                                                    (let uu___164_7697 =
                                                       problem in
                                                     {
                                                       FStar_TypeChecker_Common.pid
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.pid);
                                                       FStar_TypeChecker_Common.lhs
                                                         = lhs;
                                                       FStar_TypeChecker_Common.relation
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.relation);
                                                       FStar_TypeChecker_Common.rhs
                                                         = rhs;
                                                       FStar_TypeChecker_Common.element
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.element);
                                                       FStar_TypeChecker_Common.logical_guard
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.logical_guard);
                                                       FStar_TypeChecker_Common.scope
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.scope);
                                                       FStar_TypeChecker_Common.reason
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.reason);
                                                       FStar_TypeChecker_Common.loc
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.loc);
                                                       FStar_TypeChecker_Common.rank
                                                         =
                                                         (uu___164_7697.FStar_TypeChecker_Common.rank)
                                                     }) wl1)))))))) in
        ...
        let imitate' orig env1 wl1 uu___130_7857 =
          match uu___130_7857 with
              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_arrow
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___131_10318 =
                     match uu___131_10318 with
                     | [] -> c
                     | bs ->
                         let uu____10332 =
                           FStar_Syntax_Syntax.mk
               ...
               | (FStar_Syntax_Syntax.Tm_abs
                  ...
                  (bs2,tbody2,lopt2)) ->
                   let mk_t t l uu___132_10507 =
                     match uu___132_10507 with
                     | [] -> t
                     | bs ->
                         FStar_Syntax_Syntax.mk
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_abs _) ->
                   ...
                   (match uu____10687 with
                    | (FStar_Util.Inl t11,FStar_Util.Inl t21) ->
                        solve_t env
                          (let uu___165_10734 = problem in
                           {
                             FStar_TypeChecker_Common.pid =
                               (uu___165_10734.FStar_TypeChecker_Common.pid);
                             FStar_TypeChecker_Common.lhs = t11;
                             FStar_TypeChecker_Common.relation =
                               (uu___165_10734.FStar_TypeChecker_Common.relation);
                             FStar_TypeChecker_Common.rhs = t21;
                             FStar_TypeChecker_Common.element =
                               (uu___165_10734.FStar_TypeChecker_Common.element);
                             FStar_TypeChecker_Common.logical_guard =
                               (uu___165_10734.FStar_TypeChecker_Common.logical_guard);
                             FStar_TypeChecker_Common.scope =
                               (uu___165_10734.FStar_TypeChecker_Common.scope);
                             FStar_TypeChecker_Common.reason =
                               (uu___165_10734.FStar_TypeChecker_Common.reason);
                             FStar_TypeChecker_Common.loc =
                               (uu___165_10734.FStar_TypeChecker_Common.loc);
                             FStar_TypeChecker_Common.rank =
                               (uu___165_10734.FStar_TypeChecker_Common.rank)
                           }) wl
                        ...
                        (match uu____10799 with
                         | (x2,phi2) ->
                             ...
                             then
                               ...
                               let uu____10862 =
                                 solve env1
                                   (let uu___166_10863 = wl in
                                    {
                                      attempting = [ref_prob];
                                      wl_deferred = [];
                                      ctr = (uu___166_10863.ctr);
                                      defer_ok = false;
                                      smt_ok = (uu___166_10863.smt_ok);
                                      tcenv = (uu___166_10863.tcenv)
                                    }) in
                               (match uu____10862 with
                                ...
                                | Success uu____10870 ->
                                    ...
                                    let wl2 =
                                      let uu___167_10885 = wl1 in
                                      {
                                        attempting =
                                          (uu___167_10885.attempting);
                                        wl_deferred =
                                          (uu___167_10885.wl_deferred);
                                        ctr =
                                          (wl1.ctr + (Prims.parse_int "1"));
                                        defer_ok = (uu___167_10885.defer_ok);
                                        smt_ok = (uu___167_10885.smt_ok);
                                        tcenv = (uu___167_10885.tcenv)
                                      } in
               ...
               | (FStar_Syntax_Syntax.Tm_uvar _,FStar_Syntax_Syntax.Tm_type
                 ...
                 |(FStar_Syntax_Syntax.Tm_app
                  ...
                  |(FStar_Syntax_Syntax.Tm_uvar
                   ...
                   ->
                   solve_t' env
                     (let uu___168_11005 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___168_11005.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___168_11005.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___168_11005.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___168_11005.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___168_11005.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___168_11005.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___168_11005.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___168_11005.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___168_11005.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar _,_)
                 |(FStar_Syntax_Syntax.Tm_app
                   ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar _;
                      ...
                      then
                        let uu____11025 =
                          FStar_All.pipe_left
                            ...
                            (let uu___169_11028 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___169_11028.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___169_11028.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___169_11028.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___169_11028.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___169_11028.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___169_11028.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___169_11028.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___169_11028.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___169_11028.FStar_TypeChecker_Common.rank)
                             }) in
                        ...
                        (let uu____11034 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | None  ->
                                  let uu____11064 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___170_11067 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___170_11067.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___170_11067.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___170_11067.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___170_11067.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___170_11067.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___170_11067.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___170_11067.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___170_11067.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___170_11067.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____11068 =
                              ...
                              | Some (y,phi) ->
                                  let y' =
                                    let uu___171_11083 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___171_11083.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___171_11083.FStar_Syntax_Syntax.index);
                 ...
                 |(_,FStar_Syntax_Syntax.Tm_app
                   ...
                   then
                     ...
                     (let uu____11116 = base_and_refinement env wl t1 in
                      ...
                      | (t_base,uu____11127) ->
                          solve_t env
                            (let uu___172_11142 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___172_11142.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___172_11142.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___172_11142.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___172_11142.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___172_11142.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___172_11142.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___172_11142.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___172_11142.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____11145,uu____11146) ->
                   ...
                   solve_t env
                     (let uu___173_11167 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___173_11167.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___173_11167.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___173_11167.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___173_11167.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___173_11167.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___173_11167.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___173_11167.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___173_11167.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___173_11167.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11168,FStar_Syntax_Syntax.Tm_refine uu____11169) ->
                   ...
                   solve_t env
                     (let uu___174_11190 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___174_11190.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___174_11190.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___174_11190.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___174_11190.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___174_11190.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___174_11190.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___174_11190.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___174_11190.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___174_11190.FStar_TypeChecker_Common.rank)
                      }) wl
               ...
               | (FStar_Syntax_Syntax.Tm_ascribed
                  (t11,uu____11305,uu____11306),uu____11307) ->
                   solve_t' env
                     (let uu___175_11336 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___175_11336.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___175_11336.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___175_11336.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___175_11336.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___175_11336.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___175_11336.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___175_11336.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___175_11336.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___175_11336.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____11339,FStar_Syntax_Syntax.Tm_ascribed
                  (t21,uu____11341,uu____11342)) ->
                   solve_t' env
                     (let uu___176_11371 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___176_11371.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___176_11371.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___176_11371.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___176_11371.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___176_11371.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___176_11371.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___176_11371.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___176_11371.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___176_11371.FStar_TypeChecker_Common.rank)
                      }) wl
                 ...
                 | (FStar_Syntax_Syntax.GTotal _,FStar_Syntax_Syntax.Comp _)
                   |(FStar_Syntax_Syntax.Total _,FStar_Syntax_Syntax.Comp _)
                     ...
                     let uu____11856 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___177_11859.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____11862;
                         FStar_TypeChecker_Common.relation =
                           (uu___177_11859.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___177_11859.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___177_11859.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___177_11859.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___177_11859.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___177_11859.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___177_11859.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___177_11859.FStar_TypeChecker_Common.rank)
                       } in
                 ...
                 | (FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.GTotal _)
                   |(FStar_Syntax_Syntax.Comp _,FStar_Syntax_Syntax.Total _)
                     ...
                     let uu____11868 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___178_11871.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___178_11871.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___178_11871.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____11874;
                         FStar_TypeChecker_Common.element =
                           (uu___178_11871.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___178_11871.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___178_11871.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___178_11871.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___178_11871.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___178_11871.FStar_TypeChecker_Common.rank)
                       } in
    ...
    fun probs  ->
      fun err1  ->
        let probs1 =
          ...
          if uu____12141
          then
            let uu___179_12142 = probs in
            {
              attempting = (uu___179_12142.attempting);
              wl_deferred = (uu___179_12142.wl_deferred);
              ctr = (uu___179_12142.ctr);
              defer_ok = false;
              smt_ok = (uu___179_12142.smt_ok);
              tcenv = (uu___179_12142.tcenv)
            }
          else probs in
        let tx = FStar_Unionfind.new_transaction () in
          ...
          ((let uu____12164 =
           ...
           (let f1 =
            ...
            (let f2 =
             ...
             let uu___180_12179 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___180_12179.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___180_12179.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___180_12179.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
    ...
    fun env  ->
      fun uu____12414  ->
        ...
        | (variables,ineqs) ->
            ...
            let uu____12516 =
              let wl =
                let uu___181_12519 = empty_worklist env in
                {
                  attempting = (uu___181_12519.attempting);
                  wl_deferred = (uu___181_12519.wl_deferred);
                  ctr = (uu___181_12519.ctr);
                  defer_ok = false;
                  smt_ok = (uu___181_12519.smt_ok);
                  tcenv = (uu___181_12519.tcenv)
                } in
  ...
  fun env  ->
    fun g  ->
      ...
      (let g1 =
         ...
         | Some [] ->
             let uu___182_12676 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___182_12676.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___182_12676.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___182_12676.FStar_TypeChecker_Env.implicits)
             }
         | uu____12679 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___183_12682 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___183_12682.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___183_12682.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___183_12682.FStar_TypeChecker_Env.implicits)
        }))
let discharge_guard':
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___184_12708 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___184_12708.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___184_12708.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___184_12708.FStar_TypeChecker_Env.implicits)
            } in
          let uu____12709 =
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____12716 =
                  ...
                  (let vc1 =
                   ...
                   let uu____12722 = check_trivial vc1 in
                           ...
                           then
                             ...
                             let uu____12731 =
                               ...
                               FStar_Util.format1 "Checking VC=\n%s\n"
                                 uu____12732 in
                             FStar_Errors.diag uu____12730 uu____12731
                           else ());
                          (let vcs =
                             let uu____12738 = FStar_Options.use_tactics () in
                             if uu____12738
                             then
                           ...
                           FStar_All.pipe_right vcs
                             (FStar_List.iter
                                (fun uu____12753  ->
                                   ...
                                   | (env1,goal) ->
                                       let uu____12758 = check_trivial goal in
                                             ...
                                             (let uu____12765 =
                                              ...
                                              then
                                                ...
                                                let uu____12767 =
                                                  ...
                                                  FStar_Util.format2
                                                    "Trying to solve:\n> %s\nWith proof_ns:\n %s\n"
                                                    uu____12768 uu____12769 in
                                                FStar_Errors.diag uu____12766
                                                  uu____12767
                                              else ());
...
let discharge_guard:
  ...
  fun env  ->
    fun g  ->
      let uu____12777 = discharge_guard' None env g true in
...
let resolve_implicits:
  ...
  fun g  ->
    let unresolved u =
      let uu____12797 = FStar_Unionfind.find u in
      match uu____12797 with
      | FStar_Syntax_Syntax.Uvar  -> true
      | uu____12806 -> false in
    let rec until_fixpoint acc implicits =
      let uu____12821 = acc in
      ...
      | (out,changed) ->
          (match implicits with
           ...
           | hd1::tl1 ->
               let uu____12867 = hd1 in
               (match uu____12867 with
                | (uu____12874,env,u,tm,k,r) ->
                    let uu____12880 = unresolved u in
                    if uu____12880
                       ...
                       (let uu____12898 =
                        ...
                        then
                          ...
                          FStar_Util.print3
                            ...
                            uu____12899 uu____12903 uu____12904
                        else ());
                       (let uu____12906 =
                          env1.FStar_TypeChecker_Env.type_of
                            (let uu___185_12910 = env1 in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___185_12910.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___185_12910.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___185_12910.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___185_12910.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___185_12910.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___185_12910.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___185_12910.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___185_12910.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___185_12910.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___185_12910.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___185_12910.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___185_12910.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___185_12910.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___185_12910.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___185_12910.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___185_12910.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___185_12910.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___185_12910.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___185_12910.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___185_12910.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___185_12910.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___185_12910.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___185_12910.FStar_TypeChecker_Env.qname_and_index);
                               FStar_TypeChecker_Env.proof_ns =
                                 (uu___185_12910.FStar_TypeChecker_Env.proof_ns)
                             }) tm1 in
                        match uu____12906 with
                        | (uu____12911,uu____12912,g1) ->
                            let g2 =
                              if env1.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___186_12915 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___186_12915.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___186_12915.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___186_12915.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____12918 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
    let uu___187_12937 = g in
    let uu____12938 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___187_12937.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___187_12937.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___187_12937.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____12938
    }
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____12966 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____12966 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____12973 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____12973
      | (reason,uu____12975,uu____12976,e,t,r)::uu____12980 ->
          let uu____12994 =
            let uu____12995 = FStar_Syntax_Print.term_to_string t in
            let uu____12996 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____12995 uu____12996 reason in
          FStar_Errors.err r uu____12994
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___188_13003 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___188_13003.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___188_13003.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___188_13003.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____13021 = try_teq false env t1 t2 in
        match uu____13021 with
        | None  -> false
        | Some g ->
            let uu____13024 = discharge_guard' None env g false in
            (match uu____13024 with
             | Some uu____13028 -> true
             | None  -> false)