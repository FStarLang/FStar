              ...
              (let r = FStar_TypeChecker_Env.get_range env in
               ...
               | (FStar_Syntax_Syntax.Tm_refine
                  uu____17439,FStar_Syntax_Syntax.Tm_refine uu____17440) ->
                   ...
                   if remaining_uvars && wl.defer_ok
                   then
                     solve env
                       (defer "refinement subtyping with unsolved variables"
                          orig wl)
                   else
                     (let uu____17482 =
                        as_refinement (Prims.op_Negation remaining_uvars) env
                          wl t1 in
                      ...
                      | (x1,phi1) ->
                          ...
                          (match uu____17489 with
                           | (x2,phi2) ->
                               ...
                               let phi21 =
                                 FStar_Syntax_Subst.subst subst1 phi2 in
                               let env1 =
                                 FStar_TypeChecker_Env.push_bv env x11 in
                               let mk_imp1 imp phi12 phi22 =
                                 let uu____17535 = imp phi12 phi22 in
                                 FStar_All.pipe_right uu____17535
                                   (guard_on_element wl problem x11) in
                               let fallback uu____17539 =
                                 let impl =
                                   if
                                     problem.FStar_TypeChecker_Common.relation
                                       = FStar_TypeChecker_Common.EQ
                                 ...
                                 let guard =
                                   let uu____17545 =
                                     FStar_All.pipe_right (p_guard base_prob)
                                       FStar_Pervasives_Native.fst in
                                   FStar_Syntax_Util.mk_conj uu____17545 impl in
                                 let wl1 =
                                   solve_prob orig
                               ...
                               then
                                   ...
                                   let uu____17554 =
                                     let uu____17559 =
                                       ...
                                       FStar_List.append (p_scope orig)
                                         uu____17560 in
                                     mk_problem uu____17559 orig phi11
                                 ...
                                 let uu____17576 =
                                   solve env1
                                     (let uu___281_17578 = wl in
                                      {
                                        attempting = [ref_prob];
                                        wl_deferred = [];
                                        ctr = (uu___281_17578.ctr);
                                        defer_ok = false;
                                        smt_ok = (uu___281_17578.smt_ok);
                                        tcenv = (uu___281_17578.tcenv)
                                      }) in
                                 (match uu____17576 with
                                  | Failed uu____17585 -> fallback ()
                                  | Success uu____17590 ->
                                      let guard =
                                        let uu____17594 =
                                          FStar_All.pipe_right
                                        ...
                                        let uu____17599 =
                                          ...
                                          FStar_All.pipe_right uu____17600
                                            (guard_on_element wl problem x11) in
                                        FStar_Syntax_Util.mk_conj uu____17594
                                          uu____17599 in
                                      let wl1 =
                                        solve_prob orig
                                          (FStar_Pervasives_Native.Some guard)
                                          [] wl in
                                      let wl2 =
                                        let uu___282_17609 = wl1 in
                                        {
                                          attempting =
                                            (uu___282_17609.attempting);
                                          wl_deferred =
                                            (uu___282_17609.wl_deferred);
                                          ctr =
                                            (wl1.ctr + (Prims.parse_int "1"));
                                          defer_ok =
                                            (uu___282_17609.defer_ok);
                                          smt_ok = (uu___282_17609.smt_ok);
                                          tcenv = (uu___282_17609.tcenv)
                                        } in
                                      solve env1 (attempt [base_prob] wl2))
                               else fallback ()))
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17611,FStar_Syntax_Syntax.Tm_uvar uu____17612) ->
                   let uu____17645 = destruct_flex_t t1 in
                   let uu____17646 = destruct_flex_t t2 in
                   flex_flex1 orig uu____17645 uu____17646
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17647;
                     FStar_Syntax_Syntax.pos = uu____17648;
                     FStar_Syntax_Syntax.vars = uu____17649;_},uu____17650),FStar_Syntax_Syntax.Tm_uvar
                  uu____17651) ->
                   let uu____17704 = destruct_flex_t t1 in
                   let uu____17705 = destruct_flex_t t2 in
                   flex_flex1 orig uu____17704 uu____17705
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17706,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17707;
                     FStar_Syntax_Syntax.pos = uu____17708;
                     FStar_Syntax_Syntax.vars = uu____17709;_},uu____17710))
                   ->
                   let uu____17763 = destruct_flex_t t1 in
                   let uu____17764 = destruct_flex_t t2 in
                   flex_flex1 orig uu____17763 uu____17764
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17765;
                     FStar_Syntax_Syntax.pos = uu____17766;
                     FStar_Syntax_Syntax.vars = uu____17767;_},uu____17768),FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17769;
                   ...
                   ->
                   let uu____17845 = destruct_flex_t t1 in
                   let uu____17846 = destruct_flex_t t2 in
                   flex_flex1 orig uu____17845 uu____17846
               | (FStar_Syntax_Syntax.Tm_uvar uu____17847,uu____17848) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____17865 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____17865 t2 wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17872;
                     FStar_Syntax_Syntax.pos = uu____17873;
                     FStar_Syntax_Syntax.vars = uu____17874;_},uu____17875),uu____17876)
                   when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   ->
                   let uu____17913 = destruct_flex_pattern env t1 in
                   solve_t_flex_rigid false orig uu____17913 t2 wl
               | (uu____17920,FStar_Syntax_Syntax.Tm_uvar uu____17921) when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   -> solve_t env (invert problem) wl
               | (uu____17938,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____17939;
                     FStar_Syntax_Syntax.pos = uu____17940;
                     FStar_Syntax_Syntax.vars = uu____17941;_},uu____17942))
                   when
                   problem.FStar_TypeChecker_Common.relation =
                     FStar_TypeChecker_Common.EQ
                   -> solve_t env (invert problem) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____17979,FStar_Syntax_Syntax.Tm_type uu____17980) ->
                   solve_t' env
                     (let uu___283_17998 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___283_17998.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___283_17998.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___283_17998.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___283_17998.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___283_17998.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___283_17998.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___283_17998.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___283_17998.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___283_17998.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                     ...
                     FStar_Syntax_Syntax.vars = uu____18001;_},uu____18002),FStar_Syntax_Syntax.Tm_type
                  uu____18003) ->
                   solve_t' env
                     (let uu___283_18041 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___283_18041.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___283_18041.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___283_18041.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___283_18041.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___283_18041.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___283_18041.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___283_18041.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___283_18041.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___283_18041.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar
                  uu____18042,FStar_Syntax_Syntax.Tm_arrow uu____18043) ->
                   solve_t' env
                     (let uu___283_18073 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___283_18073.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___283_18073.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___283_18073.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___283_18073.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___283_18073.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___283_18073.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___283_18073.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___283_18073.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___283_18073.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                     ...
                     FStar_Syntax_Syntax.vars = uu____18076;_},uu____18077),FStar_Syntax_Syntax.Tm_arrow
                  uu____18078) ->
                   solve_t' env
                     (let uu___283_18128 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___283_18128.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___283_18128.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          FStar_TypeChecker_Common.EQ;
                        FStar_TypeChecker_Common.rhs =
                          (uu___283_18128.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___283_18128.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___283_18128.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___283_18128.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___283_18128.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___283_18128.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___283_18128.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_uvar uu____18129,uu____18130) ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____18149 =
                        let uu____18150 = is_top_level_prob orig in
                        FStar_All.pipe_left Prims.op_Negation uu____18150 in
                      if uu____18149
                      then
                        let uu____18151 =
                          FStar_All.pipe_left
                            ...
                            (let uu___284_18157 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___284_18157.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___284_18157.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___284_18157.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___284_18157.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___284_18157.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___284_18157.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___284_18157.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___284_18157.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___284_18157.FStar_TypeChecker_Common.rank)
                             }) in
                        let uu____18158 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____18151 uu____18158 t2
                          wl
                      else
                        (let uu____18166 = base_and_refinement env t2 in
                              ...
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18195 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___285_18201 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___285_18201.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___285_18201.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___285_18201.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___285_18201.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___285_18201.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___285_18201.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___285_18201.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___285_18201.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___285_18201.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18202 =
                                    destruct_flex_pattern env t1 in
                                  solve_t_flex_rigid false uu____18195
                                    uu____18202 t_base wl
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___286_18216 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___286_18216.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___286_18216.FStar_Syntax_Syntax.index);
                                  ...
                                  let guard =
                                    let uu____18231 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob)
                                        FStar_Pervasives_Native.fst in
                                    FStar_Syntax_Util.mk_conj uu____18231
                                      impl in
                                  let wl1 =
                                    solve_prob orig
                                      (FStar_Pervasives_Native.Some guard) []
               ...
               | (FStar_Syntax_Syntax.Tm_app
                  ({
                     ...
                     FStar_Syntax_Syntax.vars = uu____18241;_},uu____18242),uu____18243)
                   ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____18282 =
                        let uu____18283 = is_top_level_prob orig in
                        FStar_All.pipe_left Prims.op_Negation uu____18283 in
                      if uu____18282
                      then
                        let uu____18284 =
                          FStar_All.pipe_left
                            ...
                            (let uu___284_18290 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___284_18290.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs =
                                 (uu___284_18290.FStar_TypeChecker_Common.lhs);
                               FStar_TypeChecker_Common.relation = new_rel;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___284_18290.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___284_18290.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___284_18290.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___284_18290.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___284_18290.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___284_18290.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___284_18290.FStar_TypeChecker_Common.rank)
                             }) in
                        let uu____18291 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____18284 uu____18291 t2
                          wl
                      else
                        (let uu____18299 = base_and_refinement env t2 in
                              ...
                              | FStar_Pervasives_Native.None  ->
                                  let uu____18328 =
                                    FStar_All.pipe_left
                                      ...
                                      (let uu___285_18334 = problem in
                                       {
                                         FStar_TypeChecker_Common.pid =
                                           (uu___285_18334.FStar_TypeChecker_Common.pid);
                                         FStar_TypeChecker_Common.lhs =
                                           (uu___285_18334.FStar_TypeChecker_Common.lhs);
                                         FStar_TypeChecker_Common.relation =
                                           new_rel;
                                         FStar_TypeChecker_Common.rhs =
                                           (uu___285_18334.FStar_TypeChecker_Common.rhs);
                                         FStar_TypeChecker_Common.element =
                                           (uu___285_18334.FStar_TypeChecker_Common.element);
                                         FStar_TypeChecker_Common.logical_guard
                                           =
                                           (uu___285_18334.FStar_TypeChecker_Common.logical_guard);
                                         FStar_TypeChecker_Common.scope =
                                           (uu___285_18334.FStar_TypeChecker_Common.scope);
                                         FStar_TypeChecker_Common.reason =
                                           (uu___285_18334.FStar_TypeChecker_Common.reason);
                                         FStar_TypeChecker_Common.loc =
                                           (uu___285_18334.FStar_TypeChecker_Common.loc);
                                         FStar_TypeChecker_Common.rank =
                                           (uu___285_18334.FStar_TypeChecker_Common.rank)
                                       }) in
                                  let uu____18335 =
                                    destruct_flex_pattern env t1 in
                                  solve_t_flex_rigid false uu____18328
                                    uu____18335 t_base wl
                              | FStar_Pervasives_Native.Some (y,phi) ->
                                  let y' =
                                    let uu___286_18349 = y in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___286_18349.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___286_18349.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort = t1
                                    } in
                                  let impl =
                                    guard_on_element wl problem y' phi in
                                  ...
                                  let guard =
                                    let uu____18364 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob)
                                        FStar_Pervasives_Native.fst in
                                    FStar_Syntax_Util.mk_conj uu____18364
                                      impl in
                                  let wl1 =
                                    solve_prob orig
                                      (FStar_Pervasives_Native.Some guard) []
                                      wl in
                                  solve env (attempt [base_prob] wl1))))
               | (uu____18372,FStar_Syntax_Syntax.Tm_uvar uu____18373) ->
                   if wl.defer_ok
                   then
                     solve env
                       (defer "rigid-flex subtyping deferred" orig wl)
                   else
                     (let uu____18391 = base_and_refinement env t1 in
                      match uu____18391 with
                      | (t_base,uu____18403) ->
                          solve_t env
                            (let uu___287_18417 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___287_18417.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___287_18417.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___287_18417.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___287_18417.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___287_18417.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___287_18417.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___287_18417.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___287_18417.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (uu____18418,FStar_Syntax_Syntax.Tm_app
                  ({
                     FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar
                       uu____18419;
                     FStar_Syntax_Syntax.pos = uu____18420;
                     FStar_Syntax_Syntax.vars = uu____18421;_},uu____18422))
                   ->
                   if wl.defer_ok
                   then
                     solve env
                     ...
                     (let uu____18460 = base_and_refinement env t1 in
                      match uu____18460 with
                      | (t_base,uu____18472) ->
                          solve_t env
                            (let uu___287_18486 = problem in
                             {
                               FStar_TypeChecker_Common.pid =
                                 (uu___287_18486.FStar_TypeChecker_Common.pid);
                               FStar_TypeChecker_Common.lhs = t_base;
                               FStar_TypeChecker_Common.relation =
                                 FStar_TypeChecker_Common.EQ;
                               FStar_TypeChecker_Common.rhs =
                                 (uu___287_18486.FStar_TypeChecker_Common.rhs);
                               FStar_TypeChecker_Common.element =
                                 (uu___287_18486.FStar_TypeChecker_Common.element);
                               FStar_TypeChecker_Common.logical_guard =
                                 (uu___287_18486.FStar_TypeChecker_Common.logical_guard);
                               FStar_TypeChecker_Common.scope =
                                 (uu___287_18486.FStar_TypeChecker_Common.scope);
                               FStar_TypeChecker_Common.reason =
                                 (uu___287_18486.FStar_TypeChecker_Common.reason);
                               FStar_TypeChecker_Common.loc =
                                 (uu___287_18486.FStar_TypeChecker_Common.loc);
                               FStar_TypeChecker_Common.rank =
                                 (uu___287_18486.FStar_TypeChecker_Common.rank)
                             }) wl)
               | (FStar_Syntax_Syntax.Tm_refine uu____18487,uu____18488) ->
                   let t21 =
                     let uu____18498 = base_and_refinement env t2 in
                     FStar_All.pipe_left force_refinement uu____18498 in
                   solve_t env
                     (let uu___288_18522 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___288_18522.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs =
                          (uu___288_18522.FStar_TypeChecker_Common.lhs);
                        FStar_TypeChecker_Common.relation =
                          (uu___288_18522.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs = t21;
                        FStar_TypeChecker_Common.element =
                          (uu___288_18522.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___288_18522.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___288_18522.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___288_18522.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___288_18522.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___288_18522.FStar_TypeChecker_Common.rank)
                      }) wl
               | (uu____18523,FStar_Syntax_Syntax.Tm_refine uu____18524) ->
                   let t11 =
                     let uu____18534 = base_and_refinement env t1 in
                     FStar_All.pipe_left force_refinement uu____18534 in
                   solve_t env
                     (let uu___289_18558 = problem in
                      {
                        FStar_TypeChecker_Common.pid =
                          (uu___289_18558.FStar_TypeChecker_Common.pid);
                        FStar_TypeChecker_Common.lhs = t11;
                        FStar_TypeChecker_Common.relation =
                          (uu___289_18558.FStar_TypeChecker_Common.relation);
                        FStar_TypeChecker_Common.rhs =
                          (uu___289_18558.FStar_TypeChecker_Common.rhs);
                        FStar_TypeChecker_Common.element =
                          (uu___289_18558.FStar_TypeChecker_Common.element);
                        FStar_TypeChecker_Common.logical_guard =
                          (uu___289_18558.FStar_TypeChecker_Common.logical_guard);
                        FStar_TypeChecker_Common.scope =
                          (uu___289_18558.FStar_TypeChecker_Common.scope);
                        FStar_TypeChecker_Common.reason =
                          (uu___289_18558.FStar_TypeChecker_Common.reason);
                        FStar_TypeChecker_Common.loc =
                          (uu___289_18558.FStar_TypeChecker_Common.loc);
                        FStar_TypeChecker_Common.rank =
                          (uu___289_18558.FStar_TypeChecker_Common.rank)
                      }) wl
               | (FStar_Syntax_Syntax.Tm_match uu____18561,uu____18562) ->
                   let head1 =
                     let uu____18588 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____18588
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____18632 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____18632
                       FStar_Pervasives_Native.fst in
                   let uu____18673 =
                   ...
                   then
                     ...
                     (if uu____18688
                      then
                        let guard =
                          let uu____18700 =
                            let uu____18701 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____18701 = FStar_Syntax_Util.Equal in
                          if uu____18700
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____18705 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_76  ->
                                  FStar_Pervasives_Native.Some _0_76)
                               uu____18705) in
                        let uu____18708 = solve_prob orig guard [] wl in
                        solve env uu____18708
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_uinst uu____18711,uu____18712) ->
                   let head1 =
                     let uu____18722 = FStar_Syntax_Util.head_and_args t1 in
                   ...
                   then
                     ...
                     (if uu____18822
                      then
                        let guard =
                          let uu____18834 =
                            let uu____18835 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____18835 = FStar_Syntax_Util.Equal in
                          if uu____18834
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____18839 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_77  ->
                                  FStar_Pervasives_Native.Some _0_77)
                               uu____18839) in
                        let uu____18842 = solve_prob orig guard [] wl in
                        solve env uu____18842
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_name uu____18845,uu____18846) ->
                   let head1 =
                     let uu____18850 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____18850
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____18894 = FStar_Syntax_Util.head_and_args t2 in
                     FStar_All.pipe_right uu____18894
                       FStar_Pervasives_Native.fst in
                   let uu____18935 =
                     (((FStar_TypeChecker_Env.is_interpreted env head1) ||
                         (FStar_TypeChecker_Env.is_interpreted env head2))
                   ...
                   then
                     ...
                     (if uu____18950
                      then
                        let guard =
                          let uu____18962 =
                            let uu____18963 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____18963 = FStar_Syntax_Util.Equal in
                          if uu____18962
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____18967 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_78  ->
                                  FStar_Pervasives_Native.Some _0_78)
                               uu____18967) in
                        let uu____18970 = solve_prob orig guard [] wl in
                        solve env uu____18970
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_constant uu____18973,uu____18974) ->
                   let head1 =
                   ...
                   then
                     ...
                     (if uu____19078
                      then
                        let guard =
                          let uu____19090 =
                            let uu____19091 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____19091 = FStar_Syntax_Util.Equal in
                          if uu____19090
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____19095 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_79  ->
                                  FStar_Pervasives_Native.Some _0_79)
                               uu____19095) in
                        let uu____19098 = solve_prob orig guard [] wl in
                        solve env uu____19098
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_fvar uu____19101,uu____19102) ->
                   let head1 =
                     let uu____19106 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____19106
                       FStar_Pervasives_Native.fst in
                   let head2 =
                   ...
                   then
                     ...
                     (if uu____19206
                      then
                        let guard =
                          let uu____19218 =
                            let uu____19219 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____19219 = FStar_Syntax_Util.Equal in
                          if uu____19218
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____19223 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_80  ->
                                  FStar_Pervasives_Native.Some _0_80)
                               uu____19223) in
                        let uu____19226 = solve_prob orig guard [] wl in
                        solve env uu____19226
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (FStar_Syntax_Syntax.Tm_app uu____19229,uu____19230) ->
                   let head1 =
                     let uu____19248 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____19248
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____19292 = FStar_Syntax_Util.head_and_args t2 in
                   ...
                   then
                     ...
                     (if uu____19348
                      then
                        let guard =
                          let uu____19360 =
                            let uu____19361 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____19361 = FStar_Syntax_Util.Equal in
                          if uu____19360
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____19365 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_81  ->
                                  FStar_Pervasives_Native.Some _0_81)
                               uu____19365) in
                        let uu____19368 = solve_prob orig guard [] wl in
                        solve env uu____19368
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____19371,FStar_Syntax_Syntax.Tm_match uu____19372) ->
                   let head1 =
                     let uu____19398 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____19398
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____19442 = FStar_Syntax_Util.head_and_args t2 in
                   ...
                   then
                     ...
                     (if uu____19498
                      then
                        let guard =
                          let uu____19510 =
                            let uu____19511 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____19511 = FStar_Syntax_Util.Equal in
                          if uu____19510
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____19515 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_82  ->
                                  FStar_Pervasives_Native.Some _0_82)
                               uu____19515) in
                        let uu____19518 = solve_prob orig guard [] wl in
                        solve env uu____19518
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____19521,FStar_Syntax_Syntax.Tm_uinst uu____19522) ->
                   let head1 =
                   ...
                   then
                     ...
                     (if uu____19632
                      then
                        let guard =
                          let uu____19644 =
                            let uu____19645 = FStar_Syntax_Util.eq_tm t1 t2 in
               ...
               | (uu____19655,FStar_Syntax_Syntax.Tm_name uu____19656) ->
                   let head1 =
                   ...
                   then
                     ...
                     (if uu____19760
                      then
                        let guard =
                          let uu____19772 =
                            let uu____19773 = FStar_Syntax_Util.eq_tm t1 t2 in
               ...
               | (uu____19783,FStar_Syntax_Syntax.Tm_constant uu____19784) ->
                   let head1 =
                     let uu____19788 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____19788
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____19832 = FStar_Syntax_Util.head_and_args t2 in
                   ...
                   then
                     ...
                     (if uu____19888
                      then
                        let guard =
                          let uu____19900 =
                            let uu____19901 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____19901 = FStar_Syntax_Util.Equal in
                          if uu____19900
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____19905 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_85  ->
                                  FStar_Pervasives_Native.Some _0_85)
                               uu____19905) in
                        let uu____19908 = solve_prob orig guard [] wl in
                        solve env uu____19908
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____19911,FStar_Syntax_Syntax.Tm_fvar uu____19912) ->
                   let head1 =
                     let uu____19916 = FStar_Syntax_Util.head_and_args t1 in
                   ...
                   then
                     ...
                     (if uu____20016
                      then
                        let guard =
                          let uu____20028 =
                            let uu____20029 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____20029 = FStar_Syntax_Util.Equal in
                          if uu____20028
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____20033 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_86  ->
                                  FStar_Pervasives_Native.Some _0_86)
                               uu____20033) in
                        let uu____20036 = solve_prob orig guard [] wl in
                        solve env uu____20036
                      else rigid_rigid_delta env orig wl head1 head2 t1 t2)
                   else rigid_rigid_delta env orig wl head1 head2 t1 t2
               | (uu____20039,FStar_Syntax_Syntax.Tm_app uu____20040) ->
                   let head1 =
                     let uu____20058 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____20058
                       FStar_Pervasives_Native.fst in
                   let head2 =
                     let uu____20102 = FStar_Syntax_Util.head_and_args t2 in
                   ...
                   then
                     ...
                     (if uu____20158
                      then
                        let guard =
                          let uu____20170 =
                            let uu____20171 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____20171 = FStar_Syntax_Util.Equal in
                          if uu____20170
                          then FStar_Pervasives_Native.None
                          else
                            (let uu____20175 = mk_eq2 env t1 t2 in
                             FStar_All.pipe_left
                               (fun _0_87  ->
               ...
               | (FStar_Syntax_Syntax.Tm_let uu____20181,uu____20182) ->
                   let uu____20195 =
                     let uu____20196 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____20197 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____20196
                       uu____20197 in
                   failwith uu____20195
               | (FStar_Syntax_Syntax.Tm_delayed uu____20198,uu____20199) ->
                   let uu____20224 =
                     let uu____20225 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____20226 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____20225
                       uu____20226 in
                   failwith uu____20224
               | (uu____20227,FStar_Syntax_Syntax.Tm_delayed uu____20228) ->
                   let uu____20253 =
                     let uu____20254 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____20255 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____20254
                       uu____20255 in
                   failwith uu____20253
               | (uu____20256,FStar_Syntax_Syntax.Tm_let uu____20257) ->
                   let uu____20270 =
                     let uu____20271 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____20272 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____20271
                       uu____20272 in
                   failwith uu____20270
               | uu____20273 -> giveup env "head tag mismatch" orig)))
and solve_c:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.comp,Prims.unit) FStar_TypeChecker_Common.problem ->
      worklist -> solution
          ...
          then
            (let uu____20311 =
               ...
               FStar_Util.format2 "incompatible effects: %s <> %s"
                 uu____20312 uu____20313 in
             giveup env uu____20311 orig)
          else
            (let sub_probs =
               FStar_List.map2
                 (fun uu____20333  ->
                    fun uu____20334  ->
                      match (uu____20333, uu____20334) with
                      | ((a1,uu____20352),(a2,uu____20354)) ->
                          let uu____20363 =
        ...
        let solve_sub c11 edge c21 =
          ...
          let lift_c1 uu____20397 =
            ...
            let uu____20441 =
              let uu____20450 =
                let uu____20451 =
                  let uu____20452 = FStar_List.hd univs1 in
                  (edge.FStar_TypeChecker_Env.mlift).FStar_TypeChecker_Env.mlift_wp
                    uu____20452 c11.FStar_Syntax_Syntax.result_typ wp in
                FStar_Syntax_Syntax.as_arg uu____20451 in
              [uu____20450] in
            {
              ...
              FStar_Syntax_Syntax.effect_args = uu____20441;
              FStar_Syntax_Syntax.flags = (c11.FStar_Syntax_Syntax.flags)
            } in
          if
            problem.FStar_TypeChecker_Common.relation =
              FStar_TypeChecker_Common.EQ
          then let uu____20453 = lift_c1 () in solve_eq uu____20453 c21
          else
            (let is_null_wp_2 =
               FStar_All.pipe_right c21.FStar_Syntax_Syntax.flags
                 (FStar_Util.for_some
                    (fun uu___243_20459  ->
                       match uu___243_20459 with
                       | FStar_Syntax_Syntax.TOTAL  -> true
                       | FStar_Syntax_Syntax.MLEFFECT  -> true
                       | FStar_Syntax_Syntax.SOMETRIVIAL  -> true
                       | uu____20460 -> false)) in
             let uu____20461 =
               match ((c11.FStar_Syntax_Syntax.effect_args),
                       (c21.FStar_Syntax_Syntax.effect_args))
               with
               | ((wp1,uu____20495)::uu____20496,(wp2,uu____20498)::uu____20499)
                   -> (wp1, wp2)
               | uu____20556 ->
                   let uu____20577 =
                     let uu____20578 =
                       let uu____20583 =
                         ...
                         FStar_Util.format2
                           ...
                           uu____20584 uu____20585 in
                       (uu____20583, (env.FStar_TypeChecker_Env.range)) in
                     FStar_Errors.Error uu____20578 in
                   FStar_Exn.raise uu____20577 in
             match uu____20461 with
             | (wpc1,wpc2) ->
                 let uu____20604 = FStar_Util.physical_equality wpc1 wpc2 in
                 if uu____20604
                 then
                   let uu____20607 =
                   ...
                   solve_t env uu____20607 wl
                 else
                   (let uu____20611 =
                      let uu____20618 =
                        FStar_TypeChecker_Env.effect_decl_opt env
                          c21.FStar_Syntax_Syntax.effect_name in
                      FStar_Util.must uu____20618 in
                    ...
                    | (c2_decl,qualifiers) ->
                        ...
                        then
                          let c1_repr =
                            let uu____20643 =
                              let uu____20644 =
                                let uu____20645 = lift_c1 () in
                                FStar_Syntax_Syntax.mk_Comp uu____20645 in
                              let uu____20646 =
                                env.FStar_TypeChecker_Env.universe_of env
                                  c11.FStar_Syntax_Syntax.result_typ in
                              FStar_TypeChecker_Env.reify_comp env
                                uu____20644 uu____20646 in
                            FStar_TypeChecker_Normalize.normalize
                              [FStar_TypeChecker_Normalize.UnfoldUntil
                                 FStar_Syntax_Syntax.Delta_constant;
                              FStar_TypeChecker_Normalize.Weak;
                          ...
                          let prob =
                            let uu____20652 =
                              let uu____20657 =
                                ...
                                FStar_Util.format2
                                  "sub effect repr: %s <: %s" uu____20658
                                  uu____20659 in
                              sub_prob c1_repr
                                problem.FStar_TypeChecker_Common.relation
                                c2_repr uu____20657 in
                            FStar_TypeChecker_Common.TProb uu____20652 in
                          let wl1 =
                            let uu____20661 =
                              let uu____20664 =
                                FStar_All.pipe_right (p_guard prob)
                                  FStar_Pervasives_Native.fst in
                              FStar_Pervasives_Native.Some uu____20664 in
                             ...
                             let uu____20762 =
                               let uu____20765 =
                                 let uu____20768 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst in
                                 FStar_Syntax_Util.mk_conj uu____20768 g in
                               FStar_All.pipe_left
                                 (fun _0_90  ->
                                    FStar_Pervasives_Native.Some _0_90)
                                 uu____20765 in
                             solve_prob orig uu____20762 [] wl in
                           solve env (attempt [base_prob] wl1)))) in
        let uu____20781 = FStar_Util.physical_equality c1 c2 in
        if uu____20781
        then
          let uu____20782 =
            solve_prob orig FStar_Pervasives_Native.None [] wl in
          ...
          ((let uu____20785 =
            ...
            if uu____20785
            then
              let uu____20786 = FStar_Syntax_Print.comp_to_string c1 in
              let uu____20787 = FStar_Syntax_Print.comp_to_string c2 in
            ...
            | (c11,c21) ->
                (match ((c11.FStar_Syntax_Syntax.n),
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu____20799),FStar_Syntax_Syntax.Total
                    (t2,uu____20801)) when
                     ...
                     let uu____20818 =
                       problem_using_guard orig t1
                         ...
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____20818 wl
                 | (FStar_Syntax_Syntax.GTotal
                    uu____20821,FStar_Syntax_Syntax.Total uu____20822) ->
                     giveup env "incompatible monad ordering: GTot </: Tot"
                       orig
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu____20840),FStar_Syntax_Syntax.Total
                    (t2,uu____20842)) ->
                     let uu____20859 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____20859 wl
                 | (FStar_Syntax_Syntax.GTotal
                    (t1,uu____20863),FStar_Syntax_Syntax.GTotal
                    (t2,uu____20865)) ->
                     let uu____20882 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                         FStar_Pervasives_Native.None "result type" in
                     solve_t env uu____20882 wl
                 | (FStar_Syntax_Syntax.Total
                    (t1,uu____20886),FStar_Syntax_Syntax.GTotal
                    (t2,uu____20888)) ->
                     let uu____20905 =
                       problem_using_guard orig t1
                         problem.FStar_TypeChecker_Common.relation t2
                 ...
                 | (FStar_Syntax_Syntax.GTotal
                    uu____20908,FStar_Syntax_Syntax.Comp uu____20909) ->
                     let uu____20918 =
                       let uu___290_20923 = problem in
                       let uu____20928 =
                         let uu____20929 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___290_20923.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____20928;
                         FStar_TypeChecker_Common.relation =
                           (uu___290_20923.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___290_20923.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___290_20923.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___290_20923.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___290_20923.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___290_20923.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___290_20923.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___290_20923.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20918 wl
                 | (FStar_Syntax_Syntax.Total
                    uu____20930,FStar_Syntax_Syntax.Comp uu____20931) ->
                     let uu____20940 =
                       let uu___290_20945 = problem in
                       let uu____20950 =
                         let uu____20951 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c11 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___290_20945.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs = uu____20950;
                         FStar_TypeChecker_Common.relation =
                           (uu___290_20945.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs =
                           (uu___290_20945.FStar_TypeChecker_Common.rhs);
                         FStar_TypeChecker_Common.element =
                           (uu___290_20945.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___290_20945.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___290_20945.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___290_20945.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___290_20945.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___290_20945.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20940 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____20952,FStar_Syntax_Syntax.GTotal uu____20953) ->
                     let uu____20962 =
                       let uu___291_20967 = problem in
                       let uu____20972 =
                         let uu____20973 =
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___291_20967.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___291_20967.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___291_20967.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____20972;
                         FStar_TypeChecker_Common.element =
                           (uu___291_20967.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___291_20967.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___291_20967.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___291_20967.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___291_20967.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___291_20967.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20962 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____20974,FStar_Syntax_Syntax.Total uu____20975) ->
                     let uu____20984 =
                       let uu___291_20989 = problem in
                       let uu____20994 =
                         let uu____20995 =
                           FStar_TypeChecker_Env.comp_to_comp_typ env c21 in
                         FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp
                       ...
                       {
                         FStar_TypeChecker_Common.pid =
                           (uu___291_20989.FStar_TypeChecker_Common.pid);
                         FStar_TypeChecker_Common.lhs =
                           (uu___291_20989.FStar_TypeChecker_Common.lhs);
                         FStar_TypeChecker_Common.relation =
                           (uu___291_20989.FStar_TypeChecker_Common.relation);
                         FStar_TypeChecker_Common.rhs = uu____20994;
                         FStar_TypeChecker_Common.element =
                           (uu___291_20989.FStar_TypeChecker_Common.element);
                         FStar_TypeChecker_Common.logical_guard =
                           (uu___291_20989.FStar_TypeChecker_Common.logical_guard);
                         FStar_TypeChecker_Common.scope =
                           (uu___291_20989.FStar_TypeChecker_Common.scope);
                         FStar_TypeChecker_Common.reason =
                           (uu___291_20989.FStar_TypeChecker_Common.reason);
                         FStar_TypeChecker_Common.loc =
                           (uu___291_20989.FStar_TypeChecker_Common.loc);
                         FStar_TypeChecker_Common.rank =
                           (uu___291_20989.FStar_TypeChecker_Common.rank)
                       } in
                     solve_c env uu____20984 wl
                 | (FStar_Syntax_Syntax.Comp
                    uu____20996,FStar_Syntax_Syntax.Comp uu____20997) ->
                     let uu____20998 =
                                ...
                                then
                                  ...
                                  (let uu____21033 =
                                     ...
                                     FStar_Util.format2
                                       ...
                                       uu____21034 uu____21035 in
                                   giveup env uu____21033 orig)
      ...
      FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits
        (FStar_List.map
           (fun uu____21078  ->
              ...
              | (uu____21091,uu____21092,u,uu____21094,uu____21095,uu____21096)
                  -> FStar_Syntax_Print.uvar_to_string u)) in
    FStar_All.pipe_right uu____21040 (FStar_String.concat ", ")
let ineqs_to_string:
  ...
  fun ineqs  ->
    let vars =
      ...
      FStar_All.pipe_right uu____21127 (FStar_String.concat ", ") in
    let ineqs1 =
      let uu____21145 =
        FStar_All.pipe_right (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu____21173  ->
                ...
                | (u1,u2) ->
                    let uu____21180 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____21181 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____21180 uu____21181)) in
...
let guard_to_string:
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____21198,[])) -> "{}"
      | uu____21223 ->
          let form =
            match g.FStar_TypeChecker_Env.guard_f with
            ...
            let uu____21243 =
              FStar_List.map
                (fun uu____21253  ->
                   ...
                   | (uu____21258,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred in
            FStar_All.pipe_right uu____21243 (FStar_String.concat ",\n") in
          let imps = print_pending_implicits g in
          let uu____21263 =
            ineqs_to_string g.FStar_TypeChecker_Env.univ_ineqs in
          FStar_Util.format4
            "\n\t{guard_f=%s;\n\t deferred={\n%s};\n\t univ_ineqs={%s};\n\t implicits={%s}}\n"
            form carry uu____21263 imps
let new_t_problem:
  'Auu____21271 .
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.term ->
        FStar_TypeChecker_Common.rel ->
          FStar_Syntax_Syntax.term ->
            'Auu____21271 FStar_Pervasives_Native.option ->
              FStar_Range.range ->
                (FStar_Syntax_Syntax.term,'Auu____21271)
                  FStar_TypeChecker_Common.problem
  =
  fun env  ->
    fun lhs  ->
    ...
    fun t1  ->
      fun rel  ->
        fun t2  ->
          let x =
            let uu____21331 =
              let uu____21334 = FStar_TypeChecker_Env.get_range env in
              FStar_All.pipe_left
                (fun _0_91  -> FStar_Pervasives_Native.Some _0_91)
                uu____21334 in
            FStar_Syntax_Syntax.new_bv uu____21331 t1 in
          let env1 = FStar_TypeChecker_Env.push_bv env x in
          let p =
            let uu____21343 =
              let uu____21346 = FStar_Syntax_Syntax.bv_to_name x in
              FStar_All.pipe_left
                (fun _0_92  -> FStar_Pervasives_Native.Some _0_92)
                uu____21346 in
            let uu____21349 = FStar_TypeChecker_Env.get_range env1 in
            new_t_problem env1 t1 rel t2 uu____21343 uu____21349 in
...
let solve_and_commit:
  ...
  fun env  ->
    fun probs  ->
      fun err1  ->
        let probs1 =
          let uu____21379 = FStar_Options.eager_inference () in
          if uu____21379
          then
            let uu___292_21380 = probs in
            {
              attempting = (uu___292_21380.attempting);
              wl_deferred = (uu___292_21380.wl_deferred);
              ctr = (uu___292_21380.ctr);
              defer_ok = false;
              smt_ok = (uu___292_21380.smt_ok);
              tcenv = (uu___292_21380.tcenv)
            }
          else probs in
        let tx = FStar_Syntax_Unionfind.new_transaction () in
        ...
        | Failed (d,s) ->
            ((let uu____21391 =
              ...
              if uu____21391
              then
                let uu____21392 = explain env d s in
                FStar_All.pipe_left FStar_Util.print_string uu____21392
              else ());
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____21406 =
            ...
            if uu____21406
            then
              let uu____21407 = FStar_Syntax_Print.term_to_string f in
           ...
           (let f1 =
            ...
            (let uu____21411 =
             ...
             if uu____21411
             then
               let uu____21412 = FStar_Syntax_Print.term_to_string f1 in
               FStar_Util.print1 "Simplified guard to %s\n" uu____21412
             else ());
            (let f2 =
               let uu____21415 =
                 let uu____21416 = FStar_Syntax_Util.unmeta f1 in
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____21420 -> FStar_TypeChecker_Common.NonTrivial f1 in
             let uu___293_21421 = g in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___293_21421.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___293_21421.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___293_21421.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
              ...
              let uu____21441 =
                let uu____21442 =
                  let uu____21443 =
                    FStar_All.pipe_right (p_guard prob)
                      FStar_Pervasives_Native.fst in
                  FStar_All.pipe_right uu____21443
                    (fun _0_93  -> FStar_TypeChecker_Common.NonTrivial _0_93) in
                {
                  FStar_TypeChecker_Env.guard_f = uu____21442;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____21441 in
            FStar_All.pipe_left
              (fun _0_94  -> FStar_Pervasives_Native.Some _0_94) uu____21440
      ...
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____21490 =
              ...
              {
                FStar_TypeChecker_Env.guard_f = uu____21491;
                FStar_TypeChecker_Env.deferred = d;
                FStar_TypeChecker_Env.univ_ineqs = ([], []);
                FStar_TypeChecker_Env.implicits = []
              } in
            FStar_Pervasives_Native.Some uu____21490
let try_teq:
  Prims.bool ->
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.typ ->
      ...
      fun t1  ->
        fun t2  ->
          (let uu____21530 =
           ...
           if uu____21530
           then
             let uu____21531 = FStar_Syntax_Print.term_to_string t1 in
             let uu____21532 = FStar_Syntax_Print.term_to_string t2 in
          ...
          (let prob =
             let uu____21535 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____21540 in
             FStar_All.pipe_left
...
let teq:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____21571 = try_teq true env t1 t2 in
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____21574 =
              let uu____21575 =
                ...
                let uu____21581 = FStar_TypeChecker_Env.get_range env in
                (uu____21580, uu____21581) in
              FStar_Errors.Error uu____21575 in
            FStar_Exn.raise uu____21574
        | FStar_Pervasives_Native.Some g ->
            ((let uu____21584 =
              ...
              if uu____21584
              then
                let uu____21585 = FStar_Syntax_Print.term_to_string t1 in
                let uu____21586 = FStar_Syntax_Print.term_to_string t2 in
                let uu____21587 = guard_to_string env g in
                FStar_Util.print3
                  "teq of %s and %s succeeded with guard %s\n" uu____21585
                  uu____21586 uu____21587
              else ());
             g)
let subtype_fail:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun e  ->
      fun t1  ->
        fun t2  ->
          let uu____21601 = FStar_TypeChecker_Env.get_range env in
          let uu____21602 =
            FStar_TypeChecker_Err.basic_type_error env
              (FStar_Pervasives_Native.Some e) t2 t1 in
          FStar_Errors.err uu____21601 uu____21602
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
      FStar_Syntax_Syntax.comp ->
    ...
    fun c1  ->
      fun c2  ->
        (let uu____21615 =
         ...
         if uu____21615
         then
           let uu____21616 = FStar_Syntax_Print.comp_to_string c1 in
           let uu____21617 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        (let rel =
         ...
         let prob =
           let uu____21622 =
             let uu____21627 = FStar_TypeChecker_Env.get_range env in
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____21627 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_97  -> FStar_TypeChecker_Common.CProb _0_97) uu____21622 in
         let uu____21632 =
           let uu____21635 = singleton env prob in
           solve_and_commit env uu____21635
             (fun uu____21637  -> FStar_Pervasives_Native.None) in
         FStar_All.pipe_left (with_guard env prob) uu____21632)
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____21705 =
                 let uu____21706 =
                   let uu____21711 =
                     let uu____21712 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____21713 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____21712 uu____21713 in
                   let uu____21714 = FStar_TypeChecker_Env.get_range env in
                   (uu____21711, uu____21714) in
                 FStar_Errors.Error uu____21706 in
               FStar_Exn.raise uu____21705) in
            let equiv1 v1 v' =
              let uu____21722 =
                let uu____21727 = FStar_Syntax_Subst.compress_univ v1 in
                let uu____21728 = FStar_Syntax_Subst.compress_univ v' in
                (uu____21727, uu____21728) in
              match uu____21722 with
              | (FStar_Syntax_Syntax.U_unif v0,FStar_Syntax_Syntax.U_unif
                 v0') -> FStar_Syntax_Unionfind.univ_equiv v0 v0'
              | uu____21747 -> false in
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____21777 = FStar_Syntax_Subst.compress_univ v1 in
                      match uu____21777 with
                      | FStar_Syntax_Syntax.U_unif uu____21784 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____21813  ->
                                    ...
                                    | (u,v') ->
                                        let uu____21822 = equiv1 v1 v' in
                                        if uu____21822
                                        then
                                          let uu____21825 =
                                            FStar_All.pipe_right variables
                                              (FStar_Util.for_some (equiv1 u)) in
                                          (if uu____21825 then [] else [u])
                                        else [])) in
                          let lb =
            ...
            let uu____21846 =
              let wl =
                let uu___294_21850 = empty_worklist env in
                {
                  attempting = (uu___294_21850.attempting);
                  wl_deferred = (uu___294_21850.wl_deferred);
                  ctr = (uu___294_21850.ctr);
                  defer_ok = false;
                  smt_ok = (uu___294_21850.smt_ok);
                  tcenv = (uu___294_21850.tcenv)
                } in
                   ...
                   (fun uu____21868  ->
                      ...
                      | (lb,v1) ->
                          ...
                          (match uu____21875 with
                           | USolved wl1 -> ()
                           | uu____21877 -> fail lb v1))) in
            let rec check_ineq uu____21885 =
              ...
              | (u,v1) ->
                  ...
                  (match (u1, v2) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____21894) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu____21917,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu____21919,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_max us,uu____21930) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u2  -> check_ineq (u2, v2)))
                   | (uu____21937,FStar_Syntax_Syntax.U_max vs) ->
                       FStar_All.pipe_right vs
                         (FStar_Util.for_some
                            (fun v3  -> check_ineq (u1, v3)))
                   | uu____21945 -> false) in
            let uu____21950 =
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____21965  ->
                      ...
                      | (u,v1) ->
                          let uu____21972 = check_ineq (u, v1) in
                          if uu____21972
                          then true
                          else
                            ((let uu____21975 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____21976
                                  uu____21977
                              else ());
                             false))) in
            if uu____21950
            then ()
              ...
              ((let uu____21981 =
                ...
                then
                  ((let uu____21983 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
                      ...
                      uu____21983);
                   FStar_Syntax_Unionfind.rollback tx;
                   (let uu____21993 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
               ...
               (let uu____22003 =
                  let uu____22004 =
                    let uu____22009 = FStar_TypeChecker_Env.get_range env in
                    ("Failed to solve universe inequalities for inductives",
                      uu____22009) in
                  FStar_Errors.Error uu____22004 in
                FStar_Exn.raise uu____22003))
let solve_universe_inequalities:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.universe Prims.list,(FStar_Syntax_Syntax.universe,
                                               FStar_Syntax_Syntax.universe)
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____22071 =
       ...
       if uu____22071
       then
         let uu____22072 = wl_to_string wl in
         let uu____22073 =
           FStar_Util.string_of_int
             (FStar_List.length g.FStar_TypeChecker_Env.implicits) in
         FStar_Util.print2
           "Trying to solve carried problems: begin\n\t%s\nend\n and %s implicits\n"
           uu____22072 uu____22073
       else ());
      (let g1 =
         let uu____22088 = solve_and_commit env wl fail in
         match uu____22088 with
         | FStar_Pervasives_Native.Some [] ->
             let uu___295_22101 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___295_22101.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___295_22101.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___295_22101.FStar_TypeChecker_Env.implicits)
             }
         | uu____22106 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g1.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___296_22110 = g1 in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___296_22110.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___296_22110.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___296_22110.FStar_TypeChecker_Env.implicits)
        }))
let last_proof_ns:
...
let maybe_update_proof_ns: FStar_TypeChecker_Env.env -> Prims.unit =
  fun env  ->
    ...
    let uu____22132 = FStar_ST.op_Bang last_proof_ns in
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___297_22316 = g1 in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___297_22316.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___297_22316.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___297_22316.FStar_TypeChecker_Env.implicits)
            } in
          let uu____22317 =
            let uu____22318 = FStar_TypeChecker_Env.should_verify env in
            Prims.op_Negation uu____22318 in
          if uu____22317
                 ...
                 (if debug1
                  then
                    (let uu____22326 = FStar_TypeChecker_Env.get_range env in
                     let uu____22327 =
                       let uu____22328 = FStar_Syntax_Print.term_to_string vc in
                       FStar_Util.format1 "Before normalization VC=\n%s\n"
                         uu____22328 in
                     FStar_Errors.diag uu____22326 uu____22327)
                  else ();
                  (let vc1 =
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Normalize.Eager_unfolding;
                   ...
                   if debug1
                   then
                     (let uu____22332 = FStar_TypeChecker_Env.get_range env in
                      let uu____22333 =
                        let uu____22334 =
                          FStar_Syntax_Print.term_to_string vc1 in
                        FStar_Util.format1 "After normalization VC=\n%s\n"
                          uu____22334 in
                      FStar_Errors.diag uu____22332 uu____22333)
                   else ();
                   (let uu____22336 = check_trivial vc1 in
                             ...
                             (let uu____22350 =
                              ...
                              let uu____22351 =
                                ...
                                FStar_Util.format1 "Checking VC=\n%s\n"
                                  uu____22352 in
                              FStar_Errors.diag uu____22350 uu____22351)
                           else ();
                           (let vcs =
                              let uu____22363 = FStar_Options.use_tactics () in
                              if uu____22363
                              then
                                FStar_Options.with_saved_options
                                  (fun uu____22382  ->
                                     (let uu____22384 =
                                      ...
                                      FStar_All.pipe_left
                                        FStar_Pervasives.ignore uu____22384);
                                     (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.preprocess
                                       env vc2)
                              else
                                (let uu____22386 =
                                   let uu____22393 = FStar_Options.peek () in
                                   (env, vc2, uu____22393) in
                                 [uu____22386]) in
                                    ...
                                    | (env1,goal,opts) ->
                                        let goal1 =
                                          FStar_TypeChecker_Normalize.normalize
                                            ...
                                            FStar_TypeChecker_Normalize.Primops]
                                            env1 goal in
                                        let uu____22438 = check_trivial goal1 in
                                              ...
                                              then
                                                (let uu____22446 =
                                                 ...
                                                 let uu____22447 =
                                                   ...
                                                   FStar_Util.format2
                                                     "Trying to solve:\n> %s\nWith proof_ns:\n %s\n"
                                                     uu____22448 uu____22449 in
                                                 FStar_Errors.diag
                                                   uu____22446 uu____22447)
                                              else ();
                                              if debug1
                                              then
                                                (let uu____22452 =
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____22470 =
            let uu____22471 =
              let uu____22476 = FStar_TypeChecker_Env.get_range env in
              ("Expected a trivial pre-condition", uu____22476) in
            FStar_Errors.Error uu____22471 in
          FStar_Exn.raise uu____22470
let discharge_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t
  =
...
let resolve_implicits':
  ...
  fun must_total  ->
    fun forcelax  ->
      fun g  ->
        let unresolved u =
          let uu____22502 = FStar_Syntax_Unionfind.find u in
          match uu____22502 with
          | FStar_Pervasives_Native.None  -> true
          | uu____22505 -> false in
        let rec until_fixpoint acc implicits =
          let uu____22523 = acc in
          ...
          | (out,changed) ->
              (match implicits with
               ...
               | hd1::tl1 ->
                   let uu____22609 = hd1 in
                   (match uu____22609 with
                    | (uu____22622,env,u,tm,k,r) ->
                        let uu____22628 = unresolved u in
                        if uu____22628
                           ...
                           (let uu____22659 =
                            ...
                            then
                              ...
                              FStar_Util.print3
                                ...
                                uu____22660 uu____22661 uu____22662
                            else ());
                           (let env2 =
                              if forcelax
                              then
                                let uu___298_22665 = env1 in
                                {
                                  FStar_TypeChecker_Env.solver =
                                    (uu___298_22665.FStar_TypeChecker_Env.solver);
                                  FStar_TypeChecker_Env.range =
                                    (uu___298_22665.FStar_TypeChecker_Env.range);
                                  FStar_TypeChecker_Env.curmodule =
                                    (uu___298_22665.FStar_TypeChecker_Env.curmodule);
                                  FStar_TypeChecker_Env.gamma =
                                    (uu___298_22665.FStar_TypeChecker_Env.gamma);
                                  FStar_TypeChecker_Env.gamma_cache =
                                    (uu___298_22665.FStar_TypeChecker_Env.gamma_cache);
                                  FStar_TypeChecker_Env.modules =
                                    (uu___298_22665.FStar_TypeChecker_Env.modules);
                                  FStar_TypeChecker_Env.expected_typ =
                                    (uu___298_22665.FStar_TypeChecker_Env.expected_typ);
                                  FStar_TypeChecker_Env.sigtab =
                                    (uu___298_22665.FStar_TypeChecker_Env.sigtab);
                                  FStar_TypeChecker_Env.is_pattern =
                                    (uu___298_22665.FStar_TypeChecker_Env.is_pattern);
                                  FStar_TypeChecker_Env.instantiate_imp =
                                    (uu___298_22665.FStar_TypeChecker_Env.instantiate_imp);
                                  FStar_TypeChecker_Env.effects =
                                    (uu___298_22665.FStar_TypeChecker_Env.effects);
                                  FStar_TypeChecker_Env.generalize =
                                    (uu___298_22665.FStar_TypeChecker_Env.generalize);
                                  FStar_TypeChecker_Env.letrecs =
                                    (uu___298_22665.FStar_TypeChecker_Env.letrecs);
                                  FStar_TypeChecker_Env.top_level =
                                    (uu___298_22665.FStar_TypeChecker_Env.top_level);
                                  FStar_TypeChecker_Env.check_uvars =
                                    (uu___298_22665.FStar_TypeChecker_Env.check_uvars);
                                  FStar_TypeChecker_Env.use_eq =
                                    (uu___298_22665.FStar_TypeChecker_Env.use_eq);
                                  FStar_TypeChecker_Env.is_iface =
                                    (uu___298_22665.FStar_TypeChecker_Env.is_iface);
                                  FStar_TypeChecker_Env.admit =
                                    (uu___298_22665.FStar_TypeChecker_Env.admit);
                                  FStar_TypeChecker_Env.lax = true;
                                  FStar_TypeChecker_Env.lax_universes =
                                    (uu___298_22665.FStar_TypeChecker_Env.lax_universes);
                                  FStar_TypeChecker_Env.failhard =
                                    (uu___298_22665.FStar_TypeChecker_Env.failhard);
                                  FStar_TypeChecker_Env.nosynth =
                                    (uu___298_22665.FStar_TypeChecker_Env.nosynth);
                                  FStar_TypeChecker_Env.tc_term =
                                    (uu___298_22665.FStar_TypeChecker_Env.tc_term);
                                  FStar_TypeChecker_Env.type_of =
                                    (uu___298_22665.FStar_TypeChecker_Env.type_of);
                                  FStar_TypeChecker_Env.universe_of =
                                    (uu___298_22665.FStar_TypeChecker_Env.universe_of);
                                  FStar_TypeChecker_Env.use_bv_sorts =
                                    (uu___298_22665.FStar_TypeChecker_Env.use_bv_sorts);
                                  FStar_TypeChecker_Env.qname_and_index =
                                    (uu___298_22665.FStar_TypeChecker_Env.qname_and_index);
                                  FStar_TypeChecker_Env.proof_ns =
                                    (uu___298_22665.FStar_TypeChecker_Env.proof_ns);
                                  FStar_TypeChecker_Env.synth =
                                    (uu___298_22665.FStar_TypeChecker_Env.synth);
                                  FStar_TypeChecker_Env.is_native_tactic =
                                    (uu___298_22665.FStar_TypeChecker_Env.is_native_tactic);
                                  FStar_TypeChecker_Env.identifier_info =
                                    (uu___298_22665.FStar_TypeChecker_Env.identifier_info);
                                  FStar_TypeChecker_Env.tc_hooks =
                                    (uu___298_22665.FStar_TypeChecker_Env.tc_hooks);
                                  FStar_TypeChecker_Env.dsenv =
                                    (uu___298_22665.FStar_TypeChecker_Env.dsenv);
                                  FStar_TypeChecker_Env.dep_graph =
                                    (uu___298_22665.FStar_TypeChecker_Env.dep_graph)
                                }
                              else env1 in
                            let g1 =
                              if must_total
                              then
                                let uu____22668 =
                                  env2.FStar_TypeChecker_Env.type_of
                                    (let uu___299_22676 = env2 in
                                     {
                                       FStar_TypeChecker_Env.solver =
                                         (uu___299_22676.FStar_TypeChecker_Env.solver);
                                       FStar_TypeChecker_Env.range =
                                         (uu___299_22676.FStar_TypeChecker_Env.range);
                                       FStar_TypeChecker_Env.curmodule =
                                         (uu___299_22676.FStar_TypeChecker_Env.curmodule);
                                       FStar_TypeChecker_Env.gamma =
                                         (uu___299_22676.FStar_TypeChecker_Env.gamma);
                                       FStar_TypeChecker_Env.gamma_cache =
                                         (uu___299_22676.FStar_TypeChecker_Env.gamma_cache);
                                       FStar_TypeChecker_Env.modules =
                                         (uu___299_22676.FStar_TypeChecker_Env.modules);
                                       FStar_TypeChecker_Env.expected_typ =
                                         (uu___299_22676.FStar_TypeChecker_Env.expected_typ);
                                       FStar_TypeChecker_Env.sigtab =
                                         (uu___299_22676.FStar_TypeChecker_Env.sigtab);
                                       FStar_TypeChecker_Env.is_pattern =
                                         (uu___299_22676.FStar_TypeChecker_Env.is_pattern);
                                       FStar_TypeChecker_Env.instantiate_imp
                                         =
                                         (uu___299_22676.FStar_TypeChecker_Env.instantiate_imp);
                                       FStar_TypeChecker_Env.effects =
                                         (uu___299_22676.FStar_TypeChecker_Env.effects);
                                       FStar_TypeChecker_Env.generalize =
                                         (uu___299_22676.FStar_TypeChecker_Env.generalize);
                                       FStar_TypeChecker_Env.letrecs =
                                         (uu___299_22676.FStar_TypeChecker_Env.letrecs);
                                       FStar_TypeChecker_Env.top_level =
                                         (uu___299_22676.FStar_TypeChecker_Env.top_level);
                                       FStar_TypeChecker_Env.check_uvars =
                                         (uu___299_22676.FStar_TypeChecker_Env.check_uvars);
                                       FStar_TypeChecker_Env.use_eq =
                                         (uu___299_22676.FStar_TypeChecker_Env.use_eq);
                                       FStar_TypeChecker_Env.is_iface =
                                         (uu___299_22676.FStar_TypeChecker_Env.is_iface);
                                       FStar_TypeChecker_Env.admit =
                                         (uu___299_22676.FStar_TypeChecker_Env.admit);
                                       FStar_TypeChecker_Env.lax =
                                         (uu___299_22676.FStar_TypeChecker_Env.lax);
                                       FStar_TypeChecker_Env.lax_universes =
                                         (uu___299_22676.FStar_TypeChecker_Env.lax_universes);
                                       FStar_TypeChecker_Env.failhard =
                                         (uu___299_22676.FStar_TypeChecker_Env.failhard);
                                       FStar_TypeChecker_Env.nosynth =
                                         (uu___299_22676.FStar_TypeChecker_Env.nosynth);
                                       FStar_TypeChecker_Env.tc_term =
                                         (uu___299_22676.FStar_TypeChecker_Env.tc_term);
                                       FStar_TypeChecker_Env.type_of =
                                         (uu___299_22676.FStar_TypeChecker_Env.type_of);
                                       FStar_TypeChecker_Env.universe_of =
                                         (uu___299_22676.FStar_TypeChecker_Env.universe_of);
                                       FStar_TypeChecker_Env.use_bv_sorts =
                                         true;
                                       FStar_TypeChecker_Env.qname_and_index
                                         =
                                         (uu___299_22676.FStar_TypeChecker_Env.qname_and_index);
                                       FStar_TypeChecker_Env.proof_ns =
                                         (uu___299_22676.FStar_TypeChecker_Env.proof_ns);
                                       FStar_TypeChecker_Env.synth =
                                         (uu___299_22676.FStar_TypeChecker_Env.synth);
                                       FStar_TypeChecker_Env.is_native_tactic
                                         =
                                         (uu___299_22676.FStar_TypeChecker_Env.is_native_tactic);
                                       FStar_TypeChecker_Env.identifier_info
                                         =
                                         (uu___299_22676.FStar_TypeChecker_Env.identifier_info);
                                       FStar_TypeChecker_Env.tc_hooks =
                                         (uu___299_22676.FStar_TypeChecker_Env.tc_hooks);
                                       FStar_TypeChecker_Env.dsenv =
                                         (uu___299_22676.FStar_TypeChecker_Env.dsenv);
                                       FStar_TypeChecker_Env.dep_graph =
                                         (uu___299_22676.FStar_TypeChecker_Env.dep_graph)
                                     }) tm1 in
                                match uu____22668 with
                                | (uu____22677,uu____22678,g1) -> g1
                              else
                                (let uu____22681 =
                                   env2.FStar_TypeChecker_Env.tc_term
                                     (let uu___300_22689 = env2 in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___300_22689.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___300_22689.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___300_22689.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___300_22689.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___300_22689.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___300_22689.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___300_22689.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___300_22689.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.is_pattern =
                                          (uu___300_22689.FStar_TypeChecker_Env.is_pattern);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___300_22689.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___300_22689.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___300_22689.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___300_22689.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___300_22689.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___300_22689.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___300_22689.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___300_22689.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___300_22689.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax =
                                          (uu___300_22689.FStar_TypeChecker_Env.lax);
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___300_22689.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___300_22689.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___300_22689.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___300_22689.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___300_22689.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___300_22689.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          true;
                                        FStar_TypeChecker_Env.qname_and_index
                                          =
                                          (uu___300_22689.FStar_TypeChecker_Env.qname_and_index);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___300_22689.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth =
                                          (uu___300_22689.FStar_TypeChecker_Env.synth);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___300_22689.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___300_22689.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___300_22689.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___300_22689.FStar_TypeChecker_Env.dsenv);
                                        FStar_TypeChecker_Env.dep_graph =
                                          (uu___300_22689.FStar_TypeChecker_Env.dep_graph)
                                      }) tm1 in
                                 match uu____22681 with
                                 | (uu____22690,uu____22691,g1) -> g1) in
                            let g2 =
                              if env2.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___301_22694 = g1 in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___301_22694.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___301_22694.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___301_22694.FStar_TypeChecker_Env.implicits)
                                }
                              else g1 in
                            let g' =
                              let uu____22697 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl1)))) in
        let uu___302_22731 = g in
        let uu____22732 =
          until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___302_22731.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___302_22731.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs =
            (uu___302_22731.FStar_TypeChecker_Env.univ_ineqs);
          FStar_TypeChecker_Env.implicits = uu____22732
        }
let resolve_implicits:
  FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t =
...
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____22786 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____22786 resolve_implicits in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____22799 = discharge_guard env g1 in
          FStar_All.pipe_left FStar_Pervasives.ignore uu____22799
      | (reason,uu____22801,uu____22802,e,t,r)::uu____22806 ->
          let uu____22833 =
            let uu____22834 =
              let uu____22839 =
                let uu____22840 = FStar_Syntax_Print.term_to_string t in
                let uu____22841 = FStar_Syntax_Print.term_to_string e in
                FStar_Util.format2
                  "Failed to resolve implicit argument of type '%s' introduced in %s"
                  uu____22840 uu____22841 in
              (uu____22839, r) in
            FStar_Errors.Error uu____22834 in
          FStar_Exn.raise uu____22833
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___303_22848 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___303_22848.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___303_22848.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___303_22848.FStar_TypeChecker_Env.implicits)
      }
let discharge_guard_nosmt:
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.Some uu____22876 -> true
...
let teq_nosmt:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____22886 = try_teq false env t1 t2 in
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____22910 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2 in
         match uu____22910 with
         | (prob,x) ->
             let g =
               let uu____22926 =
                 let uu____22929 = singleton' env prob true in
                 solve_and_commit env uu____22929
                   (fun uu____22931  -> FStar_Pervasives_Native.None) in
               FStar_All.pipe_left (with_guard env prob) uu____22926 in
             ((let uu____22941 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____22943 =
                   FStar_TypeChecker_Normalize.term_to_string env t2 in
                 let uu____22944 =
                   let uu____22945 = FStar_Util.must g in
                   guard_to_string env uu____22945 in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____22942 uu____22943 uu____22944
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
    ...
    fun t1  ->
      fun t2  ->
        ...
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____22992 =
              let uu____22993 = FStar_Syntax_Syntax.mk_binder x in
              abstract_guard uu____22993 g in
...
let get_subtyping_prop:
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____23005 = check_subtyping env t1 t2 in
        match uu____23005 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____23024 =
              let uu____23025 =
                let uu____23026 = FStar_Syntax_Syntax.mk_binder x in
                [uu____23026] in
              close_guard env uu____23025 g in
            FStar_Pervasives_Native.Some uu____23024
let subtype_nosmt:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ -> Prims.bool
  =
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____23041 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2 in
         match uu____23041 with
         | (prob,x) ->
             let g =
               let uu____23051 =
                 let uu____23054 = singleton' env prob false in
                 solve_and_commit env uu____23054
                   (fun uu____23056  -> FStar_Pervasives_Native.None) in
               FStar_All.pipe_left (with_guard env prob) uu____23051 in
             (match g with
              | FStar_Pervasives_Native.None  -> false
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____23067 =
                      ...
                      [uu____23068] in
                    close_guard env uu____23067 g1 in
