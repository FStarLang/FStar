...
in (match ((let _151_291 = (FStar_Syntax_Subst.compress t1')
in _151_291.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_refine (_69_309) -> begin
(aux true t1')
end
| _69_312 -> begin
(t1, None)
...
| (FStar_Syntax_Syntax.Tm_uinst (f, _69_654), FStar_Syntax_Syntax.Tm_uinst (g, _69_659)) -> begin
(let _151_480 = (head_matches env f g)
in (FStar_All.pipe_right _151_480 head_match))
end
...
| (FStar_Syntax_Syntax.Tm_uvar (uv, _69_670), FStar_Syntax_Syntax.Tm_uvar (uv', _69_675)) -> begin
...
| (FStar_Syntax_Syntax.Tm_refine (x, _69_681), FStar_Syntax_Syntax.Tm_refine (y, _69_686)) -> begin
(let _151_481 = (head_matches env x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _151_481 head_match))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _69_692), _69_696) -> begin
(let _151_482 = (head_matches env x.FStar_Syntax_Syntax.sort t2)
in (FStar_All.pipe_right _151_482 head_match))
end
| (_69_699, FStar_Syntax_Syntax.Tm_refine (x, _69_702)) -> begin
(let _151_483 = (head_matches env t1 x.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _151_483 head_match))
end
...
| (FStar_Syntax_Syntax.Tm_app (head, _69_722), FStar_Syntax_Syntax.Tm_app (head', _69_727)) -> begin
(head_matches env head head')
end
| (FStar_Syntax_Syntax.Tm_app (head, _69_733), _69_737) -> begin
(head_matches env head t2)
end
| (_69_740, FStar_Syntax_Syntax.Tm_app (head, _69_743)) -> begin
(head_matches env t1 head)
end
| _69_748 -> begin
(let _151_486 = (let _151_485 = (delta_depth_of_term env t1)
in (let _151_484 = (delta_depth_of_term env t2)
in (_151_485, _151_484)))
in MisMatch (_151_486))
end))))
...
let _69_799 = if d1_greater_than_d2 then begin
(
...
in (let _151_507 = (normalize_refinement ((FStar_TypeChecker_Normalize.UnfoldUntil (d1))::(FStar_TypeChecker_Normalize.WHNF)::[]) env wl t2)
in (t1, _151_507)))
end
in (match (_69_799) with
| (t1, t2) -> begin
(aux (n_delta + 1) t1 t2)
end)))
end
| MisMatch (_69_801) -> begin
(fail r)
end
| _69_804 -> begin
...
let tcs = (FStar_All.pipe_right args (FStar_List.map (fun _69_842 -> (match (_69_842) with
| (t, _69_841) -> begin
(None, INVARIANT, T (t))
end))))
...
let fail = (fun _69_849 -> (match (()) with
| () -> begin
(FStar_All.failwith "Bad reconstruction")
end))
in (
# 723 "FStar.TypeChecker.Rel.fst"
let _69_852 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_69_852) with
| (bs, c) -> begin
(
...
let _69_869 = x
in {FStar_Syntax_Syntax.ppname = _69_869.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _69_869.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}), imp))::out) bs tcs)
end
| ([], C (c)::[]) -> begin
...
in (let _151_589 = (decompose [] bs)
in (rebuild, matches, _151_589))))
end)))
end
| _69_887 -> begin
(
...
| (_69_916, variance, T (ti)) -> begin
(
# 767 "FStar.TypeChecker.Rel.fst"
let k = (
# 768 "FStar.TypeChecker.Rel.fst"
let _69_924 = (FStar_Syntax_Util.type_u ())
in (match (_69_924) with
| (t, _69_923) -> begin
(let _151_611 = (new_uvar r scope t)
in (Prims.fst _151_611))
end))
in (
# 770 "FStar.TypeChecker.Rel.fst"
let _69_928 = (new_uvar r scope k)
...
in (let _151_614 = (let _151_613 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (FStar_All.pipe_left (fun _151_612 -> FStar_TypeChecker_Common.TProb (_151_612)) _151_613))
in (T (gi_xs), _151_614)))
end)))
end
| (_69_934, _69_936, C (_69_938)) -> begin
...
let _69_1016 = (match (q) with
| (bopt, variance, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (ti); FStar_Syntax_Syntax.tk = _69_956; FStar_Syntax_Syntax.pos = _69_954; FStar_Syntax_Syntax.vars = _69_952})) -> begin
(match ((sub_prob scope args (bopt, variance, T (ti)))) with
| (T (gi_xs), prob) -> begin
(let _151_623 = (let _151_622 = (FStar_Syntax_Syntax.mk_Total gi_xs)
in (FStar_All.pipe_left (fun _151_621 -> C (_151_621)) _151_622))
in (_151_623, (prob)::[]))
end
| _69_967 -> begin
(FStar_All.failwith "impossible")
...
| (bopt, variance, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.GTotal (ti); FStar_Syntax_Syntax.tk = _69_975; FStar_Syntax_Syntax.pos = _69_973; FStar_Syntax_Syntax.vars = _69_971})) -> begin
(match ((sub_prob scope args (bopt, variance, T (ti)))) with
| (T (gi_xs), prob) -> begin
(let _151_626 = (let _151_625 = (FStar_Syntax_Syntax.mk_GTotal gi_xs)
in (FStar_All.pipe_left (fun _151_624 -> C (_151_624)) _151_625))
in (_151_626, (prob)::[]))
end
| _69_986 -> begin
(FStar_All.failwith "impossible")
...
| (_69_988, _69_990, C ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (c); FStar_Syntax_Syntax.tk = _69_996; FStar_Syntax_Syntax.pos = _69_994; FStar_Syntax_Syntax.vars = _69_992})) -> begin
(
...
let _69_1007 = (let _151_628 = (FStar_List.map (sub_prob scope args) components)
in (FStar_All.pipe_right _151_628 FStar_List.unzip))
in (match (_69_1007) with
| (tcs, sub_probs) -> begin
(
# 800 "FStar.TypeChecker.Rel.fst"
let gi_xs = (let _151_633 = (let _151_632 = (let _151_629 = (FStar_List.hd tcs)
in (FStar_All.pipe_right _151_629 un_T))
in (let _151_631 = (let _151_630 = (FStar_List.tl tcs)
in (FStar_All.pipe_right _151_630 (FStar_List.map arg_of_tc)))
in {FStar_Syntax_Syntax.effect_name = c.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _151_632; FStar_Syntax_Syntax.effect_args = _151_631; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp _151_633))
...
let _69_1013 = (sub_prob scope args q)
in (match (_69_1013) with
| (ktec, prob) -> begin
(ktec, (prob)::[])
end))
end)
in (match (_69_1016) with
| (tc, probs) -> begin
(
# 812 "FStar.TypeChecker.Rel.fst"
let _69_1029 = (match (q) with
| (Some (b), _69_1020, _69_1022) -> begin
(let _151_635 = (let _151_634 = (FStar_Syntax_Util.arg_of_non_null_binder b)
in (_151_634)::args)
in (Some (b), (b)::scope, _151_635))
end
| _69_1025 -> begin
(None, scope, args)
end)
in (match (_69_1029) with
| (bopt, scope, args) -> begin
(
# 816 "FStar.TypeChecker.Rel.fst"
let _69_1033 = (aux scope args qs)
in (match (_69_1033) with
| (sub_probs, tcs, f) -> begin
(
# 817 "FStar.TypeChecker.Rel.fst"
let f = (match (bopt) with
| None -> begin
(let _151_638 = (let _151_637 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (f)::_151_637)
in (FStar_Syntax_Util.mk_conj_l _151_638))
end
| Some (b) -> begin
(let _151_642 = (let _151_641 = (FStar_Syntax_Util.mk_forall (Prims.fst b) f)
in (let _151_640 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (_151_641)::_151_640))
in (FStar_Syntax_Util.mk_conj_l _151_642))
end)
...
| (FStar_Syntax_Syntax.Tm_uvar (u1, _69_1061), FStar_Syntax_Syntax.Tm_uvar (u2, _69_1066)) -> begin
...
and eq_args : FStar_Syntax_Syntax.args  ->  FStar_Syntax_Syntax.args  ->  Prims.bool = (fun a1 a2 -> (((FStar_List.length a1) = (FStar_List.length a2)) && (FStar_List.forall2 (fun _69_1086 _69_1090 -> (match ((_69_1086, _69_1090)) with
| ((a1, _69_1085), (a2, _69_1089)) -> begin
(eq_tm a1 a2)
end)) a1 a2)))
...
# 862 "FStar.TypeChecker.Rel.fst"
let _69_1093 = p
in (let _151_664 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _151_663 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in {FStar_TypeChecker_Common.pid = _69_1093.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _151_664; FStar_TypeChecker_Common.relation = _69_1093.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _151_663; FStar_TypeChecker_Common.element = _69_1093.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1093.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1093.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1093.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1093.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_1093.FStar_TypeChecker_Common.rank}))))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _151_670 = (compress_tprob wl p)
in (FStar_All.pipe_right _151_670 (fun _151_669 -> FStar_TypeChecker_Common.TProb (_151_669))))
end
| FStar_TypeChecker_Common.CProb (_69_1100) -> begin
p
end))
...
let prob = (let _151_675 = (compress_prob wl pr)
in (FStar_All.pipe_right _151_675 maybe_invert_p))
in (match (prob) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(
# 875 "FStar.TypeChecker.Rel.fst"
let _69_1110 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_69_1110) with
| (lh, _69_1109) -> begin
(
# 876 "FStar.TypeChecker.Rel.fst"
let _69_1114 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.rhs)
in (match (_69_1114) with
| (rh, _69_1113) -> begin
(
# 877 "FStar.TypeChecker.Rel.fst"
let _69_1170 = (match ((lh.FStar_Syntax_Syntax.n, rh.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.Tm_uvar (_69_1116), FStar_Syntax_Syntax.Tm_uvar (_69_1119)) -> begin
(flex_flex, tp)
end
...
| (FStar_Syntax_Syntax.Tm_uvar (_69_1135), _69_1138) -> begin
(
# 884 "FStar.TypeChecker.Rel.fst"
let _69_1142 = (base_and_refinement wl.tcenv wl tp.FStar_TypeChecker_Common.rhs)
in (match (_69_1142) with
| (b, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(flex_rigid, tp)
...
let _69_1147 = tp
in (let _151_676 = (force_refinement (b, ref_opt))
in {FStar_TypeChecker_Common.pid = _69_1147.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_1147.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _69_1147.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _151_676; FStar_TypeChecker_Common.element = _69_1147.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1147.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1147.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1147.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1147.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_1147.FStar_TypeChecker_Common.rank}))
in (rank, _151_677)))
end)
end))
end
| (_69_1150, FStar_Syntax_Syntax.Tm_uvar (_69_1152)) -> begin
(
# 896 "FStar.TypeChecker.Rel.fst"
let _69_1157 = (base_and_refinement wl.tcenv wl tp.FStar_TypeChecker_Common.lhs)
in (match (_69_1157) with
| (b, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(rigid_flex, tp)
...
let _69_1161 = tp
in (let _151_678 = (force_refinement (b, ref_opt))
in {FStar_TypeChecker_Common.pid = _69_1161.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _151_678; FStar_TypeChecker_Common.relation = _69_1161.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_1161.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_1161.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1161.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1161.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1161.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1161.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_1161.FStar_TypeChecker_Common.rank}))
in (refine_flex, _151_679))
end)
end))
end
| (_69_1164, _69_1166) -> begin
(rigid_rigid, tp)
end)
in (match (_69_1170) with
| (rank, tp) -> begin
(let _151_681 = (FStar_All.pipe_right (
# 904 "FStar.TypeChecker.Rel.fst"
let _69_1171 = tp
in {FStar_TypeChecker_Common.pid = _69_1171.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_1171.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _69_1171.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_1171.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_1171.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1171.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1171.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1171.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1171.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = Some (rank)}) (fun _151_680 -> FStar_TypeChecker_Common.TProb (_151_680)))
in (rank, _151_681))
end))
end))
end))
...
(let _151_683 = (FStar_All.pipe_right (
# 906 "FStar.TypeChecker.Rel.fst"
let _69_1175 = cp
in {FStar_TypeChecker_Common.pid = _69_1175.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_1175.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _69_1175.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_1175.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_1175.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1175.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1175.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1175.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1175.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = Some (rigid_rigid)}) (fun _151_682 -> FStar_TypeChecker_Common.CProb (_151_682)))
in (rigid_rigid, _151_683))
end)))
...
let rec aux = (fun _69_1182 probs -> (match (_69_1182) with
...
let _69_1190 = (rank wl hd)
in (match (_69_1190) with
| (rank, hd) -> begin
...
let _69_1222 = (FStar_Syntax_Util.univ_kernel u)
in (match (_69_1222) with
| (k, _69_1221) -> begin
(match (k) with
...
| (FStar_Syntax_Syntax.U_max (_69_1234), FStar_Syntax_Syntax.U_max (_69_1237)) -> begin
(let _151_755 = (let _151_754 = (FStar_Syntax_Print.univ_to_string u1)
in (let _151_753 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Unable to unify universes: %s and %s" _151_754 _151_753)))
in UFailed (_151_755))
end
...
| _69_1257 -> begin
(let _151_762 = (let _151_761 = (FStar_Syntax_Print.univ_to_string u1)
in (let _151_760 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Unable to unify universes: %s and %s (%s)" _151_761 _151_760 msg)))
in UFailed (_151_762))
end))
in (match ((u1, u2)) with
...
(let _151_765 = (let _151_764 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (v1)))
in (let _151_763 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.format2 "Failed occurs check: %s occurs in %s" _151_764 _151_763)))
in (try_umax_components u1 u2 _151_765))
end else begin
(let _151_766 = (extend_solution orig ((UNIV ((v1, u)))::[]) wl)
in USolved (_151_766))
end)
end
...
let _69_1352 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _151_809 = (wl_to_string probs)
...
# 1024 "FStar.TypeChecker.Rel.fst"
let _69_1359 = probs
in {attempting = tl; wl_deferred = _69_1359.wl_deferred; ctr = _69_1359.ctr; defer_ok = _69_1359.defer_ok; smt_ok = _69_1359.smt_ok; tcenv = _69_1359.tcenv})
in (match (hd) with
| FStar_TypeChecker_Common.CProb (cp) -> begin
...
let _69_1386 = (FStar_All.pipe_right probs.wl_deferred (FStar_List.partition (fun _69_1383 -> (match (_69_1383) with
| (c, _69_1380, _69_1382) -> begin
(c < probs.ctr)
end))))
...
(match (attempt) with
| [] -> begin
(let _151_812 = (FStar_List.map (fun _69_1392 -> (match (_69_1392) with
| (_69_1389, x, y) -> begin
(x, y)
...
let _69_1395 = probs
in (let _151_814 = (FStar_All.pipe_right attempt (FStar_List.map (fun _69_1402 -> (match (_69_1402) with
| (_69_1398, _69_1400, y) -> begin
y
end))))
in {attempting = _151_814; wl_deferred = rest; ctr = _69_1395.ctr; defer_ok = _69_1395.defer_ok; smt_ok = _69_1395.smt_ok; tcenv = _69_1395.tcenv}))
in (solve env _151_815))
end)
end))
end)
end)))
...
| USolved (wl) -> begin
(let _151_821 = (solve_prob orig None [] wl)
in (solve env _151_821))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
in (match ((let _151_836 = (let _151_833 = (whnf env t1)
in _151_833.FStar_Syntax_Syntax.n)
in (let _151_835 = (let _151_834 = (whnf env t2)
in _151_834.FStar_Syntax_Syntax.n)
in (_151_836, _151_835)))) with
| (FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (f); FStar_Syntax_Syntax.tk = _69_1443; FStar_Syntax_Syntax.pos = _69_1441; FStar_Syntax_Syntax.vars = _69_1439}, us1), FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (g); FStar_Syntax_Syntax.tk = _69_1455; FStar_Syntax_Syntax.pos = _69_1453; FStar_Syntax_Syntax.vars = _69_1451}, us2)) -> begin
(
...
(let _151_841 = (prob_to_string env orig)
...
let _69_1489 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _151_845 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
let _69_1493 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_69_1493) with
| (u, args) -> begin
(
# 1108 "FStar.TypeChecker.Rel.fst"
let _69_1499 = (0, 1, 2, 3, 4)
in (match (_69_1499) with
...
let _69_1508 = (FStar_Syntax_Util.head_and_args t1)
in (match (_69_1508) with
| (h1, args1) -> begin
(
# 1113 "FStar.TypeChecker.Rel.fst"
let _69_1512 = (FStar_Syntax_Util.head_and_args t2)
in (match (_69_1512) with
| (h2, _69_1511) -> begin
...
(let _151_857 = (let _151_856 = (let _151_855 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _151_854 -> FStar_TypeChecker_Common.TProb (_151_854)) _151_855))
in (_151_856)::[])
in Some (_151_857))
end
end else begin
...
in (let _151_864 = (let _151_863 = (let _151_862 = (FStar_Syntax_Util.mk_conj phi1 phi2)
in (FStar_Syntax_Util.refine x _151_862))
in (_151_863, m))
in Some (_151_864))))))
end))
end
| (_69_1546, FStar_Syntax_Syntax.Tm_refine (y, _69_1549)) -> begin
(
...
| (FStar_Syntax_Syntax.Tm_refine (x, _69_1559), _69_1563) -> begin
(
...
| FStar_Syntax_Syntax.Tm_uvar (uv, _69_1578) -> begin
(
# 1167 "FStar.TypeChecker.Rel.fst"
let _69_1603 = (FStar_All.pipe_right wl.attempting (FStar_List.partition (fun _69_23 -> (match (_69_23) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(match (tp.FStar_TypeChecker_Common.rank) with
| Some (rank) when (is_flex_rigid rank) -> begin
(
# 1171 "FStar.TypeChecker.Rel.fst"
let _69_1589 = (FStar_Syntax_Util.head_and_args tp.FStar_TypeChecker_Common.lhs)
in (match (_69_1589) with
| (u', _69_1588) -> begin
(match ((let _151_866 = (whnf env u')
in _151_866.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (uv', _69_1592) -> begin
...
in (match (_69_1603) with
| (upper_bounds, rest) -> begin
(
# 1180 "FStar.TypeChecker.Rel.fst"
let rec make_upper_bound = (fun _69_1607 tps -> (match (_69_1607) with
...
(match ((let _151_871 = (whnf env hd.FStar_TypeChecker_Common.rhs)
in (conjoin bound _151_871))) with
...
in (match ((let _151_873 = (let _151_872 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in (_151_872, []))
in (make_upper_bound _151_873 upper_bounds))) with
| None -> begin
(
# 1191 "FStar.TypeChecker.Rel.fst"
let _69_1622 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _69_1632 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(
# 1206 "FStar.TypeChecker.Rel.fst"
let wl' = (
# 1206 "FStar.TypeChecker.Rel.fst"
let _69_1629 = wl
in {attempting = (FStar_TypeChecker_Common.TProb (eq_prob))::sub_probs; wl_deferred = _69_1629.wl_deferred; ctr = _69_1629.ctr; defer_ok = _69_1629.defer_ok; smt_ok = _69_1629.smt_ok; tcenv = _69_1629.tcenv})
in (let _151_874 = (wl_to_string wl')
...
let _69_1634 = wl
in {attempting = sub_probs; wl_deferred = _69_1634.wl_deferred; ctr = _69_1634.ctr; defer_ok = _69_1634.defer_ok; smt_ok = _69_1634.smt_ok; tcenv = _69_1634.tcenv}))) with
| Success (_69_1637) -> begin
(
# 1210 "FStar.TypeChecker.Rel.fst"
let wl = (
# 1210 "FStar.TypeChecker.Rel.fst"
let _69_1639 = wl
in {attempting = rest; wl_deferred = _69_1639.wl_deferred; ctr = _69_1639.ctr; defer_ok = _69_1639.defer_ok; smt_ok = _69_1639.smt_ok; tcenv = _69_1639.tcenv})
in (
...
let _69_1645 = (FStar_List.fold_left (fun wl p -> (solve_prob' true p None [] wl)) wl upper_bounds)
in Some (wl))))
end
| _69_1648 -> begin
None
...
let _69_1667 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_902 = (prob_to_string env rhs_prob)
...
# 1232 "FStar.TypeChecker.Rel.fst"
let _69_1681 = hd1
in (let _151_903 = (FStar_Syntax_Subst.subst subst hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _69_1681.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _69_1681.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _151_903}))
in (
# 1233 "FStar.TypeChecker.Rel.fst"
let hd2 = (
# 1233 "FStar.TypeChecker.Rel.fst"
let _69_1684 = hd2
in (let _151_904 = (FStar_Syntax_Subst.subst subst hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _69_1684.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _69_1684.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _151_904}))
in (
# 1234 "FStar.TypeChecker.Rel.fst"
let prob = (let _151_907 = (let _151_906 = (FStar_All.pipe_left invert_rel (p_rel orig))
in (mk_problem scope orig hd1.FStar_Syntax_Syntax.sort _151_906 hd2.FStar_Syntax_Syntax.sort None "Formal parameter"))
in (FStar_All.pipe_left (fun _151_905 -> FStar_TypeChecker_Common.TProb (_151_905)) _151_907))
in (
# 1235 "FStar.TypeChecker.Rel.fst"
let hd1 = (FStar_Syntax_Syntax.freshen_bv hd1)
in (
# 1236 "FStar.TypeChecker.Rel.fst"
let subst = (let _151_908 = (FStar_Syntax_Subst.shift_subst 1 subst)
in (FStar_Syntax_Syntax.DB ((0, hd1)))::_151_908)
in (
...
let phi = (let _151_910 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (let _151_909 = (FStar_Syntax_Util.close_forall (((hd1, imp))::[]) phi)
in (FStar_Syntax_Util.mk_conj _151_910 _151_909)))
in (
# 1241 "FStar.TypeChecker.Rel.fst"
let _69_1696 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_912 = (FStar_Syntax_Print.term_to_string phi)
in (let _151_911 = (FStar_Syntax_Print.bv_to_string hd1)
...
and solve_t : FStar_TypeChecker_Env.env  ->  tprob  ->  worklist  ->  solution = (fun env problem wl -> (let _151_916 = (compress_tprob wl problem)
in (solve_t' env _151_916 wl)))
...
let _69_1728 = (head_matches_delta env wl t1 t2)
in (match (_69_1728) with
| (m, o) -> begin
(match ((m, o)) with
| (MisMatch (_69_1730), _69_1733) -> begin
(
...
in (let _151_945 = (let _151_944 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_has_type t1 _151_944 t2))
in (FStar_Syntax_Util.mk_forall x _151_945)))
end))
...
in (let _151_946 = (solve_prob orig (Some (guard)) [] wl)
in (solve env _151_946)))
end else begin
(giveup env "head mismatch" orig)
end)
end
| (_69_1756, Some (t1, t2)) -> begin
(solve_t env (
# 1290 "FStar.TypeChecker.Rel.fst"
let _69_1762 = problem
in {FStar_TypeChecker_Common.pid = _69_1762.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _69_1762.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _69_1762.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1762.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1762.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1762.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1762.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_1762.FStar_TypeChecker_Common.rank}) wl)
end
| (_69_1765, None) -> begin
(
# 1293 "FStar.TypeChecker.Rel.fst"
let _69_1768 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_950 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_949 = (FStar_Syntax_Print.tag_of_term t1)
in (let _151_948 = (FStar_Syntax_Print.term_to_string t2)
in (let _151_947 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.print4 "Head matches: %s (%s) and %s (%s)\n" _151_950 _151_949 _151_948 _151_947)))))
end else begin
()
end
in (
# 1297 "FStar.TypeChecker.Rel.fst"
let _69_1772 = (FStar_Syntax_Util.head_and_args t1)
in (match (_69_1772) with
| (head, args) -> begin
(
# 1298 "FStar.TypeChecker.Rel.fst"
let _69_1775 = (FStar_Syntax_Util.head_and_args t2)
in (match (_69_1775) with
| (head', args') -> begin
(
# 1299 "FStar.TypeChecker.Rel.fst"
let nargs = (FStar_List.length args)
in if (nargs <> (FStar_List.length args')) then begin
(let _151_955 = (let _151_954 = (FStar_Syntax_Print.term_to_string head)
in (let _151_953 = (args_to_string args)
in (let _151_952 = (FStar_Syntax_Print.term_to_string head')
in (let _151_951 = (args_to_string args')
in (FStar_Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _151_954 _151_953 _151_952 _151_951)))))
in (giveup env _151_955 orig))
end else begin
if ((nargs = 0) || (eq_args args args')) then begin
(match ((solve_maybe_uinsts env orig head head' wl)) with
| USolved (wl) -> begin
(let _151_956 = (solve_prob orig None [] wl)
in (solve env _151_956))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
let _69_1785 = (base_and_refinement env wl t1)
in (match (_69_1785) with
| (base1, refinement1) -> begin
(
# 1321 "FStar.TypeChecker.Rel.fst"
let _69_1788 = (base_and_refinement env wl t2)
in (match (_69_1788) with
...
let subprobs = (FStar_List.map2 (fun _69_1801 _69_1805 -> (match ((_69_1801, _69_1805)) with
| ((a, _69_1800), (a', _69_1804)) -> begin
(let _151_960 = (mk_problem (p_scope orig) orig a FStar_TypeChecker_Common.EQ a' None "index")
in (FStar_All.pipe_left (fun _151_959 -> FStar_TypeChecker_Common.TProb (_151_959)) _151_960))
end)) args args')
in (
# 1329 "FStar.TypeChecker.Rel.fst"
let formula = (let _151_962 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
in (FStar_Syntax_Util.mk_conj_l _151_962))
in (
...
let _69_1814 = problem
in {FStar_TypeChecker_Common.pid = _69_1814.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = _69_1814.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = _69_1814.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_1814.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_1814.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_1814.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_1814.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_1814.FStar_TypeChecker_Common.rank}) wl)))
end)
end))
end))
end
...
let _69_1831 = p
in (match (_69_1831) with
| ((u, k), ps, xs, (h, _69_1828, qs)) -> begin
(
...
let _69_1837 = (imitation_sub_probs orig env xs ps qs)
in (match (_69_1837) with
| (sub_probs, gs_xs, formula) -> begin
(
# 1352 "FStar.TypeChecker.Rel.fst"
let im = (let _151_973 = (h gs_xs)
in (u_abs xs _151_973))
in (
# 1353 "FStar.TypeChecker.Rel.fst"
let _69_1839 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_978 = (FStar_Syntax_Print.term_to_string im)
in (let _151_977 = (FStar_Syntax_Print.tag_of_term im)
in (let _151_976 = (let _151_974 = (FStar_List.map (prob_to_string env) sub_probs)
in (FStar_All.pipe_right _151_974 (FStar_String.concat ", ")))
in (let _151_975 = (FStar_TypeChecker_Normalize.term_to_string env formula)
in (FStar_Util.print4 "Imitating %s (%s)\nsub_probs = %s\nformula=%s\n" _151_978 _151_977 _151_976 _151_975)))))
end else begin
()
end
in (
...
let _69_1860 = (FStar_List.nth ps i)
in (match (_69_1860) with
| (pi, _69_1859) -> begin
(
# 1370 "FStar.TypeChecker.Rel.fst"
let _69_1864 = (FStar_List.nth xs i)
in (match (_69_1864) with
| (xi, _69_1863) -> begin
(
# 1372 "FStar.TypeChecker.Rel.fst"
let rec gs = (fun k -> (
# 1373 "FStar.TypeChecker.Rel.fst"
let _69_1869 = (FStar_Syntax_Util.arrow_formals k)
in (match (_69_1869) with
| (bs, k) -> begin
(
...
let _69_1883 = (new_uvar r xs k_a)
in (match (_69_1883) with
| (gi_xs, gi) -> begin
(
...
let _69_1889 = (aux subst tl)
in (match (_69_1889) with
| (gi_xs', gi_ps') -> begin
(let _151_1000 = (let _151_997 = (FStar_Syntax_Syntax.as_arg gi_xs)
in (_151_997)::gi_xs')
in (let _151_999 = (let _151_998 = (FStar_Syntax_Syntax.as_arg gi_ps)
in (_151_998)::gi_ps')
...
in if (let _151_1001 = (matches pi)
in (FStar_All.pipe_left Prims.op_Negation _151_1001)) then begin
None
end else begin
(
# 1388 "FStar.TypeChecker.Rel.fst"
let _69_1893 = (gs xi.FStar_Syntax_Syntax.sort)
in (match (_69_1893) with
| (g_xs, _69_1892) -> begin
(
...
let proj = (let _151_1002 = (FStar_Syntax_Syntax.mk_Tm_app xi g_xs None r)
in (u_abs xs _151_1002))
in (
# 1391 "FStar.TypeChecker.Rel.fst"
let sub = (let _151_1008 = (let _151_1007 = (FStar_Syntax_Syntax.mk_Tm_app proj ps None r)
in (let _151_1006 = (let _151_1005 = (FStar_List.map (fun _69_1901 -> (match (_69_1901) with
| (_69_1897, _69_1899, y) -> begin
y
end)) qs)
in (FStar_All.pipe_left h _151_1005))
in (mk_problem (p_scope orig) orig _151_1007 (p_rel orig) _151_1006 None "projection")))
in (FStar_All.pipe_left (fun _151_1003 -> FStar_TypeChecker_Common.TProb (_151_1003)) _151_1008))
in (
# 1392 "FStar.TypeChecker.Rel.fst"
let _69_1903 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1010 = (FStar_Syntax_Print.term_to_string proj)
in (let _151_1009 = (prob_to_string env sub)
...
let wl = (let _151_1012 = (let _151_1011 = (FStar_All.pipe_left Prims.fst (p_guard sub))
in Some (_151_1011))
in (solve_prob orig _151_1012 ((TERM ((u, proj)))::[]) wl))
in (let _151_1014 = (solve env (attempt ((sub)::[]) wl))
in (FStar_All.pipe_left (fun _151_1013 -> Some (_151_1013)) _151_1014)))))))
end))
end)
end))
end)))
...
let _69_1917 = lhs
in (match (_69_1917) with
| ((t1, uv, k, args_lhs), maybe_pat_vars) -> begin
(
# 1400 "FStar.TypeChecker.Rel.fst"
let subterms = (fun ps -> (
# 1401 "FStar.TypeChecker.Rel.fst"
let xs = (let _151_1041 = (FStar_Syntax_Util.arrow_formals k)
in (FStar_All.pipe_right _151_1041 Prims.fst))
in (let _151_1046 = (decompose env t2)
in ((uv, k), ps, xs, _151_1046))))
in (
...
| Failed (_69_1927) -> begin
(
# 1411 "FStar.TypeChecker.Rel.fst"
let _69_1929 = (FStar_Unionfind.rollback tx)
...
let _69_1937 = (FStar_Unionfind.rollback tx)
in (imitate_or_project n st (i + 1)))
end
| Some (sol) -> begin
sol
...
let _69_1947 = (FStar_Syntax_Util.head_and_args t2)
in (match (_69_1947) with
| (hd, _69_1946) -> begin
...
let _69_1960 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1057 = (names_to_string fvs_hd)
in (FStar_Util.print1 "Free variables are %s" _151_1057))
end else begin
()
end
in false)
...
let fvs_hd = (let _151_1061 = (let _151_1060 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _151_1060 Prims.fst))
in (FStar_All.pipe_right _151_1061 FStar_Syntax_Free.names))
...
let _69_1973 = (occurs_check env wl (uv, k) t2)
in (match (_69_1973) with
| (occurs_ok, msg) -> begin
if (not (occurs_ok)) then begin
(let _151_1063 = (let _151_1062 = (FStar_Option.get msg)
in (Prims.strcat "occurs-check failed: " _151_1062))
in (giveup_or_defer orig _151_1063))
end else begin
...
(let _151_1064 = (subterms args_lhs)
in (imitate orig env wl _151_1064))
end else begin
(
# 1454 "FStar.TypeChecker.Rel.fst"
let _69_1974 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1067 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_1066 = (names_to_string fvs1)
in (let _151_1065 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s succeeded fvar check: %s\n" _151_1067 _151_1066 _151_1065))))
end else begin
()
end
in (
...
| _69_1978 -> begin
(let _151_1068 = (sn_binders env vars)
in (u_abs _151_1068 t2))
end)
in (
...
let _69_1981 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1071 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_1070 = (names_to_string fvs1)
in (let _151_1069 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _151_1071 _151_1070 _151_1069))))
end else begin
()
end
in (let _151_1072 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _151_1072 (- (1)))))
end else begin
...
if (let _151_1073 = (FStar_Syntax_Free.names t1)
in (check_head _151_1073 t2)) then begin
(
# 1479 "FStar.TypeChecker.Rel.fst"
let im_ok = (imitate_ok t2)
in (
# 1480 "FStar.TypeChecker.Rel.fst"
let _69_1985 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1074 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print2 "Not a pattern (%s) ... %s\n" _151_1074 (if (im_ok < 0) then begin
"imitating"
end else begin
"projecting"
end)))
...
in (let _151_1075 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _151_1075 im_ok))))
end else begin
...
let force_quasi_pattern = (fun xs_opt _69_1997 -> (match (_69_1997) with
| (t, u, k, args) -> begin
(
# 1511 "FStar.TypeChecker.Rel.fst"
let _69_2001 = (FStar_Syntax_Util.arrow_formals k)
in (match (_69_2001) with
| (all_formals, _69_2000) -> begin
(
...
let pat_args = (FStar_All.pipe_right (FStar_List.rev pat_args) (FStar_List.map (fun _69_2015 -> (match (_69_2015) with
| (x, imp) -> begin
(let _151_1097 = (FStar_Syntax_Syntax.bv_to_name x)
in (_151_1097, imp))
end))))
in (
...
let _69_2021 = (FStar_Syntax_Util.type_u ())
in (match (_69_2021) with
| (t, _69_2020) -> begin
(let _151_1098 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars t)
in (Prims.fst _151_1098))
end))
in (
# 1527 "FStar.TypeChecker.Rel.fst"
let _69_2025 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars kk)
in (match (_69_2025) with
| (t', tm_u1) -> begin
(
# 1528 "FStar.TypeChecker.Rel.fst"
let _69_2032 = (destruct_flex_t t')
in (match (_69_2032) with
| (_69_2027, u1, k1, _69_2031) -> begin
(
# 1529 "FStar.TypeChecker.Rel.fst"
let sol = (let _151_1100 = (let _151_1099 = (u_abs all_formals t')
in ((u, k), _151_1099))
in TERM (_151_1100))
in (
...
| Some (xs) -> begin
(FStar_All.pipe_right xs (FStar_Util.for_some (fun _69_2051 -> (match (_69_2051) with
| (x, _69_2050) -> begin
...
(let _151_1102 = (FStar_Util.set_add (Prims.fst formal) pattern_var_set)
in (aux ((y)::pat_args) ((formal)::pattern_vars) _151_1102 formals tl))
end)
end)
end)
end
...
in (let _151_1103 = (FStar_Syntax_Syntax.new_bv_set ())
in (aux [] [] _151_1103 all_formals args))))
end))
end))
in (
# 1558 "FStar.TypeChecker.Rel.fst"
let solve_both_pats = (fun wl _69_2061 _69_2065 r -> (match ((_69_2061, _69_2065)) with
| ((u1, k1, xs), (u2, k2, ys)) -> begin
if ((FStar_Unionfind.equivalent u1 u2) && (binders_eq xs ys)) then begin
(let _151_1112 = (solve_prob orig None [] wl)
in (solve env _151_1112))
end else begin
(
...
let _69_2070 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1115 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _151_1114 = (FStar_Syntax_Print.binders_to_string ", " ys)
in (let _151_1113 = (FStar_Syntax_Print.binders_to_string ", " zs)
in (FStar_Util.print3 "Flex-flex patterns: intersected %s and %s; got %s\n" _151_1115 _151_1114 _151_1113))))
end else begin
()
end
in (
...
let _69_2075 = (FStar_Syntax_Util.type_u ())
in (match (_69_2075) with
| (t, _69_2074) -> begin
(
# 1574 "FStar.TypeChecker.Rel.fst"
let _69_2079 = (new_uvar r zs t)
in (match (_69_2079) with
| (k, _69_2078) -> begin
(new_uvar r zs k)
end))
end))
...
let _69_2087 = (occurs_check env wl (u1, k1) sub1)
in (match (_69_2087) with
| (occurs_ok, msg) -> begin
if (not (occurs_ok)) then begin
...
let _69_2093 = (occurs_check env wl (u2, k2) sub2)
in (match (_69_2093) with
| (occurs_ok, msg) -> begin
if (not (occurs_ok)) then begin
...
let solve_one_pat = (fun _69_2101 _69_2106 -> (match ((_69_2101, _69_2106)) with
| ((t1, u1, k1, xs), (t2, u2, k2, args2)) -> begin
(
# 1594 "FStar.TypeChecker.Rel.fst"
let _69_2107 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1121 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_1120 = (FStar_Syntax_Print.term_to_string t2)
...
let sub_probs = (FStar_List.map2 (fun _69_2112 _69_2116 -> (match ((_69_2112, _69_2116)) with
| ((a, _69_2111), (t2, _69_2115)) -> begin
(let _151_1126 = (let _151_1124 = (FStar_Syntax_Syntax.bv_to_name a)
in (mk_problem (p_scope orig) orig _151_1124 FStar_TypeChecker_Common.EQ t2 None "flex-flex index"))
in (FStar_All.pipe_right _151_1126 (fun _151_1125 -> FStar_TypeChecker_Common.TProb (_151_1125))))
end)) xs args2)
in (
# 1600 "FStar.TypeChecker.Rel.fst"
let guard = (let _151_1128 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _151_1128))
in (
...
let _69_2126 = (occurs_check env wl (u1, k1) t2)
in (match (_69_2126) with
| (occurs_ok, _69_2125) -> begin
(
...
let sol = (let _151_1130 = (let _151_1129 = (u_abs xs t2)
in ((u1, k1), _151_1129))
in TERM (_151_1130))
in (
...
let _69_2137 = (force_quasi_pattern (Some (xs)) (t2, u2, k2, args2))
in (match (_69_2137) with
| (sol, (_69_2132, u2, k2, ys)) -> begin
(
# 1615 "FStar.TypeChecker.Rel.fst"
let wl = (extend_solution (p_pid orig) ((sol)::[]) wl)
in (
# 1616 "FStar.TypeChecker.Rel.fst"
let _69_2139 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
(let _151_1131 = (uvi_to_string env sol)
...
let _69_2149 = lhs
in (match (_69_2149) with
| (t1, u1, k1, args1) -> begin
(
# 1625 "FStar.TypeChecker.Rel.fst"
let _69_2154 = rhs
in (match (_69_2154) with
...
let _69_2176 = (force_quasi_pattern None (t1, u1, k1, args1))
in (match (_69_2176) with
| (sol, _69_2175) -> begin
(
...
let _69_2178 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
(let _151_1132 = (uvi_to_string env sol)
...
(let _151_1133 = (solve_prob orig None [] wl)
in (solve env _151_1133))
end else begin
(
...
(let _151_1134 = (solve_prob orig None [] wl)
in (solve env _151_1134))
end else begin
(
# 1651 "FStar.TypeChecker.Rel.fst"
let _69_2187 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("RelCheck"))) then begin
(let _151_1135 = (FStar_Util.string_of_int problem.FStar_TypeChecker_Common.pid)
...
let match_num_binders = (fun _69_2192 _69_2195 -> (match ((_69_2192, _69_2195)) with
| ((bs1, mk_cod1), (bs2, mk_cod2)) -> begin
(
# 1658 "FStar.TypeChecker.Rel.fst"
let curry = (fun n bs mk_cod -> (
# 1659 "FStar.TypeChecker.Rel.fst"
let _69_2202 = (FStar_Util.first_N n bs)
in (match (_69_2202) with
| (bs, rest) -> begin
(let _151_1165 = (mk_cod rest)
in (bs, _151_1165))
end)))
in (
...
(let _151_1169 = (let _151_1166 = (mk_cod1 [])
in (bs1, _151_1166))
in (let _151_1168 = (let _151_1167 = (mk_cod2 [])
in (bs2, _151_1167))
in (_151_1169, _151_1168)))
end else begin
if (l1 > l2) then begin
(let _151_1172 = (curry l2 bs1 mk_cod1)
in (let _151_1171 = (let _151_1170 = (mk_cod2 [])
in (bs2, _151_1170))
in (_151_1172, _151_1171)))
end else begin
(let _151_1175 = (let _151_1173 = (mk_cod1 [])
in (bs1, _151_1173))
in (let _151_1174 = (curry l1 bs2 mk_cod2)
in (_151_1175, _151_1174)))
end
end)))
end))
in (match ((t1.FStar_Syntax_Syntax.n, t2.FStar_Syntax_Syntax.n)) with
...
| bs -> begin
(let _151_1180 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((bs, c))) None c.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk_Total _151_1180))
end))
in (
# 1685 "FStar.TypeChecker.Rel.fst"
let _69_2245 = (match_num_binders (bs1, (mk_c c1)) (bs2, (mk_c c2)))
in (match (_69_2245) with
| ((bs1, c1), (bs2, c2)) -> begin
...
in (let _151_1187 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (FStar_All.pipe_left (fun _151_1186 -> FStar_TypeChecker_Common.CProb (_151_1186)) _151_1187)))))))
end)))
end
| (FStar_Syntax_Syntax.Tm_abs (bs1, tbody1, _69_2255), FStar_Syntax_Syntax.Tm_abs (bs2, tbody2, _69_2261)) -> begin
(
...
let _69_2276 = (match_num_binders (bs1, (mk_t tbody1)) (bs2, (mk_t tbody2)))
in (match (_69_2276) with
| ((bs1, tbody1), (bs2, tbody2)) -> begin
(solve_binders env bs1 bs2 orig wl (fun scope env subst -> (let _151_1200 = (let _151_1199 = (FStar_Syntax_Subst.subst subst tbody1)
in (let _151_1198 = (FStar_Syntax_Subst.subst subst tbody2)
in (mk_problem scope orig _151_1199 problem.FStar_TypeChecker_Common.relation _151_1198 None "lambda co-domain")))
in (FStar_All.pipe_left (fun _151_1197 -> FStar_TypeChecker_Common.TProb (_151_1197)) _151_1200))))
end)))
end
| (FStar_Syntax_Syntax.Tm_refine (_69_2281), FStar_Syntax_Syntax.Tm_refine (_69_2284)) -> begin
(
# 1708 "FStar.TypeChecker.Rel.fst"
let _69_2289 = (as_refinement env wl t1)
in (match (_69_2289) with
| (x1, phi1) -> begin
(
# 1709 "FStar.TypeChecker.Rel.fst"
let _69_2292 = (as_refinement env wl t2)
in (match (_69_2292) with
| (x2, phi2) -> begin
(
# 1710 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _151_1202 = (mk_problem (p_scope orig) orig x1.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.relation x2.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "refinement base type")
in (FStar_All.pipe_left (fun _151_1201 -> FStar_TypeChecker_Common.TProb (_151_1201)) _151_1202))
in (
...
let mk_imp = (fun imp phi1 phi2 -> (let _151_1219 = (imp phi1 phi2)
in (FStar_All.pipe_right _151_1219 (guard_on_element problem x1))))
in (
# 1717 "FStar.TypeChecker.Rel.fst"
let fallback = (fun _69_2304 -> (match (()) with
| () -> begin
(
...
let guard = (let _151_1222 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _151_1222 impl))
in (
...
let ref_prob = (let _151_1226 = (let _151_1225 = (let _151_1224 = (FStar_Syntax_Syntax.mk_binder x1)
in (_151_1224)::(p_scope orig))
in (mk_problem _151_1225 orig phi1 FStar_TypeChecker_Common.EQ phi2 None "refinement formula"))
in (FStar_All.pipe_left (fun _151_1223 -> FStar_TypeChecker_Common.TProb (_151_1223)) _151_1226))
in (match ((solve env (
# 1727 "FStar.TypeChecker.Rel.fst"
let _69_2309 = wl
in {attempting = (ref_prob)::[]; wl_deferred = []; ctr = _69_2309.ctr; defer_ok = false; smt_ok = _69_2309.smt_ok; tcenv = _69_2309.tcenv}))) with
| Failed (_69_2312) -> begin
(fallback ())
end
| Success (_69_2315) -> begin
(
# 1730 "FStar.TypeChecker.Rel.fst"
let guard = (let _151_1229 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (let _151_1228 = (let _151_1227 = (FStar_All.pipe_right (p_guard ref_prob) Prims.fst)
in (FStar_All.pipe_right _151_1227 (guard_on_element problem x1)))
in (FStar_Syntax_Util.mk_conj _151_1229 _151_1228)))
in (
...
# 1732 "FStar.TypeChecker.Rel.fst"
let _69_2319 = wl
in {attempting = _69_2319.attempting; wl_deferred = _69_2319.wl_deferred; ctr = (wl.ctr + 1); defer_ok = _69_2319.defer_ok; smt_ok = _69_2319.smt_ok; tcenv = _69_2319.tcenv})
in (solve env (attempt ((base_prob)::[]) wl)))))
end))
end else begin
(fallback ())
...
(let _151_1231 = (destruct_flex_t t1)
in (let _151_1230 = (destruct_flex_t t2)
in (flex_flex orig _151_1231 _151_1230)))
end
...
(let _151_1232 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid orig _151_1232 t2 wl))
end
...
in if (let _151_1233 = (is_top_level_prob orig)
in (FStar_All.pipe_left Prims.op_Negation _151_1233)) then begin
(let _151_1236 = (FStar_All.pipe_left (fun _151_1234 -> FStar_TypeChecker_Common.TProb (_151_1234)) (
# 1762 "FStar.TypeChecker.Rel.fst"
let _69_2464 = problem
in {FStar_TypeChecker_Common.pid = _69_2464.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_2464.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _69_2464.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2464.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2464.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2464.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2464.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2464.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2464.FStar_TypeChecker_Common.rank}))
in (let _151_1235 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _151_1236 _151_1235 t2 wl)))
end else begin
(
# 1763 "FStar.TypeChecker.Rel.fst"
let _69_2468 = (base_and_refinement env wl t2)
in (match (_69_2468) with
| (t_base, ref_opt) -> begin
(match (ref_opt) with
| None -> begin
(let _151_1239 = (FStar_All.pipe_left (fun _151_1237 -> FStar_TypeChecker_Common.TProb (_151_1237)) (
# 1766 "FStar.TypeChecker.Rel.fst"
let _69_2470 = problem
in {FStar_TypeChecker_Common.pid = _69_2470.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_2470.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = new_rel; FStar_TypeChecker_Common.rhs = _69_2470.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2470.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2470.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2470.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2470.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2470.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2470.FStar_TypeChecker_Common.rank}))
in (let _151_1238 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _151_1239 _151_1238 t_base wl)))
end
| Some (y, phi) -> begin
(
...
# 1769 "FStar.TypeChecker.Rel.fst"
let _69_2476 = y
in {FStar_Syntax_Syntax.ppname = _69_2476.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _69_2476.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})
in (
# 1770 "FStar.TypeChecker.Rel.fst"
let impl = (guard_on_element problem y' phi)
in (
# 1771 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _151_1241 = (mk_problem problem.FStar_TypeChecker_Common.scope orig t1 new_rel y.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _151_1240 -> FStar_TypeChecker_Common.TProb (_151_1240)) _151_1241))
in (
# 1773 "FStar.TypeChecker.Rel.fst"
let guard = (let _151_1242 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _151_1242 impl))
in (
...
let _69_2509 = (base_and_refinement env wl t1)
in (match (_69_2509) with
| (t_base, _69_2508) -> begin
(solve_t env (
# 1784 "FStar.TypeChecker.Rel.fst"
let _69_2510 = problem
in {FStar_TypeChecker_Common.pid = _69_2510.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t_base; FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ; FStar_TypeChecker_Common.rhs = _69_2510.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2510.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2510.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2510.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2510.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2510.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2510.FStar_TypeChecker_Common.rank}) wl)
end))
end
end
| (FStar_Syntax_Syntax.Tm_refine (_69_2513), _69_2516) -> begin
(
# 1787 "FStar.TypeChecker.Rel.fst"
let t2 = (let _151_1243 = (base_and_refinement env wl t2)
in (FStar_All.pipe_left force_refinement _151_1243))
in (solve_t env (
...
| (_69_2522, FStar_Syntax_Syntax.Tm_refine (_69_2524)) -> begin
(
# 1791 "FStar.TypeChecker.Rel.fst"
let t1 = (let _151_1244 = (base_and_refinement env wl t1)
in (FStar_All.pipe_left force_refinement _151_1244))
in (solve_t env (
# 1792 "FStar.TypeChecker.Rel.fst"
let _69_2528 = problem
in {FStar_TypeChecker_Common.pid = _69_2528.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _69_2528.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_2528.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2528.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2528.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2528.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2528.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2528.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2528.FStar_TypeChecker_Common.rank}) wl))
end
...
| FStar_Syntax_Syntax.Tm_abs (_69_2545) -> begin
t
end
| _69_2548 -> begin
...
let _69_2549 = problem
in (let _151_1248 = (maybe_eta t1)
in (let _151_1247 = (maybe_eta t2)
in {FStar_TypeChecker_Common.pid = _69_2549.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _151_1248; FStar_TypeChecker_Common.relation = _69_2549.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _151_1247; FStar_TypeChecker_Common.element = _69_2549.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2549.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2549.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2549.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2549.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2549.FStar_TypeChecker_Common.rank})))
in (solve_t env _151_1249 wl)))
end
...
let head1 = (let _151_1250 = (FStar_Syntax_Util.head_and_args t1)
in (FStar_All.pipe_right _151_1250 Prims.fst))
in (
# 1814 "FStar.TypeChecker.Rel.fst"
let head2 = (let _151_1251 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _151_1251 Prims.fst))
...
(let _151_1253 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Syntax.tun FStar_Syntax_Syntax.tun t1 t2)
in (FStar_All.pipe_left (fun _151_1252 -> Some (_151_1252)) _151_1253))
end
in (let _151_1254 = (solve_prob orig guard [] wl)
...
| (FStar_Syntax_Syntax.Tm_ascribed (t1, _69_2630, _69_2632), _69_2636) -> begin
(solve_t' env (
# 1830 "FStar.TypeChecker.Rel.fst"
let _69_2638 = problem
in {FStar_TypeChecker_Common.pid = _69_2638.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = t1; FStar_TypeChecker_Common.relation = _69_2638.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_2638.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2638.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2638.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2638.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2638.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2638.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2638.FStar_TypeChecker_Common.rank}) wl)
end
| (_69_2641, FStar_Syntax_Syntax.Tm_ascribed (t2, _69_2644, _69_2646)) -> begin
(solve_t' env (
# 1833 "FStar.TypeChecker.Rel.fst"
let _69_2650 = problem
in {FStar_TypeChecker_Common.pid = _69_2650.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_2650.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _69_2650.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = t2; FStar_TypeChecker_Common.element = _69_2650.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2650.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2650.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2650.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2650.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2650.FStar_TypeChecker_Common.rank}) wl)
end
...
(let _151_1257 = (let _151_1256 = (FStar_Syntax_Print.tag_of_term t1)
in (let _151_1255 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.format2 "Impossible: %s and %s" _151_1256 _151_1255)))
...
let _69_2706 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("EQ"))) then begin
...
let sub_probs = (FStar_List.map2 (fun _69_2711 _69_2715 -> (match ((_69_2711, _69_2715)) with
| ((a1, _69_2710), (a2, _69_2714)) -> begin
(let _151_1272 = (sub_prob a1 FStar_TypeChecker_Common.EQ a2 "effect arg")
in (FStar_All.pipe_left (fun _151_1271 -> FStar_TypeChecker_Common.TProb (_151_1271)) _151_1272))
end)) c1_comp.FStar_Syntax_Syntax.effect_args c2_comp.FStar_Syntax_Syntax.effect_args)
in (
# 1856 "FStar.TypeChecker.Rel.fst"
let guard = (let _151_1274 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _151_1274))
in (
# 1857 "FStar.TypeChecker.Rel.fst"
let wl = (solve_prob orig (Some (guard)) [] wl)
in (solve env (attempt sub_probs wl)))))))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _151_1275 = (solve_prob orig None [] wl)
in (solve env _151_1275))
end else begin
(
# 1861 "FStar.TypeChecker.Rel.fst"
let _69_2720 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1277 = (FStar_Syntax_Print.comp_to_string c1)
in (let _151_1276 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _151_1277 (rel_to_string problem.FStar_TypeChecker_Common.relation) _151_1276)))
end else begin
()
end
in (
...
let _69_2725 = (c1, c2)
in (match (_69_2725) with
| (c1_0, c2_0) -> begin
(match ((c1.FStar_Syntax_Syntax.n, c2.FStar_Syntax_Syntax.n)) with
| (FStar_Syntax_Syntax.GTotal (_69_2727), FStar_Syntax_Syntax.Total (_69_2730)) -> begin
...
(let _151_1278 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
...
let _69_2758 = problem
in (let _151_1279 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c1))
in {FStar_TypeChecker_Common.pid = _69_2758.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _151_1279; FStar_TypeChecker_Common.relation = _69_2758.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _69_2758.FStar_TypeChecker_Common.rhs; FStar_TypeChecker_Common.element = _69_2758.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2758.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2758.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2758.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2758.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2758.FStar_TypeChecker_Common.rank}))
in (solve_c env _151_1280 wl))
end
...
let _69_2774 = problem
in (let _151_1281 = (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp (FStar_Syntax_Util.comp_to_comp_typ c2))
in {FStar_TypeChecker_Common.pid = _69_2774.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _69_2774.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _69_2774.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _151_1281; FStar_TypeChecker_Common.element = _69_2774.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _69_2774.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _69_2774.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _69_2774.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _69_2774.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _69_2774.FStar_TypeChecker_Common.rank}))
in (solve_c env _151_1282 wl))
end
| (FStar_Syntax_Syntax.Comp (_69_2777), FStar_Syntax_Syntax.Comp (_69_2780)) -> begin
...
(let _151_1283 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _151_1283 wl))
end else begin
(
...
let _69_2787 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
| None -> begin
(let _151_1286 = (let _151_1285 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _151_1284 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _151_1285 _151_1284)))
in (giveup env _151_1286 orig))
end
| Some (edge) -> begin
if (problem.FStar_TypeChecker_Common.relation = FStar_TypeChecker_Common.EQ) then begin
(
# 1903 "FStar.TypeChecker.Rel.fst"
let _69_2805 = (match (c1.FStar_Syntax_Syntax.effect_args) with
| (wp1, _69_2798)::(wlp1, _69_2794)::[] -> begin
(wp1, wlp1)
end
| _69_2802 -> begin
(let _151_1288 = (let _151_1287 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid c1.FStar_Syntax_Syntax.effect_name))
in (FStar_Util.format1 "Unexpected number of indices on a normalized effect (%s)" _151_1287))
in (FStar_All.failwith _151_1288))
end)
in (match (_69_2805) with
| (wp, wlp) -> begin
(
# 1906 "FStar.TypeChecker.Rel.fst"
let c1 = (let _151_1294 = (let _151_1293 = (let _151_1289 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _151_1289))
in (let _151_1292 = (let _151_1291 = (let _151_1290 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wlp)
in (FStar_Syntax_Syntax.as_arg _151_1290))
in (_151_1291)::[])
in (_151_1293)::_151_1292))
in {FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _151_1294; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2))
end))
end else begin
(
...
let _69_2833 = (match ((c1.FStar_Syntax_Syntax.effect_args, c2.FStar_Syntax_Syntax.effect_args)) with
| ((wp1, _69_2818)::_69_2815, (wp2, _69_2825)::_69_2822) -> begin
(wp1, wp2)
end
| _69_2830 -> begin
(let _151_1298 = (let _151_1297 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _151_1296 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _151_1297 _151_1296)))
in (FStar_All.failwith _151_1298))
end)
in (match (_69_2833) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _151_1299 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _151_1299 wl))
end else begin
(
...
let _69_2835 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(FStar_Util.print_string "Using trivial wp ... \n")
end else begin
()
end
in (let _151_1309 = (let _151_1308 = (let _151_1307 = (let _151_1301 = (let _151_1300 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_151_1300)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _151_1301 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _151_1306 = (let _151_1305 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _151_1304 = (let _151_1303 = (let _151_1302 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _151_1302))
in (_151_1303)::[])
in (_151_1305)::_151_1304))
in (_151_1307, _151_1306)))
in FStar_Syntax_Syntax.Tm_app (_151_1308))
in (FStar_Syntax_Syntax.mk _151_1309 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(
# 1928 "FStar.TypeChecker.Rel.fst"
let wp2_imp_wp1 = (let _151_1325 = (let _151_1324 = (let _151_1323 = (let _151_1311 = (let _151_1310 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_151_1310)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _151_1311 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_binop))
in (let _151_1322 = (let _151_1321 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _151_1320 = (let _151_1319 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _151_1318 = (let _151_1317 = (let _151_1313 = (let _151_1312 = (FStar_Ident.set_lid_range FStar_Syntax_Const.imp_lid r)
in (FStar_Syntax_Syntax.fvar _151_1312 (FStar_Syntax_Syntax.Delta_unfoldable (1)) None))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _151_1313))
in (let _151_1316 = (let _151_1315 = (let _151_1314 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _151_1314))
in (_151_1315)::[])
in (_151_1317)::_151_1316))
in (_151_1319)::_151_1318))
in (_151_1321)::_151_1320))
in (_151_1323, _151_1322)))
in FStar_Syntax_Syntax.Tm_app (_151_1324))
in (FStar_Syntax_Syntax.mk _151_1325 None r))
in (let _151_1334 = (let _151_1333 = (let _151_1332 = (let _151_1327 = (let _151_1326 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_151_1326)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _151_1327 env c2_decl c2_decl.FStar_Syntax_Syntax.wp_as_type))
in (let _151_1331 = (let _151_1330 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _151_1329 = (let _151_1328 = (FStar_Syntax_Syntax.as_arg wp2_imp_wp1)
in (_151_1328)::[])
in (_151_1330)::_151_1329))
in (_151_1332, _151_1331)))
in FStar_Syntax_Syntax.Tm_app (_151_1333))
in (FStar_Syntax_Syntax.mk _151_1334 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end
in (
# 1935 "FStar.TypeChecker.Rel.fst"
let base_prob = (let _151_1336 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _151_1335 -> FStar_TypeChecker_Common.TProb (_151_1335)) _151_1336))
in (
# 1936 "FStar.TypeChecker.Rel.fst"
let wl = (let _151_1340 = (let _151_1339 = (let _151_1338 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _151_1338 g))
in (FStar_All.pipe_left (fun _151_1337 -> Some (_151_1337)) _151_1339))
in (solve_prob orig _151_1340 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _151_1344 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _69_2851 -> (match (_69_2851) with
| (_69_2843, u, _69_2846, _69_2848, _69_2850) -> begin
...
let carry = (let _151_1350 = (FStar_List.map (fun _69_2866 -> (match (_69_2866) with
| (_69_2864, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _151_1350 (FStar_String.concat ",\n")))
in (
...
| {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _69_2875; FStar_TypeChecker_Env.implicits = _69_2873} -> begin
true
end
| _69_2880 -> begin
false
...
let _69_2900 = g
in (let _151_1365 = (let _151_1364 = (let _151_1363 = (let _151_1362 = (FStar_Syntax_Syntax.mk_binder x)
in (_151_1362)::[])
in (u_abs _151_1363 f))
in (FStar_All.pipe_left (fun _151_1361 -> FStar_TypeChecker_Common.NonTrivial (_151_1361)) _151_1364))
in {FStar_TypeChecker_Env.guard_f = _151_1365; FStar_TypeChecker_Env.deferred = _69_2900.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_2900.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_2900.FStar_TypeChecker_Env.implicits}))
in Some (_151_1366)))
end))
...
let _69_2907 = g
in (let _151_1377 = (let _151_1376 = (let _151_1375 = (let _151_1374 = (let _151_1373 = (let _151_1372 = (FStar_Syntax_Syntax.as_arg e)
in (_151_1372)::[])
in (f, _151_1373))
in FStar_Syntax_Syntax.Tm_app (_151_1374))
in (FStar_Syntax_Syntax.mk _151_1375 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _151_1371 -> FStar_TypeChecker_Common.NonTrivial (_151_1371)) _151_1376))
in {FStar_TypeChecker_Env.guard_f = _151_1377; FStar_TypeChecker_Env.deferred = _69_2907.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_2907.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_2907.FStar_TypeChecker_Env.implicits}))
end))
...
| FStar_TypeChecker_Common.NonTrivial (_69_2912) -> begin
(FStar_All.failwith "impossible")
end))
...
(let _151_1384 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_151_1384))
end))
...
let binop_guard : (FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula)  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t = (fun f g1 g2 -> (let _151_1407 = (f g1.FStar_TypeChecker_Env.guard_f g2.FStar_TypeChecker_Env.guard_f)
in {FStar_TypeChecker_Env.guard_f = _151_1407; FStar_TypeChecker_Env.deferred = (FStar_List.append g1.FStar_TypeChecker_Env.deferred g2.FStar_TypeChecker_Env.deferred); FStar_TypeChecker_Env.univ_ineqs = (FStar_List.append g1.FStar_TypeChecker_Env.univ_ineqs g2.FStar_TypeChecker_Env.univ_ineqs); FStar_TypeChecker_Env.implicits = (FStar_List.append g1.FStar_TypeChecker_Env.implicits g2.FStar_TypeChecker_Env.implicits)}))
...
let _69_2957 = g
in (let _151_1422 = (let _151_1421 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _151_1421 (fun _151_1420 -> FStar_TypeChecker_Common.NonTrivial (_151_1420))))
in {FStar_TypeChecker_Env.guard_f = _151_1422; FStar_TypeChecker_Env.deferred = _69_2957.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_2957.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_2957.FStar_TypeChecker_Env.implicits}))
end))
...
(let _151_1430 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _151_1429 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _151_1430 (rel_to_string rel) _151_1429)))
end else begin
"TOP"
end
in (
...
let x = (let _151_1441 = (let _151_1440 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _151_1439 -> Some (_151_1439)) _151_1440))
in (FStar_Syntax_Syntax.new_bv _151_1441 t1))
in (
# 2030 "FStar.TypeChecker.Rel.fst"
let env = (FStar_TypeChecker_Env.push_bv env x)
in (
# 2031 "FStar.TypeChecker.Rel.fst"
let p = (let _151_1445 = (let _151_1443 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _151_1442 -> Some (_151_1442)) _151_1443))
in (let _151_1444 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _151_1445 _151_1444)))
...
# 2035 "FStar.TypeChecker.Rel.fst"
let _69_2977 = probs
in {attempting = _69_2977.attempting; wl_deferred = _69_2977.wl_deferred; ctr = _69_2977.ctr; defer_ok = false; smt_ok = _69_2977.smt_ok; tcenv = _69_2977.tcenv})
end else begin
probs
end
in (
...
let _69_2984 = (FStar_Unionfind.commit tx)
in Some (deferred))
end
| Failed (d, s) -> begin
(
# 2043 "FStar.TypeChecker.Rel.fst"
let _69_2990 = (FStar_Unionfind.rollback tx)
in (
# 2044 "FStar.TypeChecker.Rel.fst"
let _69_2992 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("ExplainRel"))) then begin
(let _151_1457 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _151_1457))
end else begin
()
end
in (err (d, s))))
...
let _69_2999 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _151_1462 = (FStar_Syntax_Print.term_to_string f)
...
let _69_3002 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _151_1463 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _151_1464 = (FStar_Syntax_Util.unmeta f)
...
let _69_3009 = g
in {FStar_TypeChecker_Env.guard_f = f; FStar_TypeChecker_Env.deferred = _69_3009.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_3009.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_3009.FStar_TypeChecker_Env.implicits})))))
end))
...
| Some (d) -> begin
(let _151_1476 = (let _151_1475 = (let _151_1474 = (let _151_1473 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _151_1473 (fun _151_1472 -> FStar_TypeChecker_Common.NonTrivial (_151_1472))))
in {FStar_TypeChecker_Env.guard_f = _151_1474; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _151_1475))
in (FStar_All.pipe_left (fun _151_1471 -> Some (_151_1471)) _151_1476))
end))
...
let _69_3020 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1484 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_1483 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _151_1487 = (let _151_1486 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _151_1486))
in (FStar_All.pipe_left (fun _151_1485 -> FStar_TypeChecker_Common.TProb (_151_1485)) _151_1487))
in (
# 2068 "FStar.TypeChecker.Rel.fst"
let g = (let _151_1489 = (solve_and_commit env (singleton env prob) (fun _69_3023 -> None))
...
| None -> begin
(let _151_1499 = (let _151_1498 = (let _151_1497 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _151_1496 = (FStar_TypeChecker_Env.get_range env)
in (_151_1497, _151_1496)))
in FStar_Syntax_Syntax.Error (_151_1498))
in (Prims.raise _151_1499))
end
| Some (g) -> begin
(
# 2075 "FStar.TypeChecker.Rel.fst"
let _69_3032 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1502 = (FStar_Syntax_Print.term_to_string t1)
in (let _151_1501 = (FStar_Syntax_Print.term_to_string t2)
in (let _151_1500 = (guard_to_string env g)
in (FStar_Util.print3 "teq of %s and %s succeeded with guard %s\n" _151_1502 _151_1501 _151_1500))))
end else begin
()
end
in g)
...
let _69_3037 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1510 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _151_1509 = (FStar_TypeChecker_Normalize.term_to_string env t2)
...
let _69_3041 = (new_t_prob env t1 FStar_TypeChecker_Common.SUB t2)
in (match (_69_3041) with
| (prob, x) -> begin
(
# 2086 "FStar.TypeChecker.Rel.fst"
let g = (let _151_1512 = (solve_and_commit env (singleton env prob) (fun _69_3042 -> None))
in (FStar_All.pipe_left (with_guard env prob) _151_1512))
in (
# 2087 "FStar.TypeChecker.Rel.fst"
let _69_3045 = if ((FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) && (FStar_Util.is_some g)) then begin
(let _151_1516 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _151_1515 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _151_1514 = (let _151_1513 = (FStar_Util.must g)
in (guard_to_string env _151_1513))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _151_1516 _151_1515 _151_1514))))
end else begin
()
end
...
let subtype_fail = (fun env t1 t2 -> (let _151_1523 = (let _151_1522 = (let _151_1521 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _151_1520 = (FStar_TypeChecker_Env.get_range env)
in (_151_1521, _151_1520)))
in FStar_Syntax_Syntax.Error (_151_1522))
in (Prims.raise _151_1523)))
...
let _69_3053 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1531 = (FStar_Syntax_Print.comp_to_string c1)
in (let _151_1530 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _151_1534 = (let _151_1533 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _151_1533 "sub_comp"))
in (FStar_All.pipe_left (fun _151_1532 -> FStar_TypeChecker_Common.CProb (_151_1532)) _151_1534))
in (let _151_1536 = (solve_and_commit env (singleton env prob) (fun _69_3057 -> None))
in (FStar_All.pipe_left (with_guard env prob) _151_1536))))))
...
let _69_3066 = (FStar_Unionfind.rollback tx)
in (
...
in (let _151_1554 = (let _151_1553 = (let _151_1552 = (let _151_1550 = (FStar_Syntax_Print.univ_to_string u1)
in (let _151_1549 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _151_1550 _151_1549 msg)))
in (let _151_1551 = (FStar_TypeChecker_Env.get_range env)
in (_151_1552, _151_1551)))
in FStar_Syntax_Syntax.Error (_151_1553))
in (Prims.raise _151_1554)))))
in (
...
let _69_3082 = hd
in (match (_69_3082) with
| (uv', lower_bounds) -> begin
if (FStar_Unionfind.equivalent uv uv') then begin
((uv', (u1)::lower_bounds))::tl
end else begin
(let _151_1561 = (insert uv u1 tl)
in (hd)::_151_1561)
end
end))
end))
...
(let _151_1566 = (insert uv u1 out)
in (group_by _151_1566 rest))
end)
end
| _69_3097 -> begin
None
...
let ad_hoc_fallback = (fun _69_3099 -> (match (()) with
| () -> begin
(match (ineqs) with
| [] -> begin
()
...
let wl = (
# 2145 "FStar.TypeChecker.Rel.fst"
let _69_3103 = (empty_worklist env)
in {attempting = _69_3103.attempting; wl_deferred = _69_3103.wl_deferred; ctr = _69_3103.ctr; defer_ok = true; smt_ok = _69_3103.smt_ok; tcenv = _69_3103.tcenv})
in (
# 2146 "FStar.TypeChecker.Rel.fst"
let _69_3143 = (FStar_All.pipe_right ineqs (FStar_List.iter (fun _69_3108 -> (match (_69_3108) with
| (u1, u2) -> begin
(
...
let _69_3135 = (FStar_Syntax_Util.univ_kernel u)
in (match (_69_3135) with
| (k_u, n) -> begin
(FStar_All.pipe_right us2 (FStar_Util.for_some (fun u' -> (
# 2165 "FStar.TypeChecker.Rel.fst"
let _69_3139 = (FStar_Syntax_Util.univ_kernel u')
in (match (_69_3139) with
| (k_u', n') -> begin
...
let wl = (
# 2176 "FStar.TypeChecker.Rel.fst"
let _69_3147 = (empty_worklist env)
in {attempting = _69_3147.attempting; wl_deferred = _69_3147.wl_deferred; ctr = _69_3147.ctr; defer_ok = false; smt_ok = _69_3147.smt_ok; tcenv = _69_3147.tcenv})
in (
...
let _69_3167 = (solve_universe_inequalities' tx env ineqs)
...
let fail = (fun _69_3174 -> (match (_69_3174) with
| (d, s) -> begin
(
...
let _69_3177 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _151_1587 = (wl_to_string wl)
in (let _151_1586 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
let _69_3181 = g
in {FStar_TypeChecker_Env.guard_f = _69_3181.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = []; FStar_TypeChecker_Env.univ_ineqs = _69_3181.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_3181.FStar_TypeChecker_Env.implicits})
end
| _69_3184 -> begin
...
let _69_3186 = (solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs)
in (
# 2205 "FStar.TypeChecker.Rel.fst"
let _69_3188 = g
in {FStar_TypeChecker_Env.guard_f = _69_3188.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _69_3188.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = _69_3188.FStar_TypeChecker_Env.implicits})))))))
...
let _69_3203 = if (not ((FStar_Options.should_verify env.FStar_TypeChecker_Env.curmodule.FStar_Ident.str))) then begin
()
end else begin
...
let _69_3201 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_1604 = (FStar_TypeChecker_Env.get_range env)
in (let _151_1603 = (let _151_1602 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _151_1602))
in (FStar_TypeChecker_Errors.diag _151_1604 _151_1603)))
end else begin
()
end
...
let _69_3205 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _69_3205.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_3205.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_3205.FStar_TypeChecker_Env.implicits}))))
...
let rec until_fixpoint = (fun _69_3218 implicits -> (match (_69_3218) with
| (out, changed) -> begin
...
let _69_3232 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _151_1620 = (FStar_Syntax_Print.uvar_to_string u)
in (let _151_1619 = (FStar_Syntax_Print.term_to_string tm)
in (let _151_1618 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _151_1620 _151_1619 _151_1618))))
end else begin
()
end
in (
# 2242 "FStar.TypeChecker.Rel.fst"
let _69_3239 = (env.FStar_TypeChecker_Env.type_of (
# 2242 "FStar.TypeChecker.Rel.fst"
let _69_3234 = env
in {FStar_TypeChecker_Env.solver = _69_3234.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _69_3234.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _69_3234.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _69_3234.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _69_3234.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _69_3234.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _69_3234.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _69_3234.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _69_3234.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _69_3234.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _69_3234.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _69_3234.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _69_3234.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _69_3234.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _69_3234.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _69_3234.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _69_3234.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _69_3234.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.default_effects = _69_3234.FStar_TypeChecker_Env.default_effects; FStar_TypeChecker_Env.type_of = _69_3234.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _69_3234.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true}) tm)
in (match (_69_3239) with
| (_69_3237, g) -> begin
(
...
let _69_3240 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _69_3240.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_3240.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _69_3240.FStar_TypeChecker_Env.implicits})
end else begin
g
end
in (
# 2246 "FStar.TypeChecker.Rel.fst"
let g' = (discharge_guard' (Some ((fun _69_3243 -> (match (()) with
| () -> begin
...
let _69_3245 = g
in (let _151_1624 = (until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _69_3245.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _69_3245.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _69_3245.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _151_1624})))))
...
let g = (let _151_1629 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _151_1629 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _151_1630 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _151_1630))
end
| (_69_3254, _69_3256, _69_3258, _69_3260, r)::_69_3252 -> begin
...
let _69_3266 = trivial_guard
in {FStar_TypeChecker_Env.guard_f = _69_3266.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _69_3266.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((u1, u2))::[]; FStar_TypeChecker_Env.implicits = _69_3266.FStar_TypeChecker_Env.implicits}))
