...
let term_to_string:
  'Auu____595 . 'Auu____595 -> FStar_Syntax_Syntax.term -> Prims.string =
  fun env  ->
    fun t  ->
      let uu____604 =
          ...
          let x =
            ...
            then "?"
              ...
              (let uu____726 = FStar_Unionfind.uvar_id u in
               FStar_All.pipe_right uu____726 FStar_Util.string_of_int) in
...
let args_to_string:
  'Auu____756 .
    (FStar_Syntax_Syntax.term,'Auu____756) FStar_Pervasives_Native.tuple2
      ...
      FStar_All.pipe_right args
        (FStar_List.map
           (fun uu____775  ->
              ...
              | (x,uu____779) -> FStar_Syntax_Print.term_to_string x)) in
...
let wl_of_guard:
  'Auu____808 .
    FStar_TypeChecker_Env.env ->
      ('Auu____808,FStar_TypeChecker_Common.prob)
...
let invert:
  'Auu____868 'Auu____869 .
    ('Auu____869,'Auu____868) FStar_TypeChecker_Common.problem ->
      ('Auu____869,'Auu____868) FStar_TypeChecker_Common.problem
  =
  fun p  ->
...
let maybe_invert:
  'Auu____886 'Auu____887 .
    ('Auu____887,'Auu____886) FStar_TypeChecker_Common.problem ->
      ('Auu____887,'Auu____886) FStar_TypeChecker_Common.problem
  =
  fun p  ->
      ...
      FStar_TypeChecker_Common.prob ->
        'Auu____1022 ->
          FStar_TypeChecker_Common.rel ->
            'Auu____1022 ->
              'Auu____1021 FStar_Pervasives_Native.option ->
                Prims.string ->
                  ('Auu____1022,'Auu____1021)
                    FStar_TypeChecker_Common.problem
  =
  fun scope  ->
    fun orig  ->
...
let new_problem:
  'Auu____1068 'Auu____1069 .
    FStar_TypeChecker_Env.env ->
      'Auu____1069 ->
        FStar_TypeChecker_Common.rel ->
          'Auu____1069 ->
            'Auu____1068 FStar_Pervasives_Native.option ->
              FStar_Range.range ->
                Prims.string ->
                  ('Auu____1069,'Auu____1068)
                    FStar_TypeChecker_Common.problem
  =
  fun env  ->
    fun lhs  ->
...
let problem_using_guard:
  'Auu____1115 'Auu____1116 .
    FStar_TypeChecker_Common.prob ->
      'Auu____1116 ->
        FStar_TypeChecker_Common.rel ->
          'Auu____1116 ->
            'Auu____1115 FStar_Pervasives_Native.option ->
              Prims.string ->
                ('Auu____1116,'Auu____1115) FStar_TypeChecker_Common.problem
  =
  fun orig  ->
    fun lhs  ->
      fun rel  ->
...
let guard_on_element:
  'Auu____1151 .
    worklist ->
      ('Auu____1151,(FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
                      FStar_Syntax_Syntax.syntax)
        FStar_TypeChecker_Common.problem ->
        FStar_Syntax_Syntax.bv ->
          FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ
    ...
    fun t  ->
      let uu____1306 =
        ...
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.WHNF] env uu____1307 in
...
let norm_arg:
  'Auu____1318 .
    FStar_TypeChecker_Env.env ->
      (FStar_Syntax_Syntax.term,'Auu____1318) FStar_Pervasives_Native.tuple2
        ->
        (FStar_Syntax_Syntax.term,'Auu____1318)
          FStar_Pervasives_Native.tuple2
  =
  fun env  ->
    fun t  ->
...
let normalize_refinement:
  'Auu____1386 .
    FStar_TypeChecker_Normalize.steps ->
      FStar_TypeChecker_Env.env ->
        'Auu____1386 -> FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ
  =
  fun steps  ->
    fun env  ->
      fun wl  ->
    ...
    FStar_TypeChecker_Env.env ->
      'Auu____1407 ->
        FStar_Syntax_Syntax.term ->
          ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
             FStar_Syntax_Syntax.syntax,(FStar_Syntax_Syntax.bv,(FStar_Syntax_Syntax.term',
                                                                  FStar_Syntax_Syntax.term')
                                                                  FStar_Syntax_Syntax.syntax)
                                          FStar_Pervasives_Native.tuple2
...
let force_refinement:
  'Auu____2068 .
    (FStar_Syntax_Syntax.term,(FStar_Syntax_Syntax.bv,FStar_Syntax_Syntax.term)
                                ...
                                FStar_Pervasives_Native.option)
      FStar_Pervasives_Native.tuple2 ->
      (FStar_Syntax_Syntax.term','Auu____2068) FStar_Syntax_Syntax.syntax
  =
  fun uu____2079  ->
      ...
      let uu____2137 =
        let uu____2139 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu____2149  ->
                  match uu____2149 with | (uu____2153,uu____2154,x) -> x)) in
          ...
          | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
              ...
              then
                ...
                (let uu____2238 = FStar_Syntax_Util.abs_formals t in
                 ...
                 | (ys',t1,uu____2259) ->
                     let uu____2272 = FStar_Syntax_Util.arrow_formals_comp k in
        ...
        fun wl  ->
          ...
          (let uu____2516 =
           ...
           then
             ...
             let uu____2518 =
               let uu____2519 = FStar_List.map (uvi_to_string wl.tcenv) uvis in
...
let occurs_check:
  'Auu____2595 'Auu____2596 .
    'Auu____2596 ->
      worklist ->
        (FStar_Syntax_Syntax.uvar,'Auu____2595)
          FStar_Pervasives_Native.tuple2 ->
          FStar_Syntax_Syntax.typ ->
            ...
            then FStar_Pervasives_Native.None
              ...
              (let uu____2626 =
                 ...
                 FStar_Util.format2 "occurs-check failed (%s occurs in %s)"
                   uu____2627 uu____2631 in
               FStar_Pervasives_Native.Some uu____2626) in
          (occurs_ok, msg)
let occurs_and_freevars_check:
  'Auu____2640 'Auu____2641 .
    'Auu____2641 ->
      worklist ->
        (FStar_Syntax_Syntax.uvar,'Auu____2640)
          FStar_Pervasives_Native.tuple2 ->
...
let intersect_vars:
  'Auu____2710 'Auu____2711 .
    (FStar_Syntax_Syntax.bv,'Auu____2711) FStar_Pervasives_Native.tuple2
      Prims.list ->
      (FStar_Syntax_Syntax.bv,'Auu____2710) FStar_Pervasives_Native.tuple2
        Prims.list ->
        (FStar_Syntax_Syntax.bv,'Auu____2710) FStar_Pervasives_Native.tuple2
          Prims.list
  =
...
let binders_eq:
  'Auu____2887 'Auu____2888 .
    (FStar_Syntax_Syntax.bv,'Auu____2888) FStar_Pervasives_Native.tuple2
      Prims.list ->
      (FStar_Syntax_Syntax.bv,'Auu____2887) FStar_Pervasives_Native.tuple2
...
let pat_var_opt:
  'Auu____2944 'Auu____2945 .
    FStar_TypeChecker_Env.env ->
      (FStar_Syntax_Syntax.bv,'Auu____2945) FStar_Pervasives_Native.tuple2
        Prims.list ->
        (FStar_Syntax_Syntax.term,'Auu____2944)
          FStar_Pervasives_Native.tuple2 ->
          (FStar_Syntax_Syntax.bv,'Auu____2944)
              ...
              FStar_All.pipe_right seen
                (FStar_Util.for_some
                   (fun uu____2984  ->
                      ...
                      | (b,uu____2988) -> FStar_Syntax_Syntax.bv_eq a b)) in
            if uu____2978
            then FStar_Pervasives_Native.None
            else
              FStar_Pervasives_Native.Some
...
let destruct_flex_t:
  'Auu____3104 .
    (FStar_Syntax_Syntax.term','Auu____3104) FStar_Syntax_Syntax.syntax ->
      ((FStar_Syntax_Syntax.term','Auu____3104) FStar_Syntax_Syntax.syntax,
        (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
          FStar_Syntax_Syntax.syntax FStar_Syntax_Syntax.uvar_basis
...
let destruct_flex_pattern:
  'Auu____3227 .
    FStar_TypeChecker_Env.env ->
      (FStar_Syntax_Syntax.term','Auu____3227) FStar_Syntax_Syntax.syntax ->
        (((FStar_Syntax_Syntax.term','Auu____3227) FStar_Syntax_Syntax.syntax,
           (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
             FStar_Syntax_Syntax.syntax FStar_Syntax_Syntax.uvar_basis
             FStar_Unionfind.uvar,(FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
    ...
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_refine (x,uu____3763),uu____3764) ->
            let uu____3769 = head_matches env x.FStar_Syntax_Syntax.sort t21 in
            FStar_All.pipe_right uu____3769 head_match
        | (uu____3770,FStar_Syntax_Syntax.Tm_refine (x,uu____3772)) ->
            let uu____3777 = head_matches env t11 x.FStar_Syntax_Syntax.sort in
      ...
      fun t1  ->
        fun t2  ->
          ...
          let rec aux retry n_delta t11 t21 =
            ...
            | MisMatch
                (FStar_Pervasives_Native.Some
                 (FStar_Syntax_Syntax.Delta_equational ),uu____4030)
                ->
                ...
                then fail r
                  ...
                  (let uu____4040 =
                     ...
                     let uu____4047 = maybe_inline t21 in
                     (uu____4045, uu____4047) in
            ...
            | MisMatch
                ...
                then fail r
                  ...
                  (let uu____4078 =
                     ...
                     let uu____4085 = maybe_inline t21 in
                     (uu____4083, uu____4085) in
                    ...
                    | (uu____5031,uu____5032,C
                       { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp c;
                        ...
                        let uu____5110 =
                          ...
                          FStar_All.pipe_right uu____5115 FStar_List.unzip in
                        (match uu____5110 with
                         | (tcs,sub_probs) ->
                             let gi_xs =
                               ...
                               FStar_All.pipe_left
                                 FStar_Syntax_Syntax.mk_Comp uu____5144 in
                             ((C gi_xs), sub_probs))
                    | uu____5160 ->
                             ...
                             | (sub_probs,tcs,f) ->
                                 let f1 =
                                   ...
                                   | FStar_Pervasives_Native.Some b ->
                                       ...
                                       FStar_Syntax_Util.mk_conj_l uu____5321 in
...
let compress_tprob:
  'Auu____5362 .
    worklist ->
      (FStar_Syntax_Syntax.term,'Auu____5362)
        FStar_TypeChecker_Common.problem ->
        (FStar_Syntax_Syntax.term,'Auu____5362)
          FStar_TypeChecker_Common.problem
  =
                          ...
                          (match uu____5535 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____5575 ->
                                    let rank =
                                      let uu____5582 = is_top_level_prob prob in
                                      if uu____5582
                                      then flex_refine
        ...
        fun u2  ->
                     ...
                     (fun u3  ->
                        ...
                        | (k,uu____5899) ->
                            (match k with
                             ...
                             | uu____5904 -> false)))
            | uu____5905 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u]) in
          let try_umax_components u12 u22 msg =
            ...
            | (FStar_Syntax_Syntax.U_max us1,FStar_Syntax_Syntax.U_max us2)
                ...
                then
                  ...
                  (let uu____5957 =
                     let uu____5958 = FStar_Syntax_Print.univ_to_string u12 in
                     let uu____5959 = FStar_Syntax_Print.univ_to_string u22 in
                     FStar_Util.format2
          ...
          | (FStar_Syntax_Syntax.U_unif v1,u) ->
              ...
              then
                ...
                (let uu____6047 = extend_solution pid_orig [UNIV (v1, u3)] wl in
                 USolved uu____6047)
          ...
          (match uu____6173 with
           | (bs2,mk_cod2) ->
               let curry n1 bs mk_cod =
                 ...
                 | (bs3,rest) ->
                     let uu____6234 = mk_cod rest in (bs3, uu____6234) in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____6488  ->
                          ...
                          | (c,uu____6493,uu____6494) -> c < probs.ctr)) in
        ...
        fun t2  ->
          fun wl  ->
            let rec aux wl1 us1 us2 =
              ...
              | ([],[]) -> USolved wl1
              | (u1::us11,u2::us21) ->
                  let uu____6595 = solve_universe_eq (p_pid orig) wl1 u1 u2 in
                    ...
                    | HeadMatch  ->
                        let uu____6747 =
                          ...
                          | FStar_Pervasives_Native.None  ->
                              ...
                              let uu____6761 = FStar_Syntax_Subst.compress t2 in
                              (uu____6760, uu____6761) in
             ...
             (match uu____7181 with
              | (ok,head_match1,partial_match,fallback,failed_match) ->
                  ...
                  let base_types_match t1 t2 =
                    ...
                    | (h1,args1) ->
                        let uu____7240 = FStar_Syntax_Util.head_and_args t2 in
                    ...
                    (match uu____7876 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi1 =
                           ...
                           FStar_Syntax_Util.mk_conj uu____7894 uu____7897 in
                         ((let uu____7903 =
                             FStar_All.pipe_left
      ...
      fun wl  ->
              ...
              (match (m, o) with
                            ...
                            | FStar_Pervasives_Native.None  ->
                                ...
                                let uu____8048 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t11
                                    uu____8049 t21 in
                                FStar_Syntax_Util.mk_forall u_x x uu____8048 in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
               ...
               | (uu____8062,FStar_Pervasives_Native.None ) ->
                   ((let uu____8069 =
                     ...
                     if uu____8069
                     then
                       let uu____8070 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____8071 = FStar_Syntax_Print.tag_of_term t1 in
                       let uu____8072 = FStar_Syntax_Print.term_to_string t2 in
                    ...
                    (let uu____8075 = FStar_Syntax_Util.head_and_args t1 in
                     ...
                     | (head11,args1) ->
                         let uu____8101 = FStar_Syntax_Util.head_and_args t2 in
                                ...
                                (let uu____8147 =
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____8150 =
                                      ...
                                      uu____8150 = FStar_Syntax_Util.Equal) in
                                 if uu____8147
                                 then
                                   let uu____8151 =
               ...
               | (sub_probs,gs_xs,formula) ->
                   ...
                   ((let uu____8441 =
                     ...
                     then
                       ...
                       let uu____8443 = FStar_Syntax_Print.comp_to_string c in
                       let uu____8444 = FStar_Syntax_Print.term_to_string im in
              ...
              (match uu____8555 with
               | (pi,uu____8558) ->
                   ...
                   (match uu____8563 with
                    | (xi,uu____8570) ->
                        let rec gs k =
                          let uu____8579 = FStar_Syntax_Util.arrow_formals k in
                                              ...
                                              let uu____8676 =
                                                let uu____8678 =
                                                  FStar_Syntax_Syntax.as_arg
                                                    gi_ps in
                                                uu____8678 :: gi_ps' in
                                              (uu____8673, uu____8676))) in
                              aux [] bs in
                        let uu____8681 =
                          let uu____8682 = matches pi in
                          FStar_All.pipe_left Prims.op_Negation uu____8682 in
                        if uu____8681
                        then FStar_Pervasives_Native.None
                        else
                          (let uu____8685 = gs xi.FStar_Syntax_Syntax.sort in
                           ...
                           | (g_xs,uu____8692) ->
                               ...
                               ((let uu____8777 =
                                 ...
                                 then
                                   ...
                                   let uu____8779 = prob_to_string env1 sub1 in
                                   FStar_Util.print2
                                     "Projecting %s\n\tsubprob=%s\n"
                                   ...
                                   let uu____8782 =
                                     let uu____8784 =
                                       FStar_All.pipe_left
                                         FStar_Pervasives_Native.fst
                                         (p_guard sub1) in
                                     FStar_Pervasives_Native.Some uu____8784 in
        ...
        let solve_t_flex_rigid patterns_only orig lhs t2 wl1 =
          ...
          | ((t1,uv,k_uv,args_lhs),maybe_pat_vars) ->
              let subterms ps =
                let uu____8836 = FStar_Syntax_Util.arrow_formals_comp k_uv in
                    ...
                    then
                      ...
                      (let k_uv1 =
                       ...
                       let rec elim k args =
                         let uu____8967 =
                           let uu____8971 =
                             let uu____8972 = FStar_Syntax_Subst.compress k in
                         ...
                         | uu____9454 ->
                             let uu____9458 =
                               ...
                               FStar_Util.format3
                                 ...
                                 uu____9459 uu____9463 uu____9464 in
                             failwith uu____9458 in
                         ...
                         (fun uu____9496  ->
                            ...
                            | (xs1,c1) ->
                                let uu____9524 =
                                  ...
                                  (((uv, k_uv1), xs1, c1), ps, uu____9547) in
                                FStar_Pervasives_Native.Some uu____9524)) in
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____9767 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____9768 in
                              ...
                              then
                                ...
                                ((let uu____9776 =
                                 ...
                                 (let sol =
                                    ...
                                    | [] -> t21
                                    | uu____9784 ->
                                        let uu____9785 = sn_binders env vars in
                                        u_abs k_uv uu____9785 t21 in
                                  let wl2 =
                                    solve_prob orig
                                      FStar_Pervasives_Native.None
                                ...
                                then
                                  ((let uu____9796 =
                                    ...
                                    then
                                      let uu____9797 =
                                        FStar_Syntax_Print.term_to_string t11 in
                                      let uu____9798 = names_to_string fvs1 in
                                      let uu____9799 = names_to_string fvs2 in
                                      FStar_Util.print3
                    ...
                    | (all_formals,uu____9905) ->
                        let rec aux pat_args pattern_vars pattern_var_set
                          ...
                          | ([],[]) ->
                              ...
                              let kk =
                                let uu____10012 = FStar_Syntax_Util.type_u () in
                                match uu____10012 with
                                | (t1,uu____10016) ->
                                    let uu____10017 =
                                      new_uvar t1.FStar_Syntax_Syntax.pos
                                        pattern_vars1 t1 in
                                    FStar_Pervasives_Native.fst uu____10017 in
                              let uu____10020 =
                          ...
                          | (formal::formals1,hd1::tl1) ->
                              let uu____10143 = pat_var_opt env pat_args hd1 in
                        ...
                        let uu____10204 = FStar_Syntax_Syntax.new_bv_set () in
                        aux [] [] uu____10204 all_formals args) in
                           ...
                           then
                             ...
                             (let uu____10517 =
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____10518 uu____10519 uu____10520 in
                              failwith uu____10517) in
                       let uu____10521 =
                         let uu____10527 =
                           let uu____10535 =
                             FStar_TypeChecker_Normalize.normalize
                         ...
                         | (bs,k1') ->
                             let uu____10553 =
                               ...
                               FStar_Syntax_Util.arrow_formals uu____10561 in
                                  ...
                                  (match uu____10587 with
                                   ...
                                   | uu____10613 ->
                                       ...
                                       (match uu____10616 with
                                        | (t,uu____10625) ->
                                            let uu____10626 = new_uvar r zs t in
                       ...
                       | (k_u',sub_probs) ->
                           let uu____10651 =
                             let uu____10659 =
                               ...
                               FStar_All.pipe_left
                                 FStar_Pervasives_Native.fst uu____10660 in
                             let uu____10665 =
                               let uu____10668 =
             ...
             let solve_one_pat uu____10776 uu____10777 =
               ...
               | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                   ((let uu____10881 =
                     ...
                     if uu____10881
                     then
                       let uu____10882 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____10883 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.print2
                    ...
                    (let uu____10885 = FStar_Unionfind.equivalent u1 u2 in
                     ...
                     then
                       ...
                       (let t21 = sn env t2 in
                        ...
                        let uu____10930 = occurs_check env wl (u1, k1) t21 in
                             ...
                             (let uu____11034 =
                              ...
                              | (sol,uu____11041) ->
                                  ...
                                  ((let uu____11044 =
                                    ...
                                    if uu____11044
                                    then
                                      let uu____11045 = uvi_to_string env sol in
                                      FStar_Util.print1
                  ...
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___130_11108 =
                     ...
                     | bs ->
                         ...
                         FStar_Syntax_Syntax.mk_Total uu____11122 in
                   let uu____11132 =
               ...
               | (FStar_Syntax_Syntax.Tm_abs uu____11422,uu____11423) ->
                   ...
                   (match uu____11489 with
                    ...
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs) ->
                        ...
                        if uu____11555
                        then
                          let uu____11556 = destruct_flex_pattern env not_abs in
                               ...
                               let guard =
                                 let uu____11830 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     FStar_Pervasives_Native.fst in
                                 FStar_Syntax_Util.mk_conj uu____11830 impl in
                               let wl1 =
                                 solve_prob orig
                   ...
                   then
                     ...
                     (if uu____12629
                      then
                        let guard =
                          let uu____12636 =
                            let uu____12637 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____12722
                      then
                        let guard =
                          let uu____12729 =
                            let uu____12730 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____12811
                      then
                        let guard =
                          let uu____12818 =
                            let uu____12819 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____12900
                      then
                        let guard =
                          let uu____12907 =
                            let uu____12908 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____12989
                      then
                        let guard =
                          let uu____12996 =
                            let uu____12997 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13087
                      then
                        let guard =
                          let uu____13094 =
                            let uu____13095 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13191
                      then
                        let guard =
                          let uu____13198 =
                            let uu____13199 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13284
                      then
                        let guard =
                          let uu____13291 =
                            let uu____13292 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13373
                      then
                        let guard =
                          let uu____13380 =
                            let uu____13381 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13462
                      then
                        let guard =
                          let uu____13469 =
                            let uu____13470 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13551
                      then
                        let guard =
                          let uu____13558 =
                            let uu____13559 = FStar_Syntax_Util.eq_tm t1 t2 in
                   ...
                   then
                     ...
                     (if uu____13649
                      then
                        let guard =
                          let uu____13656 =
                            let uu____13657 = FStar_Syntax_Util.eq_tm t1 t2 in
                               ...
                               then
                                 ((let uu____14109 =
                                  ...
                                  (let uu____14111 =
                                     let uu____14114 =
                                       ...
                                       FStar_Syntax_Syntax.Tm_app uu____14115 in
                                 ...
                                 (let uu____14145 =
                                    let uu____14148 =
                                      ...
                                      FStar_Syntax_Syntax.Tm_app uu____14149 in
        ...
        FStar_All.pipe_right (FStar_Pervasives_Native.snd ineqs)
          (FStar_List.map
             (fun uu____14481  ->
                ...
                | (u1,u2) ->
                    let uu____14486 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____14487 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____14486 uu____14487)) in
  ...
  'Auu____14544 .
    FStar_TypeChecker_Env.env ->
      FStar_Syntax_Syntax.term ->
        FStar_TypeChecker_Common.rel ->
          FStar_Syntax_Syntax.term ->
            'Auu____14544 FStar_Pervasives_Native.option ->
              FStar_Range.range ->
                (FStar_Syntax_Syntax.term,'Auu____14544)
                  FStar_TypeChecker_Common.problem
  =
  fun env  ->
    fun lhs  ->
          ...
          (let prob =
             let uu____14753 =
               ...
               new_t_problem env t1 FStar_TypeChecker_Common.EQ t2
                 FStar_Pervasives_Native.None uu____14756 in
             FStar_All.pipe_left
           ...
           let g =
             let uu____14761 =
               ...
               solve_and_commit env uu____14763
                 (fun uu____14764  -> FStar_Pervasives_Native.None) in
               ...
               let g =
                 let uu____14819 =
                   ...
                   solve_and_commit env uu____14821
                     (fun uu____14822  -> FStar_Pervasives_Native.None) in
         ...
         let prob =
           let uu____14876 =
             ...
             new_problem env c1 rel c2 FStar_Pervasives_Native.None
               uu____14879 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_92  -> FStar_TypeChecker_Common.CProb _0_92) uu____14876 in
         let uu____14882 =
           let uu____14884 = singleton env prob in
           solve_and_commit env uu____14884
             (fun uu____14885  -> FStar_Pervasives_Native.None) in
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____14929 =
                 let uu____14930 =
                   let uu____14933 =
                     let uu____14934 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____14935 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____14934 uu____14935 in
                   let uu____14936 = FStar_TypeChecker_Env.get_range env in
                   (uu____14933, uu____14936) in
                 FStar_Errors.Error uu____14930 in
               raise uu____14929) in
            let equiv v1 v' =
              let uu____14944 =
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____14970 = FStar_Syntax_Subst.compress_univ v1 in
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____15209 =
                   ...
                   then
                     ...
                     let uu____15211 =
                       let uu____15212 = FStar_Syntax_Print.term_to_string vc in
                   ...
                   | FStar_TypeChecker_Common.NonTrivial vc2 ->
                       ...
                       then FStar_Pervasives_Native.None
                         ...
                         ((let uu____15221 =
                          ...
                          (let vcs =
                             let uu____15230 = FStar_Options.use_tactics () in
                             if uu____15230
                             then
