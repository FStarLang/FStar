          ...
          let uu____22843 =
            let uu____22848 =
              ...
              FStar_Util.format2
               ...
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____22848)
             in
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____22919 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2
            in
             ...
             let g =
               let uu____22935 =
                 ...
                 solve_and_commit env uu____22938
                   (fun uu____22940  -> FStar_Pervasives_Native.None)
                  in
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        (let uu____23050 = new_t_prob env t1 FStar_TypeChecker_Common.SUB t2
            in
             ...
             let g =
               let uu____23060 =
                 ...
                 solve_and_commit env uu____23063
                   (fun uu____23065  -> FStar_Pervasives_Native.None)
                  in
