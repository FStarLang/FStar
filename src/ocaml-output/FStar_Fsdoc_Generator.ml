                     ...
                     (fun uu____180  ->
                        ...
                        | (id1,t,doco) ->
                            ...
                            let uu____191 =
                              ...
                              Prims.strcat id1.FStar_Ident.idText uu____192 in
                            Prims.strcat uu____190 uu____191)) in
                ...
                (FStar_List.map
                   (fun uu____235  ->
                      ...
                      | (id1,trmo,doco,u) ->
                          ...
                          Prims.strcat uu____250 uu____251)) in
              ...
              (FStar_List.map
                 (fun uu____324  ->
                    ...
                    | (t,d1) ->
                        ...
                        Prims.strcat uu____332 uu____333)) in
      ...
      (match topdecl.FStar_Parser_AST.doc with
       | Some (doc1,kw) ->
           let uu____558 =
             FStar_List.tryFind
               (fun uu____564  ->
                  match uu____564 with | (k,v1) -> k = "summary") kw in
...
let document_module: FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m  ->
    let uu____593 =
      ...
      | FStar_Parser_AST.Interface (n1,d,uu____609) -> (n1, d, "interface") in
