                     ...
                     (fun uu____436 ->
                        ...
                        | (id2, t, doco) ->
                            ...
                            let uu____494 =
                              ...
                              Prims.op_Hat id2.FStar_Ident.idText uu____496 in
                            Prims.op_Hat uu____492 uu____494)) in
                ...
                (FStar_List.map
                   (fun uu____623 ->
                      ...
                      | (id2, trmo, doco, u) ->
                          ...
                          Prims.op_Hat uu____691 uu____693)) in
          ...
          FStar_List.map
            (fun uu____766 ->
               ...
               | (p, t) ->
                   ...
                   (uu____779, uu____781)) pats in
        let termty' =
          FStar_List.map
            (fun uu____799 ->
               match uu____799 with
               | (p, t) -> Prims.op_Hat p (Prims.op_Hat ":" t)) termty in
              ...
              (FStar_List.map
                 (fun uu____914 ->
                    ...
                    | (t, d1) ->
                        ...
                        Prims.op_Hat uu____967 uu____969)) in
          ...
          (match topdecl.FStar_Parser_AST.doc with
           | FStar_Pervasives_Native.Some (doc1, kw) ->
               let uu____1440 =
                 FStar_List.tryFind
                   (fun uu____1458 ->
                      match uu____1458 with | (k, v1) -> k = "summary") kw in
...
let (document_module : FStar_Parser_AST.modul -> FStar_Ident.lident) =
  fun m ->
    let uu____1545 =
      ...
      | FStar_Parser_AST.Interface (n1, d, uu____1576) ->
          (n1, d, "interface") in
         ...
         | FStar_Pervasives_Native.Some (top_decl, other_decls) ->
             let on1 =
               FStar_Options.prepend_output_dir
                 (Prims.op_Hat name.FStar_Ident.str ".md") in
    ...
    let modules =
      FStar_List.map
        (fun fn ->
           ...
           FStar_Pervasives_Native.fst uu____1728) files in
