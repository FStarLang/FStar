                     ...
                     (fun uu____207  ->
                        ...
                        | (id1,t,doco) ->
                            ...
                            let uu____233 =
                              ...
                              Prims.strcat id1.FStar_Ident.idText uu____234 in
                            Prims.strcat uu____232 uu____233)) in
                ...
                (FStar_List.map
                   (fun uu____282  ->
                      ...
                      | (id1,trmo,doco,u) ->
                          ...
                          Prims.strcat uu____312 uu____313)) in
              ...
              (FStar_List.map
                 (fun uu____391  ->
                    ...
                    | (t,d1) ->
                        ...
                        Prims.strcat uu____414 uu____415)) in
      ...
      (match topdecl.FStar_Parser_AST.doc with
       | Some (doc1,kw) ->
           ...
           (match uu____655 with
            | None  -> (None, (Some doc1))
            | Some (uu____674,summary) -> ((Some summary), (Some doc1)))
       | None  -> (None, None))
...
let document_module: FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m  ->
    let uu____690 =
      ...
      | FStar_Parser_AST.Interface (n1,d,uu____706) -> (n1, d, "interface") in
...
let generate: Prims.string Prims.list -> Prims.unit =
  fun files  ->
    let modules =
      FStar_List.collect
        (fun fn  ->
           let uu____770 = FStar_Parser_Driver.parse_file fn in fst uu____770)
        files in
