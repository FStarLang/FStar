                     ...
                     (fun uu____205  ->
                        ...
                        | (id,t,doco) ->
                            ...
                            let uu____231 =
                              ...
                              Prims.strcat id.FStar_Ident.idText uu____232
                               in
      ...
      (match topdecl.FStar_Parser_AST.doc with
       | Some (doc,kw) ->
           let uu____638 =
             FStar_List.tryFind
               (fun uu____644  ->
                  match uu____644 with | (k,v) -> k = "summary") kw
              in
           (match uu____638 with
            | None  -> (None, (Some doc))
            | Some (uu____657,summary) -> ((Some summary), (Some doc)))
       | None  -> (None, None))
...
let document_module : FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m  ->
    let uu____673 =
      ...
      | FStar_Parser_AST.Interface (n,d,uu____689) -> (n, d, "interface")  in
