                     ...
                     (fun uu____354 ->
                        ...
                        | (id2, t, doco) ->
                            ...
                            let uu____401 =
                              ...
                              Prims.strcat id2.FStar_Ident.idText uu____402 in
                            Prims.strcat uu____400 uu____401)) in
                ...
                (FStar_List.map
                   (fun uu____496 ->
                      ...
                      | (id2, trmo, doco, u) ->
                          ...
                          Prims.strcat uu____551 uu____552)) in
    ...
    let tycon_documented tt =
      let tyconvars_documented tycon =
        ...
        | FStar_Parser_AST.TyconRecord
            (uu____848, uu____849, uu____850, fields) ->
            FStar_List.existsb
              (fun uu____892 ->
                 match uu____892 with
                 | (_id, _t, doco) -> FStar_Util.is_some doco) fields
        | FStar_Parser_AST.TyconVariant
            (uu____908, uu____909, uu____910, vars) ->
            FStar_List.existsb
              (fun uu____965 ->
          ...
          (match topdecl.FStar_Parser_AST.doc with
           | FStar_Pervasives_Native.Some (doc1, kw) ->
               let uu____1149 =
                 FStar_List.tryFind
                   (fun uu____1163 ->
                      match uu____1163 with | (k, v1) -> k = "summary") kw in
...
let (document_module : FStar_Parser_AST.modul -> FStar_Ident.lid) =
  fun m ->
    let uu____1214 =
      ...
      | FStar_Parser_AST.Interface (n1, d, uu____1241) ->
          (n1, d, "interface") in
    ...
    let modules =
      FStar_List.map
        (fun fn ->
           ...
           FStar_Pervasives_Native.fst uu____1343) files in
