    ...
    let tycon_documented tt =
      let tyconvars_documented tycon =
        ...
        | FStar_Parser_AST.TyconRecord
            (uu____811, uu____812, uu____813, fields) ->
            FStar_List.existsb
              (fun uu____855 ->
                 match uu____855 with
                 | (_id, _t, doco) -> FStar_Util.is_some doco) fields
        | FStar_Parser_AST.TyconVariant
            (uu____871, uu____872, uu____873, vars) ->
            FStar_List.existsb
              (fun uu____928 ->
          ...
          (match topdecl.FStar_Parser_AST.doc with
           | FStar_Pervasives_Native.Some (doc1, kw) ->
               let uu____1103 =
                 FStar_List.tryFind
                   (fun uu____1117 ->
                      match uu____1117 with | (k, v1) -> k = "summary") kw in
...
let (document_module : FStar_Parser_AST.modul -> FStar_Ident.lid) =
  fun m ->
    let uu____1166 =
      ...
      | FStar_Parser_AST.Interface (n1, d, uu____1193) ->
          (n1, d, "interface") in
    ...
    let modules =
      FStar_List.map
        (fun fn ->
           ...
           FStar_Pervasives_Native.fst uu____1291) files in
