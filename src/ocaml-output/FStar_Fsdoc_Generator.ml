  ...
  fun decls ->
    let uu____16 =
      FStar_List.partition
        ...
        decls
    in
    match uu____16 with top, nontops ->
      match top with
...
let uu___is_Leaf : mforest -> Prims.bool =
  fun projectee -> match projectee with Leaf _0 -> true | uu____96 -> false
...
let string_of_optiont:
      'Auu____143 'Auu____144. ('Auu____144 -> 'Auu____143) -> 'Auu____143
    ...
    string_of_optiont
      (fun x ->
        let uu____217 =
          ...
          Prims.strcat uu____218 "*)"
        in
        Prims.strcat "(*" uu____217 )
      "" d
    ...
    | FStar_Parser_AST.TyconRecord (id1, _bb, _ko, fields) ->
        let uu____288 =
          let uu____289 =
            let uu____290 =
              let uu____291 =
                FStar_All.pipe_right fields
                  (FStar_List.map (fun uu____330 ->
                       match uu____330 with id2, t, doco ->
                         let uu____376 = string_of_fsdoco doco in
                         let uu____377 =
                           let uu____378 =
                             let uu____379 =
                               FStar_Parser_AST.term_to_string t
                             in
                             Prims.strcat ":" uu____379
                           in
            ...
            in
            Prims.strcat uu____290 " }"
          in
          Prims.strcat " = { " uu____289
        in
          ...
          let uu____423 =
            let uu____424 =
              FStar_All.pipe_right vars
                (FStar_List.map (fun uu____472 ->
                     match uu____472 with id2, trmo, doco, u ->
                       let uu____527 = string_of_fsdoco doco in
                       let uu____528 =
                         let uu____529 =
                           let uu____530 =
                             string_of_optiont FStar_Parser_AST.term_to_string
                               "" trmo
                           in
                           Prims.strcat ":" uu____530
                         in
                         Prims.strcat id2.FStar_Ident.idText uu____529
                       in
                       Prims.strcat uu____527 uu____528 ))
            in
            FStar_All.pipe_right uu____424 (FStar_String.concat " | ")
          in
          Prims.strcat " = " uu____423
        in
  ...
  fun d ->
    ...
    | FStar_Parser_AST.TopLevelLet (uu____541, pats) ->
        ...
        let termty' =
          FStar_List.map
            (fun uu____598 ->
              match uu____598 with p, t -> Prims.strcat p (Prims.strcat ":" t)
              )
            termty
        in
    ...
    | FStar_Parser_AST.Assume (i, t) ->
        let uu____608 =
          let uu____609 =
            ...
            Prims.strcat ":" uu____610
          in
          Prims.strcat i.FStar_Ident.idText uu____609
        in
        ...
        let uu____629 =
          let uu____630 =
            FStar_All.pipe_right tys
              (FStar_List.map (fun uu____664 ->
                   match uu____664 with t, d1 ->
                     let uu____707 = string_of_tycon t in
                     let uu____708 =
                       let uu____709 = string_of_fsdoco d1 in
                       Prims.strcat " " uu____709
                     in
                     Prims.strcat uu____707 uu____708 ))
          in
          FStar_All.pipe_right uu____630 (FStar_String.concat " and ")
        in
    ...
    | FStar_Parser_AST.Val (i, t) ->
        let uu____714 =
          ...
          in
          Prims.strcat i.FStar_Ident.idText uu____715
        in
        Prims.strcat "val " uu____714
    | FStar_Parser_AST.Exception (i, uu____718) ->
        Prims.strcat "exception " i.FStar_Ident.idText
    | FStar_Parser_AST.NewEffect
        FStar_Parser_AST.DefineEffect (i, uu____724, uu____725, uu____726) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    | FStar_Parser_AST.NewEffect
        FStar_Parser_AST.RedefineEffect (i, uu____736, uu____737) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    ...
    let tycon_documented tt =
      let tyconvars_documented tycon =
        ...
        | FStar_Parser_AST.TyconRecord (uu____809, uu____810, uu____811, fields) ->
            FStar_List.existsb
              (fun uu____853 ->
                match uu____853 with _id, _t, doco -> FStar_Util.is_some doco
                )
              fields
        | FStar_Parser_AST.TyconVariant (uu____869, uu____870, uu____871, vars) ->
            FStar_List.existsb
              (fun uu____926 ->
                match uu____926 with _id, _t, doco, _u ->
                  FStar_Util.is_some doco )
              vars
      in
      FStar_List.existsb
        (fun uu____960 ->
          match uu____960 with tycon, doco ->
  ...
  fun w d ->
    if decl_documented d then
      ...
      | { FStar_Parser_AST.d= decl
        ; FStar_Parser_AST.drange= uu____1010
...
let document_toplevel:
      'Auu____1051. 'Auu____1051 -> FStar_Parser_AST.decl
  ...
  fun name topdecl ->
    ...
    | FStar_Parser_AST.TopLevelModule uu____1068 -> (
      ...
      | FStar_Pervasives_Native.Some (doc1, kw) -> (
          let uu____1101 =
            FStar_List.tryFind
              (fun uu____1115 -> match uu____1115 with k, v1 -> k = "summary")
              kw
          in
...
let document_module : FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m ->
    ...
    in
    match uu____1164 with name, decls, _mt ->
      ...
      | FStar_Pervasives_Native.Some (top_decl, other_decls) -> (
          ...
          match uu____1233 with summary, comment ->
            let summary1 =
              match summary with
              | FStar_Pervasives_Native.Some s -> s
              | FStar_Pervasives_Native.None -> no_summary
            in
            let comment1 =
              match comment with
              | FStar_Pervasives_Native.Some s -> s
              | FStar_Pervasives_Native.None -> no_comment
            in
            (let uu____1257 =
      ...
      | FStar_Pervasives_Native.None ->
          let uu____1270 =
            ...
            in
            (FStar_Errors.Fatal_NonSingletonTopLevel, uu____1275)
          in
  ...
  fun files ->
    let modules =
      FStar_List.map
        (fun fn ->
          ...
          FStar_Pervasives_Native.fst uu____1289 )
        files
    in
    ...
    FStar_List.iter
      (fun m ->
        ...
        FStar_Util.append_to_file fd uu____1315 )
      mods ;
    FStar_Util.close_file fd
