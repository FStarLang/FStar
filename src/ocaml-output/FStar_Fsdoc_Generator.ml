                     ...
                     (fun uu____231  ->
                        ...
                        | (id1,t,doco) ->
                            ...
                            let uu____257 =
                              ...
                              Prims.strcat id1.FStar_Ident.idText uu____258 in
                            Prims.strcat uu____256 uu____257)) in
                ...
                (FStar_List.map
                   (fun uu____313  ->
                      ...
                      | (id1,trmo,doco,u) ->
                          ...
                          Prims.strcat uu____343 uu____344)) in
              ...
              (FStar_List.map
                 (fun uu____436  ->
                    ...
                    | (t,d1) ->
                        ...
                        Prims.strcat uu____459 uu____460)) in
      ...
      (match topdecl.FStar_Parser_AST.doc with
       | FStar_Pervasives_Native.Some (doc1,kw) ->
           let uu____718 =
             FStar_List.tryFind
               (fun uu____727  ->
                  match uu____727 with | (k,v1) -> k = "summary") kw in
...
let document_module: FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m  ->
    let uu____757 =
      ...
      | FStar_Parser_AST.Interface (n1,d,uu____773) -> (n1, d, "interface") in
    ...
    let modules =
      FStar_List.collect
        (fun fn  ->
           ...
           FStar_Pervasives_Native.fst uu____840) files in
