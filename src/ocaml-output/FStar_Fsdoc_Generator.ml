    ...
    let tycon_documented tt =
      let tyconvars_documented tycon =
        ...
        | FStar_Parser_AST.TyconRecord
            (uu____816, uu____817, uu____818, fields) ->
            FStar_List.existsb
              (fun uu____860 ->
                 match uu____860 with
                 | (_id, _t, doco) -> FStar_Util.is_some doco) fields
        | FStar_Parser_AST.TyconVariant
            (uu____876, uu____877, uu____878, vars) ->
            FStar_List.existsb
              (fun uu____933 ->
          ...
          (match topdecl.FStar_Parser_AST.doc with
           | FStar_Pervasives_Native.Some (doc1, kw) ->
               let uu____1108 =
                 FStar_List.tryFind
                   (fun uu____1122 ->
                      match uu____1122 with | (k, v1) -> k = "summary") kw in
...
let (document_module : FStar_Parser_AST.modul -> FStar_Ident.lid) =
  fun m ->
    let uu____1171 =
      ...
      | FStar_Parser_AST.Interface (n1, d, uu____1198) ->
          (n1, d, "interface") in
    ...
    let modules =
      FStar_List.map
        (fun fn ->
           ...
           FStar_Pervasives_Native.fst uu____1296) files in
