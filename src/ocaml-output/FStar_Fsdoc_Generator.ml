                     ...
                     (fun uu____221  ->
                        ...
                        | (id1,t,doco) ->
                            ...
                            let uu____247 =
                              ...
                              Prims.strcat id1.FStar_Ident.idText uu____248 in
                            Prims.strcat uu____246 uu____247)) in
                ...
                (FStar_List.map
                   (fun uu____296  ->
                      ...
                      | (id1,trmo,doco,u) ->
                          ...
                          Prims.strcat uu____326 uu____327)) in
              ...
              (FStar_List.map
                 (fun uu____406  ->
                    ...
                    | (t,d1) ->
                        ...
                        Prims.strcat uu____429 uu____430)) in
      ...
      (match topdecl.FStar_Parser_AST.doc with
       | Some (doc1,kw) ->
           let uu____676 =
             FStar_List.tryFind
               (fun uu____682  ->
                  match uu____682 with | (k,v1) -> k = "summary") kw in
...
let document_module: FStar_Parser_AST.modul -> FStar_Ident.lid =
  fun m  ->
    let uu____712 =
      ...
      | FStar_Parser_AST.Interface (n1,d,uu____728) -> (n1, d, "interface") in
...
let generate: Prims.string Prims.list -> Prims.unit =
  fun files  ->
    let modules =
      FStar_List.collect
        (fun fn  ->
           let uu____793 = FStar_Parser_Driver.parse_file fn in fst uu____793)
        files in
