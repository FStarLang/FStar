              ...
              (FStar_List.map
                 (fun uu____724  ->
                    ...
                    | (t,d1) ->
                        ...
                        Prims.strcat uu____767 uu____768))
             in
  ...
  fun d  ->
    let tycon_documented tt =
      let tyconvars_documented tycon =
        ...
        | FStar_Parser_AST.TyconRecord (uu____882,uu____883,uu____884,fields)
            ->
            FStar_List.existsb
              (fun uu____926  ->
                 match uu____926 with
                 | (_id,_t,doco) -> FStar_Util.is_some doco) fields
        | FStar_Parser_AST.TyconVariant (uu____942,uu____943,uu____944,vars)
            ->
            FStar_List.existsb
              (fun uu____999  ->
          ...
          (match topdecl.FStar_Parser_AST.doc with
           | FStar_Pervasives_Native.Some (doc1,kw) ->
               let uu____1164 =
                 FStar_List.tryFind
                   (fun uu____1178  ->
                      match uu____1178 with | (k,v1) -> k = "summary") kw
                  in
...
let (document_module : FStar_Parser_AST.modul -> FStar_Ident.lident) =
  fun m  ->
    let uu____1229 =
      ...
      | FStar_Parser_AST.Interface (n1,d,uu____1256) -> (n1, d, "interface")
       in
