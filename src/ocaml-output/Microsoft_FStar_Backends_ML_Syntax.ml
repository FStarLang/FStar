...
| (p, s) -> begin
(let s = (match (((let _136_5 = (Support.String.get s 0)
in (Support.Char.lowercase _136_5)) <> (Support.String.get s 0))) with
| true -> begin
...
| (p, s) -> begin
(let s = (match (((let _136_8 = (Support.String.get s 0)
in (Support.Char.uppercase _136_8)) <> (Support.String.get s 0))) with
| true -> begin
...
let mlpath_of_lident = (fun ( x ) -> (let _136_12 = (Support.List.map (fun ( x ) -> x.Microsoft_FStar_Absyn_Syntax.idText) x.Microsoft_FStar_Absyn_Syntax.ns)
in (_136_12, x.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText)))
