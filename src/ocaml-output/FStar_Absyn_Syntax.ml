...
let nsstr = (let _106_1272 = (FStar_List.map text_of_id ns)
in (FStar_All.pipe_right _106_1272 text_of_path))
...
let no_fvs : freevars = (let _106_1321 = (new_ftv_set ())
in (let _106_1320 = (new_ftv_set ())
in {ftvs = _106_1321; fxvs = _106_1320}))

# 429 "FStar.Absyn.Syntax.fst"
let no_uvs : uvars = (let _106_1324 = (new_uv_set ())
in (let _106_1323 = (new_uvt_set ())
in (let _106_1322 = (new_uvt_set ())
in {uvars_k = _106_1324; uvars_t = _106_1323; uvars_e = _106_1322})))
...
let _24_424 = out
in (let _106_1329 = (FStar_Util.set_add btv out.ftvs)
in {ftvs = _106_1329; fxvs = _24_424.fxvs}))
end
| FStar_Util.Inr (bxv) -> begin
(
# 439 "FStar.Absyn.Syntax.fst"
let _24_428 = out
in (let _106_1330 = (FStar_Util.set_add bxv out.fxvs)
in {ftvs = _24_428.ftvs; fxvs = _106_1330}))
end)) no_fvs)))

# 440 "FStar.Absyn.Syntax.fst"
let list_of_freevars : freevars  ->  (btvar, bvvar) FStar_Util.either Prims.list = (fun fvs -> (let _106_1338 = (let _106_1334 = (FStar_Util.set_elements fvs.ftvs)
in (FStar_All.pipe_right _106_1334 (FStar_List.map (fun x -> FStar_Util.Inl (x)))))
in (let _106_1337 = (let _106_1336 = (FStar_Util.set_elements fvs.fxvs)
in (FStar_All.pipe_right _106_1336 (FStar_List.map (fun x -> FStar_Util.Inr (x)))))
in (FStar_List.append _106_1338 _106_1337))))
...
let mk_Kind_type : (knd', Prims.unit) syntax = (let _106_1343 = (get_unit_ref ())
in (let _106_1342 = (mk_fvs ())
in (let _106_1341 = (mk_uvs ())
in {n = Kind_type; tk = _106_1343; pos = dummyRange; fvs = _106_1342; uvs = _106_1341})))

# 447 "FStar.Absyn.Syntax.fst"
let mk_Kind_effect : (knd', Prims.unit) syntax = (let _106_1346 = (get_unit_ref ())
in (let _106_1345 = (mk_fvs ())
in (let _106_1344 = (mk_uvs ())
in {n = Kind_effect; tk = _106_1346; pos = dummyRange; fvs = _106_1345; uvs = _106_1344})))

# 448 "FStar.Absyn.Syntax.fst"
let mk_Kind_abbrev : (kabbrev * knd)  ->  FStar_Range.range  ->  knd = (fun _24_439 p -> (match (_24_439) with
| (kabr, k) -> begin
(let _106_1353 = (get_unit_ref ())
in (let _106_1352 = (mk_fvs ())
in (let _106_1351 = (mk_uvs ())
in {n = Kind_abbrev ((kabr, k)); tk = _106_1353; pos = p; fvs = _106_1352; uvs = _106_1351})))
end))

# 454 "FStar.Absyn.Syntax.fst"
let mk_Kind_arrow : (binders * knd)  ->  FStar_Range.range  ->  knd = (fun _24_443 p -> (match (_24_443) with
| (bs, k) -> begin
(let _106_1360 = (get_unit_ref ())
in (let _106_1359 = (mk_fvs ())
in (let _106_1358 = (mk_uvs ())
in {n = Kind_arrow ((bs, k)); tk = _106_1360; pos = p; fvs = _106_1359; uvs = _106_1358})))
end))
...
let mk_Kind_uvar : uvar_k_app  ->  FStar_Range.range  ->  knd = (fun uv p -> (let _106_1371 = (get_unit_ref ())
in (let _106_1370 = (mk_fvs ())
in (let _106_1369 = (mk_uvs ())
in {n = Kind_uvar (uv); tk = _106_1371; pos = p; fvs = _106_1370; uvs = _106_1369}))))

# 474 "FStar.Absyn.Syntax.fst"
let mk_Kind_lam : (binders * knd)  ->  FStar_Range.range  ->  knd = (fun _24_462 p -> (match (_24_462) with
| (vs, k) -> begin
(let _106_1378 = (get_unit_ref ())
in (let _106_1377 = (mk_fvs ())
in (let _106_1376 = (mk_uvs ())
in {n = Kind_lam ((vs, k)); tk = _106_1378; pos = p; fvs = _106_1377; uvs = _106_1376})))
end))
...
| (k, s, m) -> begin
(let _106_1385 = (get_unit_ref ())
in (let _106_1384 = (mk_fvs ())
in (let _106_1383 = (mk_uvs ())
in {n = Kind_delayed ((k, s, m)); tk = _106_1385; pos = p; fvs = _106_1384; uvs = _106_1383})))
end))

# 487 "FStar.Absyn.Syntax.fst"
let mk_Kind_unknown : (knd', Prims.unit) syntax = (let _106_1388 = (get_unit_ref ())
in (let _106_1387 = (mk_fvs ())
in (let _106_1386 = (mk_uvs ())
in {n = Kind_unknown; tk = _106_1388; pos = dummyRange; fvs = _106_1387; uvs = _106_1386})))
...
let mk_Typ_btvar : btvar  ->  knd Prims.option  ->  FStar_Range.range  ->  typ = (fun x k p -> (let _106_1401 = (get_knd_ref k)
in (let _106_1400 = (mk_fvs ())
in (let _106_1399 = (mk_uvs ())
in {n = Typ_btvar (x); tk = _106_1401; pos = p; fvs = _106_1400; uvs = _106_1399}))))

# 494 "FStar.Absyn.Syntax.fst"
let mk_Typ_const : ftvar  ->  knd Prims.option  ->  FStar_Range.range  ->  typ = (fun x k p -> (let _106_1408 = (get_knd_ref k)
in {n = Typ_const (x); tk = _106_1408; pos = p; fvs = memo_no_fvs; uvs = memo_no_uvs}))
...
| (bs, c) -> begin
(let _106_1421 = (check_fun bs c p)
in (let _106_1420 = (FStar_Util.mk_ref k)
in (let _106_1419 = (mk_fvs ())
in (let _106_1418 = (mk_uvs ())
in {n = _106_1421; tk = _106_1420; pos = p; fvs = _106_1419; uvs = _106_1418}))))
end))
...
| (x, phi) -> begin
(let _106_1430 = (FStar_Util.mk_ref k)
in (let _106_1429 = (mk_fvs ())
in (let _106_1428 = (mk_uvs ())
in {n = Typ_refine ((x, phi)); tk = _106_1430; pos = p; fvs = _106_1429; uvs = _106_1428})))
end))
...
| _24_506 -> begin
(let _106_1439 = (FStar_Util.mk_ref k)
in (let _106_1438 = (mk_fvs ())
in (let _106_1437 = (mk_uvs ())
in {n = Typ_app ((t1, args)); tk = _106_1439; pos = p; fvs = _106_1438; uvs = _106_1437})))
end)
end))
...
| _24_533 -> begin
(let _106_1460 = (FStar_Util.mk_ref k)
in (let _106_1459 = (mk_fvs ())
in (let _106_1458 = (mk_uvs ())
in {n = Typ_lam ((b, t)); tk = _106_1460; pos = p; fvs = _106_1459; uvs = _106_1458})))
end)
end))
...
| (t, k) -> begin
(let _106_1475 = (FStar_Util.mk_ref k')
in (let _106_1474 = (mk_fvs ())
in (let _106_1473 = (mk_uvs ())
in {n = Typ_ascribed ((t, k)); tk = _106_1475; pos = p; fvs = _106_1474; uvs = _106_1473})))
end))
...
let mk_Typ_meta' : meta_t  ->  knd Prims.option  ->  FStar_Range.range  ->  typ = (fun m k p -> (let _106_1488 = (FStar_Util.mk_ref k)
in (let _106_1487 = (mk_fvs ())
in (let _106_1486 = (mk_uvs ())
in {n = Typ_meta (m); tk = _106_1488; pos = p; fvs = _106_1487; uvs = _106_1486}))))
...
(let _106_1491 = (FStar_ST.read t.tk)
in (mk_Typ_meta' m _106_1491 t.pos))
end))
...
| (u, k) -> begin
(let _106_1500 = (get_knd_ref k')
in (let _106_1499 = (mk_fvs ())
in (let _106_1498 = (mk_uvs ())
in {n = Typ_uvar ((u, k)); tk = _106_1500; pos = p; fvs = _106_1499; uvs = _106_1498})))
end))
...
in (let _106_1519 = (FStar_Util.mk_ref k)
in (let _106_1518 = (mk_fvs ())
in (let _106_1517 = (mk_uvs ())
in {n = _106_1520; tk = _106_1519; pos = p; fvs = _106_1518; uvs = _106_1517}))))
end))

# 577 "FStar.Absyn.Syntax.fst"
let mk_Typ_delayed' : ((typ * subst_t), Prims.unit  ->  typ) FStar_Util.either  ->  knd Prims.option  ->  FStar_Range.range  ->  typ = (fun st k p -> (let _106_1542 = (let _106_1538 = (let _106_1537 = (FStar_Util.mk_ref None)
in (st, _106_1537))
in Typ_delayed (_106_1538))
in (let _106_1541 = (FStar_Util.mk_ref k)
in (let _106_1540 = (mk_fvs ())
in (let _106_1539 = (mk_uvs ())
in {n = _106_1542; tk = _106_1541; pos = p; fvs = _106_1540; uvs = _106_1539})))))

# 584 "FStar.Absyn.Syntax.fst"
let mk_Typ_unknown : (typ', (knd', Prims.unit) syntax) syntax = (let _106_1545 = (get_knd_nref ())
in (let _106_1544 = (mk_fvs ())
in (let _106_1543 = (mk_uvs ())
in {n = Typ_unknown; tk = _106_1545; pos = dummyRange; fvs = _106_1544; uvs = _106_1543})))
...
let mk_Total : typ  ->  comp = (fun t -> (let _106_1554 = (FStar_Util.mk_ref None)
in (let _106_1553 = (mk_fvs ())
in (let _106_1552 = (mk_uvs ())
in {n = Total (t); tk = _106_1554; pos = t.pos; fvs = _106_1553; uvs = _106_1552}))))

# 594 "FStar.Absyn.Syntax.fst"
let mk_Comp : comp_typ  ->  comp = (fun ct -> (let _106_1559 = (FStar_Util.mk_ref None)
in (let _106_1558 = (mk_fvs ())
in (let _106_1557 = (mk_uvs ())
in {n = Comp (ct); tk = _106_1559; pos = ct.result_typ.pos; fvs = _106_1558; uvs = _106_1557}))))

# 600 "FStar.Absyn.Syntax.fst"
let mk_Exp_bvar : bvvar  ->  typ Prims.option  ->  FStar_Range.range  ->  exp = (fun x t p -> (let _106_1568 = (get_typ_ref t)
in (let _106_1567 = (mk_fvs ())
in (let _106_1566 = (mk_uvs ())
in {n = Exp_bvar (x); tk = _106_1568; pos = p; fvs = _106_1567; uvs = _106_1566}))))
...
| (x, b) -> begin
(let _106_1577 = (get_typ_ref t)
in (let _106_1576 = (mk_fvs ())
in (let _106_1575 = (mk_uvs ())
in {n = Exp_fvar ((x, b)); tk = _106_1577; pos = p; fvs = _106_1576; uvs = _106_1575})))
end))

# 612 "FStar.Absyn.Syntax.fst"
let mk_Exp_constant : sconst  ->  typ Prims.option  ->  FStar_Range.range  ->  exp = (fun s t p -> (let _106_1586 = (get_typ_ref t)
in (let _106_1585 = (mk_fvs ())
in (let _106_1584 = (mk_uvs ())
in {n = Exp_constant (s); tk = _106_1586; pos = p; fvs = _106_1585; uvs = _106_1584}))))
...
| _24_632 -> begin
(let _106_1595 = (get_typ_ref t')
in (let _106_1594 = (mk_fvs ())
in (let _106_1593 = (mk_uvs ())
in {n = Exp_abs ((b, e)); tk = _106_1595; pos = p; fvs = _106_1594; uvs = _106_1593})))
end)
end))
...
| (b, e) -> begin
(let _106_1605 = (match ((b, e.n)) with
...
in (let _106_1604 = (get_typ_ref t')
in (let _106_1603 = (mk_fvs ())
in (let _106_1602 = (mk_uvs ())
in {n = _106_1605; tk = _106_1604; pos = p; fvs = _106_1603; uvs = _106_1602}))))
end))
...
| _24_660 -> begin
(let _106_1614 = (get_typ_ref t)
in (let _106_1613 = (mk_fvs ())
in (let _106_1612 = (mk_uvs ())
in {n = Exp_app ((e1, args)); tk = _106_1614; pos = p; fvs = _106_1613; uvs = _106_1612})))
end)
end))
...
in if (not ((let _106_1635 = (FStar_List.tl vars)
in (let _106_1634 = (let _106_1633 = (let _106_1632 = (FStar_List.hd vars)
in (FStar_Util.set_eq order_bvd _106_1632))
in (FStar_Util.for_all _106_1633))
in (FStar_All.pipe_right _106_1635 _106_1634))))) then begin
(
# 668 "FStar.Absyn.Syntax.fst"
let vars = (let _106_1639 = (FStar_All.pipe_right vars (FStar_List.map (fun v -> (let _106_1638 = (FStar_List.map (fun _24_2 -> (match (_24_2) with
...
in (FStar_Util.concat_l ", " _106_1638)))))
in (FStar_Util.concat_l ";\n" _106_1639))
in (let _106_1642 = (let _106_1641 = (let _106_1640 = (FStar_Util.format1 "Each branch of this pattern binds different variables: %s" vars)
in (_106_1640, p.p))
in Error (_106_1641))
in (Prims.raise _106_1642)))
end else begin
(FStar_List.hd vars)
end)
end
...
| (e, pats) -> begin
(let _106_1651 = (get_typ_ref t)
in (let _106_1650 = (mk_fvs ())
in (let _106_1649 = (mk_uvs ())
in {n = Exp_match ((e, pats)); tk = _106_1651; pos = p; fvs = _106_1650; uvs = _106_1649})))
end))
...
| (e, t, l) -> begin
(let _106_1660 = (get_typ_ref t')
in (let _106_1659 = (mk_fvs ())
in (let _106_1658 = (mk_uvs ())
in {n = Exp_ascribed ((e, t, l)); tk = _106_1660; pos = p; fvs = _106_1659; uvs = _106_1658})))
end))
...
| (lbs, e) -> begin
(let _106_1669 = (get_typ_ref t)
in (let _106_1668 = (mk_fvs ())
in (let _106_1667 = (mk_uvs ())
in {n = Exp_let ((lbs, e)); tk = _106_1669; pos = p; fvs = _106_1668; uvs = _106_1667})))
end))
...
| (u, t) -> begin
(let _106_1678 = (get_typ_ref t')
in (let _106_1677 = (mk_fvs ())
in (let _106_1676 = (mk_uvs ())
in {n = Exp_uvar ((u, t)); tk = _106_1678; pos = p; fvs = _106_1677; uvs = _106_1676})))
end))
...
| (e, s, m) -> begin
(let _106_1691 = (get_typ_ref t)
in (let _106_1690 = (mk_fvs ())
in (let _106_1689 = (mk_uvs ())
in {n = Exp_delayed ((e, s, m)); tk = _106_1691; pos = p; fvs = _106_1690; uvs = _106_1689})))
end))

# 717 "FStar.Absyn.Syntax.fst"
let mk_Exp_meta' : meta_e  ->  typ Prims.option  ->  FStar_Range.range  ->  exp = (fun m t p -> (let _106_1700 = (get_typ_ref t)
in (let _106_1699 = (mk_fvs ())
in (let _106_1698 = (mk_uvs ())
in {n = Exp_meta (m); tk = _106_1700; pos = p; fvs = _106_1699; uvs = _106_1698}))))

# 724 "FStar.Absyn.Syntax.fst"
let mk_Exp_meta : meta_e  ->  exp = (fun m -> (match (m) with
| Meta_desugared (e, _24_773) -> begin
(let _106_1703 = (FStar_ST.read e.tk)
in (mk_Exp_meta' m _106_1703 e.pos))
end))
...
let null_t_binder : knd  ->  binder = (fun t -> (let _106_1722 = (let _106_1721 = (null_bvar t)
in FStar_Util.Inl (_106_1721))
in (_106_1722, None)))

# 745 "FStar.Absyn.Syntax.fst"
let null_v_binder : typ  ->  binder = (fun t -> (let _106_1726 = (let _106_1725 = (null_bvar t)
in FStar_Util.Inr (_106_1725))
in (_106_1726, None)))
...
let _24_830 = out
in (let _106_1747 = (FStar_Util.set_add btv out.ftvs)
in {ftvs = _106_1747; fxvs = _24_830.fxvs}))
end
| (FStar_Util.Inr (bxv), _24_835) -> begin
(
# 760 "FStar.Absyn.Syntax.fst"
let _24_837 = out
in (let _106_1748 = (FStar_Util.set_add bxv out.fxvs)
in {ftvs = _24_837.ftvs; fxvs = _106_1748}))
end)) no_fvs)))
...
let binders_of_freevars : freevars  ->  binders = (fun fvs -> (let _106_1757 = (let _106_1754 = (FStar_Util.set_elements fvs.ftvs)
in (FStar_All.pipe_right _106_1754 (FStar_List.map t_binder)))
in (let _106_1756 = (let _106_1755 = (FStar_Util.set_elements fvs.fxvs)
in (FStar_All.pipe_right _106_1755 (FStar_List.map v_binder)))
in (FStar_List.append _106_1757 _106_1756))))
