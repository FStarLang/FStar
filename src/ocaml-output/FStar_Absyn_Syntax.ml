...
| (ns, id) -> begin
(let nsstr = (let _92_1403 = (FStar_List.map text_of_id ns)
in (FStar_All.pipe_right _92_1403 text_of_path))
...
let no_fvs = (let _92_1452 = (new_ftv_set ())
in (let _92_1451 = (new_ftv_set ())
in {ftvs = _92_1452; fxvs = _92_1451}))

let no_uvs = (let _92_1455 = (new_uv_set ())
in (let _92_1454 = (new_uvt_set ())
in (let _92_1453 = (new_uvt_set ())
in {uvars_k = _92_1455; uvars_t = _92_1454; uvars_e = _92_1453})))
...
(let _23_433 = out
in (let _92_1460 = (FStar_Util.set_add btv out.ftvs)
in {ftvs = _92_1460; fxvs = _23_433.fxvs}))
end
| FStar_Util.Inr (bxv) -> begin
(let _23_437 = out
in (let _92_1461 = (FStar_Util.set_add bxv out.fxvs)
in {ftvs = _23_437.ftvs; fxvs = _92_1461}))
end)) no_fvs)))

let list_of_freevars = (fun fvs -> (let _92_1469 = (let _92_1465 = (FStar_Util.set_elements fvs.ftvs)
in (FStar_All.pipe_right _92_1465 (FStar_List.map (fun x -> FStar_Util.Inl (x)))))
in (let _92_1468 = (let _92_1467 = (FStar_Util.set_elements fvs.fxvs)
in (FStar_All.pipe_right _92_1467 (FStar_List.map (fun x -> FStar_Util.Inr (x)))))
in (FStar_List.append _92_1469 _92_1468))))
...
let mk_Kind_type = (let _92_1474 = (get_unit_ref ())
in (let _92_1473 = (mk_fvs ())
in (let _92_1472 = (mk_uvs ())
in {n = Kind_type; tk = _92_1474; pos = dummyRange; fvs = _92_1473; uvs = _92_1472})))

let mk_Kind_effect = (let _92_1477 = (get_unit_ref ())
in (let _92_1476 = (mk_fvs ())
in (let _92_1475 = (mk_uvs ())
in {n = Kind_effect; tk = _92_1477; pos = dummyRange; fvs = _92_1476; uvs = _92_1475})))

let mk_Kind_abbrev = (fun _23_448 p -> (match (_23_448) with
| (kabr, k) -> begin
(let _92_1484 = (get_unit_ref ())
in (let _92_1483 = (mk_fvs ())
in (let _92_1482 = (mk_uvs ())
in {n = Kind_abbrev ((kabr, k)); tk = _92_1484; pos = p; fvs = _92_1483; uvs = _92_1482})))
end))

let mk_Kind_arrow = (fun _23_452 p -> (match (_23_452) with
| (bs, k) -> begin
(let _92_1491 = (get_unit_ref ())
in (let _92_1490 = (mk_fvs ())
in (let _92_1489 = (mk_uvs ())
in {n = Kind_arrow ((bs, k)); tk = _92_1491; pos = p; fvs = _92_1490; uvs = _92_1489})))
end))
...
let mk_Kind_uvar = (fun uv p -> (let _92_1502 = (get_unit_ref ())
in (let _92_1501 = (mk_fvs ())
in (let _92_1500 = (mk_uvs ())
in {n = Kind_uvar (uv); tk = _92_1502; pos = p; fvs = _92_1501; uvs = _92_1500}))))

let mk_Kind_lam = (fun _23_471 p -> (match (_23_471) with
| (vs, k) -> begin
(let _92_1509 = (get_unit_ref ())
in (let _92_1508 = (mk_fvs ())
in (let _92_1507 = (mk_uvs ())
in {n = Kind_lam ((vs, k)); tk = _92_1509; pos = p; fvs = _92_1508; uvs = _92_1507})))
end))

let mk_Kind_delayed = (fun _23_476 p -> (match (_23_476) with
| (k, s, m) -> begin
(let _92_1516 = (get_unit_ref ())
in (let _92_1515 = (mk_fvs ())
in (let _92_1514 = (mk_uvs ())
in {n = Kind_delayed ((k, s, m)); tk = _92_1516; pos = p; fvs = _92_1515; uvs = _92_1514})))
end))

let mk_Kind_unknown = (let _92_1519 = (get_unit_ref ())
in (let _92_1518 = (mk_fvs ())
in (let _92_1517 = (mk_uvs ())
in {n = Kind_unknown; tk = _92_1519; pos = dummyRange; fvs = _92_1518; uvs = _92_1517})))
...
let mk_Typ_btvar = (fun x k p -> (let _92_1532 = (get_knd_ref k)
in (let _92_1531 = (mk_fvs ())
in (let _92_1530 = (mk_uvs ())
in {n = Typ_btvar (x); tk = _92_1532; pos = p; fvs = _92_1531; uvs = _92_1530}))))

let mk_Typ_const = (fun x k p -> (let _92_1539 = (get_knd_ref k)
in {n = Typ_const (x); tk = _92_1539; pos = p; fvs = memo_no_fvs; uvs = memo_no_uvs}))
...
| (bs, c) -> begin
(let _92_1552 = (check_fun bs c p)
in (let _92_1551 = (FStar_Util.mk_ref k)
in (let _92_1550 = (mk_fvs ())
in (let _92_1549 = (mk_uvs ())
in {n = _92_1552; tk = _92_1551; pos = p; fvs = _92_1550; uvs = _92_1549}))))
end))

let mk_Typ_refine = (fun _23_505 k p -> (match (_23_505) with
| (x, phi) -> begin
(let _92_1561 = (FStar_Util.mk_ref k)
in (let _92_1560 = (mk_fvs ())
in (let _92_1559 = (mk_uvs ())
in {n = Typ_refine ((x, phi)); tk = _92_1561; pos = p; fvs = _92_1560; uvs = _92_1559})))
end))

let mk_Typ_app = (fun _23_510 k p -> (match (_23_510) with
| (t1, args) -> begin
(let _92_1571 = (match (args) with
| [] -> begin
...
in (let _92_1570 = (FStar_Util.mk_ref k)
in (let _92_1569 = (mk_fvs ())
in (let _92_1568 = (mk_uvs ())
in {n = _92_1571; tk = _92_1570; pos = p; fvs = _92_1569; uvs = _92_1568}))))
end))
...
in (let _92_1592 = (FStar_Util.mk_ref k)
in (let _92_1591 = (mk_fvs ())
in (let _92_1590 = (mk_uvs ())
in {n = _92_1593; tk = _92_1592; pos = p; fvs = _92_1591; uvs = _92_1590}))))
end))
...
| (t, k) -> begin
(let _92_1608 = (FStar_Util.mk_ref k')
in (let _92_1607 = (mk_fvs ())
in (let _92_1606 = (mk_uvs ())
in {n = Typ_ascribed ((t, k)); tk = _92_1608; pos = p; fvs = _92_1607; uvs = _92_1606})))
end))
...
let mk_Typ_meta' = (fun m k p -> (let _92_1621 = (FStar_Util.mk_ref k)
in (let _92_1620 = (mk_fvs ())
in (let _92_1619 = (mk_uvs ())
in {n = Typ_meta (m); tk = _92_1621; pos = p; fvs = _92_1620; uvs = _92_1619}))))
...
(let _92_1624 = (FStar_ST.read t.tk)
in (mk_Typ_meta' m _92_1624 t.pos))
end))

let mk_Typ_uvar' = (fun _23_595 k' p -> (match (_23_595) with
| (u, k) -> begin
(let _92_1633 = (get_knd_ref k')
in (let _92_1632 = (mk_fvs ())
in (let _92_1631 = (mk_uvs ())
in {n = Typ_uvar ((u, k)); tk = _92_1633; pos = p; fvs = _92_1632; uvs = _92_1631})))
end))
...
in (let _92_1652 = (FStar_Util.mk_ref k)
in (let _92_1651 = (mk_fvs ())
in (let _92_1650 = (mk_uvs ())
in {n = _92_1653; tk = _92_1652; pos = p; fvs = _92_1651; uvs = _92_1650}))))
end))

let mk_Typ_delayed' = (fun st k p -> (let _92_1675 = (let _92_1671 = (let _92_1670 = (FStar_Util.mk_ref None)
in (st, _92_1670))
in Typ_delayed (_92_1671))
in (let _92_1674 = (FStar_Util.mk_ref k)
in (let _92_1673 = (mk_fvs ())
in (let _92_1672 = (mk_uvs ())
in {n = _92_1675; tk = _92_1674; pos = p; fvs = _92_1673; uvs = _92_1672})))))

let mk_Typ_unknown = (let _92_1678 = (get_knd_nref ())
in (let _92_1677 = (mk_fvs ())
in (let _92_1676 = (mk_uvs ())
in {n = Typ_unknown; tk = _92_1678; pos = dummyRange; fvs = _92_1677; uvs = _92_1676})))
...
let mk_Total = (fun t -> (let _92_1687 = (FStar_Util.mk_ref None)
in (let _92_1686 = (mk_fvs ())
in (let _92_1685 = (mk_uvs ())
in {n = Total (t); tk = _92_1687; pos = t.pos; fvs = _92_1686; uvs = _92_1685}))))

let mk_Comp = (fun ct -> (let _92_1692 = (FStar_Util.mk_ref None)
in (let _92_1691 = (mk_fvs ())
in (let _92_1690 = (mk_uvs ())
in {n = Comp (ct); tk = _92_1692; pos = ct.result_typ.pos; fvs = _92_1691; uvs = _92_1690}))))

let mk_Exp_bvar = (fun x t p -> (let _92_1701 = (get_typ_ref t)
in (let _92_1700 = (mk_fvs ())
in (let _92_1699 = (mk_uvs ())
in {n = Exp_bvar (x); tk = _92_1701; pos = p; fvs = _92_1700; uvs = _92_1699}))))

let mk_Exp_fvar = (fun _23_631 t p -> (match (_23_631) with
| (x, b) -> begin
(let _92_1710 = (get_typ_ref t)
in (let _92_1709 = (mk_fvs ())
in (let _92_1708 = (mk_uvs ())
in {n = Exp_fvar ((x, b)); tk = _92_1710; pos = p; fvs = _92_1709; uvs = _92_1708})))
end))

let mk_Exp_constant = (fun s t p -> (let _92_1719 = (get_typ_ref t)
in (let _92_1718 = (mk_fvs ())
in (let _92_1717 = (mk_uvs ())
in {n = Exp_constant (s); tk = _92_1719; pos = p; fvs = _92_1718; uvs = _92_1717}))))

let mk_Exp_abs = (fun _23_639 t' p -> (match (_23_639) with
| (b, e) -> begin
(let _92_1729 = (match (b) with
| [] -> begin
...
in (let _92_1728 = (get_typ_ref t')
in (let _92_1727 = (mk_fvs ())
in (let _92_1726 = (mk_uvs ())
in {n = _92_1729; tk = _92_1728; pos = p; fvs = _92_1727; uvs = _92_1726}))))
end))

let mk_Exp_abs' = (fun _23_647 t' p -> (match (_23_647) with
| (b, e) -> begin
(let _92_1739 = (match ((b, e.n)) with
...
in (let _92_1738 = (get_typ_ref t')
in (let _92_1737 = (mk_fvs ())
in (let _92_1736 = (mk_uvs ())
in {n = _92_1739; tk = _92_1738; pos = p; fvs = _92_1737; uvs = _92_1736}))))
end))

let mk_Exp_app = (fun _23_667 t p -> (match (_23_667) with
| (e1, args) -> begin
(let _92_1749 = (match (args) with
| [] -> begin
...
in (let _92_1748 = (get_typ_ref t)
in (let _92_1747 = (mk_fvs ())
in (let _92_1746 = (mk_uvs ())
in {n = _92_1749; tk = _92_1748; pos = p; fvs = _92_1747; uvs = _92_1746}))))
end))
...
in (match ((not ((let _92_1770 = (FStar_List.tl vars)
in (let _92_1769 = (let _92_1768 = (let _92_1767 = (FStar_List.hd vars)
in (FStar_Util.set_eq order_bvd _92_1767))
in (FStar_Util.for_all _92_1768))
in (FStar_All.pipe_right _92_1770 _92_1769)))))) with
| true -> begin
(let vars = (let _92_1774 = (FStar_All.pipe_right vars (FStar_List.map (fun v -> (let _92_1773 = (FStar_List.map (fun _23_2 -> (match (_23_2) with
...
in (FStar_Util.concat_l ", " _92_1773)))))
in (FStar_Util.concat_l ";\n" _92_1774))
in (let _92_1777 = (let _92_1776 = (let _92_1775 = (FStar_Util.format1 "Each branch of this pattern binds different variables: %s" vars)
in (_92_1775, p.p))
in Error (_92_1776))
in (Prims.raise _92_1777)))
end
| false -> begin
(FStar_List.hd vars)
end))
...
| (e, pats) -> begin
(let _92_1786 = (get_typ_ref t)
in (let _92_1785 = (mk_fvs ())
in (let _92_1784 = (mk_uvs ())
in {n = Exp_match ((e, pats)); tk = _92_1786; pos = p; fvs = _92_1785; uvs = _92_1784})))
end))

let mk_Exp_ascribed = (fun _23_756 t' p -> (match (_23_756) with
| (e, t, l) -> begin
(let _92_1795 = (get_typ_ref t')
in (let _92_1794 = (mk_fvs ())
in (let _92_1793 = (mk_uvs ())
in {n = Exp_ascribed ((e, t, l)); tk = _92_1795; pos = p; fvs = _92_1794; uvs = _92_1793})))
end))

let mk_Exp_let = (fun _23_761 t p -> (match (_23_761) with
| (lbs, e) -> begin
(let _92_1804 = (get_typ_ref t)
in (let _92_1803 = (mk_fvs ())
in (let _92_1802 = (mk_uvs ())
in {n = Exp_let ((lbs, e)); tk = _92_1804; pos = p; fvs = _92_1803; uvs = _92_1802})))
end))

let mk_Exp_uvar' = (fun _23_766 t' p -> (match (_23_766) with
| (u, t) -> begin
(let _92_1813 = (get_typ_ref t')
in (let _92_1812 = (mk_fvs ())
in (let _92_1811 = (mk_uvs ())
in {n = Exp_uvar ((u, t)); tk = _92_1813; pos = p; fvs = _92_1812; uvs = _92_1811})))
end))
...
| (e, s, m) -> begin
(let _92_1826 = (get_typ_ref t)
in (let _92_1825 = (mk_fvs ())
in (let _92_1824 = (mk_uvs ())
in {n = Exp_delayed ((e, s, m)); tk = _92_1826; pos = p; fvs = _92_1825; uvs = _92_1824})))
end))

let mk_Exp_meta' = (fun m t p -> (let _92_1835 = (get_typ_ref t)
in (let _92_1834 = (mk_fvs ())
in (let _92_1833 = (mk_uvs ())
in {n = Exp_meta (m); tk = _92_1835; pos = p; fvs = _92_1834; uvs = _92_1833}))))

let mk_Exp_meta = (fun m -> (match (m) with
| Meta_desugared (e, _23_785) -> begin
(let _92_1838 = (FStar_ST.read e.tk)
in (mk_Exp_meta' m _92_1838 e.pos))
end))
...
let null_t_binder = (fun t -> (let _92_1857 = (let _92_1856 = (null_bvar t)
in FStar_Util.Inl (_92_1856))
in (_92_1857, None)))

let null_v_binder = (fun t -> (let _92_1861 = (let _92_1860 = (null_bvar t)
in FStar_Util.Inr (_92_1860))
in (_92_1861, None)))
...
(let _23_842 = out
in (let _92_1882 = (FStar_Util.set_add btv out.ftvs)
in {ftvs = _92_1882; fxvs = _23_842.fxvs}))
end
| (FStar_Util.Inr (bxv), _23_847) -> begin
(let _23_849 = out
in (let _92_1883 = (FStar_Util.set_add bxv out.fxvs)
in {ftvs = _23_849.ftvs; fxvs = _92_1883}))
end)) no_fvs)))

let binders_of_list = (fun fvs -> (FStar_All.pipe_right fvs (FStar_List.map (fun t -> (t, None)))))

let binders_of_freevars = (fun fvs -> (let _92_1892 = (let _92_1889 = (FStar_Util.set_elements fvs.ftvs)
in (FStar_All.pipe_right _92_1889 (FStar_List.map t_binder)))
in (let _92_1891 = (let _92_1890 = (FStar_Util.set_elements fvs.fxvs)
in (FStar_All.pipe_right _92_1890 (FStar_List.map v_binder)))
in (FStar_List.append _92_1892 _92_1891))))
