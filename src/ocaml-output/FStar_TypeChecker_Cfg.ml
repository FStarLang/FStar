              ...
              | (FStar_Syntax_Syntax.Tm_fvar fv1, (arg, uu____4167)::[]) when
                  ...
                  (match uu____4206 with
                   | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_int
                       ...
                       let uu____4229 =
                         let uu____4234 = FStar_BigInt.big_int_of_string i in
                         (fv1, uu____4234) in
                       FStar_Pervasives_Native.Some uu____4229
                   | uu____4239 -> FStar_Pervasives_Native.None)
              | uu____4244 -> FStar_Pervasives_Native.None)) in
    ...
    unary_op1 arg_as_int1
      (fun r ->
         fun x ->
           ...
           embed_simple FStar_Syntax_Embeddings.e_int r uu____4676) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_int r uu____4718) in
  let unary_bool_op1 f =
    unary_op1 arg_as_bool1
      (fun r ->
         fun x ->
           let uu____4759 = f x in
           embed_simple FStar_Syntax_Embeddings.e_bool r uu____4759) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_bool r uu____4812) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_string r uu____4865) in
  ...
  let basic_ops =
    let uu____6138 =
      ...
      (FStar_Parser_Const.op_Minus, Prims.int_one, Prims.int_zero,
        (unary_int_op1 (fun x -> FStar_BigInt.minus_big_int x)), uu____6168) in
    let uu____6202 =
      let uu____6234 =
        let uu____6264 =
                  ...
                  (FStar_Parser_Const.op_LTE, (Prims.of_int (2)),
                    ...
                    (binary_op1 arg_as_int1
                       (fun r ->
                          fun x ->
                            fun y ->
                              let uu____6823 = FStar_BigInt.le_big_int x y in
                              embed_simple FStar_Syntax_Embeddings.e_bool r
                                uu____6823)), uu____6780) in
                let uu____6826 =
                  let uu____6858 =
                    let uu____6888 =
                      FStar_TypeChecker_NBETerm.binary_op
                    ...
                    (FStar_Parser_Const.op_GT, (Prims.of_int (2)),
                      ...
                      (binary_op1 arg_as_int1
                         (fun r ->
                            fun x ->
                              fun y ->
                                let uu____6931 = FStar_BigInt.gt_big_int x y in
                                embed_simple FStar_Syntax_Embeddings.e_bool r
                                  uu____6931)), uu____6888) in
                  let uu____6934 =
                    let uu____6966 =
                      let uu____6996 =
                        FStar_TypeChecker_NBETerm.binary_op
                          ...
                          (fun x ->
                             fun y ->
                               let uu____7008 = FStar_BigInt.ge_big_int x y in
                               FStar_TypeChecker_NBETerm.embed
                                 FStar_TypeChecker_NBETerm.e_bool bogus_cbs
                                 uu____7008) in
                                  ...
                                  let uu____7668 =
                                    ...
                                    (FStar_Parser_Const.string_list_of_string_lid,
                                      ...
                                      (unary_op1 arg_as_string1
                                         list_of_string'1), uu____7698) in
                                  let uu____7728 =
                                    let uu____7760 =
                                      let uu____7790 =
                                        FStar_TypeChecker_NBETerm.unary_op
                                      ...
                                      (FStar_Parser_Const.string_string_of_list_lid,
                                        ...
                                        (unary_op1
                                           ...
                                           string_of_list'1), uu____7790) in
                                    let uu____7826 =
                                      let uu____7858 =
                                        let uu____7890 =
                                          let uu____7922 =
    ...
    let add_sub_mul_v =
      FStar_All.pipe_right
        ...
        (FStar_List.collect
           (fun m ->
              let uu____10042 =
                let uu____10072 = FStar_Parser_Const.p2l ["FStar"; m; "add"] in
                let uu____10079 =
                  FStar_TypeChecker_NBETerm.binary_op
                    ...
                    (fun uu____10097 ->
                       fun uu____10098 ->
                         ...
                         | ((int_to_t1, x), (uu____10117, y)) ->
                             let uu____10127 = FStar_BigInt.add_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____10127) in
                      ...
                      (fun uu____10280 ->
                         fun uu____10281 ->
                           ...
                           | ((int_to_t1, x), (uu____10300, y)) ->
                               let uu____10310 = FStar_BigInt.sub_big_int x y in
                               FStar_TypeChecker_NBETerm.int_as_bounded
                                 int_to_t1 uu____10310) in
              ...
              uu____10042 :: uu____10193)) in
    let div_mod_unsigned =
      FStar_All.pipe_right bounded_unsigned_int_types
        (FStar_List.collect
           (fun m ->
              let uu____10932 =
                let uu____10962 = FStar_Parser_Const.p2l ["FStar"; m; "div"] in
                let uu____10969 =
                  FStar_TypeChecker_NBETerm.binary_op
                    FStar_TypeChecker_NBETerm.arg_as_bounded_int
                    (fun uu____10987 ->
                       fun uu____10988 ->
                         ...
                         | ((int_to_t1, x), (uu____11007, y)) ->
                             let uu____11017 = FStar_BigInt.div_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____11017) in
                      ...
                      (fun uu____11170 ->
                         fun uu____11171 ->
                           ...
                           | ((int_to_t1, x), (uu____11190, y)) ->
                               let uu____11200 = FStar_BigInt.mod_big_int x y in
                               FStar_TypeChecker_NBETerm.int_as_bounded
                                 int_to_t1 uu____11200) in
                    ...
                    (fun uu____11532 ->
                       fun uu____11533 ->
                         ...
                         | ((int_to_t1, x), (uu____11552, y)) ->
                             let uu____11562 = FStar_BigInt.logor_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____11562) in
                                 ...
                                 | ((int_to_t1, x), (uu____12236, y)) ->
                                     let uu____12246 =
                                       ...
                                       FStar_BigInt.logand_big_int
                                         uu____12247 uu____12248 in
                                     FStar_TypeChecker_NBETerm.int_as_bounded
                                       int_to_t1 uu____12246) in
                                  ...
                                  fun uu____12284 ->
                                    ...
                                    | ((int_to_t1, x), (uu____12303, y)) ->
                                        let uu____12313 =
                                          ...
                                          FStar_BigInt.logand_big_int
                                            uu____12314 uu____12315 in
                                        int_as_bounded1 r int_to_t1
                                          uu____12313)), uu____12198) in
                      let uu____12316 =
                        let uu____12348 =
                          let uu____12378 =
                            FStar_Parser_Const.p2l
...
let (equality_ops : primitive_step FStar_Util.psmap) =
  ...
  let interp_prop_eq31 psc _norm_cb args =
    let r = psc.psc_range in
    match args with
    | (t1, uu____12985)::(t2, uu____12987)::(a1, uu____12989)::(a2,
                                                                uu____12991)::[]
        ->
        let uu____13064 =
...
let (fixto : Prims.int -> Prims.string -> Prims.string) =
  fun n1 ->
    fun s ->
      ...
      then
        let uu____13151 = FStar_String.make (n1 - (FStar_String.length s)) 32 in
      ...
      FStar_Util.sort_with
        (fun uu____13233 ->
           fun uu____13234 ->
             ...
             | ((uu____13260, t1), (uu____13262, t2)) -> t1 - t2) pairs in
...
let (mk_extendable_primop_set :
  ...
  fun uu____13342 ->
    let steps =
      let uu____13346 = empty_prim_steps () in FStar_Util.mk_ref uu____13346 in
    let register p =
      FStar_ST.op_Colon_Equals extendable_primops_dirty true;
      (let uu____13376 =
         let uu____13377 = FStar_ST.op_Bang steps in add_step p uu____13377 in
       FStar_ST.op_Colon_Equals steps uu____13376) in
    let retrieve uu____13421 = FStar_ST.op_Bang steps in (register, retrieve)
...
let (cached_steps : unit -> prim_step_set) =
  let memo =
    let uu____13530 = empty_prim_steps () in FStar_Util.mk_ref uu____13530 in
  fun uu____13531 ->
  ...
  fun psteps ->
    fun s ->
      fun e ->
        ...
        let psteps1 =
          let uu____13686 = cached_steps () in add_steps uu____13686 psteps in
        let uu____13687 =
