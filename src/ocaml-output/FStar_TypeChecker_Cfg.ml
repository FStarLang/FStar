  ...
  fun f  ->
    let format_opt f1 o =
      ...
      | FStar_Pervasives_Native.Some x ->
          let uu___ = let uu___1 = f1 x  in FStar_String.op_Hat uu___1 ")"
             in
          FStar_String.op_Hat "Some (" uu___
       in
...
let (built_in_primitive_steps : primitive_step FStar_Util.psmap) =
  ...
  let mixed_binary_op as_a as_b embed_c f res _norm_cb args =
    ...
    | a1::b1::[] ->
        let uu___ =
          let uu___1 = as_a a1  in let uu___2 = as_b b1  in (uu___1, uu___2)
           in
        (match uu___ with
  ...
  let prims_to_fstar_range_step psc1 _norm_cb args =
    match args with
    | (a1,uu___)::[] ->
        let uu___1 = try_unembed_simple FStar_Syntax_Embeddings.e_range a1
           in
        (match uu___1 with
  ...
  let division_op psc1 _norm_cb args =
    ...
    | (a1,FStar_Pervasives_Native.None )::(a2,FStar_Pervasives_Native.None )::[]
        ->
        let uu___ =
          let uu___1 = try_unembed_simple FStar_Syntax_Embeddings.e_int a1
             in
          let uu___2 = try_unembed_simple FStar_Syntax_Embeddings.e_int a2
             in
          (uu___1, uu___2)  in
        (match uu___ with
  ...
  let basic_ops =
    let uu___ =
      ...
      (FStar_Parser_Const.op_Minus, Prims.int_one, Prims.int_zero,
        (unary_int_op (fun x  -> FStar_BigInt.minus_big_int x)), uu___1)
       in
    let uu___1 =
      let uu___2 =
        let uu___3 =
        ...
        let uu___5 =
          ...
          let uu___7 =
                    ...
                    (fun x  ->
                       fun y  ->
                         ...
                         FStar_TypeChecker_NBETerm.embed
                           FStar_TypeChecker_NBETerm.e_bool bogus_cbs uu___11)
                   in
                      ...
                      (FStar_Parser_Const.op_GTE, (Prims.of_int (2)),
                        ...
                        (binary_op arg_as_int
                           (fun r  ->
                              fun x  ->
                                fun y  ->
                                  let uu___17 = FStar_BigInt.ge_big_int x y
                                     in
            ...
            (FStar_Parser_Const.op_Division, (Prims.of_int (2)),
              ...
              FStar_TypeChecker_NBETerm.division_op) :: uu___8
             in
          uu___6 :: uu___7  in
        uu___4 :: uu___5  in
      uu___2 :: uu___3  in
                     ...
                     (fun r  ->
                        fun uu___3  ->
                          fun uu___4  ->
                            ...
                            | ((int_to_t,x),(uu___5,y)) ->
                                let uu___6 = FStar_BigInt.add_big_int x y  in
                                int_as_bounded r int_to_t uu___6)), uu___2)
                 in
              let uu___1 =
                let uu___2 =
                       ...
                       (fun r  ->
                          fun uu___5  ->
                            fun uu___6  ->
                              match (uu___5, uu___6) with
                              | ((int_to_t,x),(uu___7,y)) ->
                                  let uu___8 = FStar_BigInt.sub_big_int x y
                                     in
                                  int_as_bounded r int_to_t uu___8)), uu___4)
                   in
                let uu___3 =
                  let uu___4 =
                    let uu___5 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                       in
                    let uu___6 =
                      FStar_TypeChecker_NBETerm.binary_op
                        FStar_TypeChecker_NBETerm.arg_as_bounded_int
                        (fun uu___7  ->
                           fun uu___8  ->
                             ...
                             | ((int_to_t,x),(uu___9,y)) ->
                                 let uu___10 = FStar_BigInt.mult_big_int x y
                                    in
                                 FStar_TypeChecker_NBETerm.int_as_bounded
                                   int_to_t uu___10)
                       in
                  ...
                  let uu___5 =
                    let uu___6 =
                      let uu___7 = FStar_Parser_Const.p2l ["FStar"; m; "v"]
                         in
                      let uu___8 =
                        FStar_TypeChecker_NBETerm.unary_op
                          FStar_TypeChecker_NBETerm.arg_as_bounded_int
                       ...
                       (fun r  ->
                          fun uu___5  ->
                            fun uu___6  ->
                              match (uu___5, uu___6) with
                              | ((int_to_t,x),(uu___7,y)) ->
                                  let uu___8 = FStar_BigInt.mod_big_int x y
                                     in
                                  int_as_bounded r int_to_t uu___8)), uu___4)
                   in
                [uu___2]  in
                     ...
                     (fun r  ->
                        fun uu___3  ->
                          fun uu___4  ->
                            match (uu___3, uu___4) with
                            | ((int_to_t,x),(uu___5,y)) ->
                                let uu___6 = FStar_BigInt.logor_big_int x y
                                   in
                                int_as_bounded r int_to_t uu___6)), uu___2)
                 in
              let uu___1 =
                let uu___2 =
                  let uu___3 = FStar_Parser_Const.p2l ["FStar"; m; "logand"]
                     in
                  let uu___4 =
                    FStar_TypeChecker_NBETerm.binary_op
                      FStar_TypeChecker_NBETerm.arg_as_bounded_int
                      (fun uu___5  ->
                         fun uu___6  ->
                           match (uu___5, uu___6) with
                           | ((int_to_t,x),(uu___7,y)) ->
                               let uu___8 = FStar_BigInt.logand_big_int x y
                                  in
                               FStar_TypeChecker_NBETerm.int_as_bounded
                                 int_to_t uu___8)
                     in
      ...
      FStar_Util.sort_with
        (fun uu___1  ->
           fun uu___2  ->
             ...
             | ((uu___3,t1),(uu___4,t2)) -> t1 - t2) pairs
       in
...
let (mk_extendable_primop_set :
  ...
  fun uu___  ->
    let steps = let uu___1 = empty_prim_steps ()  in FStar_Util.mk_ref uu___1
       in
    let register p =
      FStar_ST.op_Colon_Equals extendable_primops_dirty true;
      (let uu___2 = let uu___3 = FStar_ST.op_Bang steps  in add_step p uu___3
          in
       FStar_ST.op_Colon_Equals steps uu___2)
       in
    ...
    then
      let steps =
        let uu___2 =
          ...
          let uu___4 = retrieve_extra_steps ()  in merge_steps uu___3 uu___4
           in
      ...
      fun e  ->
        let d =
          FStar_All.pipe_right s
           ...
           in
        let d1 =
          match d with | [] -> [FStar_TypeChecker_Env.NoDelta] | uu___ -> d
           in
        let steps =
          let uu___ = to_fsteps s  in FStar_All.pipe_right uu___ add_nbe  in
        let psteps1 = let uu___ = cached_steps ()  in add_steps uu___ psteps
           in
        let uu___ =
