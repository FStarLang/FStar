              ...
              | (FStar_Syntax_Syntax.Tm_fvar fv1, (arg, uu____4174)::[]) when
                  ...
                  (match uu____4213 with
                   | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_int
                       ...
                       let uu____4236 =
                         let uu____4241 = FStar_BigInt.big_int_of_string i in
                         (fv1, uu____4241) in
    ...
    unary_op1 arg_as_int1
      (fun r ->
         fun x ->
           ...
           embed_simple FStar_Syntax_Embeddings.e_int r uu____4683) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_int r uu____4725) in
  let unary_bool_op1 f =
    unary_op1 arg_as_bool1
      (fun r ->
         fun x ->
           let uu____4766 = f x in
           embed_simple FStar_Syntax_Embeddings.e_bool r uu____4766) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_bool r uu____4819) in
      ...
      (fun r ->
         fun x ->
           fun y ->
             ...
             embed_simple FStar_Syntax_Embeddings.e_string r uu____4872) in
  ...
  let basic_ops =
    let uu____6145 =
      ...
      (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
        (Prims.parse_int "0"),
        (unary_int_op1 (fun x -> FStar_BigInt.minus_big_int x)), uu____6175) in
    let uu____6209 =
      let uu____6241 =
        let uu____6271 =
                  ...
                  (FStar_Parser_Const.op_LTE, (Prims.parse_int "2"),
                    ...
                    (binary_op1 arg_as_int1
                       (fun r ->
                          fun x ->
                            fun y ->
                              let uu____6830 = FStar_BigInt.le_big_int x y in
                              embed_simple FStar_Syntax_Embeddings.e_bool r
                                uu____6830)), uu____6787) in
                let uu____6833 =
                  let uu____6865 =
                    let uu____6895 =
                      FStar_TypeChecker_NBETerm.binary_op
                    ...
                    (FStar_Parser_Const.op_GT, (Prims.parse_int "2"),
                      ...
                      (binary_op1 arg_as_int1
                         (fun r ->
                            fun x ->
                              fun y ->
                                let uu____6938 = FStar_BigInt.gt_big_int x y in
                                embed_simple FStar_Syntax_Embeddings.e_bool r
                                  uu____6938)), uu____6895) in
                  let uu____6941 =
                    let uu____6973 =
                      let uu____7003 =
                        FStar_TypeChecker_NBETerm.binary_op
                          ...
                          (fun x ->
                             fun y ->
                               let uu____7015 = FStar_BigInt.ge_big_int x y in
                               FStar_TypeChecker_NBETerm.embed
                                 FStar_TypeChecker_NBETerm.e_bool bogus_cbs
                                 uu____7015) in
                                  ...
                                  let uu____7675 =
                                    ...
                                    (FStar_Parser_Const.string_list_of_string_lid,
                                      ...
                                      (unary_op1 arg_as_string1
                                         list_of_string'1), uu____7705) in
                                  let uu____7735 =
                                    let uu____7767 =
                                      let uu____7797 =
                                        FStar_TypeChecker_NBETerm.unary_op
                                      ...
                                      (FStar_Parser_Const.string_string_of_list_lid,
                                        ...
                                        (unary_op1
                                           ...
                                           string_of_list'1), uu____7797) in
                                    let uu____7833 =
                                      let uu____7865 =
                                        let uu____7897 =
                                          let uu____7929 =
    ...
    let add_sub_mul_v =
      FStar_All.pipe_right
        ...
        (FStar_List.collect
           (fun m ->
              let uu____10049 =
                let uu____10079 = FStar_Parser_Const.p2l ["FStar"; m; "add"] in
                let uu____10086 =
                  FStar_TypeChecker_NBETerm.binary_op
                    ...
                    (fun uu____10104 ->
                       fun uu____10105 ->
                         ...
                         | ((int_to_t1, x), (uu____10124, y)) ->
                             let uu____10134 = FStar_BigInt.add_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____10134) in
                      ...
                      (fun uu____10287 ->
                         fun uu____10288 ->
                           ...
                           | ((int_to_t1, x), (uu____10307, y)) ->
                               let uu____10317 = FStar_BigInt.sub_big_int x y in
                               FStar_TypeChecker_NBETerm.int_as_bounded
                                 int_to_t1 uu____10317) in
              ...
              uu____10049 :: uu____10200)) in
    let div_mod_unsigned =
      FStar_All.pipe_right bounded_unsigned_int_types
        (FStar_List.collect
           (fun m ->
              let uu____10939 =
                let uu____10969 = FStar_Parser_Const.p2l ["FStar"; m; "div"] in
                let uu____10976 =
                  FStar_TypeChecker_NBETerm.binary_op
                    FStar_TypeChecker_NBETerm.arg_as_bounded_int
                    (fun uu____10994 ->
                       fun uu____10995 ->
                         ...
                         | ((int_to_t1, x), (uu____11014, y)) ->
                             let uu____11024 = FStar_BigInt.div_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____11024) in
                      ...
                      (fun uu____11177 ->
                         fun uu____11178 ->
                           ...
                           | ((int_to_t1, x), (uu____11197, y)) ->
                               let uu____11207 = FStar_BigInt.mod_big_int x y in
                               FStar_TypeChecker_NBETerm.int_as_bounded
                                 int_to_t1 uu____11207) in
                    ...
                    (fun uu____11539 ->
                       fun uu____11540 ->
                         ...
                         | ((int_to_t1, x), (uu____11559, y)) ->
                             let uu____11569 = FStar_BigInt.logor_big_int x y in
                             FStar_TypeChecker_NBETerm.int_as_bounded
                               int_to_t1 uu____11569) in
                                 ...
                                 | ((int_to_t1, x), (uu____12243, y)) ->
                                     let uu____12253 =
                                       ...
                                       FStar_BigInt.logand_big_int
                                         uu____12254 uu____12255 in
                                     FStar_TypeChecker_NBETerm.int_as_bounded
                                       int_to_t1 uu____12253) in
...
let (equality_ops : primitive_step FStar_Util.psmap) =
  ...
  let interp_prop_eq31 psc _norm_cb args =
    let r = psc.psc_range in
    match args with
    | (t1, uu____12996)::(t2, uu____12998)::(a1, uu____13000)::(a2,
                                                                uu____13002)::[]
        ->
        let uu____13075 =
...
let (fixto : Prims.int -> Prims.string -> Prims.string) =
  fun n1 ->
    fun s ->
      ...
      then
        let uu____13162 = FStar_String.make (n1 - (FStar_String.length s)) 32 in
      ...
      FStar_Util.sort_with
        (fun uu____13244 ->
           fun uu____13245 ->
             ...
             | ((uu____13271, t1), (uu____13273, t2)) -> t1 - t2) pairs in
    FStar_List.fold_right
      (fun uu____13307 ->
         fun rest ->
...
let (plugins :
  ...
  let retrieve uu____13417 = FStar_ST.op_Bang plugins in (register, retrieve)
        ...
        let uu____13584 =
          (FStar_Options.normalize_pure_terms_for_extraction ()) ||
            (let uu____13587 =
             ...
             Prims.op_Negation uu____13587) in
        {
          steps = uu____13545;
          tcenv = e;
          debug = uu____13547;
