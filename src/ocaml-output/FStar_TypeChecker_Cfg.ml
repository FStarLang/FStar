...
let (add_nbe : fsteps -> fsteps) =
  fun s  ->
    ...
    if uu____13397
    then
      let uu___272_13400 = s  in
      {
        beta = (uu___272_13400.beta);
        iota = (uu___272_13400.iota);
        zeta = (uu___272_13400.zeta);
        weak = (uu___272_13400.weak);
        hnf = (uu___272_13400.hnf);
        primops = (uu___272_13400.primops);
        do_not_unfold_pure_lets = (uu___272_13400.do_not_unfold_pure_lets);
        unfold_until = (uu___272_13400.unfold_until);
        unfold_only = (uu___272_13400.unfold_only);
        unfold_fully = (uu___272_13400.unfold_fully);
        unfold_attr = (uu___272_13400.unfold_attr);
        unfold_tac = (uu___272_13400.unfold_tac);
        pure_subterms_within_computations =
          (uu___272_13400.pure_subterms_within_computations);
        simplify = (uu___272_13400.simplify);
        erase_universes = (uu___272_13400.erase_universes);
        allow_unbound_universes = (uu___272_13400.allow_unbound_universes);
        reify_ = (uu___272_13400.reify_);
        compress_uvars = (uu___272_13400.compress_uvars);
        no_full_norm = (uu___272_13400.no_full_norm);
        check_no_uvars = (uu___272_13400.check_no_uvars);
        unmeta = (uu___272_13400.unmeta);
        unascribe = (uu___272_13400.unascribe);
        in_full_norm_request = (uu___272_13400.in_full_norm_request);
        weakly_reduce_scrutinee = (uu___272_13400.weakly_reduce_scrutinee);
        nbe_step = true;
        for_extraction = (uu___272_13400.for_extraction)
      }
    else s
