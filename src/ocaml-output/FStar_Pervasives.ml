...
type 'Aheap st_pre_h = 'Aheap -> Prims.prop[@@deriving show]
type ('Aheap, 'Aa, 'Apre) st_post_h' = 'Aa -> 'Aheap -> Prims.prop[@@deriving
                                                                    show]
...
type ('Aheap, 'Aa, 'Ax, 'Ap, 'Auu___9_127) st_return = 'Ap[@@deriving show]
...
let uu___is_V : 'Aa . 'Aa result -> Prims.bool =
  fun projectee -> match projectee with | V v -> true | uu____1370 -> false
let __proj__V__item__v : 'Aa . 'Aa result -> 'Aa =
  fun projectee -> match projectee with | V v -> v
let uu___is_E : 'Aa . 'Aa result -> Prims.bool =
  fun projectee -> match projectee with | E e -> true | uu____1400 -> false
...
let uu___is_Err : 'Aa . 'Aa result -> Prims.bool =
  fun projectee ->
    match projectee with | Err msg -> true | uu____1430 -> false
...
type ('Aa, 'Apre) ex_post' = 'Aa result -> Prims.prop[@@deriving show]
...
type 'Ah all_pre_h = 'Ah -> Prims.prop[@@deriving show]
type ('Ah, 'Aa, 'Apre) all_post_h' = 'Aa result -> 'Ah -> Prims.prop[@@deriving
                                                                    show]
...
type ('Aheap, 'Aa, 'Awp, 'Apost, 'Ah0) all_ite_wp = Prims.unit[@@deriving
                                                                show]
type ('Aheap, 'Aa, 'Ax, 'Ap, 'Auu___12_3053) all_return = 'Ap[@@deriving
                                                               show]
...
let invertOption : 'Aa . Prims.unit -> Prims.unit = fun uu____4077 -> ()
type ('a, 'b) either =
  | Inl of 'a 
  | Inr of 'b [@@deriving show]
let uu___is_Inl : 'a 'b . ('a, 'b) either -> Prims.bool =
  fun projectee -> match projectee with | Inl v -> true | uu____4120 -> false
...
let uu___is_Inr : 'a 'b . ('a, 'b) either -> Prims.bool =
  fun projectee -> match projectee with | Inr v -> true | uu____4164 -> false
...
let (uu___is_PpxDerivingShow : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | PpxDerivingShow -> true | uu____4746 -> false
...
let (uu___is_CInline : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | CInline -> true | uu____4762 -> false
let (uu___is_Substitute : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | Substitute -> true | uu____4766 -> false
let (uu___is_Gc : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee -> match projectee with | Gc -> true | uu____4770 -> false
let (uu___is_Comment : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | Comment _0 -> true | uu____4775 -> false
...
let (uu___is_CPrologue : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | CPrologue _0 -> true | uu____4787 -> false
...
let (uu___is_CEpilogue : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | CEpilogue _0 -> true | uu____4799 -> false
...
let (uu___is_CConst : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee ->
    match projectee with | CConst _0 -> true | uu____4811 -> false
