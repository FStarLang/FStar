...
let uu___is_V projectee =
  match projectee with | V v -> true | uu____548 -> false
let __proj__V__item__v projectee = match projectee with | V v -> v
let uu___is_E projectee =
  match projectee with | E e -> true | uu____582 -> false
...
let raise uu____1019 = failwith "Not yet implemented:raise"
...
type ('Aheap,'Aa,'Ax,'Ap,'Auu____1160) all_return = 'Ap
...
let allow_inversion = ()
let invertOption uu____1551 = ()
type ('a,'b) either =
  | Inl of 'a
  | Inr of 'b
let uu___is_Inl projectee =
  match projectee with | Inl v -> true | uu____1597 -> false
let __proj__Inl__item__v projectee = match projectee with | Inl v -> v
let uu___is_Inr projectee =
  match projectee with | Inr v -> true | uu____1647 -> false
...
let uu___is_PpxDerivingShow: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  ->
    match projectee with | PpxDerivingShow  -> true | uu____2267 -> false
