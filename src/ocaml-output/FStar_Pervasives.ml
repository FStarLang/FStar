...
type st_wp_h = unit
type 'p st_return = 'p
type 'wp1 st_bind_wp = 'wp1
type st_if_then_else = unit
type st_ite_wp = unit
type st_stronger = unit
type st_close_wp = unit
type st_trivial = unit
type 'a result =
  | V of 'a 
  | E of Prims.exn 
  | Err of Prims.string 
...
type ex_wp = unit
type 'p ex_return = 'p
type ex_bind_wp = unit
type ex_if_then_else = unit
type ex_ite_wp = unit
type ex_stronger = unit
type ex_close_wp = unit
type 'wp ex_trivial = 'wp
type 'wp lift_div_exn = 'wp
type all_pre_h = unit
type all_post_h' = unit
type all_post_h = unit
type all_wp_h = unit
type 'p all_return = 'p
type 'wp1 all_bind_wp = 'wp1
type all_if_then_else = unit
type all_ite_wp = unit
...
let uu___is_Inr : 'a 'b . ('a, 'b) either -> Prims.bool =
  fun projectee -> match projectee with | Inr v -> true | uu____1034 -> false
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Simpl -> true | uu____1929 -> false
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Weak -> true | uu____1940 -> false
...
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Delta -> true | uu____1973 -> false
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Zeta -> true | uu____1984 -> false
let (uu___is_ZetaFull : norm_step -> Prims.bool) =
  fun projectee ->
    match projectee with | ZetaFull -> true | uu____1995 -> false
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Iota -> true | uu____2006 -> false
let (uu___is_NBE : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | NBE -> true | uu____2017 -> false
let (uu___is_Reify : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Reify -> true | uu____2028 -> false
...
let singleton : 'uuuuuu2199 . 'uuuuuu2199 -> 'uuuuuu2199 = fun x -> x
let with_type : 'uuuuuu2210 . 'uuuuuu2210 -> 'uuuuuu2210 = fun e -> e