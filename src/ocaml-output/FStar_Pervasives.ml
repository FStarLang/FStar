...
type ('Aheap,'Aa,'Ax,'Ap,'Auu___38_85) st_return = 'Ap[@@deriving show]
...
type ('Aheap,'Aa,'Ax,'Ap,'Auu___40_1290) all_return = 'Ap[@@deriving show]
...
let uu___is_PpxDerivingShow: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  ->
    match projectee with | PpxDerivingShow  -> true | uu____2368 -> false
...
let uu___is_CInline: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  ->
    match projectee with | CInline  -> true | uu____2384 -> false
let uu___is_Substitute: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  ->
    match projectee with | Substitute  -> true | uu____2388 -> false
let uu___is_Gc: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  -> match projectee with | Gc  -> true | uu____2392 -> false
let uu___is_Comment: __internal_ocaml_attributes -> Prims.bool =
  fun projectee  ->
    match projectee with | Comment _0 -> true | uu____2397 -> false
