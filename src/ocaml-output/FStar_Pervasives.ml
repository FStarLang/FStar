...
let invertOption : 'Auu____933 . unit -> unit = fun uu____934  -> () 
type ('Aa,'Ab) either =
  | Inl of 'Aa 
  | Inr of 'Ab 
let uu___is_Inl : 'Aa 'Ab . ('Aa,'Ab) either -> Prims.bool =
  fun projectee  -> match projectee with | Inl v -> true | uu____984 -> false 
...
let uu___is_Inr : 'Aa 'Ab . ('Aa,'Ab) either -> Prims.bool =
  fun projectee  ->
    match projectee with | Inr v -> true | uu____1038 -> false
...
let rec false_elim : 'Auu____1603 . unit -> 'Auu____1603 =
  fun uu____1608  -> false_elim () 
...
let (uu___is_PpxDerivingShow : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | PpxDerivingShow  -> true | uu____1654 -> false
...
let (uu___is_PpxDerivingYoJson : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | PpxDerivingYoJson  -> true | uu____1688 -> false
  
let (uu___is_CInline : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CInline  -> true | uu____1699 -> false
  
let (uu___is_Substitute : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | Substitute  -> true | uu____1710 -> false
  
let (uu___is_Gc : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  -> match projectee with | Gc  -> true | uu____1721 -> false 
let (uu___is_Comment : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comment _0 -> true | uu____1734 -> false
...
let (uu___is_CPrologue : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CPrologue _0 -> true | uu____1757 -> false
...
let (uu___is_CEpilogue : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CEpilogue _0 -> true | uu____1780 -> false
...
let (uu___is_CCConv : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CCConv _0 -> true | uu____1826 -> false
...
let (uu___is_CAbstractStruct : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CAbstractStruct  -> true | uu____1847 -> false
  
let (uu___is_CIfDef : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CIfDef  -> true | uu____1858 -> false
  
let (uu___is_CMacro : __internal_ocaml_attributes -> Prims.bool) =
  fun projectee  ->
    match projectee with | CMacro  -> true | uu____1869 -> false
...
let normalize_term : 'Auu____1890 . 'Auu____1890 -> 'Auu____1890 =
  fun x  -> x 
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Simpl  -> true | uu____1933 -> false
  
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Weak  -> true | uu____1944 -> false
  
let (uu___is_HNF : norm_step -> Prims.bool) =
  fun projectee  -> match projectee with | HNF  -> true | uu____1955 -> false 
let (uu___is_Primops : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primops  -> true | uu____1966 -> false
  
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Delta  -> true | uu____1977 -> false
...
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Iota  -> true | uu____1999 -> false
  
let (uu___is_NBE : norm_step -> Prims.bool) =
  fun projectee  -> match projectee with | NBE  -> true | uu____2010 -> false 
let (uu___is_Reify : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reify  -> true | uu____2021 -> false
  
let (uu___is_UnfoldOnly : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldOnly _0 -> true | uu____2036 -> false
  
let (__proj__UnfoldOnly__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldOnly _0 -> _0 
let (uu___is_UnfoldFully : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldFully _0 -> true | uu____2067 -> false
  
let (__proj__UnfoldFully__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldFully _0 -> _0 
let (uu___is_UnfoldAttr : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldAttr _0 -> true | uu____2098 -> false
...
let (norm : norm_step Prims.list -> unit -> Obj.t -> Obj.t) =
  fun uu____2176  -> fun uu____2177  -> fun x  -> x 

let normalize_term_spec : 'Auu____2187 . 'Auu____2187 -> unit =
  fun uu____2193  -> () 
let normalize_spec : 'Auu____2197 . unit -> unit = fun uu____2198  -> () 
let (norm_spec : norm_step Prims.list -> unit -> Obj.t -> unit) =
  fun uu____2215  -> fun uu____2216  -> fun uu____2217  -> () 
let (reveal_opaque : Prims.string -> unit -> Obj.t -> unit) =
  fun s  -> norm_spec [delta_only [s]] 
let singleton : 'Auu____2246 . 'Auu____2246 -> 'Auu____2246 = fun x  -> x 
let with_type : 'Auu____2257 . 'Auu____2257 -> 'Auu____2257 = fun e  -> e 
