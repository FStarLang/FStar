...
let raise uu____733 = failwith "Not yet implemented:raise"
...
type ('Aheap,'Aa,'Ax,'Ap,'Auu____841) all_return = 'Ap
...
let uu___is_Inl projectee =
  match projectee with | Inl v -> true | uu____1146 -> false
let __proj__Inl__item__v projectee = match projectee with | Inl v -> v
let uu___is_Inr projectee =
  match projectee with | Inr v -> true | uu____1186 -> false
