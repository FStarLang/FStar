...
let uu___is_Err: 'Aa. 'Aa result -> Prims.bool =
  fun projectee -> match projectee with Err msg -> true | uu____662 -> false
...
type ('a, 'b) either = Inl of 'a | Inr of 'b [@@deriving show]
...
type ('Aa, 'Ab, 'Ac) dtuple3 = Mkdtuple3 of 'Aa * 'Ab * 'Ac [@@deriving show]
...
let uu___is_PpxDerivingShowConstant : __internal_ocaml_attributes -> Prims.bool =
  fun projectee ->
...
let uu___is_CInline : __internal_ocaml_attributes -> Prims.bool =
  fun projectee -> match projectee with CInline -> true | uu____2362 -> false
