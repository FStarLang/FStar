...
let uu___is_V: 'Aa . 'Aa result -> Prims.bool =
  fun projectee  -> match projectee with | V v -> true | uu____354 -> false
...
let raise: 'a . Prims.exn -> 'a =
  fun uu____661  -> failwith "Not yet implemented:raise"
...
let invertOption: 'Aa . Prims.unit -> Prims.unit = fun uu____998  -> ()
type ('a,'b) either =
  | Inl of 'a
  | Inr of 'b
