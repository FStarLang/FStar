...
| Array ((s1, s2)) -> begin
(let _65_20273 = (strSort s1)
in (let _65_20272 = (strSort s2)
in (Support.Microsoft.FStar.Util.format2 "(Array %s %s)" _65_20273 _65_20272)))
end
| Arrow ((s1, s2)) -> begin
(let _65_20275 = (strSort s1)
in (let _65_20274 = (strSort s2)
in (Support.Microsoft.FStar.Util.format2 "(%s -> %s)" _65_20275 _65_20274)))
end
| Sort (s) -> begin
s
end))
...
| None -> begin
(let fvs = (let _65_20366 = (freevars t)
in (Support.Microsoft.FStar.Util.remove_dups fv_eq _65_20366))
...
| Some (i) -> begin
(let _65_20373 = (Support.Microsoft.FStar.Util.string_of_int i)
...
| BoundV (i) -> begin
(let _65_20376 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.String.strcat "@" _65_20376))
end
| FreeV (x) -> begin
(let _65_20377 = (strSort (Support.Prims.snd x))
in (Support.String.strcat (Support.String.strcat (Support.Prims.fst x) ":") _65_20377))
end
| App ((op, tms)) -> begin
(let _65_20381 = (let _65_20380 = (let _65_20379 = (Support.List.map (fun ( t ) -> t.hash) tms)
in (Support.Prims.pipe_right _65_20379 (Support.String.concat " ")))
in (Support.String.strcat (Support.String.strcat "(" (op_to_string op)) _65_20380))
in (Support.String.strcat _65_20381 ")"))
end
| Quant ((qop, pats, wopt, sorts, body)) -> begin
(let _65_20389 = (let _65_20382 = (Support.List.map strSort sorts)
in (Support.Prims.pipe_right _65_20382 (Support.String.concat " ")))
in (let _65_20388 = (weightToSmt wopt)
in (let _65_20387 = (let _65_20386 = (Support.Prims.pipe_right pats (Support.List.map (fun ( pats ) -> (let _65_20385 = (Support.List.map (fun ( p ) -> p.hash) pats)
in (Support.Prims.pipe_right _65_20385 (Support.String.concat " "))))))
in (Support.Prims.pipe_right _65_20386 (Support.String.concat "; ")))
in (Support.Microsoft.FStar.Util.format5 "(%s (%s)(! %s %s %s))" (qop_to_string qop) _65_20389 body.hash _65_20388 _65_20387))))
end))

let all_terms_l = (let _65_20391 = (let _65_20390 = (Support.Microsoft.FStar.Util.smap_create 10000)
in (_65_20390)::[])
in (ref _65_20391))

let all_terms = (fun ( _47_163 ) -> (match (()) with
| () -> begin
(let _65_20394 = (Support.ST.read all_terms_l)
in (Support.List.hd _65_20394))
end))
...
in (match ((let _65_20403 = (all_terms ())
in (Support.Microsoft.FStar.Util.smap_try_find _65_20403 key))) with
| Some (tm) -> begin
tm
end
| None -> begin
(let tm = (let _65_20404 = (Support.Microsoft.FStar.Util.mk_ref None)
in {tm = t; hash = key; freevars = _65_20404})
in (let _47_173 = (let _65_20405 = (all_terms ())
in (Support.Microsoft.FStar.Util.smap_add _65_20405 key tm))
in tm))
end)))
...
let mkInteger' = (fun ( i ) -> (let _65_20410 = (Support.Microsoft.FStar.Util.string_of_int i)
in (mkInteger _65_20410)))
...
(let _65_20429 = (let _65_20428 = (let _65_20427 = (mkAnd (t1, t1'))
in (_65_20427)::(t2')::[])
in (Imp, _65_20428))
in (mkApp' _65_20429))
end
...
| (App ((True, _)), _) -> begin
(let _65_20450 = (let _65_20449 = (mkNot t1)
in (_65_20449, t3))
in (mkImp _65_20450))
end
| (_, App ((True, _))) -> begin
...
| App ((op, tms)) -> begin
(let _65_20468 = (let _65_20467 = (Support.List.map (aux ix) tms)
in (op, _65_20467))
in (mkApp' _65_20468))
end
| Quant ((qop, pats, wopt, vars, body)) -> begin
(let n = (Support.List.length vars)
in (let _65_20471 = (let _65_20470 = (Support.Prims.pipe_right pats (Support.List.map (Support.List.map (aux (ix + n)))))
in (let _65_20469 = (aux (ix + n) body)
in (qop, _65_20470, wopt, vars, _65_20469)))
in (mkQuant _65_20471)))
end)
end))
in (aux 0 t)))))
...
| App ((op, tms)) -> begin
(let _65_20481 = (let _65_20480 = (Support.List.map (aux shift) tms)
in (op, _65_20480))
in (mkApp' _65_20481))
end
| Quant ((qop, pats, wopt, vars, body)) -> begin
...
in (let _65_20484 = (let _65_20483 = (Support.Prims.pipe_right pats (Support.List.map (Support.List.map (aux shift))))
in (let _65_20482 = (aux shift body)
in (qop, _65_20483, wopt, vars, _65_20482)))
...
| (qop, pats, wopt, vars, body) -> begin
(let _65_20490 = (let _65_20489 = (Support.Prims.pipe_right pats (Support.List.map (Support.List.map (abstr vars))))
in (let _65_20488 = (Support.List.map fv_sort vars)
in (let _65_20487 = (abstr vars body)
in (qop, _65_20489, wopt, _65_20488, _65_20487))))
...
(let _65_20549 = (let _65_20548 = (Support.List.map fv_sort vars)
in (let _65_20547 = (abstr vars tm)
in (nm, _65_20548, s, _65_20547, c)))
in DefineFun (_65_20549))
end))

let constr_id_of_sort = (fun ( sort ) -> (let _65_20552 = (strSort sort)
in (Support.Microsoft.FStar.Util.format1 "%s_constr_id" _65_20552)))

let fresh_token = (fun ( _47_517 ) ( id ) -> (match (_47_517) with
| (tok_name, sort) -> begin
(let _65_20565 = (let _65_20564 = (let _65_20563 = (let _65_20562 = (mkInteger' id)
in (let _65_20561 = (let _65_20560 = (let _65_20559 = (constr_id_of_sort sort)
in (let _65_20558 = (let _65_20557 = (mkApp (tok_name, []))
in (_65_20557)::[])
in (_65_20559, _65_20558)))
in (mkApp _65_20560))
in (_65_20562, _65_20561)))
in (mkEq _65_20563))
in (_65_20564, Some ("fresh token")))
in Assume (_65_20565))
end))
...
in (let cdecl = (let _65_20569 = (let _65_20568 = (Support.Prims.pipe_right projectors (Support.List.map Support.Prims.snd))
in (name, _65_20568, sort, Some ("Constructor")))
in DeclFun (_65_20569))
in (let n_bvars = (Support.List.length projectors)
in (let bvar_name = (fun ( i ) -> (let _65_20572 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.String.strcat "x_" _65_20572)))
in (let bvar_index = (fun ( i ) -> (n_bvars - (i + 1)))
in (let bvar = (fun ( i ) ( s ) -> (let _65_20580 = (let _65_20579 = (bvar_name i)
in (_65_20579, s))
in (mkFreeV _65_20580)))
...
in (let cid_app = (let _65_20584 = (let _65_20583 = (constr_id_of_sort sort)
in (_65_20583, (capp)::[]))
in (mkApp _65_20584))
in (let cid = (let _65_20590 = (let _65_20589 = (let _65_20588 = (let _65_20587 = (let _65_20586 = (let _65_20585 = (mkInteger id)
in (_65_20585, cid_app))
in (mkEq _65_20586))
in ([], bvar_names, _65_20587))
in (mkForall _65_20588))
in (_65_20589, Some ("Constructor distinct")))
in Assume (_65_20590))
in (let disc_name = (Support.String.strcat "is-" name)
in (let xfv = ("x", sort)
in (let xx = (mkFreeV xfv)
in (let disc_eq = (let _65_20595 = (let _65_20594 = (let _65_20592 = (let _65_20591 = (constr_id_of_sort sort)
in (_65_20591, (xx)::[]))
in (mkApp _65_20592))
in (let _65_20593 = (mkInteger id)
in (_65_20594, _65_20593)))
in (mkEq _65_20595))
in (let proj_terms = (Support.Prims.pipe_right projectors (Support.List.map (fun ( _47_550 ) -> (match (_47_550) with
| (proj, s) -> begin
(mkApp (proj, (xx)::[]))
end))))
in (let disc_inv_body = (let _65_20598 = (let _65_20597 = (mkApp (name, proj_terms))
in (xx, _65_20597))
in (mkEq _65_20598))
...
in (let projs = (let _65_20609 = (Support.Prims.pipe_right projectors (Support.List.mapi (fun ( i ) ( _47_558 ) -> (match (_47_558) with
| (name, s) -> begin
(let cproj_app = (mkApp (name, (capp)::[]))
in (let _65_20608 = (let _65_20607 = (let _65_20606 = (let _65_20605 = (let _65_20604 = (let _65_20603 = (let _65_20602 = (let _65_20601 = (bvar i s)
in (cproj_app, _65_20601))
in (mkEq _65_20602))
in ((capp)::[], bvar_names, _65_20603))
in (mkForall _65_20604))
in (_65_20605, Some ("Projection inverse")))
in Assume (_65_20606))
in (_65_20607)::[])
in (DeclFun ((name, (sort)::[], s, Some ("Projector"))))::_65_20608))
end))))
in (Support.Prims.pipe_right _65_20609 Support.List.flatten))
in (let _65_20616 = (let _65_20612 = (let _65_20611 = (let _65_20610 = (Support.Microsoft.FStar.Util.format1 "<start constructor %s>" name)
in Caption (_65_20610))
in (_65_20611)::(cdecl)::(cid)::projs)
in (Support.List.append _65_20612 ((disc)::[])))
in (let _65_20615 = (let _65_20614 = (let _65_20613 = (Support.Microsoft.FStar.Util.format1 "</end constructor %s>" name)
in Caption (_65_20613))
in (_65_20614)::[])
in (Support.List.append _65_20616 _65_20615)))))))))))))))))))))))
end))
...
in (let nm = (let _65_20625 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.String.strcat prefix _65_20625))
in (let names = ((nm, s))::names
in (let b = (let _65_20626 = (strSort s)
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" nm _65_20626))
...
| BoundV (i) -> begin
(let _65_20637 = (Support.List.nth names i)
in (Support.Prims.pipe_right _65_20637 Support.Prims.fst))
end
| FreeV (x) -> begin
(Support.Prims.fst x)
end
...
| App ((op, tms)) -> begin
(let _65_20639 = (let _65_20638 = (Support.List.map (aux n names) tms)
in (Support.Prims.pipe_right _65_20638 (Support.String.concat "\n")))
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" (op_to_string op) _65_20639))
end
| Quant ((qop, pats, wopt, sorts, body)) -> begin
...
| _ -> begin
(let _65_20645 = (Support.Prims.pipe_right pats (Support.List.map (fun ( pats ) -> (let _65_20644 = (let _65_20643 = (Support.List.map (fun ( p ) -> (let _65_20642 = (aux n names p)
in (Support.Microsoft.FStar.Util.format1 "%s" _65_20642))) pats)
in (Support.String.concat " " _65_20643))
in (Support.Microsoft.FStar.Util.format1 "\n:pattern (%s)" _65_20644)))))
in (Support.Prims.pipe_right _65_20645 (Support.String.concat "\n")))
end)
in (match ((pats, wopt)) with
| (([]::[], None)) | (([], None)) -> begin
(let _65_20646 = (aux n names body)
in (Support.Microsoft.FStar.Util.format3 "(%s (%s)\n %s)" (qop_to_string qop) binders _65_20646))
end
| _ -> begin
(let _65_20648 = (aux n names body)
in (let _65_20647 = (weightToSmt wopt)
in (Support.Microsoft.FStar.Util.format5 "(%s (%s)\n (! %s\n %s %s))" (qop_to_string qop) binders _65_20648 _65_20647 pats_str)))
end)))
end))
end))
in (aux 0 [] t)))
...
| Caption (c) -> begin
(let _65_20657 = (Support.Prims.pipe_right (Support.Microsoft.FStar.Util.splitlines c) (fun ( _47_7 ) -> (match (_47_7) with
| [] -> begin
""
end
| h::t -> begin
...
in (let _65_20659 = (caption_to_string c)
in (let _65_20658 = (strSort retsort)
in (Support.Microsoft.FStar.Util.format4 "%s(declare-fun %s (%s) %s)" _65_20659 f (Support.String.concat " " l) _65_20658))))
end
| DefineFun ((f, arg_sorts, retsort, body, c)) -> begin
(let _47_671 = (name_binders arg_sorts)
in (match (_47_671) with
| (names, binders) -> begin
(let body = (let _65_20660 = (Support.List.map mkFreeV names)
in (inst _65_20660 body))
in (let _65_20663 = (caption_to_string c)
in (let _65_20662 = (strSort retsort)
in (let _65_20661 = (termToSmt body)
in (Support.Microsoft.FStar.Util.format5 "%s(define-fun %s (%s) %s\n %s)" _65_20663 f (Support.String.concat " " binders) _65_20662 _65_20661)))))
end))
end
| Assume ((t, c)) -> begin
(let _65_20665 = (caption_to_string c)
in (let _65_20664 = (termToSmt t)
in (Support.Microsoft.FStar.Util.format2 "%s(assert %s)" _65_20665 _65_20664)))
end
| Eval (t) -> begin
(let _65_20666 = (termToSmt t)
in (Support.Microsoft.FStar.Util.format1 "(eval %s)" _65_20666))
end
| Echo (s) -> begin
...
in (let bcons = (let _65_20669 = (let _65_20668 = (Support.Prims.pipe_right constrs (Support.List.collect constructor_to_decl))
in (Support.Prims.pipe_right _65_20668 (Support.List.map (declToSmt z3options))))
in (Support.Prims.pipe_right _65_20669 (Support.String.concat "\n")))
...
let mk_Kind_uvar = (fun ( i ) -> (let _65_20674 = (let _65_20673 = (let _65_20672 = (mkInteger' i)
in (_65_20672)::[])
in ("Kind_uvar", _65_20673))
in (mkApp _65_20674)))
...
let mk_Typ_uvar = (fun ( i ) -> (let _65_20687 = (let _65_20686 = (let _65_20685 = (mkInteger' i)
in (_65_20685)::[])
in ("Typ_uvar", _65_20686))
in (mkApp _65_20687)))

let mk_Exp_uvar = (fun ( i ) -> (let _65_20692 = (let _65_20691 = (let _65_20690 = (mkInteger' i)
in (_65_20690)::[])
in ("Exp_uvar", _65_20691))
in (mkApp _65_20692)))
...
let mk_String_const = (fun ( i ) -> (let _65_20777 = (let _65_20776 = (let _65_20775 = (mkInteger' i)
in (_65_20775)::[])
in ("String_const", _65_20776))
in (mkApp _65_20777)))

let mk_Precedes = (fun ( x1 ) ( x2 ) -> (let _65_20782 = (mkApp ("Precedes", (x1)::(x2)::[]))
in (Support.Prims.pipe_right _65_20782 mk_Valid)))
...
| false -> begin
(let _65_20791 = (let _65_20790 = (let _65_20789 = (n_fuel (n - 1))
in (_65_20789)::[])
in ("SFuel", _65_20790))
in (mkApp _65_20791))
end))
...
| BoundV (n) -> begin
(let _65_20813 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "BoundV %s" _65_20813))
end
| FreeV (fv) -> begin
(Support.Microsoft.FStar.Util.format1 "FreeV %s" (Support.Prims.fst fv))
end
| App ((op, l)) -> begin
(let _65_20814 = (print_smt_term_list l)
in (Support.Microsoft.FStar.Util.format2 "App %s [ %s ]" (op_to_string op) _65_20814))
end
| Quant ((qop, l, _, _, t)) -> begin
(let _65_20816 = (print_smt_term_list_list l)
in (let _65_20815 = (print_smt_term t)
in (Support.Microsoft.FStar.Util.format3 "Quant %s %s %s" (qop_to_string qop) _65_20816 _65_20815)))
end))
and print_smt_term_list = (fun ( l ) -> (Support.List.fold_left (fun ( s ) ( t ) -> (let _65_20820 = (print_smt_term t)
in (Support.String.strcat (Support.String.strcat s "; ") _65_20820))) "" l))
and print_smt_term_list_list = (fun ( l ) -> (Support.List.fold_left (fun ( s ) ( l ) -> (let _65_20825 = (let _65_20824 = (print_smt_term_list l)
in (Support.String.strcat (Support.String.strcat s "; [ ") _65_20824))
in (Support.String.strcat _65_20825 " ] "))) "" l))
