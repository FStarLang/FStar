...
| Array ((s1, s2)) -> begin
(let _70_20430 = (strSort s1)
in (let _70_20429 = (strSort s2)
in (Support.Microsoft.FStar.Util.format2 "(Array %s %s)" _70_20430 _70_20429)))
end
| Arrow ((s1, s2)) -> begin
(let _70_20432 = (strSort s1)
in (let _70_20431 = (strSort s2)
in (Support.Microsoft.FStar.Util.format2 "(%s -> %s)" _70_20432 _70_20431)))
end
| Sort (s) -> begin
s
end))
...
| None -> begin
(let fvs = (let _70_20523 = (freevars t)
in (Support.Microsoft.FStar.Util.remove_dups fv_eq _70_20523))
...
| Some (i) -> begin
(let _70_20530 = (Support.Microsoft.FStar.Util.string_of_int i)
...
| BoundV (i) -> begin
(let _70_20533 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.String.strcat "@" _70_20533))
end
| FreeV (x) -> begin
(let _70_20534 = (strSort (Support.Prims.snd x))
in (Support.String.strcat (Support.String.strcat (Support.Prims.fst x) ":") _70_20534))
end
| App ((op, tms)) -> begin
(let _70_20538 = (let _70_20537 = (let _70_20536 = (Support.List.map (fun ( t ) -> t.hash) tms)
in (Support.All.pipe_right _70_20536 (Support.String.concat " ")))
in (Support.String.strcat (Support.String.strcat "(" (op_to_string op)) _70_20537))
in (Support.String.strcat _70_20538 ")"))
end
| Quant ((qop, pats, wopt, sorts, body)) -> begin
(let _70_20546 = (let _70_20539 = (Support.List.map strSort sorts)
in (Support.All.pipe_right _70_20539 (Support.String.concat " ")))
in (let _70_20545 = (weightToSmt wopt)
in (let _70_20544 = (let _70_20543 = (Support.All.pipe_right pats (Support.List.map (fun ( pats ) -> (let _70_20542 = (Support.List.map (fun ( p ) -> p.hash) pats)
in (Support.All.pipe_right _70_20542 (Support.String.concat " "))))))
in (Support.All.pipe_right _70_20543 (Support.String.concat "; ")))
in (Support.Microsoft.FStar.Util.format5 "(%s (%s)(! %s %s %s))" (qop_to_string qop) _70_20546 body.hash _70_20545 _70_20544))))
end))

let all_terms_l = (let _70_20548 = (let _70_20547 = (Support.Microsoft.FStar.Util.smap_create 10000)
in (_70_20547)::[])
in (ref _70_20548))

let all_terms = (fun ( _49_163 ) -> (match (()) with
| () -> begin
(let _70_20551 = (Support.ST.read all_terms_l)
in (Support.List.hd _70_20551))
end))
...
in (match ((let _70_20560 = (all_terms ())
in (Support.Microsoft.FStar.Util.smap_try_find _70_20560 key))) with
| Some (tm) -> begin
tm
end
| None -> begin
(let tm = (let _70_20561 = (Support.Microsoft.FStar.Util.mk_ref None)
in {tm = t; hash = key; freevars = _70_20561})
in (let _49_173 = (let _70_20562 = (all_terms ())
in (Support.Microsoft.FStar.Util.smap_add _70_20562 key tm))
in tm))
end)))
...
let mkInteger' = (fun ( i ) -> (let _70_20567 = (Support.Microsoft.FStar.Util.string_of_int i)
in (mkInteger _70_20567)))
...
(let _70_20586 = (let _70_20585 = (let _70_20584 = (mkAnd (t1, t1'))
in (_70_20584)::(t2')::[])
in (Imp, _70_20585))
in (mkApp' _70_20586))
end
...
(let _70_20607 = (let _70_20606 = (mkNot t1)
in (_70_20606, t3))
in (mkImp _70_20607))
end
...
| App ((op, tms)) -> begin
(let _70_20625 = (let _70_20624 = (Support.List.map (aux ix) tms)
in (op, _70_20624))
in (mkApp' _70_20625))
end
| Quant ((qop, pats, wopt, vars, body)) -> begin
(let n = (Support.List.length vars)
in (let _70_20628 = (let _70_20627 = (Support.All.pipe_right pats (Support.List.map (Support.List.map (aux (ix + n)))))
in (let _70_20626 = (aux (ix + n) body)
in (qop, _70_20627, wopt, vars, _70_20626)))
in (mkQuant _70_20628)))
end)
end))
in (aux 0 t)))))
...
| App ((op, tms)) -> begin
(let _70_20638 = (let _70_20637 = (Support.List.map (aux shift) tms)
in (op, _70_20637))
in (mkApp' _70_20638))
end
| Quant ((qop, pats, wopt, vars, body)) -> begin
...
in (let _70_20641 = (let _70_20640 = (Support.All.pipe_right pats (Support.List.map (Support.List.map (aux shift))))
in (let _70_20639 = (aux shift body)
in (qop, _70_20640, wopt, vars, _70_20639)))
in (mkQuant _70_20641))))
end))
in (aux 0 t))))

let mkQuant' = (fun ( _49_477 ) -> (match (_49_477) with
| (qop, pats, wopt, vars, body) -> begin
(let _70_20647 = (let _70_20646 = (Support.All.pipe_right pats (Support.List.map (Support.List.map (abstr vars))))
in (let _70_20645 = (Support.List.map fv_sort vars)
in (let _70_20644 = (abstr vars body)
in (qop, _70_20646, wopt, _70_20645, _70_20644))))
in (mkQuant _70_20647))
end))
...
(let _70_20706 = (let _70_20705 = (Support.List.map fv_sort vars)
in (let _70_20704 = (abstr vars tm)
in (nm, _70_20705, s, _70_20704, c)))
in DefineFun (_70_20706))
end))

let constr_id_of_sort = (fun ( sort ) -> (let _70_20709 = (strSort sort)
in (Support.Microsoft.FStar.Util.format1 "%s_constr_id" _70_20709)))

let fresh_token = (fun ( _49_517 ) ( id ) -> (match (_49_517) with
| (tok_name, sort) -> begin
(let _70_20722 = (let _70_20721 = (let _70_20720 = (let _70_20719 = (mkInteger' id)
in (let _70_20718 = (let _70_20717 = (let _70_20716 = (constr_id_of_sort sort)
in (let _70_20715 = (let _70_20714 = (mkApp (tok_name, []))
in (_70_20714)::[])
in (_70_20716, _70_20715)))
in (mkApp _70_20717))
in (_70_20719, _70_20718)))
in (mkEq _70_20720))
in (_70_20721, Some ("fresh token")))
in Assume (_70_20722))
end))
...
in (let cdecl = (let _70_20726 = (let _70_20725 = (Support.All.pipe_right projectors (Support.List.map Support.Prims.snd))
in (name, _70_20725, sort, Some ("Constructor")))
in DeclFun (_70_20726))
in (let n_bvars = (Support.List.length projectors)
in (let bvar_name = (fun ( i ) -> (let _70_20729 = (Support.Microsoft.FStar.Util.string_of_int i)
in (Support.String.strcat "x_" _70_20729)))
in (let bvar_index = (fun ( i ) -> (n_bvars - (i + 1)))
in (let bvar = (fun ( i ) ( s ) -> (let _70_20737 = (let _70_20736 = (bvar_name i)
in (_70_20736, s))
in (mkFreeV _70_20737)))
...
in (let cid_app = (let _70_20741 = (let _70_20740 = (constr_id_of_sort sort)
in (_70_20740, (capp)::[]))
in (mkApp _70_20741))
in (let cid = (let _70_20747 = (let _70_20746 = (let _70_20745 = (let _70_20744 = (let _70_20743 = (let _70_20742 = (mkInteger id)
in (_70_20742, cid_app))
in (mkEq _70_20743))
in ([], bvar_names, _70_20744))
in (mkForall _70_20745))
in (_70_20746, Some ("Constructor distinct")))
in Assume (_70_20747))
in (let disc_name = (Support.String.strcat "is-" name)
in (let xfv = ("x", sort)
in (let xx = (mkFreeV xfv)
in (let disc_eq = (let _70_20752 = (let _70_20751 = (let _70_20749 = (let _70_20748 = (constr_id_of_sort sort)
in (_70_20748, (xx)::[]))
in (mkApp _70_20749))
in (let _70_20750 = (mkInteger id)
in (_70_20751, _70_20750)))
in (mkEq _70_20752))
in (let proj_terms = (Support.All.pipe_right projectors (Support.List.map (fun ( _49_550 ) -> (match (_49_550) with
| (proj, s) -> begin
(mkApp (proj, (xx)::[]))
end))))
in (let disc_inv_body = (let _70_20755 = (let _70_20754 = (mkApp (name, proj_terms))
in (xx, _70_20754))
in (mkEq _70_20755))
...
in (let projs = (let _70_20766 = (Support.All.pipe_right projectors (Support.List.mapi (fun ( i ) ( _49_558 ) -> (match (_49_558) with
| (name, s) -> begin
(let cproj_app = (mkApp (name, (capp)::[]))
in (let _70_20765 = (let _70_20764 = (let _70_20763 = (let _70_20762 = (let _70_20761 = (let _70_20760 = (let _70_20759 = (let _70_20758 = (bvar i s)
in (cproj_app, _70_20758))
in (mkEq _70_20759))
in ((capp)::[], bvar_names, _70_20760))
in (mkForall _70_20761))
in (_70_20762, Some ("Projection inverse")))
in Assume (_70_20763))
in (_70_20764)::[])
in (DeclFun ((name, (sort)::[], s, Some ("Projector"))))::_70_20765))
end))))
in (Support.All.pipe_right _70_20766 Support.List.flatten))
in (let _70_20773 = (let _70_20769 = (let _70_20768 = (let _70_20767 = (Support.Microsoft.FStar.Util.format1 "<start constructor %s>" name)
in Caption (_70_20767))
in (_70_20768)::(cdecl)::(cid)::projs)
in (Support.List.append _70_20769 ((disc)::[])))
in (let _70_20772 = (let _70_20771 = (let _70_20770 = (Support.Microsoft.FStar.Util.format1 "</end constructor %s>" name)
in Caption (_70_20770))
in (_70_20771)::[])
in (Support.List.append _70_20773 _70_20772)))))))))))))))))))))))
end))
...
in (let nm = (let _70_20782 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.String.strcat prefix _70_20782))
in (let names = ((nm, s))::names
in (let b = (let _70_20783 = (strSort s)
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" nm _70_20783))
...
| BoundV (i) -> begin
(let _70_20794 = (Support.List.nth names i)
in (Support.All.pipe_right _70_20794 Support.Prims.fst))
end
| FreeV (x) -> begin
(Support.Prims.fst x)
end
...
| App ((op, tms)) -> begin
(let _70_20796 = (let _70_20795 = (Support.List.map (aux n names) tms)
in (Support.All.pipe_right _70_20795 (Support.String.concat "\n")))
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" (op_to_string op) _70_20796))
end
| Quant ((qop, pats, wopt, sorts, body)) -> begin
...
| _49_621 -> begin
(let _70_20802 = (Support.All.pipe_right pats (Support.List.map (fun ( pats ) -> (let _70_20801 = (let _70_20800 = (Support.List.map (fun ( p ) -> (let _70_20799 = (aux n names p)
in (Support.Microsoft.FStar.Util.format1 "%s" _70_20799))) pats)
in (Support.String.concat " " _70_20800))
in (Support.Microsoft.FStar.Util.format1 "\n:pattern (%s)" _70_20801)))))
in (Support.All.pipe_right _70_20802 (Support.String.concat "\n")))
end)
in (match ((pats, wopt)) with
| (([]::[], None)) | (([], None)) -> begin
(let _70_20803 = (aux n names body)
in (Support.Microsoft.FStar.Util.format3 "(%s (%s)\n %s)" (qop_to_string qop) binders _70_20803))
end
| _49_633 -> begin
(let _70_20805 = (aux n names body)
in (let _70_20804 = (weightToSmt wopt)
in (Support.Microsoft.FStar.Util.format5 "(%s (%s)\n (! %s\n %s %s))" (qop_to_string qop) binders _70_20805 _70_20804 pats_str)))
end)))
end))
end))
in (aux 0 [] t)))
...
| Caption (c) -> begin
(let _70_20814 = (Support.All.pipe_right (Support.Microsoft.FStar.Util.splitlines c) (fun ( _49_7 ) -> (match (_49_7) with
| [] -> begin
""
end
| h::t -> begin
...
in (let _70_20816 = (caption_to_string c)
in (let _70_20815 = (strSort retsort)
in (Support.Microsoft.FStar.Util.format4 "%s(declare-fun %s (%s) %s)" _70_20816 f (Support.String.concat " " l) _70_20815))))
end
| DefineFun ((f, arg_sorts, retsort, body, c)) -> begin
(let _49_671 = (name_binders arg_sorts)
in (match (_49_671) with
| (names, binders) -> begin
(let body = (let _70_20817 = (Support.List.map mkFreeV names)
in (inst _70_20817 body))
in (let _70_20820 = (caption_to_string c)
in (let _70_20819 = (strSort retsort)
in (let _70_20818 = (termToSmt body)
in (Support.Microsoft.FStar.Util.format5 "%s(define-fun %s (%s) %s\n %s)" _70_20820 f (Support.String.concat " " binders) _70_20819 _70_20818)))))
end))
end
| Assume ((t, c)) -> begin
(let _70_20822 = (caption_to_string c)
in (let _70_20821 = (termToSmt t)
in (Support.Microsoft.FStar.Util.format2 "%s(assert %s)" _70_20822 _70_20821)))
end
| Eval (t) -> begin
(let _70_20823 = (termToSmt t)
in (Support.Microsoft.FStar.Util.format1 "(eval %s)" _70_20823))
end
| Echo (s) -> begin
...
in (let bcons = (let _70_20826 = (let _70_20825 = (Support.All.pipe_right constrs (Support.List.collect constructor_to_decl))
in (Support.All.pipe_right _70_20825 (Support.List.map (declToSmt z3options))))
in (Support.All.pipe_right _70_20826 (Support.String.concat "\n")))
...
let mk_Kind_uvar = (fun ( i ) -> (let _70_20831 = (let _70_20830 = (let _70_20829 = (mkInteger' i)
in (_70_20829)::[])
in ("Kind_uvar", _70_20830))
in (mkApp _70_20831)))
...
let mk_Typ_uvar = (fun ( i ) -> (let _70_20844 = (let _70_20843 = (let _70_20842 = (mkInteger' i)
in (_70_20842)::[])
in ("Typ_uvar", _70_20843))
in (mkApp _70_20844)))

let mk_Exp_uvar = (fun ( i ) -> (let _70_20849 = (let _70_20848 = (let _70_20847 = (mkInteger' i)
in (_70_20847)::[])
in ("Exp_uvar", _70_20848))
in (mkApp _70_20849)))
...
let mk_String_const = (fun ( i ) -> (let _70_20934 = (let _70_20933 = (let _70_20932 = (mkInteger' i)
in (_70_20932)::[])
in ("String_const", _70_20933))
in (mkApp _70_20934)))

let mk_Precedes = (fun ( x1 ) ( x2 ) -> (let _70_20939 = (mkApp ("Precedes", (x1)::(x2)::[]))
in (Support.All.pipe_right _70_20939 mk_Valid)))
...
| false -> begin
(let _70_20948 = (let _70_20947 = (let _70_20946 = (n_fuel (n - 1))
in (_70_20946)::[])
in ("SFuel", _70_20947))
in (mkApp _70_20948))
end))
...
| BoundV (n) -> begin
(let _70_20970 = (Support.Microsoft.FStar.Util.string_of_int n)
in (Support.Microsoft.FStar.Util.format1 "BoundV %s" _70_20970))
end
| FreeV (fv) -> begin
(Support.Microsoft.FStar.Util.format1 "FreeV %s" (Support.Prims.fst fv))
end
| App ((op, l)) -> begin
(let _70_20971 = (print_smt_term_list l)
in (Support.Microsoft.FStar.Util.format2 "App %s [ %s ]" (op_to_string op) _70_20971))
end
| Quant ((qop, l, _49_805, _49_807, t)) -> begin
(let _70_20973 = (print_smt_term_list_list l)
in (let _70_20972 = (print_smt_term t)
in (Support.Microsoft.FStar.Util.format3 "Quant %s %s %s" (qop_to_string qop) _70_20973 _70_20972)))
end))
and print_smt_term_list = (fun ( l ) -> (Support.List.fold_left (fun ( s ) ( t ) -> (let _70_20977 = (print_smt_term t)
in (Support.String.strcat (Support.String.strcat s "; ") _70_20977))) "" l))
and print_smt_term_list_list = (fun ( l ) -> (Support.List.fold_left (fun ( s ) ( l ) -> (let _70_20982 = (let _70_20981 = (print_smt_term_list l)
in (Support.String.strcat (Support.String.strcat s "; [ ") _70_20981))
in (Support.String.strcat _70_20982 " ] "))) "" l))
