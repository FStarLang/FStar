...
# 132 "FStar.TypeChecker.Util.fst"
...
| (res, check_res) -> begin
(
# 174 "FStar.TypeChecker.Util.fst"
...
in (
# 185 "FStar.TypeChecker.Util.fst"
let _56_164 = (let _148_78 = (t_binders env)
in (aux _148_78 e))
in (match (_56_164) with
| (t, b) -> begin
(
# 186 "FStar.TypeChecker.Util.fst"
let t = (match (t) with
| FStar_Util.Inr (c) -> begin
...
# 196 "FStar.TypeChecker.Util.fst"
...
| (_56_277, t) -> begin
(
# 270 "FStar.TypeChecker.Util.fst"
...
in (
# 291 "FStar.TypeChecker.Util.fst"
...
in (
# 355 "FStar.TypeChecker.Util.fst"
let s = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env y.FStar_Syntax_Syntax.sort)
in (
...
in (
# 375 "FStar.TypeChecker.Util.fst"
let fv = fv'
in (
# 376 "FStar.TypeChecker.Util.fst"
...
(
# 381 "FStar.TypeChecker.Util.fst"
...
| () -> begin
(
# 533 "FStar.TypeChecker.Util.fst"
...
in (
# 544 "FStar.TypeChecker.Util.fst"
...
| Some (reason) -> begin
if (let _148_404 = (FStar_TypeChecker_Env.should_verify env)
...
# 946 "FStar.TypeChecker.Util.fst"
...
# 960 "FStar.TypeChecker.Util.fst"
...
(let _148_829 = (FStar_Range.string_of_range e.FStar_Syntax_Syntax.pos)
in (let _148_828 = (FStar_Syntax_Print.lbname_to_string l)
in (let _148_827 = (FStar_Syntax_Print.term_to_string (FStar_Syntax_Util.comp_result c))
in (let _148_826 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.print4 "(%s) Generalized %s at type %s\n%s\n" _148_829 _148_828 _148_827 _148_826)))))
end else begin
()
end
in ((l), (us), (e), (c)))
...
| Some (f) -> begin
(let _148_845 = (FStar_TypeChecker_Rel.apply_guard f e)
in (FStar_All.pipe_left (fun _148_844 -> Some (_148_844)) _148_845))
end)
end)
in (
# 1074 "FStar.TypeChecker.Util.fst"
let is_var = (fun e -> (match ((let _148_848 = (FStar_Syntax_Subst.compress e)
in _148_848.FStar_Syntax_Syntax.n)) with
...
let _56_1432 = e
in (let _148_853 = (FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)))
in {FStar_Syntax_Syntax.n = _56_1432.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _148_853; FStar_Syntax_Syntax.pos = _56_1432.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1432.FStar_Syntax_Syntax.vars}))
end)))
in (
...
# 1082 "FStar.TypeChecker.Util.fst"
let _56_1434 = env
in (let _148_854 = (env.FStar_TypeChecker_Env.use_eq || (env.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = _56_1434.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _56_1434.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _56_1434.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _56_1434.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _56_1434.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _56_1434.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _56_1434.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _56_1434.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _56_1434.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _56_1434.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _56_1434.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _56_1434.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _56_1434.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _56_1434.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _56_1434.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _148_854; FStar_TypeChecker_Env.is_iface = _56_1434.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _56_1434.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _56_1434.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _56_1434.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _56_1434.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _56_1434.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _56_1434.FStar_TypeChecker_Env.qname_and_index}))
in (match ((check env t1 t2)) with
| None -> begin
(let _148_858 = (let _148_857 = (let _148_856 = (FStar_TypeChecker_Errors.expected_expression_of_type env t2 e t1)
in (let _148_855 = (FStar_TypeChecker_Env.get_range env)
in ((_148_856), (_148_855))))
in FStar_Syntax_Syntax.Error (_148_857))
in (Prims.raise _148_858))
end
| Some (g) -> begin
(
...
(let _148_859 = (FStar_TypeChecker_Rel.guard_to_string env g)
in (FStar_All.pipe_left (FStar_Util.print1 "Applied guard is %s\n") _148_859))
end else begin
()
end
in (let _148_860 = (decorate e t2)
in ((_148_860), (g))))
end)))))))
...
(let _148_870 = (discharge g)
in (let _148_869 = (lc.FStar_Syntax_Syntax.comp ())
in ((_148_870), (_148_869))))
end else begin
(
...
let c = (let _148_873 = (let _148_872 = (let _148_871 = (FStar_TypeChecker_Normalize.unfold_effect_abbrev env c)
in (FStar_All.pipe_right _148_871 FStar_Syntax_Syntax.mk_Comp))
in (FStar_All.pipe_right _148_872 (FStar_TypeChecker_Normalize.normalize_comp steps env)))
in (FStar_All.pipe_right _148_873 FStar_Syntax_Util.comp_to_comp_typ))
in (
...
let vc = (let _148_881 = (let _148_875 = (let _148_874 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_148_874)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _148_875 env md md.FStar_Syntax_Syntax.trivial))
in (let _148_880 = (let _148_878 = (FStar_Syntax_Syntax.as_arg t)
in (let _148_877 = (let _148_876 = (FStar_Syntax_Syntax.as_arg wp)
in (_148_876)::[])
in (_148_878)::_148_877))
in (let _148_879 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk_Tm_app _148_881 _148_880 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) _148_879))))
in (
...
(let _148_882 = (FStar_Syntax_Print.term_to_string vc)
...
let g = (let _148_883 = (FStar_All.pipe_left FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (vc)))
in (FStar_TypeChecker_Rel.conj_guard g _148_883))
in (let _148_885 = (discharge g)
in (let _148_884 = (FStar_Syntax_Syntax.mk_Comp c)
in ((_148_885), (_148_884)))))))
end))))))
end)))
...
let op_and_e = (fun e -> (let _148_906 = (FStar_Syntax_Util.b2t e)
in (FStar_All.pipe_right _148_906 (fun _148_905 -> FStar_TypeChecker_Common.NonTrivial (_148_905)))))
in (
# 1122 "FStar.TypeChecker.Util.fst"
let op_or_e = (fun e -> (let _148_911 = (let _148_909 = (FStar_Syntax_Util.b2t e)
in (FStar_Syntax_Util.mk_neg _148_909))
in (FStar_All.pipe_right _148_911 (fun _148_910 -> FStar_TypeChecker_Common.NonTrivial (_148_910)))))
in (
# 1123 "FStar.TypeChecker.Util.fst"
let op_and_t = (fun t -> (FStar_All.pipe_right t (fun _148_914 -> FStar_TypeChecker_Common.NonTrivial (_148_914))))
in (
# 1124 "FStar.TypeChecker.Util.fst"
let op_or_t = (fun t -> (let _148_918 = (FStar_All.pipe_right t FStar_Syntax_Util.mk_neg)
in (FStar_All.pipe_right _148_918 (fun _148_917 -> FStar_TypeChecker_Common.NonTrivial (_148_917)))))
in (
# 1125 "FStar.TypeChecker.Util.fst"
let op_imp_t = (fun t -> (FStar_All.pipe_right t (fun _148_921 -> FStar_TypeChecker_Common.NonTrivial (_148_921))))
in (
...
(let _148_925 = (FStar_Syntax_Util.mk_neg guard)
in (FStar_All.pipe_right _148_925 (fun _148_924 -> FStar_TypeChecker_Common.NonTrivial (_148_924))))
end
| _56_1498 -> begin
...
let short_circuit_head : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun l -> (match ((let _148_961 = (FStar_Syntax_Util.un_uinst l)
in _148_961.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
| Some (t) -> begin
(match ((let _148_968 = (FStar_Syntax_Subst.compress t)
in _148_968.FStar_Syntax_Syntax.n)) with
...
| (x, i) -> begin
(let _148_972 = (FStar_Syntax_Syntax.set_range_of_bv x r)
in ((_148_972), (i)))
end))))
...
(let _148_981 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic_lift (((m1), (m2))))))) _148_981 e.FStar_Syntax_Syntax.pos))
end)))
...
# 1206 "FStar.TypeChecker.Util.fst"
...
(let _148_990 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic (((m), (t))))))) _148_990 e.FStar_Syntax_Syntax.pos))
end))

# 1211 "FStar.TypeChecker.Util.fst"
...
let no_reify = (fun l -> (let _148_1002 = (let _148_1001 = (let _148_1000 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _148_999 = (FStar_TypeChecker_Env.get_range env)
in ((_148_1000), (_148_999))))
in FStar_Syntax_Syntax.Error (_148_1001))
in (Prims.raise _148_1002)))
in (match ((let _148_1003 = (FStar_TypeChecker_Env.norm_eff_name env c.FStar_Syntax_Syntax.eff_name)
in (FStar_TypeChecker_Env.effect_decl_opt env _148_1003))) with
| None -> begin
...
(
# 1221 "FStar.TypeChecker.Util.fst"
let c = (let _148_1004 = (c.FStar_Syntax_Syntax.comp ())
in (FStar_TypeChecker_Normalize.unfold_effect_abbrev env _148_1004))
in (
# 1222 "FStar.TypeChecker.Util.fst"
let _56_1608 = (let _148_1005 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
in ((c.FStar_Syntax_Syntax.result_typ), (_148_1005)))
in (match (_56_1608) with
| (res_typ, wp) -> begin
(
# 1223 "FStar.TypeChecker.Util.fst"
let repr = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_c)::[]) env ed (([]), (ed.FStar_Syntax_Syntax.repr)))
in (let _148_1010 = (let _148_1008 = (let _148_1007 = (let _148_1006 = (FStar_Syntax_Syntax.as_arg res_typ)
in (_148_1006)::(wp)::[])
in ((repr), (_148_1007)))
in FStar_Syntax_Syntax.Tm_app (_148_1008))
in (let _148_1009 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _148_1010 None _148_1009))))
end)))
end
end)))

# 1224 "FStar.TypeChecker.Util.fst"
let d : Prims.string  ->  Prims.unit = (fun s -> (FStar_Util.print1 "\\x1b[01;36m%s\\x1b[00m\n" s))

# 1226 "FStar.TypeChecker.Util.fst"
...
# 1232 "FStar.TypeChecker.Util.fst"
let _56_1616 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
(
# 1233 "FStar.TypeChecker.Util.fst"
let _56_1614 = (d (FStar_Ident.text_of_lid lident))
in (let _148_1019 = (FStar_Syntax_Print.term_to_string def)
in (FStar_Util.print2 "Registering top-level definition: %s\n%s\n" (FStar_Ident.text_of_lid lident) _148_1019)))
end else begin
()
end
in (
# 1237 "FStar.TypeChecker.Util.fst"
let fv = (let _148_1020 = (FStar_Syntax_Util.incr_delta_qualifier def)
in (FStar_Syntax_Syntax.lid_as_fv lident _148_1020 None))
in (
# 1238 "FStar.TypeChecker.Util.fst"
let lbname = FStar_Util.Inr (fv)
in (
# 1239 "FStar.TypeChecker.Util.fst"
...
in (
# 1247 "FStar.TypeChecker.Util.fst"
let sig_ctx = FStar_Syntax_Syntax.Sig_let (((lb), (FStar_Range.dummyRange), ((lident)::[]), ((FStar_Syntax_Syntax.Inline)::[])))
in (let _148_1021 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar (fv)) None FStar_Range.dummyRange)
in ((sig_ctx), (_148_1021)))))))))
