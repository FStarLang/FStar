  ...
  fun g  ->
    fun t  ->
      let rec aux_whnf env t1 =
        let uu____11826 =
          let uu____11827 = FStar_Syntax_Subst.compress t1  in
          uu____11827.FStar_Syntax_Syntax.n  in
        match uu____11826 with
        | FStar_Syntax_Syntax.Tm_type uu____11830 -> true
        | FStar_Syntax_Syntax.Tm_fvar fv ->
            (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.unit_lid) ||
              (let uu____11833 =
                 ...
                 FStar_All.pipe_right uu____11838
                  ...
                  in
               FStar_All.pipe_right uu____11833
                 (fun l_opt  ->
                         ...
                         (FStar_List.existsb
                            (fun t2  ->
                               ...
                               | FStar_Syntax_Syntax.Tm_fvar fv1 when
                                   ...
                                   -> true
                               | uu____11878 -> false)))))
        | FStar_Syntax_Syntax.Tm_arrow uu____11879 ->
            let uu____11892 = FStar_Syntax_Util.arrow_formals_comp t1  in
            (match uu____11892 with
             | (bs,c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs  in
                 let uu____11918 = FStar_Syntax_Util.is_pure_comp c  in
                 if uu____11918
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____11920;
               FStar_Syntax_Syntax.index = uu____11921;
               FStar_Syntax_Syntax.sort = t2;_},uu____11923)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____11931,uu____11932) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____11974::[]) ->
            let uu____12005 =
              let uu____12006 = FStar_Syntax_Util.un_uinst head1  in
      ...
      and aux env t1 =
        ...
        (let uu____12019 =
         ...
         if uu____12019
         then
           let uu____12020 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____12020
         else ());
        res
       in aux g t
