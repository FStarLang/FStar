    ...
    fun seen_args  ->
      ...
      let op_and_t t =
        FStar_All.pipe_right t
          (fun _16803  -> FStar_TypeChecker_Common.NonTrivial _16803)
         in
      let op_or_t t =
        let uu____16814 = FStar_All.pipe_right t FStar_Syntax_Util.mk_neg  in
        FStar_All.pipe_right uu____16814
          (fun _16817  -> FStar_TypeChecker_Common.NonTrivial _16817)
         in
      let op_imp_t t =
        FStar_All.pipe_right t
          (fun _16824  -> FStar_TypeChecker_Common.NonTrivial _16824)
         in
      let short_op_ite uu___9_16830 =
        ...
        | _then::(guard,uu____16867)::[] ->
            ...
            FStar_All.pipe_right uu____16908
              (fun _16909  -> FStar_TypeChecker_Common.NonTrivial _16909)
            ...
            FStar_Util.find_map table
              (fun uu____17111  ->
                 ...
                 | (x,mk1) ->
                     ...
                     if uu____17128
                     then
                       let uu____17133 = mk1 seen_args  in
    ...
    fun lident  ->
      fun def  ->
        (let uu____17715 =
         ...
         if uu____17715
         then
           ((let uu____17720 = FStar_Ident.text_of_lid lident  in
             d uu____17720);
            (let uu____17722 = FStar_Ident.text_of_lid lident  in
             let uu____17724 = FStar_Syntax_Print.term_to_string def  in
             FStar_Util.print2 "Registering top-level definition: %s\n%s\n"
               uu____17722 uu____17724))
         else ());
        (let fv =
           let uu____17730 = FStar_Syntax_Util.incr_delta_qualifier def  in
           FStar_Syntax_Syntax.lid_as_fv lident uu____17730
             FStar_Pervasives_Native.None
            in
         ...
         let uu____17742 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___2072_17744 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___2072_17744.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___2072_17744.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___2072_17744.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___2072_17744.FStar_Syntax_Syntax.sigattrs);
             FStar_Syntax_Syntax.sigopts =
               (uu___2072_17744.FStar_Syntax_Syntax.sigopts)
           }), uu____17742))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___11_17762 =
        match uu___11_17762 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____17765 -> false  in
      let reducibility uu___12_17773 =
        match uu___12_17773 with
      ...
      let assumption uu___13_17788 =
        match uu___13_17788 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____17792 -> false  in
      let reification uu___14_17800 =
        match uu___14_17800 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____17803 -> true
        | uu____17805 -> false  in
      let inferred uu___15_17813 =
        match uu___15_17813 with
        | FStar_Syntax_Syntax.Discriminator uu____17815 -> true
        | FStar_Syntax_Syntax.Projector uu____17817 -> true
        | FStar_Syntax_Syntax.RecordType uu____17823 -> true
        | FStar_Syntax_Syntax.RecordConstructor uu____17833 -> true
        | FStar_Syntax_Syntax.ExceptionConstructor  -> true
        | FStar_Syntax_Syntax.HasMaskedEffect  -> true
        | FStar_Syntax_Syntax.Effect  -> true
        | uu____17846 -> false  in
      let has_eq uu___16_17854 =
        match uu___16_17854 with
      ...
      let quals_combo_ok quals q =
        ...
        | FStar_Syntax_Syntax.Reflectable uu____17937 ->
            FStar_All.pipe_right quals
              (FStar_List.for_all
                 (fun x  ->
                    ((((reification x) || (inferred x)) || (visibility x)) ||
      ...
      let check_erasable quals se1 r =
          ...
          FStar_All.pipe_right lids
            (FStar_Util.for_some
               (fun l  ->
                  ...
                  FStar_Option.isSome uu____17977))
           in
            ...
            (FStar_Util.for_some
               (fun l  ->
                  ...
                  (FStar_Option.isSome attrs_opt) &&
                    (let uu____18008 = FStar_Option.get attrs_opt  in
                     FStar_Syntax_Util.has_attribute uu____18008
        ...
        then
          (match se1.FStar_Syntax_Syntax.sigel with
           | FStar_Syntax_Syntax.Sig_bundle uu____18028 ->
               let uu____18037 =
                 let uu____18039 =
                   FStar_All.pipe_right quals
                     (FStar_Util.for_some
                        (fun uu___17_18045  ->
                           match uu___17_18045 with
                           | FStar_Syntax_Syntax.Noeq  -> true
                           | uu____18048 -> false))
                    in
           ...
           | FStar_Syntax_Syntax.Sig_declare_typ uu____18055 -> ()
           | uu____18062 ->
               FStar_Errors.raise_error
                 (FStar_Errors.Fatal_QulifierListNotPermitted,
      ...
      let uu____18076 =
        let uu____18078 =
          FStar_All.pipe_right quals
            (FStar_Util.for_some
               (fun uu___18_18084  ->
                  match uu___18_18084 with
                  | FStar_Syntax_Syntax.OnlyName  -> true
                  | uu____18087 -> false))
           in
        FStar_All.pipe_right uu____18078 Prims.op_Negation  in
      if uu____18076
      then
        ...
        let err' msg =
          let uu____18108 =
            let uu____18114 =
              let uu____18116 = FStar_Syntax_Print.quals_to_string quals  in
              FStar_Util.format2
                "The qualifier list \"[%s]\" is not permissible for this element%s"
                uu____18116 msg
               in
            (FStar_Errors.Fatal_QulifierListNotPermitted, uu____18114)  in
          FStar_Errors.raise_error uu____18108 r  in
        let err msg = err' (Prims.op_Hat ": " msg)  in
        let err'1 uu____18134 = err' ""  in
         ...
         (let uu____18142 =
            let uu____18144 =
              FStar_All.pipe_right quals
               ...
               in
            Prims.op_Negation uu____18144  in
          if uu____18142 then err "ill-formed combination" else ());
         check_erasable quals se r;
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_let ((is_rec,uu____18155),uu____18156) ->
              ((let uu____18168 =
                  is_rec &&
                    (FStar_All.pipe_right quals
                       (FStar_List.contains
          ...
          | FStar_Syntax_Syntax.Sig_bundle uu____18188 ->
              ((let uu____18198 =
                  let uu____18200 =
                    FStar_All.pipe_right quals
                      (FStar_Util.for_all
                         (fun x  ->
                            (((((x = FStar_Syntax_Syntax.Abstract) ||
                              ...
                              || (has_eq x)))
                     in
                  Prims.op_Negation uu____18200  in
                if uu____18198 then err'1 () else ());
               (let uu____18210 =
                  (FStar_All.pipe_right quals
                     (FStar_List.existsb
                        (fun uu___19_18216  ->
                           match uu___19_18216 with
                           | FStar_Syntax_Syntax.Unopteq  -> true
                           | uu____18219 -> false)))
                    &&
          ...
          | FStar_Syntax_Syntax.Sig_declare_typ uu____18225 ->
              let uu____18232 =
                FStar_All.pipe_right quals (FStar_Util.for_some has_eq)  in
              if uu____18232 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_assume uu____18240 ->
              let uu____18247 =
                let uu____18249 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (visibility x) ||
                            (x = FStar_Syntax_Syntax.Assumption)))
                   in
                Prims.op_Negation uu____18249  in
              if uu____18247 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____18259 ->
              let uu____18260 =
                let uu____18262 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (((x = FStar_Syntax_Syntax.TotalEffect) ||
                            ...
                            || (reification x)))
                   in
                Prims.op_Negation uu____18262  in
              if uu____18260 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____18272 ->
              let uu____18285 =
                let uu____18287 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____18285 then err'1 () else ()
          | uu____18297 -> ()))
      else ()
  ...
  fun g  ->
    fun t  ->
      let rec descend env t1 =
        let uu____18336 =
          let uu____18337 = FStar_Syntax_Subst.compress t1  in
          uu____18337.FStar_Syntax_Syntax.n  in
        match uu____18336 with
        | FStar_Syntax_Syntax.Tm_arrow uu____18341 ->
            let uu____18356 = FStar_Syntax_Util.arrow_formals_comp t1  in
        ...
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____18389;
               FStar_Syntax_Syntax.index = uu____18390;
               FStar_Syntax_Syntax.sort = t2;_},uu____18392)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____18401) -> descend env head1
        | FStar_Syntax_Syntax.Tm_uinst (head1,uu____18427) ->
            descend env head1
        | FStar_Syntax_Syntax.Tm_fvar fv ->
      ...
      and aux env t1 =
        ...
        (let uu____18443 =
         ...
         if uu____18443
         then
           let uu____18448 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____18448
         else ());
        res
       in aux g t
                ...
                let fail1 t =
                  let uu____18513 =
                    FStar_TypeChecker_Err.unexpected_signature_for_monad env
                      eff_name t
                     in
                  FStar_Errors.raise_error uu____18513 r  in
                let uu____18523 =
                  FStar_TypeChecker_Env.inst_tscheme signature_ts  in
                match uu____18523 with
                | (uu____18532,signature) ->
                    let uu____18534 =
                      let uu____18535 = FStar_Syntax_Subst.compress signature
                         in
                      uu____18535.FStar_Syntax_Syntax.n  in
                    (match uu____18534 with
                     | FStar_Syntax_Syntax.Tm_arrow (bs,uu____18543) ->
                                ...
                                FStar_TypeChecker_Env.uvars_for_binders env
                                  ...
                                  (fun b  ->
                                     ...
                                     FStar_Util.format3
                                       ...
                                       uu____18606 eff_name.FStar_Ident.str
                                       uu____18608) r
                                 in
                               ...
                               | (is,g) ->
                                   let uu____18621 =
                                               ...
                                               let uu____18666 =
                                                 let uu____18675 =
                                                   FStar_Syntax_Syntax.null_binder
                                                    ...
                                                    in
                                                 [uu____18675]  in
                                               (uu____18666, eff_c)  in
                                             FStar_Syntax_Syntax.Tm_arrow
                                               uu____18651
                                              in
                                           FStar_Syntax_Syntax.mk uu____18650
                                            in
                                         uu____18643
                                     ...
                                     | FStar_Pervasives_Native.Some repr_ts
                                      ...
                                      in
                                   (uu____18621, g))
                          | uu____18729 -> fail1 signature)
                     | uu____18730 -> fail1 signature)
            ...
            FStar_All.pipe_right uu____18761
              (fun ed  ->
                 ...
                 fresh_effect_repr env r eff_name
                   ed.FStar_Syntax_Syntax.signature uu____18769 u a_tm)
                  ...
                  let fail1 t =
                    let uu____18818 =
                      FStar_TypeChecker_Err.unexpected_signature_for_monad
                        env eff_name t
                       in
                    FStar_Errors.raise_error uu____18818 r  in
                  let uu____18824 =
                    let uu____18825 = FStar_Syntax_Subst.compress sig_tm  in
                    uu____18825.FStar_Syntax_Syntax.n  in
                  (match uu____18824 with
                   | FStar_Syntax_Syntax.Tm_arrow (bs,uu____18829) ->
                       let bs1 = FStar_Syntax_Subst.open_binders bs  in
                       (match bs1 with
                        | (a',uu____18852)::bs2 ->
                        ...
                        | uu____18874 -> fail1 sig_tm)
                   | uu____18875 -> fail1 sig_tm)
      ...
      fun env  ->
        fun c  ->
          (let uu____18906 =
           ...
           if uu____18906
           then
             let uu____18911 = FStar_Syntax_Print.comp_to_string c  in
             let uu____18913 = FStar_Syntax_Print.lid_to_string tgt  in
             FStar_Util.print2 "Lifting comp %s to layered effect %s {\n"
               uu____18911 uu____18913
           else ());
          (let r = FStar_TypeChecker_Env.get_range env  in
           ...
           let uu____18920 =
             ...
             let uu____18932 =
               FStar_All.pipe_right ct.FStar_Syntax_Syntax.effect_args
                 (FStar_List.map FStar_Pervasives_Native.fst)
                in
             (uu____18931, (ct.FStar_Syntax_Syntax.result_typ), uu____18932)
              in
                    ...
                    let lift_t_shape_error s =
                      let uu____19000 =
                        FStar_Ident.string_of_lid
                          ct.FStar_Syntax_Syntax.effect_name
                         in
                      let uu____19002 = FStar_Ident.string_of_lid tgt  in
                      let uu____19004 =
                        FStar_Syntax_Print.term_to_string lift_t  in
                      FStar_Util.format4
                        "Lift from %s to %s has unexpected shape, reason: %s (lift:%s)"
                        uu____19000 uu____19002 s uu____19004
                       in
                    let uu____19007 =
                      let uu____19040 =
                        let uu____19041 = FStar_Syntax_Subst.compress lift_t
                           in
                      ...
                      | uu____19253 ->
                          let uu____19254 =
                            ...
                            (FStar_Errors.Fatal_UnexpectedEffect,
                              uu____19260)
                             in
                          FStar_Errors.raise_error uu____19254 r
                       in
                               ...
                               let uu____19387 =
                                 let uu____19394 =
                                   FStar_All.pipe_right a_b
                                    ...
                                    in
                                 (uu____19394, a)  in
                               FStar_Syntax_Syntax.NT uu____19387  in
                             [uu____19386]  in
                           FStar_TypeChecker_Env.uvars_for_binders env
                             rest_bs uu____19385
                             (fun b  ->
                                ...
                                FStar_Util.format4
                                  ...
                                  uu____19411 uu____19413 uu____19415
                                  uu____19417) r
                            in
                              ...
                              ((let uu____19431 =
                                           ...
                                           let uu____19445 =
                                             let uu____19447 =
                                               FStar_Syntax_Print.term_to_string
                                                 u1
                                                in
                                             Prims.op_Hat ";;;;" uu____19447
                                              in
                                           Prims.op_Hat s uu____19445) ""
                                      rest_bs_uvars
                                     in
                               ...
                               (let substs =
                                         ...
                                         let uu____19478 =
                                           let uu____19485 =
                                             FStar_All.pipe_right b
                                              ...
                                              in
                                           (uu____19485, t)  in
                                         FStar_Syntax_Syntax.NT uu____19478)
                                  ...
                                  let f_sort_is =
                                    let uu____19510 =
                                      FStar_TypeChecker_Env.is_layered_effect
                                        ...
                                        ct.FStar_Syntax_Syntax.effect_name
                                       in
                                    effect_args_from_repr f_sort uu____19510
                                      r
                                     in
                                  FStar_List.fold_left2
                                    (fun g1  ->
                                    ...
                                    let uu____19536 =
                                      let uu____19537 =
                                        FStar_List.hd
                                         ...
                                         in
                                      FStar_Pervasives_Native.fst uu____19537
                                       in
                                    (uu____19535, uu____19536)  in
                                ...
                                (let c1 =
                                   ...
                                   FStar_Syntax_Syntax.mk_Comp uu____19575
                                    in
                                 (let uu____19600 =
                                    FStar_All.pipe_left
                                      (FStar_TypeChecker_Env.debug env)
            ...
            let lift =
              let uu____19655 =
                ...
                FStar_All.pipe_right uu____19660
                 ...
                 in
              FStar_All.pipe_right uu____19655 FStar_Pervasives_Native.snd
               in
            let rest_bs =
              let lift_t =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (uu____19730::bs,uu____19732)
                  ...
                  let uu____19879 =
                    let uu____19885 =
                      ...
                      FStar_Util.format1
                        ...
                        uu____19887
                       in
                    (FStar_Errors.Fatal_UnexpectedEffect, uu____19885)  in
                  FStar_Errors.raise_error uu____19879
                    (FStar_Pervasives_Native.snd lift_t).FStar_Syntax_Syntax.pos
               in
            let args =
              let uu____19914 = FStar_Syntax_Syntax.as_arg a  in
              let uu____19923 =
                let uu____19934 =
                  FStar_All.pipe_right rest_bs
                   ...
                   in
                let uu____19977 =
                  let uu____19988 = FStar_Syntax_Syntax.as_arg e  in
                  [uu____19988]  in
                FStar_List.append uu____19934 uu____19977  in
              uu____19914 :: uu____19923  in
...
let (get_field_projector_name :
  ...
  fun env  ->
    fun datacon  ->
      fun index1  ->
        let uu____20059 = FStar_TypeChecker_Env.lookup_datacon env datacon
           in
        ...
        | (uu____20064,t) ->
            let err n1 =
              let uu____20074 =
                let uu____20080 =
                  let uu____20082 = FStar_Ident.string_of_lid datacon  in
                  let uu____20084 = FStar_Util.string_of_int n1  in
                  let uu____20086 = FStar_Util.string_of_int index1  in
                  FStar_Util.format3
                    "Data constructor %s does not have enough binders (has %s, tried %s)"
                    uu____20082 uu____20084 uu____20086
                   in
                (FStar_Errors.Fatal_UnexpectedDataConstructor, uu____20080)
                 in
              let uu____20090 = FStar_TypeChecker_Env.get_range env  in
              FStar_Errors.raise_error uu____20074 uu____20090  in
            let uu____20091 =
              let uu____20092 = FStar_Syntax_Subst.compress t  in
              uu____20092.FStar_Syntax_Syntax.n  in
            (match uu____20091 with
             | FStar_Syntax_Syntax.Tm_arrow (bs,uu____20096) ->
                 let bs1 =
                   FStar_All.pipe_right bs
                     (FStar_List.filter
                        (fun uu____20151  ->
                 ...
                 then err (FStar_List.length bs1)
                   ...
                   (let b = FStar_List.nth bs1 index1  in
                    ...
                    FStar_All.pipe_right uu____20200
                      FStar_Pervasives_Native.fst)
             | uu____20211 -> err Prims.int_zero)
        ...
        let uu____20227 =
          let uu____20240 =
            FStar_All.pipe_right sub1.FStar_Syntax_Syntax.lift_wp
              FStar_Util.must
             in
          lift_tf_layered_effect sub1.FStar_Syntax_Syntax.target uu____20240
           in
        {
          FStar_TypeChecker_Env.mlift_wp = uu____20227;
           ...
           | (uu____20284,lift_t) ->
               ...
               let uu____20303 =
                 let uu____20304 =
                               ...
                               let uu____20352 =
                                 let uu____20363 =
                                   FStar_Syntax_Syntax.as_arg
                                    ...
                                    in
                                 [uu____20363; wp]  in
                               (lift_t, uu____20352)  in
                             FStar_Syntax_Syntax.Tm_app uu____20335  in
                           FStar_Syntax_Syntax.mk uu____20334  in
                         uu____20327 FStar_Pervasives_Native.None
                   ...
                   {
                     FStar_Syntax_Syntax.comp_univs =
                       (uu___2446_20305.FStar_Syntax_Syntax.comp_univs);
                     FStar_Syntax_Syntax.effect_name =
                       (sub1.FStar_Syntax_Syntax.target);
                     FStar_Syntax_Syntax.result_typ =
                       (uu___2446_20305.FStar_Syntax_Syntax.result_typ);
                     FStar_Syntax_Syntax.effect_args = uu____20306;
                     FStar_Syntax_Syntax.flags =
                       (uu___2446_20305.FStar_Syntax_Syntax.flags)
                   }  in
                 FStar_Syntax_Syntax.mk_Comp uu____20304  in
               (uu____20303, FStar_TypeChecker_Common.trivial_guard)
            in
         let mk_mlift_term ts u r e =
           let uu____20463 = FStar_TypeChecker_Env.inst_tscheme_with ts [u]
              in
           ...
           | (uu____20470,lift_t) ->
               let uu____20472 =
                 let uu____20479 =
                   let uu____20480 =
                     let uu____20497 =
                       let uu____20508 = FStar_Syntax_Syntax.as_arg r  in
                       let uu____20517 =
                         let uu____20528 =
                           FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun
                            in
                         let uu____20537 =
                           let uu____20548 = FStar_Syntax_Syntax.as_arg e  in
                           [uu____20548]  in
                         uu____20528 :: uu____20537  in
                       uu____20508 :: uu____20517  in
                     (lift_t, uu____20497)  in
                   FStar_Syntax_Syntax.Tm_app uu____20480  in
                 FStar_Syntax_Syntax.mk uu____20479  in
               uu____20472 FStar_Pervasives_Native.None
                 e.FStar_Syntax_Syntax.pos
            in
         let uu____20601 =
           let uu____20614 =
             FStar_All.pipe_right sub1.FStar_Syntax_Syntax.lift_wp
               FStar_Util.must
              in
           FStar_All.pipe_right uu____20614 mk_mlift_wp  in
         {
           FStar_TypeChecker_Env.mlift_wp = uu____20601;
           FStar_TypeChecker_Env.mlift_term =
             (match sub1.FStar_Syntax_Syntax.lift with
              | FStar_Pervasives_Native.None  ->
                  FStar_Pervasives_Native.Some
                    ((fun uu____20650  ->
                        fun uu____20651  -> fun e  -> FStar_Util.return_all e))
...
let (update_env_sub_eff :
  ...
  fun env  ->
    fun sub1  ->
      let uu____20674 = get_mlift_for_subeff env sub1  in
