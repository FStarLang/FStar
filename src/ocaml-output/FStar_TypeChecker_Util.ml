...
let as_uvar : FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.uvar = (fun uu___122_98 -> (match (uu___122_98) with
...
let uu___141_266 = FStar_TypeChecker_Rel.trivial_guard
in (
...
in (uu____282)::[])
in {FStar_TypeChecker_Env.guard_f = uu___141_266.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___141_266.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___141_266.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu____267}))
in (
...
let uu___142_505 = a
in {FStar_Syntax_Syntax.ppname = uu___142_505.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___142_505.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})), (false)))
end))
end
| uu____506 -> begin
((a), (true))
...
let uu___143_1168 = x
in {FStar_Syntax_Syntax.ppname = uu___143_1168.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___143_1168.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
...
let uu___144_1198 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (e))); FStar_Syntax_Syntax.p = uu___144_1198.FStar_Syntax_Syntax.p})
in (([]), ([]), ([]), (env1), (e), (p2)))
end))))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___145_1234.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___145_1234.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1235}))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___146_1278.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___146_1278.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1279}))
in (
...
let uu___147_1899 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___147_1899.FStar_Syntax_Syntax.p})))))))
end))
end))
in (
...
in {FStar_Syntax_Syntax.v = uu____2486; FStar_Syntax_Syntax.p = uu___148_2483.FStar_Syntax_Syntax.p})))
end))
end)))
end
| uu____2517 -> begin
...
let uu___149_2758 = x
in {FStar_Syntax_Syntax.ppname = uu___149_2758.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___149_2758.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
...
let uu___150_2769 = x
in {FStar_Syntax_Syntax.ppname = uu___150_2769.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___150_2769.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
...
let uu___151_4215 = lc
in (

let uu____4216 = (FStar_Syntax_Subst.subst subst1 lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___151_4215.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____4216; FStar_Syntax_Syntax.cflags = uu___151_4215.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____4221 -> (
...
let uu___152_4361 = lc
in {FStar_Syntax_Syntax.eff_name = uu___152_4361.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___152_4361.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___152_4361.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = close1})))
...
let uu___153_4775 = x
in {FStar_Syntax_Syntax.ppname = uu___153_4775.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___153_4775.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = (FStar_Syntax_Util.comp_result c1)})
in (
...
in {FStar_TypeChecker_Env.guard_f = uu____4992; FStar_TypeChecker_Env.deferred = uu___154_4991.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___154_4991.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___154_4991.FStar_TypeChecker_Env.implicits}))
end))
...
let uu___155_5073 = lc
in {FStar_Syntax_Syntax.eff_name = uu___155_5073.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___155_5073.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___155_5073.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = weaken})))
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___123_5130 -> (match (uu___123_5130) with
...
in {FStar_Syntax_Syntax.eff_name = uu____5214; FStar_Syntax_Syntax.res_typ = uu___156_5213.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu____5215; FStar_Syntax_Syntax.comp = strengthen})))
in ((uu____5212), ((

let uu___157_5225 = g0
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___157_5225.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___157_5225.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___157_5225.FStar_TypeChecker_Env.implicits}))))));
)
end)))
...
let uu___158_5760 = retc1
in {FStar_Syntax_Syntax.comp_univs = uu___158_5760.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Parser_Const.effect_GHOST_lid; FStar_Syntax_Syntax.result_typ = uu___158_5760.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___158_5760.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = flags})
...
let uu___159_5789 = lc
in {FStar_Syntax_Syntax.eff_name = uu___159_5789.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___159_5789.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = refine1}))))
...
let uu___160_6036 = lc
in {FStar_Syntax_Syntax.eff_name = uu___160_6036.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___160_6036.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___160_6036.FStar_Syntax_Syntax.comp})), (FStar_TypeChecker_Rel.trivial_guard));
)
end)
end
...
let uu___161_6049 = lc
in {FStar_Syntax_Syntax.eff_name = uu___161_6049.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___161_6049.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___161_6049.FStar_Syntax_Syntax.comp})
in ((e), (lc1), (g)))
end
| FStar_TypeChecker_Common.NonTrivial (f) -> begin
(
...
let uu___162_6052 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___162_6052.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___162_6052.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___162_6052.FStar_TypeChecker_Env.implicits})
in (
...
let uu___163_6096 = lc
in {FStar_Syntax_Syntax.eff_name = uu___163_6096.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___163_6096.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___163_6096.FStar_Syntax_Syntax.comp})
in (lc1.FStar_Syntax_Syntax.comp ()))
end
| uu____6097 -> begin
(
...
let uu___164_6189 = x
in {FStar_Syntax_Syntax.ppname = uu___164_6189.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___164_6189.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lc.FStar_Syntax_Syntax.res_typ})
in (
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___124_6214 -> (match (uu___124_6214) with
| FStar_Syntax_Syntax.RETURN -> begin
(FStar_Syntax_Syntax.PARTIAL_RETURN)::[]
end
| FStar_Syntax_Syntax.PARTIAL_RETURN -> begin
...
let uu___166_6222 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___166_6222.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___166_6222.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___166_6222.FStar_TypeChecker_Env.implicits})
in ((e), (lc1), (g2)))))))
end))
end))))
...
let decr_inst = (fun uu___125_7061 -> (match (uu___125_7061) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
let uu___167_10002 = x
in {FStar_Syntax_Syntax.ppname = uu___167_10002.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___167_10002.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) FStar_Pervasives_Native.None e2.FStar_Syntax_Syntax.pos)
end
| uu____10003 -> begin
e2
end)))
...
let uu___168_10005 = env1
in (

let uu____10006 = (env1.FStar_TypeChecker_Env.use_eq || (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = uu___168_10005.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___168_10005.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___168_10005.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___168_10005.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___168_10005.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___168_10005.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___168_10005.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___168_10005.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___168_10005.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___168_10005.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___168_10005.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___168_10005.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___168_10005.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___168_10005.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___168_10005.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu____10006; FStar_TypeChecker_Env.is_iface = uu___168_10005.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___168_10005.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___168_10005.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___168_10005.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___168_10005.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___168_10005.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___168_10005.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___168_10005.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___168_10005.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___168_10005.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___168_10005.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___168_10005.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___168_10005.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___168_10005.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___168_10005.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___168_10005.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___168_10005.FStar_TypeChecker_Env.dsenv}))
in (
...
let short_bin_op = (fun f uu___126_10146 -> (match (uu___126_10146) with
| [] -> begin
...
let short_op_ite = (fun uu___127_10213 -> (match (uu___127_10213) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
...
let uu____10560 = (FStar_Util.prefix_until (fun uu___128_10600 -> (match (uu___128_10600) with
...
let uu___169_10982 = sig_ctx
in {FStar_Syntax_Syntax.sigel = uu___169_10982.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___169_10982.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen)::[]; FStar_Syntax_Syntax.sigmeta = uu___169_10982.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___169_10982.FStar_Syntax_Syntax.sigattrs})), (uu____10976)))))));
))


let check_sigelt_quals : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt  ->  Prims.unit = (fun env se -> (

let visibility = (fun uu___129_10994 -> (match (uu___129_10994) with
...
let reducibility = (fun uu___130_10999 -> (match (uu___130_10999) with
...
let assumption = (fun uu___131_11004 -> (match (uu___131_11004) with
...
let reification = (fun uu___132_11009 -> (match (uu___132_11009) with
...
let inferred = (fun uu___133_11015 -> (match (uu___133_11015) with
...
let has_eq = (fun uu___134_11044 -> (match (uu___134_11044) with
...
let uu____11115 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___135_11119 -> (match (uu___135_11119) with
...
let uu___170_11420 = (projectee arg_typ)
in {FStar_Syntax_Syntax.ppname = uu___170_11420.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___170_11420.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})
...
let uu____11561 = (FStar_List.filter (fun uu___136_11565 -> (match (uu___136_11565) with
| FStar_Syntax_Syntax.Abstract -> begin
(not (only_decl))
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____12016 = (FStar_List.filter (fun uu___137_12020 -> (match (uu___137_12020) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____12021 -> begin
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___138_12034 -> (match (uu___138_12034) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____12589 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___139_12594 -> (match (uu___139_12594) with
...
let filter_records = (fun uu___140_12612 -> (match (uu___140_12612) with
