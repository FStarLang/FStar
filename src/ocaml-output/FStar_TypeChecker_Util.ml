               ...
               ((let uu____157 =
                ...
                (let g1 =
                   FStar_TypeChecker_Rel.solve_deferred_constraints env
                     (let uu___357_197 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          (uu___357_197.FStar_TypeChecker_Env.guard_f);
                        FStar_TypeChecker_Env.deferred = solve_now;
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___357_197.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___357_197.FStar_TypeChecker_Env.implicits)
                      })
                    in
                 let g2 =
                   let uu___358_199 = g1  in
                   {
                     FStar_TypeChecker_Env.guard_f =
                       (uu___358_199.FStar_TypeChecker_Env.guard_f);
                     FStar_TypeChecker_Env.deferred = defer;
                     FStar_TypeChecker_Env.univ_ineqs =
                       (uu___358_199.FStar_TypeChecker_Env.univ_ineqs);
                     FStar_TypeChecker_Env.implicits =
                       (uu___358_199.FStar_TypeChecker_Env.implicits)
                   }  in
                 g2)))
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____1481  in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___359_1479.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___359_1479.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___359_1479.FStar_TypeChecker_Env.implicits)
            }
              ...
              (let flags1 =
               ...
               let uu____2365 =
                 ...
                 FStar_Syntax_Syntax.mk_lcomp uu____2366
                  ...
                  in
               (uu____2365,
                 (let uu___360_2368 = g0  in
                  {
                    FStar_TypeChecker_Env.guard_f =
                      FStar_TypeChecker_Common.Trivial;
                    FStar_TypeChecker_Env.deferred =
                      (uu___360_2368.FStar_TypeChecker_Env.deferred);
                    FStar_TypeChecker_Env.univ_ineqs =
                      (uu___360_2368.FStar_TypeChecker_Env.univ_ineqs);
                    FStar_TypeChecker_Env.implicits =
                      (uu___360_2368.FStar_TypeChecker_Env.implicits)
                  })))
                                     ...
                                     then
                                       let c21 =
                                         FStar_Syntax_Subst.subst_comp
                                          ...
                                          in
                                       let x1 =
                                         let uu___361_2831 = x  in
                                         {
                                           FStar_Syntax_Syntax.ppname =
                                             (uu___361_2831.FStar_Syntax_Syntax.ppname);
                                           FStar_Syntax_Syntax.index =
                                             (uu___361_2831.FStar_Syntax_Syntax.index);
                                           FStar_Syntax_Syntax.sort =
          ...
          then
            ...
            (if uu____3430
             then
               ...
               let retc2 =
                 let uu___362_3436 = retc1  in
                 {
                   FStar_Syntax_Syntax.comp_univs =
                     (uu___362_3436.FStar_Syntax_Syntax.comp_univs);
                   FStar_Syntax_Syntax.effect_name =
                     FStar_Parser_Const.effect_GHOST_lid;
                   FStar_Syntax_Syntax.result_typ =
                     (uu___362_3436.FStar_Syntax_Syntax.result_typ);
                   FStar_Syntax_Syntax.effect_args =
                     (uu___362_3436.FStar_Syntax_Syntax.effect_args);
                   FStar_Syntax_Syntax.flags = flags1
                 }  in
          ...
          (let use_eq =
           ...
           | (FStar_Pervasives_Native.None ,uu____4537) ->
               ...
               then
                 ...
                 (FStar_TypeChecker_Rel.subtype_fail env e
                    lc.FStar_Syntax_Syntax.res_typ t;
                  (e,
                    ((let uu___363_4560 = lc  in
                      {
                        FStar_Syntax_Syntax.eff_name =
                          (uu___363_4560.FStar_Syntax_Syntax.eff_name);
                        FStar_Syntax_Syntax.res_typ = t;
                        FStar_Syntax_Syntax.cflags =
                          (uu___363_4560.FStar_Syntax_Syntax.cflags);
                        FStar_Syntax_Syntax.comp_thunk =
                          (uu___363_4560.FStar_Syntax_Syntax.comp_thunk)
           ...
           | (FStar_Pervasives_Native.Some g,apply_guard1) ->
               ...
               (match uu____4565 with
                ...
                | FStar_TypeChecker_Common.NonTrivial f ->
                    let g1 =
                      let uu___364_4620 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___364_4620.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___364_4620.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___364_4620.FStar_TypeChecker_Env.implicits)
                      }  in
                      ...
                      then FStar_Syntax_Syntax.lcomp_comp lc
                        ...
                        (let f1 =
                         ...
                         | FStar_Syntax_Syntax.Tm_abs
                             ...
                             ->
                             let lc1 =
                               let uu___365_4664 = lc  in
                               {
                                 FStar_Syntax_Syntax.eff_name =
                                   (uu___365_4664.FStar_Syntax_Syntax.eff_name);
                                 FStar_Syntax_Syntax.res_typ = t;
                                 FStar_Syntax_Syntax.cflags =
                                   (uu___365_4664.FStar_Syntax_Syntax.cflags);
                                 FStar_Syntax_Syntax.comp_thunk =
                                   (uu___365_4664.FStar_Syntax_Syntax.comp_thunk)
                               }  in
                             ...
                             ((let uu____4668 =
                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               | (eq_ret,_trivial_so_ok_to_discard) ->
                                   let x1 =
                                     let uu___366_4743 = x  in
                                     {
                                       FStar_Syntax_Syntax.ppname =
                                         (uu___366_4743.FStar_Syntax_Syntax.ppname);
                                       FStar_Syntax_Syntax.index =
                                         (uu___366_4743.FStar_Syntax_Syntax.index);
                                       FStar_Syntax_Syntax.sort =
                                         (lc.FStar_Syntax_Syntax.res_typ)
                                     }  in
                                   let c1 =
                    ...
                    let lc1 =
                      ...
                      FStar_Syntax_Syntax.mk_lcomp uu____4766 t flags1
                       ...
                       in
                    let g2 =
                      let uu___367_4768 = g1  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___367_4768.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___367_4768.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___367_4768.FStar_TypeChecker_Env.implicits)
                      }  in
                    (e, lc1, g2)))
           ...
           (let number_of_implicits t1 =
            ...
            let inst_n_binders t1 =
              ...
              | FStar_Pervasives_Native.Some expected_t ->
               ...
               in
            let decr_inst uu___346_5807 =
              match uu___346_5807 with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
                            ...
                            | (v1,uu____6291,g) ->
                                ((let uu____6306 =
                                 ...
                                 (let mark_meta_implicits tau1 g1 =
                                    let uu___368_6320 = g1  in
                                    let uu____6321 =
                                      FStar_List.map
                                        (fun imp  ->
                                           let uu___369_6327 = imp  in
                                           {
                                             FStar_TypeChecker_Env.imp_reason
                                               =
                                               (uu___369_6327.FStar_TypeChecker_Env.imp_reason);
                                             FStar_TypeChecker_Env.imp_uvar =
                                               (uu___369_6327.FStar_TypeChecker_Env.imp_uvar);
                                             FStar_TypeChecker_Env.imp_tm =
                                               (uu___369_6327.FStar_TypeChecker_Env.imp_tm);
                                             FStar_TypeChecker_Env.imp_range
                                               =
                                               (uu___369_6327.FStar_TypeChecker_Env.imp_range);
                                    ...
                                    {
                                      FStar_TypeChecker_Env.guard_f =
                                        (uu___368_6320.FStar_TypeChecker_Env.guard_f);
                                      FStar_TypeChecker_Env.deferred =
                                        (uu___368_6320.FStar_TypeChecker_Env.deferred);
                                      FStar_TypeChecker_Env.univ_ineqs =
                                        (uu___368_6320.FStar_TypeChecker_Env.univ_ineqs);
                                      FStar_TypeChecker_Env.implicits =
                                        uu____6321
                                    }  in
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___370_8920 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___370_8920.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___370_8920.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____8921 -> e2  in
          let env2 =
            let uu___371_8923 = env1  in
            let uu____8924 =
               ...
               in
            {
              FStar_TypeChecker_Env.solver =
                (uu___371_8923.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___371_8923.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___371_8923.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___371_8923.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___371_8923.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___371_8923.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___371_8923.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___371_8923.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___371_8923.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___371_8923.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___371_8923.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___371_8923.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___371_8923.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___371_8923.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___371_8923.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___371_8923.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___371_8923.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____8924;
              FStar_TypeChecker_Env.is_iface =
                (uu___371_8923.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___371_8923.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___371_8923.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___371_8923.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___371_8923.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___371_8923.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___371_8923.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___371_8923.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___371_8923.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___371_8923.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___371_8923.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___371_8923.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___371_8923.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___371_8923.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___371_8923.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___371_8923.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___371_8923.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___371_8923.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___371_8923.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___371_8923.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___371_8923.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___371_8923.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___371_8923.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___371_8923.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___371_8923.FStar_TypeChecker_Env.nbe)
            }  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___347_9119 =
        match uu___347_9119 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___348_9210 =
        match uu___348_9210 with
        | [] -> FStar_TypeChecker_Common.Trivial
        ...
        (let fv =
         ...
         let uu____10078 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___372_10080 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___372_10080.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___372_10080.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___372_10080.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___372_10080.FStar_Syntax_Syntax.sigattrs)
           }), uu____10078))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___350_10096 =
        match uu___350_10096 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____10097 -> false  in
      let reducibility uu___351_10103 =
        match uu___351_10103 with
      ...
      let assumption uu___352_10110 =
        match uu___352_10110 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____10111 -> false  in
      let reification uu___353_10117 =
        match uu___353_10117 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____10118 -> true
        | uu____10119 -> false  in
      let inferred uu___354_10125 =
        match uu___354_10125 with
      ...
      let has_eq uu___355_10156 =
        match uu___355_10156 with
  ...
  fun g  ->
    fun t  ->
      ...
      let rec aux_whnf env t1 =
        let uu____10469 =
          let uu____10470 = FStar_Syntax_Subst.compress t1  in
          uu____10470.FStar_Syntax_Syntax.n  in
        match uu____10469 with
        | FStar_Syntax_Syntax.Tm_type uu____10473 -> true
        | FStar_Syntax_Syntax.Tm_fvar fv ->
            (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.unit_lid) ||
              (has_erased_for_extraction_attr fv)
        | FStar_Syntax_Syntax.Tm_arrow uu____10475 ->
            let uu____10490 = FStar_Syntax_Util.arrow_formals_comp t1  in
            (match uu____10490 with
             | (bs,c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs  in
                 let uu____10522 = FStar_Syntax_Util.is_pure_comp c  in
                 if uu____10522
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____10524;
               FStar_Syntax_Syntax.index = uu____10525;
               FStar_Syntax_Syntax.sort = t2;_},uu____10527)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____10535,uu____10536) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____10578::[]) ->
            let uu____10617 =
              let uu____10618 = FStar_Syntax_Util.un_uinst head1  in
      ...
      and aux env t1 =
        ...
        (let uu____10631 =
         ...
         if uu____10631
         then
           let uu____10632 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____10632
         else ());
        res
       in aux g t
