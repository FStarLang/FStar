...
in (_154_493)::[])
in (FStar_Syntax_Util.abs _154_494 x_eq_y_yret (Some (FStar_Util.Inr (FStar_Syntax_Const.effect_Tot_lid)))))
...
in (FStar_Syntax_Util.abs _154_589 _154_588 (Some (FStar_Util.Inr (FStar_Syntax_Const.effect_Tot_lid))))))
in (
...
(let _154_775 = (string_of_univs univs)
...
(let _154_776 = (FStar_Syntax_Print.term_to_string t)
...
in (let _154_777 = (FStar_ST.read t0.FStar_Syntax_Syntax.tk)
in (maybe_set_tk ((gen), (ts)) _154_777)))))))))


let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _154_783 = (FStar_Util.for_all (fun _57_1289 -> (match (_57_1289) with
| (_57_1287, c) -> begin
(FStar_Syntax_Util.is_pure_or_ghost_comp c)
end)) ecs)
in (FStar_All.pipe_left Prims.op_Negation _154_783)) then begin
None
end else begin
(
...
(let _154_786 = (FStar_Syntax_Print.comp_to_string c)
...
(let _154_787 = (FStar_Syntax_Print.comp_to_string c)
...
let gen_uvars = (fun uvs -> (let _154_790 = (FStar_Util.set_difference uvs env_uvars)
in (FStar_All.pipe_right _154_790 FStar_Util.set_elements)))
in (

let _57_1311 = (let _154_792 = (FStar_All.pipe_right ecs (FStar_List.map (fun _57_1302 -> (match (_57_1302) with
| (e, c) -> begin
(
...
in (FStar_All.pipe_right _154_792 FStar_List.unzip))
...
let a = (let _154_798 = (let _154_797 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _154_796 -> Some (_154_796)) _154_797))
in (FStar_Syntax_Syntax.new_bv _154_798 kres))
in (

let t = (let _154_803 = (FStar_Syntax_Syntax.bv_to_name a)
in (let _154_802 = (let _154_801 = (let _154_800 = (let _154_799 = (FStar_Syntax_Syntax.mk_Total kres)
in (FStar_Syntax_Util.lcomp_of_comp _154_799))
in FStar_Util.Inl (_154_800))
in Some (_154_801))
in (FStar_Syntax_Util.abs bs _154_803 _154_802)))
in (
...
let t = (match ((let _154_804 = (FStar_Syntax_Subst.compress (FStar_Syntax_Util.comp_result c))
in _154_804.FStar_Syntax_Syntax.n)) with
...
in (let _154_805 = (FStar_Syntax_Syntax.mk_Total t)
in ((e'), (_154_805)))))))
end))
end)
...
(let _154_812 = (let _154_811 = (FStar_List.map (fun _57_1408 -> (match (_57_1408) with
| (lb, _57_1405, _57_1407) -> begin
(FStar_Syntax_Print.lbname_to_string lb)
end)) lecs)
in (FStar_All.pipe_right _154_811 (FStar_String.concat ", ")))
in (FStar_Util.print1 "Generalizing: %s\n" _154_812))
end else begin
()
end
in (match ((let _154_814 = (FStar_All.pipe_right lecs (FStar_List.map (fun _57_1415 -> (match (_57_1415) with
| (_57_1412, e, c) -> begin
((e), (c))
end))))
in (gen env _154_814))) with
| None -> begin
...
(let _154_821 = (FStar_Range.string_of_range e.FStar_Syntax_Syntax.pos)
in (let _154_820 = (FStar_Syntax_Print.lbname_to_string l)
in (let _154_819 = (FStar_Syntax_Print.term_to_string (FStar_Syntax_Util.comp_result c))
in (let _154_818 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.print4 "(%s) Generalized %s at type %s\n%s\n" _154_821 _154_820 _154_819 _154_818)))))
end else begin
()
end
in ((l), (us), (e), (c)))
...
| Some (f) -> begin
(let _154_837 = (FStar_TypeChecker_Rel.apply_guard f e)
in (FStar_All.pipe_left (fun _154_836 -> Some (_154_836)) _154_837))
end)
end)
in (

let is_var = (fun e -> (match ((let _154_840 = (FStar_Syntax_Subst.compress e)
...
let _57_1464 = e
in (let _154_845 = (FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)))
in {FStar_Syntax_Syntax.n = _57_1464.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _154_845; FStar_Syntax_Syntax.pos = _57_1464.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_1464.FStar_Syntax_Syntax.vars}))
end)))
in (
...
let _57_1466 = env
in (let _154_846 = (env.FStar_TypeChecker_Env.use_eq || (env.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = _57_1466.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_1466.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_1466.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_1466.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_1466.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_1466.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_1466.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_1466.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_1466.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_1466.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_1466.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_1466.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_1466.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _57_1466.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _57_1466.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _154_846; FStar_TypeChecker_Env.is_iface = _57_1466.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_1466.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _57_1466.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _57_1466.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _57_1466.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_1466.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_1466.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _57_1466.FStar_TypeChecker_Env.qname_and_index}))
in (match ((check env t1 t2)) with
| None -> begin
(let _154_850 = (let _154_849 = (let _154_848 = (FStar_TypeChecker_Errors.expected_expression_of_type env t2 e t1)
in (let _154_847 = (FStar_TypeChecker_Env.get_range env)
in ((_154_848), (_154_847))))
in FStar_Syntax_Syntax.Error (_154_849))
in (Prims.raise _154_850))
end
| Some (g) -> begin
(

let _57_1472 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _154_851 = (FStar_TypeChecker_Rel.guard_to_string env g)
in (FStar_All.pipe_left (FStar_Util.print1 "Applied guard is %s\n") _154_851))
end else begin
()
end
in (let _154_852 = (decorate e t2)
in ((_154_852), (g))))
end)))))))
...
(let _154_862 = (discharge g)
in (let _154_861 = (lc.FStar_Syntax_Syntax.comp ())
...
let c = (let _154_865 = (let _154_864 = (let _154_863 = (FStar_TypeChecker_Normalize.unfold_effect_abbrev env c)
in (FStar_All.pipe_right _154_863 FStar_Syntax_Syntax.mk_Comp))
in (FStar_All.pipe_right _154_864 (FStar_TypeChecker_Normalize.normalize_comp steps env)))
in (FStar_All.pipe_right _154_865 (FStar_TypeChecker_Normalize.comp_to_comp_typ env)))
in (
...
let vc = (let _154_871 = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_t)::[]) env md md.FStar_Syntax_Syntax.trivial)
in (let _154_870 = (let _154_868 = (FStar_Syntax_Syntax.as_arg t)
in (let _154_867 = (let _154_866 = (FStar_Syntax_Syntax.as_arg wp)
in (_154_866)::[])
in (_154_868)::_154_867))
in (let _154_869 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk_Tm_app _154_871 _154_870 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) _154_869))))
in (

let _57_1491 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _154_872 = (FStar_Syntax_Print.term_to_string vc)
...
let g = (let _154_873 = (FStar_All.pipe_left FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (vc)))
in (FStar_TypeChecker_Rel.conj_guard g _154_873))
in (let _154_875 = (discharge g)
in (let _154_874 = (FStar_Syntax_Syntax.mk_Comp c)
in ((_154_875), (_154_874)))))))
end))))))
end)))
...
let op_and_e = (fun e -> (let _154_896 = (FStar_Syntax_Util.b2t e)
in (FStar_All.pipe_right _154_896 (fun _154_895 -> FStar_TypeChecker_Common.NonTrivial (_154_895)))))
in (

let op_or_e = (fun e -> (let _154_901 = (let _154_899 = (FStar_Syntax_Util.b2t e)
in (FStar_Syntax_Util.mk_neg _154_899))
in (FStar_All.pipe_right _154_901 (fun _154_900 -> FStar_TypeChecker_Common.NonTrivial (_154_900)))))
in (

let op_and_t = (fun t -> (FStar_All.pipe_right t (fun _154_904 -> FStar_TypeChecker_Common.NonTrivial (_154_904))))
in (

let op_or_t = (fun t -> (let _154_908 = (FStar_All.pipe_right t FStar_Syntax_Util.mk_neg)
in (FStar_All.pipe_right _154_908 (fun _154_907 -> FStar_TypeChecker_Common.NonTrivial (_154_907)))))
in (

let op_imp_t = (fun t -> (FStar_All.pipe_right t (fun _154_911 -> FStar_TypeChecker_Common.NonTrivial (_154_911))))
in (
...
(let _154_915 = (FStar_Syntax_Util.mk_neg guard)
...
let short_circuit_head : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun l -> (match ((let _154_951 = (FStar_Syntax_Util.un_uinst l)
in _154_951.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
| Some (t) -> begin
(match ((let _154_958 = (FStar_Syntax_Subst.compress t)
in _154_958.FStar_Syntax_Syntax.n)) with
...
| (x, i) -> begin
(let _154_962 = (FStar_Syntax_Syntax.set_range_of_bv x r)
in ((_154_962), (i)))
end))))
...
(let _154_971 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic_lift (((m1), (m2))))))) _154_971 e.FStar_Syntax_Syntax.pos))
end)))
...
(let _154_980 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic (((m), (t))))))) _154_980 e.FStar_Syntax_Syntax.pos))
end))


let effect_repr_aux = (fun only_reifiable env c u_c -> (match ((let _154_985 = (FStar_TypeChecker_Env.norm_eff_name env (FStar_Syntax_Util.comp_effect_name c))
in (FStar_TypeChecker_Env.effect_decl_opt env _154_985))) with
| None -> begin
None
end
| Some (ed) -> begin
...
let _57_1643 = (let _154_986 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
in ((c.FStar_Syntax_Syntax.result_typ), (_154_986)))
in (match (_57_1643) with
| (res_typ, wp) -> begin
(

let repr = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_c)::[]) env ed (([]), (ed.FStar_Syntax_Syntax.repr)))
in (let _154_992 = (let _154_991 = (let _154_989 = (let _154_988 = (let _154_987 = (FStar_Syntax_Syntax.as_arg res_typ)
in (_154_987)::(wp)::[])
in ((repr), (_154_988)))
in FStar_Syntax_Syntax.Tm_app (_154_989))
in (let _154_990 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _154_991 None _154_990)))
in Some (_154_992)))
end)))
end)
end
...
let no_reify = (fun l -> (let _154_1010 = (let _154_1009 = (let _154_1008 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _154_1007 = (FStar_TypeChecker_Env.get_range env)
in ((_154_1008), (_154_1007))))
in FStar_Syntax_Syntax.Error (_154_1009))
in (Prims.raise _154_1010)))
in (match ((let _154_1011 = (c.FStar_Syntax_Syntax.comp ())
in (effect_repr_aux true env _154_1011 u_c))) with
| None -> begin
...
in (let _154_1020 = (FStar_Syntax_Print.term_to_string def)
in (FStar_Util.print2 "Registering top-level definition: %s\n%s\n" (FStar_Ident.text_of_lid lident) _154_1020)))
end else begin
()
end
in (

let fv = (let _154_1021 = (FStar_Syntax_Util.incr_delta_qualifier def)
in (FStar_Syntax_Syntax.lid_as_fv lident _154_1021 None))
in (
...
in (let _154_1022 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar (fv)) None FStar_Range.dummyRange)
in ((sig_ctx), (_154_1022)))))))))
...
let err' = (fun msg -> (let _154_1057 = (let _154_1056 = (let _154_1055 = (let _154_1054 = (FStar_Syntax_Print.quals_to_string quals)
in (FStar_Util.format2 "The qualifier list \"[%s]\" is not permissible for this element%s" _154_1054 msg))
in ((_154_1055), (r)))
in FStar_Syntax_Syntax.Error (_154_1056))
in (Prims.raise _154_1057)))
in (
