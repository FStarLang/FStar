...
let decr_inst = (fun uu___99_4820 -> (match (uu___99_4820) with
| None -> begin
None
end
| Some (i) -> begin
...
let maybe_set_tk = (fun ts uu___100_5298 -> (match (uu___100_5298) with
| None -> begin
ts
end
| Some (t) -> begin
...
let uu___142_6439 = x
in {FStar_Syntax_Syntax.ppname = uu___142_6439.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___142_6439.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})))) (Some (t2.FStar_Syntax_Syntax.n)) e2.FStar_Syntax_Syntax.pos)
end
| uu____6440 -> begin
(

let uu___143_6441 = e2
in (

let uu____6442 = (FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)))
in {FStar_Syntax_Syntax.n = uu___143_6441.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu____6442; FStar_Syntax_Syntax.pos = uu___143_6441.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___143_6441.FStar_Syntax_Syntax.vars}))
end)))
in (

let env2 = (

let uu___144_6451 = env1
in (

let uu____6452 = (env1.FStar_TypeChecker_Env.use_eq || (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = uu___144_6451.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___144_6451.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___144_6451.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___144_6451.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___144_6451.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___144_6451.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___144_6451.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___144_6451.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___144_6451.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___144_6451.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___144_6451.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___144_6451.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___144_6451.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___144_6451.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___144_6451.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu____6452; FStar_TypeChecker_Env.is_iface = uu___144_6451.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___144_6451.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___144_6451.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___144_6451.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___144_6451.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___144_6451.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___144_6451.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___144_6451.FStar_TypeChecker_Env.qname_and_index}))
in (
...
let short_bin_op = (fun f uu___101_6569 -> (match (uu___101_6569) with
| [] -> begin
...
let short_op_ite = (fun uu___102_6630 -> (match (uu___102_6630) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
...
let uu____6885 = (FStar_Util.prefix_until (fun uu___103_6904 -> (match (uu___103_6904) with
...
let visibility = (fun uu___104_7170 -> (match (uu___104_7170) with
...
let reducibility = (fun uu___105_7175 -> (match (uu___105_7175) with
...
let assumption = (fun uu___106_7180 -> (match (uu___106_7180) with
...
let reification = (fun uu___107_7185 -> (match (uu___107_7185) with
...
let inferred = (fun uu___108_7191 -> (match (uu___108_7191) with
...
let has_eq = (fun uu___109_7200 -> (match (uu___109_7200) with
...
let uu____7230 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___110_7232 -> (match (uu___110_7232) with
...
let uu___145_7476 = (projectee arg_typ)
in {FStar_Syntax_Syntax.ppname = uu___145_7476.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___145_7476.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})
...
let uu____7555 = (FStar_List.filter (fun uu___111_7557 -> (match (uu___111_7557) with
...
let uu____7872 = (FStar_List.filter (fun uu___112_7874 -> (match (uu___112_7874) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____7875 -> begin
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___113_7883 -> (match (uu___113_7883) with
...
let uu____8263 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___114_8265 -> (match (uu___114_8265) with
...
let filter_records = (fun uu___115_8278 -> (match (uu___115_8278) with
