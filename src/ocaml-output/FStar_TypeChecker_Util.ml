    ...
    then t
      ...
      (let uu____8329 = FStar_Syntax_Util.head_and_args t  in
       ...
       | (head1,args) ->
           let uu____8366 =
             let uu____8367 =
               let uu____8368 = FStar_Syntax_Subst.compress head1  in
      ...
      fun t  ->
        ...
        then (e, torig, FStar_TypeChecker_Rel.trivial_guard)
          ...
          (let number_of_implicits t1 =
             let uu____8438 = FStar_Syntax_Util.arrow_formals t1  in
           ...
           let inst_n_binders t1 =
             let uu____8688 = FStar_TypeChecker_Env.expected_typ env  in
                   ...
                   let uu____8712 =
                     let uu____8717 =
                       ...
                       FStar_Util.format3
                         ...
                         uu____8718 uu____8725 uu____8726
                        in
                     (FStar_Errors.Fatal_MissingImplicitArguments,
                       uu____8717)
                      in
                   let uu____8733 = FStar_TypeChecker_Env.get_range env  in
                   FStar_Errors.raise_error uu____8712 uu____8733
                 else FStar_Pervasives_Native.Some (n_available - n_expected)
              in
           let decr_inst uu___87_8756 =
             match uu___87_8756 with
             | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
           ...
           | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
               let uu____8786 = FStar_Syntax_Subst.open_comp bs c  in
               (match uu____8786 with
                | (bs1,c1) ->
                    let rec aux subst1 inst_n bs2 =
                      match (inst_n, bs2) with
                      | (FStar_Pervasives_Native.Some _0_18,uu____8901) when
                          _0_18 = (Prims.parse_int "0") ->
                          ([], bs2, subst1,
                            FStar_TypeChecker_Rel.trivial_guard)
                      | (uu____8944,(x,FStar_Pervasives_Native.Some
                               ...
                               (match uu____9036 with
                                | (args,bs3,subst3,g') ->
                                    ...
                                    (((v1,
                                      ...
                                      :: args), bs3, subst3, uu____9129)))
                      | (uu____9156,bs3) ->
                          ([], bs3, subst1,
                            FStar_TypeChecker_Rel.trivial_guard)
                       in
                    let uu____9202 =
                      let uu____9229 = inst_n_binders t  in
                      aux [] uu____9229 bs1  in
                    (match uu____9202 with
                     | (args,bs2,subst1,guard) ->
                         (match (args, bs2) with
                          | ([],uu____9300) -> (e, torig, guard)
                          | (uu____9331,[]) when
                              let uu____9362 =
                                FStar_Syntax_Util.is_total_comp c1  in
                              Prims.op_Negation uu____9362 ->
                          ...
                          | uu____9363 ->
                              ...
                              let e1 =
                                FStar_Syntax_Syntax.mk_Tm_app e args
                                 ...
                                 in
                              (e1, t2, guard))))
           | uu____9404 -> (e, t, FStar_TypeChecker_Rel.trivial_guard))
  
let (string_of_univs :
  FStar_Syntax_Syntax.universe_uvar FStar_Util.set -> Prims.string) =
  fun univs1  ->
    let uu____9414 =
      let uu____9417 = FStar_Util.set_elements univs1  in
      FStar_All.pipe_right uu____9417
        (FStar_List.map
           (fun u  ->
              let uu____9427 = FStar_Syntax_Unionfind.univ_uvar_id u  in
              FStar_All.pipe_right uu____9427 FStar_Util.string_of_int))
       in
    FStar_All.pipe_right uu____9414 (FStar_String.concat ", ")
...
let (gen_univs :
  ...
  fun env  ->
    fun x  ->
      let uu____9448 = FStar_Util.set_is_empty x  in
      if uu____9448
      then []
      else
        (let s =
           let uu____9463 =
             let uu____9474 = FStar_TypeChecker_Env.univ_vars env  in
             FStar_Util.set_difference x uu____9474  in
         ...
         (let uu____9506 =
          ...
          then
            let uu____9507 =
              let uu____9508 = FStar_TypeChecker_Env.univ_vars env  in
              string_of_univs uu____9508  in
            FStar_Util.print1 "univ_vars in env: %s\n" uu____9507
          else ());
         (let r =
            let uu____9515 = FStar_TypeChecker_Env.get_range env  in
            FStar_Pervasives_Native.Some uu____9515  in
          let u_names =
    ...
    fun t  ->
      ...
      let univnames1 =
        let uu____9584 = FStar_Util.set_difference tm_univnames ctx_univnames
           in
        FStar_All.pipe_right uu____9584 FStar_Util.set_elements  in
      univnames1
  ...
  fun explicit_univ_names  ->
    fun generalized_univ_names  ->
      fun t  ->
        ...
        | ([],uu____9622) -> generalized_univ_names
        | (uu____9629,[]) -> explicit_univ_names
        | uu____9636 ->
            let uu____9645 =
              let uu____9650 =
                let uu____9651 = FStar_Syntax_Print.term_to_string t  in
                Prims.strcat
                  "Generalized universe in a term containing explicit universe annotation : "
                  uu____9651
                 in
              (FStar_Errors.Fatal_UnexpectedGeneralizedUniverse, uu____9650)
               in
            FStar_Errors.raise_error uu____9645 t.FStar_Syntax_Syntax.pos
  ...
  fun env  ->
    fun t0  ->
      ...
      (let uu____9669 =
       ...
       if uu____9669
       then
         let uu____9670 = FStar_Syntax_Print.term_to_string t  in
      ...
      (let univs1 = FStar_Syntax_Free.univs t  in
       (let uu____9677 =
        ...
        if uu____9677
        then
          let uu____9678 = string_of_univs univs1  in
       ...
       (let gen1 = gen_univs env univs1  in
        (let uu____9684 =
         ...
         if uu____9684
         then
           let uu____9685 = FStar_Syntax_Print.term_to_string t  in
           let uu____9686 = FStar_Syntax_Print.univ_names_to_string gen1  in
          ...
          let uu____9765 =
            FStar_Util.for_all
              (fun uu____9778  ->
                 ...
                 | (uu____9787,uu____9788,c) ->
                     FStar_Syntax_Util.is_pure_or_ghost_comp c) lecs
             in
          FStar_All.pipe_left Prims.op_Negation uu____9765  in
        if uu____9764
        then FStar_Pervasives_Native.None
          ...
          (let norm1 c =
             (let uu____9836 =
              ...
              if uu____9836
              then
                let uu____9837 = FStar_Syntax_Print.comp_to_string c  in
             ...
             (let c1 =
              ...
              (let uu____9841 =
               ...
               if uu____9841
               then
                 let uu____9842 = FStar_Syntax_Print.comp_to_string c1  in
           ...
           let gen_uvars uvs =
             let uu____9857 = FStar_Util.set_difference uvs env_uvars  in
             FStar_All.pipe_right uu____9857 FStar_Util.set_elements  in
           let univs_and_uvars_of_lec uu____9893 =
             ...
             | (lbname,e,c) ->
                 ...
                 ((let uu____9937 =
                   ...
                   then
                     let uu____9938 =
                       let uu____9939 =
                         let uu____9942 = FStar_Util.set_elements univs1  in
                         FStar_All.pipe_right uu____9942
                           (FStar_List.map
                              (fun u  ->
                                 FStar_Syntax_Print.univ_to_string
                                   (FStar_Syntax_Syntax.U_unif u)))
                          in
                       FStar_All.pipe_right uu____9939
                         (FStar_String.concat ", ")
                        in
                     let uu____9985 =
                       let uu____9986 =
                         let uu____9989 = FStar_Util.set_elements uvt  in
                              ...
                              (fun u  ->
                                 ...
                                 let uu____10001 =
                                   FStar_Syntax_Print.term_to_string
                                    ...
                                    in
                                 FStar_Util.format2 "(%s : %s)" uu____10000
                                   uu____10001))
                          in
                  ...
                  (let univs2 =
                     let uu____10008 = FStar_Util.set_elements uvt  in
                     FStar_List.fold_left
                       (fun univs2  ->
                          fun uv  ->
                            let uu____10020 =
                              FStar_Syntax_Free.univs
                               ...
                               in
                            FStar_Util.set_union univs2 uu____10020) univs1
                       uu____10008
                      in
                   ...
                   (let uu____10027 =
                    ...
                    then
                               ...
                               (fun u  ->
                                  ...
                                  let uu____10088 =
                                    FStar_TypeChecker_Normalize.term_to_string
                                     ...
                                     in
                                  FStar_Util.format2 "(%s : %s)" uu____10087
                                    uu____10088))
                           in
                      ...
                      FStar_Util.print2
                        "^^^^\n\tFree univs = %s\n\tgen_uvars =%s"
                        uu____10028 uu____10075
                    else ());
                   (univs2, uvs, (lbname, e, c1))))
              in
           let uu____10102 =
             let uu____10119 = FStar_List.hd lecs  in
             univs_and_uvars_of_lec uu____10119  in
           ...
           | (univs1,uvs,lec_hd) ->
               let force_univs_eq lec2 u1 u2 =
                 ...
                 then ()
                   ...
                   (let uu____10213 = lec_hd  in
                    match uu____10213 with
                    | (lb1,uu____10221,uu____10222) ->
                        let uu____10223 = lec2  in
                        (match uu____10223 with
                         | (lb2,uu____10231,uu____10232) ->
                             let msg =
                               let uu____10234 =
               ...
               let force_uvars_eq lec2 u1 u2 =
                 ...
                 then ()
                   ...
                   (let uu____10302 = lec_hd  in
                    match uu____10302 with
                    | (lb1,uu____10310,uu____10311) ->
                        let uu____10312 = lec2  in
                        (match uu____10312 with
                         | (lb2,uu____10320,uu____10321) ->
                             let msg =
                               let uu____10323 =
                                 FStar_Syntax_Print.lbname_to_string lb1  in
                               let uu____10324 =
                  ...
                  in
               let lecs1 =
                 let uu____10335 = FStar_List.tl lecs  in
                 FStar_List.fold_right
                   (fun this_lec  ->
                      fun lecs1  ->
                        let uu____10394 = univs_and_uvars_of_lec this_lec  in
                 ...
                 let fail1 k =
                   ...
                   | (lbname,e,c) ->
                       let uu____10505 =
                         let uu____10510 =
                           ...
                           FStar_Util.format3
                             ...
                             uu____10511 uu____10512 uu____10513
                            in
                       ...
                       let uu____10514 = FStar_TypeChecker_Env.get_range env
                          in
                       FStar_Errors.raise_error uu____10505 uu____10514
                    in
                 FStar_All.pipe_right uvs1
                   (FStar_List.map
                      (fun u  ->
                         ...
                         | FStar_Pervasives_Native.Some uu____10544 ->
                             failwith
                             ...
                             (match uu____10555 with
                              | (bs,kres) ->
                                  ((let uu____10593 =
                                    ...
                                    | FStar_Syntax_Syntax.Tm_type uu____10598
                                        ->
                                        let free =
                                        ...
                                        let uu____10602 =
                                          ...
                                          Prims.op_Negation uu____10603  in
                                        if uu____10602
                                        then fail1 kres
                                        else ()
                                    | uu____10605 -> fail1 kres);
                                   (let a =
                                      let uu____10607 =
                                        let uu____10610 =
                                        ...
                                        FStar_All.pipe_left
                                          (fun _0_19  ->
                                             FStar_Pervasives_Native.Some
                                               _0_19) uu____10610
                                         in
                                      FStar_Syntax_Syntax.new_bv uu____10607
                                        kres
                                       in
                                    let t =
                                      match bs with
                                            ...
                                            let uu____10970 =
                                              FStar_Syntax_Subst.compress
                                                (FStar_Syntax_Util.comp_result
                                                   c1)
                                               in
                                            uu____10970.FStar_Syntax_Syntax.n
                                             in
      ...
      fun lecs  ->
             ...
             let uu____11164 =
               FStar_List.map
                 (fun uu____11177  ->
                    ...
                    | (lb,uu____11185,uu____11186) ->
                        FStar_Syntax_Print.lbname_to_string lb) lecs
                in
             FStar_All.pipe_right uu____11164 (FStar_String.concat ", ")  in
        ...
        (let univnames_lecs =
         ...
         let generalized_lecs =
           let uu____11236 = gen env is_rec lecs  in
           match uu____11236 with
           | FStar_Pervasives_Native.None  ->
               FStar_All.pipe_right lecs
                 (FStar_List.map
                    (fun uu____11335  ->
                       match uu____11335 with | (l,t,c) -> (l, [], t, c, [])))
                        ...
                        (fun uu____11443  ->
                           ...
                           | (l,us,e,c,gvs) ->
                               ...
                               FStar_Util.print5
                                 ...
                                 uu____11477 uu____11478 uu____11479
                                 uu____11480 uu____11481))
                 else ());
                luecs)
            in
         FStar_List.map2
                ...
                | (l,generalized_univs,t,c,gvs) ->
                    let uu____11566 =
                      check_universe_generalization univnames1
                        generalized_univs t
                       in
                    (l, uu____11566, t, c, gvs)) univnames_lecs
           generalized_lecs)
    ...
    fun e  ->
      fun t1  ->
        fun t2  ->
          ...
          let is_var e1 =
            let uu____11638 =
              let uu____11639 = FStar_Syntax_Subst.compress e1  in
              uu____11639.FStar_Syntax_Syntax.n  in
            match uu____11638 with
            | FStar_Syntax_Syntax.Tm_name uu____11642 -> true
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___119_11663 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___119_11663.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___119_11663.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____11664 -> e2  in
          let env2 =
            let uu___120_11666 = env1  in
            let uu____11667 =
               ...
               in
            {
              ...
              FStar_TypeChecker_Env.range =
                (uu___120_11666.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___120_11666.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___120_11666.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___120_11666.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___120_11666.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___120_11666.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___120_11666.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___120_11666.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___120_11666.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___120_11666.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___120_11666.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___120_11666.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___120_11666.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___120_11666.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___120_11666.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____11667;
              FStar_TypeChecker_Env.is_iface =
                (uu___120_11666.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___120_11666.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___120_11666.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___120_11666.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___120_11666.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___120_11666.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___120_11666.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___120_11666.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___120_11666.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___120_11666.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___120_11666.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___120_11666.FStar_TypeChecker_Env.qtbl_name_and_index);
              ...
              FStar_TypeChecker_Env.synth_hook =
                (uu___120_11666.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___120_11666.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___120_11666.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___120_11666.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___120_11666.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___120_11666.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___120_11666.FStar_TypeChecker_Env.dep_graph)
            }  in
          let uu____11668 = check1 env2 t1 t2  in
          ...
          | FStar_Pervasives_Native.None  ->
              let uu____11675 =
                FStar_TypeChecker_Err.expected_expression_of_type env2 t2 e
                  t1
                 in
              let uu____11680 = FStar_TypeChecker_Env.get_range env2  in
              FStar_Errors.raise_error uu____11675 uu____11680
          | FStar_Pervasives_Native.Some g ->
              ((let uu____11687 =
               ...
               (let uu____11690 = decorate e t2  in (uu____11690, g)))
  ...
  fun env  ->
    fun g  ->
      fun lc  ->
        ...
        let uu____11722 = FStar_Syntax_Util.is_total_lcomp lc  in
        if uu____11722
        then
          let uu____11727 = discharge g1  in
          let uu____11728 = FStar_Syntax_Syntax.lcomp_comp lc  in
          ...
          (let c = FStar_Syntax_Syntax.lcomp_comp lc  in
           ...
           let c1 =
             let uu____11735 =
               let uu____11736 =
                 ...
                 FStar_All.pipe_right uu____11737 FStar_Syntax_Syntax.mk_Comp
                  in
           ...
           let md =
             FStar_TypeChecker_Env.get_effect_decl env
               c1.FStar_Syntax_Syntax.effect_name
              in
           let uu____11739 = destruct_comp c1  in
           match uu____11739 with
           | (u_t,t,wp) ->
               let vc =
                 let uu____11756 = FStar_TypeChecker_Env.get_range env  in
                 let uu____11757 =
                   let uu____11762 =
                     FStar_TypeChecker_Env.inst_effect_fun_with [u_t] env md
                      ...
                      in
                   let uu____11763 =
                     let uu____11764 = FStar_Syntax_Syntax.as_arg t  in
                     let uu____11771 =
                       let uu____11780 = FStar_Syntax_Syntax.as_arg wp  in
                       [uu____11780]  in
                     uu____11764 :: uu____11771  in
                   FStar_Syntax_Syntax.mk_Tm_app uu____11762 uu____11763  in
                 uu____11757 FStar_Pervasives_Native.None uu____11756  in
               ((let uu____11808 =
                   FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                 ...
                 if uu____11808
                 then
                   let uu____11809 = FStar_Syntax_Print.term_to_string vc  in
                ...
                (let g2 =
                   let uu____11812 =
                     FStar_All.pipe_left
                      ...
                      in
                   FStar_TypeChecker_Rel.conj_guard g1 uu____11812  in
                 let uu____11813 = discharge g2  in
                 let uu____11814 = FStar_Syntax_Syntax.mk_Comp c1  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___88_11846 =
        match uu___88_11846 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (fst1,uu____11854)::[] -> f fst1
        | uu____11871 -> failwith "Unexpexted args to binary operator"  in
      let op_and_e e =
        let uu____11882 = FStar_Syntax_Util.b2t e  in
        FStar_All.pipe_right uu____11882
          (fun _0_21  -> FStar_TypeChecker_Common.NonTrivial _0_21)
         in
      let op_or_e e =
        let uu____11893 =
          let uu____11894 = FStar_Syntax_Util.b2t e  in
          FStar_Syntax_Util.mk_neg uu____11894  in
      ...
      let op_and_t t =
        FStar_All.pipe_right t
         ...
         in
      let op_or_t t =
        let uu____11913 = FStar_All.pipe_right t FStar_Syntax_Util.mk_neg  in
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___89_11927 =
        match uu___89_11927 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (guard,uu____11935)::[] ->
            FStar_TypeChecker_Common.NonTrivial guard
        | _then::(guard,uu____11954)::[] ->
            let uu____11983 = FStar_Syntax_Util.mk_neg guard  in
            FStar_All.pipe_right uu____11983
              (fun _0_26  -> FStar_TypeChecker_Common.NonTrivial _0_26)
        | uu____11984 -> failwith "Unexpected args to ITE"  in
      let table =
        let uu____11995 =
          let uu____12003 = short_bin_op op_and_e  in
          (FStar_Parser_Const.op_And, uu____12003)  in
        let uu____12011 =
          let uu____12021 =
            let uu____12029 = short_bin_op op_or_e  in
            (FStar_Parser_Const.op_Or, uu____12029)  in
          let uu____12037 =
            let uu____12047 =
              let uu____12055 = short_bin_op op_and_t  in
              (FStar_Parser_Const.and_lid, uu____12055)  in
            let uu____12063 =
              let uu____12073 =
                let uu____12081 = short_bin_op op_or_t  in
                (FStar_Parser_Const.or_lid, uu____12081)  in
              let uu____12089 =
                let uu____12099 =
                  let uu____12107 = short_bin_op op_imp_t  in
                  (FStar_Parser_Const.imp_lid, uu____12107)  in
                [uu____12099; (FStar_Parser_Const.ite_lid, short_op_ite)]  in
              uu____12073 :: uu____12089  in
            uu____12047 :: uu____12063  in
          uu____12021 :: uu____12037  in
        uu____11995 :: uu____12011  in
          ...
          let uu____12169 =
            FStar_Util.find_map table
              (fun uu____12184  ->
                 ...
                 | (x,mk1) ->
                     let uu____12201 = FStar_Ident.lid_equals x lid  in
                     if uu____12201
                     then
                       let uu____12204 = mk1 seen_args  in
                       FStar_Pervasives_Native.Some uu____12204
      ...
      | uu____12207 -> FStar_TypeChecker_Common.Trivial
  
let (short_circuit_head : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun l  ->
    let uu____12213 =
      let uu____12214 = FStar_Syntax_Util.un_uinst l  in
...
let (maybe_add_implicit_binders :
  ...
  fun env  ->
    fun bs  ->
      let pos bs1 =
        match bs1 with
        | (hd1,uu____12248)::uu____12249 ->
            FStar_Syntax_Syntax.range_of_bv hd1
        | uu____12260 -> FStar_TypeChecker_Env.get_range env  in
      match bs with
      | (uu____12267,FStar_Pervasives_Native.Some
         (FStar_Syntax_Syntax.Implicit uu____12268))::uu____12269 -> bs
      | uu____12280 ->
          let uu____12281 = FStar_TypeChecker_Env.expected_typ env  in
          (match uu____12281 with
           ...
           | FStar_Pervasives_Native.Some t ->
               ...
               (match uu____12285 with
                | FStar_Syntax_Syntax.Tm_arrow (bs',uu____12290) ->
                    let uu____12307 =
                      FStar_Util.prefix_until
                        (fun uu___90_12347  ->
                           match uu___90_12347 with
                           | (uu____12354,FStar_Pervasives_Native.Some
                              (FStar_Syntax_Syntax.Implicit uu____12355)) ->
                               false
                           | uu____12358 -> true) bs'
                       in
                    (match uu____12307 with
                     | FStar_Pervasives_Native.None  -> bs
                     | FStar_Pervasives_Native.Some
                         ([],uu____12393,uu____12394) -> bs
                     | FStar_Pervasives_Native.Some
                         (imps,uu____12466,uu____12467) ->
                         let uu____12540 =
    ...
    fun lident  ->
      fun def  ->
        (let uu____12726 =
         ...
         if uu____12726
         then
           ((let uu____12728 = FStar_Ident.text_of_lid lident  in
             d uu____12728);
            (let uu____12729 = FStar_Ident.text_of_lid lident  in
             let uu____12730 = FStar_Syntax_Print.term_to_string def  in
             FStar_Util.print2 "Registering top-level definition: %s\n%s\n"
               uu____12729 uu____12730))
         else ());
        (let fv =
           let uu____12733 = FStar_Syntax_Util.incr_delta_qualifier def  in
           FStar_Syntax_Syntax.lid_as_fv lident uu____12733
             FStar_Pervasives_Native.None
            in
         ...
         let uu____12743 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___121_12745 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___121_12745.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___121_12745.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___121_12745.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___121_12745.FStar_Syntax_Syntax.sigattrs)
           }), uu____12743))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___91_12761 =
        match uu___91_12761 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____12762 -> false  in
      let reducibility uu___92_12768 =
        match uu___92_12768 with
        | FStar_Syntax_Syntax.Abstract  -> true
        | FStar_Syntax_Syntax.Irreducible  -> true
        | FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen  -> true
        | FStar_Syntax_Syntax.Visible_default  -> true
        | FStar_Syntax_Syntax.Inline_for_extraction  -> true
        | uu____12769 -> false  in
      let assumption uu___93_12775 =
        match uu___93_12775 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____12776 -> false  in
      let reification uu___94_12782 =
        match uu___94_12782 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____12783 -> true
        | uu____12784 -> false  in
      let inferred uu___95_12790 =
        match uu___95_12790 with
        | FStar_Syntax_Syntax.Discriminator uu____12791 -> true
        | FStar_Syntax_Syntax.Projector uu____12792 -> true
        | FStar_Syntax_Syntax.RecordType uu____12797 -> true
        | FStar_Syntax_Syntax.RecordConstructor uu____12806 -> true
        | FStar_Syntax_Syntax.ExceptionConstructor  -> true
        | FStar_Syntax_Syntax.HasMaskedEffect  -> true
        | FStar_Syntax_Syntax.Effect  -> true
        | uu____12815 -> false  in
      let has_eq uu___96_12821 =
        match uu___96_12821 with
      ...
      let quals_combo_ok quals q =
        ...
        | FStar_Syntax_Syntax.Reflectable uu____12886 ->
            FStar_All.pipe_right quals
              (FStar_List.for_all
                 (fun x  ->
                    ((((reification x) || (inferred x)) || (visibility x)) ||
      ...
      let uu____12895 =
        let uu____12896 =
          FStar_All.pipe_right quals
            (FStar_Util.for_some
               (fun uu___97_12900  ->
                  match uu___97_12900 with
                  | FStar_Syntax_Syntax.OnlyName  -> true
                  | uu____12901 -> false))
           in
        FStar_All.pipe_right uu____12896 Prims.op_Negation  in
      if uu____12895
      then
        ...
        let err' msg =
          let uu____12916 =
            let uu____12921 =
              let uu____12922 = FStar_Syntax_Print.quals_to_string quals  in
              FStar_Util.format2
                "The qualifier list \"[%s]\" is not permissible for this element%s"
                uu____12922 msg
               in
            (FStar_Errors.Fatal_QulifierListNotPermitted, uu____12921)  in
          FStar_Errors.raise_error uu____12916 r  in
        let err msg = err' (Prims.strcat ": " msg)  in
        let err'1 uu____12934 = err' ""  in
         ...
         (let uu____12938 =
            let uu____12939 =
              FStar_All.pipe_right quals
               ...
               in
            Prims.op_Negation uu____12939  in
          if uu____12938 then err "ill-formed combination" else ());
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_let ((is_rec,uu____12944),uu____12945) ->
              ((let uu____12955 =
                  is_rec &&
                    (FStar_All.pipe_right quals
                       (FStar_List.contains
          ...
          | FStar_Syntax_Syntax.Sig_bundle uu____12965 ->
              let uu____12974 =
                let uu____12975 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____12974 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_declare_typ uu____12981 ->
              let uu____12988 =
                FStar_All.pipe_right quals (FStar_Util.for_some has_eq)  in
              if uu____12988 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_assume uu____12992 ->
              let uu____12999 =
                let uu____13000 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____12999 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____13006 ->
              let uu____13007 =
                let uu____13008 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (((x = FStar_Syntax_Syntax.TotalEffect) ||
                            ...
                            || (reification x)))
                   in
                Prims.op_Negation uu____13008  in
              if uu____13007 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____13014 ->
              let uu____13015 =
                let uu____13016 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
          ...
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____13022 ->
              let uu____13035 =
                let uu____13036 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                   ...
                   in
                Prims.op_Negation uu____13036  in
              if uu____13035 then err'1 () else ()
          | uu____13042 -> ()))
      else ()
  ...
  fun g  ->
    fun t  ->
      let rec aux_whnf env t1 =
        let uu____13076 =
          let uu____13077 = FStar_Syntax_Subst.compress t1  in
          uu____13077.FStar_Syntax_Syntax.n  in
        match uu____13076 with
        | FStar_Syntax_Syntax.Tm_type uu____13080 -> true
        | FStar_Syntax_Syntax.Tm_fvar fv ->
                         ...
                         (FStar_List.existsb
                            (fun t2  ->
                               ...
                               | FStar_Syntax_Syntax.Tm_fvar fv1 when
                                   ...
                                   -> true
                               | uu____13128 -> false)))))
        | FStar_Syntax_Syntax.Tm_arrow uu____13129 ->
            let uu____13142 = FStar_Syntax_Util.arrow_formals_comp t1  in
            (match uu____13142 with
             | (bs,c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs  in
                 let uu____13168 = FStar_Syntax_Util.is_pure_comp c  in
                 if uu____13168
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____13170;
               FStar_Syntax_Syntax.index = uu____13171;
               FStar_Syntax_Syntax.sort = t2;_},uu____13173)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____13181,uu____13182) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____13224::[]) ->
            let uu____13255 =
              let uu____13256 = FStar_Syntax_Util.un_uinst head1  in
      ...
      and aux env t1 =
        ...
        (let uu____13269 =
         ...
         if uu____13269
         then
           let uu____13270 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____13270
         else ());
        res
       in aux g t
