    ...
    fun lident  ->
      fun def  ->
        ...
        (let fv =
         ...
         ((let uu___149_7531 = sig_ctx in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___149_7531.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___149_7531.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___149_7531.FStar_Syntax_Syntax.sigmeta)
           }), uu____7521))
let check_sigelt_quals:
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.sigelt -> Prims.unit =
  fun env  ->
    fun se  ->
      let visibility uu___107_7543 =
        match uu___107_7543 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____7544 -> false in
      let reducibility uu___108_7548 =
        match uu___108_7548 with
        ...
        | uu____7549 -> false in
      let assumption uu___109_7553 =
        match uu___109_7553 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____7554 -> false in
      let reification uu___110_7558 =
        match uu___110_7558 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____7559 -> true
        | uu____7560 -> false in
      let inferred uu___111_7564 =
        match uu___111_7564 with
        | FStar_Syntax_Syntax.Discriminator uu____7565 -> true
        | FStar_Syntax_Syntax.Projector uu____7566 -> true
        | FStar_Syntax_Syntax.RecordType uu____7569 -> true
        | FStar_Syntax_Syntax.RecordConstructor uu____7574 -> true
        | FStar_Syntax_Syntax.ExceptionConstructor  -> true
        | FStar_Syntax_Syntax.HasMaskedEffect  -> true
        | FStar_Syntax_Syntax.Effect  -> true
        | uu____7579 -> false in
      let has_eq uu___112_7583 =
        match uu___112_7583 with
      ...
      let quals_combo_ok quals q =
        ...
        | FStar_Syntax_Syntax.Reflectable uu____7630 ->
            FStar_All.pipe_right quals
              (FStar_List.for_all
                 (fun x  ->
                    (((reification x) || (inferred x)) || (visibility x)) ||
      ...
      let uu____7637 =
        let uu____7638 =
          FStar_All.pipe_right quals
            (FStar_Util.for_some
               (fun uu___113_7641  ->
                  match uu___113_7641 with
                  | FStar_Syntax_Syntax.OnlyName  -> true
                  | uu____7642 -> false)) in
        FStar_All.pipe_right uu____7638 Prims.op_Negation in
      if uu____7637
      then
        ...
        let err' msg =
          let uu____7654 =
            let uu____7655 =
              let uu____7658 =
                let uu____7659 = FStar_Syntax_Print.quals_to_string quals in
                FStar_Util.format2
                  "The qualifier list \"[%s]\" is not permissible for this element%s"
                  uu____7659 msg in
              (uu____7658, r) in
            FStar_Errors.Error uu____7655 in
          raise uu____7654 in
        let err1 msg = err' (Prims.strcat ": " msg) in
        let err'1 uu____7667 = err' "" in
        (if (FStar_List.length quals) <> (FStar_List.length no_dup_quals)
         ...
         (let uu____7679 =
          ...
          if uu____7679 then err1 "ill-formed combination" else ());
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_let
              ((is_rec,uu____7684),uu____7685,uu____7686) ->
              ((let uu____7697 =
                  is_rec &&
                    (FStar_All.pipe_right quals
                       (FStar_List.contains
          ...
          | FStar_Syntax_Syntax.Sig_bundle uu____7705 ->
              let uu____7710 =
                let uu____7711 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____7710 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_declare_typ uu____7716 ->
              let uu____7720 =
                FStar_All.pipe_right quals (FStar_Util.for_some has_eq) in
              if uu____7720 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_assume uu____7723 ->
              let uu____7727 =
                let uu____7728 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                ...
                Prims.op_Negation uu____7728 in
              if uu____7727 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____7733 ->
              let uu____7734 =
                let uu____7735 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (((x = FStar_Syntax_Syntax.TotalEffect) ||
                             ...
                             || (visibility x))
                            || (reification x))) in
                Prims.op_Negation uu____7735 in
              if uu____7734 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____7740 ->
              let uu____7741 =
                let uu____7742 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____7741 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____7747 ->
              let uu____7754 =
                let uu____7755 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                  ...
                  fun indices  ->
                    fun fields  ->
                        ...
                        let inst_tc =
                          let uu____7827 =
                            let uu____7830 =
                              ...
                              FStar_Syntax_Syntax.Tm_uinst uu____7831 in
                            FStar_Syntax_Syntax.mk uu____7830 in
                          uu____7827 FStar_Pervasives_Native.None p in
                        let args =
                          FStar_All.pipe_right
                      ...
                      let unrefined_arg_binder =
                        let uu____7878 = projectee arg_typ in
                        FStar_Syntax_Syntax.mk_binder uu____7878 in
                      let arg_binder =
                                   ...
                                   let uu____7891 =
                                     let uu____7892 =
                                       ...
                                       FStar_All.pipe_left
                                         ...
                                         uu____7893 in
                                     [uu____7892] in
                                   FStar_Syntax_Syntax.mk_Tm_app uu____7890
                                     uu____7891 in
                                 uu____7889 FStar_Pervasives_Native.None p in
                               FStar_Syntax_Util.b2t uu____7888 in
                             FStar_Syntax_Util.refine x uu____7887 in
                           let uu____7898 =
                             let uu___150_7899 = projectee arg_typ in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___150_7899.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___150_7899.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = sort
                             } in
                           FStar_Syntax_Syntax.mk_binder uu____7898) in
                      ...
                      let all_params =
                        ...
                        FStar_List.append uu____7910 fields in
                      let imp_binders =
                           ...
                           let only_decl =
                             (let uu____7975 =
                              ...
                              FStar_Ident.lid_equals
                                FStar_Parser_Const.prims_lid uu____7975)
                               ||
                               (let uu____7977 =
                                  let uu____7978 =
                                    FStar_TypeChecker_Env.current_module env in
                                  uu____7978.FStar_Ident.str in
                                FStar_Options.dont_gen_projectors uu____7977) in
                           let quals =
                             let uu____7981 =
                               let uu____7983 =
                                 let uu____7985 =
                               ...
                               let uu____7988 =
                                 FStar_List.filter
                                   (fun uu___114_7991  ->
                                      match uu___114_7991 with
                                      | FStar_Syntax_Syntax.Abstract  ->
                                          Prims.op_Negation only_decl
                                      | FStar_Syntax_Syntax.Private  -> true
                                      | uu____7992 -> false) iquals in
                               FStar_List.append uu____7983 uu____7988 in
                             FStar_List.append
                               ...
                               let uu____8005 =
                                 let uu____8006 =
                                   FStar_Syntax_Syntax.lid_as_fv
                                     ...
                                     FStar_Syntax_Syntax.Delta_constant
                                     FStar_Pervasives_Native.None in
                                 FStar_Syntax_Syntax.fv_to_tm uu____8006 in
                               FStar_Syntax_Syntax.mk_Total uu____8005 in
                             let uu____8007 =
                                   ...
                                   let uu____8134 =
                                     let uu____8137 =
                                       let uu____8138 =
                                         ...
                                         (arg_exp, uu____8153) in
                                       FStar_Syntax_Syntax.Tm_match
                                         uu____8138 in
                                     FStar_Syntax_Syntax.mk uu____8137 in
                                   uu____8134 FStar_Pervasives_Native.None p) in
                              let dd =
                                let uu____8169 =
                                  FStar_All.pipe_right quals
                                    (FStar_List.contains
                                ...
                                let uu____8176 =
                                  let uu____8179 =
                                    FStar_Syntax_Syntax.lid_as_fv
                                      ...
                                      FStar_Pervasives_Native.None in
                                  FStar_Util.Inr uu____8179 in
                                let uu____8180 =
                                  FStar_Syntax_Subst.close_univ_vars uvs imp in
                                {
                                  FStar_Syntax_Syntax.lbname = uu____8176;
                                  FStar_Syntax_Syntax.lbunivs = uvs;
                                  FStar_Syntax_Syntax.lbtyp = lbtyp;
                                  FStar_Syntax_Syntax.lbeff =
                                    FStar_Parser_Const.effect_Tot_lid;
                                  FStar_Syntax_Syntax.lbdef = uu____8180
                                } in
                              let impl =
                                let uu____8184 =
                                  let uu____8185 =
                                      ...
                                      let uu____8193 =
                                        ...
                                        FStar_All.pipe_right uu____8194
                                          (fun fv  ->
                                             (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v) in
                                      [uu____8193] in
                                    ((false, [lb]), uu____8191, []) in
                                  FStar_Syntax_Syntax.Sig_let uu____8185 in
                                {
                                  FStar_Syntax_Syntax.sigel = uu____8184;
                      ...
                      let projectors_ses =
                        ...
                        FStar_All.pipe_right uu____8262 FStar_List.flatten in
      ...
      fun tcs  ->
        fun se  ->
          ...
          | FStar_Syntax_Syntax.Sig_datacon
              (constr_lid,uvs,t,typ_lid,n_typars,uu____8549) when
              Prims.op_Negation
                (FStar_Ident.lid_equals constr_lid
                   FStar_Parser_Const.lexcons_lid)
              ->
              let uu____8552 = FStar_Syntax_Subst.univ_var_opening uvs in
              (match uu____8552 with
               | (univ_opening,uvs1) ->
                   let t1 = FStar_Syntax_Subst.subst univ_opening t in
                   let uu____8565 = FStar_Syntax_Util.arrow_formals t1 in
                              ...
                              (fun se1  ->
                                 let uu____8608 =
                                   let uu____8609 =
                                     ...
                                     FStar_Util.must uu____8610 in
                                   FStar_Ident.lid_equals typ_lid uu____8609 in
                                 if uu____8608
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____8620,uvs',tps,typ0,uu____8624,constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____8683 with
                              | (indices,uu____8693) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___118_8722 =
                                      match uu___118_8722 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____8724,fns) ->
                                          FStar_Pervasives_Native.Some
