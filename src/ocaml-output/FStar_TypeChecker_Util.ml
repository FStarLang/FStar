...
let univnames = (let _151_773 = (FStar_Util.set_difference tm_univnames ctx_univnames)
in (FStar_All.pipe_right _151_773 FStar_Util.set_elements))
in univnames))))
...
let _56_1277 = (FStar_ST.op_Colon_Equals (Prims.snd ts).FStar_Syntax_Syntax.tk (Some (t.FStar_Syntax_Syntax.n)))
in ts)))
end))
...
(let _151_780 = (string_of_univs univs)
...
let _56_1287 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen"))) then begin
(let _151_781 = (FStar_Syntax_Print.term_to_string t)
...
in (let _151_782 = (FStar_ST.read t0.FStar_Syntax_Syntax.tk)
in (maybe_set_tk ((univs), (ts)) _151_782)))))))))))


let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _151_788 = (FStar_Util.for_all (fun _56_1296 -> (match (_56_1296) with
| (_56_1294, c) -> begin
(FStar_Syntax_Util.is_pure_or_ghost_comp c)
end)) ecs)
in (FStar_All.pipe_left Prims.op_Negation _151_788)) then begin
None
end else begin
(
...
(let _151_791 = (FStar_Syntax_Print.comp_to_string c)
...
let _56_1302 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
(let _151_792 = (FStar_Syntax_Print.comp_to_string c)
...
let gen_uvars = (fun uvs -> (let _151_795 = (FStar_Util.set_difference uvs env_uvars)
in (FStar_All.pipe_right _151_795 FStar_Util.set_elements)))
in (

let _56_1318 = (let _151_797 = (FStar_All.pipe_right ecs (FStar_List.map (fun _56_1309 -> (match (_56_1309) with
| (e, c) -> begin
(
...
in (FStar_All.pipe_right _151_797 FStar_List.unzip))
in (match (_56_1318) with
| (univs, uvars) -> begin
(
...
let ecs = (FStar_All.pipe_right uvars (FStar_List.map (fun _56_1327 -> (match (_56_1327) with
| (uvs, e, c) -> begin
(

let tvars = (FStar_All.pipe_right uvs (FStar_List.map (fun _56_1330 -> (match (_56_1330) with
| (u, k) -> begin
...
| FStar_Syntax_Syntax.Fixed (_56_1364) -> begin
...
let _56_1371 = (FStar_Syntax_Util.arrow_formals k)
in (match (_56_1371) with
| (bs, kres) -> begin
(

let a = (let _151_803 = (let _151_802 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _151_801 -> Some (_151_801)) _151_802))
in (FStar_Syntax_Syntax.new_bv _151_803 kres))
in (

let t = (let _151_808 = (FStar_Syntax_Syntax.bv_to_name a)
in (let _151_807 = (let _151_806 = (let _151_805 = (let _151_804 = (FStar_Syntax_Syntax.mk_Total kres)
in (FStar_Syntax_Util.lcomp_of_comp _151_804))
in FStar_Util.Inl (_151_805))
in Some (_151_806))
in (FStar_Syntax_Util.abs bs _151_808 _151_807)))
in (

let _56_1374 = (FStar_Syntax_Util.set_uvar u t)
...
let _56_1406 = (match (((tvars), (gen_univs))) with
| ([], []) -> begin
((e), (c))
end
| ([], _56_1382) -> begin
...
let t = (match ((let _151_809 = (FStar_Syntax_Subst.compress (FStar_Syntax_Util.comp_result c))
in _151_809.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, cod) -> begin
(

let _56_1399 = (FStar_Syntax_Subst.open_comp bs cod)
...
in (let _151_810 = (FStar_Syntax_Syntax.mk_Total t)
in ((e'), (_151_810)))))))
end))
end)
in (match (_56_1406) with
| (e, c) -> begin
((gen_univs), (e), (c))
end)))
end))))
...
let _56_1416 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _151_817 = (let _151_816 = (FStar_List.map (fun _56_1415 -> (match (_56_1415) with
| (lb, _56_1412, _56_1414) -> begin
(FStar_Syntax_Print.lbname_to_string lb)
end)) lecs)
in (FStar_All.pipe_right _151_816 (FStar_String.concat ", ")))
...
let univnames_lecs = (FStar_List.map (fun _56_1421 -> (match (_56_1421) with
| (l, t, c) -> begin
(gather_free_univnames env t)
end)) lecs)
in (

let generalized_lecs = (match ((let _151_820 = (FStar_All.pipe_right lecs (FStar_List.map (fun _56_1427 -> (match (_56_1427) with
| (_56_1424, e, c) -> begin
((e), (c))
end))))
in (gen env _151_820))) with
| None -> begin
(FStar_All.pipe_right lecs (FStar_List.map (fun _56_1432 -> (match (_56_1432) with
| (l, t, c) -> begin
((l), ([]), (t), (c))
end))))
end
| Some (ecs) -> begin
(FStar_List.map2 (fun _56_1440 _56_1444 -> (match (((_56_1440), (_56_1444))) with
| ((l, _56_1437, _56_1439), (us, e, c)) -> begin
(

let _56_1445 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
(let _151_827 = (FStar_Range.string_of_range e.FStar_Syntax_Syntax.pos)
in (let _151_826 = (FStar_Syntax_Print.lbname_to_string l)
in (let _151_825 = (FStar_Syntax_Print.term_to_string (FStar_Syntax_Util.comp_result c))
in (let _151_824 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.print4 "(%s) Generalized %s at type %s\n%s\n" _151_827 _151_826 _151_825 _151_824)))))
end else begin
()
end
in ((l), (us), (e), (c)))
...
in (FStar_List.map2 (fun univnames _56_1453 -> (match (_56_1453) with
| (l, generalized_univs, t, c) -> begin
((l), ((FStar_List.append univnames generalized_univs)), (t), (c))
...
| Some (f) -> begin
(let _151_845 = (FStar_TypeChecker_Rel.apply_guard f e)
in (FStar_All.pipe_left (fun _151_844 -> Some (_151_844)) _151_845))
end)
end)
in (

let is_var = (fun e -> (match ((let _151_848 = (FStar_Syntax_Subst.compress e)
in _151_848.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_name (_56_1469) -> begin
true
end
| _56_1472 -> begin
false
...
let _56_1479 = x
in {FStar_Syntax_Syntax.ppname = _56_1479.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1479.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) (Some (t2.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
end
| _56_1482 -> begin
(

let _56_1483 = e
in (let _151_853 = (FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)))
in {FStar_Syntax_Syntax.n = _56_1483.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _151_853; FStar_Syntax_Syntax.pos = _56_1483.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1483.FStar_Syntax_Syntax.vars}))
end)))
in (
...
let _56_1485 = env
in (let _151_854 = (env.FStar_TypeChecker_Env.use_eq || (env.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = _56_1485.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _56_1485.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _56_1485.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _56_1485.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _56_1485.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _56_1485.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _56_1485.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _56_1485.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _56_1485.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _56_1485.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _56_1485.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _56_1485.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _56_1485.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _56_1485.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _56_1485.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _151_854; FStar_TypeChecker_Env.is_iface = _56_1485.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _56_1485.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _56_1485.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _56_1485.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _56_1485.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _56_1485.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _56_1485.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _56_1485.FStar_TypeChecker_Env.qname_and_index}))
in (match ((check env t1 t2)) with
| None -> begin
(let _151_858 = (let _151_857 = (let _151_856 = (FStar_TypeChecker_Errors.expected_expression_of_type env t2 e t1)
in (let _151_855 = (FStar_TypeChecker_Env.get_range env)
...
let _56_1491 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _151_859 = (FStar_TypeChecker_Rel.guard_to_string env g)
in (FStar_All.pipe_left (FStar_Util.print1 "Applied guard is %s\n") _151_859))
end else begin
()
end
in (let _151_860 = (decorate e t2)
in ((_151_860), (g))))
end)))))))
...
let _56_1498 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (FStar_Syntax_Util.is_pure_lcomp lc)))
in (

let g = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
in if (FStar_Syntax_Util.is_total_lcomp lc) then begin
(let _151_870 = (discharge g)
in (let _151_869 = (lc.FStar_Syntax_Syntax.comp ())
...
let c = (let _151_873 = (let _151_872 = (let _151_871 = (FStar_TypeChecker_Normalize.unfold_effect_abbrev env c)
in (FStar_All.pipe_right _151_871 FStar_Syntax_Syntax.mk_Comp))
in (FStar_All.pipe_right _151_872 (FStar_TypeChecker_Normalize.normalize_comp steps env)))
in (FStar_All.pipe_right _151_873 (FStar_TypeChecker_Normalize.comp_to_comp_typ env)))
in (

let md = (FStar_TypeChecker_Env.get_effect_decl env c.FStar_Syntax_Syntax.effect_name)
in (

let _56_1508 = (destruct_comp c)
in (match (_56_1508) with
| (u_t, t, wp) -> begin
(

let vc = (let _151_879 = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_t)::[]) env md md.FStar_Syntax_Syntax.trivial)
in (let _151_878 = (let _151_876 = (FStar_Syntax_Syntax.as_arg t)
in (let _151_875 = (let _151_874 = (FStar_Syntax_Syntax.as_arg wp)
in (_151_874)::[])
in (_151_876)::_151_875))
in (let _151_877 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk_Tm_app _151_879 _151_878 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) _151_877))))
in (

let _56_1510 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
(let _151_880 = (FStar_Syntax_Print.term_to_string vc)
...
let g = (let _151_881 = (FStar_All.pipe_left FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (vc)))
in (FStar_TypeChecker_Rel.conj_guard g _151_881))
in (let _151_883 = (discharge g)
in (let _151_882 = (FStar_Syntax_Syntax.mk_Comp c)
...
let op_and_e = (fun e -> (let _151_904 = (FStar_Syntax_Util.b2t e)
in (FStar_All.pipe_right _151_904 (fun _151_903 -> FStar_TypeChecker_Common.NonTrivial (_151_903)))))
in (

let op_or_e = (fun e -> (let _151_909 = (let _151_907 = (FStar_Syntax_Util.b2t e)
in (FStar_Syntax_Util.mk_neg _151_907))
in (FStar_All.pipe_right _151_909 (fun _151_908 -> FStar_TypeChecker_Common.NonTrivial (_151_908)))))
in (

let op_and_t = (fun t -> (FStar_All.pipe_right t (fun _151_912 -> FStar_TypeChecker_Common.NonTrivial (_151_912))))
in (

let op_or_t = (fun t -> (let _151_916 = (FStar_All.pipe_right t FStar_Syntax_Util.mk_neg)
in (FStar_All.pipe_right _151_916 (fun _151_915 -> FStar_TypeChecker_Common.NonTrivial (_151_915)))))
in (

let op_imp_t = (fun t -> (FStar_All.pipe_right t (fun _151_919 -> FStar_TypeChecker_Common.NonTrivial (_151_919))))
in (
...
| ((guard, _56_1540))::[] -> begin
FStar_TypeChecker_Common.NonTrivial (guard)
end
| (_then)::((guard, _56_1545))::[] -> begin
(let _151_923 = (FStar_Syntax_Util.mk_neg guard)
in (FStar_All.pipe_right _151_923 (fun _151_922 -> FStar_TypeChecker_Common.NonTrivial (_151_922))))
end
| _56_1550 -> begin
...
in (match ((FStar_Util.find_map table (fun _56_1558 -> (match (_56_1558) with
| (x, mk) -> begin
if (FStar_Ident.lid_equals x lid) then begin
(let _151_956 = (mk seen_args)
in Some (_151_956))
end else begin
None
end
...
let short_circuit_head : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun l -> (match ((let _151_959 = (FStar_Syntax_Util.un_uinst l)
in _151_959.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
in (match (bs) with
| ((_56_1585, Some (FStar_Syntax_Syntax.Implicit (_56_1587))))::_56_1583 -> begin
bs
end
| _56_1593 -> begin
...
| Some (t) -> begin
(match ((let _151_966 = (FStar_Syntax_Subst.compress t)
in _151_966.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs', _56_1599) -> begin
(match ((FStar_Util.prefix_until (fun _56_8 -> (match (_56_8) with
| (_56_1604, Some (FStar_Syntax_Syntax.Implicit (_56_1606))) -> begin
false
end
| _56_1611 -> begin
true
...
| Some ([], _56_1615, _56_1617) -> begin
bs
end
| Some (imps, _56_1622, _56_1624) -> begin
if (FStar_All.pipe_right imps (FStar_Util.for_all (fun _56_1630 -> (match (_56_1630) with
| (x, _56_1629) -> begin
...
let imps = (FStar_All.pipe_right imps (FStar_List.map (fun _56_1634 -> (match (_56_1634) with
| (x, i) -> begin
(let _151_970 = (FStar_Syntax_Syntax.set_range_of_bv x r)
in ((_151_970), (i)))
end))))
...
(let _151_979 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic_lift (((m1), (m2))))))) _151_979 e.FStar_Syntax_Syntax.pos))
end)))
...
(let _151_988 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic (((m), (t))))))) _151_988 e.FStar_Syntax_Syntax.pos))
end))


let effect_repr_aux = (fun only_reifiable env c u_c -> (match ((let _151_993 = (FStar_TypeChecker_Env.norm_eff_name env (FStar_Syntax_Util.comp_effect_name c))
in (FStar_TypeChecker_Env.effect_decl_opt env _151_993))) with
| None -> begin
None
end
| Some (ed) -> begin
...
let _56_1662 = (let _151_994 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
in ((c.FStar_Syntax_Syntax.result_typ), (_151_994)))
in (match (_56_1662) with
| (res_typ, wp) -> begin
(

let repr = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_c)::[]) env ed (([]), (ed.FStar_Syntax_Syntax.repr)))
in (let _151_1000 = (let _151_999 = (let _151_997 = (let _151_996 = (let _151_995 = (FStar_Syntax_Syntax.as_arg res_typ)
in (_151_995)::(wp)::[])
in ((repr), (_151_996)))
in FStar_Syntax_Syntax.Tm_app (_151_997))
in (let _151_998 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _151_999 None _151_998)))
in Some (_151_1000)))
end)))
end)
end
...
let no_reify = (fun l -> (let _151_1018 = (let _151_1017 = (let _151_1016 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _151_1015 = (FStar_TypeChecker_Env.get_range env)
in ((_151_1016), (_151_1015))))
in FStar_Syntax_Syntax.Error (_151_1017))
in (Prims.raise _151_1018)))
in (match ((let _151_1019 = (c.FStar_Syntax_Syntax.comp ())
in (effect_repr_aux true env _151_1019 u_c))) with
| None -> begin
...
let _56_1681 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
(

let _56_1679 = (d (FStar_Ident.text_of_lid lident))
in (let _151_1028 = (FStar_Syntax_Print.term_to_string def)
in (FStar_Util.print2 "Registering top-level definition: %s\n%s\n" (FStar_Ident.text_of_lid lident) _151_1028)))
end else begin
()
end
in (

let fv = (let _151_1029 = (FStar_Syntax_Util.incr_delta_qualifier def)
in (FStar_Syntax_Syntax.lid_as_fv lident _151_1029 None))
in (
...
in (let _151_1030 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar (fv)) None FStar_Range.dummyRange)
in ((sig_ctx), (_151_1030)))))))))
...
let err' = (fun msg -> (let _151_1065 = (let _151_1064 = (let _151_1063 = (let _151_1062 = (FStar_Syntax_Print.quals_to_string quals)
in (FStar_Util.format2 "The qualifier list \"[%s]\" is not permissible for this element%s" _151_1062 msg))
in ((_151_1063), (r)))
in FStar_Syntax_Syntax.Error (_151_1064))
in (Prims.raise _151_1065)))
in (

let err = (fun msg -> (err' (Prims.strcat ": " msg)))
in (

let err' = (fun _56_1780 -> (match (()) with
| () -> begin
(err' "")
end))
in (

let _56_1781 = if ((FStar_List.length quals) <> (FStar_List.length no_dup_quals)) then begin
...
let _56_1783 = if (not ((FStar_All.pipe_right quals (FStar_List.for_all (quals_combo_ok quals))))) then begin
(err "ill-formed combination")
end else begin
()
end
in (match (se) with
| FStar_Syntax_Syntax.Sig_let ((is_rec, _56_1787), _56_1790, _56_1792, _56_1794) -> begin
(

let _56_1797 = if (is_rec && (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen))) then begin
...
| FStar_Syntax_Syntax.Sig_bundle (_56_1801) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (_56_1805) -> begin
...
| FStar_Syntax_Syntax.Sig_assume (_56_1808) -> begin
...
| FStar_Syntax_Syntax.Sig_new_effect (_56_1812) -> begin
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_56_1816) -> begin
if (not ((FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x))))))) then begin
(err' ())
end else begin
()
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (_56_1820) -> begin
