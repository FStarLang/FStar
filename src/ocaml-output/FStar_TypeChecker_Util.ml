...
let report:
  ...
  fun env  ->
    fun errs  ->
      ...
      let _0_237 = FStar_TypeChecker_Err.failed_to_prove_specification errs in
        ...
        let uu____43 =
          (FStar_Options.full_context_dependency ()) ||
            (let _0_240 = FStar_TypeChecker_Env.current_module env in
             FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _0_240) in
        if uu____43
...
let force_sort':
  ...
  fun s  ->
    ...
    | None  ->
        failwith
          (let _0_253 = FStar_Range.string_of_range s.FStar_Syntax_Syntax.pos in
                         ...
                         (let _0_259 =
                            FStar_Util.Inl
                              (let _0_258 =
                               ...
                               FStar_All.pipe_right _0_258 Prims.fst) in
                          (_0_259, false)) in
                 let uu____587 =
                   ...
                   let e =
                     (FStar_Syntax_Syntax.mk
                        (FStar_Syntax_Syntax.Tm_meta
                           (let _0_268 =
                              (let _0_267 = FStar_Syntax_Syntax.fv_to_tm fv in
                               let _0_266 =
               ...
               | (uu____1230,t) ->
                   ...
                   (match uu____1232 with
                    | (f,uu____1243) ->
                        ...
                        let _0_283 =
                          FStar_Syntax_Syntax.Pat_cons
                            (let _0_282 = aux f pats in (fv, _0_282)) in
                        {
                          FStar_Syntax_Syntax.v = _0_283;
                          FStar_Syntax_Syntax.ty =
                                 ...
                                 | (b',a',w',arg,p) ->
                                     ...
                                     then
                                       ...
                                       (let _0_288 =
                                          ...
                                          _0_287 :: args in
                                        ((FStar_List.append w' w), _0_288, (p
                                          :: pats))))) pats ([], [], []) in
          ...
          | uu____1766 ->
              ...
              (match uu____1767 with
               | (b,uu____1782,uu____1783,arg,p) ->
                   let _0_292 =
                     let _0_291 = FStar_Syntax_Syntax.as_arg arg in [_0_291] in
                   (b, _0_292, p)) in
               ...
               (let fv = fv' in
                let rec match_args matched_pats args argpats =
                  ...
                  | ([],[]) ->
                      ...
                      pkg
                        (FStar_Syntax_Syntax.Pat_cons
                           (fv, (FStar_List.rev matched_pats))) _0_302
                      ...
                      (match (arg, (argpat.FStar_Syntax_Syntax.v)) with
                       | ((e,Some (FStar_Syntax_Syntax.Implicit (true ))),FStar_Syntax_Syntax.Pat_dot_term
                          uu____2146) ->
                           let x =
                             ...
                             FStar_Syntax_Syntax.new_bv
                               (Some (p.FStar_Syntax_Syntax.p)) _0_303 in
                           let q =
                             FStar_Syntax_Syntax.withinfo
                               (FStar_Syntax_Syntax.Pat_dot_term (x, e))
                       ...
                       | ((e,imp),uu____2175) ->
                           let pat =
                             ...
                             let _0_304 = FStar_Syntax_Syntax.is_implicit imp in
                             (_0_305, _0_304) in
...
let rec decorated_pattern_as_term:
  ...
  fun pat  ->
    ...
    | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
        let uu____2328 =
          let _0_316 = FStar_All.pipe_right pats (FStar_List.map pat_as_arg) in
          ...
          failwith
            (let _0_320 =
             ...
             FStar_Util.format2
               ...
               (c.FStar_Syntax_Syntax.effect_name).FStar_Ident.str _0_320) in
      ...
      fun lift  ->
        ...
        | (u,uu____2476,wp) ->
              ...
              [_0_322] in
            {
              ...
              FStar_Syntax_Syntax.effect_args = _0_323;
  ...
  fun subst  ->
    fun lc  ->
        ...
        FStar_Syntax_Subst.subst subst lc.FStar_Syntax_Syntax.res_typ in
      {
        ...
        FStar_Syntax_Syntax.res_typ = _0_331;
    ...
    fun t  ->
      fun v  ->
               ...
               then FStar_Syntax_Syntax.tun
                 ...
                 (let uu____2686 =
                  ...
                  | (a,kwp) ->
                      ...
                      FStar_TypeChecker_Normalize.normalize
                        [FStar_TypeChecker_Normalize.Beta] env _0_338) in
        ...
        (let uu____2699 =
         ...
         if uu____2699
         then
           let _0_341 = FStar_Range.string_of_range v.FStar_Syntax_Syntax.pos in
           let _0_340 = FStar_Syntax_Print.term_to_string v in
           let _0_339 = FStar_TypeChecker_Normalize.comp_to_string env c in
                       ...
                       (let uu____2745 =
                        ...
                        then
                          let _0_349 =
                            ...
                            | None  -> "none"
                            | Some x -> FStar_Syntax_Print.bv_to_string x in
                          let _0_348 = FStar_Syntax_Print.lcomp_to_string lc1 in
                          let _0_347 = FStar_Syntax_Print.comp_to_string c1 in
                          let _0_346 = FStar_Syntax_Print.lcomp_to_string lc2 in
                          let _0_345 = FStar_Syntax_Print.comp_to_string c2 in
                          FStar_Util.print5
                            "b=%s,Evaluated %s to %s\n And %s to %s\n" _0_349
                            _0_348 _0_347 _0_346 _0_345
                        else ());
                             ...
                             | ((md,a,kwp),(u_t1,t1,wp1),(u_t2,t2,wp2)) ->
                                 ...
                                 let r1 =
                                   (FStar_Syntax_Syntax.mk
                                     ...
                                     r1 in
                                 let wp_args =
                                   let _0_362 = FStar_Syntax_Syntax.as_arg r1 in
                                   let _0_361 =
                                     let _0_360 =
      ...
      fun r  ->
        fun f  ->
          ...
          | Some reason ->
              ...
              if uu____2994
              then f
              else (let _0_365 = reason () in label _0_365 r f)
let label_guard:
  FStar_Range.range ->
    Prims.string ->
    ...
    fun reason  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            {
              FStar_TypeChecker_Env.guard_f = _0_366;
              FStar_TypeChecker_Env.deferred =
                    ...
                    | (u_res_t,res_t,wp) ->
                        ...
                        let wp =
                          (let _0_373 =
                           ...
                           let _0_372 =
                             let _0_371 = FStar_Syntax_Syntax.as_arg res_t in
                             let _0_370 =
                               let _0_369 = FStar_Syntax_Syntax.as_arg f in
                               let _0_368 =
                                 let _0_367 = FStar_Syntax_Syntax.as_arg wp in
                                 [_0_367] in
                               _0_369 :: _0_368 in
                             _0_371 :: _0_370 in
                           FStar_Syntax_Syntax.mk_Tm_app _0_373 _0_372) None
            ...
            then (lc, g0)
              ...
              ((let uu____3098 =
                ...
                then
                  ...
                  let _0_374 = FStar_TypeChecker_Rel.guard_to_string env g0 in
                  FStar_Util.print2
                                 ...
                                 (let _0_388 =
                                  ...
                                  let _0_387 =
                                    ...
                                    let _0_385 =
                                      let _0_384 =
                                        let _0_381 =
                                          let _0_380 =
                                            FStar_TypeChecker_Env.get_range
                                              env in
                                          label_opt env reason _0_380 f in
                                        FStar_All.pipe_left
                                          FStar_Syntax_Syntax.as_arg _0_381 in
                                      let _0_383 =
                                        let _0_382 =
                                      ...
                                      _0_384 :: _0_383 in
                                    _0_386 :: _0_385 in
                                  FStar_Syntax_Syntax.mk_Tm_app _0_388 _0_387)
                    ...
                    let uu____3163 =
                      (FStar_Syntax_Util.is_pure_lcomp lc) &&
                        (let _0_390 =
                         ...
                         FStar_All.pipe_left Prims.op_Negation _0_390) in
    ...
    fun comp  ->
      fun res_t  ->
        ...
        let uu____3181 =
          ...
          let _0_394 = FStar_Syntax_Syntax.bv_to_name y in (_0_395, _0_394) in
            ...
            let yret =
              (let _0_400 =
               ...
               let _0_399 =
                 ...
                 let _0_397 =
                   let _0_396 = FStar_Syntax_Syntax.as_arg yexp in [_0_396] in
                 _0_398 :: _0_397 in
               ...
               let _0_407 =
                 ...
                 let _0_405 =
                   let _0_404 =
                     ...
                     FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_401 in
                   let _0_403 =
                     let _0_402 =
                         ...
                         FStar_Syntax_Util.abs _0_410 x_eq_y_yret
                           (Some
                              (FStar_Util.Inr
                                 (FStar_Syntax_Const.effect_Tot_lid,
                                   [FStar_Syntax_Syntax.TOTAL]))) in
                       FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_411 in
                     [_0_412] in
                   _0_414 :: _0_413 in
                 _0_416 :: _0_415 in
    ...
    fun guard  ->
      fun lcomp_then  ->
        fun lcomp_else  ->
                     ...
                     (let _0_430 =
                      ...
                      let _0_429 =
                        ...
                        let _0_427 =
                          ...
                          let _0_425 =
                            let _0_424 = FStar_Syntax_Syntax.as_arg wp_t in
                            let _0_423 =
                              let _0_422 = FStar_Syntax_Syntax.as_arg wp_e in
                              [_0_422] in
                            _0_424 :: _0_423 in
                          _0_426 :: _0_425 in
                        _0_428 :: _0_427 in
                     ...
                     (let wp =
                        (let _0_437 =
                         ...
                         let _0_436 =
                           ...
                           let _0_434 =
                             let _0_433 = FStar_Syntax_Syntax.as_arg wp in
                             [_0_433] in
                           _0_435 :: _0_434 in
          ...
          {
            FStar_Syntax_Syntax.eff_name = _0_438;
            FStar_Syntax_Syntax.res_typ =
              (lcomp_then.FStar_Syntax_Syntax.res_typ);
            FStar_Syntax_Syntax.cflags = [];
               ...
               (let _0_449 =
                ...
                let _0_448 =
                  ...
                  let _0_446 =
                    ...
                    _0_445 :: _0_444 in
                  _0_447 :: _0_446 in
                FStar_Syntax_Syntax.mk_Tm_app _0_449 _0_448) None _0_450 in
             let default_case =
               let post_k =
                 let _0_453 =
               ...
               let wp =
                 ...
                 let _0_461 =
                   let _0_460 =
                     ...
                     label FStar_TypeChecker_Err.exhaustiveness_check _0_458 in
                   let _0_459 = fvar_const env FStar_Syntax_Const.false_lid in
               ...
               FStar_List.fold_right
                 (fun uu____3389  ->
                    fun celse  ->
                      ...
                      | (g,cthen) ->
                          let uu____3395 =
                            let _0_463 = cthen.FStar_Syntax_Syntax.comp () in
                ...
                | (uu____3434,uu____3435,wp) ->
                    let wp =
                      (let _0_470 =
                       ...
                       let _0_469 =
                         let _0_468 = FStar_Syntax_Syntax.as_arg res_t in
                         let _0_467 =
               ...
               (let close_wp u_res md res_t bvs wp0 =
                  FStar_List.fold_right
                    (fun x  ->
                       fun wp  ->
                         let bs =
                           let _0_471 = FStar_Syntax_Syntax.mk_binder x in
                           [_0_471] in
                         let us =
                           let _0_473 =
                             let _0_472 =
                         ...
                         (let _0_480 =
                          ...
                          let _0_479 =
                            let _0_478 = FStar_Syntax_Syntax.as_arg res_t in
                            let _0_477 =
                              let _0_476 =
                                FStar_Syntax_Syntax.as_arg
                                  x.FStar_Syntax_Syntax.sort in
                              let _0_475 =
                                let _0_474 = FStar_Syntax_Syntax.as_arg wp in
                                [_0_474] in
                              _0_476 :: _0_475 in
                            _0_478 :: _0_477 in
                          FStar_Syntax_Syntax.mk_Tm_app _0_480 _0_479) None
  ...
  fun env  ->
    fun e  ->
      fun lc  ->
                ...
                then
                  failwith
                    (let _0_482 =
                     ...
                     let _0_481 = FStar_Syntax_Print.term_to_string e in
        ...
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___129_3588.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___129_3588.FStar_Syntax_Syntax.res_typ);
                     ...
                     let _0_490 =
                       let _0_489 =
                         ...
                         FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp
                           _0_488 in
                       (None, _0_489) in
                     bind e.FStar_Syntax_Syntax.pos env (Some e) lc _0_490 in
                   let e =
                     (let _0_492 =
                        let _0_491 = FStar_Syntax_Syntax.as_arg e in [_0_491] in
              ...
              (FStar_TypeChecker_Rel.subtype_fail env e
               ...
               (e,
                 ((let uu___130_3693 = lc in
                   {
                     FStar_Syntax_Syntax.eff_name =
                       (uu___130_3693.FStar_Syntax_Syntax.eff_name);
                     FStar_Syntax_Syntax.res_typ = t;
                     FStar_Syntax_Syntax.cflags =
                       (uu___130_3693.FStar_Syntax_Syntax.cflags);
                     FStar_Syntax_Syntax.comp =
                       (uu___130_3693.FStar_Syntax_Syntax.comp)
              ...
              (match uu____3697 with
               | FStar_TypeChecker_Common.Trivial  ->
                   let lc =
                     ...
                     {
                       FStar_Syntax_Syntax.eff_name =
                         (uu___131_3702.FStar_Syntax_Syntax.eff_name);
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags =
                         (uu___131_3702.FStar_Syntax_Syntax.cflags);
                       FStar_Syntax_Syntax.comp =
                   ...
                   let g =
                     let uu___132_3705 = g in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___132_3705.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___132_3705.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                       ...
                       (let f =
                        ...
                        | FStar_Syntax_Syntax.Tm_abs
                            (uu____3720,{
                                          ...
                                          FStar_Syntax_Syntax.tk = uu____3722;
                   ...
                   let lc =
                     ...
                     let _0_514 =
                       FStar_TypeChecker_Env.norm_eff_name env
                         lc.FStar_Syntax_Syntax.eff_name in
                     {
                       FStar_Syntax_Syntax.eff_name = _0_514;
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags = flags;
                       FStar_Syntax_Syntax.comp = strengthen
                     } in
                   let g =
                     let uu___136_3834 = g in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___136_3834.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___136_3834.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         ...
                         (match uu____3952 with
                          | (us_e,uu____3959) ->
                              ...
                              let as_req =
                                ...
                                FStar_Syntax_Syntax.mk_Tm_uinst _0_523 us_r in
                              let as_ens =
                                let _0_524 =
                                  FStar_Syntax_Syntax.fvar
                                    (FStar_Ident.set_lid_range
                                    ...
                                    FStar_Syntax_Syntax.Delta_equational None in
                                FStar_Syntax_Syntax.mk_Tm_uinst _0_524 us_e in
                              let req =
                                (let _0_527 =
                                   let _0_526 =
                                     let _0_525 =
                                   ...
                                   ((ct.FStar_Syntax_Syntax.result_typ),
                                     ...
                                     _0_526 in
                                 FStar_Syntax_Syntax.mk_Tm_app as_req _0_527)
                                  (Some
                                     (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n))
                                  (ct.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
                              let ens =
                                (let _0_530 =
                                   ...
                                   ((ct.FStar_Syntax_Syntax.result_typ),
                                     (Some FStar_Syntax_Syntax.imp_tag)) ::
                                     _0_529 in
                                 FStar_Syntax_Syntax.mk_Tm_app as_ens _0_530)
                                  None
                                  (ct.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
             ...
             | Some expected_t ->
                 ...
                 then
                   Prims.raise
                     (FStar_Errors.Error
                        (let _0_537 =
                           let _0_535 = FStar_Util.string_of_int n_expected in
                           let _0_534 = FStar_Syntax_Print.term_to_string e in
                           let _0_533 = FStar_Util.string_of_int n_available in
                           FStar_Util.format3
                             "Expected a term with %s implicit arguments, but %s has only %s"
                             _0_535 _0_534 _0_533 in
                         let _0_536 = FStar_TypeChecker_Env.get_range env in
                         (_0_537, _0_536)))
                               ...
                               (match uu____4342 with
                                | (args,bs,subst,g') ->
                                    ...
                                    (((v,
                                      ...
                                      :: args), bs, subst, _0_539)))
                      | (uu____4404,bs) ->
                          ([], bs, subst,
                            FStar_TypeChecker_Rel.trivial_guard) in
                    let uu____4428 =
                      let _0_540 = inst_n_binders t in aux [] _0_540 bs in
                         ...
                         (match (args, bs) with
                          ...
                          | uu____4510 ->
                              let t =
                                ...
                                | uu____4529 -> FStar_Syntax_Util.arrow bs c in
    ...
    FStar_All.pipe_right _0_542
      (FStar_List.map
         (fun u  ->
            ...
            FStar_All.pipe_right _0_541 FStar_Util.string_of_int)) in
                    ...
                    (let uu____4598 =
                     ...
                     then
                       let _0_550 =
                         ...
                         FStar_All.pipe_left FStar_Util.string_of_int _0_547 in
                       let _0_549 =
       ...
       let generalized_lecs =
         let uu____5437 =
           let _0_570 =
             FStar_All.pipe_right lecs
               (FStar_List.map
                  (fun uu____5456  ->
                     match uu____5456 with | (uu____5462,e,c) -> (e, c))) in
           gen env _0_570 in
         ...
         | None  ->
             FStar_All.pipe_right lecs
               (FStar_List.map
                  (fun uu____5494  ->
                     match uu____5494 with | (l,t,c) -> (l, [], t, c)))
         | Some ecs ->
             FStar_List.map2
               (fun uu____5538  ->
                  fun uu____5539  ->
                    match (uu____5538, uu____5539) with
                    | ((l,uu____5572,uu____5573),(us,e,c)) ->
                        ((let uu____5599 =
                            FStar_TypeChecker_Env.debug env
                          ...
                          then
                            ...
                            let _0_571 = FStar_Syntax_Print.term_to_string e in
                            FStar_Util.print4
        ...
        fun t2  ->
          ...
          let check env t1 t2 =
            ...
            then FStar_TypeChecker_Rel.try_teq env t1 t2
              ...
              (let uu____5667 = FStar_TypeChecker_Rel.try_subtype env t1 t2 in
               match uu____5667 with
               | None  -> None
               | Some f ->
                   let _0_577 = FStar_TypeChecker_Rel.apply_guard f e in
                   FStar_All.pipe_left (fun _0_576  -> Some _0_576) _0_577) in
          let is_var e =
            let uu____5676 =
          ...
          let decorate e t =
                ...
                (FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_name
                      (let uu___137_5700 = x in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___137_5700.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___137_5700.FStar_Syntax_Syntax.index);
            ...
            | uu____5701 ->
                ...
                {
                  FStar_Syntax_Syntax.n =
                    (uu___138_5702.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk = _0_578;
                  FStar_Syntax_Syntax.pos =
                    (uu___138_5702.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
          ...
          let env =
                ...
                (env.FStar_TypeChecker_Env.is_pattern && (is_var e)) in
            {
              FStar_TypeChecker_Env.solver =
                (uu___139_5709.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___139_5709.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___139_5709.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___139_5709.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___139_5709.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___139_5709.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___139_5709.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___139_5709.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___139_5709.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___139_5709.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___139_5709.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___139_5709.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___139_5709.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___139_5709.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___139_5709.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = _0_579;
              FStar_TypeChecker_Env.is_iface =
                (uu___139_5709.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___139_5709.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___139_5709.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___139_5709.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.type_of =
                (uu___139_5709.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___139_5709.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___139_5709.FStar_TypeChecker_Env.use_bv_sorts);
          ...
          | Some g ->
              ((let uu____5718 =
                ...
                if uu____5718
                then
                  let _0_582 = FStar_TypeChecker_Rel.guard_to_string env g in
                  FStar_All.pipe_left
               ...
               let vc =
                 ...
                 (let _0_593 =
                  ...
                  let _0_592 =
                    ...
                    let _0_590 =
                      let _0_589 = FStar_Syntax_Syntax.as_arg wp in [_0_589] in
                    _0_591 :: _0_590 in
...
let short_circuit:
  ...
  fun head  ->
    fun seen_args  ->
      let short_bin_op f uu___96_5797 =
        match uu___96_5797 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_and_e e =
        ...
        FStar_All.pipe_right _0_600
          (fun _0_599  -> FStar_TypeChecker_Common.NonTrivial _0_599) in
      let op_or_e e =
      ...
      let op_or_t t =
        ...
        FStar_All.pipe_right _0_605
          (fun _0_604  -> FStar_TypeChecker_Common.NonTrivial _0_604) in
      let op_imp_t t =
        FStar_All.pipe_right t
...
let maybe_add_implicit_binders:
  ...
  fun env  ->
    fun bs  ->
      ...
      match bs with
      | (uu____6001,Some (FStar_Syntax_Syntax.Implicit uu____6002))::uu____6003
          -> bs
      | uu____6012 ->
                      ...
                      FStar_Util.prefix_until
                        (fun uu___98_6048  ->
                           ...
                           | (uu____6052,Some (FStar_Syntax_Syntax.Implicit
                              uu____6053)) -> false
                           | uu____6055 -> true) bs' in
                    (match uu____6029 with
                     | None  -> bs
                     | Some ([],uu____6073,uu____6074) -> bs
                     | Some (imps,uu____6111,uu____6112) ->
                         let uu____6149 =
      ...
      then None
        ...
        (match (ed.FStar_Syntax_Syntax.repr).FStar_Syntax_Syntax.n with
         ...
         | uu____6307 ->
             ...
             let uu____6309 =
               let _0_627 = FStar_List.hd c.FStar_Syntax_Syntax.effect_args in
                  ...
                  Some
                    (let _0_630 = FStar_TypeChecker_Env.get_range env in
                     (FStar_Syntax_Syntax.mk
                        (FStar_Syntax_Syntax.Tm_app
                           (let _0_629 =
                              let _0_628 = FStar_Syntax_Syntax.as_arg res_typ in
                              [_0_628; wp] in
...
let check_sigelt_quals:
  ...
  fun env  ->
    fun se  ->
      let visibility uu___99_6456 =
        match uu___99_6456 with
      ...
      then
        ...
        (if (FStar_List.length quals) <> (FStar_List.length no_dup_quals)
         ...
         (let uu____6543 =
          ...
          if uu____6543 then err "ill-formed combination" else ());
         (match se with
          | FStar_Syntax_Syntax.Sig_let
                                   ...
                                   let _0_644 =
                                     let _0_643 =
                                       let _0_642 =
                                         FStar_Syntax_Syntax.bv_to_name x in
                                       FStar_All.pipe_left
                                         FStar_Syntax_Syntax.as_arg _0_642 in
                                     [_0_643] in
      ...
      fun tcs  ->
        fun se  ->
          ...
          | FStar_Syntax_Syntax.Sig_datacon
              (constr_lid,uvs,t,typ_lid,n_typars,quals,uu____7188,r) when
              Prims.op_Negation
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____7313 with
                              | (indices,uu____7323) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___110_7350 =
                                      match uu___110_7350 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____7352,fns) ->
                                          Some
