                   ...
                   | FStar_Syntax_Syntax.Tm_unknown  ->
                       ...
                       (match uu____376 with
                        | (k,uu____382) ->
                            ...
                            ((let uu___119_389 = a in
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___119_389.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index =
                                  (uu___119_389.FStar_Syntax_Syntax.index);
      ...
      fun exp  ->
        ...
        let rec aux p1 e =
              ...
              (if Prims.op_Negation (FStar_Syntax_Syntax.bv_eq x y)
               ...
               (let s =
                  FStar_TypeChecker_Normalize.normalize
                    ...
                    y.FStar_Syntax_Syntax.sort in
                let x1 =
                  let uu___126_1841 = x in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___126_1841.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___126_1841.FStar_Syntax_Syntax.index);
              ...
              ((let uu____1845 =
               ...
               (let s =
                  FStar_TypeChecker_Normalize.normalize
                    ...
                    y.FStar_Syntax_Syntax.sort in
                let x1 =
                  let uu___127_1852 = x in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___127_1852.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___127_1852.FStar_Syntax_Syntax.index);
                    FStar_Syntax_Syntax.sort = s
                  } in
          ...
          | (FStar_Syntax_Syntax.Pat_dot_term (x,uu____1854),uu____1855) ->
              ...
              let x1 =
                let uu___128_1864 = x in
                {
                  FStar_Syntax_Syntax.ppname =
                    (uu___128_1864.FStar_Syntax_Syntax.ppname);
                  FStar_Syntax_Syntax.index =
                    (uu___128_1864.FStar_Syntax_Syntax.index);
                  FStar_Syntax_Syntax.sort = s
                } in
...
let subst_lcomp:
  ...
  fun subst1  ->
    fun lc  ->
      let uu___129_2870 = lc in
      let uu____2871 =
        FStar_Syntax_Subst.subst subst1 lc.FStar_Syntax_Syntax.res_typ in
      {
        FStar_Syntax_Syntax.eff_name =
          (uu___129_2870.FStar_Syntax_Syntax.eff_name);
        FStar_Syntax_Syntax.res_typ = uu____2871;
        FStar_Syntax_Syntax.cflags =
          (uu___129_2870.FStar_Syntax_Syntax.cflags);
        FStar_Syntax_Syntax.comp =
          (fun uu____2874  ->
  ...
  fun env  ->
    fun bvs  ->
      fun lc  ->
        ...
        let uu___130_2991 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___130_2991.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___130_2991.FStar_Syntax_Syntax.res_typ);
          FStar_Syntax_Syntax.cflags =
            (uu___130_2991.FStar_Syntax_Syntax.cflags);
                                       ...
                                       then
                                         let c21 =
                                           FStar_Syntax_Subst.subst_comp
                                             ...
                                             c2 in
                                         let x1 =
                                           let uu___131_3296 = x in
                                           {
                                             FStar_Syntax_Syntax.ppname =
                                               (uu___131_3296.FStar_Syntax_Syntax.ppname);
                                             FStar_Syntax_Syntax.index =
                                               (uu___131_3296.FStar_Syntax_Syntax.index);
      ...
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____3475 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___132_3473.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___132_3473.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___132_3473.FStar_TypeChecker_Env.implicits)
            }
let weaken_guard:
                        ...
                        let wp1 =
                          let uu____3533 =
                            ...
                            FStar_Syntax_Syntax.mk_Tm_app uu____3534
                              uu____3535 in
                          uu____3533 None wp.FStar_Syntax_Syntax.pos in
                        mk_comp md u_res_t res_t wp1
                          c1.FStar_Syntax_Syntax.flags)) in
        let uu___133_3547 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___133_3547.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___133_3547.FStar_Syntax_Syntax.res_typ);
          FStar_Syntax_Syntax.cflags =
            (uu___133_3547.FStar_Syntax_Syntax.cflags);
               ...
               (let flags =
                               ...
                               let wp1 =
                                 let uu____3642 =
                                   ...
                                   FStar_Syntax_Syntax.mk_Tm_app uu____3643
                                     uu____3644 in
                                 uu____3642 None wp.FStar_Syntax_Syntax.pos in
                               ((let uu____3659 =
                                   FStar_All.pipe_left
                                     (FStar_TypeChecker_Env.debug env)
                                     FStar_Options.Extreme in
                ...
                let uu____3663 =
                    ...
                    if uu____3668 then flags else [] in
                  {
                    ...
                    FStar_Syntax_Syntax.res_typ =
                      (uu___134_3664.FStar_Syntax_Syntax.res_typ);
                    FStar_Syntax_Syntax.cflags = uu____3666;
                    FStar_Syntax_Syntax.comp = strengthen
                  } in
                (uu____3663,
                  (let uu___135_3672 = g0 in
                   {
                     FStar_TypeChecker_Env.guard_f =
                       FStar_TypeChecker_Common.Trivial;
                     FStar_TypeChecker_Env.deferred =
                       (uu___135_3672.FStar_TypeChecker_Env.deferred);
                     FStar_TypeChecker_Env.univ_ineqs =
                       (uu___135_3672.FStar_TypeChecker_Env.univ_ineqs);
                     FStar_TypeChecker_Env.implicits =
                       (uu___135_3672.FStar_TypeChecker_Env.implicits)
                   }))))
      ...
      fun res_t  ->
        ...
        | (xexp,yexp) ->
            ...
            let yret =
              ...
              uu____3700 None res_t.FStar_Syntax_Syntax.pos in
            let x_eq_y_yret =
              let uu____3714 =
                let uu____3715 =
                  FStar_TypeChecker_Env.inst_effect_fun_with [u_res_t] env
              ...
              uu____3714 None res_t.FStar_Syntax_Syntax.pos in
            let forall_y_x_eq_y_yret =
              ...
              uu____3732 None res_t.FStar_Syntax_Syntax.pos in
            let lc2 =
              mk_comp md_pure u_res_t res_t forall_y_x_eq_y_yret
                [FStar_Syntax_Syntax.PARTIAL_RETURN] in
            let lc =
              let uu____3760 = FStar_TypeChecker_Env.get_range env in
              bind uu____3760 env None (FStar_Syntax_Util.lcomp_of_comp comp)
               ...
               (let comp1 = FStar_TypeChecker_Env.comp_to_comp_typ env comp in
                ...
                | (uu____4042,uu____4043,wp) ->
                    let wp1 =
                      ...
                      uu____4048 None wp.FStar_Syntax_Syntax.pos in
                    mk_comp md u_res_t res_t wp1 [])) in
        {
  ...
  fun env  ->
    fun e  ->
      fun lc  ->
                   ...
                   then
                     ...
                     (let retc =
                      ...
                      then
                        ...
                        let retc2 =
                          let uu___136_4113 = retc1 in
                          {
                            FStar_Syntax_Syntax.comp_univs =
                              (uu___136_4113.FStar_Syntax_Syntax.comp_univs);
                            FStar_Syntax_Syntax.effect_name =
                              FStar_Syntax_Const.effect_GHOST_lid;
                            FStar_Syntax_Syntax.result_typ =
                              (uu___136_4113.FStar_Syntax_Syntax.result_typ);
                            FStar_Syntax_Syntax.effect_args =
                              (uu___136_4113.FStar_Syntax_Syntax.effect_args);
                            FStar_Syntax_Syntax.flags = flags
                          } in
        ...
        let uu___137_4141 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___137_4141.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___137_4141.FStar_Syntax_Syntax.res_typ);
                ...
                let uu____4216 =
                  let uu____4217 =
                    ...
                    FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp
                      uu____4218 in
                  (None, uu____4217) in
                bind e.FStar_Syntax_Syntax.pos env (Some e) lc uu____4216 in
              let e1 =
                let uu____4227 =
                  let uu____4228 =
        ...
        fun t  ->
          ...
          | (None ,uu____4291) ->
              (FStar_TypeChecker_Rel.subtype_fail env e
               ...
               (e,
                 ((let uu___138_4294 = lc in
                   {
                     FStar_Syntax_Syntax.eff_name =
                       (uu___138_4294.FStar_Syntax_Syntax.eff_name);
                     FStar_Syntax_Syntax.res_typ = t;
                     FStar_Syntax_Syntax.cflags =
                       (uu___138_4294.FStar_Syntax_Syntax.cflags);
                     FStar_Syntax_Syntax.comp =
                       (uu___138_4294.FStar_Syntax_Syntax.comp)
          ...
          | (Some g,apply_guard1) ->
              ...
              (match uu____4298 with
               | FStar_TypeChecker_Common.Trivial  ->
                   let lc1 =
                     let uu___139_4303 = lc in
                     {
                       FStar_Syntax_Syntax.eff_name =
                         (uu___139_4303.FStar_Syntax_Syntax.eff_name);
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags =
                         (uu___139_4303.FStar_Syntax_Syntax.cflags);
                       FStar_Syntax_Syntax.comp =
                         (uu___139_4303.FStar_Syntax_Syntax.comp)
                     } in
                   (e, lc1, g)
               | FStar_TypeChecker_Common.NonTrivial f ->
                   let g1 =
                     let uu___140_4306 = g in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___140_4306.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___140_4306.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___140_4306.FStar_TypeChecker_Env.implicits)
                     } in
                     ...
                     then lc.FStar_Syntax_Syntax.comp ()
                       ...
                       (let f1 =
                        ...
                        | FStar_Syntax_Syntax.Tm_abs
                            ...
                            ->
                            let lc1 =
                              let uu___141_4353 = lc in
                              {
                                FStar_Syntax_Syntax.eff_name =
                                  (uu___141_4353.FStar_Syntax_Syntax.eff_name);
                                FStar_Syntax_Syntax.res_typ = t;
                                FStar_Syntax_Syntax.cflags =
                                  (uu___141_4353.FStar_Syntax_Syntax.cflags);
                                FStar_Syntax_Syntax.comp =
                                  (uu___141_4353.FStar_Syntax_Syntax.comp)
                              } in
                            lc1.FStar_Syntax_Syntax.comp ()
                        | uu____4354 ->
                            let c = lc.FStar_Syntax_Syntax.comp () in
                                   ...
                                   | (u_t,uu____4384,uu____4385) ->
                                       ...
                                       (match uu____4419 with
                                        | (eq_ret,_trivial_so_ok_to_discard)
                                            ->
                                            let x1 =
                                              let uu___142_4440 = x in
                                              {
                                                FStar_Syntax_Syntax.ppname =
                                                  (uu___142_4440.FStar_Syntax_Syntax.ppname);
                                                FStar_Syntax_Syntax.index =
                                                  (uu___142_4440.FStar_Syntax_Syntax.index);
                                                FStar_Syntax_Syntax.sort =
                                                  (lc.FStar_Syntax_Syntax.res_typ)
                                              } in
                                            let c1 =
                   ...
                   let g2 =
                     let uu___144_4467 = g1 in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___144_4467.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___144_4467.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___144_4467.FStar_TypeChecker_Env.implicits)
                     } in
                   (e, lc1, g2))
    ...
    fun comp  ->
      let mk_post_type res_t ens =
        ...
        let uu____4487 =
          ...
          uu____4488 None res_t.FStar_Syntax_Syntax.pos in
             ...
             then
               (match ct.FStar_Syntax_Syntax.effect_args with
                | (req,uu____4537)::(ens,uu____4539)::uu____4540 ->
                    let uu____4562 =
                      let uu____4564 = norm req in Some uu____4564 in
                    let uu____4565 =
                      let uu____4566 =
               ...
               (let ct1 = FStar_TypeChecker_Env.unfold_effect_abbrev env comp in
                ...
                | (wp,uu____4589)::uu____4590 ->
                    let uu____4604 =
                      ...
                      FStar_All.pipe_left FStar_Pervasives.fst uu____4607 in
                          ...
                          | (us_e,uu____4645) ->
                              ...
                              let ens =
                                ...
                                uu____4679 None
                                  (ct1.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
                              let uu____4701 =
                                let uu____4703 = norm req in Some uu____4703 in
                              let uu____4704 =
                                let uu____4705 =
                                  mk_post_type
      ...
      fun t  ->
        ...
        then (e, torig, FStar_TypeChecker_Rel.trivial_guard)
          ...
          (let number_of_implicits t1 =
           ...
           let decr_inst uu___101_5024 =
             match uu___101_5024 with
             | None  -> None
               ...
               (match uu____5043 with
                | (bs1,c1) ->
                    let rec aux subst1 inst_n bs2 =
                      ...
                      | (Some _0_30,uu____5104) when
                          _0_30 = (Prims.parse_int "0") ->
                          ([], bs2, subst1,
                            FStar_TypeChecker_Rel.trivial_guard)
                      | (uu____5126,(x,Some (FStar_Syntax_Syntax.Implicit
                                     dot))::rest)
                          ->
                          let t1 =
...
let gather_free_univnames:
  ...
  fun env  ->
    fun t  ->
      ...
      univnames1
let maybe_set_tk ts uu___102_5502 =
  match uu___102_5502 with
  | None  -> ts
  | Some t ->
        ...
        fun t2  ->
            ...
            then FStar_TypeChecker_Rel.try_teq true env2 t11 t21
              ...
              (let uu____6624 =
               ...
               | Some f ->
                   ...
                   FStar_All.pipe_left (fun _0_32  -> Some _0_32) uu____6628) in
          let is_var e1 =
            let uu____6634 =
          ...
          let decorate e1 t =
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___145_6657 = x in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___145_6657.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___145_6657.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) (Some (t2.FStar_Syntax_Syntax.n))
                  e2.FStar_Syntax_Syntax.pos
            | uu____6658 ->
                let uu___146_6659 = e2 in
                let uu____6660 =
                  FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)) in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___146_6659.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk = uu____6660;
                  FStar_Syntax_Syntax.pos =
                    (uu___146_6659.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
                    (uu___146_6659.FStar_Syntax_Syntax.vars)
                } in
          let env2 =
            let uu___147_6669 = env1 in
            let uu____6670 =
              env1.FStar_TypeChecker_Env.use_eq ||
                (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)) in
            {
              FStar_TypeChecker_Env.solver =
                (uu___147_6669.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___147_6669.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___147_6669.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___147_6669.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___147_6669.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___147_6669.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___147_6669.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___147_6669.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___147_6669.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___147_6669.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___147_6669.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___147_6669.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___147_6669.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___147_6669.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___147_6669.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____6670;
              FStar_TypeChecker_Env.is_iface =
                (uu___147_6669.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___147_6669.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___147_6669.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___147_6669.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.type_of =
                (uu___147_6669.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___147_6669.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___147_6669.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___147_6669.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___147_6669.FStar_TypeChecker_Env.proof_ns)
            } in
...
let short_circuit:
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___103_6787 =
        match uu___103_6787 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let short_op_ite uu___104_6848 =
        match uu___104_6848 with
        | [] -> FStar_TypeChecker_Common.Trivial
            ...
            FStar_Util.find_map table
              (fun uu____7018  ->
                 ...
                 | (x,mk1) ->
                     ...
                     then let uu____7031 = mk1 seen_args in Some uu____7031
                     else None) in
...
let maybe_add_implicit_binders:
  ...
  fun env  ->
    fun bs  ->
      ...
      match bs with
      | (uu____7072,Some (FStar_Syntax_Syntax.Implicit uu____7073))::uu____7074
          -> bs
      | uu____7083 ->
               ...
               (match uu____7087 with
                | FStar_Syntax_Syntax.Tm_arrow (bs',uu____7092) ->
                    let uu____7103 =
                      FStar_Util.prefix_until
                        (fun uu___105_7122  ->
                           match uu___105_7122 with
                           | (uu____7126,Some (FStar_Syntax_Syntax.Implicit
                              uu____7127)) -> false
                           | uu____7129 -> true) bs' in
                    (match uu____7103 with
                     | None  -> bs
                     | Some ([],uu____7147,uu____7148) -> bs
                     | Some (imps,uu____7185,uu____7186) ->
                         let uu____7223 =
    ...
    fun lident  ->
      fun def  ->
        ...
        (let fv =
           ...
           FStar_Syntax_Syntax.lid_as_fv lident uu____7350 None in
         ...
         ((let uu___148_7366 = sig_ctx in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___148_7366.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___148_7366.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___148_7366.FStar_Syntax_Syntax.sigmeta)
           }), uu____7357))
let check_sigelt_quals:
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.sigelt -> Prims.unit =
  fun env  ->
    fun se  ->
      let visibility uu___106_7376 =
        match uu___106_7376 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____7377 -> false in
      let reducibility uu___107_7381 =
        match uu___107_7381 with
        ...
        | uu____7382 -> false in
      let assumption uu___108_7386 =
        match uu___108_7386 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____7387 -> false in
      let reification uu___109_7391 =
        match uu___109_7391 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____7392 -> true
        | uu____7393 -> false in
      let inferred uu___110_7397 =
        match uu___110_7397 with
        ...
        | uu____7412 -> false in
      let has_eq uu___111_7416 =
        match uu___111_7416 with
                  ...
                  fun indices  ->
                    fun fields  ->
                               ...
                               let uu____7680 =
                                 let uu____7681 =
                                   ...
                                   FStar_Syntax_Syntax.mk_Tm_app uu____7682
                                     uu____7683 in
                                 uu____7681 None p in
                               FStar_Syntax_Util.b2t uu____7680 in
                             FStar_Syntax_Util.refine x uu____7679 in
                           let uu____7690 =
                             let uu___149_7691 = projectee arg_typ in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___149_7691.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___149_7691.FStar_Syntax_Syntax.index);
                           ...
                           let only_decl =
                             (let uu____7758 =
                              ...
                              FStar_Ident.lid_equals
                                FStar_Syntax_Const.prims_lid uu____7758)
                               ||
                               (let uu____7759 =
                                  let uu____7760 =
                                    FStar_TypeChecker_Env.current_module env in
                             ...
                             (let body =
                                   ...
                                   let uu____7912 =
                                     let uu____7915 =
                                       let uu____7916 =
                                         ...
                                         (arg_exp, uu____7932) in
                                       FStar_Syntax_Syntax.Tm_match
                                         uu____7916 in
                                     FStar_Syntax_Syntax.mk uu____7915 in
                                   uu____7912 None p) in
                              let dd =
                                let uu____7948 =
                                  FStar_All.pipe_right quals
                                    (FStar_List.contains
                              ...
                              let lb =
                                let uu____7960 =
                                  ...
                                  FStar_Util.Inr uu____7963 in
                                let uu____7964 =
                                  FStar_Syntax_Subst.close_univ_vars uvs imp in
                                {
                                  FStar_Syntax_Syntax.lbname = uu____7960;
                                  FStar_Syntax_Syntax.lbunivs = uvs;
                                  FStar_Syntax_Syntax.lbtyp = lbtyp;
                                  FStar_Syntax_Syntax.lbeff =
                                    FStar_Syntax_Const.effect_Tot_lid;
                                  FStar_Syntax_Syntax.lbdef = uu____7964
                                } in
                              let impl =
                                let uu____7968 =
                                  let uu____7969 =
                                      ...
                                      let uu____7977 =
                                        ...
                                        FStar_All.pipe_right uu____7978
                                          (fun fv  ->
                                             (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v) in
                                      [uu____7977] in
                                    ((false, [lb]), uu____7975, []) in
                                  FStar_Syntax_Syntax.Sig_let uu____7969 in
                                {
                                  FStar_Syntax_Syntax.sigel = uu____7968;
                      ...
                      let projectors_ses =
                        ...
                        FStar_All.pipe_right uu____8040 FStar_List.flatten in
      ...
      fun tcs  ->
        fun se  ->
          ...
          | FStar_Syntax_Syntax.Sig_datacon
              (constr_lid,uvs,t,typ_lid,n_typars,uu____8319) when
              Prims.op_Negation
                (FStar_Ident.lid_equals constr_lid
                   FStar_Syntax_Const.lexcons_lid)
              ->
              let uu____8322 = FStar_Syntax_Subst.univ_var_opening uvs in
              (match uu____8322 with
               | (univ_opening,uvs1) ->
                   let t1 = FStar_Syntax_Subst.subst univ_opening t in
                   let uu____8335 = FStar_Syntax_Util.arrow_formals t1 in
                              ...
                              (fun se1  ->
                                 let uu____8369 =
                                   let uu____8370 =
                                     ...
                                     FStar_Util.must uu____8371 in
                                   FStar_Ident.lid_equals typ_lid uu____8370 in
                                 if uu____8369
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____8381,uvs',tps,typ0,uu____8385,constrs)
                                       ->
                                       Some
                                         (tps, typ0,
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____8440 with
                              | (indices,uu____8450) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___117_8477 =
                                      match uu___117_8477 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____8479,fns) ->
                                          Some
