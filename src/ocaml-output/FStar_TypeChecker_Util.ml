...
in {FStar_Syntax_Syntax.lbname = _154_1185; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = if no_decl then begin
t
end else begin
FStar_Syntax_Syntax.tun
end; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _154_1184}))
in (
...
let projectors_ses = (let _154_1238 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _57_1946 -> (match (_57_1946) with
| (x, _57_1945) -> begin
(
...
in {FStar_Syntax_Syntax.lbname = _154_1231; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = if no_decl then begin
t
end else begin
FStar_Syntax_Syntax.tun
end; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _154_1230}))
in (
