...
in (FStar_All.pipe_right _153_13 (FStar_List.filter (fun _56_27 -> (match (_56_27) with
| (x, _56_26) -> begin
...
in (_153_36)::[])
in {FStar_TypeChecker_Env.guard_f = _56_66.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _56_66.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_66.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _153_37}))
...
let _56_83 = (let _153_49 = (let _153_48 = (FStar_Syntax_Print.term_to_string t)
...
let _56_171 = (let _153_78 = (t_binders env)
in (aux _153_78 e))
...
let _56_207 = (let _153_95 = (FStar_TypeChecker_Env.all_binders env)
...
in {FStar_Syntax_Syntax.ppname = _56_217.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_217.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _153_96}))
in (
...
in {FStar_Syntax_Syntax.ppname = _56_228.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_228.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _153_97}))
in (
...
in {FStar_Syntax_Syntax.v = _153_139; FStar_Syntax_Syntax.ty = _56_349.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_349.FStar_Syntax_Syntax.p})))
end))
end)))
end
| _56_352 -> begin
...
let _56_529 = if (let _153_190 = (FStar_Syntax_Syntax.fv_eq fv fv')
...
let _56_609 = (let _153_220 = (FStar_All.pipe_right pats (FStar_List.map pat_as_arg))
...
| _56_622 -> begin
(let _153_230 = (let _153_229 = (let _153_228 = (FStar_List.map (fun _56_626 -> (match (_56_626) with
| (x, _56_625) -> begin
...
let _56_644 = (let _153_258 = (FStar_TypeChecker_Env.norm_eff_name env l1)
...
in {FStar_Syntax_Syntax.eff_name = _56_676.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _153_300; FStar_Syntax_Syntax.cflags = _56_676.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _56_678 -> (match (()) with
| () -> begin
...
in {FStar_TypeChecker_Env.guard_f = _153_411; FStar_TypeChecker_Env.deferred = _56_804.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_804.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _56_804.FStar_TypeChecker_Env.implicits}))
end))
...
in {FStar_Syntax_Syntax.eff_name = _153_470; FStar_Syntax_Syntax.res_typ = _56_870.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _153_469; FStar_Syntax_Syntax.comp = strengthen})))
in ((_153_471), ((
...
let _56_882 = (let _153_479 = (FStar_Syntax_Syntax.bv_to_name x)
...
let _56_911 = (let _153_515 = (lcomp_then.FStar_Syntax_Syntax.comp ())
...
let _56_969 = (let _153_592 = (cthen.FStar_Syntax_Syntax.comp ())
...
in (FStar_Syntax_Syntax.fvar _153_666 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None))
in (
...
let _56_1120 = (let _153_704 = (FStar_All.pipe_left (fun _153_701 -> Some (_153_701)) (FStar_TypeChecker_Errors.subtyping_failed env lc.FStar_Syntax_Syntax.res_typ t))
...
let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _153_786 = (FStar_Util.for_all (fun _56_1289 -> (match (_56_1289) with
| (_56_1287, c) -> begin
...
let _56_1311 = (let _153_795 = (FStar_All.pipe_right ecs (FStar_List.map (fun _56_1302 -> (match (_56_1302) with
| (e, c) -> begin
(
...
(let _153_815 = (let _153_814 = (FStar_List.map (fun _56_1408 -> (match (_56_1408) with
...
in (match ((let _153_817 = (FStar_All.pipe_right lecs (FStar_List.map (fun _56_1415 -> (match (_56_1415) with
| (_56_1412, e, c) -> begin
((e), (c))
end))))
...
in {FStar_Syntax_Syntax.n = _56_1464.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _153_848; FStar_Syntax_Syntax.pos = _56_1464.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1464.FStar_Syntax_Syntax.vars}))
end)))
in (
...
let _56_1643 = (let _153_989 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
...
let err' = (fun msg -> (let _153_1058 = (let _153_1057 = (let _153_1056 = (let _153_1055 = (FStar_Syntax_Print.quals_to_string quals)
in (FStar_Util.format2 "The qualifier list \"[%s]\" is not permissible for this element%s" _153_1055 msg))
in ((_153_1056), (r)))
in FStar_Syntax_Syntax.Error (_153_1057))
