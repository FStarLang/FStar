          ...
          (let use_eq =
           ...
           | (FStar_Pervasives_Native.None ,uu____5141) ->
               ...
               then
                 ...
                 (FStar_TypeChecker_Rel.subtype_fail env e
                    lc.FStar_Syntax_Syntax.res_typ t;
                  (e,
                    ((let uu___363_5169 = lc  in
                      {
                        FStar_Syntax_Syntax.eff_name =
                          (uu___363_5169.FStar_Syntax_Syntax.eff_name);
                        FStar_Syntax_Syntax.res_typ = t;
                        FStar_Syntax_Syntax.cflags =
                          (uu___363_5169.FStar_Syntax_Syntax.cflags);
                        FStar_Syntax_Syntax.comp_thunk =
                          (uu___363_5169.FStar_Syntax_Syntax.comp_thunk)
           ...
           | (FStar_Pervasives_Native.Some g,apply_guard1) ->
               ...
               (match uu____5176 with
                ...
                | FStar_TypeChecker_Common.NonTrivial f ->
                    let g1 =
                      let uu___364_5252 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___364_5252.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___364_5252.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___364_5252.FStar_TypeChecker_Env.implicits)
                      }  in
                      ...
                      then FStar_Syntax_Syntax.lcomp_comp lc
                        ...
                        (let f1 =
                         ...
                         | FStar_Syntax_Syntax.Tm_abs
                             ...
                             ->
                             let lc1 =
                               let uu___365_5299 = lc  in
                               {
                                 FStar_Syntax_Syntax.eff_name =
                                   (uu___365_5299.FStar_Syntax_Syntax.eff_name);
                                 FStar_Syntax_Syntax.res_typ = t;
                                 FStar_Syntax_Syntax.cflags =
                                   (uu___365_5299.FStar_Syntax_Syntax.cflags);
                                 FStar_Syntax_Syntax.comp_thunk =
                                   (uu___365_5299.FStar_Syntax_Syntax.comp_thunk)
                               }  in
                             ...
                             ((let uu____5303 =
                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               | (eq_ret,_trivial_so_ok_to_discard) ->
                                   let x1 =
                                     let uu___366_5393 = x  in
                                     {
                                       FStar_Syntax_Syntax.ppname =
                                         (uu___366_5393.FStar_Syntax_Syntax.ppname);
                                       FStar_Syntax_Syntax.index =
                                         (uu___366_5393.FStar_Syntax_Syntax.index);
                                       FStar_Syntax_Syntax.sort =
                                         (lc.FStar_Syntax_Syntax.res_typ)
                                     }  in
                                   let c1 =
                    ...
                    let lc1 =
                      ...
                      FStar_Syntax_Syntax.mk_lcomp uu____5422 t flags1
                       ...
                       in
                    let g2 =
                      let uu___367_5424 = g1  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___367_5424.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___367_5424.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___367_5424.FStar_TypeChecker_Env.implicits)
                      }  in
                    (e, lc1, g2)))
           ...
           (let number_of_implicits t1 =
            ...
            let inst_n_binders t1 =
              ...
              | FStar_Pervasives_Native.Some expected_t ->
               ...
               in
            let decr_inst uu___346_6538 =
              match uu___346_6538 with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
                            ...
                            | (v1,uu____7047,g) ->
                                ((let uu____7062 =
                                 ...
                                 (let mark_meta_implicits tau1 g1 =
                                    let uu___368_7081 = g1  in
                                    let uu____7082 =
                                      FStar_List.map
                                        (fun imp  ->
                                           let uu___369_7088 = imp  in
                                           {
                                             FStar_TypeChecker_Env.imp_reason
                                               =
                                               (uu___369_7088.FStar_TypeChecker_Env.imp_reason);
                                             FStar_TypeChecker_Env.imp_uvar =
                                               (uu___369_7088.FStar_TypeChecker_Env.imp_uvar);
                                             FStar_TypeChecker_Env.imp_tm =
                                               (uu___369_7088.FStar_TypeChecker_Env.imp_tm);
                                             FStar_TypeChecker_Env.imp_range
                                               =
                                               (uu___369_7088.FStar_TypeChecker_Env.imp_range);
                                    ...
                                    {
                                      FStar_TypeChecker_Env.guard_f =
                                        (uu___368_7081.FStar_TypeChecker_Env.guard_f);
                                      FStar_TypeChecker_Env.deferred =
                                        (uu___368_7081.FStar_TypeChecker_Env.deferred);
                                      FStar_TypeChecker_Env.univ_ineqs =
                                        (uu___368_7081.FStar_TypeChecker_Env.univ_ineqs);
                                      FStar_TypeChecker_Env.implicits =
                                        uu____7082
                                    }  in
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___370_9884 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___370_9884.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___370_9884.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____9885 -> e2  in
          let env2 =
            let uu___371_9887 = env1  in
            let uu____9888 =
               ...
               in
            {
              FStar_TypeChecker_Env.solver =
                (uu___371_9887.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___371_9887.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___371_9887.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___371_9887.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___371_9887.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___371_9887.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___371_9887.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___371_9887.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___371_9887.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___371_9887.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___371_9887.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___371_9887.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___371_9887.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___371_9887.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___371_9887.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___371_9887.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___371_9887.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____9888;
              FStar_TypeChecker_Env.is_iface =
                (uu___371_9887.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___371_9887.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___371_9887.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___371_9887.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___371_9887.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___371_9887.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___371_9887.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___371_9887.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___371_9887.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___371_9887.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___371_9887.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___371_9887.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___371_9887.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___371_9887.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___371_9887.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___371_9887.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___371_9887.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___371_9887.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___371_9887.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___371_9887.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___371_9887.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___371_9887.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___371_9887.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___371_9887.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___371_9887.FStar_TypeChecker_Env.nbe)
            }  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___347_10119 =
        match uu___347_10119 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___348_10211 =
        match uu___348_10211 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (guard,uu____10221)::[] ->
        ...
        (let fv =
         ...
         let uu____11122 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___372_11124 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___372_11124.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___372_11124.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___372_11124.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___372_11124.FStar_Syntax_Syntax.sigattrs)
           }), uu____11122))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___350_11142 =
        match uu___350_11142 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____11145 -> false  in
      let reducibility uu___351_11153 =
        match uu___351_11153 with
      ...
      let assumption uu___352_11168 =
        match uu___352_11168 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____11172 -> false  in
      let reification uu___353_11180 =
        match uu___353_11180 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____11183 -> true
        | uu____11185 -> false  in
      let inferred uu___354_11193 =
        match uu___354_11193 with
      ...
      let has_eq uu___355_11234 =
        match uu___355_11234 with
