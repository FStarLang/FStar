...
let c = (FStar_TypeChecker_Env.unfold_effect_abbrev env c)
in (
...
let uu____3549 = (FStar_Syntax_Util.mk_eq2 u_res_t res_t xexp yexp)
...
let comp = (FStar_TypeChecker_Env.comp_to_comp_typ env comp)
in (
...
let uu____4044 = (env.FStar_TypeChecker_Env.universe_of env t)
in (FStar_Syntax_Util.mk_eq2 uu____4044 t xexp e))
in (
...
let uu____4055 = (bind e.FStar_Syntax_Syntax.pos env None (FStar_Syntax_Util.lcomp_of_comp c) ((Some (x)), (eq_ret)))
in uu____4055.FStar_Syntax_Syntax.comp)
in (uu____4050 ()))
in (FStar_Syntax_Util.comp_set_flags uu____4049 ((FStar_Syntax_Syntax.PARTIAL_RETURN)::(FStar_Syntax_Util.comp_flags c))))
in c)))))))))
end))
end))
end))))
...
let uu____4060 = (FStar_Syntax_Util.is_function_typ lc.FStar_Syntax_Syntax.res_typ)
in (not (uu____4060))) && (FStar_Syntax_Util.is_pure_or_ghost_lcomp lc)) && (
...
let uu___129_4064 = lc
in {FStar_Syntax_Syntax.eff_name = uu___129_4064.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___129_4064.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = refine}))))
...
let uu____4083 = (FStar_TypeChecker_Rel.sub_comp env c c')
...
let uu____4092 = (FStar_TypeChecker_Err.computed_computation_type_does_not_match_annotation env e c c')
in (

let uu____4093 = (FStar_TypeChecker_Env.get_range env)
in ((uu____4092), (uu____4093))))
in FStar_Errors.Error (uu____4089))
in (Prims.raise uu____4088))
end
| Some (g) -> begin
((e), (c'), (g))
end)))
...
let uu____4115 = (FStar_Syntax_Subst.compress t)
in uu____4115.FStar_Syntax_Syntax.n)
in (match (uu____4114) with
| FStar_Syntax_Syntax.Tm_type (uu____4120) -> begin
(

let uu____4121 = (

let uu____4122 = (FStar_Syntax_Subst.compress lc.FStar_Syntax_Syntax.res_typ)
in uu____4122.FStar_Syntax_Syntax.n)
...
let uu____4128 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.b2t_lid)
in (
...
let uu____4135 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____4135))
in ((None), (uu____4134)))
in (bind e.FStar_Syntax_Syntax.pos env (Some (e)) lc uu____4133))
in (
...
let uu____4146 = (FStar_Syntax_Syntax.as_arg e)
in (uu____4146)::[])
in (FStar_Syntax_Syntax.mk_Tm_app b2t uu____4145))
in (uu____4144 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos))
in ((e), (lc))))))
end
| uu____4153 -> begin
((e), (lc))
...
let uu____4174 = (FStar_TypeChecker_Env.effect_decl_opt env lc.FStar_Syntax_Syntax.eff_name)
...
let uu____4187 = (FStar_TypeChecker_Rel.try_teq env lc.FStar_Syntax_Syntax.res_typ t)
in ((uu____4187), (false)))
end
| uu____4190 -> begin
(

let uu____4191 = (FStar_TypeChecker_Rel.try_subtype env lc.FStar_Syntax_Syntax.res_typ t)
in ((uu____4191), (true)))
end)
in (match (gopt) with
| (None, uu____4197) -> begin
((FStar_TypeChecker_Rel.subtype_fail env e lc.FStar_Syntax_Syntax.res_typ t);
((e), ((

let uu___130_4200 = lc
in {FStar_Syntax_Syntax.eff_name = uu___130_4200.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___130_4200.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___130_4200.FStar_Syntax_Syntax.comp})), (FStar_TypeChecker_Rel.trivial_guard));
)
end
| (Some (g), apply_guard) -> begin
(

let uu____4204 = (FStar_TypeChecker_Rel.guard_form g)
...
let uu___131_4209 = lc
in {FStar_Syntax_Syntax.eff_name = uu___131_4209.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___131_4209.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___131_4209.FStar_Syntax_Syntax.comp})
in ((e), (lc), (g)))
end
| FStar_TypeChecker_Common.NonTrivial (f) -> begin
(
...
let uu___132_4212 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___132_4212.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___132_4212.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___132_4212.FStar_TypeChecker_Env.implicits})
in (

let strengthen = (fun uu____4218 -> (
...
let uu____4225 = (FStar_Syntax_Subst.compress f)
in uu____4225.FStar_Syntax_Syntax.n)
in (match (uu____4224) with
| FStar_Syntax_Syntax.Tm_abs (uu____4230, {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = uu____4232; FStar_Syntax_Syntax.pos = uu____4233; FStar_Syntax_Syntax.vars = uu____4234}, uu____4235) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.true_lid) -> begin
(

let lc = (

let uu___133_4259 = lc
in {FStar_Syntax_Syntax.eff_name = uu___133_4259.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___133_4259.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___133_4259.FStar_Syntax_Syntax.comp})
in (lc.FStar_Syntax_Syntax.comp ()))
end
| uu____4260 -> begin
(
...
let uu____4265 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme)
in (match (uu____4265) with
| true -> begin
(

let uu____4266 = (FStar_TypeChecker_Normalize.term_to_string env lc.FStar_Syntax_Syntax.res_typ)
in (

let uu____4267 = (FStar_TypeChecker_Normalize.term_to_string env t)
in (

let uu____4268 = (FStar_TypeChecker_Normalize.comp_to_string env c)
in (

let uu____4269 = (FStar_TypeChecker_Normalize.term_to_string env f)
...
let uu____4272 = (FStar_TypeChecker_Env.wp_signature env FStar_Syntax_Const.effect_PURE_lid)
...
let uu____4283 = (destruct_comp ct)
in (match (uu____4283) with
| (u_t, uu____4290, uu____4291) -> begin
(
...
let uu____4296 = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_t)::[]) env md md.FStar_Syntax_Syntax.ret_wp)
in (

let uu____4297 = (

let uu____4298 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____4299 = (

let uu____4301 = (FStar_Syntax_Syntax.as_arg xexp)
in (uu____4301)::[])
in (uu____4298)::uu____4299))
in (FStar_Syntax_Syntax.mk_Tm_app uu____4296 uu____4297)))
in (uu____4295 (Some (k.FStar_Syntax_Syntax.n)) xexp.FStar_Syntax_Syntax.pos))
in (

let cret = (

let uu____4307 = ((mk_comp md) u_t t wp ((FStar_Syntax_Syntax.RETURN)::[]))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____4307))
in (
...
in (uu____4319)::[])
in (FStar_Syntax_Syntax.mk_Tm_app f uu____4318))
in (uu____4317 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
end
| uu____4324 -> begin
f
end)
...
let uu____4328 = (FStar_All.pipe_left (fun _0_28 -> Some (_0_28)) (FStar_TypeChecker_Err.subtyping_failed env lc.FStar_Syntax_Syntax.res_typ t))
in (

let uu____4339 = (FStar_TypeChecker_Env.set_range env e.FStar_Syntax_Syntax.pos)
in (

let uu____4340 = (FStar_All.pipe_left FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (guard)))
in (strengthen_precondition uu____4328 uu____4339 e cret uu____4340))))
...
let uu___134_4346 = x
in {FStar_Syntax_Syntax.ppname = uu___134_4346.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___134_4346.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lc.FStar_Syntax_Syntax.res_typ})
in (
...
let uu____4349 = (FStar_Syntax_Syntax.mk_Comp ct)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____4349))
in (bind e.FStar_Syntax_Syntax.pos env (Some (e)) uu____4348 ((Some (x)), (eq_ret))))
in (

let c = (c.FStar_Syntax_Syntax.comp ())
in ((

let uu____4359 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme)
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___93_4366 -> (match (uu___93_4366) with
| (FStar_Syntax_Syntax.RETURN) | (FStar_Syntax_Syntax.PARTIAL_RETURN) -> begin
(FStar_Syntax_Syntax.PARTIAL_RETURN)::[]
end
...
let uu___135_4370 = lc
in (

let uu____4371 = (FStar_TypeChecker_Env.norm_eff_name env lc.FStar_Syntax_Syntax.eff_name)
in {FStar_Syntax_Syntax.eff_name = uu____4371; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = strengthen}))
in (

let g = (

let uu___136_4373 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___136_4373.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___136_4373.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___136_4373.FStar_TypeChecker_Env.implicits})
in ((e), (lc), (g)))))))
end))
end))))
...
let uu____4397 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Syntax.as_arg uu____4397))
in (uu____4396)::[])
in (FStar_Syntax_Syntax.mk_Tm_app ens uu____4395))
in (uu____4394 None res_t.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Util.refine x uu____4393))))
in (
...
let uu____4406 = (FStar_Syntax_Util.is_tot_or_gtot_comp comp)
...
| ((req, uu____4430))::((ens, uu____4432))::uu____4433 -> begin
(

let uu____4455 = (

let uu____4457 = (norm req)
in Some (uu____4457))
in (

let uu____4458 = (

let uu____4459 = (mk_post_type ct.FStar_Syntax_Syntax.result_typ ens)
in (FStar_All.pipe_left norm uu____4459))
in ((uu____4455), (uu____4458))))
end
| uu____4461 -> begin
(
...
let uu____4472 = (FStar_Syntax_Print.comp_to_string comp)
in (FStar_Util.format1 "Effect constructor is not fully applied; got %s" uu____4472))
in ((uu____4471), (comp.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____4468))
in (Prims.raise uu____4467))
end)
end
| uu____4476 -> begin
(

let ct = (FStar_TypeChecker_Env.unfold_effect_abbrev env comp)
in (match (ct.FStar_Syntax_Syntax.effect_args) with
| ((wp, uu____4482))::uu____4483 -> begin
(

let uu____4497 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.as_requires)
in (match (uu____4497) with
| (us_r, uu____4504) -> begin
(

let uu____4505 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.as_ensures)
in (match (uu____4505) with
| (us_e, uu____4512) -> begin
(
...
let uu____4515 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.as_requires r) FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____4515 us_r))
in (

let as_ens = (

let uu____4517 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.as_ensures r) FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____4517 us_e))
in (
...
let uu____4530 = (FStar_Syntax_Syntax.as_arg wp)
in (uu____4530)::[])
in (((ct.FStar_Syntax_Syntax.result_typ), (Some (FStar_Syntax_Syntax.imp_tag))))::uu____4523)
in (FStar_Syntax_Syntax.mk_Tm_app as_req uu____4522))
in (uu____4521 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) ct.FStar_Syntax_Syntax.result_typ.FStar_Syntax_Syntax.pos))
in (
...
let uu____4555 = (FStar_Syntax_Syntax.as_arg wp)
in (uu____4555)::[])
in (((ct.FStar_Syntax_Syntax.result_typ), (Some (FStar_Syntax_Syntax.imp_tag))))::uu____4548)
in (FStar_Syntax_Syntax.mk_Tm_app as_ens uu____4547))
in (uu____4546 None ct.FStar_Syntax_Syntax.result_typ.FStar_Syntax_Syntax.pos))
in (

let uu____4568 = (

let uu____4570 = (norm req)
in Some (uu____4570))
in (

let uu____4571 = (

let uu____4572 = (mk_post_type ct.FStar_Syntax_Syntax.result_typ ens)
in (norm uu____4572))
...
let uu____4604 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____4604) with
| (formals, uu____4613) -> begin
(

let n_implicits = (

let uu____4625 = (FStar_All.pipe_right formals (FStar_Util.prefix_until (fun uu____4662 -> (match (uu____4662) with
| (uu____4666, imp) -> begin
...
let uu____4738 = (FStar_TypeChecker_Env.expected_typ env)
...
let uu____4762 = (FStar_Util.string_of_int n_available)
in (FStar_Util.format3 "Expected a term with %s implicit arguments, but %s has only %s" uu____4757 uu____4761 uu____4762))))
in (

let uu____4766 = (FStar_TypeChecker_Env.get_range env)
in ((uu____4756), (uu____4766))))
in FStar_Errors.Error (uu____4753))
in (Prims.raise uu____4752))
end
| uu____4768 -> begin
...
let decr_inst = (fun uu___94_4779 -> (match (uu___94_4779) with
| None -> begin
None
end
| Some (i) -> begin
...
let uu____4798 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____4798) with
| (bs, c) -> begin
(

let rec aux = (fun subst inst_n bs -> (match (((inst_n), (bs))) with
| (Some (_0_29), uu____4859) when (_0_29 = (Prims.parse_int "0")) -> begin
(([]), (bs), (subst), (FStar_TypeChecker_Rel.trivial_guard))
end
| (uu____4881, ((x, Some (FStar_Syntax_Syntax.Implicit (dot))))::rest) -> begin
(

let t = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (

let uu____4900 = (new_implicit_var "Instantiation of implicit argument" e.FStar_Syntax_Syntax.pos env t)
in (match (uu____4900) with
| (v, uu____4921, g) -> begin
(

let subst = (FStar_Syntax_Syntax.NT (((x), (v))))::subst
in (

let uu____4931 = (aux subst (decr_inst inst_n) rest)
in (match (uu____4931) with
| (args, bs, subst, g') -> begin
(

let uu____4980 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((((v), (Some (FStar_Syntax_Syntax.Implicit (dot)))))::args), (bs), (subst), (uu____4980)))
end)))
end)))
end
| (uu____4994, bs) -> begin
...
let uu____5032 = (inst_n_binders t)
in (aux [] uu____5032 bs))
...
let uu____5102 = (FStar_Syntax_Util.is_total_comp c)
in (not (uu____5102))) -> begin
((e), (torig), (FStar_TypeChecker_Rel.trivial_guard))
end
| uu____5103 -> begin
(
...
let uu____5151 = (FStar_Util.set_elements univs)
in (FStar_All.pipe_right uu____5151 (FStar_List.map (fun u -> (

let uu____5161 = (FStar_Unionfind.uvar_id u)
in (FStar_All.pipe_right uu____5161 FStar_Util.string_of_int))))))
in (FStar_All.pipe_right uu____5149 (FStar_String.concat ", "))))
...
let uu____5173 = (FStar_Util.set_is_empty x)
...
let uu____5180 = (FStar_TypeChecker_Env.univ_vars env)
in (FStar_Util.set_difference x uu____5180))
in (FStar_All.pipe_right uu____5178 FStar_Util.set_elements))
in ((

let uu____5185 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen")))
...
let uu____5187 = (FStar_TypeChecker_Env.univ_vars env)
in (string_of_univs uu____5187))
...
let uu____5195 = (FStar_TypeChecker_Env.get_range env)
in Some (uu____5195))
in (
...
let uu____5207 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen")))
...
let uu____5209 = (FStar_Unionfind.uvar_id u)
in (FStar_All.pipe_left FStar_Util.string_of_int uu____5209))
in (

let uu____5211 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (u)))
in (

let uu____5212 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_name (u_name)))
...
let uu____5230 = (FStar_Util.fifo_set_difference tm_univnames ctx_univnames)
in (FStar_All.pipe_right uu____5230 FStar_Util.fifo_set_elements))
in univnames))))


let maybe_set_tk = (fun ts uu___95_5257 -> (match (uu___95_5257) with
| None -> begin
ts
end
| Some (t) -> begin
...
let uu____5316 = (FStar_Syntax_Print.term_to_string t)
in (Prims.strcat "Generalized universe in a term containing explicit universe annotation : " uu____5316))
in ((uu____5315), (t.FStar_Syntax_Syntax.pos)))
in FStar_Errors.Error (uu____5312))
in (Prims.raise uu____5311))
end))
...
let uu____5330 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen")))
in (match (uu____5330) with
| true -> begin
(

let uu____5331 = (string_of_univs univs)
...
let uu____5337 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen")))
in (match (uu____5337) with
| true -> begin
(

let uu____5338 = (FStar_Syntax_Print.term_to_string t)
...
let uu____5343 = (FStar_ST.read t0.FStar_Syntax_Syntax.tk)
in (maybe_set_tk ((univs), (ts)) uu____5343))));
));
)))))
...
let uu____5374 = (FStar_Util.for_all (fun uu____5379 -> (match (uu____5379) with
| (uu____5384, c) -> begin
(FStar_Syntax_Util.is_pure_or_ghost_comp c)
end)) ecs)
in (FStar_All.pipe_left Prims.op_Negation uu____5374))
...
let uu____5407 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
in (match (uu____5407) with
| true -> begin
(

let uu____5408 = (FStar_Syntax_Print.comp_to_string c)
...
let uu____5411 = (FStar_TypeChecker_Env.should_verify env)
...
let uu____5414 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
in (match (uu____5414) with
| true -> begin
(

let uu____5415 = (FStar_Syntax_Print.comp_to_string c)
...
let uu____5449 = (FStar_Util.set_difference uvs env_uvars)
in (FStar_All.pipe_right uu____5449 FStar_Util.set_elements)))
in (

let uu____5493 = (

let uu____5511 = (FStar_All.pipe_right ecs (FStar_List.map (fun uu____5566 -> (match (uu____5566) with
| (e, c) -> begin
(
...
in (FStar_All.pipe_right uu____5511 FStar_List.unzip))
...
let uu____5728 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
...
let ecs = (FStar_All.pipe_right uvars (FStar_List.map (fun uu____5770 -> (match (uu____5770) with
| (uvs, e, c) -> begin
(

let tvars = (FStar_All.pipe_right uvs (FStar_List.map (fun uu____5827 -> (match (uu____5827) with
| (u, k) -> begin
(

let uu____5847 = (FStar_Unionfind.find u)
...
| FStar_Syntax_Syntax.Fixed (uu____5885) -> begin
...
let uu____5898 = (FStar_Syntax_Util.arrow_formals k)
...
let uu____5924 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _0_30 -> Some (_0_30)) uu____5924))
in (FStar_Syntax_Syntax.new_bv uu____5922 kres))
in (

let t = (

let uu____5927 = (FStar_Syntax_Syntax.bv_to_name a)
in (
...
let uu____5942 = (FStar_Syntax_Syntax.mk_Total kres)
in (FStar_Syntax_Util.lcomp_of_comp uu____5942))
in FStar_Util.Inl (uu____5941))
in Some (uu____5935))
in (FStar_Syntax_Util.abs bs uu____5927 uu____5928)))
...
let uu____5957 = (match (((tvars), (gen_univs))) with
| ([], []) -> begin
((e), (c))
end
| ([], uu____5975) -> begin
...
let uu____6008 = (FStar_Syntax_Subst.compress (FStar_Syntax_Util.comp_result c))
in uu____6008.FStar_Syntax_Syntax.n)
in (match (uu____6007) with
| FStar_Syntax_Syntax.Tm_arrow (bs, cod) -> begin
(

let uu____6025 = (FStar_Syntax_Subst.open_comp bs cod)
...
let uu____6045 = (FStar_Syntax_Syntax.mk_Total t)
in ((e'), (uu____6045)))))))
end))
end)
...
let uu____6083 = (FStar_TypeChecker_Env.debug env FStar_Options.Low)
...
let uu____6085 = (FStar_List.map (fun uu____6090 -> (match (uu____6090) with
| (lb, uu____6095, uu____6096) -> begin
(FStar_Syntax_Print.lbname_to_string lb)
end)) lecs)
in (FStar_All.pipe_right uu____6085 (FStar_String.concat ", ")))
...
let univnames_lecs = (FStar_List.map (fun uu____6106 -> (match (uu____6106) with
| (l, t, c) -> begin
...
let uu____6128 = (FStar_All.pipe_right lecs (FStar_List.map (fun uu____6144 -> (match (uu____6144) with
| (uu____6150, e, c) -> begin
((e), (c))
end))))
in (gen env uu____6128))
in (match (uu____6121) with
| None -> begin
(FStar_All.pipe_right lecs (FStar_List.map (fun uu____6182 -> (match (uu____6182) with
| (l, t, c) -> begin
((l), ([]), (t), (c))
end))))
end
| Some (ecs) -> begin
(FStar_List.map2 (fun uu____6226 uu____6227 -> (match (((uu____6226), (uu____6227))) with
| ((l, uu____6260, uu____6261), (us, e, c)) -> begin
((

let uu____6287 = (FStar_TypeChecker_Env.debug env FStar_Options.Medium)
in (match (uu____6287) with
| true -> begin
(

let uu____6288 = (FStar_Range.string_of_range e.FStar_Syntax_Syntax.pos)
in (

let uu____6289 = (FStar_Syntax_Print.lbname_to_string l)
in (

let uu____6290 = (FStar_Syntax_Print.term_to_string (FStar_Syntax_Util.comp_result c))
in (

let uu____6291 = (FStar_Syntax_Print.term_to_string e)
...
in (FStar_List.map2 (fun univnames uu____6310 -> (match (uu____6310) with
| (l, generalized_univs, t, c) -> begin
(

let uu____6328 = (check_universe_generalization univnames generalized_univs t)
in ((l), (uu____6328), (t), (c)))
...
let uu____6361 = (FStar_TypeChecker_Rel.try_subtype env t1 t2)
...
let uu____6365 = (FStar_TypeChecker_Rel.apply_guard f e)
in (FStar_All.pipe_left (fun _0_31 -> Some (_0_31)) uu____6365))
end))
end))
in (
...
let uu____6372 = (FStar_Syntax_Subst.compress e)
in uu____6372.FStar_Syntax_Syntax.n)
in (match (uu____6371) with
| FStar_Syntax_Syntax.Tm_name (uu____6375) -> begin
true
end
| uu____6376 -> begin
false
...
let uu___137_6398 = x
in {FStar_Syntax_Syntax.ppname = uu___137_6398.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___137_6398.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})))) (Some (t2.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
end
| uu____6399 -> begin
(
...
let uu____6401 = (FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)))
in {FStar_Syntax_Syntax.n = uu___138_6400.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu____6401; FStar_Syntax_Syntax.pos = uu___138_6400.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___138_6400.FStar_Syntax_Syntax.vars}))
end)))
in (

let env = (

let uu___139_6410 = env
in (

let uu____6411 = (env.FStar_TypeChecker_Env.use_eq || (env.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = uu___139_6410.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___139_6410.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___139_6410.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___139_6410.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___139_6410.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___139_6410.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___139_6410.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___139_6410.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___139_6410.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___139_6410.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___139_6410.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___139_6410.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___139_6410.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___139_6410.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___139_6410.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu____6411; FStar_TypeChecker_Env.is_iface = uu___139_6410.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___139_6410.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___139_6410.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___139_6410.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___139_6410.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___139_6410.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___139_6410.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___139_6410.FStar_TypeChecker_Env.qname_and_index}))
in (

let uu____6412 = (check env t1 t2)
...
let uu____6420 = (FStar_TypeChecker_Err.expected_expression_of_type env t2 e t1)
in (

let uu____6421 = (FStar_TypeChecker_Env.get_range env)
in ((uu____6420), (uu____6421))))
in FStar_Errors.Error (uu____6417))
in (Prims.raise uu____6416))
end
| Some (g) -> begin
((

let uu____6426 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel")))
in (match (uu____6426) with
| true -> begin
(

let uu____6427 = (FStar_TypeChecker_Rel.guard_to_string env g)
...
let uu____6453 = (FStar_Syntax_Util.is_total_lcomp lc)
in (match (uu____6453) with
| true -> begin
(

let uu____6456 = (discharge g)
in (

let uu____6457 = (lc.FStar_Syntax_Syntax.comp ())
...
let uu____6471 = (FStar_TypeChecker_Env.unfold_effect_abbrev env c)
in (FStar_All.pipe_right uu____6471 FStar_Syntax_Syntax.mk_Comp))
in (FStar_All.pipe_right uu____6470 (FStar_TypeChecker_Normalize.normalize_comp steps env)))
in (FStar_All.pipe_right uu____6469 (FStar_TypeChecker_Env.comp_to_comp_typ env)))
in (

let md = (FStar_TypeChecker_Env.get_effect_decl env c.FStar_Syntax_Syntax.effect_name)
in (

let uu____6473 = (destruct_comp c)
...
let uu____6485 = (FStar_TypeChecker_Env.get_range env)
in (

let uu____6486 = (

let uu____6487 = (FStar_TypeChecker_Env.inst_effect_fun_with ((u_t)::[]) env md md.FStar_Syntax_Syntax.trivial)
in (

let uu____6488 = (

let uu____6489 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____6490 = (

let uu____6492 = (FStar_Syntax_Syntax.as_arg wp)
in (uu____6492)::[])
in (uu____6489)::uu____6490))
in (FStar_Syntax_Syntax.mk_Tm_app uu____6487 uu____6488)))
in (uu____6486 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) uu____6485)))
in ((

let uu____6498 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification")))
in (match (uu____6498) with
| true -> begin
(

let uu____6499 = (FStar_Syntax_Print.term_to_string vc)
...
let uu____6502 = (FStar_All.pipe_left FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (vc)))
in (FStar_TypeChecker_Rel.conj_guard g uu____6502))
in (

let uu____6503 = (discharge g)
in (

let uu____6504 = (FStar_Syntax_Syntax.mk_Comp c)
...
let short_bin_op = (fun f uu___96_6528 -> (match (uu___96_6528) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
| ((fst, uu____6534))::[] -> begin
(f fst)
end
| uu____6547 -> begin
...
let uu____6552 = (FStar_Syntax_Util.b2t e)
in (FStar_All.pipe_right uu____6552 (fun _0_32 -> FStar_TypeChecker_Common.NonTrivial (_0_32)))))
in (
...
let uu____6564 = (FStar_Syntax_Util.b2t e)
in (FStar_Syntax_Util.mk_neg uu____6564))
in (FStar_All.pipe_right uu____6561 (fun _0_33 -> FStar_TypeChecker_Common.NonTrivial (_0_33)))))
in (
...
let uu____6575 = (FStar_All.pipe_right t FStar_Syntax_Util.mk_neg)
in (FStar_All.pipe_right uu____6575 (fun _0_35 -> FStar_TypeChecker_Common.NonTrivial (_0_35)))))
in (

let op_imp_t = (fun t -> (FStar_All.pipe_right t (fun _0_36 -> FStar_TypeChecker_Common.NonTrivial (_0_36))))
in (

let short_op_ite = (fun uu___97_6589 -> (match (uu___97_6589) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
| ((guard, uu____6595))::[] -> begin
FStar_TypeChecker_Common.NonTrivial (guard)
end
| (_then)::((guard, uu____6610))::[] -> begin
(

let uu____6631 = (FStar_Syntax_Util.mk_neg guard)
in (FStar_All.pipe_right uu____6631 (fun _0_37 -> FStar_TypeChecker_Common.NonTrivial (_0_37))))
end
| uu____6636 -> begin
...
let uu____6648 = (short_bin_op op_and_e)
in ((FStar_Syntax_Const.op_And), (uu____6648)))
in (
...
let uu____6664 = (short_bin_op op_or_e)
in ((FStar_Syntax_Const.op_Or), (uu____6664)))
in (
...
let uu____6680 = (short_bin_op op_and_t)
in ((FStar_Syntax_Const.and_lid), (uu____6680)))
in (
...
let uu____6696 = (short_bin_op op_or_t)
in ((FStar_Syntax_Const.or_lid), (uu____6696)))
in (
...
let uu____6712 = (short_bin_op op_imp_t)
in ((FStar_Syntax_Const.imp_lid), (uu____6712)))
in (uu____6707)::(((FStar_Syntax_Const.ite_lid), (short_op_ite)))::[])
in (uu____6691)::uu____6701))
in (uu____6675)::uu____6685))
in (uu____6659)::uu____6669))
in (uu____6643)::uu____6653))
...
let uu____6753 = (FStar_Util.find_map table (fun uu____6759 -> (match (uu____6759) with
| (x, mk) -> begin
(match ((FStar_Ident.lid_equals x lid)) with
| true -> begin
(

let uu____6772 = (mk seen_args)
in Some (uu____6772))
end
| uu____6773 -> begin
None
...
let uu____6780 = (FStar_Syntax_Util.un_uinst l)
in uu____6780.FStar_Syntax_Syntax.n)
...
| ((hd, uu____6802))::uu____6803 -> begin
...
in (match (bs) with
| ((uu____6813, Some (FStar_Syntax_Syntax.Implicit (uu____6814))))::uu____6815 -> begin
bs
end
| uu____6824 -> begin
(

let uu____6825 = (FStar_TypeChecker_Env.expected_typ env)
...
let uu____6829 = (FStar_Syntax_Subst.compress t)
in uu____6829.FStar_Syntax_Syntax.n)
in (match (uu____6828) with
| FStar_Syntax_Syntax.Tm_arrow (bs', uu____6833) -> begin
(

let uu____6844 = (FStar_Util.prefix_until (fun uu___98_6863 -> (match (uu___98_6863) with
| (uu____6867, Some (FStar_Syntax_Syntax.Implicit (uu____6868))) -> begin
false
end
| uu____6870 -> begin
true
...
| Some ([], uu____6888, uu____6889) -> begin
bs
end
| Some (imps, uu____6926, uu____6927) -> begin
(

let uu____6964 = (FStar_All.pipe_right imps (FStar_Util.for_all (fun uu____6972 -> (match (uu____6972) with
| (x, uu____6977) -> begin
...
let imps = (FStar_All.pipe_right imps (FStar_List.map (fun uu____7000 -> (match (uu____7000) with
| (x, i) -> begin
(

let uu____7011 = (FStar_Syntax_Syntax.set_range_of_bv x r)
in ((uu____7011), (i)))
end))))
...
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic_lift (((m1), (m2), (t)))))))) uu____7036 e.FStar_Syntax_Syntax.pos))
end))))
...
let uu____7062 = (((is_pure_or_ghost_effect env m) || (FStar_Ident.lid_equals m FStar_Syntax_Const.effect_Tot_lid)) || (FStar_Ident.lid_equals m FStar_Syntax_Const.effect_GTot_lid))
...
let uu____7064 = (FStar_ST.read e.FStar_Syntax_Syntax.tk)
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((e), (FStar_Syntax_Syntax.Meta_monadic (((m), (t)))))))) uu____7064 e.FStar_Syntax_Syntax.pos))
end))))
...
let uu____7094 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED")))
in (match (uu____7094) with
| true -> begin
((d (FStar_Ident.text_of_lid lident));
(

let uu____7096 = (FStar_Syntax_Print.term_to_string def)
...
let uu____7099 = (FStar_Syntax_Util.incr_delta_qualifier def)
in (FStar_Syntax_Syntax.lid_as_fv lident uu____7099 None))
in (
...
let uu____7107 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar (fv))) None FStar_Range.dummyRange)
in ((sig_ctx), (uu____7107)))))));
))


let check_sigelt_quals : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt  ->  Prims.unit = (fun env se -> (

let visibility = (fun uu___99_7129 -> (match (uu___99_7129) with
...
let reducibility = (fun uu___100_7134 -> (match (uu___100_7134) with
...
let assumption = (fun uu___101_7139 -> (match (uu___101_7139) with
...
let reification = (fun uu___102_7144 -> (match (uu___102_7144) with
...
let inferred = (fun uu___103_7150 -> (match (uu___103_7150) with
...
let has_eq = (fun uu___104_7159 -> (match (uu___104_7159) with
...
let uu____7189 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___105_7191 -> (match (uu___105_7191) with
...
in (FStar_All.pipe_right uu____7189 Prims.op_Negation))
...
let uu____7207 = (FStar_Syntax_Print.quals_to_string quals)
in (FStar_Util.format2 "The qualifier list \"[%s]\" is not permissible for this element%s" uu____7207 msg))
in ((uu____7206), (r)))
in FStar_Errors.Error (uu____7203))
in (Prims.raise uu____7202)))
in (

let err = (fun msg -> (err' (Prims.strcat ": " msg)))
in (

let err' = (fun uu____7215 -> (err' ""))
...
let uu____7224 = (FStar_All.pipe_right quals (FStar_List.for_all (quals_combo_ok quals)))
in (not (uu____7224)))
...
(match (se) with
| FStar_Syntax_Syntax.Sig_let ((is_rec, uu____7228), uu____7229, uu____7230, uu____7231, uu____7232) -> begin
((

let uu____7245 = (is_rec && (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen)))
...
let uu____7248 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun x -> ((assumption x) || (has_eq x)))))
...
| FStar_Syntax_Syntax.Sig_bundle (uu____7252) -> begin
(

let uu____7260 = (

let uu____7261 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.Abstract) || (inferred x)) || (visibility x)) || (has_eq x)))))
in (not (uu____7261)))
...
| FStar_Syntax_Syntax.Sig_declare_typ (uu____7265) -> begin
(

let uu____7272 = (FStar_All.pipe_right quals (FStar_Util.for_some has_eq))
...
| FStar_Syntax_Syntax.Sig_assume (uu____7275) -> begin
(

let uu____7281 = (

let uu____7282 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((visibility x) || (x = FStar_Syntax_Syntax.Assumption)))))
in (not (uu____7282)))
...
| FStar_Syntax_Syntax.Sig_new_effect (uu____7286) -> begin
(

let uu____7289 = (

let uu____7290 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x)))))
in (not (uu____7290)))
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____7294) -> begin
(

let uu____7297 = (

let uu____7298 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x)))))
in (not (uu____7298)))
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (uu____7302) -> begin
(

let uu____7312 = (

let uu____7313 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((inferred x) || (visibility x)))))
in (not (uu____7313)))
...
let uu____7384 = (FStar_Syntax_Syntax.lid_as_fv tc FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7384))
in ((uu____7383), (inst_univs)))
in FStar_Syntax_Syntax.Tm_uinst (uu____7378))
in (FStar_Syntax_Syntax.mk uu____7377))
in (uu____7374 None p))
in (

let args = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun uu____7410 -> (match (uu____7410) with
| (x, imp) -> begin
(

let uu____7417 = (FStar_Syntax_Syntax.bv_to_name x)
in ((uu____7417), (imp)))
end))))
...
let uu____7423 = (projectee arg_typ)
in (FStar_Syntax_Syntax.mk_binder uu____7423))
in (
...
let uu____7435 = (FStar_Syntax_Syntax.mk_Tm_uinst disc_fvar inst_univs)
in (
...
let uu____7438 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____7438))
in (uu____7437)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____7435 uu____7436)))
in (uu____7434 None p))
in (FStar_Syntax_Util.b2t uu____7433))
in (FStar_Syntax_Util.refine x uu____7432)))
in (

let uu____7443 = (

let uu___140_7444 = (projectee arg_typ)
in {FStar_Syntax_Syntax.ppname = uu___140_7444.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___140_7444.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})
in (FStar_Syntax_Syntax.mk_binder uu____7443)))))
end)
in (
...
let uu____7454 = (FStar_List.map (fun uu____7464 -> (match (uu____7464) with
| (x, uu____7471) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end)) tps)
in (FStar_List.append uu____7454 fields))
in (

let imp_binders = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun uu____7495 -> (match (uu____7495) with
| (x, uu____7502) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end))))
in (
...
let uu____7511 = (FStar_TypeChecker_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid uu____7511)) || (

let uu____7512 = (

let uu____7513 = (FStar_TypeChecker_Env.current_module env)
in uu____7513.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____7512)))
in (
...
let uu____7520 = (only_decl && ((FStar_All.pipe_left Prims.op_Negation env.FStar_TypeChecker_Env.is_iface) || env.FStar_TypeChecker_Env.admit))
...
let uu____7523 = (FStar_List.filter (fun uu___106_7525 -> (match (uu___106_7525) with
...
in (FStar_List.append uu____7518 uu____7523)))
...
let uu____7540 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.bool_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7540))
in (FStar_Syntax_Syntax.mk_Total uu____7539))
in (

let uu____7541 = (FStar_Syntax_Util.arrow binders bool_typ)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close_univ_vars uvs) uu____7541)))
in (

let decl = FStar_Syntax_Syntax.Sig_declare_typ (((discriminator_name), (uvs), (t), (quals), ((FStar_Ident.range_of_lid discriminator_name))))
in ((

let uu____7545 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7545) with
| true -> begin
(

let uu____7546 = (FStar_Syntax_Print.sigelt_to_string decl)
...
let arg_pats = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j uu____7574 -> (match (uu____7574) with
| (x, imp) -> begin
(
...
let uu____7599 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((uu____7599), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (uu____7594))
in (pos uu____7593))
in ((uu____7590), (b)))
end
| uu____7602 -> begin
...
let uu____7607 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7607))
in (pos uu____7606))
in ((uu____7603), (b)))
end))
end))))
...
let uu____7631 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((uu____7631), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (uu____7623))
in (pos uu____7622))
in ((uu____7619), (None), (FStar_Syntax_Const.exp_true_bool)))
in (
...
let uu____7657 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7657))
in (pos uu____7656))
in ((uu____7653), (None), (FStar_Syntax_Const.exp_false_bool)))
in (
...
let uu____7688 = (FStar_Syntax_Util.branch pat_true)
in (

let uu____7689 = (

let uu____7691 = (FStar_Syntax_Util.branch pat_false)
in (uu____7691)::[])
in (uu____7688)::uu____7689))
in ((arg_exp), (uu____7686)))
in FStar_Syntax_Syntax.Tm_match (uu____7670))
in (FStar_Syntax_Syntax.mk uu____7669))
in (uu____7666 None p))))))
end)
in (

let dd = (

let uu____7702 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____7717 = (FStar_Syntax_Syntax.lid_as_fv discriminator_name dd None)
in FStar_Util.Inr (uu____7717))
in (

let uu____7718 = (FStar_Syntax_Subst.close_univ_vars uvs imp)
in {FStar_Syntax_Syntax.lbname = uu____7714; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____7718}))
in (
...
let uu____7734 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____7734 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____7733)::[])
in ((((false), ((lb)::[]))), (p), (uu____7731), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____7722))
in ((

let uu____7750 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7750) with
| true -> begin
(

let uu____7751 = (FStar_Syntax_Print.sigelt_to_string impl)
...
let subst = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____7771 -> (match (uu____7771) with
| (a, uu____7775) -> begin
(

let uu____7776 = (FStar_Syntax_Util.mk_field_projector_name lid a i)
in (match (uu____7776) with
| (field_name, uu____7780) -> begin
(
...
let uu____7783 = (FStar_Syntax_Syntax.lid_as_fv field_name FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7783))
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____7782 inst_univs))
in (
...
let uu____7799 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____7808 -> (match (uu____7808) with
| (x, uu____7813) -> begin
(
...
let uu____7815 = (FStar_Syntax_Util.mk_field_projector_name lid x i)
in (match (uu____7815) with
| (field_name, uu____7820) -> begin
(
...
let uu____7826 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (FStar_Syntax_Syntax.mk_Total uu____7826))
in (FStar_Syntax_Util.arrow binders uu____7823))
in (FStar_All.pipe_left (FStar_Syntax_Subst.close_univ_vars uvs) uu____7822))
in (

let only_decl = (((

let uu____7828 = (FStar_TypeChecker_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid uu____7828)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (

let uu____7829 = (

let uu____7830 = (FStar_TypeChecker_Env.current_module env)
in uu____7830.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____7829)))
in (
...
let uu____7840 = (FStar_List.filter (fun uu___107_7842 -> (match (uu___107_7842) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____7843 -> begin
...
in (FStar_Syntax_Syntax.Assumption)::uu____7840)
end
| uu____7844 -> begin
q
end))
...
let iquals = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___108_7851 -> (match (uu___108_7851) with
...
let uu____7856 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7856) with
| true -> begin
(

let uu____7857 = (FStar_Syntax_Print.sigelt_to_string decl)
...
let arg_pats = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j uu____7884 -> (match (uu____7884) with
| (x, imp) -> begin
(
...
let uu____7900 = (pos (FStar_Syntax_Syntax.Pat_var (projection)))
in ((uu____7900), (b)))
end
| uu____7905 -> begin
(match ((b && (j < ntps))) with
...
let uu____7921 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((uu____7921), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (uu____7916))
in (pos uu____7915))
in ((uu____7912), (b)))
end
| uu____7924 -> begin
...
let uu____7929 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7929))
in (pos uu____7928))
in ((uu____7925), (b)))
end)
end))
...
let uu____7953 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((uu____7953), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (uu____7945))
in (pos uu____7944))
in (

let uu____7959 = (FStar_Syntax_Syntax.bv_to_name projection)
in ((uu____7941), (None), (uu____7959))))
in (
...
let uu____7992 = (FStar_Syntax_Util.branch pat)
in (uu____7992)::[])
in ((arg_exp), (uu____7990)))
in FStar_Syntax_Syntax.Tm_match (uu____7974))
in (FStar_Syntax_Syntax.mk uu____7973))
in (uu____7970 None p))
in (
...
let uu____8009 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____8018 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (uu____8018))
in (

let uu____8019 = (FStar_Syntax_Subst.close_univ_vars uvs imp)
in {FStar_Syntax_Syntax.lbname = uu____8015; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____8019}))
in (
...
let uu____8035 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____8035 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____8034)::[])
in ((((false), ((lb)::[]))), (p), (uu____8032), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____8023))
in ((

let uu____8051 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____8051) with
| true -> begin
(

let uu____8052 = (FStar_Syntax_Print.sigelt_to_string impl)
...
in (FStar_All.pipe_right uu____7799 FStar_List.flatten))
...
| FStar_Syntax_Syntax.Sig_datacon (constr_lid, uvs, t, typ_lid, n_typars, quals, uu____8083, r) when (not ((FStar_Ident.lid_equals constr_lid FStar_Syntax_Const.lexcons_lid))) -> begin
(

let uu____8089 = (FStar_Syntax_Subst.univ_var_opening uvs)
...
let uu____8102 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____8102) with
| (formals, uu____8112) -> begin
(
...
let uu____8138 = (FStar_Syntax_Util.lid_of_sigelt se)
in (FStar_Util.must uu____8138))
in (FStar_Ident.lid_equals typ_lid uu____8137))
in (match (uu____8136) with
| true -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____8148, uvs', tps, typ0, uu____8152, constrs, uu____8154, uu____8155) -> begin
...
let uu____8211 = (FStar_Syntax_Util.arrow_formals typ0)
in (match (uu____8211) with
| (indices, uu____8221) -> begin
(

let refine_domain = (

let uu____8233 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___109_8235 -> (match (uu___109_8235) with
| FStar_Syntax_Syntax.RecordConstructor (uu____8236) -> begin
true
end
| uu____8241 -> begin
false
...
let filter_records = (fun uu___110_8248 -> (match (uu___110_8248) with
| FStar_Syntax_Syntax.RecordConstructor (uu____8250, fns) -> begin
...
let uu____8258 = (FStar_Util.find_map quals filter_records)
...
let uu____8266 = (FStar_Util.first_N n_typars formals)
in (match (uu____8266) with
| (imp_tps, fields) -> begin
(

let rename = (FStar_List.map2 (fun uu____8297 uu____8298 -> (match (((uu____8297), (uu____8298))) with
| ((x, uu____8308), (x', uu____8310)) -> begin
(

let uu____8315 = (

let uu____8320 = (FStar_Syntax_Syntax.bv_to_name x')
in ((x), (uu____8320)))
in FStar_Syntax_Syntax.NT (uu____8315))
