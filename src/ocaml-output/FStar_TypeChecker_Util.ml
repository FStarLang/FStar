...
let uu____6147 = (FStar_All.pipe_left (fun _0_40 -> FStar_Pervasives_Native.Some (_0_40)) (FStar_TypeChecker_Err.subtyping_failed env lc.FStar_Syntax_Syntax.res_typ t))
in (
...
| (FStar_Pervasives_Native.Some (_0_41), uu____7178) when (_0_41 = (Prims.parse_int "0")) -> begin
...
in (FStar_All.pipe_left (fun _0_42 -> FStar_Pervasives_Native.Some (_0_42)) uu____9262))
...
in (FStar_All.pipe_left (fun _0_43 -> FStar_Pervasives_Native.Some (_0_43)) uu____10231))
end))
end))
in (
...
in (FStar_All.pipe_right uu____10433 (fun _0_44 -> FStar_TypeChecker_Common.NonTrivial (_0_44)))))
in (
...
in (FStar_All.pipe_right uu____10442 (fun _0_45 -> FStar_TypeChecker_Common.NonTrivial (_0_45)))))
in (
...
in (FStar_All.pipe_right uu____10456 (fun _0_47 -> FStar_TypeChecker_Common.NonTrivial (_0_47)))))
in (
...
in (FStar_All.pipe_right uu____10526 (fun _0_49 -> FStar_TypeChecker_Common.NonTrivial (_0_49))))
end
| uu____10531 -> begin
