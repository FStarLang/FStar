          ...
          (let use_eq =
           ...
           | (FStar_Pervasives_Native.None ,uu____5075) ->
               ...
               then
                 ...
                 (FStar_TypeChecker_Rel.subtype_fail env e
                    lc.FStar_Syntax_Syntax.res_typ t;
                  (e,
                    ((let uu___365_5103 = lc  in
                      {
                        FStar_Syntax_Syntax.eff_name =
                          (uu___365_5103.FStar_Syntax_Syntax.eff_name);
                        FStar_Syntax_Syntax.res_typ = t;
                        FStar_Syntax_Syntax.cflags =
                          (uu___365_5103.FStar_Syntax_Syntax.cflags);
                        FStar_Syntax_Syntax.comp_thunk =
                          (uu___365_5103.FStar_Syntax_Syntax.comp_thunk)
           ...
           | (FStar_Pervasives_Native.Some g,apply_guard1) ->
               ...
               (match uu____5110 with
                ...
                | FStar_TypeChecker_Common.NonTrivial f ->
                    let g1 =
                      let uu___366_5186 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___366_5186.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___366_5186.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___366_5186.FStar_TypeChecker_Env.implicits)
                      }  in
                      ...
                      then FStar_Syntax_Syntax.lcomp_comp lc
                        ...
                        (let f1 =
                         ...
                         | FStar_Syntax_Syntax.Tm_abs
                             ...
                             ->
                             let lc1 =
                               let uu___367_5233 = lc  in
                               {
                                 FStar_Syntax_Syntax.eff_name =
                                   (uu___367_5233.FStar_Syntax_Syntax.eff_name);
                                 FStar_Syntax_Syntax.res_typ = t;
                                 FStar_Syntax_Syntax.cflags =
                                   (uu___367_5233.FStar_Syntax_Syntax.cflags);
                                 FStar_Syntax_Syntax.comp_thunk =
                                   (uu___367_5233.FStar_Syntax_Syntax.comp_thunk)
                               }  in
                             ...
                             ((let uu____5237 =
                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               | (eq_ret,_trivial_so_ok_to_discard) ->
                                   let x1 =
                                     let uu___368_5327 = x  in
                                     {
                                       FStar_Syntax_Syntax.ppname =
                                         (uu___368_5327.FStar_Syntax_Syntax.ppname);
                                       FStar_Syntax_Syntax.index =
                                         (uu___368_5327.FStar_Syntax_Syntax.index);
                                       FStar_Syntax_Syntax.sort =
                                         (lc.FStar_Syntax_Syntax.res_typ)
                                     }  in
                                   let c1 =
                    ...
                    let lc1 =
                      ...
                      FStar_Syntax_Syntax.mk_lcomp uu____5356 t flags1
                       ...
                       in
                    let g2 =
                      let uu___369_5358 = g1  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___369_5358.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___369_5358.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___369_5358.FStar_TypeChecker_Env.implicits)
                      }  in
                    (e, lc1, g2)))
           ...
           (let number_of_implicits t1 =
            ...
            let inst_n_binders t1 =
              ...
              | FStar_Pervasives_Native.Some expected_t ->
               ...
               in
            let decr_inst uu___348_6472 =
              match uu___348_6472 with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
                            ...
                            | (v1,uu____6981,g) ->
                                ((let uu____6996 =
                                 ...
                                 (let mark_meta_implicits tau1 g1 =
                                    let uu___370_7015 = g1  in
                                    let uu____7016 =
                                      FStar_List.map
                                        (fun imp  ->
                                           let uu___371_7022 = imp  in
                                           {
                                             FStar_TypeChecker_Env.imp_reason
                                               =
                                               (uu___371_7022.FStar_TypeChecker_Env.imp_reason);
                                             FStar_TypeChecker_Env.imp_uvar =
                                               (uu___371_7022.FStar_TypeChecker_Env.imp_uvar);
                                             FStar_TypeChecker_Env.imp_tm =
                                               (uu___371_7022.FStar_TypeChecker_Env.imp_tm);
                                             FStar_TypeChecker_Env.imp_range
                                               =
                                               (uu___371_7022.FStar_TypeChecker_Env.imp_range);
                                    ...
                                    {
                                      FStar_TypeChecker_Env.guard_f =
                                        (uu___370_7015.FStar_TypeChecker_Env.guard_f);
                                      FStar_TypeChecker_Env.deferred =
                                        (uu___370_7015.FStar_TypeChecker_Env.deferred);
                                      FStar_TypeChecker_Env.univ_ineqs =
                                        (uu___370_7015.FStar_TypeChecker_Env.univ_ineqs);
                                      FStar_TypeChecker_Env.implicits =
                                        uu____7016
                                    }  in
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___372_9818 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___372_9818.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___372_9818.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____9819 -> e2  in
          let env2 =
            let uu___373_9821 = env1  in
            let uu____9822 =
               ...
               in
            {
              FStar_TypeChecker_Env.solver =
                (uu___373_9821.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___373_9821.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___373_9821.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___373_9821.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___373_9821.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___373_9821.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___373_9821.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___373_9821.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___373_9821.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___373_9821.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___373_9821.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___373_9821.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___373_9821.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___373_9821.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___373_9821.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___373_9821.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___373_9821.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____9822;
              FStar_TypeChecker_Env.is_iface =
                (uu___373_9821.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___373_9821.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___373_9821.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___373_9821.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___373_9821.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___373_9821.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___373_9821.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___373_9821.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___373_9821.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___373_9821.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___373_9821.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___373_9821.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___373_9821.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___373_9821.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___373_9821.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___373_9821.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___373_9821.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___373_9821.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___373_9821.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___373_9821.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___373_9821.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___373_9821.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___373_9821.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___373_9821.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___373_9821.FStar_TypeChecker_Env.nbe)
            }  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___349_10053 =
        match uu___349_10053 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___350_10145 =
        match uu___350_10145 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (guard,uu____10155)::[] ->
        ...
        (let fv =
         ...
         let uu____11056 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___374_11058 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___374_11058.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___374_11058.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___374_11058.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___374_11058.FStar_Syntax_Syntax.sigattrs)
           }), uu____11056))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___352_11076 =
        match uu___352_11076 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____11079 -> false  in
      let reducibility uu___353_11087 =
        match uu___353_11087 with
      ...
      let assumption uu___354_11102 =
        match uu___354_11102 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____11106 -> false  in
      let reification uu___355_11114 =
        match uu___355_11114 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____11117 -> true
        | uu____11119 -> false  in
      let inferred uu___356_11127 =
        match uu___356_11127 with
      ...
      let has_eq uu___357_11168 =
        match uu___357_11168 with
