               ...
               ((let uu____157 =
                ...
                (let g1 =
                   FStar_TypeChecker_Rel.solve_deferred_constraints env
                     (let uu___358_197 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          (uu___358_197.FStar_TypeChecker_Env.guard_f);
                        FStar_TypeChecker_Env.deferred = solve_now;
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___358_197.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___358_197.FStar_TypeChecker_Env.implicits)
                      })
                    in
                 let g2 =
                   let uu___359_199 = g1  in
                   {
                     FStar_TypeChecker_Env.guard_f =
                       (uu___359_199.FStar_TypeChecker_Env.guard_f);
                     FStar_TypeChecker_Env.deferred = defer;
                     FStar_TypeChecker_Env.univ_ineqs =
                       (uu___359_199.FStar_TypeChecker_Env.univ_ineqs);
                     FStar_TypeChecker_Env.implicits =
                       (uu___359_199.FStar_TypeChecker_Env.implicits)
                   }  in
                 g2)))
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____1481  in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___360_1479.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___360_1479.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___360_1479.FStar_TypeChecker_Env.implicits)
            }
              ...
              (let flags1 =
               ...
               let uu____2365 =
                 ...
                 FStar_Syntax_Syntax.mk_lcomp uu____2366
                  ...
                  in
               (uu____2365,
                 (let uu___361_2368 = g0  in
                  {
                    FStar_TypeChecker_Env.guard_f =
                      FStar_TypeChecker_Common.Trivial;
                    FStar_TypeChecker_Env.deferred =
                      (uu___361_2368.FStar_TypeChecker_Env.deferred);
                    FStar_TypeChecker_Env.univ_ineqs =
                      (uu___361_2368.FStar_TypeChecker_Env.univ_ineqs);
                    FStar_TypeChecker_Env.implicits =
                      (uu___361_2368.FStar_TypeChecker_Env.implicits)
                  })))
                                     ...
                                     then
                                       let c21 =
                                         FStar_Syntax_Subst.subst_comp
                                          ...
                                          in
                                       let x1 =
                                         let uu___362_2831 = x  in
                                         {
                                           FStar_Syntax_Syntax.ppname =
                                             (uu___362_2831.FStar_Syntax_Syntax.ppname);
                                           FStar_Syntax_Syntax.index =
                                             (uu___362_2831.FStar_Syntax_Syntax.index);
                                           FStar_Syntax_Syntax.sort =
          ...
          then
            ...
            (if uu____3430
             then
               ...
               let retc2 =
                 let uu___363_3436 = retc1  in
                 {
                   FStar_Syntax_Syntax.comp_univs =
                     (uu___363_3436.FStar_Syntax_Syntax.comp_univs);
                   FStar_Syntax_Syntax.effect_name =
                     FStar_Parser_Const.effect_GHOST_lid;
                   FStar_Syntax_Syntax.result_typ =
                     (uu___363_3436.FStar_Syntax_Syntax.result_typ);
          ...
          (let use_eq =
           ...
           | (FStar_Pervasives_Native.None ,uu____4537) ->
               ...
               then
                 ...
                 (FStar_TypeChecker_Rel.subtype_fail env e
                    lc.FStar_Syntax_Syntax.res_typ t;
                  (e,
                    ((let uu___364_4560 = lc  in
                      {
                        FStar_Syntax_Syntax.eff_name =
                          (uu___364_4560.FStar_Syntax_Syntax.eff_name);
                        FStar_Syntax_Syntax.res_typ = t;
                        FStar_Syntax_Syntax.cflags =
                          (uu___364_4560.FStar_Syntax_Syntax.cflags);
                        FStar_Syntax_Syntax.comp_thunk =
                          (uu___364_4560.FStar_Syntax_Syntax.comp_thunk)
           ...
           | (FStar_Pervasives_Native.Some g,apply_guard1) ->
               ...
               (match uu____4565 with
                ...
                | FStar_TypeChecker_Common.NonTrivial f ->
                    let g1 =
                      let uu___365_4620 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___365_4620.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___365_4620.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___365_4620.FStar_TypeChecker_Env.implicits)
                      }  in
                      ...
                      then FStar_Syntax_Syntax.lcomp_comp lc
                        ...
                        (let f1 =
                         ...
                         | FStar_Syntax_Syntax.Tm_abs
                             ...
                             ->
                             let lc1 =
                               let uu___366_4664 = lc  in
                               {
                                 FStar_Syntax_Syntax.eff_name =
                                   (uu___366_4664.FStar_Syntax_Syntax.eff_name);
                                 FStar_Syntax_Syntax.res_typ = t;
                                 FStar_Syntax_Syntax.cflags =
                                   (uu___366_4664.FStar_Syntax_Syntax.cflags);
                                 FStar_Syntax_Syntax.comp_thunk =
                                   (uu___366_4664.FStar_Syntax_Syntax.comp_thunk)
                               }  in
                             ...
                             ((let uu____4668 =
                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               | (eq_ret,_trivial_so_ok_to_discard) ->
                                   let x1 =
                                     let uu___367_4743 = x  in
                                     {
                                       FStar_Syntax_Syntax.ppname =
                                         (uu___367_4743.FStar_Syntax_Syntax.ppname);
                                       FStar_Syntax_Syntax.index =
                                         (uu___367_4743.FStar_Syntax_Syntax.index);
                                       FStar_Syntax_Syntax.sort =
                                         (lc.FStar_Syntax_Syntax.res_typ)
                                     }  in
                                   let c1 =
                    ...
                    let lc1 =
                      ...
                      FStar_Syntax_Syntax.mk_lcomp uu____4766 t flags1
                       ...
                       in
                    let g2 =
                      let uu___368_4768 = g1  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___368_4768.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___368_4768.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___368_4768.FStar_TypeChecker_Env.implicits)
                      }  in
                    (e, lc1, g2)))
           ...
           (let number_of_implicits t1 =
            ...
            let inst_n_binders t1 =
              ...
              | FStar_Pervasives_Native.Some expected_t ->
               ...
               in
            let decr_inst uu___347_5807 =
              match uu___347_5807 with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
                            ...
                            | (v1,uu____6291,g) ->
                                ((let uu____6306 =
                                 ...
                                 (let mark_meta_implicits tau1 g1 =
                                    let uu___369_6320 = g1  in
                                    let uu____6321 =
                                      FStar_List.map
                                        (fun imp  ->
                                           let uu___370_6327 = imp  in
                                           {
                                             FStar_TypeChecker_Env.imp_reason
                                               =
                                               (uu___370_6327.FStar_TypeChecker_Env.imp_reason);
                                             FStar_TypeChecker_Env.imp_uvar =
                                               (uu___370_6327.FStar_TypeChecker_Env.imp_uvar);
                                             FStar_TypeChecker_Env.imp_tm =
                                               (uu___370_6327.FStar_TypeChecker_Env.imp_tm);
                                             FStar_TypeChecker_Env.imp_range
                                               =
                                               (uu___370_6327.FStar_TypeChecker_Env.imp_range);
                                    ...
                                    {
                                      FStar_TypeChecker_Env.guard_f =
                                        (uu___369_6320.FStar_TypeChecker_Env.guard_f);
                                      FStar_TypeChecker_Env.deferred =
                                        (uu___369_6320.FStar_TypeChecker_Env.deferred);
                                      FStar_TypeChecker_Env.univ_ineqs =
                                        (uu___369_6320.FStar_TypeChecker_Env.univ_ineqs);
                                      FStar_TypeChecker_Env.implicits =
                                        uu____6321
                                    }  in
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___371_8920 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___371_8920.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___371_8920.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____8921 -> e2  in
          let env2 =
            let uu___372_8923 = env1  in
            let uu____8924 =
               ...
               in
            {
              ...
              FStar_TypeChecker_Env.range =
                (uu___372_8923.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___372_8923.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___372_8923.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___372_8923.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___372_8923.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___372_8923.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___372_8923.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___372_8923.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___372_8923.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___372_8923.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___372_8923.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___372_8923.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___372_8923.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___372_8923.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___372_8923.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___372_8923.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____8924;
              FStar_TypeChecker_Env.is_iface =
                (uu___372_8923.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___372_8923.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___372_8923.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___372_8923.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___372_8923.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___372_8923.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___372_8923.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___372_8923.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___372_8923.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___372_8923.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___372_8923.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___372_8923.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___372_8923.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___372_8923.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___372_8923.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___372_8923.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___372_8923.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___372_8923.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___372_8923.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___372_8923.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___372_8923.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___372_8923.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___372_8923.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___372_8923.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___372_8923.FStar_TypeChecker_Env.nbe)
            }  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___348_9119 =
        match uu___348_9119 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___349_9210 =
        match uu___349_9210 with
        | [] -> FStar_TypeChecker_Common.Trivial
        ...
        (let fv =
         ...
         let uu____10078 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___373_10080 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___373_10080.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___373_10080.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___373_10080.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___373_10080.FStar_Syntax_Syntax.sigattrs)
           }), uu____10078))
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___351_10096 =
        match uu___351_10096 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____10097 -> false  in
      let reducibility uu___352_10103 =
        match uu___352_10103 with
      ...
      let assumption uu___353_10110 =
        match uu___353_10110 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____10111 -> false  in
      let reification uu___354_10117 =
        match uu___354_10117 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____10118 -> true
        | uu____10119 -> false  in
      let inferred uu___355_10125 =
        match uu___355_10125 with
      ...
      let has_eq uu___356_10156 =
        match uu___356_10156 with
