              ...
              (let flags1 =
                       ...
                       FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags
                         (FStar_List.collect
                            (fun uu___342_2691  ->
                               ...
                               | uu____2694 -> []))
                        in
                     FStar_List.append flags1 uu____2683
                  in
               ...
               let uu____2720 =
                 ...
                 FStar_Syntax_Syntax.mk_lcomp uu____2721
                  ...
                  in
               (uu____2720,
                 (let uu___360_2723 = g0  in
                  {
                    FStar_TypeChecker_Env.guard_f =
                      FStar_TypeChecker_Common.Trivial;
                    FStar_TypeChecker_Env.deferred =
                      (uu___360_2723.FStar_TypeChecker_Env.deferred);
                    FStar_TypeChecker_Env.univ_ineqs =
                      (uu___360_2723.FStar_TypeChecker_Env.univ_ineqs);
                    FStar_TypeChecker_Env.implicits =
                      (uu___360_2723.FStar_TypeChecker_Env.implicits)
                  })))
                          ...
                          (let uu____3120 =
                           ...
                           then
                             let close1 x reason c =
                               let x1 =
                                 let uu___361_3162 = x  in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___361_3162.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___361_3162.FStar_Syntax_Syntax.index);
                                   FStar_Syntax_Syntax.sort =
          ...
          then
            ...
            (if uu____3911
             then
               ...
               let retc2 =
                 let uu___362_3920 = retc1  in
                 {
                   FStar_Syntax_Syntax.comp_univs =
                     (uu___362_3920.FStar_Syntax_Syntax.comp_univs);
                   FStar_Syntax_Syntax.effect_name =
                     FStar_Parser_Const.effect_GHOST_lid;
                   FStar_Syntax_Syntax.result_typ =
                     (uu___362_3920.FStar_Syntax_Syntax.result_typ);
                   FStar_Syntax_Syntax.effect_args =
                     (uu___362_3920.FStar_Syntax_Syntax.effect_args);
                   FStar_Syntax_Syntax.flags = flags1
                 }  in
            ...
            (let c1 = FStar_TypeChecker_Env.unfold_effect_abbrev env c  in
             ...
             FStar_Syntax_Util.comp_set_flags uu____3937 flags1)
           in
            ...
            FStar_All.pipe_right lcases
              (FStar_Util.for_some
                 (fun uu____4158  ->
                    ...
                    | (uu____4173,uu____4174,flags1,uu____4176) ->
                        FStar_All.pipe_right flags1
                          (FStar_Util.for_some
                             (fun uu___344_4193  ->
                                match uu___344_4193 with
                                | FStar_Syntax_Syntax.SHOULD_NOT_INLINE  ->
                                    true
                                | uu____4196 -> false))))
             in
          ...
          (let use_eq =
           ...
           | (FStar_Pervasives_Native.None ,uu____5168) ->
               ...
               then
                 ...
                 (FStar_TypeChecker_Rel.subtype_fail env e
                    lc.FStar_Syntax_Syntax.res_typ t;
                  (e,
                    ((let uu___363_5196 = lc  in
                      {
                        FStar_Syntax_Syntax.eff_name =
                          (uu___363_5196.FStar_Syntax_Syntax.eff_name);
                        FStar_Syntax_Syntax.res_typ = t;
                        FStar_Syntax_Syntax.cflags =
                          (uu___363_5196.FStar_Syntax_Syntax.cflags);
                        FStar_Syntax_Syntax.comp_thunk =
                          (uu___363_5196.FStar_Syntax_Syntax.comp_thunk)
           ...
           | (FStar_Pervasives_Native.Some g,apply_guard1) ->
               ...
               (match uu____5203 with
                ...
                | FStar_TypeChecker_Common.NonTrivial f ->
                    let g1 =
                      let uu___364_5302 = g  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___364_5302.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___364_5302.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___364_5302.FStar_TypeChecker_Env.implicits)
                      }  in
                      ...
                      then FStar_Syntax_Syntax.lcomp_comp lc
                        ...
                        (let f1 =
                         ...
                         | FStar_Syntax_Syntax.Tm_abs
                             ...
                             ->
                             let lc1 =
                               let uu___365_5349 = lc  in
                               {
                                 FStar_Syntax_Syntax.eff_name =
                                   (uu___365_5349.FStar_Syntax_Syntax.eff_name);
                                 FStar_Syntax_Syntax.res_typ = t;
                                 FStar_Syntax_Syntax.cflags =
                                   (uu___365_5349.FStar_Syntax_Syntax.cflags);
                                 FStar_Syntax_Syntax.comp_thunk =
                                   (uu___365_5349.FStar_Syntax_Syntax.comp_thunk)
                               }  in
                             ...
                             ((let uu____5353 =
                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               | (eq_ret,_trivial_so_ok_to_discard) ->
                                   let x1 =
                                     let uu___366_5443 = x  in
                                     {
                                       FStar_Syntax_Syntax.ppname =
                                         (uu___366_5443.FStar_Syntax_Syntax.ppname);
                                       FStar_Syntax_Syntax.index =
                                         (uu___366_5443.FStar_Syntax_Syntax.index);
                                       FStar_Syntax_Syntax.sort =
                                         (lc.FStar_Syntax_Syntax.res_typ)
                                     }  in
                                   let c1 =
                    ...
                    let lc1 =
                      let uu____5472 =
                        FStar_TypeChecker_Env.norm_eff_name env
                          lc.FStar_Syntax_Syntax.eff_name
                         in
                      FStar_Syntax_Syntax.mk_lcomp uu____5472 t flags1
                        strengthen
                       in
                    let g2 =
                      let uu___367_5474 = g1  in
                      {
                        FStar_TypeChecker_Env.guard_f =
                          FStar_TypeChecker_Common.Trivial;
                        FStar_TypeChecker_Env.deferred =
                          (uu___367_5474.FStar_TypeChecker_Env.deferred);
                        FStar_TypeChecker_Env.univ_ineqs =
                          (uu___367_5474.FStar_TypeChecker_Env.univ_ineqs);
                        FStar_TypeChecker_Env.implicits =
                          (uu___367_5474.FStar_TypeChecker_Env.implicits)
                      }  in
                    (e, lc1, g2)))
           ...
           (let number_of_implicits t1 =
            ...
            let inst_n_binders t1 =
              ...
              | FStar_Pervasives_Native.Some expected_t ->
               ...
               in
            let decr_inst uu___346_6588 =
              match uu___346_6588 with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___368_9885 = x  in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___368_9885.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___368_9885.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____9886 -> e2  in
          let env2 =
            let uu___369_9888 = env1  in
            let uu____9889 =
               ...
               in
            {
              FStar_TypeChecker_Env.solver =
                (uu___369_9888.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___369_9888.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___369_9888.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___369_9888.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___369_9888.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___369_9888.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___369_9888.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___369_9888.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___369_9888.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.attrtab =
                (uu___369_9888.FStar_TypeChecker_Env.attrtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___369_9888.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___369_9888.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___369_9888.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___369_9888.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___369_9888.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___369_9888.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___369_9888.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____9889;
              FStar_TypeChecker_Env.is_iface =
                (uu___369_9888.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___369_9888.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___369_9888.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___369_9888.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.phase1 =
                (uu___369_9888.FStar_TypeChecker_Env.phase1);
              FStar_TypeChecker_Env.failhard =
                (uu___369_9888.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___369_9888.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.uvar_subtyping =
                (uu___369_9888.FStar_TypeChecker_Env.uvar_subtyping);
              FStar_TypeChecker_Env.tc_term =
                (uu___369_9888.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___369_9888.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___369_9888.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___369_9888.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___369_9888.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___369_9888.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___369_9888.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___369_9888.FStar_TypeChecker_Env.fv_delta_depths);
              FStar_TypeChecker_Env.proof_ns =
                (uu___369_9888.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___369_9888.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___369_9888.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.postprocess =
                (uu___369_9888.FStar_TypeChecker_Env.postprocess);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___369_9888.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___369_9888.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___369_9888.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___369_9888.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.nbe =
                (uu___369_9888.FStar_TypeChecker_Env.nbe)
            }  in
...
let (short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___347_10120 =
        match uu___347_10120 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___348_10212 =
        match uu___348_10212 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (guard,uu____10222)::[] ->
        ...
        (let fv =
         ...
         let uu____11123 =
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)
            ...
            in
         ((let uu___370_11125 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___370_11125.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___370_11125.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___370_11125.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___370_11125.FStar_Syntax_Syntax.sigattrs)
           }), uu____11123))
    ...
    fun t  ->
      let t1 =
        FStar_TypeChecker_Normalize.normalize
         ...
         in
      let uu____11139 = FStar_Syntax_Util.arrow_formals_comp t1  in
      match uu____11139 with
      | (uu____11153,{
                       FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp
                         { FStar_Syntax_Syntax.comp_univs = uu____11154;
                           FStar_Syntax_Syntax.effect_name = e;
                           FStar_Syntax_Syntax.result_typ = uu____11156;
                           FStar_Syntax_Syntax.effect_args = uu____11157;
                           FStar_Syntax_Syntax.flags = uu____11158;_};
                       FStar_Syntax_Syntax.pos = uu____11159;
                       FStar_Syntax_Syntax.vars = uu____11160;_})
          when
          let uu____11193 = FStar_Ident.string_of_lid e  in
          uu____11193 = "FStar.HyperStack.ST.StackInline" -> true
      | uu____11198 -> false
...
let (check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___350_11229 =
        match uu___350_11229 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____11232 -> false  in
      let reducibility uu___351_11240 =
        match uu___351_11240 with
      ...
      let assumption uu___352_11255 =
        match uu___352_11255 with
        | FStar_Syntax_Syntax.Assumption  -> true
        | FStar_Syntax_Syntax.New  -> true
        | uu____11259 -> false  in
      let reification uu___353_11267 =
        match uu___353_11267 with
        | FStar_Syntax_Syntax.Reifiable  -> true
        | FStar_Syntax_Syntax.Reflectable uu____11270 -> true
        | uu____11272 -> false  in
      let inferred uu___354_11280 =
        match uu___354_11280 with
        | FStar_Syntax_Syntax.Discriminator uu____11282 -> true
        | FStar_Syntax_Syntax.Projector uu____11284 -> true
        | FStar_Syntax_Syntax.RecordType uu____11290 -> true
        | FStar_Syntax_Syntax.RecordConstructor uu____11300 -> true
        | FStar_Syntax_Syntax.ExceptionConstructor  -> true
        | FStar_Syntax_Syntax.HasMaskedEffect  -> true
        | FStar_Syntax_Syntax.Effect  -> true
        | uu____11313 -> false  in
      let has_eq uu___355_11321 =
        match uu___355_11321 with
      ...
      let quals_combo_ok quals q =
        ...
        | FStar_Syntax_Syntax.Reflectable uu____11404 ->
            FStar_All.pipe_right quals
              (FStar_List.for_all
                 (fun x  ->
                    ((((reification x) || (inferred x)) || (visibility x)) ||
      ...
      let uu____11422 =
        let uu____11424 =
          FStar_All.pipe_right quals
            (FStar_Util.for_some
               (fun uu___356_11430  ->
                  match uu___356_11430 with
                  | FStar_Syntax_Syntax.OnlyName  -> true
                  | uu____11433 -> false))
           in
        FStar_All.pipe_right uu____11424 Prims.op_Negation  in
      if uu____11422
      then
        ...
        let err' msg =
          let uu____11454 =
            let uu____11460 =
              let uu____11462 = FStar_Syntax_Print.quals_to_string quals  in
              FStar_Util.format2
                "The qualifier list \"[%s]\" is not permissible for this element%s"
                uu____11462 msg
               in
            (FStar_Errors.Fatal_QulifierListNotPermitted, uu____11460)  in
          FStar_Errors.raise_error uu____11454 r  in
        let err msg = err' (Prims.strcat ": " msg)  in
        let err'1 uu____11480 = err' ""  in
        (if (FStar_List.length quals) <> (FStar_List.length no_dup_quals)
         ...
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_let ((is_rec,lbs),uu____11501) ->
              ((let uu____11513 =
                  is_rec &&
                    (FStar_All.pipe_right quals
                       (FStar_List.contains
          ...
          | FStar_Syntax_Syntax.Sig_bundle uu____11533 ->
              let uu____11542 =
                let uu____11544 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (((((x = FStar_Syntax_Syntax.Abstract) ||
                            ...
                            || (has_eq x)))
                   in
                Prims.op_Negation uu____11544  in
              if uu____11542 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_declare_typ uu____11554 ->
              let uu____11561 =
                FStar_All.pipe_right quals (FStar_Util.for_some has_eq)  in
              if uu____11561 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_assume uu____11569 ->
              let uu____11576 =
                let uu____11578 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (visibility x) ||
                            (x = FStar_Syntax_Syntax.Assumption)))
                   in
                Prims.op_Negation uu____11578  in
              if uu____11576 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____11588 ->
              let uu____11589 =
                let uu____11591 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x  ->
                          (((x = FStar_Syntax_Syntax.TotalEffect) ||
                            ...
                            || (reification x)))
                   in
                Prims.op_Negation uu____11591  in
          ...
          | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____11601 ->
              ...
              if uu____11602 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____11614 ->
              let uu____11627 =
                let uu____11629 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                   ...
                   in
                Prims.op_Negation uu____11629  in
              if uu____11627 then err'1 () else ()
          | uu____11639 -> ()))
      else ()
    ...
    fun t  ->
      let has_erased_for_extraction_attr fv =
        let uu____11662 =
          ...
          FStar_All.pipe_right uu____11667
            (FStar_TypeChecker_Env.lookup_attrs_of_lid g)
           in
        FStar_All.pipe_right uu____11662
          (fun l_opt  ->
             (FStar_Util.is_some l_opt) &&
               (let uu____11686 = FStar_All.pipe_right l_opt FStar_Util.must
                   in
                FStar_All.pipe_right uu____11686
                  (FStar_List.existsb
                     (fun t1  ->
                        let uu____11704 =
                          let uu____11705 = FStar_Syntax_Subst.compress t1
                             in
      ...
      let rec aux_whnf env t1 =
        ...
        | FStar_Syntax_Syntax.Tm_arrow uu____11745 ->
            let uu____11760 = FStar_Syntax_Util.arrow_formals_comp t1  in
            (match uu____11760 with
             | (bs,c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs  in
                 let uu____11793 = FStar_Syntax_Util.is_pure_comp c  in
                 if uu____11793
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____11799;
               FStar_Syntax_Syntax.index = uu____11800;
               FStar_Syntax_Syntax.sort = t2;_},uu____11802)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____11811,uu____11812) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____11854::[]) ->
            let uu____11893 =
              let uu____11894 = FStar_Syntax_Util.un_uinst head1  in
              uu____11894.FStar_Syntax_Syntax.n  in
      ...
      and aux env t1 =
        ...
        (let uu____11911 =
         ...
         if uu____11911
         then
           let uu____11916 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____11916
         else ());
        res
       in aux g t
