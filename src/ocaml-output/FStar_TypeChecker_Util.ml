  ...
  fun env  ->
    fun lc  ->
      fun f  ->
        ...
        let uu___134_3396 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___134_3396.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___134_3396.FStar_Syntax_Syntax.res_typ);
          FStar_Syntax_Syntax.cflags =
            (uu___134_3396.FStar_Syntax_Syntax.cflags);
               ...
               (let flags =
                ...
                let uu____3512 =
                    ...
                    if uu____3517 then flags else [] in
                  {
                    ...
                    FStar_Syntax_Syntax.res_typ =
                      (uu___135_3513.FStar_Syntax_Syntax.res_typ);
                    FStar_Syntax_Syntax.cflags = uu____3515;
                    FStar_Syntax_Syntax.comp = strengthen
                  } in
                (uu____3512,
                  (let uu___136_3521 = g0 in
                   {
                     FStar_TypeChecker_Env.guard_f =
                       FStar_TypeChecker_Common.Trivial;
                     FStar_TypeChecker_Env.deferred =
                       (uu___136_3521.FStar_TypeChecker_Env.deferred);
                     FStar_TypeChecker_Env.univ_ineqs =
                       (uu___136_3521.FStar_TypeChecker_Env.univ_ineqs);
                     FStar_TypeChecker_Env.implicits =
                       (uu___136_3521.FStar_TypeChecker_Env.implicits)
                   }))))
  ...
  fun env  ->
    fun bvs  ->
      fun lc  ->
        ...
        let uu___137_4006 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___137_4006.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___137_4006.FStar_Syntax_Syntax.res_typ);
          FStar_Syntax_Syntax.cflags =
            (uu___137_4006.FStar_Syntax_Syntax.cflags);
  ...
  fun env  ->
    fun e  ->
      fun lc  ->
        ...
        let uu___138_4079 = lc in
        {
          FStar_Syntax_Syntax.eff_name =
            (uu___138_4079.FStar_Syntax_Syntax.eff_name);
          FStar_Syntax_Syntax.res_typ =
            (uu___138_4079.FStar_Syntax_Syntax.res_typ);
        ...
        fun t  ->
          ...
          | (None ,uu____4217) ->
              (FStar_TypeChecker_Rel.subtype_fail env e
               ...
               (e,
                 ((let uu___139_4220 = lc in
                   {
                     FStar_Syntax_Syntax.eff_name =
                       (uu___139_4220.FStar_Syntax_Syntax.eff_name);
                     FStar_Syntax_Syntax.res_typ = t;
                     FStar_Syntax_Syntax.cflags =
                       (uu___139_4220.FStar_Syntax_Syntax.cflags);
                     FStar_Syntax_Syntax.comp =
                       (uu___139_4220.FStar_Syntax_Syntax.comp)
          ...
          | (Some g,apply_guard1) ->
              ...
              (match uu____4224 with
               | FStar_TypeChecker_Common.Trivial  ->
                   let lc1 =
                     let uu___140_4229 = lc in
                     {
                       FStar_Syntax_Syntax.eff_name =
                         (uu___140_4229.FStar_Syntax_Syntax.eff_name);
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags =
                         (uu___140_4229.FStar_Syntax_Syntax.cflags);
                       FStar_Syntax_Syntax.comp =
                         (uu___140_4229.FStar_Syntax_Syntax.comp)
                     } in
                   (e, lc1, g)
               | FStar_TypeChecker_Common.NonTrivial f ->
                   let g1 =
                     let uu___141_4232 = g in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___141_4232.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___141_4232.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___141_4232.FStar_TypeChecker_Env.implicits)
                     } in
                     ...
                     then lc.FStar_Syntax_Syntax.comp ()
                       ...
                       (let f1 =
                        ...
                        | FStar_Syntax_Syntax.Tm_abs
                            ...
                            ->
                            let lc1 =
                              let uu___142_4279 = lc in
                              {
                                FStar_Syntax_Syntax.eff_name =
                                  (uu___142_4279.FStar_Syntax_Syntax.eff_name);
                                FStar_Syntax_Syntax.res_typ = t;
                                FStar_Syntax_Syntax.cflags =
                                  (uu___142_4279.FStar_Syntax_Syntax.cflags);
                                FStar_Syntax_Syntax.comp =
                                  (uu___142_4279.FStar_Syntax_Syntax.comp)
                              } in
                            lc1.FStar_Syntax_Syntax.comp ()
                        | uu____4280 ->
                            let c = lc.FStar_Syntax_Syntax.comp () in
                                   ...
                                   | (u_t,uu____4310,uu____4311) ->
                                       ...
                                       (match uu____4345 with
                                        | (eq_ret,_trivial_so_ok_to_discard)
                                            ->
                                            let x1 =
                                              let uu___143_4366 = x in
                                              {
                                                FStar_Syntax_Syntax.ppname =
                                                  (uu___143_4366.FStar_Syntax_Syntax.ppname);
                                                FStar_Syntax_Syntax.index =
                                                  (uu___143_4366.FStar_Syntax_Syntax.index);
                   ...
                   let g2 =
                     let uu___145_4393 = g1 in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___145_4393.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___145_4393.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___145_4393.FStar_TypeChecker_Env.implicits)
                     } in
                   (e, lc1, g2))
      ...
      fun t  ->
        ...
        then (e, torig, FStar_TypeChecker_Rel.trivial_guard)
          ...
          (let number_of_implicits t1 =
           ...
           let decr_inst uu___103_4825 =
             match uu___103_4825 with
             | None  -> None
...
let gather_free_univnames:
  ...
  fun env  ->
    fun t  ->
      ...
      univnames1
let maybe_set_tk ts uu___104_5303 =
  match uu___104_5303 with
  | None  -> ts
  | Some t ->
        ...
        fun t2  ->
          ...
          let decorate e1 t =
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                (FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_name
                      (let uu___146_6444 = x in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___146_6444.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___146_6444.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = t2
                       }))) (Some (t2.FStar_Syntax_Syntax.n))
                  e2.FStar_Syntax_Syntax.pos
            | uu____6445 ->
                let uu___147_6446 = e2 in
                let uu____6447 =
                  FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n)) in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___147_6446.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk = uu____6447;
                  FStar_Syntax_Syntax.pos =
                    (uu___147_6446.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
                    (uu___147_6446.FStar_Syntax_Syntax.vars)
                } in
          let env2 =
            let uu___148_6456 = env1 in
            let uu____6457 =
              env1.FStar_TypeChecker_Env.use_eq ||
                (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)) in
            {
              FStar_TypeChecker_Env.solver =
                (uu___148_6456.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___148_6456.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___148_6456.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___148_6456.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___148_6456.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___148_6456.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___148_6456.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___148_6456.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___148_6456.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___148_6456.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___148_6456.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___148_6456.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___148_6456.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___148_6456.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___148_6456.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____6457;
              FStar_TypeChecker_Env.is_iface =
                (uu___148_6456.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___148_6456.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___148_6456.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___148_6456.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.type_of =
                (uu___148_6456.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___148_6456.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___148_6456.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___148_6456.FStar_TypeChecker_Env.qname_and_index)
            } in
...
let short_circuit:
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___105_6574 =
        match uu___105_6574 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let short_op_ite uu___106_6635 =
        match uu___106_6635 with
        | [] -> FStar_TypeChecker_Common.Trivial
...
let check_sigelt_quals:
  ...
  fun env  ->
    fun se  ->
      let visibility uu___108_7175 =
        match uu___108_7175 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____7176 -> false in
      let reducibility uu___109_7180 =
        ...
        | FStar_Syntax_Syntax.Discriminator _
          |FStar_Syntax_Syntax.Projector _
           |FStar_Syntax_Syntax.RecordType _
            ...
            -> true
        | uu____7201 -> false in
      let has_eq uu___113_7205 =
        match uu___113_7205 with
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                           ...
                           let uu____7480 =
                             let uu___149_7481 = projectee arg_typ in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___149_7481.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___149_7481.FStar_Syntax_Syntax.index);
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____8246 with
                              | (indices,uu____8256) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___119_8283 =
                                      match uu___119_8283 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____8285,fns) ->
                                          Some
