...
let as_uvar : FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.uvar = (fun uu___104_98 -> (match (uu___104_98) with
...
let uu___123_266 = FStar_TypeChecker_Rel.trivial_guard
in (
...
in (uu____282)::[])
in {FStar_TypeChecker_Env.guard_f = uu___123_266.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___123_266.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___123_266.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu____267}))
in (
...
let uu___124_505 = a
in {FStar_Syntax_Syntax.ppname = uu___124_505.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___124_505.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2})), (false)))
end))
end
| uu____506 -> begin
((a), (true))
...
let uu___125_1155 = x
in {FStar_Syntax_Syntax.ppname = uu___125_1155.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___125_1155.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
...
let uu___126_1185 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (e))); FStar_Syntax_Syntax.p = uu___126_1185.FStar_Syntax_Syntax.p})
in (([]), ([]), ([]), (env1), (e), (p2)))
end))))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___127_1221.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___127_1221.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1222}))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___128_1265.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___128_1265.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1266}))
in (
...
let uu___129_1886 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___129_1886.FStar_Syntax_Syntax.p})))))))
end))
end))
in (
...
in {FStar_Syntax_Syntax.v = uu____2473; FStar_Syntax_Syntax.p = uu___130_2470.FStar_Syntax_Syntax.p})))
end))
end)))
end
| uu____2504 -> begin
...
let uu___131_2745 = x
in {FStar_Syntax_Syntax.ppname = uu___131_2745.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___131_2745.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
...
let uu___132_2756 = x
in {FStar_Syntax_Syntax.ppname = uu___132_2756.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___132_2756.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
...
let uu___133_4202 = lc
in (

let uu____4203 = (FStar_Syntax_Subst.subst subst1 lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___133_4202.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____4203; FStar_Syntax_Syntax.cflags = uu___133_4202.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____4208 -> (
...
let uu___134_4348 = lc
in {FStar_Syntax_Syntax.eff_name = uu___134_4348.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___134_4348.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___134_4348.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = close1})))
...
let uu___135_4762 = x
in {FStar_Syntax_Syntax.ppname = uu___135_4762.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___135_4762.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = (FStar_Syntax_Util.comp_result c1)})
in (
...
in {FStar_TypeChecker_Env.guard_f = uu____4979; FStar_TypeChecker_Env.deferred = uu___136_4978.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___136_4978.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___136_4978.FStar_TypeChecker_Env.implicits}))
end))
...
let uu___137_5060 = lc
in {FStar_Syntax_Syntax.eff_name = uu___137_5060.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___137_5060.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___137_5060.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = weaken})))
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___105_5117 -> (match (uu___105_5117) with
...
in {FStar_Syntax_Syntax.eff_name = uu____5201; FStar_Syntax_Syntax.res_typ = uu___138_5200.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu____5202; FStar_Syntax_Syntax.comp = strengthen})))
in ((uu____5199), ((

let uu___139_5212 = g0
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___139_5212.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___139_5212.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___139_5212.FStar_TypeChecker_Env.implicits}))))));
)
end)))
...
let uu___140_5747 = retc1
in {FStar_Syntax_Syntax.comp_univs = uu___140_5747.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Parser_Const.effect_GHOST_lid; FStar_Syntax_Syntax.result_typ = uu___140_5747.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___140_5747.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = flags})
...
let uu___141_5776 = lc
in {FStar_Syntax_Syntax.eff_name = uu___141_5776.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___141_5776.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = refine1}))))
...
let uu___142_6023 = lc
in {FStar_Syntax_Syntax.eff_name = uu___142_6023.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___142_6023.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___142_6023.FStar_Syntax_Syntax.comp})), (FStar_TypeChecker_Rel.trivial_guard));
)
end)
end
...
let uu___143_6036 = lc
in {FStar_Syntax_Syntax.eff_name = uu___143_6036.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___143_6036.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___143_6036.FStar_Syntax_Syntax.comp})
in ((e), (lc1), (g)))
end
| FStar_TypeChecker_Common.NonTrivial (f) -> begin
(
...
let uu___144_6039 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___144_6039.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___144_6039.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___144_6039.FStar_TypeChecker_Env.implicits})
in (
...
let uu___145_6083 = lc
in {FStar_Syntax_Syntax.eff_name = uu___145_6083.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___145_6083.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = uu___145_6083.FStar_Syntax_Syntax.comp})
in (lc1.FStar_Syntax_Syntax.comp ()))
end
| uu____6084 -> begin
(
...
let uu___146_6176 = x
in {FStar_Syntax_Syntax.ppname = uu___146_6176.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___146_6176.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lc.FStar_Syntax_Syntax.res_typ})
in (
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___106_6201 -> (match (uu___106_6201) with
| FStar_Syntax_Syntax.RETURN -> begin
(FStar_Syntax_Syntax.PARTIAL_RETURN)::[]
end
| FStar_Syntax_Syntax.PARTIAL_RETURN -> begin
...
let uu___148_6209 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___148_6209.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___148_6209.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___148_6209.FStar_TypeChecker_Env.implicits})
in ((e), (lc1), (g2)))))))
end))
end))))
...
let decr_inst = (fun uu___107_7048 -> (match (uu___107_7048) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
let uu___149_9989 = x
in {FStar_Syntax_Syntax.ppname = uu___149_9989.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___149_9989.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) FStar_Pervasives_Native.None e2.FStar_Syntax_Syntax.pos)
end
| uu____9990 -> begin
e2
end)))
...
let uu___150_9992 = env1
in (

let uu____9993 = (env1.FStar_TypeChecker_Env.use_eq || (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = uu___150_9992.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___150_9992.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___150_9992.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___150_9992.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___150_9992.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___150_9992.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___150_9992.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___150_9992.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___150_9992.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___150_9992.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___150_9992.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___150_9992.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___150_9992.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___150_9992.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___150_9992.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu____9993; FStar_TypeChecker_Env.is_iface = uu___150_9992.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___150_9992.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___150_9992.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___150_9992.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___150_9992.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___150_9992.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___150_9992.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___150_9992.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___150_9992.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___150_9992.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___150_9992.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___150_9992.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___150_9992.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___150_9992.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___150_9992.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___150_9992.FStar_TypeChecker_Env.tc_hooks}))
in (
...
let short_bin_op = (fun f uu___108_10133 -> (match (uu___108_10133) with
| [] -> begin
...
let short_op_ite = (fun uu___109_10200 -> (match (uu___109_10200) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
...
let uu____10547 = (FStar_Util.prefix_until (fun uu___110_10587 -> (match (uu___110_10587) with
...
let uu___151_10969 = sig_ctx
in {FStar_Syntax_Syntax.sigel = uu___151_10969.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___151_10969.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen)::[]; FStar_Syntax_Syntax.sigmeta = uu___151_10969.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___151_10969.FStar_Syntax_Syntax.sigattrs})), (uu____10963)))))));
))


let check_sigelt_quals : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt  ->  Prims.unit = (fun env se -> (

let visibility = (fun uu___111_10981 -> (match (uu___111_10981) with
...
let reducibility = (fun uu___112_10986 -> (match (uu___112_10986) with
...
let assumption = (fun uu___113_10991 -> (match (uu___113_10991) with
...
let reification = (fun uu___114_10996 -> (match (uu___114_10996) with
...
let inferred = (fun uu___115_11002 -> (match (uu___115_11002) with
...
let has_eq = (fun uu___116_11031 -> (match (uu___116_11031) with
...
let uu____11102 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___117_11106 -> (match (uu___117_11106) with
...
let uu____11182 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((Prims.op_Equality x FStar_Syntax_Syntax.Abstract) || (inferred x)) || (visibility x)) || (has_eq x)))))
in (not (uu____11182)))
...
let uu____11207 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((visibility x) || (Prims.op_Equality x FStar_Syntax_Syntax.Assumption)))))
in (not (uu____11207)))
...
let uu____11215 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((Prims.op_Equality x FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x)))))
in (not (uu____11215)))
...
let uu____11223 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((Prims.op_Equality x FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x)))))
in (not (uu____11223)))
...
let uu___152_11407 = (projectee arg_typ)
in {FStar_Syntax_Syntax.ppname = uu___152_11407.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___152_11407.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})
...
let uu____11548 = (FStar_List.filter (fun uu___118_11552 -> (match (uu___118_11552) with
| FStar_Syntax_Syntax.Abstract -> begin
(not (only_decl))
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____12003 = (FStar_List.filter (fun uu___119_12007 -> (match (uu___119_12007) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____12008 -> begin
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___120_12021 -> (match (uu___120_12021) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____12576 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___121_12581 -> (match (uu___121_12581) with
...
let filter_records = (fun uu___122_12599 -> (match (uu___122_12599) with
