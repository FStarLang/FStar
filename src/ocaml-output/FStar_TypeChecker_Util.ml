                           ...
                           | (bs, body, rcopt) ->
                               ...
                               let rec aux1 body1 =
                                 ...
                                 | FStar_Syntax_Syntax.Tm_meta (body3, m) ->
                                     let uu___9 = aux1 body3 in
                                     (match uu___9 with
                                      | (t3, body', recheck) ->
                                          let body4 =
                                            let uu___10 = body3 in
                                            {
                                              FStar_Syntax_Syntax.n =
                                                (FStar_Syntax_Syntax.Tm_meta
                                                   (body', m));
                                              FStar_Syntax_Syntax.pos =
                                                (uu___10.FStar_Syntax_Syntax.pos);
                                              FStar_Syntax_Syntax.vars =
                                                (uu___10.FStar_Syntax_Syntax.vars)
                                            } in
                                          (t3, body4, recheck))
                                 | FStar_Syntax_Syntax.Tm_ascribed
                                     (uu___9,
                                      (FStar_Pervasives.Inl t3, uu___10),
                                      uu___11)
                                     ->
                                     (match lbtyp_opt with
                                                 ...
                                                 (let subst =
                                                  ...
                                                  (let body3 =
                                                     let uu___13 = body2 in
                                                     {
                                                       ...
                                                       FStar_Syntax_Syntax.pos
                                                         =
                                                         (uu___13.FStar_Syntax_Syntax.pos);
                                                       FStar_Syntax_Syntax.vars
                                                         =
                                                         (uu___13.FStar_Syntax_Syntax.vars)
                                                     } in
                                                   (lbtyp, body3, recheck)))))
                                 | uu___9 ->
                                     ((let uu___11 =
                                      ...
                                      (match lbtyp_opt with
                                       ...
                                       | FStar_Pervasives_Native.None ->
                                           let tarr =
                                             ...
                                             mk_arrow uu___11 in
                                           (tarr, body2, true))) in
                               let uu___9 = aux1 body in
                               (match uu___9 with
                                | (lbtyp, body1, recheck) ->
                                    let uu___10 =
                                      FStar_Syntax_Util.abs bs body1 rcopt in
                                    (lbtyp, uu___10, recheck)))) in
                   aux e1 in
                                                              ...
                                                              (match uu___11
                                                               ...
                                                               | (bs1, c1) ->
                                                                   let bs_subst
                                                                    ...
                                                                    FStar_List.hd
                                                                    bs1 in
                                                                    uu___14.FStar_Syntax_Syntax.binder_bv in
                                                                    let uu___14
                                                                    =
                                                                    FStar_All.pipe_right
                               ...
                               (let aux uu___7 =
                                  ...
                                  then
                                    ...
                                    (let uu___10 =
                                     ...
                                     if uu___10
                                     then
                                       FStar_Pervasives.Inl (c2, "both ml")
                                     else
                                       FStar_Pervasives.Inr
                           ...
                           FStar_TypeChecker_Env.uvars_for_binders env
                             ...
                             (fun b ->
                                ...
                                let uu___7 =
                                  FStar_Ident.string_of_lid
                                    ct.FStar_Syntax_Syntax.effect_name in
                                let uu___8 = FStar_Ident.string_of_lid tgt in
                                let uu___9 = FStar_Range.string_of_range r in
                                FStar_Util.format4
                                  "implicit var for binder %s of %s~>%s at %s"
                                  uu___6 uu___7 uu___8 uu___9) r in
                         (match uu___5 with
                          | (rest_bs_uvars, g) ->
                              ((let uu___7 =
                                  FStar_All.pipe_left
