...
(match (se) with
| FStar_Syntax_Syntax.Sig_let ((is_rec, uu____7275), uu____7276, uu____7277, uu____7278, uu____7279) -> begin
((

let uu____7292 = (is_rec && (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen)))
...
let uu____7295 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun x -> ((assumption x) || (has_eq x)))))
...
| FStar_Syntax_Syntax.Sig_bundle (uu____7299) -> begin
(

let uu____7307 = (

let uu____7308 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.Abstract) || (inferred x)) || (visibility x)) || (has_eq x)))))
in (not (uu____7308)))
...
| FStar_Syntax_Syntax.Sig_declare_typ (uu____7312) -> begin
(

let uu____7319 = (FStar_All.pipe_right quals (FStar_Util.for_some has_eq))
...
| FStar_Syntax_Syntax.Sig_assume (uu____7322) -> begin
(

let uu____7328 = (

let uu____7329 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((visibility x) || (x = FStar_Syntax_Syntax.Assumption)))))
in (not (uu____7329)))
...
| FStar_Syntax_Syntax.Sig_new_effect (uu____7333) -> begin
(
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____7341) -> begin
(

let uu____7344 = (

let uu____7345 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x)))))
in (not (uu____7345)))
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (uu____7349) -> begin
(

let uu____7359 = (

let uu____7360 = (FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((inferred x) || (visibility x)))))
in (not (uu____7360)))
...
let uu____7431 = (FStar_Syntax_Syntax.lid_as_fv tc FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7431))
in ((uu____7430), (inst_univs)))
in FStar_Syntax_Syntax.Tm_uinst (uu____7425))
in (FStar_Syntax_Syntax.mk uu____7424))
in (uu____7421 None p))
in (

let args = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun uu____7457 -> (match (uu____7457) with
| (x, imp) -> begin
(

let uu____7464 = (FStar_Syntax_Syntax.bv_to_name x)
in ((uu____7464), (imp)))
end))))
...
let uu____7470 = (projectee arg_typ)
in (FStar_Syntax_Syntax.mk_binder uu____7470))
in (
...
let uu____7482 = (FStar_Syntax_Syntax.mk_Tm_uinst disc_fvar inst_univs)
in (
...
let uu____7485 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____7485))
in (uu____7484)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____7482 uu____7483)))
in (uu____7481 None p))
in (FStar_Syntax_Util.b2t uu____7480))
in (FStar_Syntax_Util.refine x uu____7479)))
in (

let uu____7490 = (

let uu___143_7491 = (projectee arg_typ)
in {FStar_Syntax_Syntax.ppname = uu___143_7491.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___143_7491.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})
in (FStar_Syntax_Syntax.mk_binder uu____7490)))))
end)
in (
...
let uu____7501 = (FStar_List.map (fun uu____7511 -> (match (uu____7511) with
| (x, uu____7518) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end)) tps)
in (FStar_List.append uu____7501 fields))
in (

let imp_binders = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun uu____7542 -> (match (uu____7542) with
| (x, uu____7549) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end))))
in (
...
let uu____7558 = (FStar_TypeChecker_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid uu____7558)) || (

let uu____7559 = (

let uu____7560 = (FStar_TypeChecker_Env.current_module env)
in uu____7560.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____7559)))
in (
...
let uu____7567 = (only_decl && ((FStar_All.pipe_left Prims.op_Negation env.FStar_TypeChecker_Env.is_iface) || env.FStar_TypeChecker_Env.admit))
...
let uu____7570 = (FStar_List.filter (fun uu___109_7572 -> (match (uu___109_7572) with
...
in (FStar_List.append uu____7565 uu____7570)))
...
let uu____7587 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.bool_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7587))
in (FStar_Syntax_Syntax.mk_Total uu____7586))
in (

let uu____7588 = (FStar_Syntax_Util.arrow binders bool_typ)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close_univ_vars uvs) uu____7588)))
in (

let decl = FStar_Syntax_Syntax.Sig_declare_typ (((discriminator_name), (uvs), (t), (quals), ((FStar_Ident.range_of_lid discriminator_name))))
in ((

let uu____7592 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7592) with
| true -> begin
(

let uu____7593 = (FStar_Syntax_Print.sigelt_to_string decl)
...
let arg_pats = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j uu____7621 -> (match (uu____7621) with
| (x, imp) -> begin
(
...
let uu____7646 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((uu____7646), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (uu____7641))
in (pos uu____7640))
in ((uu____7637), (b)))
end
| uu____7649 -> begin
...
let uu____7654 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7654))
in (pos uu____7653))
in ((uu____7650), (b)))
end))
end))))
...
let uu____7678 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((uu____7678), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (uu____7670))
in (pos uu____7669))
in ((uu____7666), (None), (FStar_Syntax_Const.exp_true_bool)))
in (
...
let uu____7704 = (FStar_Syntax_Syntax.new_bv None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7704))
in (pos uu____7703))
in ((uu____7700), (None), (FStar_Syntax_Const.exp_false_bool)))
in (
...
let uu____7735 = (FStar_Syntax_Util.branch pat_true)
in (

let uu____7736 = (

let uu____7738 = (FStar_Syntax_Util.branch pat_false)
in (uu____7738)::[])
in (uu____7735)::uu____7736))
in ((arg_exp), (uu____7733)))
in FStar_Syntax_Syntax.Tm_match (uu____7717))
in (FStar_Syntax_Syntax.mk uu____7716))
in (uu____7713 None p))))))
end)
in (

let dd = (

let uu____7749 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____7764 = (FStar_Syntax_Syntax.lid_as_fv discriminator_name dd None)
in FStar_Util.Inr (uu____7764))
in (

let uu____7765 = (FStar_Syntax_Subst.close_univ_vars uvs imp)
in {FStar_Syntax_Syntax.lbname = uu____7761; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____7765}))
in (
...
let uu____7781 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____7781 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____7780)::[])
in ((((false), ((lb)::[]))), (p), (uu____7778), (quals), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____7769))
in ((

let uu____7797 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7797) with
| true -> begin
(

let uu____7798 = (FStar_Syntax_Print.sigelt_to_string impl)
...
let subst1 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____7818 -> (match (uu____7818) with
| (a, uu____7822) -> begin
(

let uu____7823 = (FStar_Syntax_Util.mk_field_projector_name lid a i)
in (match (uu____7823) with
| (field_name, uu____7827) -> begin
(
...
let uu____7830 = (FStar_Syntax_Syntax.lid_as_fv field_name FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.fv_to_tm uu____7830))
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____7829 inst_univs))
in (
...
let uu____7846 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____7855 -> (match (uu____7855) with
| (x, uu____7860) -> begin
(
...
let uu____7862 = (FStar_Syntax_Util.mk_field_projector_name lid x i)
in (match (uu____7862) with
| (field_name, uu____7867) -> begin
(
...
let uu____7873 = (FStar_Syntax_Subst.subst subst1 x.FStar_Syntax_Syntax.sort)
in (FStar_Syntax_Syntax.mk_Total uu____7873))
in (FStar_Syntax_Util.arrow binders uu____7870))
in (FStar_All.pipe_left (FStar_Syntax_Subst.close_univ_vars uvs) uu____7869))
in (

let only_decl = (((

let uu____7875 = (FStar_TypeChecker_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid uu____7875)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (

let uu____7876 = (

let uu____7877 = (FStar_TypeChecker_Env.current_module env)
in uu____7877.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____7876)))
in (
...
let uu____7887 = (FStar_List.filter (fun uu___110_7889 -> (match (uu___110_7889) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____7890 -> begin
...
in (FStar_Syntax_Syntax.Assumption)::uu____7887)
end
| uu____7891 -> begin
q
end))
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___111_7898 -> (match (uu___111_7898) with
...
let decl = FStar_Syntax_Syntax.Sig_declare_typ (((field_name), (uvs), (t), (quals1), ((FStar_Ident.range_of_lid field_name))))
in ((

let uu____7903 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____7903) with
| true -> begin
(

let uu____7904 = (FStar_Syntax_Print.sigelt_to_string decl)
...
let arg_pats = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j uu____7931 -> (match (uu____7931) with
| (x1, imp) -> begin
(
...
let uu____7947 = (pos (FStar_Syntax_Syntax.Pat_var (projection)))
in ((uu____7947), (b)))
end
| uu____7952 -> begin
(match ((b && (j < ntps))) with
...
let uu____7968 = (FStar_Syntax_Syntax.gen_bv x1.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((uu____7968), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (uu____7963))
in (pos uu____7962))
in ((uu____7959), (b)))
end
| uu____7971 -> begin
...
let uu____7976 = (FStar_Syntax_Syntax.gen_bv x1.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (uu____7976))
in (pos uu____7975))
in ((uu____7972), (b)))
end)
end))
...
let uu____8000 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((uu____8000), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (uu____7992))
in (pos uu____7991))
in (

let uu____8006 = (FStar_Syntax_Syntax.bv_to_name projection)
in ((uu____7988), (None), (uu____8006))))
in (
...
let uu____8039 = (FStar_Syntax_Util.branch pat)
in (uu____8039)::[])
in ((arg_exp), (uu____8037)))
in FStar_Syntax_Syntax.Tm_match (uu____8021))
in (FStar_Syntax_Syntax.mk uu____8020))
in (uu____8017 None p1))
in (
...
let uu____8056 = (FStar_All.pipe_right quals1 (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____8065 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (uu____8065))
in (

let uu____8066 = (FStar_Syntax_Subst.close_univ_vars uvs imp)
in {FStar_Syntax_Syntax.lbname = uu____8062; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____8066}))
in (
...
let uu____8082 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____8082 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____8081)::[])
in ((((false), ((lb)::[]))), (p1), (uu____8079), (quals1), ([])))
in FStar_Syntax_Syntax.Sig_let (uu____8070))
in ((

let uu____8098 = (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("LogTypes")))
in (match (uu____8098) with
| true -> begin
(

let uu____8099 = (FStar_Syntax_Print.sigelt_to_string impl)
...
in (FStar_All.pipe_right uu____7846 FStar_List.flatten))
...
| FStar_Syntax_Syntax.Sig_datacon (constr_lid, uvs, t, typ_lid, n_typars, quals, uu____8130, r) when (not ((FStar_Ident.lid_equals constr_lid FStar_Syntax_Const.lexcons_lid))) -> begin
(

let uu____8136 = (FStar_Syntax_Subst.univ_var_opening uvs)
...
let uu____8149 = (FStar_Syntax_Util.arrow_formals t1)
in (match (uu____8149) with
| (formals, uu____8159) -> begin
(
...
let uu____8185 = (FStar_Syntax_Util.lid_of_sigelt se1)
in (FStar_Util.must uu____8185))
in (FStar_Ident.lid_equals typ_lid uu____8184))
in (match (uu____8183) with
| true -> begin
(match (se1) with
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____8195, uvs', tps, typ0, uu____8199, constrs, uu____8201, uu____8202) -> begin
...
let uu____8258 = (FStar_Syntax_Util.arrow_formals typ01)
in (match (uu____8258) with
| (indices, uu____8268) -> begin
(

let refine_domain = (

let uu____8280 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___112_8282 -> (match (uu___112_8282) with
| FStar_Syntax_Syntax.RecordConstructor (uu____8283) -> begin
true
end
| uu____8288 -> begin
false
end))))
in (match (uu____8280) with
| true -> begin
false
end
| uu____8289 -> begin
...
let filter_records = (fun uu___113_8295 -> (match (uu___113_8295) with
| FStar_Syntax_Syntax.RecordConstructor (uu____8297, fns) -> begin
...
let uu____8305 = (FStar_Util.find_map quals filter_records)
...
let uu____8313 = (FStar_Util.first_N n_typars formals)
in (match (uu____8313) with
| (imp_tps, fields) -> begin
(

let rename = (FStar_List.map2 (fun uu____8344 uu____8345 -> (match (((uu____8344), (uu____8345))) with
| ((x, uu____8355), (x', uu____8357)) -> begin
(

let uu____8362 = (

let uu____8367 = (FStar_Syntax_Syntax.bv_to_name x')
in ((x), (uu____8367)))
in FStar_Syntax_Syntax.NT (uu____8362))
