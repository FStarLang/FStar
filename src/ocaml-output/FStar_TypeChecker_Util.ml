...
in (FStar_All.pipe_right _157_13 (FStar_List.filter (fun _57_33 -> (match (_57_33) with
| (x, _57_32) -> begin
...
in (_157_36)::[])
in {FStar_TypeChecker_Env.guard_f = _57_72.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _57_72.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _57_72.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _157_37}))
...
let _57_89 = (let _157_49 = (let _157_48 = (FStar_Syntax_Print.term_to_string t)
...
let _57_177 = (let _157_78 = (t_binders env)
in (aux _157_78 e))
...
let _57_213 = (let _157_95 = (FStar_TypeChecker_Env.all_binders env)
...
in {FStar_Syntax_Syntax.ppname = _57_223.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_223.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_96}))
in (
...
in {FStar_Syntax_Syntax.ppname = _57_234.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_234.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_97}))
in (
...
in {FStar_Syntax_Syntax.v = _157_139; FStar_Syntax_Syntax.ty = _57_355.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _57_355.FStar_Syntax_Syntax.p})))
end))
end)))
end
| _57_358 -> begin
...
let _57_535 = if (let _157_190 = (FStar_Syntax_Syntax.fv_eq fv fv')
...
let _57_615 = (let _157_220 = (FStar_All.pipe_right pats (FStar_List.map pat_as_arg))
...
| _57_628 -> begin
(let _157_230 = (let _157_229 = (let _157_228 = (FStar_List.map (fun _57_632 -> (match (_57_632) with
| (x, _57_631) -> begin
...
let _57_650 = (let _157_258 = (FStar_TypeChecker_Env.norm_eff_name env l1)
...
in {FStar_Syntax_Syntax.eff_name = _57_687.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _157_326; FStar_Syntax_Syntax.cflags = _57_687.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _57_689 -> (match (()) with
| () -> begin
...
in {FStar_TypeChecker_Env.guard_f = _157_424; FStar_TypeChecker_Env.deferred = _57_807.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _57_807.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _57_807.FStar_TypeChecker_Env.implicits}))
end))
...
in {FStar_Syntax_Syntax.eff_name = _157_483; FStar_Syntax_Syntax.res_typ = _57_873.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _157_482; FStar_Syntax_Syntax.comp = strengthen})))
in ((_157_484), ((
...
let _57_885 = (let _157_492 = (FStar_Syntax_Syntax.bv_to_name x)
...
let _57_916 = (let _157_528 = (lcomp_then.FStar_Syntax_Syntax.comp ())
...
let _57_974 = (let _157_605 = (cthen.FStar_Syntax_Syntax.comp ())
...
let _57_1125 = (let _157_716 = (FStar_All.pipe_left (fun _157_713 -> Some (_157_713)) (FStar_TypeChecker_Errors.subtyping_failed env lc.FStar_Syntax_Syntax.res_typ t))
...
let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _157_815 = (FStar_Util.for_all (fun _57_1315 -> (match (_57_1315) with
| (_57_1313, c) -> begin
...
let _57_1337 = (let _157_824 = (FStar_All.pipe_right ecs (FStar_List.map (fun _57_1328 -> (match (_57_1328) with
| (e, c) -> begin
(
...
(let _157_844 = (let _157_843 = (FStar_List.map (fun _57_1434 -> (match (_57_1434) with
...
let generalized_lecs = (match ((let _157_847 = (FStar_All.pipe_right lecs (FStar_List.map (fun _57_1446 -> (match (_57_1446) with
| (_57_1443, e, c) -> begin
((e), (c))
end))))
...
in {FStar_Syntax_Syntax.n = _57_1502.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _157_881; FStar_Syntax_Syntax.pos = _57_1502.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_1502.FStar_Syntax_Syntax.vars}))
end)))
in (
...
let _57_1682 = (let _157_1024 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
...
in if (let _157_1089 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun _57_15 -> (match (_57_15) with
...
let all_params = (let _157_1148 = (FStar_List.map (fun _57_1887 -> (match (_57_1887) with
| (x, _57_1886) -> begin
...
in (let _157_1154 = (FStar_List.filter (fun _57_16 -> (match (_57_16) with
...
let projectors_ses = (let _157_1238 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _57_1947 -> (match (_57_1947) with
| (x, _57_1946) -> begin
(
...
(let _157_1207 = (FStar_List.filter (fun _57_17 -> (match (_57_17) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| _57_1961 -> begin
