        ...
        fun k  ->
          ...
          | uu____162 ->
              ...
              (match uu____169 with
               | (t,u) ->
                   let g =
                     let uu___119_181 = FStar_TypeChecker_Rel.trivial_guard
                        in
                     let uu____182 =
                       let uu____190 =
      ...
      fun v1  ->
                      ...
                      let uu____2960 =
                        let uu____2961 =
                          ...
                          let uu____2963 =
                            ...
                            let uu____2965 =
                              let uu____2967 = FStar_Syntax_Syntax.as_arg v1
                                 in
                              [uu____2967]  in
                            uu____2964 :: uu____2965  in
                          FStar_Syntax_Syntax.mk_Tm_app uu____2962 uu____2963
                           in
                        uu____2961 (Some (k.FStar_Syntax_Syntax.n))
                          v1.FStar_Syntax_Syntax.pos
                         in
                      FStar_TypeChecker_Normalize.normalize
                        [FStar_TypeChecker_Normalize.Beta] env uu____2960)
                in
        ...
        (let uu____2973 =
         ...
         then
           ...
           let uu____2976 = FStar_TypeChecker_Normalize.comp_to_string env c
              in
            ...
            | (b,lc2) ->
                ...
                ((let uu____3003 =
                  ...
                  then
                    ...
                    let uu____3008 = FStar_Syntax_Print.lcomp_to_string lc11
                       in
                    let uu____3009 = FStar_Syntax_Print.lcomp_to_string lc21
                       in
                    FStar_Util.print4
                                 ...
                                 let wp =
                                   let uu____3256 =
                                     ...
                                     FStar_Syntax_Syntax.mk_Tm_app uu____3257
                                       wp_args
                                      in
                                   uu____3256 None t2.FStar_Syntax_Syntax.pos
                                    in
                          ...
                          | (us_e,uu____4568) ->
                              ...
                              let ens =
                                ...
                                uu____4602 None
                                 ...
                                 in
                              let uu____4624 =
                                let uu____4626 = norm req  in Some uu____4626
                                 in
                              let uu____4627 =
                                let uu____4628 =
                                  mk_post_type
             ...
             | Some expected_t ->
                 ...
                 then
                   let uu____4924 =
                     let uu____4925 =
                       let uu____4928 =
                         let uu____4929 = FStar_Util.string_of_int n_expected
                            in
                         let uu____4933 = FStar_Syntax_Print.term_to_string e
                            in
                         let uu____4934 =
                           FStar_Util.string_of_int n_available  in
                         FStar_Util.format3
                           "Expected a term with %s implicit arguments, but %s has only %s"
                           uu____4929 uu____4933 uu____4934
                          in
                       let uu____4938 = FStar_TypeChecker_Env.get_range env
                          in
    ...
    FStar_All.pipe_right uu____5323
      (FStar_List.map
         (fun u  ->
            ...
            FStar_All.pipe_right uu____5333 FStar_Util.string_of_int))
     in
...
let maybe_set_tk ts uu___103_5429 =
  match uu___103_5429 with
  | None  -> ts
  | Some t ->
                                            ...
                                            let uu____6180 =
                                              FStar_Syntax_Subst.compress
                                                (FStar_Syntax_Util.comp_result
                                                   c1)
                                               in
                                            uu____6180.FStar_Syntax_Syntax.n
                                             in
         ...
         let uu____6293 =
           let uu____6300 =
             FStar_All.pipe_right lecs
               (FStar_List.map
                  (fun uu____6316  ->
                     match uu____6316 with | (uu____6322,e,c) -> (e, c)))
              in
        ...
        fun t2  ->
            ...
            then FStar_TypeChecker_Rel.try_teq true env2 t11 t21
              ...
              (let uu____6533 =
               ...
               | Some f ->
                   ...
                   FStar_All.pipe_left (fun _0_31  -> Some _0_31) uu____6537)
             in
          let is_var e1 =
            let uu____6543 =
          ...
          let decorate e1 t =
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                (FStar_Syntax_Syntax.mk
                   (FStar_Syntax_Syntax.Tm_name
                      (let uu___145_6570 = x  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___145_6570.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___145_6570.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = t2
                       }))) (Some (t2.FStar_Syntax_Syntax.n))
                  e2.FStar_Syntax_Syntax.pos
            | uu____6571 ->
                let uu___146_6572 = e2  in
                let uu____6573 =
                  FStar_Util.mk_ref (Some (t2.FStar_Syntax_Syntax.n))  in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___146_6572.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk = uu____6573;
                  FStar_Syntax_Syntax.pos =
                    (uu___146_6572.FStar_Syntax_Syntax.pos);
                  FStar_Syntax_Syntax.vars =
                    (uu___146_6572.FStar_Syntax_Syntax.vars)
                }
             in
          let env2 =
            let uu___147_6582 = env1  in
            let uu____6583 =
               ...
               in
            {
              FStar_TypeChecker_Env.solver =
                (uu___147_6582.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___147_6582.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___147_6582.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___147_6582.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___147_6582.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___147_6582.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___147_6582.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___147_6582.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___147_6582.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___147_6582.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___147_6582.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___147_6582.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___147_6582.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___147_6582.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___147_6582.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____6583;
              FStar_TypeChecker_Env.is_iface =
                (uu___147_6582.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___147_6582.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___147_6582.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___147_6582.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.type_of =
                (uu___147_6582.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___147_6582.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___147_6582.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___147_6582.FStar_TypeChecker_Env.qname_and_index)
            }  in
           ...
           let c1 =
             let uu____6641 =
               let uu____6642 =
                 ...
                 FStar_All.pipe_right uu____6643 FStar_Syntax_Syntax.mk_Comp
                  in
...
let short_circuit :
  ...
  fun head1  ->
    fun seen_args  ->
      let short_bin_op f uu___104_6700 =
        match uu___104_6700 with
        | [] -> FStar_TypeChecker_Common.Trivial
      ...
      let op_imp_t t =
        FStar_All.pipe_right t
         ...
         in
      let short_op_ite uu___105_6761 =
        match uu___105_6761 with
        | [] -> FStar_TypeChecker_Common.Trivial
        ...
        (let fv =
         ...
         let uu____7278 =
           (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv)) None
            ...
            in
         ((let uu___148_7291 = sig_ctx  in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___148_7291.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___148_7291.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___148_7291.FStar_Syntax_Syntax.sigmeta)
           }), uu____7278))
...
let check_sigelt_quals :
  ...
  fun env  ->
    fun se  ->
      let visibility uu___107_7301 =
        match uu___107_7301 with
        | FStar_Syntax_Syntax.Private  -> true
        | uu____7302 -> false  in
      let reducibility uu___108_7306 =
        match uu___108_7306 with
        | FStar_Syntax_Syntax.Abstract 
          |FStar_Syntax_Syntax.Irreducible 
           |FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen 
            ...
            -> true
        | uu____7307 -> false  in
      let assumption uu___109_7311 =
        match uu___109_7311 with
        | FStar_Syntax_Syntax.Assumption |FStar_Syntax_Syntax.New  -> true
        | uu____7312 -> false  in
      let reification uu___110_7316 =
        match uu___110_7316 with
        | FStar_Syntax_Syntax.Reifiable |FStar_Syntax_Syntax.Reflectable _ ->
            true
        | uu____7318 -> false  in
      let inferred uu___111_7322 =
        match uu___111_7322 with
        | FStar_Syntax_Syntax.Discriminator _
          |FStar_Syntax_Syntax.Projector _
           |FStar_Syntax_Syntax.RecordType _
            ...
            -> true
        | uu____7327 -> false  in
      let has_eq uu___112_7331 =
        match uu___112_7331 with
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                           ...
                           let uu____7595 =
                             let uu___149_7596 = projectee arg_typ  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___149_7596.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___149_7596.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = sort
                             }  in
                           FStar_Syntax_Syntax.mk_binder uu____7595)
                         in
                             ...
                             (let uu____7663 =
                              ...
                              FStar_Ident.lid_equals
                               ...
                               (let uu____7664 =
                                ...
                                FStar_Options.dont_gen_projectors uu____7664)
                              in
                           let quals =
                             let uu____7668 =
                               let uu____7670 =
                               ...
                               let uu____7675 =
                                 FStar_List.filter
                                   (fun uu___114_7677  ->
                                      match uu___114_7677 with
                                      | FStar_Syntax_Syntax.Abstract  ->
                                          Prims.op_Negation only_decl
                                      | FStar_Syntax_Syntax.Private  -> true
                                      | uu____7678 -> false) iquals
                                  in
                            ...
                            FStar_Util.find_map tcs
                              (fun se1  ->
                                 let uu____8276 =
                                   ...
                                   FStar_Ident.lid_equals typ_lid uu____8277
                                    in
                                 if uu____8276
                                 then
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____8347 with
                              | (indices,uu____8357) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___118_8384 =
                                      match uu___118_8384 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____8386,fns) ->
                                          Some
