                              ...
                              (let u_t_opt = comp_univ_opt c  in
                               ...
                               let uu____5391 =
                                 ...
                                 strengthen_precondition uu____5396
                                   uu____5418 e uu____5419 uu____5420
                                  in
            ...
            then
              ...
              let uu____6206 =
                ...
                FStar_Common.string_of_option
                  FStar_Syntax_Print.term_to_string uu____6208
                 in
              FStar_Util.print3
                                  ...
                                  (FStar_Option.isNone imp) ||
                                    (let uu____6352 =
                                       FStar_Syntax_Util.eq_aqual imp
                                        ...
                                        in
                                     uu____6352 = FStar_Syntax_Util.Equal)))
                       in
                    ...
                    let uu____6491 =
                      let uu____6497 =
                        ...
                        FStar_Util.format3
                          ...
                          uu____6499 uu____6501 uu____6503
                         in
                ...
                (match uu____6568 with
                 | (bs1,c1) ->
                     let rec aux subst1 inst_n bs2 =
                       ...
                       | (FStar_Pervasives_Native.Some _6699,uu____6686) when
                           _6699 = (Prims.parse_int "0") ->
                           ([], bs2, subst1,
                             FStar_TypeChecker_Env.trivial_guard)
                       ...
                       | (uu____6957,(x,FStar_Pervasives_Native.Some
                           ...
                           let uu____6994 =
                             ...
                             FStar_TypeChecker_Env.new_implicit_var_aux
                               ...
                               e.FStar_Syntax_Syntax.pos env t2
                               FStar_Syntax_Syntax.Strict uu____7007
                              in
      ...
      FStar_All.pipe_right uu____7468
        (FStar_List.map
           (fun u  ->
              ...
              FStar_All.pipe_right uu____7480 FStar_Util.string_of_int))
       in
            ...
            let uu____7705 =
              let uu____7711 =
                ...
                Prims.op_Hat
                  ...
                  uu____7713
                 in
              (FStar_Errors.Fatal_UnexpectedGeneralizedUniverse, uu____7711)
               in
                 ...
                 let fail1 k =
                   ...
                   | (lbname,e,c) ->
                       let uu____8666 =
                         let uu____8672 =
                           ...
                           FStar_Util.format3
                             ...
                             uu____8674 uu____8676 uu____8678
                            in
                       ...
                       let uu____8682 = FStar_TypeChecker_Env.get_range env
                          in
                       FStar_Errors.raise_error uu____8666 uu____8682
                    in
                                      ...
                                      let uu____8767 =
                                        let uu____8770 =
                                          FStar_TypeChecker_Normalize.unfold_whnf
                                            env kres
                                           in
                                        FStar_Syntax_Util.unrefine uu____8770
                                         in
                                            ...
                                            let uu____9107 =
                                              FStar_Syntax_Subst.compress
                                                (FStar_Syntax_Util.comp_result
                                                   c1)
                                               in
                                            uu____9107.FStar_Syntax_Syntax.n
                                             in
            ...
            let c1 =
              let uu____9926 =
                let uu____9927 =
                  ...
                  FStar_All.pipe_right uu____9928 FStar_Syntax_Syntax.mk_Comp
                   in
    ...
    fun seen_args  ->
      ...
      let op_and_e e =
        ...
        FStar_All.pipe_right uu____10105
          (fun _10106  -> FStar_TypeChecker_Common.NonTrivial _10106)
         in
      let op_or_e e =
        let uu____10117 =
        ...
        FStar_All.pipe_right uu____10117
          (fun _10121  -> FStar_TypeChecker_Common.NonTrivial _10121)
         in
      let op_and_t t =
        FStar_All.pipe_right t
          (fun _10128  -> FStar_TypeChecker_Common.NonTrivial _10128)
         in
      let op_or_t t =
        let uu____10139 = FStar_All.pipe_right t FStar_Syntax_Util.mk_neg  in
        FStar_All.pipe_right uu____10139
          (fun _10142  -> FStar_TypeChecker_Common.NonTrivial _10142)
         in
      let op_imp_t t =
        FStar_All.pipe_right t
          (fun _10149  -> FStar_TypeChecker_Common.NonTrivial _10149)
         in
  ...
  fun g  ->
    fun t  ->
        ...
        FStar_All.pipe_right uu____11531
          (fun l_opt  ->
             (FStar_Util.is_some l_opt) &&
               (let uu____11555 = FStar_All.pipe_right l_opt FStar_Util.must
                   in
                FStar_All.pipe_right uu____11555
                  (FStar_List.existsb
                     (fun t1  ->
                        let uu____11573 =
                          let uu____11574 = FStar_Syntax_Subst.compress t1
                             in
      ...
      let rec aux_whnf env t1 =
        let uu____11606 =
          let uu____11607 = FStar_Syntax_Subst.compress t1  in
          uu____11607.FStar_Syntax_Syntax.n  in
        match uu____11606 with
        | FStar_Syntax_Syntax.Tm_type uu____11611 -> true
        | FStar_Syntax_Syntax.Tm_fvar fv ->
            let is_sub_singleton1 datacons =
              match datacons with
              | [] -> true
              | d1::[] ->
                  let uu____11628 =
                    FStar_TypeChecker_Env.lookup_datacon env d1  in
                  (match uu____11628 with
                   | (uu____11634,t2) ->
                       let t3 = norm1 env t2  in
                       let uu____11637 =
                         FStar_Syntax_Util.arrow_formals_comp t3  in
                            ...
                            FStar_All.pipe_right bs
                              (FStar_List.for_all
                                 (fun uu____11687  ->
                                    ...
                                    | (x,uu____11696) ->
                                        aux env x.FStar_Syntax_Syntax.sort))))
              | uu____11701 -> false  in
            ((FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.unit_lid)
               || (has_erased_for_extraction_attr fv))
              ||
              (let uu____11708 =
                 FStar_TypeChecker_Env.datacons_of_typ env
                   (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                  in
               (match uu____11708 with
                | (is_inductive,datacons) ->
                    is_inductive && (is_sub_singleton1 datacons)))
        | FStar_Syntax_Syntax.Tm_arrow uu____11725 ->
            let uu____11740 = FStar_Syntax_Util.arrow_formals_comp t1  in
            (match uu____11740 with
             | (bs,c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs  in
                 let uu____11773 = FStar_Syntax_Util.is_pure_comp c  in
                 if uu____11773
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____11779;
               FStar_Syntax_Syntax.index = uu____11780;
               FStar_Syntax_Syntax.sort = t2;_},uu____11782)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____11791,uu____11792) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____11834::[]) ->
            let uu____11873 =
              let uu____11874 = FStar_Syntax_Util.un_uinst head1  in
              uu____11874.FStar_Syntax_Syntax.n  in
            (match uu____11873 with
             | FStar_Syntax_Syntax.Tm_fvar fv -> aux env head1
             | uu____11879 -> false)
        | uu____11881 -> false
      
      and aux env t1 =
        let t2 = norm1 env t1  in
        ...
        (let uu____11891 =
         ...
         if uu____11891
         then
           let uu____11896 = FStar_Syntax_Print.term_to_string t2  in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____11896
         else ());
        res
       in aux g t
