      ...
      fun tcs  ->
        fun se  ->
          ...
          | FStar_Syntax_Syntax.Sig_datacon
              (constr_lid,uvs,t,typ_lid,n_typars,uu____12142) when
              Prims.op_Negation
                (FStar_Ident.lid_equals constr_lid
                   FStar_Parser_Const.lexcons_lid)
              ->
              let uu____12147 = FStar_Syntax_Subst.univ_var_opening uvs  in
              (match uu____12147 with
               | (univ_opening,uvs1) ->
                   let t1 = FStar_Syntax_Subst.subst univ_opening t  in
                   let uu____12169 = FStar_Syntax_Util.arrow_formals t1  in
                                   ...
                                   let uu____12235 =
                                     let uu____12236 =
                                       FStar_Syntax_Util.lid_of_sigelt se1
                                        in
                                     FStar_Util.must uu____12236  in
                                   FStar_Ident.lid_equals typ_lid uu____12235
                                    in
                                 if uu____12234
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____12255,uvs',tps,typ0,uu____12259,constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____12351 with
                              | (indices,uu____12367) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___120_12408 =
                                      match uu___120_12408 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____12411,fns) ->
                                          FStar_Pervasives_Native.Some
