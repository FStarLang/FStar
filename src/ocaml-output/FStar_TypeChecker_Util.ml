      ...
      fun usubst  ->
        fun us  ->
          let uu____13405 =
            ...
            | FStar_Syntax_Syntax.Sig_inductive_typ
                (lid,uu____13419,bs,t,uu____13422,uu____13423) ->
                (lid, bs, t)
            | uu____13432 -> failwith "Impossible!"  in
              ...
              let t1 =
                let uu____13454 =
                  FStar_Syntax_Subst.shift_subst (FStar_List.length bs1)
                    usubst
                   in
                FStar_Syntax_Subst.subst uu____13454 t  in
              let uu____13461 = FStar_Syntax_Subst.open_term bs1 t1  in
              (match uu____13461 with
               | (bs2,t2) ->
                   let ibs =
                     let uu____13485 =
                       let uu____13486 = FStar_Syntax_Subst.compress t2  in
                       uu____13486.FStar_Syntax_Syntax.n  in
                     match uu____13485 with
                     | FStar_Syntax_Syntax.Tm_arrow (ibs,uu____13496) -> ibs
                     | uu____13513 -> []  in
                   ...
                   let ind =
                     ...
                     let uu____13521 =
                       FStar_List.map
                        ...
                        in
                     FStar_Syntax_Syntax.mk_Tm_uinst uu____13520 uu____13521
                      in
                   let ind1 =
                     let uu____13527 =
                       let uu____13528 =
                         FStar_List.map
                           (fun uu____13541  ->
                              ...
                              | (bv,aq) ->
                                  ...
                                  (uu____13552, aq)) bs2
                          in
                       FStar_Syntax_Syntax.mk_Tm_app ind uu____13528  in
                         ...
                         FStar_List.map
                           (fun uu____13572  ->
                              ...
                              | (bv,aq) ->
                                  ...
                                  (uu____13583, aq)) ibs1
                          in
                       FStar_Syntax_Syntax.mk_Tm_app ind1 uu____13559  in
                   ...
                   let haseq_ind =
                     let uu____13589 =
                       let uu____13590 =
                         let uu____13591 = FStar_Syntax_Syntax.as_arg ind2
                            in
                         [uu____13591]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.t_haseq uu____13590
                        in
                   ...
                   let bs' =
                     FStar_List.filter
                       (fun b  ->
                          let uu____13612 =
                            let uu____13613 = FStar_Syntax_Util.type_u ()  in
                            FStar_Pervasives_Native.fst uu____13613  in
                          ...
                          fun b  ->
                            let uu____13624 =
                                  ...
                                  let uu____13627 =
                                    let uu____13628 =
                                      FStar_Syntax_Syntax.bv_to_name
                                       ...
                                       in
                                    FStar_Syntax_Syntax.as_arg uu____13628
                                     in
                                  [uu____13627]  in
                                FStar_Syntax_Syntax.mk_Tm_app
                              ...
                              uu____13625 FStar_Pervasives_Native.None
                                FStar_Range.dummyRange
                               in
                            FStar_Syntax_Util.mk_conj t3 uu____13624)
                       FStar_Syntax_Util.t_true bs'
                      in
                   let fml = FStar_Syntax_Util.mk_imp haseq_bs haseq_ind  in
                   let fml1 =
                     let uu___127_13635 = fml  in
                     let uu____13636 =
                       let uu____13637 =
                         let uu____13644 =
                           let uu____13645 =
                             let uu____13656 =
                               ...
                               [uu____13659]  in
                             [uu____13656]  in
                           FStar_Syntax_Syntax.Meta_pattern uu____13645  in
                         (fml, uu____13644)  in
                       FStar_Syntax_Syntax.Tm_meta uu____13637  in
                     {
                       FStar_Syntax_Syntax.n = uu____13636;
                       FStar_Syntax_Syntax.pos =
                         (uu___127_13635.FStar_Syntax_Syntax.pos);
                       FStar_Syntax_Syntax.vars =
                         (uu___127_13635.FStar_Syntax_Syntax.vars)
                     }  in
                   let fml2 =
                     FStar_List.fold_right
                       (fun b  ->
                                ...
                                let uu____13674 =
                                  let uu____13675 =
                                    ...
                                    FStar_Syntax_Util.abs
                                      ...
                                      FStar_Pervasives_Native.None
                                     in
                                  FStar_Syntax_Syntax.as_arg uu____13675  in
                                [uu____13674]  in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____13673
                               in
                                ...
                                let uu____13703 =
                                  let uu____13704 =
                                    ...
                                    FStar_Syntax_Util.abs
                                      ...
                                      FStar_Pervasives_Native.None
                                     in
                                  FStar_Syntax_Syntax.as_arg uu____13704  in
                                [uu____13703]  in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____13702
                               in
                            uu____13701 FStar_Pervasives_Native.None
