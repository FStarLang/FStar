...
let _56_1300 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen"))) then begin
...
let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _151_798 = (FStar_Util.for_all (fun _56_1309 -> (match (_56_1309) with
| (_56_1307, c) -> begin
...
let _56_1312 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
let _56_1331 = (let _151_807 = (FStar_All.pipe_right ecs (FStar_List.map (fun _56_1322 -> (match (_56_1322) with
| (e, c) -> begin
(
...
let ecs = (FStar_All.pipe_right uvars (FStar_List.map (fun _56_1340 -> (match (_56_1340) with
| (uvs, e, c) -> begin
(

let tvars = (FStar_All.pipe_right uvs (FStar_List.map (fun _56_1343 -> (match (_56_1343) with
| (u, k) -> begin
...
| FStar_Syntax_Syntax.Fixed (_56_1377) -> begin
...
let _56_1384 = (FStar_Syntax_Util.arrow_formals k)
...
let _56_1387 = (FStar_Syntax_Util.set_uvar u t)
...
let _56_1419 = (match (((tvars), (gen_univs))) with
| ([], []) -> begin
((e), (c))
end
| ([], _56_1395) -> begin
...
let _56_1412 = (FStar_Syntax_Subst.open_comp bs cod)
in (match (_56_1412) with
| (bs, cod) -> begin
...
let _56_1429 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _151_827 = (let _151_826 = (FStar_List.map (fun _56_1428 -> (match (_56_1428) with
| (lb, _56_1425, _56_1427) -> begin
...
let univnames_lecs = (FStar_List.map (fun _56_1434 -> (match (_56_1434) with
| (l, t, c) -> begin
(gather_free_univnames env t)
end)) lecs)
in (

let generalized_lecs = (match ((let _151_830 = (FStar_All.pipe_right lecs (FStar_List.map (fun _56_1440 -> (match (_56_1440) with
| (_56_1437, e, c) -> begin
((e), (c))
end))))
in (gen env _151_830))) with
| None -> begin
(FStar_All.pipe_right lecs (FStar_List.map (fun _56_1445 -> (match (_56_1445) with
| (l, t, c) -> begin
((l), ([]), (t), (c))
end))))
end
| Some (ecs) -> begin
(FStar_List.map2 (fun _56_1453 _56_1457 -> (match (((_56_1453), (_56_1457))) with
| ((l, _56_1450, _56_1452), (us, e, c)) -> begin
(

let _56_1458 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
in (FStar_List.map2 (fun univnames _56_1466 -> (match (_56_1466) with
...
| FStar_Syntax_Syntax.Tm_name (_56_1482) -> begin
true
end
| _56_1485 -> begin
false
...
let _56_1492 = x
in {FStar_Syntax_Syntax.ppname = _56_1492.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1492.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) (Some (t2.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
end
| _56_1495 -> begin
(
...
in {FStar_Syntax_Syntax.n = _56_1496.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _151_864; FStar_Syntax_Syntax.pos = _56_1496.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1496.FStar_Syntax_Syntax.vars}))
end)))
in (
...
in {FStar_TypeChecker_Env.solver = _56_1498.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _56_1498.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _56_1498.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _56_1498.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _56_1498.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _56_1498.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _56_1498.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _56_1498.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _56_1498.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _56_1498.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _56_1498.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _56_1498.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _56_1498.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _56_1498.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _56_1498.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _151_865; FStar_TypeChecker_Env.is_iface = _56_1498.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _56_1498.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _56_1498.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _56_1498.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _56_1498.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _56_1498.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _56_1498.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _56_1498.FStar_TypeChecker_Env.qname_and_index}))
...
let _56_1504 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let _56_1511 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
...
let _56_1521 = (destruct_comp c)
in (match (_56_1521) with
| (u_t, t, wp) -> begin
(
...
let _56_1523 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
...
| ((guard, _56_1553))::[] -> begin
FStar_TypeChecker_Common.NonTrivial (guard)
end
| (_then)::((guard, _56_1558))::[] -> begin
...
in (match ((FStar_Util.find_map table (fun _56_1571 -> (match (_56_1571) with
| (x, mk) -> begin
...
in (match (bs) with
| ((_56_1598, Some (FStar_Syntax_Syntax.Implicit (_56_1600))))::_56_1596 -> begin
bs
end
| _56_1606 -> begin
...
| FStar_Syntax_Syntax.Tm_arrow (bs', _56_1612) -> begin
(match ((FStar_Util.prefix_until (fun _56_8 -> (match (_56_8) with
| (_56_1617, Some (FStar_Syntax_Syntax.Implicit (_56_1619))) -> begin
false
end
| _56_1624 -> begin
true
...
| Some ([], _56_1628, _56_1630) -> begin
bs
end
| Some (imps, _56_1635, _56_1637) -> begin
if (FStar_All.pipe_right imps (FStar_Util.for_all (fun _56_1643 -> (match (_56_1643) with
| (x, _56_1642) -> begin
...
let imps = (FStar_All.pipe_right imps (FStar_List.map (fun _56_1647 -> (match (_56_1647) with
| (x, i) -> begin
...
let _56_1675 = (let _151_1005 = (FStar_List.hd c.FStar_Syntax_Syntax.effect_args)
in ((c.FStar_Syntax_Syntax.result_typ), (_151_1005)))
in (match (_56_1675) with
| (res_typ, wp) -> begin
(
...
let _56_1694 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
(

let _56_1692 = (d (FStar_Ident.text_of_lid lident))
...
let err' = (fun _56_1793 -> (match (()) with
| () -> begin
(err' "")
end))
in (

let _56_1794 = if ((FStar_List.length quals) <> (FStar_List.length no_dup_quals)) then begin
...
let _56_1796 = if (not ((FStar_All.pipe_right quals (FStar_List.for_all (quals_combo_ok quals))))) then begin
(err "ill-formed combination")
end else begin
()
end
in (match (se) with
| FStar_Syntax_Syntax.Sig_let ((is_rec, _56_1800), _56_1803, _56_1805, _56_1807) -> begin
(

let _56_1810 = if (is_rec && (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen))) then begin
...
| FStar_Syntax_Syntax.Sig_bundle (_56_1814) -> begin
...
| FStar_Syntax_Syntax.Sig_declare_typ (_56_1818) -> begin
...
| FStar_Syntax_Syntax.Sig_assume (_56_1821) -> begin
...
| FStar_Syntax_Syntax.Sig_new_effect (_56_1825) -> begin
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_56_1829) -> begin
if (not ((FStar_All.pipe_right quals (FStar_Util.for_all (fun x -> ((((x = FStar_Syntax_Syntax.TotalEffect) || (inferred x)) || (visibility x)) || (reification x))))))) then begin
(err' ())
end else begin
()
...
| FStar_Syntax_Syntax.Sig_effect_abbrev (_56_1833) -> begin
