...
| FStar_Syntax_Syntax.Tm_type (_71_12) -> begin
true
end
| _71_15 -> begin
false
...
in (FStar_All.pipe_right _150_13 (FStar_List.filter (fun _71_20 -> (match (_71_20) with
| (x, _71_19) -> begin
...
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uvar (uv, _71_35); FStar_Syntax_Syntax.tk = _71_32; FStar_Syntax_Syntax.pos = _71_30; FStar_Syntax_Syntax.vars = _71_28} -> begin
uv
end
| _71_40 -> begin
...
let _71_45 = (new_uvar_aux env k)
in (match (_71_45) with
| (t, u) -> begin
(
# 106 "FStar.TypeChecker.Util.fst"
let g = (
# 106 "FStar.TypeChecker.Util.fst"
let _71_46 = FStar_TypeChecker_Rel.trivial_guard
in (let _150_32 = (let _150_31 = (let _150_30 = (as_uvar u)
in (env, _150_30, t, k, u.FStar_Syntax_Syntax.pos))
in (_150_31)::[])
in {FStar_TypeChecker_Env.guard_f = _71_46.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _71_46.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _71_46.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _150_32}))
...
in (FStar_List.map (fun _71_55 -> (match (_71_55) with
| (x, _71_54) -> begin
...
let _71_59 = (FStar_ST.op_Colon_Equals FStar_Options.hide_uvar_nums false)
in (
# 118 "FStar.TypeChecker.Util.fst"
let _71_61 = (FStar_ST.op_Colon_Equals FStar_Options.print_implicits true)
in (
# 119 "FStar.TypeChecker.Util.fst"
let _71_63 = (let _150_43 = (let _150_42 = (FStar_Syntax_Print.term_to_string t)
...
let _71_65 = (FStar_ST.op_Colon_Equals FStar_Options.hide_uvar_nums hide_uvar_nums_saved)
...
let extract_let_rec_annotation : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.letbinding  ->  (FStar_Syntax_Syntax.univ_names * FStar_Syntax_Syntax.typ * Prims.bool) = (fun env _71_80 -> (match (_71_80) with
| {FStar_Syntax_Syntax.lbname = _71_79; FStar_Syntax_Syntax.lbunivs = univ_vars; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = _71_75; FStar_Syntax_Syntax.lbdef = e} -> begin
(match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
(
# 138 "FStar.TypeChecker.Util.fst"
let _71_82 = if (univ_vars <> []) then begin
...
let _71_92 = (FStar_Syntax_Util.type_u ())
...
let _71_94 = a
in {FStar_Syntax_Syntax.ppname = _71_94.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_94.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}), false))
end))
end
| _71_97 -> begin
(a, true)
...
| FStar_Syntax_Syntax.Tm_meta (e, _71_103) -> begin
(aux vars e)
end
| FStar_Syntax_Syntax.Tm_ascribed (e, t, _71_109) -> begin
(t, true)
end
| FStar_Syntax_Syntax.Tm_abs (bs, body, _71_115) -> begin
(
# 153 "FStar.TypeChecker.Util.fst"
let _71_134 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _71_121 _71_124 -> (match ((_71_121, _71_124)) with
| ((scope, bs, check), (a, imp)) -> begin
(
# 154 "FStar.TypeChecker.Util.fst"
let _71_127 = (mk_binder scope a)
in (match (_71_127) with
| (tb, c) -> begin
(
...
in (match (_71_134) with
| (scope, bs, check) -> begin
(
# 161 "FStar.TypeChecker.Util.fst"
let _71_137 = (aux scope body)
in (match (_71_137) with
| (res, check_res) -> begin
(
...
let _71_140 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _71_146 = (let _150_70 = (t_binders env)
in (aux _150_70 e))
in (match (_71_146) with
| (t, b) -> begin
([], t, b)
end))))))
end
...
let _71_151 = (FStar_Syntax_Subst.open_univ_vars univ_vars t)
in (match (_71_151) with
| (univ_vars, t) -> begin
(univ_vars, t, false)
end))
end)
...
| FStar_Syntax_Syntax.Pat_dot_term (x, _71_164) -> begin
(
# 202 "FStar.TypeChecker.Util.fst"
let _71_170 = (FStar_Syntax_Util.type_u ())
in (match (_71_170) with
| (k, _71_169) -> begin
(
...
# 204 "FStar.TypeChecker.Util.fst"
let _71_172 = x
in {FStar_Syntax_Syntax.ppname = _71_172.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_172.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
# 205 "FStar.TypeChecker.Util.fst"
let _71_177 = (let _150_83 = (FStar_TypeChecker_Env.all_binders env)
in (FStar_TypeChecker_Rel.new_uvar p.FStar_Syntax_Syntax.p _150_83 t))
in (match (_71_177) with
| (e, u) -> begin
(
...
# 206 "FStar.TypeChecker.Util.fst"
let _71_178 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term ((x, e)); FStar_Syntax_Syntax.ty = _71_178.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _71_178.FStar_Syntax_Syntax.p})
in ([], [], [], env, e, p))
end))))
end))
end
...
let _71_186 = (FStar_Syntax_Util.type_u ())
in (match (_71_186) with
| (t, _71_185) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _71_187.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_187.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _150_84}))
in (
...
let _71_197 = (FStar_Syntax_Util.type_u ())
in (match (_71_197) with
| (t, _71_196) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _71_198.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_198.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _150_85}))
in (
...
let _71_231 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _71_213 _71_216 -> (match ((_71_213, _71_216)) with
| ((b, a, w, env, args, pats), (p, imp)) -> begin
(
# 225 "FStar.TypeChecker.Util.fst"
let _71_223 = (pat_as_arg_with_env allow_wc_dependence env p)
in (match (_71_223) with
...
let _71_233 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons ((fv, (FStar_List.rev pats))); FStar_Syntax_Syntax.ty = _71_233.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _71_233.FStar_Syntax_Syntax.p}))))))
end))
end
| FStar_Syntax_Syntax.Pat_disj (_71_236) -> begin
(FStar_All.failwith "impossible")
end))
in (
...
let pats = (FStar_List.map (fun _71_251 -> (match (_71_251) with
| (p, imp) -> begin
...
let _71_256 = (FStar_TypeChecker_Env.lookup_datacon env (Prims.fst fv).FStar_Syntax_Syntax.v)
in (match (_71_256) with
| (_71_254, t) -> begin
(
# 248 "FStar.TypeChecker.Util.fst"
let _71_260 = (FStar_Syntax_Util.arrow_formals t)
in (match (_71_260) with
| (f, _71_259) -> begin
(
...
| (_71_277::_71_275, []) -> begin
(FStar_All.pipe_right formals (FStar_List.map (fun _71_283 -> (match (_71_283) with
| (t, imp) -> begin
(match (imp) with
...
(match (f) with
| (_71_301, Some (FStar_Syntax_Syntax.Implicit (_71_303))) when p_imp -> begin
(let _150_120 = (aux formals' pats')
in ((p, true))::_150_120)
end
| (_71_308, Some (FStar_Syntax_Syntax.Implicit (inaccessible))) -> begin
(
...
in {FStar_Syntax_Syntax.v = _150_127; FStar_Syntax_Syntax.ty = _71_319.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _71_319.FStar_Syntax_Syntax.p})))
end))
end)))
end
| _71_322 -> begin
...
let _71_334 = (pat_as_arg_with_env allow_wc_dependence env p)
in (match (_71_334) with
...
let _71_354 = (one_pat false env q)
in (match (_71_354) with
| (b, a, _71_351, te, q) -> begin
(
# 294 "FStar.TypeChecker.Util.fst"
let _71_369 = (FStar_List.fold_right (fun p _71_359 -> (match (_71_359) with
| (w, args, pats) -> begin
(
# 295 "FStar.TypeChecker.Util.fst"
let _71_365 = (one_pat false env p)
in (match (_71_365) with
| (b', a', w', arg, p) -> begin
...
let _71_370 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((q)::pats); FStar_Syntax_Syntax.ty = _71_370.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _71_370.FStar_Syntax_Syntax.p})))
end))
end))
end
| _71_373 -> begin
...
let _71_381 = (one_pat true env p)
in (match (_71_381) with
| (b, _71_376, _71_378, arg, p) -> begin
...
let _71_385 = (top_level_pat_as_args env p)
in (match (_71_385) with
| (b, args, p) -> begin
(
...
| (_71_399, FStar_Syntax_Syntax.Tm_uinst (e, _71_402)) -> begin
(aux p e)
end
| (FStar_Syntax_Syntax.Pat_constant (_71_407), FStar_Syntax_Syntax.Tm_constant (_71_410)) -> begin
...
let _71_418 = if (not ((FStar_Syntax_Syntax.bv_eq x y))) then begin
...
let _71_420 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Pat"))) then begin
...
# 327 "FStar.TypeChecker.Util.fst"
let _71_423 = x
in {FStar_Syntax_Syntax.ppname = _71_423.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_423.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
in (pkg (FStar_Syntax_Syntax.Pat_var (x)) s.FStar_Syntax_Syntax.n)))))
end
| (FStar_Syntax_Syntax.Pat_wild (x), FStar_Syntax_Syntax.Tm_name (y)) -> begin
(
# 331 "FStar.TypeChecker.Util.fst"
let _71_431 = if (FStar_All.pipe_right (FStar_Syntax_Syntax.bv_eq x y) Prims.op_Negation) then begin
...
# 334 "FStar.TypeChecker.Util.fst"
let _71_434 = x
in {FStar_Syntax_Syntax.ppname = _71_434.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_434.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
in (pkg (FStar_Syntax_Syntax.Pat_wild (x)) s.FStar_Syntax_Syntax.n))))
end
| (FStar_Syntax_Syntax.Pat_dot_term (x, _71_439), _71_443) -> begin
(
...
# 339 "FStar.TypeChecker.Util.fst"
let _71_446 = x
in {FStar_Syntax_Syntax.ppname = _71_446.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_446.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = s})
in (pkg (FStar_Syntax_Syntax.Pat_dot_term ((x, e))) s.FStar_Syntax_Syntax.n)))
end
| (FStar_Syntax_Syntax.Pat_cons (fv, []), FStar_Syntax_Syntax.Tm_fvar (fv')) -> begin
(
# 343 "FStar.TypeChecker.Util.fst"
let _71_456 = if (not ((FStar_Syntax_Syntax.fv_eq fv fv'))) then begin
...
let _71_499 = if (let _150_178 = (FStar_Syntax_Syntax.fv_eq fv fv')
...
| (arg::args, (argpat, _71_515)::argpats) -> begin
(match ((arg, argpat.FStar_Syntax_Syntax.v)) with
| ((e, Some (FStar_Syntax_Syntax.Implicit (true))), FStar_Syntax_Syntax.Pat_dot_term (_71_525)) -> begin
(
...
| (FStar_Syntax_Syntax.Pat_disj (ps), _71_544) when ((FStar_List.length ps) = (FStar_List.length exps)) -> begin
(
...
let pat_as_arg = (fun _71_561 -> (match (_71_561) with
| (p, i) -> begin
(
# 390 "FStar.TypeChecker.Util.fst"
let _71_564 = (decorated_pattern_as_term p)
in (match (_71_564) with
| (vars, te) -> begin
...
| FStar_Syntax_Syntax.Pat_disj (_71_566) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Pat_constant (c) -> begin
...
let _71_579 = (let _150_208 = (FStar_All.pipe_right pats (FStar_List.map pat_as_arg))
in (FStar_All.pipe_right _150_208 FStar_List.unzip))
in (match (_71_579) with
| (vars, args) -> begin
(
...
let _71_603 = (match (c.FStar_Syntax_Syntax.effect_args) with
| (wp, _71_592)::(wlp, _71_588)::[] -> begin
(wp, wlp)
end
| _71_596 -> begin
(let _150_218 = (let _150_217 = (let _150_216 = (FStar_List.map (fun _71_600 -> (match (_71_600) with
| (x, _71_599) -> begin
...
let _71_611 = (destruct_comp c)
in (match (_71_611) with
| (_71_608, wp, wlp) -> begin
...
let _71_633 = (FStar_Util.smap_add cache l.FStar_Ident.str m)
in m)
end)
end)
in res))))
...
let _71_644 = (let _150_254 = (norm_eff_name env l1)
in (let _150_253 = (norm_eff_name env l2)
in (FStar_TypeChecker_Env.join env _150_254 _150_253)))
in (match (_71_644) with
| (m, _71_641, _71_643) -> begin
m
end)))
...
let _71_656 = (FStar_TypeChecker_Env.join env c1.FStar_Syntax_Syntax.effect_name c2.FStar_Syntax_Syntax.effect_name)
in (match (_71_656) with
| (m, lift1, lift2) -> begin
(
...
let _71_662 = (FStar_TypeChecker_Env.wp_signature env md.FStar_Syntax_Syntax.mname)
...
in {FStar_Syntax_Syntax.eff_name = _71_676.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _150_298; FStar_Syntax_Syntax.cflags = _71_676.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _71_678 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_arrow (_71_681) -> begin
true
end
| _71_684 -> begin
false
...
let _71_691 = (FStar_TypeChecker_Env.wp_signature env FStar_Syntax_Const.effect_PURE_lid)
in (match (_71_691) with
| (a, kwp) -> begin
(
...
let _71_696 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Return"))) then begin
...
let bind : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term Prims.option  ->  FStar_Syntax_Syntax.lcomp  ->  lcomp_with_binder  ->  FStar_Syntax_Syntax.lcomp = (fun env e1opt lc1 _71_703 -> (match (_71_703) with
| (b, lc2) -> begin
(
# 511 "FStar.TypeChecker.Util.fst"
let _71_711 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
(
...
let bind_it = (fun _71_714 -> (match (()) with
| () -> begin
(
...
let try_simplify = (fun _71_723 -> (match (()) with
| () -> begin
(
# 532 "FStar.TypeChecker.Util.fst"
let aux = (fun _71_725 -> (match (()) with
| () -> begin
...
let _71_754 = (lift_and_destruct env c1 c2)
in (match (_71_754) with
...
let _71_776 = (FStar_TypeChecker_Env.wp_signature env md_pure.FStar_Syntax_Syntax.mname)
in (match (_71_776) with
| (a, kwp) -> begin
(
...
in {FStar_TypeChecker_Env.guard_f = _150_428; FStar_TypeChecker_Env.deferred = _71_796.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _71_796.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _71_796.FStar_TypeChecker_Env.implicits}))
end))
...
let weaken = (fun _71_812 -> (match (()) with
| () -> begin
(
...
let _71_826 = lc
in {FStar_Syntax_Syntax.eff_name = _71_826.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _71_826.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _71_826.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = weaken})))
...
let _71_833 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun _71_2 -> (match (_71_2) with
...
let strengthen = (fun _71_842 -> (match (()) with
| () -> begin
(
...
let _71_852 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
let _71_858 = (destruct_comp c)
in (match (_71_858) with
| (res_t, wp, wlp) -> begin
(
...
let _71_863 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
in {FStar_Syntax_Syntax.eff_name = _150_503; FStar_Syntax_Syntax.res_typ = _71_866.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _150_502; FStar_Syntax_Syntax.comp = strengthen})))
in (_150_504, (
# 669 "FStar.TypeChecker.Util.fst"
let _71_868 = g0
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _71_868.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _71_868.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _71_868.FStar_TypeChecker_Env.implicits}))))))
end)
...
let comp = (fun _71_874 -> (match (()) with
| () -> begin
(
...
let _71_882 = (strengthen_precondition (Some ((fun _71_878 -> (match (()) with
| () -> begin
"push"
end)))) env e (FStar_Syntax_Util.lcomp_of_comp c) g)
in (match (_71_882) with
| (c, _71_881) -> begin
(
...
let lc = (let _150_529 = (let _150_528 = (let _150_527 = (strengthen_precondition (Some ((fun _71_889 -> (match (()) with
| () -> begin
"pop"
...
let _71_891 = lc
in {FStar_Syntax_Syntax.eff_name = _71_891.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _71_891.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _71_891.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = comp})))
...
let _71_901 = (let _150_537 = (FStar_Syntax_Syntax.bv_to_name x)
in (let _150_536 = (FStar_Syntax_Syntax.bv_to_name y)
in (_150_537, _150_536)))
in (match (_71_901) with
| (xexp, yexp) -> begin
(
...
let comp = (fun _71_913 -> (match (()) with
| () -> begin
(
# 706 "FStar.TypeChecker.Util.fst"
let _71_929 = (let _150_573 = (lcomp_then.FStar_Syntax_Syntax.comp ())
in (let _150_572 = (lcomp_else.FStar_Syntax_Syntax.comp ())
in (lift_and_destruct env _150_573 _150_572)))
in (match (_71_929) with
| ((md, _71_916, _71_918), (res_t, wp_then, wlp_then), (_71_925, wp_else, wlp_else)) -> begin
(
...
let eff = (FStar_List.fold_left (fun eff _71_949 -> (match (_71_949) with
| (_71_947, lc) -> begin
(join_effects env eff lc.FStar_Syntax_Syntax.eff_name)
end)) FStar_Syntax_Const.effect_PURE_lid lcases)
in (
# 724 "FStar.TypeChecker.Util.fst"
let bind_cases = (fun _71_952 -> (match (()) with
| () -> begin
(
...
let comp = (FStar_List.fold_right (fun _71_969 celse -> (match (_71_969) with
| (g, cthen) -> begin
(
# 737 "FStar.TypeChecker.Util.fst"
let _71_987 = (let _150_658 = (cthen.FStar_Syntax_Syntax.comp ())
in (lift_and_destruct env _150_658 celse))
in (match (_71_987) with
| ((md, _71_973, _71_975), (_71_978, wp_then, wlp_then), (_71_983, wp_else, wlp_else)) -> begin
...
let _71_995 = (destruct_comp comp)
in (match (_71_995) with
| (_71_992, wp, wlp) -> begin
(
...
let close = (fun _71_1002 -> (match (()) with
| () -> begin
(
...
let _71_1024 = lc
in {FStar_Syntax_Syntax.eff_name = _71_1024.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _71_1024.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _71_1024.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = close})))

# 773 "FStar.TypeChecker.Util.fst"
let maybe_assume_result_eq_pure_term : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.lcomp  ->  FStar_Syntax_Syntax.lcomp = (fun env e lc -> (
# 774 "FStar.TypeChecker.Util.fst"
let refine = (fun _71_1030 -> (match (()) with
| () -> begin
(
...
let _71_1042 = lc
in {FStar_Syntax_Syntax.eff_name = _71_1042.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _71_1042.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = refine}))))
...
| FStar_Syntax_Syntax.Tm_type (_71_1056) -> begin
(match ((let _150_739 = (FStar_Syntax_Subst.compress lc.FStar_Syntax_Syntax.res_typ)
in _150_739.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv, _71_1060) when (FStar_Ident.lid_equals fv.FStar_Syntax_Syntax.v FStar_Syntax_Const.bool_lid) -> begin
(
# 814 "FStar.TypeChecker.Util.fst"
let _71_1063 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.b2t_lid)
in (
...
# 833 "FStar.TypeChecker.Util.fst"
let _71_1086 = lc
in {FStar_Syntax_Syntax.eff_name = _71_1086.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = _71_1086.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = _71_1086.FStar_Syntax_Syntax.comp})
in (e, lc, g))
end
| FStar_TypeChecker_Common.NonTrivial (f) -> begin
(
...
# 837 "FStar.TypeChecker.Util.fst"
let _71_1091 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _71_1091.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _71_1091.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _71_1091.FStar_TypeChecker_Env.implicits})
in (
# 838 "FStar.TypeChecker.Util.fst"
let strengthen = (fun _71_1095 -> (match (()) with
| () -> begin
(
...
| FStar_Syntax_Syntax.Tm_abs (_71_1098, {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv, _71_1107); FStar_Syntax_Syntax.tk = _71_1104; FStar_Syntax_Syntax.pos = _71_1102; FStar_Syntax_Syntax.vars = _71_1100}, _71_1112) when (FStar_Ident.lid_equals fv.FStar_Syntax_Syntax.v FStar_Syntax_Const.true_lid) -> begin
(
# 844 "FStar.TypeChecker.Util.fst"
let lc = (
# 844 "FStar.TypeChecker.Util.fst"
let _71_1115 = lc
in {FStar_Syntax_Syntax.eff_name = _71_1115.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = _71_1115.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = _71_1115.FStar_Syntax_Syntax.comp})
in (lc.FStar_Syntax_Syntax.comp ()))
end
| _71_1119 -> begin
(
...
let _71_1121 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
let _71_1126 = (FStar_TypeChecker_Env.wp_signature env FStar_Syntax_Const.effect_PURE_lid)
in (match (_71_1126) with
| (a, kwp) -> begin
(
...
let _71_1137 = (let _150_778 = (FStar_All.pipe_left (fun _150_775 -> Some (_150_775)) (FStar_TypeChecker_Errors.subtyping_failed env lc.FStar_Syntax_Syntax.res_typ t))
...
# 870 "FStar.TypeChecker.Util.fst"
let _71_1138 = x
in {FStar_Syntax_Syntax.ppname = _71_1138.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_1138.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lc.FStar_Syntax_Syntax.res_typ})
in (
...
let _71_1143 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
let flags = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun _71_3 -> (match (_71_3) with
| (FStar_Syntax_Syntax.RETURN) | (FStar_Syntax_Syntax.PARTIAL_RETURN) -> begin
(FStar_Syntax_Syntax.PARTIAL_RETURN)::[]
end
| _71_1149 -> begin
...
# 878 "FStar.TypeChecker.Util.fst"
let _71_1154 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = _71_1154.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _71_1154.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _71_1154.FStar_TypeChecker_Env.implicits})
in (e, lc, g))))))
end)
end)))
...
| (req, _71_1182)::(ens, _71_1177)::_71_1174 -> begin
...
| (wp, _71_1197)::(wlp, _71_1192)::_71_1189 -> begin
(
# 902 "FStar.TypeChecker.Util.fst"
let _71_1203 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.as_requires)
in (match (_71_1203) with
| (us_r, _71_1202) -> begin
(
# 903 "FStar.TypeChecker.Util.fst"
let _71_1207 = (FStar_TypeChecker_Env.lookup_lid env FStar_Syntax_Const.as_ensures)
in (match (_71_1207) with
| (us_e, _71_1206) -> begin
(
...
let _71_1225 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_71_1225) with
| (bs, c) -> begin
(
# 925 "FStar.TypeChecker.Util.fst"
let rec aux = (fun subst _71_4 -> (match (_71_4) with
...
let _71_1240 = (new_implicit_var env t)
in (match (_71_1240) with
| (v, u, g) -> begin
(
...
let _71_1246 = (aux subst rest)
in (match (_71_1246) with
...
let _71_1252 = (aux [] bs)
in (match (_71_1252) with
| (args, bs, subst, guard) -> begin
(match ((args, bs)) with
| ([], _71_1255) -> begin
(e, torig, guard)
end
| (_71_1258, []) when (not ((FStar_Syntax_Util.is_total_comp c))) -> begin
(e, torig, FStar_TypeChecker_Rel.trivial_guard)
end
| _71_1262 -> begin
(
...
let _71_1277 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen"))) then begin
...
let _71_1279 = (FStar_Unionfind.change u (Some (FStar_Syntax_Syntax.U_name (u_name))))
in u_name))))))
in u_names)))
end)
...
let _71_1290 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Gen"))) then begin
...
let gen : FStar_TypeChecker_Env.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list  ->  (FStar_Syntax_Syntax.univ_name Prims.list * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.comp) Prims.list Prims.option = (fun env ecs -> if (let _150_858 = (FStar_Util.for_all (fun _71_1298 -> (match (_71_1298) with
| (_71_1296, c) -> begin
...
let _71_1304 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
let _71_1321 = (let _150_867 = (FStar_All.pipe_right ecs (FStar_List.map (fun _71_1311 -> (match (_71_1311) with
| (e, c) -> begin
(
...
let _71_1325 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
let ecs = (FStar_All.pipe_right uvars (FStar_List.map (fun _71_1330 -> (match (_71_1330) with
| (uvs, e, c) -> begin
(
# 1014 "FStar.TypeChecker.Util.fst"
let tvars = (FStar_All.pipe_right uvs (FStar_List.map (fun _71_1333 -> (match (_71_1333) with
| (u, k) -> begin
...
| FStar_Syntax_Syntax.Fixed (_71_1367) -> begin
...
let _71_1374 = (FStar_Syntax_Util.arrow_formals k)
in (match (_71_1374) with
| (bs, kres) -> begin
(
...
let _71_1377 = (FStar_Syntax_Util.set_uvar u t)
...
let _71_1391 = (FStar_Syntax_Subst.open_comp bs cod)
in (match (_71_1391) with
| (bs, cod) -> begin
...
let _71_1408 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _150_886 = (let _150_885 = (FStar_List.map (fun _71_1407 -> (match (_71_1407) with
| (lb, _71_1404, _71_1406) -> begin
...
in (match ((let _150_888 = (FStar_All.pipe_right lecs (FStar_List.map (fun _71_1414 -> (match (_71_1414) with
| (_71_1411, e, c) -> begin
(e, c)
end))))
in (gen env _150_888))) with
| None -> begin
(FStar_All.pipe_right lecs (FStar_List.map (fun _71_1419 -> (match (_71_1419) with
| (l, t, c) -> begin
(l, [], t, c)
end))))
end
| Some (ecs) -> begin
(FStar_List.map2 (fun _71_1427 _71_1431 -> (match ((_71_1427, _71_1431)) with
| ((l, _71_1424, _71_1426), (us, e, c)) -> begin
(
# 1057 "FStar.TypeChecker.Util.fst"
let _71_1432 = if (FStar_TypeChecker_Env.debug env FStar_Options.Medium) then begin
...
| FStar_Syntax_Syntax.Tm_name (_71_1449) -> begin
true
end
| _71_1452 -> begin
false
...
let _71_1459 = x
in {FStar_Syntax_Syntax.ppname = _71_1459.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _71_1459.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) (Some (t2.FStar_Syntax_Syntax.n)) e.FStar_Syntax_Syntax.pos)
end
| _71_1462 -> begin
(
...
in {FStar_Syntax_Syntax.n = _71_1463.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _150_918; FStar_Syntax_Syntax.pos = _71_1463.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _71_1463.FStar_Syntax_Syntax.vars}))
end)))
in (
...
in {FStar_TypeChecker_Env.solver = _71_1465.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _71_1465.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _71_1465.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _71_1465.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _71_1465.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _71_1465.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _71_1465.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _71_1465.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _71_1465.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _71_1465.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _71_1465.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _71_1465.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _71_1465.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _71_1465.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _71_1465.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _150_919; FStar_TypeChecker_Env.is_iface = _71_1465.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _71_1465.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.default_effects = _71_1465.FStar_TypeChecker_Env.default_effects; FStar_TypeChecker_Env.type_of = _71_1465.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _71_1465.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _71_1465.FStar_TypeChecker_Env.use_bv_sorts}))
...
let _71_1471 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let _71_1478 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
...
let _71_1489 = (destruct_comp c)
in (match (_71_1489) with
| (t, wp, _71_1488) -> begin
(
...
let _71_1491 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Simplification"))) then begin
...
let short_bin_op = (fun f _71_5 -> (match (_71_5) with
| [] -> begin
...
let short_op_ite = (fun _71_6 -> (match (_71_6) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
| (guard, _71_1521)::[] -> begin
FStar_TypeChecker_Common.NonTrivial (guard)
end
| _then::(guard, _71_1526)::[] -> begin
...
| FStar_Syntax_Syntax.Tm_fvar (fv, _71_1536) -> begin
(
# 1143 "FStar.TypeChecker.Util.fst"
let lid = fv.FStar_Syntax_Syntax.v
in (match ((FStar_Util.find_map table (fun _71_1542 -> (match (_71_1542) with
| (x, mk) -> begin
...
| FStar_Syntax_Syntax.Tm_fvar (v, _71_1551) -> begin
...
in (match (bs) with
| (_71_1572, Some (FStar_Syntax_Syntax.Implicit (_71_1574)))::_71_1570 -> begin
bs
end
| _71_1580 -> begin
...
| FStar_Syntax_Syntax.Tm_arrow (bs', _71_1586) -> begin
(match ((FStar_Util.prefix_until (fun _71_7 -> (match (_71_7) with
| (_71_1591, Some (FStar_Syntax_Syntax.Implicit (_71_1593))) -> begin
false
end
| _71_1598 -> begin
true
...
| Some ([], _71_1602, _71_1604) -> begin
bs
end
| Some (imps, _71_1609, _71_1611) -> begin
if (FStar_All.pipe_right imps (FStar_Util.for_all (fun _71_1617 -> (match (_71_1617) with
| (x, _71_1616) -> begin
...
let imps = (FStar_All.pipe_right imps (FStar_List.map (fun _71_1621 -> (match (_71_1621) with
| (x, i) -> begin
