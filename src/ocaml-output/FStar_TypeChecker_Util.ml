               ...
               (match uu____7078 with
                | (bs1,c1) ->
                    let rec aux subst1 inst_n bs2 =
                      ...
                      | (FStar_Pervasives_Native.Some _0_40,uu____7187) when
                                                ...
                                                FStar_Ident.lid_equals
                                                 ...
                                                 (let uu____11814 =
                                                    let uu____11815 =
                                                      FStar_TypeChecker_Env.current_module
                                                        env in
                                                    uu____11815.FStar_Ident.str in
      ...
      fun tcs  ->
        fun se  ->
          ...
          | FStar_Syntax_Syntax.Sig_datacon
              (constr_lid,uvs,t,typ_lid,n_typars,uu____12143) when
              Prims.op_Negation
                (FStar_Ident.lid_equals constr_lid
                   FStar_Parser_Const.lexcons_lid)
              ->
              let uu____12148 = FStar_Syntax_Subst.univ_var_opening uvs in
              (match uu____12148 with
               | (univ_opening,uvs1) ->
                   let t1 = FStar_Syntax_Subst.subst univ_opening t in
                   let uu____12170 = FStar_Syntax_Util.arrow_formals t1 in
                              ...
                              (fun se1  ->
                                 let uu____12235 =
                                   let uu____12236 =
                                     ...
                                     FStar_Util.must uu____12237 in
                                   FStar_Ident.lid_equals typ_lid uu____12236 in
                                 if uu____12235
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____12256,uvs',tps,typ0,uu____12260,constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
                                           ((FStar_List.length constrs) >
                                              (Prims.parse_int "1")))
                                   | uu____12279 -> failwith "Impossible"
                                 else FStar_Pervasives_Native.None) in
                          match tps_opt with
                                  ...
                                  let refine_domain =
                                    let uu____12386 =
                                      FStar_All.pipe_right
                                        ...
                                        (FStar_Util.for_some
                                           (fun uu___119_12391  ->
                                              match uu___119_12391 with
                                              | FStar_Syntax_Syntax.RecordConstructor
                                                  uu____12392 -> true
                                              | uu____12401 -> false)) in
                                    if uu____12386
                                    then false
                                    else should_refine in
                                  let fv_qual =
                                    let filter_records uu___120_12409 =
                                      match uu___120_12409 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____12412,fns) ->
                                          FStar_Pervasives_Native.Some
