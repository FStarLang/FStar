...
let (report : FStar_TypeChecker_Env.env -> Prims.string Prims.list -> unit) =
  fun env ->
    fun errs ->
      ...
      let uu____22 = FStar_TypeChecker_Err.failed_to_prove_specification errs in
        ...
        let uu____85 =
          (FStar_Options.full_context_dependency ()) ||
            (let uu____87 = FStar_TypeChecker_Env.current_module env in
             FStar_Ident.lid_equals FStar_Parser_Const.prims_lid uu____87) in
        if uu____85
        ...
        fun k ->
          ...
          | uu____253 ->
              ...
              (match uu____264 with
               | (t, u) ->
                   let g =
                     let uu___99_284 = FStar_TypeChecker_Rel.trivial_guard in
                     let uu____285 =
                       let uu____300 =
                       ...
                       [uu____300] in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         (uu___99_284.FStar_TypeChecker_Env.guard_f);
                       FStar_TypeChecker_Env.deferred =
                         (uu___99_284.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___99_284.FStar_TypeChecker_Env.univ_ineqs);
      ...
      | { FStar_Syntax_Syntax.lbname = lbname;
          ...
          (match t1.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Tm_unknown ->
               let uu____492 = FStar_Syntax_Subst.open_univ_vars univ_vars1 e in
                               ...
                               let t2 =
                                 let uu____544 =
                                   FStar_TypeChecker_Rel.new_uvar
                                     e1.FStar_Syntax_Syntax.pos scope k in
                                 FStar_All.pipe_right uu____544
                                   FStar_Pervasives_Native.fst in
                               ((let uu___100_554 = a in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___100_554.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___100_554.FStar_Syntax_Syntax.index);
                    ...
                    let rec aux must_check_ty vars e2 =
                      ...
                      | FStar_Syntax_Syntax.Tm_abs (bs, body, uu____668) ->
                          ...
                          (match uu____689 with
                           | (scope, bs1, must_check_ty1) ->
                               let uu____940 = aux must_check_ty1 scope body in
      ...
      fun p ->
        fun tc_annot ->
          let check_bv env1 x =
            ...
            | (t_x, guard) ->
                ((let uu___101_1199 = x in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___101_1199.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___101_1199.FStar_Syntax_Syntax.index);
            ...
            | FStar_Syntax_Syntax.Pat_dot_term (x, uu____1282) ->
                ...
                (match uu____1287 with
                 | (k, uu____1313) ->
                     ...
                     let x1 =
                       let uu___102_1316 = x in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___102_1316.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___102_1316.FStar_Syntax_Syntax.index);
                     ...
                     let uu____1317 =
                       ...
                       FStar_TypeChecker_Rel.new_uvar
                         p1.FStar_Syntax_Syntax.p uu____1322 t in
                     (match uu____1317 with
                      | (e, u) ->
                          let p2 =
                            let uu___103_1348 = p1 in
                            {
                              FStar_Syntax_Syntax.v =
                                (FStar_Syntax_Syntax.Pat_dot_term (x1, e));
                              FStar_Syntax_Syntax.p =
                                (uu___103_1348.FStar_Syntax_Syntax.p)
                            } in
                          ([], [], [], env1, e,
                 ...
                 | (b, a, w, env2, args, guard, pats1) ->
                     let e =
                       let uu____1998 =
                         ...
                         FStar_Syntax_Syntax.mk_Tm_app uu____2003 uu____2004 in
                     ...
                     (uu____2011, uu____2022, uu____2033, env2, e, guard,
                       (let uu___104_2055 = p1 in
                        {
                          FStar_Syntax_Syntax.v =
                            (FStar_Syntax_Syntax.Pat_cons
                               (fv, (FStar_List.rev pats1)));
                          FStar_Syntax_Syntax.p =
                            (uu___104_2055.FStar_Syntax_Syntax.p)
                        }))) in
                     ...
                     (match uu____2182 with
                      | (f, uu____2198) ->
                            ...
                            | (f1::formals', (p2, p_imp)::pats') ->
                                (match f1 with
                                    ...
                                    inaccessible)) ->
                                     ...
                                     let p3 =
                                       let uu____2606 =
                                         FStar_Ident.range_of_lid
                                           (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
                                       maybe_dot inaccessible a uu____2606 in
                                 ...
                                 | (uu____2624, imp) ->
                                     ...
                                     uu____2630 :: uu____2640) in
                          let uu___105_2655 = p1 in
                          let uu____2658 =
                            let uu____2659 =
                            ...
                            FStar_Syntax_Syntax.Pat_cons uu____2659 in
                          {
                            ...
                            FStar_Syntax_Syntax.p =
                              (uu___105_2655.FStar_Syntax_Syntax.p)
                          }))
            | uu____2689 -> p1 in
          let one_pat allow_wc_dependence env1 p1 =
            let p2 = elaborate_pat env1 p1 in
            let uu____2731 = pat_as_arg_with_env allow_wc_dependence env1 p2 in
            ...
            | (b, a, w, env2, arg, guard, p3) ->
                ...
                (match uu____2789 with
                 ...
                 | uu____2838 -> (b, a, w, arg, guard, p3)) in
        ...
        let rec aux p1 e =
              ...
              (if Prims.op_Negation (FStar_Syntax_Syntax.bv_eq x y)
               ...
               (let s =
                  FStar_TypeChecker_Normalize.normalize
                    ...
                    y.FStar_Syntax_Syntax.sort in
                let x1 =
                  let uu___106_2959 = x in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___106_2959.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___106_2959.FStar_Syntax_Syntax.index);
              ...
              ((let uu____2963 =
               ...
               (let s =
                  FStar_TypeChecker_Normalize.normalize
                    ...
                    y.FStar_Syntax_Syntax.sort in
                let x1 =
                  let uu___107_2970 = x in
                  {
                    FStar_Syntax_Syntax.ppname =
                      (uu___107_2970.FStar_Syntax_Syntax.ppname);
                    FStar_Syntax_Syntax.index =
                      (uu___107_2970.FStar_Syntax_Syntax.index);
                    FStar_Syntax_Syntax.sort = s
                  } in
          ...
          | (FStar_Syntax_Syntax.Pat_cons (fv, argpats),
             ...
             ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv';
                ...
                FStar_Syntax_Syntax.vars = uu____3017;_},
              args)) ->
              ((let uu____3056 =
               ...
               (let fv1 = fv' in
                let rec match_args matched_pats args1 argpats1 =
                  ...
                  | (arg::args2, (argpat, uu____3200)::argpats2) ->
                      (match (arg, (argpat.FStar_Syntax_Syntax.v)) with
                       | ((e2, FStar_Pervasives_Native.Some
                          ...
                          FStar_Syntax_Syntax.Pat_dot_term uu____3275) ->
                           let x =
                             FStar_Syntax_Syntax.new_bv
                               (FStar_Pervasives_Native.Some
                                  (p1.FStar_Syntax_Syntax.p))
                  ...
                  | uu____3340 ->
                      let uu____3363 =
                        let uu____3364 = FStar_Syntax_Print.pat_to_string p1 in
                        let uu____3365 = FStar_Syntax_Print.term_to_string e1 in
                        FStar_Util.format2
                          "Unexpected number of pattern arguments: \n\t%s\n\t%s\n"
                          uu____3364 uu____3365 in
                      failwith uu____3363 in
          ...
          | (FStar_Syntax_Syntax.Pat_cons (fv, argpats),
             ...
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____3381;_},
              args)) ->
              ((let uu____3424 =
                ...
                let rec match_args matched_pats args1 argpats1 =
                  ...
                  | (arg::args2, (argpat, uu____3568)::argpats2) ->
                      (match (arg, (argpat.FStar_Syntax_Syntax.v)) with
                       | ((e2, FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Implicit (true))),
                          FStar_Syntax_Syntax.Pat_dot_term uu____3643) ->
                           let x =
                             FStar_Syntax_Syntax.new_bv
                               (FStar_Pervasives_Native.Some
                                  (p1.FStar_Syntax_Syntax.p))
                  ...
                  | uu____3708 ->
                      let uu____3731 =
                        let uu____3732 = FStar_Syntax_Print.pat_to_string p1 in
                        let uu____3733 = FStar_Syntax_Print.term_to_string e1 in
                        FStar_Util.format2
                          "Unexpected number of pattern arguments: \n\t%s\n\t%s\n"
          ...
          | uu____3742 ->
              let uu____3747 =
                ...
                FStar_Util.format3
                  ...
                  uu____3748 uu____3749 uu____3750 in
      ...
      | uu____4122 ->
          let uu____4131 =
            ...
            FStar_Util.format2
              ...
              (c.FStar_Syntax_Syntax.effect_name).FStar_Ident.str uu____4132 in
          failwith uu____4131 in
      ...
      fun g ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
              ...
              FStar_TypeChecker_Common.NonTrivial uu____4615 in
            {
              ...
              FStar_TypeChecker_Env.deferred =
                (uu___108_4613.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___108_4613.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___108_4613.FStar_TypeChecker_Env.implicits)
            }
let (close_comp :
  FStar_TypeChecker_Env.env ->
                  ...
                  (fun x ->
                     fun wp ->
                       ...
                       let uu____4697 =
                         ...
                         let uu____4703 =
                           let uu____4704 = FStar_Syntax_Syntax.as_arg res_t in
                           let uu____4705 =
                             let uu____4708 =
                         ...
                         FStar_Syntax_Syntax.mk_Tm_app uu____4702 uu____4703 in
               ...
               (let uu____4789 = FStar_Syntax_Util.head_and_args' e in
                ...
                | (head1, uu____4803) ->
                    ...
                    (match uu____4820 with
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____4825 =
                           let uu____4826 = FStar_Syntax_Syntax.lid_of_fv fv in
               ...
               let wp1 =
                 let uu____4956 =
                   ...
                   let uu____4962 =
                     ...
                     let uu____4964 =
                       let uu____4967 = FStar_Syntax_Syntax.as_arg formula in
                       let uu____4968 =
               ...
               | (u_res_t, res_t, wp) ->
                   ...
                   let wp1 =
                     let uu____5059 =
                       ...
                       let uu____5065 =
                         let uu____5066 = FStar_Syntax_Syntax.as_arg res_t in
                         let uu____5067 =
                           let uu____5070 =
                             let uu____5071 =
                               let uu____5072 =
                             ...
                             FStar_All.pipe_left FStar_Syntax_Syntax.as_arg
                               uu____5071 in
                           let uu____5073 =
                             let uu____5076 = FStar_Syntax_Syntax.as_arg wp in
                             [uu____5076] in
                           uu____5070 :: uu____5073 in
                         uu____5066 :: uu____5067 in
                       FStar_Syntax_Syntax.mk_Tm_app uu____5064 uu____5065 in
        ...
        fun lc ->
          fun g0 ->
            ...
            then (lc, g0)
              ...
              (let flags1 =
                 let uu____5130 =
                   let uu____5137 = FStar_Syntax_Util.is_tot_or_gtot_lcomp lc in
                   if uu____5137
                         ...
                         (FStar_List.collect
                            (fun uu___84_5165 ->
                               ...
                               | FStar_Syntax_Syntax.SHOULD_NOT_INLINE ->
                                   [FStar_Syntax_Syntax.SHOULD_NOT_INLINE]
                               | uu____5168 -> [])) in
                     FStar_List.append flags1 uu____5157 in
               ...
               (uu____5185,
                 (let uu___109_5188 = g0 in
                  {
                    FStar_TypeChecker_Env.guard_f =
                      FStar_TypeChecker_Common.Trivial;
                    FStar_TypeChecker_Env.deferred =
                      (uu___109_5188.FStar_TypeChecker_Env.deferred);
                    FStar_TypeChecker_Env.univ_ineqs =
                      (uu___109_5188.FStar_TypeChecker_Env.univ_ineqs);
                    FStar_TypeChecker_Env.implicits =
                      (uu___109_5188.FStar_TypeChecker_Env.implicits)
                  })))
            ...
            (let uu____5223 =
               (lcomp_has_trivial_postcondition lc) &&
                 (let uu____5225 =
                  ...
                  FStar_Option.isSome uu____5225) in
             if uu____5223
             then
               let u =
                 match uopt with
            ...
            | (b, lc2) ->
                ...
                let bind_flags =
                  ...
                  then [FStar_Syntax_Syntax.SHOULD_NOT_INLINE]
                    ...
                    (let flags1 =
                       let uu____5308 = FStar_Syntax_Util.is_total_lcomp lc11 in
                       if uu____5308
                       then
                         let uu____5311 =
                     ...
                     let uu____5324 = lcomp_has_trivial_postcondition lc21 in
                     if uu____5324
                ...
                let bind_it uu____5333 =
                  ...
                  then
                    ...
                    (let c1 = FStar_Syntax_Syntax.lcomp_comp lc11 in
                     ...
                     (let aux uu____5366 =
                        let uu____5367 = FStar_Syntax_Util.is_trivial_wp c1 in
                        if uu____5367
                        then
                          match b with
                          | FStar_Pervasives_Native.None ->
                                     ...
                                     then
                                       let c21 =
                                         FStar_Syntax_Subst.subst_comp
                                           [FStar_Syntax_Syntax.NT (x, e)] c2 in
                                       let x1 =
                                         let uu___110_5641 = x in
                                         {
                                           FStar_Syntax_Syntax.ppname =
                                             (uu___110_5641.FStar_Syntax_Syntax.ppname);
                                           FStar_Syntax_Syntax.index =
                                             (uu___110_5641.FStar_Syntax_Syntax.index);
                      ...
                      | FStar_Util.Inr reason ->
                          (debug1
                           ...
                           (let mk_bind c11 b1 c21 =
                              let uu____5713 = lift_and_destruct env c11 c21 in
                            ...
                            let mk_seq c11 b1 c21 =
                              ...
                              | (m, uu____5846, lift2) ->
                                  let c23 =
                                    let uu____5849 = lift_comp c22 m lift2 in
                                    FStar_Syntax_Syntax.mk_Comp uu____5849 in
                                        ...
                                        ((FStar_Options.vcgen_optimize_bind_as_seq
                                          ...
                                          (let uu____5910 =
                                             FStar_TypeChecker_Env.try_lookup_lid
                                               env
                                               FStar_Parser_Const.with_type_lid in
                                           FStar_Option.isSome uu____5910) in
                                      if uu____5908
                                      then
                                        let e1' =
                                          let uu____5932 =
      ...
      fun lc ->
        let should_return1 =
          (((Prims.op_Negation env.FStar_TypeChecker_Env.lax) &&
            ...
            &&
            (let uu____6000 = FStar_Syntax_Util.is_lcomp_partial_return lc in
          ...
          then
            ...
            (if uu____6022
             then
               ...
               let retc2 =
                 let uu___111_6026 = retc1 in
                 {
                   FStar_Syntax_Syntax.comp_univs =
                     (uu___111_6026.FStar_Syntax_Syntax.comp_univs);
                   FStar_Syntax_Syntax.effect_name =
                     FStar_Parser_Const.effect_GHOST_lid;
                   FStar_Syntax_Syntax.result_typ =
                     (uu___111_6026.FStar_Syntax_Syntax.result_typ);
            ...
            (let c1 = FStar_TypeChecker_Env.unfold_effect_abbrev env c in
             ...
             let ret1 =
               ...
               FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp uu____6037 in
             ...
             FStar_Syntax_Util.comp_set_flags uu____6045 flags1) in
              ...
              then lax_mk_tot_or_comp_l eff u_res_t res_t []
                ...
                (let ifthenelse md res_t1 g wp_t wp_e =
                   ...
                   let uu____6333 =
                     ...
                     let uu____6339 =
                       ...
                       let uu____6341 =
                         ...
                         let uu____6345 =
                           let uu____6348 = FStar_Syntax_Syntax.as_arg wp_t in
                           let uu____6349 =
                             let uu____6352 = FStar_Syntax_Syntax.as_arg wp_e in
                             [uu____6352] in
                 ...
                 let default_case =
                   let post_k =
                     let uu____6359 =
                       let uu____6366 = FStar_Syntax_Syntax.null_binder res_t in
                       [uu____6366] in
                     let uu____6367 =
                   ...
                   let wp =
                     let uu____6386 =
                       let uu____6387 = FStar_Syntax_Syntax.mk_binder post in
                       [uu____6387] in
                     let uu____6388 =
                       let uu____6389 =
                         let uu____6394 = FStar_TypeChecker_Env.get_range env in
                          ...
                          | (g, eff_label, uu____6466, cthen) ->
                              let uu____6478 =
                                let uu____6503 =
                                  ...
                                  FStar_Syntax_Syntax.lcomp_comp uu____6504 in
                                lift_and_destruct env uu____6503 celse in
                              (match uu____6478 with
                               | ((md, uu____6506, uu____6507),
                                  (uu____6508, uu____6509, wp_then),
    ...
    fun e ->
      fun lc ->
        fun t ->
          let is_prop t1 =
            let uu____6719 =
              let uu____6720 = FStar_Syntax_Util.unrefine t1 in
              uu____6720.FStar_Syntax_Syntax.n in
          ...
          let is_type1 t1 =
            ...
            let uu____6732 =
              let uu____6733 = FStar_Syntax_Subst.compress t2 in
              uu____6733.FStar_Syntax_Syntax.n in
            match uu____6732 with
            | FStar_Syntax_Syntax.Tm_type uu____6736 -> true
            | uu____6737 -> false in
          let uu____6738 =
            let uu____6739 =
          ...
          | FStar_Syntax_Syntax.Tm_fvar fv when
              ...
              let b2p1 =
                ...
                FStar_Syntax_Syntax.fvar uu____6757
              ...
              let lc1 =
                let uu____6759 =
                  let uu____6760 =
                    let uu____6761 =
                      let uu____6764 =
                        let uu____6765 = is_prop t in
                        if uu____6765
                        then FStar_Syntax_Util.kprop
                        else FStar_Syntax_Util.ktype0 in
                      FStar_Syntax_Syntax.mk_Total uu____6764 in
                    FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp
                      uu____6761 in
                  (FStar_Pervasives_Native.None, uu____6760) in
                bind e.FStar_Syntax_Syntax.pos env
                  (FStar_Pervasives_Native.Some e) lc uu____6759 in
              let e1 =
                let uu____6774 =
                  let uu____6779 =
                    let uu____6780 = FStar_Syntax_Syntax.as_arg e in
                    [uu____6780] in
                  FStar_Syntax_Syntax.mk_Tm_app b2p1 uu____6779 in
          ...
          let gopt =
            ...
            then
              ...
              (let uu____6873 =
               ...
               (uu____6873, true)) in
          match gopt with
          | (FStar_Pervasives_Native.None, uu____6884) ->
              ...
              then
                let uu____6893 =
                  FStar_TypeChecker_Err.basic_type_error env
                    ...
                    lc.FStar_Syntax_Syntax.res_typ in
                FStar_Errors.raise_error uu____6893 e.FStar_Syntax_Syntax.pos
              else
                (FStar_TypeChecker_Rel.subtype_fail env e
                   lc.FStar_Syntax_Syntax.res_typ t;
                 (e,
                   ((let uu___112_6907 = lc in
                     {
                       FStar_Syntax_Syntax.eff_name =
                         (uu___112_6907.FStar_Syntax_Syntax.eff_name);
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags =
                         (uu___112_6907.FStar_Syntax_Syntax.cflags);
                       FStar_Syntax_Syntax.comp_thunk =
                         (uu___112_6907.FStar_Syntax_Syntax.comp_thunk)
                     })), FStar_TypeChecker_Rel.trivial_guard))
          | (FStar_Pervasives_Native.Some g, apply_guard1) ->
              let uu____6912 = FStar_TypeChecker_Rel.guard_form g in
              (match uu____6912 with
               | FStar_TypeChecker_Common.Trivial ->
                   let lc1 =
                     let uu___113_6920 = lc in
                     {
                       FStar_Syntax_Syntax.eff_name =
                         (uu___113_6920.FStar_Syntax_Syntax.eff_name);
                       FStar_Syntax_Syntax.res_typ = t;
                       FStar_Syntax_Syntax.cflags =
                         (uu___113_6920.FStar_Syntax_Syntax.cflags);
                       FStar_Syntax_Syntax.comp_thunk =
                         (uu___113_6920.FStar_Syntax_Syntax.comp_thunk)
                     } in
                   (e, lc1, g)
               | FStar_TypeChecker_Common.NonTrivial f ->
                   let g1 =
                     let uu___114_6923 = g in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___114_6923.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___114_6923.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___114_6923.FStar_TypeChecker_Env.implicits)
                     } in
                   let strengthen uu____6929 =
                     let uu____6930 =
                       env.FStar_TypeChecker_Env.lax &&
                         (FStar_Options.ml_ish ()) in
                     if uu____6930
                     then FStar_Syntax_Syntax.lcomp_comp lc
                       ...
                       (let f1 =
                        ...
                        let uu____6933 =
                          let uu____6934 = FStar_Syntax_Subst.compress f1 in
                        ...
                        | FStar_Syntax_Syntax.Tm_abs
                            (uu____6937,
                             {
                               FStar_Syntax_Syntax.n =
                                 FStar_Syntax_Syntax.Tm_fvar fv;
                               FStar_Syntax_Syntax.pos = uu____6939;
                               FStar_Syntax_Syntax.vars = uu____6940;_},
                             uu____6941)
                            when
                            FStar_Syntax_Syntax.fv_eq_lid fv
                            ...
                            ->
                            let lc1 =
                              let uu___115_6963 = lc in
                              {
                                FStar_Syntax_Syntax.eff_name =
                                  (uu___115_6963.FStar_Syntax_Syntax.eff_name);
                                FStar_Syntax_Syntax.res_typ = t;
                                FStar_Syntax_Syntax.cflags =
                                  (uu___115_6963.FStar_Syntax_Syntax.cflags);
                                FStar_Syntax_Syntax.comp_thunk =
                                  (uu___115_6963.FStar_Syntax_Syntax.comp_thunk)
                              } in
                                ...
                                let uu____7018 =
                                  FStar_All.pipe_left
                                    ...
                                    (FStar_TypeChecker_Common.NonTrivial
                                       guard) in
                                strengthen_precondition uu____6999 uu____7016
                                  e uu____7017 uu____7018 in
                              match uu____6994 with
                              | (eq_ret, _trivial_so_ok_to_discard) ->
                                  let x1 =
                                    let uu___116_7022 = x in
                                    {
                                      FStar_Syntax_Syntax.ppname =
                                        (uu___116_7022.FStar_Syntax_Syntax.ppname);
                                      FStar_Syntax_Syntax.index =
                                        (uu___116_7022.FStar_Syntax_Syntax.index);
                                      FStar_Syntax_Syntax.sort =
                   ...
                   let lc1 =
                     let uu____7045 =
                       FStar_TypeChecker_Env.norm_eff_name env
                         lc.FStar_Syntax_Syntax.eff_name in
                     FStar_Syntax_Syntax.mk_lcomp uu____7045 t flags1
                       strengthen in
                   let g2 =
                     let uu___117_7047 = g1 in
                     {
                       FStar_TypeChecker_Env.guard_f =
                         FStar_TypeChecker_Common.Trivial;
                       FStar_TypeChecker_Env.deferred =
                         (uu___117_7047.FStar_TypeChecker_Env.deferred);
                       FStar_TypeChecker_Env.univ_ineqs =
                         (uu___117_7047.FStar_TypeChecker_Env.univ_ineqs);
                       FStar_TypeChecker_Env.implicits =
                         (uu___117_7047.FStar_TypeChecker_Env.implicits)
                     } in
                   (e, lc1, g2))
      ...
      let mk_post_type res_t ens =
        ...
        let uu____7078 =
          let uu____7079 =
            let uu____7084 =
              let uu____7085 =
                let uu____7086 = FStar_Syntax_Syntax.bv_to_name x in
                FStar_Syntax_Syntax.as_arg uu____7086 in
              [uu____7085] in
            FStar_Syntax_Syntax.mk_Tm_app ens uu____7084 in
          uu____7079 FStar_Pervasives_Native.None
            res_t.FStar_Syntax_Syntax.pos in
        FStar_Syntax_Util.refine x uu____7078 in
      let norm1 t =
        FStar_TypeChecker_Normalize.normalize
          [FStar_TypeChecker_Normalize.Beta;
          FStar_TypeChecker_Normalize.Eager_unfolding;
          FStar_TypeChecker_Normalize.EraseUniverses] env t in
      let uu____7095 = FStar_Syntax_Util.is_tot_or_gtot_comp comp in
      if uu____7095
      then
        (FStar_Pervasives_Native.None, (FStar_Syntax_Util.comp_result comp))
      else
        (match comp.FStar_Syntax_Syntax.n with
         | FStar_Syntax_Syntax.GTotal uu____7113 -> failwith "Impossible"
         | FStar_Syntax_Syntax.Total uu____7128 -> failwith "Impossible"
         | FStar_Syntax_Syntax.Comp ct ->
             ...
             then
               (match ct.FStar_Syntax_Syntax.effect_args with
                | (req, uu____7158)::(ens, uu____7160)::uu____7161 ->
                    let uu____7190 =
                      let uu____7193 = norm1 req in
                      FStar_Pervasives_Native.Some uu____7193 in
                    let uu____7194 =
                      let uu____7195 =
                        mk_post_type ct.FStar_Syntax_Syntax.result_typ ens in
                      FStar_All.pipe_left norm1 uu____7195 in
                    (uu____7190, uu____7194)
                | uu____7198 ->
                    let uu____7207 =
                      let uu____7212 =
                        let uu____7213 =
                      ...
                      (FStar_Errors.Fatal_EffectConstructorNotFullyApplied,
                        uu____7212) in
                    FStar_Errors.raise_error uu____7207
                      comp.FStar_Syntax_Syntax.pos)
             else
               (let ct1 = FStar_TypeChecker_Env.unfold_effect_abbrev env comp in
                match ct1.FStar_Syntax_Syntax.effect_args with
                | (wp, uu____7229)::uu____7230 ->
                    let uu____7249 =
                      let uu____7254 =
                        FStar_TypeChecker_Env.lookup_lid env
                          ...
                          | (us_e, uu____7324) ->
                              ...
                              let as_req =
                                let uu____7327 =
                                  ...
                                  FStar_Syntax_Syntax.fvar uu____7328
                                    FStar_Syntax_Syntax.Delta_equational
                                    FStar_Pervasives_Native.None in
                                FStar_Syntax_Syntax.mk_Tm_uinst uu____7327
                                  us_r in
                              let as_ens =
                                let uu____7330 =
                                  let uu____7331 =
                                  ...
                                  FStar_Syntax_Syntax.fvar uu____7331
                                    FStar_Syntax_Syntax.Delta_equational
                                    FStar_Pervasives_Native.None in
                                FStar_Syntax_Syntax.mk_Tm_uinst uu____7330
                                  us_e in
                              let req =
                                let uu____7335 =
                                  let uu____7340 =
                              ...
                              let ens =
                                let uu____7370 =
                                  ...
                                  FStar_Syntax_Syntax.mk_Tm_app as_ens
                                    uu____7375 in
                                uu____7370 FStar_Pervasives_Native.None
                                  (ct1.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
                              let uu____7402 =
                                let uu____7405 = norm1 req in
                              ...
                              let uu____7406 =
                                ...
                                norm1 uu____7407 in
                              (uu____7402, uu____7406)))
                | uu____7410 -> failwith "Impossible"))
let (reify_body :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
  =
    ...
    fun t ->
      ...
      (let uu____7440 =
       ...
       then
         ...
         let uu____7442 = FStar_Syntax_Print.term_to_string tm' in
      ...
      fun arg ->
        ...
        (let uu____7466 =
         ...
         then
           ...
           let uu____7468 = FStar_Syntax_Print.term_to_string tm' in
           FStar_Util.print2 "Reified body %s \nto %s\n" uu____7467
             uu____7468
         else ());
        tm'
let (remove_reify : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) =
  fun t ->
    let uu____7475 =
      let uu____7476 =
        let uu____7477 = FStar_Syntax_Subst.compress t in
        uu____7477.FStar_Syntax_Syntax.n in
      match uu____7476 with
      | FStar_Syntax_Syntax.Tm_app uu____7480 -> false
      | uu____7495 -> true in
    if uu____7475
    then t
    else
      (let uu____7497 = FStar_Syntax_Util.head_and_args t in
       ...
       | (head1, args) ->
           let uu____7534 =
             let uu____7535 =
               let uu____7536 = FStar_Syntax_Subst.compress head1 in
      ...
      fun t ->
        ...
        then (e, torig, FStar_TypeChecker_Rel.trivial_guard)
          ...
          (let number_of_implicits t1 =
             let uu____7606 = FStar_Syntax_Util.arrow_formals t1 in
           ...
           let inst_n_binders t1 =
             let uu____7854 = FStar_TypeChecker_Env.expected_typ env in
             ...
             | FStar_Pervasives_Native.Some expected_t ->
                 ...
                 then
                   let uu____7878 =
                     let uu____7883 =
                       let uu____7884 = FStar_Util.string_of_int n_expected in
                       let uu____7891 = FStar_Syntax_Print.term_to_string e in
                       let uu____7892 = FStar_Util.string_of_int n_available in
                       FStar_Util.format3
                         "Expected a term with %s implicit arguments, but %s has only %s"
                         uu____7884 uu____7891 uu____7892 in
                     (FStar_Errors.Fatal_MissingImplicitArguments,
                       uu____7883) in
                   let uu____7899 = FStar_TypeChecker_Env.get_range env in
                   FStar_Errors.raise_error uu____7878 uu____7899
                 else FStar_Pervasives_Native.Some (n_available - n_expected) in
           let decr_inst uu___88_7922 =
             match uu___88_7922 with
             | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
             | FStar_Pervasives_Native.Some i ->
                 FStar_Pervasives_Native.Some (i - (Prims.parse_int "1")) in
           match torig.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Tm_arrow (bs, c) ->
               let uu____7952 = FStar_Syntax_Subst.open_comp bs c in
               (match uu____7952 with
                | (bs1, c1) ->
                    let rec aux subst1 inst_n bs2 =
                      match (inst_n, bs2) with
                      | (FStar_Pervasives_Native.Some _0_18, uu____8067) when
                               ...
                               (match uu____8200 with
                                | (args, bs3, subst3, g') ->
                                    ...
                                    (((v1,
                                      ...
                                      :: args), bs3, subst3, uu____8293)))
                      | (uu____8320, bs3) ->
                          ([], bs3, subst1,
                            FStar_TypeChecker_Rel.trivial_guard) in
                    let uu____8366 =
                      let uu____8393 = inst_n_binders t in
                      aux [] uu____8393 bs1 in
                    (match uu____8366 with
                     | (args, bs2, subst1, guard) ->
                         (match (args, bs2) with
                          | ([], uu____8464) -> (e, torig, guard)
                          | (uu____8495, []) when
                              let uu____8526 =
                          ...
                          | uu____8527 ->
                              ...
                              let e1 =
                                FStar_Syntax_Syntax.mk_Tm_app e args
                                  ...
                                  e.FStar_Syntax_Syntax.pos in
                              (e1, t2, guard))))
           | uu____8574 -> (e, t, FStar_TypeChecker_Rel.trivial_guard))
let (string_of_univs :
  FStar_Syntax_Syntax.universe_uvar FStar_Util.set -> Prims.string) =
  fun univs1 ->
    let uu____8584 =
      let uu____8587 = FStar_Util.set_elements univs1 in
      FStar_All.pipe_right uu____8587
        (FStar_List.map
           (fun u ->
              let uu____8597 = FStar_Syntax_Unionfind.univ_uvar_id u in
              FStar_All.pipe_right uu____8597 FStar_Util.string_of_int)) in
    FStar_All.pipe_right uu____8584 (FStar_String.concat ", ")
let (gen_univs :
  FStar_TypeChecker_Env.env ->
  ...
  fun env ->
    fun x ->
      let uu____8618 = FStar_Util.set_is_empty x in
      if uu____8618
      then []
      else
        (let s =
           let uu____8625 =
             let uu____8628 = FStar_TypeChecker_Env.univ_vars env in
             FStar_Util.set_difference x uu____8628 in
           FStar_All.pipe_right uu____8625 FStar_Util.set_elements in
         (let uu____8636 =
            FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
          ...
          then
            let uu____8637 =
              let uu____8638 = FStar_TypeChecker_Env.univ_vars env in
              string_of_univs uu____8638 in
            FStar_Util.print1 "univ_vars in env: %s\n" uu____8637
          else ());
         (let r =
            let uu____8645 = FStar_TypeChecker_Env.get_range env in
            FStar_Pervasives_Native.Some uu____8645 in
          let u_names =
...
let (gather_free_univnames :
  ...
  fun env ->
    fun t ->
      ...
      let univnames1 =
        let uu____8690 = FStar_Util.set_difference tm_univnames ctx_univnames in
        FStar_All.pipe_right uu____8690 FStar_Util.set_elements in
      univnames1
  ...
  fun explicit_univ_names ->
    fun generalized_univ_names ->
      fun t ->
        ...
        | ([], uu____8728) -> generalized_univ_names
        | (uu____8735, []) -> explicit_univ_names
        | uu____8742 ->
            let uu____8751 =
              let uu____8756 =
                let uu____8757 = FStar_Syntax_Print.term_to_string t in
                Prims.strcat
                  "Generalized universe in a term containing explicit universe annotation : "
                  uu____8757 in
              (FStar_Errors.Fatal_UnexpectedGeneralizedUniverse, uu____8756) in
            FStar_Errors.raise_error uu____8751 t.FStar_Syntax_Syntax.pos
    ...
    fun t0 ->
      let t =
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.Beta;
          FStar_TypeChecker_Normalize.DoNotUnfoldPureLets] env t0 in
      ...
      (let uu____8775 =
       ...
       then
         ...
         let uu____8777 = FStar_Syntax_Print.univ_names_to_string univnames1 in
         FStar_Util.print2
      ...
      (let univs1 = FStar_Syntax_Free.univs t in
       (let uu____8783 =
        ...
        if uu____8783
        then
          let uu____8784 = string_of_univs univs1 in
       ...
       (let gen1 = gen_univs env univs1 in
        (let uu____8790 =
         ...
         then
           ...
           let uu____8792 = FStar_Syntax_Print.univ_names_to_string gen1 in
          ...
          let uu____8869 =
            FStar_Util.for_all
              (fun uu____8882 ->
                 ...
                 | (uu____8891, uu____8892, c) ->
                     FStar_Syntax_Util.is_pure_or_ghost_comp c) lecs in
          FStar_All.pipe_left Prims.op_Negation uu____8869 in
        if uu____8868
        then FStar_Pervasives_Native.None
          ...
          (let norm1 c =
             (let uu____8940 =
              ...
              if uu____8940
              then
                let uu____8941 = FStar_Syntax_Print.comp_to_string c in
             ...
             (let c1 =
                FStar_TypeChecker_Normalize.normalize_comp
                  ...
                  FStar_TypeChecker_Normalize.NoFullNorm;
                  FStar_TypeChecker_Normalize.DoNotUnfoldPureLets] env c in
              (let uu____8945 =
                 FStar_TypeChecker_Env.debug env FStar_Options.Medium in
               if uu____8945
               then
                 let uu____8946 = FStar_Syntax_Print.comp_to_string c1 in
                 FStar_Util.print1 "Normalized to:\n\t %s\n" uu____8946
               else ());
              c1) in
           let env_uvars = FStar_TypeChecker_Env.uvars_in_env env in
           let gen_uvars uvs =
             let uu____9009 = FStar_Util.set_difference uvs env_uvars in
             FStar_All.pipe_right uu____9009 FStar_Util.set_elements in
           let univs_and_uvars_of_lec uu____9141 =
             ...
             | (lbname, e, c) ->
                 ...
                 ((let uu____9207 =
                   ...
                   then
                     let uu____9208 =
                       let uu____9209 =
                         let uu____9212 = FStar_Util.set_elements univs1 in
                     ...
                     let uu____9239 =
                       let uu____9240 =
                         let uu____9243 = FStar_Util.set_elements uvt in
                  ...
                  (let univs2 =
                     let uu____9286 = FStar_Util.set_elements uvt in
                     FStar_List.fold_left
                       (fun univs2 ->
                          fun uu____9309 ->
                            match uu____9309 with
                            | (uu____9318, t2) ->
                                let uu____9320 = FStar_Syntax_Free.univs t2 in
                                FStar_Util.set_union univs2 uu____9320)
                       univs1 uu____9286 in
                   ...
                   (let uu____9343 =
                    ...
                    then
                      let uu____9344 =
                        let uu____9345 =
                          let uu____9348 = FStar_Util.set_elements univs2 in
                                  ...
                                  | (u, t2) ->
                                      ...
                                      let uu____9416 =
                                        FStar_TypeChecker_Normalize.term_to_string
                                          env t2 in
                                      FStar_Util.format2 "(%s : %s)"
                                        uu____9415 uu____9416)) in
                        FStar_All.pipe_right uu____9376
                          (FStar_String.concat ", ") in
                      FStar_Util.print2
                        "^^^^\n\tFree univs = %s\n\tgen_uvars =%s" uu____9344
                        uu____9375
                    else ());
                   (univs2, uvs, (lbname, e, c1)))) in
           let uu____9446 =
             let uu____9479 = FStar_List.hd lecs in
             univs_and_uvars_of_lec uu____9479 in
           ...
           | (univs1, uvs, lec_hd) ->
               let force_univs_eq lec2 u1 u2 =
                 ...
                 then ()
                   ...
                   (let uu____9605 = lec_hd in
                    match uu____9605 with
                    | (lb1, uu____9613, uu____9614) ->
                        let uu____9615 = lec2 in
                        (match uu____9615 with
                         | (lb2, uu____9623, uu____9624) ->
                             let msg =
                               let uu____9626 =
               ...
               let force_uvars_eq lec2 u1 u2 =
                 ...
                 then ()
                   ...
                   (let uu____9794 = lec_hd in
                    match uu____9794 with
                    | (lb1, uu____9802, uu____9803) ->
                        let uu____9804 = lec2 in
                        (match uu____9804 with
                         | (lb2, uu____9812, uu____9813) ->
                             let msg =
                               let uu____9815 =
                                 FStar_Syntax_Print.lbname_to_string lb1 in
                               let uu____9816 =
                             ...
                             FStar_Errors.raise_error
                               (FStar_Errors.Fatal_IncompatibleNumberOfTypes,
                                 msg) uu____9817)) in
               let lecs1 =
                 let uu____9827 = FStar_List.tl lecs in
                 FStar_List.fold_right
                   (fun this_lec ->
                      fun lecs1 ->
                        let uu____9886 = univs_and_uvars_of_lec this_lec in
                       ...
                       let uu____10053 =
                         let uu____10058 =
                           ...
                           FStar_Util.format3
                             ...
                             uu____10059 uu____10060 uu____10061 in
                         (FStar_Errors.Fatal_FailToResolveImplicitArgument,
                           uu____10058) in
                       let uu____10062 = FStar_TypeChecker_Env.get_range env in
                       FStar_Errors.raise_error uu____10053 uu____10062 in
                 FStar_All.pipe_right uvs1
                   (FStar_List.map
                      (fun uu____10092 ->
                         match uu____10092 with
                         | (u, k) ->
                             let uu____10105 = FStar_Syntax_Unionfind.find u in
                             (match uu____10105 with
                              | FStar_Pervasives_Native.Some uu____10114 ->
                                  failwith
                                       ...
                                       ((let uu____10163 =
                                         ...
                                         | FStar_Syntax_Syntax.Tm_type
                                             ...
                                             let uu____10172 =
                                               ...
                                               Prims.op_Negation uu____10173 in
                                             if uu____10172
                                             then fail1 kres
                                             else ()
                                         | uu____10175 -> fail1 kres);
                                        (let a =
                                           let uu____10177 =
                                             let uu____10180 =
...
let (generalize :
  ...
  fun env ->
    fun is_rec ->
      fun lecs ->
        (let uu____10701 = FStar_TypeChecker_Env.debug env FStar_Options.Low in
         if uu____10701
         then
           let uu____10702 =
             let uu____10703 =
               FStar_List.map
                 (fun uu____10716 ->
                    ...
                    | (lb, uu____10724, uu____10725) ->
                        FStar_Syntax_Print.lbname_to_string lb) lecs in
             FStar_All.pipe_right uu____10703 (FStar_String.concat ", ") in
        ...
        (let univnames_lecs =
         ...
         let generalized_lecs =
           let uu____10775 = gen env is_rec lecs in
                        ...
                        (fun uu____10980 ->
                           ...
                           | (l, us, e, c, gvs) ->
                               ...
                               FStar_Util.print5
                                 ...
                                 uu____11014 uu____11015 uu____11016
                                 uu____11017 uu____11018))
                 else ());
                luecs) in
         FStar_List.map2
           (fun univnames1 ->
              fun uu____11059 ->
                ...
                | (l, generalized_univs, t, c, gvs) ->
                    ...
                    (l, uu____11103, t, c, gvs)) univnames_lecs
           generalized_lecs)
        ...
        fun t2 ->
            ...
            then FStar_TypeChecker_Rel.try_teq true env2 t11 t21
              ...
              (let uu____11160 =
               ...
               | FStar_Pervasives_Native.Some f ->
                   let uu____11166 = FStar_TypeChecker_Rel.apply_guard f e in
                   FStar_All.pipe_left
                     (fun _0_20 -> FStar_Pervasives_Native.Some _0_20)
                     uu____11166) in
          let is_var e1 =
            let uu____11175 =
              let uu____11176 = FStar_Syntax_Subst.compress e1 in
              uu____11176.FStar_Syntax_Syntax.n in
            match uu____11175 with
            | FStar_Syntax_Syntax.Tm_name uu____11179 -> true
            ...
            | FStar_Syntax_Syntax.Tm_name x ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_name
                     (let uu___118_11200 = x in
                      {
                        FStar_Syntax_Syntax.ppname =
                          (uu___118_11200.FStar_Syntax_Syntax.ppname);
                        FStar_Syntax_Syntax.index =
                          (uu___118_11200.FStar_Syntax_Syntax.index);
                        FStar_Syntax_Syntax.sort = t2
                      })) FStar_Pervasives_Native.None
                  e2.FStar_Syntax_Syntax.pos
            | uu____11201 -> e2 in
          let env2 =
            let uu___119_11203 = env1 in
            let uu____11204 =
                ...
                (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)) in
            {
              ...
              FStar_TypeChecker_Env.range =
                (uu___119_11203.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___119_11203.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___119_11203.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___119_11203.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___119_11203.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___119_11203.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___119_11203.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___119_11203.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___119_11203.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___119_11203.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___119_11203.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___119_11203.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___119_11203.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___119_11203.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq = uu____11204;
              FStar_TypeChecker_Env.is_iface =
                (uu___119_11203.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___119_11203.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax =
                (uu___119_11203.FStar_TypeChecker_Env.lax);
              FStar_TypeChecker_Env.lax_universes =
                (uu___119_11203.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___119_11203.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___119_11203.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___119_11203.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___119_11203.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___119_11203.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___119_11203.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___119_11203.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___119_11203.FStar_TypeChecker_Env.qtbl_name_and_index);
              ...
              FStar_TypeChecker_Env.synth_hook =
                (uu___119_11203.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___119_11203.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___119_11203.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___119_11203.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___119_11203.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___119_11203.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___119_11203.FStar_TypeChecker_Env.dep_graph)
            } in
          let uu____11205 = check1 env2 t1 t2 in
          match uu____11205 with
          | FStar_Pervasives_Native.None ->
              let uu____11212 =
                FStar_TypeChecker_Err.expected_expression_of_type env2 t2 e
                  t1 in
              let uu____11217 = FStar_TypeChecker_Env.get_range env2 in
              FStar_Errors.raise_error uu____11212 uu____11217
          | FStar_Pervasives_Native.Some g ->
              ((let uu____11224 =
               ...
               (let uu____11227 = decorate e t2 in (uu____11227, g)))
let (check_top_level :
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Env.guard_t ->
      FStar_Syntax_Syntax.lcomp ->
  ...
  fun env ->
    fun g ->
      fun lc ->
        ...
        let uu____11263 = FStar_Syntax_Util.is_total_lcomp lc in
        if uu____11263
        then
          let uu____11268 = discharge g1 in
          let uu____11269 = FStar_Syntax_Syntax.lcomp_comp lc in
          (uu____11268, uu____11269)
        else
          (let c = FStar_Syntax_Syntax.lcomp_comp lc in
           let steps =
             [FStar_TypeChecker_Normalize.Beta;
           ...
           let c1 =
             let uu____11276 =
               let uu____11277 =
                 ...
                 FStar_All.pipe_right uu____11278 FStar_Syntax_Syntax.mk_Comp in
           ...
           let md =
             FStar_TypeChecker_Env.get_effect_decl env
               c1.FStar_Syntax_Syntax.effect_name in
           let uu____11280 = destruct_comp c1 in
           ...
           | (u_t, t, wp) ->
               let vc =
                 ...
                 let uu____11298 =
                   ...
                   let uu____11304 =
                     let uu____11305 = FStar_Syntax_Syntax.as_arg t in
                     let uu____11306 =
                       let uu____11309 = FStar_Syntax_Syntax.as_arg wp in
                       [uu____11309] in
                     uu____11305 :: uu____11306 in
                   FStar_Syntax_Syntax.mk_Tm_app uu____11303 uu____11304 in
                 uu____11298 FStar_Pervasives_Native.None uu____11297 in
               ((let uu____11313 =
                   FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                     (FStar_Options.Other "Simplification") in
                 if uu____11313
                 then
                   let uu____11314 = FStar_Syntax_Print.term_to_string vc in
                ...
                (let g2 =
                   ...
                   FStar_TypeChecker_Rel.conj_guard g1 uu____11317 in
                 let uu____11318 = discharge g2 in
                 let uu____11319 = FStar_Syntax_Syntax.mk_Comp c1 in
...
let (short_circuit :
  ...
  fun head1 ->
    fun seen_args ->
      let short_bin_op f uu___89_11351 =
        match uu___89_11351 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (fst1, uu____11359)::[] -> f fst1
        | uu____11376 -> failwith "Unexpexted args to binary operator" in
      let op_and_e e =
        let uu____11383 = FStar_Syntax_Util.b2p e in
        FStar_All.pipe_right uu____11383
          (fun _0_21 -> FStar_TypeChecker_Common.NonTrivial _0_21) in
      let op_or_e e =
        let uu____11394 =
          let uu____11397 = FStar_Syntax_Util.b2p e in
          FStar_Syntax_Util.mk_neg uu____11397 in
        FStar_All.pipe_right uu____11394
          (fun _0_22 -> FStar_TypeChecker_Common.NonTrivial _0_22) in
      let op_and_t t =
        FStar_All.pipe_right t
          (fun _0_23 -> FStar_TypeChecker_Common.NonTrivial _0_23) in
      let op_or_t t =
        let uu____11412 = FStar_All.pipe_right t FStar_Syntax_Util.mk_neg in
        FStar_All.pipe_right uu____11412
          (fun _0_24 -> FStar_TypeChecker_Common.NonTrivial _0_24) in
      let op_imp_t t =
        FStar_All.pipe_right t
          (fun _0_25 -> FStar_TypeChecker_Common.NonTrivial _0_25) in
      let short_op_ite uu___90_11430 =
        match uu___90_11430 with
        | [] -> FStar_TypeChecker_Common.Trivial
        | (guard, uu____11438)::[] ->
            FStar_TypeChecker_Common.NonTrivial guard
        | _then::(guard, uu____11457)::[] ->
            let uu____11486 = FStar_Syntax_Util.mk_neg guard in
            FStar_All.pipe_right uu____11486
              (fun _0_26 -> FStar_TypeChecker_Common.NonTrivial _0_26)
        | uu____11491 -> failwith "Unexpected args to ITE" in
      let table =
        let uu____11502 =
          let uu____11510 = short_bin_op op_and_e in
          (FStar_Parser_Const.op_And, uu____11510) in
        let uu____11518 =
          let uu____11528 =
            let uu____11536 = short_bin_op op_or_e in
            (FStar_Parser_Const.op_Or, uu____11536) in
          let uu____11544 =
            let uu____11554 =
              let uu____11562 = short_bin_op op_and_t in
              (FStar_Parser_Const.and_lid, uu____11562) in
            let uu____11570 =
              let uu____11580 =
                let uu____11588 = short_bin_op op_or_t in
                (FStar_Parser_Const.or_lid, uu____11588) in
              let uu____11596 =
                let uu____11606 =
                  let uu____11614 = short_bin_op op_imp_t in
                  (FStar_Parser_Const.imp_lid, uu____11614) in
                [uu____11606; (FStar_Parser_Const.ite_lid, short_op_ite)] in
              uu____11580 :: uu____11596 in
            uu____11554 :: uu____11570 in
          uu____11528 :: uu____11544 in
        uu____11502 :: uu____11518 in
          ...
          let uu____11676 =
            FStar_Util.find_map table
              (fun uu____11691 ->
                 ...
                 | (x, mk1) ->
                     let uu____11708 = FStar_Ident.lid_equals x lid in
                     if uu____11708
                     then
                       let uu____11711 = mk1 seen_args in
                       FStar_Pervasives_Native.Some uu____11711
                     else FStar_Pervasives_Native.None) in
          (match uu____11676 with
           | FStar_Pervasives_Native.None -> FStar_TypeChecker_Common.Trivial
           | FStar_Pervasives_Native.Some g -> g)
      | uu____11714 -> FStar_TypeChecker_Common.Trivial
let (short_circuit_head : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun l ->
    let uu____11720 =
      let uu____11721 = FStar_Syntax_Util.un_uinst l in
...
let (maybe_add_implicit_binders :
  ...
  fun env ->
    fun bs ->
      let pos bs1 =
        match bs1 with
        | (hd1, uu____11755)::uu____11756 ->
            FStar_Syntax_Syntax.range_of_bv hd1
        | uu____11767 -> FStar_TypeChecker_Env.get_range env in
      match bs with
      | (uu____11774, FStar_Pervasives_Native.Some
         (FStar_Syntax_Syntax.Implicit uu____11775))::uu____11776 -> bs
      | uu____11793 ->
          let uu____11794 = FStar_TypeChecker_Env.expected_typ env in
          (match uu____11794 with
           | FStar_Pervasives_Native.None -> bs
           | FStar_Pervasives_Native.Some t ->
               let uu____11798 =
                 let uu____11799 = FStar_Syntax_Subst.compress t in
                 uu____11799.FStar_Syntax_Syntax.n in
               (match uu____11798 with
                | FStar_Syntax_Syntax.Tm_arrow (bs', uu____11803) ->
                    let uu____11820 =
                      FStar_Util.prefix_until
                        (fun uu___91_11860 ->
                           match uu___91_11860 with
                           | (uu____11867, FStar_Pervasives_Native.Some
                              (FStar_Syntax_Syntax.Implicit uu____11868)) ->
                               false
                           | uu____11871 -> true) bs' in
                    (match uu____11820 with
                     | FStar_Pervasives_Native.None -> bs
                     | FStar_Pervasives_Native.Some
                         ([], uu____11906, uu____11907) -> bs
                     | FStar_Pervasives_Native.Some
                         (imps, uu____11979, uu____11980) ->
                         let uu____12053 =
        ...
        (let uu____12237 =
         ...
         then
           ((let uu____12239 = FStar_Ident.text_of_lid lident in
             d uu____12239);
            (let uu____12240 = FStar_Ident.text_of_lid lident in
             let uu____12241 = FStar_Syntax_Print.term_to_string def in
             FStar_Util.print2 "Registering top-level definition: %s\n%s\n"
               uu____12240 uu____12241))
         else ());
        (let fv =
           let uu____12244 = FStar_Syntax_Util.incr_delta_qualifier def in
           FStar_Syntax_Syntax.lid_as_fv lident uu____12244
             FStar_Pervasives_Native.None in
         ...
         ((let uu___120_12260 = sig_ctx in
           {
             FStar_Syntax_Syntax.sigel =
               (uu___120_12260.FStar_Syntax_Syntax.sigel);
             FStar_Syntax_Syntax.sigrng =
               (uu___120_12260.FStar_Syntax_Syntax.sigrng);
             FStar_Syntax_Syntax.sigquals =
               [FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen];
             FStar_Syntax_Syntax.sigmeta =
               (uu___120_12260.FStar_Syntax_Syntax.sigmeta);
             FStar_Syntax_Syntax.sigattrs =
               (uu___120_12260.FStar_Syntax_Syntax.sigattrs)
           }), uu____12254))
let (check_sigelt_quals :
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.sigelt -> unit) =
  fun env ->
    fun se ->
      let visibility uu___92_12276 =
        match uu___92_12276 with
        | FStar_Syntax_Syntax.Private -> true
        | uu____12277 -> false in
      let reducibility uu___93_12283 =
        match uu___93_12283 with
      ...
      let assumption uu___94_12290 =
        match uu___94_12290 with
        | FStar_Syntax_Syntax.Assumption -> true
        | FStar_Syntax_Syntax.New -> true
        | uu____12291 -> false in
      let reification uu___95_12297 =
        match uu___95_12297 with
        | FStar_Syntax_Syntax.Reifiable -> true
        | FStar_Syntax_Syntax.Reflectable uu____12298 -> true
        | uu____12299 -> false in
      let inferred uu___96_12305 =
        match uu___96_12305 with
        | FStar_Syntax_Syntax.Discriminator uu____12306 -> true
        | FStar_Syntax_Syntax.Projector uu____12307 -> true
        | FStar_Syntax_Syntax.RecordType uu____12312 -> true
        | FStar_Syntax_Syntax.RecordConstructor uu____12321 -> true
        | FStar_Syntax_Syntax.ExceptionConstructor -> true
        | FStar_Syntax_Syntax.HasMaskedEffect -> true
        | FStar_Syntax_Syntax.Effect -> true
        | uu____12330 -> false in
      let has_eq uu___97_12336 =
        match uu___97_12336 with
      ...
      let quals_combo_ok quals q =
        ...
        | FStar_Syntax_Syntax.Reflectable uu____12397 ->
            FStar_All.pipe_right quals
              (FStar_List.for_all
                 (fun x ->
                    ((((reification x) || (inferred x)) || (visibility x)) ||
      ...
      let uu____12406 =
        let uu____12407 =
          FStar_All.pipe_right quals
            (FStar_Util.for_some
               (fun uu___98_12411 ->
                  match uu___98_12411 with
                  | FStar_Syntax_Syntax.OnlyName -> true
                  | uu____12412 -> false)) in
        FStar_All.pipe_right uu____12407 Prims.op_Negation in
      if uu____12406
      then
        ...
        let err' msg =
          let uu____12427 =
            let uu____12432 =
              let uu____12433 = FStar_Syntax_Print.quals_to_string quals in
              FStar_Util.format2
                "The qualifier list \"[%s]\" is not permissible for this element%s"
                uu____12433 msg in
            (FStar_Errors.Fatal_QulifierListNotPermitted, uu____12432) in
          FStar_Errors.raise_error uu____12427 r in
        let err msg = err' (Prims.strcat ": " msg) in
        let err'1 uu____12445 = err' "" in
        (if (FStar_List.length quals) <> (FStar_List.length no_dup_quals)
         ...
         (let uu____12449 =
          ...
          if uu____12449 then err "ill-formed combination" else ());
         (match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_let ((is_rec, uu____12455), uu____12456)
              ->
              ((let uu____12472 =
                  is_rec &&
                    (FStar_All.pipe_right quals
          ...
          | FStar_Syntax_Syntax.Sig_bundle uu____12482 ->
              let uu____12491 =
                let uu____12492 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____12491 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_declare_typ uu____12498 ->
              let uu____12505 =
                FStar_All.pipe_right quals (FStar_Util.for_some has_eq) in
              if uu____12505 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_assume uu____12509 ->
              let uu____12516 =
                let uu____12517 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                ...
                Prims.op_Negation uu____12517 in
              if uu____12516 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____12523 ->
              let uu____12524 =
                let uu____12525 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
              ...
              if uu____12524 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____12531 ->
              let uu____12532 =
                let uu____12533 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
                       (fun x ->
                          (((x = FStar_Syntax_Syntax.TotalEffect) ||
                             ...
                             || (visibility x))
                            || (reification x))) in
                Prims.op_Negation uu____12533 in
              if uu____12532 then err'1 () else ()
          | FStar_Syntax_Syntax.Sig_effect_abbrev uu____12539 ->
              let uu____12552 =
                let uu____12553 =
                  FStar_All.pipe_right quals
                    (FStar_Util.for_all
  ...
  fun g ->
    fun t ->
      let rec aux_whnf env t1 =
        let uu____12593 =
          let uu____12594 = FStar_Syntax_Subst.compress t1 in
          uu____12594.FStar_Syntax_Syntax.n in
        match uu____12593 with
        | FStar_Syntax_Syntax.Tm_type uu____12597 -> true
        | FStar_Syntax_Syntax.Tm_fvar fv ->
                         ...
                         (FStar_List.existsb
                            (fun t2 ->
                               ...
                               | FStar_Syntax_Syntax.Tm_fvar fv1 when
                                   ...
                                   -> true
                               | uu____12645 -> false)))))
        | FStar_Syntax_Syntax.Tm_arrow uu____12646 ->
            let uu____12659 = FStar_Syntax_Util.arrow_formals_comp t1 in
            (match uu____12659 with
             | (bs, c) ->
                 let env1 = FStar_TypeChecker_Env.push_binders env bs in
                 let uu____12685 = FStar_Syntax_Util.is_pure_comp c in
                 if uu____12685
                 then aux env1 (FStar_Syntax_Util.comp_result c)
                 else FStar_Syntax_Util.is_pure_or_ghost_comp c)
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu____12687;
               FStar_Syntax_Syntax.index = uu____12688;
               FStar_Syntax_Syntax.sort = t2;_},
             uu____12690)
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_ascribed (t2, uu____12698, uu____12699) ->
            aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1, uu____12741::[]) ->
            let uu____12772 =
              let uu____12773 = FStar_Syntax_Util.un_uinst head1 in
      ...
      and aux env t1 =
        let t2 =
          FStar_TypeChecker_Normalize.normalize
            ...
            FStar_TypeChecker_Normalize.Zeta;
            FStar_TypeChecker_Normalize.Iota] env t1 in
        ...
        (let uu____12786 =
         ...
         if uu____12786
         then
           let uu____12787 = FStar_Syntax_Print.term_to_string t2 in
           FStar_Util.print2 "must_erase=%s: %s\n"
             (if res then "true" else "false") uu____12787
         else ());
        res in
      aux g t