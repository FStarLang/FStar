...
let _45_301 = (match ((let _145_356 = (FStar_Absyn_Util.compress_typ uv)
...
in {attempting = _145_390; wl_deferred = _45_328.wl_deferred; subst = _45_328.subst; ctr = _45_328.ctr; slack_vars = g.slack; defer_ok = false; smt_ok = _45_328.smt_ok; tcenv = _45_328.tcenv})))
...
in {FStar_Absyn_Syntax.v = _45_426.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _145_463; FStar_Absyn_Syntax.p = _45_426.FStar_Absyn_Syntax.p}))
...
in {FStar_Absyn_Syntax.v = _45_432.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _145_466; FStar_Absyn_Syntax.p = _45_432.FStar_Absyn_Syntax.p}))
...
let _45_564 = (let _145_521 = (normalize_refinement [] env wl t1)
...
in (FStar_All.pipe_right _145_552 (FStar_Util.for_some (fun _45_625 -> (match (_45_625) with
| (uvt, _45_624) -> begin
...
let _45_1234 = (let _145_785 = (FStar_List.map (sub_prob scope args) components)
...
in {lhs = _145_892; relation = _45_1527.relation; rhs = _145_891; element = _45_1527.element; logical_guard = _45_1527.logical_guard; scope = _45_1527.scope; reason = _45_1527.reason; loc = _45_1527.loc; rank = _45_1527.rank})))
...
in {lhs = _145_896; relation = _45_1531.relation; rhs = _145_895; element = _45_1531.element; logical_guard = _45_1531.logical_guard; scope = _45_1531.scope; reason = _45_1531.reason; loc = _45_1531.loc; rank = _45_1531.rank})))
...
in {lhs = _145_900; relation = _45_1535.relation; rhs = _145_899; element = _45_1535.element; logical_guard = _45_1535.logical_guard; scope = _45_1535.scope; reason = _45_1535.reason; loc = _45_1535.loc; rank = _45_1535.rank})))
...
let _45_1570 = kp
in {lhs = _45_1570.lhs; relation = _45_1570.relation; rhs = _45_1570.rhs; element = _45_1570.element; logical_guard = _45_1570.logical_guard; scope = _45_1570.scope; reason = _45_1570.reason; loc = _45_1570.loc; rank = Some (rank)}) (fun _145_908 -> KProb (_145_908)))
in ((rank), (_145_909))))
end
| TProb (tp) -> begin
(
...
in {lhs = _45_1614.lhs; relation = _45_1614.relation; rhs = _145_910; element = _45_1614.element; logical_guard = _45_1614.logical_guard; scope = _45_1614.scope; reason = _45_1614.reason; loc = _45_1614.loc; rank = _45_1614.rank}))
in ((rank), (_145_911))))
end)
end))
end
...
in {lhs = _145_912; relation = _45_1628.relation; rhs = _45_1628.rhs; element = _45_1628.element; logical_guard = _45_1628.logical_guard; scope = _45_1628.scope; reason = _45_1628.reason; loc = _45_1628.loc; rank = _45_1628.rank}))
...
let _45_1638 = tp
in {lhs = _45_1638.lhs; relation = _45_1638.relation; rhs = _45_1638.rhs; element = _45_1638.element; logical_guard = _45_1638.logical_guard; scope = _45_1638.scope; reason = _45_1638.reason; loc = _45_1638.loc; rank = Some (rank)}) (fun _145_914 -> TProb (_145_914)))
in ((rank), (_145_915)))
end))
end))
end))
...
let _45_1675 = ep
in {lhs = _45_1675.lhs; relation = _45_1675.relation; rhs = _45_1675.rhs; element = _45_1675.element; logical_guard = _45_1675.logical_guard; scope = _45_1675.scope; reason = _45_1675.reason; loc = _45_1675.loc; rank = Some (rank)}) (fun _145_916 -> EProb (_145_916)))
in ((rank), (_145_917))))
end))
end))
end
...
let _45_1679 = cp
in {lhs = _45_1679.lhs; relation = _45_1679.relation; rhs = _45_1679.rhs; element = _45_1679.element; logical_guard = _45_1679.logical_guard; scope = _45_1679.scope; reason = _45_1679.reason; loc = _45_1679.loc; rank = Some (rigid_rigid)}) (fun _145_918 -> CProb (_145_918)))
...
(match (attempt) with
| [] -> begin
(let _145_1010 = (let _145_1009 = (let _145_1008 = (FStar_List.map (fun _45_1905 -> (match (_45_1905) with
| (_45_1902, x, y) -> begin
((x), (y))
...
let _45_1908 = probs
in (let _145_1012 = (FStar_All.pipe_right attempt (FStar_List.map (fun _45_1915 -> (match (_45_1915) with
| (_45_1911, _45_1913, y) -> begin
y
end))))
in {attempting = _145_1012; wl_deferred = rest; subst = _45_1908.subst; ctr = _45_1908.ctr; slack_vars = _45_1908.slack_vars; defer_ok = _45_1908.defer_ok; smt_ok = _45_1908.smt_ok; tcenv = _45_1908.tcenv}))
...
in (let _145_1157 = (let _145_1156 = (FStar_List.map (fun _45_2271 -> (match (_45_2271) with
...
in {lhs = _145_1452; relation = _45_3079.relation; rhs = _45_3079.rhs; element = _45_3079.element; logical_guard = _45_3079.logical_guard; scope = _45_3079.scope; reason = _45_3079.reason; loc = _45_3079.loc; rank = _45_3079.rank}))
...
in {lhs = _45_3088.lhs; relation = _45_3088.relation; rhs = _145_1454; element = _45_3088.element; logical_guard = _45_3088.logical_guard; scope = _45_3088.scope; reason = _45_3088.reason; loc = _45_3088.loc; rank = _45_3088.rank}))
...
let _45_3215 = (let _145_1526 = (FStar_All.pipe_right args2 (FStar_List.map (fun _45_34 -> (match (_45_34) with
...
let _45_3373 = (let _145_1575 = (FStar_Tc_Env.get_range env)
...
let _45_3390 = (let _145_1583 = (FStar_Tc_Env.get_range env)
...
in {lhs = _145_1605; relation = _45_3612.relation; rhs = _45_3612.rhs; element = _45_3612.element; logical_guard = _45_3612.logical_guard; scope = _45_3612.scope; reason = _45_3612.reason; loc = _45_3612.loc; rank = _45_3612.rank}))
...
in {lhs = _45_3633.lhs; relation = _45_3633.relation; rhs = _145_1607; element = _45_3633.element; logical_guard = _45_3633.logical_guard; scope = _45_3633.scope; reason = _45_3633.reason; loc = _45_3633.loc; rank = _45_3633.rank}))
...
let _45_3665 = (let _145_1621 = (FStar_Tc_Env.get_range env)
...
in {lhs = _145_1636; relation = _45_3748.relation; rhs = _45_3748.rhs; element = _45_3748.element; logical_guard = _45_3748.logical_guard; scope = _45_3748.scope; reason = _45_3748.reason; loc = _45_3748.loc; rank = _45_3748.rank}))
...
in {lhs = _45_3756.lhs; relation = _45_3756.relation; rhs = _145_1638; element = _45_3756.element; logical_guard = _45_3756.logical_guard; scope = _45_3756.scope; reason = _45_3756.reason; loc = _45_3756.loc; rank = _45_3756.rank}))
...
let _45_3765 = (let _145_1641 = (FStar_Tc_Env.get_range env)
...
let carry = (let _145_1652 = (FStar_List.map (fun _45_3778 -> (match (_45_3778) with
| (_45_3776, x) -> begin
...
in {guard_f = _145_1668; deferred = _45_3809.deferred; implicits = _45_3809.implicits}))
in Some (_145_1669)))
end))
...
in {guard_f = _145_1681; deferred = _45_3816.deferred; implicits = _45_3816.implicits}))
end))
...
in {guard_f = _145_1726; deferred = _45_3866.deferred; implicits = _45_3866.implicits}))
end))
...
in (let _145_1803 = (solve_and_commit env (singleton env prob) (fun _45_3941 -> None))
...
let res = (let _145_1839 = (let _145_1838 = (solve_and_commit env (singleton env prob) (fun _45_3963 -> (let _145_1837 = (let _145_1836 = (let _145_1835 = (FStar_Tc_Errors.incompatible_kinds env k1 k2)
...
let g = (let _145_1852 = (solve_and_commit env (singleton env prob) (fun _45_3972 -> None))
...
let g = (let _145_1887 = (solve_and_commit env (singleton env prob) (fun _45_4002 -> None))
...
in (let _145_1917 = (solve_and_commit env (singleton env prob) (fun _45_4023 -> None))
...
(let _145_1930 = (let _145_1929 = (FStar_All.pipe_right g.deferred.carry (FStar_List.map (fun _45_4034 -> (match (_45_4034) with
| (msg, x) -> begin
