...
open Prims
# 39 "rel.fs"
let new_kvar : FStar_Range.range  ->  FStar_Absyn_Syntax.binders  ->  ((FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax * (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.uvar_basis FStar_Unionfind.uvar) = (fun r binders -> (
# 40 "rel.fs"
...
# 43 "rel.fs"
let new_tvar : FStar_Range.range  ->  FStar_Absyn_Syntax.binder Prims.list  ->  FStar_Absyn_Syntax.knd  ->  ((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax * (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) = (fun r binders k -> (
# 44 "rel.fs"
let binders = (FStar_All.pipe_right binders (FStar_List.filter (fun x -> (FStar_All.pipe_right (FStar_Absyn_Syntax.is_null_binder x) Prims.op_Negation))))
in (
# 45 "rel.fs"
...
# 56 "rel.fs"
let new_evar : FStar_Range.range  ->  FStar_Absyn_Syntax.binder Prims.list  ->  FStar_Absyn_Syntax.typ  ->  ((FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax * (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) = (fun r binders t -> (
# 57 "rel.fs"
let binders = (FStar_All.pipe_right binders (FStar_List.filter (fun x -> (FStar_All.pipe_right (FStar_Absyn_Syntax.is_null_binder x) Prims.op_Negation))))
in (
# 58 "rel.fs"
...
in (
# 65 "rel.fs"
let t' = (let _152_24 = (let _152_23 = (FStar_Absyn_Syntax.mk_Total t)
in (binders, _152_23))
...
# 270 "rel.fs"
let solve_prob' : Prims.bool  ->  prob  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax Prims.option  ->  uvi Prims.list  ->  worklist  ->  worklist = (fun resolve_ok prob logical_guard uvis wl -> (
# 271 "rel.fs"
...
# 314 "rel.fs"
let _50_316 = (empty_worklist env)
...
# 315 "rel.fs"
let _50_320 = (empty_worklist env)
...
# 322 "rel.fs"
let _50_342 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
# 382 "rel.fs"
let t = (let _152_462 = (FStar_Absyn_Util.unmeta_typ t)
...
in (
# 495 "rel.fs"
let _50_651 = (occurs_check env wl uk t)
...
in (
# 657 "rel.fs"
let fail = (fun _50_913 -> (match (()) with
| () -> begin
(MisMatch, None)
end))
in (
...
# 674 "rel.fs"
let fail = (fun _50_929 -> (match (()) with
| () -> begin
...
in (
# 683 "rel.fs"
let rec mk_b_ktecs = (fun _50_974 _50_21 -> (match (_50_974) with
...
# 696 "rel.fs"
let fail = (fun _50_993 -> (match (()) with
| () -> begin
(FStar_All.failwith "Bad reconstruction")
end))
in (
...
in (
# 730 "rel.fs"
let b_ktecs = (FStar_All.pipe_right args (FStar_List.map (fun _50_24 -> (match (_50_24) with
...
in (
# 777 "rel.fs"
let _50_1141 = (new_tvar r scope k)
...
in (
# 784 "rel.fs"
let _50_1152 = (new_evar r scope t)
...
in (
# 807 "rel.fs"
let _50_1226 = (let _152_755 = (FStar_List.map (sub_prob scope args) components)
...
# 1046 "rel.fs"
let _50_1285 = (FStar_All.pipe_left destruct_flex_t (Prims.snd slack.lower))
...
in (
# 1049 "rel.fs"
let _50_1295 = (fix_slack_uv (uh, kh) true)
in (
# 1050 "rel.fs"
let _50_1297 = (FStar_ST.op_Colon_Equals slack.flag true)
in (FStar_Absyn_Util.mk_conj (Prims.fst slack.lower) (Prims.fst slack.upper)))))
end))
end)))

# 1053 "rel.fs"
let new_slack_var : FStar_Tc_Env.env  ->  slack  ->  (((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax * (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) * FStar_Absyn_Syntax.binders) = (fun env slack -> (
# 1054 "rel.fs"
let xs = (let _152_795 = (let _152_794 = (destruct_flex_pattern env (Prims.snd slack.lower))
...
# 1058 "rel.fs"
let _50_1310 = (new_tvar p xs FStar_Absyn_Syntax.ktype)
...
in (
# 1060 "rel.fs"
let _50_1314 = (new_tvar p xs FStar_Absyn_Syntax.ktype)
...
in (
# 1105 "rel.fs"
let hi = (let _152_833 = (compress env wl phi2)
...
# 1168 "rel.fs"
let prob = (let _152_877 = (compress_prob wl prob)
...
in (let _152_879 = (FStar_All.pipe_right (
# 1177 "rel.fs"
let _50_1562 = kp
...
| (rank, tp) -> begin
(let _152_885 = (FStar_All.pipe_right (
# 1209 "rel.fs"
let _50_1630 = tp
...
in (let _152_887 = (FStar_All.pipe_right (
# 1219 "rel.fs"
let _50_1667 = ep
...
| CProb (cp) -> begin
(let _152_889 = (FStar_All.pipe_right (
# 1221 "rel.fs"
let _50_1671 = cp
...
# 1227 "rel.fs"
let rec aux = (fun _50_1678 probs -> (match (_50_1678) with
...
# 1245 "rel.fs"
let _50_1697 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 1247 "rel.fs"
let _50_1701 = (FStar_Absyn_Util.head_and_args tp.lhs)
...
# 1252 "rel.fs"
let _50_1716 = (FStar_Absyn_Util.head_and_args t1)
...
in (
# 1346 "rel.fs"
let _50_1847 = (FStar_List.fold_left (fun wl p -> (solve_prob' true p None [] wl)) wl upper_bounds)
in Some (wl))))
end
| _50_1850 -> begin
None
...
in (
# 1396 "rel.fs"
let env = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.binding_of_binder hd2))
in (
# 1397 "rel.fs"
...
in (
# 1432 "rel.fs"
let imitate_k = (fun _50_2024 -> (match (_50_2024) with
...
in (
# 1437 "rel.fs"
let _50_2029 = (imitation_sub_probs orig env xs ps qs)
...
in (
# 1530 "rel.fs"
let _50_2189 = (imitation_sub_probs orig env xs ps qs)
...
in (
# 1532 "rel.fs"
let _50_2191 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
let rec gs = (fun k -> (
# 1550 "rel.fs"
let _50_2214 = (FStar_Absyn_Util.kind_formals k)
...
in (
# 1557 "rel.fs"
let _50_2227 = (new_tvar r xs k_a)
...
in (
# 1565 "rel.fs"
let _50_2236 = (new_evar r xs t_x)
...
in (
# 1580 "rel.fs"
let proj = (let _152_1116 = (let _152_1115 = (FStar_Absyn_Syntax.mk_Typ_app' (xi, g_xs) (Some (FStar_Absyn_Syntax.ktype)) r)
in (xs, _152_1115))
in (FStar_Absyn_Syntax.mk_Typ_lam _152_1116 None r))
in (
# 1581 "rel.fs"
let sub = (let _152_1122 = (let _152_1121 = (FStar_Absyn_Syntax.mk_Typ_app' (proj, ps) (Some (FStar_Absyn_Syntax.ktype)) r)
...
in (
# 1583 "rel.fs"
let _50_2265 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 1584 "rel.fs"
let wl = (let _152_1126 = (let _152_1125 = (FStar_All.pipe_left Prims.fst (p_guard sub))
in Some (_152_1125))
...
let subterms = (fun ps -> (
# 1593 "rel.fs"
let xs = (let _152_1155 = (FStar_Absyn_Util.kind_formals k)
...
# 1609 "rel.fs"
let _50_2307 = (FStar_Absyn_Util.head_and_args t2)
...
# 1621 "rel.fs"
let fvs_hd = (let _152_1175 = (let _152_1174 = (FStar_Absyn_Util.head_and_args t2)
...
in (
# 1632 "rel.fs"
let _50_2333 = (occurs_check env wl (uv, k) t2)
...
in (
# 1661 "rel.fs"
let _50_2345 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 1694 "rel.fs"
let _50_2369 = (new_tvar t.FStar_Absyn_Syntax.pos ys kk)
...
in (
# 1704 "rel.fs"
let _50_2394 = (match ((pat_var_opt env ys hd)) with
| None -> begin
...
in (
# 1722 "rel.fs"
let solve_both_pats = (fun wl _50_2400 _50_2404 k r -> (match ((_50_2400, _50_2404)) with
...
in (
# 1734 "rel.fs"
let _50_2417 = (occurs_check env wl (u1, k1) sub1)
...
in (
# 1742 "rel.fs"
let _50_2423 = (occurs_check env wl (u2, k2) sub2)
...
in (
# 1749 "rel.fs"
let solve_one_pat = (fun _50_2431 _50_2436 -> (match ((_50_2431, _50_2436)) with
...
in (
# 1760 "rel.fs"
let guard = (let _152_1241 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
...
in (
# 1766 "rel.fs"
let _50_2463 = (occurs_check env wl (u1, k1) t2)
...
in (
# 1775 "rel.fs"
let _50_2476 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
...
in (
# 1796 "rel.fs"
let _50_2515 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("QuasiPattern"))) then begin
...
in (
# 1812 "rel.fs"
let match_num_binders = (fun _50_2529 _50_2532 -> (match ((_50_2529, _50_2532)) with
| ((bs1, mk_cod1), (bs2, mk_cod2)) -> begin
(
# 1814 "rel.fs"
let curry = (fun n bs mk_cod -> (
# 1815 "rel.fs"
let _50_2539 = (FStar_Util.first_N n bs)
...
in (
# 1839 "rel.fs"
let _50_2570 = (match_num_binders (bs1, (mk_c c1)) (bs2, (mk_c c2)))
...
in (
# 1845 "rel.fs"
let _50_2576 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("EQ"))) then begin
...
in (
# 1853 "rel.fs"
let _50_2598 = (match_num_binders (bs1, (mk_t t1')) (bs2, (mk_t t2')))
...
in (
# 1864 "rel.fs"
let x1_for_x2 = (FStar_Absyn_Util.mk_subst_one_binder (FStar_Absyn_Syntax.v_binder x1) (FStar_Absyn_Syntax.v_binder x2))
in (
# 1865 "rel.fs"
let phi2 = (FStar_Absyn_Util.subst_typ x1_for_x2 phi2)
in (
# 1866 "rel.fs"
let mk_imp = (fun imp phi1 phi2 -> (let _152_1339 = (imp phi1 phi2)
in (FStar_All.pipe_right _152_1339 (guard_on_element problem x1))))
in (
# 1867 "rel.fs"
let fallback = (fun _50_2624 -> (match (()) with
| () -> begin
(
# 1868 "rel.fs"
...
in (
# 1872 "rel.fs"
let guard = (let _152_1342 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
...
(let _152_1354 = (FStar_All.pipe_left (fun _152_1352 -> TProb (_152_1352)) (
# 1914 "rel.fs"
let _50_2800 = problem
...
(match (ref_opt) with
| None -> begin
(let _152_1357 = (FStar_All.pipe_left (fun _152_1355 -> TProb (_152_1355)) (
# 1918 "rel.fs"
let _50_2806 = problem
...
in (
# 1923 "rel.fs"
let base_prob = (let _152_1359 = (mk_problem problem.scope orig t1 new_rel y.FStar_Absyn_Syntax.sort problem.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _152_1358 -> TProb (_152_1358)) _152_1359))
in (
# 1925 "rel.fs"
let guard = (let _152_1360 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
...
in (
# 1956 "rel.fs"
let head2 = (let _152_1364 = (FStar_Absyn_Util.head_and_args t2)
...
in (
# 1971 "rel.fs"
let _50_2939 = (FStar_Absyn_Util.head_and_args t1)
...
in (
# 2003 "rel.fs"
let formula = (let _152_1389 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
...
# 2030 "rel.fs"
let _50_3033 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("EQ"))) then begin
...
in (
# 2036 "rel.fs"
let guard = (let _152_1408 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
...
in (
# 2064 "rel.fs"
let _50_3093 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2080 "rel.fs"
let _50_3143 = (match ((c1.FStar_Absyn_Syntax.effect_args, c2.FStar_Absyn_Syntax.effect_args)) with
...
in (
# 2096 "rel.fs"
let base_prob = (let _152_1447 = (sub_prob c1.FStar_Absyn_Syntax.result_typ problem.relation c2.FStar_Absyn_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _152_1446 -> TProb (_152_1446)) _152_1447))
in (
# 2097 "rel.fs"
let wl = (let _152_1451 = (let _152_1450 = (let _152_1449 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
...
in (
# 2113 "rel.fs"
let _50_3173 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2115 "rel.fs"
let flex_rigid = (fun _50_3180 e2 -> (match (_50_3180) with
...
# 2120 "rel.fs"
let _50_3207 = (let _152_1477 = (FStar_All.pipe_right args2 (FStar_List.map (fun _50_34 -> (match (_50_34) with
...
in (
# 2123 "rel.fs"
let _50_3194 = (new_tvar t.FStar_Absyn_Syntax.pos xs kk)
...
in (
# 2128 "rel.fs"
let _50_3203 = (new_evar v.FStar_Absyn_Syntax.pos xs tt)
...
# 2139 "rel.fs"
let giveup = (fun reason -> (let _152_1486 = (FStar_Util.format1 "flex-rigid: refusing to project expressions (%s)" reason)
...
in (
# 2158 "rel.fs"
let _50_3278 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2169 "rel.fs"
let imitate_or_project_e = (fun _50_3292 -> (match (()) with
| () -> begin
if wl.defer_ok then begin
...
in (
# 2178 "rel.fs"
let _50_3297 = (FStar_Absyn_Util.head_and_args_e e2)
...
in (
# 2180 "rel.fs"
let _50_3302 = (occurs_check_e env (u1, t1) head2)
...
in (
# 2191 "rel.fs"
let _50_3320 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2205 "rel.fs"
let _50_3332 = (occurs_check_e env (u1, t1) e2)
...
in (
# 2216 "rel.fs"
let flex_flex = (fun _50_3339 _50_3344 -> (match ((_50_3339, _50_3344)) with
...
in (
# 2236 "rel.fs"
let _50_3365 = (new_evar (FStar_Tc_Env.get_range env) zs tt)
...
in (
# 2249 "rel.fs"
let _50_3382 = (let _152_1532 = (FStar_Tc_Env.binders env)
...
(let _152_1568 = (solve_prob orig None wl.subst (
# 2311 "rel.fs"
let _50_3650 = orig_wl
...
in (let _152_1571 = (solve_prob orig (Some (guard)) wl.subst (
# 2315 "rel.fs"
let _50_3659 = orig_wl
...
in (
# 2331 "rel.fs"
let rec match_head_and_args = (fun head1 head2 -> (match ((let _152_1583 = (let _152_1580 = (FStar_Absyn_Util.compress_exp head1)
...
in (
# 2348 "rel.fs"
let _50_3759 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2373 "rel.fs"
let carry = (let _152_1624 = (FStar_List.map (fun _50_3777 -> (match (_50_3777) with
| (_50_3775, x) -> begin
...
# 2449 "rel.fs"
let x = (FStar_Absyn_Util.gen_bvar_p (FStar_Tc_Env.get_range env) t1)
in (
# 2450 "rel.fs"
let env = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, x.FStar_Absyn_Syntax.sort))))
in (
# 2451 "rel.fs"
let p = (let _152_1714 = (let _152_1713 = (FStar_Absyn_Util.bvar_to_exp x)
...
# 2489 "rel.fs"
let _50_3937 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2491 "rel.fs"
let prob = (let _152_1763 = (let _152_1762 = (FStar_Tc_Normalize.norm_kind ((FStar_Tc_Normalize.Beta)::[]) env k1)
...
# 2507 "rel.fs"
let _50_3959 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2509 "rel.fs"
let prob = (let _152_1792 = (let _152_1791 = (whnf_k env k1)
...
in (
# 2510 "rel.fs"
let res = (let _152_1798 = (let _152_1797 = (solve_and_commit env (singleton env prob) (fun _50_3962 -> (let _152_1796 = (let _152_1795 = (let _152_1794 = (FStar_Tc_Errors.incompatible_kinds env k1 k2)
...
# 2517 "rel.fs"
let try_teq : FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  guard_t Prims.option = (fun env t1 t2 -> (
# 2518 "rel.fs"
let _50_3968 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2520 "rel.fs"
let prob = (let _152_1808 = (new_t_problem env t1 EQ t2 None (FStar_Tc_Env.get_range env))
in (FStar_All.pipe_left (fun _152_1807 -> TProb (_152_1807)) _152_1808))
in (
# 2521 "rel.fs"
let g = (let _152_1810 = (solve_and_commit env (singleton env prob) (fun _50_3971 -> None))
...
# 2532 "rel.fs"
let kopt = (fun _50_35 -> (match (_50_35) with
| None -> begin
"None"
end
| Some (t) -> begin
...
in (
# 2535 "rel.fs"
let k = (fun t1 -> (match ((let _152_1833 = (FStar_Absyn_Util.compress_typ t1)
...
in (
# 2538 "rel.fs"
let _50_3996 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2544 "rel.fs"
let _50_4000 = (new_t_prob env t1 SUB t2)
...
in (
# 2546 "rel.fs"
let _50_4004 = if ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) && (FStar_Util.is_some g)) then begin
...
# 2560 "rel.fs"
let _50_4018 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
...
in (
# 2563 "rel.fs"
let prob = (let _152_1870 = (new_problem env c1 rel c2 None (FStar_Tc_Env.get_range env) "sub_comp")
...
# 2567 "rel.fs"
let fail = (fun _50_4029 -> (match (_50_4029) with
| (d, s) -> begin
(
# 2568 "rel.fs"
...
in (
# 2570 "rel.fs"
let _50_4034 = if ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) && ((FStar_List.length g.deferred.carry) <> 0)) then begin
...
in (
# 2577 "rel.fs"
let gopt = (let _152_1886 = (wl_of_guard env g.deferred)
