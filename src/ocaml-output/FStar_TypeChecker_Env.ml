          ...
          FStar_All.pipe_right qix
            (FStar_List.tryFind
               (fun uu____1221  ->
                  ...
                  | (m,uu____1225) -> FStar_Ident.lid_equals l m))
           in
...
let inst_tscheme :
  ...
  fun uu___95_1342  ->
    ...
    | (us,t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu____1356  -> new_u_univ ()))
           in
      ...
      let mapper uu___98_1988 =
        ...
        | FStar_Util.Inr
            ...
            then
              ...
              (if uu____2050
               then
                 let uu____2055 = inst_tscheme (uvs, t)  in Some uu____2055
               else None)
        ...
        | FStar_Util.Inr se ->
            (match se with
             ...
             | uu____2203 -> effect_signature (Prims.fst se))
         in
      let uu____2208 =
                          ...
                          let uu____2779 =
                            let uu____2780 =
                              FStar_Syntax_Util.unascribe
                               ...
                               in
                            FStar_Syntax_Subst.set_use_range
                              (FStar_Ident.range_of_lid lid) uu____2780
                             in
    ...
    fun l  ->
      let rec find l =
        ...
        | Some (uu____3054,c) ->
            ...
            (match uu____3059 with | None  -> Some l | Some l' -> Some l')
         in
      let res =
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect (sub,uu____3823) ->
          ...
          let mk_mlift_wp lift_t r wp1 =
            ...
            | (uu____3960,lift_t) ->
                ...
                uu____3962 None wp1.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_wp =
          ...
          let mk_mlift_term lift_t r wp1 e =
            ...
            | (uu____4031,lift_t) ->
                ...
                uu____4033 None e.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_term =
              ...
              let uu____4104 =
                FStar_Util.map_opt l.mlift_term
                  (fun l  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____4119)
                 in
          ...
          (FStar_All.pipe_right order
           ...
           (let joins =
            ...
            let effects =
              ...
              { decls = (uu___116_4378.decls); order; joins }  in
                     ...
                     let uu____4438 =
                       let uu____4441 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____4442 uu____4448 uu____4456
                          in
          ...
          let uu____4669 =
            let uu____4670 =
              let uu____4673 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____4674
                 in
  ...
  fun env  ->
    fun s  ->
      let rec push x rest =
        ...
        | [] -> [x]
        | local::rest -> let uu____4769 = push x rest  in local :: uu____4769
         in
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          ...
          let uu____4994 =
            let uu____4998 = FStar_Syntax_Free.uvars t  in ext out uu____4998
             in
          aux uu____4994 tl
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl ->
          let uu____5054 =
            let uu____5056 = FStar_Syntax_Free.univs t  in ext out uu____5056
             in
          aux uu____5054 tl
