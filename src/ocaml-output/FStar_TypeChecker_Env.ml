...
let new_gamma_cache : 'Auu____13298 . unit -> 'Auu____13298 FStar_Util.smap =
  fun uu____13305  -> FStar_Util.smap_create (Prims.parse_int "100") 
let (initial_env :
               ...
               (let eff_name1 = norm_eff_name env eff_name  in
                ...
                let null_wp =
                  inst_effect_fun_with [res_u] env ed
                   ...
                   in
                let null_wp_res =
                  let uu____22046 = get_range env  in
                  let uu____22047 =
                    let uu____22054 =
                      let uu____22055 =
                        let uu____22072 =
                          let uu____22083 = FStar_Syntax_Syntax.as_arg res_t
                             in
                          [uu____22083]  in
                        (null_wp, uu____22072)  in
                      FStar_Syntax_Syntax.Tm_app uu____22055  in
                    FStar_Syntax_Syntax.mk uu____22054  in
                  uu____22047 FStar_Pervasives_Native.None uu____22046  in
                let uu____22120 =
                  let uu____22121 =
                    let uu____22132 = FStar_Syntax_Syntax.as_arg null_wp_res
                       in
                    [uu____22132]  in
                  {
                    ...
                    FStar_Syntax_Syntax.effect_args = uu____22121;
                    FStar_Syntax_Syntax.flags = []
                  }  in
                FStar_Syntax_Syntax.mk_Comp uu____22120))
...
let (build_lattice : env -> FStar_Syntax_Syntax.sigelt -> env) =
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ne ->
          let effects =
            let uu___1520_22170 = env.effects  in
            {
              decls = ((ne, (se.FStar_Syntax_Syntax.sigquals)) ::
                ((env.effects).decls));
              order = (uu___1520_22170.order);
              joins = (uu___1520_22170.joins)
            }  in
          let uu___1523_22179 = env  in
          {
            solver = (uu___1523_22179.solver);
            range = (uu___1523_22179.range);
            curmodule = (uu___1523_22179.curmodule);
            gamma = (uu___1523_22179.gamma);
            gamma_sig = (uu___1523_22179.gamma_sig);
            gamma_cache = (uu___1523_22179.gamma_cache);
            modules = (uu___1523_22179.modules);
            expected_typ = (uu___1523_22179.expected_typ);
            sigtab = (uu___1523_22179.sigtab);
            attrtab = (uu___1523_22179.attrtab);
            is_pattern = (uu___1523_22179.is_pattern);
            instantiate_imp = (uu___1523_22179.instantiate_imp);
            effects;
            generalize = (uu___1523_22179.generalize);
            letrecs = (uu___1523_22179.letrecs);
            top_level = (uu___1523_22179.top_level);
            check_uvars = (uu___1523_22179.check_uvars);
            use_eq = (uu___1523_22179.use_eq);
            is_iface = (uu___1523_22179.is_iface);
            admit = (uu___1523_22179.admit);
            lax = (uu___1523_22179.lax);
            lax_universes = (uu___1523_22179.lax_universes);
            phase1 = (uu___1523_22179.phase1);
            failhard = (uu___1523_22179.failhard);
            nosynth = (uu___1523_22179.nosynth);
            uvar_subtyping = (uu___1523_22179.uvar_subtyping);
            tc_term = (uu___1523_22179.tc_term);
            type_of = (uu___1523_22179.type_of);
            universe_of = (uu___1523_22179.universe_of);
            check_type_of = (uu___1523_22179.check_type_of);
            use_bv_sorts = (uu___1523_22179.use_bv_sorts);
            qtbl_name_and_index = (uu___1523_22179.qtbl_name_and_index);
            normalized_eff_names = (uu___1523_22179.normalized_eff_names);
            fv_delta_depths = (uu___1523_22179.fv_delta_depths);
            proof_ns = (uu___1523_22179.proof_ns);
            synth_hook = (uu___1523_22179.synth_hook);
            try_solve_implicits_hook =
              (uu___1523_22179.try_solve_implicits_hook);
            splice = (uu___1523_22179.splice);
            postprocess = (uu___1523_22179.postprocess);
            is_native_tactic = (uu___1523_22179.is_native_tactic);
            identifier_info = (uu___1523_22179.identifier_info);
            tc_hooks = (uu___1523_22179.tc_hooks);
            dsenv = (uu___1523_22179.dsenv);
            nbe = (uu___1523_22179.nbe);
            strict_args_tab = (uu___1523_22179.strict_args_tab)
          }
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
          let compose_edges e1 e2 =
            let composed_lift =
              let mlift_wp u r wp1 =
                let uu____22209 = (e1.mlift).mlift_wp u r wp1  in
                (e2.mlift).mlift_wp u r uu____22209  in
              let mlift_term =
                    ...
                    FStar_Pervasives_Native.Some
                      ((fun u  ->
                          fun t  ->
                            fun wp  ->
                              fun e  ->
                                let uu____22367 = (e1.mlift).mlift_wp u t wp
                                   in
                                let uu____22368 = l1 u t wp e  in
                                l2 u t uu____22367 uu____22368))
                | uu____22369 -> FStar_Pervasives_Native.None  in
          ...
          let mk_mlift_wp lift_t u r wp1 =
            let uu____22441 = inst_tscheme_with lift_t [u]  in
            ...
            | (uu____22448,lift_t1) ->
                let uu____22450 =
                  let uu____22457 =
                    let uu____22458 =
                      let uu____22475 =
                        let uu____22486 = FStar_Syntax_Syntax.as_arg r  in
                        let uu____22495 =
                          let uu____22506 = FStar_Syntax_Syntax.as_arg wp1
                             in
                          [uu____22506]  in
                        uu____22486 :: uu____22495  in
                      (lift_t1, uu____22475)  in
                    FStar_Syntax_Syntax.Tm_app uu____22458  in
                  FStar_Syntax_Syntax.mk uu____22457  in
                uu____22450 FStar_Pervasives_Native.None
          ...
          let mk_mlift_term lift_t u r wp1 e =
            let uu____22616 = inst_tscheme_with lift_t [u]  in
            ...
            | (uu____22623,lift_t1) ->
                let uu____22625 =
                  let uu____22632 =
                    let uu____22633 =
                      let uu____22650 =
                        let uu____22661 = FStar_Syntax_Syntax.as_arg r  in
                        let uu____22670 =
                          let uu____22681 = FStar_Syntax_Syntax.as_arg wp1
                             in
                          let uu____22690 =
                            let uu____22701 = FStar_Syntax_Syntax.as_arg e
                               in
                            [uu____22701]  in
                          uu____22681 :: uu____22690  in
                        uu____22661 :: uu____22670  in
                      (lift_t1, uu____22650)  in
                    FStar_Syntax_Syntax.Tm_app uu____22633  in
                  FStar_Syntax_Syntax.mk uu____22632  in
                uu____22625 FStar_Pervasives_Native.None
          ...
          let print_mlift l =
            let bogus_term s =
              let uu____22803 =
                ...
                FStar_Syntax_Syntax.lid_as_fv uu____22804
                  FStar_Syntax_Syntax.delta_constant
                  FStar_Pervasives_Native.None
                 in
              FStar_Syntax_Syntax.fv_to_tm uu____22803  in
            let arg = bogus_term "ARG"  in
            let wp = bogus_term "WP"  in
            let e = bogus_term "COMP"  in
            let uu____22813 =
              let uu____22815 = l.mlift_wp FStar_Syntax_Syntax.U_zero arg wp
                 in
              FStar_Syntax_Print.term_to_string uu____22815  in
            let uu____22816 =
              let uu____22818 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     let uu____22846 = l1 FStar_Syntax_Syntax.U_zero arg wp e
                        in
                     FStar_Syntax_Print.term_to_string uu____22846)
                 in
              FStar_Util.dflt "none" uu____22818  in
            FStar_Util.format2 "{ wp : %s ; term : %s }" uu____22813
              uu____22816
             in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____22875  ->
                    ...
                    | (e,uu____22883) -> e.FStar_Syntax_Syntax.mname))
             in
          let find_edge order1 uu____22906 =
            match uu____22906 with
            | (i,j) ->
                let uu____22917 = FStar_Ident.lid_equals i j  in
                if uu____22917
                then
                  FStar_All.pipe_right (id_edge i)
                    (fun _22924  -> FStar_Pervasives_Native.Some _22924)
                else
            ...
            let fold_fun order1 k =
              let uu____22953 =
                FStar_All.pipe_right ms
                  (FStar_List.collect
                     (fun i  ->
                        let uu____22963 = FStar_Ident.lid_equals i k  in
                        if uu____22963
                        then []
                        else
                          FStar_All.pipe_right ms
                               ...
                               (fun j  ->
                                  ...
                                  then []
                                    ...
                                    (let uu____22984 =
                                     ...
                                     | uu____23012 -> [])))))
                 in
              FStar_List.append order1 uu____22953  in
                   ...
                   then
                     let uu____23052 =
                       ...
                       (FStar_Errors.Fatal_DivergentComputationCannotBeIncludedInTotal,
                         uu____23058)
                        in
                     let uu____23062 = get_range env  in
                     FStar_Errors.raise_error uu____23052 uu____23062
                   else ()));
           (let joins =
              FStar_All.pipe_right ms
                (FStar_List.collect
                   (fun i  ->
                      FStar_All.pipe_right ms
                        (FStar_List.collect
                           (fun j  ->
                              let join_opt =
                                let uu____23140 = FStar_Ident.lid_equals i j
                                   in
                                if uu____23140
                                then
                                  FStar_Pervasives_Native.Some
               ...
               in
            let effects =
              let uu___1650_23401 = env.effects  in
              { decls = (uu___1650_23401.decls); order = order2; joins }  in
            let uu___1653_23402 = env  in
            {
              solver = (uu___1653_23402.solver);
              range = (uu___1653_23402.range);
              curmodule = (uu___1653_23402.curmodule);
              gamma = (uu___1653_23402.gamma);
              gamma_sig = (uu___1653_23402.gamma_sig);
              gamma_cache = (uu___1653_23402.gamma_cache);
              modules = (uu___1653_23402.modules);
              expected_typ = (uu___1653_23402.expected_typ);
              sigtab = (uu___1653_23402.sigtab);
              attrtab = (uu___1653_23402.attrtab);
              is_pattern = (uu___1653_23402.is_pattern);
              instantiate_imp = (uu___1653_23402.instantiate_imp);
              effects;
              generalize = (uu___1653_23402.generalize);
              letrecs = (uu___1653_23402.letrecs);
              top_level = (uu___1653_23402.top_level);
              check_uvars = (uu___1653_23402.check_uvars);
              use_eq = (uu___1653_23402.use_eq);
              is_iface = (uu___1653_23402.is_iface);
              admit = (uu___1653_23402.admit);
              lax = (uu___1653_23402.lax);
              lax_universes = (uu___1653_23402.lax_universes);
              phase1 = (uu___1653_23402.phase1);
              failhard = (uu___1653_23402.failhard);
              nosynth = (uu___1653_23402.nosynth);
              uvar_subtyping = (uu___1653_23402.uvar_subtyping);
              tc_term = (uu___1653_23402.tc_term);
              type_of = (uu___1653_23402.type_of);
              universe_of = (uu___1653_23402.universe_of);
              check_type_of = (uu___1653_23402.check_type_of);
              use_bv_sorts = (uu___1653_23402.use_bv_sorts);
              qtbl_name_and_index = (uu___1653_23402.qtbl_name_and_index);
              normalized_eff_names = (uu___1653_23402.normalized_eff_names);
              fv_delta_depths = (uu___1653_23402.fv_delta_depths);
              proof_ns = (uu___1653_23402.proof_ns);
              synth_hook = (uu___1653_23402.synth_hook);
              try_solve_implicits_hook =
                (uu___1653_23402.try_solve_implicits_hook);
              splice = (uu___1653_23402.splice);
              postprocess = (uu___1653_23402.postprocess);
              is_native_tactic = (uu___1653_23402.is_native_tactic);
              identifier_info = (uu___1653_23402.identifier_info);
              tc_hooks = (uu___1653_23402.tc_hooks);
              dsenv = (uu___1653_23402.dsenv);
              nbe = (uu___1653_23402.nbe);
              strict_args_tab = (uu___1653_23402.strict_args_tab)
            }))
      | uu____23403 -> env
  ...
  fun env  ->
    fun comp  ->
      ...
      | FStar_Pervasives_Native.Some (binders,cdef) ->
          let uu____23462 = FStar_Syntax_Subst.open_comp binders cdef  in
           ...
           | (binders1,cdef1) ->
               (if
                     ...
                     let uu____23493 =
                       ...
                       let uu____23503 =
                         FStar_Util.string_of_int
                          ...
                          in
                       let uu____23514 =
                         let uu____23516 = FStar_Syntax_Syntax.mk_Comp c  in
                         FStar_Syntax_Print.comp_to_string uu____23516  in
                       FStar_Util.format3
                         "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s"
                         uu____23495 uu____23503 uu____23514
                        in
                     (FStar_Errors.Fatal_ConstructorArgLengthMismatch,
                       uu____23493)
                      in
                   FStar_Errors.raise_error uu____23487
                ...
                (let inst1 =
                   let uu____23524 =
                     let uu____23535 =
                       FStar_Syntax_Syntax.as_arg
                        ...
                        in
                     uu____23535 :: (c.FStar_Syntax_Syntax.effect_args)  in
                   FStar_List.map2
                     (fun uu____23572  ->
                        fun uu____23573  ->
                          match (uu____23572, uu____23573) with
                          | ((x,uu____23603),(t,uu____23605)) ->
                 ...
                 let c2 =
                   let uu____23636 =
                     let uu___1691_23637 = comp_to_comp_typ env c1  in
                     {
                       FStar_Syntax_Syntax.comp_univs =
                         (uu___1691_23637.FStar_Syntax_Syntax.comp_univs);
                       FStar_Syntax_Syntax.effect_name =
                         (uu___1691_23637.FStar_Syntax_Syntax.effect_name);
                       FStar_Syntax_Syntax.result_typ =
                         (uu___1691_23637.FStar_Syntax_Syntax.result_typ);
                       FStar_Syntax_Syntax.effect_args =
                         (uu___1691_23637.FStar_Syntax_Syntax.effect_args);
                       FStar_Syntax_Syntax.flags =
    ...
    fun env  ->
      fun c  ->
        fun u_c  ->
          ...
          let uu____23679 = effect_decl_opt env effect_name  in
               ...
               | uu____23718 ->
                         ...
                         let message =
                           let uu____23780 =
                             FStar_Util.format1
                              ...
                              in
                           Prims.op_Hat uu____23780
                             (Prims.op_Hat
                                "This usually happens when you use a partially applied DM4F effect, "
                                "like [TAC int] instead of [Tac int].")
                            in
                         let uu____23785 = get_range env  in
                   ...
                   let repr =
                     inst_effect_fun_with [u_c] env ed
                      ...
                      in
                   let uu____23800 =
                     let uu____23803 = get_range env  in
                     let uu____23804 =
                       let uu____23811 =
                         let uu____23812 =
                           let uu____23829 =
                             ...
                             [uu____23840; wp]  in
                           (repr, uu____23829)  in
                         FStar_Syntax_Syntax.Tm_app uu____23812  in
                       FStar_Syntax_Syntax.mk uu____23811  in
                     uu____23804 FStar_Pervasives_Native.None uu____23803  in
                   FStar_Pervasives_Native.Some uu____23800)
...
let (is_reifiable_function : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun env  ->
    fun t  ->
      let uu____23999 =
        let uu____24000 = FStar_Syntax_Subst.compress t  in
        uu____24000.FStar_Syntax_Syntax.n  in
      match uu____23999 with
      | FStar_Syntax_Syntax.Tm_arrow (uu____24004,c) ->
  ...
  fun env  ->
    fun c  ->
      fun u_c  ->
        ...
        (let uu____24046 =
           let uu____24048 = is_reifiable_effect env l  in
           Prims.op_Negation uu____24048  in
         if uu____24046
         then
           let uu____24051 =
             let uu____24057 =
               let uu____24059 = FStar_Ident.string_of_lid l  in
               FStar_Util.format1 "Effect %s cannot be reified" uu____24059
                in
             (FStar_Errors.Fatal_EffectCannotBeReified, uu____24057)  in
           let uu____24063 = get_range env  in
           FStar_Errors.raise_error uu____24051 uu____24063
         else ());
        (let uu____24066 = effect_repr_aux true env c u_c  in
...
let (push_sigelt : env -> FStar_Syntax_Syntax.sigelt -> env) =
  fun env  ->
    fun s  ->
      ...
      let env1 =
        let uu___1756_24102 = env  in
        {
          solver = (uu___1756_24102.solver);
          range = (uu___1756_24102.range);
          curmodule = (uu___1756_24102.curmodule);
          gamma = (uu___1756_24102.gamma);
          gamma_sig = (sb :: (env.gamma_sig));
          gamma_cache = (uu___1756_24102.gamma_cache);
          modules = (uu___1756_24102.modules);
          expected_typ = (uu___1756_24102.expected_typ);
          sigtab = (uu___1756_24102.sigtab);
          attrtab = (uu___1756_24102.attrtab);
          is_pattern = (uu___1756_24102.is_pattern);
          instantiate_imp = (uu___1756_24102.instantiate_imp);
          effects = (uu___1756_24102.effects);
          generalize = (uu___1756_24102.generalize);
          letrecs = (uu___1756_24102.letrecs);
          top_level = (uu___1756_24102.top_level);
          check_uvars = (uu___1756_24102.check_uvars);
          use_eq = (uu___1756_24102.use_eq);
          is_iface = (uu___1756_24102.is_iface);
          admit = (uu___1756_24102.admit);
          lax = (uu___1756_24102.lax);
          lax_universes = (uu___1756_24102.lax_universes);
          phase1 = (uu___1756_24102.phase1);
          failhard = (uu___1756_24102.failhard);
          nosynth = (uu___1756_24102.nosynth);
          uvar_subtyping = (uu___1756_24102.uvar_subtyping);
          tc_term = (uu___1756_24102.tc_term);
          type_of = (uu___1756_24102.type_of);
          universe_of = (uu___1756_24102.universe_of);
          check_type_of = (uu___1756_24102.check_type_of);
          use_bv_sorts = (uu___1756_24102.use_bv_sorts);
          qtbl_name_and_index = (uu___1756_24102.qtbl_name_and_index);
          normalized_eff_names = (uu___1756_24102.normalized_eff_names);
          fv_delta_depths = (uu___1756_24102.fv_delta_depths);
          proof_ns = (uu___1756_24102.proof_ns);
          synth_hook = (uu___1756_24102.synth_hook);
          try_solve_implicits_hook =
            (uu___1756_24102.try_solve_implicits_hook);
          splice = (uu___1756_24102.splice);
          postprocess = (uu___1756_24102.postprocess);
          is_native_tactic = (uu___1756_24102.is_native_tactic);
          identifier_info = (uu___1756_24102.identifier_info);
          tc_hooks = (uu___1756_24102.tc_hooks);
          dsenv = (uu___1756_24102.dsenv);
          nbe = (uu___1756_24102.nbe);
          strict_args_tab = (uu___1756_24102.strict_args_tab)
        }  in
      add_sigelt env1 s;
...
let (push_local_binding : env -> FStar_Syntax_Syntax.binding -> env) =
  fun env  ->
    fun b  ->
      let uu___1763_24116 = env  in
      {
        solver = (uu___1763_24116.solver);
        range = (uu___1763_24116.range);
        curmodule = (uu___1763_24116.curmodule);
        gamma = (b :: (env.gamma));
        gamma_sig = (uu___1763_24116.gamma_sig);
        gamma_cache = (uu___1763_24116.gamma_cache);
        modules = (uu___1763_24116.modules);
        expected_typ = (uu___1763_24116.expected_typ);
        sigtab = (uu___1763_24116.sigtab);
        attrtab = (uu___1763_24116.attrtab);
        is_pattern = (uu___1763_24116.is_pattern);
        instantiate_imp = (uu___1763_24116.instantiate_imp);
        effects = (uu___1763_24116.effects);
        generalize = (uu___1763_24116.generalize);
        letrecs = (uu___1763_24116.letrecs);
        top_level = (uu___1763_24116.top_level);
        check_uvars = (uu___1763_24116.check_uvars);
        use_eq = (uu___1763_24116.use_eq);
        is_iface = (uu___1763_24116.is_iface);
        admit = (uu___1763_24116.admit);
        lax = (uu___1763_24116.lax);
        lax_universes = (uu___1763_24116.lax_universes);
        phase1 = (uu___1763_24116.phase1);
        failhard = (uu___1763_24116.failhard);
        nosynth = (uu___1763_24116.nosynth);
        uvar_subtyping = (uu___1763_24116.uvar_subtyping);
        tc_term = (uu___1763_24116.tc_term);
        type_of = (uu___1763_24116.type_of);
        universe_of = (uu___1763_24116.universe_of);
        check_type_of = (uu___1763_24116.check_type_of);
        use_bv_sorts = (uu___1763_24116.use_bv_sorts);
        qtbl_name_and_index = (uu___1763_24116.qtbl_name_and_index);
        normalized_eff_names = (uu___1763_24116.normalized_eff_names);
        fv_delta_depths = (uu___1763_24116.fv_delta_depths);
        proof_ns = (uu___1763_24116.proof_ns);
        synth_hook = (uu___1763_24116.synth_hook);
        try_solve_implicits_hook = (uu___1763_24116.try_solve_implicits_hook);
        splice = (uu___1763_24116.splice);
        postprocess = (uu___1763_24116.postprocess);
        is_native_tactic = (uu___1763_24116.is_native_tactic);
        identifier_info = (uu___1763_24116.identifier_info);
        tc_hooks = (uu___1763_24116.tc_hooks);
        dsenv = (uu___1763_24116.dsenv);
        nbe = (uu___1763_24116.nbe);
        strict_args_tab = (uu___1763_24116.strict_args_tab)
      }
...
let (pop_bv :
  ...
  fun env  ->
    ...
    | (FStar_Syntax_Syntax.Binding_var x)::rest ->
        FStar_Pervasives_Native.Some
          (x,
            (let uu___1776_24174 = env  in
             {
               solver = (uu___1776_24174.solver);
               range = (uu___1776_24174.range);
               curmodule = (uu___1776_24174.curmodule);
               gamma = rest;
               gamma_sig = (uu___1776_24174.gamma_sig);
               gamma_cache = (uu___1776_24174.gamma_cache);
               modules = (uu___1776_24174.modules);
               expected_typ = (uu___1776_24174.expected_typ);
               sigtab = (uu___1776_24174.sigtab);
               attrtab = (uu___1776_24174.attrtab);
               is_pattern = (uu___1776_24174.is_pattern);
               instantiate_imp = (uu___1776_24174.instantiate_imp);
               effects = (uu___1776_24174.effects);
               generalize = (uu___1776_24174.generalize);
               letrecs = (uu___1776_24174.letrecs);
               top_level = (uu___1776_24174.top_level);
               check_uvars = (uu___1776_24174.check_uvars);
               use_eq = (uu___1776_24174.use_eq);
               is_iface = (uu___1776_24174.is_iface);
               admit = (uu___1776_24174.admit);
               lax = (uu___1776_24174.lax);
               lax_universes = (uu___1776_24174.lax_universes);
               phase1 = (uu___1776_24174.phase1);
               failhard = (uu___1776_24174.failhard);
               nosynth = (uu___1776_24174.nosynth);
               uvar_subtyping = (uu___1776_24174.uvar_subtyping);
               tc_term = (uu___1776_24174.tc_term);
               type_of = (uu___1776_24174.type_of);
               universe_of = (uu___1776_24174.universe_of);
               check_type_of = (uu___1776_24174.check_type_of);
               use_bv_sorts = (uu___1776_24174.use_bv_sorts);
               qtbl_name_and_index = (uu___1776_24174.qtbl_name_and_index);
               normalized_eff_names = (uu___1776_24174.normalized_eff_names);
               fv_delta_depths = (uu___1776_24174.fv_delta_depths);
               proof_ns = (uu___1776_24174.proof_ns);
               synth_hook = (uu___1776_24174.synth_hook);
               try_solve_implicits_hook =
                 (uu___1776_24174.try_solve_implicits_hook);
               splice = (uu___1776_24174.splice);
               postprocess = (uu___1776_24174.postprocess);
               is_native_tactic = (uu___1776_24174.is_native_tactic);
               identifier_info = (uu___1776_24174.identifier_info);
               tc_hooks = (uu___1776_24174.tc_hooks);
               dsenv = (uu___1776_24174.dsenv);
               nbe = (uu___1776_24174.nbe);
               strict_args_tab = (uu___1776_24174.strict_args_tab)
             }))
    | uu____24175 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env1  ->
           fun uu____24204  ->
             match uu____24204 with | (x,uu____24212) -> push_bv env1 x) env
        bs
...
let (binding_of_lb :
  ...
  fun x  ->
    fun t  ->
      ...
      | FStar_Util.Inl x1 ->
          let x2 =
            let uu___1790_24247 = x1  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___1790_24247.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___1790_24247.FStar_Syntax_Syntax.index);
...
let (push_module : env -> FStar_Syntax_Syntax.modul -> env) =
  fun env  ->
    fun m  ->
      ...
      (let uu___1801_24289 = env  in
       {
         solver = (uu___1801_24289.solver);
         range = (uu___1801_24289.range);
         curmodule = (uu___1801_24289.curmodule);
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___1801_24289.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = FStar_Pervasives_Native.None;
         sigtab = (uu___1801_24289.sigtab);
         attrtab = (uu___1801_24289.attrtab);
         is_pattern = (uu___1801_24289.is_pattern);
         instantiate_imp = (uu___1801_24289.instantiate_imp);
         effects = (uu___1801_24289.effects);
         generalize = (uu___1801_24289.generalize);
         letrecs = (uu___1801_24289.letrecs);
         top_level = (uu___1801_24289.top_level);
         check_uvars = (uu___1801_24289.check_uvars);
         use_eq = (uu___1801_24289.use_eq);
         is_iface = (uu___1801_24289.is_iface);
         admit = (uu___1801_24289.admit);
         lax = (uu___1801_24289.lax);
         lax_universes = (uu___1801_24289.lax_universes);
         phase1 = (uu___1801_24289.phase1);
         failhard = (uu___1801_24289.failhard);
         nosynth = (uu___1801_24289.nosynth);
         uvar_subtyping = (uu___1801_24289.uvar_subtyping);
         tc_term = (uu___1801_24289.tc_term);
         type_of = (uu___1801_24289.type_of);
         universe_of = (uu___1801_24289.universe_of);
         check_type_of = (uu___1801_24289.check_type_of);
         use_bv_sorts = (uu___1801_24289.use_bv_sorts);
         qtbl_name_and_index = (uu___1801_24289.qtbl_name_and_index);
         normalized_eff_names = (uu___1801_24289.normalized_eff_names);
         fv_delta_depths = (uu___1801_24289.fv_delta_depths);
         proof_ns = (uu___1801_24289.proof_ns);
         synth_hook = (uu___1801_24289.synth_hook);
         try_solve_implicits_hook =
           (uu___1801_24289.try_solve_implicits_hook);
         splice = (uu___1801_24289.splice);
         postprocess = (uu___1801_24289.postprocess);
         is_native_tactic = (uu___1801_24289.is_native_tactic);
         identifier_info = (uu___1801_24289.identifier_info);
         tc_hooks = (uu___1801_24289.tc_hooks);
         dsenv = (uu___1801_24289.dsenv);
         nbe = (uu___1801_24289.nbe);
         strict_args_tab = (uu___1801_24289.strict_args_tab)
       })
...
let (open_universes_in :
  ...
  fun env  ->
    fun uvs  ->
      fun terms  ->
        let uu____24333 = FStar_Syntax_Subst.univ_var_opening uvs  in
        match uu____24333 with
        | (univ_subst,univ_vars) ->
            let env' = push_univ_vars env univ_vars  in
            let uu____24361 =
              FStar_List.map (FStar_Syntax_Subst.subst univ_subst) terms  in
            (env', univ_vars, uu____24361)
  
let (set_expected_typ : env -> FStar_Syntax_Syntax.typ -> env) =
  fun env  ->
    fun t  ->
      let uu___1816_24377 = env  in
      {
        solver = (uu___1816_24377.solver);
        range = (uu___1816_24377.range);
        curmodule = (uu___1816_24377.curmodule);
        gamma = (uu___1816_24377.gamma);
        gamma_sig = (uu___1816_24377.gamma_sig);
        gamma_cache = (uu___1816_24377.gamma_cache);
        modules = (uu___1816_24377.modules);
        expected_typ = (FStar_Pervasives_Native.Some t);
        sigtab = (uu___1816_24377.sigtab);
        attrtab = (uu___1816_24377.attrtab);
        is_pattern = (uu___1816_24377.is_pattern);
        instantiate_imp = (uu___1816_24377.instantiate_imp);
        effects = (uu___1816_24377.effects);
        generalize = (uu___1816_24377.generalize);
        letrecs = (uu___1816_24377.letrecs);
        top_level = (uu___1816_24377.top_level);
        check_uvars = (uu___1816_24377.check_uvars);
        use_eq = false;
        is_iface = (uu___1816_24377.is_iface);
        admit = (uu___1816_24377.admit);
        lax = (uu___1816_24377.lax);
        lax_universes = (uu___1816_24377.lax_universes);
        phase1 = (uu___1816_24377.phase1);
        failhard = (uu___1816_24377.failhard);
        nosynth = (uu___1816_24377.nosynth);
        uvar_subtyping = (uu___1816_24377.uvar_subtyping);
        tc_term = (uu___1816_24377.tc_term);
        type_of = (uu___1816_24377.type_of);
        universe_of = (uu___1816_24377.universe_of);
        check_type_of = (uu___1816_24377.check_type_of);
        use_bv_sorts = (uu___1816_24377.use_bv_sorts);
        qtbl_name_and_index = (uu___1816_24377.qtbl_name_and_index);
        normalized_eff_names = (uu___1816_24377.normalized_eff_names);
        fv_delta_depths = (uu___1816_24377.fv_delta_depths);
        proof_ns = (uu___1816_24377.proof_ns);
        synth_hook = (uu___1816_24377.synth_hook);
        try_solve_implicits_hook = (uu___1816_24377.try_solve_implicits_hook);
        splice = (uu___1816_24377.splice);
        postprocess = (uu___1816_24377.postprocess);
        is_native_tactic = (uu___1816_24377.is_native_tactic);
        identifier_info = (uu___1816_24377.identifier_info);
        tc_hooks = (uu___1816_24377.tc_hooks);
        dsenv = (uu___1816_24377.dsenv);
        nbe = (uu___1816_24377.nbe);
        strict_args_tab = (uu___1816_24377.strict_args_tab)
      }
...
let (clear_expected_typ :
  ...
  fun env_  ->
    let uu____24408 = expected_typ env_  in
    ((let uu___1823_24414 = env_  in
      {
        solver = (uu___1823_24414.solver);
        range = (uu___1823_24414.range);
        curmodule = (uu___1823_24414.curmodule);
        gamma = (uu___1823_24414.gamma);
        gamma_sig = (uu___1823_24414.gamma_sig);
        gamma_cache = (uu___1823_24414.gamma_cache);
        modules = (uu___1823_24414.modules);
        expected_typ = FStar_Pervasives_Native.None;
        sigtab = (uu___1823_24414.sigtab);
        attrtab = (uu___1823_24414.attrtab);
        is_pattern = (uu___1823_24414.is_pattern);
        instantiate_imp = (uu___1823_24414.instantiate_imp);
        effects = (uu___1823_24414.effects);
        generalize = (uu___1823_24414.generalize);
        letrecs = (uu___1823_24414.letrecs);
        top_level = (uu___1823_24414.top_level);
        check_uvars = (uu___1823_24414.check_uvars);
        use_eq = false;
        is_iface = (uu___1823_24414.is_iface);
        admit = (uu___1823_24414.admit);
        lax = (uu___1823_24414.lax);
        lax_universes = (uu___1823_24414.lax_universes);
        phase1 = (uu___1823_24414.phase1);
        failhard = (uu___1823_24414.failhard);
        nosynth = (uu___1823_24414.nosynth);
        uvar_subtyping = (uu___1823_24414.uvar_subtyping);
        tc_term = (uu___1823_24414.tc_term);
        type_of = (uu___1823_24414.type_of);
        universe_of = (uu___1823_24414.universe_of);
        check_type_of = (uu___1823_24414.check_type_of);
        use_bv_sorts = (uu___1823_24414.use_bv_sorts);
        qtbl_name_and_index = (uu___1823_24414.qtbl_name_and_index);
        normalized_eff_names = (uu___1823_24414.normalized_eff_names);
        fv_delta_depths = (uu___1823_24414.fv_delta_depths);
        proof_ns = (uu___1823_24414.proof_ns);
        synth_hook = (uu___1823_24414.synth_hook);
        try_solve_implicits_hook = (uu___1823_24414.try_solve_implicits_hook);
        splice = (uu___1823_24414.splice);
        postprocess = (uu___1823_24414.postprocess);
        is_native_tactic = (uu___1823_24414.is_native_tactic);
        identifier_info = (uu___1823_24414.identifier_info);
        tc_hooks = (uu___1823_24414.tc_hooks);
        dsenv = (uu___1823_24414.dsenv);
        nbe = (uu___1823_24414.nbe);
        strict_args_tab = (uu___1823_24414.strict_args_tab)
      }), uu____24408)
  
let (finish_module : env -> FStar_Syntax_Syntax.modul -> env) =
  let empty_lid =
    let uu____24426 =
      let uu____24429 = FStar_Ident.id_of_text ""  in [uu____24429]  in
    FStar_Ident.lid_of_ids uu____24426  in
  fun env  ->
    fun m  ->
      let sigs =
        let uu____24436 =
        ...
        then
          let uu____24441 =
            FStar_All.pipe_right env.gamma_sig
             ...
             in
          FStar_All.pipe_right uu____24441 FStar_List.rev
        else m.FStar_Syntax_Syntax.exports  in
      add_sigelts env sigs;
      (let uu___1831_24469 = env  in
       {
         solver = (uu___1831_24469.solver);
         range = (uu___1831_24469.range);
         curmodule = empty_lid;
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___1831_24469.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = (uu___1831_24469.expected_typ);
         sigtab = (uu___1831_24469.sigtab);
         attrtab = (uu___1831_24469.attrtab);
         is_pattern = (uu___1831_24469.is_pattern);
         instantiate_imp = (uu___1831_24469.instantiate_imp);
         effects = (uu___1831_24469.effects);
         generalize = (uu___1831_24469.generalize);
         letrecs = (uu___1831_24469.letrecs);
         top_level = (uu___1831_24469.top_level);
         check_uvars = (uu___1831_24469.check_uvars);
         use_eq = (uu___1831_24469.use_eq);
         is_iface = (uu___1831_24469.is_iface);
         admit = (uu___1831_24469.admit);
         lax = (uu___1831_24469.lax);
         lax_universes = (uu___1831_24469.lax_universes);
         phase1 = (uu___1831_24469.phase1);
         failhard = (uu___1831_24469.failhard);
         nosynth = (uu___1831_24469.nosynth);
         uvar_subtyping = (uu___1831_24469.uvar_subtyping);
         tc_term = (uu___1831_24469.tc_term);
         type_of = (uu___1831_24469.type_of);
         universe_of = (uu___1831_24469.universe_of);
         check_type_of = (uu___1831_24469.check_type_of);
         use_bv_sorts = (uu___1831_24469.use_bv_sorts);
         qtbl_name_and_index = (uu___1831_24469.qtbl_name_and_index);
         normalized_eff_names = (uu___1831_24469.normalized_eff_names);
         fv_delta_depths = (uu___1831_24469.fv_delta_depths);
         proof_ns = (uu___1831_24469.proof_ns);
         synth_hook = (uu___1831_24469.synth_hook);
         try_solve_implicits_hook =
           (uu___1831_24469.try_solve_implicits_hook);
         splice = (uu___1831_24469.splice);
         postprocess = (uu___1831_24469.postprocess);
         is_native_tactic = (uu___1831_24469.is_native_tactic);
         identifier_info = (uu___1831_24469.identifier_info);
         tc_hooks = (uu___1831_24469.tc_hooks);
         dsenv = (uu___1831_24469.dsenv);
         nbe = (uu___1831_24469.nbe);
         strict_args_tab = (uu___1831_24469.strict_args_tab)
       })
...
let (uvars_in_env : env -> FStar_Syntax_Syntax.uvars) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____24521)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____24525,(uu____24526,t)))::tl1
          ->
          let uu____24547 =
            let uu____24550 = FStar_Syntax_Free.uvars t  in
            ext out uu____24550  in
          aux uu____24547 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____24553;
            FStar_Syntax_Syntax.index = uu____24554;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____24562 =
            let uu____24565 = FStar_Syntax_Free.uvars t  in
            ext out uu____24565  in
          aux uu____24562 tl1
       in
...
let (univ_vars : env -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____24623)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____24627,(uu____24628,t)))::tl1
          ->
          let uu____24649 =
            let uu____24652 = FStar_Syntax_Free.univs t  in
            ext out uu____24652  in
          aux uu____24649 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____24655;
            FStar_Syntax_Syntax.index = uu____24656;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____24664 =
            let uu____24667 = FStar_Syntax_Free.univs t  in
            ext out uu____24667  in
          aux uu____24664 tl1
       in
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (FStar_Syntax_Syntax.Binding_univ uname)::tl1 ->
          let uu____24729 = FStar_Util.set_add uname out  in
          aux uu____24729 tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____24732,(uu____24733,t)))::tl1
          ->
          let uu____24754 =
            let uu____24757 = FStar_Syntax_Free.univnames t  in
            ext out uu____24757  in
          aux uu____24754 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____24760;
            FStar_Syntax_Syntax.index = uu____24761;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____24769 =
            let uu____24772 = FStar_Syntax_Free.univnames t  in
            ext out uu____24772  in
          aux uu____24769 tl1
       in
...
let (bound_vars_of_bindings :
  ...
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.collect
         (fun uu___11_24793  ->
            match uu___11_24793 with
            | FStar_Syntax_Syntax.Binding_var x -> [x]
            | FStar_Syntax_Syntax.Binding_lid uu____24797 -> []
            | FStar_Syntax_Syntax.Binding_univ uu____24810 -> []))
  
let (binders_of_bindings :
  FStar_Syntax_Syntax.binding Prims.list -> FStar_Syntax_Syntax.binders) =
  fun bs  ->
    let uu____24821 =
      let uu____24830 = bound_vars_of_bindings bs  in
      FStar_All.pipe_right uu____24830
        (FStar_List.map FStar_Syntax_Syntax.mk_binder)
       in
    FStar_All.pipe_right uu____24821 FStar_List.rev
  ...
  fun gamma  ->
    let uu____24878 =
      FStar_All.pipe_right gamma
        (FStar_List.map
           (fun uu___12_24891  ->
              match uu___12_24891 with
              | FStar_Syntax_Syntax.Binding_var x ->
                  let uu____24894 = FStar_Syntax_Print.bv_to_string x  in
                  Prims.op_Hat "Binding_var " uu____24894
              | FStar_Syntax_Syntax.Binding_univ u ->
                  Prims.op_Hat "Binding_univ " u.FStar_Ident.idText
              | FStar_Syntax_Syntax.Binding_lid (l,uu____24900) ->
                  let uu____24917 = FStar_Ident.string_of_lid l  in
                  Prims.op_Hat "Binding_lid " uu____24917))
       in
    FStar_All.pipe_right uu____24878 (FStar_String.concat "::\n")
  
let (string_of_delta_level : delta_level -> Prims.string) =
  fun uu___13_24931  ->
    match uu___13_24931 with
    | NoDelta  -> "NoDelta"
    | InliningDelta  -> "Inlining"
    | Eager_unfolding_only  -> "Eager_unfolding_only"
    | Unfold d ->
        let uu____24937 = FStar_Syntax_Print.delta_depth_to_string d  in
        Prims.op_Hat "Unfold " uu____24937
  ...
  fun env  ->
    fun path  ->
      let rec str_i_prefix xs ys =
        ...
        | (uu____25048,uu____25049) -> false  in
      let uu____25063 =
        FStar_List.tryFind
          (fun uu____25085  ->
             match uu____25085 with | (p,uu____25096) -> str_i_prefix p path)
          env.proof_ns
         in
      match uu____25063 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____25115,b) -> b
  
let (should_enc_lid : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____25145 = FStar_Ident.path_of_lid lid  in
      should_enc_path env uu____25145
  
let (cons_proof_ns : Prims.bool -> env -> name_prefix -> env) =
  fun b  ->
    fun e  ->
      fun path  ->
        let uu___1974_25167 = e  in
        {
          solver = (uu___1974_25167.solver);
          range = (uu___1974_25167.range);
          curmodule = (uu___1974_25167.curmodule);
          gamma = (uu___1974_25167.gamma);
          gamma_sig = (uu___1974_25167.gamma_sig);
          gamma_cache = (uu___1974_25167.gamma_cache);
          modules = (uu___1974_25167.modules);
          expected_typ = (uu___1974_25167.expected_typ);
          sigtab = (uu___1974_25167.sigtab);
          attrtab = (uu___1974_25167.attrtab);
          is_pattern = (uu___1974_25167.is_pattern);
          instantiate_imp = (uu___1974_25167.instantiate_imp);
          effects = (uu___1974_25167.effects);
          generalize = (uu___1974_25167.generalize);
          letrecs = (uu___1974_25167.letrecs);
          top_level = (uu___1974_25167.top_level);
          check_uvars = (uu___1974_25167.check_uvars);
          use_eq = (uu___1974_25167.use_eq);
          is_iface = (uu___1974_25167.is_iface);
          admit = (uu___1974_25167.admit);
          lax = (uu___1974_25167.lax);
          lax_universes = (uu___1974_25167.lax_universes);
          phase1 = (uu___1974_25167.phase1);
          failhard = (uu___1974_25167.failhard);
          nosynth = (uu___1974_25167.nosynth);
          uvar_subtyping = (uu___1974_25167.uvar_subtyping);
          tc_term = (uu___1974_25167.tc_term);
          type_of = (uu___1974_25167.type_of);
          universe_of = (uu___1974_25167.universe_of);
          check_type_of = (uu___1974_25167.check_type_of);
          use_bv_sorts = (uu___1974_25167.use_bv_sorts);
          qtbl_name_and_index = (uu___1974_25167.qtbl_name_and_index);
          normalized_eff_names = (uu___1974_25167.normalized_eff_names);
          fv_delta_depths = (uu___1974_25167.fv_delta_depths);
          proof_ns = ((path, b) :: (e.proof_ns));
          synth_hook = (uu___1974_25167.synth_hook);
          try_solve_implicits_hook =
            (uu___1974_25167.try_solve_implicits_hook);
          splice = (uu___1974_25167.splice);
          postprocess = (uu___1974_25167.postprocess);
          is_native_tactic = (uu___1974_25167.is_native_tactic);
          identifier_info = (uu___1974_25167.identifier_info);
          tc_hooks = (uu___1974_25167.tc_hooks);
          dsenv = (uu___1974_25167.dsenv);
          nbe = (uu___1974_25167.nbe);
          strict_args_tab = (uu___1974_25167.strict_args_tab)
        }
...
let (set_proof_ns : proof_namespace -> env -> env) =
  fun ns  ->
    fun e  ->
      let uu___1983_25215 = e  in
      {
        solver = (uu___1983_25215.solver);
        range = (uu___1983_25215.range);
        curmodule = (uu___1983_25215.curmodule);
        gamma = (uu___1983_25215.gamma);
        gamma_sig = (uu___1983_25215.gamma_sig);
        gamma_cache = (uu___1983_25215.gamma_cache);
        modules = (uu___1983_25215.modules);
        expected_typ = (uu___1983_25215.expected_typ);
        sigtab = (uu___1983_25215.sigtab);
        attrtab = (uu___1983_25215.attrtab);
        is_pattern = (uu___1983_25215.is_pattern);
        instantiate_imp = (uu___1983_25215.instantiate_imp);
        effects = (uu___1983_25215.effects);
        generalize = (uu___1983_25215.generalize);
        letrecs = (uu___1983_25215.letrecs);
        top_level = (uu___1983_25215.top_level);
        check_uvars = (uu___1983_25215.check_uvars);
        use_eq = (uu___1983_25215.use_eq);
        is_iface = (uu___1983_25215.is_iface);
        admit = (uu___1983_25215.admit);
        lax = (uu___1983_25215.lax);
        lax_universes = (uu___1983_25215.lax_universes);
        phase1 = (uu___1983_25215.phase1);
        failhard = (uu___1983_25215.failhard);
        nosynth = (uu___1983_25215.nosynth);
        uvar_subtyping = (uu___1983_25215.uvar_subtyping);
        tc_term = (uu___1983_25215.tc_term);
        type_of = (uu___1983_25215.type_of);
        universe_of = (uu___1983_25215.universe_of);
        check_type_of = (uu___1983_25215.check_type_of);
        use_bv_sorts = (uu___1983_25215.use_bv_sorts);
        qtbl_name_and_index = (uu___1983_25215.qtbl_name_and_index);
        normalized_eff_names = (uu___1983_25215.normalized_eff_names);
        fv_delta_depths = (uu___1983_25215.fv_delta_depths);
        proof_ns = ns;
        synth_hook = (uu___1983_25215.synth_hook);
        try_solve_implicits_hook = (uu___1983_25215.try_solve_implicits_hook);
        splice = (uu___1983_25215.splice);
        postprocess = (uu___1983_25215.postprocess);
        is_native_tactic = (uu___1983_25215.is_native_tactic);
        identifier_info = (uu___1983_25215.identifier_info);
        tc_hooks = (uu___1983_25215.tc_hooks);
        dsenv = (uu___1983_25215.dsenv);
        nbe = (uu___1983_25215.nbe);
        strict_args_tab = (uu___1983_25215.strict_args_tab)
      }
...
let (unbound_vars :
  ...
  fun e  ->
    fun t  ->
      let uu____25231 = FStar_Syntax_Free.names t  in
      let uu____25234 = bound_vars e  in
      FStar_List.fold_left (fun s  -> fun bv  -> FStar_Util.set_remove bv s)
        uu____25231 uu____25234
  
let (closed : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun e  ->
    fun t  ->
      let uu____25257 = unbound_vars e t  in
      FStar_Util.set_is_empty uu____25257
  
let (closed' : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____25267 = FStar_Syntax_Free.names t  in
    FStar_Util.set_is_empty uu____25267
    ...
    let aux uu____25288 =
      ...
      | (p,b) ->
          ...
          then "*"
            ...
            (let uu____25308 = FStar_Ident.text_of_path p  in
             Prims.op_Hat (if b then "+" else "-") uu____25308)
       in
    let uu____25316 =
      let uu____25320 = FStar_List.map aux env.proof_ns  in
      FStar_All.pipe_right uu____25320 FStar_List.rev  in
    FStar_All.pipe_right uu____25316 (FStar_String.concat " ")
             ...
             (fun imp  ->
                ((imp.imp_uvar).FStar_Syntax_Syntax.ctx_uvar_should_check =
                  ...
                  (let uu____25390 =
                   ...
                   | FStar_Pervasives_Native.Some uu____25394 -> true
                   | FStar_Pervasives_Native.None  -> false)))
    | uu____25397 -> false
...
let (is_trivial_guard_formula : guard_t -> Prims.bool) =
  fun g  ->
    match g with
    | { guard_f = FStar_TypeChecker_Common.Trivial ; deferred = uu____25407;
        univ_ineqs = uu____25408; implicits = uu____25409;_} -> true
    | uu____25421 -> false
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          let f' =
            FStar_Syntax_Util.abs bs f
             ...
             in
          let uu___2027_25452 = g  in
          {
            guard_f = (FStar_TypeChecker_Common.NonTrivial f');
            deferred = (uu___2027_25452.deferred);
            univ_ineqs = (uu___2027_25452.univ_ineqs);
            implicits = (uu___2027_25452.implicits)
          }
...
let (def_check_vars_in_set :
  ...
  fun rng  ->
    fun msg  ->
      fun vset  ->
        fun t  ->
          let uu____25491 = FStar_Options.defensive ()  in
          if uu____25491
          then
            let s = FStar_Syntax_Free.names t  in
            let uu____25497 =
              let uu____25499 =
                let uu____25501 = FStar_Util.set_difference s vset  in
                FStar_All.pipe_left FStar_Util.set_is_empty uu____25501  in
             ...
             then
               let uu____25508 =
                 let uu____25514 =
                   ...
                   let uu____25518 =
                     let uu____25520 = FStar_Util.set_elements s  in
                     FStar_All.pipe_right uu____25520
                       (FStar_Syntax_Print.bvs_to_string ",\n\t")
                      in
                   FStar_Util.format3
                     "Internal: term is not closed (%s).\nt = (%s)\nFVs = (%s)\n"
                     msg uu____25516 uu____25518
                    in
                 (FStar_Errors.Warning_Defensive, uu____25514)  in
               FStar_Errors.log_issue rng uu____25508
             else ())
          else ()
  ...
  fun rng  ->
    fun msg  ->
      fun l  ->
        fun t  ->
          let uu____25560 =
            let uu____25562 = FStar_Options.defensive ()  in
            Prims.op_Negation uu____25562  in
          if uu____25560
          then ()
          else
            (let uu____25567 =
               FStar_Util.as_set l FStar_Syntax_Syntax.order_bv  in
             def_check_vars_in_set rng msg uu____25567 t)
  ...
  fun rng  ->
    fun msg  ->
      fun e  ->
        fun t  ->
          let uu____25593 =
            let uu____25595 = FStar_Options.defensive ()  in
            Prims.op_Negation uu____25595  in
          if uu____25593
          then ()
          else
            (let uu____25600 = bound_vars e  in
             def_check_closed_in rng msg uu____25600 t)
            ...
            let uu____25641 =
              let uu____25642 =
                let uu____25649 =
                  let uu____25650 =
                    let uu____25667 =
                      let uu____25678 = FStar_Syntax_Syntax.as_arg e  in
                      [uu____25678]  in
                    (f, uu____25667)  in
                  FStar_Syntax_Syntax.Tm_app uu____25650  in
                FStar_Syntax_Syntax.mk uu____25649  in
              uu____25642 FStar_Pervasives_Native.None
                f.FStar_Syntax_Syntax.pos
               in
            FStar_All.pipe_left
              (fun _25715  -> FStar_TypeChecker_Common.NonTrivial _25715)
              uu____25641
             in
          {
            guard_f = uu____25640;
            deferred = (uu___2064_25639.deferred);
            univ_ineqs = (uu___2064_25639.univ_ineqs);
            implicits = (uu___2064_25639.implicits)
          }
...
let (map_guard :
  ...
  fun g  ->
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.Trivial  -> g
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___2071_25733 = g  in
          let uu____25734 =
            let uu____25735 = map1 f  in
            FStar_TypeChecker_Common.NonTrivial uu____25735  in
          {
            guard_f = uu____25734;
            deferred = (uu___2071_25733.deferred);
            univ_ineqs = (uu___2071_25733.univ_ineqs);
            implicits = (uu___2071_25733.implicits)
          }
...
let (always_map_guard :
  ...
  fun g  ->
    fun map1  ->
      match g.guard_f with
      | FStar_TypeChecker_Common.Trivial  ->
          let uu___2076_25752 = g  in
          let uu____25753 =
            let uu____25754 = map1 FStar_Syntax_Util.t_true  in
            FStar_TypeChecker_Common.NonTrivial uu____25754  in
          {
            guard_f = uu____25753;
            deferred = (uu___2076_25752.deferred);
            univ_ineqs = (uu___2076_25752.univ_ineqs);
            implicits = (uu___2076_25752.implicits)
          }
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___2080_25756 = g  in
          let uu____25757 =
            let uu____25758 = map1 f  in
            FStar_TypeChecker_Common.NonTrivial uu____25758  in
          {
            guard_f = uu____25757;
            deferred = (uu___2080_25756.deferred);
            univ_ineqs = (uu___2080_25756.univ_ineqs);
            implicits = (uu___2080_25756.implicits)
          }
...
let (trivial : FStar_TypeChecker_Common.guard_formula -> unit) =
  fun t  ->
    match t with
    | FStar_TypeChecker_Common.Trivial  -> ()
    | FStar_TypeChecker_Common.NonTrivial uu____25765 ->
        failwith "impossible"
    ...
    fun g2  ->
      ...
      | (FStar_TypeChecker_Common.NonTrivial
         f1,FStar_TypeChecker_Common.NonTrivial f2) ->
          let uu____25782 = FStar_Syntax_Util.mk_conj f1 f2  in
          FStar_TypeChecker_Common.NonTrivial uu____25782
  
let (check_trivial :
  FStar_Syntax_Syntax.term -> FStar_TypeChecker_Common.guard_formula) =
  fun t  ->
    let uu____25789 =
      let uu____25790 = FStar_Syntax_Util.unmeta t  in
      uu____25790.FStar_Syntax_Syntax.n  in
    match uu____25789 with
    | FStar_Syntax_Syntax.Tm_fvar tc when
        FStar_Syntax_Syntax.fv_eq_lid tc FStar_Parser_Const.true_lid ->
        FStar_TypeChecker_Common.Trivial
    | uu____25794 -> FStar_TypeChecker_Common.NonTrivial t
...
let (binop_guard :
  ...
  fun f  ->
    fun g1  ->
      fun g2  ->
        let uu____25837 = f g1.guard_f g2.guard_f  in
        {
          guard_f = uu____25837;
            ...
            let f1 =
              FStar_List.fold_right2
                (fun u  ->
                   fun b  ->
                     fun f1  ->
                       let uu____25932 = FStar_Syntax_Syntax.is_null_binder b
                          in
                       if uu____25932
                       then f1
                       else
               ...
               in
            let uu___2135_25939 = g  in
            {
              guard_f = (FStar_TypeChecker_Common.NonTrivial f1);
              deferred = (uu___2135_25939.deferred);
              univ_ineqs = (uu___2135_25939.univ_ineqs);
              implicits = (uu___2135_25939.implicits)
            }
    ...
    fun bs  ->
      fun f  ->
        FStar_List.fold_right
          (fun b  ->
             fun f1  ->
               let uu____25973 = FStar_Syntax_Syntax.is_null_binder b  in
               if uu____25973
               then f1
               else
                 (let u =
  ...
  fun env  ->
    fun binders  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.Trivial  -> g
        | FStar_TypeChecker_Common.NonTrivial f ->
            let uu___2150_26000 = g  in
            let uu____26001 =
              let uu____26002 = close_forall env binders f  in
              FStar_TypeChecker_Common.NonTrivial uu____26002  in
            {
              guard_f = uu____26001;
              deferred = (uu___2150_26000.deferred);
              univ_ineqs = (uu___2150_26000.univ_ineqs);
              implicits = (uu___2150_26000.implicits)
            }
          ...
          fun should_check  ->
            fun meta  ->
              ...
              | uu____26151 ->
                  ...
                  let ctx_uvar =
                    let uu____26169 = FStar_Syntax_Unionfind.fresh ()  in
                    {
                      FStar_Syntax_Syntax.ctx_uvar_head = uu____26169;
                  ...
                  (FStar_TypeChecker_Common.check_uvar_ctx_invariant reason r
                   ...
                   (let t =
                    ...
                    let g =
                      let uu___2172_26201 = trivial_guard  in
                      {
                        guard_f = (uu___2172_26201.guard_f);
                        deferred = (uu___2172_26201.deferred);
                        univ_ineqs = (uu___2172_26201.univ_ineqs);
                        implicits = [imp]
                      }  in
                    (t, [(ctx_uvar, r)], g)))
...
let (dummy_solver : solver_t) =
  {
    init = (fun uu____26219  -> ());
    push = (fun uu____26221  -> ());
    pop = (fun uu____26224  -> ());
    snapshot =
      (fun uu____26227  ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    rollback = (fun uu____26246  -> fun uu____26247  -> ());
    encode_sig = (fun uu____26262  -> fun uu____26263  -> ());
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____26269 =
             let uu____26276 = FStar_Options.peek ()  in (e, g, uu____26276)
              in
           [uu____26269]);
    solve = (fun uu____26292  -> fun uu____26293  -> fun uu____26294  -> ());
    finish = (fun uu____26301  -> ());
    refresh = (fun uu____26303  -> ())
  } 