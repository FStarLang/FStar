            ...
            (match lr with
             ...
             | FStar_Util.Inr se ->
                 (match se with
                  ...
                  | uu____2493 -> effect_signature (Prims.fst se)))
         in
      let uu____2498 =
  ...
  fun env  ->
    fun bv  ->
      ...
      | None  ->
          let uu____2633 =
            let uu____2634 =
              let uu____2637 = variable_not_found bv  in (uu____2637, bvr)
               in
                          ...
                          let uu____3244 =
                            let uu____3245 =
                              FStar_Syntax_Util.unascribe
                               ...
                               in
                            FStar_Syntax_Subst.set_use_range
                              (FStar_Ident.range_of_lid lid) uu____3245
                             in
    ...
    fun l  ->
      let rec find1 l1 =
        ...
        | Some (uu____3560,c) ->
            ...
            (match uu____3565 with | None  -> Some l2 | Some l' -> Some l')
         in
      let res =
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
          ...
          let mk_mlift_wp lift_t r wp1 =
            ...
            | (uu____4573,lift_t1) ->
                ...
                uu____4575 None wp1.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_wp =
          ...
          let mk_mlift_term lift_t r wp1 e =
            ...
            | (uu____4644,lift_t1) ->
                ...
                uu____4646 None e.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_term =
              ...
              let uu____4717 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____4732)
                 in
                     ...
                     let uu____5051 =
                       let uu____5054 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____5055 uu____5061 uu____5069
                          in
          ...
          let uu____5282 =
            let uu____5283 =
              let uu____5286 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____5287
                 in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____5382 = push1 x rest1  in local :: uu____5382
         in
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          ...
          let uu____5626 =
            let uu____5630 = FStar_Syntax_Free.uvars t  in ext out uu____5630
             in
          aux uu____5626 tl1
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl1 ->
          let uu____5686 =
            let uu____5688 = FStar_Syntax_Free.univs t  in ext out uu____5688
             in
          aux uu____5686 tl1
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (Binding_univ uname)::tl1 ->
          let uu____5738 = FStar_Util.set_add uname out  in
          aux uu____5738 tl1
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl1 ->
                ...
                | Binding_sig_inst (ls,uu____5826,uu____5827) ->
                    let uu____5830 =
                      ...
                      FStar_All.pipe_right uu____5831
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____5830))
         in
