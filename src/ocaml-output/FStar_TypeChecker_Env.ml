  ...
  fun env1  ->
    fun lid  ->
      ...
      then found
        ...
        (let uu____17794 = find_in_sigtab env1 lid  in
...
let (lookup_sigelt :
  ...
  fun env1  ->
    fun lid  ->
      let uu____17875 = lookup_qname env1 lid  in
...
let (lookup_attr :
  ...
  fun env1  ->
    fun attr  ->
      let uu____18010 = FStar_Util.smap_try_find (attrtab env1) attr  in
  ...
  fun env1  ->
    fun se  ->
      let add_one env2 se1 attr =
        let uu____18055 =
          let uu____18058 = lookup_attr env2 attr  in se1 :: uu____18058  in
        FStar_Util.smap_add (attrtab env2) attr uu____18055  in
      FStar_List.iter
        (fun attr  ->
           let uu____18068 =
          ...
          | (lr,rng) ->
              (match lr with
               ...
               | FStar_Util.Inr
                   ...
                   ->
                   let uu____18832 =
                     let uu____18834 = in_cur_mod env1 l  in
                     uu____18834 = Yes  in
                   if uu____18832
                   then
                     let uu____18846 =
           ...
           in
        let uu____19316 =
          let uu____19327 = lookup_qname env1 lid  in
...
let (lid_exists : env -> FStar_Ident.lident -> Prims.bool) =
  fun env1  ->
    fun l  ->
      let uu____19472 = lookup_qname env1 l  in
...
let (lookup_bv :
  ...
  fun env1  ->
    fun bv  ->
      ...
      let uu____19547 = try_lookup_bv env1 bv  in
  ...
  fun env1  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some ((us,t),r) ->
          ...
          let r1 =
            let uu____19668 = FStar_Range.use_range use_range  in
            FStar_Range.set_use_range r uu____19668  in
          let uu____19669 =
            let uu____19678 =
              let uu____19683 = FStar_Syntax_Subst.set_use_range use_range t
                 in
              (us, uu____19683)  in
            (uu____19678, r1)  in
    ...
    fun us  ->
      fun l  ->
        ...
        | FStar_Pervasives_Native.Some ((uu____19751,t),r) ->
            let use_range = FStar_Ident.range_of_lid l  in
            let r1 =
              let uu____19776 = FStar_Range.use_range use_range  in
              FStar_Range.set_use_range r uu____19776  in
            let uu____19777 =
              let uu____19782 = FStar_Syntax_Subst.set_use_range use_range t
                 in
              (uu____19782, r1)  in
...
let (lookup_lid :
  ...
  fun env1  ->
    fun l  ->
      let uu____19806 = try_lookup_lid env1 l  in
      ...
      FStar_All.pipe_right
        (FStar_List.find
           (fun uu___5_19882  ->
              ...
              | uu____19886 -> false) env1.gamma) FStar_Option.isSome
...
let (try_lookup_val_decl :
  ...
  fun env1  ->
    fun lid  ->
      let uu____19907 = lookup_qname env1 lid  in
...
let (lookup_val_decl :
  ...
  fun env1  ->
    fun lid  ->
      let uu____20021 = lookup_qname env1 lid  in
...
let (lookup_datacon :
  ...
  fun env1  ->
    fun lid  ->
      let uu____20117 = lookup_qname env1 lid  in
...
let (datacons_of_typ :
  ...
  fun env1  ->
    fun lid  ->
      let uu____20225 = lookup_qname env1 lid  in
...
let (typ_of_datacon : env -> FStar_Ident.lident -> FStar_Ident.lident) =
  fun env1  ->
    fun lid  ->
      let uu____20326 = lookup_qname env1 lid  in
...
let (lookup_definition :
  ...
  fun delta_levels  ->
    fun env1  ->
      fun lid  ->
        let uu____20658 = lookup_qname env1 lid  in
...
let (lookup_nonrec_definition :
  ...
  fun delta_levels  ->
    fun env1  ->
      fun lid  ->
        let uu____20691 = lookup_qname env1 lid  in
        FStar_All.pipe_left
...
let (lookup_attrs_of_lid :
  ...
  fun env1  ->
    fun lid  ->
      let uu____21209 = lookup_qname env1 lid  in
...
let (fv_exists_and_has_attr :
  ...
  fun env1  ->
    fun fv_lid  ->
      fun attr_lid  ->
        let uu____21242 = lookup_attrs_of_lid env1 fv_lid  in
...
let (fv_with_lid_has_attr :
  ...
  fun env1  ->
    fun fv_lid  ->
      fun attr_lid  ->
        let uu____21302 = fv_exists_and_has_attr env1 fv_lid attr_lid  in
...
let rec (non_informative : env -> FStar_Syntax_Syntax.typ -> Prims.bool) =
  fun env1  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (head,uu____21460) ->
    ...
    fun fv  ->
      let f uu____21546 =
        let attrs =
          ...
          lookup_attrs_of_lid env1 uu____21552  in
        match attrs with
        | FStar_Pervasives_Native.None  ->
...
let (try_lookup_effect_lid :
  ...
  fun env1  ->
    fun ftv  ->
      let uu____21637 = lookup_qname env1 ftv  in
...
let (lookup_effect_lid :
  ...
  fun env1  ->
    fun ftv  ->
      let uu____21736 = try_lookup_effect_lid env1 ftv  in
...
let (lookup_effect_abbrev :
  ...
  fun env1  ->
    fun univ_insts  ->
      fun lid0  ->
        let uu____21769 = lookup_qname env1 lid0  in
        ...
        | FStar_Pervasives_Native.Some
            (FStar_Util.Inr
             ({
                FStar_Syntax_Syntax.sigel =
                  FStar_Syntax_Syntax.Sig_effect_abbrev
                  (lid,univs,binders,c,uu____21780);
            ...
            then FStar_Pervasives_Native.None
              ...
              (let insts =
                 ...
                 then univ_insts
                   ...
                   (let uu____21874 =
                      let uu____21876 =
                        let uu____21878 = get_range env1  in
...
let (lookup_effect_quals :
  ...
  fun env1  ->
    fun l  ->
      ...
      let uu____22205 = lookup_qname env1 l1  in
  ...
  fun env1  ->
    fun lid  ->
      fun i  ->
        ...
        let uu____22300 = lookup_datacon env1 lid  in
           ...
           | (binders1,cdef1) ->
               (if
                ...
                (let inst =
                 ...
                 let c2 =
                   let uu____24042 =
                     let uu___1611_24043 = comp_to_comp_typ env1 c1  in
                     {
...
let (push_new_effect :
  ...
  fun env1  ->
    fun uu____24531  ->
      ...
      | (ed,quals) ->
          let effects1 =
            let uu___1697_24545 = env1.effects  in
            {
        ...
        fun st_mlift  ->
                  ...
                  then
                    let uu____25248 =
                      ...
                      (FStar_Errors.Fatal_DivergentComputationCannotBeIncludedInTotal,
                        uu____25254)
                       in
                    let uu____25258 = get_range env1  in
          ...
          (let joins =
             FStar_All.pipe_right ms
              ...
              in
           let effects1 =
             let uu___1821_25680 = env1.effects  in
             {
        ...
        fun p  ->
          fun ty  ->
            let err_msg poly =
              ...
              let uu____25731 = FStar_Ident.string_of_lid n  in
              ...
              FStar_Util.format4
               ...
               in
            let uu____25742 =
              let uu____25744 = exists_polymonadic_bind env1 m n  in
            ...
            then
              let uu____25781 =
                ...
                (FStar_Errors.Fatal_PolymonadicBind_conflict, uu____25787)
                 in
              FStar_Errors.raise_error uu____25781 env1.range
            else
              (let uu____25793 =
                 let uu____25795 = join_opt env1 m n  in
               ...
               then
                 let uu____25820 =
                   ...
                   (FStar_Errors.Fatal_PolymonadicBind_conflict, uu____25826)
                    in
                 FStar_Errors.raise_error uu____25820 env1.range
               else
                 (let uu___1839_25832 = env1  in
                  {
                    ...
                    effects =
                      (let uu___1841_25834 = env1.effects  in
                       {
  ...
  fun env1  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env2  ->
           fun uu____25994  ->
             match uu____25994 with | (x,uu____26002) -> push_bv env2 x) env1
        bs
...
let (uvars_in_env : env -> FStar_Syntax_Syntax.uvars) =
  fun env1  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____26298)::tl -> aux out tl
      | (FStar_Syntax_Syntax.Binding_lid (uu____26302,(uu____26303,t)))::tl
          ->
          let uu____26324 =
...
let (univ_vars : env -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun env1  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____26400)::tl -> aux out tl
  ...
  fun env1  ->
    ...
    let rec aux out g =
      ...
      | (FStar_Syntax_Syntax.Binding_univ uname)::tl ->
          ...
          aux uu____26506 tl
      | (FStar_Syntax_Syntax.Binding_lid (uu____26509,(uu____26510,t)))::tl
          ->
          let uu____26531 =
  ...
  fun env1  ->
    ...
    FStar_Util.smap_fold (sigtab env1)
      (fun uu____26738  ->
         fun v  ->
           fun keys1  ->
             let uu____26744 = FStar_Syntax_Util.lids_of_sigelt v  in
...
let (should_enc_lid : env -> FStar_Ident.lident -> Prims.bool) =
  fun env1  ->
    fun lid  ->
      ...
      should_enc_path env1 uu____26926
  ...
  fun env1  ->
    let aux uu____27069 =
      ...
      | (p,b) ->
       ...
       in
    let uu____27097 =
      let uu____27101 = FStar_List.map aux env1.proof_ns  in
  ...
  fun g  ->
    fun map  ->
      ...
      | FStar_TypeChecker_Common.Trivial  ->
          ...
          let uu____27521 =
            let uu____27522 = map FStar_Syntax_Util.t_true  in
    ...
    fun binders  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu____27679 =
              let uu____27680 = close_forall env1 binders f  in
                      ...
                      fun b  ->
                        ...
                        | (substs1,uvars,g) ->
                            ...
                            let uu____28042 =
                              ...
                              new_implicit_var_aux uu____28055 r env1 sort
                            ...
                            (match uu____28042 with
                             | (t,uu____28072,g_t) ->
                                 ...
                                 (uu____28086, (FStar_List.append uvars [t]),
                                   uu____28111))) (substs, [], trivial_guard))
               in
            FStar_All.pipe_right uu____27943
              (fun uu____28140  ->
                 match uu____28140 with | (uu____28157,uvars,g) -> (uvars, g))
