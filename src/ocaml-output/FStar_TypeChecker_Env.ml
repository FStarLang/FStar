        ...
        Some
          (inst_tscheme
             (let _0_195 =
                ...
                FStar_Syntax_Util.arrow ne.FStar_Syntax_Syntax.binders _0_194 in
    ...
    fun lid  ->
      let mapper uu___96_1864 =
        ...
        | FStar_Util.Inr
            ...
            ->
            let uu____1918 = let _0_198 = in_cur_mod env l in _0_198 = Yes in
            if uu____1918
            then
              let uu____1922 =
                      ...
                      then
                        Some
                          (let _0_224 =
                             ...
                             FStar_Syntax_Subst.set_use_range
                               (FStar_Ident.range_of_lid lid) _0_223 in
                   ...
                   (FStar_Syntax_Syntax.Tm_app
                      (let _0_251 =
                         ...
                         let _0_249 =
                           ...
                           [_0_248] in
                         _0_250 :: _0_249 in
                       (lift_t, _0_251)))) None wp1.FStar_Syntax_Syntax.pos in
          let sub_lift_wp =
                                          ...
                                          then []
                                            ...
                                            (let uu____3699 =
                                             ...
                                             | (Some e1,Some e2) ->
                                                 ...
                                                 [_0_257]
                                             | uu____3711 -> []))))) in
                      FStar_List.append order _0_258) order) in
          let order =
