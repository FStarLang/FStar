    ...
    fun l  ->
      let rec find1 l1 =
        ...
        | Some (uu____3656,c) ->
            ...
            (match uu____3661 with | None  -> Some l2 | Some l' -> Some l')
         in
      let res =
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
          ...
          let mk_mlift_wp lift_t r wp1 =
            ...
            | (uu____4728,lift_t1) ->
                ...
                uu____4730 None wp1.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_wp =
          ...
          let mk_mlift_term lift_t r wp1 e =
            ...
            | (uu____4799,lift_t1) ->
                ...
                uu____4801 None e.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_term =
              ...
              let uu____4872 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____4887)
                 in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____4900  ->
                    ...
                    | (e,uu____4905) -> e.FStar_Syntax_Syntax.mname))
             in
                     ...
                     let uu____5219 =
                       let uu____5222 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____5223 uu____5229 uu____5237
                          in
          ...
          let uu____5462 =
            let uu____5463 =
              let uu____5466 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____5467
                 in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____5571 = push1 x rest1  in local :: uu____5571
         in
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (Binding_lid (uu____5838,(uu____5839,t)))::tl1 ->
          let uu____5848 =
            let uu____5852 = FStar_Syntax_Free.uvars t  in ext out uu____5852
             in
          aux uu____5848 tl1
      | (Binding_var
          ...
          ->
          let uu____5863 =
            let uu____5867 = FStar_Syntax_Free.uvars t  in ext out uu____5867
             in
          aux uu____5863 tl1
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (Binding_lid (uu____5925,(uu____5926,t)))::tl1 ->
          let uu____5935 =
            let uu____5937 = FStar_Syntax_Free.univs t  in ext out uu____5937
             in
          aux uu____5935 tl1
      | (Binding_var
          ...
          ->
          let uu____5946 =
            let uu____5948 = FStar_Syntax_Free.univs t  in ext out uu____5948
             in
          aux uu____5946 tl1
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (Binding_univ uname)::tl1 ->
          let uu____5998 = FStar_Util.set_add uname out  in
          aux uu____5998 tl1
                ...
                | Binding_sig_inst (ls,uu____6104,uu____6105) ->
                    let uu____6108 =
                      ...
                      FStar_All.pipe_right uu____6109
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____6108))
         in
