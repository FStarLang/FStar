...
let _53_160 = (let _153_500 = (let _153_499 = (FStar_ST.read stack)
in (env)::_153_499)
...
let _53_189 = (let _153_513 = (pop_stack env)
...
let _53_809 = (let _153_787 = (let _153_786 = (FStar_Syntax_Util.arrow binders c)
in ((univs), (_153_786)))
...
let _53_1168 = (FStar_All.pipe_right order (FStar_List.iter (fun edge -> if ((FStar_Ident.lid_equals edge.msource FStar_Syntax_Const.effect_DIV_lid) && (let _153_1009 = (lookup_effect_quals env edge.mtarget)
...
(let _153_1214 = (FStar_All.pipe_right env.gamma (FStar_List.collect (fun _53_11 -> (match (_53_11) with
