                          ...
                          let uu____2775 =
                            let uu____2779 =
                              ...
                              FStar_Syntax_Subst.set_use_range
                               ...
                               in
                            ((lb.FStar_Syntax_Syntax.lbunivs), uu____2779)
                             in
                          Some uu____2775
                      | uu____2785 -> None)
             | uu____2789 -> None)
  ...
  fun env  ->
    fun s  ->
      let rec push x rest =
        ...
        | [] -> [x]
        | local::rest -> let uu____4405 = push x rest  in local :: uu____4405
         in
  ...
  fun env  ->
    fun m  ->
      let sigs =
        ...
        | uu____4563 -> m.FStar_Syntax_Syntax.exports  in
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          ...
          let uu____4630 =
            let uu____4634 = FStar_Syntax_Free.uvars t  in ext out uu____4634
             in
          aux uu____4630 tl
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl ->
          let uu____4690 =
            let uu____4692 = FStar_Syntax_Free.univs t  in ext out uu____4692
             in
          aux uu____4690 tl
