...
let (inst_tscheme :
  ...
  fun uu___72_7735 ->
    ...
    | (us, t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu____7759 -> new_u_univ ())) in
                   ...
                   (if
                    ...
                    then
                      (let uu____7810 =
                         ...
                         let uu____7814 = FStar_Syntax_Print.term_to_string t in
                         FStar_Util.format4
                           "Expected %s instantiations; got %s; failed universe instantiation in effect %s\n\t%s\n"
                           uu____7811 uu____7812 uu____7813 uu____7814 in
                       failwith uu____7810)
                    else ();
                    (let uu____7816 =
                       inst_tscheme_with
...
let (uu___is_Maybe : tri -> Prims.bool) =
  fun projectee -> match projectee with | Maybe -> true | uu____7837 -> false
                       ...
                       (uu____8170,
                        {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_bundle (ses, uu____8172);
                          FStar_Syntax_Syntax.sigrng = uu____8173;
                          FStar_Syntax_Syntax.sigquals = uu____8174;
                          FStar_Syntax_Syntax.sigmeta = uu____8175;
                          FStar_Syntax_Syntax.sigattrs = uu____8176;_})
                       ->
        ...
        | FStar_Syntax_Syntax.Sig_let ((uu____8717, lbs), uu____8719) ->
            FStar_Util.find_map lbs
              (fun lb ->
                 ...
                 | FStar_Util.Inr fv ->
                     let uu____8767 = FStar_Syntax_Syntax.fv_eq_lid fv lid in
                     if uu____8767
                     then
                       let uu____8778 =
                         let uu____8787 =
                           inst_tscheme1
                             ((lb.FStar_Syntax_Syntax.lbunivs),
                               (lb.FStar_Syntax_Syntax.lbtyp)) in
                         let uu____8796 = FStar_Syntax_Syntax.range_of_fv fv in
              ...
              (match lr with
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigattrs = uu____9186;_},
                    FStar_Pervasives_Native.None)
                   ->
                   let uu____9203 =
                     let uu____9204 = in_cur_mod env l in uu____9204 = Yes in
                   if uu____9203
                   then
                     let uu____9215 =
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigattrs = uu____9299;_},
                    FStar_Pervasives_Native.None)
                   ->
                   (match tps with
                    | [] ->
                          ...
                          let uu____9374 =
                            let uu____9379 =
                              let uu____9380 =
                                ...
                                FStar_Syntax_Util.flat_arrow tps uu____9383 in
                              (uvs, uu____9380) in
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigattrs = uu____9409;_},
                          ...
                          let uu____9485 =
                            let uu____9490 =
                              let uu____9491 =
                                let uu____9494 =
                                  FStar_Syntax_Syntax.mk_Total k in
                                FStar_Syntax_Util.flat_arrow tps uu____9494 in
                              (uvs, uu____9491) in
               ...
               | FStar_Util.Inr se ->
                   let uu____9528 =
                     ...
                     | ({
                          ...
                          FStar_Syntax_Syntax.sigattrs = uu____9553;_},
                        FStar_Pervasives_Native.None) ->
...
let (try_lookup_lid :
  ...
  fun env ->
    fun l ->
      let uu____9892 = try_lookup_lid_aux FStar_Pervasives_Native.None env l in
      ...
      | FStar_Pervasives_Native.Some ((us, t), r) ->
          ...
          let uu____9959 =
            let uu____9968 =
              let uu____9973 = FStar_Syntax_Subst.set_use_range use_range1 t in
              (us, uu____9973) in
            (uu____9968, r1) in
    ...
    fun us ->
      fun l ->
        ...
        | FStar_Pervasives_Native.Some ((uu____10034, t), r) ->
            ...
            let uu____10060 =
              let uu____10065 = FStar_Syntax_Subst.set_use_range use_range1 t in
              (uu____10065, r1) in
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigattrs = uu____10183;_},
            FStar_Pervasives_Native.None),
           uu____10184)
          ->
          let uu____10233 =
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigattrs = uu____10294;_},
            FStar_Pervasives_Native.None),
           uu____10295)
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigattrs = uu____10378;_},
            FStar_Pervasives_Native.None),
           uu____10379)
          -> inst_tscheme_with_range (FStar_Ident.range_of_lid lid) (uvs, t)
      | uu____10432 ->
             ...
             | FStar_Syntax_Syntax.Sig_let ((uu____10703, lbs), uu____10705)
                 ...
                 FStar_Util.find_map lbs
                   (fun lb ->
                      ...
                      let uu____10733 = FStar_Syntax_Syntax.fv_eq_lid fv lid in
                      if uu____10733
                      then
                        FStar_Pervasives_Native.Some
                          ((lb.FStar_Syntax_Syntax.lbunivs),
  ...
  fun env ->
    fun ftv ->
      ...
      | FStar_Pervasives_Native.Some
          ...
          let uu____10948 = effect_signature FStar_Pervasives_Native.None se in
        ...
        | FStar_Pervasives_Native.Some
            (FStar_Util.Inr
             ({
                ...
                FStar_Syntax_Syntax.sigattrs = uu____11031;_},
              FStar_Pervasives_Native.None),
             uu____11032)
            ->
            let lid1 =
              ...
              (let insts =
                 ...
                 then univ_insts
                   ...
                   (let uu____11107 =
                      ...
                      let uu____11110 = FStar_Syntax_Print.lid_to_string lid1 in
                      let uu____11111 =
                        FStar_All.pipe_right (FStar_List.length univ_insts)
                          FStar_Util.string_of_int in
                      FStar_Util.format3
                        "(%s) Unexpected instantiation of effect %s with %s universes"
                        uu____11108 uu____11110 uu____11111 in
                    failwith uu____11107) in
               ...
               | (uu____11135, uu____11136::uu____11137::uu____11138) ->
                   let uu____11143 =
                     let uu____11144 = FStar_Syntax_Print.lid_to_string lid1 in
                     let uu____11145 =
                       FStar_All.pipe_left FStar_Util.string_of_int
                         (FStar_List.length univs1) in
                     FStar_Util.format2
               ...
               | uu____11152 ->
                   let uu____11157 =
                     let uu____11162 =
                       let uu____11163 = FStar_Syntax_Util.arrow binders c in
                   ...
                   (match uu____11157 with
                    | (uu____11174, t) ->
                        ...
                        let uu____11177 =
                          let uu____11178 = FStar_Syntax_Subst.compress t1 in
...
let (norm_eff_name : env -> FStar_Ident.lident -> FStar_Ident.lident) =
  ...
  fun env ->
    fun l ->
      ...
      let res =
        let uu____11279 = FStar_Util.smap_try_find cache l.FStar_Ident.str in
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigattrs = uu____11304;_},
            uu____11305),
           uu____11306)
          -> q
      | uu____11357 -> []
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigattrs = uu____11440;_},
            uu____11441),
           uu____11442)
          ->
          FStar_Util.for_some
    ...
    fun lid ->
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
                (uu____11510, uu____11511, uu____11512, uu____11513,
              ...
              FStar_Syntax_Syntax.sigattrs = uu____11519;_},
            uu____11520),
           uu____11521)
          -> true
      | uu____11576 -> false
    ...
    | FStar_Pervasives_Native.Some
        (FStar_Util.Inr
         ({
            ...
            FStar_Syntax_Syntax.sigattrs = uu____11685;_},
          uu____11686),
         uu____11687)
        ->
        FStar_Util.for_some
      ...
      let mapper x =
        ...
        | FStar_Util.Inr (se, uu____11910) ->
            (match se.FStar_Syntax_Syntax.sigel with
             ...
             | uu____11951 -> FStar_Pervasives_Native.Some false) in
      let uu____11952 =
          ...
          then
            ...
            (let uu____12229 =
             ...
             | FStar_Pervasives_Native.None ->
                 let uu____12314 =
                   let uu____12319 =
                     let uu____12320 = FStar_Syntax_Print.lid_to_string l1 in
                     let uu____12321 = FStar_Syntax_Print.lid_to_string l2 in
                     FStar_Util.format2
                       "Effects %s and %s cannot be composed" uu____12320
                       uu____12321 in
                   (FStar_Errors.Fatal_EffectsCannotBeComposed, uu____12319) in
          ...
          then
            ...
            then
              ...
              (let eff_name1 = norm_eff_name env eff_name in
               ...
               let null_wp_res =
                 ...
                 let uu____12552 =
                   let uu____12555 =
                     let uu____12556 =
                       let uu____12571 =
                         let uu____12574 = FStar_Syntax_Syntax.as_arg res_t in
                         [uu____12574] in
               ...
               let uu____12580 =
                 let uu____12581 =
                   let uu____12590 = FStar_Syntax_Syntax.as_arg null_wp_res in
                   [uu____12590] in
                 {
    ...
    fun se ->
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
                    ...
                    FStar_Pervasives_Native.Some
                      ((fun u ->
                          fun t ->
                            fun wp ->
                              fun e ->
                                let uu____12742 = (e1.mlift).mlift_wp u t wp in
                  ...
                  let uu____12804 =
                    let uu____12805 =
                      let uu____12820 =
                        ...
                        let uu____12824 =
                          let uu____12827 = FStar_Syntax_Syntax.as_arg wp1 in
                          [uu____12827] in
                  ...
                  let uu____12889 =
                    let uu____12890 =
                      let uu____12905 =
                        ...
                        let uu____12909 =
                          let uu____12912 = FStar_Syntax_Syntax.as_arg wp1 in
                          let uu____12913 =
                            let uu____12916 = FStar_Syntax_Syntax.as_arg e in
                            [uu____12916] in
          ...
          let print_mlift l =
            ...
            let uu____12963 =
              let uu____12964 = l.mlift_wp FStar_Syntax_Syntax.U_zero arg wp in
              FStar_Syntax_Print.term_to_string uu____12964 in
            let uu____12965 =
              let uu____12966 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1 ->
                     let uu____12988 = l1 FStar_Syntax_Syntax.U_zero arg wp e in
                     FStar_Syntax_Print.term_to_string uu____12988) in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____13014 ->
                    ...
                    | (e, uu____13022) -> e.FStar_Syntax_Syntax.mname)) in
                  ...
                  (let uu____13545 =
                     let uu____13550 =
                       ...
                       FStar_Util.format3
                         ...
                         uu____13551 uu____13556 uu____13563 in
                ...
                (match (ed.FStar_Syntax_Syntax.repr).FStar_Syntax_Syntax.n
                 ...
                 | uu____13713 ->
                     ...
                     let uu____13772 =
                       ...
                       uu____13776 FStar_Pervasives_Native.None uu____13775 in
        ...
        let no_reify l =
          let uu____13844 =
            let uu____13849 =
              ...
              FStar_Util.format1 "Effect %s cannot be reified" uu____13850 in
  ...
  fun env ->
    fun s ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____13963 = push1 x rest1 in local :: uu____13963 in
                ...
                | Binding_sig_inst (ls, uu____14740, uu____14741) ->
                    let uu____14746 =
                      ...
                      FStar_All.pipe_right uu____14747
                        (FStar_String.concat ", ") in
                    Prims.strcat "Binding_sig_inst " uu____14746)) in
      ...
      | (p, b) ->
          ...
          then "*"
            ...
            (let uu____15115 = FStar_Ident.text_of_path p in
             Prims.strcat (if b then "+" else "-") uu____15115) in
    let uu____15117 =
...
let (dummy_solver : solver_t) =
  {
    ...
    preprocess =
      (fun e ->
         fun g ->
           let uu____15155 =
             let uu____15162 = FStar_Options.peek () in (e, g, uu____15162) in
           [uu____15155]);
