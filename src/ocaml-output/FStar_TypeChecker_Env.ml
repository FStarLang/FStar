                 ...
                 FStar_Util.find_map lbs
                   (fun lb  ->
                      let fv = FStar_Util.right lb.FStar_Syntax_Syntax.lbname
                         in
                      let uu____3250 = FStar_Syntax_Syntax.fv_eq_lid fv lid
                         in
                      if uu____3250
                      then
                        Some
            ...
            (let uu____4245 =
             ...
             | None  ->
                 let uu____4288 =
                   let uu____4289 =
                     let uu____4292 =
                       let uu____4293 = FStar_Syntax_Print.lid_to_string l1
                          in
                       let uu____4294 = FStar_Syntax_Print.lid_to_string l2
                          in
                       FStar_Util.format2
          ...
          then FStar_Syntax_Syntax.mk_Total' res_t (Some res_u)
            ...
            then FStar_Syntax_Syntax.mk_GTotal' res_t (Some res_u)
              ...
              (let eff_name1 = norm_eff_name env eff_name  in
               ...
               let uu____4480 =
                 let uu____4481 =
                   let uu____4487 = FStar_Syntax_Syntax.as_arg null_wp_res
                      in
                   [uu____4487]  in
                 {
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
          ...
          let mk_mlift_wp lift_t r wp1 =
            ...
            | (uu____4639,lift_t1) ->
                ...
                uu____4641 None wp1.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_wp =
          ...
          let mk_mlift_term lift_t r wp1 e =
            ...
            | (uu____4710,lift_t1) ->
                ...
                uu____4712 None e.FStar_Syntax_Syntax.pos
             in
          let sub_mlift_term =
              ...
              let uu____4783 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____4798)
                 in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____4811  ->
                    ...
                    | (e,uu____4816) -> e.FStar_Syntax_Syntax.mname))
             in
                               ...
                               (fun j  ->
                                  ...
                                  then []
                                    ...
                                    (let uu____4866 =
                                     ...
                                     | (Some e1,Some e2) ->
                                         let uu____4882 = compose_edges e1 e2
                                            in
                                         [uu____4882]
                                     | uu____4883 -> [])))))
                 in
                     ...
                     let uu____5130 =
                       let uu____5133 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____5134 uu____5140 uu____5148
                          in
...
let effect_repr_aux only_reifiable env c u_c =
  let uu____5229 =
    let uu____5234 = norm_eff_name env (FStar_Syntax_Util.comp_effect_name c)
       in
          ...
          let uu____5373 =
            let uu____5374 =
              let uu____5377 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____5378
                 in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____5473 = push1 x rest1  in local :: uu____5473
         in
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          ...
          let uu____5752 =
            let uu____5756 = FStar_Syntax_Free.uvars t  in ext out uu____5756
             in
          aux uu____5752 tl1
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl1 ->
          let uu____5812 =
            let uu____5814 = FStar_Syntax_Free.univs t  in ext out uu____5814
             in
          aux uu____5812 tl1
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (Binding_univ uname)::tl1 ->
          let uu____5864 = FStar_Util.set_add uname out  in
          aux uu____5864 tl1
      | (Binding_lid (_,(_,t)))::tl1|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl1 ->
                ...
                | Binding_sig_inst (ls,uu____5952,uu____5953) ->
                    let uu____5956 =
                      ...
                      FStar_All.pipe_right uu____5957
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____5956))
         in
