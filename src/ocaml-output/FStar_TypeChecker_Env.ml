           ...
           | (binders1,cdef1) ->
               (if
                     ...
                     let uu____15818 =
                       ...
                       let uu____15824 =
                         FStar_Util.string_of_int
                          ...
                          in
                       let uu____15831 =
                         let uu____15832 = FStar_Syntax_Syntax.mk_Comp c  in
                         FStar_Syntax_Print.comp_to_string uu____15832  in
                       FStar_Util.format3
                         "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s"
                         uu____15819 uu____15824 uu____15831
                        in
                ...
                (let inst1 =
                   let uu____15837 =
                     let uu____15846 =
                       FStar_Syntax_Syntax.as_arg
                        ...
                        in
                     uu____15846 :: (c.FStar_Syntax_Syntax.effect_args)  in
                   FStar_List.map2
                     (fun uu____15875  ->
                        fun uu____15876  ->
                          match (uu____15875, uu____15876) with
                          | ((x,uu____15898),(t,uu____15900)) ->
                 ...
                 let c2 =
                   let uu____15919 =
                     let uu___102_15920 = comp_to_comp_typ env c1  in
                     {
                       FStar_Syntax_Syntax.comp_univs =
                         (uu___102_15920.FStar_Syntax_Syntax.comp_univs);
                       FStar_Syntax_Syntax.effect_name =
                         (uu___102_15920.FStar_Syntax_Syntax.effect_name);
                       FStar_Syntax_Syntax.result_typ =
                         (uu___102_15920.FStar_Syntax_Syntax.result_typ);
                       FStar_Syntax_Syntax.effect_args =
                         (uu___102_15920.FStar_Syntax_Syntax.effect_args);
                       FStar_Syntax_Syntax.flags =
                         (c.FStar_Syntax_Syntax.flags)
                     }  in
                   FStar_All.pipe_right uu____15919
    ...
    fun env  ->
      fun c  ->
        fun u_c  ->
          ...
          let uu____15950 = effect_decl_opt env effect_name  in
                 ...
                 | uu____16001 ->
                     ...
                     let repr =
                       inst_effect_fun_with [u_c] env ed
                        ...
                        in
                     let uu____16062 =
                       let uu____16065 = get_range env  in
                       let uu____16066 =
                         let uu____16073 =
                           let uu____16074 =
                             let uu____16089 =
                               ...
                               [uu____16098; wp]  in
                             (repr, uu____16089)  in
                           FStar_Syntax_Syntax.Tm_app uu____16074  in
                         FStar_Syntax_Syntax.mk uu____16073  in
                       uu____16066 FStar_Pervasives_Native.None uu____16065
                        in
    ...
    fun c  ->
      fun u_c  ->
        let no_reify l =
          let uu____16178 =
            let uu____16183 =
              let uu____16184 = FStar_Ident.string_of_lid l  in
              FStar_Util.format1 "Effect %s cannot be reified" uu____16184
               in
            (FStar_Errors.Fatal_EffectCannotBeReified, uu____16183)  in
          let uu____16185 = get_range env  in
          FStar_Errors.raise_error uu____16178 uu____16185  in
        let uu____16186 = effect_repr_aux true env c u_c  in
...
let (is_reifiable_function : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun env  ->
    fun t  ->
      let uu____16243 =
        let uu____16244 = FStar_Syntax_Subst.compress t  in
        uu____16244.FStar_Syntax_Syntax.n  in
      match uu____16243 with
      | FStar_Syntax_Syntax.Tm_arrow (uu____16247,c) ->
...
let (push_sigelt : env -> FStar_Syntax_Syntax.sigelt -> env) =
  fun env  ->
    fun s  ->
      ...
      let env1 =
        let uu___103_16286 = env  in
        {
          solver = (uu___103_16286.solver);
          range = (uu___103_16286.range);
          curmodule = (uu___103_16286.curmodule);
          gamma = (uu___103_16286.gamma);
          gamma_sig = (sb :: (env.gamma_sig));
          gamma_cache = (uu___103_16286.gamma_cache);
          modules = (uu___103_16286.modules);
          expected_typ = (uu___103_16286.expected_typ);
          sigtab = (uu___103_16286.sigtab);
          is_pattern = (uu___103_16286.is_pattern);
          instantiate_imp = (uu___103_16286.instantiate_imp);
          effects = (uu___103_16286.effects);
          generalize = (uu___103_16286.generalize);
          letrecs = (uu___103_16286.letrecs);
          top_level = (uu___103_16286.top_level);
          check_uvars = (uu___103_16286.check_uvars);
          use_eq = (uu___103_16286.use_eq);
          is_iface = (uu___103_16286.is_iface);
          admit = (uu___103_16286.admit);
          lax = (uu___103_16286.lax);
          lax_universes = (uu___103_16286.lax_universes);
          failhard = (uu___103_16286.failhard);
          nosynth = (uu___103_16286.nosynth);
          tc_term = (uu___103_16286.tc_term);
          type_of = (uu___103_16286.type_of);
          universe_of = (uu___103_16286.universe_of);
          check_type_of = (uu___103_16286.check_type_of);
          use_bv_sorts = (uu___103_16286.use_bv_sorts);
          qtbl_name_and_index = (uu___103_16286.qtbl_name_and_index);
          normalized_eff_names = (uu___103_16286.normalized_eff_names);
          proof_ns = (uu___103_16286.proof_ns);
          synth_hook = (uu___103_16286.synth_hook);
          splice = (uu___103_16286.splice);
          is_native_tactic = (uu___103_16286.is_native_tactic);
          identifier_info = (uu___103_16286.identifier_info);
          tc_hooks = (uu___103_16286.tc_hooks);
          dsenv = (uu___103_16286.dsenv);
          dep_graph = (uu___103_16286.dep_graph)
        }  in
...
let (push_local_binding : env -> FStar_Syntax_Syntax.binding -> env) =
  fun env  ->
    fun b  ->
      let uu___104_16298 = env  in
      {
        solver = (uu___104_16298.solver);
        range = (uu___104_16298.range);
        curmodule = (uu___104_16298.curmodule);
        gamma = (b :: (env.gamma));
        gamma_sig = (uu___104_16298.gamma_sig);
        gamma_cache = (uu___104_16298.gamma_cache);
        modules = (uu___104_16298.modules);
        expected_typ = (uu___104_16298.expected_typ);
        sigtab = (uu___104_16298.sigtab);
        is_pattern = (uu___104_16298.is_pattern);
        instantiate_imp = (uu___104_16298.instantiate_imp);
        effects = (uu___104_16298.effects);
        generalize = (uu___104_16298.generalize);
        letrecs = (uu___104_16298.letrecs);
        top_level = (uu___104_16298.top_level);
        check_uvars = (uu___104_16298.check_uvars);
        use_eq = (uu___104_16298.use_eq);
        is_iface = (uu___104_16298.is_iface);
        admit = (uu___104_16298.admit);
        lax = (uu___104_16298.lax);
        lax_universes = (uu___104_16298.lax_universes);
        failhard = (uu___104_16298.failhard);
        nosynth = (uu___104_16298.nosynth);
        tc_term = (uu___104_16298.tc_term);
        type_of = (uu___104_16298.type_of);
        universe_of = (uu___104_16298.universe_of);
        check_type_of = (uu___104_16298.check_type_of);
        use_bv_sorts = (uu___104_16298.use_bv_sorts);
        qtbl_name_and_index = (uu___104_16298.qtbl_name_and_index);
        normalized_eff_names = (uu___104_16298.normalized_eff_names);
        proof_ns = (uu___104_16298.proof_ns);
        synth_hook = (uu___104_16298.synth_hook);
        splice = (uu___104_16298.splice);
        is_native_tactic = (uu___104_16298.is_native_tactic);
        identifier_info = (uu___104_16298.identifier_info);
        tc_hooks = (uu___104_16298.tc_hooks);
        dsenv = (uu___104_16298.dsenv);
        dep_graph = (uu___104_16298.dep_graph)
      }
...
let (pop_bv :
  ...
  fun env  ->
    ...
    | (FStar_Syntax_Syntax.Binding_var x)::rest ->
        FStar_Pervasives_Native.Some
          (x,
            (let uu___105_16353 = env  in
             {
               solver = (uu___105_16353.solver);
               range = (uu___105_16353.range);
               curmodule = (uu___105_16353.curmodule);
               gamma = rest;
               gamma_sig = (uu___105_16353.gamma_sig);
               gamma_cache = (uu___105_16353.gamma_cache);
               modules = (uu___105_16353.modules);
               expected_typ = (uu___105_16353.expected_typ);
               sigtab = (uu___105_16353.sigtab);
               is_pattern = (uu___105_16353.is_pattern);
               instantiate_imp = (uu___105_16353.instantiate_imp);
               effects = (uu___105_16353.effects);
               generalize = (uu___105_16353.generalize);
               letrecs = (uu___105_16353.letrecs);
               top_level = (uu___105_16353.top_level);
               check_uvars = (uu___105_16353.check_uvars);
               use_eq = (uu___105_16353.use_eq);
               is_iface = (uu___105_16353.is_iface);
               admit = (uu___105_16353.admit);
               lax = (uu___105_16353.lax);
               lax_universes = (uu___105_16353.lax_universes);
               failhard = (uu___105_16353.failhard);
               nosynth = (uu___105_16353.nosynth);
               tc_term = (uu___105_16353.tc_term);
               type_of = (uu___105_16353.type_of);
               universe_of = (uu___105_16353.universe_of);
               check_type_of = (uu___105_16353.check_type_of);
               use_bv_sorts = (uu___105_16353.use_bv_sorts);
               qtbl_name_and_index = (uu___105_16353.qtbl_name_and_index);
               normalized_eff_names = (uu___105_16353.normalized_eff_names);
               proof_ns = (uu___105_16353.proof_ns);
               synth_hook = (uu___105_16353.synth_hook);
               splice = (uu___105_16353.splice);
               is_native_tactic = (uu___105_16353.is_native_tactic);
               identifier_info = (uu___105_16353.identifier_info);
               tc_hooks = (uu___105_16353.tc_hooks);
               dsenv = (uu___105_16353.dsenv);
               dep_graph = (uu___105_16353.dep_graph)
             }))
    | uu____16354 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env1  ->
           fun uu____16380  ->
             match uu____16380 with | (x,uu____16386) -> push_bv env1 x) env
        bs
...
let (binding_of_lb :
  ...
  fun x  ->
    fun t  ->
      ...
      | FStar_Util.Inl x1 ->
          let x2 =
            let uu___106_16416 = x1  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___106_16416.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___106_16416.FStar_Syntax_Syntax.index);
...
let (push_module : env -> FStar_Syntax_Syntax.modul -> env) =
  fun env  ->
    fun m  ->
      ...
      (let uu___107_16456 = env  in
       {
         solver = (uu___107_16456.solver);
         range = (uu___107_16456.range);
         curmodule = (uu___107_16456.curmodule);
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___107_16456.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = FStar_Pervasives_Native.None;
         sigtab = (uu___107_16456.sigtab);
         is_pattern = (uu___107_16456.is_pattern);
         instantiate_imp = (uu___107_16456.instantiate_imp);
         effects = (uu___107_16456.effects);
         generalize = (uu___107_16456.generalize);
         letrecs = (uu___107_16456.letrecs);
         top_level = (uu___107_16456.top_level);
         check_uvars = (uu___107_16456.check_uvars);
         use_eq = (uu___107_16456.use_eq);
         is_iface = (uu___107_16456.is_iface);
         admit = (uu___107_16456.admit);
         lax = (uu___107_16456.lax);
         lax_universes = (uu___107_16456.lax_universes);
         failhard = (uu___107_16456.failhard);
         nosynth = (uu___107_16456.nosynth);
         tc_term = (uu___107_16456.tc_term);
         type_of = (uu___107_16456.type_of);
         universe_of = (uu___107_16456.universe_of);
         check_type_of = (uu___107_16456.check_type_of);
         use_bv_sorts = (uu___107_16456.use_bv_sorts);
         qtbl_name_and_index = (uu___107_16456.qtbl_name_and_index);
         normalized_eff_names = (uu___107_16456.normalized_eff_names);
         proof_ns = (uu___107_16456.proof_ns);
         synth_hook = (uu___107_16456.synth_hook);
         splice = (uu___107_16456.splice);
         is_native_tactic = (uu___107_16456.is_native_tactic);
         identifier_info = (uu___107_16456.identifier_info);
         tc_hooks = (uu___107_16456.tc_hooks);
         dsenv = (uu___107_16456.dsenv);
         dep_graph = (uu___107_16456.dep_graph)
       })
...
let (open_universes_in :
  ...
  fun env  ->
    fun uvs  ->
      fun terms  ->
        let uu____16498 = FStar_Syntax_Subst.univ_var_opening uvs  in
        match uu____16498 with
        | (univ_subst,univ_vars) ->
            let env' = push_univ_vars env univ_vars  in
            let uu____16526 =
              FStar_List.map (FStar_Syntax_Subst.subst univ_subst) terms  in
            (env', univ_vars, uu____16526)
  
let (set_expected_typ : env -> FStar_Syntax_Syntax.typ -> env) =
  fun env  ->
    fun t  ->
      let uu___108_16541 = env  in
      {
        solver = (uu___108_16541.solver);
        range = (uu___108_16541.range);
        curmodule = (uu___108_16541.curmodule);
        gamma = (uu___108_16541.gamma);
        gamma_sig = (uu___108_16541.gamma_sig);
        gamma_cache = (uu___108_16541.gamma_cache);
        modules = (uu___108_16541.modules);
        expected_typ = (FStar_Pervasives_Native.Some t);
        sigtab = (uu___108_16541.sigtab);
        is_pattern = (uu___108_16541.is_pattern);
        instantiate_imp = (uu___108_16541.instantiate_imp);
        effects = (uu___108_16541.effects);
        generalize = (uu___108_16541.generalize);
        letrecs = (uu___108_16541.letrecs);
        top_level = (uu___108_16541.top_level);
        check_uvars = (uu___108_16541.check_uvars);
        use_eq = false;
        is_iface = (uu___108_16541.is_iface);
        admit = (uu___108_16541.admit);
        lax = (uu___108_16541.lax);
        lax_universes = (uu___108_16541.lax_universes);
        failhard = (uu___108_16541.failhard);
        nosynth = (uu___108_16541.nosynth);
        tc_term = (uu___108_16541.tc_term);
        type_of = (uu___108_16541.type_of);
        universe_of = (uu___108_16541.universe_of);
        check_type_of = (uu___108_16541.check_type_of);
        use_bv_sorts = (uu___108_16541.use_bv_sorts);
        qtbl_name_and_index = (uu___108_16541.qtbl_name_and_index);
        normalized_eff_names = (uu___108_16541.normalized_eff_names);
        proof_ns = (uu___108_16541.proof_ns);
        synth_hook = (uu___108_16541.synth_hook);
        splice = (uu___108_16541.splice);
        is_native_tactic = (uu___108_16541.is_native_tactic);
        identifier_info = (uu___108_16541.identifier_info);
        tc_hooks = (uu___108_16541.tc_hooks);
        dsenv = (uu___108_16541.dsenv);
        dep_graph = (uu___108_16541.dep_graph)
      }
...
let (clear_expected_typ :
  ...
  =
  fun env_  ->
    let uu____16569 = expected_typ env_  in
    ((let uu___109_16575 = env_  in
      {
        solver = (uu___109_16575.solver);
        range = (uu___109_16575.range);
        curmodule = (uu___109_16575.curmodule);
        gamma = (uu___109_16575.gamma);
        gamma_sig = (uu___109_16575.gamma_sig);
        gamma_cache = (uu___109_16575.gamma_cache);
        modules = (uu___109_16575.modules);
        expected_typ = FStar_Pervasives_Native.None;
        sigtab = (uu___109_16575.sigtab);
        is_pattern = (uu___109_16575.is_pattern);
        instantiate_imp = (uu___109_16575.instantiate_imp);
        effects = (uu___109_16575.effects);
        generalize = (uu___109_16575.generalize);
        letrecs = (uu___109_16575.letrecs);
        top_level = (uu___109_16575.top_level);
        check_uvars = (uu___109_16575.check_uvars);
        use_eq = false;
        is_iface = (uu___109_16575.is_iface);
        admit = (uu___109_16575.admit);
        lax = (uu___109_16575.lax);
        lax_universes = (uu___109_16575.lax_universes);
        failhard = (uu___109_16575.failhard);
        nosynth = (uu___109_16575.nosynth);
        tc_term = (uu___109_16575.tc_term);
        type_of = (uu___109_16575.type_of);
        universe_of = (uu___109_16575.universe_of);
        check_type_of = (uu___109_16575.check_type_of);
        use_bv_sorts = (uu___109_16575.use_bv_sorts);
        qtbl_name_and_index = (uu___109_16575.qtbl_name_and_index);
        normalized_eff_names = (uu___109_16575.normalized_eff_names);
        proof_ns = (uu___109_16575.proof_ns);
        synth_hook = (uu___109_16575.synth_hook);
        splice = (uu___109_16575.splice);
        is_native_tactic = (uu___109_16575.is_native_tactic);
        identifier_info = (uu___109_16575.identifier_info);
        tc_hooks = (uu___109_16575.tc_hooks);
        dsenv = (uu___109_16575.dsenv);
        dep_graph = (uu___109_16575.dep_graph)
      }), uu____16569)
  
let (finish_module : env -> FStar_Syntax_Syntax.modul -> env) =
  let empty_lid =
    let uu____16585 =
      let uu____16588 = FStar_Ident.id_of_text ""  in [uu____16588]  in
    FStar_Ident.lid_of_ids uu____16585  in
  fun env  ->
    fun m  ->
      let sigs =
        let uu____16594 =
        ...
        then
          let uu____16597 =
            FStar_All.pipe_right env.gamma_sig
             ...
             in
          FStar_All.pipe_right uu____16597 FStar_List.rev
        else m.FStar_Syntax_Syntax.exports  in
      add_sigelts env sigs;
      (let uu___110_16624 = env  in
       {
         solver = (uu___110_16624.solver);
         range = (uu___110_16624.range);
         curmodule = empty_lid;
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___110_16624.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = (uu___110_16624.expected_typ);
         sigtab = (uu___110_16624.sigtab);
         is_pattern = (uu___110_16624.is_pattern);
         instantiate_imp = (uu___110_16624.instantiate_imp);
         effects = (uu___110_16624.effects);
         generalize = (uu___110_16624.generalize);
         letrecs = (uu___110_16624.letrecs);
         top_level = (uu___110_16624.top_level);
         check_uvars = (uu___110_16624.check_uvars);
         use_eq = (uu___110_16624.use_eq);
         is_iface = (uu___110_16624.is_iface);
         admit = (uu___110_16624.admit);
         lax = (uu___110_16624.lax);
         lax_universes = (uu___110_16624.lax_universes);
         failhard = (uu___110_16624.failhard);
         nosynth = (uu___110_16624.nosynth);
         tc_term = (uu___110_16624.tc_term);
         type_of = (uu___110_16624.type_of);
         universe_of = (uu___110_16624.universe_of);
         check_type_of = (uu___110_16624.check_type_of);
         use_bv_sorts = (uu___110_16624.use_bv_sorts);
         qtbl_name_and_index = (uu___110_16624.qtbl_name_and_index);
         normalized_eff_names = (uu___110_16624.normalized_eff_names);
         proof_ns = (uu___110_16624.proof_ns);
         synth_hook = (uu___110_16624.synth_hook);
         splice = (uu___110_16624.splice);
         is_native_tactic = (uu___110_16624.is_native_tactic);
         identifier_info = (uu___110_16624.identifier_info);
         tc_hooks = (uu___110_16624.tc_hooks);
         dsenv = (uu___110_16624.dsenv);
         dep_graph = (uu___110_16624.dep_graph)
       })
...
let (uvars_in_env : env -> FStar_Syntax_Syntax.uvars) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____16675)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____16679,(uu____16680,t)))::tl1
          ->
          let uu____16701 =
            let uu____16704 = FStar_Syntax_Free.uvars t  in
            ext out uu____16704  in
          aux uu____16701 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____16707;
            FStar_Syntax_Syntax.index = uu____16708;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____16715 =
            let uu____16718 = FStar_Syntax_Free.uvars t  in
            ext out uu____16718  in
          aux uu____16715 tl1
       in
...
let (univ_vars : env -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____16775)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____16779,(uu____16780,t)))::tl1
          ->
          let uu____16801 =
            let uu____16804 = FStar_Syntax_Free.univs t  in
            ext out uu____16804  in
          aux uu____16801 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____16807;
            FStar_Syntax_Syntax.index = uu____16808;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____16815 =
            let uu____16818 = FStar_Syntax_Free.univs t  in
            ext out uu____16818  in
          aux uu____16815 tl1
       in
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (FStar_Syntax_Syntax.Binding_univ uname)::tl1 ->
          let uu____16879 = FStar_Util.set_add uname out  in
          aux uu____16879 tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____16882,(uu____16883,t)))::tl1
          ->
          let uu____16904 =
            let uu____16907 = FStar_Syntax_Free.univnames t  in
            ext out uu____16907  in
          aux uu____16904 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____16910;
            FStar_Syntax_Syntax.index = uu____16911;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____16918 =
            let uu____16921 = FStar_Syntax_Free.univnames t  in
            ext out uu____16921  in
          aux uu____16918 tl1
       in
...
let (bound_vars_of_bindings :
  ...
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.collect
         (fun uu___85_16941  ->
            match uu___85_16941 with
            | FStar_Syntax_Syntax.Binding_var x -> [x]
            | FStar_Syntax_Syntax.Binding_lid uu____16945 -> []
            | FStar_Syntax_Syntax.Binding_univ uu____16958 -> []))
  
let (binders_of_bindings :
  FStar_Syntax_Syntax.binding Prims.list -> FStar_Syntax_Syntax.binders) =
  fun bs  ->
    let uu____16968 =
      let uu____16975 = bound_vars_of_bindings bs  in
      FStar_All.pipe_right uu____16975
        (FStar_List.map FStar_Syntax_Syntax.mk_binder)
       in
    FStar_All.pipe_right uu____16968 FStar_List.rev
  ...
  fun gamma  ->
    let uu____17013 =
      FStar_All.pipe_right gamma
        (FStar_List.map
           (fun uu___86_17023  ->
              match uu___86_17023 with
              | FStar_Syntax_Syntax.Binding_var x ->
                  let uu____17025 = FStar_Syntax_Print.bv_to_string x  in
                  Prims.strcat "Binding_var " uu____17025
              | FStar_Syntax_Syntax.Binding_univ u ->
                  Prims.strcat "Binding_univ " u.FStar_Ident.idText
              | FStar_Syntax_Syntax.Binding_lid (l,uu____17028) ->
                  let uu____17045 = FStar_Ident.string_of_lid l  in
                  Prims.strcat "Binding_lid " uu____17045))
       in
    FStar_All.pipe_right uu____17013 (FStar_String.concat "::\n")
  
let (string_of_delta_level : delta_level -> Prims.string) =
  fun uu___87_17052  ->
    match uu___87_17052 with
    | NoDelta  -> "NoDelta"
    | Inlining  -> "Inlining"
    | Eager_unfolding_only  -> "Eager_unfolding_only"
    | Unfold uu____17053 -> "Unfold _"
    | UnfoldTac  -> "UnfoldTac"
  ...
  fun env  ->
    fun path  ->
      let rec list_prefix xs ys =
        ...
        | (uu____17134,uu____17135) -> false  in
      let uu____17144 =
        FStar_List.tryFind
          (fun uu____17162  ->
             match uu____17162 with | (p,uu____17170) -> list_prefix p path)
          env.proof_ns
         in
      match uu____17144 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____17181,b) -> b
  
let (should_enc_lid : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____17203 = FStar_Ident.path_of_lid lid  in
      should_enc_path env uu____17203
  
let (cons_proof_ns : Prims.bool -> env -> name_prefix -> env) =
  fun b  ->
    fun e  ->
      fun path  ->
        let uu___111_17221 = e  in
        {
          solver = (uu___111_17221.solver);
          range = (uu___111_17221.range);
          curmodule = (uu___111_17221.curmodule);
          gamma = (uu___111_17221.gamma);
          gamma_sig = (uu___111_17221.gamma_sig);
          gamma_cache = (uu___111_17221.gamma_cache);
          modules = (uu___111_17221.modules);
          expected_typ = (uu___111_17221.expected_typ);
          sigtab = (uu___111_17221.sigtab);
          is_pattern = (uu___111_17221.is_pattern);
          instantiate_imp = (uu___111_17221.instantiate_imp);
          effects = (uu___111_17221.effects);
          generalize = (uu___111_17221.generalize);
          letrecs = (uu___111_17221.letrecs);
          top_level = (uu___111_17221.top_level);
          check_uvars = (uu___111_17221.check_uvars);
          use_eq = (uu___111_17221.use_eq);
          is_iface = (uu___111_17221.is_iface);
          admit = (uu___111_17221.admit);
          lax = (uu___111_17221.lax);
          lax_universes = (uu___111_17221.lax_universes);
          failhard = (uu___111_17221.failhard);
          nosynth = (uu___111_17221.nosynth);
          tc_term = (uu___111_17221.tc_term);
          type_of = (uu___111_17221.type_of);
          universe_of = (uu___111_17221.universe_of);
          check_type_of = (uu___111_17221.check_type_of);
          use_bv_sorts = (uu___111_17221.use_bv_sorts);
          qtbl_name_and_index = (uu___111_17221.qtbl_name_and_index);
          normalized_eff_names = (uu___111_17221.normalized_eff_names);
          proof_ns = ((path, b) :: (e.proof_ns));
          synth_hook = (uu___111_17221.synth_hook);
          splice = (uu___111_17221.splice);
          is_native_tactic = (uu___111_17221.is_native_tactic);
          identifier_info = (uu___111_17221.identifier_info);
          tc_hooks = (uu___111_17221.tc_hooks);
          dsenv = (uu___111_17221.dsenv);
          dep_graph = (uu___111_17221.dep_graph)
        }
...
let (set_proof_ns : proof_namespace -> env -> env) =
  fun ns  ->
    fun e  ->
      let uu___112_17261 = e  in
      {
        solver = (uu___112_17261.solver);
        range = (uu___112_17261.range);
        curmodule = (uu___112_17261.curmodule);
        gamma = (uu___112_17261.gamma);
        gamma_sig = (uu___112_17261.gamma_sig);
        gamma_cache = (uu___112_17261.gamma_cache);
        modules = (uu___112_17261.modules);
        expected_typ = (uu___112_17261.expected_typ);
        sigtab = (uu___112_17261.sigtab);
        is_pattern = (uu___112_17261.is_pattern);
        instantiate_imp = (uu___112_17261.instantiate_imp);
        effects = (uu___112_17261.effects);
        generalize = (uu___112_17261.generalize);
        letrecs = (uu___112_17261.letrecs);
        top_level = (uu___112_17261.top_level);
        check_uvars = (uu___112_17261.check_uvars);
        use_eq = (uu___112_17261.use_eq);
        is_iface = (uu___112_17261.is_iface);
        admit = (uu___112_17261.admit);
        lax = (uu___112_17261.lax);
        lax_universes = (uu___112_17261.lax_universes);
        failhard = (uu___112_17261.failhard);
        nosynth = (uu___112_17261.nosynth);
        tc_term = (uu___112_17261.tc_term);
        type_of = (uu___112_17261.type_of);
        universe_of = (uu___112_17261.universe_of);
        check_type_of = (uu___112_17261.check_type_of);
        use_bv_sorts = (uu___112_17261.use_bv_sorts);
        qtbl_name_and_index = (uu___112_17261.qtbl_name_and_index);
        normalized_eff_names = (uu___112_17261.normalized_eff_names);
        proof_ns = ns;
        synth_hook = (uu___112_17261.synth_hook);
        splice = (uu___112_17261.splice);
        is_native_tactic = (uu___112_17261.is_native_tactic);
        identifier_info = (uu___112_17261.identifier_info);
        tc_hooks = (uu___112_17261.tc_hooks);
        dsenv = (uu___112_17261.dsenv);
        dep_graph = (uu___112_17261.dep_graph)
      }
...
let (unbound_vars :
  ...
  fun e  ->
    fun t  ->
      let uu____17276 = FStar_Syntax_Free.names t  in
      let uu____17279 = bound_vars e  in
      FStar_List.fold_left (fun s  -> fun bv  -> FStar_Util.set_remove bv s)
        uu____17276 uu____17279
  
let (closed : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun e  ->
    fun t  ->
      let uu____17300 = unbound_vars e t  in
      FStar_Util.set_is_empty uu____17300
  
let (closed' : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____17308 = FStar_Syntax_Free.names t  in
    FStar_Util.set_is_empty uu____17308
    ...
    let aux uu____17327 =
      ...
      | (p,b) ->
          ...
          then "*"
            ...
            (let uu____17343 = FStar_Ident.text_of_path p  in
             Prims.strcat (if b then "+" else "-") uu____17343)
       in
    let uu____17345 =
      let uu____17348 = FStar_List.map aux env.proof_ns  in
      FStar_All.pipe_right uu____17348 FStar_List.rev  in
    FStar_All.pipe_right uu____17345 (FStar_String.concat " ")
  
let (dummy_solver : solver_t) =
  {
    init = (fun uu____17363  -> ());
    push = (fun uu____17365  -> ());
    pop = (fun uu____17367  -> ());
    encode_modul = (fun uu____17370  -> fun uu____17371  -> ());
    encode_sig = (fun uu____17374  -> fun uu____17375  -> ());
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____17381 =
             let uu____17388 = FStar_Options.peek ()  in (e, g, uu____17388)
              in
           [uu____17381]);
    solve = (fun uu____17404  -> fun uu____17405  -> fun uu____17406  -> ());
    finish = (fun uu____17412  -> ());
    refresh = (fun uu____17414  -> ())
  } 
let (mk_copy : env -> env) =
  fun en  ->
    let uu___113_17420 = en  in
    let uu____17421 = FStar_Util.smap_copy en.gamma_cache  in
    let uu____17424 = FStar_Util.smap_copy en.sigtab  in
    let uu____17427 = FStar_Syntax_DsEnv.mk_copy en.dsenv  in
    {
      solver = (uu___113_17420.solver);
      range = (uu___113_17420.range);
      curmodule = (uu___113_17420.curmodule);
      gamma = (uu___113_17420.gamma);
      gamma_sig = (uu___113_17420.gamma_sig);
      gamma_cache = uu____17421;
      modules = (uu___113_17420.modules);
      expected_typ = (uu___113_17420.expected_typ);
      sigtab = uu____17424;
      is_pattern = (uu___113_17420.is_pattern);
      instantiate_imp = (uu___113_17420.instantiate_imp);
      effects = (uu___113_17420.effects);
      generalize = (uu___113_17420.generalize);
      letrecs = (uu___113_17420.letrecs);
      top_level = (uu___113_17420.top_level);
      check_uvars = (uu___113_17420.check_uvars);
      use_eq = (uu___113_17420.use_eq);
      is_iface = (uu___113_17420.is_iface);
      admit = (uu___113_17420.admit);
      lax = (uu___113_17420.lax);
      lax_universes = (uu___113_17420.lax_universes);
      failhard = (uu___113_17420.failhard);
      nosynth = (uu___113_17420.nosynth);
      tc_term = (uu___113_17420.tc_term);
      type_of = (uu___113_17420.type_of);
      universe_of = (uu___113_17420.universe_of);
      check_type_of = (uu___113_17420.check_type_of);
      use_bv_sorts = (uu___113_17420.use_bv_sorts);
      qtbl_name_and_index = (uu___113_17420.qtbl_name_and_index);
      normalized_eff_names = (uu___113_17420.normalized_eff_names);
      proof_ns = (uu___113_17420.proof_ns);
      synth_hook = (uu___113_17420.synth_hook);
      splice = (uu___113_17420.splice);
      is_native_tactic = (uu___113_17420.is_native_tactic);
      identifier_info = (uu___113_17420.identifier_info);
      tc_hooks = (uu___113_17420.tc_hooks);
      dsenv = uu____17427;
      dep_graph = (uu___113_17420.dep_graph)
    }
