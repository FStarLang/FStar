                        ...
                        | (substs1, uvars, g) ->
                            ...
                            let ctx_uvar_meta_t =
                              ...
                              | FStar_Pervasives_Native.Some
                                  ...
                                  let uu____25509 =
                                    let uu____25510 =
                                      let uu____25517 = FStar_Dyn.mkdyn env1 in
                                      (uu____25517, t) in
                                    FStar_Syntax_Syntax.Ctx_uvar_meta_tac
                                      uu____25510 in
                                  FStar_Pervasives_Native.Some uu____25509
                              | FStar_Pervasives_Native.Some
                                  (FStar_Syntax_Syntax.Meta
                              ...
                              | uu____25523 -> FStar_Pervasives_Native.None in
                            let uu____25526 =
                              let uu____25539 = reason b in
                              new_implicit_var_aux uu____25539 r env1 sort
                                         ...
                                         let uu____25591 =
                                           let uu____25598 =
                                             FStar_All.pipe_right b
                                               FStar_Pervasives_Native.fst in
                                           (uu____25598, t) in
                                         FStar_Syntax_Syntax.NT uu____25591 in
                                       [uu____25590] in
                                     FStar_List.append substs1 uu____25587 in
                                   let uu____25609 = conj_guard g g_t in
                                   (uu____25584,
          ...
          fun r ->
            let trivial_post =
              let post_ts =
                ...
                FStar_All.pipe_right uu____25695 FStar_Util.must in
              let uu____25712 = inst_tscheme_with post_ts [u] in
              ...
              | (uu____25717, post) ->
                  let uu____25719 =
                    ...
                    [uu____25720] in
                  FStar_Syntax_Syntax.mk_Tm_app post uu____25719 r in
            let uu____25753 =
              let uu____25754 =
                FStar_All.pipe_right trivial_post FStar_Syntax_Syntax.as_arg in
              [uu____25754] in
            FStar_Syntax_Syntax.mk_Tm_app wp uu____25753 r
let (dummy_solver : solver_t) =
  {
    init = (fun uu____25789 -> ());
    push = (fun uu____25791 -> ());
    pop = (fun uu____25793 -> ());
    snapshot =
      (fun uu____25795 ->
         ((Prims.int_zero, Prims.int_zero, Prims.int_zero), ()));
    rollback = (fun uu____25804 -> fun uu____25805 -> ());
    encode_sig = (fun uu____25816 -> fun uu____25817 -> ());
    preprocess =
      (fun e ->
         fun g ->
           let uu____25823 =
             let uu____25830 = FStar_Options.peek () in (e, g, uu____25830) in
           [uu____25823]);
    solve = (fun uu____25846 -> fun uu____25847 -> fun uu____25848 -> ());
    finish = (fun uu____25854 -> ());
    refresh = (fun uu____25856 -> ())
  }
