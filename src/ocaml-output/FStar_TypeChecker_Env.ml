...
let (uu___is_UnfoldTac : step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldTac  -> true | uu___ -> false
            ...
            fun solver  ->
              fun module_lid  ->
                fun nbe  ->
                  ...
                  let uu___3 =
                    let uu___4 = FStar_Util.smap_create (Prims.of_int (10))
                       in
                  ...
                  let uu___10 = FStar_Util.smap_create (Prims.of_int (20))
                     in
                  {
                    solver;
  ...
  fun uu___  ->
    ...
    | uu___2 ->
        let uu___3 =
          ...
          let uu___5 = FStar_ST.op_Bang query_indices  in uu___4 :: uu___5
           in
           ...
           | (stack_depth,env2) ->
               ...
               (match uu___2 with
                | (query_indices_depth,()) ->
                    ...
                    (match uu___3 with
                     | (solver_depth,()) ->
                         let uu___4 = FStar_Syntax_DsEnv.snapshot env2.dsenv
                            in
                         (match uu___4 with
                          | (dsenv_depth,dsenv1) ->
        ...
        let uu___ =
          FStar_All.pipe_right qix
            (FStar_List.tryFind
               (fun uu___1  ->
                  match uu___1 with
                  | (m,uu___2) -> FStar_Ident.lid_equals l m))
           in
        (match uu___ with
         | FStar_Pervasives_Native.None  ->
...
let (inst_tscheme :
  ...
  fun uu___  ->
    ...
    | (us,t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu___1  -> new_u_univ ()))
           in
        ...
        (let uu___2 =
         ...
         then
           let lns =
             ...
             let uu___4 =
               let uu___5 = FStar_Ident.ident_of_lid l  in [uu___5]  in
           ...
           let rec aux c l1 =
             ...
             | (hd::tl,hd'::tl') when
                 ...
                 let uu___4 = FStar_Ident.string_of_id hd'  in
          ...
          | FStar_Pervasives_Native.None  ->
              let uu___1 =
                FStar_Util.find_map env1.gamma
                  (fun uu___2  ->
                     match uu___2 with
                     | FStar_Syntax_Syntax.Binding_lid (l,(us_names,t)) when
                         FStar_Ident.lid_equals lid l ->
                         let us =
                           FStar_List.map
                             (fun uu___3  ->
                                FStar_Syntax_Syntax.U_name uu___3) us_names
                            in
                         let uu___3 =
                        ...
                        | (lids,s) ->
                            ...
                            (match uu___4 with
                             ...
                             | FStar_Pervasives_Native.Some l ->
                                 let uu___5 =
                                   let uu___6 = FStar_Ident.range_of_lid l
                                      in
                                   ((FStar_Util.Inr
      ...
      fun rng  ->
        ...
        | FStar_Syntax_Syntax.Sig_new_effect ne ->
            (check_effect_is_not_a_template ne rng;
             ...
             (let uu___2 =
                let uu___3 = inst_ts us_opt ne.FStar_Syntax_Syntax.signature
                   in
                (uu___3, (se.FStar_Syntax_Syntax.sigrng))  in
              FStar_Pervasives_Native.Some uu___2))
        | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,us,binders,uu___,uu___1)
            ->
            let uu___2 =
              let uu___3 =
                let uu___4 =
              ...
              (match lr with
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigopts = uu___9;_},FStar_Pervasives_Native.None
                    )
                   ->
                   let uu___10 =
                     let uu___11 = inst_tscheme1 (uvs, t)  in (uu___11, rng)
                      in
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigopts = uu___4;_},FStar_Pervasives_Native.None
                    )
                   ->
                   let uu___5 =
                   ...
                   then
                     ...
                     (let uu___7 =
                        let uu___8 = inst_tscheme1 (uvs, t)  in (uu___8, rng)
                         in
                      FStar_Pervasives_Native.Some uu___7)
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigopts = uu___7;_},FStar_Pervasives_Native.None
                    )
                   ->
                   (match tps with
                    | [] ->
                    ...
                    | uu___8 ->
                        let uu___9 =
                          let uu___10 =
                            let uu___11 =
                              let uu___12 =
                                let uu___13 = FStar_Syntax_Syntax.mk_Total k
                                   in
               ...
               | FStar_Util.Inr
                   ({
                      ...
                      FStar_Syntax_Syntax.sigmeta = uu___5;
                      FStar_Syntax_Syntax.sigattrs = uu___6;
                      FStar_Syntax_Syntax.sigopts = uu___7;_},FStar_Pervasives_Native.Some
                    us)
                   ->
                   (match tps with
                    | [] ->
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigopts = uu___5;_},FStar_Pervasives_Native.None
            ),uu___6)
          ->
          let uu___7 =
            let uu___8 =
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigopts = uu___6;_},FStar_Pervasives_Native.None
            ),uu___7)
          ->
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigmeta = uu___8;
              FStar_Syntax_Syntax.sigattrs = uu___9;
              FStar_Syntax_Syntax.sigopts = uu___10;_},uu___11),uu___12)
          -> (true, dcs)
      | uu___1 -> (false, [])
...
let rec (non_informative : env -> FStar_Syntax_Syntax.typ -> Prims.bool) =
  fun env1  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (head,uu___1) -> non_informative env1 head
  ...
  fun env1  ->
    fun name  ->
      fun r  ->
        ...
        | FStar_Syntax_Syntax.Tm_arrow (_a::bs,uu___) -> FStar_List.length bs
        | uu___ ->
            let uu___1 =
              let uu___2 =
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigmeta = uu___3;
              FStar_Syntax_Syntax.sigattrs = uu___4;
              FStar_Syntax_Syntax.sigopts = uu___5;_},uu___6),uu___7)
          -> q
      | uu___1 -> []
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigmeta = uu___5;
              FStar_Syntax_Syntax.sigattrs = uu___6;
              FStar_Syntax_Syntax.sigopts = uu___7;_},uu___8),uu___9)
          ->
          FStar_Util.for_some
            (fun uu___10  ->
               match uu___10 with
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              ...
              FStar_Syntax_Syntax.sigopts = uu___11;_},uu___12),uu___13)
          -> true
      | uu___1 -> false
    ...
    fun m  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___1 =
            ...
            FStar_Util.format1
              "Impossible: declaration for monad %s not found" uu___2
             in
          failwith uu___1
               ...
               (if
                ...
                (let inst =
                   ...
                   FStar_List.map2
                     (fun uu___4  ->
                        fun uu___5  ->
                          ...
                          | ((x,uu___6),(t,uu___7)) ->
                              FStar_Syntax_Syntax.NT (x, t)) binders1 uu___3
                    in
                 ...
                 let c2 =
                   ...
                   FStar_All.pipe_right uu___3 FStar_Syntax_Syntax.mk_Comp
                    in
                           ...
                           let uu___7 =
                             let uu___8 =
                               FStar_All.pipe_right res_typ
                                 FStar_Syntax_Syntax.as_arg
                                in
                             uu___8 :: (c1.FStar_Syntax_Syntax.effect_args)
                              in
                           (repr, uu___7)  in
      ...
      fun tgt  ->
        fun st_mlift  ->
          let compose_edges e1 e2 =
            let composed_lift =
              let mlift_wp env2 c =
                let uu___ = FStar_All.pipe_right c ((e1.mlift).mlift_wp env2)
                   in
            ...
            FStar_All.pipe_right ms
              (FStar_List.fold_left
                 (fun edges  ->
                    fun i  ->
                      let uu___ =
                        find_edge (env1.effects).order (i, (edge1.msource))
                         in
                      match uu___ with
                      | FStar_Pervasives_Native.Some e -> e :: edges
                      | FStar_Pervasives_Native.None  -> edges) [])
             in
          let all_tgt_j =
            FStar_All.pipe_right ms
              (FStar_List.fold_left
                 (fun edges  ->
                    fun j  ->
                      let uu___ =
                        find_edge (env1.effects).order ((edge1.mtarget), j)
                         in
                      match uu___ with
                      | FStar_Pervasives_Native.Some e -> e :: edges
                      | FStar_Pervasives_Native.None  -> edges) [])
                   ...
                   FStar_List.fold_left
                     (fun edges1  ->
                        fun tgt_j  ->
                          ...
                          (let uu___1 = FStar_Ident.lid_equals src1 tgt1  in
                           ...
                           then
                             let uu___2 =
                               let uu___3 =
                                 let uu___4 =
                                   FStar_Ident.string_of_lid edge1.msource
                                    in
                                 let uu___5 =
                                   FStar_Ident.string_of_lid edge1.mtarget
                                    in
                                 let uu___6 = FStar_Ident.string_of_lid src1
                                    in
                                 FStar_Util.format3
                          ...
                          (let uu___1 =
                             let uu___2 =
                               find_edge (env1.effects).order (src1, tgt1)
                                in
                             FStar_All.pipe_right uu___2 FStar_Util.is_some
                              in
                           if uu___1
                           then edges1
                           else
                             (let uu___3 =
                                (let uu___4 =
                                   exists_polymonadic_subcomp env1 src1 tgt1
                                    in
               ...
               (fun edge2  ->
                  let uu___1 =
                    (FStar_Ident.lid_equals edge2.msource
                      ...
                      &&
                      (let uu___2 = lookup_effect_quals env1 edge2.mtarget
                          in
                       FStar_All.pipe_right uu___2
                  ...
                  then
                    let uu___2 =
                      let uu___3 =
                        let uu___4 = FStar_Ident.string_of_lid edge2.mtarget
                           in
                        FStar_Util.format1
                                           ...
                                           let uu___5 =
                                             ...
                                             FStar_All.pipe_right uu___6
                                               (fun uu___7  ->
                                                  ...
                                                  | (l,uu___8,uu___9) -> l)
                                              in
                                           FStar_Ident.lid_equals k uu___5
                                            in
              ...
              (let uu___2 =
               ...
               then
                 let uu___3 =
                   ...
                   (FStar_Errors.Fatal_Effects_Ordering_Coherence, uu___4)
                    in
      ...
      | (p,b) ->
          ...
          then "*"
            ...
            (let uu___2 = FStar_Ident.text_of_path p  in
             Prims.op_Hat (if b then "+" else "-") uu___2)
       in
    let uu___ =
      ...
      fun l  ->
        fun t  ->
          ...
          then ()
            ...
            (let uu___2 = FStar_Util.as_set l FStar_Syntax_Syntax.order_bv
                in
          ...
          let uu___1 =
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 =
                    let uu___6 = FStar_Syntax_Syntax.as_arg e  in [uu___6]
                     in
                  (f, uu___5)  in
  ...
  fun g  ->
    fun map  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___ = g  in
          let uu___1 =
            let uu___2 = map f  in FStar_TypeChecker_Common.NonTrivial uu___2
             in
          {
            FStar_TypeChecker_Common.guard_f = uu___1;
            FStar_TypeChecker_Common.deferred_to_tac =
                     ...
                     fun f2  ->
                       ...
                       then f2
                         ...
                         FStar_Syntax_Util.mk_forall u
                           (FStar_Pervasives_Native.fst b) f2) us bs f
               in
            let uu___ = g  in
            {
              FStar_TypeChecker_Common.guard_f =
                                          ...
                                          let uu___6 =
                                            let uu___7 =
                                              ...
                                              FStar_Syntax_Syntax.NT uu___8
                                               in
                                            [uu___7]  in
                                          FStar_List.append substs1 uu___6
                                           in
            ...
            let trivial_post =
              ...
              | (uu___1,post) ->
                  let uu___2 =
                    ...
                    [uu___3]  in
                  FStar_Syntax_Syntax.mk_Tm_app post uu___2 r
               in
            let uu___ =
              let uu___1 =
