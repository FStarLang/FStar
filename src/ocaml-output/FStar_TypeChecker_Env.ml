         ...
         | FStar_Pervasives_Native.Some
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Sig_new_effect uu____18194 ->
                  FStar_Pervasives_Native.None
              | FStar_Syntax_Syntax.Sig_sub_effect uu____18195 ->
                  FStar_Pervasives_Native.None
              | FStar_Syntax_Syntax.Sig_effect_abbrev uu____18196 ->
                  FStar_Pervasives_Native.None
              | FStar_Syntax_Syntax.Sig_pragma uu____18209 ->
                  FStar_Pervasives_Native.None))
      ...
      then fv.FStar_Syntax_Syntax.fv_delta
        ...
        (let uu____18227 =
           FStar_All.pipe_right lid.FStar_Ident.str
            ...
            in
         FStar_All.pipe_right uu____18227
           (fun d_opt  ->
              let uu____18240 = FStar_All.pipe_right d_opt FStar_Util.is_some
                 in
              if uu____18240
                ...
                (let uu____18250 =
                   let uu____18253 =
                     lookup_qname env
                      ...
                      in
                   delta_depth_of_qninfo fv uu____18253  in
                 match uu____18250 with
                 | FStar_Pervasives_Native.None  ->
                     let uu____18254 =
                       let uu____18256 = FStar_Syntax_Print.fv_to_string fv
                          in
                       FStar_Util.format1 "Delta depth not found for %s"
                         uu____18256
                        in
                     failwith uu____18254
                 | FStar_Pervasives_Native.Some d ->
                     ((let uu____18261 =
                       ...
                       if uu____18261
                       then
                         let uu____18264 = FStar_Syntax_Print.fv_to_string fv
                            in
                         let uu____18266 =
...
let (quals_of_qninfo :
  ...
  fun qninfo  ->
    match qninfo with
    | FStar_Pervasives_Native.Some
        (FStar_Util.Inr (se,uu____18293),uu____18294) ->
...
let (attrs_of_qninfo :
  ...
  fun qninfo  ->
    match qninfo with
    | FStar_Pervasives_Native.Some
        (FStar_Util.Inr (se,uu____18365),uu____18366) ->
        FStar_Pervasives_Native.Some (se.FStar_Syntax_Syntax.sigattrs)
    | uu____18415 -> FStar_Pervasives_Native.None
...
let (lookup_attrs_of_lid :
  ...
  fun env  ->
    fun lid  ->
      let uu____18437 = lookup_qname env lid  in
      FStar_All.pipe_left attrs_of_qninfo uu____18437
...
let (fv_with_lid_has_attr :
  ...
  fun env  ->
    fun fv_lid1  ->
      fun attr_lid  ->
        let uu____18460 = lookup_attrs_of_lid env fv_lid1  in
        ...
        | FStar_Pervasives_Native.Some attrs ->
            FStar_All.pipe_right attrs
              (FStar_Util.for_some
                 (fun tm  ->
                    let uu____18484 =
                      let uu____18485 = FStar_Syntax_Util.un_uinst tm  in
...
let (try_lookup_effect_lid :
  ...
  fun env  ->
    fun ftv  ->
      let uu____18524 = lookup_qname env ftv  in
      match uu____18524 with
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr (se,FStar_Pervasives_Native.None ),uu____18528) ->
          let uu____18573 = effect_signature FStar_Pervasives_Native.None se
             in
          (match uu____18573 with
           | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
           | FStar_Pervasives_Native.Some ((uu____18594,t),r) ->
               let uu____18609 =
                 let uu____18610 = FStar_Ident.range_of_lid ftv  in
                 FStar_Syntax_Subst.set_use_range uu____18610 t  in
               FStar_Pervasives_Native.Some uu____18609)
      | uu____18611 -> FStar_Pervasives_Native.None
  
let (lookup_effect_lid :
  env -> FStar_Ident.lident -> FStar_Syntax_Syntax.term) =
  fun env  ->
    fun ftv  ->
      let uu____18623 = try_lookup_effect_lid env ftv  in
      match uu____18623 with
      | FStar_Pervasives_Native.None  ->
          let uu____18626 = name_not_found ftv  in
          let uu____18632 = FStar_Ident.range_of_lid ftv  in
          FStar_Errors.raise_error uu____18626 uu____18632
...
let (lookup_effect_abbrev :
  ...
  fun env  ->
    fun univ_insts  ->
      fun lid0  ->
        let uu____18656 = lookup_qname env lid0  in
        ...
        | FStar_Pervasives_Native.Some
            (FStar_Util.Inr
             ({
                FStar_Syntax_Syntax.sigel =
                  FStar_Syntax_Syntax.Sig_effect_abbrev
                  (lid,univs1,binders,c,uu____18667);
                FStar_Syntax_Syntax.sigrng = uu____18668;
                FStar_Syntax_Syntax.sigquals = quals;
                FStar_Syntax_Syntax.sigmeta = uu____18670;
                FStar_Syntax_Syntax.sigattrs = uu____18671;_},FStar_Pervasives_Native.None
              ),uu____18672)
            ->
            let lid1 =
              let uu____18726 =
                let uu____18727 = FStar_Ident.range_of_lid lid  in
                let uu____18728 =
                  let uu____18729 = FStar_Ident.range_of_lid lid0  in
                  FStar_Range.use_range uu____18729  in
                FStar_Range.set_use_range uu____18727 uu____18728  in
              FStar_Ident.set_lid_range lid uu____18726  in
            let uu____18730 =
              FStar_All.pipe_right quals
                (FStar_Util.for_some
                   (fun uu___6_18736  ->
                      match uu___6_18736 with
            ...
            then FStar_Pervasives_Native.None
              ...
              (let insts =
                 ...
                 then univ_insts
                   ...
                   (let uu____18758 =
                      let uu____18760 =
                        let uu____18762 = get_range env  in
                        FStar_Range.string_of_range uu____18762  in
                      let uu____18763 = FStar_Syntax_Print.lid_to_string lid1
                         in
                      let uu____18765 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____18760 uu____18763 uu____18765
                       in
                    failwith uu____18758)
                  in
               match (binders, univs1) with
               | ([],uu____18786) ->
                   failwith
                     "Unexpected effect abbreviation with no arguments"
               | (uu____18812,uu____18813::uu____18814::uu____18815) ->
                   let uu____18836 =
                     let uu____18838 = FStar_Syntax_Print.lid_to_string lid1
                        in
                     let uu____18840 =
                       FStar_All.pipe_left FStar_Util.string_of_int
                         (FStar_List.length univs1)
                     ...
                     FStar_Util.format2
                       ...
                       uu____18838 uu____18840
                      in
                   failwith uu____18836
               | uu____18851 ->
                   let uu____18866 =
                     let uu____18871 =
                       let uu____18872 = FStar_Syntax_Util.arrow binders c
                          in
                       (univs1, uu____18872)  in
                     inst_tscheme_with uu____18871 insts  in
                   (match uu____18866 with
                    | (uu____18885,t) ->
                        let t1 =
                          let uu____18888 = FStar_Ident.range_of_lid lid1  in
                          FStar_Syntax_Subst.set_use_range uu____18888 t  in
                        let uu____18889 =
                          let uu____18890 = FStar_Syntax_Subst.compress t1
                             in
                          uu____18890.FStar_Syntax_Syntax.n  in
                        (match uu____18889 with
                         | FStar_Syntax_Syntax.Tm_arrow (binders1,c1) ->
                             FStar_Pervasives_Native.Some (binders1, c1)
                         | uu____18925 -> failwith "Impossible")))
        | uu____18933 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun l  ->
      let rec find1 l1 =
        ...
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (uu____18970,c) ->
            let l2 = FStar_Syntax_Util.comp_effect_name c  in
            let uu____18977 = find1 l2  in
            ...
            (match uu____18988 with
             ...
             | FStar_Pervasives_Native.Some m ->
                 (FStar_Util.smap_add env.normalized_eff_names
                  ...
                  m))
         in
      let uu____18993 = FStar_Ident.range_of_lid l  in
      FStar_Ident.set_lid_range res uu____18993
...
let (lookup_effect_quals :
  ...
  fun env  ->
    fun l  ->
      ...
      let uu____19008 = lookup_qname env l1  in
          ...
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect
                uu____19011;
              FStar_Syntax_Syntax.sigrng = uu____19012;
              FStar_Syntax_Syntax.sigquals = q;
              FStar_Syntax_Syntax.sigmeta = uu____19014;
              FStar_Syntax_Syntax.sigattrs = uu____19015;_},uu____19016),uu____19017)
          -> q
      | uu____19068 -> []
...
let (lookup_projector :
  ...
  fun env  ->
    fun lid  ->
      fun i  ->
        let fail1 uu____19092 =
          let uu____19093 =
            let uu____19095 = FStar_Util.string_of_int i  in
            let uu____19097 = FStar_Syntax_Print.lid_to_string lid  in
            FStar_Util.format2
              "Impossible: projecting field #%s from constructor %s is undefined"
              uu____19095 uu____19097
             in
          failwith uu____19093  in
        let uu____19100 = lookup_datacon env lid  in
        match uu____19100 with
        | (uu____19105,t) ->
            let uu____19107 =
              let uu____19108 = FStar_Syntax_Subst.compress t  in
              uu____19108.FStar_Syntax_Syntax.n  in
            (match uu____19107 with
             | FStar_Syntax_Syntax.Tm_arrow (binders,uu____19112) ->
                 if
                   (i < (Prims.parse_int "0")) ||
...
let (is_projector : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____19181 = lookup_qname env l  in
      match uu____19181 with
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ
                (uu____19183,uu____19184,uu____19185);
              FStar_Syntax_Syntax.sigrng = uu____19186;
              FStar_Syntax_Syntax.sigquals = quals;
              FStar_Syntax_Syntax.sigmeta = uu____19188;
              FStar_Syntax_Syntax.sigattrs = uu____19189;_},uu____19190),uu____19191)
          ->
          FStar_Util.for_some
            (fun uu___7_19244  ->
               match uu___7_19244 with
               | FStar_Syntax_Syntax.Projector uu____19246 -> true
               | uu____19252 -> false) quals
      | uu____19254 -> false
  
let (is_datacon : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____19268 = lookup_qname env lid  in
      match uu____19268 with
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
                (uu____19270,uu____19271,uu____19272,uu____19273,uu____19274,uu____19275);
              FStar_Syntax_Syntax.sigrng = uu____19276;
              FStar_Syntax_Syntax.sigquals = uu____19277;
              FStar_Syntax_Syntax.sigmeta = uu____19278;
              FStar_Syntax_Syntax.sigattrs = uu____19279;_},uu____19280),uu____19281)
          -> true
      | uu____19339 -> false
...
let (is_record : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____19353 = lookup_qname env lid  in
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel =
                FStar_Syntax_Syntax.Sig_inductive_typ
                (uu____19355,uu____19356,uu____19357,uu____19358,uu____19359,uu____19360);
              FStar_Syntax_Syntax.sigrng = uu____19361;
              FStar_Syntax_Syntax.sigquals = quals;
              FStar_Syntax_Syntax.sigmeta = uu____19363;
              FStar_Syntax_Syntax.sigattrs = uu____19364;_},uu____19365),uu____19366)
          ->
          FStar_Util.for_some
            (fun uu___8_19427  ->
               match uu___8_19427 with
               | FStar_Syntax_Syntax.RecordType uu____19429 -> true
               | FStar_Syntax_Syntax.RecordConstructor uu____19439 -> true
               | uu____19449 -> false) quals
      | uu____19451 -> false
...
let (qninfo_is_action : qninfo -> Prims.bool) =
  fun qninfo  ->
    ...
    | FStar_Pervasives_Native.Some
        ...
        FStar_Util.for_some
          (fun uu___9_19525  ->
             match uu___9_19525 with
             | FStar_Syntax_Syntax.Action uu____19527 -> true
             | uu____19529 -> false) quals
    | uu____19531 -> false
  
let (is_action : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____19545 = lookup_qname env lid  in
      FStar_All.pipe_left qninfo_is_action uu____19545
...
let (is_interpreted : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  ...
  fun env  ->
    fun head1  ->
      let uu____19562 =
        let uu____19563 = FStar_Syntax_Util.un_uinst head1  in
        uu____19563.FStar_Syntax_Syntax.n  in
      match uu____19562 with
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          (match fv.FStar_Syntax_Syntax.fv_delta with
           | FStar_Syntax_Syntax.Delta_equational_at_level uu____19569 ->
               true
           | uu____19572 -> false)
      | uu____19574 -> false
...
let (is_irreducible : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____19588 = lookup_qname env l  in
      match uu____19588 with
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr (se,uu____19591),uu____19592) ->
          FStar_Util.for_some
            (fun uu___10_19640  ->
               match uu___10_19640 with
               | FStar_Syntax_Syntax.Irreducible  -> true
               | uu____19643 -> false) se.FStar_Syntax_Syntax.sigquals
      | uu____19645 -> false
  ...
  fun env  ->
    fun lid  ->
      let mapper x =
        ...
        | FStar_Util.Inl uu____19721 -> FStar_Pervasives_Native.Some false
        | FStar_Util.Inr (se,uu____19739) ->
            (match se.FStar_Syntax_Syntax.sigel with
             | FStar_Syntax_Syntax.Sig_declare_typ uu____19757 ->
                 FStar_Pervasives_Native.Some
                   (FStar_List.contains FStar_Syntax_Syntax.New
                      se.FStar_Syntax_Syntax.sigquals)
             | FStar_Syntax_Syntax.Sig_inductive_typ uu____19765 ->
                 FStar_Pervasives_Native.Some true
             | uu____19784 -> FStar_Pervasives_Native.Some false)
         in
      let uu____19787 =
        let uu____19791 = lookup_qname env lid  in
        FStar_Util.bind_opt uu____19791 mapper  in
...
let (num_inductive_ty_params :
  ...
  fun env  ->
    fun lid  ->
      let uu____19851 = lookup_qname env lid  in
      ...
      | FStar_Pervasives_Native.Some
          (FStar_Util.Inr
           ({
              FStar_Syntax_Syntax.sigel =
                FStar_Syntax_Syntax.Sig_inductive_typ
                (uu____19855,uu____19856,tps,uu____19858,uu____19859,uu____19860);
              FStar_Syntax_Syntax.sigrng = uu____19861;
              FStar_Syntax_Syntax.sigquals = uu____19862;
              FStar_Syntax_Syntax.sigmeta = uu____19863;
              FStar_Syntax_Syntax.sigattrs = uu____19864;_},uu____19865),uu____19866)
          -> FStar_Pervasives_Native.Some (FStar_List.length tps)
      | uu____19932 -> FStar_Pervasives_Native.None
...
let (get_effect_decl :
  ...
  fun env  ->
    fun l  ->
      let uu____20003 = effect_decl_opt env l  in
      match uu____20003 with
      | FStar_Pervasives_Native.None  ->
          let uu____20018 = name_not_found l  in
          let uu____20024 = FStar_Ident.range_of_lid l  in
          FStar_Errors.raise_error uu____20018 uu____20024
      | FStar_Pervasives_Native.Some md -> FStar_Pervasives_Native.fst md
  
let (identity_mlift : mlift) =
  {
    mlift_wp = (fun uu____20047  -> fun t  -> fun wp  -> wp);
    mlift_term =
      (FStar_Pervasives_Native.Some
         (fun uu____20066  ->
...
let (join :
  ...
  fun env  ->
    fun l1  ->
      fun l2  ->
        let uu____20098 = FStar_Ident.lid_equals l1 l2  in
        if uu____20098
           ...
           then
             ...
             (let uu____20120 =
                FStar_All.pipe_right (env.effects).joins
                  (FStar_Util.find_opt
                     (fun uu____20173  ->
                        ...
                        | (m1,m2,uu____20187,uu____20188,uu____20189) ->
              ...
              | FStar_Pervasives_Native.None  ->
                  let uu____20206 =
                    let uu____20212 =
                      let uu____20214 = FStar_Syntax_Print.lid_to_string l1
                         in
                      let uu____20216 = FStar_Syntax_Print.lid_to_string l2
                         in
                      FStar_Util.format2
                        "Effects %s and %s cannot be composed" uu____20214
                        uu____20216
                       in
                    (FStar_Errors.Fatal_EffectsCannotBeComposed, uu____20212)
                     in
                  FStar_Errors.raise_error uu____20206 env.range
              | FStar_Pervasives_Native.Some
                  (uu____20226,uu____20227,m3,j1,j2) -> (m3, j1, j2)))
...
let wp_sig_aux :
  'Auu____20281 .
    (FStar_Syntax_Syntax.eff_decl * 'Auu____20281) Prims.list ->
      FStar_Ident.lident ->
           ...
           | (uu____20384,s) ->
               ...
               (match ((md.FStar_Syntax_Syntax.binders),
                ...
                | ([],FStar_Syntax_Syntax.Tm_arrow
                   ((a,uu____20402)::(wp,uu____20404)::[],c)) when
                    FStar_Syntax_Syntax.is_teff
                      (FStar_Syntax_Util.comp_result c)
                    -> (a, (wp.FStar_Syntax_Syntax.sort))
                | uu____20460 -> failwith "Impossible"))
               ...
               (let eff_name1 = norm_eff_name env eff_name  in
                ...
                let null_wp =
                  inst_effect_fun_with [res_u] env ed
                   ...
                   in
                let null_wp_res =
                  let uu____20534 = get_range env  in
                  let uu____20535 =
                    let uu____20542 =
                      let uu____20543 =
                        let uu____20560 =
                          let uu____20571 = FStar_Syntax_Syntax.as_arg res_t
                             in
                          [uu____20571]  in
                        (null_wp, uu____20560)  in
                      FStar_Syntax_Syntax.Tm_app uu____20543  in
                    FStar_Syntax_Syntax.mk uu____20542  in
                  uu____20535 FStar_Pervasives_Native.None uu____20534  in
                let uu____20608 =
                  let uu____20609 =
                    let uu____20620 = FStar_Syntax_Syntax.as_arg null_wp_res
                       in
                    [uu____20620]  in
                  {
                    ...
                    FStar_Syntax_Syntax.effect_args = uu____20609;
                    FStar_Syntax_Syntax.flags = []
                  }  in
                FStar_Syntax_Syntax.mk_Comp uu____20608))
...
let (build_lattice : env -> FStar_Syntax_Syntax.sigelt -> env) =
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ne ->
          let effects =
            let uu___1496_20658 = env.effects  in
            {
              decls = ((ne, (se.FStar_Syntax_Syntax.sigquals)) ::
                ((env.effects).decls));
              order = (uu___1496_20658.order);
              joins = (uu___1496_20658.joins)
            }  in
          let uu___1499_20667 = env  in
          {
            solver = (uu___1499_20667.solver);
            range = (uu___1499_20667.range);
            curmodule = (uu___1499_20667.curmodule);
            gamma = (uu___1499_20667.gamma);
            gamma_sig = (uu___1499_20667.gamma_sig);
            gamma_cache = (uu___1499_20667.gamma_cache);
            modules = (uu___1499_20667.modules);
            expected_typ = (uu___1499_20667.expected_typ);
            sigtab = (uu___1499_20667.sigtab);
            attrtab = (uu___1499_20667.attrtab);
            is_pattern = (uu___1499_20667.is_pattern);
            instantiate_imp = (uu___1499_20667.instantiate_imp);
            effects;
            generalize = (uu___1499_20667.generalize);
            letrecs = (uu___1499_20667.letrecs);
            top_level = (uu___1499_20667.top_level);
            check_uvars = (uu___1499_20667.check_uvars);
            use_eq = (uu___1499_20667.use_eq);
            is_iface = (uu___1499_20667.is_iface);
            admit = (uu___1499_20667.admit);
            lax = (uu___1499_20667.lax);
            lax_universes = (uu___1499_20667.lax_universes);
            phase1 = (uu___1499_20667.phase1);
            failhard = (uu___1499_20667.failhard);
            nosynth = (uu___1499_20667.nosynth);
            uvar_subtyping = (uu___1499_20667.uvar_subtyping);
            tc_term = (uu___1499_20667.tc_term);
            type_of = (uu___1499_20667.type_of);
            universe_of = (uu___1499_20667.universe_of);
            check_type_of = (uu___1499_20667.check_type_of);
            use_bv_sorts = (uu___1499_20667.use_bv_sorts);
            qtbl_name_and_index = (uu___1499_20667.qtbl_name_and_index);
            normalized_eff_names = (uu___1499_20667.normalized_eff_names);
            fv_delta_depths = (uu___1499_20667.fv_delta_depths);
            proof_ns = (uu___1499_20667.proof_ns);
            synth_hook = (uu___1499_20667.synth_hook);
            splice = (uu___1499_20667.splice);
            postprocess = (uu___1499_20667.postprocess);
            is_native_tactic = (uu___1499_20667.is_native_tactic);
            identifier_info = (uu___1499_20667.identifier_info);
            tc_hooks = (uu___1499_20667.tc_hooks);
            dsenv = (uu___1499_20667.dsenv);
            nbe = (uu___1499_20667.nbe)
          }
      | FStar_Syntax_Syntax.Sig_sub_effect sub1 ->
          let compose_edges e1 e2 =
            let composed_lift =
              let mlift_wp u r wp1 =
                let uu____20697 = (e1.mlift).mlift_wp u r wp1  in
                (e2.mlift).mlift_wp u r uu____20697  in
              let mlift_term =
                    ...
                    FStar_Pervasives_Native.Some
                      ((fun u  ->
                          fun t  ->
                            fun wp  ->
                              fun e  ->
                                let uu____20855 = (e1.mlift).mlift_wp u t wp
                                   in
                                let uu____20856 = l1 u t wp e  in
                                l2 u t uu____20855 uu____20856))
                | uu____20857 -> FStar_Pervasives_Native.None  in
          ...
          let mk_mlift_wp lift_t u r wp1 =
            let uu____20929 = inst_tscheme_with lift_t [u]  in
            ...
            | (uu____20936,lift_t1) ->
                let uu____20938 =
                  let uu____20945 =
                    let uu____20946 =
                      let uu____20963 =
                        let uu____20974 = FStar_Syntax_Syntax.as_arg r  in
                        let uu____20983 =
                          let uu____20994 = FStar_Syntax_Syntax.as_arg wp1
                             in
                          [uu____20994]  in
                        uu____20974 :: uu____20983  in
                      (lift_t1, uu____20963)  in
                    FStar_Syntax_Syntax.Tm_app uu____20946  in
                  FStar_Syntax_Syntax.mk uu____20945  in
          ...
          let mk_mlift_term lift_t u r wp1 e =
            let uu____21104 = inst_tscheme_with lift_t [u]  in
            ...
            | (uu____21111,lift_t1) ->
                let uu____21113 =
                  let uu____21120 =
                    let uu____21121 =
                      let uu____21138 =
                        let uu____21149 = FStar_Syntax_Syntax.as_arg r  in
                        let uu____21158 =
                          let uu____21169 = FStar_Syntax_Syntax.as_arg wp1
                             in
                          let uu____21178 =
                            let uu____21189 = FStar_Syntax_Syntax.as_arg e
                               in
                            [uu____21189]  in
                          uu____21169 :: uu____21178  in
                        uu____21149 :: uu____21158  in
                      (lift_t1, uu____21138)  in
                    FStar_Syntax_Syntax.Tm_app uu____21121  in
                  FStar_Syntax_Syntax.mk uu____21120  in
                uu____21113 FStar_Pervasives_Native.None
          ...
          let print_mlift l =
            let bogus_term s =
              let uu____21291 =
                ...
                FStar_Syntax_Syntax.lid_as_fv uu____21292
                  FStar_Syntax_Syntax.delta_constant
                  FStar_Pervasives_Native.None
                 in
              FStar_Syntax_Syntax.fv_to_tm uu____21291  in
            let arg = bogus_term "ARG"  in
            let wp = bogus_term "WP"  in
            let e = bogus_term "COMP"  in
            let uu____21301 =
              let uu____21303 = l.mlift_wp FStar_Syntax_Syntax.U_zero arg wp
                 in
              FStar_Syntax_Print.term_to_string uu____21303  in
            let uu____21304 =
              let uu____21306 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     let uu____21334 = l1 FStar_Syntax_Syntax.U_zero arg wp e
                        in
                     FStar_Syntax_Print.term_to_string uu____21334)
                 in
              FStar_Util.dflt "none" uu____21306  in
            FStar_Util.format2 "{ wp : %s ; term : %s }" uu____21301
              uu____21304
             in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____21363  ->
                    ...
                    | (e,uu____21371) -> e.FStar_Syntax_Syntax.mname))
             in
          let find_edge order1 uu____21394 =
            match uu____21394 with
            | (i,j) ->
                let uu____21405 = FStar_Ident.lid_equals i j  in
                if uu____21405
                then
                  FStar_All.pipe_right (id_edge i)
                    (fun _21412  -> FStar_Pervasives_Native.Some _21412)
                else
            ...
            let fold_fun order1 k =
              let uu____21441 =
                FStar_All.pipe_right ms
                  (FStar_List.collect
                     (fun i  ->
                        let uu____21451 = FStar_Ident.lid_equals i k  in
                        if uu____21451
                        then []
                        else
                          FStar_All.pipe_right ms
                               ...
                               (fun j  ->
                                  ...
                                  then []
                                    ...
                                    (let uu____21472 =
                                     ...
                                     | uu____21500 -> [])))))
                 in
              FStar_List.append order1 uu____21441  in
                   ...
                   then
                     let uu____21540 =
                       ...
                       (FStar_Errors.Fatal_DivergentComputationCannotBeIncludedInTotal,
                         uu____21546)
                        in
                     let uu____21550 = get_range env  in
                     FStar_Errors.raise_error uu____21540 uu____21550
                   else ()));
           (let joins =
              FStar_All.pipe_right ms
                (FStar_List.collect
                   (fun i  ->
                      FStar_All.pipe_right ms
                        (FStar_List.collect
                           (fun j  ->
                              let join_opt =
                                let uu____21628 = FStar_Ident.lid_equals i j
                                   in
                                if uu____21628
                                then
                                  FStar_Pervasives_Native.Some
               ...
               in
            let effects =
              let uu___1626_21889 = env.effects  in
              { decls = (uu___1626_21889.decls); order = order2; joins }  in
            let uu___1629_21890 = env  in
            {
              solver = (uu___1629_21890.solver);
              range = (uu___1629_21890.range);
              curmodule = (uu___1629_21890.curmodule);
              gamma = (uu___1629_21890.gamma);
              gamma_sig = (uu___1629_21890.gamma_sig);
              gamma_cache = (uu___1629_21890.gamma_cache);
              modules = (uu___1629_21890.modules);
              expected_typ = (uu___1629_21890.expected_typ);
              sigtab = (uu___1629_21890.sigtab);
              attrtab = (uu___1629_21890.attrtab);
              is_pattern = (uu___1629_21890.is_pattern);
              instantiate_imp = (uu___1629_21890.instantiate_imp);
              effects;
              generalize = (uu___1629_21890.generalize);
              letrecs = (uu___1629_21890.letrecs);
              top_level = (uu___1629_21890.top_level);
              check_uvars = (uu___1629_21890.check_uvars);
              use_eq = (uu___1629_21890.use_eq);
              is_iface = (uu___1629_21890.is_iface);
              admit = (uu___1629_21890.admit);
              lax = (uu___1629_21890.lax);
              lax_universes = (uu___1629_21890.lax_universes);
              phase1 = (uu___1629_21890.phase1);
              failhard = (uu___1629_21890.failhard);
              nosynth = (uu___1629_21890.nosynth);
              uvar_subtyping = (uu___1629_21890.uvar_subtyping);
              tc_term = (uu___1629_21890.tc_term);
              type_of = (uu___1629_21890.type_of);
              universe_of = (uu___1629_21890.universe_of);
              check_type_of = (uu___1629_21890.check_type_of);
              use_bv_sorts = (uu___1629_21890.use_bv_sorts);
              qtbl_name_and_index = (uu___1629_21890.qtbl_name_and_index);
              normalized_eff_names = (uu___1629_21890.normalized_eff_names);
              fv_delta_depths = (uu___1629_21890.fv_delta_depths);
              proof_ns = (uu___1629_21890.proof_ns);
              synth_hook = (uu___1629_21890.synth_hook);
              splice = (uu___1629_21890.splice);
              postprocess = (uu___1629_21890.postprocess);
              is_native_tactic = (uu___1629_21890.is_native_tactic);
              identifier_info = (uu___1629_21890.identifier_info);
              tc_hooks = (uu___1629_21890.tc_hooks);
              dsenv = (uu___1629_21890.dsenv);
              nbe = (uu___1629_21890.nbe)
            }))
      | uu____21891 -> env
  ...
  fun env  ->
    fun comp  ->
      ...
      | FStar_Pervasives_Native.Some (binders,cdef) ->
          let uu____21950 = FStar_Syntax_Subst.open_comp binders cdef  in
           ...
           | (binders1,cdef1) ->
               (if
                     ...
                     let uu____21981 =
                       ...
                       let uu____21991 =
                         FStar_Util.string_of_int
                          ...
                          in
                       let uu____22002 =
                         let uu____22004 = FStar_Syntax_Syntax.mk_Comp c  in
                         FStar_Syntax_Print.comp_to_string uu____22004  in
                       FStar_Util.format3
                         "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s"
                         uu____21983 uu____21991 uu____22002
                        in
                ...
                (let inst1 =
                   let uu____22012 =
                     let uu____22023 =
                       FStar_Syntax_Syntax.as_arg
                        ...
                        in
                     uu____22023 :: (c.FStar_Syntax_Syntax.effect_args)  in
                   FStar_List.map2
                     (fun uu____22060  ->
                        fun uu____22061  ->
                          match (uu____22060, uu____22061) with
                          | ((x,uu____22091),(t,uu____22093)) ->
                 ...
                 let c2 =
                   let uu____22124 =
                     let uu___1667_22125 = comp_to_comp_typ env c1  in
                     {
                       FStar_Syntax_Syntax.comp_univs =
                         (uu___1667_22125.FStar_Syntax_Syntax.comp_univs);
                       FStar_Syntax_Syntax.effect_name =
                         (uu___1667_22125.FStar_Syntax_Syntax.effect_name);
                       FStar_Syntax_Syntax.result_typ =
                         (uu___1667_22125.FStar_Syntax_Syntax.result_typ);
                       FStar_Syntax_Syntax.effect_args =
                         (uu___1667_22125.FStar_Syntax_Syntax.effect_args);
                       FStar_Syntax_Syntax.flags =
    ...
    fun env  ->
      fun c  ->
        fun u_c  ->
          ...
          let uu____22167 = effect_decl_opt env effect_name  in
          ...
          | FStar_Pervasives_Native.Some (ed,qualifiers) ->
              let uu____22200 =
                let uu____22201 =
                  FStar_Syntax_Subst.compress
                   ...
                   in
                uu____22201.FStar_Syntax_Syntax.n  in
              (match uu____22200 with
               ...
               | uu____22210 ->
                         ...
                         let message =
                           let uu____22272 =
                             FStar_Util.format1
                              ...
                              in
                           Prims.op_Hat uu____22272
                             (Prims.op_Hat
                                "This usually happens when you use a partially applied DM4F effect, "
                                "like [TAC int] instead of [Tac int].")
                            in
                         let uu____22277 = get_range env  in
                   ...
                   then
                     let uu____22297 =
                       let uu____22300 = get_range env  in
                       let uu____22301 =
                         let uu____22308 =
                           let uu____22309 =
                             let uu____22326 =
                               ...
                               [uu____22337; wp]  in
                             (repr, uu____22326)  in
                           FStar_Syntax_Syntax.Tm_app uu____22309  in
                         FStar_Syntax_Syntax.mk uu____22308  in
                       uu____22301 FStar_Pervasives_Native.None uu____22300
                        in
                     FStar_Pervasives_Native.Some uu____22297
                   else
                     (let mrelation =
                        match ed.FStar_Syntax_Syntax.mrelation with
                        | FStar_Pervasives_Native.None  ->
                            let uu____22391 = get_range env  in
                            FStar_Errors.raise_error
                          ...
                          let uu____22407 =
                            let uu____22408 =
                              let uu____22425 =
                                ...
                                [uu____22436]  in
                              (repr, uu____22425)  in
                            FStar_Syntax_Syntax.Tm_app uu____22408  in
                          FStar_Syntax_Syntax.mk uu____22407  in
                        uu____22400 FStar_Pervasives_Native.None
                      ...
                      let ref =
                        let uu____22477 =
                          let uu____22488 = FStar_Syntax_Syntax.iarg res_typ
                             in
                          let uu____22497 =
                            let uu____22508 =
                              let uu____22517 =
                                FStar_Syntax_Syntax.bv_to_name bv  in
                              FStar_Syntax_Syntax.as_arg uu____22517  in
                            [uu____22508; wp]  in
                          uu____22488 :: uu____22497  in
                        FStar_Syntax_Util.mk_app mrelation uu____22477  in
...
let (is_reifiable_function : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun env  ->
    fun t  ->
      let uu____22667 =
        let uu____22668 = FStar_Syntax_Subst.compress t  in
        uu____22668.FStar_Syntax_Syntax.n  in
      match uu____22667 with
      | FStar_Syntax_Syntax.Tm_arrow (uu____22672,c) ->
  ...
  fun env  ->
    fun c  ->
      fun u_c  ->
        ...
        (let uu____22714 =
           let uu____22716 = is_reifiable_effect env l  in
           Prims.op_Negation uu____22716  in
         if uu____22714
         then
           let uu____22719 =
             let uu____22725 =
               let uu____22727 = FStar_Ident.string_of_lid l  in
               FStar_Util.format1 "Effect %s cannot be reified" uu____22727
                in
             (FStar_Errors.Fatal_EffectCannotBeReified, uu____22725)  in
           let uu____22731 = get_range env  in
           FStar_Errors.raise_error uu____22719 uu____22731
         else ());
        (let uu____22734 = effect_repr_aux true env c u_c  in
...
let (push_sigelt : env -> FStar_Syntax_Syntax.sigelt -> env) =
  fun env  ->
    fun s  ->
      ...
      let env1 =
        let uu___1741_22770 = env  in
        {
          solver = (uu___1741_22770.solver);
          range = (uu___1741_22770.range);
          curmodule = (uu___1741_22770.curmodule);
          gamma = (uu___1741_22770.gamma);
          gamma_sig = (sb :: (env.gamma_sig));
          gamma_cache = (uu___1741_22770.gamma_cache);
          modules = (uu___1741_22770.modules);
          expected_typ = (uu___1741_22770.expected_typ);
          sigtab = (uu___1741_22770.sigtab);
          attrtab = (uu___1741_22770.attrtab);
          is_pattern = (uu___1741_22770.is_pattern);
          instantiate_imp = (uu___1741_22770.instantiate_imp);
          effects = (uu___1741_22770.effects);
          generalize = (uu___1741_22770.generalize);
          letrecs = (uu___1741_22770.letrecs);
          top_level = (uu___1741_22770.top_level);
          check_uvars = (uu___1741_22770.check_uvars);
          use_eq = (uu___1741_22770.use_eq);
          is_iface = (uu___1741_22770.is_iface);
          admit = (uu___1741_22770.admit);
          lax = (uu___1741_22770.lax);
          lax_universes = (uu___1741_22770.lax_universes);
          phase1 = (uu___1741_22770.phase1);
          failhard = (uu___1741_22770.failhard);
          nosynth = (uu___1741_22770.nosynth);
          uvar_subtyping = (uu___1741_22770.uvar_subtyping);
          tc_term = (uu___1741_22770.tc_term);
          type_of = (uu___1741_22770.type_of);
          universe_of = (uu___1741_22770.universe_of);
          check_type_of = (uu___1741_22770.check_type_of);
          use_bv_sorts = (uu___1741_22770.use_bv_sorts);
          qtbl_name_and_index = (uu___1741_22770.qtbl_name_and_index);
          normalized_eff_names = (uu___1741_22770.normalized_eff_names);
          fv_delta_depths = (uu___1741_22770.fv_delta_depths);
          proof_ns = (uu___1741_22770.proof_ns);
          synth_hook = (uu___1741_22770.synth_hook);
          splice = (uu___1741_22770.splice);
          postprocess = (uu___1741_22770.postprocess);
          is_native_tactic = (uu___1741_22770.is_native_tactic);
          identifier_info = (uu___1741_22770.identifier_info);
          tc_hooks = (uu___1741_22770.tc_hooks);
          dsenv = (uu___1741_22770.dsenv);
          nbe = (uu___1741_22770.nbe)
        }  in
      add_sigelt env1 s;
...
let (push_local_binding : env -> FStar_Syntax_Syntax.binding -> env) =
  fun env  ->
    fun b  ->
      let uu___1748_22784 = env  in
      {
        solver = (uu___1748_22784.solver);
        range = (uu___1748_22784.range);
        curmodule = (uu___1748_22784.curmodule);
        gamma = (b :: (env.gamma));
        gamma_sig = (uu___1748_22784.gamma_sig);
        gamma_cache = (uu___1748_22784.gamma_cache);
        modules = (uu___1748_22784.modules);
        expected_typ = (uu___1748_22784.expected_typ);
        sigtab = (uu___1748_22784.sigtab);
        attrtab = (uu___1748_22784.attrtab);
        is_pattern = (uu___1748_22784.is_pattern);
        instantiate_imp = (uu___1748_22784.instantiate_imp);
        effects = (uu___1748_22784.effects);
        generalize = (uu___1748_22784.generalize);
        letrecs = (uu___1748_22784.letrecs);
        top_level = (uu___1748_22784.top_level);
        check_uvars = (uu___1748_22784.check_uvars);
        use_eq = (uu___1748_22784.use_eq);
        is_iface = (uu___1748_22784.is_iface);
        admit = (uu___1748_22784.admit);
        lax = (uu___1748_22784.lax);
        lax_universes = (uu___1748_22784.lax_universes);
        phase1 = (uu___1748_22784.phase1);
        failhard = (uu___1748_22784.failhard);
        nosynth = (uu___1748_22784.nosynth);
        uvar_subtyping = (uu___1748_22784.uvar_subtyping);
        tc_term = (uu___1748_22784.tc_term);
        type_of = (uu___1748_22784.type_of);
        universe_of = (uu___1748_22784.universe_of);
        check_type_of = (uu___1748_22784.check_type_of);
        use_bv_sorts = (uu___1748_22784.use_bv_sorts);
        qtbl_name_and_index = (uu___1748_22784.qtbl_name_and_index);
        normalized_eff_names = (uu___1748_22784.normalized_eff_names);
        fv_delta_depths = (uu___1748_22784.fv_delta_depths);
        proof_ns = (uu___1748_22784.proof_ns);
        synth_hook = (uu___1748_22784.synth_hook);
        splice = (uu___1748_22784.splice);
        postprocess = (uu___1748_22784.postprocess);
        is_native_tactic = (uu___1748_22784.is_native_tactic);
        identifier_info = (uu___1748_22784.identifier_info);
        tc_hooks = (uu___1748_22784.tc_hooks);
        dsenv = (uu___1748_22784.dsenv);
        nbe = (uu___1748_22784.nbe)
      }
...
let (pop_bv :
  ...
  fun env  ->
    ...
    | (FStar_Syntax_Syntax.Binding_var x)::rest ->
        FStar_Pervasives_Native.Some
          (x,
            (let uu___1761_22842 = env  in
             {
               solver = (uu___1761_22842.solver);
               range = (uu___1761_22842.range);
               curmodule = (uu___1761_22842.curmodule);
               gamma = rest;
               gamma_sig = (uu___1761_22842.gamma_sig);
               gamma_cache = (uu___1761_22842.gamma_cache);
               modules = (uu___1761_22842.modules);
               expected_typ = (uu___1761_22842.expected_typ);
               sigtab = (uu___1761_22842.sigtab);
               attrtab = (uu___1761_22842.attrtab);
               is_pattern = (uu___1761_22842.is_pattern);
               instantiate_imp = (uu___1761_22842.instantiate_imp);
               effects = (uu___1761_22842.effects);
               generalize = (uu___1761_22842.generalize);
               letrecs = (uu___1761_22842.letrecs);
               top_level = (uu___1761_22842.top_level);
               check_uvars = (uu___1761_22842.check_uvars);
               use_eq = (uu___1761_22842.use_eq);
               is_iface = (uu___1761_22842.is_iface);
               admit = (uu___1761_22842.admit);
               lax = (uu___1761_22842.lax);
               lax_universes = (uu___1761_22842.lax_universes);
               phase1 = (uu___1761_22842.phase1);
               failhard = (uu___1761_22842.failhard);
               nosynth = (uu___1761_22842.nosynth);
               uvar_subtyping = (uu___1761_22842.uvar_subtyping);
               tc_term = (uu___1761_22842.tc_term);
               type_of = (uu___1761_22842.type_of);
               universe_of = (uu___1761_22842.universe_of);
               check_type_of = (uu___1761_22842.check_type_of);
               use_bv_sorts = (uu___1761_22842.use_bv_sorts);
               qtbl_name_and_index = (uu___1761_22842.qtbl_name_and_index);
               normalized_eff_names = (uu___1761_22842.normalized_eff_names);
               fv_delta_depths = (uu___1761_22842.fv_delta_depths);
               proof_ns = (uu___1761_22842.proof_ns);
               synth_hook = (uu___1761_22842.synth_hook);
               splice = (uu___1761_22842.splice);
               postprocess = (uu___1761_22842.postprocess);
               is_native_tactic = (uu___1761_22842.is_native_tactic);
               identifier_info = (uu___1761_22842.identifier_info);
               tc_hooks = (uu___1761_22842.tc_hooks);
               dsenv = (uu___1761_22842.dsenv);
               nbe = (uu___1761_22842.nbe)
             }))
    | uu____22843 -> FStar_Pervasives_Native.None
  ...
  fun env  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env1  ->
           fun uu____22872  ->
             match uu____22872 with | (x,uu____22880) -> push_bv env1 x) env
        bs
...
let (binding_of_lb :
  ...
  fun x  ->
    fun t  ->
      ...
      | FStar_Util.Inl x1 ->
          let x2 =
            let uu___1775_22915 = x1  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___1775_22915.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___1775_22915.FStar_Syntax_Syntax.index);
...
let (push_module : env -> FStar_Syntax_Syntax.modul -> env) =
  fun env  ->
    fun m  ->
      ...
      (let uu___1786_22957 = env  in
       {
         solver = (uu___1786_22957.solver);
         range = (uu___1786_22957.range);
         curmodule = (uu___1786_22957.curmodule);
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___1786_22957.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = FStar_Pervasives_Native.None;
         sigtab = (uu___1786_22957.sigtab);
         attrtab = (uu___1786_22957.attrtab);
         is_pattern = (uu___1786_22957.is_pattern);
         instantiate_imp = (uu___1786_22957.instantiate_imp);
         effects = (uu___1786_22957.effects);
         generalize = (uu___1786_22957.generalize);
         letrecs = (uu___1786_22957.letrecs);
         top_level = (uu___1786_22957.top_level);
         check_uvars = (uu___1786_22957.check_uvars);
         use_eq = (uu___1786_22957.use_eq);
         is_iface = (uu___1786_22957.is_iface);
         admit = (uu___1786_22957.admit);
         lax = (uu___1786_22957.lax);
         lax_universes = (uu___1786_22957.lax_universes);
         phase1 = (uu___1786_22957.phase1);
         failhard = (uu___1786_22957.failhard);
         nosynth = (uu___1786_22957.nosynth);
         uvar_subtyping = (uu___1786_22957.uvar_subtyping);
         tc_term = (uu___1786_22957.tc_term);
         type_of = (uu___1786_22957.type_of);
         universe_of = (uu___1786_22957.universe_of);
         check_type_of = (uu___1786_22957.check_type_of);
         use_bv_sorts = (uu___1786_22957.use_bv_sorts);
         qtbl_name_and_index = (uu___1786_22957.qtbl_name_and_index);
         normalized_eff_names = (uu___1786_22957.normalized_eff_names);
         fv_delta_depths = (uu___1786_22957.fv_delta_depths);
         proof_ns = (uu___1786_22957.proof_ns);
         synth_hook = (uu___1786_22957.synth_hook);
         splice = (uu___1786_22957.splice);
         postprocess = (uu___1786_22957.postprocess);
         is_native_tactic = (uu___1786_22957.is_native_tactic);
         identifier_info = (uu___1786_22957.identifier_info);
         tc_hooks = (uu___1786_22957.tc_hooks);
         dsenv = (uu___1786_22957.dsenv);
         nbe = (uu___1786_22957.nbe)
       })
...
let (open_universes_in :
  ...
  fun env  ->
    fun uvs  ->
      fun terms  ->
        let uu____23001 = FStar_Syntax_Subst.univ_var_opening uvs  in
        match uu____23001 with
        | (univ_subst,univ_vars) ->
            let env' = push_univ_vars env univ_vars  in
            let uu____23029 =
              FStar_List.map (FStar_Syntax_Subst.subst univ_subst) terms  in
            (env', univ_vars, uu____23029)
  
let (set_expected_typ : env -> FStar_Syntax_Syntax.typ -> env) =
  fun env  ->
    fun t  ->
      let uu___1801_23045 = env  in
      {
        solver = (uu___1801_23045.solver);
        range = (uu___1801_23045.range);
        curmodule = (uu___1801_23045.curmodule);
        gamma = (uu___1801_23045.gamma);
        gamma_sig = (uu___1801_23045.gamma_sig);
        gamma_cache = (uu___1801_23045.gamma_cache);
        modules = (uu___1801_23045.modules);
        expected_typ = (FStar_Pervasives_Native.Some t);
        sigtab = (uu___1801_23045.sigtab);
        attrtab = (uu___1801_23045.attrtab);
        is_pattern = (uu___1801_23045.is_pattern);
        instantiate_imp = (uu___1801_23045.instantiate_imp);
        effects = (uu___1801_23045.effects);
        generalize = (uu___1801_23045.generalize);
        letrecs = (uu___1801_23045.letrecs);
        top_level = (uu___1801_23045.top_level);
        check_uvars = (uu___1801_23045.check_uvars);
        use_eq = false;
        is_iface = (uu___1801_23045.is_iface);
        admit = (uu___1801_23045.admit);
        lax = (uu___1801_23045.lax);
        lax_universes = (uu___1801_23045.lax_universes);
        phase1 = (uu___1801_23045.phase1);
        failhard = (uu___1801_23045.failhard);
        nosynth = (uu___1801_23045.nosynth);
        uvar_subtyping = (uu___1801_23045.uvar_subtyping);
        tc_term = (uu___1801_23045.tc_term);
        type_of = (uu___1801_23045.type_of);
        universe_of = (uu___1801_23045.universe_of);
        check_type_of = (uu___1801_23045.check_type_of);
        use_bv_sorts = (uu___1801_23045.use_bv_sorts);
        qtbl_name_and_index = (uu___1801_23045.qtbl_name_and_index);
        normalized_eff_names = (uu___1801_23045.normalized_eff_names);
        fv_delta_depths = (uu___1801_23045.fv_delta_depths);
        proof_ns = (uu___1801_23045.proof_ns);
        synth_hook = (uu___1801_23045.synth_hook);
        splice = (uu___1801_23045.splice);
        postprocess = (uu___1801_23045.postprocess);
        is_native_tactic = (uu___1801_23045.is_native_tactic);
        identifier_info = (uu___1801_23045.identifier_info);
        tc_hooks = (uu___1801_23045.tc_hooks);
        dsenv = (uu___1801_23045.dsenv);
        nbe = (uu___1801_23045.nbe)
      }
...
let (clear_expected_typ :
  ...
  fun env_  ->
    let uu____23076 = expected_typ env_  in
    ((let uu___1808_23082 = env_  in
      {
        solver = (uu___1808_23082.solver);
        range = (uu___1808_23082.range);
        curmodule = (uu___1808_23082.curmodule);
        gamma = (uu___1808_23082.gamma);
        gamma_sig = (uu___1808_23082.gamma_sig);
        gamma_cache = (uu___1808_23082.gamma_cache);
        modules = (uu___1808_23082.modules);
        expected_typ = FStar_Pervasives_Native.None;
        sigtab = (uu___1808_23082.sigtab);
        attrtab = (uu___1808_23082.attrtab);
        is_pattern = (uu___1808_23082.is_pattern);
        instantiate_imp = (uu___1808_23082.instantiate_imp);
        effects = (uu___1808_23082.effects);
        generalize = (uu___1808_23082.generalize);
        letrecs = (uu___1808_23082.letrecs);
        top_level = (uu___1808_23082.top_level);
        check_uvars = (uu___1808_23082.check_uvars);
        use_eq = false;
        is_iface = (uu___1808_23082.is_iface);
        admit = (uu___1808_23082.admit);
        lax = (uu___1808_23082.lax);
        lax_universes = (uu___1808_23082.lax_universes);
        phase1 = (uu___1808_23082.phase1);
        failhard = (uu___1808_23082.failhard);
        nosynth = (uu___1808_23082.nosynth);
        uvar_subtyping = (uu___1808_23082.uvar_subtyping);
        tc_term = (uu___1808_23082.tc_term);
        type_of = (uu___1808_23082.type_of);
        universe_of = (uu___1808_23082.universe_of);
        check_type_of = (uu___1808_23082.check_type_of);
        use_bv_sorts = (uu___1808_23082.use_bv_sorts);
        qtbl_name_and_index = (uu___1808_23082.qtbl_name_and_index);
        normalized_eff_names = (uu___1808_23082.normalized_eff_names);
        fv_delta_depths = (uu___1808_23082.fv_delta_depths);
        proof_ns = (uu___1808_23082.proof_ns);
        synth_hook = (uu___1808_23082.synth_hook);
        splice = (uu___1808_23082.splice);
        postprocess = (uu___1808_23082.postprocess);
        is_native_tactic = (uu___1808_23082.is_native_tactic);
        identifier_info = (uu___1808_23082.identifier_info);
        tc_hooks = (uu___1808_23082.tc_hooks);
        dsenv = (uu___1808_23082.dsenv);
        nbe = (uu___1808_23082.nbe)
      }), uu____23076)
  
let (finish_module : env -> FStar_Syntax_Syntax.modul -> env) =
  let empty_lid =
    let uu____23094 =
      let uu____23097 = FStar_Ident.id_of_text ""  in [uu____23097]  in
    FStar_Ident.lid_of_ids uu____23094  in
  fun env  ->
    fun m  ->
      let sigs =
        let uu____23104 =
        ...
        then
          let uu____23109 =
            FStar_All.pipe_right env.gamma_sig
             ...
             in
          FStar_All.pipe_right uu____23109 FStar_List.rev
        else m.FStar_Syntax_Syntax.exports  in
      add_sigelts env sigs;
      (let uu___1816_23137 = env  in
       {
         solver = (uu___1816_23137.solver);
         range = (uu___1816_23137.range);
         curmodule = empty_lid;
         gamma = [];
         gamma_sig = [];
         gamma_cache = (uu___1816_23137.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = (uu___1816_23137.expected_typ);
         sigtab = (uu___1816_23137.sigtab);
         attrtab = (uu___1816_23137.attrtab);
         is_pattern = (uu___1816_23137.is_pattern);
         instantiate_imp = (uu___1816_23137.instantiate_imp);
         effects = (uu___1816_23137.effects);
         generalize = (uu___1816_23137.generalize);
         letrecs = (uu___1816_23137.letrecs);
         top_level = (uu___1816_23137.top_level);
         check_uvars = (uu___1816_23137.check_uvars);
         use_eq = (uu___1816_23137.use_eq);
         is_iface = (uu___1816_23137.is_iface);
         admit = (uu___1816_23137.admit);
         lax = (uu___1816_23137.lax);
         lax_universes = (uu___1816_23137.lax_universes);
         phase1 = (uu___1816_23137.phase1);
         failhard = (uu___1816_23137.failhard);
         nosynth = (uu___1816_23137.nosynth);
         uvar_subtyping = (uu___1816_23137.uvar_subtyping);
         tc_term = (uu___1816_23137.tc_term);
         type_of = (uu___1816_23137.type_of);
         universe_of = (uu___1816_23137.universe_of);
         check_type_of = (uu___1816_23137.check_type_of);
         use_bv_sorts = (uu___1816_23137.use_bv_sorts);
         qtbl_name_and_index = (uu___1816_23137.qtbl_name_and_index);
         normalized_eff_names = (uu___1816_23137.normalized_eff_names);
         fv_delta_depths = (uu___1816_23137.fv_delta_depths);
         proof_ns = (uu___1816_23137.proof_ns);
         synth_hook = (uu___1816_23137.synth_hook);
         splice = (uu___1816_23137.splice);
         postprocess = (uu___1816_23137.postprocess);
         is_native_tactic = (uu___1816_23137.is_native_tactic);
         identifier_info = (uu___1816_23137.identifier_info);
         tc_hooks = (uu___1816_23137.tc_hooks);
         dsenv = (uu___1816_23137.dsenv);
         nbe = (uu___1816_23137.nbe)
       })
...
let (uvars_in_env : env -> FStar_Syntax_Syntax.uvars) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____23189)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____23193,(uu____23194,t)))::tl1
          ->
          let uu____23215 =
            let uu____23218 = FStar_Syntax_Free.uvars t  in
            ext out uu____23218  in
          aux uu____23215 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____23221;
            FStar_Syntax_Syntax.index = uu____23222;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____23230 =
            let uu____23233 = FStar_Syntax_Free.uvars t  in
            ext out uu____23233  in
          aux uu____23230 tl1
       in
...
let (univ_vars : env -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____23291)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____23295,(uu____23296,t)))::tl1
          ->
          let uu____23317 =
            let uu____23320 = FStar_Syntax_Free.univs t  in
            ext out uu____23320  in
          aux uu____23317 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____23323;
            FStar_Syntax_Syntax.index = uu____23324;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____23332 =
            let uu____23335 = FStar_Syntax_Free.univs t  in
            ext out uu____23335  in
          aux uu____23332 tl1
       in
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (FStar_Syntax_Syntax.Binding_univ uname)::tl1 ->
          let uu____23397 = FStar_Util.set_add uname out  in
          aux uu____23397 tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____23400,(uu____23401,t)))::tl1
          ->
          let uu____23422 =
            let uu____23425 = FStar_Syntax_Free.univnames t  in
            ext out uu____23425  in
          aux uu____23422 tl1
      | (FStar_Syntax_Syntax.Binding_var
          { FStar_Syntax_Syntax.ppname = uu____23428;
            FStar_Syntax_Syntax.index = uu____23429;
            FStar_Syntax_Syntax.sort = t;_})::tl1
          ->
          let uu____23437 =
            let uu____23440 = FStar_Syntax_Free.univnames t  in
            ext out uu____23440  in
          aux uu____23437 tl1
       in
...
let (bound_vars_of_bindings :
  ...
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.collect
         (fun uu___11_23461  ->
            match uu___11_23461 with
            | FStar_Syntax_Syntax.Binding_var x -> [x]
            | FStar_Syntax_Syntax.Binding_lid uu____23465 -> []
            | FStar_Syntax_Syntax.Binding_univ uu____23478 -> []))
  
let (binders_of_bindings :
  FStar_Syntax_Syntax.binding Prims.list -> FStar_Syntax_Syntax.binders) =
  fun bs  ->
    let uu____23489 =
      let uu____23498 = bound_vars_of_bindings bs  in
      FStar_All.pipe_right uu____23498
        (FStar_List.map FStar_Syntax_Syntax.mk_binder)
       in
    FStar_All.pipe_right uu____23489 FStar_List.rev
  ...
  fun gamma  ->
    let uu____23546 =
      FStar_All.pipe_right gamma
        (FStar_List.map
           (fun uu___12_23559  ->
              match uu___12_23559 with
              | FStar_Syntax_Syntax.Binding_var x ->
                  let uu____23562 = FStar_Syntax_Print.bv_to_string x  in
                  Prims.op_Hat "Binding_var " uu____23562
              | FStar_Syntax_Syntax.Binding_univ u ->
                  Prims.op_Hat "Binding_univ " u.FStar_Ident.idText
              | FStar_Syntax_Syntax.Binding_lid (l,uu____23568) ->
                  let uu____23585 = FStar_Ident.string_of_lid l  in
                  Prims.op_Hat "Binding_lid " uu____23585))
       in
    FStar_All.pipe_right uu____23546 (FStar_String.concat "::\n")
  
let (string_of_delta_level : delta_level -> Prims.string) =
  fun uu___13_23599  ->
    match uu___13_23599 with
    | NoDelta  -> "NoDelta"
    | InliningDelta  -> "Inlining"
    | Eager_unfolding_only  -> "Eager_unfolding_only"
    | Unfold d ->
        let uu____23605 = FStar_Syntax_Print.delta_depth_to_string d  in
        Prims.op_Hat "Unfold " uu____23605
  ...
  fun env  ->
    fun path  ->
      let rec str_i_prefix xs ys =
        ...
        | (uu____23716,uu____23717) -> false  in
      let uu____23731 =
        FStar_List.tryFind
          (fun uu____23753  ->
             match uu____23753 with | (p,uu____23764) -> str_i_prefix p path)
          env.proof_ns
         in
      match uu____23731 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____23783,b) -> b
  
let (should_enc_lid : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____23813 = FStar_Ident.path_of_lid lid  in
      should_enc_path env uu____23813
  
let (cons_proof_ns : Prims.bool -> env -> name_prefix -> env) =
  fun b  ->
    fun e  ->
      fun path  ->
        let uu___1959_23835 = e  in
        {
          solver = (uu___1959_23835.solver);
          range = (uu___1959_23835.range);
          curmodule = (uu___1959_23835.curmodule);
          gamma = (uu___1959_23835.gamma);
          gamma_sig = (uu___1959_23835.gamma_sig);
          gamma_cache = (uu___1959_23835.gamma_cache);
          modules = (uu___1959_23835.modules);
          expected_typ = (uu___1959_23835.expected_typ);
          sigtab = (uu___1959_23835.sigtab);
          attrtab = (uu___1959_23835.attrtab);
          is_pattern = (uu___1959_23835.is_pattern);
          instantiate_imp = (uu___1959_23835.instantiate_imp);
          effects = (uu___1959_23835.effects);
          generalize = (uu___1959_23835.generalize);
          letrecs = (uu___1959_23835.letrecs);
          top_level = (uu___1959_23835.top_level);
          check_uvars = (uu___1959_23835.check_uvars);
          use_eq = (uu___1959_23835.use_eq);
          is_iface = (uu___1959_23835.is_iface);
          admit = (uu___1959_23835.admit);
          lax = (uu___1959_23835.lax);
          lax_universes = (uu___1959_23835.lax_universes);
          phase1 = (uu___1959_23835.phase1);
          failhard = (uu___1959_23835.failhard);
          nosynth = (uu___1959_23835.nosynth);
          uvar_subtyping = (uu___1959_23835.uvar_subtyping);
          tc_term = (uu___1959_23835.tc_term);
          type_of = (uu___1959_23835.type_of);
          universe_of = (uu___1959_23835.universe_of);
          check_type_of = (uu___1959_23835.check_type_of);
          use_bv_sorts = (uu___1959_23835.use_bv_sorts);
          qtbl_name_and_index = (uu___1959_23835.qtbl_name_and_index);
          normalized_eff_names = (uu___1959_23835.normalized_eff_names);
          fv_delta_depths = (uu___1959_23835.fv_delta_depths);
          proof_ns = ((path, b) :: (e.proof_ns));
          synth_hook = (uu___1959_23835.synth_hook);
          splice = (uu___1959_23835.splice);
          postprocess = (uu___1959_23835.postprocess);
          is_native_tactic = (uu___1959_23835.is_native_tactic);
          identifier_info = (uu___1959_23835.identifier_info);
          tc_hooks = (uu___1959_23835.tc_hooks);
          dsenv = (uu___1959_23835.dsenv);
          nbe = (uu___1959_23835.nbe)
        }
...
let (set_proof_ns : proof_namespace -> env -> env) =
  fun ns  ->
    fun e  ->
      let uu___1968_23883 = e  in
      {
        solver = (uu___1968_23883.solver);
        range = (uu___1968_23883.range);
        curmodule = (uu___1968_23883.curmodule);
        gamma = (uu___1968_23883.gamma);
        gamma_sig = (uu___1968_23883.gamma_sig);
        gamma_cache = (uu___1968_23883.gamma_cache);
        modules = (uu___1968_23883.modules);
        expected_typ = (uu___1968_23883.expected_typ);
        sigtab = (uu___1968_23883.sigtab);
        attrtab = (uu___1968_23883.attrtab);
        is_pattern = (uu___1968_23883.is_pattern);
        instantiate_imp = (uu___1968_23883.instantiate_imp);
        effects = (uu___1968_23883.effects);
        generalize = (uu___1968_23883.generalize);
        letrecs = (uu___1968_23883.letrecs);
        top_level = (uu___1968_23883.top_level);
        check_uvars = (uu___1968_23883.check_uvars);
        use_eq = (uu___1968_23883.use_eq);
        is_iface = (uu___1968_23883.is_iface);
        admit = (uu___1968_23883.admit);
        lax = (uu___1968_23883.lax);
        lax_universes = (uu___1968_23883.lax_universes);
        phase1 = (uu___1968_23883.phase1);
        failhard = (uu___1968_23883.failhard);
        nosynth = (uu___1968_23883.nosynth);
        uvar_subtyping = (uu___1968_23883.uvar_subtyping);
        tc_term = (uu___1968_23883.tc_term);
        type_of = (uu___1968_23883.type_of);
        universe_of = (uu___1968_23883.universe_of);
        check_type_of = (uu___1968_23883.check_type_of);
        use_bv_sorts = (uu___1968_23883.use_bv_sorts);
        qtbl_name_and_index = (uu___1968_23883.qtbl_name_and_index);
        normalized_eff_names = (uu___1968_23883.normalized_eff_names);
        fv_delta_depths = (uu___1968_23883.fv_delta_depths);
        proof_ns = ns;
        synth_hook = (uu___1968_23883.synth_hook);
        splice = (uu___1968_23883.splice);
        postprocess = (uu___1968_23883.postprocess);
        is_native_tactic = (uu___1968_23883.is_native_tactic);
        identifier_info = (uu___1968_23883.identifier_info);
        tc_hooks = (uu___1968_23883.tc_hooks);
        dsenv = (uu___1968_23883.dsenv);
        nbe = (uu___1968_23883.nbe)
      }
...
let (unbound_vars :
  ...
  fun e  ->
    fun t  ->
      let uu____23899 = FStar_Syntax_Free.names t  in
      let uu____23902 = bound_vars e  in
      FStar_List.fold_left (fun s  -> fun bv  -> FStar_Util.set_remove bv s)
        uu____23899 uu____23902
  
let (closed : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun e  ->
    fun t  ->
      let uu____23925 = unbound_vars e t  in
      FStar_Util.set_is_empty uu____23925
  
let (closed' : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____23935 = FStar_Syntax_Free.names t  in
    FStar_Util.set_is_empty uu____23935
    ...
    let aux uu____23956 =
      ...
      | (p,b) ->
          ...
          then "*"
            ...
            (let uu____23976 = FStar_Ident.text_of_path p  in
             Prims.op_Hat (if b then "+" else "-") uu____23976)
       in
    let uu____23984 =
      let uu____23988 = FStar_List.map aux env.proof_ns  in
      FStar_All.pipe_right uu____23988 FStar_List.rev  in
    FStar_All.pipe_right uu____23984 (FStar_String.concat " ")
             ...
             (fun imp  ->
                ((imp.imp_uvar).FStar_Syntax_Syntax.ctx_uvar_should_check =
                  ...
                  (let uu____24058 =
                   ...
                   | FStar_Pervasives_Native.Some uu____24062 -> true
                   | FStar_Pervasives_Native.None  -> false)))
    | uu____24065 -> false
...
let (is_trivial_guard_formula : guard_t -> Prims.bool) =
  fun g  ->
    match g with
    | { guard_f = FStar_TypeChecker_Common.Trivial ; deferred = uu____24075;
        univ_ineqs = uu____24076; implicits = uu____24077;_} -> true
    | uu____24089 -> false
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          let f' =
            FStar_Syntax_Util.abs bs f
             ...
             in
          let uu___2012_24120 = g  in
          {
            guard_f = (FStar_TypeChecker_Common.NonTrivial f');
            deferred = (uu___2012_24120.deferred);
            univ_ineqs = (uu___2012_24120.univ_ineqs);
            implicits = (uu___2012_24120.implicits)
          }
...
let (def_check_vars_in_set :
  ...
  fun rng  ->
    fun msg  ->
      fun vset  ->
        fun t  ->
          let uu____24159 = FStar_Options.defensive ()  in
          if uu____24159
          then
            let s = FStar_Syntax_Free.names t  in
            let uu____24165 =
              let uu____24167 =
                let uu____24169 = FStar_Util.set_difference s vset  in
                FStar_All.pipe_left FStar_Util.set_is_empty uu____24169  in
              Prims.op_Negation uu____24167  in
            (if uu____24165
             then
               let uu____24176 =
                 let uu____24182 =
                   let uu____24184 = FStar_Syntax_Print.term_to_string t  in
                   let uu____24186 =
                     let uu____24188 = FStar_Util.set_elements s  in
                     FStar_All.pipe_right uu____24188
                       (FStar_Syntax_Print.bvs_to_string ",\n\t")
                      in
                   FStar_Util.format3
                     "Internal: term is not closed (%s).\nt = (%s)\nFVs = (%s)\n"
                     msg uu____24184 uu____24186
                    in
                 (FStar_Errors.Warning_Defensive, uu____24182)  in
               FStar_Errors.log_issue rng uu____24176
             else ())
          else ()
      ...
      fun l  ->
        fun t  ->
          let uu____24228 =
            ...
            Prims.op_Negation uu____24230  in
          if uu____24228
          then ()
          else
            (let uu____24235 =
               FStar_Util.as_set l FStar_Syntax_Syntax.order_bv  in
             def_check_vars_in_set rng msg uu____24235 t)
  ...
  fun rng  ->
    fun msg  ->
      fun e  ->
        fun t  ->
          let uu____24261 =
            let uu____24263 = FStar_Options.defensive ()  in
            Prims.op_Negation uu____24263  in
          if uu____24261
          then ()
          else
            (let uu____24268 = bound_vars e  in
             def_check_closed_in rng msg uu____24268 t)
            ...
            let uu____24309 =
              let uu____24310 =
                let uu____24317 =
                  let uu____24318 =
                    let uu____24335 =
                      let uu____24346 = FStar_Syntax_Syntax.as_arg e  in
                      [uu____24346]  in
                    (f, uu____24335)  in
                  FStar_Syntax_Syntax.Tm_app uu____24318  in
                FStar_Syntax_Syntax.mk uu____24317  in
              uu____24310 FStar_Pervasives_Native.None
                f.FStar_Syntax_Syntax.pos
               in
            FStar_All.pipe_left
              (fun _24383  -> FStar_TypeChecker_Common.NonTrivial _24383)
              uu____24309
             in
          {
            guard_f = uu____24308;
            deferred = (uu___2049_24307.deferred);
            univ_ineqs = (uu___2049_24307.univ_ineqs);
            implicits = (uu___2049_24307.implicits)
          }
...
let (map_guard :
  ...
  fun g  ->
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.Trivial  -> g
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___2056_24401 = g  in
          let uu____24402 =
            let uu____24403 = map1 f  in
            FStar_TypeChecker_Common.NonTrivial uu____24403  in
          {
            guard_f = uu____24402;
            deferred = (uu___2056_24401.deferred);
            univ_ineqs = (uu___2056_24401.univ_ineqs);
            implicits = (uu___2056_24401.implicits)
          }
...
let (always_map_guard :
  ...
  fun g  ->
    fun map1  ->
      match g.guard_f with
      | FStar_TypeChecker_Common.Trivial  ->
          let uu___2061_24420 = g  in
          let uu____24421 =
            let uu____24422 = map1 FStar_Syntax_Util.t_true  in
            FStar_TypeChecker_Common.NonTrivial uu____24422  in
          {
            guard_f = uu____24421;
            deferred = (uu___2061_24420.deferred);
            univ_ineqs = (uu___2061_24420.univ_ineqs);
            implicits = (uu___2061_24420.implicits)
          }
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___2065_24424 = g  in
          let uu____24425 =
            let uu____24426 = map1 f  in
            FStar_TypeChecker_Common.NonTrivial uu____24426  in
          {
            guard_f = uu____24425;
            deferred = (uu___2065_24424.deferred);
            univ_ineqs = (uu___2065_24424.univ_ineqs);
            implicits = (uu___2065_24424.implicits)
          }
...
let (trivial : FStar_TypeChecker_Common.guard_formula -> unit) =
  fun t  ->
    match t with
    | FStar_TypeChecker_Common.Trivial  -> ()
    | FStar_TypeChecker_Common.NonTrivial uu____24433 ->
        failwith "impossible"
    ...
    fun g2  ->
      ...
      | (FStar_TypeChecker_Common.NonTrivial
         f1,FStar_TypeChecker_Common.NonTrivial f2) ->
          let uu____24450 = FStar_Syntax_Util.mk_conj f1 f2  in
          FStar_TypeChecker_Common.NonTrivial uu____24450
  
let (check_trivial :
  FStar_Syntax_Syntax.term -> FStar_TypeChecker_Common.guard_formula) =
  fun t  ->
    let uu____24457 =
      let uu____24458 = FStar_Syntax_Util.unmeta t  in
      uu____24458.FStar_Syntax_Syntax.n  in
    match uu____24457 with
    | FStar_Syntax_Syntax.Tm_fvar tc when
        FStar_Syntax_Syntax.fv_eq_lid tc FStar_Parser_Const.true_lid ->
        FStar_TypeChecker_Common.Trivial
    | uu____24462 -> FStar_TypeChecker_Common.NonTrivial t
...
let (binop_guard :
  ...
  fun f  ->
    fun g1  ->
      fun g2  ->
        let uu____24505 = f g1.guard_f g2.guard_f  in
        {
          guard_f = uu____24505;
            ...
            let f1 =
              FStar_List.fold_right2
                (fun u  ->
                   fun b  ->
                     fun f1  ->
                       let uu____24600 = FStar_Syntax_Syntax.is_null_binder b
                          in
                       if uu____24600
                       then f1
                       else
               ...
               in
            let uu___2120_24607 = g  in
            {
              guard_f = (FStar_TypeChecker_Common.NonTrivial f1);
              deferred = (uu___2120_24607.deferred);
              univ_ineqs = (uu___2120_24607.univ_ineqs);
              implicits = (uu___2120_24607.implicits)
            }
    ...
    fun bs  ->
      fun f  ->
        FStar_List.fold_right
          (fun b  ->
             fun f1  ->
               let uu____24641 = FStar_Syntax_Syntax.is_null_binder b  in
               if uu____24641
               then f1
               else
                 (let u =
  ...
  fun env  ->
    fun binders  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.Trivial  -> g
        | FStar_TypeChecker_Common.NonTrivial f ->
            let uu___2135_24668 = g  in
            let uu____24669 =
              let uu____24670 = close_forall env binders f  in
              FStar_TypeChecker_Common.NonTrivial uu____24670  in
            {
              guard_f = uu____24669;
              deferred = (uu___2135_24668.deferred);
              univ_ineqs = (uu___2135_24668.univ_ineqs);
              implicits = (uu___2135_24668.implicits)
            }
          ...
          fun should_check  ->
            fun meta  ->
              ...
              | uu____24819 ->
                  ...
                  let ctx_uvar =
                    let uu____24837 = FStar_Syntax_Unionfind.fresh ()  in
                    {
                      FStar_Syntax_Syntax.ctx_uvar_head = uu____24837;
                  ...
                  (FStar_TypeChecker_Common.check_uvar_ctx_invariant reason r
                   ...
                   (let t =
                    ...
                    let g =
                      let uu___2157_24869 = trivial_guard  in
                      {
                        guard_f = (uu___2157_24869.guard_f);
                        deferred = (uu___2157_24869.deferred);
                        univ_ineqs = (uu___2157_24869.univ_ineqs);
                        implicits = [imp]
                      }  in
                    (t, [(ctx_uvar, r)], g)))
...
let (dummy_solver : solver_t) =
  {
    init = (fun uu____24887  -> ());
    push = (fun uu____24889  -> ());
    pop = (fun uu____24892  -> ());
    snapshot =
      (fun uu____24895  ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    rollback = (fun uu____24914  -> fun uu____24915  -> ());
    encode_sig = (fun uu____24930  -> fun uu____24931  -> ());
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____24937 =
             let uu____24944 = FStar_Options.peek ()  in (e, g, uu____24944)
              in
           [uu____24937]);
    solve = (fun uu____24960  -> fun uu____24961  -> fun uu____24962  -> ());
    finish = (fun uu____24969  -> ());
    refresh = (fun uu____24971  -> ())
  } 