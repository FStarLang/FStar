          ...
          FStar_All.pipe_right qix
            (FStar_List.tryFind
               (fun uu____4954  ->
                  ...
                  | (m,uu____4960) -> FStar_Ident.lid_equals l m))
           in
...
let inst_tscheme :
  ...
  fun uu___103_5133  ->
    ...
    | (us,t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu____5157  -> new_u_univ ()))
           in
             ...
             | FStar_Util.Inr se ->
                 ...
                 FStar_All.pipe_right uu____6946
                   (FStar_Util.map_option
                      (fun uu____7034  ->
                         match uu____7034 with | (us_t,rng1) -> (us_t, rng1))))
         in
      let uu____7065 =
  ...
  fun env  ->
    fun bv  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____7300 =
            let uu____7301 =
              let uu____7306 = variable_not_found bv  in (uu____7306, bvr)
               in
                 ...
                 then univ_insts
                   ...
                   (let uu____8685 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____8686 uu____8688 uu____8689
                       in
                    failwith uu____8685)
                  in
      ...
      let mapper x =
        ...
        | FStar_Util.Inr (se,uu____9664) ->
            (match se.FStar_Syntax_Syntax.sigel with
             ...
             | uu____9705 -> FStar_Pervasives_Native.Some false)
         in
      let uu____9706 =
              ...
              let uu____10732 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____10750)
                 in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____10776  ->
                    ...
                    | (e,uu____10784) -> e.FStar_Syntax_Syntax.mname))
             in
                     ...
                     let uu____11312 =
                       let uu____11317 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____11318 uu____11323 uu____11330
                          in
          ...
          let uu____11623 =
            let uu____11624 =
              let uu____11629 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____11630
                 in
              let uu____11631 = get_range env  in (uu____11629, uu____11631)
               in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____11753 = push1 x rest1  in local :: uu____11753
         in
                ...
                | Binding_sig_inst (ls,uu____12570,uu____12571) ->
                    let uu____12576 =
                      ...
                      FStar_All.pipe_right uu____12577
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____12576))
         in
    ...
    fun path  ->
      ...
      let rec should_enc_path' pns path1 =
        ...
        | (p,b)::pns1 ->
            ...
            if uu____12817 then b else should_enc_path' pns1 path1
         in
...
let dummy_solver : solver_t =
  {
    ...
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____13025 =
             let uu____13032 = FStar_Options.peek ()  in (e, g, uu____13032)
              in
           [uu____13025]);
