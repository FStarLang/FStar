...
let _53_797 = (let _150_786 = (let _150_785 = (FStar_Syntax_Util.arrow binders c)
in ((univs), (_150_785)))
...
let _53_1130 = (FStar_All.pipe_right order (FStar_List.iter (fun edge -> if ((FStar_Ident.lid_equals edge.msource FStar_Syntax_Const.effect_DIV_lid) && (let _150_1003 = (lookup_effect_quals env edge.mtarget)
...
in {solver = _53_1187.solver; range = _53_1187.range; curmodule = _53_1187.curmodule; gamma = _150_1149; gamma_cache = _53_1187.gamma_cache; modules = _53_1187.modules; expected_typ = _53_1187.expected_typ; sigtab = _53_1187.sigtab; is_pattern = _53_1187.is_pattern; instantiate_imp = _53_1187.instantiate_imp; effects = _53_1187.effects; generalize = _53_1187.generalize; letrecs = _53_1187.letrecs; top_level = _53_1187.top_level; check_uvars = _53_1187.check_uvars; use_eq = _53_1187.use_eq; is_iface = _53_1187.is_iface; admit = _53_1187.admit; lax = _53_1187.lax; lax_universes = _53_1187.lax_universes; type_of = _53_1187.type_of; universe_of = _53_1187.universe_of; use_bv_sorts = _53_1187.use_bv_sorts; qname_and_index = _53_1187.qname_and_index}))))
...
let _53_1242 = env
in {solver = _53_1242.solver; range = _53_1242.range; curmodule = _53_1242.curmodule; gamma = _53_1242.gamma; gamma_cache = _53_1242.gamma_cache; modules = _53_1242.modules; expected_typ = None; sigtab = _53_1242.sigtab; is_pattern = _53_1242.is_pattern; instantiate_imp = _53_1242.instantiate_imp; effects = _53_1242.effects; generalize = _53_1242.generalize; letrecs = _53_1242.letrecs; top_level = _53_1242.top_level; check_uvars = _53_1242.check_uvars; use_eq = false; is_iface = _53_1242.is_iface; admit = _53_1242.admit; lax = _53_1242.lax; lax_universes = _53_1242.lax_universes; type_of = _53_1242.type_of; universe_of = _53_1242.universe_of; use_bv_sorts = _53_1242.use_bv_sorts; qname_and_index = _53_1242.qname_and_index})), (_150_1208))))
...
let binders_of_bindings : binding Prims.list  ->  FStar_Syntax_Syntax.binders = (fun bs -> (let _150_1245 = (let _150_1244 = (bound_vars_of_bindings bs)
in (FStar_All.pipe_right _150_1244 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_All.pipe_right _150_1245 FStar_List.rev)))
...
in (FStar_Util.smap_fold (sigtab env) (fun _53_1379 v keys -> (let _150_1268 = (FStar_Syntax_Util.lids_of_sigelt v)
in (FStar_List.append _150_1268 keys))) keys)))
