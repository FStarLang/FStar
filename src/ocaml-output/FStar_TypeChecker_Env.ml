                ...
                | Binding_sig_inst (ls,uu____13407,uu____13408) ->
                    let uu____13413 =
                      ...
                      FStar_All.pipe_right uu____13414
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____13413))
         in
    ...
    fun path  ->
      ...
      let rec should_enc_path' pns path1 =
        ...
        | (p,b)::pns1 ->
            ...
            if uu____13654 then b else should_enc_path' pns1 path1
         in
...
let dummy_solver : solver_t =
  {
    ...
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____13862 =
             let uu____13869 = FStar_Options.peek ()  in (e, g, uu____13869)
              in
           [uu____13862]);
