...
let (__proj__Mkenv__item__solver : env -> solver_t) =
  fun projectee ->
    ...
    | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
        ...
        effectof_well_typed_tot_or_gtot_term; use_bv_sorts;
...
let (__proj__Mkenv__item__universeof_well_typed_term :
  ...
  fun projectee ->
    ...
    | { solver; range; curmodule; gamma; gamma_sig; gamma_cache; modules;
        ...
        erasable_types_tab; enable_defer_to_tac; unif_allow_ref_guards;_} ->
        universeof_well_typed_term
let (__proj__Mkenv__item__effectof_well_typed_tot_or_gtot_term :
  env ->
    env ->
      FStar_Syntax_Syntax.term ->
        FStar_Ident.lident FStar_Pervasives_Native.option)
  ...
  fun subst ->
    fun env1 ->
      ...
      let uu___1 = rename_gamma subst env1.gamma in
      {
        ...
        effectof_well_typed_tot_or_gtot_term =
          (uu___.effectof_well_typed_tot_or_gtot_term);
  ...
  fun env1 ->
    ...
    (let uu___1 = env1 in
     ...
     let uu___10 = FStar_Util.smap_copy env1.erasable_types_tab in
     {
       ...
       effectof_well_typed_tot_or_gtot_term =
         (uu___1.effectof_well_typed_tot_or_gtot_term);
                                ...
                                (let uu___5 = env2 in
                                 {
                                   ...
                                   effectof_well_typed_tot_or_gtot_term =
                                     (uu___5.effectof_well_typed_tot_or_gtot_term);
              ...
              (let uu___3 = env1 in
               {
                 ...
                 effectof_well_typed_tot_or_gtot_term =
                   (uu___3.effectof_well_typed_tot_or_gtot_term);
              ...
              (let uu___4 = env1 in
               {
                 ...
                 effectof_well_typed_tot_or_gtot_term =
                   (uu___4.effectof_well_typed_tot_or_gtot_term);
