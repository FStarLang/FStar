                    ...
                    then
                      failwith
                        (let _0_185 =
                         ...
                         let _0_182 = FStar_Syntax_Print.term_to_string t in
                         FStar_Util.format4
        ...
        Some
          (inst_tscheme
             (let _0_188 =
                ...
                FStar_Syntax_Util.arrow ne.FStar_Syntax_Syntax.binders _0_187 in
    ...
    fun lid  ->
      let mapper uu___96_1864 =
        ...
        | FStar_Util.Inr
            ...
            ->
            let uu____1918 = let _0_191 = in_cur_mod env l in _0_191 = Yes in
            if uu____1918
            then
              let uu____1922 =
                      ...
                      then
                        Some
                          (let _0_217 =
                             ...
                             FStar_Syntax_Subst.set_use_range
                               (FStar_Ident.range_of_lid lid) _0_216 in
              ...
              (let insts =
                 ...
                 then univ_insts
                   ...
                   then
                     ...
                     failwith
                       (let _0_221 = FStar_Syntax_Print.lid_to_string lid in
                        let _0_220 =
               ...
               | (uu____2733,uu____2734::uu____2735::uu____2736) when
                   ...
                   ->
                   failwith
                     (let _0_223 = FStar_Syntax_Print.lid_to_string lid in
                      let _0_222 =
                        FStar_All.pipe_left FStar_Util.string_of_int
                          (FStar_List.length univs) in
                      FStar_Util.format2
            ...
            (let uu____3369 =
             ...
             | None  ->
                 Prims.raise
                   (FStar_Errors.Error
                      (let _0_234 =
                         let _0_233 = FStar_Syntax_Print.lid_to_string l1 in
                         let _0_232 = FStar_Syntax_Print.lid_to_string l2 in
                         FStar_Util.format2
               ...
               let null_wp_res =
                 ...
                 (FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app
                       (let _0_236 =
                          let _0_235 = FStar_Syntax_Syntax.as_arg res_t in
                          [_0_235] in
                        (null_wp, _0_236)))) None _0_237 in
               FStar_Syntax_Syntax.mk_Comp
                 (let _0_239 =
                    let _0_238 = FStar_Syntax_Syntax.as_arg null_wp_res in
                    [_0_238] in
                  {
                   ...
                   (FStar_Syntax_Syntax.Tm_app
                      (let _0_244 =
                         ...
                         let _0_242 =
                           ...
                           [_0_241] in
                         _0_243 :: _0_242 in
                       (lift_t, _0_244)))) None wp1.FStar_Syntax_Syntax.pos in
          let sub_lift_wp =
                                          ...
                                          then []
                                            ...
                                            (let uu____3699 =
                                             ...
                                             | (Some e1,Some e2) ->
                                                 ...
                                                 [_0_250]
                                             | uu____3711 -> []))))) in
                      FStar_List.append order _0_251) order) in
          let order =
