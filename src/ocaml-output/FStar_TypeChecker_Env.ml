          ...
          FStar_All.pipe_right qix
            (FStar_List.tryFind
               (fun uu____6346  ->
                  ...
                  | (m,uu____6352) -> FStar_Ident.lid_equals l m))
           in
...
let inst_tscheme :
  ...
  fun uu___141_6952  ->
    ...
    | (us,t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu____6976  -> new_u_univ ()))
           in
             ...
             | FStar_Util.Inr se ->
                 ...
                 FStar_All.pipe_right uu____8765
                   (FStar_Util.map_option
                      (fun uu____8853  ->
                         match uu____8853 with | (us_t,rng1) -> (us_t, rng1))))
         in
      let uu____8884 =
  ...
  fun env  ->
    fun bv  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____9119 =
            let uu____9120 =
              let uu____9125 = variable_not_found bv  in (uu____9125, bvr)
               in
                 ...
                 then univ_insts
                   ...
                   (let uu____10507 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____10508 uu____10510 uu____10511
                       in
      ...
      let mapper x =
        ...
        | FStar_Util.Inr (se,uu____11486) ->
            (match se.FStar_Syntax_Syntax.sigel with
             ...
             | uu____11527 -> FStar_Pervasives_Native.Some false)
         in
      let uu____11528 =
              ...
              let uu____12554 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____12572)
                 in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____12598  ->
                    ...
                    | (e,uu____12606) -> e.FStar_Syntax_Syntax.mname))
             in
                     ...
                     let uu____13134 =
                       let uu____13139 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____13140 uu____13145 uu____13152
                          in
                ...
                (match (ed.FStar_Syntax_Syntax.repr).FStar_Syntax_Syntax.n
                 ...
                 | uu____13306 ->
                     ...
                     let uu____13371 =
                       ...
                       uu____13375 FStar_Pervasives_Native.None uu____13374
                        in
            ...
            let uu____13450 =
              let uu____13455 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____13456
                 in
              let uu____13457 = get_range env  in (uu____13455, uu____13457)
               in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____13579 = push1 x rest1  in local :: uu____13579
         in
                ...
                | Binding_sig_inst (ls,uu____14394,uu____14395) ->
                    let uu____14400 =
                      ...
                      FStar_All.pipe_right uu____14401
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____14400))
         in
      ...
      | (p,b) ->
          ...
          then "*"
            ...
            (let uu____14797 = FStar_Ident.text_of_path p  in
             Prims.strcat (if b then "+" else "-") uu____14797)
       in
    let uu____14799 =
...
let dummy_solver : solver_t =
  {
    ...
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____14837 =
             let uu____14844 = FStar_Options.peek ()  in (e, g, uu____14844)
              in
           [uu____14837]);
