...
| (n, d) -> begin
(let _189_28 = (FStar_Options.prepend_output_dir (Prims.strcat n ext))
in (let _189_27 = (FStar_Format.pretty (Prims.parse_int "120") d)
in (FStar_Util.write_file _189_28 _189_27)))
end)) newDocs))
end
| Some ("Kremlin") -> begin
(

let programs = (let _189_29 = (FStar_List.map FStar_Extraction_Kremlin.translate mllibs)
in (FStar_List.flatten _189_29))
in (

let bin = ((FStar_Extraction_Kremlin.current_version), (programs))
in (let _189_30 = (FStar_Options.prepend_output_dir "out.krml")
in (FStar_Util.save_value_to_file _189_30 bin))))
end
| _94_52 -> begin
(FStar_All.failwith "Unrecognized option")
end))))
...
(let _189_32 = (FStar_Parser_Dep.collect FStar_Parser_Dep.VerifyAll filenames)
in (FStar_Parser_Dep.print _189_32))
end else begin
...
let _94_77 = (FStar_Universal.batch_mode_tc FStar_Parser_Dep.VerifyUserList filenames)
...
let _94_81 = (FStar_Stratified.batch_mode_tc FStar_Parser_Dep.VerifyUserList filenames)
...
let _94_84 = if ((FStar_Options.verify_module ()) <> []) then begin
(

let _94_82 = (FStar_Util.print_error "--verify_module is incompatible with --verify_all")
in (FStar_All.exit (Prims.parse_int "1")))
end else begin
()
end
...
let _94_90 = (FStar_Universal.batch_mode_tc verify_mode filenames)
in (match (_94_90) with
| (fmods, dsenv, env) -> begin
(

let module_names_and_times = (FStar_All.pipe_right fmods (FStar_List.map (fun _94_93 -> (match (_94_93) with
| (x, t) -> begin
(((FStar_Universal.module_or_interface_name x)), (t))
end))))
in (

let _94_95 = (report_errors module_names_and_times)
in (

let _94_97 = (let _189_36 = (let _189_35 = (let _189_34 = (FStar_All.pipe_right fmods (FStar_List.map Prims.fst))
in ((_189_34), (env)))
in FStar_Util.Inr (_189_35))
in (codegen _189_36))
...
let _94_102 = (FStar_Stratified.batch_mode_tc verify_mode filenames)
in (match (_94_102) with
| (fmods, dsenv, env) -> begin
(

let module_names_and_times = (FStar_All.pipe_right fmods (FStar_List.map (fun _94_105 -> (match (_94_105) with
| (x, t) -> begin
(((FStar_Stratified.module_or_interface_name x)), (t))
end))))
in (

let _94_107 = (report_errors module_names_and_times)
in (

let _94_109 = (let _189_40 = (let _189_39 = (let _189_38 = (FStar_All.pipe_right fmods (FStar_List.map Prims.fst))
in ((_189_38), (env)))
in FStar_Util.Inl (_189_39))
in (codegen _189_40))
in (finished_message module_names_and_times (Prims.parse_int "0")))))
end))
end)
...
let main = (fun _94_111 -> (match (()) with
| () -> begin
try
(match (()) with
| () -> begin
...
let _94_116 = if (FStar_Absyn_Util.handleable e) then begin
...
let _94_118 = if (FStar_TypeChecker_Errors.handleable e) then begin
...
let _94_124 = (let _189_47 = (FStar_TypeChecker_Errors.report_all ())
in (FStar_All.pipe_right _189_47 Prims.ignore))
in (

let _94_126 = (report_errors [])
in (FStar_All.exit (Prims.parse_int "1"))))))
end
end))
