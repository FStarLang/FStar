  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___13_323 = bv  in
            let uu____324 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___13_323.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___13_323.FStar_Syntax_Syntax.index);
          ...
          let lbs1 =
            let uu____849 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb  ->
                      let uu___14_864 = lb  in
                      let uu____865 = inst s lb.FStar_Syntax_Syntax.lbtyp  in
                      let uu____868 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___14_864.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___14_864.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____865;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___14_864.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____868;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___14_864.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___14_864.FStar_Syntax_Syntax.lbpos)
                      }))
               in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____1079  ->
              ...
              | (x,imp) ->
                  let uu____1098 =
                    let uu___15_1099 = x  in
                    let uu____1100 = inst s x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___15_1099.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___15_1099.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
               ...
               in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___16_1211.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___16_1211.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1255 =
            let uu___17_1256 = rc  in
            let uu____1257 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s)
               in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___17_1256.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1257;
              FStar_Syntax_Syntax.residual_flags =
                (uu___17_1256.FStar_Syntax_Syntax.residual_flags)
            }  in
