...
in {FStar_Syntax_Syntax.ppname = _38_52.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _38_52.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _136_49}))
in (
...
in {FStar_Syntax_Syntax.lbname = _38_91.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _38_91.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _136_71; FStar_Syntax_Syntax.lbeff = _38_91.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _136_70}))))))
...
in {FStar_Syntax_Syntax.ppname = _38_115.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _38_115.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _136_99}))
in ((_136_100), (imp)))
end)))))
...
in (let _136_123 = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun _38_1 -> (match (_38_1) with
...
in {FStar_Syntax_Syntax.comp_univs = _38_134.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = _38_134.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _136_125; FStar_Syntax_Syntax.effect_args = _136_124; FStar_Syntax_Syntax.flags = _136_123}))))
...
in {FStar_Syntax_Syntax.eff_name = _38_151.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _136_136; FStar_Syntax_Syntax.cflags = _38_151.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _38_153 -> (match (()) with
| () -> begin
