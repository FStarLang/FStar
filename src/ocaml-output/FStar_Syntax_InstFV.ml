  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___90_309 = bv  in
            let uu____310 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___90_309.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___90_309.FStar_Syntax_Syntax.index);
          ...
          let lbs1 =
            let uu____822 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb  ->
                      let uu___91_836 = lb  in
                      let uu____837 = inst s lb.FStar_Syntax_Syntax.lbtyp  in
                      let uu____840 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___91_836.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___91_836.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____837;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___91_836.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____840;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___91_836.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___91_836.FStar_Syntax_Syntax.lbpos)
                      }))
               in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____1029  ->
              ...
              | (x,imp) ->
                  let uu____1040 =
                    let uu___92_1041 = x  in
                    let uu____1042 = inst s x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___92_1041.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___92_1041.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
               ...
               in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___93_1131.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___93_1131.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1173 =
            let uu___94_1174 = rc  in
            let uu____1175 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s)
               in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___94_1174.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1175;
              FStar_Syntax_Syntax.residual_flags =
                (uu___94_1174.FStar_Syntax_Syntax.residual_flags)
            }  in
