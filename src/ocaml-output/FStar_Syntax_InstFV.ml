  ...
  fun s ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv, t2) ->
          let bv1 =
            let uu___30_299 = bv in
            let uu____300 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___30_299.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___30_299.FStar_Syntax_Syntax.index);
                    ...
                    | (p, wopt, t3) ->
                        let wopt1 =
                          ...
                          | FStar_Pervasives_Native.Some w ->
                              ...
                              FStar_Pervasives_Native.Some uu____503 in
                        let t4 = inst s t3 in (p, wopt1, t4))) in
          let uu____509 =
            let uu____510 = let uu____533 = inst s t2 in (uu____533, pats1) in
          ...
          let lbs1 =
            let uu____782 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb ->
                      let uu___31_796 = lb in
                      let uu____797 = inst s lb.FStar_Syntax_Syntax.lbtyp in
                      let uu____800 = inst s lb.FStar_Syntax_Syntax.lbdef in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___31_796.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___31_796.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____797;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___31_796.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____800;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___31_796.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___31_796.FStar_Syntax_Syntax.lbpos)
                      })) in
            ((FStar_Pervasives_Native.fst lbs), uu____782) in
          let uu____807 =
            let uu____808 = let uu____821 = inst s t2 in (lbs1, uu____821) in
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____912 =
            let uu____913 =
              ...
              let uu____921 =
                let uu____922 = let uu____929 = inst s t' in (m, uu____929) in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t2, tag) ->
          let uu____936 =
            let uu____937 = let uu____944 = inst s t2 in (uu____944, tag) in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____969 ->
              ...
              | (x, imp) ->
                  let uu____980 =
                    let uu___32_981 = x in
                    let uu____982 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___32_981.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___32_981.FStar_Syntax_Syntax.index);
  ...
  fun s ->
    fun c ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          let ct1 =
            let uu___33_1071 = ct in
            let uu____1072 = inst s ct.FStar_Syntax_Syntax.result_typ in
            let uu____1075 = inst_args s ct.FStar_Syntax_Syntax.effect_args in
            let uu____1084 =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___29_1094 ->
                      match uu___29_1094 with
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___33_1071.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___33_1071.FStar_Syntax_Syntax.effect_name);
