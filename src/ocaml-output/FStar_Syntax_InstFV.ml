  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___159_263 = bv in
            let uu____264 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___159_263.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___159_263.FStar_Syntax_Syntax.index);
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____931  ->
              ...
              | (x,imp) ->
                  let uu____942 =
                    let uu___161_943 = x in
                    let uu____944 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___161_943.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___161_943.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___162_1033.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___162_1033.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1075 =
            let uu___163_1076 = rc in
            let uu____1077 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___163_1076.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1077;
              FStar_Syntax_Syntax.residual_flags =
                (uu___163_1076.FStar_Syntax_Syntax.residual_flags)
            } in
