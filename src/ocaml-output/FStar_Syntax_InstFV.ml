  ...
  fun s ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv, t2) ->
          let bv1 =
            let uu___28_271 = bv in
            let uu____272 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___28_271.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___28_271.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_match (t2, pats) ->
          ...
          let uu____481 =
            let uu____482 = let uu____505 = inst s t2 in (uu____505, pats1) in
          ...
          let lbs1 =
            let uu____752 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb ->
                      let uu___29_766 = lb in
                      let uu____767 = inst s lb.FStar_Syntax_Syntax.lbtyp in
                      let uu____770 = inst s lb.FStar_Syntax_Syntax.lbdef in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___29_766.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___29_766.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____767;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___29_766.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____770;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___29_766.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___29_766.FStar_Syntax_Syntax.lbpos)
                      })) in
            ((FStar_Pervasives_Native.fst lbs), uu____752) in
          let uu____777 =
            let uu____778 = let uu____791 = inst s t2 in (lbs1, uu____791) in
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____882 =
            let uu____883 =
              ...
              let uu____891 =
                let uu____892 = let uu____899 = inst s t' in (m, uu____899) in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t2, tag) ->
          let uu____906 =
            let uu____907 = let uu____914 = inst s t2 in (uu____914, tag) in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____939 ->
              ...
              | (x, imp) ->
                  let uu____950 =
                    let uu___30_951 = x in
                    let uu____952 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___30_951.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___30_951.FStar_Syntax_Syntax.index);
  ...
  fun s ->
    fun c ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          let ct1 =
            let uu___31_1041 = ct in
            let uu____1042 = inst s ct.FStar_Syntax_Syntax.result_typ in
            let uu____1045 = inst_args s ct.FStar_Syntax_Syntax.effect_args in
            let uu____1054 =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___27_1064 ->
                      match uu___27_1064 with
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___31_1041.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___31_1041.FStar_Syntax_Syntax.effect_name);
