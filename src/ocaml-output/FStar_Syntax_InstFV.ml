                   ...
                   (fun lb  ->
                      ...
                      let uu____568 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        ...
                        FStar_Syntax_Syntax.lbeff =
                          (uu___157_564.FStar_Syntax_Syntax.lbeff);
          ...
          let ct1 =
               ...
               in
            {
              ...
              FStar_Syntax_Syntax.effect_name =
                (uu___159_759.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | Some (FStar_Util.Inl lc) ->
          let uu____822 =
            let uu____828 =
              let uu___160_829 = lc  in
              let uu____830 = inst s lc.FStar_Syntax_Syntax.res_typ  in
              {
                FStar_Syntax_Syntax.eff_name =
                  (uu___160_829.FStar_Syntax_Syntax.eff_name);
                FStar_Syntax_Syntax.res_typ = uu____830;
                FStar_Syntax_Syntax.cflags =
                  (uu___160_829.FStar_Syntax_Syntax.cflags);
                FStar_Syntax_Syntax.comp =
                  (fun uu____833  ->
