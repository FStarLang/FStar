  ...
  fun s  ->
    fun t  ->
                    ...
                    | (p,wopt,t3) ->
                        let wopt1 =
                          ...
                          | FStar_Pervasives_Native.Some w ->
                              let uu____389 = inst s w  in
                              FStar_Pervasives_Native.Some uu____389
                           in
                        let t4 = inst s t3  in (p, wopt1, t4)))
             in
          let uu____394 =
            let uu____395 = let uu____411 = inst s t2  in (uu____411, pats1)
               in
          ...
          let lbs1 =
            let uu____578 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
               ...
               in
            ((FStar_Pervasives_Native.fst lbs), uu____578)  in
          let uu____593 =
            let uu____594 = let uu____602 = inst s t2  in (lbs1, uu____602)
               in
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____666 =
            let uu____667 =
              ...
              let uu____673 =
                let uu____674 = let uu____679 = inst s t'  in (m, uu____679)
                   in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t2,tag) ->
          let uu____686 =
            let uu____687 = let uu____692 = inst s t2  in (uu____692, tag)
               in
...
and inst_lcomp_opt :
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Util.Inr uu____824) -> l
    ...
    fun t  ->
      ...
      | uu____876 ->
          let inst_fv t1 fv =
            ...
            | FStar_Pervasives_Native.Some (uu____901,us) ->
