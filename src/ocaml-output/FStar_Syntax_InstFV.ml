  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___154_253 = bv in
            let uu____254 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___154_253.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___154_253.FStar_Syntax_Syntax.index);
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____706  ->
              ...
              | (x,imp) ->
                  let uu____713 =
                    let uu___156_714 = x in
                    let uu____715 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___156_714.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___156_714.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___157_779.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___157_779.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | Some (FStar_Util.Inl lc) ->
          let uu____845 =
            let uu____851 =
              let uu___158_852 = lc in
              let uu____853 = inst s lc.FStar_Syntax_Syntax.res_typ in
              {
                FStar_Syntax_Syntax.eff_name =
                  (uu___158_852.FStar_Syntax_Syntax.eff_name);
                FStar_Syntax_Syntax.res_typ = uu____853;
                FStar_Syntax_Syntax.cflags =
                  (uu___158_852.FStar_Syntax_Syntax.cflags);
                FStar_Syntax_Syntax.comp =
                  (fun uu____856  ->
