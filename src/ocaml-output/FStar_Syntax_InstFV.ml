  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___173_267 = bv in
            let uu____268 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___173_267.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___173_267.FStar_Syntax_Syntax.index);
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____935  ->
              ...
              | (x,imp) ->
                  let uu____946 =
                    let uu___175_947 = x in
                    let uu____948 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___175_947.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___175_947.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___176_1037.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___176_1037.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1079 =
            let uu___177_1080 = rc in
            let uu____1081 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___177_1080.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1081;
              FStar_Syntax_Syntax.residual_flags =
                (uu___177_1080.FStar_Syntax_Syntax.residual_flags)
            } in
