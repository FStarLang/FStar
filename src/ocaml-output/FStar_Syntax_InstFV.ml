  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___159_233 = bv  in
            let uu____234 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___159_233.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___159_233.FStar_Syntax_Syntax.index);
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____649  ->
              ...
              | (x,imp) ->
                  let uu____656 =
                    let uu___161_657 = x  in
                    let uu____658 = inst s x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___161_657.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___161_657.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
               ...
               in
            {
              FStar_Syntax_Syntax.comp_typ_name =
                (uu___162_722.FStar_Syntax_Syntax.comp_typ_name);
              FStar_Syntax_Syntax.comp_univs =
                (uu___162_722.FStar_Syntax_Syntax.comp_univs);
