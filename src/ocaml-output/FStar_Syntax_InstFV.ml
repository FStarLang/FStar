...
let mk:
      'Auu____11 'Auu____12. 'Auu____12 FStar_Syntax_Syntax.syntax
...
let rec inst
    : (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.fv
  ...
  fun s t ->
    ...
    | FStar_Syntax_Syntax.Tm_abs (bs, body, lopt) ->
        ...
        let uu____209 =
          let uu____210 =
            ...
            (bs1, body1, uu____227)
          in
          FStar_Syntax_Syntax.Tm_abs uu____210
        in
        mk1 uu____209
    ...
    | FStar_Syntax_Syntax.Tm_refine (bv, t2) ->
        let bv1 =
          ...
          { FStar_Syntax_Syntax.ppname= uu___25_263.FStar_Syntax_Syntax.ppname
          ; FStar_Syntax_Syntax.index= uu___25_263.FStar_Syntax_Syntax.index
    ...
    | FStar_Syntax_Syntax.Tm_app (t2, args) ->
        let uu____290 =
          let uu____291 =
            ...
            let uu____307 = inst_args s args in
            (uu____306, uu____307)
          in
          FStar_Syntax_Syntax.Tm_app uu____291
        in
        mk1 uu____290
    | FStar_Syntax_Syntax.Tm_match (t2, pats) ->
        let pats1 =
          FStar_All.pipe_right pats
            (FStar_List.map (fun uu____429 ->
                 match uu____429 with p, wopt, t3 ->
                   let wopt1 =
                     match wopt with
        ...
        let uu____473 =
          let uu____474 =
            ...
            (uu____497, pats1)
          in
          FStar_Syntax_Syntax.Tm_match uu____474
        in
        mk1 uu____473
    | FStar_Syntax_Syntax.Tm_ascribed (t11, asc, f) ->
        let inst_asc uu____580 =
          match uu____580 with annot, topt ->
            let topt1 = FStar_Util.map_opt topt (inst s) in
            let annot1 =
              match annot with
              | FStar_Util.Inl t2 ->
                  let uu____642 = inst s t2 in
                  FStar_Util.Inl uu____642
              | FStar_Util.Inr c ->
        ...
        let uu____663 =
          let uu____664 =
            ...
            let uu____692 = inst_asc asc in
            (uu____691, uu____692, f)
          in
          FStar_Syntax_Syntax.Tm_ascribed uu____664
        in
        mk1 uu____663
    | FStar_Syntax_Syntax.Tm_let (lbs, t2) ->
        let lbs1 =
            ...
            FStar_All.pipe_right
              ...
              (FStar_List.map (fun lb ->
                   ...
                   ; FStar_Syntax_Syntax.lbunivs=
                       uu___26_758.FStar_Syntax_Syntax.lbunivs
          ...
          in
          (FStar_Pervasives_Native.fst lbs, uu____744)
        in
        let uu____769 =
          let uu____770 =
            let uu____783 = inst s t2 in
            (lbs1, uu____783)
          in
          FStar_Syntax_Syntax.Tm_let uu____770
        in
        mk1 uu____769
    | FStar_Syntax_Syntax.Tm_meta (t2, FStar_Syntax_Syntax.Meta_pattern args) ->
        let uu____806 =
          let uu____807 =
            ...
            let uu____815 =
              ...
              in
              FStar_Syntax_Syntax.Meta_pattern uu____816
            in
            (uu____814, uu____815)
          in
          FStar_Syntax_Syntax.Tm_meta uu____807
        in
        mk1 uu____806
    | FStar_Syntax_Syntax.Tm_meta (t2, FStar_Syntax_Syntax.Meta_monadic (m, t')) ->
        let uu____874 =
          let uu____875 =
            let uu____882 = inst s t2 in
            let uu____883 =
              let uu____884 =
                let uu____891 = inst s t' in
                (m, uu____891)
              in
              FStar_Syntax_Syntax.Meta_monadic uu____884
            in
            (uu____882, uu____883)
          in
          FStar_Syntax_Syntax.Tm_meta uu____875
        in
        mk1 uu____874
    | FStar_Syntax_Syntax.Tm_meta (t2, tag) ->
        let uu____898 =
          let uu____899 =
            let uu____906 = inst s t2 in
            (uu____906, tag)
          in
          FStar_Syntax_Syntax.Tm_meta uu____899
        in
        mk1 uu____898
...
and inst_binders
  ...
  fun s bs ->
    FStar_All.pipe_right bs
      (FStar_List.map (fun uu____931 ->
           match uu____931 with x, imp ->
             let uu____942 =
...
and inst_args
  ...
  fun s args ->
    FStar_All.pipe_right args
      (FStar_List.map (fun uu____987 ->
           match uu____987 with a, imp ->
             let uu____998 = inst s a in
             (uu____998, imp) ))
        ...
        let ct1 =
          ...
          let uu____1046 =
            FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
              (FStar_List.map (fun uu___24_1056 ->
          ...
          ; FStar_Syntax_Syntax.effect_name=
              uu___28_1033.FStar_Syntax_Syntax.effect_name
    ...
    | uu____1094 ->
        let inst_fv t1 fv =
          let uu____1102 =
            FStar_Util.find_opt
              (fun uu____1116 ->
                match uu____1116 with x, uu____1122 ->
