  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___27_281 = bv  in
            let uu____282 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___27_281.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___27_281.FStar_Syntax_Syntax.index);
          ...
          let lbs1 =
            let uu____794 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb  ->
                      let uu___28_808 = lb  in
                      let uu____809 = inst s lb.FStar_Syntax_Syntax.lbtyp  in
                      let uu____812 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___28_808.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___28_808.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____809;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___28_808.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____812;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___28_808.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___28_808.FStar_Syntax_Syntax.lbpos)
                      }))
               in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____1001  ->
              ...
              | (x,imp) ->
                  let uu____1012 =
                    let uu___29_1013 = x  in
                    let uu____1014 = inst s x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___29_1013.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___29_1013.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
               ...
               in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___30_1103.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___30_1103.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1145 =
            let uu___31_1146 = rc  in
            let uu____1147 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s)
               in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___31_1146.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1147;
              FStar_Syntax_Syntax.residual_flags =
                (uu___31_1146.FStar_Syntax_Syntax.residual_flags)
            }  in
