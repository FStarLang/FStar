  ...
  fun s ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv, t2) ->
          let bv1 =
            let uu___93_321 = bv in
            let uu____322 = inst s bv.FStar_Syntax_Syntax.sort in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___93_321.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___93_321.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_match (t2, pats) ->
          ...
          let uu____551 =
            let uu____552 = let uu____575 = inst s t2 in (uu____575, pats1) in
          ...
          let lbs1 =
            let uu____844 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb ->
                      let uu___94_858 = lb in
                      let uu____859 = inst s lb.FStar_Syntax_Syntax.lbtyp in
                      let uu____862 = inst s lb.FStar_Syntax_Syntax.lbdef in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___94_858.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___94_858.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____859;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___94_858.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____862;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___94_858.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___94_858.FStar_Syntax_Syntax.lbpos)
                      })) in
            ((FStar_Pervasives_Native.fst lbs), uu____844) in
          let uu____869 =
            let uu____870 = let uu____883 = inst s t2 in (lbs1, uu____883) in
      ...
      | FStar_Syntax_Syntax.Tm_meta (t2, tag) ->
          let uu____1026 =
            let uu____1027 = let uu____1034 = inst s t2 in (uu____1034, tag) in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____1069 ->
              ...
              | (x, imp) ->
                  let uu____1088 =
                    let uu___95_1089 = x in
                    let uu____1090 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___95_1089.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___95_1089.FStar_Syntax_Syntax.index);
  ...
  fun s ->
    fun c ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          let ct1 =
            let uu___96_1201 = ct in
            let uu____1202 = inst s ct.FStar_Syntax_Syntax.result_typ in
            let uu____1205 = inst_args s ct.FStar_Syntax_Syntax.effect_args in
            let uu____1216 =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___92_1226 ->
                      match uu___92_1226 with
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___96_1201.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___96_1201.FStar_Syntax_Syntax.effect_name);
