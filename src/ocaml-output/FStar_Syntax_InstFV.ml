          ...
          let bv1 =
            ...
            let uu____324 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___21_323.FStar_Syntax_Syntax.ppname);
                   ...
                   (fun lb  ->
                      ...
                      let uu____868 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___22_864.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___22_864.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____865;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___22_864.FStar_Syntax_Syntax.lbeff);
           ...
           (fun uu____1079  ->
              ...
              | (x,imp) ->
                  let uu____1098 =
                    ...
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___23_1099.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
