      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____686  ->
              ...
              | (x,imp) ->
                  let uu____693 =
                    let uu___161_694 = x in
                    let uu____695 = inst s x.FStar_Syntax_Syntax.sort in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___161_694.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___161_694.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
                      ...
                      | f -> f)) in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___162_759.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___162_759.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | Some (FStar_Util.Inl lc) ->
          let uu____822 =
            let uu____828 =
              let uu___163_829 = lc in
              let uu____830 = inst s lc.FStar_Syntax_Syntax.res_typ in
              {
                FStar_Syntax_Syntax.eff_name =
                  (uu___163_829.FStar_Syntax_Syntax.eff_name);
                FStar_Syntax_Syntax.res_typ = uu____830;
                FStar_Syntax_Syntax.cflags =
                  (uu___163_829.FStar_Syntax_Syntax.cflags);
                FStar_Syntax_Syntax.comp =
                  (fun uu____833  ->
