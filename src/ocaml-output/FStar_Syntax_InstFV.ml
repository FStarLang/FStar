  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t2) ->
          let bv1 =
            let uu___92_321 = bv  in
            let uu____322 = inst s bv.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___92_321.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___92_321.FStar_Syntax_Syntax.index);
          ...
          let lbs1 =
            let uu____844 =
              FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                (FStar_List.map
                   (fun lb  ->
                      let uu___93_858 = lb  in
                      let uu____859 = inst s lb.FStar_Syntax_Syntax.lbtyp  in
                      let uu____862 = inst s lb.FStar_Syntax_Syntax.lbdef  in
                      {
                        FStar_Syntax_Syntax.lbname =
                          (uu___93_858.FStar_Syntax_Syntax.lbname);
                        FStar_Syntax_Syntax.lbunivs =
                          (uu___93_858.FStar_Syntax_Syntax.lbunivs);
                        FStar_Syntax_Syntax.lbtyp = uu____859;
                        FStar_Syntax_Syntax.lbeff =
                          (uu___93_858.FStar_Syntax_Syntax.lbeff);
                        FStar_Syntax_Syntax.lbdef = uu____862;
                        FStar_Syntax_Syntax.lbattrs =
                          (uu___93_858.FStar_Syntax_Syntax.lbattrs);
                        FStar_Syntax_Syntax.lbpos =
                          (uu___93_858.FStar_Syntax_Syntax.lbpos)
                      }))
               in
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun uu____1069  ->
              ...
              | (x,imp) ->
                  let uu____1088 =
                    let uu___94_1089 = x  in
                    let uu____1090 = inst s x.FStar_Syntax_Syntax.sort  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___94_1089.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___94_1089.FStar_Syntax_Syntax.index);
          ...
          let ct1 =
               ...
               in
            {
              FStar_Syntax_Syntax.comp_univs =
                (uu___95_1201.FStar_Syntax_Syntax.comp_univs);
              FStar_Syntax_Syntax.effect_name =
                (uu___95_1201.FStar_Syntax_Syntax.effect_name);
  ...
  fun s  ->
    fun l  ->
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____1245 =
            let uu___96_1246 = rc  in
            let uu____1247 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s)
               in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___96_1246.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____1247;
              FStar_Syntax_Syntax.residual_flags =
                (uu___96_1246.FStar_Syntax_Syntax.residual_flags)
            }  in
