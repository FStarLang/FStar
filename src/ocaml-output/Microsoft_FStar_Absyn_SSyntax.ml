...
let parse_error = (fun _105665 -> (match (_105665) with
| () -> begin
...
| Some (l) -> begin
(let _105673 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 's')
in (f writer l))
end))
...
let serialize_list = (fun writer f l -> (let _105683 = (Support.Microsoft.FStar.Util.MkoWriter.write_int writer (Support.List.length l))
...
let serialize_LongIdent = (fun writer ast -> (let _105698 = (serialize_list writer serialize_ident ast.Microsoft_FStar_Absyn_Syntax.ns)
...
let serialize_withinfo_t = (fun writer s_v s_sort ast -> (let _105707 = (s_v writer ast.Microsoft_FStar_Absyn_Syntax.v)
...
let serialize_bvdef = (fun writer ast -> (let _105724 = (serialize_ident writer ast.Microsoft_FStar_Absyn_Syntax.ppname)
...
(let _105805 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (s_l writer v))
end
| Support.Microsoft.FStar.Util.Inr (v) -> begin
(let _105809 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (s_r writer v))
end))
...
(let _105834 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (serialize_btvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Typ_const (v) -> begin
(let _105838 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (serialize_ftvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Typ_fun ((bs, c)) -> begin
(let _105844 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (let _105846 = (serialize_binders writer bs)
in (serialize_comp writer c)))
end
| Microsoft_FStar_Absyn_Syntax.Typ_refine ((v, t)) -> begin
(let _105852 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'd')
in (let _105854 = (serialize_bvvar writer v)
in (serialize_typ writer t)))
end
| Microsoft_FStar_Absyn_Syntax.Typ_app ((t, ars)) -> begin
(let _105860 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'e')
in (let _105862 = (serialize_typ writer t)
in (let _105864 = (serialize_args writer ars)
in if ((Support.ST.read Microsoft_FStar_Options.debug) <> []) then begin
...
(let _105878 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'f')
in (let _105880 = (serialize_binders writer bs)
in (serialize_typ writer t)))
end
| Microsoft_FStar_Absyn_Syntax.Typ_ascribed ((t, k)) -> begin
(let _105886 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'g')
in (let _105888 = (serialize_typ writer t)
in (serialize_knd writer k)))
end
| Microsoft_FStar_Absyn_Syntax.Typ_meta (m) -> begin
(let _105892 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'h')
...
(let _105913 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (let _105915 = (serialize_typ writer t)
in (serialize_list writer serialize_arg l)))
end
| Microsoft_FStar_Absyn_Syntax.Meta_named ((t, lid)) -> begin
(let _105921 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (let _105923 = (serialize_typ writer t)
in (serialize_lident writer lid)))
end
| Microsoft_FStar_Absyn_Syntax.Meta_labeled ((t, s, _, b)) -> begin
(let _105932 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (let _105934 = (serialize_typ writer t)
in (let _105936 = (Support.Microsoft.FStar.Util.MkoWriter.write_string writer s)
in (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer b))))
end
| _ -> begin
(raise (Err ("unimplemented meta\x5ft")))
end))
and serialize_arg = (fun writer ast -> (let _105942 = (serialize_either writer serialize_typ serialize_exp (Support.Prims.fst ast))
...
and serialize_binder = (fun writer ast -> (let _105948 = (serialize_either writer serialize_btvar serialize_bvvar (Support.Prims.fst ast))
in (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer (Microsoft_FStar_Absyn_Syntax.is_implicit (Support.Prims.snd ast)))))
...
and serialize_comp_typ = (fun writer ast -> (let _105956 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.effect_name)
in (let _105958 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.result_typ)
in (let _105960 = (serialize_args writer ast.Microsoft_FStar_Absyn_Syntax.effect_args)
...
(let _105966 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (serialize_typ writer t))
end
| Microsoft_FStar_Absyn_Syntax.Comp (c) -> begin
(let _105970 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
...
(let _105984 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'g')
in (serialize_exp writer e))
end))
and serialize_exp' = (fun writer ast -> (match (ast) with
| Microsoft_FStar_Absyn_Syntax.Exp_bvar (v) -> begin
(let _105990 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (serialize_bvvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Exp_fvar ((v, b)) -> begin
(let _105996 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (let _105998 = (serialize_fvvar writer v)
in (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer b)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_constant (c) -> begin
(let _106002 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (serialize_sconst writer c))
end
| Microsoft_FStar_Absyn_Syntax.Exp_abs ((bs, e)) -> begin
(let _106008 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'd')
in (let _106010 = (serialize_binders writer bs)
in (serialize_exp writer e)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_app ((e, ars)) -> begin
(let _106016 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'e')
in (let _106018 = (serialize_exp writer e)
in (serialize_args writer ars)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_match ((e, l)) -> begin
(let g = (fun writer eopt -> (match (eopt) with
| Some (e1) -> begin
(let _106029 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (serialize_exp writer e1))
end
| None -> begin
(Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
end))
in (let f = (fun writer _106037 -> (match (_106037) with
| (p, eopt, e) -> begin
(let _106038 = (serialize_pat writer p)
in (let _106040 = (g writer eopt)
in (serialize_exp writer e)))
end))
in (let _106042 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'f')
in (let _106044 = (serialize_exp writer e)
in (serialize_list writer f l)))))
end
| Microsoft_FStar_Absyn_Syntax.Exp_ascribed ((e, t)) -> begin
(let _106050 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'g')
in (let _106052 = (serialize_exp writer e)
in (serialize_typ writer t)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_let ((lbs, e)) -> begin
(let _106058 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'h')
in (let _106060 = (serialize_letbindings writer lbs)
in (serialize_exp writer e)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_meta (m) -> begin
(let _106064 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'i')
...
(let _106074 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (let _106076 = (serialize_exp writer e)
...
(let _106094 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (serialize_list writer serialize_pat l))
end
| Microsoft_FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let _106098 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (serialize_sconst writer c))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((v, l)) -> begin
(let _106104 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (let _106106 = (serialize_fvvar writer v)
in (serialize_list writer serialize_pat l)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var ((v, b)) -> begin
(let _106112 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'd')
in (let _106114 = (serialize_bvvar writer v)
in (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer b)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (v) -> begin
(let _106118 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'e')
in (serialize_btvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_wild (v) -> begin
(let _106122 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'f')
in (serialize_bvvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (v) -> begin
(let _106126 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'g')
in (serialize_btvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_term ((v, e)) -> begin
(let _106132 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'h')
in (let _106134 = (serialize_bvvar writer v)
in (serialize_exp writer e)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((v, t)) -> begin
(let _106140 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'i')
in (let _106142 = (serialize_btvar writer v)
in (serialize_typ writer t)))
end))
...
(let _106156 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (let _106158 = (serialize_kabbrev writer ka)
in (serialize_knd writer k)))
end
| Microsoft_FStar_Absyn_Syntax.Kind_arrow ((bs, k)) -> begin
(let _106164 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'd')
in (let _106166 = (serialize_binders writer bs)
in (serialize_knd writer k)))
end
| Microsoft_FStar_Absyn_Syntax.Kind_lam ((bs, k)) -> begin
(let _106172 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'e')
in (let _106174 = (serialize_binders writer bs)
in (serialize_knd writer k)))
end
...
and serialize_kabbrev = (fun writer ast -> (let _106193 = (serialize_lident writer (Support.Prims.fst ast))
...
and serialize_letbindings = (fun writer ast -> (let f = (fun writer _106204 -> (match (_106204) with
| (n, t, e) -> begin
(let _106205 = (serialize_lbname writer n)
in (let _106207 = (serialize_typ writer t)
in (serialize_exp writer e)))
end))
in (let _106209 = (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer (Support.Prims.fst ast))
...
(let _106337 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'i')
in (serialize_lident writer lid))
end
| Microsoft_FStar_Absyn_Syntax.Projector ((lid, v)) -> begin
(let _106343 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'j')
in (let _106345 = (serialize_lident writer lid)
in (serialize_either writer serialize_btvdef serialize_bvvdef v)))
end
| Microsoft_FStar_Absyn_Syntax.RecordType (l) -> begin
(let _106349 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'k')
in (serialize_list writer serialize_ident l))
end
| Microsoft_FStar_Absyn_Syntax.RecordConstructor (l) -> begin
(let _106353 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'l')
in (serialize_list writer serialize_ident l))
end
...
(let _106359 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'p')
...
let serialize_tycon = (fun writer _106383 -> (match (_106383) with
| (lid, bs, k) -> begin
(let _106384 = (serialize_lident writer lid)
in (let _106386 = (serialize_binders writer bs)
in (serialize_knd writer k)))
end))

let deserialize_tycon = (fun reader -> ((deserialize_lident reader), (deserialize_binders reader), (deserialize_knd reader)))

let serialize_monad_abbrev = (fun writer ast -> (let _106391 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.mabbrev)
in (let _106393 = (serialize_binders writer ast.Microsoft_FStar_Absyn_Syntax.parms)
...
let serialize_sub_effect = (fun writer ast -> (let _106398 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.source)
in (let _106400 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.target)
...
let rec serialize_new_effect = (fun writer ast -> (let _106405 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.mname)
in (let _106407 = (serialize_list writer serialize_binder ast.Microsoft_FStar_Absyn_Syntax.binders)
in (let _106409 = (serialize_list writer serialize_qualifier ast.Microsoft_FStar_Absyn_Syntax.qualifiers)
in (let _106411 = (serialize_knd writer ast.Microsoft_FStar_Absyn_Syntax.signature)
in (let _106413 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.ret)
in (let _106415 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.bind_wp)
in (let _106417 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.bind_wlp)
in (let _106419 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.if_then_else)
in (let _106421 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.ite_wp)
in (let _106423 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.ite_wlp)
in (let _106425 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.wp_binop)
in (let _106427 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.wp_as_type)
in (let _106429 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.close_wp)
in (let _106431 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.close_wp_t)
in (let _106433 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.assert_p)
in (let _106435 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.assume_p)
in (let _106437 = (serialize_typ writer ast.Microsoft_FStar_Absyn_Syntax.null_wp)
...
(let _106454 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'a')
in (let _106456 = (serialize_lident writer lid)
in (let _106458 = (serialize_binders writer bs)
in (let _106460 = (serialize_knd writer k)
in (let _106462 = (serialize_list writer serialize_lident l1)
in (let _106464 = (serialize_list writer serialize_lident l2)
in (serialize_list writer serialize_qualifier qs)))))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev ((lid, bs, k, t, qs, _)) -> begin
(let _106475 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'b')
in (let _106477 = (serialize_lident writer lid)
in (let _106479 = (serialize_binders writer bs)
in (let _106481 = (serialize_knd writer k)
in (let _106483 = (serialize_typ writer t)
in (serialize_list writer serialize_qualifier qs))))))
end
...
in (let _106500 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'c')
in (let _106502 = (serialize_lident writer lid1)
in (let _106504 = (serialize_typ writer t')
in (let _106506 = (serialize_tycon writer tyc)
in (let _106508 = (serialize_list writer serialize_qualifier qs)
in (serialize_list writer serialize_lident mutuals)))))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((lid, t, qs, _)) -> begin
(let _106517 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'd')
in (let _106519 = (serialize_lident writer lid)
in (let _106521 = (serialize_typ writer t)
in (serialize_list writer serialize_qualifier qs))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_assume ((lid, fml, qs, _)) -> begin
(let _106530 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'e')
in (let _106532 = (serialize_lident writer lid)
in (let _106534 = (serialize_formula writer fml)
in (serialize_list writer serialize_qualifier qs))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_let ((lbs, _, l, quals)) -> begin
(let _106543 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'f')
in (let _106545 = (serialize_letbindings writer lbs)
in (let _106547 = (serialize_list writer serialize_lident l)
in (Support.Microsoft.FStar.Util.MkoWriter.write_bool writer ((Support.Microsoft.FStar.Util.for_some (fun _105663 -> (match (_105663) with
| Microsoft_FStar_Absyn_Syntax.HasMaskedEffect -> begin
true
end
| _ -> begin
...
(let _106558 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'g')
in (serialize_exp writer e))
end
| Microsoft_FStar_Absyn_Syntax.Sig_bundle ((l, qs, lids, _)) -> begin
(let _106567 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'h')
in (let _106569 = (serialize_list writer serialize_sigelt l)
in (let _106571 = (serialize_list writer serialize_qualifier qs)
in (serialize_list writer serialize_lident lids))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_new_effect ((n, _)) -> begin
(let _106578 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'i')
in (serialize_new_effect writer n))
end
| Microsoft_FStar_Absyn_Syntax.Sig_effect_abbrev ((lid, bs, c, qs, _)) -> begin
(let _106588 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'j')
in (let _106590 = (serialize_lident writer lid)
in (let _106592 = (serialize_binders writer bs)
in (let _106594 = (serialize_comp writer c)
in (serialize_list writer serialize_qualifier qs)))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_sub_effect ((se, r)) -> begin
(let _106600 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'k')
in (serialize_sub_effect writer se))
end
| Microsoft_FStar_Absyn_Syntax.Sig_kind_abbrev ((l, binders, k, _)) -> begin
(let _106609 = (Support.Microsoft.FStar.Util.MkoWriter.write_char writer 'l')
in (let _106611 = (serialize_lident writer l)
in (let _106613 = (serialize_list writer serialize_binder binders)
in (serialize_knd writer k))))
end))
...
let serialize_modul = (fun writer ast -> (let _106636 = (serialize_lident writer ast.Microsoft_FStar_Absyn_Syntax.name)
in (let _106638 = (serialize_sigelts writer [])
in (let _106640 = (serialize_sigelts writer ast.Microsoft_FStar_Absyn_Syntax.exports)
...
in (let _106644 = m
in {Microsoft_FStar_Absyn_Syntax.name = _106644.Microsoft_FStar_Absyn_Syntax.name; Microsoft_FStar_Absyn_Syntax.declarations = m.Microsoft_FStar_Absyn_Syntax.exports; Microsoft_FStar_Absyn_Syntax.exports = _106644.Microsoft_FStar_Absyn_Syntax.exports; Microsoft_FStar_Absyn_Syntax.is_interface = _106644.Microsoft_FStar_Absyn_Syntax.is_interface; Microsoft_FStar_Absyn_Syntax.is_deserialized = _106644.Microsoft_FStar_Absyn_Syntax.is_deserialized})))
