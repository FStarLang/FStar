...
| () -> begin
(All.failwith "Parse error: ill-formed cache")
end))

type l__Writer =
Microsoft_FStar_Util.oWriter

type l__Reader =
Microsoft_FStar_Util.oReader

let serialize_option = (fun writer f l -> (match (l) with
| None -> begin
(writer.Microsoft_FStar_Util.write_char 'n')
end
| Some (l) -> begin
(let _27_12 = (writer.Microsoft_FStar_Util.write_char 's')
in (f writer l))
end))

let deserialize_option = (fun reader f -> (let n = (reader.Microsoft_FStar_Util.read_char ())
in (match ((n = 'n')) with
| true -> begin
None
end
...
let serialize_list = (fun writer f l -> (let _27_22 = (writer.Microsoft_FStar_Util.write_int (Microsoft_FStar_List.length l))
in (Microsoft_FStar_List.iter (fun elt -> (f writer elt)) (Microsoft_FStar_List.rev_append l []))))

let deserialize_list = (fun reader f -> (let n = (reader.Microsoft_FStar_Util.read_int ())
...
let serialize_ident = (fun writer ast -> (writer.Microsoft_FStar_Util.write_string ast.Microsoft_FStar_Absyn_Syntax.idText))

let deserialize_ident = (fun reader -> (let _93_50 = (let _93_49 = (reader.Microsoft_FStar_Util.read_string ())
...
in (_93_57)::[])
in (Microsoft_FStar_List.append _93_59 _93_58)))
...
(writer.Microsoft_FStar_Util.write_char 'a')
end
| Microsoft_FStar_Absyn_Syntax.Const_uint8 (v) -> begin
(let _27_83 = (writer.Microsoft_FStar_Util.write_char 'b')
in (writer.Microsoft_FStar_Util.write_byte v))
end
| Microsoft_FStar_Absyn_Syntax.Const_bool (v) -> begin
(let _27_87 = (writer.Microsoft_FStar_Util.write_char 'c')
in (writer.Microsoft_FStar_Util.write_bool v))
end
| Microsoft_FStar_Absyn_Syntax.Const_int32 (v) -> begin
(let _27_91 = (writer.Microsoft_FStar_Util.write_char 'd')
in (writer.Microsoft_FStar_Util.write_int32 v))
end
| Microsoft_FStar_Absyn_Syntax.Const_int64 (v) -> begin
(let _27_95 = (writer.Microsoft_FStar_Util.write_char 'e')
in (writer.Microsoft_FStar_Util.write_int64 v))
end
| Microsoft_FStar_Absyn_Syntax.Const_char (v) -> begin
(let _27_99 = (writer.Microsoft_FStar_Util.write_char 'f')
in (writer.Microsoft_FStar_Util.write_char v))
end
| Microsoft_FStar_Absyn_Syntax.Const_float (v) -> begin
(let _27_103 = (writer.Microsoft_FStar_Util.write_char 'g')
in (writer.Microsoft_FStar_Util.write_double v))
end
| Microsoft_FStar_Absyn_Syntax.Const_bytearray (v, _27_107) -> begin
(let _27_110 = (writer.Microsoft_FStar_Util.write_char 'h')
in (writer.Microsoft_FStar_Util.write_bytearray v))
end
| Microsoft_FStar_Absyn_Syntax.Const_string (v, _27_114) -> begin
(let _27_117 = (writer.Microsoft_FStar_Util.write_char 'i')
in (writer.Microsoft_FStar_Util.write_bytearray v))
end
| Microsoft_FStar_Absyn_Syntax.Const_int (v) -> begin
(let _27_121 = (writer.Microsoft_FStar_Util.write_char 'j')
in (writer.Microsoft_FStar_Util.write_string v))
end))

let deserialize_sconst = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
Microsoft_FStar_Absyn_Syntax.Const_unit
end
| 'b' -> begin
(let _93_132 = (reader.Microsoft_FStar_Util.read_byte ())
in Microsoft_FStar_Absyn_Syntax.Const_uint8 (_93_132))
end
| 'c' -> begin
(let _93_133 = (reader.Microsoft_FStar_Util.read_bool ())
in Microsoft_FStar_Absyn_Syntax.Const_bool (_93_133))
end
| 'd' -> begin
(let _93_134 = (reader.Microsoft_FStar_Util.read_int32 ())
in Microsoft_FStar_Absyn_Syntax.Const_int32 (_93_134))
end
| 'e' -> begin
(let _93_135 = (reader.Microsoft_FStar_Util.read_int64 ())
in Microsoft_FStar_Absyn_Syntax.Const_int64 (_93_135))
end
| 'f' -> begin
(let _93_136 = (reader.Microsoft_FStar_Util.read_char ())
in Microsoft_FStar_Absyn_Syntax.Const_char (_93_136))
end
| 'g' -> begin
(let _93_137 = (reader.Microsoft_FStar_Util.read_double ())
in Microsoft_FStar_Absyn_Syntax.Const_float (_93_137))
end
| 'h' -> begin
(let _93_139 = (let _93_138 = (reader.Microsoft_FStar_Util.read_bytearray ())
in (_93_138, Microsoft_FStar_Absyn_Syntax.dummyRange))
in Microsoft_FStar_Absyn_Syntax.Const_bytearray (_93_139))
end
| 'i' -> begin
(let _93_141 = (let _93_140 = (reader.Microsoft_FStar_Util.read_bytearray ())
in (_93_140, Microsoft_FStar_Absyn_Syntax.dummyRange))
in Microsoft_FStar_Absyn_Syntax.Const_string (_93_141))
end
| 'j' -> begin
(let _93_142 = (reader.Microsoft_FStar_Util.read_string ())
...
| Microsoft_FStar_Util.Inl (v) -> begin
(let _27_144 = (writer.Microsoft_FStar_Util.write_char 'a')
in (s_l writer v))
end
| Microsoft_FStar_Util.Inr (v) -> begin
(let _27_148 = (writer.Microsoft_FStar_Util.write_char 'b')
in (s_r writer v))
end))

let deserialize_either = (fun reader ds_l ds_r -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
(let _93_168 = (ds_l reader)
in Microsoft_FStar_Util.Inl (_93_168))
end
| 'b' -> begin
(let _93_169 = (ds_r reader)
in Microsoft_FStar_Util.Inr (_93_169))
end
| _27_158 -> begin
(parse_error ())
end))
...
in (let _93_187 = (Microsoft_FStar_Util.mk_ref None)
in (let _93_186 = (Microsoft_FStar_Util.mk_ref None)
in (let _93_185 = (Microsoft_FStar_Util.mk_ref None)
...
(let _27_252 = (writer.Microsoft_FStar_Util.write_char 'a')
...
(let _27_260 = (writer.Microsoft_FStar_Util.write_char 'b')
...
(let _27_271 = (writer.Microsoft_FStar_Util.write_char 'c')
in (let _27_273 = (serialize_typ writer t)
in (let _27_275 = (writer.Microsoft_FStar_Util.write_string s)
in (writer.Microsoft_FStar_Util.write_bool b))))
end
| _27_278 -> begin
(Prims.raise (Err ("unimplemented meta_t")))
end))
and serialize_arg = (fun writer ast -> (let _27_281 = (serialize_either writer serialize_typ serialize_exp (Prims.fst ast))
in (let _93_255 = (All.pipe_left Microsoft_FStar_Absyn_Syntax.is_implicit (Prims.snd ast))
in (writer.Microsoft_FStar_Util.write_bool _93_255))))
and serialize_args = (fun writer ast -> (serialize_list writer serialize_arg ast))
and serialize_binder = (fun writer ast -> (let _27_287 = (serialize_either writer serialize_btvar serialize_bvvar (Prims.fst ast))
in (let _93_260 = (All.pipe_left Microsoft_FStar_Absyn_Syntax.is_implicit (Prims.snd ast))
in (writer.Microsoft_FStar_Util.write_bool _93_260))))
...
(let _27_305 = (writer.Microsoft_FStar_Util.write_char 'a')
in (serialize_typ writer t))
end
| Microsoft_FStar_Absyn_Syntax.Comp (c) -> begin
(let _27_309 = (writer.Microsoft_FStar_Util.write_char 'b')
...
| Some (e1) -> begin
(let _27_368 = (writer.Microsoft_FStar_Util.write_char 'a')
...
(let _27_400 = (writer.Microsoft_FStar_Util.write_char 'h')
in (let _27_402 = (serialize_letbindings writer lbs)
in (serialize_exp writer e)))
end
| Microsoft_FStar_Absyn_Syntax.Exp_meta (m) -> begin
(let _27_406 = (writer.Microsoft_FStar_Util.write_char 'i')
...
(let _27_416 = (writer.Microsoft_FStar_Util.write_char 'a')
...
(let _27_436 = (writer.Microsoft_FStar_Util.write_char 'a')
in (serialize_list writer serialize_pat l))
end
| Microsoft_FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let _27_440 = (writer.Microsoft_FStar_Util.write_char 'b')
in (serialize_sconst writer c))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons (v, _27_444, l) -> begin
(let _27_448 = (writer.Microsoft_FStar_Util.write_char 'c')
...
in (w.Microsoft_FStar_Util.write_bool b))
end)) l)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var (v) -> begin
(let _27_460 = (writer.Microsoft_FStar_Util.write_char 'd')
in (serialize_bvvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (v) -> begin
(let _27_464 = (writer.Microsoft_FStar_Util.write_char 'e')
in (serialize_btvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_wild (v) -> begin
(let _27_468 = (writer.Microsoft_FStar_Util.write_char 'f')
in (serialize_bvvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (v) -> begin
(let _27_472 = (writer.Microsoft_FStar_Util.write_char 'g')
in (serialize_btvar writer v))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_term (v, e) -> begin
(let _27_478 = (writer.Microsoft_FStar_Util.write_char 'h')
in (let _27_480 = (serialize_bvvar writer v)
in (serialize_exp writer e)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_typ (v, t) -> begin
(let _27_486 = (writer.Microsoft_FStar_Util.write_char 'i')
...
(let _27_502 = (writer.Microsoft_FStar_Util.write_char 'c')
in (let _27_504 = (serialize_kabbrev writer ka)
in (serialize_knd writer k)))
end
| Microsoft_FStar_Absyn_Syntax.Kind_arrow (bs, k) -> begin
(let _27_510 = (writer.Microsoft_FStar_Util.write_char 'd')
in (let _27_512 = (serialize_binders writer bs)
in (serialize_knd writer k)))
end
| Microsoft_FStar_Absyn_Syntax.Kind_lam (bs, k) -> begin
(let _27_518 = (writer.Microsoft_FStar_Util.write_char 'e')
...
and serialize_kabbrev = (fun writer ast -> (let _27_539 = (serialize_lident writer (Prims.fst ast))
...
in (let _27_554 = (writer.Microsoft_FStar_Util.write_bool (Prims.fst ast))
...
let rec deserialize_typ' = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_meta_t = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (let _93_384 = (reader.Microsoft_FStar_Util.read_string ())
in (let _93_383 = (reader.Microsoft_FStar_Util.read_bool ())
...
in (let _93_389 = (let _93_388 = (reader.Microsoft_FStar_Util.read_bool ())
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.as_implicit _93_388))
in (_93_390, _93_389))))
...
in (let _93_394 = (let _93_393 = (reader.Microsoft_FStar_Util.read_bool ())
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.as_implicit _93_393))
in (_93_395, _93_394))))
...
and deserialize_comp' = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_cflags = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_exp' = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (let _93_412 = (let _27_609 = (let _93_411 = (reader.Microsoft_FStar_Util.read_bool ())
in (All.pipe_left Prims.ignore _93_411))
in None)
in (_93_413, _93_412)))
...
| 'f' -> begin
(let g = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_meta_e = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_meta_source_info = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
and deserialize_pat' = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (let _93_453 = (r.Microsoft_FStar_Util.read_bool ())
in (_93_454, _93_453)))))
...
and deserialize_knd' = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (let _93_493 = (reader.Microsoft_FStar_Util.read_bool ())
...
(writer.Microsoft_FStar_Util.write_char 'g')
end
| Microsoft_FStar_Absyn_Syntax.Opaque -> begin
(writer.Microsoft_FStar_Util.write_char 'h')
end
| Microsoft_FStar_Absyn_Syntax.Discriminator (lid) -> begin
(let _27_685 = (writer.Microsoft_FStar_Util.write_char 'i')
in (serialize_lident writer lid))
end
| Microsoft_FStar_Absyn_Syntax.Projector (lid, v) -> begin
(let _27_691 = (writer.Microsoft_FStar_Util.write_char 'j')
...
(let _27_697 = (writer.Microsoft_FStar_Util.write_char 'k')
in (serialize_list writer serialize_lident l))
end
| Microsoft_FStar_Absyn_Syntax.RecordConstructor (l) -> begin
(let _27_701 = (writer.Microsoft_FStar_Util.write_char 'l')
in (serialize_list writer serialize_lident l))
end
| Microsoft_FStar_Absyn_Syntax.ExceptionConstructor -> begin
(writer.Microsoft_FStar_Util.write_char 'm')
end
| Microsoft_FStar_Absyn_Syntax.HasMaskedEffect -> begin
(writer.Microsoft_FStar_Util.write_char 'o')
end
| Microsoft_FStar_Absyn_Syntax.DefaultEffect (l) -> begin
(let _27_707 = (writer.Microsoft_FStar_Util.write_char 'p')
in (serialize_option writer serialize_lident l))
end
| Microsoft_FStar_Absyn_Syntax.TotalEffect -> begin
(writer.Microsoft_FStar_Util.write_char 'q')
end
| _27_711 -> begin
(All.failwith "Unexpected qualifier")
end))

let deserialize_qualifier = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (All.pipe_right _93_515 (fun _93_514 -> Microsoft_FStar_Absyn_Syntax.DefaultEffect (_93_514))))
end
| 'q' -> begin
...
(let _27_802 = (writer.Microsoft_FStar_Util.write_char 'a')
...
(let _27_823 = (writer.Microsoft_FStar_Util.write_char 'b')
...
in (let _27_848 = (writer.Microsoft_FStar_Util.write_char 'c')
...
(let _27_865 = (writer.Microsoft_FStar_Util.write_char 'd')
...
(let _27_878 = (writer.Microsoft_FStar_Util.write_char 'e')
...
(let _27_891 = (writer.Microsoft_FStar_Util.write_char 'f')
in (let _27_893 = (serialize_letbindings writer lbs)
in (let _27_895 = (serialize_list writer serialize_lident l)
in (let _93_554 = (All.pipe_right quals (Microsoft_FStar_Util.for_some (fun _27_1 -> (match (_27_1) with
| Microsoft_FStar_Absyn_Syntax.HasMaskedEffect -> begin
true
end
| _27_900 -> begin
...
in (writer.Microsoft_FStar_Util.write_bool _93_554)))))
end
| Microsoft_FStar_Absyn_Syntax.Sig_main (e, _27_903) -> begin
(let _27_906 = (writer.Microsoft_FStar_Util.write_char 'g')
in (serialize_exp writer e))
end
| Microsoft_FStar_Absyn_Syntax.Sig_bundle (l, qs, lids, _27_912) -> begin
(let _27_915 = (writer.Microsoft_FStar_Util.write_char 'h')
...
(let _27_926 = (writer.Microsoft_FStar_Util.write_char 'i')
in (serialize_new_effect writer n))
end
| Microsoft_FStar_Absyn_Syntax.Sig_effect_abbrev (lid, bs, c, qs, _27_933) -> begin
(let _27_936 = (writer.Microsoft_FStar_Util.write_char 'j')
...
(let _27_948 = (writer.Microsoft_FStar_Util.write_char 'k')
in (serialize_sub_effect writer se))
end
| Microsoft_FStar_Absyn_Syntax.Sig_kind_abbrev (l, binders, k, _27_954) -> begin
(let _27_957 = (writer.Microsoft_FStar_Util.write_char 'l')
...
and deserialize_sigelt = (fun reader -> (match ((reader.Microsoft_FStar_Util.read_char ())) with
| 'a' -> begin
...
in (let _93_604 = (match ((reader.Microsoft_FStar_Util.read_bool ())) with
| true -> begin
(Microsoft_FStar_Absyn_Syntax.HasMaskedEffect)::[]
end
| false -> begin
...
in (writer.Microsoft_FStar_Util.write_bool ast.Microsoft_FStar_Absyn_Syntax.is_interface)))))
...
in (let _93_628 = (reader.Microsoft_FStar_Util.read_bool ())
