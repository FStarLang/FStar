  ...
  fun g  ->
    ...
    let uu___1 =
      ...
      | FStar_Pervasives_Native.Some t ->
          ...
          FStar_Util.format1 "\tGOAL ALREADY SOLVED!: %s" uu___3
       in
    ...
    fun t  ->
      ...
      let fresh_until b f =
        let rec aux i =
          ...
          let uu___ = f t1  in if uu___ then t1 else aux (i + Prims.int_one)
           in
        ...
        | b::bs2 ->
            ...
            (match uu___ with
             | (bv0,q) ->
                 ...
                 go (nbs :: seen) uu___1 bs2 (b2 :: bs') t1)
         in
      go [] [] bs [] t
