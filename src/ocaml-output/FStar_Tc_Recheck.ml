...
(let _100_30 = (FStar_Absyn_Util.compress_typ t)
in (recompute_kind _100_30))
end
...
(let _100_32 = (let _100_31 = (recompute_kind body)
in (binders, _100_31))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_32 t.FStar_Absyn_Syntax.pos))
end
...
| (_31_105, []) -> begin
(let _100_39 = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, k) t.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _100_39 (FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _100_40 = (FStar_Absyn_Util.subst_formal b a)
in (_100_40)::subst)
in (aux subst bs args))
end
| _31_117 -> begin
(let _100_45 = (let _100_44 = (FStar_Absyn_Print.kind_to_string k1)
in (let _100_43 = (FStar_Absyn_Print.tag_of_typ t)
in (let _100_42 = (FStar_Absyn_Print.kind_to_string k)
in (let _100_41 = (FStar_All.pipe_right (FStar_List.length args) FStar_Util.string_of_int)
in (FStar_Util.format4 "Head kind is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _100_44 _100_43 _100_42 _100_41)))))
in (FStar_All.failwith _100_45))
end))
in (aux [] bs args))
end)))
end)
...
(let _100_50 = (FStar_Absyn_Util.compress_exp e)
in (recompute_typ _100_50))
end
...
(let _100_53 = (let _100_52 = (let _100_51 = (recompute_typ body)
in (FStar_Absyn_Syntax.mk_Total _100_51))
in (bs, _100_52))
in (FStar_Absyn_Syntax.mk_Typ_fun _100_53 None e.FStar_Absyn_Syntax.pos))
end
...
| (_31_162, []) -> begin
(let _100_60 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _100_60 (FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _100_61 = (FStar_Absyn_Util.subst_formal b a)
in (_100_61)::subst)
in (aux subst bs args))
end
| _31_174 -> begin
