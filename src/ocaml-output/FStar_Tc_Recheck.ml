...
| FStar_Absyn_Syntax.Const_bool (_30_5) -> begin
t_bool
end
| FStar_Absyn_Syntax.Const_int (_30_8) -> begin
t_int
end
| FStar_Absyn_Syntax.Const_int32 (_30_11) -> begin
t_int32
end
| FStar_Absyn_Syntax.Const_int64 (_30_14) -> begin
t_int64
end
| FStar_Absyn_Syntax.Const_string (_30_17) -> begin
t_string
end
| FStar_Absyn_Syntax.Const_float (_30_20) -> begin
t_float
end
| FStar_Absyn_Syntax.Const_char (_30_23) -> begin
t_char
end
| FStar_Absyn_Syntax.Const_uint8 (_30_26) -> begin
t_uint8
end
| _30_29 -> begin
...
| FStar_Absyn_Syntax.Typ_delayed (_30_34) -> begin
...
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (t, _30_69)) -> begin
(recompute_kind t)
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label (t, _30_75, _30_77)) -> begin
(recompute_kind t)
end
...
in (let _30_96 = (FStar_Absyn_Util.kind_formals k1)
...
| None -> begin
(let k = (recompute t)
in (let _30_123 = (FStar_ST.op_Colon_Equals t.FStar_Absyn_Syntax.tk (Some (k)))
in k))
end)))

let rec recompute_typ = (fun e -> (let recompute = (fun e -> (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (_30_129) -> begin
...
| FStar_Absyn_Syntax.Exp_fvar (f, _30_135) -> begin
...
| FStar_Absyn_Syntax.Exp_match (_30_176) -> begin
(FStar_All.failwith "Expect match nodes to be annotated already")
end
| FStar_Absyn_Syntax.Exp_ascribed (_30_179, t, _30_182) -> begin
t
end
| FStar_Absyn_Syntax.Exp_let (_30_186, e) -> begin
(recompute_typ e)
end
| FStar_Absyn_Syntax.Exp_uvar (_30_191, t) -> begin
t
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _30_197)) -> begin
(recompute_typ e)
end))
...
| None -> begin
(let t = (recompute e)
in (let _30_205 = (FStar_ST.op_Colon_Equals e.FStar_Absyn_Syntax.tk (Some (t)))
in t))
end)))
