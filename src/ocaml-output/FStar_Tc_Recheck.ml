...
(let _121_30 = (FStar_Absyn_Util.compress_typ t)
in (recompute_kind _121_30))
end
...
(let _121_32 = (let _121_31 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "UNKNOWN KIND FOR %s" _121_31))
in (FStar_All.failwith _121_32))
end
| _37_42 -> begin
...
(let _121_34 = (let _121_33 = (recompute_kind body)
in (binders, _121_33))
in (FStar_Absyn_Syntax.mk_Kind_arrow _121_34 t.FStar_Absyn_Syntax.pos))
end
...
| (_37_108, []) -> begin
(let _121_41 = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, k) t.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _121_41 (FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
(
# 85 "FStar.Tc.Recheck.fst"
let subst = (let _121_42 = (FStar_Absyn_Util.subst_formal b a)
in (_121_42)::subst)
in (aux subst bs args))
end
| _37_120 -> begin
(let _121_48 = (let _121_47 = (FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _121_46 = (FStar_Absyn_Print.kind_to_string k1)
in (let _121_45 = (FStar_Absyn_Print.tag_of_typ t)
in (let _121_44 = (FStar_Absyn_Print.kind_to_string k)
in (let _121_43 = (FStar_All.pipe_right (FStar_List.length args) FStar_Util.string_of_int)
in (FStar_Util.format5 "(%s) HEAD KIND is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _121_47 _121_46 _121_45 _121_44 _121_43))))))
in (FStar_All.failwith _121_48))
end))
in (aux [] bs args))
end)))
end)
...
(let _121_53 = (FStar_Absyn_Util.compress_exp e)
in (recompute_typ _121_53))
end
...
(let _121_56 = (let _121_55 = (let _121_54 = (recompute_typ body)
in (FStar_Absyn_Syntax.mk_Total _121_54))
in (bs, _121_55))
in (FStar_Absyn_Syntax.mk_Typ_fun _121_56 None e.FStar_Absyn_Syntax.pos))
end
...
| (_37_165, []) -> begin
(let _121_63 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _121_63 (FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
(
# 113 "FStar.Tc.Recheck.fst"
let subst = (let _121_64 = (FStar_Absyn_Util.subst_formal b a)
in (_121_64)::subst)
in (aux subst bs args))
end
| _37_177 -> begin
