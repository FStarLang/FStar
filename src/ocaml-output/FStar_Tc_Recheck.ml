...
| FStar_Const.Const_int (_44_8, None) -> begin
t_int
end
| FStar_Const.Const_int (_44_13, Some (FStar_Const.Unsigned, FStar_Const.Int8)) -> begin
t_uint8
end
| FStar_Const.Const_int (_44_21, Some (FStar_Const.Signed, FStar_Const.Int8)) -> begin
t_int8
end
| FStar_Const.Const_int (_44_29, Some (FStar_Const.Unsigned, FStar_Const.Int16)) -> begin
t_uint16
end
| FStar_Const.Const_int (_44_37, Some (FStar_Const.Signed, FStar_Const.Int16)) -> begin
t_int16
end
| FStar_Const.Const_int (_44_45, Some (FStar_Const.Unsigned, FStar_Const.Int32)) -> begin
t_uint32
end
| FStar_Const.Const_int (_44_53, Some (FStar_Const.Signed, FStar_Const.Int32)) -> begin
t_int32
end
| FStar_Const.Const_int (_44_61, Some (FStar_Const.Unsigned, FStar_Const.Int64)) -> begin
t_uint64
end
| FStar_Const.Const_int (_44_69, Some (FStar_Const.Signed, FStar_Const.Int64)) -> begin
t_int64
end
| FStar_Const.Const_string (_44_77) -> begin
t_string
end
| FStar_Const.Const_float (_44_80) -> begin
t_float
end
| FStar_Const.Const_char (_44_83) -> begin
t_char
end
| _44_86 -> begin
...
| FStar_Absyn_Syntax.Typ_delayed (_44_91) -> begin
(let _145_40 = (FStar_Absyn_Util.compress_typ t)
in (recompute_kind _145_40))
end
...
(let _145_42 = (let _145_41 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "UNKNOWN KIND FOR %s" _145_41))
in (failwith _145_42))
end
| _44_99 -> begin
...
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (t, _44_129)) -> begin
(recompute_kind t)
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label (t, _44_135, _44_137)) -> begin
(recompute_kind t)
end
| FStar_Absyn_Syntax.Typ_lam (binders, body) -> begin
(let _145_44 = (let _145_43 = (recompute_kind body)
in ((binders), (_145_43)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _145_44 t.FStar_Absyn_Syntax.pos))
end
...
let _44_156 = (FStar_Absyn_Util.kind_formals k1)
in (match (_44_156) with
| (bs, k) -> begin
(
...
| (_44_165, []) -> begin
(let _145_51 = (FStar_Absyn_Syntax.mk_Kind_arrow ((bs), (k)) t.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _145_51 (FStar_Absyn_Util.subst_kind subst)))
end
| ((b)::bs, (a)::args) -> begin
(

let subst = (let _145_52 = (FStar_Absyn_Util.subst_formal b a)
in (_145_52)::subst)
in (aux subst bs args))
end
| _44_177 -> begin
(let _145_58 = (let _145_57 = (FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _145_56 = (FStar_Absyn_Print.kind_to_string k1)
in (let _145_55 = (FStar_Absyn_Print.tag_of_typ t)
in (let _145_54 = (FStar_Absyn_Print.kind_to_string k)
in (let _145_53 = (FStar_All.pipe_right (FStar_List.length args) FStar_Util.string_of_int)
in (FStar_Util.format5 "(%s) HEAD KIND is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _145_57 _145_56 _145_55 _145_54 _145_53))))))
in (failwith _145_58))
end))
in (aux [] bs args))
end)))
...
let _44_183 = (FStar_ST.op_Colon_Equals t.FStar_Absyn_Syntax.tk (Some (k)))
in k))
end)))
...
| FStar_Absyn_Syntax.Exp_delayed (_44_189) -> begin
(let _145_63 = (FStar_Absyn_Util.compress_exp e)
in (recompute_typ _145_63))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
x.FStar_Absyn_Syntax.sort
end
| FStar_Absyn_Syntax.Exp_fvar (f, _44_195) -> begin
...
(let _145_66 = (let _145_65 = (let _145_64 = (recompute_typ body)
in (FStar_Absyn_Syntax.mk_Total _145_64))
in ((bs), (_145_65)))
in (FStar_Absyn_Syntax.mk_Typ_fun _145_66 None e.FStar_Absyn_Syntax.pos))
end
...
| (_44_222, []) -> begin
(let _145_73 = (FStar_Absyn_Syntax.mk_Typ_fun ((bs), (c)) None e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _145_73 (FStar_Absyn_Util.subst_typ subst)))
end
| ((b)::bs, (a)::args) -> begin
(

let subst = (let _145_74 = (FStar_Absyn_Util.subst_formal b a)
in (_145_74)::subst)
in (aux subst bs args))
end
| _44_234 -> begin
...
| FStar_Absyn_Syntax.Exp_match (_44_236) -> begin
(failwith "Expect match nodes to be annotated already")
end
| FStar_Absyn_Syntax.Exp_ascribed (_44_239, t, _44_242) -> begin
t
end
| FStar_Absyn_Syntax.Exp_let (_44_246, e) -> begin
(recompute_typ e)
end
| FStar_Absyn_Syntax.Exp_uvar (_44_251, t) -> begin
t
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _44_257)) -> begin
(recompute_typ e)
end))
...
let _44_265 = (FStar_ST.op_Colon_Equals e.FStar_Absyn_Syntax.tk (Some (t)))
in t))
end)))
