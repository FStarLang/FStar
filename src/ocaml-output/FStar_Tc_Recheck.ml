...
| FStar_Const.Const_bool (_38_5) -> begin
t_bool
end
| FStar_Const.Const_int (_38_8) -> begin
t_int
end
| FStar_Const.Const_int32 (_38_11) -> begin
t_int32
end
| FStar_Const.Const_int64 (_38_14) -> begin
t_int64
end
| FStar_Const.Const_string (_38_17) -> begin
t_string
end
| FStar_Const.Const_float (_38_20) -> begin
t_float
end
| FStar_Const.Const_char (_38_23) -> begin
t_char
end
| FStar_Const.Const_uint8 (_38_26) -> begin
t_uint8
end
| _38_29 -> begin
...
| FStar_Absyn_Syntax.Typ_delayed (_38_34) -> begin
(let _117_30 = (FStar_Absyn_Util.compress_typ t)
in (recompute_kind _117_30))
end
...
(let _117_32 = (let _117_31 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "UNKNOWN KIND FOR %s" _117_31))
in (FStar_All.failwith _117_32))
end
| _38_42 -> begin
...
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (t, _38_72)) -> begin
(recompute_kind t)
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label (t, _38_78, _38_80)) -> begin
(recompute_kind t)
end
| FStar_Absyn_Syntax.Typ_lam (binders, body) -> begin
(let _117_34 = (let _117_33 = (recompute_kind body)
in (binders, _117_33))
in (FStar_Absyn_Syntax.mk_Kind_arrow _117_34 t.FStar_Absyn_Syntax.pos))
end
...
let _38_99 = (FStar_Absyn_Util.kind_formals k1)
in (match (_38_99) with
| (bs, k) -> begin
(
...
| (_38_108, []) -> begin
(let _117_41 = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, k) t.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _117_41 (FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
(
# 85 "FStar.Tc.Recheck.fst"
let subst = (let _117_42 = (FStar_Absyn_Util.subst_formal b a)
in (_117_42)::subst)
in (aux subst bs args))
end
| _38_120 -> begin
(let _117_48 = (let _117_47 = (FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _117_46 = (FStar_Absyn_Print.kind_to_string k1)
in (let _117_45 = (FStar_Absyn_Print.tag_of_typ t)
in (let _117_44 = (FStar_Absyn_Print.kind_to_string k)
in (let _117_43 = (FStar_All.pipe_right (FStar_List.length args) FStar_Util.string_of_int)
in (FStar_Util.format5 "(%s) HEAD KIND is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _117_47 _117_46 _117_45 _117_44 _117_43))))))
in (FStar_All.failwith _117_48))
end))
in (aux [] bs args))
end)))
end)
...
in (
# 95 "FStar.Tc.Recheck.fst"
let _38_126 = (FStar_ST.op_Colon_Equals t.FStar_Absyn_Syntax.tk (Some (k)))
in k))
end)))

# 97 "FStar.Tc.Recheck.fst"
...
| FStar_Absyn_Syntax.Exp_delayed (_38_132) -> begin
(let _117_53 = (FStar_Absyn_Util.compress_exp e)
in (recompute_typ _117_53))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
x.FStar_Absyn_Syntax.sort
end
| FStar_Absyn_Syntax.Exp_fvar (f, _38_138) -> begin
...
(let _117_56 = (let _117_55 = (let _117_54 = (recompute_typ body)
in (FStar_Absyn_Syntax.mk_Total _117_54))
in (bs, _117_55))
in (FStar_Absyn_Syntax.mk_Typ_fun _117_56 None e.FStar_Absyn_Syntax.pos))
end
...
| (_38_165, []) -> begin
(let _117_63 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _117_63 (FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
(
# 113 "FStar.Tc.Recheck.fst"
let subst = (let _117_64 = (FStar_Absyn_Util.subst_formal b a)
in (_117_64)::subst)
in (aux subst bs args))
end
| _38_177 -> begin
...
| FStar_Absyn_Syntax.Exp_match (_38_179) -> begin
(FStar_All.failwith "Expect match nodes to be annotated already")
end
| FStar_Absyn_Syntax.Exp_ascribed (_38_182, t, _38_185) -> begin
t
end
| FStar_Absyn_Syntax.Exp_let (_38_189, e) -> begin
(recompute_typ e)
end
| FStar_Absyn_Syntax.Exp_uvar (_38_194, t) -> begin
t
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _38_200)) -> begin
(recompute_typ e)
end))
...
in (
# 127 "FStar.Tc.Recheck.fst"
let _38_208 = (FStar_ST.op_Colon_Equals e.FStar_Absyn_Syntax.tk (Some (t)))
in t))
end)))
