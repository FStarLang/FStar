...
| None -> begin
(let _20_130 = (let _91_39 = (set_fstar_home ())
...
in (Support.ST.op_Colon_Equals codegen_libs _91_72))), "namespace")), "External runtime library library"))::((Support.Microsoft.FStar.Getopt.noshort, "lax", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_163 ) -> (match (()) with
| () -> begin
...
in ((dlevel x))::_91_90)
in (Support.ST.op_Colon_Equals debug_level _91_91))), "Low|Medium|High|Extreme")), "Control the verbosity of debugging info"))::((Support.Microsoft.FStar.Getopt.noshort, "log_types", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_172 ) -> (match (()) with
| () -> begin
...
in (Support.ST.op_Colon_Equals admit_smt_queries _91_104))), "true|false")), "Admit SMT queries (UNSAFE! But, useful during development); default: \'false\'"))::((Support.Microsoft.FStar.Getopt.noshort, "logQueries", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_177 ) -> (match (()) with
| () -> begin
...
in (x)::_91_121)
in (Support.ST.op_Colon_Equals show_signatures _91_122))), "module name")), "Show the checked signatures for all top-level symbols in the module"))::((Support.Microsoft.FStar.Getopt.noshort, "full_context_dependency", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_183 ) -> (match (()) with
| () -> begin
...
in (Support.ST.op_Colon_Equals max_ifuel _91_148))), "non-negative integer")), "Number of unrolling of inductive datatypes to try at most (default 1)"))::((Support.Microsoft.FStar.Getopt.noshort, "warn_top_level_effects", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_194 ) -> (match (()) with
| () -> begin
...
in (x)::_91_163)
in (Support.ST.op_Colon_Equals verify_module _91_164))), "string")), "Name of the module to verify"))::((Support.Microsoft.FStar.Getopt.noshort, "use_build_config", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_203 ) -> (match (()) with
| () -> begin
...
in (Support.ST.op_Colon_Equals split_cases _91_169))), "t")), "Partition VC of a match into groups of n cases"))::((Support.Microsoft.FStar.Getopt.noshort, "in", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_205 ) -> (match (()) with
| () -> begin
...
in (Support.ST.op_Colon_Equals _include_path _91_175))), "path")), "A directory in which to search for files included on the command line"))::((Support.Microsoft.FStar.Getopt.noshort, "fsi", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _20_207 ) -> (match (()) with
| () -> begin
(set_interactive_fsi ())
...
in (let _20_221 = (let _91_181 = (specs ())
in (display_usage _91_181))
...
in (let _20_227 = (let _91_183 = (specs ())
in (display_usage _91_183))
in (Support.All.exit 1)))
end))
...
let set_options = (fun ( s ) -> (let _91_189 = (specs ())
in (Support.Microsoft.FStar.Getopt.parse_string _91_189 (fun ( _20_233 ) -> ()) s)))
...
| _20_241 -> begin
(let _91_193 = (specs ())
in (Support.Microsoft.FStar.Getopt.parse_cmdline _91_193 (fun ( x ) -> ())))
end))
end))
