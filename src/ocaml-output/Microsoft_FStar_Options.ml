...
let z3_exe = (let _13_2857 = (Support.Microsoft.FStar.Platform.exe "z3")
in ((Support.Microsoft.FStar.Util.mk_ref ()) _13_2857))
...
let debug_level_geq = (fun ( l2  :  debug_level_t ) -> (let _13_2867 = ((Support.Prims.op_Bang ()) debug_level)
in ((Support.Prims.pipe_right ()) _13_2867 ((Support.Microsoft.FStar.Util.for_some ()) (fun ( l1  :  debug_level_t ) -> (one_debug_level_geq l1 l2))))))
...
in (let _11_30 = (let _13_2872 = (Support.Microsoft.FStar.Platform.exe "z3")
in ((Support.ST.op_Colon_Equals ()) z3_exe _13_2872))
...
| None -> begin
(let _11_127 = (let _13_2877 = (set_fstar_home ())
in ((Support.Prims.pipe_left ()) (Support.Prims.ignore ()) _13_2877))
...
| () -> begin
(let _13_2884 = ((Support.Prims.op_Bang ()) _include_path)
in (let _13_2883 = (let _13_2882 = (let _13_2881 = (let _13_2880 = (get_fstar_home ())
in (Support.String.strcat _13_2880 "/lib"))
in (_13_2881)::[])
in (".")::_13_2882)
in ((List.append ()) _13_2884 _13_2883)))
end))
...
let display_usage = (fun ( _13_49  :  unit ) -> (fun ( specs  :  ('u11u1074 * string * Support.Microsoft.FStar.Getopt.opt_variant * string) list ) -> (let _11_141 = (Support.Microsoft.FStar.Util.print_string "fstar [option] infile...")
...
(match ((doc = "")) with
| true -> begin
(let _13_2893 = (Support.Microsoft.FStar.Util.format1 "  --%s\n" flag)
in (Support.Microsoft.FStar.Util.print_string _13_2893))
end
| false -> begin
(let _13_2894 = (Support.Microsoft.FStar.Util.format2 "  --%s  %s\n" flag doc)
in (Support.Microsoft.FStar.Util.print_string _13_2894))
end)
end
| Support.Microsoft.FStar.Getopt.OneArg ((_, argname)) -> begin
(match ((doc = "")) with
| true -> begin
(let _13_2895 = (Support.Microsoft.FStar.Util.format2 "  --%s %s\n" flag argname)
in (Support.Microsoft.FStar.Util.print_string _13_2895))
end
| false -> begin
(let _13_2896 = (Support.Microsoft.FStar.Util.format3 "  --%s %s  %s\n" flag argname doc)
in (Support.Microsoft.FStar.Util.print_string _13_2896))
end)
end)
end)) specs))))
...
end))), "Don\'t print an error message; show an exception trace instead"))::((Support.Microsoft.FStar.Getopt.noshort, "codegen", Support.Microsoft.FStar.Getopt.OneArg (((fun ( s  :  string ) -> (let _11_159 = (let _13_2904 = (parse_codegen s)
in ((Support.ST.op_Colon_Equals ()) codegen _13_2904))
in ((Support.ST.op_Colon_Equals ()) verify false))), "OCaml")), "Generate code for execution"))::((Support.Microsoft.FStar.Getopt.noshort, "codegen-lib", Support.Microsoft.FStar.Getopt.OneArg (((fun ( s  :  string ) -> (let _13_2909 = (let _13_2908 = ((Support.Prims.op_Bang ()) codegen_libs)
in ((Support.Microsoft.FStar.Util.split s "."))::_13_2908)
in ((Support.ST.op_Colon_Equals ()) codegen_libs _13_2909))), "namespace")), "External runtime library library"))::((Support.Microsoft.FStar.Getopt.noshort, "lax", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_162  :  unit ) -> (match (()) with
| () -> begin
...
end))), "Print real names---you may want to use this in conjunction with logQueries"))::((Support.Microsoft.FStar.Getopt.noshort, "debug", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2923 = (let _13_2922 = ((Support.Prims.op_Bang ()) debug)
in (x)::_13_2922)
in ((Support.ST.op_Colon_Equals ()) debug _13_2923))), "module name")), "Print LOTS of debugging information while checking module [arg]"))::((Support.Microsoft.FStar.Getopt.noshort, "debug_level", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2928 = (let _13_2927 = ((Support.Prims.op_Bang ()) debug_level)
in ((dlevel x))::_13_2927)
in ((Support.ST.op_Colon_Equals ()) debug_level _13_2928))), "Low|Medium|High|Extreme")), "Control the verbosity of debugging info"))::((Support.Microsoft.FStar.Getopt.noshort, "log_types", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_171  :  unit ) -> (match (()) with
| () -> begin
...
in ((Support.ST.op_Colon_Equals ()) admit_smt_queries _13_2941))), "true|false")), "Admit SMT queries (UNSAFE! But, useful during development); default: \'false\'"))::((Support.Microsoft.FStar.Getopt.noshort, "logQueries", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_176  :  unit ) -> (match (()) with
| () -> begin
((Support.ST.op_Colon_Equals ()) logQueries true)
end))), "Log the Z3 queries in queries.smt2"))::((Support.Microsoft.FStar.Getopt.noshort, "admit_fsi", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2947 = (let _13_2946 = ((Support.Prims.op_Bang ()) admit_fsi)
in (x)::_13_2946)
in ((Support.ST.op_Colon_Equals ()) admit_fsi _13_2947))), "module name")), "Treat .fsi as a .fst"))::((Support.Microsoft.FStar.Getopt.noshort, "odir", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> ((Support.ST.op_Colon_Equals ()) outputDir (Some (x)))), "dir")), "Place output in directory dir"))::((Support.Microsoft.FStar.Getopt.noshort, "smt", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> ((Support.ST.op_Colon_Equals ()) z3_exe x)), "path")), "Path to the SMT solver (usually Z3, but could be any SMT2-compatible solver)"))::((Support.Microsoft.FStar.Getopt.noshort, "print_before_norm", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_180  :  unit ) -> (match (()) with
| () -> begin
((Support.ST.op_Colon_Equals ()) norm_then_print false)
end))), "Do not normalize types before printing (for debugging)"))::((Support.Microsoft.FStar.Getopt.noshort, "show_signatures", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2959 = (let _13_2958 = ((Support.Prims.op_Bang ()) show_signatures)
in (x)::_13_2958)
in ((Support.ST.op_Colon_Equals ()) show_signatures _13_2959))), "module name")), "Show the checked signatures for all top-level symbols in the module"))::((Support.Microsoft.FStar.Getopt.noshort, "full_context_dependency", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_182  :  unit ) -> (match (()) with
| () -> begin
...
end))), "Serialize compiled modules"))::((Support.Microsoft.FStar.Getopt.noshort, "initial_fuel", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2969 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) initial_fuel _13_2969))), "non-negative integer")), "Number of unrolling of recursive functions to try initially (default 2)"))::((Support.Microsoft.FStar.Getopt.noshort, "max_fuel", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2973 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) max_fuel _13_2973))), "non-negative integer")), "Number of unrolling of recursive functions to try at most (default 8)"))::((Support.Microsoft.FStar.Getopt.noshort, "min_fuel", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2977 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) min_fuel _13_2977))), "non-negative integer")), "Minimum number of unrolling of recursive functions to try (default 1)"))::((Support.Microsoft.FStar.Getopt.noshort, "initial_ifuel", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2981 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) initial_ifuel _13_2981))), "non-negative integer")), "Number of unrolling of inductive datatypes to try at first (default 1)"))::((Support.Microsoft.FStar.Getopt.noshort, "max_ifuel", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2985 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) max_ifuel _13_2985))), "non-negative integer")), "Number of unrolling of inductive datatypes to try at most (default 1)"))::((Support.Microsoft.FStar.Getopt.noshort, "warn_top_level_effects", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_193  :  unit ) -> (match (()) with
| () -> begin
...
end))), "Do not allow the use of t<t1,...,tn> syntax for type applications"))::((Support.Microsoft.FStar.Getopt.noshort, "n_cores", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_2996 = (Support.Microsoft.FStar.Util.int_of_string x)
in ((Support.ST.op_Colon_Equals ()) n_cores _13_2996))), "positive integer")), "Maximum number of cores to use for the solver (default 1)"))::((Support.Microsoft.FStar.Getopt.noshort, "verify_module", Support.Microsoft.FStar.Getopt.OneArg (((fun ( x  :  string ) -> (let _13_3001 = (let _13_3000 = ((Support.Prims.op_Bang ()) verify_module)
in (x)::_13_3000)
in ((Support.ST.op_Colon_Equals ()) verify_module _13_3001))), "string")), "Name of the module to verify"))::((Support.Microsoft.FStar.Getopt.noshort, "use_build_config", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_202  :  unit ) -> (match (()) with
| () -> begin
((Support.ST.op_Colon_Equals ()) use_build_config true)
end))), "Expect just a single file on the command line and no options; will read the \'build-config\' prelude from the file"))::((Support.Microsoft.FStar.Getopt.noshort, "split_cases", Support.Microsoft.FStar.Getopt.OneArg (((fun ( n  :  string ) -> (let _13_3006 = (Support.Microsoft.FStar.Util.int_of_string n)
in ((Support.ST.op_Colon_Equals ()) split_cases _13_3006))), "t")), "Partition VC of a match into groups of n cases"))::((Support.Microsoft.FStar.Getopt.noshort, "in", Support.Microsoft.FStar.Getopt.ZeroArgs ((fun ( _11_204  :  unit ) -> (match (()) with
| () -> begin
((Support.ST.op_Colon_Equals ()) interactive true)
end))), "Interactive mode; reads input from stdin"))::((Support.Microsoft.FStar.Getopt.noshort, "include", Support.Microsoft.FStar.Getopt.OneArg (((fun ( s  :  string ) -> (let _13_3012 = (let _13_3011 = ((Support.Prims.op_Bang ()) _include_path)
in ((List.append ()) _13_3011 ((s)::[])))
in ((Support.ST.op_Colon_Equals ()) _include_path _13_3012))), "path")), "A directory in which to search for files included on the command line"))::[]
...
in (let _11_217 = (let _13_3015 = (specs ())
in ((display_usage ()) _13_3015))
in (exit (1))))
end))

let should_verify = (fun ( m  :  string ) -> (let _13_3019 = ((Support.Prims.op_Bang ()) verify)
in (let _13_3018 = (match (((Support.Prims.op_Bang ()) verify_module)) with
| [] -> begin
true
end
| l -> begin
...
in (_13_3019 && _13_3018))))

let set_options = (fun ( s  :  string ) -> (let _13_3023 = (specs ())
in ((Support.Microsoft.FStar.Getopt.parse_string ()) _13_3023 (fun ( _11_223  :  string ) -> ()) s)))
...
| _ -> begin
(let _13_3027 = (specs ())
in ((Support.Microsoft.FStar.Getopt.parse_cmdline ()) _13_3027 (fun ( x  :  string ) -> ())))
end))
end))
