    ...
    fun ninja  ->
      fun dep_opt  ->
        ...
        let print_entry kind modul source target first_dep all_deps =
          if ninja
          then
            (let uu____7607 = dep_opt_le kind dep_opt  in
             if uu____7607
             then
               (pr "build ";
        ...
        let get_module_from_file_name fst_file =
          let uu____7653 =
            let uu____7657 = FStar_Util.basename fst_file  in
            check_and_strip_suffix uu____7657  in
          FStar_Option.get uu____7653  in
        let output_file ext fst_file =
          let ml_base_name =
            let uu____7678 = get_module_from_file_name fst_file  in
            FStar_Util.replace_chars uu____7678 46 "_"  in
          let uu____7682 = FStar_String.op_Hat ml_base_name ext  in
          FStar_Options.prepend_output_dir uu____7682  in
        let norm_path s = FStar_Util.replace_chars s 92 "/"  in
        let output_ml_file f =
          let uu____7704 = output_file ".ml" f  in norm_path uu____7704  in
        let output_krml_file f =
          let uu____7716 = output_file ".krml" f  in norm_path uu____7716  in
        let output_cmx_file f =
          let uu____7728 = output_file ".cmx" f  in norm_path uu____7728  in
        let cache_file f =
          let uu____7740 = cache_file_name f  in norm_path uu____7740  in
        let uu____7742 =
                ...
                (FStar_List.fold_left
                   (fun all_checked_files  ->
                      fun file_name  ->
                        ...
                        let process_one_key uu____7787 =
                          let dep_node =
                            let uu____7789 =
                              deps_try_find deps.dep_graph file_name  in
                            FStar_All.pipe_right uu____7789 FStar_Option.get
                             in
                          let iface_deps =
                            let uu____7799 = is_interface file_name  in
                            if uu____7799
                            then FStar_Pervasives_Native.None
                              ...
                              (let uu____7810 =
                                 ...
                                 interface_of deps uu____7814  in
                                     ...
                                     let uu____7829 =
                                       let uu____7830 =
                                         deps_try_find deps.dep_graph iface
                                          in
                                       FStar_Option.get uu____7830  in
                                     uu____7829.edges  in
                                   FStar_Pervasives_Native.Some uu____7826)
                             in
                          let iface_deps1 =
                            ...
                            let uu____7924 =
                              let uu____7926 =
                                ...
                                FStar_Options.should_be_already_cached
                                  uu____7928
                                 in
                              Prims.op_Negation uu____7926  in
                            if uu____7924
                            then
                          ...
                          let uu____7939 =
                            let uu____7948 = FStar_Options.cmi ()  in
                            if uu____7948
                            then
                              FStar_Options.profile
                                (fun uu____7969  ->
                                   let uu____7970 = dep_graph_copy dep_graph
                                      in
                                   topological_dependences_of'
                                     deps.file_system_map uu____7970
                              ...
                              let all_checked_fst_dep_files_string =
                                ...
                                then
                                  ...
                                  FStar_String.concat " \\\n\t"
                                    all_checked_fst_dep_files
                                 in
                              ((let uu____8070 = is_implementation file_name
                                   in
                                if uu____8070
                                then
                                  ((let uu____8074 =
                                      ...
                                      ((let uu____8078 =
                                       ...
                                       (let uu____8081 =
                                        ...
                                        print_entry "krml" modul norm_f
                                          uu____8081 cache_file_name1
                                          all_checked_fst_dep_files_string))
                                    else
                                      ((let uu____8087 =
                                          output_ml_file file_name  in
                                        print_entry "ml" modul norm_f
                                          uu____8087 cache_file_name1 "");
                                       (let uu____8091 =
                                          output_krml_file file_name  in
                                        print_entry "krml" modul norm_f
                                          uu____8091 cache_file_name1 "")));
                                   (let cmx_files =
                                    ...
                                    let uu____8133 =
                                      let uu____8135 =
                                        lowercase_module_name file_name  in
                                      FStar_Options.should_extract uu____8135
                                       in
                                    if uu____8133
                                    then
                                      let cmx_files1 =
                                      ...
                                      print_entry "cmx" modul norm_f
                                        uu____8146 uu____8148 cmx_files1
                                    else ()))
                                else
                                  (let uu____8155 =
                                     (let uu____8159 =
                                        let uu____8161 =
                                          lowercase_module_name file_name  in
                                        has_implementation
                                          deps.file_system_map uu____8161
                                         in
                                     ...
                                     (if uu____8164
                                      then
                                        let uu____8168 =
                                          output_krml_file file_name  in
                                        print_entry "krml" modul norm_f
                                          uu____8168 cache_file_name1
                                          all_checked_fst_dep_files_string
                                      else
                                        (let uu____8173 =
                                           output_krml_file file_name  in
                                         print_entry "krml" modul norm_f
                                           uu____8173 cache_file_name1 ""))
                                   else ()));
                               all_checked_files1)
                           in
              ...
              FStar_All.pipe_right all_fst_files
                (FStar_List.iter
                   (fun fst_file  ->
                      ...
                      let uu____8256 = FStar_Options.should_extract mname  in
                      if uu____8256
                      then
                        let uu____8259 = output_ml_file fst_file  in
                        FStar_Util.smap_add ml_file_map mname uu____8259
                      else ()));
            ...
            let all_krml_files =
              ...
              FStar_All.pipe_right keys
                (FStar_List.iter
                   (fun fst_file  ->
                      let mname = lowercase_module_name fst_file  in
                      let uu____8286 = output_krml_file fst_file  in
                      FStar_Util.smap_add krml_file_map mname uu____8286));
...
let (print : deps -> unit) =
  fun deps  ->
    let uu____8350 = FStar_Options.dep ()  in
    match uu____8350 with
    | FStar_Pervasives_Native.Some "make" -> print_make deps
    | FStar_Pervasives_Native.Some "full" ->
        FStar_Options.profile
          (fun uu____8359  -> print_full deps false "all")
          (fun uu____8363  -> "Dependence analysis: printing")
    | FStar_Pervasives_Native.Some "ninja" ->
        let dep_opt = FStar_Options.dep_ninja ()  in
        FStar_Options.profile
          (fun uu____8370  -> print_full deps true dep_opt)
          (fun uu____8373  -> "Dependence analysis: printing")
                 ...
                 let uu____8463 =
                   let uu____8465 =
                     FStar_Util.format3 "%s -> (%s, %s)" k
                      ...
                      in
                   FStar_String.op_Hat "; " uu____8465  in
                 FStar_String.op_Hat s uu____8463) ""
