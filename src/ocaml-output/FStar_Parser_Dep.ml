...
let uu___is_VerifyAll : verify_mode -> Prims.bool =
  fun projectee -> match projectee with VerifyAll -> true | uu____4 -> false
...
type color = White | Gray | Black [@@deriving show]
...
let is_implementation : Prims.string -> Prims.bool =
  fun f ->
    let uu____141 = is_interface f in
    Prims.op_Negation uu____141


let list_of_option:
      'Auu____144. 'Auu____144 FStar_Pervasives_Native.option
      -> 'Auu____144 Prims.list =
  fun uu___53_152 ->
    match uu___53_152 with
...
let list_of_pair:
  ...
  fun uu____172 ->
    match uu____172 with intf, impl ->
...
let module_name_of_file : Prims.string -> Prims.string =
  fun f ->
    let uu____194 =
      ...
      check_and_strip_suffix uu____197
    in
    ...
    | FStar_Pervasives_Native.None ->
        let uu____199 =
          ...
          in
          (FStar_Errors.Fatal_NotValidFStarFile, uu____204)
        in
...
type dependence_graph =
  | Deps of (dependences, color) FStar_Pervasives_Native.tuple2 FStar_Util.smap
  [@@deriving show]
...
let deps_try_find
    : dependence_graph -> Prims.string
      -> (dependences, color) FStar_Pervasives_Native.tuple2
         FStar_Pervasives_Native.option =
  fun uu____364 k ->
    match uu____364 with Deps m -> FStar_Util.smap_try_find m k
...
let deps_add_dep
  ...
  fun uu____393 k v1 ->
    match uu____393 with Deps m -> FStar_Util.smap_add m k v1
...
let resolve_module_name
    : files_for_module_name -> module_name
      -> module_name FStar_Pervasives_Native.option =
  fun file_system_map key ->
    let uu____500 = FStar_Util.smap_try_find file_system_map key in
    match uu____500 with
    | FStar_Pervasives_Native.Some (FStar_Pervasives_Native.Some fn, uu____522) ->
        let uu____537 = lowercase_module_name fn in
        FStar_Pervasives_Native.Some uu____537
    | FStar_Pervasives_Native.Some (uu____538, FStar_Pervasives_Native.Some fn) ->
...
let interface_of
    : files_for_module_name -> module_name
      -> file_name FStar_Pervasives_Native.option =
  fun file_system_map key ->
...
let cache_file_name : Prims.string -> Prims.string =
  fun fn ->
    let uu____703 =
      ...
      if uu____704 then Prims.strcat fn ".checked.lax"
...
let file_of_dep_aux
    : Prims.bool -> files_for_module_name -> file_name Prims.list -> dependence
      -> file_name =
  fun use_checked_file file_system_map all_cmd_line_files d ->
    let cmd_line_has_impl key =
      FStar_All.pipe_right all_cmd_line_files
        (FStar_Util.for_some (fun fn ->
            ...
            let uu____744 =
              let uu____749 =
                FStar_Util.format1
                  ...
                  key
              in
              (FStar_Errors.Fatal_MissingInterface, uu____749)
            in
            FStar_Errors.raise_err uu____744
        | FStar_Pervasives_Native.Some f ->
            if use_checked_file then
            ...
            let uu____764 =
              let uu____769 =
                let uu____770 =
                  ...
                  FStar_Option.get uu____771
                in
                let uu____774 =
                  let uu____775 = interface_of file_system_map key in
                  FStar_Option.get uu____775
                in
                FStar_Util.format2
                  ...
                  uu____770 uu____774
              in
              (FStar_Errors.Fatal_MissingExposeInterfacesOption, uu____769)
            in
            FStar_Errors.raise_err uu____764
        else
          let uu____779 =
            let uu____780 = interface_of file_system_map key in
            FStar_Option.get uu____780
          in
            ...
            let uu____790 =
              let uu____795 =
                FStar_Util.format1
                  ...
                  key
              in
              (FStar_Errors.Fatal_MissingImplementation, uu____795)
            in
            ...
            let uu____804 =
              let uu____809 =
                FStar_Util.format1
                  ...
                  key
              in
              (FStar_Errors.Fatal_MissingImplementation, uu____809)
            in
...
let dependences_of
    : files_for_module_name -> dependence_graph -> file_name Prims.list
      -> file_name -> file_name Prims.list =
  fun file_system_map deps all_cmd_line_files fn ->
    ...
    let uu____964 =
      let uu____965 =
        let uu____966 =
          let uu____967 =
            let uu____970 =
              let uu____973 = deps_keys graph in
              FStar_List.unique uu____973
            in
            FStar_List.collect
              (fun k ->
                let deps =
                  let uu____982 =
                    ...
                    FStar_Util.must uu____987
                  in
                  FStar_Pervasives_Native.fst uu____982
                in
...
let build_inclusion_candidates_list
  ...
  fun uu____1016 ->
    ...
    let include_directories1 =
      FStar_List.map FStar_Util.normalize_file_path include_directories
    in
    let include_directories2 = FStar_List.unique include_directories1 in
    let cwd =
      let uu____1033 = FStar_Util.getcwd () in
      FStar_Util.normalize_file_path uu____1033
    in
    FStar_List.concatMap
      (fun d ->
        if FStar_Util.file_exists d then
          ...
          FStar_List.filter_map
            (fun f ->
              ...
              FStar_All.pipe_right uu____1059
                (FStar_Util.map_option (fun longname ->
                     let full_path =
          ...
          let uu____1080 =
            ...
            in
            (FStar_Errors.Fatal_NotValidIncludeDirectory, uu____1085)
          in
          FStar_Errors.raise_err uu____1080 )
...
let build_map : Prims.string Prims.list -> files_for_module_name =
  fun filenames ->
    ...
    (let uu____1223 = build_inclusion_candidates_list () in
     FStar_List.iter
       (fun uu____1237 ->
         match uu____1237 with longname, full_path ->
           add_entry (FStar_String.lowercase longname) full_path )
       uu____1223) ;
    FStar_List.iter
      (fun f ->
        let uu____1248 = lowercase_module_name f in
        add_entry uu____1248 f )
      filenames ;
    map1


let enter_namespace
    : files_for_module_name -> files_for_module_name -> Prims.string
      -> Prims.bool =
  fun original_map working_map prefix1 ->
    let found = FStar_Util.mk_ref false in
    let prefix2 = Prims.strcat prefix1 "." in
    (let uu____1263 =
       let uu____1266 = FStar_Util.smap_keys original_map in
       FStar_List.unique uu____1266
     in
     FStar_List.iter
       (fun k ->
         if FStar_Util.starts_with k prefix2 then
           let suffix =
             FStar_String.substring k
               (FStar_String.length prefix2)
               (FStar_String.length k - FStar_String.length prefix2)
           in
           let filename =
             let uu____1292 = FStar_Util.smap_try_find original_map k in
             FStar_Util.must uu____1292
           in
...
let string_of_lid : FStar_Ident.lident -> Prims.bool -> Prims.string =
  fun l last1 ->
    let suffix =
      if last1 then [l.FStar_Ident.ident.FStar_Ident.idText] else []
    in
    let names =
      let uu____1426 =
        FStar_List.map (fun x -> x.FStar_Ident.idText) l.FStar_Ident.ns
      in
      FStar_List.append uu____1426 suffix
    in
    FStar_String.concat "." names


let lowercase_join_longident : FStar_Ident.lident -> Prims.bool -> Prims.string =
  fun l last1 ->
      ...
      let uu____1452 =
        let uu____1453 =
          let uu____1454 =
            ...
            check_and_strip_suffix uu____1457
          in
          FStar_Util.must uu____1454
        in
        FStar_String.lowercase uu____1453
      in
      uu____1452 <> k'
    in
    if uu____1451 then
      let uu____1458 =
        let uu____1463 =
          ...
          FStar_Util.format2
            ...
            uu____1464 filename
        in
        (FStar_Errors.Error_ModuleFileNameMismatch, uu____1463)
      in
...
let uu___is_Exit : Prims.exn -> Prims.bool =
  fun projectee -> match projectee with Exit -> true | uu____1469 -> false
...
let hard_coded_dependencies
  ...
  fun full_filename ->
    ...
    in
    if FStar_List.mem filename corelibs then []
    else
      let implicit_deps =
      ...
      let uu____1526 =
        ...
        namespace_of_module uu____1529
      in
...
let collect_one
    : files_for_module_name -> Prims.string
      -> ( dependence Prims.list
         , dependence Prims.list )
         FStar_Pervasives_Native.tuple2 =
  fun original_map filename ->
    ...
    let add_dep deps1 d =
      let uu____1718 =
        let uu____1719 =
          ...
          FStar_List.existsML (fun d' -> d' = d) uu____1720
        in
        Prims.op_Negation uu____1719
      in
      if uu____1718 then
        let uu____1790 =
          let uu____1793 = FStar_ST.op_Bang deps1 in
          d :: uu____1793
        in
    ...
    let add_dependence_edge original_or_working_map lid =
      ...
      | FStar_Pervasives_Native.Some module_name ->
          ...
          (let uu____1993 =
             ...
             uu____1995 = FStar_Pervasives_Native.Some "full"
           in
           if uu____1993 then add_dep mo_roots (UseImplementation module_name)
           else ()) ;
          true
      | uu____2034 -> false
    in
    let record_open_module let_open lid =
      let uu____2044 =
        ...
        || Prims.op_Negation let_open && add_dependence_edge original_map lid
      in
      if uu____2044 then true
      else (
        if let_open then
          let uu____2047 =
            let uu____2052 =
              let uu____2053 = string_of_lid lid true in
              FStar_Util.format1 "Module not found: %s" uu____2053
            in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2052)
          in
          FStar_Errors.log_issue (FStar_Ident.range_of_lid lid) uu____2047
        else () ;
        false )
    in
        ...
        let uu____2061 =
          let uu____2066 =
            ...
            FStar_Util.format1
              ...
              uu____2067
          in
          (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2066)
        in
    ...
    let record_open let_open lid =
      ...
      if uu____2076 then ()
      else if Prims.op_Negation let_open then record_open_namespace lid
      else ()
    in
    let record_open_module_or_namespace uu____2086 =
      match uu____2086 with lid, kind ->
        match kind with
        | Open_namespace -> record_open_namespace lid
        | Open_module ->
            let uu____2093 = record_open_module false lid in
            ()
    in
    let record_module_alias ident lid =
      ...
      | FStar_Pervasives_Native.None ->
          (let uu____2157 =
             ...
             in
             (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2162)
           in
           FStar_Errors.log_issue (FStar_Ident.range_of_lid lid) uu____2157) ;
          false
    in
    let record_lid lid =
      match lid.FStar_Ident.ns with
            ...
            if uu____2173 then
              let uu____2174 =
                let uu____2179 =
                  ...
                  FStar_Util.format1 "Unbound module reference %s" uu____2180
                in
                (FStar_Errors.Warning_UnboundModuleReference, uu____2179)
              in
              FStar_Errors.log_issue (FStar_Ident.range_of_lid lid) uu____2174
            else ()
    in
    let auto_open = hard_coded_dependencies filename in
    FStar_List.iter record_open_module_or_namespace auto_open ;
    let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
    let rec collect_module uu___55_2266 =
      match uu___55_2266 with
      | FStar_Parser_AST.Module (lid, decls) ->
          check_module_declaration_against_filename lid filename ;
          if FStar_List.length lid.FStar_Ident.ns > Prims.parse_int "0" then
            let uu____2275 =
              let uu____2276 = namespace_of_lid lid in
              enter_namespace original_map working_map uu____2276
            in
            ()
          else () ;
          collect_decls decls
      | FStar_Parser_AST.Interface (lid, decls, uu____2280) ->
          ...
          if FStar_List.length lid.FStar_Ident.ns > Prims.parse_int "0" then
            let uu____2287 =
              ...
              enter_namespace original_map working_map uu____2288
            in
            ()
          else () ;
          collect_decls decls
    and collect_decls decls =
      FStar_List.iter
        ...
        decls
    and collect_decl uu___56_2297 =
      match uu___56_2297 with
      ...
      | FStar_Parser_AST.TopLevelLet (uu____2339, patterms) ->
          FStar_List.iter
            (fun uu____2361 ->
              match uu____2361 with pat, t ->
                collect_pattern pat ; collect_term t )
            patterms
      ...
      | FStar_Parser_AST.SubEffect
          ...
          ; FStar_Parser_AST.lift_op= FStar_Parser_AST.ReifiableLift (t0, t1); _
          } ->
            ...
            let uu____2515 =
              let uu____2520 =
                ...
                FStar_Util.format1
                  ...
                  uu____2521
              in
              (FStar_Errors.Fatal_OneModulePerFile, uu____2520)
            in
            FStar_Errors.raise_error uu____2515 (FStar_Ident.range_of_lid lid)
          else ()
    and collect_tycon uu___57_2523 =
      match uu___57_2523 with
      ...
      | FStar_Parser_AST.TyconRecord (uu____2550, binders, k, identterms) ->
          ...
          FStar_List.iter
            (fun uu____2596 ->
              match uu____2596 with uu____2605, t, uu____2607 -> collect_term t
              )
            identterms
      | FStar_Parser_AST.TyconVariant (uu____2612, binders, k, identterms) ->
          ...
          FStar_List.iter
            (fun uu____2671 ->
              match uu____2671 with uu____2684, t, uu____2686, uu____2687 ->
                FStar_Util.iter_opt t collect_term )
            identterms
    and collect_effect_decl uu___58_2696 =
      match uu___58_2696 with
    ...
    and collect_binder uu___59_2722 =
      match uu___59_2722 with
      | { FStar_Parser_AST.b= FStar_Parser_AST.Annotated (uu____2723, t)
        ...
        ; FStar_Parser_AST.aqual= uu____2727; _ } ->
          collect_term t
      | { FStar_Parser_AST.b= FStar_Parser_AST.TAnnotated (uu____2728, t)
        ...
        ; FStar_Parser_AST.aqual= uu____2732; _ } ->
          collect_term t
      | { FStar_Parser_AST.b= FStar_Parser_AST.NoName t
        ; FStar_Parser_AST.brange= uu____2734
        ; FStar_Parser_AST.blevel= uu____2735
        ; FStar_Parser_AST.aqual= uu____2736; _ } ->
          collect_term t
      | uu____2737 -> ()
    and collect_term t = collect_term' t.FStar_Parser_AST.tm
    and collect_constant uu___60_2739 =
      match uu___60_2739 with
      ...
      | uu____2858 -> ()
    and collect_term' uu___61_2859 =
      match uu___61_2859 with
      | FStar_Parser_AST.Wild -> ()
      | FStar_Parser_AST.Const c -> collect_constant c
      | FStar_Parser_AST.Op (s, ts) ->
          if FStar_Ident.text_of_id s = "@" then
            let uu____2868 =
              let uu____2869 =
                FStar_Ident.lid_of_path
                  ...
                  FStar_Range.dummyRange
              in
              FStar_Parser_AST.Name uu____2869
            in
      ...
      | FStar_Parser_AST.Construct (lid, termimps) ->
          if FStar_List.length termimps = Prims.parse_int "1" then
            record_lid lid
          else () ;
          FStar_List.iter
            (fun uu____2905 ->
      ...
      | FStar_Parser_AST.Let (uu____2923, patterms, t) ->
          FStar_List.iter
            (fun uu____2973 ->
              match uu____2973 with attrs_opt, (pat, t1) ->
                (let uu____3002 =
                   FStar_Util.map_opt attrs_opt (FStar_List.iter collect_term)
                 in
                 ()) ;
                collect_pattern pat ; collect_term t1 )
            patterms ;
          collect_term t
      | FStar_Parser_AST.LetOpen (lid, t) ->
          record_open true lid ; collect_term t
      | FStar_Parser_AST.Bind (uu____3013, t1, t2) ->
          collect_term t1 ; collect_term t2
      | FStar_Parser_AST.Seq (t1, t2) -> collect_term t1 ; collect_term t2
      | FStar_Parser_AST.If (t1, t2, t3) ->
          collect_term t1 ; collect_term t2 ; collect_term t3
      | FStar_Parser_AST.Match (t, bs) -> collect_term t ; collect_branches bs
      ...
      | FStar_Parser_AST.Record (t, idterms) ->
          ...
          FStar_List.iter
            (fun uu____3109 ->
              match uu____3109 with uu____3114, t1 -> collect_term t1 )
            idterms
      | FStar_Parser_AST.Project (t, uu____3117) -> collect_term t
      ...
      | FStar_Parser_AST.NamedTyp (uu____3173, t) -> collect_term t
      | FStar_Parser_AST.Paren t -> collect_term t
      | FStar_Parser_AST.Assign (uu____3176, t) -> collect_term t
      | FStar_Parser_AST.Requires (t, uu____3179) -> collect_term t
      | FStar_Parser_AST.Ensures (t, uu____3185) -> collect_term t
      | FStar_Parser_AST.Labeled (t, uu____3191, uu____3192) -> collect_term t
      | FStar_Parser_AST.Attributes cattributes ->
          FStar_List.iter collect_term cattributes
    and collect_patterns ps = FStar_List.iter collect_pattern ps
    and collect_pattern p = collect_pattern' p.FStar_Parser_AST.pat
    and collect_pattern' uu___62_3200 =
      match uu___62_3200 with
      | FStar_Parser_AST.PatWild -> ()
      | FStar_Parser_AST.PatOp uu____3201 -> ()
      | FStar_Parser_AST.PatConst uu____3202 -> ()
      | FStar_Parser_AST.PatApp (p, ps) ->
          collect_pattern p ; collect_patterns ps
      | FStar_Parser_AST.PatVar uu____3210 -> ()
      | FStar_Parser_AST.PatName uu____3217 -> ()
      | FStar_Parser_AST.PatTvar uu____3218 -> ()
      | FStar_Parser_AST.PatList ps -> collect_patterns ps
      | FStar_Parser_AST.PatOr ps -> collect_patterns ps
      | FStar_Parser_AST.PatTuple (ps, uu____3232) -> collect_patterns ps
      | FStar_Parser_AST.PatRecord lidpats ->
          FStar_List.iter
            (fun uu____3251 ->
              match uu____3251 with uu____3256, p -> collect_pattern p )
            lidpats
      | FStar_Parser_AST.PatAscribed (p, t) ->
          collect_pattern p ; collect_term t
    and collect_branches bs = FStar_List.iter collect_branch bs
    and collect_branch uu____3280 =
      match uu____3280 with pat, t1, t2 ->
        collect_pattern pat ;
        FStar_Util.iter_opt t1 collect_term ;
        collect_term t2
    in
    let uu____3298 = FStar_Parser_Driver.parse_file filename in
    match uu____3298 with ast, uu____3318 ->
      let mname = lowercase_module_name filename in
      (let uu____3333 =
         (is_interface filename && has_implementation original_map mname)
         &&
         let uu____3335 = FStar_Options.dep () in
         uu____3335 = FStar_Pervasives_Native.Some "full"
       in
       if uu____3333 then add_dep mo_roots (UseImplementation mname) else ()) ;
      collect_module ast ;
      let uu____3375 = FStar_ST.op_Bang deps in
      let uu____3423 = FStar_ST.op_Bang mo_roots in
      (uu____3375, uu____3423)
...
let collect
  ...
  fun all_cmd_line_files ->
    let all_cmd_line_files1 =
      FStar_All.pipe_right all_cmd_line_files
        (FStar_List.map (fun fn ->
             let uu____3505 = FStar_Options.find_file fn in
             ...
             | FStar_Pervasives_Native.None ->
                 let uu____3508 =
                   ...
                   in
                   (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____3513)
                 in
                 FStar_Errors.raise_err uu____3508
    ...
    let rec discover_one file_name =
      let uu____3521 =
        let uu____3522 = deps_try_find dep_graph file_name in
        uu____3522 = FStar_Pervasives_Native.None
      in
      if uu____3521 then
        let uu____3539 = collect_one file_system_map file_name in
        match uu____3539 with deps, mo_roots ->
          let deps1 =
            ...
            in
            if uu____3562 then FStar_List.append deps [UseInterface module_name]
            else deps
          in
          (let uu____3567 =
             let uu____3572 = FStar_List.unique deps1 in
             (uu____3572, White)
           in
           deps_add_dep dep_graph file_name uu____3567) ;
          let uu____3577 =
            FStar_List.map
              (file_of_dep file_system_map all_cmd_line_files1)
              (FStar_List.append deps1 mo_roots)
          in
          FStar_List.iter discover_one uu____3577
      else ()
    in
    ...
    let topological_dependences_of all_command_line_files =
      ...
      let rec aux cycle filename =
        let uu____3610 =
          let uu____3615 = deps_try_find dep_graph filename in
          FStar_Util.must uu____3615
        in
        match uu____3610 with direct_deps, color ->
          match color with
          | Gray ->
              (let uu____3629 =
                 let uu____3634 =
                   FStar_Util.format1 "Recursive dependency on module %s\n"
                     filename
                 in
                 (FStar_Errors.Warning_RecursiveDependency, uu____3634)
               in
               FStar_Errors.log_issue FStar_Range.dummyRange uu____3629) ;
              FStar_Util.print1
          ...
          | White ->
              ...
              (let uu____3640 =
               ...
               in
               FStar_List.iter (fun k -> aux (k :: cycle) k) uu____3640) ;
              deps_add_dep dep_graph filename (direct_deps, Black) ;
              let uu____3646 =
                let uu____3649 = FStar_ST.op_Bang topologically_sorted in
                filename :: uu____3649
              in
              FStar_ST.op_Colon_Equals topologically_sorted uu____3646
      in
    ...
    let uu____3795 = topological_dependences_of all_cmd_line_files1 in
    (uu____3795, Mk (dep_graph, file_system_map, all_cmd_line_files1))


let deps_of : deps -> Prims.string -> Prims.string Prims.list =
  fun uu____3808 f ->
    match uu____3808 with Mk (deps, file_system_map, all_cmd_line_files) ->
...
let hash_dependences
    : deps -> Prims.string
      -> (Prims.string, Prims.string) FStar_Pervasives_Native.tuple2 Prims.list
         FStar_Pervasives_Native.option =
  fun uu____3833 fn ->
    match uu____3833 with Mk (deps, file_system_map, all_cmd_line_files) ->
      let fn1 =
        let uu____3851 = FStar_Options.find_file fn in
      ...
      let interface_hash =
        let uu____3875 =
          is_implementation fn1 && has_interface file_system_map module_name
        in
        if uu____3875 then
          let uu____3882 =
            let uu____3887 =
              let uu____3888 =
                let uu____3889 = interface_of file_system_map module_name in
                FStar_Option.get uu____3889
              in
              digest_of_file1 uu____3888
            in
            ("interface", uu____3887)
          in
          [uu____3882]
        else []
      in
      let binary_deps =
        let uu____3908 =
          dependences_of file_system_map deps all_cmd_line_files fn1
        in
        FStar_All.pipe_right uu____3908
          (FStar_List.filter (fun fn2 ->
               let uu____3918 =
                 is_interface fn2
                 &&
                 let uu____3920 = lowercase_module_name fn2 in
                 uu____3920 = module_name
               in
      ...
      let binary_deps1 =
        FStar_List.sortWith
          (fun fn11 fn2 ->
            let uu____3930 = lowercase_module_name fn11 in
            let uu____3931 = lowercase_module_name fn2 in
            FStar_String.compare uu____3930 uu____3931 )
          binary_deps
      in
      let rec hash_deps out uu___63_3954 =
        match uu___63_3954 with
        | [] ->
            FStar_Pervasives_Native.Some
        ...
        | fn2 :: deps1 ->
            ...
            if FStar_Util.file_exists cache_fn then
              let uu____3998 =
                let uu____4005 =
                  let uu____4010 = lowercase_module_name fn2 in
                  let uu____4011 = digest_of_file1 cache_fn in
                  (uu____4010, uu____4011)
                in
                uu____4005 :: out
              in
              hash_deps uu____3998 deps1
            else (
              (let uu____4018 = FStar_Options.debug_any () in
               if uu____4018 then
  ...
  fun dig ->
    let uu____4045 =
      FStar_All.pipe_right dig
        (FStar_List.map (fun uu____4064 ->
             match uu____4064 with m, d ->
               let uu____4071 = FStar_Util.base64_encode d in
               FStar_Util.format2 "%s:%s" m uu____4071 ))
    in
    FStar_All.pipe_right uu____4045 (FStar_String.concat "\n")


let print_make : deps -> Prims.unit =
  fun uu____4076 ->
    match uu____4076 with Mk (deps, file_system_map, all_cmd_line_files) ->
      let keys = deps_keys deps in
      FStar_All.pipe_right keys
        (FStar_List.iter (fun f ->
             let uu____4096 =
               let uu____4101 = deps_try_find deps f in
               FStar_All.pipe_right uu____4101 FStar_Option.get
             in
             match uu____4096 with f_deps, uu____4123 ->
               let files =
                 FStar_List.map
...
let print_full : deps -> Prims.unit =
  fun uu____4135 ->
    match uu____4135 with Mk (deps, file_system_map, all_cmd_line_files) ->
      let sort_output_files orig_output_file_map =
        let order = FStar_Util.mk_ref [] in
        let remaining_output_files =
          FStar_Util.smap_copy orig_output_file_map
        in
        let visited_other_modules =
          FStar_Util.smap_create (Prims.parse_int "41")
        in
        let should_visit lc_module_name =
          (let uu____4172 =
             FStar_Util.smap_try_find remaining_output_files lc_module_name
           in
           FStar_Option.isSome uu____4172)
          ||
          let uu____4176 =
            FStar_Util.smap_try_find visited_other_modules lc_module_name
          in
          FStar_Option.isNone uu____4176
        in
        ...
        let emit_output_file_opt ml_file_opt =
          ...
          | FStar_Pervasives_Native.Some ml_file ->
              let uu____4199 =
                let uu____4202 = FStar_ST.op_Bang order in
                ml_file :: uu____4202
              in
              FStar_ST.op_Colon_Equals order uu____4199
        in
        let rec aux uu___64_4300 =
          match uu___64_4300 with
          | [] -> ()
          | lc_module_name :: modules_to_extract ->
              let visit_file file_opt =
                ...
                | FStar_Pervasives_Native.Some file_name ->
                    let uu____4316 = deps_try_find deps file_name in
                    ...
                    | FStar_Pervasives_Native.None ->
                        ...
                        in
                        failwith uu____4327
                    | FStar_Pervasives_Native.Some (immediate_deps, uu____4329) ->
                        let immediate_deps1 =
                          FStar_List.map
                            (fun x ->
                        ...
                        aux immediate_deps1
              in
              (let uu____4340 = should_visit lc_module_name in
               if uu____4340 then
                 let ml_file_opt = mark_visiting lc_module_name in
                 (let uu____4345 =
                    implementation_of file_system_map lc_module_name
                  in
                  visit_file uu____4345) ;
                 (let uu____4349 =
                    interface_of file_system_map lc_module_name
                  in
                  visit_file uu____4349) ;
                 emit_output_file_opt ml_file_opt
               else ()) ;
              aux modules_to_extract
        in
        let all_extracted_modules =
          FStar_Util.smap_keys orig_output_file_map
        in
        aux all_extracted_modules ;
        let uu____4357 = FStar_ST.op_Bang order in
        FStar_List.rev uu____4357
      in
      let keys = deps_keys deps in
      let output_file ext fst_file =
        let ml_base_name =
          let uu____4416 =
            let uu____4417 =
              let uu____4420 = FStar_Util.basename fst_file in
              check_and_strip_suffix uu____4420
            in
            FStar_Option.get uu____4417
          in
          FStar_Util.replace_chars uu____4416 46 "_"
        in
        FStar_Options.prepend_output_dir (Prims.strcat ml_base_name ext)
      in
      let norm_path s = FStar_Util.replace_chars s 92 "/" in
      let output_ml_file f =
        let uu____4431 = output_file ".ml" f in
        norm_path uu____4431
      in
      let output_krml_file f =
        let uu____4436 = output_file ".krml" f in
        norm_path uu____4436
      in
      let output_cmx_file f =
        let uu____4441 = output_file ".cmx" f in
        norm_path uu____4441
      in
      let cache_file f =
        let uu____4446 = cache_file_name f in
        norm_path uu____4446
      in
      FStar_All.pipe_right keys
        (FStar_List.iter (fun f ->
             let uu____4468 =
               let uu____4473 = deps_try_find deps f in
               FStar_All.pipe_right uu____4473 FStar_Option.get
             in
             match uu____4468 with f_deps, uu____4495 ->
               let norm_f = norm_path f in
               let files =
                 FStar_List.map
                   (file_of_dep_aux true file_system_map all_cmd_line_files)
                   f_deps
               in
               ...
               (let uu____4511 = is_interface f in
                if uu____4511 then
                  let uu____4512 =
                    let uu____4513 = FStar_Options.prepend_cache_dir norm_f in
                    norm_path uu____4513
                  in
                  FStar_Util.print3 "%s.source: %s \\\n\t%s\n\ttouch $@\n\n"
                    uu____4512 norm_f files3
                else ()) ;
               (let uu____4516 = cache_file f in
                FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____4516 norm_f
                  files3) ;
               let uu____4517 = is_implementation f in
               if uu____4517 then (
                 (let uu____4519 = output_ml_file f in
                  let uu____4520 = cache_file f in
                 ...
                 let cmx_files =
                   ...
                   let extracted_fst_files =
                     FStar_All.pipe_right fst_files
                       (FStar_List.filter (fun df ->
                            (let uu____4542 = lowercase_module_name df in
                             let uu____4543 = lowercase_module_name f in
                             uu____4542 <> uu____4543)
                            &&
                            let uu____4545 = lowercase_module_name df in
                            FStar_Options.should_extract uu____4545 ))
                   in
                   FStar_All.pipe_right extracted_fst_files
                     (FStar_List.map output_cmx_file)
                 in
                 (let uu____4551 =
                    let uu____4552 = lowercase_module_name f in
                    FStar_Options.should_extract uu____4552
                  in
                  if uu____4551 then
                    let uu____4553 = output_cmx_file f in
                    let uu____4554 = output_ml_file f in
                    FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____4553
                      uu____4554
                      (FStar_String.concat "\\\n\t" cmx_files)
                  else ()) ;
                 let uu____4556 = output_krml_file f in
                 let uu____4557 = cache_file f in
                 FStar_Util.print2 "%s: %s\n\n" uu____4556 uu____4557 )
               else
                 let uu____4559 =
                   (let uu____4562 =
                      let uu____4563 = lowercase_module_name f in
                      has_implementation file_system_map uu____4563
                    in
                    Prims.op_Negation uu____4562)
                   && is_interface f
                 in
                 if uu____4559 then
                   let uu____4564 = output_krml_file f in
                   let uu____4565 = cache_file f in
                   FStar_Util.print2 "%s: %s\n\n" uu____4564 uu____4565
                 else () )) ;
      let all_fst_files =
        let uu____4570 =
      ...
      let all_ml_files =
        ...
        FStar_All.pipe_right all_fst_files
          (FStar_List.iter (fun fst_file ->
               let mname = lowercase_module_name fst_file in
               let uu____4596 = FStar_Options.should_extract mname in
               if uu____4596 then
                 let uu____4597 = output_ml_file fst_file in
                 FStar_Util.smap_add ml_file_map mname uu____4597
               else () )) ;
      ...
      let all_krml_files =
        ...
        FStar_All.pipe_right keys
          (FStar_List.iter (fun fst_file ->
               let mname = lowercase_module_name fst_file in
               let uu____4613 = output_krml_file fst_file in
               FStar_Util.smap_add krml_file_map mname uu____4613 )) ;
      ...
      (let uu____4615 =
         ...
         in
         FStar_All.pipe_right uu____4616 (FStar_String.concat " \\\n\t")
       in
      ...
      (let uu____4626 =
         ...
         in
         FStar_All.pipe_right uu____4627 (FStar_String.concat " \\\n\t")
       in
      ...
      let uu____4636 =
        ...
        in
        FStar_All.pipe_right uu____4637 (FStar_String.concat " \\\n\t")
      in
