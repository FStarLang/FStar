  ...
  fun original_map  ->
    fun working_map  ->
      fun prefix  ->
        ...
        (let _0_289 = FStar_List.unique (FStar_Util.smap_keys original_map)
            in
         FStar_List.iter
           (fun k  ->
              ...
              let uu____362 =
                Prims.op_Negation
                  (let _0_294 = FStar_ST.read deps  in
                   FStar_List.existsb (fun d'  -> d' = d) _0_294)
                 in
              if uu____362
              then
                let _0_296 = let _0_295 = FStar_ST.read deps  in d :: _0_295
                   in
                  ...
                  then
                    (if let_open
                     then
                       ...
                       (let _0_298 =
                          let _0_297 = string_of_lid lid true  in [_0_297]
                           in
                        FStar_Util.fprint FStar_Util.stderr
  ...
  fun verify_mode  ->
    fun filenames  ->
      ...
      let rec discover_one is_user_provided_filename interface_only key =
        let uu____1180 =
          let _0_312 = FStar_Util.smap_try_find graph key  in _0_312 = None
           in
        if uu____1180
        then
                        ...
                        (FStar_List.flatten
                           (FStar_List.map
                              (fun dep  ->
                                 ...
                                 dep :: _0_313) direct_deps))
                       in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let _0_315 =
                       let _0_314 = FStar_ST.read topologically_sorted  in
                       key :: _0_314  in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) _0_320
          in
