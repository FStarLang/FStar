...
let list_of_option :
  ...
  =
  fun uu___58_177 ->
    match uu___58_177 with
    | FStar_Pervasives_Native.Some x -> [x]
    | FStar_Pervasives_Native.None -> []
let list_of_pair :
  'Auu____185 .
    ('Auu____185 FStar_Pervasives_Native.option,
      'Auu____185 FStar_Pervasives_Native.option)
...
let (lowercase_module_name : Prims.string -> Prims.string) =
  fun f ->
    let uu____240 = module_name_of_file f in FStar_String.lowercase uu____240
              ...
              let uu____856 =
                (cmd_line_has_impl key) &&
                  (let uu____858 = FStar_Options.dep () in
                   FStar_Option.isNone uu____858) in
              if uu____856
              then
                ...
                (if uu____861
                 then
                   let uu____862 =
                     let uu____863 = implementation_of file_system_map key in
                   ...
                   let uu____891 =
                     let uu____896 =
                       FStar_Util.format1
                         ...
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____896) in
                   ...
                   let uu____903 =
                     let uu____908 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____908) in
           ...
           let uu____1092 =
             ...
             FStar_List.collect
               (fun k ->
                  ...
                  FStar_List.map print7 deps) uu____1095 in
           FStar_String.concat "\n" uu____1092 in
         ...
         FStar_List.iter
           (fun k ->
              ...
              then
                ...
                let filename =
                  let uu____1435 = FStar_Util.smap_try_find original_map k in
  ...
  fun l ->
    fun last1 ->
      ...
      let names =
        ...
        FStar_List.append uu____1689 suffix in
      FStar_String.concat "." names
let (lowercase_join_longident :
  FStar_Ident.lident -> Prims.bool -> Prims.string) =
  fun l ->
    fun last1 ->
      let uu____1704 = string_of_lid l last1 in
      FStar_String.lowercase uu____1704
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____1710 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
    FStar_String.concat "_" uu____1710
    ...
    fun filename ->
      ...
      let uu____1724 =
        let uu____1725 =
          let uu____1726 =
            let uu____1727 =
              let uu____1730 = FStar_Util.basename filename in
              check_and_strip_suffix uu____1730 in
            FStar_Util.must uu____1727 in
          FStar_String.lowercase uu____1726 in
        uu____1725 <> k' in
      if uu____1724
      then
        let uu____1731 = FStar_Ident.range_of_lid lid in
        let uu____1732 =
          let uu____1737 =
            let uu____1738 = string_of_lid lid true in
            FStar_Util.format2
              "The module declaration \"module %s\" found in file %s does not match its filename. Dependencies will be incorrect and the module will not be verified.\n"
              uu____1738 filename in
          (FStar_Errors.Error_ModuleFileNameMismatch, uu____1737) in
        FStar_Errors.log_issue uu____1731 uu____1732
      else ()
exception Exit 
let (uu___is_Exit : Prims.exn -> Prims.bool) =
  fun projectee -> match projectee with | Exit -> true | uu____1745 -> false
let (hard_coded_dependencies :
  ...
  fun full_filename ->
    ...
    let corelibs =
      let uu____1761 = FStar_Options.prims_basename () in
      let uu____1762 =
        let uu____1765 = FStar_Options.pervasives_basename () in
        let uu____1766 =
          let uu____1769 = FStar_Options.pervasives_native_basename () in
          [uu____1769] in
    ...
    then []
      ...
      (let implicit_deps =
       ...
       let uu____1804 =
         let uu____1807 = lowercase_module_name full_filename in
         namespace_of_module uu____1807 in
  ...
  fun original_map ->
    fun filename ->
      ...
      let add_dep deps1 d =
        let uu____2093 =
          let uu____2094 =
            let uu____2095 = FStar_ST.op_Bang deps1 in
            FStar_List.existsML (fun d' -> d' = d) uu____2095 in
          Prims.op_Negation uu____2094 in
        if uu____2093
        then
          let uu____2199 =
            let uu____2202 = FStar_ST.op_Bang deps1 in d :: uu____2202 in
          FStar_ST.op_Colon_Equals deps1 uu____2199
        else () in
      let working_map = FStar_Util.smap_copy original_map in
      let add_dependence_edge original_or_working_map lid =
        let key = lowercase_join_longident lid true in
        let uu____2435 = resolve_module_name original_or_working_map key in
            ...
            (add_dep deps (PreferInterface module_name);
             (let uu____2546 =
                ((has_interface original_or_working_map module_name) &&
                  ...
                  &&
                  (let uu____2548 = FStar_Options.dep () in
                   uu____2548 = (FStar_Pervasives_Native.Some "full")) in
              if uu____2546
      ...
      let record_open_module let_open lid =
        ...
        then true
          ...
          (if let_open
           then
             (let uu____2676 = FStar_Ident.range_of_lid lid in
              let uu____2677 =
                let uu____2682 =
                  let uu____2683 = string_of_lid lid true in
                  FStar_Util.format1 "Module not found: %s" uu____2683 in
                (FStar_Errors.Warning_ModuleOrFileNotFoundWarning,
                  uu____2682) in
              FStar_Errors.log_issue uu____2676 uu____2677)
           else ();
           false) in
      let record_open_namespace lid =
        ...
        then
          let uu____2693 = FStar_Ident.range_of_lid lid in
          let uu____2694 =
            let uu____2699 =
              let uu____2700 = string_of_lid lid true in
              FStar_Util.format1
                "No modules in namespace %s and no file with that name either"
                uu____2700 in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2699) in
          FStar_Errors.log_issue uu____2693 uu____2694
        else () in
      let record_open let_open lid =
        let uu____2713 = record_open_module let_open lid in
        if uu____2713
        then ()
        else
      ...
      let record_open_module_or_namespace uu____2725 =
        match uu____2725 with
        | (lid, kind) ->
            (match kind with
             | Open_namespace -> record_open_namespace lid
             | Open_module ->
                 let uu____2732 = record_open_module false lid in ()) in
      let record_module_alias ident lid =
        let key =
          let uu____2745 = FStar_Ident.text_of_id ident in
          FStar_String.lowercase uu____2745 in
        let alias = lowercase_join_longident lid true in
        let uu____2747 = FStar_Util.smap_try_find original_map alias in
        match uu____2747 with
        | FStar_Pervasives_Native.Some deps_of_aliased_module ->
            (FStar_Util.smap_add working_map key deps_of_aliased_module; true)
        | FStar_Pervasives_Native.None ->
            ((let uu____2801 = FStar_Ident.range_of_lid lid in
              let uu____2802 =
                let uu____2807 =
                ...
                (FStar_Errors.Warning_ModuleOrFileNotFoundWarning,
                  uu____2807) in
              FStar_Errors.log_issue uu____2801 uu____2802);
             false) in
      let record_lid lid =
        match lid.FStar_Ident.ns with
        | [] -> ()
        | uu____2814 ->
            ...
            let uu____2818 = add_dependence_edge working_map module_name in
            if uu____2818
            then ()
            else
              (let uu____2820 = FStar_Options.debug_any () in
               if uu____2820
               then
                 let uu____2821 = FStar_Ident.range_of_lid lid in
                 let uu____2822 =
                   let uu____2827 =
                     let uu____2828 = FStar_Ident.string_of_lid module_name in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2828 in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2827) in
                 FStar_Errors.log_issue uu____2821 uu____2822
               else ()) in
      let auto_open = hard_coded_dependencies filename in
      FStar_List.iter record_open_module_or_namespace auto_open;
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
       let rec collect_module uu___60_2944 =
         match uu___60_2944 with
         | FStar_Parser_AST.Module (lid, decls) ->
             (check_module_declaration_against_filename lid filename;
              ...
              then
                (let uu____2953 =
                   let uu____2954 = namespace_of_lid lid in
                   enter_namespace original_map working_map uu____2954 in
                 ())
              else ();
              collect_decls decls)
         | FStar_Parser_AST.Interface (lid, decls, uu____2958) ->
             (check_module_declaration_against_filename lid filename;
              if
                (FStar_List.length lid.FStar_Ident.ns) >
                  (Prims.parse_int "0")
              then
                (let uu____2965 =
                   let uu____2966 = namespace_of_lid lid in
                   enter_namespace original_map working_map uu____2966 in
                 ())
              else ();
              collect_decls decls)
       ...
       and collect_decl uu___61_2975 =
         match uu___61_2975 with
         | FStar_Parser_AST.Include lid -> record_open false lid
         | FStar_Parser_AST.Open lid -> record_open false lid
         | FStar_Parser_AST.ModuleAbbrev (ident, lid) ->
             let uu____2980 = record_module_alias ident lid in
             if uu____2980
             then
               let uu____2981 =
                 let uu____2982 = lowercase_join_longident lid true in
                 PreferInterface uu____2982 in
               add_dep deps uu____2981
             else ()
         | FStar_Parser_AST.TopLevelLet (uu____3089, patterms) ->
             FStar_List.iter
               (fun uu____3111 ->
         ...
         | FStar_Parser_AST.Splice (uu____3120, t) -> collect_term t
         | FStar_Parser_AST.Assume (uu____3126, t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____3128;
               FStar_Parser_AST.mdest = uu____3129;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.NonReifiableLift t;_}
             -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____3131;
               FStar_Parser_AST.mdest = uu____3132;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.LiftForFree t;_}
             -> collect_term t
         | FStar_Parser_AST.Val (uu____3134, t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____3136;
               FStar_Parser_AST.mdest = uu____3137;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.ReifiableLift
                 (t0, t1);_}
             -> (collect_term t0; collect_term t1)
         | FStar_Parser_AST.Tycon (uu____3141, ts) ->
             let ts1 =
               FStar_List.map
                 (fun uu____3171 -> match uu____3171 with | (x, docnik) -> x)
                 ts in
             FStar_List.iter collect_tycon ts1
         | FStar_Parser_AST.Exception (uu____3184, t) ->
             FStar_Util.iter_opt t collect_term
         | FStar_Parser_AST.NewEffect ed -> collect_effect_decl ed
         | FStar_Parser_AST.Fsdoc uu____3191 -> ()
         | FStar_Parser_AST.Pragma uu____3192 -> ()
         | FStar_Parser_AST.TopLevelModule lid ->
             (FStar_Util.incr num_of_toplevelmods;
              (let uu____3300 =
                 let uu____3301 = FStar_ST.op_Bang num_of_toplevelmods in
                 uu____3301 > (Prims.parse_int "1") in
               if uu____3300
               then
                 let uu____3401 =
                   let uu____3406 =
                     let uu____3407 = string_of_lid lid true in
                     FStar_Util.format1
                       "Automatic dependency analysis demands one module per file (module %s not supported)"
                       uu____3407 in
                   (FStar_Errors.Fatal_OneModulePerFile, uu____3406) in
                 let uu____3408 = FStar_Ident.range_of_lid lid in
                 FStar_Errors.raise_error uu____3401 uu____3408
               else ()))
       and collect_tycon uu___62_3410 =
         match uu___62_3410 with
         | FStar_Parser_AST.TyconAbstract (uu____3411, binders, k) ->
             (collect_binders binders; FStar_Util.iter_opt k collect_term)
         | FStar_Parser_AST.TyconAbbrev (uu____3423, binders, k, t) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              collect_term t)
         | FStar_Parser_AST.TyconRecord (uu____3437, binders, k, identterms)
             ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____3483 ->
                   ...
                   | (uu____3492, t, uu____3494) -> collect_term t)
                identterms)
         | FStar_Parser_AST.TyconVariant (uu____3499, binders, k, identterms)
             ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____3558 ->
                   ...
                   | (uu____3571, t, uu____3573, uu____3574) ->
                       FStar_Util.iter_opt t collect_term) identterms)
       and collect_effect_decl uu___63_3583 =
         match uu___63_3583 with
         | FStar_Parser_AST.DefineEffect (uu____3584, binders, t, decls) ->
             (collect_binders binders; collect_term t; collect_decls decls)
         | FStar_Parser_AST.RedefineEffect (uu____3598, binders, t) ->
             (collect_binders binders; collect_term t)
       and collect_binders binders = FStar_List.iter collect_binder binders
       and collect_binder uu___64_3609 =
         match uu___64_3609 with
         | { FStar_Parser_AST.b = FStar_Parser_AST.Annotated (uu____3610, t);
             FStar_Parser_AST.brange = uu____3612;
             FStar_Parser_AST.blevel = uu____3613;
             FStar_Parser_AST.aqual = uu____3614;_} -> collect_term t
         | {
             FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu____3615, t);
             FStar_Parser_AST.brange = uu____3617;
             FStar_Parser_AST.blevel = uu____3618;
             FStar_Parser_AST.aqual = uu____3619;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.NoName t;
             FStar_Parser_AST.brange = uu____3621;
             FStar_Parser_AST.blevel = uu____3622;
             FStar_Parser_AST.aqual = uu____3623;_} -> collect_term t
         | uu____3624 -> ()
       and collect_term t = collect_term' t.FStar_Parser_AST.tm
       and collect_constant uu___65_3626 =
         match uu___65_3626 with
         | FStar_Const.Const_int
             (uu____3627, FStar_Pervasives_Native.Some (signedness, width))
             ->
             let u =
             ...
             let uu____3642 =
               let uu____3643 = FStar_Util.format2 "fstar.%sint%s" u w in
               PreferInterface uu____3643 in
             add_dep deps uu____3642
         | FStar_Const.Const_char uu____3749 ->
             add_dep deps (PreferInterface "fstar.char")
         | FStar_Const.Const_float uu____3855 ->
             add_dep deps (PreferInterface "fstar.float")
         | uu____3961 -> ()
       and collect_term' uu___66_3962 =
         match uu___66_3962 with
         | FStar_Parser_AST.Wild -> ()
         | FStar_Parser_AST.Const c -> collect_constant c
         | FStar_Parser_AST.Op (s, ts) ->
             ((let uu____3971 =
                 let uu____3972 = FStar_Ident.text_of_id s in
                 uu____3972 = "@" in
               if uu____3971
               then
                 let uu____3973 =
                   let uu____3974 =
                     let uu____3975 =
                       FStar_Ident.path_of_text "FStar.List.Tot.Base.append" in
                     FStar_Ident.lid_of_path uu____3975
                       FStar_Range.dummyRange in
                   FStar_Parser_AST.Name uu____3974 in
                 collect_term' uu____3973
               else ());
              FStar_List.iter collect_term ts)
         | FStar_Parser_AST.Tvar uu____3977 -> ()
         | FStar_Parser_AST.Uvar uu____3978 -> ()
         | FStar_Parser_AST.Var lid -> record_lid lid
         | FStar_Parser_AST.Projector (lid, uu____3981) -> record_lid lid
         ...
         | FStar_Parser_AST.Construct (lid, termimps) ->
             (if (FStar_List.length termimps) = (Prims.parse_int "1")
              ...
              FStar_List.iter
                (fun uu____4011 ->
                   match uu____4011 with | (t, uu____4017) -> collect_term t)
                termimps)
         | FStar_Parser_AST.Abs (pats, t) ->
             (collect_patterns pats; collect_term t)
         | FStar_Parser_AST.App (t1, t2, uu____4027) ->
             (collect_term t1; collect_term t2)
         | FStar_Parser_AST.Let (uu____4029, patterms, t) ->
             (FStar_List.iter
                (fun uu____4079 ->
         ...
         | FStar_Parser_AST.Bind (uu____4117, t1, t2) ->
             (collect_term t1; collect_term t2)
             ...
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____4213 ->
                   ...
                   | (uu____4218, t1) -> collect_term t1) idterms)
         | FStar_Parser_AST.Project (t, uu____4221) -> collect_term t
         ...
         | FStar_Parser_AST.NamedTyp (uu____4277, t) -> collect_term t
         | FStar_Parser_AST.Paren t -> collect_term t
         | FStar_Parser_AST.Requires (t, uu____4281) -> collect_term t
         | FStar_Parser_AST.Ensures (t, uu____4287) -> collect_term t
         | FStar_Parser_AST.Labeled (t, uu____4293, uu____4294) ->
             collect_term t
         | FStar_Parser_AST.VQuote t -> collect_term t
         | FStar_Parser_AST.Quote uu____4296 -> ()
         | FStar_Parser_AST.Antiquote uu____4301 -> ()
         | FStar_Parser_AST.Attributes cattributes ->
             FStar_List.iter collect_term cattributes
       and collect_patterns ps = FStar_List.iter collect_pattern ps
       and collect_pattern p = collect_pattern' p.FStar_Parser_AST.pat
       and collect_pattern' uu___67_4313 =
         match uu___67_4313 with
         | FStar_Parser_AST.PatWild -> ()
         | FStar_Parser_AST.PatOp uu____4314 -> ()
         | FStar_Parser_AST.PatConst uu____4315 -> ()
         | FStar_Parser_AST.PatApp (p, ps) ->
             (collect_pattern p; collect_patterns ps)
         | FStar_Parser_AST.PatVar uu____4323 -> ()
         | FStar_Parser_AST.PatName uu____4330 -> ()
         | FStar_Parser_AST.PatTvar uu____4331 -> ()
         | FStar_Parser_AST.PatList ps -> collect_patterns ps
         | FStar_Parser_AST.PatOr ps -> collect_patterns ps
         | FStar_Parser_AST.PatTuple (ps, uu____4345) -> collect_patterns ps
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____4364 ->
                  match uu____4364 with
                  | (uu____4369, p) -> collect_pattern p) lidpats
       ...
       and collect_branch uu____4414 =
         match uu____4414 with
         | (pat, t1, t2) ->
             (collect_pattern pat;
              FStar_Util.iter_opt t1 collect_term;
              collect_term t2) in
       let uu____4432 = FStar_Parser_Driver.parse_file filename in
       ...
       | (ast, uu____4452) ->
           ...
           ((let uu____4467 =
               ((is_interface filename) &&
                 ...
                 &&
                 (let uu____4469 = FStar_Options.dep () in
                  uu____4469 = (FStar_Pervasives_Native.Some "full")) in
             if uu____4467
             then add_dep mo_roots (UseImplementation mname)
             else ());
            collect_module ast;
            (let uu____4581 = FStar_ST.op_Bang deps in
             let uu____4687 = FStar_ST.op_Bang mo_roots in
             (uu____4581, uu____4687))))
let (collect_one_cache :
  (dependence Prims.list, dependence Prims.list)
    FStar_Pervasives_Native.tuple2 FStar_Util.smap FStar_ST.ref)
  =
  let uu____4844 = FStar_Util.smap_create (Prims.parse_int "0") in
  FStar_Util.mk_ref uu____4844
  ...
  fun all_cmd_line_files ->
    let all_cmd_line_files1 =
      FStar_All.pipe_right all_cmd_line_files
        (FStar_List.map
           (fun fn ->
              let uu____4979 = FStar_Options.find_file fn in
              match uu____4979 with
              | FStar_Pervasives_Native.None ->
                  let uu____4982 =
                    let uu____4987 =
                      FStar_Util.format1 "File %s could not be found\n" fn in
                    (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____4987) in
                  FStar_Errors.raise_err uu____4982
              | FStar_Pervasives_Native.Some fn1 -> fn1)) in
    let dep_graph = deps_empty () in
    let file_system_map = build_map all_cmd_line_files1 in
    let rec discover_one file_name =
      let uu____4997 =
        let uu____4998 = deps_try_find dep_graph file_name in
        uu____4998 = FStar_Pervasives_Native.None in
      if uu____4997
      then
        let uu____5015 =
          let uu____5024 =
            let uu____5035 = FStar_ST.op_Bang collect_one_cache in
            FStar_Util.smap_try_find uu____5035 file_name in
          match uu____5024 with
          | FStar_Pervasives_Native.Some cached -> cached
          | FStar_Pervasives_Native.None ->
              collect_one file_system_map file_name in
        ...
        | (deps, mo_roots) ->
            ...
            ((let uu____5155 =
                let uu____5160 = FStar_List.unique deps1 in
                (uu____5160, White) in
              deps_add_dep dep_graph file_name uu____5155);
             (let uu____5165 =
                FStar_List.map
                  (file_of_dep file_system_map all_cmd_line_files1)
                  (FStar_List.append deps1 mo_roots) in
              FStar_List.iter discover_one uu____5165))
      else () in
    ...
    (let topological_dependences_of all_command_line_files =
       ...
       let rec aux cycle filename =
         let uu____5204 =
           let uu____5209 = deps_try_find dep_graph filename in
           FStar_Util.must uu____5209 in
             ...
             (match color with
              | Gray ->
                  ((let uu____5223 =
                      ...
                      (FStar_Errors.Warning_RecursiveDependency, uu____5228) in
                    FStar_Errors.log_issue FStar_Range.dummyRange uu____5223);
                   FStar_Util.print1
              ...
              | White ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   (let uu____5234 =
                    ...
                    FStar_List.iter (fun k -> aux (k :: cycle) k) uu____5234);
                   deps_add_dep dep_graph filename (direct_deps, Black);
                   (let uu____5240 =
                      let uu____5243 = FStar_ST.op_Bang topologically_sorted in
                      filename :: uu____5243 in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____5240))) in
     ...
     (let uu____5563 = topological_dependences_of all_cmd_line_files1 in
      (uu____5563, (Mk (dep_graph, file_system_map, all_cmd_line_files1)))))
          ...
          let interface_hash =
            ...
            then
              let uu____5660 =
                let uu____5665 =
                  let uu____5666 =
                    let uu____5667 = interface_of file_system_map module_name in
                    FStar_Option.get uu____5667 in
                  digest_of_file1 uu____5666 in
                ("interface", uu____5665) in
              [uu____5660]
            else [] in
          let binary_deps =
            let uu____5686 =
            ...
            FStar_All.pipe_right uu____5686
              (FStar_List.filter
                 (fun fn2 ->
                    let uu____5696 =
                      (is_interface fn2) &&
                        (let uu____5698 = lowercase_module_name fn2 in
                         uu____5698 = module_name) in
                    Prims.op_Negation uu____5696)) in
          let binary_deps1 =
            FStar_List.sortWith
              (fun fn11 ->
                 fun fn2 ->
                   let uu____5708 = lowercase_module_name fn11 in
                   let uu____5709 = lowercase_module_name fn2 in
                   FStar_String.compare uu____5708 uu____5709) binary_deps in
          let rec hash_deps out uu___68_5736 =
            match uu___68_5736 with
            | [] ->
                FStar_Pervasives_Native.Some
            ...
            | fn2::deps1 ->
                ...
                then
                  let uu____5780 =
                    let uu____5787 =
                      let uu____5792 = lowercase_module_name fn2 in
                      let uu____5793 = digest_of_file1 cache_fn in
                      (uu____5792, uu____5793) in
                    uu____5787 :: out in
                  hash_deps uu____5780 deps1
                else
                  ((let uu____5800 = FStar_Options.debug_any () in
                    if uu____5800
                    then
      ...
      FStar_All.pipe_right dig
        (FStar_List.map
           (fun uu____5848 ->
              ...
              | (m, d) ->
                  let uu____5855 = FStar_Util.base64_encode d in
                  FStar_Util.format2 "%s:%s" m uu____5855)) in
    FStar_All.pipe_right uu____5829 (FStar_String.concat "\n")
    ...
    | Mk (deps, file_system_map, all_cmd_line_files) ->
        ...
        FStar_All.pipe_right keys
          (FStar_List.iter
             (fun f ->
                let uu____5882 =
                  let uu____5887 = deps_try_find deps f in
                  FStar_All.pipe_right uu____5887 FStar_Option.get in
        ...
        let sort_output_files orig_output_file_map =
          ...
          let should_visit lc_module_name =
            (let uu____5964 =
             ...
             FStar_Option.isSome uu____5964) ||
              (let uu____5968 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name in
               FStar_Option.isNone uu____5968) in
          ...
          let emit_output_file_opt ml_file_opt =
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____5995 =
                  let uu____5998 = FStar_ST.op_Bang order in ml_file ::
                    uu____5998 in
                FStar_ST.op_Colon_Equals order uu____5995 in
          let rec aux uu___69_6214 =
            match uu___69_6214 with
            | [] -> ()
            | lc_module_name::modules_to_extract ->
                let visit_file file_opt =
                  ...
                  | FStar_Pervasives_Native.Some file_name ->
                      let uu____6232 = deps_try_find deps file_name in
                ...
                ((let uu____6256 = should_visit lc_module_name in
                  if uu____6256
                  then
                    let ml_file_opt = mark_visiting lc_module_name in
                    ((let uu____6261 =
                        implementation_of file_system_map lc_module_name in
                      visit_file uu____6261);
                     (let uu____6265 =
          ...
          (let uu____6273 = FStar_ST.op_Bang order in
           FStar_List.rev uu____6273) in
        let keys = deps_keys deps in
        let output_file ext fst_file =
          let ml_base_name =
            let uu____6394 =
              let uu____6395 =
                let uu____6398 = FStar_Util.basename fst_file in
                check_and_strip_suffix uu____6398 in
              FStar_Option.get uu____6395 in
            FStar_Util.replace_chars uu____6394 46 "_" in
          FStar_Options.prepend_output_dir (Prims.strcat ml_base_name ext) in
        let norm_path s = FStar_Util.replace_chars s 92 "/" in
        let output_ml_file f =
          let uu____6413 = output_file ".ml" f in norm_path uu____6413 in
        let output_krml_file f =
          let uu____6420 = output_file ".krml" f in norm_path uu____6420 in
        let output_cmx_file f =
          let uu____6427 = output_file ".cmx" f in norm_path uu____6427 in
        let cache_file f =
          let uu____6434 = cache_file_name f in norm_path uu____6434 in
        let transitive_krml = FStar_Util.smap_create (Prims.parse_int "41") in
        (FStar_All.pipe_right keys
           (FStar_List.iter
              (fun f ->
                 let uu____6477 =
                   let uu____6482 = deps_try_find deps f in
                   FStar_All.pipe_right uu____6482 FStar_Option.get in
                 ...
                 | (f_deps, uu____6504) ->
                     ...
                     ((let uu____6520 = is_interface f in
                       if uu____6520
                       then
                         let uu____6521 =
                           let uu____6522 =
                             FStar_Options.prepend_cache_dir norm_f in
                           norm_path uu____6522 in
                         FStar_Util.print3
                           "%s.source: %s \\\n\t%s\n\ttouch $@\n\n"
                           uu____6521 norm_f files3
                       else ());
                      (let uu____6525 = cache_file f in
                       FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____6525
                         norm_f files3);
                      (let already_there =
                         let uu____6529 =
                           let uu____6540 =
                             let uu____6541 = output_file ".krml" f in
                             norm_path uu____6541 in
                           FStar_Util.smap_try_find transitive_krml
                             uu____6540 in
                         match uu____6529 with
                         | FStar_Pervasives_Native.Some
                             (uu____6552, already_there, uu____6554) ->
                             already_there
                         | FStar_Pervasives_Native.None -> [] in
                       (let uu____6576 =
                          let uu____6577 = output_file ".krml" f in
                          norm_path uu____6577 in
                        let uu____6578 =
                          let uu____6587 =
                            let uu____6588 = output_file ".exe" f in
                            norm_path uu____6588 in
                          let uu____6589 =
                            let uu____6592 =
                              let uu____6595 =
                                let uu____6598 =
                                  deps_of
                                    (Mk
                                       (deps, file_system_map,
                                         all_cmd_line_files)) f in
                                FStar_List.map
                                  (fun x ->
                                     let uu____6606 = output_file ".krml" x in
                                     norm_path uu____6606) uu____6598 in
                              FStar_List.append already_there uu____6595 in
                            FStar_List.unique uu____6592 in
                          (uu____6587, uu____6589, false) in
                        FStar_Util.smap_add transitive_krml uu____6576
                          uu____6578);
                       (let uu____6617 = is_implementation f in
                        if uu____6617
                        then
                          ((let uu____6619 = output_ml_file f in
                            let uu____6620 = cache_file f in
                            FStar_Util.print2 "%s: %s\n\n" uu____6619
                              uu____6620);
                           (let cmx_files =
                              let fst_files =
                            ...
                            (let uu____6651 =
                               let uu____6652 = lowercase_module_name f in
                               FStar_Options.should_extract uu____6652 in
                             if uu____6651
                             then
                               let uu____6653 = output_cmx_file f in
                               let uu____6654 = output_ml_file f in
                               FStar_Util.print3 "%s: %s \\\n\t%s\n\n"
                                 uu____6653 uu____6654
                                 (FStar_String.concat "\\\n\t" cmx_files)
                             else ());
                            (let uu____6656 = output_krml_file f in
                             let uu____6657 = cache_file f in
                             FStar_Util.print2 "%s: %s\n\n" uu____6656
                               uu____6657)))
                        else
                          (let uu____6659 =
                             (let uu____6662 =
                                let uu____6663 = lowercase_module_name f in
                                has_implementation file_system_map uu____6663 in
                              Prims.op_Negation uu____6662) &&
                               (is_interface f) in
                           if uu____6659
                           then
                             let uu____6664 = output_krml_file f in
                             let uu____6665 = cache_file f in
                             FStar_Util.print2 "%s: %s\n\n" uu____6664
                               uu____6665
                           else ()))))));
         (let all_fst_files =
            ...
            FStar_All.pipe_right all_fst_files
              (FStar_List.iter
                 (fun fst_file ->
                    ...
                    let uu____6696 = FStar_Options.should_extract mname in
                    if uu____6696
                    then
                      let uu____6697 = output_ml_file fst_file in
                      FStar_Util.smap_add ml_file_map mname uu____6697
                    else ()));
          ...
          let all_krml_files =
            ...
            FStar_All.pipe_right keys
              (FStar_List.iter
                 (fun fst_file ->
                    let mname = lowercase_module_name fst_file in
                    let uu____6713 = output_krml_file fst_file in
                    FStar_Util.smap_add krml_file_map mname uu____6713));
            sort_output_files krml_file_map in
          let rec make_transitive f =
            let uu____6726 =
              let uu____6735 = FStar_Util.smap_try_find transitive_krml f in
              FStar_Util.must uu____6735 in
                   ...
                   (let deps2 =
                      let uu____6798 =
                        let uu____6801 =
                          FStar_List.map
                            (fun dep1 ->
                               let uu____6813 = make_transitive dep1 in
                               match uu____6813 with
                               | (uu____6822, deps2) -> dep1 :: deps2) deps1 in
                        FStar_List.flatten uu____6801 in
                      FStar_List.unique uu____6798 in
                    FStar_Util.smap_add transitive_krml f (exe, deps2, true);
                    (exe, deps2))) in
          (let uu____6842 = FStar_Util.smap_keys transitive_krml in
           FStar_List.iter
             (fun f ->
                let uu____6861 = make_transitive f in
                match uu____6861 with
                | (exe, deps1) ->
                    let deps2 =
                      let uu____6875 = FStar_List.unique (f :: deps1) in
                      FStar_String.concat " " uu____6875 in
                    let wasm =
                      let uu____6879 =
                        FStar_Util.substring exe (Prims.parse_int "0")
                          ((FStar_String.length exe) - (Prims.parse_int "4")) in
                      Prims.strcat uu____6879 ".wasm" in
                    (FStar_Util.print2 "%s: %s\n\n" exe deps2;
                     FStar_Util.print2 "%s: %s\n\n" wasm deps2)) uu____6842);
          (let uu____6882 =
             let uu____6883 =
               FStar_All.pipe_right all_fst_files (FStar_List.map norm_path) in
             FStar_All.pipe_right uu____6883 (FStar_String.concat " \\\n\t") in
           FStar_Util.print1 "ALL_FST_FILES=\\\n\t%s\n\n" uu____6882);
          (let uu____6893 =
             let uu____6894 =
               FStar_All.pipe_right all_ml_files (FStar_List.map norm_path) in
             FStar_All.pipe_right uu____6894 (FStar_String.concat " \\\n\t") in
           FStar_Util.print1 "ALL_ML_FILES=\\\n\t%s\n\n" uu____6893);
          (let uu____6903 =
             let uu____6904 =
               FStar_All.pipe_right all_krml_files (FStar_List.map norm_path) in
             FStar_All.pipe_right uu____6904 (FStar_String.concat " \\\n\t") in
           FStar_Util.print1 "ALL_KRML_FILES=\\\n\t%s\n" uu____6903)))
let (print : deps -> unit) =
  fun deps ->
    let uu____6918 = FStar_Options.dep () in
    match uu____6918 with
    | FStar_Pervasives_Native.Some "make" -> print_make deps
    | FStar_Pervasives_Native.Some "full" -> print_full deps
    | FStar_Pervasives_Native.Some "graph" ->
        let uu____6921 = deps in
        (match uu____6921 with
         | Mk (deps1, uu____6923, uu____6924) -> print_graph deps1)
