              ...
              let uu____864 =
                (cmd_line_has_impl key) &&
                  (let uu____866 = FStar_Options.dep () in
                   FStar_Option.isNone uu____866) in
              if uu____864
              then
                ...
                (if uu____869
                 then
                   let uu____870 =
                     let uu____871 = implementation_of file_system_map key in
                   ...
                   let uu____899 =
                     let uu____904 =
                       FStar_Util.format1
                         ...
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____904) in
                   ...
                   let uu____911 =
                     let uu____916 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____916) in
                   ...
                   let uu____923 =
                     let uu____928 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____928) in
           ...
           let uu____1002 =
             ...
             FStar_List.collect
               (fun k ->
                  ...
                  FStar_List.map print7 deps) uu____1005 in
           FStar_String.concat "\n" uu____1002 in
         ...
         FStar_List.iter
           (fun k ->
              ...
              then
                ...
                let filename =
                  let uu____1345 = FStar_Util.smap_try_find original_map k in
...
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____1504 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
          ...
          let uu____2183 =
            let uu____2188 =
              ...
              FStar_Util.format1
                ...
                uu____2189 in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2188) in
      ...
      let record_open_module_or_namespace uu____2214 =
        ...
        | (lid, kind) ->
            (match kind with
             ...
             | Open_module ->
                 let uu____2221 = record_open_module false lid in ()) in
            ...
            then ()
              ...
              (let uu____2309 = FStar_Options.debug_any () in
               ...
               then
                 ...
                 let uu____2311 =
                   let uu____2316 =
                     let uu____2317 = FStar_Ident.string_of_lid module_name in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2317 in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2316) in
         ...
         | FStar_Parser_AST.Tycon (uu____2594, tc, ts) ->
             (if tc then record_lid FStar_Parser_Const.mk_class_lid else ();
              (let ts1 =
                 FStar_List.map
                   (fun uu____2627 ->
                      match uu____2627 with | (x, docnik) -> x) ts in
             ...
             (collect_binders binders;
              ...
              FStar_List.iter
                (fun uu____2809 ->
                   ...
                   | (uu____2818, t, uu____2820) -> collect_term t)
                identterms)
             ...
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3330 ->
                   ...
                   | (uu____3335, t1) -> collect_term t1) idterms)
         ...
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____3477 ->
                  ...
                  | (uu____3482, p) -> collect_pattern p) lidpats
...
let (collect :
  ...
  fun all_cmd_line_files ->
    ...
    (let dep_graph_copy dep_graph1 =
       ...
       | Deps g -> let uu____4055 = FStar_Util.smap_copy g in Deps uu____4055 in
     let cycle_detected dep_graph1 cycle filename =
       ...
       (let uu____4089 =
        ...
        FStar_Errors.raise_err uu____4089) in
     ...
     (let topological_dependences_of all_command_line_files =
                        ...
                        (deps_add_dep dep_graph1 filename (direct_deps, Gray);
                         (let uu____4371 =
                            ...
                            all_friend_deps dep_graph1 cycle
                              (all_friends, all_files) uu____4380 in
                                    ...
                                    FStar_List.filter
                                      (fun uu___121_4414 ->
                                         ...
                                         | FriendImplementation uu____4415 ->
                                             true
                                         | uu____4416 -> false) direct_deps in
                                  FStar_List.append uu____4409 all_friends1 in
        ...
        | (friends, uu____4474) ->
            ...
            (match uu____4513 with | (uu____4590, all_files) -> all_files) in
          ...
          let interface_hash =
            ...
            then
              let uu____4697 =
                let uu____4702 =
                  let uu____4703 =
                    let uu____4704 = interface_of file_system_map module_name in
                    ...
                    let uu____4733 =
                      (is_interface fn2) &&
                        (let uu____4735 = lowercase_module_name fn2 in
                         uu____4735 = module_name) in
                    Prims.op_Negation uu____4733)) in
          let binary_deps1 =
            FStar_List.sortWith
              (fun fn11 ->
                 fun fn2 ->
                   ...
                   FStar_String.compare uu____4745 uu____4746) binary_deps in
        ...
        (FStar_List.map
           (fun uu____4900 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4907)) in
             ...
             FStar_Option.isSome uu____5074) ||
              (let uu____5078 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name in
               FStar_Option.isNone uu____5078) in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____5105 =
                  let uu____5108 = FStar_ST.op_Bang order in ml_file ::
                    uu____5108 in
                FStar_ST.op_Colon_Equals order uu____5105 in
                       ...
                       then FStar_Pervasives_Native.None
                         ...
                         (let uu____5464 =
                          ...
                          | FStar_Pervasives_Native.Some iface ->
                              let uu____5475 =
                                let uu____5478 =
                                  let uu____5483 = deps_try_find deps1 iface in
                          ...
                          let uu____5607 =
                            let uu____5610 =
                              let uu____5613 =
                                ...
                                FStar_List.map
                                  (fun x ->
                                     let uu____5624 = output_file ".krml" x in
                                     norm_path uu____5624) uu____5616 in
                        ...
                        then
                          ...
                          (let uu____5705 =
                             (let uu____5708 =
                                ...
                                has_implementation file_system_map uu____5709 in
                        ...
                        let uu____5847 =
                          FStar_List.map
                            (fun dep1 ->
                               ...
                               | (uu____5868, deps3) -> dep1 :: deps3) deps2 in
