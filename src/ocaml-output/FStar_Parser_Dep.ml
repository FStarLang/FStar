          ...
          | PreferInterface key when has_interface file_system_map key ->
              let uu____724 =
                (cmd_line_has_impl key) &&
                  (let uu____726 = FStar_Options.dep () in
                   FStar_Option.isNone uu____726) in
              if uu____724
              then
                let uu____729 = FStar_Options.expose_interfaces () in
                (if uu____729
                 then
                   let uu____730 =
                     let uu____731 = implementation_of file_system_map key in
                     FStar_Option.get uu____731 in
                   maybe_add_suffix uu____730
                 else
                   (let uu____735 =
                      let uu____736 =
                        let uu____737 =
                   ...
                   let uu____757 =
                     let uu____758 =
                       FStar_Util.format1
                         ...
                         key in
                     FStar_Errors.Err uu____758 in
                   FStar_Exn.raise uu____757
               | FStar_Pervasives_Native.Some f -> maybe_add_suffix f)
          | UseImplementation key ->
              let uu____761 = implementation_of file_system_map key in
...
let dependences_of:
  ...
  fun file_system_map  ->
    fun deps  ->
      fun all_cmd_line_files  ->
        fun fn  ->
          let uu____798 = deps_try_find deps fn in
          match uu____798 with
          | FStar_Pervasives_Native.None  -> empty_dependences ()
          | FStar_Pervasives_Native.Some (deps1,uu____812) ->
...
let add_dependence: dependence_graph -> file_name -> file_name -> Prims.unit
  ...
  fun deps  ->
    fun from  ->
      fun to_  ->
        let add_dep uu____843 to_1 =
          match uu____843 with
          | (d,color) ->
              let uu____863 = is_interface to_1 in
              if uu____863
              then
                let uu____870 =
                  let uu____873 =
                    let uu____874 = lowercase_module_name to_1 in
                    PreferInterface uu____874 in
                  uu____873 :: d in
                (uu____870, color)
              else
                (let uu____878 =
                   let uu____881 =
                     let uu____882 = lowercase_module_name to_1 in
                     UseImplementation uu____882 in
                   uu____881 :: d in
                 (uu____878, color)) in
        let uu____885 = deps_try_find deps from in
        match uu____885 with
        | FStar_Pervasives_Native.None  ->
            let uu____896 = add_dep ((empty_dependences ()), White) to_ in
            deps_add_dep deps from uu____896
        | FStar_Pervasives_Native.Some key_deps ->
            let uu____912 = add_dep key_deps to_ in
            deps_add_dep deps from uu____912
    ...
    (let uu____923 =
       let uu____924 =
         let uu____925 =
           let uu____926 =
             let uu____929 =
               let uu____932 = deps_keys graph in FStar_List.unique uu____932 in
             FStar_List.collect
               (fun k  ->
                  let deps =
                    let uu____941 =
                      let uu____946 = deps_try_find graph k in
                      FStar_Util.must uu____946 in
                    FStar_Pervasives_Native.fst uu____941 in
                  let r s = FStar_Util.replace_char s 46 95 in
                  let print7 dep1 =
                    FStar_Util.format2 " %s -> %s" (r k)
                      (r (module_name_of_dep dep1)) in
                  FStar_List.map print7 deps) uu____929 in
           FStar_String.concat "\n" uu____926 in
         Prims.strcat uu____925 "\n}\n" in
       Prims.strcat "digraph {\n" uu____924 in
     FStar_Util.write_file "dep.graph" uu____923)
let build_inclusion_candidates_list:
  ...
  fun uu____973  ->
    ...
    let cwd =
      let uu____990 = FStar_Util.getcwd () in
      FStar_Util.normalize_file_path uu____990 in
         ...
         then
           ...
           FStar_List.filter_map
             (fun f  ->
                ...
                let uu____1016 = check_and_strip_suffix f1 in
           ...
           (let uu____1037 =
              ...
              FStar_Errors.Err uu____1038 in
            FStar_Exn.raise uu____1037)) include_directories2
let build_map: Prims.string Prims.list -> files_for_module_name =
  fun filenames  ->
    let map1 = FStar_Util.smap_create (Prims.parse_int "41") in
    let add_entry key full_path =
      let uu____1078 = FStar_Util.smap_try_find map1 key in
      match uu____1078 with
      | FStar_Pervasives_Native.Some (intf,impl) ->
          let uu____1115 = is_interface full_path in
          if uu____1115
          then
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____1149 = is_interface full_path in
          if uu____1149
          then
            FStar_Util.smap_add map1 key
    ...
    (let uu____1176 = build_inclusion_candidates_list () in
     FStar_List.iter
       (fun uu____1190  ->
    ...
    FStar_List.iter
      (fun f  ->
         let uu____1201 = lowercase_module_name f in add_entry uu____1201 f)
      filenames;
    map1
let enter_namespace:
  files_for_module_name ->
  ...
  fun original_map  ->
    fun working_map  ->
      fun prefix1  ->
        ...
        (let uu____1216 =
           let uu____1219 = FStar_Util.smap_keys original_map in
           FStar_List.unique uu____1219 in
         FStar_List.iter
           (fun k  ->
              ...
              then
                ...
                let filename =
                  let uu____1245 = FStar_Util.smap_try_find original_map k in
                  FStar_Util.must uu____1245 in
  ...
  fun l  ->
    fun last1  ->
      ...
      let names =
        ...
        FStar_List.append uu____1417 suffix in
      FStar_String.concat "." names
let lowercase_join_longident:
  FStar_Ident.lident -> Prims.bool -> Prims.string =
  fun l  ->
    fun last1  ->
      let uu____1428 = string_of_lid l last1 in
      FStar_String.lowercase uu____1428
let namespace_of_lid: FStar_Ident.lident -> Prims.string =
  fun l  ->
    let uu____1432 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
    FStar_String.concat "_" uu____1432
    ...
    fun filename  ->
      ...
      let uu____1442 =
        let uu____1443 =
          let uu____1444 =
            let uu____1445 =
              let uu____1448 = FStar_Util.basename filename in
              check_and_strip_suffix uu____1448 in
            FStar_Util.must uu____1445 in
          FStar_String.lowercase uu____1444 in
        uu____1443 <> k' in
      if uu____1442
      then
        let uu____1449 =
          let uu____1450 = string_of_lid lid true in
          FStar_Util.format2
            "The module declaration \"module %s\" found in file %s does not match its filename. Dependencies will be incorrect and the module will not be verified.\n"
            uu____1450 filename in
        FStar_Errors.err (FStar_Ident.range_of_lid lid) uu____1449
      else ()
exception Exit
let uu___is_Exit: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with | Exit  -> true | uu____1455 -> false
let hard_coded_dependencies:
  ...
  fun filename  ->
    ...
    let corelibs =
      let uu____1469 = FStar_Options.prims_basename () in
      let uu____1470 =
        let uu____1473 = FStar_Options.pervasives_basename () in
        let uu____1474 =
          let uu____1477 = FStar_Options.pervasives_native_basename () in
          [uu____1477] in
  ...
  fun original_map  ->
    fun filename  ->
      ...
      let add_dep deps1 d =
        ...
        then
          let uu____2041 =
            let uu____2044 = FStar_ST.op_Bang deps1 in d :: uu____2044 in
          FStar_ST.op_Colon_Equals deps1 uu____2041
        else () in
      let working_map = FStar_Util.smap_copy original_map in
      let add_dependence_edge lid =
        let key = lowercase_join_longident lid true in
        let uu____2364 = resolve_module_name working_map key in
      ...
      let record_open_module let_open lid =
        let uu____2424 = add_dependence_edge lid in
        if uu____2424
        then true
        else
          (if let_open
           then
             (let uu____2427 =
                let uu____2428 = string_of_lid lid true in
                FStar_Util.format1 "Module not found: %s" uu____2428 in
              FStar_Errors.warn (FStar_Ident.range_of_lid lid) uu____2427)
           else ();
           false) in
      let record_open_namespace lid =
        ...
        then
          let uu____2436 =
            let uu____2437 = string_of_lid lid true in
            FStar_Util.format1
              "No modules in namespace %s and no file with that name either"
              uu____2437 in
          FStar_Errors.warn (FStar_Ident.range_of_lid lid) uu____2436
        else () in
      let record_open let_open lid =
        let uu____2446 = record_open_module let_open lid in
        if uu____2446
        then ()
        else
      ...
      let record_open_module_or_namespace uu____2456 =
        match uu____2456 with
        | (lid,kind) ->
            (match kind with
             | Open_namespace  -> record_open_namespace lid
             | Open_module  ->
                 let uu____2463 = record_open_module false lid in ()) in
      let record_module_alias ident lid =
        let key = FStar_String.lowercase (FStar_Ident.text_of_id ident) in
        let alias = lowercase_join_longident lid true in
        let uu____2473 = FStar_Util.smap_try_find original_map alias in
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____2525 =
              FStar_Util.format1 "module not found in search path: %s\n"
                alias in
            FStar_Errors.warn (FStar_Ident.range_of_lid lid) uu____2525 in
      let record_lid lid =
        match lid.FStar_Ident.ns with
        | [] -> ()
        | uu____2530 ->
            let module_name = FStar_Ident.lid_of_ids lid.FStar_Ident.ns in
            let uu____2534 = add_dependence_edge module_name in
            if uu____2534
            then ()
            else
              (let uu____2536 = FStar_Options.debug_any () in
               if uu____2536
               then
                 let uu____2537 =
                   let uu____2538 = FStar_Ident.string_of_lid module_name in
                   FStar_Util.format1 "Unbound module reference %s"
                     uu____2538 in
                 FStar_Errors.warn (FStar_Ident.range_of_lid lid) uu____2537
               else ()) in
      let auto_open = hard_coded_dependencies filename in
      FStar_List.iter record_open_module_or_namespace auto_open;
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
       let rec collect_module uu___114_2624 =
         match uu___114_2624 with
         | FStar_Parser_AST.Module (lid,decls) ->
             (check_module_declaration_against_filename lid filename;
              ...
              then
                (let uu____2633 =
                   let uu____2634 = namespace_of_lid lid in
                   enter_namespace original_map working_map uu____2634 in
                 ())
              else ();
              collect_decls decls)
         | FStar_Parser_AST.Interface (lid,decls,uu____2638) ->
             (check_module_declaration_against_filename lid filename;
              if
                (FStar_List.length lid.FStar_Ident.ns) >
                  (Prims.parse_int "0")
              then
                (let uu____2645 =
                   let uu____2646 = namespace_of_lid lid in
                   enter_namespace original_map working_map uu____2646 in
                 ())
              else ();
              collect_decls decls)
       ...
       and collect_decl uu___115_2655 =
         match uu___115_2655 with
         | FStar_Parser_AST.Include lid -> record_open false lid
         | FStar_Parser_AST.Open lid -> record_open false lid
         | FStar_Parser_AST.ModuleAbbrev (ident,lid) ->
             ((let uu____2661 =
                 let uu____2662 = lowercase_join_longident lid true in
                 PreferInterface uu____2662 in
               add_dep deps uu____2661);
              record_module_alias ident lid)
         | FStar_Parser_AST.TopLevelLet (uu____2684,patterms) ->
             FStar_List.iter
               (fun uu____2706  ->
         ...
         | FStar_Parser_AST.Assume (uu____2715,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2717;
               FStar_Parser_AST.mdest = uu____2718;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.NonReifiableLift t;_}
             -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2720;
               FStar_Parser_AST.mdest = uu____2721;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.LiftForFree t;_}
             -> collect_term t
         | FStar_Parser_AST.Val (uu____2723,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
         ...
         | FStar_Parser_AST.Tycon (uu____2730,ts) ->
             let ts1 =
               FStar_List.map
                 (fun uu____2760  -> match uu____2760 with | (x,docnik) -> x)
                 ts in
             FStar_List.iter collect_tycon ts1
         | FStar_Parser_AST.Exception (uu____2773,t) ->
             FStar_Util.iter_opt t collect_term
         | FStar_Parser_AST.NewEffect ed -> collect_effect_decl ed
         | FStar_Parser_AST.Fsdoc uu____2780 -> ()
         | FStar_Parser_AST.Pragma uu____2781 -> ()
         | FStar_Parser_AST.TopLevelModule lid ->
             (FStar_Util.incr num_of_toplevelmods;
              (let uu____2805 =
                 let uu____2806 = FStar_ST.op_Bang num_of_toplevelmods in
                 uu____2806 > (Prims.parse_int "1") in
               if uu____2805
               then
                 let uu____2867 =
                   let uu____2868 =
                     let uu____2873 =
                       let uu____2874 = string_of_lid lid true in
                       FStar_Util.format1
                         "Automatic dependency analysis demands one module per file (module %s not supported)"
                         uu____2874 in
                     (uu____2873, (FStar_Ident.range_of_lid lid)) in
                   FStar_Errors.Error uu____2868 in
                 FStar_Exn.raise uu____2867
               else ()))
       and collect_tycon uu___116_2876 =
         match uu___116_2876 with
         | FStar_Parser_AST.TyconAbstract (uu____2877,binders,k) ->
             (collect_binders binders; FStar_Util.iter_opt k collect_term)
         | FStar_Parser_AST.TyconAbbrev (uu____2889,binders,k,t) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              collect_term t)
         | FStar_Parser_AST.TyconRecord (uu____2903,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____2949  ->
                   match uu____2949 with
                   | (uu____2958,t,uu____2960) -> collect_term t) identterms)
         | FStar_Parser_AST.TyconVariant (uu____2965,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____3024  ->
                   match uu____3024 with
                   | (uu____3037,t,uu____3039,uu____3040) ->
                       FStar_Util.iter_opt t collect_term) identterms)
       and collect_effect_decl uu___117_3049 =
         match uu___117_3049 with
         | FStar_Parser_AST.DefineEffect (uu____3050,binders,t,decls) ->
             (collect_binders binders; collect_term t; collect_decls decls)
         | FStar_Parser_AST.RedefineEffect (uu____3064,binders,t) ->
             (collect_binders binders; collect_term t)
       and collect_binders binders = FStar_List.iter collect_binder binders
       and collect_binder uu___118_3075 =
         match uu___118_3075 with
         | { FStar_Parser_AST.b = FStar_Parser_AST.Annotated (uu____3076,t);
             FStar_Parser_AST.brange = uu____3078;
             FStar_Parser_AST.blevel = uu____3079;
             FStar_Parser_AST.aqual = uu____3080;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu____3081,t);
         ...
         | { FStar_Parser_AST.b = FStar_Parser_AST.NoName t;
             FStar_Parser_AST.brange = uu____3087;
             FStar_Parser_AST.blevel = uu____3088;
             FStar_Parser_AST.aqual = uu____3089;_} -> collect_term t
         | uu____3090 -> ()
       and collect_term t = collect_term' t.FStar_Parser_AST.tm
       and collect_constant uu___119_3092 =
         match uu___119_3092 with
         | FStar_Const.Const_int
             (uu____3093,FStar_Pervasives_Native.Some (signedness,width)) ->
             let u =
             ...
             let uu____3108 =
               let uu____3109 = FStar_Util.format2 "fstar.%sint%s" u w in
               PreferInterface uu____3109 in
             add_dep deps uu____3108
         | FStar_Const.Const_char uu____3131 ->
             add_dep deps (PreferInterface "fstar.char")
         | FStar_Const.Const_float uu____3153 ->
             add_dep deps (PreferInterface "fstar.float")
         | uu____3175 -> ()
       and collect_term' uu___120_3176 =
         match uu___120_3176 with
             ...
             (if (FStar_Ident.text_of_id s) = "@"
              then
                (let uu____3185 =
                   ...
                   FStar_Parser_AST.Name uu____3186 in
                 collect_term' uu____3185)
              else ();
              FStar_List.iter collect_term ts)
         | FStar_Parser_AST.Tvar uu____3188 -> ()
         | FStar_Parser_AST.Uvar uu____3189 -> ()
         | FStar_Parser_AST.Var lid -> record_lid lid
         | FStar_Parser_AST.Projector (lid,uu____3192) -> record_lid lid
         ...
         | FStar_Parser_AST.Construct (lid,termimps) ->
             (if (FStar_List.length termimps) = (Prims.parse_int "1")
              ...
              FStar_List.iter
                (fun uu____3222  ->
                   match uu____3222 with | (t,uu____3228) -> collect_term t)
                termimps)
         | FStar_Parser_AST.Abs (pats,t) ->
             (collect_patterns pats; collect_term t)
         | FStar_Parser_AST.App (t1,t2,uu____3238) ->
             (collect_term t1; collect_term t2)
         | FStar_Parser_AST.Let (uu____3240,patterms,t) ->
             (FStar_List.iter
                (fun uu____3264  ->
         ...
         | FStar_Parser_AST.Assign (uu____3438,t) -> collect_term t
         | FStar_Parser_AST.Requires (t,uu____3441) -> collect_term t
         | FStar_Parser_AST.Ensures (t,uu____3447) -> collect_term t
         | FStar_Parser_AST.Labeled (t,uu____3453,uu____3454) ->
             collect_term t
         | FStar_Parser_AST.Attributes cattributes ->
             FStar_List.iter collect_term cattributes
       and collect_patterns ps = FStar_List.iter collect_pattern ps
       and collect_pattern p = collect_pattern' p.FStar_Parser_AST.pat
       and collect_pattern' uu___121_3462 =
         match uu___121_3462 with
         | FStar_Parser_AST.PatWild  -> ()
         | FStar_Parser_AST.PatOp uu____3463 -> ()
         | FStar_Parser_AST.PatConst uu____3464 -> ()
         | FStar_Parser_AST.PatApp (p,ps) ->
             (collect_pattern p; collect_patterns ps)
         | FStar_Parser_AST.PatVar uu____3472 -> ()
         | FStar_Parser_AST.PatName uu____3479 -> ()
         | FStar_Parser_AST.PatTvar uu____3480 -> ()
         | FStar_Parser_AST.PatList ps -> collect_patterns ps
         | FStar_Parser_AST.PatOr ps -> collect_patterns ps
         | FStar_Parser_AST.PatTuple (ps,uu____3494) -> collect_patterns ps
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____3513  ->
                  match uu____3513 with | (uu____3518,p) -> collect_pattern p)
               lidpats
       ...
       | (ast,uu____3580) ->
           (collect_module ast;
            (let uu____3594 = FStar_ST.op_Bang deps in
             let uu____3661 = FStar_ST.op_Bang mo_roots in
             (uu____3594, uu____3661))))
let collect:
  ...
  fun all_cmd_line_files  ->
    ...
    let rec discover_one file_name =
      let uu____3757 =
        let uu____3758 = deps_try_find dep_graph file_name in
        uu____3758 = FStar_Pervasives_Native.None in
      if uu____3757
      then
        let uu____3775 = collect_one file_system_map file_name in
        ...
        | (deps,mo_roots) ->
            ...
            ((let uu____3803 =
                let uu____3808 = FStar_List.unique deps1 in
                (uu____3808, White) in
              deps_add_dep dep_graph file_name uu____3803);
             (let uu____3813 =
                FStar_List.map
                  (file_of_dep file_system_map all_cmd_line_files)
                  (FStar_List.append deps1 mo_roots) in
              FStar_List.iter discover_one uu____3813))
      else () in
    ...
    (let topological_dependences_of all_command_line_files =
       ...
       let rec aux cycle filename =
         let uu____3846 =
           let uu____3851 = deps_try_find dep_graph filename in
           FStar_Util.must uu____3851 in
              ...
              | White  ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   (let uu____3870 =
                    ...
                    FStar_List.iter (fun k  -> aux (k :: cycle) k) uu____3870);
                   deps_add_dep dep_graph filename (direct_deps, Black);
                   (let uu____3876 =
                      let uu____3879 = FStar_ST.op_Bang topologically_sorted in
                      filename :: uu____3879 in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3876))) in
     ...
     (let uu____4082 = topological_dependences_of all_cmd_line_files in
      (uu____4082, (Mk (dep_graph, file_system_map, all_cmd_line_files)))))
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          ...
          let interface_hash =
            ...
            then
              let uu____4145 =
                let uu____4146 =
                  let uu____4147 = interface_of file_system_map module_name in
                  FStar_Option.get uu____4147 in
                digest_of_file1 uu____4146 in
              [uu____4145]
            else [] in
          let binary_deps =
            let uu____4154 =
            ...
            FStar_All.pipe_right uu____4154
              (FStar_List.filter
                 (fun fn1  ->
                    let uu____4164 =
                      (is_interface fn1) &&
                        (let uu____4166 = lowercase_module_name fn1 in
                         uu____4166 = module_name) in
                    Prims.op_Negation uu____4164)) in
          let binary_deps1 =
            FStar_List.sortWith FStar_String.compare binary_deps in
          let rec hash_deps out uu___122_4184 =
            match uu___122_4184 with
            | [] ->
                FStar_Pervasives_Native.Some
            ...
            | fn1::deps1 ->
                ...
                then
                  let uu____4204 =
                    let uu____4207 = digest_of_file1 fn2 in uu____4207 :: out in
                  hash_deps uu____4204 deps1
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        ...
        FStar_All.pipe_right keys
          (FStar_List.iter
             (fun f  ->
                let uu____4233 =
                  let uu____4238 = deps_try_find deps f in
                  FStar_All.pipe_right uu____4238 FStar_Option.get in
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        ...
        (FStar_All.pipe_right keys
           (FStar_List.iter
              (fun f  ->
                 let uu____4297 =
                   let uu____4302 = deps_try_find deps f in
                   FStar_All.pipe_right uu____4302 FStar_Option.get in
                 ...
                 | (f_deps,uu____4324) ->
                     ...
                     let files1 =
                       FStar_List.map
                         ...
                         files in
                     ((let uu____4334 = is_interface f in
                       if uu____4334
                       then
                         FStar_Util.print2 "%s:\\\n\t%s\n\n" f
                           (FStar_String.concat "\\\n\t" files1)
                      ...
                      FStar_Util.print3 "%s.checked: %s \\\n\t%s\n\n" f f
                        (FStar_String.concat " \\\n\t" files1);
                      (let uu____4337 = is_implementation f in
                       if uu____4337
                       then
                         let ml_base_name =
                           let uu____4339 =
                             let uu____4340 =
                               let uu____4343 = FStar_Util.basename f in
                               check_and_strip_suffix uu____4343 in
                             FStar_Option.get uu____4340 in
                           FStar_Util.replace_chars uu____4339 46 "_" in
                         let uu____4344 =
                           let uu____4345 = FStar_Options.output_dir () in
                           match uu____4345 with
                           | FStar_Pervasives_Native.None  -> ""
                           | FStar_Pervasives_Native.Some x ->
                               Prims.strcat x "/" in
                         FStar_Util.print3 "%s%s.ml: %s.checked\n\n"
                           uu____4344 ml_base_name f
                       else ()))));
         (let all_fst_files =
