            ...
            | (ast, uu____4366) ->
                ...
                ((let uu____4384 =
                 ...
                 (let uu____4390 = FStar_ST.op_Bang deps in
                  ...
                  let uu____4442 = FStar_ST.op_Bang has_inline_for_extraction in
                  {
                       ...
                       ((let uu____4824 = FStar_Options.debug_any () in
                        ...
                        (let uu____4841 =
                           ...
                           all_friend_deps dep_graph1 cycle
                             (all_friends, all_files) uu____4852 in
                         ...
                         | (all_friends1, all_files1) ->
                             (deps_add_dep dep_graph1 filename
                              ...
                              (let uu____4890 = FStar_Options.debug_any () in
                               if uu____4890
                                 ...
                                 let uu____4900 =
                                   FStar_List.collect
                                     (fun uu___12_4907 ->
                                        ...
                                        | FriendImplementation m -> [m]
                                        | d -> []) dep_node.edges in
                                 FStar_List.append uu____4900 all_friends1 in
                              ...
                              fun dep_node ->
                                fun uu____5064 ->
                                  let uu____5066 =
                                    ...
                                    let uu____5068 = widen_one dep_node.edges in
  ...
  fun all_cmd_line_files ->
    fun get_parsing_data_from_cache ->
             ...
             (fun fn ->
                ...
                | FStar_Pervasives_Native.None ->
                    let uu____5291 =
                      ...
                      (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____5297) in
      ...
      let add_interface_for_inlining l =
        ...
        let uu____5327 =
          let uu____5331 = FStar_ST.op_Bang interfaces_needing_inlining in l1
            :: uu____5331 in
      ...
      (let cycle_detected dep_graph1 cycle filename =
         ...
         (let uu____5631 =
          ...
          FStar_Errors.raise_err uu____5631) in
        ...
        (FStar_List.map
           (fun uu____5918 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____5932)) in
...
let (print_full : deps -> unit) =
  fun deps ->
    let sort_output_files orig_output_file_map =
        ...
        (let uu____6096 =
         ...
         FStar_Option.isSome uu____6096) ||
          (let uu____6103 =
           ...
           FStar_Option.isNone uu____6103) in
        ...
        | FStar_Pervasives_Native.Some ml_file ->
            let uu____6146 =
              let uu____6150 = FStar_ST.op_Bang order in ml_file ::
                uu____6150 in
            FStar_ST.op_Colon_Equals order uu____6146 in
      ...
      (let uu____6282 = FStar_ST.op_Bang order in FStar_List.rev uu____6282) in
    let sb =
           ...
           (fun all_checked_files ->
              fun file_name ->
                let process_one_key uu____6478 =
                  let dep_node =
                    let uu____6480 = deps_try_find deps.dep_graph file_name in
                      ...
                      (let uu____6501 =
                       ...
                       | FStar_Pervasives_Native.Some iface ->
                           let uu____6517 =
                             ...
                             uu____6520.edges in
                           FStar_Pervasives_Native.Some uu____6517) in
                  let iface_deps1 =
                  ...
                  let files4 =
                    FStar_Options.profile
                      ...
                      (fun uu____6601 -> "Dependence analysis: concat files") in
                        ...
                        then
                          ...
                          (let uu____6824 =
                           ...
                           then
                             ...
                             (if uu____6833
                              then
                                let uu____6837 = output_krml_file file_name in
                                print_entry uu____6837 cache_file_name1
                                  all_checked_fst_dep_files_string
                              else
                                (let uu____6841 = output_krml_file file_name in
