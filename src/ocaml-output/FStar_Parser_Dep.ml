...
type deps =
  ...
  file_name Prims.list) FStar_Pervasives_Native.tuple4 
              ...
              let uu____886 =
                (cmd_line_has_impl key) &&
                  (let uu____888 = FStar_Options.dep () in
                   FStar_Option.isNone uu____888) in
              if uu____886
              then
                ...
                (if uu____891
                 then
                   let uu____892 =
                     let uu____893 = implementation_of file_system_map key in
                   ...
                   let uu____921 =
                     let uu____926 =
                       FStar_Util.format1
                         ...
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____926) in
                   ...
                   let uu____933 =
                     let uu____938 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____938) in
                   ...
                   let uu____945 =
                     let uu____950 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____950) in
           ...
           let uu____1024 =
             ...
             FStar_List.collect
               (fun k ->
                  ...
                  FStar_List.map print7 deps) uu____1027 in
           FStar_String.concat "\n" uu____1024 in
         ...
         FStar_List.iter
           (fun k ->
              ...
              then
                ...
                let filename =
                  let uu____1367 = FStar_Util.smap_try_find original_map k in
...
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____1526 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
  ...
  fun original_map ->
    fun filename ->
          ...
          let uu____2205 =
            let uu____2210 =
              ...
              FStar_Util.format1
                ...
                uu____2211 in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2210) in
      ...
      let record_open_module_or_namespace uu____2236 =
        ...
        | (lid, kind) ->
            (match kind with
             ...
             | Open_module ->
                 let uu____2243 = record_open_module false lid in ()) in
            ...
            then ()
              ...
              (let uu____2331 = FStar_Options.debug_any () in
               ...
               then
                 ...
                 let uu____2333 =
                   let uu____2338 =
                     let uu____2339 = FStar_Ident.string_of_lid module_name in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2339 in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2338) in
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
       let rec collect_module uu___113_2455 =
         match uu___113_2455 with
       ...
       and collect_decl uu___114_2486 =
         match uu___114_2486 with
         ...
         | FStar_Parser_AST.Tycon (uu____2616, tc, ts) ->
             (if tc then record_lid FStar_Parser_Const.mk_class_lid else ();
              (let ts1 =
                 FStar_List.map
                   (fun uu____2649 ->
                      match uu____2649 with | (x, docnik) -> x) ts in
       ...
       and collect_tycon uu___115_2758 =
         match uu___115_2758 with
             ...
             (collect_binders binders;
              ...
              FStar_List.iter
                (fun uu____2831 ->
                   ...
                   | (uu____2840, t, uu____2842) -> collect_term t)
                identterms)
       ...
       and collect_effect_decl uu___116_2931 =
         match uu___116_2931 with
       ...
       and collect_binder uu___117_2957 =
         match uu___117_2957 with
       ...
       and collect_constant uu___118_2980 =
         match uu___118_2980 with
         ...
         | uu____3100 -> ()
       and collect_term' uu___119_3101 =
         match uu___119_3101 with
             ...
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3352 ->
                   ...
                   | (uu____3357, t1) -> collect_term t1) idterms)
       ...
       and collect_pattern' uu___120_3445 =
         match uu___120_3445 with
         ...
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____3499 ->
                  ...
                  | (uu____3504, p) -> collect_pattern p) lidpats
...
let (collect :
  ...
  fun all_cmd_line_files ->
    ...
    (let dep_graph_copy dep_graph1 =
       ...
       | Deps g -> let uu____4077 = FStar_Util.smap_copy g in Deps uu____4077 in
     let cycle_detected dep_graph1 cycle filename =
       ...
       (let uu____4111 =
        ...
        FStar_Errors.raise_err uu____4111) in
             ...
             (match color with
              ...
              | White ->
                  (deps_add_dep dep_graph1 filename (direct_deps1, Gray);
                   ...
                   deps_add_dep dep_graph1 filename (direct_deps1, Black))) in
                        ...
                        (deps_add_dep dep_graph1 filename (direct_deps, Gray);
                         (let uu____4393 =
                            ...
                            all_friend_deps dep_graph1 cycle
                              (all_friends, all_files) uu____4402 in
                              ...
                              (deps_add_dep dep_graph1 filename
                               ...
                               (let uu____4428 =
                                  let uu____4431 =
                                    FStar_List.filter
                                      (fun uu___121_4436 ->
                                         match uu___121_4436 with
                                         | FriendImplementation uu____4437 ->
                                             true
                                         | uu____4438 -> false) direct_deps in
                                  FStar_List.append uu____4431 all_friends1 in
                   ...
                   | Deps dg' ->
                       (FStar_Util.smap_fold dg
                        ...
                        all_friend_deps (Deps dg') [] ([], [])
                          all_command_line_files)) in
            (match uu____4535 with | (uu____4612, all_files) -> all_files) in
          ...
          let interface_hash =
            ...
            then
              let uu____4731 =
                let uu____4736 =
                  let uu____4737 =
                    let uu____4738 = interface_of file_system_map module_name in
            ...
            FStar_List.sortWith
              (fun fn11 ->
                 fun fn2 ->
                   ...
                   FStar_String.compare uu____4779 uu____4780) binary_deps in
          let rec hash_deps out uu___122_4807 =
            match uu___122_4807 with
            | [] ->
                FStar_Pervasives_Native.Some
                  ...
                  then
                    ...
                    (let uu____4850 =
                     ...
                     | FStar_Pervasives_Native.Some fn4 ->
                         ...
                         FStar_Pervasives_Native.Some uu____4857) in
                (match digest with
                 | FStar_Pervasives_Native.None ->
        ...
        (FStar_List.map
           (fun uu____4934 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4941)) in
             ...
             FStar_Option.isSome uu____5123) ||
              (let uu____5127 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name in
               FStar_Option.isNone uu____5127) in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____5154 =
                  let uu____5157 = FStar_ST.op_Bang order in ml_file ::
                    uu____5157 in
                FStar_ST.op_Colon_Equals order uu____5154 in
          let rec aux uu___123_5257 =
            match uu___123_5257 with
            | [] -> ()
                       ...
                       then FStar_Pervasives_Native.None
                         ...
                         (let uu____5513 =
                          ...
                          | FStar_Pervasives_Native.Some iface ->
                              let uu____5524 =
                                let uu____5527 =
                                  let uu____5532 = deps_try_find deps1 iface in
                       ...
                       FStar_Util.map_opt iface_deps
                         (FStar_List.filter
                            (fun iface_dep ->
                               let uu____5557 =
                                 FStar_Util.for_some
                                   (dep_subsumed_by iface_dep) f_deps in
                               Prims.op_Negation uu____5557)) in
                     ...
                     let files1 =
                       ...
                       | FStar_Pervasives_Native.Some iface_deps2 ->
                           let iface_files =
                             FStar_List.map
                               (file_of_dep_aux true file_system_map
                                  all_cmd_line_files) iface_deps2 in
                                  ...
                                  deps_of
                                    (Mk
                                       (deps1, file_system_map,
                                         all_cmd_line_files, all_files)) f in
                                FStar_List.map
                                  (fun x ->
                                     let uu____5675 = output_file ".krml" x in
                                     norm_path uu____5675) uu____5665 in
                        ...
                        then
                          ...
                          (let uu____5756 =
                             (let uu____5759 =
                                ...
                                has_implementation file_system_map uu____5760 in
                        ...
                        let uu____5898 =
                          FStar_List.map
                            (fun dep1 ->
                               ...
                               | (uu____5919, deps3) -> dep1 :: deps3) deps2 in
  ...
  fun deps ->
    ...
    | FStar_Pervasives_Native.Some "graph" ->
        ...
        (match uu____6018 with
         | Mk (deps1, uu____6020, uu____6021, uu____6022) ->
             print_graph deps1)
