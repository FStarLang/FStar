  ...
  fun original_map  ->
    fun filename  ->
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0")  in
       let rec collect_module uu___83_2542 =
         match uu___83_2542 with
       ...
       and collect_decl uu___84_2573 =
         match uu___84_2573 with
       ...
       and collect_tycon uu___85_2810 =
         match uu___85_2810 with
       ...
       and collect_effect_decl uu___86_2983 =
         match uu___86_2983 with
       ...
       and collect_binder uu___87_3009 =
       ...
       and collect_constant uu___88_3026 =
         match uu___88_3026 with
       ...
       and collect_term' uu___89_3146 =
         match uu___89_3146 with
       ...
       and collect_pattern' uu___90_3497 =
         match uu___90_3497 with
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          ...
          let binary_deps1 =
            FStar_List.sortWith
             ...
             in
          let rec hash_deps out uu___91_4542 =
            match uu___91_4542 with
            | [] ->
                FStar_Pervasives_Native.Some
        ...
        let sort_output_files orig_output_file_map =
          ...
          let emit_output_file_opt ml_file_opt =
            ...
            | FStar_Pervasives_Native.Some ml_file ->
             ...
             in
          let rec aux uu___92_4912 =
            match uu___92_4912 with
            | [] -> ()
