...
let lowercase_module_name : Prims.string -> Prims.string =
  fun f  ->
    let uu____204 = module_name_of_file f  in
    FStar_String.lowercase uu____204
          ...
          | PreferInterface key when has_interface file_system_map key ->
              ...
              then
                ...
                (if uu____749
                 then
                   let uu____750 =
                     let uu____751 = implementation_of file_system_map key
                        in
                   ...
                   (let uu____755 =
                      let uu____756 =
                        ...
                        let uu____761 =
                          let uu____762 = interface_of file_system_map key
                             in
    ...
    (let uu____943 =
       let uu____944 =
         let uu____945 =
           let uu____946 =
             let uu____949 =
               let uu____952 = deps_keys graph  in
               FStar_List.unique uu____952  in
             FStar_List.collect
               (fun k  ->
                  let deps =
                    let uu____961 =
                  ...
                  let print7 dep1 =
                    FStar_Util.format2 " %s -> %s" (r k)
                     ...
                     in
                  FStar_List.map print7 deps) uu____949
              in
           FStar_String.concat "\n" uu____946  in
              ...
              then
                let suffix =
                  FStar_String.substring k (FStar_String.length prefix2)
                   ...
                   in
                let filename =
                  let uu____1267 = FStar_Util.smap_try_find original_map k
                     in
...
let namespace_of_lid : FStar_Ident.lident -> Prims.string =
  fun l  ->
    let uu____1458 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns
       in
      ...
      let record_open_module_or_namespace uu____2525 =
        ...
        | (lid,kind) ->
            (match kind with
             ...
             | Open_module  ->
                 let uu____2532 = record_open_module false lid  in ())
         in
             ...
             (match color with
              ...
              | White  ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   ...
                   (let uu____3954 =
                      let uu____3957 = FStar_ST.op_Bang topologically_sorted
                         in
                      filename :: uu____3957  in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3954)))
          in
          ...
          let interface_hash =
            ...
            then
              let uu____4245 =
                let uu____4250 =
                  let uu____4251 =
                    let uu____4252 = interface_of file_system_map module_name
                       in
            ...
            FStar_List.sortWith
              (fun fn1  ->
                 fun fn2  ->
                   ...
                   FStar_String.compare uu____4293 uu____4294) binary_deps
             in
        ...
        (FStar_List.map
           (fun uu____4427  ->
              ...
              | (m,d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4434))
       in
