  ...
  fun original_map  ->
    fun filename  ->
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
       let rec collect_module uu___72_2808 =
         match uu___72_2808 with
       ...
       and collect_decl uu___73_2839 =
         match uu___73_2839 with
       ...
       and collect_tycon uu___74_3094 =
         match uu___74_3094 with
       ...
       and collect_effect_decl uu___75_3267 =
         match uu___75_3267 with
       ...
       and collect_binder uu___76_3293 =
         match uu___76_3293 with
       ...
       and collect_constant uu___77_3310 =
         match uu___77_3310 with
         ...
         | uu____3429 -> ()
       and collect_term' uu___78_3430 =
         match uu___78_3430 with
       ...
       and collect_pattern' uu___79_3716 =
         match uu___79_3716 with
  ...
  fun uu____4430  ->
    fun fn  ->
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          ...
          let rec hash_deps out uu___80_4543 =
            match uu___80_4543 with
            | [] ->
                FStar_Pervasives_Native.Some
