...
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l  ->
    let uu____1440 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns
       in
             ...
             (let uu____2013 =
                ((has_interface original_or_working_map module_name) &&
                  ...
                  (let uu____2015 = FStar_Options.dep ()  in
                   uu____2015 = (FStar_Pervasives_Native.Some "full"))
                 in
              if uu____2013
          ...
          let uu____2081 =
            let uu____2086 =
              ...
              FStar_Util.format1
                ...
                uu____2087
               in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2086)
             in
      ...
      let record_open_module_or_namespace uu____2106 =
        ...
        | (lid,kind) ->
            (match kind with
             ...
             | Open_module  ->
                 let uu____2113 = record_open_module false lid  in ())
         in
            ...
            then ()
              ...
              (let uu____2193 = FStar_Options.debug_any ()  in
               ...
               then
                 let uu____2194 =
                   let uu____2199 =
                     let uu____2200 = FStar_Ident.string_of_lid module_name
                        in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2200
                      in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2199)
                    in
                 FStar_Errors.log_issue (FStar_Ident.range_of_lid lid)
                   uu____2194
               else ())
           ...
           ((let uu____3298 =
               ((is_interface filename) &&
                 ...
                 (let uu____3300 = FStar_Options.dep ()  in
                  uu____3300 = (FStar_Pervasives_Native.Some "full"))
                in
             if uu____3298
             ...
             (match color with
                  ...
                  ((let uu____3573 =
                      let uu____3578 =
                        FStar_Util.format1
                         ...
                         in
                      (FStar_Errors.Warning_RecursiveDependency, uu____3578)
                       in
              ...
              | White  ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   ...
                   (let uu____3590 =
                      let uu____3593 = FStar_ST.op_Bang topologically_sorted
                         in
                      filename :: uu____3593  in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3590)))
          in
          ...
          let interface_hash =
            ...
            then
              let uu____3818 =
                let uu____3823 =
                  let uu____3824 =
                    let uu____3825 = interface_of file_system_map module_name
                       in
                    ...
                    let uu____3854 =
                      (is_interface fn1) &&
                        (let uu____3856 = lowercase_module_name fn1  in
                         uu____3856 = module_name)
                       in
                    Prims.op_Negation uu____3854))
             in
          let binary_deps1 =
            FStar_List.sortWith
              (fun fn1  ->
                 fun fn2  ->
                   ...
                   FStar_String.compare uu____3866 uu____3867) binary_deps
             in
        ...
        (FStar_List.map
           (fun uu____4000  ->
              ...
              | (m,d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4007))
       in
             ...
             FStar_Option.isSome uu____4108) ||
              (let uu____4112 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name
                  in
               FStar_Option.isNone uu____4112)
             in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____4135 =
                  let uu____4138 = FStar_ST.op_Bang order  in ml_file ::
                    uu____4138
                   in
                FStar_ST.op_Colon_Equals order uu____4135
             in
                       ...
                       then
                         ...
                         (let uu____4434 =
                            (let uu____4437 =
                               ...
                               has_implementation file_system_map uu____4438
                                in
