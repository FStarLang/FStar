               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____1369 = lowercase_module_name f1  in
                     uu____1369 = m1) && (is_implementation f1)) filenames
                in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____1520
          in
