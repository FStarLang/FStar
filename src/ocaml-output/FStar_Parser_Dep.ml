                         ...
                         FStar_List.iter
                           (fun uu____636  ->
                              ...
                              | (m,r) ->
                                  let uu____644 =
                                    let uu____645 =
                                      let uu____646 = string_of_lid lid true
                                         in
                                      FStar_String.lowercase uu____646  in
                                    (FStar_String.lowercase m) = uu____645
                                     in
                                  if uu____644
             ...
             and collect_decl uu___88_654 =
               ...
               | FStar_Parser_AST.Tycon (uu____688,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____703  ->
                          match uu____703 with | (x,doc1) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____1377 = lowercase_module_name f1  in
                     uu____1377 = m1) && (is_implementation f1)) filenames
                in
             Prims.op_Negation uu____1375)
           in
                   ...
                   (let all_deps =
                      let uu____1439 =
                        let uu____1441 =
                          FStar_List.map
                            (fun dep1  ->
                               let uu____1446 = discover (key :: cycle) dep1
                                  in
                               dep1 :: uu____1446) direct_deps
                           in
                        FStar_List.flatten uu____1441  in
                      FStar_List.unique uu____1439  in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let uu____1454 =
                       let uu____1456 = FStar_ST.read topologically_sorted
                          in
                       key :: uu____1456  in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____1528
          in
