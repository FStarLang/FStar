...
let rec collect_module = (fun uu___83_1368 -> (match (uu___83_1368) with
...
and collect_decl = (fun uu___84_2481 -> (match (uu___84_2481) with
...
and collect_tycon = (fun uu___85_2680 -> (match (uu___85_2680) with
...
and collect_effect_decl = (fun uu___86_2853 -> (match (uu___86_2853) with
...
and collect_binder = (fun uu___87_2879 -> (match (uu___87_2879) with
...
and collect_constant = (fun uu___88_2896 -> (match (uu___88_2896) with
...
and collect_term' = (fun uu___89_2916 -> (match (uu___89_2916) with
...
and collect_pattern' = (fun uu___90_3202 -> (match (uu___90_3202) with
