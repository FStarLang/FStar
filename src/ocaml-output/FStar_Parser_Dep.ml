              ...
              let uu____754 =
                (cmd_line_has_impl key) &&
                  (let uu____756 = FStar_Options.dep () in
                   FStar_Option.isNone uu____756) in
              if uu____754
              then
                   ...
                   let uu____791 =
                     let uu____796 =
                       FStar_Util.format1
                         ...
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____796) in
                   ...
                   let uu____805 =
                     let uu____810 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____810) in
    ...
    (let uu____965 =
       let uu____966 =
         let uu____967 =
           let uu____968 =
             let uu____971 =
               let uu____974 = deps_keys graph in FStar_List.unique uu____974 in
             FStar_List.collect
               (fun k ->
                  let deps =
                    let uu____983 =
                  ...
                  FStar_List.map print7 deps) uu____971 in
           FStar_String.concat "\n" uu____968 in
         ...
         FStar_List.iter
           (fun k ->
              ...
              then
                ...
                let filename =
                  let uu____1293 = FStar_Util.smap_try_find original_map k in
...
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____1442 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
             ...
             (let uu____1995 =
                ((has_interface original_or_working_map module_name) &&
                  ...
                  (let uu____1997 = FStar_Options.dep () in
                   uu____1997 = (FStar_Pervasives_Native.Some "full")) in
              if uu____1995
          ...
          let uu____2065 =
            let uu____2070 =
              ...
              FStar_Util.format1
                ...
                uu____2071 in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2070) in
      ...
      let record_open_module_or_namespace uu____2090 =
        ...
        | (lid, kind) ->
            (match kind with
             ...
             | Open_module ->
                 let uu____2097 = record_open_module false lid in ()) in
            ...
            then ()
              ...
              (let uu____2179 = FStar_Options.debug_any () in
               ...
               then
                 ...
                 let uu____2181 =
                   let uu____2186 =
                     let uu____2187 = FStar_Ident.string_of_lid module_name in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2187 in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2186) in
             ...
             (collect_binders binders;
              ...
              FStar_List.iter
                (fun uu____2610 ->
                   ...
                   | (uu____2619, t, uu____2621) -> collect_term t)
                identterms)
             ...
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3126 ->
                   ...
                   | (uu____3131, t1) -> collect_term t1) idterms)
         ...
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____3277 ->
                  ...
                  | (uu____3282, p) -> collect_pattern p) lidpats
           ...
           ((let uu____3380 =
               ((is_interface filename) &&
                 ...
                 (let uu____3382 = FStar_Options.dep () in
                  uu____3382 = (FStar_Pervasives_Native.Some "full")) in
             if uu____3380
             ...
             (match color with
              | Gray ->
                  ((let uu____3676 =
                      ...
                      (FStar_Errors.Warning_RecursiveDependency, uu____3681) in
              ...
              | White ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   ...
                   (let uu____3693 =
                      let uu____3696 = FStar_ST.op_Bang topologically_sorted in
                      filename :: uu____3696 in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3693))) in
          ...
          let interface_hash =
            ...
            then
              let uu____3929 =
                let uu____3934 =
                  let uu____3935 =
                    let uu____3936 = interface_of file_system_map module_name in
            ...
            FStar_List.sortWith
              (fun fn11 ->
                 fun fn2 ->
                   ...
                   FStar_String.compare uu____3977 uu____3978) binary_deps in
        ...
        (FStar_List.map
           (fun uu____4111 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4118)) in
             ...
             FStar_Option.isSome uu____4219) ||
              (let uu____4223 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name in
               FStar_Option.isNone uu____4223) in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____4246 =
                  let uu____4249 = FStar_ST.op_Bang order in ml_file ::
                    uu____4249 in
                FStar_ST.op_Colon_Equals order uu____4246 in
                     ...
                     ((let uu____4578 = is_interface f in
                      ...
                      (let uu____4583 = cache_file f in
                       FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____4583
                         norm_f files3);
                      (let uu____4585 =
                         let uu____4586 = output_file ".krml" f in
                         norm_path uu____4586 in
                       let uu____4587 =
                         let uu____4596 =
                           let uu____4597 = output_file ".exe" f in
                           norm_path uu____4597 in
                         let uu____4598 =
                           let uu____4601 =
                             deps_of
                               (Mk
                                  (deps, file_system_map, all_cmd_line_files))
                               f in
                           FStar_List.map
                             (fun x ->
                                let uu____4609 = output_file ".krml" x in
                                norm_path uu____4609) uu____4601 in
                         (uu____4596, uu____4598, false) in
                       FStar_Util.smap_add transitive_krml uu____4585
                         uu____4587);
                      (let uu____4620 = is_implementation f in
                       if uu____4620
                       then
                         ((let uu____4622 = output_ml_file f in
                           let uu____4623 = cache_file f in
                           FStar_Util.print2 "%s: %s\n\n" uu____4622
                             uu____4623);
                          (let cmx_files =
                             let fst_files =
                           ...
                           (let uu____4654 =
                              let uu____4655 = lowercase_module_name f in
                              FStar_Options.should_extract uu____4655 in
                            if uu____4654
                            then
                              let uu____4656 = output_cmx_file f in
                              let uu____4657 = output_ml_file f in
                              FStar_Util.print3 "%s: %s \\\n\t%s\n\n"
                                uu____4656 uu____4657
                                (FStar_String.concat "\\\n\t" cmx_files)
                            else ());
                           (let uu____4659 = output_krml_file f in
                            let uu____4660 = cache_file f in
                            FStar_Util.print2 "%s: %s\n\n" uu____4659
                              uu____4660)))
                       else
                         (let uu____4662 =
                            (let uu____4665 =
                               let uu____4666 = lowercase_module_name f in
                               has_implementation file_system_map uu____4666 in
                             Prims.op_Negation uu____4665) &&
                              (is_interface f) in
                          if uu____4662
                          then
                            let uu____4667 = output_krml_file f in
                            let uu____4668 = cache_file f in
                            FStar_Util.print2 "%s: %s\n\n" uu____4667
                              uu____4668
                          else ())))));
         (let all_fst_files =
            ...
            FStar_All.pipe_right all_fst_files
              (FStar_List.iter
                 (fun fst_file ->
                    ...
                    let uu____4699 = FStar_Options.should_extract mname in
                    if uu____4699
                    then
                      let uu____4700 = output_ml_file fst_file in
                      FStar_Util.smap_add ml_file_map mname uu____4700
                    else ()));
          ...
          let all_krml_files =
            ...
            FStar_All.pipe_right keys
              (FStar_List.iter
                 (fun fst_file ->
                    let mname = lowercase_module_name fst_file in
                    let uu____4716 = output_krml_file fst_file in
                    FStar_Util.smap_add krml_file_map mname uu____4716));
            sort_output_files krml_file_map in
          let rec make_transitive f =
            let uu____4727 =
              let uu____4736 = FStar_Util.smap_try_find transitive_krml f in
              FStar_Util.must uu____4736 in
                   ...
                   (let deps2 =
                      let uu____4799 =
                        let uu____4802 =
                          FStar_List.map
                            (fun dep1 ->
                               let uu____4814 = make_transitive dep1 in
                               match uu____4814 with
                               | (uu____4823, deps2) -> dep1 :: deps2) deps1 in
                        FStar_List.flatten uu____4802 in
                      FStar_List.unique uu____4799 in
