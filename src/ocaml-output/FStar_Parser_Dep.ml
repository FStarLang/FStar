    ...
    let matches =
      FStar_List.map
        (fun ext  ->
           ...
           let uu____46 =
             (l > lext) &&
               (let _0_286 = FStar_String.substring f (l - lext) lext in
                _0_286 = ext) in
           if uu____46
           then
...
let build_map:
  ...
  fun filenames  ->
    ...
    FStar_List.iter
      ...
      include_directories;
    FStar_List.iter
      (fun f  -> let _0_288 = lowercase_module_name f in add_entry _0_288 f)
      filenames;
    map
  ...
  fun original_map  ->
    fun working_map  ->
      fun prefix  ->
        ...
        (let _0_289 = FStar_List.unique (FStar_Util.smap_keys original_map) in
         FStar_List.iter
           (fun k  ->
  ...
  fun l  ->
    fun last  ->
      ...
      let names =
        ...
        FStar_List.append _0_290 suffix in
...
let check_module_declaration_against_filename:
  ...
  fun lid  ->
    fun filename  ->
      ...
      then
        let _0_293 =
          let _0_292 = string_of_lid lid true in [_0_292; filename] in
        ...
        fun original_map  ->
          fun filename  ->
            ...
            let add_dep d =
              let uu____362 =
                Prims.op_Negation
                  (let _0_294 = FStar_ST.read deps in
                   FStar_List.existsb (fun d'  -> d' = d) _0_294) in
              if uu____362
              then
                let _0_296 = let _0_295 = FStar_ST.read deps in d :: _0_295 in
                FStar_ST.write deps _0_296
              else () in
                  ...
                  then
                    (if let_open
                     then
                       ...
                       (let _0_298 =
                          let _0_297 = string_of_lid lid true in [_0_297] in
                        FStar_Util.fprint FStar_Util.stderr
            ...
            let record_lid lid =
              let try_key key =
                ...
                | None  ->
                    ...
                    then
                      let _0_300 =
                        let _0_299 = string_of_lid lid false in [_0_299] in
                      FStar_Util.fprint FStar_Util.stderr
            ...
            let auto_open =
              let uu____495 =
                let _0_301 = FStar_Util.basename filename in
                _0_301 = "prims.fst" in
              if uu____495
              then []
              else
                           ...
                           (fun uu____603  ->
                              ...
                              | (m,r) ->
                                  let uu____611 =
                                    ...
                                    (FStar_String.lowercase m) = _0_302 in
                                  if uu____611
             ...
             and collect_decl uu___118_619 =
               ...
               | FStar_Parser_AST.TopLevelModule lid ->
                   (FStar_Util.incr num_of_toplevelmods;
                    (let uu____687 =
                       let _0_303 = FStar_ST.read num_of_toplevelmods in
                       _0_303 > (Prims.parse_int "1") in
                     if uu____687
                     then
                       Prims.raise
                         (FStar_Errors.Err
                            (let _0_304 = string_of_lid lid true in
                             FStar_Util.format1
...
let print_graph graph =
  ...
  (let _0_309 =
     let _0_308 =
       let _0_307 =
         let _0_306 =
           let _0_305 = FStar_List.unique (FStar_Util.smap_keys graph) in
           FStar_List.collect
             (fun k  ->
                let deps =
                  Prims.fst
   ...
   FStar_Util.write_file "dep.graph" _0_309)
let collect:
  verify_mode ->
    Prims.string Prims.list ->
  ...
  fun verify_mode  ->
    fun filenames  ->
      ...
      let verify_flags =
        let _0_311 = FStar_Options.verify_module () in
        FStar_List.map
          (fun f  -> let _0_310 = FStar_Util.mk_ref false in (f, _0_310))
          _0_311 in
      ...
      let rec discover_one is_user_provided_filename interface_only key =
        let uu____1180 =
          let _0_312 = FStar_Util.smap_try_find graph key in _0_312 = None in
        if uu____1180
        then
      ...
      (let immediate_graph = FStar_Util.smap_copy graph in
                   ...
                   (let all_deps =
                      FStar_List.unique
                        (FStar_List.flatten
                           (FStar_List.map
                              (fun dep  ->
                                 let _0_313 = discover (key :: cycle) dep in
                                 dep :: _0_313) direct_deps)) in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let _0_315 =
                       let _0_314 = FStar_ST.read topologically_sorted in key
                         :: _0_314 in
                     FStar_ST.write topologically_sorted _0_315);
                    all_deps))) in
         ...
         | (Some intf,Some impl) when
             (Prims.op_Negation partial_discovery) &&
               (Prims.op_Negation
                  (FStar_List.existsML
                     (fun f  ->
                        let _0_316 = lowercase_module_name f in _0_316 = k)
                     filenames))
             -> [intf; impl]
         | (Some intf,Some impl) when
             FStar_List.existsML
               (fun f  ->
                  (is_implementation f) &&
                    (let _0_317 = lowercase_module_name f in _0_317 = k))
               filenames
             -> [intf; impl]
       ...
       let by_target =
         let _0_320 =
           let _0_319 = FStar_Util.smap_keys graph in
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   let deps_as_filenames =
                     let _0_318 = FStar_List.collect must_find deps in
                     FStar_List.append _0_318 suffix in
                   (f, deps_as_filenames)) as_list) _0_320 in
       let topologically_sorted =
         let _0_321 = FStar_ST.read topologically_sorted in
         FStar_List.collect must_find_r _0_321 in
       FStar_List.iter
         (fun uu____1404  ->
                ...
                then
                  let maybe_fst =
                    ...
                    then
                      ...
                      FStar_Util.format1 " Did you mean %s ?" _0_323
                    else "" in
                  Prims.raise
                    (FStar_Errors.Err
                       (FStar_Util.format3
