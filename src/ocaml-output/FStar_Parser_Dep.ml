                         ...
                         FStar_List.iter
                           (fun uu____695  ->
                              ...
                              | (m,r) ->
                                  let uu____703 =
                                    let uu____704 =
                                      let uu____705 = string_of_lid lid true
                                         in
                                      FStar_String.lowercase uu____705  in
                                    (FStar_String.lowercase m) = uu____704
                                     in
                                  if uu____703
                           ...
                           (fun uu____722  ->
                              ...
                              | (m,r) ->
                                  let uu____730 =
                                    ...
                                    (FStar_String.lowercase m) = uu____731
                                     in
                                  if uu____730
                                  then FStar_ST.write r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___88_740 =
               ...
               | FStar_Parser_AST.Tycon (uu____779,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____794  ->
                          match uu____794 with | (x,doc1) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____1508 = lowercase_module_name f1  in
                     uu____1508 = m1) && (is_implementation f1)) filenames
                in
                   ...
                   (let all_deps =
                      let uu____1570 =
                        let uu____1572 =
                          FStar_List.map
                            (fun dep1  ->
                               let uu____1577 = discover (key :: cycle) dep1
                                  in
                               dep1 :: uu____1577) direct_deps
                           in
                        FStar_List.flatten uu____1572  in
                      FStar_List.unique uu____1570  in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let uu____1585 =
                       let uu____1587 = FStar_ST.read topologically_sorted
                          in
                       key :: uu____1587  in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____1659
          in
