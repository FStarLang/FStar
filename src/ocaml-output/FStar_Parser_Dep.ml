             ...
             (collect_binders binders;
              ...
              FStar_List.iter
                (fun uu____2597 ->
                   ...
                   | (uu____2606, t, uu____2608) -> collect_term t)
                identterms)
             ...
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3110 ->
                   ...
                   | (uu____3115, t1) -> collect_term t1) idterms)
           ...
           ((let uu____3359 =
               ((is_interface filename) &&
                 ...
                 (let uu____3361 = FStar_Options.dep () in
                  uu____3361 = (FStar_Pervasives_Native.Some "full")) in
             if uu____3359
             ...
             (match color with
              | Gray ->
                  ((let uu____3655 =
                      ...
                      (FStar_Errors.Warning_RecursiveDependency, uu____3660) in
              ...
              | White ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   ...
                   (let uu____3672 =
                      let uu____3675 = FStar_ST.op_Bang topologically_sorted in
                      filename :: uu____3675 in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3672))) in
          ...
          let interface_hash =
            ...
            then
              let uu____3908 =
                let uu____3913 =
                  let uu____3914 =
                    let uu____3915 = interface_of file_system_map module_name in
            ...
            FStar_List.sortWith
              (fun fn11 ->
                 fun fn2 ->
                   ...
                   FStar_String.compare uu____3956 uu____3957) binary_deps in
        ...
        (FStar_List.map
           (fun uu____4090 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4097)) in
             ...
             FStar_Option.isSome uu____4198) ||
              (let uu____4202 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name in
               FStar_Option.isNone uu____4202) in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____4225 =
                  let uu____4228 = FStar_ST.op_Bang order in ml_file ::
                    uu____4228 in
                FStar_ST.op_Colon_Equals order uu____4225 in
                       ...
                       then
                         ...
                         (let uu____4585 =
                            (let uu____4588 =
                               ...
                               has_implementation file_system_map uu____4589 in
