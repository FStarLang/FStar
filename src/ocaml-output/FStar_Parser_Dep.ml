            ...
            let record_open_module_or_namespace uu____780 =
              ...
              | (lid,kind) ->
                  (match kind with
                   ...
                   | Open_module  ->
                       let uu____787 = record_open_module false lid  in ())
               in
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1019 =
                         ...
                         enter_namespace original_map working_map uu____1020
                          in
                       ())
                    else ();
                           ...
                           (fun uu____1036  ->
                              ...
                              | (m,r) ->
                                  let uu____1049 =
                                    ...
                                    (FStar_String.lowercase m) = uu____1050
                                     in
                                  if uu____1049
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1064 =
                         ...
                         enter_namespace original_map working_map uu____1065
                          in
                       ())
                    else ();
                    (match verify_mode with
                           ...
                           (fun uu____1081  ->
                              ...
                              | (m,r) ->
                                  let uu____1094 =
                                    ...
                                    (FStar_String.lowercase m) = uu____1095
                                     in
                                  if uu____1094
                                  then FStar_ST.write r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___86_1107 =
               ...
               | FStar_Parser_AST.Tycon (uu____1160,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____1190  ->
                          match uu____1190 with | (x,docnik) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____2284 = lowercase_module_name f1  in
                     uu____2284 = m1) && (is_implementation f1)) filenames
                in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____2530
          in
