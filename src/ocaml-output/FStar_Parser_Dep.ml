  ...
  fun original_map  ->
    fun filename  ->
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0")  in
       ...
       and collect_term' uu___123_3116 =
         match uu___123_3116 with
       ...
       and collect_pattern' uu___124_3481 =
         match uu___124_3481 with
      ...
      | Mk (deps,file_system_map,all_cmd_line_files,uu____4722) ->
          ...
          let binary_deps1 =
            FStar_List.sortWith
             ...
             in
          let rec hash_deps out uu___126_4841 =
            match uu___126_4841 with
            | [] ->
                FStar_Pervasives_Native.Some
        ...
        let sort_output_files orig_output_file_map =
          ...
          let emit_output_file_opt ml_file_opt =
            ...
            | FStar_Pervasives_Native.Some ml_file ->
             ...
             in
          let rec aux uu___127_5291 =
            match uu___127_5291 with
            | [] -> ()
