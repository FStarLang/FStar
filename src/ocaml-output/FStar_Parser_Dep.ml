...
let _56_51 = (FStar_List.iter (fun f -> (let _138_25 = (lowercase_module_name f)
in (FStar_Util.smap_add map _138_25 f))) filenames)
in map))))))))
...
let _56_63 = (let _138_35 = (let _138_34 = (FStar_Util.smap_keys original_map)
in (FStar_List.unique _138_34))
...
let filename = (let _138_33 = (FStar_Util.smap_try_find original_map k)
in (FStar_Util.must _138_33))
in (
...
let names = (let _138_41 = (FStar_List.map (fun x -> x.FStar_Ident.idText) l.FStar_Ident.ns)
in (FStar_List.append _138_41 suffix))
in (FStar_String.concat "." names))))

# 138 "FStar.Parser.Dep.fst"
let lowercase_join_longident : FStar_Ident.lident  ->  Prims.bool  ->  Prims.string = (fun l last -> (let _138_46 = (string_of_lid l last)
in (FStar_String.lowercase _138_46)))
...
in if ((let _138_53 = (let _138_52 = (let _138_51 = (FStar_Util.basename filename)
in (check_and_strip_suffix _138_51))
in (FStar_Util.must _138_52))
in (FStar_String.lowercase _138_53)) <> k') then begin
(let _138_55 = (let _138_54 = (string_of_lid lid true)
in (_138_54)::(filename)::[])
...
let add_dep = (fun d -> if (not ((let _138_64 = (FStar_ST.read deps)
in (FStar_List.existsb (fun d' -> (d' = d)) _138_64)))) then begin
(let _138_66 = (let _138_65 = (FStar_ST.read deps)
in (d)::_138_65)
in (FStar_ST.op_Colon_Equals deps _138_66))
end else begin
()
end)
in (
...
| Some (filename) -> begin
(let _138_69 = (lowercase_module_name filename)
in (add_dep _138_69))
end
| None -> begin
(
...
(let _138_71 = (let _138_70 = (string_of_lid lid true)
in (_138_70)::[])
...
let me = (let _138_82 = (let _138_81 = (let _138_80 = (FStar_Util.basename filename)
in (check_and_strip_suffix _138_80))
in (FStar_Util.must _138_81))
in (FStar_String.lowercase _138_82))
in (
...
in (FStar_List.filter (fun lid -> ((let _138_88 = (lowercase_join_longident lid true)
in (index_or_length _138_88 ordered)) < my_index)) desired_opens)))))))
in (
...
| Some (filename) -> begin
(let _138_120 = (lowercase_module_name filename)
in (add_dep _138_120))
end
| None -> begin
if (((FStar_List.length lid.FStar_Ident.ns) > 0) && ((FStar_ST.read FStar_Options.debug) <> [])) then begin
(let _138_122 = (let _138_121 = (string_of_lid lid false)
in (_138_121)::[])
...
let filename = (let _138_138 = (FStar_Util.smap_try_find m key)
in (FStar_Util.must _138_138))
in (
...
let _56_519 = (let _138_139 = (FStar_List.map lowercase_module_name filenames)
in (FStar_List.iter discover_one _138_139))
in (
# 424 "FStar.Parser.Dep.fst"
let print_graph = (fun _56_522 -> (match (()) with
| () -> begin
(let _138_148 = (let _138_147 = (FStar_Util.smap_keys graph)
in (FStar_List.unique _138_147))
in (FStar_List.iter (fun k -> (let _138_146 = (let _138_145 = (let _138_144 = (let _138_143 = (FStar_Util.smap_try_find graph k)
in (FStar_Util.must _138_143))
in (Prims.fst _138_144))
in (FStar_String.concat " " _138_145))
in (FStar_Util.print2 "%s: %s\n" k _138_146))) _138_148))
end))
in (
...
let _56_529 = (let _138_151 = (FStar_Util.smap_try_find graph key)
in (FStar_Util.must _138_151))
...
let all_deps = (let _138_155 = (let _138_154 = (FStar_List.map (fun dep -> (let _138_153 = (discover dep)
in (dep)::_138_153)) direct_deps)
in (FStar_List.flatten _138_154))
in (FStar_List.unique _138_155))
in (
# 453 "FStar.Parser.Dep.fst"
let _56_545 = (FStar_Util.smap_add graph key (all_deps, Black))
in (
# 455 "FStar.Parser.Dep.fst"
let _56_547 = (let _138_157 = (let _138_156 = (FStar_ST.read topologically_sorted)
in (key)::_138_156)
in (FStar_ST.op_Colon_Equals topologically_sorted _138_157))
in all_deps))))
end)
end)))
in (
# 460 "FStar.Parser.Dep.fst"
let must_find = (fun k -> (let _138_160 = (FStar_Util.smap_try_find m k)
in (FStar_Util.must _138_160)))
in (
# 463 "FStar.Parser.Dep.fst"
let by_target = (let _138_165 = (FStar_Util.smap_keys graph)
in (FStar_List.map (fun k -> (
# 464 "FStar.Parser.Dep.fst"
let deps = (let _138_162 = (discover k)
in (FStar_List.rev _138_162))
in (let _138_164 = (must_find k)
in (let _138_163 = (FStar_List.map must_find deps)
in (_138_164, _138_163))))) _138_165))
in (
# 467 "FStar.Parser.Dep.fst"
let topologically_sorted = (let _138_166 = (FStar_ST.read topologically_sorted)
in (FStar_List.map must_find _138_166))
