    ...
    let add_entry key full_path =
      ...
      | None  ->
          ...
          (match uu____217 with
           ...
           | uu____224 ->
               FStar_Util.smap_add map key (None, (Some full_path))) in
    FStar_List.iter
      (fun d  ->
  ...
  fun original_map  ->
    fun working_map  ->
      fun prefix  ->
        ...
        (let _0_845 = FStar_List.unique (FStar_Util.smap_keys original_map) in
         FStar_List.iter
           (fun k  ->
              ...
              let uu____362 =
                Prims.op_Negation
                  (let _0_850 = FStar_ST.read deps in
                   FStar_List.existsb (fun d'  -> d' = d) _0_850) in
              match uu____362 with
              | true  ->
                  let _0_852 = let _0_851 = FStar_ST.read deps in d :: _0_851 in
                  ...
                  (match Prims.op_Negation r with
                   | true  ->
                       (match let_open with
                        ...
                        | uu____417 ->
                            let _0_854 =
                              let _0_853 = string_of_lid lid true in [_0_853] in
                            FStar_Util.fprint FStar_Util.stderr
              ...
              let try_key key =
                ...
                | None  ->
                    ...
                    (match uu____487 with
                     | true  ->
                         let _0_856 =
                           let _0_855 = string_of_lid lid false in [_0_855] in
                         FStar_Util.fprint FStar_Util.stderr
  ...
  fun verify_mode  ->
    fun filenames  ->
      ...
      let rec discover_one is_user_provided_filename interface_only key =
        let uu____1180 =
          let _0_868 = FStar_Util.smap_try_find graph key in _0_868 = None in
                        ...
                        (FStar_List.flatten
                           (FStar_List.map
                              (fun dep  ->
                                 ...
                                 dep :: _0_869) direct_deps)) in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let _0_871 =
                       let _0_870 = FStar_ST.read topologically_sorted in key
                         :: _0_870 in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) _0_875 in
