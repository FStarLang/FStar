          ...
          (let num_of_toplevelmods = FStar_Util.mk_ref Prims.int_zero  in
           ...
           and collect_constant uu___9_4537 =
             ...
             | FStar_Const.Const_int
                 (uu____4538,FStar_Pervasives_Native.Some (signedness,width))
                 ->
                 let u =
                 ...
                 let uu____4565 =
                   let uu____4566 =
                     let uu____4572 =
                       ...
                       FStar_All.pipe_right uu____4573 FStar_Ident.lid_of_str
                        in
                     (false, uu____4572)  in
                   P_dep uu____4566  in
           ...
           and collect_term' uu___12_4607 =
             ...
             | FStar_Parser_AST.CalcProof (rel,init,steps) ->
                 ((let uu____5018 =
                     let uu____5019 =
                       let uu____5025 = FStar_Ident.lid_of_str "FStar.Calc"
                          in
                       (false, uu____5025)  in
                     P_dep uu____5019  in
           ...
           | (ast,uu____5195) ->
               (collect_module ast;
                (let pd1 =
                   ...
                   Mk_pd uu____5212  in
                 let uu____5241 = from_parsing_data pd1 original_map filename
                    in
        ...
        fun root_files  ->
          fun widened  ->
                       ...
                       ((let uu____5783 =
                        ...
                        (let uu____5801 =
                           ...
                           all_friend_deps dep_graph1 cycle
                             (all_friends, all_files) uu____5812
                            in
                                 ...
                                 let uu____5861 =
                                   FStar_List.collect
                                     (fun uu___14_5868  ->
                                        ...
                                        | d -> []) dep_node1.edges
                                    in
                                 FStar_List.append uu____5861 all_friends1
                                  in
            ...
            and all_friend_deps dep_graph1 cycle all_friends filenames =
             ...
             in
            let uu____5933 = all_friend_deps dep_graph [] ([], []) root_files
               in
  ...
  fun all_cmd_line_files  ->
    fun get_parsing_data_from_cache  ->
                    ...
                    let uu____6276 =
                      let uu____6282 =
                        FStar_Util.format1 "File %s could not be found\n" fn
                         in
                      (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____6282)
                       in
      ...
      let add_interface_for_inlining l =
        ...
        let uu____6312 =
          let uu____6316 = FStar_ST.op_Bang interfaces_needing_inlining  in
          l1 :: uu____6316  in
      ...
      (let cycle_detected dep_graph1 cycle filename =
         ...
         (let uu____6698 =
          ...
          FStar_Errors.raise_err uu____6698)
          in
       let full_cycle_detection all_command_line_files file_system_map1 =
                ...
                (let uu____6823 = is_interface filename  in
                 ...
                 then
                   let uu____6826 =
                     ...
                     implementation_of_internal file_system_map1 uu____6830
                      in
         ...
         (let uu____6905 = FStar_ST.op_Bang mo_files  in
          FStar_List.iter (aux []) uu____6905)
          in
        ...
        (FStar_List.map
           (fun uu____7103  ->
              ...
              | (m,d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____7117))
       in
...
let (print_full : deps -> unit) =
  fun deps1  ->
    let sort_output_files orig_output_file_map =
         ...
         FStar_Option.isSome uu____7281) ||
          (let uu____7288 =
             FStar_Util.smap_try_find visited_other_modules lc_module_name
              in
           FStar_Option.isNone uu____7288)
         in
        ...
        | FStar_Pervasives_Native.Some ml_file ->
            let uu____7331 =
              let uu____7335 = FStar_ST.op_Bang order  in ml_file ::
                uu____7335
               in
            FStar_ST.op_Colon_Equals order uu____7331
         in
        ...
        | lc_module_name::modules_to_extract ->
            let visit_file file_opt =
              ...
              | FStar_Pervasives_Native.Some file_name1 ->
                  let uu____7426 = deps_try_find deps1.dep_graph file_name1
                     in
      ...
      (let uu____7467 = FStar_ST.op_Bang order  in FStar_List.rev uu____7467)
       in
    let sb =
                      ...
                      | (iface_fn,iface_deps) ->
                          ...
                          let files2 =
                            ...
                            then
                              ...
                              FStar_All.pipe_right uu____7867
                                (fun files2  ->
                                   let uu____7894 = cache_file_name iface_fn1
                                      in
                                   uu____7894 :: files2)
                            else files1  in
                          ...
                          let uu____7928 =
                            ...
                            then
                              profile
                                (fun uu____7958  ->
                                   let uu____7959 = dep_graph_copy dep_graph
                                      in
                                      ...
                                      (let uu____8123 =
                                         let uu____8125 =
                                           lowercase_module_name file_name1
                                            in
                                         has_implementation
                                           deps1.file_system_map uu____8125
                                          in
