        ...
        fun original_map  ->
          fun filename  ->
            ...
            let add_dep d =
              ...
              then
                let uu____890 =
                  let uu____893 = FStar_ST.op_Bang deps  in d :: uu____893
                   in
            ...
            let record_open_module_or_namespace uu____1146 =
              ...
              | (lid,kind) ->
                  (match kind with
                   ...
                   | Open_module  ->
                       let uu____1153 = record_open_module false lid  in ())
               in
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1377 =
                         ...
                         enter_namespace original_map working_map uu____1378
                          in
                       ())
                    else ();
                           ...
                           (fun uu____1486  ->
                              ...
                              | (m,r) ->
                                  let uu____1775 =
                                    ...
                                    (FStar_String.lowercase m) = uu____1776
                                     in
                                  if uu____1775
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1930 =
                         ...
                         enter_namespace original_map working_map uu____1931
                          in
                       ())
                    else ();
                    (match verify_mode with
                           ...
                           (fun uu____2039  ->
                              ...
                              | (m,r) ->
                                  let uu____2328 =
                                    ...
                                    (FStar_String.lowercase m) = uu____2329
                                     in
                                  if uu____2328
                                  then FStar_ST.op_Colon_Equals r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___92_2481 =
               ...
               | FStar_Parser_AST.Tycon (uu____2534,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____2564  ->
                          match uu____2564 with | (x,docnik) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____3813 = lowercase_module_name f1  in
                     uu____3813 = m1) && (is_implementation f1)) filenames
                in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____4179
          in
