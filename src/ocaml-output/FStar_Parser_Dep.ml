          ...
          let uu____1818 =
            let uu____1824 =
              FStar_Util.format1
                ...
                mname in
            (FStar_Errors.Error_AlreadyCachedAssertionFailure, uu____1824) in
              ...
              let uu____1983 =
                (cmd_line_has_impl key) &&
                  (let uu____1986 = FStar_Options.dep () in
                   FStar_Option.isNone uu____1986) in
              if uu____1983
              then
                   ...
                   (let uu____2006 =
                      let uu____2012 =
                        ...
                        FStar_Util.format3
                          ...
                          key uu____2014 uu____2021 in
                      (FStar_Errors.Fatal_MissingExposeInterfacesOption,
                        uu____2012) in
                    FStar_Errors.raise_err uu____2006))
              else
                (let uu____2033 =
                   let uu____2035 = interface_of_internal file_system_map key in
                   FStar_Option.get uu____2035 in
                 maybe_use_cache_of uu____2033)
          | PreferInterface key ->
              let uu____2042 = implementation_of_internal file_system_map key in
                   ...
                   let uu____2048 =
                     let uu____2054 =
                       FStar_Util.format1
                         ...
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2054) in
                   FStar_Errors.raise_err uu____2048
               | FStar_Pervasives_Native.Some f -> maybe_use_cache_of f)
          | UseImplementation key ->
              let uu____2064 = implementation_of_internal file_system_map key in
                   ...
                   let uu____2070 =
                     let uu____2076 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2076) in
                   FStar_Errors.raise_err uu____2070
               | FStar_Pervasives_Native.Some f -> maybe_use_cache_of f)
          | FriendImplementation key ->
              let uu____2086 = implementation_of_internal file_system_map key in
                   ...
                   let uu____2092 =
                     let uu____2098 =
                       FStar_Util.format1
                         "Expected an implementation of module %s, but couldn't find one"
                         key in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2098) in
           ...
           let uu____2187 =
             ...
             FStar_List.collect
               (fun k ->
                  ...
                  FStar_List.map print7 deps) uu____2191 in
           FStar_String.concat "\n" uu____2187 in
          ...
          (fun k ->
             fun uu____2649 ->
               ...
               then
                 ...
                 let filename =
                   let uu____2675 = FStar_Util.smap_try_find original_map k in
...
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____2827 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns in
      ...
      fun get_parsing_data_from_cache ->
        let from_parsing_data pd original_map1 filename1 =
          ...
          let add_dep deps1 d =
            ...
            then
              let uu____3347 =
                let uu____3350 = FStar_ST.op_Bang deps1 in d :: uu____3350 in
          ...
          let add_dependence_edge original_or_working_map lid is_friend =
            ...
            let uu____3441 = resolve_module_name original_or_working_map key in
                 ...
                 (let uu____3481 = FStar_Ident.range_of_lid lid in
                  let uu____3482 =
                    let uu____3488 =
                      ...
                      FStar_Util.format1 "Module not found: %s" uu____3490 in
          ...
          let record_open_module_or_namespace uu____3556 =
            ...
            | (lid, kind) ->
                (match kind with
                 ...
                 | Open_module ->
                     let uu____3563 = record_open_module false lid in ()) in
            ...
            then ()
              ...
              (let uu____3689 = FStar_Options.debug_any () in
               ...
               then
                 ...
                 let uu____3693 =
                   let uu____3699 =
                     let uu____3701 = FStar_Ident.string_of_lid module_name in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____3701 in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____3699) in
          ...
          (let uu____3757 = FStar_ST.op_Bang deps in
           ...
           (uu____3757, uu____3783, mo_roots)) in
        let data_from_cache =
        ...
        then
          ...
          (let num_of_toplevelmods = FStar_Util.mk_ref Prims.int_zero in
           ...
           let add_to_parsing_data elt =
             ...
             then
               let uu____3946 =
                 let uu____3949 = FStar_ST.op_Bang pd in elt :: uu____3949 in
           ...
           and collect_decl d =
                 ...
                 let uu____4150 =
                   let uu____4151 =
                     let uu____4157 =
                       ...
                       FStar_All.pipe_right uu____4158 FStar_Ident.lid_of_str in
                     (true, uu____4157) in
                   P_dep uu____4151 in
             ...
             | FStar_Parser_AST.Tycon (uu____4218, tc, ts) ->
                 (if tc
                  ...
                  (let ts1 =
                     FStar_List.map
                       (fun uu____4257 ->
                          match uu____4257 with | (x, docnik) -> x) ts in
             ...
             | FStar_Parser_AST.TopLevelModule lid ->
                 (FStar_Util.incr num_of_toplevelmods;
                  (let uu____4282 =
                     let uu____4284 = FStar_ST.op_Bang num_of_toplevelmods in
           ...
           and collect_tycon uu___6_4325 =
             ...
             | FStar_Parser_AST.TyconRecord
                 (uu____4352, binders, k, identterms) ->
                 (collect_binders binders;
                  FStar_Util.iter_opt k collect_term;
                  FStar_List.iter
                    (fun uu____4398 ->
           ...
           and collect_constant uu___9_4561 =
             ...
             | FStar_Const.Const_int
                 (uu____4562, FStar_Pervasives_Native.Some
                  (signedness, width))
                 ->
                 let u =
                 ...
                 let uu____4589 =
                   let uu____4590 =
                     let uu____4596 =
                       ...
                       FStar_All.pipe_right uu____4597 FStar_Ident.lid_of_str in
                     (false, uu____4596) in
                   P_dep uu____4590 in
           ...
           and collect_term' uu___12_4631 =
             ...
             | FStar_Parser_AST.CalcProof (rel, init1, steps) ->
                 ((let uu____5042 =
                     let uu____5043 =
                       let uu____5049 = FStar_Ident.lid_of_str "FStar.Calc" in
                       (false, uu____5049) in
                     P_dep uu____5043 in
           ...
           | (ast, uu____5219) ->
               (collect_module ast;
                (let pd1 =
                   ...
                   Mk_pd uu____5236 in
                 let uu____5265 = from_parsing_data pd1 original_map filename in
      ...
      fun interfaces_needing_inlining ->
        fun root_files ->
          fun widened ->
                       ...
                       ((let uu____5807 = FStar_Options.debug_any () in
                        ...
                        (let uu____5824 =
                           ...
                           all_friend_deps dep_graph1 cycle
                             (all_friends, all_files) uu____5835 in
                         ...
                         | (all_friends1, all_files1) ->
                             (deps_add_dep dep_graph1 filename
                              ...
                              (let uu____5873 = FStar_Options.debug_any () in
                               if uu____5873
                                 ...
                                 let uu____5883 =
                                   FStar_List.collect
                                     (fun uu___14_5890 ->
                                        ...
                                        | FriendImplementation m -> [m]
                                        | d -> []) dep_node.edges in
                                 FStar_List.append uu____5883 all_friends1 in
            ...
            let uu____5955 = all_friend_deps dep_graph [] ([], []) root_files in
  ...
  fun all_cmd_line_files ->
    fun get_parsing_data_from_cache ->
             ...
             (fun fn ->
                ...
                | FStar_Pervasives_Native.None ->
                    let uu____6294 =
                      ...
                      (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____6300) in
      ...
      let add_interface_for_inlining l =
        ...
        let uu____6330 =
          let uu____6334 = FStar_ST.op_Bang interfaces_needing_inlining in l1
            :: uu____6334 in
      ...
      (let cycle_detected dep_graph1 cycle filename =
         ...
         (let uu____6716 =
          ...
          FStar_Errors.raise_err uu____6716) in
       let full_cycle_detection all_command_line_files file_system_map1 =
                ...
                (let uu____6841 = is_interface filename in
                 ...
                 then
                   let uu____6844 =
                     ...
                     implementation_of_internal file_system_map1 uu____6848 in
         ...
         (let uu____6923 = FStar_ST.op_Bang mo_files in
          FStar_List.iter (aux []) uu____6923) in
        ...
        (FStar_List.map
           (fun uu____7120 ->
              ...
              | (m, d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____7134)) in
...
let (print_full : deps -> unit) =
  fun deps ->
    let sort_output_files orig_output_file_map =
        ...
        (let uu____7298 =
         ...
         FStar_Option.isSome uu____7298) ||
          (let uu____7305 =
           ...
           FStar_Option.isNone uu____7305) in
        ...
        | FStar_Pervasives_Native.Some ml_file ->
            let uu____7348 =
              let uu____7352 = FStar_ST.op_Bang order in ml_file ::
                uu____7352 in
            FStar_ST.op_Colon_Equals order uu____7348 in
      ...
      (let uu____7484 = FStar_ST.op_Bang order in FStar_List.rev uu____7484) in
    let sb =
                    ...
                    let process_one_key uu____7691 =
                      ...
                      let iface_deps =
                        ...
                        then FStar_Pervasives_Native.None
                          ...
                          (let uu____7714 =
                             let uu____7718 = lowercase_module_name file_name in
                           ...
                           | FStar_Pervasives_Native.Some iface ->
                               let uu____7730 =
                                 ...
                                 uu____7733.edges in
                               FStar_Pervasives_Native.Some uu____7730) in
                      let iface_deps1 =
                      ...
                      let all_checked_files1 =
                        let uu____7816 =
                          let uu____7818 =
                            let uu____7820 = module_name_of_file file_name in
                            FStar_Options.should_be_already_cached uu____7820 in
                          ...
                          ((let uu____7946 = is_implementation file_name in
                            ...
                            then
                              ((let uu____7950 =
                                ...
                                if uu____7950
                                then
                                  ((let uu____7954 = output_ml_file file_name in
                                  ...
                                  ((let uu____7961 = output_ml_file file_name in
                               ...
                               (let cmx_files =
                                ...
                                then
                                  let cmx_files1 =
                                    FStar_String.concat "\\\n\t" cmx_files in
                                  let uu____8013 = output_cmx_file file_name in
                                  let uu____8015 = output_ml_file file_name in
