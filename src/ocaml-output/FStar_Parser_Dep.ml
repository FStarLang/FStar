            ...
            let record_open_module_or_namespace uu____599 =
              ...
              | (lid,kind) ->
                  (match kind with
                   ...
                   | Open_module  ->
                       let uu____604 = record_open_module false lid  in ())
               in
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____780 =
                         ...
                         enter_namespace original_map working_map uu____781
                          in
                       ())
                    else ();
                           ...
                           (fun uu____794  ->
                              ...
                              | (m,r) ->
                                  let uu____802 =
                                    ...
                                    (FStar_String.lowercase m) = uu____803
                                     in
                                  if uu____802
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____821 =
                         ...
                         enter_namespace original_map working_map uu____822
                          in
                       ())
                    else ();
                    (match verify_mode with
                           ...
                           (fun uu____835  ->
                              ...
                              | (m,r) ->
                                  let uu____843 =
                                    ...
                                    (FStar_String.lowercase m) = uu____844
                                     in
                                  if uu____843
                                  then FStar_ST.write r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___86_855 =
               ...
               | FStar_Parser_AST.Tycon (uu____898,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____916  ->
                          match uu____916 with | (x,docnik) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____1650 = lowercase_module_name f1  in
                     uu____1650 = m1) && (is_implementation f1)) filenames
                in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____1808
          in
