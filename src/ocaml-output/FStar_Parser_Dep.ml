...
| (FStar_Parser_AST.Var (lid)) | (FStar_Parser_AST.Projector (lid, _)) | (FStar_Parser_AST.Name (lid)) -> begin
(record_lid false lid)
end
| FStar_Parser_AST.Construct (lid, termimps) -> begin
(

let _70_460 = if (((FStar_List.length termimps) = (Prims.parse_int "1")) && (FStar_Options.universes ())) then begin
(record_lid true lid)
end else begin
()
end
in (FStar_List.iter (fun _70_465 -> (match (_70_465) with
| (t, _70_464) -> begin
(collect_term t)
end)) termimps))
end
...
let _70_470 = (collect_patterns pats)
in (collect_term t))
end
| FStar_Parser_AST.App (t1, t2, _70_475) -> begin
(

let _70_478 = (collect_term t1)
in (collect_term t2))
end
| FStar_Parser_AST.Let (_70_481, patterms, t) -> begin
(

let _70_491 = (FStar_List.iter (fun _70_488 -> (match (_70_488) with
| (pat, t) -> begin
(

let _70_489 = (collect_pattern pat)
in (collect_term t))
end)) patterms)
in (collect_term t))
end
...
let _70_497 = (record_open true lid)
in (collect_term t))
end
| FStar_Parser_AST.Seq (t1, t2) -> begin
(

let _70_503 = (collect_term t1)
in (collect_term t2))
end
| FStar_Parser_AST.If (t1, t2, t3) -> begin
(

let _70_510 = (collect_term t1)
in (

let _70_512 = (collect_term t2)
in (collect_term t3)))
end
| (FStar_Parser_AST.Match (t, bs)) | (FStar_Parser_AST.TryWith (t, bs)) -> begin
(

let _70_520 = (collect_term t)
in (collect_branches bs))
end
| FStar_Parser_AST.Ascribed (t1, t2) -> begin
(

let _70_526 = (collect_term t1)
in (collect_term t2))
end
| FStar_Parser_AST.Record (t, idterms) -> begin
(

let _70_532 = (FStar_Util.iter_opt t collect_term)
in (FStar_List.iter (fun _70_537 -> (match (_70_537) with
| (_70_535, t) -> begin
(collect_term t)
end)) idterms))
end
| FStar_Parser_AST.Project (t, _70_540) -> begin
(collect_term t)
end
| (FStar_Parser_AST.Product (binders, t)) | (FStar_Parser_AST.Sum (binders, t)) -> begin
(

let _70_549 = (collect_binders binders)
in (collect_term t))
end
| (FStar_Parser_AST.QForall (binders, ts, t)) | (FStar_Parser_AST.QExists (binders, ts, t)) -> begin
(

let _70_558 = (collect_binders binders)
in (

let _70_560 = (FStar_List.iter (FStar_List.iter collect_term) ts)
in (collect_term t)))
end
| FStar_Parser_AST.Refine (binder, t) -> begin
(

let _70_566 = (collect_binder binder)
in (collect_term t))
end
| FStar_Parser_AST.NamedTyp (_70_569, t) -> begin
(collect_term t)
end
...
(FStar_List.iter (fun _70_631 -> (match (_70_631) with
| (_70_629, p) -> begin
(collect_pattern p)
end)) lidpats)
end
...
let _70_636 = (collect_pattern p)
in (collect_term t))
end))
and collect_branches = (fun bs -> (FStar_List.iter collect_branch bs))
and collect_branch = (fun _70_642 -> (match (_70_642) with
| (pat, t1, t2) -> begin
(

let _70_643 = (collect_pattern pat)
in (

let _70_645 = (FStar_Util.iter_opt t1 collect_term)
in (collect_term t2)))
end))
in (
...
let _70_651 = (FStar_Util.print_endline "A DOT-format graph has been dumped in the current directory as dep.graph")
in (

let _70_653 = (FStar_Util.print_endline "With GraphViz installed, try: fdp -Tpng -odep.png dep.graph")
in (

let _70_655 = (FStar_Util.print_endline "Hint: cat dep.graph | grep -v _ | grep -v prims")
...
let _70_674 = (let _165_207 = (FStar_Util.smap_try_find m key)
in (FStar_Util.must _165_207))
in (match (_70_674) with
| (intf, impl) -> begin
(
...
let _70_684 = (FStar_Util.smap_add graph key ((deps), (White)))
...
let _70_686 = (let _165_208 = (FStar_List.map lowercase_module_name filenames)
...
let _70_695 = (let _165_213 = (FStar_Util.smap_try_find graph key)
...
let _70_697 = (FStar_Util.print1 "Warning: recursive dependency on module %s\n" key)
in (

let _70_699 = (FStar_Util.print1 "The cycle is: %s \n" (FStar_String.concat " -> " cycle))
in (

let _70_701 = (print_graph immediate_graph)
in (

let _70_703 = (FStar_Util.print_string "\n")
...
let _70_707 = (FStar_Util.smap_add graph key ((direct_deps), (Gray)))
in (
...
let _70_711 = (FStar_Util.smap_add graph key ((all_deps), (Black)))
in (

let _70_713 = (let _165_219 = (let _165_218 = (FStar_ST.read topologically_sorted)
in (key)::_165_218)
...
let _70_733 = (FStar_List.iter (fun _70_732 -> (match (_70_732) with
| (m, r) -> begin
...
let print_make : (Prims.string * Prims.string Prims.list) Prims.list  ->  Prims.unit = (fun deps -> (FStar_List.iter (fun _70_738 -> (match (_70_738) with
| (f, deps) -> begin
(
...
let print = (fun _70_745 -> (match (_70_745) with
| (make_deps, _70_743, graph) -> begin
