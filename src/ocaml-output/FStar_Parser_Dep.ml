    ...
    fun filename  ->
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0")  in
       ...
       and collect_decl uu___58_2297 =
         ...
         | FStar_Parser_AST.Splice (uu____2370,t) -> collect_term t
         | FStar_Parser_AST.Assume (uu____2376,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2378;
               FStar_Parser_AST.mdest = uu____2379;
         ...
         | FStar_Parser_AST.SubEffect
             ...
             -> collect_term t
         | FStar_Parser_AST.Val (uu____2384,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2386;
               FStar_Parser_AST.mdest = uu____2387;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.ReifiableLift
                 (t0,t1);_}
             -> (collect_term t0; collect_term t1)
         | FStar_Parser_AST.Tycon (uu____2391,ts) ->
             let ts1 =
               FStar_List.map
                 (fun uu____2421  -> match uu____2421 with | (x,docnik) -> x)
                 ts
                in
             FStar_List.iter collect_tycon ts1
         | FStar_Parser_AST.Exception (uu____2434,t) ->
             FStar_Util.iter_opt t collect_term
         | FStar_Parser_AST.NewEffect ed -> collect_effect_decl ed
         | FStar_Parser_AST.Fsdoc uu____2441 -> ()
         | FStar_Parser_AST.Pragma uu____2442 -> ()
         | FStar_Parser_AST.TopLevelModule lid ->
             (FStar_Util.incr num_of_toplevelmods;
              (let uu____2478 =
                 let uu____2479 = FStar_ST.op_Bang num_of_toplevelmods  in
                 uu____2479 > (Prims.parse_int "1")  in
               if uu____2478
               then
                 let uu____2521 =
                   let uu____2526 =
                     let uu____2527 = string_of_lid lid true  in
                     FStar_Util.format1
                       "Automatic dependency analysis demands one module per file (module %s not supported)"
                       uu____2527
                      in
                   (FStar_Errors.Fatal_OneModulePerFile, uu____2526)  in
                 FStar_Errors.raise_error uu____2521
                   (FStar_Ident.range_of_lid lid)
               else ()))
       
       and collect_tycon uu___59_2529 =
         match uu___59_2529 with
         | FStar_Parser_AST.TyconAbstract (uu____2530,binders,k) ->
             (collect_binders binders; FStar_Util.iter_opt k collect_term)
         | FStar_Parser_AST.TyconAbbrev (uu____2542,binders,k,t) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              collect_term t)
         | FStar_Parser_AST.TyconRecord (uu____2556,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____2602  ->
                   match uu____2602 with
                   | (uu____2611,t,uu____2613) -> collect_term t) identterms)
         | FStar_Parser_AST.TyconVariant (uu____2618,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____2677  ->
                   match uu____2677 with
                   | (uu____2690,t,uu____2692,uu____2693) ->
                       FStar_Util.iter_opt t collect_term) identterms)
       
       and collect_effect_decl uu___60_2702 =
         match uu___60_2702 with
         | FStar_Parser_AST.DefineEffect (uu____2703,binders,t,decls) ->
             (collect_binders binders; collect_term t; collect_decls decls)
         | FStar_Parser_AST.RedefineEffect (uu____2717,binders,t) ->
             (collect_binders binders; collect_term t)
       
       and collect_binders binders = FStar_List.iter collect_binder binders
       
       and collect_binder uu___61_2728 =
         match uu___61_2728 with
         | { FStar_Parser_AST.b = FStar_Parser_AST.Annotated (uu____2729,t);
             FStar_Parser_AST.brange = uu____2731;
             FStar_Parser_AST.blevel = uu____2732;
             FStar_Parser_AST.aqual = uu____2733;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu____2734,t);
             FStar_Parser_AST.brange = uu____2736;
             FStar_Parser_AST.blevel = uu____2737;
             FStar_Parser_AST.aqual = uu____2738;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.NoName t;
             FStar_Parser_AST.brange = uu____2740;
             FStar_Parser_AST.blevel = uu____2741;
             FStar_Parser_AST.aqual = uu____2742;_} -> collect_term t
         | uu____2743 -> ()
       
       and collect_term t = collect_term' t.FStar_Parser_AST.tm
       
       and collect_constant uu___62_2745 =
         match uu___62_2745 with
         | FStar_Const.Const_int
             (uu____2746,FStar_Pervasives_Native.Some (signedness,width)) ->
             let u =
             ...
             let uu____2761 =
               let uu____2762 = FStar_Util.format2 "fstar.%sint%s" u w  in
               PreferInterface uu____2762  in
             add_dep deps uu____2761
         | FStar_Const.Const_char uu____2796 ->
             add_dep deps (PreferInterface "fstar.char")
         | FStar_Const.Const_float uu____2830 ->
             add_dep deps (PreferInterface "fstar.float")
         | uu____2864 -> ()
       
       and collect_term' uu___63_2865 =
         match uu___63_2865 with
                ...
                (let uu____2874 =
                   let uu____2875 =
                     FStar_Ident.lid_of_path
                       ...
                       FStar_Range.dummyRange
                      in
                   FStar_Parser_AST.Name uu____2875  in
                 collect_term' uu____2874)
              else ();
              FStar_List.iter collect_term ts)
         | FStar_Parser_AST.Tvar uu____2877 -> ()
         | FStar_Parser_AST.Uvar uu____2878 -> ()
         | FStar_Parser_AST.Var lid -> record_lid lid
         | FStar_Parser_AST.Projector (lid,uu____2881) -> record_lid lid
         ...
         | FStar_Parser_AST.Construct (lid,termimps) ->
             (if (FStar_List.length termimps) = (Prims.parse_int "1")
              ...
              FStar_List.iter
                (fun uu____2911  ->
                   match uu____2911 with | (t,uu____2917) -> collect_term t)
                termimps)
         | FStar_Parser_AST.Abs (pats,t) ->
             (collect_patterns pats; collect_term t)
         | FStar_Parser_AST.App (t1,t2,uu____2927) ->
             (collect_term t1; collect_term t2)
         | FStar_Parser_AST.Let (uu____2929,patterms,t) ->
             (FStar_List.iter
                (fun uu____2979  ->
         ...
         | FStar_Parser_AST.Bind (uu____3019,t1,t2) ->
             (collect_term t1; collect_term t2)
         ...
         | FStar_Parser_AST.Record (t,idterms) ->
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3115  ->
                   match uu____3115 with | (uu____3120,t1) -> collect_term t1)
                idterms)
         | FStar_Parser_AST.Project (t,uu____3123) -> collect_term t
         ...
         | FStar_Parser_AST.NamedTyp (uu____3179,t) -> collect_term t
         | FStar_Parser_AST.Paren t -> collect_term t
         | FStar_Parser_AST.Requires (t,uu____3183) -> collect_term t
         | FStar_Parser_AST.Ensures (t,uu____3189) -> collect_term t
         | FStar_Parser_AST.Labeled (t,uu____3195,uu____3196) ->
             collect_term t
         | FStar_Parser_AST.VQuote t -> collect_term t
         | FStar_Parser_AST.Quote uu____3198 -> ()
         | FStar_Parser_AST.Antiquote uu____3203 -> ()
       ...
       and collect_pattern' uu___64_3215 =
         match uu___64_3215 with
         | FStar_Parser_AST.PatWild  -> ()
         | FStar_Parser_AST.PatOp uu____3216 -> ()
         | FStar_Parser_AST.PatConst uu____3217 -> ()
         | FStar_Parser_AST.PatApp (p,ps) ->
             (collect_pattern p; collect_patterns ps)
         | FStar_Parser_AST.PatVar uu____3225 -> ()
         | FStar_Parser_AST.PatName uu____3232 -> ()
         | FStar_Parser_AST.PatTvar uu____3233 -> ()
         | FStar_Parser_AST.PatList ps -> collect_patterns ps
         | FStar_Parser_AST.PatOr ps -> collect_patterns ps
         | FStar_Parser_AST.PatTuple (ps,uu____3247) -> collect_patterns ps
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____3266  ->
                  match uu____3266 with | (uu____3271,p) -> collect_pattern p)
               lidpats
       ...
       and collect_branch uu____3316 =
         ...
         | (pat,t1,t2) ->
             (collect_pattern pat;
              ...
              collect_term t2)
        in
       let uu____3334 = FStar_Parser_Driver.parse_file filename  in
       ...
       | (ast,uu____3354) ->
           ...
           ((let uu____3369 =
               ((is_interface filename) &&
                 ...
                 &&
                 (let uu____3371 = FStar_Options.dep ()  in
                  uu____3371 = (FStar_Pervasives_Native.Some "full"))
                in
             if uu____3369
             then add_dep mo_roots (UseImplementation mname)
             else ());
            collect_module ast;
            (let uu____3411 = FStar_ST.op_Bang deps  in
             let uu____3459 = FStar_ST.op_Bang mo_roots  in
             (uu____3411, uu____3459))))
  ...
  fun all_cmd_line_files  ->
    let all_cmd_line_files1 =
      FStar_All.pipe_right all_cmd_line_files
        (FStar_List.map
           (fun fn  ->
              let uu____3541 = FStar_Options.find_file fn  in
                  ...
                  let uu____3544 =
                    let uu____3549 =
                      FStar_Util.format1 "File %s could not be found\n" fn
                       in
                    (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____3549)  in
                  FStar_Errors.raise_err uu____3544
    ...
    let rec discover_one file_name =
      let uu____3557 =
        let uu____3558 = deps_try_find dep_graph file_name  in
        uu____3558 = FStar_Pervasives_Native.None  in
      if uu____3557
      then
        let uu____3575 = collect_one file_system_map file_name  in
        ...
        | (deps,mo_roots) ->
            ...
            ((let uu____3603 =
                let uu____3608 = FStar_List.unique deps1  in
                (uu____3608, White)  in
              deps_add_dep dep_graph file_name uu____3603);
             (let uu____3613 =
                FStar_List.map
                  (file_of_dep file_system_map all_cmd_line_files1)
                  (FStar_List.append deps1 mo_roots)
                 in
              FStar_List.iter discover_one uu____3613))
      else ()  in
    ...
    (let topological_dependences_of all_command_line_files =
       ...
       let rec aux cycle filename =
         let uu____3646 =
           let uu____3651 = deps_try_find dep_graph filename  in
           FStar_Util.must uu____3651  in
                  ...
                  ((let uu____3665 =
                      let uu____3670 =
                        FStar_Util.format1
                         ...
                         in
                      (FStar_Errors.Warning_RecursiveDependency, uu____3670)
                       in
                    FStar_Errors.log_issue FStar_Range.dummyRange uu____3665);
                   FStar_Util.print1
                  ...
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   (let uu____3676 =
                      dependences_of file_system_map dep_graph
                       ...
                       in
                    FStar_List.iter (fun k  -> aux (k :: cycle) k) uu____3676);
                   deps_add_dep dep_graph filename (direct_deps, Black);
                   (let uu____3682 =
                      let uu____3685 = FStar_ST.op_Bang topologically_sorted
                         in
                      filename :: uu____3685  in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3682)))
          in
     ...
     (let uu____3831 = topological_dependences_of all_cmd_line_files1  in
      (uu____3831, (Mk (dep_graph, file_system_map, all_cmd_line_files1)))))
...
let (hash_dependences :
  ...
  fun uu____3869  ->
    fun fn  ->
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          let fn1 =
            let uu____3887 = FStar_Options.find_file fn  in
            match uu____3887 with
            | FStar_Pervasives_Native.Some fn1 -> fn1
            | uu____3891 -> fn  in
          let cache_file = cache_file_name fn1  in
          let digest_of_file1 fn2 =
            (let uu____3900 = FStar_Options.debug_any ()  in
             if uu____3900
             then
          ...
          let interface_hash =
            ...
            then
              let uu____3918 =
                let uu____3923 =
                  let uu____3924 =
                    let uu____3925 = interface_of file_system_map module_name
                       in
                    FStar_Option.get uu____3925  in
                  digest_of_file1 uu____3924  in
                ("interface", uu____3923)  in
              [uu____3918]
            else []  in
          let binary_deps =
            let uu____3944 =
            ...
            FStar_All.pipe_right uu____3944
              (FStar_List.filter
                 (fun fn2  ->
                    let uu____3954 =
                      (is_interface fn2) &&
                        (let uu____3956 = lowercase_module_name fn2  in
                         uu____3956 = module_name)
                       in
          ...
          let binary_deps1 =
            FStar_List.sortWith
              (fun fn11  ->
                 fun fn2  ->
                   let uu____3966 = lowercase_module_name fn11  in
                   let uu____3967 = lowercase_module_name fn2  in
                   FStar_String.compare uu____3966 uu____3967) binary_deps
             in
          let rec hash_deps out uu___65_3990 =
            match uu___65_3990 with
            | [] ->
                FStar_Pervasives_Native.Some
            ...
            | fn2::deps1 ->
                ...
                then
                  let uu____4034 =
                    let uu____4041 =
                      let uu____4046 = lowercase_module_name fn2  in
                      let uu____4047 = digest_of_file1 cache_fn  in
                      (uu____4046, uu____4047)  in
                    uu____4041 :: out  in
                  hash_deps uu____4034 deps1
                else
                  ((let uu____4054 = FStar_Options.debug_any ()  in
                    if uu____4054
                    then
      ...
      FStar_All.pipe_right dig
        (FStar_List.map
           (fun uu____4100  ->
              ...
              | (m,d) ->
                  let uu____4107 = FStar_Util.base64_encode d  in
                  FStar_Util.format2 "%s:%s" m uu____4107))
       in
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        ...
        FStar_All.pipe_right keys
          (FStar_List.iter
             (fun f  ->
                let uu____4132 =
                  let uu____4137 = deps_try_find deps f  in
                  FStar_All.pipe_right uu____4137 FStar_Option.get  in
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        let sort_output_files orig_output_file_map =
          ...
          let should_visit lc_module_name =
            (let uu____4208 =
               FStar_Util.smap_try_find remaining_output_files lc_module_name
                in
             FStar_Option.isSome uu____4208) ||
              (let uu____4212 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name
                  in
               FStar_Option.isNone uu____4212)
             in
          ...
          let emit_output_file_opt ml_file_opt =
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____4235 =
                  let uu____4238 = FStar_ST.op_Bang order  in ml_file ::
                    uu____4238
                   in
                FStar_ST.op_Colon_Equals order uu____4235
             in
          let rec aux uu___66_4336 =
            match uu___66_4336 with
            | [] -> ()
            | lc_module_name::modules_to_extract ->
                let visit_file file_opt =
                  ...
                  | FStar_Pervasives_Native.Some file_name ->
                      let uu____4352 = deps_try_find deps file_name  in
          ...
          (let uu____4393 = FStar_ST.op_Bang order  in
           FStar_List.rev uu____4393)
           in
        let keys = deps_keys deps  in
        let output_file ext fst_file =
          let ml_base_name =
            let uu____4452 =
              let uu____4453 =
                let uu____4456 = FStar_Util.basename fst_file  in
                check_and_strip_suffix uu____4456  in
              FStar_Option.get uu____4453  in
            FStar_Util.replace_chars uu____4452 46 "_"  in
          FStar_Options.prepend_output_dir (Prims.strcat ml_base_name ext)
           in
        let norm_path s = FStar_Util.replace_chars s 92 "/"  in
        let output_ml_file f =
          let uu____4467 = output_file ".ml" f  in norm_path uu____4467  in
        let output_krml_file f =
          let uu____4472 = output_file ".krml" f  in norm_path uu____4472  in
        let output_cmx_file f =
          let uu____4477 = output_file ".cmx" f  in norm_path uu____4477  in
        let cache_file f =
          let uu____4482 = cache_file_name f  in norm_path uu____4482  in
        (FStar_All.pipe_right keys
           (FStar_List.iter
              (fun f  ->
                 let uu____4504 =
                   let uu____4509 = deps_try_find deps f  in
                   FStar_All.pipe_right uu____4509 FStar_Option.get  in
                 ...
                 | (f_deps,uu____4531) ->
                     ...
                     ((let uu____4547 = is_interface f  in
                       if uu____4547
                       then
                         let uu____4548 =
                           let uu____4549 =
                             FStar_Options.prepend_cache_dir norm_f  in
                           norm_path uu____4549  in
                         FStar_Util.print3
                           "%s.source: %s \\\n\t%s\n\ttouch $@\n\n"
                           uu____4548 norm_f files3
                       else ());
                      (let uu____4552 = cache_file f  in
                       FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____4552
                         norm_f files3);
                      (let uu____4553 = is_implementation f  in
                       if uu____4553
                       then
                         ((let uu____4555 = output_ml_file f  in
                           let uu____4556 = cache_file f  in
                           FStar_Util.print2 "%s: %s\n\n" uu____4555
                             uu____4556);
                          (let cmx_files =
                             let fst_files =
                             ...
                             FStar_All.pipe_right extracted_fst_files
                              ...
                              in
                           (let uu____4587 =
                              let uu____4588 = lowercase_module_name f  in
                              FStar_Options.should_extract uu____4588  in
                            if uu____4587
                            then
                              let uu____4589 = output_cmx_file f  in
                              let uu____4590 = output_ml_file f  in
                              FStar_Util.print3 "%s: %s \\\n\t%s\n\n"
                                uu____4589 uu____4590
                                (FStar_String.concat "\\\n\t" cmx_files)
                            else ());
                           (let uu____4592 = output_krml_file f  in
                            let uu____4593 = cache_file f  in
                            FStar_Util.print2 "%s: %s\n\n" uu____4592
                              uu____4593)))
                       else
                         (let uu____4595 =
                            (let uu____4598 =
                               let uu____4599 = lowercase_module_name f  in
                               has_implementation file_system_map uu____4599
                                in
                          ...
                          if uu____4595
                          then
                            let uu____4600 = output_krml_file f  in
                            let uu____4601 = cache_file f  in
                            FStar_Util.print2 "%s: %s\n\n" uu____4600
                              uu____4601
                          else ())))));
         (let all_fst_files =
            ...
            FStar_All.pipe_right all_fst_files
              (FStar_List.iter
                 (fun fst_file  ->
                    ...
                    let uu____4632 = FStar_Options.should_extract mname  in
                    if uu____4632
                    then
                      let uu____4633 = output_ml_file fst_file  in
                      FStar_Util.smap_add ml_file_map mname uu____4633
                    else ()));
          ...
          let all_krml_files =
            ...
            FStar_All.pipe_right keys
              (FStar_List.iter
                 (fun fst_file  ->
                    let mname = lowercase_module_name fst_file  in
                    let uu____4649 = output_krml_file fst_file  in
                    FStar_Util.smap_add krml_file_map mname uu____4649));
            sort_output_files krml_file_map  in
          (let uu____4651 =
             let uu____4652 =
               FStar_All.pipe_right all_fst_files (FStar_List.map norm_path)
                in
             FStar_All.pipe_right uu____4652 (FStar_String.concat " \\\n\t")
              in
