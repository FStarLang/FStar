        ...
        ((let uu____1782 =
         ...
         (let uu____1812 =
            (FStar_Util.file_exists expected_cache_file) &&
              (FStar_Util.paths_to_same_file path expected_cache_file)
             in
          if uu____1812 then expected_cache_file else path))
    | FStar_Pervasives_Native.None  ->
        let uu____1819 =
          ...
          let uu____1825 =
            let uu____1831 =
              FStar_Util.format1
                ...
                mname
               in
            (FStar_Errors.Error_AlreadyCachedAssertionFailure, uu____1831)
             in
          FStar_Errors.raise_err uu____1825
        else FStar_Options.prepend_cache_dir cache_fn
     in
  let memo = FStar_Util.smap_create (Prims.of_int (100))  in
  let memo1 f x =
    let uu____1867 = FStar_Util.smap_try_find memo x  in
...
let (parsing_data_of : deps -> Prims.string -> parsing_data) =
  fun deps1  ->
    fun fn  ->
      let uu____1894 = FStar_Util.smap_try_find deps1.parse_results fn  in
      FStar_All.pipe_right uu____1894 FStar_Util.must
    ...
    fun file_system_map  ->
      fun all_cmd_line_files  ->
        fun d  ->
              ...
              (FStar_Util.for_some
                 (fun fn  ->
                    (is_implementation fn) &&
                      (let uu____1948 = lowercase_module_name fn  in
                       key = uu____1948)))
             in
          ...
          match d with
          | UseInterface key ->
              let uu____1967 = interface_of_internal file_system_map key  in
                   ...
                   let uu____1974 =
                     let uu____1980 =
                       FStar_Util.format1
                         ...
                         key
                        in
                     (FStar_Errors.Fatal_MissingInterface, uu____1980)  in
                   FStar_Errors.raise_err uu____1974
               | FStar_Pervasives_Native.Some f -> f)
          | PreferInterface key when has_interface file_system_map key ->
              let uu____1990 =
                (cmd_line_has_impl key) &&
                  (let uu____1993 = FStar_Options.dep ()  in
                   FStar_Option.isNone uu____1993)
                 in
              if uu____1990
              then
                let uu____2000 = FStar_Options.expose_interfaces ()  in
                (if uu____2000
                 then
                   let uu____2004 =
                     let uu____2006 =
                       implementation_of_internal file_system_map key  in
                     FStar_Option.get uu____2006  in
                   maybe_use_cache_of uu____2004
                 else
                   (let uu____2013 =
                      let uu____2019 =
                        let uu____2021 =
                        ...
                        let uu____2028 =
                          ...
                          FStar_Option.get uu____2030  in
                        FStar_Util.format3
                          "You may have a cyclic dependence on module %s: use --dep full to confirm. Alternatively, invoking fstar with %s on the command line breaks the abstraction imposed by its interface %s; if you really want this behavior add the option '--expose_interfaces'"
                          key uu____2021 uu____2028
                         in
                ...
                (let uu____2040 =
                   let uu____2042 = interface_of_internal file_system_map key
                      in
                   FStar_Option.get uu____2042  in
                 maybe_use_cache_of uu____2040)
          | PreferInterface key ->
              let uu____2049 = implementation_of_internal file_system_map key
                 in
                   ...
                   let uu____2055 =
                     let uu____2061 =
                       FStar_Util.format1
                         ...
                         key
                        in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2061)
                      in
                   FStar_Errors.raise_err uu____2055
               | FStar_Pervasives_Native.Some f -> maybe_use_cache_of f)
          | UseImplementation key ->
              let uu____2071 = implementation_of_internal file_system_map key
                 in
                   ...
                   let uu____2077 =
                     let uu____2083 =
                       FStar_Util.format1
                         ...
                         key
                        in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2083)
                      in
                   FStar_Errors.raise_err uu____2077
               | FStar_Pervasives_Native.Some f -> maybe_use_cache_of f)
          | FriendImplementation key ->
              let uu____2093 = implementation_of_internal file_system_map key
                 in
                   ...
                   let uu____2099 =
                     let uu____2105 =
                       FStar_Util.format1
                         ...
                         key
                        in
                     (FStar_Errors.Fatal_MissingImplementation, uu____2105)
                      in
                   FStar_Errors.raise_err uu____2099
               | FStar_Pervasives_Native.Some f -> maybe_use_cache_of f)
...
let (dependences_of :
  ...
  fun file_system_map  ->
    fun deps1  ->
      fun all_cmd_line_files  ->
        fun fn  ->
          let uu____2166 = deps_try_find deps1 fn  in
          match uu____2166 with
          | FStar_Pervasives_Native.None  -> empty_dependences ()
          | FStar_Pervasives_Native.Some
              { edges = deps2; color = uu____2174;_} ->
              let uu____2175 =
                FStar_List.map
    ...
    (let uu____2203 =
       let uu____2205 =
         let uu____2207 =
           let uu____2209 =
             let uu____2213 =
               let uu____2217 = deps_keys graph  in
               FStar_List.unique uu____2217  in
             FStar_List.collect
               (fun k  ->
                  let deps1 =
                    let uu____2231 =
                      let uu____2232 = deps_try_find graph k  in
                      FStar_Util.must uu____2232  in
                    uu____2231.edges  in
                  let r s = FStar_Util.replace_char s 46 95  in
                  let print dep =
                    let uu____2253 =
                      let uu____2255 = lowercase_module_name k  in
                      r uu____2255  in
                    FStar_Util.format2 "  \"%s\" -> \"%s\"" uu____2253
                      (r (module_name_of_dep dep))
                     in
                  FStar_List.map print deps1) uu____2213
              in
           FStar_String.concat "\n" uu____2209  in
         FStar_String.op_Hat uu____2207 "\n}\n"  in
       FStar_String.op_Hat "digraph {\n" uu____2205  in
     FStar_Util.write_file "dep.graph" uu____2203)
...
let (build_inclusion_candidates_list :
  ...
  fun uu____2276  ->
    ...
    let cwd =
      let uu____2302 = FStar_Util.getcwd ()  in
      FStar_Util.normalize_file_path uu____2302  in
         ...
         then
           ...
           FStar_List.filter_map
             (fun f  ->
                ...
                let uu____2342 = check_and_strip_suffix f1  in
           ...
           (let uu____2379 =
              let uu____2385 =
                FStar_Util.format1 "not a valid include directory: %s\n" d
                 in
              (FStar_Errors.Fatal_NotValidIncludeDirectory, uu____2385)  in
            FStar_Errors.raise_err uu____2379)) include_directories2
  
let (build_map : Prims.string Prims.list -> files_for_module_name) =
  fun filenames  ->
    let map = FStar_Util.smap_create (Prims.of_int (41))  in
    let add_entry key full_path =
      let uu____2448 = FStar_Util.smap_try_find map key  in
      match uu____2448 with
      | FStar_Pervasives_Native.Some (intf,impl) ->
          let uu____2495 = is_interface full_path  in
          if uu____2495
          then
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____2544 = is_interface full_path  in
          if uu____2544
          then
            FStar_Util.smap_add map key
            ...
            FStar_Util.smap_add map key
              (FStar_Pervasives_Native.None,
                (FStar_Pervasives_Native.Some full_path))
       in
    (let uu____2586 = build_inclusion_candidates_list ()  in
     FStar_List.iter
       (fun uu____2604  ->
    ...
    FStar_List.iter
      (fun f  ->
         let uu____2623 = lowercase_module_name f  in add_entry uu____2623 f)
      filenames;
    map
               ...
               then
                 let suffix =
                   FStar_String.substring k (FStar_String.length prefix1)
                    ...
                    in
                 let filename =
                   let uu____2697 = FStar_Util.smap_try_find original_map k
                      in
                   FStar_Util.must uu____2697  in
      ...
      let names =
        let uu____2817 =
          FStar_List.map (fun x  -> x.FStar_Ident.idText) l.FStar_Ident.ns
           in
        FStar_List.append uu____2817 suffix  in
...
let (lowercase_join_longident :
  ...
  fun l  ->
    fun last  ->
      let uu____2840 = string_of_lid l last  in
      FStar_String.lowercase uu____2840
  
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l  ->
    let uu____2849 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns
       in
    FStar_String.concat "_" uu____2849
    ...
    fun filename  ->
      ...
      let uu____2871 =
        let uu____2873 =
          let uu____2875 =
            let uu____2877 =
              let uu____2881 = FStar_Util.basename filename  in
              check_and_strip_suffix uu____2881  in
            FStar_Util.must uu____2877  in
          FStar_String.lowercase uu____2875  in
        uu____2873 <> k'  in
      if uu____2871
      then
        let uu____2886 = FStar_Ident.range_of_lid lid  in
        let uu____2887 =
          let uu____2893 =
            let uu____2895 = string_of_lid lid true  in
            FStar_Util.format2
              "The module declaration \"module %s\" found in file %s does not match its filename. Dependencies will be incorrect and the module will not be verified.\n"
              uu____2895 filename
             in
          (FStar_Errors.Error_ModuleFileNameMismatch, uu____2893)  in
        FStar_Errors.log_issue uu____2886 uu____2887
      else ()
  
exception Exit 
let (uu___is_Exit : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with | Exit  -> true | uu____2911 -> false
  
let (core_modules : Prims.string Prims.list) =
  let uu____2917 =
    let uu____2921 = FStar_Options.prims_basename ()  in
    let uu____2923 =
      let uu____2927 = FStar_Options.pervasives_basename ()  in
      let uu____2929 =
        let uu____2933 = FStar_Options.pervasives_native_basename ()  in
        [uu____2933]  in
      uu____2927 :: uu____2929  in
    uu____2921 :: uu____2923  in
  FStar_All.pipe_right uu____2917 (FStar_List.map module_name_of_file) 
let (hard_coded_dependencies :
  Prims.string -> (FStar_Ident.lident * open_kind) Prims.list) =
  fun full_filename  ->
    let filename = FStar_Util.basename full_filename  in
    let uu____2963 =
      let uu____2965 = module_name_of_file filename  in
      FStar_List.mem uu____2965 core_modules  in
    if uu____2963
    then []
    else
      (let implicit_deps =
       ...
       let uu____3004 =
         let uu____3007 = lowercase_module_name full_filename  in
         namespace_of_module uu____3007  in
    ...
    fun filename  ->
      fun get_parsing_data_from_cache  ->
        let from_parsing_data pd original_map1 filename1 =
          ...
          let mo_roots =
            ...
            let uu____3164 =
              (is_interface filename1) &&
               ...
               in
            if uu____3164 then [UseImplementation mname] else []  in
          let auto_open =
            let uu____3174 = hard_coded_dependencies filename1  in
          ...
          let set_interface_inlining uu____3231 =
            let uu____3232 = is_interface filename1  in
            if uu____3232
          ...
          let add_dep deps2 d =
            let uu____3354 =
              let uu____3356 =
                let uu____3358 = FStar_ST.op_Bang deps2  in
                FStar_List.existsML (dep_subsumed_by d) uu____3358  in
              Prims.op_Negation uu____3356  in
            if uu____3354
            then
              let uu____3385 =
                let uu____3388 = FStar_ST.op_Bang deps2  in d :: uu____3388
                 in
              FStar_ST.op_Colon_Equals deps2 uu____3385
            else ()  in
          ...
          let add_dependence_edge original_or_working_map lid is_friend =
            ...
            let uu____3479 = resolve_module_name original_or_working_map key
               in
          ...
          let record_open_module let_open lid =
            ...
            then true
              ...
              (if let_open
               then
                 (let uu____3519 = FStar_Ident.range_of_lid lid  in
                  let uu____3520 =
                    let uu____3526 =
                      let uu____3528 = string_of_lid lid true  in
                      FStar_Util.format1 "Module not found: %s" uu____3528
                       in
                    (FStar_Errors.Warning_ModuleOrFileNotFoundWarning,
                      uu____3526)
                     in
                  FStar_Errors.log_issue uu____3519 uu____3520)
               else ();
               false)
             in
          let record_open_namespace lid =
            ...
            then
              let uu____3548 = FStar_Ident.range_of_lid lid  in
              let uu____3549 =
                let uu____3555 =
                  let uu____3557 = string_of_lid lid true  in
                  FStar_Util.format1
                ...
                (FStar_Errors.Warning_ModuleOrFileNotFoundWarning,
                  uu____3555)
                 in
              FStar_Errors.log_issue uu____3548 uu____3549
            else ()  in
          let record_open let_open lid =
            let uu____3577 = record_open_module let_open lid  in
            if uu____3577
            then ()
            else
             ...
             in
          let record_open_module_or_namespace uu____3594 =
            match uu____3594 with
            | (lid,kind) ->
                (match kind with
                 | Open_namespace  -> record_open_namespace lid
                 | Open_module  ->
                     let uu____3601 = record_open_module false lid  in ())
             in
          let record_module_alias ident lid =
            let key =
              let uu____3618 = FStar_Ident.text_of_id ident  in
              FStar_String.lowercase uu____3618  in
            let alias = lowercase_join_longident lid true  in
            let uu____3623 = FStar_Util.smap_try_find original_map1 alias  in
            match uu____3623 with
            | FStar_Pervasives_Native.Some deps_of_aliased_module ->
                (FStar_Util.smap_add working_map key deps_of_aliased_module;
                 (let uu____3680 =
                    let uu____3681 = lowercase_join_longident lid true  in
                    dep_edge uu____3681 false  in
                  add_dep deps1 uu____3680);
                 true)
            | FStar_Pervasives_Native.None  ->
                ((let uu____3697 = FStar_Ident.range_of_lid lid  in
                  let uu____3698 =
                    ...
                    (FStar_Errors.Warning_ModuleOrFileNotFoundWarning,
                      uu____3704)
                     in
                  FStar_Errors.log_issue uu____3697 uu____3698);
                 false)
             in
          let add_dep_on_module module_name1 is_friend =
            ...
            then ()
              ...
              (let uu____3727 =
               ...
               if uu____3727
               then
                 let uu____3731 = FStar_Ident.range_of_lid module_name1  in
                 let uu____3732 =
                   let uu____3738 =
                     let uu____3740 = FStar_Ident.string_of_lid module_name1
                        in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____3740
                      in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____3738)
                    in
                 FStar_Errors.log_issue uu____3731 uu____3732
               else ())
             in
          let record_lid lid =
            match lid.FStar_Ident.ns with
          ...
          let begin_module lid =
            ...
            then
              let uu____3765 =
                let uu____3767 = namespace_of_lid lid  in
                enter_namespace original_map1 working_map uu____3767  in
              ()
            else ()  in
          (match pd with
           | Mk_pd l ->
               FStar_All.pipe_right (FStar_List.append auto_open l)
                 (FStar_List.iter
                    (fun elt  ->
                       ...
                       | P_alias (id,lid) ->
                           let uu____3793 = record_module_alias id lid  in ()
                       | P_lid lid -> record_lid lid
                       | P_inline_for_extraction  ->
                           set_interface_inlining ())));
          (let uu____3796 = FStar_ST.op_Bang deps1  in
           let uu____3822 = FStar_ST.op_Bang has_inline_for_extraction  in
           (uu____3796, uu____3822, mo_roots))
           in
        let data_from_cache =
        ...
        then
          ((let uu____3876 =
           ...
           (let uu____3883 =
              ...
              from_parsing_data uu____3895 original_map filename  in
            match uu____3883 with
            | (deps1,has_inline_for_extraction,mo_roots) ->
                let uu____3924 =
                  FStar_All.pipe_right data_from_cache FStar_Util.must  in
                (uu____3924, deps1, has_inline_for_extraction, mo_roots)))
        else
          (let num_of_toplevelmods = FStar_Util.mk_ref Prims.int_zero  in
           ...
           let add_to_parsing_data elt =
             let uu____3953 =
               let uu____3955 =
                 let uu____3957 = FStar_ST.op_Bang pd  in
             ...
             then
               let uu____3986 =
                 let uu____3989 = FStar_ST.op_Bang pd  in elt :: uu____3989
                  in
               FStar_ST.op_Colon_Equals pd uu____3986
             else ()  in
           let rec collect_module uu___5_4146 =
             match uu___5_4146 with
             | FStar_Parser_AST.Module (lid,decls) ->
                 (check_module_declaration_against_filename lid filename;
                  add_to_parsing_data (P_begin_module lid);
                  collect_decls decls)
             | FStar_Parser_AST.Interface (lid,decls,uu____4157) ->
                 (check_module_declaration_against_filename lid filename;
                  add_to_parsing_data (P_begin_module lid);
                  collect_decls decls)
             ...
             FStar_List.iter
               (fun x  ->
                  ...
                  (match x.FStar_Parser_AST.d with
                   | FStar_Parser_AST.Val uu____4176 when
                       FStar_List.contains
           ...
           and collect_decl d =
             ...
             | FStar_Parser_AST.Friend lid ->
                 let uu____4190 =
                   let uu____4191 =
                     let uu____4197 =
                       let uu____4198 = lowercase_join_longident lid true  in
                       FStar_All.pipe_right uu____4198 FStar_Ident.lid_of_str
                        in
                     (true, uu____4197)  in
                   P_dep uu____4191  in
                 add_to_parsing_data uu____4190
             | FStar_Parser_AST.ModuleAbbrev (ident,lid) ->
                 add_to_parsing_data (P_alias (ident, lid))
             | FStar_Parser_AST.TopLevelLet (uu____4206,patterms) ->
                 FStar_List.iter
                   (fun uu____4228  ->
             ...
             | FStar_Parser_AST.Splice (uu____4237,t) -> collect_term t
             | FStar_Parser_AST.Assume (uu____4243,t) -> collect_term t
             | FStar_Parser_AST.SubEffect
                 ...
                 -> collect_term t
             | FStar_Parser_AST.SubEffect
                 { FStar_Parser_AST.msource = uu____4248;
                   FStar_Parser_AST.mdest = uu____4249;
                   FStar_Parser_AST.lift_op = FStar_Parser_AST.LiftForFree t;_}
                 -> collect_term t
             | FStar_Parser_AST.Val (uu____4251,t) -> collect_term t
             | FStar_Parser_AST.SubEffect
             ...
             | FStar_Parser_AST.Tycon (uu____4258,tc,ts) ->
                 (if tc
                  then
                    add_to_parsing_data
             ...
             | FStar_Parser_AST.Exception (uu____4273,t) ->
                 FStar_Util.iter_opt t collect_term
             | FStar_Parser_AST.NewEffect ed -> collect_effect_decl ed
             | FStar_Parser_AST.LayeredEffect ed -> collect_effect_decl ed
             | FStar_Parser_AST.Polymonadic_bind
                 (uu____4281,uu____4282,uu____4283,bind) -> collect_term bind
             | FStar_Parser_AST.Pragma uu____4285 -> ()
             | FStar_Parser_AST.TopLevelModule lid ->
                 (FStar_Util.incr num_of_toplevelmods;
                  (let uu____4288 =
                     let uu____4290 = FStar_ST.op_Bang num_of_toplevelmods
                        in
                     uu____4290 > Prims.int_one  in
                   if uu____4288
                   then
                     let uu____4315 =
                       let uu____4321 =
                         let uu____4323 = string_of_lid lid true  in
                         FStar_Util.format1
                           "Automatic dependency analysis demands one module per file (module %s not supported)"
                           uu____4323
                          in
                       (FStar_Errors.Fatal_OneModulePerFile, uu____4321)  in
                     let uu____4328 = FStar_Ident.range_of_lid lid  in
                     FStar_Errors.raise_error uu____4315 uu____4328
                   else ()))
           
           and collect_tycon uu___6_4331 =
             match uu___6_4331 with
             | FStar_Parser_AST.TyconAbstract (uu____4332,binders,k) ->
                 (collect_binders binders; FStar_Util.iter_opt k collect_term)
             | FStar_Parser_AST.TyconAbbrev (uu____4344,binders,k,t) ->
                 (collect_binders binders;
                  FStar_Util.iter_opt k collect_term;
                  collect_term t)
             | FStar_Parser_AST.TyconRecord (uu____4358,binders,k,identterms)
                 ->
                 (collect_binders binders;
                  FStar_Util.iter_opt k collect_term;
                  FStar_List.iter
                    (fun uu____4391  ->
                       ...
                       | (uu____4396,t) -> collect_term t) identterms)
             | FStar_Parser_AST.TyconVariant
                 (uu____4398,binders,k,identterms) ->
                 (collect_binders binders;
                  FStar_Util.iter_opt k collect_term;
                  FStar_List.iter
                    (fun uu____4447  ->
                       match uu____4447 with
                       | (uu____4457,t,uu____4459) ->
                           FStar_Util.iter_opt t collect_term) identterms)
           
           and collect_effect_decl uu___7_4466 =
             match uu___7_4466 with
             | FStar_Parser_AST.DefineEffect (uu____4467,binders,t,decls) ->
                 (collect_binders binders;
                  collect_term t;
                  collect_decls decls)
             | FStar_Parser_AST.RedefineEffect (uu____4481,binders,t) ->
           ...
           and collect_aqual uu___8_4515 =
             match uu___8_4515 with
           ...
           and collect_constant uu___9_4523 =
             match uu___9_4523 with
             | FStar_Const.Const_int
                 (uu____4524,FStar_Pervasives_Native.Some (signedness,width))
                 ->
                 let u =
                 ...
                 let uu____4551 =
                   let uu____4552 =
                     let uu____4558 =
                       ...
                       FStar_All.pipe_right uu____4559 FStar_Ident.lid_of_str
                        in
                     (false, uu____4558)  in
                   P_dep uu____4552  in
                 add_to_parsing_data uu____4551
             | FStar_Const.Const_char uu____4565 ->
                 let uu____4567 =
                   let uu____4568 =
                     let uu____4574 =
                     ...
                     (false, uu____4574)  in
                   P_dep uu____4568  in
                 add_to_parsing_data uu____4567
             | FStar_Const.Const_float uu____4579 ->
                 let uu____4580 =
                   let uu____4581 =
                     let uu____4587 =
           ...
           and collect_term' uu___12_4593 =
             match uu___12_4593 with
             | FStar_Parser_AST.Wild  -> ()
             | FStar_Parser_AST.Const c -> collect_constant c
             | FStar_Parser_AST.Op (s,ts) ->
                 ((let uu____4602 =
                     let uu____4604 = FStar_Ident.text_of_id s  in
                     uu____4604 = "@"  in
                   if uu____4602
                   then
                     let uu____4609 =
                       let uu____4610 =
                         let uu____4611 =
                           FStar_Ident.path_of_text
                            ...
                            in
                         FStar_Ident.lid_of_path uu____4611
                           FStar_Range.dummyRange
                          in
                       FStar_Parser_AST.Name uu____4610  in
                     collect_term' uu____4609
                   else ());
                  FStar_List.iter collect_term ts)
             | FStar_Parser_AST.Tvar uu____4615 -> ()
             | FStar_Parser_AST.Uvar uu____4616 -> ()
             | FStar_Parser_AST.Var lid -> add_to_parsing_data (P_lid lid)
             | FStar_Parser_AST.Projector (lid,uu____4619) ->
                 ...
                 (add_to_parsing_data (P_lid lid);
                  FStar_List.iter
                    (fun uu____4644  ->
                       ...
                       | (t,uu____4650) -> collect_term t) termimps)
             | FStar_Parser_AST.Abs (pats,t) ->
                 (collect_patterns pats; collect_term t)
             | FStar_Parser_AST.App (t1,t2,uu____4660) ->
                 (collect_term t1; collect_term t2)
             | FStar_Parser_AST.Let (uu____4662,patterms,t) ->
                 (FStar_List.iter
                    (fun uu____4712  ->
             ...
             | FStar_Parser_AST.Bind (uu____4752,t1,t2) ->
                 (collect_term t1; collect_term t2)
                 ...
                 (FStar_Util.iter_opt t collect_term;
                  FStar_List.iter
                    (fun uu____4848  ->
                       ...
                       | (uu____4853,t1) -> collect_term t1) idterms)
             | FStar_Parser_AST.Project (t,uu____4856) -> collect_term t
             | FStar_Parser_AST.Product (binders,t) ->
                 (collect_binders binders; collect_term t)
             | FStar_Parser_AST.Sum (binders,t) ->
                 (FStar_List.iter
                    (fun uu___10_4885  ->
                       match uu___10_4885 with
                       | FStar_Util.Inl b -> collect_binder b
                       | FStar_Util.Inr t1 -> collect_term t1) binders;
                  collect_term t)
             | FStar_Parser_AST.QForall (binders,(uu____4893,ts),t) ->
                 (collect_binders binders;
                  FStar_List.iter (FStar_List.iter collect_term) ts;
                  collect_term t)
             | FStar_Parser_AST.QExists (binders,(uu____4927,ts),t) ->
                 (collect_binders binders;
                  FStar_List.iter (FStar_List.iter collect_term) ts;
                  collect_term t)
             | FStar_Parser_AST.Refine (binder,t) ->
                 (collect_binder binder; collect_term t)
             | FStar_Parser_AST.NamedTyp (uu____4963,t) -> collect_term t
             | FStar_Parser_AST.Paren t -> collect_term t
             | FStar_Parser_AST.Requires (t,uu____4967) -> collect_term t
             | FStar_Parser_AST.Ensures (t,uu____4975) -> collect_term t
             | FStar_Parser_AST.Labeled (t,uu____4983,uu____4984) ->
                 collect_term t
             | FStar_Parser_AST.Quote (t,uu____4990) -> collect_term t
             ...
             | FStar_Parser_AST.CalcProof (rel,init,steps) ->
                 ((let uu____5004 =
                     let uu____5005 =
                       let uu____5011 = FStar_Ident.lid_of_str "FStar.Calc"
                          in
                       (false, uu____5011)  in
                     P_dep uu____5005  in
                   add_to_parsing_data uu____5004);
                  collect_term rel;
                  collect_term init;
                  FStar_List.iter
                    (fun uu___11_5023  ->
                       match uu___11_5023 with
           ...
           and collect_pattern' uu___13_5033 =
             match uu___13_5033 with
             | FStar_Parser_AST.PatVar (uu____5034,aqual) ->
                 collect_aqual aqual
             | FStar_Parser_AST.PatTvar (uu____5040,aqual) ->
                 collect_aqual aqual
             | FStar_Parser_AST.PatWild aqual -> collect_aqual aqual
             | FStar_Parser_AST.PatOp uu____5049 -> ()
             | FStar_Parser_AST.PatConst uu____5050 -> ()
             | FStar_Parser_AST.PatApp (p,ps) ->
                 (collect_pattern p; collect_patterns ps)
             | FStar_Parser_AST.PatName uu____5058 -> ()
             | FStar_Parser_AST.PatList ps -> collect_patterns ps
             | FStar_Parser_AST.PatOr ps -> collect_patterns ps
             | FStar_Parser_AST.PatTuple (ps,uu____5066) ->
                 collect_patterns ps
             | FStar_Parser_AST.PatRecord lidpats ->
                 FStar_List.iter
                   (fun uu____5087  ->
                      match uu____5087 with
                      | (uu____5092,p) -> collect_pattern p) lidpats
           ...
           and collect_branch uu____5137 =
             ...
             | (pat,t1,t2) ->
                 (collect_pattern pat;
                  ...
                  collect_term t2)
            in
           let uu____5155 = FStar_Parser_Driver.parse_file filename  in
           match uu____5155 with
           | (ast,uu____5181) ->
               (collect_module ast;
                (let pd1 =
                   let uu____5198 =
                     let uu____5201 = FStar_ST.op_Bang pd  in
                     FStar_List.rev uu____5201  in
                   Mk_pd uu____5198  in
                 let uu____5227 = from_parsing_data pd1 original_map filename
                    in
...
let (collect_one_cache :
  ...
  =
  let uu____5286 = FStar_Util.smap_create Prims.int_zero  in
  FStar_Util.mk_ref uu____5286 
...
let (dep_graph_copy : dependence_graph -> dependence_graph) =
  fun dep_graph  ->
    let uu____5408 = dep_graph  in
    match uu____5408 with
    | Deps g -> let uu____5412 = FStar_Util.smap_copy g  in Deps uu____5412
    ...
    fun dep_graph  ->
      fun file_system_map  ->
        fun widened  ->
          ...
          let uu____5454 = dep_graph  in
          match uu____5454 with
          | Deps dg ->
              let uu____5463 = deps_empty ()  in
                   ...
                   (FStar_Util.smap_fold dg
                      (fun filename  ->
                         fun dep_node1  ->
                           fun uu____5526  ->
                             let uu____5528 =
                               let uu___985_5529 = dep_node1  in
                               let uu____5530 = widen_one dep_node1.edges  in
                               { edges = uu____5530; color = White }  in
                             FStar_Util.smap_add dg' filename uu____5528) ();
                    (let uu____5531 = FStar_ST.op_Bang widened1  in
                     (uu____5531, (Deps dg')))))
  ...
  fun file_system_map  ->
    fun dep_graph  ->
      fun interfaces_needing_inlining  ->
        fun root_files  ->
          fun widened  ->
            let rec all_friend_deps_1 dep_graph1 cycle uu____5697 filename =
              match uu____5697 with
              | (all_friends,all_files) ->
                  let dep_node1 =
                    let uu____5738 = deps_try_find dep_graph1 filename  in
                    FStar_Util.must uu____5738  in
                   ...
                   | White  ->
                       ((let uu____5769 =
                        ...
                        deps_add_dep dep_graph1 filename
                          (let uu___1007_5786 = dep_node1  in
                           { edges = (uu___1007_5786.edges); color = Gray });
                        (let uu____5787 =
                           let uu____5798 =
                           ...
                           all_friend_deps dep_graph1 cycle
                             (all_friends, all_files) uu____5798
                            in
                         match uu____5787 with
                         | (all_friends1,all_files1) ->
                             (deps_add_dep dep_graph1 filename
                                (let uu___1013_5834 = dep_node1  in
                                 {
                                   edges = (uu___1013_5834.edges);
                                   color = Black
                                 });
                              (let uu____5836 =
                                 FStar_Options.debug_at_level_no_module
                              ...
                              (let uu____5843 =
                                 let uu____5847 =
                                   FStar_List.collect
                                     (fun uu___14_5854  ->
                                        match uu___14_5854 with
                                        | FriendImplementation m -> [m]
                                        | d -> []) dep_node1.edges
                                    in
                                 FStar_List.append uu____5847 all_friends1
                                  in
                               (uu____5843, (filename :: all_files1)))))))
            ...
            and all_friend_deps dep_graph1 cycle all_friends filenames =
             ...
             in
            let uu____5919 = all_friend_deps dep_graph [] ([], []) root_files
               in
                    ...
                    let uu____5966 =
                      let uu____5968 =
                        FStar_Util.remove_dups (fun x  -> fun y  -> x = y)
                          friends
                         in
                      FStar_String.concat ", " uu____5968  in
                    FStar_Util.print3
                      "Phase1 complete:\n\tall_files = %s\n\tall_friends=%s\n\tinterfaces_with_inlining=%s\n"
                      (FStar_String.concat ", " all_files_0) uu____5966
      ...
      fun interfaces_needing_inlining  ->
        fun for_extraction  ->
          ...
          (let widened = false  in
           let uu____6112 = (FStar_Options.cmi ()) && for_extraction  in
           if uu____6112
           then
    ...
    fun get_parsing_data_from_cache  ->
      let all_cmd_line_files1 =
        FStar_All.pipe_right all_cmd_line_files
          (FStar_List.map
             (fun fn  ->
                let uu____6256 = FStar_Options.find_file fn  in
                    ...
                    let uu____6262 =
                      let uu____6268 =
                        FStar_Util.format1 "File %s could not be found\n" fn
                         in
                      (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____6268)
                       in
                    FStar_Errors.raise_err uu____6262
      ...
      let add_interface_for_inlining l =
        ...
        let uu____6298 =
          let uu____6302 = FStar_ST.op_Bang interfaces_needing_inlining  in
          l1 :: uu____6302  in
        FStar_ST.op_Colon_Equals interfaces_needing_inlining uu____6298  in
      let parse_results = FStar_Util.smap_create (Prims.of_int (40))  in
      let rec discover_one file_name1 =
        let uu____6369 =
          let uu____6371 = deps_try_find dep_graph file_name1  in
          uu____6371 = FStar_Pervasives_Native.None  in
        if uu____6369
        then
          let uu____6377 =
            let uu____6393 =
              let uu____6407 = FStar_ST.op_Bang collect_one_cache  in
              FStar_Util.smap_try_find uu____6407 file_name1  in
          ...
          | (parsing_data1,(deps1,mo_roots,needs_interface_inlining)) ->
              (if needs_interface_inlining
               ...
               (let deps2 =
                ...
                let dep_node1 =
                  let uu____6639 = FStar_List.unique deps2  in
                  { edges = uu____6639; color = White }  in
                ...
                (let uu____6641 =
                   FStar_List.map
                    ...
                    in
                 FStar_List.iter discover_one uu____6641)))
        else ()  in
      profile
        (fun uu____6651  -> FStar_List.iter discover_one all_cmd_line_files1)
      ...
      (let cycle_detected dep_graph1 cycle filename =
         ...
         (let uu____6684 =
            let uu____6690 =
              FStar_Util.format1 "Recursive dependency on module %s\n"
                filename
               in
            (FStar_Errors.Fatal_CyclicDependence, uu____6690)  in
       ...
       let full_cycle_detection all_command_line_files file_system_map1 =
         ...
         let rec aux cycle filename =
           let node =
             let uu____6742 = deps_try_find dep_graph1 filename  in
                     ...
                     | UseInterface f ->
                         ...
                         (match uu____6760 with
                          ...
                          | FStar_Pervasives_Native.Some fn when
                              fn = filename -> [x]
                          | uu____6771 -> [x; UseImplementation f])
                     | PreferInterface f ->
                         let uu____6777 =
                           implementation_of_internal file_system_map1 f  in
           ...
           | White  ->
               (deps_add_dep dep_graph1 filename
                  (let uu___1134_6795 = node  in
                   { edges = direct_deps; color = Gray });
                (let uu____6797 =
                   dependences_of file_system_map1 dep_graph1
                     all_command_line_files filename
                    in
                 FStar_List.iter (fun k  -> aux (k :: cycle) k) uu____6797);
                deps_add_dep dep_graph1 filename
                  (let uu___1139_6808 = node  in
                   { edges = direct_deps; color = Black });
                (let uu____6809 = is_interface filename  in
                 if uu____6809
                 then
                   let uu____6812 =
                     let uu____6816 = lowercase_module_name filename  in
                     implementation_of_internal file_system_map1 uu____6816
                      in
                   FStar_Util.iter_opt uu____6812
                     (fun impl  ->
                        if
                          Prims.op_Negation
                        ...
                        then
                          let uu____6825 =
                            let uu____6829 = FStar_ST.op_Bang mo_files  in
                            impl :: uu____6829  in
                          FStar_ST.op_Colon_Equals mo_files uu____6825
                        else ())
                 else ()))
            in
         FStar_List.iter (aux []) all_command_line_files;
         (let uu____6891 = FStar_ST.op_Bang mo_files  in
          FStar_List.iter (aux []) uu____6891)
          in
       ...
       (let inlining_ifaces = FStar_ST.op_Bang interfaces_needing_inlining
        ...
        let uu____6963 =
          profile
            (fun uu____6982  ->
               let uu____6983 =
                 let uu____6985 = FStar_Options.codegen ()  in
                 uu____6985 <> FStar_Pervasives_Native.None  in
               topological_dependences_of file_system_map dep_graph
                 inlining_ifaces all_cmd_line_files1 uu____6983)
            "FStar.Parser.Dep.topological_dependences_of"
           in
        match uu____6963 with
        | (all_files,uu____6999) ->
            ((let uu____7009 =
                FStar_Options.debug_at_level_no_module
                  (FStar_Options.Other "Dep")
                 in
      ...
      FStar_All.pipe_right dig
        (FStar_List.map
           (fun uu____7089  ->
              ...
              | (m,d) ->
                  let uu____7103 = FStar_Util.base64_encode d  in
                  FStar_Util.format2 "%s:%s" m uu____7103))
       in
    FStar_All.pipe_right uu____7063 (FStar_String.concat "\n")
  ...
  fun deps1  ->
    ...
    FStar_All.pipe_right keys
      (FStar_List.iter
         (fun f  ->
            let dep_node1 =
              let uu____7138 = deps_try_find deps2 f  in
              FStar_All.pipe_right uu____7138 FStar_Option.get  in
            let files =
...
let (print_raw : deps -> unit) =
  fun deps1  ->
    let uu____7167 = deps1.dep_graph  in
              ...
              (fun k  ->
                 fun dep_node1  ->
                   fun out  ->
                     ...
                     uu____7191 :: out) []
             in
          FStar_All.pipe_right uu____7173 (FStar_String.concat ";;\n")  in
        FStar_All.pipe_right uu____7171 FStar_Util.print_endline
  ...
  fun deps1  ->
    let sort_output_files orig_output_file_map =
      ...
      let emit_output_file_opt ml_file_opt =
        ...
        | FStar_Pervasives_Native.Some ml_file ->
            let uu____7317 =
              let uu____7321 = FStar_ST.op_Bang order  in ml_file ::
                uu____7321
               in
            FStar_ST.op_Colon_Equals order uu____7317
         in
      let rec aux uu___15_7384 =
        match uu___15_7384 with
        | [] -> ()
        | lc_module_name::modules_to_extract ->
            let visit_file file_opt =
              ...
              | FStar_Pervasives_Native.Some file_name1 ->
                  let uu____7412 = deps_try_find deps1.dep_graph file_name1
                     in
                  (match uu____7412 with
                   | FStar_Pervasives_Native.None  ->
                       ...
                       failwith uu____7415
                   | FStar_Pervasives_Native.Some
                       { edges = immediate_deps; color = uu____7419;_} ->
                       let immediate_deps1 =
                         FStar_List.map
                           (fun x  ->
                       ...
                       aux immediate_deps1)
               in
            ((let uu____7428 = should_visit lc_module_name  in
              if uu____7428
              then
                let ml_file_opt = mark_visiting lc_module_name  in
                ((let uu____7436 = implementation_of deps1 lc_module_name  in
                  visit_file uu____7436);
                 (let uu____7441 = interface_of deps1 lc_module_name  in
                  visit_file uu____7441);
      ...
      (let uu____7453 = FStar_ST.op_Bang order  in FStar_List.rev uu____7453)
       in
    let sb =
      let uu____7484 = FStar_BigInt.of_int_fs (Prims.of_int (10000))  in
      FStar_StringBuffer.create uu____7484  in
    let pr str =
      let uu____7494 = FStar_StringBuffer.add str sb  in
      FStar_All.pipe_left (fun uu____7495  -> ()) uu____7494  in
    ...
    let output_file ext fst_file =
      let ml_base_name =
        let uu____7548 =
          let uu____7550 =
            let uu____7554 = FStar_Util.basename fst_file  in
            check_and_strip_suffix uu____7554  in
          FStar_Option.get uu____7550  in
        FStar_Util.replace_chars uu____7548 46 "_"  in
      let uu____7559 = FStar_String.op_Hat ml_base_name ext  in
      FStar_Options.prepend_output_dir uu____7559  in
    let norm_path s = FStar_Util.replace_chars s 92 "/"  in
    let output_ml_file f =
      let uu____7581 = output_file ".ml" f  in norm_path uu____7581  in
    let output_krml_file f =
      let uu____7593 = output_file ".krml" f  in norm_path uu____7593  in
    let output_cmx_file f =
      let uu____7605 = output_file ".cmx" f  in norm_path uu____7605  in
    let cache_file f =
      let uu____7617 = cache_file_name f  in norm_path uu____7617  in
    let uu____7619 =
          ...
          FStar_All.pipe_right keys
            (FStar_List.fold_left
               (fun all_checked_files  ->
                  fun file_name1  ->
                    let process_one_key uu____7661 =
                      let dep_node1 =
                        let uu____7663 =
                          deps_try_find deps1.dep_graph file_name1  in
                        FStar_All.pipe_right uu____7663 FStar_Option.get  in
                      let iface_deps =
                        let uu____7673 = is_interface file_name1  in
                        if uu____7673
                        then FStar_Pervasives_Native.None
                          ...
                          (let uu____7684 =
                             ...
                             interface_of deps1 uu____7688  in
                           ...
                           | FStar_Pervasives_Native.Some iface ->
                               let uu____7700 =
                                 let uu____7703 =
                                   ...
                                   FStar_Option.get uu____7704  in
                                 uu____7703.edges  in
                      ...
                      let all_checked_files1 =
                        let uu____7786 =
                          let uu____7788 =
                            let uu____7790 = module_name_of_file file_name1
                               in
                            FStar_Options.should_be_already_cached uu____7790
                             in
                          Prims.op_Negation uu____7788  in
                        if uu____7786
                        then
                      ...
                      let uu____7800 =
                        let uu____7809 = FStar_Options.cmi ()  in
                        if uu____7809
                        then
                          profile
                            (fun uu____7830  ->
                               let uu____7831 = dep_graph_copy dep_graph  in
                               topological_dependences_of'
                                 deps1.file_system_map uu____7831
                      ...
                      | (all_fst_files_dep,widened1) ->
                          ...
                          let all_checked_fst_dep_files_string =
                            FStar_String.concat " \\\n\t"
                             ...
                             in
                          ((let uu____7916 = is_implementation file_name1  in
                            if uu____7916
                            then
                              ((let uu____7920 =
                                ...
                                then
                                  ...
                                  ((let uu____7931 =
                                      output_ml_file file_name1  in
                                    print_entry uu____7931 cache_file_name1
                                      "");
                                   (let uu____7934 =
                                      output_krml_file file_name1  in
                                    print_entry uu____7934 cache_file_name1
                                      "")));
                               (let cmx_files =
                                ...
                                let uu____7975 =
                                  let uu____7977 =
                                    lowercase_module_name file_name1  in
                                  FStar_Options.should_extract uu____7977  in
                                if uu____7975
                                then
                                  let cmx_files1 =
                                    FStar_String.concat "\\\n\t" cmx_files
                                     in
                                  let uu____7983 = output_cmx_file file_name1
                                     in
                                  let uu____7985 = output_ml_file file_name1
                                     in
                                  print_entry uu____7983 uu____7985
                                    cmx_files1
                                else ()))
                            else
                              (let uu____7991 =
                               ...
                               then
                                 ...
                                 (if uu____8000
                                  then
                                    let uu____8004 =
                                      output_krml_file file_name1  in
                                    print_entry uu____8004 cache_file_name1
                                      all_checked_fst_dep_files_string
                                  else
                                    (let uu____8008 =
                                       output_krml_file file_name1  in
                                     print_entry uu____8008 cache_file_name1
                                       ""))
                               else ()));
                           all_checked_files1)
                       in
          ...
          FStar_All.pipe_right all_fst_files
            (FStar_List.iter
               (fun fst_file  ->
                  ...
                  let uu____8085 = FStar_Options.should_extract mname  in
                  if uu____8085
                  then
                    let uu____8088 = output_ml_file fst_file  in
                    FStar_Util.smap_add ml_file_map mname uu____8088
                  else ()));
        ...
        let all_krml_files =
          ...
          FStar_All.pipe_right keys
            (FStar_List.iter
               (fun fst_file  ->
                  let mname = lowercase_module_name fst_file  in
                  let uu____8115 = output_krml_file fst_file  in
                  FStar_Util.smap_add krml_file_map mname uu____8115));
                 ...
                 let uu____8264 =
                   let uu____8266 =
                     FStar_Util.format3 "%s -> (%s, %s)" k
                      ...
                      in
                   FStar_String.op_Hat "; " uu____8266  in
                 FStar_String.op_Hat s uu____8264) ""
  
let (module_has_interface : deps -> FStar_Ident.lident -> Prims.bool) =
  fun deps1  ->
    fun module_name1  ->
      let uu____8287 =
        let uu____8289 = FStar_Ident.string_of_lid module_name1  in
        FStar_String.lowercase uu____8289  in
      has_interface deps1.file_system_map uu____8287
  
let (deps_has_implementation : deps -> FStar_Ident.lident -> Prims.bool) =
  fun deps1  ->
    fun module_name1  ->
      let m =
        let uu____8305 = FStar_Ident.string_of_lid module_name1  in
        FStar_String.lowercase uu____8305  in
      FStar_All.pipe_right deps1.all_files
        (FStar_Util.for_some
           (fun f  ->
              (is_implementation f) &&
                (let uu____8316 =
                   let uu____8318 = module_name_of_file f  in
                   FStar_String.lowercase uu____8318  in
                 uu____8316 = m)))
